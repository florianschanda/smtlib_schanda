...
(define-fun to_int6 ((x bits_5)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_5)) (! (in_range_int3 (to_int6 x)) :pattern ((to_int6 x)))))
...
(assert (forall ((x bits_7)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x80))) (=> (in_range5 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun to_int7 ((x bits_7)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x bits_7)) (! (in_range_int4 (to_int7 x)) :pattern ((to_int7 x)))))
...
(define-fun in_range_int5 ((x Int)) Bool (and (<= 0 x) (<= x 1023)))
...
(assert (forall ((x bits_10)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x bits_10)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x0400))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int9 ((x bits_10)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x bits_10)) (! (in_range_int5 (to_int9 x)) :pattern ((to_int9 x)))))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (and (and (and (and (and (= (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__tflen (us_split_fields3 a))) (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__tflen (us_split_fields3 b)))) (= (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__tfle (us_split_fields3 a))) (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__tfle (us_split_fields3 b))))) (= (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__r (us_split_fields3 a))) (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__r (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txbr (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txbr (us_split_fields3 b))))) (= (to_rep (rec__dw1000__register_types__tx_fctrl_type__tr (us_split_fields3 a))) (to_rep (rec__dw1000__register_types__tx_fctrl_type__tr (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txprf (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txprf (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txpsr (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txpsr (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__pe (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__pe (us_split_fields3 b))))) (= (to_rep6 (rec__dw1000__register_types__tx_fctrl_type__txboffs (us_split_fields3 a))) (to_rep6 (rec__dw1000__register_types__tx_fctrl_type__txboffs (us_split_fields3 b))))) (= (to_rep5 (rec__dw1000__register_types__tx_fctrl_type__ifsdelay (us_split_fields3 a))) (to_rep5 (rec__dw1000__register_types__tx_fctrl_type__ifsdelay (us_split_fields3 b))))) true false))
...
(define-fun in_range7 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x0F)))
(define-fun in_range_int6 ((x Int)) Bool (and (<= 0 x) (<= x 15)))
(declare-fun attr__ATTRIBUTE_IMAGE8 ((_ BitVec 8)) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check8 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE8 (us_image) (_ BitVec 8))
(declare-fun user_eq9 (bits_4 bits_4) Bool)
(declare-const dummy9 bits_4)
...
(declare-fun to_rep7 (bits_4) (_ BitVec 8))
(declare-fun of_rep7 ((_ BitVec 8)) bits_4)
(assert (forall ((x bits_4)) (! (= (of_rep7 (to_rep7 x)) x) :pattern ((to_rep7 x)))))
(assert (forall ((x bits_4)) (! (in_range7 (to_rep7 x)) :pattern ((to_rep7 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x10))) (=> (in_range7 y) (= (to_rep7 (of_rep7 x)) y))) :pattern ((to_rep7 (of_rep7 x))))))
(define-fun to_int10 ((x bits_4)) Int (bv2nat (to_rep7 x)))
(assert (forall ((x bits_4)) (! (in_range_int6 (to_int10 x)) :pattern ((to_int10 x)))))
(declare-sort bits_9 0)
(define-fun in_range8 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x01FF)))
(define-fun in_range_int7 ((x Int)) Bool (and (<= 0 x) (<= x 511)))
...
(declare-fun user_eq10 (bits_9 bits_9) Bool)
(declare-const dummy10 bits_9)
...
(declare-fun to_rep8 (bits_9) (_ BitVec 16))
(declare-fun of_rep8 ((_ BitVec 16)) bits_9)
(assert (forall ((x bits_9)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x bits_9)) (! (in_range8 (to_rep8 x)) :pattern ((to_rep8 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x0200))) (=> (in_range8 y) (= (to_rep8 (of_rep8 x)) y))) :pattern ((to_rep8 (of_rep8 x))))))
(define-fun to_int11 ((x bits_9)) Int (bv2nat (to_rep8 x)))
(assert (forall ((x bits_9)) (! (in_range_int7 (to_int11 x)) :pattern ((to_int11 x)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (and (and (and (and (and (= (to_rep7 (rec__dw1000__register_types__chan_ctrl_type__tx_chan (us_split_fields5 a))) (to_rep7 (rec__dw1000__register_types__chan_ctrl_type__tx_chan (us_split_fields5 b)))) (= (to_rep7 (rec__dw1000__register_types__chan_ctrl_type__rx_chan (us_split_fields5 a))) (to_rep7 (rec__dw1000__register_types__chan_ctrl_type__rx_chan (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__chan_ctrl_type__dwsfd (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__chan_ctrl_type__dwsfd (us_split_fields5 b))))) (= (to_rep1 (rec__dw1000__register_types__chan_ctrl_type__rxprf (us_split_fields5 a))) (to_rep1 (rec__dw1000__register_types__chan_ctrl_type__rxprf (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__chan_ctrl_type__tnssfd (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__chan_ctrl_type__tnssfd (us_split_fields5 b))))) (= (to_rep (rec__dw1000__register_types__chan_ctrl_type__rnssfd (us_split_fields5 a))) (to_rep (rec__dw1000__register_types__chan_ctrl_type__rnssfd (us_split_fields5 b))))) (= (to_rep3 (rec__dw1000__register_types__chan_ctrl_type__tx_pcode (us_split_fields5 a))) (to_rep3 (rec__dw1000__register_types__chan_ctrl_type__tx_pcode (us_split_fields5 b))))) (= (to_rep3 (rec__dw1000__register_types__chan_ctrl_type__rx_pcode (us_split_fields5 a))) (to_rep3 (rec__dw1000__register_types__chan_ctrl_type__rx_pcode (us_split_fields5 b))))) (= (to_rep8 (rec__dw1000__register_types__chan_ctrl_type__reserved (us_split_fields5 a))) (to_rep8 (rec__dw1000__register_types__chan_ctrl_type__reserved (us_split_fields5 b))))) true false))
...
(declare-fun user_eq12 (bits_16 bits_16) Bool)
...
(declare-fun to_rep10 (bits_32) (_ BitVec 32))
(declare-fun of_rep10 ((_ BitVec 32)) bits_32)
(assert (forall ((x bits_32)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert true)
(assert (forall ((x (_ BitVec 32))) (! (= (to_rep10 (of_rep10 x)) x) :pattern ((to_rep10 (of_rep10 x))))))
(define-fun to_int14 ((x bits_32)) Int (bv2nat (to_rep10 x)))
...
(define-fun bool_eq4 ((a (Array Int bits_32)) (a__first Int) (a__last Int) (b (Array Int bits_32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep10 (select a temp___idx_206)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_206))))))) true false))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep10 (select a temp___idx_206)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_206)))))))))))
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__decadriver__driver_type__part_id bits_32) (rec__decadriver__driver_type__lot_id bits_32) (rec__decadriver__driver_type__antenna_delay_prf_64 bits_16) (rec__decadriver__driver_type__antenna_delay_prf_16 bits_16) (rec__decadriver__driver_type__xtal_trim bits_5) (rec__decadriver__driver_type__otp_tx_power_levels (Array Int bits_32)) (rec__decadriver__driver_type__long_frames Bool) (rec__decadriver__driver_type__sys_cfg_reg us_rep) (rec__decadriver__driver_type__use_otp_xtal_trim Bool) (rec__decadriver__driver_type__use_otp_antenna_delay Bool) (rec__decadriver__driver_type__detect_frame_timeout Bool) (rec__decadriver__driver_type__detect_sfd_timeout Bool) (rec__decadriver__driver_type__detect_phr_error Bool) (rec__decadriver__driver_type__detect_rs_error Bool) (rec__decadriver__driver_type__detect_fcs_error Bool)))))
(define-fun us_split_fields_Part_ID__projection ((a us_split_fields8)) bits_32 (rec__decadriver__driver_type__part_id a))
(define-fun us_split_fields_Lot_ID__projection ((a us_split_fields8)) bits_32 (rec__decadriver__driver_type__lot_id a))
(define-fun us_split_fields_Antenna_Delay_PRF_64__projection ((a us_split_fields8)) bits_16 (rec__decadriver__driver_type__antenna_delay_prf_64 a))
(define-fun us_split_fields_Antenna_Delay_PRF_16__projection ((a us_split_fields8)) bits_16 (rec__decadriver__driver_type__antenna_delay_prf_16 a))
(define-fun us_split_fields_XTAL_Trim__projection ((a us_split_fields8)) bits_5 (rec__decadriver__driver_type__xtal_trim a))
(define-fun us_split_fields_OTP_Tx_Power_Levels__projection ((a us_split_fields8)) (Array Int bits_32) (rec__decadriver__driver_type__otp_tx_power_levels a))
(define-fun us_split_fields_Long_Frames__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__long_frames a))
(define-fun us_split_fields_SYS_CFG_Reg__projection ((a us_split_fields8)) us_rep (rec__decadriver__driver_type__sys_cfg_reg a))
(define-fun us_split_fields_Use_OTP_XTAL_Trim__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__use_otp_xtal_trim a))
(define-fun us_split_fields_Use_OTP_Antenna_Delay__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__use_otp_antenna_delay a))
(define-fun us_split_fields_Detect_Frame_Timeout__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__detect_frame_timeout a))
(define-fun us_split_fields_Detect_SFD_Timeout__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__detect_sfd_timeout a))
(define-fun us_split_fields_Detect_PHR_Error__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__detect_phr_error a))
(define-fun us_split_fields_Detect_RS_Error__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__detect_rs_error a))
(define-fun us_split_fields_Detect_FCS_Error__projection ((a us_split_fields8)) Bool (rec__decadriver__driver_type__detect_fcs_error a))
(declare-datatypes () ((us_split_fields__ref4 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref___143__projection ((a us_split_fields__ref4)) us_split_fields8 (us_split_fields__content4 a))
(declare-datatypes () ((us_rep4 (mk___rep4 (us_split_fields9 us_split_fields8)))))
(define-fun us_rep___145__projection ((a us_rep4)) us_split_fields8 (us_split_fields9 a))
...
(declare-datatypes () ((driver_type__ref (mk_driver_type__ref (driver_type__content us_rep4)))))
(define-fun driver_type__ref___projection ((a driver_type__ref)) us_rep4 (driver_type__content a))
(declare-fun phr_mode (us_rep4) Int)
(declare-fun phr_mode__function_guard (Int us_rep4) Bool)
(declare-sort physical_header_modes 0)
(define-fun in_range9 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE12 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) Int)
(declare-fun user_eq16 (physical_header_modes physical_header_modes) Bool)
(declare-const dummy15 physical_header_modes)
...
(define-fun dynamic_invariant ((temp___expr_4891 Int) (temp___is_init_4887 Bool) (temp___skip_constant_4888 Bool) (temp___do_toplevel_4889 Bool) (temp___do_typ_inv_4890 Bool)) Bool (=> (or (= temp___is_init_4887 true) (<= 0 1)) (in_range9 temp___expr_4891)))
(declare-fun temp_____aggregate_def_5041 ((_ BitVec 32)) (Array Int bits_32))
(define-fun default_initial_assumption ((temp___expr_5039 us_rep4) (temp___skip_top_level_5040 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep10 (rec__decadriver__driver_type__part_id (us_split_fields9 temp___expr_5039))) #x00000000) (= (to_rep10 (rec__decadriver__driver_type__lot_id (us_split_fields9 temp___expr_5039))) #x00000000)) (= (to_rep9 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields9 temp___expr_5039))) #x0000)) (= (to_rep9 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields9 temp___expr_5039))) #x0000)) (= (to_rep3 (rec__decadriver__driver_type__xtal_trim (us_split_fields9 temp___expr_5039))) #x10)) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields9 temp___expr_5039)) (temp_____aggregate_def_5041 #x00000000))) (= (rec__decadriver__driver_type__long_frames (us_split_fields9 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 temp___expr_5039)) (mk___rep (mk___split_fields (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep1 #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep2 #x00) (of_rep3 #x00))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields9 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields9 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields9 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields9 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields9 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields9 temp___expr_5039)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields9 temp___expr_5039)) (distinct 0 0))))
(assert (forall ((self__ us_rep4)) (! (dynamic_invariant (phr_mode self__) true false true true) :pattern ((phr_mode self__)))))
(declare-sort data_rates 0)
(define-fun in_range10 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
(declare-fun attr__ATTRIBUTE_IMAGE13 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) Int)
(declare-fun user_eq17 (data_rates data_rates) Bool)
(declare-const dummy16 data_rates)
...
(declare-fun to_rep11 (data_rates) Int)
(declare-fun of_rep11 (Int) data_rates)
(assert (forall ((x data_rates)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x data_rates)) (! (in_range10 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((i channel_number)) (and (<= 1 (channel_numberqtint i)) (<= (channel_numberqtint i) 7))))
(define-fun in_range11 ((x Int)) Bool (and (<= 1 x) (<= x 7)))
(declare-fun attr__ATTRIBUTE_IMAGE14 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check14 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE14 (us_image) Int)
(declare-fun user_eq18 (channel_number channel_number) Bool)
(declare-const dummy17 channel_number)
...
(define-fun dynamic_invariant1 ((temp___expr_4853 Int) (temp___is_init_4849 Bool) (temp___skip_constant_4850 Bool) (temp___do_toplevel_4851 Bool) (temp___do_typ_inv_4852 Bool)) Bool (and (=> (or (= temp___is_init_4849 true) (<= 1 7)) (in_range11 temp___expr_4853)) (=> (= temp___do_toplevel_4851 true) (=> (= temp___is_init_4849 true) (or (and (<= 1 temp___expr_4853) (<= temp___expr_4853 5)) (and (<= 7 temp___expr_4853) (<= temp___expr_4853 7)))))))
(define-fun dynamic_predicate ((temp___4857 Int)) Bool (or (and (<= 1 temp___4857) (<= temp___4857 5)) (and (<= 7 temp___4857) (<= temp___4857 7))))
(define-fun to_rep12 ((x channel_number)) Int (channel_numberqtint x))
(declare-fun of_rep12 (Int) channel_number)
(assert (forall ((x channel_number)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x channel_number)) (! (in_range11 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq19 (prf_type prf_type) Bool)
(declare-const dummy18 prf_type)
...
(declare-fun to_rep13 (prf_type) Int)
(declare-fun of_rep13 (Int) prf_type)
(assert (forall ((x prf_type)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x prf_type)) (! (in_range12 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-fun user_eq20 (preamble_lengths preamble_lengths) Bool)
(declare-const dummy19 preamble_lengths)
...
(declare-fun to_rep14 (preamble_lengths) Int)
(declare-fun of_rep14 (Int) preamble_lengths)
(assert (forall ((x preamble_lengths)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x preamble_lengths)) (! (in_range13 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-fun user_eq21 (preamble_acq_chunk_length preamble_acq_chunk_length) Bool)
(declare-const dummy20 preamble_acq_chunk_length)
...
(declare-fun to_rep15 (preamble_acq_chunk_length) Int)
(declare-fun of_rep15 (Int) preamble_acq_chunk_length)
(assert (forall ((x preamble_acq_chunk_length)) (! (= (of_rep15 (to_rep15 x)) x) :pattern ((to_rep15 x)))))
(assert (forall ((x preamble_acq_chunk_length)) (! (in_range14 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(assert (forall ((i preamble_code_number)) (and (<= 1 (preamble_code_numberqtint i)) (<= (preamble_code_numberqtint i) 24))))
(define-fun in_range15 ((x Int)) Bool (and (<= 1 x) (<= x 24)))
...
(declare-fun user_eq22 (preamble_code_number preamble_code_number) Bool)
(declare-const dummy21 preamble_code_number)
...
(define-fun to_rep16 ((x preamble_code_number)) Int (preamble_code_numberqtint x))
(declare-fun of_rep16 (Int) preamble_code_number)
(assert (forall ((x preamble_code_number)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x preamble_code_number)) (! (in_range15 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
(declare-fun to_rep17 (physical_header_modes) Int)
(declare-fun of_rep17 (Int) physical_header_modes)
(assert (forall ((x physical_header_modes)) (! (= (of_rep17 (to_rep17 x)) x) :pattern ((to_rep17 x)))))
(assert (forall ((x physical_header_modes)) (! (in_range9 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range9 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
(declare-sort sfd_timeout_number 0)
(declare-fun sfd_timeout_numberqtint (sfd_timeout_number) Int)
(assert (forall ((i sfd_timeout_number)) (and (<= 0 (sfd_timeout_numberqtint i)) (<= (sfd_timeout_numberqtint i) 65535))))
...
(declare-fun user_eq23 (sfd_timeout_number sfd_timeout_number) Bool)
(declare-const dummy22 sfd_timeout_number)
...
(define-fun dynamic_invariant2 ((temp___expr_4898 Int) (temp___is_init_4894 Bool) (temp___skip_constant_4895 Bool) (temp___do_toplevel_4896 Bool) (temp___do_typ_inv_4897 Bool)) Bool (=> (or (= temp___is_init_4894 true) (<= 0 65535)) (in_range16 temp___expr_4898)))
(define-fun to_rep18 ((x sfd_timeout_number)) Int (sfd_timeout_numberqtint x))
(declare-fun of_rep18 (Int) sfd_timeout_number)
(assert (forall ((x sfd_timeout_number)) (! (= (of_rep18 (to_rep18 x)) x) :pattern ((to_rep18 x)))))
(assert (forall ((x sfd_timeout_number)) (! (in_range16 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range16 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__decadriver__configuration_type__channel channel_number) (rec__decadriver__configuration_type__prf prf_type) (rec__decadriver__configuration_type__tx_preamble_length preamble_lengths) (rec__decadriver__configuration_type__tx_pac preamble_acq_chunk_length) (rec__decadriver__configuration_type__tx_preamble_code preamble_code_number) (rec__decadriver__configuration_type__rx_preamble_code preamble_code_number) (rec__decadriver__configuration_type__use_nonstandard_sfd Bool) (rec__decadriver__configuration_type__data_rate data_rates) (rec__decadriver__configuration_type__phr_mode physical_header_modes) (rec__decadriver__configuration_type__sfd_timeout sfd_timeout_number) (rec__decadriver__configuration_type__enable_smart_power Bool)))))
(define-fun us_split_fields_Channel__projection ((a us_split_fields10)) channel_number (rec__decadriver__configuration_type__channel a))
(define-fun us_split_fields_PRF__projection ((a us_split_fields10)) prf_type (rec__decadriver__configuration_type__prf a))
(define-fun us_split_fields_Tx_Preamble_Length__projection ((a us_split_fields10)) preamble_lengths (rec__decadriver__configuration_type__tx_preamble_length a))
(define-fun us_split_fields_Tx_PAC__projection ((a us_split_fields10)) preamble_acq_chunk_length (rec__decadriver__configuration_type__tx_pac a))
(define-fun us_split_fields_Tx_Preamble_Code__projection ((a us_split_fields10)) preamble_code_number (rec__decadriver__configuration_type__tx_preamble_code a))
(define-fun us_split_fields_Rx_Preamble_Code__projection ((a us_split_fields10)) preamble_code_number (rec__decadriver__configuration_type__rx_preamble_code a))
(define-fun us_split_fields_Use_Nonstandard_SFD__projection ((a us_split_fields10)) Bool (rec__decadriver__configuration_type__use_nonstandard_sfd a))
(define-fun us_split_fields_Data_Rate__projection ((a us_split_fields10)) data_rates (rec__decadriver__configuration_type__data_rate a))
(define-fun us_split_fields_PHR_Mode__projection ((a us_split_fields10)) physical_header_modes (rec__decadriver__configuration_type__phr_mode a))
(define-fun us_split_fields_SFD_Timeout__projection ((a us_split_fields10)) sfd_timeout_number (rec__decadriver__configuration_type__sfd_timeout a))
(define-fun us_split_fields_Enable_Smart_Power__projection ((a us_split_fields10)) Bool (rec__decadriver__configuration_type__enable_smart_power a))
(declare-datatypes () ((us_split_fields__ref5 (mk___split_fields__ref5 (us_split_fields__content5 us_split_fields10)))))
(define-fun us_split_fields__ref___139__projection ((a us_split_fields__ref5)) us_split_fields10 (us_split_fields__content5 a))
...
(define-fun bool_eq5 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (and (and (and (and (and (and (= (to_rep12 (rec__decadriver__configuration_type__channel (us_split_fields11 a))) (to_rep12 (rec__decadriver__configuration_type__channel (us_split_fields11 b)))) (= (to_rep13 (rec__decadriver__configuration_type__prf (us_split_fields11 a))) (to_rep13 (rec__decadriver__configuration_type__prf (us_split_fields11 b))))) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 a))) (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 b))))) (= (to_rep15 (rec__decadriver__configuration_type__tx_pac (us_split_fields11 a))) (to_rep15 (rec__decadriver__configuration_type__tx_pac (us_split_fields11 b))))) (= (to_rep16 (rec__decadriver__configuration_type__tx_preamble_code (us_split_fields11 a))) (to_rep16 (rec__decadriver__configuration_type__tx_preamble_code (us_split_fields11 b))))) (= (to_rep16 (rec__decadriver__configuration_type__rx_preamble_code (us_split_fields11 a))) (to_rep16 (rec__decadriver__configuration_type__rx_preamble_code (us_split_fields11 b))))) (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 a)) (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 b)))) (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 a))) (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 b))))) (= (to_rep17 (rec__decadriver__configuration_type__phr_mode (us_split_fields11 a))) (to_rep17 (rec__decadriver__configuration_type__phr_mode (us_split_fields11 b))))) (= (to_rep18 (rec__decadriver__configuration_type__sfd_timeout (us_split_fields11 a))) (to_rep18 (rec__decadriver__configuration_type__sfd_timeout (us_split_fields11 b))))) (= (rec__decadriver__configuration_type__enable_smart_power (us_split_fields11 a)) (rec__decadriver__configuration_type__enable_smart_power (us_split_fields11 b)))) true false))
...
(declare-datatypes () ((configuration_type__ref (mk_configuration_type__ref (configuration_type__content us_rep5)))))
(define-fun configuration_type__ref___projection ((a configuration_type__ref)) us_rep5 (configuration_type__content a))
(define-fun dynamic_invariant3 ((temp___expr_4920 us_rep5) (temp___is_init_4916 Bool) (temp___skip_constant_4917 Bool) (temp___do_toplevel_4918 Bool) (temp___do_typ_inv_4919 Bool)) Bool (=> (= temp___is_init_4916 true) (let ((temp___4922 (to_rep12 (rec__decadriver__configuration_type__channel (us_split_fields11 temp___expr_4920))))) (or (and (<= 1 temp___4922) (<= temp___4922 5)) (and (<= 7 temp___4922) (<= temp___4922 7))))))
(declare-const config us_rep5)
...
(assert (forall ((temp___5043 (_ BitVec 32))) (=> (dynamic_invariant5 temp___5043 true true true true) (forall ((temp___5044 Int)) (= (to_rep10 (select (temp_____aggregate_def_5041 temp___5043) temp___5044)) temp___5043)))))
...
(define-fun dynamic_invariant9 ((temp___expr_336 (_ BitVec 8)) (temp___is_init_332 Bool) (temp___skip_constant_333 Bool) (temp___do_toplevel_334 Bool) (temp___do_typ_inv_335 Bool)) Bool (=> (or (= temp___is_init_332 true) (bvule #x00 #x0F)) (in_range7 temp___expr_336)))
(define-fun dynamic_invariant10 ((temp___expr_343 (_ BitVec 8)) (temp___is_init_339 Bool) (temp___skip_constant_340 Bool) (temp___do_toplevel_341 Bool) (temp___do_typ_inv_342 Bool)) Bool (=> (or (= temp___is_init_339 true) (bvule #x00 #x1F)) (in_range4 temp___expr_343)))
(define-fun dynamic_invariant11 ((temp___expr_357 (_ BitVec 8)) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool) (temp___do_typ_inv_356 Bool)) Bool (=> (or (= temp___is_init_353 true) (bvule #x00 #x7F)) (in_range5 temp___expr_357)))
...
(define-fun dynamic_invariant13 ((temp___expr_371 (_ BitVec 16)) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool) (temp___do_typ_inv_370 Bool)) Bool (=> (or (= temp___is_init_367 true) (bvule #x0000 #x01FF)) (in_range8 temp___expr_371)))
(define-fun dynamic_invariant14 ((temp___expr_378 (_ BitVec 16)) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool) (temp___do_typ_inv_377 Bool)) Bool (=> (or (= temp___is_init_374 true) (bvule #x0000 #x03FF)) (in_range6 temp___expr_378)))
(define-fun dynamic_invariant15 ((temp___expr_4846 Int) (temp___is_init_4842 Bool) (temp___skip_constant_4843 Bool) (temp___do_toplevel_4844 Bool) (temp___do_typ_inv_4845 Bool)) Bool (=> (or (= temp___is_init_4842 true) (<= 0 2)) (in_range10 temp___expr_4846)))
(define-fun dynamic_invariant16 ((temp___expr_4863 Int) (temp___is_init_4859 Bool) (temp___skip_constant_4860 Bool) (temp___do_toplevel_4861 Bool) (temp___do_typ_inv_4862 Bool)) Bool (=> (or (= temp___is_init_4859 true) (<= 0 1)) (in_range12 temp___expr_4863)))
(define-fun dynamic_invariant17 ((temp___expr_4870 Int) (temp___is_init_4866 Bool) (temp___skip_constant_4867 Bool) (temp___do_toplevel_4868 Bool) (temp___do_typ_inv_4869 Bool)) Bool (=> (or (= temp___is_init_4866 true) (<= 0 7)) (in_range13 temp___expr_4870)))
(define-fun dynamic_invariant18 ((temp___expr_4877 Int) (temp___is_init_4873 Bool) (temp___skip_constant_4874 Bool) (temp___do_toplevel_4875 Bool) (temp___do_typ_inv_4876 Bool)) Bool (=> (or (= temp___is_init_4873 true) (<= 0 3)) (in_range14 temp___expr_4877)))
(define-fun dynamic_invariant19 ((temp___expr_4884 Int) (temp___is_init_4880 Bool) (temp___skip_constant_4881 Bool) (temp___do_toplevel_4882 Bool) (temp___do_typ_inv_4883 Bool)) Bool (=> (or (= temp___is_init_4880 true) (<= 1 24)) (in_range15 temp___expr_4884)))
...
(declare-const temp___5196 bits_16)
...
(declare-const temp___5200 bits_16)
...
(declare-const o19 us_split_fields8)
(declare-const o20 us_rep4)
...
(declare-const o49 bits_8)
(declare-const o50 bits_10)
(declare-const o51 bits_2)
(declare-const o52 bits_2)
(declare-const o53 bits_2)
(declare-const o54 bits_1)
(declare-const result bits_16)
(declare-const lde_repc_reg__split_fields1 bits_16)
(declare-const result1 driver_type__ref)
(declare-const self__1 us_rep4)
...
(declare-const self__2 us_rep4)
(declare-const result4 driver_type__ref)
(declare-const self__3 us_rep4)
(declare-const result5 driver_type__ref)
(declare-const self__4 us_rep4)
...
(assert (dynamic_invariant3 config true false true true))
(assert (=> (<= 0 65535) (in_range16 sfd_timeout)))
(assert (= (to_rep9 o) (to_rep9 (select lde_replica_coeffs (to_rep16 (rec__decadriver__configuration_type__rx_preamble_code (us_split_fields11 config)))))))
(assert (= o o1))
(assert (= temp___5196 o1))
...
(assert (= temp___5196 lde_repc_reg__split_fields1))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= (to_rep o2) #x01)))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= o3 (mk___split_fields (rec__dw1000__register_types__sys_cfg_type__ffen (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffbc (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffab (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffad (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffaa (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffam (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffar (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffa4 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffa5 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__hirq_pol (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__spi_edge (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_fce (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_drxb (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_phe (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_rsde (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__fcs_int2f (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__phr_mode (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_stxp (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) o2 (rec__dw1000__register_types__sys_cfg_type__rxwtoe (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__rxautr (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__autoack (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__aackpend (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__reserved_1 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__reserved_2 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__)))))))))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= o4 (mk___rep o3))))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= o5 (mk___split_fields4 (rec__decadriver__driver_type__part_id (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__lot_id (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__xtal_trim (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__long_frames (us_split_fields9 (driver_type__content self__))) o4 (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields9 (driver_type__content self__)))))))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= o6 (mk___rep4 o5))))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= result1 self__)))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= (let ((subject self__)) self__1) o6)))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= (to_rep9 o7) (bvudiv (to_rep9 lde_repc_reg__split_fields1) #x0008))))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= o7 o8)))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= temp___5200 o8)))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= result2 lde_repc_reg__split_fields1)))
(assert (=> (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0) (= lde_repc_reg__split_fields2 (mk___split_fields3 temp___5200))))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= (to_rep o9) #x00)))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= o10 (mk___split_fields (rec__dw1000__register_types__sys_cfg_type__ffen (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffbc (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffab (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffad (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffaa (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffam (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffar (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffa4 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__ffa5 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__hirq_pol (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__spi_edge (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_fce (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_drxb (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_phe (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_rsde (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__fcs_int2f (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__phr_mode (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__dis_stxp (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) o9 (rec__dw1000__register_types__sys_cfg_type__rxwtoe (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__rxautr (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__autoack (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__aackpend (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__reserved_1 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__))))) (rec__dw1000__register_types__sys_cfg_type__reserved_2 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (driver_type__content self__)))))))))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= o11 (mk___rep o10))))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= o12 (mk___split_fields4 (rec__decadriver__driver_type__part_id (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__lot_id (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__xtal_trim (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__long_frames (us_split_fields9 (driver_type__content self__))) o11 (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields9 (driver_type__content self__))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields9 (driver_type__content self__)))))))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= o13 (mk___rep4 o12))))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= result3 self__)))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= (let ((subject self__)) self__2) o13)))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= (let ((subject self__)) (mk_driver_type__ref self__1)) (let ((subject self__)) (mk_driver_type__ref self__2)))))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= lde_repc_reg__split_fields2 lde_repc_reg__split_fields3)))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= self__1 self__2)))
(assert (=> (not (= (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))) 0)) (= lde_repc_reg__split_fields2 lde_repc_reg__split_fields3)))
(assert (= result4 (let ((subject self__)) (mk_driver_type__ref self__1))))
(assert (= (let ((subject self__)) self__3) (mk___rep4 (mk___split_fields4 (rec__decadriver__driver_type__part_id (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__lot_id (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__xtal_trim (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields9 (let ((subject self__)) self__1))) (ite (= (to_rep17 (rec__decadriver__configuration_type__phr_mode (us_split_fields11 config))) 1) true false) (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields9 (let ((subject self__)) self__1))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields9 (let ((subject self__)) self__1)))))))
(assert (and (= o14 (to_rep17 (rec__decadriver__configuration_type__phr_mode (us_split_fields11 config)))) (in_range_int1 (to_rep17 (rec__decadriver__configuration_type__phr_mode (us_split_fields11 config))))))
(assert (= o15 ((_ int2bv 8) o14)))
(assert (= (to_rep1 o16) o15))
(assert (= o17 (mk___split_fields (rec__dw1000__register_types__sys_cfg_type__ffen (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffbc (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffab (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffad (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffaa (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffam (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffar (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffa4 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__ffa5 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__hirq_pol (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__spi_edge (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__dis_fce (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__dis_drxb (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__dis_phe (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__dis_rsde (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__fcs_int2f (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) o16 (rec__dw1000__register_types__sys_cfg_type__dis_stxp (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__rxm110k (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__rxwtoe (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__rxautr (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__autoack (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__aackpend (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__reserved_1 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))) (rec__dw1000__register_types__sys_cfg_type__reserved_2 (us_split_fields1 (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields9 (let ((subject self__)) self__3))))))))
(assert (= o18 (mk___rep o17)))
(assert (= o19 (mk___split_fields4 (rec__decadriver__driver_type__part_id (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__lot_id (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__xtal_trim (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__long_frames (us_split_fields9 (let ((subject self__)) self__3))) o18 (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_phr_error (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_rs_error (us_split_fields9 (let ((subject self__)) self__3))) (rec__decadriver__driver_type__detect_fcs_error (us_split_fields9 (let ((subject self__)) self__3))))))
(assert (= o20 (mk___rep4 o19)))
(assert (= result5 (let ((subject self__)) (mk_driver_type__ref self__3))))
(assert (= (let ((subject self__)) self__4) o20))
(assert (=> (= (to_rep18 (rec__decadriver__configuration_type__sfd_timeout (us_split_fields11 config))) 0) (= o21 4161)))
(assert (=> (not (= (to_rep18 (rec__decadriver__configuration_type__sfd_timeout (us_split_fields11 config))) 0)) (= o21 (to_rep18 (rec__decadriver__configuration_type__sfd_timeout (us_split_fields11 config))))))
(assert (= result6 (mk_int__ref sfd_timeout)))
(assert (= sfd_timeout1 o21))
(assert (=> (not (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 config)) true)) (= device_state1 device_state)))
(assert (= (to_rep8 o22) #x0000))
(assert (= (to_rep3 o23) ((_ int2bv 8) (to_rep16 (rec__decadriver__configuration_type__rx_preamble_code (us_split_fields11 config))))))
(assert (= (to_rep3 o24) ((_ int2bv 8) (to_rep16 (rec__decadriver__configuration_type__tx_preamble_code (us_split_fields11 config))))))
(assert (=> (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 config)) true) (= (to_rep o25) #x01)))
(assert (=> (not (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 config)) true)) (= (to_rep o25) #x00)))
(assert (=> (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 config)) true) (= (to_rep o26) #x01)))
(assert (=> (not (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 config)) true)) (= (to_rep o26) #x00)))
(assert (=> (= (to_rep13 (rec__decadriver__configuration_type__prf (us_split_fields11 config))) 0) (= (to_rep1 o27) #x01)))
(assert (=> (not (= (to_rep13 (rec__decadriver__configuration_type__prf (us_split_fields11 config))) 0)) (= (to_rep1 o27) #x02)))
(assert (=> (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 config)) true) (= (to_rep o28) #x01)))
(assert (=> (not (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields11 config)) true)) (= (to_rep o28) #x00)))
(assert (= (to_rep7 o29) ((_ int2bv 8) (to_rep12 (rec__decadriver__configuration_type__channel (us_split_fields11 config))))))
(assert (= (to_rep7 o30) ((_ int2bv 8) (to_rep12 (rec__decadriver__configuration_type__channel (us_split_fields11 config))))))
(assert (= o30 o31))
(assert (= o29 o32))
(assert (= o28 o33))
(assert (= o27 o34))
...
(assert (= o47 o38))
(assert (= o48 o39))
(assert (= (to_rep5 o49) #x00))
(assert (= (to_rep6 o50) #x0000))
(assert (=> (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 0)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 4)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 7))) (= (to_rep1 o51) #x00)))
(assert (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 0)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 4)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 7)))) (=> (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 1)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 5)) (= (to_rep1 o51) #x01))))
(assert (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 0)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 4)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 7)))) (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 1)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 5))) (=> (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 2)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 6)) (= (to_rep1 o51) #x02)))))
(assert (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 0)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 4)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 7)))) (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 1)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 5))) (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 2)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 6))) (= (to_rep1 o51) #x03)))))
(assert (=> (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 0)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 1)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 2)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 3)))) (= (to_rep1 o52) #x01)))
(assert (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 0)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 1)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 2)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 3))))) (=> (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 4)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 5)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 6))) (= (to_rep1 o52) #x02))))
(assert (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 0)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 1)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 2)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 3))))) (=> (not (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 4)) (=> (not (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 5)) (= (to_rep14 (rec__decadriver__configuration_type__tx_preamble_length (us_split_fields11 config))) 6)))) (= (to_rep1 o52) #x03))))
(assert (=> (= (to_rep13 (rec__decadriver__configuration_type__prf (us_split_fields11 config))) 0) (= (to_rep1 o53) #x01)))
(assert (=> (not (= (to_rep13 (rec__decadriver__configuration_type__prf (us_split_fields11 config))) 0)) (= (to_rep1 o53) #x02)))
(assert (= (to_rep o54) #x01))
(assert (not (in_range_int1 (to_rep11 (rec__decadriver__configuration_type__data_rate (us_split_fields11 config))))))
(check-sat)
(exit)
