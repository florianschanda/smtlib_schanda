...
(define-fun dynamic_invariant ((temp___expr_4329 Int) (temp___is_init_4326 Bool) (temp___skip_constant_4327 Bool) (temp___do_toplevel_4328 Bool)) Bool (and (=> (or (= temp___is_init_4326 true) (<= 1 7)) (in_range10 temp___expr_4329)) (=> (= temp___do_toplevel_4328 true) (=> (= temp___is_init_4326 true) (or (and (<= 1 temp___expr_4329) (<= temp___expr_4329 5)) (and (<= 7 temp___expr_4329) (<= temp___expr_4329 7)))))))
(define-fun dynamic_predicate ((temp___4333 Int)) Bool (or (and (<= 1 temp___4333) (<= temp___4333 5)) (and (<= 7 temp___4333) (<= temp___4333 7))))
...
(define-fun dynamic_invariant1 ((temp___expr_4368 Int) (temp___is_init_4365 Bool) (temp___skip_constant_4366 Bool) (temp___do_toplevel_4367 Bool)) Bool (=> (or (= temp___is_init_4365 true) (<= 0 65535)) (in_range16 temp___expr_4368)))
...
(define-fun us_rep___137__projection ((a us_rep4)) us_split_fields8 (us_split_fields9 a))
...
(define-fun dynamic_invariant2 ((temp___expr_4388 us_rep4) (temp___is_init_4385 Bool) (temp___skip_constant_4386 Bool) (temp___do_toplevel_4387 Bool)) Bool (=> (= temp___is_init_4385 true) (let ((temp___4390 (to_rep11 (rec__decadriver__configuration_type__channel (us_split_fields9 temp___expr_4388))))) (or (and (<= 1 temp___4390) (<= temp___4390 5)) (and (<= 7 temp___4390) (<= temp___4390 7))))))
...
(assert (forall ((temp___4502 (_ BitVec 32))) (forall ((temp___4503 Int)) (= (select (temp___4500 temp___4502) temp___4503) (of_rep18 temp___4502)))))
(define-fun default_initial_assumption ((temp___expr_4498 us_rep5) (temp___skip_top_level_4499 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep18 (rec__decadriver__driver_type__part_id (us_split_fields11 temp___expr_4498))) ((_ int2bv 32) 0)) (= (to_rep18 (rec__decadriver__driver_type__lot_id (us_split_fields11 temp___expr_4498))) ((_ int2bv 32) 0))) (= (to_rep9 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields11 temp___expr_4498))) ((_ int2bv 16) 0))) (= (to_rep9 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields11 temp___expr_4498))) ((_ int2bv 16) 0))) (= (to_rep4 (rec__decadriver__driver_type__xtal_trim (us_split_fields11 temp___expr_4498))) ((_ int2bv 8) 16))) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields11 temp___expr_4498)) (temp___4500 ((_ int2bv 32) 0)))) (= (rec__decadriver__driver_type__long_frames (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields11 temp___expr_4498)) (mk___rep (mk___split_fields (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep1 ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep2 ((_ int2bv 8) 0)) (of_rep4 ((_ int2bv 8) 0)))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields11 temp___expr_4498)) (of_int 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_4362 Int) (temp___is_init_4359 Bool) (temp___skip_constant_4360 Bool) (temp___do_toplevel_4361 Bool)) Bool (=> (or (= temp___is_init_4359 true) (<= 0 1)) (in_range15 temp___expr_4362)))
...
(define-fun dynamic_invariant15 ((temp___expr_4323 Int) (temp___is_init_4320 Bool) (temp___skip_constant_4321 Bool) (temp___do_toplevel_4322 Bool)) Bool (=> (or (= temp___is_init_4320 true) (<= 0 2)) (in_range9 temp___expr_4323)))
(define-fun dynamic_invariant16 ((temp___expr_4338 Int) (temp___is_init_4335 Bool) (temp___skip_constant_4336 Bool) (temp___do_toplevel_4337 Bool)) Bool (=> (or (= temp___is_init_4335 true) (<= 0 1)) (in_range11 temp___expr_4338)))
(define-fun dynamic_invariant17 ((temp___expr_4344 Int) (temp___is_init_4341 Bool) (temp___skip_constant_4342 Bool) (temp___do_toplevel_4343 Bool)) Bool (=> (or (= temp___is_init_4341 true) (<= 0 7)) (in_range12 temp___expr_4344)))
(define-fun dynamic_invariant18 ((temp___expr_4350 Int) (temp___is_init_4347 Bool) (temp___skip_constant_4348 Bool) (temp___do_toplevel_4349 Bool)) Bool (=> (or (= temp___is_init_4347 true) (<= 0 3)) (in_range13 temp___expr_4350)))
(define-fun dynamic_invariant19 ((temp___expr_4356 Int) (temp___is_init_4353 Bool) (temp___skip_constant_4354 Bool) (temp___do_toplevel_4355 Bool)) Bool (=> (or (= temp___is_init_4353 true) (<= 1 24)) (in_range14 temp___expr_4356)))
...
(assert (=> (= (to_rep10 (rec__decadriver__configuration_type__data_rate (us_split_fields9 config))) 0) (= temp___4657 o8)))
...
(assert (=> (= (to_rep10 (rec__decadriver__configuration_type__data_rate (us_split_fields9 config))) 0) (= lde_repc_reg__split_fields2 (mk___split_fields3 temp___4657))))
...
(assert (=> (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields9 config)) true) (= (to_rep o25) ((_ int2bv 8) 1))))
(assert (=> (not (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields9 config)) true)) (= (to_rep o25) ((_ int2bv 8) 0))))
(assert (=> (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields9 config)) true) (= (to_rep o26) ((_ int2bv 8) 1))))
(assert (=> (not (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields9 config)) true)) (= (to_rep o26) ((_ int2bv 8) 0))))
(assert (=> (= (to_rep12 (rec__decadriver__configuration_type__prf (us_split_fields9 config))) 0) (= (to_rep1 o27) ((_ int2bv 8) 1))))
(assert (=> (not (= (to_rep12 (rec__decadriver__configuration_type__prf (us_split_fields9 config))) 0)) (= (to_rep1 o27) ((_ int2bv 8) 2))))
(assert (=> (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields9 config)) true) (= (to_rep o28) ((_ int2bv 8) 1))))
(assert (=> (not (= (rec__decadriver__configuration_type__use_nonstandard_sfd (us_split_fields9 config)) true)) (= (to_rep o28) ((_ int2bv 8) 0))))
