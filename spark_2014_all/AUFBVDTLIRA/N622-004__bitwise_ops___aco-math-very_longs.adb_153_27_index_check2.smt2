...
(assert (<= 1 i1))
(assert (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))
(assert (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(assert (= o2 i2))
(assert (= o3 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))) o2)))
...
(assert (= o i2))
(assert (= o1 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))) o)))
(assert (= o5 (to_rep1 o1)))
(assert (= result2 (ite (bvult o5 o4) true false)))
(assert (not (= result2 true)))
(assert (= result__3 result__2))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(assert (= o6 i2))
(assert (= o7 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))) o6)))
