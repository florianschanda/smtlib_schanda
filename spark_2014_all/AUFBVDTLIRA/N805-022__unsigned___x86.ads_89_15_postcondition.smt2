...
(assert (forall ((x unsigned_8)) (! (uint_in_range3 (to_int6 x)) :pattern ((to_int6 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_149 (_ BitVec 16)) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool true)
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned_8))) (! (=> (dynamic_invariant addr true true true) (let ((result (readmem16 addr x86__memory))) (and (and (= result (bvadd ((_ zero_extend 8) (to_rep (select x86__memory addr))) (bvmul ((_ zero_extend 8) (to_rep (select x86__memory (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 16) 256)))) (bvuge result ((_ int2bv 16) 0))) (dynamic_invariant1 result true false true)))) :pattern ((readmem16 addr x86__memory))))))
...
(assert (and (= o1 (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) (and (= o1 (bvadd ((_ zero_extend 8) (to_rep (select memory (bvadd addr ((_ int2bv 64) 2))))) (bvmul ((_ zero_extend 8) (to_rep (select memory (bvadd (bvadd addr ((_ int2bv 64) 2)) ((_ int2bv 64) 1))))) ((_ int2bv 16) 256)))) (bvuge o1 ((_ int2bv 16) 0)))))
(assert (= o2 ((_ zero_extend 16) o1)))
(assert (= o3 (bvmul o2 ((_ int2bv 32) 65536))))
(assert (and (= o (readmem16 addr memory)) (and (= o (bvadd ((_ zero_extend 8) (to_rep (select memory addr))) (bvmul ((_ zero_extend 8) (to_rep (select memory (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 16) 256)))) (bvuge o ((_ int2bv 16) 0)))))
...
(assert (not (= x86__readmem32__result4 (bvadd ((_ zero_extend 16) (readmem16 addr memory)) (bvmul ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 65536))))))
(check-sat)
(exit)
