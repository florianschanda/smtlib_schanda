...
(define-fun result____split_fields2 () us_split_fields (mk___split_fields result____split_fields1))
...
(assert (= result____split_fields2 find_map__index_maps__clear__container__fields1))
...
(assert (and (= o (has_key (model__ (mk___rep result____split_discrs result____split_fields2)) (to_rep (select (elts a) k1)))) (= (= o true) (= (has_key (model__ (mk___rep result____split_discrs result____split_fields2)) (to_rep (select (elts a) k1))) true))))
(assert (= result2 (ite (not (= o true)) true false)))
(assert (= result2 true))
(assert (and (= o1 k1) (in_range5 k1)))
(assert (not (< (length1 (mk___rep result____split_discrs result____split_fields2)) (to_rep3 (rec__find_map__index_maps__map__capacity result____split_discrs)))))
(check-sat)
(exit)
