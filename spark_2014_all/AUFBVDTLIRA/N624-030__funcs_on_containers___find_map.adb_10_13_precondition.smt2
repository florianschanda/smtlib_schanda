...
(assert (= result2 true))
(assert (and (= o1 k1) (in_range5 k1)))
(assert (not (< (length1 (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (to_rep3 (rec__find_map__index_maps__map__capacity result____split_discrs)))))
(check-sat)
(exit)
