...
(assert (not (= (ite (<= (to_rep1 (first temp___2591)) (to_rep1 (last temp___2591))) (+ (- (to_rep1 (last temp___2591)) (to_rep1 (first temp___2591))) 1) 0) (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last)) (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0))))
(check-sat)
(exit)
