...
(assert (and (= o81 (base Tuple0)) (= o81 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (= o80 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o79)))
...
(assert (and (= o62 (base Tuple0)) (= o62 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
