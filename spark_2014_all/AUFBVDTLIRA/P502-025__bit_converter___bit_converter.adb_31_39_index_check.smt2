...
(define-fun dynamic_invariant ((temp___expr_159 (_ BitVec 8)) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_166 (_ BitVec 8)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (bvule #x00 #x01)) (in_range1 temp___expr_166)))
...
(assert (forall ((bool__ Bool)) (! (dynamic_invariant1 (to_number bool__) true false true true) :pattern ((to_number bool__)))))
...
(assert (and (=> (bvule #x00 #x01) (in_range1 bit2)) (and (<= (+ first_index 1) i2) (<= i2 last_index))))
(assert (= result4 bits3))
(assert (= bits4 (bvmul bits3 #x02)))
