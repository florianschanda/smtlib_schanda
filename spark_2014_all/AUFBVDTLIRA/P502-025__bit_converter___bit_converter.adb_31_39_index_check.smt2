...
(declare-const dummy modular_type)
...
(define-fun dynamic_invariant ((temp___expr_136 (_ BitVec 8)) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool true)
...
(declare-const dummy1 zero_or_one)
...
(define-fun dynamic_invariant1 ((temp___expr_142 (_ BitVec 8)) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range1 temp___expr_142)))
...
(define-fun dynamic_invariant2 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 8)) (in_range2 temp___expr_148)))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int2 (select a (+ i 1))) (to_int2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int2 (select b (+ i 1))) (to_int2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant3 ((temp___expr_154 us_t) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (not (= temp___skip_constant_152 true)) (dynamic_property 1 8 (first1 temp___expr_154) (last1 temp___expr_154))))
(declare-fun to_number (Bool) (_ BitVec 8))
(declare-fun to_number__function_guard ((_ BitVec 8) Bool) Bool)
(assert (forall ((bool__ Bool)) (! (dynamic_invariant1 (to_number bool__) true false true) :pattern ((to_number bool__)))))
...
(declare-const bit2 (_ BitVec 8))
(declare-const result2 (_ BitVec 8))
(declare-const bits2 (_ BitVec 8))
(declare-const result3 Int)
(declare-const i1 Int)
(declare-const bits3 (_ BitVec 8))
(declare-const bit3 (_ BitVec 8))
(declare-const i2 Int)
(declare-const result4 (_ BitVec 8))
(declare-const bits4 (_ BitVec 8))
...
(assert (= bits2 (bvor bits1 bit2)))
(assert (= result3 i))
(assert (= i1 (+ first_index 1)))
(assert (<= (+ first_index 1) i1))
(assert (<= i1 last_index))
(assert (and (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1)) (in_range1 bit3)) (and (<= (+ first_index 1) i2) (<= i2 last_index))))
(assert (= result4 bits3))
(assert (= bits4 (bvmul bits3 ((_ int2bv 8) 2))))
(assert (not (<= (to_rep (first (rt array_of_bits))) i2)))
(check-sat)
(exit)
