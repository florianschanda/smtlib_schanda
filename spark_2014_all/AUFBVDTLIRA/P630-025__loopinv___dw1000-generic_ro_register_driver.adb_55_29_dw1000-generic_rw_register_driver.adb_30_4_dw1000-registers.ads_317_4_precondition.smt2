...
(define-fun dynamic_invariant ((temp___expr_3684 us_t1) (temp___is_init_3681 Bool) (temp___skip_constant_3682 Bool) (temp___do_toplevel_3683 Bool)) Bool (=> (not (= temp___skip_constant_3682 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3684) (last3 temp___expr_3684)) (and (= (first3 temp___expr_3684) 1) (= (last3 temp___expr_3684) 4)))))
