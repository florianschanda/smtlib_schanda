...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_173)))
...
(declare-fun temp___347 ((_ BitVec 8)) (Array Int byte))
...
(assert (forall ((temp___345 (_ BitVec 8))) (=> (dynamic_invariant4 temp___345 true true true true) (forall ((temp___346 Int)) (= (to_rep1 (select (main__arr__aggregate_def temp___345) temp___346)) temp___345)))))
...
(assert (forall ((temp___349 (_ BitVec 8))) (=> (dynamic_invariant4 temp___349 true true true true) (forall ((temp___350 Int)) (= (to_rep1 (select (temp___347 temp___349) temp___350)) temp___349)))))
