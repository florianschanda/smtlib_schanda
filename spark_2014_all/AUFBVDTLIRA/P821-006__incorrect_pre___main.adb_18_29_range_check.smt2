...
(define-fun dynamic_invariant ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_148)))
...
(define-fun dynamic_invariant1 ((temp___expr_208 us_t) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (not (= temp___skip_constant_206 true)) (dynamic_property 0 2147483647 (first1 temp___expr_208) (last1 temp___expr_208))))
...
(assert (forall ((bytes us_t)) (! (=> (and (dynamic_invariant1 bytes true true true) (= (length bytes) 4)) (dynamic_invariant (tointeger_32 bytes) true false true)) :pattern ((tointeger_32 bytes)))))
(assert (forall ((bytes us_t)) (! (=> (dynamic_invariant1 bytes true true true) (= (tointeger_32 bytes) (from_byte_array_to_integer_32 (slide (to_array bytes) (first1 bytes) 1)))) :pattern ((tointeger_32 bytes)))))
...
(assert (forall ((temp___298 (_ BitVec 8))) (forall ((temp___299 Int)) (= (select (main__arr__aggregate_def temp___298) temp___299) (of_rep1 temp___298)))))
(declare-fun temp___300 ((_ BitVec 8)) (Array Int byte))
(assert (forall ((temp___302 (_ BitVec 8))) (forall ((temp___303 Int)) (= (select (temp___300 temp___302) temp___303) (of_rep1 temp___302)))))
...
(define-fun dynamic_invariant4 ((temp___expr_202 (_ BitVec 8)) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_236)))
(assert (forall ((s (Array Int byte))) (! (dynamic_invariant5 (from_byte_array_to_integer_32 s) true false true) :pattern ((from_byte_array_to_integer_32 s)))))
