...
(define-fun dynamic_invariant ((temp___expr_5604 us_t1) (temp___is_init_5601 Bool) (temp___skip_constant_5602 Bool) (temp___do_toplevel_5603 Bool)) Bool (=> (not (= temp___skip_constant_5602 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5604) (last3 temp___expr_5604)) (and (= (first3 temp___expr_5604) 1) (= (last3 temp___expr_5604) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5620 us_t2) (temp___is_init_5617 Bool) (temp___skip_constant_5618 Bool) (temp___do_toplevel_5619 Bool)) Bool (=> (not (= temp___skip_constant_5618 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5620) (last5 temp___expr_5620)) (and (= (first5 temp___expr_5620) 1) (= (last5 temp___expr_5620) 1)))))
...
(assert (and (= (mk___t2 temp___8034 temp___80341) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8034 temp___80341) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80341)) (to_rep (last4 temp___80341))) (+ (- (to_rep (last4 temp___80341)) (to_rep (first4 temp___80341))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
