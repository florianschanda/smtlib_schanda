...
(define-fun register_type__ref___148__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___105__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___105__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6160 us_t1) (temp___is_init_6156 Bool) (temp___skip_constant_6157 Bool) (temp___do_toplevel_6158 Bool) (temp___do_typ_inv_6159 Bool)) Bool (=> (not (= temp___skip_constant_6157 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6160) (last3 temp___expr_6160)) (and (= (first3 temp___expr_6160) 1) (= (last3 temp___expr_6160) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___44__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___44__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_6178 us_t2) (temp___is_init_6174 Bool) (temp___skip_constant_6175 Bool) (temp___do_toplevel_6176 Bool) (temp___do_typ_inv_6177 Bool)) Bool (=> (not (= temp___skip_constant_6175 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6178) (last5 temp___expr_6178)) (and (= (first5 temp___expr_6178) 1) (= (last5 temp___expr_6178) 1)))))
...
(declare-const temp___8806 (Array Int bits_8))
(declare-const temp___88061 t2)
(define-fun temp___88062 () us_t2 (mk___t2 temp___8806 temp___88061))
...
(assert (and (= temp___88062 (register_to_bytes reg)) (dynamic_invariant1 temp___88062 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___88061)) (to_rep (last4 temp___88061))) (+ (- (to_rep (last4 temp___88061)) (to_rep (first4 temp___88061))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
