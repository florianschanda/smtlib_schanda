...
(assert (and (and (and (= us (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (and (and (= us1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))) (and (and (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r8b) (in_range2 r8b)) (and (and (and (and (and (and (and (and (= (to_rep2 (first4 (rt2 (temp___1379 ((_ int2bv 8) 0) 1 r8b)))) 1) (and (= (to_rep2 (last4 (rt2 (temp___1379 ((_ int2bv 8) 0) 1 r8b)))) r8b) (= (mk___t2 temp___1386 temp___13861) (temp___1379 ((_ int2bv 8) 0) 1 r8b)))) (and (= (ite (<= (to_rep2 (first4 temp___13861)) (to_rep2 (last4 temp___13861))) (+ (- (to_rep2 (last4 temp___13861)) (to_rep2 (first4 temp___13861))) 1) 0) (ite (<= 1 r8b) (+ (- r8b 1) 1) 0)) (and (= temp___1386 temp___1387) (= (mk1 (to_rep2 (first4 temp___13861)) (to_rep2 (last4 temp___13861))) temp___13871)))) (and (= (ite (<= (to_rep2 (first2 temp___13871)) (to_rep2 (last2 temp___13871))) (+ (- (to_rep2 (last2 temp___13871)) (to_rep2 (first2 temp___13871))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)) (= (mk___t1 temp___1389 temp___13891) (mk___t1 temp___1387 temp___13871)))) (and (= temp___1389 o) (= (mk (to_rep2 (first2 temp___13891)) (to_rep2 (last2 temp___13891))) o1))) (and (= o2 o) (= o3 o1))) (and (= result____split_discrs (mk___split_discrs temp___1391)) (and (= temp___13911 o2) (= temp___13912 o3)))) (and (and (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))) (= result____split_fields2 (mk___split_fields (mk___t temp___13911 temp___13912)))) (= result____split_discrs (mk___split_discrs temp___1391)))) (and (and (= result1 (mk_t__ref1 carry)) (= carry1 ((_ int2bv 16) 0))) (and (and (= result2 (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (and (and (= temp___1403 sum) (and (= temp___1402 r_digit) (and (= temp___1401 carry1) (and (= temp___1400 l_digit) (and (and (= result____split_discrs (mk___split_discrs temp___1397)) (= result____split_fields2 (mk___split_fields (mk___t temp___13971 temp___13972)))) (and (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true) (and (= (rec__aco__math__very_longs__very_long__octet_length result____split_discrs) temp___1397) (forall ((temp___1399 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1399) (<= temp___1399 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1399) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1399) (select temp___13971 temp___1399))))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o4 i2)) (= o5 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))) o4))) (= o6 (to_rep o5))) (= o7 ((_ zero_extend 8) o6))) (and (= result3 (mk_t__ref1 l_digit2)) (= l_digit3 o7))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o8 i2)) (= o9 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))) o8))) (= o10 (to_rep o9))) (= o11 ((_ zero_extend 8) o10))) (and (= result4 (mk_t__ref1 r_digit2)) (= r_digit3 o11))) (and (and (= result5 (mk_t__ref1 sum2)) (= sum3 (bvadd (bvadd l_digit3 r_digit3) carry2))) (and (and (and (= o12 (shift_right sum3 8)) (= o12 (bvudiv sum3 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))) (and (= result6 (mk_t__ref1 carry2)) (= carry3 o12))) (and (and (and (and (and (and (and (= o13 (takelsb_from16 sum3)) (= (to_rep o14) o13)) (and (and (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (= o15 i2)) (= o16 (store (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o15 o14)))) (= o17 (mk___t o16 (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3))))) (= o18 (mk___split_fields o17))) (= temp___1396 (mk___rep result____split_discrs o18))) (and (and (= result7 (mk___split_fields__ref result____split_fields3)) (= result____split_fields4 (us_split_fields1 temp___1396))) (= result____split_discrs (us_split_discrs1 temp___1396)))) (= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))))))))))))) (and (and (= i3 (mk_int__ref i2)) (and (= sum4 (mk_t__ref1 sum3)) (and (= r_digit4 (mk_t__ref1 r_digit3)) (and (= l_digit4 (mk_t__ref1 l_digit3)) (and (= carry4 (mk_t__ref1 carry3)) (= result____split_fields5 (mk___split_fields__ref result____split_fields4))))))) (and (= i4 i2) (and (= sum5 sum3) (and (= r_digit5 r_digit3) (and (= l_digit5 l_digit3) (and (= carry5 carry3) (= result____split_fields6 result____split_fields4)))))))) (and (and (= i5 i3) (and (= sum6 sum4) (and (= r_digit6 r_digit4) (and (= l_digit6 l_digit4) (and (= carry6 carry4) (= result____split_fields7 result____split_fields5)))))) (and (= i6 i4) (and (= sum7 sum5) (and (= r_digit7 r_digit5) (and (= l_digit7 l_digit5) (and (= carry7 carry5) (= result____split_fields8 result____split_fields6)))))))) (and (and (= i5 (mk_int__ref i1)) (and (= sum6 (mk_t__ref1 sum)) (and (= r_digit6 (mk_t__ref1 r_digit)) (and (= l_digit6 (mk_t__ref1 l_digit)) (and (= carry6 (mk_t__ref1 carry1)) (= result____split_fields7 (mk___split_fields__ref result____split_fields2))))))) (and (= i6 i1) (and (= sum7 sum1) (and (= r_digit7 r_digit1) (and (= l_digit7 l_digit1) (and (= carry7 carry1) (= result____split_fields8 result____split_fields2)))))))))))))) (and (and (= i7 i5) (and (= sum8 sum6) (and (= r_digit8 r_digit6) (and (= l_digit8 l_digit6) (and (= carry8 carry6) (= result____split_fields9 result____split_fields7)))))) (and (= i8 i6) (and (= sum9 sum7) (and (= r_digit9 r_digit7) (and (= l_digit9 l_digit7) (and (= carry9 carry7) (= result____split_fields10 result____split_fields8)))))))))
