...
(define-fun dynamic_invariant ((temp___expr_298 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool) (temp___do_typ_inv_297 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 0 10)) (in_range2 temp___expr_298)))
...
(define-fun dynamic_invariant1 ((temp___expr_305 Int) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool (=> (or (= temp___is_init_301 true) (<= 1 256)) (in_range3 temp___expr_305)))
...
(declare-fun to_rep1 (unsigned8) (_ BitVec 8))
(declare-fun of_rep1 ((_ BitVec 8)) unsigned8)
(assert (forall ((x unsigned8)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert true)
(assert (forall ((x (_ BitVec 8))) (! (= (to_rep1 (of_rep1 x)) x) :pattern ((to_rep1 (of_rep1 x))))))
(define-fun to_int2 ((x unsigned8)) Int (bv2nat (to_rep1 x)))
...
(declare-const temp___1864 query_type)
(declare-const temp___18641 unsigned8)
(declare-const temp___18642 unsigned8)
(declare-const temp___18643 unsigned32)
(declare-const temp___18644 unsigned32)
(declare-const temp___18645 unsigned32)
(declare-const temp___18646 unsigned16)
(declare-const temp___18647 (Array Int character))
(declare-const temp___18648 (Array Int character))
(declare-const temp___18649 siglengthvaluetype)
(declare-const temp___186410 unsigned32)
(declare-const temp___186411 classtype)
(declare-const temp___186412 us_private)
(declare-const temp___186413 Int)
...
(define-fun rrsig_rec__split_fields39 () us_split_fields2 (mk___split_fields1 rrsig_rec__split_fields26 rrsig_rec__split_fields27 rrsig_rec__split_fields28 rrsig_rec__split_fields29 rrsig_rec__split_fields30 rrsig_rec__split_fields31 rrsig_rec__split_fields32 rrsig_rec__split_fields33 rrsig_rec__split_fields34 rrsig_rec__split_fields35 rrsig_rec__split_fields36 rrsig_rec__split_fields37 rrsig_rec__split_fields38))
(define-fun rrsig_rec__split_fields40 () us_split_fields2 (mk___split_fields1 rrsig_rec__split_fields13 rrsig_rec__split_fields14 rrsig_rec__split_fields15 rrsig_rec__split_fields16 rrsig_rec__split_fields17 rrsig_rec__split_fields18 rrsig_rec__split_fields19 rrsig_rec__split_fields20 rrsig_rec__split_fields21 rrsig_rec__split_fields22 rrsig_rec__split_fields23 rrsig_rec__split_fields24 rrsig_rec__split_fields25))
(assert (in_range3 zlength))
(assert (in_range3 endidx))
...
(assert (=> (= success1 true) (and (= o (+ endidx 1)) (in_range3 (+ endidx 1)))))
(assert (=> (= success1 true) (= (mk_int__ref result1) (mk_int__ref begidx))))
(assert (=> (= success1 true) (= begidx2 o)))
(assert (=> (= success1 true) (and (and (and (and (<= begidx3 endidx2) (<= begidx3 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i Int)) (=> (and (<= begidx3 i) (<= i endidx2)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range3 begidx3) (in_range3 endidx2)) (in_range2 foundtype2)))))
...
(assert (=> (= success1 true) (=> (= success2 true) (= temp___1864 o3))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18641 o4))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18642 o5))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18643 o6))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18644 o7))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18645 o8))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18646 o9))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18647 o10))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18648 o11))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18649 o12))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___186410 o13))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___186411 o14))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___186412 o15))))
(assert (=> (= success1 true) (=> (= success2 true) (= rrsig_rec__attr__tag temp___186413))))
...
(assert (=> (= success1 true) (=> (= success2 true) (= temp___1864 rrsig_rec__split_fields26))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18641 rrsig_rec__split_fields27))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18642 rrsig_rec__split_fields28))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18643 rrsig_rec__split_fields29))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18644 rrsig_rec__split_fields30))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18645 rrsig_rec__split_fields31))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18646 rrsig_rec__split_fields32))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18647 rrsig_rec__split_fields33))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18648 rrsig_rec__split_fields34))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___18649 rrsig_rec__split_fields35))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___186410 rrsig_rec__split_fields36))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___186411 rrsig_rec__split_fields37))))
(assert (=> (= success1 true) (=> (= success2 true) (= temp___186412 rrsig_rec__split_fields38))))
...
(assert (=> (= success1 true) (=> (not (= success2 true)) (= rrsig_rec__split_fields39 rrsig_rec__split_fields40))))
