...
(define-fun dynamic_invariant1 ((temp___expr_223 (_ BitVec 64)) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_217 (_ BitVec 32)) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool true)
...
(assert (and (= temp___752 (bv2nat (bvurem i ((_ int2bv 64) 32)))) (in_range2 (bv2nat (bvurem i ((_ int2bv 64) 32))))))
(assert (=> (< temp___752 4294967296) (= o7 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___752)))))
(assert (=> (not (< temp___752 4294967296)) (= o7 ((_ int2bv 32) 0))))
(assert (and (= o3 (bv2nat (bvudiv i ((_ int2bv 64) 32)))) (in_range2 (bv2nat (bvudiv i ((_ int2bv 64) 32))))))
(assert (= o4 (+ a_first o3)))
