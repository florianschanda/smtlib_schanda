...
(assert (=> (< temp___752 4294967296) (= o2 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___752)))))
(assert (=> (not (< temp___752 4294967296)) (= o2 ((_ int2bv 32) 0))))
(assert (and (= o (bv2nat (bvudiv i ((_ int2bv 64) 32)))) (in_range2 (bv2nat (bvudiv i ((_ int2bv 64) 32))))))
(assert (= o1 (+ a_first o)))
