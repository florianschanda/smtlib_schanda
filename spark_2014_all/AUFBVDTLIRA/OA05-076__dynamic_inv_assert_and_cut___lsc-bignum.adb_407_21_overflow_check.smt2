...
(define-fun dynamic_invariant5 ((temp___expr_253 (_ BitVec 32)) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool true)
(declare-const o Int)
...
(assert (and (= temp___822 (bv2nat (bvurem i #x0000000000000020))) (in_range2 (bv2nat (bvurem i #x0000000000000020)))))
(assert (=> (< temp___822 4294967296) (= o2 (bvshl #x00000001 ((_ int2bv 32) temp___822)))))
(assert (=> (not (< temp___822 4294967296)) (= o2 #x00000000)))
