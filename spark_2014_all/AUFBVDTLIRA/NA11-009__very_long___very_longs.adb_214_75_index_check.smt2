...
(assert (=> (< digit_count3 i2) (forall ((j1 Int)) (=> (and (<= (+ digit_count3 1) j1) (<= j1 i2)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) ((_ int2bv 8) 0))))))
