...
(assert (= i3 1))
(assert (<= 1 i3))
(assert (<= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
...
(assert (=> (= result3 true) (and (= o5 i3) (in_range1 i3))))
...
(assert (=> (< digit_count3 i4) (forall ((j1 Int)) (=> (and (<= (+ digit_count3 1) j1) (<= j1 i4)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) ((_ int2bv 8) 0))))))
