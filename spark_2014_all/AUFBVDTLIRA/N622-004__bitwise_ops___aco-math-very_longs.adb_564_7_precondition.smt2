...
(assert (forall ((l us_rep) (r us_rep)) (! (=> (and (and (dynamic_invariant l true true true true) (dynamic_invariant r true true true true)) (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (let ((result (modadd l r))) (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 result))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant result true false true true)))) :pattern ((modadd l r)))))
