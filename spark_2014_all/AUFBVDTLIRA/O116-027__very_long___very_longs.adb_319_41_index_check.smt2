...
(assert (= r_digit1 o11))
(assert (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r94b))
...
(assert (= temp___1046 (- o18 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1046) (<= temp___1046 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o19 temp___1046))
...
(assert (= temp___1048 (- o23 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1048)))
(check-sat)
(exit)
