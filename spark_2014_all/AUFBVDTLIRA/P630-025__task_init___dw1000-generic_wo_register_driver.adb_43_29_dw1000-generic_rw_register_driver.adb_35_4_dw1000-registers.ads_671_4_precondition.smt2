...
(define-fun dynamic_invariant ((temp___expr_7532 us_t1) (temp___is_init_7529 Bool) (temp___skip_constant_7530 Bool) (temp___do_toplevel_7531 Bool)) Bool (=> (not (= temp___skip_constant_7530 true)) (and (dynamic_property2 1 1 (first3 temp___expr_7532) (last3 temp___expr_7532)) (and (= (first3 temp___expr_7532) 1) (= (last3 temp___expr_7532) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7548 us_t2) (temp___is_init_7545 Bool) (temp___skip_constant_7546 Bool) (temp___do_toplevel_7547 Bool)) Bool (=> (not (= temp___skip_constant_7546 true)) (and (dynamic_property3 1 1 (first5 temp___expr_7548) (last5 temp___expr_7548)) (and (= (first5 temp___expr_7548) 1) (= (last5 temp___expr_7548) 1)))))
...
(declare-const temp___8234 (Array Int bits_8))
(declare-const temp___82341 t2)
(declare-const temp___8235 (Array Int bits_8))
(declare-const temp___82351 t1)
...
(define-fun temp___82342 () us_t2 (mk___t2 temp___8234 temp___82341))
...
(assert (and (= temp___82342 (register_to_bytes reg)) (dynamic_invariant1 temp___82342 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___82341)) (to_rep (last4 temp___82341))) (+ (- (to_rep (last4 temp___82341)) (to_rep (first4 temp___82341))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8234 temp___8235))
(assert (= (mk1 (to_rep (first4 temp___82341)) (to_rep (last4 temp___82341))) temp___82351))
(assert (= (ite (<= (to_rep (first2 temp___82351)) (to_rep (last2 temp___82351))) (+ (- (to_rep (last2 temp___82351)) (to_rep (first2 temp___82351))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8235 temp___82351)))
(assert (= o2 o))
