...
(define-fun dynamic_invariant ((temp___expr_5260 us_t1) (temp___is_init_5257 Bool) (temp___skip_constant_5258 Bool) (temp___do_toplevel_5259 Bool)) Bool (=> (not (= temp___skip_constant_5258 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5260) (last3 temp___expr_5260)) (and (= (first3 temp___expr_5260) 1) (= (last3 temp___expr_5260) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5276 us_t2) (temp___is_init_5273 Bool) (temp___skip_constant_5274 Bool) (temp___do_toplevel_5275 Bool)) Bool (=> (not (= temp___skip_constant_5274 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5276) (last5 temp___expr_5276)) (and (= (first5 temp___expr_5276) 1) (= (last5 temp___expr_5276) 1)))))
...
(declare-const temp___7993 (Array Int bits_8))
(declare-const temp___79931 t2)
(define-fun temp___79932 () us_t2 (mk___t2 temp___7993 temp___79931))
...
(assert (and (= temp___79932 (register_to_bytes reg)) (dynamic_invariant1 temp___79932 true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___79931)) (to_rep (last4 temp___79931))) (+ (- (to_rep (last4 temp___79931)) (to_rep (first4 temp___79931))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
