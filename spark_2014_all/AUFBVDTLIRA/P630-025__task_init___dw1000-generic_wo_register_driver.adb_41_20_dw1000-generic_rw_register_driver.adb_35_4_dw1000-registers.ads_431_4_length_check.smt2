...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh bits_8)))))
(define-fun us_split_fields_RF_RXCTRLH__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___55__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___55__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh__first__bit Int)
(declare-const dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh__last__bit Int)
(declare-const dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh__position Int)
(assert (<= 0 dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh__first__bit))
(assert (< dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh__first__bit dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh__last__bit))
(assert (<= 0 dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh__position))
(declare-fun user_eq4 (us_rep us_rep) Bool)
(declare-const dummy4 us_rep)
(declare-datatypes () ((rf_rxctrlh_type__ref (mk_rf_rxctrlh_type__ref (rf_rxctrlh_type__content us_rep)))))
(define-fun rf_rxctrlh_type__ref___projection ((a rf_rxctrlh_type__ref)) us_rep (rf_rxctrlh_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___130__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___92__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___92__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5775 us_t1) (temp___is_init_5771 Bool) (temp___skip_constant_5772 Bool) (temp___do_toplevel_5773 Bool) (temp___do_typ_inv_5774 Bool)) Bool (=> (not (= temp___skip_constant_5772 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5775) (last3 temp___expr_5775)) (and (= (first3 temp___expr_5775) 1) (= (last3 temp___expr_5775) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___39__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___39__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_5793 us_t2) (temp___is_init_5789 Bool) (temp___skip_constant_5790 Bool) (temp___do_toplevel_5791 Bool) (temp___do_typ_inv_5792 Bool)) Bool (=> (not (= temp___skip_constant_5790 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5793) (last5 temp___expr_5793)) (and (= (first5 temp___expr_5793) 1) (= (last5 temp___expr_5793) 1)))))
...
(declare-const temp___8765 (Array Int bits_8))
(declare-const temp___87651 t2)
(define-fun temp___87652 () us_t2 (mk___t2 temp___8765 temp___87651))
...
(assert (and (= temp___87652 (register_to_bytes reg)) (dynamic_invariant1 temp___87652 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___87651)) (to_rep (last4 temp___87651))) (+ (- (to_rep (last4 temp___87651)) (to_rep (first4 temp___87651))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
