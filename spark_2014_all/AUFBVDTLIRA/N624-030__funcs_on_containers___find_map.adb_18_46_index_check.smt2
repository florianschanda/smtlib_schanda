...
(assert (=> (= result5 true) (and (= o9 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o8)) (and (in_range5 o9) (= o9 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o8))))))
...
(assert (=> (= result5 true) (and (= o5 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o4)) (and (in_range5 o5) (= o5 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o4))))))
(assert (=> (= result5 true) (= o11 (ite (<= (to_rep1 (first (rt a))) o5) true false))))
