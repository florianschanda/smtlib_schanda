...
(assert (and (= result5 (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) o21)) (= (= result5 true) (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) o21) true))))
(assert (=> (= result5 true) (and (<= (to_rep1 (first (rt a))) i) (<= i (to_rep1 (last (rt a)))))))
(assert (=> (= result5 true) (= o13 i)))
(assert (=> (= result5 true) (= o14 (select (elts a) o13))))
(assert (=> (= result5 true) (= o15 (to_rep o14))))
(assert (=> (= result5 true) (and (= o16 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) o15)) (and (in_range5 o16) (= o16 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) o15))))))
(assert (=> (= result5 true) (= o17 (ite (<= o16 i) true false))))
(assert (=> (= result5 true) (and (<= (to_rep1 (first (rt a))) i) (<= i (to_rep1 (last (rt a)))))))
(assert (=> (= result5 true) (= o9 i)))
(assert (=> (= result5 true) (= o10 (select (elts a) o9))))
(assert (=> (= result5 true) (= o11 (to_rep o10))))
(assert (=> (= result5 true) (and (= o12 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) o11)) (and (in_range5 o12) (= o12 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) o11))))))
(assert (=> (= result5 true) (= o18 (ite (<= (to_rep1 (first (rt a))) o12) true false))))
(assert (=> (= result5 true) (= result4 (ite (= o18 true) o17 false))))
