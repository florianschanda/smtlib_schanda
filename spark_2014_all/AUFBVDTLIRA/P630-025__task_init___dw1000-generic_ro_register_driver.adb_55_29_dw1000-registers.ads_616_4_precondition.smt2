...
(define-fun dynamic_invariant ((temp___expr_7087 us_t1) (temp___is_init_7084 Bool) (temp___skip_constant_7085 Bool) (temp___do_toplevel_7086 Bool)) Bool (=> (not (= temp___skip_constant_7085 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7087) (last3 temp___expr_7087)) (and (= (first3 temp___expr_7087) 1) (= (last3 temp___expr_7087) 2)))))
