...
(assert (= begidx2 o))
(assert (and (and (and (and (<= begidx3 endidx2) (<= begidx3 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i Int)) (=> (and (<= begidx3 i) (<= i endidx2)) (and (<= 48 (to_rep1 (select zonefileline i))) (<= (to_rep1 (select zonefileline i)) 57)))))) (and (and (in_range2 begidx3) (in_range2 endidx2)) (in_range1 foundtype2))))
(assert (= success1 result2))
(assert (= success2 (ite (= foundtype2 3) true false)))
(assert (= success2 true))
(assert (not (<= begidx3 endidx2)))
(check-sat)
(exit)
