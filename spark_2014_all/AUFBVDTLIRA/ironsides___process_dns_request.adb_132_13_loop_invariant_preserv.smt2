...
(assert (= result5 true))
(assert (and (and (and (and (and (<= (+ srcbyte2 3) keylength1) (<= keylength1 1365)) (= keylength1 (to_rep5 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__keylength (us_split_fields3 dnskey_record))))) (<= 1 dstbytes2)) (<= dstbytes2 srcbyte2)) (<= start_byte (- 8170 (to_rep5 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__keylength (us_split_fields3 dnskey_record)))))))
(assert (and (and (=> (<= 0 1365) (in_range4 dstbytes2)) (=> (<= (- 2147483648) 2147483647) (in_range1 srcbyte2))) (<= (+ srcbyte2 3) keylength1)))
(assert (and (<= 1 srcbyte2) (<= srcbyte2 1365)))
(assert (= o9 srcbyte2))
(assert (= o10 (select (rec__rr_type__dnskey_record_type__dnskeyrecordtype__key (us_split_fields3 dnskey_record)) o9)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C3b__assume (to_rep o10)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C3b__assume c3b))
(assert (in_range2 c3b))
(assert (=> (and (<= 65 c3b) (<= c3b 90)) (= ans result6)))
(assert (=> (and (<= 65 c3b) (<= c3b 90)) (= ans4 (bvsub ((_ int2bv 8) c3b) #x41))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (and (<= 97 c3b) (<= c3b 122)) (= result7 (mk_t__ref ans)))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (and (<= 97 c3b) (<= c3b 122)) (= ans5 (bvadd (bvsub ((_ int2bv 8) c3b) #x61) #x1A)))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (and (<= 48 c3b) (<= c3b 57)) (= result8 (mk_t__ref ans))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (and (<= 48 c3b) (<= c3b 57)) (= ans6 (bvadd (bvsub ((_ int2bv 8) c3b) #x30) #x34))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (= c3b 43) (= result9 (mk_t__ref ans)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (= c3b 43) (= ans7 #x3E))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (= c3b 47) (= result10 (mk_t__ref ans))))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (= c3b 47) (= ans8 #x3F)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (not (= c3b 47)) (= result11 (mk_t__ref ans))))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (not (= c3b 47)) (= ans9 #x00)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (not (= c3b 47)) (= ans8 ans9)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (= ans7 ans8))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (= ans6 ans7)))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (= ans5 ans6))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (= ans4 ans5)))
(assert (= result12 (mk_t__ref srcnum0)))
(assert (= srcnum01 ans4))
(assert (and (= temp___5846 (+ srcbyte2 1)) (in_range1 (+ srcbyte2 1))))
(assert (and (<= 1 temp___5846) (<= temp___5846 1365)))
(assert (= o11 temp___5846))
(assert (= o12 (select (rec__rr_type__dnskey_record_type__dnskeyrecordtype__key (us_split_fields3 dnskey_record)) o11)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C6b__assume (to_rep o12)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C6b__assume c6b))
(assert (in_range2 c6b))
(assert (=> (and (<= 65 c6b) (<= c6b 90)) (= result13 (mk_t__ref ans1))))
(assert (=> (and (<= 65 c6b) (<= c6b 90)) (= ans10 (bvsub ((_ int2bv 8) c6b) #x41))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (and (<= 97 c6b) (<= c6b 122)) (= result14 (mk_t__ref ans1)))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (and (<= 97 c6b) (<= c6b 122)) (= ans11 (bvadd (bvsub ((_ int2bv 8) c6b) #x61) #x1A)))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (and (<= 48 c6b) (<= c6b 57)) (= result15 (mk_t__ref ans1))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (and (<= 48 c6b) (<= c6b 57)) (= ans12 (bvadd (bvsub ((_ int2bv 8) c6b) #x30) #x34))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (= c6b 43) (= result16 (mk_t__ref ans1)))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (= c6b 43) (= ans13 #x3E))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (not (= c6b 43)) (=> (= c6b 47) (= result17 (mk_t__ref ans1))))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (not (= c6b 43)) (=> (= c6b 47) (= ans14 #x3F)))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (not (= c6b 43)) (=> (not (= c6b 47)) (= result18 (mk_t__ref ans1))))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (not (= c6b 43)) (=> (not (= c6b 47)) (= ans15 #x00)))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (not (= c6b 43)) (=> (not (= c6b 47)) (= ans14 ans15)))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (=> (not (= c6b 43)) (= ans13 ans14))))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (=> (not (and (<= 48 c6b) (<= c6b 57))) (= ans12 ans13)))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (=> (not (and (<= 97 c6b) (<= c6b 122))) (= ans11 ans12))))
(assert (=> (not (and (<= 65 c6b) (<= c6b 90))) (= ans10 ans11)))
(assert (= result19 (mk_t__ref srcnum1)))
(assert (= srcnum11 ans10))
(assert (and (= temp___5848 (+ srcbyte2 2)) (in_range1 (+ srcbyte2 2))))
(assert (and (<= 1 temp___5848) (<= temp___5848 1365)))
(assert (= o13 temp___5848))
(assert (= o14 (select (rec__rr_type__dnskey_record_type__dnskeyrecordtype__key (us_split_fields3 dnskey_record)) o13)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C9b__assume (to_rep o14)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C9b__assume c9b))
(assert (in_range2 c9b))
(assert (=> (and (<= 65 c9b) (<= c9b 90)) (= result20 (mk_t__ref ans2))))
(assert (=> (and (<= 65 c9b) (<= c9b 90)) (= ans16 (bvsub ((_ int2bv 8) c9b) #x41))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (and (<= 97 c9b) (<= c9b 122)) (= result21 (mk_t__ref ans2)))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (and (<= 97 c9b) (<= c9b 122)) (= ans17 (bvadd (bvsub ((_ int2bv 8) c9b) #x61) #x1A)))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (and (<= 48 c9b) (<= c9b 57)) (= result22 (mk_t__ref ans2))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (and (<= 48 c9b) (<= c9b 57)) (= ans18 (bvadd (bvsub ((_ int2bv 8) c9b) #x30) #x34))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (= c9b 43) (= result23 (mk_t__ref ans2)))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (= c9b 43) (= ans19 #x3E))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (not (= c9b 43)) (=> (= c9b 47) (= result24 (mk_t__ref ans2))))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (not (= c9b 43)) (=> (= c9b 47) (= ans20 #x3F)))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (not (= c9b 43)) (=> (not (= c9b 47)) (= result25 (mk_t__ref ans2))))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (not (= c9b 43)) (=> (not (= c9b 47)) (= ans21 #x00)))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (not (= c9b 43)) (=> (not (= c9b 47)) (= ans20 ans21)))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (=> (not (= c9b 43)) (= ans19 ans20))))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (=> (not (and (<= 48 c9b) (<= c9b 57))) (= ans18 ans19)))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (=> (not (and (<= 97 c9b) (<= c9b 122))) (= ans17 ans18))))
(assert (=> (not (and (<= 65 c9b) (<= c9b 90))) (= ans16 ans17)))
(assert (= result26 (mk_t__ref srcnum2)))
(assert (= srcnum21 ans16))
(assert (and (= temp___5850 (+ srcbyte2 3)) (in_range1 (+ srcbyte2 3))))
(assert (and (<= 1 temp___5850) (<= temp___5850 1365)))
(assert (= o15 temp___5850))
(assert (= o16 (select (rec__rr_type__dnskey_record_type__dnskeyrecordtype__key (us_split_fields3 dnskey_record)) o15)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C12b__assume (to_rep o16)))
(assert (= process_dns_request__set_ttl_data_dnskey__L_1__C12b__assume c12b))
(assert (in_range2 c12b))
(assert (=> (and (<= 65 c12b) (<= c12b 90)) (= result27 (mk_t__ref ans3))))
(assert (=> (and (<= 65 c12b) (<= c12b 90)) (= ans22 (bvsub ((_ int2bv 8) c12b) #x41))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (and (<= 97 c12b) (<= c12b 122)) (= result28 (mk_t__ref ans3)))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (and (<= 97 c12b) (<= c12b 122)) (= ans23 (bvadd (bvsub ((_ int2bv 8) c12b) #x61) #x1A)))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (and (<= 48 c12b) (<= c12b 57)) (= result29 (mk_t__ref ans3))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (and (<= 48 c12b) (<= c12b 57)) (= ans24 (bvadd (bvsub ((_ int2bv 8) c12b) #x30) #x34))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (= c12b 43) (= result30 (mk_t__ref ans3)))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (= c12b 43) (= ans25 #x3E))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (not (= c12b 43)) (=> (= c12b 47) (= result31 (mk_t__ref ans3))))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (not (= c12b 43)) (=> (= c12b 47) (= ans26 #x3F)))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (not (= c12b 43)) (=> (not (= c12b 47)) (= result32 (mk_t__ref ans3))))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (not (= c12b 43)) (=> (not (= c12b 47)) (= ans27 #x00)))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (not (= c12b 43)) (=> (not (= c12b 47)) (= ans26 ans27)))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (=> (not (= c12b 43)) (= ans25 ans26))))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (=> (not (and (<= 48 c12b) (<= c12b 57))) (= ans24 ans25)))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (=> (not (and (<= 97 c12b) (<= c12b 122))) (= ans23 ans24))))
(assert (=> (not (and (<= 65 c12b) (<= c12b 90))) (= ans22 ans23)))
(assert (= result33 (mk_t__ref srcnum3)))
(assert (= srcnum31 ans22))
(assert (= result34 (mk_t__ref dstnum0)))
(assert (= dstnum01 (bvadd (bvmul srcnum01 #x04) (bvudiv srcnum11 #x10))))
(assert (= result35 (mk_t__ref dstnum1)))
(assert (= dstnum11 (bvadd (bvmul srcnum11 #x10) (bvudiv srcnum21 #x04))))
(assert (= result36 (mk_t__ref dstnum2)))
(assert (= dstnum21 (bvadd (bvmul srcnum21 #x40) srcnum31)))
(assert (= (to_rep1 o18) dstnum01))
(assert (and (= o17 dstbytes2) (in_range3 dstbytes2)))
(assert (= temp___5851 (+ (+ start_byte 9) o17)))
(assert (and (<= 1 temp___5851) (<= temp___5851 8180)))
(assert (= o19 temp___5851))
(assert (= o20 (store bytes3 o19 o18)))
(assert (= result37 (mk_map__ref1 bytes3)))
(assert (= bytes4 o20))
(assert (= (to_rep1 o22) dstnum11))
(assert (and (= o21 (+ dstbytes2 1)) (in_range3 (+ dstbytes2 1))))
(assert (= temp___5852 (+ (+ start_byte 9) o21)))
(assert (and (<= 1 temp___5852) (<= temp___5852 8180)))
(assert (= o23 temp___5852))
(assert (= o24 (store bytes4 o23 o22)))
(assert (= result38 (mk_map__ref1 bytes4)))
(assert (= bytes5 o24))
(assert (= (to_rep1 o26) dstnum21))
(assert (and (= o25 (+ dstbytes2 2)) (in_range3 (+ dstbytes2 2))))
(assert (= temp___5853 (+ (+ start_byte 9) o25)))
(assert (and (<= 1 temp___5853) (<= temp___5853 8180)))
(assert (= o27 temp___5853))
(assert (= o28 (store bytes5 o27 o26)))
(assert (= result39 (mk_map__ref1 bytes5)))
(assert (= bytes6 o28))
(assert (and (= o29 (+ srcbyte2 4)) (in_range1 (+ srcbyte2 4))))
(assert (= result40 (mk_int__ref srcbyte2)))
(assert (= srcbyte3 o29))
(assert (and (= o30 (+ dstbytes2 3)) (in_range4 (+ dstbytes2 3))))
(assert (= result41 (mk_int__ref dstbytes2)))
(assert (= dstbytes3 o30))
(assert (and (= o31 (+ srcbyte3 3)) (in_range1 (+ srcbyte3 3))))
(assert (= o32 (ite (<= o31 keylength1) true false)))
(assert (= result42 (ite (not (= o32 true)) true false)))
(assert (not (= result42 true)))
(assert (not (<= (+ srcbyte3 3) keylength1)))
(check-sat)
(exit)
