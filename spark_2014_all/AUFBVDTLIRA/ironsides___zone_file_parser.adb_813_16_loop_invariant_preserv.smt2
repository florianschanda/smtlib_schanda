...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 256)) (<= endidx1 256)) (=> (= foundtype1 1) (forall ((i6 Int)) (=> (and (<= begidx2 i6) (<= i6 endidx1)) (and (<= 48 (to_rep (select rrstring i6))) (<= (to_rep (select rrstring i6)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
(assert (= foundtype1 3))
...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i6 Int)) (=> (and (<= begidx4 i6) (<= i6 endidx3)) (and (<= 48 (to_rep (select rrstring i6))) (<= (to_rep (select rrstring i6)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (bvule #x00 i1))
(assert (bvule i1 #xFF))
(assert (and (and (and (and (<= 1 numberofblocks3) (< numberofblocks3 32)) (forall ((j (_ BitVec 8))) (=> (and (bvule #x00 j) (bvule j #xFF)) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap7) j))) (<= (to_rep3 (select (map__content6 blocklengthmap7) j)) 32))))) (<= 1 (int__content numberofrecordtypes7))) (<= (int__content numberofrecordtypes7) 32)))
(assert (and (=> (<= 0 32) (in_range9 numberofblocks3)) (and (bvule #x00 i2) (bvule i2 #xFF))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (and (= o43 (+ numberofblocks3 1)) (in_range9 (+ numberofblocks3 1)))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= result25 (mk_int__ref numberofblocks3))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= numberofblocks4 o43)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= (to_rep1 o44) i2)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (and (<= 1 numberofblocks4) (<= numberofblocks4 32))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= o45 numberofblocks4)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= o46 (store blocknumbers2 o45 o44))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= result26 (mk_map__ref1 blocknumbers2))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= blocknumbers3 o46)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= (to_rep3 o47) (to_rep3 (select (map__content6 blocklengthmap7) i2)))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (and (<= 1 numberofblocks4) (<= numberofblocks4 32))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= o48 numberofblocks4)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= o49 (store blocklengths2 o48 o47))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= result27 (mk_map__ref3 blocklengths2))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= blocklengths3 o49)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= blocklengths4 (mk_map__ref3 blocklengths3))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= blocknumbers4 (mk_map__ref1 blocknumbers3))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= numberofblocks5 (mk_int__ref numberofblocks4))))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= blocklengths5 blocklengths3)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= blocknumbers5 blocknumbers3)))
(assert (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (= numberofblocks6 numberofblocks4)))
(assert (=> (not (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false)) (= blocklengths4 (mk_map__ref3 blocklengths2))))
(assert (=> (not (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false)) (= blocknumbers4 (mk_map__ref1 blocknumbers2))))
(assert (=> (not (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false)) (= numberofblocks5 (mk_int__ref numberofblocks3))))
(assert (=> (not (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false)) (= blocklengths5 blocklengths2)))
(assert (=> (not (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false)) (= blocknumbers5 blocknumbers2)))
(assert (=> (not (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false)) (= numberofblocks6 numberofblocks3)))
(assert (not (= (int__content numberofblocks5) 32)))
(assert (not (= i2 #xFF)))
(assert (= result28 (mk_t__ref i2)))
(assert (= i3 (bvadd i2 #x01)))
(assert (= i4 (mk_t__ref i3)))
(assert (= blocklengths6 blocklengths4))
(assert (= blocknumbers6 blocknumbers4))
(assert (= numberofblocks7 numberofblocks5))
(assert (= i5 i3))
(assert (= blocklengths7 blocklengths5))
(assert (= blocknumbers7 blocknumbers5))
(assert (= numberofblocks8 numberofblocks6))
(assert (not (< (int__content numberofblocks7) 32)))
(check-sat)
(exit)
