...
(assert (= result5 true))
(assert (and (= temp___708 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)) (and (in_range5 temp___708) (= temp___708 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)))))
