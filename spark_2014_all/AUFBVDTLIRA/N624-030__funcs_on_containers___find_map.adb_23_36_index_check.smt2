...
(assert (= result4 true))
(assert (and (= o3 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)) (and (in_range5 o3) (= o3 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)))))
(assert (= o4 (ite (<= o3 k2) true false)))
(assert (and (= o2 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)) (and (in_range5 o2) (= o2 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)))))
(assert (= o5 (ite (<= (to_rep1 (first (rt a))) o2) true false)))
(assert (= result5 (ite (= o5 true) o4 false)))
(assert (= result5 true))
(assert (and (= temp___756 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)) (and (in_range5 temp___756) (= temp___756 (get (model__ (mk___rep result____split_discrs result____split_fields4)) e)))))
(assert (not (<= (to_rep1 (first (rt a))) temp___756)))
(check-sat)
(exit)
