...
(assert (= result6 true))
(assert (and (= o23 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e)) (and (in_range5 o23) (= o23 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e)))))
(assert (= o24 (ite (<= o23 k2) true false)))
(assert (and (= o22 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e)) (and (in_range5 o22) (= o22 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e)))))
(assert (= o25 (ite (<= (to_rep1 (first (rt a))) o22) true false)))
(assert (= result7 (ite (= o25 true) o24 false)))
(assert (= result7 true))
(assert (and (= temp___708 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e)) (and (in_range5 temp___708) (= temp___708 (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e)))))
(assert (not (<= (to_rep1 (first (rt a))) temp___708)))
(check-sat)
(exit)
