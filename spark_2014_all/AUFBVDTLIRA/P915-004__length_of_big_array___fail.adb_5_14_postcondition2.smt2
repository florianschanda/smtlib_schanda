...
(assert (= (ite (<= (bv2nat (to_rep (first4 temp___7131))) (bv2nat (to_rep (last5 temp___7131)))) (+ (- (bv2nat (to_rep (last5 temp___7131))) (bv2nat (to_rep (first4 temp___7131)))) 1) 0) (ite (<= (bv2nat #x0000000000000000) (bv2nat last2)) (+ (- (bv2nat last2) (bv2nat #x0000000000000000)) 1) 0)))
(assert (= temp___713 fail__create__r__assume))
(assert (= (mk1 (to_rep (first4 temp___7131)) (to_rep (last5 temp___7131))) fail__create__r__assume1))
(assert (= result r))
...
(assert (and (dynamic_property2 #x0000000000000000 last2 (to_rep r__first) (to_rep r__last)) (and (= (to_rep r__first) #x0000000000000000) (= (to_rep r__last) last2))))
(assert (= fail__create__result4 fail__create__result2))
(assert (= fail__create__result5 fail__create__result3))
(assert (= (mk___t fail__create__result6 fail__create__result7) (mk___t fail__create__result2 fail__create__result3)))
...
(assert (= (mk_a__ref (mk___t fail__create__result8 fail__create__result9)) (mk_a__ref (mk___t fail__create__result4 fail__create__result5))))
(assert (= r2 r1))
...
(assert (not (= (to_rep (last fail__create__result9)) last2)))
(check-sat)
(exit)
