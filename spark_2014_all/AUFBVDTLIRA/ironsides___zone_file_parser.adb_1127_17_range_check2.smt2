...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i Int)) (=> (and (<= begidx5 i) (<= i endidx3)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i Int)) (=> (and (<= begidx11 i) (<= i endidx8)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
(assert (= foundtype8 1))
