...
(declare-const temp___1344 (_ BitVec 16))
(declare-const temp___1341 digit_index_type)
(declare-const temp___13411 (Array Int octet))
(declare-const temp___13412 t1)
(declare-const o Int)
...
(declare-const temp___1340 us_rep1)
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1348 current_borrow1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1347 future_borrow)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1346 temporary_digit)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1345 product)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1344 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (and (= (mk___split_discrs temp___1341) u__split_discrs) (and (= temp___13411 u__split_fields) (= temp___13412 u__split_fields1)))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (and (= o6 (shift_right product3 8)) (= o6 (bvudiv product3 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000))))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temporary_digit3 (bvand product3 #x00FF))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (and (= o7 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1334 (- o7 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1334) (<= temp___1334 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= o8 temp___1334)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1336 (- o13 1))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= o14 temp___1336)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1338 (- o12 1))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= o24 temp___1338)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= temp___1340 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 o28 o29))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= result9 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= u__split_fields4 (us_split_fields3 temp___1340))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b)) (= u__split_discrs (us_split_discrs2 temp___1340))))
...
(assert (and (= temp___1352 (+ j n)) (in_range1 (+ j n))))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1352)))
(check-sat)
(exit)
