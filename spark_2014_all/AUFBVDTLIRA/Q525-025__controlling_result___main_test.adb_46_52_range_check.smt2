...
(assert (not (= (length temp___310) 0)))
(assert (=> (<= (to_rep1 (first (rt temp___311))) (to_rep1 (last (rt temp___311)))) (= o27 (+ (- (to_rep1 (last (rt temp___311))) (to_rep1 (first (rt temp___311)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___311))) (to_rep1 (last (rt temp___311))))) (= o27 0)))
(assert (=> (<= (to_rep1 (first (rt temp___310))) (to_rep1 (last (rt temp___310)))) (= o28 (+ (- (to_rep1 (last (rt temp___310))) (to_rep1 (first (rt temp___310)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___310))) (to_rep1 (last (rt temp___310))))) (= o28 0)))
(assert (= o29 (+ o28 o27)))
(assert (= o30 (+ (to_rep1 (first (rt temp___310))) o29)))
(assert (= o31 (- o30 1)))
