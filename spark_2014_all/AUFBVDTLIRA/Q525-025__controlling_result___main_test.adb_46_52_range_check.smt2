...
(assert (=> (<= (to_rep1 (first (rt temp___290))) (to_rep1 (last (rt temp___290)))) (= o27 (+ (- (to_rep1 (last (rt temp___290))) (to_rep1 (first (rt temp___290)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___290))) (to_rep1 (last (rt temp___290))))) (= o27 0)))
(assert (=> (<= (to_rep1 (first (rt temp___289))) (to_rep1 (last (rt temp___289)))) (= o28 (+ (- (to_rep1 (last (rt temp___289))) (to_rep1 (first (rt temp___289)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___289))) (to_rep1 (last (rt temp___289))))) (= o28 0)))
(assert (= o29 (+ o28 o27)))
