...
(assert (= a9 a7))
(assert (not (= (oeq (osubtract (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int b b_first (+ (- a_last a_first) 1))) (osubtract (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (num_of_boolean (bool__content carry8))))) true)))
(check-sat)
(exit)
