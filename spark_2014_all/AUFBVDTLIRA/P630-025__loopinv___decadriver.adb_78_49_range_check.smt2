...
(assert (=> (<= (to_rep1 frame__first) (to_rep1 frame__last)) (= o2 (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1))))
(assert (=> (not (<= (to_rep1 frame__first) (to_rep1 frame__last))) (= o2 0)))
(assert (and (= temp___5084 o2) (in_range1 o2)))
(assert (<= 1 temp___5084))
(assert (not (<= 1 1024)))
(check-sat)
(exit)
