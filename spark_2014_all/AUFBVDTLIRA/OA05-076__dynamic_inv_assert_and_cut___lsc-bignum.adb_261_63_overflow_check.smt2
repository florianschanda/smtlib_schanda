...
(assert (= a9 a7))
(assert (= o33 (from_word32 (t__content carry28))))
(assert (and (= o32 (base Tuple0)) (= o32 (oexpon (from_word32 #x00000002) 32))))
(assert (= o34 (omultiply o32 o33)))
(assert (= o31 (from_word32 (t__content carry18))))
(assert (= o35 (oadd o31 o34)))
...
(assert (= o36 (omultiply o30 o35)))
(assert (and (= o20 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o21 (+ o20 1)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (and (= o23 o22) (in_range2 o22)))
(assert (= o24 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o23)))
(assert (= o37 (oadd o24 o36)))
(assert (= o18 (from_word32 carry2)))
(assert (and (= o17 (base Tuple0)) (= o17 (oexpon (from_word32 #x00000002) 32))))
(assert (= o19 (omultiply o17 o18)))
(assert (= o16 (from_word32 carry1)))
(assert (= o14 (from_word32 y)))
