...
(declare-const xcx6 (Array Int unsigned_8))
(assert true)
...
(assert (not (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))))
(check-sat)
(exit)
