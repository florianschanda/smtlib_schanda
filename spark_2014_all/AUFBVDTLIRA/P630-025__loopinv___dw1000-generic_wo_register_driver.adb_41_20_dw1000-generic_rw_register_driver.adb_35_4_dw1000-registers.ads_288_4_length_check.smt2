...
(define-fun temp___78172 () us_t2 (mk___t2 temp___7817 temp___78171))
...
(assert (and (= temp___78172 (register_to_bytes reg)) (dynamic_invariant1 temp___78172 true false true)))
