...
(define-fun dynamic_invariant ((temp___expr_3377 us_t1) (temp___is_init_3374 Bool) (temp___skip_constant_3375 Bool) (temp___do_toplevel_3376 Bool)) Bool (=> (not (= temp___skip_constant_3375 true)) (and (dynamic_property2 1 41 (first3 temp___expr_3377) (last3 temp___expr_3377)) (and (= (first3 temp___expr_3377) 1) (= (last3 temp___expr_3377) 41)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3396 us_t2) (temp___is_init_3393 Bool) (temp___skip_constant_3394 Bool) (temp___do_toplevel_3395 Bool)) Bool (=> (not (= temp___skip_constant_3394 true)) (and (dynamic_property3 1 41 (first5 temp___expr_3396) (last5 temp___expr_3396)) (and (= (first5 temp___expr_3396) 1) (= (last5 temp___expr_3396) 41)))))
...
(declare-const temp___7817 (Array Int bits_8))
(declare-const temp___78171 t2)
(declare-const temp___7818 (Array Int bits_8))
(declare-const temp___78181 t1)
...
(assert (and (= (mk___t2 temp___7817 temp___78171) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7817 temp___78171) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___78171)) (to_rep (last4 temp___78171))) (+ (- (to_rep (last4 temp___78171)) (to_rep (first4 temp___78171))) 1) 0) (ite (<= 1 41) (+ (- 41 1) 1) 0))))
(check-sat)
(exit)
