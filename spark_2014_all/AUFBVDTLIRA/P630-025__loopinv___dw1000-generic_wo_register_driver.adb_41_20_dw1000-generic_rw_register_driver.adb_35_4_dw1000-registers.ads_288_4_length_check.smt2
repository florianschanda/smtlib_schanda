...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__usr_sfd_type__sub_registers (Array Int bits_8))))))
(define-fun us_split_fields_Sub_Registers__projection ((a us_split_fields)) (Array Int bits_8) (rec__dw1000__register_types__usr_sfd_type__sub_registers a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___25__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___25__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (bool_eq (rec__dw1000__register_types__usr_sfd_type__sub_registers (us_split_fields1 a)) 0 40 (rec__dw1000__register_types__usr_sfd_type__sub_registers (us_split_fields1 b)) 0 40) true) true false))
...
(declare-const dw1000__register_types__usr_sfd_type__sub_registers__first__bit Int)
(declare-const dw1000__register_types__usr_sfd_type__sub_registers__last__bit Int)
(declare-const dw1000__register_types__usr_sfd_type__sub_registers__position Int)
(assert (<= 0 dw1000__register_types__usr_sfd_type__sub_registers__first__bit))
(assert (< dw1000__register_types__usr_sfd_type__sub_registers__first__bit dw1000__register_types__usr_sfd_type__sub_registers__last__bit))
(assert (<= 0 dw1000__register_types__usr_sfd_type__sub_registers__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((usr_sfd_type__ref (mk_usr_sfd_type__ref (usr_sfd_type__content us_rep)))))
(define-fun usr_sfd_type__ref___projection ((a usr_sfd_type__ref)) us_rep (usr_sfd_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___55__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___40__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___40__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3719 us_t1) (temp___is_init_3715 Bool) (temp___skip_constant_3716 Bool) (temp___do_toplevel_3717 Bool) (temp___do_typ_inv_3718 Bool)) Bool (=> (not (= temp___skip_constant_3716 true)) (and (dynamic_property2 1 41 (first3 temp___expr_3719) (last3 temp___expr_3719)) (and (= (first3 temp___expr_3719) 1) (= (last3 temp___expr_3719) 41)))))
(declare-sort t2 0)
...
(define-fun target__ref___16__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___16__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_3740 us_t2) (temp___is_init_3736 Bool) (temp___skip_constant_3737 Bool) (temp___do_toplevel_3738 Bool) (temp___do_typ_inv_3739 Bool)) Bool (=> (not (= temp___skip_constant_3737 true)) (and (dynamic_property3 1 41 (first5 temp___expr_3740) (last5 temp___expr_3740)) (and (= (first5 temp___expr_3740) 1) (= (last5 temp___expr_3740) 41)))))
...
(declare-const temp___8589 (Array Int bits_8))
(declare-const temp___85891 t2)
(define-fun temp___85892 () us_t2 (mk___t2 temp___8589 temp___85891))
(assert (and (dynamic_property2 1 41 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 41))))
(assert (and (= temp___85892 (register_to_bytes reg)) (dynamic_invariant1 temp___85892 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85891)) (to_rep (last4 temp___85891))) (+ (- (to_rep (last4 temp___85891)) (to_rep (first4 temp___85891))) 1) 0) (ite (<= 1 41) (+ (- 41 1) 1) 0))))
(check-sat)
(exit)
