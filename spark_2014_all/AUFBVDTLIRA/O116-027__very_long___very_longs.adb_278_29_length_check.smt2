...
(declare-datatypes () ((tT80bP1__ref (mk_tT80bP1__ref (tT80bP1__content tdigit_count_typeB)))))
(define-fun tT80bP1__ref___projection ((a tT80bP1__ref)) tdigit_count_typeB (tT80bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t81b__ref (mk_t81b__ref (t81b__content tdigit_count_typeB)))))
(define-fun t81b__ref___projection ((a t81b__ref)) tdigit_count_typeB (t81b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t82b__ref (mk_t82b__ref (t82b__content us_t2)))))
(define-fun t82b__ref___projection ((a t82b__ref)) us_t2 (t82b__content a))
...
(declare-const temp___944 us_rep1)
...
(assert (not (= (ite (<= (to_rep2 (first4 temp___9341)) (to_rep2 (last4 temp___9341))) (+ (- (to_rep2 (last4 temp___9341)) (to_rep2 (first4 temp___9341))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0))))
(check-sat)
(exit)
