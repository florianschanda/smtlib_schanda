...
(assert (=> (<= 128 lengthoftoken2) (= result7 (mk_bool__ref success))))
(assert (=> (<= 128 lengthoftoken2) (= success2 (of_int 0))))
(assert (=> (<= 128 lengthoftoken2) (= i24 (mk_int__ref i1))))
(assert (=> (<= 128 lengthoftoken2) (= success3 (mk_bool__ref success2))))
(assert (=> (<= 128 lengthoftoken2) (= newowner13 (mk_map__ref newowner))))
(assert (=> (<= 128 lengthoftoken2) (= i25 i3)))
(assert (=> (<= 128 lengthoftoken2) (= success4 success2)))
(assert (=> (<= 128 lengthoftoken2) (= newowner14 newowner1)))
(assert (=> (not (<= 128 lengthoftoken2)) (= result8 (mk_map__ref newowner))))
(assert (=> (not (<= 128 lengthoftoken2)) (= newowner2 blankdomainname)))
(assert (=> (not (<= 128 lengthoftoken2)) (= lengthoftoken2 r112b)))
(assert (=> (not (<= 128 lengthoftoken2)) (in_range5 r112b)))
(assert (=> (not (<= 128 lengthoftoken2)) (= result9 (mk_int__ref i1))))
(assert (=> (not (<= 128 lengthoftoken2)) (= i13 1)))
...
(assert (=> (not (<= 128 lengthoftoken2)) (=> (and (<= 1 i13) (<= i13 r112b)) (= i22 i20))))
(assert (=> (not (<= 128 lengthoftoken2)) (=> (and (<= 1 i13) (<= i13 r112b)) (= newowner11 newowner9))))
(assert (=> (not (<= 128 lengthoftoken2)) (=> (and (<= 1 i13) (<= i13 r112b)) (= i23 i21))))
(assert (=> (not (<= 128 lengthoftoken2)) (=> (and (<= 1 i13) (<= i13 r112b)) (= newowner12 newowner10))))
(assert (=> (not (<= 128 lengthoftoken2)) (=> (not (and (<= 1 i13) (<= i13 r112b))) (= i22 (mk_int__ref i13)))))
(assert (=> (not (<= 128 lengthoftoken2)) (=> (not (and (<= 1 i13) (<= i13 r112b))) (= newowner11 (mk_map__ref newowner2)))))
(assert (=> (not (<= 128 lengthoftoken2)) (=> (not (and (<= 1 i13) (<= i13 r112b))) (= i23 i13))))
(assert (=> (not (<= 128 lengthoftoken2)) (=> (not (and (<= 1 i13) (<= i13 r112b))) (= newowner12 newowner2))))
(assert (=> (not (<= 128 lengthoftoken2)) (= i24 i22)))
(assert (=> (not (<= 128 lengthoftoken2)) (= success3 (mk_bool__ref success))))
(assert (=> (not (<= 128 lengthoftoken2)) (= newowner13 newowner11)))
(assert (=> (not (<= 128 lengthoftoken2)) (= i25 i23)))
(assert (=> (not (<= 128 lengthoftoken2)) (= success4 success1)))
(assert (=> (not (<= 128 lengthoftoken2)) (= newowner14 newowner12)))
(assert (not (<= zlength endidx2)))
(assert (not (= tokentype2 9)))
(assert (not (in_range5 (+ endidx2 1))))
(check-sat)
(exit)
