...
(assert (= x28 o107))
(assert (not (= (bool_eq2 x28 (to_rep1 (first (mk (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3)))) (to_rep1 (last (mk (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3)))) y (to_rep1 (first2 (mk1 (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3)))) (to_rep1 (last2 (mk1 (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3))))) true)))
(check-sat)
(exit)
