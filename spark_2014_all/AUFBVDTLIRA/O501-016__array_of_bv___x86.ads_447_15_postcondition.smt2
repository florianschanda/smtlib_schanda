...
(assert true)
(assert true)
(assert (and (and (and (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))) (and (and (= (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory2) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 8)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 1)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))) (and (and (= (readmem8 (bvadd addr ((_ int2bv 64) 2)) memory3) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 16)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 2)))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))) (and (and (= (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory4) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 24)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 3)))) (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))) (and (= ((_ zero_extend 8) (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 2))))) ((_ extract 15 0) (bvlshr (bvand val__ ((_ int2bv 32) 16711680)) ((_ int2bv 32) 16)))) (and (= (readmem16 addr memory4) ((_ extract 15 0) (bvand val__ ((_ int2bv 32) 65535)))) (= (bvor ((_ zero_extend 16) (readmem16 addr memory4)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory4)) ((_ int2bv 32) 16))) val__))))))) (and (= memory4 memory5) (= memory6 memory4))))
(assert (not (= (readmem32 addr memory5) val__)))
(check-sat)
(exit)
