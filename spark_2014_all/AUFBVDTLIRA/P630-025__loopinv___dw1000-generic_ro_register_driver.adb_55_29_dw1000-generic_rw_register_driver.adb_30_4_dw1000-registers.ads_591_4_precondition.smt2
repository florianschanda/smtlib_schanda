...
(define-fun dynamic_invariant ((temp___expr_6964 us_t1) (temp___is_init_6961 Bool) (temp___skip_constant_6962 Bool) (temp___do_toplevel_6963 Bool)) Bool (=> (not (= temp___skip_constant_6962 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6964) (last3 temp___expr_6964)) (and (= (first3 temp___expr_6964) 1) (= (last3 temp___expr_6964) 4)))))
