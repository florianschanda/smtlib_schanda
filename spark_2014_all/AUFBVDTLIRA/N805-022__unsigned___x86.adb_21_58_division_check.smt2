...
(assert (= xcx3 result3))
(assert (= xcx4 o7))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) #x00000100)) (bvurem val__ #x00010000)))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000)))
(assert (not (not (= #x00010000 #x00000000))))
(check-sat)
(exit)
