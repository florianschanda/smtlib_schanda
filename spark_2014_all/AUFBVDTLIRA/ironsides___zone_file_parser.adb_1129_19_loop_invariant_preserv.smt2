...
(assert (<= r75b i3))
(assert (<= i3 r76b))
(assert (and (<= 1 begidx13) (bvule tmpval2 ((_ int2bv 16) 32767))))
(assert (and (=> (<= r75b r76b) (dynamic_property r75b r76b i4)) (and (<= r75b i4) (<= i4 r76b))))
(assert (= result7 (mk_t__ref digitval2)))
(assert (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i4))) ((_ int2bv 16) 48))))
(assert (= result8 (mk_t__ref tmpval2)))
(assert (= tmpval3 (bvadd (bvmul ((_ int2bv 16) 10) tmpval2) digitval3)))
(assert (not (bvugt tmpval3 ((_ int2bv 16) 32767))))
(assert (not (= i4 r76b)))
(assert (= result9 (mk_int__ref i4)))
(assert (= i5 (+ i4 1)))
(assert (= i6 (mk_int__ref i5)))
(assert (= tmpval4 (mk_t__ref tmpval3)))
(assert (= digitval4 (mk_t__ref digitval3)))
(assert (= i7 i5))
(assert (= tmpval5 tmpval3))
(assert (= digitval5 digitval3))
