...
(assert (= memory6 o11))
(assert (= (to_rep o12) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 281474976710656)) ((_ int2bv 64) 256)))))
(assert (= o13 (store memory6 (bvadd addr ((_ int2bv 64) 6)) o12)))
(assert (= memory6 result6))
(assert (= memory7 o13))
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvurem (bvudiv val__ ((_ int2bv 64) 72057594037927936)) ((_ int2bv 64) 256)))))
(check-sat)
(exit)
