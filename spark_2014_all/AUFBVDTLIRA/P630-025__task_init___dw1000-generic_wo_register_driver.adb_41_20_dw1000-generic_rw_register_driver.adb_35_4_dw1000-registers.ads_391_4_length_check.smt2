...
(assert (and (= (mk___t2 temp___7942 temp___79421) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7942 temp___79421) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___79421)) (to_rep (last4 temp___79421))) (+ (- (to_rep (last4 temp___79421)) (to_rep (first4 temp___79421))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
