...
(define-fun target__ref___45__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__fs_pllcfg_type__fs_pllcfg (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__fs_pllcfg_type__fs_pllcfg (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_6242 us_t1) (temp___is_init_6238 Bool) (temp___skip_constant_6239 Bool) (temp___do_toplevel_6240 Bool) (temp___do_typ_inv_6241 Bool)) Bool (=> (not (= temp___skip_constant_6239 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6242) (last3 temp___expr_6242)) (and (= (first3 temp___expr_6242) 1) (= (last3 temp___expr_6242) 4)))))
...
(define-fun register_byte_array__ref___107__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6224 us_t2) (temp___is_init_6220 Bool) (temp___skip_constant_6221 Bool) (temp___do_toplevel_6222 Bool) (temp___do_typ_inv_6223 Bool)) Bool (=> (not (= temp___skip_constant_6221 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6224) (last5 temp___expr_6224)) (and (= (first5 temp___expr_6224) 1) (= (last5 temp___expr_6224) 4)))))
...
(declare-const temp___88131 t1)
(define-fun temp___88132 () us_t1 (mk___t1 temp___8813 temp___88131))
...
(assert (and (= temp___88132 (register_to_bytes reg)) (dynamic_invariant temp___88132 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___88131)) (to_rep (last2 temp___88131))) (+ (- (to_rep (last2 temp___88131)) (to_rep (first2 temp___88131))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
