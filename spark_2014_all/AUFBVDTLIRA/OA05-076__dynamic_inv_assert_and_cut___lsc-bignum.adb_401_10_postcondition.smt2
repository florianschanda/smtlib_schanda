...
(assert (not (not (= (bvand (to_rep (select (elts a) (+ a_first (bv2nat (bvudiv i ((_ int2bv 64) 32)))))) (let ((temp___755 (bv2nat (bvurem i ((_ int2bv 64) 32))))) (ite (< temp___755 4294967296) (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___755)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0)))))
(check-sat)
(exit)
