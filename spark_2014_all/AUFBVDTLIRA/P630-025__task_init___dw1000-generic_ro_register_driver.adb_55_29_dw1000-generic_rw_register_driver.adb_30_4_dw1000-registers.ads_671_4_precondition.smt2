...
(define-fun dynamic_invariant ((temp___expr_7516 us_t1) (temp___is_init_7513 Bool) (temp___skip_constant_7514 Bool) (temp___do_toplevel_7515 Bool)) Bool (=> (not (= temp___skip_constant_7514 true)) (and (dynamic_property2 1 1 (first3 temp___expr_7516) (last3 temp___expr_7516)) (and (= (first3 temp___expr_7516) 1) (= (last3 temp___expr_7516) 1)))))
