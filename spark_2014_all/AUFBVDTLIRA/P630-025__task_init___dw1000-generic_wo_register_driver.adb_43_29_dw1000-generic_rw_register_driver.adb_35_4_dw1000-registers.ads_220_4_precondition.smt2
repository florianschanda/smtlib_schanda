...
(declare-const temp___8502 (Array Int bits_8))
(declare-const temp___85021 t1)
...
(assert (= (ite (<= (to_rep (first4 temp___85011)) (to_rep (last4 temp___85011))) (+ (- (to_rep (last4 temp___85011)) (to_rep (first4 temp___85011))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___8501 temp___8502))
(assert (= (mk1 (to_rep (first4 temp___85011)) (to_rep (last4 temp___85011))) temp___85021))
(assert (= (ite (<= (to_rep (first2 temp___85021)) (to_rep (last2 temp___85021))) (+ (- (to_rep (last2 temp___85021)) (to_rep (first2 temp___85021))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8502 temp___85021)))
(assert (= o2 o))
