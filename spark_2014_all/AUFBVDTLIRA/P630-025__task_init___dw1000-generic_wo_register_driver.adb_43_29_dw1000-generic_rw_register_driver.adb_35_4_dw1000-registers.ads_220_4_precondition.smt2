...
(assert (and (= (mk___t2 temp___7729 temp___77291) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7729 temp___77291) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77291)) (to_rep (last4 temp___77291))) (+ (- (to_rep (last4 temp___77291)) (to_rep (first4 temp___77291))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___7729 temp___7730))
(assert (= (mk1 (to_rep (first4 temp___77291)) (to_rep (last4 temp___77291))) temp___77301))
(assert (= (ite (<= (to_rep (first2 temp___77301)) (to_rep (last2 temp___77301))) (+ (- (to_rep (last2 temp___77301)) (to_rep (first2 temp___77301))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7730 temp___77301)))
(assert (= o2 o))
