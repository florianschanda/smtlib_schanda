...
(define-fun dynamic_invariant ((temp___expr_6789 us_t1) (temp___is_init_6786 Bool) (temp___skip_constant_6787 Bool) (temp___do_toplevel_6788 Bool)) Bool (=> (not (= temp___skip_constant_6787 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6789) (last3 temp___expr_6789)) (and (= (first3 temp___expr_6789) 1) (= (last3 temp___expr_6789) 2)))))
