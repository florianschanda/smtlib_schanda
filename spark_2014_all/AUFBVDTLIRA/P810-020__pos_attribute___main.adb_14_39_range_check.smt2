...
(define-fun default_initial_assumption ((temp___expr_580 us_rep) (temp___skip_top_level_581 Bool)) Bool (and (= (to_rep2 (rec__main__some_record__c1 (us_split_fields1 temp___expr_580))) #x00) (= (to_rep2 (rec__main__some_record__c2 (us_split_fields1 temp___expr_580))) #x00)))
