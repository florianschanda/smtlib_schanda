...
(define-fun default_initial_assumption ((temp___expr_509 us_rep) (temp___skip_top_level_510 Bool)) Bool (and (= (to_rep2 (rec__main__some_record__c1 (us_split_fields1 temp___expr_509))) ((_ int2bv 8) 0)) (= (to_rep2 (rec__main__some_record__c2 (us_split_fields1 temp___expr_509))) ((_ int2bv 8) 0))))
...
(assert (and (= main__off_c1__assume main__some_record__c1__position) (in_range main__some_record__c1__position)))
(assert (= main__off_c1__assume off_c1))
(assert (in_range off_c1))
(assert (not (in_range main__some_record__c2__position)))
(check-sat)
(exit)
