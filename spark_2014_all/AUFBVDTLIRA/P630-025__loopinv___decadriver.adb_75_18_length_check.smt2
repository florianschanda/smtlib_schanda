...
(assert (= o3 frame))
(assert (= o3 temp___5096))
(assert (= (mk1 (to_rep1 frame__first) r6b) temp___50961))
(assert (not (= (ite (<= (to_rep1 (first2 temp___50941)) (to_rep1 (last2 temp___50941))) (+ (- (to_rep1 (last2 temp___50941)) (to_rep1 (first2 temp___50941))) 1) 0) (ite (<= (to_rep1 (first2 temp___50961)) (to_rep1 (last2 temp___50961))) (+ (- (to_rep1 (last2 temp___50961)) (to_rep1 (first2 temp___50961))) 1) 0))))
(check-sat)
(exit)
