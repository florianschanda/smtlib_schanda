...
(assert (= result5 true))
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs3)) r10b))
(assert (in_range1 r10b))
(assert (= (to_rep2 o21) 1))
(assert (= o22 (mk___split_discrs o21)))
(assert (= temp___324 (mk___rep2 o22 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___324)) (rec__parse__parse_result_t__return_code result____split_discrs3))))
(check-sat)
(exit)
