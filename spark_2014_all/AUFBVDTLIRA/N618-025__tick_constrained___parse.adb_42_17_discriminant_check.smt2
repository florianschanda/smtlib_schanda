...
(declare-const o17 return_code_t)
(declare-const o18 us_split_discrs)
...
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= (rec__types__query_header__id header__split_fields3) o9)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= o8 o10)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= (rec__types__query_header__qdcount header__split_fields3) o11)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= temp___318 (mk___rep1 (mk___split_fields1 o9 o10 o11)))))
...
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= o13 (mk___split_fields1 (rec__types__query_header__id header__split_fields3) o12 (rec__types__query_header__qdcount header__split_fields3)))))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= temp___320 (mk___rep1 o13))))
...
(assert (= result5 (ite (= o16 false) (ite (not (= (to_rep (rec__types__octet__data (us_split_fields1 (select query 3)))) ((_ int2bv 8) 0))) true false) true)))
(assert (= result5 true))
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs3)) r10b))
(assert (in_range1 r10b))
(assert (= (to_rep2 o17) 1))
(assert (= o18 (mk___split_discrs o17)))
(assert (= temp___324 (mk___rep2 o18 (mk___split_fields2 dummy6) true)))
