...
(declare-const temp___372 us_rep2)
...
(assert (= temp___372 (mk___rep2 o18 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___372)) (rec__parse__parse_result_t__return_code result____split_discrs3))))
(check-sat)
(exit)
