...
(assert (forall ((temp___1171 (_ BitVec 8))) (forall ((temp___1172 Int) (temp___1173 Int)) (let ((temp___1170 (temp___1169 temp___1171 temp___1172 temp___1173))) (and (=> (dynamic_property6 1 2147483647 temp___1172 temp___1173) (and (= (first5 temp___1170) temp___1172) (= (last5 temp___1170) temp___1173))) (forall ((temp___1174 Int)) (= (select (to_array2 temp___1170) temp___1174) (of_rep1 temp___1171))))))))
(define-fun dynamic_invariant4 ((temp___expr_383 us_t1) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (not (= temp___skip_constant_381 true)) (and (dynamic_property3 1 r21b (first3 temp___expr_383) (last3 temp___expr_383)) (and (= (first3 temp___expr_383) 1) (= (last3 temp___expr_383) r21b)))))
...
(declare-const temp___1193 (_ BitVec 16))
(declare-const temp___1190 digit_index_type)
(declare-const temp___11901 (Array Int octet))
(declare-const temp___11902 t)
(declare-const temp___1189 (_ BitVec 16))
(declare-const temp___1188 (_ BitVec 16))
(declare-const temp___1187 (_ BitVec 16))
...
(declare-const temp___1186 us_rep)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1169 ((_ int2bv 8) 0) 1 r21b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1169 ((_ int2bv 8) 0) 1 r21b)))) r21b))
(assert (= (mk___t2 temp___1176 temp___11761) (temp___1169 ((_ int2bv 8) 0) 1 r21b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11761)) (to_rep2 (last4 temp___11761))) (+ (- (to_rep2 (last4 temp___11761)) (to_rep2 (first4 temp___11761))) 1) 0) (ite (<= 1 r21b) (+ (- r21b 1) 1) 0)))
(assert (= temp___1176 temp___1177))
(assert (= (mk1 (to_rep2 (first4 temp___11761)) (to_rep2 (last4 temp___11761))) temp___11771))
(assert (= (ite (<= (to_rep2 (first2 temp___11771)) (to_rep2 (last2 temp___11771))) (+ (- (to_rep2 (last2 temp___11771)) (to_rep2 (first2 temp___11771))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1179 temp___11791) (mk___t1 temp___1177 temp___11771)))
(assert (= temp___1179 o))
(assert (= (mk (to_rep2 (first2 temp___11791)) (to_rep2 (last2 temp___11791))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11811 temp___11812))))
(assert (= result____split_discrs (mk___split_discrs temp___1181)))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1192 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1192) (<= temp___1192 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1192) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1192) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1192)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
