...
(define-fun dynamic_invariant ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range1 temp___expr_223)))
...
(declare-fun temp___1240 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1242 (_ BitVec 8))) (forall ((temp___1243 Int) (temp___1244 Int)) (let ((temp___1241 (temp___1240 temp___1242 temp___1243 temp___1244))) (=> (dynamic_invariant3 temp___1242 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1243 temp___1244) (and (= (first5 temp___1241) temp___1243) (= (last5 temp___1241) temp___1244))) (forall ((temp___1245 Int)) (= (to_rep1 (select (to_array2 temp___1241) temp___1245)) temp___1242))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1240 #x00 1 r21b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1240 #x00 1 r21b)))) r21b))
(assert (= (mk___t2 temp___1247 temp___12471) (temp___1240 #x00 1 r21b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12471)) (to_rep2 (last4 temp___12471))) (+ (- (to_rep2 (last4 temp___12471)) (to_rep2 (first4 temp___12471))) 1) 0) (ite (<= 1 r21b) (+ (- r21b 1) 1) 0)))
(assert (= temp___1247 temp___1248))
(assert (= (mk1 (to_rep2 (first4 temp___12471)) (to_rep2 (last4 temp___12471))) temp___12481))
(assert (= (ite (<= (to_rep2 (first2 temp___12481)) (to_rep2 (last2 temp___12481))) (+ (- (to_rep2 (last2 temp___12481)) (to_rep2 (first2 temp___12481))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1250 temp___12501) (mk___t1 temp___1248 temp___12481)))
(assert (= temp___1250 o))
(assert (= (mk (to_rep2 (first2 temp___12501)) (to_rep2 (last2 temp___12501))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1263 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1263) (<= temp___1263 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1263) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1263) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1263)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
