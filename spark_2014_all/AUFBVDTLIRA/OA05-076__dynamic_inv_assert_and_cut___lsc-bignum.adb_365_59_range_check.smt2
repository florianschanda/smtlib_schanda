...
(assert (= a_msw3 o37))
(assert (= o105 (from_word32 ((_ int2bv 32) 1))))
...
(assert (= o98 (from_word32 ((_ int2bv 32) 2))))
...
(assert (and (= o89 (base Tuple0)) (= o89 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (= o88 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o87)))
