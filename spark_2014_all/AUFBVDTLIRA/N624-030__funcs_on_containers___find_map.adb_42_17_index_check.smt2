...
(assert (=> (= result1 true) (and (= o5 (get (model__ m) e)) (and (in_range6 o5) (= o5 (get (model__ m) e))))))
(assert (=> (= result1 true) (= o6 (ite (<= o5 (to_rep1 (last (rt a)))) true false))))
(assert (=> (= result1 true) (and (= o4 (get (model__ m) e)) (and (in_range6 o4) (= o4 (get (model__ m) e))))))
(assert (=> (= result1 true) (= o7 (ite (<= (to_rep1 (first (rt a))) o4) true false))))
(assert (=> (= result1 true) (= result (ite (= o7 true) o6 false))))
(assert (=> (not (= result1 true)) (= result (of_int 1))))
(assert (= result true))
(assert (and (= o1 (get (model__ m) e)) (and (in_range6 o1) (= o1 (get (model__ m) e)))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= (to_rep1 (first (rt a))) i) o3 false)))
(assert (= result2 true))
