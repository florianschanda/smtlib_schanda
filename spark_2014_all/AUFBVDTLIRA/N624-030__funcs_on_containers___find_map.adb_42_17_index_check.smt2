...
(assert (=> (= result1 true) (= o5 (ite (<= o4 (to_rep1 (last (rt a)))) true false))))
(assert (=> (= result1 true) (and (= o3 (get (model__ m) e)) (and (in_range6 o3) (= o3 (get (model__ m) e))))))
(assert (=> (= result1 true) (= o6 (ite (<= (to_rep1 (first (rt a))) o3) true false))))
