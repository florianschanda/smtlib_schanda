...
(assert (=> (= result1 true) (and (= o4 (get (model__ m) e)) (and (in_range3 o4) (= o4 (get (model__ m) e))))))
(assert (=> (= result1 true) (= o5 (ite (<= o4 (to_rep3 (last (rt a)))) true false))))
(assert (=> (= result1 true) (and (= o3 (get (model__ m) e)) (and (in_range3 o3) (= o3 (get (model__ m) e))))))
(assert (=> (= result1 true) (= o6 (ite (<= (to_rep3 (first (rt a))) o3) true false))))
...
(assert (= result2 (ite (<= (to_rep3 (first (rt a))) i) o2 false)))
(assert (= result2 true))
