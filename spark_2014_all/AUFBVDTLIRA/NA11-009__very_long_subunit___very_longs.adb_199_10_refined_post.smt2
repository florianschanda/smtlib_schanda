...
(assert (<= (+ very_longs__number_of_digits__result4 1) i15))
(assert (<= i15 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
(assert (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) i15)) #x00)))
(check-sat)
(exit)
