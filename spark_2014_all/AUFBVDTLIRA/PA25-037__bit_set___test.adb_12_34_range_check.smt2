...
(define-fun to_int4 ((x unsigned_32)) Int (bv2nat (to_rep x)))
...
(define-fun dynamic_invariant4 ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 2147483646)) (in_range3 temp___expr_202)))
(define-fun dynamic_invariant5 ((temp___expr_178 (_ BitVec 32)) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool true)
...
(declare-const test__bit_set__result1 Bool)
(declare-const test__bit_set__result2 Bool)
(declare-const test__bit_set__result3 Bool)
(declare-const test__bit_set__result4 Bool)
(declare-const test__bit_set__result5 Bool)
(assert (dynamic_invariant2 a true false true))
(assert (in_range2 a_first))
(assert true)
(assert (and (and (<= (to_rep1 (first (rt a))) a_first) (<= a_first (to_rep1 (last (rt a))))) (bvule (bvudiv i ((_ int2bv 64) 32)) ((_ int2bv 64) (- (to_rep1 (last (rt a))) a_first)))))
(assert (and (= temp___224 (bv2nat (bvurem i ((_ int2bv 64) 32)))) (in_range2 (bv2nat (bvurem i ((_ int2bv 64) 32))))))
(assert (=> (< temp___224 4294967296) (= o7 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___224)))))
(assert (=> (not (< temp___224 4294967296)) (= o7 ((_ int2bv 32) 0))))
(assert (not (in_range2 (bv2nat (bvudiv i ((_ int2bv 64) 32))))))
(check-sat)
(exit)
