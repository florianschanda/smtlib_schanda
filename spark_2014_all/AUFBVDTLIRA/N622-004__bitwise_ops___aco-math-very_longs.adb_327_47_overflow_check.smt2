...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= temp___1435 i1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= temp___1434 digit_index1)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= o2 (to_rep o1))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= o3 (ite (= o2 ((_ int2bv 8) 0)) true false))))
...
(assert (not (in_range1 (+ aco__math__very_longs__divide__get_msd__result4 1))))
(check-sat)
(exit)
