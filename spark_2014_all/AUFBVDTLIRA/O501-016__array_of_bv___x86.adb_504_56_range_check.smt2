...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr true true true true) (let ((result (readmem64 addr x86__memory))) (and (= result (bvor ((_ zero_extend 32) (readmem32 addr x86__memory)) (bvshl ((_ zero_extend 32) (readmem32 (bvadd addr #x0000000000000004) x86__memory)) ((_ int2bv 64) 32)))) (dynamic_invariant result true false true true)))) :pattern ((readmem64 addr x86__memory))))))
...
(assert (forall ((addr1 (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr1 true true true true) (let ((result (readmem8 addr1 x86__memory))) (and (= result (to_rep (select x86__memory addr1))) (dynamic_invariant3 result true false true true)))) :pattern ((readmem8 addr1 x86__memory))))))
...
(assert (forall ((addr1 (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr1 true true true true) (let ((result (readmem16 addr1 x86__memory))) (and (= result (bvor ((_ zero_extend 8) (to_rep (select x86__memory addr1))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select x86__memory (bvadd addr1 #x0000000000000001)))) ((_ int2bv 16) 8)) #x0000))) (dynamic_invariant2 result true false true true)))) :pattern ((readmem16 addr1 x86__memory))))))
(assert (forall ((addr1 (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr1 true true true true) (let ((result (readmem32 addr1 x86__memory))) (and (= result (bvor ((_ zero_extend 16) (readmem16 addr1 x86__memory)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr1 #x0000000000000002) x86__memory)) ((_ int2bv 32) 16)))) (dynamic_invariant1 result true false true true)))) :pattern ((readmem32 addr1 x86__memory))))))
...
(assert (and (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000001) memory2) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 8)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000001))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000002) memory3) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 16)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000002))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000003) memory4) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 24)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000003))) (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000004) memory5) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 32)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000004))) (= (to_rep (select memory5 i)) (to_rep (select memory4 i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000005) memory6) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 40)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000005))) (= (to_rep (select memory6 i)) (to_rep (select memory5 i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000006) memory7) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 48)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000006))) (= (to_rep (select memory7 i)) (to_rep (select memory6 i))))))))
(assert (not (bvule ((_ zero_extend 56) #x00) (bvand (bvlshr val__ ((_ int2bv 64) 56)) #x00000000000000FF))))
(check-sat)
(exit)
