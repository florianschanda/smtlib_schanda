...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr true true true) (let ((result (readmem64 addr x86__memory))) (and (= result (bvor ((_ zero_extend 32) (readmem32 addr x86__memory)) (bvshl ((_ zero_extend 32) (readmem32 (bvadd addr ((_ int2bv 64) 4)) x86__memory)) ((_ int2bv 64) 32)))) (dynamic_invariant result true false true)))) :pattern ((readmem64 addr x86__memory))))))
...
(define-fun dynamic_invariant2 ((temp___expr_214 (_ BitVec 16)) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool true)
...
(assert (forall ((addr1 (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr1 true true true) (let ((result (readmem8 addr1 x86__memory))) (and (= result (to_rep (select x86__memory addr1))) (dynamic_invariant3 result true false true)))) :pattern ((readmem8 addr1 x86__memory))))))
...
(assert (forall ((addr1 (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr1 true true true) (let ((result (readmem16 addr1 x86__memory))) (and (= result (bvor ((_ zero_extend 8) (to_rep (select x86__memory addr1))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select x86__memory (bvadd addr1 ((_ int2bv 64) 1))))) ((_ int2bv 16) 8)) ((_ int2bv 16) 0)))) (dynamic_invariant2 result true false true)))) :pattern ((readmem16 addr1 x86__memory))))))
(assert (forall ((addr1 (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr1 true true true) (let ((result (readmem32 addr1 x86__memory))) (and (= result (bvor ((_ zero_extend 16) (readmem16 addr1 x86__memory)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr1 ((_ int2bv 64) 2)) x86__memory)) ((_ int2bv 32) 16)))) (dynamic_invariant1 result true false true)))) :pattern ((readmem32 addr1 x86__memory))))))
...
(assert (and (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory2) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 8)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 1)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 2)) memory3) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 16)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 2)))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory4) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 24)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 3)))) (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 4)) memory5) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 32)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 4)))) (= (to_rep (select memory5 i)) (to_rep (select memory4 i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 5)) memory6) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 40)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 5)))) (= (to_rep (select memory6 i)) (to_rep (select memory5 i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 6)) memory7) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 48)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 6)))) (= (to_rep (select memory7 i)) (to_rep (select memory6 i))))))))
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand (bvlshr val__ ((_ int2bv 64) 56)) ((_ int2bv 64) 255)))))
(check-sat)
(exit)
