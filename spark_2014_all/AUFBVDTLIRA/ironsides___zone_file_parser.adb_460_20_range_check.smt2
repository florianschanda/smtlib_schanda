...
(assert (= begidx7 o48))
(assert (and (and (and (and (<= begidx8 endidx5) (<= begidx8 zlength)) (<= endidx5 zlength)) (=> (= foundtype5 1) (forall ((i26 Int)) (=> (and (<= begidx8 i26) (<= i26 endidx5)) (and (<= 48 (to_rep (select zonefileline i26))) (<= (to_rep (select zonefileline i26)) 57)))))) (and (and (in_range5 begidx8) (in_range5 endidx5)) (in_range4 foundtype5))))
