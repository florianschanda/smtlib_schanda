...
(assert (= i8 r78b))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= temp___1742 newdomainname1)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= temp___1741 i8)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= temp___1744 endidx9)))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)) (= endidx9 temp___1744))))
...
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (= temp___1740 o5) (in_range1 o5))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (and (<= 1 temp___1740) (<= temp___1740 128))))
(assert (=> (and (<= r78b i8) (<= i8 r79b)) (= o7 temp___1740)))
