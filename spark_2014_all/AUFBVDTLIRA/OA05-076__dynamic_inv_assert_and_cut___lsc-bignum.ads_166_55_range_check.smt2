...
(assert (= o35 (ite (<= o34 (to_rep (last (rt b)))) true false)))
(assert (and (= o29 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o30 (+ b_first o29)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (= o36 (ite (<= (to_rep (first (rt b))) o31) true false)))
(assert (= result (ite (= o36 true) o35 false)))
(assert (= result true))
...
(assert (= o27 (ite (<= o26 (to_rep (last (rt c)))) true false)))
(assert (and (= o21 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o22 (+ c_first o21)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o28 (ite (<= (to_rep (first (rt c))) o23) true false)))
...
(assert (= o19 (ite (<= o18 (to_rep (last (rt m)))) true false)))
(assert (and (= o13 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o14 (+ m_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o20 (ite (<= (to_rep (first (rt m))) o15) true false)))
(assert (= result2 (ite (= o20 true) o19 false)))
(assert (= result2 true))
