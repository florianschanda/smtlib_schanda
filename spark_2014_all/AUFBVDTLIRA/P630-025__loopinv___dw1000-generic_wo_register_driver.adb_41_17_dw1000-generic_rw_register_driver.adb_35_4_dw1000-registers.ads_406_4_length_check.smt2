...
(define-fun dynamic_invariant ((temp___expr_4996 us_t1) (temp___is_init_4993 Bool) (temp___skip_constant_4994 Bool) (temp___do_toplevel_4995 Bool)) Bool (=> (not (= temp___skip_constant_4994 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4996) (last3 temp___expr_4996)) (and (= (first3 temp___expr_4996) 1) (= (last3 temp___expr_4996) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5012 us_t2) (temp___is_init_5009 Bool) (temp___skip_constant_5010 Bool) (temp___do_toplevel_5011 Bool)) Bool (=> (not (= temp___skip_constant_5010 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5012) (last5 temp___expr_5012)) (and (= (first5 temp___expr_5012) 1) (= (last5 temp___expr_5012) 2)))))
...
(assert (and (= (mk___t2 temp___7963 temp___79631) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7963 temp___79631) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79631)) (to_rep (last4 temp___79631))) (+ (- (to_rep (last4 temp___79631)) (to_rep (first4 temp___79631))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7963 temp___7964))
(assert (= (mk1 (to_rep (first4 temp___79631)) (to_rep (last4 temp___79631))) temp___79641))
(assert (not (= (ite (<= (to_rep (first2 temp___79641)) (to_rep (last2 temp___79641))) (+ (- (to_rep (last2 temp___79641)) (to_rep (first2 temp___79641))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
