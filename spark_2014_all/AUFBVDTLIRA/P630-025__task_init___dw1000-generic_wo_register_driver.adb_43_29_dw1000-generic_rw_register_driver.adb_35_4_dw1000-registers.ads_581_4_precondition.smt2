...
(assert (= (ite (<= (to_rep (first4 temp___81681)) (to_rep (last4 temp___81681))) (+ (- (to_rep (last4 temp___81681)) (to_rep (first4 temp___81681))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8168 temp___8169))
(assert (= (mk1 (to_rep (first4 temp___81681)) (to_rep (last4 temp___81681))) temp___81691))
(assert (= (ite (<= (to_rep (first2 temp___81691)) (to_rep (last2 temp___81691))) (+ (- (to_rep (last2 temp___81691)) (to_rep (first2 temp___81691))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
