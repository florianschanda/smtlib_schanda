...
(define-fun dynamic_invariant ((temp___expr_292 us_t) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool)) Bool (=> (not (= temp___skip_constant_290 true)) (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (first1 temp___expr_292) (last1 temp___expr_292))))
(define-fun dynamic_invariant1 ((temp___expr_286 (_ BitVec 64)) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool true)
(declare-fun create ((_ BitVec 64)) us_t)
(declare-fun create__function_guard (us_t (_ BitVec 64)) Bool)
(assert (forall ((last2 (_ BitVec 64))) (! (=> (dynamic_invariant1 last2 true true true) (let ((result (create last2))) (and (and (= (last1 result) last2) (= (first1 result) ((_ int2bv 64) 0))) (dynamic_invariant result true false true)))) :pattern ((create last2)))))
...
(assert (and (= (mk___t fail__c__assume fail__c__assume1) (create ((_ int2bv 64) 18446744073709551615))) (and (dynamic_invariant (mk___t fail__c__assume fail__c__assume1) true false true) (and (= (to_rep (last fail__c__assume1)) ((_ int2bv 64) 18446744073709551615)) (= (to_rep (first fail__c__assume1)) ((_ int2bv 64) 0))))))
(assert (= (mk___t fail__c__assume fail__c__assume1) c))
(assert (dynamic_invariant c true false true))
(assert (not (= (to_rep (first (rt c))) ((_ int2bv 64) 0))))
(check-sat)
(exit)
