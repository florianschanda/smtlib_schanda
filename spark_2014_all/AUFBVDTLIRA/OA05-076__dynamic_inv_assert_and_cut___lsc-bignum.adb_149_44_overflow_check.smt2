...
(assert (= o39 (ite (<= o38 k) true false)))
(assert (= result7 (ite (= o39 true) (ite (<= k a_last) true false) false)))
(assert (= (= o40 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 a_last)) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o36 (num_of_boolean carry3)))
