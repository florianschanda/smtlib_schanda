...
(assert true)
(assert true)
(assert (and (and (and (and (and (and (and (<= (to_rep a__first) a_first) (<= a_first (to_rep a__last))) (and (<= (to_rep a__first) (+ a_last 1)) (<= (+ a_last 1) (to_rep a__last)))) (<= a_first a_last)) (and (<= (to_rep (first (rt b))) b_first) (<= b_first (to_rep (last (rt b)))))) (and (<= (to_rep (first (rt b))) (+ b_first (- a_last a_first))) (<= (+ b_first (- a_last a_first)) (to_rep (last (rt b)))))) (and (<= (to_rep (first (rt c))) c_first) (<= c_first (to_rep (last (rt c)))))) (and (<= (to_rep (first (rt c))) (+ c_first (- a_last a_first))) (<= (+ c_first (- a_last a_first)) (to_rep (last (rt c)))))))
(assert true)
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (= temp___738 a) (and (= temp___731 a) (and (= temp___740 a) (and (= temp___742 carry2) (and (= temp___743 a) (and (= temp___730 carry2) (and (= temp___736 carry2) (and (= temp___728 a) (and (= temp___741 carry1) (and (= temp___729 carry1) (and (= temp___735 carry1) (and (= temp___734 i1) (and (= temp___733 temp) (and (and (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t temp___740 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (- i2 a_first)) (omultiply (num_of_big_int b b_first (- i2 a_first)) (from_word32 x))) (omultiply (num_of_big_int c c_first (- i2 a_first)) (from_word32 y))) (from_word32 temp___741)) (omultiply (base Tuple0) (from_word32 temp___742))) (oadd (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (oadd (from_word32 carry12) (omultiply (base Tuple0) (from_word32 carry22)))))) true) (forall ((k2 Int)) (=> (and (<= i2 k2) (<= k2 (+ a_last 1))) (= (to_rep1 (select a2 k2)) (to_rep1 (select temp___743 k2)))))) (and (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___739 Int)) (=> (and (<= (to_rep a__first) temp___739) (<= temp___739 (to_rep a__last))) (=> (<= i2 temp___739) (= (select a2 temp___739) (select temp___738 temp___739)))))) (and (<= a_first i2) (<= i2 a_last))) (and (and (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t temp___728 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (- (+ i2 1) a_first)) (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (from_word32 x))) (omultiply (num_of_big_int c c_first (- (+ i2 1) a_first)) (from_word32 y))) (from_word32 temp___729)) (omultiply (base Tuple0) (from_word32 temp___730))) (oadd (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (oadd (from_word32 carry13) (omultiply (base Tuple0) (from_word32 carry23)))))) true) (forall ((k2 Int)) (=> (and (<= (+ i2 1) k2) (<= k2 (+ a_last 1))) (= (to_rep1 (select a3 k2)) (to_rep1 (select temp___731 k2)))))) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (= i2 a_last)))))))))))))))))) (and (and (= i2 i6) (and (= temp4 temp7) (and (= carry23 carry26) (and (= carry13 carry16) (= a3 a6))))) (and (= i7 i2) (and (= temp8 temp4) (and (= carry27 carry23) (and (= carry17 carry13) (= a7 a3)))))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i8 (mk_int__ref i6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp9 (mk_t__ref temp7))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry28 (mk_t__ref carry26))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (mk_t__ref carry18) (mk_t__ref carry16))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (mk_map__ref a8) (mk_map__ref a6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i9 i7)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp10 temp8)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry29 carry27)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry19 carry17)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a9 a7)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i8 (mk_int__ref i1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= temp9 (mk_t__ref temp))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry28 (mk_t__ref carry2))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= (mk_t__ref carry18) (mk_t__ref carry1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= (mk_map__ref a8) (mk_map__ref a))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i9 i1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= temp10 temp1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry29 carry21)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry19 carry11)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a9 a1)))
(assert (= i10 i8))
(assert (= temp11 temp9))
(assert (= carry210 carry28))
(assert (= carry110 (mk_t__ref carry18)))
(assert (= a10 (mk_map__ref a8)))
(assert (= i11 i9))
(assert (= temp12 temp10))
(assert (= carry211 carry29))
(assert (= carry111 carry19))
(assert (= a11 a9))
(assert (= o159 (from_word32 (t__content carry210))))
(assert (and (= o158 (base Tuple0)) (= o158 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o160 (omultiply o158 o159)))
(assert (= o157 (from_word32 (t__content carry110))))
(assert (= o161 (oadd o157 o160)))
(assert (and (= o152 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o153 (+ o152 1)))
(assert (and (= o154 o153) (in_range1 o153)))
(assert (and (= o155 o154) (in_range2 o154)))
(assert (and (= o151 (base Tuple0)) (= o151 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o156 (oexpon o151 o155)))
(assert (= o162 (omultiply o156 o161)))
(assert (and (= o146 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o147 (+ o146 1)))
(assert (and (= o148 o147) (in_range1 o147)))
(assert (and (= o149 o148) (in_range2 o148)))
(assert (= o150 (num_of_big_int (mk___t (map__content a10) (mk (to_rep a__first) (to_rep a__last))) a_first o149)))
(assert (= o163 (oadd o150 o162)))
(assert (= o144 (from_word32 carry2)))
(assert (and (= o143 (base Tuple0)) (= o143 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o145 (omultiply o143 o144)))
(assert (= o142 (from_word32 carry1)))
(assert (= o140 (from_word32 y)))
(assert (and (= o135 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o136 (+ o135 1)))
(assert (and (= o137 o136) (in_range1 o136)))
(assert (and (= o138 o137) (in_range2 o137)))
(assert (= o139 (num_of_big_int c c_first o138)))
(assert (= o141 (omultiply o139 o140)))
(assert (= o133 (from_word32 x)))
(assert (and (= o128 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o129 (+ o128 1)))
(assert (and (= o130 o129) (in_range1 o129)))
(assert (and (= o131 o130) (in_range2 o130)))
(assert (= o132 (num_of_big_int b b_first o131)))
(assert (= o134 (omultiply o132 o133)))
(assert (and (= o124 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o125 (+ o124 1)))
(assert (and (= o126 o125) (in_range1 o125)))
(assert (not (in_range2 o126)))
(check-sat)
(exit)
