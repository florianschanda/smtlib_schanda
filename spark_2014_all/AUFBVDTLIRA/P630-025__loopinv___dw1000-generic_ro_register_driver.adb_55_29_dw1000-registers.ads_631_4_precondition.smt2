...
(define-fun dynamic_invariant ((temp___expr_7138 us_t1) (temp___is_init_7135 Bool) (temp___skip_constant_7136 Bool) (temp___do_toplevel_7137 Bool)) Bool (=> (not (= temp___skip_constant_7136 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7138) (last3 temp___expr_7138)) (and (= (first3 temp___expr_7138) 1) (= (last3 temp___expr_7138) 2)))))
