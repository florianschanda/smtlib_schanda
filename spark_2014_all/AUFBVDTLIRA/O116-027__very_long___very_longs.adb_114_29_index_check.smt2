...
(declare-fun temp_____aggregate_def_1219 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1221 (_ BitVec 8))) (forall ((temp___1222 Int) (temp___1223 Int)) (let ((temp___1220 (temp_____aggregate_def_1219 temp___1221 temp___1222 temp___1223))) (=> (dynamic_invariant temp___1221 true true true true) (and (=> (dynamic_property7 1 65536 temp___1222 temp___1223) (and (= (first5 temp___1220) temp___1222) (= (last5 temp___1220) temp___1223))) (forall ((temp___1224 Int)) (= (to_rep2 (select (to_array2 temp___1220) temp___1224)) temp___1221))))))))
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1219 #x00 1 r19b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1219 #x00 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1226 temp___12261) (temp_____aggregate_def_1219 #x00 1 r19b)))
(assert (= (ite (<= (to_rep1 (first4 temp___12261)) (to_rep1 (last4 temp___12261))) (+ (- (to_rep1 (last4 temp___12261)) (to_rep1 (first4 temp___12261))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1226 temp___1227))
(assert (= (mk1 (to_rep1 (first4 temp___12261)) (to_rep1 (last4 temp___12261))) temp___12271))
(assert (= (ite (<= (to_rep1 (first2 temp___12271)) (to_rep1 (last2 temp___12271))) (+ (- (to_rep1 (last2 temp___12271)) (to_rep1 (first2 temp___12271))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1229 temp___12291) (mk___t1 temp___1227 temp___12271)))
(assert (= temp___1229 o))
(assert (= (mk (to_rep1 (first2 temp___12291)) (to_rep1 (last2 temp___12291))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (and (=> (<= 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))) (dynamic_property6 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i2)) (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true true)) (forall ((temp___1245 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1245) (<= temp___1245 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1245) (or (< temp___1245 1) (<= i2 temp___1245))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1245) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1245)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) r23b))
(assert (in_range2 r23b))
(assert (and (<= 1 i2) (<= i2 r23b)))
(assert (= o12 (takelsb_from16 difference2)))
(assert (= (to_rep2 o13) o12))
(assert (not (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(check-sat)
(exit)
