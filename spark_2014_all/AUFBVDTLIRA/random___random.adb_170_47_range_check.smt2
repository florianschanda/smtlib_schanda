...
(define-fun x10 () t__ref (mk_t__ref x5))
(define-fun g__split_fields15 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields g__split_fields10 g__split_fields11)))
(define-fun g__split_fields16 () us_split_fields (mk___split_fields g__split_fields8 g__split_fields9))
(define-fun g__split_fields17 () us_split_fields (mk___split_fields g__split_fields2 g__split_fields3))
...
(assert (=> (and (= min (- 2147483648)) (= max 2147483647)) (= g__split_fields13 (mk___split_fields__ref g__split_fields17))))
(assert (=> (and (= min (- 2147483648)) (= max 2147483647)) (= x9 x1)))
(assert (=> (and (= min (- 2147483648)) (= max 2147483647)) (= g__split_fields14 g__split_fields17)))
...
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (or (= slop n) (bvule x2 (bvsub ((_ int2bv 32) 4294967295) slop)))))
...
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= g__split_fields16 (mk___split_fields g__split_fields4 g__split_fields5))))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x10 (mk_t__ref x3))))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= g__split_fields15 (mk___split_fields__ref (mk___split_fields g__split_fields6 g__split_fields7)))))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x6 x4)))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= g__split_fields12 g__split_fields16)))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= result x10)))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x7 (bvurem x5 n))))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (and (bvule ((_ int2bv 32) 0) x7) (bvule x7 (bvsub n ((_ int2bv 32) 1))))))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x8 (mk_t__ref x7))))
(assert (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= g__split_fields13 g__split_fields15)))
...
(assert (not (in_range1 (+ min (bv2nat (t__content x8))))))
(check-sat)
(exit)
