...
(define-fun to_int2 ((x unsigned16)) Int (bv2nat (to_rep1 x)))
(assert (forall ((x unsigned16)) (! (uint_in_range (to_int2 x)) :pattern ((to_int2 x)))))
...
(define-fun bool_eq1 ((a (Array Int unsigned16)) (a__first Int) (a__last Int) (b (Array Int unsigned16)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep1 (select a temp___idx_173)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
...
(declare-fun ipv6addrtypeindexqtint (ipv6addrtypeindex) Int)
(assert (forall ((i ipv6addrtypeindex)) (and (<= 1 (ipv6addrtypeindexqtint i)) (<= (ipv6addrtypeindexqtint i) 8))))
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 8)))
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun user_eq4 (ipv6addrtypeindex ipv6addrtypeindex) Bool)
(declare-const dummy4 ipv6addrtypeindex)
...
(define-fun dynamic_invariant4 ((temp___expr_649 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1 8)) (in_range4 temp___expr_649)))
(assert (= invalid_ipv6_addr (rr_type__aaaa_record_type__invalid_ipv6_addr__aggregate_def #x0000)))
(assert (forall ((temp___175 (_ BitVec 16))) (=> (dynamic_invariant3 temp___175 true true true true) (forall ((temp___176 Int)) (= (to_rep1 (select (rr_type__aaaa_record_type__invalid_ipv6_addr__aggregate_def temp___175) temp___176)) temp___175)))))
...
(assert (= (rr_type__aaaa_record_type__invalid_ipv6_addr__aggregate_def #x0000) invalid_ipv6_addr))
(assert (in_range3 zlength))
(assert (= result begidx))
(assert (= begidx1 1))
(assert (in_range3 begidx1))
