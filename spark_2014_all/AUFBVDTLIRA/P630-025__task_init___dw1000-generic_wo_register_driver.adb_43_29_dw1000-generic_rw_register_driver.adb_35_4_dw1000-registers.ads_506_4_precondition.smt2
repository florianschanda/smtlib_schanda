...
(define-fun dynamic_invariant ((temp___expr_6676 us_t1) (temp___is_init_6672 Bool) (temp___skip_constant_6673 Bool) (temp___do_toplevel_6674 Bool) (temp___do_typ_inv_6675 Bool)) Bool (=> (not (= temp___skip_constant_6673 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6676) (last3 temp___expr_6676)) (and (= (first3 temp___expr_6676) 1) (= (last3 temp___expr_6676) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6694 us_t2) (temp___is_init_6690 Bool) (temp___skip_constant_6691 Bool) (temp___do_toplevel_6692 Bool) (temp___do_typ_inv_6693 Bool)) Bool (=> (not (= temp___skip_constant_6691 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6694) (last5 temp___expr_6694)) (and (= (first5 temp___expr_6694) 1) (= (last5 temp___expr_6694) 1)))))
...
(declare-const temp___8855 (Array Int bits_8))
(declare-const temp___88551 t2)
(declare-const temp___8856 (Array Int bits_8))
(declare-const temp___88561 t1)
...
(define-fun temp___88552 () us_t2 (mk___t2 temp___8855 temp___88551))
...
(assert (and (= temp___88552 (register_to_bytes reg)) (dynamic_invariant1 temp___88552 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___88551)) (to_rep (last4 temp___88551))) (+ (- (to_rep (last4 temp___88551)) (to_rep (first4 temp___88551))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8855 temp___8856))
(assert (= (mk1 (to_rep (first4 temp___88551)) (to_rep (last4 temp___88551))) temp___88561))
(assert (= (ite (<= (to_rep (first2 temp___88561)) (to_rep (last2 temp___88561))) (+ (- (to_rep (last2 temp___88561)) (to_rep (first2 temp___88561))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8856 temp___88561)))
(assert (= o2 o))
