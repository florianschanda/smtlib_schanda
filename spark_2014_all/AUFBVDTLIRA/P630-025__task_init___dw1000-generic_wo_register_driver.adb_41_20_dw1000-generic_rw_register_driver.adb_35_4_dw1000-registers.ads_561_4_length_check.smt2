...
(assert (and (= (mk___t2 temp___8150 temp___81501) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8150 temp___81501) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___81501)) (to_rep (last4 temp___81501))) (+ (- (to_rep (last4 temp___81501)) (to_rep (first4 temp___81501))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
