...
(define-fun dynamic_invariant ((temp___expr_7387 us_t1) (temp___is_init_7383 Bool) (temp___skip_constant_7384 Bool) (temp___do_toplevel_7385 Bool) (temp___do_typ_inv_7386 Bool)) Bool (=> (not (= temp___skip_constant_7384 true)) (and (dynamic_property2 1 1 (first3 temp___expr_7387) (last3 temp___expr_7387)) (and (= (first3 temp___expr_7387) 1) (= (last3 temp___expr_7387) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7406 us_t2) (temp___is_init_7402 Bool) (temp___skip_constant_7403 Bool) (temp___do_toplevel_7404 Bool) (temp___do_typ_inv_7405 Bool)) Bool (=> (not (= temp___skip_constant_7403 true)) (and (dynamic_property3 1 1 (first5 temp___expr_7406) (last5 temp___expr_7406)) (and (= (first5 temp___expr_7406) 1) (= (last5 temp___expr_7406) 1)))))
...
(declare-const temp___89221 t2)
(define-fun temp___89222 () us_t2 (mk___t2 temp___8922 temp___89221))
...
(assert (and (= temp___89222 (register_to_bytes reg)) (dynamic_invariant1 temp___89222 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___89221)) (to_rep (last4 temp___89221))) (+ (- (to_rep (last4 temp___89221)) (to_rep (first4 temp___89221))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
