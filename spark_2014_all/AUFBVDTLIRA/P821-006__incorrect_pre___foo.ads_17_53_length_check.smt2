...
(define-fun dynamic_invariant ((temp___expr_208 us_t) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (not (= temp___skip_constant_206 true)) (dynamic_property 0 2147483647 (first1 temp___expr_208) (last1 temp___expr_208))))
...
(define-fun dynamic_invariant1 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_236)))
...
(assert (forall ((s (Array Int byte))) (! (dynamic_invariant1 (from_byte_array_to_integer_32 s) true false true) :pattern ((from_byte_array_to_integer_32 s)))))
