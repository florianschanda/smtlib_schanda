...
(define-fun dynamic_invariant ((temp___expr_275 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool) (temp___do_typ_inv_274 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_275)))
(assert (forall ((s (Array Int byte))) (! (dynamic_invariant (from_byte_array_to_integer_32 s) true false true true) :pattern ((from_byte_array_to_integer_32 s)))))
