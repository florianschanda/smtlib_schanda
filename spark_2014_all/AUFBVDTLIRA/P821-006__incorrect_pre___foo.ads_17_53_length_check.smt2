...
(define-fun dynamic_invariant ((temp___expr_243 us_t) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool (=> (not (= temp___skip_constant_240 true)) (dynamic_property 0 2147483647 (first1 temp___expr_243) (last1 temp___expr_243))))
...
(define-fun dynamic_invariant1 ((temp___expr_275 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool) (temp___do_typ_inv_274 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_275)))
...
(assert (forall ((s (Array Int byte))) (! (dynamic_invariant1 (from_byte_array_to_integer_32 s) true false true true) :pattern ((from_byte_array_to_integer_32 s)))))
...
(assert (not (= (ite (<= (to_rep1 (first (rt bytes))) (to_rep1 (last (rt bytes)))) (+ (- (to_rep1 (last (rt bytes))) (to_rep1 (first (rt bytes)))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
