...
(assert (forall ((x86__rax (_ BitVec 64))) (! (=> (dynamic_invariant x86__rax true true true) (let ((result (ax x86__rax))) (and (= result (readreg16 x86__rax)) (dynamic_invariant1 result true false true)))) :pattern ((ax x86__rax)))))
...
(assert true)
(assert true)
(assert (and (= o (readmem64 rsp (map__content memory))) (and (and (and (and (and (and (and (= (bvand o ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep (select (map__content memory) rsp)))) (= (bvand o ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep (select (map__content memory) (bvadd rsp ((_ int2bv 64) 1))))) ((_ int2bv 64) 256)))) (= (bvand o ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep (select (map__content memory) (bvadd rsp ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536)))) (= (bvand o ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) (to_rep (select (map__content memory) (bvadd rsp ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216)))) (= (bvand o ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) (to_rep (select (map__content memory) (bvadd rsp ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296)))) (= (bvand o ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) (to_rep (select (map__content memory) (bvadd rsp ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776)))) (= (bvand o ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) (to_rep (select (map__content memory) (bvadd rsp ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656)))) (= (bvand o ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) (to_rep (select (map__content memory) (bvadd rsp ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936))))))
(assert (= o1 o))
