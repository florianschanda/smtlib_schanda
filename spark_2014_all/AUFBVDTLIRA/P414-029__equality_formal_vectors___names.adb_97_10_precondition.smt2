...
(assert (and (= temp___612 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) o33)) (= (bool_eq4 temp___612 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) o33)) true)))
(assert (= (to_rep3 o34) n12))
(assert (= o35 (mk___split_fields2 (rec__names__name_entry__table_index (us_split_fields5 temp___612)) (rec__names__name_entry__length (us_split_fields5 temp___612)) o34)))
(assert (= o36 (mk___rep2 o35)))
(assert (and (= o32 (int__content ptr10)) (in_range14 (int__content ptr10))))
(assert (not (<= 1 o32)))
(check-sat)
(exit)
