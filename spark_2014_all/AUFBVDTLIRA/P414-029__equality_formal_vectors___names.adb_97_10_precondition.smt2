...
(assert (=> (in_range9 n3) (and (= o33 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) (= (bool_eq4 o33 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) true))))
...
(assert (and (= o29 (int__content ptr10)) (in_range14 (int__content ptr10))))
(assert (and (= temp___675 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields1)) o29)) (= (bool_eq4 temp___675 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields1)) o29)) true)))
(assert (= (to_rep3 o30) n12))
(assert (= o31 (mk___split_fields2 (rec__names__name_entry__table_index (us_split_fields5 temp___675)) (rec__names__name_entry__length (us_split_fields5 temp___675)) o30)))
(assert (= o32 (mk___rep2 o31)))
(assert (and (= o28 (int__content ptr10)) (in_range14 (int__content ptr10))))
(assert (not (<= 1 o28)))
(check-sat)
(exit)
