...
(define-fun dynamic_invariant ((temp___expr_5437 us_t1) (temp___is_init_5434 Bool) (temp___skip_constant_5435 Bool) (temp___do_toplevel_5436 Bool)) Bool (=> (not (= temp___skip_constant_5435 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5437) (last3 temp___expr_5437)) (and (= (first3 temp___expr_5437) 1) (= (last3 temp___expr_5437) 2)))))
