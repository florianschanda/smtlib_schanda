...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i32 Int)) (=> (and (<= begidx2 i32) (<= i32 endidx1)) (and (<= 48 (to_rep (select zonefileline i32))) (<= (to_rep (select zonefileline i32)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 foundtype1))))
...
(assert (=> (= success20 true) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i32 Int)) (=> (and (<= begidx4 i32) (<= i32 endidx2)) (and (<= 48 (to_rep (select zonefileline i32))) (<= (to_rep (select zonefileline i32)) 57)))))) (and (and (in_range5 begidx4) (in_range5 endidx2)) (in_range4 foundtype2)))))
...
(assert (= begidx7 o48))
(assert (and (and (and (and (<= begidx8 endidx5) (<= begidx8 zlength)) (<= endidx5 zlength)) (=> (= foundtype5 1) (forall ((i32 Int)) (=> (and (<= begidx8 i32) (<= i32 endidx5)) (and (<= 48 (to_rep (select zonefileline i32))) (<= (to_rep (select zonefileline i32)) 57)))))) (and (and (in_range5 begidx8) (in_range5 endidx5)) (in_range4 foundtype5))))
...
(assert (and (<= 1 temp___1549) (<= temp___1549 128)))
(assert (= o53 temp___1549))
...
(assert (= temp___1551 (mk___rep1 o55 rrsig_rec__attr__tag)))
(assert (= result18 (mk___split_fields__ref1 rrsig_rec__split_fields27)))
(assert (= rrsig_rec__split_fields28 (us_split_fields3 temp___1551)))
(assert (not (= i26 r14b)))
