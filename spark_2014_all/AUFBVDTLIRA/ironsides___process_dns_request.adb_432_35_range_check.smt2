...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rr_type__ns_record_type__nsrecordtype__nameserver (Array Int character)) (rec__rr_type__resourcerecordtype__ttlinseconds1 unsigned32) (rec__rr_type__resourcerecordtype__class1 classtype) (rec__ext__1 us_private)))))
(define-fun us_split_fields_NameServer__projection ((a us_split_fields2)) (Array Int character) (rec__rr_type__ns_record_type__nsrecordtype__nameserver a))
(define-fun us_split_fields_TTLInSeconds__7__projection ((a us_split_fields2)) unsigned32 (rec__rr_type__resourcerecordtype__ttlinseconds1 a))
(define-fun us_split_fields_Class__7__projection ((a us_split_fields2)) classtype (rec__rr_type__resourcerecordtype__class1 a))
(define-fun us_split_fields___8__projection ((a us_split_fields2)) us_private (rec__ext__1 a))
...
(define-fun us_rep___19__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun us_rep___20__projection ((a us_rep1)) Int (attr__tag1 a))
...
(assert (forall ((nameserver (Array Int character))) (forall ((rec__ext__2 us_private)) (= (extract__nameserver (hide_ext__ nameserver rec__ext__2)) nameserver))))
(declare-fun extract__ext__ (us_private) us_private)
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (mk___split_fields (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a)) (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a)) (hide_ext__ (rec__rr_type__ns_record_type__nsrecordtype__nameserver (us_split_fields3 a)) (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (mk___split_fields1 (extract__nameserver (rec__ext__ (us_split_fields1 r))) (rec__rr_type__resourcerecordtype__ttlinseconds (us_split_fields1 r)) (rec__rr_type__resourcerecordtype__class (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (bool_eq (rec__rr_type__ns_record_type__nsrecordtype__nameserver (us_split_fields3 a)) 1 129 (rec__rr_type__ns_record_type__nsrecordtype__nameserver (us_split_fields3 b)) 1 129) true) (= (to_rep2 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a))) (to_rep2 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 b))))) (= (to_rep3 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a))) (to_rep3 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 b))))) true false))
...
(declare-const rr_type__ns_record_type__nsrecordtype__nameserver__first__bit Int)
(declare-const rr_type__ns_record_type__nsrecordtype__nameserver__last__bit Int)
(declare-const rr_type__ns_record_type__nsrecordtype__nameserver__position Int)
(assert (<= 0 rr_type__ns_record_type__nsrecordtype__nameserver__first__bit))
(assert (< rr_type__ns_record_type__nsrecordtype__nameserver__first__bit rr_type__ns_record_type__nsrecordtype__nameserver__last__bit))
(assert (<= 0 rr_type__ns_record_type__nsrecordtype__nameserver__position))
...
(declare-datatypes () ((nsrecordtype__ref (mk_nsrecordtype__ref (nsrecordtype__content us_rep1)))))
(define-fun nsrecordtype__ref___projection ((a nsrecordtype__ref)) us_rep1 (nsrecordtype__content a))
(define-fun default_initial_assumption ((temp___expr_1396 us_rep1) (temp___skip_top_level_1397 Bool)) Bool (= (attr__tag1 temp___expr_1396) us_tag1))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const start_byte Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const ns_record us_rep1)
...
(assert (not (in_range2 (+ start_byte 4))))
(check-sat)
(exit)
