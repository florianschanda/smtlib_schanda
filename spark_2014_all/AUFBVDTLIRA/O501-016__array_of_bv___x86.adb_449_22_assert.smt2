...
(assert (= (bvor ((_ zero_extend 8) (readmem8 addr memory)) (ite (< 8 16) (bvshl ((_ zero_extend 8) (readmem8 (bvadd addr #x0000000000000001) memory)) ((_ int2bv 16) 8)) #x0000)) (readmem16 addr memory)))
(assert (not (= (bvor (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr #x0000000000000002) memory)) ((_ int2bv 32) 16)) (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr #x0000000000000003) memory)) ((_ int2bv 32) 24))) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) memory)) ((_ int2bv 32) 16)))))
(check-sat)
(exit)
