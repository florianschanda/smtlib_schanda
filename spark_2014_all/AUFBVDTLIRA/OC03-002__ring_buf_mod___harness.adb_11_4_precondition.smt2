...
(declare-fun temp___246 (Int) (Array (_ BitVec 16) integer))
...
(assert (forall ((m us_t)) (! (=> (dynamic_invariant3 m true true true true) (= (func_head m) (to_rep2 (select (to_array m) (first1 m))))) :pattern ((func_head m)))))
...
(assert (forall ((m us_t)) (forall ((x1 Int)) (! (=> (and (dynamic_invariant3 m true true true true) (dynamic_invariant x1 true true true true)) (= (func_push m x1) (ite (= (length m) 0) (of_array (singleton1 (of_rep2 x1) #x0000) #x0000 #x0000) (of_array (concat_singleton_right (to_array m) (first1 m) (last1 m) (of_rep2 x1)) (first1 m) ((_ int2bv 16) (- (+ (bv2nat (first1 m)) (+ (ite (<= (bv2nat (first1 m)) (bv2nat (last1 m))) (+ (- (bv2nat (last1 m)) (bv2nat (first1 m))) 1) 0) 1)) 1)))))) :pattern ((func_push m x1))))))
...
(assert (forall ((temp___248 Int)) (=> (dynamic_invariant temp___248 true true true true) (forall ((temp___249 (_ BitVec 16))) (= (to_rep2 (select (temp___246 temp___248) temp___249)) temp___248)))))
(declare-const h Int)
...
(assert (= (let ((temp___250 (to_model (mk___rep r__split_fields7)))) (bool_eq (elts temp___250) (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250))) (temp___246 0) #x0001 #x0000)) true))
