...
(assert (forall ((x length_type)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun temp_____aggregate_def_246 (Int) (Array (_ BitVec 16) integer))
...
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 65536)) (in_range1 temp___expr_166)))
...
(assert (forall ((r us_rep)) (! (dynamic_invariant3 (to_model r) true false true true) :pattern ((to_model r)))))
(assert (forall ((r us_rep)) (! (= (to_model r) (ite (< 65535 (- (+ (bv2nat (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) 1)) (let ((temp___221 (let ((temp___218 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001))) (let ((temp___217 #x0000)) (let ((temp___219 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (of_array2 temp___219 temp___217 temp___218)))))) (let ((temp___220 (let ((temp___215 #xFFFF)) (let ((temp___214 (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) (let ((temp___216 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (of_array1 temp___216 temp___214 temp___215)))))) (ite (= (length1 temp___220) 0) (of_array (to_array2 temp___221) (first5 temp___221) (last5 temp___221)) (of_array (concat1 (to_array1 temp___220) (first3 temp___220) (last3 temp___220) (to_array2 temp___221) (first5 temp___221) (last5 temp___221)) (first3 temp___220) ((_ int2bv 16) (- (+ (bv2nat (first3 temp___220)) (+ (ite (<= (bv2nat (first3 temp___220)) (bv2nat (last3 temp___220))) (+ (- (bv2nat (last3 temp___220)) (bv2nat (first3 temp___220))) 1) 0) (ite (<= (bv2nat (first5 temp___221)) (bv2nat (last5 temp___221))) (+ (- (bv2nat (last5 temp___221)) (bv2nat (first5 temp___221))) 1) 0))) 1)))))) (let ((temp___225 (let ((temp___223 (bvsub (bvadd (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) #x0001))) (let ((temp___222 (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) (let ((temp___224 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (of_array3 temp___224 temp___222 temp___223)))))) (of_array (to_array3 temp___225) (first7 temp___225) (last7 temp___225))))) :pattern ((to_model r)))))
(assert (forall ((m us_t)) (! (=> (and (dynamic_invariant3 m true true true true) (< 0 (length m))) (dynamic_invariant (func_head m) true false true true)) :pattern ((func_head m)))))
(assert (forall ((m us_t)) (! (=> (dynamic_invariant3 m true true true true) (= (func_head m) (to_rep1 (select (to_array m) (first1 m))))) :pattern ((func_head m)))))
(assert (forall ((m us_t)) (forall ((x1 Int)) (! (=> (and (dynamic_invariant3 m true true true true) (dynamic_invariant x1 true true true true)) (dynamic_invariant3 (func_push m x1) true false true true)) :pattern ((func_push m x1))))))
(assert (forall ((m us_t)) (forall ((x1 Int)) (! (=> (and (dynamic_invariant3 m true true true true) (dynamic_invariant x1 true true true true)) (= (func_push m x1) (ite (= (length m) 0) (of_array (singleton1 (of_rep1 x1) #x0000) #x0000 #x0000) (of_array (concat_singleton_right (to_array m) (first1 m) (last1 m) (of_rep1 x1)) (first1 m) ((_ int2bv 16) (- (+ (bv2nat (first1 m)) (+ (ite (<= (bv2nat (first1 m)) (bv2nat (last1 m))) (+ (- (bv2nat (last1 m)) (bv2nat (first1 m))) 1) 0) 1)) 1)))))) :pattern ((func_push m x1))))))
...
(assert (forall ((m us_t)) (! (=> (and (dynamic_invariant3 m true true true true) (< 0 (length m))) (dynamic_invariant3 (func_pop m) true false true true)) :pattern ((func_pop m)))))
(assert (forall ((m us_t)) (! (=> (dynamic_invariant3 m true true true true) (= (func_pop m) (let ((temp___241 (let ((temp___240 (bvsub (last1 m) #x0001))) (let ((temp___239 (first1 m))) (of_array4 (to_array m) temp___239 temp___240))))) (of_array (to_array4 temp___241) (first9 temp___241) (last9 temp___241))))) :pattern ((func_pop m)))))
(assert true)
(assert (forall ((r us_rep)) (! (= (= (is_full r) true) (= (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))) 65536)) :pattern ((is_full r)))))
(assert true)
...
(assert (forall ((temp___248 Int)) (=> (dynamic_invariant temp___248 true true true true) (forall ((temp___249 (_ BitVec 16))) (= (select (temp_____aggregate_def_246 temp___248) temp___249) rliteral)))))
(declare-const h Int)
...
(define-fun r__split_fields6 () us_split_fields (mk___split_fields r__split_fields3 r__split_fields4 r__split_fields5))
(define-fun r__split_fields7 () us_split_fields (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))
(assert (in_range x))
(assert (in_range y))
(assert (in_range z))
(assert (=> (<= (- 2147483648) 2147483647) (in_range h)))
(assert (= (let ((temp___250 (to_model (mk___rep r__split_fields7)))) (bool_eq (elts temp___250) (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250))) (temp_____aggregate_def_246 0) #x0001 #x0000)) true))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields7)) x))) (let ((temp___257 (to_model (mk___rep r__split_fields6)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (not (not (= (is_full (mk___rep r__split_fields6)) true))))
(check-sat)
(exit)
