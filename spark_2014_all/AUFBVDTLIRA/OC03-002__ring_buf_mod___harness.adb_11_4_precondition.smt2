...
(declare-const r__split_fields18 (Array (_ BitVec 16) integer))
(declare-const r__split_fields19 ar_index)
(declare-const r__split_fields20 length_type)
(declare-const h3 Int)
(assert (in_range x))
(assert (in_range y))
(assert (in_range z))
(assert (=> (<= (- 2147483648) 2147483647) (in_range h)))
(assert (= (let ((temp___223 (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))))) (bool_eq (elts temp___223) (to_rep (first (rt temp___223))) (to_rep (last (rt temp___223))) (temp___219 0) ((_ int2bv 16) 1) ((_ int2bv 16) 0))) true))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))) x))) (let ((temp___230 (to_model (mk___rep (mk___split_fields r__split_fields3 r__split_fields4 r__split_fields5))))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (not (not (= (is_full (mk___rep (mk___split_fields r__split_fields3 r__split_fields4 r__split_fields5))) true))))
(check-sat)
(exit)
