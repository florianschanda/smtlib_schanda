...
(assert (and (= (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq3 (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true)))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o9 o8))
(assert (= o10 (to_rep2 o9)))
(assert (= result6 (ite (= o10 0) true false)))
(assert (not (= result6 true)))
(assert (and (= o11 ptr3) (in_range11 ptr3)))
(assert (not (<= 1 o11)))
(check-sat)
(exit)
