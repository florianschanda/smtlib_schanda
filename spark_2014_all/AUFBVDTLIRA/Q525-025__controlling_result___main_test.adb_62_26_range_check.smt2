...
(define-fun default_initial_assumption ((temp___expr_200 us_rep) (temp___skip_top_level_201 Bool)) Bool (and (= (attr__tag temp___expr_200) us_tag) (and (= (to_rep4 (rec__fixed_string__object__width (us_split_fields1 temp___expr_200))) 0) (= (rec__fixed_string__object__name (us_split_fields1 temp___expr_200)) (temp___202 0)))))
...
(declare-fun temp___231 (Int) (Array Int character))
(define-fun default_initial_assumption1 ((temp___expr_229 us_rep1) (temp___skip_top_level_230 Bool)) Bool (and (= (attr__tag1 temp___expr_229) us_tag1) (and (= (to_rep4 (rec__fixed_stream__object__width (us_split_fields3 temp___expr_229))) 0) (= (rec__fixed_stream__object__name (us_split_fields3 temp___expr_229)) (temp___231 0)))))
...
(assert (forall ((temp___204 Int)) (=> (dynamic_invariant6 temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep (select (temp___202 temp___204) temp___205)) temp___204)))))
(assert (forall ((temp___233 Int)) (=> (dynamic_invariant6 temp___233 true true true true) (forall ((temp___234 Int)) (= (to_rep (select (temp___231 temp___233) temp___234)) temp___233)))))
...
(declare-const temp___315 us_t1)
...
(assert (=> (= (length1 temp___307) 0) (= main_test__total_stream__assume (mk___t1 (elts1 temp___308) (mk1 (to_rep2 (first2 (rt1 temp___308))) (to_rep2 (last2 (rt1 temp___308))))))))
(assert (=> (not (= (length1 temp___307) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___308))) (to_rep2 (last2 (rt1 temp___308)))) (= o6 (+ (- (to_rep2 (last2 (rt1 temp___308))) (to_rep2 (first2 (rt1 temp___308)))) 1)))))
(assert (=> (not (= (length1 temp___307) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___308))) (to_rep2 (last2 (rt1 temp___308))))) (= o6 0))))
(assert (=> (not (= (length1 temp___307) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___307))) (to_rep2 (last2 (rt1 temp___307)))) (= o7 (+ (- (to_rep2 (last2 (rt1 temp___307))) (to_rep2 (first2 (rt1 temp___307)))) 1)))))
(assert (=> (not (= (length1 temp___307) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___307))) (to_rep2 (last2 (rt1 temp___307))))) (= o7 0))))
(assert (=> (not (= (length1 temp___307) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length1 temp___307) 0)) (= o9 (+ (to_rep2 (first2 (rt1 temp___307))) o8))))
(assert (=> (not (= (length1 temp___307) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length1 temp___307) 0)) (and (= o11 o10) (in_range6 o10))))
(assert (=> (not (= (length1 temp___307) 0)) (= main_test__total_stream__assume (mk___t1 (concat2 (elts1 temp___307) (to_rep2 (first2 (rt1 temp___307))) (to_rep2 (last2 (rt1 temp___307))) (elts1 temp___308) (to_rep2 (first2 (rt1 temp___308))) (to_rep2 (last2 (rt1 temp___308)))) (mk1 (to_rep2 (first2 (rt1 temp___307))) o11)))))
...
(assert (=> (= (length1 temp___313) 0) (= temp___315 (mk___t1 (elts1 temp___314) (mk1 (to_rep2 (first2 (rt1 temp___314))) (to_rep2 (last2 (rt1 temp___314))))))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___314))) (to_rep2 (last2 (rt1 temp___314)))) (= o39 (+ (- (to_rep2 (last2 (rt1 temp___314))) (to_rep2 (first2 (rt1 temp___314)))) 1)))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___314))) (to_rep2 (last2 (rt1 temp___314))))) (= o39 0))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___313))) (to_rep2 (last2 (rt1 temp___313)))) (= o40 (+ (- (to_rep2 (last2 (rt1 temp___313))) (to_rep2 (first2 (rt1 temp___313)))) 1)))))
(assert (=> (not (= (length1 temp___313) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___313))) (to_rep2 (last2 (rt1 temp___313))))) (= o40 0))))
(assert (=> (not (= (length1 temp___313) 0)) (= o41 (+ o40 o39))))
(assert (=> (not (= (length1 temp___313) 0)) (= o42 (+ (to_rep2 (first2 (rt1 temp___313))) o41))))
(assert (=> (not (= (length1 temp___313) 0)) (= o43 (- o42 1))))
(assert (=> (not (= (length1 temp___313) 0)) (and (= o44 o43) (in_range6 o43))))
(assert (=> (not (= (length1 temp___313) 0)) (= temp___315 (mk___t1 (concat2 (elts1 temp___313) (to_rep2 (first2 (rt1 temp___313))) (to_rep2 (last2 (rt1 temp___313))) (elts1 temp___314) (to_rep2 (first2 (rt1 temp___314))) (to_rep2 (last2 (rt1 temp___314)))) (mk1 (to_rep2 (first2 (rt1 temp___313))) o44)))))
(assert (= (ite (<= (to_rep2 (first2 (rt1 temp___315))) (to_rep2 (last2 (rt1 temp___315)))) (+ (- (to_rep2 (last2 (rt1 temp___315))) (to_rep2 (first2 (rt1 temp___315)))) 1) 0) (ite (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1) 0)))
(assert (= o45 temp___315))
