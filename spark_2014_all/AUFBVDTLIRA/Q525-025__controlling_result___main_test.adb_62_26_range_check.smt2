...
(define-fun dynamic_invariant1 ((temp___expr_21 Int) (temp___is_init_18 Bool) (temp___skip_constant_19 Bool) (temp___do_toplevel_20 Bool)) Bool (=> (or (= temp___is_init_18 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_21)))
...
(assert (forall ((x tstream_element_offsetB)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x tstream_element_offsetB)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq2 ((a (Array Int stream_element)) (a__first Int) (a__last Int) (b (Array Int stream_element)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array Int stream_element)) (b (Array Int stream_element))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132)))))))))))
(declare-fun compare1 ((Array Int stream_element) Int Int (Array Int stream_element) Int Int) Int)
(assert (forall ((a (Array Int stream_element)) (b (Array Int stream_element))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int stream_element)) (b (Array Int stream_element))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int stream_element)) (b (Array Int stream_element))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep3 (select a (+ j 1))) (to_rep3 (select b (+ i 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(declare-sort t1 0)
(declare-fun first2 (t1) tstream_element_offsetB)
(declare-fun last2 (t1) tstream_element_offsetB)
(declare-fun mk1 (Int Int) t1)
(assert (forall ((f Int) (l Int)) (! (=> (in_range5 f) (=> (in_range5 l) (and (= (to_rep2 (first2 (mk1 f l))) f) (= (to_rep2 (last2 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(define-fun bool_eq4 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep4 (rec__fixed_string__object__width (us_split_fields1 a))) (to_rep4 (rec__fixed_string__object__width (us_split_fields1 b)))) (= (bool_eq (rec__fixed_string__object__name (us_split_fields1 a)) 1 20 (rec__fixed_string__object__name (us_split_fields1 b)) 1 20) true)) true false))
...
(assert (forall ((temp___180 Int)) (forall ((temp___181 Int)) (= (select (temp___178 temp___180) temp___181) (of_rep temp___180)))))
(define-fun default_initial_assumption ((temp___expr_176 us_rep) (temp___skip_top_level_177 Bool)) Bool (and (= (attr__tag temp___expr_176) us_tag) (and (= (to_rep4 (rec__fixed_string__object__width (us_split_fields1 temp___expr_176))) 0) (= (rec__fixed_string__object__name (us_split_fields1 temp___expr_176)) (temp___178 0)))))
...
(assert (forall ((this us_rep)) (! (dynamic_invariant2 (elements this) true false true) :pattern ((elements this)))))
(assert (forall ((attr__tag1 Int)) (forall ((this us_rep)) (! (dynamic_invariant2 (elements1 attr__tag1 this) true false true) :pattern ((elements1 attr__tag1 this))))))
...
(assert (forall ((elem_width Int)) (forall ((name us_t)) (! (=> (and (dynamic_invariant2 elem_width true true true) (dynamic_invariant3 name true true true)) (let ((result (create elem_width name))) (and (= (elements result) elem_width) (= (attr__tag result) us_tag)))) :pattern ((create elem_width name))))))
(assert (forall ((attr__tag1 Int) (elem_width Int)) (forall ((name us_t)) (! (=> (and (dynamic_invariant2 elem_width true true true) (dynamic_invariant3 name true true true)) (= (attr__tag (create1 attr__tag1 elem_width name)) attr__tag1)) :pattern ((create1 attr__tag1 elem_width name))))))
...
(assert (forall ((this us_rep)) (! (let ((result (null_string this))) (and (= (length result) (elements this)) (dynamic_invariant3 result true false true))) :pattern ((null_string this)))))
(assert (forall ((attr__tag1 Int)) (forall ((this us_rep)) (! (dynamic_invariant3 (null_string1 attr__tag1 this) true false true) :pattern ((null_string1 attr__tag1 this))))))
...
(assert (forall ((this us_rep)) (forall ((in_string us_t)) (! (=> (dynamic_invariant3 in_string true true true) (let ((result (convert this in_string))) (and (= (length result) (elements this)) (dynamic_invariant3 result true false true)))) :pattern ((convert this in_string))))))
(assert (forall ((attr__tag1 Int)) (forall ((this us_rep)) (forall ((in_string us_t)) (! (=> (dynamic_invariant3 in_string true true true) (dynamic_invariant3 (convert1 attr__tag1 this in_string) true false true)) :pattern ((convert1 attr__tag1 this in_string)))))))
...
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep4 (rec__fixed_stream__object__width (us_split_fields3 a))) (to_rep4 (rec__fixed_stream__object__width (us_split_fields3 b)))) (= (bool_eq (rec__fixed_stream__object__name (us_split_fields3 a)) 1 20 (rec__fixed_stream__object__name (us_split_fields3 b)) 1 20) true)) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_209 us_rep1) (temp___skip_top_level_210 Bool)) Bool (and (= (attr__tag1 temp___expr_209) us_tag1) (and (= (to_rep4 (rec__fixed_stream__object__width (us_split_fields3 temp___expr_209))) 0) (= (rec__fixed_stream__object__name (us_split_fields3 temp___expr_209)) (temp___211 0)))))
...
(assert (forall ((this us_rep1)) (! (dynamic_invariant2 (elements2 this) true false true) :pattern ((elements2 this)))))
(assert (forall ((attr__tag2 Int)) (forall ((this us_rep1)) (! (dynamic_invariant2 (elements3 attr__tag2 this) true false true) :pattern ((elements3 attr__tag2 this))))))
...
(assert (forall ((elem_width Int)) (forall ((name us_t)) (! (=> (and (dynamic_invariant2 elem_width true true true) (dynamic_invariant3 name true true true)) (let ((result (create2 elem_width name))) (and (= (elements2 result) elem_width) (= (attr__tag1 result) us_tag1)))) :pattern ((create2 elem_width name))))))
(assert (forall ((attr__tag2 Int) (elem_width Int)) (forall ((name us_t)) (! (=> (and (dynamic_invariant2 elem_width true true true) (dynamic_invariant3 name true true true)) (= (attr__tag1 (create3 attr__tag2 elem_width name)) attr__tag2)) :pattern ((create3 attr__tag2 elem_width name))))))
...
(define-fun dynamic_invariant4 ((temp___expr_160 us_t1) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (not (= temp___skip_constant_158 true)) (dynamic_property1 (- 9223372036854775808) 9223372036854775807 (first3 temp___expr_160) (last3 temp___expr_160))))
...
(assert (forall ((this us_rep1)) (! (let ((result (null_string2 this))) (and (= (length1 result) (elements2 this)) (dynamic_invariant4 result true false true))) :pattern ((null_string2 this)))))
(assert (forall ((attr__tag2 Int)) (forall ((this us_rep1)) (! (dynamic_invariant4 (null_string3 attr__tag2 this) true false true) :pattern ((null_string3 attr__tag2 this))))))
...
(assert (forall ((this us_rep1)) (forall ((in_string us_t)) (! (=> (dynamic_invariant3 in_string true true true) (let ((result (convert2 this in_string))) (and (= (length1 result) (elements2 this)) (dynamic_invariant4 result true false true)))) :pattern ((convert2 this in_string))))))
(assert (forall ((attr__tag2 Int)) (forall ((this us_rep1)) (forall ((in_string us_t)) (! (=> (dynamic_invariant3 in_string true true true) (dynamic_invariant4 (convert3 attr__tag2 this in_string) true false true)) :pattern ((convert3 attr__tag2 this in_string)))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_275 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_275 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_275 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_275 us_void_param) 4)) 103)) :pattern ((temp___String_Literal_275 us_void_param)))))
(declare-fun temp___String_Literal_276 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_276 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_276 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_276 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_276 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_276 us_void_param) 5)) 116)) :pattern ((temp___String_Literal_276 us_void_param)))))
(declare-fun temp___String_Literal_277 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_277 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_277 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_277 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_277 us_void_param) 4)) 103)) :pattern ((temp___String_Literal_277 us_void_param)))))
(declare-fun temp___String_Literal_278 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_278 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_278 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_278 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_278 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_278 us_void_param) 5)) 116)) :pattern ((temp___String_Literal_278 us_void_param)))))
(declare-fun temp___String_Literal_279 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_279 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_279 us_void_param) 2)) 98)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 7)) 103)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 8)) 104)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 10)) 106)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 11)) 107)) (= (to_rep (select (temp___String_Literal_279 us_void_param) 12)) 108)) :pattern ((temp___String_Literal_279 us_void_param)))))
(declare-fun temp___String_Literal_281 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_281 us_void_param) 1)) 102) (= (to_rep (select (temp___String_Literal_281 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_281 us_void_param) 3)) 111)) :pattern ((temp___String_Literal_281 us_void_param)))))
(define-fun dynamic_invariant5 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range1 temp___expr_39)))
(define-fun dynamic_invariant6 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range2 temp___expr_63)))
(define-fun dynamic_invariant7 ((temp___expr_142 (_ BitVec 8)) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool true)
(define-fun dynamic_invariant8 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range6 temp___expr_148)))
...
(declare-const temp___287 us_t1)
(declare-const temp___286 us_t1)
...
(declare-const temp___290 us_t)
(declare-const temp___289 us_t)
...
(declare-const temp___293 us_t1)
(declare-const temp___292 us_t1)
...
(declare-const temp___294 us_t1)
(declare-const o47 us_t1)
(declare-const o48 (Array Int stream_element))
...
(declare-const total_stream2 (Array Int stream_element))
(declare-const result18 int__ref)
(declare-const len_n3 Int)
(declare-const result19 int__ref)
(declare-const len_i3 Int)
(declare-const result20 int__ref)
(declare-const len_l3 Int)
(declare-const result21 int__ref)
(declare-const len_n4 Int)
(assert (and (= (mk___rep (mk___split_fields main_test__field_10__assume main_test__field_10__assume1 main_test__field_10__assume2) main_test__field_10__assume3) (create 10 (mk___t (temp___String_Literal_275 Tuple0) (mk 1 4)))) (= (elements (mk___rep (mk___split_fields main_test__field_10__assume main_test__field_10__assume1 main_test__field_10__assume2) main_test__field_10__assume3)) 10)))
...
(assert (and (= (mk___rep (mk___split_fields main_test__field_06__assume main_test__field_06__assume1 main_test__field_06__assume2) main_test__field_06__assume3) (create 6 (mk___t (temp___String_Literal_276 Tuple0) (mk 1 5)))) (= (elements (mk___rep (mk___split_fields main_test__field_06__assume main_test__field_06__assume1 main_test__field_06__assume2) main_test__field_06__assume3)) 6)))
...
(assert (and (= (mk___rep1 (mk___split_fields1 main_test__stream_10__assume main_test__stream_10__assume1 main_test__stream_10__assume2) main_test__stream_10__assume3) (create2 10 (mk___t (temp___String_Literal_277 Tuple0) (mk 1 4)))) (= (elements2 (mk___rep1 (mk___split_fields1 main_test__stream_10__assume main_test__stream_10__assume1 main_test__stream_10__assume2) main_test__stream_10__assume3)) 10)))
...
(assert (and (= main_test__stream_06__assume (create2 6 (mk___t (temp___String_Literal_278 Tuple0) (mk 1 5)))) (= (elements2 main_test__stream_06__assume) 6)))
...
(assert (and (= temp___284 (null_string (mk___rep field_06__split_fields3 field_06__attr__tag))) (and (dynamic_invariant3 temp___284 true false true) (= (length temp___284) (elements (mk___rep field_06__split_fields3 field_06__attr__tag))))))
(assert (and (= temp___283 (null_string (mk___rep field_10__split_fields3 field_10__attr__tag))) (and (dynamic_invariant3 temp___283 true false true) (= (length temp___283) (elements (mk___rep field_10__split_fields3 field_10__attr__tag))))))
(assert (=> (= (length temp___283) 0) (= main_test__total_string__assume (mk___t (elts temp___284) (mk (to_rep1 (first (rt temp___284))) (to_rep1 (last (rt temp___284))))))))
(assert (=> (not (= (length temp___283) 0)) (=> (<= (to_rep1 (first (rt temp___284))) (to_rep1 (last (rt temp___284)))) (= o (+ (- (to_rep1 (last (rt temp___284))) (to_rep1 (first (rt temp___284)))) 1)))))
(assert (=> (not (= (length temp___283) 0)) (=> (not (<= (to_rep1 (first (rt temp___284))) (to_rep1 (last (rt temp___284))))) (= o 0))))
(assert (=> (not (= (length temp___283) 0)) (=> (<= (to_rep1 (first (rt temp___283))) (to_rep1 (last (rt temp___283)))) (= o1 (+ (- (to_rep1 (last (rt temp___283))) (to_rep1 (first (rt temp___283)))) 1)))))
(assert (=> (not (= (length temp___283) 0)) (=> (not (<= (to_rep1 (first (rt temp___283))) (to_rep1 (last (rt temp___283))))) (= o1 0))))
(assert (=> (not (= (length temp___283) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length temp___283) 0)) (= o3 (+ (to_rep1 (first (rt temp___283))) o2))))
(assert (=> (not (= (length temp___283) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length temp___283) 0)) (and (= o5 o4) (in_range1 o4))))
(assert (=> (not (= (length temp___283) 0)) (= main_test__total_string__assume (mk___t (concat1 (elts temp___283) (to_rep1 (first (rt temp___283))) (to_rep1 (last (rt temp___283))) (elts temp___284) (to_rep1 (first (rt temp___284))) (to_rep1 (last (rt temp___284)))) (mk (to_rep1 (first (rt temp___283))) o5)))))
...
(assert (and (= temp___287 (null_string2 (mk___rep1 stream_06__split_fields3 stream_06__attr__tag))) (and (dynamic_invariant4 temp___287 true false true) (= (length1 temp___287) (elements2 (mk___rep1 stream_06__split_fields3 stream_06__attr__tag))))))
(assert (and (= temp___286 (null_string2 (mk___rep1 stream_10__split_fields3 stream_10__attr__tag))) (and (dynamic_invariant4 temp___286 true false true) (= (length1 temp___286) (elements2 (mk___rep1 stream_10__split_fields3 stream_10__attr__tag))))))
(assert (=> (= (length1 temp___286) 0) (= main_test__total_stream__assume (mk___t1 (elts1 temp___287) (mk1 (to_rep2 (first2 (rt1 temp___287))) (to_rep2 (last2 (rt1 temp___287))))))))
(assert (=> (not (= (length1 temp___286) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___287))) (to_rep2 (last2 (rt1 temp___287)))) (= o6 (+ (- (to_rep2 (last2 (rt1 temp___287))) (to_rep2 (first2 (rt1 temp___287)))) 1)))))
(assert (=> (not (= (length1 temp___286) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___287))) (to_rep2 (last2 (rt1 temp___287))))) (= o6 0))))
(assert (=> (not (= (length1 temp___286) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___286))) (to_rep2 (last2 (rt1 temp___286)))) (= o7 (+ (- (to_rep2 (last2 (rt1 temp___286))) (to_rep2 (first2 (rt1 temp___286)))) 1)))))
(assert (=> (not (= (length1 temp___286) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___286))) (to_rep2 (last2 (rt1 temp___286))))) (= o7 0))))
(assert (=> (not (= (length1 temp___286) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length1 temp___286) 0)) (= o9 (+ (to_rep2 (first2 (rt1 temp___286))) o8))))
(assert (=> (not (= (length1 temp___286) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length1 temp___286) 0)) (and (= o11 o10) (in_range6 o10))))
(assert (=> (not (= (length1 temp___286) 0)) (= main_test__total_stream__assume (mk___t1 (concat2 (elts1 temp___286) (to_rep2 (first2 (rt1 temp___286))) (to_rep2 (last2 (rt1 temp___286))) (elts1 temp___287) (to_rep2 (first2 (rt1 temp___287))) (to_rep2 (last2 (rt1 temp___287)))) (mk1 (to_rep2 (first2 (rt1 temp___286))) o11)))))
(assert (= result7 (mk_map__ref1 total_stream)))
(assert (= total_stream1 (elts1 main_test__total_stream__assume)))
(assert (= (to_rep2 total_stream__first) (to_rep2 (first2 (rt1 main_test__total_stream__assume)))))
(assert (= (to_rep2 total_stream__last) (to_rep2 (last2 (rt1 main_test__total_stream__assume)))))
(assert (dynamic_property1 (- 9223372036854775808) 9223372036854775807 (to_rep2 total_stream__first) (to_rep2 total_stream__last)))
...
(assert (=> (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (= o12 (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last))) (= o12 0)))
(assert (and (= o13 o12) (in_range4 o12)))
(assert (= result8 (mk_int__ref len_n)))
(assert (= len_n1 o13))
(assert (=> (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (= o14 (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last))) (= o14 0)))
(assert (and (= o15 o14) (in_range o14)))
(assert (= result9 (mk_int__ref len_i)))
(assert (= len_i1 o15))
(assert (=> (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (= o16 (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last))) (= o16 0)))
...
(assert (and (= temp___290 (convert (mk___rep field_06__split_fields3 field_06__attr__tag) (mk___t short_string1 (mk (to_rep1 short_string__first) (to_rep1 short_string__last))))) (and (dynamic_invariant3 temp___290 true false true) (= (length temp___290) (elements (mk___rep field_06__split_fields3 field_06__attr__tag))))))
(assert (and (= temp___289 (convert (mk___rep field_10__split_fields3 field_10__attr__tag) (mk___t ref_string1 (mk (to_rep1 ref_string__first) (to_rep1 ref_string__last))))) (and (dynamic_invariant3 temp___289 true false true) (= (length temp___289) (elements (mk___rep field_10__split_fields3 field_10__attr__tag))))))
(assert (=> (= (length temp___289) 0) (= temp___291 (mk___t (elts temp___290) (mk (to_rep1 (first (rt temp___290))) (to_rep1 (last (rt temp___290))))))))
(assert (=> (not (= (length temp___289) 0)) (=> (<= (to_rep1 (first (rt temp___290))) (to_rep1 (last (rt temp___290)))) (= o27 (+ (- (to_rep1 (last (rt temp___290))) (to_rep1 (first (rt temp___290)))) 1)))))
(assert (=> (not (= (length temp___289) 0)) (=> (not (<= (to_rep1 (first (rt temp___290))) (to_rep1 (last (rt temp___290))))) (= o27 0))))
(assert (=> (not (= (length temp___289) 0)) (=> (<= (to_rep1 (first (rt temp___289))) (to_rep1 (last (rt temp___289)))) (= o28 (+ (- (to_rep1 (last (rt temp___289))) (to_rep1 (first (rt temp___289)))) 1)))))
(assert (=> (not (= (length temp___289) 0)) (=> (not (<= (to_rep1 (first (rt temp___289))) (to_rep1 (last (rt temp___289))))) (= o28 0))))
(assert (=> (not (= (length temp___289) 0)) (= o29 (+ o28 o27))))
(assert (=> (not (= (length temp___289) 0)) (= o30 (+ (to_rep1 (first (rt temp___289))) o29))))
(assert (=> (not (= (length temp___289) 0)) (= o31 (- o30 1))))
(assert (=> (not (= (length temp___289) 0)) (and (= o32 o31) (in_range1 o31))))
(assert (=> (not (= (length temp___289) 0)) (= temp___291 (mk___t (concat1 (elts temp___289) (to_rep1 (first (rt temp___289))) (to_rep1 (last (rt temp___289))) (elts temp___290) (to_rep1 (first (rt temp___290))) (to_rep1 (last (rt temp___290)))) (mk (to_rep1 (first (rt temp___289))) o32)))))
(assert (= (ite (<= (to_rep1 (first (rt temp___291))) (to_rep1 (last (rt temp___291)))) (+ (- (to_rep1 (last (rt temp___291))) (to_rep1 (first (rt temp___291)))) 1) 0) (ite (<= (to_rep1 total_string__first) (to_rep1 total_string__last)) (+ (- (to_rep1 total_string__last) (to_rep1 total_string__first)) 1) 0)))
...
(assert (and (= o37 (elements2 (mk___rep1 stream_06__split_fields3 stream_06__attr__tag))) (in_range4 o37)))
(assert (and (= o38 (elements2 (mk___rep1 stream_10__split_fields3 stream_10__attr__tag))) (in_range4 o38)))
(assert (= o39 (+ o38 o37)))
(assert (and (= o40 o39) (in_range o39)))
(assert (= result16 (mk_int__ref total_len1)))
(assert (= total_len2 o40))
(assert (and (= temp___293 (convert2 (mk___rep1 stream_06__split_fields3 stream_06__attr__tag) (mk___t short_string1 (mk (to_rep1 short_string__first) (to_rep1 short_string__last))))) (and (dynamic_invariant4 temp___293 true false true) (= (length1 temp___293) (elements2 (mk___rep1 stream_06__split_fields3 stream_06__attr__tag))))))
(assert (and (= temp___292 (convert2 (mk___rep1 stream_10__split_fields3 stream_10__attr__tag) (mk___t ref_string1 (mk (to_rep1 ref_string__first) (to_rep1 ref_string__last))))) (and (dynamic_invariant4 temp___292 true false true) (= (length1 temp___292) (elements2 (mk___rep1 stream_10__split_fields3 stream_10__attr__tag))))))
(assert (=> (= (length1 temp___292) 0) (= temp___294 (mk___t1 (elts1 temp___293) (mk1 (to_rep2 (first2 (rt1 temp___293))) (to_rep2 (last2 (rt1 temp___293))))))))
(assert (=> (not (= (length1 temp___292) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___293))) (to_rep2 (last2 (rt1 temp___293)))) (= o41 (+ (- (to_rep2 (last2 (rt1 temp___293))) (to_rep2 (first2 (rt1 temp___293)))) 1)))))
(assert (=> (not (= (length1 temp___292) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___293))) (to_rep2 (last2 (rt1 temp___293))))) (= o41 0))))
(assert (=> (not (= (length1 temp___292) 0)) (=> (<= (to_rep2 (first2 (rt1 temp___292))) (to_rep2 (last2 (rt1 temp___292)))) (= o42 (+ (- (to_rep2 (last2 (rt1 temp___292))) (to_rep2 (first2 (rt1 temp___292)))) 1)))))
(assert (=> (not (= (length1 temp___292) 0)) (=> (not (<= (to_rep2 (first2 (rt1 temp___292))) (to_rep2 (last2 (rt1 temp___292))))) (= o42 0))))
(assert (=> (not (= (length1 temp___292) 0)) (= o43 (+ o42 o41))))
(assert (=> (not (= (length1 temp___292) 0)) (= o44 (+ (to_rep2 (first2 (rt1 temp___292))) o43))))
(assert (=> (not (= (length1 temp___292) 0)) (= o45 (- o44 1))))
(assert (=> (not (= (length1 temp___292) 0)) (and (= o46 o45) (in_range6 o45))))
(assert (=> (not (= (length1 temp___292) 0)) (= temp___294 (mk___t1 (concat2 (elts1 temp___292) (to_rep2 (first2 (rt1 temp___292))) (to_rep2 (last2 (rt1 temp___292))) (elts1 temp___293) (to_rep2 (first2 (rt1 temp___293))) (to_rep2 (last2 (rt1 temp___293)))) (mk1 (to_rep2 (first2 (rt1 temp___292))) o46)))))
(assert (= (ite (<= (to_rep2 (first2 (rt1 temp___294))) (to_rep2 (last2 (rt1 temp___294)))) (+ (- (to_rep2 (last2 (rt1 temp___294))) (to_rep2 (first2 (rt1 temp___294)))) 1) 0) (ite (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1) 0)))
(assert (= o47 temp___294))
(assert (= o48 (elts1 o47)))
(assert (= result17 (mk_map__ref1 total_stream1)))
(assert (= total_stream2 o48))
(assert (=> (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (= o49 (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last))) (= o49 0)))
(assert (and (= o50 o49) (in_range4 o49)))
(assert (= result18 (mk_int__ref len_n2)))
(assert (= len_n3 o50))
(assert (=> (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (= o51 (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last))) (= o51 0)))
(assert (and (= o52 o51) (in_range o51)))
(assert (= result19 (mk_int__ref len_i2)))
(assert (= len_i3 o52))
(assert (=> (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (= o53 (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1))))
(assert (=> (not (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last))) (= o53 0)))
(assert (and (= o54 o53) (in_range3 o53)))
(assert (= result20 (mk_int__ref len_l2)))
(assert (= len_l3 o54))
(assert (=> (<= (to_rep1 total_string__first) (to_rep1 total_string__last)) (= o55 (+ (- (to_rep1 total_string__last) (to_rep1 total_string__first)) 1))))
(assert (=> (not (<= (to_rep1 total_string__first) (to_rep1 total_string__last))) (= o55 0)))
(assert (and (= o56 o55) (in_range4 o55)))
(assert (= result21 (mk_int__ref len_n3)))
(assert (= len_n4 o56))
(assert (=> (<= (to_rep1 total_string__first) (to_rep1 total_string__last)) (= o57 (+ (- (to_rep1 total_string__last) (to_rep1 total_string__first)) 1))))
(assert (=> (not (<= (to_rep1 total_string__first) (to_rep1 total_string__last))) (= o57 0)))
(assert (not (in_range o57)))
(check-sat)
(exit)
