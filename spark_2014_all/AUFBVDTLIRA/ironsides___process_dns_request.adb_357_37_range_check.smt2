...
(assert (and (= o16 (convertdomainnametowire (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername (us_split_fields3 rrsig_record)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 128)) (and (<= 0 (to_rep (select o16 i3))) (<= (to_rep (select o16 i3)) 255))))))
...
(assert (<= 1 i1))
(assert (<= i1 r21b))
(assert (and (and (and (and (and (<= start_byte (- 8156 current_name_length1)) (<= 1 i2)) (<= i2 129)) (<= 1 current_name_length1)) (<= current_name_length1 129)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 129)) (and (<= 0 (to_rep (select wireversion1 j))) (<= (to_rep (select wireversion1 j)) 255))))))
(assert (and (=> (<= 1 r21b) (dynamic_property 1 r21b i2)) (and (<= 1 i2) (<= i2 r21b))))
(assert (not (uint_in_range (to_rep (select wireversion1 i2)))))
(check-sat)
(exit)
