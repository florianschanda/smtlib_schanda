...
(assert (= i34 r13b))
(assert (=> (and (<= r13b i34) (<= i34 r14b)) (and (and (= temp___1495 i34) (and (= temp___1496 endidx5) (and (= temp___1493 (mk___rep1 (us_split_fields__content1 rrsig_rec__split_fields25) rrsig_rec__attr__tag)) (and (and (and (<= 1 begidx8) (<= (+ (- endidx5 begidx8) 1) 128)) (= endidx5 temp___1496)) (and (and (and (and (and (and (and (and (and (and (and (and (and (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__typecovered rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__typecovered (us_split_fields3 temp___1493))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__algorithm rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__algorithm (us_split_fields3 temp___1493)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__numlabels rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__numlabels (us_split_fields3 temp___1493)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__origttl rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__origttl (us_split_fields3 temp___1493)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__sigexpiration rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__sigexpiration (us_split_fields3 temp___1493)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__siginception rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__siginception (us_split_fields3 temp___1493)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__keytag rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__keytag (us_split_fields3 temp___1493)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__signature rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__signature (us_split_fields3 temp___1493)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__signaturelength rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__signaturelength (us_split_fields3 temp___1493)))) (= (rec__rr_type__resourcerecordtype__ttlinseconds1 rrsig_rec__split_fields27) (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 temp___1493)))) (= (rec__rr_type__resourcerecordtype__class1 rrsig_rec__split_fields27) (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 temp___1493)))) (=> (<= r13b r14b) (dynamic_property r13b r14b i35))) (and (<= r13b i35) (<= i35 r14b))) (and (and (and (and (and (= (to_rep o56) (to_rep (select zonefileline i35))) (and (and (and (and (and (= o54 (+ i35 1)) (in_range1 (+ i35 1))) (= o55 (- o54 begidx8))) (and (= temp___1490 o55) (in_range1 o55))) (and (and (<= 1 temp___1490) (<= temp___1490 128)) (= o57 temp___1490))) (= o58 (store (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername rrsig_rec__split_fields27) o57 o56)))) (= o59 (mk___split_fields1 (rec__rr_type__rrsig_record_type__rrsigrecordtype__typecovered rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__algorithm rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__numlabels rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__origttl rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__sigexpiration rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__siginception rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__keytag rrsig_rec__split_fields27) o58 (rec__rr_type__rrsig_record_type__rrsigrecordtype__signature rrsig_rec__split_fields27) (rec__rr_type__rrsig_record_type__rrsigrecordtype__signaturelength rrsig_rec__split_fields27) (rec__rr_type__resourcerecordtype__ttlinseconds1 rrsig_rec__split_fields27) (rec__rr_type__resourcerecordtype__class1 rrsig_rec__split_fields27) (rec__ext__1 rrsig_rec__split_fields27)))) (= temp___1492 (mk___rep1 o59 rrsig_rec__attr__tag))) (and (= result20 (mk___split_fields__ref1 rrsig_rec__split_fields27)) (= rrsig_rec__split_fields28 (us_split_fields3 temp___1492)))) (= i35 r14b))))))) (and (and (= i41 (mk_int__ref i35)) (= rrsig_rec__split_fields33 (mk___split_fields__ref1 rrsig_rec__split_fields28))) (and (= i42 i35) (= rrsig_rec__split_fields34 rrsig_rec__split_fields28))))))
(assert (=> (and (<= r13b i34) (<= i34 r14b)) (= i43 i41)))
(assert (=> (and (<= r13b i34) (<= i34 r14b)) (= rrsig_rec__split_fields35 rrsig_rec__split_fields33)))
(assert (=> (and (<= r13b i34) (<= i34 r14b)) (= i44 i42)))
(assert (=> (and (<= r13b i34) (<= i34 r14b)) (= rrsig_rec__split_fields36 rrsig_rec__split_fields34)))
(assert (=> (not (and (<= r13b i34) (<= i34 r14b))) (= i43 (mk_int__ref i34))))
(assert (=> (not (and (<= r13b i34) (<= i34 r14b))) (= rrsig_rec__split_fields35 rrsig_rec__split_fields25)))
(assert (=> (not (and (<= r13b i34) (<= i34 r14b))) (= i44 i34)))
(assert (=> (not (and (<= r13b i34) (<= i34 r14b))) (= rrsig_rec__split_fields36 rrsig_rec__split_fields26)))
(assert (= (+ endidx5 1) r16b))
(assert (in_range1 r16b))
(assert (= result22 (mk_int__ref i3)))
(assert (= i45 r16b))
(assert (<= r16b i45))
(assert (<= i45 128))
