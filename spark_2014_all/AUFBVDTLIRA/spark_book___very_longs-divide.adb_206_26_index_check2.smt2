...
(define-fun dynamic_invariant3 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range1 temp___expr_228)))
...
(declare-const temp___1387 (_ BitVec 16))
(declare-const temp___1384 us_rep1)
(declare-const temp___1383 (_ BitVec 16))
...
(assert (dynamic_invariant4 dividend true false true true))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1387 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1384 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1383 sum)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o22 (to_rep2 o21))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o23 ((_ zero_extend 8) o22))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (= o16 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1377 (- o16 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1377) (<= temp___1377 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o17 temp___1377)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o19 (to_rep2 o18))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= (to_rep2 o29) o28)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (= o27 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1380 (- o27 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1380) (<= temp___1380 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o30 temp___1380)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1382 (mk___rep1 u__split_discrs o33))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= result5 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= u__split_fields4 (us_split_fields3 temp___1382))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= u__split_discrs (us_split_discrs2 temp___1382))))
...
(assert (and (= temp___1389 (+ j n)) (in_range2 (+ j n))))
...
(assert (= o38 (to_rep2 o36)))
(assert (= o39 (bvadd o38 o37)))
(assert (= (to_rep2 o40) o39))
(assert (and (= temp___1391 (+ j n)) (in_range2 (+ j n))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1391)))
(check-sat)
(exit)
