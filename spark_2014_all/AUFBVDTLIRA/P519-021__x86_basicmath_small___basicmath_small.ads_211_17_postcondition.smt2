...
(assert (and (= o (readmem64 #x00000000004011D8 memory)) (and (and (and (and (and (and (and (= (bvand o #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory #x00000000004011D8)))) (= (bvand o #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D8 #x0000000000000001)))) #x0000000000000100))) (= (bvand o #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D8 #x0000000000000002)))) #x0000000000010000))) (= (bvand o #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D8 #x0000000000000003)))) #x0000000001000000))) (= (bvand o #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D8 #x0000000000000004)))) #x0000000100000000))) (= (bvand o #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D8 #x0000000000000005)))) #x0000010000000000))) (= (bvand o #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D8 #x0000000000000006)))) #x0001000000000000))) (= (bvand o #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D8 #x0000000000000007)))) #x0100000000000000)))))
(assert (= o1 (bvmul xmm0 o)))
(assert (= result xmm0))
(assert (= xmm01 o1))
(assert (and (= o2 (readmem64 #x00000000004011D0 memory)) (and (and (and (and (and (and (and (= (bvand o2 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory #x00000000004011D0)))) (= (bvand o2 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D0 #x0000000000000001)))) #x0000000000000100))) (= (bvand o2 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D0 #x0000000000000002)))) #x0000000000010000))) (= (bvand o2 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D0 #x0000000000000003)))) #x0000000001000000))) (= (bvand o2 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D0 #x0000000000000004)))) #x0000000100000000))) (= (bvand o2 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D0 #x0000000000000005)))) #x0000010000000000))) (= (bvand o2 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D0 #x0000000000000006)))) #x0001000000000000))) (= (bvand o2 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory (bvadd #x00000000004011D0 #x0000000000000007)))) #x0100000000000000)))))
(assert (and (= o3 (safedivision64 xmm01 o2)) (= o3 (bvudiv xmm01 o2))))
(assert (= result1 xmm01))
(assert (= xmm02 o3))
(assert (= result2 rsp))
(assert (= rsp1 (bvadd rsp #x0000000000000008)))
(assert (= rsp1 rsp2))
(assert (= xmm03 xmm02))
(assert (= rsp3 rsp1))
(assert (= xmm04 xmm02))
(assert (not (= rsp2 (bvadd rsp #x0000000000000008))))
(check-sat)
(exit)
