...
(assert (= saved_ra2 (mk_t__ref2 saved_ra1)))
(assert (= saved_rbp2 (mk_t__ref2 saved_rbp1)))
(assert (= tmp_register10 tmp_register8))
(assert (= saved_722 (mk_t__ref2 saved_721)))
(assert (= saved_322 (mk_t__ref2 saved_321)))
...
(assert (= saved_723 saved_721))
(assert (= saved_323 saved_321))
...
(assert (not (= (to_rep (select (map__content memory11) (bvsub rbp #x0000000000000020))) (to_rep (select memory (bvsub rbp #x0000000000000020))))))
(check-sat)
(exit)
