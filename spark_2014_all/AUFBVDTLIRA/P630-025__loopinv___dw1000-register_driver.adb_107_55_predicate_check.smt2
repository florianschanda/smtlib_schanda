...
(assert (= (mk___rep (mk___split_fields dw1000__register_driver__write_register__B_4__header__assume dw1000__register_driver__write_register__B_4__header__assume1 dw1000__register_driver__write_register__B_4__header__assume2)) (mk___rep (mk___split_fields temp___759 temp___7591 temp___7592))))
(assert (= (mk___rep (mk___split_fields dw1000__register_driver__write_register__B_4__header__assume dw1000__register_driver__write_register__B_4__header__assume1 dw1000__register_driver__write_register__B_4__header__assume2)) header))
(assert (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 header))) 0))
(assert (not (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 header))) 0)))
(check-sat)
(exit)
