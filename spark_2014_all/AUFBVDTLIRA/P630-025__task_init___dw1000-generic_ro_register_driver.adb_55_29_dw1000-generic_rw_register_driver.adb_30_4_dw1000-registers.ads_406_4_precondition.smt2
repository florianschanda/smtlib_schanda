...
(define-fun register_type__ref___116__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___82__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___82__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_4980 us_t1) (temp___is_init_4977 Bool) (temp___skip_constant_4978 Bool) (temp___do_toplevel_4979 Bool)) Bool (=> (not (= temp___skip_constant_4978 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4980) (last3 temp___expr_4980)) (and (= (first3 temp___expr_4980) 1) (= (last3 temp___expr_4980) 2)))))
