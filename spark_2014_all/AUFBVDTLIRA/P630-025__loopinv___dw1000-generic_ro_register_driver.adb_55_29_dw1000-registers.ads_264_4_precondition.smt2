...
(define-fun dynamic_invariant ((temp___expr_3278 us_t1) (temp___is_init_3274 Bool) (temp___skip_constant_3275 Bool) (temp___do_toplevel_3276 Bool) (temp___do_typ_inv_3277 Bool)) Bool (=> (not (= temp___skip_constant_3275 true)) (and (dynamic_property2 1 10 (first3 temp___expr_3278) (last3 temp___expr_3278)) (and (= (first3 temp___expr_3278) 1) (= (last3 temp___expr_3278) 10)))))
