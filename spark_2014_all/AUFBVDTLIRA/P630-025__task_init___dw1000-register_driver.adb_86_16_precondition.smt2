...
(define-fun dynamic_invariant ((temp___expr_271 (_ BitVec 8)) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool (=> (or (= temp___is_init_267 true) (bvule #x00 #x3F)) (in_range2 temp___expr_271)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x40))) (=> (in_range2 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun in_range4 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x7FFF)))
...
(define-fun dynamic_invariant1 ((temp___expr_334 (_ BitVec 16)) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool) (temp___do_typ_inv_333 Bool)) Bool (=> (or (= temp___is_init_330 true) (bvule #x0000 #x7FFF)) (in_range4 temp___expr_334)))
...
(define-fun bool_eq ((a (Array Int bits_8)) (a__first Int) (a__last Int) (b (Array Int bits_8)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep3 (select a temp___idx_154)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_716 us_rep) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (= temp___do_toplevel_714 true) (=> (= temp___is_init_712 true) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_716))) 0))))
(define-fun default_initial_assumption ((temp___expr_718 us_rep) (temp___skip_top_level_719 Bool)) Bool (and (and (= (to_rep1 (rec__dw1000__register_driver__non_indexed_header__register_id (us_split_fields1 temp___expr_718))) #x00) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_718))) 0)) (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__operation (us_split_fields1 temp___expr_718))) 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_801 us_rep1) (temp___is_init_797 Bool) (temp___skip_constant_798 Bool) (temp___do_toplevel_799 Bool) (temp___do_typ_inv_800 Bool)) Bool (=> (= temp___do_toplevel_799 true) (=> (= temp___is_init_797 true) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_801))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_801))) 0)))))
(define-fun default_initial_assumption4 ((temp___expr_803 us_rep1) (temp___skip_top_level_804 Bool)) Bool (and (and (and (and (= (to_rep1 (rec__dw1000__register_driver__short_indexed_header__register_id (us_split_fields3 temp___expr_803))) #x00) (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_803))) 1)) (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__operation (us_split_fields3 temp___expr_803))) 0)) (= (to_rep2 (rec__dw1000__register_driver__short_indexed_header__register_sub_address (us_split_fields3 temp___expr_803))) #x00)) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_803))) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_823 us_rep2) (temp___is_init_819 Bool) (temp___skip_constant_820 Bool) (temp___do_toplevel_821 Bool) (temp___do_typ_inv_822 Bool)) Bool (=> (= temp___do_toplevel_821 true) (=> (= temp___is_init_819 true) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_823))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_823))) 1)))))
(define-fun default_initial_assumption5 ((temp___expr_825 us_rep2) (temp___skip_top_level_826 Bool)) Bool (and (and (and (and (and (= (to_rep1 (rec__dw1000__register_driver__long_indexed_header__register_id (us_split_fields5 temp___expr_825))) #x00) (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_825))) 1)) (= (to_rep4 (rec__dw1000__register_driver__long_indexed_header__operation (us_split_fields5 temp___expr_825))) 0)) (= (to_rep2 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_lsb (us_split_fields5 temp___expr_825))) #x00)) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_825))) 1)) (= (to_rep3 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_msb (us_split_fields5 temp___expr_825))) #x00)))
...
(assert (= header2 (mk___rep2 (mk___split_fields2 (of_rep1 register_id) (of_rep5 1) (of_rep4 0) (of_rep2 ((_ extract 7 0) (bvand sub_address #x007F))) (of_rep6 1) (of_rep3 ((_ extract 7 0) (bvudiv sub_address #x0080)))))))
(define-fun dynamic_invariant10 ((temp___expr_695 Int) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool) (temp___do_typ_inv_694 Bool)) Bool (=> (or (= temp___is_init_691 true) (<= 0 1)) (in_range5 temp___expr_695)))
(define-fun dynamic_invariant11 ((temp___expr_702 Int) (temp___is_init_698 Bool) (temp___skip_constant_699 Bool) (temp___do_toplevel_700 Bool) (temp___do_typ_inv_701 Bool)) Bool (=> (or (= temp___is_init_698 true) (<= 0 1)) (in_range6 temp___expr_702)))
(define-fun dynamic_invariant12 ((temp___expr_709 Int) (temp___is_init_705 Bool) (temp___skip_constant_706 Bool) (temp___do_toplevel_707 Bool) (temp___do_typ_inv_708 Bool)) Bool (=> (or (= temp___is_init_705 true) (<= 0 1)) (in_range7 temp___expr_709)))
(define-fun dynamic_invariant13 ((temp___expr_278 (_ BitVec 8)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool (=> (or (= temp___is_init_274 true) (bvule #x00 #x7F)) (in_range3 temp___expr_278)))
...
(assert (= (to_rep3 o) ((_ extract 7 0) (bvudiv sub_address #x0080))))
(assert (= (to_rep6 o1) 1))
(assert (= (to_rep2 o2) ((_ extract 7 0) (bvand sub_address #x007F))))
(assert (= (to_rep4 o3) 0))
(assert (= (to_rep5 o4) 1))
...
(assert (and (= (to_rep5 temp___8621) 1) (= (to_rep6 temp___8624) 1)))
