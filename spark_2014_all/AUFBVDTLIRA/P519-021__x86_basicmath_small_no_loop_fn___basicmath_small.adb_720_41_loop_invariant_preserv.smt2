...
(assert (= zeroflag59 (mk_bool__ref zeroflag58)))
...
(assert (= xmm211 xmm29))
(assert (= xmm111 xmm19))
(assert (= xmm059 xmm057))
(assert (= overflowflag59 overflowflag57))
(assert (= signflag59 signflag57))
(assert (= carryflag59 carryflag57))
(assert (= zeroflag60 zeroflag58))
(assert (not (= (t__content3 rsp97) (let ((subject rsp)) rsp78))))
(check-sat)
(exit)
