...
(declare-fun temp_____aggregate_def_961 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___963 (_ BitVec 8))) (forall ((temp___964 Int) (temp___965 Int)) (let ((temp___962 (temp_____aggregate_def_961 temp___963 temp___964 temp___965))) (=> (dynamic_invariant temp___963 true true true true) (and (=> (dynamic_property6 1 65536 temp___964 temp___965) (and (= (first5 temp___962) temp___964) (= (last5 temp___962) temp___965))) (forall ((temp___966 Int)) (= (to_rep2 (select (to_array2 temp___962) temp___966)) temp___963))))))))
...
(declare-const temp___981 (_ BitVec 16))
(declare-const temp___980 (_ BitVec 16))
...
(declare-const temp___979 us_rep1)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_961 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_961 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___968 temp___9681) (temp_____aggregate_def_961 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep1 (first4 temp___9681)) (to_rep1 (last4 temp___9681))) (+ (- (to_rep1 (last4 temp___9681)) (to_rep1 (first4 temp___9681))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___968 temp___969))
(assert (= (mk1 (to_rep1 (first4 temp___9681)) (to_rep1 (last4 temp___9681))) temp___9691))
(assert (= (ite (<= (to_rep1 (first2 temp___9691)) (to_rep1 (last2 temp___9691))) (+ (- (to_rep1 (last2 temp___9691)) (to_rep1 (first2 temp___9691))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___981 carry1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___980 sum)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___979 (mk___rep1 result____split_discrs o18))))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_fields4 (us_split_fields3 temp___979))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_discrs (us_split_discrs2 temp___979))))
