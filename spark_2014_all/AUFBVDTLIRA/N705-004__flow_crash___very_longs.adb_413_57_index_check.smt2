...
(assert (<= 1 i1))
(assert (<= i1 r130b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1348 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1348) (<= temp___1348 (to_rep1 (last number__split_fields3)))) (=> (<= temp___1348 i2) (= (select number__split_fields2 temp___1348) (select number__split_fields temp___1348)))))) (and (<= 1 i2) (<= i2 r130b))))
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1341)))
(assert (= temp___13411 o14))
(assert (= temp___13412 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___13411 temp___13412))))
(assert (= number__split_discrs (mk___split_discrs temp___1341)))
