...
(assert true)
(assert (=> (= load_xtal_trim true) (= (to_rep1 o18) ((_ extract 7 0) (bvand word4 ((_ int2bv 32) 31))))))
...
(assert (=> (not (= load_xtal_trim true)) (= (to_rep1 o21) ((_ int2bv 8) 16))))
...
(assert (= result9 i))
(assert (= i1 0))
(assert (not (in_range_int2 (+ 16 i1))))
(check-sat)
(exit)
