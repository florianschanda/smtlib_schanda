...
(assert (<= 1 i1))
(assert (<= i1 r124b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1312 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1312) (<= temp___1312 (to_rep1 (last number__split_fields3)))) (=> (or (< r124b temp___1312) (or (< temp___1312 1) (<= temp___1312 i2))) (= (select number__split_fields2 temp___1312) (select number__split_fields temp___1312)))))) (and (<= 1 i2) (<= i2 r124b))))
