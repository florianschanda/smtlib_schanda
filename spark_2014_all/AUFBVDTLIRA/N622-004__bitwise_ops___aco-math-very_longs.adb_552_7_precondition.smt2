...
(assert (forall ((l us_rep) (r us_rep)) (! (=> (and (and (dynamic_invariant1 l true true true) (dynamic_invariant1 r true true true)) (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (let ((result (modsubtract l r))) (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 result))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant1 result true false true)))) :pattern ((modsubtract l r)))))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___205 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___205) (first3 temp___205) (last3 temp___205))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___204 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___204) (first1 temp___204) (last1 temp___204))))))
...
(define-fun dynamic_invariant2 ((temp___expr_954 us_rep1) (temp___is_init_951 Bool) (temp___skip_constant_952 Bool) (temp___do_toplevel_953 Bool)) Bool (and (=> (not (= temp___skip_constant_952 true)) (in_range3 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_954))) (and (dynamic_property3 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_954))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_954)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_954))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_954))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_957 us_rep1) (temp___skip_top_level_958 Bool)) Bool (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_957))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-const aco__math__very_longs__add_fp__result digit_index_type)
(declare-const aco__math__very_longs__add_fp__result1 (Array Int octet))
(declare-const aco__math__very_longs__add_fp__result2 t)
...
(declare-const o5 t)
(declare-const temp___1346 digit_index_type)
(declare-const temp___13461 (Array Int octet))
(declare-const temp___13462 t1)
...
(declare-const result3 very_long__ref)
(declare-const aco__math__very_longs__add_fp__result3 us_rep)
(declare-const aco__math__very_longs__add_fp__result4 very_long__ref)
(declare-const aco__math__very_longs__add_fp__result5 us_rep)
(declare-const result____split_fields4 us_split_fields__ref1)
(declare-const carry2 t__ref)
(declare-const aco__math__very_longs__add_fp__result6 very_long__ref)
(declare-const result____split_fields5 us_split_fields2)
(declare-const carry3 (_ BitVec 16))
(declare-const aco__math__very_longs__add_fp__result7 us_rep)
...
(assert true)
(assert (not (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(check-sat)
(exit)
