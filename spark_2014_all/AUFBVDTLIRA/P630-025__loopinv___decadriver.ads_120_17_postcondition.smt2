...
(define-fun dynamic_invariant ((temp___expr_4301 Int) (temp___is_init_4298 Bool) (temp___skip_constant_4299 Bool) (temp___do_toplevel_4300 Bool)) Bool (=> (or (= temp___is_init_4298 true) (<= 0 1)) (in_range1 temp___expr_4301)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 2)))) (=> (in_range3 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun dynamic_invariant3 ((temp___expr_4397 Int) (temp___is_init_4394 Bool) (temp___skip_constant_4395 Bool) (temp___do_toplevel_4396 Bool)) Bool (=> (or (= temp___is_init_4394 true) (<= 0 1024)) (in_range4 temp___expr_4397)))
(define-fun dynamic_invariant4 ((temp___expr_4403 Int) (temp___is_init_4400 Bool) (temp___skip_constant_4401 Bool) (temp___do_toplevel_4402 Bool)) Bool (=> (or (= temp___is_init_4400 true) (<= 0 5)) (in_range5 temp___expr_4403)))
...
(define-fun dynamic_invariant6 ((temp___expr_4427 (_ BitVec 8)) (temp___is_init_4424 Bool) (temp___skip_constant_4425 Bool) (temp___do_toplevel_4426 Bool)) Bool (=> (or (= temp___is_init_4424 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range3 temp___expr_4427)))
...
(assert (dynamic_invariant1 (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3 self__4)) true false true))
