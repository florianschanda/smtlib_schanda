...
(define-fun dynamic_invariant ((temp___expr_4311 Int) (temp___is_init_4308 Bool) (temp___skip_constant_4309 Bool) (temp___do_toplevel_4310 Bool)) Bool (=> (or (= temp___is_init_4308 true) (<= 0 1)) (in_range1 temp___expr_4311)))
...
(define-fun dynamic_invariant3 ((temp___expr_4407 Int) (temp___is_init_4404 Bool) (temp___skip_constant_4405 Bool) (temp___do_toplevel_4406 Bool)) Bool (=> (or (= temp___is_init_4404 true) (<= 0 1024)) (in_range4 temp___expr_4407)))
(define-fun dynamic_invariant4 ((temp___expr_4413 Int) (temp___is_init_4410 Bool) (temp___skip_constant_4411 Bool) (temp___do_toplevel_4412 Bool)) Bool (=> (or (= temp___is_init_4410 true) (<= 0 5)) (in_range5 temp___expr_4413)))
...
(define-fun dynamic_invariant6 ((temp___expr_4437 (_ BitVec 8)) (temp___is_init_4434 Bool) (temp___skip_constant_4435 Bool) (temp___do_toplevel_4436 Bool)) Bool (=> (or (= temp___is_init_4434 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range3 temp___expr_4437)))
