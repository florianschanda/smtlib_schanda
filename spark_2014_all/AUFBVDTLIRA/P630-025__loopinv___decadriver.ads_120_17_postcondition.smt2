...
(define-fun dynamic_invariant ((temp___expr_4772 Int) (temp___is_init_4768 Bool) (temp___skip_constant_4769 Bool) (temp___do_toplevel_4770 Bool) (temp___do_typ_inv_4771 Bool)) Bool (=> (or (= temp___is_init_4768 true) (<= 0 1)) (in_range1 temp___expr_4772)))
...
(define-fun dynamic_invariant3 ((temp___expr_4880 Int) (temp___is_init_4876 Bool) (temp___skip_constant_4877 Bool) (temp___do_toplevel_4878 Bool) (temp___do_typ_inv_4879 Bool)) Bool (=> (or (= temp___is_init_4876 true) (<= 0 1024)) (in_range4 temp___expr_4880)))
(define-fun dynamic_invariant4 ((temp___expr_4887 Int) (temp___is_init_4883 Bool) (temp___skip_constant_4884 Bool) (temp___do_toplevel_4885 Bool) (temp___do_typ_inv_4886 Bool)) Bool (=> (or (= temp___is_init_4883 true) (<= 0 5)) (in_range5 temp___expr_4887)))
...
(define-fun dynamic_invariant6 ((temp___expr_4913 (_ BitVec 8)) (temp___is_init_4909 Bool) (temp___skip_constant_4910 Bool) (temp___do_toplevel_4911 Bool) (temp___do_typ_inv_4912 Bool)) Bool (=> (or (= temp___is_init_4909 true) (bvule #x00 #x01)) (in_range3 temp___expr_4913)))
