...
(define-fun dynamic_invariant ((temp___expr_215 (_ BitVec 64)) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_236 (_ BitVec 64)) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool) (temp___do_typ_inv_235 Bool)) Bool true)
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant1 addr true true true true) (let ((result (readmem64 addr x86__memory))) (and (= (hasmem64 x86__memory addr result) true) (dynamic_invariant1 result true false true true)))) :pattern ((readmem64 addr x86__memory))))))
...
(define-fun to_int4 ((x unsigned_64)) Int (bv2nat (to_rep1 x)))
(assert (forall ((x unsigned_64)) (! (uint_in_range1 (to_int4 x)) :pattern ((to_int4 x)))))
...
(assert (and (forall ((i9 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i9) (bvule i9 (bvsub rcx_start rcx))) (=> (not (= i9 (bvsub rcx_start rcx))) (= (hasmem64 mem (bvadd rdi_start (bvmul i9 #x0000000000000008)) rax) true)))) (and (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) #x0000000000000008))) (and (bvule rcx rcx_start) (and (bvult rcx_start #x1FFFFFFFFFFFFFFF) (and (= (nooverlap8equal memory mem rdi) true) (forall ((i9 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i9) (bvule i9 (bvsub rcx_start rcx))) (=> (not (= i9 (bvsub rcx_start rcx))) (= (nooverlap8 (bvadd rdi_start (bvmul i9 #x0000000000000008)) rdi) true))))))))))
(assert (= (bvsub rcx_start rcx) r75b))
(assert (= (mk_t__ref1 result) (mk_t__ref1 i)))
(assert (= i1 #x0000000000000000))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (= temp___431 i1)))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (=> (not (= i1 (bvsub rcx_start rcx))) (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j #x0000000000000007)) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j)))))))))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (=> (not (= i1 (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul i1 #x0000000000000008)) rax) true))))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j i2)) (=> (not (= j (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul j #x0000000000000008)) rax) true))))))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (and (=> (bvule #x0000000000000000 r75b) (dynamic_property #x0000000000000000 r75b i2)) (and (bvule #x0000000000000000 i2) (bvule i2 r75b)))))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (= i2 r75b)))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (= i2 i3)))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (= i4 i2)))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (= (mk_t__ref1 i5) (mk_t__ref1 i3))))
(assert (=> (and (bvule #x0000000000000000 i1) (bvule i1 r75b)) (= i6 i4)))
(assert (=> (not (and (bvule #x0000000000000000 i1) (bvule i1 r75b))) (= i1 i5)))
(assert (=> (not (and (bvule #x0000000000000000 i1) (bvule i1 r75b))) (= i6 i1)))
(assert (= i7 i5))
(assert (= i8 i6))
(declare-const i9 (_ BitVec 64))
(assert (bvule #x0000000000000000 i9))
(assert (bvule i9 (bvsub rcx_start rcx)))
(assert (not (= i9 (bvsub rcx_start rcx))))
(assert (not (= (readmem64 (bvadd rdi_start (bvmul i9 #x0000000000000008)) memory) rax)))
(check-sat)
(exit)
