...
(define-fun dynamic_invariant1 ((temp___expr_202 (_ BitVec 64)) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool true)
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant1 addr true true true) (let ((result (readmem64 addr x86__memory))) (and (= (hasmem64 x86__memory addr result) true) (dynamic_invariant1 result true false true)))) :pattern ((readmem64 addr x86__memory))))))
(declare-const rcx_start (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const rdi_start (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const r75b (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-fun to_rep1 (unsigned_64) (_ BitVec 64))
(declare-fun of_rep1 ((_ BitVec 64)) unsigned_64)
(assert (forall ((x unsigned_64)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert true)
(assert (forall ((x (_ BitVec 64))) (! (= (to_rep1 (of_rep1 x)) x) :pattern ((to_rep1 (of_rep1 x))))))
(define-fun to_int5 ((x unsigned_64)) Int (bv2nat (to_rep1 x)))
...
(declare-datatypes () ((t76b__ref (mk_t76b__ref (t76b__content unsigned_64)))))
(define-fun t76b__ref___projection ((a t76b__ref)) unsigned_64 (t76b__content a))
...
(assert (and (forall ((i9 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i9) (bvule i9 (bvsub rcx_start rcx))) (=> (not (= i9 (bvsub rcx_start rcx))) (= (hasmem64 mem (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rax) true)))) (and (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8)))) (and (bvule rcx rcx_start) (and (bvult rcx_start ((_ int2bv 64) 2305843009213693951)) (and (= (nooverlap8equal memory mem rdi) true) (forall ((i9 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i9) (bvule i9 (bvsub rcx_start rcx))) (=> (not (= i9 (bvsub rcx_start rcx))) (= (nooverlap8 (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) rdi) true))))))))))
(assert (= (bvsub rcx_start rcx) r75b))
(assert (= (mk_t__ref1 result) (mk_t__ref1 i)))
(assert (= i1 ((_ int2bv 64) 0)))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= temp___392 i1)))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (=> (not (= i1 (bvsub rcx_start rcx))) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j ((_ int2bv 64) 7))) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j)))))))))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (=> (not (= i1 (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) rax) true))))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j i2)) (=> (not (= j (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul j ((_ int2bv 64) 8))) rax) true))))))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (and (=> (bvule ((_ int2bv 64) 0) r75b) (dynamic_property ((_ int2bv 64) 0) r75b i2)) (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 r75b)))))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= i2 r75b)))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= i2 i3)))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= i4 i2)))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= (mk_t__ref1 i5) (mk_t__ref1 i3))))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= i6 i4)))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))) (= i1 i5)))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))) (= i6 i1)))
(assert (= i7 i5))
(assert (= i8 i6))
(declare-const i9 (_ BitVec 64))
(assert (bvule ((_ int2bv 64) 0) i9))
(assert (bvule i9 (bvsub rcx_start rcx)))
(assert (not (= i9 (bvsub rcx_start rcx))))
(assert (not (= (readmem64 (bvadd rdi_start (bvmul i9 ((_ int2bv 64) 8))) memory) rax)))
(check-sat)
(exit)
