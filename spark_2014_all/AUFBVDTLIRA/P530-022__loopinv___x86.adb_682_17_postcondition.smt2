...
(assert true)
(assert true)
(assert (and (forall ((i12 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i12) (bvule i12 (bvsub rcx_start rcx))) (=> (not (= i12 (bvsub rcx_start rcx))) (= (hasmem64 mem (bvadd rdi_start (bvmul i12 ((_ int2bv 64) 8))) rax) true)))) (and (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8)))) (and (bvule rcx rcx_start) (and (bvult rcx_start ((_ int2bv 64) 2305843009213693951)) (and (= (nooverlap8equal memory mem rdi) true) (forall ((i12 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i12) (bvule i12 (bvsub rcx_start rcx))) (=> (not (= i12 (bvsub rcx_start rcx))) (= (nooverlap8 (bvadd rdi_start (bvmul i12 ((_ int2bv 64) 8))) rdi) true))))))))))
(assert (= (bvsub rcx_start rcx) r75b))
(assert true)
(assert (= (mk_t__ref1 result) (mk_t__ref1 i)))
(assert (= i1 ((_ int2bv 64) 0)))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (and (and (= temp___392 i1) (and (=> (not (= i1 (bvsub rcx_start rcx))) (and (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j ((_ int2bv 64) 7))) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j)))))) (= (hasmem64 memory (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) rax) true))) (and (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j i2)) (=> (not (= j (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul j ((_ int2bv 64) 8))) rax) true)))) (and (and (=> (bvule ((_ int2bv 64) 0) r75b) (dynamic_property ((_ int2bv 64) 0) r75b i2)) (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 r75b))) (= i2 r75b))))) (and (= i2 i6) (= i7 i2)))))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= (mk_t__ref1 i8) (mk_t__ref1 i6))))
(assert (=> (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b)) (= i9 i7)))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))) (= i1 i8)))
(assert (=> (not (and (bvule ((_ int2bv 64) 0) i1) (bvule i1 r75b))) (= i9 i1)))
(assert (= i10 i8))
(assert (= i11 i9))
(declare-const i12 (_ BitVec 64))
(assert (bvule ((_ int2bv 64) 0) i12))
(assert (bvule i12 (bvsub rcx_start rcx)))
(assert (not (= i12 (bvsub rcx_start rcx))))
(assert (not (= (readmem64 (bvadd rdi_start (bvmul i12 ((_ int2bv 64) 8))) memory) rax)))
(check-sat)
(exit)
