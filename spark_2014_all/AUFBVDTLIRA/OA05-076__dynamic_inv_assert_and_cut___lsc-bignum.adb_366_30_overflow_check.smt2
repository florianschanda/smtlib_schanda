...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o98 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o99 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o99 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= a_msw3 o37))
(assert (= o95 (from_word32 #x00000001)))
(assert (and (= o89 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o90 (+ o89 1)))
(assert (and (= o91 o90) (in_range1 o90)))
(assert (and (= o92 o91) (in_range2 o91)))
(assert (= o93 (num_of_big_int m m_first o92)))
(assert (= o88 (from_word32 #x00000002)))
(assert (= o94 (omultiply o88 o93)))
(assert (= o96 (osubtract o94 o95)))
(assert (= o85 (from_word32 a_msw3)))
(assert (and (= o80 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o81 (+ o80 1)))
(assert (and (= o82 o81) (in_range1 o81)))
(assert (and (= o83 o82) (in_range2 o82)))
(assert (and (= o79 (base Tuple0)) (= o79 (oexpon (from_word32 #x00000002) 32))))
(assert (= o84 (oexpon o79 o83)))
(assert (= o86 (omultiply o84 o85)))
(assert (and (= o74 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o75 (+ o74 1)))
(assert (and (= o76 o75) (in_range1 o75)))
(assert (and (= o77 o76) (in_range2 o76)))
(assert (= o78 (num_of_big_int (mk___t o102 (mk (to_rep a__first) (to_rep a__last))) a_first o77)))
(assert (= o87 (oadd o78 o86)))
(assert (= o97 (olt o87 o96)))
(assert (and (= o68 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o69 (+ o68 1)))
(assert (and (= o70 o69) (in_range1 o69)))
(assert (and (= o71 o70) (in_range2 o70)))
(assert (= o72 (num_of_big_int m m_first o71)))
(assert (and (= o62 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o63 (- o62 a_first)))
