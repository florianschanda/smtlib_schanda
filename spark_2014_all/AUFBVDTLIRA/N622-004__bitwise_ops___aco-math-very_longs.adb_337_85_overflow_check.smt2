...
(assert (or (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index3)) ((_ int2bv 8) 0))) (exists ((j Int)) (and (and (<= (+ i2 1) j) (<= j (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) j)) ((_ int2bv 8) 0)))))))
(assert (=> (< digit_index3 i2) (forall ((j Int)) (=> (and (<= (+ digit_index3 1) j) (<= j i2)) (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) j)) ((_ int2bv 8) 0))))))
...
(assert (not (in_range1 (+ digit_index3 1))))
(check-sat)
(exit)
