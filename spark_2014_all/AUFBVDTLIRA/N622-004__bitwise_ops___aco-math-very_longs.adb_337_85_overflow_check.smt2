...
(assert (=> (< digit_index3 i2) (forall ((j Int)) (=> (and (<= (+ digit_index3 1) j) (<= j i2)) (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00)))))
