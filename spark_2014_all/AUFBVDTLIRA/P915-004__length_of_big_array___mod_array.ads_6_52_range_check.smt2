...
(define-fun dynamic_invariant ((temp___expr_319 us_t) (temp___is_init_315 Bool) (temp___skip_constant_316 Bool) (temp___do_toplevel_317 Bool) (temp___do_typ_inv_318 Bool)) Bool (=> (not (= temp___skip_constant_316 true)) (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF (first1 temp___expr_319) (last1 temp___expr_319))))
(declare-const x us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_312 (_ BitVec 64)) (temp___is_init_308 Bool) (temp___skip_constant_309 Bool) (temp___do_toplevel_310 Bool) (temp___do_typ_inv_311 Bool)) Bool true)
