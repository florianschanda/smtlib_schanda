...
(define-fun dynamic_invariant ((temp___expr_3177 us_t1) (temp___is_init_3173 Bool) (temp___skip_constant_3174 Bool) (temp___do_toplevel_3175 Bool) (temp___do_typ_inv_3176 Bool)) Bool (=> (not (= temp___skip_constant_3174 true)) (and (dynamic_property2 1 1024 (first3 temp___expr_3177) (last3 temp___expr_3177)) (and (= (first3 temp___expr_3177) 1) (= (last3 temp___expr_3177) 1024)))))
