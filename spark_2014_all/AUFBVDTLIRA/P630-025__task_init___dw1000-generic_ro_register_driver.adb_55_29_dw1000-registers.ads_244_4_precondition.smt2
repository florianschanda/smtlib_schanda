...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rx_buffer_type__rx_buffer (Array Int bits_8))))))
(define-fun us_split_fields_RX_BUFFER__projection ((a us_split_fields)) (Array Int bits_8) (rec__dw1000__register_types__rx_buffer_type__rx_buffer a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (bool_eq (rec__dw1000__register_types__rx_buffer_type__rx_buffer (us_split_fields1 a)) 1 1024 (rec__dw1000__register_types__rx_buffer_type__rx_buffer (us_split_fields1 b)) 1 1024) true) true false))
...
(declare-const dw1000__register_types__rx_buffer_type__rx_buffer__first__bit Int)
(declare-const dw1000__register_types__rx_buffer_type__rx_buffer__last__bit Int)
(declare-const dw1000__register_types__rx_buffer_type__rx_buffer__position Int)
(assert (<= 0 dw1000__register_types__rx_buffer_type__rx_buffer__first__bit))
(assert (< dw1000__register_types__rx_buffer_type__rx_buffer__first__bit dw1000__register_types__rx_buffer_type__rx_buffer__last__bit))
(assert (<= 0 dw1000__register_types__rx_buffer_type__rx_buffer__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((rx_buffer_type__ref (mk_rx_buffer_type__ref (rx_buffer_type__content us_rep)))))
(define-fun rx_buffer_type__ref___projection ((a rx_buffer_type__ref)) us_rep (rx_buffer_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___32__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___23__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___23__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2885 us_t1) (temp___is_init_2882 Bool) (temp___skip_constant_2883 Bool) (temp___do_toplevel_2884 Bool)) Bool (=> (not (= temp___skip_constant_2883 true)) (and (dynamic_property2 1 1024 (first3 temp___expr_2885) (last3 temp___expr_2885)) (and (= (first3 temp___expr_2885) 1) (= (last3 temp___expr_2885) 1024)))))
