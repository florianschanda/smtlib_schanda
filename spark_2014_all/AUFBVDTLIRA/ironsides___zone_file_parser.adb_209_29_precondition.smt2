...
(assert (= begidx6 o31))
(assert (and (and (and (and (<= begidx7 endidx4) (<= begidx7 zlength)) (<= endidx4 zlength)) (=> (= foundtype4 1) (forall ((i Int)) (=> (and (<= begidx7 i) (<= i endidx4)) (and (<= 48 (to_rep1 (select zonefileline i))) (<= (to_rep1 (select zonefileline i)) 57)))))) (and (and (in_range2 begidx7) (in_range2 endidx4)) (in_range1 foundtype4))))
