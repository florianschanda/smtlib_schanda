...
(define-fun dynamic_invariant ((temp___expr_6527 us_t1) (temp___is_init_6524 Bool) (temp___skip_constant_6525 Bool) (temp___do_toplevel_6526 Bool)) Bool (=> (not (= temp___skip_constant_6525 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6527) (last3 temp___expr_6527)) (and (= (first3 temp___expr_6527) 1) (= (last3 temp___expr_6527) 4)))))
