...
(assert (= (mk_t__ref2 x86__readmem32__result4) (mk_t__ref2 x86__readmem32__result2)))
(assert (= x86__readmem32__result5 x86__readmem32__result3))
(assert (= result1 x86__readmem32__result4))
(assert (not (= x86__readmem32__result4 (bvor ((_ zero_extend 16) (readmem16 addr memory)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) memory)) ((_ int2bv 32) 16))))))
(check-sat)
(exit)
