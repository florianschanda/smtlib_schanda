...
(assert (not (= x86__readmem32__result4 (bvor ((_ zero_extend 16) (readmem16 addr memory)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 16))))))
(check-sat)
(exit)
