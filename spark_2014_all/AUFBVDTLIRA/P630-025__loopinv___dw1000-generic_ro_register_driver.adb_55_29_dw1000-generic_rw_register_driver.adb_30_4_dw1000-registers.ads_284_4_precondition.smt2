...
(define-fun dynamic_invariant ((temp___expr_3275 us_t1) (temp___is_init_3272 Bool) (temp___skip_constant_3273 Bool) (temp___do_toplevel_3274 Bool)) Bool (=> (not (= temp___skip_constant_3273 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3275) (last3 temp___expr_3275)) (and (= (first3 temp___expr_3275) 1) (= (last3 temp___expr_3275) 4)))))
