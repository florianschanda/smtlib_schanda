...
(assert (= (to_rep6 o12) 0))
(assert (= (to_rep1 o13) ((_ extract 7 0) sub_address)))
(assert (= (to_rep4 o14) 1))
(assert (= (to_rep5 o15) 1))
(assert (= (to_rep o16) register_id))
(assert (= o16 o17))
(assert (= o15 o18))
(assert (= o14 o19))
(assert (= o13 o20))
(assert (= o12 o21))
(assert (= temp___757 o17))
(assert (= temp___7571 o18))
(assert (= temp___7572 o19))
(assert (= temp___7573 o20))
(assert (= temp___7574 o21))
(assert (not (= (to_rep5 temp___7571) 1)))
(check-sat)
(exit)
