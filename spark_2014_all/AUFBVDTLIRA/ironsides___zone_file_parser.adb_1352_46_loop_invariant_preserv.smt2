...
(assert (and (<= 1 temp___1714) (<= temp___1714 128)))
(assert (= o9 temp___1714))
(assert (= o10 (store newdomainname2 o9 o8)))
(assert (= result30 (mk_map__ref newdomainname2)))
(assert (= newdomainname3 o10))
(assert (not (= i39 r93b)))
(assert (= result31 (mk_int__ref i39)))
(assert (= i40 (+ i39 1)))
(assert (= i41 (mk_int__ref i40)))
(assert (= newdomainname4 (mk_map__ref newdomainname3)))
(assert (= i42 i40))
(assert (= newdomainname5 newdomainname3))
(assert (not (<= 1 begidx19)))
(check-sat)
(exit)
