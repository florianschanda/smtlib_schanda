...
(assert (= (to_rep2 o30) 1))
(assert (= o31 (mk___split_discrs o30)))
(assert (= temp___332 (mk___rep2 o31 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___332)) (rec__parse__parse_result_t__return_code result____split_discrs5))))
(check-sat)
(exit)
