...
(assert (and (and (<= start_byte (- 8168 current_name_length)) (<= 1 i2)) (<= i2 129)))
(assert (and (=> (<= 1 current_name_length) (dynamic_property 1 current_name_length i2)) (and (<= 1 i2) (<= i2 current_name_length))))
(assert (and (= o6 (to_rep (select (rec__rr_type__srv_record_type__srvrecordtype__servername (us_split_fields3 srv_record)) i2))) (uint_in_range (to_rep (select (rec__rr_type__srv_record_type__srvrecordtype__servername (us_split_fields3 srv_record)) i2)))))
(assert (= o7 ((_ int2bv 8) o6)))
(assert (= (to_rep1 o8) o7))
(assert (not (<= 1 (+ (+ start_byte 11) i2))))
(check-sat)
(exit)
