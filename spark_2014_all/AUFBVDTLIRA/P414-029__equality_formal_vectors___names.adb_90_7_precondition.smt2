...
(define-fun o26 () us_rep4 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
(assert (=> (in_range12 n3) (and (= o26 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq4 o26 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))))
...
(assert (= o24 o21))
(assert (= o25 o22))
(assert (not (< (length4 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) (capacity1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))))))
(check-sat)
(exit)
