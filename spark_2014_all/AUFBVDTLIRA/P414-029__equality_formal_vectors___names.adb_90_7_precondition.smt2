...
(define-fun o27 () us_rep3 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
(assert (=> (in_range9 n3) (and (= o27 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) (= (bool_eq4 o27 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) true))))
...
(assert (= o25 o22))
(assert (= o26 o23))
(assert (not (< (length4 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) (capacity1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))))))
(check-sat)
(exit)
