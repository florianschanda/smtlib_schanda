...
(assert (= result20 (mk_t__ref blocknumber)))
(assert (= blocknumber1 o31))
(assert (= result21 (mk_map__ref5 blockmap3)))
(assert (= blockmap4 (store blockmap3 blocknumber1 (distinct 1 0))))
(assert (= o32 (from_query_type recordtype3)))
(assert (= o33 (bvudiv o32 #x0100)))
(assert (= o34 (bvmul #x0100 o33)))
(assert (= o35 (from_query_type recordtype3)))
(assert (= o36 (bvsub o35 o34)))
(assert (= o37 (bvudiv o36 #x0008)))
