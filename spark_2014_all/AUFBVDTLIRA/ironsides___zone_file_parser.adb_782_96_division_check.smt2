...
(assert (= result21 (mk_t__ref blocknumber2)))
(assert (= blocknumber3 o31))
(assert (= result22 (mk_map__ref5 blockmap3)))
(assert (= blockmap4 (store blockmap3 blocknumber3 (of_int 1))))
(assert (= o32 (from_query_type recordtype4)))
(assert (= o33 (bvudiv o32 ((_ int2bv 16) 256))))
(assert (= o34 (bvmul ((_ int2bv 16) 256) o33)))
(assert (= o35 (from_query_type recordtype4)))
(assert (= o36 (bvsub o35 o34)))
(assert (= o37 (bvudiv o36 ((_ int2bv 16) 8))))
