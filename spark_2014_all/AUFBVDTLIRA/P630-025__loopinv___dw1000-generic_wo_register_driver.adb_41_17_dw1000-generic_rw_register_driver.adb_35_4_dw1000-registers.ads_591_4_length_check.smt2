...
(define-fun register_byte_array__ref___149__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_7686 us_t1) (temp___is_init_7682 Bool) (temp___skip_constant_7683 Bool) (temp___do_toplevel_7684 Bool) (temp___do_typ_inv_7685 Bool)) Bool (=> (not (= temp___skip_constant_7683 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7686) (last3 temp___expr_7686)) (and (= (first3 temp___expr_7686) 1) (= (last3 temp___expr_7686) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___64__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_7706 us_t2) (temp___is_init_7702 Bool) (temp___skip_constant_7703 Bool) (temp___do_toplevel_7704 Bool) (temp___do_typ_inv_7705 Bool)) Bool (=> (not (= temp___skip_constant_7703 true)) (and (dynamic_property3 1 4 (first5 temp___expr_7706) (last5 temp___expr_7706)) (and (= (first5 temp___expr_7706) 1) (= (last5 temp___expr_7706) 4)))))
...
(declare-const temp___89541 t2)
(declare-const temp___8955 (Array Int bits_8))
(declare-const temp___89551 t1)
(define-fun temp___89542 () us_t2 (mk___t2 temp___8954 temp___89541))
...
(assert (and (= temp___89542 (register_to_bytes reg)) (dynamic_invariant1 temp___89542 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___89541)) (to_rep (last4 temp___89541))) (+ (- (to_rep (last4 temp___89541)) (to_rep (first4 temp___89541))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8954 temp___8955))
(assert (= (mk1 (to_rep (first4 temp___89541)) (to_rep (last4 temp___89541))) temp___89551))
(assert (not (= (ite (<= (to_rep (first2 temp___89551)) (to_rep (last2 temp___89551))) (+ (- (to_rep (last2 temp___89551)) (to_rep (first2 temp___89551))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
