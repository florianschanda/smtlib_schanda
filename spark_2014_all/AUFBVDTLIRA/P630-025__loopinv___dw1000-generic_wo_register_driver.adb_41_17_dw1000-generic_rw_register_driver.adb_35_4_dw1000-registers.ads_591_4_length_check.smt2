...
(define-fun tregister_byte_arrayP1__ref___149__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___64__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x3FFFFFFF)))
...
(declare-fun user_eq7 (bits_30 bits_30) Bool)
(declare-const dummy7 bits_30)
(declare-datatypes () ((bits_30__ref (mk_bits_30__ref (bits_30__content bits_30)))))
(define-fun bits_30__ref___projection ((a bits_30__ref)) bits_30 (bits_30__content a))
(declare-fun to_rep3 (bits_30) (_ BitVec 32))
(declare-fun of_rep3 ((_ BitVec 32)) bits_30)
(assert (forall ((x bits_30)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_30)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x #x40000000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int6 ((x bits_30)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_30)) (! (in_range_int1 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__evc_ctrl_type__evc_en bits_1) (rec__dw1000__register_types__evc_ctrl_type__evc_clr bits_1) (rec__dw1000__register_types__evc_ctrl_type__reserved bits_30)))))
(define-fun us_split_fields_EVC_EN__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__evc_ctrl_type__evc_en a))
(define-fun us_split_fields_EVC_CLR__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__evc_ctrl_type__evc_clr a))
(define-fun us_split_fields_Reserved__22__projection ((a us_split_fields)) bits_30 (rec__dw1000__register_types__evc_ctrl_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___87__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___87__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep2 (rec__dw1000__register_types__evc_ctrl_type__evc_en (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__evc_ctrl_type__evc_en (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__evc_ctrl_type__evc_clr (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__evc_ctrl_type__evc_clr (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__evc_ctrl_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__evc_ctrl_type__reserved (us_split_fields1 b))))) true false))
...
(assert (< dw1000__register_types__evc_ctrl_type__evc_en__first__bit dw1000__register_types__evc_ctrl_type__evc_en__last__bit))
...
(assert (< dw1000__register_types__evc_ctrl_type__evc_clr__first__bit dw1000__register_types__evc_ctrl_type__evc_clr__last__bit))
...
(assert (< dw1000__register_types__evc_ctrl_type__reserved__first__bit dw1000__register_types__evc_ctrl_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__evc_ctrl_type__reserved__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((evc_ctrl_type__ref (mk_evc_ctrl_type__ref (evc_ctrl_type__content us_rep)))))
(define-fun evc_ctrl_type__ref___projection ((a evc_ctrl_type__ref)) us_rep (evc_ctrl_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___64__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_7706 us_t1) (temp___is_init_7702 Bool) (temp___skip_constant_7703 Bool) (temp___do_toplevel_7704 Bool) (temp___do_typ_inv_7705 Bool)) Bool (=> (not (= temp___skip_constant_7703 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7706) (last3 temp___expr_7706)) (and (= (first3 temp___expr_7706) 1) (= (last3 temp___expr_7706) 4)))))
...
(define-fun register_type__ref___212__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___149__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7686 us_t2) (temp___is_init_7682 Bool) (temp___skip_constant_7683 Bool) (temp___do_toplevel_7684 Bool) (temp___do_typ_inv_7685 Bool)) Bool (=> (not (= temp___skip_constant_7683 true)) (and (dynamic_property3 1 4 (first5 temp___expr_7686) (last5 temp___expr_7686)) (and (= (first5 temp___expr_7686) 1) (= (last5 temp___expr_7686) 4)))))
...
(declare-const temp___8954 (Array Int bits_8))
(declare-const temp___89541 t1)
(declare-const temp___8955 (Array Int bits_8))
(declare-const temp___89551 t2)
(define-fun temp___89542 () us_t1 (mk___t1 temp___8954 temp___89541))
...
(assert (and (= temp___89542 (register_to_bytes reg)) (dynamic_invariant temp___89542 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89541)) (to_rep (last2 temp___89541))) (+ (- (to_rep (last2 temp___89541)) (to_rep (first2 temp___89541))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8954 temp___8955))
(assert (= (mk2 (to_rep (first2 temp___89541)) (to_rep (last2 temp___89541))) temp___89551))
(assert (not (= (ite (<= (to_rep (first4 temp___89551)) (to_rep (last4 temp___89551))) (+ (- (to_rep (last4 temp___89551)) (to_rep (first4 temp___89551))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
