...
(define-fun dynamic_invariant ((temp___expr_4 Int) (temp___is_init_0 Bool) (temp___skip_constant_1 Bool) (temp___do_toplevel_2 Bool) (temp___do_typ_inv_3 Bool)) Bool (=> (or (= temp___is_init_0 true) (<= (- 128) 127)) (in_range1 temp___expr_4)))
...
(define-fun dynamic_invariant1 ((temp___expr_166 (_ BitVec 16)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool true)
...
(assert (forall ((c (_ BitVec 16))) (! (=> (dynamic_invariant1 c true true true true) (let ((result (create c))) (and (and (= (first1 result) #x0000) (= (last1 result) c)) (dynamic_invariant2 result true false true true)))) :pattern ((create c)))))
...
(assert (and (= test_length__p1__a__assume2 (create #xFFFF)) (and (dynamic_invariant2 test_length__p1__a__assume2 true false true true) (and (= (to_rep (first test_length__p1__a__assume1)) #x0000) (= (to_rep (last test_length__p1__a__assume1)) #xFFFF)))))
(assert (= result a))
...
(assert (dynamic_property #x0000 #xFFFF (to_rep a__first) (to_rep a__last)))
