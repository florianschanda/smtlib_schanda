...
(assert (and (= (mk___t test_length__p1__a__assume test_length__p1__a__assume1) (create ((_ int2bv 16) 65535))) (and (dynamic_invariant2 (mk___t test_length__p1__a__assume test_length__p1__a__assume1) true false true) (and (= (to_rep (first test_length__p1__a__assume1)) ((_ int2bv 16) 0)) (= (to_rep (last test_length__p1__a__assume1)) ((_ int2bv 16) 65535))))))
(assert (= result a))
