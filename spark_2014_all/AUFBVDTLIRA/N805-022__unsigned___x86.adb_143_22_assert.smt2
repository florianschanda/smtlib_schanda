...
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000002)))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x01000000)) val__)))
(check-sat)
(exit)
