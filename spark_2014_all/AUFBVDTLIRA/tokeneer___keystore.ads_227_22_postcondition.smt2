...
(assert (forall ((x keyidt)) (! (in_range8 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range9 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x algorithmt)) (! (in_range10 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep)))))
(define-fun us_split_fields_IsPresent__projection ((a us_split_fields4)) Bool (rec__keystore__optionalprivatekeyt__ispresent a))
(define-fun us_split_fields_Owner__2__projection ((a us_split_fields4)) us_rep (rec__keystore__optionalprivatekeyt__owner a))
...
(assert true)
(assert (forall ((keystore__thistisinfo__fields us_split_fields4)) (! (= (= (privatekeypresent keystore__thistisinfo__fields) true) (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields5 (mk___rep2 keystore__thistisinfo__fields))) true)) :pattern ((privatekeypresent keystore__thistisinfo__fields)))))
...
(define-fun in_range11 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 15))))
...
(assert (forall ((x maskt)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x maskt)) (! (in_range11 (to_rep8 x)) :pattern ((to_rep8 x)))))
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 16)))) (=> (in_range11 y) (= (to_rep8 (of_rep8 x)) y))) :pattern ((to_rep8 (of_rep8 x))))))
...
(define-fun us_split_fields_Owner__projection ((a us_split_fields6)) us_rep (rec__keystore__interfac__keytemplatet__owner a))
...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (and (= (to_rep8 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields7 a))) (to_rep8 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields7 b)))) (= (bool_eq2 (rec__keystore__interfac__keytemplatet__owner (us_split_fields7 a)) (rec__keystore__interfac__keytemplatet__owner (us_split_fields7 b))) true)) (= (to_rep2 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields7 a))) (to_rep2 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields7 b))))) (= (to_rep2 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields7 a))) (to_rep2 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields7 b))))) (= (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields7 a)) (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields7 b)))) true false))
...
(declare-datatypes () ((keytemplatet__ref (mk_keytemplatet__ref (keytemplatet__content us_rep3)))))
(define-fun keytemplatet__ref___projection ((a keytemplatet__ref)) us_rep3 (keytemplatet__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_1038 Int) (temp___is_init_1035 Bool) (temp___skip_constant_1036 Bool) (temp___do_toplevel_1037 Bool)) Bool (=> (or (= temp___is_init_1035 true) (<= 0 28)) (in_range12 temp___expr_1038)))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq6 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int2 (select a (+ i 1))) (to_int2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int2 (select b (+ i 1))) (to_int2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1187 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1187 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_1187 us_void_param) 3)) 100)) (= (to_rep (select (temp___String_Literal_1187 us_void_param) 4)) 75)) (= (to_rep (select (temp___String_Literal_1187 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1187 us_void_param) 6)) 121)) :pattern ((temp___String_Literal_1187 us_void_param)))))
(declare-fun temp___String_Literal_1197 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1197 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 25)) 65)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 26)) 100)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 27)) 100)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 28)) 75)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 29)) 101)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 30)) 121)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 32)) 58)) (= (to_rep (select (temp___String_Literal_1197 us_void_param) 33)) 32)) :pattern ((temp___String_Literal_1197 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_259 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 4294967295)) (in_range5 temp___expr_259)))
...
(define-fun dynamic_invariant8 ((temp___expr_742 Int) (temp___is_init_739 Bool) (temp___skip_constant_740 Bool) (temp___do_toplevel_741 Bool)) Bool (=> (or (= temp___is_init_739 true) (<= 0 10)) (in_range10 temp___expr_742)))
(define-fun dynamic_invariant9 ((temp___expr_754 Int) (temp___is_init_751 Bool) (temp___skip_constant_752 Bool) (temp___do_toplevel_753 Bool)) Bool (=> (or (= temp___is_init_751 true) (<= 0 4294967295)) (in_range8 temp___expr_754)))
(define-fun dynamic_invariant10 ((temp___expr_760 Int) (temp___is_init_757 Bool) (temp___skip_constant_758 Bool) (temp___do_toplevel_759 Bool)) Bool (=> (or (= temp___is_init_757 true) (<= 0 128)) (in_range9 temp___expr_760)))
(define-fun dynamic_invariant11 ((temp___expr_217 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 1 150)) (in_range4 temp___expr_217)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_135 Tuple0)))
(assert true)
(define-fun dynamic_invariant12 ((temp___expr_979 (_ BitVec 32)) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 15))) (in_range11 temp___expr_979)))
...
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 thekeytemplate__split_fields (mk___rep (mk___split_fields thekeytemplate__split_fields1 thekeytemplate__split_fields2 thekeytemplate__split_fields3)) thekeytemplate__split_fields4 thekeytemplate__split_fields5 thekeytemplate__split_fields6))))
(assert (= thekeytemplate__split_fields7 (mk___split_fields3 temp___1185 (mk___rep (mk___split_fields temp___11851 temp___11852 temp___11853)) temp___11854 temp___11855 temp___11856)))
(assert (in_range12 retval1))
(assert (= result1 (mk_bool__ref added)))
(assert (= added1 (ite (= retval1 0) true false)))
(assert (=> (ite (= added1 true) (not (= ispublic true)) false) (= result2 (mk___split_fields__ref2 (mk___split_fields2 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))))
(assert (=> (ite (= added1 true) (not (= ispublic true)) false) (= thistisinfo__split_fields5 (mk___split_fields2 (of_int 1) theowner))))
(assert (=> (not (ite (= added1 true) (not (= ispublic true)) false)) (= thistisinfo__split_fields5 (mk___split_fields2 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))
...
(assert (=> (= (select issystem retval1) true) (= result3 (mk_map__ref result__))))
(assert (=> (= (select issystem retval1) true) (= result__2 nodescription)))
(assert (=> (= (select issystem retval1) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b)))))) (= o10 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b)))))) 1)))))
(assert (=> (= (select issystem retval1) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))))) (= o10 0))))
(assert (=> (= (select issystem retval1) true) (=> (<= 1 33) (= o11 (+ (- 33 1) 1)))))
(assert (=> (= (select issystem retval1) true) (=> (not (<= 1 33)) (= o11 0))))
...
(assert (=> (= (select issystem retval1) true) (and (= o15 o14) (in_range2 o14))))
(assert (=> (= (select issystem retval1) true) (= keystore__addkey__B153b__thestring__assume (mk___t (concat1 (temp___String_Literal_1197 Tuple0) 1 33 (elts (to_string (attr__ATTRIBUTE_IMAGE12 c149b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b)))))) (mk 1 o15)))))
(assert (=> (= (select issystem retval1) true) (= keystore__addkey__B153b__thestring__assume thestring)))
(assert (=> (= (select issystem retval1) true) (dynamic_invariant thestring true false true)))
(assert (=> (= (select issystem retval1) true) (and (= o16 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= (select issystem retval1) true) (= result4 (ite (<= o16 150) true false))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0)))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= temp___1191 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (and (= temp___1193 (length thestring)) (in_range1 (length thestring))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (=> (<= 1 temp___1193) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1193) (<= temp___1193 150)))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= o17 result__2))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= temp___1194 (mk___t1 o17 (mk1 1 temp___1193))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1191))) (to_rep1 (last2 (rt1 temp___1191)))) (+ (- (to_rep1 (last2 (rt1 temp___1191))) (to_rep1 (first2 (rt1 temp___1191)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1194))) (to_rep1 (last2 (rt1 temp___1194)))) (+ (- (to_rep1 (last2 (rt1 temp___1194))) (to_rep1 (first2 (rt1 temp___1194)))) 1) 0)))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= temp___1195 temp___1191))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (forall ((temp___1196 Int)) (ite (and (<= 1 temp___1196) (<= temp___1196 (length thestring))) (= (select o18 temp___1196) (select (elts1 temp___1195) temp___1196)) (= (select o18 temp___1196) (select result__2 temp___1196)))))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= result5 (mk_map__ref result__2)))))
(assert (=> (= (select issystem retval1) true) (=> (= result4 true) (= result__3 o18))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring))))))))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= temp___1190 thestring))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= o19 (elts temp___1190)))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= result6 (mk_map__ref result__2)))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= result__4 o19))))
(assert (=> (= (select issystem retval1) true) (=> (not (= result4 true)) (= result__3 result__4))))
(assert (=> (= (select issystem retval1) true) (= result7 (mk_map__ref c151b))))
(assert (=> (= (select issystem retval1) true) (= c151b2 result__3)))
(assert (=> (= (select issystem retval1) true) (= (valid_numberlogentries state2) true)))
(assert (=> (not (= (select issystem retval1) true)) (= filestate2 filestate)))
(assert (=> (not (= (select issystem retval1) true)) (= state2 state)))
(assert (=> (not (= (select issystem retval1) true)) (= result__3 result__)))
...
(assert (=> (not (= (select issystem retval1) true)) (= result__3 result__1)))
...
(assert (= thekeytemplate__split_fields8 (mk___split_fields__ref3 thekeytemplate__split_fields7)))
(assert (= thistisinfo__split_fields6 (mk___split_fields__ref2 thistisinfo__split_fields5)))
...
(assert (not (ite (= (ite (= (ite (= (bool__content added2) true) (ite (= ispublic false) (privatekeypresent (us_split_fields__content2 thistisinfo__split_fields6)) false) false) false) (ite (= (bool__content added2) true) (ite (= ispublic false) false (= (to_int2 (privatekeypresent (us_split_fields__content2 thistisinfo__split_fields6))) (to_int2 (privatekeypresent (mk___split_fields2 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))) (= (to_int2 (privatekeypresent (us_split_fields__content2 thistisinfo__split_fields6))) (to_int2 (privatekeypresent (mk___split_fields2 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))) true) true) (ite (= (ite (= (ite (= (bool__content added2) true) (ite (= ispublic false) (privatekeypresent (us_split_fields__content2 thistisinfo__split_fields6)) false) false) true) (ite (= (bool__content added2) true) (ite (= ispublic false) false (= (to_int2 (privatekeypresent (us_split_fields__content2 thistisinfo__split_fields6))) (to_int2 (privatekeypresent (mk___split_fields2 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))) (= (to_int2 (privatekeypresent (us_split_fields__content2 thistisinfo__split_fields6))) (to_int2 (privatekeypresent (mk___split_fields2 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))) false) false) true true) true)))
(check-sat)
(exit)
