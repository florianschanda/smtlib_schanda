...
(define-fun dynamic_invariant ((temp___expr_5661 us_t1) (temp___is_init_5658 Bool) (temp___skip_constant_5659 Bool) (temp___do_toplevel_5660 Bool)) Bool (=> (not (= temp___skip_constant_5659 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5661) (last3 temp___expr_5661)) (and (= (first3 temp___expr_5661) 1) (= (last3 temp___expr_5661) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5677 us_t2) (temp___is_init_5674 Bool) (temp___skip_constant_5675 Bool) (temp___do_toplevel_5676 Bool)) Bool (=> (not (= temp___skip_constant_5675 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5677) (last5 temp___expr_5677)) (and (= (first5 temp___expr_5677) 1) (= (last5 temp___expr_5677) 4)))))
...
(declare-const temp___8041 (Array Int bits_8))
(declare-const temp___80411 t2)
(declare-const temp___8042 (Array Int bits_8))
(declare-const temp___80421 t1)
...
(assert (and (= (mk___t2 temp___8041 temp___80411) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8041 temp___80411) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80411)) (to_rep (last4 temp___80411))) (+ (- (to_rep (last4 temp___80411)) (to_rep (first4 temp___80411))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
