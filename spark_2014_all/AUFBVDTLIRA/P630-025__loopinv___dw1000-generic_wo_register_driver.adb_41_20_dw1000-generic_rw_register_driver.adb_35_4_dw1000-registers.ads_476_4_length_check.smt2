...
(define-fun register_type__ref___151__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___107__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___107__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6224 us_t1) (temp___is_init_6220 Bool) (temp___skip_constant_6221 Bool) (temp___do_toplevel_6222 Bool) (temp___do_typ_inv_6223 Bool)) Bool (=> (not (= temp___skip_constant_6221 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6224) (last3 temp___expr_6224)) (and (= (first3 temp___expr_6224) 1) (= (last3 temp___expr_6224) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___45__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___45__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_6242 us_t2) (temp___is_init_6238 Bool) (temp___skip_constant_6239 Bool) (temp___do_toplevel_6240 Bool) (temp___do_typ_inv_6241 Bool)) Bool (=> (not (= temp___skip_constant_6239 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6242) (last5 temp___expr_6242)) (and (= (first5 temp___expr_6242) 1) (= (last5 temp___expr_6242) 4)))))
...
(declare-const temp___8813 (Array Int bits_8))
(declare-const temp___88131 t2)
(define-fun temp___88132 () us_t2 (mk___t2 temp___8813 temp___88131))
...
(assert (and (= temp___88132 (register_to_bytes reg)) (dynamic_invariant1 temp___88132 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___88131)) (to_rep (last4 temp___88131))) (+ (- (to_rep (last4 temp___88131)) (to_rep (first4 temp___88131))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
