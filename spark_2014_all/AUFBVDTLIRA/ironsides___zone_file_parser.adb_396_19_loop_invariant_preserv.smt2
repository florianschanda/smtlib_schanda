...
(assert (<= 1 i6))
(assert (<= i6 14))
(assert (and (and (<= endidx1 zlength) (= (- endidx1 begidx2) 13)) (<= i7 14)))
(assert (and (and (=> (<= 1 14) (in_range8 i7)) (forall ((temp___1473 Int)) (=> (and (<= 1 temp___1473) (<= temp___1473 14)) (=> (<= i7 temp___1473) (= (select timestring2 temp___1473) (select timestring1 temp___1473)))))) (and (<= 1 i7) (<= i7 14))))
(assert (and (<= 1 (- (+ begidx2 i7) 1)) (<= (- (+ begidx2 i7) 1) 256)))
(assert (= o14 (- (+ begidx2 i7) 1)))
(assert (= o15 (select zonefileline o14)))
(assert (= o16 (to_rep o15)))
(assert (= (to_rep o17) o16))
(assert (= o18 (store timestring2 i7 o17)))
(assert (= result5 (mk_map__ref timestring2)))
(assert (= timestring3 o18))
(assert (not (= i7 14)))
(assert (= result6 (mk_int__ref i7)))
(assert (= i8 (+ i7 1)))
