...
(assert (and (and (=> (<= 1 14) (in_range8 i2)) (forall ((temp___1532 Int)) (=> (and (<= 1 temp___1532) (<= temp___1532 14)) (=> (<= i2 temp___1532) (= (select timestring2 temp___1532) (select timestring1 temp___1532)))))) (and (<= 1 i2) (<= i2 14))))
