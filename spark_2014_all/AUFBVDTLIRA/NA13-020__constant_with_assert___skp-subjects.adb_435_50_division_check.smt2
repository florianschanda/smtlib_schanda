...
(assert (forall ((subject1 Int)) (=> (and (<= 0 subject1) (<= subject1 0)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject1 Int)) (=> (and (<= 1 subject1) (<= subject1 1)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject1 Int)) (=> (and (<= 2 subject1) (<= subject1 2)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject1 Int)) (=> (and (<= 3 subject1) (<= subject1 3)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject1 Int)) (=> (and (<= 4 subject1) (<= subject1 4)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (<= 5 subject))
(assert (<= subject 5))
