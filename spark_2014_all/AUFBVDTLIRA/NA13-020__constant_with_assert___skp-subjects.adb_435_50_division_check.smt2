...
(assert (forall ((subject7 Int)) (=> (and (<= 0 subject7) (<= subject7 0)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject7)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject7 Int)) (=> (and (<= 1 subject7) (<= subject7 1)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject7)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject7 Int)) (=> (and (<= 2 subject7) (<= subject7 2)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject7)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject7 Int)) (=> (and (<= 3 subject7) (<= subject7 3)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject7)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject7 Int)) (=> (and (<= 4 subject7) (<= subject7 4)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject7)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (<= 5 subject5))
(assert (<= subject5 5))
(assert (not (not (= ((_ int2bv 64) 4096) #x0000000000000000))))
(check-sat)
(exit)
