...
(assert (=> (<= (to_rep1 (first (rt temp___284))) (to_rep1 (last (rt temp___284)))) (= o (+ (- (to_rep1 (last (rt temp___284))) (to_rep1 (first (rt temp___284)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___284))) (to_rep1 (last (rt temp___284))))) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt temp___283))) (to_rep1 (last (rt temp___283)))) (= o1 (+ (- (to_rep1 (last (rt temp___283))) (to_rep1 (first (rt temp___283)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___283))) (to_rep1 (last (rt temp___283))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
