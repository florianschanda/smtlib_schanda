...
(assert (=> (<= (to_rep1 (first (rt temp___305))) (to_rep1 (last (rt temp___305)))) (= o (+ (- (to_rep1 (last (rt temp___305))) (to_rep1 (first (rt temp___305)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___305))) (to_rep1 (last (rt temp___305))))) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt temp___304))) (to_rep1 (last (rt temp___304)))) (= o1 (+ (- (to_rep1 (last (rt temp___304))) (to_rep1 (first (rt temp___304)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___304))) (to_rep1 (last (rt temp___304))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
