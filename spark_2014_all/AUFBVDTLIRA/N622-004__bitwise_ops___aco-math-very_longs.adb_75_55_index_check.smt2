...
(declare-fun temp___1491 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1493 (_ BitVec 8))) (forall ((temp___1494 Int) (temp___1495 Int)) (let ((temp___1492 (temp___1491 temp___1493 temp___1494 temp___1495))) (=> (dynamic_invariant1 temp___1493 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1494 temp___1495) (and (= (first5 temp___1492) temp___1494) (= (last5 temp___1492) temp___1495))) (forall ((temp___1496 Int)) (= (to_rep (select (to_array2 temp___1492) temp___1496)) temp___1493))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1491 #x00 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1491 #x00 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1498 temp___14981) (temp___1491 #x00 1 r19b)))
...
(assert (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1514 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1514) (<= temp___1514 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1514) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1514) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1514)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
