...
(define-fun dynamic_invariant2 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range1 temp___expr_271)))
...
(assert (forall ((x digit_index_type)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-datatypes () ((tS18bP1__ref (mk_tS18bP1__ref (tS18bP1__content tdigit_index_typeB)))))
(define-fun tS18bP1__ref___projection ((a tS18bP1__ref)) tdigit_index_typeB (tS18bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((s18b__ref (mk_s18b__ref (s18b__content us_t1)))))
(define-fun s18b__ref___projection ((a s18b__ref)) us_t1 (s18b__content a))
...
(declare-datatypes () ((t20b__ref (mk_t20b__ref (t20b__content tdigit_index_typeB)))))
(define-fun t20b__ref___projection ((a t20b__ref)) tdigit_index_typeB (t20b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t21b__ref (mk_t21b__ref (t21b__content us_t2)))))
(define-fun t21b__ref___projection ((a t21b__ref)) us_t2 (t21b__content a))
...
(declare-fun temp___1406 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1408 (_ BitVec 8))) (forall ((temp___1409 Int) (temp___1410 Int)) (let ((temp___1407 (temp___1406 temp___1408 temp___1409 temp___1410))) (and (=> (dynamic_property6 1 2147483647 temp___1409 temp___1410) (and (= (first5 temp___1407) temp___1409) (= (last5 temp___1407) temp___1410))) (forall ((temp___1411 Int)) (= (select (to_array2 temp___1407) temp___1411) (of_rep temp___1408))))))))
(define-fun dynamic_invariant4 ((temp___expr_498 us_t1) (temp___is_init_495 Bool) (temp___skip_constant_496 Bool) (temp___do_toplevel_497 Bool)) Bool (=> (not (= temp___skip_constant_496 true)) (and (dynamic_property3 1 r19b (first3 temp___expr_498) (last3 temp___expr_498)) (and (= (first3 temp___expr_498) 1) (= (last3 temp___expr_498) r19b)))))
...
(declare-const temp___1413 (Array Int octet))
(declare-const temp___14131 t2)
(declare-const temp___1414 (Array Int octet))
(declare-const temp___14141 t1)
(declare-const temp___1416 (Array Int octet))
(declare-const temp___14161 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1418 digit_index_type)
(declare-const temp___14181 (Array Int octet))
(declare-const temp___14182 t)
(declare-const temp___1430 (_ BitVec 16))
(declare-const temp___1427 digit_index_type)
(declare-const temp___14271 (Array Int octet))
(declare-const temp___14272 t)
(declare-const temp___1426 (_ BitVec 16))
(declare-const temp___1425 (_ BitVec 16))
(declare-const temp___1424 (_ BitVec 16))
...
(assert (dynamic_invariant3 (mk___rep result____split_discrs (mk___split_fields (mk___t result____split_fields result____split_fields1))) false false true))
(assert true)
...
(assert (and (= us (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (and (= us1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert true)
(assert true)
(assert true)
(assert (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r19b))
(assert (in_range1 r19b))
(assert (= (to_rep2 (first4 (rt2 (temp___1406 ((_ int2bv 8) 0) 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1406 ((_ int2bv 8) 0) 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1413 temp___14131) (temp___1406 ((_ int2bv 8) 0) 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___14131)) (to_rep2 (last4 temp___14131))) (+ (- (to_rep2 (last4 temp___14131)) (to_rep2 (first4 temp___14131))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1413 temp___1414))
(assert (= (mk1 (to_rep2 (first4 temp___14131)) (to_rep2 (last4 temp___14131))) temp___14141))
(assert (= (ite (<= (to_rep2 (first2 temp___14141)) (to_rep2 (last2 temp___14141))) (+ (- (to_rep2 (last2 temp___14141)) (to_rep2 (first2 temp___14141))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1416 temp___14161) (mk___t1 temp___1414 temp___14141)))
(assert (= temp___1416 o))
(assert (= (mk (to_rep2 (first2 temp___14161)) (to_rep2 (last2 temp___14161))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1418)))
(assert (= temp___14181 o2))
(assert (= temp___14182 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___14181 temp___14182))))
(assert (= result____split_discrs (mk___split_discrs temp___1418)))
...
(assert (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1429 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1429) (<= temp___1429 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1429) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1429) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1429)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
(assert (not (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) i2)))
(check-sat)
(exit)
