...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i Int)) (=> (and (<= begidx2 i) (<= i endidx1)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 tokentype1))))
(assert (and (= o (+ (- endidx1 begidx2) 1)) (in_range4 (+ (- endidx1 begidx2) 1))))
(assert (= (mk_int__ref result3) (mk_int__ref lengthoftoken)))
(assert (= lengthoftoken1 o))
(assert (= begidx2 r109b))
(assert (in_range4 r109b))
(assert (= endidx1 r110b))
(assert (in_range4 r110b))
(assert (<= r109b r110b))
(assert (not (<= (- 2147483648) r109b)))
(check-sat)
(exit)
