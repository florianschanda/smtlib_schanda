...
(declare-fun temp___1149 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1151 (_ BitVec 8))) (forall ((temp___1152 Int) (temp___1153 Int)) (let ((temp___1150 (temp___1149 temp___1151 temp___1152 temp___1153))) (and (=> (dynamic_property6 1 65536 temp___1152 temp___1153) (and (= (first5 temp___1150) temp___1152) (= (last5 temp___1150) temp___1153))) (forall ((temp___1154 Int)) (= (select (to_array2 temp___1150) temp___1154) (of_rep1 temp___1151))))))))
(define-fun dynamic_invariant4 ((temp___expr_375 us_t1) (temp___is_init_372 Bool) (temp___skip_constant_373 Bool) (temp___do_toplevel_374 Bool)) Bool (=> (not (= temp___skip_constant_373 true)) (and (dynamic_property3 1 r19b (first3 temp___expr_375) (last3 temp___expr_375)) (and (= (first3 temp___expr_375) 1) (= (last3 temp___expr_375) r19b)))))
...
(declare-const temp___1156 (Array Int octet))
(declare-const temp___11561 t2)
(declare-const temp___1157 (Array Int octet))
(declare-const temp___11571 t1)
(declare-const temp___1159 (Array Int octet))
(declare-const temp___11591 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1161 digit_index_type)
(declare-const temp___11611 (Array Int octet))
(declare-const temp___11612 t)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1149 ((_ int2bv 8) 0) 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1149 ((_ int2bv 8) 0) 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1156 temp___11561) (temp___1149 ((_ int2bv 8) 0) 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11561)) (to_rep2 (last4 temp___11561))) (+ (- (to_rep2 (last4 temp___11561)) (to_rep2 (first4 temp___11561))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1156 temp___1157))
(assert (= (mk1 (to_rep2 (first4 temp___11561)) (to_rep2 (last4 temp___11561))) temp___11571))
(assert (= (ite (<= (to_rep2 (first2 temp___11571)) (to_rep2 (last2 temp___11571))) (+ (- (to_rep2 (last2 temp___11571)) (to_rep2 (first2 temp___11571))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1159 temp___11591) (mk___t1 temp___1157 temp___11571)))
(assert (= temp___1159 o))
(assert (= (mk (to_rep2 (first2 temp___11591)) (to_rep2 (last2 temp___11591))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1161)))
(assert (= temp___11611 o2))
(assert (= temp___11612 o3))
(assert (= result result____split_fields))
(assert (= result1 result____split_fields1))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11611 temp___11612))))
(assert (= result____split_discrs (mk___split_discrs temp___1161)))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1172 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1172) (<= temp___1172 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1172) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1172) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1172)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
