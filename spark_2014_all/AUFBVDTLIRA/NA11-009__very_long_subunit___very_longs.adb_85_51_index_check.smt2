...
(declare-fun temp___1218 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1220 (_ BitVec 8))) (forall ((temp___1221 Int) (temp___1222 Int)) (let ((temp___1219 (temp___1218 temp___1220 temp___1221 temp___1222))) (=> (dynamic_invariant3 temp___1220 true true true true) (and (=> (dynamic_property6 1 65536 temp___1221 temp___1222) (and (= (first5 temp___1219) temp___1221) (= (last5 temp___1219) temp___1222))) (forall ((temp___1223 Int)) (= (to_rep1 (select (to_array2 temp___1219) temp___1223)) temp___1220))))))))
...
(declare-const temp___12251 t2)
(declare-const temp___1226 (Array Int octet))
(declare-const temp___12261 t1)
...
(declare-const o3 t)
(declare-const temp___1230 digit_index_type)
(declare-const temp___12301 (Array Int octet))
(declare-const temp___12302 t)
...
(assert (dynamic_invariant1 (mk___rep result____split_discrs (mk___split_fields (mk___t result____split_fields result____split_fields1))) false false true true))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1218 #x00 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1218 #x00 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1225 temp___12251) (temp___1218 #x00 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12251)) (to_rep2 (last4 temp___12251))) (+ (- (to_rep2 (last4 temp___12251)) (to_rep2 (first4 temp___12251))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1225 temp___1226))
(assert (= (mk1 (to_rep2 (first4 temp___12251)) (to_rep2 (last4 temp___12251))) temp___12261))
(assert (= (ite (<= (to_rep2 (first2 temp___12261)) (to_rep2 (last2 temp___12261))) (+ (- (to_rep2 (last2 temp___12261)) (to_rep2 (first2 temp___12261))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1228 temp___12281) (mk___t1 temp___1226 temp___12261)))
(assert (= temp___1228 o))
(assert (= (mk (to_rep2 (first2 temp___12281)) (to_rep2 (last2 temp___12281))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1230)))
(assert (= temp___12301 o2))
(assert (= temp___12302 o3))
(assert (= result result____split_fields))
(assert (= result1 result____split_fields1))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12301 temp___12302))))
(assert (= result____split_discrs (mk___split_discrs temp___1230)))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1241 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1241) (<= temp___1241 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1241) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1241) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1241)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
