...
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) ((_ int2bv 32) 16777216))) val__))
(assert (= xsi4 xsi5))
(assert (= xsi6 xsi4))
