...
(assert true)
(assert (and (and (and (and (= (to_rep o) ((_ extract 7 0) (bvurem val__ ((_ int2bv 32) 256)))) (= o1 (store xsi 0 o))) (and (= (mk_map__ref result) (mk_map__ref xsi)) (= xsi1 o1))) (and (and (and (= (to_rep o2) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 256)) ((_ int2bv 32) 256)))) (= o3 (store xsi1 1 o2))) (and (= xsi1 result1) (= xsi2 o3))) (and (and (and (= (to_rep o4) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 256)))) (= o5 (store xsi2 2 o4))) (and (= xsi2 result2) (= xsi3 o5))) (and (and (and (= (to_rep o6) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 16777216)) ((_ int2bv 32) 256)))) (= o7 (store xsi3 3 o6))) (and (= xsi3 result3) (= xsi4 o7))) (and (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (and (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))) (and (= (bvadd (bvurem val__ ((_ int2bv 32) 65536)) (bvmul (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))) val__) (and (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) ((_ int2bv 32) 16777216))) val__)) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) ((_ int2bv 32) 16777216))) val__))))))))) (and (= xsi4 xsi5) (= xsi6 xsi4))))
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi5 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi5 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi5 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi5 3))) ((_ int2bv 32) 16777216))) val__)))
(check-sat)
(exit)
