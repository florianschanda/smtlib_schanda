...
(define-fun dynamic_invariant2 ((temp___expr_4880 Int) (temp___is_init_4876 Bool) (temp___skip_constant_4877 Bool) (temp___do_toplevel_4878 Bool) (temp___do_typ_inv_4879 Bool)) Bool (=> (or (= temp___is_init_4876 true) (<= 0 1024)) (in_range2 temp___expr_4880)))
(define-fun dynamic_invariant3 ((temp___expr_4887 Int) (temp___is_init_4883 Bool) (temp___skip_constant_4884 Bool) (temp___do_toplevel_4885 Bool) (temp___do_typ_inv_4886 Bool)) Bool (=> (or (= temp___is_init_4883 true) (<= 0 5)) (in_range3 temp___expr_4887)))
(define-fun dynamic_invariant4 ((temp___expr_4894 us_rep) (temp___is_init_4890 Bool) (temp___skip_constant_4891 Bool) (temp___do_toplevel_4892 Bool) (temp___do_typ_inv_4893 Bool)) Bool (=> (= temp___do_toplevel_4892 true) (=> (= temp___is_init_4890 true) (ite (= (to_rep2 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4894))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4894)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4894))) 0)))))
...
(define-fun dynamic_invariant5 ((temp___expr_4913 (_ BitVec 8)) (temp___is_init_4909 Bool) (temp___skip_constant_4910 Bool) (temp___do_toplevel_4911 Bool) (temp___do_typ_inv_4912 Bool)) Bool (=> (or (= temp___is_init_4909 true) (bvule #x00 #x01)) (in_range1 temp___expr_4913)))
(assert (forall ((temp___4956 us_rep)) (=> (dynamic_invariant4 temp___4956 true true true true) (forall ((temp___4957 (_ BitVec 8))) (= (select (temp___4954 temp___4956) temp___4957) temp___4956)))))
...
(assert (forall ((temp___4960 (_ BitVec 8))) (=> (dynamic_invariant6 temp___4960 true true true true) (forall ((temp___4961 Int)) (= (to_rep3 (select (temp___4958 temp___4960) temp___4961)) temp___4960)))))
