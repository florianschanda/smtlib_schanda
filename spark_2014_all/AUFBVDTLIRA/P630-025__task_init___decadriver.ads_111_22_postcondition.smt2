...
(define-fun dynamic_invariant2 ((temp___expr_4397 Int) (temp___is_init_4394 Bool) (temp___skip_constant_4395 Bool) (temp___do_toplevel_4396 Bool)) Bool (=> (or (= temp___is_init_4394 true) (<= 0 1024)) (in_range2 temp___expr_4397)))
(define-fun dynamic_invariant3 ((temp___expr_4403 Int) (temp___is_init_4400 Bool) (temp___skip_constant_4401 Bool) (temp___do_toplevel_4402 Bool)) Bool (=> (or (= temp___is_init_4400 true) (<= 0 5)) (in_range3 temp___expr_4403)))
(define-fun dynamic_invariant4 ((temp___expr_4409 us_rep) (temp___is_init_4406 Bool) (temp___skip_constant_4407 Bool) (temp___do_toplevel_4408 Bool)) Bool (=> (= temp___do_toplevel_4408 true) (=> (= temp___is_init_4406 true) (ite (= (to_rep2 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4409))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4409)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4409))) 0)))))
...
(define-fun dynamic_invariant5 ((temp___expr_4427 (_ BitVec 8)) (temp___is_init_4424 Bool) (temp___skip_constant_4425 Bool) (temp___do_toplevel_4426 Bool)) Bool (=> (or (= temp___is_init_4424 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range1 temp___expr_4427)))
