...
(define-fun bool_eq2 ((a (Array (_ BitVec 32) name_id)) (a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b (Array (_ BitVec 32) name_id)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_132)))))))))))
...
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (< (to_rep2 (select a (bvadd i #x00000001))) (to_rep2 (select b (bvadd j #x00000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (< (to_rep2 (select b (bvadd i #x00000001))) (to_rep2 (select a (bvadd j #x00000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun in_range6 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep3 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_569 us_rep) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (not (= temp___skip_constant_567 true)) (in_range6 1024 temp___expr_569)))
(define-fun default_initial_assumption ((temp___expr_571 us_rep) (temp___skip_top_level_572 Bool)) Bool (and (= (to_rep3 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_571))) 1024) (=> (not (= temp___skip_top_level_572 true)) (= (is_empty temp___expr_571) true))))
...
(assert (forall ((x capacity_range1)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x Int)) (! (=> (in_range7 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun in_range8 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep4 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant4 ((temp___expr_578 us_rep1) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (not (= temp___skip_constant_576 true)) (in_range8 256 temp___expr_578)))
(define-fun default_initial_assumption1 ((temp___expr_580 us_rep1) (temp___skip_top_level_581 Bool)) Bool (and (= (to_rep4 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_580))) 256) (=> (not (= temp___skip_top_level_581 true)) (= (is_empty1 temp___expr_580) true))))
...
(assert (forall ((n Int)) (forall ((names__hash_table (Array (_ BitVec 32) name_id))) (forall ((names__char_table__fields us_split_fields)) (forall ((names__entry_table__fields us_split_fields2)) (! (=> (and (and (and (dynamic_invariant2 n true true true) (dynamic_invariant3 (mk___rep char_table__split_discrs names__char_table__fields) true true true)) (dynamic_invariant4 (mk___rep1 entry_table__split_discrs names__entry_table__fields) true true true)) (= (invariant__ names__hash_table names__char_table__fields names__entry_table__fields) true)) (dynamic_invariant (to_string1 n names__hash_table names__char_table__fields names__entry_table__fields) true false true)) :pattern ((to_string1 n names__hash_table names__char_table__fields names__entry_table__fields))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_249 (_ BitVec 32)) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool)) Bool (=> (or (= temp___is_init_246 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 255))) (in_range10 temp___expr_249)))
(declare-sort index_type 0)
(define-fun in_range11 ((x Int)) Bool (and (<= 1 x) (<= x 2147483647)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq14 (index_type index_type) Bool)
(declare-const dummy14 index_type)
...
(declare-fun to_rep5 (positive) Int)
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 a))) (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 b)))) (= (to_rep5 (rec__names__data__name_entry__length (us_split_fields5 a))) (to_rep5 (rec__names__data__name_entry__length (us_split_fields5 b))))) (= (to_rep2 (rec__names__data__name_entry__next_hash (us_split_fields5 a))) (to_rep2 (rec__names__data__name_entry__next_hash (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant6 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 2147483647)) (in_range13 temp___expr_436)))
...
(define-fun equal_except ((left us_rep3) (right us_rep3) (position Int)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (last2 left))) (=> (not (= i position)) (= (bool_eq3 (get left i) (get right i)) true)))) true false)))
...
(define-fun dynamic_invariant7 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range2 temp___expr_39)))
(define-fun dynamic_invariant8 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range3 temp___expr_63)))
...
(assert true)
(assert (forall ((names__hash_table (Array (_ BitVec 32) name_id))) (forall ((names__entry_table__fields us_split_fields2)) (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true) (forall ((h1 (_ BitVec 32))) (=> (and (bvule ((_ int2bv 32) 0) h1) (bvule h1 ((_ int2bv 32) 255))) (<= (to_rep2 (select names__hash_table h1)) (last_index (mk___rep1 entry_table__split_discrs names__entry_table__fields)))))) :pattern ((valid_hashes names__hash_table names__entry_table__fields))))))
...
(define-fun dynamic_invariant10 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range14 temp___expr_142)))
(define-fun dynamic_invariant11 ((temp___expr_243 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 1 2147483647)) (in_range9 temp___expr_243)))
(define-fun dynamic_invariant12 ((temp___expr_264 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483646)) (in_range12 temp___expr_264)))
...
(define-fun dynamic_invariant13 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 1) 2147483647)) (in_range15 temp___expr_282)))
(define-fun dynamic_invariant14 ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 0 2147483647)) (in_range5 temp___expr_288)))
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep3 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (capacity container)) (dynamic_invariant14 result true false true))) :pattern ((length3 container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_322 us_rep4) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (length4 temp___expr_322) 0)))
...
(define-fun dynamic_invariant15 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 1) 2147483646)) (in_range16 temp___expr_315)))
(assert (forall ((container us_rep4)) (! (let ((result (length4 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant10 result true false true))) :pattern ((length4 container)))))
...
(define-fun dynamic_invariant16 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range17 temp___expr_309)))
(assert (forall ((container us_rep4)) (forall ((position Int)) (! (=> (and (dynamic_invariant15 position true true true) (and (<= 0 position) (<= position (last3 container)))) (dynamic_invariant16 (get1 container position) true false true)) :pattern ((get1 container position))))))
(define-fun dynamic_invariant17 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range7 temp___expr_442)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (of_int 0) true) (to_rep4 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
(declare-fun capacity__function_guard1 (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (let ((result (length2 container))) (and (<= result (capacity1 container)) (dynamic_invariant17 result true false true))) :pattern ((length2 container)))))
(define-fun oeq1 ((left us_rep3) (right us_rep3)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last2 left))) (= (bool_eq3 (get left n) (get right n)) true))) true false)))
(declare-fun oeq__function_guard1 (Bool us_rep3 us_rep3) Bool)
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq17 a b) (oeq1 a b)) :pattern ((user_eq17 a b)))))
(define-fun default_initial_assumption3 ((temp___expr_479 us_rep3) (temp___skip_top_level_480 Bool)) Bool (=> (not (= temp___skip_top_level_480 true)) (= (length1 temp___expr_479) 0)))
...
(define-fun dynamic_invariant18 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range11 temp___expr_421)))
...
(define-fun dynamic_invariant19 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 2147483647)) (in_range18 temp___expr_472)))
(assert (forall ((container us_rep3)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant10 result true false true))) :pattern ((length1 container)))))
(assert true)
(declare-const n Int)
...
(declare-const temp___647 (Array Int character))
(declare-const temp___6471 t)
...
(declare-const temp___6472 (Array Int character))
(declare-const temp___6473 t)
(declare-const o20 Int)
(declare-const o21 Int)
(declare-const temp___650 char_table_index)
(declare-const temp___6501 positive)
(declare-const temp___6502 name_id)
(declare-const o22 name_id)
(declare-const o23 char_table_index)
(declare-const o24 positive)
(declare-const o25 name_id)
(declare-const o26 char_table_index)
(declare-const o27 positive)
(declare-const o28 name_id)
(declare-const o29 name_id)
(declare-const o30 (Array (_ BitVec 32) name_id))
...
(declare-const ptr4 Int)
(declare-const result8 Bool)
(declare-const result9 int__ref)
(declare-const n6 Int)
(declare-const ptr5 int__ref)
(declare-const ptr6 Int)
(declare-const n7 int__ref)
(declare-const ptr7 int__ref)
(declare-const n8 Int)
(declare-const ptr8 Int)
(declare-const n9 int__ref)
(declare-const ptr9 int__ref)
(declare-const n10 Int)
(declare-const ptr10 Int)
(declare-const n11 int__ref)
(declare-const ptr11 int__ref)
(declare-const n12 Int)
(declare-const ptr12 Int)
(declare-const n13 int__ref)
(declare-const ptr13 int__ref)
(declare-const n14 Int)
(declare-const ptr14 Int)
(declare-const n15 int__ref)
(declare-const ptr15 int__ref)
(declare-const n16 Int)
(declare-const ptr16 Int)
...
(declare-const names__data__entry_tables__replace_element__container__fields us_split_fields2)
...
(declare-const char_table__split_fields3 us_split_fields__ref)
(declare-const entry_table__split_fields6 us_split_fields__ref1)
(declare-const ptr17 int__ref)
...
(assert (= n3 (to_rep2 (select hash_table h))))
(assert (in_range9 n3))
(assert (= result3 (mk_int__ref ptr1)))
(assert (= ptr2 n3))
(assert (and (= (mk___t temp___647 temp___6471) (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant (mk___t temp___647 temp___6471) true false true)))
(assert (= result4 (bool_eq temp___647 (to_rep1 (first temp___6471)) (to_rep1 (last temp___6471)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))))
(assert (not (= result4 true)))
(assert (= n4 n3))
(assert (and (and (in_range9 ptr3) (<= ptr3 (last2 (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))) (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)))
(assert (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n5))))
(assert (and (= o2 ptr3) (in_range11 ptr3)))
(assert (not (<= 1 o2)))
(check-sat)
(exit)
