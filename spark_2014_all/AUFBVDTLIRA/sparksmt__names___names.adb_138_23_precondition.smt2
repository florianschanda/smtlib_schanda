...
(define-fun temp___6472 () us_t (mk___t temp___647 temp___6471))
...
(assert (= ptr2 n3))
(assert (and (= temp___6472 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___6472 true false true)))
(assert (= result3 (bool_eq temp___647 (to_rep1 (first temp___6471)) (to_rep1 (last temp___6471)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))))
