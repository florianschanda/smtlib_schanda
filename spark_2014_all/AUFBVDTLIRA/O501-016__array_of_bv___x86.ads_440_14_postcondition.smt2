...
(assert (= (bvor (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr #x0000000000000002) memory)) ((_ int2bv 32) 16)) (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr #x0000000000000003) memory)) ((_ int2bv 32) 24))) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) memory)) ((_ int2bv 32) 16))))
