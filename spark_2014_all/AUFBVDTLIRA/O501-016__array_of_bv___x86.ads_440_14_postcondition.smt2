...
(assert (= (bvor (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 16)) (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory)) ((_ int2bv 32) 24))) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 16))))
