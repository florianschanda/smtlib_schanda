...
(assert true)
(assert (and (and (= (bvor ((_ zero_extend 8) (readmem8 addr memory)) (ite (< 8 16) (bvshl ((_ zero_extend 8) (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory)) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))) (readmem16 addr memory)) (and (= (bvor (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 16)) (bvshl ((_ zero_extend 24) (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory)) ((_ int2bv 32) 24))) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 16))) (and (and (= x86__readmem32__result1 x86__readmem32__result2) (= x86__readmem32__result3 x86__readmem32__result1)) (and (and (and (and (and (= o9 (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory)) (= o9 (to_rep (select memory (bvadd addr ((_ int2bv 64) 3)))))) (= o10 ((_ zero_extend 24) o9))) (= o11 (bvshl o10 ((_ int2bv 32) 24)))) (and (and (and (and (and (= o5 (readmem8 (bvadd addr ((_ int2bv 64) 2)) memory)) (= o5 (to_rep (select memory (bvadd addr ((_ int2bv 64) 2)))))) (= o6 ((_ zero_extend 24) o5))) (= o7 (bvshl o6 ((_ int2bv 32) 16)))) (and (and (and (and (and (= o1 (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory)) (= o1 (to_rep (select memory (bvadd addr ((_ int2bv 64) 1)))))) (= o2 ((_ zero_extend 24) o1))) (= o3 (bvshl o2 ((_ int2bv 32) 8)))) (and (and (and (= o (readmem8 addr memory)) (= o (to_rep (select memory addr)))) (= o4 ((_ zero_extend 24) o))) (= o8 (bvor o4 o3)))) (= o12 (bvor o8 o7)))) (= o13 (bvor o12 o11)))) (and (= result x86__readmem32__result) (= x86__readmem32__result1 o13)))))) (and (= (mk_t__ref2 x86__readmem32__result4) (mk_t__ref2 x86__readmem32__result2)) (= x86__readmem32__result5 x86__readmem32__result3))))
