...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (= temp___566 b) (and (= temp___564 i1) (and (= temp___562 b) (and (= temp___558 b) (and (forall ((k3 Int)) (=> (and (<= (to_rep b__first) k3) (<= k3 (to_rep b__last))) (and (=> (and (<= b_first k3) (<= k3 (- (- (+ b_first i2) a_first) 1))) (= (to_rep1 (select b2 k3)) (to_rep1 (select (elts a) (- (+ a_first k3) b_first))))) (=> (=> (<= b_first k3) (not (<= k3 (- (- (+ b_first i2) a_first) 1)))) (= (to_rep1 (select b2 k3)) (to_rep1 (select temp___566 k3))))))) (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last))) (and (forall ((k3 Int)) (=> (and (<= (to_rep b__first) k3) (<= k3 (to_rep b__last))) (and (=> (and (<= b_first k3) (<= k3 (- (- (+ b_first (+ i2 1)) a_first) 1))) (= (to_rep1 (select b3 k3)) (to_rep1 (select (elts a) (- (+ a_first k3) b_first))))) (=> (=> (<= b_first k3) (not (<= k3 (- (- (+ b_first (+ i2 1)) a_first) 1)))) (= (to_rep1 (select b3 k3)) (to_rep1 (select temp___558 k3))))))) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (= i2 a_last))))))))) (and (and (= i2 i6) (= b3 b6)) (and (= i7 i2) (= b7 b3))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (mk_map__ref b8) (mk_map__ref b6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i9 i7)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= b9 b7)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i1 i8)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= (mk_map__ref b8) (mk_map__ref b))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i9 i1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= b9 b1)))
(assert (= (mk_int__ref i10) (mk_int__ref i8)))
(assert (= (mk_map__ref b10) (mk_map__ref b8)))
(assert (= i11 i9))
(assert (= b11 b9))
(assert (<= (to_rep b__first) k2))
(assert (<= k2 (to_rep b__last)))
(assert (and (= o78 (+ b_first a_last)) (in_range1 (+ b_first a_last))))
(assert (= o79 (- o78 a_first)))
(assert (and (= o80 o79) (in_range1 o79)))
(assert (= o81 (ite (<= k2 o80) true false)))
(assert (= o82 (ite (<= b_first k2) o81 false)))
(assert (= result7 (ite (not (= o82 true)) true false)))
(assert (= result7 true))
(assert (not (<= (to_rep b__first) k2)))
(check-sat)
(exit)
