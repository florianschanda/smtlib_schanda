...
(declare-const i Int)
(declare-const temp___638 (Array Int word32))
(declare-const temp___636 Int)
(declare-const temp___634 (Array Int word32))
(declare-const temp___630 (Array Int word32))
(declare-const k Int)
(declare-const o Int)
...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___638 b)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___636 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___634 b)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___630 b)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (forall ((k1 Int)) (=> (and (<= (to_rep b__first) k1) (<= k1 (to_rep b__last))) (and (=> (and (<= b_first k1) (<= k1 (- (- (+ b_first i2) a_first) 1))) (= (to_rep1 (select b2 k1)) (to_rep1 (select (elts a) (- (+ a_first k1) b_first))))) (=> (=> (<= b_first k1) (not (<= k1 (- (- (+ b_first i2) a_first) 1)))) (= (to_rep1 (select b2 k1)) (to_rep1 (select temp___638 k1)))))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (forall ((k1 Int)) (=> (and (<= (to_rep b__first) k1) (<= k1 (to_rep b__last))) (and (=> (and (<= b_first k1) (<= k1 (- (- (+ b_first (+ i2 1)) a_first) 1))) (= (to_rep1 (select b3 k1)) (to_rep1 (select (elts a) (- (+ a_first k1) b_first))))) (=> (=> (<= b_first k1) (not (<= k1 (- (- (+ b_first (+ i2 1)) a_first) 1)))) (= (to_rep1 (select b3 k1)) (to_rep1 (select temp___630 k1)))))))))
