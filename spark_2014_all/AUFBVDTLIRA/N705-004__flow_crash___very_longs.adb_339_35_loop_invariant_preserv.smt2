...
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o4 i3))
...
(assert (not (or (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index4)) #x00)) (exists ((j Int)) (and (and (<= (+ i3 1) j) (<= j (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00)))))))
(check-sat)
(exit)
