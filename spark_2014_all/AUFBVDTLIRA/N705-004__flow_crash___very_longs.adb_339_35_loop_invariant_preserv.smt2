...
(assert (= i2 1))
(assert (<= 1 i2))
(assert (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
...
(assert (not (= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= i3 result6))
(assert (= i4 (+ i3 1)))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i4) (<= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o9 i4))
(assert (= o10 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= o12 (ite (= o11 ((_ int2bv 8) 0)) true false)))
(assert (= result7 (ite (not (= o12 true)) true false)))
(assert (=> (= result7 true) (= result8 digit_index3)))
(assert (=> (= result7 true) (= digit_index4 i4)))
(assert (=> (not (= result7 true)) (= digit_index4 digit_index3)))
(assert (not (or (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index4)) ((_ int2bv 8) 0))) (exists ((j2 Int)) (and (and (<= (+ i4 1) j2) (<= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0))))))))
(check-sat)
(exit)
