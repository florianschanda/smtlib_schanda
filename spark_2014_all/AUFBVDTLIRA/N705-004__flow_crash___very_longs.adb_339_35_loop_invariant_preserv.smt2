...
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i1) (<= i1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o i1))
...
(assert (=> (< digit_index3 i2) (forall ((j Int)) (=> (and (<= (+ digit_index3 1) j) (<= j i2)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00)))))
...
(assert (not (= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i3) (<= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o4 i3))
(assert (= o5 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o4)))
(assert (= o6 (to_rep1 o5)))
(assert (= o7 (ite (= o6 #x00) true false)))
...
(assert (not (or (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index4)) #x00)) (exists ((j Int)) (and (and (<= (+ i3 1) j) (<= j (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00)))))))
(check-sat)
(exit)
