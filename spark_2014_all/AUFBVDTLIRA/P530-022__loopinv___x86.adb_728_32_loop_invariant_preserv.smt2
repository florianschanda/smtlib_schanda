...
(assert (= mem1 memory))
(assert (and (= (hasmem64 memory1 rdi rax) true) (= (nooverlap8equal memory1 memory rdi) true)))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (hasmem64 mem1 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) rax) true)))))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (readmem64 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) memory1) rax)))))
(assert (= (readmem64 (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8))) memory1) rax))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= (inrange64 i rdi (bvmul rcx ((_ int2bv 64) 8))) true)) (= (to_rep (select memory i)) (to_rep (select memory2 i)))))))
(assert (= rdi1 (bvadd rdi (bvmul (bvsub rcx rcx1) ((_ int2bv 64) 8)))))
(assert (= (inrange64 rdi1 rdi (bvmul rcx ((_ int2bv 64) 8))) true))
(assert (bvule rcx1 rcx))
(assert (= (readmem64 rdi1 memory2) rax))
(assert (= (readmem64 (bvadd rdi (bvmul (bvsub rcx rcx1) ((_ int2bv 64) 8))) memory2) rax))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx rcx1))) (= (readmem64 (bvadd rdi (bvmul i ((_ int2bv 64) 8))) memory2) rax))))
(assert (= rdi1 result1))
(assert (= rdi2 (bvadd rdi1 ((_ int2bv 64) 8))))
(assert (= rcx1 result2))
(assert (= rcx2 (bvsub rcx1 ((_ int2bv 64) 1))))
(assert (not (= rcx2 ((_ int2bv 64) 0))))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx rcx2))) (=> (not (= i (bvsub rcx rcx2))) (= (readmem64 (bvadd rdi (bvmul i ((_ int2bv 64) 8))) memory2) rax)))))
(assert (= mem2 result3))
(assert (= mem3 memory2))
(assert (and (= (hasmem64 memory3 rdi2 rax) true) (= (nooverlap8equal memory3 memory2 rdi2) true)))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx2))) (=> (not (= i (bvsub rcx_start rcx2))) (= (hasmem64 mem3 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) rax) true)))))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx2))) (=> (not (= i (bvsub rcx_start rcx2))) (= (readmem64 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) memory3) rax)))))
(assert (= (readmem64 (bvadd rdi_start (bvmul (bvsub rcx_start rcx2) ((_ int2bv 64) 8))) memory3) rax))
...
(assert (not (= (to_rep (select memory i)) (to_rep (select memory3 i)))))
(check-sat)
(exit)
