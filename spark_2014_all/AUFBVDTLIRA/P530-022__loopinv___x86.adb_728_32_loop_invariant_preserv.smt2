...
(assert (not (= rcx #x0000000000000000)))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx rcx))) (=> (not (= i (bvsub rcx rcx))) (= (readmem64 (bvadd rdi (bvmul i #x0000000000000008)) memory) rax)))))
...
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (hasmem64 mem1 (bvadd rdi_start (bvmul i #x0000000000000008)) rax) true)))))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (readmem64 (bvadd rdi_start (bvmul i #x0000000000000008)) memory1) rax)))))
(assert (= (readmem64 (bvadd rdi_start (bvmul (bvsub rcx_start rcx) #x0000000000000008)) memory1) rax))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= (inrange64 i rdi (bvmul rcx #x0000000000000008)) true)) (= (to_rep (select memory i)) (to_rep (select memory2 i)))))))
(assert (= rdi1 (bvadd rdi (bvmul (bvsub rcx rcx1) #x0000000000000008))))
(assert (= (inrange64 rdi1 rdi (bvmul rcx #x0000000000000008)) true))
(assert (bvule rcx1 rcx))
(assert (= (readmem64 rdi1 memory2) rax))
(assert (= (readmem64 (bvadd rdi (bvmul (bvsub rcx rcx1) #x0000000000000008)) memory2) rax))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx rcx1))) (= (readmem64 (bvadd rdi (bvmul i #x0000000000000008)) memory2) rax))))
(assert (= rdi1 result1))
(assert (= rdi2 (bvadd rdi1 #x0000000000000008)))
(assert (= rcx1 result2))
(assert (= rcx2 (bvsub rcx1 #x0000000000000001)))
(assert (not (= rcx2 #x0000000000000000)))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx rcx2))) (=> (not (= i (bvsub rcx rcx2))) (= (readmem64 (bvadd rdi (bvmul i #x0000000000000008)) memory2) rax)))))
(assert (= mem2 result3))
(assert (= mem3 memory2))
(assert (and (= (hasmem64 memory3 rdi2 rax) true) (= (nooverlap8equal memory3 memory2 rdi2) true)))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx_start rcx2))) (=> (not (= i (bvsub rcx_start rcx2))) (= (hasmem64 mem3 (bvadd rdi_start (bvmul i #x0000000000000008)) rax) true)))))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx_start rcx2))) (=> (not (= i (bvsub rcx_start rcx2))) (= (readmem64 (bvadd rdi_start (bvmul i #x0000000000000008)) memory3) rax)))))
(assert (= (readmem64 (bvadd rdi_start (bvmul (bvsub rcx_start rcx2) #x0000000000000008)) memory3) rax))
(declare-const i (_ BitVec 64))
(assert (bvule #x0000000000000000 i))
(assert (bvule i #xFFFFFFFFFFFFFFFF))
(assert (not (= (inrange64 i rdi (bvmul rcx #x0000000000000008)) true)))
