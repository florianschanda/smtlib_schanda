...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 32)))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun in_range6 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 511))))
(define-fun in_range_int4 ((x Int)) Bool (and (<= 0 x) (<= x 511)))
...
(declare-fun user_eq8 (bits_9 bits_9) Bool)
(declare-const dummy8 bits_9)
...
(declare-fun to_rep6 (bits_9) (_ BitVec 16))
(declare-fun of_rep6 ((_ BitVec 16)) bits_9)
(assert (forall ((x bits_9)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x bits_9)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 512)))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int8 ((x bits_9)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x bits_9)) (! (in_range_int4 (to_int8 x)) :pattern ((to_int8 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__chan_ctrl_type__tx_chan bits_4) (rec__dw1000__register_types__chan_ctrl_type__rx_chan bits_4) (rec__dw1000__register_types__chan_ctrl_type__dwsfd bits_1) (rec__dw1000__register_types__chan_ctrl_type__rxprf bits_2) (rec__dw1000__register_types__chan_ctrl_type__tnssfd bits_1) (rec__dw1000__register_types__chan_ctrl_type__rnssfd bits_1) (rec__dw1000__register_types__chan_ctrl_type__tx_pcode bits_5) (rec__dw1000__register_types__chan_ctrl_type__rx_pcode bits_5) (rec__dw1000__register_types__chan_ctrl_type__reserved bits_9)))))
(define-fun us_split_fields_TX_CHAN__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__chan_ctrl_type__tx_chan a))
(define-fun us_split_fields_RX_CHAN__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__chan_ctrl_type__rx_chan a))
(define-fun us_split_fields_DWSFD__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__chan_ctrl_type__dwsfd a))
(define-fun us_split_fields_RXPRF__2__projection ((a us_split_fields)) bits_2 (rec__dw1000__register_types__chan_ctrl_type__rxprf a))
(define-fun us_split_fields_TNSSFD__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__chan_ctrl_type__tnssfd a))
(define-fun us_split_fields_RNSSFD__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__chan_ctrl_type__rnssfd a))
(define-fun us_split_fields_TX_PCODE__projection ((a us_split_fields)) bits_5 (rec__dw1000__register_types__chan_ctrl_type__tx_pcode a))
(define-fun us_split_fields_RX_PCODE__projection ((a us_split_fields)) bits_5 (rec__dw1000__register_types__chan_ctrl_type__rx_pcode a))
(define-fun us_split_fields_Reserved__3__projection ((a us_split_fields)) bits_9 (rec__dw1000__register_types__chan_ctrl_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___24__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___24__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (and (and (= (to_rep4 (rec__dw1000__register_types__chan_ctrl_type__tx_chan (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__chan_ctrl_type__tx_chan (us_split_fields1 b)))) (= (to_rep4 (rec__dw1000__register_types__chan_ctrl_type__rx_chan (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__chan_ctrl_type__rx_chan (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__chan_ctrl_type__dwsfd (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__chan_ctrl_type__dwsfd (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__chan_ctrl_type__rxprf (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__chan_ctrl_type__rxprf (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__chan_ctrl_type__tnssfd (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__chan_ctrl_type__tnssfd (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__chan_ctrl_type__rnssfd (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__chan_ctrl_type__rnssfd (us_split_fields1 b))))) (= (to_rep5 (rec__dw1000__register_types__chan_ctrl_type__tx_pcode (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_types__chan_ctrl_type__tx_pcode (us_split_fields1 b))))) (= (to_rep5 (rec__dw1000__register_types__chan_ctrl_type__rx_pcode (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_types__chan_ctrl_type__rx_pcode (us_split_fields1 b))))) (= (to_rep6 (rec__dw1000__register_types__chan_ctrl_type__reserved (us_split_fields1 a))) (to_rep6 (rec__dw1000__register_types__chan_ctrl_type__reserved (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((chan_ctrl_type__ref (mk_chan_ctrl_type__ref (chan_ctrl_type__content us_rep)))))
(define-fun chan_ctrl_type__ref___projection ((a chan_ctrl_type__ref)) us_rep (chan_ctrl_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___52__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___38__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___38__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3299 us_t1) (temp___is_init_3296 Bool) (temp___skip_constant_3297 Bool) (temp___do_toplevel_3298 Bool)) Bool (=> (not (= temp___skip_constant_3297 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3299) (last3 temp___expr_3299)) (and (= (first3 temp___expr_3299) 1) (= (last3 temp___expr_3299) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___15__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___15__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_3323 us_t2) (temp___is_init_3320 Bool) (temp___skip_constant_3321 Bool) (temp___do_toplevel_3322 Bool)) Bool (=> (not (= temp___skip_constant_3321 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3323) (last5 temp___expr_3323)) (and (= (first5 temp___expr_3323) 1) (= (last5 temp___expr_3323) 4)))))
...
(declare-const temp___7807 (Array Int bits_8))
(declare-const temp___78071 t2)
(declare-const temp___7808 (Array Int bits_8))
(declare-const temp___78081 t1)
...
(assert (and (= (mk___t2 temp___7807 temp___78071) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7807 temp___78071) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___78071)) (to_rep (last4 temp___78071))) (+ (- (to_rep (last4 temp___78071)) (to_rep (first4 temp___78071))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
