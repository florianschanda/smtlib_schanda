...
(define-fun in_range6 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x01FF)))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x0200))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
...
(define-fun dynamic_invariant ((temp___expr_3634 us_t1) (temp___is_init_3630 Bool) (temp___skip_constant_3631 Bool) (temp___do_toplevel_3632 Bool) (temp___do_typ_inv_3633 Bool)) Bool (=> (not (= temp___skip_constant_3631 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3634) (last3 temp___expr_3634)) (and (= (first3 temp___expr_3634) 1) (= (last3 temp___expr_3634) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3660 us_t2) (temp___is_init_3656 Bool) (temp___skip_constant_3657 Bool) (temp___do_toplevel_3658 Bool) (temp___do_typ_inv_3659 Bool)) Bool (=> (not (= temp___skip_constant_3657 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3660) (last5 temp___expr_3660)) (and (= (first5 temp___expr_3660) 1) (= (last5 temp___expr_3660) 4)))))
...
(declare-const temp___8579 (Array Int bits_8))
(declare-const temp___85791 t2)
(define-fun temp___85792 () us_t2 (mk___t2 temp___8579 temp___85791))
...
(assert (and (= temp___85792 (register_to_bytes reg)) (dynamic_invariant1 temp___85792 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85791)) (to_rep (last4 temp___85791))) (+ (- (to_rep (last4 temp___85791)) (to_rep (first4 temp___85791))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
