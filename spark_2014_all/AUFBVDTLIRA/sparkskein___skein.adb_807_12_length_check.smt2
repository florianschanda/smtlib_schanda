...
(assert (not (= (ite (<= (bv2nat (to_rep (first temp___14081))) (bv2nat (to_rep (last temp___14081)))) (+ (- (bv2nat (to_rep (last temp___14081))) (bv2nat (to_rep (first temp___14081)))) 1) 0) (ite (<= (bv2nat (to_rep hash__first)) (bv2nat (to_rep hash__last))) (+ (- (bv2nat (to_rep hash__last)) (bv2nat (to_rep hash__first))) 1) 0))))
(check-sat)
(exit)
