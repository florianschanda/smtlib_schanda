...
(assert (not (= (ite (<= (bv2nat (to_rep7 (first temp___15601))) (bv2nat (to_rep7 (last temp___15601)))) (+ (- (bv2nat (to_rep7 (last temp___15601))) (bv2nat (to_rep7 (first temp___15601)))) 1) 0) (ite (<= (bv2nat (to_rep7 hash__first)) (bv2nat (to_rep7 hash__last))) (+ (- (bv2nat (to_rep7 hash__last)) (bv2nat (to_rep7 hash__first))) 1) 0))))
(check-sat)
(exit)
