...
(define-fun dynamic_invariant ((temp___expr_357 (_ BitVec 8)) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool) (temp___do_typ_inv_356 Bool)) Bool true)
...
(declare-fun temp_____aggregate_def_3691 ((_ BitVec 8) Int Int) us_t1)
...
(assert (forall ((temp___3693 (_ BitVec 8))) (forall ((temp___3694 Int) (temp___3695 Int)) (let ((temp___3692 (temp_____aggregate_def_3691 temp___3693 temp___3694 temp___3695))) (=> (dynamic_invariant temp___3693 true true true true) (and (=> (dynamic_property 0 2147483647 temp___3694 temp___3695) (and (= (first3 temp___3692) temp___3694) (= (last3 temp___3692) temp___3695))) (forall ((temp___3696 Int)) (= (to_rep3 (select (to_array1 temp___3692) temp___3696)) temp___3693))))))))
(define-fun dynamic_invariant3 ((temp___expr_308 (_ BitVec 8)) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (bvule #x00 #x01)) (in_range3 temp___expr_308)))
...
(define-fun dynamic_invariant5 ((temp___expr_756 us_t) (temp___is_init_752 Bool) (temp___skip_constant_753 Bool) (temp___do_toplevel_754 Bool) (temp___do_typ_inv_755 Bool)) Bool (=> (not (= temp___skip_constant_753 true)) (dynamic_property 0 2147483647 (first1 temp___expr_756) (last1 temp___expr_756))))
(declare-const o Int)
