...
(define-fun dynamic_invariant1 ((temp___expr_658 us_t) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool)) Bool (=> (not (= temp___skip_constant_656 true)) (dynamic_property 0 2147483647 (first1 temp___expr_658) (last1 temp___expr_658))))
...
(define-fun dynamic_invariant3 ((temp___expr_316 (_ BitVec 8)) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_358 (_ BitVec 16)) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 32767))) (in_range2 temp___expr_358)))
(declare-const o Int)
