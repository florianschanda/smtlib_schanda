...
(define-fun dynamic_invariant4 ((temp___expr_406 (_ BitVec 16)) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (or (= temp___is_init_402 true) (bvule #x0000 #x7FFF)) (in_range2 temp___expr_406)))
(assert (dynamic_invariant1 data true false true true))
(assert (in_range1 offset))
(assert (and (< 0 (length data)) (and (<= (length data) 1024) (and (< offset 1024) (<= (+ (length data) offset) 1024)))))
(assert (not (in_range_int offset)))
(check-sat)
(exit)
