...
(assert (and (bvule (to_rep2 (first (rt block))) (bvadd src_index1 #x0000000000000001)) (bvule (bvadd src_index1 #x0000000000000001) (to_rep2 (last (rt block))))))
...
(assert (not (bvule (to_rep2 (first (rt block))) src_index1)))
(check-sat)
(exit)
