...
(assert (and (bvule (to_rep2 (first (rt block))) (bvadd src_index3 ((_ int2bv 64) 1))) (bvule (bvadd src_index3 ((_ int2bv 64) 1)) (to_rep2 (last (rt block))))))
(assert (= o50 (bvadd src_index3 ((_ int2bv 64) 1))))
(assert (= o51 (select (elts block) o50)))
(assert (= o52 (to_rep o51)))
(assert (= o53 ((_ zero_extend 56) o52)))
(assert (= o54 (bvshl o53 ((_ int2bv 64) 8))))
(assert (not (bvule (to_rep2 (first (rt block))) src_index3)))
(check-sat)
(exit)
