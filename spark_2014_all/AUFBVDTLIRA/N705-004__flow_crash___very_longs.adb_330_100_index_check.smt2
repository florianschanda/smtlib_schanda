...
(assert (and (= o13 (+ very_longs__divide__get_msd__result4 1)) (in_range1 (+ very_longs__divide__get_msd__result4 1))))
(assert (= o14 (ite (<= o13 i1) true false)))
(assert (= result10 (ite (= o14 true) (ite (<= i1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))) true false) false)))
