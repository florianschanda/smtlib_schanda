...
(assert (=> (< digit_count3 index3) (forall ((j2 Int)) (=> (and (<= (+ digit_count3 1) j2) (<= j2 index3)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0))))))
