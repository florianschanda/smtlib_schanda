...
(define-fun dynamic_invariant ((temp___expr_2018 us_t1) (temp___is_init_2015 Bool) (temp___skip_constant_2016 Bool) (temp___do_toplevel_2017 Bool)) Bool (=> (not (= temp___skip_constant_2016 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2018) (last3 temp___expr_2018)) (and (= (first3 temp___expr_2018) 1) (= (last3 temp___expr_2018) 4)))))
