...
(define-fun r__split_fields18 () us_split_fields (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))
(define-fun r__split_fields19 () us_split_fields (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))
(define-fun r__split_fields20 () us_split_fields (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8))
(define-fun r__split_fields21 () us_split_fields (mk___split_fields r__split_fields3 r__split_fields4 r__split_fields5))
(define-fun r__split_fields22 () us_split_fields (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))
(assert (in_range x))
(assert (in_range y))
(assert (in_range z))
(assert (=> (<= (- 2147483648) 2147483647) (in_range h)))
(assert (= (let ((temp___250 (to_model (mk___rep r__split_fields22)))) (bool_eq (elts temp___250) (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250))) (temp_____aggregate_def_246 0) #x0001 #x0000)) true))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields22)) x))) (let ((temp___257 (to_model (mk___rep r__split_fields21)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields21)) y))) (let ((temp___257 (to_model (mk___rep r__split_fields20)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (and (and (= (let ((temp___262 (func_pop (to_model (mk___rep r__split_fields20))))) (let ((temp___261 (to_model (mk___rep r__split_fields19)))) (bool_eq (elts temp___261) (to_rep (first (rt temp___261))) (to_rep (last (rt temp___261))) (elts temp___262) (to_rep (first (rt temp___262))) (to_rep (last (rt temp___262)))))) true) (= h1 (func_head (to_model (mk___rep r__split_fields20))))) (in_range h1)))
(assert (= h1 x))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields19)) z))) (let ((temp___257 (to_model (mk___rep r__split_fields18)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (and (and (= (let ((temp___262 (func_pop (to_model (mk___rep r__split_fields18))))) (let ((temp___261 (to_model (mk___rep (mk___split_fields r__split_fields15 r__split_fields16 r__split_fields17))))) (bool_eq (elts temp___261) (to_rep (first (rt temp___261))) (to_rep (last (rt temp___261))) (elts temp___262) (to_rep (first (rt temp___262))) (to_rep (last (rt temp___262)))))) true) (= h2 (func_head (to_model (mk___rep r__split_fields18))))) (in_range h2)))
(assert (not (= h2 y)))
(check-sat)
(exit)
