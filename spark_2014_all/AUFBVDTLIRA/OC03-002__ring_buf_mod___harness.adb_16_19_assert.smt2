...
(assert (= (let ((temp___231 (func_push (to_model (mk___rep (mk___split_fields r__split_fields3 r__split_fields4 r__split_fields5))) y))) (let ((temp___230 (to_model (mk___rep (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8))))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (and (and (= (let ((temp___235 (func_pop (to_model (mk___rep (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8)))))) (let ((temp___234 (to_model (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))))) (bool_eq (elts temp___234) (to_rep (first (rt temp___234))) (to_rep (last (rt temp___234))) (elts temp___235) (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true) (= h1 (func_head (to_model (mk___rep (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8)))))) (in_range h1)))
(assert (= h1 x))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))) z))) (let ((temp___230 (to_model (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (and (and (= (let ((temp___235 (func_pop (to_model (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14)))))) (let ((temp___234 (to_model (mk___rep (mk___split_fields r__split_fields15 r__split_fields16 r__split_fields17))))) (bool_eq (elts temp___234) (to_rep (first (rt temp___234))) (to_rep (last (rt temp___234))) (elts temp___235) (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true) (= h2 (func_head (to_model (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14)))))) (in_range h2)))
(assert (not (= h2 y)))
(check-sat)
(exit)
