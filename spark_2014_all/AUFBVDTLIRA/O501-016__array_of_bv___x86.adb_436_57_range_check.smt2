...
(assert (= tmp1 val__))
(assert true)
(assert (and (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ ((_ int2bv 16) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
