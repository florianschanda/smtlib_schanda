...
(define-fun dynamic_invariant ((temp___expr_6550 us_t1) (temp___is_init_6547 Bool) (temp___skip_constant_6548 Bool) (temp___do_toplevel_6549 Bool)) Bool (=> (not (= temp___skip_constant_6548 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6550) (last3 temp___expr_6550)) (and (= (first3 temp___expr_6550) 1) (= (last3 temp___expr_6550) 4)))))
