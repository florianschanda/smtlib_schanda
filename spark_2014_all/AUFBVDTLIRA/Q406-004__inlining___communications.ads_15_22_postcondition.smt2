...
(assert (in_range n))
(assert (=> (< (to_rep1 self__3) 16) (= (to_rep o) n)))
(assert (=> (< (to_rep1 self__3) 16) (= o1 (store self__ (to_rep2 self__1) o))))
(assert (=> (< (to_rep1 self__3) 16) (= o1 o2)))
(assert (=> (< (to_rep1 self__3) 16) (= self__1 o3)))
(assert (=> (< (to_rep1 self__3) 16) (= self__2 o4)))
(assert (=> (< (to_rep1 self__3) 16) (= self__3 o5)))
(assert (=> (< (to_rep1 self__3) 16) (= o6 o2)))
(assert (=> (< (to_rep1 self__3) 16) (= o7 o3)))
(assert (=> (< (to_rep1 self__3) 16) (= o8 o4)))
(assert (=> (< (to_rep1 self__3) 16) (= o9 o5)))
(assert (=> (< (to_rep1 self__3) 16) (= (mk_mailboxT__ref (mk___rep (mk___split_fields result result1 result2 result3))) (mk_mailboxT__ref (mk___rep (mk___split_fields self__ self__1 self__2 self__3))))))
(assert (=> (< (to_rep1 self__3) 16) (= (mk___rep (mk___split_fields self__8 self__9 self__10 self__11)) (mk___rep (mk___split_fields o6 o7 o8 o9)))))
(assert (=> (< (to_rep1 self__3) 16) (= (to_rep2 o10) (bvurem (bvadd (to_rep2 self__9) #x01) #x10))))
(assert (=> (< (to_rep1 self__3) 16) (= self__8 o11)))
(assert (=> (< (to_rep1 self__3) 16) (= o10 o12)))
(assert (=> (< (to_rep1 self__3) 16) (= self__10 o13)))
(assert (=> (< (to_rep1 self__3) 16) (= self__11 o14)))
(assert (=> (< (to_rep1 self__3) 16) (= o15 o11)))
(assert (=> (< (to_rep1 self__3) 16) (= o16 o12)))
(assert (=> (< (to_rep1 self__3) 16) (= o17 o13)))
(assert (=> (< (to_rep1 self__3) 16) (= o18 o14)))
(assert (=> (< (to_rep1 self__3) 16) (= result4 self__8)))
(assert (=> (< (to_rep1 self__3) 16) (= result5 self__9)))
(assert (=> (< (to_rep1 self__3) 16) (= result6 self__10)))
(assert (=> (< (to_rep1 self__3) 16) (= result7 self__11)))
(assert (=> (< (to_rep1 self__3) 16) (= self__12 (mk___rep (mk___split_fields o15 o16 o17 o18)))))
(assert (=> (< (to_rep1 self__3) 16) (and (= o19 (+ (to_rep1 (rec__communications__mailboxT__count (us_split_fields1 self__12))) 1)) (in_range2 (+ (to_rep1 (rec__communications__mailboxT__count (us_split_fields1 self__12))) 1)))))
(assert (=> (< (to_rep1 self__3) 16) (= (to_rep1 o20) o19)))
(assert (=> (< (to_rep1 self__3) 16) (= (rec__communications__mailboxT__messages (us_split_fields1 self__12)) o21)))
(assert (=> (< (to_rep1 self__3) 16) (= (rec__communications__mailboxT__next_in (us_split_fields1 self__12)) o22)))
(assert (=> (< (to_rep1 self__3) 16) (= (rec__communications__mailboxT__next_out (us_split_fields1 self__12)) o23)))
(assert (=> (< (to_rep1 self__3) 16) (= o20 o24)))
(assert (=> (< (to_rep1 self__3) 16) (= o25 o21)))
(assert (=> (< (to_rep1 self__3) 16) (= o26 o22)))
(assert (=> (< (to_rep1 self__3) 16) (= o27 o23)))
(assert (=> (< (to_rep1 self__3) 16) (= o28 o24)))
(assert (=> (< (to_rep1 self__3) 16) (= result8 (mk_mailboxT__ref self__12))))
(assert (=> (< (to_rep1 self__3) 16) (= self__13 (mk___rep (mk___split_fields o25 o26 o27 o28)))))
(assert (=> (not (< (to_rep1 self__3) 16)) (= self__13 (mk___rep (mk___split_fields self__ self__1 self__2 self__3)))))
(assert (=> (not (< (to_rep1 self__3) 16)) (= self__13 (mk___rep (mk___split_fields self__4 self__5 self__6 self__7)))))
(assert (= self__14 (mk_mailboxT__ref self__13)))
(assert (= self__15 self__13))
(assert (not (< 0 (item_count (mailboxT__content self__14)))))
(check-sat)
(exit)
