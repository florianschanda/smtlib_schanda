...
(assert (= o24 (ite (<= o23 (to_rep (last (rt c)))) true false)))
(assert (and (= o18 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o19 (+ c_first o18)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (= o25 (ite (<= (to_rep (first (rt c))) o20) true false)))
