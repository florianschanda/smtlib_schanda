...
(assert (forall ((x (_ BitVec 64))) (! (let ((y (bvurem x ((_ int2bv 64) 1099511627776)))) (=> (in_range2 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_2959 us_t1) (temp___is_init_2956 Bool) (temp___skip_constant_2957 Bool) (temp___do_toplevel_2958 Bool)) Bool (=> (not (= temp___skip_constant_2957 true)) (and (dynamic_property2 1 14 (first3 temp___expr_2959) (last3 temp___expr_2959)) (and (= (first3 temp___expr_2959) 1) (= (last3 temp___expr_2959) 14)))))
