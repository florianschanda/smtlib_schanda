...
(assert (= (ite (<= (to_rep (first2 temp___86131)) (to_rep (last2 temp___86131))) (+ (- (to_rep (last2 temp___86131)) (to_rep (first2 temp___86131))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8613 temp___86131)))
(assert (= o2 o))
