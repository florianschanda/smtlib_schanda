...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i10 Int)) (=> (and (<= begidx2 i10) (<= i10 endidx1)) (and (<= 48 (to_rep (select zonefileline i10))) (<= (to_rep (select zonefileline i10)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 tokentype1))))
...
(assert (= i2 r109b))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= temp___1830 token1)))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= temp___1832 i2)))
...
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (and (= temp___1829 o2) (in_range1 o2))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (and (<= 1 temp___1829) (<= temp___1829 256))))
(assert (=> (and (<= r109b i2) (<= i2 r110b)) (= o4 temp___1829)))
...
(assert (and (and (=> (<= 1 r112b) (dynamic_property1 1 r112b i9)) (forall ((temp___1837 Int)) (=> (and (<= 1 temp___1837) (<= temp___1837 128)) (=> (<= i9 temp___1837) (= (select newowner2 temp___1837) (select newowner1 temp___1837)))))) (and (<= 1 i9) (<= i9 r112b))))
