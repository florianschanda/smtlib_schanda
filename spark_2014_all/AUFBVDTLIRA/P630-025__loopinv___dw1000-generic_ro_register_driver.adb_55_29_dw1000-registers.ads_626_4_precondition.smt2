...
(define-fun dynamic_invariant ((temp___expr_7121 us_t1) (temp___is_init_7118 Bool) (temp___skip_constant_7119 Bool) (temp___do_toplevel_7120 Bool)) Bool (=> (not (= temp___skip_constant_7119 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7121) (last3 temp___expr_7121)) (and (= (first3 temp___expr_7121) 1) (= (last3 temp___expr_7121) 2)))))
