...
(assert (= test__bit_set__result4 true))
(assert (not (not (= (bvand (to_rep (select (elts a) (+ a_first (bv2nat (bvudiv i #x0000000000000020))))) (let ((temp___264 (bv2nat (bvurem i #x0000000000000020)))) (ite (< temp___264 4294967296) (bvshl #x00000001 ((_ int2bv 32) temp___264)) #x00000000))) #x00000000))))
(check-sat)
(exit)
