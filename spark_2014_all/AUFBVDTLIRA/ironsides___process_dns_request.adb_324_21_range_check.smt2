...
(assert (= o1 (from_query_type (to_rep2 (rec__rr_type__rrsig_record_type__rrsigrecordtype__typecovered (us_split_fields3 rrsig_record))))))
(assert (= o2 (bvurem o1 #x00010000)))
(assert (= o3 o2))
(assert (= o4 ((_ extract 15 0) o3)))
(assert (not (in_range3 (+ start_byte 6))))
(check-sat)
(exit)
