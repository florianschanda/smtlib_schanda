...
(assert (and (= o16 (convertdomainnametowire (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername (us_split_fields3 rrsig_record)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 128)) (and (<= 0 (to_rep (select o16 i2))) (<= (to_rep (select o16 i2)) 255))))))
...
(assert (<= 1 i1))
(assert (<= i1 r21b))
(assert (not (<= start_byte (- 8156 current_name_length1))))
(check-sat)
(exit)
