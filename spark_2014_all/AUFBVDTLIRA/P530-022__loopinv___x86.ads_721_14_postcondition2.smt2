...
(assert (forall ((var (_ BitVec 64)) (bottom (_ BitVec 64)) (range_size (_ BitVec 64))) (! (=> (and (and (dynamic_invariant var true true true true) (dynamic_invariant bottom true true true true)) (dynamic_invariant range_size true true true true)) (= (= (inrange64 var bottom range_size) true) (and (not (= range_size #x0000000000000000)) (ite (bvule bottom (bvsub #xFFFFFFFFFFFFFFFF (bvsub range_size #x0000000000000001))) (and (bvule bottom var) (bvule var (bvadd bottom (bvsub range_size #x0000000000000001)))) (or (and (bvule bottom var) (bvule var #xFFFFFFFFFFFFFFFF)) (bvule var (bvsub (bvsub range_size (bvsub #xFFFFFFFFFFFFFFFF bottom)) #x0000000000000002))))))) :pattern ((inrange64 var bottom range_size)))))
(assert (forall ((var (_ BitVec 64)) (bottom (_ BitVec 64)) (range_size (_ BitVec 64))) (! (= (= (inrange64 var bottom range_size) true) (and (not (= range_size #x0000000000000000)) (ite (bvule bottom (bvsub #xFFFFFFFFFFFFFFFF (bvsub range_size #x0000000000000001))) (and (bvule bottom var) (bvule var (bvadd bottom (bvsub range_size #x0000000000000001)))) (or (bvule bottom var) (bvule var (bvsub (bvsub range_size (bvsub #xFFFFFFFFFFFFFFFF bottom)) #x0000000000000002)))))) :pattern ((inrange64 var bottom range_size)))))
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr true true true true) (let ((result (readmem64 addr x86__memory))) (and (= (hasmem64 x86__memory addr result) true) (dynamic_invariant result true false true true)))) :pattern ((readmem64 addr x86__memory))))))
...
(declare-fun all_equal_rax ((_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) unsigned8) (_ BitVec 64)) Bool)
(declare-fun all_equal_rax__function_guard (Bool (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) unsigned8) (_ BitVec 64)) Bool)
(assert true)
(assert (forall ((start (_ BitVec 64)) (last (_ BitVec 64)) (x86__rax (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (= (= (all_equal_rax start last x86__memory x86__rax) true) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i last)) (= (readmem64 (bvadd start (bvmul i #x0000000000000008)) x86__memory) x86__rax)))) :pattern ((all_equal_rax start last x86__memory x86__rax))))))
...
(declare-const temp___378 (_ BitVec 64))
(declare-const temp___387 (_ BitVec 64))
(declare-const temp___382 (Array (_ BitVec 64) unsigned8))
(declare-const temp___376 (_ BitVec 64))
(declare-const temp___386 (_ BitVec 64))
(declare-const temp___381 (Array (_ BitVec 64) unsigned8))
...
(declare-const temp___390 (_ BitVec 64))
(declare-const temp___394 (_ BitVec 64))
(declare-const temp___380 (_ BitVec 64))
...
(define-fun mem10 () map__ref (mk_map__ref mem6))
(define-fun memory10 () map__ref (mk_map__ref memory6))
(define-fun rdi10 () t__ref1 (mk_t__ref1 rdi6))
(define-fun rcx10 () t__ref1 (mk_t__ref1 rcx6))
(define-fun mem11 () map__ref (mk_map__ref mem))
(assert (bvult rcx #x1FFFFFFFFFFFFFFF))
(assert (= rcx rcx_start))
(assert (= rdi rdi_start))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___378 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___387 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___382 mem)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___376 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___386 rdi)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___381 memory)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___392 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___391 rdi)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___383 memory)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___385 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___384 rdi)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___390 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___394 rdi)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___380 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___379 rdi)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___393 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___389 rcx)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___388 rdi)))
(assert (=> (not (= rcx #x0000000000000000)) (= temp___377 rdi)))
(assert (=> (not (= rcx #x0000000000000000)) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub temp___376 rcx))) (=> (not (= i (bvsub temp___378 rcx))) (= (readmem64 (bvadd temp___377 (bvmul i #x0000000000000008)) memory) rax))))))
(assert (=> (not (= rcx #x0000000000000000)) (= (mk_map__ref result) mem11)))
(assert (=> (not (= rcx #x0000000000000000)) (= mem2 memory)))
(assert (=> (not (= rcx #x0000000000000000)) (and (= (hasmem64 memory2 rdi rax) true) (= (nooverlap8equal memory2 memory rdi) true))))
(assert (=> (not (= rcx #x0000000000000000)) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (hasmem64 mem2 (bvadd rdi_start (bvmul i #x0000000000000008)) rax) true))))))
(assert (=> (not (= rcx #x0000000000000000)) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (readmem64 (bvadd rdi_start (bvmul i #x0000000000000008)) memory2) rax))))))
(assert (=> (not (= rcx #x0000000000000000)) (= (readmem64 (bvadd rdi_start (bvmul (bvsub rcx_start rcx) #x0000000000000008)) memory2) rax)))
(assert (=> (not (= rcx #x0000000000000000)) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= (inrange64 i temp___384 (bvmul temp___385 #x0000000000000008)) true)) (= (to_rep (select temp___383 i)) (to_rep (select memory3 i))))))))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi2 (bvadd temp___386 (bvmul (bvsub temp___387 rcx2) #x0000000000000008)))))
(assert (=> (not (= rcx #x0000000000000000)) (= (inrange64 rdi2 temp___388 (bvmul temp___389 #x0000000000000008)) true)))
(assert (=> (not (= rcx #x0000000000000000)) (bvule rcx2 temp___390)))
(assert (=> (not (= rcx #x0000000000000000)) (= (readmem64 rdi2 memory3) rax)))
(assert (=> (not (= rcx #x0000000000000000)) (= (readmem64 (bvadd temp___391 (bvmul (bvsub temp___392 rcx2) #x0000000000000008)) memory3) rax)))
(assert (=> (not (= rcx #x0000000000000000)) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i (bvsub temp___393 rcx2))) (= (readmem64 (bvadd temp___394 (bvmul i #x0000000000000008)) memory3) rax)))))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi2 result1)))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi3 (bvadd rdi2 #x0000000000000008))))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx2 result2)))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx3 (bvsub rcx2 #x0000000000000001))))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx3 #x0000000000000000)))
(assert (=> (not (= rcx #x0000000000000000)) (= mem3 mem4)))
(assert (=> (not (= rcx #x0000000000000000)) (= memory3 memory4)))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi3 rdi4)))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx3 rcx4)))
(assert (=> (not (= rcx #x0000000000000000)) (= mem5 mem3)))
(assert (=> (not (= rcx #x0000000000000000)) (= memory5 memory3)))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi5 rdi3)))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx5 rcx3)))
(assert (=> (not (= rcx #x0000000000000000)) (= mem10 (mk_map__ref mem4))))
(assert (=> (not (= rcx #x0000000000000000)) (= memory10 (mk_map__ref memory4))))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi10 (mk_t__ref1 rdi4))))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx10 (mk_t__ref1 rcx4))))
(assert (=> (not (= rcx #x0000000000000000)) (= mem7 mem5)))
(assert (=> (not (= rcx #x0000000000000000)) (= memory7 memory5)))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi7 rdi5)))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx7 rcx5)))
(assert (=> (not (not (= rcx #x0000000000000000))) (= mem10 mem11)))
(assert (=> (not (not (= rcx #x0000000000000000))) (= memory10 (mk_map__ref memory))))
(assert (=> (not (not (= rcx #x0000000000000000))) (= rdi10 (mk_t__ref1 rdi))))
(assert (=> (not (not (= rcx #x0000000000000000))) (= rcx10 (mk_t__ref1 rcx))))
(assert (=> (not (not (= rcx #x0000000000000000))) (= mem7 mem1)))
(assert (=> (not (not (= rcx #x0000000000000000))) (= memory7 memory1)))
(assert (=> (not (not (= rcx #x0000000000000000))) (= rdi7 rdi1)))
(assert (=> (not (not (= rcx #x0000000000000000))) (= rcx7 rcx1)))
(assert (=> (not (= rcx_start #x0000000000000000)) (= (all_equal_rax rdi_start (bvsub rcx_start #x0000000000000001) memory6 rax) true)))
(assert (= mem8 mem10))
(assert (= memory8 memory10))
(assert (= rdi8 rdi10))
(assert (= rcx8 rcx10))
(assert (= mem9 mem7))
...
(assert (= rdi9 rdi7))
(assert (= rcx9 rcx7))
(assert (not (= (t__content1 rcx8) #x0000000000000000)))
(check-sat)
(exit)
