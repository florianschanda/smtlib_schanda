...
(assert (and (< 0 (length a)) (and (=> (= (has_key (model__ m) e) true) (and (<= (to_rep3 (first (rt a))) (get (model__ m) e)) (<= (get (model__ m) e) (to_rep3 (last (rt a)))))) (and (forall ((i1 Int)) (=> (and (<= (to_rep3 (first (rt a))) i1) (<= i1 (- (get (model__ m) e) 1))) (not (= (to_rep (select (elts a) i1)) e)))) (= (has_key (model__ m) e) true)))))
...
(assert (and (= o (get (model__ m) e)) (and (in_range3 o) (= o (get (model__ m) e)))))
(assert (= result (ite (<= o last2) true false)))
(assert (=> (= result true) (and (= o1 (get (model__ m) e)) (and (in_range3 o1) (= o1 (get (model__ m) e))))))
...
(assert (<= i last2))
(assert (not (<= i (to_rep3 (last (rt a))))))
(check-sat)
(exit)
