...
(define-fun dynamic_invariant1 ((temp___expr_320 Int) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool)) Bool (=> (or (= temp___is_init_317 true) (<= 1 100)) (in_range2 temp___expr_320)))
...
(define-fun dynamic_invariant2 ((temp___expr_326 us_t) (temp___is_init_323 Bool) (temp___skip_constant_324 Bool) (temp___do_toplevel_325 Bool)) Bool (=> (not (= temp___skip_constant_324 true)) (dynamic_property 1 100 (first1 temp___expr_326) (last1 temp___expr_326))))
...
(define-fun dynamic_invariant3 ((temp___expr_331 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range5 temp___expr_331)))
...
(define-fun dynamic_invariant4 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1 100)) (in_range6 temp___expr_337)))
...
(define-fun dynamic_invariant7 ((temp___expr_168 (_ BitVec 32)) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool true)
(define-fun dynamic_invariant8 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 2147483647)) (in_range4 temp___expr_174)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep3 (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant8 result true false true))) :pattern ((length1 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant8 (length2 attr__tag container) true false true) :pattern ((length2 attr__tag container))))))
...
(define-fun default_initial_assumption1 ((temp___expr_379 us_rep1) (temp___skip_top_level_380 Bool)) Bool (=> (not (= temp___skip_top_level_380 true)) (and (= (is_empty2 temp___expr_379) true) (= (length3 temp___expr_379) 0))))
(assert true)
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant9 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range8 k) (= (has_key container k) true)) (= (equivalent_keys k key) true))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant10 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 100)) (in_range9 temp___expr_372)))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant9 key true true true) (= (has_key container key) true)) (let ((result (get container key))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range8 k) (= (has_key container k) true)) (= (= (equivalent_keys k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant10 result true false true)))) :pattern ((get container key))))))
(assert (forall ((container us_rep1)) (! (dynamic_invariant8 (length3 container) true false true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant9 key true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant8 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant8 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant10 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (and (< 0 (length a)) (and (=> (= (has_key (model__ m) e) true) (and (<= (to_rep1 (first (rt a))) (get (model__ m) e)) (<= (get (model__ m) e) (to_rep1 (last (rt a)))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (- (get (model__ m) e) 1))) (not (= (to_rep (select (elts a) i2)) e)))) (= (has_key (model__ m) e) true)))))
...
(assert (and (= o8 (get (model__ m) e)) (and (in_range6 o8) (= o8 (get (model__ m) e)))))
(assert (= result3 (ite (<= o8 last2) true false)))
(assert (=> (= result3 true) (and (= o9 (get (model__ m) e)) (and (in_range6 o9) (= o9 (get (model__ m) e))))))
(assert (=> (not (= result3 true)) (= o9 0)))
(assert (= (mk_int__ref result4) (mk_int__ref find_map__find_upto__find_map_bad__result)))
(assert (= find_map__find_upto__find_map_bad__result1 o9))
...
(assert (<= i1 last2))
(assert (not (<= (to_rep1 (first (rt a))) i1)))
(check-sat)
(exit)
