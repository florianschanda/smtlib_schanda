...
(define-fun dynamic_invariant ((temp___expr_1911 us_t1) (temp___is_init_1908 Bool) (temp___skip_constant_1909 Bool) (temp___do_toplevel_1910 Bool)) Bool (=> (not (= temp___skip_constant_1909 true)) (and (dynamic_property2 1 4 (first3 temp___expr_1911) (last3 temp___expr_1911)) (and (= (first3 temp___expr_1911) 1) (= (last3 temp___expr_1911) 4)))))
