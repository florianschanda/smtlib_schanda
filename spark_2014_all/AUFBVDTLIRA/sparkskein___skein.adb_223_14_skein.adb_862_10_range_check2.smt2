...
(assert (= n1 (bvsub byte_count1 (bvmul blocks_done2 #x0000000000000040))))
(assert (=> (bvuge n1 #x0000000000000040) (= result24 (mk_t__ref3 n1))))
(assert (=> (bvuge n1 #x0000000000000040) (= n2 #x0000000000000040)))
(assert (=> (bvuge n1 #x0000000000000040) (= n3 (mk_t__ref3 n2))))
(assert (=> (bvuge n1 #x0000000000000040) (= n4 n2)))
(assert (=> (not (bvuge n1 #x0000000000000040)) (= n3 (mk_t__ref3 n1))))
(assert (=> (not (bvuge n1 #x0000000000000040)) (= n4 n1)))
(assert (= (bvmul blocks_done2 #x0000000000000040) c264b))
(assert (= (rec__skein__skein_512_context__x local_ctx__split_fields35) c266b))
(assert (= (t__content3 n3) c267b))
(assert (bvuge c267b #x0000000000000001))
(assert (bvule #x0000000000000000 (bvsub c267b #x0000000000000001)))
