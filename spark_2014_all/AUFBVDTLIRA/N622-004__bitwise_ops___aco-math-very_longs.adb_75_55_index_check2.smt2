...
(define-fun dynamic_invariant2 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range1 temp___expr_302)))
...
(declare-fun temp_____aggregate_def_1491 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1493 (_ BitVec 8))) (forall ((temp___1494 Int) (temp___1495 Int)) (let ((temp___1492 (temp_____aggregate_def_1491 temp___1493 temp___1494 temp___1495))) (=> (dynamic_invariant temp___1493 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1494 temp___1495) (and (= (first5 temp___1492) temp___1494) (= (last5 temp___1492) temp___1495))) (forall ((temp___1496 Int)) (= (to_rep1 (select (to_array2 temp___1492) temp___1496)) temp___1493))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_539 us_t1) (temp___is_init_535 Bool) (temp___skip_constant_536 Bool) (temp___do_toplevel_537 Bool) (temp___do_typ_inv_538 Bool)) Bool (=> (not (= temp___skip_constant_536 true)) (and (dynamic_property3 1 r19b (first3 temp___expr_539) (last3 temp___expr_539)) (and (= (first3 temp___expr_539) 1) (= (last3 temp___expr_539) r19b)))))
...
(declare-const i Int)
(declare-const temp___1498 (Array Int octet))
(declare-const temp___14981 t2)
(declare-const temp___1499 (Array Int octet))
(declare-const temp___14991 t1)
(declare-const temp___1501 (Array Int octet))
(declare-const temp___15011 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1503 digit_index_type)
(declare-const temp___15031 (Array Int octet))
(declare-const temp___15032 t)
...
(assert (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r19b))
(assert (in_range1 r19b))
(assert (= (to_rep2 (first4 (rt2 (temp_____aggregate_def_1491 #x00 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp_____aggregate_def_1491 #x00 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1498 temp___14981) (temp_____aggregate_def_1491 #x00 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___14981)) (to_rep2 (last4 temp___14981))) (+ (- (to_rep2 (last4 temp___14981)) (to_rep2 (first4 temp___14981))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1498 temp___1499))
(assert (= (mk1 (to_rep2 (first4 temp___14981)) (to_rep2 (last4 temp___14981))) temp___14991))
(assert (= (ite (<= (to_rep2 (first2 temp___14991)) (to_rep2 (last2 temp___14991))) (+ (- (to_rep2 (last2 temp___14991)) (to_rep2 (first2 temp___14991))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1501 temp___15011) (mk___t1 temp___1499 temp___14991)))
(assert (= temp___1501 o))
(assert (= (mk (to_rep2 (first2 temp___15011)) (to_rep2 (last2 temp___15011))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1503)))
(assert (= temp___15031 o2))
(assert (= temp___15032 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___15031 temp___15032))))
(assert (= result____split_discrs (mk___split_discrs temp___1503)))
...
(assert (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1516 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1516) (<= temp___1516 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1516) (or (< temp___1516 1) (<= i2 temp___1516))) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1516) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1516)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
