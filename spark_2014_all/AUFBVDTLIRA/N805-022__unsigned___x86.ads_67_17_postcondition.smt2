...
(define-fun dynamic_invariant ((temp___expr_143 (_ BitVec 32)) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool true)
...
(define-fun bool_eq ((a (Array Int unsigned_8)) (a__first Int) (a__last Int) (b (Array Int unsigned_8)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep (select a temp___idx_133)) (to_rep (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
...
(assert (forall ((a (Array Int unsigned_8)) (b (Array Int unsigned_8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int unsigned_8)) (b (Array Int unsigned_8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep (select a (+ j 1))) (to_rep (select b (+ i 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(declare-const o1 (Array Int unsigned_8))
(declare-const o2 unsigned_8)
(declare-const o3 (Array Int unsigned_8))
(declare-const o4 unsigned_8)
(declare-const o5 (Array Int unsigned_8))
(declare-const o6 unsigned_8)
(declare-const o7 (Array Int unsigned_8))
(declare-const result (Array Int unsigned_8))
(declare-const xdi1 (Array Int unsigned_8))
(declare-const result1 (Array Int unsigned_8))
(declare-const xdi2 (Array Int unsigned_8))
(declare-const result2 (Array Int unsigned_8))
(declare-const xdi3 (Array Int unsigned_8))
(declare-const result3 (Array Int unsigned_8))
(declare-const xdi4 (Array Int unsigned_8))
(declare-const xdi5 (Array Int unsigned_8))
(declare-const xdi6 (Array Int unsigned_8))
(assert true)
(assert (and (and (and (and (= (to_rep o) ((_ extract 7 0) (bvurem val__ ((_ int2bv 32) 256)))) (= o1 (store xdi 0 o))) (and (= (mk_map__ref result) (mk_map__ref xdi)) (= xdi1 o1))) (and (and (and (= (to_rep o2) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 256)) ((_ int2bv 32) 256)))) (= o3 (store xdi1 1 o2))) (and (= xdi1 result1) (= xdi2 o3))) (and (and (and (= (to_rep o4) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 256)))) (= o5 (store xdi2 2 o4))) (and (= xdi2 result2) (= xdi3 o5))) (and (and (and (= (to_rep o6) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 16777216)) ((_ int2bv 32) 256)))) (= o7 (store xdi3 3 o6))) (and (= xdi3 result3) (= xdi4 o7))) (and (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (and (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))) (and (= (bvadd (bvurem val__ ((_ int2bv 32) 65536)) (bvmul (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))) val__) (and (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 16777216))) val__)) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 16777216))) val__))))))))) (and (= xdi4 xdi5) (= xdi6 xdi4))))
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi5 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi5 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi5 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi5 3))) ((_ int2bv 32) 16777216))) val__)))
(check-sat)
(exit)
