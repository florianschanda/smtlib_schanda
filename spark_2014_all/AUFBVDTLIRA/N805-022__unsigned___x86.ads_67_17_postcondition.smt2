...
(assert (= (to_rep o) ((_ extract 7 0) (bvurem val__ ((_ int2bv 32) 256)))))
(assert (= o1 (store xdi 0 o)))
(assert (= (mk_map__ref result) (mk_map__ref xdi)))
(assert (= xdi1 o1))
(assert (= (to_rep o2) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 256)) ((_ int2bv 32) 256)))))
(assert (= o3 (store xdi1 1 o2)))
(assert (= xdi1 result1))
(assert (= xdi2 o3))
(assert (= (to_rep o4) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 256)))))
(assert (= o5 (store xdi2 2 o4)))
(assert (= xdi2 result2))
(assert (= xdi3 o5))
(assert (= (to_rep o6) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 16777216)) ((_ int2bv 32) 256)))))
(assert (= o7 (store xdi3 3 o6)))
(assert (= xdi3 result3))
(assert (= xdi4 o7))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))))
(assert (= (bvadd (bvurem val__ ((_ int2bv 32) 65536)) (bvmul (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))) val__))
(assert (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 16777216))) val__)))
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) ((_ int2bv 32) 16777216))) val__))
(assert (= xdi4 xdi5))
(assert (= xdi6 xdi4))
