...
(assert (= xdi3 result3))
(assert (= xdi4 o7))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) #x00000100)) (bvurem val__ #x00010000)))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000)))
(assert (= (bvadd (bvurem val__ #x00010000) (bvmul (bvurem (bvudiv val__ #x00010000) #x00010000) #x00010000)) val__))
(assert (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) #x00000100)) (bvurem val__ #x00010000)) (= (bvadd ((_ zero_extend 24) (to_rep (select xdi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) #x01000000)) val__)))
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xdi4 3))) #x01000000)) val__))
(assert (= xdi4 xdi5))
(assert (= xdi6 xdi4))
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi5 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi5 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xdi5 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xdi5 3))) #x01000000)) val__)))
(check-sat)
(exit)
