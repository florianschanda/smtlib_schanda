...
(assert (not (= (ite (<= (to_rep2 (first4 temp___11861)) (to_rep2 (last4 temp___11861))) (+ (- (to_rep2 (last4 temp___11861)) (to_rep2 (first4 temp___11861))) 1) 0) (ite (<= 1 r116b) (+ (- r116b 1) 1) 0))))
(check-sat)
(exit)
