...
(assert (and (= o1 (esi rsi)) (= o1 ((_ extract 31 0) (bvand rsi ((_ int2bv 64) 4294967295))))))
(assert (= o2 ((_ zero_extend 32) o1)))
(assert (and (= o3 (readmem8 o2 memory)) (= o3 (to_rep (select memory o2)))))
(assert (= result2 val1))
(assert (= val11 o3))
(assert (and (= o4 (edi rdi)) (= o4 ((_ extract 31 0) (bvand rdi ((_ int2bv 64) 4294967295))))))
...
(assert (and (= o11 (esi rsi)) (= o11 ((_ extract 31 0) (bvand rsi ((_ int2bv 64) 4294967295))))))
(assert (= o12 (bvadd o11 ((_ int2bv 32) 1))))
(assert (and (= (esi rsi1) o12) (= rsi1 (bvor (bvand rsi ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) o12)))))
(assert (and (= o13 (edi rdi)) (= o13 ((_ extract 31 0) (bvand rdi ((_ int2bv 64) 4294967295))))))
(assert (= o14 (bvadd o13 ((_ int2bv 32) 1))))
(assert (and (= (edi rdi1) o14) (= rdi1 (bvor (bvand rdi ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) o14)))))
