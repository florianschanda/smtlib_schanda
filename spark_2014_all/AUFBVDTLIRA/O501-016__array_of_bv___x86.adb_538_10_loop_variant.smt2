...
(assert (and (= o1 (esi rsi1)) (= o1 ((_ extract 31 0) (bvand rsi1 ((_ int2bv 64) 4294967295))))))
(assert (= o2 ((_ zero_extend 32) o1)))
(assert (and (= o3 (readmem8 o2 memory)) (= o3 (to_rep (select memory o2)))))
(assert (= result2 val11))
(assert (= val12 o3))
(assert (and (= o4 (edi rdi1)) (= o4 ((_ extract 31 0) (bvand rdi1 ((_ int2bv 64) 4294967295))))))
(assert (= o5 ((_ zero_extend 32) o4)))
(assert (and (= o6 (readmem8 o5 memory)) (= o6 (to_rep (select memory o5)))))
(assert (= result3 val21))
(assert (= val22 o6))
(assert (= result4 zeroflag))
(assert (= zeroflag1 (ite (= (bvsub val12 val22) ((_ int2bv 8) 0)) true false)))
(assert (= result5 carryflag))
(assert (= carryflag1 (ite (bvugt (bvadd ((_ zero_extend 8) val12) ((_ zero_extend 8) val22)) ((_ zero_extend 8) (bvadd val12 val22))) true false)))
(assert (and (= o7 (ecx rcx1)) (= o7 ((_ extract 31 0) (bvand rcx1 ((_ int2bv 64) 4294967295))))))
(assert (= o8 (bvsub o7 ((_ int2bv 32) 1))))
(assert (and (= (ecx rcx2) o8) (= rcx2 (bvor (bvand rcx1 ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) o8)))))
(assert (and (= o9 (ecx rcx2)) (= o9 ((_ extract 31 0) (bvand rcx2 ((_ int2bv 64) 4294967295))))))
...
(assert (and (= o11 (esi rsi1)) (= o11 ((_ extract 31 0) (bvand rsi1 ((_ int2bv 64) 4294967295))))))
(assert (= o12 (bvadd o11 ((_ int2bv 32) 1))))
(assert (and (= (esi rsi2) o12) (= rsi2 (bvor (bvand rsi1 ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) o12)))))
(assert (and (= o13 (edi rdi1)) (= o13 ((_ extract 31 0) (bvand rdi1 ((_ int2bv 64) 4294967295))))))
(assert (= o14 (bvadd o13 ((_ int2bv 32) 1))))
(assert (and (= (edi rdi2) o14) (= rdi2 (bvor (bvand rdi1 ((_ int2bv 64) 18446744069414584320)) ((_ zero_extend 32) o14)))))
(assert (and (= o15 (ecx rcx2)) (= o15 ((_ extract 31 0) (bvand rcx2 ((_ int2bv 64) 4294967295))))))
(assert (= o16 (ite (bvugt o15 ((_ int2bv 32) 0)) true false)))
(assert (= result7 (ite (not (= o16 true)) true false)))
(assert (not (= result7 true)))
(assert (not (bvult (ecx rcx2) temp___3311)))
(check-sat)
(exit)
