...
(assert (= o8 (+ c_first o7)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (ite (<= o9 (to_rep (last (rt c)))) true false)))
(assert (and (= o4 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o5 (+ c_first o4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o11 (ite (<= (to_rep (first (rt c))) o6) true false)))
(assert (= o12 (ite (= o11 true) o10 false)))
(assert (and (= o (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o1 (+ b_first o)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (= o3 (ite (<= o2 (to_rep (last (rt b)))) true false)))
