...
(assert (= o16 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o15)))
(assert (= o29 (oadd o16 o28)))
(assert (= o10 (from_word32 carry2)))
(assert (and (= o9 (base Tuple0)) (= o9 (oexpon (from_word32 #x00000002) 32))))
(assert (= o11 (omultiply o9 o10)))
(assert (= o8 (from_word32 carry1)))
(assert (= o6 (from_word32 y)))
