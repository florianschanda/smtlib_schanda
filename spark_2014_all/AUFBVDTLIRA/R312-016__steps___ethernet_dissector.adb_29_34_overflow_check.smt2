...
(assert (=> (<= temp___721 temp___722) (and (and (<= (to_rep (first (rt buffer))) temp___721) (<= temp___721 (to_rep (last (rt buffer))))) (and (<= (to_rep (first (rt buffer))) temp___722) (<= temp___722 (to_rep (last (rt buffer))))))))
(assert (= o9 (elts buffer)))
(assert (= o9 temp___723))
(assert (= (mk4 temp___721 temp___722) temp___7231))
(assert (= temp___723 o10))
(assert (= (mk (to_rep (first8 temp___7231)) (to_rep (last8 temp___7231))) o11))
