...
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields2) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r125b))))
...
(assert (= temp___1336 (- o7 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1336) (<= temp___1336 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o8 temp___1336))
...
(assert (= temp___1338 (- o13 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1338) (<= temp___1338 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o14 temp___1338))
(assert (= o15 (select (elts1 (rec__very_longs__very_long__long_digits1 u__split_fields2)) o14)))
...
(assert (= temp___1340 (- o12 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1340)))
(check-sat)
(exit)
