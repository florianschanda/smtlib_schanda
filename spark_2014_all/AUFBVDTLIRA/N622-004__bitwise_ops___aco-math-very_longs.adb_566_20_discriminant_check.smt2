...
(assert (and (= o3 (modadd (to_base (mk___rep1 result____split_discrs result____split_fields2)) p)) (and (dynamic_invariant1 o3 true false true) (= (to_rep o) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (to_base (mk___rep1 result____split_discrs result____split_fields2)))))))))
