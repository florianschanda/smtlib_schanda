...
(assert (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant (mk___rep result____split_discrs aco__math__very_longs__modsubtract_and_borrow__result__fields) true true true true)))
...
(assert (= borrow #x0001))
(assert (and (= o3 (modadd (to_base (mk___rep1 result____split_discrs result____split_fields2)) p)) (and (dynamic_invariant o3 true false true true) (= (to_rep o) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (to_base (mk___rep1 result____split_discrs result____split_fields2)))))))))
