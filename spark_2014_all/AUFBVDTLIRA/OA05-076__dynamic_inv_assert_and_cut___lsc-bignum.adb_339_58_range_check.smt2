...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o53 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o54 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o54 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= o49 (omultiply o43 o48)))
(assert (= o51 (osubtract o49 o50)))
(assert (= o40 (from_word32 a_msw2)))
...
(assert (= o39 (oexpon o34 o38)))
(assert (= o41 (omultiply o39 o40)))
(assert (and (= o29 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o30 (+ o29 1)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (and (= o32 o31) (in_range2 o31)))
(assert (= o33 (num_of_big_int (mk___t o54 (mk (to_rep a__first) (to_rep a__last))) a_first o32)))
(assert (= o42 (oadd o33 o41)))
(assert (= o52 (olt o42 o51)))
...
(assert (= o5 (num_of_big_int b b_first o4)))
(assert (= o11 (omultiply o5 o10)))
(assert (= o22 (omultiply o11 o21)))
(assert (= o28 (omod o22 o27)))
