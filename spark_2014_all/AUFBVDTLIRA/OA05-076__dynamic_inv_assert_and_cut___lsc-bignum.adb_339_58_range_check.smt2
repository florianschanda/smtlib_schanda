...
(assert (and (= o98 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o99 (+ o98 1)))
(assert (and (= o100 o99) (in_range1 o99)))
(assert (and (= o101 o100) (in_range2 o100)))
(assert (= o102 (num_of_big_int m m_first o101)))
(assert (= o97 (from_word32 ((_ int2bv 32) 2))))
(assert (= o103 (omultiply o97 o102)))
(assert (= o105 (osubtract o103 o104)))
(assert (= o94 (from_word32 a_msw2)))
(assert (and (= o89 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o90 (+ o89 1)))
(assert (and (= o91 o90) (in_range1 o90)))
(assert (and (= o92 o91) (in_range2 o91)))
(assert (and (= o88 (base Tuple0)) (= o88 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o93 (oexpon o88 o92)))
(assert (= o95 (omultiply o93 o94)))
(assert (and (= o83 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o84 (+ o83 1)))
(assert (and (= o85 o84) (in_range1 o84)))
(assert (and (= o86 o85) (in_range2 o85)))
(assert (= o87 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o86)))
(assert (= o96 (oadd o87 o95)))
(assert (= o106 (olt o96 o105)))
