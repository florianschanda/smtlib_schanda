...
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i2 Int)) (=> (and (<= begidx4 i2) (<= i2 endidx2)) (and (<= 48 (to_rep (select zonefileline i2))) (<= (to_rep (select zonefileline i2)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx2)) (in_range3 foundtype2)))))
