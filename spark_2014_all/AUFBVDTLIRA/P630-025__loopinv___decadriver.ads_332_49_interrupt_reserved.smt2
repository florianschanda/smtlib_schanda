...
(assert (forall ((x bits_2)) (! (in_range_int1 (to_int6 x)) :pattern ((to_int6 x)))))
...
(assert (forall ((x bits_3)) (! (in_range_int2 (to_int7 x)) :pattern ((to_int7 x)))))
(declare-sort bits_5 0)
(define-fun in_range4 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 31))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 32)))) (=> (in_range4 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int8 ((x bits_5)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_5)) (! (in_range_int3 (to_int8 x)) :pattern ((to_int8 x)))))
...
(assert (forall ((x bits_32)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert true)
...
(assert (forall ((x bits_32)) (! (uint_in_range2 (to_int9 x)) :pattern ((to_int9 x)))))
...
(define-fun bool_eq1 ((a (Array Int bits_32)) (a__first Int) (a__last Int) (b (Array Int bits_32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_184 Int)) (=> (and (<= a__first temp___idx_184) (<= temp___idx_184 a__last)) (= (to_rep4 (select a temp___idx_184)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_184))))))) true false))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_184 Int)) (=> (and (<= a__first temp___idx_184) (<= temp___idx_184 a__last)) (= (to_rep4 (select a temp___idx_184)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_184)))))))))))
(declare-fun compare ((Array Int bits_32) Int Int (Array Int bits_32) Int Int) Int)
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq1 a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep4 (select a (+ i 1))) (to_rep4 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep4 (select a (+ j 1))) (to_rep4 (select b (+ i 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__decadriver__driver_type__part_id bits_32) (rec__decadriver__driver_type__lot_id bits_32) (rec__decadriver__driver_type__antenna_delay_prf_64 bits_16) (rec__decadriver__driver_type__antenna_delay_prf_16 bits_16) (rec__decadriver__driver_type__xtal_trim bits_5) (rec__decadriver__driver_type__otp_tx_power_levels (Array Int bits_32)) (rec__decadriver__driver_type__long_frames Bool) (rec__decadriver__driver_type__sys_cfg_reg us_rep) (rec__decadriver__driver_type__use_otp_xtal_trim Bool) (rec__decadriver__driver_type__use_otp_antenna_delay Bool) (rec__decadriver__driver_type__detect_frame_timeout Bool) (rec__decadriver__driver_type__detect_sfd_timeout Bool) (rec__decadriver__driver_type__detect_phr_error Bool) (rec__decadriver__driver_type__detect_rs_error Bool) (rec__decadriver__driver_type__detect_fcs_error Bool)))))
(define-fun us_split_fields_Part_ID__projection ((a us_split_fields2)) bits_32 (rec__decadriver__driver_type__part_id a))
(define-fun us_split_fields_Lot_ID__projection ((a us_split_fields2)) bits_32 (rec__decadriver__driver_type__lot_id a))
(define-fun us_split_fields_Antenna_Delay_PRF_64__projection ((a us_split_fields2)) bits_16 (rec__decadriver__driver_type__antenna_delay_prf_64 a))
(define-fun us_split_fields_Antenna_Delay_PRF_16__projection ((a us_split_fields2)) bits_16 (rec__decadriver__driver_type__antenna_delay_prf_16 a))
(define-fun us_split_fields_XTAL_Trim__projection ((a us_split_fields2)) bits_5 (rec__decadriver__driver_type__xtal_trim a))
(define-fun us_split_fields_OTP_Tx_Power_Levels__projection ((a us_split_fields2)) (Array Int bits_32) (rec__decadriver__driver_type__otp_tx_power_levels a))
(define-fun us_split_fields_Long_Frames__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__long_frames a))
(define-fun us_split_fields_SYS_CFG_Reg__projection ((a us_split_fields2)) us_rep (rec__decadriver__driver_type__sys_cfg_reg a))
(define-fun us_split_fields_Use_OTP_XTAL_Trim__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__use_otp_xtal_trim a))
(define-fun us_split_fields_Use_OTP_Antenna_Delay__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__use_otp_antenna_delay a))
(define-fun us_split_fields_Detect_Frame_Timeout__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__detect_frame_timeout a))
(define-fun us_split_fields_Detect_SFD_Timeout__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__detect_sfd_timeout a))
(define-fun us_split_fields_Detect_PHR_Error__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__detect_phr_error a))
(define-fun us_split_fields_Detect_RS_Error__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__detect_rs_error a))
(define-fun us_split_fields_Detect_FCS_Error__projection ((a us_split_fields2)) Bool (rec__decadriver__driver_type__detect_fcs_error a))
...
(declare-datatypes () ((driver_type__ref (mk_driver_type__ref (driver_type__content us_rep1)))))
(define-fun driver_type__ref___projection ((a driver_type__ref)) us_rep1 (driver_type__content a))
(declare-fun temp___4490 ((_ BitVec 32)) (Array Int bits_32))
(assert (forall ((temp___4492 (_ BitVec 32))) (forall ((temp___4493 Int)) (= (select (temp___4490 temp___4492) temp___4493) (of_rep4 temp___4492)))))
(declare-fun to_rep5 (bits_16) (_ BitVec 16))
(declare-fun of_rep5 ((_ BitVec 16)) bits_16)
(assert (forall ((x bits_16)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert true)
(assert (forall ((x (_ BitVec 16))) (! (= (to_rep5 (of_rep5 x)) x) :pattern ((to_rep5 (of_rep5 x))))))
(define-fun to_int10 ((x bits_16)) Int (bv2nat (to_rep5 x)))
(assert (forall ((x bits_16)) (! (uint_in_range1 (to_int10 x)) :pattern ((to_int10 x)))))
(define-fun default_initial_assumption ((temp___expr_4488 us_rep1) (temp___skip_top_level_4489 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep4 (rec__decadriver__driver_type__part_id (us_split_fields3 temp___expr_4488))) ((_ int2bv 32) 0)) (= (to_rep4 (rec__decadriver__driver_type__lot_id (us_split_fields3 temp___expr_4488))) ((_ int2bv 32) 0))) (= (to_rep5 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields3 temp___expr_4488))) ((_ int2bv 16) 0))) (= (to_rep5 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields3 temp___expr_4488))) ((_ int2bv 16) 0))) (= (to_rep3 (rec__decadriver__driver_type__xtal_trim (us_split_fields3 temp___expr_4488))) ((_ int2bv 8) 16))) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields3 temp___expr_4488)) (temp___4490 ((_ int2bv 32) 0)))) (= (rec__decadriver__driver_type__long_frames (us_split_fields3 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields3 temp___expr_4488)) (mk___rep (mk___split_fields (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep1 ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep2 ((_ int2bv 8) 0)) (of_rep3 ((_ int2bv 8) 0)))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields3 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields3 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields3 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields3 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields3 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields3 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields3 temp___expr_4488)) (of_int 0))))
(define-fun dynamic_invariant ((temp___expr_281 (_ BitVec 8)) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool)) Bool (=> (or (= temp___is_init_278 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range1 temp___expr_281)))
(define-fun dynamic_invariant1 ((temp___expr_287 (_ BitVec 8)) (temp___is_init_284 Bool) (temp___skip_constant_285 Bool) (temp___do_toplevel_286 Bool)) Bool (=> (or (= temp___is_init_284 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 3))) (in_range2 temp___expr_287)))
(define-fun dynamic_invariant2 ((temp___expr_293 (_ BitVec 8)) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool)) Bool (=> (or (= temp___is_init_290 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 7))) (in_range3 temp___expr_293)))
(define-fun dynamic_invariant3 ((temp___expr_305 (_ BitVec 8)) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 31))) (in_range4 temp___expr_305)))
(define-fun dynamic_invariant4 ((temp___expr_371 (_ BitVec 16)) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_467 (_ BitVec 32)) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool true)
(declare-const self__ us_rep1)
(declare-const temp___4590 Bool)
(assert (not (= temp___4590 false)))
(check-sat)
(exit)
