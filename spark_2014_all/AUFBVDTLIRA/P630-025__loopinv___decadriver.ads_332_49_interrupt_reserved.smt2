...
(define-fun bool_eq1 ((a (Array Int bits_32)) (a__first Int) (a__last Int) (b (Array Int bits_32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep4 (select a temp___idx_206)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_206))))))) true false))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_206 Int)) (=> (and (<= a__first temp___idx_206) (<= temp___idx_206 a__last)) (= (to_rep4 (select a temp___idx_206)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_206)))))))))))
...
(assert (forall ((x bits_16)) (! (uint_in_range1 (to_int9 x)) :pattern ((to_int9 x)))))
(define-fun default_initial_assumption ((temp___expr_4979 us_rep1) (temp___skip_top_level_4980 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep4 (rec__decadriver__driver_type__part_id (us_split_fields3 temp___expr_4979))) #x00000000) (= (to_rep4 (rec__decadriver__driver_type__lot_id (us_split_fields3 temp___expr_4979))) #x00000000)) (= (to_rep5 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields3 temp___expr_4979))) #x0000)) (= (to_rep5 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields3 temp___expr_4979))) #x0000)) (= (to_rep3 (rec__decadriver__driver_type__xtal_trim (us_split_fields3 temp___expr_4979))) #x10)) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields3 temp___expr_4979)) (temp___4981 #x00000000))) (= (rec__decadriver__driver_type__long_frames (us_split_fields3 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields3 temp___expr_4979)) (mk___rep (mk___split_fields (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep1 #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep2 #x00) (of_rep3 #x00))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields3 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields3 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields3 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields3 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields3 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields3 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields3 temp___expr_4979)) (distinct 0 0))))
...
(assert (forall ((temp___4983 (_ BitVec 32))) (=> (dynamic_invariant temp___4983 true true true true) (forall ((temp___4984 Int)) (= (to_rep4 (select (temp___4981 temp___4983) temp___4984)) temp___4983)))))
...
(define-fun dynamic_invariant5 ((temp___expr_420 (_ BitVec 16)) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool true)
(declare-const self__ us_rep1)
(declare-const temp___5083 Bool)
(assert (not (= temp___5083 false)))
(check-sat)
(exit)
