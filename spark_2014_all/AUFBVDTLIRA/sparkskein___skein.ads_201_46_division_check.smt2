...
(assert (and (= o (hash_bit_len_of ctx)) (and (in_range2 o) (= o (to_rep2 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx)))))))))
