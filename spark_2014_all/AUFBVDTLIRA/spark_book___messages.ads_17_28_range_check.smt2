...
(define-fun dynamic_invariant ((temp___expr_366 (_ BitVec 64)) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_394 us_t) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool) (temp___do_typ_inv_393 Bool)) Bool (=> (not (= temp___skip_constant_391 true)) (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF (first1 temp___expr_394) (last1 temp___expr_394))))
(declare-const buffer us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const size (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_387 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool) (temp___do_typ_inv_386 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= 0 255)) (in_range temp___expr_387)))
