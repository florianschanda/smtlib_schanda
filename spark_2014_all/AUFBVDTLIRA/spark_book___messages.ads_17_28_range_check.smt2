...
(define-fun bool_eq ((a (Array (_ BitVec 64) char)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) char)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_155 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_155) (bvule temp___idx_155 a__last)) (= (to_rep1 (select a temp___idx_155)) (to_rep1 (select b (bvadd (bvsub b__first a__first) temp___idx_155))))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_359 (_ BitVec 64)) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool) (temp___do_typ_inv_358 Bool)) Bool true)
(define-fun dynamic_invariant1 ((temp___expr_387 us_t) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool) (temp___do_typ_inv_386 Bool)) Bool (=> (not (= temp___skip_constant_384 true)) (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF (first1 temp___expr_387) (last1 temp___expr_387))))
(declare-const buffer us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const size (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_380 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool) (temp___do_typ_inv_379 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 0 255)) (in_range temp___expr_380)))
