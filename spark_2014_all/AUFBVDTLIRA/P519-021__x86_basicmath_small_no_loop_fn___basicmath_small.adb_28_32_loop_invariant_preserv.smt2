...
(assert (= (writereg32post rdi2 #x0040112F) true))
(assert (= rbx result3))
(assert (= rbx1 (bvadd rbx #x0000000000000001)))
(assert (= rsp3 result4))
(assert (= rsp4 (bvsub rsp3 #x0000000000000008)))
(assert (= rsp5 (bvadd rsp4 #x0000000000000008)))
(assert (= zeroflag result5))
(assert (= zeroflag1 (ite (= (bvsub rbx1 #x00000000000003E9) #x0000000000000000) true false)))
(assert (= result6 (mk_bool__ref signflag)))
(assert (= signflag1 (ite (bvugt (bvsub rbx1 #x00000000000003E9) #x7FFFFFFFFFFFFFFF) true false)))
(assert (= result7 (mk_bool__ref carryflag)))
(assert (= carryflag1 (ite (bvult rbx1 #x00000000000003E9) true false)))
(assert (= result8 (mk_bool__ref overflowflag)))
(assert (= overflowflag1 (ite (and (and (= signflag1 true) (= (distinct 0 0) true)) (bvule rbx1 #x7FFFFFFFFFFFFFFF)) true (ite (and (and (not (= signflag1 true)) (bvugt rbx1 #x7FFFFFFFFFFFFFFF)) (= (distinct 1 0) true)) true false))))
