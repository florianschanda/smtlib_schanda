...
(assert (= zeroflag1 (ite (= (bvsub rbx1 ((_ int2bv 64) 1001)) ((_ int2bv 64) 0)) true false)))
(assert (= result6 (mk_bool__ref signflag)))
(assert (= signflag1 (ite (bvugt (bvsub rbx1 ((_ int2bv 64) 1001)) ((_ int2bv 64) 9223372036854775807)) true false)))
...
(assert (= overflowflag1 (ite (and (and (= signflag1 true) (= (of_int 0) true)) (bvule rbx1 ((_ int2bv 64) 9223372036854775807))) true (ite (and (and (not (= signflag1 true)) (bvugt rbx1 ((_ int2bv 64) 9223372036854775807))) (= (of_int 1) true)) true false))))
