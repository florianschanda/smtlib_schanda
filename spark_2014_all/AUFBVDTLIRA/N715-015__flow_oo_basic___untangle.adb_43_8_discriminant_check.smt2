...
(define-fun untangle__optional_thing__t__pred ((a us_rep2)) Bool (= (to_int3 (rec__untangle__optional_thing__exists (us_split_discrs1 a))) 1))
...
(define-fun default_initial_assumption ((temp___expr_184 us_rep2) (temp___skip_top_level_185 Bool)) Bool (and (= (attr__constrained temp___expr_184) false) (= (rec__untangle__optional_thing__exists (us_split_discrs1 temp___expr_184)) (of_int 0))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun wibble (Int Bool) Int)
(declare-fun wibble__function_guard (Int Int Bool) Bool)
(assert (forall ((n Int)) (forall ((untangle__g Bool)) (! (=> (and (dynamic_invariant n true true true) (= untangle__g true)) (dynamic_invariant (wibble n untangle__g) true false true)) :pattern ((wibble n untangle__g))))))
(assert (forall ((n Int)) (forall ((untangle__g Bool)) (! (=> (dynamic_invariant n true true true) (= (wibble n untangle__g) n)) :pattern ((wibble n untangle__g))))))
...
(assert (in_range n))
(assert (not (= (to_int3 x__split_discrs) 1)))
(check-sat)
(exit)
