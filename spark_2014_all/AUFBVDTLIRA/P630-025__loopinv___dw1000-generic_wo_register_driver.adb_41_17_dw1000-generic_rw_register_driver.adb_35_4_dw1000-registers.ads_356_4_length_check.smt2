...
(define-fun register_byte_array__ref___64__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_4305 us_t1) (temp___is_init_4302 Bool) (temp___skip_constant_4303 Bool) (temp___do_toplevel_4304 Bool)) Bool (=> (not (= temp___skip_constant_4303 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4305) (last3 temp___expr_4305)) (and (= (first3 temp___expr_4305) 1) (= (last3 temp___expr_4305) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___26__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_4330 us_t2) (temp___is_init_4327 Bool) (temp___skip_constant_4328 Bool) (temp___do_toplevel_4329 Bool)) Bool (=> (not (= temp___skip_constant_4328 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4330) (last5 temp___expr_4330)) (and (= (first5 temp___expr_4330) 1) (= (last5 temp___expr_4330) 4)))))
...
(declare-const temp___7898 (Array Int bits_8))
(declare-const temp___78981 t2)
(declare-const temp___7899 (Array Int bits_8))
(declare-const temp___78991 t1)
...
(assert (and (= (mk___t2 temp___7898 temp___78981) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7898 temp___78981) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___78981)) (to_rep (last4 temp___78981))) (+ (- (to_rep (last4 temp___78981)) (to_rep (first4 temp___78981))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7898 temp___7899))
(assert (= (mk1 (to_rep (first4 temp___78981)) (to_rep (last4 temp___78981))) temp___78991))
(assert (not (= (ite (<= (to_rep (first2 temp___78991)) (to_rep (last2 temp___78991))) (+ (- (to_rep (last2 temp___78991)) (to_rep (first2 temp___78991))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
