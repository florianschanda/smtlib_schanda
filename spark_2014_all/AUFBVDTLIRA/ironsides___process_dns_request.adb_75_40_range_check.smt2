...
(declare-fun to_rep1 (unsigned32) (_ BitVec 32))
(declare-fun of_rep1 ((_ BitVec 32)) unsigned32)
(assert (forall ((x unsigned32)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert true)
(assert (forall ((x (_ BitVec 32))) (! (= (to_rep1 (of_rep1 x)) x) :pattern ((to_rep1 (of_rep1 x))))))
(define-fun to_int5 ((x unsigned32)) Int (bv2nat (to_rep1 x)))
...
(declare-fun to_rep2 (classtype) Int)
(declare-fun of_rep2 (Int) classtype)
(assert (forall ((x classtype)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x classtype)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__rr_type__resourcerecordtype__ttlinseconds (us_split_fields1 a))) (to_rep1 (rec__rr_type__resourcerecordtype__ttlinseconds (us_split_fields1 b)))) (= (to_rep2 (rec__rr_type__resourcerecordtype__class (us_split_fields1 a))) (to_rep2 (rec__rr_type__resourcerecordtype__class (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rr_type__a_record_type__arecordtype__ipv4 unsigned32) (rec__rr_type__resourcerecordtype__ttlinseconds1 unsigned32) (rec__rr_type__resourcerecordtype__class1 classtype) (rec__ext__1 us_private)))))
(define-fun us_split_fields_IPV4__projection ((a us_split_fields2)) unsigned32 (rec__rr_type__a_record_type__arecordtype__ipv4 a))
...
(declare-fun hide_ext__ (unsigned32 us_private) us_private)
(declare-fun extract__ipv4 (us_private) unsigned32)
(assert (forall ((ipv4 unsigned32)) (forall ((rec__ext__2 us_private)) (= (extract__ipv4 (hide_ext__ ipv4 rec__ext__2)) ipv4))))
(declare-fun extract__ext__ (us_private) us_private)
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (mk___split_fields (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a)) (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a)) (hide_ext__ (rec__rr_type__a_record_type__arecordtype__ipv4 (us_split_fields3 a)) (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (mk___split_fields1 (extract__ipv4 (rec__ext__ (us_split_fields1 r))) (rec__rr_type__resourcerecordtype__ttlinseconds (us_split_fields1 r)) (rec__rr_type__resourcerecordtype__class (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep1 (rec__rr_type__a_record_type__arecordtype__ipv4 (us_split_fields3 a))) (to_rep1 (rec__rr_type__a_record_type__arecordtype__ipv4 (us_split_fields3 b)))) (= (to_rep1 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a))) (to_rep1 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 b))))) (= (to_rep2 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a))) (to_rep2 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 b))))) true false))
...
(declare-const rr_type__a_record_type__arecordtype__ipv4__first__bit Int)
(declare-const rr_type__a_record_type__arecordtype__ipv4__last__bit Int)
(declare-const rr_type__a_record_type__arecordtype__ipv4__position Int)
(assert (<= 0 rr_type__a_record_type__arecordtype__ipv4__first__bit))
(assert (< rr_type__a_record_type__arecordtype__ipv4__first__bit rr_type__a_record_type__arecordtype__ipv4__last__bit))
(assert (<= 0 rr_type__a_record_type__arecordtype__ipv4__position))
...
(declare-datatypes () ((arecordtype__ref (mk_arecordtype__ref (arecordtype__content us_rep1)))))
(define-fun arecordtype__ref___projection ((a arecordtype__ref)) us_rep1 (arecordtype__content a))
(define-fun default_initial_assumption ((temp___expr_1108 us_rep1) (temp___skip_top_level_1109 Bool)) Bool (= (attr__tag1 temp___expr_1108) us_tag1))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const start_byte Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const a_record us_rep1)
...
(define-fun dynamic_invariant2 ((temp___expr_963 (_ BitVec 32)) (temp___is_init_959 Bool) (temp___skip_constant_960 Bool) (temp___do_toplevel_961 Bool) (temp___do_typ_inv_962 Bool)) Bool true)
(define-fun dynamic_invariant3 ((temp___expr_970 Int) (temp___is_init_966 Bool) (temp___skip_constant_967 Bool) (temp___do_toplevel_968 Bool) (temp___do_typ_inv_969 Bool)) Bool (=> (or (= temp___is_init_966 true) (<= 0 3)) (in_range1 temp___expr_970)))
...
(assert (<= start_byte 8170))
(assert (and (= o (+ start_byte 4)) (in_range (+ start_byte 4))))
(assert (not (in_range (+ start_byte 6))))
(check-sat)
(exit)
