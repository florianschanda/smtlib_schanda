...
(assert (not (= (ite (<= (to_rep2 (first4 temp___12201)) (to_rep2 (last4 temp___12201))) (+ (- (to_rep2 (last4 temp___12201)) (to_rep2 (first4 temp___12201))) 1) 0) (ite (<= 1 r10b) (+ (- r10b 1) 1) 0))))
(check-sat)
(exit)
