...
(assert (not (= zeroflag72 true)))
(assert (= memory30 (let ((subject memory)) (mk_map__ref memory29))))
...
(assert (= xmm070 xmm068))
(assert (= overflowflag70 overflowflag68))
(assert (= signflag70 signflag68))
(assert (= carryflag70 carryflag68))
(assert (= zeroflag73 (mk_bool__ref zeroflag72)))
(assert (= memory31 memory29))
(assert (= r146 r144))
(assert (= r1313 r1311))
(assert (= r1220 r1218))
(assert (= rdi83 rdi81))
...
(assert (= xmm071 xmm069))
(assert (= overflowflag71 overflowflag69))
(assert (= signflag71 signflag69))
(assert (= carryflag71 carryflag69))
(assert (= zeroflag74 zeroflag72))
(assert (not (= (t__content3 rsp109) (let ((subject rsp)) rsp76))))
(check-sat)
(exit)
