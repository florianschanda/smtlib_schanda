...
(declare-const temp___595 (_ BitVec 64))
(declare-const temp___596 (_ BitVec 64))
(declare-const temp___594 (_ BitVec 64))
(declare-const temp___593 (Array (_ BitVec 64) unsigned8))
(declare-const temp___592 (_ BitVec 64))
(declare-const temp___597 (Array (_ BitVec 64) unsigned8))
(declare-const temp___591 (_ BitVec 64))
(declare-const temp___590 (_ BitVec 64))
(declare-const temp___589 (_ BitVec 64))
(declare-const temp___588 (_ BitVec 64))
(declare-const temp___587 Bool)
...
(assert (= temp___595 rbx))
(assert (= temp___596 rsp))
(assert (= temp___594 rsp))
(assert (= temp___593 memory))
(assert (= temp___592 xmm2))
(assert (= temp___597 memory))
(assert (= temp___591 xmm1))
(assert (= temp___590 rax))
(assert (= temp___589 xmm0))
(assert (= temp___588 rdi))
(assert (= temp___587 zeroflag))
(assert (= rsp1 temp___596))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rsp1)) (not (= i (bvadd rsp1 #x0000000000000001)))) (not (= i (bvadd rsp1 #x0000000000000002)))) (not (= i (bvadd rsp1 #x0000000000000003)))) (not (= i (bvadd rsp1 #x0000000000000004)))) (not (= i (bvadd rsp1 #x0000000000000005)))) (not (= i (bvadd rsp1 #x0000000000000006)))) (not (= i (bvadd rsp1 #x0000000000000007)))) (= (to_rep (select memory1 i)) (to_rep (select temp___597 i)))))))
...
(assert (= xmm02 xmm21))
(assert (= (writereg32post rdi1 #x004010E0) true))
