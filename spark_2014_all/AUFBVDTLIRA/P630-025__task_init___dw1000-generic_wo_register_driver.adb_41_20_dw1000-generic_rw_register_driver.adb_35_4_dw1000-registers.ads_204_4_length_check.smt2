...
(define-fun dynamic_invariant ((temp___expr_2058 us_t1) (temp___is_init_2055 Bool) (temp___skip_constant_2056 Bool) (temp___do_toplevel_2057 Bool)) Bool (=> (not (= temp___skip_constant_2056 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2058) (last3 temp___expr_2058)) (and (= (first3 temp___expr_2058) 1) (= (last3 temp___expr_2058) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2098 us_t2) (temp___is_init_2095 Bool) (temp___skip_constant_2096 Bool) (temp___do_toplevel_2097 Bool)) Bool (=> (not (= temp___skip_constant_2096 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2098) (last5 temp___expr_2098)) (and (= (first5 temp___expr_2098) 1) (= (last5 temp___expr_2098) 4)))))
...
(assert (and (= (mk___t2 temp___7707 temp___77071) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7707 temp___77071) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___77071)) (to_rep (last4 temp___77071))) (+ (- (to_rep (last4 temp___77071)) (to_rep (first4 temp___77071))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
