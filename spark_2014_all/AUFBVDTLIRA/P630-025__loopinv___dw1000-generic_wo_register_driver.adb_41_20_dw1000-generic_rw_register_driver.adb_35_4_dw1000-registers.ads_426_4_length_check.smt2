...
(define-fun register_byte_array__ref___90__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5706 us_t1) (temp___is_init_5702 Bool) (temp___skip_constant_5703 Bool) (temp___do_toplevel_5704 Bool) (temp___do_typ_inv_5705 Bool)) Bool (=> (not (= temp___skip_constant_5703 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5706) (last3 temp___expr_5706)) (and (= (first3 temp___expr_5706) 1) (= (last3 temp___expr_5706) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___38__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_5729 us_t2) (temp___is_init_5725 Bool) (temp___skip_constant_5726 Bool) (temp___do_toplevel_5727 Bool) (temp___do_typ_inv_5728 Bool)) Bool (=> (not (= temp___skip_constant_5726 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5729) (last5 temp___expr_5729)) (and (= (first5 temp___expr_5729) 1) (= (last5 temp___expr_5729) 4)))))
...
(declare-const temp___87581 t2)
(define-fun temp___87582 () us_t2 (mk___t2 temp___8758 temp___87581))
...
(assert (and (= temp___87582 (register_to_bytes reg)) (dynamic_invariant1 temp___87582 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___87581)) (to_rep (last4 temp___87581))) (+ (- (to_rep (last4 temp___87581)) (to_rep (first4 temp___87581))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
