...
(assert (= (writereg32post rdx1 ((_ int2bv 32) 0)) true))
(assert (= rsp1 rsp))
(assert (and (and (and (and (and (and (and (and (= (bvand rax2 ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep (select memory1 rsi)))) (= (bvand rax2 ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 1))))) ((_ int2bv 64) 256)))) (= (bvand rax2 ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536)))) (= (bvand rax2 ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216)))) (= (bvand rax2 ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296)))) (= (bvand rax2 ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776)))) (= (bvand rax2 ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656)))) (= (bvand rax2 ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (and (and (and (and (not (= i rsi)) (not (= i (bvadd rsi ((_ int2bv 64) 1))))) (not (= i (bvadd rsi ((_ int2bv 64) 2))))) (not (= i (bvadd rsi ((_ int2bv 64) 3))))) (not (= i (bvadd rsi ((_ int2bv 64) 4))))) (not (= i (bvadd rsi ((_ int2bv 64) 5))))) (not (= i (bvadd rsi ((_ int2bv 64) 6))))) (not (= i (bvadd rsi ((_ int2bv 64) 7))))) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
...
(assert (= rdx3 (mk_t__ref2 rdx2)))
(assert (= rcx2 (mk_t__ref2 rcx1)))
(assert (= rax3 (mk_t__ref2 rax2)))
