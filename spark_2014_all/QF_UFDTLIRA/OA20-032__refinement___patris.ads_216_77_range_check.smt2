...
(define-fun dynamic_invariant ((temp___expr_2174 Int) (temp___is_init_2170 Bool) (temp___skip_constant_2171 Bool) (temp___do_toplevel_2172 Bool) (temp___do_typ_inv_2173 Bool)) Bool (=> (or (= temp___is_init_2170 true) (<= 0 3)) (in_range temp___expr_2174)))
...
(define-fun dynamic_invariant1 ((temp___expr_2285 Int) (temp___is_init_2281 Bool) (temp___skip_constant_2282 Bool) (temp___do_toplevel_2283 Bool) (temp___do_typ_inv_2284 Bool)) Bool (=> (or (= temp___is_init_2281 true) (<= 3 4)) (in_range1 temp___expr_2285)))
(declare-const d Int)
