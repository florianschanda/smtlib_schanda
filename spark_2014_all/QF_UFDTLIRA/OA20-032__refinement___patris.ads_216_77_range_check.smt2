...
(define-fun dynamic_invariant ((temp___expr_1920 Int) (temp___is_init_1917 Bool) (temp___skip_constant_1918 Bool) (temp___do_toplevel_1919 Bool)) Bool (=> (or (= temp___is_init_1917 true) (<= 0 3)) (in_range temp___expr_1920)))
...
(define-fun dynamic_invariant1 ((temp___expr_2022 Int) (temp___is_init_2019 Bool) (temp___skip_constant_2020 Bool) (temp___do_toplevel_2021 Bool)) Bool (=> (or (= temp___is_init_2019 true) (<= 3 4)) (in_range1 temp___expr_2022)))
(declare-const d Int)
