...
(define-fun dynamic_invariant ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= 0 3)) (in_range temp___expr_2167)))
...
(define-fun dynamic_invariant1 ((temp___expr_2278 Int) (temp___is_init_2274 Bool) (temp___skip_constant_2275 Bool) (temp___do_toplevel_2276 Bool) (temp___do_typ_inv_2277 Bool)) Bool (=> (or (= temp___is_init_2274 true) (<= 3 4)) (in_range1 temp___expr_2278)))
(declare-const d Int)
