...
(define-fun dynamic_invariant ((temp___expr_1926 Int) (temp___is_init_1923 Bool) (temp___skip_constant_1924 Bool) (temp___do_toplevel_1925 Bool)) Bool (=> (or (= temp___is_init_1923 true) (<= 0 3)) (in_range temp___expr_1926)))
...
(define-fun dynamic_invariant1 ((temp___expr_2028 Int) (temp___is_init_2025 Bool) (temp___skip_constant_2026 Bool) (temp___do_toplevel_2027 Bool)) Bool (=> (or (= temp___is_init_2025 true) (<= 3 4)) (in_range1 temp___expr_2028)))
(declare-const d Int)
