...
(assert (=> (and (<= (- 2147483648) j1) (<= j1 2147483647)) (and (and (= temp___150 x2) (and (= temp___149 j1) (and (= x2 temp___150) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 j2)) (and (<= (- 2147483648) j2) (<= j2 2147483647))) (= j2 2147483647))))) (and (= j2 j5) (= j6 j2)))))
(assert (=> (and (<= (- 2147483648) j1) (<= j1 2147483647)) (= (mk_int__ref j7) (mk_int__ref j5))))
(assert (=> (and (<= (- 2147483648) j1) (<= j1 2147483647)) (= j8 j6)))
(assert (=> (not (and (<= (- 2147483648) j1) (<= j1 2147483647))) (= j1 j7)))
(assert (=> (not (and (<= (- 2147483648) j1) (<= j1 2147483647))) (= j8 j1)))
(assert (not (= i2 10)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (= result4 x2))
