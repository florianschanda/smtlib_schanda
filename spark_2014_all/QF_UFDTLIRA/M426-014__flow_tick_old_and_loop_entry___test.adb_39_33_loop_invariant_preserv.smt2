...
(assert (=> (and (<= (- 2147483648) j1) (<= j1 2147483647)) (= temp___150 x2)))
(assert (=> (and (<= (- 2147483648) j1) (<= j1 2147483647)) (= temp___149 j1)))
(assert (=> (and (<= (- 2147483648) j1) (<= j1 2147483647)) (= x2 temp___150)))
