...
(declare-const p__result1 int__ref)
...
(assert (<= k1 10))
(assert (<= k2 x))
(assert (and (=> (<= 1 10) (in_range4 k2)) (and (<= 1 k2) (<= k2 10))))
(assert (=> (< k2 y) (not (< k2 z))))
(assert (=> (< k2 y) (= p__result1 (mk_int__ref p__result))))
(assert (=> (< k2 y) (= p__result2 p__result)))
(assert (=> (< k2 y) (= p__result3 p__result1)))
(assert (=> (< k2 y) (= p__result4 p__result2)))
(assert (=> (not (< k2 y)) (= p__result3 (mk_int__ref p__result))))
(assert (=> (not (< k2 y)) (= p__result4 p__result)))
(assert (not (= k2 10)))
(assert (= result2 (mk_int__ref k2)))
(assert (= k3 (+ k2 1)))
(assert (= p__result5 p__result3))
(assert (= k4 (mk_int__ref k3)))
(assert (= p__result6 p__result4))
(assert (= k5 k3))
(assert (not (<= (int__content k4) x)))
(check-sat)
(exit)
