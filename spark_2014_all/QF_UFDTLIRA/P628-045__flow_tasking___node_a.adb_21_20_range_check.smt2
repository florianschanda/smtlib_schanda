...
(define-fun dynamic_invariant ((temp___expr_318 Int) (temp___is_init_315 Bool) (temp___skip_constant_316 Bool) (temp___do_toplevel_317 Bool)) Bool (=> (or (= temp___is_init_315 true) (<= 0 97)) (in_range temp___expr_318)))
(assert (not (<= 0 97)))
(check-sat)
(exit)
