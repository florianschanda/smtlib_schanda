...
(assert (not (not (ite (<= b4 10000) (and (and (and (= temp___184 b4) (and (and (in_range1 b42) (<= b42 10000)) (and (and (and (= o (+ b42 1)) (in_range1 (+ b42 1))) (and (= result b42) (= b43 o))) (not (<= b43 10000))))) (and (= b43 b44) (= b45 b43))) (and (= b48 (mk_int__ref b44)) (= b47 b45))) (and (= b48 (mk_int__ref b4)) (= b47 b41))))))
(check-sat)
(exit)
