...
(assert (=> (<= b4 10000) (= temp___184 b4)))
(assert (=> (<= b4 10000) (and (in_range1 b42) (<= b42 10000))))
(assert (=> (<= b4 10000) (and (= o (+ b42 1)) (in_range1 (+ b42 1)))))
(assert (=> (<= b4 10000) (= result b42)))
(assert (=> (<= b4 10000) (= b43 o)))
(assert (=> (<= b4 10000) (not (<= b43 10000))))
(assert (=> (<= b4 10000) (= b43 b44)))
(assert (=> (<= b4 10000) (= b45 b43)))
(assert (=> (<= b4 10000) (= (mk_int__ref b46) (mk_int__ref b44))))
(assert (=> (<= b4 10000) (= b47 b45)))
(assert (=> (not (<= b4 10000)) (= (mk_int__ref b46) (mk_int__ref b4))))
(assert (=> (not (<= b4 10000)) (= b47 b41)))
(assert (not false))
(check-sat)
(exit)
