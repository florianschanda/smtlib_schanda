...
(assert (= x1 c))
(assert (in_range2 x1))
(assert (=> (= (of_int 1) true) (= temp___541 x1)))
(assert (=> (= (of_int 1) true) (=> (<= 0 2147483647) (in_range2 x2))))
(assert (=> (= (of_int 1) true) (and (= o (+ x2 1)) (in_range1 (+ x2 1)))))
(assert (=> (= (of_int 1) true) (= result1 x2)))
(assert (=> (= (of_int 1) true) (= x3 o)))
(assert (=> (= (of_int 1) true) (not (= (of_int 1) true))))
(assert (=> (= (of_int 1) true) (= x3 x4)))
(assert (=> (= (of_int 1) true) (= x5 x3)))
(assert (=> (= (of_int 1) true) (= (mk_int__ref x6) (mk_int__ref x4))))
(assert (=> (= (of_int 1) true) (= x7 x5)))
(assert (=> (not (= (of_int 1) true)) (= x1 x6)))
(assert (=> (not (= (of_int 1) true)) (= x7 x1)))
(assert (not false))
(check-sat)
(exit)
