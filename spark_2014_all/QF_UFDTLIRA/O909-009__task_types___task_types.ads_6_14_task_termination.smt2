...
(assert (not (not (and (in_range2 c) (and (and (= (mk_int__ref result) (mk_int__ref x)) (= x1 c)) (and (in_range2 x1) (ite (= (of_int 1) true) (and (and (and (= temp___547 x1) (and (=> (<= 0 2147483647) (in_range2 x2)) (and (and (and (= o (+ x2 1)) (in_range1 (+ x2 1))) (and (= result1 x2) (= x3 o))) (not (= (of_int 1) true))))) (and (= x3 x4) (= x5 x3))) (and (= (mk_int__ref x6) (mk_int__ref x4)) (= x7 x5))) (and (= x1 x6) (= x7 x1)))))))))
(check-sat)
(exit)
