...
(declare-datatypes () ((templatet__ref (mk_templatet__ref (templatet__content templatet)))))
(define-fun templatet__ref___projection ((a templatet__ref)) templatet (templatet__content a))
