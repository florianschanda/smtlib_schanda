...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 0)) (in_range1 temp___expr_158)))
(assert true)
...
(assert (not (= (oeq left1 right1) true)))
(check-sat)
(exit)
