...
(assert (= j28 1))
(assert (=> (and (<= 1 j28) (<= j28 10)) (and (and (= temp___177 j28) (and (= temp___176 prop__23) (and (= prop__24 true) (and (and (=> (<= 1 10) (in_range4 j29)) (and (<= 1 j29) (<= j29 10))) (and (and (= result13 (mk_bool__ref prop__24)) (= prop__25 (of_int 0))) (= j29 10)))))) (and (and (= j35 (mk_int__ref j29)) (= prop__30 (mk_bool__ref prop__25))) (and (= j36 j29) (= prop__31 prop__25))))))
(assert (=> (and (<= 1 j28) (<= j28 10)) (= j37 j35)))
(assert (=> (and (<= 1 j28) (<= j28 10)) (= prop__32 prop__30)))
(assert (=> (and (<= 1 j28) (<= j28 10)) (= j38 j36)))
(assert (=> (and (<= 1 j28) (<= j28 10)) (= prop__33 prop__31)))
(assert (=> (not (and (<= 1 j28) (<= j28 10))) (= j37 (mk_int__ref j28))))
(assert (=> (not (and (<= 1 j28) (<= j28 10))) (= prop__32 (mk_bool__ref prop__23))))
(assert (=> (not (and (<= 1 j28) (<= j28 10))) (= j38 j28)))
(assert (=> (not (and (<= 1 j28) (<= j28 10))) (= prop__33 prop__23)))
(assert true)
(assert (not true))
(check-sat)
(exit)
