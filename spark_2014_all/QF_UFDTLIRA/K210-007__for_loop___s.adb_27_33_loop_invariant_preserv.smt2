...
(assert (<= 1 index11))
(assert (<= index11 10))
(assert (= t11 (+ index12 1)))
(assert (and (and (=> (<= 1 10) (in_range3 index12)) (=> (<= (- 2147483648) 2147483647) (in_range1 t11))) (and (<= 1 index12) (<= index12 10))))
(assert (= t11 result6))
(assert (= t12 index12))
(assert (not (= index12 1)))
(assert (= result7 index12))
(assert (= index13 (- index12 1)))
(assert (= index13 index14))
(assert (= t12 t13))
(assert (= index15 index13))
(assert (= t14 t12))
(assert (not (= t13 (+ index14 1))))
(check-sat)
(exit)
