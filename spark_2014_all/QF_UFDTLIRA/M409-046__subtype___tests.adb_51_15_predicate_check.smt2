...
(define-fun dynamic_invariant1 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (and (=> (or (= temp___is_init_165 true) (<= 1 2147483647)) (in_range2 temp___expr_168)) (=> (= temp___do_toplevel_167 true) (=> (= temp___is_init_165 true) (and (<= 2 temp___expr_168) (<= temp___expr_168 2147483647))))))
...
(assert (in_range1 x))
(assert (= (= o true) (let ((temp___191 x)) (and (<= 2 temp___191) (<= temp___191 2147483647)))))
