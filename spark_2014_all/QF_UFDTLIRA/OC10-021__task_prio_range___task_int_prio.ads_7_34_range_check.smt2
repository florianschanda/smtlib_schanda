...
(define-fun dynamic_invariant ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 98)) (in_range1 temp___expr_153)))
(declare-const x Int)
(assert (not (<= 0 x)))
(check-sat)
(exit)
