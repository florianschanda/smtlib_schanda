...
(assert (<= 1 j28))
(assert (<= j28 10))
(assert (= prop__24 true))
(assert (and (=> (<= 1 10) (in_range4 j29)) (and (<= 1 j29) (<= j29 10))))
(assert (= result13 (mk_bool__ref prop__24)))
(assert (= prop__25 (of_int 0)))
(assert (not (= j29 10)))
(assert (= result14 (mk_int__ref j29)))
(assert (= j30 (+ j29 1)))
(assert (= j31 (mk_int__ref j30)))
(assert (= prop__26 (mk_bool__ref prop__25)))
(assert (= j32 j30))
(assert (= prop__27 prop__25))
(assert (not (= (bool__content prop__26) true)))
(check-sat)
(exit)
