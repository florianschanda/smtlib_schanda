...
(define-fun dynamic_invariant1 ((temp___expr_701 Int) (temp___is_init_697 Bool) (temp___skip_constant_698 Bool) (temp___do_toplevel_699 Bool) (temp___do_typ_inv_700 Bool)) Bool (=> (or (= temp___is_init_697 true) (<= 3 4)) (in_range1 temp___expr_701)))
(declare-const d Int)
