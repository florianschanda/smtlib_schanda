...
(declare-datatypes () ((wide_character__ref (mk_wide_character__ref (wide_character__content wide_character)))))
(define-fun wide_character__ref___projection ((a wide_character__ref)) wide_character (wide_character__content a))
(define-fun dynamic_invariant1 ((temp___expr_81 Int) (temp___is_init_77 Bool) (temp___skip_constant_78 Bool) (temp___do_toplevel_79 Bool) (temp___do_typ_inv_80 Bool)) Bool (=> (or (= temp___is_init_77 true) (<= 0 65535)) (in_range1 temp___expr_81)))
...
(declare-datatypes () ((wide_wide_character__ref (mk_wide_wide_character__ref (wide_wide_character__content wide_wide_character)))))
(define-fun wide_wide_character__ref___projection ((a wide_wide_character__ref)) wide_wide_character (wide_wide_character__content a))
(define-fun dynamic_invariant2 ((temp___expr_88 Int) (temp___is_init_84 Bool) (temp___skip_constant_85 Bool) (temp___do_toplevel_86 Bool) (temp___do_typ_inv_87 Bool)) Bool (=> (or (= temp___is_init_84 true) (<= 0 2147483647)) (in_range2 temp___expr_88)))
...
(assert (= chars__doit__result1 (ite (and (and (= z1 true) (= wz1 true)) (= wwz1 true)) true false)))
...
(assert (not (= (bool__content chars__doit__result4) true)))
(check-sat)
(exit)
