...
(define-fun dynamic_invariant1 ((temp___expr_69 Int) (temp___is_init_66 Bool) (temp___skip_constant_67 Bool) (temp___do_toplevel_68 Bool)) Bool (=> (or (= temp___is_init_66 true) (<= 0 65535)) (in_range1 temp___expr_69)))
...
(define-fun dynamic_invariant2 ((temp___expr_75 Int) (temp___is_init_72 Bool) (temp___skip_constant_73 Bool) (temp___do_toplevel_74 Bool)) Bool (=> (or (= temp___is_init_72 true) (<= 0 2147483647)) (in_range2 temp___expr_75)))
