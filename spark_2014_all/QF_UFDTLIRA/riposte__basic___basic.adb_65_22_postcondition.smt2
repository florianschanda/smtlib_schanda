...
(assert (in_range1 x))
(assert (and (< 0 x) (< x 10)))
(assert (and (and (= x x_old) (and (in_range1 x_old) (and (and (<= (+ x_old 3) x1) (<= x1 (+ x_old 3))) (and (=> (<= (- 2147483648) 2147483647) (in_range1 x1)) (and (and (= o4 (+ x1 3)) (in_range1 (+ x1 3))) (and (= x1 result1) (= x2 o4))))))) (and (= x2 x3) (= x4 x2))))
(assert (not (= x3 (+ x 5))))
(check-sat)
(exit)
