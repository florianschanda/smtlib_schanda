...
(assert (and (and (= r2 i2) (< (+ (+ r2 r2) 1) n)) (in_range1 r2)))
(assert (and (and (=> (<= 0 127) (in_range2 i2)) (=> (<= 0 255) (in_range1 r2))) (and (<= 0 i2) (<= i2 127))))
(assert (not (= i2 127)))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (= r2 result3))
(assert (= r3 i3))
(assert (not (not (not (= (+ r3 r3) n)))))
(assert (not (= (+ (+ r3 r3) 1) n)))
(assert (not (= r3 i3)))
(check-sat)
(exit)
