...
(declare-sort cardstatet 0)
(define-fun in_range2 ((x Int)) Bool (and (<= 0 x) (<= x 6)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq1 (cardstatet cardstatet) Bool)
(declare-const dummy1 cardstatet)
(declare-datatypes () ((cardstatet__ref (mk_cardstatet__ref (cardstatet__content cardstatet)))))
...
(assert (<= 0 cardstate))
(assert (<= cardstate 6))
(assert (not (in_range2 cardstate)))
(check-sat)
(exit)
