...
(define-fun dynamic_invariant ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 3 5)) (in_range2 temp___expr_141)))
(declare-const a Int)
...
(declare-const r Int)
(declare-const enums__next_a__result Int)
(declare-const o Int)
...
(declare-const enums__next_a__result1 Int)
(declare-const enums__next_a__result2 Int)
(declare-const enums__next_a__result3 Int)
(declare-const r3 Int)
(declare-const enums__next_a__result4 Int)
(declare-const r4 Int)
(declare-const enums__next_a__result5 Int)
(assert (in_range2 a))
