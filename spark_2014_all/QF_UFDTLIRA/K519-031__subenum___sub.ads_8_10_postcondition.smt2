...
(define-fun sub__remove_absent__result9 () int__ref (mk_int__ref sub__remove_absent__result5))
(declare-const result2 Int)
(assert (in_range1 x))
(assert (= sub__remove_absent__result9 (mk_int__ref sub__remove_absent__result3)))
(assert (= sub__remove_absent__result6 sub__remove_absent__result4))
(assert (=> (=> (not (= x 0)) (= x 1)) (= sub__remove_absent__result1 sub__remove_absent__result3)))
(assert (=> (=> (not (= x 0)) (= x 1)) (= sub__remove_absent__result4 sub__remove_absent__result1)))
(assert (=> (=> (not (= x 0)) (= x 1)) (= result sub__remove_absent__result)))
(assert (=> (=> (not (= x 0)) (= x 1)) (= sub__remove_absent__result1 1)))
(assert (=> (not (=> (not (= x 0)) (= x 1))) (= sub__remove_absent__result2 sub__remove_absent__result3)))
(assert (=> (not (=> (not (= x 0)) (= x 1))) (= sub__remove_absent__result4 sub__remove_absent__result2)))
(assert (=> (not (=> (not (= x 0)) (= x 1))) (= result1 sub__remove_absent__result)))
(assert (=> (not (=> (not (= x 0)) (= x 1))) (= sub__remove_absent__result2 2)))
(assert (= (mk_int__ref sub__remove_absent__result7) sub__remove_absent__result9))
(assert (= sub__remove_absent__result8 sub__remove_absent__result6))
(assert (= result2 sub__remove_absent__result7))
(assert (= x 2))
(assert (not (= sub__remove_absent__result7 2)))
(check-sat)
(exit)
