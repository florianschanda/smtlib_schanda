...
(define-fun dynamic_invariant1 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (and (=> (or (= temp___is_init_161 true) (<= 0 6)) (in_range2 temp___expr_165)) (=> (= temp___do_toplevel_163 true) (=> (= temp___is_init_161 true) (or (and (<= 1 temp___expr_165) (<= temp___expr_165 1)) (and (<= 3 temp___expr_165) (<= temp___expr_165 3)))))))
(define-fun dynamic_predicate ((temp___169 Int)) Bool (or (and (<= 1 temp___169) (<= temp___169 1)) (and (<= 3 temp___169) (<= temp___169 3))))
...
(assert (=> (= result1 true) (= temp___171 tmp2)))
