...
(define-fun dynamic_invariant1 ((temp___expr_712 Int) (temp___is_init_708 Bool) (temp___skip_constant_709 Bool) (temp___do_toplevel_710 Bool) (temp___do_typ_inv_711 Bool)) Bool (=> (or (= temp___is_init_708 true) (<= 3 4)) (in_range1 temp___expr_712)))
(declare-const d Int)
