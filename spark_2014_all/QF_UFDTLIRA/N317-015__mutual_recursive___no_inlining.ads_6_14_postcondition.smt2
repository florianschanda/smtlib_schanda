...
(assert (=> (= (of_int 0) true) (= result tmp)))
(assert (=> (= (of_int 0) true) (= tmp1 (of_int 1))))
(assert (=> (not (= (of_int 0) true)) (= o (recurse2 (of_int 1)))))
(assert (=> (not (= (of_int 0) true)) (= result1 tmp)))
(assert (=> (not (= (of_int 0) true)) (= tmp2 o)))
(assert (=> (not (= (of_int 0) true)) (= tmp1 tmp2)))
(assert (= result2 res))
(assert (= res1 tmp1))
(assert (= tmp3 tmp1))
(assert (= res1 res2))
