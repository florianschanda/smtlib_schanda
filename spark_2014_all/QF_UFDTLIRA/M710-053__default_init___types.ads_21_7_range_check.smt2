...
(declare-const temp___max_size_183 Int)
(declare-const temp___max_size_182 Int)
(assert (in_range temp___max_size_183))
(assert (in_range temp___max_size_182))
(assert (<= 1 temp___max_size_182))
(assert (not (<= 1 1)))
(check-sat)
(exit)
