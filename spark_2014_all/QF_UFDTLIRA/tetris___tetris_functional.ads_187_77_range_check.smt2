...
(define-fun dynamic_invariant1 ((temp___expr_671 Int) (temp___is_init_668 Bool) (temp___skip_constant_669 Bool) (temp___do_toplevel_670 Bool)) Bool (=> (or (= temp___is_init_668 true) (<= 3 4)) (in_range1 temp___expr_671)))
(declare-const d Int)
