...
(assert (not (= val__ 2147483647)))
(assert (and (= o2 (+ val__ 1)) (in_range (+ val__ 1))))
(assert (= result val__))
(assert (= val__1 o2))
(assert (= val__1 val__2))
(assert (= val__3 val__1))
(assert (= (> (+ val__ 1) 0) true))
(assert (not (in_range (+ val__ 1))))
(check-sat)
(exit)
