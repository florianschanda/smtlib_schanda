...
(assert (= j51 1))
(assert (=> (and (<= 1 j51) (<= j51 10)) (and (and (= temp___185 j51) (and (= temp___184 prop__46) (and (= prop__47 true) (and (and (=> (<= 1 10) (in_range6 j52)) (and (<= 1 j52) (<= j52 10))) (and (and (= result23 (mk_bool__ref prop__47)) (= prop__48 prop__47)) (= j52 10)))))) (and (and (= j58 (mk_int__ref j52)) (= prop__53 (mk_bool__ref prop__48))) (and (= j59 j52) (= prop__54 prop__48))))))
(assert (=> (and (<= 1 j51) (<= j51 10)) (= j60 j58)))
(assert (=> (and (<= 1 j51) (<= j51 10)) (= prop__55 prop__53)))
(assert (=> (and (<= 1 j51) (<= j51 10)) (= j61 j59)))
(assert (=> (and (<= 1 j51) (<= j51 10)) (= prop__56 prop__54)))
(assert (=> (not (and (<= 1 j51) (<= j51 10))) (= j60 (mk_int__ref j51))))
(assert (=> (not (and (<= 1 j51) (<= j51 10))) (= prop__55 (mk_bool__ref prop__46))))
(assert (=> (not (and (<= 1 j51) (<= j51 10))) (= j61 j51)))
(assert (=> (not (and (<= 1 j51) (<= j51 10))) (= prop__56 prop__46)))
(assert (not true))
(check-sat)
(exit)
