...
(assert (<= 1 j74))
(assert (<= j74 10))
(assert (=> (< 1 j75) (= prop__70 true)))
(assert (and (=> (<= 1 10) (in_range8 j75)) (and (<= 1 j75) (<= j75 10))))
(assert (= result33 (mk_bool__ref prop__70)))
(assert (= prop__71 prop__70))
(assert (not (= j75 10)))
(assert (= result34 (mk_int__ref j75)))
(assert (= j76 (+ j75 1)))
(assert (= j77 (mk_int__ref j76)))
(assert (= prop__72 (mk_bool__ref prop__71)))
(assert (= j78 j76))
(assert (= prop__73 prop__71))
(assert (< 1 (int__content j77)))
(assert (not (= (bool__content prop__72) true)))
(check-sat)
(exit)
