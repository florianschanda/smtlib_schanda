...
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 2)) (in_range2 temp___expr_136)))
...
(define-fun dynamic_invariant3 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 1)) (in_range3 temp___expr_142)))
(declare-const temp___z_186 Int)
(declare-const us Int)
(declare-const temp___z_185 Int)
...
(assert (<= temp___f_183 temp___l_184))
(assert (not (<= 1 temp___f_183)))
(check-sat)
(exit)
