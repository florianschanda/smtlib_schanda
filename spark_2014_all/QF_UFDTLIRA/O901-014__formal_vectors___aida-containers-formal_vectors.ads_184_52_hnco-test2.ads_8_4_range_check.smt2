...
(define-fun dynamic_invariant ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 2147483647)) (in_range1 temp___expr_207)))
...
(assert (not (in_range3 temp___capacity_944)))
(check-sat)
(exit)
