...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 127)) (and (and (= temp___176 i1) (and (= temp___175 r) (and (and (= (mk_int__ref result1) (mk_int__ref r)) (= r2 i1)) (or (and (and (and (= i1 i8) (= r2 r9)) (and (= i9 i1) (= r10 r2))) (=> (not (= (+ r2 r2) n)) (= (+ (+ r2 r2) 1) n))) (and (not (=> (not (= (+ r2 r2) n)) (= (+ (+ r2 r2) 1) n))) (and (and (and (= (mk_int__ref i8) (mk_int__ref i4)) (= (mk_int__ref r9) (mk_int__ref r5))) (and (= i9 i5) (= r10 r6))) (and (and (< (+ (+ r3 r3) 1) n) (in_range1 r3)) (and (and (and (=> (<= 0 255) (in_range1 r3)) (=> (<= 0 127) (in_range2 i2))) (and (<= 0 i2) (<= i2 127))) (or (and (and (and (= i2 i4) (= r3 r5)) (and (= i5 i2) (= r6 r3))) (= i2 127)) (and (not (= i2 127)) (and (and (and (= i3 i4) (= r4 r5)) (and (= i5 i3) (= r6 r4))) (and (and (= i2 result2) (= i3 (+ i2 1))) (and (and (= r3 result3) (= r4 i3)) (=> (not (= (+ r4 r4) n)) (= (+ (+ r4 r4) 1) n))))))))))))))) (and (and (= (mk_int__ref i10) (mk_int__ref i8)) (= (mk_int__ref r11) (mk_int__ref r9))) (and (= i11 i9) (= r12 r10))))))
...
(assert (= arithmetic__halve_b__result1 r13))
