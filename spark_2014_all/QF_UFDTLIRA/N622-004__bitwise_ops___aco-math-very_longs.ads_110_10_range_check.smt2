...
(define-fun dynamic_invariant ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range temp___expr_302)))
(declare-const temp___octet_length_1108 Int)
(assert (in_range temp___octet_length_1108))
(assert (<= 1 temp___octet_length_1108))
(assert (not (<= 1 1)))
(check-sat)
(exit)
