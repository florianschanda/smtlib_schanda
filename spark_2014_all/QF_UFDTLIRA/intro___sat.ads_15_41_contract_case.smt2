...
(assert (=> (not (< (+ x y) 10000)) (= o 10000)))
(assert (= result sat__add__result))
(assert (= sat__add__result1 o))
(assert (= (mk_int__ref sat__add__result4) (mk_int__ref sat__add__result2)))
(assert (= sat__add__result5 sat__add__result3))
(assert (= (< (+ x y) 10000) true))
(assert (not (= sat__add__result4 (+ x y))))
(check-sat)
(exit)
