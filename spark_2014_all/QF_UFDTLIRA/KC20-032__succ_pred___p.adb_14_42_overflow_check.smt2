...
(declare-const p__ident__result Int)
(declare-const o Int)
...
(declare-const p__ident__result1 Int)
(declare-const p__ident__result2 Int)
(declare-const p__ident__result3 Int)
(declare-const p__ident__result4 Int)
(declare-const p__ident__result5 Int)
(assert (in_range1 n))
(assert (not (= n 2147483647)))
(assert (not (not (= n 2147483647))))
(check-sat)
(exit)
