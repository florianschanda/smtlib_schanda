...
(define-fun prop__15 () bool__ref (mk_bool__ref prop__))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= temp___201 i2)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= temp___200 prop__)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= (mk_bool__ref result1) prop__15)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= prop__2 (distinct 0 0))))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= (mk_int__ref result2) j15)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= j3 1)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (=> (and (<= 1 j3) (<= j3 10)) (= temp___197 j3))))
(assert (=> (and (<= 1 i2) (<= i2 3)) (=> (and (<= 1 j3) (<= j3 10)) (= temp___196 prop__2))))
...
(assert (=> (not (and (<= 1 i2) (<= i2 3))) (= j12 j15)))
(assert (=> (not (and (<= 1 i2) (<= i2 3))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= 1 i2) (<= i2 3))) (= prop__12 prop__15)))
