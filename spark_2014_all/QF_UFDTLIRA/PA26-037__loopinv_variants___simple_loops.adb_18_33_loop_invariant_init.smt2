...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= temp___173 i2)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= temp___172 prop__)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= (mk_bool__ref result1) prop__15)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= prop__2 (of_int 0))))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= (mk_int__ref result2) j15)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= j3 1)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (=> (and (<= 1 j3) (<= j3 10)) (= temp___169 j3))))
(assert (=> (and (<= 1 i2) (<= i2 3)) (=> (and (<= 1 j3) (<= j3 10)) (= temp___168 prop__2))))
...
(assert (=> (and (<= 1 i2) (<= i2 3)) (=> (and (<= 1 j3) (<= j3 10)) (= prop__4 (of_int 1)))))
