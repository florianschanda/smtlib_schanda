...
(assert (in_range1 c))
(assert (not (<= 1 (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ (+ 0 (ite (= (= c 48) true) 1 0)) (ite (= (= c 49) true) 1 0)) (ite (= (= c 50) true) 1 0)) (ite (= (= c 51) true) 1 0)) (ite (= (= c 52) true) 1 0)) (ite (= (= c 53) true) 1 0)) (ite (= (= c 54) true) 1 0)) (ite (= (= c 55) true) 1 0)) (ite (= (= c 56) true) 1 0)) (ite (= (= c 57) true) 1 0)) (ite (= (> c 57) true) 1 0)) (ite (= (< c 48) true) 1 0)))))
(check-sat)
(exit)
