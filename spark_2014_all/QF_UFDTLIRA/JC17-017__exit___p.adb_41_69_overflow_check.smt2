...
(assert (= k12 1))
(assert (=> (and (<= 1 k12) (<= k12 10)) (and (and (= temp___135 k12) (and (<= k13 x) (and (and (=> (<= 1 10) (in_range3 k13)) (and (<= 1 k13) (<= k13 10))) (or (and (< k13 y) (and (< k13 z) (< z y))) (and (=> (< k13 y) (=> (< k13 z) (not (< z y)))) (= k13 10)))))) (and (= k13 k19) (= k20 k13)))))
(assert (=> (and (<= 1 k12) (<= k12 10)) (= (mk_int__ref k21) (mk_int__ref k19))))
(assert (=> (and (<= 1 k12) (<= k12 10)) (= k22 k20)))
(assert (=> (not (and (<= 1 k12) (<= k12 10))) (= k12 k21)))
