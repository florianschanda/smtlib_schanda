...
(assert (=> (ite (= in_0_rdy_v1 true) (not (= out_1_rdy_v1 true)) false) (= in_0_rdy_v12 (of_int 0))))
...
(assert (=> (ite (= in_0_rdy_v1 true) (not (= out_1_rdy_v1 true)) false) (= out_1_rdy_v12 (of_int 1))))
...
(assert (=> (ite (= in_1_rdy_v1 true) (not (= out_0_rdy_v1 true)) false) (= in_1_rdy_v12 (of_int 0))))
...
(assert (=> (ite (= in_1_rdy_v1 true) (not (= out_0_rdy_v1 true)) false) (= out_0_rdy_v12 (of_int 1))))
...
(assert (=> (ite (= in_0_rdy_v2 true) (not (= out_1_rdy_v2 true)) false) (= in_0_rdy_v22 (of_int 0))))
...
(assert (=> (ite (= in_0_rdy_v2 true) (not (= out_1_rdy_v2 true)) false) (= out_1_rdy_v22 (of_int 1))))
...
(assert (=> (ite (= in_1_rdy_v2 true) (not (= out_0_rdy_v2 true)) false) (= in_1_rdy_v22 (of_int 0))))
...
(assert (=> (ite (= in_1_rdy_v2 true) (not (= out_0_rdy_v2 true)) false) (= out_0_rdy_v22 (of_int 1))))
