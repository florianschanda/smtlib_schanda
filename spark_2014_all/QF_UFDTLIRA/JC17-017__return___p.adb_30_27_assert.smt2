...
(assert (= k1 1))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= temp___132 k1)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (<= k2 x)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (and (=> (<= 1 10) (in_range2 k2)) (and (<= 1 k2) (<= k2 10)))))
(assert (=> (and (<= 1 k1) (<= k1 10)) (not (< k2 y))))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= p__result2 p__result1)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (or (< k2 z) (and (not (< k2 z)) (= k2 10)))))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= p__result2 p__result3)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= k2 k3)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= p__result4 p__result2)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= k4 k2)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= (mk_int__ref p__result5) (mk_int__ref p__result3))))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= (mk_int__ref k5) (mk_int__ref k3))))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= p__result6 p__result4)))
(assert (=> (and (<= 1 k1) (<= k1 10)) (= k6 k4)))
(assert (=> (not (and (<= 1 k1) (<= k1 10))) (= p__result p__result5)))
(assert (=> (not (and (<= 1 k1) (<= k1 10))) (= k1 k5)))
(assert (=> (not (and (<= 1 k1) (<= k1 10))) (= p__result6 p__result)))
