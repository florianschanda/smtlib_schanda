...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (and (=> (or (= temp___is_init_156 true) (<= 1 2147483647)) (in_range2 temp___expr_159)) (=> (= temp___do_toplevel_158 true) (=> (= temp___is_init_156 true) (or (and (<= 1 temp___expr_159) (<= temp___expr_159 9)) (and (<= 21 temp___expr_159) (<= temp___expr_159 2147483647)))))))
(define-fun dynamic_predicate ((temp___163 Int)) Bool (or (and (<= 1 temp___163) (<= temp___163 9)) (and (<= 21 temp___163) (<= temp___163 2147483647))))
...
(assert (in_range1 x))
(assert (= (= o true) (let ((temp___188 x)) (or (and (<= 1 temp___188) (<= temp___188 9)) (and (<= 21 temp___188) (<= temp___188 2147483647))))))
(assert (= result (ite (in_range2 x) o false)))
(assert (= result true))
(define-fun temp___190 () Int x)
(assert (not (or (and (<= 1 temp___190) (<= temp___190 9)) (and (<= 21 temp___190) (<= temp___190 2147483647)))))
(check-sat)
(exit)
