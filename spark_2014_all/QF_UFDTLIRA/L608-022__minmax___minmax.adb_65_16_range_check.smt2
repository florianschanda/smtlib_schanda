...
(define-fun dynamic_invariant ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 1 127)) (in_range1 temp___expr_207)))
...
(assert (= mint2 o4))
(assert (and (= o5 (+ x y)) (in_range (+ x y))))
(assert (= o6 (ite (< o5 y) y o5)))
