...
(assert (= k3 1))
(assert (=> (and (<= 1 k3) (<= k3 10)) (and (and (= temp___132 k3) (and (<= k4 x) (and (and (=> (<= 1 10) (in_range2 k4)) (and (<= 1 k4) (<= k4 10))) (or (< k4 y) (and (not (< k4 y)) (or (< k4 z) (and (not (< k4 z)) (= k4 10)))))))) (and (= k4 k8) (= k9 k4)))))
