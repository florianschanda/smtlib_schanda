...
(define-fun j32 () int__ref (mk_int__ref j1))
(define-fun j33 () int__ref (mk_int__ref j))
(define-fun prop__31 () bool__ref (mk_bool__ref prop__))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i3 1))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= temp___201 i3)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= temp___200 prop__)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= (mk_bool__ref result1) prop__31)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= prop__2 (distinct 0 0))))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= (mk_int__ref result2) j33)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (= j5 1)))
(assert (=> (and (<= 1 i3) (<= i3 3)) (=> (and (<= 1 j5) (<= j5 10)) (= temp___197 j5))))
(assert (=> (and (<= 1 i3) (<= i3 3)) (=> (and (<= 1 j5) (<= j5 10)) (= temp___196 prop__2))))
...
(assert (=> (not (and (<= 1 i3) (<= i3 3))) (= j14 j33)))
(assert (=> (not (and (<= 1 i3) (<= i3 3))) (= i7 (mk_int__ref i3))))
(assert (=> (not (and (<= 1 i3) (<= i3 3))) (= prop__12 prop__31)))
...
(assert (= i9 1))
(assert (=> (and (<= 1 i9) (<= i9 3)) (= temp___209 i9)))
(assert (=> (and (<= 1 i9) (<= i9 3)) (= temp___208 (bool__content prop__12))))
(assert (=> (and (<= 1 i9) (<= i9 3)) (= result5 prop__12)))
(assert (=> (and (<= 1 i9) (<= i9 3)) (= prop__14 (distinct 1 0))))
(assert (=> (and (<= 1 i9) (<= i9 3)) (= result6 j32)))
(assert (=> (and (<= 1 i9) (<= i9 3)) (= j16 1)))
(assert (=> (and (<= 1 i9) (<= i9 3)) (=> (and (<= 1 j16) (<= j16 10)) (= temp___205 j16))))
(assert (=> (and (<= 1 i9) (<= i9 3)) (=> (and (<= 1 j16) (<= j16 10)) (= temp___204 prop__14))))
...
(assert (=> (not (and (<= 1 i9) (<= i9 3))) (= j25 j32)))
...
(assert (<= 1 j27))
(assert (<= j27 10))
(assert (= prop__27 true))
(assert (and (=> (<= 1 10) (in_range6 j28)) (and (<= 1 j28) (<= j28 10))))
(assert (= result11 (mk_bool__ref prop__27)))
(assert (= prop__28 prop__27))
(assert (not (= j28 10)))
(assert (= result12 (mk_int__ref j28)))
(assert (= j29 (+ j28 1)))
(assert (= j30 (mk_int__ref j29)))
(assert (= prop__29 (mk_bool__ref prop__28)))
(assert (= j31 j29))
(assert (= prop__30 prop__28))
(assert (not (= (bool__content prop__29) true)))
(check-sat)
(exit)
