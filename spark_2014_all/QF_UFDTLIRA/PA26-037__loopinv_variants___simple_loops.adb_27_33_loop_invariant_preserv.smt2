...
(assert (<= 1 i22))
(assert (<= i22 3))
(assert (= result21 prop__44))
(assert (= prop__46 (of_int 1)))
(assert (= result22 (mk_int__ref j2)))
(assert (= j51 1))
(assert (<= 1 j51))
(assert (<= j51 10))
(assert (= prop__47 true))
(assert (and (=> (<= 1 10) (in_range6 j52)) (and (<= 1 j52) (<= j52 10))))
(assert (= result23 (mk_bool__ref prop__47)))
(assert (= prop__48 prop__47))
(assert (not (= j52 10)))
(assert (= result24 (mk_int__ref j52)))
(assert (= j53 (+ j52 1)))
(assert (= j54 (mk_int__ref j53)))
(assert (= prop__49 (mk_bool__ref prop__48)))
(assert (= j55 j53))
(assert (= prop__50 prop__48))
(assert (not (= (bool__content prop__49) true)))
(check-sat)
(exit)
