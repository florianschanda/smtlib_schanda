...
(assert (= prop__2 (of_int 0)))
(assert (= (mk_int__ref result2) (mk_int__ref j)))
(assert (= j7 1))
(assert (=> (and (<= 1 j7) (<= j7 10)) (and (and (= temp___169 j7) (and (= temp___168 prop__2) (and (= prop__3 true) (and (and (=> (<= 1 10) (in_range2 j8)) (and (<= 1 j8) (<= j8 10))) (and (and (= prop__3 result3) (= prop__4 (of_int 1))) (= j8 10)))))) (and (and (= j8 j12) (= prop__4 prop__7)) (and (= j13 j8) (= prop__8 prop__4))))))
(assert (=> (and (<= 1 j7) (<= j7 10)) (= (mk_int__ref j14) (mk_int__ref j12))))
(assert (=> (and (<= 1 j7) (<= j7 10)) (= (mk_bool__ref prop__9) (mk_bool__ref prop__7))))
(assert (=> (and (<= 1 j7) (<= j7 10)) (= j15 j13)))
(assert (=> (and (<= 1 j7) (<= j7 10)) (= prop__10 prop__8)))
(assert (=> (not (and (<= 1 j7) (<= j7 10))) (= j7 j14)))
(assert (=> (not (and (<= 1 j7) (<= j7 10))) (= prop__2 prop__9)))
(assert (=> (not (and (<= 1 j7) (<= j7 10))) (= j15 j7)))
(assert (=> (not (and (<= 1 j7) (<= j7 10))) (= prop__10 prop__2)))
(assert (not true))
(check-sat)
(exit)
