...
(assert (in_range x))
(assert (and (or (and (and (= (mk_int__ref x3) (mk_int__ref x)) (= x4 x1)) (= x 0)) (and (not (= x 0)) (and (and (= x2 x3) (= x4 x2)) (and (=> (<= (- 2147483648) 2147483647) (in_range x)) (and (= result x) (= x2 0)))))) (and (= (mk_int__ref x5) (mk_int__ref x3)) (= x6 x4))))
(assert (not (= x5 0)))
(check-sat)
(exit)
