...
(define-fun dynamic_invariant1 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_135)))
...
(assert (< 0 global_var))
(assert (not (in_range1 (- 2147483647 global_var))))
(check-sat)
(exit)
