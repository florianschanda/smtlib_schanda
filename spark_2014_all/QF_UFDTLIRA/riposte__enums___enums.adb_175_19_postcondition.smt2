...
(assert (=> (= a 3) (= (mk_int__ref result) (mk_int__ref r))))
(assert (=> (= a 3) (= r1 4)))
(assert (=> (not (= a 3)) (=> (= a 4) (= (mk_int__ref result1) (mk_int__ref r)))))
(assert (=> (not (= a 3)) (=> (= a 4) (= r2 5))))
(assert (=> (not (= a 3)) (=> (not (= a 4)) (= (mk_int__ref result2) (mk_int__ref r)))))
...
(assert (< a 5))
(assert (not (= enums__next_b__result4 (+ a 1))))
(check-sat)
(exit)
