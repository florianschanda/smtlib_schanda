...
(assert (=> (= b true) (= result y)))
(assert (=> (= b true) (= y2 0)))
(assert (=> (= b true) (= result1 z)))
(assert (=> (= b true) (= z2 0)))
(assert (=> (not (= b true)) (= y2 y)))
(assert (=> (not (= b true)) (= z2 z)))
(assert (=> (not (= b true)) (= y2 y1)))
(assert (=> (not (= b true)) (= z2 z1)))
(assert (= result2 y2))
(assert (= y3 0))
(assert (not (in_range (+ z2 y3))))
(check-sat)
(exit)
