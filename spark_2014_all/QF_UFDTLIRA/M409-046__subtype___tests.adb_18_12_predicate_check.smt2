...
(define-fun dynamic_invariant ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (and (=> (or (= temp___is_init_156 true) (<= 1 2147483647)) (in_range temp___expr_159)) (=> (= temp___do_toplevel_158 true) (=> (= temp___is_init_156 true) (or (and (<= 1 temp___expr_159) (<= temp___expr_159 9)) (and (<= 21 temp___expr_159) (<= temp___expr_159 2147483647)))))))
...
(assert (not (= v 15)))
(assert (not (or (and (<= 1 10) (<= 10 9)) (and (<= 21 10) (<= 10 2147483647)))))
(check-sat)
(exit)
