...
(define-fun dynamic_invariant ((temp___expr_517 Int) (temp___is_init_514 Bool) (temp___skip_constant_515 Bool) (temp___do_toplevel_516 Bool)) Bool (=> (or (= temp___is_init_514 true) (<= 0 6)) (in_range temp___expr_517)))
(declare-const day Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const o Int)
(assert (in_range day))
(assert (not (= day 6)))
(assert (not (not (= day 6))))
(check-sat)
(exit)
