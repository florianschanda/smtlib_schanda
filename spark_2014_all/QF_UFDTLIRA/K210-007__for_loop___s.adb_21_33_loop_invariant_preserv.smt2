...
(assert (<= index2 10))
(assert (= t2 (- index3 1)))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 t2)) (=> (<= 1 10) (in_range2 index3))) (and (<= 1 index3) (<= index3 10))))
(assert (= t2 result2))
(assert (= t3 index3))
(assert (not (= index3 10)))
(assert (= result3 index3))
(assert (= index4 (+ index3 1)))
(assert (not (= t3 (- index4 1))))
(check-sat)
(exit)
