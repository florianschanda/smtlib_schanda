...
(define-fun dynamic_invariant ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 2147483647)) (in_range1 temp___expr_159)))
...
(assert (in_range1 e2))
(assert (< 0 e1))
(assert (not (in_range (- 2147483647 e1))))
(check-sat)
(exit)
