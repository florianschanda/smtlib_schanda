...
(assert (= j74 1))
(assert (=> (and (<= 1 j74) (<= j74 10)) (and (and (= temp___193 j74) (and (= temp___192 prop__69) (and (=> (< 1 j75) (= prop__70 true)) (and (and (=> (<= 1 10) (in_range8 j75)) (and (<= 1 j75) (<= j75 10))) (and (and (= result33 (mk_bool__ref prop__70)) (= prop__71 prop__70)) (= j75 10)))))) (and (and (= j81 (mk_int__ref j75)) (= prop__76 (mk_bool__ref prop__71))) (and (= j82 j75) (= prop__77 prop__71))))))
(assert (=> (and (<= 1 j74) (<= j74 10)) (= j83 j81)))
(assert (=> (and (<= 1 j74) (<= j74 10)) (= prop__78 prop__76)))
(assert (=> (and (<= 1 j74) (<= j74 10)) (= j84 j82)))
(assert (=> (and (<= 1 j74) (<= j74 10)) (= prop__79 prop__77)))
(assert (=> (not (and (<= 1 j74) (<= j74 10))) (= j83 (mk_int__ref j74))))
(assert (=> (not (and (<= 1 j74) (<= j74 10))) (= prop__78 (mk_bool__ref prop__69))))
(assert (=> (not (and (<= 1 j74) (<= j74 10))) (= j84 j74)))
(assert (=> (not (and (<= 1 j74) (<= j74 10))) (= prop__79 prop__69)))
(assert true)
(assert (not true))
(check-sat)
(exit)
