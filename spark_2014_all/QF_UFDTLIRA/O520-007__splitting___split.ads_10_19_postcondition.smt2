...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 5)) (and (and (= temp___132 j1) (and (and (and (<= 1 u) (<= u 20)) (and (<= 1 v) (<= v 20))) (and (and (=> (<= 1 5) (in_range2 j2)) (and (<= 1 j2) (<= j2 5))) (= j2 5)))) (and (= j2 j6) (= j7 j2)))))
(assert (=> (and (<= 1 j1) (<= j1 5)) (= (mk_int__ref j8) (mk_int__ref j6))))
(assert (=> (and (<= 1 j1) (<= j1 5)) (= j9 j7)))
(assert (=> (not (and (<= 1 j1) (<= j1 5))) (= j1 j8)))
(assert (=> (not (and (<= 1 j1) (<= j1 5))) (= j9 j1)))
(assert (= j10 j8))
(assert (= j11 j9))
(assert (not (<= 1 u)))
(check-sat)
