...
(assert (=> (not (= (ite (= a true) b false) true)) (=> (and (not (= a true)) (not (= b true))) (= r2 (of_int 0)))))
(assert (=> (not (= (ite (= a true) b false) true)) (=> (not (and (not (= a true)) (not (= b true)))) (=> (ite (= a true) (not (= b true)) false) (= result2 r)))))
(assert (=> (not (= (ite (= a true) b false) true)) (=> (not (and (not (= a true)) (not (= b true)))) (=> (ite (= a true) (not (= b true)) false) (= r3 (of_int 1))))))
(assert (=> (not (= (ite (= a true) b false) true)) (=> (not (and (not (= a true)) (not (= b true)))) (=> (not (ite (= a true) (not (= b true)) false)) (= result3 r)))))
(assert (=> (not (= (ite (= a true) b false) true)) (=> (not (and (not (= a true)) (not (= b true)))) (=> (not (ite (= a true) (not (= b true)) false)) (= r4 (of_int 1))))))
...
(assert (not (ite (= (ite (= (= (to_int1 logic__xor_test_a__result4) (to_int1 a)) false) b true) true) (ite (= (ite (= (= (to_int1 logic__xor_test_a__result4) (to_int1 a)) true) b false) false) true true) true)))
(check-sat)
(exit)
