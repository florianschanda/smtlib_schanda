...
(assert (=> (and (<= 3 i) (<= i 5)) (= (mk_bool__ref result) (mk_bool__ref success))))
(assert (=> (and (<= 3 i) (<= i 5)) (= success1 (of_int 1))))
(assert (=> (and (<= 3 i) (<= i 5)) (and (= o i) (in_range2 i))))
(assert (=> (and (<= 3 i) (<= i 5)) (and (= o1 o) (in_range3 o))))
(assert (=> (and (<= 3 i) (<= i 5)) (= (mk_int__ref result1) (mk_int__ref result__))))
(assert (=> (and (<= 3 i) (<= i 5)) (= result__1 o1)))
(assert (=> (not (and (<= 3 i) (<= i 5))) (= (mk_bool__ref result2) (mk_bool__ref success))))
(assert (=> (not (and (<= 3 i) (<= i 5))) (= success2 (of_int 0))))
(assert (=> (not (and (<= 3 i) (<= i 5))) (= (mk_int__ref result3) (mk_int__ref result__))))
