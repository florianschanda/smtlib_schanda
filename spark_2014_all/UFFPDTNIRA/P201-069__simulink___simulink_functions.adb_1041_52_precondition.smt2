...
(declare-fun arcsin (Float64) Float64)
(declare-fun arcsin__function_guard (Float64 Float64) Bool)
(assert (forall ((x Float64)) (! (=> (and (dynamic_invariant x true true true true) (fp.leq (fp.abs x) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (let ((result (arcsin x))) (and (=> (fp.eq x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((arcsin x)))))
(declare-const lf Float64)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (fp.isFinite64 lf))
(assert (not (fp.leq (fp.abs lf) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
