...
(assert (and (= o4 (odivide (fp #b0 #b01111111 #b00000000000000000000000) o3)) (and (fp.isFinite32 o4) (= o4 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) o3)))))
(assert (= result7 x41))
(assert (= x42 o4))
(assert (not (not (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)))))
(check-sat)
(exit)
