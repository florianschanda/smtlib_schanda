...
(assert (forall ((x Float64)) (! (=> (and (dynamic_invariant x true true true true) (fp.lt (fp.abs x) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (let ((result (arctanh x))) (and (=> (fp.eq x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((arctanh x)))))
(declare-const lf Float64)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (fp.isFinite64 lf))
(assert (not (fp.lt (fp.abs lf) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(check-sat)
(exit)
