...
(assert (and (= o2 (pow9 x)) (and (fp.isFinite32 o2) (= o2 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x) x) x) x)))))
(assert (= o3 (fp.mul RNE (fp #b0 #b10000100 #b11110000000000000000000) o2)))
(assert (and (= o4 o3) (fp.isFinite32 o3)))
(assert (= o5 (fp.div RNE o4 (fp #b0 #b10001010 #b01100010011000000000000))))
...
(assert (= o1 (fp.mul RNE (fp #b0 #b10000011 #b00010000000000000000000) o)))
