...
(assert (= result__1 o1))
(assert (fp.leq right (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (fp.leq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (not (fp.isFinite64 (fp.sub RNE result__1 (fp #b0 #b10000000000 #b1001001000011111101101010100010001000010110100011000)))))
(check-sat)
(exit)
