...
(assert (and (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) test_dynamic_property__nested__dyn_param__x1) (dynamic_property1 (fp #b0 #b00000000 #b00000000000000000000000) last1 test_dynamic_property__nested__dyn_param__x1)))
(assert (and (= us4 test_dynamic_property__nested__dyn_param__x1) (dynamic_property (fp #b0 #b01111111 #b00000000000000000000000) last test_dynamic_property__nested__dyn_param__x1)))
(assert (= o5 test_dynamic_property__nested__dyn_param__x1))
(assert (= result3 x3))
(assert (= x4 o5))
(assert (not (fp.leq x4 c)))
(check-sat)
(exit)
