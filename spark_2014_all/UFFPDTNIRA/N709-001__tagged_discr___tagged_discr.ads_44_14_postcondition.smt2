...
(assert (forall ((v us_rep1)) (! (= (= (is_zero__2 v) true) (and (and (not (= (rec__tagged_discr__t__z1 (us_split_fields3 v)) true)) (ite (or (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 v))) 0) (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 v))) 2)) (= (to_rep1 (rec__tagged_discr__t__x1 (us_split_fields3 v))) 0) (fp.eq (to_rep (rec__tagged_discr__t__y1 (us_split_fields3 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) (= (to_rep1 (rec__tagged_discr__u1__w (us_split_fields3 v))) 0))) :pattern ((is_zero__2 v)))))
...
(declare-const result17 integer)
(declare-const result18 float)
(declare-const result19 us_private)
(declare-const v__split_fields20 integer)
(declare-const v__split_fields21 Bool)
(declare-const v__split_fields22 integer)
(declare-const v__split_fields23 float)
(declare-const v__split_fields24 us_private)
(declare-const v__split_fields25 integer)
(declare-const v__split_fields26 Bool)
(declare-const v__split_fields27 integer)
(declare-const v__split_fields28 float)
(declare-const v__split_fields29 us_private)
(declare-const v__split_fields30 integer)
...
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields5 v__split_fields10)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields6 v__split_fields11)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= rliteral v__split_fields12)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields8 v__split_fields13)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields9 v__split_fields14)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= (to_rep o) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields5 o1)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields6 o2)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields7 o3)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= o o4)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields9 o5)))
...
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2491 o1)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2492 o2)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2493 o3)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2494 o4)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2495 o5)))
...
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2491 v__split_fields15)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2492 v__split_fields16)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2493 v__split_fields17)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2494 v__split_fields18)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2495 v__split_fields19)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_discrs (mk___split_discrs temp___249))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= (mk___split_fields1 v__split_fields10 v__split_fields11 v__split_fields12 v__split_fields13 v__split_fields14) (mk___split_fields1 v__split_fields15 v__split_fields16 v__split_fields17 v__split_fields18 v__split_fields19))))
(assert (= result15 v__split_fields10))
(assert (= result16 v__split_fields11))
(assert (= result17 v__split_fields12))
(assert (= result18 v__split_fields13))
(assert (= result19 v__split_fields14))
(assert (= rliteral v__split_fields20))
(assert (= v__split_fields11 v__split_fields21))
(assert (= v__split_fields12 v__split_fields22))
(assert (= v__split_fields13 v__split_fields23))
(assert (= v__split_fields14 v__split_fields24))
(assert (= v__split_fields25 v__split_fields20))
(assert (= v__split_fields26 v__split_fields21))
(assert (= v__split_fields27 v__split_fields22))
(assert (= v__split_fields28 v__split_fields23))
(assert (= v__split_fields29 v__split_fields24))
(assert (= v__split_fields30 v__split_fields20))
(assert (= v__split_fields31 v__split_fields21))
(assert (= v__split_fields32 v__split_fields22))
(assert (= v__split_fields33 v__split_fields23))
(assert (= v__split_fields34 v__split_fields24))
(assert (not (= (is_zero__2 (mk___rep1 v__split_discrs (mk___split_fields1 v__split_fields25 v__split_fields26 v__split_fields27 v__split_fields28 v__split_fields29) v__attr__tag)) true)))
(check-sat)
(exit)
