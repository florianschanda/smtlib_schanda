...
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_discrs (mk___split_discrs temp___220))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= (mk___split_fields1 v__split_fields10 v__split_fields11 v__split_fields12 v__split_fields13 v__split_fields14) v__split_fields15)))
(assert (= (to_rep o12) 0))
(assert (= o12 o13))
...
(assert (= result15 (mk___split_fields__ref1 (mk___split_fields1 v__split_fields10 v__split_fields11 v__split_fields12 v__split_fields13 v__split_fields14))))
