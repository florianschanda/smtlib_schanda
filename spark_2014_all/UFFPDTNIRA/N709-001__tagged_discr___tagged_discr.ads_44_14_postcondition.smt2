...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 a))) (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 b)))) (= (rec__tagged_discr__t__z (us_split_fields1 a)) (rec__tagged_discr__t__z (us_split_fields1 b)))) (=> (tagged_discr__t__x__pred a) (= (to_rep (rec__tagged_discr__t__x (us_split_fields1 a))) (to_rep (rec__tagged_discr__t__x (us_split_fields1 b)))))) (=> (tagged_discr__t__y__pred a) (= (to_rep1 (rec__tagged_discr__t__y (us_split_fields1 a))) (to_rep1 (rec__tagged_discr__t__y (us_split_fields1 b)))))) true false))
...
(assert true)
(assert true)
(assert (forall ((v us_rep1)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero__21 us_tag1 v))) :pattern ((is_zero__21 us_tag1 v)))))
(assert (forall ((v us_rep1)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero__21 us_tag2 v))) :pattern ((is_zero__21 us_tag2 v)))))
...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 3)) (in_range2 temp___expr_135)))
...
(declare-const temp___218 e)
(declare-const temp___2181 integer)
(declare-const temp___2182 Bool)
(declare-const temp___2183 integer)
(declare-const temp___2184 float)
(declare-const temp___2185 us_private)
...
(declare-const temp___220 e)
(declare-const temp___2201 integer)
(declare-const temp___2202 Bool)
(declare-const temp___2203 integer)
(declare-const temp___2204 float)
(declare-const temp___2205 us_private)
...
(declare-const temp___222 e)
(declare-const temp___2221 integer)
(declare-const temp___2222 Bool)
(declare-const temp___2223 integer)
(declare-const temp___2224 float)
(declare-const temp___2225 us_private)
...
(declare-const result13 float)
(declare-const result14 us_private)
(declare-const v__split_fields15 us_split_fields2)
(declare-const result15 us_split_fields__ref1)
(declare-const v__split_fields16 us_split_fields2)
(declare-const v__split_fields17 us_split_fields__ref1)
(declare-const v__split_fields18 us_split_fields2)
(define-fun v__split_fields19 () us_split_fields2 (mk___split_fields1 v__split_fields10 v__split_fields11 v__split_fields12 v__split_fields13 v__split_fields14))
...
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= (to_rep o) 0)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields5 o1)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields6 o2)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= o o3)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields8 o4)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_fields9 o5)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_discrs (mk___split_discrs temp___218))))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2181 o1)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2182 o2)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2183 o3)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2184 o4)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2185 o5)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__attr__tag temp___2186)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= result5 v__split_fields5)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= result6 v__split_fields6)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= result7 v__split_fields7)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= result8 v__split_fields8)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= result9 v__split_fields9)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2181 v__split_fields10)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2182 v__split_fields11)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2183 v__split_fields12)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2184 v__split_fields13)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= temp___2185 v__split_fields14)))
(assert (=> (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)) (= v__split_discrs (mk___split_discrs temp___218))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= (to_rep1 o6) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields5 o7)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields6 o8)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields7 o9)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= o6 o10)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields9 o11)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_discrs (mk___split_discrs temp___220))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2201 o7)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2202 o8)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2203 o9)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2204 o10)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= temp___2205 o11)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__attr__tag temp___2206)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= result10 v__split_fields5)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= result11 v__split_fields6)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= result12 v__split_fields7)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= result13 v__split_fields8)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= result14 v__split_fields9)))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields15 (mk___split_fields1 temp___2201 temp___2202 temp___2203 temp___2204 temp___2205))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_discrs (mk___split_discrs temp___220))))
(assert (=> (not (=> (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)) (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2))) (= v__split_fields19 v__split_fields15)))
(assert (= (to_rep o12) 0))
(assert (= o12 o13))
...
(assert (= v__split_fields16 (mk___split_fields1 temp___2221 temp___2222 temp___2223 temp___2224 temp___2225)))
(assert (= v__split_discrs (mk___split_discrs temp___222)))
(assert (= v__split_fields17 (mk___split_fields__ref1 v__split_fields16)))
(assert (= v__split_fields18 v__split_fields16))
(assert (not (= (is_zero__2 (mk___rep1 v__split_discrs (us_split_fields__content1 v__split_fields17) v__attr__tag)) true)))
(check-sat)
(exit)
