...
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant x1 true true true true) (dynamic_invariant (r1 x1) true false true true)) :pattern ((r1 x1)))))
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant x1 true true true true) (= (r1 x1) (fp.roundToIntegral RTN x1))) :pattern ((r1 x1)))))
