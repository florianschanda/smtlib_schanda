...
(assert (forall ((left Float64) (right Float64)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (dynamic_invariant (pow__2 left right) true false true)) :pattern ((pow__2 left right)))))
...
(define-fun dynamic_invariant1 ((temp___expr_213 Float64) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (in_range temp___expr_213)))
