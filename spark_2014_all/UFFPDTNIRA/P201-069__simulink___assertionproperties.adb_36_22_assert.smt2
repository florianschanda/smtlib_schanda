...
(assert (forall ((left Float64) (right Float64)) (! (=> (and (dynamic_invariant left true true true true) (dynamic_invariant right true true true true)) (dynamic_invariant (pow__2 left right) true false true true)) :pattern ((pow__2 left right)))))
(declare-sort long_float_m0_0_minf 0)
(define-fun in_range ((x Float64)) Bool (and (fp.isFinite64 x) (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.leq x (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)))))
...
(declare-datatypes () ((long_float_m0_0_minf__ref (mk_long_float_m0_0_minf__ref (long_float_m0_0_minf__content long_float_m0_0_minf)))))
(define-fun long_float_m0_0_minf__ref___projection ((a long_float_m0_0_minf__ref)) long_float_m0_0_minf (long_float_m0_0_minf__content a))
(define-fun dynamic_invariant1 ((temp___expr_249 Float64) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (in_range temp___expr_249)))
...
(assert (not (fp.eq x (fp #b0 #b10000000011 #b0000000000000000000000000000000000000000000000000000))))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp.isFinite64 sqrt_out1)))
(assert (and (= o (pow__2 x (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000))) (fp.isFinite64 o)))
(assert (= result sqrt_out1))
(assert (= sqrt_out11 o))
(assert (= result1 y))
(assert (= y1 sqrt_out11))
(assert (not (not (fp.eq x (fp #b0 #b10000000011 #b0000000000000000000000000000000000000000000000000000)))))
(check-sat)
(exit)
