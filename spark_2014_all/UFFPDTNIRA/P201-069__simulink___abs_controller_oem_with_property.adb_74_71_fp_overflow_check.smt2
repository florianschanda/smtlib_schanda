...
(assert (and (= o3 (fp.sub RNE (fp #b0 #b01111111100 #b1001100110011001100110011001100110011001100110011010) diff_out11)) (fp.isFinite64 (fp.sub RNE (fp #b0 #b01111111100 #b1001100110011001100110011001100110011001100110011010) diff_out11))))
(assert (= result3 difference_out1))
(assert (= difference_out11 o3))
(assert (and (= o4 (boolean_to_long_float (ite (fp.lt difference_out11 (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) true false))) (fp.isFinite64 o4)))
(assert (and (= o5 (boolean_to_long_float (ite (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) difference_out11) true false))) (fp.isFinite64 o5)))
(assert (= o6 (fp.sub RNE o5 o4)))
(assert (not (fp.isFinite64 o6)))
(check-sat)
(exit)
