...
(define-fun in_range ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp.neg (fp #b0 #b10000011 #b01000000000000000000000)) x) (fp.leq x (fp.neg (fp #b0 #b10000010 #b01000000000000000000000))))))
(declare-fun user_eq (range_b range_b) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE (Float32) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE (us_image) Float32)
(declare-const dummy range_b)
(declare-datatypes () ((range_b__ref (mk_range_b__ref (range_b__content range_b)))))
(define-fun range_b__ref___projection ((a range_b__ref)) range_b (range_b__content a))
(define-fun dynamic_invariant ((temp___expr_141 Float32) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (fp.leq (fp.neg (fp #b0 #b10000011 #b01000000000000000000000)) (fp.neg (fp #b0 #b10000010 #b01000000000000000000000)))) (in_range temp___expr_141)))
(declare-fun to_rep (range_b) Float32)
(declare-fun of_rep (Float32) range_b)
(assert (forall ((x range_b)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x range_b)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Float32)) (! (=> (in_range x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const b Float32)
(declare-const o Float32)
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000011 #b01000000000000000000000)) (fp.neg (fp #b0 #b10000010 #b01000000000000000000000))) (in_range b)))
(assert (not (in_range (fp #b0 #b10000011 #b01000000000000000000000))))
(check-sat)
(exit)
