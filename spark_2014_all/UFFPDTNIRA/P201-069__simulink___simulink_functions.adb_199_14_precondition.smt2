...
(declare-fun log (Float64) Float64)
(declare-fun log__function_guard (Float64 Float64) Bool)
(assert (forall ((x Float64)) (! (=> (and (dynamic_invariant x true true true true) (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x)) (let ((result (log x))) (and (=> (fp.eq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((log x)))))
(declare-const f Float64)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (fp.isFinite64 f))
(assert (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) f)))
(check-sat)
(exit)
