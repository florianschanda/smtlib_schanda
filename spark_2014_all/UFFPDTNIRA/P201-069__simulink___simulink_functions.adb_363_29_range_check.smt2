...
(assert (forall ((i tinteger_8B)) (and (<= (- 128) (tinteger_8Bqtint i)) (<= (tinteger_8Bqtint i) 127))))
...
(assert (forall ((i integer_8)) (and (<= (- 128) (integer_8qtint i)) (<= (integer_8qtint i) 127))))
...
(assert (not (= right 0)))
(assert (and (= o (fp.div RNE (of_int RNE left) (of_int RNE right))) (fp.isFinite32 (fp.div RNE (of_int RNE left) (of_int RNE right)))))
