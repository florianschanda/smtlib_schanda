...
(assert (forall ((x1 Float32)) (! (=> (and (dynamic_invariant1 x1 true true true true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x1)) (let ((result (r3 x1))) (and (and (fp.leq result x1) (fp.leq (fp.sub RNE x1 (fp #b0 #b01111111 #b00000000000000000000000)) result)) (dynamic_invariant1 result true false true true)))) :pattern ((r3 x1)))))
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true true) (= (r3 x1) (fp.roundToIntegral RTN x1))) :pattern ((r3 x1)))))
...
(assert (in_range x))
(assert (and (= o (r3 (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (and (in_range2 o) (and (= o (fp.roundToIntegral RTN (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (and (fp.leq o (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000))) (fp.leq (fp.sub RNE (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)) (fp #b0 #b01111111 #b00000000000000000000000)) o))))))
