...
(assert (and (= o2 (fib o1)) (and (in_range2 o2) (and (= o2 (ite (or (= o1 0) (= o1 1)) o1 (+ (fib (- o1 1)) (fib (- o1 2))))) (fp.lt (of_int1 RNE o2) (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) o1) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (= o3 (ite (= oldest3 o2) true false)))
(assert (not (in_range4 (- i3 1))))
(check-sat)
(exit)
