...
(assert (and (and (and (and (=> (<= 2 n) (dynamic_property 2 n i2)) (=> (<= 1 2147483647) (in_range3 old__2))) (=> (<= 0 2147483647) (in_range2 oldest2))) (=> (<= 0 2147483647) (in_range2 temp1))) (and (<= 2 i2) (<= i2 n))))
(assert (and (= o (- i2 2)) (in_range4 (- i2 2))))
(assert (and (= o1 (fib o)) (and (in_range2 o1) (and (= o1 (ite (or (= o 0) (= o 1)) o (+ (fib (- o 1)) (fib (- o 2))))) (fp.lt (of_int1 RNE o1) (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) o) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (= o2 (ite (= oldest2 o1) true false)))
(assert (not (in_range4 (- i2 1))))
(check-sat)
(exit)
