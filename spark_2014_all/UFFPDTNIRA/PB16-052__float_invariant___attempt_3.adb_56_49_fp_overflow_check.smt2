...
(assert (and (= o6 (high_bound n)) (and (fp.isFinite64 o6) (= o6 (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (= o7 (fp.add RNE o6 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 o7)))
(check-sat)
(exit)
