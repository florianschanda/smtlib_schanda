...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 14)) (in_range temp___expr_141)))
(declare-sort u 0)
...
(define-fun dynamic_invariant2 ((temp___expr_147 Float32) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b11000000000000000000000))) (in_range1 temp___expr_147)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (let ((result (a x))) (and (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) result) (fp.leq result (fp #b0 #b10000010 #b11000000000000000000000))) (dynamic_invariant result true false true)))) :pattern ((a x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (a x) (c x))) :pattern ((a x)))))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true) (dynamic_invariant (c x) true false true)) :pattern ((c x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true) (= (c x) (of_int RNE x))) :pattern ((c x)))))
...
(assert (not (fp.leq (a x1) (fp #b0 #b10000010 #b11000000000000000000000))))
(check-sat)
(exit)
