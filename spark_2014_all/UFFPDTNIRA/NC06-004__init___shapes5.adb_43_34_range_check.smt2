...
(assert (and (= o (fp.abs (fp.sub RNE x (to_rep (rec__shapes5__circle__center_x (us_split_fields1 c)))))) (fp.isFinite64 (fp.abs (fp.sub RNE x (to_rep (rec__shapes5__circle__center_x (us_split_fields1 c))))))))
(assert (= result delta_x))
(assert (= delta_x1 o))
(assert (not (in_range3 (fp.abs (fp.sub RNE y (to_rep (rec__shapes5__circle__center_y (us_split_fields1 c))))))))
(check-sat)
(exit)
