...
(define-fun shapes5__make_circle__result12 () us_rep (mk___rep (mk___split_fields shapes5__make_circle__result3 shapes5__make_circle__result4 shapes5__make_circle__result5)))
(assert (in_range2 x))
(assert (in_range2 y))
...
(assert (=> (fp.leq (fp.sub RNE y (fp.neg (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000))) r4) (and (= o3 (fp.sub RNE y (fp.neg (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000)))) (fp.isFinite64 (fp.sub RNE y (fp.neg (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000)))))))
(assert (=> (fp.leq (fp.sub RNE y (fp.neg (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000))) r4) (= result4 r4)))
(assert (=> (fp.leq (fp.sub RNE y (fp.neg (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000))) r4) (= r5 o3)))
(assert (=> (not (fp.leq (fp.sub RNE y (fp.neg (fp #b0 #b10000000101 #b1001000000000000000000000000000000000000000000000000))) r4)) (= r5 r4)))
...
(assert (= shapes5__make_circle__result12 (mk___rep (mk___split_fields o10 o11 o12))))
(assert (= shapes5__make_circle__result10 (mk_circle__ref (mk___rep (mk___split_fields shapes5__make_circle__result6 shapes5__make_circle__result7 shapes5__make_circle__result8)))))
(assert (= r6 (mk_t__ref r5)))
(assert (= shapes5__make_circle__result11 shapes5__make_circle__result9))
(assert (= r7 r5))
(assert (not (in_range2 (fp.add RNE (to_rep (rec__shapes5__circle__center_x (us_split_fields1 (circle__content shapes5__make_circle__result10)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result10))))))))
(check-sat)
(exit)
