...
(assert (forall ((i t_int16)) (and (<= (- 32768) (t_int16qtint i)) (<= (t_int16qtint i) 32767))))
...
(declare-datatypes () ((t_int16__ref (mk_t_int16__ref (t_int16__content t_int16)))))
(define-fun t_int16__ref___projection ((a t_int16__ref)) t_int16 (t_int16__content a))
(declare-const value Float32)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_1438 Int) (temp___is_init_1434 Bool) (temp___skip_constant_1435 Bool) (temp___do_toplevel_1436 Bool) (temp___do_typ_inv_1437 Bool)) Bool (=> (or (= temp___is_init_1434 true) (<= (- 32768) 32767)) (in_range temp___expr_1438)))
(assert (fp.isFinite32 value))
(assert (not (fp.lt (fp #b0 #b10001101 #b11111111111111000000000) value)))
(assert (not (fp.lt value (fp.neg (fp #b0 #b10001110 #b00000000000000000000000)))))
(assert (not (in_range (to_int1 RNA value))))
(check-sat)
(exit)
