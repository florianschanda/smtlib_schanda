...
(assert (and (= (to_rep temp___140) (fp #b0 #b00000000 #b00000000000000000000000)) (= (to_rep temp___1401) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (not (= (has_valid_order (mk___rep (mk___split_fields temp___140 temp___1401))) true)))
(check-sat)
(exit)
