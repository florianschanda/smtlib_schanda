...
(assert (forall ((i nb_type)) (and (<= 0 (nb_typeqtint i)) (<= (nb_typeqtint i) 100))))
...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 100)) (in_range1 temp___expr_158)))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Float32) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b11110100000000000000000))) (in_range2 temp___expr_165)))
...
(define-fun dynamic_invariant3 ((temp___expr_172 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (in_range3 temp___expr_172)))
...
(define-fun in_range4 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) x) (fp.leq x (fp #b0 #b11111110 #b11111111111111111111110)))))
...
(declare-datatypes () ((tt_fpS__ref (mk_tt_fpS__ref (tt_fpS__content tt_fpS)))))
(define-fun tt_fpS__ref___projection ((a tt_fpS__ref)) tt_fpS (tt_fpS__content a))
(define-fun dynamic_invariant4 ((temp___expr_186 Float32) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111110))) (in_range4 temp___expr_186)))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-sort ttmp1S 0)
(define-fun in_range5 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000110 #b10010000000000000000000)))))
...
(declare-datatypes () ((ttmp1S__ref (mk_ttmp1S__ref (ttmp1S__content ttmp1S)))))
(define-fun ttmp1S__ref___projection ((a ttmp1S__ref)) ttmp1S (ttmp1S__content a))
(define-fun dynamic_invariant5 ((temp___expr_193 Float32) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b10010000000000000000000))) (in_range5 temp___expr_193)))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-sort ttmp2S 0)
(define-fun in_range6 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000100 #b10010000000000000000000)))))
...
(declare-datatypes () ((ttmp2S__ref (mk_ttmp2S__ref (ttmp2S__content ttmp2S)))))
(define-fun ttmp2S__ref___projection ((a ttmp2S__ref)) ttmp2S (ttmp2S__content a))
(define-fun dynamic_invariant6 ((temp___expr_200 Float32) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000100 #b10010000000000000000000))) (in_range6 temp___expr_200)))
...
(assert (and (and (and (< 0 nb_of_pp) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) delta_time)) (fp.leq (fp.mul RNE (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) (of_int RNE (+ nb_of_fp nb_of_pp))) delta_time) time)) (fp.leq time (fp #b0 #b11111110 #b11111111111111111111110))))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001000 #b11110100000000000000000)) (in_range2 d)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111110)) (in_range4 t_fp)))
...
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000110 #b10010000000000000000000)) (in_range5 tmp1)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000100 #b10010000000000000000000)) (in_range6 tmp2)))
(assert (= (mk_t__ref result) (mk_t__ref d)))
(assert (= d1 (fp.mul RNE (of_int RNE (+ nb_of_fp nb_of_pp)) delta_time)))
(assert (and (= o (fp.sub RNE time (fp.div RNE d1 (fp #b0 #b10000000 #b00000000000000000000000)))) (fp.isFinite32 (fp.sub RNE time (fp.div RNE d1 (fp #b0 #b10000000 #b00000000000000000000000))))))
...
(assert (and (= o2 (fp.add RNE t_fp1 tmp11)) (fp.isFinite32 (fp.add RNE t_fp1 tmp11))))
(assert (= (mk_t__ref result3) (mk_t__ref t_pp)))
(assert (= t_pp1 o2))
(assert (= (mk_t__ref result4) (mk_t__ref tmp2)))
(assert (= tmp21 (fp.mul RNE (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) (of_int RNE nb_of_fp)) delta_time)))
(assert (and (= o3 (fp.add RNE t_pp1 tmp21)) (fp.isFinite32 (fp.add RNE t_pp1 tmp21))))
(assert (= result5 time))
(assert (= time1 o3))
(assert (= tmp22 tmp21))
(assert (= tmp12 tmp11))
