...
(assert (and (= o (fp.mul RNE speed (fp #b0 #b10001000 #b11110100000000000000000))) (fp.isFinite32 (fp.mul RNE speed (fp #b0 #b10001000 #b11110100000000000000000)))))
(assert (not (not (fp.isZero (fp #b0 #b10001010 #b11000010000000000000000)))))
(check-sat)
(exit)
