...
(assert (and (<= 2 n) (<= n 46)))
(assert (fp.lt x (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) (- n 2)) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (fp.lt y (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) (- n 1)) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000))))
