...
(assert (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 approx2)) (fp.lt (fp #b0 #b01110001 #b10100011011011100010111) (fp.abs (fp.sub RNE x1 (fp.mul RNE approx2 approx2))))))
(assert (not (fp.isFinite32 (fp.div RNE x1 approx2))))
(check-sat)
(exit)
