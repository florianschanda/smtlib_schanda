...
(assert (and (= o20 (low_bound n)) (and (fp.isFinite64 o20) (= o20 (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
(assert (= o21 (fp.sub RNE o20 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 o21)))
(check-sat)
(exit)
