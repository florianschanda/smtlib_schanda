...
(assert (= (= result true) (exists ((y Int)) (and (and (<= 0 y) (<= y 100000)) (fp.eq x (fp.mul RNE (fp.div RNE (of_int RNE y) (fp #b0 #b10001111 #b10000110101000000000000)) (fp.div RNE (of_int RNE y) (fp #b0 #b10001111 #b10000110101000000000000))))))))
(assert (=> (= result true) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (= x copy))
...
(assert (= result1 x))
(assert (= x1 o2))
(assert (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)))
(check-sat)
(exit)
