...
(assert (fp.lt (next_representable x2) (fp #b0 #b01111111 #b00011001100110011001101)))
(assert (fp.lt (prev_representable x2) (fp #b0 #b01111111 #b00000000000000000000000)))
(assert (fp.lt (fp #b0 #b01111110 #b11001100110011001100110) (prev_representable x2)))
(assert (= result2 x2))
(assert (= x3 (fp #b0 #b11111110 #b11111111111111111111111)))
(assert (=> (= a true) (= result3 x3)))
(assert (=> (= a true) (= x4 (next_representable x3))))
(assert (=> (not (= a true)) (fp.lt (prev_representable x3) (fp #b0 #b11111110 #b11111111111111111111111))))
(assert (=> (not (= a true)) (= x4 x3)))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (prev_representable x4)))
(assert (= result4 x4))
(assert (= x5 (fp.neg (fp #b0 #b11111110 #b11111111111111111111111))))
(assert (=> (= b true) (= result5 x5)))
(assert (=> (= b true) (= x6 (prev_representable x5))))
(assert (=> (not (= b true)) (fp.lt (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (next_representable x5))))
(assert (=> (not (= b true)) (= x6 x5)))
(assert (not (fp.lt (next_representable x6) (fp #b0 #b00000000 #b00000000000000000000000))))
(check-sat)
(exit)
