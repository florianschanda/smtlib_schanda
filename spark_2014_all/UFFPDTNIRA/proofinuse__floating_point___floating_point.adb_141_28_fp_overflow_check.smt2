...
(define-fun dynamic_invariant2 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_223)))
...
(define-fun dynamic_invariant3 ((temp___expr_229 Float32) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (or (= temp___is_init_226 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_229)))
(declare-fun to_float (Int) Float32)
(declare-fun to_float__function_guard (Float32 Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (to_float s) true false true)) :pattern ((to_float s)))))
...
(define-fun dynamic_invariant4 ((temp___expr_235 Float32) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool)) Bool (=> (or (= temp___is_init_232 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_235)))
(declare-sort target1 0)
(define-fun in_range3 ((x1 Int)) Bool (and (<= (- 2147483648) x1) (<= x1 2147483647)))
...
(define-fun dynamic_invariant5 ((temp___expr_241 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_241)))
(declare-fun to_int3 (Float32) Int)
(declare-fun to_int__function_guard (Int Float32) Bool)
(assert (forall ((s Float32)) (! (=> (dynamic_invariant4 s true true true) (dynamic_invariant5 (to_int3 s) true false true)) :pattern ((to_int3 s)))))
...
(assert (= o6 (fp.sub RNE (fp #b0 #b01111111 #b10000000000000000000000) o5)))
