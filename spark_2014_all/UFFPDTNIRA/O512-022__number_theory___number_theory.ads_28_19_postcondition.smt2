...
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= (mk_int__ref result1) (mk_int__ref oldest))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= oldest2 0)))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= (mk_int__ref result2) (mk_int__ref old__))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= old__2 1)))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= (mk_int__ref result3) (mk_int__ref i))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= i2 2)))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (and (and (= temp___194 temp) (and (= temp___193 oldest2) (and (= temp___192 old__2) (and (= temp___191 i2) (and (and (= old__3 (fib (- i3 1))) (= oldest3 (fib (- i3 2)))) (and (and (and (and (and (=> (<= 2 n) (dynamic_property 2 n i3)) (=> (<= 1 2147483647) (in_range3 old__3))) (=> (<= 0 2147483647) (in_range2 oldest3))) (=> (<= 0 2147483647) (in_range2 temp2))) (and (<= 2 i3) (<= i3 n))) (and (and (= temp2 result4) (= temp3 oldest3)) (and (and (= oldest3 result5) (= oldest4 old__3)) (and (and (and (= o4 (+ old__3 temp3)) (in_range1 (+ old__3 temp3))) (and (= old__3 result6) (= old__4 o4))) (= i3 n)))))))))) (and (and (= i7 (mk_int__ref i3)) (and (= temp3 temp6) (and (= oldest4 oldest7) (= old__4 old__7)))) (and (= i8 i3) (and (= temp7 temp3) (and (= oldest8 oldest4) (= old__8 old__4)))))))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= i9 i7))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= temp8 (mk_int__ref temp6)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= oldest9 (mk_int__ref oldest7)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= old__9 (mk_int__ref old__7)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= i10 i8))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= temp9 temp7))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= oldest10 oldest8))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= old__10 old__8))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= i9 (mk_int__ref i2)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= temp8 (mk_int__ref temp)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= oldest9 (mk_int__ref oldest2)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= old__9 (mk_int__ref old__2)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= i10 i2))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= temp9 temp1))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= oldest10 oldest2))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (not (and (<= 2 i2) (<= i2 n))) (= old__10 old__2))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= result8 (mk_int__ref result__))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (= result__2 (int__content old__9))))
