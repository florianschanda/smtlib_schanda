...
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= temp___217 temp))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= temp___216 oldest2))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= temp___215 old__2))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (=> (and (<= 2 i2) (<= i2 n)) (= temp___214 i2))))
