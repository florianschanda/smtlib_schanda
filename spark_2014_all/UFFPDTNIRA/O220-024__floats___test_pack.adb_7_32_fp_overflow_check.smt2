...
(assert (ite (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) measured) (fp.leq (fp.add RNE (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) measured) (to_rep pid__split_fields)) (fp.leq (to_rep pid__split_fields) (fp.add RNE (fp #b0 #b11111110 #b11111111111111111111111) measured))))
(assert (not (fp.isFinite32 (fp.sub RNE (to_rep pid__split_fields) measured))))
(check-sat)
(exit)
