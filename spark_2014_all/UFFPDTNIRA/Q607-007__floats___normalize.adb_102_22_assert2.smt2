...
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant x true true true true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x)) (dynamic_invariant (r2 x) true false true true)) :pattern ((r2 x)))))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true true) (= (r2 x) (fp.roundToIntegral RTN x))) :pattern ((r2 x)))))
(declare-sort t1 0)
