...
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant x true true true) (fp.leq (fp.abs x) (fp #b0 #b01111111 #b00000000000000000000000))) (let ((result (arcsin x))) (and (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant result true false true)))) :pattern ((arcsin x)))))
