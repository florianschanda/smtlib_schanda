...
(assert (forall ((x sub_enum)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-datatypes () ((us_split_discrs2 (mk___split_discrs1 (rec__rec__sub_rec_ok__z enum)))))
(define-fun us_split_discrs___3__projection ((a us_split_discrs2)) enum (rec__rec__sub_rec_ok__z a))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rec__sub_rec_ok__plop us_rep)))))
(define-fun us_split_fields_Plop__2__projection ((a us_split_fields2)) us_rep (rec__rec__sub_rec_ok__plop a))
...
(define-fun rec__sub_rec_ok__plop__pred ((a us_rep1)) Bool (and (<= 0 (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs3 a)))) (<= (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs3 a))) 1)))
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs3 a))) (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs3 b)))) (=> (rec__sub_rec_ok__plop__pred a) (= (bool_eq (rec__rec__sub_rec_ok__plop (us_split_fields3 a)) (rec__rec__sub_rec_ok__plop (us_split_fields3 b))) true))) true false))
...
(declare-datatypes () ((sub_rec_ok__ref (mk_sub_rec_ok__ref (sub_rec_ok__content us_rep1)))))
(define-fun sub_rec_ok__ref___projection ((a sub_rec_ok__ref)) us_rep1 (sub_rec_ok__content a))
(declare-const a Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun in_range5 ((rec__rec__my_rec__e1 Int) (a1 us_rep)) Bool (= rec__rec__my_rec__e1 (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 a1)))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__rec__sub_rec_ok__plop1 us_rep)))))
(define-fun us_split_fields_Plop__4__projection ((a1 us_split_fields4)) us_rep (rec__rec__sub_rec_ok__plop1 a1))
...
(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a1) (mk___split_fields1 (rec__rec__sub_rec_ok__plop1 (us_split_fields5 a1)))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (rec__rec__sub_rec_ok__plop (us_split_fields3 r)))))
(define-fun rec__sub_rec_ok__plop__pred1 ((a1 us_rep2)) Bool (and (<= 0 (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs4 a1)))) (<= (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs4 a1))) 1)))
(define-fun bool_eq2 ((a1 us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs4 a1))) (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs4 b)))) (=> (rec__sub_rec_ok__plop__pred1 a1) (= (bool_eq (rec__rec__sub_rec_ok__plop1 (us_split_fields5 a1)) (rec__rec__sub_rec_ok__plop1 (us_split_fields5 b))) true))) true false))
(define-fun in_range6 ((rec__rec__sub_rec_ok__z1 Int) (a1 us_rep1)) Bool (= rec__rec__sub_rec_ok__z1 (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs3 a1)))))
...
(assert (< rec__sub_rec_ok__plop__first__bit1 rec__sub_rec_ok__plop__last__bit1))
...
(define-fun tzS__ref___2__projection ((a1 tzS__ref)) us_rep2 (tzS__content a1))
(define-fun dynamic_invariant1 ((temp___expr_281 us_rep2) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool) (temp___do_typ_inv_280 Bool)) Bool (and (=> (not (= temp___skip_constant_278 true)) (in_range6 a (to_base temp___expr_281))) (=> (rec__sub_rec_ok__plop__pred1 temp___expr_281) (in_range5 a (rec__rec__sub_rec_ok__plop1 (us_split_fields5 temp___expr_281))))))
(define-fun default_initial_assumption ((temp___expr_284 us_rep2) (temp___skip_top_level_285 Bool)) Bool (and (= (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs4 temp___expr_284))) a) (=> (rec__sub_rec_ok__plop__pred1 temp___expr_284) (= (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 (rec__rec__sub_rec_ok__plop1 (us_split_fields5 temp___expr_284))))) a))))
...
(define-fun dynamic_invariant4 ((temp___expr_168 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 0 1)) (in_range3 temp___expr_168)))
(define-fun dynamic_invariant5 ((temp___expr_188 us_rep1) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool) (temp___do_typ_inv_187 Bool)) Bool (=> (rec__sub_rec_ok__plop__pred temp___expr_188) (in_range4 (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs3 temp___expr_188))) (rec__rec__sub_rec_ok__plop (us_split_fields3 temp___expr_188)))))
(assert (in_range1 a))
