...
(define-fun dynamic_invariant1 ((temp___expr_243 us_rep2) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool)) Bool (and (=> (not (= temp___skip_constant_241 true)) (in_range6 a (to_base temp___expr_243))) (=> (rec__sub_rec_ok__plop__pred1 temp___expr_243) (in_range5 a (rec__rec__sub_rec_ok__plop1 (us_split_fields5 temp___expr_243))))))
(define-fun default_initial_assumption ((temp___expr_246 us_rep2) (temp___skip_top_level_247 Bool)) Bool (and (= (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs4 temp___expr_246))) a) (=> (rec__sub_rec_ok__plop__pred1 temp___expr_246) (= (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 (rec__rec__sub_rec_ok__plop1 (us_split_fields5 temp___expr_246))))) a))))
...
(define-fun dynamic_invariant4 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 0 1)) (in_range3 temp___expr_144)))
(define-fun dynamic_invariant5 ((temp___expr_161 us_rep1) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (=> (rec__sub_rec_ok__plop__pred temp___expr_161) (in_range4 (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs3 temp___expr_161))) (rec__rec__sub_rec_ok__plop (us_split_fields3 temp___expr_161)))))
