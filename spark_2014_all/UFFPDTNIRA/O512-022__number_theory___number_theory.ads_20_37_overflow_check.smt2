...
(assert (and (= o2 (fib o1)) (and (in_range2 o2) (and (= o2 (ite (or (= o1 0) (= o1 1)) o1 (+ (fib (- o1 1)) (fib (- o1 2))))) (fp.lt (of_int RNE o2) (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) o1) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (and (= o (- n 1)) (in_range3 (- n 1))))
(assert (and (= o3 (fib o)) (and (in_range2 o3) (and (= o3 (ite (or (= o 0) (= o 1)) o (+ (fib (- o 1)) (fib (- o 2))))) (fp.lt (of_int RNE o3) (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) o) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (= o4 (+ o3 o2)))
