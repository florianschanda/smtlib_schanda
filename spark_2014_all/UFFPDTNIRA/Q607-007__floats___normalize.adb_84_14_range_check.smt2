...
(assert (in_range x))
(assert (and (= o (r2 (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (and (in_range2 o) (= o (fp.roundToIntegral RTN (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))))))
