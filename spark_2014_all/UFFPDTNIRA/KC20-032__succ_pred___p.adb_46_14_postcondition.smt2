...
(assert (= p__ident__5__result1 (prev_representable (next_representable f))))
(assert (= (mk_t__ref p__ident__5__result4) (mk_t__ref p__ident__5__result2)))
(assert (= p__ident__5__result5 p__ident__5__result3))
(assert (= result1 p__ident__5__result4))
(assert (not (fp.eq p__ident__5__result4 f)))
(check-sat)
(exit)
