...
(assert (forall ((r1 Float32) (r2 Float32)) (! (=> (and (and (dynamic_invariant r1 true true true) (dynamic_invariant r2 true true true)) (and (fp.lt r1 (fp #b0 #b01111111 #b00000000000000000000000)) (and (fp.lt r2 (fp #b0 #b01111111 #b00000000000000000000000)) (and (fp.lt (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) r1) (fp.lt (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) r2))))) (let ((result (add r1 r2))) (and (fp.eq result (fp.add RNE r1 r2)) (dynamic_invariant result true false true)))) :pattern ((add r1 r2)))))
