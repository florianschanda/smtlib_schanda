...
(define-fun us_split_fields_X__projection ((a us_split_fields)) float (rec__depends_legal_2__dis_rec__x a))
(define-fun us_split_fields_Y__projection ((a us_split_fields)) float (rec__depends_legal_2__dis_rec__y a))
(define-fun us_split_fields_Z__projection ((a us_split_fields)) float (rec__depends_legal_2__dis_rec__z a))
...
(define-fun depends_legal_2__dis_rec__a__pred ((a us_rep)) Bool (= (ite (rec__depends_legal_2__dis_rec__d (us_split_discrs1 a)) 1 0) 1))
(define-fun depends_legal_2__dis_rec__b__pred ((a us_rep)) Bool (= (ite (rec__depends_legal_2__dis_rec__d (us_split_discrs1 a)) 1 0) 1))
(define-fun depends_legal_2__dis_rec__x__pred ((a us_rep)) Bool (= (ite (rec__depends_legal_2__dis_rec__d (us_split_discrs1 a)) 1 0) 0))
(define-fun depends_legal_2__dis_rec__y__pred ((a us_rep)) Bool (= (ite (rec__depends_legal_2__dis_rec__d (us_split_discrs1 a)) 1 0) 0))
(define-fun depends_legal_2__dis_rec__z__pred ((a us_rep)) Bool (= (ite (rec__depends_legal_2__dis_rec__d (us_split_discrs1 a)) 1 0) 0))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (rec__depends_legal_2__dis_rec__d (us_split_discrs1 a)) (rec__depends_legal_2__dis_rec__d (us_split_discrs1 b))) (and (and (and (and (=> (depends_legal_2__dis_rec__a__pred a) (= (to_rep1 (rec__depends_legal_2__dis_rec__a (us_split_fields1 a))) (to_rep1 (rec__depends_legal_2__dis_rec__a (us_split_fields1 b))))) (=> (depends_legal_2__dis_rec__b__pred a) (= (to_rep1 (rec__depends_legal_2__dis_rec__b (us_split_fields1 a))) (to_rep1 (rec__depends_legal_2__dis_rec__b (us_split_fields1 b)))))) (=> (depends_legal_2__dis_rec__x__pred a) (= (to_rep (rec__depends_legal_2__dis_rec__x (us_split_fields1 a))) (to_rep (rec__depends_legal_2__dis_rec__x (us_split_fields1 b)))))) (=> (depends_legal_2__dis_rec__y__pred a) (= (to_rep (rec__depends_legal_2__dis_rec__y (us_split_fields1 a))) (to_rep (rec__depends_legal_2__dis_rec__y (us_split_fields1 b)))))) (=> (depends_legal_2__dis_rec__z__pred a) (= (to_rep (rec__depends_legal_2__dis_rec__z (us_split_fields1 a))) (to_rep (rec__depends_legal_2__dis_rec__z (us_split_fields1 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_160 us_rep) (temp___skip_top_level_161 Bool)) Bool (and (= (attr__constrained temp___expr_160) false) (= (rec__depends_legal_2__dis_rec__d (us_split_discrs1 temp___expr_160)) (distinct 1 0))))
...
(declare-const usq_7 Bool)
(declare-const usq_8 integer)
(declare-const usq_9 integer)
(declare-const usq_10 float)
(declare-const usq_11 float)
(declare-const usq_12 float)
(declare-const usq_13 Bool)
...
(define-fun par1__split_discrs3 () us_split_discrs__ref (mk___split_discrs__ref (mk___split_discrs par1__split_discrs)))
(define-fun par1__split_fields7 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields par1__split_fields par1__split_fields1 par1__split_fields2 par1__split_fields3 par1__split_fields4)))
(assert (= rec1__attr__constrained false))
(assert (=> (= par1__split_discrs true) (= par1__split_discrs r4b)))
(assert (=> (= par1__split_discrs true) (=> (= par1__attr__constrained true) (= (distinct 1 0) par1__split_discrs))))
(assert (=> (= par1__split_discrs true) (= (distinct 1 0) usq_)))
(assert (=> (= par1__split_discrs true) (= rliteral usq_1)))
(assert (=> (= par1__split_discrs true) (= rliteral usq_2)))
(assert (=> (= par1__split_discrs true) (= dummy1 usq_3)))
(assert (=> (= par1__split_discrs true) (= dummy1 usq_4)))
(assert (=> (= par1__split_discrs true) (= dummy1 usq_5)))
(assert (=> (= par1__split_discrs true) (= true usq_6)))
...
(assert (=> (= par1__split_discrs true) (= par1__attr__constrained temp___1906)))
(assert (=> (= par1__split_discrs true) (= result par1__split_fields7)))
(assert (=> (= par1__split_discrs true) (= par1__split_fields5 (mk___split_fields temp___1901 temp___1902 temp___1903 temp___1904 temp___1905))))
(assert (=> (= par1__split_discrs true) (= result1 par1__split_discrs3)))
(assert (=> (= par1__split_discrs true) (= par1__split_discrs1 (mk___split_discrs temp___190))))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_discrs r7b)))
(assert (=> (not (= par1__split_discrs true)) (= (to_rep o) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (= par1__split_discrs true)) (= (to_rep o1) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (= par1__split_discrs true)) (= (to_rep o2) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (= par1__split_discrs true)) (= dummy o3)))
(assert (=> (not (= par1__split_discrs true)) (= dummy o4)))
(assert (=> (not (= par1__split_discrs true)) (= o2 o5)))
(assert (=> (not (= par1__split_discrs true)) (= o1 o6)))
(assert (=> (not (= par1__split_discrs true)) (= o o7)))
(assert (=> (not (= par1__split_discrs true)) (= (distinct 0 0) temp___185)))
(assert (=> (not (= par1__split_discrs true)) (= temp___1851 o3)))
(assert (=> (not (= par1__split_discrs true)) (= temp___1852 o4)))
(assert (=> (not (= par1__split_discrs true)) (= temp___1853 o5)))
(assert (=> (not (= par1__split_discrs true)) (= temp___1854 o6)))
(assert (=> (not (= par1__split_discrs true)) (= temp___1855 o7)))
(assert (=> (not (= par1__split_discrs true)) (= true temp___1856)))
(assert (=> (not (= par1__split_discrs true)) (=> (= par1__attr__constrained true) (= temp___185 par1__split_discrs))))
(assert (=> (not (= par1__split_discrs true)) (= (mk___rep (mk___split_discrs usq_7) (mk___split_fields usq_8 usq_9 usq_10 usq_11 usq_12) usq_13) (mk___rep (mk___split_discrs temp___185) (mk___split_fields temp___1851 temp___1852 temp___1853 temp___1854 temp___1855) temp___1856))))
(assert (=> (not (= par1__split_discrs true)) (= temp___187 (mk___rep (mk___split_discrs usq_7) (mk___split_fields usq_8 usq_9 usq_10 usq_11 usq_12) par1__attr__constrained))))
(assert (=> (not (= par1__split_discrs true)) (= result2 par1__split_fields7)))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_fields6 (us_split_fields1 temp___187))))
(assert (=> (not (= par1__split_discrs true)) (= result3 par1__split_discrs3)))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_discrs2 (us_split_discrs1 temp___187))))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_discrs1 par1__split_discrs2)))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_fields5 par1__split_fields6)))
(assert (= rec1__attr__constrained true))
(assert (not (= (rec__depends_legal_2__dis_rec__d (us_split_discrs1 par2)) rec1__split_discrs)))
(check-sat)
(exit)
