...
(assert (and (= o5 (pow7 x)) (and (fp.isFinite32 o5) (= o5 (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x) x)))))
(assert (= o6 (fp.div RNE o5 (fp #b0 #b10001011 #b00111011000000000000000))))
