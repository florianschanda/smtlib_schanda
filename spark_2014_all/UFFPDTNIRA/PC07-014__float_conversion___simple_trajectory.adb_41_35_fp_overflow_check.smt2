...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 25000)) (in_range1 temp___expr_141)))
...
(assert (and (= o25 (+ n 1)) (in_range1 (+ n 1))))
(assert (and (= o26 (low_bound o25)) (and (fp.isFinite64 o26) (= o26 (fp.mul RNE (of_int RNE o25) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
(assert (and (= o23 (low_bound n)) (and (fp.isFinite64 o23) (= o23 (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
(assert (= o24 (fp.sub RNE o23 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 o24)))
(check-sat)
(exit)
