...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (pure_function x) true false true)) :pattern ((pure_function x)))))
(declare-fun impure_function (Int) Int)
(declare-fun impure_function__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (impure_function x) true false true)) :pattern ((impure_function x)))))
...
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant1 x true true true) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) x)) (let ((result (log x))) (and (=> (fp.eq x (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant1 result true false true)))) :pattern ((log x)))))
(declare-fun pure_function1 (Int) Int)
(declare-fun pure_function__function_guard1 (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (pure_function1 x) true false true)) :pattern ((pure_function1 x)))))
(declare-fun pure_function2 (Int us_private) Int)
(declare-fun pure_function__function_guard2 (Int Int us_private) Bool)
(assert (forall ((x Int)) (forall ((state__y us_private)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (pure_function2 x state__y) true false true)) :pattern ((pure_function2 x state__y))))))
...
(assert (= result2 x2))
(assert (= x3 o1))
(assert (and (= o2 (log (fp #b0 #b00000000 #b00000000000000000000000))) (and (fp.isFinite32 o2) (=> (fp.eq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq o2 (fp #b0 #b00000000 #b00000000000000000000000))))))
