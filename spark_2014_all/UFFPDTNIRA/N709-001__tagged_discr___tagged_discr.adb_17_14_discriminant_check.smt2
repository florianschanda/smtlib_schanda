...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (and (and (and (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 a))) (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 b)))) (= (to_rep (rec__tagged_discr__u2__w (us_split_fields5 a))) (to_rep (rec__tagged_discr__u2__w (us_split_fields5 b))))) (= (to_rep (rec__tagged_discr__u2__xx (us_split_fields5 a))) (to_rep (rec__tagged_discr__u2__xx (us_split_fields5 b))))) (= (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields5 a))) (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields5 b))))) (= (rec__tagged_discr__t__z2 (us_split_fields5 a)) (rec__tagged_discr__t__z2 (us_split_fields5 b)))) (=> (tagged_discr__t__x__pred2 a) (= (to_rep (rec__tagged_discr__t__x2 (us_split_fields5 a))) (to_rep (rec__tagged_discr__t__x2 (us_split_fields5 b)))))) (=> (tagged_discr__t__y__pred2 a) (= (to_rep1 (rec__tagged_discr__t__y2 (us_split_fields5 a))) (to_rep1 (rec__tagged_discr__t__y2 (us_split_fields5 b)))))) true false))
...
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__2 (of_base v))) (to_int2 (is_zero1 us_tag1 v))) :pattern ((is_zero1 us_tag1 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__3 (of_base1 v))) (to_int2 (is_zero1 us_tag2 v))) :pattern ((is_zero1 us_tag2 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero v)) (to_int2 (is_zero1 us_tag3 v))) :pattern ((is_zero1 us_tag3 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero v)) (to_int2 (is_zero1 us_tag4 v))) :pattern ((is_zero1 us_tag4 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__2 (of_base v))) (to_int2 (is_zero1 us_tag5 v))) :pattern ((is_zero1 us_tag5 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero v)) (to_int2 (is_zero1 us_tag6 v))) :pattern ((is_zero1 us_tag6 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__3 (of_base1 v))) (to_int2 (is_zero1 us_tag7 v))) :pattern ((is_zero1 us_tag7 v)))))
...
(assert (forall ((v us_rep1)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero__21 us_tag5 v))) :pattern ((is_zero__21 us_tag5 v)))))
...
(assert true)
(assert true)
(assert (forall ((v us_rep2)) (! (= (to_int2 (is_zero__3 v)) (to_int2 (is_zero__31 us_tag2 v))) :pattern ((is_zero__31 us_tag2 v)))))
(assert (forall ((v us_rep2)) (! (= (to_int2 (is_zero__3 v)) (to_int2 (is_zero__31 us_tag7 v))) :pattern ((is_zero__31 us_tag7 v)))))
...
(assert (= (mk___split_fields__ref (mk___split_fields result result1 result2 result3)) (mk___split_fields__ref (mk___split_fields v__split_fields v__split_fields1 v__split_fields2 v__split_fields3))))
...
(assert (not (not (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 0)))))
(assert (not (= (to_rep2 (rec__tagged_discr__t__discr v__split_discrs)) 2)))
(assert (not (tagged_discr__t__y__pred (mk___rep v__split_discrs (mk___split_fields v__split_fields4 v__split_fields5 v__split_fields6 v__split_fields7) v__attr__tag))))
(check-sat)
(exit)
