...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 a))) (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 b)))) (and (and (and (and (and (= (to_rep1 (rec__tagged_discr__u2__w (us_split_fields5 a))) (to_rep1 (rec__tagged_discr__u2__w (us_split_fields5 b)))) (= (to_rep1 (rec__tagged_discr__u2__xx (us_split_fields5 a))) (to_rep1 (rec__tagged_discr__u2__xx (us_split_fields5 b))))) (= (to_rep (rec__tagged_discr__u2__yy (us_split_fields5 a))) (to_rep (rec__tagged_discr__u2__yy (us_split_fields5 b))))) (= (rec__tagged_discr__t__z2 (us_split_fields5 a)) (rec__tagged_discr__t__z2 (us_split_fields5 b)))) (=> (tagged_discr__t__x__pred2 a) (= (to_rep1 (rec__tagged_discr__t__x2 (us_split_fields5 a))) (to_rep1 (rec__tagged_discr__t__x2 (us_split_fields5 b)))))) (=> (tagged_discr__t__y__pred2 a) (= (to_rep (rec__tagged_discr__t__y2 (us_split_fields5 a))) (to_rep (rec__tagged_discr__t__y2 (us_split_fields5 b))))))) true false))
...
(assert (forall ((v us_rep2)) (! (= (= (is_zero__3 v) true) (and (and (and (= (is_zero (to_base1 v)) true) (= (to_rep1 (rec__tagged_discr__u2__w (us_split_fields5 v))) 0)) (= (to_rep1 (rec__tagged_discr__u2__xx (us_split_fields5 v))) 0)) (fp.eq (to_rep (rec__tagged_discr__u2__yy (us_split_fields5 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern ((is_zero__3 v)))))
...
(declare-const v__split_fields42 us_split_fields4)
...
(assert (= temp___2661 o1))
(assert (= temp___2662 o2))
(assert (= temp___2663 o3))
(assert (= temp___2664 o4))
(assert (= temp___2665 o5))
(assert (= temp___2666 o6))
(assert (= temp___2667 o7))
...
(assert (= temp___2661 v__split_fields28))
(assert (= temp___2662 v__split_fields29))
(assert (= temp___2663 v__split_fields30))
(assert (= temp___2664 v__split_fields31))
(assert (= temp___2665 v__split_fields32))
(assert (= temp___2666 v__split_fields33))
(assert (= temp___2667 v__split_fields34))
(assert (= v__split_discrs (mk___split_discrs temp___266)))
...
(assert (= v__split_fields42 (mk___split_fields2 v__split_fields28 v__split_fields29 v__split_fields30 v__split_fields31 v__split_fields32 v__split_fields33 v__split_fields34)))
(assert (not (= (is_zero__3 (mk___rep2 v__split_discrs (mk___split_fields2 v__split_fields35 v__split_fields36 v__split_fields37 v__split_fields38 v__split_fields39 v__split_fields40 v__split_fields41) v__attr__tag)) true)))
(check-sat)
(exit)
