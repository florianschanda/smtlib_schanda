...
(assert (update__specific_post v__attr__tag (mk___split_fields v__split_fields4 v__split_fields5 v__split_fields6 v__split_fields7) v__attr__tag (mk___split_fields v__split_fields v__split_fields1 v__split_fields2 v__split_fields3)))
...
(assert (not (= (c_is_zero (mk___rep (mk___split_fields v__split_fields8 v__split_fields9 v__split_fields10 v__split_fields11) v__attr__tag)) true)))
(check-sat)
(exit)
