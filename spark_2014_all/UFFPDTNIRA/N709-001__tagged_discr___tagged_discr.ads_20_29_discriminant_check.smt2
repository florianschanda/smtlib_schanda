...
(assert (not (not (not (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 v))) 0)))))
(assert (not (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 v))) 2)))
(assert (not (tagged_discr__t__y__pred v)))
(check-sat)
(exit)
