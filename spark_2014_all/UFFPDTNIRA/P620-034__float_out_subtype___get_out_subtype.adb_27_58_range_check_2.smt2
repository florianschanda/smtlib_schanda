...
(assert (and (= o pitch_rate_desired1) (fp.isFinite32 pitch_rate_desired1)))
(assert (= o get_out_subtype__controller_get_desired_rate__pitch_rate_desired))
(assert (and (and (fp.isFinite32 get_out_subtype__controller_get_desired_rate__roll_rate_desired) (fp.isFinite32 get_out_subtype__controller_get_desired_rate__pitch_rate_desired1)) (fp.isFinite32 get_out_subtype__controller_get_desired_rate__yaw_rate_desired)))
(assert (and (= o1 get_out_subtype__controller_get_desired_rate__roll_rate_desired) (fp.isFinite32 get_out_subtype__controller_get_desired_rate__roll_rate_desired)))
(assert (= result3 roll_rate_desired1))
(assert (= roll_rate_desired2 o1))
(assert (not (in_range get_out_subtype__controller_get_desired_rate__pitch_rate_desired1)))
(check-sat)
(exit)
