...
(assert (and (= o (pow7 x)) (and (fp.isFinite32 o) (= o (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x) x)))))
(assert (not (not (fp.isZero (fp #b0 #b10001011 #b00111011000000000000000)))))
(check-sat)
(exit)
