...
(define-fun real_matrix__ref___projection ((a real_matrix__ref)) us_t (real_matrix__content a))
(declare-fun transpose1 (us_t) us_t)
(declare-fun transpose__function_guard (us_t us_t) Bool)
(define-fun dynamic_invariant ((temp___expr_230 us_t) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool) (temp___do_typ_inv_229 Bool)) Bool (=> (not (= temp___skip_constant_227 true)) (dynamic_property2 (- 2147483648) 2147483647 (first2 temp___expr_230) (last2 temp___expr_230) (- 2147483648) 2147483647 (first_2 temp___expr_230) (last_2 temp___expr_230))))
...
(define-fun taxa_matrixP1__ref___projection ((a taxa_matrixP1__ref)) taxa_matrixP1 (taxa_matrixP1__content a))
...
(define-fun taxa_matrixP2__ref___projection ((a taxa_matrixP2__ref)) taxa_matrixP2 (taxa_matrixP2__content a))
...
(define-fun taxb_matrixP1__ref___projection ((a taxb_matrixP1__ref)) taxb_matrixP1 (taxb_matrixP1__content a))
...
(define-fun taxb_matrixP2__ref___projection ((a taxb_matrixP2__ref)) taxb_matrixP2 (taxb_matrixP2__content a))
...
(define-fun temp___17923 () us_t (mk___t temp___1792 temp___17921 temp___17922))
...
(assert (and (= temp___17923 (omultiply__4 o6 (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant temp___17923 true false true true)))
(assert (not (= (ite (<= (to_rep (first temp___17921)) (to_rep (last temp___17921))) (+ (- (to_rep (last temp___17921)) (to_rep (first temp___17921))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
