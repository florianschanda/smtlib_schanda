...
(assert (not (fp.eq lat_long__distance__result4 (sqrt1 (fp.add RNE (fp.mul RNE (delta_lat_in_meters source destination) (delta_lat_in_meters source destination)) (fp.mul RNE (delta_long_in_meters source destination) (delta_long_in_meters source destination)))))))
(check-sat)
(exit)
