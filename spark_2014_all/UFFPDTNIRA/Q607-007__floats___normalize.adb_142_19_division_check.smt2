...
(assert (forall ((x1 Float32)) (! (=> (and (dynamic_invariant1 x1 true true true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x1)) (let ((result (r4 x1))) (and (fp.eq result (fp.roundToIntegral RTN x1)) (dynamic_invariant1 result true false true)))) :pattern ((r4 x1)))))
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true) (= (r4 x1) (fp.roundToIntegral RTN x1))) :pattern ((r4 x1)))))
