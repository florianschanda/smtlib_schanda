...
(declare-const temp___242 e)
(declare-const temp___2421 integer)
(declare-const temp___2422 Bool)
(declare-const temp___2423 integer)
(declare-const temp___2424 float)
(declare-const temp___2425 us_private)
(declare-const temp___2426 Int)
...
(assert (= (rec__tagged_discr__t__discr (us_split_discrs1 r7b)) (rec__tagged_discr__t__discr v__split_discrs)))
(assert (= (us_split_discrs1 r7b) (mk___split_discrs usq_)))
(assert (= rliteral usq_1))
(assert (= (rec__tagged_discr__t__z (us_split_fields1 r7b)) usq_2))
(assert (= (rec__tagged_discr__t__x (us_split_fields1 r7b)) usq_3))
(assert (= (rec__tagged_discr__t__y (us_split_fields1 r7b)) usq_4))
(assert (= us_null_ext__ usq_5))
(assert (= us_tag2 usq_6))
(assert (= usq_ temp___242))
(assert (= usq_1 temp___2421))
(assert (= usq_2 temp___2422))
(assert (= usq_3 temp___2423))
(assert (= usq_4 temp___2424))
(assert (= usq_5 temp___2425))
(assert (= v__attr__tag temp___2426))
...
(assert (= temp___2421 v__split_fields5))
(assert (= temp___2422 v__split_fields6))
(assert (= temp___2423 v__split_fields7))
(assert (= temp___2424 v__split_fields8))
(assert (= temp___2425 v__split_fields9))
(assert (= v__split_discrs (mk___split_discrs temp___242)))
...
(assert (= v__split_fields15 v__split_fields5))
(assert (= v__split_fields16 v__split_fields6))
(assert (= v__split_fields17 v__split_fields7))
(assert (= v__split_fields18 v__split_fields8))
(assert (= v__split_fields19 v__split_fields9))
