...
(assert (= result true))
(assert (and (= temp___152 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (not (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last temp___152)))
(check-sat)
(exit)
