...
(assert (and (and (and (in_range2 (fp.add RNE (to_rep (rec__shapes5__circle__center_x (us_split_fields1 (circle__content shapes5__make_circle__result10)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result10)))))) (in_range2 (fp.sub RNE (to_rep (rec__shapes5__circle__center_x (us_split_fields1 (circle__content shapes5__make_circle__result10)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result10))))))) (in_range2 (fp.add RNE (to_rep (rec__shapes5__circle__center_y (us_split_fields1 (circle__content shapes5__make_circle__result10)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result10))))))) (in_range2 (fp.sub RNE (to_rep (rec__shapes5__circle__center_y (us_split_fields1 (circle__content shapes5__make_circle__result10)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result10))))))))
(assert (= (mk___rep (mk___split_fields result8 result9 result10)) (circle__content shapes5__make_circle__result10)))
(assert (not (= (in_bounds (circle__content shapes5__make_circle__result10) wild_man) true)))
(check-sat)
(exit)
