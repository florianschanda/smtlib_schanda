...
(assert (and (= o (pow9 x)) (and (fp.isFinite32 o) (= o (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE (fp.mul RNE x x) x) x) x) x) x) x) x)))))
(assert (= o1 (fp.mul RNE (fp #b0 #b10000100 #b11110000000000000000000) o)))
(assert (and (= o2 o1) (fp.isFinite32 o1)))
(assert (not (not (fp.isZero (fp #b0 #b10001010 #b01100010011000000000000)))))
(check-sat)
(exit)
