...
(declare-fun init__specific_post (Int us_split_fields Int us_split_fields) Bool)
(assert (forall ((classwide__init__v__fields us_split_fields) (classwide__init__v__old__fields us_split_fields)) (forall ((v__attr__tag Int)) (! (=> (init__specific_post us_tag classwide__init__v__fields v__attr__tag classwide__init__v__old__fields) (= (is_zero (mk___rep classwide__init__v__fields v__attr__tag)) true)) :pattern ((init__specific_post us_tag classwide__init__v__fields v__attr__tag classwide__init__v__old__fields))))))
(assert (forall ((classwide__init__v__fields us_split_fields) (classwide__init__v__old__fields us_split_fields)) (forall ((v__attr__tag Int)) (! (=> (init__specific_post us_tag1 classwide__init__v__fields v__attr__tag classwide__init__v__old__fields) (= (is_zero__2 (mk___rep classwide__init__v__fields v__attr__tag)) true)) :pattern ((init__specific_post us_tag1 classwide__init__v__fields v__attr__tag classwide__init__v__old__fields))))))
(assert (forall ((classwide__init__v__fields us_split_fields) (classwide__init__v__old__fields us_split_fields)) (forall ((v__attr__tag Int)) (! (=> (init__specific_post us_tag2 classwide__init__v__fields v__attr__tag classwide__init__v__old__fields) (= (is_zero__3 (of_base (mk___rep classwide__init__v__fields v__attr__tag))) true)) :pattern ((init__specific_post us_tag2 classwide__init__v__fields v__attr__tag classwide__init__v__old__fields))))))
...
(assert (init__specific_post v__attr__tag (mk___split_fields v__split_fields4 v__split_fields5 v__split_fields6 v__split_fields7) v__attr__tag (mk___split_fields v__split_fields v__split_fields1 v__split_fields2 v__split_fields3)))
