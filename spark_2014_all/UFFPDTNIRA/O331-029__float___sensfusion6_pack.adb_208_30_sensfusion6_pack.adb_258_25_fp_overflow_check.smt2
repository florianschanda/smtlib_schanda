...
(assert (and (= o37 (fp.add RNE rad_gx1 integral_fbx2)) (fp.isFinite32 (fp.add RNE rad_gx1 integral_fbx2))))
(assert (= result19 (mk_t__ref rad_gx1)))
(assert (= rad_gx2 o37))
(assert (and (= o38 (fp.add RNE rad_gy1 integral_fby2)) (fp.isFinite32 (fp.add RNE rad_gy1 integral_fby2))))
(assert (= result20 (mk_t__ref rad_gy1)))
(assert (= rad_gy2 o38))
(assert (not (fp.isFinite32 (fp.add RNE rad_gz1 integral_fbz2))))
(check-sat)
(exit)
