...
(assert (= rad_gx2 o37))
(assert (and (= o38 (fp.add RNE rad_gy1 integral_fby1)) (fp.isFinite32 (fp.add RNE rad_gy1 integral_fby1))))
(assert (= result20 (mk_t__ref rad_gy1)))
(assert (= rad_gy2 o38))
(assert (not (fp.isFinite32 (fp.add RNE rad_gz1 integral_fbz1))))
(check-sat)
(exit)
