...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__useless_discr__t__discr (us_split_discrs1 a))) (to_rep2 (rec__useless_discr__t__discr (us_split_discrs1 b)))) (= (rec__useless_discr__t__z (us_split_fields1 a)) (rec__useless_discr__t__z (us_split_fields1 b)))) (=> (useless_discr__t__x__pred a) (= (to_rep (rec__useless_discr__t__x (us_split_fields1 a))) (to_rep (rec__useless_discr__t__x (us_split_fields1 b)))))) (=> (useless_discr__t__y__pred a) (= (to_rep1 (rec__useless_discr__t__y (us_split_fields1 a))) (to_rep1 (rec__useless_discr__t__y (us_split_fields1 b)))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_187 us_rep) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (not (= temp___skip_constant_185 true)) (in_range3 0 temp___expr_187)))
(define-fun default_initial_assumption ((temp___expr_189 us_rep) (temp___skip_top_level_190 Bool)) Bool (and (= (attr__tag temp___expr_189) us_tag1) (= (to_rep2 (rec__useless_discr__t__discr (us_split_discrs1 temp___expr_189))) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 3)) (in_range2 temp___expr_171)))
