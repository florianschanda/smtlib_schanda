...
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (id x) true false true)) :pattern ((id x)))))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (= (id x) x)) :pattern ((id x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_171 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq first last)) (dynamic_property first last temp___expr_171)))
