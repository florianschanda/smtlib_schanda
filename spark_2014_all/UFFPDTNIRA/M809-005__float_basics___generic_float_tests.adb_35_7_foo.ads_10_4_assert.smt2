...
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant1 (magic x) true false true true)) :pattern ((magic x)))))
...
(assert (not (= (magic (fp.min a b)) (magic (fp.min b a)))))
(check-sat)
(exit)
