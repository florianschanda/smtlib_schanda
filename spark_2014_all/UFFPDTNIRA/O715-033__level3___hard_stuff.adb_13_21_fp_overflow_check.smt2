...
(assert (= (= result true) (exists ((y1 Int)) (and (and (<= 0 y1) (<= y1 100000)) (fp.eq x (fp.mul RNE (fp.div RNE (of_int RNE y1) (fp #b0 #b10001111 #b10000110101000000000000)) (fp.div RNE (of_int RNE y1) (fp #b0 #b10001111 #b10000110101000000000000))))))))
