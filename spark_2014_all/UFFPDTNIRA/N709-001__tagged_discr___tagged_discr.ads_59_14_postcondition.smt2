...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 a))) (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs2 b)))) (and (and (and (and (and (= (to_rep (rec__tagged_discr__u2__w (us_split_fields3 a))) (to_rep (rec__tagged_discr__u2__w (us_split_fields3 b)))) (= (to_rep (rec__tagged_discr__u2__xx (us_split_fields3 a))) (to_rep (rec__tagged_discr__u2__xx (us_split_fields3 b))))) (= (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields3 a))) (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields3 b))))) (= (rec__tagged_discr__t__z1 (us_split_fields3 a)) (rec__tagged_discr__t__z1 (us_split_fields3 b)))) (=> (tagged_discr__t__x__pred1 a) (= (to_rep (rec__tagged_discr__t__x1 (us_split_fields3 a))) (to_rep (rec__tagged_discr__t__x1 (us_split_fields3 b)))))) (=> (tagged_discr__t__y__pred1 a) (= (to_rep1 (rec__tagged_discr__t__y1 (us_split_fields3 a))) (to_rep1 (rec__tagged_discr__t__y1 (us_split_fields3 b))))))) true false))
...
(assert true)
(assert true)
(assert (forall ((v us_rep1)) (! (= (to_int2 (is_zero__3 v)) (to_int2 (is_zero__31 us_tag1 v))) :pattern ((is_zero__31 us_tag1 v)))))
(assert (forall ((v us_rep1)) (! (= (to_int2 (is_zero__3 v)) (to_int2 (is_zero__31 us_tag2 v))) :pattern ((is_zero__31 us_tag2 v)))))
(assert (forall ((v us_rep1)) (! (= (= (is_zero__3 v) true) (and (and (and (= (is_zero (to_base v)) true) (= (to_rep (rec__tagged_discr__u2__w (us_split_fields3 v))) 0)) (= (to_rep (rec__tagged_discr__u2__xx (us_split_fields3 v))) 0)) (fp.eq (to_rep1 (rec__tagged_discr__u2__yy (us_split_fields3 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern ((is_zero__3 v)))))
...
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__2 (of_base1 v))) (to_int2 (is_zero1 us_tag4 v))) :pattern ((is_zero1 us_tag4 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__3 (of_base v))) (to_int2 (is_zero1 us_tag1 v))) :pattern ((is_zero1 us_tag1 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero v)) (to_int2 (is_zero1 us_tag5 v))) :pattern ((is_zero1 us_tag5 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero v)) (to_int2 (is_zero1 us_tag6 v))) :pattern ((is_zero1 us_tag6 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__2 (of_base1 v))) (to_int2 (is_zero1 us_tag7 v))) :pattern ((is_zero1 us_tag7 v)))))
...
(assert true)
(assert true)
(assert (forall ((v us_rep2)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero__21 us_tag4 v))) :pattern ((is_zero__21 us_tag4 v)))))
(assert (forall ((v us_rep2)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero__21 us_tag7 v))) :pattern ((is_zero__21 us_tag7 v)))))
(assert (forall ((v us_rep2)) (! (= (= (is_zero__2 v) true) (and (and (not (= (rec__tagged_discr__t__z2 (us_split_fields5 v)) true)) (ite (or (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 v))) 0) (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs3 v))) 2)) (= (to_rep (rec__tagged_discr__t__x2 (us_split_fields5 v))) 0) (fp.eq (to_rep1 (rec__tagged_discr__t__y2 (us_split_fields5 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) (= (to_rep (rec__tagged_discr__u1__w (us_split_fields5 v))) 0))) :pattern ((is_zero__2 v)))))
...
(assert (= (mk___rep1 (mk___split_discrs usq_) (mk___split_fields1 usq_1 usq_2 usq_3 usq_4 usq_5 usq_6 usq_7) usq_8) (mk___rep1 (mk___split_discrs temp___227) (mk___split_fields1 temp___2271 temp___2272 temp___2273 temp___2274 temp___2275 temp___2276 temp___2277) temp___2278)))
