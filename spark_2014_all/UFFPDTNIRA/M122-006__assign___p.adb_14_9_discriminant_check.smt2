...
(assert (= rliteral p__good__x__assume1))
(assert (= dummy1 p__good__x__assume2))
...
(assert (= rliteral1 temp___1701))
(assert (= dummy1 temp___1702))
(assert (not (= temp___170 (rec__types__r__i x__split_discrs))))
(check-sat)
(exit)
