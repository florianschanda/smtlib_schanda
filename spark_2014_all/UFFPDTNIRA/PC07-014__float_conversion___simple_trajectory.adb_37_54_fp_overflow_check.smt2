...
(assert (and (= o16 (low_bound n)) (and (fp.isFinite64 o16) (= o16 (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
(assert (= o17 (fp.sub RNE o16 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 o17)))
(check-sat)
(exit)
