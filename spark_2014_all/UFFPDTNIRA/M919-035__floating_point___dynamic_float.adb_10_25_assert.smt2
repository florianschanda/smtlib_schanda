...
(assert (= result i))
(assert (= i1 1))
(assert (and (= us (fp #b0 #b01111111 #b00000000000000000000000)) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) (last i1) (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (= o (fp #b0 #b01111111 #b00000000000000000000000)))
(assert (= result1 x))
(assert (= x1 o))
(assert (dynamic_invariant x1 true false true true i1))
(assert (= (to_int1 RNA (last i1)) i1))
(assert (not (fp.eq (fp #b0 #b00000000 #b00000000000000000000000) (last i1))))
(assert (= result2 i1))
(assert (= i2 2))
(assert (and (= us1 (fp #b0 #b01111111 #b00000000000000000000000)) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) (last i2) (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (= o1 (fp #b0 #b01111111 #b00000000000000000000000)))
(assert (= result3 x1))
(assert (= x2 o1))
(assert (dynamic_invariant x2 true false true true i2))
(assert (= (to_int1 RNA (last i2)) i2))
(assert (not (not (fp.eq (fp #b0 #b00000000 #b00000000000000000000000) (last i2)))))
(check-sat)
(exit)
