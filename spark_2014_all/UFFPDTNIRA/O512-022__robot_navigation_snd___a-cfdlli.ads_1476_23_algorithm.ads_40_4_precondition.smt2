...
(define-fun default_initial_assumption1 ((temp___expr_529 us_rep5) (temp___skip_top_level_530 Bool)) Bool (=> (not (= temp___skip_top_level_530 true)) (and (= (is_empty temp___expr_529) true) (= (length2 temp___expr_529) 0))))
...
(assert (forall ((container us_rep5)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant1 result true false true true)))) :pattern ((get1 container key))))))
...
(define-fun default_initial_assumption3 ((temp___expr_507 us_rep2) (temp___skip_top_level_508 Bool)) Bool (=> (not (= temp___skip_top_level_508 true)) (= (length1 temp___expr_507) 0)))
...
(assert true)
(assert (forall ((container1 us_rep5)) (forall ((key us_rep1)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep1)) (and (= (has_key container1 k) true) (= (bool_eq1 k key) true))) (= (has_key container1 key) true))) :pattern ((has_key container1 key))))))
...
(assert true)
(assert (forall ((container1 us_rep5)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container1 key))))))
...
(declare-const temp___850 count_type)
(declare-const o2 us_rep5)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___850 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___850)) no_element))
