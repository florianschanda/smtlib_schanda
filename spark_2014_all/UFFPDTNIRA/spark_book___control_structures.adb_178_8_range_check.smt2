...
(assert (= count3 5))
(assert (= result51 (mk_int__ref count3)))
(assert (= count4 6))
(assert (= result52 (mk_int__ref count4)))
(assert (= count5 7))
(assert (= result53 (mk_int__ref count5)))
(assert (= count6 8))
(assert (= result54 count1))
(assert (= (let ((subject count1)) count7) 8))
(assert (= result55 (let ((subject count1)) (mk_int__ref count7))))
(assert (= (let ((subject count1)) count8) 7))
(assert (= result56 (let ((subject count1)) (mk_int__ref count8))))
(assert (= (let ((subject count1)) count9) 6))
(assert (= result57 (let ((subject count1)) (mk_int__ref count9))))
(assert (= (let ((subject count1)) count10) 5))
...
(assert (= (let ((subject count2)) count11) r4b))
(assert (=> (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b)) (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b))))
(assert (=> (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b)) (= (let ((subject count2)) count12) r5b)))
(assert (=> (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b)) (= count13 (let ((subject count2)) (mk_int__ref count12)))))
(assert (=> (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b)) (= count14 count12)))
(assert (=> (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b)) (= count15 count13)))
(assert (=> (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b)) (= count16 count14)))
(assert (=> (not (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b))) (= count15 (let ((subject count2)) (mk_int__ref count11)))))
(assert (=> (not (and (<= r4b (let ((subject count2)) count11)) (<= (let ((subject count2)) count11) r5b))) (= count16 count11)))
(assert (= a3 r7b))
(assert (in_range1 r7b))
(assert (= b3 r8b))
(assert (in_range1 r8b))
(assert (<= r7b r8b))
(assert (not (<= (- 2147483648) r7b)))
(check-sat)
(exit)
