...
(assert (forall ((i num)) (and (<= (- 2147483648) (numqtint i)) (<= (numqtint i) 2147483647))))
...
(define-fun dynamic_invariant3 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_572)))
...
(define-fun dynamic_invariant4 ((temp___expr_527 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool) (temp___do_typ_inv_526 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 0 255)) (in_range4 temp___expr_527)))
...
(define-fun dynamic_invariant5 ((temp___expr_534 Int) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool) (temp___do_typ_inv_533 Bool)) Bool (=> (or (= temp___is_init_530 true) (<= 2 16)) (in_range5 temp___expr_534)))
...
(define-fun dynamic_invariant6 ((temp___expr_587 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool) (temp___do_typ_inv_586 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 65 90)) (in_range6 temp___expr_587)))
...
(assert (=> (= result47 true) (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 approx2)) (fp.lt tolerance (fp.abs (fp.sub RNE x1 (fp.mul RNE approx2 approx2)))))))
...
(assert (=> (= result47 true) (= o27 (ite (fp.lt tolerance o26) true false))))
