...
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant1 n1 true true true) (= (low_bound n1) (fp.mul RNE (fp.mul RNE (of_int RNE n1) (fp.neg (fp #b0 #b10000000000 #b1101101100000010000011000100100110111010010111100011))) (fp #b0 #b01111111001 #b0001000100010001000100010001000100010001000100010001)))) :pattern ((low_bound n1)))))
...
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant1 n1 true true true) (= (high_bound n1) (fp.mul RNE (fp.mul RNE (of_int RNE n1) (fp #b0 #b10000000000 #b1101101100000010000011000100100110111010010111100011)) (fp #b0 #b01111111001 #b0001000100010001000100010001000100010001000100010001)))) :pattern ((high_bound n1)))))
