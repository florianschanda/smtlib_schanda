...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int3 x) 0) (ite (< 0 x) (pos_div_relation (to_int3 x) x 16) (pos_div_relation (- (to_int3 x)) (- x) 16))) :pattern ((to_int3 x)))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int4 x) x 16) (pos_div_relation1 (- (to_int4 x)) (- x) 16))) :pattern ((to_int4 x)))))
...
(assert (= result7 u))
(assert (= u1 o6))
(assert (= (to_fixed1 o7) (* y21 16)))
(assert (= result8 u1))
(assert (= u2 o7))
(assert (= (to_fixed1 o8) (* y32 16)))
(assert (= result9 u2))
(assert (= u3 o8))
...
(assert (= result12 u5))
(assert (= u6 o11))
(assert (= (to_fixed1 o12) (of_float32 (fp.sub RNE (fp.add RNE z31 z31) z31))))
(assert (= result13 u6))
(assert (= u7 o12))
