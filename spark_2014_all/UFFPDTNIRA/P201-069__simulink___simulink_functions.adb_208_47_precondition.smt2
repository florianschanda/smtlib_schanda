...
(assert (forall ((x Float32) (base Float32)) (! (=> (and (and (dynamic_invariant x true true true) (dynamic_invariant base true true true)) (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) base)) (not (fp.eq base (fp #b0 #b01111111 #b00000000000000000000000))))) (let ((result (log__2 x base))) (and (=> (fp.eq x (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant result true false true)))) :pattern ((log__2 x base)))))
