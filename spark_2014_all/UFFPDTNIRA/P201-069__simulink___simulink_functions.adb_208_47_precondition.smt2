...
(declare-fun log__2 (Float32 Float32) Float32)
(declare-fun log__2__function_guard (Float32 Float32 Float32) Bool)
(assert (forall ((x Float32) (base Float32)) (! (=> (and (and (dynamic_invariant x true true true true) (dynamic_invariant base true true true true)) (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) base)) (not (fp.eq base (fp #b0 #b01111111 #b00000000000000000000000))))) (let ((result (log__2 x base))) (and (=> (fp.eq x (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((log__2 x base)))))
(declare-const f Float32)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (fp.isFinite32 f))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b01000000000000000000000))))
(check-sat)
(exit)
