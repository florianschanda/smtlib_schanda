...
(assert (forall ((left Float32) (right Float32)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (dynamic_invariant (oadd left right) true false true)) :pattern ((oadd left right)))))
(assert (forall ((left Float32) (right Float32)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (= (oadd left right) (fp.add RNE left right))) :pattern ((oadd left right)))))
(declare-fun osubtract (Float32 Float32) Float32)
(declare-fun osubtract__function_guard (Float32 Float32 Float32) Bool)
(assert (forall ((left Float32) (right Float32)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (dynamic_invariant (osubtract left right) true false true)) :pattern ((osubtract left right)))))
(assert (forall ((left Float32) (right Float32)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (= (osubtract left right) (fp.sub RNE left right))) :pattern ((osubtract left right)))))
(declare-fun omultiply (Float32 Float32) Float32)
(declare-fun omultiply__function_guard (Float32 Float32 Float32) Bool)
(assert (forall ((left Float32) (right Float32)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (dynamic_invariant (omultiply left right) true false true)) :pattern ((omultiply left right)))))
(assert (forall ((left Float32) (right Float32)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (= (omultiply left right) (fp.mul RNE left right))) :pattern ((omultiply left right)))))
(declare-fun odivide (Float32 Float32) Float32)
(declare-fun odivide__function_guard (Float32 Float32 Float32) Bool)
(assert (forall ((left Float32) (right Float32)) (! (=> (and (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (not (fp.eq right (fp #b0 #b00000000 #b00000000000000000000000)))) (dynamic_invariant (odivide left right) true false true)) :pattern ((odivide left right)))))
(assert (forall ((left Float32) (right Float32)) (! (=> (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (= (odivide left right) (fp.div RNE left right))) :pattern ((odivide left right)))))
