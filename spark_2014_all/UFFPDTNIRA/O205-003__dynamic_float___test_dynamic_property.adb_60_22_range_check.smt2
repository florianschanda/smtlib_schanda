...
(assert (= x2 o1))
(assert (fp.leq x2 c))
(assert (fp.leq (dyn_return (fp #b0 #b10000100 #b01000000000000000000000)) c))
(assert (dynamic_property (fp #b0 #b01111111 #b00000000000000000000000) last x3))
(assert (fp.leq x3 c))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (and (= us1 y) (dynamic_property (fp #b0 #b01111111 #b00000000000000000000000) last y))))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= o2 y)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= o2 test_dynamic_property__dyn_param__x)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (dynamic_property (fp #b0 #b01111111 #b00000000000000000000000) last test_dynamic_property__dyn_param__x1)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (and (= us2 test_dynamic_property__dyn_param__x1) (dynamic_property1 (fp #b0 #b00000000 #b00000000000000000000000) last1 test_dynamic_property__dyn_param__x1))))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= o3 test_dynamic_property__dyn_param__x1)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= (mk_t__ref result2) (mk_t__ref y))))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= y2 o3)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (fp.leq y2 c)))
(assert (=> (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y)) (= y2 y)))
(assert (=> (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y)) (= y2 y1)))
(assert (not (dynamic_property1 (fp #b0 #b00000000 #b00000000000000000000000) last1 x3)))
(check-sat)
(exit)
