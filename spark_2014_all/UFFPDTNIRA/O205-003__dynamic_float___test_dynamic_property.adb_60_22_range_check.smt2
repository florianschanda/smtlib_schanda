...
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= o3 y)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= o3 test_dynamic_property__dyn_param__x)))
...
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= o4 test_dynamic_property__dyn_param__x1)))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= (mk_t__ref result2) (mk_t__ref y))))
(assert (=> (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) y) (= y2 o4)))
