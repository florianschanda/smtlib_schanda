...
(define-fun dynamic_invariant1 ((temp___expr_178 Float32) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_178)))
(declare-const n Int)
...
(assert (and (<= 2 n) (<= n 46)))
(assert (=> (< (- n 2) 0) (not (fp.eq (fp #b0 #b01111111 #b10011110001110111100111) ((_ to_fp 8 24) #x00000000)))))
(assert (= o (power (fp #b0 #b01111111 #b10011110001110111100111) (- n 2))))
(assert (and (= o1 o) (fp.isFinite32 o)))
(assert (not (not (fp.isZero (fp #b0 #b10000000 #b00011110001101010100000)))))
(check-sat)
(exit)
