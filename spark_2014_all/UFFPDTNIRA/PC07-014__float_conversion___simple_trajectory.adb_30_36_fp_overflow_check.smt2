...
(assert (and (= o12 (high_bound o11)) (and (fp.isFinite64 o12) (= o12 (fp.mul RNE (of_int RNE o11) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (and (= o9 (high_bound n)) (and (fp.isFinite64 o9) (= o9 (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (= o10 (fp.add RNE o9 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 o10)))
(check-sat)
(exit)
