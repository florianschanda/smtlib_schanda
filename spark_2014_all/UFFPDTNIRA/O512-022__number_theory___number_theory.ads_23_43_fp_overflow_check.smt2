...
(define-fun dynamic_invariant ((temp___expr_185 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 0 46)) (in_range2 temp___expr_185)))
(declare-const n Int)
...
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant n1 true true true) (= (fib n1) (ite (or (= n1 0) (= n1 1)) n1 (+ (fib (- n1 1)) (fib (- n1 2)))))) :pattern ((fib n1)))))
