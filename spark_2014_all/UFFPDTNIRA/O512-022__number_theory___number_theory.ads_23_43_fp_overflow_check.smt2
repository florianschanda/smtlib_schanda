...
(define-fun dynamic_invariant ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 46)) (in_range2 temp___expr_208)))
(declare-const n Int)
...
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant n1 true true true true) (= (fib n1) (ite (or (= n1 0) (= n1 1)) n1 (+ (fib (- n1 1)) (fib (- n1 2)))))) :pattern ((fib n1)))))
...
(assert (=> (not (=> (not (= n 0)) (= n 1))) (and (= o1 (- n 2)) (in_range2 (- n 2)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (and (= o2 (fib o1)) (and (in_range3 o2) (and (= o2 (ite (or (= o1 0) (= o1 1)) o1 (+ (fib (- o1 1)) (fib (- o1 2))))) (fp.lt (of_int RNE o2) (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) o1) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000))))))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (and (= o (- n 1)) (in_range2 (- n 1)))))
(assert (=> (not (=> (not (= n 0)) (= n 1))) (and (= o3 (fib o)) (and (in_range3 o3) (and (= o3 (ite (or (= o 0) (= o 1)) o (+ (fib (- o 1)) (fib (- o 2))))) (fp.lt (of_int RNE o3) (fp.add RNE (fp.div RNE (power (fp #b0 #b01111111 #b10011110001110111100111) o) (fp #b0 #b10000000 #b00011110001101010100000)) (fp #b0 #b01111111 #b00000000000000000000000))))))))
...
(assert (=> (< n 0) (not (fp.eq (fp #b0 #b01111111 #b10011110001110111100111) ((_ to_fp 8 24) #x00000000)))))
(assert (= o6 (power (fp #b0 #b01111111 #b10011110001110111100111) n)))
(assert (not (fp.isFinite32 o6)))
(check-sat)
(exit)
