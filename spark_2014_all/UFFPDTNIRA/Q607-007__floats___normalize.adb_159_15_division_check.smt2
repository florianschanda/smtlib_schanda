...
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant x true true true true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x)) (let ((result (r4 x))) (and (fp.eq result (fp.roundToIntegral RTN x)) (dynamic_invariant result true false true true)))) :pattern ((r4 x)))))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true true) (= (r4 x) (fp.roundToIntegral RTN x))) :pattern ((r4 x)))))
(declare-sort t1 0)
