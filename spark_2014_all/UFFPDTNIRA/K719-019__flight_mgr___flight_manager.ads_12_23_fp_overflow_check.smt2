...
(define-fun result____split_fields11 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields result____split_fields result____split_fields1)))
...
(assert (=> (fp.lt target_x position_x) (= result result____split_fields11)))
...
(assert (=> (not (fp.lt target_x position_x)) (=> (fp.lt position_x target_x) (= result1 result____split_fields11))))
...
(assert (and (= o12 (fp.sub RNE position_x target_x)) (fp.isFinite32 (fp.sub RNE position_x target_x))))
(assert (= o13 (fp.abs o12)))
(assert (and (=> (fp.lt o13 (fp #b0 #b10000010 #b01000000000000000000000)) (fp.eq flight_manager__set_engine_speed__adjust_speed__f (fp.div RNE (fp.mul RNE (to_rep (rec__flight_manager__engine_values__x_speed result____split_fields5)) o13) (fp #b0 #b10000010 #b01000000000000000000000)))) (fp.isFinite32 flight_manager__set_engine_speed__adjust_speed__f)))
(assert (= (to_rep o14) flight_manager__set_engine_speed__adjust_speed__f))
(assert (= o14 o15))
(assert (= (rec__flight_manager__engine_values__y_speed result____split_fields5) o16))
(assert (= temp___151 o15))
(assert (= temp___1511 o16))
(assert (= result4 (mk___split_fields__ref result____split_fields5)))
(assert (= result____split_fields7 (mk___split_fields temp___151 temp___1511)))
(assert (and (= o17 (fp.sub RNE position_y target_y)) (fp.isFinite32 (fp.sub RNE position_y target_y))))
(assert (= o18 (fp.abs o17)))
(assert (and (=> (fp.lt o18 (fp #b0 #b10000010 #b01000000000000000000000)) (fp.eq flight_manager__set_engine_speed__adjust_speed__f1 (fp.div RNE (fp.mul RNE (to_rep (rec__flight_manager__engine_values__y_speed result____split_fields7)) o18) (fp #b0 #b10000010 #b01000000000000000000000)))) (fp.isFinite32 flight_manager__set_engine_speed__adjust_speed__f1)))
(assert (= (to_rep o19) flight_manager__set_engine_speed__adjust_speed__f1))
(assert (= (rec__flight_manager__engine_values__x_speed result____split_fields7) o20))
(assert (= o19 o21))
...
(assert (= result6 (mk_engine_values__ref (mk___rep (mk___split_fields flight_manager__set_engine_speed__result flight_manager__set_engine_speed__result1)))))
(assert (= flight_manager__set_engine_speed__result2 (mk___rep result____split_fields8)))
...
(assert (and (= o22 (fp.add RNE position_y (to_rep (rec__flight_manager__engine_values__y_speed (us_split_fields1 (engine_values__content flight_manager__set_engine_speed__result5)))))) (fp.isFinite32 (fp.add RNE position_y (to_rep (rec__flight_manager__engine_values__y_speed (us_split_fields1 (engine_values__content flight_manager__set_engine_speed__result5))))))))
(assert (not (fp.isFinite32 (fp.add RNE position_y (to_rep (rec__flight_manager__engine_values__y_speed (us_split_fields1 (engine_values__content flight_manager__set_engine_speed__result5))))))))
(check-sat)
(exit)
