...
(assert (and (= o22 (fp.mul RNE two_ki half_ex1)) (fp.isFinite32 (fp.mul RNE two_ki half_ex1))))
(assert (= o23 (fp.mul RNE o22 c9b)))
(assert (and (= o24 o23) (fp.isFinite32 o23)))
...
(assert (and (= o27 (fp.mul RNE two_ki (let ((subject half_ey)) half_ey1))) (fp.isFinite32 (fp.mul RNE two_ki (let ((subject half_ey)) half_ey1)))))
(assert (= o28 (fp.mul RNE o27 c9b)))
(assert (and (= o29 o28) (fp.isFinite32 o28)))
(assert (= o30 (fp.add RNE integral_fby o29)))
(assert (and (= o31 o30) (fp.isFinite32 o30)))
(assert (= result17 (mk_t__ref integral_fby)))
(assert (= integral_fby1 o31))
(assert (and (= o32 (fp.mul RNE two_ki (let ((subject half_ez)) half_ez1))) (fp.isFinite32 (fp.mul RNE two_ki (let ((subject half_ez)) half_ez1)))))
(assert (= o33 (fp.mul RNE o32 c9b)))
(assert (and (= o34 o33) (fp.isFinite32 o33)))
(assert (= o35 (fp.add RNE integral_fbz o34)))
(assert (and (= o36 o35) (fp.isFinite32 o35)))
(assert (= result18 (mk_t__ref integral_fbz)))
(assert (= integral_fbz1 o36))
(assert (not (fp.isFinite32 (fp.add RNE rad_gx1 integral_fbx1))))
(check-sat)
(exit)
