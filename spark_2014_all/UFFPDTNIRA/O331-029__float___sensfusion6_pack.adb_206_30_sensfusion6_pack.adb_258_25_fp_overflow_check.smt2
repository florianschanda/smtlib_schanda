...
(assert (and (= o22 (fp.mul RNE two_ki half_ex2)) (fp.isFinite32 (fp.mul RNE two_ki half_ex2))))
...
(assert (= integral_fbx2 o26))
(assert (and (= o27 (fp.mul RNE two_ki (let ((subject half_ey)) half_ey2))) (fp.isFinite32 (fp.mul RNE two_ki (let ((subject half_ey)) half_ey2)))))
...
(assert (= integral_fby2 o31))
(assert (and (= o32 (fp.mul RNE two_ki (let ((subject half_ez)) half_ez2))) (fp.isFinite32 (fp.mul RNE two_ki (let ((subject half_ez)) half_ez2)))))
...
(assert (= integral_fbz2 o36))
(assert (not (fp.isFinite32 (fp.add RNE rad_gx1 integral_fbx2))))
(check-sat)
(exit)
