...
(assert (forall ((lf Float64)) (! (=> (dynamic_invariant lf true true true true) (dynamic_invariant (atan__2 lf) true false true true)) :pattern ((atan__2 lf)))))
...
(assert (= pi1 (fp #b0 #b10000000000 #b1001001000011111101101010100010001000010110100011000)))
(assert (= pi_over_two (fp #b0 #b01111111111 #b1001001000011111101101010100010001000010110100011000)))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp.isFinite64 result__)))
(assert (fp.isFinite64 pi1))
(assert (fp.isFinite64 pi_over_two))
(assert (not (and (fp.eq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq right (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))))
(assert (not (fp.leq (fp.abs left) (fp.abs right))))
(assert (and (= o (fp.div RNE right left)) (fp.isFinite64 (fp.div RNE right left))))
(assert (= o1 (fp.neg o)))
(assert (and (= o2 (atan__2 o1)) (fp.isFinite64 o2)))
(assert (= result result__))
(assert (= result__1 o2))
(assert (fp.leq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (not (fp.isFinite64 (fp.sub RNE result__1 (fp #b0 #b01111111111 #b1001001000011111101101010100010001000010110100011000)))))
(check-sat)
(exit)
