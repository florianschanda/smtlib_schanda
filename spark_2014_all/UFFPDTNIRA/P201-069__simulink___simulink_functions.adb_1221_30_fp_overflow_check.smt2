...
(assert (forall ((lf Float64)) (! (=> (dynamic_invariant lf true true true) (dynamic_invariant (atan__2 lf) true false true)) :pattern ((atan__2 lf)))))
...
(assert (and (= o4 (fp.div RNE right left)) (fp.isFinite64 (fp.div RNE right left))))
(assert (= o5 (fp.neg o4)))
...
(assert (not (fp.isFinite64 (fp.sub RNE result__2 (fp #b0 #b01111111111 #b1001001000011111101101010100010001000010110100011000)))))
(check-sat)
(exit)
