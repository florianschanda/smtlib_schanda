...
(assert (forall ((x enum)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun types__r__x__pred ((a us_rep)) Bool (= (to_rep2 (rec__types__r__i (us_split_discrs1 a))) 0))
(define-fun types__r__y__pred ((a us_rep)) Bool (= (to_rep2 (rec__types__r__i (us_split_discrs1 a))) 1))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__types__r__i (us_split_discrs1 a))) (to_rep2 (rec__types__r__i (us_split_discrs1 b)))) (and (=> (types__r__x__pred a) (= (to_rep (rec__types__r__x (us_split_fields1 a))) (to_rep (rec__types__r__x (us_split_fields1 b))))) (=> (types__r__y__pred a) (= (to_rep1 (rec__types__r__y (us_split_fields1 a))) (to_rep1 (rec__types__r__y (us_split_fields1 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (attr__constrained temp___expr_143) false) (= (to_rep2 (rec__types__r__i (us_split_discrs1 temp___expr_143))) 0)))
(define-fun in_range2 ((rec__types__r__i1 Int) (a us_rep)) Bool (= rec__types__r__i1 (to_rep2 (rec__types__r__i (us_split_discrs1 a)))))
...
(define-fun in_range3 ((rec__types__r__i1 Int) (a us_rep)) Bool (= rec__types__r__i1 (to_rep2 (rec__types__r__i (us_split_discrs1 a)))))
...
(declare-const temp___151 enum)
(declare-const temp___1511 integer)
(declare-const temp___1512 float)
(declare-const temp___1513 Bool)
...
(assert (= (to_rep2 o5) 1))
(assert (= o5 o9))
(assert (= temp___151 o9))
(assert (= temp___1511 o7))
(assert (= temp___1512 o8))
(assert (= true temp___1513))
(assert (= x__attr__constrained true))
(assert (not (= temp___151 x__split_discrs1)))
(check-sat)
(exit)
