...
(define-fun default_initial_assumption ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep2 (rec__types__r__i (us_split_discrs1 temp___expr_167))) 0)))
...
(assert (not (= temp___175 x__split_discrs1)))
(check-sat)
(exit)
