...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__types__r__i (us_split_discrs1 a))) (to_rep1 (rec__types__r__i (us_split_discrs1 b)))) (and (=> (types__r__x__pred a) (= (to_rep2 (rec__types__r__x (us_split_fields1 a))) (to_rep2 (rec__types__r__x (us_split_fields1 b))))) (=> (types__r__y__pred a) (= (to_rep (rec__types__r__y (us_split_fields1 a))) (to_rep (rec__types__r__y (us_split_fields1 b))))))) true false))
