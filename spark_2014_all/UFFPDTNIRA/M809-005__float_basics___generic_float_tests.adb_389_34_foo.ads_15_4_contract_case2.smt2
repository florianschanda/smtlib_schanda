...
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b0110011001100110011001100110011001100110011001100110))) true) (= i2 (- 1))))
(assert (=> (= (fp.eq x (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) true) (= i2 (- 1))))
(assert (=> (= (fp.eq x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) true) (= i2 0)))
(assert (=> (= (fp.eq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) true) (= i2 1)))
(assert (=> (= (fp.eq x (fp #b0 #b01111111111 #b0110011001100110011001100110011001100110011001100110)) true) (= i2 1)))
(assert (=> (= (fp.eq x (fp #b0 #b01111111111 #b1000000000000000000000000000000000000000000000000000)) true) (= i2 2)))
