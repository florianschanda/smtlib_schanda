...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__rec__sub_rec__plop1 us_rep)))))
(define-fun us_split_fields_Plop__3__projection ((a1 us_split_fields4)) us_rep (rec__rec__sub_rec__plop1 a1))
(declare-datatypes () ((us_split_fields__ref2 (mk___split_fields__ref2 (us_split_fields__content2 us_split_fields4)))))
(define-fun us_split_fields__ref___6__projection ((a1 us_split_fields__ref2)) us_split_fields4 (us_split_fields__content2 a1))
(declare-datatypes () ((us_rep2 (mk___rep2 (us_split_discrs4 us_split_discrs2) (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___11__projection ((a1 us_rep2)) us_split_discrs2 (us_split_discrs4 a1))
(define-fun us_rep___12__projection ((a1 us_rep2)) us_split_fields4 (us_split_fields5 a1))
(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a1) (mk___split_fields1 (rec__rec__sub_rec__plop1 (us_split_fields5 a1)))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (rec__rec__sub_rec__plop (us_split_fields3 r)))))
(define-fun bool_eq2 ((a1 us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__rec__sub_rec__z (us_split_discrs4 a1))) (to_rep (rec__rec__sub_rec__z (us_split_discrs4 b)))) (= (bool_eq (rec__rec__sub_rec__plop1 (us_split_fields5 a1)) (rec__rec__sub_rec__plop1 (us_split_fields5 b))) true)) true false))
(define-fun in_range6 ((rec__rec__sub_rec__z1 Int) (a1 us_rep1)) Bool (= rec__rec__sub_rec__z1 (to_rep (rec__rec__sub_rec__z (us_split_discrs3 a1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_263 us_rep2) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (and (=> (not (= temp___skip_constant_260 true)) (in_range6 a (to_base temp___expr_263))) (in_range5 a (rec__rec__sub_rec__plop1 (us_split_fields5 temp___expr_263)))))
(define-fun default_initial_assumption ((temp___expr_266 us_rep2) (temp___skip_top_level_267 Bool)) Bool (and (= (to_rep (rec__rec__sub_rec__z (us_split_discrs4 temp___expr_266))) a) (= (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 (rec__rec__sub_rec__plop1 (us_split_fields5 temp___expr_266))))) a)))
...
(define-fun dynamic_invariant5 ((temp___expr_181 us_rep1) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (in_range4 (to_rep (rec__rec__sub_rec__z (us_split_discrs3 temp___expr_181))) (rec__rec__sub_rec__plop (us_split_fields3 temp___expr_181))))
(assert (in_range1 a))
