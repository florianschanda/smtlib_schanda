...
(define-fun dynamic_invariant1 ((temp___expr_226 us_rep2) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool)) Bool (and (=> (not (= temp___skip_constant_224 true)) (in_range6 a (to_base temp___expr_226))) (in_range5 a (rec__rec__sub_rec__plop1 (us_split_fields5 temp___expr_226)))))
(define-fun default_initial_assumption ((temp___expr_229 us_rep2) (temp___skip_top_level_230 Bool)) Bool (and (= (to_rep (rec__rec__sub_rec__z (us_split_discrs4 temp___expr_229))) a) (= (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 (rec__rec__sub_rec__plop1 (us_split_fields5 temp___expr_229))))) a)))
...
(define-fun dynamic_invariant5 ((temp___expr_155 us_rep1) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (in_range4 (to_rep (rec__rec__sub_rec__z (us_split_discrs3 temp___expr_155))) (rec__rec__sub_rec__plop (us_split_fields3 temp___expr_155))))
(assert (in_range1 a))
