...
(assert (forall ((b Bool)) (! (dynamic_invariant (v b) true false true true) :pattern ((v b)))))
(assert (forall ((b Bool)) (! (= (v b) (ite (= b true) (fp #b0 #b01111011 #b10011001100110011001101) (fp.neg (fp #b0 #b01111011 #b10011001100110011001101)))) :pattern ((v b)))))
...
(assert (and (= o (v (distinct 1 0))) (and (fp.isFinite32 o) (= o (ite (= (distinct 1 0) true) (fp #b0 #b01111011 #b10011001100110011001101) (fp.neg (fp #b0 #b01111011 #b10011001100110011001101)))))))
(assert (= result x))
(assert (= x1 o))
(assert (fp.isFinite32 x1))
(assert (and (= o1 (v (distinct 0 0))) (and (fp.isFinite32 o1) (= o1 (ite (= (distinct 0 0) true) (fp #b0 #b01111011 #b10011001100110011001101) (fp.neg (fp #b0 #b01111011 #b10011001100110011001101)))))))
(assert (= result1 y))
(assert (= y1 o1))
(assert (fp.isFinite32 y1))
(assert (not (fp.eq x1 (fp #b0 #b01111011 #b10011001100110011001101))))
(check-sat)
(exit)
