...
(assert (forall ((b Bool)) (! (dynamic_invariant (v b) true false true) :pattern ((v b)))))
...
(assert (and (= o (v (of_int1 1))) (and (fp.isFinite32 o) (= o (ite (= (of_int1 1) true) (fp #b0 #b01111011 #b10011001100110011001101) (fp.neg (fp #b0 #b01111011 #b10011001100110011001101)))))))
(assert (= result x))
(assert (= x1 o))
(assert (fp.isFinite32 x1))
(assert (and (= o1 (v (of_int1 0))) (and (fp.isFinite32 o1) (= o1 (ite (= (of_int1 0) true) (fp #b0 #b01111011 #b10011001100110011001101) (fp.neg (fp #b0 #b01111011 #b10011001100110011001101)))))))
(assert (= result1 y))
(assert (= y1 o1))
