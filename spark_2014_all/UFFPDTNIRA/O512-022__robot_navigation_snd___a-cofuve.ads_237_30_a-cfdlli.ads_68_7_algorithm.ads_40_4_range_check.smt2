...
(define-fun dynamic_invariant ((temp___expr_426 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 1 2147483647)) (in_range2 temp___expr_426)))
...
(define-fun dynamic_invariant1 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range3 temp___expr_442)))
...
(define-fun dynamic_invariant2 ((temp___expr_324 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 0 2147483647)) (in_range6 temp___expr_324)))
...
(define-fun dynamic_invariant4 ((temp___expr_170 Float32) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range4 temp___expr_170)))
(define-fun dynamic_invariant5 ((temp___expr_286 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 1) 1)) (in_range5 temp___expr_286)))
(assert true)
(declare-const o Int)
