...
(define-fun dynamic_invariant ((temp___expr_481 Int) (temp___is_init_477 Bool) (temp___skip_constant_478 Bool) (temp___do_toplevel_479 Bool) (temp___do_typ_inv_480 Bool)) Bool (=> (or (= temp___is_init_477 true) (<= 1 2147483647)) (in_range2 temp___expr_481)))
...
(define-fun dynamic_invariant1 ((temp___expr_499 Int) (temp___is_init_495 Bool) (temp___skip_constant_496 Bool) (temp___do_toplevel_497 Bool) (temp___do_typ_inv_498 Bool)) Bool (=> (or (= temp___is_init_495 true) (<= 0 2147483647)) (in_range3 temp___expr_499)))
...
(assert (forall ((x normalized2pi)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Float32)) (! (=> (in_range4 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__spaces__angles__angle__theta (us_split_fields1 a))) (to_rep1 (rec__spaces__angles__angle__theta (us_split_fields1 b)))) true false))
...
(assert (forall ((x idir_t)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__gaps__gap__bearing us_rep1) (rec__gaps__gap__distance float) (rec__gaps__gap__idir idir_t)))))
(define-fun us_split_fields_bearing__projection ((a us_split_fields2)) us_rep1 (rec__gaps__gap__bearing a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (bool_eq1 (rec__gaps__gap__bearing (us_split_fields3 a)) (rec__gaps__gap__bearing (us_split_fields3 b))) true) (= (to_rep (rec__gaps__gap__distance (us_split_fields3 a))) (to_rep (rec__gaps__gap__distance (us_split_fields3 b))))) (= (to_rep2 (rec__gaps__gap__idir (us_split_fields3 a))) (to_rep2 (rec__gaps__gap__idir (us_split_fields3 b))))) true false))
...
(define-fun oeq ((left us_rep) (right us_rep)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq2 (get left n) (get right n)) true))) true false)))
(declare-fun oeq__function_guard (Bool us_rep us_rep) Bool)
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq3 a b) (oeq a b)) :pattern ((user_eq3 a b)))))
(define-fun default_initial_assumption ((temp___expr_507 us_rep) (temp___skip_top_level_508 Bool)) Bool (=> (not (= temp___skip_top_level_508 true)) (= (length temp___expr_507) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range4 temp___expr_198)))
(define-fun dynamic_invariant5 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 1) 1)) (in_range5 temp___expr_323)))
(assert true)
(declare-const o Int)
