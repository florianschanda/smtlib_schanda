...
(define-fun dynamic_invariant ((temp___expr_197 us_t) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (=> (not (= temp___skip_constant_195 true)) (dynamic_property2 (- 2147483648) 2147483647 (first2 temp___expr_197) (last2 temp___expr_197) (- 2147483648) 2147483647 (first_2 temp___expr_197) (last_2 temp___expr_197))))
...
(declare-const o4 t)
(declare-const o5 t1)
(declare-const temp___1621 map1)
(declare-const temp___16211 t)
(declare-const temp___16212 t1)
...
(assert (and (= (mk___t temp___1621 temp___16211 temp___16212) (omultiply__4 (mk___t o3 o4 o5) (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant (mk___t temp___1621 temp___16211 temp___16212) true false true)))
(assert (not (= (ite (<= (to_rep1 (first temp___16211)) (to_rep1 (last temp___16211))) (+ (- (to_rep1 (last temp___16211)) (to_rep1 (first temp___16211))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
