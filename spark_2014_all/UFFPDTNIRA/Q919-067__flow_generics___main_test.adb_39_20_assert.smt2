...
(assert true)
(assert (forall ((original map1) (map2 map1)) (! (= (manipulate1 original map2) (let ((temp___1937 (omultiply__4 (omultiply__4 (transpose (of_array map2 1 3 1 2)) (of_array original 1 3 1 3)) (of_array map2 1 3 1 2)))) (slide (to_array temp___1937) (first2 temp___1937) 1 (first_2 temp___1937) 1))) :pattern ((manipulate1 original map2)))))
...
(define-fun dynamic_invariant ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_18)))
...
(assert (forall ((x us_t)) (! (=> (dynamic_invariant2 x true true true true) (dynamic_invariant2 (transpose x) true false true true)) :pattern ((transpose x)))))
...
(assert (and (= o (manipulate1 mat_in1 mat_map1)) (= o (let ((temp___1926 (omultiply__4 (omultiply__4 (transpose (mk___t mat_map1 (mk 1 3) (mk1 1 2))) (mk___t mat_in1 (mk 1 3) (mk1 1 3))) (mk___t mat_map1 (mk 1 3) (mk1 1 2))))) (slide (elts temp___1926) (to_rep1 (first (rt temp___1926))) 1 (to_rep1 (first1 (rt_2 temp___1926))) 1)))))
(assert (= result6 mat_out1))
(assert (= mat_out3 o))
(assert (not (= (bool_eq mat_out3 1 2 1 2 (temp___1988 (fp #b0 #b10000001 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b00100000000000000000000)) (- 2147483648) (- 2147483647) (- 2147483648) (- 2147483647)) true)))
(check-sat)
(exit)
