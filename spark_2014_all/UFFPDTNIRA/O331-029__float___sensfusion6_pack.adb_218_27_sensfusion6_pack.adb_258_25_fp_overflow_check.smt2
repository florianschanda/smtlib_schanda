...
(assert (= rad_gy3 o45))
(assert (and (= o46 (fp.mul RNE two_kp (let ((subject half_ez)) half_ez1))) (fp.isFinite32 (fp.mul RNE two_kp (let ((subject half_ez)) half_ez1)))))
(assert (= o47 (fp.add RNE rad_gz2 o46)))
(assert (not (fp.isFinite32 o47)))
(check-sat)
(exit)
