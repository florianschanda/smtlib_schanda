...
(declare-sort t 0)
(define-fun in_range ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000000 #b00000000000000000000000)))))
...
(define-fun dynamic_invariant1 ((temp___expr_171 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) (fp #b0 #b10000000 #b00000000000000000000000))) (in_range temp___expr_171)))
...
(assert (and (= o3 (fp.mul RNE x x)) (fp.isFinite32 (fp.mul RNE x x))))
(assert (and (= o (fp.mul RNE x (fp.mul RNE x x))) (fp.isFinite32 (fp.mul RNE x (fp.mul RNE x x)))))
(assert (= o1 (fp.mul RNE (fp #b0 #b10000001 #b11000000000000000000000) o)))
(assert (and (= o2 o1) (fp.isFinite32 o1)))
(assert (< 4 0))
(assert (not (not (= x ((_ to_fp 8 24) #x00000000)))))
(check-sat)
(exit)
