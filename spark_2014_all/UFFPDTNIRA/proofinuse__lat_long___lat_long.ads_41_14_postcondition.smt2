...
(assert (= lat_long__delta_long_in_meters__result1 lat_long__delta_long_in_meters__result2))
(assert (= lat_long__delta_long_in_meters__result3 lat_long__delta_long_in_meters__result1))
...
(assert (= (mk_t__ref lat_long__delta_long_in_meters__result4) (mk_t__ref lat_long__delta_long_in_meters__result2)))
(assert (= lat_long__delta_long_in_meters__result5 lat_long__delta_long_in_meters__result3))
(assert (= result1 lat_long__delta_long_in_meters__result4))
(assert (not (= (olt (fp.abs lat_long__delta_long_in_meters__result4) (fp #b0 #b10011000 #b00110001001111000100110)) true)))
(check-sat)
(exit)
