...
(assert (=> (fp.lt target_x position_x) (= result (mk___split_fields__ref (mk___split_fields result____split_fields result____split_fields1)))))
...
(assert (=> (not (fp.lt target_x position_x)) (=> (fp.lt position_x target_x) (= result1 (mk___split_fields__ref (mk___split_fields result____split_fields result____split_fields1))))))
