...
(assert (and (= o (add (fp #b0 #b01111100 #b10011001100110011001101) (fp #b0 #b01111101 #b00110011001100110011010))) (and (fp.isFinite32 o) (fp.eq o (fp.add RNE (fp #b0 #b01111100 #b10011001100110011001101) (fp #b0 #b01111101 #b00110011001100110011010))))))
(assert (and (= o1 (add (fp #b0 #b01111011 #b10011001100110011001101) o)) (and (fp.isFinite32 o1) (fp.eq o1 (fp.add RNE (fp #b0 #b01111011 #b10011001100110011001101) o)))))
(assert (not (fp.lt (fp #b0 #b01111011 #b10011001100110011001101) (fp #b0 #b01111111 #b00000000000000000000000))))
(check-sat)
(exit)
