...
(assert (and (= o28 (high_bound o27)) (and (fp.isFinite64 o28) (= o28 (fp.mul RNE (of_int RNE o27) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (and (= o25 (high_bound n)) (and (fp.isFinite64 o25) (= o25 (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (= o26 (fp.add RNE o25 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 o26)))
(check-sat)
(exit)
