...
(assert (=> (not (= (bool_eq1 position no_element) true)) (and (= o4 (get1 o3 position)) (and (in_range4 o4) (=> (= (of_int 0) true) (and (= o4 (w_get o3 (witness o3 position))) (forall ((k us_rep1)) (=> (= (has_key o3 k) true) (= (= (bool_eq1 k position) true) (= (witness o3 position) (witness o3 k)))))))))))
