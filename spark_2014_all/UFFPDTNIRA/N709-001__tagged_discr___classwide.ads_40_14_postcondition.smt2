...
(define-fun classwide__c_init__v__fields4 () us_split_fields (mk___split_fields classwide__c_init__v__fields classwide__c_init__v__fields1 classwide__c_init__v__fields2 classwide__c_init__v__fields3))
(assert (= (c_is_zero (mk___rep classwide__c_init__v__fields4 v__attr__tag)) true))
...
(assert (= (mk___split_fields v__split_fields4 v__split_fields5 v__split_fields6 v__split_fields7) classwide__c_init__v__fields4))
