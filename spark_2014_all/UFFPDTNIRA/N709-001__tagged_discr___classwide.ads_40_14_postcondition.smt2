...
(assert true)
(assert true)
(assert (forall ((v us_rep)) (! (= (to_int2 (d_is_zero v)) (to_int2 (d_is_zero1 us_tag v))) :pattern ((d_is_zero1 us_tag v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (d_is_zero__2 v)) (to_int2 (d_is_zero1 us_tag1 v))) :pattern ((d_is_zero1 us_tag1 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (d_is_zero v)) (to_int2 (d_is_zero1 us_tag2 v))) :pattern ((d_is_zero1 us_tag2 v)))))
...
(assert true)
(assert true)
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero v)) (to_int2 (is_zero1 us_tag v))) :pattern ((is_zero1 us_tag v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero1 us_tag1 v))) :pattern ((is_zero1 us_tag1 v)))))
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__3 (of_base v))) (to_int2 (is_zero1 us_tag2 v))) :pattern ((is_zero1 us_tag2 v)))))
...
(define-fun default_initial_assumption1 ((temp___expr_165 us_rep) (temp___skip_top_level_166 Bool)) Bool (= (attr__tag temp___expr_165) us_tag1))
(assert true)
(assert true)
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero__21 us_tag1 v))) :pattern ((is_zero__21 us_tag1 v)))))
...
(assert true)
(assert true)
(assert (forall ((v us_rep)) (! (= (to_int2 (d_is_zero__2 v)) (to_int2 (d_is_zero__21 us_tag1 v))) :pattern ((d_is_zero__21 us_tag1 v)))))
(assert (forall ((v us_rep)) (! (= (= (d_is_zero__2 v) true) (= (c_u1_is_zero v) true)) :pattern ((d_is_zero__2 v)))))
(define-fun default_initial_assumption2 ((temp___expr_184 us_rep1) (temp___skip_top_level_185 Bool)) Bool (= (attr__tag1 temp___expr_184) us_tag2))
(assert true)
(assert true)
(assert (forall ((v us_rep1)) (! (= (to_int2 (is_zero__3 v)) (to_int2 (is_zero__31 us_tag2 v))) :pattern ((is_zero__31 us_tag2 v)))))
...
(declare-const classwide__c_init__v__fields1 integer)
(declare-const classwide__c_init__v__fields2 float)
(declare-const classwide__c_init__v__fields3 us_private)
...
(assert (= (c_is_zero (mk___rep (mk___split_fields classwide__c_init__v__fields classwide__c_init__v__fields1 classwide__c_init__v__fields2 classwide__c_init__v__fields3) v__attr__tag)) true))
...
(assert (= (mk___split_fields v__split_fields4 v__split_fields5 v__split_fields6 v__split_fields7) (mk___split_fields classwide__c_init__v__fields classwide__c_init__v__fields1 classwide__c_init__v__fields2 classwide__c_init__v__fields3)))
