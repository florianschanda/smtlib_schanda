...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 4294967295)) (in_range temp___expr_135)))
(declare-const x Int)
...
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 4294967295)) (in_range1 temp___expr_147)))
...
(define-fun dynamic_invariant2 ((temp___expr_153 Float32) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_153)))
(declare-fun conv (Int) Float32)
(declare-fun conv__function_guard (Float32 Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (conv s) true false true)) :pattern ((conv s)))))
(declare-const o Int)
(assert (in_range x))
(assert (in_range y))
