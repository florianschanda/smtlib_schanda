...
(assert (and (= us1 y) (dynamic_property (fp #b0 #b01111111 #b00000000000000000000000) last y)))
(assert (= o2 y))
(assert (= o2 test_dynamic_property__dyn_param__x))
(assert (dynamic_property (fp #b0 #b01111111 #b00000000000000000000000) last test_dynamic_property__dyn_param__x1))
(assert (and (= us2 test_dynamic_property__dyn_param__x1) (dynamic_property1 (fp #b0 #b00000000 #b00000000000000000000000) last1 test_dynamic_property__dyn_param__x1)))
