...
(assert (and (= o32 (low_bound n)) (and (fp.isFinite64 o32) (= o32 (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))))
(assert (= o33 (fp.sub RNE o32 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (and (= o34 o33) (fp.isFinite64 o33)))
