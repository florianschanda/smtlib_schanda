...
(assert (=> (= result true) (and (= temp___177 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))))))
(assert (=> (= result true) (and (= us temp___177) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last temp___177))))
