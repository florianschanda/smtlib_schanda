...
(define-fun dynamic_invariant2 ((temp___expr_147 Float32) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) last)) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last temp___expr_147)))
(assert (= last c))
...
(assert (=> (= result true) (and (= temp___152 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))) (fp.isFinite32 (fp.add RNE x (fp #b0 #b01111111 #b00000000000000000000000))))))
(assert (=> (= result true) (and (= us temp___152) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last temp___152))))
(assert (=> (= result true) (= o1 temp___152)))
(assert (=> (= result true) (= result1 x)))
(assert (=> (= result true) (= x1 o1)))
(assert (=> (not (= result true)) (and (= us1 (fp #b0 #b01111111 #b00000000000000000000000)) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) last (fp #b0 #b01111111 #b00000000000000000000000)))))
(assert (=> (not (= result true)) (= o2 (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (=> (not (= result true)) (= result2 x)))
(assert (=> (not (= result true)) (= x2 o2)))
(assert (=> (not (= result true)) (= x1 x2)))
(assert (= x1 x3))
(assert (= x4 x1))
(assert (not (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) x3)))
(check-sat)
(exit)
