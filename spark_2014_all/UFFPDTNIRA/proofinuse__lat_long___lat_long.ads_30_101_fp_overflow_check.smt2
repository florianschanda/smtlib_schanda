...
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (let ((result (cos1 x))) (and (=> (and (fp.leq (fp.neg (fp #b0 #b10000101 #b00101100000000000000000)) x) (fp.leq x (fp #b0 #b10000101 #b00101100000000000000000))) (fp.leq (fp #b0 #b01111011 #b10011001100110011001101) result)) (dynamic_invariant result true false true)))) :pattern ((cos1 x)))))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (= (cos1 x) (sin1 x))) :pattern ((cos1 x)))))
(declare-fun sqrt1 (Float32) Float32)
(declare-fun sqrt__function_guard (Float32 Float32) Bool)
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (sqrt1 x) true false true)) :pattern ((sqrt1 x)))))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (= (sqrt1 x) (fp.sqrt RNE x))) :pattern ((sqrt1 x)))))
...
(assert (forall ((source1 us_rep) (destination1 us_rep)) (! (let ((result (delta_lat_in_meters source1 destination1))) (and (= (olt (fp.abs result) (fp #b0 #b10010111 #b00110001001111000100110)) true) (dynamic_invariant result true false true))) :pattern ((delta_lat_in_meters source1 destination1)))))
...
(assert (forall ((source1 us_rep) (destination1 us_rep)) (! (let ((result (delta_long_in_meters source1 destination1))) (and (= (olt (fp.abs result) (fp #b0 #b10011000 #b00110001001111000100110)) true) (dynamic_invariant result true false true))) :pattern ((delta_long_in_meters source1 destination1)))))
...
(define-fun dynamic_invariant2 ((temp___expr_147 Float32) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b00101100000000000000000)) (fp #b0 #b10000101 #b00101100000000000000000))) (in_range temp___expr_147)))
(define-fun dynamic_invariant3 ((temp___expr_153 Float32) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01100111111111111111111)) (fp #b0 #b10000110 #b01101000000000000000000))) (in_range1 temp___expr_153)))
(assert (forall ((x Float32)) (! (=> (dynamic_invariant1 x true true true) (let ((result (sin1 x))) (and (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) result) (fp.leq result (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000)))) (dynamic_invariant1 result true false true)))) :pattern ((sin1 x)))))
...
(assert (and (= o3 (fp.mul RNE delta_long1 delta_long1)) (fp.isFinite32 (fp.mul RNE delta_long1 delta_long1))))
(assert (and (= o4 (fp.mul RNE delta_lat1 delta_lat1)) (fp.isFinite32 (fp.mul RNE delta_lat1 delta_lat1))))
(assert (= o5 (fp.add RNE o4 o3)))
(assert (and (= o6 o5) (fp.isFinite32 o5)))
(assert (and (= o7 (sqrt1 o6)) (and (fp.isFinite32 o7) (= o7 (fp.sqrt RNE o6)))))
(assert (= (mk_t__ref result2) (mk_t__ref lat_long__distance__result)))
(assert (= lat_long__distance__result1 o7))
(assert (= (mk_t__ref lat_long__distance__result4) (mk_t__ref lat_long__distance__result2)))
...
(assert (and (= o11 (delta_long_in_meters source destination)) (and (fp.isFinite32 o11) (and (= o11 (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) (fp #b0 #b10010101 #b10000100101000110101001)) (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))) (= (olt (fp.abs o11) (fp #b0 #b10011000 #b00110001001111000100110)) true)))))
(assert (and (= o12 (delta_long_in_meters source destination)) (and (fp.isFinite32 o12) (and (= o12 (fp.div RNE (fp.mul RNE (fp.sub RNE (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 destination))) (to_rep1 (rec__lat_long__coordinates__long (us_split_fields1 source)))) (fp #b0 #b10010101 #b10000100101000110101001)) (cos1 (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))))) (= (olt (fp.abs o12) (fp #b0 #b10011000 #b00110001001111000100110)) true)))))
(assert (= o13 (fp.mul RNE o12 o11)))
(assert (and (= o14 o13) (fp.isFinite32 o13)))
(assert (and (= o8 (delta_lat_in_meters source destination)) (and (fp.isFinite32 o8) (and (= o8 (fp.mul RNE (fp.mul RNE (fp.sub RNE (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 destination))) (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))) (fp #b0 #b10010101 #b10000100101000110101001)) (fp #b0 #b01111001 #b00011101111101000110101))) (= (olt (fp.abs o8) (fp #b0 #b10010111 #b00110001001111000100110)) true)))))
(assert (and (= o9 (delta_lat_in_meters source destination)) (and (fp.isFinite32 o9) (and (= o9 (fp.mul RNE (fp.mul RNE (fp.sub RNE (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 destination))) (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))) (fp #b0 #b10010101 #b10000100101000110101001)) (fp #b0 #b01111001 #b00011101111101000110101))) (= (olt (fp.abs o9) (fp #b0 #b10010111 #b00110001001111000100110)) true)))))
(assert (= o10 (fp.mul RNE o9 o8)))
(assert (and (= o15 o10) (fp.isFinite32 o10)))
(assert (= o16 (fp.add RNE o15 o14)))
(assert (not (fp.isFinite32 o16)))
(check-sat)
(exit)
