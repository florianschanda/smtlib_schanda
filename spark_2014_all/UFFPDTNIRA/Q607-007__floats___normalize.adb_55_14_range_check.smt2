...
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true true) (dynamic_invariant1 (r1 x1) true false true true)) :pattern ((r1 x1)))))
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true true) (= (r1 x1) (fp.roundToIntegral RTN x1))) :pattern ((r1 x1)))))
...
(assert (in_range x))
(assert (and (= o (r1 (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))) (and (in_range2 o) (= o (fp.roundToIntegral RTN (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))))))
