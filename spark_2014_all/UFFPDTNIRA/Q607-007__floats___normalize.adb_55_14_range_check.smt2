...
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true) (dynamic_invariant1 (r1 x1) true false true)) :pattern ((r1 x1)))))
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true) (= (r1 x1) (fp.roundToIntegral RTN x1))) :pattern ((r1 x1)))))
