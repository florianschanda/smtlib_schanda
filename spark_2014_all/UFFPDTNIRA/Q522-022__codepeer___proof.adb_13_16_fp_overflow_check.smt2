...
(define-fun dynamic_invariant2 ((temp___expr_179 Float32) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01101000000000000000000)) (fp #b0 #b10000110 #b01101000000000000000000))) (in_range1 temp___expr_179)))
(declare-sort t_z 0)
...
(define-fun dynamic_invariant3 ((temp___expr_186 Float32) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (fp.leq (fp.neg (fp #b0 #b01111110 #b00000000000000000000000)) (fp #b0 #b01111110 #b00000000000000000000000))) (in_range2 temp___expr_186)))
