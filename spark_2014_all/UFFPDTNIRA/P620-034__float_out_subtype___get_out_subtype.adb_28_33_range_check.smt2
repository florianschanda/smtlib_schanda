...
(define-fun dynamic_invariant1 ((temp___expr_135 Float32) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (fp.leq (fp.neg (fp #b0 #b10001010 #b01110111000000000000000)) (fp #b0 #b10001010 #b01110111000000000000000))) (in_range temp___expr_135)))
...
(assert (and (= o2 get_out_subtype__controller_get_desired_rate__pitch_rate_desired1) (fp.isFinite32 get_out_subtype__controller_get_desired_rate__pitch_rate_desired1)))
(assert (= (to_rep o3) o2))
(assert (= o4 (to_rep o3)))
(assert (= result4 pitch_rate_desired1))
(assert (= pitch_rate_desired2 o4))
(assert (not (in_range get_out_subtype__controller_get_desired_rate__yaw_rate_desired)))
(check-sat)
(exit)
