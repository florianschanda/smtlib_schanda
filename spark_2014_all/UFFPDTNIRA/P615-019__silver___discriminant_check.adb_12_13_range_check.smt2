...
(define-fun discriminant_check__rec__x__pred ((a us_rep)) Bool (= (to_int1 (rec__discriminant_check__rec__b (us_split_discrs1 a))) 1))
(define-fun discriminant_check__rec__y__pred ((a us_rep)) Bool (= (to_int1 (rec__discriminant_check__rec__b (us_split_discrs1 a))) 0))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (rec__discriminant_check__rec__b (us_split_discrs1 a)) (rec__discriminant_check__rec__b (us_split_discrs1 b))) (=> (discriminant_check__rec__x__pred a) (= (to_rep (rec__discriminant_check__rec__x (us_split_fields1 a))) (to_rep (rec__discriminant_check__rec__x (us_split_fields1 b)))))) (=> (discriminant_check__rec__y__pred a) (= (to_rep1 (rec__discriminant_check__rec__y (us_split_fields1 a))) (to_rep1 (rec__discriminant_check__rec__y (us_split_fields1 b)))))) true false))
...
(assert (not (in_range (to_int1 (rec__discriminant_check__rec__b (us_split_discrs1 r))))))
(check-sat)
(exit)
