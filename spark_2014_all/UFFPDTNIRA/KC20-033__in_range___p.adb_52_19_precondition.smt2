...
(define-fun dynamic_invariant2 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 2)) (in_range1 temp___expr_171)))
(declare-sort volt 0)
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int2 x) 0) (ite (< 0 x) (pos_div_relation (to_int2 x) x 8) (pos_div_relation (- (to_int2 x)) (- x) 8))) :pattern ((to_int2 x)))))
...
(assert (forall ((n Int)) (! (=> (and (dynamic_invariant n true true true) (and (<= 1 n) (<= n 10))) (dynamic_invariant (ident n) true false true)) :pattern ((ident n)))))
(declare-fun ident__2 (Int) Int)
(declare-fun ident__2__function_guard (Int Int) Bool)
(assert (forall ((c Int)) (! (=> (and (dynamic_invariant2 c true true true) (and (<= 0 c) (<= c 1))) (dynamic_invariant2 (ident__2 c) true false true)) :pattern ((ident__2 c)))))
...
(assert (forall ((f Float32)) (! (=> (and (dynamic_invariant1 f true true true) (and (fp.leq (fp.neg (fp #b0 #b01111110 #b11111111011111001110111)) f) (fp.leq f (fp #b0 #b01111110 #b11111111011111001110111)))) (dynamic_invariant1 (ident__5 f) true false true)) :pattern ((ident__5 f)))))
...
(assert (= result3 m))
(assert (= m1 o5))
(assert (not (fp.leq (fp.neg (fp #b0 #b01111110 #b11111111011111001110111)) (fp.neg (fp #b0 #b01111011 #b11001010110000001000010)))))
(check-sat)
(exit)
