...
(define-fun default_initial_assumption1 ((temp___expr_184 us_rep1) (temp___skip_top_level_185 Bool)) Bool (= (attr__tag1 temp___expr_184) us_tag2))
...
(define-fun default_initial_assumption2 ((temp___expr_165 us_rep) (temp___skip_top_level_166 Bool)) Bool (= (attr__tag temp___expr_165) us_tag1))
(assert true)
(assert true)
...
(declare-const temp___2141 integer)
(declare-const temp___2142 float)
(declare-const temp___2143 Bool)
(declare-const temp___2144 integer)
(declare-const temp___2145 float)
(declare-const temp___2146 us_private)
...
(declare-const temp___216 integer)
(declare-const temp___2161 integer)
(declare-const temp___2162 float)
(declare-const temp___2163 Bool)
(declare-const temp___2164 integer)
(declare-const temp___2165 float)
(declare-const temp___2166 us_private)
...
(declare-const temp___2182 float)
(declare-const temp___2183 Bool)
(declare-const temp___2184 integer)
(declare-const temp___2185 float)
(declare-const temp___2186 us_private)
...
(assert (= v__split_fields28 (mk___split_fields1 temp___218 temp___2181 temp___2182 temp___2183 temp___2184 temp___2185 temp___2186)))
