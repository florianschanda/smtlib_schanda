...
(assert (= (is_zero (mk___rep (mk___split_fields classwide__update__v__fields classwide__update__v__fields1 classwide__update__v__fields2 classwide__update__v__fields3) v__attr__tag)) true))
...
(assert (= (mk___split_fields1 v__split_fields7 v__split_fields8 v__split_fields9 v__split_fields10 v__split_fields11 v__split_fields12 v__split_fields13) (us_split_fields3 (of_base (mk___rep (mk___split_fields classwide__update__v__fields classwide__update__v__fields1 classwide__update__v__fields2 classwide__update__v__fields3) v__attr__tag)))))
(assert (= (to_rep o) 0))
(assert (= o o1))
