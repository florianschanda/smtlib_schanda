...
(define-fun us_split_fields_Y__projection ((a us_split_fields)) float (rec__classwide__t__y a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (rec__classwide__t__z (us_split_fields1 a)) (rec__classwide__t__z (us_split_fields1 b))) (= (to_rep1 (rec__classwide__t__x (us_split_fields1 a))) (to_rep1 (rec__classwide__t__x (us_split_fields1 b))))) (= (to_rep (rec__classwide__t__y (us_split_fields1 a))) (to_rep (rec__classwide__t__y (us_split_fields1 b))))) true false))
...
(define-fun us_split_fields_YY__projection ((a us_split_fields2)) float (rec__classwide__u2__yy a))
...
(define-fun us_split_fields_Y__2__projection ((a us_split_fields2)) float (rec__classwide__t__y1 a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (and (= (to_rep1 (rec__classwide__u2__w (us_split_fields3 a))) (to_rep1 (rec__classwide__u2__w (us_split_fields3 b)))) (= (to_rep1 (rec__classwide__u2__xx (us_split_fields3 a))) (to_rep1 (rec__classwide__u2__xx (us_split_fields3 b))))) (= (to_rep (rec__classwide__u2__yy (us_split_fields3 a))) (to_rep (rec__classwide__u2__yy (us_split_fields3 b))))) (= (rec__classwide__t__z1 (us_split_fields3 a)) (rec__classwide__t__z1 (us_split_fields3 b)))) (= (to_rep1 (rec__classwide__t__x1 (us_split_fields3 a))) (to_rep1 (rec__classwide__t__x1 (us_split_fields3 b))))) (= (to_rep (rec__classwide__t__y1 (us_split_fields3 a))) (to_rep (rec__classwide__t__y1 (us_split_fields3 b))))) true false))
...
(declare-fun update__specific_post (Int us_split_fields Int us_split_fields) Bool)
(assert (forall ((classwide__update__v__fields us_split_fields) (classwide__update__v__old__fields us_split_fields)) (forall ((v__attr__tag Int)) (! (=> (update__specific_post us_tag classwide__update__v__fields v__attr__tag classwide__update__v__old__fields) (= (is_zero (mk___rep classwide__update__v__fields v__attr__tag)) true)) :pattern ((update__specific_post us_tag classwide__update__v__fields v__attr__tag classwide__update__v__old__fields))))))
(assert (forall ((classwide__update__v__fields us_split_fields) (classwide__update__v__old__fields us_split_fields)) (forall ((v__attr__tag Int)) (! (=> (update__specific_post us_tag1 classwide__update__v__fields v__attr__tag classwide__update__v__old__fields) (= (is_zero__2 (mk___rep classwide__update__v__fields v__attr__tag)) true)) :pattern ((update__specific_post us_tag1 classwide__update__v__fields v__attr__tag classwide__update__v__old__fields))))))
(assert (forall ((classwide__update__v__fields us_split_fields) (classwide__update__v__old__fields us_split_fields)) (forall ((v__attr__tag Int)) (! (=> (update__specific_post us_tag2 classwide__update__v__fields v__attr__tag classwide__update__v__old__fields) (= (is_zero__3 (of_base (mk___rep classwide__update__v__fields v__attr__tag))) true)) :pattern ((update__specific_post us_tag2 classwide__update__v__fields v__attr__tag classwide__update__v__old__fields))))))
(define-fun in_range1 ((x Int)) Bool (or (= x 0) (= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Bool) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Bool)
(define-fun default_initial_assumption1 ((temp___expr_214 us_rep1) (temp___skip_top_level_215 Bool)) Bool (= (attr__tag1 temp___expr_214) us_tag2))
(assert true)
(assert true)
(assert (forall ((v us_rep1)) (! (= (ite (is_zero__3 v) 1 0) (ite (is_zero__31 us_tag2 v) 1 0)) :pattern ((is_zero__31 us_tag2 v)))))
(assert (forall ((v us_rep1)) (! (= (= (is_zero__3 v) true) (and (and (and (= (is_zero (to_base v)) true) (= (to_rep1 (rec__classwide__u2__w (us_split_fields3 v))) 0)) (= (to_rep1 (rec__classwide__u2__xx (us_split_fields3 v))) 0)) (fp.eq (to_rep (rec__classwide__u2__yy (us_split_fields3 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern ((is_zero__3 v)))))
...
(assert (forall ((v us_rep)) (! (= (= (is_zero v) true) (and (and (not (= (rec__classwide__t__z (us_split_fields1 v)) true)) (= (to_rep1 (rec__classwide__t__x (us_split_fields1 v))) 0)) (fp.eq (to_rep (rec__classwide__t__y (us_split_fields1 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern ((is_zero v)))))
(define-fun default_initial_assumption2 ((temp___expr_192 us_rep) (temp___skip_top_level_193 Bool)) Bool (= (attr__tag temp___expr_192) us_tag1))
(assert true)
(assert true)
(assert (forall ((v us_rep)) (! (= (ite (is_zero__2 v) 1 0) (ite (is_zero__21 us_tag1 v) 1 0)) :pattern ((is_zero__21 us_tag1 v)))))
(assert (forall ((v us_rep)) (! (= (= (is_zero__2 v) true) (and (and (not (= (rec__classwide__t__z (us_split_fields1 v)) true)) (= (to_rep1 (rec__classwide__t__x (us_split_fields1 v))) 0)) (fp.eq (to_rep (rec__classwide__t__y (us_split_fields1 v))) (fp #b0 #b00000000 #b00000000000000000000000)))) :pattern ((is_zero__2 v)))))
...
(declare-const temp___244 integer)
(declare-const temp___2441 integer)
(declare-const temp___2442 float)
(declare-const temp___2443 Bool)
(declare-const temp___2444 integer)
(declare-const temp___2445 float)
(declare-const temp___2446 us_private)
(declare-const temp___2447 Int)
(declare-const classwide__update__v__fields Bool)
(declare-const classwide__update__v__fields1 integer)
(declare-const classwide__update__v__fields2 float)
(declare-const classwide__update__v__fields3 us_private)
...
(declare-const result14 integer)
(declare-const result15 integer)
(declare-const result16 float)
(declare-const result17 Bool)
(declare-const result18 integer)
(declare-const result19 float)
(declare-const result20 us_private)
(declare-const v__split_fields21 integer)
(declare-const v__split_fields22 integer)
(declare-const v__split_fields23 float)
(declare-const v__split_fields24 Bool)
(declare-const v__split_fields25 integer)
(declare-const v__split_fields26 float)
(declare-const v__split_fields27 us_private)
(declare-const result21 integer)
(declare-const result22 integer)
(declare-const result23 float)
(declare-const result24 Bool)
(declare-const result25 integer)
(declare-const result26 float)
(declare-const result27 us_private)
(declare-const v__split_fields28 integer)
(declare-const v__split_fields29 integer)
(declare-const v__split_fields30 float)
(declare-const v__split_fields31 Bool)
(declare-const v__split_fields32 integer)
(declare-const v__split_fields33 float)
(declare-const v__split_fields34 us_private)
(declare-const v__split_fields35 integer)
(declare-const v__split_fields36 integer)
(declare-const v__split_fields37 float)
(declare-const v__split_fields38 Bool)
(declare-const v__split_fields39 integer)
(declare-const v__split_fields40 float)
(declare-const v__split_fields41 us_private)
(declare-const v__split_fields42 integer)
(declare-const v__split_fields43 integer)
(declare-const v__split_fields44 float)
(declare-const v__split_fields45 Bool)
(declare-const v__split_fields46 integer)
(declare-const v__split_fields47 float)
(declare-const v__split_fields48 us_private)
(define-fun classwide__update__v__fields4 () us_split_fields (mk___split_fields classwide__update__v__fields classwide__update__v__fields1 classwide__update__v__fields2 classwide__update__v__fields3))
(assert (= (is_zero (mk___rep classwide__update__v__fields4 v__attr__tag)) true))
...
(assert (= (mk___split_fields1 v__split_fields7 v__split_fields8 v__split_fields9 v__split_fields10 v__split_fields11 v__split_fields12 v__split_fields13) (us_split_fields3 (of_base (mk___rep classwide__update__v__fields4 v__attr__tag)))))
...
(assert (= rliteral v__split_fields14))
(assert (= v__split_fields8 v__split_fields15))
(assert (= v__split_fields9 v__split_fields16))
(assert (= v__split_fields10 v__split_fields17))
(assert (= v__split_fields11 v__split_fields18))
(assert (= v__split_fields12 v__split_fields19))
(assert (= v__split_fields13 v__split_fields20))
...
(assert (= v__split_fields14 v__split_fields21))
(assert (= rliteral v__split_fields22))
(assert (= v__split_fields16 v__split_fields23))
(assert (= v__split_fields17 v__split_fields24))
(assert (= v__split_fields18 v__split_fields25))
(assert (= v__split_fields19 v__split_fields26))
(assert (= v__split_fields20 v__split_fields27))
(assert (= (to_rep o) (fp #b0 #b00000000 #b00000000000000000000000)))
(assert (= v__split_fields21 o1))
(assert (= v__split_fields22 o2))
(assert (= o o3))
(assert (= v__split_fields24 o4))
(assert (= v__split_fields25 o5))
(assert (= v__split_fields26 o6))
(assert (= v__split_fields27 o7))
(assert (= temp___244 o1))
(assert (= temp___2441 o2))
(assert (= temp___2442 o3))
(assert (= temp___2443 o4))
(assert (= temp___2444 o5))
(assert (= temp___2445 o6))
(assert (= temp___2446 o7))
(assert (= v__attr__tag temp___2447))
(assert (= result21 v__split_fields21))
(assert (= result22 v__split_fields22))
(assert (= result23 v__split_fields23))
(assert (= result24 v__split_fields24))
(assert (= result25 v__split_fields25))
(assert (= result26 v__split_fields26))
(assert (= result27 v__split_fields27))
(assert (= temp___244 v__split_fields28))
(assert (= temp___2441 v__split_fields29))
(assert (= temp___2442 v__split_fields30))
(assert (= temp___2443 v__split_fields31))
(assert (= temp___2444 v__split_fields32))
(assert (= temp___2445 v__split_fields33))
(assert (= temp___2446 v__split_fields34))
(assert (= v__split_fields35 v__split_fields28))
(assert (= v__split_fields36 v__split_fields29))
(assert (= v__split_fields37 v__split_fields30))
(assert (= v__split_fields38 v__split_fields31))
(assert (= v__split_fields39 v__split_fields32))
(assert (= v__split_fields40 v__split_fields33))
(assert (= v__split_fields41 v__split_fields34))
(assert (= v__split_fields42 v__split_fields28))
(assert (= v__split_fields43 v__split_fields29))
(assert (= v__split_fields44 v__split_fields30))
(assert (= v__split_fields45 v__split_fields31))
(assert (= v__split_fields46 v__split_fields32))
(assert (= v__split_fields47 v__split_fields33))
(assert (= v__split_fields48 v__split_fields34))
(assert (not (= (is_zero__3 (mk___rep1 (mk___split_fields1 v__split_fields35 v__split_fields36 v__split_fields37 v__split_fields38 v__split_fields39 v__split_fields40 v__split_fields41) v__attr__tag)) true)))
(check-sat)
(exit)
