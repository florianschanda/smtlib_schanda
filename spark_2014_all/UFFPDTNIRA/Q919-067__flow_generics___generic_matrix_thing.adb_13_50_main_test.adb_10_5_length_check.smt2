...
(define-fun temp___19803 () us_t (mk___t temp___1980 temp___19801 temp___19802))
(define-fun o6 () us_t (mk___t o3 o4 o5))
(define-fun o7 () us_t (mk___t o o1 o2))
(assert (and (= o7 (transpose (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant o7 true false true)))
(assert (and (= o6 (omultiply__4 o7 (mk___t original (mk 1 3) (mk1 1 3)))) (dynamic_invariant o6 true false true)))
(assert (and (= temp___19803 (omultiply__4 o6 (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant temp___19803 true false true)))
