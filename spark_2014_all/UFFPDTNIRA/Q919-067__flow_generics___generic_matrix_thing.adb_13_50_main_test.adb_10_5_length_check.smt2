...
(assert (forall ((x us_t)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (transpose x) true false true true)) :pattern ((transpose x)))))
...
(assert (and (= o7 (transpose (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant o7 true false true true)))
...
(assert (not (= (ite (<= (to_rep1 (first temp___21591)) (to_rep1 (last temp___21591))) (+ (- (to_rep1 (last temp___21591)) (to_rep1 (first temp___21591))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
