...
(declare-const o4 t)
(declare-const o5 t1)
(declare-const temp___1980 map1)
(declare-const temp___19801 t)
(declare-const temp___19802 t1)
(assert (and (= (mk___t o o1 o2) (transpose (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant (mk___t o o1 o2) true false true)))
(assert (and (= (mk___t o3 o4 o5) (omultiply__4 (mk___t o o1 o2) (mk___t original (mk 1 3) (mk1 1 3)))) (dynamic_invariant (mk___t o3 o4 o5) true false true)))
(assert (and (= (mk___t temp___1980 temp___19801 temp___19802) (omultiply__4 (mk___t o3 o4 o5) (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant (mk___t temp___1980 temp___19801 temp___19802) true false true)))
(assert (not (= (ite (<= (to_rep1 (first temp___19801)) (to_rep1 (last temp___19801))) (+ (- (to_rep1 (last temp___19801)) (to_rep1 (first temp___19801))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
