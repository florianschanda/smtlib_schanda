...
(define-fun dynamic_invariant ((temp___expr_527 us_t) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool) (temp___do_typ_inv_526 Bool)) Bool (=> (not (= temp___skip_constant_524 true)) (dynamic_property2 (- 2147483648) 2147483647 (first2 temp___expr_527) (last2 temp___expr_527) (- 2147483648) 2147483647 (first_2 temp___expr_527) (last_2 temp___expr_527))))
(assert (forall ((x us_t)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant (transpose1 x) true false true true)) :pattern ((transpose1 x)))))
(declare-fun omultiply__4 (us_t us_t) us_t)
(declare-fun omultiply__4__function_guard (us_t us_t us_t) Bool)
(assert (forall ((left us_t) (right us_t)) (! (=> (and (dynamic_invariant left true true true true) (dynamic_invariant right true true true true)) (dynamic_invariant (omultiply__4 left right) true false true true)) :pattern ((omultiply__4 left right)))))
...
(define-fun temp___21593 () us_t (mk___t temp___2159 temp___21591 temp___21592))
(define-fun o6 () us_t (mk___t o3 o4 o5))
(define-fun o7 () us_t (mk___t o o1 o2))
(assert (and (= o7 (transpose1 (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant o7 true false true true)))
(assert (and (= o6 (omultiply__4 o7 (mk___t original (mk 1 3) (mk1 1 3)))) (dynamic_invariant o6 true false true true)))
(assert (and (= temp___21593 (omultiply__4 o6 (mk___t map2 (mk 1 3) (mk1 1 2)))) (dynamic_invariant temp___21593 true false true true)))
(assert (not (= (ite (<= (to_rep (first1 temp___21592)) (to_rep (last1 temp___21592))) (+ (- (to_rep (last1 temp___21592)) (to_rep (first1 temp___21592))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
