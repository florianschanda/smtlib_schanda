...
(assert (and (= o4 (fp.div RNE acceleration speed2)) (fp.isFinite32 (fp.div RNE acceleration speed2))))
(assert (= o5 (fp.mul RNE o4 (fp #b0 #b10000001 #b01000000000000000000000))))
