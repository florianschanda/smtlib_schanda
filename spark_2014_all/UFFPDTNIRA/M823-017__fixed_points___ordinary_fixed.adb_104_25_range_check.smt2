...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation (fxp_mult x y) (* x y) 400) (pos_div_relation (- (fxp_mult x y)) (- (* x y)) 400))) :pattern ((fxp_mult x y))))))
(declare-fun fxp_div (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation (fxp_div x y) (* x 400) y) (ite (and (< x 0) (< y 0)) (pos_div_relation (fxp_div x y) (* (- x) 400) (- y)) (ite (and (< x 0) (< 0 y)) (pos_div_relation (- (fxp_div x y)) (* (- x) 400) y) (=> (and (< 0 x) (< y 0)) (pos_div_relation (- (fxp_div x y)) (* x 400) (- y))))))) :pattern ((fxp_div x y))))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int3 x) 0) (ite (< 0 x) (pos_div_relation (to_int3 x) x 400) (pos_div_relation (- (to_int3 x)) (- x) 400))) :pattern ((to_int3 x)))))
...
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (or (= x 0) (= y 0)) (= (fxp_mult1 x y) 0) (ite (or (and (< 0 x) (< 0 y)) (and (< x 0) (< y 0))) (pos_div_relation1 (fxp_mult1 x y) (* x y) 400) (pos_div_relation1 (- (fxp_mult1 x y)) (- (* x y)) 400))) :pattern ((fxp_mult1 x y))))))
(declare-fun fxp_div1 (Int Int) Int)
(assert (forall ((x Int)) (forall ((y Int)) (! (ite (= x 0) (= (fxp_div1 x y) 0) (ite (and (< 0 x) (< 0 y)) (pos_div_relation1 (fxp_div1 x y) (* x 400) y) (ite (and (< x 0) (< y 0)) (pos_div_relation1 (fxp_div1 x y) (* (- x) 400) (- y)) (ite (and (< x 0) (< 0 y)) (pos_div_relation1 (- (fxp_div1 x y)) (* (- x) 400) y) (=> (and (< 0 x) (< y 0)) (pos_div_relation1 (- (fxp_div1 x y)) (* x 400) (- y))))))) :pattern ((fxp_div1 x y))))))
...
(assert (forall ((x Int)) (! (ite (= x 0) (= (to_int4 x) 0) (ite (< 0 x) (pos_div_relation1 (to_int4 x) x 400) (pos_div_relation1 (- (to_int4 x)) (- x) 400))) :pattern ((to_int4 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 10)) (in_range4 temp___expr_165)))
...
(define-fun dynamic_invariant3 ((temp___expr_172 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 10)) (in_range5 temp___expr_172)))
...
(define-fun dynamic_invariant4 ((temp___expr_179 Float32) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b01000000000000000000000))) (in_range6 temp___expr_179)))
...
(define-fun dynamic_invariant5 ((temp___expr_186 Float32) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b01000000000000000000000))) (in_range7 temp___expr_186)))
...
(assert (and (= o (to_int4 (to_fixed1 x))) (in_range1 (to_int4 (to_fixed1 x)))))
(assert (= result3 y1))
(assert (= y11 o))
(assert (<= 0 (to_fixed1 x)))
(assert (and (= o1 (to_int4 (to_fixed1 x))) (in_range1 (to_int4 (to_fixed1 x)))))
(assert (and (= o2 o1) (in_range4 o1)))
(assert (= result4 y2))
(assert (= y21 o2))
(assert (and (= o3 (to_int3 (+ (to_fixed1 x) (to_fixed1 x)))) (in_range1 (to_int3 (+ (to_fixed1 x) (to_fixed1 x))))))
(assert (and (= o4 o3) (in_range5 o3)))
(assert (= result5 y3))
(assert (= y31 o4))
(assert (and (= o5 (to_int3 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x)))) (in_range5 (to_int3 (- (+ (to_fixed1 x) (to_fixed1 x)) (to_fixed1 x))))))
(assert (= result6 y31))
(assert (= y32 o5))
(assert (= (to_fixed1 o6) (* y11 400)))
(assert (= result7 u))
(assert (= u1 o6))
(assert (= (to_fixed1 o7) (* y21 400)))
(assert (= result8 u1))
(assert (= u2 o7))
(assert (= (to_fixed1 o8) (* y32 400)))
(assert (= result9 u2))
(assert (= u3 o8))
(assert (= (to_fixed1 o9) (of_float32 z11)))
(assert (= result10 u3))
(assert (= u4 o9))
(assert (= (to_fixed1 o10) (of_float32 z21)))
(assert (= result11 u4))
(assert (= u5 o10))
(assert (= (to_fixed1 o11) (of_float32 (fp.add RNE z31 z31))))
(assert (= result12 u5))
(assert (= u6 o11))
(assert (not (in_range3 (of_float32 (fp.sub RNE (fp.add RNE z31 z31) z31)))))
(check-sat)
(exit)
