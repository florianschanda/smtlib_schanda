...
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant x true true true) (not (fp.eq (fp.abs x) (fp #b0 #b01111111 #b00000000000000000000000)))) (let ((result (arctanh x))) (and (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant result true false true)))) :pattern ((arctanh x)))))
(declare-const f Float32)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (fp.isFinite32 f))
(assert (not (not (fp.eq (fp.abs f) (fp #b0 #b01111111 #b00000000000000000000000)))))
(check-sat)
(exit)
