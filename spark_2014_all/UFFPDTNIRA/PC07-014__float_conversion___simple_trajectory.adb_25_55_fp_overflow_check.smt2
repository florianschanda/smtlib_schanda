...
(assert (and (= o2 (high_bound n)) (and (fp.isFinite64 o2) (= o2 (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (= o3 (fp.add RNE o2 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (not (fp.isFinite64 o3)))
(check-sat)
(exit)
