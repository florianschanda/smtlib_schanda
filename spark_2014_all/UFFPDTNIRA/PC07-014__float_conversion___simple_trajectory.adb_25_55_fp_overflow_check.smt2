...
(assert (and (= o1 (high_bound n)) (and (fp.isFinite64 o1) (= o1 (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (= o2 (fp.add RNE o1 (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
