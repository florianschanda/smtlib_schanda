...
(assert (forall ((left1 Float64) (right1 Float64)) (! (=> (and (dynamic_invariant1 left1 true true true true) (dynamic_invariant1 right1 true true true true)) (dynamic_invariant1 (atan2__2 left1 right1) true false true true)) :pattern ((atan2__2 left1 right1)))))
(declare-const o Float64)
(declare-const o1 Float32)
(assert (fp.isFinite32 left))
(assert (fp.isFinite32 right))
(assert (and (= o (atan2__2 ((_ to_fp 11 53) RNE left) ((_ to_fp 11 53) RNE right))) (fp.isFinite64 o)))
