...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__message_tests__flags_t__a Bool) (rec__message_tests__flags_t__b Bool)))))
(define-fun us_split_fields_A__projection ((a us_split_fields)) Bool (rec__message_tests__flags_t__a a))
(define-fun us_split_fields_B__projection ((a us_split_fields)) Bool (rec__message_tests__flags_t__b a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (rec__message_tests__flags_t__a (us_split_fields1 a)) (rec__message_tests__flags_t__a (us_split_fields1 b))) (= (rec__message_tests__flags_t__b (us_split_fields1 a)) (rec__message_tests__flags_t__b (us_split_fields1 b)))) true false))
...
(assert (< message_tests__flags_t__a__first__bit message_tests__flags_t__a__last__bit))
...
(assert (< message_tests__flags_t__b__first__bit message_tests__flags_t__b__last__bit))
(assert (<= 0 message_tests__flags_t__b__position))
(declare-fun user_eq1 (us_rep us_rep) Bool)
(declare-const dummy1 us_rep)
(declare-datatypes () ((flags_t__ref (mk_flags_t__ref (flags_t__content us_rep)))))
(define-fun flags_t__ref___projection ((a flags_t__ref)) us_rep (flags_t__content a))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__message_tests__coordinate__x float) (rec__message_tests__coordinate__y float) (rec__message_tests__coordinate__w float) (rec__message_tests__coordinate__flags us_rep)))))
(define-fun us_split_fields_X__projection ((a us_split_fields2)) float (rec__message_tests__coordinate__x a))
(define-fun us_split_fields_Y__projection ((a us_split_fields2)) float (rec__message_tests__coordinate__y a))
(define-fun us_split_fields_W__projection ((a us_split_fields2)) float (rec__message_tests__coordinate__w a))
(define-fun us_split_fields_Flags__projection ((a us_split_fields2)) us_rep (rec__message_tests__coordinate__flags a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep (rec__message_tests__coordinate__x (us_split_fields3 a))) (to_rep (rec__message_tests__coordinate__x (us_split_fields3 b)))) (= (to_rep (rec__message_tests__coordinate__y (us_split_fields3 a))) (to_rep (rec__message_tests__coordinate__y (us_split_fields3 b))))) (= (to_rep (rec__message_tests__coordinate__w (us_split_fields3 a))) (to_rep (rec__message_tests__coordinate__w (us_split_fields3 b))))) (= (bool_eq (rec__message_tests__coordinate__flags (us_split_fields3 a)) (rec__message_tests__coordinate__flags (us_split_fields3 b))) true)) true false))
...
(assert (< message_tests__coordinate__x__first__bit message_tests__coordinate__x__last__bit))
...
(assert (< message_tests__coordinate__y__first__bit message_tests__coordinate__y__last__bit))
...
(assert (< message_tests__coordinate__w__first__bit message_tests__coordinate__w__last__bit))
...
(assert (< message_tests__coordinate__flags__first__bit message_tests__coordinate__flags__last__bit))
(assert (<= 0 message_tests__coordinate__flags__position))
(declare-fun user_eq2 (us_rep1 us_rep1) Bool)
(declare-const dummy2 us_rep1)
(declare-datatypes () ((coordinate__ref (mk_coordinate__ref (coordinate__content us_rep1)))))
(define-fun coordinate__ref___projection ((a coordinate__ref)) us_rep1 (coordinate__content a))
(declare-const c us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const w Float32)
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 w)))
(assert (not (fp.isFinite32 (fp.add RNE (to_rep (rec__message_tests__coordinate__x (us_split_fields3 c))) (to_rep (rec__message_tests__coordinate__y (us_split_fields3 c)))))))
(check-sat)
(exit)
