...
(assert (= c8 o5))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1) (= result35 (mk_t__ref y))))
...
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (= result36 (mk_t__ref y))))
...
(assert (and (= o16 (fp.mul RNE approx1 approx1)) (fp.isFinite32 (fp.mul RNE approx1 approx1))))
(assert (= o17 (fp.sub RNE x1 o16)))
(assert (and (= o18 o17) (fp.isFinite32 o17)))
(assert (= o19 (fp.abs o18)))
(assert (= result47 (ite (fp.lt (fp #b0 #b01110001 #b10100011011011100010111) o19) true false)))
(assert (=> (= result47 true) (= temp___526 approx1)))
...
(assert (=> (= result47 true) (and (= o20 (fp.div RNE x1 approx2)) (fp.isFinite32 (fp.div RNE x1 approx2)))))
(assert (=> (= result47 true) (= o21 (fp.add RNE approx2 o20))))
(assert (=> (= result47 true) (and (= o22 o21) (fp.isFinite32 o21))))
(assert (=> (= result47 true) (= o23 (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) o22))))
(assert (=> (= result47 true) (= result48 (mk_t__ref approx2))))
(assert (=> (= result47 true) (= approx3 o23)))
(assert (=> (= result47 true) (and (= o24 (fp.mul RNE approx3 approx3)) (fp.isFinite32 (fp.mul RNE approx3 approx3)))))
(assert (=> (= result47 true) (= o25 (fp.sub RNE x1 o24))))
(assert (=> (= result47 true) (and (= o26 o25) (fp.isFinite32 o25))))
(assert (=> (= result47 true) (= o27 (fp.abs o26))))
(assert (=> (= result47 true) (= o28 (ite (fp.lt (fp #b0 #b01110001 #b10100011011011100010111) o27) true false))))
(assert (=> (= result47 true) (= result49 (ite (not (= o28 true)) true false))))
