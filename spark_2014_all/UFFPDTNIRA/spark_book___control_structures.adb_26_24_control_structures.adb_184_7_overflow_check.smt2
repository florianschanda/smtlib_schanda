...
(define-fun dynamic_invariant3 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 255)) (in_range3 temp___expr_472)))
...
(define-fun dynamic_invariant4 ((temp___expr_478 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 2 16)) (in_range4 temp___expr_478)))
...
(define-fun dynamic_invariant5 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_514)))
...
(define-fun dynamic_invariant6 ((temp___expr_527 Int) (temp___is_init_524 Bool) (temp___skip_constant_525 Bool) (temp___do_toplevel_526 Bool)) Bool (=> (or (= temp___is_init_524 true) (<= 65 90)) (in_range6 temp___expr_527)))
...
(assert (=> (= result47 true) (= temp___532 approx1)))
