...
(define-fun dynamic_invariant3 ((temp___expr_534 Int) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool) (temp___do_typ_inv_533 Bool)) Bool (=> (or (= temp___is_init_530 true) (<= 0 255)) (in_range3 temp___expr_534)))
...
(define-fun dynamic_invariant4 ((temp___expr_541 Int) (temp___is_init_537 Bool) (temp___skip_constant_538 Bool) (temp___do_toplevel_539 Bool) (temp___do_typ_inv_540 Bool)) Bool (=> (or (= temp___is_init_537 true) (<= 2 16)) (in_range4 temp___expr_541)))
...
(define-fun dynamic_invariant5 ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_579)))
...
(define-fun dynamic_invariant6 ((temp___expr_594 Int) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool) (temp___do_typ_inv_593 Bool)) Bool (=> (or (= temp___is_init_590 true) (<= 65 90)) (in_range6 temp___expr_594)))
...
(declare-const temp___599 Float32)
...
(assert (=> (not (and (< b2 a2) (< c1 a2))) (=> (and (< a2 b2) (< c1 b2)) (= result19 g5))))
(assert (=> (not (and (< b2 a2) (< c1 a2))) (=> (and (< a2 b2) (< c1 b2)) (= g3 7))))
(assert (=> (not (and (< b2 a2) (< c1 a2))) (=> (not (and (< a2 b2) (< c1 b2))) (=> (and (< a2 c1) (< b2 c1)) (= result20 g5)))))
...
(assert (=> (not (and (<= 97 ch1) (<= ch1 122))) (=> (and (<= 65 ch1) (<= ch1 90)) (= result23 h6))))
(assert (=> (not (and (<= 97 ch1) (<= ch1 122))) (=> (and (<= 65 ch1) (<= ch1 90)) (= h2 2))))
(assert (=> (not (and (<= 97 ch1) (<= ch1 122))) (=> (and (<= 65 ch1) (<= ch1 90)) (= success2 success1))))
(assert (=> (not (and (<= 97 ch1) (<= ch1 122))) (=> (not (and (<= 65 ch1) (<= ch1 90))) (=> (and (<= 48 ch1) (<= ch1 57)) (= result24 h6)))))
...
(assert (=> (not (and (<= 97 ch1) (<= ch1 122))) (=> (not (and (<= 65 ch1) (<= ch1 90))) (=> (not (and (<= 48 ch1) (<= ch1 57))) (=> (=> (not (= ch1 46)) (=> (not (= ch1 33)) (= ch1 63))) (= result25 h6))))))
...
(assert (=> (not (and (<= 97 ch1) (<= ch1 122))) (=> (not (and (<= 65 ch1) (<= ch1 90))) (=> (not (and (<= 48 ch1) (<= ch1 57))) (=> (not (=> (not (= ch1 46)) (=> (not (= ch1 33)) (= ch1 63)))) (= result26 h6))))))
...
(assert (=> (not (and (<= 97 ch1) (<= ch1 122))) (=> (not (and (<= 65 ch1) (<= ch1 90))) (=> (not (and (<= 48 ch1) (<= ch1 57))) (=> (not (=> (not (= ch1 46)) (=> (not (= ch1 33)) (= ch1 63)))) (= success2 (distinct 0 0)))))))
...
(assert (=> (< b2 a2) (= c5 o3)))
(assert (=> (not (< b2 a2)) (=> (= a2 b2) (and (= o4 (* 2 a2)) (in_range1 (* 2 a2))))))
(assert (=> (not (< b2 a2)) (=> (= a2 b2) (= result32 (mk_int__ref c4)))))
(assert (=> (not (< b2 a2)) (=> (= a2 b2) (= c6 o4))))
(assert (=> (not (< b2 a2)) (=> (not (= a2 b2)) (= result33 (mk_int__ref c4)))))
...
(assert (=> (not (< b2 a2)) (=> (= a2 b2) (and (= o5 (* 2 a2)) (in_range1 (* 2 a2))))))
(assert (=> (not (< b2 a2)) (=> (not (= a2 b2)) (= o5 (div1 f3 2)))))
(assert (= result34 (mk_int__ref c5)))
(assert (= c8 o5))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1) (= result35 y4)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1) (= y1 (fp.sqrt RNE x1))))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (and (= o6 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) x1)) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) x1)))))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (= o7 (fp.neg o6))))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (= o8 (fp.sqrt RNE o7))))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (= result36 y4)))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (= y2 o8)))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (= y1 y2)))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1) (= o10 x1)))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (and (= o9 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) x1)) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) x1)))))
(assert (=> (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x1)) (= o10 (fp.neg o9))))
...
(assert (=> (=> (not (= letter1 65)) (=> (not (= letter1 69)) (=> (not (= letter1 73)) (=> (not (= letter1 76)) (=> (not (= letter1 85)) (=> (not (= letter1 78)) (=> (not (= letter1 79)) (=> (not (= letter1 82)) (=> (not (= letter1 83)) (= letter1 84)))))))))) (= o14 1)))
(assert (=> (not (=> (not (= letter1 65)) (=> (not (= letter1 69)) (=> (not (= letter1 73)) (=> (not (= letter1 76)) (=> (not (= letter1 85)) (=> (not (= letter1 78)) (=> (not (= letter1 79)) (=> (not (= letter1 82)) (=> (not (= letter1 83)) (= letter1 84))))))))))) (=> (=> (not (= letter1 68)) (= letter1 71)) (= o14 2))))
(assert (=> (not (=> (not (= letter1 65)) (=> (not (= letter1 69)) (=> (not (= letter1 73)) (=> (not (= letter1 76)) (=> (not (= letter1 85)) (=> (not (= letter1 78)) (=> (not (= letter1 79)) (=> (not (= letter1 82)) (=> (not (= letter1 83)) (= letter1 84))))))))))) (=> (not (=> (not (= letter1 68)) (= letter1 71))) (=> (=> (not (= letter1 66)) (=> (not (= letter1 67)) (=> (not (= letter1 77)) (= letter1 80)))) (= o14 3)))))
(assert (=> (not (=> (not (= letter1 65)) (=> (not (= letter1 69)) (=> (not (= letter1 73)) (=> (not (= letter1 76)) (=> (not (= letter1 85)) (=> (not (= letter1 78)) (=> (not (= letter1 79)) (=> (not (= letter1 82)) (=> (not (= letter1 83)) (= letter1 84))))))))))) (=> (not (=> (not (= letter1 68)) (= letter1 71))) (=> (not (=> (not (= letter1 66)) (=> (not (= letter1 67)) (=> (not (= letter1 77)) (= letter1 80))))) (=> (=> (not (= letter1 70)) (=> (not (= letter1 72)) (=> (not (= letter1 86)) (=> (not (= letter1 87)) (= letter1 89))))) (= o14 4))))))
(assert (=> (not (=> (not (= letter1 65)) (=> (not (= letter1 69)) (=> (not (= letter1 73)) (=> (not (= letter1 76)) (=> (not (= letter1 85)) (=> (not (= letter1 78)) (=> (not (= letter1 79)) (=> (not (= letter1 82)) (=> (not (= letter1 83)) (= letter1 84))))))))))) (=> (not (=> (not (= letter1 68)) (= letter1 71))) (=> (not (=> (not (= letter1 66)) (=> (not (= letter1 67)) (=> (not (= letter1 77)) (= letter1 80))))) (=> (not (=> (not (= letter1 70)) (=> (not (= letter1 72)) (=> (not (= letter1 86)) (=> (not (= letter1 87)) (= letter1 89)))))) (=> (= letter1 75) (= o14 5)))))))
(assert (=> (not (=> (not (= letter1 65)) (=> (not (= letter1 69)) (=> (not (= letter1 73)) (=> (not (= letter1 76)) (=> (not (= letter1 85)) (=> (not (= letter1 78)) (=> (not (= letter1 79)) (=> (not (= letter1 82)) (=> (not (= letter1 83)) (= letter1 84))))))))))) (=> (not (=> (not (= letter1 68)) (= letter1 71))) (=> (not (=> (not (= letter1 66)) (=> (not (= letter1 67)) (=> (not (= letter1 77)) (= letter1 80))))) (=> (not (=> (not (= letter1 70)) (=> (not (= letter1 72)) (=> (not (= letter1 86)) (=> (not (= letter1 87)) (= letter1 89)))))) (=> (not (= letter1 75)) (=> (=> (not (= letter1 74)) (= letter1 88)) (= o14 8))))))))
(assert (=> (not (=> (not (= letter1 65)) (=> (not (= letter1 69)) (=> (not (= letter1 73)) (=> (not (= letter1 76)) (=> (not (= letter1 85)) (=> (not (= letter1 78)) (=> (not (= letter1 79)) (=> (not (= letter1 82)) (=> (not (= letter1 83)) (= letter1 84))))))))))) (=> (not (=> (not (= letter1 68)) (= letter1 71))) (=> (not (=> (not (= letter1 66)) (=> (not (= letter1 67)) (=> (not (= letter1 77)) (= letter1 80))))) (=> (not (=> (not (= letter1 70)) (=> (not (= letter1 72)) (=> (not (= letter1 86)) (=> (not (= letter1 87)) (= letter1 89)))))) (=> (not (= letter1 75)) (=> (not (=> (not (= letter1 74)) (= letter1 88))) (= o14 10))))))))
...
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 value2)) (=> (<= (- 2147483648) 2147483647) (in_range1 sum2))))
(assert (in_range5 ada__integer_text_io__get__2__item))
...
(assert (= approx1 (fp.div RNE x1 (fp #b0 #b10000000 #b00000000000000000000000))))
(assert (and (= o15 (fp.mul RNE approx1 approx1)) (fp.isFinite32 (fp.mul RNE approx1 approx1))))
(assert (= o16 (fp.sub RNE x1 o15)))
(assert (and (= o17 o16) (fp.isFinite32 o16)))
(assert (= o18 (fp.abs o17)))
(assert (= result47 (ite (fp.lt (fp #b0 #b01110001 #b10100011011011100010111) o18) true false)))
(assert (=> (= result47 true) (= temp___599 approx1)))
(assert (=> (= result47 true) (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 approx2)) (fp.lt (fp #b0 #b01110001 #b10100011011011100010111) (fp.abs (fp.sub RNE x1 (fp.mul RNE approx2 approx2)))))))
(assert (=> (= result47 true) (and (= o19 (fp.div RNE x1 approx2)) (fp.isFinite32 (fp.div RNE x1 approx2)))))
(assert (=> (= result47 true) (= o20 (fp.add RNE approx2 o19))))
(assert (=> (= result47 true) (and (= o21 o20) (fp.isFinite32 o20))))
(assert (=> (= result47 true) (= o22 (fp.mul RNE (fp #b0 #b01111110 #b00000000000000000000000) o21))))
(assert (=> (= result47 true) (= result48 (mk_t__ref approx2))))
(assert (=> (= result47 true) (= approx3 o22)))
(assert (=> (= result47 true) (and (= o23 (fp.mul RNE approx3 approx3)) (fp.isFinite32 (fp.mul RNE approx3 approx3)))))
...
(assert (=> (= result47 true) (= o27 (ite (fp.lt (fp #b0 #b01110001 #b10100011011011100010111) o26) true false))))
(assert (=> (= result47 true) (= result49 (ite (not (= o27 true)) true false))))
...
(assert (=> (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b)) (and (<= r4b (let ((subject count2)) count13)) (<= (let ((subject count2)) count13) r5b))))
(assert (=> (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b)) (= (let ((subject count2)) count13) r5b)))
(assert (=> (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b)) (= count14 (let ((subject count2)) (mk_int__ref count13)))))
(assert (=> (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b)) (= count15 count13)))
(assert (=> (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b)) (= count16 count14)))
(assert (=> (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b)) (= count17 count15)))
(assert (=> (not (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b))) (= count16 (let ((subject count2)) (mk_int__ref count12)))))
(assert (=> (not (and (<= r4b (let ((subject count2)) count12)) (<= (let ((subject count2)) count12) r5b))) (= count17 count12)))
(assert (= a3 r7b))
...
(assert (=> (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b)) (and (<= r7b (let ((subject count3)) count19)) (<= (let ((subject count3)) count19) r8b))))
(assert (=> (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b)) (= (let ((subject count3)) count19) r7b)))
(assert (=> (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b)) (= count20 (let ((subject count3)) (mk_int__ref count19)))))
(assert (=> (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b)) (= count21 count19)))
(assert (=> (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b)) (= count22 count20)))
(assert (=> (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b)) (= count23 count21)))
(assert (=> (not (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b))) (= count22 (let ((subject count3)) (mk_int__ref count18)))))
(assert (=> (not (and (<= r7b (let ((subject count3)) count18)) (<= (let ((subject count3)) count18) r8b))) (= count23 count18)))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 valve_setting1)) (=> (<= (- 2147483648) 2147483647) (in_range1 temperature1))))
(assert (in_range1 temperature2))
(assert (= temperature2 c10b))
(assert (in_range1 c10b))
(assert (not (in_range1 (* 2 c10b))))
(check-sat)
(exit)
