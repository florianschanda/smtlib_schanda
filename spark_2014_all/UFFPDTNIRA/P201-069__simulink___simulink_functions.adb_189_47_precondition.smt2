...
(assert (forall ((x Float32)) (! (=> (and (dynamic_invariant x true true true) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) x)) (let ((result (log x))) (and (=> (fp.eq x (fp #b0 #b01111111 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant result true false true)))) :pattern ((log x)))))
