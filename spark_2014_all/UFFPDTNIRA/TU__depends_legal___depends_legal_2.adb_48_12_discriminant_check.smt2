...
(assert (=> (= par1__split_discrs true) (=> (= par1__attr__constrained true) (= temp___164 par1__split_discrs))))
(assert (=> (= par1__split_discrs true) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4 usq_5) usq_6) (mk___rep (mk___split_discrs temp___164) (mk___split_fields temp___1641 temp___1642 temp___1643 temp___1644 temp___1645) temp___1646))))
...
(assert (=> (= par1__split_discrs true) (= par1__attr__constrained temp___1666)))
(assert (=> (= par1__split_discrs true) (= result (mk___split_fields__ref (mk___split_fields par1__split_fields par1__split_fields1 par1__split_fields2 par1__split_fields3 par1__split_fields4)))))
(assert (=> (= par1__split_discrs true) (= par1__split_fields5 (mk___split_fields temp___1661 temp___1662 temp___1663 temp___1664 temp___1665))))
(assert (=> (= par1__split_discrs true) (= result1 (mk___split_discrs__ref (mk___split_discrs par1__split_discrs)))))
(assert (=> (= par1__split_discrs true) (= par1__split_discrs1 (mk___split_discrs temp___166))))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_discrs r7b)))
(assert (=> (not (= par1__split_discrs true)) (= (to_rep1 o7) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (= par1__split_discrs true)) (= (to_rep1 o8) (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (=> (not (= par1__split_discrs true)) (= (to_rep1 o9) (fp #b0 #b00000000 #b00000000000000000000000))))
...
(assert (=> (not (= par1__split_discrs true)) (=> (= par1__attr__constrained true) (= temp___161 par1__split_discrs))))
(assert (=> (not (= par1__split_discrs true)) (= usq_7 (mk___rep (mk___split_discrs temp___161) (mk___split_fields temp___1611 temp___1612 temp___1613 temp___1614 temp___1615) temp___1616))))
(assert (=> (not (= par1__split_discrs true)) (= temp___163 (mk___rep (us_split_discrs1 usq_7) (us_split_fields1 usq_7) par1__attr__constrained))))
(assert (=> (not (= par1__split_discrs true)) (= result2 (mk___split_fields__ref (mk___split_fields par1__split_fields par1__split_fields1 par1__split_fields2 par1__split_fields3 par1__split_fields4)))))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_fields6 (us_split_fields1 temp___163))))
(assert (=> (not (= par1__split_discrs true)) (= result3 (mk___split_discrs__ref (mk___split_discrs par1__split_discrs)))))
(assert (=> (not (= par1__split_discrs true)) (= par1__split_discrs2 (us_split_discrs1 temp___163))))
