...
(assert (=> (= par1__split_discrs true) (=> (= par1__attr__constrained true) (= temp___188 par1__split_discrs))))
(assert (=> (= par1__split_discrs true) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4 usq_5) usq_6) (mk___rep (mk___split_discrs temp___188) (mk___split_fields temp___1881 temp___1882 temp___1883 temp___1884 temp___1885) temp___1886))))
...
(assert (=> (not (= par1__split_discrs true)) (= usq_7 (mk___rep (mk___split_discrs temp___185) (mk___split_fields temp___1851 temp___1852 temp___1853 temp___1854 temp___1855) temp___1856))))
(assert (=> (not (= par1__split_discrs true)) (= temp___187 (mk___rep (us_split_discrs1 usq_7) (us_split_fields1 usq_7) par1__attr__constrained))))
