...
(define-fun dynamic_invariant ((temp___expr_141 Float32) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (fp.leq (fp.neg (fp #b0 #b10001000 #b01101000000000000000000)) (fp #b0 #b10001000 #b01101000000000000000000))) (in_range temp___expr_141)))
(declare-sort t2 0)
(define-fun in_range1 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp.neg (fp #b0 #b10000000 #b10000000000000000000000)) x) (fp.leq x (fp #b0 #b10000000 #b00000000000000000000000)))))
...
(define-fun in_range2 ((x1 Float32)) Bool (and (fp.isFinite32 x1) (and (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x1) (fp.leq x1 (fp #b0 #b11111110 #b11111111111111111101110)))))
...
(define-fun dynamic_invariant1 ((temp___expr_135 Float32) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) (fp #b0 #b11111110 #b11111111111111111101110))) (in_range2 temp___expr_135)))
(declare-fun r2 (Float32) Float32)
(declare-fun r2__function_guard (Float32 Float32) Bool)
(assert (forall ((x1 Float32)) (! (=> (and (dynamic_invariant1 x1 true true true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x1)) (dynamic_invariant1 (r2 x1) true false true)) :pattern ((r2 x1)))))
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true) (= (r2 x1) (fp.roundToIntegral RTN x1))) :pattern ((r2 x1)))))
(define-fun dynamic_invariant2 ((temp___expr_147 Float32) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (fp.leq (fp.neg (fp #b0 #b10000000 #b10000000000000000000000)) (fp #b0 #b10000000 #b00000000000000000000000))) (in_range1 temp___expr_147)))
(assert (in_range x))
(assert (not (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) (fp.div RNE x (fp #b0 #b10000111 #b01101000000000000000000)))))
(check-sat)
(exit)
