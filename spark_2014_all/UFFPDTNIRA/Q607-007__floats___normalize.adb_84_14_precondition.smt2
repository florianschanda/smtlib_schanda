...
(define-fun dynamic_invariant1 ((temp___expr_158 Float32) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) (fp #b0 #b11111110 #b11111111111111111101110))) (in_range2 temp___expr_158)))
(declare-fun r2 (Float32) Float32)
(declare-fun r2__function_guard (Float32 Float32) Bool)
(assert (forall ((x1 Float32)) (! (=> (and (dynamic_invariant1 x1 true true true true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) x1)) (dynamic_invariant1 (r2 x1) true false true true)) :pattern ((r2 x1)))))
(assert (forall ((x1 Float32)) (! (=> (dynamic_invariant1 x1 true true true true) (= (r2 x1) (fp.roundToIntegral RTN x1))) :pattern ((r2 x1)))))
(define-fun dynamic_invariant2 ((temp___expr_172 Float32) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (or (= temp___is_init_168 true) (fp.leq (fp.neg (fp #b0 #b10000000 #b10000000000000000000000)) (fp #b0 #b10000000 #b00000000000000000000000))) (in_range1 temp___expr_172)))
(assert (in_range x))
