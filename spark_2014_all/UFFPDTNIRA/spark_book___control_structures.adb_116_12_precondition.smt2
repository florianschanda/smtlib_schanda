...
(assert (and (= o6 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) x1)) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) x1))))
(assert (= o7 (fp.neg o6)))
(assert (not (or (fp.isZero o7) (fp.isPositive o7))))
(check-sat)
(exit)
