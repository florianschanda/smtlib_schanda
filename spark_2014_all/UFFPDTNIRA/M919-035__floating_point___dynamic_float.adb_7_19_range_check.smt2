...
(define-fun dynamic_invariant ((temp___expr_207 Float32) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool) (dynamic_float__L_1__i Int)) Bool (=> (or (= temp___is_init_203 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (last dynamic_float__L_1__i))) (dynamic_property (fp #b0 #b00000000 #b00000000000000000000000) (last dynamic_float__L_1__i) temp___expr_207)))
