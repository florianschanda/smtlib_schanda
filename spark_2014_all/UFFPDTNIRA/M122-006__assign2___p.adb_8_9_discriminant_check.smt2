...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__types__r__i (us_split_discrs1 a))) (to_rep1 (rec__types__r__i (us_split_discrs1 b)))) (=> (types__r__x__pred a) (= (to_rep (rec__types__r__x (us_split_fields1 a))) (to_rep (rec__types__r__x (us_split_fields1 b)))))) (=> (types__r__y__pred a) (= (to_rep2 (rec__types__r__y (us_split_fields1 a))) (to_rep2 (rec__types__r__y (us_split_fields1 b)))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (attr__constrained temp___expr_143) false) (= (to_rep1 (rec__types__r__i (us_split_discrs1 temp___expr_143))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1)) (in_range1 temp___expr_135)))
...
(assert (not (= temp___148 x__split_discrs1)))
(check-sat)
(exit)
