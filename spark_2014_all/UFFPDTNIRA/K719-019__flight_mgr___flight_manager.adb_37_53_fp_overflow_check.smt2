...
(assert (=> (fp.lt target_x position_x) (= result result____split_fields8)))
...
(assert (=> (not (fp.lt target_x position_x)) (=> (fp.lt position_x target_x) (= result1 result____split_fields8))))
...
(assert (not (fp.isFinite32 (fp.sub RNE position_y target_y))))
(check-sat)
(exit)
