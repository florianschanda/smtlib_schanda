...
(assert (= mat_out3 o))
(assert (= (bool_eq mat_out3 1 2 1 2 (temp___1988 (fp #b0 #b10000001 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b00100000000000000000000)) (- 2147483648) (- 2147483647) (- 2147483648) (- 2147483647)) true))
(assert (= o1 (manipulate mat_in21 mat_map21)))
(assert (= result7 mat_out21))
(assert (= mat_out22 o1))
(assert (not (= (bool_eq mat_out22 1 2 1 2 (temp___1998 (fp #b0 #b10000001 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000010 #b00100000000000000000000)) (- 2147483648) (- 2147483647) (- 2147483648) (- 2147483647)) true)))
(check-sat)
(exit)
