...
(declare-datatypes () ((tspeed_km_per_h_tB__ref (mk_tspeed_km_per_h_tB__ref (tspeed_km_per_h_tB__content tspeed_km_per_h_tB)))))
(define-fun tspeed_km_per_h_tB__ref___projection ((a tspeed_km_per_h_tB__ref)) tspeed_km_per_h_tB (tspeed_km_per_h_tB__content a))
...
(assert (not (fp.isFinite32 (fp.mul RNE speed (fp #b0 #b10001000 #b11110100000000000000000)))))
(check-sat)
(exit)
