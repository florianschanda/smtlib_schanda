...
(assert (forall ((x Float64)) (! (=> (and (dynamic_invariant x true true true true) (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) x)) (let ((result (arccosh x))) (and (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) result) (=> (fp.eq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))) (dynamic_invariant result true false true true)))) :pattern ((arccosh x)))))
(declare-const lf Float64)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (fp.isFinite64 lf))
(assert (not (fp.leq (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000) lf)))
(check-sat)
(exit)
