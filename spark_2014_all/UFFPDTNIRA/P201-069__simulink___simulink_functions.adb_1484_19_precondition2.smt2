...
(declare-fun oexpon (Float64 Float64) Float64)
(declare-fun oexpon__function_guard (Float64 Float64 Float64) Bool)
(assert (forall ((left Float64) (right Float64)) (! (=> (and (and (dynamic_invariant left true true true true) (dynamic_invariant right true true true true)) (and (=> (fp.eq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) right)) (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) left))) (let ((result (oexpon left right))) (and (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) result) (and (=> (fp.eq right (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (and (=> (fp.eq right (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result left)) (and (=> (fp.eq left (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (=> (fp.eq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))))) (dynamic_invariant result true false true true)))) :pattern ((oexpon left right)))))
...
(assert (fp.eq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))
(assert (not (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) right)))
(check-sat)
(exit)
