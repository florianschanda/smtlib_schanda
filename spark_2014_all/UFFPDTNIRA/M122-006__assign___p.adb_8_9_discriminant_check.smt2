...
(assert (= rliteral p__bad__x__assume1))
(assert (= dummy1 p__bad__x__assume2))
...
(assert (= (to_rep1 o2) 1))
(assert (= o2 o6))
(assert (= temp___167 o6))
(assert (= temp___1671 o4))
(assert (= temp___1672 o5))
(assert (not (= temp___167 (rec__types__r__i x__split_discrs))))
(check-sat)
(exit)
