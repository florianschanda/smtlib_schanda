...
(assert (forall ((y Float64) (x Float64)) (! (=> (and (and (dynamic_invariant y true true true true) (dynamic_invariant x true true true true)) (or (not (fp.eq x (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (not (fp.eq y (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))) (let ((result (arctan1 y x))) (and (=> (and (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) x) (fp.eq y (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((arctan1 y x)))))
