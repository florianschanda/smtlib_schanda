...
(assert (forall ((left Float64) (right Float64)) (! (=> (and (and (dynamic_invariant left true true true) (dynamic_invariant right true true true)) (and (=> (fp.eq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) right)) (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) left))) (let ((result (oexpon left right))) (and (and (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) result) (and (=> (fp.eq right (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (and (=> (fp.eq right (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result left)) (and (=> (fp.eq left (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (=> (fp.eq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))))) (dynamic_invariant result true false true)))) :pattern ((oexpon left right)))))
