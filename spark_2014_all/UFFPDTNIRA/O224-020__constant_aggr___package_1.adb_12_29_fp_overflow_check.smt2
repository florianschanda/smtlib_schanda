...
(assert (= (mk___rep (mk___split_fields temp___140 temp___1401)) record_const))
...
(assert (and (= o4 (fp.add RNE (fp #b0 #b01111000 #b01000111101011100001010) (to_rep (rec__package_1__record_t__a (us_split_fields1 record_const))))) (fp.isFinite32 (fp.add RNE (fp #b0 #b01111000 #b01000111101011100001010) (to_rep (rec__package_1__record_t__a (us_split_fields1 record_const)))))))
(assert (= result1 res_2))
(assert (= res_21 o4))
(assert (not (fp.isFinite32 (fp.add RNE (fp #b0 #b01111000 #b01000111101011100001010) temp))))
(check-sat)
(exit)
