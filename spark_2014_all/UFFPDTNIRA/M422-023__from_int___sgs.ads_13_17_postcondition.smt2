...
(define-fun dynamic_invariant1 ((temp___expr_135 Float32) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_135)))
(declare-fun c (Int) Float32)
(declare-fun c__function_guard (Float32 Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant1 (c x) true false true)) :pattern ((c x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (c x) (of_int RNE x))) :pattern ((c x)))))
(declare-sort t 0)
...
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 14)) (in_range1 temp___expr_141)))
(declare-const x Int)
...
(assert (not (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) sgs__a__result4)))
(check-sat)
(exit)
