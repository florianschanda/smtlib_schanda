...
(assert (forall ((i nb_type1)) (and (<= 0 (nb_typeqtint1 i)) (<= (nb_typeqtint1 i) 100))))
...
(assert (and (=> (< 0 nb_of_fp2) (fp.leq time2 time3)) (fp.isFinite32 time3)))
...
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) delta_time3)))
(check-sat)
(exit)
