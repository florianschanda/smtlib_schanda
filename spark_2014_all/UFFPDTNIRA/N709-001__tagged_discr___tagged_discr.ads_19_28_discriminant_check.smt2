...
(assert (= (to_int2 (rec__tagged_discr__t__z (us_split_fields1 v))) (to_int2 (of_int1 0))))
(assert (=> (not (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 v))) 0)) (= (to_rep2 (rec__tagged_discr__t__discr (us_split_discrs1 v))) 2)))
(assert (not (tagged_discr__t__x__pred v)))
(check-sat)
(exit)
