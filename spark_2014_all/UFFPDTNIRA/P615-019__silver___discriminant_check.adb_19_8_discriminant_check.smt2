...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__discriminant_check__rec__b Bool)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) Bool (rec__discriminant_check__rec__b a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__discriminant_check__rec__x integer) (rec__discriminant_check__rec__y float)))))
(define-fun us_split_fields_X__projection ((a us_split_fields)) integer (rec__discriminant_check__rec__x a))
(define-fun us_split_fields_Y__projection ((a us_split_fields)) float (rec__discriminant_check__rec__y a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_discrs1 us_split_discrs) (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___2__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun discriminant_check__rec__x__pred ((a us_rep)) Bool (= (ite (rec__discriminant_check__rec__b (us_split_discrs1 a)) 1 0) 1))
(define-fun discriminant_check__rec__y__pred ((a us_rep)) Bool (= (ite (rec__discriminant_check__rec__b (us_split_discrs1 a)) 1 0) 0))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (rec__discriminant_check__rec__b (us_split_discrs1 a)) (rec__discriminant_check__rec__b (us_split_discrs1 b))) (and (=> (discriminant_check__rec__x__pred a) (= (to_rep (rec__discriminant_check__rec__x (us_split_fields1 a))) (to_rep (rec__discriminant_check__rec__x (us_split_fields1 b))))) (=> (discriminant_check__rec__y__pred a) (= (to_rep1 (rec__discriminant_check__rec__y (us_split_fields1 a))) (to_rep1 (rec__discriminant_check__rec__y (us_split_fields1 b))))))) true false))
...
(assert (< discriminant_check__rec__b__first__bit discriminant_check__rec__b__last__bit))
...
(assert (< discriminant_check__rec__x__first__bit discriminant_check__rec__x__last__bit))
...
(assert (< discriminant_check__rec__y__first__bit discriminant_check__rec__y__last__bit))
...
(assert (in_range v))
(assert (not (= (ite (rec__discriminant_check__rec__b r__split_discrs) 1 0) 1)))
(check-sat)
(exit)
