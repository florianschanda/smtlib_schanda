...
(define-fun discriminant_check__rec__x__pred ((a us_rep)) Bool (= (to_int2 (rec__discriminant_check__rec__b (us_split_discrs1 a))) 1))
(define-fun discriminant_check__rec__y__pred ((a us_rep)) Bool (= (to_int2 (rec__discriminant_check__rec__b (us_split_discrs1 a))) 0))
...
(assert (in_range v))
(assert (not (= (to_int2 (rec__discriminant_check__rec__b r__split_discrs)) 1)))
(check-sat)
(exit)
