...
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (of_int RNE numerator)))
(assert (fp.leq (fp #b0 #b01111111 #b00000000000000000000000) (of_int RNE denominator)))
(assert (not (not (fp.isZero (of_int RNE denominator)))))
(check-sat)
(exit)
