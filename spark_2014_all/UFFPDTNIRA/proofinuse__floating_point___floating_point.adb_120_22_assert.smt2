...
(declare-datatypes () ((tfloat_32B__ref (mk_tfloat_32B__ref (tfloat_32B__content tfloat_32B)))))
(define-fun tfloat_32B__ref___projection ((a tfloat_32B__ref)) tfloat_32B (tfloat_32B__content a))
...
(declare-datatypes () ((float_32__ref (mk_float_32__ref (float_32__content float_32)))))
(define-fun float_32__ref___projection ((a float_32__ref)) float_32 (float_32__content a))
(define-fun dynamic_invariant ((temp___expr_208 Float32) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_208)))
(declare-sort t 0)
...
(define-fun dynamic_invariant1 ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 1000000)) (in_range1 temp___expr_239)))
...
(assert (in_range1 x))
(assert (and (< x 1000000) (or (= state (fp #b0 #b00000000 #b00000000000000000000000)) (and (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) state) (fp.leq state (fp.mul RNE (of_int RNE x) (fp #b0 #b10000010 #b01000000000000000000000)))))))
(assert (and (= o (fp.add RNE state (fp #b0 #b10000010 #b01000000000000000000000))) (fp.isFinite32 (fp.add RNE state (fp #b0 #b10000010 #b01000000000000000000000)))))
(assert (= result state))
(assert (= state1 o))
(assert (not (fp.leq state1 (fp.mul RNE (of_int RNE (+ x 1)) (fp #b0 #b10000010 #b01000000000000000000000)))))
(check-sat)
(exit)
