...
(define-fun dynamic_invariant1 ((temp___expr_147 Float32) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (fp.leq (fp.neg (fp #b0 #b10000101 #b00101100000000000000000)) (fp #b0 #b10000101 #b00101100000000000000000))) (in_range temp___expr_147)))
(define-fun dynamic_invariant2 ((temp___expr_153 Float32) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (fp.leq (fp.neg (fp #b0 #b10000110 #b01100111111111111111111)) (fp #b0 #b10000110 #b01101000000000000000000))) (in_range1 temp___expr_153)))
...
(assert (= lat_long__delta_lat_in_meters__result1 lat_long__delta_lat_in_meters__result2))
(assert (= lat_long__delta_lat_in_meters__result3 lat_long__delta_lat_in_meters__result1))
(assert (= result lat_long__delta_lat_in_meters__result))
(assert (= lat_long__delta_lat_in_meters__result1 (fp.mul RNE (fp.mul RNE (fp.sub RNE (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 destination))) (to_rep (rec__lat_long__coordinates__lat (us_split_fields1 source)))) (fp #b0 #b10010101 #b10000100101000110101001)) (fp #b0 #b01111001 #b00011101111101000110101))))
(assert (= (mk_t__ref lat_long__delta_lat_in_meters__result4) (mk_t__ref lat_long__delta_lat_in_meters__result2)))
(assert (= lat_long__delta_lat_in_meters__result5 lat_long__delta_lat_in_meters__result3))
(assert (= result1 lat_long__delta_lat_in_meters__result4))
(assert (not (= (olt (fp.abs lat_long__delta_lat_in_meters__result4) (fp #b0 #b10010111 #b00110001001111000100110)) true)))
(check-sat)
(exit)
