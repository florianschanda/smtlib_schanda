...
(define-fun default_initial_assumption ((temp___expr_192 us_rep) (temp___skip_top_level_193 Bool)) Bool (= (attr__tag temp___expr_192) us_tag))
...
(assert true)
(assert true)
(assert (forall ((v us_rep)) (! (= (ite (is_zero__2 v) 1 0) (ite (is_zero__21 us_tag v) 1 0)) :pattern ((is_zero__21 us_tag v)))))
...
(assert (not (= (is_zero__2 (mk___rep (mk___split_fields v__split_fields16 v__split_fields17 v__split_fields18 v__split_fields19) v__attr__tag)) true)))
(check-sat)
(exit)
