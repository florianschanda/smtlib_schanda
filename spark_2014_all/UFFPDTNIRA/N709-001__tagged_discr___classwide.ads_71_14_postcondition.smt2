...
(define-fun default_initial_assumption ((temp___expr_165 us_rep) (temp___skip_top_level_166 Bool)) Bool (= (attr__tag temp___expr_165) us_tag))
...
(assert true)
(assert true)
(assert (forall ((v us_rep)) (! (= (to_int2 (is_zero__2 v)) (to_int2 (is_zero__21 us_tag v))) :pattern ((is_zero__21 us_tag v)))))
