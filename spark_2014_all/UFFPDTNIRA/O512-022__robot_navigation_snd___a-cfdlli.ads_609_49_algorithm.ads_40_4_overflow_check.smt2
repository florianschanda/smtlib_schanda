...
(define-fun us_split_fields_Theta__projection ((a us_split_fields4)) normalized2pi (rec__spaces__angles__angle__theta a))
...
(define-fun dynamic_invariant1 ((temp___expr_521 Int) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool) (temp___do_typ_inv_520 Bool)) Bool (=> (or (= temp___is_init_517 true) (<= 1 2147483647)) (in_range5 temp___expr_521)))
...
(assert (not (in_range1 (- (to_rep (rec__algorithm__gap_vectors__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
