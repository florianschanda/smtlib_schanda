...
(define-fun dynamic_invariant ((temp___expr_481 Int) (temp___is_init_477 Bool) (temp___skip_constant_478 Bool) (temp___do_toplevel_479 Bool) (temp___do_typ_inv_480 Bool)) Bool (=> (or (= temp___is_init_477 true) (<= 1 2147483647)) (in_range1 temp___expr_481)))
...
(define-fun dynamic_invariant1 ((temp___expr_365 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range5 temp___expr_365)))
...
(define-fun dynamic_invariant2 ((temp___expr_499 Int) (temp___is_init_495 Bool) (temp___skip_constant_496 Bool) (temp___do_toplevel_497 Bool) (temp___do_typ_inv_498 Bool)) Bool (=> (or (= temp___is_init_495 true) (<= 0 2147483647)) (in_range6 temp___expr_499)))
...
(define-fun dynamic_invariant4 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range3 temp___expr_198)))
(define-fun dynamic_invariant5 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 1) 1)) (in_range4 temp___expr_323)))
(assert true)
(declare-const o Int)
