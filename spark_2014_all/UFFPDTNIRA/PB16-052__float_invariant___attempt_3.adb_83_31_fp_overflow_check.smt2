...
(assert (forall ((i tframeB)) (and (<= (- 32768) (tframeBqtint i)) (<= (tframeBqtint i) 32767))))
...
(assert (fp.leq (low_bound (+ n 1)) (fp.sub RNE (low_bound n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))))
(assert (fp.leq (low_bound (+ n 1)) new_speed1))
(assert (not (fp.isFinite64 (fp.add RNE old_speed new_speed1))))
(check-sat)
(exit)
