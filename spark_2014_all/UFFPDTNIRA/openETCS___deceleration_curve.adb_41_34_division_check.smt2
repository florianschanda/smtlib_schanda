...
(assert (and (= o1 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) speed2)) (fp.isFinite32 (fp.div RNE (fp #b0 #b01111111 #b00000000000000000000000) speed2))))
(assert (= o2 (ite (fp.lt o1 (fp #b0 #b10000010 #b01000000000000000000000)) true false)))
