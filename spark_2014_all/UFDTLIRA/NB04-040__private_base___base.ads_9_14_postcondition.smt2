...
(assert (forall ((attr__tag1 Int)) (forall ((x us_rep)) (! (dynamic_invariant (sum1 attr__tag1 x) true false true) :pattern ((sum1 attr__tag1 x))))))
...
(assert (= (mk___rep (mk___split_fields base__create__result9 base__create__result10) base__create__result11) (mk___rep (mk___split_fields base__create__result3 base__create__result4) base__create__result5)))
(assert (= (to_rep o) c))
(assert (= o o1))
...
(assert (= (mk___rep (mk___split_fields base__create__result3 base__create__result4) base__create__result5) (mk___rep (mk___split_fields o3 o4) o5)))
