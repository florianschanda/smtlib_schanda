...
(define-fun dynamic_invariant ((temp___expr_181 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 2147483647)) (in_range temp___expr_181)))
(define-fun default_initial_assumption ((temp___expr_182 Int) (temp___skip_top_level_183 Bool)) Bool (and (= temp___expr_182 0) (=> (not (= temp___skip_top_level_183 true)) (= (wrong_ok temp___expr_182) true))))
