...
(declare-const temp___191 status)
(declare-const temp___1911 natural)
(declare-const temp___1912 natural)
(declare-const temp___1913 Bool)
(declare-const temp___1914 Bool)
...
(assert (= (to_rep1 o) 2))
(assert (= o o5))
(assert (= temp___191 o5))
(assert (= temp___1911 o2))
(assert (= temp___1912 o3))
(assert (= temp___1913 o4))
(assert (= true temp___1914))
(assert (= g__attr__constrained true))
(assert (not (= temp___191 g__split_discrs)))
(check-sat)
(exit)
