...
(assert (<= (length q) 100))
(assert (and (= o17 (length q)) (and (in_range3 o17) (<= (+ 0 o17) 2147483647))))
(assert (and (= o14 (length v)) (and (in_range3 o14) (<= (+ 0 o14) 2147483647))))
(assert (and (= o15 (length p)) (and (in_range3 o15) (<= (+ 0 o15) 2147483647))))
(assert (= o16 (- o15 o14)))
(assert (and (= o18 o16) (in_range1 o16)))
(assert (= result2 (ite (= o18 o17) true false)))
(assert (=> (= result2 true) (and (= o12 (length q)) (and (in_range3 o12) (<= (+ 0 o12) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o10 (length v)) (and (in_range3 o10) (<= (+ 0 o10) 2147483647)))))
