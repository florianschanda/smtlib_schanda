...
(assert (= (integerqtint rliteral) 2147483647))
...
(assert (= rliteral c1__split_fields2))
(assert (= us_null_ext__ c1__split_fields3))
...
(assert (= rliteral1 c2__split_fields3))
(assert (= rliteral c2__split_fields4))
(assert (= us_null_ext__ c2__split_fields5))
