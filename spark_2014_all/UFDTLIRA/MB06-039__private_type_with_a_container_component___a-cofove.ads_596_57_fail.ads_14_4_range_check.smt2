...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__fail__my_lists__vector__capacity (us_split_discrs1 container))) 3))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 3)) (in_range1 temp___expr_214)))
...
(define-fun dynamic_invariant1 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 4)) (in_range2 temp___expr_269)))
...
(define-fun dynamic_invariant2 ((temp___expr_255 Int) (temp___is_init_251 Bool) (temp___skip_constant_252 Bool) (temp___do_toplevel_253 Bool) (temp___do_typ_inv_254 Bool)) Bool (=> (or (= temp___is_init_251 true) (<= 1 3)) (in_range3 temp___expr_255)))
...
(define-fun dynamic_invariant4 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= 0 3)) (in_range5 temp___expr_294)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 3) (dynamic_invariant3 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_287)))
