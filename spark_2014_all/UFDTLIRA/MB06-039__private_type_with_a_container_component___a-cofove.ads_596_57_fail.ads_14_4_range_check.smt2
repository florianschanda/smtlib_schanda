...
(define-fun dynamic_invariant1 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 4)) (in_range3 temp___expr_231)))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant2 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 3)) (in_range2 temp___expr_183)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__fail__my_lists__vector__capacity (us_split_discrs1 container))) 3))
...
(define-fun dynamic_invariant3 ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= 1 3)) (in_range4 temp___expr_219)))
...
(define-fun default_initial_assumption ((temp___expr_260 us_rep1) (temp___skip_top_level_261 Bool)) Bool (=> (not (= temp___skip_top_level_261 true)) (= (length1 temp___expr_260) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_253 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 3)) (in_range5 temp___expr_253)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 3) (dynamic_invariant result true false true))) :pattern ((length1 container)))))
