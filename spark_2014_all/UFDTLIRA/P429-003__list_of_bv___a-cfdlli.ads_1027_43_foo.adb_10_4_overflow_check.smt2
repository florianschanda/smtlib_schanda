...
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__foo__lists__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__foo__lists__list__capacity target__split_discrs)) o2)))
