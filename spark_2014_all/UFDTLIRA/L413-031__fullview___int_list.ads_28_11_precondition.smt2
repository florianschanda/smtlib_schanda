...
(assert (= result8 true))
(assert (and (= o29 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) c1)) (and (in_range1 o29) (= o29 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1))))))
(assert (= o30 (+ o29 1)))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) c1) true)))
(check-sat)
(exit)
