...
(assert (and (= o8 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range2 o8) (<= o8 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
(assert (and (= o9 (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (in_range2 o9) (<= o9 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
...
(assert (= result5 true))
(assert (and (= o6 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) c)) (and (in_range1 o6) (= o6 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c))))))
(assert (= o7 (+ o6 1)))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) c) true)))
(check-sat)
(exit)
