...
(assert (= r__split_fields3 (mk___split_fields1 temp___407 (mk___rep (mk___split_fields temp___4071 temp___4072)))))
...
(assert (not (= (bool_eq1 (optional_pair__content records__make_optional_pair_a_1__result6) (mk___rep1 (mk___split_fields1 (of_int 1) x))) true)))
(check-sat)
(exit)
