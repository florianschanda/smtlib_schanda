...
(declare-const temp___4401 unsigned_byte)
(declare-const temp___4402 unsigned_byte)
...
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= temp___440 o6))
(assert (= temp___4401 o7))
(assert (= temp___4402 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= r__split_fields3 (mk___split_fields1 temp___440 (mk___rep (mk___split_fields temp___4401 temp___4402)))))
...
(assert (= result4 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__make_optional_pair_a_1__result (mk___rep (mk___split_fields records__make_optional_pair_a_1__result1 records__make_optional_pair_a_1__result2)))))))
(assert (= records__make_optional_pair_a_1__result3 (mk___rep1 r__split_fields4)))
...
(assert (= (mk___rep1 (mk___split_fields1 result5 (mk___rep (mk___split_fields result6 result7)))) (optional_pair__content records__make_optional_pair_a_1__result6)))
