...
(assert (not (= (get (model__ (mk___rep front__split_discrs front__split_fields4)) (- (+ (last (model__ (mk___rep front__split_discrs front__split_fields4))) idx3) i)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i))))
(check-sat)
(exit)
