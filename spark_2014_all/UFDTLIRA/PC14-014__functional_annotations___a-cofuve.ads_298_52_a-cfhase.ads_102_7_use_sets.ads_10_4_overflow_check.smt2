...
(define-fun dynamic_invariant ((temp___expr_408 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool) (temp___do_typ_inv_407 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range1 temp___expr_408)))
...
(define-fun dynamic_invariant3 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 2147483647)) (in_range5 temp___expr_422)))
