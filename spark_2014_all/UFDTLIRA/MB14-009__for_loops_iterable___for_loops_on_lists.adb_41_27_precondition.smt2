...
(assert (and (= o5 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o5 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o5) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o5) 1)))))
...
(assert (and (= o3 (length (mk___rep l__split_discrs l__split_fields1))) (and (in_range1 o3) (<= o3 (to_rep (rec__for_loops_on_lists__my_lists__list__capacity l__split_discrs))))))
