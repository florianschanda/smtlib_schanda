...
(define-fun o7 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___499 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___499)) no_element))
(assert (and (= o7 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o7) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o7) 1)))))
...
(assert (and (= o5 (length (mk___rep l__split_discrs l__split_fields1))) (and (in_range1 o5) (<= o5 (to_rep (rec__for_loops_on_lists__my_lists__list__capacity l__split_discrs))))))
