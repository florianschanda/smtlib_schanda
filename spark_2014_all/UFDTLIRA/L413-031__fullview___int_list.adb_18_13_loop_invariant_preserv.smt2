...
(assert (and (= o23 (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 c__split_fields2))) (and (in_range1 o23) (= o23 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2)))))))
(assert (= o24 (+ o23 1)))
...
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2)) 1)))))
(assert (and (= o26 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3))) (= (= o26 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) true))))
(assert (= result5 (ite (not (= o26 true)) true false)))
(assert (not (= result5 true)))
(declare-const i2 Int)
(assert (<= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) i2))
(assert (<= i2 (length (mk___rep l__split_discrs l__split_fields3))))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i2) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2))))
(check-sat)
(exit)
