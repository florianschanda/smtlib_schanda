...
(assert (= result3 a22))
(assert (= a23 o7))
(assert (and (= call_actuals__fnt__y (+ call_actuals__fnt__x 1)) (and (in_range3 call_actuals__fnt__x) (in_range3 call_actuals__fnt__y))))
...
(assert (= result5 a23))
(assert (= a24 o11))
(assert (and (= o12 a24) (in_range4 a24)))
(assert (and (= o13 o12) (in_range4 o12)))
(assert (= o13 call_actuals__fs__y))
(assert (and (= o14 a14) (in_range4 a14)))
(assert (and (= o15 o14) (in_range4 o14)))
(assert (= o15 call_actuals__fs__x))
(assert (and (= call_actuals__fs__y1 (+ call_actuals__fs__x1 1)) (and (in_range4 call_actuals__fs__x1) (in_range4 call_actuals__fs__y1))))
(assert (and (= o16 call_actuals__fs__x1) (in_range2 call_actuals__fs__x1)))
(assert (= (to_rep o17) o16))
(assert (= o18 (to_rep o17)))
(assert (= result6 a14))
(assert (= a15 o18))
(assert (not (in_range2 call_actuals__fs__y1)))
(check-sat)
(exit)
