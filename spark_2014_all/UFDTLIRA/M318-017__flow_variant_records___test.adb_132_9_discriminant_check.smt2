...
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= (to_rep o) 12)))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= o o1)))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= r__split_fields1 o2)))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= r__split_discrs (mk___split_discrs temp___282))))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= temp___2821 o1)))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= temp___2822 o2)))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= r__attr__constrained temp___2823)))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= result (mk___split_fields__ref (mk___split_fields r__split_fields r__split_fields1)))))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= r__split_fields2 (mk___split_fields temp___2821 temp___2822))))
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= r__split_discrs (mk___split_discrs temp___282))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= (to_rep1 o3) 0)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= dummy o4)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= o3 o5)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= (of_int 0) o6)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= o7 o4)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= o8 o5)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= true o9)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= (mk___rep (mk___split_discrs o10) (mk___split_fields o11 o12) o13) (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= (mk___rep (mk___split_discrs o14) (mk___split_fields o15 o16) o17) (mk___rep (mk___split_discrs o10) (mk___split_fields o11 o12) o13))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= (mk___rep (mk___split_discrs temp___283) (mk___split_fields temp___2831 temp___2832) temp___2833) (mk___rep (mk___split_discrs o14) (mk___split_fields o15 o16) o17))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= result1 (mk___split_fields__ref (mk___split_fields r__split_fields r__split_fields1)))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= r__split_fields3 (mk___split_fields temp___2831 temp___2832))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= r__split_discrs (mk___split_discrs temp___283))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= r__split_fields2 r__split_fields3)))
