...
(declare-const temp___315 Bool)
(declare-const temp___3151 integer)
(declare-const temp___3152 failure_reason)
(declare-const temp___3153 Bool)
...
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= (to_rep o) 12)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= o o1)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= r__split_fields1 o2)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= r__split_discrs (mk___split_discrs temp___315))))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= temp___3151 o1)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= temp___3152 o2)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= r__attr__constrained temp___3153)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= result r__split_fields4)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= r__split_fields2 (mk___split_fields temp___3151 temp___3152))))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= r__split_discrs (mk___split_discrs temp___315))))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= (to_rep1 o3) 0)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= dummy o4)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o3 o5)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= (distinct 0 0) o6)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o7 o4)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o8 o5)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= true o9)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o19 (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o18 o19)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= (mk___rep (mk___split_discrs temp___316) (mk___split_fields temp___3161 temp___3162) temp___3163) o18)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= result1 r__split_fields4)))
