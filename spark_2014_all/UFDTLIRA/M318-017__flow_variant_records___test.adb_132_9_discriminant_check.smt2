...
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o14) (mk___split_fields o15 o16) o17))
(define-fun o19 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 o12) o13))
(define-fun r__split_fields4 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields r__split_fields r__split_fields1)))
...
(assert (=> (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1) (= result r__split_fields4)))
...
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= o19 (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= o18 o19)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= (mk___rep (mk___split_discrs temp___283) (mk___split_fields temp___2831 temp___2832) temp___2833) o18)))
(assert (=> (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)) (= result1 r__split_fields4)))
