...
(declare-const o5 yearst)
(declare-const o6 monthst)
(declare-const o7 dayst)
(declare-const o8 millisecst)
(declare-const o9 yearst)
(declare-const o10 monthst)
(declare-const o11 dayst)
(declare-const o12 millisecst)
...
(define-fun o41 () us_rep1 (mk___rep1 (mk___split_fields1 o9 o10 o11 o12)))
(define-fun o42 () us_rep1 (mk___rep1 (mk___split_fields1 o5 o6 o7 o8)))
(assert (in_range10 status))
(assert (and (= o33 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o33)))
(assert (= result (ite (= o33 1) true false)))
(assert (=> (= result true) (= o37 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o38 (ite (not (= o37 true)) true false))))
(assert (=> (= result true) (and (= o34 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o34))))
(assert (=> (= result true) (= o35 (ite (= o34 3) true false))))
(assert (=> (= result true) (= o36 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o39 (ite (= o36 true) o35 false))))
(assert (=> (= result true) (= o40 (ite (= o39 false) o38 true))))
(assert (=> (not (= result true)) (= o40 (of_int 1))))
(assert (and (= o28 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o28)))
(assert (= o29 (ite (= o28 3) true false)))
(assert (= o30 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result1 (ite (= o30 true) o29 false)))
(assert (=> (= result1 true) (and (= o31 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o31))))
(assert (=> (= result1 true) (= o32 (ite (= o31 1) true false))))
(assert (=> (not (= result1 true)) (= o32 (of_int 1))))
(assert (and (= o21 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o21)))
(assert (= result2 (ite (= o21 1) true false)))
(assert (=> (= result2 true) (and (= o24 (theauthcertrole state)) (in_range1 o24))))
(assert (=> (= result2 true) (= o25 (ite (= o24 1) true false))))
(assert (=> (= result2 true) (= o22 (authcertvalid state))))
(assert (=> (= result2 true) (= o23 (isgood state))))
(assert (=> (= result2 true) (= o26 (ite (= o23 true) o22 false))))
(assert (=> (= result2 true) (= o27 (ite (= o26 true) o25 false))))
(assert (=> (not (= result2 true)) (= o27 (of_int 1))))
(assert (and (= o16 (thedooralarm state2)) (in_range9 o16)))
(assert (= o17 (ite (= o16 0) true false)))
(assert (= o18 (to_int1 o17)))
(assert (= o41 (alarm_timeout state2)))
(assert (= o42 (thecurrenttime currenttime)))
(assert (= o13 (greaterthanorequal o42 o41)))
(assert (and (= o2 (thecurrentdoor state2)) (in_range8 o2)))
(assert (= o3 (ite (= o2 0) true false)))
(assert (= o4 (islocked state1)))
(assert (= o14 (ite (= o4 true) o3 false)))
(assert (= o15 (ite (= o14 true) o13 false)))
(assert (= o19 (to_int1 o15)))
(assert (= o20 (ite (= o19 o18) true false)))
(assert (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= o (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
