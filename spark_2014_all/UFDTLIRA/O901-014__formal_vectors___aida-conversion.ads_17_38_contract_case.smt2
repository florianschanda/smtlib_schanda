...
(assert (=> (= (= source 54) true) (= aida__conversion__convert_character_digit_to_integer__result4 6)))
(assert (=> (= (= source 55) true) (= aida__conversion__convert_character_digit_to_integer__result4 7)))
(assert (= (= source 56) true))
(assert (not (= aida__conversion__convert_character_digit_to_integer__result4 8)))
(check-sat)
(exit)
