...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (bad_priority us_void_param) true false true true) :pattern ((bad_priority us_void_param)))))
...
(assert (not (<= (bad_priority Tuple0) 97)))
(check-sat)
(exit)
