...
(assert (not (= (bool_eq2 (mk___rep2 (us_split_fields__content2 r__split_fields11)) (mk___rep2 (mk___split_fields2 (mk___rep1 (let ((usq_ (us_split_fields3 a))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_) b (rec__ar__rec2t__h2 usq_)))) r__split_fields4))) true)))
(check-sat)
(exit)
