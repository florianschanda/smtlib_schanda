...
(assert (forall ((left us_rep) (right us_rep)) (! (= (= (oeq1 left right) true) (= (oeq (model__ left) (model__ right)) true)) :pattern ((oeq1 left right)))))
...
(assert (= (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 left))) (to_rep (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity (us_split_discrs1 (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 left)))))))
(assert (= (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 right))) (to_rep (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity (us_split_discrs1 (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 right)))))))
(assert (not (in_range1 (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 left))))))
(check-sat)
(exit)
