...
(assert (forall ((i my_range)) (and (<= 1 (my_rangeqtint i)) (<= (my_rangeqtint i) 5))))
...
(assert (in_range r4b))
(assert (and (= us r4b) (in_range1 r4b)))
(assert (and (= discr_checks__check_derived_priv__R5b__assume (bad Tuple0)) (and (in_range discr_checks__check_derived_priv__R5b__assume) (= discr_checks__check_derived_priv__R5b__assume 6))))
(assert (= discr_checks__check_derived_priv__R5b__assume r5b))
(assert (in_range r5b))
(assert (not (in_range1 r4b)))
(check-sat)
(exit)
