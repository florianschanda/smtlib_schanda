...
(assert (and (= o51 (next (mk___rep l3__split_discrs l3__split_fields2) o50)) (ite (= (ite (= (bool_eq1 o50 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o50) (length (mk___rep l3__split_discrs l3__split_fields2))) true) true) (= (bool_eq1 o51 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o51) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o51) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o50) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o51) true) (= (bool_eq1 o51 no_element) true))))
(check-sat)
(exit)
