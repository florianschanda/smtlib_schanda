...
(assert (= (mk___rep (mk___split_fields usq_ usq_1) usq_2) y))
(assert (= usq_ temp___149))
(assert (= usq_1 temp___1491))
(assert (= x__attr__tag temp___1492))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= x__split_fields2 temp___149))
(assert (= x__split_fields3 temp___1491))
(assert (not false))
(check-sat)
(exit)
