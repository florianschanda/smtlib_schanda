...
(declare-const temp___639 integer)
(declare-const temp___6391 integer)
(declare-const temp___6392 integer)
(declare-const temp___6393 us_private)
(declare-const temp___6394 Int)
...
(assert (= temp___639 o2))
(assert (= temp___6391 o3))
(assert (= temp___6392 o4))
(assert (= temp___6393 o5))
(assert (= arg__attr__tag temp___6394))
...
(assert (= temp___639 arg__split_fields4))
(assert (= temp___6391 arg__split_fields5))
(assert (= temp___6392 arg__split_fields6))
(assert (= temp___6393 arg__split_fields7))
