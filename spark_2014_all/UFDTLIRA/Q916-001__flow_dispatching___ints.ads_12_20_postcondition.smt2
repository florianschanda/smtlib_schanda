...
(declare-const temp___569 integer)
(declare-const temp___5691 integer)
(declare-const temp___5692 integer)
(declare-const temp___5693 us_private)
(declare-const temp___5694 Int)
...
(assert (and (= o (+ (to_rep arg__split_fields2) 1)) (in_range (+ (to_rep arg__split_fields2) 1))))
(assert (= (to_rep o1) o))
(assert (= arg__split_fields o2))
(assert (= arg__split_fields1 o3))
(assert (= o1 o4))
(assert (= arg__split_fields3 o5))
(assert (= temp___569 o2))
(assert (= temp___5691 o3))
(assert (= temp___5692 o4))
(assert (= temp___5693 o5))
(assert (= arg__attr__tag temp___5694))
(assert (= result arg__split_fields))
(assert (= result1 arg__split_fields1))
(assert (= result2 arg__split_fields2))
(assert (= result3 arg__split_fields3))
(assert (= temp___569 arg__split_fields4))
(assert (= temp___5691 arg__split_fields5))
(assert (= temp___5692 arg__split_fields6))
(assert (= temp___5693 arg__split_fields7))
...
(assert (= arg__split_fields12 arg__split_fields4))
(assert (= arg__split_fields13 arg__split_fields5))
(assert (= arg__split_fields14 arg__split_fields6))
(assert (= arg__split_fields15 arg__split_fields7))
