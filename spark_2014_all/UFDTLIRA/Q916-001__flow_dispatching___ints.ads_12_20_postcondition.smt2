...
(declare-const temp___563 integer)
(declare-const temp___5631 integer)
(declare-const temp___5632 integer)
(declare-const temp___5633 us_private)
(declare-const temp___5634 Int)
...
(assert (= temp___563 o2))
(assert (= temp___5631 o3))
(assert (= temp___5632 o4))
(assert (= temp___5633 o5))
(assert (= arg__attr__tag temp___5634))
...
(assert (= temp___563 arg__split_fields4))
(assert (= temp___5631 arg__split_fields5))
(assert (= temp___5632 arg__split_fields6))
(assert (= temp___5633 arg__split_fields7))
