...
(assert (not (= idx3 r4b)))
(assert (= result2 (mk_int__ref idx3)))
(assert (= idx4 (+ idx3 1)))
(assert (and (= o8 idx4) (in_range3 idx4)))
(assert (and (= o9 (get (model__ left) o8)) (and (in_range6 o9) (= o9 (get (model__ left) o8)))))
(assert (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3)))) 1)) o9)))
(assert (= result3 (mk___split_fields__ref (mk___split_fields result____split_fields3))))
(assert (= result____split_fields4 amortized_queue__my_vectors__append__2__container__fields1))
(assert (not (= (length (mk___rep result____split_discrs result____split_fields4)) idx4)))
(check-sat)
(exit)
