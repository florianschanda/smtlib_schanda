...
(assert (and (= (rec__tests__test_15__holder__present h1__split_discrs) (of_int 0)) (and (= h1__split_fields2 true) (= h1__split_fields (of_int 0)))))
(assert (dynamic_invariant1 (mk___rep2 h1__split_discrs (mk___split_fields2 (mk___rep (mk___split_discrs h1__split_fields) (mk___split_fields h1__split_fields1) h1__split_fields2))) false false true))
(assert (and (= (mk___rep1 (mk___split_discrs1 tests__test_15__R17b__assume) (mk___split_fields1 (mk___rep (mk___split_discrs tests__test_15__R17b__assume1) (mk___split_fields tests__test_15__R17b__assume2) tests__test_15__R17b__assume3))) (id (mk___rep1 h1__split_discrs (mk___split_fields1 (mk___rep (mk___split_discrs h1__split_fields) (mk___split_fields h1__split_fields1) h1__split_fields2))))) (and (dynamic_invariant (mk___rep1 (mk___split_discrs1 tests__test_15__R17b__assume) (mk___split_fields1 (mk___rep (mk___split_discrs tests__test_15__R17b__assume1) (mk___split_fields tests__test_15__R17b__assume2) tests__test_15__R17b__assume3))) true false true) (and (= h1__split_discrs (mk___split_discrs1 tests__test_15__R17b__assume)) (and (= h1__split_fields tests__test_15__R17b__assume1) (and (= h1__split_fields1 tests__test_15__R17b__assume2) (= h1__split_fields2 tests__test_15__R17b__assume3)))))))
(assert (= (mk___rep1 (mk___split_discrs1 tests__test_15__R17b__assume) (mk___split_fields1 (mk___rep (mk___split_discrs tests__test_15__R17b__assume1) (mk___split_fields tests__test_15__R17b__assume2) tests__test_15__R17b__assume3))) r17b))
(assert (dynamic_invariant r17b true false true))
(assert (not (in_range (to_int1 (rec__tests__test_15__holder__present (us_split_discrs3 r17b))))))
(check-sat)
(exit)
