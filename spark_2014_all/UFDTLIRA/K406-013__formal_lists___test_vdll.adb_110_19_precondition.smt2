...
(assert (and (= o58 (first (mk___rep l4__split_discrs l4__split_fields2))) (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields2)) 0) true) (= (bool_eq1 o58 no_element) true) (and (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) o58) true) (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields2)) o58) 1)))))
(assert (not (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) o58) true)))
(check-sat)
(exit)
