...
(assert (= (invariant__ (rec__foo__level_2__c1 (let ((subject black__split_fields)) black__split_fields1)) (rec__foo__level_2__c2 (let ((subject black__split_fields)) black__split_fields1)) (rec__foo__level_2__c3 (let ((subject black__split_fields)) black__split_fields1))) true))
