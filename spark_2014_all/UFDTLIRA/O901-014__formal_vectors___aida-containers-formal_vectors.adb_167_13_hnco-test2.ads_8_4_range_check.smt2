...
(define-fun dynamic_invariant ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_201)))
...
(assert (forall ((container1 us_rep)) (forall ((item1 Int)) (! (=> (dynamic_invariant2 item1 true true true) (= (= (contains1 container1 item1) true) (= (contains (model__ container1) 1 (last_index container1) item1) true))) :pattern ((contains1 container1 item1))))))
...
(define-fun dynamic_invariant4 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range1 temp___expr_213)))
...
(define-fun dynamic_invariant5 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 2147483647)) (in_range6 temp___expr_377)))
(define-fun dynamic_invariant6 ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= 0 2147483647)) (in_range2 temp___expr_219)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant6 result true false true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant7 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 0 2147483647)) (in_range8 temp___expr_399)))
...
(define-fun dynamic_invariant8 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= (- 2147483648) 2147483647)) (in_range9 temp___expr_393)))
