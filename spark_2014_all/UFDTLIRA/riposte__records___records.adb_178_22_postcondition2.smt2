...
(declare-const temp___3251 unsigned_byte)
(declare-const temp___3252 unsigned_byte)
...
(assert (= tmp1 (to_rep x__split_fields1)))
...
(assert (= x__split_fields3 (mk___split_fields1 temp___325 (mk___rep (mk___split_fields temp___3251 temp___3252)))))
...
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= temp___328 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15))))))
(assert (= result2 (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___328)))
