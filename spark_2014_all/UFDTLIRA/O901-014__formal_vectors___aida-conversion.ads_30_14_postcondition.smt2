...
(assert (=> (= (= source 49) true) (= target2 1)))
(assert (=> (= (= source 50) true) (= target2 2)))
(assert (=> (= (= source 51) true) (= target2 3)))
(assert (=> (= (= source 52) true) (= target2 4)))
(assert (=> (= (= source 53) true) (= target2 5)))
(assert (=> (= (= source 54) true) (= target2 6)))
(assert (=> (= (= source 55) true) (= target2 7)))
(assert (=> (= (= source 56) true) (= target2 8)))
(assert (=> (= (= source 57) true) (= target2 9)))
(assert (not (<= 0 target2)))
(check-sat)
(exit)
