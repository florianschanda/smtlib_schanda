...
(assert (=> (= result2 true) (and (= o8 (length m)) (and (in_range4 o8) (<= o8 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o8 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o6 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o6) (<= o6 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
...
(assert (and (= o5 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o4)) (and (in_range5 o5) (= o5 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o4)))))
