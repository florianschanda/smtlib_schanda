...
(assert (=> (= result1 true) (and (= o9 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o9) (<= o9 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
(assert (=> (= result1 true) (= o10 (ite (<= i1 o9) true false))))
(assert (=> (= result1 true) (= result3 (ite (<= 1 i1) o10 false))))
...
(assert (= result true))
(assert (and (= o (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o) (<= o (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result4 (ite (<= 1 i) o1 false)))
(assert (= result4 true))
(assert (and (= o6 i) (in_range3 i)))
(assert (and (= o7 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o6)) (and (in_range5 o7) (= o7 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o6)))))
