...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ (- first 1) result) last) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= first1 last2)) (dynamic_property1 first1 last2 temp___expr_294)))
...
(define-fun dynamic_invariant2 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first last)) (dynamic_property first last temp___expr_280)))
(assert (= first fst))
(assert (= last lst))
...
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant1 position true true true true) (and (<= first position) (<= position (last1 container)))) (dynamic_invariant4 (get container position) true false true true)) :pattern ((get container position))))))
(declare-const o Int)
...
(assert (dynamic_property1 first1 last2 lst1))
(assert (in_range3 offset))
(assert (and (= o8 (last1 left)) (and (dynamic_property1 first1 last2 o8) (= o8 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o8) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o6 first) (in_range3 first))))
...
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o5 lst1) (in_range3 lst1)))
(assert (and (= o2 (length right)) (and (in_range1 o2) (<= (+ (- first 1) o2) last))))
(assert (and (= o first) (in_range3 first)))
(assert (= o1 (- o 1)))
