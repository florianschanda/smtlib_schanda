...
(assert (and (= (mk___rep1 (mk___split_fields1 o10)) (find l e no_element)) (ite (ite (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (length2 l) e) false) true false) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o10)) no_element) true) (and (and (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o10))) true) (= (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 o10)))) e)) (=> (not (= (bool_eq1 no_element no_element) true)) (<= (get1 (positions l) no_element) (get1 (positions l) (mk___rep1 (mk___split_fields1 o10)))))) (not (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (- (get1 (positions l) (mk___rep1 (mk___split_fields1 o10))) 1) e) true))))))
(assert (= result7 (bool_eq1 (mk___rep1 (mk___split_fields1 o10)) no_element)))
(assert (not (= result7 true)))
(assert (and (= o14 (positions l)) (and (not (= (has_key o14 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o14 i1) true) (and (and (<= 1 (get1 o14 i1)) (<= (get1 o14 i1) (length2 l))) (forall ((j us_rep1)) (=> (= (has_key o14 j) true) (=> (= (get1 o14 i1) (get1 o14 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o15 (get1 o14 (cursor__content use_lists__my_find__result15))) (and (in_range5 o15) (=> (= (of_int 0) true) (and (= o15 (w_get o14 (witness o14 (cursor__content use_lists__my_find__result15)))) (forall ((k us_rep1)) (=> (= (has_key o14 k) true) (= (= (bool_eq1 k (cursor__content use_lists__my_find__result15)) true) (= (witness o14 (cursor__content use_lists__my_find__result15)) (witness o14 k))))))))))
(assert (and (= (mk___rep1 (mk___split_fields1 o13)) (find l e no_element)) (ite (ite (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (length2 l) e) false) true false) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o13)) no_element) true) (and (and (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o13))) true) (= (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 o13)))) e)) (=> (not (= (bool_eq1 no_element no_element) true)) (<= (get1 (positions l) no_element) (get1 (positions l) (mk___rep1 (mk___split_fields1 o13)))))) (not (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (- (get1 (positions l) (mk___rep1 (mk___split_fields1 o13))) 1) e) true))))))
(assert (and (= o12 (positions l)) (and (not (= (has_key o12 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o12 i1) true) (and (and (<= 1 (get1 o12 i1)) (<= (get1 o12 i1) (length2 l))) (forall ((j us_rep1)) (=> (= (has_key o12 j) true) (=> (= (get1 o12 i1) (get1 o12 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (not (= (has_key o12 (mk___rep1 (mk___split_fields1 o13))) true)))
(check-sat)
(exit)
