...
(assert (or (and (and (and (= use_lists__my_find__result11 (mk_cursor__ref use_lists__my_find__result3)) (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields2))) (and (= use_lists__my_find__result12 use_lists__my_find__result3) (= cu__split_fields9 cu__split_fields2))) (and (and (= result1 (has_key (positions l) (mk___rep1 cu__split_fields12))) (= (= result1 true) (= (has_key (positions l) (mk___rep1 cu__split_fields12)) true))) (and (= result1 true) (and (= temp___523 cu__split_fields1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) (mk___rep1 cu__split_fields2)) 1))) (not (= (get (model__ l) i) e)))) (and (= (has_key (positions l) (mk___rep1 cu__split_fields2)) true) (and (and (and (= o2 (element l (mk___rep1 cu__split_fields2))) (and (in_range6 o2) (= o2 (get (model__ l) (get1 (positions l) (mk___rep1 cu__split_fields2)))))) (= result2 (ite (= o2 e) true false))) (and (= result2 true) (and (= result3 (mk_cursor__ref use_lists__my_find__result2)) (= use_lists__my_find__result3 (mk___rep1 cu__split_fields2))))))))))) (and (and (and (= result1 (has_key (positions l) (mk___rep1 cu__split_fields12))) (= (= result1 true) (= (has_key (positions l) (mk___rep1 cu__split_fields12)) true))) (ite (= result1 true) (and (and (and (= temp___523 cu__split_fields1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) (mk___rep1 cu__split_fields2)) 1))) (not (= (get (model__ l) i) e)))) (and (= (has_key (positions l) (mk___rep1 cu__split_fields2)) true) (and (and (and (and (= o2 (element l (mk___rep1 cu__split_fields2))) (and (in_range6 o2) (= o2 (get (model__ l) (get1 (positions l) (mk___rep1 cu__split_fields2)))))) (= result2 (ite (= o2 e) true false))) (and (not (= result2 true)) (= use_lists__my_find__result3 use_lists__my_find__result2))) (and (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions l) (mk___rep1 cu__split_fields2)) (length2 l)) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions l) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions l) (mk___rep1 cu__split_fields3)) (+ (get1 (positions l) (mk___rep1 cu__split_fields2)) 1)))) (and (and (and (= o3 (has_key (positions l) (mk___rep1 cu__split_fields3))) (= (= o3 true) (= (has_key (positions l) (mk___rep1 cu__split_fields3)) true))) (= result4 (ite (not (= o3 true)) true false))) (= result4 true))))))) (and (and (= use_lists__my_find__result4 (mk_cursor__ref use_lists__my_find__result3)) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))) (and (= use_lists__my_find__result5 use_lists__my_find__result3) (= cu__split_fields5 cu__split_fields3)))) (and (and (= use_lists__my_find__result6 use_lists__my_find__result4) (= cu__split_fields6 cu__split_fields4)) (and (= use_lists__my_find__result7 use_lists__my_find__result5) (= cu__split_fields7 cu__split_fields5)))) (and (and (= use_lists__my_find__result6 (mk_cursor__ref (mk___rep1 (mk___split_fields1 use_lists__my_find__result)))) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields12))) (and (= use_lists__my_find__result7 (mk___rep1 (mk___split_fields1 use_lists__my_find__result1))) (= cu__split_fields7 cu__split_fields12))))) (and (and (and (= use_lists__my_find__result11 use_lists__my_find__result9) (= cu__split_fields8 cu__split_fields6)) (and (= use_lists__my_find__result12 use_lists__my_find__result10) (= cu__split_fields9 cu__split_fields7))) (and (and (= use_lists__my_find__result9 (mk_cursor__ref use_lists__my_find__result8)) (= use_lists__my_find__result10 use_lists__my_find__result8)) (and (= result5 use_lists__my_find__result6) (= use_lists__my_find__result8 no_element)))))))
...
(assert (and (= o10 (find l e no_element)) (ite (ite (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (length2 l) e) false) true false) (= (bool_eq1 o10 no_element) true) (and (and (and (= (has_key (positions l) o10) true) (= (get (model__ l) (get1 (positions l) o10)) e)) (=> (not (= (bool_eq1 no_element no_element) true)) (<= (get1 (positions l) no_element) (get1 (positions l) o10)))) (not (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (- (get1 (positions l) o10) 1) e) true))))))
(assert (= result6 (bool_eq1 o10 no_element)))
(assert (not (= result6 true)))
(assert (and (= o7 (positions l)) (and (not (= (has_key o7 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o7 i) true) (and (and (<= 1 (get1 o7 i)) (<= (get1 o7 i) (length2 l))) (forall ((j us_rep1)) (=> (= (has_key o7 j) true) (=> (= (get1 o7 i) (get1 o7 j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o8 (get1 o7 (cursor__content use_lists__my_find__result13))) (and (in_range5 o8) (=> (= (distinct 0 0) true) (and (= o8 (w_get o7 (witness o7 (cursor__content use_lists__my_find__result13)))) (forall ((k us_rep1)) (=> (= (has_key o7 k) true) (= (= (bool_eq1 k (cursor__content use_lists__my_find__result13)) true) (= (witness o7 (cursor__content use_lists__my_find__result13)) (witness o7 k))))))))))
(assert (and (= o9 (find l e no_element)) (ite (ite (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (length2 l) e) false) true false) (= (bool_eq1 o9 no_element) true) (and (and (and (= (has_key (positions l) o9) true) (= (get (model__ l) (get1 (positions l) o9)) e)) (=> (not (= (bool_eq1 no_element no_element) true)) (<= (get1 (positions l) no_element) (get1 (positions l) o9)))) (not (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (- (get1 (positions l) o9) 1) e) true))))))
