...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (capacity1 container)) (dynamic_invariant3 result true false true))) :pattern ((length1 container)))))
...
(declare-const hnco__test2__v_type_owner__vector_type_owner__reserve_capacity__container__fields us_main_type)
...
(assert (=> (= (of_int 1) true) (<= capacity (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity container__split_discrs)))))
