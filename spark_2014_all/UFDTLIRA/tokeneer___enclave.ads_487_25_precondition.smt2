...
(assert (=> (= result true) (and (= o33 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o33))))
(assert (=> (= result true) (= o34 (ite (= o33 3) true false))))
(assert (=> (= result true) (= o35 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result1 true) (and (= o27 (theauthcertrole (us_private__content state3))) (in_range1 o27))))
(assert (=> (= result1 true) (= o28 (ite (= o27 1) true false))))
(assert (=> (= result1 true) (= o25 (authcertvalid (us_private__content state3)))))
(assert (=> (= result1 true) (= o26 (isgood (us_private__content state3)))))
...
(assert (= o20 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))))
(assert (= result2 (ite (not (= o20 true)) true false)))
(assert (=> (= result2 true) (= o21 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))))))
(assert (=> (= result2 true) (= o22 (ite (not (= o21 true)) true false))))
(assert (=> (not (= result2 true)) (= o22 (of_int 1))))
(assert (and (= o12 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range1 o12)))
(assert (= result3 (ite (= o12 1) true false)))
(assert (=> (= result3 true) (= o16 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))))))
(assert (=> (= result3 true) (= o17 (ite (not (= o16 true)) true false))))
(assert (=> (= result3 true) (and (= o13 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o13))))
(assert (=> (= result3 true) (= o14 (ite (= o13 3) true false))))
(assert (=> (= result3 true) (= o15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))))))
...
(assert (and (= o7 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o7)))
(assert (= o8 (ite (= o7 3) true false)))
(assert (= o9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))))
(assert (= result4 (ite (= o9 true) o8 false)))
(assert (=> (= result4 true) (and (= o10 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range1 o10))))
(assert (=> (= result4 true) (= o11 (ite (= o10 1) true false))))
(assert (=> (not (= result4 true)) (= o11 (of_int 1))))
(assert (and (= o (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range1 o)))
(assert (= result5 (ite (= o 1) true false)))
(assert (=> (= result5 true) (and (= o3 (theauthcertrole (us_private__content state3))) (in_range1 o3))))
(assert (=> (= result5 true) (= o4 (ite (= o3 1) true false))))
(assert (=> (= result5 true) (= o1 (authcertvalid (us_private__content state3)))))
