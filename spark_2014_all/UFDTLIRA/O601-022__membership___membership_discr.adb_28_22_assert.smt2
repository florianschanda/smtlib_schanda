...
(define-fun dynamic_invariant ((temp___expr_215 us_rep) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (in_range3 0 temp___expr_215)))
(define-fun default_initial_assumption ((temp___expr_217 us_rep) (temp___skip_top_level_218 Bool)) Bool (and (= (attr__tag temp___expr_217) us_tag2) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_217))) 0)))
(declare-const r02__split_discrs us_split_discrs)
(declare-const r02__attr__tag Int)
...
(define-fun dynamic_invariant2 ((temp___expr_206 us_rep) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (in_range2 0 temp___expr_206)))
(define-fun default_initial_assumption1 ((temp___expr_208 us_rep) (temp___skip_top_level_209 Bool)) Bool (and (= (attr__tag temp___expr_208) us_tag1) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_208))) 0)))
(assert (and (= r02__attr__tag us_tag2) (= (to_rep (rec__membership_discr__root__c r02__split_discrs)) 0)))
(assert (= 0 (to_rep (rec__membership_discr__root__c r02__split_discrs))))
(assert (= r02__attr__tag us_tag))
(assert (not (= 0 (to_rep (rec__membership_discr__root__c r02__split_discrs)))))
(check-sat)
(exit)
