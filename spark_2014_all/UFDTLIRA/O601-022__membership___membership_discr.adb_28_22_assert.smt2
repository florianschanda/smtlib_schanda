...
(define-fun dynamic_invariant ((temp___expr_189 us_rep) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (not (= temp___skip_constant_187 true)) (in_range3 0 temp___expr_189)))
(define-fun default_initial_assumption ((temp___expr_191 us_rep) (temp___skip_top_level_192 Bool)) Bool (and (= (attr__tag temp___expr_191) us_tag2) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_191))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_181 us_rep) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (in_range2 0 temp___expr_181)))
(define-fun default_initial_assumption1 ((temp___expr_183 us_rep) (temp___skip_top_level_184 Bool)) Bool (and (= (attr__tag temp___expr_183) us_tag1) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_183))) 0)))
