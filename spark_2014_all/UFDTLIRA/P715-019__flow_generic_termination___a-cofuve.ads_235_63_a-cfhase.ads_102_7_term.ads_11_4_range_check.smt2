...
(define-fun dynamic_invariant3 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_379)))
(declare-const o Int)
