...
(define-fun dynamic_invariant ((temp___expr_350 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 2147483647)) (in_range2 temp___expr_350)))
...
(define-fun dynamic_invariant1 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range1 temp___expr_176)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range3 temp___expr_415)))
...
(define-fun default_initial_assumption1 ((temp___expr_423 us_rep3) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (and (= (is_empty temp___expr_423) true) (= (length2 temp___expr_423) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_401 us_rep2) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (= (length1 temp___expr_401) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_393 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 0 2147483647)) (in_range4 temp___expr_393)))
...
(define-fun dynamic_invariant4 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range5 temp___expr_386)))
...
(declare-const temp___1068 count_type)
(declare-const o2 us_rep2)
(declare-const o3 us_rep3)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1068 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1068)) no_element))
(assert (in_range2 item))
(assert (or (= (has_key (positions container) position) true) (= (bool_eq1 position no_element) true)))
(assert (=> (= (bool_eq1 position no_element) true) (and (= o4 (length container)) (and (in_range1 o4) (<= o4 (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container))))))))
