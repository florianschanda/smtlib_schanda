...
(define-fun dynamic_invariant ((temp___expr_320 Int) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool)) Bool (=> (or (= temp___is_init_317 true) (<= 1 2147483647)) (in_range2 temp___expr_320)))
...
(define-fun dynamic_invariant1 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 2147483647)) (in_range1 temp___expr_152)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1 2147483647)) (in_range3 temp___expr_376)))
...
(define-fun default_initial_assumption1 ((temp___expr_383 us_rep3) (temp___skip_top_level_384 Bool)) Bool (=> (not (= temp___skip_top_level_384 true)) (and (= (is_empty temp___expr_383) true) (= (length2 temp___expr_383) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_364 us_rep2) (temp___skip_top_level_365 Bool)) Bool (=> (not (= temp___skip_top_level_365 true)) (= (length1 temp___expr_364) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_357 Int) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool)) Bool (=> (or (= temp___is_init_354 true) (<= 0 2147483647)) (in_range4 temp___expr_357)))
...
(define-fun dynamic_invariant4 ((temp___expr_351 Int) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool (=> (or (= temp___is_init_348 true) (<= 1 2147483647)) (in_range5 temp___expr_351)))
