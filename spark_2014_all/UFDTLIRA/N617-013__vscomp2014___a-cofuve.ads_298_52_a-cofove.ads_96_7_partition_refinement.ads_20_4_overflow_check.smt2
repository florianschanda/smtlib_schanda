...
(define-fun dynamic_invariant ((temp___expr_349 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= 0 10000)) (in_range1 temp___expr_349)))
...
(assert (forall ((x index_count)) (! (in_range3 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= (- 1) 10000)) (in_range6 temp___expr_366)))
...
(define-fun dynamic_invariant3 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 6)) (in_range3 temp___expr_277)))
(define-fun dynamic_invariant4 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 5)) (in_range4 temp___expr_284)))
(assert true)
(declare-const o Int)
...
(assert (and (= o2 (length container)) (and (in_range5 o2) (<= (+ (- 1) o2) 10000))))
(assert (= result (ite (< o2 2147483647) true false)))
(assert (= result true))
(assert (and (= o1 (last container)) (and (in_range6 o1) (= o1 (+ (- 1) (length container))))))
(assert (= result1 (ite (< o1 10000) true false)))
(assert (= result1 true))
(assert (and (= o (last container)) (and (in_range6 o) (= o (+ (- 1) (length container))))))
