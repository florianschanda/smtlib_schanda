...
(define-fun dynamic_invariant ((temp___expr_314 Int) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool)) Bool (=> (or (= temp___is_init_311 true) (<= 0 10000)) (in_range1 temp___expr_314)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_329 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= (- 1) 10000)) (in_range6 temp___expr_329)))
...
(define-fun dynamic_invariant3 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 6)) (in_range3 temp___expr_251)))
(define-fun dynamic_invariant4 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 5)) (in_range4 temp___expr_257)))
(assert true)
(declare-const o Int)
...
(assert (and (= o3 (length container)) (and (in_range5 o3) (<= (+ (- 1) o3) 10000))))
(assert (= result (ite (< o3 2147483647) true false)))
(assert (= result true))
(assert (and (= o2 (last container)) (and (in_range6 o2) (= o2 (+ (- 1) (length container))))))
(assert (= result1 (ite (< o2 10000) true false)))
(assert (= result1 true))
