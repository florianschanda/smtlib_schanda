...
(assert (and (= o2 (length container)) (and (in_range o2) (<= (+ (- 1) o2) 10000))))
(assert (= result (ite (< o2 2147483647) true false)))
(assert (= result true))
(assert (and (= o1 (last container)) (and (in_range4 o1) (= o1 (+ (- 1) (length container))))))
(assert (= result1 (ite (< o1 10000) true false)))
(assert (= result1 true))
(assert (and (= o (last container)) (and (in_range4 o) (= o (+ (- 1) (length container))))))
(assert (not (not (= o 32767))))
(check-sat)
(exit)
