...
(define-fun default_initial_assumption ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (and (and (= (attr__tag temp___expr_159) us_tag) (= (rec__dic__parent__b (us_split_fields1 temp___expr_159)) (distinct 1 0))) (=> (not (= temp___skip_top_level_160 true)) (= (is_ok temp___expr_159) true))))
...
(assert (forall ((obj us_rep)) (! (= (ite (is_ok__2 obj) 1 0) (ite (is_ok1 us_tag1 obj) 1 0)) :pattern ((is_ok1 us_tag1 obj)))))
(assert (forall ((obj us_rep)) (! (= (= (is_ok obj) true) (= (rec__dic__parent__b (us_split_fields1 obj)) true)) :pattern ((is_ok obj)))))
(define-fun default_initial_assumption1 ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (and (= (attr__tag temp___expr_167) us_tag1) (= (rec__dic__parent__b (us_split_fields1 temp___expr_167)) (distinct 1 0))) (=> (not (= temp___skip_top_level_168 true)) (= (is_ok__2 temp___expr_167) true))))
(assert true)
(assert true)
(assert (forall ((obj us_rep)) (! (= (ite (is_ok__2 obj) 1 0) (ite (is_ok__21 us_tag1 obj) 1 0)) :pattern ((is_ok__21 us_tag1 obj)))))
...
(assert (and (= temp___1752 us_tag) (= temp___175 (distinct 1 0))))
(assert (not (= (is_ok (mk___rep (mk___split_fields temp___175 temp___1751) temp___1752)) true)))
(check-sat)
(exit)
