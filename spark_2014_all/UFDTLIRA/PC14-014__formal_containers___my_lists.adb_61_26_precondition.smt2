...
(assert (and (= o3 (length (mk___rep l__split_discrs l__split_fields7))) (and (in_range1 o3) (<= o3 (to_rep (rec__my_lists__m__list__capacity l__split_discrs))))))
...
(assert (not (= (has_key o2 (mk___rep1 d__split_fields5)) true)))
(check-sat)
(exit)
