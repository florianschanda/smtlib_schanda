...
(assert (and (= o18 (model__1 (queue__content amortized_queue__tail__result7))) (= (is_model (queue__content amortized_queue__tail__result7) o18) true)))
(assert (and (= o21 (oconcat__3 o18 o20)) (and (= (length o21) (+ (length o18) 1)) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ o18)))) (= (get (model__ o21) i) (get (model__ o18) i)))) (= (get (model__ o21) (+ (last (model__ o18)) 1)) o20)))))
