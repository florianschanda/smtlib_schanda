...
(define-fun o21 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o22 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o22 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o22) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o21 o22))
(assert (= o7 o21))
...
(assert (and (= o19 (last_element o18)) (and (in_range2 o19) (= o19 (get (model__ o18) (last (model__ o18)))))))
(assert (and (= o17 (model__1 (queue__content amortized_queue__tail__result7))) (= (is_model (queue__content amortized_queue__tail__result7) o17) true)))
(assert (and (= o20 (oconcat__3 o17 o19)) (and (= (length o20) (+ (length o17) 1)) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ o17)))) (= (get (model__ o20) i) (get (model__ o17) i)))) (= (get (model__ o20) (+ (last (model__ o17)) 1)) o19)))))
