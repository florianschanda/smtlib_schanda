...
(assert (and (= o10 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))))) (and (dynamic_property5 first4 last6 o10) (= o10 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))))))))
(assert (= o11 (ite (<= i2 o10) true false)))
(assert (= result3 (ite (<= current2 i2) o11 false)))
(assert (= result3 true))
(assert (and (= us4 i2) (dynamic_property3 first2 last3 i2)))
(assert (= o13 i2))
(assert (and (= o14 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o13)) (in_range3 o14)))
(assert (and (= us3 i2) (dynamic_property1 first1 last1 i2)))
(assert (= o12 i2))
(assert (not (<= first1 o12)))
(check-sat)
(exit)
