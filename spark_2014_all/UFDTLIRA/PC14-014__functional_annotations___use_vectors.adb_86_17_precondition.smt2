...
(assert (forall ((i1 Int)) (=> (and (<= fst1 i1) (<= i1 (- current2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) 0))))
(assert (forall ((i1 Int)) (=> (and (<= first i1) (<= i1 (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i1)))))
(assert (forall ((i1 Int)) (=> (and (<= current2 i1) (<= i1 (last5 (model__ (mk___rep v__split_discrs v__split_fields2))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i1) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i1)))))
...
(assert (and (= o (last5 (model__ (mk___rep v__split_discrs v__split_fields2)))) (and (dynamic_property5 first4 last6 o) (= o (last5 (model__ (mk___rep v__split_discrs v__split_fields2)))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result1 (ite (<= current2 i) o1 false)))
(assert (= result1 true))
(assert (and (= us1 i) (dynamic_property3 first2 last3 i)))
(assert (= o3 i))
