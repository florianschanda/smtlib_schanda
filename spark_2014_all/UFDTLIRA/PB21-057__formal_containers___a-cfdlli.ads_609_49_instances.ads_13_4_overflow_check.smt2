...
(define-fun dynamic_invariant ((temp___expr_587 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool) (temp___do_typ_inv_586 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 0 2147483647)) (in_range1 temp___expr_587)))
...
(define-fun dynamic_invariant1 ((temp___expr_601 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool) (temp___do_typ_inv_600 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_601)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__instances__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption1 ((temp___expr_674 us_rep2) (temp___skip_top_level_675 Bool)) Bool (=> (not (= temp___skip_top_level_675 true)) (and (= (is_empty temp___expr_674) true) (= (length1 temp___expr_674) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_666 Int) (temp___is_init_662 Bool) (temp___skip_constant_663 Bool) (temp___do_toplevel_664 Bool) (temp___do_typ_inv_665 Bool)) Bool (=> (or (= temp___is_init_662 true) (<= 1 2147483647)) (in_range4 temp___expr_666)))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___997 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___997)) no_element))
