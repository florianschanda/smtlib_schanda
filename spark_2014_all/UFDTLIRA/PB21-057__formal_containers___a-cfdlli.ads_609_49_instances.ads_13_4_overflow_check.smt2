...
(define-fun default_initial_assumption ((temp___expr_539 us_rep1) (temp___skip_top_level_540 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_539))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_590 us_rep2) (temp___skip_top_level_591 Bool)) Bool (=> (not (= temp___skip_top_level_591 true)) (and (= (is_empty temp___expr_590) true) (= (length1 temp___expr_590) 0))))
(declare-fun get (us_rep2 us_rep1) Int)
(declare-fun get__function_guard (Int us_rep2 us_rep1) Bool)
(define-fun default_initial_assumption2 ((temp___expr_578 us_rep1) (temp___skip_top_level_579 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_578))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_583 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 1 2147483647)) (in_range4 temp___expr_583)))
...
(declare-const temp___901 count_type)
(declare-const o2 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___901 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___901)) no_element))
