...
(define-fun dynamic_invariant ((temp___expr_521 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 2147483647)) (in_range1 temp___expr_521)))
...
(define-fun dynamic_invariant1 ((temp___expr_533 Int) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool)) Bool (=> (or (= temp___is_init_530 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_533)))
...
(define-fun default_initial_assumption ((temp___expr_545 us_rep1) (temp___skip_top_level_546 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_545))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_596 us_rep2) (temp___skip_top_level_597 Bool)) Bool (=> (not (= temp___skip_top_level_597 true)) (and (= (is_empty temp___expr_596) true) (= (length1 temp___expr_596) 0))))
(declare-fun get (us_rep2 us_rep1) Int)
(declare-fun get__function_guard (Int us_rep2 us_rep1) Bool)
(define-fun default_initial_assumption2 ((temp___expr_584 us_rep1) (temp___skip_top_level_585 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields3 temp___expr_584))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 2147483647)) (in_range4 temp___expr_589)))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___907 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___907)) no_element))
