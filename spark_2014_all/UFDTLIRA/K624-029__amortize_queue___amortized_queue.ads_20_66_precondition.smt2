...
(assert (and (= o11 (length right)) (and (in_range5 o11) (<= o11 (capacity right)))))
(assert (and (= o12 (length left)) (and (in_range5 o12) (<= o12 (capacity left)))))
(assert (= o13 (+ o12 o11)))
(assert (and (= o14 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range5 o14) (<= o14 (capacity (vector__content amortized_queue__Oconcat__result5))))))
