...
(assert (and (= o17 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o17 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o17 i4) true) (and (and (<= 1 (get1 o17 i4)) (<= (get1 o17 i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key o17 j) true) (=> (= (get1 o17 i4) (get1 o17 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (not (= (has_key o17 (mk___rep1 (mk___split_fields1 current__split_fields2))) true)))
(check-sat)
(exit)
