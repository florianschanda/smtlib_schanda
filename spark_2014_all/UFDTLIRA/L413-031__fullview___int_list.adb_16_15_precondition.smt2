...
(assert (and (= o3 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o3 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key o3 i2) true) (and (and (<= 1 (get1 o3 i2)) (<= (get1 o3 i2) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o3 j) true) (=> (= (get1 o3 i2) (get1 o3 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o4 (get1 o3 (mk___rep1 c__split_fields2))) (and (in_range5 o4) (=> (= (of_int 0) true) (and (= o4 (w_get o3 (witness o3 (mk___rep1 c__split_fields2)))) (forall ((k us_rep1)) (=> (= (has_key o3 k) true) (= (= (bool_eq1 k (mk___rep1 c__split_fields2)) true) (= (witness o3 (mk___rep1 c__split_fields2)) (witness o3 k))))))))))
(assert (= o5 (- o4 1)))
(assert (= o6 (ite (<= i o5) true false)))
(assert (= result3 (ite (<= 1 i) o6 false)))
(assert (= result3 true))
(assert (and (= o8 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o8) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o9 (get o8 i)) (in_range4 o9)))
(assert (= o10 (+ o9 1)))
(assert (and (= o7 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o7) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
