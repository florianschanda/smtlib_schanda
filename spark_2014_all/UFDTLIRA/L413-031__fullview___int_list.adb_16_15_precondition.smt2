...
(assert (and (= o6 (get o5 i)) (in_range2 o6)))
(assert (= o7 (+ o6 1)))
(assert (and (= o4 (model__ (mk___rep l__split_discrs l__split_fields1))) (= (length1 o4) (length (mk___rep l__split_discrs l__split_fields1)))))
