...
(define-fun default_initial_assumption ((temp___expr_1551 us_rep1) (temp___skip_top_level_1552 Bool)) Bool (and (= (to_rep (rec__interrupt_priority__interrupt_needed_1__c (us_split_discrs2 temp___expr_1551))) 0) (= (to_rep1 (rec__interrupt_priority__interrupt_needed_1__i1 (us_split_fields3 temp___expr_1551))) 0)))
