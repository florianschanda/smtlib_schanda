...
(define-fun default_initial_assumption ((temp___expr_1541 us_rep1) (temp___skip_top_level_1542 Bool)) Bool (and (= (to_rep (rec__interrupt_priority__interrupt_needed_1__c (us_split_discrs2 temp___expr_1541))) 0) (= (to_rep1 (rec__interrupt_priority__interrupt_needed_1__i1 (us_split_fields3 temp___expr_1541))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 98)) (in_range temp___expr_202)))
