...
(assert (= v__split_fields9 indefinite_bounded__vect__clear__container__fields1))
...
(assert (not (= (get (model__ (mk___rep v__split_discrs v__split_fields7)) 2) 4)))
(check-sat)
(exit)
