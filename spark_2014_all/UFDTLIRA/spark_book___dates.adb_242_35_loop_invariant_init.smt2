...
(define-fun dynamic_invariant ((temp___expr_192 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= (- 36524) 36524)) (in_range1 temp___expr_192)))
...
(define-fun dynamic_invariant1 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_15)))
(define-fun dynamic_invariant2 ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 2000 2099)) (in_range2 temp___expr_150)))
(define-fun dynamic_invariant3 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 1 12)) (in_range3 temp___expr_156)))
(define-fun dynamic_invariant4 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 1 31)) (in_range4 temp___expr_162)))
...
(declare-const o7 month_type)
(declare-const o8 year_type)
(declare-const o9 day_type)
(declare-const o10 month_type)
(declare-const o11 year_type)
...
(declare-const valid4 Bool)
(declare-const result6 Int)
(declare-const steps2 Int)
(declare-const result7 int__ref)
(declare-const i5 Int)
(declare-const result8 Bool)
(declare-const valid5 Bool)
(declare-const current_date__split_fields9 us_split_fields)
(declare-const valid6 Bool)
(declare-const i6 Int)
(declare-const current_date__split_fields10 us_split_fields)
(declare-const result9 int__ref)
(declare-const i7 Int)
(declare-const result10 Bool)
(declare-const valid7 Bool)
...
(assert (<= 1 i5))
(assert (<= i5 r38b))
(assert (and (= (mk___rep (mk___split_fields o6 o7 o8)) (minimum_date Tuple0)) (and (= (of_rep2 1) o6) (and (= (of_rep1 1) o7) (= (of_rep 2000) o8)))))
(assert (= result8 (bool_eq (mk___rep (mk___split_fields current_date__split_fields current_date__split_fields1 current_date__split_fields2)) (mk___rep (mk___split_fields o6 o7 o8)))))
