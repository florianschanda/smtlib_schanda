...
(declare-const temp___240 status)
(declare-const temp___2401 natural)
(declare-const temp___2402 natural)
(declare-const temp___2403 Bool)
(declare-const temp___2404 Bool)
...
(assert (= true temp___2404))
(assert (= x__attr__constrained true))
(assert (not (= temp___240 x__split_discrs)))
(check-sat)
(exit)
