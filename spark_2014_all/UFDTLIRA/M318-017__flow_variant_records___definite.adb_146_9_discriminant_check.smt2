...
(declare-datatypes () ((t42b__ref (mk_t42b__ref (t42b__content us_rep)))))
(define-fun t42b__ref___projection ((a t42b__ref)) us_rep (t42b__content a))
...
(declare-const temp___216 status)
(declare-const temp___2161 natural)
(declare-const temp___2162 natural)
(declare-const temp___2163 Bool)
(declare-const temp___2164 Bool)
(assert (= (to_rep1 x__split_discrs) r41b))
...
(assert (= (to_rep1 o) 2))
(assert (= o o5))
(assert (= temp___216 o5))
(assert (= temp___2161 o2))
(assert (= temp___2162 o3))
(assert (= temp___2163 o4))
(assert (= true temp___2164))
(assert (= x__attr__constrained true))
(assert (not (= temp___216 x__split_discrs)))
(check-sat)
(exit)
