...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (not (= (get (elements s) i) e)))))
(assert (= (has_key (positions s) (mk___rep1 cu__split_fields4)) true))
(assert (and (= o2 (element s (mk___rep1 cu__split_fields4))) (and (in_range7 o2) (= o2 (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields4)))))))
...
(assert (and (= temp___7201 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length2 s)) true) true) (= (bool_eq1 temp___7201 no_element) true) (and (= (has_key (positions s) temp___7201) true) (= (get1 (positions s) temp___7201) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result3 (mk___split_fields__ref1 cu__split_fields4)))
(assert (= cu__split_fields3 (mk___split_fields1 temp___720)))
(assert (and (= o3 (has_key (positions s) (mk___rep1 cu__split_fields3))) (= (= o3 true) (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true))))
