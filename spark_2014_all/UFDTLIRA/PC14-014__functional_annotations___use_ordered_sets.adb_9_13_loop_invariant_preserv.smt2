...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___678)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length2 s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___678)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 temp___678))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___678))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
...
(assert (and (= o9 (has_key (positions s) (mk___rep1 cu__split_fields3))) (= (= o9 true) (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true))))
