...
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields6)) (to_rep (rec__my_ordered_sets__n__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral7))) true))))
(check-sat)
(exit)
