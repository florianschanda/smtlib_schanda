...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) true) (= (bool_eq3 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true))))
(check-sat)
(exit)
