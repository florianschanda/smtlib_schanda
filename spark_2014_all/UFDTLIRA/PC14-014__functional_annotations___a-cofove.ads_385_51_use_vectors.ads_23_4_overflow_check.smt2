...
(define-fun dynamic_invariant1 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_249)))
...
(define-fun dynamic_invariant2 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first1 last1)) (dynamic_property1 first1 last1 temp___expr_256)))
...
(define-fun dynamic_invariant3 ((temp___expr_270 us_rep) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 temp___expr_270)))))
...
(define-fun dynamic_invariant4 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 last2)) (dynamic_property2 0 last2 temp___expr_263)))
(assert (= last2 last_count))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (=> (dynamic_invariant3 container true true true true) (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true true)))) :pattern ((length container)))))
...
(assert (forall ((container us_rep)) (! (=> (dynamic_invariant3 container true true true true) (= (length1 (model__ container)) (length container))) :pattern ((model__ container)))))
...
(assert (=> (not (= before no_index)) (and (= o4 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property1 first1 last1 o4) (= o4 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before no_index)) (and (= o5 (- before 1)) (in_range1 (- before 1)))))
(assert (=> (not (= before no_index)) (= o6 (ite (= o5 o4) true false))))
(assert (=> (not (not (= before no_index))) (= o6 false)))
(assert (and (= o2 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property1 first1 last1 o2) (= o2 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o3 (ite (<= before o2) true false)))
(assert (= o7 (ite (<= first before) o3 false)))
(assert (= o8 (ite (= o7 false) o6 true)))
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property2 0 last2 o) (= o (ite (= (distinct 0 0) true) (to_rep1 (rec__use_vectors__my_vectors__vector__capacity container__split_discrs)) last2)))))
(assert (= o1 (- o count)))
