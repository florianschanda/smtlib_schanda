...
(define-fun t__ref___projection ((a1 t__ref)) integer (t__content a1))
(define-fun dynamic_invariant1 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 last)) (dynamic_property 0 last temp___expr_200)))
(assert (= last c2))
