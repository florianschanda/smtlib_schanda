...
(define-fun dynamic_invariant ((temp___expr_455 Int) (temp___is_init_451 Bool) (temp___skip_constant_452 Bool) (temp___do_toplevel_453 Bool) (temp___do_typ_inv_454 Bool)) Bool (=> (or (= temp___is_init_451 true) (<= 0 864000)) (in_range3 temp___expr_455)))
...
(define-fun dynamic_invariant1 ((temp___expr_1170 Int) (temp___is_init_1166 Bool) (temp___skip_constant_1167 Bool) (temp___do_toplevel_1168 Bool) (temp___do_typ_inv_1169 Bool)) Bool (=> (or (= temp___is_init_1166 true) (<= 0 1)) (in_range5 temp___expr_1170)))
...
(define-fun dynamic_invariant2 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 1901 2099)) (in_range temp___expr_420)))
(define-fun dynamic_invariant3 ((temp___expr_427 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool) (temp___do_typ_inv_426 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 1 12)) (in_range1 temp___expr_427)))
(define-fun dynamic_invariant4 ((temp___expr_434 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool) (temp___do_typ_inv_433 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 1 31)) (in_range2 temp___expr_434)))
(define-fun dynamic_invariant5 ((temp___expr_466 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool) (temp___do_typ_inv_465 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 0 86399999)) (in_range4 temp___expr_466)))
...
(declare-const temp___1536 yearst)
(declare-const temp___15361 monthst)
(declare-const temp___15362 dayst)
(declare-const temp___15363 millisecst)
...
(assert (= o1 o6))
(assert (= o o7))
(assert (= temp___1536 o4))
(assert (= temp___15361 o5))
(assert (= temp___15362 o6))
(assert (= temp___15363 o7))
(assert (= (mk___rep (mk___split_fields temp___1536 temp___15361 temp___15362 temp___15363)) zerotime))
