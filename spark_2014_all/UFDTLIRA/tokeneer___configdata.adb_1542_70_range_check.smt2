...
(define-fun dynamic_invariant ((temp___expr_367 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= 0 864000)) (in_range3 temp___expr_367)))
...
(define-fun dynamic_invariant2 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1901 2099)) (in_range temp___expr_337)))
(define-fun dynamic_invariant3 ((temp___expr_343 Int) (temp___is_init_340 Bool) (temp___skip_constant_341 Bool) (temp___do_toplevel_342 Bool)) Bool (=> (or (= temp___is_init_340 true) (<= 1 12)) (in_range1 temp___expr_343)))
(define-fun dynamic_invariant4 ((temp___expr_349 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 31)) (in_range2 temp___expr_349)))
(define-fun dynamic_invariant5 ((temp___expr_373 Int) (temp___is_init_370 Bool) (temp___skip_constant_371 Bool) (temp___do_toplevel_372 Bool)) Bool (=> (or (= temp___is_init_370 true) (<= 0 86399999)) (in_range4 temp___expr_373)))
...
(declare-const temp___1311 yearst)
(declare-const temp___13111 monthst)
(declare-const temp___13112 dayst)
(declare-const temp___13113 millisecst)
...
(assert (= o1 o6))
(assert (= o o7))
(assert (= temp___1311 o4))
(assert (= temp___13111 o5))
(assert (= temp___13112 o6))
(assert (= temp___13113 o7))
(assert (= (mk___rep (mk___split_fields temp___1311 temp___13111 temp___13112 temp___13113)) zerotime))
