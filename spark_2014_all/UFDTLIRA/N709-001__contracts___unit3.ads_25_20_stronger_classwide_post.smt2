...
(assert (and (= (to_rep x__split_fields10) (+ (to_rep x__split_fields1) 1)) (and (= (to_rep x__split_fields11) (+ (to_rep x__split_fields2) 1)) (= (to_rep x__split_fields9) (+ (to_rep x__split_fields) 1)))))
(assert (not (= (bool_eq2 (mk___rep2 (mk___split_fields2 x__split_fields9 x__split_fields10 x__split_fields11 x__split_fields12) x__attr__tag) (next (mk___rep2 (mk___split_fields2 x__split_fields x__split_fields1 x__split_fields2 x__split_fields3) x__attr__tag))) true)))
(check-sat)
(exit)
