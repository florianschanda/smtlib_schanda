...
(assert (not (= (bool_eq2 (mk___rep2 (mk___split_fields2 x__split_fields4 x__split_fields5 x__split_fields6 x__split_fields7) x__attr__tag) (next (mk___rep2 (mk___split_fields2 x__split_fields x__split_fields1 x__split_fields2 x__split_fields3) x__attr__tag))) true)))
(check-sat)
(exit)
