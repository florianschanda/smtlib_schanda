...
(assert (<= 1 c1))
(assert (<= c1 10))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- c2 1))) (and (= (to_rep (get m2 5 i1)) (to_rep (get m1 7 i1))) (= (to_rep (get m2 7 i1)) (to_rep (get m1 5 i1)))))))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 tmp1)) (forall ((temp___264 Int) (temp___265 Int)) (=> (and (and (<= 1 temp___264) (<= temp___264 10)) (and (<= 1 temp___265) (<= temp___265 10))) (=> (and (or (< 10 temp___265) (or (< temp___265 1) (or (<= c2 temp___265) (not (= 7 temp___264))))) (or (< 10 temp___265) (or (< temp___265 1) (or (<= c2 temp___265) (not (= 5 temp___264)))))) (= (get m2 temp___264 temp___265) (get m1 temp___264 temp___265)))))) (=> (<= 1 10) (in_range5 c2))) (and (<= 1 c2) (<= c2 10))))
(assert (<= 1 i))
(assert (<= i (- c2 1)))
(assert (and (<= 1 i) (<= i 10)))
(assert (= o i))
(assert (= o1 (get m1 5 o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= 1 i)))
(check-sat)
(exit)
