...
(assert (forall ((entities__state us_private)) (! (dynamic_invariant (get_current_cycles entities__state) true false true) :pattern ((get_current_cycles entities__state)))))
