...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (too_big us_void_param) true false true) :pattern ((too_big us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_176 us_rep1) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (not (= temp___skip_constant_174 true)) (in_range2 r1s (to_base temp___expr_176))))
(define-fun default_initial_assumption ((temp___expr_178 us_rep1) (temp___skip_top_level_179 Bool)) Bool (and (= (to_rep (rec__interrupt_priority__no_interrupt_needed_1__c (us_split_discrs2 temp___expr_178))) r1s) (= (to_rep1 (rec__interrupt_priority__no_interrupt_needed_1__i1 (us_split_fields3 temp___expr_178))) 0)))
