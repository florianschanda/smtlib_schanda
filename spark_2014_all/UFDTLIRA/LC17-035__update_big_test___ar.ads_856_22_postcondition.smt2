...
(declare-const temp___6826 et3)
(declare-const temp___68261 et1)
(declare-const temp___68262 et2)
(declare-const temp___68263 enum1ta)
...
(assert (= temp___6826 o5))
(assert (= temp___68261 o6))
(assert (= temp___68262 o7))
(assert (= temp___68263 o8))
...
(assert (= r__split_fields8 (mk___split_fields1 temp___6826 (mk___rep (mk___split_fields temp___68261 temp___68262)) temp___68263)))
