...
(assert (not (= discr 0)))
(assert (= discr 1))
(assert (= (to_rep o10) init_val))
(assert (= (rec__extended_returns__record_t__a result____split_fields4) o11))
(assert (= (rec__extended_returns__record_t__b result____split_fields4) o12))
(assert (= o10 o13))
(assert (= (rec__extended_returns__record_t__d result____split_fields4) o14))
(assert (= result____split_discrs (mk___split_discrs temp___165)))
(assert (= temp___1651 o11))
(assert (= temp___1652 o12))
(assert (= temp___1653 o13))
(assert (= temp___1654 o14))
(assert (= result____attr__constrained temp___1655))
(assert (= result2 (mk___split_fields__ref result____split_fields4)))
(assert (= result____split_fields6 (mk___split_fields temp___1651 temp___1652 temp___1653 temp___1654)))
(assert (= result____split_discrs (mk___split_discrs temp___165)))
