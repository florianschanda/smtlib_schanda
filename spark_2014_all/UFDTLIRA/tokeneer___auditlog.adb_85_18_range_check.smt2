...
(define-fun dynamic_invariant ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 1 17)) (in_range temp___expr_1204)))
(declare-const value Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (in_range value))
(assert (not (= value 17)))
(assert (not (in_range (+ value 1))))
(check-sat)
(exit)
