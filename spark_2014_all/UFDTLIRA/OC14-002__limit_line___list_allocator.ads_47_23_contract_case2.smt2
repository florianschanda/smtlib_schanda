...
(define-fun list_allocator__m__find__result18 () int__ref (mk_int__ref list_allocator__m__find__result14))
(define-fun j14 () int__ref (mk_int__ref j10))
(define-fun list_allocator__m__find__result19 () int__ref (mk_int__ref list_allocator__m__find__result9))
...
(assert (or (and (and (and (= list_allocator__m__find__result18 (mk_int__ref list_allocator__m__find__result5)) (= j14 (mk_int__ref j4))) (and (= list_allocator__m__find__result15 list_allocator__m__find__result6) (= j11 j5))) (and (= temp___415 1) (and (= temp___416 r29b) (and (and (= result7 j16) (= j1 temp___415)) (and (and (<= temp___415 j1) (<= j1 temp___416)) (and (= temp___417 j1) (or (and (and (and (= list_allocator__m__find__result2 list_allocator__m__find__result5) (= j1 j4)) (and (= list_allocator__m__find__result6 list_allocator__m__find__result2) (= j5 j1))) (and (and (and (= o (get s j1)) (in_range3 o)) (= result1 (ite (= o r) true false))) (and (= result1 true) (and (= result2 list_allocator__m__find__result) (= list_allocator__m__find__result2 j1))))) (and (and (and (and (= o (get s j1)) (in_range3 o)) (= result1 (ite (= o r) true false))) (and (not (= result1 true)) (and (= list_allocator__m__find__result2 list_allocator__m__find__result) (= list_allocator__m__find__result2 list_allocator__m__find__result1)))) (and (and (and (= list_allocator__m__find__result4 list_allocator__m__find__result5) (= j3 j4)) (and (= list_allocator__m__find__result6 list_allocator__m__find__result4) (= j5 j3))) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (not (= (get s k) r)))) (and (and (=> (<= 1 r29b) (dynamic_property 1 r29b j2)) (and (<= 1 j2) (<= j2 r29b))) (and (not (= j2 temp___416)) (and (and (= j2 result3) (= j3 (+ j2 1))) (and (and (and (= o1 (get s j3)) (in_range3 o1)) (= result4 (ite (= o1 r) true false))) (and (= result4 true) (and (= result5 list_allocator__m__find__result3) (= list_allocator__m__find__result4 j3))))))))))))))))) (and (and (and (= result7 j16) (= j1 1)) (ite (and (<= 1 j1) (<= j1 r29b)) (and (and (and (= temp___417 j1) (and (and (and (and (= o (get s j1)) (in_range3 o)) (= result1 (ite (= o r) true false))) (and (not (= result1 true)) (and (= list_allocator__m__find__result2 list_allocator__m__find__result) (= list_allocator__m__find__result2 list_allocator__m__find__result1)))) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (not (= (get s k) r)))) (and (and (=> (<= 1 r29b) (dynamic_property 1 r29b j2)) (and (<= 1 j2) (<= j2 r29b))) (= j2 r29b))))) (and (and (= list_allocator__m__find__result3 list_allocator__m__find__result7) (= j2 j6)) (and (= list_allocator__m__find__result8 list_allocator__m__find__result3) (= j7 j2)))) (and (and (= list_allocator__m__find__result19 (mk_int__ref list_allocator__m__find__result7)) (= j15 (mk_int__ref j6))) (and (= list_allocator__m__find__result10 list_allocator__m__find__result8) (= j9 j7)))) (and (and (= list_allocator__m__find__result19 (mk_int__ref list_allocator__m__find__result)) (= j1 j8)) (and (= list_allocator__m__find__result10 list_allocator__m__find__result1) (= j9 j1))))) (and (and (and (= list_allocator__m__find__result18 (mk_int__ref list_allocator__m__find__result12)) (= j14 j15)) (and (= list_allocator__m__find__result15 list_allocator__m__find__result13) (= j11 j9))) (and (and (= list_allocator__m__find__result11 list_allocator__m__find__result12) (= list_allocator__m__find__result13 list_allocator__m__find__result11)) (and (= result6 list_allocator__m__find__result9) (= list_allocator__m__find__result11 0)))))))
(assert (= (mk_int__ref list_allocator__m__find__result16) list_allocator__m__find__result18))
(assert (= j12 j10))
(assert (= list_allocator__m__find__result17 list_allocator__m__find__result15))
(assert (= j13 j11))
(assert (= (mem s r) true))
(assert (not (<= 1 list_allocator__m__find__result16)))
(check-sat)
(exit)
