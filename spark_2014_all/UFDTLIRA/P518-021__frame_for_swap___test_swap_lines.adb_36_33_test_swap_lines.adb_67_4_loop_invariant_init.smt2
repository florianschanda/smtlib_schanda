...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- c3 1))) (and (= (to_rep (get m2 5 i2)) (to_rep (get temp___232 7 i2))) (= (to_rep (get m2 7 i2)) (to_rep (get temp___233 5 i2))))))))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 c9)) (and (= (to_rep (get m10 5 i2)) (to_rep (get temp___248 7 i2))) (= (to_rep (get m10 7 i2)) (to_rep (get temp___249 5 i2))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i2 Int)) (=> (and (<= (+ c9 1) i2) (<= i2 10)) (and (= (to_rep (get m10 5 i2)) (to_rep (get temp___250 5 i2))) (= (to_rep (get m10 7 i2)) (to_rep (get temp___251 7 i2))))))))
