...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- c3 1))) (and (= (to_rep (get m2 5 i2)) (to_rep (get temp___265 7 i2))) (= (to_rep (get m2 7 i2)) (to_rep (get temp___266 5 i2))))))))
...
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 10)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (ite (= i2 5) (= (to_rep (get m7 i2 j)) 2) (ite (= i2 7) (= (to_rep (get m7 i2 j)) 1) (= (to_rep (get m7 i2 j)) 0))))))))
(assert (= result5 m18))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 c9)) (and (= (to_rep (get m10 5 i2)) (to_rep (get temp___281 7 i2))) (= (to_rep (get m10 7 i2)) (to_rep (get temp___282 5 i2))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i2 Int)) (=> (and (<= (+ c9 1) i2) (<= i2 10)) (and (= (to_rep (get m10 5 i2)) (to_rep (get temp___283 5 i2))) (= (to_rep (get m10 7 i2)) (to_rep (get temp___284 7 i2))))))))
...
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 10)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (ite (= i2 5) (= (to_rep (get (map__content m15) i2 j)) 2) (ite (= i2 7) (= (to_rep (get (map__content m15) i2 j)) 1) (= (to_rep (get (map__content m15) i2 j)) 0))))))))
(assert (= result10 m15))
...
(assert (<= 1 k))
(assert (<= k (- i1 1)))
(assert (not (= (to_rep (get m17 k k)) (+ (to_rep (get m17 k k)) 1))))
(check-sat)
(exit)
