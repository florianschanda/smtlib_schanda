...
(define-fun capacity ((container us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep1 (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 container))) 10001))
...
(define-fun dynamic_invariant ((temp___expr_406 us_rep1) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (not (= temp___skip_constant_403 true)) (in_range3 10 temp___expr_406)))
(define-fun default_initial_assumption ((temp___expr_408 us_rep1) (temp___skip_top_level_409 Bool)) Bool (and (= (to_rep1 (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 temp___expr_408))) 10) (=> (not (= temp___skip_top_level_409 true)) (= (is_empty temp___expr_408) true))))
(declare-const p__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 5)) (in_range temp___expr_221)))
...
(define-fun dynamic_invariant3 ((temp___expr_260 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool) (temp___do_typ_inv_259 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= (- 1) 10001)) (in_range5 temp___expr_260)))
(define-fun dynamic_invariant4 ((temp___expr_267 Int) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool) (temp___do_typ_inv_266 Bool)) Bool (=> (or (= temp___is_init_263 true) (<= 0 10001)) (in_range1 temp___expr_267)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption1 ((temp___expr_308 us_rep2) (temp___skip_top_level_309 Bool)) Bool (=> (not (= temp___skip_top_level_309 true)) (= (length1 temp___expr_308) 0)))
...
(define-fun dynamic_invariant5 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 10000)) (in_range6 temp___expr_244)))
...
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant2 result true false true true))) :pattern ((length1 container)))))
(assert true)
