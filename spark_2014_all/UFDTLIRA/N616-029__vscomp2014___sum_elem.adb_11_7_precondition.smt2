...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__sum_elem__interval__first (us_split_fields1 a))) (to_rep (rec__sum_elem__interval__first (us_split_fields1 b)))) (= (to_rep (rec__sum_elem__interval__last (us_split_fields1 a))) (to_rep (rec__sum_elem__interval__last (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__sum_elem__partitions__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields2)) us_main_type (rec__sum_elem__partitions__vector a))
...
(define-fun element_type__ref___projection ((a element_type__ref)) us_rep (element_type__content a))
...
(define-fun capacity ((container us_rep1)) Int (ite (= (of_int 1) true) (to_rep1 (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 container))) 10001))
...
(define-fun element_type__ref___2__projection ((a element_type__ref1)) us_rep (element_type__content1 a))
...
(define-fun in_range3 ((rec__sum_elem__partitions__vector__capacity1 Int) (a us_rep1)) Bool (= rec__sum_elem__partitions__vector__capacity1 (to_rep1 (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 a)))))
...
(assert (< sum_elem__partitions__vector__capacity__first__bit2 sum_elem__partitions__vector__capacity__last__bit2))
...
(define-fun dynamic_invariant ((temp___expr_361 us_rep1) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool)) Bool (=> (not (= temp___skip_constant_359 true)) (in_range3 10 temp___expr_361)))
(define-fun default_initial_assumption ((temp___expr_363 us_rep1) (temp___skip_top_level_364 Bool)) Bool (and (= (to_rep1 (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 temp___expr_363))) 10) (=> (not (= temp___skip_top_level_364 true)) (= (is_empty temp___expr_363) true))))
(declare-const p__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 5)) (in_range temp___expr_189)))
...
(define-fun dynamic_invariant3 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= (- 1) 10001)) (in_range5 temp___expr_223)))
(define-fun dynamic_invariant4 ((temp___expr_229 Int) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (or (= temp___is_init_226 true) (<= 0 10001)) (in_range1 temp___expr_229)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_209 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 10000)) (in_range6 temp___expr_209)))
...
(define-fun dynamic_invariant6 ((temp___expr_258 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= (- 1) 10000)) (in_range7 temp___expr_258)))
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant2 result true false true))) :pattern ((length1 container)))))
(assert true)
...
(declare-const sum_elem__partitions__append__2__container__fields us_main_type)
(declare-const result us_main_type)
(declare-const p__split_fields1 us_main_type)
(assert (= 10 (to_rep1 (rec__sum_elem__partitions__vector__capacity p__split_discrs))))
(assert (= (to_rep o) 1))
(assert (= (to_rep o1) 1))
(assert (= o1 o2))
(assert (= o o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (not (< (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))))))
(check-sat)
(exit)
