...
(assert (not (not (= (has_key (positions (mk___rep l1__split_discrs (mk___split_fields l1__split_fields))) (first (mk___rep l1__split_discrs (mk___split_fields l1__split_fields)))) true))))
(check-sat)
(exit)
