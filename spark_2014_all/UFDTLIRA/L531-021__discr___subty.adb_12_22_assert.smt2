...
(define-fun o29 () us_rep (mk___rep (mk___split_discrs o18) (mk___split_fields o19 o20 o21 o22)))
(define-fun o30 () us_rep (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17)))
...
(assert (= o11 o5))
(assert (= o12 o6))
(assert (= o30 (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
(assert (= o29 o30))
(assert (= (mk___rep (mk___split_discrs subty__p__z__assume) (mk___split_fields subty__p__z__assume1 subty__p__z__assume2 subty__p__z__assume3 subty__p__z__assume4)) o29))
