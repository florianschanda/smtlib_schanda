...
(declare-const n Int)
(assert (<= i3 n))
(assert (<= n (last2 (model__ (mk___rep v__split_discrs v__split_fields3)))))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields3)) n))))
(check-sat)
(exit)
