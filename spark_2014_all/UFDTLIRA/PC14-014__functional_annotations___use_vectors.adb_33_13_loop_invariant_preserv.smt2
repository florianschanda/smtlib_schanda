...
(assert (<= i3 n3))
(assert (<= n3 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))))))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n3) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) n3))))
(check-sat)
(exit)
