...
(assert (<= 1 i1))
(assert (<= i1 r36b))
(assert (and (= o7 (maximum_date Tuple0)) (and (= (of_rep2 31) o) (and (= (of_rep1 12) o1) (= (of_rep 2099) o2)))))
...
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
(assert (and (= o6 (maximum_date Tuple0)) (and (= (of_rep2 31) o3) (and (= (of_rep1 12) o4) (= (of_rep 2099) o5)))))
