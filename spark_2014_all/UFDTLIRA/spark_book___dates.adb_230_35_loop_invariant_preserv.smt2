...
(define-fun current_date__split_fields9 () us_split_fields (mk___split_fields current_date__split_fields6 current_date__split_fields7 current_date__split_fields8))
...
(assert (<= 1 i1))
(assert (<= i1 r36b))
(assert (and (= o7 (maximum_date Tuple0)) (and (= rliteral o) (and (= rliteral1 o1) (= rliteral2 o2)))))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields current_date__split_fields3 current_date__split_fields4 current_date__split_fields5)) (maximum_date Tuple0)) true)))
(assert (and (=> (<= 1 r36b) (dynamic_property 1 r36b i2)) (and (<= 1 i2) (<= i2 r36b))))
(assert (not (= i2 r36b)))
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
(assert (and (= o6 (maximum_date Tuple0)) (and (= rliteral o3) (and (= rliteral1 o4) (= rliteral2 o5)))))
(assert (= result5 (bool_eq (mk___rep current_date__split_fields9) o6)))
(assert (not (= result5 true)))
(assert (= valid4 valid3))
(assert (not (not (= (bool_eq (mk___rep current_date__split_fields9) (maximum_date Tuple0)) true))))
(check-sat)
(exit)
