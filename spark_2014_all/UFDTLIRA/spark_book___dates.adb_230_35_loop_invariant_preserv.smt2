...
(assert (and (=> (<= 1 r36b) (dynamic_property 1 r36b i3)) (and (<= 1 i3) (<= i3 r36b))))
(assert true)
(assert (not (= i3 r36b)))
(assert (= result4 i3))
(assert (= i4 (+ i3 1)))
(assert (and (= (mk___rep (mk___split_fields o3 o4 o5)) (maximum_date Tuple0)) (and (= (of_rep2 31) o3) (and (= (of_rep1 12) o4) (= (of_rep 2099) o5)))))
(assert (= result5 (bool_eq (mk___rep (mk___split_fields current_date__split_fields6 current_date__split_fields7 current_date__split_fields8)) (mk___rep (mk___split_fields o3 o4 o5)))))
(assert (not (= result5 true)))
(assert (= valid4 valid3))
(assert (not (not (= (bool_eq (mk___rep (mk___split_fields current_date__split_fields6 current_date__split_fields7 current_date__split_fields8)) (maximum_date Tuple0)) true))))
(check-sat)
(exit)
