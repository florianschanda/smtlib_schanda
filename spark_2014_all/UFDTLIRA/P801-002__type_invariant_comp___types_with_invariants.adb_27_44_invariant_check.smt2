...
(assert (and (= (mk___rep (mk___split_fields temp___298 temp___2981)) (from_integer i)) (and (= (>= i 0) temp___298) (= (of_rep (abs i)) temp___2981))))
(assert (= (to_rep temp___2981) 0))
(assert (not (= temp___298 true)))
(check-sat)
(exit)
