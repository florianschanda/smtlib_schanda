...
(assert (and (= (mk___rep (mk___split_fields temp___265 temp___2651)) (from_integer i)) (and (= (>= i 0) temp___265) (= (of_rep (abs i)) temp___2651))))
(assert (= (to_rep temp___2651) 0))
(assert (not (= temp___265 true)))
(check-sat)
(exit)
