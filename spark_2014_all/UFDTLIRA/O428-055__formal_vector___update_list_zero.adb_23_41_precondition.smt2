...
(assert (and (= o10 (get1 o9 (mk___rep1 cu__split_fields2))) (and (in_range5 o10) (=> (= (of_int 0) true) (and (= o10 (w_get o9 (witness o9 (mk___rep1 cu__split_fields2)))) (forall ((k us_rep1)) (=> (= (has_key o9 k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields2)) true) (= (witness o9 (mk___rep1 cu__split_fields2)) (witness o9 k))))))))))
(assert (= o13 (ite (<= o10 i1) true false)))
(assert (= result4 (ite (= o13 true) o12 false)))
(assert (= result4 true))
(assert (and (= o17 i1) (in_range3 i1)))
