...
(assert (not (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields4) 3 (next (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4)))) no_element) true)))
(check-sat)
(exit)
