...
(assert (<= first n3))
(assert (<= n3 (- i1 1)))
(assert (not (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n3) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n3)) true)))
(check-sat)
(exit)
