...
(assert (<= first n))
(assert (<= n (- i1 1)))
(assert (not (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n)) true)))
(check-sat)
(exit)
