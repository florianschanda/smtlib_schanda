...
(define-fun e_bigger_than_range ((container us_rep1) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_inf (get container i) item) true))) true false))
...
(define-fun e_is_find ((container us_rep1) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (of_int 1)) (ite (< position (length2 container)) (e_smaller_than_range container (+ position 1) (length2 container) item) (of_int 1))))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true)))) :pattern ((find container item))))))
...
(assert (forall ((left1 us_rep) (right1 us_rep)) (! (ite (= (oeq left1 right1) true) (= (oeq2 (elements left1) (elements right1)) true) (or (not (= (e_elements_included (elements left1) (elements right1)) true)) (not (= (e_elements_included (elements right1) (elements left1)) true)))) :pattern ((oeq left1 right1)))))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant (length3 container) true false true) :pattern ((length3 container)))))
(assert (forall ((container us_rep2)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range5 item) (= (contains container item) true))))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty container)))))
...
(assert (and (= o (length right)) (and (in_range1 o) (<= o (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 right)))))))
