...
(declare-const o poT)
(declare-const us_self__compl poT)
(declare-const po poT)
(declare-const us_self__compl1 poT)
(declare-const result poT)
(declare-const po1 poT)
(assert (not (not (and (and (= o po) (= o us_self__compl)) (and (= result po) (= po1 us_self__compl1))))))
(check-sat)
(exit)
