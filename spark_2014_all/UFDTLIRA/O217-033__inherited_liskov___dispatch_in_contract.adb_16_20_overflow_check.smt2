...
(declare-const temp___1922 us_private)
...
(assert (= temp___1921 o3))
(assert (= temp___1922 o4))
(assert (= o__attr__tag temp___1923))
(assert (= result o__split_fields))
(assert (= result1 o__split_fields1))
(assert (= result2 o__split_fields2))
(assert (= temp___192 o__split_fields3))
(assert (= temp___1921 o__split_fields4))
(assert (= temp___1922 o__split_fields5))
