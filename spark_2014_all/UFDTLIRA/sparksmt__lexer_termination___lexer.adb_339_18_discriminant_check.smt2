...
(assert (= (to_rep1 o) 2))
(assert (= o o8))
(assert (= temp___1068 o8))
(assert (= temp___10681 o4))
(assert (= temp___10682 o5))
(assert (= temp___10683 o6))
(assert (= temp___10684 o7))
(assert (= true temp___10685))
(assert (= t__attr__constrained true))
(assert (not (= temp___1068 t__split_discrs)))
(check-sat)
(exit)
