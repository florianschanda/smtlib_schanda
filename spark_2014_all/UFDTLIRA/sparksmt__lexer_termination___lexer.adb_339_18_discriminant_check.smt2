...
(assert (= (to_rep1 o9) 2))
(assert (= o9 o17))
(assert (= temp___972 o17))
(assert (= temp___9721 o13))
(assert (= temp___9722 o14))
(assert (= temp___9723 o15))
(assert (= temp___9724 o16))
(assert (= true temp___9725))
(assert (= t__attr__constrained true))
(assert (not (= temp___972 t__split_discrs)))
(check-sat)
(exit)
