...
(define-fun dynamic_invariant1 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 100)) (in_range2 temp___expr_346)))
...
(define-fun dynamic_invariant2 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 100)) (in_range4 temp___expr_386)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= (my_eq e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (and (= o3 (length right)) (in_range o3)))
(assert (= o4 (- 2147483647 o3)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o (num_overlaps left right)) (and (in_range o) (and (and (and (= o (length (intersection1 left right))) (ite (= (ole left right) true) (= o (length left)) (< o (length left)))) (ite (= (ole right left) true) (= o (length right)) (< o (length right)))) (= (= o 0) (= (no_overlap left right) true))))))
(assert (and (= o1 (length left)) (in_range o1)))
(assert (= o2 (- o1 o)))
