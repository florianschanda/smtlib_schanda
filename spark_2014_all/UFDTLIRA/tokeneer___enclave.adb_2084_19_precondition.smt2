...
(assert (and (= o (rolepresent (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range1 o)))
(assert (= result3 (ite (= o 1) true false)))
(assert (= result3 true))
(assert (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))))
