...
(assert (= o14 (islocked (us_private__content state4))))
(assert (= o15 (ite (not (= o14 true)) true false)))
(assert (= result (ite (= o15 true) (islocked state1) false)))
...
(assert (= o6 (islocked (us_private__content state4))))
(assert (= o7 (ite (not (= o6 true)) true false)))
(assert (= result1 (ite (= o7 true) (islocked state1) false)))
(assert (=> (= result1 true) (and (= o10 (theauthcertrole (us_private__content state3))) (in_range1 o10))))
(assert (=> (= result1 true) (= o11 (ite (= o10 1) true false))))
(assert (=> (= result1 true) (= o8 (authcertvalid (us_private__content state3)))))
(assert (=> (= result1 true) (= o9 (isgood (us_private__content state3)))))
...
(assert (= o3 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))))
(assert (= result2 (ite (not (= o3 true)) true false)))
(assert (=> (= result2 true) (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))))))
(assert (=> (= result2 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (not (= result2 true)) (= o5 (of_int 1))))
...
(assert (= result3 true))
(assert (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))))
