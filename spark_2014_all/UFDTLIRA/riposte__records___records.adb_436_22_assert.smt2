...
(declare-const temp___458 Bool)
(declare-const temp___4581 unsigned_byte)
(declare-const temp___4582 unsigned_byte)
...
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= temp___458 o6))
(assert (= temp___4581 o7))
(assert (= temp___4582 o8))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= result2 x__split_fields2))
(assert (= temp___458 x__split_fields3))
(assert (= temp___4581 x__split_fields4))
(assert (= temp___4582 x__split_fields5))
(assert (not (not (= x__split_fields3 true))))
(check-sat)
(exit)
