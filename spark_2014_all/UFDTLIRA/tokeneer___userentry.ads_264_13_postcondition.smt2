...
(assert (= (and (and (= (islocked (us_private__content state4)) true) (= (thecurrentdoor (us_private__content state5)) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout (us_private__content state5))) true)) (= (thedooralarm (us_private__content state5)) 0)))
(assert (in_range8 (int__content status1)))
(assert (= (islocked (us_private__content state4)) true))
(assert (= (thecurrentdoor (us_private__content state5)) 0))
(assert (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout (us_private__content state5))) true))
(assert (not (= (thedooralarm (us_private__content state5)) 0)))
(check-sat)
(exit)
