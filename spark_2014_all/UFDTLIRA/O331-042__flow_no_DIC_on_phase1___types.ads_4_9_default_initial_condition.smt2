...
(declare-const temp___1652 us_private)
(declare-const temp___1653 Int)
(assert (in_range temp___164))
(assert (= temp___1653 us_tag))
(assert (not (= (valid (mk___rep (mk___split_discrs temp___165) (mk___split_fields temp___1651 temp___1652) temp___1653)) true)))
(check-sat)
(exit)
