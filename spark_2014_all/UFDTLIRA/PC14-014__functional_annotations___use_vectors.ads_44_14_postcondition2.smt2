...
(assert (=> (and (<= first4 i1) (<= i1 r7b)) (forall ((n Int)) (=> (and (<= first4 n) (<= n (- i2 1))) (= (is_incr (get temp___481 n) (get (model__ (mk___rep v__split_discrs v__split_fields12)) n)) true)))))
(assert (=> (and (<= first4 i1) (<= i1 r7b)) (forall ((n Int)) (=> (and (<= i2 n) (<= n (last2 (model__ (mk___rep v__split_discrs v__split_fields12))))) (= (get temp___482 n) (get (model__ (mk___rep v__split_discrs v__split_fields12)) n))))))
