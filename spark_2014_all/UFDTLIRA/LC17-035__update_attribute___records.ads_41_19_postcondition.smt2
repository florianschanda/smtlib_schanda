...
(declare-const r__split_fields21 natural)
(declare-const r__split_fields22 my_range)
...
(assert (= r__split_fields2 r__split_fields6))
...
(assert (= r__split_fields4 r__split_fields8))
(assert (= r__split_fields5 r__split_fields9))
(assert (= rliteral1 r__split_fields10))
(assert (= r__split_fields7 r__split_fields11))
(assert (= (to_rep o) (to_rep r__split_fields8)))
(assert (= r__split_fields8 o1))
(assert (= r__split_fields9 o2))
(assert (= r__split_fields10 o3))
(assert (= o o4))
(assert (= temp___279 o1))
(assert (= temp___2791 o2))
(assert (= temp___2792 o3))
(assert (= temp___2793 o4))
...
(assert (= r__split_fields20 r__split_fields12))
(assert (= r__split_fields21 r__split_fields13))
(assert (= r__split_fields22 r__split_fields14))
(assert (= r__split_fields23 r__split_fields15))
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields16 r__split_fields17 r__split_fields18 r__split_fields19)) (mk___rep (mk___split_fields r__split_fields rliteral rliteral1 r__split_fields))) true)))
(check-sat)
(exit)
