...
(declare-const temp___1491 us_private)
...
(assert (= temp___1491 o2))
(assert (= x__attr__tag temp___1492))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= temp___149 x__split_fields2))
(assert (= temp___1491 x__split_fields3))
...
(assert (not (= (to_rep x__split_fields4) 0)))
(check-sat)
(exit)
