...
(declare-const temp___1731 us_private)
...
(assert (= temp___1731 o2))
(assert (= x__attr__tag temp___1732))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= temp___173 x__split_fields2))
(assert (= temp___1731 x__split_fields3))
