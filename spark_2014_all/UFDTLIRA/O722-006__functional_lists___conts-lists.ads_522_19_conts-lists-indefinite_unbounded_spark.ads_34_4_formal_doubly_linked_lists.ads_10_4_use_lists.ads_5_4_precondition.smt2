...
(declare-datatypes () ((list__ref1 (mk_list__ref1 (list__content1 us_rep3)))))
(define-fun list__ref___2__projection ((a list__ref1)) us_rep3 (list__content1 a))
(define-fun default_initial_assumption ((temp___expr_488 us_rep3) (temp___skip_top_level_489 Bool)) Bool (= (attr__tag2 temp___expr_488) us_tag3))
...
(define-fun default_initial_assumption3 ((temp___expr_441 us_rep3) (temp___skip_top_level_442 Bool)) Bool (= (attr__tag2 temp___expr_441) us_tag2))
