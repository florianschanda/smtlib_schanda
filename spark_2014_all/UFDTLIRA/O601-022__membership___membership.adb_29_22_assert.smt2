...
(define-fun default_initial_assumption ((temp___expr_215 us_rep) (temp___skip_top_level_216 Bool)) Bool (= (attr__tag temp___expr_215) us_tag1))
(declare-const g__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun default_initial_assumption1 ((temp___expr_208 us_rep) (temp___skip_top_level_209 Bool)) Bool (= (attr__tag temp___expr_208) us_tag))
