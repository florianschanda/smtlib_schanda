...
(define-fun default_initial_assumption ((temp___expr_192 us_rep) (temp___skip_top_level_193 Bool)) Bool (= (attr__tag temp___expr_192) us_tag1))
(declare-const g__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun default_initial_assumption1 ((temp___expr_182 us_rep) (temp___skip_top_level_183 Bool)) Bool (= (attr__tag temp___expr_182) us_tag))
(assert (= g__attr__tag us_tag1))
(assert (not (= g__attr__tag us_tag)))
(check-sat)
(exit)
