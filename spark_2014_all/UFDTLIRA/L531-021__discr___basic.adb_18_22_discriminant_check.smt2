...
(assert (and (= us (to_rep2 (rec__basic__r__x (us_split_discrs1 v)))) (in_range2 (to_rep2 (rec__basic__r__x (us_split_discrs1 v))))))
...
(assert (not (= (to_rep2 (rec__basic__r__x (us_split_discrs1 v))) 2)))
(check-sat)
(exit)
