...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (and (= (attr__tag temp___expr_143) us_tag) (= (rec__dic__parent__b (us_split_fields1 temp___expr_143)) (of_int 1))) (=> (not (= temp___skip_top_level_144 true)) (= (is_ok__2 temp___expr_143) true))))
(assert true)
(assert true)
(assert (forall ((obj us_rep)) (! (= (to_int1 (is_ok__2 obj)) (to_int1 (is_ok__21 us_tag obj))) :pattern ((is_ok__21 us_tag obj)))))
...
(assert (not (= (is_ok__2 (mk___rep (mk___split_fields temp___162 temp___1621) temp___1622)) true)))
(check-sat)
(exit)
