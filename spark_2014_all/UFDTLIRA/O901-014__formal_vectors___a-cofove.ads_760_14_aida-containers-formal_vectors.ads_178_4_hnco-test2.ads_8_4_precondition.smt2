...
(define-fun dynamic_invariant ((temp___expr_365 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 1 2147483647)) (in_range2 temp___expr_365)))
...
(define-fun default_initial_assumption ((temp___expr_406 us_rep1) (temp___skip_top_level_407 Bool)) Bool (=> (not (= temp___skip_top_level_407 true)) (= (length temp___expr_406) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 2147483647)) (in_range4 temp___expr_377)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity (us_split_discrs1 container1))) 2147483647))
