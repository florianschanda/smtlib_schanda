...
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range4 o2) (= o2 (ite (= (distinct 1 0) true) (to_rep (rec__indefinite_bounded__vect__vector__capacity container__split_discrs)) 2147483647)))))
