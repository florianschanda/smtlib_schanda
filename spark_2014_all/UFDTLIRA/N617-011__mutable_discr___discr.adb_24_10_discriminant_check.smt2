...
(declare-const temp___313 natural)
(declare-const temp___3131 Bool)
...
(declare-const temp___316 us_rep)
...
(assert (= (to_rep o4) 0))
(assert (= o4 o5))
(assert (= temp___313 o5))
(assert (= true temp___3131))
(assert (=> (= d__attr__constrained true) (= temp___313 (rec__discr__with_default__c d__split_discrs2))))
(assert (= (mk___rep (mk___split_discrs usq_2) usq_3) (mk___rep (mk___split_discrs temp___313) temp___3131)))
...
(assert (= (to_rep o6) c))
(assert (= o7 (mk___split_discrs o6)))
(assert (= temp___316 (mk___rep o7 true)))
(assert (= d2__attr__constrained true))
(assert (not (= (rec__discr__with_default__c (us_split_discrs1 temp___316)) d2__split_discrs)))
(check-sat)
(exit)
