...
(assert (=> (= d__attr__constrained true) (= temp___275 (rec__discr__with_default__c d__split_discrs2))))
(assert (= (mk___rep (mk___split_discrs usq_2) usq_3) (mk___rep (mk___split_discrs temp___275) temp___2751)))
(assert (= usq_2 temp___277))
(assert (= d__attr__constrained temp___2771))
(assert (= result2 (mk___split_discrs__ref d__split_discrs2)))
(assert (= d__split_discrs3 (mk___split_discrs temp___277)))
(assert (not (= d2__attr__constrained true)))
(assert (= (to_rep d2__split_discrs) 0))
(assert (= (to_rep o6) c))
(assert (= o7 (mk___split_discrs o6)))
(assert (= temp___278 (mk___rep o7 true)))
(assert (= d2__attr__constrained true))
(assert (not (= (rec__discr__with_default__c (us_split_discrs1 temp___278)) d2__split_discrs)))
(check-sat)
(exit)
