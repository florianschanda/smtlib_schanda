...
(define-fun dynamic_invariant ((temp___expr_1337 Int) (temp___is_init_1334 Bool) (temp___skip_constant_1335 Bool) (temp___do_toplevel_1336 Bool)) Bool (=> (or (= temp___is_init_1334 true) (<= 1 2147483647)) (in_range2 temp___expr_1337)))
...
(define-fun default_initial_assumption ((temp___expr_1344 us_rep2) (temp___skip_top_level_1345 Bool)) Bool (=> (not (= temp___skip_top_level_1345 true)) (and (= (is_empty temp___expr_1344) true) (= (length temp___expr_1344) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true))) :pattern ((length1 container1)))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length1 container1)) (forall ((temp___1358 Int)) (=> (and (in_range5 temp___1358) (= (iter_has_element result temp___1358) true)) (= (contains (model__ container1) (get1 result temp___1358)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
