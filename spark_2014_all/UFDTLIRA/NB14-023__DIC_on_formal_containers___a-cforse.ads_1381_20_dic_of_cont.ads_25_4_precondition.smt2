...
(define-fun default_initial_assumption ((temp___expr_1446 us_rep2) (temp___skip_top_level_1447 Bool)) Bool (=> (not (= temp___skip_top_level_1447 true)) (and (= (is_empty temp___expr_1446) true) (= (length temp___expr_1446) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_1423 us_rep3) (temp___skip_top_level_1424 Bool)) Bool (=> (not (= temp___skip_top_level_1424 true)) (= (length3 temp___expr_1423) 0)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length1 container1)) (forall ((temp___1461 Int)) (=> (and (in_range5 temp___1461) (= (iter_has_element result temp___1461) true)) (= (contains (model__ container1) (get1 result temp___1461)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(declare-const temp___2290 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___2290 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___2290)) no_element))
