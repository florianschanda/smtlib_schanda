...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dic_of_cont__my_orse__cursor__node count_type)))))
(define-fun us_split_fields_Node__5__projection ((a us_split_fields)) count_type (rec__dic_of_cont__my_orse__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__dic_of_cont__my_orse__cursor__node (us_split_fields1 a))) (to_rep (rec__dic_of_cont__my_orse__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun cursor__ref___5__projection ((a cursor__ref)) us_rep (cursor__content a))
(declare-datatypes () ((key_type__ref (mk_key_type__ref (key_type__content us_rep)))))
(define-fun key_type__ref___9__projection ((a key_type__ref)) us_rep (key_type__content a))
...
(define-fun map__ref___9__projection ((a map__ref)) us_rep1 (map__content a))
...
(define-fun dynamic_invariant ((temp___expr_1438 Int) (temp___is_init_1434 Bool) (temp___skip_constant_1435 Bool) (temp___do_toplevel_1436 Bool) (temp___do_typ_inv_1437 Bool)) Bool (=> (or (= temp___is_init_1434 true) (<= 1 2147483647)) (in_range2 temp___expr_1438)))
...
(define-fun default_initial_assumption ((temp___expr_1446 us_rep1) (temp___skip_top_level_1447 Bool)) Bool (=> (not (= temp___skip_top_level_1447 true)) (and (= (is_empty temp___expr_1446) true) (= (length temp___expr_1446) 0))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dic_of_cont__my_orse__set us_main_type1)))))
(define-fun us_split_fields_Set__2__projection ((a us_split_fields2)) us_main_type1 (rec__dic_of_cont__my_orse__set a))
...
(define-fun us_rep___19__projection ((a us_rep2)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___20__projection ((a us_rep2)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 a))) (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__dic_of_cont__my_orse__set (us_split_fields3 a)) (rec__dic_of_cont__my_orse__set (us_split_fields3 b))) true)) true false))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant2 ((temp___expr_1349 Int) (temp___is_init_1345 Bool) (temp___skip_constant_1346 Bool) (temp___do_toplevel_1347 Bool) (temp___do_typ_inv_1348 Bool)) Bool (=> (or (= temp___is_init_1345 true) (<= 0 2147483647)) (in_range3 temp___expr_1349)))
...
(define-fun default_initial_assumption1 ((temp___expr_1423 us_rep3) (temp___skip_top_level_1424 Bool)) Bool (=> (not (= temp___skip_top_level_1424 true)) (= (length2 temp___expr_1423) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_1387 us_rep4) (temp___skip_top_level_1388 Bool)) Bool (=> (not (= temp___skip_top_level_1388 true)) (= (is_empty1 temp___expr_1387) true)))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length1 container1)) (forall ((temp___1461 Int)) (=> (and (in_range5 temp___1461) (= (iter_has_element result temp___1461) true)) (= (contains (model__ container1) (get1 result temp___1461)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(define-fun dynamic_invariant3 ((temp___expr_1379 Int) (temp___is_init_1375 Bool) (temp___skip_constant_1376 Bool) (temp___do_toplevel_1377 Bool) (temp___do_typ_inv_1378 Bool)) Bool (=> (or (= temp___is_init_1375 true) (<= 0 2147483647)) (in_range4 temp___expr_1379)))
...
(define-fun dynamic_invariant4 ((temp___expr_1415 Int) (temp___is_init_1411 Bool) (temp___skip_constant_1412 Bool) (temp___do_toplevel_1413 Bool) (temp___do_typ_inv_1414 Bool)) Bool (=> (or (= temp___is_init_1411 true) (<= 0 2147483647)) (in_range5 temp___expr_1415)))
...
(define-fun dynamic_invariant5 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 2147483647)) (in_range6 temp___expr_1408)))
