...
(assert (not (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields2) 3 no_element) (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2)))) true)))
(check-sat)
(exit)
