...
(assert (= result4 (mk___split_fields__ref (mk___split_fields z1__split_fields z1__split_fields1))))
(assert (= z1__split_fields2 (us_split_fields1 c1)))
(assert (= z1__split_discrs (us_split_discrs1 c1)))
(assert (= z1__attr__constrained true))
(assert (and (= 0 (to_rep1 (rec__p_init__t__e z1__split_discrs))) (= z1__attr__constrained true)))
