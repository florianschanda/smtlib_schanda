...
(define-fun dynamic_invariant ((temp___expr_368 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool) (temp___do_typ_inv_367 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= 1 2147483647)) (in_range2 temp___expr_368)))
...
(define-fun dynamic_invariant1 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 0 2147483647)) (in_range3 temp___expr_382)))
...
(define-fun default_initial_assumption ((temp___expr_390 us_rep) (temp___skip_top_level_391 Bool)) Bool (=> (not (= temp___skip_top_level_391 true)) (= (length temp___expr_390) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_375 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool) (temp___do_typ_inv_374 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 2147483647)) (in_range5 temp___expr_375)))
