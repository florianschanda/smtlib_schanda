...
(declare-const temp___2181 Bool)
...
(assert (= o10 o11))
(assert (= (mk___rep (mk___split_discrs p__y__assume) p__y__assume1) o10))
...
(assert (= (to_rep o8) 3))
(assert (= o8 o9))
(assert (= temp___218 o9))
(assert (= true temp___2181))
(assert (= x__attr__constrained true))
(assert (not (= temp___218 x__split_discrs)))
(check-sat)
(exit)
