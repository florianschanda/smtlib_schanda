...
(assert (=> (= (bool_eq1 position no_element) true) (and (= o4 (length container)) (and (in_range1 o4) (<= o4 (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 container))))))))
