...
(define-fun temp___5202 () us_rep2 (mk___rep1 (mk___split_fields1 temp___5201)))
(define-fun o4 () us_rep2 (mk___rep1 (mk___split_fields1 o2)))
(define-fun o5 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
(assert (and (= o5 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o5 no_element) true) (and (= (has_key (positions l) o5) true) (= (get1 (positions l) o5) 1)))))
(assert (= temp___520 o))
(assert (and (= result (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___520)))) (= (= result true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___520))) true))))
(assert (=> (= result true) (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___520)))) (and (in_range4 o1) (= o1 (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___520)))))))))
(assert (=> (= result true) (= (mk_int__ref result1) (mk_int__ref e))))
(assert (=> (= result true) (= e2 o1)))
(assert (=> (not (= result true)) (= e2 e)))
(assert (=> (not (= result true)) (= e2 e1)))
(assert (and (= result2 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___520)))) (= (= result2 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___520))) true))))
(assert (= result2 true))
(assert (and (= (has_key (positions l) temp___5202) true) (= e3 (element l temp___5202))))
(assert (not (= e3 0)))
(assert (= for_loops_on_lists__contains_0_for_of__result1 for_loops_on_lists__contains_0_for_of__result))
(assert (and (= o4 (next l temp___5202)) (ite (= (ite (= (bool_eq2 temp___5202 no_element) false) (= (get1 (positions l) temp___5202) (length1 l)) true) true) (= (bool_eq2 o4 no_element) true) (and (= (has_key (positions l) o4) true) (= (get1 (positions l) o4) (+ (get1 (positions l) temp___5202) 1))))))
(assert (and (= o3 (has_key (positions l) o4)) (= (= o3 true) (= (has_key (positions l) o4) true))))
(assert (= result3 (ite (not (= o3 true)) true false)))
(assert (not (= result3 true)))
(assert (not (or (= (has_key (positions l) temp___5202) true) (= (bool_eq2 temp___5202 no_element) true))))
(check-sat)
(exit)
