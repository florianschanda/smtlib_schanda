...
(assert (in_range x))
(assert (< 1 x))
(assert (not (= (invariant__ (rec__foo__level_2__c1 (let ((subject red__split_fields)) red__split_fields1)) (rec__foo__level_2__c2 (let ((subject red__split_fields)) red__split_fields1)) (rec__foo__level_2__c3 (let ((subject red__split_fields)) red__split_fields1))) true)))
(check-sat)
(exit)
