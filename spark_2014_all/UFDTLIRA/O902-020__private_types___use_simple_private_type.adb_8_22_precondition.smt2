...
(assert (= use_simple_private_type__add__result2 use_simple_private_type__add__result))
(assert (= use_simple_private_type__add__result2 use_simple_private_type__add__result1))
(assert (not (not (= (is_zero x) true))))
(check-sat)
(exit)
