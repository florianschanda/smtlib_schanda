...
(assert (and (= result5 (is_empty (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (and (= (= result5 true) (forall ((item Int)) (not (and (in_range6 item) (= (contains (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)) item) true))))) (= (= result5 true) (= (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10))) 0)))))
(assert (=> (= result5 true) (and (= o4 (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (in_range3 o4))))
(assert (=> (= result5 true) (= result4 (ite (= o4 0) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (and (= o3 (length (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10)))) (and (in_range3 o3) (<= (+ 0 o3) 2147483647)))))
