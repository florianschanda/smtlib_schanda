...
(assert (not (= status 6)))
(assert (= o (currentfloppy state)))
(assert (= (mk_t__ref1 result) (mk_t__ref1 thecurrentfloppy)))
(assert (= thecurrentfloppy1 o))
(assert (=> (not (= configdataok true)) (= state2 state4)))
(assert (=> (not (= configdataok true)) (= filestate filestate1)))
(assert (=> (not (= configdataok true)) (= state1 state3)))
