...
(define-fun amortized_queue__my_vectors__append__2__container__fields3 () us_split_fields (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1))
(define-fun result____split_fields6 () us_split_fields (mk___split_fields result____split_fields1))
(define-fun amortized_queue__my_vectors__append__2__container__fields4 () us_split_fields (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))
...
(assert (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (length (mk___rep result____split_discrs result____split_fields6)) 1)) (= (olt (model__ (mk___rep result____split_discrs result____split_fields6)) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (last (model__ (mk___rep result____split_discrs result____split_fields6))) 1)) o2)))
(assert (= result2 result____split_fields1))
(assert (= (mk___split_fields result____split_fields2) amortized_queue__my_vectors__append__2__container__fields3))
(assert (= (length (mk___rep result____split_discrs result____split_fields5)) (+ 1 idx2)))
(assert (= (get (model__ (mk___rep result____split_discrs result____split_fields5)) 1) left))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields5)) (+ 1 i)) (get (model__ right) i)))))
