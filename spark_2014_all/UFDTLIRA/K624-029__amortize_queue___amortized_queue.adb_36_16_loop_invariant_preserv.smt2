...
(assert (= (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (+ 1 idx2)))
(assert (= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) 1) left))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 idx2)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (+ 1 i2)) (get (model__ right) i2)))))
(assert (and (=> (<= r23b r24b) (dynamic_property r23b r24b idx2)) (and (<= r23b idx2) (<= idx2 r24b))))
(assert (not (= idx2 r24b)))
(assert (= idx2 result3))
(assert (= idx3 (+ idx2 1)))
(assert (and (= o10 idx3) (in_range4 idx3)))
(assert (and (= o11 (get (model__ right) o10)) (and (in_range7 o11) (= o11 (get (model__ right) o10)))))
(assert (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3)))) 1)) o11)))
(assert (= result4 (mk___split_fields__ref (mk___split_fields result____split_fields3))))
(assert (= result____split_fields4 amortized_queue__my_vectors__append__2__container__fields2))
(declare-const i2 Int)
(assert (<= 1 i2))
(assert (<= i2 idx3))
(assert (not (= (get (model__ (mk___rep result____split_discrs result____split_fields4)) (+ 1 i2)) (get (model__ right) i2))))
(check-sat)
(exit)
