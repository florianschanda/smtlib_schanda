...
(assert (= o i))
(assert (and (and (and (and (= (length (mk___rep v__split_discrs v__split_fields2)) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) 1)) (= (range_equal (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs v__split_fields2)) first1 (- o 1)) true)) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) o) 0)) (= (range_shifted (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs v__split_fields2)) o (last6 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) 1) true)) (dynamic_property3 0 last3 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
