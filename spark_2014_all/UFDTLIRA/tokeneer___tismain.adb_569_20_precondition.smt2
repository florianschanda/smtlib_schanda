...
(assert (=> (= result true) (= o16 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result1 true) (and (= o12 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o12))))
(assert (=> (= result1 true) (= o13 (ite (= o12 0) true false))))
(assert (=> (= result1 true) (= o11 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result2 true) (= o9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result3 true) (= o6 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result3 true) (= o7 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result3 true) (= o8 (ite (= o7 true) o6 false))))
(assert (=> (not (= result3 true)) (= o8 (of_int 1))))
(assert (= o (statusiswaitingremoveadmintokenfail (us_private__content state))))
(assert (= o1 (statusisgotadmintoken (us_private__content state))))
(assert (= result4 (ite (= o1 false) o true)))
(assert (=> (= result4 true) (= o2 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
