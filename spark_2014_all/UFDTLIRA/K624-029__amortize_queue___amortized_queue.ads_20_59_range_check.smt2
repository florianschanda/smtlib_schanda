...
(assert (and (= o15 (length right)) (and (in_range5 o15) (<= o15 (capacity right)))))
(assert (and (= o16 (length left)) (and (in_range5 o16) (<= o16 (capacity left)))))
(assert (= o17 (+ o16 o15)))
(assert (and (= o18 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range5 o18) (<= o18 (capacity (vector__content amortized_queue__Oconcat__result5))))))
...
(assert (and (= o12 (get (model__ right) o11)) (and (in_range6 o12) (= o12 (get (model__ right) o11)))))
(assert (and (= o8 (last (model__ left))) (and (in_range4 o8) (= o8 (last (model__ left))))))
(assert (= o9 (+ o8 i)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (not (in_range3 o10)))
(check-sat)
(exit)
