...
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)) true))
...
(assert (=> (= result2 true) (and (= o1 (element (mk___rep l__split_discrs l__split_fields4) (mk___rep1 cu__split_fields5))) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields4)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5))))))))
(assert (=> (= result2 true) (= o2 (+ o1 1))))
(assert (=> (= result2 true) (and (= o3 o2) (in_range7 o2))))
...
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) 1)))
(assert (not (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs l__split_fields3)) n)) true)))
(check-sat)
(exit)
