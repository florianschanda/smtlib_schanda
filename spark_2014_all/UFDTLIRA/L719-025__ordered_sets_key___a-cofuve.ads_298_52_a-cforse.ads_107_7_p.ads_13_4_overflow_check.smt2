...
(define-fun dynamic_invariant ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 1 2147483647)) (in_range1 temp___expr_340)))
...
(define-fun dynamic_invariant1 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 1 100)) (in_range2 temp___expr_346)))
