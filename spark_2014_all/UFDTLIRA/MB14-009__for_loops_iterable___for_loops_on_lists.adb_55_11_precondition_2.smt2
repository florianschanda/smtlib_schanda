...
(define-fun o7 () us_rep2 (mk___rep1 (mk___split_fields1 o6)))
...
(assert (and (= o5 (has_key (positions l) o8)) (= (= o5 true) (= (has_key (positions l) o8) true))))
(assert (= result7 (ite (not (= o5 true)) true false)))
(assert (not (= result7 true)))
(assert (and (= o7 (next l temp___5471)) (ite (= (ite (= (bool_eq2 temp___5471 no_element) false) (= (get1 (positions l) temp___5471) (length1 l)) true) true) (= (bool_eq2 o7 no_element) true) (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) (+ (get1 (positions l) temp___5471) 1))))))
(assert (= result8 (mk_cursor__ref temp___5471)))
(assert (= temp___5472 o7))
(assert (and (= result9 (has_key (positions l) temp___5472)) (= (= result9 true) (= (has_key (positions l) temp___5472) true))))
(assert (= result9 true))
(assert (not (= (has_key (positions l) temp___5472) true)))
(check-sat)
(exit)
