...
(assert (forall ((x et3)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x enum1ta)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_188 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 10 90)) (in_range1 temp___expr_188)))
(define-fun dynamic_invariant3 ((temp___expr_212 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 4)) (in_range2 temp___expr_212)))
...
(declare-const temp___6788 et3)
(declare-const temp___67881 et1)
(declare-const temp___67882 et2)
(declare-const temp___67883 enum1ta)
...
(assert (= (to_rep o) e))
(assert (= o o1))
(assert (= r__split_fields6 o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= r__split_fields4 o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= r__split_fields7 o8))
(assert (= temp___6788 o5))
(assert (= temp___67881 o6))
(assert (= temp___67882 o7))
(assert (= temp___67883 o8))
(assert (= result4 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields4 (mk___rep (mk___split_fields r__split_fields5 r__split_fields6)) r__split_fields7))))
(assert (= r__split_fields8 (mk___split_fields1 temp___6788 (mk___rep (mk___split_fields temp___67881 temp___67882)) temp___67883)))
(assert (= r__split_fields9 (mk___split_fields__ref1 r__split_fields8)))
(assert (= r__split_fields10 r__split_fields8))
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields9)) (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 a)))) r__split_fields3))) true)))
(check-sat)
(exit)
