...
(declare-const temp___6847 et3)
(declare-const temp___68471 et1)
(declare-const temp___68472 et2)
(declare-const temp___68473 enum1ta)
...
(assert (= temp___6847 o5))
(assert (= temp___68471 o6))
(assert (= temp___68472 o7))
(assert (= temp___68473 o8))
...
(assert (= r__split_fields8 (mk___split_fields1 temp___6847 (mk___rep (mk___split_fields temp___68471 temp___68472)) temp___68473)))
