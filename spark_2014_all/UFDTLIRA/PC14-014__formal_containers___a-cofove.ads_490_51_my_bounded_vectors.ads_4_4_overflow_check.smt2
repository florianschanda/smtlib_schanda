...
(define-fun dynamic_invariant ((temp___expr_780 Int) (temp___is_init_776 Bool) (temp___skip_constant_777 Bool) (temp___do_toplevel_778 Bool) (temp___do_typ_inv_779 Bool)) Bool (=> (or (= temp___is_init_776 true) (<= 0 2147483647)) (in_range1 temp___expr_780)))
