...
(define-fun dynamic_invariant1 ((temp___expr_620 Int) (temp___is_init_616 Bool) (temp___skip_constant_617 Bool) (temp___do_toplevel_618 Bool) (temp___do_typ_inv_619 Bool)) Bool (=> (or (= temp___is_init_616 true) (<= 0 2147483647)) (in_range2 temp___expr_620)))
...
(define-fun dynamic_invariant2 ((temp___expr_606 Int) (temp___is_init_602 Bool) (temp___skip_constant_603 Bool) (temp___do_toplevel_604 Bool) (temp___do_typ_inv_605 Bool)) Bool (=> (or (= temp___is_init_602 true) (<= 1 2147483647)) (in_range4 temp___expr_606)))
...
(define-fun dynamic_invariant3 ((temp___expr_613 Int) (temp___is_init_609 Bool) (temp___skip_constant_610 Bool) (temp___do_toplevel_611 Bool) (temp___do_typ_inv_612 Bool)) Bool (=> (or (= temp___is_init_609 true) (<= 1 2147483647)) (in_range5 temp___expr_613)))
...
(assert (forall ((container1 us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant1 position1 true true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant3 (get container1 position1) true false true true)) :pattern ((get container1 position1))))))
(declare-const o Int)
...
(assert (= result true))
(assert (and (= o1 (last container)) (and (in_range2 o1) (= o1 (+ 0 (length container))))))
(assert (= result1 (ite (< o1 2147483647) true false)))
(assert (= result1 true))
(assert (and (= o (last container)) (and (in_range2 o) (= o (+ 0 (length container))))))
