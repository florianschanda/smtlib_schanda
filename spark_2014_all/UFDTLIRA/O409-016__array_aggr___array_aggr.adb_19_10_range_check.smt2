...
(assert (forall ((temp___279 Int)) (forall ((temp___280 Int) (temp___281 Int)) (= (get (array_aggr__bi_dim_aggr_ok__aggregate_ko2__b__aggregate_def temp___279) temp___280 temp___281) (of_rep1 temp___279)))))
(declare-fun array_aggr__bi_dim_aggr_ok__aggregate_ko2__f__aggregate_def (Int) map1)
(assert (forall ((temp___284 Int)) (forall ((temp___285 Int) (temp___286 Int)) (= (get (array_aggr__bi_dim_aggr_ok__aggregate_ko2__f__aggregate_def temp___284) temp___285 temp___286) (of_rep1 temp___284)))))
...
(assert (<= one 1))
(assert (= result b))
(assert (= b1 (slide (array_aggr__bi_dim_aggr_ok__aggregate_ko2__b__aggregate_def 0) 0 1 0 1)))
(assert (<= 1 2))
(assert (not (<= first 1)))
(check-sat)
(exit)
