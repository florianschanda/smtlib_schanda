...
(assert (= first one))
(assert (forall ((temp___315 Int)) (=> (dynamic_invariant temp___315 true true true true) (forall ((temp___316 Int) (temp___317 Int)) (= (to_rep1 (get (array_aggr__bi_dim_aggr_ok__aggregate_ko2__b__aggregate_def temp___315) temp___316 temp___317)) temp___315)))))
(assert (forall ((temp___320 Int)) (=> (dynamic_invariant temp___320 true true true true) (forall ((temp___321 Int) (temp___322 Int)) (= (to_rep1 (get (array_aggr__bi_dim_aggr_ok__aggregate_ko2__f__aggregate_def temp___320) temp___321 temp___322)) temp___320)))))
...
(assert (<= one 1))
(assert (= result b))
(assert (= b1 (slide (array_aggr__bi_dim_aggr_ok__aggregate_ko2__b__aggregate_def 0) 3 1 0 1)))
(assert (<= 1 2))
(assert (not (<= first 1)))
(check-sat)
(exit)
