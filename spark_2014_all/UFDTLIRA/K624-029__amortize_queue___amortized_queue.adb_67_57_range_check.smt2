...
(assert (= (= result9 true) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (last (model__ ofront)))) (= (get (model__ (mk___rep front__split_discrs (us_split_fields__content front__split_fields9))) i4) (get (model__ ofront) i4))))))
(assert (= result9 true))
(assert (and (= o21 (last (model__ orear))) (and (in_range3 o21) (= o21 (last (model__ orear))))))
(assert (= o22 (ite (<= i2 o21) true false)))
(assert (= result11 (ite (<= 1 i2) o22 false)))
(assert (= result11 true))
(assert (and (= o27 i2) (in_range2 i2)))
(assert (and (= o28 (get (model__ orear) o27)) (and (in_range5 o28) (= o28 (get (model__ orear) o27)))))
(assert (and (= o23 (last (model__ (mk___rep front__split_discrs (us_split_fields__content front__split_fields9))))) (and (in_range3 o23) (= o23 (last (model__ (mk___rep front__split_discrs (us_split_fields__content front__split_fields9))))))))
(assert (= o24 (+ o23 1)))
(assert (= o25 (- o24 i2)))
