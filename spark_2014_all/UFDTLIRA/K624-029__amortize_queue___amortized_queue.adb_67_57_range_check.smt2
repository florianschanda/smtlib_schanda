...
(assert (and (= o12 (length orear)) (and (in_range4 o12) (<= o12 (capacity orear)))))
(assert (and (= o13 (length ofront)) (and (in_range4 o13) (<= o13 (capacity ofront)))))
(assert (= o14 (+ o13 o12)))
(assert (and (= o15 (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))) (and (in_range4 o15) (<= o15 (capacity (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))))))
(assert (= result3 (ite (= o15 o14) true false)))
(assert (= result3 true))
(assert (and (= o11 (length (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))) (and (in_range4 o11) (<= o11 (capacity (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))))))
...
(assert (and (= o8 (get (model__ orear) o7)) (and (in_range5 o8) (= o8 (get (model__ orear) o7)))))
