...
(declare-const temp___6994 us_rep2)
...
(declare-const temp___6998 us_rep2)
...
(assert (= temp___6994 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o14 (mk___rep (mk___split_fields o15 o16)) o17)) o18))))
...
(assert (= r__split_fields5 (us_split_fields5 temp___6994)))
...
(assert (= temp___6998 (mk___rep2 o24)))
(assert (= result2 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields6 (us_split_fields5 temp___6998)))
