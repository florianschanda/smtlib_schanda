...
(assert (and (= o2 (positions s)) (and (not (= (has_key1 o2 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key1 o2 i1) true) (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length3 s))) (forall ((j us_rep1)) (=> (= (has_key1 o2 j) true) (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (not (= (has_key1 o2 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
