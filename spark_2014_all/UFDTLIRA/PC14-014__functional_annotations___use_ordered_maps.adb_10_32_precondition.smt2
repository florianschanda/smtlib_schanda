...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (not (= (get (keys s) i) k)))))
(assert (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true))
(assert (and (= o2 (positions s)) (and (not (= (has_key1 o2 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key1 o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length3 s))) (forall ((j us_rep1)) (=> (= (has_key1 o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq1 i j) true))))))))))
