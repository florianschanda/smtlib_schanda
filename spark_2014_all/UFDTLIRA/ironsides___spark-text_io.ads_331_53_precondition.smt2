...
(define-fun dynamic_invariant ((temp___expr_746 Int) (temp___is_init_742 Bool) (temp___skip_constant_743 Bool) (temp___do_toplevel_744 Bool) (temp___do_typ_inv_745 Bool)) Bool (=> (or (= temp___is_init_742 true) (<= 1 2147483647)) (in_range temp___expr_746)))
...
(define-fun dynamic_invariant1 ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 0 2)) (in_range1 temp___expr_732)))
