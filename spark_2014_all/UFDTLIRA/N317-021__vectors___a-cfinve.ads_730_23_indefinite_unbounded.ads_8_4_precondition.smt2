...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 0 0) true) (to_rep (rec__indefinite_unbounded__vect__vector__capacity (us_split_discrs1 container1))) 2147483647))
