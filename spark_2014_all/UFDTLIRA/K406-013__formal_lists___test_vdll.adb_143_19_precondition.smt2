...
(assert (and (= o12 (next (mk___rep l3__split_discrs l3__split_fields4) o11)) (ite (= (ite (= (bool_eq3 o11 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o11) (length (mk___rep l3__split_discrs l3__split_fields4))) true) true) (= (bool_eq3 o12 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o12) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o12) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o11) 1))))))
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o12) true)))
(check-sat)
(exit)
