...
(assert (and (= o71 (next (mk___rep l3__split_discrs l3__split_fields4) o70)) (ite (= (ite (= (bool_eq1 o70 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o70) (length (mk___rep l3__split_discrs l3__split_fields4))) true) true) (= (bool_eq1 o71 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o71) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o71) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o70) 1))))))
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o71) true)))
(check-sat)
(exit)
