...
(define-fun dynamic_invariant ((temp___expr_432 Int) (temp___is_init_428 Bool) (temp___skip_constant_429 Bool) (temp___do_toplevel_430 Bool) (temp___do_typ_inv_431 Bool)) Bool (=> (or (= temp___is_init_428 true) (<= 1 2147483647)) (in_range2 temp___expr_432)))
...
(define-fun dynamic_invariant1 ((temp___expr_446 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool) (temp___do_typ_inv_445 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 2147483647)) (in_range3 temp___expr_446)))
...
(define-fun default_initial_assumption ((temp___expr_454 us_rep) (temp___skip_top_level_455 Bool)) Bool (=> (not (= temp___skip_top_level_455 true)) (= (length temp___expr_454) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_439 Int) (temp___is_init_435 Bool) (temp___skip_constant_436 Bool) (temp___do_toplevel_437 Bool) (temp___do_typ_inv_438 Bool)) Bool (=> (or (= temp___is_init_435 true) (<= 0 2147483647)) (in_range5 temp___expr_439)))
