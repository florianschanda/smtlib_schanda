...
(define-fun dynamic_invariant ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1 2147483647)) (in_range2 temp___expr_383)))
...
(define-fun dynamic_invariant1 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range3 temp___expr_395)))
...
(define-fun default_initial_assumption ((temp___expr_402 us_rep) (temp___skip_top_level_403 Bool)) Bool (=> (not (= temp___skip_top_level_403 true)) (= (length temp___expr_402) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 0 2147483647)) (in_range5 temp___expr_389)))
