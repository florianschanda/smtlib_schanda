...
(define-fun dynamic_invariant1 ((temp___expr_446 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool) (temp___do_typ_inv_445 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 2147483647)) (in_range2 temp___expr_446)))
...
(define-fun dynamic_invariant2 ((temp___expr_432 Int) (temp___is_init_428 Bool) (temp___skip_constant_429 Bool) (temp___do_toplevel_430 Bool) (temp___do_typ_inv_431 Bool)) Bool (=> (or (= temp___is_init_428 true) (<= 1 2147483647)) (in_range4 temp___expr_432)))
