...
(define-fun v__split_fields8 () us_split_fields (mk___split_fields v__split_fields2))
...
(define-fun v__split_fields9 () us_split_fields (mk___split_fields v__split_fields1))
