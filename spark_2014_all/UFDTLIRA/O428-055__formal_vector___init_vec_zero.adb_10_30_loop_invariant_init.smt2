...
(assert (not (= (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))) (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(check-sat)
(exit)
