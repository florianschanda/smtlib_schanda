...
(assert (and (= o (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__use_lists__my_lists__list__capacity container__split_discrs))))))
(assert (= o1 (- o count)))
