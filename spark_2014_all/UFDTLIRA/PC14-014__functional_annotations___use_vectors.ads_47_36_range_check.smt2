...
(assert (forall ((x tcount_typeB)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_270 us_rep) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 temp___expr_270)))))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(declare-const last_count Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant2 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 last2)) (dynamic_property2 0 last2 temp___expr_263)))
(assert (= last2 last_count))
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 0 0) true) (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 container))) last2))
...
(define-fun dynamic_invariant3 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_287)))
(define-fun dynamic_invariant4 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_294)))
...
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant4 position true true true true) (and (<= first3 position) (<= position (last5 container)))) (dynamic_invariant3 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant5 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first4 last6)) (dynamic_property5 first4 last6 temp___expr_256)))
...
(define-fun dynamic_invariant6 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_249)))
(declare-fun first_index__function_guard (Int us_rep) Bool)
(define-fun equal_except ((left us_rep1) (right us_rep1) (position Int)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((i Int)) (=> (and (<= first3 i) (<= i (last5 left))) (=> (not (= i position)) (= (get left i) (get right i))))) true false)))
...
(define-fun dynamic_invariant7 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_235)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= first last)) (dynamic_property first last temp___expr_228)))
(assert (= first fst))
(assert (= last lst))
...
(define-fun dynamic_invariant10 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first1 last1)) (dynamic_property1 first1 last1 temp___expr_242)))
(assert (= first1 fst))
(assert (= last1 lst))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first3 1) result) last4) (dynamic_invariant9 result true false true true))) :pattern ((length1 container)))))
(define-fun dynamic_invariant11 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first3 last4)) (dynamic_property4 first3 last4 temp___expr_280)))
(assert (= first3 fst))
(assert (= last4 lst))
...
(declare-const temp___479 us_rep1)
(declare-const temp___480 us_rep1)
(declare-const temp___476 tcount_typeB)
(declare-const temp___4761 us_main_type)
...
(assert (and (= o (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (and (dynamic_property5 first4 last6 o) (= o (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))))
...
(assert (= i1 first))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= temp___477 i1)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= temp___479 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= temp___480 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (and (= v__split_discrs (mk___split_discrs temp___476)) (= v__split_fields temp___4761))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= temp___478 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= (length (mk___rep v__split_discrs v__split_fields12)) temp___478)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (forall ((n1 Int)) (=> (and (<= first n1) (<= n1 (- i2 1))) (= (is_incr (get temp___479 n1) (get (model__ (mk___rep v__split_discrs v__split_fields12)) n1)) true)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (forall ((n1 Int)) (=> (and (<= i2 n1) (<= n1 (last5 (model__ (mk___rep v__split_discrs v__split_fields12))))) (= (get temp___480 n1) (get (model__ (mk___rep v__split_discrs v__split_fields12)) n1))))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (and (and (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))) (=> (<= first r7b) (dynamic_property6 first r7b i2))) (and (<= first i2) (<= i2 r7b)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (and (= us i2) (dynamic_property1 first1 last1 i2))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= o1 i2)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1)) (and (in_range5 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o1))))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= result2 (ite (< o2 2147483647) true false))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (and (= us2 i2) (dynamic_property1 first1 last1 i2)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (= o4 i2))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (and (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o4)) (and (in_range5 o5) (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields12)) o4)))))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (= o6 (+ o5 1)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (and (= o7 o6) (in_range2 o6)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (and (= us1 i2) (dynamic_property1 first1 last1 i2)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (= o3 i2))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (= result2 true) (and (and (and (= (length (mk___rep v__split_discrs v__split_fields11)) (length (mk___rep v__split_discrs v__split_fields12))) (= (get (model__ (mk___rep v__split_discrs v__split_fields11)) o3) o7)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields12)) (model__ (mk___rep v__split_discrs v__split_fields11)) o3) true)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (=> (not (= result2 true)) (= v__split_fields11 v__split_fields12))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= i2 r7b)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= i2 i3)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= v__split_fields4 v__split_fields3)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= i4 i2)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= v__split_fields10 v__split_fields11)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= i5 (mk_int__ref i3))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields4)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= i6 i4)))
(assert (=> (and (<= first i1) (<= i1 r7b)) (= v__split_fields7 v__split_fields10)))
(assert (=> (not (and (<= first i1) (<= i1 r7b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= first i1) (<= i1 r7b))) (= v__split_fields6 (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (not (and (<= first i1) (<= i1 r7b))) (= i6 i1)))
(assert (=> (not (and (<= first i1) (<= i1 r7b))) (= v__split_fields7 (mk___split_fields v__split_fields1))))
(assert (= i7 i5))
...
(assert (and (= o8 (last5 (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))))) (and (dynamic_property5 first4 last6 o8) (= o8 (last5 (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))))))))
(assert (= o9 (ite (<= n o8) true false)))
(assert (= result3 (ite (<= first n) o9 false)))
(assert (= result3 true))
(assert (not (dynamic_property1 first1 last1 n)))
(check-sat)
(exit)
