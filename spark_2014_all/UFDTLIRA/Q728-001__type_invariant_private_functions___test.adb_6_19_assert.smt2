...
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true true) (= (saturate x) (ite (< (to_rep (rec__test_type__t__f (us_split_fields1 x))) 0) (mk___rep (mk___split_fields (of_rep 0))) x))) :pattern ((saturate x)))))
