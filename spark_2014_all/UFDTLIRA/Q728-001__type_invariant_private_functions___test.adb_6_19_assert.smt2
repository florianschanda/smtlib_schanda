...
(define-fun dynamic_invariant ((temp___expr_135 us_rep) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (in_range1 (to_rep (rec__test_type__t__f (us_split_fields1 temp___expr_135)))))
(define-fun default_initial_assumption ((temp___expr_137 us_rep) (temp___skip_top_level_138 Bool)) Bool (= (to_rep (rec__test_type__t__f (us_split_fields1 temp___expr_137))) 0))
(define-fun type_invariant ((temp___139 us_rep)) Bool (in_range1 (to_rep (rec__test_type__t__f (us_split_fields1 temp___139)))))
...
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (decr x) true false true)) :pattern ((decr x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true) (= (decr x) (saturate (decr_int x)))) :pattern ((decr x)))))
...
(assert (forall ((x us_rep)) (! (=> (and (dynamic_invariant x true true true) (< (- 2147483648) (to_rep (rec__test_type__t__f (us_split_fields1 x))))) (dynamic_invariant (decr_int x) true false true)) :pattern ((decr_int x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true) (= (decr_int x) (mk___rep (mk___split_fields (of_rep (- (to_rep (rec__test_type__t__f (us_split_fields1 x))) 1)))))) :pattern ((decr_int x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (saturate x) true false true)) :pattern ((saturate x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true) (= (saturate x) (ite (< (to_rep (rec__test_type__t__f (us_split_fields1 x))) 0) (mk___rep (mk___split_fields (of_rep 0))) x))) :pattern ((saturate x)))))
...
(assert (and (= (mk___rep (mk___split_fields test__y__assume)) (decr (mk___rep (mk___split_fields x__split_fields)))) (and (in_range1 (to_rep test__y__assume)) (= (mk___rep (mk___split_fields test__y__assume)) (saturate (decr_int (mk___rep (mk___split_fields x__split_fields))))))))
