...
(assert (= result1 true))
(assert (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3)) (+ (length (mk___rep s2__split_discrs s2__split_fields2)) 1)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) i) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i)))))
