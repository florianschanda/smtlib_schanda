...
(assert (=> (= result1 true) (= o28 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result1 true) (= o29 (ite (not (= o28 true)) true false))))
(assert (=> (= result1 true) (= o27 (ispresent (mk___rep theadmin__split_fields2)))))
...
(assert (=> (= result2 true) (and (= o23 (rolepresent (mk___rep theadmin__split_fields2))) (in_range1 o23))))
(assert (=> (= result2 true) (= o24 (ite (= o23 0) true false))))
(assert (=> (= result2 true) (= o22 (isdoingop (mk___rep theadmin__split_fields2)))))
...
(assert (=> (= result3 true) (= o20 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result3 true) (= o21 (ite (not (= o20 true)) true false))))
(assert (=> (not (= result3 true)) (= o21 (of_int 1))))
(assert (= o15 (statusiswaitingfinishadminop (let ((subject state)) state12))))
(assert (= o16 (statusiswaitingstartadminop (let ((subject state)) state12))))
(assert (= result4 (ite (= o16 false) o15 true)))
(assert (=> (= result4 true) (= o17 (ispresent (mk___rep theadmin__split_fields2)))))
(assert (=> (= result4 true) (= o18 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result4 true) (= o19 (ite (= o18 true) o17 false))))
(assert (=> (not (= result4 true)) (= o19 (of_int 1))))
(assert (= o11 (statusiswaitingremoveadmintokenfail (let ((subject state)) state12))))
(assert (= o12 (statusisgotadmintoken (let ((subject state)) state12))))
(assert (= result5 (ite (= o12 false) o11 true)))
(assert (=> (= result5 true) (= o13 (ispresent (mk___rep theadmin__split_fields2)))))
(assert (=> (= result5 true) (= o14 (ite (not (= o13 true)) true false))))
(assert (=> (not (= result5 true)) (= o14 (of_int 1))))
(assert (and (= o7 (thecurrentop (mk___rep theadmin__split_fields2))) (in_range3 o7)))
(assert (= o8 (ite (= o7 4) true false)))
(assert (= o9 (isdoingop (mk___rep theadmin__split_fields2))))
(assert (= result6 (ite (= o9 true) o8 false)))
(assert (=> (= result6 true) (= o10 (statusiswaitingstartadminop (let ((subject state)) state12)))))
(assert (=> (not (= result6 true)) (= o10 (of_int 1))))
(assert (= o4 (ispresent (mk___rep theadmin__split_fields2))))
(assert (= result7 (ite (not (= o4 true)) true false)))
(assert (=> (= result7 true) (= o5 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result7 true) (= o6 (ite (not (= o5 true)) true false))))
(assert (=> (not (= result7 true)) (= o6 (of_int 1))))
(assert (and (= o1 (rolepresent (mk___rep theadmin__split_fields2))) (in_range1 o1)))
(assert (= result8 (ite (= o1 1) true false)))
(assert (= result8 true))
(assert (= o2 (isdoingop (mk___rep theadmin__split_fields2))))
