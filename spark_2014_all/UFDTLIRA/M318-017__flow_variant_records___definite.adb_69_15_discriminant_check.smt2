...
(assert (not (= (to_rep1 x__split_discrs) 1)))
(assert (= (to_rep1 x__split_discrs) r13b))
...
(assert (= o13 o18))
(assert (= temp___177 o18))
(assert (= temp___1771 o15))
(assert (= temp___1772 o16))
(assert (= temp___1773 o17))
(assert (= true temp___1774))
(assert (= x__attr__constrained true))
(assert (not (= temp___177 x__split_discrs)))
(check-sat)
(exit)
