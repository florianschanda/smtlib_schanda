...
(declare-const temp___998 read_status)
(declare-const temp___9981 character)
(declare-const temp___9982 Bool)
(declare-const o Int)
...
(assert (=> (= current_read__attr__constrained true) (= next_read__split_discrs current_read__split_discrs)))
(assert (= next_read__split_discrs usq_))
(assert (= next_read__split_fields usq_1))
(assert (= next_read__attr__constrained usq_2))
(assert (= usq_ temp___998))
(assert (= usq_1 temp___9981))
(assert (= current_read__attr__constrained temp___9982))
(assert (= result (mk___split_fields__ref (mk___split_fields current_read__split_fields))))
(assert (= current_read__split_fields1 (mk___split_fields temp___9981)))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs))))
(assert (= current_read__split_discrs1 (mk___split_discrs temp___998)))
(assert (= result2 (mk_int__ref current_idx)))
(assert (= current_idx1 next_idx))
(assert (and (in_range2 current_line1) (in_range1 current_col1)))
(assert (=> (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0) (and (and (and (= (size the_file2) (size the_file)) (<= (index the_file2) (size the_file2))) (or (not (= (to_rep (rec__file_io__read_result__status next_read__split_discrs2)) 0)) (= (index the_file2) (+ (index the_file) 1)))) (or (= (to_rep (rec__file_io__read_result__status next_read__split_discrs2)) 0) (= (index the_file2) (index the_file))))))
(assert (=> (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0) (and (= o (index the_file2)) (and (in_range1 o) (<= o (size the_file2))))))
(assert (=> (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0) (= result3 (mk_int__ref next_idx))))
(assert (=> (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0) (= next_idx2 o)))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= next_idx2 next_idx)))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= next_read__split_discrs2 (mk___split_discrs next_read__split_discrs))))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= next_read__split_fields2 (mk___split_fields next_read__split_fields))))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= the_file2 the_file)))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= next_idx2 next_idx1)))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= next_read__split_discrs2 (mk___split_discrs next_read__split_discrs1))))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= next_read__split_fields2 (mk___split_fields next_read__split_fields1))))
(assert (=> (not (= (to_rep (rec__file_io__read_result__status current_read__split_discrs1)) 0)) (= the_file2 the_file1)))
(assert (= next_idx3 (mk_int__ref next_idx2)))
...
(assert (= current_read__split_discrs2 (mk___split_discrs__ref current_read__split_discrs1)))
(assert (= current_read__split_fields2 (mk___split_fields__ref current_read__split_fields1)))
(assert (= the_file3 (mk_file__ref the_file2)))
(assert (= next_idx4 next_idx2))
