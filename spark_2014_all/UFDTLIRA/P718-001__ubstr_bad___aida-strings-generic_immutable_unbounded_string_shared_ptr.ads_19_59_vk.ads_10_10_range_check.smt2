...
(define-fun default_initial_assumption ((temp___expr_842 us_rep) (temp___skip_top_level_843 Bool)) Bool (=> (not (= temp___skip_top_level_843 true)) (= (length temp___expr_842) 0)))
