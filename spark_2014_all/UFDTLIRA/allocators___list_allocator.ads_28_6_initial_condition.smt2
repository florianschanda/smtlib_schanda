...
(assert (=> (= result7 true) (= (= result6 true) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 10000)) (= (get (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields12)) rr3) rr3))))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (= (= result11 true) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 10000)) (= (contains1 (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields12)) rr3) true))))))
(assert (=> (not (= result6 true)) (= result11 false)))
(assert (not (= (is_empty (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields12))) true)))
(check-sat)
(exit)
