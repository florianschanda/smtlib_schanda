...
(assert (and (= result7 (is_empty (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (and (= (= result7 true) (forall ((item Int)) (not (and (in_range6 item) (= (contains (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)) item) true))))) (= (= result7 true) (= (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10))) 0)))))
(assert (=> (= result7 true) (and (= o5 (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (in_range3 o5))))
(assert (=> (= result7 true) (= result6 (ite (= o5 0) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o4 (length (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10)))) (and (in_range3 o4) (<= (+ 0 o4) 2147483647)))))
(assert (=> (= result6 true) (= result5 (ite (= o4 10000) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o3 (get (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10)) 1)) (in_range4 o3))))
