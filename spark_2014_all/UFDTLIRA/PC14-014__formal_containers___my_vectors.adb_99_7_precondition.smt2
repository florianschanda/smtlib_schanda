...
(assert (not (<= (length (mk___rep k__split_discrs k__split_fields3)) (- (capacity (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields3))))))
(check-sat)
(exit)
