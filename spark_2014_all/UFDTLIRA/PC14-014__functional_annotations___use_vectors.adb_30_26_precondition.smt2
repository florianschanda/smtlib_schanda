...
(assert (= o5 n))
(assert (and (= o6 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o5)) (and (in_range5 o6) (= o6 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o5)))))
(assert (and (= us n) (dynamic_property3 first2 last3 n)))
(assert (= o3 n))
(assert (not (<= first3 o3)))
(check-sat)
(exit)
