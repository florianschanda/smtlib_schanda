...
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields)))) 1)) o2))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields9)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= (mk___split_fields result____split_fields2) amortized_queue__my_vectors__append__2__container__fields1)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= (length (mk___rep result____split_discrs result____split_fields8)) idx2)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields8)) i) (get (model__ left) i))))))
...
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= result____split_fields4 (mk___split_fields__ref result____split_fields8))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= idx4 idx2)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= result____split_fields5 result____split_fields8)))
...
(assert (=> (not (and (<= r33b idx1) (<= idx1 r34b))) (= result____split_fields6 result____split_fields9)))
