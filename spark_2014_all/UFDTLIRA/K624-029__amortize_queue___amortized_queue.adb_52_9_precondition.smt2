...
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (and (and (= (length (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields))) (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))) true)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields)))) 1)) o2))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields result____split_fields)))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= (mk___split_fields result____split_fields2) (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) idx2)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 idx2)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) i2) (get (model__ left) i2))))))
...
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= idx4 (mk_int__ref idx2))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= result____split_fields5 (mk___split_fields__ref (mk___split_fields result____split_fields3)))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= idx5 idx2)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= result____split_fields6 (mk___split_fields result____split_fields3))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= idx6 idx4)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= result____split_fields7 result____split_fields5)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= idx7 idx5)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= result____split_fields8 result____split_fields6)))
(assert (=> (not (and (<= r33b idx1) (<= idx1 r34b))) (= idx6 (mk_int__ref idx1))))
(assert (=> (not (and (<= r33b idx1) (<= idx1 r34b))) (= result____split_fields7 (mk___split_fields__ref (mk___split_fields result____split_fields)))))
(assert (=> (not (and (<= r33b idx1) (<= idx1 r34b))) (= idx7 idx1)))
(assert (=> (not (and (<= r33b idx1) (<= idx1 r34b))) (= result____split_fields8 (mk___split_fields result____split_fields1))))
