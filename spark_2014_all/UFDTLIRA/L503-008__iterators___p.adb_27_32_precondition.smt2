...
(define-fun dynamic_invariant1 ((temp___expr_190 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_190)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption1 ((temp___expr_234 us_rep2) (temp___skip_top_level_235 Bool)) Bool (=> (not (= temp___skip_top_level_235 true)) (= (length1 temp___expr_234) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_253 us_rep3) (temp___skip_top_level_254 Bool)) Bool (=> (not (= temp___skip_top_level_254 true)) (and (= (is_empty temp___expr_253) true) (= (length2 temp___expr_253) 0))))
(define-fun default_initial_assumption3 ((temp___expr_241 us_rep1) (temp___skip_top_level_242 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_241))) 0))
...
(define-fun dynamic_invariant3 ((temp___expr_227 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 0 2147483647)) (in_range4 temp___expr_227)))
...
(define-fun dynamic_invariant4 ((temp___expr_221 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_221)))
...
(define-fun dynamic_invariant5 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 1 2147483647)) (in_range6 temp___expr_246)))
...
(declare-const temp___468 count_type)
(declare-const temp___464 count_type)
...
(declare-const c__split_fields3 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___468 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___468)) no_element))
(assert (= result sum))
(assert (= sum1 0))
(assert (in_range1 sum1))
(assert (= (to_rep c__split_fields) 0))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___464)) (first x)) (ite (= (= (length x) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___464)) no_element) true) (and (= (has_key (positions x) (mk___rep1 (mk___split_fields1 temp___464))) true) (= (get1 (positions x) (mk___rep1 (mk___split_fields1 temp___464))) 1)))))
(assert (= result1 c__split_fields))
(assert (= temp___464 c__split_fields1))
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 c__split_fields1)) no_element) true)))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 sum2)) (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 c__split_fields2)) no_element) true))))
(assert (not (= (has_key (positions x) (mk___rep1 (mk___split_fields1 c__split_fields2))) true)))
(check-sat)
(exit)
