...
(define-fun default_initial_assumption ((temp___expr_236 us_rep1) (temp___skip_top_level_237 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_236))) 0))
...
(define-fun dynamic_invariant1 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_222)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep2) (temp___skip_top_level_274 Bool)) Bool (=> (not (= temp___skip_top_level_274 true)) (= (length1 temp___expr_273) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_295 us_rep3) (temp___skip_top_level_296 Bool)) Bool (=> (not (= temp___skip_top_level_296 true)) (and (= (is_empty temp___expr_295) true) (= (length2 temp___expr_295) 0))))
(define-fun default_initial_assumption3 ((temp___expr_281 us_rep1) (temp___skip_top_level_282 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_281))) 0))
...
(define-fun dynamic_invariant3 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483647)) (in_range4 temp___expr_265)))
...
(define-fun in_range5 ((x1 Int)) Bool (and (<= (- 2147483648) x1) (<= x1 2147483647)))
...
(define-fun dynamic_invariant4 ((temp___expr_258 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool) (temp___do_typ_inv_257 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_258)))
...
(define-fun dynamic_invariant5 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= 1 2147483647)) (in_range6 temp___expr_287)))
...
(declare-const temp___511 count_type)
(declare-const temp___507 count_type)
...
(define-fun c__split_fields3 () us_split_fields2 (mk___split_fields1 c__split_fields2))
(define-fun temp___5071 () us_rep1 (mk___rep1 (mk___split_fields1 temp___507)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___511 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___511)) no_element))
(assert (= result sum))
(assert (= sum1 0))
(assert (in_range1 sum1))
(assert (= (to_rep c__split_fields) 0))
(assert (and (= temp___5071 (first x)) (ite (= (= (length x) 0) true) (= (bool_eq1 temp___5071 no_element) true) (and (= (has_key (positions x) temp___5071) true) (= (get1 (positions x) temp___5071) 1)))))
(assert (= result1 c__split_fields))
(assert (= temp___507 c__split_fields1))
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 c__split_fields1)) no_element) true)))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 sum2)) (not (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true))))
(assert (not (= (has_key (positions x) (mk___rep1 c__split_fields3)) true)))
(check-sat)
(exit)
