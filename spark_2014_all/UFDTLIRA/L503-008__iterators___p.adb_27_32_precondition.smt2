...
(define-fun temp___4641 () us_rep1 (mk___rep1 (mk___split_fields1 temp___464)))
(assert (= (to_rep o) 0))
(assert (= o o1))
...
(assert (and (= temp___4641 (first x)) (ite (= (= (length x) 0) true) (= (bool_eq1 temp___4641 no_element) true) (and (= (has_key (positions x) temp___4641) true) (= (get1 (positions x) temp___4641) 1)))))
