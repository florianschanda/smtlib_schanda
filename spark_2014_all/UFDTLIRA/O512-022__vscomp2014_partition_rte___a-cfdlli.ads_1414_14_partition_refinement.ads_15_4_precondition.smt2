...
(declare-const temp___990 count_type)
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___990 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___990)) no_element))
(assert (in_range2 item))
(assert (or (= (has_key (positions container) position) true) (= (bool_eq1 position no_element) true)))
(assert (and (= o5 (length container)) (and (in_range1 o5) (<= o5 (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))))))
