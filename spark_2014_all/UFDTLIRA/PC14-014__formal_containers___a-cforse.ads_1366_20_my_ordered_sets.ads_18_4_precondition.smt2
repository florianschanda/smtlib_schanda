...
(define-fun e_is_find ((container1 us_rep4) (item us_rep3) (position1 Int)) Bool (and (ite (< 0 position1) (e_bigger_than_range container1 1 (- position1 1) item) (of_int 1)) (ite (< position1 (length3 container1)) (e_smaller_than_range container1 (+ position1 1) (length3 container1) item) (of_int 1))))
