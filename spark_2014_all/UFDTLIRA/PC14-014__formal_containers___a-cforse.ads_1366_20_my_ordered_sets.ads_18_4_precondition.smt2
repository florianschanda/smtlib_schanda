...
(define-fun e_is_find ((container1 us_rep4) (item us_rep3) (position1 Int)) Bool (and (ite (< 0 position1) (e_bigger_than_range container1 1 (- position1 1) item) (distinct 1 0)) (ite (< position1 (length3 container1)) (e_smaller_than_range container1 (+ position1 1) (length3 container1) item) (distinct 1 0))))
...
(define-fun iter_has_element ((container1 us_rep4) (position1 Int)) Bool (and (ite (<= 1 position1) true false) (ite (<= position1 (last container1)) true false)))
...
(declare-const temp___1080 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1080 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1080)) no_element))
