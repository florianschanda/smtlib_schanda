...
(define-fun dynamic_invariant3 ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 50 59)) (in_range3 temp___expr_225)))
...
(declare-const temp___7216 us_rep3)
...
(declare-const temp___7221 us_rep3)
...
(assert (= temp___7216 (mk___rep3 o19)))
...
(assert (= r__split_fields6 (us_split_fields7 temp___7216)))
...
(assert (= temp___7221 (mk___rep3 o27)))
(assert (= result1 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7221)))
