...
(assert (<= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) fst) i4))
(assert (<= i4 (- (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 current__split_fields3)) 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i4) 0)))
(check-sat)
(exit)
