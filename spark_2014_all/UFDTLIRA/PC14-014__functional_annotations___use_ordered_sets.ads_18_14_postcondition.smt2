...
(assert (or (and (and (and (= use_ordered_sets__my_find__result13 (mk_cursor__ref use_ordered_sets__my_find__result3)) (= cu__split_fields10 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2)))) (and (= use_ordered_sets__my_find__result14 use_ordered_sets__my_find__result3) (= cu__split_fields11 (mk___split_fields1 cu__split_fields2)))) (and (and (= result1 (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (and (= result1 true) (and (= temp___679 cu__split_fields1) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (elements s) i1) e)))) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (and (= o8 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (elements s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (= result3 (ite (= o8 e) true false))) (and (= result3 true) (and (= result4 (mk_cursor__ref (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__result2)))) (= use_ordered_sets__my_find__result3 (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))))) (and (and (and (= result1 (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (ite (= result1 true) (and (and (and (= temp___679 cu__split_fields1) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (elements s) i1) e)))) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (and (and (= o8 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (elements s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (= result3 (ite (= o8 e) true false))) (and (not (= result3 true)) (= use_ordered_sets__my_find__result3 (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__result2))))) (and (and (and (= (mk___rep1 (mk___split_fields1 temp___678)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length2 s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___678)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 temp___678))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___678))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))) (and (= result5 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2))) (= cu__split_fields3 (mk___split_fields1 temp___678)))) (and (and (and (= o9 (has_key (positions s) (mk___rep1 cu__split_fields3))) (= (= o9 true) (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true))) (= result6 (ite (not (= o9 true)) true false))) (= result6 true))))))) (and (and (= use_ordered_sets__my_find__result6 (mk_cursor__ref use_ordered_sets__my_find__result3)) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields3))) (and (= use_ordered_sets__my_find__result7 use_ordered_sets__my_find__result3) (= cu__split_fields7 cu__split_fields3)))) (and (and (= use_ordered_sets__my_find__result8 use_ordered_sets__my_find__result6) (= cu__split_fields8 cu__split_fields6)) (and (= use_ordered_sets__my_find__result9 use_ordered_sets__my_find__result7) (= cu__split_fields9 cu__split_fields7)))) (and (and (= use_ordered_sets__my_find__result8 (mk_cursor__ref (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__result)))) (= cu__split_fields8 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields1)))) (and (= use_ordered_sets__my_find__result9 (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__result1))) (= cu__split_fields9 (mk___split_fields1 cu__split_fields1)))))) (and (and (and (= use_ordered_sets__my_find__result13 use_ordered_sets__my_find__result11) (= cu__split_fields10 cu__split_fields8)) (and (= use_ordered_sets__my_find__result14 use_ordered_sets__my_find__result12) (= cu__split_fields11 cu__split_fields9))) (and (and (= use_ordered_sets__my_find__result11 (mk_cursor__ref use_ordered_sets__my_find__result10)) (= use_ordered_sets__my_find__result12 use_ordered_sets__my_find__result10)) (and (= result7 use_ordered_sets__my_find__result8) (= use_ordered_sets__my_find__result10 no_element)))))))
(assert (= use_ordered_sets__my_find__result15 use_ordered_sets__my_find__result13))
(assert (= cu__split_fields12 cu__split_fields10))
(assert (= use_ordered_sets__my_find__result16 use_ordered_sets__my_find__result14))
(assert (= cu__split_fields13 cu__split_fields11))
(assert (= (mk___rep1 (mk___split_fields1 result8)) (cursor__content use_ordered_sets__my_find__result15)))
(assert (not (= (bool_eq1 (cursor__content use_ordered_sets__my_find__result15) (find1 s e)) true)))
(check-sat)
(exit)
