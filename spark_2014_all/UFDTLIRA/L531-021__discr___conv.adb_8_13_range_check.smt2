...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep (rec__basic__r__x (us_split_discrs1 a))) (to_rep (rec__basic__r__x (us_split_discrs1 b)))) (= (to_rep1 (rec__basic__r__base (us_split_fields1 a))) (to_rep1 (rec__basic__r__base (us_split_fields1 b))))) (=> (basic__r__a_field__pred a) (= (to_rep1 (rec__basic__r__a_field (us_split_fields1 a))) (to_rep1 (rec__basic__r__a_field (us_split_fields1 b)))))) (=> (basic__r__c_field1__pred a) (= (rec__basic__r__c_field1 (us_split_fields1 a)) (rec__basic__r__c_field1 (us_split_fields1 b))))) (=> (basic__r__c_field2__pred a) (= (to_rep2 (rec__basic__r__c_field2 (us_split_fields1 a))) (to_rep2 (rec__basic__r__c_field2 (us_split_fields1 b)))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 2)) (in_range temp___expr_135)))
(assert (not (in_range (to_rep (rec__basic__r__x (us_split_discrs1 x))))))
(check-sat)
(exit)
