...
(assert (forall ((segway__speed Int)) (! (=> (dynamic_invariant2 segway__speed true true true true) (dynamic_invariant2 (current_speed segway__speed) true false true true)) :pattern ((current_speed segway__speed)))))
(assert (forall ((segway__speed Int)) (! (=> (dynamic_invariant2 segway__speed true true true true) (= (current_speed segway__speed) segway__speed)) :pattern ((current_speed segway__speed)))))
