...
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 1 3)) (in_range1 temp___expr_147)))
...
(define-fun dynamic_invariant2 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= (- 100) 100)) (in_range2 temp___expr_153)))
...
(assert (forall ((segway__speed Int)) (! (=> (dynamic_invariant2 segway__speed true true true) (dynamic_invariant2 (current_speed segway__speed) true false true)) :pattern ((current_speed segway__speed)))))
(assert (forall ((segway__speed Int)) (! (=> (dynamic_invariant2 segway__speed true true true) (= (current_speed segway__speed) segway__speed)) :pattern ((current_speed segway__speed)))))
