...
(assert (<= b i13))
(assert (<= i13 (- 1)))
(assert (and (= o6 r1) (not (= r1 (- 2147483648)))))
(assert (= o7 (- o6 1)))
(assert (= r1 result6))
(assert (= r11 o7))
(assert (= r12 (+ a i14)))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r12)) (=> (<= b (- 1)) (dynamic_property1 b (- 1) i14))) (and (<= b i14) (<= i14 (- 1)))))
(assert (not (in_range1 (+ a i14))))
(check-sat)
(exit)
