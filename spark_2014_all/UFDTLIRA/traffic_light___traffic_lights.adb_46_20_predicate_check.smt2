...
(assert (=> (not (= ls__split_fields5 true)) (=> (not (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false)) (=> (ite (= ls__split_fields7 true) (not (= ls__split_fields6 true)) false) (= result27 (mk___split_fields__ref (mk___split_fields ls__split_fields5 ls__split_fields6 ls__split_fields7 ls__split_fields8 ls__split_fields9)))))))
...
(assert (=> (not (= ls__split_fields5 true)) (=> (not (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false)) (=> (not (ite (= ls__split_fields7 true) (not (= ls__split_fields6 true)) false)) (=> (= (ite (= ls__split_fields7 true) ls__split_fields6 false) true) (= result30 (mk___split_fields__ref (mk___split_fields ls__split_fields5 ls__split_fields6 ls__split_fields7 ls__split_fields8 ls__split_fields9))))))))
...
(assert (=> (not (= ls__split_fields5 true)) (=> (not (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false)) (=> (not (ite (= ls__split_fields7 true) (not (= ls__split_fields6 true)) false)) (=> (not (= (ite (= ls__split_fields7 true) ls__split_fields6 false) true)) (= ls__split_fields33 (mk___split_fields ls__split_fields5 ls__split_fields6 ls__split_fields7 ls__split_fields8 ls__split_fields9)))))))
...
(assert (=> (not (= ls__split_fields5 true)) (= (mk___split_fields ls__split_fields15 ls__split_fields16 ls__split_fields17 ls__split_fields18 ls__split_fields19) ls__split_fields27)))
(assert (not (= (valid_combination (mk___rep (mk___split_fields ls__split_fields15 ls__split_fields16 ls__split_fields17 ls__split_fields18 ls__split_fields19))) true)))
(check-sat)
(exit)
