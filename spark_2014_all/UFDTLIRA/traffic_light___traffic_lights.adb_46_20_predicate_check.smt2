...
(define-fun default_initial_assumption ((temp___expr_1473 us_rep1) (temp___skip_top_level_1474 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1473)) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1473)) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1473)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1473)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1473)) (of_int 0))))
...
(define-fun us_rep___28__projection ((a us_rep2)) us_split_fields2 (us_split_fields3 a))
...
(define-fun dynamic_invariant ((temp___expr_1487 us_rep2) (temp___is_init_1484 Bool) (temp___skip_constant_1485 Bool) (temp___do_toplevel_1486 Bool)) Bool (= (valid_combination (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1487))) true))
(define-fun default_initial_assumption1 ((temp___expr_1489 us_rep2) (temp___skip_top_level_1490 Bool)) Bool (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields3 temp___expr_1489)) time_first) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields3 temp___expr_1489)) (of_int 0))) (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 0)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant1 ((temp___expr_1478 us_rep1) (temp___is_init_1475 Bool) (temp___skip_constant_1476 Bool) (temp___do_toplevel_1477 Bool)) Bool (=> (= temp___do_toplevel_1477 true) (=> (= temp___is_init_1475 true) (= (valid_combination temp___expr_1478) true))))
(define-fun default_initial_assumption2 ((temp___expr_1480 us_rep1) (temp___skip_top_level_1481 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1480)) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1480)) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1480)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1480)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1480)) (of_int 0))))
(define-fun dynamic_predicate ((temp___1482 us_rep1)) Bool (= (valid_combination temp___1482) true))
...
(assert (=> (not (= ls__split_fields5 true)) (=> (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false) (= (of_int 0) ls__split_fields21))))
...
(assert (=> (not (= ls__split_fields5 true)) (=> (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false) (= ls__split_fields25 (mk___split_fields ls__split_fields20 ls__split_fields21 (of_int 1) ls__split_fields23 ls__split_fields24)))))
...
(assert (=> (not (= ls__split_fields5 true)) (=> (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false) (= ls__split_fields26 (mk___split_fields (rec__traffic_lights__lights_state__vehicles_green ls__split_fields25) (rec__traffic_lights__lights_state__vehicles_yellow ls__split_fields25) (rec__traffic_lights__lights_state__vehicles_red ls__split_fields25) (of_int 1) (rec__traffic_lights__lights_state__pedestrians_red ls__split_fields25))))))
...
(assert (=> (not (= ls__split_fields5 true)) (=> (not (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false)) (=> (ite (= ls__split_fields7 true) (not (= ls__split_fields6 true)) false) (= ls__split_fields28 (mk___split_fields ls__split_fields5 (of_int 1) ls__split_fields7 ls__split_fields8 ls__split_fields9))))))
...
(assert (=> (not (= ls__split_fields5 true)) (=> (not (ite (= ls__split_fields6 true) (not (= ls__split_fields7 true)) false)) (=> (not (ite (= ls__split_fields7 true) (not (= ls__split_fields6 true)) false)) (=> (= (ite (= ls__split_fields7 true) ls__split_fields6 false) true) (= ls__split_fields31 (mk___split_fields (of_int 1) ls__split_fields6 ls__split_fields7 ls__split_fields8 ls__split_fields9)))))))
