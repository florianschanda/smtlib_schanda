...
(declare-const temp___4831 unsigned_byte)
(declare-const temp___4832 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___483 o5))
(assert (= temp___4831 o6))
(assert (= temp___4832 o7))
...
(assert (= r__split_fields3 (mk___split_fields1 temp___483 (mk___rep (mk___split_fields temp___4831 temp___4832)))))
