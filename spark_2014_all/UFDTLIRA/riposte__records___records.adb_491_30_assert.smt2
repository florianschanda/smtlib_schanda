...
(assert (= temp___483 r__split_fields3))
(assert (= temp___4831 r__split_fields4))
(assert (= temp___4832 r__split_fields5))
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 r__split_fields3 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)))) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r_old)) (mk___rep (mk___split_fields (of_rep x) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 r_old))))))))) true)))
(check-sat)
(exit)
