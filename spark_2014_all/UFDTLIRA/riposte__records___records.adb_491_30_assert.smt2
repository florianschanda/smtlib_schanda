...
(declare-const temp___450 Bool)
(declare-const temp___4501 unsigned_byte)
(declare-const temp___4502 unsigned_byte)
...
(declare-const temp___4571 unsigned_byte)
(declare-const temp___4572 unsigned_byte)
(declare-const result us_split_fields__ref1)
(declare-const r__split_fields3 us_split_fields2)
(declare-const result1 us_split_fields__ref1)
(declare-const r__split_fields4 us_split_fields2)
(declare-const r__split_fields5 us_split_fields__ref1)
(declare-const r__split_fields6 us_split_fields2)
(assert (in_range x))
(assert (= (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)))) r_old))
(assert (= (to_rep o) x))
(assert (= o o1))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___450 o5))
(assert (= temp___4501 o6))
(assert (= temp___4502 o7))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2))))))
(assert (= r__split_fields3 (mk___split_fields1 temp___450 (mk___rep (mk___split_fields temp___4501 temp___4502)))))
(assert (not (= (bool_eq1 (mk___rep1 r__split_fields3) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r_old)) (mk___rep (mk___split_fields (of_rep x) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 r_old))))))))) true)))
(check-sat)
(exit)
