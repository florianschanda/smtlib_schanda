...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__queue__mylists__cursor__node (us_split_fields3 a))) (to_rep (rec__queue__mylists__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__queue__mylists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_235 us_rep2) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__queue__mylists__cursor__node (us_split_fields3 temp___expr_235))) 0))
