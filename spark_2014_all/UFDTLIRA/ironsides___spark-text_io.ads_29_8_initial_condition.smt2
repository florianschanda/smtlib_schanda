...
(define-fun dynamic_invariant ((temp___expr_718 Int) (temp___is_init_714 Bool) (temp___skip_constant_715 Bool) (temp___do_toplevel_716 Bool) (temp___do_typ_inv_717 Bool)) Bool (=> (or (= temp___is_init_714 true) (<= 0 10)) (in_range1 temp___expr_718)))
...
(define-fun dynamic_invariant1 ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 0 2)) (in_range2 temp___expr_732)))
...
(assert (and (= o2 (is_writable standard_error)) (= (= o2 true) (and (= (is_open standard_error) true) (or (= (mode__2 standard_error) 1) (= (mode__2 standard_error) 2))))))
(assert (and (= o (is_writable standard_output)) (= (= o true) (and (= (is_open standard_output) true) (or (= (mode__2 standard_output) 1) (= (mode__2 standard_output) 2))))))
(assert (and (= o1 (is_readable standard_input)) (= (= o1 true) (and (= (is_open standard_input) true) (= (mode__2 standard_input) 0)))))
