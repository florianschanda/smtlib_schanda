...
(assert (=> (= result true) (= o27 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o28 (ite (not (= o27 true)) true false))))
(assert (=> (= result true) (= o26 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result1 true) (and (= o22 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o22))))
(assert (=> (= result1 true) (= o23 (ite (= o22 0) true false))))
(assert (=> (= result1 true) (= o21 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result2 true) (= o19 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result2 true) (= o20 (ite (not (= o19 true)) true false))))
(assert (=> (not (= result2 true)) (= o20 (of_int 1))))
(assert (= o14 (statusiswaitingfinishadminop (us_private__content state))))
(assert (= o15 (statusiswaitingstartadminop (us_private__content state))))
(assert (= result3 (ite (= o15 false) o14 true)))
(assert (=> (= result3 true) (= o16 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result3 true) (= o17 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result3 true) (= o18 (ite (= o17 true) o16 false))))
(assert (=> (not (= result3 true)) (= o18 (of_int 1))))
(assert (= o10 (statusiswaitingremoveadmintokenfail (us_private__content state))))
(assert (= o11 (statusisgotadmintoken (us_private__content state))))
(assert (= result4 (ite (= o11 false) o10 true)))
(assert (=> (= result4 true) (= o12 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result4 true) (= o13 (ite (not (= o12 true)) true false))))
(assert (=> (not (= result4 true)) (= o13 (of_int 1))))
(assert (and (= o6 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o6)))
(assert (= o7 (ite (= o6 4) true false)))
(assert (= o8 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result5 (ite (= o8 true) o7 false)))
(assert (=> (= result5 true) (= o9 (statusiswaitingstartadminop (us_private__content state)))))
(assert (=> (not (= result5 true)) (= o9 (of_int 1))))
(assert (= o3 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result6 (ite (not (= o3 true)) true false)))
(assert (=> (= result6 true) (= o4 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
