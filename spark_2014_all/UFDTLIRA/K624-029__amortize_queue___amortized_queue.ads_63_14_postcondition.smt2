...
(define-fun dynamic_invariant1 ((temp___expr_403 us_rep2) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (and (in_range2 1000 (rec__amortized_queue__queue__front (us_split_fields3 temp___expr_403))) (in_range2 1000 (rec__amortized_queue__queue__rear (us_split_fields3 temp___expr_403)))))
...
(define-fun dynamic_invariant2 ((temp___expr_393 us_rep) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (not (= temp___skip_constant_390 true)) (in_range2 1000 temp___expr_393)))
...
(define-fun dynamic_invariant4 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 1001)) (in_range4 temp___expr_242)))
