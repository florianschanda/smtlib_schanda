...
(define-fun amortized_queue__model__result8 () us_rep (mk___rep (mk___split_discrs amortized_queue__model__result2) (mk___split_fields amortized_queue__model__result3)))
(define-fun revrear__split_fields5 () us_split_fields (mk___split_fields revrear__split_fields2))
(define-fun o2 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
(define-fun amortized_queue__model__revrear__assume2 () us_rep (mk___rep (mk___split_discrs amortized_queue__model__revrear__assume) (mk___split_fields amortized_queue__model__revrear__assume1)))
...
(assert (= (inv q) true))
(assert (and (= amortized_queue__model__revrear__assume2 (copy (rec__amortized_queue__queue__rear (us_split_fields3 q)) 0)) (and (= (oeq (model__ amortized_queue__model__revrear__assume2) (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q)))) true) (= (to_rep amortized_queue__model__revrear__assume) (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
...
(assert (= (m_elements_reversed (model__ (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields1))) (model__ (mk___rep revrear__split_discrs revrear__split_fields5))) true))
(assert (= amortized_queue__model__result4 (mk_vector__ref amortized_queue__model__result8)))
(assert (= amortized_queue__model__result5 amortized_queue__model__result8))
(assert (and (= o2 (oconcat (mk___rep revrear__split_discrs revrear__split_fields5) (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (= (length o2) (+ (length (mk___rep revrear__split_discrs revrear__split_fields5)) (length (rec__amortized_queue__queue__front (us_split_fields3 q))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ (mk___rep revrear__split_discrs revrear__split_fields5))))) (= (get (model__ o2) i) (get (model__ (mk___rep revrear__split_discrs revrear__split_fields5)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))))) (= (get (model__ o2) (+ (last (model__ (mk___rep revrear__split_discrs revrear__split_fields5))) i)) (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) i))))))))
...
(assert (= revrear__split_fields3 (mk___split_fields__ref revrear__split_fields5)))
