...
(assert (forall ((source us_rep)) (forall ((capacity Int)) (! (=> (and (dynamic_invariant capacity true true true) (=> (= (of_int 1) true) (or (= capacity 0) (<= (length source) capacity)))) (let ((result (copy source capacity))) (and (= (oeq (model__ result) (model__ source)) true) (ite (= capacity 0) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 result))) (length source)) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 result))) capacity))))) :pattern ((copy source capacity))))))
...
(assert (forall ((left us_rep) (right us_rep)) (! (=> (<= (+ (length left) (length right)) 1000) (let ((result (oconcat left right))) (and (= (length result) (+ (length left) (length right))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (last_index left))) (= (element result i) (element left i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last_index right))) (= (element result (+ (last_index left) i)) (element right i)))))))) :pattern ((oconcat left right)))))
(define-fun in_range2 ((rec__amortized_queue__my_vectors__vector__capacity1 Int) (a us_rep)) Bool (= rec__amortized_queue__my_vectors__vector__capacity1 (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant1 ((temp___expr_360 us_rep2) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (and (in_range2 1000 (rec__amortized_queue__queue__front (us_split_fields3 temp___expr_360))) (in_range2 1000 (rec__amortized_queue__queue__rear (us_split_fields3 temp___expr_360)))))
...
(assert true)
(assert (forall ((q us_rep2)) (forall ((m us_rep)) (! (= (= (is_model q m) true) (and (and (and (= (+ (length (rec__amortized_queue__queue__front (us_split_fields3 q))) (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (length m)) (<= (length m) 1000)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))) (= (element m i) (element (rec__amortized_queue__queue__rear (us_split_fields3 q)) (+ (- (length (rec__amortized_queue__queue__rear (us_split_fields3 q))) i) 1)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (rec__amortized_queue__queue__front (us_split_fields3 q))))) (= (element m (+ i (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))) (element (rec__amortized_queue__queue__front (us_split_fields3 q)) i)))))) :pattern ((is_model q m))))))
(declare-const q us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const revrear__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_351 us_rep) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool (=> (not (= temp___skip_constant_349 true)) (in_range2 1000 temp___expr_351)))
...
(define-fun dynamic_invariant4 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 1001)) (in_range4 temp___expr_207)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 1000) (dynamic_invariant3 result true false true))) :pattern ((length1 container)))))
...
(declare-const amortized_queue__model__result capacity_range)
(declare-const amortized_queue__model__result1 us_main_type)
...
(declare-const result1 capacity_range)
(declare-const result2 us_main_type)
(declare-const amortized_queue__model__result2 capacity_range)
(declare-const amortized_queue__model__result3 us_main_type)
(declare-const amortized_queue__model__result4 vector__ref)
(declare-const amortized_queue__model__result5 us_rep)
(declare-const revrear__split_fields3 us_split_fields__ref)
(declare-const amortized_queue__model__result6 vector__ref)
(declare-const revrear__split_fields4 us_split_fields)
(declare-const amortized_queue__model__result7 us_rep)
(declare-const result3 capacity_range)
...
(assert (= (inv q) true))
(assert (and (= (mk___rep (mk___split_discrs amortized_queue__model__revrear__assume) (mk___split_fields amortized_queue__model__revrear__assume1)) (copy (rec__amortized_queue__queue__rear (us_split_fields3 q)) 0)) (and (= (oeq (model__ (mk___rep (mk___split_discrs amortized_queue__model__revrear__assume) (mk___split_fields amortized_queue__model__revrear__assume1))) (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q)))) true) (= (to_rep amortized_queue__model__revrear__assume) (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields revrear__split_fields))))
(assert (= amortized_queue__model__revrear__assume1 revrear__split_fields1))
(assert (= revrear__split_discrs (mk___split_discrs amortized_queue__model__revrear__assume)))
(assert (= (m_elements_reversed (model__ (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields1))) (model__ (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields2)))) true))
(assert (= amortized_queue__model__result4 (mk_vector__ref (mk___rep (mk___split_discrs amortized_queue__model__result2) (mk___split_fields amortized_queue__model__result3)))))
(assert (= amortized_queue__model__result5 (mk___rep (mk___split_discrs amortized_queue__model__result2) (mk___split_fields amortized_queue__model__result3))))
(assert (and (= (mk___rep (mk___split_discrs o) (mk___split_fields o1)) (oconcat (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields2)) (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (= (length (mk___rep (mk___split_discrs o) (mk___split_fields o1))) (+ (length (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields2))) (length (rec__amortized_queue__queue__front (us_split_fields3 q))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields2)))))) (= (get (model__ (mk___rep (mk___split_discrs o) (mk___split_fields o1))) i) (get (model__ (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields2))) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))))) (= (get (model__ (mk___rep (mk___split_discrs o) (mk___split_fields o1))) (+ (last (model__ (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields2)))) i)) (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) i))))))))
(assert (= result1 amortized_queue__model__result))
(assert (= result2 amortized_queue__model__result1))
(assert (= (mk___rep (mk___split_discrs amortized_queue__model__result2) (mk___split_fields amortized_queue__model__result3)) (mk___rep (mk___split_discrs o) (mk___split_fields o1))))
(assert (= amortized_queue__model__result6 amortized_queue__model__result4))
(assert (= revrear__split_fields3 (mk___split_fields__ref (mk___split_fields revrear__split_fields2))))
(assert (= amortized_queue__model__result7 amortized_queue__model__result5))
(assert (= revrear__split_fields4 (mk___split_fields revrear__split_fields2)))
(assert (= (mk___rep (mk___split_discrs result3) (mk___split_fields result4)) (vector__content amortized_queue__model__result6)))
(assert (not (= (is_model q (vector__content amortized_queue__model__result6)) true)))
(check-sat)
(exit)
