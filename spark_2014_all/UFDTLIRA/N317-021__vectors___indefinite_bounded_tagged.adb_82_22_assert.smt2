...
(assert (not (= (let ((temp___623 (f 4))) (let ((temp___622 (get (model__ (mk___rep1 v__split_discrs v__split_fields9)) 1))) (ite (= (attr__tag temp___622) (attr__tag temp___623)) (us_dispatch_eq temp___622 temp___623) false))) true)))
(check-sat)
(exit)
