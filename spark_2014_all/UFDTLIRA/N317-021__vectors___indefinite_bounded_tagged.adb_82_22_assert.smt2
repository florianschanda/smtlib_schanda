...
(assert (not (= (let ((temp___666 (f 4))) (let ((temp___665 (get (model__ (mk___rep v__split_discrs v__split_fields9)) 1))) (ite (= (attr__tag temp___665) (attr__tag temp___666)) (us_dispatch_eq temp___665 temp___666) false))) true)))
(check-sat)
(exit)
