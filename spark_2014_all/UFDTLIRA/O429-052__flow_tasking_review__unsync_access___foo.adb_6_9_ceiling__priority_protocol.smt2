...
(define-fun default_initial_assumption ((temp___expr_184 us_rep) (temp___skip_top_level_185 Bool)) Bool (= (rec__foo__g (us_split_fields1 temp___expr_184)) (of_int 0)))
