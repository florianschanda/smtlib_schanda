...
(declare-const temp___553 count_type)
(declare-const temp___554 count_type)
...
(define-fun temp___5541 () us_rep1 (mk___rep1 (mk___split_fields1 temp___554)))
(define-fun temp___5531 () us_rep1 (mk___rep1 (mk___split_fields1 temp___553)))
...
(assert (and (= temp___5531 (last1 (mk___rep l__split_discrs l__split_fields3))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true) (= (bool_eq1 temp___5531 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) temp___5531) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___5531) (length (mk___rep l__split_discrs l__split_fields3)))))))
(assert (= result3 (mk___split_fields__ref1 c__split_fields3)))
(assert (= c__split_fields4 (mk___split_fields1 temp___553)))
...
(assert (and (= temp___5541 (last1 (mk___rep l__split_discrs l__split_fields3))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true) (= (bool_eq1 temp___5541 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) temp___5541) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___5541) (length (mk___rep l__split_discrs l__split_fields3)))))))
(assert (= result4 (mk___split_fields__ref1 c__split_fields5)))
(assert (= c__split_fields6 (mk___split_fields1 temp___554)))
...
(assert (and (= o (copy (mk___rep l__split_discrs l__split_fields5) 0)) (and (and (= (oeq (model__ o) (model__ (mk___rep l__split_discrs l__split_fields5))) true) (= (oeq1 (positions o) (positions (mk___rep l__split_discrs l__split_fields5))) true)) (= (to_rep (rec__my_lists__m__list__capacity (us_split_discrs1 o))) (to_rep (rec__my_lists__m__list__capacity l__split_discrs))))))
(assert (= o1 o))
(assert (= temp___558 o1))
