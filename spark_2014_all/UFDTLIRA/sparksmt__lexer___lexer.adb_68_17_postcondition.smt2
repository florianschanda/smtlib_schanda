...
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (= (to_rep current_read__split_fields) 10) (= (mk_int__ref result1) (mk_int__ref current_col)))))
...
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (= (mk_int__ref result2) (mk_int__ref current_col))))))
