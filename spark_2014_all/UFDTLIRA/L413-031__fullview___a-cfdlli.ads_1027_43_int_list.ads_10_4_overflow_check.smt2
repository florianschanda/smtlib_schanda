...
(define-fun default_initial_assumption2 ((temp___expr_240 us_rep1) (temp___skip_top_level_241 Bool)) Bool (= (to_rep (rec__int_list__my_lists__cursor__node (us_split_fields3 temp___expr_240))) 0))
...
(declare-const temp___426 count_type)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___426 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___426)) no_element))
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__int_list__my_lists__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__int_list__my_lists__list__capacity target__split_discrs)) o2)))
