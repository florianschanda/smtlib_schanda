...
(define-fun dynamic_invariant1 ((temp___expr_705 Int) (temp___is_init_701 Bool) (temp___skip_constant_702 Bool) (temp___do_toplevel_703 Bool) (temp___do_typ_inv_704 Bool)) Bool (=> (or (= temp___is_init_701 true) (<= 0 2147483647)) (in_range4 temp___expr_705)))
...
(define-fun dynamic_invariant2 ((temp___expr_689 Int) (temp___is_init_685 Bool) (temp___skip_constant_686 Bool) (temp___do_toplevel_687 Bool) (temp___do_typ_inv_688 Bool)) Bool (=> (or (= temp___is_init_685 true) (<= 1 2147483647)) (in_range6 temp___expr_689)))
...
(assert (and (= o4 (last left)) (and (in_range4 o4) (= o4 (+ 0 (length left))))))
(assert (= result (ite (<= lst o4) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o3 (- (- 2147483648) offset)) (in_range5 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o3 1) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o2 lst) (in_range5 lst)))
