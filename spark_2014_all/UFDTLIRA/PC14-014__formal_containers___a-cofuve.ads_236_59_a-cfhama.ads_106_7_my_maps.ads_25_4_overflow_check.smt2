...
(define-fun dynamic_invariant ((temp___expr_635 Int) (temp___is_init_632 Bool) (temp___skip_constant_633 Bool) (temp___do_toplevel_634 Bool)) Bool (=> (or (= temp___is_init_632 true) (<= 1 2147483647)) (in_range2 temp___expr_635)))
...
(define-fun dynamic_invariant1 ((temp___expr_649 Int) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool)) Bool (=> (or (= temp___is_init_646 true) (<= 0 2147483647)) (in_range3 temp___expr_649)))
...
(define-fun default_initial_assumption ((temp___expr_656 us_rep) (temp___skip_top_level_657 Bool)) Bool (=> (not (= temp___skip_top_level_657 true)) (= (length temp___expr_656) 0)))
...
(assert (and (= o1 (length right)) (and (in_range6 o1) (<= (+ 0 o1) 2147483647))))
(assert (= o2 (+ 0 o1)))
