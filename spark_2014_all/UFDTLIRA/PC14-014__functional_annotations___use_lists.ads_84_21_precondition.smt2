...
(assert (and (and (and (= (mk___split_fields__ref1 (mk___split_fields1 result2)) (mk___split_fields__ref1 (mk___split_fields1 current__split_fields))) (= (mk___split_fields1 current__split_fields1) (us_split_fields3 fst))) (and (and (= (mk___split_fields__ref1 (mk___split_fields1 result3)) (mk___split_fields__ref1 (mk___split_fields1 n_last__split_fields))) (= (mk___split_fields1 n_last__split_fields1) (us_split_fields3 lst))) (and (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 n_last__split_fields1)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 n_last__split_fields1))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 n_last__split_fields2)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 n_last__split_fields2))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 n_last__split_fields2))) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 n_last__split_fields1))) 1)))) (ite (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 current__split_fields1)) (mk___rep1 (mk___split_fields1 n_last__split_fields2))) true)) (and (and (and (and (= l__split_discrs (mk___split_discrs temp___540)) (= l__split_fields temp___5401)) (and (= temp___543 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (= temp___539 current__split_fields1) (and (= temp___542 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (= temp___544 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (= temp___541 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (and (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) temp___541) (and (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) temp___542) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 current__split_fields2))) true) (and (and (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) fst) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 current__split_fields2)))) (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 current__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) lst))) (and (forall ((i4 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) fst) i4) (<= i4 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 current__split_fields2))) 1))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) i4) 0))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) fst) 1))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) i4) (get temp___543 i4)))) (forall ((i4 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 current__split_fields2))) i4) (<= i4 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) i4) (get temp___544 i4)))))))))) (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2)))) 0)) (= (equal_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2)))) true)) (and (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 current__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2))) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 current__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 current__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 current__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2))) 1)))) (= (bool_eq1 (mk___rep1 current__split_fields3) (mk___rep1 (mk___split_fields1 n_last__split_fields2))) true)))))))))) (and (and (= current__split_fields4 (mk___split_fields__ref1 current__split_fields3)) (= l__split_fields4 (mk___split_fields__ref l__split_fields3))) (and (= current__split_fields5 current__split_fields3) (= l__split_fields5 l__split_fields3)))) (and (and (= current__split_fields6 current__split_fields4) (= l__split_fields6 l__split_fields4)) (and (= current__split_fields7 current__split_fields5) (= l__split_fields7 l__split_fields5)))) (and (and (= current__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 current__split_fields1))) (= l__split_fields6 (mk___split_fields__ref (mk___split_fields l__split_fields)))) (and (= current__split_fields7 (mk___split_fields1 current__split_fields1)) (= l__split_fields7 (mk___split_fields l__split_fields1)))))))) (and (and (= n_last__split_fields3 (mk___split_fields__ref1 (mk___split_fields1 n_last__split_fields2))) (and (= current__split_fields8 current__split_fields6) (= l__split_fields8 l__split_fields6))) (and (= n_last__split_fields4 (mk___split_fields1 n_last__split_fields2)) (and (= current__split_fields9 current__split_fields7) (= l__split_fields9 l__split_fields7))))))
(assert (and (= o42 (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (in_range1 o42) (<= o42 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o43 (ite (<= i3 o42) true false)))
(assert (= result7 (ite (<= 1 i3) o43 false)))
(assert (= result7 true))
(assert (and (= o46 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (not (= (has_key o46 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o46 i4) true) (and (and (<= 1 (get1 o46 i4)) (<= (get1 o46 i4) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))) (forall ((j us_rep1)) (=> (= (has_key o46 j) true) (=> (= (get1 o46 i4) (get1 o46 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (and (= o47 (get1 o46 lst)) (and (in_range4 o47) (=> (= (of_int 0) true) (and (= o47 (w_get o46 (witness o46 lst))) (forall ((k us_rep1)) (=> (= (has_key o46 k) true) (= (= (bool_eq1 k lst) true) (= (witness o46 lst) (witness o46 k))))))))))
(assert (= o48 (ite (<= i3 o47) true false)))
(assert (and (= o44 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (not (= (has_key o44 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o44 i4) true) (and (and (<= 1 (get1 o44 i4)) (<= (get1 o44 i4) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))) (forall ((j us_rep1)) (=> (= (has_key o44 j) true) (=> (= (get1 o44 i4) (get1 o44 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (and (= o45 (get1 o44 fst)) (and (in_range4 o45) (=> (= (of_int 0) true) (and (= o45 (w_get o44 (witness o44 fst))) (forall ((k us_rep1)) (=> (= (has_key o44 k) true) (= (= (bool_eq1 k fst) true) (= (witness o44 fst) (witness o44 k))))))))))
(assert (= o49 (ite (<= o45 i3) true false)))
(assert (= result8 (ite (= o49 true) o48 false)))
(assert (= result8 true))
(assert (and (= o50 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o50) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= 1 i3)))
(check-sat)
(exit)
