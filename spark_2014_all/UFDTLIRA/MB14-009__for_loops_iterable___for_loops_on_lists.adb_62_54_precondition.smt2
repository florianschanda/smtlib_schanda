...
(assert (< 0 count_12))
(assert (and (= o6 (has_key (positions l) (mk___rep1 (mk___split_fields1 cu1)))) (= (= o6 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 cu1))) true))))
(assert (= o7 true))
(assert (= result7 (ite (= o7 true) o6 false)))
(assert (= result7 true))
(assert (not (= (has_key (positions l) (mk___rep1 (mk___split_fields1 cu1))) true)))
(check-sat)
(exit)
