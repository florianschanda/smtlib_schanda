...
(assert (= result6 true))
(assert (and (= o23 i1) (in_range3 i1)))
(assert (and (= o22 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o22) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o24 (get o22 o23)) (in_range4 o24)))
(assert (and (= o21 i1) (in_range3 i1)))
(assert (and (= o20 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o20) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= 1 o21)))
(check-sat)
(exit)
