...
(assert (and (= o14 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o14 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o14) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o14) 1)))))
...
(assert (and (= o11 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o11) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o13 (get o11 o12)) (in_range4 o13)))
(assert (and (= o10 i) (in_range3 i)))
(assert (and (= o9 (model__ (mk___rep l__split_discrs l__split_fields1))) (= (length1 o9) (length (mk___rep l__split_discrs l__split_fields1)))))
(assert (not (<= 1 o10)))
(check-sat)
(exit)
