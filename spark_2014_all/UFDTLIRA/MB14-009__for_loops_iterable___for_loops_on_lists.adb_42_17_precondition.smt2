...
(assert (and (= o12 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o12 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o12) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o12) 1)))))
...
(assert (and (= o9 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o9) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o11 (get o9 o10)) (in_range2 o11)))
(assert (and (= o8 i) (in_range3 i)))
(assert (and (= o7 (model__ (mk___rep l__split_discrs l__split_fields1))) (= (length1 o7) (length (mk___rep l__split_discrs l__split_fields1)))))
(assert (not (<= o8 (last o7))))
(check-sat)
(exit)
