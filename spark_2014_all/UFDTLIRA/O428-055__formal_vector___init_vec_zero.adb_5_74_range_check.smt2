...
(assert (and (= o7 (last (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields9))))) (and (in_range2 o7) (= o7 (last (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields9))))))))
(assert (= o8 (ite (<= j1 o7) true false)))
(assert (and (= o6 1) (and (in_range1 o6) (= o6 1))))
(assert (= o9 (ite (<= o6 j1) true false)))
(assert (= result5 (ite (= o9 true) o8 false)))
(assert (= result5 true))
