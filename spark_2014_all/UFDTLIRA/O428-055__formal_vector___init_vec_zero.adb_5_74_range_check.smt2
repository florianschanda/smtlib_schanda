...
(assert (= j2 r4b))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= temp___585 j2)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= temp___586 (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (and (= v__split_discrs (mk___split_discrs temp___584)) (= v__split_fields temp___5841))))
...
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= (last (model__ (mk___rep v__split_discrs v__split_fields10))) temp___586)))
