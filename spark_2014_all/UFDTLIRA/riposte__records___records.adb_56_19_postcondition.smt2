...
(assert (= (mk___rep (mk___split_fields records__add_pair_a__result6 records__add_pair_a__result7)) (mk___rep (mk___split_fields records__add_pair_a__result2 records__add_pair_a__result3))))
...
(assert (= (mk___rep (mk___split_fields records__add_pair_a__result2 records__add_pair_a__result3)) (mk___rep (mk___split_fields o6 o7))))
