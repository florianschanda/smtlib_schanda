...
(assert (and (= result1 (has_key1 (positions s1) (mk___rep cu__split_fields6))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep cu__split_fields6)) true))))
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep cu__split_fields5)) 1))) (not (= (has_key (model__ s2) (get (keys s1) i)) true)))))
(assert (= (has_key1 (positions s1) (mk___rep cu__split_fields5)) true))
(assert (and (= o (key s1 (mk___rep cu__split_fields5))) (and (in_range6 o) (= o (get (keys s1) (get1 (positions s1) (mk___rep cu__split_fields5)))))))
...
(assert (and (= temp___8041 (next s1 (mk___rep cu__split_fields5))) (ite (= (ite (= (bool_eq2 (mk___rep cu__split_fields5) no_element) false) (= (get1 (positions s1) (mk___rep cu__split_fields5)) (length3 s1)) true) true) (= (bool_eq2 temp___8041 no_element) true) (and (= (has_key1 (positions s1) temp___8041) true) (= (get1 (positions s1) temp___8041) (+ (get1 (positions s1) (mk___rep cu__split_fields5)) 1))))))
(assert (= result3 cu__split_fields2))
(assert (= temp___804 cu__split_fields3))
(assert (and (= o1 (has_key1 (positions s1) (mk___rep cu__split_fields4))) (= (= o1 true) (= (has_key1 (positions s1) (mk___rep cu__split_fields4)) true))))
