...
(define-fun dynamic_invariant1 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range1 temp___expr_256)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (capacity container1)) (dynamic_invariant1 result true false true true))) :pattern ((length container1)))))
