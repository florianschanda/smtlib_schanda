...
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o16 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o16 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o16) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o15 o16))
(assert (= o7 o15))
...
(assert (= result2 true))
(assert (and (= o12 (copy (rec__amortized_queue__queue__rear result____split_fields5) 1000)) (and (= (oeq1 (model__ o12) (model__ (rec__amortized_queue__queue__rear result____split_fields5))) true) (ite (= 1000 0) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o12))) (length (rec__amortized_queue__queue__rear result____split_fields5))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o12))) 1000)))))
(assert (= o13 o12))
(assert (= o14 o13))
