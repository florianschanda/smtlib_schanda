...
(declare-const temp___583 integer)
(declare-const temp___5831 us_private)
...
(assert (and (= (mk___rep (mk___split_fields temp___583 temp___5831) temp___5832) (f 2)) (and (and (= (of_rep 2) temp___583) (= us_null_ext__ temp___5831)) (= us_tag temp___5832))))
(assert (not (<= 1 2)))
(check-sat)
(exit)
