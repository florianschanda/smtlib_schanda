...
(define-fun o16 () us_rep (mk___rep (mk___split_fields o6 o7)))
(assert (in_range2 x))
(assert (and (= o12 (length p)) (and (in_range4 o12) (<= o12 (capacity p)))))
...
(assert (and (= o16 (get (model__ p) o5)) (= (bool_eq o16 (get (model__ p) o5)) true)))
(assert (= o6 o8))
(assert (= o7 o9))
(assert (= o10 o9))
