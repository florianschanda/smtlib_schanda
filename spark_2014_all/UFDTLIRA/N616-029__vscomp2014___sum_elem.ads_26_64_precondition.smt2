...
(define-fun o16 () us_rep2 (mk___rep1 (mk___split_fields1 o6 o7)))
(assert (in_range5 x))
(assert (and (= o12 (length p)) (and (in_range1 o12) (<= o12 (capacity p)))))
(assert (and (= o13 o12) (in_range5 o12)))
(assert (= o14 (- o13 1)))
(assert (= o15 (ite (<= x o14) true false)))
(assert (= result (ite (<= 0 x) o15 false)))
(assert (= result true))
...
(assert (= result1 true))
(assert (and (= o5 j) (in_range3 j)))
(assert (and (= o16 (get (model__ p) o5)) (= (bool_eq1 o16 (get (model__ p) o5)) true)))
(assert (= o6 o8))
(assert (= o7 o9))
(assert (= o10 o9))
