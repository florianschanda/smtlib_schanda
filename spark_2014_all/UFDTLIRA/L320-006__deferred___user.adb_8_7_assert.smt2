...
(assert (forall ((us_void_param tuple0)) (! (let ((result (query_x2 us_void_param))) (and (= result 3) (dynamic_invariant result true false true))) :pattern ((query_x2 us_void_param)))))
