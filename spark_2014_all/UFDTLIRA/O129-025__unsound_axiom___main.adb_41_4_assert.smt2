...
(assert (= x__split_fields2 (mk___split_fields (mk___rep (mk___split_discrs main__create_empty_branch__branch__fields) main__create_empty_branch__branch__fields1))))
(assert (not false))
(check-sat)
(exit)
