...
(assert (<= (length q) 100))
(assert (and (= o11 (length q)) (and (in_range1 o11) (<= (+ 0 o11) 2147483647))))
(assert (and (= o8 (length v)) (and (in_range1 o8) (<= (+ 0 o8) 2147483647))))
(assert (and (= o9 (length p)) (and (in_range1 o9) (<= (+ 0 o9) 2147483647))))
(assert (= o10 (- o9 o8)))
(assert (and (= o12 o10) (in_range4 o10)))
(assert (= result1 (ite (= o12 o11) true false)))
(assert (=> (= result1 true) (and (= o6 (length q)) (and (in_range1 o6) (<= (+ 0 o6) 2147483647)))))
(assert (=> (= result1 true) (= o7 (ite (<= i1 o6) true false))))
(assert (=> (= result1 true) (= result2 (ite (<= 1 i1) o7 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length q))) (= (get p i2) (get q i2)))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (length v)) (and (in_range1 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result3 (ite (<= 1 i) o1 false)))
(assert (= result3 true))
(assert (and (= o5 (get v i)) (in_range2 o5)))
(assert (and (= o2 (length q)) (and (in_range1 o2) (<= (+ 0 o2) 2147483647))))
(assert (= o3 (+ i o2)))
