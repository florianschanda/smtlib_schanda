...
(define-fun cu__split_fields1 () us_split_fields2 (mk___split_fields1 cu__split_fields))
...
(assert (and (and (and (and (= (contains (model__ (mk___rep l__split_discrs l__split_fields2)) e) true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields1)) true)) (= (equivalent_elements (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields1)) e) true)) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields2)) e (get (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields1))) true)) (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true) (and (and (and (not (= i true)) (= (oeq4 (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq3 (elements (mk___rep l__split_discrs l__split_fields2)) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (and (and (and (and (and (and (and (= i true) (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (= (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields1)) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields2)) 1 (- (get (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields1)) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields2)) (get (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields1)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2)) (get (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields1)) 1) true)))))
(assert (not (= i true)))
(check-sat)
(exit)
