...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range1 temp___expr_142)))
...
(define-fun default_initial_assumption ((temp___expr_379 us_rep2) (temp___skip_top_level_380 Bool)) Bool (=> (not (= temp___skip_top_level_380 true)) (and (= (is_empty temp___expr_379) true) (= (length2 temp___expr_379) 0))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq2 left right) true) (and (forall ((key us_rep1)) (=> (= (has_key left key) true) (and (= (has_key right key) true) (= (get right key) (get left key))))) (forall ((key us_rep1)) (=> (= (has_key right key) true) (= (has_key left key) true))))) :pattern ((oeq2 left right)))))
...
(define-fun dynamic_invariant2 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 1 100)) (in_range3 temp___expr_295)))
(assert true)
...
(define-fun e_bigger_than_range ((container us_rep3) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get1 container i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep3 Int Int Int) Bool)
(define-fun e_smaller_than_range ((container us_rep3) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get1 container i)) true))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 1 2147483647)) (in_range4 temp___expr_315)))
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq5 a b) (oeq3 a b)) :pattern ((user_eq5 a b)))))
(define-fun default_initial_assumption1 ((temp___expr_359 us_rep3) (temp___skip_top_level_360 Bool)) Bool (=> (not (= temp___skip_top_level_360 true)) (= (length3 temp___expr_359) 0)))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_elements item (get1 container result)) true))) (dynamic_invariant1 result true false true)))) :pattern ((find container item))))))
(declare-fun keys_included (us_rep2 us_rep2) Bool)
(declare-fun keys_included__function_guard (Bool us_rep2 us_rep2) Bool)
(assert (forall ((small us_rep2) (big us_rep2)) (forall ((cut Int) (count Int)) (! (=> (and (dynamic_invariant3 cut true true true) (dynamic_invariant1 count true true true)) (= (= (p_positions_shifted small big cut count) true) (and (and (= (keys_included small big) true) (forall ((i us_rep1)) (=> (= (has_key small i) true) (ite (< (get small i) cut) (= (get big i) (get small i)) (= (- (get big i) count) (get small i)))))) (forall ((i us_rep1)) (=> (= (has_key big i) true) (or (= (has_key small i) true) (and (<= (- cut count) (- (get big i) count)) (<= (- (get big i) count) (- cut 1))))))))) :pattern ((p_positions_shifted small big cut count))))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length3 result) (length container)) (forall ((temp___393 Int)) (=> (and (in_range6 temp___393) (= (iter_has_element result temp___393) true)) (= (contains (model__ container) (get1 result temp___393)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container)))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 100)) (in_range5 temp___expr_321)))
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (=> (= (of_int 1) true) (=> (exists ((e1 Int)) (and (and (in_range5 e1) (= (contains container e1) true)) (= (equivalent_elements e1 item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq4 left right) true) (and (= (ole left right) true) (= (ole right left) true))) :pattern ((oeq4 left right)))))
(assert (forall ((container us_rep4)) (! (let ((result (is_empty1 container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range5 item) (= (contains container item) true))))) (= (= result true) (= (length4 container) 0)))) :pattern ((is_empty1 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (= (= (included_except left right item) true) (forall ((e1 Int)) (=> (and (in_range5 e1) (= (contains left e1) true)) (or (= (contains right e1) true) (= (equivalent_elements e1 item) true)))))) :pattern ((included_except left right item))))))
...
(assert (forall ((container us_rep3)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 1 100)) (in_range7 temp___expr_346)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant6 (get1 container position) true false true)) :pattern ((get1 container position))))))
...
(define-fun dynamic_invariant7 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 2147483647)) (in_range8 temp___expr_372)))
...
(assert (forall ((container us_rep2)) (! (dynamic_invariant1 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant1 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant1 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (in_range2 e))
(assert (and (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep (rec__p__my_sets__set__capacity l__split_discrs))) (not (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true))))
(assert (and (and (and (and (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) e) true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (mk___rep1 (mk___split_fields1 cu__split_fields))) true)) (= (equivalent_elements (element (mk___rep l__split_discrs (mk___split_fields l__split_fields1)) (mk___rep1 (mk___split_fields1 cu__split_fields))) e) true)) (= (e_is_find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) e (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true)) (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true) (and (and (and (not (= i true)) (= (oeq4 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq3 (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq2 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (and (and (and (and (and (and (and (= i true) (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (= (element (mk___rep l__split_discrs (mk___split_fields l__split_fields1)) (mk___rep1 (mk___split_fields1 cu__split_fields))) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1)))) true)) (= (included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) 1 (- (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true)))))
(assert (not (= i true)))
(check-sat)
(exit)
