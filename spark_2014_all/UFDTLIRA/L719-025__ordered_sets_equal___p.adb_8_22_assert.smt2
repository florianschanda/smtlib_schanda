...
(define-fun dynamic_invariant ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 1 100)) (in_range2 temp___expr_316)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_420 us_rep2) (temp___skip_top_level_421 Bool)) Bool (=> (not (= temp___skip_top_level_421 true)) (and (= (is_empty temp___expr_420) true) (= (length2 temp___expr_420) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= 1 100)) (in_range3 temp___expr_323)))
(assert true)
...
(define-fun default_initial_assumption1 ((temp___expr_397 us_rep3) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length3 temp___expr_397) 0)))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_elements item (get1 container result)) true))) (dynamic_invariant1 result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length3 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range6 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get1 result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep3)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant6 (get1 container position) true false true true)) :pattern ((get1 container position))))))
...
(assert (forall ((container us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant7 result true false true true)))) :pattern ((get container key))))))
...
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant1 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
