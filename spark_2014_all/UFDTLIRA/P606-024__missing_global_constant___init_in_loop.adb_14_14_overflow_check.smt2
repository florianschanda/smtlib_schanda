...
(assert (<= fst lst1))
(assert (= i2 j2))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 j2)) (=> (<= 1 100) (in_range3 i2))) (dynamic_invariant1 c false true true lst2)) (=> (<= 0 2147483647) (in_range2 lst2))) (and (<= 1 i2) (<= i2 100))))
