...
(define-fun dynamic_invariant1 ((temp___expr_817 us_rep1) (temp___is_init_814 Bool) (temp___skip_constant_815 Bool) (temp___do_toplevel_816 Bool)) Bool (=> (not (= temp___skip_constant_815 true)) (in_range5 10 temp___expr_817)))
(define-fun default_initial_assumption ((temp___expr_819 us_rep1) (temp___skip_top_level_820 Bool)) Bool (and (= (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 temp___expr_819))) 10) (=> (not (= temp___skip_top_level_820 true)) (= (is_empty temp___expr_819) true))))
...
(define-fun dynamic_invariant2 ((temp___expr_826 us_rep1) (temp___is_init_823 Bool) (temp___skip_constant_824 Bool) (temp___do_toplevel_825 Bool)) Bool (=> (not (= temp___skip_constant_824 true)) (in_range6 10 temp___expr_826)))
(define-fun default_initial_assumption1 ((temp___expr_828 us_rep1) (temp___skip_top_level_829 Bool)) Bool (and (= (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 temp___expr_828))) 10) (=> (not (= temp___skip_top_level_829 true)) (= (is_empty temp___expr_828) true))))
...
(define-fun dynamic_invariant5 ((temp___expr_544 Int) (temp___is_init_541 Bool) (temp___skip_constant_542 Bool) (temp___do_toplevel_543 Bool)) Bool (=> (or (= temp___is_init_541 true) (<= 1 2147483647)) (in_range7 temp___expr_544)))
...
(define-fun dynamic_invariant6 ((temp___expr_585 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 2147483647)) (in_range4 temp___expr_585)))
...
(define-fun dynamic_invariant7 ((temp___expr_605 Int) (temp___is_init_602 Bool) (temp___skip_constant_603 Bool) (temp___do_toplevel_604 Bool)) Bool (=> (or (= temp___is_init_602 true) (<= 1 2147483647)) (in_range8 temp___expr_605)))
...
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const temp___1124 count_type)
(declare-const temp___1125 count_type)
...
(assert (and (= (mk___rep2 (mk___split_fields2 temp___1124)) (first (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))) (ite (= (= (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 0) true) (= (bool_eq2 (mk___rep2 (mk___split_fields2 temp___1124)) no_element) true) (and (= (has_key (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 (mk___split_fields2 temp___1124))) true) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 (mk___split_fields2 temp___1124))) 1)))))
(assert (= result (mk___split_fields__ref2 (mk___split_fields2 c__split_fields))))
(assert (= c__split_fields1 (mk___split_fields2 temp___1124)))
(assert (and (= (mk___rep2 (mk___split_fields2 temp___1125)) (next (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)) (mk___rep2 c__split_fields1))) (ite (= (ite (= (bool_eq2 (mk___rep2 c__split_fields1) no_element) false) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 c__split_fields1)) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))) true) true) (= (bool_eq2 (mk___rep2 (mk___split_fields2 temp___1125)) no_element) true) (and (= (has_key (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 (mk___split_fields2 temp___1125))) true) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 (mk___split_fields2 temp___1125))) (+ (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 c__split_fields1)) 1))))))
(assert (= result1 (mk___split_fields__ref2 c__split_fields1)))
(assert (= c__split_fields2 (mk___split_fields2 temp___1125)))
(assert (= (to_rep o) 1))
(assert (= (to_rep1 o1) 1))
(assert (= o1 o2))
(assert (= o o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (+ (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1)) (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (mk___rep (mk___split_fields o4 o5))) true)) (= (bool_eq (get (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (mk___rep (mk___split_fields o4 o5)))) (mk___rep (mk___split_fields o4 o5))) true)) (= (ole (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep (mk___split_fields o4 o5))) true)) (= (range_equal (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) 1 (- (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (mk___rep (mk___split_fields o4 o5))) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (mk___rep (mk___split_fields o4 o5))) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (mk___rep (mk___split_fields o4 o5))) 1) true)))
...
(assert (= o10 o8))
(assert (= o11 o9))
(assert (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (+ (length (mk___rep1 l__split_discrs l__split_fields1)) 1)) (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (mk___rep (mk___split_fields o10 o11))) true)) (= (bool_eq (get (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (mk___rep (mk___split_fields o10 o11)))) (mk___rep (mk___split_fields o10 o11))) true)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields1)) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (model__ (mk___rep1 l__split_discrs l__split_fields1)) (mk___rep (mk___split_fields o10 o11))) true)) (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields1)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) 1 (- (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (mk___rep (mk___split_fields o10 o11))) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields1)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (mk___rep (mk___split_fields o10 o11))) (length (mk___rep1 l__split_discrs l__split_fields1)) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs l__split_fields1)) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields1)) (mk___rep (mk___split_fields o10 o11))) 1) true)))
...
(assert (= o16 o14))
(assert (= o17 o15))
(assert (and (and (and (and (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep (mk___split_fields o16 o17))) true) (= (has_key (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) true)) (= (equivalent_elements (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) (mk___rep (mk___split_fields o16 o17))) true)) (= (e_is_find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep (mk___split_fields o16 o17)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3))) true)) (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields2)) (mk___rep (mk___split_fields o16 o17))) true) (and (and (and (not (= b true)) (= (oeq2 (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq3 (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (elements (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq4 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (positions (mk___rep1 l__split_discrs l__split_fields2))) true)) (and (and (and (and (and (and (and (= b true) (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (+ (length (mk___rep1 l__split_discrs l__split_fields2)) 1))) (= (bool_eq (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) (mk___rep (mk___split_fields o16 o17))) true)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields2)) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2)) (mk___rep (mk___split_fields o16 o17))) true)) (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) 1 (- (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) (length (mk___rep1 l__split_discrs l__split_fields2)) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs l__split_fields2)) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1) true)))))
...
(assert (and (= temp___1137 (find1 (mk___rep1 l__split_discrs l__split_fields9) o42)) (ite (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields9)) o42) false) true false) (and (not (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1137) true)) (= (bool_eq2 temp___1137 no_element) true)) (and (and (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1137) true) (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1137) (find (elements (mk___rep1 l__split_discrs l__split_fields9)) o42))) (= (equivalent_elements (element (mk___rep1 l__split_discrs l__split_fields9) temp___1137) o42) true)))))
(assert (= result13 (mk___split_fields__ref2 c__split_fields3)))
(assert (= c__split_fields4 (us_split_fields5 temp___1137)))
