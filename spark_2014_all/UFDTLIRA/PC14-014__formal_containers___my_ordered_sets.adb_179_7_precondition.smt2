...
(assert true)
(define-fun in_range5 ((rec__my_ordered_sets__n__set__capacity1 Int) (a us_rep1)) Bool (= rec__my_ordered_sets__n__set__capacity1 (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant1 ((temp___expr_880 us_rep1) (temp___is_init_876 Bool) (temp___skip_constant_877 Bool) (temp___do_toplevel_878 Bool) (temp___do_typ_inv_879 Bool)) Bool (=> (not (= temp___skip_constant_877 true)) (in_range5 10 temp___expr_880)))
(define-fun default_initial_assumption ((temp___expr_882 us_rep1) (temp___skip_top_level_883 Bool)) Bool (and (= (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 temp___expr_882))) 10) (=> (not (= temp___skip_top_level_883 true)) (= (is_empty temp___expr_882) true))))
...
(define-fun dynamic_invariant2 ((temp___expr_890 us_rep1) (temp___is_init_886 Bool) (temp___skip_constant_887 Bool) (temp___do_toplevel_888 Bool) (temp___do_typ_inv_889 Bool)) Bool (=> (not (= temp___skip_constant_887 true)) (in_range6 10 temp___expr_890)))
(define-fun default_initial_assumption1 ((temp___expr_892 us_rep1) (temp___skip_top_level_893 Bool)) Bool (and (= (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 temp___expr_892))) 10) (=> (not (= temp___skip_top_level_893 true)) (= (is_empty temp___expr_892) true))))
...
(declare-const temp___1201 us_rep2)
...
(define-fun temp___11891 () us_rep2 (mk___rep2 (mk___split_fields2 temp___1189)))
(define-fun temp___11881 () us_rep2 (mk___rep2 (mk___split_fields2 temp___1188)))
...
(assert (and (= temp___11881 (first (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))) (ite (= (= (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 0) true) (= (bool_eq2 temp___11881 no_element) true) (and (= (has_key (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11881) true) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11881) 1)))))
(assert (= result (mk___split_fields__ref2 (mk___split_fields2 c__split_fields))))
(assert (= c__split_fields1 (mk___split_fields2 temp___1188)))
(assert (and (= temp___11891 (next (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)) (mk___rep2 c__split_fields1))) (ite (= (ite (= (bool_eq2 (mk___rep2 c__split_fields1) no_element) false) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 c__split_fields1)) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))) true) true) (= (bool_eq2 temp___11891 no_element) true) (and (= (has_key (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11891) true) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11891) (+ (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 c__split_fields1)) 1))))))
(assert (= result1 (mk___split_fields__ref2 c__split_fields1)))
(assert (= c__split_fields2 (mk___split_fields2 temp___1189)))
(assert (= (to_rep o) 1))
(assert (= (to_rep1 o1) 1))
(assert (= o1 o2))
(assert (= o o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (+ (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1)) (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o45) true)) (= (bool_eq (get (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o45)) o45) true)) (= (ole (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) o45) true)) (= (range_equal (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) 1 (- (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o45) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o45) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o45) 1) true)))
...
(assert (= o16 o14))
(assert (= o17 o15))
(assert (and (and (and (and (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) o43) true) (= (has_key (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) true)) (= (equivalent_elements (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) o43) true)) (= (e_is_find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) o43 (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3))) true)) (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields2)) o43) true) (and (and (and (not (= b true)) (= (oeq2 (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq3 (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (elements (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq4 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (positions (mk___rep1 l__split_discrs l__split_fields2))) true)) (and (and (and (and (and (and (and (= b true) (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (+ (length (mk___rep1 l__split_discrs l__split_fields2)) 1))) (= (bool_eq (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) o43) true)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields2)) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2)) o43) true)) (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) 1 (- (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) (length (mk___rep1 l__split_discrs l__split_fields2)) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs l__split_fields2)) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1) true)))))
...
(assert (and (= temp___1201 (find1 (mk___rep1 l__split_discrs l__split_fields9) o42)) (ite (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields9)) o42) false) true false) (and (not (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1201) true)) (= (bool_eq2 temp___1201 no_element) true)) (and (and (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1201) true) (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1201) (find (elements (mk___rep1 l__split_discrs l__split_fields9)) o42))) (= (equivalent_elements (element (mk___rep1 l__split_discrs l__split_fields9) temp___1201) o42) true)))))
(assert (= result13 (mk___split_fields__ref2 c__split_fields3)))
(assert (= c__split_fields4 (us_split_fields5 temp___1201)))
(assert (not (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9)) (mk___rep2 c__split_fields4)) true)))
(check-sat)
(exit)
