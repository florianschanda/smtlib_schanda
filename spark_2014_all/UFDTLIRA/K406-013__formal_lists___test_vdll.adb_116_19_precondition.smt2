...
(assert (and (= o61 (first (mk___rep l4__split_discrs l4__split_fields2))) (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields2)) 0) true) (= (bool_eq1 o61 no_element) true) (and (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) o61) true) (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields2)) o61) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) no_element) true) (= (bool_eq1 no_element no_element) true))))
(check-sat)
(exit)
