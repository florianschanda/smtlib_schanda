...
(define-fun e_bigger_than_range ((container1 us_rep2) (fst Int) (lst Int) (item us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get container1 i) item) true))) true false))
