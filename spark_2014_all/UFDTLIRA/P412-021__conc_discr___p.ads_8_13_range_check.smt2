...
(define-fun dynamic_invariant1 ((temp___expr_181 us_rep2) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (in_range1 0 (to_base temp___expr_181))))
(define-fun default_initial_assumption ((temp___expr_183 us_rep2) (temp___skip_top_level_184 Bool)) Bool (= (to_rep (rec__p__pt__x (us_split_discrs4 temp___expr_183))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_189 us_rep3) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (not (= temp___skip_constant_187 true)) (in_range2 0 (to_base1 temp___expr_189))))
(define-fun default_initial_assumption1 ((temp___expr_191 us_rep3) (temp___skip_top_level_192 Bool)) Bool (= (to_rep (rec__p__tt__x (us_split_discrs5 temp___expr_191))) 0))
...
(declare-const p__po_x__assume Int)
