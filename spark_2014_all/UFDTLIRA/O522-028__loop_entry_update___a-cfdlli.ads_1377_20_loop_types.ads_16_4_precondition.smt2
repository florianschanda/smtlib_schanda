...
(define-fun default_initial_assumption1 ((temp___expr_476 us_rep2) (temp___skip_top_level_477 Bool)) Bool (=> (not (= temp___skip_top_level_477 true)) (and (= (is_empty temp___expr_476) true) (= (length temp___expr_476) 0))))
...
(declare-const temp___731 count_type)
