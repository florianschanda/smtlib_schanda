...
(declare-const result7 capacity_range)
(declare-const result8 us_main_type)
...
(assert (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_discrs result7) (mk___split_fields result8)) (mk___rep (mk___split_discrs result9) (mk___split_fields result10)))) (queue__content amortized_queue__tail__result7)))
