...
(assert (<= (length q) 100))
(assert (and (= o14 (length q)) (and (in_range1 o14) (<= (+ 0 o14) 2147483647))))
(assert (and (= o11 (length v)) (and (in_range1 o11) (<= (+ 0 o11) 2147483647))))
(assert (and (= o12 (length p)) (and (in_range1 o12) (<= (+ 0 o12) 2147483647))))
(assert (= o13 (- o12 o11)))
(assert (and (= o15 o13) (in_range4 o13)))
(assert (= result2 (ite (= o15 o14) true false)))
(assert (=> (= result2 true) (and (= o9 (length q)) (and (in_range1 o9) (<= (+ 0 o9) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o7 (length v)) (and (in_range1 o7) (<= (+ 0 o7) 2147483647)))))
