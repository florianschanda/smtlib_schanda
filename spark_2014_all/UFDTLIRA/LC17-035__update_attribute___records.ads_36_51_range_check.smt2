...
(assert (and (= o13 (- (to_rep1 r__split_fields2) 1)) (in_range2 (- (to_rep1 r__split_fields2) 1))))
(assert (= (to_rep1 o14) o13))
(assert (and (= o12 (+ (to_rep r__split_fields) 1)) (in_range1 (+ (to_rep r__split_fields) 1))))
