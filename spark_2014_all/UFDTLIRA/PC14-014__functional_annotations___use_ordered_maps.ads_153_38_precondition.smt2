...
(assert (and (= temp___831 (keys s)) (and (and (and (= (length temp___831) (length1 s)) (forall ((temp___396 Int)) (=> (and (in_range2 temp___396) (= (iter_has_element temp___831 temp___396) true)) (= (has_key (model__ s) (get temp___831 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___831 key2)) (= (equivalent_keys (get temp___831 (find temp___831 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (and (= (find temp___831 (get temp___831 i)) i) (= (k_is_find temp___831 (get temp___831 i) i) true)))))))
(assert (and (= o3 (iter_has_element temp___831 temp___830)) (= (= o3 true) (and (<= 1 temp___830) (<= temp___830 (last temp___831))))))
(assert (= (= o4 true) (in_range2 temp___830)))
(assert (= result1 (ite (= o4 true) o3 false)))
(assert (= result1 true))
(assert (and (= k (get temp___831 temp___830)) (in_range3 k)))
