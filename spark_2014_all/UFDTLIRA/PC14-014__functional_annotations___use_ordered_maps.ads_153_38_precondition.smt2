...
(declare-const temp___874 us_rep2)
...
(assert (and (= temp___874 (keys s)) (and (and (and (= (length temp___874) (length1 s)) (forall ((temp___439 Int)) (=> (and (in_range2 temp___439) (= (iter_has_element temp___874 temp___439) true)) (= (has_key (model__ s) (get temp___874 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___874 key2)) (= (equivalent_keys (get temp___874 (find temp___874 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 s))) (and (= (find temp___874 (get temp___874 i)) i) (= (k_is_find temp___874 (get temp___874 i) i) true)))))))
...
(assert (= result true))
(assert (and (= k (get temp___874 temp___873)) (in_range3 k)))
