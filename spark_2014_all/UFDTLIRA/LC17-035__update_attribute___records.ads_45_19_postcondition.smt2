...
(assert (= (to_rep o) (to_rep r__split_fields4)))
(assert (= r__split_fields4 o1))
(assert (= r__split_fields5 o2))
(assert (= r__split_fields6 o3))
(assert (= o o4))
(assert (= temp___285 o1))
(assert (= temp___2851 o2))
(assert (= temp___2852 o3))
(assert (= temp___2853 o4))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14 r__split_fields15)) (mk___rep (mk___split_fields r__split_fields rliteral r__split_fields2 r__split_fields))) true)))
(check-sat)
(exit)
