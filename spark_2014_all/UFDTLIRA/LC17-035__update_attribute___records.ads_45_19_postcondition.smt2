...
(declare-const temp___283 integer)
(declare-const temp___2831 natural)
(declare-const temp___2832 my_range)
(declare-const temp___2833 integer)
...
(declare-const temp___285 integer)
(declare-const temp___2851 natural)
(declare-const temp___2852 my_range)
(declare-const temp___2853 integer)
...
(assert (= temp___283 r__split_fields4))
(assert (= temp___2831 r__split_fields5))
(assert (= temp___2832 r__split_fields6))
(assert (= temp___2833 r__split_fields7))
(assert (= (to_rep o5) (to_rep r__split_fields4)))
(assert (= r__split_fields4 o6))
(assert (= r__split_fields5 o7))
(assert (= r__split_fields6 o8))
(assert (= o5 o9))
(assert (= temp___285 o6))
...
(assert (= temp___285 r__split_fields8))
(assert (= temp___2851 r__split_fields9))
(assert (= temp___2852 r__split_fields10))
(assert (= temp___2853 r__split_fields11))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14 r__split_fields15)) (mk___rep (mk___split_fields r__split_fields (of_rep1 2) r__split_fields2 r__split_fields))) true)))
(check-sat)
(exit)
