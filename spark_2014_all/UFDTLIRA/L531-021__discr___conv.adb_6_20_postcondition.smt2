...
(assert (and (and (and (= us (to_rep (rec__basic__r__x (us_split_discrs1 x)))) (in_range (to_rep (rec__basic__r__x (us_split_discrs1 x))))) (and (and (and (= conv__id__result10 conv__id__result5) (and (= conv__id__result11 conv__id__result6) (and (= conv__id__result12 conv__id__result7) (and (= conv__id__result13 conv__id__result8) (= conv__id__result14 conv__id__result9))))) (= (mk___rep (mk___split_discrs conv__id__result15) (mk___split_fields conv__id__result16 conv__id__result17 conv__id__result18 conv__id__result19)) (mk___rep (mk___split_discrs conv__id__result5) (mk___split_fields conv__id__result6 conv__id__result7 conv__id__result8 conv__id__result9)))) (and (and (= result conv__id__result) (and (= result1 conv__id__result1) (and (= result2 conv__id__result2) (and (= result3 conv__id__result3) (= result4 conv__id__result4))))) (= (mk___rep (mk___split_discrs conv__id__result5) (mk___split_fields conv__id__result6 conv__id__result7 conv__id__result8 conv__id__result9)) x)))) (and (= (mk_r__ref (mk___rep (mk___split_discrs conv__id__result20) (mk___split_fields conv__id__result21 conv__id__result22 conv__id__result23 conv__id__result24))) (mk_r__ref (mk___rep (mk___split_discrs conv__id__result10) (mk___split_fields conv__id__result11 conv__id__result12 conv__id__result13 conv__id__result14)))) (= conv__id__result25 (mk___rep (mk___split_discrs conv__id__result15) (mk___split_fields conv__id__result16 conv__id__result17 conv__id__result18 conv__id__result19))))))
