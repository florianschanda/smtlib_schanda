...
(assert (and (= o1 (capacity (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o1) (= o1 (ite (= (distinct 1 0) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity target__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
