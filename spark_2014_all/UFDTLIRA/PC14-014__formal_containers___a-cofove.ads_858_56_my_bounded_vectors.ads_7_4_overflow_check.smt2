...
(define-fun dynamic_invariant ((temp___expr_700 Int) (temp___is_init_697 Bool) (temp___skip_constant_698 Bool) (temp___do_toplevel_699 Bool)) Bool (=> (or (= temp___is_init_697 true) (<= 0 2147483647)) (in_range1 temp___expr_700)))
...
(assert (and (= o1 (capacity (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o1) (= o1 (ite (= (of_int 1) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity target__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
