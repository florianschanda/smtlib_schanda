...
(define-fun dynamic_invariant1 ((temp___expr_717 Int) (temp___is_init_714 Bool) (temp___skip_constant_715 Bool) (temp___do_toplevel_716 Bool)) Bool (=> (or (= temp___is_init_714 true) (<= 0 1001)) (in_range2 temp___expr_717)))
...
(define-fun dynamic_invariant2 ((temp___expr_723 Int) (temp___is_init_720 Bool) (temp___skip_constant_721 Bool) (temp___do_toplevel_722 Bool)) Bool (=> (or (= temp___is_init_720 true) (<= 0 1000)) (in_range3 temp___expr_723)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__instances__vectors__vector__capacity (us_split_discrs1 container))) 1000))
...
(define-fun dynamic_invariant3 ((temp___expr_705 Int) (temp___is_init_702 Bool) (temp___skip_constant_703 Bool) (temp___do_toplevel_704 Bool)) Bool (=> (or (= temp___is_init_702 true) (<= 1 1000)) (in_range4 temp___expr_705)))
...
(define-fun default_initial_assumption ((temp___expr_757 us_rep1) (temp___skip_top_level_758 Bool)) Bool (=> (not (= temp___skip_top_level_758 true)) (= (length1 temp___expr_757) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_750 Int) (temp___is_init_747 Bool) (temp___skip_constant_748 Bool) (temp___do_toplevel_749 Bool)) Bool (=> (or (= temp___is_init_747 true) (<= 0 1000)) (in_range5 temp___expr_750)))
...
(define-fun dynamic_invariant5 ((temp___expr_744 Int) (temp___is_init_741 Bool) (temp___skip_constant_742 Bool) (temp___do_toplevel_743 Bool)) Bool (=> (or (= temp___is_init_741 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_744)))
