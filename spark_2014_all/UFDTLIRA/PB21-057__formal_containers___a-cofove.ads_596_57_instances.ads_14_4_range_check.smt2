...
(define-fun dynamic_invariant1 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 1001)) (in_range2 temp___expr_799)))
...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__instances__vectors__vector__capacity capacity_range)))))
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) capacity_range (rec__instances__vectors__vector__capacity a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__instances__vectors__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type (rec__instances__vectors__vector a))
...
(assert (< instances__vectors__vector__capacity__first__bit instances__vectors__vector__capacity__last__bit))
...
(define-fun dynamic_invariant2 ((temp___expr_806 Int) (temp___is_init_802 Bool) (temp___skip_constant_803 Bool) (temp___do_toplevel_804 Bool) (temp___do_typ_inv_805 Bool)) Bool (=> (or (= temp___is_init_802 true) (<= 0 1000)) (in_range3 temp___expr_806)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__instances__vectors__vector__capacity (us_split_discrs1 container))) 1000))
...
(define-fun dynamic_invariant3 ((temp___expr_785 Int) (temp___is_init_781 Bool) (temp___skip_constant_782 Bool) (temp___do_toplevel_783 Bool) (temp___do_typ_inv_784 Bool)) Bool (=> (or (= temp___is_init_781 true) (<= 1 1000)) (in_range4 temp___expr_785)))
...
(define-fun default_initial_assumption ((temp___expr_845 us_rep1) (temp___skip_top_level_846 Bool)) Bool (=> (not (= temp___skip_top_level_846 true)) (= (length1 temp___expr_845) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_837 Int) (temp___is_init_833 Bool) (temp___skip_constant_834 Bool) (temp___do_toplevel_835 Bool) (temp___do_typ_inv_836 Bool)) Bool (=> (or (= temp___is_init_833 true) (<= 0 1000)) (in_range5 temp___expr_837)))
...
(define-fun dynamic_invariant5 ((temp___expr_830 Int) (temp___is_init_826 Bool) (temp___skip_constant_827 Bool) (temp___do_toplevel_828 Bool) (temp___do_typ_inv_829 Bool)) Bool (=> (or (= temp___is_init_826 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_830)))
