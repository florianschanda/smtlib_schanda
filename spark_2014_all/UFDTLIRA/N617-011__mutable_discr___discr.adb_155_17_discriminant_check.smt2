...
(define-fun default_initial_assumption ((temp___expr_142 us_rep) (temp___skip_top_level_143 Bool)) Bool (and (= (attr__constrained temp___expr_142) false) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___expr_142))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_148 us_rep1) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (= (attr__constrained (rec__private_discr__p_holder__content (us_split_fields3 temp___expr_148))) false))
(define-fun default_initial_assumption1 ((temp___expr_150 us_rep1) (temp___skip_top_level_151 Bool)) Bool (and (= (attr__constrained (rec__private_discr__p_holder__content (us_split_fields3 temp___expr_150))) false) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 (rec__private_discr__p_holder__content (us_split_fields3 temp___expr_150))))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_253 us_rep) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool)) Bool (and (=> (not (= temp___skip_constant_251 true)) (in_range1 c temp___expr_253)) (= (attr__constrained temp___expr_253) true)))
(define-fun default_initial_assumption2 ((temp___expr_255 us_rep) (temp___skip_top_level_256 Bool)) Bool (and (= (attr__constrained temp___expr_255) true) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___expr_255))) c)))
...
(declare-const h__split_fields1 us_main_type)
(declare-const h__split_fields2 Bool)
...
(declare-const discr__p5__d1__assume natural)
(declare-const discr__p5__d1__assume1 us_main_type)
(declare-const discr__p5__d1__assume2 Bool)
(declare-const discr__p5__d2__assume natural)
(declare-const discr__p5__d2__assume1 us_main_type)
(declare-const discr__p5__d2__assume2 Bool)
(declare-const usq_ us_rep)
(declare-const o6 us_rep)
(declare-const o7 us_split_fields2)
(declare-const temp___343 us_rep1)
...
(declare-const d1__split_fields1 us_split_fields)
(declare-const result1 us_split_fields__ref)
(declare-const d2__split_fields1 us_split_fields)
...
(declare-const h__split_fields3 us_split_fields2)
(declare-const result4 us_split_fields__ref1)
(declare-const h__split_fields4 us_split_fields2)
(assert (in_range c))
(assert (and (= us c) (in_range c)))
(assert (and (= (mk___rep (mk___split_discrs o) (mk___split_fields o1) o2) (new_with_default c)) (= (to_rep o) c)))
(assert (= (mk___rep (mk___split_discrs o3) (mk___split_fields o4) o5) (mk___rep (mk___split_discrs o) (mk___split_fields o1) o2)))
(assert (= (mk___rep (mk___split_discrs discr__p5__d1__assume) (mk___split_fields discr__p5__d1__assume1) discr__p5__d1__assume2) (mk___rep (mk___split_discrs o3) (mk___split_fields o4) o5)))
(assert (= result (mk___split_fields__ref (mk___split_fields d1__split_fields))))
(assert (= d1__split_fields1 (mk___split_fields discr__p5__d1__assume1)))
(assert (= d1__split_discrs (mk___split_discrs discr__p5__d1__assume)))
...
(assert (and (= (mk___rep (mk___split_discrs discr__p5__d2__assume) (mk___split_fields discr__p5__d2__assume1) discr__p5__d2__assume2) (new_with_default c)) (= (to_rep discr__p5__d2__assume) c)))
(assert (= result1 (mk___split_fields__ref (mk___split_fields d2__split_fields))))
(assert (= d2__split_fields1 (mk___split_fields discr__p5__d2__assume1)))
(assert (= result2 (mk___split_discrs__ref (mk___split_discrs d2__split_discrs))))
(assert (= d2__split_discrs1 (mk___split_discrs discr__p5__d2__assume)))
(assert (= d2__attr__constrained false))
(assert (and (= h__split_fields2 false) (= (to_rep h__split_fields) 0)))
(assert (= h__split_fields2 false))
(assert (= (to_rep h__split_fields) 0))
(assert (not (= h__split_fields2 true)))
(assert (=> (= h__split_fields2 true) (= (rec__private_discr__p_with_default__c d1__split_discrs) h__split_fields)))
(assert (= usq_ (mk___rep d1__split_discrs d1__split_fields1 d1__attr__constrained)))
(assert (= o6 (mk___rep (us_split_discrs1 usq_) (us_split_fields1 usq_) h__split_fields2)))
(assert (= o7 (mk___split_fields1 o6)))
(assert (= temp___343 (mk___rep1 o7)))
(assert (= result3 (mk___split_fields__ref1 (mk___split_fields1 (mk___rep (mk___split_discrs h__split_fields) (mk___split_fields h__split_fields1) h__split_fields2)))))
(assert (= h__split_fields3 (us_split_fields3 temp___343)))
(assert (not (= (attr__constrained (rec__private_discr__p_holder__content h__split_fields3)) true)))
(assert (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 (rec__private_discr__p_holder__content h__split_fields3)))) c))
(assert (= (attr__constrained (rec__private_discr__p_holder__content h__split_fields3)) true))
(assert (not (= (rec__private_discr__p_with_default__c d2__split_discrs1) (rec__private_discr__p_with_default__c (us_split_discrs1 (rec__private_discr__p_holder__content h__split_fields3))))))
(check-sat)
(exit)
