...
(define-fun o8 () us_rep (mk___rep (mk___split_discrs o3) (mk___split_fields o4) o5))
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1) o2))
(assert (in_range c))
(assert (and (= us c) (in_range c)))
(assert (and (= o9 (new_with_default c)) (= (to_rep o) c)))
(assert (= o8 o9))
(assert (= (mk___rep (mk___split_discrs discr__p5__d1__assume) (mk___split_fields discr__p5__d1__assume1) discr__p5__d1__assume2) o8))
