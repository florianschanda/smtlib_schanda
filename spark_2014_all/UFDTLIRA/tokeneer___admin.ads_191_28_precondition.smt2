...
(declare-const dummy opandnullt)
...
(assert (forall ((x opandnullt)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x opandnullt)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(declare-const dummy1 opt)
(declare-datatypes () ((opt__ref (mk_opt__ref (opt__content opt)))))
(define-fun opt__ref___projection ((a opt__ref)) opt (opt__content a))
(define-fun dynamic_invariant ((temp___expr_479 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool) (temp___do_typ_inv_478 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 4)) (in_range2 temp___expr_479)))
...
(declare-const dummy2 privileget)
...
(assert (forall ((x privileget)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x privileget)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__admin__t__rolepresent (us_split_fields1 a))) (to_rep1 (rec__admin__t__rolepresent (us_split_fields1 b)))) (= (to_rep (rec__admin__t__currentop (us_split_fields1 a))) (to_rep (rec__admin__t__currentop (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 3)) (in_range3 temp___expr_402)))
(assert (forall ((theadmin us_rep)) (! (dynamic_invariant1 (rolepresent theadmin) true false true true) :pattern ((rolepresent theadmin)))))
(assert (forall ((theadmin us_rep)) (! (= (rolepresent theadmin) (to_rep1 (rec__admin__t__rolepresent (us_split_fields1 theadmin)))) :pattern ((rolepresent theadmin)))))
(declare-fun isdoingop (us_rep) Bool)
(declare-fun isdoingop__function_guard (Bool us_rep) Bool)
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (isdoingop theadmin) true) (in_range2 (to_rep (rec__admin__t__currentop (us_split_fields1 theadmin))))) :pattern ((isdoingop theadmin)))))
...
(assert (forall ((theadmin us_rep)) (! (= (thecurrentop theadmin) (to_rep (rec__admin__t__currentop (us_split_fields1 theadmin)))) :pattern ((thecurrentop theadmin)))))
...
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (ispresent theadmin) true) (in_range4 (to_rep1 (rec__admin__t__rolepresent (us_split_fields1 theadmin))))) :pattern ((ispresent theadmin)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const op Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 0 4)) (in_range1 temp___expr_472)))
...
(declare-const temp___601 privileget)
(declare-const temp___6011 opandnullt)
...
(assert (in_range2 op))
(assert (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))
(assert (= (to_rep o) op))
(assert (= theadmin__split_fields o1))
(assert (= o o2))
(assert (= temp___601 o1))
(assert (= temp___6011 o2))
(assert (= (mk___split_fields__ref (mk___split_fields result result1)) (mk___split_fields__ref (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
(assert (= temp___601 theadmin__split_fields2))
(assert (= temp___6011 theadmin__split_fields3))
(assert (= theadmin__split_fields4 theadmin__split_fields2))
(assert (= theadmin__split_fields5 theadmin__split_fields3))
(assert (= (mk___split_fields theadmin__split_fields6 theadmin__split_fields7) (mk___split_fields theadmin__split_fields2 theadmin__split_fields3)))
