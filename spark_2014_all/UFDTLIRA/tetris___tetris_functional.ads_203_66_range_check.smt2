...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep (rec__tetris_functional__piece__s (us_split_fields1 a))) (to_rep (rec__tetris_functional__piece__s (us_split_fields1 b)))) (= (to_rep3 (rec__tetris_functional__piece__d (us_split_fields1 a))) (to_rep3 (rec__tetris_functional__piece__d (us_split_fields1 b))))) (= (to_rep1 (rec__tetris_functional__piece__x (us_split_fields1 a))) (to_rep1 (rec__tetris_functional__piece__x (us_split_fields1 b))))) (= (to_rep2 (rec__tetris_functional__piece__y (us_split_fields1 a))) (to_rep2 (rec__tetris_functional__piece__y (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_698 Int) (temp___is_init_694 Bool) (temp___skip_constant_695 Bool) (temp___do_toplevel_696 Bool) (temp___do_typ_inv_697 Bool)) Bool (=> (or (= temp___is_init_694 true) (<= 0 4)) (in_range5 temp___expr_698)))
(assert true)
(assert (forall ((p us_rep)) (forall ((a Int)) (! (= (= (move_is_possible p a) true) (ite (= a 0) (in_range3 (- (to_rep1 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) (ite (= a 1) (in_range3 (+ (to_rep1 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) (=> (= a 2) (in_range4 (+ (to_rep2 (rec__tetris_functional__piece__y (us_split_fields1 p))) 1)))))) :pattern ((move_is_possible p a))))))
