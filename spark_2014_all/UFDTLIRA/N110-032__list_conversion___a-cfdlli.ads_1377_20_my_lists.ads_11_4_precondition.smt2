...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___569 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___569)) no_element))
