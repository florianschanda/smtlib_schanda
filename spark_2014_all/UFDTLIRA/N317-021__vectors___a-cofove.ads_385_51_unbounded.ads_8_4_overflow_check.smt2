...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o) (= o (ite (= (distinct 0 0) true) (to_rep (rec__unbounded__vect__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
