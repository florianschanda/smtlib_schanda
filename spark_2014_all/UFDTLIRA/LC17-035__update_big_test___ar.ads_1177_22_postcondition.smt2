...
(define-fun dynamic_invariant3 ((temp___expr_212 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 4)) (in_range4 temp___expr_212)))
...
(assert (= r__split_fields7 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields5 r__split_fields6)) r__split_fields3)) r__split_fields4 (mk___rep (mk___split_fields r__split_fields5 r__split_fields6)))))
(assert (= result9 (mk___split_fields__ref2 r__split_fields7)))
(assert (= r__split_fields8 (mk___split_fields2 (rec__ar__rec5t__f5 r__split_fields7) (rec__ar__rec5t__g5 r__split_fields7) (mk___rep (mk___split_fields temp__split_fields2 temp__split_fields3)))))
(assert (= temp__split_fields4 (mk___split_fields__ref (mk___split_fields temp__split_fields2 temp__split_fields3))))
(assert (= r__split_fields9 (mk___split_fields__ref2 r__split_fields8)))
(assert (= temp__split_fields5 (mk___split_fields temp__split_fields2 temp__split_fields3)))
