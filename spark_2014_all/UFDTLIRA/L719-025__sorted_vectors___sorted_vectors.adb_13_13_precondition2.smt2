...
(assert (and (=> (<= 1 100) (in_range8 position2)) (and (<= position2 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (< (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position2) new_item))))
(assert (and (= o4 1) (and (in_range5 o4) (= o4 1))))
(assert (= result3 (ite (= position2 o4) true false)))
(assert (not (= result3 true)))
(assert (and (= o3 (- position2 1)) (in_range5 (- position2 1))))
(assert (not (<= 1 o3)))
(check-sat)
(exit)
