...
(assert (not (= (local_invariant the_file2 (us_split_fields__content1 current_read__split_fields2) (us_split_discrs__content1 current_read__split_discrs2) (int__content current_idx2) (us_split_fields__content1 next_read__split_fields2) (us_split_discrs__content1 next_read__split_discrs2) (int__content next_idx2)) true)))
(check-sat)
(exit)
