...
(define-fun dynamic_invariant ((temp___expr_1497 Int) (temp___is_init_1494 Bool) (temp___skip_constant_1495 Bool) (temp___do_toplevel_1496 Bool)) Bool (=> (or (= temp___is_init_1494 true) (<= 0 2147483647)) (in_range2 temp___expr_1497)))
...
(define-fun dynamic_invariant1 ((temp___expr_1503 Int) (temp___is_init_1500 Bool) (temp___skip_constant_1501 Bool) (temp___do_toplevel_1502 Bool)) Bool (=> (or (= temp___is_init_1500 true) (<= 0 2147483647)) (in_range3 temp___expr_1503)))
...
(define-fun dynamic_invariant3 ((temp___expr_1530 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2147483647)) (in_range5 temp___expr_1530)))
...
(define-fun dynamic_invariant4 ((temp___expr_1524 Int) (temp___is_init_1521 Bool) (temp___skip_constant_1522 Bool) (temp___do_toplevel_1523 Bool)) Bool (=> (or (= temp___is_init_1521 true) (<= 0 2147483647)) (in_range6 temp___expr_1524)))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range3 o1) (= o1 (ite (= (of_int 1) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
