...
(declare-const temp___7028 us_rep2)
...
(assert (= temp___7028 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
(assert (= result1 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields6 (us_split_fields5 temp___7028)))
(assert (= r__split_fields7 (mk___split_fields__ref2 r__split_fields6)))
(assert (= r__split_fields8 r__split_fields6))
(assert (not (= (bool_eq2 (mk___rep2 (us_split_fields__content2 r__split_fields7)) (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 a)) (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 a)))))) (rec__ar__rec2t__h2 (us_split_fields3 a)))) r__split_fields4))) true)))
(check-sat)
(exit)
