...
(assert (and (= o1 (get1 o (mk___rep1 c__split_fields2))) (and (in_range5 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 c__split_fields2)))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k (mk___rep1 c__split_fields2)) true) (= (witness o (mk___rep1 c__split_fields2)) (witness o k))))))))))
