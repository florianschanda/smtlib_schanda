...
(define-fun default_initial_assumption ((temp___expr_201 us_rep1) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__int_list__my_lists__cursor__node (us_split_fields3 temp___expr_201))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__int_list__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 1 100)) (in_range4 temp___expr_220)))
...
(define-fun default_initial_assumption3 ((temp___expr_240 us_rep1) (temp___skip_top_level_241 Bool)) Bool (= (to_rep (rec__int_list__my_lists__cursor__node (us_split_fields3 temp___expr_240))) 0))
...
(define-fun dynamic_invariant4 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 1 100)) (in_range1 temp___expr_189)))
...
(declare-const temp___475 count_type)
(declare-const temp___4751 us_main_type)
(declare-const temp___472 count_type)
(declare-const temp___4721 us_main_type)
(declare-const temp___476 count_type)
(declare-const temp___4761 us_main_type)
(declare-const temp___471 count_type)
(declare-const temp___474 us_rep3)
(declare-const temp___473 count_type)
(declare-const temp___4731 us_main_type)
(declare-const i Int)
...
(assert (forall ((c2 us_rep1)) (=> (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c2) true) (< (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) c2) 100))))
(assert (and (= (mk___rep1 (mk___split_fields1 int_list__incr__c__assume)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 int_list__incr__c__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 int_list__incr__c__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 int_list__incr__c__assume))) 1)))))
(assert (= result1 (mk___split_fields__ref1 (mk___split_fields1 c__split_fields))))
(assert (= c__split_fields1 (mk___split_fields1 int_list__incr__c__assume)))
(assert (and (= result2 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1))) (= (= result2 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) true))))
(assert (= result2 true))
...
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2)) 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i2) (+ (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2) 1)))))
(assert (forall ((i2 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2)) i2) (<= i2 (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i2) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2)))))
(assert (and (= o14 (length (mk___rep l__split_discrs l__split_fields2))) (and (in_range2 o14) (<= o14 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
(assert (= o15 (ite (<= i1 o14) true false)))
(assert (and (= o12 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o12 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key o12 i2) true) (and (and (<= 1 (get1 o12 i2)) (<= (get1 o12 i2) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o12 j) true) (=> (= (get1 o12 i2) (get1 o12 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o13 (get1 o12 (mk___rep1 c__split_fields2))) (and (in_range5 o13) (=> (= (of_int 0) true) (and (= o13 (w_get o12 (witness o12 (mk___rep1 c__split_fields2)))) (forall ((k us_rep1)) (=> (= (has_key o12 k) true) (= (= (bool_eq1 k (mk___rep1 c__split_fields2)) true) (= (witness o12 (mk___rep1 c__split_fields2)) (witness o12 k))))))))))
(assert (= o16 (ite (<= o13 i1) true false)))
(assert (= result4 (ite (= o16 true) o15 false)))
(assert (= result4 true))
(assert (and (= o20 i1) (in_range3 i1)))
(assert (and (= o19 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o19) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o21 (get o19 o20)) (in_range4 o21)))
