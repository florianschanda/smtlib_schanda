...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields1)) true) (= (bool_eq3 (mk___rep2 c__split_fields1) no_element) true))))
(check-sat)
(exit)
