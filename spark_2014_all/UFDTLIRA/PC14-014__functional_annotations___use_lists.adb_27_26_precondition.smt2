...
(assert (and (= o (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1)))) (and (in_range2 o) (<= o (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))))
(assert (= o1 (ite (<= n o) true false)))
(assert (= result2 (ite (<= 1 n) o1 false)))
(assert (= result2 true))
(assert (and (= o4 (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1)))) (= (length1 o4) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))))))
