...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length3 result) (length1 container)) (forall ((temp___393 Int)) (=> (and (in_range6 temp___393) (= (iter_has_element result temp___393) true)) (= (contains (model__ container) (get1 result temp___393)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container)))))
(assert true)
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range5 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (and (= o (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (and (in_range3 o) (= o (get1 (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))))))))
(assert (= (mk_int__ref result) (mk_int__ref e)))
(assert (= e1 o))
(assert (in_range1 e1))
(assert (and (and (and (and (and (and (and (and (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields1)) no_element) true) (= (length1 (mk___rep l__split_discrs l__split_fields2)) (- (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (not (= (contains (model__ (mk___rep l__split_discrs l__split_fields2)) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true))) (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields))) true))) (= (ole (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2)) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields2)) 1 (- (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields2)) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length1 (mk___rep l__split_discrs l__split_fields2)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true)))
(assert (not (or (< (length1 (mk___rep l__split_discrs l__split_fields2)) (to_rep (rec__p__my_sets__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep l__split_discrs l__split_fields2)) e1) true))))
(check-sat)
(exit)
