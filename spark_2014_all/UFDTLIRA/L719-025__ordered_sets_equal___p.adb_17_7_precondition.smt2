...
(assert (= e1 o))
(assert (in_range1 e1))
(assert (and (and (and (and (and (and (and (and (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields1)) no_element) true) (= (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (- (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (not (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true))) (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (mk___rep1 (mk___split_fields1 cu__split_fields))) true))) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) 1 (- (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true)))
(assert (not (or (< (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (to_rep (rec__p__my_sets__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) e1) true))))
(check-sat)
(exit)
