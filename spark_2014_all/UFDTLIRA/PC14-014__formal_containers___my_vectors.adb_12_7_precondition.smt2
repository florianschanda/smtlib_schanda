...
(assert (= l__split_fields2 my_vectors__v__append__2__container__fields1))
(assert (not (<= (length (mk___rep l__split_discrs l__split_fields2)) (- (capacity (mk___rep l__split_discrs l__split_fields2)) 4))))
(check-sat)
(exit)
