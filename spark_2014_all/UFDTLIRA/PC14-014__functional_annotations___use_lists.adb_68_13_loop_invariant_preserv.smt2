...
(assert (and (= result1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields6))) (= (= result1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields6)) true))))
(assert (= result1 true))
(assert (= (length (mk___rep l__split_discrs l__split_fields4)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (forall ((n Int)) (=> (and (<= 1 n) (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)) 1))) (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs l__split_fields4)) n)) true))))
(assert (forall ((n Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5)) n) (<= n (length (mk___rep l__split_discrs l__split_fields4)))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs l__split_fields4)) n)))))
(assert (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields4))) true))
...
(assert (=> (= result2 true) (and (= o1 (element (mk___rep l__split_discrs l__split_fields4) (mk___rep1 cu__split_fields5))) (and (in_range6 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields4)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields5))))))))
(assert (=> (= result2 true) (= o2 (+ o1 1))))
(assert (=> (= result2 true) (and (= o3 o2) (in_range1 o2))))
(assert (=> (= result2 true) (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields4))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields4)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields5))) o3)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields4)) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields5))) true))))
...
(assert (and (= o4 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4))) (= (= o4 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) true))))
(assert (= result3 (ite (not (= o4 true)) true false)))
(assert (not (= result3 true)))
(declare-const n Int)
(assert (<= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields4)) n))
(assert (<= n (length (mk___rep l__split_discrs l__split_fields3))))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs l__split_fields3)) n))))
(check-sat)
(exit)
