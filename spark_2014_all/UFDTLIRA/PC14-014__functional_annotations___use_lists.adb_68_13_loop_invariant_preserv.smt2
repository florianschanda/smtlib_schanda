...
(assert (and (= o21 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3)))) (= (= o21 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true))))
(assert (= result5 (ite (not (= o21 true)) true false)))
(assert (not (= result5 true)))
(declare-const n3 Int)
(assert (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) n3))
(assert (<= n3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) n3))))
(check-sat)
(exit)
