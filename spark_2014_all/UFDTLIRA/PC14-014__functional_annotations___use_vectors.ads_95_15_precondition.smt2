...
(assert (and (= us8 temp___525) (dynamic_property2 first1 last3 temp___525)))
...
(assert (= o11 j))
(assert (not (<= o11 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8)))))))
(check-sat)
(exit)
