...
(assert (in_range n))
(assert (< n 255))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result (mk___rep (mk___split_fields result1 result2)))) (mk___split_fields__ref1 (mk___split_fields1 tmp__split_fields (mk___rep (mk___split_fields tmp__split_fields1 tmp__split_fields2))))))
