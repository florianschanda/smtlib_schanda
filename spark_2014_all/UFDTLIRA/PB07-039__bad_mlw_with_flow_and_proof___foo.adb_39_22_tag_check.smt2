...
(assert (and (= (mk___rep (mk___split_fields temp___206) temp___2061) (prim_func (mk___split_fields t1_var__split_fields))) (and (= t1_var__split_fields temp___206) (= t1_var__attr__tag temp___2061))))
(assert (us_compatible_tags temp___2061 us_tag1))
(assert (= (mk___rep (mk___split_fields o) o1) (mk___rep (mk___split_fields temp___206) temp___2061)))
(assert (= o2 o))
(assert (= o3 o1))
