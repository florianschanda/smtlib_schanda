...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (= (attr__tag temp___expr_172) us_tag))
...
(define-fun default_initial_assumption1 ((temp___expr_183 us_rep) (temp___skip_top_level_184 Bool)) Bool (= (attr__tag temp___expr_183) us_tag1))
(define-fun default_initial_assumption2 ((temp___expr_193 us_rep) (temp___skip_top_level_194 Bool)) Bool (= (attr__tag temp___expr_193) us_tag2))
(declare-const t1_var__split_fields us_private)
(declare-const temp___205 us_private)
...
(define-fun temp___2062 () us_rep (mk___rep (mk___split_fields temp___206) temp___2061))
(assert (and (= temp___2062 (prim_func (mk___split_fields t1_var__split_fields))) (and (= t1_var__split_fields temp___206) (= t1_var__attr__tag temp___2061))))
(assert (us_compatible_tags temp___2061 us_tag1))
(assert (= (mk___rep (mk___split_fields o) o1) temp___2062))
(assert (= o2 o))
(assert (= o3 o1))
(assert (and (= (mk___rep (mk___split_fields temp___205) temp___2051) (prim_func (mk___split_fields t1_var__split_fields))) (and (= t1_var__split_fields temp___205) (= t1_var__attr__tag temp___2051))))
(assert (not (us_compatible_tags temp___2051 us_tag1)))
(check-sat)
(exit)
