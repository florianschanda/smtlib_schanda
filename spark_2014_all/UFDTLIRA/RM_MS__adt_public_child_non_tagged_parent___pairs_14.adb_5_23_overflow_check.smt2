...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__pairs_14__pair__value_one integer) (rec__pairs_14__pair__value_two integer)))))
(define-fun us_split_fields_Value_One__projection ((a us_split_fields)) integer (rec__pairs_14__pair__value_one a))
(define-fun us_split_fields_Value_Two__projection ((a us_split_fields)) integer (rec__pairs_14__pair__value_two a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__pairs_14__pair__value_one (us_split_fields1 a))) (to_rep (rec__pairs_14__pair__value_one (us_split_fields1 b)))) (= (to_rep (rec__pairs_14__pair__value_two (us_split_fields1 a))) (to_rep (rec__pairs_14__pair__value_two (us_split_fields1 b))))) true false))
...
(assert (< pairs_14__pair__value_one__first__bit pairs_14__pair__value_one__last__bit))
...
(assert (< pairs_14__pair__value_two__first__bit pairs_14__pair__value_two__last__bit))
