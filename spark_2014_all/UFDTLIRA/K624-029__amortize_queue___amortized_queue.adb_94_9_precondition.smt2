...
(assert (not (< 0 (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields4)) (us_split_fields1 (rec__amortized_queue__queue__front result____split_fields4)))))))
(check-sat)
(exit)
