...
(define-fun dynamic_invariant1 ((temp___expr_631 Int) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool (=> (or (= temp___is_init_627 true) (<= 0 3)) (in_range2 temp___expr_631)))
(assert true)
