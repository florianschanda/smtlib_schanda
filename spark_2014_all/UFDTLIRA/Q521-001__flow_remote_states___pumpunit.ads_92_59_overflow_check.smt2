...
(assert (forall ((pumpunit__total_pay Int)) (! (=> (dynamic_invariant pumpunit__total_pay true true true) (dynamic_invariant (get_total pumpunit__total_pay) true false true)) :pattern ((get_total pumpunit__total_pay)))))
(assert (forall ((pumpunit__total_pay Int)) (! (=> (dynamic_invariant pumpunit__total_pay true true true) (= (get_total pumpunit__total_pay) pumpunit__total_pay)) :pattern ((get_total pumpunit__total_pay)))))
...
(define-fun dynamic_invariant1 ((temp___expr_557 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 0 3)) (in_range2 temp___expr_557)))
(assert true)
