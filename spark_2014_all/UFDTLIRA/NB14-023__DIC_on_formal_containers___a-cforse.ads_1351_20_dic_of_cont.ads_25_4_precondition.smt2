...
(define-fun dynamic_invariant1 ((temp___expr_1438 Int) (temp___is_init_1434 Bool) (temp___skip_constant_1435 Bool) (temp___do_toplevel_1436 Bool) (temp___do_typ_inv_1437 Bool)) Bool (=> (or (= temp___is_init_1434 true) (<= 1 2147483647)) (in_range2 temp___expr_1438)))
...
(define-fun default_initial_assumption ((temp___expr_1446 us_rep2) (temp___skip_top_level_1447 Bool)) Bool (=> (not (= temp___skip_top_level_1447 true)) (and (= (is_empty temp___expr_1446) true) (= (length2 temp___expr_1446) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___1461 Int)) (=> (and (in_range5 temp___1461) (= (iter_has_element result temp___1461) true)) (= (contains (model__ container1) (get1 result temp___1461)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(declare-const temp___2282 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___2282 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___2282)) no_element))
