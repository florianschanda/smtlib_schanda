...
(declare-const dst__split_fields1 unsigned_byte)
(declare-const dst__split_fields2 unsigned_byte)
(declare-const result Bool)
(declare-const result1 unsigned_byte)
(declare-const result2 unsigned_byte)
(declare-const dst__split_fields3 Bool)
(declare-const dst__split_fields4 unsigned_byte)
(declare-const dst__split_fields5 unsigned_byte)
(declare-const result3 Bool)
(declare-const result4 unsigned_byte)
(declare-const result5 unsigned_byte)
(declare-const dst__split_fields6 Bool)
(declare-const dst__split_fields7 unsigned_byte)
(declare-const dst__split_fields8 unsigned_byte)
(declare-const dst__split_fields9 Bool)
(declare-const dst__split_fields10 unsigned_byte)
(declare-const dst__split_fields11 unsigned_byte)
(declare-const dst__split_fields12 us_split_fields2)
(define-fun dst__split_fields13 () us_split_fields2 (mk___split_fields1 dst__split_fields6 (mk___rep (mk___split_fields dst__split_fields7 dst__split_fields8))))
(assert (= result dst__split_fields))
(assert (= result1 dst__split_fields1))
(assert (= result2 dst__split_fields2))
(assert (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) dst__split_fields3))
(assert (= dst__split_fields1 dst__split_fields4))
(assert (= dst__split_fields2 dst__split_fields5))
(assert (=> (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true) (= result3 dst__split_fields3)))
(assert (=> (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true) (= result4 dst__split_fields4)))
(assert (=> (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true) (= result5 dst__split_fields5)))
(assert (=> (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true) (= dst__split_fields3 dst__split_fields6)))
(assert (=> (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true) (= (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 src)) (mk___rep (mk___split_fields dst__split_fields7 dst__split_fields8)))))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true)) (= dst__split_fields13 (mk___split_fields1 dst__split_fields3 (mk___rep (mk___split_fields dst__split_fields4 dst__split_fields5))))))
...
(assert (= dst__split_fields12 dst__split_fields13))
(assert (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true))
(assert (not (= dst__split_fields9 true)))
(check-sat)
(exit)
