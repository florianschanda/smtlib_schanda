...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 1 10)) (in_range1 temp___expr_135)))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant (sf s) true false true) :pattern ((sf s)))))
...
(assert (not (= (sf (rec__f__r1__f1 (us_split_fields3 x))) 2)))
(check-sat)
(exit)
