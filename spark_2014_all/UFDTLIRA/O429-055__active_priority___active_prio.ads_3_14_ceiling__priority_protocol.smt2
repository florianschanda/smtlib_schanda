...
(declare-const us_self__compl3 integer)
(declare-const result us_split_fields__ref)
(declare-const p__split_fields1 us_split_fields)
(declare-const q__split_fields us_split_fields2)
(declare-const us_self__compl4 us_rep1)
(declare-const result1 us_split_fields__ref1)
(declare-const q__split_fields1 us_split_fields2)
(declare-const p__split_fields2 us_split_fields)
(declare-const us_self__compl5 us_rep)
