...
(assert (not (= (test_element (mk___rep l3__split_discrs l3__split_fields2) (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2))) 3) true)))
(check-sat)
(exit)
