...
(declare-const temp___672 us_rep)
...
(assert (and (= temp___672 (f 4)) (= temp___672 (mk___rep (mk___split_fields (of_rep 4) us_null_ext__) us_tag))))
(assert (not (not (= (is_empty (mk___rep1 v__split_discrs v__split_fields9)) true))))
(check-sat)
(exit)
