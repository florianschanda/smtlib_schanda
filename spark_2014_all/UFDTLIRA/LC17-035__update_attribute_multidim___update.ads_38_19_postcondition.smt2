...
(define-fun dynamic_invariant1 ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= 1 8)) (in_range1 temp___expr_138)))
(declare-sort map1 0)
...
(assert (forall ((temp___180 map1)) (forall ((temp___181 Int) (temp___182 Int) (temp___183 Int) (temp___184 Int)) (let ((temp___179 (temp___178 temp___180 temp___181 temp___182 temp___183 temp___184))) (forall ((temp___185 Int) (temp___186 Int) (temp___187 Int)) (ite (and (and (= temp___185 temp___181) (= temp___186 temp___182)) (= temp___187 temp___183)) (= (get temp___179 temp___185 temp___186 temp___187) (of_rep temp___184)) (= (get temp___179 temp___185 temp___186 temp___187) (get temp___180 temp___185 temp___186 temp___187))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 8 1 8 1 8 (temp___178 a i i 5 new_val) 1 8 1 8 1 8) true)))
(check-sat)
(exit)
