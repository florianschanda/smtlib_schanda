...
(assert (not (= 0 (to_rep (rec__record_equality__root__c (us_split_discrs2 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag))))))))
(check-sat)
(exit)
