...
(define-fun dynamic_invariant1 ((temp___expr_592 us_rep1) (temp___is_init_588 Bool) (temp___skip_constant_589 Bool) (temp___do_toplevel_590 Bool) (temp___do_typ_inv_591 Bool)) Bool (= (attr__constrained (rec__with_default__bad_nested_defaults1__non_init__e (us_split_fields1 temp___expr_592))) false))
(define-fun default_initial_assumption ((temp___expr_594 us_rep1) (temp___skip_top_level_595 Bool)) Bool (and (= (attr__constrained (rec__with_default__bad_nested_defaults1__non_init__e (us_split_fields1 temp___expr_594))) false) (= (to_rep1 (rec__with_default__bad_nested_defaults1__empty_rec__d (us_split_discrs1 (rec__with_default__bad_nested_defaults1__non_init__e (us_split_fields1 temp___expr_594))))) c)))
...
(define-fun default_initial_assumption1 ((temp___expr_585 us_rep) (temp___skip_top_level_586 Bool)) Bool (and (= (attr__constrained temp___expr_585) false) (= (to_rep1 (rec__with_default__bad_nested_defaults1__empty_rec__d (us_split_discrs1 temp___expr_585))) c)))
(assert (in_range c))
