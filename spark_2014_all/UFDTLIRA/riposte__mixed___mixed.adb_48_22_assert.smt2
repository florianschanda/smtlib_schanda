...
(assert (forall ((r us_rep)) (! (= (bool_eq r (id r)) true) :pattern ((id r)))))
(declare-const r us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant1 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2)) (in_range1 temp___expr_165)))
(declare-const x Bool)
(declare-const n Int)
(declare-const s__split_fields Bool)
(declare-const s__split_fields1 enum_t)
(declare-const s__split_fields2 integer)
(declare-const temp___180 Bool)
(declare-const temp___1801 enum_t)
(declare-const temp___1802 integer)
(declare-const result Bool)
(declare-const result1 enum_t)
(declare-const result2 integer)
(declare-const s__split_fields3 Bool)
(declare-const s__split_fields4 enum_t)
(declare-const s__split_fields5 integer)
(declare-const result3 Int)
(declare-const n1 Int)
(declare-const result4 Bool)
(declare-const x1 Bool)
(define-fun temp___1803 () us_rep (mk___rep (mk___split_fields temp___180 temp___1801 temp___1802)))
(assert (=> (<= (- 2147483648) 2147483647) (in_range n)))
(assert (and (= temp___1803 (id r)) (= (bool_eq r temp___1803) true)))
(assert (= result s__split_fields))
(assert (= result1 s__split_fields1))
(assert (= result2 s__split_fields2))
(assert (= temp___180 s__split_fields3))
(assert (= temp___1801 s__split_fields4))
(assert (= temp___1802 s__split_fields5))
(assert (= result3 n))
(assert (= n1 (to_rep s__split_fields5)))
(assert (= result4 x))
(assert (= x1 (ite (= n1 0) true false)))
(assert (not (= x1 true)))
(check-sat)
(exit)
