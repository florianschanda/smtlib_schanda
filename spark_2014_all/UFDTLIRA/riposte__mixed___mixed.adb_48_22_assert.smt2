...
(declare-const temp___155 Bool)
(declare-const temp___1551 enum_t)
(declare-const temp___1552 integer)
...
(assert (and (= (mk___rep (mk___split_fields temp___155 temp___1551 temp___1552)) (id r)) (= (bool_eq r (mk___rep (mk___split_fields temp___155 temp___1551 temp___1552))) true)))
(assert (= result s__split_fields))
(assert (= result1 s__split_fields1))
(assert (= result2 s__split_fields2))
(assert (= temp___155 s__split_fields3))
(assert (= temp___1551 s__split_fields4))
(assert (= temp___1552 s__split_fields5))
(assert (= result3 n))
