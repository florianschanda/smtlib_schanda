...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__cursors__l__list__capacity count_type)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) count_type (rec__cursors__l__list__capacity a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__cursors__l__list us_main_type)))))
(define-fun us_split_fields_List__projection ((a us_split_fields)) us_main_type (rec__cursors__l__list a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_discrs1 us_split_discrs) (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___2__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__cursors__l__list__capacity (us_split_discrs1 a))) (to_rep (rec__cursors__l__list__capacity (us_split_discrs1 b)))) (= (us_main_eq (rec__cursors__l__list (us_split_fields1 a)) (rec__cursors__l__list (us_split_fields1 b))) true)) true false))
...
(assert (< cursors__l__list__capacity__first__bit cursors__l__list__capacity__last__bit))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__cursors__l__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type (rec__cursors__l__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 a))) (to_rep (rec__cursors__l__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_195 us_rep1) (temp___skip_top_level_196 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_195))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__cursors__l__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_234 us_rep1) (temp___skip_top_level_235 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_234))) 0))
...
(define-fun dynamic_invariant1 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 1 2147483647)) (in_range2 temp___expr_239)))
...
(declare-const temp___443 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___443 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___443)) no_element))
