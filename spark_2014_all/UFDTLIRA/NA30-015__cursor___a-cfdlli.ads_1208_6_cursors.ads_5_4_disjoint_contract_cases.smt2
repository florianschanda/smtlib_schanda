...
(define-fun default_initial_assumption ((temp___expr_228 us_rep1) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_228))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__cursors__l__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_273 us_rep1) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___487 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___487)) no_element))
