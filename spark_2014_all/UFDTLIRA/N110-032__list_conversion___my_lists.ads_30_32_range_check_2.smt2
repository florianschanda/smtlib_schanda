...
(assert (and (= us3 100) (in_range 100)))
(assert (and (= us4 100) (in_range 100)))
(assert (and (= us5 100) (in_range 100)))
(assert (and (= us6 100) (in_range 100)))
(assert (and (= us7 100) (in_range 100)))
