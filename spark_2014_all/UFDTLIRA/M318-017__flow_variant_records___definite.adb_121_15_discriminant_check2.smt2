...
(declare-const temp___228 status)
(declare-const temp___2281 natural)
(declare-const temp___2282 natural)
(declare-const temp___2283 Bool)
(declare-const temp___2284 Bool)
...
(assert (not (= y1 0)))
(assert (not (= y1 1)))
(assert (= (to_rep x__split_discrs) r29b))
(assert (in_range2 r29b))
(assert (= (to_rep o) 2))
(assert (= o o1))
(assert (= temp___228 o1))
(assert (= rliteral temp___2281))
(assert (= dummy temp___2282))
(assert (= true temp___2283))
(assert (= true temp___2284))
(assert (= x__attr__constrained true))
(assert (not (= temp___228 x__split_discrs)))
(check-sat)
(exit)
