...
(assert (= body_elaborated1 (distinct 0 0)))
(assert (not (= (get1 us_tag1 (mk___rep (mk___split_fields (hide_ext__ (distinct 0 0) us_null_ext__)) us_tag1) body_elaborated1) true)))
(check-sat)
(exit)
