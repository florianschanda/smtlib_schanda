...
(declare-const extension_pkg__early_call__assume Bool)
(declare-const result Bool)
(declare-const body_elaborated1 Bool)
(declare-const result1 Bool)
(declare-const body_elaborated2 Bool)
(assert (= (mk_bool__ref result) (mk_bool__ref body_elaborated)))
(assert (= body_elaborated1 (of_int 0)))
(assert (not (= (get1 us_tag1 (mk___rep (mk___split_fields (hide_ext__ (of_int 0) us_null_ext__)) us_tag1) body_elaborated1) true)))
(check-sat)
(exit)
