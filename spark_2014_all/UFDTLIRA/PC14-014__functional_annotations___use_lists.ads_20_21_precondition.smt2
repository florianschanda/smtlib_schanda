...
(assert (and (= o6 (find l e no_element)) (ite (ite (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (length2 l) e) false) true false) (= (bool_eq1 o6 no_element) true) (and (and (and (= (has_key (positions l) o6) true) (= (get (model__ l) (get1 (positions l) o6)) e)) (=> (not (= (bool_eq1 no_element no_element) true)) (<= (get1 (positions l) no_element) (get1 (positions l) o6)))) (not (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (- (get1 (positions l) o6) 1) e) true))))))
(assert (= result6 (bool_eq1 o6 no_element)))
...
(assert (not (= (has_key o5 (cursor__content use_lists__my_find__result13)) true)))
(check-sat)
(exit)
