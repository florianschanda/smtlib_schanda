...
(assert (not (= (let ((temp___635 (f 4))) (let ((temp___634 (get (model__ (mk___rep1 v__split_discrs v__split_fields6)) 2))) (ite (= (attr__tag temp___634) (attr__tag temp___635)) (us_dispatch_eq temp___634 temp___635) false))) true)))
(check-sat)
(exit)
