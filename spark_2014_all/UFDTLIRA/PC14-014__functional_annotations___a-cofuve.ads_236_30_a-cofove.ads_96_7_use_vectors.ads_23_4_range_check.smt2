...
(assert (and (= o4 (last1 left)) (and (dynamic_property1 first1 last2 o4) (= o4 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o4) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o2 first) (in_range3 first))))
(assert (=> (< offset 0) (and (= o3 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o3 o2) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o1 lst1) (in_range3 lst1)))
(assert (and (= o (length right)) (and (in_range1 o) (<= (+ (- first 1) o) last))))
