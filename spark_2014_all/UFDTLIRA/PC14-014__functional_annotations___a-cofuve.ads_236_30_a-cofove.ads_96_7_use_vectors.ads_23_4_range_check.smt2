...
(assert (and (= o4 (last2 left)) (and (dynamic_property1 first1 last1 o4) (= o4 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o4) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o2 first) (in_range1 first))))
...
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o1 lst1) (in_range1 lst1)))
(assert (and (= o (length right)) (and (in_range3 o) (<= (+ (- first 1) o) last))))
