...
(assert (not (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6)))) true)))
(check-sat)
(exit)
