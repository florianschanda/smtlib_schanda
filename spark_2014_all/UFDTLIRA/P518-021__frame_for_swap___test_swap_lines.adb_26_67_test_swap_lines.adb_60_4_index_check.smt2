...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- c3 1))) (and (= (to_rep (get m2 5 i1)) (to_rep (get temp___232 7 i1))) (= (to_rep (get m2 7 i1)) (to_rep (get temp___233 5 i1))))))))
...
(assert (and (and (and (=> (<= 0 9) (in_range6 c9)) (=> (<= 0 2147483647) (in_range2 tmp9))) (forall ((temp___246 Int) (temp___247 Int)) (=> (and (and (<= 1 temp___246) (<= temp___246 10)) (and (<= 1 temp___247) (<= temp___247 10))) (=> (and (not (= 7 temp___246)) (not (= 5 temp___246))) (= (get m10 temp___246 temp___247) (get m9 temp___246 temp___247)))))) (and (<= 0 c9) (<= c9 9))))
(assert (<= (+ c9 1) i))
(assert (<= i 10))
(assert (not (<= 1 i)))
(check-sat)
