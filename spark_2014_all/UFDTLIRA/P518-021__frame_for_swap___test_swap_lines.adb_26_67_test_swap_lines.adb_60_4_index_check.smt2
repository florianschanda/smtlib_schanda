...
(assert (<= 0 c11))
(assert (<= c11 9))
(assert (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 c12)) (and (= (to_rep (get m12 5 i13)) (to_rep (get m11 7 i13))) (= (to_rep (get m12 7 i13)) (to_rep (get m11 5 i13)))))))
(assert (forall ((i13 Int)) (=> (and (<= (+ c12 1) i13) (<= i13 10)) (and (= (to_rep (get m12 5 i13)) (to_rep (get m11 5 i13))) (= (to_rep (get m12 7 i13)) (to_rep (get m11 7 i13)))))))
(assert (and (and (and (=> (<= 0 9) (in_range6 c12)) (forall ((temp___245 Int) (temp___246 Int)) (=> (and (and (<= 1 temp___245) (<= temp___245 10)) (and (<= 1 temp___246) (<= temp___246 10))) (=> (and (not (= 7 temp___245)) (not (= 5 temp___245))) (= (get m12 temp___245 temp___246) (get m11 temp___245 temp___246)))))) (=> (<= 0 2147483647) (in_range2 tmp12))) (and (<= 0 c12) (<= c12 9))))
(assert (<= (+ c12 1) i3))
(assert (<= i3 10))
(assert (not (<= 1 i3)))
(check-sat)
