...
(assert (forall ((obj us_rep)) (! (= (to_int1 (has_stored_area obj)) (to_int1 (has_stored_area1 us_tag1 obj))) :pattern ((has_stored_area1 us_tag1 obj)))))
...
(assert (forall ((attr__tag2 Int)) (forall ((obj us_rep)) (! (=> (= (has_stored_area1 (attr__tag obj) obj) true) (dynamic_invariant (get_stored_area1 attr__tag2 obj) true false true)) :pattern ((get_stored_area1 attr__tag2 obj))))))
...
(define-fun default_initial_assumption1 ((temp___expr_149 us_rep1) (temp___skip_top_level_150 Bool)) Bool (and (= (attr__tag1 temp___expr_149) us_tag1) (and (and (= (to_rep (rec__object__t__area1 (us_split_fields3 temp___expr_149))) (- 1)) (= (to_rep (rec__object__t__max_width1 (us_split_fields3 temp___expr_149))) (- 1))) (= (to_rep (rec__object__t__max_height1 (us_split_fields3 temp___expr_149))) (- 1)))))
