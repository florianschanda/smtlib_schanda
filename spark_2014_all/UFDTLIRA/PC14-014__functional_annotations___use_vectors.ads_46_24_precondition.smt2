...
(assert (= o11 n))
(assert (and (= o12 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o11)) (and (in_range5 o12) (= o12 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o11)))))
(assert (and (= us3 n) (dynamic_property3 first2 last3 n)))
(assert (= o10 n))
(assert (not (<= first3 o10)))
(check-sat)
(exit)
