...
(define-fun dynamic_invariant ((temp___expr_1203 Int) (temp___is_init_1199 Bool) (temp___skip_constant_1200 Bool) (temp___do_toplevel_1201 Bool) (temp___do_typ_inv_1202 Bool)) Bool (=> (or (= temp___is_init_1199 true) (<= 1 2147483647)) (in_range1 temp___expr_1203)))
...
(define-fun dynamic_invariant1 ((temp___expr_1210 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool) (temp___do_typ_inv_1209 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2147483647)) (in_range2 temp___expr_1210)))
...
(define-fun dynamic_invariant3 ((temp___expr_1217 Int) (temp___is_init_1213 Bool) (temp___skip_constant_1214 Bool) (temp___do_toplevel_1215 Bool) (temp___do_typ_inv_1216 Bool)) Bool (=> (or (= temp___is_init_1213 true) (<= 0 2147483647)) (in_range5 temp___expr_1217)))
