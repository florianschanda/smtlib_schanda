...
(define-fun dynamic_invariant ((temp___expr_1122 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 1 2147483647)) (in_range1 temp___expr_1122)))
...
(define-fun dynamic_invariant1 ((temp___expr_1128 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 2147483647)) (in_range2 temp___expr_1128)))
...
(define-fun dynamic_invariant3 ((temp___expr_1134 Int) (temp___is_init_1131 Bool) (temp___skip_constant_1132 Bool) (temp___do_toplevel_1133 Bool)) Bool (=> (or (= temp___is_init_1131 true) (<= 0 2147483647)) (in_range5 temp___expr_1134)))
