...
(assert (and (= temp___10151 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields6))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields6) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields6)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___10151 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields6)) 1))))))
...
(assert (not (not (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) true))))
(check-sat)
(exit)
