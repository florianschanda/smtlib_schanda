...
(define-fun o1 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (= o1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o1) 1)))))
...
(assert (= result1 true))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) true)))
(check-sat)
(exit)
