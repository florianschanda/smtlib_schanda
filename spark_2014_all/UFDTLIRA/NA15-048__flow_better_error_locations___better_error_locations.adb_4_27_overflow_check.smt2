...
(assert (forall ((a__state us_private)) (! (dynamic_invariant (return_state a__state) true false true) :pattern ((return_state a__state)))))
(declare-fun return_state1 (us_private) Int)
(declare-fun return_state__function_guard1 (Int us_private) Bool)
(assert (forall ((b__state us_private)) (! (dynamic_invariant (return_state1 b__state) true false true) :pattern ((return_state1 b__state)))))
