...
(assert (not (= (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) i) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i))))
(check-sat)
(exit)
