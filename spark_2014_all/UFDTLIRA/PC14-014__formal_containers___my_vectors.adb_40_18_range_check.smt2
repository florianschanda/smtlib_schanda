...
(define-fun l__split_fields16 () us_split_fields (mk___split_fields l__split_fields2))
...
(define-fun l__split_fields17 () us_split_fields (mk___split_fields l__split_fields1))
...
(assert (and (and (= (length (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1)) (+ (length (mk___rep l__split_discrs l__split_fields17)) 4)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields17)) (model__ (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1))) true)) (=> (< 0 4) (= (constant_range (model__ (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1)) (+ (last (model__ (mk___rep l__split_discrs l__split_fields17))) 1) (+ (last (model__ (mk___rep l__split_discrs l__split_fields17))) 4) 9) true))))
(assert (= result2 l__split_fields1))
(assert (= l__split_fields16 my_vectors__v__append__3__container__fields1))
(assert (and (= (length (mk___rep l__split_discrs my_vectors__v__delete_last__container__fields1)) (- (length (mk___rep l__split_discrs l__split_fields16)) 1)) (= (olt (model__ (mk___rep l__split_discrs my_vectors__v__delete_last__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields16))) true)))
