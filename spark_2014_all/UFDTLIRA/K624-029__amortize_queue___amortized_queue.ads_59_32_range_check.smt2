...
(assert (and (= o5 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o5) (<= o5 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o6 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o6) (<= o6 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o8 (+ o6 o5)))
(assert (= result2 (ite (= o8 o7) true false)))
(assert (=> (= result2 true) (and (= o4 (length m)) (and (in_range4 o4) (<= o4 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o4 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o2 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o2) (<= o2 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
