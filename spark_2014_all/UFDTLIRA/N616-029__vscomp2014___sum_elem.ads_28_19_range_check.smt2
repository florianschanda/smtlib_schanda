...
(define-fun dynamic_invariant ((temp___expr_361 us_rep) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool)) Bool (=> (not (= temp___skip_constant_359 true)) (in_range1 10 temp___expr_361)))
(define-fun default_initial_assumption ((temp___expr_363 us_rep) (temp___skip_top_level_364 Bool)) Bool (and (= (to_rep (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 temp___expr_363))) 10) (=> (not (= temp___skip_top_level_364 true)) (= (is_empty temp___expr_363) true))))
(declare-const p__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_229 Int) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (or (= temp___is_init_226 true) (<= 0 10001)) (in_range temp___expr_229)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 container))) 10001))
