...
(assert (not (= (let ((temp___585 (f 2))) (let ((temp___584 (get (model__ (mk___rep1 v__split_discrs v__split_fields4)) 2))) (ite (= (attr__tag temp___584) (attr__tag temp___585)) (us_dispatch_eq temp___584 temp___585) false))) true)))
(check-sat)
(exit)
