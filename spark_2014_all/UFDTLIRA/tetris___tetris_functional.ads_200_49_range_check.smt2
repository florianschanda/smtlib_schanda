...
(define-fun dynamic_invariant ((temp___expr_698 Int) (temp___is_init_694 Bool) (temp___skip_constant_695 Bool) (temp___do_toplevel_696 Bool) (temp___do_typ_inv_697 Bool)) Bool (=> (or (= temp___is_init_694 true) (<= 0 4)) (in_range4 temp___expr_698)))
...
(define-fun dynamic_invariant2 ((temp___expr_712 Int) (temp___is_init_708 Bool) (temp___skip_constant_709 Bool) (temp___do_toplevel_710 Bool) (temp___do_typ_inv_711 Bool)) Bool (=> (or (= temp___is_init_708 true) (<= 3 4)) (in_range5 temp___expr_712)))
...
(assert (= a 0))
(assert (not (in_range (- (to_rep (rec__tetris_functional__piece__x (us_split_fields1 p))) 1))))
(check-sat)
(exit)
