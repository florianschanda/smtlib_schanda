...
(define-fun temp___558 () us_rep (model__ l))
(assert (not (exists ((temp___557 Int)) (and (and (in_range4 temp___557) (= (iter_has_element temp___558 temp___557) true)) (= (get temp___558 temp___557) 0)))))
(check-sat)
(exit)
