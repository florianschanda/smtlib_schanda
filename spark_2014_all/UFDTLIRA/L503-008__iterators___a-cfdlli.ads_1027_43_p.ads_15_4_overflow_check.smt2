...
(define-fun dynamic_invariant1 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= 1 2147483647)) (in_range3 temp___expr_287)))
...
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__p__my_lists__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__p__my_lists__list__capacity target__split_discrs)) o2)))
