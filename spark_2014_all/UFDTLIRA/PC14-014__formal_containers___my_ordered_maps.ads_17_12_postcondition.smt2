...
(assert (< (to_rep (rec__my_ordered_maps__my_rec__f (us_split_fields1 x))) (to_rep (rec__my_ordered_maps__my_rec__f (us_split_fields1 y)))))
(assert (not (= my_ordered_maps__my_lt__result4 true)))
(check-sat)
(exit)
