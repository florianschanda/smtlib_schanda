...
(declare-const temp___6687 et1)
(declare-const temp___66871 et2)
...
(assert (= temp___6687 o1))
(assert (= temp___66871 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___6687 r__split_fields4))
(assert (= temp___66871 r__split_fields5))
