...
(assert (= result2 true))
(assert (and (= o6 (elements s)) (and (and (and (= (length o6) (length2 s)) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o6 temp___390) true)) (= (contains (model__ s) (get o6 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ s) item) true)) (and (< 0 (find o6 item)) (= (equivalent_elements (get o6 (find o6 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length2 s))) (and (= (find o6 (get o6 i1)) i1) (= (e_is_find o6 (get o6 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
