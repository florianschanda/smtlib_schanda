...
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant1 position true true true true) (and (<= 0 position) (<= position (last container)))) (dynamic_invariant3 (get container position) true false true true)) :pattern ((get container position))))))
(declare-const o Int)
...
(assert (and (= o7 (last left)) (and (in_range2 o7) (= o7 (+ (- 1) (length left))))))
(assert (= result (ite (<= lst o7) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o6 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o6 0) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o1 lst) (in_range3 lst)))
(assert (and (= o (length right)) (and (in_range1 o) (<= (+ (- 1) o) 2147483646))))
(assert (= o2 (+ (- 1) o)))
(assert (= o3 (- o2 o1)))
