...
(define-fun dynamic_invariant ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range2 temp___expr_295)))
...
(define-fun dynamic_invariant1 ((temp___expr_307 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= (- 1) 2147483646)) (in_range3 temp___expr_307)))
...
(define-fun default_initial_assumption ((temp___expr_314 us_rep) (temp___skip_top_level_315 Bool)) Bool (=> (not (= temp___skip_top_level_315 true)) (= (length temp___expr_314) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_301 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 0 255)) (in_range5 temp___expr_301)))
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant1 position true true true) (and (<= 0 position) (<= position (last container)))) (dynamic_invariant3 (get container position) true false true)) :pattern ((get container position))))))
(declare-const o Int)
...
(assert (= result true))
(assert (=> (< offset 0) (and (= o6 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o6 0) true false))))
(assert (=> (not (< offset 0)) (= result1 (of_int 1))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o1 lst) (in_range1 lst)))
(assert (and (= o (length right)) (and (in_range4 o) (<= (+ (- 1) o) 2147483646))))
(assert (= o2 (+ (- 1) o)))
(assert (= o3 (- o2 o1)))
