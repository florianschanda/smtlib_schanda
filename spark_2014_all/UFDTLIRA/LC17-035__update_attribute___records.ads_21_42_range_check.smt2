...
(define-fun dynamic_invariant1 ((temp___expr_185 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 1 10)) (in_range2 temp___expr_185)))
...
(assert (= temp___218 o3))
(assert (= temp___2181 o4))
(assert (= temp___2182 o5))
(assert (= temp___2183 o6))
...
(assert (= temp___218 r__split_fields4))
(assert (= temp___2181 r__split_fields5))
(assert (= temp___2182 r__split_fields6))
(assert (= temp___2183 r__split_fields7))
