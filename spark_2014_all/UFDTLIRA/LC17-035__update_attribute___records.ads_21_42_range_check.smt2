...
(define-fun dynamic_invariant1 ((temp___expr_213 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 10)) (in_range2 temp___expr_213)))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__types__rec__s1 (us_split_fields1 a))) (to_rep2 (rec__types__rec__s1 (us_split_fields1 b)))) (= (to_rep (rec__types__rec__s2 (us_split_fields1 a))) (to_rep (rec__types__rec__s2 (us_split_fields1 b))))) (= (to_rep1 (rec__types__rec__s3 (us_split_fields1 a))) (to_rep1 (rec__types__rec__s3 (us_split_fields1 b))))) (= (to_rep2 (rec__types__rec__s4 (us_split_fields1 a))) (to_rep2 (rec__types__rec__s4 (us_split_fields1 b))))) true false))
...
(assert (in_range2 new_data_2))
(assert (= (to_rep1 o1) new_data_2))
(assert (and (= o new_data) (in_range1 new_data)))
(assert (= (to_rep o2) o))
(assert (= r__split_fields o3))
(assert (= o2 o4))
(assert (= o1 o5))
(assert (= r__split_fields3 o6))
(assert (= temp___247 o3))
(assert (= temp___2471 o4))
(assert (= temp___2472 o5))
(assert (= temp___2473 o6))
...
(assert (= temp___247 r__split_fields4))
(assert (= temp___2471 r__split_fields5))
(assert (= temp___2472 r__split_fields6))
(assert (= temp___2473 r__split_fields7))
...
(assert (= (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14 r__split_fields15) (mk___split_fields r__split_fields4 r__split_fields5 r__split_fields6 r__split_fields7)))
(assert (= (to_rep1 o7) new_data_2))
(assert (not (in_range1 new_data)))
(check-sat)
(exit)
