...
(define-fun dynamic_invariant ((temp___expr_367 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= 1 2147483647)) (in_range2 temp___expr_367)))
...
(define-fun default_initial_assumption ((temp___expr_386 us_rep) (temp___skip_top_level_387 Bool)) Bool (=> (not (= temp___skip_top_level_387 true)) (= (length temp___expr_386) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_373 Int) (temp___is_init_370 Bool) (temp___skip_constant_371 Bool) (temp___do_toplevel_372 Bool)) Bool (=> (or (= temp___is_init_370 true) (<= 1 2147483647)) (in_range5 temp___expr_373)))
