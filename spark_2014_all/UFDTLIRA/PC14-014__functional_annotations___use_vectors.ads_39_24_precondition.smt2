...
(assert (= result3 true))
(assert (and (= us4 n) (dynamic_property2 first1 last3 n)))
(assert (= o12 n))
(assert (and (= o13 (get (model__ (mk___rep v2__split_discrs (us_split_fields__content v2__split_fields8))) o12)) (and (in_range3 o13) (= o13 (get (model__ (mk___rep v2__split_discrs (us_split_fields__content v2__split_fields8))) o12)))))
(assert (and (= us3 n) (dynamic_property2 first1 last3 n)))
(assert (= o11 n))
(assert (not (<= o11 (last2 (model__ v1)))))
(check-sat)
(exit)
