...
(define-fun default_initial_assumption ((temp___expr_237 us_rep) (temp___skip_top_level_238 Bool)) Bool (=> (not (= temp___skip_top_level_238 true)) (= (is_empty temp___expr_237) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 2147483647)) (in_range3 temp___expr_230)))
