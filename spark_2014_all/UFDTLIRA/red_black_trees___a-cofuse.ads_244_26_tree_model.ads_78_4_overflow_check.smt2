...
(define-fun default_initial_assumption ((temp___expr_274 us_rep) (temp___skip_top_level_275 Bool)) Bool (=> (not (= temp___skip_top_level_275 true)) (= (is_empty temp___expr_274) true)))
