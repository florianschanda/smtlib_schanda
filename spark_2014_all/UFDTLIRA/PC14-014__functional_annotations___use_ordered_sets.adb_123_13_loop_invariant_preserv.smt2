...
(declare-const e Int)
(assert (in_range3 e))
(assert (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) e)))))
(check-sat)
(exit)
