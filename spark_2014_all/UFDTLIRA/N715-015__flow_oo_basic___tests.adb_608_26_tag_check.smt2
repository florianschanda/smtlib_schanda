...
(assert (not (= g__attr__tag (attr__tag1 (of_base (mk___rep (mk___split_fields (hide_ext__1 (rec__foo__nice_widget_t__round (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__foo__widget_t__x1 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__foo__widget_t__y1 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))) (rec__ext__2 (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c)))))) (attr__tag2 (rec__tests__pair__b (us_split_fields7 c)))))))))
(check-sat)
(exit)
