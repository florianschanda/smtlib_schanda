...
(define-fun default_initial_assumption ((temp___expr_839 us_rep) (temp___skip_top_level_840 Bool)) Bool (=> (not (= temp___skip_top_level_840 true)) (= (is_empty temp___expr_839) true)))
...
(define-fun element_type__ref___9__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant1 ((temp___expr_831 Int) (temp___is_init_827 Bool) (temp___skip_constant_828 Bool) (temp___do_toplevel_829 Bool) (temp___do_typ_inv_830 Bool)) Bool (=> (or (= temp___is_init_827 true) (<= 0 2147483647)) (in_range3 temp___expr_831)))
