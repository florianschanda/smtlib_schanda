...
(define-fun default_initial_assumption ((temp___expr_777 us_rep) (temp___skip_top_level_778 Bool)) Bool (=> (not (= temp___skip_top_level_778 true)) (= (is_empty temp___expr_777) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_770 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool)) Bool (=> (or (= temp___is_init_767 true) (<= 0 2147483647)) (in_range3 temp___expr_770)))
