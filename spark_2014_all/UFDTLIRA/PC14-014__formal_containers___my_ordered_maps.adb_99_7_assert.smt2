...
(define-fun temp___10291 () us_rep3 (mk___rep2 (mk___split_fields2 temp___1029)))
...
(assert (and (= temp___10151 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields7))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields7) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields7)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___10151 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields7)) 1))))))
...
(assert (not (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) true)))
(assert (and (= temp___10291 (find1 (mk___rep l__split_discrs l__split_fields10) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2)))) (ite (ite (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) false) true false) (and (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) temp___10291) true)) (= (bool_eq3 temp___10291 no_element) true)) (and (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields10)) temp___10291) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) temp___10291) (find (keys (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))))) (= (equivalent_keys (key (mk___rep l__split_discrs l__split_fields10) temp___10291) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) true)))))
(assert (= result15 (mk___split_fields__ref2 c__split_fields5)))
(assert (= c__split_fields6 (mk___split_fields2 temp___1029)))
(assert (and (not (= (has_key1 (model__ (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) true)) (ite (ite (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) false) true false) (and (and (= (oeq1 (model__ (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields10))) true) (= (oeq2 (keys (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (keys (mk___rep l__split_discrs l__split_fields10))) true)) (= (oeq3 (positions (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (positions (mk___rep l__split_discrs l__split_fields10))) true)) (and (and (and (and (and (= (length (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields10)) 1)) (= (ole (model__ (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields10))) true)) (= (keys_included_except (model__ (mk___rep l__split_discrs l__split_fields10)) (model__ (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) true)) (= (range_equal (keys (mk___rep l__split_discrs l__split_fields10)) (keys (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) 1 (- (find (keys (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) 1)) true)) (= (range_shifted (keys (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (keys (mk___rep l__split_discrs l__split_fields10)) (find (keys (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) (length (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs my_ordered_maps__n__exclude__container__fields)) (positions (mk___rep l__split_discrs l__split_fields10)) (find (keys (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 (mk___split_fields1 rliteral2 rliteral2))) 1) true)))))
