...
(define-fun dynamic_invariant1 ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_396)))
...
(define-fun dynamic_invariant3 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 2147483647)) (in_range5 temp___expr_403)))
