...
(assert (not (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields2) 1 no_element) (previous (mk___rep l3__split_discrs l3__split_fields2) (last1 (mk___rep l3__split_discrs l3__split_fields2)))) true)))
(check-sat)
(exit)
