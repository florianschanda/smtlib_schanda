...
(assert (forall ((x command_t)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x command_t)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x unsigned_byte)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x unsigned_byte)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (to_rep1 (rec__records_prooffuncs__pair__a (us_split_fields1 b)))) (= (to_rep1 (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (to_rep1 (rec__records_prooffuncs__pair__b (us_split_fields1 b))))) true false))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (bool_eq (rec__records_prooffuncs__packet__data (us_split_fields3 a)) (rec__records_prooffuncs__packet__data (us_split_fields3 b))) true) (= (to_rep (rec__records_prooffuncs__packet__command (us_split_fields3 a))) (to_rep (rec__records_prooffuncs__packet__command (us_split_fields3 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 255)) (in_range2 temp___expr_207)))
