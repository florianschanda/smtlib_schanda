...
(assert (and (= o2 (length s2)) (and (in_range2 o2) (<= o2 (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs))))))
