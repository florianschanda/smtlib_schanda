...
(assert (and (= result (adminlogoncanstart state (mk___split_fields theadmin__split_fields theadmin__split_fields1) status)) (= (= result true) (and (and (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (= status 3)) (= (ispresent1 state) true)))))
(assert (not (= result true)))
(assert (and (= result1 (adminopcanstart state (mk___split_fields theadmin__split_fields theadmin__split_fields1) status)) (= (= result1 true) (and (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= status 3)) (= (ispresent1 state) true)))))
(assert (= result1 true))
(assert (not (= (adminopcanstart state (mk___split_fields theadmin__split_fields theadmin__split_fields1) status) true)))
(check-sat)
(exit)
