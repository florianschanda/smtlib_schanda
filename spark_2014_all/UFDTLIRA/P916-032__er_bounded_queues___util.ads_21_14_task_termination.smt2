...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (= (rec__util__p__flag (us_split_fields1 temp___expr_172)) (of_int 0)))
