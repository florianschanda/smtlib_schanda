...
(assert (= result2 true))
(assert (and (= o4 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
