...
(assert (not (= (let ((temp___652 (f 1))) (let ((temp___651 (get (model__ (mk___rep1 v__split_discrs v__split_fields7)) 3))) (ite (= (attr__tag temp___651) (attr__tag temp___652)) (us_dispatch_eq temp___651 temp___652) false))) true)))
(check-sat)
(exit)
