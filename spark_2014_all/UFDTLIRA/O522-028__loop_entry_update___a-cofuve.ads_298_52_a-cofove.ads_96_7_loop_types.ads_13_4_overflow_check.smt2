...
(define-fun dynamic_invariant ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 1 1000)) (in_range1 temp___expr_284)))
...
(define-fun dynamic_invariant1 ((temp___expr_291 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 2147483647)) (in_range2 temp___expr_291)))
...
(define-fun dynamic_invariant3 ((temp___expr_298 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool) (temp___do_typ_inv_297 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 0 1000)) (in_range5 temp___expr_298)))
