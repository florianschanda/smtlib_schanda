...
(assert (and (= temp___511 (model__ l)) (= (length temp___511) (length1 l))))
(assert (and (= o17 (iter_has_element temp___511 temp___510)) (= (= o17 true) (and (<= 1 temp___510) (<= temp___510 (last temp___511))))))
(assert (= (= o18 true) (in_range5 temp___510)))
(assert (= result15 (ite (= o18 true) o17 false)))
(assert (= (= o19 true) (let ((temp___513 (model__ l))) (exists ((temp___512 Int)) (and (and (in_range5 temp___512) (= (iter_has_element temp___513 temp___512) true)) (= (get temp___513 temp___512) 1))))))
(assert (and (= temp___507 (model__ l)) (= (length temp___507) (length1 l))))
(assert (not true))
(check-sat)
(exit)
