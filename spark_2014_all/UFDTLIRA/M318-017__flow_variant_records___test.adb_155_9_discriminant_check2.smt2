...
(declare-const temp___3231 integer)
(declare-const temp___3232 failure_reason)
(declare-const temp___3233 Bool)
(declare-const result Bool)
(declare-const y1 Bool)
(assert (= result y))
(assert (= y1 (distinct 0 0)))
(assert (= x__split_discrs r45b))
(assert (= (to_rep o) 2))
(assert (= dummy o1))
(assert (= o o2))
(assert (= (distinct 0 0) temp___323))
(assert (= temp___3231 o1))
(assert (= temp___3232 o2))
(assert (= true temp___3233))
(assert (= x__attr__constrained true))
(assert (not (= temp___323 x__split_discrs)))
(check-sat)
(exit)
