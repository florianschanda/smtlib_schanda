...
(assert (<= 1 e3))
(assert (<= e3 3))
(assert (= (length (mk___rep l1__split_discrs l1__split_fields6)) (- e4 1)))
(assert (and (=> (<= 1 3) (in_range8 e4)) (and (<= 1 e4) (<= e4 3))))
(assert (and (and (and (and (and (= (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (+ (length (mk___rep l1__split_discrs l1__split_fields6)) 1)) (= (get1 (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (last1 (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)))) (= (keys_included_except (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (positions (mk___rep l1__split_discrs l1__split_fields6)) (last1 (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true)) (= (ole1 (positions (mk___rep l1__split_discrs l1__split_fields6)) (positions (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true)) (= (get (model__ (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3)) (length (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) e4)) (= (ole (model__ (mk___rep l1__split_discrs l1__split_fields6)) (model__ (mk___rep l1__split_discrs formal_container__vdll__append__container__fields3))) true)))
(assert (= result21 (mk___split_fields__ref l1__split_fields6)))
(assert (= l1__split_fields7 formal_container__vdll__append__container__fields3))
(assert (not (= e4 3)))
(assert (= result22 (mk_int__ref e4)))
(assert (= e5 (+ e4 1)))
(assert (not (= (length (mk___rep l1__split_discrs l1__split_fields7)) (- e5 1))))
(check-sat)
(exit)
