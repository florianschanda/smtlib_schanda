...
(assert (= (valid_combination (mk___rep (mk___split_fields traffic_light__split_fields traffic_light__split_fields1 traffic_light__split_fields2 traffic_light__split_fields3 traffic_light__split_fields4))) true))
(assert (not (<= 97 97)))
(check-sat)
(exit)
