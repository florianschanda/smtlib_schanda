...
(assert (and (= result1 (has_key1 (positions s2) (mk___rep1 cu__split_fields2))) (= (= result1 true) (= (has_key1 (positions s2) (mk___rep1 cu__split_fields2)) true))))
(assert (= result1 true))
(define-fun temp___823 () us_rep3 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))
(declare-const temp___822 Int)
(assert (in_range5 temp___822))
(assert (= (iter_has_element temp___823 temp___822) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 temp___823 temp___822))) true)))
(check-sat)
(exit)
