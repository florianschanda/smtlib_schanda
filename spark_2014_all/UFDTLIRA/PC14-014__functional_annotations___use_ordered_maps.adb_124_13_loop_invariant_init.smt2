...
(assert (= (iter_has_element (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___779) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___779))) true)))
(check-sat)
(exit)
