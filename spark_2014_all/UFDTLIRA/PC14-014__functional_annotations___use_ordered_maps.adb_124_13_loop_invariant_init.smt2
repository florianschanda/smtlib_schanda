...
(assert (= result1 true))
(define-fun temp___780 () us_rep3 (keys (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))
(declare-const temp___779 Int)
(assert (in_range5 temp___779))
(assert (= (iter_has_element temp___780 temp___779) true))
(assert (not (= (prop__ (get (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 temp___780 temp___779))) true)))
(check-sat)
(exit)
