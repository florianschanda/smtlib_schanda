...
(declare-const temp___579 integer)
(declare-const temp___5791 us_private)
(declare-const temp___5792 Int)
...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___579 temp___5791) temp___5792) (f 1)) (and (and (= (of_rep1 1) temp___579) (= us_null_ext__ temp___5791)) (= us_tag temp___5792))))
(assert (not (<= 1 (last (model__ (mk___rep v__split_discrs v__split_fields4))))))
(check-sat)
(exit)
