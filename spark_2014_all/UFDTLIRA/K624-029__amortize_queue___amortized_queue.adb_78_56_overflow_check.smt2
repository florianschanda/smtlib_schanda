...
(assert (and (= o9 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o8)) (and (in_range4 o9) (= o9 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o8)))))
