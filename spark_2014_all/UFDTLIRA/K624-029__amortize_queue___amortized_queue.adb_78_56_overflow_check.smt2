...
(assert (= result2 true))
(assert (and (= o8 i) (in_range2 i)))
(assert (and (= o9 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o8)) (and (in_range5 o9) (= o9 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o8)))))
(assert (and (= o4 (last (model__ (mk___rep front__split_discrs front__split_fields3)))) (and (in_range3 o4) (= o4 (last (model__ (mk___rep front__split_discrs front__split_fields3)))))))
(assert (= o5 (+ o4 idx2)))
