...
(assert (and (= o17 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o16)) (and (in_range5 o17) (= o17 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o16)))))
(assert (and (= o10 (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3))))) (and (in_range3 o10) (= o10 (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3))))))))
(assert (= o11 (+ o10 idx2)))
