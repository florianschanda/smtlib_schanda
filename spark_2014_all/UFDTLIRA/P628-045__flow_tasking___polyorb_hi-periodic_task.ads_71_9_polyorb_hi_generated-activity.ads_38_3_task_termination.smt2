...
(declare-fun user_eq2 (error_kind error_kind) Bool)
(declare-const dummy2 error_kind)
...
(define-fun dynamic_invariant ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 0 1)) (in_range temp___expr_225)))
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (rmaaadl_task2_job us_void_param) true false true true) :pattern ((rmaaadl_task2_job us_void_param)))))
...
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_358 Int) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool) (temp___do_typ_inv_357 Bool)) Bool (=> (or (= temp___is_init_354 true) (<= 0 97)) (in_range1 temp___expr_358)))
