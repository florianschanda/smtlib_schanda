...
(assert (=> (< 2 n2) (and (and (and (=> (<= 0 2147483647) (in_range1 a22)) (in_range1 n22)) (=> (<= 0 2147483647) (in_range1 b22))) (=> (<= 0 2147483647) (in_range1 i9)))))
(assert (=> (< 2 n2) (= result13 (mk_int__ref temp___1711))))
(assert (=> (< 2 n2) (= temp___1712 n22)))
(assert (=> (< 2 n2) (and (= o5 (+ a22 b22)) (in_range (+ a22 b22)))))
(assert (=> (< 2 n2) (= result14 (mk_int__ref a22))))
(assert (=> (< 2 n2) (= a23 o5)))
(assert (=> (< 2 n2) (and (= o6 (- a23 b22)) (in_range (- a23 b22)))))
(assert (=> (< 2 n2) (and (= o7 o6) (in_range1 o6))))
(assert (=> (< 2 n2) (= result15 (mk_int__ref b22))))
(assert (=> (< 2 n2) (= b23 o7)))
(assert (=> (< 2 n2) (and (= o8 (- n22 1)) (in_range1 (- n22 1)))))
(assert (=> (< 2 n2) (= result16 (mk_int__ref n22))))
(assert (=> (< 2 n2) (= n23 o8)))
(assert (=> (< 2 n2) (and (= o9 (+ i9 1)) (in_range (+ i9 1)))))
