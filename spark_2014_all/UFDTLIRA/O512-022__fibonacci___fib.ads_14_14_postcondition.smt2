...
(assert (= i1 2))
(assert (=> (< 2 n1) (and (and (= temp___165 i1) (and (= temp___164 b11) (and (= temp___163 n1) (and (= temp___162 a11) (and (= 0 temp___166) (and (and (and (and (= a12 (fibonacci i2)) (= b12 (fibonacci (- i2 1)))) (<= i2 23)) (= (- (+ n12 i2) 2) copy_n11)) (and (and (and (and (and (=> (<= 0 2147483647) (in_range2 a12)) (in_range2 n12)) (=> (<= 0 2147483647) (in_range2 b12))) (=> (<= 0 2147483647) (in_range2 i2))) (< 2 n12)) (and (and (= temp___1661 result8) (= temp___1662 n12)) (and (and (and (= o3 (+ a12 b12)) (in_range1 (+ a12 b12))) (and (= result9 (mk_int__ref a12)) (= a13 o3))) (and (and (and (and (= o4 (- a13 b12)) (in_range1 (- a13 b12))) (and (= o5 o4) (in_range2 o4))) (and (= result10 (mk_int__ref b12)) (= b13 o5))) (and (and (and (= o6 (- n12 1)) (in_range2 (- n12 1))) (and (= result11 (mk_int__ref n12)) (= n13 o6))) (and (and (and (= o7 (+ i2 1)) (in_range1 (+ i2 1))) (and (= result12 (mk_int__ref i2)) (= i3 o7))) (not (< 2 n13)))))))))))))) (and (and (= i6 (mk_int__ref i3)) (and (= b16 (mk_int__ref b13)) (and (= a16 (mk_int__ref a13)) (= n16 (mk_int__ref n13))))) (and (= i7 i3) (and (= b17 b13) (and (= a17 a13) (= n17 n13))))))))
(assert (=> (< 2 n1) (= i8 i6)))
(assert (=> (< 2 n1) (= b18 b16)))
(assert (=> (< 2 n1) (= a18 a16)))
(assert (=> (< 2 n1) (= n18 n16)))
...
(assert (=> (< 2 n1) (= a19 a17)))
(assert (=> (< 2 n1) (= n19 n17)))
(assert (=> (not (< 2 n1)) (= i8 (mk_int__ref i1))))
(assert (=> (not (< 2 n1)) (= b18 (mk_int__ref b11))))
(assert (=> (not (< 2 n1)) (= a18 (mk_int__ref a11))))
(assert (=> (not (< 2 n1)) (= n18 (mk_int__ref n1))))
(assert (=> (not (< 2 n1)) (= i9 i1)))
(assert (=> (not (< 2 n1)) (= b19 b11)))
(assert (=> (not (< 2 n1)) (= a19 a11)))
(assert (=> (not (< 2 n1)) (= n19 n11)))
(assert (= result13 i8))
(assert (= i10 2))
(assert (=> (< 2 n2) (and (and (= temp___170 i10) (and (= temp___169 b21) (and (= temp___168 n2) (and (= temp___167 a21) (and (= 0 temp___171) (and (and (and (and (= a22 (fibonacci i11)) (= b22 (fibonacci (- i11 1)))) (<= i11 23)) (= (- (+ n22 i11) 2) copy_n21)) (and (and (and (and (and (=> (<= 0 2147483647) (in_range2 a22)) (in_range2 n22)) (=> (<= 0 2147483647) (in_range2 b22))) (=> (<= 0 2147483647) (in_range2 i11))) (< 2 n22)) (and (and (= result15 (mk_int__ref temp___1711)) (= temp___1712 n22)) (and (and (and (= o11 (+ a22 b22)) (in_range1 (+ a22 b22))) (and (= result16 (mk_int__ref a22)) (= a23 o11))) (and (and (and (and (= o12 (- a23 b22)) (in_range1 (- a23 b22))) (and (= o13 o12) (in_range2 o12))) (and (= result17 (mk_int__ref b22)) (= b23 o13))) (and (and (and (= o14 (- n22 1)) (in_range2 (- n22 1))) (and (= result18 (mk_int__ref n22)) (= n23 o14))) (and (and (and (= o15 (+ i11 1)) (in_range1 (+ i11 1))) (and (= result19 (mk_int__ref i11)) (= i12 o15))) (not (< 2 n23)))))))))))))) (and (and (= i17 (mk_int__ref i12)) (and (= b28 (mk_int__ref b23)) (and (= a28 (mk_int__ref a23)) (= n28 (mk_int__ref n23))))) (and (= i18 i12) (and (= b29 b23) (and (= a29 a23) (= n29 n23))))))))
(assert (=> (< 2 n2) (= i19 i17)))
(assert (=> (< 2 n2) (= b210 b28)))
(assert (=> (< 2 n2) (= a210 a28)))
(assert (=> (< 2 n2) (= n210 n28)))
(assert (=> (< 2 n2) (= i20 i18)))
(assert (=> (< 2 n2) (= b211 b29)))
(assert (=> (< 2 n2) (= a211 a29)))
(assert (=> (< 2 n2) (= n211 n29)))
(assert (=> (not (< 2 n2)) (= i19 (mk_int__ref i10))))
(assert (=> (not (< 2 n2)) (= b210 (mk_int__ref b21))))
(assert (=> (not (< 2 n2)) (= a210 (mk_int__ref a21))))
(assert (=> (not (< 2 n2)) (= n210 (mk_int__ref n2))))
(assert (=> (not (< 2 n2)) (= i20 i10)))
(assert (=> (not (< 2 n2)) (= b211 b21)))
(assert (=> (not (< 2 n2)) (= a211 a21)))
(assert (=> (not (< 2 n2)) (= n211 n21)))
(assert (=> (< l1 (int__content a18)) (= result20 (mk_int__ref l1))))
(assert (=> (< l1 (int__content a18)) (= l11 (int__content a18))))
(assert (=> (< l1 (int__content a18)) (= l13 (mk_int__ref l11))))
(assert (=> (< l1 (int__content a18)) (= l14 l11)))
(assert (=> (not (< l1 (int__content a18))) (= result21 (mk_int__ref l1))))
(assert (=> (not (< l1 (int__content a18))) (= l12 0)))
(assert (=> (not (< l1 (int__content a18))) (= l13 (mk_int__ref l12))))
(assert (=> (not (< l1 (int__content a18))) (= l14 l12)))
(assert (=> (< l2 (int__content a210)) (= result22 (mk_int__ref l2))))
(assert (=> (< l2 (int__content a210)) (= l21 (int__content a210))))
(assert (=> (< l2 (int__content a210)) (= l23 (mk_int__ref l21))))
(assert (=> (< l2 (int__content a210)) (= l24 l21)))
(assert (=> (not (< l2 (int__content a210))) (= result23 (mk_int__ref l2))))
(assert (=> (not (< l2 (int__content a210))) (= l22 0)))
(assert (=> (not (< l2 (int__content a210))) (= l23 (mk_int__ref l22))))
(assert (=> (not (< l2 (int__content a210))) (= l24 l22)))
