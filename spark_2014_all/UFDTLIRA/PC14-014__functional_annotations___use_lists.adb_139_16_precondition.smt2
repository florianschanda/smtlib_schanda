...
(assert (and (= o18 (get1 o17 (mk___rep1 (mk___split_fields1 current__split_fields2)))) (and (in_range4 o18) (=> (= (of_int 0) true) (and (= o18 (w_get o17 (witness o17 (mk___rep1 (mk___split_fields1 current__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key o17 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 current__split_fields2))) true) (= (witness o17 (mk___rep1 (mk___split_fields1 current__split_fields2))) (witness o17 k))))))))))
(assert (= o19 (- o18 1)))
(assert (= o20 (ite (<= i o19) true false)))
(assert (and (= o15 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o15 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o15 i4) true) (and (and (<= 1 (get1 o15 i4)) (<= (get1 o15 i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key o15 j) true) (=> (= (get1 o15 i4) (get1 o15 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (not (= (has_key o15 fst) true)))
(check-sat)
(exit)
