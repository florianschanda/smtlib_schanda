...
(define-fun dynamic_invariant ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range2 temp___expr_412)))
...
(define-fun default_initial_assumption ((temp___expr_420 us_rep2) (temp___skip_top_level_421 Bool)) Bool (=> (not (= temp___skip_top_level_421 true)) (and (= (is_empty temp___expr_420) true) (= (length temp___expr_420) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant2 result true false true true))) :pattern ((length1 container1)))))
(assert (forall ((attr__tag Int)) (forall ((container1 us_rep)) (! (dynamic_invariant2 (length2 attr__tag container1) true false true true) :pattern ((length2 attr__tag container1))))))
...
(define-fun e_bigger_than_range ((container1 us_rep3) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get1 container1 i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep3 Int Int Int) Bool)
(define-fun e_smaller_than_range ((container1 us_rep3) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get1 container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep3 Int Int Int) Bool)
(define-fun e_is_find ((container1 us_rep3) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length3 container1)) (e_smaller_than_range container1 (+ position 1) (length3 container1) item) (distinct 1 0))))
...
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant2 result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length1 container1)) (forall ((temp___435 Int)) (=> (and (in_range6 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container1) (get1 result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (forall ((container1 us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container1 e) true)) (= (equivalent_elements e item) true))) (= (contains container1 item) true)))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant2 (length4 container1) true false true true) :pattern ((length4 container1)))))
(assert (forall ((container1 us_rep4)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item Int)) (not (and (in_range5 item) (= (contains container1 item) true))))) (= (= result true) (= (length4 container1) 0)))) :pattern ((is_empty1 container1)))))
...
(assert (forall ((container1 us_rep3)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true true))) :pattern ((length3 container1)))))
...
(assert (forall ((container1 us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant6 (get1 container1 position) true false true true)) :pattern ((get1 container1 position))))))
...
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant2 (length container1) true false true true) :pattern ((length container1)))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant (w_get container1 witness1) true false true true)) :pattern ((w_get container1 witness1))))))
(declare-const position__split_fields count_type)
(declare-const o count_type)
(declare-const o1 count_type)
(declare-const temp___654 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___654 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___654)) no_element))
