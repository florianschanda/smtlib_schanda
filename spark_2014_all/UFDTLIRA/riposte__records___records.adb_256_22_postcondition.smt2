...
(declare-const temp___342 Bool)
(declare-const temp___3421 unsigned_byte)
(declare-const temp___3422 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___342 o5))
(assert (= temp___3421 o6))
(assert (= temp___3422 o7))
...
(assert (= x__split_fields3 (mk___split_fields1 temp___342 (mk___rep (mk___split_fields temp___3421 temp___3422)))))
...
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= temp___345 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15))))))
(assert (= result2 (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___345)))
