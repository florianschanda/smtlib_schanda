...
(assert (not (= (bool_eq3 (find (mk___rep l3__split_discrs l3__split_fields4) 4 no_element) (next (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4)))) true)))
(check-sat)
(exit)
