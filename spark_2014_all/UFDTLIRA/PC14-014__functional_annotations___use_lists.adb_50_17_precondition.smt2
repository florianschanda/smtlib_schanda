...
(assert (= result2 true))
(assert (and (= o6 n) (in_range3 n)))
(assert (and (= o5 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o5) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= 1 o6)))
(check-sat)
(exit)
