...
(define-fun dynamic_invariant1 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 2147483647)) (in_range3 temp___expr_377)))
...
(define-fun dynamic_invariant3 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range temp___expr_213)))
...
(define-fun dynamic_invariant5 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 0 2147483647)) (in_range6 temp___expr_399)))
(assert (forall ((container1 us_rep2)) (! (let ((result (length container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_393)))
(assert (forall ((container1 us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant6 (get container1 position) true false true)) :pattern ((get container1 position))))))
