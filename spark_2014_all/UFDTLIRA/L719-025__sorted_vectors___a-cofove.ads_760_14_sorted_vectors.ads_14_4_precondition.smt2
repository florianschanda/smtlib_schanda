...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__sorted_vectors__my_vectors__vector__capacity (us_split_discrs1 container1))) 100))
