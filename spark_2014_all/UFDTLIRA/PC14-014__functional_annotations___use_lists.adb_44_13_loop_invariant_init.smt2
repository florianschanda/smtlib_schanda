...
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields2)) 1)))
(assert (not (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n)) true)))
(check-sat)
(exit)
