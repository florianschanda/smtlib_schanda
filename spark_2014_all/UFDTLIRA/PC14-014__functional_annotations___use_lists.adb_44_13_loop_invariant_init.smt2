...
(assert (<= 1 n3))
(assert (<= n3 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1)))
(assert (not (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n3)) true)))
(check-sat)
(exit)
