...
(declare-fun temp_____aggregate_def_185 (map1 Int Int Int Int) map1)
(assert (forall ((temp___187 map1)) (forall ((temp___188 Int) (temp___189 Int) (temp___190 Int) (temp___191 Int)) (let ((temp___186 (temp_____aggregate_def_185 temp___187 temp___188 temp___189 temp___190 temp___191))) (=> (and (and (and (dynamic_invariant1 temp___188 true true true true) (dynamic_invariant1 temp___189 true true true true)) (dynamic_invariant1 temp___190 true true true true)) (dynamic_invariant temp___191 true true true true)) (forall ((temp___192 Int) (temp___193 Int) (temp___194 Int)) (ite (and (and (= temp___192 temp___188) (= temp___193 temp___189)) (= temp___194 temp___190)) (= (to_rep (get temp___186 temp___192 temp___193 temp___194)) temp___191) (= (get temp___186 temp___192 temp___193 temp___194) (get temp___187 temp___192 temp___193 temp___194)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 8 1 8 1 8 (temp_____aggregate_def_185 a i i i new_val) 1 8 1 8 1 8) true)))
(check-sat)
(exit)
