...
(define-fun default_initial_assumption ((temp___expr_211 us_rep2) (temp___skip_top_level_212 Bool)) Bool (= (attr__tag2 temp___expr_211) us_tag2))
...
(assert true)
(assert true)
(assert (forall ((x us_rep2)) (! (= (ite (is_max x) 1 0) (ite (is_max1 us_tag2 x) 1 0)) :pattern ((is_max1 us_tag2 x)))))
...
(define-fun default_initial_assumption1 ((temp___expr_186 us_rep1) (temp___skip_top_level_187 Bool)) Bool (= (attr__tag1 temp___expr_186) us_tag1))
...
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (! (= (ite (is_max (of_base1 (to_base x))) 1 0) (ite (is_max3 us_tag2 x) 1 0)) :pattern ((is_max3 us_tag2 x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (ite (is_max (of_base1 x)) 1 0) (ite (is_max5 us_tag2 x) 1 0)) :pattern ((is_max5 us_tag2 x)))))
(assert (forall ((x us_rep)) (! (= (ite (is_max2 (of_base x)) 1 0) (ite (is_max5 us_tag1 x) 1 0)) :pattern ((is_max5 us_tag1 x)))))
