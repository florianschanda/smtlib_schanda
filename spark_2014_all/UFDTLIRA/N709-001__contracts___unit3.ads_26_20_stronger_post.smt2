...
(define-fun default_initial_assumption ((temp___expr_184 us_rep2) (temp___skip_top_level_185 Bool)) Bool (= (attr__tag2 temp___expr_184) us_tag2))
...
(assert true)
(assert true)
(assert (forall ((x us_rep2)) (! (= (to_int1 (is_max x)) (to_int1 (is_max1 us_tag2 x))) :pattern ((is_max1 us_tag2 x)))))
(assert (forall ((x us_rep2)) (! (= (= (is_max x) true) (or (= (is_max2 (of_base (to_base1 x))) true) (= (to_rep (rec__unit3__t3__c3 (us_split_fields5 x))) 2147483647))) :pattern ((is_max x)))))
(declare-fun next (us_rep2) us_rep2)
(declare-fun next__function_guard (us_rep2 us_rep2) Bool)
(declare-fun next1 (Int us_rep2) us_rep2)
(declare-fun next__function_guard1 (us_rep2 Int us_rep2) Bool)
...
(assert (forall ((x us_rep2)) (! (= (next x) (next1 us_tag2 x)) :pattern ((next1 us_tag2 x)))))
(define-fun default_initial_assumption1 ((temp___expr_161 us_rep1) (temp___skip_top_level_162 Bool)) Bool (= (attr__tag1 temp___expr_161) us_tag1))
...
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (! (= (to_int1 (is_max (of_base1 (to_base x)))) (to_int1 (is_max3 us_tag2 x))) :pattern ((is_max3 us_tag2 x)))))
(assert (forall ((x us_rep1)) (! (= (to_int1 (is_max2 x)) (to_int1 (is_max3 us_tag1 x))) :pattern ((is_max3 us_tag1 x)))))
(assert (forall ((x us_rep1)) (! (= (= (is_max2 x) true) (or (= (is_max4 (to_base x)) true) (= (to_rep (rec__unit2__t2__c2 (us_split_fields3 x))) 2147483647))) :pattern ((is_max2 x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (to_int1 (is_max (of_base1 x))) (to_int1 (is_max5 us_tag2 x))) :pattern ((is_max5 us_tag2 x)))))
(assert (forall ((x us_rep)) (! (= (to_int1 (is_max2 (of_base x))) (to_int1 (is_max5 us_tag1 x))) :pattern ((is_max5 us_tag1 x)))))
...
(declare-const x__split_fields11 integer)
(declare-const x__split_fields12 us_private)
(assert (not (= (is_max (mk___rep2 (mk___split_fields2 x__split_fields x__split_fields1 x__split_fields2 x__split_fields3) x__attr__tag)) true)))
(assert (and (= (to_rep x__split_fields5) (+ (to_rep x__split_fields1) 1)) (and (= (to_rep x__split_fields6) (+ (to_rep x__split_fields2) 1)) (= (to_rep x__split_fields4) (+ (to_rep x__split_fields) 1)))))
(assert (not (= (to_rep x__split_fields5) (+ (to_rep x__split_fields1) 1))))
(check-sat)
(exit)
