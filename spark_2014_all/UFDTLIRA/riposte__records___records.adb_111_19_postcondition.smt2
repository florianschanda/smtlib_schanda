...
(declare-const records__is_valid_b__result Bool)
(declare-const o unsigned_byte)
(declare-const o1 unsigned_byte)
(declare-const o2 unsigned_byte)
(declare-const o3 unsigned_byte)
(declare-const temp___311 unsigned_byte)
(declare-const temp___3111 unsigned_byte)
...
(declare-const records__is_valid_b__result1 Bool)
(declare-const records__is_valid_b__result2 Bool)
(declare-const records__is_valid_b__result3 Bool)
(declare-const records__is_valid_b__result4 Bool)
(declare-const records__is_valid_b__result5 Bool)
(declare-const result1 Bool)
(assert (= (to_rep o) 0))
(assert (= (to_rep o1) 0))
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___311 o2))
(assert (= temp___3111 o3))
(assert (= (mk___rep (mk___split_fields temp___311 temp___3111)) null_pair))
...
(assert (=> (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true) (= o10 true)))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= (to_rep o4) 0)))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= (to_rep o5) 0)))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= o5 o6)))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= o4 o7)))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= o8 o6)))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= o9 o7)))
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= o10 (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 a)) (mk___rep (mk___split_fields o8 o9))))))
(assert (= result records__is_valid_b__result))
(assert (= records__is_valid_b__result1 o10))
(assert (= (mk_bool__ref records__is_valid_b__result4) (mk_bool__ref records__is_valid_b__result2)))
...
(assert (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)))
(assert (not (= (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 a)) null_pair) true)))
(check-sat)
(exit)
