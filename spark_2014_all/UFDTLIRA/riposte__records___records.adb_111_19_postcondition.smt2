...
(assert (= records__is_valid_b__result1 (ite (or (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true) (= (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 a)) (mk___rep (mk___split_fields rliteral rliteral))) true)) true false)))
...
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 a)) null_pair) true)))
(assert (not (= records__is_valid_b__result4 true)))
(check-sat)
(exit)
