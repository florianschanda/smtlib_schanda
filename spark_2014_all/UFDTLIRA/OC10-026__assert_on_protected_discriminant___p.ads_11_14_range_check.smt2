...
(define-fun dynamic_invariant ((temp___expr_176 us_rep1) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (not (= temp___skip_constant_174 true)) (in_range2 (- 1) (to_base temp___expr_176))))
(define-fun default_initial_assumption ((temp___expr_178 us_rep1) (temp___skip_top_level_179 Bool)) Bool (and (= (to_rep (rec__p__pt__j (us_split_discrs2 temp___expr_178))) (- 1)) (= (to_rep1 (rec__p__pt__x1 (us_split_fields3 temp___expr_178))) (zero Tuple0))))
