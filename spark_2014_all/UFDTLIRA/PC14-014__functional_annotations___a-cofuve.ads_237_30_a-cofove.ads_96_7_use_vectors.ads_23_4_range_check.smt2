...
(assert (and (= o2 (last2 left)) (and (dynamic_property1 first1 last1 o2) (= o2 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o2) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o first) (in_range1 first))))
(assert (=> (< offset 0) (and (= o1 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o1 o) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (not (in_range1 lst1)))
(check-sat)
(exit)
