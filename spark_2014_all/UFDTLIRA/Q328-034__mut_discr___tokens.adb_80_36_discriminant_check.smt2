...
(define-fun dynamic_invariant ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 200)) (in_range1 temp___expr_194)))
...
(declare-fun user_eq3 (instruction instruction) Bool)
(declare-const dummy3 instruction)
...
(declare-fun to_rep1 (instruction) Int)
(declare-fun of_rep1 (Int) instruction)
(assert (forall ((x instruction)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x instruction)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 a))) (to_rep3 (rec__tokens__token__kind (us_split_discrs1 b)))) (and (and (=> (tokens__token__val__pred a) (= (bool_eq (rec__tokens__token__val (us_split_fields3 a)) (rec__tokens__token__val (us_split_fields3 b))) true)) (=> (tokens__token__op__pred a) (= (to_rep2 (rec__tokens__token__op (us_split_fields3 a))) (to_rep2 (rec__tokens__token__op (us_split_fields3 b)))))) (=> (tokens__token__instr__pred a) (= (to_rep1 (rec__tokens__token__instr (us_split_fields3 a))) (to_rep1 (rec__tokens__token__instr (us_split_fields3 b))))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 2)) (in_range3 temp___expr_177)))
