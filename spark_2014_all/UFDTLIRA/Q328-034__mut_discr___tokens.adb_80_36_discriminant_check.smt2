...
(define-fun dynamic_invariant ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 200)) (in_range2 temp___expr_168)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 a))) (to_rep3 (rec__tokens__token__kind (us_split_discrs1 b)))) (=> (tokens__token__val__pred a) (= (bool_eq (rec__tokens__token__val (us_split_fields3 a)) (rec__tokens__token__val (us_split_fields3 b))) true))) (=> (tokens__token__op__pred a) (= (to_rep2 (rec__tokens__token__op (us_split_fields3 a))) (to_rep2 (rec__tokens__token__op (us_split_fields3 b)))))) (=> (tokens__token__instr__pred a) (= (to_rep (rec__tokens__token__instr (us_split_fields3 a))) (to_rep (rec__tokens__token__instr (us_split_fields3 b)))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_193 us_rep1) (temp___skip_top_level_194 Bool)) Bool (and (= (attr__constrained temp___expr_193) false) (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 temp___expr_193))) 0)))
(declare-const t us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_185 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 0 2)) (in_range5 temp___expr_185)))
(define-fun dynamic_invariant3 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 2)) (in_range1 temp___expr_153)))
(define-fun dynamic_invariant4 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 3)) (in_range4 temp___expr_177)))
