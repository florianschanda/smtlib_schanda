...
(assert (forall ((x instruction)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x instruction)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 200)) (in_range2 temp___expr_194)))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__types__value__e (us_split_fields1 a))) (to_rep1 (rec__types__value__e (us_split_fields1 b)))) true false))
...
(assert (forall ((stack__last Int)) (! (=> (dynamic_invariant stack__last true true true true) (dynamic_invariant1 (size stack__last) true false true true)) :pattern ((size stack__last)))))
(assert (forall ((stack__last Int)) (! (=> (dynamic_invariant stack__last true true true true) (= (size stack__last) stack__last)) :pattern ((size stack__last)))))
...
(assert (forall ((x operation)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x operation)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun tokens__token__val__pred ((a us_rep1)) Bool (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 a))) 0))
(define-fun tokens__token__op__pred ((a us_rep1)) Bool (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 a))) 1))
(define-fun tokens__token__instr__pred ((a us_rep1)) Bool (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 a))) 2))
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 a))) (to_rep3 (rec__tokens__token__kind (us_split_discrs1 b)))) (and (and (=> (tokens__token__val__pred a) (= (bool_eq (rec__tokens__token__val (us_split_fields3 a)) (rec__tokens__token__val (us_split_fields3 b))) true)) (=> (tokens__token__op__pred a) (= (to_rep2 (rec__tokens__token__op (us_split_fields3 a))) (to_rep2 (rec__tokens__token__op (us_split_fields3 b)))))) (=> (tokens__token__instr__pred a) (= (to_rep (rec__tokens__token__instr (us_split_fields3 a))) (to_rep (rec__tokens__token__instr (us_split_fields3 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_222 us_rep1) (temp___skip_top_level_223 Bool)) Bool (and (= (attr__constrained temp___expr_222) false) (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 temp___expr_222))) 0)))
(declare-const t us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_213 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 0 2)) (in_range5 temp___expr_213)))
(define-fun dynamic_invariant3 ((temp___expr_177 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool) (temp___do_typ_inv_176 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 2)) (in_range1 temp___expr_177)))
(define-fun dynamic_invariant4 ((temp___expr_204 Int) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool) (temp___do_typ_inv_203 Bool)) Bool (=> (or (= temp___is_init_200 true) (<= 0 3)) (in_range4 temp___expr_204)))
(declare-const last Int)
(declare-const us Int)
(assert (in_range2 last))
(assert (=> (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t))) 0) (and (not (= (full last) true)) (=> (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t))) 1) (<= 2 (size last))))))
(assert (and (= us (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t)))) (in_range5 (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t))))))
(assert (not (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t))) 0)))
(assert (not (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t))) 1)))
(assert (not (= (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t))) 2)))
(check-sat)
(exit)
