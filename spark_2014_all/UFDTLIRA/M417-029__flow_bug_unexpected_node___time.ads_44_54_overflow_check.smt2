...
(assert (and (and (and (= time__t_increment__result10 time__t_increment__result8) (= result____split_fields13 result____split_fields11)) (and (= time__t_increment__result11 time__t_increment__result9) (= result____split_fields14 result____split_fields12))) (ite (< (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59) (and (and (and (= time__t_increment__result8 (mk_t__ref time__t_increment__result3)) (= result____split_fields11 (mk___split_fields__ref result____split_fields4))) (and (= time__t_increment__result9 time__t_increment__result3) (= result____split_fields12 result____split_fields4))) (and (and (and (and (and (and (= o6 (+ (to_rep2 (rec__time__t__seconds result____split_fields3)) 1)) (in_range4 (+ (to_rep2 (rec__time__t__seconds result____split_fields3)) 1))) (= (to_rep2 o7) o6)) (and (= (rec__time__t__hours result____split_fields3) o8) (and (= (rec__time__t__minutes result____split_fields3) o9) (= o7 o10)))) (and (= temp___165 o8) (and (= temp___1651 o9) (= temp___1652 o10)))) (and (= result1 (mk___split_fields__ref result____split_fields3)) (= result____split_fields4 (mk___split_fields temp___165 temp___1651 temp___1652)))) (and (= result2 (mk_t__ref (mk___rep (mk___split_fields time__t_increment__result time__t_increment__result1 time__t_increment__result2)))) (= time__t_increment__result3 (mk___rep result____split_fields4))))) (and (and (and (= time__t_increment__result8 time__t_increment__result6) (= result____split_fields11 result____split_fields9)) (and (= time__t_increment__result9 time__t_increment__result7) (= result____split_fields12 result____split_fields10))) (and (and (and (and (= (to_rep2 o11) 0) (and (= (rec__time__t__hours result____split_fields3) o12) (and (= (rec__time__t__minutes result____split_fields3) o13) (= o11 o14)))) (and (= temp___157 o12) (and (= temp___1571 o13) (= temp___1572 o14)))) (and (= result3 (mk___split_fields__ref result____split_fields3)) (= result____split_fields5 (mk___split_fields temp___157 temp___1571 temp___1572)))) (ite (< (to_rep1 (rec__time__t__minutes (us_split_fields1 x))) 59) (and (and (and (= time__t_increment__result6 (mk_t__ref time__t_increment__result4)) (= result____split_fields9 (mk___split_fields__ref result____split_fields6))) (and (= time__t_increment__result7 time__t_increment__result4) (= result____split_fields10 result____split_fields6))) (and (and (and (and (and (and (= o15 (+ (to_rep1 (rec__time__t__minutes result____split_fields5)) 1)) (in_range3 (+ (to_rep1 (rec__time__t__minutes result____split_fields5)) 1))) (= (to_rep1 o16) o15)) (and (= (rec__time__t__hours result____split_fields5) o17) (and (= o16 o18) (= (rec__time__t__seconds result____split_fields5) o19)))) (and (= temp___163 o17) (and (= temp___1631 o18) (= temp___1632 o19)))) (and (= result4 (mk___split_fields__ref result____split_fields5)) (= result____split_fields6 (mk___split_fields temp___163 temp___1631 temp___1632)))) (and (= result5 (mk_t__ref (mk___rep (mk___split_fields time__t_increment__result time__t_increment__result1 time__t_increment__result2)))) (= time__t_increment__result4 (mk___rep result____split_fields6))))) (and (and (and (= time__t_increment__result6 (mk_t__ref time__t_increment__result5)) (= result____split_fields9 (mk___split_fields__ref result____split_fields8))) (and (= time__t_increment__result7 time__t_increment__result5) (= result____split_fields10 result____split_fields8))) (and (and (and (and (= (to_rep1 o20) 0) (and (= (rec__time__t__hours result____split_fields5) o21) (and (= o20 o22) (= (rec__time__t__seconds result____split_fields5) o23)))) (and (= temp___159 o21) (and (= temp___1591 o22) (= temp___1592 o23)))) (and (= result6 (mk___split_fields__ref result____split_fields5)) (= result____split_fields7 (mk___split_fields temp___159 temp___1591 temp___1592)))) (and (and (and (and (and (and (= o24 (+ (to_rep (rec__time__t__hours result____split_fields7)) 1)) (in_range1 (+ (to_rep (rec__time__t__hours result____split_fields7)) 1))) (= (to_rep o25) o24)) (and (= o25 o26) (and (= (rec__time__t__minutes result____split_fields7) o27) (= (rec__time__t__seconds result____split_fields7) o28)))) (= temp___161 (mk___rep (mk___split_fields o26 o27 o28)))) (and (= result7 (mk___split_fields__ref result____split_fields7)) (= result____split_fields8 (us_split_fields1 temp___161)))) (and (= result8 (mk_t__ref (mk___rep (mk___split_fields time__t_increment__result time__t_increment__result1 time__t_increment__result2)))) (= time__t_increment__result5 (mk___rep result____split_fields8))))))))))))
