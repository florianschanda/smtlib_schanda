...
(assert (not (not (and (ite (= (<= (length (mk___rep l__split_discrs l__split_fields9)) 3) true) (= (length (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields1)) 0) (and (and (= (length (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields1)) (- (length (mk___rep l__split_discrs l__split_fields9)) 3)) (= (range_shifted (model__ (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields9)) 1 (length (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields1)) 3) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs my_lists__m__delete_first__2__container__fields1)) (positions (mk___rep l__split_discrs l__split_fields9)) 1 3) true))) (and (= result13 (mk___split_fields__ref l__split_fields9)) (= l__split_fields10 my_lists__m__delete_first__2__container__fields1))))))
(check-sat)
(exit)
