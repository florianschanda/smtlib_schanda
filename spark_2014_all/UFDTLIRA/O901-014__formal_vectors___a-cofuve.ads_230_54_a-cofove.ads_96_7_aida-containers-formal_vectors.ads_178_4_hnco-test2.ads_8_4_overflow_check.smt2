...
(define-fun dynamic_invariant ((temp___expr_431 Int) (temp___is_init_427 Bool) (temp___skip_constant_428 Bool) (temp___do_toplevel_429 Bool) (temp___do_typ_inv_430 Bool)) Bool (=> (or (= temp___is_init_427 true) (<= 1 2147483647)) (in_range2 temp___expr_431)))
...
(define-fun dynamic_invariant1 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 0 2147483647)) (in_range3 temp___expr_445)))
