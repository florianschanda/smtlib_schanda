...
(assert (=> (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true) (and (= temp___5091 (last1 (mk___rep l__split_discrs l__split_fields2))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields2)) 0) true) (= (bool_eq1 temp___5091 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) temp___5091) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) temp___5091) (length (mk___rep l__split_discrs l__split_fields2))))))))
(assert (=> (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true)) (and (= temp___5091 (previous (mk___rep l__split_discrs l__split_fields2) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true) true) (= (bool_eq1 temp___5091 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) temp___5091) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) temp___5091) (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)))))))
...
(assert (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true)))
(check-sat)
(exit)
