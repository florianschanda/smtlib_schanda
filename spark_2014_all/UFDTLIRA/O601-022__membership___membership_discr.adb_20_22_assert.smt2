...
(declare-datatypes () ((root_01__ref (mk_root_01__ref (root_01__content us_rep)))))
(define-fun root_01__ref___projection ((a root_01__ref)) us_rep (root_01__content a))
(define-fun dynamic_invariant ((temp___expr_206 us_rep) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (in_range2 0 temp___expr_206)))
(define-fun default_initial_assumption ((temp___expr_208 us_rep) (temp___skip_top_level_209 Bool)) Bool (and (= (attr__tag temp___expr_208) us_tag1) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_208))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_215 us_rep) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (in_range3 0 temp___expr_215)))
(define-fun default_initial_assumption1 ((temp___expr_217 us_rep) (temp___skip_top_level_218 Bool)) Bool (and (= (attr__tag temp___expr_217) us_tag2) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_217))) 0)))
(assert (and (= r01__attr__tag us_tag1) (= (to_rep (rec__membership_discr__root__c r01__split_discrs)) 0)))
(assert (= 0 (to_rep (rec__membership_discr__root__c r01__split_discrs))))
(assert (not (= 0 (to_rep (rec__membership_discr__root__c r01__split_discrs)))))
(check-sat)
(exit)
