...
(assert (=> (<= (- y (- 100)) r4) (and (= o3 (- y (- 100))) (in_range1 (- y (- 100))))))
...
(assert (= (mk___rep (mk___split_fields shapes4__make_circle__result9 shapes4__make_circle__result10 shapes4__make_circle__result11)) (mk___rep (mk___split_fields shapes4__make_circle__result3 shapes4__make_circle__result4 shapes4__make_circle__result5))))
...
(assert (= (mk___rep (mk___split_fields shapes4__make_circle__result3 shapes4__make_circle__result4 shapes4__make_circle__result5)) (mk___rep (mk___split_fields o10 o11 o12))))
(assert (= shapes4__make_circle__result12 (mk_circle__ref (mk___rep (mk___split_fields shapes4__make_circle__result6 shapes4__make_circle__result7 shapes4__make_circle__result8)))))
(assert (= r6 (mk_int__ref r5)))
(assert (= shapes4__make_circle__result13 (mk___rep (mk___split_fields shapes4__make_circle__result9 shapes4__make_circle__result10 shapes4__make_circle__result11))))
(assert (= r7 r5))
(assert (not (= (in_bounds (circle__content shapes4__make_circle__result12)) true)))
(check-sat)
(exit)
