...
(define-fun to_rep1 ((x et4)) Int (et4qtint x))
...
(declare-const temp___6872 us_rep2)
...
(assert (= temp___6872 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
...
(assert (= r__split_fields5 (us_split_fields5 temp___6872)))
(assert (= r__split_fields6 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields7 r__split_fields5))
(assert (not (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields6)) (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) r__split_fields2)) r__split_fields3))) true)))
(check-sat)
(exit)
