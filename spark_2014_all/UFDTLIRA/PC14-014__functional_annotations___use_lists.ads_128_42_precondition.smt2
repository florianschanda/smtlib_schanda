...
(assert (and (= o (has_key (positions l) (mk___rep1 (mk___split_fields1 cu)))) (= (= o true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 cu))) true))))
(assert (= o1 true))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (= (has_key (positions l) (mk___rep1 (mk___split_fields1 cu))) true)))
(check-sat)
(exit)
