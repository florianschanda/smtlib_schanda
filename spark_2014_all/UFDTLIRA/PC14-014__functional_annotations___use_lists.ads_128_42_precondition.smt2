...
(define-fun cu1 () us_rep2 (mk___rep1 (mk___split_fields1 cu)))
(assert (and (= o (has_key (positions l) cu1)) (= (= o true) (= (has_key (positions l) cu1) true))))
(assert (= o1 true))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (= (has_key (positions l) cu1) true)))
(check-sat)
(exit)
