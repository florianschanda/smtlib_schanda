...
(assert (=> (= status4 3) (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= status4 3) (= o2 (ite (not (= o1 true)) true false))))
(assert (=> (not (= status4 3)) (= o2 (of_int 1))))
(assert (=> (not (= status4 6)) (= status4 7)))
