...
(define-fun dynamic_invariant1 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 255)) (in_range4 temp___expr_218)))
...
(define-fun dynamic_invariant2 ((temp___expr_224 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 0 2147483647)) (in_range5 temp___expr_224)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant3 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range3 temp___expr_183)))
...
(define-fun default_initial_assumption ((temp___expr_253 us_rep1) (temp___skip_top_level_254 Bool)) Bool (=> (not (= temp___skip_top_level_254 true)) (= (length1 temp___expr_253) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 0 2147483647)) (in_range6 temp___expr_246)))
...
(define-fun dynamic_invariant5 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 255)) (in_range7 temp___expr_240)))
...
(assert (in_range5 before))
(assert (in_range4 new_item))
(assert (in_range2 count))
(assert (=> (not (= before 0)) (and (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range5 o4) (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before 0)) (= o5 (ite (= (- before 1) o4) true false))))
(assert (=> (not (not (= before 0))) (= o5 false)))
(assert (and (= o2 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range5 o2) (= o2 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o3 (ite (<= before o2) true false)))
(assert (= o6 (ite (<= 1 before) o3 false)))
(assert (= o7 (ite (= o6 false) o5 true)))
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range3 o) (= o (ite (= (of_int 0) true) (to_rep (rec__unbounded_strings__char_vectors__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
