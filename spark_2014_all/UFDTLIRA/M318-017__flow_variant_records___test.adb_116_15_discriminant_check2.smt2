...
(declare-const temp___308 Bool)
(declare-const temp___3081 integer)
(declare-const temp___3082 failure_reason)
(declare-const temp___3083 Bool)
(assert (not (= (ite x__split_discrs 1 0) 1)))
(assert (= x__split_discrs r34b))
(assert (= (to_rep o) 0))
(assert (= dummy o1))
(assert (= o o2))
(assert (= (distinct 0 0) temp___308))
(assert (= temp___3081 o1))
(assert (= temp___3082 o2))
(assert (= true temp___3083))
(assert (= x__attr__constrained true))
(assert (not (= temp___308 x__split_discrs)))
(check-sat)
(exit)
