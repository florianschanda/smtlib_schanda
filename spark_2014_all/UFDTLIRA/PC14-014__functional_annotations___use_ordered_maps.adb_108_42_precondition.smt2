...
(assert (and (= o1 (get1 o (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key1 o k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (keys s1)) (and (and (and (= (length1 o4) (length3 s1)) (forall ((temp___396 Int)) (=> (and (in_range3 temp___396) (= (iter_has_element o4 temp___396) true)) (= (has_key (model__ s1) (get o4 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s1) key2) true)) (and (< 0 (find o4 key2)) (= (equivalent_keys (get o4 (find o4 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s1))) (and (= (find o4 (get o4 i1)) i1) (= (k_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
