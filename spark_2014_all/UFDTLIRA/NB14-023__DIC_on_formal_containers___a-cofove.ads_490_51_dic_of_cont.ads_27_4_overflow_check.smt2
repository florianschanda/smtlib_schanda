...
(define-fun dynamic_invariant ((temp___expr_1503 Int) (temp___is_init_1500 Bool) (temp___skip_constant_1501 Bool) (temp___do_toplevel_1502 Bool)) Bool (=> (or (= temp___is_init_1500 true) (<= 0 2147483647)) (in_range1 temp___expr_1503)))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o1) (= o1 (ite (= (of_int 1) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
