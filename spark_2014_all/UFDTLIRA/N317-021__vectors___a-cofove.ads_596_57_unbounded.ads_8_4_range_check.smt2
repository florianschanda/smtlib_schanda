...
(define-fun dynamic_invariant3 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 1 2147483647)) (in_range5 temp___expr_183)))
...
(define-fun dynamic_invariant4 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 0 2147483647)) (in_range6 temp___expr_228)))
...
(define-fun dynamic_invariant5 ((temp___expr_222 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_222)))
