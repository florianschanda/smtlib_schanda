...
(define-fun dynamic_invariant ((temp___expr_816 Int) (temp___is_init_812 Bool) (temp___skip_constant_813 Bool) (temp___do_toplevel_814 Bool) (temp___do_typ_inv_815 Bool)) Bool (=> (or (= temp___is_init_812 true) (<= 0 10000)) (in_range2 temp___expr_816)))
...
(define-fun dynamic_invariant1 ((temp___expr_833 Int) (temp___is_init_829 Bool) (temp___skip_constant_830 Bool) (temp___do_toplevel_831 Bool) (temp___do_typ_inv_832 Bool)) Bool (=> (or (= temp___is_init_829 true) (<= (- 1) 10000)) (in_range3 temp___expr_833)))
...
(define-fun default_initial_assumption ((temp___expr_841 us_rep) (temp___skip_top_level_842 Bool)) Bool (=> (not (= temp___skip_top_level_842 true)) (= (length temp___expr_841) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range6 temp___expr_176)))
...
(define-fun dynamic_invariant3 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range4 temp___expr_326)))
(define-fun dynamic_invariant4 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range5 temp___expr_333)))
(assert true)
(declare-const o Int)
