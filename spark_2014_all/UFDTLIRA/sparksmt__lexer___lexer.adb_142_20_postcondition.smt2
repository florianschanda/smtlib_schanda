...
(define-fun default_initial_assumption ((temp___expr_524 us_rep1) (temp___skip_top_level_525 Bool)) Bool (and (= (attr__constrained temp___expr_524) false) (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs1 temp___expr_524))) 2)))
...
(declare-const temp___981 read_status)
(declare-const temp___9811 character)
(declare-const temp___9812 Bool)
...
(assert (= usq_ temp___981))
(assert (= usq_1 temp___9811))
(assert (= current_read__attr__constrained temp___9812))
(assert (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields current_read__split_fields))))
(assert (= temp___9811 current_read__split_fields1))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs))))
(assert (= current_read__split_discrs1 (mk___split_discrs temp___981)))
(assert (and (<= current_pos current_pos1) (and (and (in_range2 current_line1) (in_range1 current_col1)) (in_range1 current_pos1))))
(assert (= next_read__split_discrs2 (mk___split_discrs__ref next_read__split_discrs1)))
(assert (= next_read__split_fields2 (mk___split_fields__ref next_read__split_fields1)))
...
(assert (= current_read__split_fields2 (mk___split_fields__ref current_read__split_fields4)))
...
(assert (not (= (bool_eq1 (mk___rep (us_split_discrs__content current_read__split_discrs2) (us_split_fields__content current_read__split_fields2) current_read__attr__constrained) (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)) true)))
(check-sat)
(exit)
