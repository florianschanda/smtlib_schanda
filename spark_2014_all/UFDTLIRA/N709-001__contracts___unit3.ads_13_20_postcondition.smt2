...
(declare-const temp___228 integer)
...
(assert (= x__attr__tag temp___2284))
...
(assert (= temp___228 x__split_fields8))
(assert (= temp___2281 x__split_fields9))
(assert (= temp___2282 x__split_fields10))
(assert (= temp___2283 x__split_fields11))
