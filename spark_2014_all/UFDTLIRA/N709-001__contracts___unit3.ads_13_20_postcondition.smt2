...
(assert (forall ((unit2__create__x__fields us_split_fields2) (unit2__create__x__old__fields us_split_fields2)) (forall ((x__attr__tag Int)) (! (=> (create__specific_post us_tag2 unit2__create__x__fields x__attr__tag unit2__create__x__old__fields) (let ((temp___x_169 (of_base1 (to_base (mk___rep1 unit2__create__x__fields x__attr__tag))))) (and (= (to_rep (rec__unit1__t1__c12 (us_split_fields5 temp___x_169))) 0) (and (= (to_rep (rec__unit2__t2__c21 (us_split_fields5 temp___x_169))) 0) (= (to_rep (rec__unit3__t3__c3 (us_split_fields5 temp___x_169))) 0))))) :pattern ((create__specific_post us_tag2 unit2__create__x__fields x__attr__tag unit2__create__x__old__fields))))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep2)) (! (= (to_int1 (is_zero2 x)) (to_int1 (is_zero3 us_tag2 x))) :pattern ((is_zero3 us_tag2 x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (! (= (to_int1 (is_zero2 (of_base1 (to_base x)))) (to_int1 (is_zero1 us_tag2 x))) :pattern ((is_zero1 us_tag2 x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (to_int1 (is_zero2 (of_base1 x))) (to_int1 (is_zero5 us_tag2 x))) :pattern ((is_zero5 us_tag2 x)))))
(assert (forall ((x us_rep)) (! (= (to_int1 (is_zero (of_base x))) (to_int1 (is_zero5 us_tag1 x))) :pattern ((is_zero5 us_tag1 x)))))
...
(declare-const temp___2002 integer)
(declare-const temp___2003 us_private)
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= x__split_fields5 o2))
(assert (= x__split_fields6 o3))
(assert (= x__split_fields7 o4))
(assert (= temp___200 o1))
(assert (= temp___2001 o2))
(assert (= temp___2002 o3))
(assert (= temp___2003 o4))
(assert (= x__attr__tag temp___2004))
...
(assert (= temp___200 x__split_fields8))
(assert (= temp___2001 x__split_fields9))
(assert (= temp___2002 x__split_fields10))
(assert (= temp___2003 x__split_fields11))
...
(assert (not (= (to_rep x__split_fields13) 0)))
(check-sat)
(exit)
