...
(assert (<= 1 i2))
(assert (<= i2 (- (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i2) (+ (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2) 1))))
(check-sat)
(exit)
