...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__p_init__t__e (us_split_discrs1 a))) (to_rep1 (rec__p_init__t__e (us_split_discrs1 b)))) (= (to_rep (rec__p_init__t__x1 (us_split_fields1 a))) (to_rep (rec__p_init__t__x1 (us_split_fields1 b))))) (=> (p_init__t__x2__pred a) (= (to_rep (rec__p_init__t__x2 (us_split_fields1 a))) (to_rep (rec__p_init__t__x2 (us_split_fields1 b)))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (attr__constrained temp___expr_143) false) (= (to_rep1 (rec__p_init__t__e (us_split_discrs1 temp___expr_143))) 0)))
...
(define-fun dynamic_invariant ((temp___expr_199 us_rep) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool)) Bool (and (=> (not (= temp___skip_constant_197 true)) (in_range2 0 temp___expr_199)) (= (attr__constrained temp___expr_199) true)))
(define-fun default_initial_assumption1 ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (and (= (attr__constrained temp___expr_201) true) (= (to_rep1 (rec__p_init__t__e (us_split_discrs1 temp___expr_201))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_209 us_rep) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (and (=> (not (= temp___skip_constant_207 true)) (in_range3 1 temp___expr_209)) (= (attr__constrained temp___expr_209) true)))
(define-fun default_initial_assumption2 ((temp___expr_211 us_rep) (temp___skip_top_level_212 Bool)) Bool (and (= (attr__constrained temp___expr_211) true) (= (to_rep1 (rec__p_init__t__e (us_split_discrs1 temp___expr_211))) 1)))
...
(define-fun dynamic_invariant2 ((temp___expr_179 us_rep) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (and (=> (not (= temp___skip_constant_177 true)) (in_range4 0 temp___expr_179)) (= (attr__constrained temp___expr_179) true)))
(define-fun default_initial_assumption3 ((temp___expr_181 us_rep) (temp___skip_top_level_182 Bool)) Bool (and (= (attr__constrained temp___expr_181) true) (= (to_rep1 (rec__p_init__t__e (us_split_discrs1 temp___expr_181))) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_189 us_rep) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (and (=> (not (= temp___skip_constant_187 true)) (in_range6 1 temp___expr_189)) (= (attr__constrained temp___expr_189) true)))
(define-fun default_initial_assumption4 ((temp___expr_191 us_rep) (temp___skip_top_level_192 Bool)) Bool (and (= (attr__constrained temp___expr_191) true) (= (to_rep1 (rec__p_init__t__e (us_split_discrs1 temp___expr_191))) 1)))
...
(assert (= c1 (mk___rep (mk___split_discrs (of_rep1 0)) (mk___split_fields (of_rep 1) dummy) true)))
(assert (= c2 (mk___rep (mk___split_discrs (of_rep1 1)) (mk___split_fields (of_rep 1) (of_rep 2)) true)))
(define-fun dynamic_invariant5 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1)) (in_range1 temp___expr_135)))
...
(define-fun o24 () us_rep (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15) o16))
(define-fun o25 () us_rep (mk___rep (mk___split_discrs o9) (mk___split_fields o10 o11) o12))
...
(assert (= o7 o3))
(assert (= true o8))
(assert (= o25 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))
(assert (= o24 o25))
(assert (= run__c1__assume o24))
...
(assert (= o23 o22))
(assert (not (= 1 (to_rep1 (rec__p_init__t__e (us_split_discrs1 o23))))))
(check-sat)
(exit)
