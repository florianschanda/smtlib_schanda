...
(define-fun dynamic_invariant ((temp___expr_271 Int) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool (=> (or (= temp___is_init_267 true) (<= 1 2147483647)) (in_range2 temp___expr_271)))
