...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__new_eq__my_rec__f integer) (rec__new_eq__my_rec__g integer)))))
(define-fun us_split_fields_F__projection ((a us_split_fields)) integer (rec__new_eq__my_rec__f a))
(define-fun us_split_fields_G__projection ((a us_split_fields)) integer (rec__new_eq__my_rec__g a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__new_eq__my_rec__f (us_split_fields1 a))) (to_rep (rec__new_eq__my_rec__f (us_split_fields1 b)))) (= (to_rep (rec__new_eq__my_rec__g (us_split_fields1 a))) (to_rep (rec__new_eq__my_rec__g (us_split_fields1 b))))) true false))
...
(assert (= rliteral1 x__split_fields3))
(assert (= result2 y__split_fields))
(assert (= result3 y__split_fields1))
(assert (= rliteral y__split_fields2))
(assert (= rliteral2 y__split_fields3))
(assert (not (not (= (oeq (mk___rep (mk___split_fields x__split_fields2 x__split_fields3)) (mk___rep (mk___split_fields y__split_fields2 y__split_fields3))) true))))
(check-sat)
(exit)
