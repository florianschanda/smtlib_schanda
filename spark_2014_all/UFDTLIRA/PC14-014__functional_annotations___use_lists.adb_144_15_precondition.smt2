...
(assert (and (= o1 (get1 o fst)) (and (in_range4 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o fst))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k fst) true) (= (witness o fst) (witness o k))))))))))
(assert (= o2 (- o1 1)))
