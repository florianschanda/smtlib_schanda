...
(assert (and (= o25 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o25 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o25 i4) true) (and (and (<= 1 (get1 o25 i4)) (<= (get1 o25 i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key o25 j) true) (=> (= (get1 o25 i4) (get1 o25 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (and (= o26 (get1 o25 fst)) (and (in_range4 o26) (=> (= (of_int 0) true) (and (= o26 (w_get o25 (witness o25 fst))) (forall ((k us_rep1)) (=> (= (has_key o25 k) true) (= (= (bool_eq1 k fst) true) (= (witness o25 fst) (witness o25 k))))))))))
(assert (= o27 (- o26 1)))
(assert (= o28 (ite (<= i1 o27) true false)))
(assert (= result5 (ite (<= 1 i1) o28 false)))
(assert (= result5 true))
(assert (and (= o30 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)) (in_range3 o30)))
(assert (and (= o29 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o29) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (not (<= 1 i1)))
(check-sat)
(exit)
