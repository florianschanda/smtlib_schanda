...
(assert (and (= o53 (first (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq1 o53 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o53) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o53) 1)))))
(assert (and (= o54 (next (mk___rep l3__split_discrs l3__split_fields2) o53)) (ite (= (ite (= (bool_eq1 o53 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o53) (length (mk___rep l3__split_discrs l3__split_fields2))) true) true) (= (bool_eq1 o54 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o54) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o54) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o53) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o54) true) (= (bool_eq1 o54 no_element) true))))
(check-sat)
(exit)
