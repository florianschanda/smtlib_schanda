...
(define-fun dynamic_invariant ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first1 last1)) (dynamic_property1 first1 last1 temp___expr_256)))
...
(define-fun dynamic_invariant5 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first last)) (dynamic_property first last temp___expr_242)))
(assert (= first fst))
(assert (= last lst))
...
(assert (= last5 last3))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first2 1) result) last3) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
