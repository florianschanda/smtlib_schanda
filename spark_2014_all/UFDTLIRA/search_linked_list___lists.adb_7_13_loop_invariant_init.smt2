...
(define-fun c__split_fields2 () us_split_fields (mk___split_fields c__split_fields1))
...
(assert (and (= result1 (has_key (positions l) (mk___rep c__split_fields2))) (= (= result1 true) (= (has_key (positions l) (mk___rep c__split_fields2)) true))))
(assert (= result1 true))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get1 (positions l) (mk___rep c__split_fields2)) 1)))
