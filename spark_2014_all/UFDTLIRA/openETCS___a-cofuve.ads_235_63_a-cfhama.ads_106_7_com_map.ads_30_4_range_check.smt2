...
(define-fun dynamic_invariant ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range2 temp___expr_422)))
...
(define-fun dynamic_invariant1 ((temp___expr_436 Int) (temp___is_init_432 Bool) (temp___skip_constant_433 Bool) (temp___do_toplevel_434 Bool) (temp___do_typ_inv_435 Bool)) Bool (=> (or (= temp___is_init_432 true) (<= 0 2147483647)) (in_range3 temp___expr_436)))
...
(define-fun default_initial_assumption ((temp___expr_444 us_rep) (temp___skip_top_level_445 Bool)) Bool (=> (not (= temp___skip_top_level_445 true)) (= (length temp___expr_444) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 1 10000)) (in_range5 temp___expr_429)))
...
(assert (and (= o5 (last left)) (and (in_range3 o5) (= o5 (+ 0 (length left))))))
...
(assert (= o2 (+ 0 o)))
(assert (= o3 (- o2 o1)))
(assert (= o4 (ite (<= offset o3) true false)))
