...
(define-fun dynamic_invariant1 ((temp___expr_436 Int) (temp___is_init_432 Bool) (temp___skip_constant_433 Bool) (temp___do_toplevel_434 Bool) (temp___do_typ_inv_435 Bool)) Bool (=> (or (= temp___is_init_432 true) (<= 0 2147483647)) (in_range2 temp___expr_436)))
...
(assert (forall ((i element_type)) (and (<= 1 (element_typeqtint i)) (<= (element_typeqtint i) 10000))))
...
(assert (and (= o5 (last left)) (and (in_range2 o5) (= o5 (+ 0 (length left))))))
...
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o1 lst) (in_range3 lst)))
