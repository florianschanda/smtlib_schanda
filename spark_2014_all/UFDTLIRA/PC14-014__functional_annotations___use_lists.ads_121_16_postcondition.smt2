...
(declare-const temp___561 us_rep2)
...
(assert (let ((temp___565 (model__ l))) (forall ((temp___564 Int)) (=> (and (in_range2 temp___564) (= (iter_has_element temp___565 temp___564) true)) (= (prop__ (get temp___565 temp___564)) true)))))
(declare-const cu1 us_rep1)
(assert (= (has_key (positions l) cu1) true))
(assert (not (= (prop__ (element l cu1)) true)))
(check-sat)
(exit)
