...
(assert (let ((temp___608 (model__ l))) (forall ((temp___607 Int)) (=> (and (in_range2 temp___607) (= (iter_has_element temp___608 temp___607) true)) (= (prop__ (get temp___608 temp___607)) true)))))
(declare-const cu us_rep2)
(assert (= (has_key (positions l) cu) true))
(assert (not (= (prop__ (element l cu)) true)))
(check-sat)
(exit)
