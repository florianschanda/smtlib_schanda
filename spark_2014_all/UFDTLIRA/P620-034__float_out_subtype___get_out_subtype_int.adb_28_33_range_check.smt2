...
(assert (and (= o3 get_out_subtype_int__controller_get_desired_rate__pitch_rate_desired1) (in_range1 get_out_subtype_int__controller_get_desired_rate__pitch_rate_desired1)))
(assert (= (to_rep o4) o3))
(assert (= o5 (to_rep o4)))
(assert (= result4 pitch_rate_desired1))
(assert (= pitch_rate_desired2 o5))
(assert (not (in_range1 get_out_subtype_int__controller_get_desired_rate__yaw_rate_desired)))
(check-sat)
(exit)
