...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__names__char_tables__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type1 (rec__names__char_tables__vector a))
...
(define-fun oeq ((left us_rep) (right us_rep)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
(declare-fun oeq__function_guard (Bool us_rep us_rep) Bool)
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq a b) (oeq a b)) :pattern ((user_eq a b)))))
(define-fun default_initial_assumption ((temp___expr_363 us_rep) (temp___skip_top_level_364 Bool)) Bool (=> (not (= temp___skip_top_level_364 true)) (= (length temp___expr_363) 0)))
...
(define-fun dynamic_invariant ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= (- 1) 2147483647)) (in_range2 temp___expr_317)))
...
(define-fun dynamic_invariant1 ((temp___expr_303 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool) (temp___do_typ_inv_302 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 2147483646)) (in_range3 temp___expr_303)))
...
(define-fun dynamic_invariant2 ((temp___expr_310 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool) (temp___do_typ_inv_309 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range4 temp___expr_310)))
...
(define-fun dynamic_invariant4 ((temp___expr_324 Int) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool) (temp___do_typ_inv_323 Bool)) Bool (=> (or (= temp___is_init_320 true) (<= 0 2147483647)) (in_range1 temp___expr_324)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep (rec__names__char_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_355 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool) (temp___do_typ_inv_354 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 1) 2147483646)) (in_range5 temp___expr_355)))
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant3 result true false true true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_348 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool) (temp___do_typ_inv_347 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 0 255)) (in_range7 temp___expr_348)))
(assert (forall ((container1 us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true true) (and (<= 0 position) (<= position (last container1)))) (dynamic_invariant6 (get container1 position) true false true true)) :pattern ((get container1 position))))))
...
(assert (=> (not (= result true)) (and (= o3 o2) (in_range5 o2))))
