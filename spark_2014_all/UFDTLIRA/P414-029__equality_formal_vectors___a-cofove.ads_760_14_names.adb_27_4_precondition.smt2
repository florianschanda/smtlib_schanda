...
(define-fun dynamic_invariant ((temp___expr_262 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 2147483646)) (in_range2 temp___expr_262)))
...
(define-fun dynamic_invariant1 ((temp___expr_268 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 255)) (in_range3 temp___expr_268)))
...
(define-fun oeq ((left us_rep1) (right us_rep1)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
(declare-fun oeq__function_guard (Bool us_rep1 us_rep1) Bool)
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq5 a b) (oeq a b)) :pattern ((user_eq5 a b)))))
(define-fun default_initial_assumption ((temp___expr_314 us_rep1) (temp___skip_top_level_315 Bool)) Bool (=> (not (= temp___skip_top_level_315 true)) (= (length temp___expr_314) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_274 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 1) 2147483647)) (in_range5 temp___expr_274)))
...
(define-fun dynamic_invariant4 ((temp___expr_280 Int) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (<= 0 2147483647)) (in_range1 temp___expr_280)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__names__char_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_307 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= (- 1) 2147483646)) (in_range4 temp___expr_307)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant3 result true false true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_301 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 0 255)) (in_range7 temp___expr_301)))
(assert (forall ((container1 us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true) (and (<= 0 position) (<= position (last container1)))) (dynamic_invariant6 (get container1 position) true false true)) :pattern ((get container1 position))))))
