...
(define-fun dynamic_invariant ((temp___expr_303 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool) (temp___do_typ_inv_302 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 2147483646)) (in_range2 temp___expr_303)))
...
(define-fun dynamic_invariant1 ((temp___expr_310 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool) (temp___do_typ_inv_309 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range3 temp___expr_310)))
...
(define-fun default_initial_assumption ((temp___expr_363 us_rep1) (temp___skip_top_level_364 Bool)) Bool (=> (not (= temp___skip_top_level_364 true)) (= (length temp___expr_363) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= (- 1) 2147483647)) (in_range5 temp___expr_317)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 0 0) true) (to_rep (rec__names__char_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_355 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool) (temp___do_typ_inv_354 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 1) 2147483646)) (in_range4 temp___expr_355)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant3 result true false true true))) :pattern ((length container1)))))
...
(assert (forall ((container1 us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant5 position true true true true) (and (<= 0 position) (<= position (last container1)))) (dynamic_invariant6 (get container1 position) true false true true)) :pattern ((get container1 position))))))
