...
(define-fun default_initial_assumption1 ((temp___expr_138 us_rep) (temp___skip_top_level_139 Bool)) Bool (= (attr__tag temp___expr_138) us_tag))
(assert (not (= w2__attr__tag (attr__tag1 w1))))
(check-sat)
(exit)
