...
(define-fun dynamic_invariant ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 1 2147483647)) (in_range2 temp___expr_246)))
...
(define-fun default_initial_assumption1 ((temp___expr_253 us_rep2) (temp___skip_top_level_254 Bool)) Bool (=> (not (= temp___skip_top_level_254 true)) (and (= (is_empty temp___expr_253) true) (= (length temp___expr_253) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true))) :pattern ((length1 container1)))))
...
(declare-const temp___452 count_type)
