...
(define-fun default_initial_assumption1 ((temp___expr_295 us_rep2) (temp___skip_top_level_296 Bool)) Bool (=> (not (= temp___skip_top_level_296 true)) (and (= (is_empty temp___expr_295) true) (= (length temp___expr_295) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___495 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___495)) no_element))
