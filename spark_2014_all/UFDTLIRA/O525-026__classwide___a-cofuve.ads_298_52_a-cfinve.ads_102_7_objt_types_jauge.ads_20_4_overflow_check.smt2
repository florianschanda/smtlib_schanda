...
(define-fun dynamic_invariant ((temp___expr_262 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 1 4)) (in_range1 temp___expr_262)))
...
(define-fun oeq ((left us_rep1) (right us_rep1)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (let ((temp___133 (get right n))) (let ((temp___132 (get left n))) (and (ite (= (attr__tag temp___132) (attr__tag temp___133)) true false) (us_dispatch_eq temp___132 temp___133)))) true))) true false)))
(declare-fun oeq__function_guard (Bool us_rep1 us_rep1) Bool)
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq3 a b) (oeq a b)) :pattern ((user_eq3 a b)))))
(define-fun default_initial_assumption1 ((temp___expr_279 us_rep1) (temp___skip_top_level_280 Bool)) Bool (=> (not (= temp___skip_top_level_280 true)) (= (length temp___expr_279) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_209 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range3 temp___expr_209)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= (+ 0 result) 4) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_272 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= 0 4)) (in_range4 temp___expr_272)))
...
(assert (and (= o3 (length container)) (and (in_range3 o3) (<= (+ 0 o3) 4))))
(assert (= result (ite (< o3 2147483647) true false)))
(assert (= result true))
(assert (and (= o2 (last container)) (and (in_range4 o2) (= o2 (+ 0 (length container))))))
(assert (= result1 (ite (< o2 4) true false)))
(assert (= result1 true))
