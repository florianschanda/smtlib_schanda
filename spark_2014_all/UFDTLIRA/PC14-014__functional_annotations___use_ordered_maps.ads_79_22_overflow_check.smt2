...
(assert (and (= o9 (length s2)) (and (in_range2 o9) (<= o9 (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 s2)))))))
(assert (and (= o7 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o7) (<= o7 (to_rep (rec__use_ordered_maps__my_maps__map__capacity s1__split_discrs))))))
(assert (= o8 (- (to_rep (rec__use_ordered_maps__my_maps__map__capacity s1__split_discrs)) o7)))
