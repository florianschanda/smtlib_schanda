...
(define-fun dynamic_invariant2 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_287)))
...
(define-fun dynamic_invariant3 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= first1 last3)) (dynamic_property2 first1 last3 temp___expr_294)))
...
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant3 position true true true true) (and (<= first position) (<= position (last2 container)))) (dynamic_invariant2 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant4 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first3 last5)) (dynamic_property4 first3 last5 temp___expr_256)))
...
(define-fun dynamic_invariant5 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_249)))
...
(define-fun dynamic_invariant6 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= first4 last6)) (dynamic_property5 first4 last6 temp___expr_228)))
(assert (= first4 fst))
(assert (= last6 lst))
...
(declare-const temp___514 tcount_typeB)
...
(declare-const temp___516 us_rep1)
(declare-const i Int)
(declare-const o Int)
...
(define-fun v__split_fields10 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields v__split_fields6)))
(define-fun v__split_fields11 () us_split_fields (mk___split_fields v__split_fields5))
(define-fun v__split_fields12 () us_split_fields (mk___split_fields v__split_fields3))
(define-fun v__split_fields13 () us_split_fields (mk___split_fields v__split_fields2))
(assert (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))
(assert (dynamic_property5 first4 last6 fst1))
(assert (dynamic_property5 first4 last6 lst1))
(assert (and (<= lst1 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (<= fst1 lst1)))
(assert (= (mk_int__ref result) (mk_int__ref current)))
(assert (= current1 fst1))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (and (= v__split_discrs (mk___split_discrs temp___514)) (= v__split_fields temp___5141))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= temp___513 current1)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= temp___517 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= temp___515 (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= temp___516 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= (length (mk___rep v__split_discrs v__split_fields13)) temp___515)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (forall ((i1 Int)) (=> (and (<= fst1 i1) (<= i1 (- current2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i1) 0)))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (forall ((i1 Int)) (=> (and (<= first4 i1) (<= i1 (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i1) (get temp___516 i1))))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (forall ((i1 Int)) (=> (and (<= current2 i1) (<= i1 (last2 (model__ (mk___rep v__split_discrs v__split_fields13))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i1) (get temp___517 i1))))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (and (and (=> (<= fst1 lst1) (dynamic_property6 fst1 lst1 current2)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))) (and (<= fst1 current2) (<= current2 lst1)))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (and (and (and (= (length (mk___rep v__split_discrs v__split_fields12)) (length (mk___rep v__split_discrs v__split_fields13))) (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) current2) 0)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields13)) (model__ (mk___rep v__split_discrs v__split_fields12)) current2) true)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= current2 lst1)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= current2 current3)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= v__split_fields4 v__split_fields3)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= current4 current2)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= v__split_fields11 v__split_fields12)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= current5 (mk_int__ref current3))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= v__split_fields10 (mk___split_fields__ref (mk___split_fields v__split_fields4)))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= current6 current4)))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (= v__split_fields7 v__split_fields11)))
(assert (=> (not (and (<= fst1 current1) (<= current1 lst1))) (= current5 (mk_int__ref current1))))
(assert (=> (not (and (<= fst1 current1) (<= current1 lst1))) (= v__split_fields10 (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (not (and (<= fst1 current1) (<= current1 lst1))) (= current6 current1)))
(assert (=> (not (and (<= fst1 current1) (<= current1 lst1))) (= v__split_fields7 (mk___split_fields v__split_fields1))))
...
(assert (and (= o (last2 (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))))) (and (dynamic_property4 first3 last5 o) (= o (last2 (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result1 (ite (<= first4 i) o1 false)))
(assert (= result1 true))
(assert (not (and (<= fst1 i) (<= i lst1))))
(assert (and (= us1 i) (dynamic_property2 first1 last3 i)))
(assert (= o3 i))
(assert (and (= o4 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) o3)) (in_range3 o4)))
(assert (and (= us i) (dynamic_property3 first2 last4 i)))
(assert (= o2 i))
(assert (not (<= first2 o2)))
(check-sat)
(exit)
