...
(declare-const temp___552 count_type)
(declare-const temp___553 us_rep1)
(declare-const temp___554 us_rep1)
(declare-const temp___555 us_rep1)
(declare-const o2 us_rep)
(declare-const o3 us_rep)
(declare-const temp___558 us_rep)
(declare-const temp___559 us_rep1)
(declare-const temp___561 us_rep1)
(declare-const temp___563 us_rep1)
(declare-const temp___565 us_rep1)
...
(define-fun temp___5521 () us_rep1 (mk___rep1 (mk___split_fields1 temp___552)))
(assert (= (to_rep o) 0))
(assert (= o o1))
...
(assert (and (= temp___5521 (first (mk___rep l__split_discrs l__split_fields3))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true) (= (bool_eq1 temp___5521 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) temp___5521) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___5521) 1)))))
(assert (= result2 (mk___split_fields__ref1 c__split_fields1)))
(assert (= c__split_fields2 (mk___split_fields1 temp___552)))
...
(assert (and (= temp___553 (last1 (mk___rep l__split_discrs l__split_fields3))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true) (= (bool_eq1 temp___553 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) temp___553) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___553) (length (mk___rep l__split_discrs l__split_fields3)))))))
(assert (= result3 (mk___split_fields__ref1 c__split_fields3)))
(assert (= c__split_fields4 (us_split_fields3 temp___553)))
...
(assert (and (= temp___554 (last1 (mk___rep l__split_discrs l__split_fields3))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true) (= (bool_eq1 temp___554 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) temp___554) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___554) (length (mk___rep l__split_discrs l__split_fields3)))))))
(assert (= result4 (mk___split_fields__ref1 c__split_fields5)))
(assert (= c__split_fields6 (us_split_fields3 temp___554)))
...
(assert (and (= temp___555 (previous (mk___rep l__split_discrs l__split_fields3) (mk___rep1 c__split_fields8))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields8) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields8)) 1) true) true) (= (bool_eq1 temp___555 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) temp___555) true) (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___555) (- (get (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields8)) 1))))))
(assert (= result5 (mk___split_fields__ref1 (mk___split_fields1 d__split_fields))))
(assert (= d__split_fields1 (us_split_fields3 temp___555)))
...
(assert (= o3 o2))
(assert (= temp___558 o3))
(assert (= result8 (mk___split_fields__ref (mk___split_fields k__split_fields))))
(assert (= k__split_fields1 (us_split_fields1 temp___558)))
(assert (= k__split_discrs (us_split_discrs1 temp___558)))
(assert (and (= temp___559 (next (mk___rep l__split_discrs l__split_fields5) (mk___rep1 d__split_fields1))) (ite (= (ite (= (bool_eq1 (mk___rep1 d__split_fields1) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 d__split_fields1)) (length (mk___rep l__split_discrs l__split_fields5))) true) true) (= (bool_eq1 temp___559 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields5)) temp___559) true) (= (get (positions (mk___rep l__split_discrs l__split_fields5)) temp___559) (+ (get (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 d__split_fields1)) 1))))))
(assert (= result9 (mk___split_fields__ref1 c__split_fields8)))
(assert (= c__split_fields9 (us_split_fields3 temp___559)))
...
(assert (and (= temp___561 (previous (mk___rep l__split_discrs l__split_fields6) (mk___rep1 c__split_fields9))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields9) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 c__split_fields9)) 1) true) true) (= (bool_eq1 temp___561 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) temp___561) true) (= (get (positions (mk___rep l__split_discrs l__split_fields6)) temp___561) (- (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 c__split_fields9)) 1))))))
(assert (= result11 (mk___split_fields__ref1 d__split_fields2)))
(assert (= d__split_fields3 (us_split_fields3 temp___561)))
...
(assert (and (= temp___563 (next (mk___rep l__split_discrs l__split_fields7) (mk___rep1 c__split_fields9))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields9) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields7)) (mk___rep1 c__split_fields9)) (length (mk___rep l__split_discrs l__split_fields7))) true) true) (= (bool_eq1 temp___563 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields7)) temp___563) true) (= (get (positions (mk___rep l__split_discrs l__split_fields7)) temp___563) (+ (get (positions (mk___rep l__split_discrs l__split_fields7)) (mk___rep1 c__split_fields9)) 1))))))
(assert (= result13 (mk___split_fields__ref1 d__split_fields4)))
(assert (= d__split_fields5 (us_split_fields3 temp___563)))
...
(assert (and (= temp___565 (next (mk___rep l__split_discrs l__split_fields8) (mk___rep1 c__split_fields9))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields9) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields8)) (mk___rep1 c__split_fields9)) (length (mk___rep l__split_discrs l__split_fields8))) true) true) (= (bool_eq1 temp___565 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) temp___565) true) (= (get (positions (mk___rep l__split_discrs l__split_fields8)) temp___565) (+ (get (positions (mk___rep l__split_discrs l__split_fields8)) (mk___rep1 c__split_fields9)) 1))))))
(assert (= result15 (mk___split_fields__ref1 d__split_fields6)))
(assert (= d__split_fields7 (us_split_fields3 temp___565)))
