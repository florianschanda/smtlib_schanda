...
(define-fun dynamic_invariant ((temp___expr_1715 us_rep1) (temp___is_init_1711 Bool) (temp___skip_constant_1712 Bool) (temp___do_toplevel_1713 Bool) (temp___do_typ_inv_1714 Bool)) Bool (=> (not (= temp___skip_constant_1712 true)) (in_range2 2 (to_base temp___expr_1715))))
(define-fun default_initial_assumption ((temp___expr_1717 us_rep1) (temp___skip_top_level_1718 Bool)) Bool (= (to_rep (rec__r__pt__irq (us_split_discrs2 temp___expr_1717))) 2))
...
(define-fun dynamic_invariant1 ((temp___expr_1739 us_rep2) (temp___is_init_1735 Bool) (temp___skip_constant_1736 Bool) (temp___do_toplevel_1737 Bool) (temp___do_typ_inv_1738 Bool)) Bool (=> (not (= temp___skip_constant_1736 true)) (in_range3 4 (to_base1 temp___expr_1739))))
(define-fun default_initial_assumption1 ((temp___expr_1741 us_rep2) (temp___skip_top_level_1742 Bool)) Bool (= (to_rep (rec__r__pt__irq (us_split_discrs3 temp___expr_1741))) 4))
...
(define-fun dynamic_invariant2 ((temp___expr_1754 us_rep3) (temp___is_init_1750 Bool) (temp___skip_constant_1751 Bool) (temp___do_toplevel_1752 Bool) (temp___do_typ_inv_1753 Bool)) Bool (=> (not (= temp___skip_constant_1751 true)) (in_range4 1 (to_base2 temp___expr_1754))))
(define-fun default_initial_assumption2 ((temp___expr_1756 us_rep3) (temp___skip_top_level_1757 Bool)) Bool (= (to_rep (rec__r__pt__irq (us_split_discrs4 temp___expr_1756))) 1))
...
(define-fun dynamic_invariant3 ((temp___expr_1763 us_rep4) (temp___is_init_1759 Bool) (temp___skip_constant_1760 Bool) (temp___do_toplevel_1761 Bool) (temp___do_typ_inv_1762 Bool)) Bool (=> (not (= temp___skip_constant_1760 true)) (in_range5 3 (to_base3 temp___expr_1763))))
(define-fun default_initial_assumption3 ((temp___expr_1765 us_rep4) (temp___skip_top_level_1766 Bool)) Bool (= (to_rep (rec__r__pt__irq (us_split_discrs5 temp___expr_1765))) 3))
...
(define-fun dynamic_invariant4 ((temp___expr_1772 us_rep5) (temp___is_init_1768 Bool) (temp___skip_constant_1769 Bool) (temp___do_toplevel_1770 Bool) (temp___do_typ_inv_1771 Bool)) Bool (=> (not (= temp___skip_constant_1769 true)) (in_range6 5 (to_base4 temp___expr_1772))))
(define-fun default_initial_assumption4 ((temp___expr_1774 us_rep5) (temp___skip_top_level_1775 Bool)) Bool (= (to_rep (rec__r__pt__irq (us_split_discrs6 temp___expr_1774))) 5))
(declare-const po5__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(define-fun dynamic_invariant5 ((temp___expr_1702 Int) (temp___is_init_1698 Bool) (temp___skip_constant_1699 Bool) (temp___do_toplevel_1700 Bool) (temp___do_typ_inv_1701 Bool)) Bool (=> (or (= temp___is_init_1698 true) (<= 0 63)) (in_range1 temp___expr_1702)))
