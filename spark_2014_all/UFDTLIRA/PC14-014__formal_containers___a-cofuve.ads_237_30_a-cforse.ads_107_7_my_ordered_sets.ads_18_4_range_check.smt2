...
(define-fun dynamic_invariant ((temp___expr_571 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 1 2147483647)) (in_range2 temp___expr_571)))
...
(define-fun dynamic_invariant1 ((temp___expr_585 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 2147483647)) (in_range3 temp___expr_585)))
