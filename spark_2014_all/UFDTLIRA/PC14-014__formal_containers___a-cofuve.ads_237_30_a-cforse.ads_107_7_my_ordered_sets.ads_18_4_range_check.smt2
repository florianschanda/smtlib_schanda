...
(define-fun dynamic_invariant ((temp___expr_621 Int) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool (=> (or (= temp___is_init_617 true) (<= 1 2147483647)) (in_range2 temp___expr_621)))
...
(define-fun dynamic_invariant1 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= 0 2147483647)) (in_range3 temp___expr_637)))
...
(assert (forall ((x natural)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant4 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range5 temp___expr_39)))
(assert true)
(declare-const o Int)
