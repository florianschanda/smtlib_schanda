...
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3) usq_4) (mk___rep (mk___split_discrs temp___159) (mk___split_fields temp___1591 temp___1592 temp___1593) temp___1594)))
...
(assert (= x__split_fields3 (mk___split_fields temp___1611 temp___1612 temp___1613)))
...
(assert (not (= (rec__definite__t__d (us_split_discrs1 temp___162)) g__split_discrs)))
(check-sat)
(exit)
