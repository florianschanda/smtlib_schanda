...
(assert (and (= (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)) (copy (mk___rep l__split_discrs (mk___split_fields l__split_fields)) 0)) (and (and (= (oeq (model__ (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) (= (oeq1 (positions (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (to_rep p__identity_swap__l_in__assume) (to_rep (rec__p__my_lists__list__capacity l__split_discrs))))))
(assert (= (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)) l_in))
(assert (and (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu2)) true) (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)))
(assert (= (element (mk___rep l__split_discrs (mk___split_fields l__split_fields1)) cu1) (element l_in cu2)))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) cu1) true)))
(check-sat)
(exit)
