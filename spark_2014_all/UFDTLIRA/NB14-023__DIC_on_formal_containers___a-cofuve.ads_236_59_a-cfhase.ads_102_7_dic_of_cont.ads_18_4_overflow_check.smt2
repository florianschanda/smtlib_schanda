...
(define-fun dynamic_invariant ((temp___expr_789 Int) (temp___is_init_786 Bool) (temp___skip_constant_787 Bool) (temp___do_toplevel_788 Bool)) Bool (=> (or (= temp___is_init_786 true) (<= 1 2147483647)) (in_range2 temp___expr_789)))
...
(define-fun dynamic_invariant1 ((temp___expr_801 Int) (temp___is_init_798 Bool) (temp___skip_constant_799 Bool) (temp___do_toplevel_800 Bool)) Bool (=> (or (= temp___is_init_798 true) (<= 0 2147483647)) (in_range3 temp___expr_801)))
...
(define-fun sequence__ref___3__projection ((a sequence__ref)) us_rep (sequence__content a))
...
(define-fun default_initial_assumption ((temp___expr_808 us_rep) (temp___skip_top_level_809 Bool)) Bool (=> (not (= temp___skip_top_level_809 true)) (= (length temp___expr_808) 0)))
...
(define-fun element_type__ref___10__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant3 ((temp___expr_795 Int) (temp___is_init_792 Bool) (temp___skip_constant_793 Bool) (temp___do_toplevel_794 Bool)) Bool (=> (or (= temp___is_init_792 true) (<= 0 2147483647)) (in_range5 temp___expr_795)))
