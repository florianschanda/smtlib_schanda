...
(declare-const temp___864 us_rep1)
(declare-const k Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (= temp___864 (model__ s)))
(assert (and (= o (has_key temp___864 k)) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key temp___864 k1) true)) (= (equivalent_keys k1 k) true))) (= o true)))))
