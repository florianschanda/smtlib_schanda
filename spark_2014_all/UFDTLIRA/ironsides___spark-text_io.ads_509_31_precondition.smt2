...
(define-fun default_initial_assumption ((temp___expr_793 us_rep1) (temp___skip_top_level_794 Bool)) Bool (and (= (attr__constrained temp___expr_793) false) (= (to_rep1 (rec__spark__text_io__character_result__status (us_split_discrs1 temp___expr_793))) 3)))
...
(define-fun dynamic_invariant1 ((temp___expr_718 Int) (temp___is_init_714 Bool) (temp___skip_constant_715 Bool) (temp___do_toplevel_716 Bool) (temp___do_typ_inv_717 Bool)) Bool (=> (or (= temp___is_init_714 true) (<= 0 10)) (in_range1 temp___expr_718)))
...
(define-fun dynamic_invariant2 ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 0 2)) (in_range2 temp___expr_732)))
...
(assert (and (= result1 (is_readable standard_input)) (= (= result1 true) (and (= (is_open standard_input) true) (= (mode__2 standard_input) 0)))))
(assert (= result1 true))
(assert (not (= (is_readable standard_input) true)))
(check-sat)
(exit)
