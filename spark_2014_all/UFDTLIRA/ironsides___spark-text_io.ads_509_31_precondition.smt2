...
(define-fun default_initial_assumption ((temp___expr_786 us_rep1) (temp___skip_top_level_787 Bool)) Bool (and (= (attr__constrained temp___expr_786) false) (= (to_rep1 (rec__spark__text_io__character_result__status (us_split_discrs1 temp___expr_786))) 3)))
...
(define-fun dynamic_invariant1 ((temp___expr_711 Int) (temp___is_init_707 Bool) (temp___skip_constant_708 Bool) (temp___do_toplevel_709 Bool) (temp___do_typ_inv_710 Bool)) Bool (=> (or (= temp___is_init_707 true) (<= 0 10)) (in_range1 temp___expr_711)))
...
(define-fun dynamic_invariant2 ((temp___expr_725 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool) (temp___do_typ_inv_724 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 0 2)) (in_range2 temp___expr_725)))
