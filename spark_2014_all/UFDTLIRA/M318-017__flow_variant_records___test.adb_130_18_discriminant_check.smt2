...
(define-fun dynamic_invariant ((temp___expr_219 us_rep) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (and (=> (not (= temp___skip_constant_217 true)) (in_range3 tmp temp___expr_219)) (= (attr__constrained temp___expr_219) true)))
(define-fun default_initial_assumption1 ((temp___expr_221 us_rep) (temp___skip_top_level_222 Bool)) Bool (and (= (attr__constrained temp___expr_221) true) (= (rec__test__search_result__found (us_split_discrs1 temp___expr_221)) tmp)))
...
(define-fun dynamic_invariant2 ((temp___expr_203 Int) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool)) Bool (=> (or (= temp___is_init_200 true) (<= 0 2)) (in_range2 temp___expr_203)))
...
(declare-const temp___282 Bool)
(declare-const temp___2821 integer)
(declare-const temp___2822 failure_reason)
(declare-const temp___2823 Bool)
(declare-const o3 failure_reason)
(declare-const o4 integer)
(declare-const o5 failure_reason)
(declare-const o6 Bool)
(declare-const o7 integer)
(declare-const o8 failure_reason)
(declare-const o9 Bool)
(declare-const o10 Bool)
(declare-const o11 integer)
(declare-const o12 failure_reason)
(declare-const o13 Bool)
(declare-const o14 Bool)
(declare-const o15 integer)
(declare-const o16 failure_reason)
(declare-const o17 Bool)
(declare-const temp___283 Bool)
(declare-const temp___2831 integer)
(declare-const temp___2832 failure_reason)
(declare-const temp___2833 Bool)
...
(assert (not (= (to_int1 (rec__test__search_result__found r__split_discrs)) 1)))
(assert (= (to_rep1 o3) 0))
(assert (= dummy o4))
(assert (= o3 o5))
(assert (= (of_int 0) o6))
...
(assert (= o8 o5))
(assert (= true o9))
(assert (= (mk___rep (mk___split_discrs o10) (mk___split_fields o11 o12) o13) (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9)))
(assert (not (= tmp o10)))
(check-sat)
(exit)
