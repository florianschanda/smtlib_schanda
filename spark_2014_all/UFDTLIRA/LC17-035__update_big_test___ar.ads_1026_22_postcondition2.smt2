...
(assert (not (= (bool_eq2 (rec__ar__rec4t__f4 (us_split_fields__content3 r__split_fields7)) (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) r__split_fields2)) r__split_fields3)) r__split_fields4))) true)))
(check-sat)
(exit)
