...
(assert (and (= o5 (length orear)) (and (in_range4 o5) (<= o5 (capacity orear)))))
(assert (and (= o6 (length ofront)) (and (in_range4 o6) (<= o6 (capacity ofront)))))
(assert (= o7 (+ o6 o5)))
(assert (and (= o8 (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))) (and (in_range4 o8) (<= o8 (capacity (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))))))
(assert (= result3 (ite (= o8 o7) true false)))
(assert (= result3 true))
(assert (and (= o4 (length (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))) (and (in_range4 o4) (<= o4 (capacity (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))))))
