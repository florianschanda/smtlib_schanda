...
(declare-const temp___475 Bool)
(declare-const temp___4751 unsigned_byte)
(declare-const temp___4752 unsigned_byte)
...
(assert (= (bool_eq1 (mk___rep1 r__split_fields3) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r_old)) (mk___rep (mk___split_fields (of_rep x) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 r_old))))))))) true))
(assert (= (to_rep o) x))
(assert (= (rec__records_prooffuncs__pair__a (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair r__split_fields3))) o1))
(assert (= o o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= (rec__records_prooffuncs__optional_pair__exists r__split_fields3) o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___475 o5))
(assert (= temp___4751 o6))
(assert (= temp___4752 o7))
(assert (= result (mk___split_fields__ref1 r__split_fields3)))
(assert (= r__split_fields4 (mk___split_fields1 temp___475 (mk___rep (mk___split_fields temp___4751 temp___4752)))))
