...
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (let ((result (find1 container item))) (ite (not (= (contains (model__ container) item) true)) (and (not (= (has_key (positions container) result) true)) (= (bool_eq1 result no_element) true)) (and (and (= (has_key (positions container) result) true) (= (get (positions container) result) (find (elements container) item))) (= (equivalent_elements (element container result) item) true))))) :pattern ((find1 container item))))))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_397 us_rep3) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length2 temp___expr_397) 0)))
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get1 container result)) true))) (dynamic_invariant2 result true false true true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e1 Int)) (and (and (in_range4 e1) (= (contains container e1) true)) (= (equivalent_elements e1 item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant6 result true false true true)))) :pattern ((get container key))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container key))))))
...
(declare-const temp___719 count_type)
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___719 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___719)) no_element))
(assert (in_range2 e))
...
(assert (and (= o5 (find1 s e)) (ite (ite (= (contains (model__ s) e) false) true false) (and (not (= (has_key (positions s) o5) true)) (= (bool_eq1 o5 no_element) true)) (and (and (= (has_key (positions s) o5) true) (= (get (positions s) o5) (find (elements s) e))) (= (equivalent_elements (element s o5) e) true)))))
