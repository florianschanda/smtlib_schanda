...
(assert (and (and (and (= rec____attr__tag us_tag1) (and (and (= (to_rep rec____split_fields) (- 1)) (= (to_rep rec____split_fields1) (- 1))) (= (to_rep rec____split_fields2) (- 1)))) (and (and (= (has_stored_area1 rec____attr__tag (mk___rep (mk___split_fields window__prepare_to_draw__obj__fields window__prepare_to_draw__obj__fields1 window__prepare_to_draw__obj__fields2 window__prepare_to_draw__obj__fields3) rec____attr__tag)) true) (and (and (= result rec____split_fields3) (and (= result1 rec____split_fields4) (and (= result2 rec____split_fields5) (and (= result3 rec____split_fields6) (and (= result4 rec____split_fields7) (= result5 rec____split_fields8)))))) (= (mk___split_fields1 rec____split_fields9 rec____split_fields10 rec____split_fields11 rec____split_fields12 rec____split_fields13 rec____split_fields14) (us_split_fields3 (of_base (mk___rep (mk___split_fields window__prepare_to_draw__obj__fields window__prepare_to_draw__obj__fields1 window__prepare_to_draw__obj__fields2 window__prepare_to_draw__obj__fields3) rec____attr__tag)))))) (and (= total_area1 (- total_area (get_stored_area1 rec____attr__tag (mk___rep (mk___split_fields rec____split_fields9 rec____split_fields10 rec____split_fields11 (hide_ext__ rec____split_fields12 rec____split_fields13 rec____split_fields14)) rec____attr__tag)))) (in_range total_area1)))) (and (and (and (= rec____split_fields15 rec____split_fields9) (and (= rec____split_fields16 rec____split_fields10) (and (= rec____split_fields17 rec____split_fields11) (and (= rec____split_fields18 rec____split_fields12) (and (= rec____split_fields19 rec____split_fields13) (= rec____split_fields20 rec____split_fields14)))))) (= total_area1 total_area2)) (and (= (mk___split_fields1 rec____split_fields21 rec____split_fields22 rec____split_fields23 rec____split_fields24 rec____split_fields25 rec____split_fields26) (mk___split_fields1 rec____split_fields9 rec____split_fields10 rec____split_fields11 rec____split_fields12 rec____split_fields13 rec____split_fields14)) (= total_area3 total_area1)))))
