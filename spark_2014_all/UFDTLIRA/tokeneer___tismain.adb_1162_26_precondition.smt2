...
(assert (=> (= result true) (= o31 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result true) (= o32 (ite (not (= o31 true)) true false))))
(assert (=> (= result true) (= o30 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
...
(assert (=> (= result1 true) (and (= o26 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range1 o26))))
(assert (=> (= result1 true) (= o27 (ite (= o26 0) true false))))
(assert (=> (= result1 true) (= o25 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
...
(assert (=> (= result2 true) (= o23 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result2 true) (= o24 (ite (not (= o23 true)) true false))))
(assert (=> (not (= result2 true)) (= o24 (of_int 1))))
(assert (= o14 (statusiswaitingfinishadminop (us_private__content state48))))
(assert (= o15 (statusiswaitingstartadminop (us_private__content state48))))
(assert (= result3 (ite (= o15 false) o14 true)))
(assert (=> (= result3 true) (and (= o18 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o18))))
(assert (=> (= result3 true) (and (= o19 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range1 o19))))
(assert (=> (= result3 true) (= o20 (ite (= o19 o18) true false))))
(assert (=> (= result3 true) (= o16 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result3 true) (= o17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
...
(assert (= o10 (statusiswaitingremoveadmintokenfail (us_private__content state48))))
(assert (= o11 (statusisgotadmintoken (us_private__content state48))))
(assert (= result4 (ite (= o11 false) o10 true)))
(assert (=> (= result4 true) (= o12 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result4 true) (= o13 (ite (not (= o12 true)) true false))))
(assert (=> (not (= result4 true)) (= o13 (of_int 1))))
(assert (and (= o6 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o6)))
(assert (= o7 (ite (= o6 4) true false)))
(assert (= o8 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))))
(assert (= result5 (ite (= o8 true) o7 false)))
(assert (=> (= result5 true) (= o9 (statusiswaitingstartadminop (us_private__content state48)))))
(assert (=> (not (= result5 true)) (= o9 (of_int 1))))
(assert (= o3 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4)))))
(assert (= result6 (ite (not (= o3 true)) true false)))
(assert (=> (= result6 true) (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
...
(assert (= result7 true))
(assert (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))))
