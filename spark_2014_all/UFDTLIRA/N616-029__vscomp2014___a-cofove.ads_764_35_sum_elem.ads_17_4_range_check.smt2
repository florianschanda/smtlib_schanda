...
(define-fun dynamic_invariant ((temp___expr_209 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 10000)) (in_range1 temp___expr_209)))
...
(define-fun default_initial_assumption ((temp___expr_265 us_rep1) (temp___skip_top_level_266 Bool)) Bool (=> (not (= temp___skip_top_level_266 true)) (= (length temp___expr_265) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= (- 1) 10001)) (in_range5 temp___expr_223)))
...
(define-fun dynamic_invariant2 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 5)) (in_range4 temp___expr_189)))
...
(define-fun dynamic_invariant4 ((temp___expr_229 Int) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (or (= temp___is_init_226 true) (<= 0 10001)) (in_range2 temp___expr_229)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep1 (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 container1))) 10001))
...
(define-fun dynamic_invariant5 ((temp___expr_258 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= (- 1) 10000)) (in_range3 temp___expr_258)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant3 result true false true))) :pattern ((length container1)))))
(assert true)
