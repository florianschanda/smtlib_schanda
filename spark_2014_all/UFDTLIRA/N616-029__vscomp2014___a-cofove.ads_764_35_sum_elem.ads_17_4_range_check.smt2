...
(define-fun element_type__ref___2__projection ((a element_type__ref)) us_rep (element_type__content a))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__sum_elem__partitions__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields2)) us_main_type1 (rec__sum_elem__partitions__vector a))
...
(define-fun us_rep___2__projection ((a us_rep2)) us_split_discrs (us_split_discrs1 a))
...
(define-fun dynamic_invariant ((temp___expr_260 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool) (temp___do_typ_inv_259 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= (- 1) 10001)) (in_range3 temp___expr_260)))
...
(define-fun dynamic_invariant1 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 10000)) (in_range4 temp___expr_244)))
...
(define-fun element_type__ref___projection ((a element_type__ref1)) us_rep (element_type__content1 a))
(declare-const item us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const index1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant2 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 5)) (in_range1 temp___expr_221)))
...
(define-fun capacity ((container1 us_rep2)) Int (ite (= (distinct 1 0) true) (to_rep1 (rec__sum_elem__partitions__vector__capacity (us_split_discrs1 container1))) 10001))
(declare-fun capacity__function_guard (Int us_rep2) Bool)
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant4 result true false true true))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant5 ((temp___expr_300 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= (- 1) 10000)) (in_range5 temp___expr_300)))
...
(assert (in_range4 index1))
(assert (and (= o (last (model__ container))) (and (in_range3 o) (= o (last (model__ container))))))
(assert (= result (ite (<= index1 o) true false)))
(assert (not (= result true)))
(assert (and (= o1 (last (model__ container))) (and (in_range3 o1) (= o1 (last (model__ container))))))
