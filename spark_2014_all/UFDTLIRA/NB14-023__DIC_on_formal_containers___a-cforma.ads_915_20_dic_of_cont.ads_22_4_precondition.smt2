...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1154 Int) (temp___is_init_1151 Bool) (temp___skip_constant_1152 Bool) (temp___do_toplevel_1153 Bool)) Bool (=> (or (= temp___is_init_1151 true) (<= 1 2147483647)) (in_range2 temp___expr_1154)))
...
(define-fun default_initial_assumption ((temp___expr_1161 us_rep2) (temp___skip_top_level_1162 Bool)) Bool (=> (not (= temp___skip_top_level_1162 true)) (and (= (is_empty temp___expr_1161) true) (= (length2 temp___expr_1161) 0))))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs1 container)))))))
