...
(define-fun default_initial_assumption ((temp___expr_1248 us_rep2) (temp___skip_top_level_1249 Bool)) Bool (=> (not (= temp___skip_top_level_1249 true)) (and (= (is_empty temp___expr_1248) true) (= (length2 temp___expr_1248) 0))))
...
(declare-const temp___2183 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___2183 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___2183)) no_element))
