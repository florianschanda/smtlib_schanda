...
(declare-const temp___312 unsigned_byte)
(declare-const temp___3121 unsigned_byte)
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___312 o2))
(assert (= temp___3121 o3))
(assert (= (mk___rep (mk___split_fields temp___312 temp___3121)) null_pair))
...
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true)) (= (to_rep o5) 1)))
