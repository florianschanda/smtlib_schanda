...
(assert (and (= o9 (has_key (positions l) (mk___rep1 cu__split_fields3))) (= (= o9 true) (= (has_key (positions l) (mk___rep1 cu__split_fields3)) true))))
(assert (= result5 (ite (not (= o9 true)) true false)))
(assert (not (= result5 true)))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (- (get1 (positions l) (mk___rep1 cu__split_fields3)) 1)))
