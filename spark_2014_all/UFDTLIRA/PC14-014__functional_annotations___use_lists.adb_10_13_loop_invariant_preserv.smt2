...
(assert (and (= result1 (has_key (positions l) (mk___rep1 cu__split_fields4))) (= (= result1 true) (= (has_key (positions l) (mk___rep1 cu__split_fields4)) true))))
(assert (= result1 true))
...
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions l) (mk___rep1 cu__split_fields2)) (length2 l)) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions l) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions l) (mk___rep1 cu__split_fields3)) (+ (get1 (positions l) (mk___rep1 cu__split_fields2)) 1)))))
(assert (and (= o3 (has_key (positions l) (mk___rep1 cu__split_fields3))) (= (= o3 true) (= (has_key (positions l) (mk___rep1 cu__split_fields3)) true))))
