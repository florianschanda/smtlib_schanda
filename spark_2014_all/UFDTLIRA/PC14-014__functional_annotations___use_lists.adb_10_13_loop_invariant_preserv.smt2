...
(assert (and (= result1 (has_key (positions l) (mk___rep cu__split_fields5))) (= (= result1 true) (= (has_key (positions l) (mk___rep cu__split_fields5)) true))))
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) (mk___rep cu__split_fields4)) 1))) (not (= (get (model__ l) i) e)))))
(assert (= (has_key (positions l) (mk___rep cu__split_fields4)) true))
...
(assert (and (= o1 (has_key (positions l) (mk___rep cu__split_fields3))) (= (= o1 true) (= (has_key (positions l) (mk___rep cu__split_fields3)) true))))
