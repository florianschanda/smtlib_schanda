...
(assert (not (< (length (mk___rep l__split_discrs l__split_fields5)) (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs)))))
(check-sat)
(exit)
