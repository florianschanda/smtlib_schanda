...
(define-fun l__split_fields5 () us_split_fields (mk___split_fields l__split_fields4))
(define-fun l__split_fields6 () us_split_fields (mk___split_fields l__split_fields3))
(define-fun l__split_fields7 () us_split_fields (mk___split_fields l__split_fields2))
(define-fun l__split_fields8 () us_split_fields (mk___split_fields l__split_fields1))
...
(assert (and (= (length (mk___rep l__split_discrs l__split_fields8)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (ite (= (bool_eq2 cu no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs l__split_fields8)) (last1 (mk___rep l__split_discrs l__split_fields8))) (length (mk___rep l__split_discrs l__split_fields8))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields8)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (last1 (mk___rep l__split_discrs l__split_fields8))) true)) (= (ole1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields8))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields8)) (length (mk___rep l__split_discrs l__split_fields8))) 0)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields8))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields8)) 1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields8)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields8)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu)) 0)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields8)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu) 1) true)))))
