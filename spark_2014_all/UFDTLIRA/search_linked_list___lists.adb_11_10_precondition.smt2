...
(declare-const lists__search__result count_type)
...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) (mk___rep c__split_fields3)) 1))) (not (= (get (model__ l) i) 0)))))
(assert (= (has_key (positions l) (mk___rep c__split_fields3)) true))
(assert (and (= o (element l (mk___rep c__split_fields3))) (and (in_range5 o) (= o (get (model__ l) (get1 (positions l) (mk___rep c__split_fields3)))))))
(assert (= result2 (ite (= o 0) true false)))
(assert (not (= result2 true)))
(assert (= lists__search__result1 (mk___rep (mk___split_fields lists__search__result))))
(assert (not (or (= (has_key (positions l) (mk___rep c__split_fields3)) true) (= (bool_eq1 (mk___rep c__split_fields3) no_element) true))))
(check-sat)
(exit)
