...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) (mk___rep1 c__split_fields2)) 1))) (not (= (get (model__ l) i) 0)))))
(assert (= (has_key (positions l) (mk___rep1 c__split_fields2)) true))
(assert (and (= o2 (element l (mk___rep1 c__split_fields2))) (and (in_range5 o2) (= o2 (get (model__ l) (get1 (positions l) (mk___rep1 c__split_fields2)))))))
(assert (= result2 (ite (= o2 0) true false)))
(assert (not (= result2 true)))
(assert (= lists__search__result1 lists__search__result))
(assert (not (or (= (has_key (positions l) (mk___rep1 c__split_fields2)) true) (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) true))))
(check-sat)
(exit)
