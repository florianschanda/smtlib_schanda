...
(assert (and (= o14 (element l (mk___rep1 c__split_fields2))) (and (in_range5 o14) (= o14 (get (model__ l) (get1 (positions l) (mk___rep1 c__split_fields2)))))))
(assert (= result5 (ite (= o14 0) true false)))
(assert (not (= result5 true)))
(assert (= lists__search__result3 lists__search__result2))
