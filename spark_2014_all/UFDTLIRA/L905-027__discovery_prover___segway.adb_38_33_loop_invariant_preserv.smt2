...
(assert (and (and (in_range2 speed2) (in_range1 state2)) (not (= state2 0))))
(assert (=> (< 0 speed2) (and (= (speed_is_valid speed3 state3) true) (and (in_range2 speed3) (in_range1 state3)))))
(assert (=> (not (< 0 speed2)) (and (= (speed_is_valid speed4 state4) true) (and (in_range2 speed4) (in_range1 state4)))))
(assert (=> (not (< 0 speed2)) (= state3 state4)))
(assert (=> (not (< 0 speed2)) (= speed3 speed4)))
(assert (not (= state3 0)))
(assert (not (= (speed_is_valid speed3 state3) true)))
(check-sat)
(exit)
