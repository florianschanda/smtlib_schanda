...
(assert (not (not (and (and (and (= o11 (get (model__ (mk___rep1 v__split_discrs v__split_fields10)) 2)) (= (let ((temp___426 (get (model__ (mk___rep1 v__split_discrs v__split_fields10)) 2))) (ite (= (attr__tag o11) (attr__tag temp___426)) (us_dispatch_eq o11 temp___426) false)) true)) (and (and (= (length (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__replace_element__container__fields1)) (length (mk___rep1 v__split_discrs v__split_fields10))) (= (let ((temp___430 (get (model__ (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__replace_element__container__fields1)) 1))) (ite (= (attr__tag temp___430) (attr__tag o11)) (us_dispatch_eq temp___430 o11) false)) true)) (= (equal_except (model__ (mk___rep1 v__split_discrs v__split_fields10)) (model__ (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__replace_element__container__fields1)) 1) true))) (and (= result11 (mk___split_fields__ref1 v__split_fields10)) (= v__split_fields11 indefinite_unbounded_tagged__vect__replace_element__container__fields1))))))
(check-sat)
(exit)
