...
(assert (=> (<= 0 b) (= i4 1)))
(assert (=> (<= 0 b) (=> (and (<= 1 i4) (<= i4 b)) (= temp___193 i4))))
(assert (=> (<= 0 b) (=> (and (<= 1 i4) (<= i4 b)) (= temp___192 r1))))
(assert (=> (<= 0 b) (=> (and (<= 1 i4) (<= i4 b)) (= temp___194 b))))
...
(assert (=> (<= 0 b) (=> (and (<= 1 i4) (<= i4 b)) (and (= r3 (+ a i5)) (= b temp___194)))))
...
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (= temp___188 i10))))
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (= temp___187 r1))))
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (= temp___189 b))))
...
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (and (= r9 (+ a i11)) (= b temp___189)))))
