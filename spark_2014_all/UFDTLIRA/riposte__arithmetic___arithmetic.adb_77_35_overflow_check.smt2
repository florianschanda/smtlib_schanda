...
(assert (=> (<= 0 b) (=> (and (<= 1 i4) (<= i4 b)) (and (= r3 (+ a i5)) (= b temp___168)))))
...
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (= temp___162 i10))))
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (= temp___161 r1))))
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (= temp___163 b))))
...
(assert (=> (not (<= 0 b)) (=> (and (<= b i10) (<= i10 (- 1))) (and (= r9 (+ a i11)) (= b temp___163)))))
