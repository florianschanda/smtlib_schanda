...
(define-fun dynamic_invariant1 ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 1 8)) (in_range2 temp___expr_161)))
(declare-sort map1 0)
...
(assert (<= 1 l))
(assert (<= l 8))
(assert (or (or (not (= i j)) (not (= i k))) (not (= i l))))
(assert (not (= (to_rep (get a2 j k l)) (to_rep (get a j j j)))))
(check-sat)
(exit)
