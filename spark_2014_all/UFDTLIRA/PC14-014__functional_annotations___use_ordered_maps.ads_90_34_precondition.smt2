...
(assert (and (= o (length (mk___rep m__split_discrs (mk___split_fields m__split_fields)))) (and (in_range2 o) (<= o (to_rep (rec__use_ordered_maps__my_maps__map__capacity m__split_discrs))))))
