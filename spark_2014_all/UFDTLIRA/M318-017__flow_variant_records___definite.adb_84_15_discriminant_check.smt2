...
(define-fun dynamic_invariant1 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 2)) (in_range2 temp___expr_135)))
...
(declare-const temp___180 status)
(declare-const temp___1801 natural)
(declare-const temp___1802 natural)
(declare-const temp___1803 Bool)
(declare-const temp___1804 Bool)
...
(declare-const temp___186 status)
(declare-const temp___1861 natural)
(declare-const temp___1862 natural)
(declare-const temp___1863 Bool)
(declare-const temp___1864 Bool)
(assert (= g__attr__constrained false))
(assert (not (= (to_rep1 g__split_discrs) 0)))
(assert (not (= (to_rep1 g__split_discrs) 1)))
(assert (= (to_rep o14) 0))
(assert (= o14 o15))
(assert (= dummy o16))
(assert (= true o17))
...
(assert (= o13 o18))
(assert (= temp___186 o18))
(assert (= temp___1861 o15))
(assert (= temp___1862 o16))
(assert (= temp___1863 o17))
(assert (= true temp___1864))
(assert (= g__attr__constrained true))
(assert (not (= temp___186 g__split_discrs)))
(check-sat)
(exit)
