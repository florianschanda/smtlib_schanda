...
(declare-const temp___310 unsigned_byte)
...
(assert (= (mk___rep (mk___split_fields temp___310 temp___3101)) null_pair))
...
(assert (= records__is_valid__result1 (ite (or (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 a)) true) (= (bool_eq (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 a)) null_pair) true)) true false)))
(assert (= (mk_bool__ref records__is_valid__result4) (mk_bool__ref records__is_valid__result2)))
