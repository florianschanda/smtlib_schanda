...
(define-fun dynamic_invariant3 ((temp___expr_406 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 2147483647)) (in_range5 temp___expr_406)))
