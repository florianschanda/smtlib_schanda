...
(declare-const p__create_type_6__result type_6__ref)
...
(declare-const o11 us_split_fields8)
(declare-const o12 us_rep4)
(declare-const result type_6__ref)
(declare-const p__create_type_6__result1 us_rep4)
(declare-const p__create_type_6__result2 type_6__ref)
(declare-const p__create_type_6__result3 us_rep4)
(declare-const p__create_type_6__result4 type_6__ref)
(declare-const p__create_type_6__result5 us_rep4)
(define-fun o13 () us_rep (mk___rep (mk___split_fields o3 o4 o5 o6 o7 o8 o9 o10)))
(declare-const result1 us_rep4)
(assert (= p__create_type_6__result2 (let ((subject p__create_type_6__result)) (mk_type_6__ref p__create_type_6__result1))))
(assert (= p__create_type_6__result3 p__create_type_6__result1))
...
(assert (and (= o2 (create_type_5 Tuple0)) (and (= (to_rep1 (rec__p__type_5__field_0 (us_split_fields7 o2))) 0) (and (= (bool_eq2 (rec__p__type_5__field_1 (us_split_fields7 o2)) (create_type_4 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_5__field_2 (us_split_fields7 o2)) (create_type_2 Tuple0)) true) (and (= (bool_eq2 (rec__p__type_5__field_3 (us_split_fields7 o2)) (create_type_4 Tuple0)) true) (= (bool_eq2 (rec__p__type_5__field_4 (us_split_fields7 o2)) (create_type_4 Tuple0)) true)))))))
(assert (and (= o13 (create_type_1 Tuple0)) (and (= (to_rep o3) 0) (and (= (to_rep o4) 0) (and (= (to_rep o5) 0) (and (= (to_rep o6) 0) (and (= (to_rep o7) 0) (and (= (to_rep o8) 0) (and (= (to_rep o9) 0) (= (to_rep o10) 0))))))))))
(assert (= o11 (mk___split_fields4 o13 o2 o1 o)))
(assert (= o12 (mk___rep4 o11)))
(assert (= result p__create_type_6__result))
(assert (= (let ((subject p__create_type_6__result)) p__create_type_6__result1) o12))
(assert (= p__create_type_6__result4 p__create_type_6__result2))
(assert (= p__create_type_6__result5 p__create_type_6__result3))
(assert (= result1 (type_6__content p__create_type_6__result4)))
(assert (not (= (bool_eq3 (rec__p__type_6__field_1 (us_split_fields9 (type_6__content p__create_type_6__result4))) (create_type_5 Tuple0)) true)))
(check-sat)
(exit)
