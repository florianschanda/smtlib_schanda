...
(define-fun dynamic_invariant1 ((temp___expr_142 us_rep) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (not (= temp___skip_constant_140 true)) (in_range1 input temp___expr_142)))
(define-fun default_initial_assumption ((temp___expr_144 us_rep) (temp___skip_top_level_145 Bool)) Bool (= (to_rep (rec__p__t__discr (us_split_discrs1 temp___expr_144))) input))
