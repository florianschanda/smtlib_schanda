...
(assert (forall ((i my_int)) (and (<= 1 (my_intqtint i)) (<= (my_intqtint i) 100))))
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 100)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq7 (my_int my_int) Bool)
(declare-const dummy7 my_int)
...
(define-fun dynamic_invariant2 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 1 100)) (in_range4 temp___expr_214)))
...
(assert (forall ((i1 positive_count_type)) (and (<= 1 (positive_count_typeqtint i1)) (<= (positive_count_typeqtint i1) 2147483647))))
...
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq4 a b) (oeq a b)) :pattern ((user_eq4 a b)))))
...
(assert (forall ((i1 element_type1)) (and (<= 1 (element_typeqtint1 i1)) (<= (element_typeqtint1 i1) 100))))
...
(assert (and (= o8 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) o9)) (and (in_range2 o8) (= o8 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) o9))))))
(assert (= result (ite (= o8 i) true false)))
(assert (= result true))
(assert (and (= o3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range1 o3) (<= o3 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
(assert (= o4 (+ o3 1)))
(assert (and (= o5 o4) (in_range3 o4)))
(assert (and (= o6 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (in_range1 o6) (<= o6 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
...
(assert (= result2 true))
(assert (and (= o2 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) c1)) (and (in_range2 o2) (= o2 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1))))))
