...
(assert (and (= o4 (get (model__ left) o3)) (and (in_range4 o4) (= o4 (get (model__ left) o3)))))
...
(assert (<= 1 i))
(assert (<= i idx3))
(assert (not (= (get (model__ (mk___rep result____split_discrs result____split_fields3)) i) (get (model__ left) i))))
(check-sat)
(exit)
