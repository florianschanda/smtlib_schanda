...
(define-fun dynamic_invariant ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range2 temp___expr_184)))
...
(define-fun dynamic_invariant1 ((temp___expr_766 Int) (temp___is_init_762 Bool) (temp___skip_constant_763 Bool) (temp___do_toplevel_764 Bool) (temp___do_typ_inv_765 Bool)) Bool (=> (or (= temp___is_init_762 true) (<= 1 2147483647)) (in_range3 temp___expr_766)))
...
(define-fun dynamic_invariant3 ((temp___expr_780 Int) (temp___is_init_776 Bool) (temp___skip_constant_777 Bool) (temp___do_toplevel_778 Bool) (temp___do_typ_inv_779 Bool)) Bool (=> (or (= temp___is_init_776 true) (<= 0 2147483647)) (in_range5 temp___expr_780)))
...
(define-fun default_initial_assumption ((temp___expr_819 us_rep1) (temp___skip_top_level_820 Bool)) Bool (=> (not (= temp___skip_top_level_820 true)) (= (length1 temp___expr_819) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_811 Int) (temp___is_init_807 Bool) (temp___skip_constant_808 Bool) (temp___do_toplevel_809 Bool) (temp___do_typ_inv_810 Bool)) Bool (=> (or (= temp___is_init_807 true) (<= 0 2147483647)) (in_range6 temp___expr_811)))
...
(define-fun dynamic_invariant5 ((temp___expr_804 Int) (temp___is_init_800 Bool) (temp___skip_constant_801 Bool) (temp___do_toplevel_802 Bool) (temp___do_typ_inv_803 Bool)) Bool (=> (or (= temp___is_init_800 true) (<= 1 2147483647)) (in_range7 temp___expr_804)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o) (= o (ite (= (distinct 1 0) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
