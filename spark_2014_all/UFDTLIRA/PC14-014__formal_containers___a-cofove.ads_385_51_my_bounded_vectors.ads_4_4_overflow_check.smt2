...
(define-fun dynamic_invariant1 ((temp___expr_688 Int) (temp___is_init_685 Bool) (temp___skip_constant_686 Bool) (temp___do_toplevel_687 Bool)) Bool (=> (or (= temp___is_init_685 true) (<= 1 2147483647)) (in_range3 temp___expr_688)))
...
(define-fun dynamic_invariant3 ((temp___expr_700 Int) (temp___is_init_697 Bool) (temp___skip_constant_698 Bool) (temp___do_toplevel_699 Bool)) Bool (=> (or (= temp___is_init_697 true) (<= 0 2147483647)) (in_range5 temp___expr_700)))
...
(define-fun default_initial_assumption ((temp___expr_734 us_rep1) (temp___skip_top_level_735 Bool)) Bool (=> (not (= temp___skip_top_level_735 true)) (= (length1 temp___expr_734) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_727 Int) (temp___is_init_724 Bool) (temp___skip_constant_725 Bool) (temp___do_toplevel_726 Bool)) Bool (=> (or (= temp___is_init_724 true) (<= 0 2147483647)) (in_range6 temp___expr_727)))
...
(define-fun dynamic_invariant5 ((temp___expr_721 Int) (temp___is_init_718 Bool) (temp___skip_constant_719 Bool) (temp___do_toplevel_720 Bool)) Bool (=> (or (= temp___is_init_718 true) (<= 1 2147483647)) (in_range7 temp___expr_721)))
