...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 2147483647)) (in_range2 temp___expr_160)))
...
(define-fun dynamic_invariant1 ((temp___expr_682 Int) (temp___is_init_679 Bool) (temp___skip_constant_680 Bool) (temp___do_toplevel_681 Bool)) Bool (=> (or (= temp___is_init_679 true) (<= 1 2147483647)) (in_range3 temp___expr_682)))
...
(define-fun dynamic_invariant3 ((temp___expr_694 Int) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool)) Bool (=> (or (= temp___is_init_691 true) (<= 0 2147483647)) (in_range5 temp___expr_694)))
...
(define-fun default_initial_assumption ((temp___expr_728 us_rep1) (temp___skip_top_level_729 Bool)) Bool (=> (not (= temp___skip_top_level_729 true)) (= (length1 temp___expr_728) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_721 Int) (temp___is_init_718 Bool) (temp___skip_constant_719 Bool) (temp___do_toplevel_720 Bool)) Bool (=> (or (= temp___is_init_718 true) (<= 0 2147483647)) (in_range6 temp___expr_721)))
...
(define-fun dynamic_invariant5 ((temp___expr_715 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 1 2147483647)) (in_range7 temp___expr_715)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o) (= o (ite (= (of_int 1) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
