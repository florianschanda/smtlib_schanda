...
(define-fun default_initial_assumption1 ((temp___expr_426 us_rep2) (temp___skip_top_level_427 Bool)) Bool (=> (not (= temp___skip_top_level_427 true)) (and (= (is_empty temp___expr_426) true) (= (length1 temp___expr_426) 0))))
...
(declare-const temp___1878 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1878 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1878)) no_element))
