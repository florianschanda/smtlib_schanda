...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (= o6 (+ formal 1)) (in_range1 (+ formal 1))))
(assert (= (mk_int__ref result1) (mk_int__ref formal)))
(assert (= formal2 o6))
(assert (< 0 (+ formal3 (ghost_func Tuple0))))
(assert (and (and (in_range1 formal3) (=> (<= 1 2) (in_range2 i2))) (and (<= 1 i2) (<= i2 2))))
(assert (= temp___1361 result2))
(assert (= temp___1362 (+ formal3 (ghost_func Tuple0))))
(assert (not (= i2 2)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (and (= o10 (+ formal3 1)) (in_range1 (+ formal3 1))))
(assert (= formal3 result4))
(assert (= formal4 o10))
(assert (and (= o11 (ghost_func Tuple0)) (in_range1 o11)))
(assert (= o12 (+ formal4 o11)))
