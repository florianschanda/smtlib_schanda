...
(assert (not (= (test_element (mk___rep l1__split_discrs l1__split_fields3) (next (mk___rep l2__split_discrs l2__split_fields4) (first (mk___rep l2__split_discrs l2__split_fields4))) 3) true)))
(check-sat)
(exit)
