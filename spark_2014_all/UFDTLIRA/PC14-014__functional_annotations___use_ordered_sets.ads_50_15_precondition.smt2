...
(assert (and (and (let ((temp___738 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((temp___737 Int)) (=> (and (in_range3 temp___737) (= (iter_has_element temp___738 temp___737) true)) (= (prop__ (get temp___738 temp___737)) true)))) (let ((temp___740 (elements s2))) (forall ((temp___739 Int)) (=> (and (in_range3 temp___739) (= (iter_has_element temp___740 temp___739) true)) (= (prop__ (get temp___740 temp___739)) true))))) (< (length s2) (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs)) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))))
...
(assert (and (= temp___724 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))) (and (and (and (= (length2 temp___724) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element temp___724 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (get temp___724 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) item) true)) (and (< 0 (find temp___724 item)) (= (equivalent_elements (get temp___724 (find temp___724 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))) (and (= (find temp___724 (get temp___724 i)) i) (= (e_is_find temp___724 (get temp___724 i) i) true)))))))
(assert (and (= o10 (iter_has_element temp___724 temp___723)) (= (= o10 true) (and (<= 1 temp___723) (<= temp___723 (last temp___724))))))
(assert (= (= o11 true) (in_range3 temp___723)))
(assert (= result2 (ite (= o11 true) o10 false)))
(assert (= result2 true))
(assert (not (<= 1 temp___723)))
(check-sat)
(exit)
