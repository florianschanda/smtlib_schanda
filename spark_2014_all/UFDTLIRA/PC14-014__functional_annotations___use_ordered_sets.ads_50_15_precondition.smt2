...
(assert (and (and (let ((temp___780 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (forall ((temp___779 Int)) (=> (and (in_range3 temp___779) (= (iter_has_element temp___780 temp___779) true)) (= (prop__ (get temp___780 temp___779)) true)))) (let ((temp___782 (elements s2))) (forall ((temp___781 Int)) (=> (and (in_range3 temp___781) (= (iter_has_element temp___782 temp___781) true)) (= (prop__ (get temp___782 temp___781)) true))))) (< (length s2) (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs)) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))))
...
(assert (and (= temp___766 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))) (and (and (and (= (length2 temp___766) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element temp___766 temp___432) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (get temp___766 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) item) true)) (and (< 0 (find temp___766 item)) (= (equivalent_elements (get temp___766 (find temp___766 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))) (and (= (find temp___766 (get temp___766 i)) i) (= (e_is_find temp___766 (get temp___766 i) i) true)))))))
(assert (and (= o (iter_has_element temp___766 temp___765)) (= (= o true) (and (<= 1 temp___765) (<= temp___765 (last temp___766))))))
(assert (= (= o1 true) (in_range3 temp___765)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 temp___765)))
(check-sat)
(exit)
