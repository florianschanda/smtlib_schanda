...
(assert (not (not (= (bool_eq (mk___rep (mk___split_fields current_date__split_fields3 current_date__split_fields4 current_date__split_fields5)) (maximum_date Tuple0)) true))))
(check-sat)
(exit)
