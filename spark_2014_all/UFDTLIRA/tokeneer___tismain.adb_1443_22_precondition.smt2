...
(assert (=> (= result1 true) (= o33 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result1 true) (= o34 (ite (not (= o33 true)) true false))))
(assert (=> (= result1 true) (= o32 (ispresent (mk___rep theadmin__split_fields2)))))
...
(assert (=> (= result2 true) (and (= o28 (rolepresent (mk___rep theadmin__split_fields2))) (in_range1 o28))))
(assert (=> (= result2 true) (= o29 (ite (= o28 0) true false))))
(assert (=> (= result2 true) (= o27 (isdoingop (mk___rep theadmin__split_fields2)))))
...
(assert (=> (= result3 true) (= o25 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result3 true) (= o26 (ite (not (= o25 true)) true false))))
(assert (=> (not (= result3 true)) (= o26 (of_int 1))))
(assert (= o20 (statusiswaitingfinishadminop (let ((subject state)) state12))))
(assert (= o21 (statusiswaitingstartadminop (let ((subject state)) state12))))
(assert (= result4 (ite (= o21 false) o20 true)))
(assert (=> (= result4 true) (= o22 (ispresent (mk___rep theadmin__split_fields2)))))
(assert (=> (= result4 true) (= o23 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result4 true) (= o24 (ite (= o23 true) o22 false))))
(assert (=> (not (= result4 true)) (= o24 (of_int 1))))
(assert (= o16 (statusiswaitingremoveadmintokenfail (let ((subject state)) state12))))
(assert (= o17 (statusisgotadmintoken (let ((subject state)) state12))))
(assert (= result5 (ite (= o17 false) o16 true)))
(assert (=> (= result5 true) (= o18 (ispresent (mk___rep theadmin__split_fields2)))))
(assert (=> (= result5 true) (= o19 (ite (not (= o18 true)) true false))))
(assert (=> (not (= result5 true)) (= o19 (of_int 1))))
(assert (and (= o12 (thecurrentop (mk___rep theadmin__split_fields2))) (in_range3 o12)))
(assert (= o13 (ite (= o12 4) true false)))
(assert (= o14 (isdoingop (mk___rep theadmin__split_fields2))))
(assert (= result6 (ite (= o14 true) o13 false)))
(assert (=> (= result6 true) (= o15 (statusiswaitingstartadminop (let ((subject state)) state12)))))
(assert (=> (not (= result6 true)) (= o15 (of_int 1))))
(assert (= o9 (ispresent (mk___rep theadmin__split_fields2))))
(assert (= result7 (ite (not (= o9 true)) true false)))
(assert (=> (= result7 true) (= o10 (isdoingop (mk___rep theadmin__split_fields2)))))
...
(assert (=> (= result8 true) (= o5 (isdoingop (mk___rep theadmin__split_fields2)))))
(assert (=> (= result8 true) (= o6 (ite (not (= o5 true)) true false))))
(assert (=> (= result8 true) (and (= o2 (thecurrentop (mk___rep theadmin__split_fields2))) (in_range3 o2))))
(assert (=> (= result8 true) (= o3 (ite (= o2 3) true false))))
(assert (=> (= result8 true) (= o4 (isdoingop (mk___rep theadmin__split_fields2)))))
