...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range5 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_353)))
...
(define-fun dynamic_invariant4 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_382)))
...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity target__split_discrs)) o)))
