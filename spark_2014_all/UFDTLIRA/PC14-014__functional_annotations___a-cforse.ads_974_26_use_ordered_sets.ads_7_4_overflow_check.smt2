...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity target__split_discrs))))))
