...
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_321)))
...
(define-fun dynamic_invariant4 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_346)))
...
(assert (and (= o5 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o5) (<= o5 (to_rep (rec__use_ordered_sets__my_sets__set__capacity target__split_discrs))))))
(assert (= o6 (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity target__split_discrs)) o5)))
