...
(define-fun dynamic_invariant ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1 100)) (in_range1 temp___expr_286)))
...
(define-fun dynamic_invariant1 ((temp___expr_293 Int) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool) (temp___do_typ_inv_292 Bool)) Bool (=> (or (= temp___is_init_289 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_293)))
...
(define-fun default_initial_assumption ((temp___expr_346 us_rep1) (temp___skip_top_level_347 Bool)) Bool (=> (not (= temp___skip_top_level_347 true)) (= (length temp___expr_346) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_300 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 101)) (in_range5 temp___expr_300)))
...
(define-fun dynamic_invariant3 ((temp___expr_230 Int) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool) (temp___do_typ_inv_229 Bool)) Bool (=> (or (= temp___is_init_226 true) (<= 0 2147483647)) (in_range6 temp___expr_230)))
(define-fun dynamic_invariant4 ((temp___expr_307 Int) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool) (temp___do_typ_inv_306 Bool)) Bool (=> (or (= temp___is_init_303 true) (<= 0 100)) (in_range3 temp___expr_307)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__list__my_lists__vector__capacity (us_split_discrs1 container1))) 100))
...
(define-fun dynamic_invariant5 ((temp___expr_338 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool) (temp___do_typ_inv_337 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 0 100)) (in_range4 temp___expr_338)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ 0 result) 100) (dynamic_invariant3 result true false true true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_331 Int) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool (=> (or (= temp___is_init_327 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_331)))
