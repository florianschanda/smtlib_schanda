...
(assert (=> (= x__split_fields true) (= x__split_fields4 (mk___split_fields1 temp___355 (mk___rep (mk___split_fields temp___3551 temp___3552))))))
...
(assert (=> (= x__split_fields true) (= temp___358 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)))))))
(assert (=> (= x__split_fields true) (= result2 (mk___split_fields__ref1 x__split_fields4))))
(assert (=> (= x__split_fields true) (= x__split_fields5 (us_split_fields3 temp___358))))
