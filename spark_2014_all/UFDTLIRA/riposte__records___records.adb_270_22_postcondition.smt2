...
(declare-const temp___3881 unsigned_byte)
(declare-const temp___3882 unsigned_byte)
...
(declare-const temp___391 us_rep1)
...
(assert (=> (= x__split_fields true) (= temp___388 o5)))
(assert (=> (= x__split_fields true) (= temp___3881 o6)))
(assert (=> (= x__split_fields true) (= temp___3882 o7)))
...
(assert (=> (= x__split_fields true) (= x__split_fields4 (mk___split_fields1 temp___388 (mk___rep (mk___split_fields temp___3881 temp___3882))))))
...
(assert (=> (= x__split_fields true) (= temp___391 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)))))))
(assert (=> (= x__split_fields true) (= result2 (mk___split_fields__ref1 x__split_fields4))))
(assert (=> (= x__split_fields true) (= x__split_fields5 (us_split_fields3 temp___391))))
...
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 x__split_fields6)) (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields2 x__split_fields1))))) true)))
(check-sat)
(exit)
