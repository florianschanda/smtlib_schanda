...
(assert (and (and (and (and (= o (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (and (in_range6 o) (= o (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))) (and (= (mk_int__ref result) (mk_int__ref e)) (= e1 o))) (and (in_range1 e1) (and (and (= (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (- (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (olt (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (and (and (= (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) 1)) (= (olt (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) true)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ (last (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1)))) 1)) e1))))) (and (and (= e1 e2) (= l__split_fields3 l__split_fields2)) (and (= e3 e1) (= (mk___split_fields l__split_fields4) (mk___split_fields l__split_fields2))))))
