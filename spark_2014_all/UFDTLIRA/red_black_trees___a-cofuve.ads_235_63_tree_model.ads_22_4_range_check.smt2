...
(define-fun dynamic_invariant ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 1 2147483647)) (in_range2 temp___expr_178)))
...
(define-fun dynamic_invariant1 ((temp___expr_190 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= 0 2147483647)) (in_range3 temp___expr_190)))
...
(define-fun dynamic_invariant3 ((temp___expr_184 Int) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (or (= temp___is_init_181 true) (<= 0 1)) (in_range5 temp___expr_184)))
