...
(define-fun e_smaller_than_range ((container us_rep2) (fst Int) (lst Int) (item us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get container i)) true))) true false))
...
(assert (forall ((container us_rep1)) (! (=> (not (= (is_empty container) true)) (let ((result (first_element container))) (and (= (bool_eq result (get (elements container) 1)) true) (= (e_smaller_than_range (elements container) 2 (length container) result) true)))) :pattern ((first_element container)))))
(assert true)
...
(define-fun e_bigger_than_range ((container1 us_rep2) (fst Int) (lst Int) (item1 us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get container1 i) item1) true))) true false))
