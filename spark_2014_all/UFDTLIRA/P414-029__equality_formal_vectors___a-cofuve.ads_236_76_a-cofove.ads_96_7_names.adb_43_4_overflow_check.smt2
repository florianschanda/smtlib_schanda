...
(assert (and (= o6 (last left)) (and (in_range5 o6) (= o6 (+ 0 (length left))))))
(assert (= result (ite (<= lst o6) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o5 (- (- 2147483648) offset)) (in_range6 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o5 1) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o2 lst) (in_range6 lst)))
(assert (and (= o (length right)) (and (in_range1 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (+ 0 o)))
(assert (and (= o3 o1) (in_range6 o1)))
(assert (= o4 (- o3 o2)))
(assert (not (in_range6 o4)))
(check-sat)
(exit)
