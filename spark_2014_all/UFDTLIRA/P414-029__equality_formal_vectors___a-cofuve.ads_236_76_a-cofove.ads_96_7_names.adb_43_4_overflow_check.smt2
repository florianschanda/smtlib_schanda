...
(define-fun dynamic_invariant ((temp___expr_458 Int) (temp___is_init_455 Bool) (temp___skip_constant_456 Bool) (temp___do_toplevel_457 Bool)) Bool (=> (or (= temp___is_init_455 true) (<= 1 2147483647)) (in_range2 temp___expr_458)))
...
(define-fun dynamic_invariant1 ((temp___expr_473 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 0 2147483647)) (in_range3 temp___expr_473)))
...
(define-fun dynamic_invariant2 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range7 temp___expr_142)))
...
(define-fun dynamic_invariant4 ((temp___expr_256 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 2147483646)) (in_range6 temp___expr_256)))
(define-fun dynamic_invariant5 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range5 temp___expr_180)))
(assert true)
(declare-const o Int)
...
(assert (and (= o1 (length right)) (and (in_range7 o1) (<= (+ 0 o1) 2147483647))))
(assert (= o2 (+ 0 o1)))
