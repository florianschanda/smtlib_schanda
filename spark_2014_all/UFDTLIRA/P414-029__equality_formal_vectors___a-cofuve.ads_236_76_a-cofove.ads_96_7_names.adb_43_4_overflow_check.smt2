...
(define-fun dynamic_invariant ((temp___expr_515 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool) (temp___do_typ_inv_514 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 2147483647)) (in_range2 temp___expr_515)))
...
(define-fun dynamic_invariant1 ((temp___expr_532 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool) (temp___do_typ_inv_531 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= 0 2147483647)) (in_range3 temp___expr_532)))
...
(define-fun default_initial_assumption ((temp___expr_540 us_rep) (temp___skip_top_level_541 Bool)) Bool (=> (not (= temp___skip_top_level_541 true)) (= (length temp___expr_540) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range7 temp___expr_166)))
...
(define-fun dynamic_invariant4 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range6 temp___expr_296)))
...
(assert (and (= o6 (last left)) (and (in_range3 o6) (= o6 (+ 0 (length left))))))
(assert (= result (ite (<= lst o6) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o5 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o5 1) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o2 lst) (in_range1 lst)))
(assert (and (= o (length right)) (and (in_range7 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (+ 0 o)))
