...
(define-fun dynamic_invariant1 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_321)))
(declare-fun is_empty (us_rep1) Bool)
(declare-fun is_empty__function_guard (Bool us_rep1) Bool)
(define-fun default_initial_assumption ((temp___expr_328 us_rep1) (temp___skip_top_level_329 Bool)) Bool (=> (not (= temp___skip_top_level_329 true)) (= (is_empty temp___expr_328) true)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant2 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_346)))
(define-fun dynamic_invariant3 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range4 temp___expr_352)))
...
(define-fun default_initial_assumption1 ((temp___expr_359 us_rep2) (temp___skip_top_level_360 Bool)) Bool (=> (not (= temp___skip_top_level_360 true)) (= (length2 temp___expr_359) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___393 Int)) (=> (and (in_range4 temp___393) (= (iter_has_element result temp___393) true)) (= (contains (model__ container) (get result temp___393)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 1 2147483647)) (in_range7 temp___expr_315)))
...
(define-fun default_initial_assumption2 ((temp___expr_379 us_rep3) (temp___skip_top_level_380 Bool)) Bool (=> (not (= temp___skip_top_level_380 true)) (and (= (is_empty1 temp___expr_379) true) (= (length4 temp___expr_379) 0))))
...
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range3 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(assert (forall ((container us_rep3)) (forall ((key us_rep4)) (! (=> (= (of_int 0) true) (=> (exists ((k us_rep4)) (and (= (has_key container k) true) (= (bool_eq4 k key) true))) (= (has_key container key) true))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant6 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 2147483647)) (in_range8 temp___expr_372)))
...
(assert (forall ((container us_rep3)) (forall ((key us_rep4)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (of_int 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep4)) (=> (= (has_key container k) true) (= (= (bool_eq4 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant6 result true false true)))) :pattern ((get1 container key))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant (length4 container) true false true) :pattern ((length4 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key us_rep4)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (and (and (and (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1) true) (ite (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true) (and (and (and (= (oeq3 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1)))) true) (= (oeq4 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1)) 1)) (= (equal_except (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1)))) true)) (= (included_except (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1)) 1)) (= (range_equal (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1 (- (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1) 1) true)))) (and (and (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 2) true) (ite (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 2) true) (and (and (and (= (oeq3 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) true) (= (oeq4 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields1)))) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 2)) 2)) (= (equal_except (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 2)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) true)) (= (included_except (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 2) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 2)) 2)) (= (range_equal (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 1 (- (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 2) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 2) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 2) 1) true)))) (and (and (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 3) true) (ite (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 3) true) (and (and (and (= (oeq3 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3)))) true) (= (oeq4 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 3)) 3)) (= (equal_except (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 3)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3)))) true)) (= (included_except (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 3) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 3)) 3)) (= (range_equal (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 1 (- (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 3) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 3) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 3) 1) true)))) (and (and (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 4) true) (ite (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 4) true) (and (and (and (= (oeq3 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4)))) true) (= (oeq4 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3)))) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 4)) 4)) (= (equal_except (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 4)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4)))) true)) (= (included_except (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 4) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 4)) 4)) (= (range_equal (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 1 (- (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 4) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 4) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 4) 1) true)))) (and (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 5) true) (ite (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 5) true) (and (and (and (= (oeq3 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields5)))) true) (= (oeq4 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields4)))) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 5)) 5)) (= (equal_except (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 5)) true)) (and (and (and (and (and (and (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields5)))) true)) (= (included_except (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 5) true)) (= (get (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 5)) 5)) (= (range_equal (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 1 (- (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 5) 1)) true)) (= (range_shifted (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 5) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 1) true)) (= (p_positions_shifted (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) (find (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields5))) 5) 1) true)))))))) (and (= s__split_fields6 s__split_fields5) (= (mk___split_fields s__split_fields7) (mk___split_fields s__split_fields5)))))
(assert (not (<= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields6))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 5))))
(check-sat)
(exit)
