...
(define-fun dynamic_invariant ((temp___expr_1589 Int) (temp___is_init_1585 Bool) (temp___skip_constant_1586 Bool) (temp___do_toplevel_1587 Bool) (temp___do_typ_inv_1588 Bool)) Bool (=> (or (= temp___is_init_1585 true) (<= 1 2147483647)) (in_range1 temp___expr_1589)))
...
(define-fun dynamic_invariant1 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 2147483647)) (in_range2 temp___expr_1596)))
...
(define-fun default_initial_assumption ((temp___expr_1649 us_rep1) (temp___skip_top_level_1650 Bool)) Bool (=> (not (= temp___skip_top_level_1650 true)) (= (length temp___expr_1649) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 2147483647)) (in_range4 temp___expr_1603)))
...
(define-fun dynamic_invariant4 ((temp___expr_1610 Int) (temp___is_init_1606 Bool) (temp___skip_constant_1607 Bool) (temp___do_toplevel_1608 Bool) (temp___do_typ_inv_1609 Bool)) Bool (=> (or (= temp___is_init_1606 true) (<= 0 2147483647)) (in_range3 temp___expr_1610)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity (us_split_discrs1 container1))) 2147483647))
