...
(define-fun dynamic_invariant ((temp___expr_1485 Int) (temp___is_init_1482 Bool) (temp___skip_constant_1483 Bool) (temp___do_toplevel_1484 Bool)) Bool (=> (or (= temp___is_init_1482 true) (<= 1 2147483647)) (in_range1 temp___expr_1485)))
...
(define-fun dynamic_invariant1 ((temp___expr_1491 Int) (temp___is_init_1488 Bool) (temp___skip_constant_1489 Bool) (temp___do_toplevel_1490 Bool)) Bool (=> (or (= temp___is_init_1488 true) (<= 0 2147483647)) (in_range2 temp___expr_1491)))
...
(define-fun default_initial_assumption ((temp___expr_1537 us_rep1) (temp___skip_top_level_1538 Bool)) Bool (=> (not (= temp___skip_top_level_1538 true)) (= (length temp___expr_1537) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_1497 Int) (temp___is_init_1494 Bool) (temp___skip_constant_1495 Bool) (temp___do_toplevel_1496 Bool)) Bool (=> (or (= temp___is_init_1494 true) (<= 0 2147483647)) (in_range4 temp___expr_1497)))
...
(define-fun dynamic_invariant3 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range5 temp___expr_173)))
(define-fun dynamic_invariant4 ((temp___expr_1503 Int) (temp___is_init_1500 Bool) (temp___skip_constant_1501 Bool) (temp___do_toplevel_1502 Bool)) Bool (=> (or (= temp___is_init_1500 true) (<= 0 2147483647)) (in_range3 temp___expr_1503)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_1530 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2147483647)) (in_range6 temp___expr_1530)))
...
(define-fun dynamic_invariant6 ((temp___expr_1524 Int) (temp___is_init_1521 Bool) (temp___skip_constant_1522 Bool) (temp___do_toplevel_1523 Bool)) Bool (=> (or (= temp___is_init_1521 true) (<= 0 2147483647)) (in_range7 temp___expr_1524)))
