...
(assert (=> (and (<= 1 i1) (<= i1 100)) (= state8 (mk___private__ref state2))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= trace10 (mk_trace__ref trace4))))
...
(assert (not (= (element trace8 c) (+ (element trace8 (previous trace8 c)) 1))))
(check-sat)
(exit)
