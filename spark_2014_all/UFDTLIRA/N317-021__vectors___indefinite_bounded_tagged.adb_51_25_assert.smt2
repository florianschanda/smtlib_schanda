...
(assert (not (= (let ((temp___614 (f 3))) (let ((temp___613 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 3))) (ite (= (attr__tag temp___613) (attr__tag temp___614)) (us_dispatch_eq temp___613 temp___614) false))) true)))
(check-sat)
(exit)
