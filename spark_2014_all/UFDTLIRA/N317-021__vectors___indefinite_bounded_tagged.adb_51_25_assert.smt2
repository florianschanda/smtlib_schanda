...
(assert (not (= (let ((temp___571 (f 3))) (let ((temp___570 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 3))) (ite (= (attr__tag temp___570) (attr__tag temp___571)) (us_dispatch_eq temp___570 temp___571) false))) true)))
(check-sat)
(exit)
