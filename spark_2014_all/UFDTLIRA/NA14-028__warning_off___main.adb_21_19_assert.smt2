...
(assert (forall ((foo__state us_private)) (! (dynamic_invariant (get_data foo__state) true false true true) :pattern ((get_data foo__state)))))
...
(assert (not (= (get_data state) value2)))
(check-sat)
(exit)
