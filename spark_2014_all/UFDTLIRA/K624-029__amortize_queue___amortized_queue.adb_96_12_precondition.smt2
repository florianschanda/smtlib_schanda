...
(define-fun dynamic_invariant2 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_221)))
...
(assert (forall ((left us_rep)) (forall ((right Int)) (! (=> (and (dynamic_invariant2 right true true true true) (<= (+ (length left) 1) 1000)) (let ((result (oconcat__3 left right))) (and (= (length result) (+ (length left) 1)) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (last_index left))) (= (element result i) (element left i)))) (= (element result (+ (last_index left) 1)) right))))) :pattern ((oconcat__3 left right))))))
...
(define-fun dynamic_invariant3 ((temp___expr_403 us_rep2) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (and (in_range4 1000 (rec__amortized_queue__queue__front (us_split_fields3 temp___expr_403))) (in_range4 1000 (rec__amortized_queue__queue__rear (us_split_fields3 temp___expr_403)))))
...
(assert (forall ((q us_rep2)) (! (=> (and (dynamic_invariant3 q true true true true) (= (inv q) true)) (= (is_model q (model__1 q)) true)) :pattern ((model__1 q)))))
(declare-const q us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant4 ((temp___expr_393 us_rep) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (not (= temp___skip_constant_390 true)) (in_range4 1000 temp___expr_393)))
...
(define-fun dynamic_invariant5 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range5 temp___expr_165)))
...
(define-fun dynamic_invariant6 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 1001)) (in_range6 temp___expr_242)))
