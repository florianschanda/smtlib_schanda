...
(define-fun dynamic_invariant1 ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 1)) (in_range2 temp___expr_215)))
...
(assert (<= (length q) 100))
(assert (and (= o18 (length q)) (and (in_range1 o18) (<= (+ 0 o18) 2147483647))))
(assert (and (= o15 (length v)) (and (in_range1 o15) (<= (+ 0 o15) 2147483647))))
(assert (and (= o16 (length p)) (and (in_range1 o16) (<= (+ 0 o16) 2147483647))))
(assert (= o17 (- o16 o15)))
(assert (and (= o19 o17) (in_range4 o17)))
(assert (= result2 (ite (= o19 o18) true false)))
(assert (=> (= result2 true) (and (= o13 (length q)) (and (in_range1 o13) (<= (+ 0 o13) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o11 (length v)) (and (in_range1 o11) (<= (+ 0 o11) 2147483647)))))
...
(assert (= result true))
(assert (and (= o3 (length p)) (and (in_range1 o3) (<= (+ 0 o3) 2147483647))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (and (= o (length q)) (and (in_range1 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range4 o1)))
(assert (= o5 (ite (<= o2 i) true false)))
(assert (= result5 (ite (= o5 true) o4 false)))
(assert (= result5 true))
(assert (and (= o9 i) (in_range3 i)))
(assert (and (= o10 (get p o9)) (in_range2 o10)))
(assert (and (= o6 (length q)) (and (in_range1 o6) (<= (+ 0 o6) 2147483647))))
(assert (= o7 (- i o6)))
