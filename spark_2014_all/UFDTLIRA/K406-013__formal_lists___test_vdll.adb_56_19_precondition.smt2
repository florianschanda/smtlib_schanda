...
(assert (and (= o20 (next (mk___rep l2__split_discrs l2__split_fields4) o19)) (ite (= (ite (= (bool_eq1 o19 no_element) false) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o19) (length (mk___rep l2__split_discrs l2__split_fields4))) true) true) (= (bool_eq1 o20 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields4)) o20) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o20) (+ (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o19) 1))))))
(assert (not (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields3)) o20) true)))
(check-sat)
(exit)
