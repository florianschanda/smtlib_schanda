...
(assert (<= 1 i1))
(assert (<= i1 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields)))))
(assert (not (= (get (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields))) i1) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1))))
(check-sat)
(exit)
