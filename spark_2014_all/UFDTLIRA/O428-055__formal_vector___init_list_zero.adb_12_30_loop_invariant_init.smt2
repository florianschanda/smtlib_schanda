...
(assert (<= 1 i1))
(assert (<= i1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1) 0)))
(check-sat)
(exit)
