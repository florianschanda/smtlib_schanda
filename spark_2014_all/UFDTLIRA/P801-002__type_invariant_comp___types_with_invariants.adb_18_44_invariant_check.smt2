...
(assert (and (= (mk___rep (mk___split_fields temp___268 temp___2681)) (from_integer i)) (and (= (>= i 0) temp___268) (= (of_rep (abs i)) temp___2681))))
(assert (= (to_rep temp___2681) 0))
(assert (not (= temp___268 true)))
(check-sat)
(exit)
