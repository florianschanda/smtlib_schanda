...
(define-fun dynamic_invariant1 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 10000)) (in_range4 temp___expr_200)))
...
(define-fun dynamic_invariant2 ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 2147483647)) (in_range5 temp___expr_207)))
...
(define-fun dynamic_invariant3 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range1 temp___expr_173)))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 10000)) (in_range2 temp___expr_180)))
...
(define-fun dynamic_invariant5 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 10000)) (in_range6 temp___expr_222)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range6 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(declare-const temp___301 us_rep)
(declare-const temp___3011 us_rep1)
(declare-const o3 us_rep)
(declare-const o4 us_rep)
(declare-const o5 us_rep1)
(declare-const temp___3012 us_rep)
(declare-const temp___3013 us_rep1)
...
(assert (= temp___301 o1))
(assert (= temp___3011 o2))
...
(assert (= temp___301 model____split_fields2))
(assert (= temp___3011 model____split_fields3))
...
(assert (= temp___3012 o4))
(assert (= temp___3013 o5))
(assert (= result4 model____split_fields4))
(assert (= result5 model____split_fields5))
(assert (= temp___3012 model____split_fields6))
(assert (= temp___3013 model____split_fields7))
