...
(define-fun default_initial_assumption ((temp___expr_185 us_rep) (temp___skip_top_level_186 Bool)) Bool (=> (not (= temp___skip_top_level_186 true)) (= (length temp___expr_185) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range4 temp___expr_172)))
...
(define-fun dynamic_invariant2 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 2147483647)) (in_range5 temp___expr_178)))
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant2 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant1 (get container position) true false true)) :pattern ((get container position))))))
...
(assert (forall ((container us_rep)) (forall ((new_item Int)) (! (=> (and (dynamic_invariant1 new_item true true true) (and (< (length container) 2147483647) (< (last container) 2147483647))) (let ((result (add container new_item))) (and (= (length result) (+ (length container) 1)) (and (= (get result (last result)) new_item) (= (ole container result) true))))) :pattern ((add container new_item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_198 us_rep1) (temp___skip_top_level_199 Bool)) Bool (=> (not (= temp___skip_top_level_199 true)) (= (is_empty temp___expr_198) true)))
(assert (forall ((container us_rep1)) (! (dynamic_invariant (length1 container) true false true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep1)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range6 item) (= (contains container item) true))))) (= (= result true) (= (length1 container) 0)))) :pattern ((is_empty container)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (user_eq2 (rec__list_allocator__m__t__available (us_split_fields1 a)) (rec__list_allocator__m__t__available (us_split_fields1 b))) true) (= (bool_eq1 (rec__list_allocator__m__t__allocated (us_split_fields1 a)) (rec__list_allocator__m__t__allocated (us_split_fields1 b))) true)) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_211 us_rep2) (temp___skip_top_level_212 Bool)) Bool (and (= (length (rec__list_allocator__m__t__available (us_split_fields1 temp___expr_211))) 0) (= (is_empty (rec__list_allocator__m__t__allocated (us_split_fields1 temp___expr_211))) true)))
(declare-fun contains1 (us_rep Int) Bool)
(declare-fun contains__function_guard1 (Bool us_rep Int) Bool)
(define-fun dynamic_invariant3 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 10000)) (in_range1 temp___expr_148)))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 1 10000)) (in_range2 temp___expr_154)))
...
(define-fun dynamic_invariant5 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range6 temp___expr_191)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range6 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(declare-fun ole1 (us_rep1 us_rep1) Bool)
(declare-fun ole__function_guard1 (Bool us_rep1 us_rep1) Bool)
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (ole1 left right) true) (forall ((item Int)) (=> (and (in_range6 item) (= (contains left item) true)) (= (contains right item) true)))) :pattern ((ole1 left right)))))
...
(declare-const r Int)
(declare-const temp___266 us_rep)
(declare-const temp___2661 us_rep1)
...
(declare-const model____split_fields12 us_split_fields__ref)
(declare-const r6 int__ref)
(declare-const model____split_fields13 us_split_fields)
...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (and (= o (add model____split_fields r1)) (and (= (length o) (+ (length model____split_fields) 1)) (and (= (get o (last o)) r1) (= (ole model____split_fields o) true)))))
(assert (= o o1))
(assert (= model____split_fields1 o2))
(assert (= temp___264 o1))
(assert (= temp___2641 o2))
(assert (= (mk___split_fields__ref (mk___split_fields result1 result2)) (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1))))
(assert (= temp___264 model____split_fields4))
(assert (= temp___2641 model____split_fields5))
(assert (= (is_empty model____split_fields7) true))
(assert (= (length1 model____split_fields7) 0))
(assert (= (length model____split_fields6) r2))
(assert (= (get model____split_fields6 1) 1))
(assert (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r2)) (= (get model____split_fields6 rr3) rr3))))
(assert (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r2)) (= (contains1 model____split_fields6 rr3) true))))
(assert (and (and (=> (<= 1 10000) (in_range2 r2)) (= model____split_fields7 model____split_fields1)) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result3))
(assert (= r3 (+ r2 1)))
(assert (and (= o6 (add model____split_fields6 r3)) (and (= (length o6) (+ (length model____split_fields6) 1)) (and (= (get o6 (last o6)) r3) (= (ole model____split_fields6 o6) true)))))
(assert (= o6 o7))
(assert (= model____split_fields7 o8))
(assert (= temp___2642 o7))
(assert (= temp___2643 o8))
(assert (= result4 model____split_fields6))
(assert (= result5 model____split_fields7))
(assert (= temp___2642 model____split_fields8))
(assert (= temp___2643 model____split_fields9))
(declare-const rr3 Int)
(assert (<= 1 rr3))
(assert (<= rr3 r3))
(assert (not (= (contains1 model____split_fields8 rr3) true)))
(check-sat)
(exit)
