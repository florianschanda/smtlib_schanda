...
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (get model____split_fields4 rr) rr))))
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (contains1 model____split_fields4 rr) true))))
(assert (and (and (=> (<= 1 10000) (in_range2 r2)) (= model____split_fields5 model____split_fields1)) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result3))
(assert (= r3 (+ r2 1)))
(assert (and (= o3 (add model____split_fields4 r3)) (and (= (length o3) (+ (length model____split_fields4) 1)) (and (= (get o3 (last o3)) r3) (= (ole model____split_fields4 o3) true)))))
(assert (= o3 o4))
...
(assert (<= 1 rr))
(assert (<= rr r3))
(assert (not (= (contains1 model____split_fields6 rr) true)))
(check-sat)
(exit)
