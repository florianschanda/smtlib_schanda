...
(declare-const temp___3032 us_rep)
(declare-const temp___3033 us_rep1)
...
(assert (= temp___303 o1))
(assert (= temp___3031 o2))
...
(assert (= temp___303 model____split_fields2))
(assert (= temp___3031 model____split_fields3))
...
(assert (and (and (=> (<= 1 10000) (in_range6 r2)) (= model____split_fields5 model____split_fields1)) (and (<= 1 r2) (<= r2 10000))))
(assert (not (= r2 10000)))
(assert (= r2 result3))
(assert (= r3 (+ r2 1)))
...
(assert (= temp___3032 o4))
(assert (= temp___3033 o5))
(assert (= result4 model____split_fields4))
(assert (= result5 model____split_fields5))
(assert (= temp___3032 model____split_fields6))
(assert (= temp___3033 model____split_fields7))
