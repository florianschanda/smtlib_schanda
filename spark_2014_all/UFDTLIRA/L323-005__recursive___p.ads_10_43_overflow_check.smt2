...
(assert (forall ((x1 Int)) (! (=> (dynamic_invariant x1 true true true true) (= (down x1) (ite (= x1 1) x1 (+ (down (- x1 1)) 1)))) :pattern ((down x1)))))
...
(assert (and (= o1 (down o)) (and (in_range1 o1) (= o1 (ite (= o 1) o (+ (down (- o 1)) 1))))))
(assert (= o2 (+ o1 1)))
