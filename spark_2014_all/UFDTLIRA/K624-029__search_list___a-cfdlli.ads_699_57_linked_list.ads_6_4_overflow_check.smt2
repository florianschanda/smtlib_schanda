...
(define-fun dynamic_invariant1 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_183)))
...
(assert (not (in_range (- (to_rep (rec__linked_list__mylists__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
