...
(define-fun dynamic_invariant ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 1 2147483647)) (in_range2 temp___expr_234)))
...
(define-fun dynamic_invariant1 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 0 2147483647)) (in_range3 temp___expr_246)))
...
(define-fun default_initial_assumption ((temp___expr_253 us_rep) (temp___skip_top_level_254 Bool)) Bool (=> (not (= temp___skip_top_level_254 true)) (= (length temp___expr_253) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 255)) (in_range5 temp___expr_240)))
