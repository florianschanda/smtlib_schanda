...
(assert (not (or (< (length (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields1))) 2) true))))
(check-sat)
(exit)
