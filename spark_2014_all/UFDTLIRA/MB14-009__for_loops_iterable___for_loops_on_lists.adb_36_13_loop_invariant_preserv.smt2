...
(define-fun default_initial_assumption ((temp___expr_228 us_rep1) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields3 temp___expr_228))) 0))
...
(define-fun dynamic_invariant1 ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 0 2147483647)) (in_range4 temp___expr_250)))
...
(define-fun default_initial_assumption1 ((temp___expr_265 us_rep2) (temp___skip_top_level_266 Bool)) Bool (=> (not (= temp___skip_top_level_266 true)) (= (length1 temp___expr_265) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_279 Int) (temp___is_init_275 Bool) (temp___skip_constant_276 Bool) (temp___do_toplevel_277 Bool) (temp___do_typ_inv_278 Bool)) Bool (=> (or (= temp___is_init_275 true) (<= 1 2147483647)) (in_range5 temp___expr_279)))
...
(define-fun default_initial_assumption3 ((temp___expr_273 us_rep1) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(define-fun dynamic_invariant4 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range2 temp___expr_214)))
...
(define-fun o11 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___541 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___541)) no_element))
(assert (and (= o11 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o11 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o11) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o11) 1)))))
...
(assert (= result1 true))
(assert (and (= o3 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) cu1)) (and (in_range2 o3) (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1))))))
(assert (= result2 (ite (= o3 0) true false)))
...
(assert (and (= o4 (element (mk___rep l__split_discrs l__split_fields1) cu2)) (and (in_range2 o4) (= o4 (get (model__ (mk___rep l__split_discrs l__split_fields1)) (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2))))))
(assert (= o5 (- o4 1)))
(assert (and (= o6 o5) (in_range2 o5)))
(assert (and (and (and (= (length (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep l__split_discrs l__split_fields1))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields1)) (positions (mk___rep l__split_discrs l__split_fields2))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2)) o6)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields1)) (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2)) true)))
(assert (and (= o7 (next (mk___rep l__split_discrs l__split_fields2) cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) (length (mk___rep l__split_discrs l__split_fields2))) true) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o7) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) o7) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))))))
(assert (and (= o8 (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o7)) (= (= o8 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o7) true))))
(assert (= result3 (ite (not (= o8 true)) true false)))
(assert (not (= result3 true)))
(assert (and (= o9 (next (mk___rep l__split_discrs l__split_fields2) cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) (length (mk___rep l__split_discrs l__split_fields2))) true) true) (= (bool_eq1 o9 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o9) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) o9) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))))))
(assert (= result4 (mk_cursor__ref cu2)))
(assert (= cu3 o9))
(assert (and (= o10 (element (mk___rep l__split_discrs l__split_fields2) cu3)) (and (in_range2 o10) (= o10 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu3))))))
(assert (= result5 (ite (= o10 0) true false)))
...
(assert (not (< 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))))
(check-sat)
(exit)
