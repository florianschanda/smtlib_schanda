...
(define-fun o9 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (= o9 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o9 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o9) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o9) 1)))))
(assert (= result (mk_cursor__ref (mk___rep1 (mk___split_fields1 cu)))))
(assert (= cu1 o9))
(assert (and (= result1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1)) (= (= result1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) true))))
(assert (= result1 true))
(assert (and (= o1 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) cu1)) (and (in_range5 o1) (= o1 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1))))))
(assert (= result2 (ite (= o1 0) true false)))
(assert (not (= result2 true)))
(assert (= c__split_fields2 (mk___split_fields1 c__split_fields)))
(assert (= c__split_fields2 c__split_fields1))
...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2) 1))) (and (< 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i) (- (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i) 1))))))
(assert (forall ((i Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2) i) (<= i (length (mk___rep l__split_discrs l__split_fields1)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))
(assert (not (= (element (mk___rep l__split_discrs l__split_fields1) cu2) 0)))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields1)) cu2) true))
(assert (and (= o2 (element (mk___rep l__split_discrs l__split_fields1) cu2)) (and (in_range5 o2) (= o2 (get (model__ (mk___rep l__split_discrs l__split_fields1)) (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2))))))
(assert (= o3 (- o2 1)))
(assert (and (= o4 o3) (in_range5 o3)))
(assert (and (and (and (= (length (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep l__split_discrs l__split_fields1))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields1)) (positions (mk___rep l__split_discrs l__split_fields2))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2)) o4)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields1)) (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2)) true)))
(assert (and (= o5 (next (mk___rep l__split_discrs l__split_fields2) cu2)) (ite (= (ite (= (bool_eq2 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) (length (mk___rep l__split_discrs l__split_fields2))) true) true) (= (bool_eq2 o5 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o5) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) o5) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))))))
(assert (and (= o6 (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o5)) (= (= o6 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o5) true))))
(assert (= result3 (ite (not (= o6 true)) true false)))
(assert (not (= result3 true)))
(assert (and (= o7 (next (mk___rep l__split_discrs l__split_fields2) cu2)) (ite (= (ite (= (bool_eq2 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) (length (mk___rep l__split_discrs l__split_fields2))) true) true) (= (bool_eq2 o7 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o7) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) o7) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))))))
(assert (= result4 (mk_cursor__ref cu2)))
(assert (= cu3 o7))
(assert (and (= o8 (element (mk___rep l__split_discrs l__split_fields2) cu3)) (and (in_range5 o8) (= o8 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu3))))))
(assert (= result5 (ite (= o8 0) true false)))
(assert (not (= result5 true)))
(assert (= c__split_fields4 c__split_fields3))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu3) 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (- (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i) 1))))
(check-sat)
(exit)
