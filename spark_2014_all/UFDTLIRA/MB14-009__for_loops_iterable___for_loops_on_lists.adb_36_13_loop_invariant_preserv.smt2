...
(assert (and (= (mk___rep1 (mk___split_fields1 o2)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o2)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 o2))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 o2))) 1)))))
(assert (= result (mk_cursor__ref (mk___rep1 (mk___split_fields1 cu)))))
(assert (= cu1 (mk___rep1 (mk___split_fields1 o2))))
...
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))) (and (< 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i3) (- (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3) 1))))))
(assert (forall ((i3 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) i3) (<= i3 (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)))))
(assert (not (= (element (mk___rep l__split_discrs l__split_fields2) cu2) 0)))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) cu2) true))
(assert (and (= o27 (element (mk___rep l__split_discrs l__split_fields2) cu2)) (and (in_range2 o27) (= o27 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2))))))
(assert (= o28 (- o27 1)))
(assert (and (= o29 o28) (in_range2 o28)))
(assert (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields2))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2)) o29)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2)) true)))
(assert (and (= o30 (next (mk___rep l__split_discrs l__split_fields3) cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 o30 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o30) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) o30) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) 1))))))
(assert (and (= o31 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o30)) (= (= o31 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o30) true))))
(assert (= result7 (ite (not (= o31 true)) true false)))
(assert (not (= result7 true)))
(assert (and (= o32 (next (mk___rep l__split_discrs l__split_fields3) cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 o32 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o32) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) o32) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) 1))))))
(assert (= result8 (mk_cursor__ref cu2)))
(assert (= cu3 o32))
(assert (and (= o33 (element (mk___rep l__split_discrs l__split_fields3) cu3)) (and (in_range2 o33) (= o33 (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu3))))))
(assert (= result9 (ite (= o33 0) true false)))
(assert (not (= result9 true)))
(assert (= c__split_fields4 c__split_fields3))
(declare-const i3 Int)
(assert (<= 1 i3))
(assert (<= i3 (- (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu3) 1)))
(assert (not (< 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))
(check-sat)
(exit)
