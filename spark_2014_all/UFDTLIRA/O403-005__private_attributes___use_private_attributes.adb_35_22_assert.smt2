...
(assert (= (to_rep (rec__private_with_attributes__root__f1 (us_split_fields9 c1))) (to_rep (rec__private_with_attributes__root__f1 (us_split_fields9 c2)))))
(assert (not (= (ite (= rc__attr__tag fc__attr__tag) (us_dispatch_eq (mk___rep (mk___split_fields rc__split_fields2 rc__split_fields3) rc__attr__tag) (mk___rep fc__split_fields2 fc__attr__tag)) false) true)))
(assert (not (= (bool_eq3 (mk___rep3 (mk___split_fields3 (rec__private_with_attributes__root__f2 g1__split_fields4) (hide_ext__4 (rec__private_with_attributes__child1 g1__split_fields4) (rec__public_derives_private__grand_child__f2 g1__split_fields4) (rec__ext__6 g1__split_fields4))) g1__attr__tag) (mk___rep3 (mk___split_fields3 (rec__private_with_attributes__root__f2 g2__split_fields4) (hide_ext__4 (rec__private_with_attributes__child1 g2__split_fields4) (rec__public_derives_private__grand_child__f2 g2__split_fields4) (rec__ext__6 g2__split_fields4))) g2__attr__tag)) true)))
(check-sat)
(exit)
