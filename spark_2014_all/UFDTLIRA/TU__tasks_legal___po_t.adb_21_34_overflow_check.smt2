...
(define-fun default_initial_assumption ((temp___expr_178 us_rep) (temp___skip_top_level_179 Bool)) Bool (and (= (to_rep (rec__po_t__hidden_poT__the_protected_int (us_split_fields1 temp___expr_178))) 0) (= (rec__po_t__hidden_poT__switch (us_split_fields1 temp___expr_178)) (of_int 1))))
