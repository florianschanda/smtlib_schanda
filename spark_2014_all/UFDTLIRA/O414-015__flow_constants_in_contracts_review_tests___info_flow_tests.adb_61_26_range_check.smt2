...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 last)) (dynamic_property 0 last temp___expr_159)))
(assert (= last c1))
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 last1)) (dynamic_property1 0 last1 temp___expr_165)))
(assert (= last1 c2))
(declare-const a Int)
(declare-const b Int)
(declare-const o Int)
