...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (= model____split_fields temp___266) (= model____split_fields1 temp___2661))))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= (mk___split_fields__ref (mk___split_fields result1 result2)) (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___264 model____split_fields4)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___2641 model____split_fields5)))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r2)) (= (get model____split_fields6 rr3) rr3)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r2)) (= (contains1 model____split_fields6 rr3) true)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (=> (<= 1 10000) (in_range2 r2)) (= model____split_fields7 temp___2661)) (and (<= 1 r2) (<= r2 10000)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r2 10000)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r4 (mk_int__ref r2))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= model____split_fields10 (mk___split_fields__ref (mk___split_fields model____split_fields6 model____split_fields7)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r5 r2)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= model____split_fields11 (mk___split_fields model____split_fields6 model____split_fields7))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r6 r4)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= model____split_fields12 model____split_fields10)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r7 r5)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= model____split_fields13 model____split_fields11)))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= r6 (mk_int__ref r1))))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= model____split_fields12 (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1)))))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= r7 r1)))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= model____split_fields13 (mk___split_fields model____split_fields2 model____split_fields3))))
(assert (= (length (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields12))) 10000))
(assert (and (= result10 (is_empty (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields12)))) (and (= (= result10 true) (forall ((item Int)) (not (and (in_range6 item) (= (contains (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields12)) item) true))))) (= (= result10 true) (= (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields12))) 0)))))
(assert (=> (= result10 true) (and (= o12 (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields12)))) (in_range3 o12))))
(assert (=> (= result10 true) (= result9 (ite (= o12 0) true false))))
(assert (=> (not (= result10 true)) (= result9 false)))
(assert (=> (= result9 true) (and (= o11 (length (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields12)))) (and (in_range3 o11) (<= (+ 0 o11) 2147483647)))))
(assert (=> (= result9 true) (= result8 (ite (= o11 10000) true false))))
(assert (=> (not (= result9 true)) (= result8 false)))
(assert (=> (= result8 true) (and (= o10 (get (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields12)) 1)) (in_range4 o10))))
(assert (=> (= result8 true) (= result7 (ite (= o10 1) true false))))
