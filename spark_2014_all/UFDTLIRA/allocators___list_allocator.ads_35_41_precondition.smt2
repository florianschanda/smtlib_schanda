...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (= model____split_fields temp___303) (= model____split_fields1 temp___3031))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___302 r1)))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___301 o1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___3011 o2)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= (mk___split_fields__ref (mk___split_fields result1 result2)) model____split_fields13)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___301 model____split_fields4)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___3011 model____split_fields5)))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (get model____split_fields6 rr1) rr1)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (contains1 model____split_fields6 rr1) true)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (=> (<= 1 10000) (in_range2 r2)) (= model____split_fields7 temp___3031)) (and (<= 1 r2) (<= r2 10000)))))
...
(assert (and (= result6 (is_empty (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (and (= (= result6 true) (forall ((item Int)) (not (and (in_range6 item) (= (contains (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)) item) true))))) (= (= result6 true) (= (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10))) 0)))))
(assert (=> (= result6 true) (and (= o5 (length1 (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields10)))) (in_range3 o5))))
(assert (=> (= result6 true) (= result5 (ite (= o5 0) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o4 (length (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10)))) (and (in_range3 o4) (<= (+ 0 o4) 2147483647)))))
(assert (=> (= result5 true) (= result4 (ite (= o4 10000) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (and (= o3 (get (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields10)) 1)) (in_range4 o3))))
(assert (=> (= result4 true) (= result3 (ite (= o3 1) true false))))
