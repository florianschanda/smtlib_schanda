...
(assert (= k result3))
(assert (= k1 1))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (and (and (= temp___169 count3) (and (= temp___168 k1) (and (and (and (= o (+ count3 1)) (in_range1 (+ count3 1))) (and (= count3 result4) (= count4 o))) (and (= count5 k2) (and (and (and (=> (<= 1 i2) (dynamic_property 1 i2 k2)) (=> (<= (- 2147483648) 2147483647) (in_range1 count5))) (and (<= 1 k2) (<= k2 i2))) (= k2 i2)))))) (and (and (= k2 k6) (= count5 count9)) (and (= k7 k2) (= count10 count5))))))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= (mk_int__ref k8) (mk_int__ref k6))))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= (mk_int__ref count11) (mk_int__ref count9))))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= k9 k7)))
(assert (=> (and (<= 1 k1) (<= k1 i2)) (= count12 count10)))
(assert (=> (not (and (<= 1 k1) (<= k1 i2))) (= k1 k8)))
(assert (=> (not (and (<= 1 k1) (<= k1 i2))) (= count3 count11)))
(assert (=> (not (and (<= 1 k1) (<= k1 i2))) (= k9 k1)))
(assert (=> (not (and (<= 1 k1) (<= k1 i2))) (= count12 count3)))
(assert (not (= i2 5)))
(assert (= result7 i2))
(assert (= i3 (+ i2 1)))
(assert (= k10 k8))
(assert (= i3 i4))
(assert (= (mk_int__ref count13) (mk_int__ref count11)))
(assert (= k11 k9))
(assert (= i5 i3))
(assert (= count14 count12))
(assert (not (= count13 (- i4 1))))
(check-sat)
(exit)
