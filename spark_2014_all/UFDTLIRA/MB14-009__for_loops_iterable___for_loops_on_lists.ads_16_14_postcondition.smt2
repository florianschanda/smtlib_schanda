...
(define-fun default_initial_assumption ((temp___expr_265 us_rep2) (temp___skip_top_level_266 Bool)) Bool (=> (not (= temp___skip_top_level_266 true)) (= (length temp___expr_265) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_228 us_rep1) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields3 temp___expr_228))) 0))
...
(define-fun dynamic_invariant3 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range1 temp___expr_165)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant3 result true false true true))) :pattern ((length1 container)))))
...
(declare-const temp___5204 us_rep1)
...
(declare-const temp___5206 us_rep1)
...
(define-fun temp___5207 () us_rep1 (mk___rep1 (mk___split_fields1 temp___5202)))
...
(assert (= e11 e9))
(assert (= result7 (bool__content for_loops_on_lists__contains_0_for_of__result13)))
(assert (= (bool__content for_loops_on_lists__contains_0_for_of__result13) true))
(define-fun temp___527 () us_rep2 (model__ l))
(assert (not (exists ((temp___526 Int)) (and (and (in_range2 temp___526) (= (iter_has_element temp___527 temp___526) true)) (= (get temp___527 temp___526) 0)))))
(check-sat)
(exit)
