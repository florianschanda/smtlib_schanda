...
(assert (forall ((f1 Int) (l1 Int) (f2 Int) (l2 Int)) (! (=> (and (and (and (dynamic_invariant f1 true true true true) (dynamic_invariant l1 true true true true)) (dynamic_invariant f2 true true true true)) (dynamic_invariant l2 true true true true)) (= (new_m f1 l1 f2 l2) (let ((temp___177 (temp___165 0 f1 l1 f2 l2))) (of_array (to_array1 temp___177) (first5 temp___177) (last5 temp___177) (first_21 temp___177) (last_21 temp___177))))) :pattern ((new_m f1 l1 f2 l2)))))
...
(assert (forall ((temp___167 Int) (temp___168 Int) (temp___169 Int) (temp___170 Int) (temp___171 Int)) (let ((temp___166 (temp___165 temp___167 temp___168 temp___169 temp___170 temp___171))) (=> (dynamic_invariant2 temp___167 true true true true) (and (=> (dynamic_property2 1 2147483647 temp___168 temp___169 1 2147483647 temp___170 temp___171) (and (and (= (first_21 temp___166) temp___170) (= (last_21 temp___166) temp___171)) (and (= (first5 temp___166) temp___168) (= (last5 temp___166) temp___169)))) (forall ((temp___172 Int) (temp___173 Int)) (= (to_rep1 (get (to_array1 temp___166) temp___172 temp___173)) temp___167)))))))
...
(assert (and (= array_types__a__assume3 (new_m 1 3 2 5)) (and (dynamic_invariant1 array_types__a__assume3 true false true true) (= array_types__a__assume3 (let ((temp___174 (temp___165 0 1 3 2 5))) (mk___t (elts1 temp___174) (mk (to_rep (first3 (rt1 temp___174))) (to_rep (last3 (rt1 temp___174)))) (mk1 (to_rep (first4 (rt_21 temp___174))) (to_rep (last4 (rt_21 temp___174))))))))))
(assert (= result a))
