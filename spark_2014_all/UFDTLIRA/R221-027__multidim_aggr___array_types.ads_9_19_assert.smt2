...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep (first1 (mk1 f l))) f) (= (to_rep (last1 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep (first3 (mk2 f l))) f) (= (to_rep (last3 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep (first4 (mk3 f l))) f) (= (to_rep (last4 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f1 Int) (l1 Int) (f2 Int) (l2 Int)) (! (=> (and (and (and (dynamic_invariant f1 true true true true) (dynamic_invariant l1 true true true true)) (dynamic_invariant f2 true true true true)) (dynamic_invariant l2 true true true true)) (dynamic_invariant1 (new_m f1 l1 f2 l2) true false true true)) :pattern ((new_m f1 l1 f2 l2)))))
(assert (forall ((f1 Int) (l1 Int) (f2 Int) (l2 Int)) (! (=> (and (and (and (dynamic_invariant f1 true true true true) (dynamic_invariant l1 true true true true)) (dynamic_invariant f2 true true true true)) (dynamic_invariant l2 true true true true)) (= (new_m f1 l1 f2 l2) (let ((temp___177 (temp_____aggregate_def_165 0 f1 l1 f2 l2))) (of_array (to_array1 temp___177) (first5 temp___177) (last5 temp___177) (first_21 temp___177) (last_21 temp___177))))) :pattern ((new_m f1 l1 f2 l2)))))
...
(assert (forall ((temp___167 Int) (temp___168 Int) (temp___169 Int) (temp___170 Int) (temp___171 Int)) (let ((temp___166 (temp_____aggregate_def_165 temp___167 temp___168 temp___169 temp___170 temp___171))) (=> (dynamic_invariant2 temp___167 true true true true) (and (=> (dynamic_property2 1 2147483647 temp___168 temp___169 1 2147483647 temp___170 temp___171) (and (and (= (first_21 temp___166) temp___170) (= (last_21 temp___166) temp___171)) (and (= (first5 temp___166) temp___168) (= (last5 temp___166) temp___169)))) (forall ((temp___172 Int) (temp___173 Int)) (= (get (to_array1 temp___166) temp___172 temp___173) rliteral)))))))
(declare-const a map1)
(declare-const array_types__a__assume map1)
(declare-const array_types__a__assume1 t)
(declare-const array_types__a__assume2 t1)
(declare-const result map1)
(declare-const a1 map1)
(define-fun array_types__a__assume3 () us_t (mk___t array_types__a__assume array_types__a__assume1 array_types__a__assume2))
(assert (and (= array_types__a__assume3 (new_m 1 3 2 5)) (and (dynamic_invariant1 array_types__a__assume3 true false true true) (= array_types__a__assume3 (let ((temp___174 (temp_____aggregate_def_165 0 1 3 2 5))) (mk___t (elts1 temp___174) (mk (to_rep (first3 (rt1 temp___174))) (to_rep (last3 (rt1 temp___174)))) (mk1 (to_rep (first4 (rt_21 temp___174))) (to_rep (last4 (rt_21 temp___174))))))))))
(assert (= result a))
(assert (= a1 array_types__a__assume))
(assert (= (to_rep a__first) (to_rep (first array_types__a__assume1))))
(assert (= (to_rep a__last) (to_rep (last array_types__a__assume1))))
(assert (= (to_rep a__first_2) (to_rep (first1 array_types__a__assume2))))
(assert (= (to_rep a__last_2) (to_rep (last1 array_types__a__assume2))))
(assert (dynamic_property2 1 2147483647 (to_rep a__first) (to_rep a__last) 1 2147483647 (to_rep a__first_2) (to_rep a__last_2)))
(assert (not (= (to_rep a__first) (to_rep a__first_2))))
(check-sat)
(exit)
