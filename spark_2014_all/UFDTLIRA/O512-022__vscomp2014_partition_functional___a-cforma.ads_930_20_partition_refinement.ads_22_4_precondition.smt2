...
(define-fun dynamic_invariant ((temp___expr_586 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 1 2147483647)) (in_range2 temp___expr_586)))
...
(define-fun default_initial_assumption ((temp___expr_593 us_rep2) (temp___skip_top_level_594 Bool)) Bool (=> (not (= temp___skip_top_level_594 true)) (and (= (is_empty temp___expr_593) true) (= (length temp___expr_593) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true))) :pattern ((length1 container1)))))
...
(declare-const temp___1064 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1064 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1064)) no_element))
