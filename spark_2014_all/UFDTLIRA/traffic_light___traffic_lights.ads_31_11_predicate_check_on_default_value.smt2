...
(define-fun dynamic_invariant ((temp___expr_1656 us_rep1) (temp___is_init_1652 Bool) (temp___skip_constant_1653 Bool) (temp___do_toplevel_1654 Bool) (temp___do_typ_inv_1655 Bool)) Bool (=> (= temp___do_toplevel_1654 true) (=> (= temp___is_init_1652 true) (= (valid_combination temp___expr_1656) true))))
(define-fun default_initial_assumption ((temp___expr_1658 us_rep1) (temp___skip_top_level_1659 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1658)) (distinct 0 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1658)) (distinct 0 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1658)) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1658)) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1658)) (distinct 0 0))))
