...
(define-fun dynamic_invariant ((temp___expr_1478 us_rep1) (temp___is_init_1475 Bool) (temp___skip_constant_1476 Bool) (temp___do_toplevel_1477 Bool)) Bool (=> (= temp___do_toplevel_1477 true) (=> (= temp___is_init_1475 true) (= (valid_combination temp___expr_1478) true))))
(define-fun default_initial_assumption ((temp___expr_1480 us_rep1) (temp___skip_top_level_1481 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1480)) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1480)) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1480)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1480)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1480)) (of_int 0))))
...
(define-fun dynamic_invariant1 ((temp___expr_1487 us_rep2) (temp___is_init_1484 Bool) (temp___skip_constant_1485 Bool) (temp___do_toplevel_1486 Bool)) Bool (= (valid_combination (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1487))) true))
(define-fun default_initial_assumption2 ((temp___expr_1489 us_rep2) (temp___skip_top_level_1490 Bool)) Bool (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields3 temp___expr_1489)) time_first) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields3 temp___expr_1489)) (of_int 0))) (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1489)))) (of_int 0)))))
(declare-const self__ us_rep2)
(declare-const temp___1511 Bool)
(declare-const temp___15111 Bool)
(declare-const temp___15112 Bool)
(declare-const temp___15113 Bool)
(declare-const temp___15114 Bool)
(assert (and (and (and (and (= temp___1511 (of_int 0)) (= temp___15111 (of_int 0))) (= temp___15112 (of_int 1))) (= temp___15113 (of_int 1))) (= temp___15114 (of_int 0))))
(assert (not (= (valid_combination (mk___rep (mk___split_fields temp___1511 temp___15111 temp___15112 temp___15113 temp___15114))) true)))
(check-sat)
(exit)
