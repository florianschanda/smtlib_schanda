...
(define-fun dynamic_invariant ((temp___expr_1468 us_rep1) (temp___is_init_1465 Bool) (temp___skip_constant_1466 Bool) (temp___do_toplevel_1467 Bool)) Bool (=> (= temp___do_toplevel_1467 true) (=> (= temp___is_init_1465 true) (= (valid_combination temp___expr_1468) true))))
(define-fun default_initial_assumption ((temp___expr_1470 us_rep1) (temp___skip_top_level_1471 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1470)) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1470)) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1470)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1470)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1470)) (of_int 0))))
...
(define-fun dynamic_invariant1 ((temp___expr_1477 us_rep2) (temp___is_init_1474 Bool) (temp___skip_constant_1475 Bool) (temp___do_toplevel_1476 Bool)) Bool (= (valid_combination (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1477))) true))
(define-fun default_initial_assumption2 ((temp___expr_1479 us_rep2) (temp___skip_top_level_1480 Bool)) Bool (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields3 temp___expr_1479)) time_first) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields3 temp___expr_1479)) (of_int 0))) (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 0)))))
(declare-const self__ us_rep2)
(declare-const temp___1501 Bool)
(declare-const temp___15011 Bool)
(declare-const temp___15012 Bool)
(declare-const temp___15013 Bool)
(declare-const temp___15014 Bool)
(assert (and (and (and (and (= temp___1501 (of_int 0)) (= temp___15011 (of_int 0))) (= temp___15012 (of_int 1))) (= temp___15013 (of_int 1))) (= temp___15014 (of_int 0))))
(assert (not (= (valid_combination (mk___rep (mk___split_fields temp___1501 temp___15011 temp___15012 temp___15013 temp___15014))) true)))
(check-sat)
(exit)
