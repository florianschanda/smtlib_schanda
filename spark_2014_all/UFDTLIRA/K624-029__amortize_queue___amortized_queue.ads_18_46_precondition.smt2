...
(assert (and (= o10 (length left)) (and (in_range2 o10) (<= o10 (capacity left)))))
(assert (= o11 (+ o10 o9)))
(assert (and (= o12 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range2 o12) (<= o12 (capacity (vector__content amortized_queue__Oconcat__result5))))))
...
(assert (not (<= o8 (last (model__ left)))))
(check-sat)
(exit)
