...
(define-fun dynamic_invariant2 ((temp___expr_230 us_rep1) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (in_range4 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 temp___expr_230))) (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 temp___expr_230))))
...
(define-fun dynamic_invariant3 ((temp___expr_365 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 1 2147483647)) (in_range6 temp___expr_365)))
...
(define-fun dynamic_invariant4 ((temp___expr_371 Int) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool)) Bool (=> (or (= temp___is_init_368 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_371)))
...
(define-fun dynamic_invariant5 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 2147483647)) (in_range8 temp___expr_377)))
...
(define-fun dynamic_invariant6 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range9 temp___expr_141)))
(define-fun dynamic_invariant7 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range2 temp___expr_213)))
(define-fun dynamic_invariant8 ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= 0 2147483647)) (in_range3 temp___expr_219)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant8 result true false true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant9 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 0 2147483647)) (in_range10 temp___expr_399)))
(assert (forall ((container1 us_rep2)) (! (let ((result (length container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant10 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= (- 2147483648) 2147483647)) (in_range11 temp___expr_393)))
