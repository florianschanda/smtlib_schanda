...
(define-fun dynamic_invariant2 ((temp___expr_269 us_rep1) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (in_range4 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 temp___expr_269))) (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 temp___expr_269))))
...
(define-fun dynamic_invariant3 ((temp___expr_406 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 2147483647)) (in_range6 temp___expr_406)))
...
(define-fun dynamic_invariant4 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_413)))
...
(define-fun dynamic_invariant5 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 2147483647)) (in_range8 temp___expr_420)))
...
(define-fun contains ((container1 us_rep2) (fst Int) (lst Int) (item1 Int)) Bool (ite (exists ((i Int)) (and (and (<= fst i) (<= i lst)) (= (get container1 i) item1))) true false))
...
(assert (forall ((container1 us_rep)) (forall ((item1 Int) (index1 Int)) (! (=> (and (dynamic_invariant4 item1 true true true true) (dynamic_invariant3 index1 true true true true)) (let ((result (reverse_find_index container1 item1 index1))) (and (ite (not (= (contains (model__ container1) 1 (ite (<= index1 (last_index container1)) index1 (last_index container1)) item1) true)) (= result 0) (and (and (and (and (<= 1 result) (<= result index1)) (<= result (last_index container1))) (= (get (model__ container1) result) item1)) (not (= (contains (model__ container1) (+ result 1) (ite (<= index1 (last_index container1)) index1 (last_index container1)) item1) true)))) (dynamic_invariant5 result true false true true)))) :pattern ((reverse_find_index container1 item1 index1))))))
...
(define-fun dynamic_invariant6 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range9 temp___expr_165)))
(define-fun dynamic_invariant7 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483647)) (in_range2 temp___expr_249)))
(define-fun dynamic_invariant8 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range3 temp___expr_256)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant8 result true false true true))) :pattern ((length1 container1)))))
...
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq10 a b) (oeq a b)) :pattern ((user_eq10 a b)))))
...
(define-fun dynamic_invariant9 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 0 2147483647)) (in_range10 temp___expr_445)))
(assert (forall ((container1 us_rep2)) (! (let ((result (length container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant10 ((temp___expr_438 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool) (temp___do_typ_inv_437 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= (- 2147483648) 2147483647)) (in_range11 temp___expr_438)))
...
(assert (not (in_range2 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))))))
(check-sat)
(exit)
