...
(assert (= (= o11 true) (forall ((j1 Int)) (=> (and (<= (+ i 7) j1) (<= j1 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8)))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j1) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- j1 7)))))))
