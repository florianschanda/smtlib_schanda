...
(define-fun dynamic_invariant ((temp___expr_176 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 1 3)) (in_range2 temp___expr_176)))
...
(define-fun dynamic_invariant1 ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 0 3)) (in_range1 temp___expr_170)))
...
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (ispresent theadmin) true) (in_range2 (to_rep (rec__admin__t__rolepresent (us_split_fields1 theadmin))))) :pattern ((ispresent theadmin)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const role Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 4)) (in_range3 temp___expr_377)))
(define-fun dynamic_invariant3 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1 4)) (in_range4 temp___expr_383)))
...
(declare-const temp___493 privileget)
(declare-const temp___4931 opandnullt)
(declare-const o3 opandnullt)
(declare-const o4 privileget)
(declare-const o5 opandnullt)
(declare-const temp___495 privileget)
(declare-const temp___4951 opandnullt)
