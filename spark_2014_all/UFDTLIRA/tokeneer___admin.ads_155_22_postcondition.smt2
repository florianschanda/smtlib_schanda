...
(define-fun dynamic_invariant ((temp___expr_365 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 1 3)) (in_range2 temp___expr_365)))
...
(define-fun dynamic_invariant1 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 3)) (in_range1 temp___expr_359)))
...
(define-fun dynamic_invariant2 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 4)) (in_range3 temp___expr_421)))
(define-fun dynamic_invariant3 ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 1 4)) (in_range4 temp___expr_427)))
...
(declare-const temp___537 privileget)
(declare-const temp___5371 opandnullt)
(declare-const o3 opandnullt)
(declare-const o4 privileget)
(declare-const o5 opandnullt)
(declare-const temp___539 privileget)
(declare-const temp___5391 opandnullt)
...
(assert (= temp___537 o1))
(assert (= temp___5371 o2))
(assert (= result theadmin__split_fields))
(assert (= result1 theadmin__split_fields1))
(assert (= temp___537 theadmin__split_fields2))
(assert (= temp___5371 theadmin__split_fields3))
(assert (= (to_rep1 o3) 0))
(assert (= theadmin__split_fields2 o4))
(assert (= o3 o5))
(assert (= temp___539 o4))
(assert (= temp___5391 o5))
(assert (= result2 theadmin__split_fields2))
(assert (= result3 theadmin__split_fields3))
(assert (= temp___539 theadmin__split_fields4))
(assert (= temp___5391 theadmin__split_fields5))
