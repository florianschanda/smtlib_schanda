...
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) (next (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4)))) true)))
(check-sat)
(exit)
