...
(assert (= (to_rep1 o) 1))
(assert (= o o8))
(assert (= temp___934 o8))
(assert (= temp___9341 o4))
(assert (= temp___9342 o5))
(assert (= temp___9343 o6))
(assert (= temp___9344 o7))
(assert (= true temp___9345))
(assert (= t__attr__constrained true))
(assert (not (= temp___934 t__split_discrs)))
(check-sat)
(exit)
