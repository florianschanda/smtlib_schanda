...
(define-fun dynamic_invariant1 ((temp___expr_660 Int) (temp___is_init_657 Bool) (temp___skip_constant_658 Bool) (temp___do_toplevel_659 Bool)) Bool (=> (or (= temp___is_init_657 true) (<= 0 8)) (in_range3 temp___expr_660)))
...
(define-fun default_initial_assumption ((temp___expr_674 us_rep) (temp___skip_top_level_675 Bool)) Bool (and (= (attr__constrained temp___expr_674) false) (= (to_rep1 (rec__lexer__token__kind (us_split_discrs1 temp___expr_674))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_651 Int) (temp___is_init_648 Bool) (temp___skip_constant_649 Bool) (temp___do_toplevel_650 Bool)) Bool (=> (or (= temp___is_init_648 true) (<= 0 2147483647)) (in_range2 temp___expr_651)))
...
(assert (= kind 1))
(assert (= (to_rep1 t__split_discrs) r19b))
(assert (in_range3 r19b))
(assert (= (to_rep o1) 1))
(assert (= (to_rep o2) first_col))
(assert (= (to_rep o3) first_line))
(assert (= o3 o4))
(assert (= o2 o5))
(assert (= o1 o6))
(assert (= dummy1 o7))
(assert (= (to_rep1 o) 1))
(assert (= o o8))
(assert (= temp___944 o8))
(assert (= temp___9441 o4))
(assert (= temp___9442 o5))
(assert (= temp___9443 o6))
(assert (= temp___9444 o7))
(assert (= true temp___9445))
(assert (= t__attr__constrained true))
(assert (not (= temp___944 t__split_discrs)))
(check-sat)
(exit)
