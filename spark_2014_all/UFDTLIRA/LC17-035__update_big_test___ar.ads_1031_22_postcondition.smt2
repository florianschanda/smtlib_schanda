...
(declare-const temp___7096 us_rep3)
...
(assert (= temp___7096 (mk___rep3 o19)))
...
(assert (= r__split_fields6 (us_split_fields7 temp___7096)))
(assert (= r__split_fields7 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields8 r__split_fields6))
(assert (not (= (to_rep4 (rec__ar__rec4t__g4 (us_split_fields__content3 r__split_fields7))) (to_rep4 r__split_fields5))))
(check-sat)
(exit)
