...
(define-fun default_initial_assumption ((temp___expr_476 us_rep2) (temp___skip_top_level_477 Bool)) Bool (=> (not (= temp___skip_top_level_477 true)) (and (= (is_empty temp___expr_476) true) (= (length1 temp___expr_476) 0))))
(define-fun default_initial_assumption1 ((temp___expr_462 us_rep1) (temp___skip_top_level_463 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_462))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_417 us_rep1) (temp___skip_top_level_418 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_417))) 0))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container)))))))
