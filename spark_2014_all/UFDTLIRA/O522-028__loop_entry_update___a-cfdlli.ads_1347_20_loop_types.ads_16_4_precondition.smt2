...
(define-fun default_initial_assumption ((temp___expr_370 us_rep1) (temp___skip_top_level_371 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_370))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range2 temp___expr_414)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption1 ((temp___expr_421 us_rep2) (temp___skip_top_level_422 Bool)) Bool (=> (not (= temp___skip_top_level_422 true)) (and (= (is_empty temp___expr_421) true) (= (length1 temp___expr_421) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_409 us_rep1) (temp___skip_top_level_410 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_409))) 0))
...
(declare-const temp___666 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___666 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___666)) no_element))
