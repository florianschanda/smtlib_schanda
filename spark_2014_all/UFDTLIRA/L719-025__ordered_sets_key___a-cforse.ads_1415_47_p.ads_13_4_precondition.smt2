...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant1 (first_element1 attr__tag container) true false true true) :pattern ((first_element1 attr__tag container))))))
