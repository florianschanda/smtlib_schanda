...
(assert (and (= temp___404 (id 2147483647 fst 2147483647)) (and (in_range1 temp___404) (=> (and (<= fst 2147483647) (<= 2147483647 2147483647)) (and (<= fst temp___404) (<= temp___404 2147483647))))))
(assert (and (= us temp___404) (dynamic_property first 2147483647 temp___404)))
(assert (= use_vectors__lst__assume temp___404))
(assert (= use_vectors__lst__assume lst))
(assert (dynamic_property first 2147483647 lst))
(assert (<= fst lst))
(assert (not (<= lst 2147483647)))
(check-sat)
(exit)
