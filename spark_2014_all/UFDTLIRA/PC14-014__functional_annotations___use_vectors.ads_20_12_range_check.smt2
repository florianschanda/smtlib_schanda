...
(assert (and (= temp___361 (id 2147483647 fst 2147483647)) (and (in_range1 temp___361) (=> (and (<= fst 2147483647) (<= 2147483647 2147483647)) (and (<= fst temp___361) (<= temp___361 2147483647))))))
(assert (and (= us temp___361) (dynamic_property first 2147483647 temp___361)))
(assert (= use_vectors__lst__assume temp___361))
