...
(assert (= result2 true))
(assert (not (= (local_invariant (us_split_fields__content current_read__split_fields6) (us_split_discrs__content current_read__split_discrs6) (us_split_fields__content next_read__split_fields6) (us_split_discrs__content next_read__split_discrs6)) true)))
(check-sat)
(exit)
