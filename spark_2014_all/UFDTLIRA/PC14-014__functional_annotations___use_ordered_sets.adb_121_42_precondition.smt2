...
(assert (= result2 true))
(assert (and (= o7 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length2 o7) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___390 Int)) (=> (and (in_range5 temp___390) (= (iter_has_element o7 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o7 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o7 item)) (= (equivalent_elements (get o7 (find o7 item)) item) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o7 (get o7 i2)) i2) (= (e_is_find o7 (get o7 i2) i2) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
