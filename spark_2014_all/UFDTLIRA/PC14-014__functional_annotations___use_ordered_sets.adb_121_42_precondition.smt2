...
(assert (forall ((e Int)) (=> (and (in_range3 e) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1) e))))))
...
(assert (= result2 true))
(assert (and (= o2 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length2 o2) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___390 Int)) (=> (and (in_range5 temp___390) (= (iter_has_element o2 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o2 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
