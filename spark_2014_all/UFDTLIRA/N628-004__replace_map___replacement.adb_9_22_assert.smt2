...
(assert (forall ((c us_rep1)) (=> (= (has_key (positions d_old) c) true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true))))
(declare-const c us_rep1)
(assert (= (has_key (positions d_old) c) true))
(assert (not (= (key d_old c) (key (mk___rep d__split_discrs d__split_fields2) c))))
(check-sat)
(exit)
