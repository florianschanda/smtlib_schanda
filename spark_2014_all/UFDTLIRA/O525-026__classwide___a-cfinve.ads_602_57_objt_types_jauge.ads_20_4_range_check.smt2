...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__objt_types_jauge__objt_liste_jauge__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type (rec__objt_types_jauge__objt_liste_jauge__vector a))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__objt_types_jauge__objt_liste_jauge__vector__capacity (us_split_discrs1 container))) 4))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 4)) (in_range1 temp___expr_284)))
...
(define-fun dynamic_invariant1 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 5)) (in_range2 temp___expr_277)))
...
(define-fun dynamic_invariant2 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 1 4)) (in_range3 temp___expr_265)))
...
(define-fun dynamic_invariant3 ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 2147483647)) (in_range4 temp___expr_239)))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__ext__ us_private)))))
...
(declare-datatypes () ((tinterface_jauge__ref (mk_tinterface_jauge__ref (tinterface_jauge__content us_rep2)))))
(define-fun tinterface_jauge__ref___projection ((a tinterface_jauge__ref)) us_rep2 (tinterface_jauge__content a))
(define-fun default_initial_assumption ((temp___expr_247 us_rep2) (temp___skip_top_level_248 Bool)) Bool (= (attr__tag temp___expr_247) us_tag))
...
(define-fun default_initial_assumption1 ((temp___expr_321 us_rep1) (temp___skip_top_level_322 Bool)) Bool (=> (not (= temp___skip_top_level_322 true)) (= (length1 temp___expr_321) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_313 Int) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool (=> (or (= temp___is_init_309 true) (<= 0 4)) (in_range5 temp___expr_313)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 4) (dynamic_invariant3 result true false true true))) :pattern ((length1 container)))))
(assert true)
