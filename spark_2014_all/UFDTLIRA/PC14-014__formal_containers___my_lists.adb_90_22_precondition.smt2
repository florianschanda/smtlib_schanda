...
(assert (and (= o4 (next (mk___rep l__split_discrs l__split_fields8) (mk___rep1 c__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields8)) (mk___rep1 c__split_fields2)) (length (mk___rep l__split_discrs l__split_fields8))) true) true) (= (bool_eq1 o4 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o4) true) (= (get (positions (mk___rep l__split_discrs l__split_fields8)) o4) (+ (get (positions (mk___rep l__split_discrs l__split_fields8)) (mk___rep1 c__split_fields2)) 1))))))
