...
(assert (and (= o17 (next (mk___rep l__split_discrs l__split_fields26) (mk___rep1 c__split_fields14))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields14) no_element) false) (= (get (positions (mk___rep l__split_discrs l__split_fields26)) (mk___rep1 c__split_fields14)) (length (mk___rep l__split_discrs l__split_fields26))) true) true) (= (bool_eq1 o17 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields26)) o17) true) (= (get (positions (mk___rep l__split_discrs l__split_fields26)) o17) (+ (get (positions (mk___rep l__split_discrs l__split_fields26)) (mk___rep1 c__split_fields14)) 1))))))
