...
(assert (or (not (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 e))) 0)) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 e)) true)))
