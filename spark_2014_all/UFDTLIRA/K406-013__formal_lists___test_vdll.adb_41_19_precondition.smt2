...
(assert (and (= o7 (next (mk___rep l2__split_discrs l2__split_fields2) o6)) (ite (= (ite (= (bool_eq1 o6 no_element) false) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o6) (length (mk___rep l2__split_discrs l2__split_fields2))) true) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields2)) o7) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o7) (+ (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o6) 1))))))
(assert (not (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields2)) o7) true)))
(check-sat)
(exit)
