...
(assert (and (= o3 (next (mk___rep l2__split_discrs l2__split_fields2) o2)) (ite (= (ite (= (bool_eq3 o2 no_element) false) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o2) (length (mk___rep l2__split_discrs l2__split_fields2))) true) true) (= (bool_eq3 o3 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields2)) o3) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o3) (+ (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o2) 1))))))
(assert (not (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields2)) o3) true)))
(check-sat)
(exit)
