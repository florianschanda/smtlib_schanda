...
(declare-const temp___468 Bool)
(declare-const temp___4681 unsigned_byte)
(declare-const temp___4682 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___468 o5))
(assert (= temp___4681 o6))
(assert (= temp___4682 o7))
...
(assert (= r__split_fields3 (mk___split_fields1 temp___468 (mk___rep (mk___split_fields temp___4681 temp___4682)))))
