...
(declare-const temp___4351 unsigned_byte)
(declare-const temp___4352 unsigned_byte)
...
(declare-const temp___442 Bool)
(declare-const temp___4421 unsigned_byte)
(declare-const temp___4422 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___435 o5))
(assert (= temp___4351 o6))
(assert (= temp___4352 o7))
...
(assert (= r__split_fields3 (mk___split_fields1 temp___435 (mk___rep (mk___split_fields temp___4351 temp___4352)))))
