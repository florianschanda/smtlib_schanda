...
(assert (and (= o13 (length m)) (and (in_range4 o13) (<= o13 (capacity m)))))
(assert (and (= o11 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o11) (<= o11 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o12 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o12) (<= o12 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o14 (+ o12 o11)))
(assert (= result2 (ite (= o14 o13) true false)))
(assert (=> (= result2 true) (and (= o10 (length m)) (and (in_range4 o10) (<= o10 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o10 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o8 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o8) (<= o8 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
