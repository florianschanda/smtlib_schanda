...
(declare-const temp___6653 et3)
(declare-const temp___66531 et1)
(declare-const temp___66532 et2)
(declare-const temp___66533 enum1ta)
...
(assert (= temp___6653 o5))
(assert (= temp___66531 o6))
(assert (= temp___66532 o7))
(assert (= temp___66533 o8))
...
(assert (= temp___6653 r__split_fields4))
(assert (= temp___66531 r__split_fields5))
(assert (= temp___66532 r__split_fields6))
(assert (= temp___66533 r__split_fields7))
(assert (= r__split_fields8 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields4 (mk___rep (mk___split_fields r__split_fields5 r__split_fields6)) r__split_fields7))))
(assert (= r__split_fields9 (mk___split_fields1 r__split_fields4 (mk___rep (mk___split_fields r__split_fields5 r__split_fields6)) r__split_fields7)))
