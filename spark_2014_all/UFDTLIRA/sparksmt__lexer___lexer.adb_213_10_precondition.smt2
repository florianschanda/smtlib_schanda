...
(assert (not (= (local_invariant (mk___split_fields1 current_read__split_fields) (mk___split_discrs1 current_read__split_discrs) (mk___split_fields1 next_read__split_fields) (mk___split_discrs1 next_read__split_discrs)) true)))
(check-sat)
(exit)
