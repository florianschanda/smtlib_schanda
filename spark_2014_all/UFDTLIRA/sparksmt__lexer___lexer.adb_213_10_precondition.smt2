...
(assert (= (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields1))) (+ (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields))) 1)))
(assert (not (= (local_invariant (mk___split_fields current_read__split_fields) (mk___split_discrs current_read__split_discrs) (mk___split_fields next_read__split_fields) (mk___split_discrs next_read__split_discrs)) true)))
(check-sat)
(exit)
