...
(define-fun dynamic_invariant ((temp___expr_401 Int) (temp___is_init_397 Bool) (temp___skip_constant_398 Bool) (temp___do_toplevel_399 Bool) (temp___do_typ_inv_400 Bool)) Bool (=> (or (= temp___is_init_397 true) (<= 1 2147483647)) (in_range2 temp___expr_401)))
