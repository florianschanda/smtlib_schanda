...
(define-fun dynamic_invariant1 ((temp___expr_301 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 0 100)) (in_range3 temp___expr_301)))
...
(define-fun default_initial_assumption ((temp___expr_308 us_rep) (temp___skip_top_level_309 Bool)) Bool (=> (not (= temp___skip_top_level_309 true)) (= (length temp___expr_308) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_208 Int) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (or (= temp___is_init_205 true) (<= 0 2147483647)) (in_range4 temp___expr_208)))
