...
(define-fun dynamic_invariant ((temp___expr_244 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 1 1000)) (in_range2 temp___expr_244)))
...
(define-fun dynamic_invariant1 ((temp___expr_256 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 1000)) (in_range3 temp___expr_256)))
...
(define-fun default_initial_assumption ((temp___expr_263 us_rep) (temp___skip_top_level_264 Bool)) Bool (=> (not (= temp___skip_top_level_264 true)) (= (length temp___expr_263) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_250 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 0 2147483647)) (in_range5 temp___expr_250)))
