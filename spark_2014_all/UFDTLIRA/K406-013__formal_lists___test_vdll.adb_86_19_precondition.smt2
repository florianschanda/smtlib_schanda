...
(assert (and (= o47 (last1 (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq1 o47 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o47) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o47) (length (mk___rep l3__split_discrs l3__split_fields2)))))))
(assert (and (= o48 (previous (mk___rep l3__split_discrs l3__split_fields2) o47)) (ite (= (ite (= (bool_eq1 o47 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o47) 1) true) true) (= (bool_eq1 o48 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o48) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o48) (- (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o47) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) no_element) true) (= (bool_eq1 no_element no_element) true))))
(check-sat)
(exit)
