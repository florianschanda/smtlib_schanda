...
(declare-const temp___1175 us_rep2)
(declare-const temp___1177 us_rep2)
...
(assert (and (= temp___1177 (find4 (mk___rep1 k__split_discrs k__split_fields6) 2)) (ite (forall ((e us_rep)) (=> (= (contains (model__ (mk___rep1 k__split_discrs k__split_fields6)) e) true) (not (= (equivalent_keys 2 (to_rep1 (rec__my_ordered_sets__my_rec__f (us_split_fields1 e)))) true)))) (and (not (= (has_key (positions (mk___rep1 k__split_discrs k__split_fields6)) temp___1177) true)) (= (bool_eq2 temp___1177 no_element) true)) (and (and (= (has_key (positions (mk___rep1 k__split_discrs k__split_fields6)) temp___1177) true) (= (get1 (positions (mk___rep1 k__split_discrs k__split_fields6)) temp___1177) (find3 (elements (mk___rep1 k__split_discrs k__split_fields6)) 2))) (= (equivalent_keys (to_rep1 (rec__my_ordered_sets__my_rec__f (us_split_fields1 (element (mk___rep1 k__split_discrs k__split_fields6) temp___1177)))) 2) true)))))
(assert (= result23 (mk___split_fields__ref2 c__split_fields8)))
(assert (= c__split_fields9 (us_split_fields5 temp___1177)))
