...
(assert (and (= o10 (last1 left)) (and (dynamic_property1 first1 last2 o10) (= o10 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o10) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o8 first) (in_range3 first))))
(assert (=> (< offset 0) (and (= o9 (- (- 2147483648) offset)) (in_range3 (- (- 2147483648) offset)))))
