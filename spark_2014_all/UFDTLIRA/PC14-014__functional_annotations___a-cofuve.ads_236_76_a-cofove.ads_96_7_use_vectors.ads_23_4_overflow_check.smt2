...
(assert (and (= o10 (last2 left)) (and (dynamic_property1 first1 last1 o10) (= o10 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o10) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o8 first) (in_range1 first))))
(assert (=> (< offset 0) (and (= o9 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
