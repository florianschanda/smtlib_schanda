...
(define-fun dynamic_invariant1 ((temp___expr_260 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool) (temp___do_typ_inv_259 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 1001)) (in_range2 temp___expr_260)))
...
(define-fun dynamic_invariant2 ((temp___expr_267 Int) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool) (temp___do_typ_inv_266 Bool)) Bool (=> (or (= temp___is_init_263 true) (<= 0 1000)) (in_range3 temp___expr_267)))
...
(define-fun dynamic_invariant3 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 1000)) (in_range4 temp___expr_246)))
...
(define-fun default_initial_assumption ((temp___expr_306 us_rep1) (temp___skip_top_level_307 Bool)) Bool (=> (not (= temp___skip_top_level_307 true)) (= (length1 temp___expr_306) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_298 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool) (temp___do_typ_inv_297 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 0 1000)) (in_range5 temp___expr_298)))
...
(define-fun dynamic_invariant5 ((temp___expr_291 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 2147483647)) (in_range6 temp___expr_291)))
