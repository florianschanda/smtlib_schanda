...
(assert (<= (length q) 100))
(assert (and (= o19 (length q)) (and (in_range3 o19) (<= (+ 0 o19) 2147483647))))
(assert (and (= o16 (length v)) (and (in_range3 o16) (<= (+ 0 o16) 2147483647))))
(assert (and (= o17 (length p)) (and (in_range3 o17) (<= (+ 0 o17) 2147483647))))
(assert (= o18 (- o17 o16)))
(assert (and (= o20 o18) (in_range1 o18)))
(assert (= result2 (ite (= o20 o19) true false)))
(assert (=> (= result2 true) (and (= o14 (length q)) (and (in_range3 o14) (<= (+ 0 o14) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o12 (length v)) (and (in_range3 o12) (<= (+ 0 o12) 2147483647)))))
