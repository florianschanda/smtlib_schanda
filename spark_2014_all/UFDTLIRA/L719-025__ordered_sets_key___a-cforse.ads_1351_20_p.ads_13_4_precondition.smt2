...
(define-fun default_initial_assumption ((temp___expr_420 us_rep2) (temp___skip_top_level_421 Bool)) Bool (=> (not (= temp___skip_top_level_421 true)) (and (= (is_empty temp___expr_420) true) (= (length1 temp___expr_420) 0))))
...
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq6 a b) (oeq1 a b)) :pattern ((user_eq6 a b)))))
...
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length container1)) (forall ((temp___435 Int)) (=> (and (in_range6 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container1) (get1 result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container)))))))
