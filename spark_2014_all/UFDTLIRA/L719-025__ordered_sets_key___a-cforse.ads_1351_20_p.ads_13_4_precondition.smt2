...
(define-fun dynamic_invariant1 ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range2 temp___expr_412)))
...
(define-fun e_bigger_than_range ((container1 us_rep3) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_inf (get1 container1 i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep3 Int Int Int) Bool)
(define-fun e_smaller_than_range ((container1 us_rep3) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_inf item (get1 container1 i)) true))) true false))
...
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___435 Int)) (=> (and (in_range6 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container1) (get1 result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___678 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___678)) no_element))
