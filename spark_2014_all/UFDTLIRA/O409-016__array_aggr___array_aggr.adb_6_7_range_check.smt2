...
(assert (= first one))
(assert (forall ((temp___295 Int)) (=> (dynamic_invariant temp___295 true true true true) (forall ((temp___296 Int) (temp___297 Int)) (= (to_rep1 (get (array_aggr__bi_dim_aggr_ok__a__aggregate_def temp___295) temp___296 temp___297)) temp___295)))))
(assert (forall ((temp___300 Int)) (=> (dynamic_invariant temp___300 true true true true) (forall ((temp___301 Int) (temp___302 Int)) (= (to_rep1 (get (array_aggr__bi_dim_aggr_ok__c__aggregate_def temp___300) temp___301 temp___302)) temp___300)))))
