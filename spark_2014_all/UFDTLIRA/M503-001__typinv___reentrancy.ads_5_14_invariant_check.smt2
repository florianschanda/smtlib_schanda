...
(assert (=> (= start true) (= result start)))
(assert (=> (= start true) (= start2 (distinct 0 0))))
(assert (=> (= start true) (and (in_range1 x1) (type_invariant x1))))
(assert (=> (not (= start true)) (= result1 x)))
(assert (=> (not (= start true)) (= x2 1)))
(assert (=> (not (= start true)) (= start3 start)))
(assert (=> (not (= start true)) (= x1 x2)))
