...
(define-fun us_rep___32__projection ((a us_rep1)) us_split_discrs (us_split_discrs2 a))
(define-fun us_rep___33__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun dynamic_invariant ((temp___expr_1717 us_rep1) (temp___is_init_1713 Bool) (temp___skip_constant_1714 Bool) (temp___do_toplevel_1715 Bool) (temp___do_typ_inv_1716 Bool)) Bool (=> (not (= temp___skip_constant_1714 true)) (in_range1 1 2 3 (to_base temp___expr_1717))))
(define-fun default_initial_assumption ((temp___expr_1721 us_rep1) (temp___skip_top_level_1722 Bool)) Bool (and (and (= (to_rep (rec__q__pt__x (us_split_discrs2 temp___expr_1721))) 1) (= (to_rep (rec__q__pt__y (us_split_discrs2 temp___expr_1721))) 2)) (= (to_rep (rec__q__pt__z (us_split_discrs2 temp___expr_1721))) 3)))
