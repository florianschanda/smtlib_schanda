...
(define-fun us_split_discrs___projection ((a us_split_discrs)) integer (rec__q__pt__x a))
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) integer (rec__q__pt__y a))
(define-fun us_split_discrs___3__projection ((a us_split_discrs)) integer (rec__q__pt__z a))
...
(define-fun us_rep___29__projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___30__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
...
(define-fun us_rep___32__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun dynamic_invariant ((temp___expr_1541 us_rep1) (temp___is_init_1538 Bool) (temp___skip_constant_1539 Bool) (temp___do_toplevel_1540 Bool)) Bool (=> (not (= temp___skip_constant_1539 true)) (in_range1 1 2 3 (to_base temp___expr_1541))))
(define-fun default_initial_assumption ((temp___expr_1545 us_rep1) (temp___skip_top_level_1546 Bool)) Bool (and (and (= (to_rep (rec__q__pt__x (us_split_discrs2 temp___expr_1545))) 1) (= (to_rep (rec__q__pt__y (us_split_discrs2 temp___expr_1545))) 2)) (= (to_rep (rec__q__pt__z (us_split_discrs2 temp___expr_1545))) 3)))
