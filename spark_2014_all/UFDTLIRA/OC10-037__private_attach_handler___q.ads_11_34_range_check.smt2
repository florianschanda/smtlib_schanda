...
(define-fun dynamic_invariant ((temp___expr_1531 us_rep1) (temp___is_init_1528 Bool) (temp___skip_constant_1529 Bool) (temp___do_toplevel_1530 Bool)) Bool (=> (not (= temp___skip_constant_1529 true)) (in_range1 1 2 3 (to_base temp___expr_1531))))
(define-fun default_initial_assumption ((temp___expr_1535 us_rep1) (temp___skip_top_level_1536 Bool)) Bool (and (and (= (to_rep (rec__q__pt__x (us_split_discrs2 temp___expr_1535))) 1) (= (to_rep (rec__q__pt__y (us_split_discrs2 temp___expr_1535))) 2)) (= (to_rep (rec__q__pt__z (us_split_discrs2 temp___expr_1535))) 3)))
