...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__use_ordered_sets__my_sets__cursor__node (us_split_fields1 a))) (to_rep (rec__use_ordered_sets__my_sets__cursor__node (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__use_ordered_sets__my_sets__set us_main_type1)))))
(define-fun us_split_fields_Set__projection ((a us_split_fields2)) us_main_type1 (rec__use_ordered_sets__my_sets__set a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 a))) (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__use_ordered_sets__my_sets__set (us_split_fields3 a)) (rec__use_ordered_sets__my_sets__set (us_split_fields3 b))) true)) true false))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length1 container1)) (forall ((temp___435 Int)) (=> (and (in_range5 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container1) (get1 result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
