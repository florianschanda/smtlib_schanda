...
(define-fun dynamic_invariant ((temp___expr_1518 Int) (temp___is_init_1515 Bool) (temp___skip_constant_1516 Bool) (temp___do_toplevel_1517 Bool)) Bool (=> (or (= temp___is_init_1515 true) (<= 0 63)) (in_range temp___expr_1518)))
(declare-const self__ us_rep)
(declare-const temp___1602 Bool)
(assert (not (= temp___1602 false)))
(check-sat)
(exit)
