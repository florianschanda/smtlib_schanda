...
(define-fun dynamic_invariant ((temp___expr_1702 Int) (temp___is_init_1698 Bool) (temp___skip_constant_1699 Bool) (temp___do_toplevel_1700 Bool) (temp___do_typ_inv_1701 Bool)) Bool (=> (or (= temp___is_init_1698 true) (<= 0 63)) (in_range temp___expr_1702)))
(declare-const self__ us_rep)
(declare-const temp___1793 Bool)
(assert (not (= temp___1793 false)))
(check-sat)
(exit)
