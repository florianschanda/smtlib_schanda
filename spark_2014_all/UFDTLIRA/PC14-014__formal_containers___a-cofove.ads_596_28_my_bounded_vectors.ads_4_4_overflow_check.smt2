...
(define-fun dynamic_invariant3 ((temp___expr_676 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 2147483647)) (in_range5 temp___expr_676)))
