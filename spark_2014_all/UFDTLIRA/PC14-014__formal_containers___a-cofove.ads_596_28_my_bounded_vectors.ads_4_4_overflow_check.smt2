...
(define-fun dynamic_invariant3 ((temp___expr_682 Int) (temp___is_init_679 Bool) (temp___skip_constant_680 Bool) (temp___do_toplevel_681 Bool)) Bool (=> (or (= temp___is_init_679 true) (<= 1 2147483647)) (in_range5 temp___expr_682)))
