...
(assert (<= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu3) i3))
(assert (<= i3 (length (mk___rep l__split_discrs l__split_fields3))))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))
(check-sat)
(exit)
