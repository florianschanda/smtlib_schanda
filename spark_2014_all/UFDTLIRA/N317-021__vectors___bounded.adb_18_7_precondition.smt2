...
(assert (= v__split_fields2 bounded__vect__clear__container__fields1))
(assert (= (is_empty (mk___rep v__split_discrs v__split_fields2)) true))
(assert (= (oeq (mk___rep v__split_discrs v__split_fields2) (empty_vector Tuple0)) true))
(assert (= (capacity (mk___rep v__split_discrs v__split_fields2)) 5))
(assert (not (< (length (mk___rep v__split_discrs v__split_fields2)) (capacity (mk___rep v__split_discrs v__split_fields2)))))
(check-sat)
(exit)
