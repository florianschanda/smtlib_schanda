...
(define-fun default_initial_assumption ((temp___expr_184 us_rep) (temp___skip_top_level_185 Bool)) Bool (= (to_rep (rec__active_prio__q_type__a (us_split_fields1 temp___expr_184))) 0))
