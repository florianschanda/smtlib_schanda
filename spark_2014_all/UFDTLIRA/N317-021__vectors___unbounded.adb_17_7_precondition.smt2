...
(define-fun unbounded__vect__append__2__container__fields1 () us_split_fields (mk___split_fields unbounded__vect__append__2__container__fields))
...
(assert (= v__split_fields4 unbounded__vect__clear__container__fields1))
...
(assert (and (and (= (length (mk___rep v__split_discrs unbounded__vect__append__2__container__fields1)) (+ (length (mk___rep v__split_discrs v__split_fields4)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields4)) (model__ (mk___rep v__split_discrs unbounded__vect__append__2__container__fields1))) true)) (= (get (model__ (mk___rep v__split_discrs unbounded__vect__append__2__container__fields1)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields4))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= v__split_fields3 unbounded__vect__append__2__container__fields1))
