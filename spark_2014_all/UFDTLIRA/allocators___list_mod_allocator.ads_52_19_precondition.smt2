...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range3 temp___expr_142)))
...
(define-fun dynamic_invariant2 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 2147483647)) (in_range4 temp___expr_178)))
...
(assert (in_range1 e))
(assert (and (= o6 (length s)) (and (in_range3 o6) (<= (+ 0 o6) 2147483647))))
(assert (= result2 (ite (< o6 2147483647) true false)))
(assert (=> (= result2 true) (and (= o2 (length s)) (and (in_range3 o2) (<= (+ 0 o2) 2147483647)))))
(assert (=> (= result2 true) (= o3 (+ o2 1))))
(assert (=> (= result2 true) (and (= o4 o3) (in_range o3))))
(assert (=> (= result2 true) (and (= o5 (length result__)) (and (in_range3 o5) (<= (+ 0 o5) 2147483647)))))
(assert (=> (= result2 true) (= result1 (ite (= o5 o4) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o1 (get result__ 1)) (in_range5 o1))))
(assert (=> (= result1 true) (= result (ite (= o1 e) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (last s)) (and (in_range4 o) (= o (+ 0 (length s))))))
(assert (not (<= o (last s))))
(check-sat)
(exit)
