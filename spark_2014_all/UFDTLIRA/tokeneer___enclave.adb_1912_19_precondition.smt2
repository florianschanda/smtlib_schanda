...
(assert (=> (= result1 true) (and (= o29 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o29))))
(assert (=> (= result1 true) (= o30 (ite (= o29 3) true false))))
(assert (=> (= result1 true) (= o31 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result1 true) (= o32 (ite (= o31 true) o30 false))))
(assert (=> (not (= result1 true)) (= o32 (of_int 1))))
(assert (and (= o23 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range3 o23)))
(assert (= o24 (ite (= o23 4) true false)))
(assert (= o25 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))))
(assert (= result2 (ite (= o25 true) o24 false)))
(assert (=> (= result2 true) (= o26 (ite (= (int__content status8) 6) true false))))
(assert (=> (not (= result2 true)) (= o26 (of_int 1))))
(assert (=> (= (int__content status8) 8) (and (= o19 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range1 o19))))
(assert (=> (= (int__content status8) 8) (= o20 (ite (= o19 0) true false))))
(assert (=> (= (int__content status8) 8) (= o18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6))))))
(assert (=> (= (int__content status8) 8) (= o21 (ite (not (= o18 true)) true false))))
(assert (=> (= (int__content status8) 8) (= o22 (ite (= o21 true) o20 false))))
(assert (=> (not (= (int__content status8) 8)) (= o22 (of_int 1))))
(assert (=> (= (int__content status8) 3) (= o16 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6))))))
(assert (=> (= (int__content status8) 3) (= o17 (ite (not (= o16 true)) true false))))
(assert (=> (not (= (int__content status8) 3)) (= o17 (of_int 1))))
(assert (=> (=> (not (= (int__content status8) 6)) (= (int__content status8) 7)) (and (= o11 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o11))))
(assert (=> (=> (not (= (int__content status8) 6)) (= (int__content status8) 7)) (and (= o12 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range1 o12))))
(assert (=> (=> (not (= (int__content status8) 6)) (= (int__content status8) 7)) (= o13 (ite (= o12 o11) true false))))
(assert (=> (=> (not (= (int__content status8) 6)) (= (int__content status8) 7)) (= o9 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields6))))))
(assert (=> (=> (not (= (int__content status8) 6)) (= (int__content status8) 7)) (= o10 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6))))))
...
(assert (=> (not (=> (not (= (int__content status8) 6)) (= (int__content status8) 7))) (= o15 (of_int 1))))
(assert (=> (=> (not (= (int__content status8) 5)) (= (int__content status8) 4)) (= o7 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields6))))))
(assert (=> (=> (not (= (int__content status8) 5)) (= (int__content status8) 4)) (= o8 (ite (not (= o7 true)) true false))))
(assert (=> (not (=> (not (= (int__content status8) 5)) (= (int__content status8) 4))) (= o8 (of_int 1))))
(assert (= o4 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields6)))))
(assert (= result3 (ite (not (= o4 true)) true false)))
(assert (=> (= result3 true) (= o5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6))))))
...
(assert (= result4 true))
(assert (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))))
