...
(assert (and (= (mk___rep (mk___split_discrs temp___354) (mk___split_fields temp___3541) temp___3542) (new_with_default 0)) (= (to_rep temp___354) 0)))
(assert (= d__attr__constrained true))
(assert (not (= temp___354 d__split_discrs)))
(check-sat)
(exit)
