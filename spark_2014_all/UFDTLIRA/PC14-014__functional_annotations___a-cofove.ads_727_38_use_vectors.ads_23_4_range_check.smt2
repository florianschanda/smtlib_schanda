...
(define-fun dynamic_invariant ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first last)) (dynamic_property first last temp___expr_242)))
(assert (= first fst))
(assert (= last lst))
...
(define-fun dynamic_invariant1 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_249)))
...
(define-fun dynamic_invariant2 ((temp___expr_270 us_rep) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (dynamic_property1 0 last1 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 temp___expr_270)))))
...
(define-fun dynamic_invariant6 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 last1)) (dynamic_property1 0 last1 temp___expr_263)))
(assert (= last1 last_count))
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 0 0) true) (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 container1))) last1))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container1 us_rep)) (! (=> (dynamic_invariant2 container1 true true true true) (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant6 result true false true true)))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant7 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_294)))
(assert (= first2 (- first1 1)))
(assert (= last3 last2))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ (- first1 1) result) last2) (dynamic_invariant5 result true false true true))) :pattern ((length container1)))))
...
(assert (forall ((container1 us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true true) (and (<= first1 position) (<= position (last4 container1)))) (dynamic_invariant8 (get container1 position) true false true true)) :pattern ((get container1 position))))))
(define-fun dynamic_invariant9 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first1 last2)) (dynamic_property2 first1 last2 temp___expr_280)))
(assert (= first1 fst))
(assert (= last2 lst))
...
(assert (and (= o (last4 (model__ container))) (and (dynamic_property4 first3 last5 o) (= o (last4 (model__ container))))))
(assert (= result (ite (< o index) true false)))
(assert (not (= result true)))
(assert (and (= temp___460 (last4 (model__ container))) (and (dynamic_property4 first3 last5 temp___460) (= temp___460 (last4 (model__ container))))))
(assert (not (dynamic_property3 first2 last3 temp___460)))
(check-sat)
(exit)
