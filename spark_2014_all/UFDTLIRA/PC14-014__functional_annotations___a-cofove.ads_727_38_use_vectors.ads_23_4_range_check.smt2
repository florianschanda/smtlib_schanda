...
(assert (and (= o (last1 (model__ container))) (and (dynamic_property3 first2 last4 o) (= o (last1 (model__ container))))))
...
(assert (not (dynamic_property4 first3 last5 temp___460)))
(check-sat)
(exit)
