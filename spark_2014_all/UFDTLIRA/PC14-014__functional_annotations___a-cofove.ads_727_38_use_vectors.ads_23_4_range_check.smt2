...
(define-fun dynamic_invariant ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= first last)) (dynamic_property first last temp___expr_207)))
(assert (= first fst))
(assert (= last lst))
...
(define-fun dynamic_invariant1 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_213)))
...
(define-fun dynamic_invariant2 ((temp___expr_231 us_rep) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (dynamic_property1 0 last1 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 temp___expr_231)))))
...
(define-fun index_type__ref___3__projection ((a index_type__ref1)) integer (index_type__content1 a))
...
(define-fun contains ((container us_rep1) (fst1 Int) (lst1 Int) (item Int)) Bool (ite (exists ((i Int)) (and (and (<= fst1 i) (<= i lst1)) (= (get container i) item))) true false))
...
(define-fun last4 ((container us_rep1)) Int (+ (- first1 1) (length container)))
...
(define-fun oeq ((left us_rep1) (right us_rep1)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= first1 n) (<= n (last4 left))) (= (get left n) (get right n)))) true false)))
...
(assert (= last5 (+ (ite (< 2147483646 last) 2147483646 last) 1)))
...
(assert (forall ((x Int) (f Int) (l Int)) (! (=> (and (and (dynamic_invariant4 x true true true) (dynamic_invariant4 f true true true)) (dynamic_invariant4 l true true true)) (let ((result (id x f l))) (and (=> (and (<= f x) (<= x l)) (and (<= f result) (<= result l))) (dynamic_invariant4 result true false true)))) :pattern ((id x f l)))))
...
(define-fun dynamic_invariant6 ((temp___expr_225 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 last1)) (dynamic_property1 0 last1 temp___expr_225)))
(assert (= last1 last_count))
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 0) true) (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 container1))) last1))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container1 us_rep)) (! (=> (dynamic_invariant2 container1 true true true) (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant6 result true false true)))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant7 ((temp___expr_252 Int) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool)) Bool (=> (or (= temp___is_init_249 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_252)))
(assert (= first2 (- first1 1)))
(assert (= last3 last2))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ (- first1 1) result) last2) (dynamic_invariant5 result true false true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant8 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_246)))
(assert (forall ((container1 us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true) (and (<= first1 position) (<= position (last4 container1)))) (dynamic_invariant8 (get container1 position) true false true)) :pattern ((get container1 position))))))
(define-fun dynamic_invariant9 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= first1 last2)) (dynamic_property2 first1 last2 temp___expr_240)))
(assert (= first1 fst))
(assert (= last2 lst))
(declare-const o us_rep1)
(declare-const us Int)
(declare-const o1 Int)
(declare-const temp___421 Int)
(declare-const us1 Int)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const o4 Int)
(declare-const result Bool)
(assert (dynamic_property1 0 last1 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 container)))))
(assert (in_range2 item))
(assert (dynamic_property first last index))
(assert (and (= o4 (last4 (model__ container))) (and (dynamic_property4 first3 last5 o4) (= o4 (last4 (model__ container))))))
(assert (= result (ite (< o4 index) true false)))
(assert (not (= result true)))
(assert (and (= temp___421 (last4 (model__ container))) (and (dynamic_property4 first3 last5 temp___421) (= temp___421 (last4 (model__ container))))))
(assert (not (dynamic_property3 first2 last3 temp___421)))
(check-sat)
(exit)
