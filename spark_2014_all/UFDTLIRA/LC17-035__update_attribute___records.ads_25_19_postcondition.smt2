...
(declare-const temp___251 integer)
(declare-const temp___2511 natural)
(declare-const temp___2512 my_range)
...
(declare-const temp___2531 natural)
(declare-const temp___2532 my_range)
(declare-const temp___2533 integer)
...
(declare-const temp___2551 natural)
(declare-const temp___2552 my_range)
(declare-const temp___2553 integer)
...
(assert (= temp___251 r__split_fields4))
(assert (= temp___2511 r__split_fields5))
(assert (= temp___2512 r__split_fields6))
(assert (= temp___2513 r__split_fields7))
...
(assert (= temp___253 r__split_fields8))
(assert (= temp___2531 r__split_fields9))
(assert (= temp___2532 r__split_fields10))
(assert (= temp___2533 r__split_fields11))
...
(assert (= temp___2551 o12))
(assert (= temp___2552 o13))
(assert (= temp___2553 o14))
...
(assert (= temp___255 r__split_fields12))
(assert (= temp___2551 r__split_fields13))
(assert (= temp___2552 r__split_fields14))
(assert (= temp___2553 r__split_fields15))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields16 r__split_fields17 r__split_fields18 r__split_fields19)) (mk___rep (mk___split_fields (of_rep 10) (of_rep1 new_data) (of_rep2 10) r__split_fields3))) true)))
(check-sat)
(exit)
