...
(assert (= r__split_fields1 r__split_fields5))
(assert (= r__split_fields2 r__split_fields6))
(assert (= r__split_fields3 r__split_fields7))
(assert (= (to_rep o) new_data))
(assert (= r__split_fields4 o1))
(assert (= o o2))
(assert (= r__split_fields6 o3))
(assert (= r__split_fields7 o4))
(assert (= temp___253 o1))
(assert (= temp___2531 o2))
(assert (= temp___2532 o3))
(assert (= temp___2533 o4))
...
(assert (= r__split_fields8 r__split_fields12))
(assert (= r__split_fields9 r__split_fields13))
(assert (= rliteral1 r__split_fields14))
(assert (= r__split_fields11 r__split_fields15))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields16 r__split_fields17 r__split_fields18 r__split_fields19)) (mk___rep (mk___split_fields rliteral (of_rep new_data) rliteral1 r__split_fields3))) true)))
(check-sat)
(exit)
