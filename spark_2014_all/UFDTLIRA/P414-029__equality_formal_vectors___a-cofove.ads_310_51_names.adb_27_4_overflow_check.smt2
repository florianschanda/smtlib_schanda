...
(define-fun dynamic_invariant ((temp___expr_274 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 1) 2147483647)) (in_range3 temp___expr_274)))
...
(define-fun dynamic_invariant1 ((temp___expr_280 Int) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (<= 0 2147483647)) (in_range2 temp___expr_280)))
...
(define-fun default_initial_assumption ((temp___expr_314 us_rep1) (temp___skip_top_level_315 Bool)) Bool (=> (not (= temp___skip_top_level_315 true)) (= (length1 temp___expr_314) 0)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant2 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_301 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 0 255)) (in_range6 temp___expr_301)))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant3 position true true true) (and (<= 0 position) (<= position (last container)))) (dynamic_invariant4 (get container position) true false true)) :pattern ((get container position))))))
...
(assert (=> (not (= before (- 1))) (and (= o6 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range3 o6) (= o6 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before (- 1))) (= o7 (ite (= (- before 1) o6) true false))))
(assert (=> (= before (- 1)) (= o7 false)))
...
(assert (= o8 (ite (<= 0 before) o5 false)))
(assert (= o9 (ite (= o8 false) o7 true)))
(assert (and (= o (length new_item)) (and (in_range2 o) (<= o (capacity new_item)))))
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o1) (= o1 (ite (= (of_int 0) true) (to_rep (rec__names__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
