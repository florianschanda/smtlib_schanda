...
(define-fun dynamic_invariant ((temp___expr_301 Int) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool) (temp___do_typ_inv_300 Bool)) Bool (=> (or (= temp___is_init_297 true) (<= 1 4)) (in_range2 temp___expr_301)))
...
(define-fun dynamic_invariant1 ((temp___expr_313 Int) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool (=> (or (= temp___is_init_309 true) (<= 0 4)) (in_range3 temp___expr_313)))
...
(define-fun dynamic_invariant2 ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 2147483647)) (in_range4 temp___expr_239)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 4) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
