...
(assert (= first one))
(assert (forall ((temp___305 Int)) (=> (dynamic_invariant temp___305 true true true true) (forall ((temp___306 Int) (temp___307 Int)) (= (to_rep1 (get (array_aggr__bi_dim_aggr_ok__aggregate_ko1__d__aggregate_def temp___305) temp___306 temp___307)) temp___305)))))
(assert (forall ((temp___310 Int)) (=> (dynamic_invariant temp___310 true true true true) (forall ((temp___311 Int) (temp___312 Int)) (= (to_rep1 (get (array_aggr__bi_dim_aggr_ok__aggregate_ko1__e__aggregate_def temp___310) temp___311 temp___312)) temp___310)))))
