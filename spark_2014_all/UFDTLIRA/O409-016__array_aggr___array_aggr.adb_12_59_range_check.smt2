...
(assert (forall ((temp___269 Int)) (forall ((temp___270 Int) (temp___271 Int)) (= (get (array_aggr__bi_dim_aggr_ok__aggregate_ko1__d__aggregate_def temp___269) temp___270 temp___271) (of_rep1 temp___269)))))
(declare-fun array_aggr__bi_dim_aggr_ok__aggregate_ko1__e__aggregate_def (Int) map1)
(assert (forall ((temp___274 Int)) (forall ((temp___275 Int) (temp___276 Int)) (= (get (array_aggr__bi_dim_aggr_ok__aggregate_ko1__e__aggregate_def temp___274) temp___275 temp___276) (of_rep1 temp___274)))))
...
(assert (<= one 1))
(assert (= result d))
(assert (= d1 (slide (array_aggr__bi_dim_aggr_ok__aggregate_ko1__d__aggregate_def 0) 3 1 3 1)))
(assert (<= 0 1))
(assert (not (<= first 0)))
(check-sat)
(exit)
