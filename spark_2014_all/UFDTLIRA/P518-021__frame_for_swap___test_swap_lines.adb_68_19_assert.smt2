...
(declare-const temp___297 map1)
(declare-const temp___295 Int)
(declare-const temp___292 map1)
(declare-const temp___296 map1)
...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 (- c3 1))) (and (= (to_rep (get m2 5 i7)) (to_rep (get temp___265 7 i7))) (= (to_rep (get m2 7 i7)) (to_rep (get temp___266 5 i7))))))))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 c9)) (and (= (to_rep (get m10 5 i7)) (to_rep (get temp___281 7 i7))) (= (to_rep (get m10 7 i7)) (to_rep (get temp___282 5 i7))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i7 Int)) (=> (and (<= (+ c9 1) i7) (<= i7 10)) (and (= (to_rep (get m10 5 i7)) (to_rep (get temp___283 5 i7))) (= (to_rep (get m10 7 i7)) (to_rep (get temp___284 7 i7))))))))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___297 m17)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___295 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___292 m17)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___296 m17)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i2 1))) (= (to_rep (get m18 k k)) (+ (to_rep (get temp___296 k k)) 1))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i2 1))) (forall ((h Int)) (=> (and (<= 1 h) (<= h (- i2 1))) (=> (not (= k h)) (= (to_rep (get m18 k h)) (to_rep (get temp___297 k h))))))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (forall ((temp___293 Int) (temp___294 Int)) (=> (and (and (<= 1 temp___293) (<= temp___293 10)) (and (<= 1 temp___294) (<= temp___294 10))) (=> (or (<= i2 temp___294) (<= i2 temp___293)) (= (get m18 temp___293 temp___294) (get temp___292 temp___293 temp___294))))) (=> (<= 1 10) (in_range7 i2))) (and (<= 1 i2) (<= i2 10)))))
