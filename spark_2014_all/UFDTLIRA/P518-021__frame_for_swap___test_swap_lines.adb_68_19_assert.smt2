...
(assert (= i4 1))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= temp___264 m21)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= temp___262 i4)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= temp___259 m21)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= temp___263 m21)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- i5 1))) (= (to_rep (get m22 k2 k2)) (+ (to_rep (get temp___263 k2 k2)) 1))))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- i5 1))) (forall ((h1 Int)) (=> (and (<= 1 h1) (<= h1 (- i5 1))) (=> (not (= k2 h1)) (= (to_rep (get m22 k2 h1)) (to_rep (get temp___264 k2 h1))))))))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (and (and (forall ((temp___260 Int) (temp___261 Int)) (=> (and (and (<= 1 temp___260) (<= temp___260 10)) (and (<= 1 temp___261) (<= temp___261 10))) (=> (or (<= i5 temp___261) (<= i5 temp___260)) (= (get m22 temp___260 temp___261) (get temp___259 temp___260 temp___261))))) (=> (<= 1 10) (in_range7 i5))) (and (<= 1 i5) (<= i5 10)))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (and (= o50 (+ (to_rep (get m22 i5 i5)) 1)) (in_range1 (+ (to_rep (get m22 i5 i5)) 1)))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= (to_rep o51) o50)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= o52 (set m22 i5 i5 o51))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= result14 (mk_map__ref m22))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= m23 o52)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= i5 10)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= i9 (mk_int__ref i5))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= m26 (mk_map__ref m23))))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= i10 i5)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= m27 m23)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= i11 i9)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= m28 m26)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= i12 i10)))
(assert (=> (and (<= 1 i4) (<= i4 10)) (= m29 m27)))
(assert (=> (not (and (<= 1 i4) (<= i4 10))) (= i11 (mk_int__ref i4))))
(assert (=> (not (and (<= 1 i4) (<= i4 10))) (= m28 (mk_map__ref m21))))
(assert (=> (not (and (<= 1 i4) (<= i4 10))) (= i12 i4)))
(assert (=> (not (and (<= 1 i4) (<= i4 10))) (= m29 m21)))
...
(assert (<= j 10))
(assert (= i13 j))
(assert (not (= (to_rep (get (map__content m28) i13 j)) 1)))
(check-sat)
(exit)
