...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 (- c3 1))) (and (= (to_rep (get m2 5 i7)) (to_rep (get temp___232 7 i7))) (= (to_rep (get m2 7 i7)) (to_rep (get temp___233 5 i7))))))))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 c9)) (and (= (to_rep (get m10 5 i7)) (to_rep (get temp___248 7 i7))) (= (to_rep (get m10 7 i7)) (to_rep (get temp___249 5 i7))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i7 Int)) (=> (and (<= (+ c9 1) i7) (<= i7 10)) (and (= (to_rep (get m10 5 i7)) (to_rep (get temp___250 5 i7))) (= (to_rep (get m10 7 i7)) (to_rep (get temp___251 7 i7))))))))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___264 m17)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___260 m17)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___259 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___263 m17)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i2 1))) (= (to_rep (get m18 k k)) (+ (to_rep (get temp___263 k k)) 1))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i2 1))) (forall ((h Int)) (=> (and (<= 1 h) (<= h (- i2 1))) (=> (not (= k h)) (= (to_rep (get m18 k h)) (to_rep (get temp___264 k h))))))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (=> (<= 1 10) (in_range7 i2)) (forall ((temp___261 Int) (temp___262 Int)) (=> (and (and (<= 1 temp___261) (<= temp___261 10)) (and (<= 1 temp___262) (<= temp___262 10))) (=> (or (<= i2 temp___262) (<= i2 temp___261)) (= (get m18 temp___261 temp___262) (get temp___260 temp___261 temp___262)))))) (and (<= 1 i2) (<= i2 10)))))
