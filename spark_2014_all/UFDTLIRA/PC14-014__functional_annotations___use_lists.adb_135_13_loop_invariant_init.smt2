...
(assert (not (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) fst) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 current__split_fields1))))))
(check-sat)
(exit)
