...
(assert (not (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 current__split_fields2)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) lst))))
(check-sat)
(exit)
