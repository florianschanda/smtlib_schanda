...
(assert (not (= (bool_eq3 (find (mk___rep l3__split_discrs l3__split_fields2) 1 (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2)))) no_element) true)))
(check-sat)
(exit)
