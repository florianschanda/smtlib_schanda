...
(define-fun dynamic_invariant1 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_195)))
...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__formal_list__vec__vector__capacity capacity_range)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) capacity_range (rec__formal_list__vec__vector__capacity a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__formal_list__vec__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type (rec__formal_list__vec__vector a))
...
(declare-const formal_list__vec__vector__capacity__first__bit Int)
(declare-const formal_list__vec__vector__capacity__last__bit Int)
(declare-const formal_list__vec__vector__capacity__position Int)
(assert (<= 0 formal_list__vec__vector__capacity__first__bit))
(assert (< formal_list__vec__vector__capacity__first__bit formal_list__vec__vector__capacity__last__bit))
(assert (<= 0 formal_list__vec__vector__capacity__position))
...
(define-fun default_initial_assumption ((temp___expr_241 us_rep1) (temp___skip_top_level_242 Bool)) Bool (=> (not (= temp___skip_top_level_242 true)) (= (length temp___expr_241) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 0 101)) (in_range5 temp___expr_201)))
...
(define-fun dynamic_invariant4 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 100)) (in_range3 temp___expr_207)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__formal_list__vec__vector__capacity (us_split_discrs1 container1))) 100))
...
(define-fun dynamic_invariant5 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 100)) (in_range4 temp___expr_234)))
...
(define-fun dynamic_invariant6 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_228)))
