...
(assert (and (= temp___776 (keys (mk___rep s1__split_discrs s1__split_fields2))) (and (and (and (= (length3 temp___776) (length (mk___rep s1__split_discrs s1__split_fields2))) (forall ((temp___396 Int)) (=> (and (in_range5 temp___396) (= (iter_has_element temp___776 temp___396) true)) (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields2)) (get1 temp___776 temp___396)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields2)) key2) true)) (and (< 0 (find temp___776 key2)) (= (equivalent_keys (get1 temp___776 (find temp___776 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs s1__split_fields2)))) (and (= (find temp___776 (get1 temp___776 i)) i) (= (k_is_find temp___776 (get1 temp___776 i) i) true)))))))
(assert (and (= o (iter_has_element temp___776 temp___775)) (= (= o true) (and (<= 1 temp___775) (<= temp___775 (last temp___776))))))
(assert (= (= o1 true) (in_range5 temp___775)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= k (get1 temp___776 temp___775)) (in_range6 k)))
