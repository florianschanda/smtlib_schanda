...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__names__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant2 ((temp___expr_280 Int) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (<= 0 2147483647)) (in_range2 temp___expr_280)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o) (= o (ite (= (of_int 0) true) (to_rep (rec__names__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
