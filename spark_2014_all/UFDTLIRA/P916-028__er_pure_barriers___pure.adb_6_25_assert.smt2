...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (and (= (to_rep (rec__pure__pt__n (us_split_fields1 temp___expr_172))) 0) (= (rec__pure__pt__b (us_split_fields1 temp___expr_172)) (of_int 0))))
