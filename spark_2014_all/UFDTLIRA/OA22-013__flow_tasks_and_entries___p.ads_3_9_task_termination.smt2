...
(define-fun default_initial_assumption ((temp___expr_208 us_rep) (temp___skip_top_level_209 Bool)) Bool (= (rec__p__poT__x (us_split_fields1 temp___expr_208)) (distinct 0 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_186 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 0 97)) (in_range2 temp___expr_186)))
(assert (not true))
(check-sat)
(exit)
