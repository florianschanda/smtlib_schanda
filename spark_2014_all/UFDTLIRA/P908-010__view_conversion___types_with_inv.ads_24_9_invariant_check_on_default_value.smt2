...
(define-fun default_initial_assumption ((temp___expr_156 us_rep) (temp___skip_top_level_157 Bool)) Bool (= (to_rep (rec__types_with_inv__r1__f (us_split_fields1 temp___expr_156))) 1))
...
(assert (not (not (= (to_rep temp___160) 0))))
(check-sat)
(exit)
