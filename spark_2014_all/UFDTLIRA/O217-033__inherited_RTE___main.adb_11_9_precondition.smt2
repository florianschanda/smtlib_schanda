...
(declare-fun incr__specific_post (Int us_split_fields Int us_split_fields) Bool)
(assert true)
(assert true)
(declare-fun incr2__specific_post (Int us_split_fields Int us_split_fields) Bool)
(assert true)
(assert true)
...
(declare-fun incr__2__specific_post (Int us_split_fields2 Int us_split_fields2) Bool)
(assert true)
(declare-fun incr2__2__specific_post (Int us_split_fields2 Int us_split_fields2) Bool)
(assert true)
(declare-const dummy3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const c1__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const c2__attr__tag Int)
...
(assert (forall ((o us_rep1)) (! (= (= (less_than_max__2 o) true) (or (< (to_rep (rec__dispatch_in_contract__root__f11 (us_split_fields3 o))) 2147483647) (< (to_rep (rec__dispatch_in_contract__child__f2 (us_split_fields3 o))) 2147483647))) :pattern ((less_than_max__2 o)))))
(declare-const c1__split_fields integer)
(declare-const c1__split_fields1 us_private)
(declare-const c2__split_fields integer)
(declare-const c2__split_fields1 integer)
(declare-const c2__split_fields2 us_private)
(declare-const o integer)
(declare-const o1 integer)
(declare-const o2 us_private)
(declare-const main__c1__assume integer)
(declare-const main__c1__assume1 us_private)
(declare-const main__c1__assume2 Int)
(declare-const o3 integer)
(declare-const o4 integer)
(declare-const o5 integer)
(declare-const o6 integer)
(declare-const o7 us_private)
(declare-const main__c2__assume integer)
(declare-const main__c2__assume1 integer)
(declare-const main__c2__assume2 us_private)
(declare-const main__c2__assume3 Int)
(declare-const result integer)
(declare-const result1 us_private)
(declare-const c1__split_fields2 integer)
(declare-const c1__split_fields3 us_private)
(declare-const result2 integer)
(declare-const result3 integer)
(declare-const result4 us_private)
(declare-const c2__split_fields3 integer)
(declare-const c2__split_fields4 integer)
(declare-const c2__split_fields5 us_private)
(assert (in_range dummy3))
(assert (= (to_rep o) 2147483647))
(assert (= o o1))
(assert (= us_null_ext__ o2))
(assert (= main__c1__assume o1))
(assert (= main__c1__assume1 o2))
(assert (= us_tag main__c1__assume2))
(assert (= result c1__split_fields))
(assert (= result1 c1__split_fields1))
(assert (= main__c1__assume c1__split_fields2))
(assert (= main__c1__assume1 c1__split_fields3))
(assert (= c1__attr__tag us_tag))
(assert (= (to_rep o3) 2147483647))
(assert (= (to_rep o4) 1))
(assert (= o4 o5))
(assert (= o3 o6))
(assert (= us_null_ext__ o7))
(assert (= main__c2__assume o5))
(assert (= main__c2__assume1 o6))
(assert (= main__c2__assume2 o7))
(assert (= us_tag1 main__c2__assume3))
(assert (= result2 c2__split_fields))
(assert (= result3 c2__split_fields1))
(assert (= result4 c2__split_fields2))
...
(assert (not (= dummy3 1)))
(assert (= dummy3 2))
(assert (not (= (less_than_max__2 (mk___rep1 (mk___split_fields1 c2__split_fields3 c2__split_fields4 c2__split_fields5) c2__attr__tag)) true)))
(check-sat)
(exit)
