...
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant2 result true false true true))) :pattern ((length container1)))))
...
(assert (forall ((container1 us_rep)) (! (= (length1 (model__ container1)) (length container1)) :pattern ((model__ container1)))))
...
(define-fun default_initial_assumption2 ((temp___expr_245 us_rep2) (temp___skip_top_level_246 Bool)) Bool (=> (not (= temp___skip_top_level_246 true)) (and (= (is_empty temp___expr_245) true) (= (length2 temp___expr_245) 0))))
(define-fun default_initial_assumption3 ((temp___expr_231 us_rep1) (temp___skip_top_level_232 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_231))) 0))
(assert (forall ((container1 us_rep)) (! (let ((result (positions container1))) (and (not (= (has_key result no_element) true)) (forall ((i us_rep1)) (=> (= (has_key result i) true) (and (and (<= 1 (get1 result i)) (<= (get1 result i) (length container1))) (forall ((j us_rep1)) (=> (= (has_key result j) true) (=> (= (get1 result i) (get1 result j)) (= (bool_eq1 i j) true))))))))) :pattern ((positions container1)))))
...
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (get1 container1 key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container1 (witness container1 key))) (forall ((k us_rep1)) (=> (= (has_key container1 k) true) (= (= (bool_eq1 k key) true) (= (witness container1 key) (witness container1 k))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get1 container1 key))))))
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant2 (length2 container1) true false true true) :pattern ((length2 container1)))))
...
(assert (forall ((container1 us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant5 (w_get container1 witness1) true false true true)) :pattern ((w_get container1 witness1))))))
