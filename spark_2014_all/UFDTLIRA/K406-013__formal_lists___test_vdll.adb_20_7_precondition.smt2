...
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant2 result true false true))) :pattern ((length container1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_191 us_rep3) (temp___skip_top_level_192 Bool)) Bool (=> (not (= temp___skip_top_level_192 true)) (= (length1 temp___expr_191) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_210 us_rep2) (temp___skip_top_level_211 Bool)) Bool (=> (not (= temp___skip_top_level_211 true)) (and (= (is_empty temp___expr_210) true) (= (length2 temp___expr_210) 0))))
(define-fun default_initial_assumption3 ((temp___expr_198 us_rep1) (temp___skip_top_level_199 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_198))) 0))
...
(define-fun dynamic_invariant3 ((temp___expr_184 Int) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (or (= temp___is_init_181 true) (<= 0 2147483647)) (in_range4 temp___expr_184)))
(assert (forall ((container1 us_rep3)) (! (let ((result (length1 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant4 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_178)))
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant3 position1 true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant4 (get container1 position1) true false true)) :pattern ((get container1 position1))))))
...
(define-fun dynamic_invariant5 ((temp___expr_203 Int) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool)) Bool (=> (or (= temp___is_init_200 true) (<= 1 2147483647)) (in_range6 temp___expr_203)))
...
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (get1 container1 key))) (and (=> (= (of_int 0) true) (and (= result (w_get container1 (witness container1 key))) (forall ((k us_rep1)) (=> (= (has_key container1 k) true) (= (= (bool_eq1 k key) true) (= (witness container1 key) (witness container1 k))))))) (dynamic_invariant5 result true false true)))) :pattern ((get1 container1 key))))))
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant2 (length2 container1) true false true) :pattern ((length2 container1)))))
