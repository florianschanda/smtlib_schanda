...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__formal_container__vdll__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields)) count_type (rec__formal_container__vdll__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields1 a))) (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__formal_container__vdll__list us_main_type1)))))
(define-fun us_split_fields_List__projection ((a us_split_fields2)) us_main_type1 (rec__formal_container__vdll__list a))
...
(define-fun default_initial_assumption ((temp___expr_186 us_rep) (temp___skip_top_level_187 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields1 temp___expr_186))) 0))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant2 result true false true true))) :pattern ((length container1)))))
...
(define-fun last ((container1 us_rep3)) Int (+ 0 (length1 container1)))
...
(define-fun default_initial_assumption1 ((temp___expr_223 us_rep3) (temp___skip_top_level_224 Bool)) Bool (=> (not (= temp___skip_top_level_224 true)) (= (length1 temp___expr_223) 0)))
(assert (forall ((container1 us_rep2)) (! (= (length1 (model__ container1)) (length container1)) :pattern ((model__ container1)))))
...
(define-fun default_initial_assumption2 ((temp___expr_245 us_rep1) (temp___skip_top_level_246 Bool)) Bool (=> (not (= temp___skip_top_level_246 true)) (and (= (is_empty temp___expr_245) true) (= (length2 temp___expr_245) 0))))
(define-fun default_initial_assumption3 ((temp___expr_231 us_rep) (temp___skip_top_level_232 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields1 temp___expr_231))) 0))
(assert (forall ((container1 us_rep2)) (! (let ((result (positions container1))) (and (not (= (has_key result no_element) true)) (forall ((i us_rep)) (=> (= (has_key result i) true) (and (and (<= 1 (get1 result i)) (<= (get1 result i) (length container1))) (forall ((j us_rep)) (=> (= (has_key result j) true) (=> (= (get1 result i) (get1 result j)) (= (bool_eq i j) true))))))))) :pattern ((positions container1)))))
...
(define-fun dynamic_invariant3 ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 2147483647)) (in_range4 temp___expr_215)))
(assert (forall ((container1 us_rep3)) (! (let ((result (length1 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant4 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_208)))
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant3 position1 true true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant4 (get container1 position1) true false true true)) :pattern ((get container1 position1))))))
...
(define-fun dynamic_invariant5 ((temp___expr_237 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool) (temp___do_typ_inv_236 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 1 2147483647)) (in_range6 temp___expr_237)))
(assert (forall ((container1 us_rep1)) (forall ((key us_rep)) (! (=> (= (has_key container1 key) true) (let ((result (get1 container1 key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container1 (witness container1 key))) (forall ((k us_rep)) (=> (= (has_key container1 k) true) (= (= (bool_eq k key) true) (= (witness container1 key) (witness container1 k))))))) (dynamic_invariant5 result true false true true)))) :pattern ((get1 container1 key))))))
(assert (forall ((container1 us_rep1)) (! (dynamic_invariant2 (length2 container1) true false true true) :pattern ((length2 container1)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (forall ((key us_rep)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant5 (w_get container1 witness1) true false true true)) :pattern ((w_get container1 witness1))))))
