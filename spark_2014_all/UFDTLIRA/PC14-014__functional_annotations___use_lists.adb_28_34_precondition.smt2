...
(assert (and (= o1 (length (mk___rep l2__split_discrs l2__split_fields2))) (and (in_range1 o1) (<= o1 (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range7 o2)))
(assert (and (= o (positions l1)) (and (not (= (has_key o no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length l1))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq2 i j) true))))))))))
