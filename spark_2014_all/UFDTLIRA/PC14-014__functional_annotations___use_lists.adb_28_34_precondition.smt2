...
(assert (and (= o7 (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1)))) (and (in_range2 o7) (<= o7 (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (and (= o6 (positions l1)) (and (not (= (has_key o6 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o6 i) true) (and (and (<= 1 (get1 o6 i)) (<= (get1 o6 i) (length l1))) (forall ((j us_rep1)) (=> (= (has_key o6 j) true) (=> (= (get1 o6 i) (get1 o6 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key o6 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
