...
(declare-fun user_eq (tname_idB tname_idB) Bool)
(declare-const dummy tname_idB)
(declare-datatypes () ((tname_idB__ref (mk_tname_idB__ref (tname_idB__content tname_idB)))))
(define-fun tname_idB__ref___projection ((a tname_idB__ref)) tname_idB (tname_idB__content a))
...
(define-fun dynamic_invariant ((temp___expr_458 Int) (temp___is_init_455 Bool) (temp___skip_constant_456 Bool) (temp___do_toplevel_457 Bool)) Bool (=> (or (= temp___is_init_455 true) (<= 1 2147483647)) (in_range1 temp___expr_458)))
...
(assert (forall ((x name_id)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun to_rep2 (char_table_index) Int)
(declare-fun of_rep2 (Int) char_table_index)
(assert (forall ((x char_table_index)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x char_table_index)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__names__name_entry__table_index char_table_index) (rec__names__name_entry__length positive) (rec__names__name_entry__next_hash name_id)))))
(define-fun us_split_fields_Table_Index__projection ((a us_split_fields)) char_table_index (rec__names__name_entry__table_index a))
(define-fun us_split_fields_Length__projection ((a us_split_fields)) positive (rec__names__name_entry__length a))
(define-fun us_split_fields_Next_Hash__projection ((a us_split_fields)) name_id (rec__names__name_entry__next_hash a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep2 (rec__names__name_entry__table_index (us_split_fields1 a))) (to_rep2 (rec__names__name_entry__table_index (us_split_fields1 b)))) (= (to_rep (rec__names__name_entry__length (us_split_fields1 a))) (to_rep (rec__names__name_entry__length (us_split_fields1 b))))) (= (to_rep1 (rec__names__name_entry__next_hash (us_split_fields1 a))) (to_rep1 (rec__names__name_entry__next_hash (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_480 us_rep) (temp___skip_top_level_481 Bool)) Bool (=> (not (= temp___skip_top_level_481 true)) (= (length temp___expr_480) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range6 temp___expr_142)))
...
(define-fun dynamic_invariant2 ((temp___expr_473 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 0 2147483647)) (in_range7 temp___expr_473)))
...
(define-fun dynamic_invariant4 ((temp___expr_256 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 2147483646)) (in_range5 temp___expr_256)))
(define-fun dynamic_invariant5 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range4 temp___expr_180)))
(assert true)
(declare-const o Int)
...
(assert (and (= o2 (length container)) (and (in_range6 o2) (<= (+ 0 o2) 2147483647))))
(assert (= result (ite (< o2 2147483647) true false)))
(assert (= result true))
(assert (and (= o1 (last container)) (and (in_range7 o1) (= o1 (+ 0 (length container))))))
(assert (= result1 (ite (< o1 2147483647) true false)))
(assert (= result1 true))
(assert (and (= o (last container)) (and (in_range7 o) (= o (+ 0 (length container))))))
