...
(define-fun dynamic_invariant ((temp___expr_515 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool) (temp___do_typ_inv_514 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 2147483647)) (in_range1 temp___expr_515)))
...
(define-fun dynamic_invariant2 ((temp___expr_532 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool) (temp___do_typ_inv_531 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= 0 2147483647)) (in_range7 temp___expr_532)))
...
(define-fun dynamic_invariant4 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range5 temp___expr_296)))
(define-fun dynamic_invariant5 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range4 temp___expr_210)))
(assert true)
(declare-const o Int)
