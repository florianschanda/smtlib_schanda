...
(define-fun default_initial_assumption ((temp___expr_218 us_rep) (temp___skip_top_level_219 Bool)) Bool (and (= (attr__constrained temp___expr_218) false) (and (and (= (to_rep1 (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_218))) 1) (= (to_rep (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_218))) 0)) (=> (storage_place_attributes__r2__d2__pred temp___expr_218) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_218)) (distinct 0 0))))))
