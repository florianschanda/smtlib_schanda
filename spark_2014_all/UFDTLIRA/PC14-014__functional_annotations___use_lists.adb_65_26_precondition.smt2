...
(assert (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) true))
(assert (and (= o (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= n o2) true false)))
(assert (= result2 (ite (<= 1 n) o3 false)))
(assert (= result2 true))
(assert (and (= o5 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o5) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (and (= o6 (get o5 n)) (in_range4 o6)))
(assert (not (<= 1 n)))
(check-sat)
(exit)
