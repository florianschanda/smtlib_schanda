...
(assert (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2))) true))
...
(assert (= result2 (ite (<= 1 n) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o4) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (and (= o5 (get o4 n)) (in_range4 o5)))
(assert (not (<= 1 n)))
(check-sat)
(exit)
