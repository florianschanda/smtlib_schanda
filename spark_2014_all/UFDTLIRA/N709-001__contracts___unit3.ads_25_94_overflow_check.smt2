...
(assert (and (= o2 (+ (to_rep x__split_fields1) 1)) (in_range (+ (to_rep x__split_fields1) 1))))
(assert (= result (ite (= (to_rep x__split_fields7) o2) true false)))
(assert (= result true))
(assert (and (= o1 (+ (to_rep x__split_fields2) 1)) (in_range (+ (to_rep x__split_fields2) 1))))
(assert (= result1 (ite (= (to_rep x__split_fields8) o1) true false)))
(assert (= result1 true))
(assert (not (in_range (+ (to_rep x__split_fields) 1))))
(check-sat)
(exit)
