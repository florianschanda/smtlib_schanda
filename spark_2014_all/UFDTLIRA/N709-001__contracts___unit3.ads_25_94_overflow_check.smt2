...
(assert (and (= o1 (+ (to_rep x__split_fields1) 1)) (in_range (+ (to_rep x__split_fields1) 1))))
(assert (= result (ite (= (to_rep x__split_fields3) o1) true false)))
(assert (= result true))
(assert (and (= o (+ (to_rep x__split_fields2) 1)) (in_range (+ (to_rep x__split_fields2) 1))))
(assert (= result1 (ite (= (to_rep x__split_fields4) o) true false)))
(assert (= result1 true))
