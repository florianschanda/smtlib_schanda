...
(define-fun dynamic_invariant1 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 255)) (in_range3 temp___expr_263)))
...
(define-fun dynamic_invariant2 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (or (= temp___is_init_266 true) (<= (- 1) 2147483647)) (in_range4 temp___expr_270)))
...
(define-fun dynamic_invariant3 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 2147483647)) (in_range5 temp___expr_277)))
...
(define-fun oeq ((left us_rep1) (right us_rep1)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
(declare-fun oeq__function_guard (Bool us_rep1 us_rep1) Bool)
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq6 a b) (oeq a b)) :pattern ((user_eq6 a b)))))
(define-fun default_initial_assumption ((temp___expr_316 us_rep1) (temp___skip_top_level_317 Bool)) Bool (=> (not (= temp___skip_top_level_317 true)) (= (length1 temp___expr_316) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_308 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= (- 1) 2147483646)) (in_range6 temp___expr_308)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_301 Int) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool) (temp___do_typ_inv_300 Bool)) Bool (=> (or (= temp___is_init_297 true) (<= 0 255)) (in_range7 temp___expr_301)))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant4 position true true true true) (and (<= 0 position) (<= position (last container)))) (dynamic_invariant5 (get container position) true false true true)) :pattern ((get container position))))))
...
(assert (in_range4 before))
(assert (in_range3 new_item))
(assert (in_range2 count))
(assert (=> (not (= before (- 1))) (and (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range4 o4) (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before (- 1))) (= o5 (ite (= (- before 1) o4) true false))))
(assert (=> (not (not (= before (- 1)))) (= o5 false)))
(assert (and (= o2 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range4 o2) (= o2 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o3 (ite (<= before o2) true false)))
(assert (= o6 (ite (<= 0 before) o3 false)))
(assert (= o7 (ite (= o6 false) o5 true)))
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o) (= o (ite (= (distinct 0 0) true) (to_rep (rec__names__data__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
