...
(assert (=> (not (= before (- 1))) (and (= o5 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range4 o5) (= o5 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before (- 1))) (= o6 (ite (= (- before 1) o5) true false))))
(assert (=> (= before (- 1)) (= o6 false)))
(assert (and (= o3 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range4 o3) (= o3 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o4 (ite (<= before o3) true false)))
(assert (= o7 (ite (<= 0 before) o4 false)))
