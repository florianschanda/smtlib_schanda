...
(define-fun us_split_discrs___projection ((a us_split_discrs)) integer (rec__r__pt__x a))
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) integer (rec__r__pt__y a))
(define-fun us_split_discrs___3__projection ((a us_split_discrs)) integer (rec__r__pt__z a))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__r__pt1 us_main_type)))))
(define-fun us_split_fields_PT__2__projection ((a us_split_fields2)) us_main_type (rec__r__pt1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (rec__r__pt1 (us_split_fields3 a)))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (rec__r__pt (us_split_fields1 r)))))
(declare-fun to_rep (integer) Int)
(declare-fun of_rep (Int) integer)
(assert (forall ((x integer)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x integer)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Int)) (! (=> (in_range x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
(define-fun in_range1 ((rec__r__pt__x1 Int) (rec__r__pt__y1 Int) (rec__r__pt__z1 Int) (a us_rep)) Bool (and (and (= rec__r__pt__x1 (to_rep (rec__r__pt__x (us_split_discrs1 a)))) (= rec__r__pt__y1 (to_rep (rec__r__pt__y (us_split_discrs1 a))))) (= rec__r__pt__z1 (to_rep (rec__r__pt__z (us_split_discrs1 a))))))
...
(define-fun default_initial_assumption ((temp___expr_1545 us_rep1) (temp___skip_top_level_1546 Bool)) Bool (and (and (= (to_rep (rec__r__pt__x (us_split_discrs2 temp___expr_1545))) 1) (= (to_rep (rec__r__pt__y (us_split_discrs2 temp___expr_1545))) 2)) (= (to_rep (rec__r__pt__z (us_split_discrs2 temp___expr_1545))) 3)))
