...
(define-fun default_initial_assumption ((temp___expr_1535 us_rep1) (temp___skip_top_level_1536 Bool)) Bool (and (and (= (to_rep (rec__r__pt__x (us_split_discrs2 temp___expr_1535))) 1) (= (to_rep (rec__r__pt__y (us_split_discrs2 temp___expr_1535))) 2)) (= (to_rep (rec__r__pt__z (us_split_discrs2 temp___expr_1535))) 3)))
