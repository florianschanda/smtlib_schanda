...
(define-fun dynamic_invariant1 ((temp___expr_221 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= first last)) (dynamic_property first last temp___expr_221)))
(assert (= first c))
(assert (= last c))
(declare-const a Int)
