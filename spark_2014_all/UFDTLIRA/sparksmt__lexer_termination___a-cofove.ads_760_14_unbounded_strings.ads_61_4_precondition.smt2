...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__unbounded_strings__char_vectors__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type1 (rec__unbounded_strings__char_vectors__vector a))
...
(define-fun dynamic_invariant ((temp___expr_260 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool) (temp___do_typ_inv_259 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 2147483647)) (in_range2 temp___expr_260)))
...
(define-fun dynamic_invariant1 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range3 temp___expr_246)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs1 container1))) 2147483647))
