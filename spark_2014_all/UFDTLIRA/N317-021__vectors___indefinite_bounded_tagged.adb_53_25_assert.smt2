...
(assert (not (= (let ((temp___579 (f 2))) (let ((temp___578 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 5))) (ite (= (attr__tag temp___578) (attr__tag temp___579)) (us_dispatch_eq temp___578 temp___579) false))) true)))
(check-sat)
(exit)
