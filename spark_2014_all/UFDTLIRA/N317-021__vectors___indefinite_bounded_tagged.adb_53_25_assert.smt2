...
(assert (not (= (let ((temp___622 (f 2))) (let ((temp___621 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 5))) (ite (= (attr__tag temp___621) (attr__tag temp___622)) (us_dispatch_eq temp___621 temp___622) false))) true)))
(check-sat)
(exit)
