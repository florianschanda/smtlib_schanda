...
(define-fun dynamic_invariant4 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483646)) (in_range7 temp___expr_249)))
(define-fun dynamic_invariant5 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 2147483647)) (in_range6 temp___expr_173)))
...
(define-fun dynamic_invariant6 ((temp___expr_475 Int) (temp___is_init_471 Bool) (temp___skip_constant_472 Bool) (temp___do_toplevel_473 Bool) (temp___do_typ_inv_474 Bool)) Bool (=> (or (= temp___is_init_471 true) (<= 0 2147483647)) (in_range8 temp___expr_475)))
...
(assert (=> (not (= before 0)) (and (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range3 o4) (= o4 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before 0)) (= o5 (ite (= (- before 1) o4) true false))))
(assert (=> (not (not (= before 0))) (= o5 false)))
(assert (and (= o2 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range3 o2) (= o2 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o3 (ite (<= before o2) true false)))
(assert (= o6 (ite (<= 1 before) o3 false)))
(assert (= o7 (ite (= o6 false) o5 true)))
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range4 o) (= o (ite (= (distinct 0 0) true) (to_rep (rec__names__data__entry_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
