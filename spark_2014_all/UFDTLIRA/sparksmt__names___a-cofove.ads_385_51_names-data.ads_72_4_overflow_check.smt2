...
(define-fun dynamic_invariant4 ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 2147483646)) (in_range7 temp___expr_214)))
(define-fun dynamic_invariant5 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 2147483647)) (in_range6 temp___expr_148)))
...
(define-fun dynamic_invariant6 ((temp___expr_422 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 0 2147483647)) (in_range8 temp___expr_422)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range4 o) (= o (ite (= (of_int 0) true) (to_rep (rec__names__data__entry_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
