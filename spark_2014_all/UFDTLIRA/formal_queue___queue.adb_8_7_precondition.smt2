...
(assert (< 0 (length q)))
(assert (and (= (mk___rep (mk___split_discrs queue__tail__r__assume) (mk___split_fields queue__tail__r__assume1)) (copy q 0)) (and (and (= (oeq (model__ (mk___rep (mk___split_discrs queue__tail__r__assume) (mk___split_fields queue__tail__r__assume1))) (model__ q)) true) (= (oeq1 (positions (mk___rep (mk___split_discrs queue__tail__r__assume) (mk___split_fields queue__tail__r__assume1))) (positions q)) true)) (= (to_rep queue__tail__r__assume) (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))))
