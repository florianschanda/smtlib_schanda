...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(declare-const temp___413 count_type)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___413 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___413)) no_element))
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__formal_container__vdll__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__formal_container__vdll__list__capacity target__split_discrs)) o2)))
