...
(define-fun dynamic_invariant ((temp___expr_553 Int) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (<= 1 2147483647)) (in_range2 temp___expr_553)))
...
(define-fun dynamic_invariant1 ((temp___expr_567 Int) (temp___is_init_564 Bool) (temp___skip_constant_565 Bool) (temp___do_toplevel_566 Bool)) Bool (=> (or (= temp___is_init_564 true) (<= 0 2147483647)) (in_range3 temp___expr_567)))
...
(define-fun default_initial_assumption ((temp___expr_574 us_rep) (temp___skip_top_level_575 Bool)) Bool (=> (not (= temp___skip_top_level_575 true)) (= (length temp___expr_574) 0)))
