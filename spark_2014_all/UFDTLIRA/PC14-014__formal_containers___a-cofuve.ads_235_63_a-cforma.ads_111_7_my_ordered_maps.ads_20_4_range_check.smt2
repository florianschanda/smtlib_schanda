...
(define-fun dynamic_invariant ((temp___expr_607 Int) (temp___is_init_603 Bool) (temp___skip_constant_604 Bool) (temp___do_toplevel_605 Bool) (temp___do_typ_inv_606 Bool)) Bool (=> (or (= temp___is_init_603 true) (<= 1 2147483647)) (in_range2 temp___expr_607)))
...
(define-fun dynamic_invariant1 ((temp___expr_623 Int) (temp___is_init_619 Bool) (temp___skip_constant_620 Bool) (temp___do_toplevel_621 Bool) (temp___do_typ_inv_622 Bool)) Bool (=> (or (= temp___is_init_619 true) (<= 0 2147483647)) (in_range3 temp___expr_623)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__my_ordered_maps__my_rec__f (us_split_fields1 a))) (to_rep (rec__my_ordered_maps__my_rec__f (us_split_fields1 b)))) (= (to_rep (rec__my_ordered_maps__my_rec__g (us_split_fields1 a))) (to_rep (rec__my_ordered_maps__my_rec__g (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_631 us_rep) (temp___skip_top_level_632 Bool)) Bool (=> (not (= temp___skip_top_level_632 true)) (= (length temp___expr_631) 0)))
...
(assert (and (= o (length right)) (and (in_range5 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (+ 0 o)))
