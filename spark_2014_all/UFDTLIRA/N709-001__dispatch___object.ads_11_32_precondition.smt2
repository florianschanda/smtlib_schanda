...
(assert (and (= result (has_stored_area (mk___rep (mk___split_fields obj__split_fields obj__split_fields1 obj__split_fields2 obj__split_fields3) obj__attr__tag))) (= (= result true) (in_range (to_rep obj__split_fields)))))
(assert (= result true))
(assert (not (= (has_stored_area (mk___rep (mk___split_fields obj__split_fields obj__split_fields1 obj__split_fields2 obj__split_fields3) obj__attr__tag)) true)))
(check-sat)
(exit)
