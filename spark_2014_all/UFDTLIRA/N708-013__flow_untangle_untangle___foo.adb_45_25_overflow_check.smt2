...
(assert (<= 1 i1))
(assert (<= i1 3))
(assert (and (= o5 (+ (to_rep tmp__split_fields4) 1)) (in_range1 (+ (to_rep tmp__split_fields4) 1))))
(assert (= (to_rep o6) o5))
(assert (= tmp__split_fields3 o7))
(assert (= o6 o8))
(assert (= tmp__split_fields5 o9))
(assert (= temp___227 o7))
(assert (= temp___2271 o8))
(assert (= temp___2272 o9))
(assert (= result4 tmp__split_fields3))
(assert (= result5 tmp__split_fields4))
(assert (= result6 tmp__split_fields5))
(assert (= tmp__split_fields6 temp___227))
(assert (= tmp__split_fields7 temp___2271))
(assert (= tmp__split_fields8 temp___2272))
(assert (and (and (and (= tmp__split_fields9 tmp__split_fields3) (= tmp__split_fields11 tmp__split_fields5)) (=> (<= 1 3) (in_range2 i2))) (and (<= 1 i2) (<= i2 3))))
(assert (not (= i2 3)))
(assert (= i2 result7))
(assert (= i3 (+ i2 1)))
(assert (not (in_range1 (+ (to_rep tmp__split_fields10) 1))))
(check-sat)
(exit)
