...
(define-fun dynamic_invariant ((temp___expr_216 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 1 2147483647)) (in_range2 temp___expr_216)))
...
(define-fun dynamic_invariant1 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 0 2147483647)) (in_range3 temp___expr_228)))
...
(define-fun dynamic_invariant3 ((temp___expr_222 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_222)))
