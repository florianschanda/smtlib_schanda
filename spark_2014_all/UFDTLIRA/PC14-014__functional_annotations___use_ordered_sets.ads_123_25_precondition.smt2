...
(assert (and (= o1 (length s)) (and (in_range1 o1) (<= o1 (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 s)))))))
(assert (= o2 (ite (<= i o1) true false)))
(assert (= result (ite (<= 1 i) o2 false)))
(assert (= result true))
(assert (and (= o3 (elements s)) (and (and (and (= (length2 o3) (length s)) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o3 temp___390) true)) (= (contains (model__ s) (get o3 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s) item) true)) (and (< 0 (find o3 item)) (= (equivalent_elements (get o3 (find o3 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o3 (get o3 i1)) i1) (= (e_is_find o3 (get o3 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
