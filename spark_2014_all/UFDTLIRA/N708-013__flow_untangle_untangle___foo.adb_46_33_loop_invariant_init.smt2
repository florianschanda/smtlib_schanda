...
(declare-const temp___197 integer)
(declare-const temp___1971 integer)
...
(declare-const tmp__split_fields6 integer)
(declare-const tmp__split_fields7 integer)
(declare-const tmp__split_fields8 integer)
(declare-const tmp__split_fields9 integer)
(declare-const tmp__split_fields10 integer)
(declare-const tmp__split_fields11 integer)
...
(assert (<= 1 i1))
(assert (<= i1 3))
(assert (and (= o6 (+ (to_rep tmp__split_fields4) 1)) (in_range1 (+ (to_rep tmp__split_fields4) 1))))
(assert (= (to_rep o7) o6))
(assert (= tmp__split_fields3 o8))
(assert (= o7 o9))
(assert (= tmp__split_fields5 o10))
(assert (= temp___197 o8))
(assert (= temp___1971 o9))
(assert (= temp___1972 o10))
(assert (= result4 tmp__split_fields3))
(assert (= result5 tmp__split_fields4))
(assert (= result6 tmp__split_fields5))
(assert (= tmp__split_fields6 temp___197))
(assert (= tmp__split_fields7 temp___1971))
(assert (= tmp__split_fields8 temp___1972))
(assert (not true))
(check-sat)
(exit)
