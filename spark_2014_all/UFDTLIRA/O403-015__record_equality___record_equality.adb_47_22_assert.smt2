...
(assert (= c_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ko_d3__g_pu1__assume)))
...
(assert (= record_equality__test_eq_ko_d3__g_pu1__assume1 g_pu1__split_fields4))
(assert (= record_equality__test_eq_ko_d3__g_pu1__assume2 g_pu1__split_fields5))
(assert (= record_equality__test_eq_ko_d3__g_pu1__assume3 g_pu1__split_fields6))
(assert (= record_equality__test_eq_ko_d3__g_pu1__assume4 g_pu1__split_fields7))
(assert (= g_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ko_d3__g_pu1__assume)))
...
(assert (= c_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ko_d3__g_pu2__assume)))
...
(assert (= g_pu2__split_fields4 (mk___split_fields2 record_equality__test_eq_ko_d3__g_pu2__assume1 record_equality__test_eq_ko_d3__g_pu2__assume2 record_equality__test_eq_ko_d3__g_pu2__assume3 record_equality__test_eq_ko_d3__g_pu2__assume4)))
(assert (= g_pu2__split_discrs (mk___split_discrs record_equality__test_eq_ko_d3__g_pu2__assume)))
(assert (= g_pu2__attr__tag us_tag2))
(assert (= result5 (mk___split_fields__ref (mk___split_fields r_g1__split_fields r_g1__split_fields1))))
(assert (= r_g1__split_fields2 (mk___split_fields g_pu1__split_fields5 (hide_ext__1 g_pu1__split_fields4 g_pu1__split_fields6 g_pu1__split_fields7))))
(assert (= r_g1__split_discrs g_pu1__split_discrs))
(assert (= r_g1__attr__tag g_pu1__attr__tag))
(assert (= result6 (mk___split_fields__ref (mk___split_fields r_g2__split_fields r_g2__split_fields1))))
(assert (= r_g2__split_fields2 (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4)))))
(assert (= r_g2__split_discrs g_pu2__split_discrs))
(assert (= r_g2__attr__tag g_pu2__attr__tag))
(assert (not (= (ite (= r_g1__attr__tag r_g2__attr__tag) (us_dispatch_eq (mk___rep r_g1__split_discrs r_g1__split_fields2 r_g1__attr__tag) (mk___rep r_g2__split_discrs r_g2__split_fields2 r_g2__attr__tag)) false) true)))
(check-sat)
(exit)
