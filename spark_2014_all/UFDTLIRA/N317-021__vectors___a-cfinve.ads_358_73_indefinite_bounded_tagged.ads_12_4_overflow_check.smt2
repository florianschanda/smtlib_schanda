...
(assert (and (= o2 (capacity (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields)))) (and (in_range3 o2) (= o2 (ite (= (distinct 1 0) true) (to_rep1 (rec__indefinite_bounded_tagged__vect__vector__capacity container__split_discrs)) 2147483647)))))
