...
(assert (<= (length q) 100))
(assert (and (= o10 (length q)) (and (in_range3 o10) (<= (+ 0 o10) 2147483647))))
(assert (and (= o7 (length v)) (and (in_range3 o7) (<= (+ 0 o7) 2147483647))))
(assert (and (= o8 (length p)) (and (in_range3 o8) (<= (+ 0 o8) 2147483647))))
(assert (= o9 (- o8 o7)))
(assert (and (= o11 o9) (in_range1 o9)))
(assert (= result1 (ite (= o11 o10) true false)))
(assert (=> (= result1 true) (and (= o5 (length q)) (and (in_range3 o5) (<= (+ 0 o5) 2147483647)))))
