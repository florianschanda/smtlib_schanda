...
(declare-const temp___184 coordinate_type)
(declare-const temp___1841 coordinate_type)
(declare-const temp___1842 radius_type)
(assert (and (and (= (to_rep temp___184) 0) (= (to_rep temp___1841) 0)) (= (to_rep1 temp___1842) 0)))
(assert (not (= (in_bounds (mk___rep (mk___split_fields temp___184 temp___1841 temp___1842))) true)))
(check-sat)
(exit)
