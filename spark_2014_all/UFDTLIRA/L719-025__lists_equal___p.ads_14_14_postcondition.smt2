...
(define-fun temp___5091 () us_rep1 (mk___rep1 (mk___split_fields1 temp___509)))
(assert (= (to_rep o) 0))
(assert (= o o1))
...
(assert (and (= (length (mk___rep l__split_discrs l__split_fields6)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (last1 (mk___rep l__split_discrs l__split_fields6))) (length (mk___rep l__split_discrs l__split_fields6))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (last1 (mk___rep l__split_discrs l__split_fields6))) true)) (= (ole1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields6))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields6)) (length (mk___rep l__split_discrs l__split_fields6))) 1)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6)) 1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields6)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields)))) 1)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields6)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true)))))
(assert (=> (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true) (and (= temp___5091 (last1 (mk___rep l__split_discrs l__split_fields6))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields6)) 0) true) (= (bool_eq1 temp___5091 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) temp___5091) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields6)) temp___5091) (length (mk___rep l__split_discrs l__split_fields6))))))))
(assert (=> (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true)) (and (= temp___5091 (previous (mk___rep l__split_discrs l__split_fields6) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true) true) (= (bool_eq1 temp___5091 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) temp___5091) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields6)) temp___5091) (- (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)))))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= temp___509 cu__split_fields1))
(assert (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields5)) (- (length (mk___rep l__split_discrs l__split_fields6)) 1)) (= (bool_eq1 (mk___rep1 cu__split_fields5) no_element) true)) (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields5)) 1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields6)) 1)) true)) (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields5)) (model__ (mk___rep l__split_discrs l__split_fields6)) (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields6)) (length (mk___rep l__split_discrs l__split_fields5)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields5)) (positions (mk___rep l__split_discrs l__split_fields6)) (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields6)) 1) true)))
