...
(define-fun temp___4661 () us_rep1 (mk___rep1 (mk___split_fields1 temp___466)))
(assert (= (to_rep o) 0))
(assert (= o o1))
...
(assert (=> (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true) (and (= temp___4661 (last1 (mk___rep l__split_discrs l__split_fields6))) (ite (= (= (length (mk___rep l__split_discrs l__split_fields6)) 0) true) (= (bool_eq1 temp___4661 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) temp___4661) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields6)) temp___4661) (length (mk___rep l__split_discrs l__split_fields6))))))))
(assert (=> (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true)) (and (= temp___4661 (previous (mk___rep l__split_discrs l__split_fields6) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true) true) (= (bool_eq1 temp___4661 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) temp___4661) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields6)) temp___4661) (- (get1 (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)))))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= temp___466 cu__split_fields1))
