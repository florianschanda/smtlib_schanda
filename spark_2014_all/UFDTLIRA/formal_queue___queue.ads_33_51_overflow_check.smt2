...
(assert (and (= o4 (length q)) (and (in_range2 o4) (<= o4 (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))))
(assert (= o5 (+ o4 1)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o7 (ite (<= i o6) true false)))
(assert (= result3 (ite (<= 2 i) o7 false)))
(assert (= (= o8 true) (forall ((i1 Int)) (=> (and (<= 2 i1) (<= i1 (+ (length q) 1))) (= (get (model__ (list__content queue__enqueue__result7)) i1) (get (model__ q) (- i1 1)))))))
(assert (and (= o2 (first_element (list__content queue__enqueue__result7))) (and (in_range6 o2) (= o2 (get (model__ (list__content queue__enqueue__result7)) 1)))))
(assert (= o3 (ite (= o2 v) true false)))
