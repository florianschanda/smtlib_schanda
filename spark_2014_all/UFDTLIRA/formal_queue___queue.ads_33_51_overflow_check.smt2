...
(assert (= (= o13 true) (forall ((i1 Int)) (=> (and (<= 2 i1) (<= i1 (+ (length q) 1))) (= (get (model__ (list__content queue__enqueue__result7)) i1) (get (model__ q) (- i1 1)))))))
(assert (and (= o3 (first_element (list__content queue__enqueue__result7))) (and (in_range6 o3) (= o3 (get (model__ (list__content queue__enqueue__result7)) 1)))))
(assert (= o4 (ite (= o3 v) true false)))
