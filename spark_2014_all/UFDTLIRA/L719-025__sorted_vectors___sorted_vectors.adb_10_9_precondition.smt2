...
(assert (= position1 o))
(assert (and (= o1 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o1) (<= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (= result1 (ite (<= position1 o1) true false)))
(assert (= result1 true))
(assert (not (<= 1 position1)))
(check-sat)
(exit)
