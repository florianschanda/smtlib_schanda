...
(assert (= position1 o))
(assert (and (= o1 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o1) (<= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (= result1 (ite (<= position1 o1) true false)))
(assert (= result1 true))
(assert (not (<= position1 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(check-sat)
(exit)
