...
(define-fun dynamic_invariant ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1 2147483647)) (in_range1 temp___expr_383)))
...
(define-fun dynamic_invariant3 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range5 temp___expr_395)))
