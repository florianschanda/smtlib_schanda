...
(define-fun o17 () us_rep (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15) o16))
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o9) (mk___split_fields o10 o11) o12))
...
(assert (= o7 o3))
(assert (= true o8))
(assert (= o18 (mk___rep (mk___split_discrs o5) (mk___split_fields o6 o7) o8)))
(assert (= o17 o18))
(assert (= (mk___rep (mk___split_discrs main__u1__assume) (mk___split_fields main__u1__assume1 main__u1__assume2) main__u1__assume3) o17))
