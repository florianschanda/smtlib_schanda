...
(assert (= records__make_optional_pair_b__result3 (mk___rep1 (mk___split_fields1 r__split_fields3 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5))))))
(assert (= records__make_optional_pair_b__result6 records__make_optional_pair_b__result4))
(assert (= r__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields3 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5))))))
(assert (= records__make_optional_pair_b__result7 records__make_optional_pair_b__result5))
(assert (= r__split_fields7 (mk___split_fields1 r__split_fields3 (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)))))
...
(assert (not (= (bool_eq1 (optional_pair__content records__make_optional_pair_b__result6) (mk___rep1 (mk___split_fields1 (of_int 1) x))) true)))
(check-sat)
(exit)
