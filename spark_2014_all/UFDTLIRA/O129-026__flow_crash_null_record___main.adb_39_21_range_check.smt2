...
(define-fun dynamic_invariant ((temp___expr_197 us_rep1) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (= (attr__constrained (rec__main__node_type__variant_node (us_split_fields1 temp___expr_197))) false))
(define-fun default_initial_assumption ((temp___expr_199 us_rep1) (temp___skip_top_level_200 Bool)) Bool (and (= (attr__constrained (rec__main__node_type__variant_node (us_split_fields1 temp___expr_199))) false) (= (to_rep1 (rec__main__node_variant_type__m_variant (us_split_discrs1 (rec__main__node_type__variant_node (us_split_fields1 temp___expr_199))))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_206 us_rep2) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (= (attr__constrained (rec__main__node_type__variant_node (us_split_fields1 (rec__main__branch_type__n (us_split_fields3 temp___expr_206))))) false))
...
(define-fun dynamic_invariant2 ((temp___expr_214 us_rep2) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (and (=> (not (= temp___skip_constant_212 true)) (in_range3 7 temp___expr_214)) (= (attr__constrained (rec__main__node_type__variant_node (us_split_fields1 (rec__main__branch_type__n (us_split_fields3 temp___expr_214))))) false)))
(define-fun default_initial_assumption1 ((temp___expr_217 us_rep2) (temp___skip_top_level_218 Bool)) Bool (and (= (to_rep (rec__main__branch_type__m_height (us_split_discrs3 temp___expr_217))) 7) (and (= (attr__constrained (rec__main__node_type__variant_node (us_split_fields1 (rec__main__branch_type__n (us_split_fields3 temp___expr_217))))) false) (= (to_rep1 (rec__main__node_variant_type__m_variant (us_split_discrs1 (rec__main__node_type__variant_node (us_split_fields1 (rec__main__branch_type__n (us_split_fields3 temp___expr_217))))))) 0))))
(declare-const x__split_discrs us_split_discrs2)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant3 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 14)) (in_range temp___expr_177)))
(define-fun dynamic_invariant4 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 0)) (in_range1 temp___expr_183)))
(define-fun default_initial_assumption2 ((temp___expr_191 us_rep) (temp___skip_top_level_192 Bool)) Bool (and (= (attr__constrained temp___expr_191) false) (= (to_rep1 (rec__main__node_variant_type__m_variant (us_split_discrs1 temp___expr_191))) 0)))
