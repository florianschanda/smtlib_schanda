...
(assert (and (= o72 (first (mk___rep l3__split_discrs l3__split_fields4))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields4)) 0) true) (= (bool_eq1 o72 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o72) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o72) 1)))))
(assert (and (= o73 (next (mk___rep l3__split_discrs l3__split_fields4) o72)) (ite (= (ite (= (bool_eq1 o72 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o72) (length (mk___rep l3__split_discrs l3__split_fields4))) true) true) (= (bool_eq1 o73 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o73) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o73) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o72) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) no_element) true) (= (bool_eq1 no_element no_element) true))))
(check-sat)
(exit)
