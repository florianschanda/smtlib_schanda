...
(assert (not (in_range1 (+ (to_rep (rec__sum_elem__interval__first (us_split_fields1 (get (model__ p) x)))) (to_rep (rec__sum_elem__interval__last (us_split_fields1 (get (model__ p) x))))))))
(check-sat)
(exit)
