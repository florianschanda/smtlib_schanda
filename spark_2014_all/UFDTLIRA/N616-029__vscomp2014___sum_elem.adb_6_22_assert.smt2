...
(assert (not (in_range4 (+ (to_rep1 (rec__sum_elem__interval__first (us_split_fields3 (get (model__ p) x)))) (to_rep1 (rec__sum_elem__interval__last (us_split_fields3 (get (model__ p) x))))))))
(check-sat)
(exit)
