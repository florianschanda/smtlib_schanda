...
(define-fun model____split_fields4 () us_split_fields (mk___split_fields model____split_fields2 model____split_fields3))
...
(assert (and (and (= (is_valid state1 model____split_fields4) true) (ite (= (= (length model____split_fields) 0) true) (and (= res11 0) (= (oeq (mk___rep model____split_fields4) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true)) (and (= (is_prepend model____split_fields2 res11 model____split_fields) true) (= (is_add model____split_fields1 res11 model____split_fields3) true)))) (in_range res11)))
(assert (not (not (= res11 0))))
(check-sat)
(exit)
