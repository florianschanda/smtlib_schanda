...
(define-fun o6 () us_rep2 (mk___rep1 (mk___split_fields1 o4)))
...
(assert (=> (= result4 true) (and (= o6 (next l temp___5472)) (ite (= (ite (= (bool_eq2 temp___5472 no_element) false) (= (get1 (positions l) temp___5472) (length1 l)) true) true) (= (bool_eq2 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) (+ (get1 (positions l) temp___5472) 1)))))))
...
(define-fun temp___560 () us_rep (model__ l))
(assert (not (exists ((temp___559 Int)) (and (and (in_range4 temp___559) (= (iter_has_element temp___560 temp___559) true)) (= (get temp___560 temp___559) 1)))))
(check-sat)
(exit)
