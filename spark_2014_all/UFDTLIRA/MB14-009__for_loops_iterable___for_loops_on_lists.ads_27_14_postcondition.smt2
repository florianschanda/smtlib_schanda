...
(declare-const temp___5472 us_rep1)
...
(declare-const temp___5474 us_rep1)
...
(declare-const temp___5476 us_rep1)
...
(assert (and (= o7 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) 1)))))
(assert (= temp___547 o))
...
(assert (=> (= result4 true) (= temp___544 e2)))
(assert (=> (= result4 true) (= temp___543 count_11)))
(assert (=> (= result4 true) (= temp___542 count_01)))
...
(assert (=> (= result4 true) (=> (< 0 count_03) (exists ((cu us_rep1)) (and (= (has_key (positions l) cu) true) (= (element l cu) 0))))))
(assert (=> (= result4 true) (=> (< 0 count_12) (exists ((cu us_rep1)) (and (= (has_key (positions l) cu) true) (= (element l cu) 1))))))
(assert (=> (= result4 true) (and (and (and (=> (<= 0 2147483647) (in_range2 count_03)) (=> (<= 0 2147483647) (in_range2 count_12))) (=> (<= 0 2147483647) (in_range3 e3))) (and (= (has_key (positions l) temp___5472) true) (= e3 (element l temp___5472))))))
...
(assert (=> (= result4 true) (and (= o6 (next l temp___5472)) (ite (= (ite (= (bool_eq1 temp___5472 no_element) false) (= (get1 (positions l) temp___5472) (length1 l)) true) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) (+ (get1 (positions l) temp___5472) 1)))))))
(assert (=> (= result4 true) (and (= o5 (has_key (positions l) o6)) (= (= o5 true) (= (has_key (positions l) o6) true)))))
...
(assert (= result9 (bool__content for_loops_on_lists__count_for_of__result4)))
(assert (= (bool__content for_loops_on_lists__count_for_of__result4) true))
(define-fun temp___558 () us_rep2 (model__ l))
(assert (not (exists ((temp___557 Int)) (and (and (in_range5 temp___557) (= (iter_has_element temp___558 temp___557) true)) (= (get temp___558 temp___557) 0)))))
(check-sat)
(exit)
