...
(assert (=> (= result4 true) (= temp___502 e4)))
(assert (=> (= result4 true) (= temp___501 count_11)))
(assert (=> (= result4 true) (= temp___500 count_01)))
(assert (=> (= result4 true) (=> (= e4 0) (and (= o2 (+ count_01 1)) (in_range1 (+ count_01 1))))))
(assert (=> (= result4 true) (=> (= e4 0) (= result5 (mk_int__ref count_01)))))
(assert (=> (= result4 true) (=> (= e4 0) (= count_02 o2))))
(assert (=> (= result4 true) (=> (not (= e4 0)) (= count_02 count_01))))
(assert (=> (= result4 true) (=> (< 0 count_03) (exists ((cu2 us_rep1)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 0))))))
(assert (=> (= result4 true) (=> (< 0 count_12) (exists ((cu2 us_rep1)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 1))))))
(assert (=> (= result4 true) (and (and (and (=> (<= 0 2147483647) (in_range2 count_03)) (=> (<= 0 2147483647) (in_range2 count_12))) (=> (<= 0 2147483647) (in_range3 e5))) (and (= (has_key (positions l) temp___5052) true) (= e5 (element l temp___5052))))))
(assert (=> (= result4 true) (=> (= e5 1) (and (= o9 (+ count_12 1)) (in_range1 (+ count_12 1))))))
(assert (=> (= result4 true) (=> (= e5 1) (= result8 (mk_int__ref count_12)))))
(assert (=> (= result4 true) (=> (= e5 1) (= count_13 o9))))
(assert (=> (= result4 true) (=> (not (= e5 1)) (= count_13 count_12))))
(assert (=> (= result4 true) (and (= (mk___rep1 (mk___split_fields1 o10)) (next l temp___5052)) (ite (= (ite (= (bool_eq1 temp___5052 no_element) false) (= (get1 (positions l) temp___5052) (length1 l)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o10)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o10))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o10))) (+ (get1 (positions l) temp___5052) 1)))))))
(assert (=> (= result4 true) (and (= o11 (has_key (positions l) (mk___rep1 (mk___split_fields1 o10)))) (= (= o11 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o10))) true)))))
(assert (=> (= result4 true) (= result9 (ite (not (= o11 true)) true false))))
(assert (=> (= result4 true) (= result9 true)))
(assert (=> (= result4 true) (= temp___5054 (mk_cursor__ref temp___5052))))
(assert (=> (= result4 true) (= e7 (mk_int__ref e5))))
(assert (=> (= result4 true) (= count_14 (mk_int__ref count_13))))
(assert (=> (= result4 true) (= count_05 (mk_int__ref count_03))))
(assert (=> (= result4 true) (= temp___5055 temp___5052)))
(assert (=> (= result4 true) (= e8 e5)))
(assert (=> (= result4 true) (= count_15 count_13)))
(assert (=> (= result4 true) (= count_06 count_03)))
(assert (=> (= result4 true) (= temp___5056 temp___5054)))
(assert (=> (= result4 true) (= e9 e7)))
(assert (=> (= result4 true) (= count_16 count_14)))
(assert (=> (= result4 true) (= count_07 count_05)))
(assert (=> (= result4 true) (= temp___5057 temp___5055)))
(assert (=> (= result4 true) (= e10 e8)))
(assert (=> (= result4 true) (= count_17 count_15)))
(assert (=> (= result4 true) (= count_08 count_06)))
(assert (=> (not (= result4 true)) (= temp___5056 (mk_cursor__ref (mk___rep1 (mk___split_fields1 temp___505))))))
(assert (=> (not (= result4 true)) (= e9 (mk_int__ref e4))))
(assert (=> (not (= result4 true)) (= count_16 (mk_int__ref count_11))))
(assert (=> (not (= result4 true)) (= count_07 (mk_int__ref count_01))))
(assert (=> (not (= result4 true)) (= temp___5057 (mk___rep1 (mk___split_fields1 temp___5051)))))
(assert (=> (not (= result4 true)) (= e10 e4)))
(assert (=> (not (= result4 true)) (= count_17 count_11)))
(assert (=> (not (= result4 true)) (= count_08 count_01)))
...
(assert (= result14 (mk_bool__ref for_loops_on_lists__count_for_of__result)))
(assert (= for_loops_on_lists__count_for_of__result1 (ite (and (< 0 (int__content count_16)) (< 0 (int__content count_07))) true false)))
...
(assert (= count_010 count_08))
(assert (= result17 (bool__content for_loops_on_lists__count_for_of__result4)))
(assert (= (bool__content for_loops_on_lists__count_for_of__result4) true))
(assert (not (exists ((temp___515 Int)) (and (and (in_range5 temp___515) (= (iter_has_element (model__ l) temp___515) true)) (= (get (model__ l) temp___515) 0)))))
(check-sat)
(exit)
