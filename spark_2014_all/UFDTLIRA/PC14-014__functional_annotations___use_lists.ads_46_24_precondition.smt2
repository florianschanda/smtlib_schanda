...
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1))) (= (is_incr (get temp___500 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1)) true)))))
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) n1) (<= n1 (length (mk___rep l__split_discrs l__split_fields11)))) (= (get temp___501 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1))))))
