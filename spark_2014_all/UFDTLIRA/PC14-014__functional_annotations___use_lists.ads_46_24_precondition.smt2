...
(assert (and (= o27 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (not (= (has_key o27 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o27 i) true) (and (and (<= 1 (get1 o27 i)) (<= (get1 o27 i) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))) (forall ((j us_rep1)) (=> (= (has_key o27 j) true) (=> (= (get1 o27 i) (get1 o27 j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o28 (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o27)) (= (= o28 true) (and (forall ((key us_rep1)) (=> (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key) true) (and (= (has_key o27 key) true) (= (get1 o27 key) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key))))) (forall ((key us_rep1)) (=> (= (has_key o27 key) true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key) true)))))))
