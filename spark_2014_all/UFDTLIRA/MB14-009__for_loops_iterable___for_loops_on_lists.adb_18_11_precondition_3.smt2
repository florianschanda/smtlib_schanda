...
(assert (and (= o1 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o1 no_element) true) (and (= (has_key (positions l) o1) true) (= (get1 (positions l) o1) 1)))))
(assert (= temp___520 o))
...
(assert (= result true))
(assert (not (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___520))) true)))
(check-sat)
(exit)
