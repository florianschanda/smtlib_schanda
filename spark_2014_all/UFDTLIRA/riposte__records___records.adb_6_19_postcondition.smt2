...
(declare-const temp___257 unsigned_byte)
(declare-const temp___2571 unsigned_byte)
...
(assert (= (mk___rep (mk___split_fields records__init_a__result6 records__init_a__result7)) (mk___rep (mk___split_fields records__init_a__result2 records__init_a__result3))))
...
(assert (= records__init_a__result9 (mk___rep (mk___split_fields records__init_a__result6 records__init_a__result7))))
