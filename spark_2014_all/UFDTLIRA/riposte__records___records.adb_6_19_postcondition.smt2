...
(declare-const temp___290 unsigned_byte)
(declare-const temp___2901 unsigned_byte)
...
(declare-const records__init_a__result8 pair__ref)
(declare-const r__split_fields5 us_split_fields)
(declare-const records__init_a__result9 us_rep)
(define-fun records__init_a__result10 () us_rep (mk___rep (mk___split_fields records__init_a__result6 records__init_a__result7)))
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___290 o2))
(assert (= temp___2901 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___290 r__split_fields2))
(assert (= temp___2901 r__split_fields3))
(assert (= records__init_a__result4 records__init_a__result2))
(assert (= records__init_a__result5 records__init_a__result3))
(assert (= records__init_a__result10 (mk___rep (mk___split_fields records__init_a__result2 records__init_a__result3))))
...
(assert (= records__init_a__result8 (mk_pair__ref (mk___rep (mk___split_fields records__init_a__result4 records__init_a__result5)))))
...
(assert (= (mk___rep (mk___split_fields result4 result5)) (pair__content records__init_a__result8)))
(assert (not (= (bool_eq (pair__content records__init_a__result8) (mk___rep (mk___split_fields (of_rep 0) (of_rep 0)))) true)))
(check-sat)
(exit)
