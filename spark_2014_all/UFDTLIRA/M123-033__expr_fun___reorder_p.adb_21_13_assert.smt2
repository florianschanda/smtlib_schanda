...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (value us_void_param) true false true) :pattern ((value us_void_param)))))
(declare-fun g1 (tuple0) Int)
(declare-fun g1__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (g1 us_void_param) true false true) :pattern ((g1 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (g2 us_void_param) true false true) :pattern ((g2 us_void_param)))))
(declare-fun g3 (tuple0) Int)
(declare-fun g3__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (g3 us_void_param) true false true) :pattern ((g3 us_void_param)))))
(declare-fun g4 (tuple0) Int)
(declare-fun g4__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (g4 us_void_param) true false true) :pattern ((g4 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (f1 us_void_param) true false true) :pattern ((f1 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (f2 us_void_param) true false true) :pattern ((f2 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (f3 us_void_param) true false true) :pattern ((f3 us_void_param)))))
(assert (forall ((us_void_param tuple0)) (! (= (f3 us_void_param) 1) :pattern ((f3 us_void_param)))))
(declare-fun f4 (tuple0) Int)
(declare-fun f4__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (f4 us_void_param) true false true) :pattern ((f4 us_void_param)))))
...
(assert (and (= o4 (value Tuple0)) (in_range o4)))
(assert (= result4 (ite (= o4 4) true false)))
(assert (not (= result4 true)))
(assert (and (= o5 (value Tuple0)) (in_range o5)))
(assert (= result5 (ite (= o5 5) true false)))
(assert (not (= result5 true)))
(assert (and (= o6 (value Tuple0)) (in_range o6)))
(assert (= result6 (ite (= o6 6) true false)))
(assert (not (= result6 true)))
(assert (and (= o7 (value Tuple0)) (in_range o7)))
(assert (= result7 (ite (= o7 7) true false)))
(assert (= result7 true))
(assert (not (= (g4 Tuple0) 1)))
(check-sat)
(exit)
