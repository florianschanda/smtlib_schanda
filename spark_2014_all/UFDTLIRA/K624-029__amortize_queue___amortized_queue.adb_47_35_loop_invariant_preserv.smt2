...
(assert (and (= o (length left)) (and (in_range5 o) (<= o (capacity left)))))
...
(assert (and (= amortized_queue__Oconcat__3__L_4__R34b__assume (last (model__ left))) (and (in_range4 amortized_queue__Oconcat__3__L_4__R34b__assume) (= amortized_queue__Oconcat__3__L_4__R34b__assume (last (model__ left))))))
...
(assert (and (= o2 (get (model__ left) o1)) (and (in_range6 o2) (= o2 (get (model__ left) o1)))))
...
(assert (= (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) idx2))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 idx2)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) i2) (get (model__ left) i2)))))
(assert (and (=> (<= r33b r34b) (dynamic_property r33b r34b idx2)) (and (<= r33b idx2) (<= idx2 r34b))))
(assert (not (= idx2 r34b)))
(assert (= idx2 result2))
(assert (= idx3 (+ idx2 1)))
(assert (and (= o7 idx3) (in_range3 idx3)))
(assert (and (= o8 (get (model__ left) o7)) (and (in_range6 o8) (= o8 (get (model__ left) o7)))))
(assert (and (and (= (length (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1))) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1)))) true)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1))) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3)))) 1)) o8)))
(assert (= result3 result____split_fields3))
(assert (= result____split_fields4 (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1)))
(assert (not (= (length (mk___rep result____split_discrs result____split_fields4)) idx3)))
(check-sat)
(exit)
