...
(assert (=> (= result1 true) (= o32 (isdoingop (mk___rep theadmin__split_fields4)))))
(assert (=> (= result1 true) (= o33 (ite (not (= o32 true)) true false))))
(assert (=> (= result1 true) (= o31 (ispresent (mk___rep theadmin__split_fields4)))))
...
(assert (=> (= result2 true) (and (= o27 (rolepresent (mk___rep theadmin__split_fields4))) (in_range1 o27))))
(assert (=> (= result2 true) (= o28 (ite (= o27 0) true false))))
(assert (=> (= result2 true) (= o26 (isdoingop (mk___rep theadmin__split_fields4)))))
...
(assert (=> (= result3 true) (= o24 (isdoingop (mk___rep theadmin__split_fields4)))))
(assert (=> (= result3 true) (= o25 (ite (not (= o24 true)) true false))))
(assert (=> (not (= result3 true)) (= o25 (of_int 1))))
(assert (= o19 (statusiswaitingfinishadminop (let ((subject state2)) state17))))
(assert (= o20 (statusiswaitingstartadminop (let ((subject state2)) state17))))
(assert (= result4 (ite (= o20 false) o19 true)))
(assert (=> (= result4 true) (= o21 (ispresent (mk___rep theadmin__split_fields4)))))
(assert (=> (= result4 true) (= o22 (isdoingop (mk___rep theadmin__split_fields4)))))
(assert (=> (= result4 true) (= o23 (ite (= o22 true) o21 false))))
(assert (=> (not (= result4 true)) (= o23 (of_int 1))))
(assert (= o15 (statusiswaitingremoveadmintokenfail (let ((subject state2)) state17))))
(assert (= o16 (statusisgotadmintoken (let ((subject state2)) state17))))
(assert (= result5 (ite (= o16 false) o15 true)))
(assert (=> (= result5 true) (= o17 (ispresent (mk___rep theadmin__split_fields4)))))
(assert (=> (= result5 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (not (= result5 true)) (= o18 (of_int 1))))
(assert (and (= o11 (thecurrentop (mk___rep theadmin__split_fields4))) (in_range3 o11)))
(assert (= o12 (ite (= o11 4) true false)))
(assert (= o13 (isdoingop (mk___rep theadmin__split_fields4))))
(assert (= result6 (ite (= o13 true) o12 false)))
(assert (=> (= result6 true) (= o14 (statusiswaitingstartadminop (let ((subject state2)) state17)))))
(assert (=> (not (= result6 true)) (= o14 (of_int 1))))
(assert (= o8 (ispresent (mk___rep theadmin__split_fields4))))
(assert (= result7 (ite (not (= o8 true)) true false)))
(assert (=> (= result7 true) (= o9 (isdoingop (mk___rep theadmin__split_fields4)))))
...
(assert (=> (= result8 true) (= o4 (isdoingop (mk___rep theadmin__split_fields4)))))
(assert (=> (= result8 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result8 true) (and (= o1 (thecurrentop (mk___rep theadmin__split_fields4))) (in_range3 o1))))
(assert (=> (= result8 true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result8 true) (= o3 (isdoingop (mk___rep theadmin__split_fields4)))))
