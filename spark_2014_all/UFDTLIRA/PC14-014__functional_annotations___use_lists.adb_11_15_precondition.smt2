...
(assert (and (= o3 (get1 o2 (mk___rep1 cu__split_fields2))) (and (in_range5 o3) (=> (= (of_int 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 cu__split_fields2)))) (forall ((k us_rep1)) (=> (= (has_key o2 k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields2)) true) (= (witness o2 (mk___rep1 cu__split_fields2)) (witness o2 k))))))))))
(assert (= o4 (- o3 1)))
