...
(define-fun dynamic_invariant ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= (- 1) 2147483647)) (in_range3 temp___expr_325)))
...
(declare-datatypes () ((sequence__ref1 (mk_sequence__ref1 (sequence__content1 us_rep2)))))
(define-fun sequence__ref___2__projection ((a sequence__ref1)) us_rep2 (sequence__content1 a))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(define-fun last1 ((container us_rep2)) Int (+ 0 (length1 container)))
(declare-fun last__function_guard1 (Int us_rep2) Bool)
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__names__data__entry_tables__vector us_main_type3)))))
(define-fun us_split_fields_Vector__2__projection ((a us_split_fields2)) us_main_type3 (rec__names__data__entry_tables__vector a))
...
(declare-datatypes () ((us_rep3 (mk___rep1 (us_split_discrs3 us_split_discrs2) (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___4__projection ((a us_rep3)) us_split_discrs2 (us_split_discrs3 a))
(define-fun us_rep___5__projection ((a us_rep3)) us_split_fields2 (us_split_fields3 a))
...
(define-fun vector__ref___2__projection ((a vector__ref1)) us_rep3 (vector__content1 a))
(declare-fun model__1 (us_rep3) us_rep2)
(declare-fun model____function_guard1 (us_rep2 us_rep3) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 2147483647)) (in_range5 temp___expr_489)))
...
(define-fun in_range6 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun in_range7 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep3)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(declare-datatypes () ((tentry_tableS__ref (mk_tentry_tableS__ref (tentry_tableS__content us_rep3)))))
(define-fun tentry_tableS__ref___projection ((a tentry_tableS__ref)) us_rep3 (tentry_tableS__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_629 us_rep1) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (not (= temp___skip_constant_626 true)) (in_range6 1024 temp___expr_629)))
(define-fun default_initial_assumption ((temp___expr_631 us_rep1) (temp___skip_top_level_632 Bool)) Bool (and (= (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_631))) 1024) (=> (not (= temp___skip_top_level_632 true)) (= (is_empty temp___expr_631) true))))
(declare-fun is_empty1 (us_rep3) Bool)
(declare-fun is_empty__function_guard1 (Bool us_rep3) Bool)
(define-fun dynamic_invariant3 ((temp___expr_639 us_rep3) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (not (= temp___skip_constant_636 true)) (in_range7 256 temp___expr_639)))
(define-fun default_initial_assumption1 ((temp___expr_641 us_rep3) (temp___skip_top_level_642 Bool)) Bool (and (= (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_641))) 256) (=> (not (= temp___skip_top_level_642 true)) (= (is_empty1 temp___expr_641) true))))
(assert true)
...
(assert (forall ((x name_id)) (! (in_range8 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x char_table_index)) (! (in_range10 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq2 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep4 (rec__names__data__name_entry__table_index (us_split_fields5 a))) (to_rep4 (rec__names__data__name_entry__table_index (us_split_fields5 b)))) (= (to_rep (rec__names__data__name_entry__length (us_split_fields5 a))) (to_rep (rec__names__data__name_entry__length (us_split_fields5 b))))) (= (to_rep3 (rec__names__data__name_entry__next_hash (us_split_fields5 a))) (to_rep3 (rec__names__data__name_entry__next_hash (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant6 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range11 temp___expr_166)))
(define-fun dynamic_invariant7 ((temp___expr_304 Int) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool) (temp___do_typ_inv_303 Bool)) Bool (=> (or (= temp___is_init_300 true) (<= 0 2147483646)) (in_range10 temp___expr_304)))
(define-fun dynamic_invariant8 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range2 temp___expr_332)))
(define-fun capacity ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(assert (forall ((container us_rep1)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant8 result true false true true))) :pattern ((length2 container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_371 us_rep) (temp___skip_top_level_372 Bool)) Bool (=> (not (= temp___skip_top_level_372 true)) (= (length temp___expr_371) 0)))
(assert (forall ((container us_rep1)) (! (= (length (model__ container)) (length2 container)) :pattern ((model__ container)))))
(assert (forall ((container us_rep1)) (! (= (= (is_empty container) true) (= (length2 container) 0)) :pattern ((is_empty container)))))
...
(define-fun dynamic_invariant9 ((temp___expr_363 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool) (temp___do_typ_inv_362 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= (- 1) 2147483646)) (in_range12 temp___expr_363)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant6 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant10 ((temp___expr_356 Int) (temp___is_init_352 Bool) (temp___skip_constant_353 Bool) (temp___do_toplevel_354 Bool) (temp___do_typ_inv_355 Bool)) Bool (=> (or (= temp___is_init_352 true) (<= 0 255)) (in_range13 temp___expr_356)))
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant9 position true true true true) (and (<= 0 position) (<= position (last container)))) (dynamic_invariant10 (get container position) true false true true)) :pattern ((get container position))))))
...
(define-fun capacity1 ((container us_rep3)) Int (ite (= (distinct 0 0) true) (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(assert (forall ((container us_rep3)) (! (let ((result (length3 container))) (and (<= result (capacity1 container)) (dynamic_invariant11 result true false true true))) :pattern ((length3 container)))))
...
(declare-fun get1 (us_rep2 Int) us_rep4)
(declare-fun get__function_guard1 (us_rep4 us_rep2 Int) Bool)
(define-fun oeq1 ((left us_rep2) (right us_rep2)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last1 left))) (= (bool_eq2 (get1 left n) (get1 right n)) true))) true false)))
...
(assert (forall ((container us_rep3)) (! (= (length1 (model__1 container)) (length3 container)) :pattern ((model__1 container)))))
(assert (forall ((container us_rep3)) (! (= (= (is_empty1 container) true) (= (length3 container) 0)) :pattern ((is_empty1 container)))))
...
(define-fun dynamic_invariant12 ((temp___expr_530 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool) (temp___do_typ_inv_529 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 2147483647)) (in_range14 temp___expr_530)))
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true true))) :pattern ((length1 container)))))
(assert true)
...
(assert (and (= o (last (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))) (and (in_range3 o) (= o (last (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))))))
(assert (= o1 (- o (to_rep4 (rec__names__data__name_entry__table_index (us_split_fields5 e))))))
(assert (not (in_range9 o1)))
(check-sat)
(exit)
