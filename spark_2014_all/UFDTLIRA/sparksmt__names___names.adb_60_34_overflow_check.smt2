...
(define-fun in_range4 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep2 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant ((temp___expr_569 us_rep) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (not (= temp___skip_constant_567 true)) (in_range4 1024 temp___expr_569)))
(define-fun default_initial_assumption ((temp___expr_571 us_rep) (temp___skip_top_level_572 Bool)) Bool (and (= (to_rep2 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_571))) 1024) (=> (not (= temp___skip_top_level_572 true)) (= (is_empty temp___expr_571) true))))
...
(declare-fun to_rep3 (capacity_range1) Int)
(declare-fun of_rep3 (Int) capacity_range1)
(assert (forall ((x capacity_range1)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x capacity_range1)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun in_range6 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep3 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant1 ((temp___expr_578 us_rep1) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (not (= temp___skip_constant_576 true)) (in_range6 256 temp___expr_578)))
(define-fun default_initial_assumption1 ((temp___expr_580 us_rep1) (temp___skip_top_level_581 Bool)) Bool (and (= (to_rep3 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_580))) 256) (=> (not (= temp___skip_top_level_581 true)) (= (is_empty1 temp___expr_580) true))))
...
(declare-fun user_eq8 (tchar_table_indexB tchar_table_indexB) Bool)
(declare-const dummy8 tchar_table_indexB)
...
(define-fun dynamic_invariant2 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 1) 2147483647)) (in_range9 temp___expr_282)))
...
(define-fun bool_eq1 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep4 (rec__names__data__name_entry__table_index (us_split_fields5 a))) (to_rep4 (rec__names__data__name_entry__table_index (us_split_fields5 b)))) (= (to_rep (rec__names__data__name_entry__length (us_split_fields5 a))) (to_rep (rec__names__data__name_entry__length (us_split_fields5 b))))) (= (to_rep1 (rec__names__data__name_entry__next_hash (us_split_fields5 a))) (to_rep1 (rec__names__data__name_entry__next_hash (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 2147483647)) (in_range10 temp___expr_436)))
...
(define-fun last1 ((container us_rep4)) Int (+ 0 (length1 container)))
...
(define-fun dynamic_invariant5 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range2 temp___expr_180)))
...
(define-fun dynamic_invariant6 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range11 temp___expr_142)))
...
(define-fun dynamic_invariant8 ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 0 2147483647)) (in_range3 temp___expr_288)))
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep2 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(declare-fun length2 (us_rep) Int)
(declare-fun length__function_guard2 (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant8 result true false true))) :pattern ((length2 container)))))
(declare-fun get (us_rep2 Int) Int)
(declare-fun get__function_guard (Int us_rep2 Int) Bool)
(define-fun oeq ((left us_rep2) (right us_rep2)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun dynamic_invariant9 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 1) 2147483646)) (in_range12 temp___expr_315)))
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant6 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant10 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range13 temp___expr_309)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant9 position true true true) (and (<= 0 position) (<= position (last container)))) (dynamic_invariant10 (get container position) true false true)) :pattern ((get container position))))))
(define-fun dynamic_invariant11 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range5 temp___expr_442)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (of_int 0) true) (to_rep3 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last1 left))) (= (bool_eq1 (get1 left n) (get1 right n)) true))) true false)))
(declare-fun oeq__function_guard1 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq14 a b) (oeq1 a b)) :pattern ((user_eq14 a b)))))
(define-fun default_initial_assumption3 ((temp___expr_479 us_rep4) (temp___skip_top_level_480 Bool)) Bool (=> (not (= temp___skip_top_level_480 true)) (= (length1 temp___expr_479) 0)))
...
(define-fun dynamic_invariant12 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 2147483647)) (in_range14 temp___expr_472)))
(assert (forall ((container us_rep4)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true))) :pattern ((length1 container)))))
(assert true)
...
(assert (and (= o (last (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))) (and (in_range9 o) (= o (last (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))))))
