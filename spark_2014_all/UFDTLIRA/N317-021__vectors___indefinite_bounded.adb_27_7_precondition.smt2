...
(assert (= v__split_fields6 indefinite_bounded__vect__clear__container__fields1))
...
(assert (not (<= 3 (to_rep (rec__indefinite_bounded__vect__vector__capacity v__split_discrs)))))
(check-sat)
(exit)
