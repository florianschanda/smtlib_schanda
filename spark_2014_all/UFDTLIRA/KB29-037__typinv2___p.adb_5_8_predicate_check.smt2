...
(define-fun dynamic_invariant ((temp___expr_135 us_rep) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (= temp___do_toplevel_134 true) (=> (= temp___is_init_132 true) (= (= (rec__p__t__locked (us_split_fields1 temp___expr_135)) true) (< 3 (to_rep (rec__p__t__access_count (us_split_fields1 temp___expr_135))))))))
(define-fun default_initial_assumption ((temp___expr_137 us_rep) (temp___skip_top_level_138 Bool)) Bool (and (= (to_rep (rec__p__t__access_count (us_split_fields1 temp___expr_137))) 0) (= (rec__p__t__locked (us_split_fields1 temp___expr_137)) (of_int 0))))
(define-fun dynamic_predicate ((temp___139 us_rep)) Bool (= (= (rec__p__t__locked (us_split_fields1 temp___139)) true) (< 3 (to_rep (rec__p__t__access_count (us_split_fields1 temp___139))))))
...
(declare-const temp___144 natural)
(declare-const temp___1441 Bool)
(declare-const temp___145 natural)
(declare-const temp___1451 Bool)
(declare-const result natural)
(declare-const result1 Bool)
(declare-const v__split_fields2 natural)
(declare-const v__split_fields3 Bool)
(assert (let ((temp___136 i1s)) (= (= (rec__p__t__locked (us_split_fields1 temp___136)) true) (< 3 (to_rep (rec__p__t__access_count (us_split_fields1 temp___136)))))))
...
(assert (= (= temp___1441 true) (< 3 (to_rep temp___144))))
(assert (= (mk___rep (mk___split_fields temp___145 temp___1451)) (mk___rep (mk___split_fields temp___144 temp___1441))))
(assert (= result v__split_fields))
(assert (= result1 v__split_fields1))
(assert (= temp___145 v__split_fields2))
(assert (= temp___1451 v__split_fields3))
