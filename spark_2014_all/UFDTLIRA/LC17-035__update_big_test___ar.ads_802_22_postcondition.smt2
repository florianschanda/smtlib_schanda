...
(declare-const temp___6691 et3)
(declare-const temp___66911 et1)
(declare-const temp___66912 et2)
(declare-const temp___66913 enum1ta)
...
(declare-const temp___6694 et3)
(declare-const temp___66941 et1)
(declare-const temp___66942 et2)
(declare-const temp___66943 enum1ta)
...
(assert (= temp___6691 o5))
(assert (= temp___66911 o6))
(assert (= temp___66912 o7))
(assert (= temp___66913 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6691 (mk___rep (mk___split_fields temp___66911 temp___66912)) temp___66913)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6694 o14))
(assert (= temp___66941 o15))
(assert (= temp___66942 o16))
(assert (= temp___66943 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6694 (mk___rep (mk___split_fields temp___66941 temp___66942)) temp___66943)))
