...
(declare-const temp___6750 et3)
(declare-const temp___67501 et1)
(declare-const temp___67502 et2)
(declare-const temp___67503 enum1ta)
...
(declare-const temp___6753 et3)
(declare-const temp___67531 et1)
(declare-const temp___67532 et2)
(declare-const temp___67533 enum1ta)
...
(assert (= temp___6750 o5))
(assert (= temp___67501 o6))
(assert (= temp___67502 o7))
(assert (= temp___67503 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6750 (mk___rep (mk___split_fields temp___67501 temp___67502)) temp___67503)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6753 o14))
(assert (= temp___67531 o15))
(assert (= temp___67532 o16))
(assert (= temp___67533 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6753 (mk___rep (mk___split_fields temp___67531 temp___67532)) temp___67533)))
(assert (= r__split_fields6 (mk___split_fields__ref1 r__split_fields5)))
(assert (= r__split_fields7 r__split_fields5))
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields6)) (mk___rep1 (let ((usq_ (us_split_fields__content1 r__split_fields6))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_) (mk___rep (mk___split_fields (of_rep e) (of_rep1 f))) (rec__ar__rec2t__h2 usq_))))) true)))
(check-sat)
(exit)
