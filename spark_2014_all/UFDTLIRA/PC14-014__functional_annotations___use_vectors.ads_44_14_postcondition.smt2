...
(assert (=> (and (<= first i1) (<= i1 r7b)) (forall ((n Int)) (=> (and (<= first n) (<= n (- i2 1))) (= (is_incr (get temp___479 n) (get (model__ (mk___rep v__split_discrs v__split_fields12)) n)) true)))))
(assert (=> (and (<= first i1) (<= i1 r7b)) (forall ((n Int)) (=> (and (<= i2 n) (<= n (last5 (model__ (mk___rep v__split_discrs v__split_fields12))))) (= (get temp___480 n) (get (model__ (mk___rep v__split_discrs v__split_fields12)) n))))))
