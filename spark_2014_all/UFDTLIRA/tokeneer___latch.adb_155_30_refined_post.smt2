...
(define-fun dynamic_invariant ((temp___expr_424 Int) (temp___is_init_421 Bool) (temp___skip_constant_422 Bool) (temp___do_toplevel_423 Bool)) Bool (=> (or (= temp___is_init_421 true) (<= 1901 2099)) (in_range temp___expr_424)))
(define-fun dynamic_invariant1 ((temp___expr_430 Int) (temp___is_init_427 Bool) (temp___skip_constant_428 Bool) (temp___do_toplevel_429 Bool)) Bool (=> (or (= temp___is_init_427 true) (<= 1 12)) (in_range1 temp___expr_430)))
(define-fun dynamic_invariant2 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 1 31)) (in_range2 temp___expr_436)))
(define-fun dynamic_invariant3 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 86399999)) (in_range3 temp___expr_464)))
