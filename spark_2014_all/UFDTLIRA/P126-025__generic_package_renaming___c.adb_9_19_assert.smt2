...
(assert (forall ((e Int)) (! (=> (dynamic_invariant1 e true true true) (dynamic_invariant1 (id e) true false true)) :pattern ((id e)))))
(assert (forall ((e Int)) (! (=> (dynamic_invariant1 e true true true) (= (id e) e)) :pattern ((id e)))))
