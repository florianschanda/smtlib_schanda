...
(assert (= result6 true))
(assert (and (= o27 (has_key (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) c1)) (= (= o27 true) (= (has_key (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) c1) true))))
(assert (= o28 true))
(assert (= result7 (ite (= o28 true) o27 false)))
(assert (= result7 true))
(assert (and (= result8 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1)) (= (= result8 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1) true))))
(assert (= result8 true))
