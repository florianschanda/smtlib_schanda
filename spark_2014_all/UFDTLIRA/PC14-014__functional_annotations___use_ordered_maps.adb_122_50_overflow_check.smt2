...
(assert (and (= o12 (positions s2)) (and (not (= (has_key1 o12 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key1 o12 i) true) (and (and (<= 1 (get2 o12 i)) (<= (get2 o12 i) (length s2))) (forall ((j us_rep1)) (=> (= (has_key1 o12 j) true) (=> (= (get2 o12 i) (get2 o12 j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o13 (get2 o12 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o13) (=> (= (of_int 0) true) (and (= o13 (w_get1 o12 (witness1 o12 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k4 us_rep1)) (=> (= (has_key1 o12 k4) true) (= (= (bool_eq1 k4 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness1 o12 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness1 o12 k4))))))))))
(assert (= o14 (+ (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) o13)))
(assert (not (in_range1 o14)))
(check-sat)
(exit)
