...
(assert (= result1 true))
(assert (< (length (mk___rep s1__split_discrs s1__split_fields2)) (+ (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get2 (positions s2) (mk___rep1 cu__split_fields3)))))
(assert (let ((temp___780 (keys (mk___rep s1__split_discrs s1__split_fields2)))) (forall ((temp___779 Int)) (=> (and (in_range5 temp___779) (= (iter_has_element temp___780 temp___779) true)) (= (prop__ (get (model__ (mk___rep s1__split_discrs s1__split_fields2)) (get1 temp___780 temp___779))) true)))))
(assert (and (= o (positions s2)) (and (not (= (has_key1 o no_element) true)) (forall ((i us_rep1)) (=> (= (has_key1 o i) true) (and (and (<= 1 (get2 o i)) (<= (get2 o i) (length s2))) (forall ((j us_rep1)) (=> (= (has_key1 o j) true) (=> (= (get2 o i) (get2 o j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o1 (get2 o (mk___rep1 cu__split_fields3))) (and (in_range7 o1) (=> (= (of_int 0) true) (and (= o1 (w_get1 o (witness1 o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key1 o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness1 o (mk___rep1 cu__split_fields3)) (witness1 o k))))))))))
(assert (= o2 (+ (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) o1)))
