...
(assert (in_range x))
(assert (and (and (= (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)))) r_old) (and (= (bool_eq1 (mk___rep1 r__split_fields3) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r_old)) (mk___rep (mk___split_fields (of_rep x) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 r_old))))))))) true) (and (and (and (and (and (= (to_rep o8) 0) (and (= (rec__records_prooffuncs__pair__a (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair r__split_fields3))) o9) (= o8 o10))) (and (= o11 o9) (= o12 o10))) (and (= (rec__records_prooffuncs__optional_pair__exists r__split_fields3) o13) (and (= o14 o11) (= o15 o12)))) (and (= temp___457 o13) (and (= temp___4571 o14) (= temp___4572 o15)))) (and (= result1 (mk___split_fields__ref1 r__split_fields3)) (= r__split_fields4 (mk___split_fields1 temp___457 (mk___rep (mk___split_fields temp___4571 temp___4572)))))))) (and (= r__split_fields5 (mk___split_fields__ref1 r__split_fields4)) (= r__split_fields6 r__split_fields4))))
