...
(declare-const temp___4901 unsigned_byte)
(declare-const temp___4902 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___490 o5))
(assert (= temp___4901 o6))
(assert (= temp___4902 o7))
(assert (= result (mk___split_fields__ref1 r__split_fields3)))
(assert (= r__split_fields4 (mk___split_fields1 temp___490 (mk___rep (mk___split_fields temp___4901 temp___4902)))))
