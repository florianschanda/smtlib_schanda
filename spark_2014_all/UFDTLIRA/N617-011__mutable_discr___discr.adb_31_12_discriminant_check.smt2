...
(assert (= (mk___rep (mk___split_discrs temp___284) temp___2841) (mk___rep (mk___split_discrs o6) o7)))
(assert (= d__split_discrs (mk___split_discrs temp___284)))
(assert (= (to_rep o8) 0))
(assert (= o8 o9))
(assert (= o10 o9))
(assert (= true o11))
(assert (= (mk___rep (mk___split_discrs o12) o13) (mk___rep (mk___split_discrs o10) o11)))
(assert (not (= c (to_rep o12))))
(check-sat)
(exit)
