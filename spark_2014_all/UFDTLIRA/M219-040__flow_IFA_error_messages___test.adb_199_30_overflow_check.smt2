...
(assert (forall ((test__unused_variables_2__x Int) (test__unused_variables_2__y Int)) (! (=> (and (dynamic_invariant test__unused_variables_2__x true true true) (dynamic_invariant test__unused_variables_2__y true true true)) (dynamic_invariant (return_x test__unused_variables_2__x test__unused_variables_2__y) true false true)) :pattern ((return_x test__unused_variables_2__x test__unused_variables_2__y)))))
(declare-const x Int)
(declare-const y Int)
(declare-const z Int)
(declare-const o Int)
