...
(assert (and (and (=> (<= 0 255) (in_range1 tmp)) (and (= (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))) x_old) (and (and (= (bool_eq1 (mk___rep1 x__split_fields3) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 x_old)) (mk___rep (mk___split_fields (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x_old)))) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x_old))))))))) true) (= tmp1 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x_old))))))) (and (=> (<= 0 255) (in_range1 tmp1)) (and (and (and (and (and (= (to_rep o8) tmp1) (and (= (rec__records_prooffuncs__pair__a (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair x__split_fields3))) o9) (= o8 o10))) (and (= o11 o9) (= o12 o10))) (and (= (rec__records_prooffuncs__optional_pair__exists x__split_fields3) o13) (and (= o14 o11) (= o15 o12)))) (= temp___317 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)))))) (and (= result2 (mk___split_fields__ref1 x__split_fields3)) (= x__split_fields4 (us_split_fields3 temp___317)))))))) (and (and (= tmp2 (mk_int__ref tmp1)) (= x__split_fields5 (mk___split_fields__ref1 x__split_fields4))) (and (= tmp3 tmp1) (= x__split_fields6 x__split_fields4)))))
