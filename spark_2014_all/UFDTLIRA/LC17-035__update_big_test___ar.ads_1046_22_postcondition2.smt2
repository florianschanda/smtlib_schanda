...
(declare-fun user_eq2 (enum1t enum1t) Bool)
(declare-const dummy2 enum1t)
...
(assert (forall ((x enum1t)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun to_rep3 ((x et3)) Int (et3qtint x))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (bool_eq2 (rec__ar__rec4t__f4 (us_split_fields7 a)) (rec__ar__rec4t__f4 (us_split_fields7 b))) true) (= (to_rep2 (rec__ar__rec4t__g4 (us_split_fields7 a))) (to_rep2 (rec__ar__rec4t__g4 (us_split_fields7 b))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_218 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 10 90)) (in_range3 temp___expr_218)))
(define-fun dynamic_invariant3 ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 50 59)) (in_range5 temp___expr_225)))
(define-fun dynamic_invariant4 ((temp___expr_232 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 6)) (in_range2 temp___expr_232)))
...
(declare-const temp___7196 us_rep3)
...
(declare-const o27 us_split_fields6)
(declare-const temp___7201 us_rep3)
...
(assert (= o18 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
(assert (= o19 (mk___split_fields3 o18 r__split_fields5)))
(assert (= temp___7196 (mk___rep3 o19)))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)) r__split_fields3)) r__split_fields4)) r__split_fields5))))
(assert (= r__split_fields6 (us_split_fields7 temp___7196)))
(assert (= (to_rep1 o20) f))
(assert (= o21 (mk___split_fields (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))))) o20)))
(assert (= o22 (mk___rep o21)))
(assert (= o23 (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))) o22 (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))))))
(assert (= o24 (mk___rep1 o23)))
(assert (= o25 (mk___split_fields2 o24 (rec__ar__rec3t__g3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))))
(assert (= o26 (mk___rep2 o25)))
(assert (= o27 (mk___split_fields3 o26 (rec__ar__rec4t__g4 r__split_fields6))))
(assert (= temp___7201 (mk___rep3 o27)))
(assert (= result1 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7201)))
(assert (= r__split_fields8 (mk___split_fields__ref3 r__split_fields7)))
(assert (= r__split_fields9 r__split_fields7))
(assert (not (= (bool_eq2 (rec__ar__rec4t__f4 (us_split_fields__content3 r__split_fields8)) (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) (of_rep1 f))) r__split_fields3)) r__split_fields4))) true)))
(check-sat)
(exit)
