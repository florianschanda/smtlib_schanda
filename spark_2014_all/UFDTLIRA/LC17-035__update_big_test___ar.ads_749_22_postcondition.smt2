...
(declare-const temp___6626 et1)
(declare-const temp___66261 et2)
...
(assert (= temp___6626 o1))
(assert (= temp___66261 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___6626 r__split_fields4))
(assert (= temp___66261 r__split_fields5))
