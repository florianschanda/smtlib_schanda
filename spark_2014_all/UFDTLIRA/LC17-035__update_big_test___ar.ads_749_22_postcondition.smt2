...
(declare-const temp___6685 et1)
(declare-const temp___66851 et2)
...
(assert (= (to_rep o) 25))
(assert (= o o1))
(assert (= r__split_fields3 o2))
(assert (= temp___6685 o1))
(assert (= temp___66851 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___6685 r__split_fields4))
(assert (= temp___66851 r__split_fields5))
...
(assert (not (= (to_rep r__split_fields6) 25)))
(check-sat)
(exit)
