...
(assert (not (or (< (length (mk___rep s2__split_discrs s2__split_fields1)) (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields1)) o18) true))))
(check-sat)
(exit)
