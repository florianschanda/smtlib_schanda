...
(assert (and (= o1 (last4 (model__ container))) (and (dynamic_property4 first3 last5 o1) (= o1 (last4 (model__ container))))))
...
(assert (and (= us temp___460) (dynamic_property3 first2 last3 temp___460)))
(assert (= o temp___460))
(assert (not (dynamic_property2 first1 last2 index)))
(check-sat)
(exit)
