...
(assert (and (= o1 (last1 (model__ container))) (and (dynamic_property3 first2 last4 o1) (= o1 (last1 (model__ container))))))
...
(assert (and (= us temp___460) (dynamic_property4 first3 last5 temp___460)))
(assert (= o temp___460))
(assert (not (dynamic_property first last index)))
(check-sat)
(exit)
