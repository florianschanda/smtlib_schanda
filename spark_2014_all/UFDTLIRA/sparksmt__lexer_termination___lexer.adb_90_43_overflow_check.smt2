...
(define-fun default_initial_assumption ((temp___expr_463 us_rep) (temp___skip_top_level_464 Bool)) Bool (and (= (attr__constrained temp___expr_463) false) (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs1 temp___expr_463))) 2)))
...
(define-fun dynamic_invariant4 ((temp___expr_455 Int) (temp___is_init_452 Bool) (temp___skip_constant_453 Bool) (temp___do_toplevel_454 Bool)) Bool (=> (or (= temp___is_init_452 true) (<= 0 2)) (in_range4 temp___expr_455)))
