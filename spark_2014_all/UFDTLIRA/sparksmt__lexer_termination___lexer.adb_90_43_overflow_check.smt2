...
(define-fun default_initial_assumption ((temp___expr_531 us_rep) (temp___skip_top_level_532 Bool)) Bool (and (= (attr__constrained temp___expr_531) false) (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs1 temp___expr_531))) 2)))
...
(define-fun dynamic_invariant4 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 2)) (in_range4 temp___expr_522)))
...
(assert (not (in_range (+ current_col 1))))
(check-sat)
(exit)
