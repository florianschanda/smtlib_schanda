...
(assert (= j13 j11))
(assert (= (mem s r) true))
(assert (and (= o3 (length s)) (in_range1 o3)))
(assert (= o4 (ite (<= list_allocator__m__find__result16 o3) true false)))
(assert (= result7 (ite (<= 1 list_allocator__m__find__result16) o4 false)))
(assert (= result7 true))
(assert (and (= o2 list_allocator__m__find__result16) (in_range2 list_allocator__m__find__result16)))
(assert (not (<= 1 o2)))
(check-sat)
(exit)
