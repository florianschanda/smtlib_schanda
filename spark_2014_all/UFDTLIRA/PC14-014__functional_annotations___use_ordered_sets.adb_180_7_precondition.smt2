...
(assert (not (or (< (length (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs))) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields4))) 5) true))))
(check-sat)
(exit)
