...
(assert (= temp___6813 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
...
(assert (not (= (to_rep1 (rec__ar__rec3t__g3 (us_split_fields__content2 r__split_fields6))) (to_rep1 r__split_fields4))))
(check-sat)
(exit)
