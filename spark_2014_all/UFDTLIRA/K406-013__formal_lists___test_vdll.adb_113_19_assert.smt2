...
(assert (not (not (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) (next (mk___rep l1__split_discrs l1__split_fields4) (first (mk___rep l4__split_discrs l4__split_fields2)))) true))))
(check-sat)
(exit)
