...
(assert (=> (= result1 true) (and (and (= temp___404 position1) (and (or (= position2 1) (< (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) (- position2 1)) new_item)) (and (and (=> (<= 1 100) (in_range3 position2)) (and (<= position2 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (< (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position2) new_item))) (and (and (and (= o6 (+ position2 1)) (in_range3 (+ position2 1))) (and (= position2 result4) (= position3 o6))) (and (and (and (and (and (= o8 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o8) (<= o8 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))) (= result6 (ite (<= position3 o8) true false))) (ite (= result6 true) (and (and (= o7 (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position3)) (and (in_range8 o7) (= o7 (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position3)))) (= o9 (ite (< o7 new_item) true false))) (= o9 false))) (= result5 (ite (not (= o9 true)) true false))) (= result5 true)))))) (and (= position3 position6) (= position7 position3)))))
(assert (=> (= result1 true) (= (mk_int__ref position8) (mk_int__ref position6))))
(assert (=> (= result1 true) (= position9 position7)))
(assert (=> (not (= result1 true)) (= position1 position8)))
(assert (=> (not (= result1 true)) (= position9 position1)))
