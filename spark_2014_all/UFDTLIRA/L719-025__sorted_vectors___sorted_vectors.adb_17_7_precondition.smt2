...
(define-fun dynamic_invariant ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 1 100)) (in_range2 temp___expr_183)))
...
(define-fun dynamic_invariant1 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 1 100)) (in_range3 temp___expr_189)))
...
(define-fun dynamic_invariant2 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 100)) (in_range5 temp___expr_213)))
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__sorted_vectors__my_vectors__vector__capacity (us_split_discrs1 container))) 100))
...
(define-fun dynamic_invariant3 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 1 100)) (in_range7 temp___expr_234)))
(define-fun dynamic_invariant4 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 100)) (in_range6 temp___expr_240)))
...
(define-fun dynamic_invariant5 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 1 100)) (in_range4 temp___expr_195)))
...
(define-fun dynamic_invariant6 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 1 100)) (in_range8 temp___expr_201)))
...
(define-fun dynamic_invariant9 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 101)) (in_range10 temp___expr_207)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 100) (dynamic_invariant8 result true false true))) :pattern ((length1 container)))))
...
(assert (=> (= result1 true) (= temp___404 position1)))
...
(assert (=> (= result1 true) (=> (<= 1 100) (in_range3 position2))))
