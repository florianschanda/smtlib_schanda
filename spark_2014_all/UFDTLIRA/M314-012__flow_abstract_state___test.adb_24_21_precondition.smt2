...
(assert (forall ((stack_asm__state us_private)) (! (=> (not (= (is_empty stack_asm__state) true)) (dynamic_invariant (top stack_asm__state) true false true)) :pattern ((top stack_asm__state)))))
