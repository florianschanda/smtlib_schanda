...
(assert (let ((temp___208 (id 2))) (and (in_range1 (id 2)) (or (and (<= (- 2147483648) temp___208) (<= temp___208 (- 2))) (and (<= 2 temp___208) (<= temp___208 2147483647))))))
(assert (let ((temp___212 (id (- 2)))) (and (in_range1 (id (- 2))) (or (and (<= (- 2147483648) temp___212) (<= temp___212 (- 2))) (and (<= 2 temp___212) (<= temp___212 2147483647))))))
