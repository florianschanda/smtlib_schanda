...
(define-fun dynamic_invariant ((temp___expr_407 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range2 temp___expr_407)))
...
(define-fun dynamic_invariant1 ((temp___expr_422 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 0 2147483647)) (in_range3 temp___expr_422)))
...
(define-fun default_initial_assumption ((temp___expr_429 us_rep) (temp___skip_top_level_430 Bool)) Bool (=> (not (= temp___skip_top_level_430 true)) (= (length temp___expr_429) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 2147483646)) (in_range6 temp___expr_214)))
(define-fun dynamic_invariant5 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 2147483647)) (in_range5 temp___expr_148)))
(assert true)
(declare-const o Int)
...
(assert (and (= o1 (last left)) (and (in_range3 o1) (= o1 (+ 0 (length left))))))
(assert (= result (ite (<= lst o1) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o 1) true false))))
(assert (=> (not (< offset 0)) (= result1 (of_int 1))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (not (in_range1 lst)))
(check-sat)
(exit)
