...
(assert (and (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu2)) true) (= (p_positions_swapped (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) cu1 cu2) true)))
