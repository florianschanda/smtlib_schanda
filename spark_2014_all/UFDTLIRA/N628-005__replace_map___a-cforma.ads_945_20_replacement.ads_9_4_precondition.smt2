...
(define-fun default_initial_assumption ((temp___expr_434 us_rep1) (temp___skip_top_level_435 Bool)) Bool (=> (not (= temp___skip_top_level_435 true)) (and (= (is_empty temp___expr_434) true) (= (length temp___expr_434) 0))))
