...
(assert (= mixed__get_i__result1 (to_rep (rec__mixed__rec__i (us_split_fields1 r)))))
(assert (= (mk_int__ref mixed__get_i__result4) (mk_int__ref mixed__get_i__result2)))
(assert (= mixed__get_i__result5 mixed__get_i__result3))
(assert (= result1 mixed__get_i__result4))
(assert (not (= mixed__get_i__result4 (to_rep (rec__mixed__rec__i (us_split_fields1 r))))))
(check-sat)
(exit)
