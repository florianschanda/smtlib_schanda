...
(assert (and (= o2 (get (model__ left) o1)) (and (in_range4 o2) (= o2 (get (model__ left) o1)))))
...
(assert (= (mk___split_fields result____split_fields1) amortized_queue__my_vectors__append__2__container__fields1))
(assert (= (length (mk___rep result____split_discrs result____split_fields3)) idx2))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields3)) i) (get (model__ left) i)))))
(assert (and (=> (<= r33b r34b) (dynamic_property r33b r34b idx2)) (and (<= r33b idx2) (<= idx2 r34b))))
(assert (not (= idx2 r34b)))
(assert (= idx2 result2))
(assert (= idx3 (+ idx2 1)))
(assert (not (in_range3 idx3)))
(check-sat)
(exit)
