...
(define-fun default_initial_assumption ((temp___expr_654 us_rep2) (temp___skip_top_level_655 Bool)) Bool (=> (not (= temp___skip_top_level_655 true)) (and (= (is_empty temp___expr_654) true) (= (length temp___expr_654) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 container1)))) (dynamic_invariant2 result true false true true))) :pattern ((length1 container1)))))
...
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant2 (length3 container1) true false true true) :pattern ((length3 container1)))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness1 container1 result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true true) (= (has_witness1 container1 witness2) true)) (dynamic_invariant (w_get container1 witness2) true false true true)) :pattern ((w_get container1 witness2))))))
(declare-const position__split_fields count_type)
(declare-const o count_type)
(declare-const o1 count_type)
(declare-const temp___963 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___963 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___963)) no_element))
