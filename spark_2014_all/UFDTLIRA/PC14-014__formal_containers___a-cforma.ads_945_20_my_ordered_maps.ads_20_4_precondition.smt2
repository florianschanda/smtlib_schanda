...
(define-fun dynamic_invariant ((temp___expr_587 Int) (temp___is_init_584 Bool) (temp___skip_constant_585 Bool) (temp___do_toplevel_586 Bool)) Bool (=> (or (= temp___is_init_584 true) (<= 1 2147483647)) (in_range2 temp___expr_587)))
...
(define-fun default_initial_assumption ((temp___expr_594 us_rep2) (temp___skip_top_level_595 Bool)) Bool (=> (not (= temp___skip_top_level_595 true)) (and (= (is_empty temp___expr_594) true) (= (length temp___expr_594) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 container1)))) (dynamic_invariant2 result true false true))) :pattern ((length1 container1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_541 us_rep4) (temp___skip_top_level_542 Bool)) Bool (=> (not (= temp___skip_top_level_542 true)) (and (= (is_empty1 temp___expr_541) true) (= (length3 temp___expr_541) 0))))
...
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (of_int 1) true) (=> (exists ((k us_rep3)) (and (= (has_key1 container1 k) true) (= (equivalent_keys k key) true))) (= (has_key1 container1 key) true))) :pattern ((has_key1 container1 key))))))
...
(define-fun dynamic_invariant3 ((temp___expr_534 Int) (temp___is_init_531 Bool) (temp___skip_constant_532 Bool) (temp___do_toplevel_533 Bool)) Bool (=> (or (= temp___is_init_531 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_534)))
...
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key1 container1 key) true) (let ((result (get1 container1 key))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container1 (witness1 container1 key))) (forall ((k us_rep3)) (=> (= (has_key1 container1 k) true) (= (= (equivalent_keys k key) true) (= (witness1 container1 key) (witness1 container1 k))))))) (dynamic_invariant3 result true false true)))) :pattern ((get1 container1 key))))))
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant2 (length3 container1) true false true) :pattern ((length3 container1)))))
...
(assert true)
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key1 container1 key) true) (let ((result (witness1 container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness1 container1 key))))))
(assert (forall ((container1 us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant3 (w_get1 container1 witness2) true false true)) :pattern ((w_get1 container1 witness2))))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness1 container1 result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true) (= (has_witness1 container1 witness2) true)) (dynamic_invariant (w_get container1 witness2) true false true)) :pattern ((w_get container1 witness2))))))
(declare-const position__split_fields count_type)
(declare-const o count_type)
(declare-const o1 count_type)
(declare-const temp___896 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___896 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___896)) no_element))
