...
(assert true)
(assert true)
(assert (forall ((x us_rep2)) (! (= (ite (is_zero x) 1 0) (ite (is_zero1 us_tag2 x) 1 0)) :pattern ((is_zero1 us_tag2 x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (! (= (ite (is_zero (of_base1 (to_base x))) 1 0) (ite (is_zero3 us_tag2 x) 1 0)) :pattern ((is_zero3 us_tag2 x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (ite (is_zero (of_base1 x)) 1 0) (ite (is_zero5 us_tag2 x) 1 0)) :pattern ((is_zero5 us_tag2 x)))))
(assert (forall ((x us_rep)) (! (= (ite (is_zero2 (of_base x)) 1 0) (ite (is_zero5 us_tag1 x) 1 0)) :pattern ((is_zero5 us_tag1 x)))))
...
(assert (and (= (to_rep x__split_fields1) 0) (and (= (to_rep x__split_fields2) 0) (= (to_rep x__split_fields) 0))))
(assert (not (= (is_zero (mk___rep2 (mk___split_fields2 x__split_fields x__split_fields1 x__split_fields2 x__split_fields3) x__attr__tag)) true)))
(check-sat)
(exit)
