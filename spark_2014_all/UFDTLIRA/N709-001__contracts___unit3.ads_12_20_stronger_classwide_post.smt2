...
(declare-fun is_zero (us_rep2) Bool)
(declare-fun is_zero__function_guard (Bool us_rep2) Bool)
(declare-fun is_zero1 (Int us_rep2) Bool)
(declare-fun is_zero__function_guard1 (Bool Int us_rep2) Bool)
...
(assert true)
(assert true)
(assert (forall ((x us_rep2)) (! (= (to_int1 (is_zero x)) (to_int1 (is_zero1 us_tag2 x))) :pattern ((is_zero1 us_tag2 x)))))
(assert (forall ((x us_rep2)) (! (= (= (is_zero x) true) (and (= (is_zero2 (of_base (to_base1 x))) true) (= (to_rep (rec__unit3__t3__c3 (us_split_fields5 x))) 0))) :pattern ((is_zero x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (! (= (to_int1 (is_zero (of_base1 (to_base x)))) (to_int1 (is_zero3 us_tag2 x))) :pattern ((is_zero3 us_tag2 x)))))
(assert (forall ((x us_rep1)) (! (= (to_int1 (is_zero2 x)) (to_int1 (is_zero3 us_tag1 x))) :pattern ((is_zero3 us_tag1 x)))))
(assert (forall ((x us_rep1)) (! (= (= (is_zero2 x) true) (and (= (is_zero4 (to_base x)) true) (= (to_rep (rec__unit2__t2__c2 (us_split_fields3 x))) 0))) :pattern ((is_zero2 x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (to_int1 (is_zero (of_base1 x))) (to_int1 (is_zero5 us_tag2 x))) :pattern ((is_zero5 us_tag2 x)))))
(assert (forall ((x us_rep)) (! (= (to_int1 (is_zero2 (of_base x))) (to_int1 (is_zero5 us_tag1 x))) :pattern ((is_zero5 us_tag1 x)))))
(assert (forall ((x us_rep)) (! (= (to_int1 (is_zero4 x)) (to_int1 (is_zero5 us_tag x))) :pattern ((is_zero5 us_tag x)))))
...
(declare-const x__split_fields6 us_private)
(assert (and (= (to_rep x__split_fields4) 0) (and (= (to_rep x__split_fields5) 0) (= (to_rep x__split_fields3) 0))))
(assert (not (= (is_zero (mk___rep2 (mk___split_fields2 x__split_fields3 x__split_fields4 x__split_fields5 x__split_fields6) x__attr__tag)) true)))
(check-sat)
(exit)
