...
(assert (and (= o2 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o2 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep2)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq2 i j) true))))))))))
(assert (and (= result (has_key o2 fst)) (=> (= (distinct 0 0) true) (=> (exists ((k us_rep2)) (and (= (has_key o2 k) true) (= (bool_eq2 k fst) true))) (= result true)))))
(assert (= result true))
...
(assert (and (= result1 (has_key o1 lst)) (=> (= (distinct 0 0) true) (=> (exists ((k us_rep2)) (and (= (has_key o1 k) true) (= (bool_eq2 k lst) true))) (= result1 true)))))
(assert (= result1 true))
