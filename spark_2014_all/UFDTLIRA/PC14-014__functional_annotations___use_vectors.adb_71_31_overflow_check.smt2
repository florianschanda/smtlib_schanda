...
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= temp___509 current1)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (forall ((i Int)) (=> (and (<= first3 i) (<= i (- current2 1))) (not (= (get (model__ v) i) e))))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (and (=> (<= first3 r27b) (dynamic_property5 first3 r27b current2)) (and (<= first3 current2) (<= current2 r27b)))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (and (= us current2) (dynamic_property2 first1 last3 current2))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= o1 current2)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (and (= o2 (get (model__ v) o1)) (and (in_range3 o2) (= o2 (get (model__ v) o1))))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= result2 (ite (= o2 e) true false))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (not (= result2 true))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= use_vectors__my_find__result3 use_vectors__my_find__result2)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= current2 r27b)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= use_vectors__my_find__result3 use_vectors__my_find__result4)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= current2 current3)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= use_vectors__my_find__result5 use_vectors__my_find__result3)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= current4 current2)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= use_vectors__my_find__result8 (mk_int__ref use_vectors__my_find__result4))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= (mk_int__ref current5) (mk_int__ref current3))))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= use_vectors__my_find__result7 use_vectors__my_find__result5)))
(assert (=> (and (<= first3 current1) (<= current1 r27b)) (= current6 current4)))
(assert (=> (not (and (<= first3 current1) (<= current1 r27b))) (= use_vectors__my_find__result8 (mk_int__ref use_vectors__my_find__result))))
(assert (=> (not (and (<= first3 current1) (<= current1 r27b))) (= current1 current5)))
(assert (=> (not (and (<= first3 current1) (<= current1 r27b))) (= use_vectors__my_find__result7 use_vectors__my_find__result1)))
(assert (=> (not (and (<= first3 current1) (<= current1 r27b))) (= current6 current1)))
(assert (not (in_range1 (- first3 1))))
(check-sat)
(exit)
