...
(assert (forall ((x enum1t)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x enum1t)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 4)) (in_range5 temp___expr_246)))
(declare-fun to_rep5 (enum1ta) Int)
(declare-fun of_rep5 (Int) enum1ta)
(assert (forall ((x enum1ta)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x enum1ta)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (bool_eq2 (rec__ar__rec4t__f4 (us_split_fields7 a)) (rec__ar__rec4t__f4 (us_split_fields7 b))) true) (= (to_rep4 (rec__ar__rec4t__g4 (us_split_fields7 a))) (to_rep4 (rec__ar__rec4t__g4 (us_split_fields7 b))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 1 25)) (in_range1 temp___expr_211)))
...
(define-fun dynamic_invariant4 ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 50 59)) (in_range3 temp___expr_225)))
(define-fun dynamic_invariant5 ((temp___expr_232 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 6)) (in_range4 temp___expr_232)))
...
(declare-const temp___7314 us_rep3)
(declare-const o17 enum1t)
(declare-const o18 us_split_fields6)
(declare-const temp___7316 us_rep3)
...
(assert (in_range5 (to_rep4 r__split_fields5)))
(assert (=> (<= 1 4) (in_range5 temp)))
(assert (= result (mk_int__ref temp)))
(assert (= temp1 (to_rep5 r__split_fields3)))
(assert (and (= o (to_rep4 r__split_fields5)) (in_range5 (to_rep4 r__split_fields5))))
(assert (= (to_rep5 o1) o))
...
(assert (= temp___7314 (mk___rep3 o16)))
...
(assert (= r__split_fields6 (us_split_fields7 temp___7314)))
(assert (= (to_rep4 o17) temp1))
(assert (= o18 (mk___split_fields3 (rec__ar__rec4t__f4 r__split_fields6) o17)))
(assert (= temp___7316 (mk___rep3 o18)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7316)))
...
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 (us_split_fields__content3 r__split_fields8))))))) (to_rep2 r__split_fields))))
(check-sat)
(exit)
