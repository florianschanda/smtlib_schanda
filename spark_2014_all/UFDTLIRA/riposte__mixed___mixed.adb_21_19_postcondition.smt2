...
(assert (= (mk___rep (mk___split_fields mixed__id__result9 mixed__id__result10 mixed__id__result11)) (mk___rep (mk___split_fields mixed__id__result3 mixed__id__result4 mixed__id__result5))))
(assert (= result mixed__id__result))
(assert (= result1 mixed__id__result1))
(assert (= result2 mixed__id__result2))
(assert (= (mk___rep (mk___split_fields mixed__id__result3 mixed__id__result4 mixed__id__result5)) r))
