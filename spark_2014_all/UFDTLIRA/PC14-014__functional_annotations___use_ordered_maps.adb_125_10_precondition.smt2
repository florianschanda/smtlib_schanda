...
(assert (not (or (< (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) (to_rep (rec__use_ordered_maps__my_maps__map__capacity s1__split_discrs))) (= (has_key (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) o20) true))))
(check-sat)
(exit)
