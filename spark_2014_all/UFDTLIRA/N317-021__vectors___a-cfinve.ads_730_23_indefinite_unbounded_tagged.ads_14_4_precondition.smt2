...
(define-fun dynamic_invariant ((temp___expr_232 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= 1 2147483647)) (in_range2 temp___expr_232)))
...
(define-fun oeq ((left us_rep2) (right us_rep2)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (let ((temp___133 (get right n))) (let ((temp___132 (get left n))) (and (ite (= (attr__tag temp___132) (attr__tag temp___133)) true false) (us_dispatch_eq temp___132 temp___133)))) true))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (=> (not (= temp___skip_top_level_281 true)) (= (length temp___expr_280) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_242 Int) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool)) Bool (=> (or (= temp___is_init_239 true) (<= 0 2147483647)) (in_range4 temp___expr_242)))
...
(define-fun dynamic_invariant3 ((temp___expr_211 Int) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (or (= temp___is_init_208 true) (<= 0 2147483647)) (in_range5 temp___expr_211)))
(define-fun dynamic_invariant4 ((temp___expr_248 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483647)) (in_range3 temp___expr_248)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (of_int 0) true) (to_rep1 (rec__indefinite_unbounded_tagged__vect__vector__capacity (us_split_discrs1 container1))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep1) Bool)
(assert (forall ((container1 us_rep1)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant4 result true false true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_273 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 2147483647)) (in_range6 temp___expr_273)))
