...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep1 (rec__indefinite_unbounded_tagged__vect__vector__capacity (us_split_discrs1 container1))) 2147483647))
