...
(define-fun default_initial_assumption ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__p__po_type__content (us_split_fields1 temp___expr_201))) 0))
