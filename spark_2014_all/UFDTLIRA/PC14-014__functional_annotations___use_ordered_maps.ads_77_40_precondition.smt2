...
(assert (= (= o6 true) (let ((temp___795 (keys s2))) (forall ((temp___794 Int)) (=> (and (in_range5 temp___794) (= (iter_has_element temp___795 temp___794) true)) (= (prop__ (get (model__ s2) (get1 temp___795 temp___794))) true))))))
