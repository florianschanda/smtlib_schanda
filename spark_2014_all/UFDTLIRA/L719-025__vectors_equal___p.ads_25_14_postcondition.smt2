...
(assert (and (and (and (and (= (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)) (copy (mk___rep l__split_discrs (mk___split_fields l__split_fields)) 0)) (and (= (oeq (model__ (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) (= (to_rep p__identity_swap__l_in__assume) (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))) (= (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)) l_in)) (and (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) i1 i2) true) (and (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) i1) (get (model__ l_in) i2)) (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) i1 i2) true)))) (and (= l__split_fields3 l__split_fields2) (= (mk___split_fields l__split_fields4) (mk___split_fields l__split_fields2)))))
