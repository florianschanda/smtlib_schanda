...
(assert (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6)) i1 i2) true))
(assert (= (get (model__ (mk___rep l__split_discrs l__split_fields6)) i1) (get (model__ l_in) i2)))
(assert (= (m_elements_swapped (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields5)) i1 i2) true))
