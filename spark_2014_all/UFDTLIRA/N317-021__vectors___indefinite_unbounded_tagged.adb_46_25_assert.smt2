...
(assert (not (= (let ((temp___610 (f 2))) (let ((temp___609 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 2))) (ite (= (attr__tag temp___609) (attr__tag temp___610)) (us_dispatch_eq temp___609 temp___610) false))) true)))
(check-sat)
(exit)
