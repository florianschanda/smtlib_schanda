...
(assert (let ((temp___448 (keys s))) (forall ((temp___447 Int)) (=> (and (in_range3 temp___447) (= (iter_has_element temp___448 temp___447) true)) (exists ((i1 us_rep1)) (and (= (has_key1 (positions s) i1) true) (= (get (keys s) (get1 (positions s) i1)) (get temp___448 temp___447))))))))
