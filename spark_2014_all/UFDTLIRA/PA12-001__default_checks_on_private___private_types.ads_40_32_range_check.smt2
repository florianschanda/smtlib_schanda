...
(define-fun default_initial_assumption ((temp___expr_193 us_rep) (temp___skip_top_level_194 Bool)) Bool (and (= (attr__constrained temp___expr_193) false) (and (= (rec__private_types__p3__t__d (us_split_discrs1 temp___expr_193)) (distinct 0 0)) (=> (private_types__p3__t__f__pred temp___expr_193) (= (to_rep (rec__private_types__p3__t__f (us_split_fields1 temp___expr_193))) (id 0))))))
(declare-const temp___236 Bool)
(declare-const temp___235 Bool)
(declare-const o Int)
(assert (= temp___236 temp___235))
(assert (= (ite temp___235 1 0) 1))
