...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__unbounded__vect__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 0 2147483647)) (in_range temp___expr_201)))
...
(define-fun dynamic_invariant1 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range2 temp___expr_195)))
...
(assert (forall ((source us_rep)) (forall ((capacity1 Int)) (! (=> (and (dynamic_invariant capacity1 true true true) (=> (= (of_int 0) true) (or (= capacity1 0) (<= (length source) capacity1)))) (let ((result (copy source capacity1))) (and (= (oeq1 (model__ result) (model__ source)) true) (ite (= capacity1 0) (= (to_rep (rec__unbounded__vect__vector__capacity (us_split_discrs1 result))) (length source)) (= (to_rep (rec__unbounded__vect__vector__capacity (us_split_discrs1 result))) capacity1))))) :pattern ((copy source capacity1))))))
...
(define-fun dynamic_invariant2 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 1 2147483647)) (in_range3 temp___expr_183)))
...
(define-fun dynamic_invariant3 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_189)))
...
(assert (forall ((container us_rep)) (forall ((item Int) (index Int)) (! (=> (and (dynamic_invariant3 item true true true) (dynamic_invariant2 index true true true)) (let ((result (find_index container item index))) (and (ite (or (< (last_index container) index) (not (= (contains (model__ container) index (last_index container) item) true))) (= result 0) (and (and (and (<= index result) (<= result (last_index container))) (= (get (model__ container) result) item)) (not (= (contains (model__ container) index (- result 1) item) true)))) (dynamic_invariant1 result true false true)))) :pattern ((find_index container item index))))))
(declare-fun reverse_find_index (us_rep Int Int) Int)
(declare-fun reverse_find_index__function_guard (Int us_rep Int Int) Bool)
(assert (forall ((container us_rep)) (forall ((item Int) (index Int)) (! (=> (and (dynamic_invariant3 item true true true) (dynamic_invariant2 index true true true)) (let ((result (reverse_find_index container item index))) (and (ite (not (= (contains (model__ container) 1 (ite (<= index (last_index container)) index (last_index container)) item) true)) (= result 0) (and (and (and (and (<= 1 result) (<= result index)) (<= result (last_index container))) (= (get (model__ container) result) item)) (not (= (contains (model__ container) (+ result 1) (ite (<= index (last_index container)) index (last_index container)) item) true)))) (dynamic_invariant1 result true false true)))) :pattern ((reverse_find_index container item index))))))
(declare-fun contains1 (us_rep Int) Bool)
(declare-fun contains__function_guard1 (Bool us_rep Int) Bool)
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true) (= (= (contains1 container item) true) (= (contains (model__ container) 1 (last_index container) item) true))) :pattern ((contains1 container item))))))
...
(define-fun in_range5 ((rec__unbounded__vect__vector__capacity1 Int) (a us_rep)) Bool (= rec__unbounded__vect__vector__capacity1 (to_rep (rec__unbounded__vect__vector__capacity (us_split_discrs1 a)))))
...
(declare-const unbounded__vect__vector__capacity__first__bit1 Int)
(declare-const unbounded__vect__vector__capacity__last__bit1 Int)
(declare-const unbounded__vect__vector__capacity__position1 Int)
(assert (<= 0 unbounded__vect__vector__capacity__first__bit1))
(assert (< unbounded__vect__vector__capacity__first__bit1 unbounded__vect__vector__capacity__last__bit1))
(assert (<= 0 unbounded__vect__vector__capacity__position1))
...
(define-fun dynamic_invariant4 ((temp___expr_333 us_rep) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool)) Bool (=> (not (= temp___skip_constant_331 true)) (in_range5 2 temp___expr_333)))
(define-fun default_initial_assumption ((temp___expr_335 us_rep) (temp___skip_top_level_336 Bool)) Bool (and (= (to_rep (rec__unbounded__vect__vector__capacity (us_split_discrs1 temp___expr_335))) 2) (=> (not (= temp___skip_top_level_336 true)) (= (is_empty temp___expr_335) true))))
...
(define-fun dynamic_invariant5 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_15)))
(assert true)
...
(define-fun dynamic_invariant6 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range7 temp___expr_141)))
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq2 a b) (oeq1 a b)) :pattern ((user_eq2 a b)))))
(define-fun default_initial_assumption1 ((temp___expr_235 us_rep1) (temp___skip_top_level_236 Bool)) Bool (=> (not (= temp___skip_top_level_236 true)) (= (length1 temp___expr_235) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 0 2147483647)) (in_range8 temp___expr_228)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_222 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= (- 2147483648) 2147483647)) (in_range9 temp___expr_222)))
...
(declare-const unbounded__test__B_1__w__assume capacity_range)
(declare-const unbounded__test__B_1__w__assume1 us_main_type)
...
(declare-const o12 capacity_range)
(declare-const o13 us_main_type)
...
(declare-const unbounded__vect__clear__container__fields us_main_type)
(declare-const result us_main_type)
(declare-const v__split_fields1 us_main_type)
(declare-const unbounded__vect__append__2__container__fields us_main_type)
(declare-const result1 us_main_type)
(declare-const v__split_fields2 us_main_type)
(declare-const unbounded__vect__append__2__container__fields1 us_main_type)
(declare-const result2 us_main_type)
(declare-const v__split_fields3 us_split_fields)
(declare-const unbounded__vect__append__2__container__fields2 us_split_fields)
(declare-const result3 us_split_fields__ref)
(declare-const v__split_fields4 us_split_fields)
(declare-const unbounded__vect__reserve_capacity__container__fields us_split_fields)
...
(declare-const unbounded__vect__replace_element__container__fields us_split_fields)
(declare-const result6 us_split_fields__ref)
(declare-const v__split_fields6 us_split_fields)
(declare-const unbounded__vect__swap__container__fields us_split_fields)
(declare-const result7 us_split_fields__ref)
(declare-const v__split_fields7 us_split_fields)
(declare-const unbounded__vect__delete_last__container__fields us_split_fields)
(declare-const result8 us_split_fields__ref)
(declare-const v__split_fields8 us_split_fields)
(declare-const unbounded__vect__reverse_elements__container__fields us_split_fields)
(declare-const result9 us_split_fields__ref)
(declare-const v__split_fields9 us_split_fields)
(declare-const unbounded__sort__sort__container__fields us_split_fields)
(declare-const result10 us_split_fields__ref)
(declare-const v__split_fields10 us_split_fields)
(declare-const unbounded__vect__replace_element__container__fields1 us_split_fields)
...
(assert (= 2 (to_rep (rec__unbounded__vect__vector__capacity v__split_discrs))))
(assert (= (length (mk___rep v__split_discrs (mk___split_fields unbounded__vect__clear__container__fields))) 0))
(assert (= result v__split_fields))
(assert (= (mk___split_fields v__split_fields1) (mk___split_fields unbounded__vect__clear__container__fields)))
(assert (= (is_empty (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) true))
(assert (= (oeq (mk___rep v__split_discrs (mk___split_fields v__split_fields1)) (empty_vector Tuple0)) true))
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields unbounded__vect__append__2__container__fields))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) (model__ (mk___rep v__split_discrs (mk___split_fields unbounded__vect__append__2__container__fields)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields unbounded__vect__append__2__container__fields))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1)))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= (mk___split_fields v__split_fields2) (mk___split_fields unbounded__vect__append__2__container__fields)))
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields unbounded__vect__append__2__container__fields1))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) (model__ (mk___rep v__split_discrs (mk___split_fields unbounded__vect__append__2__container__fields1)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields unbounded__vect__append__2__container__fields1))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))) 1)) 2)))
(assert (= result2 v__split_fields2))
(assert (= v__split_fields3 (mk___split_fields unbounded__vect__append__2__container__fields1)))
(assert (and (and (= (length (mk___rep v__split_discrs unbounded__vect__append__2__container__fields2)) (+ (length (mk___rep v__split_discrs v__split_fields3)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields3)) (model__ (mk___rep v__split_discrs unbounded__vect__append__2__container__fields2))) true)) (= (get (model__ (mk___rep v__split_discrs unbounded__vect__append__2__container__fields2)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields3))) 1)) 3)))
(assert (= result3 (mk___split_fields__ref v__split_fields3)))
(assert (= v__split_fields4 unbounded__vect__append__2__container__fields2))
...
(assert (= (oeq1 (model__ (mk___rep v__split_discrs unbounded__vect__reserve_capacity__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields4))) true))
(assert (= result4 (mk___split_fields__ref v__split_fields4)))
(assert (= v__split_fields5 unbounded__vect__reserve_capacity__container__fields))
...
(assert (and (= (mk___rep (mk___split_discrs unbounded__test__B_1__w__assume) (mk___split_fields unbounded__test__B_1__w__assume1)) (copy (mk___rep v__split_discrs v__split_fields5) 0)) (and (= (oeq1 (model__ (mk___rep (mk___split_discrs unbounded__test__B_1__w__assume) (mk___split_fields unbounded__test__B_1__w__assume1))) (model__ (mk___rep v__split_discrs v__split_fields5))) true) (= (to_rep unbounded__test__B_1__w__assume) (length (mk___rep v__split_discrs v__split_fields5))))))
(assert (= result5 (mk___split_fields__ref (mk___split_fields w__split_fields))))
(assert (= w__split_fields1 (mk___split_fields unbounded__test__B_1__w__assume1)))
(assert (= w__split_discrs (mk___split_discrs unbounded__test__B_1__w__assume)))
...
(assert (and (= (mk___rep (mk___split_discrs o12) (mk___split_fields o13)) (empty_vector Tuple0)) (= (length (mk___rep (mk___split_discrs o12) (mk___split_fields o13))) 0)))
(assert (= (oeq1 (model__ (mk___rep w__split_discrs w__split_fields3)) (model__ (mk___rep (mk___split_discrs o12) (mk___split_fields o13)))) true))
...
(assert (and (and (= (length (mk___rep v__split_discrs unbounded__vect__replace_element__container__fields)) (length (mk___rep v__split_discrs v__split_fields5))) (= (get (model__ (mk___rep v__split_discrs unbounded__vect__replace_element__container__fields)) 2) 4)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields5)) (model__ (mk___rep v__split_discrs unbounded__vect__replace_element__container__fields)) 2) true)))
(assert (= result6 (mk___split_fields__ref v__split_fields5)))
(assert (= v__split_fields6 unbounded__vect__replace_element__container__fields))
...
(assert (= (m_elements_swapped (model__ (mk___rep v__split_discrs v__split_fields6)) (model__ (mk___rep v__split_discrs unbounded__vect__swap__container__fields)) 1 3) true))
(assert (= result7 (mk___split_fields__ref v__split_fields6)))
(assert (= v__split_fields7 unbounded__vect__swap__container__fields))
...
(assert (and (= (length (mk___rep v__split_discrs unbounded__vect__delete_last__container__fields)) (- (length (mk___rep v__split_discrs v__split_fields7)) 1)) (= (olt (model__ (mk___rep v__split_discrs unbounded__vect__delete_last__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields7))) true)))
(assert (= result8 (mk___split_fields__ref v__split_fields7)))
(assert (= v__split_fields8 unbounded__vect__delete_last__container__fields))
...
(assert (= (get (model__ (mk___rep v__split_discrs v__split_fields8)) 1) 3))
(assert (= (get (model__ (mk___rep v__split_discrs v__split_fields8)) 2) 4))
(assert (= (m_elements_reversed (model__ (mk___rep v__split_discrs v__split_fields8)) (model__ (mk___rep v__split_discrs unbounded__vect__reverse_elements__container__fields))) true))
(assert (= result9 (mk___split_fields__ref v__split_fields8)))
(assert (= v__split_fields9 unbounded__vect__reverse_elements__container__fields))
...
(assert (= (get (model__ (mk___rep v__split_discrs v__split_fields9)) 1) 4))
(assert (= (get (model__ (mk___rep v__split_discrs v__split_fields9)) 2) 3))
(assert true)
...
(assert (= (find_index (mk___rep v__split_discrs v__split_fields9) 0 1) 0))
(assert (= (find_index (mk___rep v__split_discrs v__split_fields9) 4 1) 1))
(assert (= (find_index (mk___rep v__split_discrs v__split_fields9) 4 2) 0))
(assert (= (reverse_find_index (mk___rep v__split_discrs v__split_fields9) 0 2147483647) 0))
(assert (= (reverse_find_index (mk___rep v__split_discrs v__split_fields9) 4 2147483647) 1))
(assert (= (reverse_find_index (mk___rep v__split_discrs v__split_fields9) 4 2) 1))
(assert (= (contains1 (mk___rep v__split_discrs v__split_fields9) 4) true))
(assert (not (= (contains1 (mk___rep v__split_discrs v__split_fields9) 0) true)))
