...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__my_lists__my_lists__cursor__node (us_split_fields3 a))) (to_rep (rec__my_lists__my_lists__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__my_lists__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(assert (forall ((i element_type1)) (and (<= 0 (element_typeqtint1 i)) (<= (element_typeqtint1 i) 100))))
...
(define-fun dynamic_invariant2 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 100)) (in_range3 temp___expr_221)))
(define-fun default_initial_assumption3 ((temp___expr_235 us_rep2) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__my_lists__my_lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(assert (forall ((i element_type2)) (and (<= 0 (element_typeqtint2 i)) (<= (element_typeqtint2 i) 100))))
...
(define-fun dynamic_invariant4 ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 100)) (in_range5 temp___expr_257)))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 container)))))))
