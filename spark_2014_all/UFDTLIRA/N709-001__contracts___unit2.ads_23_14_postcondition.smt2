...
(assert (forall ((unit1__bump__x__fields us_split_fields) (unit1__bump__x__old__fields us_split_fields)) (forall ((x__attr__tag Int)) (! (=> (bump__specific_post us_tag1 unit1__bump__x__fields x__attr__tag unit1__bump__x__old__fields) (let ((temp___x_147 (of_base (mk___rep unit1__bump__x__old__fields x__attr__tag)))) (let ((temp___x_1471 (of_base (mk___rep unit1__bump__x__fields x__attr__tag)))) (and (= (to_rep (rec__unit1__t1__c11 (us_split_fields3 temp___x_1471))) (+ (to_rep (rec__unit1__t1__c11 (us_split_fields3 temp___x_147))) 1)) (= (to_rep (rec__unit2__t2__c2 (us_split_fields3 temp___x_1471))) (+ (to_rep (rec__unit2__t2__c2 (us_split_fields3 temp___x_147))) 1)))))) :pattern ((bump__specific_post us_tag1 unit1__bump__x__fields x__attr__tag unit1__bump__x__old__fields))))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (to_int1 (is_max2 (of_base x))) (to_int1 (is_max1 us_tag1 x))) :pattern ((is_max1 us_tag1 x)))))
(assert (forall ((x us_rep)) (! (= (to_int1 (is_max x)) (to_int1 (is_max1 us_tag x))) :pattern ((is_max1 us_tag x)))))
...
(declare-const temp___1752 us_private)
...
(assert (= temp___175 o2))
(assert (= temp___1751 o3))
(assert (= temp___1752 o4))
(assert (= x__attr__tag temp___1753))
(assert (= result3 x__split_fields3))
(assert (= result4 x__split_fields4))
(assert (= result5 x__split_fields5))
(assert (= temp___175 x__split_fields6))
(assert (= temp___1751 x__split_fields7))
(assert (= temp___1752 x__split_fields8))
...
(assert (not (= (to_rep x__split_fields10) (+ (to_rep x__split_fields1) 1))))
(check-sat)
(exit)
