...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 a))) (to_rep (rec__ar__rec1t__f1 (us_split_fields1 b)))) (= (to_rep3 (rec__ar__rec1t__g1 (us_split_fields1 a))) (to_rep3 (rec__ar__rec1t__g1 (us_split_fields1 b))))) true false))
...
(declare-const temp___6833 et3)
(declare-const temp___68331 et1)
(declare-const temp___68332 et2)
(declare-const temp___68333 enum1ta)
...
(assert (= temp___6833 o5))
(assert (= temp___68331 o6))
(assert (= temp___68332 o7))
(assert (= temp___68333 o8))
...
(assert (= r__split_fields8 (mk___split_fields1 temp___6833 (mk___rep (mk___split_fields temp___68331 temp___68332)) temp___68333)))
(assert (= r__split_fields9 (mk___split_fields__ref1 r__split_fields8)))
(assert (= r__split_fields10 r__split_fields8))
(assert (not (= (to_rep1 (rec__ar__rec2t__f2 (us_split_fields__content1 r__split_fields9))) (to_rep1 r__split_fields))))
(check-sat)
(exit)
