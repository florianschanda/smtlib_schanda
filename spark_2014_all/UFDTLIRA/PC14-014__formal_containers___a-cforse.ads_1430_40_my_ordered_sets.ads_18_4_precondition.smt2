...
(define-fun e_is_find ((container1 us_rep2) (item1 us_rep) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item1) (of_int 1)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item1) (of_int 1))))
...
(assert (forall ((container1 us_rep2)) (forall ((item1 us_rep)) (! (let ((result (find container1 item1))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item1 (get container1 result)) true))) (dynamic_invariant result true false true))) :pattern ((find container1 item1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_559 us_rep3) (temp___skip_top_level_560 Bool)) Bool (=> (not (= temp___skip_top_level_560 true)) (= (is_empty2 temp___expr_559) true)))
...
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((item1 us_rep)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep)) (and (= (contains container1 e) true) (= (equivalent_elements e item1) true))) (= (contains container1 item1) true))) :pattern ((contains container1 item1))))))
...
(define-fun dynamic_invariant3 ((temp___expr_585 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 2147483647)) (in_range4 temp___expr_585)))
...
(assert (and (= o2 (length container)) (and (in_range3 o2) (<= o2 (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container)))))))
