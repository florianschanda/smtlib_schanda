...
(define-fun my_lt ((x us_rep) (y us_rep)) Bool (< (to_rep (rec__my_ordered_sets__my_rec__f (us_split_fields1 x))) (to_rep (rec__my_ordered_sets__my_rec__f (us_split_fields1 y)))))
...
(define-fun e_bigger_than_range ((container us_rep2) (fst Int) (lst Int) (item us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get container i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep2 Int Int us_rep) Bool)
...
(assert (forall ((container us_rep1)) (! (=> (not (= (is_empty container) true)) (let ((result (last_element container))) (and (= (bool_eq result (get (elements container) (length container))) true) (= (e_bigger_than_range (elements container) 1 (- (length container) 1) result) true)))) :pattern ((last_element container)))))
(assert true)
...
(define-fun e_smaller_than_range ((container1 us_rep2) (fst Int) (lst Int) (item1 us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item1 (get container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep2 Int Int us_rep) Bool)
(define-fun e_is_find ((container1 us_rep2) (item1 us_rep) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item1) (distinct 1 0)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item1) (distinct 1 0))))
...
(define-fun default_initial_assumption ((temp___expr_645 us_rep2) (temp___skip_top_level_646 Bool)) Bool (=> (not (= temp___skip_top_level_646 true)) (= (length2 temp___expr_645) 0)))
(declare-fun find (us_rep2 us_rep) Int)
(declare-fun find__function_guard (Int us_rep2 us_rep) Bool)
(assert (forall ((container1 us_rep2)) (forall ((item1 us_rep)) (! (let ((result (find container1 item1))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item1 (get container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item1))))))
(define-fun e_elements_included ((left us_rep2) (right us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 left))) (and (< 0 (find right (get left i))) (= (bool_eq (get right (find right (get left i))) (get left i)) true)))) true false))
...
(define-fun set__ref___4__projection ((a set__ref1)) us_rep3 (set__content1 a))
(declare-fun is_empty2 (us_rep3) Bool)
(declare-fun is_empty__function_guard2 (Bool us_rep3) Bool)
(define-fun default_initial_assumption1 ((temp___expr_607 us_rep3) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty2 temp___expr_607) true)))
...
(assert (forall ((container1 us_rep1)) (! (= (length3 (model__ container1)) (length container1)) :pattern ((model__ container1)))))
...
(assert (forall ((container1 us_rep1)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length container1)) (forall ((temp___683 Int)) (=> (and (in_range4 temp___683) (= (iter_has_element result temp___683) true)) (= (contains (model__ container1) (get result temp___683)) true)))) (forall ((item1 us_rep)) (=> (= (contains (model__ container1) item1) true) (and (< 0 (find result item1)) (= (equivalent_elements (get result (find result item1)) item1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
(assert (forall ((left us_rep1) (right us_rep1)) (! (ite (= (oeq left right) true) (= (oeq2 (elements left) (elements right)) true) (or (not (= (e_elements_included (elements left) (elements right)) true)) (not (= (e_elements_included (elements right) (elements left)) true)))) :pattern ((oeq left right)))))
(assert true)
(assert (forall ((container1 us_rep1)) (! (= (= (is_empty container1) true) (= (length container1) 0)) :pattern ((is_empty container1)))))
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((item1 us_rep)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep)) (and (= (contains container1 e) true) (= (equivalent_elements e item1) true))) (= (contains container1 item1) true))) :pattern ((contains container1 item1))))))
(assert (forall ((container1 us_rep3)) (! (dynamic_invariant (length3 container1) true false true true) :pattern ((length3 container1)))))
(assert (forall ((container1 us_rep3)) (! (let ((result (is_empty2 container1))) (and (= (= result true) (forall ((item1 us_rep)) (not (= (contains container1 item1) true)))) (= (= result true) (= (length3 container1) 0)))) :pattern ((is_empty2 container1)))))
(define-fun dynamic_invariant3 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= 0 2147483647)) (in_range4 temp___expr_637)))
(assert (forall ((container1 us_rep2)) (! (let ((result (length2 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true true))) :pattern ((length2 container1)))))
(assert true)
(declare-const o Int)
(declare-const result Bool)
(assert (and (= o (length container)) (and (in_range3 o) (<= o (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container)))))))
