...
(define-fun e_is_find ((container1 us_rep2) (item1 us_rep) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item1) (distinct 1 0)) (ite (< position (length1 container1)) (e_smaller_than_range container1 (+ position 1) (length1 container1) item1) (distinct 1 0))))
...
(assert (forall ((container1 us_rep2)) (forall ((item1 us_rep)) (! (let ((result (find container1 item1))) (and (=> (< 0 result) (and (<= result (length1 container1)) (= (equivalent_elements item1 (get container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item1))))))
(define-fun e_elements_included ((left us_rep2) (right us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 left))) (and (< 0 (find right (get left i))) (= (bool_eq (get right (find right (get left i))) (get left i)) true)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_607 us_rep3) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty1 temp___expr_607) true)))
(assert (forall ((container1 us_rep1)) (! (= (length2 (model__ container1)) (length container1)) :pattern ((model__ container1)))))
...
(assert (forall ((container1 us_rep3)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item1 us_rep)) (not (= (contains container1 item1) true)))) (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty1 container1)))))
