...
(assert (not (or (and (<= 1 o13) (<= o13 (last (model__ (mk___rep l__split_discrs l__split_fields22))))) (and (not (= o13 0)) (= (- o13 1) (last (model__ (mk___rep l__split_discrs l__split_fields22))))))))
(check-sat)
(exit)
