...
(define-fun dynamic_invariant ((temp___expr_345 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range1 temp___expr_345)))
...
(define-fun dynamic_invariant1 ((temp___expr_351 Int) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool (=> (or (= temp___is_init_348 true) (<= 1 2147483647)) (in_range2 temp___expr_351)))
...
(define-fun dynamic_invariant3 ((temp___expr_357 Int) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool)) Bool (=> (or (= temp___is_init_354 true) (<= 0 2147483647)) (in_range5 temp___expr_357)))
