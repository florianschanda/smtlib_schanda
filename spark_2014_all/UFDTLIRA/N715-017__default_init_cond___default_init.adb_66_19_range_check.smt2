...
(define-fun default_init__discr__f__pred ((a us_rep)) Bool (= (ite (rec__default_init__discr__b (us_split_discrs1 a)) 1 0) 1))
...
(define-fun default_init__mut_discr__f__pred ((a us_rep1)) Bool (= (ite (rec__default_init__mut_discr__b (us_split_discrs3 a)) 1 0) 1))
...
(define-fun default_initial_assumption ((temp___expr_254 us_rep1) (temp___skip_top_level_255 Bool)) Bool (and (and (= (attr__constrained temp___expr_254) false) (and (= (rec__default_init__mut_discr__b (us_split_discrs3 temp___expr_254)) (distinct 0 0)) (=> (default_init__mut_discr__f__pred temp___expr_254) (= (to_rep (rec__default_init__mut_discr__f (us_split_fields3 temp___expr_254))) (init 0))))) (=> (not (= temp___skip_top_level_255 true)) (= (mut_discr_ok temp___expr_254) true))))
...
(define-fun dynamic_invariant1 ((temp___expr_270 us_rep) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (not (= temp___skip_constant_267 true)) (in_range2 (distinct 1 0) temp___expr_270)))
(define-fun default_initial_assumption1 ((temp___expr_272 us_rep) (temp___skip_top_level_273 Bool)) Bool (and (and (= (rec__default_init__discr__b (us_split_discrs1 temp___expr_272)) (distinct 1 0)) (=> (default_init__discr__f__pred temp___expr_272) (= (to_rep (rec__default_init__discr__f (us_split_fields1 temp___expr_272))) 0))) (=> (not (= temp___skip_top_level_273 true)) (= (discr_ok temp___expr_272) true))))
...
(define-fun dynamic_invariant2 ((temp___expr_280 us_rep) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (not (= temp___skip_constant_277 true)) (in_range3 (distinct 0 0) temp___expr_280)))
(define-fun default_initial_assumption2 ((temp___expr_282 us_rep) (temp___skip_top_level_283 Bool)) Bool (and (and (= (rec__default_init__discr__b (us_split_discrs1 temp___expr_282)) (distinct 0 0)) (=> (default_init__discr__f__pred temp___expr_282) (= (to_rep (rec__default_init__discr__f (us_split_fields1 temp___expr_282))) 0))) (=> (not (= temp___skip_top_level_283 true)) (= (discr_ok temp___expr_282) true))))
...
(define-fun dynamic_invariant3 ((temp___expr_290 us_rep1) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool) (temp___do_typ_inv_289 Bool)) Bool (and (=> (not (= temp___skip_constant_287 true)) (in_range4 (distinct 0 0) temp___expr_290)) (= (attr__constrained temp___expr_290) true)))
(define-fun default_initial_assumption3 ((temp___expr_292 us_rep1) (temp___skip_top_level_293 Bool)) Bool (and (and (= (attr__constrained temp___expr_292) true) (and (= (rec__default_init__mut_discr__b (us_split_discrs3 temp___expr_292)) (distinct 0 0)) (=> (default_init__mut_discr__f__pred temp___expr_292) (= (to_rep (rec__default_init__mut_discr__f (us_split_fields3 temp___expr_292))) (init 0))))) (=> (not (= temp___skip_top_level_293 true)) (= (mut_discr_ok temp___expr_292) true))))
...
(define-fun dynamic_invariant4 ((temp___expr_300 us_rep1) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (and (=> (not (= temp___skip_constant_297 true)) (in_range5 (distinct 1 0) temp___expr_300)) (= (attr__constrained temp___expr_300) true)))
(define-fun default_initial_assumption4 ((temp___expr_302 us_rep1) (temp___skip_top_level_303 Bool)) Bool (and (and (= (attr__constrained temp___expr_302) true) (and (= (rec__default_init__mut_discr__b (us_split_discrs3 temp___expr_302)) (distinct 1 0)) (=> (default_init__mut_discr__f__pred temp___expr_302) (= (to_rep (rec__default_init__mut_discr__f (us_split_fields3 temp___expr_302))) (init 0))))) (=> (not (= temp___skip_top_level_303 true)) (= (mut_discr_ok temp___expr_302) true))))
...
(assert (= (distinct 1 0) (rec__default_init__discr__b d1__split_discrs)))
