...
(assert (and (= o (positions s1)) (and (not (= (has_key o no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length3 s1))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq1 i1 j) true))))))))))
...
(assert (= result2 true))
(assert (and (= o4 (elements s1)) (and (and (and (= (length1 o4) (length3 s1)) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o4 temp___432) true)) (= (contains (model__ s1) (get o4 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ s1) item) true)) (and (< 0 (find o4 item)) (= (equivalent_elements (get o4 (find o4 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s1))) (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
