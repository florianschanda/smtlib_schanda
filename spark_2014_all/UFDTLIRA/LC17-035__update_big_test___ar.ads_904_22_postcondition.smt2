...
(define-fun dynamic_invariant1 ((temp___expr_188 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 10 90)) (in_range1 temp___expr_188)))
...
(define-fun dynamic_invariant2 ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 50 59)) (in_range2 temp___expr_194)))
...
(assert (= temp___6840 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
...
(assert (= r__split_fields5 (us_split_fields5 temp___6840)))
...
(assert (= temp___6848 (mk___rep2 o27)))
(assert (= result3 (mk___split_fields__ref2 r__split_fields7)))
(assert (= r__split_fields8 (us_split_fields5 temp___6848)))
(assert (= r__split_fields9 (mk___split_fields__ref2 r__split_fields8)))
(assert (= r__split_fields10 r__split_fields8))
(assert (not (= (bool_eq2 (mk___rep2 (us_split_fields__content2 r__split_fields9)) (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (of_rep1 f) (mk___rep (mk___split_fields (of_rep e) r__split_fields2)) (of_rep3 2))) (of_rep2 g)))) true)))
(check-sat)
(exit)
