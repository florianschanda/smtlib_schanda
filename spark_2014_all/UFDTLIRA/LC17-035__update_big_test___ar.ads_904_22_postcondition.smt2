...
(declare-const temp___6902 us_rep2)
...
(declare-const temp___6907 us_rep2)
...
(assert (= temp___6899 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
...
(assert (= r__split_fields5 (us_split_fields5 temp___6899)))
...
(assert (= temp___6907 (mk___rep2 o27)))
(assert (= result3 (mk___split_fields__ref2 r__split_fields7)))
(assert (= r__split_fields8 (us_split_fields5 temp___6907)))
