...
(define-fun dynamic_invariant ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 1)) (in_range temp___expr_194)))
...
(define-fun dynamic_invariant2 ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 1)) (in_range3 temp___expr_215)))
...
(define-fun dynamic_invariant3 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range4 temp___expr_222)))
...
(assert (in_range d))
(assert (and (= o2 (length s1)) (and (in_range2 o2) (<= (+ 0 o2) 2147483647))))
(assert (and (= o1 (length s2)) (and (in_range2 o1) (<= (+ 0 o1) 2147483647))))
(assert (= o3 (- o1 1)))
(assert (= result1 (ite (= o3 o2) true false)))
