...
(assert (and (= o38 i2) (in_range2 i2)))
(assert (and (= o37 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o37) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (not (<= 1 o38)))
(check-sat)
(exit)
