...
(assert (and (= o4 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o4 no_element) true) (and (= (has_key (positions l) o4) true) (= (get1 (positions l) o4) 1)))))
...
(assert (not (= (has_key o3 cu2) true)))
(check-sat)
(exit)
