...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 a))) (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_294 us_rep2) (temp___skip_top_level_295 Bool)) Bool (=> (not (= temp___skip_top_level_295 true)) (and (= (is_empty temp___expr_294) true) (= (length2 temp___expr_294) 0))))
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep3) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_235 us_rep3) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(assert (forall ((container us_rep2)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep3)) (=> (= (has_key container k) true) (= (= (bool_eq3 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant4 result true false true true)))) :pattern ((get1 container key))))))
...
(assert (forall ((container us_rep2)) (! (= (= (is_empty container) true) (forall ((key us_rep3)) (not (= (has_key container key) true)))) :pattern ((is_empty container)))))
...
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant4 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert (and (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep (rec__p__my_lists__list__capacity l__split_discrs))) (or (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) true) (= (bool_eq3 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true))))
(assert (and (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (ite (= (bool_eq3 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true) (and (and (and (and (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (last1 (mk___rep l__split_discrs l__split_fields2))) (length (mk___rep l__split_discrs l__split_fields2))) (= (keys_included_except (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (last1 (mk___rep l__split_discrs l__split_fields2))) true)) (= (ole1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep l__split_discrs l__split_fields2))) 1)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2))) true)) (and (and (and (= (range_equal (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2)) 1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true) (= (range_shifted (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields)))) 1)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true)))))
(assert (not (= (bool_eq3 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true)))
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields))) true) (= (bool_eq3 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true))))
(check-sat)
(exit)
