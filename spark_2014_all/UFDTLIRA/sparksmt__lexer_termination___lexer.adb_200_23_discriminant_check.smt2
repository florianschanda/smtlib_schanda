...
(declare-fun to_rep (read_status) Int)
(declare-fun of_rep (Int) read_status)
(assert (forall ((x read_status)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x read_status)) (! (in_range3 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun file_io__read_result__c__pred ((a us_rep1)) Bool (= (to_rep (rec__file_io__read_result__status (us_split_discrs1 a))) 0))
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__file_io__read_result__status (us_split_discrs1 a))) (to_rep (rec__file_io__read_result__status (us_split_discrs1 b)))) (=> (file_io__read_result__c__pred a) (= (to_rep1 (rec__file_io__read_result__c (us_split_fields1 a))) (to_rep1 (rec__file_io__read_result__c (us_split_fields1 b)))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_531 us_rep1) (temp___skip_top_level_532 Bool)) Bool (and (= (attr__constrained temp___expr_531) false) (= (to_rep (rec__file_io__read_result__status (us_split_discrs1 temp___expr_531))) 2)))
...
(define-fun dynamic_invariant3 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 2)) (in_range3 temp___expr_522)))
...
(assert (= current_read__attr__constrained true))
(assert (not (= next_read__split_discrs current_read__split_discrs)))
(check-sat)
(exit)
