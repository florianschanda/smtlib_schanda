...
(define-fun default_initial_assumption ((temp___expr_463 us_rep1) (temp___skip_top_level_464 Bool)) Bool (and (= (attr__constrained temp___expr_463) false) (= (to_rep (rec__file_io__read_result__status (us_split_discrs1 temp___expr_463))) 2)))
...
(declare-const temp___902 read_status)
(declare-const temp___9021 character)
(declare-const temp___9022 Bool)
(declare-const o Int)
...
(declare-const next_idx3 int__ref)
