...
(define-fun default_initial_assumption ((temp___expr_469 us_rep1) (temp___skip_top_level_470 Bool)) Bool (and (= (attr__constrained temp___expr_469) false) (= (to_rep (rec__file_io__read_result__status (us_split_discrs1 temp___expr_469))) 2)))
...
(define-fun dynamic_invariant3 ((temp___expr_461 Int) (temp___is_init_458 Bool) (temp___skip_constant_459 Bool) (temp___do_toplevel_460 Bool)) Bool (=> (or (= temp___is_init_458 true) (<= 0 2)) (in_range3 temp___expr_461)))
