...
(define-fun default_initial_assumption ((temp___expr_524 us_rep1) (temp___skip_top_level_525 Bool)) Bool (and (= (attr__constrained temp___expr_524) false) (= (to_rep (rec__file_io__read_result__status (us_split_discrs1 temp___expr_524))) 2)))
...
(define-fun dynamic_invariant3 ((temp___expr_515 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool) (temp___do_typ_inv_514 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 0 2)) (in_range3 temp___expr_515)))
(assert (not true))
(check-sat)
(exit)
