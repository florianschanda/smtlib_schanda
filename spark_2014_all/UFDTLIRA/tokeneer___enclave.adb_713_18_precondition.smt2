...
(assert (and (= o8 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o8)))
(assert (and (= o9 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range1 o9)))
...
(assert (=> (= result true) (= o4 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= result true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result true) (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range3 o1))))
(assert (=> (= result true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result true) (= o3 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
