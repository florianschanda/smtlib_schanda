...
(assert (and (= o8 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) (and (in_range3 o8) (= o8 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))))))
(assert (= o9 (ite (<= i1 o8) true false)))
(assert (= result3 (ite (<= idx2 i1) o9 false)))
(assert (= result3 true))
