...
(define-fun front__split_fields3 () us_split_fields (mk___split_fields front__split_fields2))
...
(assert (and (and (= (length (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (length (mk___rep front__split_discrs (mk___split_fields front__split_fields))) 1)) (= (olt (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields))) (model__ (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields1))) true)) (= (get (model__ (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields)))) 1)) o1)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields front__split_fields))))
(assert (= (mk___split_fields front__split_fields1) amortized_queue__my_vectors__append__2__container__fields1))
(assert (= (length (mk___rep front__split_discrs front__split_fields3)) (+ (- (+ (length ofront) (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) idx2) 1)))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (last (model__ ofront)))) (= (get (model__ (mk___rep front__split_discrs front__split_fields3)) i1) (get (model__ ofront) i1)))))
(assert (forall ((i1 Int)) (=> (and (<= idx2 i1) (<= i1 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields)))))) (= (get (model__ (mk___rep front__split_discrs front__split_fields3)) (- (+ (last (model__ (mk___rep front__split_discrs front__split_fields3))) idx2) i1)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i1)))))
(assert (and (=> (<= 1 r51b) (dynamic_property 1 r51b idx2)) (and (<= 1 idx2) (<= idx2 r51b))))
(assert (and (= o2 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) (and (in_range3 o2) (= o2 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))))))
