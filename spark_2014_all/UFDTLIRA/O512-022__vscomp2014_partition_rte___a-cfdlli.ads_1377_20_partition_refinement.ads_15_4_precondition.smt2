...
(define-fun dynamic_invariant ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1 2147483647)) (in_range2 temp___expr_376)))
...
(define-fun default_initial_assumption1 ((temp___expr_383 us_rep2) (temp___skip_top_level_384 Bool)) Bool (=> (not (= temp___skip_top_level_384 true)) (and (= (is_empty temp___expr_383) true) (= (length temp___expr_383) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true))) :pattern ((length1 container1)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___982 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___982)) no_element))
