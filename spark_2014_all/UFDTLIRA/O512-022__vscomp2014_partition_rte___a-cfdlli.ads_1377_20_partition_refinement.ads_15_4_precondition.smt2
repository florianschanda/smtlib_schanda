...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 a))) (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_423 us_rep1) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (and (= (is_empty temp___expr_423) true) (= (length temp___expr_423) 0))))
(define-fun default_initial_assumption1 ((temp___expr_409 us_rep) (temp___skip_top_level_410 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 temp___expr_409))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_364 us_rep) (temp___skip_top_level_365 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 temp___expr_364))) 0))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
