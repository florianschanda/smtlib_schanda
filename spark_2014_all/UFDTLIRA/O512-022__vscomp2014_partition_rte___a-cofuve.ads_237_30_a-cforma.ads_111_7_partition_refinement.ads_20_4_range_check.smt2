...
(define-fun dynamic_invariant ((temp___expr_554 Int) (temp___is_init_551 Bool) (temp___skip_constant_552 Bool) (temp___do_toplevel_553 Bool)) Bool (=> (or (= temp___is_init_551 true) (<= 1 2147483647)) (in_range2 temp___expr_554)))
...
(define-fun dynamic_invariant1 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 2147483647)) (in_range3 temp___expr_566)))
...
(define-fun dynamic_invariant3 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1 2147483647)) (in_range5 temp___expr_560)))
