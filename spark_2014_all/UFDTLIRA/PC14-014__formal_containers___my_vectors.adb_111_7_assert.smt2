...
(assert (not (not (and (= (length (mk___rep l__split_discrs my_vectors__v__clear__container__fields)) 0) (and (= result13 (mk___split_fields__ref l__split_fields7)) (= l__split_fields8 my_vectors__v__clear__container__fields))))))
(check-sat)
(exit)
