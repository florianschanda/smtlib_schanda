...
(assert (<= first i1))
(assert (<= i1 r7b))
(assert (= (length (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))
(assert (forall ((n3 Int)) (=> (and (<= first n3) (<= n3 (- i2 1))) (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n3) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) n3)) true))))
(assert (forall ((n3 Int)) (=> (and (<= i2 n3) (<= n3 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n3) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) n3)))))
...
(assert (= result2 true))
(assert (and (= us1 n) (dynamic_property1 first1 last1 n)))
(assert (= o5 n))
(assert (not (<= first1 o5)))
(check-sat)
(exit)
