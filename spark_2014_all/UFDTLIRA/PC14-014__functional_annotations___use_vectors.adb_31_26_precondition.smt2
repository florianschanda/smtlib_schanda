...
(assert (<= first i1))
(assert (<= i1 r7b))
(assert (= (length (mk___rep v__split_discrs v__split_fields2)) (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))
(assert (forall ((n1 Int)) (=> (and (<= first n1) (<= n1 (- i2 1))) (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n1) (get (model__ (mk___rep v__split_discrs v__split_fields2)) n1)) true))))
(assert (forall ((n1 Int)) (=> (and (<= i2 n1) (<= n1 (last5 (model__ (mk___rep v__split_discrs v__split_fields2))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n1) (get (model__ (mk___rep v__split_discrs v__split_fields2)) n1)))))
(assert (and (and (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))) (=> (<= first r7b) (dynamic_property6 first r7b i2))) (and (<= first i2) (<= i2 r7b))))
(assert (and (= o1 (- i2 1)) (in_range1 (- i2 1))))
(assert (= o2 (ite (<= n o1) true false)))
(assert (= result2 (ite (<= first n) o2 false)))
(assert (= result2 true))
(assert (and (= us n) (dynamic_property1 first1 last1 n)))
(assert (= o3 n))
