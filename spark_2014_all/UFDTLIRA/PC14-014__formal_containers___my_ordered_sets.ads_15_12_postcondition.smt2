...
(assert (= my_ordered_sets__my_lt__result1 my_ordered_sets__my_lt__result2))
(assert (= my_ordered_sets__my_lt__result3 my_ordered_sets__my_lt__result1))
(assert (= result my_ordered_sets__my_lt__result))
(assert (= my_ordered_sets__my_lt__result1 (ite (< (to_rep (rec__my_ordered_sets__my_rec__f (us_split_fields1 x))) (to_rep (rec__my_ordered_sets__my_rec__f (us_split_fields1 y)))) true false)))
(assert (= (mk_bool__ref my_ordered_sets__my_lt__result4) (mk_bool__ref my_ordered_sets__my_lt__result2)))
(assert (= my_ordered_sets__my_lt__result5 my_ordered_sets__my_lt__result3))
(assert (= result1 my_ordered_sets__my_lt__result4))
(assert (< (to_rep (rec__my_ordered_sets__my_rec__f (us_split_fields1 x))) (to_rep (rec__my_ordered_sets__my_rec__f (us_split_fields1 y)))))
(assert (not (= my_ordered_sets__my_lt__result4 true)))
(check-sat)
(exit)
