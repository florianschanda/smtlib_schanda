...
(define-fun dynamic_invariant ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_346)))
...
(define-fun dynamic_invariant1 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range4 temp___expr_352)))
...
(define-fun default_initial_assumption1 ((temp___expr_359 us_rep3) (temp___skip_top_level_360 Bool)) Bool (=> (not (= temp___skip_top_level_360 true)) (= (length1 temp___expr_359) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 2147483647)) (in_range5 temp___expr_372)))
...
(define-fun default_initial_assumption2 ((temp___expr_379 us_rep4) (temp___skip_top_level_380 Bool)) Bool (=> (not (= temp___skip_top_level_380 true)) (and (= (is_empty1 temp___expr_379) true) (= (length2 temp___expr_379) 0))))
...
(define-fun e_is_find ((container us_rep3) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (of_int 1)) (ite (< position (length1 container)) (e_smaller_than_range container (+ position 1) (length1 container) item) (of_int 1))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length3 container)) (forall ((temp___393 Int)) (=> (and (in_range4 temp___393) (= (iter_has_element result temp___393) true)) (= (contains (model__ container) (get result temp___393)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_295)))
...
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant4 result true false true)))) :pattern ((find container item))))))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_321)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant4 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant2 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const use_ordered_sets__are_disjoint__result4 Bool)
...
(declare-const use_ordered_sets__are_disjoint__result8 bool__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_ordered_sets__are_disjoint__result9 Bool)
...
(declare-const use_ordered_sets__are_disjoint__result15 bool__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_ordered_sets__are_disjoint__result16 Bool)
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_sets__are_disjoint__cu__assume)) (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_sets__are_disjoint__cu__assume)) no_element) true) (and (= (has_key (positions s1) (mk___rep1 (mk___split_fields1 use_ordered_sets__are_disjoint__cu__assume))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 use_ordered_sets__are_disjoint__cu__assume))) 1)))))
...
(assert (= use_ordered_sets__are_disjoint__result3 use_ordered_sets__are_disjoint__result2))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___711)) (next s1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length3 s1)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___711)) no_element) true) (and (= (has_key (positions s1) (mk___rep1 (mk___split_fields1 temp___711))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 temp___711))) (+ (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (= result5 cu__split_fields2))
(assert (= temp___711 cu__split_fields3))
(assert (and (= o7 (has_key (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields3)))) (= (= o7 true) (= (has_key (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true))))
(assert (= result6 (ite (not (= o7 true)) true false)))
(assert (not (= result6 true)))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (- (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields3))) 1)))
