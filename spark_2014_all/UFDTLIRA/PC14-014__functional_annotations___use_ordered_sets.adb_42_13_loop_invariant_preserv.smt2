...
(define-fun dynamic_invariant ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_382)))
...
(define-fun dynamic_invariant1 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 0 2147483647)) (in_range4 temp___expr_389)))
...
(define-fun default_initial_assumption1 ((temp___expr_397 us_rep3) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length1 temp___expr_397) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range5 temp___expr_412)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length3 container)) (forall ((temp___435 Int)) (=> (and (in_range4 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant4 result true false true true)))) :pattern ((find container item))))))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_353)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant4 result true false true true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant2 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(define-fun use_ordered_sets__are_disjoint__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_ordered_sets__are_disjoint__cu__assume)))
(assert (and (= use_ordered_sets__are_disjoint__cu__assume1 (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq1 use_ordered_sets__are_disjoint__cu__assume1 no_element) true) (and (= (has_key (positions s1) use_ordered_sets__are_disjoint__cu__assume1) true) (= (get1 (positions s1) use_ordered_sets__are_disjoint__cu__assume1) 1)))))
...
(assert (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields6))) (= (= result1 true) (= (has_key (positions s1) (mk___rep1 cu__split_fields6)) true))))
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s1) (mk___rep1 cu__split_fields5)) 1))) (not (= (contains (model__ s2) (get (elements s1) i)) true)))))
(assert (= (has_key (positions s1) (mk___rep1 cu__split_fields5)) true))
(assert (and (= o (element s1 (mk___rep1 cu__split_fields5))) (and (in_range6 o) (= o (get (elements s1) (get1 (positions s1) (mk___rep1 cu__split_fields5)))))))
(assert (and (= result2 (contains (model__ s2) o)) (= (= result2 true) (= (contains (model__ s2) o) true))))
(assert (not (= result2 true)))
(assert (= use_ordered_sets__are_disjoint__result1 use_ordered_sets__are_disjoint__result))
(assert (and (= temp___7531 (next s1 (mk___rep1 cu__split_fields5))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields5) no_element) false) (= (get1 (positions s1) (mk___rep1 cu__split_fields5)) (length3 s1)) true) true) (= (bool_eq1 temp___7531 no_element) true) (and (= (has_key (positions s1) temp___7531) true) (= (get1 (positions s1) temp___7531) (+ (get1 (positions s1) (mk___rep1 cu__split_fields5)) 1))))))
(assert (= result3 cu__split_fields2))
(assert (= temp___753 cu__split_fields3))
(assert (and (= o1 (has_key (positions s1) (mk___rep1 cu__split_fields4))) (= (= o1 true) (= (has_key (positions s1) (mk___rep1 cu__split_fields4)) true))))
