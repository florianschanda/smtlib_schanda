...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 2)) (in_range2 temp___expr_135)))
...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (attr__constrained temp___expr_143) false) (= (to_rep1 (rec__definite__t__d (us_split_discrs1 temp___expr_143))) 2)))
...
(declare-datatypes () ((t27b__ref (mk_t27b__ref (t27b__content us_rep)))))
(define-fun t27b__ref___projection ((a t27b__ref)) us_rep (t27b__content a))
...
(declare-datatypes () ((t30b__ref (mk_t30b__ref (t30b__content us_rep)))))
(define-fun t30b__ref___projection ((a t30b__ref)) us_rep (t30b__content a))
...
(declare-const temp___198 status)
(declare-const temp___1981 natural)
(declare-const temp___1982 natural)
(declare-const temp___1983 Bool)
(declare-const temp___1984 Bool)
...
(declare-const temp___201 status)
(declare-const temp___2011 natural)
(declare-const temp___2012 natural)
(declare-const temp___2013 Bool)
(declare-const temp___2014 Bool)
...
(declare-const temp___204 status)
(declare-const temp___2041 natural)
(declare-const temp___2042 natural)
(declare-const temp___2043 Bool)
(declare-const temp___2044 Bool)
...
(assert (= y1 0))
(assert (= (to_rep1 x__split_discrs) r23b))
(assert (in_range2 r23b))
(assert (= (to_rep o1) 0))
(assert (= (to_rep o2) 0))
(assert (= o2 o3))
(assert (= o1 o4))
...
(assert (= temp___1981 o3))
(assert (= temp___1982 o4))
(assert (= temp___1983 o5))
(assert (= true temp___1984))
(assert (= x__attr__constrained true))
(assert (not (= temp___198 x__split_discrs)))
(check-sat)
(exit)
