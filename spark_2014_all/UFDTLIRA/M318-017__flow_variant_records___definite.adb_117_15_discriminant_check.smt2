...
(declare-const temp___222 status)
(declare-const temp___2221 natural)
(declare-const temp___2222 natural)
(declare-const temp___2223 Bool)
(declare-const temp___2224 Bool)
...
(assert (= (to_rep1 o) 0))
(assert (= o o6))
(assert (= temp___222 o6))
(assert (= temp___2221 o3))
(assert (= temp___2222 o4))
(assert (= temp___2223 o5))
(assert (= true temp___2224))
(assert (= x__attr__constrained true))
(assert (not (= temp___222 x__split_discrs)))
(check-sat)
(exit)
