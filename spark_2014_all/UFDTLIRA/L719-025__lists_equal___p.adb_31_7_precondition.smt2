...
(declare-fun p_positions_swapped (us_rep3 us_rep3 us_rep1 us_rep1) Bool)
(declare-fun p_positions_swapped__function_guard (Bool us_rep3 us_rep3 us_rep1 us_rep1) Bool)
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length2 container)))))
...
(declare-fun elements_equal_except__2 (us_rep3 us_rep3 us_rep1 us_rep1) Bool)
(declare-fun elements_equal_except__2__function_guard (Bool us_rep3 us_rep3 us_rep1 us_rep1) Bool)
(assert (forall ((left us_rep3) (right us_rep3)) (forall ((x us_rep1) (y us_rep1)) (! (= (= (p_positions_swapped left right x y) true) (and (and (and (and (and (= (same_keys left right) true) (= (elements_equal_except__2 left right x y) true)) (= (has_key left x) true)) (= (has_key left y) true)) (= (get1 left x) (get1 right y))) (= (get1 left y) (get1 right x)))) :pattern ((p_positions_swapped left right x y))))))
...
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 1 100)) (in_range3 temp___expr_220)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant1 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant2 (get container position) true false true)) :pattern ((get container position))))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant (length1 container) true false true) :pattern ((length1 container)))))
...
(assert (forall ((left us_rep3) (right us_rep3)) (forall ((x us_rep1) (y us_rep1)) (! (= (= (elements_equal_except__2 left right x y) true) (forall ((key us_rep1)) (=> (= (has_key left key) true) (=> (and (not (= (bool_eq1 key x) true)) (not (= (bool_eq1 key y) true))) (and (= (has_key right key) true) (= (get1 left key) (get1 right key))))))) :pattern ((elements_equal_except__2 left right x y))))))
...
(assert (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu2) true)))
