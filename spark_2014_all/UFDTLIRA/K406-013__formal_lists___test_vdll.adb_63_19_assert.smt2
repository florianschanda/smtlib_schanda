...
(assert (not (= (bool_eq1 (find (mk___rep l1__split_discrs l1__split_fields4) 3 no_element) (previous (mk___rep l1__split_discrs l1__split_fields4) (last1 (mk___rep l1__split_discrs l1__split_fields4)))) true)))
(check-sat)
(exit)
