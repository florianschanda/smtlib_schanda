...
(assert (not (= (bool_eq (mk___rep c_pu1__split_discrs (mk___split_fields c_pu1__split_fields1 (hide_ext__ c_pu1__split_fields c_pu1__split_fields2)) c_pu1__attr__tag) (mk___rep c_pu2__split_discrs (mk___split_fields c_pu2__split_fields1 (hide_ext__ c_pu2__split_fields c_pu2__split_fields2)) c_pu2__attr__tag)) true)))
(check-sat)
(exit)
