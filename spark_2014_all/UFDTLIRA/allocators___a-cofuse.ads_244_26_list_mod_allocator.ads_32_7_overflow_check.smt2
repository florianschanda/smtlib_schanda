...
(define-fun default_initial_assumption ((temp___expr_230 us_rep) (temp___skip_top_level_231 Bool)) Bool (=> (not (= temp___skip_top_level_231 true)) (= (is_empty temp___expr_230) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 10000)) (in_range3 temp___expr_222)))
