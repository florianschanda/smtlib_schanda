...
(assert (and (= (mk___rep (mk___split_discrs o1) (mk___split_fields o2)) (model__1 q)) (= (is_model q (mk___rep (mk___split_discrs o1) (mk___split_fields o2))) true)))
(assert (not (not (= (is_empty (mk___rep (mk___split_discrs o1) (mk___split_fields o2))) true))))
(check-sat)
(exit)
