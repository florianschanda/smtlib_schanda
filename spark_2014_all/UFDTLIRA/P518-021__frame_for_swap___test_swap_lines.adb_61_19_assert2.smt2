...
(define-fun m17 () map__ref (mk_map__ref m7))
(assert (= result m))
...
(assert (=> (and (<= 1 c2) (<= c2 10)) (= m17 (mk_map__ref m5))))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i Int)) (=> (and (<= 1 i) (<= i c9)) (and (= (to_rep (get m10 5 i)) (to_rep (get temp___283 7 i))) (= (to_rep (get m10 7 i)) (to_rep (get temp___284 5 i))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i Int)) (=> (and (<= (+ c9 1) i) (<= i 10)) (and (= (to_rep (get m10 5 i)) (to_rep (get temp___285 5 i))) (= (to_rep (get m10 7 i)) (to_rep (get temp___286 7 i))))))))
...
(assert (<= j 10))
(assert (= i 5))
(assert (not (= (to_rep (get (map__content m15) i j)) 2)))
(check-sat)
(exit)
