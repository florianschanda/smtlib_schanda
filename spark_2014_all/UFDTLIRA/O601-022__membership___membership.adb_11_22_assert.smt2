...
(define-fun default_initial_assumption1 ((temp___expr_182 us_rep) (temp___skip_top_level_183 Bool)) Bool (= (attr__tag temp___expr_182) us_tag1))
(assert (= r__attr__tag us_tag))
(assert (= r__attr__tag us_tag))
(assert (not (= r__attr__tag us_tag1)))
(check-sat)
(exit)
