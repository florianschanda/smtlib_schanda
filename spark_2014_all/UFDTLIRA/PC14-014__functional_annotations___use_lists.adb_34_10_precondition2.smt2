...
(assert (and (and (and (and (and (= (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (+ (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) 1)) (= (get1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))))) (= (keys_included_except (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)) (= (ole1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)) (= (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) o14)) (= (ole (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)))
