...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__traffic_lights__traffic_lightT__last_state_change us_rep) (rec__traffic_lights__traffic_lightT__vehicles_green Bool) (rec__traffic_lights__traffic_lightT__vehicles_yellow Bool) (rec__traffic_lights__traffic_lightT__vehicles_red Bool) (rec__traffic_lights__traffic_lightT__pedestrians_green Bool) (rec__traffic_lights__traffic_lightT__pedestrians_red Bool) (rec__traffic_lights__traffic_lightT__change_state Bool)))))
(define-fun us_split_fields_Last_State_Change__projection ((a us_split_fields)) us_rep (rec__traffic_lights__traffic_lightT__last_state_change a))
(define-fun us_split_fields_Vehicles_Green__projection ((a us_split_fields)) Bool (rec__traffic_lights__traffic_lightT__vehicles_green a))
(define-fun us_split_fields_Vehicles_Yellow__projection ((a us_split_fields)) Bool (rec__traffic_lights__traffic_lightT__vehicles_yellow a))
(define-fun us_split_fields_Vehicles_Red__projection ((a us_split_fields)) Bool (rec__traffic_lights__traffic_lightT__vehicles_red a))
(define-fun us_split_fields_Pedestrians_Green__projection ((a us_split_fields)) Bool (rec__traffic_lights__traffic_lightT__pedestrians_green a))
(define-fun us_split_fields_Pedestrians_Red__projection ((a us_split_fields)) Bool (rec__traffic_lights__traffic_lightT__pedestrians_red a))
(define-fun us_split_fields_Change_State__projection ((a us_split_fields)) Bool (rec__traffic_lights__traffic_lightT__change_state a))
...
(define-fun us_rep___28__projection ((a us_rep1)) us_split_fields (us_split_fields1 a))
...
(assert (< traffic_lights__traffic_lightT__vehicles_green__first__bit traffic_lights__traffic_lightT__vehicles_green__last__bit))
...
(assert (< traffic_lights__traffic_lightT__vehicles_yellow__first__bit traffic_lights__traffic_lightT__vehicles_yellow__last__bit))
...
(assert (< traffic_lights__traffic_lightT__vehicles_red__first__bit traffic_lights__traffic_lightT__vehicles_red__last__bit))
...
(assert (<= 0 traffic_lights__traffic_lightT__pedestrians_green__first__bit))
(assert (< traffic_lights__traffic_lightT__pedestrians_green__first__bit traffic_lights__traffic_lightT__pedestrians_green__last__bit))
...
(assert (< traffic_lights__traffic_lightT__pedestrians_red__first__bit traffic_lights__traffic_lightT__pedestrians_red__last__bit))
...
(declare-datatypes () ((traffic_lightT__ref (mk_traffic_lightT__ref (traffic_lightT__content us_rep1)))))
(define-fun traffic_lightT__ref___projection ((a traffic_lightT__ref)) us_rep1 (traffic_lightT__content a))
...
(define-fun default_initial_assumption ((temp___expr_1650 us_rep1) (temp___skip_top_level_1651 Bool)) Bool (and (and (and (and (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields1 temp___expr_1650)) time_first) (= (rec__traffic_lights__traffic_lightT__vehicles_green (us_split_fields1 temp___expr_1650)) (distinct 0 0))) (= (rec__traffic_lights__traffic_lightT__vehicles_yellow (us_split_fields1 temp___expr_1650)) (distinct 0 0))) (= (rec__traffic_lights__traffic_lightT__vehicles_red (us_split_fields1 temp___expr_1650)) (distinct 1 0))) (= (rec__traffic_lights__traffic_lightT__pedestrians_green (us_split_fields1 temp___expr_1650)) (distinct 1 0))) (= (rec__traffic_lights__traffic_lightT__pedestrians_red (us_split_fields1 temp___expr_1650)) (distinct 0 0))) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields1 temp___expr_1650)) (distinct 0 0))))
