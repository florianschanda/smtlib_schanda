...
(declare-sort et4 0)
(define-fun in_range1 ((x Int)) Bool (and (<= 50 x) (<= x 59)))
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun user_eq1 (et4 et4) Bool)
(declare-const dummy1 et4)
(declare-datatypes () ((et4__ref (mk_et4__ref (et4__content et4)))))
(define-fun et4__ref___projection ((a et4__ref)) et4 (et4__content a))
(declare-fun to_rep1 (et4) Int)
(declare-fun of_rep1 (Int) et4)
(assert (forall ((x et4)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x et4)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 a))) (to_rep (rec__ar__rec1t__f1 (us_split_fields1 b)))) (= (to_rep2 (rec__ar__rec1t__g1 (us_split_fields1 a))) (to_rep2 (rec__ar__rec1t__g1 (us_split_fields1 b))))) true false))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields5 a)) (rec__ar__rec3t__f3 (us_split_fields5 b))) true) (= (to_rep1 (rec__ar__rec3t__g3 (us_split_fields5 a))) (to_rep1 (rec__ar__rec3t__g3 (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 1 25)) (in_range2 temp___expr_211)))
...
(define-fun dynamic_invariant3 ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 50 59)) (in_range1 temp___expr_225)))
...
(declare-const temp___7062 us_rep2)
...
(assert (= r__split_fields5 (mk___split_fields2 a r__split_fields4)))
(assert (= (to_rep o) e))
(assert (= o o1))
(assert (= (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))) o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))) o8))
(assert (= o9 o5))
(assert (= o10 o6))
(assert (= o11 o7))
(assert (= o12 o8))
...
(assert (= o15 o11))
(assert (= o16 o12))
(assert (= (rec__ar__rec3t__g3 r__split_fields5) o17))
(assert (= temp___7062 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
(assert (= result1 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields6 (us_split_fields5 temp___7062)))
(assert (= r__split_fields7 (mk___split_fields__ref2 r__split_fields6)))
(assert (= r__split_fields8 r__split_fields6))
(assert (not (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields7)) (mk___rep1 (let ((usq_ (us_split_fields3 a))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_) (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 a)))))) (rec__ar__rec2t__h2 usq_))))) true)))
(check-sat)
(exit)
