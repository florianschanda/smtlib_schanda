...
(assert (not (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields2)) (next (mk___rep l2__split_discrs l2__split_fields2) (first (mk___rep l1__split_discrs l1__split_fields1)))) true)))
(check-sat)
(exit)
