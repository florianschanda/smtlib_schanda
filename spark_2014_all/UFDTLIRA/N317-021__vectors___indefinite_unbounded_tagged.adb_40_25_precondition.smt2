...
(declare-const temp___600 us_rep1)
...
(assert (and (= temp___600 (f 3)) (= temp___600 (mk___rep1 (mk___split_fields1 (of_rep1 3) us_null_ext__) us_tag))))
(assert (not (<= 3 (last (model__ (mk___rep w__split_discrs w__split_fields1))))))
(check-sat)
(exit)
