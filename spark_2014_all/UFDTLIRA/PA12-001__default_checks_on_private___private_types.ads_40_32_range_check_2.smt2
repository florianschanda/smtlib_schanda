...
(define-fun private_types__p3__t__f__pred ((a us_rep)) Bool (= (ite (rec__private_types__p3__t__d (us_split_discrs1 a)) 1 0) 1))
...
(define-fun dynamic_invariant1 ((temp___expr_200 us_rep) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (and (=> (not (= temp___skip_constant_197 true)) (in_range3 (distinct 1 0) temp___expr_200)) (= (attr__constrained temp___expr_200) true)))
(define-fun default_initial_assumption ((temp___expr_202 us_rep) (temp___skip_top_level_203 Bool)) Bool (and (= (attr__constrained temp___expr_202) true) (and (= (rec__private_types__p3__t__d (us_split_discrs1 temp___expr_202)) (distinct 1 0)) (=> (private_types__p3__t__f__pred temp___expr_202) (= (to_rep (rec__private_types__p3__t__f (us_split_fields1 temp___expr_202))) (id 0))))))
...
(define-fun default_initial_assumption1 ((temp___expr_193 us_rep) (temp___skip_top_level_194 Bool)) Bool (and (= (attr__constrained temp___expr_193) false) (and (= (rec__private_types__p3__t__d (us_split_discrs1 temp___expr_193)) (distinct 0 0)) (=> (private_types__p3__t__f__pred temp___expr_193) (= (to_rep (rec__private_types__p3__t__f (us_split_fields1 temp___expr_193))) (id 0))))))
(declare-const temp___231 Bool)
(declare-const o Int)
(assert (= (distinct 1 0) temp___231))
(assert (= (ite temp___231 1 0) 1))
