...
(declare-const temp___624 us_rep1)
...
(define-fun o9 () us_rep1 (mk___rep1 (mk___split_fields1 o6 o7) o8))
(define-fun o10 () us_rep1 (mk___rep1 (mk___split_fields1 o3 o4) o5))
(define-fun o11 () us_rep1 (mk___rep1 (mk___split_fields1 o o1) o2))
...
(assert (and (= temp___624 (f 3)) (= temp___624 (mk___rep1 (mk___split_fields1 (of_rep1 3) us_null_ext__) us_tag))))
(assert (not (<= 6 (last (model__ (mk___rep w__split_discrs w__split_fields2))))))
(check-sat)
(exit)
