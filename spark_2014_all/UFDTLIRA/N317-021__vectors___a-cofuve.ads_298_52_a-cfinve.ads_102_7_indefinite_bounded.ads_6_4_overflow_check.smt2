...
(define-fun dynamic_invariant ((temp___expr_216 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 1 2147483647)) (in_range1 temp___expr_216)))
...
(define-fun dynamic_invariant1 ((temp___expr_222 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_222)))
...
(define-fun default_initial_assumption ((temp___expr_235 us_rep) (temp___skip_top_level_236 Bool)) Bool (=> (not (= temp___skip_top_level_236 true)) (= (length temp___expr_235) 0)))
