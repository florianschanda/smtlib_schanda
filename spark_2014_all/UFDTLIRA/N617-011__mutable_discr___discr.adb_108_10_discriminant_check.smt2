...
(assert (=> (= d__attr__constrained true) (= (rec__private_discr__p_with_default__c (us_split_discrs1 temp___323)) (rec__private_discr__p_with_default__c d__split_discrs2))))
(assert (= usq_3 temp___323))
(assert (= temp___325 (mk___rep (us_split_discrs1 usq_3) (us_split_fields1 usq_3) d__attr__constrained)))
...
(assert (and (= temp___326 (new_with_default c)) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___326))) c)))
(assert (= d2__attr__constrained true))
(assert (not (= (rec__private_discr__p_with_default__c (us_split_discrs1 temp___326)) d2__split_discrs)))
(check-sat)
(exit)
