...
(declare-const temp___363 us_rep)
(declare-const temp___364 us_rep)
...
(assert (=> (= d__attr__constrained true) (= (rec__private_discr__p_with_default__c (us_split_discrs1 temp___361)) (rec__private_discr__p_with_default__c d__split_discrs2))))
(assert (= usq_3 temp___361))
(assert (= temp___363 (mk___rep (us_split_discrs1 usq_3) (us_split_fields1 usq_3) d__attr__constrained)))
(assert (= result4 (mk___split_fields__ref d__split_fields2)))
(assert (= d__split_fields3 (us_split_fields1 temp___363)))
(assert (= result5 (mk___split_discrs__ref d__split_discrs2)))
(assert (= d__split_discrs3 (us_split_discrs1 temp___363)))
(assert (not (= d2__attr__constrained true)))
(assert (= (to_rep d2__split_discrs) 0))
(assert (and (= temp___364 (new_with_default c)) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___364))) c)))
(assert (= d2__attr__constrained true))
(assert (not (= (rec__private_discr__p_with_default__c (us_split_discrs1 temp___364)) d2__split_discrs)))
(check-sat)
(exit)
