...
(define-fun tests__test_16__t__x__pred ((a us_rep)) Bool (= (to_int1 (rec__tests__test_16__t__d (us_split_discrs1 a))) 1))
...
(define-fun default_initial_assumption ((temp___expr_289 us_rep) (temp___skip_top_level_290 Bool)) Bool (and (= (attr__constrained temp___expr_289) false) (= (rec__tests__test_16__t__d (us_split_discrs1 temp___expr_289)) (of_int 0))))
...
(define-fun dynamic_invariant ((temp___expr_296 us_rep) (temp___is_init_293 Bool) (temp___skip_constant_294 Bool) (temp___do_toplevel_295 Bool)) Bool (and (=> (not (= temp___skip_constant_294 true)) (in_range2 (of_int 0) temp___expr_296)) (= (attr__constrained temp___expr_296) true)))
(define-fun default_initial_assumption1 ((temp___expr_298 us_rep) (temp___skip_top_level_299 Bool)) Bool (and (= (attr__constrained temp___expr_298) true) (= (rec__tests__test_16__t__d (us_split_discrs1 temp___expr_298)) (of_int 0))))
