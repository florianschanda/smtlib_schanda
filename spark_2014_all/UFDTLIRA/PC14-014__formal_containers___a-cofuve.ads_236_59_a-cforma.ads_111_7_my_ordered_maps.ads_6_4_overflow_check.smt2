...
(define-fun dynamic_invariant ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 1 2147483647)) (in_range2 temp___expr_346)))
...
(define-fun dynamic_invariant1 ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= 0 2147483647)) (in_range3 temp___expr_358)))
...
(define-fun default_initial_assumption ((temp___expr_365 us_rep) (temp___skip_top_level_366 Bool)) Bool (=> (not (= temp___skip_top_level_366 true)) (= (length temp___expr_365) 0)))
