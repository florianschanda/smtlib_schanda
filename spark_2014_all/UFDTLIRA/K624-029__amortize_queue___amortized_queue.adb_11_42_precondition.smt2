...
(assert (= (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) idx3))
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 idx3)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) i5) (get (model__ left) i5)))))
(assert (and (=> (<= 1 r4b) (dynamic_property 1 r4b idx3)) (and (<= 1 idx3) (<= idx3 r4b))))
(assert (<= 1 i))
(assert (<= i idx3))
