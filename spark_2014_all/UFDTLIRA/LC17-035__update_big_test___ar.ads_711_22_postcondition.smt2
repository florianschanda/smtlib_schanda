...
(declare-const temp___6652 et1)
(declare-const temp___66521 et2)
...
(assert (= temp___6652 o1))
(assert (= temp___66521 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___6652 r__split_fields2))
(assert (= temp___66521 r__split_fields3))
