...
(define-fun dynamic_invariant ((temp___expr_458 Int) (temp___is_init_454 Bool) (temp___skip_constant_455 Bool) (temp___do_toplevel_456 Bool) (temp___do_typ_inv_457 Bool)) Bool (=> (or (= temp___is_init_454 true) (<= 1 2147483647)) (in_range1 temp___expr_458)))
...
(define-fun dynamic_invariant2 ((temp___expr_475 Int) (temp___is_init_471 Bool) (temp___skip_constant_472 Bool) (temp___do_toplevel_473 Bool) (temp___do_typ_inv_474 Bool)) Bool (=> (or (= temp___is_init_471 true) (<= 0 2147483647)) (in_range7 temp___expr_475)))
...
(define-fun dynamic_invariant4 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483646)) (in_range5 temp___expr_249)))
(define-fun dynamic_invariant5 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 2147483647)) (in_range4 temp___expr_173)))
(assert true)
(declare-const o Int)
