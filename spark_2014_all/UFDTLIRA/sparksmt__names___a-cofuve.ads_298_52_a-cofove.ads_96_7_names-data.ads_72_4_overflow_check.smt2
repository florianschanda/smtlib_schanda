...
(define-fun dynamic_invariant ((temp___expr_407 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range1 temp___expr_407)))
...
(define-fun dynamic_invariant2 ((temp___expr_422 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 0 2147483647)) (in_range7 temp___expr_422)))
...
(define-fun dynamic_invariant4 ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 2147483646)) (in_range5 temp___expr_214)))
(define-fun dynamic_invariant5 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 2147483647)) (in_range4 temp___expr_148)))
(assert true)
(declare-const o Int)
