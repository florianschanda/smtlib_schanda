...
(declare-const temp___183 natural)
(declare-const temp___1831 minutes_t)
(declare-const temp___1832 seconds_t)
(assert (= (to_rep2 o) 59))
...
(assert (= o1 o4))
(assert (= o o5))
(assert (= temp___183 o3))
(assert (= temp___1831 o4))
(assert (= temp___1832 o5))
(assert (= (mk___rep (mk___split_fields temp___183 temp___1831 temp___1832)) max))
