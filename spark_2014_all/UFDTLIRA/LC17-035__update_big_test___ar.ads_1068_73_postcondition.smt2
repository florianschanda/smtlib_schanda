...
(declare-const temp___7257 et3)
(declare-const temp___72571 et1)
(declare-const temp___72572 et2)
(declare-const temp___72573 enum1ta)
(declare-const temp___72574 et4)
(declare-const temp___72575 enum1t)
...
(declare-const temp___7261 us_rep3)
...
(assert (= temp1 o))
(assert (= (to_rep4 o1) (to_rep5 r__split_fields3)))
...
(assert (= o1 o7))
(assert (= temp___7257 o2))
(assert (= temp___72571 o3))
(assert (= temp___72572 o4))
(assert (= temp___72573 o5))
(assert (= temp___72574 o6))
(assert (= temp___72575 o7))
...
(assert (= r__split_fields6 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 temp___7257 (mk___rep (mk___split_fields temp___72571 temp___72572)) temp___72573)) temp___72574)) temp___72575)))
(assert (= (to_rep5 o8) temp1))
...
(assert (= temp___7261 (mk___rep3 o13)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7261)))
...
(assert (not (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 (us_split_fields__content3 r__split_fields8))))))))) (to_rep r__split_fields1))))
(check-sat)
(exit)
