...
(assert (= result2 true))
(assert (and (= o4 (keys s)) (and (and (and (= (length1 o4) (length3 s)) (forall ((temp___439 Int)) (=> (and (in_range4 temp___439) (= (iter_has_element o4 temp___439) true)) (= (has_key (model__ s) (get o4 temp___439)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o4 key1)) (= (equivalent_keys (get o4 (find o4 key1)) key1) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s))) (and (= (find o4 (get o4 i1)) i1) (= (k_is_find o4 (get o4 i1) i1) true)))))))
