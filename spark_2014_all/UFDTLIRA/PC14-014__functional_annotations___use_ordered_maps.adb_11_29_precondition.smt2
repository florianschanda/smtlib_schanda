...
(assert (= result2 true))
(assert (and (= o6 (keys s)) (and (and (and (= (length1 o6) (length3 s)) (forall ((temp___439 Int)) (=> (and (in_range5 temp___439) (= (iter_has_element o6 temp___439) true)) (= (has_key (model__ s) (get o6 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o6 key2)) (= (equivalent_keys (get o6 (find o6 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length3 s))) (and (= (find o6 (get o6 i1)) i1) (= (k_is_find o6 (get o6 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
