...
(assert (and (= o24 (last1 (mk___rep l1__split_discrs l1__split_fields4))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields4)) 0) true) (= (bool_eq1 o24 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o24) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o24) (length (mk___rep l1__split_discrs l1__split_fields4)))))))
