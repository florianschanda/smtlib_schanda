...
(assert (= rliteral3 current_date__split_fields3))
(assert (= current_date__split_fields1 current_date__split_fields4))
(assert (= current_date__split_fields2 current_date__split_fields5))
