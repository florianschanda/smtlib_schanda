...
(declare-const o Int)
(declare-const o1 day_type)
(declare-const o2 day_type)
(declare-const o3 month_type)
(declare-const o4 year_type)
(declare-const temp___299 day_type)
(declare-const temp___2991 month_type)
(declare-const temp___2992 year_type)
...
(assert (not (= (to_rep1 current_date__split_fields1) 12)))
(assert (= (to_rep2 o1) 1))
(assert (= o1 o2))
(assert (= current_date__split_fields1 o3))
(assert (= current_date__split_fields2 o4))
(assert (= temp___299 o2))
(assert (= temp___2991 o3))
(assert (= temp___2992 o4))
(assert (= result1 current_date__split_fields))
(assert (= result2 current_date__split_fields1))
(assert (= result3 current_date__split_fields2))
(assert (= temp___299 current_date__split_fields3))
(assert (= temp___2991 current_date__split_fields4))
(assert (= temp___2992 current_date__split_fields5))
(assert (not (in_range1 (+ (to_rep1 current_date__split_fields4) 1))))
(check-sat)
(exit)
