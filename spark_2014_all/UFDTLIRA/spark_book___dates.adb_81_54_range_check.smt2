...
(assert (= temp___265 o2))
(assert (= temp___2651 o3))
(assert (= temp___2652 o4))
...
(assert (= temp___265 current_date__split_fields3))
(assert (= temp___2651 current_date__split_fields4))
(assert (= temp___2652 current_date__split_fields5))
