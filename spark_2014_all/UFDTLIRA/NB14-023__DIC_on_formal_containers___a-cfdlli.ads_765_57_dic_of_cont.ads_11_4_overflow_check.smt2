...
(define-fun dynamic_invariant1 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range2 temp___expr_353)))
...
(assert (not (in_range (- (to_rep (rec__dic_of_cont__my_dlli__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
