...
(assert (and (= o67 (first (mk___rep l3__split_discrs l3__split_fields4))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields4)) 0) true) (= (bool_eq1 o67 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o67) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o67) 1)))))
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o67) true)))
(check-sat)
(exit)
