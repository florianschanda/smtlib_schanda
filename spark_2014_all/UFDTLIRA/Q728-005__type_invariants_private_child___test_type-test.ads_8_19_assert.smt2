...
(assert (= (mk___rep (mk___split_fields rliteral)) x))
...
(assert (= test_type__test__y__assume y__split_fields1))
(assert (not (= (bool_eq x (mk___rep (mk___split_fields y__split_fields1))) true)))
(check-sat)
(exit)
