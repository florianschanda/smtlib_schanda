...
(assert (and (= (mk___rep (mk___split_fields test_type__test__y__assume)) (decr_int x)) (= (of_rep (- (to_rep (rec__test_type__t__f (us_split_fields1 x))) 1)) test_type__test__y__assume)))
(assert (= (mk___rep (mk___split_fields test_type__test__y__assume)) y))
