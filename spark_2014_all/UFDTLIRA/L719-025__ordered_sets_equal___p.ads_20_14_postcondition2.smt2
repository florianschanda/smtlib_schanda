...
(assert (and (and (and (and (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) e) true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) true)) (= (equivalent_elements (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5)) e) true)) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields6)) e (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5))) true)) (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true) (and (and (and (not (= i true)) (= (oeq3 (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq2 (elements (mk___rep l__split_discrs l__split_fields6)) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (and (and (and (and (and (and (and (= i true) (= (length (mk___rep l__split_discrs l__split_fields6)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (= (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5)) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields6)) 1 (- (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields6)) (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields6)) (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) 1) true)))))
(assert (= i true))
(assert (and (and (and (and (and (and (and (and (= (bool_eq2 (mk___rep1 cu__split_fields4) no_element) true) (= (length (mk___rep l__split_discrs l__split_fields5)) (- (length (mk___rep l__split_discrs l__split_fields6)) 1))) (not (= (contains (model__ (mk___rep l__split_discrs l__split_fields5)) (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5))) true))) (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5)) true))) (= (ole (model__ (mk___rep l__split_discrs l__split_fields5)) (model__ (mk___rep l__split_discrs l__split_fields6))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields5)) (element (mk___rep l__split_discrs l__split_fields6) (mk___rep1 cu__split_fields5))) true)) (= (range_equal (elements (mk___rep l__split_discrs l__split_fields6)) (elements (mk___rep l__split_discrs l__split_fields5)) 1 (- (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields5)) (elements (mk___rep l__split_discrs l__split_fields6)) (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) (length (mk___rep l__split_discrs l__split_fields5)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields5)) (positions (mk___rep l__split_discrs l__split_fields6)) (get (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 cu__split_fields5)) 1) true)))
(assert (= i i1))
