...
(assert (= (mk___rep1 (mk___split_fields1 result6)) (cursor__content use_lists__my_find__result13)))
(assert (= (bool_eq1 (find l e no_element) no_element) true))
(assert (not (= (bool_eq1 (cursor__content use_lists__my_find__result13) no_element) true)))
(check-sat)
(exit)
