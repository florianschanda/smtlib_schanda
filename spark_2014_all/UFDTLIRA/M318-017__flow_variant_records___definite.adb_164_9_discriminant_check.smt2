...
(declare-const temp___246 status)
(declare-const temp___2461 natural)
(declare-const temp___2462 natural)
(declare-const temp___2463 Bool)
(declare-const temp___2464 Bool)
(assert (in_range i))
...
(assert (= (to_rep1 o) 2))
(assert (= o o6))
(assert (= temp___246 o6))
(assert (= temp___2461 o3))
(assert (= temp___2462 o4))
(assert (= temp___2463 o5))
(assert (= true temp___2464))
(assert (= x__attr__constrained true))
(assert (not (= temp___246 x__split_discrs)))
(check-sat)
(exit)
