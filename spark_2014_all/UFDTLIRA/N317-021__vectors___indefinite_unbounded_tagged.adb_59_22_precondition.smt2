...
(declare-const temp___633 us_rep1)
...
(assert (and (= temp___633 (f 4)) (= temp___633 (mk___rep1 (mk___split_fields1 (of_rep1 4) us_null_ext__) us_tag))))
(assert (not (<= 2 (last (model__ (mk___rep v__split_discrs v__split_fields6))))))
(check-sat)
(exit)
