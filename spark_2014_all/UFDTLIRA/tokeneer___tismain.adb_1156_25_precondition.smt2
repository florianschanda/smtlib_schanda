...
(assert (=> (= result true) (= o36 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result true) (= o37 (ite (not (= o36 true)) true false))))
(assert (=> (= result true) (= o35 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result true) (= o38 (ite (not (= o35 true)) true false))))
(assert (=> (= result true) (= o39 (ite (= o38 true) o37 false))))
(assert (=> (not (= result true)) (= o39 (of_int 1))))
(assert (= result1 (statusisshutdown (us_private__content state48))))
(assert (=> (= result1 true) (and (= o31 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range1 o31))))
(assert (=> (= result1 true) (= o32 (ite (= o31 0) true false))))
(assert (=> (= result1 true) (= o30 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result1 true) (= o33 (ite (not (= o30 true)) true false))))
(assert (=> (= result1 true) (= o34 (ite (= o33 true) o32 false))))
(assert (=> (not (= result1 true)) (= o34 (of_int 1))))
(assert (= result2 (statusisenclavequiescent (us_private__content state48))))
(assert (=> (= result2 true) (= o28 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result2 true) (= o29 (ite (not (= o28 true)) true false))))
(assert (=> (not (= result2 true)) (= o29 (of_int 1))))
(assert (= o19 (statusiswaitingfinishadminop (us_private__content state48))))
(assert (= o20 (statusiswaitingstartadminop (us_private__content state48))))
(assert (= result3 (ite (= o20 false) o19 true)))
(assert (=> (= result3 true) (and (= o23 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o23))))
(assert (=> (= result3 true) (and (= o24 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range1 o24))))
(assert (=> (= result3 true) (= o25 (ite (= o24 o23) true false))))
(assert (=> (= result3 true) (= o21 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result3 true) (= o22 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result3 true) (= o26 (ite (= o22 true) o21 false))))
(assert (=> (= result3 true) (= o27 (ite (= o26 true) o25 false))))
(assert (=> (not (= result3 true)) (= o27 (of_int 1))))
(assert (= o15 (statusiswaitingremoveadmintokenfail (us_private__content state48))))
(assert (= o16 (statusisgotadmintoken (us_private__content state48))))
(assert (= result4 (ite (= o16 false) o15 true)))
(assert (=> (= result4 true) (= o17 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result4 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (not (= result4 true)) (= o18 (of_int 1))))
(assert (and (= o11 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o11)))
(assert (= o12 (ite (= o11 4) true false)))
(assert (= o13 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))))
(assert (= result5 (ite (= o13 true) o12 false)))
(assert (=> (= result5 true) (= o14 (statusiswaitingstartadminop (us_private__content state48)))))
(assert (=> (not (= result5 true)) (= o14 (of_int 1))))
(assert (= o8 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4)))))
(assert (= result6 (ite (not (= o8 true)) true false)))
(assert (=> (= result6 true) (= o9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result6 true) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (not (= result6 true)) (= o10 (of_int 1))))
(assert (and (= o (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range1 o)))
(assert (= result7 (ite (= o 1) true false)))
(assert (=> (= result7 true) (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result7 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result7 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range3 o1))))
(assert (=> (= result7 true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result7 true) (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
