...
(define-fun dynamic_invariant ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 1000)) (in_range temp___expr_249)))
...
(assert (forall ((left Int)) (forall ((right us_rep)) (! (=> (and (dynamic_invariant1 left true true true true) (<= (+ 1 (length right)) 1000)) (let ((result (oconcat__2 left right))) (and (= (length result) (+ 1 (length right))) (and (= (element result 1) left) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last_index right))) (= (element result (+ 1 i)) (element right i)))))))) :pattern ((oconcat__2 left right))))))
(define-fun in_range3 ((rec__amortized_queue__my_vectors__vector__capacity1 Int) (a us_rep)) Bool (= rec__amortized_queue__my_vectors__vector__capacity1 (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_403 us_rep2) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (and (in_range3 1000 (rec__amortized_queue__queue__front (us_split_fields3 temp___expr_403))) (in_range3 1000 (rec__amortized_queue__queue__rear (us_split_fields3 temp___expr_403)))))
...
(assert (forall ((q us_rep2)) (! (=> (and (dynamic_invariant2 q true true true true) (= (inv q) true)) (= (is_model q (model__1 q)) true)) :pattern ((model__1 q)))))
(define-fun dynamic_invariant3 ((temp___expr_393 us_rep) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (not (= temp___skip_constant_390 true)) (in_range3 1000 temp___expr_393)))
...
(define-fun dynamic_invariant4 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range4 temp___expr_165)))
...
(define-fun dynamic_invariant5 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 1001)) (in_range5 temp___expr_242)))
...
(define-fun dynamic_invariant6 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_235)))
...
(define-fun dynamic_invariant7 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 1000)) (in_range7 temp___expr_228)))
...
(define-fun dynamic_invariant8 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 0 1000)) (in_range8 temp___expr_280)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 1000) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant9 ((temp___expr_273 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool) (temp___do_typ_inv_272 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= (- 2147483648) 2147483647)) (in_range9 temp___expr_273)))
...
(declare-const amortized_queue__enqueue__result capacity_range)
(declare-const amortized_queue__enqueue__result1 us_main_type)
(declare-const amortized_queue__enqueue__result2 capacity_range)
(declare-const amortized_queue__enqueue__result3 us_main_type)
...
(declare-const amortized_queue__reverse_insert__rear__fields us_split_fields)
(declare-const amortized_queue__reverse_insert__front__fields us_split_fields)
...
(declare-const result5 queue__ref)
(declare-const amortized_queue__enqueue__result4 us_rep2)
(declare-const result____split_fields8 us_split_fields__ref1)
(declare-const amortized_queue__enqueue__result5 queue__ref)
(declare-const result____split_fields9 us_split_fields2)
(declare-const amortized_queue__enqueue__result6 us_rep2)
(declare-const result____split_fields10 us_split_fields__ref1)
(declare-const amortized_queue__enqueue__result7 queue__ref)
(declare-const result____split_fields11 us_split_fields2)
(declare-const amortized_queue__enqueue__result8 us_rep2)
(define-fun o17 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
(declare-const result6 capacity_range)
(declare-const result7 us_main_type)
(declare-const result8 capacity_range)
(declare-const result9 us_main_type)
...
(assert (in_range2 v))
(assert (and (= (inv q) true) (< (length (rec__amortized_queue__queue__rear (us_split_fields3 q))) (- (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 (rec__amortized_queue__queue__front (us_split_fields3 q))))) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= amortized_queue__enqueue__result5 (mk_queue__ref amortized_queue__enqueue__result4)))
(assert (= result____split_fields8 (mk___split_fields__ref1 result____split_fields7)))
(assert (= amortized_queue__enqueue__result6 amortized_queue__enqueue__result4))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o18 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o18) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o17 o18))
(assert (= o7 o17))
...
(assert (= result____split_fields4 (us_split_fields3 amortized_queue__enqueue__R63b__result__assume)))
...
(assert (and (and (= (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) amortized_queue__my_vectors__append__2__container__fields)) (+ (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) (us_split_fields1 (rec__amortized_queue__queue__rear result____split_fields4)))) 1)) (= (olt (model__ (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) (us_split_fields1 (rec__amortized_queue__queue__rear result____split_fields4)))) (model__ (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) amortized_queue__my_vectors__append__2__container__fields))) true)) (= (get (model__ (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) amortized_queue__my_vectors__append__2__container__fields)) (+ (last (model__ (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) (us_split_fields1 (rec__amortized_queue__queue__rear result____split_fields4))))) 1)) v)))
(assert (= result1 (mk___split_fields__ref1 result____split_fields4)))
(assert (= result____split_fields5 (mk___split_fields1 (rec__amortized_queue__queue__front result____split_fields4) (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields4)) amortized_queue__my_vectors__append__2__container__fields))))
...
(assert (=> (= result2 true) (and (= o14 (copy (rec__amortized_queue__queue__rear result____split_fields5) 1000)) (and (= (oeq1 (model__ o14) (model__ (rec__amortized_queue__queue__rear result____split_fields5))) true) (ite (= 1000 0) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o14))) (length (rec__amortized_queue__queue__rear result____split_fields5))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o14))) 1000))))))
(assert (=> (= result2 true) (= o15 o14)))
(assert (=> (= result2 true) (= o16 o15)))
(assert (=> (= result2 true) (and (= o11 (copy (rec__amortized_queue__queue__front result____split_fields5) 1000)) (and (= (oeq1 (model__ o11) (model__ (rec__amortized_queue__queue__front result____split_fields5))) true) (ite (= 1000 0) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o11))) (length (rec__amortized_queue__queue__front result____split_fields5))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o11))) 1000))))))
(assert (=> (= result2 true) (= o12 o11)))
(assert (=> (= result2 true) (= o13 o12)))
(assert (=> (= result2 true) (and (= (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields5)) amortized_queue__reverse_insert__front__fields)) (+ (length o13) (length o16))) (and (= (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields5)) amortized_queue__reverse_insert__rear__fields)) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ o13)))) (= (get (model__ (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields5)) amortized_queue__reverse_insert__front__fields)) i) (get (model__ o13) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ o16)))) (= (get (model__ (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields5)) amortized_queue__reverse_insert__front__fields)) (- (+ (last (model__ (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields5)) amortized_queue__reverse_insert__front__fields))) 1) i)) (get (model__ o16) i)))))))))
(assert (=> (= result2 true) (= result3 (mk___split_fields__ref1 result____split_fields5))))
(assert (=> (= result2 true) (= result____split_fields6 (mk___split_fields1 (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields5)) amortized_queue__reverse_insert__front__fields) (rec__amortized_queue__queue__rear result____split_fields5)))))
(assert (=> (= result2 true) (= result4 (mk___split_fields__ref1 result____split_fields6))))
(assert (=> (= result2 true) (= result____split_fields7 (mk___split_fields1 (rec__amortized_queue__queue__front result____split_fields6) (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields5)) amortized_queue__reverse_insert__rear__fields)))))
(assert (=> (not (= result2 true)) (= result____split_fields7 result____split_fields5)))
(assert (= result5 (mk_queue__ref (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_discrs amortized_queue__enqueue__result) (mk___split_fields amortized_queue__enqueue__result1)) (mk___rep (mk___split_discrs amortized_queue__enqueue__result2) (mk___split_fields amortized_queue__enqueue__result3)))))))
(assert (= amortized_queue__enqueue__result4 (mk___rep1 result____split_fields7)))
(assert (= amortized_queue__enqueue__result7 amortized_queue__enqueue__result5))
(assert (= result____split_fields10 result____split_fields8))
(assert (= amortized_queue__enqueue__result8 amortized_queue__enqueue__result6))
(assert (= result____split_fields11 result____split_fields9))
(assert (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_discrs result6) (mk___split_fields result7)) (mk___rep (mk___split_discrs result8) (mk___split_fields result9)))) (queue__content amortized_queue__enqueue__result7)))
(assert (not (= (oeq (oconcat__2 v (model__1 q)) (model__1 (queue__content amortized_queue__enqueue__result7))) true)))
(check-sat)
(exit)
