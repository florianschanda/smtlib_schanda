...
(assert (=> (not (= state 0)) (and (and (= temp___157 state) (and (= temp___156 speed) (and (= (speed_is_valid speed2 state2) true) (and (and (and (in_range2 speed2) (in_range1 state2)) (not (= state2 0))) (and (ite (< 0 speed2) (and (= (speed_is_valid speed3 state3) true) (and (in_range2 speed3) (in_range1 state3))) (and (and (= (speed_is_valid speed4 state4) true) (and (in_range2 speed4) (in_range1 state4))) (and (= state3 state4) (= speed3 speed4)))) (= state3 0)))))) (and (and (= state3 state7) (= speed3 speed7)) (and (= state8 state3) (= speed8 speed3))))))
