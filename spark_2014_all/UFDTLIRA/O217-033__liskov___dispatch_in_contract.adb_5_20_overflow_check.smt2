...
(assert (forall ((o us_rep)) (! (= (to_int1 (less_than_max__3 (of_base o))) (to_int1 (less_than_max1 us_tag2 o))) :pattern ((less_than_max1 us_tag2 o)))))
...
(define-fun default_initial_assumption1 ((temp___expr_150 us_rep1) (temp___skip_top_level_151 Bool)) Bool (= (attr__tag1 temp___expr_150) us_tag1))
(assert true)
(assert true)
