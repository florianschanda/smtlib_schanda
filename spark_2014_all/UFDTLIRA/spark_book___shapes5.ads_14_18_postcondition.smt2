...
(assert (and (and (and (in_range2 (+ (to_rep (rec__shapes5__circle__center_x (us_split_fields1 (circle__content shapes5__make_circle__result)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result)))))) (in_range2 (- (to_rep (rec__shapes5__circle__center_x (us_split_fields1 (circle__content shapes5__make_circle__result)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result))))))) (in_range2 (+ (to_rep (rec__shapes5__circle__center_y (us_split_fields1 (circle__content shapes5__make_circle__result)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result))))))) (in_range2 (- (to_rep (rec__shapes5__circle__center_y (us_split_fields1 (circle__content shapes5__make_circle__result)))) (to_rep1 (rec__shapes5__circle__radius (us_split_fields1 (circle__content shapes5__make_circle__result))))))))
