...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 3 1 5 1 10 (temp_____aggregate_def_206 a (- x1 1) (- y1 1) (- z1 1) (+ x2 1) (+ y2 1) (+ z2 1) (+ new_val_1 1) (+ x3 1) (+ y3 1) (+ z3 1) (- new_val_2 1)) 1 3 1 5 1 10) true)))
(check-sat)
(exit)
