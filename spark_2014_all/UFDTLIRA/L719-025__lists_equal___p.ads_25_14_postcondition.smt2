...
(assert (and (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6)) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu2)) true) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)))
(assert (= (element (mk___rep l__split_discrs l__split_fields6) cu1) (element l_in cu2)))
(assert (and (= (m_elements_swapped (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields5)) (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu1) (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu2)) true) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields5)) (positions (mk___rep l__split_discrs l__split_fields6))) true)))
