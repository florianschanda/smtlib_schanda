...
(define-fun dynamic_invariant3 ((temp___expr_397 Int) (temp___is_init_394 Bool) (temp___skip_constant_395 Bool) (temp___do_toplevel_396 Bool)) Bool (=> (or (= temp___is_init_394 true) (<= 1 100)) (in_range5 temp___expr_397)))
