...
(assert (not (= y1 0)))
(assert (not (= y1 1)))
(assert (= (to_rep1 x__split_discrs) r29b))
...
(assert (= o13 o18))
(assert (= temp___204 o18))
(assert (= temp___2041 o15))
(assert (= temp___2042 o16))
(assert (= temp___2043 o17))
(assert (= true temp___2044))
(assert (= x__attr__constrained true))
(assert (not (= temp___204 x__split_discrs)))
(check-sat)
(exit)
