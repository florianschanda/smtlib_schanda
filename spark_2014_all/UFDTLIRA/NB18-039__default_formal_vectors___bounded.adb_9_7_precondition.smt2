...
(define-fun bounded__vect__append__2__container__fields1 () us_split_fields (mk___split_fields bounded__vect__append__2__container__fields))
...
(assert (and (and (= (length (mk___rep v__split_discrs bounded__vect__append__2__container__fields1)) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs bounded__vect__append__2__container__fields1))) true)) (= (get (model__ (mk___rep v__split_discrs bounded__vect__append__2__container__fields1)) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) 1)) 1)))
(assert (= result v__split_fields))
(assert (= v__split_fields2 bounded__vect__append__2__container__fields1))
