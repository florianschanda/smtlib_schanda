...
(define-fun default_initial_assumption ((temp___expr_202 us_rep) (temp___skip_top_level_203 Bool)) Bool (= (attr__tag temp___expr_202) us_tag1))
(declare-const b__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun default_initial_assumption1 ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (= (attr__tag temp___expr_172) us_tag))
(assert (= b__attr__tag us_tag1))
(assert (not (= b__attr__tag us_tag)))
(check-sat)
(exit)
