...
(assert (and (= o6 (first (mk___rep l1__split_discrs l1__split_fields1))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields1)) 0) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields1)) o6) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields1)) o6) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields2)) o6) true) (= (bool_eq1 o6 no_element) true))))
(check-sat)
(exit)
