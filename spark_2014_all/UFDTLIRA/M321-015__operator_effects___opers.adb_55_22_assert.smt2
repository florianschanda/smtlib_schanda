...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_141)))
(declare-fun double1 (Int) Int)
(declare-fun double1__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant1 (double1 x) true false true)) :pattern ((double1 x)))))
(declare-sort t1 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant2 x true true true) (dynamic_invariant2 (double2 x) true false true)) :pattern ((double2 x)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant3 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 1 10)) (in_range4 temp___expr_153)))
(declare-fun ten1 (Int) Int)
(declare-fun ten1__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true) (dynamic_invariant3 (ten1 x) true false true)) :pattern ((ten1 x)))))
(declare-sort t3 0)
...
(define-fun dynamic_invariant4 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 10)) (in_range5 temp___expr_159)))
(declare-fun ten2 (Int) Int)
(declare-fun ten2__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant4 x true true true) (dynamic_invariant4 (ten2 x) true false true)) :pattern ((ten2 x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_165 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_165)))
(assert true)
...
(define-fun dynamic_invariant6 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_171)))
(assert true)
...
(define-fun dynamic_invariant7 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 1 10)) (in_range8 temp___expr_177)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 1 10)) (in_range9 temp___expr_183)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= (- 2147483648) 2147483647)) (in_range10 temp___expr_189)))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= (- 2147483648) 2147483647)) (in_range11 temp___expr_195)))
(assert true)
...
(define-fun dynamic_invariant11 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 1 10)) (in_range12 temp___expr_201)))
(assert true)
...
(define-fun dynamic_invariant12 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 1 10)) (in_range13 temp___expr_207)))
(assert true)
(define-fun dynamic_invariant13 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 1 10)) (in_range1 temp___expr_135)))
(declare-const a Int)
(declare-const o Int)
