...
(define-fun dynamic_invariant1 ((temp___expr_149 us_rep) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (not (= temp___skip_constant_147 true)) (in_range3 2 temp___expr_149)))
(define-fun default_initial_assumption ((temp___expr_151 us_rep) (temp___skip_top_level_152 Bool)) Bool (= (to_rep (rec__test__wibble__d (us_split_discrs1 temp___expr_151))) 2))
