...
(assert (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (get model____split_fields4 rr1) rr1))))
(assert (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (contains1 model____split_fields4 rr1) true))))
