...
(define-fun dynamic_invariant ((temp___expr_408 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool) (temp___do_typ_inv_407 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range2 temp___expr_408)))
...
(define-fun dynamic_invariant3 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_415)))
(declare-const o Int)
