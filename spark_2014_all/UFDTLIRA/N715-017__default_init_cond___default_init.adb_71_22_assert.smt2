...
(assert (and (= (of_int 0) (rec__default_init__mut_discr__b d4__split_discrs)) (= d4__attr__constrained true)))
...
(assert (and (= (of_int 1) (rec__default_init__mut_discr__b d5__split_discrs)) (= d5__attr__constrained true)))
