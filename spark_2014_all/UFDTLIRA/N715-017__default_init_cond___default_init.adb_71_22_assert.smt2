...
(assert (default_initial_assumption2 (mk___rep d2__split_discrs (mk___split_fields d2__split_fields)) false))
(assert (= (distinct 0 0) (rec__default_init__discr__b d2__split_discrs)))
(assert (default_initial_assumption (mk___rep1 (mk___split_discrs1 d3__split_discrs) (mk___split_fields1 d3__split_fields) d3__attr__constrained) false))
(assert (default_initial_assumption3 (mk___rep1 d4__split_discrs (mk___split_fields1 d4__split_fields) d4__attr__constrained) false))
(assert (and (= (distinct 0 0) (rec__default_init__mut_discr__b d4__split_discrs)) (= d4__attr__constrained true)))
(assert (default_initial_assumption4 (mk___rep1 d5__split_discrs (mk___split_fields1 d5__split_fields) d5__attr__constrained) false))
(assert (and (= (distinct 1 0) (rec__default_init__mut_discr__b d5__split_discrs)) (= d5__attr__constrained true)))
(assert (not (= (to_rep d1__split_fields) 0)))
(check-sat)
(exit)
