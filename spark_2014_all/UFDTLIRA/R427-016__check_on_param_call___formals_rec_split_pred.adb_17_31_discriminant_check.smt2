...
(define-fun dynamic_invariant ((temp___expr_220 us_rep) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool (and (=> (not (= temp___skip_constant_217 true)) (in_range3 (distinct 1 0) temp___expr_220)) (=> (= temp___do_toplevel_218 true) (=> (= temp___is_init_216 true) (not (= (to_rep (rec__formals_rec_split_pred__rec__h (us_split_fields1 temp___expr_220))) 0))))))
(define-fun default_initial_assumption ((temp___expr_223 us_rep) (temp___skip_top_level_224 Bool)) Bool (and (and (and (= (rec__formals_rec_split_pred__rec__d (us_split_discrs1 temp___expr_223)) (distinct 1 0)) (=> (formals_rec_split_pred__rec__f__pred temp___expr_223) (= (to_rep1 (rec__formals_rec_split_pred__rec__f (us_split_fields1 temp___expr_223))) 1))) (=> (formals_rec_split_pred__rec__g__pred temp___expr_223) (= (to_rep1 (rec__formals_rec_split_pred__rec__g (us_split_fields1 temp___expr_223))) 1))) (=> (formals_rec_split_pred__rec__h__pred temp___expr_223) (= (to_rep (rec__formals_rec_split_pred__rec__h (us_split_fields1 temp___expr_223))) 1))))
(define-fun dynamic_predicate ((temp___226 us_rep)) Bool (not (= (to_rep (rec__formals_rec_split_pred__rec__h (us_split_fields1 temp___226))) 0)))
...
(assert (= (distinct 1 0) (rec__formals_rec_split_pred__rec__d (us_split_discrs1 i3b))))
(assert (not (= (ite (rec__formals_rec_split_pred__rec__d (us_split_discrs1 i3b)) 1 0) 1)))
(check-sat)
(exit)
