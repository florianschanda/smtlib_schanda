...
(assert (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions l) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (model__ l) i2) 0))))))
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) true)))
(assert (not (= (has_key (positions l) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
