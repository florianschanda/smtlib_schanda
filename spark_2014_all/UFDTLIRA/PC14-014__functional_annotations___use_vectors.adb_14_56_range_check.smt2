...
(assert (and (= o2 (last4 (model__ (mk___rep v2__split_discrs (mk___split_fields v2__split_fields1))))) (and (dynamic_property4 first3 last5 o2) (= o2 (last4 (model__ (mk___rep v2__split_discrs (mk___split_fields v2__split_fields1))))))))
(assert (= o3 (ite (<= n o2) true false)))
(assert (= result2 (ite (<= first n) o3 false)))
(assert (= result2 true))
