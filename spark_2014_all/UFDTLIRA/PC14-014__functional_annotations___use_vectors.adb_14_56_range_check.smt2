...
(assert (forall ((n1 Int)) (=> (and (<= first n1) (<= n1 (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2))))) (= (is_incr (get (model__ v1) n1) (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n1)) true))))
...
(assert (and (= o1 (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2)))) (and (dynamic_property4 first3 last5 o1) (= o1 (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2)))))))
