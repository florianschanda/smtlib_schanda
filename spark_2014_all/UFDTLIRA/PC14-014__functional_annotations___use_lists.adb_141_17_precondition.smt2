...
(assert (and (= o16 (get1 o15 fst)) (and (in_range4 o16) (=> (= (of_int 0) true) (and (= o16 (w_get o15 (witness o15 fst))) (forall ((k us_rep1)) (=> (= (has_key o15 k) true) (= (= (bool_eq1 k fst) true) (= (witness o15 fst) (witness o15 k))))))))))
(assert (= o21 (ite (<= o16 i) true false)))
(assert (= result4 (ite (= o21 true) o20 false)))
(assert (= result4 true))
(assert (and (= o23 i) (in_range2 i)))
(assert (and (= o22 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o22) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (not (<= 1 o23)))
(check-sat)
(exit)
