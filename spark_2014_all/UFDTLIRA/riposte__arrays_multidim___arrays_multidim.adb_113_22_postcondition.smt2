...
(define-fun bool_eq ((a map1) (a__first Int) (a__last Int) (a__first_2 Int) (a__last_2 Int) (b map1) (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int)) Bool (ite (and (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (ite (<= a__first_2 a__last_2) (and (<= b__first_2 b__last_2) (= (- a__last_2 a__first_2) (- b__last_2 b__first_2))) (< b__last_2 b__first_2))) (forall ((temp___idx_156 Int) (temp___idx_157 Int)) (=> (and (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (and (<= a__first_2 temp___idx_157) (<= temp___idx_157 a__last_2))) (= (to_rep (get a temp___idx_156 temp___idx_157)) (to_rep (get b (+ (- b__first a__first) temp___idx_156) (+ (- b__first_2 a__first_2) temp___idx_157))))))) true false))
(assert (forall ((a map1) (b map1)) (forall ((a__first Int) (a__last Int) (a__first_2 Int) (a__last_2 Int) (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int)) (=> (= (bool_eq b b__first b__last b__first_2 b__last_2 a a__first a__last a__first_2 a__last_2) true) (and (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (ite (<= a__first_2 a__last_2) (and (<= b__first_2 b__last_2) (= (- a__last_2 a__first_2) (- b__last_2 b__first_2))) (< b__last_2 b__first_2))) (forall ((temp___idx_156 Int) (temp___idx_157 Int)) (=> (and (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (and (<= a__first_2 temp___idx_157) (<= temp___idx_157 a__last_2))) (= (to_rep (get a temp___idx_156 temp___idx_157)) (to_rep (get b (+ (- b__first a__first) temp___idx_156) (+ (- b__first_2 a__first_2) temp___idx_157)))))))))))
