...
(define-fun dynamic_invariant ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 1001)) (in_range temp___expr_171)))
...
(assert (forall ((m map1)) (forall ((i Int)) (forall ((j Int)) (forall ((a value)) (! (= (get (set m i j a) i j) a) :pattern ((set m i j a))))))))
(assert (forall ((m map1)) (forall ((i Int) (i2 Int)) (forall ((j Int) (j2 Int)) (forall ((a value)) (! (=> (not (and (= i i2) (= j j2))) (= (get (set m i j a) i2 j2) (get m i2 j2))) :pattern ((get (set m i j a) i2 j2)) :pattern ((set m i j a) (get m i2 j2))))))))
...
(define-fun bool_eq ((a map1) (a__first Int) (a__last Int) (a__first_2 Int) (a__last_2 Int) (b map1) (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int)) Bool (ite (and (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (ite (<= a__first_2 a__last_2) (and (<= b__first_2 b__last_2) (= (- a__last_2 a__first_2) (- b__last_2 b__first_2))) (< b__last_2 b__first_2))) (forall ((temp___idx_134 Int) (temp___idx_135 Int)) (=> (and (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (and (<= a__first_2 temp___idx_135) (<= temp___idx_135 a__last_2))) (= (to_rep (get a temp___idx_134 temp___idx_135)) (to_rep (get b (+ (- b__first a__first) temp___idx_134) (+ (- b__first_2 a__first_2) temp___idx_135))))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= (- 23) 69)) (in_range1 temp___expr_177)))
...
(assert (in_range i))
(assert (in_range j))
(assert (= (to_rep o) (to_rep (get a j i))))
(assert (= o1 (set a i j o)))
(assert (= result a))
(assert (= a1 o1))
(assert (= (to_rep o2) (to_rep (get a1 0 1))))
(assert (= o3 (set a1 i j o2)))
(assert (= result1 a1))
(assert (= a2 o3))
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (to_rep (get a3 i j)) (to_rep (get a3 j i)))))
(check-sat)
(exit)
