...
(assert (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2)))
(assert (= result1 (mk_int__ref temp___972)))
(assert (= temp___9721 next_idx2))
(assert (= result2 (mk_int__ref temp___971)))
(assert (= temp___9711 (to_int1 (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false))))
