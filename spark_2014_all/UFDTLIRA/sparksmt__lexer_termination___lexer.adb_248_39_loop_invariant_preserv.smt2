...
(declare-const temp___10581 Int)
(declare-const result2 int__ref)
(declare-const temp___10571 Int)
...
(assert (and (and (and (and (= (local_invariant the_file1 current_read__split_fields1 current_read__split_discrs1 current_idx1 next_read__split_fields1 next_read__split_discrs1 next_idx1) true) (= (bool_eq1 (mk___rep current_read__split_discrs1 current_read__split_fields1 current_read__attr__constrained) (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)) true)) (= current_idx1 next_idx)) (<= current_idx current_idx1)) (and (and (and (in_range2 current_line1) (in_range1 current_col1)) (in_range1 current_idx1)) (in_range1 next_idx1))))
...
(assert (= result1 (mk_int__ref temp___1058)))
(assert (= temp___10581 next_idx2))
(assert (= result2 (mk_int__ref temp___1057)))
(assert (= temp___10571 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false) 1 0)))
