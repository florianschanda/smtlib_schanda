...
(assert (= result1 (mk_int__ref temp___9621)))
(assert (= temp___9622 next_idx2))
(assert (= result2 (mk_int__ref temp___9611)))
(assert (= temp___9612 (to_int1 (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false))))
