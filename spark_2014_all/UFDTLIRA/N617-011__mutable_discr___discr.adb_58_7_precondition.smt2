...
(assert (= o10 o11))
(assert (= (mk___rep (mk___split_discrs discr__r4__d2__assume) discr__r4__d2__assume1) o10))
...
(assert (=> (= d2__attr__constrained true) (= (mk___split_discrs discr__r4__nested1__d__discrs) d2__split_discrs)))
(assert (not (not (= d2__attr__constrained true))))
(check-sat)
(exit)
