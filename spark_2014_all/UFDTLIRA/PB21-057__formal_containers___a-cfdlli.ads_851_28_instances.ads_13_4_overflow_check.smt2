...
(define-fun dynamic_invariant1 ((temp___expr_666 Int) (temp___is_init_662 Bool) (temp___skip_constant_663 Bool) (temp___do_toplevel_664 Bool) (temp___do_typ_inv_665 Bool)) Bool (=> (or (= temp___is_init_662 true) (<= 1 2147483647)) (in_range3 temp___expr_666)))
...
(assert (and (= o (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__instances__lists__list__capacity container__split_discrs))))))
(assert (= o1 (- o count)))
