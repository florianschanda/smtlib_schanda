...
(assert (and (= o32 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (in_range2 o32) (<= o32 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
(assert (and (= o33 (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (in_range2 o33) (<= o33 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
(assert (= result6 (ite (= o33 o32) true false)))
(assert (= result6 true))
(assert (not true))
(check-sat)
(exit)
