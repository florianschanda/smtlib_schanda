...
(assert (and (= temp___1139 (find1 (mk___rep1 l__split_discrs l__split_fields10) o46)) (ite (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields10)) o46) false) true false) (and (not (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1139) true)) (= (bool_eq2 temp___1139 no_element) true)) (and (and (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1139) true) (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1139) (find (elements (mk___rep1 l__split_discrs l__split_fields10)) o46))) (= (equivalent_elements (element (mk___rep1 l__split_discrs l__split_fields10) temp___1139) o46) true)))))
