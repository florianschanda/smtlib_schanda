...
(declare-const temp___1203 us_rep2)
...
(assert (and (= temp___1203 (find1 (mk___rep1 l__split_discrs l__split_fields10) o46)) (ite (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields10)) o46) false) true false) (and (not (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1203) true)) (= (bool_eq2 temp___1203 no_element) true)) (and (and (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1203) true) (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1203) (find (elements (mk___rep1 l__split_discrs l__split_fields10)) o46))) (= (equivalent_elements (element (mk___rep1 l__split_discrs l__split_fields10) temp___1203) o46) true)))))
(assert (= result15 (mk___split_fields__ref2 c__split_fields5)))
(assert (= c__split_fields6 (us_split_fields5 temp___1203)))
(assert (= (to_rep o47) 7))
