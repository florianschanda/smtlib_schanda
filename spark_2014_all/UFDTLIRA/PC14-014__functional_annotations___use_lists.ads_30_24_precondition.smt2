...
(assert (=> (= result1 true) (and (= l2__split_discrs (mk___split_discrs temp___484)) (= temp___4841 l2__split_fields))))
(assert (=> (= result1 true) (= temp___483 cu__split_fields1)))
(assert (=> (= result1 true) (forall ((n2 Int)) (=> (and (<= 1 n2) (<= n2 (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))))) (= (is_incr (get (model__ l1) n2) (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) n2)) true)))))
(assert (=> (= result1 true) (= (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) 1))))
(assert (=> (= result1 true) (and (= o11 (element l1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o11) (= o11 (get (model__ l1) (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result1 true) (= result3 (ite (< o11 2147483647) true false))))
(assert (=> (= result1 true) (=> (= result3 true) (and (= o12 (element l1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o12) (= o12 (get (model__ l1) (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))))
(assert (=> (= result1 true) (=> (= result3 true) (= o13 (+ o12 1)))))
(assert (=> (= result1 true) (=> (= result3 true) (and (= o14 o13) (in_range3 o13)))))
(assert (=> (= result1 true) (=> (= result3 true) (and (and (and (and (and (= (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (+ (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) 1)) (= (get1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))))) (= (keys_included_except (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)) (= (ole1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)) (= (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) o14)) (= (ole (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)))))
(assert (=> (= result1 true) (=> (not (= result3 true)) (and (= o15 (element l1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o15) (= o15 (get (model__ l1) (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))))
(assert (=> (= result1 true) (=> (not (= result3 true)) (and (and (and (and (and (= (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (+ (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) 1)) (= (get1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))))) (= (keys_included_except (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) true)) (= (ole1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) true)) (= (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) o15)) (= (ole (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) true)))))
(assert (=> (= result1 true) (=> (not (= result3 true)) (= (mk___split_fields l2__split_fields2) (mk___split_fields l2__split_fields3)))))
(assert (=> (= result1 true) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length l1)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields3)) no_element) true) (and (= (has_key (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true) (= (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields3))) (+ (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (=> (= result1 true) (and (= o16 (has_key (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields3)))) (= (= o16 true) (= (has_key (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true)))))
(assert (=> (= result1 true) (= result4 (ite (not (= o16 true)) true false))))
...
(assert (=> (= result1 true) (= l2__split_fields4 (mk___split_fields__ref (mk___split_fields l2__split_fields2)))))
(assert (=> (= result1 true) (= cu__split_fields5 (mk___split_fields1 cu__split_fields3))))
(assert (=> (= result1 true) (= l2__split_fields5 (mk___split_fields l2__split_fields2))))
...
(assert (=> (not (= result1 true)) (= l2__split_fields6 (mk___split_fields__ref (mk___split_fields l2__split_fields)))))
(assert (=> (not (= result1 true)) (= cu__split_fields7 (mk___split_fields1 cu__split_fields1))))
(assert (=> (not (= result1 true)) (= l2__split_fields7 (mk___split_fields l2__split_fields))))
...
(assert (and (= o17 (length l1)) (and (in_range2 o17) (<= o17 (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 l1)))))))
(assert (= o18 (ite (<= n1 o17) true false)))
(assert (= result5 (ite (<= 1 n1) o18 false)))
(assert (= result5 true))
(assert (and (= o21 (model__ (mk___rep l2__split_discrs (us_split_fields__content l2__split_fields8)))) (= (length1 o21) (length (mk___rep l2__split_discrs (us_split_fields__content l2__split_fields8))))))
(assert (and (= o22 (get o21 n1)) (in_range4 o22)))
(assert (and (= o19 (model__ l1)) (= (length1 o19) (length l1))))
(assert (not (<= 1 n1)))
(check-sat)
(exit)
