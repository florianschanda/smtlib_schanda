...
(declare-const temp___595 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___595 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___595)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__replacement__inverse_sets__map__capacity (us_split_discrs1 container)))))))
