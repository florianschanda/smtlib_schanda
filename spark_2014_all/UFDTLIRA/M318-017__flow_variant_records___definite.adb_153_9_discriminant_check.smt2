...
(declare-const temp___219 status)
(declare-const temp___2191 natural)
(declare-const temp___2192 natural)
(declare-const temp___2193 Bool)
(declare-const temp___2194 Bool)
(assert (= (to_rep1 x__split_discrs) r44b))
...
(assert (= temp___2192 o3))
(assert (= temp___2193 o4))
(assert (= true temp___2194))
(assert (= x__attr__constrained true))
(assert (not (= temp___219 x__split_discrs)))
(check-sat)
(exit)
