...
(assert (=> (not (= result true)) (and (= temp___426 (last4 (model__ container))) (and (dynamic_property4 first3 last5 temp___426) (= temp___426 (last4 (model__ container)))))))
(assert (=> (not (= result true)) (and (= us2 temp___426) (dynamic_property3 first2 last3 temp___426))))
