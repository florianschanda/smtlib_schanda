...
(define-fun dynamic_invariant5 ((temp___expr_832 us_rep) (temp___is_init_829 Bool) (temp___skip_constant_830 Bool) (temp___do_toplevel_831 Bool)) Bool (=> (not (= temp___skip_constant_830 true)) (in_range7 10 temp___expr_832)))
(define-fun default_initial_assumption ((temp___expr_834 us_rep) (temp___skip_top_level_835 Bool)) Bool (and (= (to_rep (rec__my_vectors__v__vector__capacity (us_split_discrs1 temp___expr_834))) 10) (=> (not (= temp___skip_top_level_835 true)) (= (is_empty temp___expr_834) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_841 us_rep) (temp___is_init_838 Bool) (temp___skip_constant_839 Bool) (temp___do_toplevel_840 Bool)) Bool (=> (not (= temp___skip_constant_839 true)) (in_range8 10 temp___expr_841)))
(define-fun default_initial_assumption1 ((temp___expr_843 us_rep) (temp___skip_top_level_844 Bool)) Bool (and (= (to_rep (rec__my_vectors__v__vector__capacity (us_split_discrs1 temp___expr_843))) 10) (=> (not (= temp___skip_top_level_844 true)) (= (is_empty temp___expr_843) true))))
...
(define-fun l__split_fields29 () us_split_fields (mk___split_fields l__split_fields2))
...
(define-fun l__split_fields30 () us_split_fields (mk___split_fields l__split_fields1))
...
(define-fun my_bounded_vectors__test_bounded_vectors__B_1__i__assume2 () us_rep (mk___rep (mk___split_discrs my_bounded_vectors__test_bounded_vectors__B_1__i__assume) (mk___split_fields my_bounded_vectors__test_bounded_vectors__B_1__i__assume1)))
...
(assert (= l__split_fields30 my_vectors__v__append__2__container__fields1))
(assert (and (and (= (length (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1)) (+ (length (mk___rep l__split_discrs l__split_fields30)) 4)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields30)) (model__ (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1))) true)) (=> (< 0 4) (= (constant_range (model__ (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1)) (+ (last (model__ (mk___rep l__split_discrs l__split_fields30))) 1) (+ (last (model__ (mk___rep l__split_discrs l__split_fields30))) 4) 9) true))))
(assert (= result2 l__split_fields1))
(assert (= l__split_fields29 my_vectors__v__append__3__container__fields1))
(assert (and (= (length (mk___rep l__split_discrs my_vectors__v__delete_last__container__fields1)) (- (length (mk___rep l__split_discrs l__split_fields29)) 1)) (= (olt (model__ (mk___rep l__split_discrs my_vectors__v__delete_last__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields29))) true)))
