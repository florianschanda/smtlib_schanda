...
(assert (not (or (and (<= 1 o24) (<= o24 (last (model__ (mk___rep l__split_discrs l__split_fields28))))) (and (not (= o24 0)) (= (- o24 1) (last (model__ (mk___rep l__split_discrs l__split_fields28))))))))
(check-sat)
(exit)
