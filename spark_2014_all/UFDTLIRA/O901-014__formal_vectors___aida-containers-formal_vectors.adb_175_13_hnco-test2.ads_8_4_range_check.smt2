...
(define-fun dynamic_invariant ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 2147483647)) (in_range temp___expr_242)))
...
(define-fun has_element ((container1 us_rep) (position1 Int)) Bool (and (ite (<= 1 position1) true false) (ite (<= position1 (last_index container1)) true false)))
...
(define-fun dynamic_invariant3 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483647)) (in_range1 temp___expr_249)))
...
(define-fun dynamic_invariant4 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 2147483647)) (in_range6 temp___expr_420)))
...
(assert (forall ((container1 us_rep2)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant6 position1 true true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant7 (get container1 position1) true false true true)) :pattern ((get container1 position1))))))
