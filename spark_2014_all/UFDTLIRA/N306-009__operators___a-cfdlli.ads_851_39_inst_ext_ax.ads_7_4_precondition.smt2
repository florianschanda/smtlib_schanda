...
(assert (and (= o (positions (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (not (= (has_key o no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o i) true) (and (and (<= 1 (get o i)) (<= (get o i) (length (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get o i) (get o j)) (= (bool_eq1 i j) true))))))))))
