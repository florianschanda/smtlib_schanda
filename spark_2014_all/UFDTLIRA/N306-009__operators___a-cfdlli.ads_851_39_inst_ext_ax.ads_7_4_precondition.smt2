...
(define-fun default_initial_assumption ((temp___expr_367 us_rep1) (temp___skip_top_level_368 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 temp___expr_367))) 0))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range3 temp___expr_411)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption1 ((temp___expr_418 us_rep2) (temp___skip_top_level_419 Bool)) Bool (=> (not (= temp___skip_top_level_419 true)) (and (= (is_empty temp___expr_418) true) (= (length1 temp___expr_418) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_406 us_rep1) (temp___skip_top_level_407 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 temp___expr_406))) 0))
