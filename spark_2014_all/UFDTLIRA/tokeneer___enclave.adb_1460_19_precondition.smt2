...
(assert (= o6 (islocked (us_private__content state36))))
(assert (= o7 (ite (not (= o6 true)) true false)))
(assert (= result3 (ite (= o7 true) (islocked state2) false)))
(assert (=> (= result3 true) (and (= o8 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o8))))
(assert (=> (= result3 true) (= o9 (ite (= o8 3) true false))))
(assert (=> (= result3 true) (= o10 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result3 true) (= o11 (ite (= o10 true) o9 false))))
(assert (=> (not (= result3 true)) (= o11 (of_int 1))))
(assert (and (= o3 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range1 o3)))
(assert (= result4 (ite (= o3 1) true false)))
(assert (= result4 true))
(assert (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))))
