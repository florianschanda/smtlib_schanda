...
(declare-const temp___3321 unsigned_byte)
(declare-const temp___3322 unsigned_byte)
...
(assert (= x__split_fields3 (mk___split_fields1 temp___332 (mk___rep (mk___split_fields temp___3321 temp___3322)))))
...
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= temp___335 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15))))))
(assert (= result2 (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___335)))
