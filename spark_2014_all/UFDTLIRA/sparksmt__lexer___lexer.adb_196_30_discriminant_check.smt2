...
(declare-const temp___914 us_rep)
...
(assert (=> (= result true) (= temp___914 the_file)))
(assert (=> (= result true) (and (= next_read__split_discrs1 (mk___split_discrs temp___913)) (and (= next_read__split_fields1 (mk___split_fields temp___9131)) (= next_read__attr__constrained temp___9132)))))
(assert (=> (= result true) (= temp___912 current_pos1)))
(assert (=> (= result true) (= temp___911 current_col1)))
(assert (=> (= result true) (= temp___910 current_line1)))
(assert (=> (= result true) (= temp___909 (mk___rep current_read__split_discrs1 current_read__split_fields1 current_read__attr__constrained))))
(assert (=> (= result true) (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_pos2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (let ((temp___916 (to_rep (rec__file_io__read_result__c current_read__split_fields2)))) (or (= temp___916 10) (or (= temp___916 13) (or (= temp___916 32) (= temp___916 9)))))))))
