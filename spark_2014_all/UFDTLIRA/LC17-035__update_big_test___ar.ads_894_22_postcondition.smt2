...
(assert (= temp___6883 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
...
(assert (= r__split_fields5 (us_split_fields5 temp___6883)))
(assert (= r__split_fields6 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields7 r__split_fields5))
(assert (not (= (to_rep3 (rec__ar__rec3t__g3 (us_split_fields__content2 r__split_fields6))) (to_rep3 r__split_fields4))))
(check-sat)
(exit)
