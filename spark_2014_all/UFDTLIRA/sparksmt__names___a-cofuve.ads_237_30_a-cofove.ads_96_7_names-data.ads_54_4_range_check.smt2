...
(define-fun dynamic_invariant ((temp___expr_253 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 2147483646)) (in_range2 temp___expr_253)))
...
(define-fun dynamic_invariant1 ((temp___expr_265 Int) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool)) Bool (=> (or (= temp___is_init_262 true) (<= (- 1) 2147483646)) (in_range3 temp___expr_265)))
...
(define-fun dynamic_invariant3 ((temp___expr_259 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 255)) (in_range5 temp___expr_259)))
