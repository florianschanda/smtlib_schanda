...
(assert (not (= (let ((temp___575 (f 1))) (let ((temp___574 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 4))) (ite (= (attr__tag temp___574) (attr__tag temp___575)) (us_dispatch_eq temp___574 temp___575) false))) true)))
(check-sat)
(exit)
