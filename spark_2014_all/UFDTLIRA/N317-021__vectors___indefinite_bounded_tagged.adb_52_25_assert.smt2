...
(assert (not (= (let ((temp___618 (f 1))) (let ((temp___617 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 4))) (ite (= (attr__tag temp___617) (attr__tag temp___618)) (us_dispatch_eq temp___617 temp___618) false))) true)))
(check-sat)
(exit)
