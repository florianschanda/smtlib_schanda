...
(assert (= (to_rep1 o) 2))
(assert (= o o7))
(assert (= temp___1061 o7))
(assert (= temp___10611 o3))
(assert (= temp___10612 o4))
(assert (= temp___10613 o5))
(assert (= temp___10614 o6))
(assert (= true temp___10615))
(assert (= t__attr__constrained true))
(assert (not (= temp___1061 t__split_discrs)))
(check-sat)
(exit)
