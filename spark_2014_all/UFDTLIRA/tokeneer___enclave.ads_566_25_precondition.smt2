...
(assert (and (= o23 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o23)))
...
(assert (=> (= result true) (and (= o24 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o24))))
(assert (=> (= result true) (= o25 (ite (= o24 3) true false))))
(assert (=> (= result true) (= o26 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (and (= o19 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o19)))
(assert (= o20 (ite (= o19 4) true false)))
(assert (= o21 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result1 (ite (= o21 true) o20 false)))
(assert (=> (= result1 true) (and (= o22 (statusiswaitingstartadminop status)) (= (= o22 true) (= status 6)))))
(assert (=> (not (= result1 true)) (= o22 (of_int 1))))
(assert (and (= result2 (statusisshutdown status)) (= (= result2 true) (= status 8))))
(assert (=> (= result2 true) (and (= o15 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o15))))
(assert (=> (= result2 true) (= o16 (ite (= o15 0) true false))))
(assert (=> (= result2 true) (= o14 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (and (= result3 (statusisenclavequiescent status)) (= (= result3 true) (= status 3))))
(assert (=> (= result3 true) (= o12 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result4 true) (= o9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result4 true) (= o10 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result5 true) (= o5 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result6 true) (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
