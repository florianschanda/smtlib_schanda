...
(define-fun default_initial_assumption ((temp___expr_328 us_rep) (temp___skip_top_level_329 Bool)) Bool (=> (not (= temp___skip_top_level_329 true)) (= (is_empty temp___expr_328) true)))
...
(define-fun equivalent_elements ((left1 Int) (right1 Int)) Bool (and (not (my_lt left1 right1)) (not (my_lt right1 left1))))
...
(define-fun dynamic_invariant2 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 100)) (in_range4 temp___expr_321)))
(declare-fun contains (us_rep Int) Bool)
(declare-fun contains__function_guard (Bool us_rep Int) Bool)
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
