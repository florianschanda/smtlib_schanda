...
(define-fun dynamic_invariant ((temp___expr_649 Int) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool)) Bool (=> (or (= temp___is_init_646 true) (<= 0 4)) (in_range4 temp___expr_649)))
...
(define-fun dynamic_invariant2 ((temp___expr_661 Int) (temp___is_init_658 Bool) (temp___skip_constant_659 Bool) (temp___do_toplevel_660 Bool)) Bool (=> (or (= temp___is_init_658 true) (<= 3 4)) (in_range5 temp___expr_661)))
