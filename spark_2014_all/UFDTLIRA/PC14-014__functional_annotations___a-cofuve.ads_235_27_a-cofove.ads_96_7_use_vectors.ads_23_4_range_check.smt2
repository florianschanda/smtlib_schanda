...
(assert (and (= o13 (last2 left)) (and (dynamic_property1 first1 last1 o13) (= o13 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o13) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o11 first) (in_range1 first))))
(assert (=> (< offset 0) (and (= o12 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o12 o11) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o6 lst1) (in_range1 lst1)))
(assert (and (= o3 (length right)) (and (in_range3 o3) (<= (+ (- first 1) o3) last))))
