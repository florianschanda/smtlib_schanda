...
(define-fun dynamic_invariant1 ((temp___expr_491 Int) (temp___is_init_487 Bool) (temp___skip_constant_488 Bool) (temp___do_toplevel_489 Bool) (temp___do_typ_inv_490 Bool)) Bool (=> (or (= temp___is_init_487 true) (<= 0 2147483647)) (in_range4 temp___expr_491)))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant2 ((temp___expr_498 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool) (temp___do_typ_inv_497 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 0 2147483647)) (in_range3 temp___expr_498)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 0 0) true) (to_rep (rec__names__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun dynamic_invariant3 ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 1 2147483647)) (in_range5 temp___expr_474)))
...
(define-fun dynamic_invariant5 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range7 temp___expr_296)))
...
(define-fun dynamic_invariant6 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range8 temp___expr_210)))
...
(define-fun default_initial_assumption ((temp___expr_540 us_rep1) (temp___skip_top_level_541 Bool)) Bool (=> (not (= temp___skip_top_level_541 true)) (= (length1 temp___expr_540) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_532 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool) (temp___do_typ_inv_531 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= 0 2147483647)) (in_range9 temp___expr_532)))
