...
(declare-const test__test_7__result1 Int)
(declare-const test__test_7__result2 Int)
(declare-const test__test_7__result3 Int)
(declare-const test__test_7__result4 Int)
(declare-const test__test_7__result5 Int)
(declare-const result1 Int)
(assert (= test__test_7__result1 test__test_7__result2))
(assert (= test__test_7__result3 test__test_7__result1))
(assert (= result test__test_7__result))
(assert (= test__test_7__result1 (to_rep (get mat 1 2))))
(assert (= (mk_int__ref test__test_7__result4) (mk_int__ref test__test_7__result2)))
(assert (= test__test_7__result5 test__test_7__result3))
(assert (= result1 test__test_7__result4))
(assert (not (= test__test_7__result4 1)))
(check-sat)
(exit)
