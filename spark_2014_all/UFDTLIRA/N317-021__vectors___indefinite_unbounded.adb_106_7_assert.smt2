...
(assert (= v__split_fields13 indefinite_unbounded__vect__clear__container__fields1))
...
(assert (= v__split_fields12 indefinite_unbounded__vect__append__2__container__fields4))
...
(assert (not (not (and (and (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2)) (and (in_range4 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2)))) (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__replace_element__container__fields1)) (length (mk___rep v__split_discrs v__split_fields10))) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__replace_element__container__fields1)) 1) o2)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields10)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__replace_element__container__fields1)) 1) true))) (and (= result11 (mk___split_fields__ref v__split_fields10)) (= v__split_fields11 indefinite_unbounded__vect__replace_element__container__fields1))))))
(check-sat)
(exit)
