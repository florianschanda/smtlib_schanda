...
(define-fun dynamic_invariant ((temp___expr_215 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= 1 2147483647)) (in_range2 temp___expr_215)))
...
(define-fun dynamic_invariant1 ((temp___expr_227 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 0 2147483647)) (in_range3 temp___expr_227)))
...
(define-fun dynamic_invariant3 ((temp___expr_221 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_221)))
