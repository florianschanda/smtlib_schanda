...
(define-fun in_range1 ((x Int)) Bool (and (<= 10 x) (<= x 90)))
(declare-fun attr__ATTRIBUTE_IMAGE1 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) Int)
(declare-fun user_eq1 (et3 et3) Bool)
(declare-const dummy1 et3)
(declare-datatypes () ((et3__ref (mk_et3__ref (et3__content et3)))))
(define-fun et3__ref___projection ((a et3__ref)) et3 (et3__content a))
(define-fun dynamic_invariant1 ((temp___expr_218 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 10 90)) (in_range1 temp___expr_218)))
(define-fun to_rep1 ((x et3)) Int (et3qtint x))
(declare-fun of_rep1 (Int) et3)
(assert (forall ((x et3)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x et3)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Int)) (! (=> (in_range1 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
(declare-sort et4 0)
(declare-fun et4qtint (et4) Int)
(assert (forall ((i et4)) (and (<= 50 (et4qtint i)) (<= (et4qtint i) 59))))
(define-fun in_range2 ((x Int)) Bool (and (<= 50 x) (<= x 59)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq2 (et4 et4) Bool)
(declare-const dummy2 et4)
(declare-datatypes () ((et4__ref (mk_et4__ref (et4__content et4)))))
(define-fun et4__ref___projection ((a et4__ref)) et4 (et4__content a))
(define-fun dynamic_invariant2 ((temp___expr_225 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 50 59)) (in_range2 temp___expr_225)))
(define-fun to_rep2 ((x et4)) Int (et4qtint x))
(declare-fun of_rep2 (Int) et4)
(assert (forall ((x et4)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x et4)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 a))) (to_rep (rec__ar__rec1t__f1 (us_split_fields1 b)))) (= (to_rep4 (rec__ar__rec1t__g1 (us_split_fields1 a))) (to_rep4 (rec__ar__rec1t__g1 (us_split_fields1 b))))) true false))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields5 a)) (rec__ar__rec3t__f3 (us_split_fields5 b))) true) (= (to_rep2 (rec__ar__rec3t__g3 (us_split_fields5 a))) (to_rep2 (rec__ar__rec3t__g3 (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 1 25)) (in_range4 temp___expr_211)))
...
(declare-const r__split_fields7 us_split_fields4)
(declare-const result3 us_split_fields__ref2)
(declare-const r__split_fields8 us_split_fields4)
(declare-const r__split_fields9 us_split_fields__ref2)
(declare-const r__split_fields10 us_split_fields4)
(assert (in_range e))
(assert (in_range1 f))
(assert (in_range2 g))
(assert (= (to_rep o) e))
...
(assert (= temp___6919 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)) o16)) o17))))
(assert (= result (mk___split_fields__ref2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)) r__split_fields3)) r__split_fields4))))
(assert (= r__split_fields5 (us_split_fields5 temp___6919)))
(assert (= (to_rep3 o18) 2))
(assert (= o19 (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))) (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields5))) o18)))
(assert (= o20 (mk___rep1 o19)))
(assert (= o21 (mk___split_fields2 o20 (rec__ar__rec3t__g3 r__split_fields5))))
(assert (= temp___6922 (mk___rep2 o21)))
(assert (= result1 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields6 (us_split_fields5 temp___6922)))
(assert (= (to_rep2 o22) g))
(assert (= o23 (mk___split_fields2 (rec__ar__rec3t__f3 r__split_fields6) o22)))
(assert (= temp___6924 (mk___rep2 o23)))
(assert (= result2 (mk___split_fields__ref2 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields5 temp___6924)))
(assert (= (to_rep1 o24) f))
(assert (= o25 (mk___split_fields1 o24 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields7))) (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec3t__f3 r__split_fields7))))))
(assert (= o26 (mk___rep1 o25)))
(assert (= o27 (mk___split_fields2 o26 (rec__ar__rec3t__g3 r__split_fields7))))
(assert (= temp___6927 (mk___rep2 o27)))
(assert (= result3 (mk___split_fields__ref2 r__split_fields7)))
(assert (= r__split_fields8 (us_split_fields5 temp___6927)))
(assert (= r__split_fields9 (mk___split_fields__ref2 r__split_fields8)))
(assert (= r__split_fields10 r__split_fields8))
(assert (not (= (to_rep2 (rec__ar__rec3t__g3 (us_split_fields__content2 r__split_fields9))) g)))
(check-sat)
(exit)
