...
(define-fun default_initial_assumption ((temp___expr_136 us_rep) (temp___skip_top_level_137 Bool)) Bool (and (= (attr__tag temp___expr_136) us_tag) (and (and (= (to_rep (rec__object__t__area (us_split_fields1 temp___expr_136))) (- 1)) (= (to_rep (rec__object__t__max_width (us_split_fields1 temp___expr_136))) (- 1))) (= (to_rep (rec__object__t__max_height (us_split_fields1 temp___expr_136))) (- 1)))))
...
(assert true)
(assert true)
(assert (forall ((obj us_rep)) (! (= (to_int1 (has_stored_area obj)) (to_int1 (has_stored_area1 us_tag obj))) :pattern ((has_stored_area1 us_tag obj)))))
...
(assert (forall ((obj us_rep)) (! (=> (= (has_stored_area obj) true) (dynamic_invariant (get_stored_area obj) true false true)) :pattern ((get_stored_area obj)))))
(assert (forall ((attr__tag1 Int)) (forall ((obj us_rep)) (! (=> (= (has_stored_area1 (attr__tag obj) obj) true) (dynamic_invariant (get_stored_area1 attr__tag1 obj) true false true)) :pattern ((get_stored_area1 attr__tag1 obj))))))
...
(assert (not (= (has_stored_area (mk___rep (mk___split_fields obj__split_fields8 obj__split_fields9 obj__split_fields10 obj__split_fields11) obj__attr__tag)) true)))
(check-sat)
(exit)
