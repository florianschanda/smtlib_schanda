...
(declare-const temp___1703 us_private)
...
(assert (= temp___170 o1))
(assert (= temp___1701 o2))
(assert (= temp___1702 o3))
(assert (= temp___1703 o4))
(assert (= obj__attr__tag temp___1704))
...
(assert (= temp___170 obj__split_fields4))
(assert (= temp___1701 obj__split_fields5))
(assert (= temp___1702 obj__split_fields6))
(assert (= temp___1703 obj__split_fields7))
