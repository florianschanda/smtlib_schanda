...
(declare-const temp___7379 us_rep3)
...
(assert (= temp___7379 (mk___rep3 o19)))
(assert (= result3 (mk___split_fields__ref3 r__split_fields8)))
(assert (= r__split_fields9 (us_split_fields7 temp___7379)))
(assert (= r__split_fields10 (mk___split_fields__ref3 r__split_fields9)))
(assert (= r__split_fields11 r__split_fields9))
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 (us_split_fields__content3 r__split_fields10))))))) (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 b))))))
(check-sat)
(exit)
