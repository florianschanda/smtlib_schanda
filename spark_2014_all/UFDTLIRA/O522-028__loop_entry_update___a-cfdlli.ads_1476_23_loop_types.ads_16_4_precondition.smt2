...
(define-fun dynamic_invariant ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 2147483647)) (in_range2 temp___expr_403)))
...
(define-fun dynamic_invariant2 ((temp___expr_468 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool) (temp___do_typ_inv_467 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 1 2147483647)) (in_range3 temp___expr_468)))
...
(define-fun default_initial_assumption1 ((temp___expr_476 us_rep3) (temp___skip_top_level_477 Bool)) Bool (=> (not (= temp___skip_top_level_477 true)) (and (= (is_empty temp___expr_476) true) (= (length2 temp___expr_476) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_454 us_rep2) (temp___skip_top_level_455 Bool)) Bool (=> (not (= temp___skip_top_level_455 true)) (= (length1 temp___expr_454) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_446 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool) (temp___do_typ_inv_445 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 2147483647)) (in_range4 temp___expr_446)))
...
(define-fun dynamic_invariant4 ((temp___expr_439 Int) (temp___is_init_435 Bool) (temp___skip_constant_436 Bool) (temp___do_toplevel_437 Bool) (temp___do_typ_inv_438 Bool)) Bool (=> (or (= temp___is_init_435 true) (<= 0 2147483647)) (in_range5 temp___expr_439)))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___743 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___743)) no_element))
