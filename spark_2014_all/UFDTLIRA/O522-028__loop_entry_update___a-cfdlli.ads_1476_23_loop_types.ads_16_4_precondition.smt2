...
(define-fun dynamic_invariant ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= 0 2147483647)) (in_range2 temp___expr_358)))
...
(define-fun dynamic_invariant2 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range3 temp___expr_414)))
...
(define-fun default_initial_assumption1 ((temp___expr_421 us_rep3) (temp___skip_top_level_422 Bool)) Bool (=> (not (= temp___skip_top_level_422 true)) (and (= (is_empty temp___expr_421) true) (= (length2 temp___expr_421) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_402 us_rep2) (temp___skip_top_level_403 Bool)) Bool (=> (not (= temp___skip_top_level_403 true)) (= (length1 temp___expr_402) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range4 temp___expr_395)))
...
(define-fun dynamic_invariant4 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 0 2147483647)) (in_range5 temp___expr_389)))
...
(declare-const temp___686 count_type)
(declare-const o2 us_rep3)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___686 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___686)) no_element))
