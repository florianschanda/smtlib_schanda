...
(assert (forall ((n Int)) (=> (and (<= 1 n) (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields3)) 1))) (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs l__split_fields4)) n)) true))))
(assert (forall ((n Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields3)) n) (<= n (length (mk___rep l__split_discrs l__split_fields4)))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs l__split_fields4)) n)))))
...
(assert (and (= o (element (mk___rep l__split_discrs l__split_fields4) (mk___rep1 cu__split_fields3))) (and (in_range6 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields4)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields3)))))))
(assert (= result2 (ite (< o 2147483647) true false)))
(assert (=> (= result2 true) (and (= o1 (element (mk___rep l__split_discrs l__split_fields4) (mk___rep1 cu__split_fields3))) (and (in_range6 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields4)) (get1 (positions (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 cu__split_fields3))))))))
(assert (=> (= result2 true) (= o2 (+ o1 1))))
(assert (=> (= result2 true) (and (= o3 o2) (in_range1 o2))))
(assert (=> (= result2 true) (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields4))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields4)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3))) o3)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields4)) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3))) true))))
(assert (=> (not (= result2 true)) (= l__split_fields3 l__split_fields4)))
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
