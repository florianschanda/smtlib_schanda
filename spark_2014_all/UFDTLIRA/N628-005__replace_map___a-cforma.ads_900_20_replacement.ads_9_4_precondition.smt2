...
(define-fun default_initial_assumption ((temp___expr_434 us_rep2) (temp___skip_top_level_435 Bool)) Bool (=> (not (= temp___skip_top_level_435 true)) (and (= (is_empty temp___expr_434) true) (= (length1 temp___expr_434) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_375 us_rep3) (temp___skip_top_level_376 Bool)) Bool (=> (not (= temp___skip_top_level_376 true)) (and (= (is_empty1 temp___expr_375) true) (= (length2 temp___expr_375) 0))))
(assert true)
