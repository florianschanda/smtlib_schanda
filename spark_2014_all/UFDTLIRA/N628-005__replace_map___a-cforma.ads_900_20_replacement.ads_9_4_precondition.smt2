...
(define-fun dynamic_invariant1 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 1 2147483647)) (in_range2 temp___expr_426)))
...
(define-fun default_initial_assumption ((temp___expr_434 us_rep2) (temp___skip_top_level_435 Bool)) Bool (=> (not (= temp___skip_top_level_435 true)) (and (= (is_empty temp___expr_434) true) (= (length2 temp___expr_434) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_375 us_rep3) (temp___skip_top_level_376 Bool)) Bool (=> (not (= temp___skip_top_level_376 true)) (and (= (is_empty1 temp___expr_375) true) (= (length3 temp___expr_375) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_367 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool) (temp___do_typ_inv_366 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_367)))
