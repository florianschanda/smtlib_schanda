...
(define-fun dynamic_invariant ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 2147483647)) (in_range1 temp___expr_143)))
...
(define-fun dynamic_invariant1 ((temp___expr_384 Int) (temp___is_init_381 Bool) (temp___skip_constant_382 Bool) (temp___do_toplevel_383 Bool)) Bool (=> (or (= temp___is_init_381 true) (<= 1 2147483647)) (in_range2 temp___expr_384)))
...
(define-fun default_initial_assumption ((temp___expr_391 us_rep2) (temp___skip_top_level_392 Bool)) Bool (=> (not (= temp___skip_top_level_392 true)) (and (= (is_empty temp___expr_391) true) (= (length2 temp___expr_391) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_340 us_rep3) (temp___skip_top_level_341 Bool)) Bool (=> (not (= temp___skip_top_level_341 true)) (and (= (is_empty1 temp___expr_340) true) (= (length3 temp___expr_340) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_333 Int) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool)) Bool (=> (or (= temp___is_init_330 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_333)))
...
(declare-const temp___564 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___564 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___564)) no_element))
