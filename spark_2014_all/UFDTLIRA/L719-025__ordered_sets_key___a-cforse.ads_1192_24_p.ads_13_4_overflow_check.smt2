...
(assert (and (= (mk___rep (mk___split_discrs o7) (mk___split_fields o8)) (intersection__2 (mk___rep target__split_discrs (mk___split_fields target__split_fields)) source)) (and (and (and (and (and (= (length (mk___rep (mk___split_discrs o7) (mk___split_fields o8))) (num_overlaps (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source))) (= (ole (model__ (mk___rep (mk___split_discrs o7) (mk___split_fields o8))) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (ole (model__ (mk___rep (mk___split_discrs o7) (mk___split_fields o8))) (model__ source)) true)) (= (includes_intersection (model__ (mk___rep (mk___split_discrs o7) (mk___split_fields o8))) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source)) true)) (= (e_elements_included (elements (mk___rep (mk___split_discrs o7) (mk___split_fields o8))) (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (e_elements_included__2 (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source) (elements (mk___rep (mk___split_discrs o7) (mk___split_fields o8)))) true))))
(assert (and (= o9 (length (mk___rep (mk___split_discrs o7) (mk___split_fields o8)))) (and (in_range1 o9) (<= o9 (to_rep o7)))))
