...
(declare-datatypes () ((time_span__ref (mk_time_span__ref (time_span__content us_rep2)))))
(define-fun time_span__ref___projection ((a time_span__ref)) us_rep2 (time_span__content a))
