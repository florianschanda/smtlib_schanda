...
(declare-const temp___7198 et3)
(declare-const temp___71981 et1)
(declare-const temp___71982 et2)
(declare-const temp___71983 enum1ta)
(declare-const temp___71984 et4)
(declare-const temp___71985 enum1t)
...
(declare-const temp___7202 us_rep3)
...
(assert (= o1 o7))
(assert (= temp___7198 o2))
(assert (= temp___71981 o3))
(assert (= temp___71982 o4))
(assert (= temp___71983 o5))
(assert (= temp___71984 o6))
(assert (= temp___71985 o7))
...
(assert (= r__split_fields6 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 temp___7198 (mk___rep (mk___split_fields temp___71981 temp___71982)) temp___71983)) temp___71984)) temp___71985)))
...
(assert (= temp___7202 (mk___rep3 o13)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7202)))
