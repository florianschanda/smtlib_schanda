...
(assert (and (= (mk___rep (mk___split_fields temp___240) temp___2401) (prim_func (mk___split_fields t1_var__split_fields))) (and (= t1_var__split_fields temp___240) (= t1_var__attr__tag temp___2401))))
(assert (not (us_compatible_tags temp___2401 us_tag1)))
(check-sat)
(exit)
