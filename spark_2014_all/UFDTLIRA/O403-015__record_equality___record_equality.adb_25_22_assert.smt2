...
(define-fun dynamic_invariant1 ((temp___expr_205 us_rep1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (in_range1 0 (to_base temp___expr_205))))
(define-fun default_initial_assumption ((temp___expr_207 us_rep1) (temp___skip_top_level_208 Bool)) Bool (and (= (attr__tag1 temp___expr_207) us_tag3) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_207))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_207))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_207))) 0))))
