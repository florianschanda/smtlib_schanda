...
(declare-const result5 et3)
(declare-const result6 et1)
(declare-const result7 et2)
(declare-const result8 enum1ta)
(declare-const result9 et4)
(declare-const r__split_fields10 us_split_fields4)
(declare-const r__split_fields11 us_split_fields__ref2)
(declare-const r__split_fields12 us_split_fields4)
...
(assert (= a (mk___rep1 (mk___split_fields1 r__split_fields5 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) r__split_fields8))))
...
(assert (= r__split_fields10 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields5 b r__split_fields8)) r__split_fields9)))
(assert (= r__split_fields11 (mk___split_fields__ref2 r__split_fields10)))
(assert (= r__split_fields12 r__split_fields10))
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields11))))) (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 a))))))
(check-sat)
(exit)
