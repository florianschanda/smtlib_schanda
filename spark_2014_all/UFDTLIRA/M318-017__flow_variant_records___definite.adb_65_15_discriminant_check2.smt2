...
(declare-const temp___195 status)
(declare-const temp___1951 natural)
(declare-const temp___1952 natural)
(declare-const temp___1953 Bool)
(declare-const temp___1954 Bool)
(assert (= (to_rep x__split_discrs) 0))
(assert (= (to_rep x__split_discrs) r7b))
(assert (in_range2 r7b))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___195 o1))
(assert (= rliteral temp___1951))
(assert (= rliteral temp___1952))
(assert (= true temp___1953))
(assert (= true temp___1954))
(assert (= x__attr__constrained true))
(assert (not (= temp___195 x__split_discrs)))
(check-sat)
(exit)
