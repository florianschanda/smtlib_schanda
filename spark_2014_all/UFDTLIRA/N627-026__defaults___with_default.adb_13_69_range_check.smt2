...
(define-fun dynamic_invariant1 ((temp___expr_157 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 2147483647)) (in_range1 temp___expr_157)))
...
(define-fun dynamic_invariant2 ((temp___expr_163 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_163)))
(assert (= first c))
...
(define-fun dynamic_invariant3 ((temp___expr_169 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= first1 2147483647)) (dynamic_property1 first1 2147483647 temp___expr_169)))
(assert (= first1 c))
...
(declare-const no_def Int)
(declare-const no_ini Int)
(declare-const us Int)
(declare-const us1 Int)
(declare-const o Int)
(declare-const result Int)
(declare-const no_def1 Int)
(assert (in_range c))
