...
(declare-const x__split_discrs1 integer)
...
(assert (=> (= x__attr__constrained true) (= rliteral1 x__split_discrs)))
(assert (= rliteral1 usq_))
(assert (= true usq_1))
(assert (= usq_ temp___220))
(assert (= x__attr__constrained temp___2201))
(assert (= result x__split_discrs))
(assert (= x__split_discrs1 temp___220))
(assert (not (= 2 (to_rep rliteral1))))
(check-sat)
(exit)
