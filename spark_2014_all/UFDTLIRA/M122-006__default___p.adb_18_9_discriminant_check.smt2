...
(declare-const temp___220 integer)
(declare-const temp___2201 Bool)
...
(assert (= o15 o16))
(assert (= (mk___rep (mk___split_discrs p__y__assume) p__y__assume1) o15))
...
(assert (=> (= x__attr__constrained true) (= temp___218 x__split_discrs)))
(assert (= (mk___rep (mk___split_discrs usq_) usq_1) (mk___rep (mk___split_discrs temp___218) temp___2181)))
(assert (= usq_ temp___220))
(assert (= x__attr__constrained temp___2201))
(assert (= result (mk___split_discrs__ref (mk___split_discrs x__split_discrs))))
(assert (= x__split_discrs1 (mk___split_discrs temp___220)))
(assert (= (to_rep o10) 3))
(assert (= o10 o11))
(assert (= o12 o11))
(assert (= true o13))
(assert (= o14 (mk___rep (mk___split_discrs o12) o13)))
(assert (not (= 2 (to_rep (rec__p__t__x (us_split_discrs1 o14))))))
(check-sat)
(exit)
