...
(assert (=> (= x__attr__constrained true) (= temp___188 x__split_discrs)))
(assert (= (mk___rep (mk___split_discrs usq_) usq_1) (mk___rep (mk___split_discrs temp___188) temp___1881)))
(assert (= usq_ temp___190))
(assert (= x__attr__constrained temp___1901))
(assert (= result (mk___split_discrs__ref (mk___split_discrs x__split_discrs))))
(assert (= x__split_discrs1 (mk___split_discrs temp___190)))
(assert (= (to_rep o10) 3))
(assert (= o10 o11))
(assert (= o12 o11))
(assert (= true o13))
