...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o1) (= o1 (ite (= (distinct 0 0) true) (to_rep (rec__unbounded_strings__char_vectors__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
