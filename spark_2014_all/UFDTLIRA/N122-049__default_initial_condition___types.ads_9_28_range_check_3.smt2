...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__q__t6__f1 s2) (rec__q__t6__f2 colour)))))
(define-fun us_split_fields_F1__3__projection ((a us_split_fields)) s2 (rec__q__t6__f1 a))
(define-fun us_split_fields_F2__3__projection ((a us_split_fields)) colour (rec__q__t6__f2 a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__q__t6__f1 (us_split_fields1 a))) (to_rep (rec__q__t6__f1 (us_split_fields1 b)))) (= (to_rep1 (rec__q__t6__f2 (us_split_fields1 a))) (to_rep1 (rec__q__t6__f2 (us_split_fields1 b))))) true false))
...
(declare-const q__t6__f1__first__bit Int)
(declare-const q__t6__f1__last__bit Int)
(declare-const q__t6__f1__position Int)
(assert (<= 0 q__t6__f1__first__bit))
(assert (< q__t6__f1__first__bit q__t6__f1__last__bit))
(assert (<= 0 q__t6__f1__position))
(declare-const q__t6__f2__first__bit Int)
(declare-const q__t6__f2__last__bit Int)
(declare-const q__t6__f2__position Int)
(assert (<= 0 q__t6__f2__first__bit))
(assert (< q__t6__f2__first__bit q__t6__f2__last__bit))
(assert (<= 0 q__t6__f2__position))
(declare-fun user_eq2 (us_rep us_rep) Bool)
(declare-const dummy2 us_rep)
(declare-datatypes () ((t6__ref (mk_t6__ref (t6__content us_rep)))))
(define-fun t6__ref___projection ((a t6__ref)) us_rep (t6__content a))
(define-fun default_initial_assumption ((temp___expr_256 us_rep) (temp___skip_top_level_257 Bool)) Bool (and (= (to_rep (rec__q__t6__f1 (us_split_fields1 temp___expr_256))) 3) (= (to_rep1 (rec__q__t6__f2 (us_split_fields1 temp___expr_256))) 1)))
