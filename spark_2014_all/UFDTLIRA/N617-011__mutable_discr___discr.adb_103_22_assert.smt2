...
(define-fun dynamic_invariant1 ((temp___expr_229 us_rep) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (in_range1 c temp___expr_229)) (= (attr__constrained temp___expr_229) true)))
(define-fun default_initial_assumption1 ((temp___expr_231 us_rep) (temp___skip_top_level_232 Bool)) Bool (and (= (attr__constrained temp___expr_231) true) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___expr_231))) c)))
...
(declare-const temp___326 us_rep)
...
(assert (not (= d1__attr__constrained true)))
(check-sat)
(exit)
