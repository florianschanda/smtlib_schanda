...
(define-fun dynamic_invariant2 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range4 temp___expr_414)))
...
(declare-const temp___625 count_type)
(declare-const o2 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___625 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___625)) no_element))
