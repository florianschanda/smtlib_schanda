...
(declare-const temp___422 Bool)
(declare-const temp___4221 unsigned_byte)
(declare-const temp___4222 unsigned_byte)
...
(assert (= (to_rep o1) o))
(assert (= o1 o2))
(assert (= (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair tmp__split_fields3))) o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= (rec__records_prooffuncs__optional_pair__exists tmp__split_fields3) o6))
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= temp___422 o6))
(assert (= temp___4221 o7))
(assert (= temp___4222 o8))
(assert (= result3 (mk___split_fields__ref1 tmp__split_fields3)))
(assert (= tmp__split_fields4 (mk___split_fields1 temp___422 (mk___rep (mk___split_fields temp___4221 temp___4222)))))
(assert (= records__update_b__result4 (mk_optional_pair__ref records__update_b__result3)))
(assert (= records__update_b__result5 records__update_b__result3))
(assert (= result4 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__update_b__result (mk___rep (mk___split_fields records__update_b__result1 records__update_b__result2)))))))
...
(assert (= (mk___rep1 (mk___split_fields1 result5 (mk___rep (mk___split_fields result6 result7)))) (optional_pair__content records__update_b__result6)))
(assert (not (= (bool_eq1 (optional_pair__content records__update_b__result6) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 x)) (mk___rep (mk___split_fields (of_rep n) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x))))))))) true)))
(check-sat)
(exit)
