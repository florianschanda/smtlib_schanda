...
(define-fun dynamic_invariant ((temp___expr_171 ct) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (= temp___do_toplevel_170 true) (not (= temp___is_init_168 true))))
...
(define-fun dynamic_invariant1 ((temp___expr_180 us_rep) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (not (= temp___is_init_177 true)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const c3b ct)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const temp___187 ct)
(assert (not (dynamic_predicate temp___187)))
(check-sat)
(exit)
