...
(declare-const temp___6683 et3)
(declare-const temp___66831 et1)
(declare-const temp___66832 et2)
(declare-const temp___66833 enum1ta)
...
(declare-const temp___6686 et3)
(declare-const temp___66861 et1)
(declare-const temp___66862 et2)
(declare-const temp___66863 enum1ta)
...
(assert (= temp___6683 o5))
(assert (= temp___66831 o6))
(assert (= temp___66832 o7))
(assert (= temp___66833 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6683 (mk___rep (mk___split_fields temp___66831 temp___66832)) temp___66833)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6686 o14))
(assert (= temp___66861 o15))
(assert (= temp___66862 o16))
(assert (= temp___66863 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6686 (mk___rep (mk___split_fields temp___66861 temp___66862)) temp___66863)))
