...
(define-fun default_initial_assumption ((temp___expr_1469 us_rep2) (temp___skip_top_level_1470 Bool)) Bool (= (to_rep (rec__test_02__databaseT__cache (us_split_fields1 temp___expr_1469))) (- 2147483648)))
