...
(assert (and (= o81 (first (mk___rep l4__split_discrs l4__split_fields4))) (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields4)) 0) true) (= (bool_eq1 o81 no_element) true) (and (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o81) true) (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields4)) o81) 1)))))
(assert (not (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o81) true)))
(check-sat)
(exit)
