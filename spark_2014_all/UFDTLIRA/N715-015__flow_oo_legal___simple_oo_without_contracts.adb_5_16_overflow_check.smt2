...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__simple_oo_without_contracts__t__x integer) (rec__ext__ us_private)))))
(define-fun us_split_fields_X__projection ((a us_split_fields)) integer (rec__simple_oo_without_contracts__t__x a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__simple_oo_without_contracts__t__x (us_split_fields1 a))) (to_rep (rec__simple_oo_without_contracts__t__x (us_split_fields1 b)))) true false))
...
(assert (< simple_oo_without_contracts__t__x__first__bit simple_oo_without_contracts__t__x__last__bit))
