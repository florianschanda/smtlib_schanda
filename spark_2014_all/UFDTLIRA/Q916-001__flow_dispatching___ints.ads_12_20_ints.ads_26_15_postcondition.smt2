...
(declare-const temp___657 natural)
(declare-const temp___6571 integer)
(declare-const temp___6572 integer)
(declare-const temp___6573 integer)
(declare-const temp___6574 us_private)
(declare-const temp___6575 Int)
...
(assert (= temp___657 o2))
(assert (= temp___6571 o3))
(assert (= temp___6572 o4))
(assert (= temp___6573 o5))
(assert (= temp___6574 o6))
(assert (= arg__attr__tag temp___6575))
...
(assert (= temp___657 arg__split_fields5))
(assert (= temp___6571 arg__split_fields6))
(assert (= temp___6572 arg__split_fields7))
(assert (= temp___6573 arg__split_fields8))
(assert (= temp___6574 arg__split_fields9))
