...
(declare-const temp___588 natural)
(declare-const temp___5881 integer)
(declare-const temp___5882 integer)
(declare-const temp___5883 integer)
(declare-const temp___5884 us_private)
...
(assert (= temp___5882 o4))
(assert (= temp___5883 o5))
(assert (= temp___5884 o6))
(assert (= arg__attr__tag temp___5885))
...
(assert (= temp___588 arg__split_fields5))
(assert (= temp___5881 arg__split_fields6))
(assert (= temp___5882 arg__split_fields7))
(assert (= temp___5883 arg__split_fields8))
(assert (= temp___5884 arg__split_fields9))
