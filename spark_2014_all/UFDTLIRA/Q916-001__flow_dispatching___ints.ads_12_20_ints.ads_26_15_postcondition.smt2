...
(declare-const temp___664 natural)
(declare-const temp___6641 integer)
(declare-const temp___6642 integer)
(declare-const temp___6643 integer)
(declare-const temp___6644 us_private)
(declare-const temp___6645 Int)
...
(assert (= temp___664 o2))
(assert (= temp___6641 o3))
(assert (= temp___6642 o4))
(assert (= temp___6643 o5))
(assert (= temp___6644 o6))
(assert (= arg__attr__tag temp___6645))
...
(assert (= temp___664 arg__split_fields5))
(assert (= temp___6641 arg__split_fields6))
(assert (= temp___6642 arg__split_fields7))
(assert (= temp___6643 arg__split_fields8))
(assert (= temp___6644 arg__split_fields9))
