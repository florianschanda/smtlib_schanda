...
(declare-const arg__split_fields3 integer)
(declare-const arg__split_fields4 us_private)
(declare-const o Int)
...
(declare-const temp___594 natural)
(declare-const temp___5941 integer)
(declare-const temp___5942 integer)
(declare-const temp___5943 integer)
(declare-const temp___5944 us_private)
(declare-const temp___5945 Int)
...
(declare-const arg__split_fields5 natural)
(declare-const arg__split_fields6 integer)
(declare-const arg__split_fields7 integer)
(declare-const arg__split_fields8 integer)
(declare-const arg__split_fields9 us_private)
(declare-const arg__split_fields10 natural)
(declare-const arg__split_fields11 integer)
(declare-const arg__split_fields12 integer)
(declare-const arg__split_fields13 integer)
(declare-const arg__split_fields14 us_private)
(declare-const arg__split_fields15 natural)
(declare-const arg__split_fields16 integer)
(declare-const arg__split_fields17 integer)
(declare-const arg__split_fields18 integer)
(declare-const arg__split_fields19 us_private)
(assert (< (to_rep arg__split_fields3) (- (to_rep arg__split_fields2) 10)))
(assert (and (= o (+ (to_rep arg__split_fields3) 10)) (in_range (+ (to_rep arg__split_fields3) 10))))
(assert (= (to_rep o1) o))
(assert (= arg__split_fields o2))
(assert (= arg__split_fields1 o3))
(assert (= arg__split_fields2 o4))
(assert (= o1 o5))
(assert (= arg__split_fields4 o6))
(assert (= temp___594 o2))
(assert (= temp___5941 o3))
(assert (= temp___5942 o4))
(assert (= temp___5943 o5))
(assert (= temp___5944 o6))
(assert (= arg__attr__tag temp___5945))
...
(assert (= result4 arg__split_fields4))
(assert (= temp___594 arg__split_fields5))
(assert (= temp___5941 arg__split_fields6))
(assert (= temp___5942 arg__split_fields7))
(assert (= temp___5943 arg__split_fields8))
(assert (= temp___5944 arg__split_fields9))
(assert (= arg__split_fields10 arg__split_fields5))
(assert (= arg__split_fields11 arg__split_fields6))
(assert (= arg__split_fields12 arg__split_fields7))
(assert (= arg__split_fields13 arg__split_fields8))
(assert (= arg__split_fields14 arg__split_fields9))
(assert (= arg__split_fields15 arg__split_fields5))
(assert (= arg__split_fields16 arg__split_fields6))
(assert (= arg__split_fields17 arg__split_fields7))
(assert (= arg__split_fields18 arg__split_fields8))
(assert (= arg__split_fields19 arg__split_fields9))
(assert (not (< (to_rep arg__split_fields3) (to_rep arg__split_fields13))))
(check-sat)
(exit)
