...
(define-fun default_initial_assumption1 ((temp___expr_322 us_rep2) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (is_empty temp___expr_322) true)))
...
(assert (and (= o (length right)) (and (in_range1 o) (<= o (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 right)))))))
