...
(define-fun dynamic_invariant ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_183)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_220)))
...
(define-fun dynamic_invariant3 ((temp___expr_226 Int) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool)) Bool (=> (or (= temp___is_init_223 true) (<= 0 2147483647)) (in_range5 temp___expr_226)))
...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (first_element container))) (and (= result (get (model__ container) 1)) (dynamic_invariant4 result true false true)))) :pattern ((first_element container)))))
...
(define-fun default_initial_assumption1 ((temp___expr_201 us_rep3) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__queue__mylists__cursor__node (us_split_fields3 temp___expr_201))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_252 us_rep2) (temp___skip_top_level_253 Bool)) Bool (=> (not (= temp___skip_top_level_253 true)) (and (= (is_empty1 temp___expr_252) true) (= (length2 temp___expr_252) 0))))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true))) :pattern ((length1 container)))))
(assert (forall ((container us_rep2)) (forall ((key us_rep3)) (! (=> (= (of_int 0) true) (=> (exists ((k us_rep3)) (and (= (has_key container k) true) (= (bool_eq3 k key) true))) (= (has_key container key) true))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant6 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range8 temp___expr_245)))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant1 result true false true)))) :pattern ((witness container key))))))
...
(assert (and (and (and (and (= (mk___rep (mk___split_discrs queue__enqueue__r__assume) (mk___split_fields queue__enqueue__r__assume1)) (copy q 0)) (and (and (= (oeq (model__ (mk___rep (mk___split_discrs queue__enqueue__r__assume) (mk___split_fields queue__enqueue__r__assume1))) (model__ q)) true) (= (oeq1 (positions (mk___rep (mk___split_discrs queue__enqueue__r__assume) (mk___split_fields queue__enqueue__r__assume1))) (positions q)) true)) (= (to_rep queue__enqueue__r__assume) (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))) (and (and (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields r__split_fields))) (= queue__enqueue__r__assume1 r__split_fields1)) (= r__split_discrs (mk___split_discrs queue__enqueue__r__assume)))) (and (and (and (and (= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (+ (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 1)) (= (range_shifted (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) 1 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 1) true)) (= (get (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) 1) v)) (= (p_positions_shifted (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) 1 1) true)) (and (and (and (= queue__enqueue__result4 queue__enqueue__result2) (= queue__enqueue__result5 queue__enqueue__result3)) (= queue__enqueue__result6 (mk___rep (mk___split_discrs queue__enqueue__result2) (mk___split_fields queue__enqueue__result3)))) (and (= (mk_list__ref (mk___rep (mk___split_discrs result1) (mk___split_fields result2))) (mk_list__ref (mk___rep (mk___split_discrs queue__enqueue__result) (mk___split_fields queue__enqueue__result1)))) (and (= r__split_discrs (mk___split_discrs queue__enqueue__result2)) (= queue__enqueue__result3 r__split_fields2)))))) (and (and (= queue__enqueue__result7 (mk_list__ref (mk___rep (mk___split_discrs queue__enqueue__result4) (mk___split_fields queue__enqueue__result5)))) (= r__split_fields3 (mk___split_fields__ref (mk___split_fields r__split_fields2)))) (and (= queue__enqueue__result8 queue__enqueue__result6) (= r__split_fields4 (mk___split_fields r__split_fields2))))))
(assert (and (= o5 (length q)) (and (in_range2 o5) (<= o5 (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))))
(assert (= o6 (+ o5 1)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (= o8 (ite (<= i o7) true false)))
(assert (= result3 (ite (<= 2 i) o8 false)))
(assert (= result3 true))
(assert (and (= o10 (model__ q)) (= (length1 o10) (length q))))
(assert (not (<= 1 (- i 1))))
(check-sat)
(exit)
