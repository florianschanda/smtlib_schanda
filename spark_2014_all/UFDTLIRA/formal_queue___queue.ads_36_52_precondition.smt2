...
(assert (and (= o (length q)) (and (in_range2 o) (<= o (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result3 (ite (<= 2 i) o3 false)))
(assert (= result3 true))
(assert (and (= o4 (model__ q)) (= (length1 o4) (length q))))
(assert (not (<= 1 (- i 1))))
(check-sat)
(exit)
