...
(declare-const temp___242 us_rep)
...
(assert (= o19 o20))
(assert (= (mk___rep (mk___split_discrs main__u1__assume) (mk___split_fields main__u1__assume1 main__u1__assume2) main__u1__assume3) o19))
...
(assert (and (= 1 (to_rep (rec__main__variant_type__discr u2__split_discrs))) (= u2__attr__constrained true)))
...
(assert (= temp___242 (mk___rep (us_split_discrs1 usq_) (us_split_fields1 usq_) u0__attr__constrained)))
(assert (= result2 (mk___split_fields__ref (mk___split_fields u0__split_fields u0__split_fields1))))
(assert (= u0__split_fields2 (us_split_fields1 temp___242)))
(assert (= result3 (mk___split_discrs__ref (mk___split_discrs u0__split_discrs))))
(assert (= u0__split_discrs1 (us_split_discrs1 temp___242)))
(assert (not (= 0 (to_rep (rec__main__variant_type__discr u0__split_discrs1)))))
(check-sat)
(exit)
