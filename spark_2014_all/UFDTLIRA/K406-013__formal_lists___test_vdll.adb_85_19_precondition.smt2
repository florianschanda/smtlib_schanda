...
(assert (and (= o45 (first (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq1 o45 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o45) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o45) 1)))))
