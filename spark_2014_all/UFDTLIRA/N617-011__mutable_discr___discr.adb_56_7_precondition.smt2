...
(define-fun dynamic_invariant1 ((temp___expr_197 us_rep) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (and (=> (not (= temp___skip_constant_195 true)) (in_range2 c temp___expr_197)) (= (attr__constrained temp___expr_197) true)))
(define-fun default_initial_assumption1 ((temp___expr_199 us_rep) (temp___skip_top_level_200 Bool)) Bool (and (= (attr__constrained temp___expr_199) true) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_199))) c)))
...
(declare-const discr__r4__d1__assume natural)
(declare-const discr__r4__d1__assume1 Bool)
...
(declare-const discr__r4__d2__assume natural)
(declare-const discr__r4__d2__assume1 Bool)
(declare-const result natural)
(declare-const d1__split_discrs1 natural)
(declare-const discr__r4__nested1__d__discrs natural)
(assert (in_range c))
(assert (= (to_rep o) c))
(assert (= o o1))
(assert (= discr__r4__d1__assume o1))
(assert (= true discr__r4__d1__assume1))
(assert (= result d1__split_discrs))
(assert (= discr__r4__d1__assume d1__split_discrs1))
...
(assert (= o4 o3))
(assert (= true o5))
(assert (= (mk___rep (mk___split_discrs o6) o7) (mk___rep (mk___split_discrs o4) o5)))
(assert (= (mk___rep (mk___split_discrs o8) o9) (mk___rep (mk___split_discrs o6) o7)))
(assert (= (mk___rep (mk___split_discrs discr__r4__d2__assume) discr__r4__d2__assume1) (mk___rep (mk___split_discrs o8) o9)))
(assert (= d2__split_discrs (mk___split_discrs discr__r4__d2__assume)))
(assert (= d2__attr__constrained true))
(assert (and (= c (to_rep (rec__discr__with_default__c d2__split_discrs))) (= d2__attr__constrained true)))
(assert true)
(assert (not true))
(check-sat)
(exit)
