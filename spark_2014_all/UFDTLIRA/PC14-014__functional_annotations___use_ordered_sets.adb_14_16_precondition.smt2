...
(define-fun default_initial_assumption ((temp___expr_359 us_rep2) (temp___skip_top_level_360 Bool)) Bool (=> (not (= temp___skip_top_level_360 true)) (= (length temp___expr_359) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_379 us_rep3) (temp___skip_top_level_380 Bool)) Bool (=> (not (= temp___skip_top_level_380 true)) (and (= (is_empty temp___expr_379) true) (= (length1 temp___expr_379) 0))))
...
(define-fun e_is_find ((container us_rep2) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (of_int 1)) (ite (< position (length container)) (e_smaller_than_range container (+ position 1) (length container) item) (of_int 1))))
...
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (let ((result (find1 container item))) (ite (not (= (contains (model__ container) item) true)) (and (not (= (has_key (positions container) result) true)) (= (bool_eq1 result no_element) true)) (and (and (= (has_key (positions container) result) true) (= (get1 (positions container) result) (find (elements container) item))) (= (equivalent_elements (element container result) item) true))))) :pattern ((find1 container item))))))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant5 result true false true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (=> (= (of_int 1) true) (=> (exists ((e1 Int)) (and (and (in_range6 e1) (= (contains container e1) true)) (= (equivalent_elements e1 item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant5 (length4 container) true false true) :pattern ((length4 container)))))
...
(declare-const temp___681 count_type)
...
(declare-const use_ordered_sets__my_find__result1 count_type)
(declare-const result count_type)
(declare-const cu__split_fields1 count_type)
(declare-const result1 Bool)
(declare-const cu__split_fields2 count_type)
(declare-const use_ordered_sets__my_find__result2 count_type)
(declare-const result2 Bool)
(declare-const result3 Bool)
(declare-const result4 cursor__ref)
(declare-const use_ordered_sets__my_find__result3 us_rep1)
...
(declare-const use_ordered_sets__my_find__result4 cursor__ref)
(declare-const cu__split_fields5 us_split_fields2)
(declare-const use_ordered_sets__my_find__result5 us_rep1)
(declare-const cu__split_fields6 us_split_fields__ref1)
(declare-const use_ordered_sets__my_find__result6 cursor__ref)
(declare-const cu__split_fields7 us_split_fields2)
(declare-const use_ordered_sets__my_find__result7 us_rep1)
(declare-const cu__split_fields8 us_split_fields__ref1)
(declare-const use_ordered_sets__my_find__result8 cursor__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_ordered_sets__my_find__result9 us_rep1)
(declare-const result7 cursor__ref)
(declare-const use_ordered_sets__my_find__result10 us_rep1)
(declare-const use_ordered_sets__my_find__result11 cursor__ref)
(declare-const use_ordered_sets__my_find__result12 us_rep1)
(declare-const cu__split_fields10 us_split_fields__ref1)
(declare-const use_ordered_sets__my_find__result13 cursor__ref)
(declare-const cu__split_fields11 us_split_fields2)
(declare-const use_ordered_sets__my_find__result14 us_rep1)
(declare-const cu__split_fields12 us_split_fields__ref1)
(declare-const use_ordered_sets__my_find__result15 cursor__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_ordered_sets__my_find__result16 us_rep1)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___681 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___681)) no_element))
(assert (in_range2 e))
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__cu__assume)) (first s)) (ite (= (= (length2 s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__cu__assume)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__cu__assume))) 1)))))
...
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (elements s) i1) e)))))
(assert (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true))
(assert (and (= o8 (element s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (elements s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (= result3 (ite (= o8 e) true false)))
(assert (not (= result3 true)))
(assert (= use_ordered_sets__my_find__result3 (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__result2))))
(assert (not (or (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) true))))
(check-sat)
(exit)
