...
(define-fun dynamic_invariant ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_316)))
...
(define-fun oeq2 ((left us_rep2) (right us_rep2)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun default_initial_assumption ((temp___expr_397 us_rep2) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length temp___expr_397) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_420 us_rep3) (temp___skip_top_level_421 Bool)) Bool (=> (not (= temp___skip_top_level_421 true)) (and (= (is_empty temp___expr_420) true) (= (length1 temp___expr_420) 0))))
...
(define-fun e_is_find ((container us_rep2) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (distinct 1 0)) (ite (< position (length container)) (e_smaller_than_range container (+ position 1) (length container) item) (distinct 1 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length result) (length2 container)) (forall ((temp___435 Int)) (=> (and (in_range4 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun element_type__ref___2__projection ((a element_type__ref4)) element_type4 (element_type__content4 a))
...
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (let ((result (find1 container item))) (ite (not (= (contains (model__ container) item) true)) (and (not (= (has_key (positions container) result) true)) (= (bool_eq1 result no_element) true)) (and (and (= (has_key (positions container) result) true) (= (get1 (positions container) result) (find (elements container) item))) (= (equivalent_elements (element container result) item) true))))) :pattern ((find1 container item))))))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length2 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant5 (length3 attr__tag container) true false true true) :pattern ((length3 attr__tag container))))))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant5 result true false true true)))) :pattern ((find container item))))))
(define-fun e_elements_included ((left us_rep2) (right us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length left))) (and (< 0 (find right (get left i))) (= (get right (find right (get left i))) (get left i))))) true false))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e1 Int)) (and (and (in_range6 e1) (= (contains container e1) true)) (= (equivalent_elements e1 item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant5 (length4 container) true false true true) :pattern ((length4 container)))))
(assert (forall ((container us_rep4)) (! (let ((result (is_empty1 container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range6 item) (= (contains container item) true))))) (= (= result true) (= (length4 container) 0)))) :pattern ((is_empty1 container)))))
...
(declare-const temp___723 count_type)
...
(define-fun use_ordered_sets__my_find__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__cu__assume)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___723 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___723)) no_element))
(assert (in_range2 e))
...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (not (= (get (elements s) i) e)))))
(assert (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true))
(assert (and (= o2 (element s (mk___rep1 cu__split_fields3))) (and (in_range7 o2) (= o2 (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields3)))))))
(assert (= result2 (ite (= o2 e) true false)))
(assert (not (= result2 true)))
(assert (= use_ordered_sets__my_find__result1 (mk___rep1 (mk___split_fields1 use_ordered_sets__my_find__result))))
(assert (not (or (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
