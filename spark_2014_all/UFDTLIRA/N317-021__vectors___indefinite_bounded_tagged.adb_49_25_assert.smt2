...
(assert (not (= (let ((temp___606 (f 1))) (let ((temp___605 (get (model__ (mk___rep w__split_discrs w__split_fields2)) 1))) (ite (= (attr__tag temp___605) (attr__tag temp___606)) (us_dispatch_eq temp___605 temp___606) false))) true)))
(check-sat)
(exit)
