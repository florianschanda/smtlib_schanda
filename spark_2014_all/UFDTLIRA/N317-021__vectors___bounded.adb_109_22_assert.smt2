...
(define-fun default_initial_assumption ((temp___expr_375 us_rep) (temp___skip_top_level_376 Bool)) Bool (and (= (to_rep (rec__bounded__vect__vector__capacity (us_split_discrs1 temp___expr_375))) 5) (=> (not (= temp___skip_top_level_376 true)) (= (is_empty temp___expr_375) true))))
