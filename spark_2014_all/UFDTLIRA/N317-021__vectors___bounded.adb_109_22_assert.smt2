...
(define-fun bounded__vect__append__2__container__fields3 () us_split_fields (mk___split_fields bounded__vect__append__2__container__fields1))
(define-fun v__split_fields11 () us_split_fields (mk___split_fields v__split_fields2))
(define-fun bounded__vect__append__2__container__fields4 () us_split_fields (mk___split_fields bounded__vect__append__2__container__fields))
(define-fun v__split_fields12 () us_split_fields (mk___split_fields v__split_fields1))
(define-fun bounded__vect__clear__container__fields1 () us_split_fields (mk___split_fields bounded__vect__clear__container__fields))
(define-fun o2 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
(define-fun bounded__test__B_1__w__assume2 () us_rep (mk___rep (mk___split_discrs bounded__test__B_1__w__assume) (mk___split_fields bounded__test__B_1__w__assume1)))
...
(assert (= (length (mk___rep v__split_discrs bounded__vect__clear__container__fields1)) 0))
(assert (= result v__split_fields))
(assert (= v__split_fields12 bounded__vect__clear__container__fields1))
...
(assert (= (capacity (mk___rep v__split_discrs v__split_fields12)) 5))
(assert (and (and (= (length (mk___rep v__split_discrs bounded__vect__append__2__container__fields4)) (+ (length (mk___rep v__split_discrs v__split_fields12)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields12)) (model__ (mk___rep v__split_discrs bounded__vect__append__2__container__fields4))) true)) (= (get (model__ (mk___rep v__split_discrs bounded__vect__append__2__container__fields4)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields12))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= v__split_fields11 bounded__vect__append__2__container__fields4))
