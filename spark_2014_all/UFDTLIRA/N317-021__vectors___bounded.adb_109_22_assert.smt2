...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__bounded__vect__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun in_range5 ((rec__bounded__vect__vector__capacity1 Int) (a us_rep)) Bool (= rec__bounded__vect__vector__capacity1 (to_rep (rec__bounded__vect__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant4 ((temp___expr_333 us_rep) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool)) Bool (=> (not (= temp___skip_constant_331 true)) (in_range5 5 temp___expr_333)))
(define-fun default_initial_assumption ((temp___expr_335 us_rep) (temp___skip_top_level_336 Bool)) Bool (and (= (to_rep (rec__bounded__vect__vector__capacity (us_split_discrs1 temp___expr_335))) 5) (=> (not (= temp___skip_top_level_336 true)) (= (is_empty temp___expr_335) true))))
...
(declare-const bounded__sort__sort__container__fields us_split_fields)
(declare-const result10 us_split_fields__ref)
(declare-const v__split_fields10 us_split_fields)
(declare-const bounded__vect__replace_element__container__fields1 us_split_fields)
...
(assert (= 5 (to_rep (rec__bounded__vect__vector__capacity v__split_discrs))))
(assert (= (length (mk___rep v__split_discrs (mk___split_fields bounded__vect__clear__container__fields))) 0))
(assert (= result v__split_fields))
(assert (= (mk___split_fields v__split_fields1) (mk___split_fields bounded__vect__clear__container__fields)))
...
(assert (= (capacity (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) 5))
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields bounded__vect__append__2__container__fields))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) (model__ (mk___rep v__split_discrs (mk___split_fields bounded__vect__append__2__container__fields)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields bounded__vect__append__2__container__fields))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1)))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= (mk___split_fields v__split_fields2) (mk___split_fields bounded__vect__append__2__container__fields)))
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields bounded__vect__append__2__container__fields1))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) (model__ (mk___rep v__split_discrs (mk___split_fields bounded__vect__append__2__container__fields1)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields bounded__vect__append__2__container__fields1))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))) 1)) 2)))
(assert (= result2 v__split_fields2))
(assert (= v__split_fields3 (mk___split_fields bounded__vect__append__2__container__fields1)))
(assert (and (and (= (length (mk___rep v__split_discrs bounded__vect__append__2__container__fields2)) (+ (length (mk___rep v__split_discrs v__split_fields3)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields3)) (model__ (mk___rep v__split_discrs bounded__vect__append__2__container__fields2))) true)) (= (get (model__ (mk___rep v__split_discrs bounded__vect__append__2__container__fields2)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields3))) 1)) 3)))
...
(assert (= (oeq1 (model__ (mk___rep v__split_discrs bounded__vect__reserve_capacity__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields4))) true))
(assert (= result4 (mk___split_fields__ref v__split_fields4)))
(assert (= v__split_fields5 bounded__vect__reserve_capacity__container__fields))
...
(assert (and (= (mk___rep (mk___split_discrs bounded__test__B_1__w__assume) (mk___split_fields bounded__test__B_1__w__assume1)) (copy (mk___rep v__split_discrs v__split_fields5) 6)) (and (= (oeq1 (model__ (mk___rep (mk___split_discrs bounded__test__B_1__w__assume) (mk___split_fields bounded__test__B_1__w__assume1))) (model__ (mk___rep v__split_discrs v__split_fields5))) true) (ite (= 6 0) (= (to_rep bounded__test__B_1__w__assume) (length (mk___rep v__split_discrs v__split_fields5))) (= (to_rep bounded__test__B_1__w__assume) 6)))))
(assert (= result5 (mk___split_fields__ref (mk___split_fields w__split_fields))))
(assert (= w__split_fields1 (mk___split_fields bounded__test__B_1__w__assume1)))
(assert (= w__split_discrs (mk___split_discrs bounded__test__B_1__w__assume)))
...
(assert (and (and (= (length (mk___rep v__split_discrs bounded__vect__replace_element__container__fields)) (length (mk___rep v__split_discrs v__split_fields5))) (= (get (model__ (mk___rep v__split_discrs bounded__vect__replace_element__container__fields)) 2) 4)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields5)) (model__ (mk___rep v__split_discrs bounded__vect__replace_element__container__fields)) 2) true)))
(assert (= result6 (mk___split_fields__ref v__split_fields5)))
(assert (= v__split_fields6 bounded__vect__replace_element__container__fields))
...
(assert (= (m_elements_swapped (model__ (mk___rep v__split_discrs v__split_fields6)) (model__ (mk___rep v__split_discrs bounded__vect__swap__container__fields)) 1 3) true))
...
(assert (and (= (length (mk___rep v__split_discrs bounded__vect__delete_last__container__fields)) (- (length (mk___rep v__split_discrs v__split_fields7)) 1)) (= (olt (model__ (mk___rep v__split_discrs bounded__vect__delete_last__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields7))) true)))
...
(assert (= (m_elements_reversed (model__ (mk___rep v__split_discrs v__split_fields8)) (model__ (mk___rep v__split_discrs bounded__vect__reverse_elements__container__fields))) true))
(assert (= result9 (mk___split_fields__ref v__split_fields8)))
(assert (= v__split_fields9 bounded__vect__reverse_elements__container__fields))
...
(assert (= (get (model__ (mk___rep v__split_discrs v__split_fields10)) 1) 3))
(assert (not (= (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2) 4)))
(check-sat)
(exit)
