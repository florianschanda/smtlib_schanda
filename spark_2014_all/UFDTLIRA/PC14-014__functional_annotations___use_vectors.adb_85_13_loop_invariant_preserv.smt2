...
(assert (<= current3 i4))
(assert (<= i4 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))))))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) i4) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i4))))
(check-sat)
(exit)
