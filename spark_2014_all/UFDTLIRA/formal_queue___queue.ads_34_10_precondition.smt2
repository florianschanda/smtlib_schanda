...
(assert (= (= o4 true) (forall ((i1 Int)) (=> (and (<= 2 i1) (<= i1 (+ (length q) 1))) (= (get (model__ (list__content queue__enqueue__result7)) i1) (get (model__ q) (- i1 1)))))))
(assert (not (not (= (is_empty (list__content queue__enqueue__result7)) true))))
(check-sat)
(exit)
