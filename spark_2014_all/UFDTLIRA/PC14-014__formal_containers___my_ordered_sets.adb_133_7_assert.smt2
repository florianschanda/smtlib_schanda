...
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun e_is_find ((container us_rep3) (item us_rep) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (distinct 1 0)) (ite (< position (length2 container)) (e_smaller_than_range container (+ position 1) (length2 container) item) (distinct 1 0))))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (= (= (contains3 container key) true) (exists ((e us_rep)) (and (= (contains (model__ container) e) true) (= (equivalent_keys key (get_f e)) true))))) :pattern ((contains3 container key))))))
...
(define-fun dynamic_invariant2 ((temp___expr_860 us_rep1) (temp___is_init_856 Bool) (temp___skip_constant_857 Bool) (temp___do_toplevel_858 Bool) (temp___do_typ_inv_859 Bool)) Bool (=> (not (= temp___skip_constant_857 true)) (in_range6 10 temp___expr_860)))
(define-fun default_initial_assumption ((temp___expr_862 us_rep1) (temp___skip_top_level_863 Bool)) Bool (and (= (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 temp___expr_862))) 10) (=> (not (= temp___skip_top_level_863 true)) (= (is_empty temp___expr_862) true))))
...
(define-fun dynamic_invariant3 ((temp___expr_870 us_rep1) (temp___is_init_866 Bool) (temp___skip_constant_867 Bool) (temp___do_toplevel_868 Bool) (temp___do_typ_inv_869 Bool)) Bool (=> (not (= temp___skip_constant_867 true)) (in_range7 10 temp___expr_870)))
(define-fun default_initial_assumption1 ((temp___expr_872 us_rep1) (temp___skip_top_level_873 Bool)) Bool (and (= (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 temp___expr_872))) 10) (=> (not (= temp___skip_top_level_873 true)) (= (is_empty temp___expr_872) true))))
...
(define-fun default_initial_assumption2 ((temp___expr_645 us_rep3) (temp___skip_top_level_646 Bool)) Bool (=> (not (= temp___skip_top_level_646 true)) (= (length2 temp___expr_645) 0)))
(assert (forall ((container us_rep3)) (forall ((item us_rep)) (! (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption3 ((temp___expr_668 us_rep4) (temp___skip_top_level_669 Bool)) Bool (=> (not (= temp___skip_top_level_669 true)) (and (= (is_empty2 temp___expr_668) true) (= (length3 temp___expr_668) 0))))
...
(define-fun default_initial_assumption4 ((temp___expr_607 us_rep5) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty3 temp___expr_607) true)))
...
(assert true)
(assert true)
(assert (forall ((container us_rep5)) (forall ((item us_rep)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep4)) (forall ((key us_rep2)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep2)) (=> (= (has_key container k) true) (= (= (bool_eq2 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get1 container key))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key us_rep2)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key))))))
...
(define-fun e_is_find1 ((container us_rep3) (key Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range1 container 1 (- position 1) key) (distinct 1 0)) (ite (< position (length2 container)) (e_smaller_than_range1 container (+ position 1) (length2 container) key) (distinct 1 0))))
(declare-fun e_is_find__function_guard1 (Bool us_rep3 Int Int) Bool)
(assert (forall ((container us_rep3)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (let ((result (find3 container key))) (and (=> (< 0 result) (and (and (<= result (length2 container)) (= (equivalent_keys key (get_f (get container result))) true)) (= (e_is_find1 container key result) true))) (dynamic_invariant result true false true true)))) :pattern ((find3 container key))))))
(assert (forall ((left us_rep5) (right us_rep5)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (= (= (m_included_except left right key) true) (forall ((e us_rep)) (=> (= (contains left e) true) (or (= (contains right e) true) (= (equivalent_keys (get_f e) key) true)))))) :pattern ((m_included_except left right key))))))
...
(define-fun o55 () us_rep (mk___rep (mk___split_fields o16 o17)))
(define-fun o56 () us_rep (mk___rep (mk___split_fields o10 o11)))
(define-fun o57 () us_rep (mk___rep (mk___split_fields o4 o5)))
(define-fun temp___11551 () us_rep2 (mk___rep2 (mk___split_fields2 temp___1155)))
(define-fun temp___11541 () us_rep2 (mk___rep2 (mk___split_fields2 temp___1154)))
...
(assert (and (= temp___11541 (first (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))) (ite (= (= (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 0) true) (= (bool_eq2 temp___11541 no_element) true) (and (= (has_key (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11541) true) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11541) 1)))))
...
(assert (and (= temp___11551 (next (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)) (mk___rep2 c__split_fields1))) (ite (= (ite (= (bool_eq2 (mk___rep2 c__split_fields1) no_element) false) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 c__split_fields1)) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))) true) true) (= (bool_eq2 temp___11551 no_element) true) (and (= (has_key (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11551) true) (= (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) temp___11551) (+ (get1 (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (mk___rep2 c__split_fields1)) 1))))))
...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (+ (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1)) (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o57) true)) (= (bool_eq (get (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o57)) o57) true)) (= (ole (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) o57) true)) (= (range_equal (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) 1 (- (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o57) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o57) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o57) 1) true)))
...
(assert (= o16 o14))
(assert (= o17 o15))
(assert (and (and (and (and (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) o55) true) (= (has_key (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) true)) (= (equivalent_elements (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) o55) true)) (= (e_is_find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) o55 (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3))) true)) (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields2)) o55) true) (and (and (and (not (= b true)) (= (oeq2 (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq3 (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (elements (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq4 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (positions (mk___rep1 l__split_discrs l__split_fields2))) true)) (and (and (and (and (and (and (and (= b true) (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (+ (length (mk___rep1 l__split_discrs l__split_fields2)) 1))) (= (bool_eq (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) o55) true)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields2)) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2)) o55) true)) (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) 1 (- (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) (length (mk___rep1 l__split_discrs l__split_fields2)) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs l__split_fields2)) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1) true)))))
...
(assert (let ((temp___689 (elements (mk___rep1 l__split_discrs l__split_fields5)))) (forall ((temp___688 Int)) (=> (and (in_range4 temp___688) (= (iter_has_element temp___689 temp___688) true)) (exists ((i us_rep2)) (and (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields5)) i) true) (= (bool_eq (get (elements (mk___rep1 l__split_discrs l__split_fields5)) (get1 (positions (mk___rep1 l__split_discrs l__split_fields5)) i)) (get temp___689 temp___688)) true)))))))
...
(assert (and (= temp___1168 (find1 (mk___rep1 l__split_discrs l__split_fields9) o42)) (ite (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields9)) o42) false) true false) (and (not (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1168) true)) (= (bool_eq2 temp___1168 no_element) true)) (and (and (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1168) true) (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9)) temp___1168) (find (elements (mk___rep1 l__split_discrs l__split_fields9)) o42))) (= (equivalent_elements (element (mk___rep1 l__split_discrs l__split_fields9) temp___1168) o42) true)))))
(assert (= result14 (mk___split_fields__ref2 c__split_fields3)))
(assert (= c__split_fields4 (us_split_fields5 temp___1168)))
...
(assert (and (= temp___1170 (find1 (mk___rep1 l__split_discrs l__split_fields10) o46)) (ite (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields10)) o46) false) true false) (and (not (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1170) true)) (= (bool_eq2 temp___1170 no_element) true)) (and (and (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1170) true) (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10)) temp___1170) (find (elements (mk___rep1 l__split_discrs l__split_fields10)) o46))) (= (equivalent_elements (element (mk___rep1 l__split_discrs l__split_fields10) temp___1170) o46) true)))))
(assert (= result16 (mk___split_fields__ref2 c__split_fields5)))
(assert (= c__split_fields6 (us_split_fields5 temp___1170)))
(assert (= (to_rep o47) 2))
...
(assert (not (= (length (mk___rep1 l__split_discrs l__split_fields12)) 0)))
(check-sat)
(exit)
