...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1)) (in_range1 temp___expr_135)))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__p__s__d (us_split_discrs1 a))) (to_rep (rec__p__s__d (us_split_discrs1 b)))) (=> (p__s__bool_field__pred a) (= (rec__p__s__bool_field (us_split_fields1 a)) (rec__p__s__bool_field (us_split_fields1 b))))) (=> (p__s__int_field__pred a) (= (to_rep1 (rec__p__s__int_field (us_split_fields1 a))) (to_rep1 (rec__p__s__int_field (us_split_fields1 b)))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_146 us_rep1) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (in_range3 (to_rep (rec__p__t__z (us_split_discrs3 temp___expr_146))) (rec__p__t__field (us_split_fields3 temp___expr_146))))
...
(assert (not (= (to_rep v__split_fields) 0)))
(check-sat)
(exit)
