...
(declare-const cu3 cursor__ref)
(declare-const for_loops_on_lists__search_0_for_in__result4 cursor__ref)
(declare-const cu4 us_rep1)
(declare-const for_loops_on_lists__search_0_for_in__result5 us_rep1)
(declare-const cu5 cursor__ref)
(declare-const for_loops_on_lists__search_0_for_in__result6 cursor__ref)
(declare-const cu6 us_rep1)
(declare-const for_loops_on_lists__search_0_for_in__result7 us_rep1)
(declare-const result5 cursor__ref)
(declare-const for_loops_on_lists__search_0_for_in__result8 us_rep1)
(declare-const for_loops_on_lists__search_0_for_in__result9 cursor__ref)
(declare-const for_loops_on_lists__search_0_for_in__result10 us_rep1)
(declare-const cu7 cursor__ref)
(declare-const for_loops_on_lists__search_0_for_in__result11 cursor__ref)
(declare-const cu8 us_rep1)
(declare-const for_loops_on_lists__search_0_for_in__result12 us_rep1)
(declare-const cu9 cursor__ref)
(declare-const for_loops_on_lists__search_0_for_in__result13 cursor__ref)
(declare-const cu10 us_rep1)
(declare-const for_loops_on_lists__search_0_for_in__result14 us_rep1)
(define-fun result6 () cursor__ref (mk_cursor__ref (mk___rep1 (mk___split_fields1 result))))
(define-fun o6 () us_rep1 (mk___rep1 (mk___split_fields1 o4)))
(define-fun temp___4651 () us_rep1 (mk___rep1 (mk___split_fields1 temp___465)))
(define-fun o7 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
(define-fun cu11 () cursor__ref (mk_cursor__ref (mk___rep1 (mk___split_fields1 cu))))
(declare-const result7 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___473 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___473)) no_element))
(assert (or (and (and (and (= for_loops_on_lists__search_0_for_in__result11 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result3)) (= cu7 (mk_cursor__ref cu2))) (and (= for_loops_on_lists__search_0_for_in__result12 for_loops_on_lists__search_0_for_in__result3) (= cu8 cu2))) (and (and (and (= o7 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) 1)))) (and (= result6 cu11) (= cu1 o7))) (and (and (= result1 (has_key (positions l) cu1)) (= (= result1 true) (= (has_key (positions l) cu1) true))) (and (= result1 true) (and (= temp___4651 cu1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) cu2) 1))) (not (= (get (model__ l) i) 0)))) (and (= (has_key (positions l) cu2) true) (and (and (and (= o3 (element l cu2)) (and (in_range5 o3) (= o3 (get (model__ l) (get1 (positions l) cu2))))) (= result2 (ite (= o3 0) true false))) (and (= result2 true) (and (= result3 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result2)) (= for_loops_on_lists__search_0_for_in__result3 cu2))))))))))) (and (and (and (and (= o7 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) 1)))) (and (= result6 cu11) (= cu1 o7))) (and (and (= result1 (has_key (positions l) cu1)) (= (= result1 true) (= (has_key (positions l) cu1) true))) (ite (= result1 true) (and (and (and (= temp___4651 cu1) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) cu2) 1))) (not (= (get (model__ l) i) 0)))) (and (= (has_key (positions l) cu2) true) (and (and (and (and (= o3 (element l cu2)) (and (in_range5 o3) (= o3 (get (model__ l) (get1 (positions l) cu2))))) (= result2 (ite (= o3 0) true false))) (and (not (= result2 true)) (= for_loops_on_lists__search_0_for_in__result3 for_loops_on_lists__search_0_for_in__result2))) (and (and (and (and (= o6 (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) (+ (get1 (positions l) cu2) 1))))) (and (= o5 (has_key (positions l) o6)) (= (= o5 true) (= (has_key (positions l) o6) true)))) (= result4 (ite (not (= o5 true)) true false))) (= result4 true)))))) (and (and (= for_loops_on_lists__search_0_for_in__result4 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result3)) (= cu3 (mk_cursor__ref cu2))) (and (= for_loops_on_lists__search_0_for_in__result5 for_loops_on_lists__search_0_for_in__result3) (= cu4 cu2)))) (and (and (= for_loops_on_lists__search_0_for_in__result6 for_loops_on_lists__search_0_for_in__result4) (= cu5 cu3)) (and (= for_loops_on_lists__search_0_for_in__result7 for_loops_on_lists__search_0_for_in__result5) (= cu6 cu4)))) (and (and (= for_loops_on_lists__search_0_for_in__result6 (mk_cursor__ref (mk___rep1 (mk___split_fields1 for_loops_on_lists__search_0_for_in__result)))) (= cu5 (mk_cursor__ref cu1))) (and (= for_loops_on_lists__search_0_for_in__result7 (mk___rep1 (mk___split_fields1 for_loops_on_lists__search_0_for_in__result1))) (= cu6 cu1)))))) (and (and (and (= for_loops_on_lists__search_0_for_in__result11 for_loops_on_lists__search_0_for_in__result9) (= cu7 cu5)) (and (= for_loops_on_lists__search_0_for_in__result12 for_loops_on_lists__search_0_for_in__result10) (= cu8 cu6))) (and (and (= for_loops_on_lists__search_0_for_in__result9 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result8)) (= for_loops_on_lists__search_0_for_in__result10 for_loops_on_lists__search_0_for_in__result8)) (and (= result5 for_loops_on_lists__search_0_for_in__result6) (= for_loops_on_lists__search_0_for_in__result8 no_element)))))))
(assert (= for_loops_on_lists__search_0_for_in__result13 for_loops_on_lists__search_0_for_in__result11))
(assert (= cu9 cu7))
(assert (= for_loops_on_lists__search_0_for_in__result14 for_loops_on_lists__search_0_for_in__result12))
(assert (= cu10 cu8))
(assert (= (mk___rep1 (mk___split_fields1 result7)) (cursor__content for_loops_on_lists__search_0_for_in__result13)))
(assert (not (or (and (= (has_key (positions l) (cursor__content for_loops_on_lists__search_0_for_in__result13)) true) (= (element l (cursor__content for_loops_on_lists__search_0_for_in__result13)) 0)) (and (= (bool_eq1 (cursor__content for_loops_on_lists__search_0_for_in__result13) no_element) true) (let ((temp___475 (model__ l))) (forall ((temp___474 Int)) (=> (and (in_range2 temp___474) (= (iter_has_element temp___475 temp___474) true)) (not (= (get temp___475 temp___474) 0)))))))))
(check-sat)
(exit)
