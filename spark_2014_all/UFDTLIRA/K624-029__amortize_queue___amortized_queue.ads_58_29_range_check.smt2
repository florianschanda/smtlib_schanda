...
(assert (and (= o12 (length m)) (and (in_range4 o12) (<= o12 (capacity m)))))
(assert (and (= o10 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o10) (<= o10 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o11 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o11) (<= o11 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o13 (+ o11 o10)))
(assert (= result2 (ite (= o13 o12) true false)))
(assert (=> (= result2 true) (and (= o9 (length m)) (and (in_range4 o9) (<= o9 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o9 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o7 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o7) (<= o7 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
...
(assert (and (= o6 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o5)) (and (in_range5 o6) (= o6 (get (model__ (rec__amortized_queue__queue__front (us_split_fields3 q))) o5)))))
