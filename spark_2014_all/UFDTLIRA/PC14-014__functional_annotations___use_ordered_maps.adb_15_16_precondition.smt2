...
(assert (not (or (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) true))))
(check-sat)
(exit)
