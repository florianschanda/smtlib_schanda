...
(assert (= temp___6721 (get1 (positions s) (mk___rep1 cu__split_fields3))))
(assert (and (= o2 (key s (mk___rep1 cu__split_fields3))) (and (in_range7 o2) (= o2 (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields3)))))))
...
(assert (not (or (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
