...
(assert (and (= o (positions (mk___rep s1__split_discrs s1__split_fields1))) (and (not (= (has_key o no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length (mk___rep s1__split_discrs s1__split_fields1)))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq1 i j) true))))))))))
