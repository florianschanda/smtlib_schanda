...
(assert (and (= o (positions (mk___rep s1__split_discrs s1__split_fields2))) (and (not (= (has_key o no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key o i2) true) (and (and (<= 1 (get1 o i2)) (<= (get1 o i2) (length (mk___rep s1__split_discrs s1__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i2) (get1 o j)) (= (bool_eq1 i2 j) true))))))))))
