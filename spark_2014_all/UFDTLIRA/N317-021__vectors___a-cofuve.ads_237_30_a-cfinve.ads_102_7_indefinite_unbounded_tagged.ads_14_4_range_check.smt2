...
(define-fun dynamic_invariant2 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range5 temp___expr_302)))
...
(assert (= result true))
(assert (=> (< offset 0) (and (= o (- (- 2147483648) offset)) (in_range4 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o 1) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (not (in_range4 lst)))
(check-sat)
(exit)
