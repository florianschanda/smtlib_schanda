...
(define-fun dynamic_invariant ((temp___expr_263 Int) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (=> (or (= temp___is_init_260 true) (<= 1 2147483647)) (in_range2 temp___expr_263)))
...
(define-fun dynamic_invariant1 ((temp___expr_273 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 2147483647)) (in_range3 temp___expr_273)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__indefinite_unbounded_tagged__t__c (us_split_fields1 a))) (to_rep (rec__indefinite_unbounded_tagged__t__c (us_split_fields1 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_280 us_rep) (temp___skip_top_level_281 Bool)) Bool (=> (not (= temp___skip_top_level_281 true)) (= (length temp___expr_280) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_211 Int) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (or (= temp___is_init_208 true) (<= 0 2147483647)) (in_range5 temp___expr_211)))
...
(define-fun default_initial_assumption1 ((temp___expr_218 us_rep1) (temp___skip_top_level_219 Bool)) Bool (= (attr__tag temp___expr_218) us_tag))
(assert true)
(declare-const o Int)
