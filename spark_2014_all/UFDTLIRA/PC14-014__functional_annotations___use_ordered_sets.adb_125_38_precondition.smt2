...
(assert (and (= temp___772 (model__ (mk___rep s2__split_discrs s2__split_fields2))) (= (length4 temp___772) (length (mk___rep s2__split_discrs s2__split_fields2)))))
(assert (and (= o (contains temp___772 e)) (=> (= (of_int 1) true) (=> (exists ((e1 Int)) (and (and (in_range3 e1) (= (contains temp___772 e1) true)) (= (equivalent_elements e1 e) true))) (= o true)))))
