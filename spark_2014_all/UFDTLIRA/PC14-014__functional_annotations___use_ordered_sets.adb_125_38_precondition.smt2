...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant3 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 0 2147483647)) (in_range5 temp___expr_389)))
...
(define-fun dynamic_invariant4 ((temp___expr_412 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool) (temp___do_typ_inv_411 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range6 temp___expr_412)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range5 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_323)))
...
(assert (forall ((container us_rep2)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range3 item) (= (contains container item) true))))) (= (= result true) (= (length4 container) 0)))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range3 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(define-fun use_ordered_sets__move_3__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_ordered_sets__move_3__cu__assume)))
...
(assert (forall ((e1 Int)) (=> (and (in_range3 e1) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e1) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1) e1))))))
(assert (and (= temp___814 (model__ (mk___rep s2__split_discrs s2__split_fields2))) (= (length4 temp___814) (length (mk___rep s2__split_discrs s2__split_fields2)))))
(assert (and (= o (contains temp___814 e)) (=> (= (distinct 1 0) true) (=> (exists ((e1 Int)) (and (and (in_range3 e1) (= (contains temp___814 e1) true)) (= (equivalent_elements e1 e) true))) (= o true)))))
(assert (= (= o1 true) (in_range3 e)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= o2 (length (mk___rep s2__split_discrs s2__split_fields2))) (and (in_range2 o2) (<= o2 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result3 (ite (<= 1 i) o3 false)))
(assert (= result3 true))
(assert (and (= o4 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length2 o4) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___432 Int)) (=> (and (in_range5 temp___432) (= (iter_has_element o4 temp___432) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o4 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o4 item)) (= (equivalent_elements (get o4 (find o4 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
