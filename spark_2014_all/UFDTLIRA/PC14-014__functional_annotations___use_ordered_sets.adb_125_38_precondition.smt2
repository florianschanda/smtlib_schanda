...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant3 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range5 temp___expr_352)))
...
(define-fun dynamic_invariant4 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 2147483647)) (in_range6 temp___expr_372)))
...
(define-fun dynamic_invariant5 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_295)))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range3 e) (= (contains left e) true)) (or (= (contains right e) true) (= (equivalent_elements e item) true)))))) :pattern ((included_except left right item))))))
...
(declare-const temp___7711 us_main_type)
(declare-const temp___770 count_type)
...
(declare-const temp___772 us_rep2)
(declare-const e Int)
...
(declare-const temp___769 count_type)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_sets__move_3__cu__assume)) (first (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (ite (= (= (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_sets__move_3__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 use_ordered_sets__move_3__cu__assume))) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 use_ordered_sets__move_3__cu__assume))) 1)))))
...
(assert (and (= (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields))) 0) (= (is_empty (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields)))) true)))
...
(assert (= result1 true))
(assert (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) 1)))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))))) (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i2)) true))))
(assert (forall ((e1 Int)) (=> (and (in_range3 e1) (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) e1) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i2) e1))))))
(assert (and (= temp___772 (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))) (= (length4 temp___772) (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))))))
(assert (and (= o9 (contains temp___772 e)) (=> (= (of_int 1) true) (=> (exists ((e1 Int)) (and (and (in_range3 e1) (= (contains temp___772 e1) true)) (= (equivalent_elements e1 e) true))) (= o9 true)))))
(assert (= (= o10 true) (in_range3 e)))
(assert (= result3 (ite (= o10 true) o9 false)))
(assert (= result3 true))
(assert (and (= o11 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))) (and (in_range2 o11) (<= o11 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o12 (ite (<= i1 o11) true false)))
(assert (= result4 (ite (<= 1 i1) o12 false)))
(assert (= result4 true))
(assert (and (= o13 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length2 o13) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___390 Int)) (=> (and (in_range5 temp___390) (= (iter_has_element o13 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o13 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o13 item)) (= (equivalent_elements (get o13 (find o13 item)) item) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o13 (get o13 i2)) i2) (= (e_is_find o13 (get o13 i2) i2) true)))))))
(assert (not (<= 1 i1)))
(check-sat)
(exit)
