...
(assert (not (or (< (length (mk___rep1 l__split_discrs l__split_fields6)) (to_rep2 (rec__my_ordered_sets__n__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields6)) o30) true))))
(check-sat)
(exit)
