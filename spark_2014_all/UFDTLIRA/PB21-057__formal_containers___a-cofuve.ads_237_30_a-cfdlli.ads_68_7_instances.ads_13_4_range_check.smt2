...
(define-fun dynamic_invariant ((temp___expr_558 Int) (temp___is_init_555 Bool) (temp___skip_constant_556 Bool) (temp___do_toplevel_557 Bool)) Bool (=> (or (= temp___is_init_555 true) (<= 1 2147483647)) (in_range2 temp___expr_558)))
...
(define-fun dynamic_invariant1 ((temp___expr_570 Int) (temp___is_init_567 Bool) (temp___skip_constant_568 Bool) (temp___do_toplevel_569 Bool)) Bool (=> (or (= temp___is_init_567 true) (<= 0 2147483647)) (in_range3 temp___expr_570)))
...
(define-fun dynamic_invariant3 ((temp___expr_564 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_564)))
