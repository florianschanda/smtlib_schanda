...
(define-fun dynamic_invariant ((temp___expr_630 Int) (temp___is_init_626 Bool) (temp___skip_constant_627 Bool) (temp___do_toplevel_628 Bool) (temp___do_typ_inv_629 Bool)) Bool (=> (or (= temp___is_init_626 true) (<= 1 2147483647)) (in_range2 temp___expr_630)))
...
(define-fun dynamic_invariant1 ((temp___expr_644 Int) (temp___is_init_640 Bool) (temp___skip_constant_641 Bool) (temp___do_toplevel_642 Bool) (temp___do_typ_inv_643 Bool)) Bool (=> (or (= temp___is_init_640 true) (<= 0 2147483647)) (in_range3 temp___expr_644)))
...
(define-fun dynamic_invariant3 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_637)))
