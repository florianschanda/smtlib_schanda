...
(define-fun dynamic_invariant ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 1 100)) (in_range1 temp___expr_214)))
...
(define-fun default_initial_assumption1 ((temp___expr_294 us_rep3) (temp___skip_top_level_295 Bool)) Bool (=> (not (= temp___skip_top_level_295 true)) (and (= (is_empty temp___expr_294) true) (= (length1 temp___expr_294) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_272 us_rep2) (temp___skip_top_level_273 Bool)) Bool (=> (not (= temp___skip_top_level_273 true)) (= (length temp___expr_272) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_264 Int) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool) (temp___do_typ_inv_263 Bool)) Bool (=> (or (= temp___is_init_260 true) (<= 0 2147483647)) (in_range5 temp___expr_264)))
...
(define-fun dynamic_invariant5 ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 1 100)) (in_range6 temp___expr_257)))
...
(define-fun dynamic_invariant6 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1 2147483647)) (in_range7 temp___expr_286)))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant2 (length1 container) true false true true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(define-fun p__nearly_identity__nxt__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 p__nearly_identity__nxt__assume)))
(define-fun p__nearly_identity__prev__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 p__nearly_identity__prev__assume)))
...
(assert (= e1 o))
(assert (in_range1 e1))
(assert (and (= p__nearly_identity__prev__assume1 (previous (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true) true) (= (bool_eq1 p__nearly_identity__prev__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) p__nearly_identity__prev__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) p__nearly_identity__prev__assume1) (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1))))))
(assert (= p__nearly_identity__prev__assume1 prev))
(assert (and (= p__nearly_identity__nxt__assume1 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 p__nearly_identity__nxt__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) p__nearly_identity__nxt__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) p__nearly_identity__nxt__assume1) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1))))))
