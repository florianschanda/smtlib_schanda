...
(define-fun dynamic_invariant ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 1 100)) (in_range1 temp___expr_183)))
...
(define-fun default_initial_assumption1 ((temp___expr_252 us_rep3) (temp___skip_top_level_253 Bool)) Bool (=> (not (= temp___skip_top_level_253 true)) (and (= (is_empty temp___expr_252) true) (= (length1 temp___expr_252) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_233 us_rep2) (temp___skip_top_level_234 Bool)) Bool (=> (not (= temp___skip_top_level_234 true)) (= (length temp___expr_233) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_226 Int) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool)) Bool (=> (or (= temp___is_init_223 true) (<= 0 2147483647)) (in_range5 temp___expr_226)))
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 1 100)) (in_range6 temp___expr_220)))
...
(define-fun dynamic_invariant6 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range7 temp___expr_245)))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant2 (length1 container) true false true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (and (= o (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (and (in_range3 o) (= o (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))))))))
(assert (= (mk_int__ref result) (mk_int__ref e)))
(assert (= e1 o))
(assert (in_range1 e1))
(assert (and (= (mk___rep1 (mk___split_fields1 p__nearly_identity__prev__assume)) (previous (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 p__nearly_identity__prev__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 p__nearly_identity__prev__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 p__nearly_identity__prev__assume))) (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1))))))
(assert (= (mk___rep1 (mk___split_fields1 p__nearly_identity__prev__assume)) prev))
(assert (and (= (mk___rep1 (mk___split_fields1 p__nearly_identity__nxt__assume)) (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 p__nearly_identity__nxt__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 p__nearly_identity__nxt__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 p__nearly_identity__nxt__assume))) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1))))))
(assert (= (mk___rep1 (mk___split_fields1 p__nearly_identity__nxt__assume)) nxt))
