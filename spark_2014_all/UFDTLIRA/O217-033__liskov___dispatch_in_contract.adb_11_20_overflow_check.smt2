...
(declare-const temp___2042 us_private)
...
(assert (= o__attr__tag temp___2043))
(assert (= result o__split_fields))
(assert (= result1 o__split_fields1))
(assert (= result2 o__split_fields2))
(assert (= temp___204 o__split_fields3))
(assert (= temp___2041 o__split_fields4))
(assert (= temp___2042 o__split_fields5))
