...
(assert (forall ((x et4)) (! (in_range3 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-fun to_rep5 (enum1t) Int)
(declare-fun of_rep5 (Int) enum1t)
(assert (forall ((x enum1t)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x enum1t)) (! (in_range4 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (bool_eq2 (rec__ar__rec4t__f4 (us_split_fields7 a)) (rec__ar__rec4t__f4 (us_split_fields7 b))) true) (= (to_rep5 (rec__ar__rec4t__g4 (us_split_fields7 a))) (to_rep5 (rec__ar__rec4t__g4 (us_split_fields7 b))))) true false))
...
(assert (= temp___7106 (mk___rep3 o19)))
...
(assert (= r__split_fields6 (us_split_fields7 temp___7106)))
(assert (= r__split_fields7 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields8 r__split_fields6))
(assert (not (= (bool_eq3 (mk___rep3 (us_split_fields__content3 r__split_fields7)) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) r__split_fields2)) r__split_fields3)) r__split_fields4)) r__split_fields5))) true)))
(check-sat)
(exit)
