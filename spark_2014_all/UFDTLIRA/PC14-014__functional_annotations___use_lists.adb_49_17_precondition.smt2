...
(declare-const temp___491 us_rep2)
(declare-const temp___488 count_type)
(declare-const temp___492 us_rep2)
(declare-const n Int)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_lists__incr_all_2__cu__assume)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_lists__incr_all_2__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__incr_all_2__cu__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__incr_all_2__cu__assume))) 1)))))
...
(assert (forall ((n3 Int)) (=> (and (<= 1 n3) (<= n3 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) n3)) true))))
(assert (forall ((n3 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) n3) (<= n3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) n3)))))
...
(assert (and (= o9 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (in_range2 o9) (<= o9 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o10 (ite (<= n1 o9) true false)))
(assert (and (= o7 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o7 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o7 i) true) (and (and (<= 1 (get1 o7 i)) (<= (get1 o7 i) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key o7 j) true) (=> (= (get1 o7 i) (get1 o7 j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o8 (get1 o7 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o8) (=> (= (of_int 0) true) (and (= o8 (w_get o7 (witness o7 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key o7 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o7 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o7 k))))))))))
(assert (= o11 (ite (<= o8 n1) true false)))
(assert (= result3 (ite (= o11 true) o10 false)))
(assert (= result3 true))
(assert (and (= o14 n1) (in_range3 n1)))
(assert (and (= o13 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (length1 o13) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))))
(assert (and (= o15 (get o13 o14)) (in_range4 o15)))
(assert (and (= o12 n1) (in_range3 n1)))
(assert (not (<= 1 o12)))
(check-sat)
(exit)
