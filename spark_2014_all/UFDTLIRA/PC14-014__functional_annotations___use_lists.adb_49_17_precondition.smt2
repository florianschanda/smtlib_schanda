...
(define-fun use_lists__incr_all_2__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_lists__incr_all_2__cu__assume)))
(assert (and (= use_lists__incr_all_2__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 use_lists__incr_all_2__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_2__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_2__cu__assume1) 1)))))
...
(assert (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) 1))) (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n1) (get (model__ (mk___rep l__split_discrs l__split_fields2)) n1)) true))))
(assert (forall ((n1 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) n1) (<= n1 (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n1) (get (model__ (mk___rep l__split_discrs l__split_fields2)) n1)))))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) true))
(assert (and (= o2 (length (mk___rep l__split_discrs l__split_fields2))) (and (in_range2 o2) (<= o2 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o3 (ite (<= n o2) true false)))
...
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o4 (ite (<= o1 n) true false)))
(assert (= result2 (ite (= o4 true) o3 false)))
(assert (= result2 true))
(assert (and (= o7 n) (in_range3 n)))
(assert (and (= o6 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o6) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (and (= o8 (get o6 o7)) (in_range4 o8)))
(assert (and (= o5 n) (in_range3 n)))
(assert (not (<= 1 o5)))
(check-sat)
(exit)
