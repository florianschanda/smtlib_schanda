...
(assert (=> (not (= before 0)) (and (= o4 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields))))) (and (in_range4 o4) (= o4 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields)))))))))
(assert (=> (not (= before 0)) (= o5 (ite (= (- before 1) o4) true false))))
(assert (=> (not (not (= before 0))) (= o5 false)))
(assert (and (= o2 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields))))) (and (in_range4 o2) (= o2 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields))))))))
