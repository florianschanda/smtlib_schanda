...
(define-fun dynamic_invariant ((temp___expr_211 Int) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (or (= temp___is_init_208 true) (<= 0 2147483647)) (in_range2 temp___expr_211)))
...
(define-fun dynamic_invariant2 ((temp___expr_248 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483647)) (in_range5 temp___expr_248)))
...
(define-fun oeq ((left us_rep2) (right us_rep2)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (let ((temp___133 (get right n))) (let ((temp___132 (get left n))) (and (ite (= (attr__tag temp___132) (attr__tag temp___133)) true false) (us_dispatch_eq temp___132 temp___133)))) true))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (=> (not (= temp___skip_top_level_281 true)) (= (length1 temp___expr_280) 0)))
...
(assert (=> (not (= before 0)) (and (= o5 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields))))) (and (in_range4 o5) (= o5 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields)))))))))
(assert (=> (not (= before 0)) (= o6 (ite (= (- before 1) o5) true false))))
(assert (=> (= before 0) (= o6 false)))
(assert (and (= o3 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields))))) (and (in_range4 o3) (= o3 (last (model__ (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields))))))))
(assert (= o4 (ite (<= before o3) true false)))
(assert (= o7 (ite (<= 1 before) o4 false)))
(assert (= o8 (ite (= o7 false) o6 true)))
(assert (and (= o (capacity (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields)))) (and (in_range5 o) (= o (ite (= (of_int 1) true) (to_rep1 (rec__indefinite_bounded_tagged__vect__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
