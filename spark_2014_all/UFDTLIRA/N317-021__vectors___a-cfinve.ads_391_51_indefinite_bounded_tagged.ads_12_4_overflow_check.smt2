...
(define-fun dynamic_invariant1 ((temp___expr_278 Int) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool (=> (or (= temp___is_init_274 true) (<= 0 2147483647)) (in_range2 temp___expr_278)))
...
(define-fun dynamic_invariant2 ((temp___expr_241 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 2147483647)) (in_range4 temp___expr_241)))
...
(define-fun bool_eq1 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep1 (rec__indefinite_bounded_tagged__t__c (us_split_fields3 a))) (to_rep1 (rec__indefinite_bounded_tagged__t__c (us_split_fields3 b)))) true false))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (= o (ite (= (distinct 1 0) true) (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
