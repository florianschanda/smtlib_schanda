...
(define-fun dynamic_invariant ((temp___expr_241 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 2147483647)) (in_range2 temp___expr_241)))
...
(define-fun dynamic_invariant2 ((temp___expr_285 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool) (temp___do_typ_inv_284 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= 0 2147483647)) (in_range5 temp___expr_285)))
...
(define-fun oeq ((left us_rep2) (right us_rep2)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (let ((temp___155 (get right n))) (let ((temp___154 (get left n))) (and (ite (= (attr__tag temp___154) (attr__tag temp___155)) true false) (us_dispatch_eq temp___154 temp___155)))) true))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_322 us_rep2) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (length1 temp___expr_322) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_314 Int) (temp___is_init_310 Bool) (temp___skip_constant_311 Bool) (temp___do_toplevel_312 Bool) (temp___do_typ_inv_313 Bool)) Bool (=> (or (= temp___is_init_310 true) (<= 0 2147483647)) (in_range6 temp___expr_314)))
...
(assert (and (= o (capacity (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields)))) (and (in_range5 o) (= o (ite (= (distinct 1 0) true) (to_rep1 (rec__indefinite_bounded_tagged__vect__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
