...
(define-fun default_initial_assumption1 ((temp___expr_136 us_rep) (temp___skip_top_level_137 Bool)) Bool (and (= (attr__tag temp___expr_136) us_tag) (and (and (= (to_rep (rec__object__t__area (us_split_fields1 temp___expr_136))) (- 1)) (= (to_rep (rec__object__t__max_width (us_split_fields1 temp___expr_136))) (- 1))) (= (to_rep (rec__object__t__max_height (us_split_fields1 temp___expr_136))) (- 1)))))
...
(assert (= (has_stored_area1 rec____attr__tag (mk___rep (mk___split_fields window__prepare_to_draw__obj__fields window__prepare_to_draw__obj__fields1 window__prepare_to_draw__obj__fields2 window__prepare_to_draw__obj__fields3) rec____attr__tag)) true))
...
(assert (= (mk___split_fields1 rec____split_fields9 rec____split_fields10 rec____split_fields11 rec____split_fields12 rec____split_fields13 rec____split_fields14) (us_split_fields3 (of_base (mk___rep (mk___split_fields window__prepare_to_draw__obj__fields window__prepare_to_draw__obj__fields1 window__prepare_to_draw__obj__fields2 window__prepare_to_draw__obj__fields3) rec____attr__tag)))))
(assert (not (= (has_stored_area1 rec____attr__tag (mk___rep (mk___split_fields rec____split_fields9 rec____split_fields10 rec____split_fields11 (hide_ext__ rec____split_fields12 rec____split_fields13 rec____split_fields14)) rec____attr__tag)) true)))
(check-sat)
(exit)
