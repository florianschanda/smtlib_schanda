...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___158 x)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___157 x)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___156 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___154 x)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___155 x_last)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (property temp___158 x2) true)))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (prop_transitive temp___154 x_last3 x3) true)))
