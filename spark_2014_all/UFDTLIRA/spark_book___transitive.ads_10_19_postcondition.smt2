...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (= temp___136 x) (and (= temp___135 x) (and (= temp___134 i1) (and (= temp___132 x) (and (= temp___133 x_last) (and (= (property temp___136 x2) true) (and (and (and (and (=> (<= 0 2147483647) (in_range1 x_last2)) (=> (<= 1 10) (in_range2 i2))) (in_range1 x2)) (and (<= 1 i2) (<= i2 10))) (and (and (= x_last2 result1) (= x_last3 x2)) (and (and (= (property x2 x3) true) (in_range1 x3)) (and (= (prop_transitive temp___132 x_last3 x3) true) (= i2 10))))))))))) (and (and (= i2 i6) (and (= x_last3 x_last6) (= x3 x6))) (and (= i7 i2) (and (= x_last7 x_last3) (= x7 x3)))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref x_last8) (mk_int__ref x_last6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref x8) (mk_int__ref x6))))
...
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= (mk_int__ref x_last8) (mk_int__ref x_last))))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= (mk_int__ref x8) (mk_int__ref x))))
...
(assert (= (mk_int__ref x10) (mk_int__ref x8)))
(assert (= i11 i9))
(assert (= x_last11 x_last9))
(assert (= x11 x9))
(assert (not (= (property x x10) true)))
(check-sat)
(exit)
