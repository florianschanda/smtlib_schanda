...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___160 x)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___159 x)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___158 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___156 x)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___157 x_last)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (property temp___160 x2) true)))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (prop_transitive temp___156 x_last3 x3) true)))
