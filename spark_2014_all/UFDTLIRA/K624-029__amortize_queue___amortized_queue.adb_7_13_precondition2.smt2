...
(assert (<= 1 idx1))
(assert (<= idx1 r4b))
(assert (and (= o2 idx1) (in_range6 idx1)))
(assert (and (= o3 (get (model__ left) o2)) (and (in_range4 o3) (= o3 (get (model__ left) o2)))))
(assert (not (< (length (mk___rep result____split_discrs (mk___split_fields result____split_fields))) (capacity (mk___rep result____split_discrs (mk___split_fields result____split_fields))))))
(check-sat)
(exit)
