...
(define-fun dynamic_invariant ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_189)))
...
(define-fun dynamic_invariant1 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 1 1000)) (in_range3 temp___expr_195)))
...
(define-fun dynamic_invariant2 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 1001)) (in_range4 temp___expr_207)))
...
(define-fun dynamic_invariant3 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 1000)) (in_range5 temp___expr_213)))
...
(define-fun dynamic_invariant4 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_201)))
...
(define-fun dynamic_invariant5 ((temp___expr_428 us_rep) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool)) Bool (=> (not (= temp___skip_constant_426 true)) (in_range7 r31b temp___expr_428)))
(define-fun default_initial_assumption ((temp___expr_430 us_rep) (temp___skip_top_level_431 Bool)) Bool (and (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 temp___expr_430))) r31b) (=> (not (= temp___skip_top_level_431 true)) (= (is_empty temp___expr_430) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_15)))
...
(declare-const temp___522 capacity_range)
(declare-const temp___5221 us_main_type)
...
(assert (and (and (and (= amortized_queue__Oconcat__3__result3 (mk_vector__ref amortized_queue__Oconcat__3__result2)) (and (= idx8 idx6) (= result____split_fields10 (mk___split_fields__ref result____split_fields9)))) (and (= amortized_queue__Oconcat__3__result4 amortized_queue__Oconcat__3__result2) (and (= idx9 idx7) (= result____split_fields11 result____split_fields9)))) (and (and (and (and (and (= o (length left)) (and (in_range5 o) (<= o (capacity left)))) (= amortized_queue__Oconcat__3__R30b__R31b__assume (+ o 1))) (= amortized_queue__Oconcat__3__R30b__R31b__assume r31b)) (in_range1 r31b)) (and (and (= us r31b) (in_range5 r31b)) (and (and (default_initial_assumption (mk___rep result____split_discrs (mk___split_fields result____split_fields)) false) (= r31b (to_rep (rec__amortized_queue__my_vectors__vector__capacity result____split_discrs)))) (and (and (and (and (= amortized_queue__Oconcat__3__L_4__R33b__assume 1) (and (in_range3 amortized_queue__Oconcat__3__L_4__R33b__assume) (= amortized_queue__Oconcat__3__L_4__R33b__assume 1))) (= amortized_queue__Oconcat__3__L_4__R33b__assume r33b)) (in_range3 r33b)) (and (and (and (and (= amortized_queue__Oconcat__3__L_4__R34b__assume (last (model__ left))) (and (in_range4 amortized_queue__Oconcat__3__L_4__R34b__assume) (= amortized_queue__Oconcat__3__L_4__R34b__assume (last (model__ left))))) (= amortized_queue__Oconcat__3__L_4__R34b__assume r34b)) (in_range4 r34b)) (and (and (and (= (mk_int__ref result) (mk_int__ref idx)) (= idx1 r33b)) (ite (and (<= r33b idx1) (<= idx1 r34b)) (and (and (and (and (= result____split_discrs (mk___split_discrs temp___522)) (= result____split_fields temp___5221)) (and (= temp___521 idx1) (and (and (and (and (and (= o1 idx1) (in_range3 idx1)) (and (= o2 (get (model__ left) o1)) (and (in_range6 o2) (= o2 (get (model__ left) o1))))) (and (and (= (length (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields))) (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))) true)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields)))) 1)) o2))) (and (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields result____split_fields))) (= (mk___split_fields result____split_fields2) (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))) (and (and (= (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) idx2) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 idx2)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) i2) (get (model__ left) i2))))) (and (and (=> (<= r33b r34b) (dynamic_property r33b r34b idx2)) (and (<= r33b idx2) (<= idx2 r34b))) (= idx2 r34b)))))) (and (and (= idx4 (mk_int__ref idx2)) (= result____split_fields5 (mk___split_fields__ref (mk___split_fields result____split_fields3)))) (and (= idx5 idx2) (= result____split_fields6 (mk___split_fields result____split_fields3))))) (and (and (= idx6 idx4) (= result____split_fields7 result____split_fields5)) (and (= idx7 idx5) (= result____split_fields8 result____split_fields6)))) (and (and (= idx6 (mk_int__ref idx1)) (= result____split_fields7 (mk___split_fields__ref (mk___split_fields result____split_fields)))) (and (= idx7 idx1) (= result____split_fields8 (mk___split_fields result____split_fields1)))))) (and (and (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields7))) 1)) (= (olt (model__ (mk___rep result____split_discrs (us_split_fields__content result____split_fields7))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (last (model__ (mk___rep result____split_discrs (us_split_fields__content result____split_fields7)))) 1)) right)) (and (= result4 result____split_fields7) (= result____split_fields9 amortized_queue__my_vectors__append__2__container__fields2))) (and (= result5 (mk_vector__ref (mk___rep (mk___split_discrs amortized_queue__Oconcat__3__result) (mk___split_fields amortized_queue__Oconcat__3__result1)))) (= amortized_queue__Oconcat__3__result2 (mk___rep result____split_discrs result____split_fields9))))))))))))
...
(assert (and (= o19 (length left)) (and (in_range5 o19) (<= o19 (capacity left)))))
(assert (= o20 (+ o19 1)))
(assert (and (= o21 (length (vector__content amortized_queue__Oconcat__3__result5))) (and (in_range5 o21) (<= o21 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
(assert (= result6 (ite (= o21 o20) true false)))
(assert (= result6 true))
(assert (and (= o13 (last (model__ left))) (and (in_range4 o13) (= o13 (last (model__ left))))))
(assert (= o14 (ite (<= i1 o13) true false)))
(assert (= result8 (ite (<= 1 i1) o14 false)))
(assert (= result8 true))
(assert (not (in_range3 i1)))
(check-sat)
(exit)
