...
(assert (= idx1 r33b))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (and (= result____split_discrs (mk___split_discrs temp___522)) (= result____split_fields temp___5221))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= temp___521 idx1)))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (and (= o1 idx1) (in_range3 idx1))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (and (= o2 (get (model__ left) o1)) (and (in_range6 o2) (= o2 (get (model__ left) o1))))))
...
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields13)) i1) (get (model__ left) i1))))))
...
(assert (and (= o5 (length left)) (and (in_range5 o5) (<= o5 (capacity left)))))
(assert (= o6 (+ o5 1)))
(assert (and (= o7 (length (vector__content amortized_queue__Oconcat__3__result5))) (and (in_range5 o7) (<= o7 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
(assert (= result4 (ite (= o7 o6) true false)))
(assert (= result4 true))
(assert (and (= o3 (last (model__ left))) (and (in_range4 o3) (= o3 (last (model__ left))))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (= result5 (ite (<= 1 i) o4 false)))
(assert (= result5 true))
