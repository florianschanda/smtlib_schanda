...
(declare-const temp___568 capacity_range)
(declare-const temp___5681 us_main_type)
...
(assert (= idx1 r33b))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (and (= result____split_discrs (mk___split_discrs temp___568)) (= result____split_fields temp___5681))))
(assert (=> (and (<= r33b idx1) (<= idx1 r34b)) (= temp___567 idx1)))
