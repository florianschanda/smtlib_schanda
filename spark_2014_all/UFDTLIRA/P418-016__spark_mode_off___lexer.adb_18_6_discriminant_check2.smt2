...
(define-fun default_initial_assumption ((temp___expr_216 us_rep1) (temp___skip_top_level_217 Bool)) Bool (and (= (attr__constrained temp___expr_216) false) (= (to_rep (rec__lexer__token__kind (us_split_discrs1 temp___expr_216))) 1)))
...
(define-fun dynamic_invariant ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 1)) (in_range temp___expr_207)))
(declare-const t__split_discrs token_kind)
(declare-const o token_kind)
(declare-const o1 token_kind)
(declare-const temp___225 token_kind)
(declare-const temp___2251 us_rep)
(declare-const temp___2252 Bool)
(assert (and (= t__attr__constrained false) (= (to_rep t__split_discrs) 1)))
(assert (= (to_rep o) 1))
(assert (= o o1))
(assert (= temp___225 o1))
(assert (= dummy temp___2251))
(assert (= true temp___2252))
(assert (= t__attr__constrained true))
(assert (not (= temp___225 t__split_discrs)))
(check-sat)
(exit)
