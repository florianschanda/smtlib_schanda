...
(define-fun temp___615 () us_rep2 (model__ l))
(declare-const temp___614 Int)
(assert (in_range2 temp___614))
(assert (= (iter_has_element temp___615 temp___614) true))
(assert (not (= (prop__ (get temp___615 temp___614)) true)))
(check-sat)
(exit)
