...
(define-fun default_initial_assumption ((temp___expr_404 us_rep2) (temp___skip_top_level_405 Bool)) Bool (=> (not (= temp___skip_top_level_405 true)) (= (length2 temp___expr_404) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___442 Int)) (=> (and (in_range3 temp___442) (= (iter_has_element result temp___442) true)) (= (has_key (model__ container) (get result temp___442)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container key2))))))
...
(define-fun default_initial_assumption1 ((temp___expr_368 us_rep3) (temp___skip_top_level_369 Bool)) Bool (=> (not (= temp___skip_top_level_369 true)) (and (= (is_empty temp___expr_368) true) (= (length3 temp___expr_368) 0))))
(assert true)
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant6 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= (equivalent_keys k key2) true))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant6 key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant7 result true false true true)))) :pattern ((get2 container key2))))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant6 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key2))))))
