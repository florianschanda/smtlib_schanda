...
(assert (= (= o4 true) (let ((temp___736 (elements s2))) (forall ((temp___735 Int)) (=> (and (in_range3 temp___735) (= (iter_has_element temp___736 temp___735) true)) (= (prop__ (get temp___736 temp___735)) true))))))
(assert (and (= temp___730 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length2 temp___730) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element temp___730 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get temp___730 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find temp___730 item)) (= (equivalent_elements (get temp___730 (find temp___730 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find temp___730 (get temp___730 i)) i) (= (e_is_find temp___730 (get temp___730 i) i) true)))))))
(assert (not true))
(check-sat)
(exit)
