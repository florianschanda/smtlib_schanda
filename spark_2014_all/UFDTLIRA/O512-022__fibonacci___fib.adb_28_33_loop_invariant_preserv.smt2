...
(assert (= temp___1661 result8))
(assert (= temp___1662 n12))
(assert (and (= o3 (+ a12 b12)) (in_range1 (+ a12 b12))))
(assert (= result9 (mk_int__ref a12)))
(assert (= a13 o3))
(assert (and (= o4 (- a13 b12)) (in_range1 (- a13 b12))))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (= result10 (mk_int__ref b12)))
(assert (= b13 o5))
(assert (and (= o6 (- n12 1)) (in_range2 (- n12 1))))
(assert (= result11 (mk_int__ref n12)))
(assert (= n13 o6))
(assert (and (= o7 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= result12 (mk_int__ref i2)))
(assert (= i3 o7))
(assert (< 2 n13))
(assert (not (= a13 (fibonacci i3))))
(check-sat)
(exit)
