...
(assert (and (= o7 (length (mk___rep l__split_discrs l__split_fields8))) (and (in_range2 o7) (<= o7 (to_rep (rec__my_lists__m__list__capacity l__split_discrs))))))
(assert (and (= o4 (positions (mk___rep l__split_discrs l__split_fields8))) (and (not (= (has_key o4 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o4 i) true) (and (and (<= 1 (get o4 i)) (<= (get o4 i) (length (mk___rep l__split_discrs l__split_fields8)))) (forall ((j us_rep1)) (=> (= (has_key o4 j) true) (=> (= (get o4 i) (get o4 j)) (= (bool_eq1 i j) true))))))))))
(assert (and (= o5 (get o4 (mk___rep1 d__split_fields7))) (and (in_range3 o5) (=> (= (distinct 0 0) true) (and (= o5 (w_get o4 (witness o4 (mk___rep1 d__split_fields7)))) (forall ((k us_rep1)) (=> (= (has_key o4 k) true) (= (= (bool_eq1 k (mk___rep1 d__split_fields7)) true) (= (witness o4 (mk___rep1 d__split_fields7)) (witness o4 k))))))))))
(assert (= o6 (+ o5 3)))
