...
(assert (and (= o5 (length (mk___rep l__split_discrs l__split_fields8))) (and (in_range1 o5) (<= o5 (to_rep (rec__my_lists__m__list__capacity l__split_discrs))))))
...
(assert (and (= o3 (get o2 (mk___rep1 d__split_fields7))) (and (in_range2 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 d__split_fields7)))) (forall ((k us_rep1)) (=> (= (has_key o2 k) true) (= (= (bool_eq1 k (mk___rep1 d__split_fields7)) true) (= (witness o2 (mk___rep1 d__split_fields7)) (witness o2 k))))))))))
(assert (= o4 (+ o3 3)))
