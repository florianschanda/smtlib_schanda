...
(assert (<= first3 i1))
(assert (<= i1 r1b))
(assert (= (length (mk___rep v2__split_discrs v2__split_fields6)) (- i2 first3)))
(assert (forall ((n Int)) (=> (and (<= first3 n) (<= n (last2 (model__ (mk___rep v2__split_discrs v2__split_fields6))))) (= (is_incr (get (model__ v1) n) (get (model__ (mk___rep v2__split_discrs v2__split_fields6)) n)) true))))
...
(declare-const n Int)
(assert (<= first3 n))
(assert (<= n (last2 (model__ (mk___rep v2__split_discrs v2__split_fields5)))))
