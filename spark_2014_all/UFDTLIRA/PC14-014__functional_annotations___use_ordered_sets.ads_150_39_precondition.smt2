...
(define-fun dynamic_invariant2 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_289)))
(assert true)
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant3 result true false true)))) :pattern ((find container item))))))
...
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant3 (length4 container) true false true) :pattern ((length4 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(declare-const temp___833 us_rep2)
(declare-const e Int)
...
(assert (forall ((e1 Int)) (=> (and (in_range2 e1) (= (contains (model__ s) e1) true)) (= (q e1) true))))
(assert (and (= o1 (has_key (positions s) (mk___rep1 (mk___split_fields1 cu)))) (= (= o1 true) (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu))) true))))
(assert (= o2 true))
(assert (= result (ite (= o2 true) o1 false)))
(assert (= result true))
(assert (not (= (has_key (positions s) (mk___rep1 (mk___split_fields1 cu))) true)))
(check-sat)
(exit)
