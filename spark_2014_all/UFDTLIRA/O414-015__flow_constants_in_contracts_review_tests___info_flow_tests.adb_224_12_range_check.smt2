...
(assert (forall ((x tt4B)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x tt4B)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= first last)) (dynamic_property first last temp___expr_201)))
(assert (= first a))
(assert (= last b))
(define-fun dynamic_invariant3 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= first1 last1)) (dynamic_property1 first1 last1 temp___expr_207)))
(assert (= first1 a))
(assert (= last1 b))
(define-fun dynamic_invariant4 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 last2)) (dynamic_property2 0 last2 temp___expr_213)))
(assert (= last2 last1))
(define-fun dynamic_invariant5 ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_219)))
(assert (= first2 0))
(assert (= last3 last2))
(declare-const c Int)
(declare-const d Int)
