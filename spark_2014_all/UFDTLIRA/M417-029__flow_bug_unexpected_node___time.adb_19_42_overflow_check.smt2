...
(declare-const o10 minutes_t)
(declare-const o11 natural)
(declare-const o12 minutes_t)
(declare-const o13 seconds_t)
(declare-const temp___184 natural)
(declare-const temp___1841 minutes_t)
(declare-const temp___1842 seconds_t)
...
(assert (= temp___184 o11))
(assert (= temp___1841 o12))
(assert (= temp___1842 o13))
(assert (= result2 (mk___split_fields__ref result____split_fields4)))
(assert (= result____split_fields5 (mk___split_fields temp___184 temp___1841 temp___1842)))
(assert (not (in_range1 (+ (to_rep (rec__time__t__hours result____split_fields5)) 1))))
(check-sat)
(exit)
