...
(define-fun result____split_fields8 () us_split_fields (mk___split_fields result____split_fields3 result____split_fields4 result____split_fields5))
...
(assert (= result____split_fields8 (us_split_fields1 x)))
(assert (not (< (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59)))
(assert (= result3 (mk___split_fields__ref result____split_fields8)))
...
(assert (= result4 (mk___split_fields__ref result____split_fields6)))
(assert (= result____split_fields7 (mk___split_fields (rec__time__t__hours result____split_fields6) rliteral4 (rec__time__t__seconds result____split_fields6))))
