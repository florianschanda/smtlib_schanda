...
(assert (and (= o15 (last2 left)) (and (dynamic_property1 first1 last1 o15) (= o15 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o15) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o13 first) (in_range1 first))))
(assert (=> (< offset 0) (and (= o14 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o14 o13) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o8 lst1) (in_range1 lst1)))
(assert (and (= o5 (length right)) (and (in_range3 o5) (<= (+ (- first 1) o5) last))))
(assert (and (= o3 first) (in_range1 first)))
(assert (= o4 (- o3 1)))
