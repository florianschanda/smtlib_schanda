...
(assert (and (= o (element (mk___rep l__split_discrs l__split_fields1) (mk___rep1 cu__split_fields2))) (and (in_range5 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields1)) (get1 (positions (mk___rep l__split_discrs l__split_fields1)) (mk___rep1 cu__split_fields2)))))))
(assert (= result2 (ite (<= o threshold) true false)))
(assert (= result2 true))
(assert (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields1)) (mk___rep1 cu__split_fields2)) true)))
(check-sat)
(exit)
