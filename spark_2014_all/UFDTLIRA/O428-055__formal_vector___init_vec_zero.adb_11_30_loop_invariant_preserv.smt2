...
(assert (= j3 result3))
(assert (= j4 (+ j3 1)))
(assert (and (= o5 j4) (in_range1 j4)))
(assert (and (and (= (length1 (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields1))) (length1 (mk___rep v__split_discrs (mk___split_fields v__split_fields3)))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields1))) o5) 0)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) (model__ (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields1))) o5) true)))
(assert (= result4 v__split_fields3))
(assert (= (mk___split_fields v__split_fields4) (mk___split_fields loop_types__vectors__replace_element__container__fields1)))
(declare-const k1 Int)
(assert (<= 1 k1))
(assert (<= k1 j4))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields4))) k1) 0)))
(check-sat)
(exit)
