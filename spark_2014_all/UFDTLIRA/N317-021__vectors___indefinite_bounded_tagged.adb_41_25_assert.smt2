...
(assert (not (= (let ((temp___594 (f 1))) (let ((temp___593 (get (model__ (mk___rep w__split_discrs w__split_fields1)) 1))) (ite (= (attr__tag temp___593) (attr__tag temp___594)) (us_dispatch_eq temp___593 temp___594) false))) true)))
(check-sat)
(exit)
