...
(assert (not (= (let ((temp___551 (f 1))) (let ((temp___550 (get (model__ (mk___rep1 w__split_discrs w__split_fields1)) 1))) (ite (= (attr__tag temp___550) (attr__tag temp___551)) (us_dispatch_eq temp___550 temp___551) false))) true)))
(check-sat)
(exit)
