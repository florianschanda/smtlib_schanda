...
(define-fun default_initial_assumption ((temp___expr_198 us_rep) (temp___skip_top_level_199 Bool)) Bool (=> (not (= temp___skip_top_level_199 true)) (= (is_empty temp___expr_198) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range3 temp___expr_191)))
