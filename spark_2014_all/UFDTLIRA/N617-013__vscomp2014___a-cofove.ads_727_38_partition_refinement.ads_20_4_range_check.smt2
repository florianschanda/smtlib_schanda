...
(define-fun dynamic_invariant ((temp___expr_308 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= 0 10000)) (in_range1 temp___expr_308)))
...
(define-fun dynamic_invariant1 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= (- 1) 10001)) (in_range6 temp___expr_325)))
...
(define-fun dynamic_invariant2 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 6)) (in_range4 temp___expr_277)))
(define-fun dynamic_invariant3 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 5)) (in_range5 temp___expr_284)))
...
(define-fun dynamic_invariant5 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 10001)) (in_range2 temp___expr_332)))
...
(define-fun dynamic_invariant6 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= (- 1) 10000)) (in_range3 temp___expr_366)))
...
(assert (and (= o (last (model__ container))) (and (in_range6 o) (= o (last (model__ container))))))
