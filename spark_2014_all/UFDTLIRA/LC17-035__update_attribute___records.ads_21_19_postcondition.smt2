...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields8 r__split_fields9 r__split_fields10 r__split_fields11)) (mk___rep (mk___split_fields r__split_fields (of_rep new_data) (of_rep1 new_data_2) r__split_fields3))) true)))
(check-sat)
(exit)
