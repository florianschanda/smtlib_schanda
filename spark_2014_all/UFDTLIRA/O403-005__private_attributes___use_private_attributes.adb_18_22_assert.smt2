...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (and (= (attr__constrained temp___expr_172) false) (= (to_rep (rec__private_with_attributes__private_unconstrained__c (us_split_discrs1 temp___expr_172))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_178 us_rep) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (and (=> (not (= temp___skip_constant_176 true)) (in_range1 0 temp___expr_178)) (= (attr__constrained temp___expr_178) true)))
(define-fun default_initial_assumption1 ((temp___expr_180 us_rep) (temp___skip_top_level_181 Bool)) Bool (and (= (attr__constrained temp___expr_180) true) (= (to_rep (rec__private_with_attributes__private_unconstrained__c (us_split_discrs1 temp___expr_180))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_256 us_rep) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool)) Bool (and (=> (not (= temp___skip_constant_254 true)) (in_range2 0 temp___expr_256)) (= (attr__constrained temp___expr_256) true)))
(define-fun default_initial_assumption2 ((temp___expr_258 us_rep) (temp___skip_top_level_259 Bool)) Bool (and (= (attr__constrained temp___expr_258) true) (= (to_rep (rec__private_with_attributes__private_unconstrained__c (us_split_discrs1 temp___expr_258))) 0)))
...
(declare-const temp___2721 us_main_type)
(declare-const temp___2722 Bool)
...
(assert (= c__split_fields1 (mk___split_fields u1__split_fields1)))
(assert (= c__split_discrs u1__split_discrs1))
(assert (not (= u1__attr__constrained true)))
(assert (not (= u2__attr__constrained true)))
(check-sat)
(exit)
