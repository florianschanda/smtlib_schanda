...
(define-fun default_initial_assumption ((temp___expr_337 us_rep) (temp___skip_top_level_338 Bool)) Bool (= (attr__tag temp___expr_337) us_tag))
...
(define-fun default_initial_assumption1 ((temp___expr_347 us_rep) (temp___skip_top_level_348 Bool)) Bool (= (attr__tag temp___expr_347) us_tag1))
...
(assert (not (us_compatible_tags x__attr__tag us_tag1)))
(check-sat)
(exit)
