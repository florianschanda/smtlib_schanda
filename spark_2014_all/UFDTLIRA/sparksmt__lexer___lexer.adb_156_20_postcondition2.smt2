...
(assert (not (= (local_invariant (mk___split_fields1 current_read__split_fields2) (us_split_discrs__content1 current_read__split_discrs2) (us_split_fields__content1 next_read__split_fields2) (us_split_discrs__content1 next_read__split_discrs2)) true)))
(check-sat)
(exit)
