...
(assert (not (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields9)) (mk___rep1 (mk___split_fields1 (of_rep1 f) (mk___rep (mk___split_fields (of_rep e) r__split_fields2)) (of_rep3 2)))) true)))
(check-sat)
(exit)
