...
(assert (=> (not (= state 0)) (= (mk_int__ref state7) (mk_int__ref state5))))
(assert (=> (not (= state 0)) (= (mk_int__ref speed7) (mk_int__ref speed5))))
(assert (=> (not (= state 0)) (= state8 state6)))
(assert (=> (not (= state 0)) (= speed8 speed6)))
(assert (=> (= state 0) (= (mk_int__ref state7) (mk_int__ref state))))
(assert (=> (= state 0) (= (mk_int__ref speed7) (mk_int__ref speed))))
(assert (=> (= state 0) (= state8 state1)))
(assert (=> (= state 0) (= speed8 speed1)))
(assert (= (mk_int__ref state9) (mk_int__ref state7)))
(assert (= (mk_int__ref speed9) (mk_int__ref speed7)))
