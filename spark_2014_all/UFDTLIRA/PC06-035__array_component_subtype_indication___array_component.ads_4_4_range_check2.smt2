...
(assert (= d (id 0)))
(declare-const array_component__d__assume Int)
(assert (and (= array_component__d__assume (id 0)) (and (in_range array_component__d__assume) (= array_component__d__assume 0))))
