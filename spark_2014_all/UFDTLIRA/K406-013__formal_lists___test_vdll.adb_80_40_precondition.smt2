...
(assert (and (= o38 (next (mk___rep l3__split_discrs l3__split_fields2) o37)) (ite (= (ite (= (bool_eq1 o37 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o37) (length (mk___rep l3__split_discrs l3__split_fields2))) true) true) (= (bool_eq1 o38 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o38) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o38) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o37) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o38) true) (= (bool_eq1 o38 no_element) true))))
(check-sat)
(exit)
