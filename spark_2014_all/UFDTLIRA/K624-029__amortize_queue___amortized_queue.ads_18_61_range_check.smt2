...
(assert (and (= o8 (length right)) (and (in_range5 o8) (<= o8 (capacity right)))))
(assert (and (= o9 (length left)) (and (in_range5 o9) (<= o9 (capacity left)))))
(assert (= o10 (+ o9 o8)))
(assert (and (= o11 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range5 o11) (<= o11 (capacity (vector__content amortized_queue__Oconcat__result5))))))
