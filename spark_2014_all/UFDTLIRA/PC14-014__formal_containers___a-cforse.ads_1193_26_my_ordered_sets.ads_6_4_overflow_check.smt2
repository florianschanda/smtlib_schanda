...
(define-fun default_initial_assumption ((temp___expr_390 us_rep2) (temp___skip_top_level_391 Bool)) Bool (=> (not (= temp___skip_top_level_391 true)) (= (length2 temp___expr_390) 0)))
