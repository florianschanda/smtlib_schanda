...
(define-fun dynamic_invariant5 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_214)))
(assert true)
...
(define-fun use_lists__incr_all_3__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_lists__incr_all_3__cu__assume)))
(assert (and (= use_lists__incr_all_3__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 use_lists__incr_all_3__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_3__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_3__cu__assume1) 1)))))
...
(assert (=> (= result1 true) (forall ((n Int)) (=> (and (<= 1 n) (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1))) (= (is_incr (get temp___543 n) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n)) true)))))
(assert (=> (= result1 true) (forall ((n Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) n) (<= n (length (mk___rep l__split_discrs l__split_fields11)))) (= (get temp___544 n) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n))))))
(assert (=> (= result1 true) (= (oeq1 temp___545 (positions (mk___rep l__split_discrs l__split_fields11))) true)))
(assert (=> (= result1 true) (and (= o (element (mk___rep l__split_discrs l__split_fields11) (mk___rep1 cu__split_fields11))) (and (in_range6 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields11)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11))))))))
(assert (=> (= result1 true) (= result2 (ite (< o 2147483647) true false))))
(assert (=> (= result1 true) (=> (= result2 true) (and (= o1 (element (mk___rep l__split_discrs l__split_fields11) (mk___rep1 cu__split_fields11))) (and (in_range6 o1) (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields11)) (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)))))))))
(assert (=> (= result1 true) (=> (= result2 true) (= o2 (+ o1 1)))))
(assert (=> (= result1 true) (=> (= result2 true) (and (= o3 o2) (in_range1 o2)))))
...
(assert (not (= (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(check-sat)
(exit)
