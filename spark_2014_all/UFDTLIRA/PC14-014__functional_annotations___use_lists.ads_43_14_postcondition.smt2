...
(assert (=> (= result1 true) (= (length (mk___rep l__split_discrs l__split_fields11)) temp___499)))
(assert (=> (= result1 true) (forall ((n Int)) (=> (and (<= 1 n) (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1))) (= (is_incr (get temp___500 n) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n)) true)))))
(assert (=> (= result1 true) (forall ((n Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) n) (<= n (length (mk___rep l__split_discrs l__split_fields11)))) (= (get temp___501 n) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n))))))
(assert (=> (= result1 true) (= (oeq1 temp___502 (positions (mk___rep l__split_discrs l__split_fields11))) true)))
