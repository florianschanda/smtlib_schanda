...
(define-fun dynamic_invariant5 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_183)))
(assert true)
...
(declare-const temp___498 count_type)
(declare-const temp___4981 us_main_type)
(declare-const temp___499 Int)
(declare-const temp___502 us_rep3)
(declare-const temp___500 us_rep2)
(declare-const temp___497 count_type)
(declare-const temp___501 us_rep2)
(declare-const n Int)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_lists__incr_all_3__cu__assume)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_lists__incr_all_3__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__incr_all_3__cu__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 use_lists__incr_all_3__cu__assume))) 1)))))
...
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___498)) (= l__split_fields temp___4981))))
(assert (=> (= result1 true) (= temp___499 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___502 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___500 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___497 cu__split_fields1)))
(assert (=> (= result1 true) (= temp___501 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) temp___499)))
(assert (=> (= result1 true) (forall ((n3 Int)) (=> (and (<= 1 n3) (<= n3 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (is_incr (get temp___500 n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) n3)) true)))))
(assert (=> (= result1 true) (forall ((n3 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) n3) (<= n3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (= (get temp___501 n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) n3))))))
(assert (=> (= result1 true) (= (oeq1 temp___502 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) true)))
(assert (=> (= result1 true) (and (= o17 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o17) (= o17 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result1 true) (= result4 (ite (< o17 2147483647) true false))))
(assert (=> (= result1 true) (=> (= result4 true) (and (= o18 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o18) (= o18 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))))
(assert (=> (= result1 true) (=> (= result4 true) (= o19 (+ o18 1)))))
(assert (=> (= result1 true) (=> (= result4 true) (and (= o20 o19) (in_range1 o19)))))
(assert (=> (= result1 true) (=> (= result4 true) (and (and (and (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true)) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) o20)) (= (equal_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) true)))))
(assert (=> (= result1 true) (=> (not (= result4 true)) (= (mk___split_fields l__split_fields3) (mk___split_fields l__split_fields2)))))
(assert (=> (= result1 true) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields3)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (=> (= result1 true) (and (= o21 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3)))) (= (= o21 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields3))) true)))))
(assert (=> (= result1 true) (= result5 (ite (not (= o21 true)) true false))))
(assert (=> (= result1 true) (= result5 true)))
(assert (=> (= result1 true) (= cu__split_fields4 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields3)))))
(assert (=> (= result1 true) (= l__split_fields4 (mk___split_fields__ref (mk___split_fields l__split_fields3)))))
(assert (=> (= result1 true) (= cu__split_fields5 (mk___split_fields1 cu__split_fields3))))
(assert (=> (= result1 true) (= l__split_fields5 (mk___split_fields l__split_fields3))))
