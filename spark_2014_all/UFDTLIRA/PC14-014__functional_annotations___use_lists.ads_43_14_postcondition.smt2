...
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))))
(assert (not (= (is_incr (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) n) (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) n)) true)))
(check-sat)
(exit)
