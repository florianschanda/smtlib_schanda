...
(define-fun o15 () us_rep (mk___rep (mk___split_fields o5 o6)))
(assert (in_range2 x))
(assert (and (= o11 (length p)) (and (in_range4 o11) (<= o11 (capacity p)))))
...
(assert (and (= o15 (get (model__ p) o4)) (= (bool_eq o15 (get (model__ p) o4)) true)))
(assert (= o5 o7))
(assert (= o6 o8))
(assert (= o9 o8))
