...
(define-fun o15 () us_rep2 (mk___rep1 (mk___split_fields1 o5 o6)))
(assert (in_range5 x))
(assert (and (= o11 (length p)) (and (in_range1 o11) (<= o11 (capacity p)))))
(assert (and (= o12 o11) (in_range5 o11)))
(assert (= o13 (- o12 1)))
(assert (= o14 (ite (<= x o13) true false)))
(assert (= result (ite (<= 0 x) o14 false)))
(assert (= result true))
...
(assert (and (= o15 (get (model__ p) o4)) (= (bool_eq1 o15 (get (model__ p) o4)) true)))
(assert (= o5 o7))
(assert (= o6 o8))
(assert (= o9 o8))
