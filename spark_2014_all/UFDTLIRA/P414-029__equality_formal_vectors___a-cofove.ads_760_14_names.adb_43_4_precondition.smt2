...
(define-fun dynamic_invariant ((temp___expr_422 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 1 2147483647)) (in_range2 temp___expr_422)))
...
(define-fun default_initial_assumption ((temp___expr_480 us_rep1) (temp___skip_top_level_481 Bool)) Bool (=> (not (= temp___skip_top_level_481 true)) (= (length temp___expr_480) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_437 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= 0 2147483647)) (in_range6 temp___expr_437)))
...
(define-fun dynamic_invariant4 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range4 temp___expr_180)))
...
(define-fun dynamic_invariant6 ((temp___expr_443 Int) (temp___is_init_440 Bool) (temp___skip_constant_441 Bool) (temp___do_toplevel_442 Bool)) Bool (=> (or (= temp___is_init_440 true) (<= 0 2147483647)) (in_range1 temp___expr_443)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 0) true) (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant7 ((temp___expr_473 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 0 2147483647)) (in_range8 temp___expr_473)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true))) :pattern ((length container1)))))
(assert true)
