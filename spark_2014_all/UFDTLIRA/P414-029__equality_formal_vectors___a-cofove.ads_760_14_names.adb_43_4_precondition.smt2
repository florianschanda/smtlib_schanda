...
(define-fun dynamic_invariant ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 1 2147483647)) (in_range2 temp___expr_474)))
...
(define-fun bool_eq1 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep2 (rec__names__name_entry__table_index (us_split_fields3 a))) (to_rep2 (rec__names__name_entry__table_index (us_split_fields3 b)))) (= (to_rep (rec__names__name_entry__length (us_split_fields3 a))) (to_rep (rec__names__name_entry__length (us_split_fields3 b))))) (= (to_rep1 (rec__names__name_entry__next_hash (us_split_fields3 a))) (to_rep1 (rec__names__name_entry__next_hash (us_split_fields3 b))))) true false))
...
(define-fun oeq ((left us_rep1) (right us_rep1)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq1 (get left n) (get right n)) true))) true false)))
(declare-fun oeq__function_guard (Bool us_rep1 us_rep1) Bool)
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq3 a b) (oeq a b)) :pattern ((user_eq3 a b)))))
(define-fun default_initial_assumption ((temp___expr_540 us_rep1) (temp___skip_top_level_541 Bool)) Bool (=> (not (= temp___skip_top_level_541 true)) (= (length temp___expr_540) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_491 Int) (temp___is_init_487 Bool) (temp___skip_constant_488 Bool) (temp___do_toplevel_489 Bool) (temp___do_typ_inv_490 Bool)) Bool (=> (or (= temp___is_init_487 true) (<= 0 2147483647)) (in_range6 temp___expr_491)))
...
(define-fun dynamic_invariant3 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range5 temp___expr_296)))
(define-fun dynamic_invariant4 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range4 temp___expr_210)))
...
(define-fun dynamic_invariant6 ((temp___expr_498 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool) (temp___do_typ_inv_497 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 0 2147483647)) (in_range1 temp___expr_498)))
...
(assert (forall ((x capacity_range)) (! (in_range1 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range1 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 0 0) true) (to_rep3 (rec__names__entry_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant7 ((temp___expr_532 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool) (temp___do_typ_inv_531 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= 0 2147483647)) (in_range8 temp___expr_532)))
