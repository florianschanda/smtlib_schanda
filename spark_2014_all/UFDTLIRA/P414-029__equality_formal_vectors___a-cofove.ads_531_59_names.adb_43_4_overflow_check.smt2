...
(define-fun dynamic_invariant1 ((temp___expr_498 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool) (temp___do_typ_inv_497 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 0 2147483647)) (in_range2 temp___expr_498)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o) (= o (ite (= (distinct 0 0) true) (to_rep (rec__names__entry_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
