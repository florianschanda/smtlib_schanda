...
(define-fun default_initial_assumption ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__q__po2T__content (us_split_fields1 temp___expr_201))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_208 us_rep1) (temp___skip_top_level_209 Bool)) Bool (= (to_rep (rec__p__po1T__content (us_split_fields3 temp___expr_208))) 0))
