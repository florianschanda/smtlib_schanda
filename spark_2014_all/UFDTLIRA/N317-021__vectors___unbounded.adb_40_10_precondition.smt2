...
(assert (not (<= (length (mk___rep w__split_discrs w__split_fields1)) (- (capacity (mk___rep w__split_discrs w__split_fields1)) (length (mk___rep v__split_discrs v__split_fields5))))))
(check-sat)
(exit)
