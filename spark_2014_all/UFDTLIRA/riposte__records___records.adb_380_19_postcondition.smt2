...
(assert (= result6 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__make_optional_pair_a_2__result (mk___rep (mk___split_fields records__make_optional_pair_a_2__result1 records__make_optional_pair_a_2__result2)))))))
(assert (= records__make_optional_pair_a_2__result3 (mk___rep1 r__split_fields11)))
...
(assert (= (mk___rep1 (mk___split_fields1 result7 (mk___rep (mk___split_fields result8 result9)))) (optional_pair__content records__make_optional_pair_a_2__result6)))
