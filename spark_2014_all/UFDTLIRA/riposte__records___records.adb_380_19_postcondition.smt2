...
(declare-const temp___4131 unsigned_byte)
(declare-const temp___4132 unsigned_byte)
...
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= temp___413 o6))
(assert (= temp___4131 o7))
(assert (= temp___4132 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= r__split_fields3 (mk___split_fields1 temp___413 (mk___rep (mk___split_fields temp___4131 temp___4132)))))
...
(assert (not (= (bool_eq1 (optional_pair__content records__make_optional_pair_a_2__result6) (mk___rep1 (mk___split_fields1 (of_int 0) x))) true)))
(check-sat)
(exit)
