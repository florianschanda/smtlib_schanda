...
(declare-const records__make_optional_pair_a_2__result Bool)
(declare-const records__make_optional_pair_a_2__result1 unsigned_byte)
(declare-const records__make_optional_pair_a_2__result2 unsigned_byte)
...
(declare-const temp___446 Bool)
(declare-const temp___4461 unsigned_byte)
(declare-const temp___4462 unsigned_byte)
...
(declare-const records__make_optional_pair_a_2__result3 us_rep1)
(declare-const records__make_optional_pair_a_2__result4 optional_pair__ref)
(declare-const records__make_optional_pair_a_2__result5 us_rep1)
(declare-const r__split_fields5 us_split_fields__ref1)
(declare-const records__make_optional_pair_a_2__result6 optional_pair__ref)
(declare-const r__split_fields6 us_split_fields2)
(declare-const records__make_optional_pair_a_2__result7 us_rep1)
...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= (distinct 1 0) o6))
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= temp___446 o6))
(assert (= temp___4461 o7))
(assert (= temp___4462 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= r__split_fields3 (mk___split_fields1 temp___446 (mk___rep (mk___split_fields temp___4461 temp___4462)))))
(assert (= result3 (mk___split_fields__ref1 r__split_fields3)))
(assert (= r__split_fields4 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists r__split_fields3) x)))
(assert (= records__make_optional_pair_a_2__result4 (mk_optional_pair__ref records__make_optional_pair_a_2__result3)))
(assert (= records__make_optional_pair_a_2__result5 records__make_optional_pair_a_2__result3))
(assert (= result4 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__make_optional_pair_a_2__result (mk___rep (mk___split_fields records__make_optional_pair_a_2__result1 records__make_optional_pair_a_2__result2)))))))
(assert (= records__make_optional_pair_a_2__result3 (mk___rep1 r__split_fields4)))
(assert (= records__make_optional_pair_a_2__result6 records__make_optional_pair_a_2__result4))
(assert (= r__split_fields5 (mk___split_fields__ref1 r__split_fields4)))
(assert (= records__make_optional_pair_a_2__result7 records__make_optional_pair_a_2__result5))
(assert (= r__split_fields6 r__split_fields4))
(assert (= (mk___rep1 (mk___split_fields1 result5 (mk___rep (mk___split_fields result6 result7)))) (optional_pair__content records__make_optional_pair_a_2__result6)))
(assert (not (= (bool_eq1 (optional_pair__content records__make_optional_pair_a_2__result6) (mk___rep1 (mk___split_fields1 (distinct 0 0) x))) true)))
(check-sat)
(exit)
