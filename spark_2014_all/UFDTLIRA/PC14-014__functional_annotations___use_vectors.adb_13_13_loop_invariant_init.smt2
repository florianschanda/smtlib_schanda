...
(assert (<= first n2))
(assert (<= n2 (last4 (model__ (mk___rep v2__split_discrs (mk___split_fields v2__split_fields))))))
(assert (not (= (is_incr (get (model__ v1) n2) (get (model__ (mk___rep v2__split_discrs (mk___split_fields v2__split_fields))) n2)) true)))
(check-sat)
(exit)
