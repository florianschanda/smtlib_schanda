...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 2)) (in_range2 temp___expr_135)))
(assert (not (in_range2 (to_rep2 (rec__basic__r__x (us_split_discrs1 v))))))
(check-sat)
(exit)
