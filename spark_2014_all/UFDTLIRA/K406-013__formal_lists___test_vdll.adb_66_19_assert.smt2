...
(assert (not (= (bool_eq3 (find (mk___rep l1__split_discrs l1__split_fields4) 1 (next (mk___rep l1__split_discrs l1__split_fields4) (first (mk___rep l1__split_discrs l1__split_fields4)))) no_element) true)))
(check-sat)
(exit)
