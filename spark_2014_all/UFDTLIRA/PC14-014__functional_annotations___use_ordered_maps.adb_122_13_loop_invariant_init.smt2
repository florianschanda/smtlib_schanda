...
(assert (= result1 true))
(assert (not (< (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (+ (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get2 (positions s2) (mk___rep1 cu__split_fields2))))))
(check-sat)
(exit)
