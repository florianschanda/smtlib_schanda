...
(declare-const c__split_fields1 us_private)
...
(assert (= (mk___split_fields cc__split_fields1) (mk___split_fields c__split_fields1)))
(assert (= cc__attr__tag c__attr__tag))
(assert (= result2 r2__split_fields))
(assert (= (mk___split_fields r2__split_fields1) (mk___split_fields c__split_fields1)))
...
(assert (not (us_compatible_tags cc__attr__tag us_tag1)))
(check-sat)
(exit)
