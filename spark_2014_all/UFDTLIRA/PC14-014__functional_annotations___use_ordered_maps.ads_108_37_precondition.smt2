...
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (= (length1 o2) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element o2 temp___439) true)) (= (has_key (model__ s) (get o2 temp___439)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find o2 key)) (= (equivalent_keys (get o2 (find o2 key)) key) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o2 (get o2 i1)) i1) (= (k_is_find o2 (get o2 i1) i1) true)))))))
