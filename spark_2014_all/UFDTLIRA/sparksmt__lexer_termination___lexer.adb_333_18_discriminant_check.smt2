...
(assert (= (to_rep1 o) 1))
(assert (= o o8))
(assert (= temp___979 o8))
(assert (= temp___9791 o4))
(assert (= temp___9792 o5))
(assert (= temp___9793 o6))
(assert (= temp___9794 o7))
(assert (= true temp___9795))
(assert (= t__attr__constrained true))
(assert (not (= temp___979 t__split_discrs)))
(check-sat)
(exit)
