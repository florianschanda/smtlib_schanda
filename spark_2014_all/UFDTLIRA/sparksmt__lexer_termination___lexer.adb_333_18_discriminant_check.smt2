...
(assert (= (to_rep1 o) 1))
(assert (= o o8))
(assert (= temp___969 o8))
(assert (= temp___9691 o4))
(assert (= temp___9692 o5))
(assert (= temp___9693 o6))
(assert (= temp___9694 o7))
(assert (= true temp___9695))
(assert (= t__attr__constrained true))
(assert (not (= temp___969 t__split_discrs)))
(check-sat)
(exit)
