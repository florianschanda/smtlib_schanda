...
(assert (and (= o40 (first (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq1 o40 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o40) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o40) 1)))))
(assert (and (= o41 (next (mk___rep l3__split_discrs l3__split_fields2) o40)) (ite (= (ite (= (bool_eq1 o40 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o40) (length (mk___rep l3__split_discrs l3__split_fields2))) true) true) (= (bool_eq1 o41 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o41) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o41) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o40) 1))))))
