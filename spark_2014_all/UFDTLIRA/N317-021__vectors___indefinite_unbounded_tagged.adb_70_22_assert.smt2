...
(assert (not (= (let ((temp___657 (f 3))) (let ((temp___656 (get (model__ (mk___rep1 v__split_discrs v__split_fields8)) 1))) (ite (= (attr__tag temp___656) (attr__tag temp___657)) (us_dispatch_eq temp___656 temp___657) false))) true)))
(check-sat)
(exit)
