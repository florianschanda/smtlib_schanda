...
(declare-const p__identity_swap__l_in__assume1 us_main_type1)
(declare-const l__split_fields1 us_main_type1)
(define-fun p__identity_swap__l_in__assume2 () us_rep1 (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)))
(assert (in_range5 i1))
(assert (in_range5 i2))
...
(assert (not (<= i2 (last (model__ l_in)))))
(check-sat)
(exit)
