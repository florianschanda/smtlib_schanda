...
(define-fun dynamic_invariant ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 1 10)) (in_range1 temp___expr_189)))
...
(define-fun dynamic_invariant1 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 1 2147483647)) (in_range2 temp___expr_195)))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 0 11)) (in_range5 temp___expr_201)))
...
(define-fun dynamic_invariant4 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 10)) (in_range3 temp___expr_207)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__my_vectors__v__vector__capacity (us_split_discrs1 container1))) 10))
...
(define-fun dynamic_invariant5 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 10)) (in_range4 temp___expr_234)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ 0 result) 10) (dynamic_invariant3 result true false true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range7 temp___expr_228)))
