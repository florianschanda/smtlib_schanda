...
(assert (and (= o3 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o3 no_element) true) (and (= (has_key (positions l) o3) true) (= (get1 (positions l) o3) 1)))))
(assert (= temp___547 o))
...
(assert (< 0 count_11))
(assert (not (exists ((cu us_rep2)) (and (= (has_key (positions l) cu) true) (= (element l cu) 1)))))
(check-sat)
(exit)
