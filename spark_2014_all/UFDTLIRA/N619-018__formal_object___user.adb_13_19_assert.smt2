...
(assert (forall ((user__x Int)) (! (=> (dynamic_invariant user__x true true true) (dynamic_invariant (get user__x) true false true)) :pattern ((get user__x)))))
(declare-fun get1 (Int) Int)
(declare-fun get__function_guard1 (Int Int) Bool)
(assert (forall ((user__y Int)) (! (=> (dynamic_invariant user__y true true true) (dynamic_invariant (get1 user__y) true false true)) :pattern ((get1 user__y)))))
(declare-const x Int)
(declare-const y Int)
