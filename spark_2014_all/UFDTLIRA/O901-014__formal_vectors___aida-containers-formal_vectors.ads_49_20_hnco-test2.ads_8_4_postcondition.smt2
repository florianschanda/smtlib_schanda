...
(assert (= hnco__test2__v_type_owner__capacity__result1 hnco__test2__v_type_owner__capacity__result2))
(assert (= hnco__test2__v_type_owner__capacity__result3 hnco__test2__v_type_owner__capacity__result1))
(assert (= result hnco__test2__v_type_owner__capacity__result))
(assert (= hnco__test2__v_type_owner__capacity__result1 (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container)))))
(assert (= (mk_int__ref hnco__test2__v_type_owner__capacity__result4) (mk_int__ref hnco__test2__v_type_owner__capacity__result2)))
(assert (= hnco__test2__v_type_owner__capacity__result5 hnco__test2__v_type_owner__capacity__result3))
(assert (= result1 hnco__test2__v_type_owner__capacity__result4))
(assert (not (<= (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))) hnco__test2__v_type_owner__capacity__result4)))
(check-sat)
(exit)
