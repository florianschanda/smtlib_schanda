...
(assert (and (and (and (= us (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container)))) (in_range (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))))) (and (and (= hnco__test2__v_type_owner__capacity__result1 hnco__test2__v_type_owner__capacity__result2) (= hnco__test2__v_type_owner__capacity__result3 hnco__test2__v_type_owner__capacity__result1)) (and (= result hnco__test2__v_type_owner__capacity__result) (= hnco__test2__v_type_owner__capacity__result1 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))))))) (and (= (mk_int__ref hnco__test2__v_type_owner__capacity__result4) (mk_int__ref hnco__test2__v_type_owner__capacity__result2)) (= hnco__test2__v_type_owner__capacity__result5 hnco__test2__v_type_owner__capacity__result3))))
(assert (= result1 hnco__test2__v_type_owner__capacity__result4))
(assert (not (<= (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))) hnco__test2__v_type_owner__capacity__result4)))
(check-sat)
(exit)
