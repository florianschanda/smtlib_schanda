...
(assert (<= 1 n2))
(assert (<= n2 (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))))
(assert (not (= (is_incr (get (model__ l1) n2) (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) n2)) true)))
(check-sat)
(exit)
