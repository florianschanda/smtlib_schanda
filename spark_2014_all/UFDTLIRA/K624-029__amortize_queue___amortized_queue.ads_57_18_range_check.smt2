...
(assert (and (= o5 (length m)) (and (in_range4 o5) (<= o5 (capacity m)))))
...
(assert (and (= o4 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o4) (<= o4 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o6 (+ o4 o3)))
(assert (= result2 (ite (= o6 o5) true false)))
(assert (=> (= result2 true) (and (= o2 (length m)) (and (in_range4 o2) (<= o2 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o2 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o) (<= o (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
