...
(define-fun n_last__split_fields2 () us_split_fields2 (mk___split_fields1 n_last__split_fields1))
...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 n_last__split_fields2)) true) (= (bool_eq1 (mk___rep1 n_last__split_fields2) no_element) true))))
(check-sat)
(exit)
