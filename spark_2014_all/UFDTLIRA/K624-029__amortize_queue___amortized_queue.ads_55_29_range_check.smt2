...
(assert (and (= o10 (length m)) (and (in_range2 o10) (<= o10 (capacity m)))))
(assert (and (= o8 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o8) (<= o8 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o9 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o9) (<= o9 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o11 (+ o9 o8)))
(assert (= result1 (ite (= o11 o10) true false)))
(assert (=> (= result1 true) (and (= o7 (length m)) (and (in_range2 o7) (<= o7 (capacity m))))))
...
(assert (and (= o6 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o5)) (and (in_range3 o6) (= o6 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o5)))))
