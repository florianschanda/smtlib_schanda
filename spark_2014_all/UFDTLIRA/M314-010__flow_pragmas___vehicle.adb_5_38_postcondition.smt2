...
(assert (=> (not (= state 0)) (= temp___183 speed)))
(assert (=> (not (= state 0)) (= temp___182 state)))
(assert (=> (not (= state 0)) (= (speed_is_valid speed2 state2) true)))
(assert (=> (not (= state 0)) (and (and (in_range1 state2) (in_range2 speed2)) (not (= state2 0)))))
(assert (=> (not (= state 0)) (=> (< 0 speed2) (and (= (speed_is_valid speed3 state3) true) (and (in_range1 state3) (in_range2 speed3))))))
(assert (=> (not (= state 0)) (=> (not (< 0 speed2)) (and (= (speed_is_valid speed4 state4) true) (and (in_range1 state4) (in_range2 speed4))))))
