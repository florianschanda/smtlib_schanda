...
(define-fun dynamic_invariant2 ((temp___expr_292 us_rep1) (temp___is_init_288 Bool) (temp___skip_constant_289 Bool) (temp___do_toplevel_290 Bool) (temp___do_typ_inv_291 Bool)) Bool (in_range2 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 temp___expr_292))) (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 temp___expr_292))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (capacity container1)) (dynamic_invariant3 result true false true true))) :pattern ((length container1)))))
