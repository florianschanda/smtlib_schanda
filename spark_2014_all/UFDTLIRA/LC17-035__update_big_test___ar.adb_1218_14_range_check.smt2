...
(declare-const temp___6604 et1)
(declare-const temp___66041 et2)
(declare-const o4 et2)
(declare-const o5 et1)
(declare-const o6 et2)
(declare-const temp___6606 et1)
(declare-const temp___66061 et2)
...
(assert (not (in_range1 (to_rep r__split_fields))))
(check-sat)
(exit)
