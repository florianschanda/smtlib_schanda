...
(assert (=> (= result3 true) (and (= o13 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o13))))
(assert (=> (= result3 true) (= o14 (ite (= o13 3) true false))))
(assert (=> (= result3 true) (= o15 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result4 true) (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6))))))
(assert (=> (= result4 true) (= o8 (ite (not (= o7 true)) true false))))
(assert (=> (= result4 true) (and (= o4 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range3 o4))))
(assert (=> (= result4 true) (= o5 (ite (= o4 3) true false))))
(assert (=> (= result4 true) (= o6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6))))))
