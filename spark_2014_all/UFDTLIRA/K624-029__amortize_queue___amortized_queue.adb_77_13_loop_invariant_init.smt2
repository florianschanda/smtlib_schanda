...
(define-fun front__split_fields2 () us_split_fields (mk___split_fields front__split_fields1))
...
(assert (= front__split_fields2 amortized_queue__my_vectors__append__2__container__fields1))
(declare-const i Int)
(assert (<= idx1 i))
(assert (<= i (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))))
(assert (not (= (get (model__ (mk___rep front__split_discrs front__split_fields2)) (- (+ (last (model__ (mk___rep front__split_discrs front__split_fields2))) idx1) i)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i))))
(check-sat)
(exit)
