...
(assert (<= idx1 i4))
(assert (<= i4 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))))
(assert (not (= (get (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields2))) (- (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields2)))) idx1) i4)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i4))))
(check-sat)
(exit)
