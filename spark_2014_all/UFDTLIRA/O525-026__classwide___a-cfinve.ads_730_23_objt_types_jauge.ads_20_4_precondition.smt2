...
(define-fun default_initial_assumption ((temp___expr_216 us_rep) (temp___skip_top_level_217 Bool)) Bool (= (attr__tag temp___expr_216) us_tag))
...
(define-fun dynamic_invariant ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 1 4)) (in_range1 temp___expr_231)))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__objt_types_jauge__objt_liste_jauge__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields2)) us_main_type (rec__objt_types_jauge__objt_liste_jauge__vector a))
...
(define-fun default_initial_assumption1 ((temp___expr_279 us_rep2) (temp___skip_top_level_280 Bool)) Bool (=> (not (= temp___skip_top_level_280 true)) (= (length temp___expr_279) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_241 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 5)) (in_range4 temp___expr_241)))
...
(define-fun dynamic_invariant2 ((temp___expr_209 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range5 temp___expr_209)))
(define-fun dynamic_invariant3 ((temp___expr_247 Int) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool)) Bool (=> (or (= temp___is_init_244 true) (<= 0 4)) (in_range2 temp___expr_247)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (of_int 1) true) (to_rep (rec__objt_types_jauge__objt_liste_jauge__vector__capacity (us_split_discrs1 container1))) 4))
(declare-fun capacity__function_guard (Int us_rep1) Bool)
(assert (forall ((container1 us_rep1)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant3 result true false true))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant4 ((temp___expr_272 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= 0 4)) (in_range3 temp___expr_272)))
(assert (forall ((container1 us_rep2)) (! (let ((result (length container1))) (and (<= (+ 0 result) 4) (dynamic_invariant2 result true false true))) :pattern ((length container1)))))
(assert true)
...
(assert (and (= o4 (last (model__ container))) (and (in_range4 o4) (= o4 (last (model__ container))))))
