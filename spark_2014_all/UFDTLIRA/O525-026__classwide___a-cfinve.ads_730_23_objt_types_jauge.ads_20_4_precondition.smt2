...
(define-fun default_initial_assumption ((temp___expr_247 us_rep) (temp___skip_top_level_248 Bool)) Bool (= (attr__tag temp___expr_247) us_tag))
...
(define-fun dynamic_invariant ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 1 4)) (in_range1 temp___expr_265)))
...
(define-fun default_initial_assumption1 ((temp___expr_321 us_rep2) (temp___skip_top_level_322 Bool)) Bool (=> (not (= temp___skip_top_level_322 true)) (= (length temp___expr_321) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 5)) (in_range4 temp___expr_277)))
...
(define-fun dynamic_invariant3 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 4)) (in_range2 temp___expr_284)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep (rec__objt_types_jauge__objt_liste_jauge__vector__capacity (us_split_discrs1 container1))) 4))
(declare-fun capacity__function_guard (Int us_rep1) Bool)
(assert (forall ((container1 us_rep1)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant3 result true false true true))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant4 ((temp___expr_313 Int) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool (=> (or (= temp___is_init_309 true) (<= 0 4)) (in_range3 temp___expr_313)))
(assert (forall ((container1 us_rep2)) (! (let ((result (length container1))) (and (<= (+ 0 result) 4) (dynamic_invariant2 result true false true true))) :pattern ((length container1)))))
(assert true)
