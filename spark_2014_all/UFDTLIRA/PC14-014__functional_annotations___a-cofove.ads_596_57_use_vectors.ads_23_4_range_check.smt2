...
(define-fun dynamic_invariant2 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first2 last4)) (dynamic_property3 first2 last4 temp___expr_256)))
...
(define-fun dynamic_invariant3 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first1 last3)) (dynamic_property2 first1 last3 temp___expr_242)))
(assert (= first1 fst))
(assert (= last3 lst))
...
(assert (= last5 last1))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first 1) result) last1) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true true) (and (<= first position) (<= position (last2 container)))) (dynamic_invariant7 (get container position) true false true true)) :pattern ((get container position))))))
(define-fun dynamic_invariant8 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first last1)) (dynamic_property1 first last1 temp___expr_280)))
(assert (= first fst))
(assert (= last1 lst))
...
(assert (dynamic_property3 first2 last4 index))
(assert (in_range3 count))
(assert (and (<= first1 index) (<= index (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (and (= o (- index first1)) (in_range1 (- index first1))))
