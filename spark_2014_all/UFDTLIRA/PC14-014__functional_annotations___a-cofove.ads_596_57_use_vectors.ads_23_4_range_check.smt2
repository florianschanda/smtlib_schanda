...
(define-fun dynamic_invariant4 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first last)) (dynamic_property first last temp___expr_242)))
(assert (= first fst))
(assert (= last lst))
...
(assert (forall ((x Int) (f Int) (l Int)) (! (=> (and (and (dynamic_invariant5 x true true true true) (dynamic_invariant5 f true true true true)) (dynamic_invariant5 l true true true true)) (let ((result (id x f l))) (and (=> (and (<= f x) (<= x l)) (and (<= f result) (<= result l))) (dynamic_invariant5 result true false true true)))) :pattern ((id x f l)))))
...
(define-fun dynamic_invariant6 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= first3 last5)) (dynamic_property4 first3 last5 temp___expr_294)))
(assert (= first3 (- first2 1)))
(assert (= last5 last3))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first2 1) result) last3) (dynamic_invariant result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_287)))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true true) (and (<= first2 position) (<= position (last4 container)))) (dynamic_invariant7 (get container position) true false true true)) :pattern ((get container position))))))
(define-fun dynamic_invariant8 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_280)))
(assert (= first2 fst))
(assert (= last3 lst))
...
(assert (and (= o (- index first)) (in_range1 (- index first))))
