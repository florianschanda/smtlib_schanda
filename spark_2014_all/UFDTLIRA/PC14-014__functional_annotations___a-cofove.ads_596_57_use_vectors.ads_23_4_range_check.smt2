...
(define-fun dynamic_invariant ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range3 temp___expr_141)))
...
(define-fun dynamic_invariant4 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= first last)) (dynamic_property first last temp___expr_207)))
(assert (= first fst))
(assert (= last lst))
...
(assert (forall ((x Int) (f Int) (l Int)) (! (=> (and (and (dynamic_invariant5 x true true true) (dynamic_invariant5 f true true true)) (dynamic_invariant5 l true true true)) (let ((result (id x f l))) (and (=> (and (<= f x) (<= x l)) (and (<= f result) (<= result l))) (dynamic_invariant5 result true false true)))) :pattern ((id x f l)))))
...
(define-fun dynamic_invariant6 ((temp___expr_252 Int) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool)) Bool (=> (or (= temp___is_init_249 true) (<= first3 last5)) (dynamic_property4 first3 last5 temp___expr_252)))
(assert (= first3 (- first2 1)))
(assert (= last5 last3))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first2 1) result) last3) (dynamic_invariant result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_246)))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true) (and (<= first2 position) (<= position (last4 container)))) (dynamic_invariant7 (get container position) true false true)) :pattern ((get container position))))))
(define-fun dynamic_invariant8 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_240)))
(assert (= first2 fst))
(assert (= last3 lst))
...
(assert (and (<= first index) (<= index (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (and (= o2 (- index first)) (in_range1 (- index first))))
(assert (not (in_range3 o2)))
(check-sat)
(exit)
