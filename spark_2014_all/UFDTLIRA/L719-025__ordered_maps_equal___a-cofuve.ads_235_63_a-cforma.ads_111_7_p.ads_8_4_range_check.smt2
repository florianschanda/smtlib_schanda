...
(define-fun dynamic_invariant ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 1 2147483647)) (in_range2 temp___expr_396)))
...
(define-fun dynamic_invariant1 ((temp___expr_410 Int) (temp___is_init_406 Bool) (temp___skip_constant_407 Bool) (temp___do_toplevel_408 Bool) (temp___do_typ_inv_409 Bool)) Bool (=> (or (= temp___is_init_406 true) (<= 0 2147483647)) (in_range3 temp___expr_410)))
...
(define-fun default_initial_assumption ((temp___expr_418 us_rep) (temp___skip_top_level_419 Bool)) Bool (=> (not (= temp___skip_top_level_419 true)) (= (length temp___expr_418) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 1 100)) (in_range5 temp___expr_403)))
