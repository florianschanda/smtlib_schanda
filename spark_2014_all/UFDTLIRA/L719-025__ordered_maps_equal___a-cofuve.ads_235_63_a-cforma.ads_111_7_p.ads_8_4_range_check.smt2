...
(define-fun dynamic_invariant ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= 1 2147483647)) (in_range2 temp___expr_358)))
...
(define-fun dynamic_invariant1 ((temp___expr_370 Int) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool)) Bool (=> (or (= temp___is_init_367 true) (<= 0 2147483647)) (in_range3 temp___expr_370)))
...
(define-fun default_initial_assumption ((temp___expr_377 us_rep) (temp___skip_top_level_378 Bool)) Bool (=> (not (= temp___skip_top_level_378 true)) (= (length temp___expr_377) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_364 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 1 100)) (in_range5 temp___expr_364)))
