...
(define-fun dynamic_invariant ((temp___expr_425 Int) (temp___is_init_421 Bool) (temp___skip_constant_422 Bool) (temp___do_toplevel_423 Bool) (temp___do_typ_inv_424 Bool)) Bool (=> (or (= temp___is_init_421 true) (<= 1 2147483647)) (in_range2 temp___expr_425)))
...
(define-fun dynamic_invariant1 ((temp___expr_439 Int) (temp___is_init_435 Bool) (temp___skip_constant_436 Bool) (temp___do_toplevel_437 Bool) (temp___do_typ_inv_438 Bool)) Bool (=> (or (= temp___is_init_435 true) (<= 0 2147483647)) (in_range3 temp___expr_439)))
