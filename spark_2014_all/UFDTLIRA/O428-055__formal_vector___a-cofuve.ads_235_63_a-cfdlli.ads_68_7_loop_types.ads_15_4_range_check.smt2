...
(define-fun dynamic_invariant ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 1 2147483647)) (in_range2 temp___expr_377)))
...
(define-fun dynamic_invariant1 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 0 2147483647)) (in_range3 temp___expr_389)))
...
(define-fun default_initial_assumption ((temp___expr_396 us_rep) (temp___skip_top_level_397 Bool)) Bool (=> (not (= temp___skip_top_level_397 true)) (= (length temp___expr_396) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 0 2147483647)) (in_range5 temp___expr_383)))
