...
(assert (and (= o10 (next (mk___rep l1__split_discrs l1__split_fields4) o9)) (ite (= (ite (= (bool_eq3 o9 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o9) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq3 o10 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o10) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o10) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o9) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) o10) true) (= (bool_eq3 o10 no_element) true))))
(check-sat)
(exit)
