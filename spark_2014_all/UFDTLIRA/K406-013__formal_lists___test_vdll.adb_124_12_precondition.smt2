...
(assert (and (= o64 (next (mk___rep l1__split_discrs l1__split_fields4) o63)) (ite (= (ite (= (bool_eq1 o63 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o63) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq1 o64 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o64) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o64) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o63) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) o64) true) (= (bool_eq1 o64 no_element) true))))
(check-sat)
(exit)
