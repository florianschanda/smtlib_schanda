...
(assert (and (= o12 (next (mk___rep l1__split_discrs l1__split_fields4) o11)) (ite (= (ite (= (bool_eq1 o11 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o11) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq1 o12 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o12) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o12) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o11) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) o12) true) (= (bool_eq1 o12 no_element) true))))
(check-sat)
(exit)
