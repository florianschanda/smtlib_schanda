...
(define-fun dynamic_invariant2 ((temp___expr_303 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool) (temp___do_typ_inv_302 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 2147483646)) (in_range3 temp___expr_303)))
...
(declare-fun user_eq7 (tchar_table_indexB tchar_table_indexB) Bool)
(declare-const dummy7 tchar_table_indexB)
...
(assert (and (= o2 (- index 0)) (in_range6 (- index 0))))
