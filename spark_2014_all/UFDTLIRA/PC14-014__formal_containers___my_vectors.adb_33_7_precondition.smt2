...
(assert (not (or (and (<= 1 o1) (<= o1 (last (model__ (mk___rep l__split_discrs l__split_fields13))))) (and (not (= o1 0)) (= (- o1 1) (last (model__ (mk___rep l__split_discrs l__split_fields13))))))))
(check-sat)
(exit)
