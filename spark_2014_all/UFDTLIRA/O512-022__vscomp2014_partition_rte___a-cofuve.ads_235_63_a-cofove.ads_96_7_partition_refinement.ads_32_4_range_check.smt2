...
(define-fun dynamic_invariant ((temp___expr_748 Int) (temp___is_init_745 Bool) (temp___skip_constant_746 Bool) (temp___do_toplevel_747 Bool)) Bool (=> (or (= temp___is_init_745 true) (<= 0 10000)) (in_range2 temp___expr_748)))
...
(define-fun dynamic_invariant1 ((temp___expr_763 Int) (temp___is_init_760 Bool) (temp___skip_constant_761 Bool) (temp___do_toplevel_762 Bool)) Bool (=> (or (= temp___is_init_760 true) (<= (- 1) 10000)) (in_range3 temp___expr_763)))
...
(define-fun us_rep___13__projection ((a us_rep1)) us_split_fields (us_split_fields1 a))
...
(define-fun element_type__ref___9__projection ((a element_type__ref)) us_rep1 (element_type__content a))
...
(define-fun default_initial_assumption ((temp___expr_770 us_rep) (temp___skip_top_level_771 Bool)) Bool (=> (not (= temp___skip_top_level_771 true)) (= (length temp___expr_770) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 2147483647)) (in_range6 temp___expr_152)))
...
(define-fun dynamic_invariant3 ((temp___expr_299 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 6)) (in_range4 temp___expr_299)))
(define-fun dynamic_invariant4 ((temp___expr_305 Int) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (<= 0 5)) (in_range5 temp___expr_305)))
(assert true)
(declare-const o Int)
