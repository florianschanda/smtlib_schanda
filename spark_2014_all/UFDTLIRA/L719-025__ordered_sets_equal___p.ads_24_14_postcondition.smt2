...
(assert (= e1 o))
(assert (in_range1 e1))
(assert (and (and (and (and (and (and (and (and (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields1)) no_element) true) (= (length1 (mk___rep l__split_discrs l__split_fields6)) (- (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1))) (not (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true))) (not (= (has_key (positions (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 (mk___split_fields1 cu__split_fields))) true))) (= (ole (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6)) (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields)))) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields6)) 1 (- (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields6)) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length1 (mk___rep l__split_discrs l__split_fields6)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true)))
(assert (and (and (and (and (= (contains (model__ (mk___rep l__split_discrs l__split_fields5)) e1) true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5)) true)) (= (equivalent_elements (element (mk___rep l__split_discrs l__split_fields5) (mk___rep1 cu__split_fields5)) e1) true)) (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields5)) e1 (get (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5))) true)) (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) e1) true) (and (and (and (not (= i true)) (= (oeq4 (model__ (mk___rep l__split_discrs l__split_fields5)) (model__ (mk___rep l__split_discrs l__split_fields6))) true)) (= (oeq3 (elements (mk___rep l__split_discrs l__split_fields5)) (elements (mk___rep l__split_discrs l__split_fields6))) true)) (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields5)) (positions (mk___rep l__split_discrs l__split_fields6))) true)) (and (and (and (and (and (and (and (= i true) (= (length1 (mk___rep l__split_discrs l__split_fields5)) (+ (length1 (mk___rep l__split_discrs l__split_fields6)) 1))) (= (element (mk___rep l__split_discrs l__split_fields5) (mk___rep1 cu__split_fields5)) e1)) (= (ole (model__ (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields5))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields5)) (model__ (mk___rep l__split_discrs l__split_fields6)) e1) true)) (= (range_equal (elements (mk___rep l__split_discrs l__split_fields6)) (elements (mk___rep l__split_discrs l__split_fields5)) 1 (- (get (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5)) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields6)) (elements (mk___rep l__split_discrs l__split_fields5)) (get (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5)) (length1 (mk___rep l__split_discrs l__split_fields6)) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs l__split_fields5)) (get (positions (mk___rep l__split_discrs l__split_fields5)) (mk___rep1 cu__split_fields5)) 1) true)))))
(assert (= i true))
(assert (= i i1))
(assert (= e1 e2))
