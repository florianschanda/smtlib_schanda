...
(assert (= result1 (adminmustlogout (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)) state1 currenttime (us_private__content state4))))
(assert (= result1 true))
(assert (not (not (= (enrolmentisinprogress (us_private__content state4)) true))))
(check-sat)
(exit)
