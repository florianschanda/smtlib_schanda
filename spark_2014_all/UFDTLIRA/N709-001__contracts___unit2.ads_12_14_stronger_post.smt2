...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (ite (is_zero (of_base x)) 1 0) (ite (is_zero3 us_tag1 x) 1 0)) :pattern ((is_zero3 us_tag1 x)))))
(assert (forall ((x us_rep)) (! (= (ite (is_zero2 x) 1 0) (ite (is_zero3 us_tag x) 1 0)) :pattern ((is_zero3 us_tag x)))))
