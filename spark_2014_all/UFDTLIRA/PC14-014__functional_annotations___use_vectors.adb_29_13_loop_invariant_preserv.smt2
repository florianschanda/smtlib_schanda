...
(assert (=> (= result4 true) (and (= us6 i2) (dynamic_property1 first1 last1 i2))))
(assert (=> (= result4 true) (= o16 i2)))
(assert (=> (= result4 true) (and (= o17 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o16)) (and (in_range5 o17) (= o17 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o16))))))
(assert (=> (= result4 true) (= o18 (+ o17 1))))
(assert (=> (= result4 true) (and (= o19 o18) (in_range2 o18))))
(assert (=> (= result4 true) (and (= us5 i2) (dynamic_property1 first1 last1 i2))))
(assert (=> (= result4 true) (= o15 i2)))
(assert (=> (= result4 true) (and (and (and (= (length (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) (length (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) o15) o19)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) o15) true)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
(assert (=> (not (= result4 true)) (= (mk___split_fields v__split_fields3) (mk___split_fields v__split_fields2))))
(assert (not (= i2 r7b)))
(assert (= result5 i2))
(assert (= i3 (+ i2 1)))
...
(assert (<= first n3))
(assert (<= n3 (- i3 1)))
(assert (not (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n3) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) n3)) true)))
(check-sat)
(exit)
