...
(assert (forall ((n Int)) (=> (and (<= first n) (<= n (- i2 1))) (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields4)) n)) true))))
(assert (forall ((n Int)) (=> (and (<= i2 n) (<= n (last5 (model__ (mk___rep v__split_discrs v__split_fields4))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields4)) n)))))
...
(assert (= o1 i2))
(assert (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o1)) (and (in_range5 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o1)))))
(assert (= result2 (ite (< o2 2147483647) true false)))
(assert (=> (= result2 true) (and (= us2 i2) (dynamic_property1 first1 last1 i2))))
(assert (=> (= result2 true) (= o4 i2)))
(assert (=> (= result2 true) (and (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o4)) (and (in_range5 o5) (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o4))))))
