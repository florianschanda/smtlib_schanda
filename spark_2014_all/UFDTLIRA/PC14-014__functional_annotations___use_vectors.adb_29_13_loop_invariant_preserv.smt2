...
(assert (forall ((n Int)) (=> (and (<= first4 n) (<= n (- i2 1))) (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields4)) n)) true))))
(assert (forall ((n Int)) (=> (and (<= i2 n) (<= n (last2 (model__ (mk___rep v__split_discrs v__split_fields4))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields4)) n)))))
...
(assert (=> (= result2 true) (and (= us2 i2) (dynamic_property3 first2 last4 i2))))
(assert (=> (= result2 true) (= o4 i2)))
(assert (=> (= result2 true) (and (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o4)) (and (in_range4 o5) (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields4)) o4))))))
(assert (=> (= result2 true) (= o6 (+ o5 1))))
(assert (=> (= result2 true) (and (= o7 o6) (in_range6 o6))))
(assert (=> (= result2 true) (and (= us1 i2) (dynamic_property3 first2 last4 i2))))
(assert (=> (= result2 true) (= o3 i2)))
(assert (=> (= result2 true) (and (and (and (= (length (mk___rep v__split_discrs v__split_fields3)) (length (mk___rep v__split_discrs v__split_fields4))) (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) o3) o7)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields4)) (model__ (mk___rep v__split_discrs v__split_fields3)) o3) true)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
...
(assert (<= first4 n))
(assert (<= n (- i3 1)))
(assert (not (= (is_incr (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) n) (get (model__ (mk___rep v__split_discrs v__split_fields3)) n)) true)))
(check-sat)
(exit)
