...
(assert (and (= (mk___rep (mk___split_discrs temp___358) (mk___split_fields temp___3581) temp___3582) (new_with_default c)) (= (to_rep temp___358) c)))
(assert (= d__attr__constrained true))
(assert (not (= temp___358 (rec__private_discr__p_with_default__c d__split_discrs1))))
(check-sat)
(exit)
