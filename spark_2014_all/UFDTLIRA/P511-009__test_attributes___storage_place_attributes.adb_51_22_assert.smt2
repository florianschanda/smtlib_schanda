...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__storage_place_attributes__r1__f1 Bool) (rec__ext__ us_private)))))
(define-fun us_split_fields_F1__projection ((a us_split_fields)) Bool (rec__storage_place_attributes__r1__f1 a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (rec__storage_place_attributes__r1__f1 (us_split_fields1 a)) (rec__storage_place_attributes__r1__f1 (us_split_fields1 b))) true false))
...
(assert (< storage_place_attributes__r1__f1__first__bit storage_place_attributes__r1__f1__last__bit))
