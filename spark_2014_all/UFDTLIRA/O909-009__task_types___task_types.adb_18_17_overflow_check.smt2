...
(define-fun default_initial_assumption ((temp___expr_574 us_rep) (temp___skip_top_level_575 Bool)) Bool (and (= (attr__constrained temp___expr_574) false) (= (to_rep (rec__task_types__my_task_type__c (us_split_discrs1 temp___expr_574))) 0)))
...
(assert (= x1 0))
(assert (in_range2 x1))
(assert (not (= (to_rep (rec__task_types__my_task_type__c (us_split_discrs1 t1))) (to_rep (rec__task_types__my_task_type__c (us_split_discrs1 t2))))))
