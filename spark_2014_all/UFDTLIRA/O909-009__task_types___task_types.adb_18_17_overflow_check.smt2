...
(define-fun default_initial_assumption ((temp___expr_581 us_rep) (temp___skip_top_level_582 Bool)) Bool (and (= (attr__constrained temp___expr_581) false) (= (to_rep (rec__task_types__my_task_type__c (us_split_discrs1 temp___expr_581))) 0)))
