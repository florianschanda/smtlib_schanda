...
(define-fun default_initial_assumption1 ((temp___expr_220 us_rep) (temp___skip_top_level_221 Bool)) Bool (and (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___expr_220)) (of_int 1)) (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___expr_220))) 0)))
...
(declare-const t__split_fields Bool)
(declare-const t__split_fields1 natural)
(declare-const o Int)
(declare-const o1 Bool)
(declare-const o2 natural)
(declare-const temp___268 Bool)
(declare-const temp___2681 natural)
(declare-const o3 Int)
(declare-const o4 Bool)
(declare-const o5 natural)
(declare-const result Bool)
(declare-const result1 natural)
(declare-const t__split_fields2 Bool)
(declare-const t__split_fields3 natural)
(assert (in_range2 i))
(assert (= result t__split_fields))
(assert (= result1 t__split_fields1))
(assert (= (mk___split_fields t__split_fields2 t__split_fields3) (us_split_fields1 e)))
(assert (= (to_rep t__split_fields3) (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 e)))))
(assert (=> (or (not (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 e))) 0)) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 e)) true)) (= (bool_eq (from_integer (to_integer e)) e) true)))
(assert (= (to_integer (from_integer i)) i))
(assert (and (= o3 (to_integer e)) (and (in_range3 o3) (= o3 (ite (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 e)) true) (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 e))) (- (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 e)))))))))
(assert (not (< (- 2147483648) o3)))
(check-sat)
(exit)
