...
(assert (= (to_rep x__split_fields2) (+ (to_rep x__split_fields) 1)))
(assert (not (= (bool_eq (mk___rep (mk___split_fields x__split_fields2 x__split_fields3) x__attr__tag) (next (mk___rep (mk___split_fields x__split_fields x__split_fields1) x__attr__tag))) true)))
(check-sat)
(exit)
