...
(assert (and (and (and (forall ((temp___228 Int) (temp___229 Int)) (=> (and (and (<= 1 temp___228) (<= temp___228 10)) (and (<= 1 temp___229) (<= temp___229 10))) (=> (and (or (<= c2 temp___229) (not (= 5 temp___228))) (or (<= c2 temp___229) (not (= 7 temp___228)))) (= (get m2 temp___228 temp___229) (get m1 temp___228 temp___229))))) (=> (<= 1 10) (in_range5 c2))) (=> (<= 0 2147483647) (in_range2 tmp1))) (and (<= 1 c2) (<= c2 10))))
(assert (= tmp1 result2))
...
(assert (<= 1 i))
(assert (<= i (- c3 1)))
(assert (not (= (to_rep (get m4 5 i)) (to_rep (get m1 7 i)))))
(check-sat)
(exit)
