...
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 tmp1)) (forall ((temp___262 Int) (temp___263 Int)) (=> (and (and (<= 1 temp___262) (<= temp___262 10)) (and (<= 1 temp___263) (<= temp___263 10))) (=> (and (or (<= c2 temp___263) (not (= 7 temp___262))) (or (<= c2 temp___263) (not (= 5 temp___262)))) (= (get m2 temp___262 temp___263) (get m1 temp___262 temp___263)))))) (=> (<= 1 10) (in_range5 c2))) (and (<= 1 c2) (<= c2 10))))
(assert (= tmp1 result2))
