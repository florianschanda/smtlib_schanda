...
(assert (=> (= result true) (and (= temp___950 next_read__split_discrs) (and (= temp___9501 next_read__split_fields) (= temp___9502 next_read__attr__constrained)))))
...
(assert (=> (= result true) (and (= temp___946 current_read__split_discrs) (and (= temp___9461 current_read__split_fields) (= temp___9462 current_read__attr__constrained)))))
(assert (=> (= result true) (= 0 temp___955)))
(assert (=> (= result true) (= 0 temp___954)))
(assert (=> (= result true) (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= temp___953 current_idx2))))
...
(assert (=> (= result true) (= temp___9542 (to_int1 (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false)))))
