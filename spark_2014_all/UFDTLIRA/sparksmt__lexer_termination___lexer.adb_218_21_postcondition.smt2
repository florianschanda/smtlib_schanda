...
(declare-const temp___1036 read_status)
(declare-const temp___10361 character)
(declare-const temp___10362 Bool)
(declare-const temp___1035 Int)
(declare-const temp___1034 Int)
(declare-const temp___1033 Int)
(declare-const temp___1039 Int)
(declare-const temp___1032 read_status)
(declare-const temp___10321 character)
(declare-const temp___10322 Bool)
...
(declare-const temp___10412 Int)
(declare-const result2 int__ref)
(declare-const temp___10402 Int)
...
(assert (=> (= result true) (= temp___1038 next_idx)))
(assert (=> (= result true) (= temp___1037 the_file)))
(assert (=> (= result true) (and (= temp___1036 next_read__split_discrs) (and (= temp___10361 next_read__split_fields) (= temp___10362 next_read__attr__constrained)))))
(assert (=> (= result true) (= temp___1035 current_idx)))
(assert (=> (= result true) (= temp___1034 current_col)))
(assert (=> (= result true) (= temp___1033 current_line)))
(assert (=> (= result true) (= temp___1039 current_idx)))
(assert (=> (= result true) (and (= temp___1032 current_read__split_discrs) (and (= temp___10321 current_read__split_fields) (= temp___10322 current_read__attr__constrained)))))
(assert (=> (= result true) (= 0 temp___1041)))
(assert (=> (= result true) (= 0 temp___1040)))
(assert (=> (= result true) (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= temp___1039 current_idx2))))
(assert (=> (= result true) (and (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (let ((temp___1043 (to_rep (rec__file_io__read_result__c current_read__split_fields2)))) (or (= temp___1043 10) (or (= temp___1043 13) (or (= temp___1043 32) (= temp___1043 9)))))))))
(assert (=> (= result true) (= result1 (mk_int__ref temp___10411))))
(assert (=> (= result true) (= temp___10412 next_idx2)))
(assert (=> (= result true) (= result2 (mk_int__ref temp___10401))))
(assert (=> (= result true) (= temp___10402 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false) 1 0))))
