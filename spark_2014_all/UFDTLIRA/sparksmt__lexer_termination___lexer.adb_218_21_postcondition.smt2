...
(assert (=> (= result true) (and (and (= temp___942 next_idx) (and (= temp___941 the_file) (and (and (= temp___940 next_read__split_discrs) (and (= temp___9401 next_read__split_fields) (= temp___9402 next_read__attr__constrained))) (and (= temp___939 current_idx) (and (= temp___938 current_col) (and (= temp___937 current_line) (and (= temp___943 current_idx) (and (and (= temp___936 current_read__split_discrs) (and (= temp___9361 current_read__split_fields) (= temp___9362 current_read__attr__constrained))) (and (= 0 temp___945) (and (= 0 temp___944) (and (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= temp___943 current_idx2)) (and (and (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (let ((temp___947 (to_rep (rec__file_io__read_result__c current_read__split_fields2)))) (or (= temp___947 10) (or (= temp___947 13) (or (= temp___947 32) (= temp___947 9))))))) (and (and (= result1 (mk_int__ref temp___9451)) (= temp___9452 next_idx2)) (and (and (= result2 (mk_int__ref temp___9441)) (= temp___9442 (to_int1 (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false)))) (and (and (and (and (and (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true) (= (bool_eq1 (mk___rep current_read__split_discrs3 current_read__split_fields3 current_read__attr__constrained) (mk___rep next_read__split_discrs2 next_read__split_fields2 next_read__attr__constrained)) true)) (= current_idx3 next_idx2)) (<= current_idx2 current_idx3)) (and (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_idx3)) (in_range1 next_idx3))) (and (and (ite (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs3)) 0) (= o (ite (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 10) (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 13) (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 32) (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 9)))) true false)) (= o false)) (= result3 (ite (not (= o true)) true false))) (= result3 true))))))))))))))))) (and (and (= next_idx6 (mk_int__ref next_idx3)) (and (= next_read__split_discrs6 (mk___split_discrs__ref next_read__split_discrs3)) (and (= next_read__split_fields6 (mk___split_fields__ref next_read__split_fields3)) (and (= current_idx6 (mk_int__ref current_idx3)) (and (= current_col6 (mk_int__ref current_col3)) (and (= current_line6 (mk_int__ref current_line3)) (and (= current_read__split_discrs6 (mk___split_discrs__ref current_read__split_discrs3)) (and (= current_read__split_fields6 (mk___split_fields__ref current_read__split_fields3)) (= the_file6 (mk_file__ref the_file3)))))))))) (and (= next_idx7 next_idx3) (and (= next_read__split_discrs7 next_read__split_discrs3) (and (= next_read__split_fields7 next_read__split_fields3) (and (= current_idx7 current_idx3) (and (= current_col7 current_col3) (and (= current_line7 current_line3) (and (= current_read__split_discrs7 current_read__split_discrs3) (and (= current_read__split_fields7 current_read__split_fields3) (= the_file7 the_file3)))))))))))))
(assert (=> (= result true) (= next_idx8 next_idx6)))
(assert (=> (= result true) (= next_read__split_discrs8 next_read__split_discrs6)))
(assert (=> (= result true) (= next_read__split_fields8 next_read__split_fields6)))
(assert (=> (= result true) (= current_idx8 current_idx6)))
(assert (=> (= result true) (= current_col8 current_col6)))
(assert (=> (= result true) (= current_line8 current_line6)))
(assert (=> (= result true) (= current_read__split_discrs8 current_read__split_discrs6)))
(assert (=> (= result true) (= current_read__split_fields8 current_read__split_fields6)))
(assert (=> (= result true) (= the_file8 the_file6)))
(assert (=> (= result true) (= next_idx9 next_idx7)))
(assert (=> (= result true) (= next_read__split_discrs9 next_read__split_discrs7)))
(assert (=> (= result true) (= next_read__split_fields9 next_read__split_fields7)))
(assert (=> (= result true) (= current_idx9 current_idx7)))
(assert (=> (= result true) (= current_col9 current_col7)))
(assert (=> (= result true) (= current_line9 current_line7)))
(assert (=> (= result true) (= current_read__split_discrs9 current_read__split_discrs7)))
(assert (=> (= result true) (= current_read__split_fields9 current_read__split_fields7)))
(assert (=> (= result true) (= the_file9 the_file7)))
(assert (=> (not (= result true)) (= next_idx8 (mk_int__ref next_idx))))
(assert (=> (not (= result true)) (= next_read__split_discrs8 (mk___split_discrs__ref (mk___split_discrs next_read__split_discrs)))))
(assert (=> (not (= result true)) (= next_read__split_fields8 (mk___split_fields__ref (mk___split_fields next_read__split_fields)))))
(assert (=> (not (= result true)) (= current_idx8 (mk_int__ref current_idx))))
(assert (=> (not (= result true)) (= current_col8 (mk_int__ref current_col))))
(assert (=> (not (= result true)) (= current_line8 (mk_int__ref current_line))))
(assert (=> (not (= result true)) (= current_read__split_discrs8 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs)))))
(assert (=> (not (= result true)) (= current_read__split_fields8 (mk___split_fields__ref (mk___split_fields current_read__split_fields)))))
(assert (=> (not (= result true)) (= the_file8 (mk_file__ref the_file))))
(assert (=> (not (= result true)) (= next_idx9 next_idx1)))
(assert (=> (not (= result true)) (= next_read__split_discrs9 next_read__split_discrs1)))
(assert (=> (not (= result true)) (= next_read__split_fields9 next_read__split_fields1)))
(assert (=> (not (= result true)) (= current_idx9 current_idx1)))
(assert (=> (not (= result true)) (= current_col9 current_col1)))
(assert (=> (not (= result true)) (= current_line9 current_line1)))
(assert (=> (not (= result true)) (= current_read__split_discrs9 current_read__split_discrs1)))
(assert (=> (not (= result true)) (= current_read__split_fields9 current_read__split_fields1)))
(assert (=> (not (= result true)) (= the_file9 the_file1)))
(assert (= next_idx10 next_idx8))
(assert (= next_read__split_discrs10 next_read__split_discrs8))
(assert (= next_read__split_fields10 next_read__split_fields8))
(assert (= current_idx10 current_idx8))
