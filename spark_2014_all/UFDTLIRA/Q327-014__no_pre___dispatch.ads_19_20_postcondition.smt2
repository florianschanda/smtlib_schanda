...
(assert (= (mk___rep (mk___split_fields result6 result7) result8) (root__content dispatch__incr3__result15)))
(assert (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647))
(assert (not (= (to_rep (rec__dispatch__root__f (us_split_fields1 (root__content dispatch__incr3__result15)))) (+ (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 1))))
(check-sat)
(exit)
