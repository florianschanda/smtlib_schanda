...
(assert (and (= (is_valid state6 (mk___split_fields model____split_fields12 model____split_fields13)) true) (ite (= (contains model____split_fields11 res21) true) (and (= (is_prepend model____split_fields10 res21 model____split_fields12) true) (= (is_add model____split_fields13 res21 model____split_fields11) true)) (= (oeq (mk___rep (mk___split_fields model____split_fields12 model____split_fields13)) (mk___rep (mk___split_fields model____split_fields10 model____split_fields11))) true))))
(assert (= (is_available res21 state6) true))
(assert (and (= (is_valid state7 (mk___split_fields model____split_fields14 model____split_fields15)) true) (ite (= (contains model____split_fields13 res31) true) (and (= (is_prepend model____split_fields12 res31 model____split_fields14) true) (= (is_add model____split_fields15 res31 model____split_fields13) true)) (= (oeq (mk___rep (mk___split_fields model____split_fields14 model____split_fields15)) (mk___rep (mk___split_fields model____split_fields12 model____split_fields13))) true))))
