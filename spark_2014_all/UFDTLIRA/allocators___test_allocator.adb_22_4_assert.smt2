...
(define-fun model____split_fields16 () us_split_fields (mk___split_fields model____split_fields14 model____split_fields15))
(define-fun model____split_fields17 () us_split_fields (mk___split_fields model____split_fields12 model____split_fields13))
(define-fun model____split_fields18 () us_split_fields (mk___split_fields model____split_fields10 model____split_fields11))
(define-fun model____split_fields19 () us_split_fields (mk___split_fields model____split_fields8 model____split_fields9))
(define-fun model____split_fields20 () us_split_fields (mk___split_fields model____split_fields6 model____split_fields7))
(define-fun model____split_fields21 () us_split_fields (mk___split_fields model____split_fields4 model____split_fields5))
(define-fun model____split_fields22 () us_split_fields (mk___split_fields model____split_fields2 model____split_fields3))
...
(assert (and (and (= (is_valid state1 model____split_fields22) true) (ite (= (= (length model____split_fields) 0) true) (and (= res11 0) (= (oeq (mk___rep model____split_fields22) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true)) (and (= (is_prepend model____split_fields2 res11 model____split_fields) true) (= (is_add model____split_fields1 res11 model____split_fields3) true)))) (in_range res11)))
(assert (not (= res11 0)))
(assert (= (is_allocated res11 state1) true))
(assert (and (and (= (is_valid state2 model____split_fields21) true) (ite (= (= (length model____split_fields2) 0) true) (and (= res21 0) (= (oeq (mk___rep model____split_fields21) (mk___rep model____split_fields22)) true)) (and (= (is_prepend model____split_fields4 res21 model____split_fields2) true) (= (is_add model____split_fields3 res21 model____split_fields5) true)))) (in_range res21)))
(assert (not (= res21 0)))
(assert (= (is_allocated res21 state2) true))
(assert (and (and (= (is_valid state3 model____split_fields20) true) (ite (= (= (length model____split_fields4) 0) true) (and (= res31 0) (= (oeq (mk___rep model____split_fields20) (mk___rep model____split_fields21)) true)) (and (= (is_prepend model____split_fields6 res31 model____split_fields4) true) (= (is_add model____split_fields5 res31 model____split_fields7) true)))) (in_range res31)))
(assert (not (= res31 0)))
(assert (= (is_allocated res31 state3) true))
(assert (and (and (= (is_valid state4 model____split_fields19) true) (ite (= (= (length model____split_fields6) 0) true) (and (= res41 0) (= (oeq (mk___rep model____split_fields19) (mk___rep model____split_fields20)) true)) (and (= (is_prepend model____split_fields8 res41 model____split_fields6) true) (= (is_add model____split_fields7 res41 model____split_fields9) true)))) (in_range res41)))
(assert (not (= res41 0)))
(assert (and (= (is_valid state5 model____split_fields18) true) (ite (= (contains model____split_fields9 res11) true) (and (= (is_prepend model____split_fields8 res11 model____split_fields10) true) (= (is_add model____split_fields11 res11 model____split_fields9) true)) (= (oeq (mk___rep model____split_fields18) (mk___rep model____split_fields19)) true))))
(assert (= (is_available res11 state5) true))
(assert (and (= (is_valid state6 model____split_fields17) true) (ite (= (contains model____split_fields11 res21) true) (and (= (is_prepend model____split_fields10 res21 model____split_fields12) true) (= (is_add model____split_fields13 res21 model____split_fields11) true)) (= (oeq (mk___rep model____split_fields17) (mk___rep model____split_fields18)) true))))
(assert (= (is_available res21 state6) true))
(assert (and (= (is_valid state7 model____split_fields16) true) (ite (= (contains model____split_fields13 res31) true) (and (= (is_prepend model____split_fields12 res31 model____split_fields14) true) (= (is_add model____split_fields15 res31 model____split_fields13) true)) (= (oeq (mk___rep model____split_fields16) (mk___rep model____split_fields17)) true))))
(assert (not (= (is_available res31 state7) true)))
(check-sat)
(exit)
