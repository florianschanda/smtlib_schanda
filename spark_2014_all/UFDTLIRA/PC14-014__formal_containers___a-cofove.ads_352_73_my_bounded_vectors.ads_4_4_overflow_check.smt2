...
(define-fun dynamic_invariant ((temp___expr_766 Int) (temp___is_init_762 Bool) (temp___skip_constant_763 Bool) (temp___do_toplevel_764 Bool) (temp___do_typ_inv_765 Bool)) Bool (=> (or (= temp___is_init_762 true) (<= 1 2147483647)) (in_range2 temp___expr_766)))
...
(define-fun dynamic_invariant1 ((temp___expr_773 Int) (temp___is_init_769 Bool) (temp___skip_constant_770 Bool) (temp___do_toplevel_771 Bool) (temp___do_typ_inv_772 Bool)) Bool (=> (or (= temp___is_init_769 true) (<= 0 2147483647)) (in_range3 temp___expr_773)))
...
(define-fun dynamic_invariant2 ((temp___expr_780 Int) (temp___is_init_776 Bool) (temp___skip_constant_777 Bool) (temp___do_toplevel_778 Bool) (temp___do_typ_inv_779 Bool)) Bool (=> (or (= temp___is_init_776 true) (<= 0 2147483647)) (in_range4 temp___expr_780)))
...
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range4 o2) (= o2 (ite (= (distinct 1 0) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity container__split_discrs)) 2147483647)))))
