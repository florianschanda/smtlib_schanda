...
(declare-const temp___489 count_type)
(declare-const temp___4891 us_main_type)
(declare-const temp___486 us_rep1)
...
(define-fun temp___4892 () us_rep (mk___rep (mk___split_discrs temp___489) (mk___split_fields temp___4891)))
(define-fun temp___4902 () us_rep (mk___rep (mk___split_discrs temp___490) (mk___split_fields temp___4901)))
(define-fun o13 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
...
(assert (or (and (and (and (= cu10 cu4) (and (= c__split_fields12 c__split_fields5) (= l__split_fields10 l__split_fields4))) (and (= cu11 cu5) (and (= c__split_fields13 c__split_fields6) (= l__split_fields11 l__split_fields5)))) (and (and (and (= o13 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o13 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o13) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o13) 1)))) (and (= result cu14) (= cu1 o13))) (and (and (= result1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1)) (= (= result1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) true))) (and (= result1 true) (and (and (= l__split_discrs (mk___split_discrs temp___490)) (= l__split_fields temp___4901)) (and (= c__split_fields temp___488) (and (and (= l__split_discrs (mk___split_discrs temp___487)) (= l__split_fields temp___4871)) (and (and (= l__split_discrs (mk___split_discrs temp___489)) (= l__split_fields temp___4891)) (and (= temp___486 cu1) (and (= temp___491 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (and (= temp___492 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (or (and (and (and (= cu4 (mk_cursor__ref cu1)) (and (= c__split_fields5 (mk___split_fields__ref1 c__split_fields2)) (= l__split_fields4 l__split_fields14))) (and (= cu5 cu1) (and (= c__split_fields6 c__split_fields2) (= l__split_fields5 l__split_fields1)))) (and (and (and (= o3 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) cu1)) (and (in_range2 o3) (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1))))) (= result2 (ite (= o3 0) true false))) (and (= result2 true) (and (= result3 c__split_fields16) (= c__split_fields2 (us_split_fields3 cu1)))))) (and (and (and (and (= o3 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) cu1)) (and (in_range2 o3) (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1))))) (= result2 (ite (= o3 0) true false))) (and (not (= result2 true)) (and (= c__split_fields2 (mk___split_fields1 c__split_fields)) (= c__split_fields2 c__split_fields1)))) (and (and (and (= cu4 (mk_cursor__ref cu3)) (and (= c__split_fields5 (mk___split_fields__ref1 c__split_fields4)) (= l__split_fields4 (mk___split_fields__ref l__split_fields3)))) (and (= cu5 cu3) (and (= c__split_fields6 c__split_fields4) (= l__split_fields5 l__split_fields3)))) (and (and (= (length (mk___rep l__split_discrs l__split_fields2)) (length temp___4892)) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))) (and (< 0 (get (model__ temp___4902) i)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (- (get (model__ temp___491) i) 1))))) (and (forall ((i Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) i) (<= i (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (get (model__ temp___492) i)))) (not (= (element (mk___rep l__split_discrs l__split_fields2) cu2) 0))))) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) cu2) true) (and (and (and (and (and (= o4 (element (mk___rep l__split_discrs l__split_fields2) cu2)) (and (in_range2 o4) (= o4 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2))))) (= o5 (- o4 1))) (and (= o6 o5) (in_range2 o5))) (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields2))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2)) o6)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2)) true))) (and (and (and (and (and (= o7 (next (mk___rep l__split_discrs l__split_fields3) cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o7) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) o7) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) 1))))) (and (= o8 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o7)) (= (= o8 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o7) true)))) (= result4 (ite (not (= o8 true)) true false))) (not (= result4 true))) (and (and (and (= o9 (next (mk___rep l__split_discrs l__split_fields3) cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 o9 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o9) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) o9) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) 1))))) (and (= result5 (mk_cursor__ref cu2)) (= cu3 o9))) (and (and (and (= o10 (element (mk___rep l__split_discrs l__split_fields3) cu3)) (and (in_range2 o10) (= o10 (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu3))))) (= result6 (ite (= o10 0) true false))) (and (= result6 true) (and (= result7 (mk___split_fields__ref1 c__split_fields3)) (= c__split_fields4 (us_split_fields3 cu3)))))))))))))))))))))))) (and (and (and (and (= o13 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o13 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o13) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o13) 1)))) (and (= result cu14) (= cu1 o13))) (and (and (= result1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1)) (= (= result1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1) true))) (ite (= result1 true) (and (and (and (and (= l__split_discrs (mk___split_discrs temp___490)) (= l__split_fields temp___4901)) (and (= c__split_fields temp___488) (and (and (= l__split_discrs (mk___split_discrs temp___487)) (= l__split_fields temp___4871)) (and (and (= l__split_discrs (mk___split_discrs temp___489)) (= l__split_fields temp___4891)) (and (= temp___486 cu1) (and (= temp___491 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (and (= temp___492 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (and (and (and (and (= o3 (element (mk___rep l__split_discrs (mk___split_fields l__split_fields)) cu1)) (and (in_range2 o3) (= o3 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) cu1))))) (= result2 (ite (= o3 0) true false))) (and (not (= result2 true)) (and (= c__split_fields2 (mk___split_fields1 c__split_fields)) (= c__split_fields2 c__split_fields1)))) (and (and (= (length (mk___rep l__split_discrs l__split_fields2)) (length temp___4892)) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))) (and (< 0 (get (model__ temp___4902) i)) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (- (get (model__ temp___491) i) 1))))) (and (forall ((i Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) i) (<= i (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (get (model__ temp___492) i)))) (not (= (element (mk___rep l__split_discrs l__split_fields2) cu2) 0))))) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) cu2) true) (and (and (and (and (and (= o4 (element (mk___rep l__split_discrs l__split_fields2) cu2)) (and (in_range2 o4) (= o4 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2))))) (= o5 (- o4 1))) (and (= o6 o5) (in_range2 o5))) (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields2))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2)) o6)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2)) true))) (and (and (and (and (= o7 (next (mk___rep l__split_discrs l__split_fields3) cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o7) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) o7) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) cu2) 1))))) (and (= o8 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o7)) (= (= o8 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) o7) true)))) (= result4 (ite (not (= o8 true)) true false))) (= result4 true))))))))))))) (and (and (= cu6 (mk_cursor__ref cu2)) (and (= c__split_fields7 (mk___split_fields__ref1 c__split_fields3)) (= l__split_fields6 (mk___split_fields__ref l__split_fields3)))) (and (= cu7 cu2) (and (= c__split_fields8 c__split_fields3) (= l__split_fields7 l__split_fields3))))) (and (and (= cu8 cu6) (and (= c__split_fields9 c__split_fields7) (= l__split_fields8 l__split_fields6))) (and (= cu9 cu7) (and (= c__split_fields10 c__split_fields8) (= l__split_fields9 l__split_fields7))))) (and (and (= cu8 (mk_cursor__ref cu1)) (and (= c__split_fields9 c__split_fields16) (= l__split_fields8 l__split_fields14))) (and (= cu9 cu1) (and (= c__split_fields10 c__split_fields1) (= l__split_fields9 l__split_fields1))))))) (and (and (and (= cu10 cu8) (and (= c__split_fields12 (mk___split_fields__ref1 c__split_fields11)) (= l__split_fields10 l__split_fields8))) (and (= cu11 cu9) (and (= c__split_fields13 c__split_fields11) (= l__split_fields11 l__split_fields9)))) (and (= result8 c__split_fields9) (= c__split_fields11 (us_split_fields3 no_element)))))))
(assert (= cu12 cu10))
...
(assert (=> (= result10 true) (and (= o12 (element (mk___rep l__split_discrs (us_split_fields__content l__split_fields12)) (mk___rep1 (us_split_fields__content1 c__split_fields14)))) (and (in_range2 o12) (= o12 (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (get1 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (mk___rep1 (us_split_fields__content1 c__split_fields14)))))))))
(assert (=> (= result10 true) (= result9 (ite (= o12 0) true false))))
...
(assert (and (= o11 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12)))) (and (not (= (has_key o11 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o11 i) true) (and (and (<= 1 (get1 o11 i)) (<= (get1 o11 i) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))))) (forall ((j us_rep1)) (=> (= (has_key o11 j) true) (=> (= (get1 o11 i) (get1 o11 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key o11 (mk___rep1 (us_split_fields__content1 c__split_fields14))) true)))
(check-sat)
(exit)
