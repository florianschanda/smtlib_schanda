...
(assert (and (= o9 (first (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq1 o9 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o9) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o9) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o9) true) (= (bool_eq1 o9 no_element) true))))
(check-sat)
(exit)
