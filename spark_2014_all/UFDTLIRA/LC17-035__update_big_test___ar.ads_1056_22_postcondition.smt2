...
(declare-const temp___7171 us_rep3)
...
(declare-const temp___7176 us_rep3)
...
(assert (= temp___7171 (mk___rep3 o19)))
...
(assert (= r__split_fields6 (us_split_fields7 temp___7171)))
...
(assert (= temp___7176 (mk___rep3 o27)))
(assert (= result1 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7176)))
(assert (= r__split_fields8 (mk___split_fields__ref3 r__split_fields7)))
(assert (= r__split_fields9 r__split_fields7))
(assert (not (= (bool_eq3 (mk___rep3 (us_split_fields__content3 r__split_fields8)) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) (of_rep1 f))) r__split_fields3)) r__split_fields4)) r__split_fields5))) true)))
(check-sat)
(exit)
