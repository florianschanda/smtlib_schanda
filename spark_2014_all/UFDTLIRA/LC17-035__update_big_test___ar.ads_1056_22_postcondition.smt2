...
(declare-const temp___7230 us_rep3)
...
(declare-const temp___7235 us_rep3)
...
(assert (= temp___7230 (mk___rep3 o19)))
...
(assert (= r__split_fields6 (us_split_fields7 temp___7230)))
...
(assert (= temp___7235 (mk___rep3 o27)))
(assert (= result1 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7235)))
