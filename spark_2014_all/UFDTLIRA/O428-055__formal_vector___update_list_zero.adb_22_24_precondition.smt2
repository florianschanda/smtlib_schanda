...
(assert (and (= o11 (length (mk___rep l__split_discrs l__split_fields2))) (and (in_range2 o11) (<= o11 (to_rep (rec__loop_types__lists__list__capacity l__split_discrs))))))
(assert (= o12 (ite (<= i1 o11) true false)))
(assert (and (= o9 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o9 no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key o9 i3) true) (and (and (<= 1 (get1 o9 i3)) (<= (get1 o9 i3) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o9 j) true) (=> (= (get1 o9 i3) (get1 o9 j)) (= (bool_eq1 i3 j) true))))))))))
(assert (not (= (has_key o9 (mk___rep1 cu__split_fields2)) true)))
(check-sat)
(exit)
