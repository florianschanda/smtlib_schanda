...
(assert (forall ((i3 Int)) (=> (and (<= first i3) (<= i3 (- current2 1))) (not (= (get (model__ v) i3) e)))))
(assert (and (=> (<= first r27b) (dynamic_property5 first r27b current2)) (and (<= first current2) (<= current2 r27b))))
(assert (not (dynamic_property1 first1 last1 current2)))
(check-sat)
(exit)
