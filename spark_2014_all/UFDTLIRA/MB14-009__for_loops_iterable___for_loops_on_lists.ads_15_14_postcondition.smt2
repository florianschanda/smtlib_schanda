...
(define-fun default_initial_assumption ((temp___expr_227 us_rep2) (temp___skip_top_level_228 Bool)) Bool (=> (not (= temp___skip_top_level_228 true)) (= (length temp___expr_227) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range4 temp___expr_183)))
(define-fun default_initial_assumption1 ((temp___expr_195 us_rep1) (temp___skip_top_level_196 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields3 temp___expr_195))) 0))
...
(define-fun dynamic_invariant3 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range1 temp___expr_141)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant3 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 1 2147483647)) (in_range5 temp___expr_239)))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant3 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant4 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(declare-const e Int)
...
(declare-const temp___480 us_rep2)
...
(assert (or (and (and (and (= for_loops_on_lists__contains_0_for_of__result11 (mk_bool__ref for_loops_on_lists__contains_0_for_of__result3)) (= e9 (mk_int__ref e4))) (and (= for_loops_on_lists__contains_0_for_of__result12 for_loops_on_lists__contains_0_for_of__result3) (= e10 e4))) (and (and (and (= (mk___rep1 (mk___split_fields1 o)) (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o))) 1)))) (= temp___478 o)) (and (and (and (= result (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478)))) (= (= result true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478))) true))) (ite (= result true) (and (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___478)))) (and (in_range4 o1) (= o1 (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___478))))))) (and (= (mk_int__ref result1) (mk_int__ref e)) (= e3 o1))) (and (= e3 e) (= e3 e2)))) (and (and (= result2 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478)))) (= (= result2 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478))) true))) (and (= result2 true) (and (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___4782))) true) (= e4 (element l (mk___rep1 (mk___split_fields1 temp___4782))))) (and (= e4 0) (and (= for_loops_on_lists__contains_0_for_of__result2 result3) (= for_loops_on_lists__contains_0_for_of__result3 (of_int 1)))))))))) (and (and (and (and (= (mk___rep1 (mk___split_fields1 o)) (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o))) 1)))) (= temp___478 o)) (and (and (and (= result (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478)))) (= (= result true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478))) true))) (ite (= result true) (and (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___478)))) (and (in_range4 o1) (= o1 (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___478))))))) (and (= (mk_int__ref result1) (mk_int__ref e)) (= e3 o1))) (and (= e3 e) (= e3 e2)))) (and (and (= result2 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478)))) (= (= result2 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478))) true))) (ite (= result2 true) (and (and (and (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___4782))) true) (= e4 (element l (mk___rep1 (mk___split_fields1 temp___4782))))) (and (and (not (= e4 0)) (= for_loops_on_lists__contains_0_for_of__result3 for_loops_on_lists__contains_0_for_of__result2)) (and (and (and (and (= (mk___rep1 (mk___split_fields1 o2)) (next l (mk___rep1 (mk___split_fields1 temp___4782)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___4782)) no_element) false) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___4782))) (length1 l)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o2)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o2))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o2))) (+ (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___4782))) 1))))) (and (= o3 (has_key (positions l) (mk___rep1 (mk___split_fields1 o2)))) (= (= o3 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o2))) true)))) (= result4 (ite (not (= o3 true)) true false))) (= result4 true)))) (and (and (= temp___4784 (mk_cursor__ref (mk___rep1 (mk___split_fields1 temp___4782)))) (and (= for_loops_on_lists__contains_0_for_of__result4 (mk_bool__ref for_loops_on_lists__contains_0_for_of__result3)) (= e5 (mk_int__ref e4)))) (and (= temp___4785 (mk___rep1 (mk___split_fields1 temp___4782))) (and (= for_loops_on_lists__contains_0_for_of__result5 for_loops_on_lists__contains_0_for_of__result3) (= e6 e4))))) (and (and (= temp___4786 temp___4784) (and (= for_loops_on_lists__contains_0_for_of__result6 for_loops_on_lists__contains_0_for_of__result4) (= e7 e5))) (and (= temp___4787 temp___4785) (and (= for_loops_on_lists__contains_0_for_of__result7 for_loops_on_lists__contains_0_for_of__result5) (= e8 e6))))) (and (and (= temp___4786 (mk_cursor__ref (mk___rep1 (mk___split_fields1 temp___478)))) (and (= for_loops_on_lists__contains_0_for_of__result6 (mk_bool__ref for_loops_on_lists__contains_0_for_of__result)) (= e7 (mk_int__ref e3)))) (and (= temp___4787 (mk___rep1 (mk___split_fields1 temp___4781))) (and (= for_loops_on_lists__contains_0_for_of__result7 for_loops_on_lists__contains_0_for_of__result1) (= e8 e3)))))))) (and (and (and (= for_loops_on_lists__contains_0_for_of__result11 for_loops_on_lists__contains_0_for_of__result9) (= e9 e7)) (and (= for_loops_on_lists__contains_0_for_of__result12 for_loops_on_lists__contains_0_for_of__result10) (= e10 e8))) (and (and (= for_loops_on_lists__contains_0_for_of__result9 (mk_bool__ref for_loops_on_lists__contains_0_for_of__result8)) (= for_loops_on_lists__contains_0_for_of__result10 for_loops_on_lists__contains_0_for_of__result8)) (and (= result7 for_loops_on_lists__contains_0_for_of__result6) (= for_loops_on_lists__contains_0_for_of__result8 (of_int 0))))))))
...
(assert (= e12 e10))
(assert (= result9 (bool__content for_loops_on_lists__contains_0_for_of__result13)))
(assert (= (bool__content for_loops_on_lists__contains_0_for_of__result13) true))
(assert (not (exists ((temp___484 Int)) (and (and (in_range2 temp___484) (= (iter_has_element (model__ l) temp___484) true)) (= (get (model__ l) temp___484) 0)))))
(check-sat)
(exit)
