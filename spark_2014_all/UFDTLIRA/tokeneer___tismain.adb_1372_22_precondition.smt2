...
(assert (=> (= result true) (= o17 (isdoingop (mk___rep theadmin__split_fields1)))))
(assert (=> (= result true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (= result true) (= o16 (ispresent (mk___rep theadmin__split_fields1)))))
...
(assert (=> (= result1 true) (and (= o12 (rolepresent (mk___rep theadmin__split_fields1))) (in_range1 o12))))
(assert (=> (= result1 true) (= o13 (ite (= o12 0) true false))))
(assert (=> (= result1 true) (= o11 (isdoingop (mk___rep theadmin__split_fields1)))))
...
(assert (= result2 (statusisenclavequiescent (let ((subject state)) state7))))
(assert (=> (= result2 true) (= o9 (isdoingop (mk___rep theadmin__split_fields1)))))
(assert (=> (= result2 true) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (not (= result2 true)) (= o10 (of_int 1))))
(assert (= o4 (statusiswaitingfinishadminop (let ((subject state)) state7))))
(assert (= o5 (statusiswaitingstartadminop (let ((subject state)) state7))))
(assert (= result3 (ite (= o5 false) o4 true)))
(assert (=> (= result3 true) (= o6 (isdoingop (mk___rep theadmin__split_fields1)))))
(assert (=> (= result3 true) (= o7 (ispresent (mk___rep theadmin__split_fields1)))))
(assert (=> (= result3 true) (= o8 (ite (= o7 true) o6 false))))
(assert (=> (not (= result3 true)) (= o8 (of_int 1))))
(assert (= o (statusiswaitingremoveadmintokenfail (let ((subject state)) state7))))
(assert (= o1 (statusisgotadmintoken (let ((subject state)) state7))))
(assert (= result4 (ite (= o1 false) o true)))
(assert (=> (= result4 true) (= o2 (ispresent (mk___rep theadmin__split_fields1)))))
(assert (=> (= result4 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (not (= result4 true)) (= o3 (of_int 1))))
(assert (not (= (isdoingop (mk___rep theadmin__split_fields1)) true)))
(check-sat)
(exit)
