...
(define-fun o16 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
...
(assert (=> (= result10 true) (and (= o15 (element (mk___rep l__split_discrs (us_split_fields__content l__split_fields12)) (mk___rep1 (us_split_fields__content1 c__split_fields14)))) (and (in_range2 o15) (= o15 (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (get1 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (mk___rep1 (us_split_fields__content1 c__split_fields14)))))))))
