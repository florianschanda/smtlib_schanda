...
(assert (and (= o4 (length s2)) (and (in_range2 o4) (<= o4 (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 s2)))))))
(assert (and (= o2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o2) (<= o2 (to_rep (rec__use_ordered_maps__my_maps__map__capacity s1__split_discrs))))))
...
(assert (and (= o (iter_has_element temp___793 temp___792)) (= (= o true) (and (<= 1 temp___792) (<= temp___792 (last temp___793))))))
