...
(assert (and (= temp___836 (keys s2)) (and (and (and (= (length3 temp___836) (length s2)) (forall ((temp___439 Int)) (=> (and (in_range5 temp___439) (= (iter_has_element temp___836 temp___439) true)) (= (has_key (model__ s2) (get1 temp___836 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key (model__ s2) key2) true)) (and (< 0 (find temp___836 key2)) (= (equivalent_keys (get1 temp___836 (find temp___836 key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (and (= (find temp___836 (get1 temp___836 i)) i) (= (k_is_find temp___836 (get1 temp___836 i) i) true)))))))
