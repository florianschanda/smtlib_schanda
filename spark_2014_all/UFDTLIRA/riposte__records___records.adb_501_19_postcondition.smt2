...
(declare-const records__field_suppression_on_computation_is_insufficient__result Bool)
(declare-const result Bool)
(declare-const records__field_suppression_on_computation_is_insufficient__result1 Bool)
(declare-const records__field_suppression_on_computation_is_insufficient__result2 Bool)
(declare-const records__field_suppression_on_computation_is_insufficient__result3 Bool)
(declare-const records__field_suppression_on_computation_is_insufficient__result4 Bool)
(declare-const records__field_suppression_on_computation_is_insufficient__result5 Bool)
(declare-const result1 Bool)
(assert (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r)) true))
(assert (= records__field_suppression_on_computation_is_insufficient__result1 records__field_suppression_on_computation_is_insufficient__result2))
(assert (= records__field_suppression_on_computation_is_insufficient__result3 records__field_suppression_on_computation_is_insufficient__result1))
(assert (= result records__field_suppression_on_computation_is_insufficient__result))
(assert (= records__field_suppression_on_computation_is_insufficient__result1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r))))
(assert (= (mk_bool__ref records__field_suppression_on_computation_is_insufficient__result4) (mk_bool__ref records__field_suppression_on_computation_is_insufficient__result2)))
(assert (= records__field_suppression_on_computation_is_insufficient__result5 records__field_suppression_on_computation_is_insufficient__result3))
(assert (= result1 records__field_suppression_on_computation_is_insufficient__result4))
(assert (not (= records__field_suppression_on_computation_is_insufficient__result4 true)))
(check-sat)
(exit)
