...
(assert (and (and (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r)) true) (and (and (= records__field_suppression_on_computation_is_insufficient__result1 records__field_suppression_on_computation_is_insufficient__result2) (= records__field_suppression_on_computation_is_insufficient__result3 records__field_suppression_on_computation_is_insufficient__result1)) (and (= result records__field_suppression_on_computation_is_insufficient__result) (= records__field_suppression_on_computation_is_insufficient__result1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 r)))))) (and (= (mk_bool__ref records__field_suppression_on_computation_is_insufficient__result4) (mk_bool__ref records__field_suppression_on_computation_is_insufficient__result2)) (= records__field_suppression_on_computation_is_insufficient__result5 records__field_suppression_on_computation_is_insufficient__result3))))
(assert (= result1 records__field_suppression_on_computation_is_insufficient__result4))
(assert (= records__field_suppression_on_computation_is_insufficient__result4 true))
(assert (not true))
(check-sat)
(exit)
