...
(define-fun o8 () us_rep2 (mk___rep2 (mk___split_fields2 o5 o6 o7)))
...
(assert (and (= o8 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o4)) (= (bool_eq o8 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o4)) true)))
