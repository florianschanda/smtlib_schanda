...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__names__data__entry_tables__vector__capacity capacity_range)))))
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) capacity_range (rec__names__data__entry_tables__vector__capacity a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__names__data__entry_tables__vector us_main_type1)))))
(define-fun us_split_fields_Vector__2__projection ((a us_split_fields)) us_main_type1 (rec__names__data__entry_tables__vector a))
...
(define-fun us_rep___5__projection ((a us_rep1)) us_split_fields (us_split_fields1 a))
...
(define-fun vector__ref___2__projection ((a vector__ref)) us_rep1 (vector__content a))
...
(define-fun dynamic_invariant ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 2147483647)) (in_range2 temp___expr_489)))
...
(define-fun dynamic_invariant1 ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 1 2147483647)) (in_range3 temp___expr_472)))
...
(assert (forall ((x positive)) (! (in_range4 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x name_id)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-const dummy7 char_table_index)
...
(assert (forall ((x char_table_index)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range6 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__names__data__name_entry__table_index char_table_index) (rec__names__data__name_entry__length positive) (rec__names__data__name_entry__next_hash name_id)))))
(define-fun us_split_fields_Table_Index__projection ((a us_split_fields2)) char_table_index (rec__names__data__name_entry__table_index a))
(define-fun us_split_fields_Length__projection ((a us_split_fields2)) positive (rec__names__data__name_entry__length a))
(define-fun us_split_fields_Next_Hash__projection ((a us_split_fields2)) name_id (rec__names__data__name_entry__next_hash a))
...
(define-fun bool_eq1 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep2 (rec__names__data__name_entry__table_index (us_split_fields3 a))) (to_rep2 (rec__names__data__name_entry__table_index (us_split_fields3 b)))) (= (to_rep (rec__names__data__name_entry__length (us_split_fields3 a))) (to_rep (rec__names__data__name_entry__length (us_split_fields3 b))))) (= (to_rep1 (rec__names__data__name_entry__next_hash (us_split_fields3 a))) (to_rep1 (rec__names__data__name_entry__next_hash (us_split_fields3 b))))) true false))
...
(declare-datatypes () ((us_split_discrs2 (mk___split_discrs1 (rec__names__data__char_tables__vector__capacity capacity_range1)))))
(define-fun us_split_discrs___projection ((a us_split_discrs2)) capacity_range1 (rec__names__data__char_tables__vector__capacity a))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__names__data__char_tables__vector us_main_type2)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields4)) us_main_type2 (rec__names__data__char_tables__vector a))
...
(declare-datatypes () ((us_rep3 (mk___rep2 (us_split_discrs3 us_split_discrs2) (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___projection ((a us_rep3)) us_split_discrs2 (us_split_discrs3 a))
(define-fun us_rep___2__projection ((a us_rep3)) us_split_fields4 (us_split_fields5 a))
...
(declare-datatypes () ((vector__ref1 (mk_vector__ref1 (vector__content1 us_rep3)))))
(define-fun vector__ref___projection ((a vector__ref1)) us_rep3 (vector__content1 a))
...
(assert (forall ((x capacity_range1)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range7 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun in_range8 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep3)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep3 (rec__names__data__char_tables__vector__capacity (us_split_discrs3 a)))))
...
(declare-datatypes () ((tchar_tableS__ref (mk_tchar_tableS__ref (tchar_tableS__content us_rep3)))))
(define-fun tchar_tableS__ref___projection ((a tchar_tableS__ref)) us_rep3 (tchar_tableS__content a))
...
(assert (forall ((x capacity_range)) (! (in_range1 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x Int)) (! (=> (in_range1 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun in_range9 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep4 (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 a)))))
...
(declare-fun valid_tables (us_split_fields4 us_split_fields) Bool)
(declare-fun valid_tables__function_guard (Bool us_split_fields4 us_split_fields) Bool)
...
(declare-fun model__1 (us_rep3) us_rep4)
(declare-fun model____function_guard1 (us_rep4 us_rep3) Bool)
(define-fun last_index1 ((container us_rep3)) Int (last1 (model__1 container)))
...
(define-fun dynamic_invariant2 ((temp___expr_629 us_rep3) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (not (= temp___skip_constant_626 true)) (in_range8 1024 temp___expr_629)))
(define-fun default_initial_assumption ((temp___expr_631 us_rep3) (temp___skip_top_level_632 Bool)) Bool (and (= (to_rep3 (rec__names__data__char_tables__vector__capacity (us_split_discrs3 temp___expr_631))) 1024) (=> (not (= temp___skip_top_level_632 true)) (= (is_empty temp___expr_631) true))))
...
(define-fun default_initial_assumption1 ((temp___expr_641 us_rep1) (temp___skip_top_level_642 Bool)) Bool (and (= (to_rep4 (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 temp___expr_641))) 256) (=> (not (= temp___skip_top_level_642 true)) (= (is_empty1 temp___expr_641) true))))
(assert true)
(assert (forall ((names__char_table__fields us_split_fields4)) (forall ((names__entry_table__fields us_split_fields)) (! (= (= (valid_tables names__char_table__fields names__entry_table__fields) true) (and (<= (last_index (mk___rep entry_table__split_discrs names__entry_table__fields)) 2147483647) (<= (last_index1 (mk___rep2 char_table__split_discrs names__char_table__fields)) 2147483646))) :pattern ((valid_tables names__char_table__fields names__entry_table__fields))))))
(declare-fun valid_entry (us_rep2 us_split_fields4 us_split_fields) Bool)
(declare-fun valid_entry__function_guard (Bool us_rep2 us_split_fields4 us_split_fields) Bool)
(assert true)
(assert (forall ((e us_rep2)) (forall ((names__char_table__fields us_split_fields4)) (forall ((names__entry_table__fields us_split_fields)) (! (= (= (valid_entry e names__char_table__fields names__entry_table__fields) true) (and (<= (to_rep1 (rec__names__data__name_entry__next_hash (us_split_fields3 e))) (last_index (mk___rep entry_table__split_discrs names__entry_table__fields))) (<= (- (to_rep (rec__names__data__name_entry__length (us_split_fields3 e))) 1) (- (last_index1 (mk___rep2 char_table__split_discrs names__char_table__fields)) (to_rep2 (rec__names__data__name_entry__table_index (us_split_fields3 e))))))) :pattern ((valid_entry e names__char_table__fields names__entry_table__fields)))))))
(define-fun dynamic_invariant4 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range4 temp___expr_46)))
(define-fun dynamic_invariant5 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range5 temp___expr_210)))
...
(define-fun dynamic_invariant7 ((temp___expr_304 Int) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool) (temp___do_typ_inv_303 Bool)) Bool (=> (or (= temp___is_init_300 true) (<= 0 2147483646)) (in_range6 temp___expr_304)))
...
(define-fun dynamic_invariant9 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range7 temp___expr_332)))
(define-fun capacity ((container us_rep3)) Int (ite (= (distinct 0 0) true) (to_rep3 (rec__names__data__char_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(assert (forall ((container us_rep3)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant9 result true false true true))) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep3)) (! (= (length1 (model__1 container)) (length2 container)) :pattern ((model__1 container)))))
(assert (forall ((container us_rep3)) (! (= (= (is_empty container) true) (= (length2 container) 0)) :pattern ((is_empty container)))))
...
(define-fun dynamic_invariant12 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2147483647)) (in_range1 temp___expr_496)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep4 (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun oeq1 ((left us_rep) (right us_rep)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq1 (get left n) (get right n)) true))) true false)))
...
(define-fun default_initial_assumption3 ((temp___expr_538 us_rep) (temp___skip_top_level_539 Bool)) Bool (=> (not (= temp___skip_top_level_539 true)) (= (length temp___expr_538) 0)))
...
(assert true)
(declare-const char_table__split_fields us_main_type2)
...
(declare-const o5 char_table_index)
(declare-const o6 positive)
(declare-const o7 name_id)
(declare-const result Bool)
(define-fun o8 () us_rep2 (mk___rep1 (mk___split_fields1 o5 o6 o7)))
...
(assert (= (valid_tables (mk___split_fields2 char_table__split_fields) (mk___split_fields entry_table__split_fields)) true))
(assert (and (= o1 (last (model__ (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))))) (and (in_range2 o1) (= o1 (last (model__ (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))))))))
(assert (= o2 (ite (<= i o1) true false)))
(assert (and (= o 1) (and (in_range3 o) (= o 1))))
(assert (= o3 (ite (<= o i) true false)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (= result true))
(assert (and (= o4 i) (in_range3 i)))
(assert (and (= o8 (get (model__ (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o4)) (= (bool_eq1 o8 (get (model__ (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o4)) true)))
(assert (not (= (valid_tables (mk___split_fields2 char_table__split_fields) (mk___split_fields entry_table__split_fields)) true)))
(check-sat)
(exit)
