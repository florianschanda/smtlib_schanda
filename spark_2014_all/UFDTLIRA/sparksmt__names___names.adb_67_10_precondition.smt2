...
(define-fun dynamic_invariant ((temp___expr_569 us_rep) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (not (= temp___skip_constant_567 true)) (in_range3 1024 temp___expr_569)))
(define-fun default_initial_assumption ((temp___expr_571 us_rep) (temp___skip_top_level_572 Bool)) Bool (and (= (to_rep (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_571))) 1024) (=> (not (= temp___skip_top_level_572 true)) (= (is_empty temp___expr_571) true))))
...
(define-fun dynamic_invariant1 ((temp___expr_578 us_rep1) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (not (= temp___skip_constant_576 true)) (in_range5 256 temp___expr_578)))
(define-fun default_initial_assumption1 ((temp___expr_580 us_rep1) (temp___skip_top_level_581 Bool)) Bool (and (= (to_rep1 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_580))) 256) (=> (not (= temp___skip_top_level_581 true)) (= (is_empty1 temp___expr_580) true))))
...
(define-fun dynamic_invariant2 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 2147483647)) (in_range9 temp___expr_436)))
(declare-fun first_index__function_guard (Int us_rep1) Bool)
(define-fun dynamic_invariant3 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range6 temp___expr_421)))
...
(define-fun dynamic_invariant4 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range7 temp___expr_39)))
(define-fun dynamic_invariant5 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range1 temp___expr_180)))
...
(define-fun dynamic_invariant6 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range10 temp___expr_142)))
(define-fun dynamic_invariant7 ((temp___expr_264 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483646)) (in_range8 temp___expr_264)))
...
(define-fun dynamic_invariant8 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 1) 2147483647)) (in_range11 temp___expr_282)))
(define-fun dynamic_invariant9 ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 0 2147483647)) (in_range2 temp___expr_288)))
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(declare-fun length2 (us_rep) Int)
(declare-fun length__function_guard2 (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant9 result true false true))) :pattern ((length2 container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_322 us_rep4) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (length1 temp___expr_322) 0)))
...
(define-fun dynamic_invariant10 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 1) 2147483646)) (in_range12 temp___expr_315)))
(assert (forall ((container us_rep4)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant6 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant11 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range13 temp___expr_309)))
(assert (forall ((container us_rep4)) (forall ((position Int)) (! (=> (and (dynamic_invariant10 position true true true) (and (<= 0 position) (<= position (last1 container)))) (dynamic_invariant11 (get1 container position) true false true)) :pattern ((get1 container position))))))
(define-fun dynamic_invariant12 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range4 temp___expr_442)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (of_int 0) true) (to_rep1 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(assert (forall ((container us_rep1)) (! (let ((result (length3 container))) (and (<= result (capacity1 container)) (dynamic_invariant12 result true false true))) :pattern ((length3 container)))))
...
(define-fun default_initial_assumption3 ((temp___expr_479 us_rep3) (temp___skip_top_level_480 Bool)) Bool (=> (not (= temp___skip_top_level_480 true)) (= (length temp___expr_479) 0)))
...
(assert (= result true))
(assert (and (= o4 i) (in_range6 i)))
(assert (and (= (mk___rep2 (mk___split_fields2 o5 o6 o7)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o4)) (= (bool_eq (mk___rep2 (mk___split_fields2 o5 o6 o7)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o4)) true)))
(assert (not (= (valid_tables (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)))
(check-sat)
(exit)
