...
(assert (forall ((x Int) (f Int) (l Int)) (! (=> (and (and (dynamic_invariant1 x true true true true) (dynamic_invariant1 f true true true true)) (dynamic_invariant1 l true true true true)) (let ((result (id x f l))) (and (=> (and (<= f x) (<= x l)) (and (<= f result) (<= result l))) (dynamic_invariant1 result true false true true)))) :pattern ((id x f l)))))
...
(define-fun dynamic_invariant2 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= (- 2147483647) 2147483647)) (in_range3 temp___expr_214)))
...
(define-fun dynamic_invariant3 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_221)))
(assert (= first fst))
...
(define-fun dynamic_invariant4 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first2 last1)) (dynamic_property2 first2 last1 temp___expr_256)))
...
(define-fun dynamic_invariant5 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first1 last)) (dynamic_property1 first1 last temp___expr_242)))
(assert (= first1 fst))
(assert (= last lst))
...
(assert (=> (< last first1) (= temp___406 0)))
(assert (=> (not (< last first1)) (=> (=> (not (< last (- 1))) (< (- last 2147483647) first1)) (= temp___406 (+ (- last first1) 1)))))
(assert (=> (not (< last first1)) (=> (not (=> (not (< last (- 1))) (< (- last 2147483647) first1))) (= temp___406 2147483647))))
(assert (= temp___406 last_count))
(assert (and (= o (id 1 (- 2147483647) 2147483647)) (and (in_range1 o) (=> (and (<= (- 2147483647) 1) (<= 1 2147483647)) (and (<= (- 2147483647) o) (<= o 2147483647))))))
(assert (and (= use_vectors__fst__assume o) (in_range3 o)))
(assert (= use_vectors__fst__assume fst))
(assert (in_range3 fst))
(assert (<= fst 2147483647))
(assert (not (<= (- 2147483648) fst)))
(check-sat)
(exit)
