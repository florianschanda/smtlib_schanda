...
(assert (=> (= b 1) (= result (mk___split_fields__ref1 (mk___split_fields1 r__split_fields r__split_fields1 (mk___rep (mk___split_fields r__split_fields2 r__split_fields3)))))))
(assert (=> (= b 1) (= r__split_fields4 (mk___split_fields1 temp___178 temp___1781 (mk___rep (mk___split_fields temp___1782 temp___1783))))))
...
(assert (=> (not (= b 1)) (=> (= b 2) (= temp___179 (mk___rep1 (mk___split_fields1 o20 o21 (mk___rep (mk___split_fields o22 o23))))))))
(assert (=> (not (= b 1)) (=> (= b 2) (= result1 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields r__split_fields1 (mk___rep (mk___split_fields r__split_fields2 r__split_fields3))))))))
(assert (=> (not (= b 1)) (=> (= b 2) (= r__split_fields5 (us_split_fields3 temp___179)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= (to_rep o24) one)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= (to_rep o25) 1)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= o26 (mk___split_fields o25 o24))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= o27 (mk___rep o26))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= (to_rep o28) one)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= (to_rep o29) one)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= o30 (mk___split_fields1 o29 o28 o27))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= temp___180 (mk___rep1 o30))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= result2 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields r__split_fields1 (mk___rep (mk___split_fields r__split_fields2 r__split_fields3)))))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= r__split_fields6 (us_split_fields3 temp___180))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= (to_rep o31) one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= (to_rep o32) 2))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= o33 (mk___split_fields o32 o31)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= o34 (mk___rep o33)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= (to_rep o35) one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= (to_rep o36) 2))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= o37 (mk___split_fields1 o36 o35 o34)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= temp___181 (mk___rep1 o37)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= result3 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields r__split_fields1 (mk___rep (mk___split_fields r__split_fields2 r__split_fields3))))))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= r__split_fields7 (us_split_fields3 temp___181)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= (to_rep o38) 2))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= (to_rep o39) one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= o40 (mk___split_fields o39 o38)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= o41 (mk___rep o40)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= (to_rep o42) 2))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= (to_rep o43) one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= o44 (mk___split_fields1 o43 o42 o41)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= temp___182 (mk___rep1 o44)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= result4 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields r__split_fields1 (mk___rep (mk___split_fields r__split_fields2 r__split_fields3))))))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= r__split_fields8 (us_split_fields3 temp___182)))))))
...
(assert (= b 1))
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields9)) (mk___rep1 (mk___split_fields1 (of_rep one) (of_rep 2) (mk___rep (mk___split_fields (of_rep one) (of_rep 2)))))) true)))
(check-sat)
(exit)
