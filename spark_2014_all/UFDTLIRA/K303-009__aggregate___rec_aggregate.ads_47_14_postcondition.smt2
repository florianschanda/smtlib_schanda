...
(assert (not (= b 1)))
(assert (= b 2))
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields9)) (mk___rep1 (mk___split_fields1 (of_rep one) (of_rep one) (mk___rep (mk___split_fields (of_rep one) (of_rep one)))))) true)))
(check-sat)
(exit)
