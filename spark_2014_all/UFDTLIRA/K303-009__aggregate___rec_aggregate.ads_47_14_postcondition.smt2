...
(assert (=> (= b 1) (= o10 o4)))
(assert (=> (= b 1) (= o11 o5)))
(assert (=> (= b 1) (= temp___204 o8)))
(assert (=> (= b 1) (= temp___2041 o9)))
(assert (=> (= b 1) (= temp___2042 o10)))
(assert (=> (= b 1) (= temp___2043 o11)))
...
(assert (=> (not (= b 1)) (=> (= b 2) (= temp___205 (mk___rep1 (mk___split_fields1 o20 o21 (mk___rep (mk___split_fields o22 o23))))))))
...
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= temp___206 (mk___rep1 o30))))))
...
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= temp___207 (mk___rep1 o37)))))))
...
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= temp___208 (mk___rep1 o44)))))))
