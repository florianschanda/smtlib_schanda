...
(define-fun e_bigger_than_range ((container us_rep2) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get container i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep2 Int Int Int) Bool)
(define-fun e_smaller_than_range ((container us_rep2) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get container i)) true))) true false))
...
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq4 a b) (oeq4 a b)) :pattern ((user_eq4 a b)))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant1 result true false true)))) :pattern ((find container item))))))
...
(assert (=> (= result true) (and (and (and (= (oeq2 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1)))) true) (= (oeq3 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (get (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) e)) e)) (= (equal_except (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) e)) true))))
(assert (=> (not (= result true)) (and (and (and (and (and (and (and (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) e) true)) (= (get (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) e)) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) true)) (= (included_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) 1 (- (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) e) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) e) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) e) 1) true))))
...
(assert (and (= (mk___rep1 (mk___split_fields1 o)) (find1 (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) e)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e) false) true false) (and (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 o))) true)) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o)) no_element) true)) (and (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 o))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 o))) (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e))) (= (equivalent_elements (element (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) (mk___rep1 (mk___split_fields1 o))) e) true)))))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 o))) true)))
(check-sat)
(exit)
