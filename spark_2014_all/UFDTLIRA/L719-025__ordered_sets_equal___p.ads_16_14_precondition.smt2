...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant1 result true false true true)))) :pattern ((find container item))))))
