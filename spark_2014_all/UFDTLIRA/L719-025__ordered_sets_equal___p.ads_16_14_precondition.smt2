...
(assert (=> (= result true) (and (and (and (= (oeq2 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields6))) true) (= (oeq3 (positions (mk___rep l__split_discrs l__split_fields6)) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)) (= (get (elements (mk___rep l__split_discrs l__split_fields6)) (find (elements (mk___rep l__split_discrs l__split_fields6)) e)) e)) (= (equal_except (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields6)) (find (elements (mk___rep l__split_discrs l__split_fields6)) e)) true))))
(assert (=> (not (= result true)) (and (and (and (and (and (and (and (= (length (mk___rep l__split_discrs l__split_fields5)) (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (contains (model__ (mk___rep l__split_discrs l__split_fields5)) e) true)) (= (get (elements (mk___rep l__split_discrs l__split_fields5)) (find (elements (mk___rep l__split_discrs l__split_fields5)) e)) e)) (= (ole (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields5))) true)) (= (included_except (model__ (mk___rep l__split_discrs l__split_fields5)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) e) true)) (= (range_equal (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields5)) 1 (- (find (elements (mk___rep l__split_discrs l__split_fields5)) e) 1)) true)) (= (range_shifted (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (elements (mk___rep l__split_discrs l__split_fields5)) (find (elements (mk___rep l__split_discrs l__split_fields5)) e) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (positions (mk___rep l__split_discrs l__split_fields5)) (find (elements (mk___rep l__split_discrs l__split_fields5)) e) 1) true))))
...
(assert (and (= o1 (find1 (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) e)) (ite (ite (= (contains (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e) false) true false) (and (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) o1) true)) (= (bool_eq1 o1 no_element) true)) (and (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) o1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) o1) (find (elements (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) e))) (= (equivalent_elements (element (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) o1) e) true)))))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) o1) true)))
(check-sat)
(exit)
