...
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ ofront)))) (= (get (model__ (mk___rep front__split_discrs front__split_fields10)) i) (get (model__ ofront) i))))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (forall ((i Int)) (=> (and (<= idx2 i) (<= i (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields)))))) (= (get (model__ (mk___rep front__split_discrs front__split_fields10)) (- (+ (last (model__ (mk___rep front__split_discrs front__split_fields10))) idx2) i)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i))))))
...
(assert (not (= (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields8))) (+ (length ofront) (length orear)))))
(check-sat)
(exit)
