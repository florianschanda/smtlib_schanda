...
(define-fun dynamic_invariant ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 1 2147483647)) (in_range1 temp___expr_214)))
...
(define-fun dynamic_invariant1 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 1 100)) (in_range2 temp___expr_220)))
...
(define-fun default_initial_assumption ((temp___expr_233 us_rep) (temp___skip_top_level_234 Bool)) Bool (=> (not (= temp___skip_top_level_234 true)) (= (length temp___expr_233) 0)))
