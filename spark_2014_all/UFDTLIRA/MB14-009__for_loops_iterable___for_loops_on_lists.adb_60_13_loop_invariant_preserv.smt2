...
(assert (and (= o10 (next l temp___5471)) (ite (= (ite (= (bool_eq1 temp___5471 no_element) false) (= (get1 (positions l) temp___5471) (length1 l)) true) true) (= (bool_eq1 o10 no_element) true) (and (= (has_key (positions l) o10) true) (= (get1 (positions l) o10) (+ (get1 (positions l) temp___5471) 1))))))
...
(assert (and (= o9 (next l temp___5471)) (ite (= (ite (= (bool_eq1 temp___5471 no_element) false) (= (get1 (positions l) temp___5471) (length1 l)) true) true) (= (bool_eq1 o9 no_element) true) (and (= (has_key (positions l) o9) true) (= (get1 (positions l) o9) (+ (get1 (positions l) temp___5471) 1))))))
(assert (= result8 (mk_cursor__ref temp___5471)))
(assert (= temp___5472 o9))
(assert (and (= result9 (has_key (positions l) temp___5472)) (= (= result9 true) (= (has_key (positions l) temp___5472) true))))
(assert (=> (= result9 true) (and (= o7 (element l temp___5472)) (and (in_range3 o7) (= o7 (get (model__ l) (get1 (positions l) temp___5472)))))))
