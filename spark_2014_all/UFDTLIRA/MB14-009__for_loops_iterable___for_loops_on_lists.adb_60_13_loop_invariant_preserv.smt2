...
(assert (and (= o11 (has_key (positions l) (mk___rep1 (mk___split_fields1 o10)))) (= (= o11 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o10))) true))))
(assert (= result9 (ite (not (= o11 true)) true false)))
(assert (not (= result9 true)))
(assert (and (= (mk___rep1 (mk___split_fields1 o12)) (next l temp___5052)) (ite (= (ite (= (bool_eq1 temp___5052 no_element) false) (= (get1 (positions l) temp___5052) (length1 l)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o12)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o12))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o12))) (+ (get1 (positions l) temp___5052) 1))))))
(assert (= result10 (mk_cursor__ref temp___5052)))
(assert (= temp___5053 (mk___rep1 (mk___split_fields1 o12))))
(assert (and (= result11 (has_key (positions l) temp___5053)) (= (= result11 true) (= (has_key (positions l) temp___5053) true))))
(assert (=> (= result11 true) (and (= o13 (element l temp___5053)) (and (in_range3 o13) (= o13 (get (model__ l) (get1 (positions l) temp___5053)))))))
(assert (=> (= result11 true) (= result12 (mk_int__ref e5))))
(assert (=> (= result11 true) (= e6 o13)))
(assert (=> (not (= result11 true)) (= e6 e5)))
(assert (=> (= e6 0) (and (= o14 (+ count_03 1)) (in_range1 (+ count_03 1)))))
(assert (=> (= e6 0) (= result13 (mk_int__ref count_03))))
(assert (=> (= e6 0) (= count_04 o14)))
(assert (=> (not (= e6 0)) (= count_04 count_03)))
(assert (< 0 count_04))
