...
(assert (and (= o11 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 o11 no_element) true) (and (= (has_key (positions l) o11) true) (= (get1 (positions l) o11) 1)))))
(assert (= temp___505 o))
...
(assert (and (= o10 (next l temp___5051)) (ite (= (ite (= (bool_eq1 temp___5051 no_element) false) (= (get1 (positions l) temp___5051) (length1 l)) true) true) (= (bool_eq1 o10 no_element) true) (and (= (has_key (positions l) o10) true) (= (get1 (positions l) o10) (+ (get1 (positions l) temp___5051) 1))))))
(assert (and (= o5 (has_key (positions l) o10)) (= (= o5 true) (= (has_key (positions l) o10) true))))
(assert (= result7 (ite (not (= o5 true)) true false)))
(assert (not (= result7 true)))
(assert (and (= o9 (next l temp___5051)) (ite (= (ite (= (bool_eq1 temp___5051 no_element) false) (= (get1 (positions l) temp___5051) (length1 l)) true) true) (= (bool_eq1 o9 no_element) true) (and (= (has_key (positions l) o9) true) (= (get1 (positions l) o9) (+ (get1 (positions l) temp___5051) 1))))))
(assert (= result8 (mk_cursor__ref temp___5051)))
(assert (= temp___5052 o9))
(assert (and (= result9 (has_key (positions l) temp___5052)) (= (= result9 true) (= (has_key (positions l) temp___5052) true))))
(assert (=> (= result9 true) (and (= o7 (element l temp___5052)) (and (in_range3 o7) (= o7 (get (model__ l) (get1 (positions l) temp___5052)))))))
(assert (=> (= result9 true) (= result10 (mk_int__ref e3))))
(assert (=> (= result9 true) (= e4 o7)))
(assert (=> (not (= result9 true)) (= e4 e3)))
(assert (=> (= e4 0) (and (= o8 (+ count_03 1)) (in_range1 (+ count_03 1)))))
