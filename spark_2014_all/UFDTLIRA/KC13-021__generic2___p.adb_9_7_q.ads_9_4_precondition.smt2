...
(assert (forall ((j Int)) (! (=> (dynamic_invariant j true true true true) (dynamic_invariant (qf1 j) true false true true)) :pattern ((qf1 j)))))
(declare-sort t1 0)
...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_158)))
