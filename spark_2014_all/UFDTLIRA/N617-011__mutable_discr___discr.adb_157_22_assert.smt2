...
(define-fun o10 () us_rep (mk___rep (mk___split_discrs o3) (mk___split_fields o4) o5))
(define-fun o11 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1) o2))
(assert (in_range c))
(assert (and (= us c) (in_range c)))
(assert (and (= o11 (new_with_default c)) (= (to_rep o) c)))
(assert (= o10 o11))
(assert (= (mk___rep (mk___split_discrs discr__p5__d1__assume) (mk___split_fields discr__p5__d1__assume1) discr__p5__d1__assume2) o10))
...
(assert (=> (= (attr__constrained (rec__private_discr__p_holder__content h__split_fields3)) true) (= (rec__private_discr__p_with_default__c d2__split_discrs1) (rec__private_discr__p_with_default__c (us_split_discrs1 (rec__private_discr__p_holder__content h__split_fields3))))))
(assert (= usq_1 (mk___rep d2__split_discrs1 d2__split_fields1 d2__attr__constrained)))
(assert (= o8 (mk___rep (us_split_discrs1 usq_1) (us_split_fields1 usq_1) (attr__constrained (rec__private_discr__p_holder__content h__split_fields3)))))
(assert (= o9 (mk___split_fields1 o8)))
(assert (= temp___385 (mk___rep1 o9)))
(assert (= result4 (mk___split_fields__ref1 h__split_fields3)))
(assert (= h__split_fields4 (us_split_fields3 temp___385)))
(assert (not (= (attr__constrained (rec__private_discr__p_holder__content h__split_fields4)) true)))
(assert (not (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 (rec__private_discr__p_holder__content h__split_fields4)))) c)))
(check-sat)
(exit)
