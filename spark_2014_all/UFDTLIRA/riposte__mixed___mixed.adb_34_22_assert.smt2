...
(assert (forall ((r us_rep)) (! (let ((result (get_i r))) (and (= result (to_rep (rec__mixed__rec__i (us_split_fields1 r)))) (dynamic_invariant result true false true))) :pattern ((get_i r)))))
