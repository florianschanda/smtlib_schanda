...
(assert (not (or (< temp___9622 next_idx3) (and (= next_idx3 temp___9622) (< (to_int1 (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs3)) 0)) temp___9612)))))
(check-sat)
(exit)
