...
(assert (not (or (< temp___10581 next_idx3) (and (= next_idx3 temp___10581) (< (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs3)) 0) 1 0) temp___10571)))))
(check-sat)
(exit)
