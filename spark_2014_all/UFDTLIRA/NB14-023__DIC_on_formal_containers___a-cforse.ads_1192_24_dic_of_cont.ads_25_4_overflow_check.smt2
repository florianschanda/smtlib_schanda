...
(define-fun dynamic_invariant1 ((temp___expr_1260 Int) (temp___is_init_1257 Bool) (temp___skip_constant_1258 Bool) (temp___do_toplevel_1259 Bool)) Bool (=> (or (= temp___is_init_1257 true) (<= 0 2147483647)) (in_range3 temp___expr_1260)))
...
(define-fun default_initial_assumption ((temp___expr_1324 us_rep2) (temp___skip_top_level_1325 Bool)) Bool (=> (not (= temp___skip_top_level_1325 true)) (= (length2 temp___expr_1324) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_1293 us_rep1) (temp___skip_top_level_1294 Bool)) Bool (=> (not (= temp___skip_top_level_1294 true)) (= (is_empty temp___expr_1293) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___1358 Int)) (=> (and (in_range5 temp___1358) (= (iter_has_element result temp___1358) true)) (= (contains (model__ container) (get result temp___1358)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_1286 Int) (temp___is_init_1283 Bool) (temp___skip_constant_1284 Bool) (temp___do_toplevel_1285 Bool)) Bool (=> (or (= temp___is_init_1283 true) (<= 0 2147483647)) (in_range4 temp___expr_1286)))
...
(define-fun dynamic_invariant3 ((temp___expr_1317 Int) (temp___is_init_1314 Bool) (temp___skip_constant_1315 Bool) (temp___do_toplevel_1316 Bool)) Bool (=> (or (= temp___is_init_1314 true) (<= 0 2147483647)) (in_range5 temp___expr_1317)))
...
(define-fun dynamic_invariant4 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2147483647)) (in_range6 temp___expr_1311)))
