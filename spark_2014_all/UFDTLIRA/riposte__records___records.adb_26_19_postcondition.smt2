...
(declare-const temp___297 unsigned_byte)
(declare-const temp___2971 unsigned_byte)
(declare-const o4 unsigned_byte)
(declare-const o5 unsigned_byte)
(declare-const o6 unsigned_byte)
(declare-const o7 unsigned_byte)
(declare-const temp___296 unsigned_byte)
(declare-const temp___2961 unsigned_byte)
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___297 o2))
(assert (= temp___2971 o3))
(assert (= (mk___rep (mk___split_fields temp___297 temp___2971)) null_pair))
(assert (= (to_rep o4) 0))
(assert (= (to_rep o5) 0))
(assert (= o5 o6))
(assert (= o4 o7))
...
(assert (= temp___296 r__split_fields2))
(assert (= temp___2961 r__split_fields3))
(assert (= records__init_c__result4 records__init_c__result2))
(assert (= records__init_c__result5 records__init_c__result3))
(assert (= records__init_c__result6 (mk___rep (mk___split_fields records__init_c__result2 records__init_c__result3))))
...
(assert (= records__init_c__result7 (mk_pair__ref (mk___rep (mk___split_fields records__init_c__result4 records__init_c__result5)))))
...
(assert (= (mk___rep (mk___split_fields result4 result5)) (pair__content records__init_c__result7)))
(assert (not (= (bool_eq (pair__content records__init_c__result7) null_pair) true)))
(check-sat)
(exit)
