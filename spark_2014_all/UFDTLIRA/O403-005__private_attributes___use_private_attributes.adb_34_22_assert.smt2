...
(assert (not (not (= (ite (= rc__attr__tag fc__attr__tag) (us_dispatch_eq (mk___rep (mk___split_fields rc__split_fields2 rc__split_fields3) rc__attr__tag) (mk___rep fc__split_fields2 fc__attr__tag)) false) true))))
(check-sat)
(exit)
