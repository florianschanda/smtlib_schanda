...
(assert (= (integerqtint rliteral) 12))
(declare-const x__split_discrs Bool)
(declare-const r__split_fields integer)
(declare-const r__split_fields1 failure_reason)
(declare-const o failure_reason)
(declare-const o1 integer)
(declare-const o2 failure_reason)
(declare-const o3 Bool)
(declare-const o4 integer)
(declare-const o5 failure_reason)
(declare-const o6 Bool)
(declare-const o7 Bool)
(declare-const o8 integer)
(declare-const o9 failure_reason)
(declare-const o10 Bool)
(declare-const o11 Bool)
(declare-const o12 integer)
(declare-const o13 failure_reason)
(declare-const o14 Bool)
(declare-const temp___316 Bool)
(declare-const temp___3161 integer)
(declare-const temp___3162 failure_reason)
(declare-const temp___3163 Bool)
(declare-const result integer)
(declare-const result1 failure_reason)
...
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o11) (mk___split_fields o12 o13) o14))
(define-fun o16 () us_rep (mk___rep (mk___split_discrs o7) (mk___split_fields o8 o9) o10))
(assert (= x__split_discrs tmp))
(assert (and (= r__attr__constrained true) (= (rec__test__search_result__found r__split_discrs) tmp)))
(assert (and (= tmp (rec__test__search_result__found r__split_discrs)) (= r__attr__constrained true)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= result r__split_fields)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= result1 r__split_fields1)))
(assert (=> (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1) (= r__split_fields2 (mk___split_fields rliteral r__split_fields1))))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= (to_rep o) 0)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= dummy o1)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o o2)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= (distinct 0 0) o3)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o4 o1)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o5 o2)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= true o6)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o16 (mk___rep (mk___split_discrs o3) (mk___split_fields o4 o5) o6))))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= o15 o16)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= (mk___rep (mk___split_discrs temp___316) (mk___split_fields temp___3161 temp___3162) temp___3163) o15)))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= result2 (mk___split_fields__ref (mk___split_fields r__split_fields r__split_fields1)))))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= r__split_fields3 (mk___split_fields temp___3161 temp___3162))))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= r__split_discrs (mk___split_discrs temp___316))))
(assert (=> (not (= (ite (rec__test__search_result__found r__split_discrs) 1 0) 1)) (= r__split_fields2 r__split_fields3)))
(assert (= x__split_discrs r40b))
(assert (= x__attr__constrained true))
(assert (not (= (rec__test__search_result__found r__split_discrs) x__split_discrs)))
(check-sat)
(exit)
