...
(define-fun dynamic_invariant1 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= (- 1) 10001)) (in_range2 temp___expr_223)))
...
(define-fun dynamic_invariant2 ((temp___expr_229 Int) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (or (= temp___is_init_226 true) (<= 0 10001)) (in_range3 temp___expr_229)))
...
(define-fun dynamic_invariant3 ((temp___expr_209 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 10000)) (in_range4 temp___expr_209)))
...
(define-fun dynamic_invariant4 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 5)) (in_range5 temp___expr_189)))
...
(define-fun dynamic_invariant5 ((temp___expr_258 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= (- 1) 10000)) (in_range6 temp___expr_258)))
