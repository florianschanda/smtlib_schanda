...
(declare-fun user_eq2 (my_pos my_pos) Bool)
(declare-const dummy2 my_pos)
...
(define-fun dynamic_invariant1 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 100)) (in_range2 temp___expr_160)))
