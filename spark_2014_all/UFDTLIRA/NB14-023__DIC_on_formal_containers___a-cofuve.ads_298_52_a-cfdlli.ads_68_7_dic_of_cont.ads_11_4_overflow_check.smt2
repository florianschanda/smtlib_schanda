...
(define-fun dynamic_invariant ((temp___expr_350 Int) (temp___is_init_347 Bool) (temp___skip_constant_348 Bool) (temp___do_toplevel_349 Bool)) Bool (=> (or (= temp___is_init_347 true) (<= 1 2147483647)) (in_range1 temp___expr_350)))
...
(define-fun dynamic_invariant1 ((temp___expr_356 Int) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool)) Bool (=> (or (= temp___is_init_353 true) (<= 0 2147483647)) (in_range2 temp___expr_356)))
...
(define-fun dynamic_invariant3 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 2147483647)) (in_range5 temp___expr_362)))
