...
(assert (= temp___178 1))
(assert (or (and (<= (- 2147483648) temp___178) (<= temp___178 (- 1))) (and (<= 1 temp___178) (<= temp___178 2147483647))))
(assert (= o temp___178))
(assert (= result s))
(assert (= s1 o))
(assert (dynamic_invariant1 s1 true false true))
(assert (and (= us1 (- c 1)) (dynamic_property first last (- c 1))))
(assert (= temp___181 (- c 1)))
(assert (not (or (and (<= (- 2147483648) temp___181) (<= temp___181 (- 1))) (and (<= 1 temp___181) (<= temp___181 2147483647)))))
(check-sat)
(exit)
