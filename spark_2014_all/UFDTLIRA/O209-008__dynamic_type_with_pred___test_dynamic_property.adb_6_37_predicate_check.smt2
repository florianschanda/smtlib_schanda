...
(define-fun dynamic_invariant1 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (and (=> (or (= temp___is_init_196 true) (<= first last)) (dynamic_property first last temp___expr_200)) (=> (= temp___do_toplevel_198 true) (=> (= temp___is_init_196 true) (or (and (<= (- 2147483648) temp___expr_200) (<= temp___expr_200 (- 1))) (and (<= 1 temp___expr_200) (<= temp___expr_200 2147483647)))))))
(define-fun dynamic_predicate ((temp___204 Int)) Bool (or (and (<= (- 2147483648) temp___204) (<= temp___204 (- 1))) (and (<= 1 temp___204) (<= temp___204 2147483647))))
(assert (= first (- c)))
(assert (= last c))
...
(assert (= temp___207 1))
(assert (or (and (<= (- 2147483648) temp___207) (<= temp___207 (- 1))) (and (<= 1 temp___207) (<= temp___207 2147483647))))
(assert (= o temp___207))
(assert (= result s))
(assert (= s1 o))
(assert (dynamic_invariant1 s1 true false true true))
(assert (and (= us1 (- c 1)) (dynamic_property first last (- c 1))))
(assert (= temp___210 (- c 1)))
(assert (not (or (and (<= (- 2147483648) temp___210) (<= temp___210 (- 1))) (and (<= 1 temp___210) (<= temp___210 2147483647)))))
(check-sat)
(exit)
