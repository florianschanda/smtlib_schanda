...
(define-fun dynamic_invariant ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 1)) (in_range temp___expr_202)))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (rmaaadl_task2_job us_void_param) true false true) :pattern ((rmaaadl_task2_job us_void_param)))))
