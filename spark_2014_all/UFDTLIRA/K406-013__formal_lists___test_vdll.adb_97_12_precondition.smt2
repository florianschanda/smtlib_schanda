...
(assert (and (= o11 (next (mk___rep l1__split_discrs l1__split_fields4) o10)) (ite (= (ite (= (bool_eq1 o10 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o10) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq1 o11 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o11) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o11) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o10) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o11) true) (= (bool_eq1 o11 no_element) true))))
(check-sat)
(exit)
