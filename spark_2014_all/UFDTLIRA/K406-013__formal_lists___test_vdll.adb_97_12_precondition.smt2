...
(assert (and (= o8 (next (mk___rep l3__split_discrs l3__split_fields2) o7)) (ite (= (ite (= (bool_eq3 o7 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o7) (length (mk___rep l3__split_discrs l3__split_fields2))) true) true) (= (bool_eq3 o8 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o8) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o8) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o7) 1))))))
(assert (and (= o9 (next (mk___rep l1__split_discrs l1__split_fields4) o8)) (ite (= (ite (= (bool_eq3 o8 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o8) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq3 o9 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o9) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o9) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o8) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o9) true) (= (bool_eq3 o9 no_element) true))))
(check-sat)
(exit)
