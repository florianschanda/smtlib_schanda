...
(assert (and (= o55 (next (mk___rep l1__split_discrs l1__split_fields4) o54)) (ite (= (ite (= (bool_eq1 o54 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o54) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq1 o55 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o55) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o55) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o54) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o55) true) (= (bool_eq1 o55 no_element) true))))
(check-sat)
(exit)
