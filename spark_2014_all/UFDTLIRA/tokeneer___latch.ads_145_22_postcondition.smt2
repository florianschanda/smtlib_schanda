...
(define-fun dynamic_invariant ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 1901 2099)) (in_range temp___expr_380)))
(define-fun dynamic_invariant1 ((temp___expr_386 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= 1 12)) (in_range1 temp___expr_386)))
(define-fun dynamic_invariant2 ((temp___expr_392 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 1 31)) (in_range2 temp___expr_392)))
(define-fun dynamic_invariant3 ((temp___expr_416 Int) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool)) Bool (=> (or (= temp___is_init_413 true) (<= 0 86399999)) (in_range3 temp___expr_416)))
...
(assert (= (bool_eq (mk___rep (mk___split_fields latchtimeout__split_fields8 latchtimeout__split_fields9 latchtimeout__split_fields10 latchtimeout__split_fields11)) time) true))
(assert (not (= (bool_eq (latch_timeout (mk___split_fields latchtimeout__split_fields8 latchtimeout__split_fields9 latchtimeout__split_fields10 latchtimeout__split_fields11)) time) true)))
(check-sat)
(exit)
