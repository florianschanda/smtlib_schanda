...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (and (=> (or (= temp___is_init_154 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_158)) (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (and (<= low temp___expr_158) (<= temp___expr_158 high))))))
(define-fun dynamic_predicate ((temp___162 Int)) Bool (and (<= low temp___162) (<= temp___162 high)))
