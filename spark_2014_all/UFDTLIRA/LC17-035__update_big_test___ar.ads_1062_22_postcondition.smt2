...
(declare-const temp___7241 et3)
(declare-const temp___72411 et1)
(declare-const temp___72412 et2)
(declare-const temp___72413 enum1ta)
(declare-const temp___72414 et4)
(declare-const temp___72415 enum1t)
...
(declare-const temp___7245 us_rep3)
...
(assert (= o1 o7))
(assert (= temp___7241 o2))
(assert (= temp___72411 o3))
(assert (= temp___72412 o4))
(assert (= temp___72413 o5))
(assert (= temp___72414 o6))
(assert (= temp___72415 o7))
...
(assert (= r__split_fields6 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 temp___7241 (mk___rep (mk___split_fields temp___72411 temp___72412)) temp___72413)) temp___72414)) temp___72415)))
(assert (= (to_rep1 o8) temp1))
(assert (= o9 (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))) (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))) o8)))
(assert (= o10 (mk___rep1 o9)))
(assert (= o11 (mk___split_fields2 o10 (rec__ar__rec3t__g3 (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))))
(assert (= o12 (mk___rep2 o11)))
(assert (= o13 (mk___split_fields3 o12 (rec__ar__rec4t__g4 r__split_fields6))))
(assert (= temp___7245 (mk___rep3 o13)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7245)))
...
(assert (not (= (bool_eq3 (mk___rep3 (us_split_fields__content3 r__split_fields8)) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)) (of_rep1 (to_rep r__split_fields5)))) r__split_fields4)) (of_rep (to_rep1 r__split_fields3))))) true)))
(check-sat)
(exit)
