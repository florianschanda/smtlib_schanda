...
(declare-const temp___7182 et3)
(declare-const temp___71821 et1)
(declare-const temp___71822 et2)
(declare-const temp___71823 enum1ta)
(declare-const temp___71824 et4)
(declare-const temp___71825 enum1t)
...
(assert (= o1 o7))
(assert (= temp___7182 o2))
(assert (= temp___71821 o3))
(assert (= temp___71822 o4))
(assert (= temp___71823 o5))
(assert (= temp___71824 o6))
(assert (= temp___71825 o7))
...
(assert (= r__split_fields6 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 temp___7182 (mk___rep (mk___split_fields temp___71821 temp___71822)) temp___71823)) temp___71824)) temp___71825)))
...
(assert (= temp___7186 (mk___rep3 o13)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7186)))
