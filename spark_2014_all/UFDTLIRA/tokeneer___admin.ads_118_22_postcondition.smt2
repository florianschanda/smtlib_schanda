...
(declare-const temp___483 privileget)
(declare-const temp___4831 opandnullt)
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___483 o2))
(assert (= temp___4831 o3))
(assert (= result theadmin__split_fields))
(assert (= result1 theadmin__split_fields1))
(assert (= temp___483 theadmin__split_fields2))
(assert (= temp___4831 theadmin__split_fields3))
