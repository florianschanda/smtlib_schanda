...
(declare-const temp___527 privileget)
(declare-const temp___5271 opandnullt)
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___527 o2))
(assert (= temp___5271 o3))
(assert (= result theadmin__split_fields))
(assert (= result1 theadmin__split_fields1))
(assert (= temp___527 theadmin__split_fields2))
(assert (= temp___5271 theadmin__split_fields3))
