...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 a))) (to_rep (rec__cursors__l__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep2) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_228 us_rep2) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields3 temp___expr_228))) 0))
...
(assert (=> (= (bool_eq2 position no_element) true) (and (= o2 (length container)) (and (in_range1 o2) (<= o2 (to_rep (rec__cursors__l__list__capacity (us_split_discrs1 container))))))))
