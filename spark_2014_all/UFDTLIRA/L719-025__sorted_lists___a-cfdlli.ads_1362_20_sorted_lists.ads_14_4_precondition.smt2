...
(define-fun default_initial_assumption ((temp___expr_294 us_rep2) (temp___skip_top_level_295 Bool)) Bool (=> (not (= temp___skip_top_level_295 true)) (and (= (is_empty temp___expr_294) true) (= (length1 temp___expr_294) 0))))
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep1) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__sorted_lists__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_235 us_rep1) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__sorted_lists__my_lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__sorted_lists__my_lists__list__capacity (us_split_discrs1 container)))))))
