...
(define-fun dynamic_invariant ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 1 100)) (in_range1 temp___expr_221)))
...
(define-fun default_initial_assumption ((temp___expr_288 us_rep1) (temp___skip_top_level_289 Bool)) Bool (=> (not (= temp___skip_top_level_289 true)) (= (length temp___expr_288) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 101)) (in_range3 temp___expr_242)))
(define-fun dynamic_invariant2 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 100)) (in_range2 temp___expr_249)))
...
(assert (forall ((source us_rep)) (forall ((capacity Int)) (! (=> (and (dynamic_invariant2 capacity true true true true) (=> (= (distinct 1 0) true) (or (= capacity 0) (<= (length1 source) capacity)))) (let ((result (copy source capacity))) (and (= (oeq (model__ result) (model__ source)) true) (ite (= capacity 0) (= (to_rep (rec__p__my_vectors__vector__capacity (us_split_discrs1 result))) (length1 source)) (= (to_rep (rec__p__my_vectors__vector__capacity (us_split_discrs1 result))) capacity))))) :pattern ((copy source capacity))))))
...
(define-fun dynamic_invariant3 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 100)) (in_range4 temp___expr_228)))
...
(define-fun dynamic_invariant4 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 1 100)) (in_range5 temp___expr_235)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__p__my_vectors__vector__capacity (us_split_discrs1 container))) 100))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant2 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= (+ 0 result) 100) (dynamic_invariant5 result true false true true))) :pattern ((length container)))))
