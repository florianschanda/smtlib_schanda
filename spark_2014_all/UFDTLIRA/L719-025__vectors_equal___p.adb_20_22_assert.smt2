...
(define-fun p__identity_swap__l_in__assume2 () us_rep (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)))
(assert (in_range1 i1))
(assert (in_range1 i2))
...
(assert (and (= p__identity_swap__l_in__assume2 (copy (mk___rep l__split_discrs (mk___split_fields l__split_fields)) 0)) (and (= (oeq (model__ p__identity_swap__l_in__assume2) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) (= (to_rep p__identity_swap__l_in__assume) (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (= p__identity_swap__l_in__assume2 l_in))
(assert (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs l__split_fields2)) i1 i2) true))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i1) (get (model__ l_in) i2))))
(check-sat)
(exit)
