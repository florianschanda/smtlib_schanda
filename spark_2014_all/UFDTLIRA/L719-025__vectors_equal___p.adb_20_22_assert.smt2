...
(define-fun dynamic_invariant ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 1 100)) (in_range1 temp___expr_189)))
...
(define-fun default_initial_assumption ((temp___expr_247 us_rep1) (temp___skip_top_level_248 Bool)) Bool (=> (not (= temp___skip_top_level_248 true)) (= (length temp___expr_247) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 101)) (in_range3 temp___expr_207)))
(define-fun dynamic_invariant2 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 100)) (in_range2 temp___expr_213)))
...
(assert (forall ((source us_rep)) (forall ((capacity Int)) (! (=> (and (dynamic_invariant2 capacity true true true) (=> (= (of_int 1) true) (or (= capacity 0) (<= (length1 source) capacity)))) (let ((result (copy source capacity))) (and (= (oeq (model__ result) (model__ source)) true) (ite (= capacity 0) (= (to_rep (rec__p__my_vectors__vector__capacity (us_split_discrs1 result))) (length1 source)) (= (to_rep (rec__p__my_vectors__vector__capacity (us_split_discrs1 result))) capacity))))) :pattern ((copy source capacity))))))
...
(define-fun dynamic_invariant3 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 1 100)) (in_range4 temp___expr_195)))
...
(define-fun dynamic_invariant4 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 1 100)) (in_range5 temp___expr_201)))
(define-fun equal_except__2 ((left us_rep1) (right us_rep1) (x Int) (y Int)) Bool (and (= (length left) (length right)) (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (last left))) (=> (and (not (= i x)) (not (= i y))) (= (get left i) (get right i))))) true false)))
(declare-fun equal_except__2__function_guard (Bool us_rep1 us_rep1 Int Int) Bool)
(define-fun m_elements_swapped ((left us_rep1) (right us_rep1) (x Int) (y Int)) Bool (and (and (and (= (length left) (length right)) (= (get left x) (get right y))) (= (get left y) (get right x))) (equal_except__2 left right x y)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant2 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 100)) (in_range7 temp___expr_240)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= (+ 0 result) 100) (dynamic_invariant5 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 1 100)) (in_range8 temp___expr_234)))
...
(declare-const p__identity_swap__l_in__assume capacity_range)
...
(assert (in_range1 i1))
(assert (in_range1 i2))
(assert (and (and (and (<= 1 i1) (<= i1 (last (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))) (<= 1 i2)) (<= i2 (last (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (and (= (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)) (copy (mk___rep l__split_discrs (mk___split_fields l__split_fields)) 0)) (and (= (oeq (model__ (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) (= (to_rep p__identity_swap__l_in__assume) (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(assert (= (mk___rep (mk___split_discrs p__identity_swap__l_in__assume) (mk___split_fields p__identity_swap__l_in__assume1)) l_in))
(assert (= (m_elements_swapped (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) i1 i2) true))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) i1) (get (model__ l_in) i2))))
(check-sat)
(exit)
