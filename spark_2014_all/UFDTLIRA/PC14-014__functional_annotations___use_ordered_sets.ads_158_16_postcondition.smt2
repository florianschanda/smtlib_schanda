...
(define-fun dynamic_invariant2 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_289)))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container)))) (dynamic_invariant3 result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant3 result true false true)))) :pattern ((find container item))))))
...
(assert true)
(assert (forall ((container us_rep2)) (! (dynamic_invariant3 (length2 container) true false true) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range3 temp___expr_352)))
(assert (forall ((container us_rep3)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant4 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant5 (get container position) true false true)) :pattern ((get container position))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant3 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep4)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (forall ((cu1 us_rep1)) (=> (= (has_key (positions s) cu1) true) (= (q (element s cu1)) true))))
(assert (let ((temp___399 (elements s))) (forall ((temp___398 Int)) (=> (and (in_range3 temp___398) (= (iter_has_element temp___399 temp___398) true)) (exists ((i us_rep1)) (and (= (has_key (positions s) i) true) (= (get (elements s) (get1 (positions s) i)) (get temp___399 temp___398))))))))
(declare-const e1 Int)
(assert (in_range2 e1))
(assert (= (contains (model__ s) e1) true))
(assert (not (= (q e1) true)))
(check-sat)
(exit)
