...
(define-fun indefinite_unbounded__vect__append__2__container__fields3 () us_split_fields (mk___split_fields indefinite_unbounded__vect__append__2__container__fields1))
(define-fun v__split_fields10 () us_split_fields (mk___split_fields v__split_fields2))
(define-fun indefinite_unbounded__vect__append__2__container__fields4 () us_split_fields (mk___split_fields indefinite_unbounded__vect__append__2__container__fields))
(define-fun v__split_fields11 () us_split_fields (mk___split_fields v__split_fields1))
(define-fun indefinite_unbounded__vect__clear__container__fields1 () us_split_fields (mk___split_fields indefinite_unbounded__vect__clear__container__fields))
(define-fun o2 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
(define-fun indefinite_unbounded__test__B_1__w__assume2 () us_rep (mk___rep (mk___split_discrs indefinite_unbounded__test__B_1__w__assume) (mk___split_fields indefinite_unbounded__test__B_1__w__assume1)))
...
(assert (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__clear__container__fields1)) 0))
(assert (= result v__split_fields))
(assert (= v__split_fields11 indefinite_unbounded__vect__clear__container__fields1))
(assert (= (is_empty (mk___rep v__split_discrs v__split_fields11)) true))
(assert (= (oeq (mk___rep v__split_discrs v__split_fields11) (empty_vector Tuple0)) true))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields4)) (+ (length (mk___rep v__split_discrs v__split_fields11)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields11)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields4))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields4)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields11))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= v__split_fields10 indefinite_unbounded__vect__append__2__container__fields4))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields3)) (+ (length (mk___rep v__split_discrs v__split_fields10)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields10)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields3))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields3)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields10))) 1)) 2)))
(assert (= result2 v__split_fields2))
(assert (= v__split_fields3 indefinite_unbounded__vect__append__2__container__fields3))
...
(assert (and (= indefinite_unbounded__test__B_1__w__assume2 (copy (mk___rep v__split_discrs v__split_fields5) 0)) (and (= (oeq1 (model__ indefinite_unbounded__test__B_1__w__assume2) (model__ (mk___rep v__split_discrs v__split_fields5))) true) (= (to_rep indefinite_unbounded__test__B_1__w__assume) (length (mk___rep v__split_discrs v__split_fields5))))))
