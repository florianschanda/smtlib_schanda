...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__indefinite_unbounded__vect__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun in_range5 ((rec__indefinite_unbounded__vect__vector__capacity1 Int) (a us_rep)) Bool (= rec__indefinite_unbounded__vect__vector__capacity1 (to_rep (rec__indefinite_unbounded__vect__vector__capacity (us_split_discrs1 a)))))
...
(declare-const indefinite_unbounded__vect__vector__capacity__first__bit1 Int)
(declare-const indefinite_unbounded__vect__vector__capacity__last__bit1 Int)
(declare-const indefinite_unbounded__vect__vector__capacity__position1 Int)
(assert (<= 0 indefinite_unbounded__vect__vector__capacity__first__bit1))
(assert (< indefinite_unbounded__vect__vector__capacity__first__bit1 indefinite_unbounded__vect__vector__capacity__last__bit1))
...
(define-fun default_initial_assumption ((temp___expr_335 us_rep) (temp___skip_top_level_336 Bool)) Bool (and (= (to_rep (rec__indefinite_unbounded__vect__vector__capacity (us_split_discrs1 temp___expr_335))) 2) (=> (not (= temp___skip_top_level_336 true)) (= (is_empty temp___expr_335) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 2147483647)) (in_range7 temp___expr_177)))
...
(declare-const indefinite_unbounded__test__B_1__w__assume capacity_range)
(declare-const indefinite_unbounded__test__B_1__w__assume1 us_main_type)
...
(declare-const indefinite_unbounded__vect__clear__container__fields us_main_type)
(declare-const result us_main_type)
(declare-const v__split_fields1 us_main_type)
(declare-const indefinite_unbounded__vect__append__2__container__fields us_main_type)
(declare-const result1 us_main_type)
(declare-const v__split_fields2 us_main_type)
(declare-const indefinite_unbounded__vect__append__2__container__fields1 us_main_type)
(declare-const result2 us_main_type)
(declare-const v__split_fields3 us_split_fields)
(declare-const indefinite_unbounded__vect__append__2__container__fields2 us_split_fields)
(declare-const result3 us_split_fields__ref)
(declare-const v__split_fields4 us_split_fields)
(declare-const indefinite_unbounded__vect__reserve_capacity__container__fields us_split_fields)
...
(declare-const indefinite_unbounded__vect__replace_element__container__fields us_split_fields)
(declare-const result6 us_split_fields__ref)
(declare-const v__split_fields6 us_split_fields)
(declare-const indefinite_unbounded__vect__swap__container__fields us_split_fields)
(declare-const result7 us_split_fields__ref)
(declare-const v__split_fields7 us_split_fields)
(declare-const indefinite_unbounded__vect__delete_last__container__fields us_split_fields)
(declare-const result8 us_split_fields__ref)
(declare-const v__split_fields8 us_split_fields)
(declare-const indefinite_unbounded__vect__reverse_elements__container__fields us_split_fields)
(declare-const result9 us_split_fields__ref)
(declare-const v__split_fields9 us_split_fields)
(declare-const indefinite_unbounded__sort__sort__container__fields us_split_fields)
(declare-const result10 us_split_fields__ref)
(declare-const v__split_fields10 us_split_fields)
(declare-const indefinite_unbounded__vect__replace_element__container__fields1 us_split_fields)
...
(assert (= 2 (to_rep (rec__indefinite_unbounded__vect__vector__capacity v__split_discrs))))
(assert (= (length (mk___rep v__split_discrs (mk___split_fields indefinite_unbounded__vect__clear__container__fields))) 0))
(assert (= result v__split_fields))
(assert (= (mk___split_fields v__split_fields1) (mk___split_fields indefinite_unbounded__vect__clear__container__fields)))
...
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields indefinite_unbounded__vect__append__2__container__fields))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_unbounded__vect__append__2__container__fields)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_unbounded__vect__append__2__container__fields))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1)))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= (mk___split_fields v__split_fields2) (mk___split_fields indefinite_unbounded__vect__append__2__container__fields)))
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields indefinite_unbounded__vect__append__2__container__fields1))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_unbounded__vect__append__2__container__fields1)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_unbounded__vect__append__2__container__fields1))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))) 1)) 2)))
(assert (= result2 v__split_fields2))
(assert (= v__split_fields3 (mk___split_fields indefinite_unbounded__vect__append__2__container__fields1)))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields2)) (+ (length (mk___rep v__split_discrs v__split_fields3)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields3)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields2))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields2)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields3))) 1)) 3)))
(assert (= result3 (mk___split_fields__ref v__split_fields3)))
(assert (= v__split_fields4 indefinite_unbounded__vect__append__2__container__fields2))
...
(assert (= (oeq1 (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__reserve_capacity__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields4))) true))
(assert (= result4 (mk___split_fields__ref v__split_fields4)))
(assert (= v__split_fields5 indefinite_unbounded__vect__reserve_capacity__container__fields))
...
(assert (and (= (mk___rep (mk___split_discrs indefinite_unbounded__test__B_1__w__assume) (mk___split_fields indefinite_unbounded__test__B_1__w__assume1)) (copy (mk___rep v__split_discrs v__split_fields5) 0)) (and (= (oeq1 (model__ (mk___rep (mk___split_discrs indefinite_unbounded__test__B_1__w__assume) (mk___split_fields indefinite_unbounded__test__B_1__w__assume1))) (model__ (mk___rep v__split_discrs v__split_fields5))) true) (= (to_rep indefinite_unbounded__test__B_1__w__assume) (length (mk___rep v__split_discrs v__split_fields5))))))
(assert (= result5 (mk___split_fields__ref (mk___split_fields w__split_fields))))
(assert (= w__split_fields1 (mk___split_fields indefinite_unbounded__test__B_1__w__assume1)))
(assert (= w__split_discrs (mk___split_discrs indefinite_unbounded__test__B_1__w__assume)))
...
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__replace_element__container__fields)) (length (mk___rep v__split_discrs v__split_fields5))) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__replace_element__container__fields)) 2) 4)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields5)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__replace_element__container__fields)) 2) true)))
(assert (= result6 (mk___split_fields__ref v__split_fields5)))
(assert (= v__split_fields6 indefinite_unbounded__vect__replace_element__container__fields))
...
(assert (= (m_elements_swapped (model__ (mk___rep v__split_discrs v__split_fields6)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__swap__container__fields)) 1 3) true))
(assert (= result7 (mk___split_fields__ref v__split_fields6)))
(assert (= v__split_fields7 indefinite_unbounded__vect__swap__container__fields))
...
(assert (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__delete_last__container__fields)) (- (length (mk___rep v__split_discrs v__split_fields7)) 1)) (= (olt (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__delete_last__container__fields)) (model__ (mk___rep v__split_discrs v__split_fields7))) true)))
(assert (= result8 (mk___split_fields__ref v__split_fields7)))
(assert (= v__split_fields8 indefinite_unbounded__vect__delete_last__container__fields))
...
(assert (= (m_elements_reversed (model__ (mk___rep v__split_discrs v__split_fields8)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__reverse_elements__container__fields))) true))
(assert (= result9 (mk___split_fields__ref v__split_fields8)))
(assert (= v__split_fields9 indefinite_unbounded__vect__reverse_elements__container__fields))
...
(assert (not (= (contains1 (mk___rep v__split_discrs v__split_fields9) 4) true)))
(check-sat)
(exit)
