...
(assert (= v__split_fields6 unbounded__vect__clear__container__fields1))
...
(assert (not (<= 10 (to_rep (rec__unbounded__vect__vector__capacity v__split_discrs)))))
(check-sat)
(exit)
