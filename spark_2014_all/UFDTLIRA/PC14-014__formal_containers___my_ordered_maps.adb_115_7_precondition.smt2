...
(assert (not (or (< (length (mk___rep1 l__split_discrs l__split_fields2)) (to_rep1 (rec__my_ordered_maps__n__map__capacity l__split_discrs))) (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields2)) o23) true))))
(check-sat)
(exit)
