...
(assert (not (= (bool_eq (rec__ar__rec2t__g2 (us_split_fields__content1 r__split_fields9)) (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 a))))) true)))
(check-sat)
(exit)
