...
(define-fun dynamic_invariant2 ((temp___expr_381 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 1 2147483647)) (in_range4 temp___expr_381)))
...
(declare-const temp___1719 count_type)
