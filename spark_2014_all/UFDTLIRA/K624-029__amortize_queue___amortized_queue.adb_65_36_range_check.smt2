...
(define-fun dynamic_invariant ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 1001)) (in_range3 temp___expr_207)))
...
(define-fun dynamic_invariant1 ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 1000)) (in_range4 temp___expr_213)))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_201)))
...
(define-fun dynamic_invariant3 ((temp___expr_351 us_rep) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool (=> (not (= temp___skip_constant_349 true)) (in_range6 1000 temp___expr_351)))
(define-fun default_initial_assumption ((temp___expr_353 us_rep) (temp___skip_top_level_354 Bool)) Bool (and (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 temp___expr_353))) 1000) (=> (not (= temp___skip_top_level_354 true)) (= (is_empty temp___expr_353) true))))
...
(define-fun dynamic_invariant5 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range7 temp___expr_141)))
...
(define-fun dynamic_invariant6 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 1 1000)) (in_range2 temp___expr_195)))
...
(define-fun dynamic_invariant7 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 1000)) (in_range8 temp___expr_240)))
...
(define-fun dynamic_invariant8 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range9 temp___expr_234)))
...
(declare-const temp___559 capacity_range)
(declare-const temp___5591 us_main_type)
(declare-const o Int)
...
(declare-const front__split_fields4 us_main_type)
(declare-const front__split_fields5 us_split_fields__ref)
(declare-const idx4 int__ref)
(declare-const front__split_fields6 us_split_fields)
(declare-const idx5 Int)
(declare-const front__split_fields7 us_split_fields__ref)
(declare-const idx6 int__ref)
(declare-const front__split_fields8 us_split_fields)
...
(declare-const front__split_fields9 us_split_fields__ref)
(declare-const rear__split_fields2 us_split_fields__ref)
(declare-const idx8 int__ref)
(declare-const front__split_fields10 us_split_fields)
...
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (and (= front__split_discrs (mk___split_discrs temp___559)) (= front__split_fields temp___5591))))
...
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (and (and (= (length (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (length (mk___rep front__split_discrs (mk___split_fields front__split_fields))) 1)) (= (olt (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields))) (model__ (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))) true)) (= (get (model__ (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields)))) 1)) o1))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields front__split_fields)))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= (mk___split_fields front__split_fields2) (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= (length (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) (+ (- (+ (length ofront) (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) idx2) 1))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (last (model__ ofront)))) (= (get (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) i4) (get (model__ ofront) i4))))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (forall ((i4 Int)) (=> (and (<= idx2 i4) (<= i4 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields)))))) (= (get (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) (- (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3)))) idx2) i4)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i4))))))
...
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= idx4 (mk_int__ref idx2))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= front__split_fields5 (mk___split_fields__ref (mk___split_fields front__split_fields3)))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= idx5 idx2)))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= front__split_fields6 (mk___split_fields front__split_fields3))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= idx6 idx4)))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= front__split_fields7 front__split_fields5)))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= idx7 idx5)))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= front__split_fields8 front__split_fields6)))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r51b))) (= idx6 (mk_int__ref idx1))))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r51b))) (= front__split_fields7 (mk___split_fields__ref (mk___split_fields front__split_fields)))))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r51b))) (= idx7 idx1)))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r51b))) (= front__split_fields8 (mk___split_fields front__split_fields1))))
(assert (= (length (mk___rep rear__split_discrs amortized_queue__my_vectors__clear__container__fields)) 0))
(assert (= result6 (mk___split_fields__ref (mk___split_fields rear__split_fields))))
...
(assert (= front__split_fields10 front__split_fields8))
(assert (and (= o37 (length orear)) (and (in_range4 o37) (<= o37 (capacity orear)))))
(assert (and (= o38 (length ofront)) (and (in_range4 o38) (<= o38 (capacity ofront)))))
(assert (= o39 (+ o38 o37)))
(assert (and (= o40 (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields9)))) (and (in_range4 o40) (<= o40 (capacity (mk___rep front__split_discrs (us_split_fields__content front__split_fields9)))))))
(assert (= result7 (ite (= o40 o39) true false)))
(assert (= result7 true))
(assert (and (= o36 (length (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))) (and (in_range4 o36) (<= o36 (capacity (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))))))
(assert (= result8 (ite (= o36 0) true false)))
(assert (= result8 true))
(assert (and (= o30 (last (model__ ofront))) (and (in_range3 o30) (= o30 (last (model__ ofront))))))
(assert (= o31 (ite (<= i3 o30) true false)))
(assert (= result10 (ite (<= 1 i3) o31 false)))
(assert (= result10 true))
(assert (and (= o33 i3) (in_range2 i3)))
(assert (and (= o34 (get (model__ ofront) o33)) (and (in_range5 o34) (= o34 (get (model__ ofront) o33)))))
(assert (not (in_range2 i3)))
(check-sat)
(exit)
