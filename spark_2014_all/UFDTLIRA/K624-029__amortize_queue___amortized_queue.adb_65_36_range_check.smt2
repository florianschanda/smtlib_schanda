...
(declare-const temp___607 capacity_range)
(declare-const temp___6071 us_main_type)
(declare-const o Int)
...
(assert (= idx1 r51b))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (= temp___608 idx1)))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (and (= front__split_discrs (mk___split_discrs temp___607)) (= front__split_fields temp___6071))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (and (= o idx1) (in_range5 idx1))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (and (= o1 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o)) (and (in_range4 o1) (= o1 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o))))))
...
(assert (and (= o7 (length orear)) (and (in_range2 o7) (<= o7 (capacity orear)))))
(assert (and (= o8 (length ofront)) (and (in_range2 o8) (<= o8 (capacity ofront)))))
(assert (= o9 (+ o8 o7)))
(assert (and (= o10 (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))) (and (in_range2 o10) (<= o10 (capacity (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))))))
(assert (= result3 (ite (= o10 o9) true false)))
(assert (= result3 true))
(assert (and (= o6 (length (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))) (and (in_range2 o6) (<= o6 (capacity (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))))))
...
(assert (= result5 true))
(assert (and (= o4 i) (in_range5 i)))
(assert (and (= o5 (get (model__ ofront) o4)) (and (in_range4 o5) (= o5 (get (model__ ofront) o4)))))
(assert (not (in_range5 i)))
(check-sat)
(exit)
