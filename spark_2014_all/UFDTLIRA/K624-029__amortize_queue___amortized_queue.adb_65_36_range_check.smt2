...
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (last (model__ ofront)))) (= (get (model__ (mk___rep front__split_discrs front__split_fields10)) i1) (get (model__ ofront) i1))))))
(assert (=> (and (<= 1 idx1) (<= idx1 r51b)) (forall ((i1 Int)) (=> (and (<= idx2 i1) (<= i1 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields)))))) (= (get (model__ (mk___rep front__split_discrs front__split_fields10)) (- (+ (last (model__ (mk___rep front__split_discrs front__split_fields10))) idx2) i1)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i1))))))
...
(assert (= result4 true))
(assert (and (= o2 (last (model__ ofront))) (and (in_range3 o2) (= o2 (last (model__ ofront))))))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result5 (ite (<= 1 i) o3 false)))
(assert (= result5 true))
(assert (and (= o4 i) (in_range2 i)))
(assert (and (= o5 (get (model__ ofront) o4)) (and (in_range5 o5) (= o5 (get (model__ ofront) o4)))))
