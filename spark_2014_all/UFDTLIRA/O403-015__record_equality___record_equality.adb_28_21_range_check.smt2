...
(define-fun dynamic_invariant ((temp___expr_213 us_rep) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (not (= temp___skip_constant_211 true)) (in_range2 0 temp___expr_213)))
(define-fun default_initial_assumption ((temp___expr_215 us_rep) (temp___skip_top_level_216 Bool)) Bool (and (= (attr__tag temp___expr_215) us_tag1) (and (= (to_rep (rec__record_equality__root__c (us_split_discrs1 temp___expr_215))) 0) (= (to_rep (rec__record_equality__root__f1 (us_split_fields1 temp___expr_215))) 0))))
...
(define-fun dynamic_invariant1 ((temp___expr_221 us_rep1) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (in_range3 0 (to_base temp___expr_221))))
(define-fun default_initial_assumption1 ((temp___expr_223 us_rep1) (temp___skip_top_level_224 Bool)) Bool (and (= (attr__tag1 temp___expr_223) us_tag2) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_223))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_223))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_223))) 0))))
