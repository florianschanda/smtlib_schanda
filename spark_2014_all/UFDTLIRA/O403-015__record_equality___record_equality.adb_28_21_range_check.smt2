...
(define-fun tr_pu1S__ref___2__projection ((a tr_pu1S__ref)) us_rep (tr_pu1S__content a))
(define-fun dynamic_invariant ((temp___expr_236 us_rep) (temp___is_init_232 Bool) (temp___skip_constant_233 Bool) (temp___do_toplevel_234 Bool) (temp___do_typ_inv_235 Bool)) Bool (=> (not (= temp___skip_constant_233 true)) (in_range2 0 temp___expr_236)))
(define-fun default_initial_assumption ((temp___expr_238 us_rep) (temp___skip_top_level_239 Bool)) Bool (and (= (attr__tag temp___expr_238) us_tag1) (and (= (to_rep (rec__record_equality__root__c (us_split_discrs1 temp___expr_238))) 0) (= (to_rep (rec__record_equality__root__f1 (us_split_fields1 temp___expr_238))) 0))))
...
(define-fun tc_pu1S__ref___3__projection ((a tc_pu1S__ref)) us_rep1 (tc_pu1S__content a))
(define-fun dynamic_invariant1 ((temp___expr_245 us_rep1) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (not (= temp___skip_constant_242 true)) (in_range3 0 (to_base temp___expr_245))))
(define-fun default_initial_assumption1 ((temp___expr_247 us_rep1) (temp___skip_top_level_248 Bool)) Bool (and (= (attr__tag1 temp___expr_247) us_tag2) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_247))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_247))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_247))) 0))))
