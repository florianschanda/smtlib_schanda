...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields rliteral (rec__ar__rec1t__g1 (us_split_fields1 s))))) true)))
(check-sat)
(exit)
