...
(declare-const temp___6624 et1)
(declare-const temp___66241 et2)
...
(assert (= temp___6624 o1))
(assert (= temp___66241 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___6624 r__split_fields4))
(assert (= temp___66241 r__split_fields5))
