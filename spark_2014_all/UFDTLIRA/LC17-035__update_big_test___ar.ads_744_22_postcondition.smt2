...
(declare-const temp___6683 et1)
(declare-const temp___66831 et2)
...
(assert (= temp___6683 o1))
(assert (= temp___66831 o2))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___6683 r__split_fields4))
(assert (= temp___66831 r__split_fields5))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (of_rep 25) (rec__ar__rec1t__g1 (us_split_fields1 s))))) true)))
(check-sat)
(exit)
