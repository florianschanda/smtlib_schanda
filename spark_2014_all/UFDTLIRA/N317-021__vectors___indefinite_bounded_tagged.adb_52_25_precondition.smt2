...
(assert (and (and (= (length (mk___rep1 v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields2)) (+ (length (mk___rep1 v__split_discrs v__split_fields3)) 1)) (= (olt (model__ (mk___rep1 v__split_discrs v__split_fields3)) (model__ (mk___rep1 v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields2))) true)) (= (let ((temp___410 (get (model__ (mk___rep1 v__split_discrs indefinite_bounded_tagged__vect__append__2__container__fields2)) (+ (last (model__ (mk___rep1 v__split_discrs v__split_fields3))) 1)))) (ite (= (attr__tag temp___410) o8) (us_dispatch_eq temp___410 o9) false)) true)))
