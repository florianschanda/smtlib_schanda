...
(define-fun default_initial_assumption ((temp___expr_202 us_rep) (temp___skip_top_level_203 Bool)) Bool (=> (not (= temp___skip_top_level_203 true)) (= (is_empty temp___expr_202) true)))
...
(assert true)
(assert (forall ((a Int) (b Int)) (! (= (= (my_equal_02 a b) true) (= a b)) :pattern ((my_equal_02 a b)))))
...
(define-fun dynamic_invariant2 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_194)))
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= (my_equal_02 e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
