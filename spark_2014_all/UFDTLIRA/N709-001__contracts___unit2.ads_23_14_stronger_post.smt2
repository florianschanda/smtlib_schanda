...
(define-fun default_initial_assumption ((temp___expr_181 us_rep1) (temp___skip_top_level_182 Bool)) Bool (= (attr__tag1 temp___expr_181) us_tag1))
...
(assert (forall ((x us_rep1)) (! (= (= (is_max x) true) (or (= (is_max2 (to_base x)) true) (= (to_rep (rec__unit2__t2__c2 (us_split_fields3 x))) 2147483647))) :pattern ((is_max x)))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (ite (is_max (of_base x)) 1 0) (ite (is_max3 us_tag1 x) 1 0)) :pattern ((is_max3 us_tag1 x)))))
(assert (forall ((x us_rep)) (! (= (ite (is_max2 x) 1 0) (ite (is_max3 us_tag x) 1 0)) :pattern ((is_max3 us_tag x)))))
(assert (forall ((x us_rep)) (! (= (= (is_max2 x) true) (= (to_rep (rec__unit1__t1__c1 (us_split_fields1 x))) 2147483647)) :pattern ((is_max2 x)))))
...
(assert (not (= (is_max (mk___rep1 (mk___split_fields1 x__split_fields x__split_fields1 x__split_fields2) x__attr__tag)) true)))
(assert (and (= (to_rep x__split_fields4) (+ (to_rep x__split_fields1) 1)) (= (to_rep x__split_fields3) (+ (to_rep x__split_fields) 1))))
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 x__split_fields3 x__split_fields4 x__split_fields5) x__attr__tag) (next (mk___rep1 (mk___split_fields1 x__split_fields x__split_fields1 x__split_fields2) x__attr__tag))) true)))
(check-sat)
(exit)
