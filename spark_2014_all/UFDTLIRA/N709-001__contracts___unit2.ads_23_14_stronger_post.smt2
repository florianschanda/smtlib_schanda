...
(define-fun default_initial_assumption ((temp___expr_156 us_rep1) (temp___skip_top_level_157 Bool)) Bool (= (attr__tag1 temp___expr_156) us_tag1))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (! (= (to_int1 (is_max (of_base x))) (to_int1 (is_max3 us_tag1 x))) :pattern ((is_max3 us_tag1 x)))))
(assert (forall ((x us_rep)) (! (= (to_int1 (is_max2 x)) (to_int1 (is_max3 us_tag x))) :pattern ((is_max3 us_tag x)))))
