...
(assert (forall ((x us_rep1)) (forall ((n Int)) (! (=> (dynamic_invariant n true true true true) (= (bool_eq1 (update_a x n) (mk___rep1 (let ((usq_ (us_split_fields3 x))) (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists usq_) (let ((temp___279 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x)))) (mk___rep (let ((usq_1 (us_split_fields1 temp___279))) (mk___split_fields (of_rep n) (rec__records_prooffuncs__pair__b usq_1))))))))) true)) :pattern ((update_a x n))))))
...
(define-fun temp___4253 () us_rep1 (mk___rep1 (mk___split_fields1 temp___425 (mk___rep (mk___split_fields temp___4251 temp___4252)))))
(assert (and (= temp___4253 (update_a (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))) (to_rep x__split_fields2))) (= (bool_eq1 temp___4253 (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields (of_rep (to_rep x__split_fields2)) x__split_fields2))))) true)))
