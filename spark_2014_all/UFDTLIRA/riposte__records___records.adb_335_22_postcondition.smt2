...
(define-fun temp___3923 () us_rep1 (mk___rep1 (mk___split_fields1 temp___392 (mk___rep (mk___split_fields temp___3921 temp___3922)))))
(assert (and (= temp___3923 (update_a (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))) (to_rep x__split_fields2))) (= (bool_eq1 temp___3923 (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields (of_rep (to_rep x__split_fields2)) x__split_fields2))))) true)))
