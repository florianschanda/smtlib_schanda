...
(assert (forall ((x us_rep1)) (forall ((n Int)) (! (=> (dynamic_invariant n true true true) (= (bool_eq1 (update_a x n) (mk___rep1 (let ((usq_ (us_split_fields3 x))) (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists usq_) (let ((temp___246 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x)))) (mk___rep (let ((usq_1 (us_split_fields1 temp___246))) (mk___split_fields (of_rep n) (rec__records_prooffuncs__pair__b usq_1))))))))) true)) :pattern ((update_a x n))))))
...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___392 (mk___rep (mk___split_fields temp___3921 temp___3922)))) (update_a (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))) (to_rep x__split_fields2))) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___392 (mk___rep (mk___split_fields temp___3921 temp___3922)))) (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields (of_rep (to_rep x__split_fields2)) x__split_fields2))))) true)))
...
(assert (not (= (bool_eq1 (mk___rep1 (mk___split_fields1 x__split_fields6 (mk___rep (mk___split_fields x__split_fields7 x__split_fields8)))) (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields2 x__split_fields2))))) true)))
(check-sat)
(exit)
