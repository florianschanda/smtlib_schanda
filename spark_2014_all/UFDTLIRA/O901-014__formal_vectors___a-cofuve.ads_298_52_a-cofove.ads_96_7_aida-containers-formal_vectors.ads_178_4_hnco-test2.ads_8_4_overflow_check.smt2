...
(define-fun dynamic_invariant ((temp___expr_387 Int) (temp___is_init_384 Bool) (temp___skip_constant_385 Bool) (temp___do_toplevel_386 Bool)) Bool (=> (or (= temp___is_init_384 true) (<= 1 2147483647)) (in_range1 temp___expr_387)))
...
(define-fun dynamic_invariant1 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_393)))
