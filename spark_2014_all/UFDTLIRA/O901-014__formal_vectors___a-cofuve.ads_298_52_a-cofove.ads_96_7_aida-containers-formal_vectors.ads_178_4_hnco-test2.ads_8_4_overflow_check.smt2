...
(define-fun dynamic_invariant ((temp___expr_431 Int) (temp___is_init_427 Bool) (temp___skip_constant_428 Bool) (temp___do_toplevel_429 Bool) (temp___do_typ_inv_430 Bool)) Bool (=> (or (= temp___is_init_427 true) (<= 1 2147483647)) (in_range1 temp___expr_431)))
...
(define-fun dynamic_invariant1 ((temp___expr_438 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool) (temp___do_typ_inv_437 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_438)))
