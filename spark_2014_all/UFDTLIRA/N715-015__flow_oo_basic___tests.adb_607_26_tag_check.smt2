...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__tests__pair__a us_rep1) (rec__tests__pair__b us_rep2)))))
(define-fun us_split_fields_A__projection ((a us_split_fields6)) us_rep1 (rec__tests__pair__a a))
(define-fun us_split_fields_B__projection ((a us_split_fields6)) us_rep2 (rec__tests__pair__b a))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (bool_eq1 (rec__tests__pair__a (us_split_fields7 a)) (rec__tests__pair__a (us_split_fields7 b))) true) (= (bool_eq2 (rec__tests__pair__b (us_split_fields7 a)) (rec__tests__pair__b (us_split_fields7 b))) true)) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_198 us_rep3) (temp___skip_top_level_199 Bool)) Bool (and (= (attr__tag1 (rec__tests__pair__a (us_split_fields7 temp___expr_198))) us_tag1) (= (attr__tag2 (rec__tests__pair__b (us_split_fields7 temp___expr_198))) us_tag2)))
...
(define-fun default_initial_assumption3 ((temp___expr_138 us_rep) (temp___skip_top_level_139 Bool)) Bool (= (attr__tag temp___expr_138) us_tag))
(declare-const a__split_fields integer)
(declare-const a__split_fields1 integer)
(declare-const a__split_fields2 us_private)
(declare-const b__split_fields integer)
(declare-const b__split_fields1 integer)
(declare-const b__split_fields2 us_private)
(declare-const b__split_fields3 Int)
(declare-const b__split_fields4 Bool)
(declare-const b__split_fields5 integer)
(declare-const b__split_fields6 integer)
(declare-const b__split_fields7 us_private)
(declare-const b__split_fields8 Int)
(declare-const d__split_fields integer)
(declare-const d__split_fields1 integer)
(declare-const d__split_fields2 us_private)
(declare-const e__split_fields integer)
(declare-const e__split_fields1 integer)
(declare-const e__split_fields2 us_private)
(declare-const f__split_fields integer)
(declare-const f__split_fields1 integer)
(declare-const f__split_fields2 us_private)
(declare-const g__split_fields integer)
(declare-const g__split_fields1 integer)
(declare-const g__split_fields2 us_private)
(declare-const usq_ integer)
(declare-const usq_1 integer)
(declare-const usq_2 us_private)
(declare-const usq_3 Int)
(declare-const temp___451 integer)
(declare-const temp___4511 integer)
(declare-const temp___4512 us_private)
(declare-const temp___4513 Int)
(declare-const usq_4 us_rep1)
(declare-const temp___453 us_rep1)
(declare-const usq_5 us_rep1)
(declare-const temp___455 us_rep1)
(declare-const result us_split_fields__ref3)
(declare-const b__split_fields9 us_split_fields6)
(declare-const result1 us_split_fields__ref3)
(declare-const b__split_fields10 us_split_fields6)
(declare-const result2 us_split_fields__ref1)
(declare-const a__split_fields3 us_split_fields2)
...
(declare-const e__split_fields3 us_split_fields2)
...
(declare-const g__split_fields3 us_split_fields2)
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 (mk___rep1 (mk___split_fields1 b__split_fields b__split_fields1 b__split_fields2) b__split_fields3) (mk___rep2 (mk___split_fields2 b__split_fields4 b__split_fields5 b__split_fields6 b__split_fields7) b__split_fields8)))))
(assert (= b__split_fields9 (mk___split_fields3 (mk___rep1 (mk___split_fields1 a__split_fields a__split_fields1 a__split_fields2) b__split_fields3) (mk___rep2 (mk___split_fields2 b__split_fields4 b__split_fields5 b__split_fields6 b__split_fields7) b__split_fields8))))
(assert (= result1 (mk___split_fields__ref3 b__split_fields9)))
(assert (= b__split_fields10 (mk___split_fields3 (rec__tests__pair__a b__split_fields9) (mk___rep2 (us_split_fields5 (of_base1 (mk___rep (mk___split_fields (hide_ext__ a__split_fields a__split_fields1 a__split_fields2)) a__attr__tag))) (attr__tag2 (rec__tests__pair__b b__split_fields9))))))
(assert (= result2 (mk___split_fields__ref1 (mk___split_fields1 a__split_fields a__split_fields1 a__split_fields2))))
(assert (= a__split_fields3 (us_split_fields3 (rec__tests__pair__a (us_split_fields7 c)))))
(assert (= result3 (mk___split_fields__ref1 (mk___split_fields1 d__split_fields d__split_fields1 d__split_fields2))))
(assert (= d__split_fields3 (us_split_fields3 (rec__tests__pair__a (us_split_fields7 c)))))
(assert (= e__attr__tag (attr__tag1 (rec__tests__pair__a (us_split_fields7 c)))))
(assert (= (mk___rep1 (mk___split_fields1 usq_ usq_1 usq_2) usq_3) (rec__tests__pair__a (us_split_fields7 c))))
(assert (= usq_ temp___451))
(assert (= usq_1 temp___4511))
(assert (= usq_2 temp___4512))
(assert (= e__attr__tag temp___4513))
(assert (= result4 (mk___split_fields__ref1 (mk___split_fields1 e__split_fields e__split_fields1 e__split_fields2))))
(assert (= e__split_fields3 (mk___split_fields1 temp___451 temp___4511 temp___4512)))
(assert (not (= f__attr__tag a__attr__tag)))
(check-sat)
(exit)
