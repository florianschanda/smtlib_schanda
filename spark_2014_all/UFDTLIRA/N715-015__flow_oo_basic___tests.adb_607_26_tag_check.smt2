...
(define-fun default_initial_assumption2 ((temp___expr_210 us_rep3) (temp___skip_top_level_211 Bool)) Bool (and (= (attr__tag1 (rec__tests__pair__a (us_split_fields7 temp___expr_210))) us_tag1) (= (attr__tag2 (rec__tests__pair__b (us_split_fields7 temp___expr_210))) us_tag2)))
...
(define-fun default_initial_assumption3 ((temp___expr_161 us_rep) (temp___skip_top_level_162 Bool)) Bool (= (attr__tag temp___expr_161) us_tag))
...
(declare-const temp___487 integer)
(declare-const temp___4871 integer)
(declare-const temp___4872 us_private)
(declare-const temp___4873 Int)
...
(assert (= usq_ temp___487))
(assert (= usq_1 temp___4871))
(assert (= usq_2 temp___4872))
(assert (= e__attr__tag temp___4873))
(assert (= result4 (mk___split_fields__ref1 (mk___split_fields1 e__split_fields e__split_fields1 e__split_fields2))))
(assert (= e__split_fields3 (mk___split_fields1 temp___487 temp___4871 temp___4872)))
