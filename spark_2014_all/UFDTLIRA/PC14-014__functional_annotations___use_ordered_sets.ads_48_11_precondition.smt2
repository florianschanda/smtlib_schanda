...
(define-fun dynamic_invariant1 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_346)))
...
(define-fun dynamic_invariant3 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_289)))
(assert true)
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption2 ((temp___expr_328 us_rep2) (temp___skip_top_level_329 Bool)) Bool (=> (not (= temp___skip_top_level_329 true)) (= (is_empty1 temp___expr_328) true)))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_321)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(declare-const temp___730 us_rep1)
(declare-const temp___729 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const e Int)
(declare-const temp___734 us_rep1)
...
(declare-const temp___724 us_rep1)
...
(assert (and (= o7 (length s2)) (and (in_range2 o7) (<= o7 (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o5 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range2 o5) (<= o5 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o6 (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs)) o5)))
(assert (and (= o8 o6) (in_range1 o6)))
(assert (= o9 (ite (< o7 o8) true false)))
(assert (and (= temp___734 (elements s2)) (and (and (and (= (length2 temp___734) (length s2)) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element temp___734 temp___390) true)) (= (contains (model__ s2) (get temp___734 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s2) item) true)) (and (< 0 (find temp___734 item)) (= (equivalent_elements (get temp___734 (find temp___734 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (and (= (find temp___734 (get temp___734 i)) i) (= (e_is_find temp___734 (get temp___734 i) i) true)))))))
(assert (and (= o2 (iter_has_element temp___734 temp___733)) (= (= o2 true) (and (<= 1 temp___733) (<= temp___733 (last temp___734))))))
(assert (= (= o3 true) (in_range3 temp___733)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (= result true))
(assert (not (<= 1 temp___733)))
(check-sat)
(exit)
