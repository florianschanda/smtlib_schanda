...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__inst_ext_ax__ok_lists2__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields)) count_type (rec__inst_ext_ax__ok_lists2__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields1 a))) (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_463 Int) (temp___is_init_459 Bool) (temp___skip_constant_460 Bool) (temp___do_toplevel_461 Bool) (temp___do_typ_inv_462 Bool)) Bool (=> (or (= temp___is_init_459 true) (<= 1 2147483647)) (in_range2 temp___expr_463)))
...
(define-fun default_initial_assumption ((temp___expr_471 us_rep1) (temp___skip_top_level_472 Bool)) Bool (=> (not (= temp___skip_top_level_472 true)) (and (= (is_empty temp___expr_471) true) (= (length temp___expr_471) 0))))
(define-fun default_initial_assumption1 ((temp___expr_457 us_rep) (temp___skip_top_level_458 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields1 temp___expr_457))) 0))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__inst_ext_ax__ok_lists2__list us_main_type1)))))
(define-fun us_split_fields_List__2__projection ((a us_split_fields2)) us_main_type1 (rec__inst_ext_ax__ok_lists2__list a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 a))) (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__inst_ext_ax__ok_lists2__list (us_split_fields3 a)) (rec__inst_ext_ax__ok_lists2__list (us_split_fields3 b))) true)) true false))
...
(define-fun list__ref___2__projection ((a list__ref)) us_rep2 (list__content a))
...
(define-fun default_initial_assumption2 ((temp___expr_412 us_rep) (temp___skip_top_level_413 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields1 temp___expr_412))) 0))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
