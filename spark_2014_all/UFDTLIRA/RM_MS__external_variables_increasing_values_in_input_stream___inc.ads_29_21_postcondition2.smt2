...
(assert (= (is_increasing (mk___rep (us_split_fields__content result____split_fields16))) true))
(assert (not (< (first (mk___rep (us_split_fields__content result____split_fields16))) (second (mk___rep (us_split_fields__content result____split_fields16))))))
(check-sat)
(exit)
