...
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 last)) (dynamic_property 0 last temp___expr_147)))
(assert (= last c1))
(declare-const c2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant2 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 last1)) (dynamic_property1 0 last1 temp___expr_153)))
(assert (= last1 c2))
(declare-const a Int)
(declare-const b Int)
(declare-const o Int)
