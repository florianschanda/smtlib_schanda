...
(assert (and (= inrange__pt__add_out__i1 (+ inrange__pt__add_out__i y1)) (in_range inrange__pt__add_out__i1)))
(assert (= po result2))
(assert (= po1 us_self__compl1))
(assert (and (= o2 inrange__pt__add_out__i1) (in_range1 inrange__pt__add_out__i1)))
(assert (= result3 x1))
(assert (= x2 o2))
(assert (not (<= x2 10)))
(check-sat)
