...
(assert (forall ((x enum1t)) (! (in_range4 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant ((temp___expr_212 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 4)) (in_range5 temp___expr_212)))
...
(assert (forall ((x enum1ta)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x et1)) (! (in_range (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x et2)) (! (in_range1 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x et3)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x et3)) (! (in_range2 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x Int)) (! (=> (in_range2 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
...
(assert (forall ((x et4)) (! (in_range3 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_rep5 (of_rep5 x)) x)) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun dynamic_invariant2 ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 1 25)) (in_range1 temp___expr_182)))
...
(define-fun dynamic_invariant4 ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 50 59)) (in_range3 temp___expr_194)))
(define-fun dynamic_invariant5 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 6)) (in_range4 temp___expr_200)))
...
(declare-const temp___7282 us_rep3)
(declare-const o17 enum1t)
(declare-const o18 us_split_fields6)
(declare-const temp___7284 us_rep3)
...
(assert (not (in_range5 (to_rep r__split_fields5))))
(check-sat)
(exit)
