...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__variants__t__c (us_split_discrs1 a))) (to_rep (rec__variants__t__c (us_split_discrs1 b)))) (=> (variants__t__d__pred a) (= (to_rep1 (rec__variants__t__d (us_split_fields1 a))) (to_rep1 (rec__variants__t__d (us_split_fields1 b)))))) (=> (variants__t__e__pred a) (= (to_rep1 (rec__variants__t__e (us_split_fields1 a))) (to_rep1 (rec__variants__t__e (us_split_fields1 b)))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (attr__constrained temp___expr_143) false) (= (to_rep (rec__variants__t__c (us_split_discrs1 temp___expr_143))) 0)))
...
(define-fun dynamic_invariant ((temp___expr_151 us_rep) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (and (=> (not (= temp___skip_constant_149 true)) (in_range2 0 temp___expr_151)) (= (attr__constrained temp___expr_151) true)))
(define-fun default_initial_assumption1 ((temp___expr_153 us_rep) (temp___skip_top_level_154 Bool)) Bool (and (= (attr__constrained temp___expr_153) true) (= (to_rep (rec__variants__t__c (us_split_discrs1 temp___expr_153))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_161 us_rep) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (and (=> (not (= temp___skip_constant_159 true)) (in_range3 1 temp___expr_161)) (= (attr__constrained temp___expr_161) true)))
(define-fun default_initial_assumption2 ((temp___expr_163 us_rep) (temp___skip_top_level_164 Bool)) Bool (and (= (attr__constrained temp___expr_163) true) (= (to_rep (rec__variants__t__c (us_split_discrs1 temp___expr_163))) 1)))
...
(define-fun dynamic_invariant3 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1)) (in_range temp___expr_135)))
