...
(assert (forall ((x e)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__variants__t__c e)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) e (rec__variants__t__c a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__variants__t__d integer) (rec__variants__t__e integer)))))
(define-fun us_split_fields_D__projection ((a us_split_fields)) integer (rec__variants__t__d a))
(define-fun us_split_fields_E__projection ((a us_split_fields)) integer (rec__variants__t__e a))
...
(define-fun variants__t__d__pred ((a us_rep)) Bool (= (to_rep (rec__variants__t__c (us_split_discrs1 a))) 0))
(define-fun variants__t__e__pred ((a us_rep)) Bool (= (to_rep (rec__variants__t__c (us_split_discrs1 a))) 1))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__variants__t__c (us_split_discrs1 a))) (to_rep (rec__variants__t__c (us_split_discrs1 b)))) (and (=> (variants__t__d__pred a) (= (to_rep1 (rec__variants__t__d (us_split_fields1 a))) (to_rep1 (rec__variants__t__d (us_split_fields1 b))))) (=> (variants__t__e__pred a) (= (to_rep1 (rec__variants__t__e (us_split_fields1 a))) (to_rep1 (rec__variants__t__e (us_split_fields1 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep (rec__variants__t__c (us_split_discrs1 temp___expr_167))) 0)))
(define-fun in_range2 ((rec__variants__t__c1 Int) (a us_rep)) Bool (= rec__variants__t__c1 (to_rep (rec__variants__t__c (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant ((temp___expr_176 us_rep) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (and (=> (not (= temp___skip_constant_173 true)) (in_range2 0 temp___expr_176)) (= (attr__constrained temp___expr_176) true)))
(define-fun default_initial_assumption1 ((temp___expr_178 us_rep) (temp___skip_top_level_179 Bool)) Bool (and (= (attr__constrained temp___expr_178) true) (= (to_rep (rec__variants__t__c (us_split_discrs1 temp___expr_178))) 0)))
(define-fun in_range3 ((rec__variants__t__c1 Int) (a us_rep)) Bool (= rec__variants__t__c1 (to_rep (rec__variants__t__c (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant1 ((temp___expr_187 us_rep) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (and (=> (not (= temp___skip_constant_184 true)) (in_range3 1 temp___expr_187)) (= (attr__constrained temp___expr_187) true)))
(define-fun default_initial_assumption2 ((temp___expr_189 us_rep) (temp___skip_top_level_190 Bool)) Bool (and (= (attr__constrained temp___expr_189) true) (= (to_rep (rec__variants__t__c (us_split_discrs1 temp___expr_189))) 1)))
...
(define-fun dynamic_invariant3 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 0 1)) (in_range temp___expr_158)))
(declare-const us Int)
(assert (and (= 0 (to_rep (rec__variants__t__c y__split_discrs))) (= y__attr__constrained true)))
(assert (and (= 1 (to_rep (rec__variants__t__c z__split_discrs))) (= z__attr__constrained true)))
(assert (and (= us (to_rep (rec__variants__t__c (us_split_discrs1 x)))) (in_range (to_rep (rec__variants__t__c (us_split_discrs1 x))))))
(assert (not (= 1 (to_rep (rec__variants__t__c y__split_discrs)))))
(check-sat)
(exit)
