...
(declare-const temp___260 unsigned_byte)
(declare-const temp___2601 unsigned_byte)
...
(declare-const records__init_b__result8 pair__ref)
(declare-const r__split_fields5 us_split_fields)
(declare-const records__init_b__result9 us_rep)
...
(assert (= (mk___rep (mk___split_fields records__init_b__result6 records__init_b__result7)) (mk___rep (mk___split_fields records__init_b__result2 records__init_b__result3))))
...
(assert (= records__init_b__result8 (mk_pair__ref (mk___rep (mk___split_fields records__init_b__result4 records__init_b__result5)))))
(assert (= r__split_fields4 (mk___split_fields__ref (mk___split_fields r__split_fields2 r__split_fields3))))
(assert (= records__init_b__result9 (mk___rep (mk___split_fields records__init_b__result6 records__init_b__result7))))
(assert (= r__split_fields5 (mk___split_fields r__split_fields2 r__split_fields3)))
(assert (= (mk___rep (mk___split_fields result4 result5)) (pair__content records__init_b__result8)))
(assert (not (= (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 (pair__content records__init_b__result8)))) 0)))
(check-sat)
(exit)
