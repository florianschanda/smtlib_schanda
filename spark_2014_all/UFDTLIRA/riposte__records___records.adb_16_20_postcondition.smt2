...
(declare-const temp___293 unsigned_byte)
(declare-const temp___2931 unsigned_byte)
...
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___293 o2))
(assert (= temp___2931 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___293 r__split_fields2))
(assert (= temp___2931 r__split_fields3))
