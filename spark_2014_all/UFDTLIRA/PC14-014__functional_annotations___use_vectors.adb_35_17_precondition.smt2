...
(assert (and (= o7 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))))) (and (dynamic_property5 first4 last6 o7) (= o7 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))))))))
(assert (= o8 (ite (<= n1 o7) true false)))
(assert (= result3 (ite (<= i2 n1) o8 false)))
(assert (= result3 true))
(assert (and (= us3 n1) (dynamic_property1 first1 last1 n1)))
(assert (= o10 n1))
(assert (not (<= first1 o10)))
(check-sat)
(exit)
