...
(assert (= c1 1))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___264 c1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___261 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___266 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___265 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___260 tmp)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- c2 1))) (and (= (to_rep (get m2 5 i)) (to_rep (get temp___265 7 i))) (= (to_rep (get m2 7 i)) (to_rep (get temp___266 5 i))))))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (and (and (and (=> (<= 0 2147483647) (in_range2 tmp2)) (forall ((temp___262 Int) (temp___263 Int)) (=> (and (and (<= 1 temp___262) (<= temp___262 10)) (and (<= 1 temp___263) (<= temp___263 10))) (=> (and (or (<= c2 temp___263) (not (= 7 temp___262))) (or (<= c2 temp___263) (not (= 5 temp___262)))) (= (get m2 temp___262 temp___263) (get temp___261 temp___262 temp___263)))))) (=> (<= 1 10) (in_range5 c2))) (and (<= 1 c2) (<= c2 10)))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= tmp2 result2)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= tmp3 (to_rep (get m2 5 c2)))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= (to_rep o) (to_rep (get m2 7 c2)))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= o1 (set m2 5 c2 o))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= m2 result3)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= m3 o1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= (to_rep o2) tmp3)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= o3 (set m3 7 c2 o2))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= m3 result4)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= m4 o3)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= c2 10)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= c2 c3)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= tmp3 tmp4)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= m4 m5)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= c4 c2)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= tmp5 tmp3)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= m6 m4)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= (mk_int__ref c5) (mk_int__ref c3))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= tmp8 (mk_int__ref tmp4))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= (mk_map__ref m7) (mk_map__ref m5))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= c6 c4)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= tmp7 tmp5)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= m8 m6)))
(assert (=> (not (and (<= 1 c1) (<= c1 10))) (= c1 c5)))
(assert (=> (not (and (<= 1 c1) (<= c1 10))) (= tmp8 (mk_int__ref tmp))))
(assert (=> (not (and (<= 1 c1) (<= c1 10))) (= m1 m7)))
(assert (=> (not (and (<= 1 c1) (<= c1 10))) (= c6 c1)))
(assert (=> (not (and (<= 1 c1) (<= c1 10))) (= tmp7 tmp1)))
(assert (=> (not (and (<= 1 c1) (<= c1 10))) (= m8 m1)))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 10))
(declare-const j Int)
...
(assert (<= j 10))
(assert (= i 5))
(assert (not (= (to_rep (get m7 i j)) 2)))
(check-sat)
(exit)
