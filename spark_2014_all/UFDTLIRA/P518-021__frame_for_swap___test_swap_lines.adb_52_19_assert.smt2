...
(assert (= c1 1))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___231 tmp)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___230 c1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___227 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___233 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (= temp___232 m1)))
(assert (=> (and (<= 1 c1) (<= c1 10)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- c2 1))) (and (= (to_rep (get m2 5 i)) (to_rep (get temp___232 7 i))) (= (to_rep (get m2 7 i)) (to_rep (get temp___233 5 i))))))))
(assert (=> (and (<= 1 c1) (<= c1 10)) (and (and (and (forall ((temp___228 Int) (temp___229 Int)) (=> (and (and (<= 1 temp___228) (<= temp___228 10)) (and (<= 1 temp___229) (<= temp___229 10))) (=> (and (or (<= c2 temp___229) (not (= 5 temp___228))) (or (<= c2 temp___229) (not (= 7 temp___228)))) (= (get m2 temp___228 temp___229) (get temp___227 temp___228 temp___229))))) (=> (<= 1 10) (in_range5 c2))) (=> (<= 0 2147483647) (in_range2 tmp2))) (and (<= 1 c2) (<= c2 10)))))
