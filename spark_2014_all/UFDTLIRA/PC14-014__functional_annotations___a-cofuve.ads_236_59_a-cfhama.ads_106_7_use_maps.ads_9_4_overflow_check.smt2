...
(define-fun dynamic_invariant ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 1 2147483647)) (in_range2 temp___expr_379)))
...
(define-fun dynamic_invariant1 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range3 temp___expr_391)))
...
(define-fun default_initial_assumption ((temp___expr_398 us_rep) (temp___skip_top_level_399 Bool)) Bool (=> (not (= temp___skip_top_level_399 true)) (= (length temp___expr_398) 0)))
