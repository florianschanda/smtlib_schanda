...
(declare-const temp___3431 unsigned_byte)
(declare-const temp___3432 unsigned_byte)
...
(assert (and (= (bool_eq1 (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))) x_old) true) (= tmp1 (to_rep x__split_fields2))))
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___343 o5))
(assert (= temp___3431 o6))
(assert (= temp___3432 o7))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2))))))
(assert (= x__split_fields3 (mk___split_fields1 temp___343 (mk___rep (mk___split_fields temp___3431 temp___3432)))))
(assert (not (= (bool_eq1 (mk___rep1 x__split_fields3) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 x_old)) (mk___rep (mk___split_fields (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x_old)))) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x_old))))))))) true)))
(check-sat)
(exit)
