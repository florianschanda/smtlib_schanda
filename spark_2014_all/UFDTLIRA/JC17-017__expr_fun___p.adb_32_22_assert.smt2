...
(assert true)
(assert (forall ((p__sub__z Bool)) (! (= (= (h_x p__sub__z) true) (= p__sub__z true)) :pattern ((h_x p__sub__z)))))
...
(assert (forall ((p__sub__z Bool)) (! (= (= (h_y p__sub__z) true) (= p__sub__z true)) :pattern ((h_y p__sub__z)))))
(assert (forall ((p__sub__z Bool)) (! (= (= (h_y p__sub__z) true) (= p__sub__z true)) :pattern ((h_y p__sub__z)))))
