...
(define-fun default_init__mut_discr__f__pred ((a us_rep)) Bool (= (to_int1 (rec__default_init__mut_discr__b (us_split_discrs1 a))) 1))
...
(define-fun default_initial_assumption ((temp___expr_220 us_rep) (temp___skip_top_level_221 Bool)) Bool (and (and (= (attr__constrained temp___expr_220) false) (and (= (rec__default_init__mut_discr__b (us_split_discrs1 temp___expr_220)) (of_int 0)) (=> (default_init__mut_discr__f__pred temp___expr_220) (= (to_rep (rec__default_init__mut_discr__f (us_split_fields1 temp___expr_220))) (init 0))))) (=> (not (= temp___skip_top_level_221 true)) (= (mut_discr_ok temp___expr_220) true))))
(assert true)
...
(assert (and (= temp___2972 false) (=> (= (to_int1 temp___297) 1) (= (to_rep temp___2971) (init 0)))))
(assert (not (= (mut_discr_ok (mk___rep (mk___split_discrs temp___297) (mk___split_fields temp___2971) temp___2972)) true)))
(check-sat)
(exit)
