...
(assert (= result2 true))
(assert (not (= (has_key (positions (mk___rep container__split_discrs (mk___split_fields container__split_fields))) (mk___rep1 (mk___split_fields1 current__split_fields1))) true)))
(check-sat)
(exit)
