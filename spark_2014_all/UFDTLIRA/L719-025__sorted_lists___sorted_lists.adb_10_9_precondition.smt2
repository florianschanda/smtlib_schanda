...
(assert (and (= result1 (has_key (positions (mk___rep container__split_discrs (mk___split_fields container__split_fields))) (mk___rep1 current__split_fields2))) (= (= result1 true) (= (has_key (positions (mk___rep container__split_discrs (mk___split_fields container__split_fields))) (mk___rep1 current__split_fields2)) true))))
(assert (= result1 true))
(assert (not (= (has_key (positions (mk___rep container__split_discrs (mk___split_fields container__split_fields))) (mk___rep1 current__split_fields2)) true)))
(check-sat)
(exit)
