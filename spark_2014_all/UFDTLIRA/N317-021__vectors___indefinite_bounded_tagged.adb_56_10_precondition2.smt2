...
(define-fun o10 () us_rep1 (mk___rep1 (mk___split_fields1 o6 o7) o8))
(define-fun o11 () us_rep1 (mk___rep1 (mk___split_fields1 o3 o4) o5))
(define-fun o12 () us_rep1 (mk___rep1 (mk___split_fields1 o o1) o2))
...
(assert (and (= o12 (f 1)) (and (and (= (of_rep1 1) o) (= us_null_ext__ o1)) (= us_tag o2))))
...
(assert (and (= o11 (f 2)) (and (and (= (of_rep1 2) o3) (= us_null_ext__ o4)) (= us_tag o5))))
...
(assert (and (= o10 (f 3)) (and (and (= (of_rep1 3) o6) (= us_null_ext__ o7)) (= us_tag o8))))
...
(assert (not (<= (length o9) (to_rep (rec__indefinite_bounded_tagged__vect__vector__capacity w__split_discrs)))))
(check-sat)
(exit)
