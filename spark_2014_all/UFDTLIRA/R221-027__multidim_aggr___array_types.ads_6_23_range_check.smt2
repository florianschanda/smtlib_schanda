...
(declare-fun temp___165 (Int Int Int Int Int) us_t1)
...
(assert (forall ((temp___167 Int) (temp___168 Int) (temp___169 Int) (temp___170 Int) (temp___171 Int)) (let ((temp___166 (temp___165 temp___167 temp___168 temp___169 temp___170 temp___171))) (=> (dynamic_invariant1 temp___167 true true true true) (and (=> (dynamic_property2 1 2147483647 temp___168 temp___169 1 2147483647 temp___170 temp___171) (and (and (= (first_21 temp___166) temp___170) (= (last_21 temp___166) temp___171)) (and (= (first5 temp___166) temp___168) (= (last5 temp___166) temp___169)))) (forall ((temp___172 Int) (temp___173 Int)) (= (to_rep1 (get (to_array1 temp___166) temp___172 temp___173)) temp___167)))))))
(assert (in_range1 f1))
(assert (in_range1 l1))
(assert (in_range1 f2))
(assert (in_range1 l2))
