...
(define-fun dynamic_invariant1 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_235)))
...
(define-fun dynamic_invariant4 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 1 1000)) (in_range5 temp___expr_214)))
(define-fun dynamic_invariant5 ((temp___expr_393 us_rep) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (not (= temp___skip_constant_390 true)) (in_range4 1000 temp___expr_393)))
...
(define-fun dynamic_invariant8 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 1000)) (in_range6 temp___expr_228)))
...
(assert (and (= o11 (length m)) (and (in_range2 o11) (<= o11 (capacity m)))))
(assert (and (= o9 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o9) (<= o9 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o10 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o10) (<= o10 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o12 (+ o10 o9)))
(assert (= result1 (ite (= o12 o11) true false)))
(assert (=> (= result1 true) (and (= o8 (length m)) (and (in_range2 o8) (<= o8 (capacity m))))))
(assert (=> (= result1 true) (= result (ite (<= o8 1000) true false))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (and (= o (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o) (<= o (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result2 (ite (<= 1 i) o1 false)))
(assert (= result2 true))
(assert (and (= o3 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o3) (<= o3 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (= o4 (- o3 i)))
(assert (= o5 (+ o4 1)))
(assert (and (= o6 o5) (in_range6 o5)))
(assert (and (= o7 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o6)) (and (in_range3 o7) (= o7 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o6)))))
(assert (and (= o2 i) (in_range6 i)))
(assert (not (<= o2 (last (model__ m)))))
(check-sat)
(exit)
