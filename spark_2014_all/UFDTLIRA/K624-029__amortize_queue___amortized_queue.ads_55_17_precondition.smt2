...
(assert (and (= o11 (length m)) (and (in_range4 o11) (<= o11 (capacity m)))))
...
(assert (and (= o10 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o10) (<= o10 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o12 (+ o10 o9)))
(assert (= result1 (ite (= o12 o11) true false)))
(assert (=> (= result1 true) (and (= o8 (length m)) (and (in_range4 o8) (<= o8 (capacity m))))))
(assert (=> (= result1 true) (= result (ite (<= o8 1000) true false))))
...
(assert (= result2 true))
(assert (and (= o3 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o3) (<= o3 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (= o4 (- o3 i)))
(assert (= o5 (+ o4 1)))
(assert (and (= o6 o5) (in_range3 o5)))
(assert (and (= o7 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o6)) (and (in_range5 o7) (= o7 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o6)))))
(assert (and (= o2 i) (in_range3 i)))
(assert (not (<= 1 o2)))
(check-sat)
(exit)
