...
(define-fun dynamic_invariant ((temp___expr_213 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 1000)) (in_range4 temp___expr_213)))
...
(define-fun dynamic_invariant1 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_201)))
...
(define-fun dynamic_invariant2 ((temp___expr_360 us_rep2) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (and (in_range6 1000 (rec__amortized_queue__queue__front (us_split_fields3 temp___expr_360))) (in_range6 1000 (rec__amortized_queue__queue__rear (us_split_fields3 temp___expr_360)))))
...
(define-fun dynamic_invariant4 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 1 1000)) (in_range2 temp___expr_183)))
(define-fun dynamic_invariant5 ((temp___expr_351 us_rep) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool (=> (not (= temp___skip_constant_349 true)) (in_range6 1000 temp___expr_351)))
...
(define-fun dynamic_invariant7 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 1001)) (in_range8 temp___expr_207)))
...
(define-fun dynamic_invariant8 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 1 1000)) (in_range3 temp___expr_195)))
...
(define-fun dynamic_invariant9 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 1000)) (in_range9 temp___expr_240)))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 1000) (dynamic_invariant6 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant10 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range10 temp___expr_234)))
...
(assert (and (= o21 (length m)) (and (in_range4 o21) (<= o21 (capacity m)))))
(assert (and (= o19 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o19) (<= o19 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o20 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o20) (<= o20 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o22 (+ o20 o19)))
(assert (= result2 (ite (= o22 o21) true false)))
(assert (=> (= result2 true) (and (= o18 (length m)) (and (in_range4 o18) (<= o18 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o18 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (= result1 true))
(assert (and (= o9 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o9) (<= o9 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (= o10 (ite (<= i1 o9) true false)))
(assert (= result3 (ite (<= 1 i1) o10 false)))
(assert (= result3 true))
(assert (and (= o12 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o12) (<= o12 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (= o13 (- o12 i1)))
(assert (= o14 (+ o13 1)))
(assert (and (= o15 o14) (in_range3 o14)))
(assert (and (= o16 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o15)) (and (in_range5 o16) (= o16 (get (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q))) o15)))))
(assert (and (= o11 i1) (in_range3 i1)))
(assert (not (<= 1 o11)))
(check-sat)
(exit)
