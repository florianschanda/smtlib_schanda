...
(assert (=> (< 0 speed2) (and (= (speed_is_valid speed3 status3) true) (and (in_range2 speed3) (in_range1 status3)))))
(assert (=> (not (< 0 speed2)) (and (= (speed_is_valid speed4 status4) true) (and (in_range2 speed4) (in_range1 status4)))))
(assert (=> (not (< 0 speed2)) (= status3 status4)))
(assert (=> (not (< 0 speed2)) (= speed3 speed4)))
(assert (not (= status3 0)))
(assert (not (= (speed_is_valid speed3 status3) true)))
(check-sat)
(exit)
