...
(assert (=> (< 0 speed1) (and (= (speed_is_valid speed2 status2) true) (and (in_range2 speed2) (in_range1 status2)))))
(assert (=> (not (< 0 speed1)) (and (= (speed_is_valid speed3 status3) true) (and (in_range2 speed3) (in_range1 status3)))))
(assert (=> (not (< 0 speed1)) (= status2 status3)))
