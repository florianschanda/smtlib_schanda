...
(define-fun dynamic_invariant1 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 0 98)) (in_range temp___expr_228)))
(define-fun dynamic_invariant2 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 98 98)) (in_range1 temp___expr_242)))
(declare-const self__ us_rep)
(declare-const temp___1785 Bool)
(assert (not (= temp___1785 false)))
(check-sat)
(exit)
