...
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) any_priority (rec__interrupt_priority__interrupt_needed_1__c a))
...
(declare-const temp___1548 Bool)
(assert (not (= temp___1548 false)))
(check-sat)
(exit)
