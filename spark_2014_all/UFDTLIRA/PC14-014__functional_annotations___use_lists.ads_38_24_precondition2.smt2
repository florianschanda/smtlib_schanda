...
(define-fun use_lists__incr_all_2__cu__assume1 () us_rep2 (mk___rep1 (mk___split_fields1 use_lists__incr_all_2__cu__assume)))
(assert (and (= use_lists__incr_all_2__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 use_lists__incr_all_2__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_2__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) use_lists__incr_all_2__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_lists__incr_all_2__cu__assume cu__split_fields1))
...
(assert (=> (= result1 true) (= temp___533 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___532)) (= l__split_fields temp___5321))))
(assert (=> (= result1 true) (= temp___534 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___531 cu__split_fields1)))
(assert (=> (= result1 true) (= temp___535 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= (length (mk___rep l__split_discrs l__split_fields11)) temp___533)))
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1))) (= (is_incr (get temp___534 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1)) true)))))
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) n1) (<= n1 (length (mk___rep l__split_discrs l__split_fields11)))) (= (get temp___535 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1))))))
(assert (=> (= result1 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) true)))
...
(assert (and (= o8 (get o7 n)) (in_range2 o8)))
(assert (not (<= 1 n)))
(check-sat)
(exit)
