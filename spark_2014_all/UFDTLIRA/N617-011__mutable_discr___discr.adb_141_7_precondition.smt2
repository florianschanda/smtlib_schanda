...
(assert (= o6 o7))
(assert (= (mk___rep (mk___split_discrs discr__p4__d2__assume) (mk___split_fields discr__p4__d2__assume1) discr__p4__d2__assume2) o6))
...
(assert (=> (= d2__attr__constrained true) (= discr__p4__nested1__d__discrs d2__split_discrs)))
