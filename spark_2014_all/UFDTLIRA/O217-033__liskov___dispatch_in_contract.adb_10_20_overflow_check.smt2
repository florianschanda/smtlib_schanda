...
(assert true)
(assert true)
(assert (forall ((o us_rep1)) (! (= (to_int1 (less_than_max__2 o)) (to_int1 (less_than_max__21 us_tag1 o))) :pattern ((less_than_max__21 us_tag1 o)))))
(assert (forall ((o us_rep1)) (! (= (to_int1 (less_than_max__3 o)) (to_int1 (less_than_max__21 us_tag2 o))) :pattern ((less_than_max__21 us_tag2 o)))))
...
(define-fun default_initial_assumption2 ((temp___expr_164 us_rep1) (temp___skip_top_level_165 Bool)) Bool (= (attr__tag1 temp___expr_164) us_tag2))
(assert true)
(assert true)
(assert (forall ((o us_rep1)) (! (= (to_int1 (less_than_max__3 o)) (to_int1 (less_than_max__31 us_tag2 o))) :pattern ((less_than_max__31 us_tag2 o)))))
...
(declare-const temp___1762 us_private)
...
(assert (and (= (less_than_max__2 (mk___rep1 (mk___split_fields1 o__split_fields o__split_fields1 o__split_fields2) o__attr__tag)) true) (< (to_rep o__split_fields) 2147483647)))
