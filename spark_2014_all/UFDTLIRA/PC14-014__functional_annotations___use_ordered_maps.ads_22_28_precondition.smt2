...
(define-fun default_initial_assumption ((temp___expr_334 us_rep2) (temp___skip_top_level_335 Bool)) Bool (=> (not (= temp___skip_top_level_335 true)) (and (= (is_empty temp___expr_334) true) (= (length temp___expr_334) 0))))
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range3 k) (= (has_key container k) true)) (= (equivalent_keys k key) true))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant2 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 2147483647)) (in_range4 temp___expr_352)))
...
(define-fun dynamic_invariant3 ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= 0 2147483647)) (in_range5 temp___expr_358)))
...
(define-fun default_initial_assumption1 ((temp___expr_365 us_rep3) (temp___skip_top_level_366 Bool)) Bool (=> (not (= temp___skip_top_level_366 true)) (= (length1 temp___expr_365) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_378 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= 1 2147483647)) (in_range6 temp___expr_378)))
...
(define-fun default_initial_assumption2 ((temp___expr_385 us_rep4) (temp___skip_top_level_386 Bool)) Bool (=> (not (= temp___skip_top_level_386 true)) (and (= (is_empty1 temp___expr_385) true) (= (length2 temp___expr_385) 0))))
...
(define-fun k_is_find ((container us_rep3) (key Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key) (of_int 1)) (ite (< position (length1 container)) (k_smaller_than_range container (+ position 1) (length1 container) key) (of_int 1))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length1 result) (length3 container)) (forall ((temp___399 Int)) (=> (and (in_range5 temp___399) (= (iter_has_element result temp___399) true)) (= (has_key (model__ container) (get result temp___399)) true)))) (forall ((key Int)) (=> (and (in_range3 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 1 2147483647)) (in_range7 temp___expr_289)))
...
(define-fun dynamic_invariant6 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range2 temp___expr_142)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant6 result true false true))) :pattern ((length3 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant6 (length4 attr__tag container) true false true) :pattern ((length4 attr__tag container))))))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant6 result true false true)))) :pattern ((find container key2))))))
...
(define-fun dynamic_invariant7 ((temp___expr_327 Int) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool)) Bool (=> (or (= temp___is_init_324 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_327)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k1 Int)) (=> (and (in_range3 k1) (= (has_key container k1) true)) (= (= (equivalent_keys k1 key2) true) (= (witness1 container key2) (witness1 container k1))))))) (dynamic_invariant7 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant6 (length container) true false true) :pattern ((length container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq3 left right) true) (and (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get2 right key2) (get2 left key2))))) (forall ((key2 Int)) (=> (and (in_range3 key2) (= (has_key right key2) true)) (= (has_key left key2) true))))) :pattern ((oeq3 left right)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true) (= (has_key container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness container result) true) (dynamic_invariant6 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant6 witness2 true true true) (= (has_witness container witness2) true)) (dynamic_invariant7 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
(assert (forall ((container us_rep3)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant6 result true false true))) :pattern ((length1 container)))))
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (of_int 0) true) (=> (exists ((k1 us_rep1)) (and (= (has_key1 container k1) true) (= (bool_eq1 k1 key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant6 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant6 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant6 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant4 (w_get container witness2) true false true)) :pattern ((w_get container witness2))))))
...
(declare-const use_ordered_maps__my_find__result8 cursor__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_ordered_maps__my_find__result9 us_rep1)
...
(declare-const use_ordered_maps__my_find__result15 cursor__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_ordered_maps__my_find__result16 us_rep1)
...
(assert (in_range1 k))
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_maps__my_find__cu__assume)) (first s)) (ite (= (= (length3 s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_maps__my_find__cu__assume)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 use_ordered_maps__my_find__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_ordered_maps__my_find__cu__assume))) 1)))))
...
(assert (or (and (and (and (= use_ordered_maps__my_find__result13 (mk_cursor__ref use_ordered_maps__my_find__result3)) (= cu__split_fields10 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2)))) (and (= use_ordered_maps__my_find__result14 use_ordered_maps__my_find__result3) (= cu__split_fields11 (mk___split_fields1 cu__split_fields2)))) (and (and (= result1 (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (and (= result1 true) (and (= temp___628 cu__split_fields1) (and (= 0 temp___629) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (keys s) i1) k)))) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (= result3 (mk_int__ref temp___6291)) (= temp___6292 (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (and (and (and (= o8 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (= result4 (ite (= o8 k) true false))) (and (= result4 true) (and (= result5 (mk_cursor__ref use_ordered_maps__my_find__result2)) (= use_ordered_maps__my_find__result3 (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))))))) (and (and (and (= result1 (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))) (ite (= result1 true) (and (and (and (= temp___628 cu__split_fields1) (and (= 0 temp___629) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (keys s) i1) k)))) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (and (and (= result3 (mk_int__ref temp___6291)) (= temp___6292 (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (and (and (and (and (= o8 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))) (= result4 (ite (= o8 k) true false))) (and (not (= result4 true)) (= use_ordered_maps__my_find__result3 use_ordered_maps__my_find__result2))) (and (and (and (= (mk___rep1 (mk___split_fields1 temp___627)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length3 s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___627)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 temp___627))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___627))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))) (and (= result6 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2))) (= cu__split_fields3 (mk___split_fields1 temp___627)))) (and (and (and (= o9 (has_key1 (positions s) (mk___rep1 cu__split_fields3))) (= (= o9 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true))) (= result7 (ite (not (= o9 true)) true false))) (= result7 true))))))))) (and (and (= use_ordered_maps__my_find__result6 (mk_cursor__ref use_ordered_maps__my_find__result3)) (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields3))) (and (= use_ordered_maps__my_find__result7 use_ordered_maps__my_find__result3) (= cu__split_fields7 cu__split_fields3)))) (and (and (= use_ordered_maps__my_find__result8 use_ordered_maps__my_find__result6) (= cu__split_fields8 cu__split_fields6)) (and (= use_ordered_maps__my_find__result9 use_ordered_maps__my_find__result7) (= cu__split_fields9 cu__split_fields7)))) (and (and (= use_ordered_maps__my_find__result8 (mk_cursor__ref (mk___rep1 (mk___split_fields1 use_ordered_maps__my_find__result)))) (= cu__split_fields8 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields1)))) (and (= use_ordered_maps__my_find__result9 (mk___rep1 (mk___split_fields1 use_ordered_maps__my_find__result1))) (= cu__split_fields9 (mk___split_fields1 cu__split_fields1)))))) (and (and (and (= use_ordered_maps__my_find__result13 use_ordered_maps__my_find__result11) (= cu__split_fields10 cu__split_fields8)) (and (= use_ordered_maps__my_find__result14 use_ordered_maps__my_find__result12) (= cu__split_fields11 cu__split_fields9))) (and (and (= use_ordered_maps__my_find__result11 (mk_cursor__ref use_ordered_maps__my_find__result10)) (= use_ordered_maps__my_find__result12 use_ordered_maps__my_find__result10)) (and (= result8 use_ordered_maps__my_find__result8) (= use_ordered_maps__my_find__result10 no_element)))))))
(assert (= use_ordered_maps__my_find__result15 use_ordered_maps__my_find__result13))
(assert (= cu__split_fields12 cu__split_fields10))
(assert (= use_ordered_maps__my_find__result16 use_ordered_maps__my_find__result14))
(assert (= cu__split_fields13 cu__split_fields11))
(assert (not (= (bool_eq1 (cursor__content use_ordered_maps__my_find__result15) no_element) true)))
(assert (and (= result9 (has_key1 (positions s) (cursor__content use_ordered_maps__my_find__result15))) (= (= result9 true) (= (has_key1 (positions s) (cursor__content use_ordered_maps__my_find__result15)) true))))
(assert (= result9 true))
(assert (not (= (has_key1 (positions s) (cursor__content use_ordered_maps__my_find__result15)) true)))
(check-sat)
(exit)
