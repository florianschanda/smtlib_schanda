...
(define-fun dynamic_invariant ((temp___expr_605 Int) (temp___is_init_602 Bool) (temp___skip_constant_603 Bool) (temp___do_toplevel_604 Bool)) Bool (=> (or (= temp___is_init_602 true) (<= 1 2147483647)) (in_range2 temp___expr_605)))
...
(define-fun default_initial_assumption ((temp___expr_612 us_rep2) (temp___skip_top_level_613 Bool)) Bool (=> (not (= temp___skip_top_level_613 true)) (and (= (is_empty temp___expr_612) true) (= (length temp___expr_612) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range1 temp___expr_142)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant3 result true false true))) :pattern ((length1 container1)))))
(assert (forall ((attr__tag Int)) (forall ((container1 us_rep)) (! (dynamic_invariant3 (length2 attr__tag container1) true false true) :pattern ((length2 attr__tag container1))))))
...
(define-fun e_is_find ((container1 us_rep4) (item us_rep3) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (of_int 1)) (ite (< position (length3 container1)) (e_smaller_than_range container1 (+ position 1) (length3 container1) item) (of_int 1))))
...
(define-fun default_initial_assumption1 ((temp___expr_592 us_rep4) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (= (length3 temp___expr_592) 0)))
(declare-fun find (us_rep4 us_rep3) Int)
(declare-fun find__function_guard (Int us_rep4 us_rep3) Bool)
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant3 result true false true))) :pattern ((find container1 item))))))
...
(define-fun default_initial_assumption2 ((temp___expr_559 us_rep5) (temp___skip_top_level_560 Bool)) Bool (=> (not (= temp___skip_top_level_560 true)) (= (is_empty1 temp___expr_559) true)))
...
(assert true)
(assert (forall ((container1 us_rep5)) (forall ((item us_rep3)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep3)) (and (= (contains container1 e) true) (= (equivalent_elements e item) true))) (= (contains container1 item) true))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep5)) (! (dynamic_invariant3 (length4 container1) true false true) :pattern ((length4 container1)))))
...
(define-fun dynamic_invariant4 ((temp___expr_585 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 2147483647)) (in_range5 temp___expr_585)))
(assert (forall ((container1 us_rep4)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true))) :pattern ((length3 container1)))))
(assert true)
...
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant3 (length container1) true false true) :pattern ((length container1)))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant3 result true false true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant (w_get container1 witness1) true false true)) :pattern ((w_get container1 witness1))))))
(declare-const position__split_fields count_type)
(declare-const o count_type)
(declare-const o1 count_type)
(declare-const temp___1020 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1020 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1020)) no_element))
