...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__my_ordered_sets__n__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields2)) count_type (rec__my_ordered_sets__n__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__my_ordered_sets__n__cursor__node (us_split_fields3 a))) (to_rep (rec__my_ordered_sets__n__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun key_type__ref___2__projection ((a key_type__ref)) us_rep1 (key_type__content a))
...
(define-fun dynamic_invariant ((temp___expr_660 Int) (temp___is_init_656 Bool) (temp___skip_constant_657 Bool) (temp___do_toplevel_658 Bool) (temp___do_typ_inv_659 Bool)) Bool (=> (or (= temp___is_init_656 true) (<= 1 2147483647)) (in_range2 temp___expr_660)))
...
(define-fun default_initial_assumption ((temp___expr_668 us_rep2) (temp___skip_top_level_669 Bool)) Bool (=> (not (= temp___skip_top_level_669 true)) (and (= (is_empty temp___expr_668) true) (= (length temp___expr_668) 0))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__my_ordered_sets__my_rec__f natural) (rec__my_ordered_sets__my_rec__g integer)))))
(define-fun us_split_fields_F__projection ((a us_split_fields4)) natural (rec__my_ordered_sets__my_rec__f a))
(define-fun us_split_fields_G__projection ((a us_split_fields4)) integer (rec__my_ordered_sets__my_rec__g a))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep2 (rec__my_ordered_sets__my_rec__f (us_split_fields5 a))) (to_rep2 (rec__my_ordered_sets__my_rec__f (us_split_fields5 b)))) (= (to_rep1 (rec__my_ordered_sets__my_rec__g (us_split_fields5 a))) (to_rep1 (rec__my_ordered_sets__my_rec__g (us_split_fields5 b))))) true false))
...
(define-fun my_lt ((x us_rep3) (y us_rep3)) Bool (< (to_rep2 (rec__my_ordered_sets__my_rec__f (us_split_fields5 x))) (to_rep2 (rec__my_ordered_sets__my_rec__f (us_split_fields5 y)))))
(declare-fun my_lt__function_guard (Bool us_rep3 us_rep3) Bool)
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range1 temp___expr_166)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant3 result true false true true))) :pattern ((length1 container1)))))
(assert (forall ((attr__tag Int)) (forall ((container1 us_rep)) (! (dynamic_invariant3 (length2 attr__tag container1) true false true true) :pattern ((length2 attr__tag container1))))))
(declare-datatypes () ((element_type__ref2 (mk_element_type__ref2 (element_type__content2 us_rep3)))))
(define-fun element_type__ref___7__projection ((a element_type__ref2)) us_rep3 (element_type__content2 a))
...
(define-fun sequence__ref___2__projection ((a sequence__ref)) us_rep4 (sequence__content a))
...
(define-fun e_bigger_than_range ((container1 us_rep4) (fst Int) (lst Int) (item us_rep3)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get1 container1 i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep4 Int Int us_rep3) Bool)
(define-fun e_smaller_than_range ((container1 us_rep4) (fst Int) (lst Int) (item us_rep3)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get1 container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep4 Int Int us_rep3) Bool)
(define-fun e_is_find ((container1 us_rep4) (item us_rep3) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length3 container1)) (e_smaller_than_range container1 (+ position 1) (length3 container1) item) (distinct 1 0))))
...
(define-fun oeq2 ((left us_rep4) (right us_rep4)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq3 (get1 left n) (get1 right n)) true))) true false)))
(declare-fun oeq__function_guard2 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq8 a b) (oeq2 a b)) :pattern ((user_eq8 a b)))))
(define-fun default_initial_assumption1 ((temp___expr_645 us_rep4) (temp___skip_top_level_646 Bool)) Bool (=> (not (= temp___skip_top_level_646 true)) (= (length3 temp___expr_645) 0)))
(declare-fun find (us_rep4 us_rep3) Int)
(declare-fun find__function_guard (Int us_rep4 us_rep3) Bool)
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant3 result true false true true))) :pattern ((find container1 item))))))
(define-fun e_elements_included ((left us_rep4) (right us_rep4)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 left))) (and (< 0 (find right (get1 left i))) (= (bool_eq3 (get1 right (find right (get1 left i))) (get1 left i)) true)))) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_607 us_rep5) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty1 temp___expr_607) true)))
...
(assert (forall ((container1 us_rep)) (! (= (length4 (model__ container1)) (length1 container1)) :pattern ((model__ container1)))))
(declare-datatypes () ((element_type__ref3 (mk_element_type__ref3 (element_type__content3 us_rep3)))))
(define-fun element_type__ref___6__projection ((a element_type__ref3)) us_rep3 (element_type__content3 a))
...
(define-fun iter_has_element ((container1 us_rep4) (position Int)) Bool (and (ite (<= 1 position) true false) (ite (<= position (last container1)) true false)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length1 container1)) (forall ((temp___683 Int)) (=> (and (in_range5 temp___683) (= (iter_has_element result temp___683) true)) (= (contains (model__ container1) (get1 result temp___683)) true)))) (forall ((item us_rep3)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert true)
(assert (forall ((container1 us_rep5)) (forall ((item us_rep3)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep3)) (and (= (contains container1 e) true) (= (equivalent_elements e item) true))) (= (contains container1 item) true))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep5)) (! (dynamic_invariant3 (length4 container1) true false true true) :pattern ((length4 container1)))))
(assert (forall ((container1 us_rep5)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item us_rep3)) (not (= (contains container1 item) true)))) (= (= result true) (= (length4 container1) 0)))) :pattern ((is_empty1 container1)))))
(define-fun dynamic_invariant4 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= 0 2147483647)) (in_range5 temp___expr_637)))
(assert (forall ((container1 us_rep4)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true true))) :pattern ((length3 container1)))))
(assert true)
...
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant3 (length container1) true false true true) :pattern ((length container1)))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant3 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant (w_get container1 witness1) true false true true)) :pattern ((w_get container1 witness1))))))
(declare-const position__split_fields count_type)
(declare-const o count_type)
(declare-const o1 count_type)
(declare-const temp___1084 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1084 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1084)) no_element))
