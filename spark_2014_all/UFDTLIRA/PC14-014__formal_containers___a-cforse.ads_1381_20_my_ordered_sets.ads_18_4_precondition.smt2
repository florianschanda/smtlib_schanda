...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__my_ordered_sets__n__cursor__node count_type)))))
(define-fun us_split_fields_Node__2__projection ((a us_split_fields)) count_type (rec__my_ordered_sets__n__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__my_ordered_sets__n__cursor__node (us_split_fields1 a))) (to_rep (rec__my_ordered_sets__n__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun key_type__ref___2__projection ((a key_type__ref)) us_rep (key_type__content a))
...
(define-fun default_initial_assumption ((temp___expr_668 us_rep1) (temp___skip_top_level_669 Bool)) Bool (=> (not (= temp___skip_top_level_669 true)) (and (= (is_empty temp___expr_668) true) (= (length temp___expr_668) 0))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__my_ordered_sets__n__set us_main_type1)))))
(define-fun us_split_fields_Set__2__projection ((a us_split_fields2)) us_main_type1 (rec__my_ordered_sets__n__set a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 a))) (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__my_ordered_sets__n__set (us_split_fields3 a)) (rec__my_ordered_sets__n__set (us_split_fields3 b))) true)) true false))
...
(define-fun set__ref___3__projection ((a set__ref)) us_rep2 (set__content a))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant3 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun e_is_find ((container1 us_rep4) (item us_rep3) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item) (distinct 1 0))))
...
(define-fun last ((container1 us_rep4)) Int (+ 0 (length2 container1)))
(declare-fun last__function_guard (Int us_rep4) Bool)
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq3 (get1 left n) (get1 right n)) true))) true false)))
(declare-fun oeq__function_guard1 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq8 a b) (oeq1 a b)) :pattern ((user_eq8 a b)))))
(define-fun default_initial_assumption1 ((temp___expr_645 us_rep4) (temp___skip_top_level_646 Bool)) Bool (=> (not (= temp___skip_top_level_646 true)) (= (length2 temp___expr_645) 0)))
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant3 result true false true true))) :pattern ((find container1 item))))))
(define-fun e_elements_included ((left us_rep4) (right us_rep4)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 left))) (and (< 0 (find right (get1 left i))) (= (bool_eq3 (get1 right (find right (get1 left i))) (get1 left i)) true)))) true false))
...
(declare-fun model__ (us_rep2) us_rep5)
(declare-fun model____function_guard (us_rep5 us_rep2) Bool)
...
(declare-fun elements (us_rep2) us_rep4)
(declare-fun elements__function_guard (us_rep4 us_rep2) Bool)
...
(assert (forall ((container1 us_rep5)) (! (dynamic_invariant3 (length3 container1) true false true true) :pattern ((length3 container1)))))
(assert (forall ((container1 us_rep5)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item us_rep3)) (not (= (contains container1 item) true)))) (= (= result true) (= (length3 container1) 0)))) :pattern ((is_empty1 container1)))))
...
(assert (forall ((container1 us_rep4)) (! (let ((result (length2 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true true))) :pattern ((length2 container1)))))
(assert true)
...
(assert (forall ((container1 us_rep1)) (! (dynamic_invariant3 (length container1) true false true true) :pattern ((length container1)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (forall ((key us_rep)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant3 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant (w_get container1 witness1) true false true true)) :pattern ((w_get container1 witness1))))))
