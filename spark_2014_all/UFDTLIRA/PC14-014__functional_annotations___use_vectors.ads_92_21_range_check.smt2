...
(assert (and (= o16 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))) (and (dynamic_property4 first3 last5 o16) (= o16 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))
...
(assert (= (= o19 true) (forall ((j3 Int)) (=> (and (<= (+ i 7) j3) (<= j3 (last2 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8)))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j3) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (- j3 7)))))))
...
(assert (= result2 true))
(assert (and (= us7 j) (dynamic_property2 first1 last3 j)))
(assert (= o9 j))
