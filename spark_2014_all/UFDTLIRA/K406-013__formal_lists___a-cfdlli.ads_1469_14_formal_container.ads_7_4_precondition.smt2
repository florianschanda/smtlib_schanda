...
(define-fun default_initial_assumption ((temp___expr_195 us_rep1) (temp___skip_top_level_196 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_195))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 1 2147483647)) (in_range3 temp___expr_239)))
...
(define-fun default_initial_assumption1 ((temp___expr_246 us_rep3) (temp___skip_top_level_247 Bool)) Bool (=> (not (= temp___skip_top_level_247 true)) (and (= (is_empty temp___expr_246) true) (= (length2 temp___expr_246) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_234 us_rep1) (temp___skip_top_level_235 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_234))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_227 us_rep2) (temp___skip_top_level_228 Bool)) Bool (=> (not (= temp___skip_top_level_228 true)) (= (length1 temp___expr_227) 0)))
...
(declare-const temp___450 count_type)
(declare-const o2 us_rep2)
(declare-const o3 us_rep3)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___450 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___450)) no_element))
...
(assert (=> (not (= (bool_eq1 position no_element) true)) (and (= o4 (get1 o3 position)) (and (in_range3 o4) (=> (= (of_int 0) true) (and (= o4 (w_get o3 (witness o3 position))) (forall ((k us_rep1)) (=> (= (has_key o3 k) true) (= (= (bool_eq1 k position) true) (= (witness o3 position) (witness o3 k)))))))))))
