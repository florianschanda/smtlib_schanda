...
(assert (and (= result1 (has_key (positions l1) (mk___rep1 cu__split_fields6))) (= (= result1 true) (= (has_key (positions l1) (mk___rep1 cu__split_fields6)) true))))
(assert (= result1 true))
...
(assert (= (get1 (positions l1) (mk___rep1 cu__split_fields5)) (+ (length (mk___rep l2__split_discrs l2__split_fields6)) 1)))
(assert (and (= o (element l1 (mk___rep1 cu__split_fields5))) (and (in_range7 o) (= o (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields5)))))))
(assert (= result2 (ite (< o 2147483647) true false)))
(assert (=> (= result2 true) (and (= o1 (element l1 (mk___rep1 cu__split_fields5))) (and (in_range7 o1) (= o1 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields5))))))))
...
(assert (=> (not (= result2 true)) (and (= o4 (element l1 (mk___rep1 cu__split_fields5))) (and (in_range7 o4) (= o4 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields5))))))))
...
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields5) no_element) false) (= (get1 (positions l1) (mk___rep1 cu__split_fields5)) (length l1)) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) true) (and (= (has_key (positions l1) (mk___rep1 cu__split_fields4)) true) (= (get1 (positions l1) (mk___rep1 cu__split_fields4)) (+ (get1 (positions l1) (mk___rep1 cu__split_fields5)) 1)))))
(assert (and (= o5 (has_key (positions l1) (mk___rep1 cu__split_fields4))) (= (= o5 true) (= (has_key (positions l1) (mk___rep1 cu__split_fields4)) true))))
(assert (= result3 (ite (not (= o5 true)) true false)))
(assert (not (= result3 true)))
(assert (not (= (get1 (positions l1) (mk___rep1 cu__split_fields4)) (+ (length (mk___rep l2__split_discrs l2__split_fields5)) 1))))
(check-sat)
(exit)
