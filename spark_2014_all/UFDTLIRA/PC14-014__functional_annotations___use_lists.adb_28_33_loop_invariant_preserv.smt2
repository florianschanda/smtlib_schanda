...
(assert (and (= o (element l1 (mk___rep1 cu__split_fields5))) (and (in_range5 o) (= o (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields5)))))))
(assert (= result2 (ite (< o 2147483647) true false)))
(assert (=> (= result2 true) (and (= o1 (element l1 (mk___rep1 cu__split_fields5))) (and (in_range5 o1) (= o1 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields5))))))))
...
(assert (=> (not (= result2 true)) (and (= o4 (element l1 (mk___rep1 cu__split_fields5))) (and (in_range5 o4) (= o4 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields5))))))))
...
(assert (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields5) no_element) false) (= (get1 (positions l1) (mk___rep1 cu__split_fields5)) (length l1)) true) true) (= (bool_eq2 (mk___rep1 cu__split_fields4) no_element) true) (and (= (has_key (positions l1) (mk___rep1 cu__split_fields4)) true) (= (get1 (positions l1) (mk___rep1 cu__split_fields4)) (+ (get1 (positions l1) (mk___rep1 cu__split_fields5)) 1)))))
