...
(assert (and (= o (copy (rec__amortized_queue__queue__rear (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o) (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o))) (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o))) 1000)))))
(assert (not (= 1000 (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o))))))
(check-sat)
(exit)
