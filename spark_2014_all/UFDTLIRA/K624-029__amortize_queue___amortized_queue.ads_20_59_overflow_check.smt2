...
(define-fun dynamic_invariant ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 1001)) (in_range4 temp___expr_242)))
...
(define-fun dynamic_invariant1 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 1000)) (in_range5 temp___expr_249)))
...
(define-fun dynamic_invariant2 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_235)))
...
(define-fun dynamic_invariant6 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 1000)) (in_range3 temp___expr_228)))
...
(declare-const temp___540 capacity_range)
(declare-const temp___5401 us_main_type)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const amortized_queue__Oconcat__L_2__R10b__assume Int)
(declare-const temp___546 Int)
(declare-const temp___545 capacity_range)
(declare-const temp___5451 us_main_type)
...
(assert (= idx2 1))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= temp___541 idx2)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (and (= result____split_discrs (mk___split_discrs temp___540)) (= result____split_fields temp___5401))))
...
(assert (= idx8 1))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= temp___546 idx8)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (= result____split_discrs (mk___split_discrs temp___545)) (= (us_split_fields__content result____split_fields6) (mk___split_fields temp___5451)))))
