...
(declare-const result4 vector__ref)
...
(define-fun result____split_fields18 () us_split_fields (mk___split_fields result____split_fields3))
...
(define-fun result____split_fields19 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields result____split_fields)))
(assert (<= (+ (length left) (length right)) 1000))
(assert (= amortized_queue__Oconcat__result3 (mk_vector__ref amortized_queue__Oconcat__result2)))
(assert (= idx15 idx12))
(assert (= idx14 idx6))
(assert (= result____split_fields14 result____split_fields12))
(assert (= amortized_queue__Oconcat__result4 amortized_queue__Oconcat__result2))
(assert (= idx17 idx13))
(assert (= idx16 idx7))
(assert (= result____split_fields15 result____split_fields13))
(assert (and (= o (length right)) (and (in_range5 o) (<= o (capacity right)))))
(assert (and (= o1 (length left)) (and (in_range5 o1) (<= o1 (capacity left)))))
...
(assert (and (= amortized_queue__Oconcat__L_1__R4b__assume (last (model__ left))) (and (in_range4 amortized_queue__Oconcat__L_1__R4b__assume) (= amortized_queue__Oconcat__L_1__R4b__assume (last (model__ left))))))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (and (= result____split_discrs (mk___split_discrs temp___494)) (= result____split_fields temp___4941))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (and (= o2 idx2) (in_range3 idx2))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (and (= o3 (get (model__ left) o2)) (and (in_range6 o3) (= o3 (get (model__ left) o2))))))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields19)))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (length (mk___rep result____split_discrs result____split_fields18)) idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 idx3)) (= (get (model__ (mk___rep result____split_discrs result____split_fields18)) i2) (get (model__ left) i2))))))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields4 (mk___split_fields__ref result____split_fields18))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx5 idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields5 result____split_fields18)))
...
(assert (=> (not (and (<= 1 idx2) (<= idx2 r4b))) (= result____split_fields6 result____split_fields19)))
...
(assert (and (= amortized_queue__Oconcat__L_2__R10b__assume (last (model__ right))) (and (in_range4 amortized_queue__Oconcat__L_2__R10b__assume) (= amortized_queue__Oconcat__L_2__R10b__assume (last (model__ right))))))
...
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (= result____split_discrs (mk___split_discrs temp___499)) (= (us_split_fields__content result____split_fields6) (mk___split_fields temp___4991)))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (= o4 idx8) (in_range3 idx8))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (= o5 (get (model__ right) o4)) (and (in_range6 o5) (= o5 (get (model__ right) o4))))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields6))) 1)) (= (olt (model__ (mk___rep result____split_discrs (us_split_fields__content result____split_fields6))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (last (model__ (mk___rep result____split_discrs (us_split_fields__content result____split_fields6)))) 1)) o5))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= result3 result____split_fields6)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= result____split_fields8 amortized_queue__my_vectors__append__2__container__fields1)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= (length (mk___rep result____split_discrs result____split_fields9)) (+ (last (model__ left)) idx9))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (last (model__ left)))) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) i2) (get (model__ left) i2))))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 idx9)) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) (+ (last (model__ left)) i2)) (get (model__ right) i2))))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (and (=> (<= 1 r10b) (dynamic_property1 1 r10b idx9)) (and (<= 1 idx9) (<= idx9 r10b)))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= idx9 r10b)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= idx10 (mk_int__ref idx9))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= result____split_fields10 (mk___split_fields__ref result____split_fields9))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= idx11 idx9)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= result____split_fields11 result____split_fields9)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= idx12 idx10)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= result____split_fields12 result____split_fields10)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= idx13 idx11)))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (= result____split_fields13 result____split_fields11)))
(assert (=> (not (and (<= 1 idx8) (<= idx8 r10b))) (= idx12 (mk_int__ref idx8))))
(assert (=> (not (and (<= 1 idx8) (<= idx8 r10b))) (= result____split_fields12 result____split_fields6)))
(assert (=> (not (and (<= 1 idx8) (<= idx8 r10b))) (= idx13 idx8)))
(assert (=> (not (and (<= 1 idx8) (<= idx8 r10b))) (= result____split_fields13 result____split_fields7)))
(assert (= result4 (mk_vector__ref (mk___rep (mk___split_discrs amortized_queue__Oconcat__result) (mk___split_fields amortized_queue__Oconcat__result1)))))
(assert (= amortized_queue__Oconcat__result2 (mk___rep result____split_discrs (us_split_fields__content result____split_fields12))))
...
(assert (and (= o14 (length right)) (and (in_range5 o14) (<= o14 (capacity right)))))
(assert (and (= o15 (length left)) (and (in_range5 o15) (<= o15 (capacity left)))))
(assert (= o16 (+ o15 o14)))
(assert (and (= o17 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range5 o17) (<= o17 (capacity (vector__content amortized_queue__Oconcat__result5))))))
(assert (= result5 (ite (= o17 o16) true false)))
(assert (= result5 true))
(assert (and (= o12 (last (model__ left))) (and (in_range4 o12) (= o12 (last (model__ left))))))
(assert (= o13 (ite (<= i1 o12) true false)))
(assert (= result7 (ite (<= 1 i1) o13 false)))
(assert (= (= result6 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (last (model__ left)))) (= (get (model__ (vector__content amortized_queue__Oconcat__result5)) i2) (get (model__ left) i2))))))
(assert (= result6 true))
(assert (and (= o6 (last (model__ right))) (and (in_range4 o6) (= o6 (last (model__ right))))))
(assert (= o7 (ite (<= i o6) true false)))
(assert (= result8 (ite (<= 1 i) o7 false)))
(assert (= result8 true))
(assert (and (= o10 i) (in_range3 i)))
(assert (and (= o11 (get (model__ right) o10)) (and (in_range6 o11) (= o11 (get (model__ right) o10)))))
(assert (and (= o8 (last (model__ left))) (and (in_range4 o8) (= o8 (last (model__ left))))))
(assert (= o9 (+ o8 i)))
