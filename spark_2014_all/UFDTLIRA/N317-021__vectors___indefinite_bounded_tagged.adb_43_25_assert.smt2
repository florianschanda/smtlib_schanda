...
(assert (not (= (let ((temp___602 (f 3))) (let ((temp___601 (get (model__ (mk___rep w__split_discrs w__split_fields1)) 3))) (ite (= (attr__tag temp___601) (attr__tag temp___602)) (us_dispatch_eq temp___601 temp___602) false))) true)))
(check-sat)
(exit)
