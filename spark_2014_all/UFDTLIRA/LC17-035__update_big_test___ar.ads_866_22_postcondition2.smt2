...
(declare-const temp___6840 et3)
(declare-const temp___68401 et1)
(declare-const temp___68402 et2)
(declare-const temp___68403 enum1ta)
...
(assert (= temp___6840 o5))
(assert (= temp___68401 o6))
(assert (= temp___68402 o7))
(assert (= temp___68403 o8))
...
(assert (= r__split_fields8 (mk___split_fields1 temp___6840 (mk___rep (mk___split_fields temp___68401 temp___68402)) temp___68403)))
(assert (= r__split_fields9 (mk___split_fields__ref1 r__split_fields8)))
(assert (= r__split_fields10 r__split_fields8))
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields__content1 r__split_fields9))) (to_rep2 r__split_fields))))
(check-sat)
(exit)
