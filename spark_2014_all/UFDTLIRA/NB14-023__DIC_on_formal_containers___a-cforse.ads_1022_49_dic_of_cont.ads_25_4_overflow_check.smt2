...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_1387 us_rep2) (temp___skip_top_level_1388 Bool)) Bool (=> (not (= temp___skip_top_level_1388 true)) (= (is_empty temp___expr_1387) true)))
