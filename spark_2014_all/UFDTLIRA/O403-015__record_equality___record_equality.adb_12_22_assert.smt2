...
(assert (not (= (bool_eq (mk___rep r_pu1__split_discrs (mk___split_fields r_pu1__split_fields r_pu1__split_fields1) r_pu1__attr__tag) (mk___rep r_pu2__split_discrs (mk___split_fields r_pu2__split_fields r_pu2__split_fields1) r_pu2__attr__tag)) true)))
(check-sat)
(exit)
