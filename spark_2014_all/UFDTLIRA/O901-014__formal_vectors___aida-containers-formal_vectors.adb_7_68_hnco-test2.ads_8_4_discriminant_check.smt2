...
(define-fun dynamic_invariant ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= 0 2147483647)) (in_range1 temp___expr_219)))
...
(declare-const o6 capacity_range1)
(declare-const o7 us_main_type)
(assert (and (= (mk___rep (mk___split_discrs o) (mk___split_fields o1)) (empty_vector Tuple0)) (= (length (mk___rep (mk___split_discrs o) (mk___split_fields o1))) 0)))
(assert (= o o2))
(assert (= o3 o2))
(assert (= hnco__test2__v_type_owner__empty_vector__R185s__R186s__assume (to_rep1 o3)))
(assert (= hnco__test2__v_type_owner__empty_vector__R185s__R186s__assume r186s))
(assert (in_range1 r186s))
(assert (and (= (mk___rep (mk___split_discrs o4) (mk___split_fields o5)) (empty_vector Tuple0)) (= (length (mk___rep (mk___split_discrs o4) (mk___split_fields o5))) 0)))
(assert (not (= r186s (to_rep1 o4))))
(check-sat)
(exit)
