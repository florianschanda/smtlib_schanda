...
(define-fun in_range ((x Int)) Bool (and (<= 1 x) (<= x 25)))
(declare-fun attr__ATTRIBUTE_IMAGE (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE (us_image) Int)
(declare-fun user_eq (et2 et2) Bool)
(declare-const dummy et2)
(declare-datatypes () ((et2__ref (mk_et2__ref (et2__content et2)))))
(define-fun et2__ref___projection ((a et2__ref)) et2 (et2__content a))
(define-fun dynamic_invariant ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 1 25)) (in_range temp___expr_211)))
(define-fun to_rep ((x et2)) Int (et2qtint x))
(declare-fun of_rep (Int) et2)
(assert (forall ((x et2)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x et2)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun user_eq2 (enum1ta enum1ta) Bool)
(declare-const dummy2 enum1ta)
...
(declare-fun to_rep2 (enum1ta) Int)
(declare-fun of_rep2 (Int) enum1ta)
(assert (forall ((x enum1ta)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x enum1ta)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__ar__rec1t__f1 (us_split_fields1 a))) (to_rep3 (rec__ar__rec1t__f1 (us_split_fields1 b)))) (= (to_rep (rec__ar__rec1t__g1 (us_split_fields1 a))) (to_rep (rec__ar__rec1t__g1 (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_218 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 10 90)) (in_range1 temp___expr_218)))
(define-fun dynamic_invariant3 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 4)) (in_range2 temp___expr_246)))
...
(declare-const temp___6698 et3)
(declare-const temp___66981 et1)
(declare-const temp___66982 et2)
(declare-const temp___66983 enum1ta)
(declare-const result et3)
(declare-const result1 et1)
(declare-const result2 et2)
(declare-const result3 enum1ta)
(declare-const r__split_fields4 et3)
(declare-const r__split_fields5 et1)
(declare-const r__split_fields6 et2)
(declare-const r__split_fields7 enum1ta)
(declare-const r__split_fields8 us_split_fields__ref1)
(declare-const r__split_fields9 us_split_fields2)
(define-fun r__split_fields10 () us_split_fields2 (mk___split_fields1 r__split_fields4 (mk___rep (mk___split_fields r__split_fields5 r__split_fields6)) r__split_fields7))
(assert (in_range e))
(assert (= (to_rep o) e))
(assert (= r__split_fields1 o1))
(assert (= o o2))
(assert (= o3 o1))
(assert (= o4 o2))
...
(assert (= temp___6698 o5))
(assert (= temp___66981 o6))
(assert (= temp___66982 o7))
(assert (= temp___66983 o8))
...
(assert (= temp___6698 r__split_fields4))
(assert (= temp___66981 r__split_fields5))
(assert (= temp___66982 r__split_fields6))
(assert (= temp___66983 r__split_fields7))
(assert (= r__split_fields8 (mk___split_fields__ref1 r__split_fields10)))
(assert (= r__split_fields9 r__split_fields10))
(assert (not (= (to_rep2 (rec__ar__rec2t__h2 (us_split_fields__content1 r__split_fields8))) (to_rep2 r__split_fields3))))
(check-sat)
(exit)
