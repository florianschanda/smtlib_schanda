...
(define-fun dynamic_invariant ((temp___expr_1491 Int) (temp___is_init_1488 Bool) (temp___skip_constant_1489 Bool) (temp___do_toplevel_1490 Bool)) Bool (=> (or (= temp___is_init_1488 true) (<= 0 2147483647)) (in_range2 temp___expr_1491)))
...
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range5 temp___expr_173)))
...
(assert (and (= o3 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range4 o3) (= o3 (ite (= (of_int 1) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity container__split_discrs)) 2147483647)))))
