...
(define-fun dynamic_invariant ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_221)))
...
(define-fun dynamic_invariant1 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 1000)) (in_range4 temp___expr_228)))
...
(define-fun dynamic_invariant2 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 1001)) (in_range5 temp___expr_242)))
...
(define-fun dynamic_invariant3 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 1000)) (in_range6 temp___expr_249)))
...
(define-fun dynamic_invariant4 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_235)))
...
(declare-const temp___557 capacity_range)
(declare-const temp___5571 us_main_type)
...
(define-fun result____split_fields12 () us_split_fields (mk___split_fields result____split_fields3))
...
(define-fun result____split_fields13 () us_split_fields (mk___split_fields result____split_fields1))
...
(assert (= amortized_queue__Oconcat__2__result3 (mk_vector__ref amortized_queue__Oconcat__2__result2)))
(assert (= idx7 idx5))
(assert (= result____split_fields8 result____split_fields6))
(assert (= amortized_queue__Oconcat__2__result4 amortized_queue__Oconcat__2__result2))
(assert (= idx8 idx6))
...
(assert (= result____split_fields13 amortized_queue__my_vectors__append__2__container__fields3))
...
(assert (= idx1 r23b))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= temp___558 idx1)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (= result____split_discrs (mk___split_discrs temp___557)) (= temp___5571 result____split_fields1))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (= o1 idx1) (in_range4 idx1))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (= o2 (get (model__ right) o1)) (and (in_range7 o2) (= o2 (get (model__ right) o1))))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (length (mk___rep result____split_discrs result____split_fields13)) 1)) (= (olt (model__ (mk___rep result____split_discrs result____split_fields13)) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (last (model__ (mk___rep result____split_discrs result____split_fields13))) 1)) o2))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= result2 result____split_fields1)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= (mk___split_fields result____split_fields2) amortized_queue__my_vectors__append__2__container__fields2)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= (length (mk___rep result____split_discrs result____split_fields12)) (+ 1 idx2))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= (get (model__ (mk___rep result____split_discrs result____split_fields12)) 1) left)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields12)) (+ 1 i)) (get (model__ right) i))))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (and (=> (<= r23b r24b) (dynamic_property r23b r24b idx2)) (and (<= r23b idx2) (<= idx2 r24b)))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= idx2 r24b)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= idx3 (mk_int__ref idx2))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= result____split_fields4 (mk___split_fields__ref result____split_fields12))))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= idx4 idx2)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= result____split_fields5 result____split_fields12)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= idx5 idx3)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= result____split_fields6 result____split_fields4)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= idx6 idx4)))
(assert (=> (and (<= r23b idx1) (<= idx1 r24b)) (= result____split_fields7 result____split_fields5)))
(assert (=> (not (and (<= r23b idx1) (<= idx1 r24b))) (= idx5 (mk_int__ref idx1))))
(assert (=> (not (and (<= r23b idx1) (<= idx1 r24b))) (= result____split_fields6 (mk___split_fields__ref result____split_fields13))))
(assert (=> (not (and (<= r23b idx1) (<= idx1 r24b))) (= idx6 idx1)))
(assert (=> (not (and (<= r23b idx1) (<= idx1 r24b))) (= result____split_fields7 result____split_fields13)))
(assert (= result3 (mk_vector__ref (mk___rep (mk___split_discrs amortized_queue__Oconcat__2__result) (mk___split_fields amortized_queue__Oconcat__2__result1)))))
(assert (= amortized_queue__Oconcat__2__result2 (mk___rep result____split_discrs (us_split_fields__content result____split_fields6))))
(assert (= amortized_queue__Oconcat__2__result5 amortized_queue__Oconcat__2__result3))
(assert (= idx9 idx7))
(assert (= result____split_fields10 result____split_fields8))
(assert (= amortized_queue__Oconcat__2__result6 amortized_queue__Oconcat__2__result4))
(assert (= idx10 idx8))
(assert (= result____split_fields11 result____split_fields9))
(assert (and (= o3 (length right)) (and (in_range6 o3) (<= o3 (capacity right)))))
(assert (= o4 (+ 1 o3)))
(assert (and (= o5 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range6 o5) (<= o5 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o5 o4) true false)))
(assert (= result4 true))
(assert (not (<= 1 1)))
(check-sat)
(exit)
