...
(assert (and (= o1 (get1 o (mk___rep1 current__split_fields3))) (and (in_range4 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 current__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k (mk___rep1 current__split_fields3)) true) (= (witness o (mk___rep1 current__split_fields3)) (witness o k))))))))))
