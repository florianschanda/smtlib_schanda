...
(assert (and (= o34 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (in_range1 o34) (<= o34 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o35 (ite (<= i2 o34) true false)))
(assert (and (= o32 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (and (not (= (has_key o32 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o32 i4) true) (and (and (<= 1 (get1 o32 i4)) (<= (get1 o32 i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key o32 j) true) (=> (= (get1 o32 i4) (get1 o32 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (and (= o33 (get1 o32 (mk___rep1 (mk___split_fields1 current__split_fields2)))) (and (in_range4 o33) (=> (= (of_int 0) true) (and (= o33 (w_get o32 (witness o32 (mk___rep1 (mk___split_fields1 current__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key o32 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 current__split_fields2))) true) (= (witness o32 (mk___rep1 (mk___split_fields1 current__split_fields2))) (witness o32 k))))))))))
(assert (= o36 (ite (<= o33 i2) true false)))
(assert (= result6 (ite (= o36 true) o35 false)))
(assert (= result6 true))
(assert (and (= o39 i2) (in_range2 i2)))
(assert (and (= o40 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o39)) (in_range3 o40)))
