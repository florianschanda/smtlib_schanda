...
(assert (not (= (bool_eq2 (mk___rep1 current__split_fields4) (mk___rep1 n_last__split_fields3)) true)))
...
(assert (and (= o (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 current__split_fields3))) (and (in_range4 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 current__split_fields3)))) (forall ((k us_rep2)) (=> (= (has_key o k) true) (= (= (bool_eq2 k (mk___rep1 current__split_fields3)) true) (= (witness o (mk___rep1 current__split_fields3)) (witness o k))))))))))
(assert (= o4 (ite (<= o1 i) true false)))
(assert (= result2 (ite (= o4 true) o3 false)))
(assert (= result2 true))
(assert (and (= o5 i) (in_range3 i)))
(assert (and (= o6 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o5)) (in_range2 o6)))
