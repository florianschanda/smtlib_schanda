...
(define-fun temp___2722 () us_rep (mk___rep (mk___split_fields temp___272 temp___2721)))
(declare-const result6 unsigned_byte)
(declare-const result7 unsigned_byte)
(assert (=> (and (<= (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))) (and (= temp___2722 (add_pair_a a b)) (= (bool_eq temp___2722 (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (of_rep (+ (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b)))))))) true))))
