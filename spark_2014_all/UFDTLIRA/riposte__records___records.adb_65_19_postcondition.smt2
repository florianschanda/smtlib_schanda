...
(declare-const temp___304 unsigned_byte)
(declare-const temp___3041 unsigned_byte)
...
(define-fun records__safe_add_pair_a__result8 () us_rep (mk___rep (mk___split_fields records__safe_add_pair_a__result2 records__safe_add_pair_a__result3)))
...
(assert (=> (not (and (<= (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= temp___304 o2)))
(assert (=> (not (and (<= (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= temp___3041 o3)))
...
(assert (=> (not (and (<= (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= temp___304 r__split_fields4)))
(assert (=> (not (and (<= (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b))))) (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255 (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))) (= temp___3041 r__split_fields5)))
...
(assert (= records__safe_add_pair_a__result4 (mk_pair__ref records__safe_add_pair_a__result8)))
(assert (= records__safe_add_pair_a__result5 records__safe_add_pair_a__result8))
