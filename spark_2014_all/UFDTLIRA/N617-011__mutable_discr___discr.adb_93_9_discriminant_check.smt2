...
(define-fun temp___3082 () us_rep (mk___rep (mk___split_discrs temp___308) (mk___split_fields temp___3081)))
(assert (in_range c))
...
(assert (= temp___308 (rec__private_discr__p_no_default__c d__split_discrs)))
(assert (= (mk___rep (mk___split_discrs temp___310) (mk___split_fields temp___3101)) temp___3082))
(assert (= result1 d__split_fields1))
(assert (= temp___3101 d__split_fields2))
(assert (= d__split_discrs (mk___split_discrs temp___310)))
(assert (and (= (mk___rep (mk___split_discrs temp___311) (mk___split_fields temp___3111)) (new_no_default 0)) (= (to_rep temp___311) 0)))
(assert (not (= temp___311 (rec__private_discr__p_no_default__c d__split_discrs))))
(check-sat)
(exit)
