...
(declare-fun page_length__3 (us_rep) Int)
(declare-fun page_length__3__function_guard (Int us_rep) Bool)
...
(assert (= result true))
(assert (and (= o (page_length__3 standard_output)) (in_range2 o)))
