...
(assert (=> (= result3 true) (and (= o12 (element l1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o12) (= o12 (get (model__ l1) (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result3 true) (= o13 (+ o12 1))))
(assert (=> (= result3 true) (and (= o14 o13) (in_range3 o13))))
(assert (=> (= result3 true) (and (and (and (and (and (= (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (+ (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) 1)) (= (get1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))))) (= (keys_included_except (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)) (= (ole1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true)) (= (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) o14)) (= (ole (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields2)))) true))))
(assert (=> (not (= result3 true)) (and (= o15 (element l1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o15) (= o15 (get (model__ l1) (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (not (= result3 true)) (and (and (and (and (and (= (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (+ (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) 1)) (= (get1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))))) (= (keys_included_except (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (last1 (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) true)) (= (ole1 (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (positions (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) true)) (= (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3))) (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) o15)) (= (ole (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields3)))) true))))
(assert (=> (not (= result3 true)) (= (mk___split_fields l2__split_fields2) (mk___split_fields l2__split_fields3))))
(assert (not (or (= (has_key (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) true))))
(check-sat)
(exit)
