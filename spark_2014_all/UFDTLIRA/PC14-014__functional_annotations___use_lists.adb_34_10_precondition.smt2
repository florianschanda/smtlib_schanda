...
(define-fun l2__split_fields4 () us_split_fields (mk___split_fields l2__split_fields3))
(define-fun l2__split_fields5 () us_split_fields (mk___split_fields l2__split_fields2))
(define-fun cu__split_fields3 () us_split_fields2 (mk___split_fields1 cu__split_fields2))
(define-fun l2__split_fields6 () us_split_fields (mk___split_fields l2__split_fields1))
...
(assert (= result1 true))
(assert (forall ((n Int)) (=> (and (<= 1 n) (<= n (length (mk___rep l2__split_discrs l2__split_fields6)))) (= (is_incr (get (model__ l1) n) (get (model__ (mk___rep l2__split_discrs l2__split_fields6)) n)) true))))
(assert (= (get1 (positions l1) (mk___rep1 cu__split_fields3)) (+ (length (mk___rep l2__split_discrs l2__split_fields6)) 1)))
...
(assert (=> (= result2 true) (and (= o1 (element l1 (mk___rep1 cu__split_fields3))) (and (in_range7 o1) (= o1 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3))))))))
(assert (=> (= result2 true) (= o2 (+ o1 1))))
(assert (=> (= result2 true) (and (= o3 o2) (in_range3 o2))))
(assert (=> (= result2 true) (and (and (and (and (and (= (length (mk___rep l2__split_discrs l2__split_fields5)) (+ (length (mk___rep l2__split_discrs l2__split_fields6)) 1)) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields5)) (last1 (mk___rep l2__split_discrs l2__split_fields5))) (length (mk___rep l2__split_discrs l2__split_fields5)))) (= (keys_included_except (positions (mk___rep l2__split_discrs l2__split_fields5)) (positions (mk___rep l2__split_discrs l2__split_fields6)) (last1 (mk___rep l2__split_discrs l2__split_fields5))) true)) (= (ole1 (positions (mk___rep l2__split_discrs l2__split_fields6)) (positions (mk___rep l2__split_discrs l2__split_fields5))) true)) (= (get (model__ (mk___rep l2__split_discrs l2__split_fields5)) (length (mk___rep l2__split_discrs l2__split_fields5))) o3)) (= (ole (model__ (mk___rep l2__split_discrs l2__split_fields6)) (model__ (mk___rep l2__split_discrs l2__split_fields5))) true))))
(assert (=> (not (= result2 true)) (and (= o4 (element l1 (mk___rep1 cu__split_fields3))) (and (in_range7 o4) (= o4 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3))))))))
(assert (=> (not (= result2 true)) (and (and (and (and (and (= (length (mk___rep l2__split_discrs l2__split_fields4)) (+ (length (mk___rep l2__split_discrs l2__split_fields6)) 1)) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) (last1 (mk___rep l2__split_discrs l2__split_fields4))) (length (mk___rep l2__split_discrs l2__split_fields4)))) (= (keys_included_except (positions (mk___rep l2__split_discrs l2__split_fields4)) (positions (mk___rep l2__split_discrs l2__split_fields6)) (last1 (mk___rep l2__split_discrs l2__split_fields4))) true)) (= (ole1 (positions (mk___rep l2__split_discrs l2__split_fields6)) (positions (mk___rep l2__split_discrs l2__split_fields4))) true)) (= (get (model__ (mk___rep l2__split_discrs l2__split_fields4)) (length (mk___rep l2__split_discrs l2__split_fields4))) o4)) (= (ole (model__ (mk___rep l2__split_discrs l2__split_fields6)) (model__ (mk___rep l2__split_discrs l2__split_fields4))) true))))
(assert (=> (not (= result2 true)) (= l2__split_fields5 l2__split_fields4)))
(assert (not (or (= (has_key (positions l1) (mk___rep1 cu__split_fields3)) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true))))
(check-sat)
(exit)
