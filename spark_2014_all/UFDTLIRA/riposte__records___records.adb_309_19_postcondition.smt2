...
(declare-const temp___3811 unsigned_byte)
(declare-const temp___3812 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___381 o5))
(assert (= temp___3811 o6))
(assert (= temp___3812 o7))
(assert (= result3 (mk___split_fields__ref1 tmp__split_fields3)))
(assert (= tmp__split_fields4 (mk___split_fields1 temp___381 (mk___rep (mk___split_fields temp___3811 temp___3812)))))
