...
(declare-const tmp__split_fields Bool)
(declare-const tmp__split_fields1 unsigned_byte)
(declare-const tmp__split_fields2 unsigned_byte)
(declare-const records__update_a__result Bool)
(declare-const records__update_a__result1 unsigned_byte)
(declare-const records__update_a__result2 unsigned_byte)
...
(declare-const temp___4141 unsigned_byte)
(declare-const temp___4142 unsigned_byte)
(declare-const result Bool)
(declare-const result1 unsigned_byte)
(declare-const result2 unsigned_byte)
(declare-const tmp__split_fields3 us_split_fields2)
(declare-const result3 us_split_fields__ref1)
(declare-const tmp__split_fields4 us_split_fields2)
(declare-const result4 optional_pair__ref)
(declare-const records__update_a__result3 us_rep1)
(declare-const records__update_a__result4 optional_pair__ref)
(declare-const records__update_a__result5 us_rep1)
(declare-const tmp__split_fields5 us_split_fields__ref1)
(declare-const records__update_a__result6 optional_pair__ref)
(declare-const tmp__split_fields6 us_split_fields2)
(declare-const records__update_a__result7 us_rep1)
...
(assert (= tmp__split_fields3 (us_split_fields3 x)))
(assert (= (to_rep o) n))
(assert (= o o1))
(assert (= (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair tmp__split_fields3))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= (rec__records_prooffuncs__optional_pair__exists tmp__split_fields3) o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___414 o5))
(assert (= temp___4141 o6))
(assert (= temp___4142 o7))
(assert (= result3 (mk___split_fields__ref1 tmp__split_fields3)))
(assert (= tmp__split_fields4 (mk___split_fields1 temp___414 (mk___rep (mk___split_fields temp___4141 temp___4142)))))
(assert (= records__update_a__result4 (mk_optional_pair__ref records__update_a__result3)))
(assert (= records__update_a__result5 records__update_a__result3))
(assert (= result4 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__update_a__result (mk___rep (mk___split_fields records__update_a__result1 records__update_a__result2)))))))
(assert (= records__update_a__result3 (mk___rep1 tmp__split_fields4)))
(assert (= records__update_a__result6 records__update_a__result4))
(assert (= tmp__split_fields5 (mk___split_fields__ref1 tmp__split_fields4)))
(assert (= records__update_a__result7 records__update_a__result5))
(assert (= tmp__split_fields6 tmp__split_fields4))
(assert (= (mk___rep1 (mk___split_fields1 result5 (mk___rep (mk___split_fields result6 result7)))) (optional_pair__content records__update_a__result6)))
(assert (not (= (bool_eq1 (optional_pair__content records__update_a__result6) (mk___rep1 (mk___split_fields1 (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 x)) (mk___rep (mk___split_fields (of_rep n) (rec__records_prooffuncs__pair__b (us_split_fields1 (rec__records_prooffuncs__optional_pair__the_pair (us_split_fields3 x))))))))) true)))
(check-sat)
(exit)
