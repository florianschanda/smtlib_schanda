...
(declare-fun user_eq3 (type_3 type_3) Bool)
(declare-const dummy3 type_3)
...
(assert (= (to_rep1 o4) 0))
(assert (= o5 (mk___split_fields3 o4 o3 o2 o1 o)))
(assert (= o6 (mk___rep3 o5)))
(assert (= result p__create_type_5__result))
(assert (= (let ((subject p__create_type_5__result)) p__create_type_5__result1) o6))
