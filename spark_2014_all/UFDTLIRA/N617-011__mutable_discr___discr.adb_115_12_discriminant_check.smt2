...
(define-fun dynamic_invariant1 ((temp___expr_237 us_rep) (temp___is_init_234 Bool) (temp___skip_constant_235 Bool) (temp___do_toplevel_236 Bool)) Bool (and (=> (not (= temp___skip_constant_235 true)) (in_range1 c temp___expr_237)) (= (attr__constrained temp___expr_237) true)))
(define-fun default_initial_assumption1 ((temp___expr_239 us_rep) (temp___skip_top_level_240 Bool)) Bool (and (= (attr__constrained temp___expr_239) true) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___expr_239))) c)))
...
(declare-const temp___332 natural)
(declare-const temp___3321 us_main_type)
(declare-const temp___3322 Bool)
...
(assert (= o9 o10))
(assert (= (mk___rep (mk___split_discrs temp___332) (mk___split_fields temp___3321) temp___3322) o9))
