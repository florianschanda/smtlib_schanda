...
(define-fun dynamic_invariant1 ((temp___expr_273 us_rep) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool) (temp___do_typ_inv_272 Bool)) Bool (and (=> (not (= temp___skip_constant_270 true)) (in_range1 c temp___expr_273)) (= (attr__constrained temp___expr_273) true)))
(define-fun default_initial_assumption1 ((temp___expr_275 us_rep) (temp___skip_top_level_276 Bool)) Bool (and (= (attr__constrained temp___expr_275) true) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___expr_275))) c)))
...
(declare-const temp___370 natural)
(declare-const temp___3701 us_main_type)
(declare-const temp___3702 Bool)
...
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o3) (mk___split_fields o4) o5))
(define-fun o10 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1) o2))
(assert (in_range c))
(assert (and (= us c) (in_range c)))
(assert (and (= d__attr__constrained true) (= (to_rep (rec__private_discr__p_with_default__c d__split_discrs)) c)))
(assert (and (= c (to_rep (rec__private_discr__p_with_default__c d__split_discrs))) (= d__attr__constrained true)))
(assert (and (= o10 (new_with_default c)) (= (to_rep o) c)))
(assert (= o9 o10))
(assert (= (mk___rep (mk___split_discrs temp___370) (mk___split_fields temp___3701) temp___3702) o9))
(assert (= result d__split_fields))
(assert (= d__split_fields1 temp___3701))
(assert (= d__split_discrs (mk___split_discrs temp___370)))
(assert (and (= (mk___rep (mk___split_discrs o6) (mk___split_fields o7) o8) (new_with_default 0)) (= (to_rep o6) 0)))
