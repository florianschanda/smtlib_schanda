...
(assert (=> (= result true) (= o4 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))))
(assert (=> (= result true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result true) (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields2 theadmin__split_fields3)))) (in_range3 o1))))
(assert (=> (= result true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result true) (= o3 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))))))
