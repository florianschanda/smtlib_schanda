...
(assert (not (or (< (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))) (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) o11) true))))
(check-sat)
(exit)
