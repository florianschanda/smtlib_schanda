...
(assert (not (= (let ((temp___648 (f 4))) (let ((temp___647 (get (model__ (mk___rep1 v__split_discrs v__split_fields7)) 2))) (ite (= (attr__tag temp___647) (attr__tag temp___648)) (us_dispatch_eq temp___647 temp___648) false))) true)))
(check-sat)
(exit)
