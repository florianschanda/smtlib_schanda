...
(assert (not (<= (- (length s2) (length (intersection__2 (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) s2))) (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs)) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))))
(check-sat)
(exit)
