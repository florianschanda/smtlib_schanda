...
(define-fun dynamic_invariant ((temp___expr_320 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool) (temp___do_typ_inv_319 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 100)) (in_range1 temp___expr_320)))
...
(define-fun dynamic_invariant1 ((temp___expr_327 Int) (temp___is_init_323 Bool) (temp___skip_constant_324 Bool) (temp___do_toplevel_325 Bool) (temp___do_typ_inv_326 Bool)) Bool (=> (or (= temp___is_init_323 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_327)))
...
(define-fun dynamic_invariant3 ((temp___expr_334 Int) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool) (temp___do_typ_inv_333 Bool)) Bool (=> (or (= temp___is_init_330 true) (<= 0 100)) (in_range5 temp___expr_334)))
