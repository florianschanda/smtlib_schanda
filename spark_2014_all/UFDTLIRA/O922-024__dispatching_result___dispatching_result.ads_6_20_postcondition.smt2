...
(assert (= (mk___rep (mk___split_fields dispatching_result__init__result9 dispatching_result__init__result10) dispatching_result__init__result11) (mk___rep (mk___split_fields dispatching_result__init__result3 dispatching_result__init__result4) dispatching_result__init__result5)))
(assert (= (to_rep o) v))
(assert (= o o1))
...
(assert (= (mk___rep (mk___split_fields dispatching_result__init__result3 dispatching_result__init__result4) dispatching_result__init__result5) (mk___rep (mk___split_fields o3 o4) o5)))
