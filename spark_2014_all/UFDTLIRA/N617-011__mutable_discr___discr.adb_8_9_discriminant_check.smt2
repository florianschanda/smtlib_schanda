...
(declare-const temp___300 natural)
(declare-const o4 natural)
(declare-const o5 natural)
(declare-const temp___301 natural)
(assert (in_range c))
(assert (= (to_rep o) c))
(assert (= o o1))
...
(assert (= temp___298 (rec__discr__no_default__c d__split_discrs)))
(assert (= (mk___rep (mk___split_discrs temp___300)) (mk___rep (mk___split_discrs temp___298))))
(assert (= d__split_discrs (mk___split_discrs temp___300)))
(assert (= (to_rep o4) 0))
(assert (= o4 o5))
(assert (= temp___301 o5))
(assert (not (= temp___301 (rec__discr__no_default__c d__split_discrs))))
(check-sat)
(exit)
