...
(assert (and (= o13 (length orear)) (and (in_range4 o13) (<= o13 (capacity orear)))))
(assert (and (= o14 (length ofront)) (and (in_range4 o14) (<= o14 (capacity ofront)))))
(assert (= o15 (+ o14 o13)))
(assert (and (= o16 (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))) (and (in_range4 o16) (<= o16 (capacity (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))))))
(assert (= result3 (ite (= o16 o15) true false)))
(assert (= result3 true))
(assert (and (= o12 (length (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))) (and (in_range4 o12) (<= o12 (capacity (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))))))
...
(assert (and (= o9 (get (model__ orear) o8)) (and (in_range5 o9) (= o9 (get (model__ orear) o8)))))
