...
(define-fun dynamic_invariant ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range1 temp___expr_183)))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o1) (= o1 (ite (= (of_int 0) true) (to_rep (rec__unbounded_strings__char_vectors__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
