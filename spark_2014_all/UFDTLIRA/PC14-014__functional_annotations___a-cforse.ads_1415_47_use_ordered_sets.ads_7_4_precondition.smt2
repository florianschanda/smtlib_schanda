...
(assert (and (= o (length container)) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 container)))))))
