...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__account8__protected_natural__the_data natural) (rec__account8__protected_natural__not_full Bool)))))
(define-fun us_split_fields_The_Data__projection ((a us_split_fields)) natural (rec__account8__protected_natural__the_data a))
(define-fun us_split_fields_Not_Full__projection ((a us_split_fields)) Bool (rec__account8__protected_natural__not_full a))
...
(assert (< account8__protected_natural__the_data__first__bit account8__protected_natural__the_data__last__bit))
...
(assert (< account8__protected_natural__not_full__first__bit account8__protected_natural__not_full__last__bit))
(assert (<= 0 account8__protected_natural__not_full__position))
(declare-fun user_eq2 (us_rep us_rep) Bool)
(declare-datatypes () ((protected_natural__ref (mk_protected_natural__ref (protected_natural__content us_rep)))))
(define-fun protected_natural__ref___projection ((a protected_natural__ref)) us_rep (protected_natural__content a))
(define-fun default_initial_assumption ((temp___expr_201 us_rep) (temp___skip_top_level_202 Bool)) Bool (and (= (to_rep (rec__account8__protected_natural__the_data (us_split_fields1 temp___expr_201))) 0) (= (rec__account8__protected_natural__not_full (us_split_fields1 temp___expr_201)) (distinct 1 0))))
