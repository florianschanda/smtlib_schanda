...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (and (= (to_rep (rec__account8__protected_natural__the_data (us_split_fields1 temp___expr_172))) 0) (= (rec__account8__protected_natural__not_full (us_split_fields1 temp___expr_172)) (of_int 1))))
