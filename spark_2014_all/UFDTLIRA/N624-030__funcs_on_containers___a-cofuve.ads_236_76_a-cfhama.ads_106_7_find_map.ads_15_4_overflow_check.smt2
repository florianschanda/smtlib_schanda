...
(define-fun dynamic_invariant ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 1 2147483647)) (in_range2 temp___expr_391)))
...
(define-fun dynamic_invariant1 ((temp___expr_403 Int) (temp___is_init_400 Bool) (temp___skip_constant_401 Bool) (temp___do_toplevel_402 Bool)) Bool (=> (or (= temp___is_init_400 true) (<= 0 2147483647)) (in_range3 temp___expr_403)))
...
(define-fun default_initial_assumption ((temp___expr_410 us_rep) (temp___skip_top_level_411 Bool)) Bool (=> (not (= temp___skip_top_level_411 true)) (= (length temp___expr_410) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 2147483647)) (in_range4 temp___expr_174)))
...
(define-fun dynamic_invariant3 ((temp___expr_397 Int) (temp___is_init_394 Bool) (temp___skip_constant_395 Bool) (temp___do_toplevel_396 Bool)) Bool (=> (or (= temp___is_init_394 true) (<= 0 2147483647)) (in_range5 temp___expr_397)))
