...
(assert (and (= o8 (length m)) (and (in_range4 o8) (<= o8 (capacity m)))))
(assert (and (= o6 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o6) (<= o6 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o7 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o7) (<= o7 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o9 (+ o7 o6)))
(assert (= result1 (ite (= o9 o8) true false)))
(assert (=> (= result1 true) (and (= o5 (length m)) (and (in_range4 o5) (<= o5 (capacity m))))))
(assert (=> (= result1 true) (= result (ite (<= o5 1000) true false))))
