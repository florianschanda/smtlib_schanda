...
(define-fun dynamic_invariant1 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1 2147483647)) (in_range3 temp___expr_286)))
...
(declare-const temp___544 count_type)
(declare-const o2 Int)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___544 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___544)) no_element))
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__my_lists__my_lists__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__my_lists__my_lists__list__capacity target__split_discrs)) o2)))
