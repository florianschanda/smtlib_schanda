...
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))
(assert (not (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (+ (length (mk___rep s2__split_discrs s2__split_fields)) i)))))
(check-sat)
(exit)
