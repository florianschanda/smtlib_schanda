...
(declare-const temp___243 integer)
(declare-const temp___2431 integer)
(declare-const temp___2432 integer)
(declare-const temp___2433 integer)
(declare-const temp___2434 integer)
(declare-const temp___2435 integer)
...
(assert (= temp___243 o8))
(assert (= temp___2431 o9))
(assert (= temp___2432 o10))
(assert (= temp___2433 o11))
(assert (= temp___2434 o12))
(assert (= temp___2435 o13))
...
(assert (= tmp__split_fields6 (mk___split_fields1 (mk___rep (mk___split_fields temp___243 temp___2431 temp___2432)) (mk___rep (mk___split_fields temp___2433 temp___2434 temp___2435)))))
