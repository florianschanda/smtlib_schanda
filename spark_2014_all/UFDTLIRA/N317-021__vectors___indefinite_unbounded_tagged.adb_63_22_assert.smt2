...
(assert (not (= (let ((temp___644 (f 3))) (let ((temp___643 (get (model__ (mk___rep1 v__split_discrs v__split_fields7)) 1))) (ite (= (attr__tag temp___643) (attr__tag temp___644)) (us_dispatch_eq temp___643 temp___644) false))) true)))
(check-sat)
(exit)
