...
(assert (forall ((x enum1t)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x enum1t)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 4)) (in_range1 temp___expr_246)))
(declare-fun to_rep1 (enum1ta) Int)
(declare-fun of_rep1 (Int) enum1ta)
(assert (forall ((x enum1ta)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x enum1ta)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun to_rep3 ((x et1)) Int (et1qtint x))
(declare-fun of_rep3 (Int) et1)
(assert (forall ((x et1)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x et1)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-const dummy4 et2)
(declare-datatypes () ((et2__ref (mk_et2__ref (et2__content et2)))))
(define-fun et2__ref___projection ((a et2__ref)) et2 (et2__content a))
(define-fun to_rep4 ((x et2)) Int (et2qtint x))
(declare-fun of_rep4 (Int) et2)
(assert (forall ((x et2)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x et2)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__ar__rec1t__f1 (us_split_fields1 a))) (to_rep3 (rec__ar__rec1t__f1 (us_split_fields1 b)))) (= (to_rep4 (rec__ar__rec1t__g1 (us_split_fields1 a))) (to_rep4 (rec__ar__rec1t__g1 (us_split_fields1 b))))) true false))
...
(define-fun to_rep5 ((x et4)) Int (et4qtint x))
(declare-fun of_rep5 (Int) et4)
(assert (forall ((x et4)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x et4)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (bool_eq1 (rec__ar__rec3t__f3 (us_split_fields5 a)) (rec__ar__rec3t__f3 (us_split_fields5 b))) true) (= (to_rep5 (rec__ar__rec3t__g3 (us_split_fields5 a))) (to_rep5 (rec__ar__rec3t__g3 (us_split_fields5 b))))) true false))
...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__ar__rec4t__f4 us_rep2) (rec__ar__rec4t__g4 enum1t)))))
(define-fun us_split_fields_F4__projection ((a us_split_fields6)) us_rep2 (rec__ar__rec4t__f4 a))
(define-fun us_split_fields_G4__projection ((a us_split_fields6)) enum1t (rec__ar__rec4t__g4 a))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (bool_eq2 (rec__ar__rec4t__f4 (us_split_fields7 a)) (rec__ar__rec4t__f4 (us_split_fields7 b))) true) (= (to_rep (rec__ar__rec4t__g4 (us_split_fields7 a))) (to_rep (rec__ar__rec4t__g4 (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((rec4t__ref (mk_rec4t__ref (rec4t__content us_rep3)))))
(define-fun rec4t__ref___projection ((a rec4t__ref)) us_rep3 (rec4t__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant1 ((temp___expr_204 Int) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool) (temp___do_typ_inv_203 Bool)) Bool (=> (or (= temp___is_init_200 true) (<= 0 99)) (in_range3 temp___expr_204)))
(define-fun dynamic_invariant2 ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 1 25)) (in_range4 temp___expr_211)))
(define-fun dynamic_invariant3 ((temp___expr_218 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool) (temp___do_typ_inv_217 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 10 90)) (in_range2 temp___expr_218)))
...
(define-fun dynamic_invariant5 ((temp___expr_232 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 6)) (in_range temp___expr_232)))
...
(declare-const o Int)
(declare-const o1 enum1ta)
(declare-const o2 et3)
(declare-const o3 et1)
(declare-const o4 et2)
(declare-const o5 enum1ta)
...
(declare-const o14 et4)
(declare-const o15 us_rep2)
(declare-const o16 us_split_fields6)
(declare-const temp___7298 us_rep3)
(declare-const o17 enum1t)
(declare-const o18 us_split_fields6)
(declare-const temp___7300 us_rep3)
(declare-const o19 enum1t)
...
(declare-const r__split_fields8 us_split_fields__ref3)
...
(assert (and (= o (to_rep r__split_fields5)) (in_range1 (to_rep r__split_fields5))))
(assert (= (to_rep1 o1) o))
...
(assert (= o15 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o10 (mk___rep (mk___split_fields o11 o12)) o13)) o14))))
(assert (= o16 (mk___split_fields3 o15 r__split_fields5)))
(assert (= temp___7298 (mk___rep3 o16)))
(assert (= result1 (mk___split_fields__ref3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)) r__split_fields3)) r__split_fields4)) r__split_fields5))))
(assert (= r__split_fields6 (us_split_fields7 temp___7298)))
(assert (= (to_rep o17) temp1))
(assert (= o18 (mk___split_fields3 (rec__ar__rec4t__f4 r__split_fields6) o17)))
(assert (= temp___7300 (mk___rep3 o18)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields6)))
(assert (= r__split_fields7 (us_split_fields7 temp___7300)))
...
(assert (= (to_rep o19) (to_rep1 r__split_fields3)))
(assert (not (in_range1 (to_rep r__split_fields5))))
(check-sat)
(exit)
