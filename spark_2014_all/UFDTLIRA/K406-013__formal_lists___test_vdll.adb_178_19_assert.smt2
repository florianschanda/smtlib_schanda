...
(assert (= (bool_eq1 (find (mk___rep l1__split_discrs l1__split_fields4) 3 no_element) (next (mk___rep l1__split_discrs l1__split_fields4) (first (mk___rep l1__split_discrs l1__split_fields4)))) true))
(assert (= (bool_eq1 (find (mk___rep l1__split_discrs l1__split_fields4) 4 no_element) (last1 (mk___rep l1__split_discrs l1__split_fields4))) true))
(assert (= (bool_eq1 (find (mk___rep l1__split_discrs l1__split_fields4) 3 no_element) (previous (mk___rep l1__split_discrs l1__split_fields4) (last1 (mk___rep l1__split_discrs l1__split_fields4)))) true))
(assert (= (bool_eq1 (find (mk___rep l1__split_discrs l1__split_fields4) 1 (next (mk___rep l1__split_discrs l1__split_fields4) (first (mk___rep l1__split_discrs l1__split_fields4)))) no_element) true))
...
(assert (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2)))) true))
(assert (= (test_element (mk___rep l3__split_discrs l3__split_fields2) (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2))) 3) true))
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) (next (mk___rep l1__split_discrs l1__split_fields4) (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2))))) true)))
(assert (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields2) 3 no_element) (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2)))) true))
(assert (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields2) 3 no_element) (last1 (mk___rep l3__split_discrs l3__split_fields2))) true))
(assert (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields2) 1 no_element) (first (mk___rep l3__split_discrs l3__split_fields2))) true))
(assert (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields2) 1 no_element) (previous (mk___rep l3__split_discrs l3__split_fields2) (last1 (mk___rep l3__split_discrs l3__split_fields2)))) true))
(assert (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields2) 1 (next (mk___rep l3__split_discrs l3__split_fields2) (first (mk___rep l3__split_discrs l3__split_fields2)))) no_element) true))
(assert (= (to_rep e__split_fields) 0))
(assert true)
(assert (and (= o56 (copy (mk___rep l1__split_discrs l1__split_fields4) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))) (and (and (= (oeq (model__ o56) (model__ (mk___rep l1__split_discrs l1__split_fields4))) true) (= (oeq1 (positions o56) (positions (mk___rep l1__split_discrs l1__split_fields4))) true)) (ite (= (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)) 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o56))) (to_rep (rec__formal_container__vdll__list__capacity l1__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o56))) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))))))
(assert (= o57 o56))
(assert (= temp___418 o57))
(assert (= result11 (mk___split_fields__ref (mk___split_fields l4__split_fields))))
(assert (= l4__split_fields1 (us_split_fields1 temp___418)))
(assert (= l4__split_discrs (us_split_discrs1 temp___418)))
(assert (ite (= (<= (length (mk___rep l4__split_discrs l4__split_fields1)) 2) true) (= (length (mk___rep l4__split_discrs formal_container__vdll__delete_last__2__container__fields)) 0) (and (and (= (length (mk___rep l4__split_discrs formal_container__vdll__delete_last__2__container__fields)) (- (length (mk___rep l4__split_discrs l4__split_fields1)) 2)) (= (ole (model__ (mk___rep l4__split_discrs formal_container__vdll__delete_last__2__container__fields)) (model__ (mk___rep l4__split_discrs l4__split_fields1))) true)) (= (p_positions_truncated (positions (mk___rep l4__split_discrs formal_container__vdll__delete_last__2__container__fields)) (positions (mk___rep l4__split_discrs l4__split_fields1)) (+ (length (mk___rep l4__split_discrs formal_container__vdll__delete_last__2__container__fields)) 1) 2) true))))
(assert (= result12 (mk___split_fields__ref l4__split_fields1)))
(assert (= l4__split_fields2 formal_container__vdll__delete_last__2__container__fields))
(assert (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) (first (mk___rep l4__split_discrs l4__split_fields2))) true))
(assert (= (test_element (mk___rep l4__split_discrs l4__split_fields2) (first (mk___rep l4__split_discrs l4__split_fields2)) 1) true))
(assert (not (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) (next (mk___rep l1__split_discrs l1__split_fields4) (first (mk___rep l4__split_discrs l4__split_fields2)))) true)))
(assert (= (bool_eq1 (find (mk___rep l4__split_discrs l4__split_fields2) 1 no_element) (first (mk___rep l4__split_discrs l4__split_fields2))) true))
(assert (= (to_rep e__split_fields1) 0))
(assert true)
(assert (and (= o65 (copy (mk___rep l1__split_discrs l1__split_fields4) 3)) (and (and (= (oeq (model__ o65) (model__ (mk___rep l1__split_discrs l1__split_fields4))) true) (= (oeq1 (positions o65) (positions (mk___rep l1__split_discrs l1__split_fields4))) true)) (ite (= 3 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o65))) (to_rep (rec__formal_container__vdll__list__capacity l1__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o65))) 3)))))
(assert (= o66 o65))
(assert (= temp___423 o66))
...
(assert (and (and (and (and (= (length (mk___rep l2__split_discrs formal_container__vdll__delete_last__container__fields1)) (- (length (mk___rep l2__split_discrs l2__split_fields5)) 1)) (= (ole (model__ (mk___rep l2__split_discrs formal_container__vdll__delete_last__container__fields1)) (model__ (mk___rep l2__split_discrs l2__split_fields5))) true)) (not (= (has_key (positions (mk___rep l2__split_discrs formal_container__vdll__delete_last__container__fields1)) (last1 (mk___rep l2__split_discrs l2__split_fields5))) true))) (= (keys_included_except (positions (mk___rep l2__split_discrs l2__split_fields5)) (positions (mk___rep l2__split_discrs l2__split_fields5)) (last1 (mk___rep l2__split_discrs l2__split_fields5))) true)) (= (ole1 (positions (mk___rep l2__split_discrs formal_container__vdll__delete_last__container__fields1)) (positions (mk___rep l2__split_discrs l2__split_fields5))) true)))
(assert (= result14 (mk___split_fields__ref l2__split_fields5)))
(assert (= l2__split_fields6 formal_container__vdll__delete_last__container__fields1))
(assert (= result15 (mk___split_fields__ref l3__split_fields2)))
(assert (= l3__split_fields3 l1__split_fields4))
(assert (= l3__split_discrs l1__split_discrs))
(assert (and (and (= (length (mk___rep l3__split_discrs formal_container__vdll__delete_first__container__fields)) (- (length (mk___rep l3__split_discrs l3__split_fields3)) 1)) (= (range_shifted (model__ (mk___rep l3__split_discrs formal_container__vdll__delete_first__container__fields)) (model__ (mk___rep l3__split_discrs l3__split_fields3)) 1 (length (mk___rep l3__split_discrs formal_container__vdll__delete_first__container__fields)) 1) true)) (= (p_positions_shifted (positions (mk___rep l3__split_discrs formal_container__vdll__delete_first__container__fields)) (positions (mk___rep l3__split_discrs l3__split_fields3)) 1 1) true)))
(assert (= result16 (mk___split_fields__ref l3__split_fields3)))
(assert (= l3__split_fields4 formal_container__vdll__delete_first__container__fields))
(assert (= (length (mk___rep l3__split_discrs l3__split_fields4)) 2))
(assert (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) (first (mk___rep l3__split_discrs l3__split_fields4))) true))
(assert (= (test_element (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4)) 3) true))
(assert (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) (next (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4)))) true))
(assert (= (test_element (mk___rep l3__split_discrs l3__split_fields4) (next (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4))) 4) true))
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) (first (mk___rep l1__split_discrs l1__split_fields4))) true)))
(assert (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields4) 4 no_element) (next (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4)))) true))
(assert (= (bool_eq1 (find (mk___rep l3__split_discrs l3__split_fields4) 3 (next (mk___rep l3__split_discrs l3__split_fields4) (first (mk___rep l3__split_discrs l3__split_fields4)))) no_element) true))
(assert (= (to_rep e__split_fields2) 0))
(assert true)
(assert (and (= o79 (copy (mk___rep l1__split_discrs l1__split_fields4) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))) (and (and (= (oeq (model__ o79) (model__ (mk___rep l1__split_discrs l1__split_fields4))) true) (= (oeq1 (positions o79) (positions (mk___rep l1__split_discrs l1__split_fields4))) true)) (ite (= (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)) 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o79))) (to_rep (rec__formal_container__vdll__list__capacity l1__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o79))) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))))))
(assert (= o80 o79))
(assert (= temp___430 o80))
(assert (= result17 (mk___split_fields__ref l4__split_fields2)))
(assert (= l4__split_fields3 (us_split_fields1 temp___430)))
(assert (= l4__split_discrs (us_split_discrs1 temp___430)))
(assert (ite (= (<= (length (mk___rep l4__split_discrs l4__split_fields3)) 2) true) (= (length (mk___rep l4__split_discrs formal_container__vdll__delete_first__2__container__fields)) 0) (and (and (= (length (mk___rep l4__split_discrs formal_container__vdll__delete_first__2__container__fields)) (- (length (mk___rep l4__split_discrs l4__split_fields3)) 2)) (= (range_shifted (model__ (mk___rep l4__split_discrs formal_container__vdll__delete_first__2__container__fields)) (model__ (mk___rep l4__split_discrs l4__split_fields3)) 1 (length (mk___rep l4__split_discrs formal_container__vdll__delete_first__2__container__fields)) 2) true)) (= (p_positions_shifted (positions (mk___rep l4__split_discrs formal_container__vdll__delete_first__2__container__fields)) (positions (mk___rep l4__split_discrs l4__split_fields3)) 1 2) true))))
(assert (= result18 (mk___split_fields__ref l4__split_fields3)))
(assert (= l4__split_fields4 formal_container__vdll__delete_first__2__container__fields))
(assert (= (length (mk___rep l4__split_discrs l4__split_fields4)) 1))
(assert (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) (first (mk___rep l4__split_discrs l4__split_fields4))) true))
(assert (= (test_element (mk___rep l4__split_discrs l4__split_fields4) (first (mk___rep l4__split_discrs l4__split_fields4)) 4) true))
(assert (not (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) (next (mk___rep l1__split_discrs l1__split_fields4) (first (mk___rep l1__split_discrs l1__split_fields4)))) true)))
(assert (not (= (bool_eq1 (find (mk___rep l4__split_discrs l4__split_fields4) 4 no_element) (first (mk___rep l4__split_discrs l4__split_fields4))) true)))
(check-sat)
(exit)
