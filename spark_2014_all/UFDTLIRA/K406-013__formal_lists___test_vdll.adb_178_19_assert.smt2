...
(define-fun default_initial_assumption ((temp___expr_186 us_rep1) (temp___skip_top_level_187 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_186))) 0))
...
(define-fun default_initial_assumption5 ((temp___expr_245 us_rep3) (temp___skip_top_level_246 Bool)) Bool (=> (not (= temp___skip_top_level_246 true)) (and (= (is_empty1 temp___expr_245) true) (= (length2 temp___expr_245) 0))))
(declare-fun keys_included (us_rep3 us_rep3) Bool)
(declare-fun keys_included__function_guard (Bool us_rep3 us_rep3) Bool)
(define-fun default_initial_assumption6 ((temp___expr_231 us_rep1) (temp___skip_top_level_232 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_231))) 0))
...
(define-fun default_initial_assumption7 ((temp___expr_223 us_rep2) (temp___skip_top_level_224 Bool)) Bool (=> (not (= temp___skip_top_level_224 true)) (= (length1 temp___expr_223) 0)))
...
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant10 result true false true true)))) :pattern ((get1 container key))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant1 (length2 container) true false true true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant1 result true false true true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant1 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant10 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(declare-const temp___489 us_rep1)
...
(assert (= temp___489 (mk___rep1 o1)))
(assert (= temp___489 no_element))
...
(assert (and (= temp___455 (next (mk___rep l2__split_discrs l2__split_fields3) o6)) (ite (= (ite (= (bool_eq1 o6 no_element) false) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields3)) o6) (length (mk___rep l2__split_discrs l2__split_fields3))) true) true) (= (bool_eq1 temp___455 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields3)) temp___455) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields3)) temp___455) (+ (get1 (positions (mk___rep l2__split_discrs l2__split_fields3)) o6) 1))))))
...
(assert (= o10 o9))
(assert (= temp___464 o10))
(assert (= result11 (mk___split_fields__ref (mk___split_fields l4__split_fields))))
(assert (= l4__split_fields1 (us_split_fields1 temp___464)))
(assert (= l4__split_discrs (us_split_discrs1 temp___464)))
...
(assert (= o12 o11))
(assert (= temp___469 o12))
(assert (= result13 (mk___split_fields__ref l2__split_fields4)))
(assert (= l2__split_fields5 (us_split_fields1 temp___469)))
(assert (= l2__split_discrs (us_split_discrs1 temp___469)))
...
(assert (= o14 o13))
(assert (= temp___476 o14))
(assert (= result17 (mk___split_fields__ref l4__split_fields2)))
(assert (= l4__split_fields3 (us_split_fields1 temp___476)))
(assert (= l4__split_discrs (us_split_discrs1 temp___476)))
