...
(assert (and (= o4 (copy (mk___rep l2__split_discrs l2__split_fields3) 3)) (and (and (= (oeq (model__ o4) (model__ (mk___rep l2__split_discrs l2__split_fields3))) true) (= (oeq1 (positions o4) (positions (mk___rep l2__split_discrs l2__split_fields3))) true)) (ite (= 3 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o4))) (to_rep (rec__formal_container__vdll__list__capacity l2__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o4))) 3)))))
(assert (= o5 o4))
...
(assert (and (= o6 (first (mk___rep l2__split_discrs l2__split_fields3))) (ite (= (= (length (mk___rep l2__split_discrs l2__split_fields3)) 0) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields3)) o6) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields3)) o6) 1)))))
(assert (and (= temp___409 (next (mk___rep l2__split_discrs l2__split_fields3) o6)) (ite (= (ite (= (bool_eq1 o6 no_element) false) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields3)) o6) (length (mk___rep l2__split_discrs l2__split_fields3))) true) true) (= (bool_eq1 temp___409 no_element) true) (and (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields3)) temp___409) true) (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields3)) temp___409) (+ (get1 (positions (mk___rep l2__split_discrs l2__split_fields3)) o6) 1))))))
...
(assert (and (= o7 (copy (mk___rep l2__split_discrs l2__split_fields4) 3)) (and (and (= (oeq (model__ o7) (model__ (mk___rep l2__split_discrs l2__split_fields4))) true) (= (oeq1 (positions o7) (positions (mk___rep l2__split_discrs l2__split_fields4))) true)) (ite (= 3 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o7))) (to_rep (rec__formal_container__vdll__list__capacity l2__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o7))) 3)))))
(assert (= o8 o7))
...
(assert (and (= o9 (copy (mk___rep l1__split_discrs l1__split_fields4) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))) (and (and (= (oeq (model__ o9) (model__ (mk___rep l1__split_discrs l1__split_fields4))) true) (= (oeq1 (positions o9) (positions (mk___rep l1__split_discrs l1__split_fields4))) true)) (ite (= (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)) 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o9))) (to_rep (rec__formal_container__vdll__list__capacity l1__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o9))) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))))))
(assert (= o10 o9))
...
(assert (and (= o11 (copy (mk___rep l1__split_discrs l1__split_fields4) 3)) (and (and (= (oeq (model__ o11) (model__ (mk___rep l1__split_discrs l1__split_fields4))) true) (= (oeq1 (positions o11) (positions (mk___rep l1__split_discrs l1__split_fields4))) true)) (ite (= 3 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o11))) (to_rep (rec__formal_container__vdll__list__capacity l1__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o11))) 3)))))
(assert (= o12 o11))
...
(assert (and (= o13 (copy (mk___rep l1__split_discrs l1__split_fields4) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))) (and (and (= (oeq (model__ o13) (model__ (mk___rep l1__split_discrs l1__split_fields4))) true) (= (oeq1 (positions o13) (positions (mk___rep l1__split_discrs l1__split_fields4))) true)) (ite (= (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)) 0) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o13))) (to_rep (rec__formal_container__vdll__list__capacity l1__split_discrs))) (= (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 o13))) (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))))))
(assert (= o14 o13))
(assert (= temp___430 o14))
