...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity capacity_range)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) capacity_range (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity a))
...
(define-fun dynamic_invariant1 ((temp___expr_371 Int) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool)) Bool (=> (or (= temp___is_init_368 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_371)))
...
(define-fun dynamic_invariant2 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 2147483647)) (in_range5 temp___expr_377)))
...
(define-fun dynamic_invariant3 ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= 0 2147483647)) (in_range3 temp___expr_219)))
...
(define-fun default_initial_assumption ((temp___expr_406 us_rep1) (temp___skip_top_level_407 Bool)) Bool (=> (not (= temp___skip_top_level_407 true)) (= (length1 temp___expr_406) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 0 2147483647)) (in_range6 temp___expr_399)))
...
(define-fun dynamic_invariant5 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_393)))
...
(assert (=> (not (= before 0)) (and (= o5 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range5 o5) (= o5 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before 0)) (= o6 (ite (= (- before 1) o5) true false))))
(assert (=> (= before 0) (= o6 false)))
(assert (and (= o3 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range5 o3) (= o3 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o4 (ite (<= before o3) true false)))
(assert (= o7 (ite (<= 1 before) o4 false)))
(assert (= o8 (ite (= o7 false) o6 true)))
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range3 o) (= o (ite (= (of_int 1) true) (to_rep (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
