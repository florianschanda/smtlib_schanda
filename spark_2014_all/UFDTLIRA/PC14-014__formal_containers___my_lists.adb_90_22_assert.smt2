...
(assert (not (= (bool_eq1 (reverse_find (mk___rep l__split_discrs l__split_fields26) 16 no_element) (next (mk___rep l__split_discrs l__split_fields26) (mk___rep1 c__split_fields14))) true)))
(check-sat)
(exit)
