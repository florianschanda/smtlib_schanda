...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o) (= o (ite (= (of_int 0) true) (to_rep (rec__names__entry_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
