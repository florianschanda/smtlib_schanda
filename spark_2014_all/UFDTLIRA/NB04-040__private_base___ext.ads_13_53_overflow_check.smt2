...
(assert (forall ((x1 us_rep1)) (! (dynamic_invariant (sum__2 x1) true false true) :pattern ((sum__2 x1)))))
(assert (forall ((attr__tag2 Int)) (forall ((x1 us_rep1)) (! (dynamic_invariant (sum__21 attr__tag2 x1) true false true) :pattern ((sum__21 attr__tag2 x1))))))
