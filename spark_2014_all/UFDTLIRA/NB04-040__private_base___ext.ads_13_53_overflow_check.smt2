...
(assert (forall ((x1 us_rep1)) (! (dynamic_invariant (sum__2 x1) true false true true) :pattern ((sum__2 x1)))))
(assert (forall ((attr__tag2 Int)) (forall ((x1 us_rep1)) (! (dynamic_invariant (sum__21 attr__tag2 x1) true false true true) :pattern ((sum__21 attr__tag2 x1))))))
(assert (forall ((x1 us_rep1)) (! (= (sum__2 x1) (sum__21 us_tag1 x1)) :pattern ((sum__21 us_tag1 x1)))))
