...
(define-fun dynamic_invariant ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 2147483647)) (in_range2 temp___expr_389)))
...
(define-fun dynamic_invariant1 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 2147483647)) (in_range3 temp___expr_403)))
...
(define-fun default_initial_assumption ((temp___expr_411 us_rep) (temp___skip_top_level_412 Bool)) Bool (=> (not (= temp___skip_top_level_412 true)) (= (length temp___expr_411) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 2147483647)) (in_range4 temp___expr_167)))
...
(define-fun dynamic_invariant3 ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_396)))
