...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(declare-const temp___503 count_type)
(declare-const o2 us_rep3)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___503 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___503)) no_element))
