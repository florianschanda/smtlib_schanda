...
(define-fun o32 () us_rep (mk___rep (mk___split_discrs o18) (mk___split_fields o19 o20 o21 o22)))
(define-fun o33 () us_rep (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17)))
(assert (= (to_rep o1) 1))
(assert (= (to_rep o2) 1))
(assert (= o2 o3))
(assert (= o1 o4))
...
(assert (= o11 o5))
(assert (= o12 o6))
(assert (= o33 (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
(assert (= o32 o33))
(assert (= (mk___rep (mk___split_discrs conv__p__x__assume) (mk___split_fields conv__p__x__assume1 conv__p__x__assume2 conv__p__x__assume3 conv__p__x__assume4)) o32))
...
(assert (not (= 0 (to_rep1 (rec__basic__r__x (us_split_discrs1 o31))))))
(check-sat)
(exit)
