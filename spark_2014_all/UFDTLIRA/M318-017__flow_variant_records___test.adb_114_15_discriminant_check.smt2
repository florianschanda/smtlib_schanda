...
(declare-const temp___305 Bool)
(declare-const temp___3051 integer)
(declare-const temp___3052 failure_reason)
(declare-const temp___3053 Bool)
(assert (= (ite x__split_discrs 1 0) 1))
(assert (= x__split_discrs r31b))
(assert (= (to_rep o) 12))
(assert (= o o1))
(assert (= dummy1 o2))
(assert (= (distinct 1 0) temp___305))
(assert (= temp___3051 o1))
(assert (= temp___3052 o2))
(assert (= true temp___3053))
(assert (= x__attr__constrained true))
(assert (not (= temp___305 x__split_discrs)))
(check-sat)
(exit)
