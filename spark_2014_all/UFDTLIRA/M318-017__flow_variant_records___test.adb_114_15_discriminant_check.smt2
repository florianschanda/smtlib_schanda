...
(assert (forall ((x failure_reason)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x failure_reason)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun default_initial_assumption ((temp___expr_211 us_rep) (temp___skip_top_level_212 Bool)) Bool (and (= (attr__constrained temp___expr_211) false) (= (rec__test__search_result__found (us_split_discrs1 temp___expr_211)) (of_int 0))))
...
(define-fun dynamic_invariant1 ((temp___expr_203 Int) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool)) Bool (=> (or (= temp___is_init_200 true) (<= 0 2)) (in_range2 temp___expr_203)))
...
(declare-const o3 failure_reason)
(declare-const o4 integer)
(declare-const o5 failure_reason)
(declare-const temp___275 Bool)
(declare-const temp___2751 integer)
(declare-const temp___2752 failure_reason)
(declare-const temp___2753 Bool)
...
(assert (not (= temp___272 x__split_discrs)))
(check-sat)
(exit)
