...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range temp___expr_158)))
...
(assert (forall ((self us_rep)) (! (dynamic_invariant (from self) true false true) :pattern ((from self)))))
