...
(assert (forall ((x uml_state_access)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x uml_state_access)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Int)) (! (=> (in_range x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__model__uml_transition__from_data uml_state_access) (rec__model__uml_transition__to_data uml_state_access)))))
(define-fun us_split_fields_From_Data__projection ((a us_split_fields)) uml_state_access (rec__model__uml_transition__from_data a))
(define-fun us_split_fields_To_Data__projection ((a us_split_fields)) uml_state_access (rec__model__uml_transition__to_data a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__model__uml_transition__from_data (us_split_fields1 a))) (to_rep (rec__model__uml_transition__from_data (us_split_fields1 b)))) (= (to_rep (rec__model__uml_transition__to_data (us_split_fields1 a))) (to_rep (rec__model__uml_transition__to_data (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((uml_transition__ref (mk_uml_transition__ref (uml_transition__content us_rep)))))
(define-fun uml_transition__ref___projection ((a uml_transition__ref)) us_rep (uml_transition__content a))
(declare-fun from (us_rep) Int)
(declare-fun from__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_183 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool) (temp___do_typ_inv_182 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 0 100)) (in_range temp___expr_183)))
(assert (forall ((self us_rep)) (! (dynamic_invariant (from self) true false true true) :pattern ((from self)))))
(assert (forall ((self us_rep)) (! (= (from self) (to_rep (rec__model__uml_transition__from_data (us_split_fields1 self)))) :pattern ((from self)))))
...
(declare-const temp___406 uml_state_access)
(declare-const temp___4061 uml_state_access)
...
(assert (= temp___406 o1))
(assert (= temp___4061 o2))
(assert (= result self__split_fields))
(assert (= result1 self__split_fields1))
(assert (= temp___406 self__split_fields2))
(assert (= temp___4061 self__split_fields3))
...
(assert (not (= (from (mk___rep (mk___split_fields self__split_fields4 self__split_fields5))) val__)))
(check-sat)
(exit)
