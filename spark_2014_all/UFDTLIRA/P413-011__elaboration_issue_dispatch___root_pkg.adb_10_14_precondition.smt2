...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (ite (get x extension_pkg__body_elaborated) 1 0) (ite (get1 us_tag x extension_pkg__body_elaborated) 1 0)) :pattern ((get1 us_tag x extension_pkg__body_elaborated))))))
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (ite (get2 (of_base x) extension_pkg__body_elaborated) 1 0) (ite (get1 us_tag1 x extension_pkg__body_elaborated) 1 0)) :pattern ((get1 us_tag1 x extension_pkg__body_elaborated))))))
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (get x extension_pkg__body_elaborated) true) :pattern ((get x extension_pkg__body_elaborated))))))
...
(declare-fun op2 (us_rep1 Bool) Bool)
(declare-fun op__function_guard2 (Bool us_rep1 Bool) Bool)
(declare-fun op3 (Int us_rep1 Bool) Bool)
(declare-fun op__function_guard3 (Bool Int us_rep1 Bool) Bool)
(assert true)
(assert true)
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (ite (op x extension_pkg__body_elaborated) 1 0) (ite (op1 us_tag x extension_pkg__body_elaborated) 1 0)) :pattern ((op1 us_tag x extension_pkg__body_elaborated))))))
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (ite (op2 (of_base x) extension_pkg__body_elaborated) 1 0) (ite (op1 us_tag1 x extension_pkg__body_elaborated) 1 0)) :pattern ((op1 us_tag1 x extension_pkg__body_elaborated))))))
(declare-const y us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption1 ((temp___expr_171 us_rep1) (temp___skip_top_level_172 Bool)) Bool (= (attr__tag1 temp___expr_171) us_tag1))
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (ite (get2 x extension_pkg__body_elaborated) 1 0) (ite (get3 us_tag1 x extension_pkg__body_elaborated) 1 0)) :pattern ((get3 us_tag1 x extension_pkg__body_elaborated))))))
(assert (forall ((x us_rep1)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (= (get2 x extension_pkg__body_elaborated) true) (= extension_pkg__body_elaborated true)) :pattern ((get2 x extension_pkg__body_elaborated))))))
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (ite (op2 x extension_pkg__body_elaborated) 1 0) (ite (op3 us_tag1 x extension_pkg__body_elaborated) 1 0)) :pattern ((op3 us_tag1 x extension_pkg__body_elaborated))))))
