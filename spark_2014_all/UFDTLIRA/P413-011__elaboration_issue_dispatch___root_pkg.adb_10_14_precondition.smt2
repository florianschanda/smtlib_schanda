...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (to_int1 (get x extension_pkg__body_elaborated)) (to_int1 (get1 us_tag x extension_pkg__body_elaborated))) :pattern ((get1 us_tag x extension_pkg__body_elaborated))))))
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (to_int1 (get2 (of_base x) extension_pkg__body_elaborated)) (to_int1 (get1 us_tag1 x extension_pkg__body_elaborated))) :pattern ((get1 us_tag1 x extension_pkg__body_elaborated))))))
...
(assert true)
(assert true)
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (to_int1 (op x extension_pkg__body_elaborated)) (to_int1 (op1 us_tag x extension_pkg__body_elaborated))) :pattern ((op1 us_tag x extension_pkg__body_elaborated))))))
(assert (forall ((x us_rep)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (to_int1 (op2 (of_base x) extension_pkg__body_elaborated)) (to_int1 (op1 us_tag1 x extension_pkg__body_elaborated))) :pattern ((op1 us_tag1 x extension_pkg__body_elaborated))))))
(declare-const y us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption1 ((temp___expr_146 us_rep1) (temp___skip_top_level_147 Bool)) Bool (= (attr__tag1 temp___expr_146) us_tag1))
(assert true)
(assert true)
(assert (forall ((x us_rep1)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (to_int1 (get2 x extension_pkg__body_elaborated)) (to_int1 (get3 us_tag1 x extension_pkg__body_elaborated))) :pattern ((get3 us_tag1 x extension_pkg__body_elaborated))))))
