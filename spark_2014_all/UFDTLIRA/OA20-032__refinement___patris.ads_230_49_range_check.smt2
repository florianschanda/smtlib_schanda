...
(assert (forall ((x shape)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x px_coord)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x py_coord)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x direction)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant ((temp___expr_2174 Int) (temp___is_init_2170 Bool) (temp___skip_constant_2171 Bool) (temp___do_toplevel_2172 Bool) (temp___do_typ_inv_2173 Bool)) Bool (=> (or (= temp___is_init_2170 true) (<= 0 3)) (in_range3 temp___expr_2174)))
...
(define-fun dynamic_invariant1 ((temp___expr_2285 Int) (temp___is_init_2281 Bool) (temp___skip_constant_2282 Bool) (temp___do_toplevel_2283 Bool) (temp___do_typ_inv_2284 Bool)) Bool (=> (or (= temp___is_init_2281 true) (<= 3 4)) (in_range4 temp___expr_2285)))
...
(define-fun dynamic_invariant2 ((temp___expr_2271 Int) (temp___is_init_2267 Bool) (temp___skip_constant_2268 Bool) (temp___do_toplevel_2269 Bool) (temp___do_typ_inv_2270 Bool)) Bool (=> (or (= temp___is_init_2267 true) (<= 0 4)) (in_range5 temp___expr_2271)))
(assert true)
(assert (forall ((p us_rep)) (forall ((a Int)) (! (= (= (move_is_possible p a) true) (ite (= a 0) (in_range1 (- (to_rep1 (rec__patris__piece__x (us_split_fields1 p))) 1)) (ite (= a 1) (in_range1 (+ (to_rep1 (rec__patris__piece__x (us_split_fields1 p))) 1)) (=> (= a 2) (in_range2 (+ (to_rep2 (rec__patris__piece__y (us_split_fields1 p))) 1)))))) :pattern ((move_is_possible p a))))))
(declare-const p us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const a Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant3 ((temp___expr_2101 Int) (temp___is_init_2097 Bool) (temp___skip_constant_2098 Bool) (temp___do_toplevel_2099 Bool) (temp___do_typ_inv_2100 Bool)) Bool (=> (or (= temp___is_init_2097 true) (<= 1 7)) (in_range temp___expr_2101)))
(define-fun dynamic_invariant4 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 9)) (in_range1 temp___expr_2160)))
(define-fun dynamic_invariant5 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= (- 1) 19)) (in_range2 temp___expr_2167)))
(assert (in_range5 a))
(assert (= (move_is_possible p a) true))
(assert (not (= a 0)))
(assert (= a 1))
(assert (not (in_range1 (+ (to_rep1 (rec__patris__piece__x (us_split_fields1 p))) 1))))
(check-sat)
(exit)
