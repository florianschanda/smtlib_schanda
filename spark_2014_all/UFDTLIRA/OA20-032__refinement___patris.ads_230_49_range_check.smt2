...
(define-fun dynamic_invariant ((temp___expr_2010 Int) (temp___is_init_2007 Bool) (temp___skip_constant_2008 Bool) (temp___do_toplevel_2009 Bool)) Bool (=> (or (= temp___is_init_2007 true) (<= 0 4)) (in_range4 temp___expr_2010)))
...
(define-fun dynamic_invariant1 ((temp___expr_1920 Int) (temp___is_init_1917 Bool) (temp___skip_constant_1918 Bool) (temp___do_toplevel_1919 Bool)) Bool (=> (or (= temp___is_init_1917 true) (<= 0 3)) (in_range2 temp___expr_1920)))
(define-fun dynamic_invariant2 ((temp___expr_2022 Int) (temp___is_init_2019 Bool) (temp___skip_constant_2020 Bool) (temp___do_toplevel_2021 Bool)) Bool (=> (or (= temp___is_init_2019 true) (<= 3 4)) (in_range5 temp___expr_2022)))
...
(define-fun dynamic_invariant3 ((temp___expr_1855 Int) (temp___is_init_1852 Bool) (temp___skip_constant_1853 Bool) (temp___do_toplevel_1854 Bool)) Bool (=> (or (= temp___is_init_1852 true) (<= 1 7)) (in_range3 temp___expr_1855)))
(define-fun dynamic_invariant4 ((temp___expr_1908 Int) (temp___is_init_1905 Bool) (temp___skip_constant_1906 Bool) (temp___do_toplevel_1907 Bool)) Bool (=> (or (= temp___is_init_1905 true) (<= (- 1) 9)) (in_range temp___expr_1908)))
(define-fun dynamic_invariant5 ((temp___expr_1914 Int) (temp___is_init_1911 Bool) (temp___skip_constant_1912 Bool) (temp___do_toplevel_1913 Bool)) Bool (=> (or (= temp___is_init_1911 true) (<= (- 1) 19)) (in_range1 temp___expr_1914)))
(declare-const o Int)
