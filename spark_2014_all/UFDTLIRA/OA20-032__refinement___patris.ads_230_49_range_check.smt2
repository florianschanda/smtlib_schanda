...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep3 (rec__patris__piece__s (us_split_fields1 a))) (to_rep3 (rec__patris__piece__s (us_split_fields1 b)))) (= (to_rep2 (rec__patris__piece__d (us_split_fields1 a))) (to_rep2 (rec__patris__piece__d (us_split_fields1 b))))) (= (to_rep (rec__patris__piece__x (us_split_fields1 a))) (to_rep (rec__patris__piece__x (us_split_fields1 b))))) (= (to_rep1 (rec__patris__piece__y (us_split_fields1 a))) (to_rep1 (rec__patris__piece__y (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_2264 Int) (temp___is_init_2260 Bool) (temp___skip_constant_2261 Bool) (temp___do_toplevel_2262 Bool) (temp___do_typ_inv_2263 Bool)) Bool (=> (or (= temp___is_init_2260 true) (<= 0 4)) (in_range4 temp___expr_2264)))
...
(define-fun dynamic_invariant1 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= 0 3)) (in_range2 temp___expr_2167)))
(define-fun dynamic_invariant2 ((temp___expr_2278 Int) (temp___is_init_2274 Bool) (temp___skip_constant_2275 Bool) (temp___do_toplevel_2276 Bool) (temp___do_typ_inv_2277 Bool)) Bool (=> (or (= temp___is_init_2274 true) (<= 3 4)) (in_range5 temp___expr_2278)))
(declare-fun turn_direction (Int Int) Int)
(declare-fun turn_direction__function_guard (Int Int Int) Bool)
(assert (forall ((d Int) (t Int)) (! (=> (and (dynamic_invariant1 d true true true true) (dynamic_invariant2 t true true true true)) (dynamic_invariant1 (turn_direction d t) true false true true)) :pattern ((turn_direction d t)))))
(assert (forall ((d Int) (t Int)) (! (=> (and (dynamic_invariant1 d true true true true) (dynamic_invariant2 t true true true true)) (= (turn_direction d t) (ite (= t 3) (ite (= d 0) 3 (- d 1)) (ite (= d 3) 0 (+ d 1))))) :pattern ((turn_direction d t)))))
(declare-fun move_is_possible (us_rep Int) Bool)
(declare-fun move_is_possible__function_guard (Bool us_rep Int) Bool)
(assert true)
(assert (forall ((p us_rep)) (forall ((a Int)) (! (= (= (move_is_possible p a) true) (ite (= a 0) (in_range (- (to_rep (rec__patris__piece__x (us_split_fields1 p))) 1)) (ite (= a 1) (in_range (+ (to_rep (rec__patris__piece__x (us_split_fields1 p))) 1)) (=> (= a 2) (in_range1 (+ (to_rep1 (rec__patris__piece__y (us_split_fields1 p))) 1)))))) :pattern ((move_is_possible p a))))))
(declare-const p us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const a Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant3 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 1 7)) (in_range3 temp___expr_2094)))
(define-fun dynamic_invariant4 ((temp___expr_2153 Int) (temp___is_init_2149 Bool) (temp___skip_constant_2150 Bool) (temp___do_toplevel_2151 Bool) (temp___do_typ_inv_2152 Bool)) Bool (=> (or (= temp___is_init_2149 true) (<= (- 1) 9)) (in_range temp___expr_2153)))
(define-fun dynamic_invariant5 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 19)) (in_range1 temp___expr_2160)))
(assert (in_range4 a))
(assert (= (move_is_possible p a) true))
(assert (not (= a 0)))
(assert (= a 1))
(assert (not (in_range (+ (to_rep (rec__patris__piece__x (us_split_fields1 p))) 1))))
(check-sat)
(exit)
