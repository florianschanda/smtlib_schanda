...
(define-fun dynamic_invariant ((temp___expr_2016 Int) (temp___is_init_2013 Bool) (temp___skip_constant_2014 Bool) (temp___do_toplevel_2015 Bool)) Bool (=> (or (= temp___is_init_2013 true) (<= 0 4)) (in_range4 temp___expr_2016)))
...
(define-fun dynamic_invariant1 ((temp___expr_1926 Int) (temp___is_init_1923 Bool) (temp___skip_constant_1924 Bool) (temp___do_toplevel_1925 Bool)) Bool (=> (or (= temp___is_init_1923 true) (<= 0 3)) (in_range2 temp___expr_1926)))
(define-fun dynamic_invariant2 ((temp___expr_2028 Int) (temp___is_init_2025 Bool) (temp___skip_constant_2026 Bool) (temp___do_toplevel_2027 Bool)) Bool (=> (or (= temp___is_init_2025 true) (<= 3 4)) (in_range5 temp___expr_2028)))
...
(define-fun dynamic_invariant3 ((temp___expr_1861 Int) (temp___is_init_1858 Bool) (temp___skip_constant_1859 Bool) (temp___do_toplevel_1860 Bool)) Bool (=> (or (= temp___is_init_1858 true) (<= 1 7)) (in_range3 temp___expr_1861)))
(define-fun dynamic_invariant4 ((temp___expr_1914 Int) (temp___is_init_1911 Bool) (temp___skip_constant_1912 Bool) (temp___do_toplevel_1913 Bool)) Bool (=> (or (= temp___is_init_1911 true) (<= (- 1) 9)) (in_range temp___expr_1914)))
(define-fun dynamic_invariant5 ((temp___expr_1920 Int) (temp___is_init_1917 Bool) (temp___skip_constant_1918 Bool) (temp___do_toplevel_1919 Bool)) Bool (=> (or (= temp___is_init_1917 true) (<= (- 1) 19)) (in_range1 temp___expr_1920)))
(assert (in_range4 a))
