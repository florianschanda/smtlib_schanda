...
(declare-sort et3 0)
(define-fun in_range ((x Int)) Bool (and (<= 10 x) (<= x 90)))
(declare-fun attr__ATTRIBUTE_IMAGE (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE (us_image) Int)
(declare-fun user_eq (et3 et3) Bool)
(declare-const dummy et3)
(declare-datatypes () ((et3__ref (mk_et3__ref (et3__content et3)))))
(define-fun et3__ref___projection ((a et3__ref)) et3 (et3__content a))
(declare-fun to_rep (et3) Int)
(declare-fun of_rep (Int) et3)
(assert (forall ((x et3)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x et3)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun to_rep2 (et1) Int)
(declare-fun of_rep2 (Int) et1)
(assert (forall ((x et1)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x et1)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun to_rep3 (et2) Int)
(declare-fun of_rep3 (Int) et2)
(assert (forall ((x et2)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x et2)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__ar__rec1t__f1 (us_split_fields1 a))) (to_rep2 (rec__ar__rec1t__f1 (us_split_fields1 b)))) (= (to_rep3 (rec__ar__rec1t__g1 (us_split_fields1 a))) (to_rep3 (rec__ar__rec1t__g1 (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_176 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 99)) (in_range2 temp___expr_176)))
(define-fun dynamic_invariant1 ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 1 25)) (in_range3 temp___expr_182)))
(define-fun dynamic_invariant2 ((temp___expr_188 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 10 90)) (in_range temp___expr_188)))
(define-fun dynamic_invariant3 ((temp___expr_212 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 4)) (in_range1 temp___expr_212)))
...
(declare-const r__split_fields8 et3)
(declare-const r__split_fields9 et1)
(declare-const r__split_fields10 et2)
(declare-const r__split_fields11 enum1ta)
(declare-const r__split_fields12 et3)
(declare-const r__split_fields13 et1)
(declare-const r__split_fields14 et2)
(declare-const r__split_fields15 enum1ta)
...
(assert (= r__split_fields r__split_fields4))
(assert (= a (mk___rep (mk___split_fields r__split_fields5 r__split_fields6))))
(assert (= r__split_fields3 r__split_fields7))
...
(assert (not (= (to_rep r__split_fields8) (to_rep r__split_fields))))
(check-sat)
(exit)
