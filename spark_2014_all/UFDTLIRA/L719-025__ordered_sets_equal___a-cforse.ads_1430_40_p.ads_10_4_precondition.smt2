...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (last_element container))) (and (and (= result (get (elements container) (length container))) (= (e_bigger_than_range (elements container) 1 (- (length container) 1) result) true)) (dynamic_invariant2 result true false true true)))) :pattern ((last_element container)))))
...
(assert (forall ((container1 us_rep1)) (forall ((item1 Int)) (! (=> (dynamic_invariant2 item1 true true true true) (let ((result (find container1 item1))) (and (=> (< 0 result) (and (<= result (length1 container1)) (= (equivalent_elements item1 (get container1 result)) true))) (dynamic_invariant1 result true false true true)))) :pattern ((find container1 item1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_361 us_rep2) (temp___skip_top_level_362 Bool)) Bool (=> (not (= temp___skip_top_level_362 true)) (= (is_empty1 temp___expr_361) true)))
...
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant1 (length2 container1) true false true true) :pattern ((length2 container1)))))
(assert (forall ((container1 us_rep2)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item1 Int)) (not (and (in_range4 item1) (= (contains container1 item1) true))))) (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty1 container1)))))
...
(assert (forall ((container1 us_rep1)) (! (let ((result (length1 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(assert (and (= o (length container)) (and (in_range2 o) (<= o (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container)))))))
