...
(define-fun dynamic_invariant1 ((temp___expr_468 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool) (temp___do_typ_inv_467 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 1 2147483647)) (in_range3 temp___expr_468)))
...
(assert (and (= o3 (get o2 (mk___rep1 (mk___split_fields1 position__split_fields)))) (and (in_range3 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 (mk___split_fields1 position__split_fields))))) (forall ((k us_rep1)) (=> (= (has_key o2 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 position__split_fields))) true) (= (witness o2 (mk___rep1 (mk___split_fields1 position__split_fields))) (witness o2 k))))))))))
(assert (and (= o (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__loop_types__lists__list__capacity container__split_discrs))))))
(assert (= o1 (- o count)))
