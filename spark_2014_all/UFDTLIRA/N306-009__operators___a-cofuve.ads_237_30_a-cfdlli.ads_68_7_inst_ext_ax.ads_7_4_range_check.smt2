...
(define-fun dynamic_invariant ((temp___expr_427 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool) (temp___do_typ_inv_426 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 1 2147483647)) (in_range2 temp___expr_427)))
...
(define-fun dynamic_invariant1 ((temp___expr_441 Int) (temp___is_init_437 Bool) (temp___skip_constant_438 Bool) (temp___do_toplevel_439 Bool) (temp___do_typ_inv_440 Bool)) Bool (=> (or (= temp___is_init_437 true) (<= 0 2147483647)) (in_range3 temp___expr_441)))
