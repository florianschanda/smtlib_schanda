...
(define-fun dynamic_invariant ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 1 2147483647)) (in_range2 temp___expr_380)))
...
(define-fun dynamic_invariant1 ((temp___expr_392 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 0 2147483647)) (in_range3 temp___expr_392)))
...
(define-fun default_initial_assumption ((temp___expr_399 us_rep) (temp___skip_top_level_400 Bool)) Bool (=> (not (= temp___skip_top_level_400 true)) (= (length temp___expr_399) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_386 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= 0 2147483647)) (in_range5 temp___expr_386)))
