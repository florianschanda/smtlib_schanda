...
(define-fun dynamic_invariant3 ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 2147483646)) (in_range6 temp___expr_214)))
(define-fun dynamic_invariant4 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 2147483647)) (in_range5 temp___expr_148)))
...
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range3 o2) (= o2 (ite (= (of_int 0) true) (to_rep (rec__names__data__entry_tables__vector__capacity container__split_discrs)) 2147483647)))))
