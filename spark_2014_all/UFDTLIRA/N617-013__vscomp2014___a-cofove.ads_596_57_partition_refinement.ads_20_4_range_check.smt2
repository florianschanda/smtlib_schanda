...
(define-fun dynamic_invariant1 ((temp___expr_293 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= (- 1) 10001)) (in_range2 temp___expr_293)))
...
(define-fun dynamic_invariant2 ((temp___expr_299 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 10001)) (in_range3 temp___expr_299)))
...
(define-fun dynamic_invariant3 ((temp___expr_278 Int) (temp___is_init_275 Bool) (temp___skip_constant_276 Bool) (temp___do_toplevel_277 Bool)) Bool (=> (or (= temp___is_init_275 true) (<= 0 10000)) (in_range4 temp___expr_278)))
...
(define-fun dynamic_invariant4 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 6)) (in_range5 temp___expr_251)))
...
(define-fun dynamic_invariant5 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 5)) (in_range6 temp___expr_257)))
...
(define-fun default_initial_assumption ((temp___expr_336 us_rep1) (temp___skip_top_level_337 Bool)) Bool (=> (not (= temp___skip_top_level_337 true)) (= (length1 temp___expr_336) 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_329 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= (- 1) 10000)) (in_range7 temp___expr_329)))
