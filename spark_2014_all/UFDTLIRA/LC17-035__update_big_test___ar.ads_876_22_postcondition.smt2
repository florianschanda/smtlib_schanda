...
(declare-const temp___6854 et3)
(declare-const temp___68541 et1)
(declare-const temp___68542 et2)
(declare-const temp___68543 enum1ta)
...
(assert (= temp___6854 o5))
(assert (= temp___68541 o6))
(assert (= temp___68542 o7))
(assert (= temp___68543 o8))
...
(assert (= r__split_fields8 (mk___split_fields1 temp___6854 (mk___rep (mk___split_fields temp___68541 temp___68542)) temp___68543)))
