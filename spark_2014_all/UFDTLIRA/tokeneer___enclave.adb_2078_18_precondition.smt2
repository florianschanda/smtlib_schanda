...
(assert (=> (= result3 true) (= o4 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= result3 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result3 true) (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range3 o1))))
(assert (=> (= result3 true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result3 true) (= o3 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
