...
(assert (=> (= (to_rep current_read__split_fields) 10) (= (mk_int__ref result1) current_col4)))
...
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (= (mk_int__ref result2) current_col4))))
