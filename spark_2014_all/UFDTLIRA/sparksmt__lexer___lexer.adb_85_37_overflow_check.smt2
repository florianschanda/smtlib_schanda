...
(assert (=> (= (to_rep current_read__split_fields) 10) (and (= o (+ current_line 1)) (in_range (+ current_line 1)))))
(assert (=> (= (to_rep current_read__split_fields) 10) (= (mk_int__ref result) (mk_int__ref current_line))))
(assert (=> (= (to_rep current_read__split_fields) 10) (= current_line2 o)))
(assert (=> (= (to_rep current_read__split_fields) 10) (= (mk_int__ref result1) (mk_int__ref current_col))))
(assert (=> (= (to_rep current_read__split_fields) 10) (= current_col2 0)))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (=> (= (to_rep current_read__split_fields) 13) (= current_col3 current_col))))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (=> (= (to_rep current_read__split_fields) 13) (= current_col3 current_col1))))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (and (= o1 (+ current_col 1)) (in_range (+ current_col 1))))))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (= (mk_int__ref result2) (mk_int__ref current_col)))))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (=> (not (= (to_rep current_read__split_fields) 13)) (= current_col3 o1))))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (= current_col2 current_col3)))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (= current_line2 current_line)))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (= current_col2 current_col3)))
(assert (=> (not (= (to_rep current_read__split_fields) 10)) (= current_line2 current_line1)))
(assert (not (in_range (+ current_pos 1))))
(check-sat)
(exit)
