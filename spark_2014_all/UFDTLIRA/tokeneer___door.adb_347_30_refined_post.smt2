...
(define-fun alarmtimeout__split_fields13 () us_split_fields (mk___split_fields alarmtimeout__split_fields4 alarmtimeout__split_fields5 alarmtimeout__split_fields6 alarmtimeout__split_fields7))
...
(assert (= (mk___rep (mk___split_fields temp___859 temp___8591 temp___8592 temp___8593)) (thecurrenttime currenttime)))
...
(assert (and (= (= (islocked state1) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state1)) true)) (= (bool_eq (latch_timeout state1) (latch_timeout state)) true)))
(assert (and (= (and (and (= currentdoor 0) (= (islocked state1) true)) (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep alarmtimeout__split_fields13)) true)) (= dooralarm1 0)) (in_range1 dooralarm1)))
...
(assert (= (islocked state4) true))
(assert (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep (mk___split_fields alarmtimeout__split_fields8 alarmtimeout__split_fields9 alarmtimeout__split_fields10 alarmtimeout__split_fields11))) true))
