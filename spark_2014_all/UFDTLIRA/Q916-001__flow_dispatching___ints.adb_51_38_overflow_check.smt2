...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__ints__int__min (us_split_fields1 a))) (to_rep1 (rec__ints__int__min (us_split_fields1 b)))) (= (to_rep1 (rec__ints__int__max (us_split_fields1 a))) (to_rep1 (rec__ints__int__max (us_split_fields1 b))))) (= (to_rep1 (rec__ints__int__value (us_split_fields1 a))) (to_rep1 (rec__ints__int__value (us_split_fields1 b))))) true false))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep (rec__ints__approx_int__precision (us_split_fields3 a))) (to_rep (rec__ints__approx_int__precision (us_split_fields3 b)))) (= (to_rep1 (rec__ints__int__min1 (us_split_fields3 a))) (to_rep1 (rec__ints__int__min1 (us_split_fields3 b))))) (= (to_rep1 (rec__ints__int__max1 (us_split_fields3 a))) (to_rep1 (rec__ints__int__max1 (us_split_fields3 b))))) (= (to_rep1 (rec__ints__int__value1 (us_split_fields3 a))) (to_rep1 (rec__ints__int__value1 (us_split_fields3 b))))) true false))
...
(declare-const arg__split_fields natural)
(declare-const o Int)
(assert (not (in_range (+ (to_rep arg__split_fields) 1))))
(check-sat)
(exit)
