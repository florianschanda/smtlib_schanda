...
(declare-const temp___6981 us_rep2)
...
(declare-const temp___6985 us_rep2)
...
(assert (= temp___6981 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o14 (mk___rep (mk___split_fields o15 o16)) o17)) o18))))
...
(assert (= r__split_fields5 (us_split_fields5 temp___6981)))
...
(assert (= temp___6985 (mk___rep2 o24)))
(assert (= result2 (mk___split_fields__ref2 r__split_fields5)))
(assert (= r__split_fields6 (us_split_fields5 temp___6985)))
...
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields7))))) (to_rep2 r__split_fields))))
(check-sat)
(exit)
