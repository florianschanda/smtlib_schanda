...
(assert (and (= o9 (element l cu2)) (and (in_range5 o9) (= o9 (get (model__ l) (get1 (positions l) cu2))))))
(assert (= result3 (ite (= o9 0) true false)))
(assert (not (= result3 true)))
(assert (= for_loops_on_lists__search_0_for_in__result3 for_loops_on_lists__search_0_for_in__result2))
(assert (and (= (mk___rep1 (mk___split_fields1 o10)) (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o10)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o10))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o10))) (+ (get1 (positions l) cu2) 1))))))
...
(assert (and (= (mk___rep1 (mk___split_fields1 o12)) (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o12)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o12))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o12))) (+ (get1 (positions l) cu2) 1))))))
(assert (= result6 (mk_cursor__ref cu2)))
(assert (= cu3 (mk___rep1 (mk___split_fields1 o12))))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (- (get1 (positions l) cu3) 1)))
