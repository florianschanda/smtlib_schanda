...
(define-fun cu4 () us_rep1 (mk___rep (mk___split_fields cu1)))
(define-fun o5 () us_rep1 (mk___rep (mk___split_fields o4)))
(define-fun o6 () us_rep1 (mk___rep (mk___split_fields o2)))
(define-fun o7 () us_rep1 (mk___rep (mk___split_fields o)))
(assert (= (mk___rep (mk___split_fields rliteral)) no_element))
(assert (and (= o7 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) 1)))))
(assert (= (mk_cursor__ref (mk___rep (mk___split_fields result))) (mk_cursor__ref (mk___rep (mk___split_fields cu)))))
(assert (= cu4 o7))
(assert (and (= result1 (has_key (positions l) cu4)) (= (= result1 true) (= (has_key (positions l) cu4) true))))
(assert (= result1 true))
...
(assert (and (= o6 (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) (+ (get1 (positions l) cu2) 1))))))
...
(assert (and (= o5 (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 o5 no_element) true) (and (= (has_key (positions l) o5) true) (= (get1 (positions l) o5) (+ (get1 (positions l) cu2) 1))))))
