...
(assert (and (= o9 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o9 no_element) true) (and (= (has_key (positions l) o9) true) (= (get1 (positions l) o9) 1)))))
...
(assert (and (= o3 (element l cu2)) (and (in_range5 o3) (= o3 (get (model__ l) (get1 (positions l) cu2))))))
...
(assert (and (= o8 (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 o8 no_element) true) (and (= (has_key (positions l) o8) true) (= (get1 (positions l) o8) (+ (get1 (positions l) cu2) 1))))))
...
(assert (and (= o7 (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 o7 no_element) true) (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) (+ (get1 (positions l) cu2) 1))))))
