...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (= shutdowncompleted true)) (not (= systemfault true))) (= (not (= (enrolmentisinprogress (let ((subject state)) state10)) true)) (= (privatekeypresent state8) true))) (=> (and (and (= (islocked state11) true) (= (thecurrentdoor state12) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state12)) true)) (or (= (isalarming Tuple0) true) (= systemfault true)))) (or (= (= (islocked state11) true) (= (interfac_islocked Tuple0) true)) (= systemfault true))) (=> (= (rolepresent (mk___rep theadmin__split_fields2)) 1) (and (and (= (isgood state9) true) (= (authcertvalid state9) true)) (= (theauthcertrole state9) 1)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields2)) true) (= (thecurrentop (mk___rep theadmin__split_fields2)) 3)) (= (rolepresent (mk___rep theadmin__split_fields2)) 1))) (=> (= (rolepresent (mk___rep theadmin__split_fields2)) 1) (or (and (= (isdoingop (mk___rep theadmin__split_fields2)) true) (= (thecurrentop (mk___rep theadmin__split_fields2)) 3)) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true))))) (=> (not (= (ispresent (mk___rep theadmin__split_fields2)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields2)) true) (= (thecurrentop (mk___rep theadmin__split_fields2)) 4)) (= (statusiswaitingstartadminop (let ((subject state)) state10)) true))) (=> (or (= (statusisgotadmintoken (let ((subject state)) state10)) true) (= (statusiswaitingremoveadmintokenfail (let ((subject state)) state10)) true)) (not (= (ispresent (mk___rep theadmin__split_fields2)) true)))) (=> (or (= (statusiswaitingstartadminop (let ((subject state)) state10)) true) (= (statusiswaitingfinishadminop (let ((subject state)) state10)) true)) (and (= (isdoingop (mk___rep theadmin__split_fields2)) true) (= (ispresent (mk___rep theadmin__split_fields2)) true)))) (=> (= (statusisenclavequiescent (let ((subject state)) state10)) true) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true)))) (=> (= (statusisshutdown (let ((subject state)) state10)) true) (and (not (= (isdoingop (mk___rep theadmin__split_fields2)) true)) (= (rolepresent (mk___rep theadmin__split_fields2)) 0)))) (=> (= (enrolmentisinprogress (let ((subject state)) state10)) true) (and (not (= (ispresent (mk___rep theadmin__split_fields2)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true))))))
(assert (not (= (enrolmentisinprogress (let ((subject state)) state10)) true)))
(assert (not (= (privatekeypresent state8) true)))
(check-sat)
(exit)
