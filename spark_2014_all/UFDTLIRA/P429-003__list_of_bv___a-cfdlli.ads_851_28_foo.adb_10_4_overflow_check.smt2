...
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep1) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_235 us_rep1) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__foo__lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(assert (and (= o (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range o) (<= o (to_rep (rec__foo__lists__list__capacity container__split_discrs))))))
(assert (= o1 (- o count)))
