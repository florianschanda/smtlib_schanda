...
(assert (and (= (mk___rep1 (mk___split_fields1 o o1) o2) (f 1)) (and (and (= (of_rep1 1) o) (= us_null_ext__ o1)) (= us_tag o2))))
(assert (not (< (length (mk___rep v__split_discrs v__split_fields1)) (capacity (mk___rep v__split_discrs v__split_fields1)))))
(check-sat)
(exit)
