...
(define-fun dynamic_invariant ((temp___expr_241 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 1 3)) (in_range2 temp___expr_241)))
...
(define-fun dynamic_invariant1 ((temp___expr_253 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 3)) (in_range3 temp___expr_253)))
...
(define-fun default_initial_assumption ((temp___expr_260 us_rep) (temp___skip_top_level_261 Bool)) Bool (=> (not (= temp___skip_top_level_261 true)) (= (length temp___expr_260) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 3) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_247 Int) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool)) Bool (=> (or (= temp___is_init_244 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_247)))
...
(assert (and (= o1 (length right)) (and (in_range4 o1) (<= (+ 0 o1) 3))))
(assert (= o2 (+ 0 o1)))
