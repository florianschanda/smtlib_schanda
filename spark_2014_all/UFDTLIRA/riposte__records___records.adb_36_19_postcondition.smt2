...
(declare-const records__init_d__result unsigned_byte)
(declare-const records__init_d__result1 unsigned_byte)
...
(declare-const records__init_d__result2 unsigned_byte)
(declare-const records__init_d__result3 unsigned_byte)
(declare-const records__init_d__result4 unsigned_byte)
(declare-const records__init_d__result5 unsigned_byte)
(declare-const records__init_d__result6 unsigned_byte)
(declare-const records__init_d__result7 unsigned_byte)
(declare-const r__split_fields4 unsigned_byte)
(declare-const r__split_fields5 unsigned_byte)
(declare-const records__init_d__result8 unsigned_byte)
(declare-const records__init_d__result9 unsigned_byte)
(declare-const r__split_fields6 us_split_fields)
(declare-const records__init_d__result10 us_rep)
(define-fun records__init_d__result11 () us_rep (mk___rep (mk___split_fields records__init_d__result6 records__init_d__result7)))
(define-fun r__split_fields7 () us_split_fields (mk___split_fields r__split_fields2 r__split_fields3))
...
(assert (= r__split_fields7 (us_split_fields1 null_pair)))
(assert (= records__init_d__result4 records__init_d__result2))
(assert (= records__init_d__result5 records__init_d__result3))
(assert (= records__init_d__result11 (mk___rep (mk___split_fields records__init_d__result2 records__init_d__result3))))
(assert (= result2 records__init_d__result))
(assert (= result3 records__init_d__result1))
(assert (= records__init_d__result2 r__split_fields2))
(assert (= records__init_d__result3 r__split_fields3))
(assert (= (mk_pair__ref (mk___rep (mk___split_fields records__init_d__result8 records__init_d__result9))) (mk_pair__ref (mk___rep (mk___split_fields records__init_d__result4 records__init_d__result5)))))
(assert (= r__split_fields4 r__split_fields2))
(assert (= r__split_fields5 r__split_fields3))
(assert (= records__init_d__result10 records__init_d__result11))
(assert (= r__split_fields6 r__split_fields7))
(assert (= result4 records__init_d__result8))
(assert (= result5 records__init_d__result9))
(assert (not (= (bool_eq (mk___rep (mk___split_fields records__init_d__result8 records__init_d__result9)) null_pair) true)))
(check-sat)
(exit)
