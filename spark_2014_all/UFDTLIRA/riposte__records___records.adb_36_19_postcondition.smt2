...
(declare-const temp___300 unsigned_byte)
(declare-const temp___3001 unsigned_byte)
...
(define-fun records__init_d__result10 () us_rep (mk___rep (mk___split_fields records__init_d__result6 records__init_d__result7)))
...
(assert (= (mk___rep (mk___split_fields temp___300 temp___3001)) null_pair))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= r__split_fields6 (us_split_fields1 null_pair)))
(assert (= records__init_d__result4 records__init_d__result2))
(assert (= records__init_d__result5 records__init_d__result3))
(assert (= records__init_d__result10 (mk___rep (mk___split_fields records__init_d__result2 records__init_d__result3))))
...
(assert (= records__init_d__result9 records__init_d__result10))
