...
(declare-const temp___267 unsigned_byte)
(declare-const temp___2671 unsigned_byte)
...
(declare-const records__init_d__result8 pair__ref)
(declare-const r__split_fields5 us_split_fields)
(declare-const records__init_d__result9 us_rep)
...
(assert (= (mk___rep (mk___split_fields temp___267 temp___2671)) null_pair))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= (mk___split_fields r__split_fields2 r__split_fields3) (us_split_fields1 null_pair)))
(assert (= records__init_d__result4 records__init_d__result2))
(assert (= records__init_d__result5 records__init_d__result3))
(assert (= (mk___rep (mk___split_fields records__init_d__result6 records__init_d__result7)) (mk___rep (mk___split_fields records__init_d__result2 records__init_d__result3))))
...
(assert (= records__init_d__result8 (mk_pair__ref (mk___rep (mk___split_fields records__init_d__result4 records__init_d__result5)))))
(assert (= r__split_fields4 (mk___split_fields__ref (mk___split_fields r__split_fields2 r__split_fields3))))
(assert (= records__init_d__result9 (mk___rep (mk___split_fields records__init_d__result6 records__init_d__result7))))
(assert (= r__split_fields5 (mk___split_fields r__split_fields2 r__split_fields3)))
(assert (= (mk___rep (mk___split_fields result4 result5)) (pair__content records__init_d__result8)))
(assert (not (= (bool_eq (pair__content records__init_d__result8) null_pair) true)))
(check-sat)
(exit)
