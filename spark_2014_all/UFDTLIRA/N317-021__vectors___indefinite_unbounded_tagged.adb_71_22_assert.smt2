...
(assert (not (= (let ((temp___661 (f 4))) (let ((temp___660 (get (model__ (mk___rep1 v__split_discrs v__split_fields8)) 2))) (ite (= (attr__tag temp___660) (attr__tag temp___661)) (us_dispatch_eq temp___660 temp___661) false))) true)))
(check-sat)
(exit)
