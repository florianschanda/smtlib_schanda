...
(declare-const temp___190 status)
(declare-const temp___1901 natural)
(declare-const temp___1902 natural)
(declare-const temp___1903 Bool)
(declare-const temp___1904 Bool)
...
(declare-const temp___192 status)
(declare-const temp___1921 natural)
(declare-const temp___1922 natural)
(declare-const temp___1923 Bool)
(declare-const temp___1924 Bool)
...
(declare-const temp___193 us_rep)
...
(assert (not (= temp___190 x__split_discrs)))
(check-sat)
(exit)
