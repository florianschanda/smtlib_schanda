...
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___475)) (= l__split_fields temp___4751))))
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___472)) (= l__split_fields temp___4721))))
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___476)) (= l__split_fields temp___4761))))
(assert (=> (= result1 true) (= c__split_fields1 (mk___split_fields1 temp___471))))
(assert (=> (= result1 true) (= temp___474 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___473)) (= l__split_fields temp___4731))))
(assert (=> (= result1 true) (= (length (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep (mk___split_discrs temp___473) (mk___split_fields temp___4731))))))
(assert (=> (= result1 true) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields2)) temp___474) true)))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2)) 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (+ (get (model__ (mk___rep (mk___split_discrs temp___475) (mk___split_fields temp___4751))) i) 1))))))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2)) i) (<= i (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (get (model__ (mk___rep (mk___split_discrs temp___476) (mk___split_fields temp___4761))) i))))))
(assert (=> (= result1 true) (and (= o (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 c__split_fields2))) (and (in_range1 o) (= o (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2))))))))
(assert (=> (= result1 true) (= o1 (+ o 1))))
(assert (=> (= result1 true) (and (= o2 o1) (in_range1 o1))))
...
(assert (=> (= result1 true) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2)) 1))))))
