...
(assert (=> (= result2 true) (and (= l__split_discrs (mk___split_discrs temp___475)) (= l__split_fields temp___4751))))
(assert (=> (= result2 true) (and (= l__split_discrs (mk___split_discrs temp___472)) (= l__split_fields temp___4721))))
(assert (=> (= result2 true) (and (= l__split_discrs (mk___split_discrs temp___476)) (= l__split_fields temp___4761))))
(assert (=> (= result2 true) (= c__split_fields1 (mk___split_fields1 temp___471))))
(assert (=> (= result2 true) (= temp___474 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result2 true) (and (= l__split_discrs (mk___split_discrs temp___473)) (= l__split_fields temp___4731))))
(assert (=> (= result2 true) (= (length (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep (mk___split_discrs temp___473) (mk___split_fields temp___4731))))))
(assert (=> (= result2 true) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields2)) temp___474) true)))
(assert (=> (= result2 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2)) 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i2) (+ (get (model__ (mk___rep (mk___split_discrs temp___475) (mk___split_fields temp___4751))) i2) 1))))))
(assert (=> (= result2 true) (forall ((i2 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2)) i2) (<= i2 (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i2) (get (model__ (mk___rep (mk___split_discrs temp___476) (mk___split_fields temp___4761))) i2))))))
(assert (=> (= result2 true) (and (= o23 (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 c__split_fields2))) (and (in_range1 o23) (= o23 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 c__split_fields2))))))))
(assert (=> (= result2 true) (= o24 (+ o23 1))))
(assert (=> (= result2 true) (and (= o25 o24) (in_range1 o24))))
(assert (=> (= result2 true) (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs l__split_fields2))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2))) o25)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2))) true))))
(assert (=> (= result2 true) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields2)) 1))))))
(assert (=> (= result2 true) (and (= o26 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3))) (= (= o26 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 c__split_fields3)) true)))))
(assert (=> (= result2 true) (= result5 (ite (not (= o26 true)) true false))))
(assert (=> (= result2 true) (= result5 true)))
(assert (=> (= result2 true) (= c__split_fields4 (mk___split_fields__ref1 c__split_fields3))))
(assert (=> (= result2 true) (= l__split_fields4 (mk___split_fields__ref l__split_fields3))))
(assert (=> (= result2 true) (= c__split_fields5 c__split_fields3)))
(assert (=> (= result2 true) (= l__split_fields5 l__split_fields3)))
(assert (=> (= result2 true) (= c__split_fields6 c__split_fields4)))
(assert (=> (= result2 true) (= l__split_fields6 l__split_fields4)))
(assert (=> (= result2 true) (= c__split_fields7 c__split_fields5)))
(assert (=> (= result2 true) (= l__split_fields7 l__split_fields5)))
(assert (=> (not (= result2 true)) (= c__split_fields6 (mk___split_fields__ref1 c__split_fields1))))
(assert (=> (not (= result2 true)) (= l__split_fields6 (mk___split_fields__ref (mk___split_fields l__split_fields)))))
(assert (=> (not (= result2 true)) (= c__split_fields7 c__split_fields1)))
(assert (=> (not (= result2 true)) (= l__split_fields7 l__split_fields1)))
