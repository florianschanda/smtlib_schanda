...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__algorithm__gap_vectors__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields)) count_type (rec__algorithm__gap_vectors__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields1 a))) (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_521 Int) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool) (temp___do_typ_inv_520 Bool)) Bool (=> (or (= temp___is_init_517 true) (<= 1 2147483647)) (in_range2 temp___expr_521)))
...
(define-fun default_initial_assumption ((temp___expr_529 us_rep1) (temp___skip_top_level_530 Bool)) Bool (=> (not (= temp___skip_top_level_530 true)) (and (= (is_empty temp___expr_529) true) (= (length temp___expr_529) 0))))
(define-fun default_initial_assumption1 ((temp___expr_515 us_rep) (temp___skip_top_level_516 Bool)) Bool (= (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields1 temp___expr_515))) 0))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__algorithm__gap_vectors__list us_main_type1)))))
(define-fun us_split_fields_List__projection ((a us_split_fields2)) us_main_type1 (rec__algorithm__gap_vectors__list a))
...
(define-fun us_rep___14__projection ((a us_rep2)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 a))) (to_rep (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__algorithm__gap_vectors__list (us_split_fields3 a)) (rec__algorithm__gap_vectors__list (us_split_fields3 b))) true)) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_466 us_rep) (temp___skip_top_level_467 Bool)) Bool (= (to_rep (rec__algorithm__gap_vectors__cursor__node (us_split_fields1 temp___expr_466))) 0))
(declare-const container us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant1 ((temp___expr_365 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range1 temp___expr_365)))
(declare-const rliteral count_type)
(assert (= (count_typeqtint rliteral) 0))
(assert (= no_element (mk___rep (mk___split_fields rliteral))))
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
