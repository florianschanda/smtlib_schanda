...
(define-fun dynamic_invariant ((temp___expr_239 us_rep) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (not (= temp___skip_constant_237 true)) (in_range3 1 temp___expr_239)))
(define-fun default_initial_assumption ((temp___expr_241 us_rep) (temp___skip_top_level_242 Bool)) Bool (and (= (attr__tag temp___expr_241) us_tag2) (= (to_rep (rec__membership_discr__root__c (us_split_discrs1 temp___expr_241))) 1)))
