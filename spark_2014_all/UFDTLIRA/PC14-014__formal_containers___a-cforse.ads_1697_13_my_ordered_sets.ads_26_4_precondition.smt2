...
(define-fun element_type__ref___6__projection ((a element_type__ref)) us_rep1 (element_type__content a))
...
(define-fun set__ref___4__projection ((a set__ref1)) us_rep2 (set__content1 a))
(declare-fun contains (us_rep2 us_rep1) Bool)
(declare-fun contains__function_guard (Bool us_rep2 us_rep1) Bool)
...
(define-fun default_initial_assumption ((temp___expr_559 us_rep2) (temp___skip_top_level_560 Bool)) Bool (=> (not (= temp___skip_top_level_560 true)) (= (is_empty temp___expr_559) true)))
(assert (forall ((container us_rep2)) (forall ((item us_rep1)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range4 temp___expr_39)))
...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range1 temp___expr_142)))
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true))) :pattern ((length container1)))))
(assert (forall ((attr__tag Int)) (forall ((container1 us_rep)) (! (dynamic_invariant4 (length1 attr__tag container1) true false true) :pattern ((length1 attr__tag container1))))))
(declare-datatypes () ((element_type__ref2 (mk_element_type__ref2 (element_type__content2 us_rep1)))))
(define-fun element_type__ref___7__projection ((a element_type__ref2)) us_rep1 (element_type__content2 a))
...
(define-fun e_bigger_than_range ((container1 us_rep3) (fst Int) (lst Int) (item us_rep1)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get container1 i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep3 Int Int us_rep1) Bool)
(define-fun e_smaller_than_range ((container1 us_rep3) (fst Int) (lst Int) (item us_rep1)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep3 Int Int us_rep1) Bool)
(define-fun e_is_find ((container1 us_rep3) (item us_rep1) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (of_int 1)) (ite (< position (length3 container1)) (e_smaller_than_range container1 (+ position 1) (length3 container1) item) (of_int 1))))
(declare-fun e_is_find__function_guard (Bool us_rep3 us_rep1 Int) Bool)
(define-fun last ((container1 us_rep3)) Int (+ 0 (length3 container1)))
(declare-fun last__function_guard (Int us_rep3) Bool)
(define-fun oeq2 ((left us_rep3) (right us_rep3)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (bool_eq1 (get left n) (get right n)) true))) true false)))
...
(define-fun default_initial_assumption1 ((temp___expr_592 us_rep3) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (= (length3 temp___expr_592) 0)))
(declare-fun find (us_rep3 us_rep1) Int)
(declare-fun find__function_guard (Int us_rep3 us_rep1) Bool)
(assert (forall ((container1 us_rep3)) (forall ((item us_rep1)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant4 result true false true))) :pattern ((find container1 item))))))
(define-fun e_elements_included ((left us_rep3) (right us_rep3)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 left))) (and (< 0 (find right (get left i))) (= (bool_eq1 (get right (find right (get left i))) (get left i)) true)))) true false))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___626 Int)) (=> (and (in_range6 temp___626) (= (iter_has_element result temp___626) true)) (= (contains (model__ container1) (get result temp___626)) true)))) (forall ((item us_rep1)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant4 (length2 container1) true false true) :pattern ((length2 container1)))))
(assert (forall ((container1 us_rep2)) (! (let ((result (is_empty container1))) (and (= (= result true) (forall ((item us_rep1)) (not (= (contains container1 item) true)))) (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty container1)))))
(define-fun dynamic_invariant5 ((temp___expr_585 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 2147483647)) (in_range6 temp___expr_585)))
(assert (forall ((container1 us_rep3)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true))) :pattern ((length3 container1)))))
(assert true)
(declare-const temp___1034 us_rep2)
(declare-const e natural)
(declare-const e1 integer)
(declare-const o Bool)
(assert (in_range5 key))
(assert (and (= temp___1034 (model__ container)) (= (length2 temp___1034) (length container))))
(assert (not true))
(check-sat)
(exit)
