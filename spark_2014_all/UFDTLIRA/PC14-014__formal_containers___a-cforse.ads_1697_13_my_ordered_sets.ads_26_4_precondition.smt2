...
(define-fun element_type__ref___5__projection ((a element_type__ref1)) us_rep (element_type__content1 a))
...
(define-fun default_initial_assumption ((temp___expr_607 us_rep1) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty temp___expr_607) true)))
(assert (forall ((container us_rep1)) (forall ((item us_rep)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 a))) (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__my_ordered_sets__n__set (us_split_fields3 a)) (rec__my_ordered_sets__n__set (us_split_fields3 b))) true)) true false))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length container1))) (and (<= result (to_rep2 (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true true))) :pattern ((length container1)))))
...
(define-fun element_type__ref___7__projection ((a element_type__ref2)) us_rep (element_type__content2 a))
(declare-fun get (us_rep3 Int) us_rep)
(declare-fun get__function_guard (us_rep us_rep3 Int) Bool)
(define-fun e_bigger_than_range ((container1 us_rep3) (fst Int) (lst Int) (item us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt (get container1 i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep3 Int Int us_rep) Bool)
(define-fun e_smaller_than_range ((container1 us_rep3) (fst Int) (lst Int) (item us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep3 Int Int us_rep) Bool)
(define-fun e_is_find ((container1 us_rep3) (item us_rep) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item) (distinct 1 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_645 us_rep3) (temp___skip_top_level_646 Bool)) Bool (=> (not (= temp___skip_top_level_646 true)) (= (length2 temp___expr_645) 0)))
(assert (forall ((container1 us_rep3)) (forall ((item us_rep)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant4 result true false true true))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length container1)) (forall ((temp___683 Int)) (=> (and (in_range6 temp___683) (= (iter_has_element result temp___683) true)) (= (contains (model__ container1) (get result temp___683)) true)))) (forall ((item us_rep)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
