...
(define-fun default_initial_assumption ((temp___expr_607 us_rep2) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty temp___expr_607) true)))
(assert (forall ((container us_rep2)) (forall ((item us_rep1)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range4 temp___expr_46)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true true))) :pattern ((length container1)))))
(assert (forall ((attr__tag Int)) (forall ((container1 us_rep)) (! (dynamic_invariant4 (length1 attr__tag container1) true false true true) :pattern ((length1 attr__tag container1))))))
...
(define-fun e_is_find ((container1 us_rep3) (item us_rep1) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length3 container1)) (e_smaller_than_range container1 (+ position 1) (length3 container1) item) (distinct 1 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_645 us_rep3) (temp___skip_top_level_646 Bool)) Bool (=> (not (= temp___skip_top_level_646 true)) (= (length3 temp___expr_645) 0)))
(declare-fun find (us_rep3 us_rep1) Int)
(declare-fun find__function_guard (Int us_rep3 us_rep1) Bool)
(assert (forall ((container1 us_rep3)) (forall ((item us_rep1)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant4 result true false true true))) :pattern ((find container1 item))))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant4 (length2 container1) true false true true) :pattern ((length2 container1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= 0 2147483647)) (in_range6 temp___expr_637)))
(assert (forall ((container1 us_rep3)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true true))) :pattern ((length3 container1)))))
(assert true)
(assert (not true))
(check-sat)
(exit)
