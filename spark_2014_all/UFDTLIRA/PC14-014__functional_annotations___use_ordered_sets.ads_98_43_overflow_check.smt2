...
(assert (and (= o (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6)))) (= (length2 o) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields6))))))
(assert (and (= o1 (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o)) (= (= o1 true) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) item) true)) (= (contains o item) true))))))
(assert (not (in_range5 (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 5))))
(check-sat)
(exit)
