...
(assert (and (= temp___815 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields6)))) (and (and (and (= (length2 temp___815) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields6)))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element temp___815 temp___390) true)) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6))) (get temp___815 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6))) item) true)) (and (< 0 (find temp___815 item)) (= (equivalent_elements (get temp___815 (find temp___815 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s__split_discrs (mk___split_fields s__split_fields6))))) (and (= (find temp___815 (get temp___815 i)) i) (= (e_is_find temp___815 (get temp___815 i) i) true)))))))
(assert (and (= o4 (iter_has_element temp___815 temp___814)) (= (= o4 true) (and (<= 1 temp___814) (<= temp___814 (last temp___815))))))
(assert (= (= o5 true) (in_range4 temp___814)))
(assert (= result (ite (= o5 true) o4 false)))
(assert (= (= o6 true) (let ((temp___818 (elements (mk___rep s__split_discrs (mk___split_fields s__split_fields6))))) (forall ((temp___817 Int)) (=> (and (in_range4 temp___817) (= (iter_has_element temp___818 temp___817) true)) (let ((e1 (get temp___818 temp___817))) (or (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) e1) true) (and (<= 1 e1) (<= e1 5)))))))))
(assert (= (= o3 true) (forall ((e1 Int)) (=> (and (<= 1 e1) (<= e1 5)) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6))) e1) true)))))
(assert (and (= o1 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6)))) (= (length3 o1) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields6))))))
(assert (and (= o2 (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o1)) (= (= o2 true) (forall ((item Int)) (=> (and (in_range3 item) (= (contains (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) item) true)) (= (contains o1 item) true))))))
