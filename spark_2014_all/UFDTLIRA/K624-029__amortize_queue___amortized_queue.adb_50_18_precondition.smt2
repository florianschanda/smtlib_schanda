...
(assert (and (= o5 (get (model__ left) o4)) (and (in_range4 o5) (= o5 (get (model__ left) o4)))))
(assert (and (= o3 i) (in_range3 i)))
(assert (not (<= o3 (last (model__ (mk___rep result____split_discrs result____split_fields3))))))
(check-sat)
(exit)
