...
(assert (<= 1 i5))
(assert (<= i5 (last (model__ left))))
(assert (not (= (get (model__ (mk___rep result____split_discrs (us_split_fields__content result____split_fields12))) i5) (get (model__ left) i5))))
(check-sat)
(exit)
