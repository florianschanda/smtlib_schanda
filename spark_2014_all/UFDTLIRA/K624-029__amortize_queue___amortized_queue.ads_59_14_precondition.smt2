...
(assert (and (= o8 (length m)) (and (in_range2 o8) (<= o8 (capacity m)))))
(assert (and (= o6 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o6) (<= o6 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o7 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range2 o7) (<= o7 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o9 (+ o7 o6)))
(assert (= result2 (ite (= o9 o8) true false)))
(assert (=> (= result2 true) (and (= o5 (length m)) (and (in_range2 o5) (<= o5 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o5 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o3 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range2 o3) (<= o3 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
(assert (=> (= result1 true) (= o4 (ite (<= i1 o3) true false))))
(assert (=> (= result1 true) (= result3 (ite (<= 1 i1) o4 false))))
...
(assert (not (<= o2 (last (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(check-sat)
(exit)
