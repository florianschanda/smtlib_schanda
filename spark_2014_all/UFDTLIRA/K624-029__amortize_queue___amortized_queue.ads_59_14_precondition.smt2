...
(assert (=> (= result2 true) (and (= o5 (length m)) (and (in_range4 o5) (<= o5 (capacity m))))))
(assert (=> (= result2 true) (= result1 (ite (<= o5 1000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o3 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o3) (<= o3 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q))))))))
