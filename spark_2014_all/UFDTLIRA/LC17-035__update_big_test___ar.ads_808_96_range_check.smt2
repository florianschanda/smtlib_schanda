...
(declare-const temp___6761 et3)
(declare-const temp___67611 et1)
(declare-const temp___67612 et2)
(declare-const temp___67613 enum1ta)
...
(declare-const temp___6764 us_rep1)
...
(assert (= temp___6761 o6))
(assert (= temp___67611 o7))
(assert (= temp___67612 o8))
(assert (= temp___67613 o9))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6761 (mk___rep (mk___split_fields temp___67611 temp___67612)) temp___67613)))
...
(assert (= temp___6764 (mk___rep1 (mk___split_fields1 o15 (mk___rep (mk___split_fields o16 o17)) o18))))
(assert (= result2 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (us_split_fields3 temp___6764)))
