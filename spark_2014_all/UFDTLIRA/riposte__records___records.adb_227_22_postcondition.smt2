...
(declare-const temp___323 Bool)
(declare-const temp___3231 unsigned_byte)
(declare-const temp___3232 unsigned_byte)
...
(assert (=> (= x__split_fields true) (= x__split_fields4 (mk___split_fields1 temp___323 (mk___rep (mk___split_fields temp___3231 temp___3232))))))
...
(assert (=> (= x__split_fields true) (= temp___326 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15)))))))
(assert (=> (= x__split_fields true) (= result2 (mk___split_fields__ref1 x__split_fields4))))
(assert (=> (= x__split_fields true) (= x__split_fields5 (us_split_fields3 temp___326))))
