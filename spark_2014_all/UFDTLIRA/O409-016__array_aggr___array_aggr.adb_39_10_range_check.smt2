...
(assert (= first one))
(assert (forall ((temp___325 Int)) (=> (dynamic_invariant temp___325 true true true true) (forall ((temp___326 Int) (temp___327 Int)) (= (to_rep (get (array_aggr__bi_dim_aggr_ko__aggregate_ko__a__aggregate_def temp___325) temp___326 temp___327)) temp___325)))))
(assert (<= 1 2))
(assert (not (<= first 1)))
(check-sat)
(exit)
