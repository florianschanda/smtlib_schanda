...
(assert (forall ((temp___289 Int)) (forall ((temp___290 Int) (temp___291 Int)) (= (get (array_aggr__bi_dim_aggr_ko__aggregate_ko__a__aggregate_def temp___289) temp___290 temp___291) (of_rep temp___289)))))
...
(define-fun dynamic_invariant2 ((temp___expr_221 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_221)))
(assert (= first one))
(assert (<= 1 2))
(assert (not (<= first 1)))
(check-sat)
