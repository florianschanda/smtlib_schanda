...
(define-fun tTaSP2__ref___2__projection ((a tTaSP2__ref)) tTaSP2 (tTaSP2__content a))
(declare-sort t23b 0)
(declare-fun t23bqtint (t23b) Int)
(assert (forall ((i t23b)) (and (<= 3 (t23bqtint i)) (<= (t23bqtint i) 4))))
...
(assert (forall ((i t24b)) (and (<= 3 (t24bqtint i)) (<= (t24bqtint i) 4))))
...
(define-fun dynamic_invariant2 ((temp___expr_253 Int) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool (=> (or (= temp___is_init_249 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_253)))
(assert (= first one))
(declare-const rliteral natural)
(assert (= (naturalqtint rliteral) 0))
(assert (forall ((temp___325 Int)) (=> (dynamic_invariant temp___325 true true true true) (forall ((temp___326 Int) (temp___327 Int)) (= (get (array_aggr__bi_dim_aggr_ko__aggregate_ko__a__aggregate_def temp___325) temp___326 temp___327) rliteral)))))
(assert (<= 1 2))
