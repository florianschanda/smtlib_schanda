...
(assert (=> (= result true) (and (= us index) (dynamic_property3 first2 last3 index))))
...
(assert (=> (not (= result true)) (and (= us1 temp___465) (dynamic_property3 first2 last3 temp___465))))
(assert (=> (not (= result true)) (= o1 temp___465)))
(assert (not (dynamic_property2 first1 last2 first)))
(check-sat)
(exit)
