...
(assert (=> (= result true) (and (= us index) (dynamic_property4 first3 last5 index))))
...
(assert (=> (not (= result true)) (and (= us1 temp___465) (dynamic_property4 first3 last5 temp___465))))
(assert (=> (not (= result true)) (= o1 temp___465)))
(assert (not (dynamic_property first last first1)))
(check-sat)
(exit)
