...
(declare-const temp___803 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___803 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___803)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__my_ordered_maps__m__map__capacity (us_split_discrs1 container)))))))
