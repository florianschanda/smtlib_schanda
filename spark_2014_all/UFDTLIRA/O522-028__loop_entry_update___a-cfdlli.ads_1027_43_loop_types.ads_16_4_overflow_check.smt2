...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___706 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___706)) no_element))
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__loop_types__lists__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__loop_types__lists__list__capacity target__split_discrs)) o2)))
