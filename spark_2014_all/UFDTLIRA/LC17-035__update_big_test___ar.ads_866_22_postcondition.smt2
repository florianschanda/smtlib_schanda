...
(declare-const temp___6781 et3)
(declare-const temp___67811 et1)
(declare-const temp___67812 et2)
(declare-const temp___67813 enum1ta)
...
(assert (= temp___6781 o5))
(assert (= temp___67811 o6))
(assert (= temp___67812 o7))
(assert (= temp___67813 o8))
...
(assert (= r__split_fields8 (mk___split_fields1 temp___6781 (mk___rep (mk___split_fields temp___67811 temp___67812)) temp___67813)))
