...
(assert (and (= o6 (+ position2 1)) (in_range3 (+ position2 1))))
(assert (= position2 result4))
(assert (= position3 o6))
(assert (and (= o8 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o8) (<= o8 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (= result6 (ite (<= position3 o8) true false)))
(assert (=> (= result6 true) (and (= o7 (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position3)) (and (in_range8 o7) (= o7 (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position3))))))
(assert (=> (= result6 true) (= o9 (ite (< o7 new_item) true false))))
(assert (=> (not (= result6 true)) (= o9 false)))
