...
(assert (=> (< 0 speed1) (and (= (speed_is_valid speed2 state2) true) (and (in_range1 state2) (in_range2 speed2)))))
(assert (=> (not (< 0 speed1)) (and (= (speed_is_valid speed3 state3) true) (and (in_range1 state3) (in_range2 speed3)))))
