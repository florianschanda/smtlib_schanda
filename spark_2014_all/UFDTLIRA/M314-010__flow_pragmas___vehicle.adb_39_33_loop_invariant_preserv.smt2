...
(assert (=> (< 0 speed2) (and (= (speed_is_valid speed3 state3) true) (and (in_range1 state3) (in_range2 speed3)))))
(assert (=> (not (< 0 speed2)) (and (= (speed_is_valid speed4 state4) true) (and (in_range1 state4) (in_range2 speed4)))))
