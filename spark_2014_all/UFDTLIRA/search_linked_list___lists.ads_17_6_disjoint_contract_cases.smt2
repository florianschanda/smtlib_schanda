...
(assert (not (<= (+ (+ 0 (ite (forall ((cu us_rep1)) (=> (= (has_key (positions l) cu) true) (not (= (element l cu) 0)))) 1 0)) (ite (exists ((cu us_rep1)) (and (= (has_key (positions l) cu) true) (= (element l cu) 0))) 1 0)) 1)))
(check-sat)
(exit)
