...
(define-fun e_is_find ((container us_rep2) (item us_rep1) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container 1 (- position 1) item) (of_int 1)) (ite (< position (length2 container)) (e_smaller_than_range container (+ position 1) (length2 container) item) (of_int 1))))
...
(define-fun oeq2 ((left1 us_rep2) (right1 us_rep2)) Bool (and (= (length2 left1) (length2 right1)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left1))) (= (bool_eq1 (get left1 n) (get right1 n)) true))) true false)))
...
(assert (forall ((container us_rep2)) (forall ((item us_rep1)) (! (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true))) :pattern ((find container item))))))
(define-fun e_elements_included ((left1 us_rep2) (right1 us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 left1))) (and (< 0 (find right1 (get left1 i))) (= (bool_eq1 (get right1 (find right1 (get left1 i))) (get left1 i)) true)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_559 us_rep3) (temp___skip_top_level_560 Bool)) Bool (=> (not (= temp___skip_top_level_560 true)) (= (is_empty temp___expr_559) true)))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((item us_rep1)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant (length3 container) true false true) :pattern ((length3 container)))))
(assert (forall ((container us_rep3)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item us_rep1)) (not (= (contains container item) true)))) (= (= result true) (= (length3 container) 0)))) :pattern ((is_empty container)))))
