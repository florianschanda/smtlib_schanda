...
(assert (= i result3))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 5)) (= temp___165 i1)))
(assert (=> (and (<= 1 i1) (<= i1 5)) (= 0 temp___166)))
(assert (=> (and (<= 1 i1) (<= i1 5)) (and (=> (<= 1 5) (in_range2 i2)) (and (<= 1 i2) (<= i2 5)))))
(assert (=> (and (<= 1 i1) (<= i1 5)) (= temp___1661 result4)))
(assert (=> (and (<= 1 i1) (<= i1 5)) (= temp___1662 i2)))
(assert (=> (and (<= 1 i1) (<= i1 5)) (=> (= (distinct 1 0) true) (not (= (distinct 1 0) true)))))
(assert (=> (and (<= 1 i1) (<= i1 5)) (= i2 5)))
(assert (=> (and (<= 1 i1) (<= i1 5)) (= i2 i3)))
(assert (=> (and (<= 1 i1) (<= i1 5)) (= rho1 temp___1662)))
