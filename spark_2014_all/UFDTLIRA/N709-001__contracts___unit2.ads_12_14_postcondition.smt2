...
(declare-const temp___1982 us_private)
(declare-const temp___1983 Int)
...
(assert (= temp___198 o1))
(assert (= temp___1981 o2))
(assert (= temp___1982 o3))
(assert (= x__attr__tag temp___1983))
(assert (= result3 x__split_fields3))
(assert (= result4 x__split_fields4))
(assert (= result5 x__split_fields5))
(assert (= temp___198 x__split_fields6))
(assert (= temp___1981 x__split_fields7))
(assert (= temp___1982 x__split_fields8))
