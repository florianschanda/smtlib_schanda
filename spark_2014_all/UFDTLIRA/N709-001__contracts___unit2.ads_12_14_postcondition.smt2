...
(assert (forall ((unit1__create__x__fields us_split_fields) (unit1__create__x__old__fields us_split_fields)) (forall ((x__attr__tag Int)) (! (=> (create__specific_post us_tag1 unit1__create__x__fields x__attr__tag unit1__create__x__old__fields) (let ((temp___x_143 (of_base (mk___rep unit1__create__x__fields x__attr__tag)))) (and (= (to_rep (rec__unit1__t1__c11 (us_split_fields3 temp___x_143))) 0) (= (to_rep (rec__unit2__t2__c2 (us_split_fields3 temp___x_143))) 0)))) :pattern ((create__specific_post us_tag1 unit1__create__x__fields x__attr__tag unit1__create__x__old__fields))))))
...
(declare-const temp___1722 us_private)
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= x__split_fields4 o2))
(assert (= x__split_fields5 o3))
(assert (= temp___172 o1))
(assert (= temp___1721 o2))
(assert (= temp___1722 o3))
(assert (= x__attr__tag temp___1723))
(assert (= result3 x__split_fields3))
(assert (= result4 x__split_fields4))
(assert (= result5 x__split_fields5))
(assert (= temp___172 x__split_fields6))
(assert (= temp___1721 x__split_fields7))
(assert (= temp___1722 x__split_fields8))
...
(assert (not (= (to_rep x__split_fields10) 0)))
(check-sat)
(exit)
