...
(assert (and (= o15 (has_key (positions l) (mk___rep1 c__split_fields3))) (= (= o15 true) (= (has_key (positions l) (mk___rep1 c__split_fields3)) true))))
(assert (= result7 (ite (not (= o15 true)) true false)))
(assert (not (= result7 true)))
(declare-const i2 Int)
(assert (<= 1 i2))
(assert (<= i2 (- (get1 (positions l) (mk___rep1 c__split_fields3)) 1)))
