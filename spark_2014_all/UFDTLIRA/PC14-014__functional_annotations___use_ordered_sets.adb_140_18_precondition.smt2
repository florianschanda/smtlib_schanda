...
(assert (and (= o5 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))) (and (in_range2 o5) (<= o5 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o6 (ite (<= i o5) true false)))
(assert (= result2 (ite (<= 1 i) o6 false)))
(assert (= result2 true))
(assert (and (= o8 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length2 o8) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o8 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o8 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o8 item)) (= (equivalent_elements (get o8 (find o8 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o8 (get o8 i1)) i1) (= (e_is_find o8 (get o8 i1) i1) true)))))))
(assert (and (= o9 (get o8 i)) (in_range3 o9)))
(assert (and (= o7 (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))) (and (and (and (= (length2 o7) (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o7 temp___390) true)) (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (get o7 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) item) true)) (and (< 0 (find o7 item)) (= (equivalent_elements (get o7 (find o7 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))))) (and (= (find o7 (get o7 i1)) i1) (= (e_is_find o7 (get o7 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
