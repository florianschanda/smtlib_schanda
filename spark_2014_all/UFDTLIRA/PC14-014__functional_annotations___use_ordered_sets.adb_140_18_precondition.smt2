...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) i1) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1)))))
(assert (and (= o (length (mk___rep s2__split_discrs s2__split_fields2))) (and (in_range2 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result2 (ite (<= 1 i) o1 false)))
(assert (= result2 true))
(assert (and (= o3 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length2 o3) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o3 temp___432) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o3 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o3 item)) (= (equivalent_elements (get o3 (find o3 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o3 (get o3 i1)) i1) (= (e_is_find o3 (get o3 i1) i1) true)))))))
(assert (and (= o4 (get o3 i)) (in_range3 o4)))
(assert (and (= o2 (elements (mk___rep s2__split_discrs s2__split_fields2))) (and (and (and (= (length2 o2) (length (mk___rep s2__split_discrs s2__split_fields2))) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o2 temp___432) true)) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) (get o2 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2)))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
