...
(define-fun default_initial_assumption1 ((temp___expr_174 us_rep1) (temp___skip_top_level_175 Bool) (dic__g Int)) Bool (and (and (= (to_rep (rec__dic__pr_record_t2__x (us_split_fields3 temp___expr_174))) 0) (= (to_rep (rec__dic__pr_record_t2__y (us_split_fields3 temp___expr_174))) 0)) (=> (not (= temp___skip_top_level_175 true)) (= (foo temp___expr_174 dic__g) true))))
...
(define-fun default_initial_assumption2 ((temp___expr_182 us_rep2) (temp___skip_top_level_183 Bool)) Bool (and (= (to_rep (rec__dic__pr_uninit_t__x (us_split_fields5 temp___expr_182))) 0) (= (to_rep (rec__dic__pr_uninit_t__y (us_split_fields5 temp___expr_182))) 0)))
