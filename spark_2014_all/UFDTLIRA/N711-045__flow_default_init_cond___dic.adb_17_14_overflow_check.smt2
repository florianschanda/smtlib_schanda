...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (to_rep (rec__dic__pr_record_t__x (us_split_fields1 temp___expr_143))) 0) (= (to_rep (rec__dic__pr_record_t__y (us_split_fields1 temp___expr_143))) 0)))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dic__pr_record_t2__x integer) (rec__dic__pr_record_t2__y integer)))))
(define-fun us_split_fields_X__3__projection ((a us_split_fields2)) integer (rec__dic__pr_record_t2__x a))
(define-fun us_split_fields_Y__2__projection ((a us_split_fields2)) integer (rec__dic__pr_record_t2__y a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__dic__pr_record_t2__x (us_split_fields3 a))) (to_rep (rec__dic__pr_record_t2__x (us_split_fields3 b)))) (= (to_rep (rec__dic__pr_record_t2__y (us_split_fields3 a))) (to_rep (rec__dic__pr_record_t2__y (us_split_fields3 b))))) true false))
...
(assert (< dic__pr_record_t2__x__first__bit dic__pr_record_t2__x__last__bit))
...
(assert (< dic__pr_record_t2__y__first__bit dic__pr_record_t2__y__last__bit))
(assert (<= 0 dic__pr_record_t2__y__position))
(declare-fun user_eq2 (us_rep1 us_rep1) Bool)
(declare-const dummy2 us_rep1)
(declare-datatypes () ((pr_record_t2__ref (mk_pr_record_t2__ref (pr_record_t2__content us_rep1)))))
(define-fun pr_record_t2__ref___projection ((a pr_record_t2__ref)) us_rep1 (pr_record_t2__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun foo (us_rep1 Int) Bool)
(declare-fun foo__function_guard (Bool us_rep1 Int) Bool)
(define-fun default_initial_assumption1 ((temp___expr_149 us_rep1) (temp___skip_top_level_150 Bool) (dic__g Int)) Bool (and (and (= (to_rep (rec__dic__pr_record_t2__x (us_split_fields3 temp___expr_149))) 0) (= (to_rep (rec__dic__pr_record_t2__y (us_split_fields3 temp___expr_149))) 0)) (=> (not (= temp___skip_top_level_150 true)) (= (foo temp___expr_149 dic__g) true))))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__dic__pr_uninit_t__x integer) (rec__dic__pr_uninit_t__y integer)))))
(define-fun us_split_fields_X__4__projection ((a us_split_fields4)) integer (rec__dic__pr_uninit_t__x a))
(define-fun us_split_fields_Y__3__projection ((a us_split_fields4)) integer (rec__dic__pr_uninit_t__y a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__dic__pr_uninit_t__x (us_split_fields5 a))) (to_rep (rec__dic__pr_uninit_t__x (us_split_fields5 b)))) (= (to_rep (rec__dic__pr_uninit_t__y (us_split_fields5 a))) (to_rep (rec__dic__pr_uninit_t__y (us_split_fields5 b))))) true false))
...
(declare-datatypes () ((pr_uninit_t__ref (mk_pr_uninit_t__ref (pr_uninit_t__content us_rep2)))))
(define-fun pr_uninit_t__ref___projection ((a pr_uninit_t__ref)) us_rep2 (pr_uninit_t__content a))
(define-fun default_initial_assumption2 ((temp___expr_156 us_rep2) (temp___skip_top_level_157 Bool)) Bool (and (= (to_rep (rec__dic__pr_uninit_t__x (us_split_fields5 temp___expr_156))) 0) (= (to_rep (rec__dic__pr_uninit_t__y (us_split_fields5 temp___expr_156))) 0)))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__dic__pr_liar_t__x integer) (rec__dic__pr_liar_t__y integer)))))
(define-fun us_split_fields_X__5__projection ((a us_split_fields6)) integer (rec__dic__pr_liar_t__x a))
(define-fun us_split_fields_Y__4__projection ((a us_split_fields6)) integer (rec__dic__pr_liar_t__y a))
...
(define-fun bool_eq3 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep (rec__dic__pr_liar_t__x (us_split_fields7 a))) (to_rep (rec__dic__pr_liar_t__x (us_split_fields7 b)))) (= (to_rep (rec__dic__pr_liar_t__y (us_split_fields7 a))) (to_rep (rec__dic__pr_liar_t__y (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((pr_liar_t__ref (mk_pr_liar_t__ref (pr_liar_t__content us_rep3)))))
(define-fun pr_liar_t__ref___projection ((a pr_liar_t__ref)) us_rep3 (pr_liar_t__content a))
