...
(assert (forall ((initialization_and_elaboration__private_child__state us_private)) (! (dynamic_invariant (get_it initialization_and_elaboration__private_child__state) true false true) :pattern ((get_it initialization_and_elaboration__private_child__state)))))
