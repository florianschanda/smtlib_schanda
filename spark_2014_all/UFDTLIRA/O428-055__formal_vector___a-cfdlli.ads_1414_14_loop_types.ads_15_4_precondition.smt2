...
(define-fun dynamic_invariant1 ((temp___expr_461 Int) (temp___is_init_457 Bool) (temp___skip_constant_458 Bool) (temp___do_toplevel_459 Bool) (temp___do_typ_inv_460 Bool)) Bool (=> (or (= temp___is_init_457 true) (<= 1 2147483647)) (in_range2 temp___expr_461)))
...
(define-fun default_initial_assumption ((temp___expr_469 us_rep3) (temp___skip_top_level_470 Bool)) Bool (=> (not (= temp___skip_top_level_470 true)) (and (= (is_empty temp___expr_469) true) (= (length2 temp___expr_469) 0))))
(define-fun default_initial_assumption1 ((temp___expr_455 us_rep2) (temp___skip_top_level_456 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_455))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_447 us_rep1) (temp___skip_top_level_448 Bool)) Bool (=> (not (= temp___skip_top_level_448 true)) (= (length1 temp___expr_447) 0)))
...
(assert (=> (= (bool_eq2 position no_element) true) (= o2 1)))
