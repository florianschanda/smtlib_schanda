...
(define-fun dynamic_invariant ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range2 temp___expr_396)))
...
(define-fun dynamic_invariant2 ((temp___expr_461 Int) (temp___is_init_457 Bool) (temp___skip_constant_458 Bool) (temp___do_toplevel_459 Bool) (temp___do_typ_inv_460 Bool)) Bool (=> (or (= temp___is_init_457 true) (<= 1 2147483647)) (in_range3 temp___expr_461)))
...
(define-fun default_initial_assumption2 ((temp___expr_455 us_rep1) (temp___skip_top_level_456 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_455))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_447 us_rep2) (temp___skip_top_level_448 Bool)) Bool (=> (not (= temp___skip_top_level_448 true)) (= (length1 temp___expr_447) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_439 Int) (temp___is_init_435 Bool) (temp___skip_constant_436 Bool) (temp___do_toplevel_437 Bool) (temp___do_typ_inv_438 Bool)) Bool (=> (or (= temp___is_init_435 true) (<= 0 2147483647)) (in_range4 temp___expr_439)))
...
(define-fun dynamic_invariant4 ((temp___expr_432 Int) (temp___is_init_428 Bool) (temp___skip_constant_429 Bool) (temp___do_toplevel_430 Bool) (temp___do_typ_inv_431 Bool)) Bool (=> (or (= temp___is_init_428 true) (<= 0 2147483647)) (in_range5 temp___expr_432)))
...
(declare-const temp___732 count_type)
(declare-const o2 us_rep3)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___732 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___732)) no_element))
(assert (in_range2 item))
(assert (or (= (has_key (positions container) position) true) (= (bool_eq1 position no_element) true)))
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container)))))))
