...
(define-fun dynamic_invariant ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range2 temp___expr_352)))
...
(define-fun dynamic_invariant2 ((temp___expr_408 Int) (temp___is_init_405 Bool) (temp___skip_constant_406 Bool) (temp___do_toplevel_407 Bool)) Bool (=> (or (= temp___is_init_405 true) (<= 1 2147483647)) (in_range3 temp___expr_408)))
...
(define-fun default_initial_assumption1 ((temp___expr_415 us_rep3) (temp___skip_top_level_416 Bool)) Bool (=> (not (= temp___skip_top_level_416 true)) (and (= (is_empty temp___expr_415) true) (= (length2 temp___expr_415) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_403 us_rep1) (temp___skip_top_level_404 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields3 temp___expr_403))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_396 us_rep2) (temp___skip_top_level_397 Bool)) Bool (=> (not (= temp___skip_top_level_397 true)) (= (length1 temp___expr_396) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 0 2147483647)) (in_range4 temp___expr_389)))
...
(define-fun dynamic_invariant4 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 0 2147483647)) (in_range5 temp___expr_383)))
...
(declare-const temp___676 count_type)
(declare-const o2 us_rep3)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___676 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___676)) no_element))
