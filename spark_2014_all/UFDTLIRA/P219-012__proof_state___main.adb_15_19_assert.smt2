...
(declare-const dummy1 a)
(declare-datatypes () ((a__ref (mk_a__ref (a__content a)))))
(define-fun a__ref___projection ((a1 a__ref)) a (a__content a1))
(define-fun dynamic_invariant1 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 10)) (in_range1 temp___expr_171)))
(declare-fun f (tuple0) Int)
(declare-fun f__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant1 (f us_void_param) true false true) :pattern ((f us_void_param)))))
(declare-const x Int)
