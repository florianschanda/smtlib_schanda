...
(assert (forall ((e Int)) (=> (and (in_range3 e) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields3)) e) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields3)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) e))))))
...
(assert (not (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i)) true)))
(check-sat)
(exit)
