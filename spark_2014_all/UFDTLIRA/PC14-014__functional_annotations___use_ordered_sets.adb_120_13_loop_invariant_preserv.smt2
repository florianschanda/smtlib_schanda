...
(assert (not (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i2)) true)))
(check-sat)
(exit)
