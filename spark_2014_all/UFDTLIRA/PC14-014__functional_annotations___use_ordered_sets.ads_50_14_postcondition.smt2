...
(declare-const temp___741 Int)
(assert (in_range3 temp___741))
(assert (= (iter_has_element (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) temp___741) true))
(assert (not (= (prop__ (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) temp___741)) true)))
(check-sat)
(exit)
