...
(define-fun temp___784 () us_rep1 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))))
(declare-const temp___783 Int)
(assert (in_range3 temp___783))
(assert (= (iter_has_element temp___784 temp___783) true))
(assert (not (= (prop__ (get temp___784 temp___783)) true)))
(check-sat)
(exit)
