...
(define-fun dynamic_invariant ((temp___expr_176 us_rep1) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (not (= temp___skip_constant_174 true)) (in_range2 0 (to_base temp___expr_176))))
...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 97)) (in_range1 temp___expr_159)))
...
(assert (= po__split_discrs (mk___split_discrs o)))
(assert (= o o1))
(assert (= us_self__compl o1))
(assert (= po__split_discrs (mk___split_discrs o2)))
(assert (= o2 o3))
(assert (= o4 o3))
(assert (= o5 (to_rep o4)))
(assert (not (not (= o5 (to_rep us_self__compl)))))
(check-sat)
(exit)
