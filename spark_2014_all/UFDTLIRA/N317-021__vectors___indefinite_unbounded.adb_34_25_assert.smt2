...
(define-fun v__split_fields6 () us_split_fields (mk___split_fields v__split_fields2))
...
(define-fun v__split_fields7 () us_split_fields (mk___split_fields v__split_fields1))
...
(assert (= v__split_fields7 indefinite_unbounded__vect__clear__container__fields1))
(assert (= (is_empty (mk___rep v__split_discrs v__split_fields7)) true))
(assert (= (oeq (mk___rep v__split_discrs v__split_fields7) (empty_vector Tuple0)) true))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields4)) (+ (length (mk___rep v__split_discrs v__split_fields7)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields7)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields4))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields4)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields7))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= v__split_fields6 indefinite_unbounded__vect__append__2__container__fields4))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields3)) (+ (length (mk___rep v__split_discrs v__split_fields6)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields6)) (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields3))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_unbounded__vect__append__2__container__fields3)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields6))) 1)) 2)))
