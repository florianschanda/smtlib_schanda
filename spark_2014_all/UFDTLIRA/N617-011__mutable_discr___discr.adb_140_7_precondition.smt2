...
(define-fun td2S__ref___2__projection ((a td2S__ref)) us_rep (td2S__content a))
(define-fun dynamic_invariant1 ((temp___expr_245 us_rep) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (and (=> (not (= temp___skip_constant_243 true)) (in_range1 c temp___expr_245)) (= (attr__constrained temp___expr_245) true)))
(define-fun default_initial_assumption1 ((temp___expr_247 us_rep) (temp___skip_top_level_248 Bool)) Bool (and (= (attr__constrained temp___expr_247) true) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___expr_247))) c)))
...
(declare-const discr__p4__d2__assume natural)
(declare-const discr__p4__d2__assume1 us_main_type)
(declare-const discr__p4__d2__assume2 Bool)
...
(declare-const discr__p4__nested1__d__discrs us_split_discrs)
(declare-const discr__p4__nested1__d__fields us_split_fields)
(declare-const result3 us_split_fields__ref)
(declare-const d2__split_fields2 us_split_fields)
(assert (in_range c))
(assert (and (= (mk___rep (mk___split_discrs discr__p4__d1__assume) (mk___split_fields discr__p4__d1__assume1) discr__p4__d1__assume2) (new_with_default c)) (= (to_rep discr__p4__d1__assume) c)))
(assert (= result d1__split_fields))
(assert (= discr__p4__d1__assume1 d1__split_fields1))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs d1__split_discrs))))
...
(assert (= (mk___rep (mk___split_discrs discr__p4__d2__assume) (mk___split_fields discr__p4__d2__assume1) discr__p4__d2__assume2) (mk___rep (mk___split_discrs o3) (mk___split_fields o4) o5)))
(assert (= result2 (mk___split_fields__ref (mk___split_fields d2__split_fields))))
(assert (= d2__split_fields1 (mk___split_fields discr__p4__d2__assume1)))
(assert (= d2__split_discrs (mk___split_discrs discr__p4__d2__assume)))
(assert (= d2__attr__constrained true))
(assert (and (= c (to_rep (rec__private_discr__p_with_default__c d2__split_discrs))) (= d2__attr__constrained true)))
(assert true)
(assert (not true))
(check-sat)
(exit)
