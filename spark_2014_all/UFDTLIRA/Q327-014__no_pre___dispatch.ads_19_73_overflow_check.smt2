...
(define-fun dispatch__incr3__result17 () us_rep (mk___rep (mk___split_fields dispatch__incr3__result6 dispatch__incr3__result7) dispatch__incr3__result8))
(define-fun dispatch__incr3__result18 () us_rep (mk___rep (mk___split_fields dispatch__incr3__result3 dispatch__incr3__result4) dispatch__incr3__result5))
(define-fun dispatch__incr3__result19 () root__ref (mk_root__ref (mk___rep (mk___split_fields dispatch__incr3__result dispatch__incr3__result1) dispatch__incr3__result2)))
(assert (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647))
(assert (= dispatch__incr3__result13 (mk_root__ref (mk___rep (mk___split_fields dispatch__incr3__result9 dispatch__incr3__result10) dispatch__incr3__result11))))
...
(assert (=> (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647) (= dispatch__incr3__result12 dispatch__incr3__result18)))
...
(assert (=> (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647) (= (mk_root__ref (mk___rep (mk___split_fields result result1) result2)) dispatch__incr3__result19)))
(assert (=> (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647) (= dispatch__incr3__result18 (mk___rep (mk___split_fields o4 o5) o6))))
...
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= dispatch__incr3__result12 dispatch__incr3__result17)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= (to_rep o7) 0)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= o7 o8)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= us_null_ext__ o9)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= o10 o8)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= o11 o9)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= us_tag o12)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= (mk_root__ref (mk___rep (mk___split_fields result3 result4) result5)) dispatch__incr3__result19)))
(assert (=> (not (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647)) (= dispatch__incr3__result17 (mk___rep (mk___split_fields o10 o11) o12))))
(assert (= dispatch__incr3__result15 dispatch__incr3__result13))
(assert (= dispatch__incr3__result16 dispatch__incr3__result14))
(assert (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647))
(assert (not (in_range1 (+ (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 1))))
(check-sat)
(exit)
