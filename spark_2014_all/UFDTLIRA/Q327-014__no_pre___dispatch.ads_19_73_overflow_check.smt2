...
(assert (and (and (= dispatch__incr3__result13 (mk_root__ref (mk___rep (mk___split_fields dispatch__incr3__result9 dispatch__incr3__result10) dispatch__incr3__result11))) (= dispatch__incr3__result14 dispatch__incr3__result12)) (ite (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647) (and (and (and (and (= dispatch__incr3__result9 dispatch__incr3__result3) (= dispatch__incr3__result10 dispatch__incr3__result4)) (= dispatch__incr3__result11 dispatch__incr3__result5)) (= dispatch__incr3__result12 (mk___rep (mk___split_fields dispatch__incr3__result3 dispatch__incr3__result4) dispatch__incr3__result5))) (and (and (and (and (and (= o (+ (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 1)) (in_range1 (+ (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 1))) (= (to_rep o1) o)) (and (= o1 o2) (= us_null_ext__ o3))) (and (and (= o4 o2) (= o5 o3)) (= us_tag o6))) (and (= (mk_root__ref (mk___rep (mk___split_fields result result1) result2)) (mk_root__ref (mk___rep (mk___split_fields dispatch__incr3__result dispatch__incr3__result1) dispatch__incr3__result2))) (= (mk___rep (mk___split_fields dispatch__incr3__result3 dispatch__incr3__result4) dispatch__incr3__result5) (mk___rep (mk___split_fields o4 o5) o6))))) (and (and (and (and (= dispatch__incr3__result9 dispatch__incr3__result6) (= dispatch__incr3__result10 dispatch__incr3__result7)) (= dispatch__incr3__result11 dispatch__incr3__result8)) (= dispatch__incr3__result12 (mk___rep (mk___split_fields dispatch__incr3__result6 dispatch__incr3__result7) dispatch__incr3__result8))) (and (and (and (= (to_rep o7) 0) (and (= o7 o8) (= us_null_ext__ o9))) (and (and (= o10 o8) (= o11 o9)) (= us_tag o12))) (and (= (mk_root__ref (mk___rep (mk___split_fields result3 result4) result5)) (mk_root__ref (mk___rep (mk___split_fields dispatch__incr3__result dispatch__incr3__result1) dispatch__incr3__result2))) (= (mk___rep (mk___split_fields dispatch__incr3__result6 dispatch__incr3__result7) dispatch__incr3__result8) (mk___rep (mk___split_fields o10 o11) o12))))))))
