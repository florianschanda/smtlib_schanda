...
(define-fun dynamic_invariant ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 10000)) (in_range temp___expr_147)))
...
(define-fun default_initial_assumption ((temp___expr_204 us_rep2) (temp___skip_top_level_205 Bool)) Bool (and (= (length (rec__list_allocator__m__t__available (us_split_fields1 temp___expr_204))) 0) (= (is_empty (rec__list_allocator__m__t__allocated (us_split_fields1 temp___expr_204))) true)))
...
(define-fun default_initial_assumption1 ((temp___expr_178 us_rep) (temp___skip_top_level_179 Bool)) Bool (=> (not (= temp___skip_top_level_179 true)) (= (length temp___expr_178) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_191 us_rep1) (temp___skip_top_level_192 Bool)) Bool (=> (not (= temp___skip_top_level_192 true)) (= (is_empty temp___expr_191) true)))
...
(define-fun dynamic_invariant2 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 2147483647)) (in_range3 temp___expr_171)))
...
(define-fun dynamic_invariant3 ((temp___expr_165 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 10000)) (in_range4 temp___expr_165)))
...
(define-fun dynamic_invariant4 ((temp___expr_184 Int) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (or (= temp___is_init_181 true) (<= 0 10000)) (in_range5 temp___expr_184)))
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(declare-fun length1 (us_rep1) Int)
(declare-fun length__function_guard1 (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (dynamic_invariant1 (length1 container) true false true) :pattern ((length1 container)))))
...
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range5 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(declare-const model____split_fields10 us_rep)
(declare-const model____split_fields11 us_rep1)
(declare-const state5 us_private)
(declare-const model____split_fields12 us_rep)
(declare-const model____split_fields13 us_rep1)
(declare-const state6 us_private)
(declare-const model____split_fields14 us_rep)
(declare-const model____split_fields15 us_rep1)
(declare-const state7 us_private)
(assert (and (= (all_available state) true) (= (is_valid state (mk___split_fields model____split_fields model____split_fields1)) true)))
(assert (=> (<= 0 10000) (in_range res1)))
(assert (=> (<= 0 10000) (in_range res2)))
(assert (=> (<= 0 10000) (in_range res3)))
(assert (=> (<= 0 10000) (in_range res4)))
(assert (and (and (= (is_valid state1 (mk___split_fields model____split_fields2 model____split_fields3)) true) (ite (= (= (length model____split_fields) 0) true) (and (= res11 0) (= (oeq (mk___rep (mk___split_fields model____split_fields2 model____split_fields3)) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true)) (and (= (is_prepend model____split_fields2 res11 model____split_fields) true) (= (is_add model____split_fields1 res11 model____split_fields3) true)))) (in_range res11)))
(assert (not (= res11 0)))
(assert (= (is_allocated res11 state1) true))
(assert (and (and (= (is_valid state2 (mk___split_fields model____split_fields4 model____split_fields5)) true) (ite (= (= (length model____split_fields2) 0) true) (and (= res21 0) (= (oeq (mk___rep (mk___split_fields model____split_fields4 model____split_fields5)) (mk___rep (mk___split_fields model____split_fields2 model____split_fields3))) true)) (and (= (is_prepend model____split_fields4 res21 model____split_fields2) true) (= (is_add model____split_fields3 res21 model____split_fields5) true)))) (in_range res21)))
(assert (not (= res21 0)))
(assert (= (is_allocated res21 state2) true))
(assert (and (and (= (is_valid state3 (mk___split_fields model____split_fields6 model____split_fields7)) true) (ite (= (= (length model____split_fields4) 0) true) (and (= res31 0) (= (oeq (mk___rep (mk___split_fields model____split_fields6 model____split_fields7)) (mk___rep (mk___split_fields model____split_fields4 model____split_fields5))) true)) (and (= (is_prepend model____split_fields6 res31 model____split_fields4) true) (= (is_add model____split_fields5 res31 model____split_fields7) true)))) (in_range res31)))
(assert (not (= res31 0)))
(assert (= (is_allocated res31 state3) true))
(assert (and (and (= (is_valid state4 (mk___split_fields model____split_fields8 model____split_fields9)) true) (ite (= (= (length model____split_fields6) 0) true) (and (= res41 0) (= (oeq (mk___rep (mk___split_fields model____split_fields8 model____split_fields9)) (mk___rep (mk___split_fields model____split_fields6 model____split_fields7))) true)) (and (= (is_prepend model____split_fields8 res41 model____split_fields6) true) (= (is_add model____split_fields7 res41 model____split_fields9) true)))) (in_range res41)))
(assert (not (= res41 0)))
(assert (and (= (is_valid state5 (mk___split_fields model____split_fields10 model____split_fields11)) true) (ite (= (contains model____split_fields9 res11) true) (and (= (is_prepend model____split_fields8 res11 model____split_fields10) true) (= (is_add model____split_fields11 res11 model____split_fields9) true)) (= (oeq (mk___rep (mk___split_fields model____split_fields10 model____split_fields11)) (mk___rep (mk___split_fields model____split_fields8 model____split_fields9))) true))))
(assert (not (= (is_available res11 state5) true)))
(check-sat)
(exit)
