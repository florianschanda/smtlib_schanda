...
(define-fun default_initial_assumption ((temp___expr_164 us_rep1) (temp___skip_top_level_165 Bool)) Bool (= (attr__tag1 temp___expr_164) us_tag1))
...
(assert true)
(assert true)
(assert (forall ((o us_rep1)) (! (= (to_int1 (less_than_max__3 o)) (to_int1 (less_than_max__31 us_tag1 o))) :pattern ((less_than_max__31 us_tag1 o)))))
...
(declare-const temp___180 integer)
...
(assert (= temp___180 o2))
(assert (= temp___1801 o3))
(assert (= temp___1802 o4))
(assert (= o__attr__tag temp___1803))
(assert (= result o__split_fields))
(assert (= result1 o__split_fields1))
(assert (= result2 o__split_fields2))
(assert (= temp___180 o__split_fields3))
(assert (= temp___1801 o__split_fields4))
(assert (= temp___1802 o__split_fields5))
