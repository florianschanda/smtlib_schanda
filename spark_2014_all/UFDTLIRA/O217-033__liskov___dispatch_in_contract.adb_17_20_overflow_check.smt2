...
(define-fun default_initial_assumption ((temp___expr_191 us_rep1) (temp___skip_top_level_192 Bool)) Bool (= (attr__tag1 temp___expr_191) us_tag1))
...
(assert true)
(assert true)
(assert (forall ((o us_rep1)) (! (= (ite (less_than_max__3 o) 1 0) (ite (less_than_max__31 us_tag1 o) 1 0)) :pattern ((less_than_max__31 us_tag1 o)))))
...
(declare-const temp___2082 us_private)
(declare-const temp___2083 Int)
(declare-const result integer)
(declare-const result1 integer)
(declare-const result2 us_private)
(declare-const o__split_fields3 integer)
(declare-const o__split_fields4 integer)
(declare-const o__split_fields5 us_private)
(assert (and (= (less_than_max__3 (mk___rep1 (mk___split_fields1 o__split_fields o__split_fields1 o__split_fields2) o__attr__tag)) true) (< (to_rep o__split_fields) 2147483647)))
(assert (and (= o (+ (to_rep o__split_fields1) 1)) (in_range (+ (to_rep o__split_fields1) 1))))
(assert (= (to_rep o1) o))
(assert (= o__split_fields o2))
(assert (= o1 o3))
(assert (= o__split_fields2 o4))
(assert (= temp___208 o2))
(assert (= temp___2081 o3))
(assert (= temp___2082 o4))
(assert (= o__attr__tag temp___2083))
(assert (= result o__split_fields))
(assert (= result1 o__split_fields1))
(assert (= result2 o__split_fields2))
(assert (= temp___208 o__split_fields3))
(assert (= temp___2081 o__split_fields4))
(assert (= temp___2082 o__split_fields5))
(assert (not (in_range (+ (to_rep o__split_fields3) 1))))
(check-sat)
(exit)
