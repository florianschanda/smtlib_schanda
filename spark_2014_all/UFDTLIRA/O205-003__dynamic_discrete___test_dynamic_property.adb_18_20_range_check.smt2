...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 last)) (dynamic_property 0 last temp___expr_141)))
(assert (= last c))
...
(assert (not (dynamic_property 0 last temp___144)))
(check-sat)
(exit)
