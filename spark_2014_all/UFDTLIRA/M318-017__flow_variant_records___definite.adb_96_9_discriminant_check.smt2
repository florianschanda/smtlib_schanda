...
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3) usq_4) (mk___rep (mk___split_discrs temp___190) (mk___split_fields temp___1901 temp___1902 temp___1903) temp___1904)))
...
(assert (= x__split_fields3 (mk___split_fields temp___1921 temp___1922 temp___1923)))
...
(assert (not (= (rec__definite__t__d (us_split_discrs1 temp___193)) g__split_discrs)))
(check-sat)
(exit)
