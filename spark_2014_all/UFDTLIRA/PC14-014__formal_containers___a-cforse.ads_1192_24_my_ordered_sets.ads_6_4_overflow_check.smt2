...
(assert (and (= o5 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o5) (<= o5 (to_rep (rec__my_ordered_sets__m__set__capacity target__split_discrs))))))
...
(assert (and (= o3 (length source)) (and (in_range o3) (<= o3 (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 source)))))))
(assert (= o4 (- o3 o2)))
