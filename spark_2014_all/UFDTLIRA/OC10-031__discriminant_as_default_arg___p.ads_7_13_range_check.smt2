...
(define-fun in_range1 ((rec__p__pt__d1 Int) (a us_rep)) Bool (= rec__p__pt__d1 (to_rep (rec__p__pt__d (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant ((temp___expr_176 us_rep1) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (not (= temp___skip_constant_174 true)) (in_range1 0 (to_base temp___expr_176))))
(define-fun default_initial_assumption ((temp___expr_178 us_rep1) (temp___skip_top_level_179 Bool)) Bool (= (to_rep (rec__p__pt__d (us_split_discrs2 temp___expr_178))) 0))
