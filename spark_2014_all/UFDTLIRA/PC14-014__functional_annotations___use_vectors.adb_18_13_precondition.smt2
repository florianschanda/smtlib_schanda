...
(assert (<= first i1))
(assert (<= i1 r1b))
(assert (= (length (mk___rep v2__split_discrs v2__split_fields2)) (- i2 first)))
(assert (forall ((n Int)) (=> (and (<= first n) (<= n (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2))))) (= (is_incr (get (model__ v1) n) (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n)) true))))
...
(assert (= o3 i2))
(assert (and (= o4 (get (model__ v1) o3)) (and (in_range4 o4) (= o4 (get (model__ v1) o3)))))
(assert (not (< (length (mk___rep v2__split_discrs v2__split_fields2)) (capacity (mk___rep v2__split_discrs v2__split_fields2)))))
(check-sat)
(exit)
