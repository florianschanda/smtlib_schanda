...
(assert (= (length (mk___rep l__split_discrs l__split_fields37)) 10))
(assert (not (= (is_sorted (mk___rep l__split_discrs l__split_fields37)) true)))
(assert (= (oeq (model__ (mk___rep k__split_discrs my_lists__m__assign__target__fields2)) (model__ (mk___rep l__split_discrs l__split_fields37))) true))
(assert (= result63 (mk___split_fields__ref k__split_fields10)))
(assert (= k__split_fields11 my_lists__m__assign__target__fields2))
(assert (and (and (and (= (length (mk___rep l__split_discrs my_lists__s__sort__container__fields)) (length (mk___rep l__split_discrs l__split_fields37))) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields37)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields)) (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields37)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true)))
(assert (= result64 (mk___split_fields__ref l__split_fields37)))
(assert (= l__split_fields38 my_lists__s__sort__container__fields))
(assert (ite (= (<= (length (mk___rep l__split_discrs l__split_fields38)) 5) true) (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields5)) 0) (and (and (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields5)) (- (length (mk___rep l__split_discrs l__split_fields38)) 5)) (= (ole (model__ (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields5)) (model__ (mk___rep l__split_discrs l__split_fields38))) true)) (= (p_positions_truncated (positions (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields5)) (positions (mk___rep l__split_discrs l__split_fields38)) (+ (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields5)) 1) 5) true))))
(assert (= result65 (mk___split_fields__ref l__split_fields38)))
(assert (= l__split_fields39 my_lists__m__delete_last__2__container__fields5))
(assert (ite (= (<= (length (mk___rep k__split_discrs k__split_fields11)) 5) true) (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields5)) 0) (and (and (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields5)) (- (length (mk___rep k__split_discrs k__split_fields11)) 5)) (= (range_shifted (model__ (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields5)) (model__ (mk___rep k__split_discrs k__split_fields11)) 1 (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields5)) 5) true)) (= (p_positions_shifted (positions (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields5)) (positions (mk___rep k__split_discrs k__split_fields11)) 1 5) true))))
(assert (= result66 (mk___split_fields__ref k__split_fields11)))
(assert (= k__split_fields12 my_lists__m__delete_first__2__container__fields5))
(assert (not (<= (length (mk___rep k__split_discrs k__split_fields12)) (- (to_rep (rec__my_lists__m__list__capacity l__split_discrs)) (length (mk___rep l__split_discrs l__split_fields39))))))
(check-sat)
(exit)
