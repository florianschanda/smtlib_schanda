...
(assert (= (length (mk___rep l__split_discrs l__split_fields1)) 10))
(assert (not (= (is_sorted (mk___rep l__split_discrs l__split_fields1)) true)))
(assert (= (oeq (model__ (mk___rep k__split_discrs my_lists__m__assign__target__fields)) (model__ (mk___rep l__split_discrs l__split_fields1))) true))
(assert (= result (mk___split_fields__ref k__split_fields1)))
(assert (= k__split_fields2 my_lists__m__assign__target__fields))
(assert (and (and (and (= (length (mk___rep l__split_discrs my_lists__s__sort__container__fields)) (length (mk___rep l__split_discrs l__split_fields1))) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields)) (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true)))
(assert (= result1 (mk___split_fields__ref l__split_fields1)))
(assert (= l__split_fields2 my_lists__s__sort__container__fields))
(assert (ite (= (<= (length (mk___rep l__split_discrs l__split_fields2)) 5) true) (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields)) 0) (and (and (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields)) (- (length (mk___rep l__split_discrs l__split_fields2)) 5)) (= (ole (model__ (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields)) (model__ (mk___rep l__split_discrs l__split_fields2))) true)) (= (p_positions_truncated (positions (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields)) (positions (mk___rep l__split_discrs l__split_fields2)) (+ (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields)) 1) 5) true))))
(assert (= result2 (mk___split_fields__ref l__split_fields2)))
(assert (= l__split_fields3 my_lists__m__delete_last__2__container__fields))
(assert (ite (= (<= (length (mk___rep k__split_discrs k__split_fields2)) 5) true) (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields)) 0) (and (and (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields)) (- (length (mk___rep k__split_discrs k__split_fields2)) 5)) (= (range_shifted (model__ (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields)) (model__ (mk___rep k__split_discrs k__split_fields2)) 1 (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields)) 5) true)) (= (p_positions_shifted (positions (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields)) (positions (mk___rep k__split_discrs k__split_fields2)) 1 5) true))))
(assert (= result3 (mk___split_fields__ref k__split_fields2)))
(assert (= k__split_fields3 my_lists__m__delete_first__2__container__fields))
(assert (not (<= (length (mk___rep k__split_discrs k__split_fields3)) (- (to_rep (rec__my_lists__m__list__capacity l__split_discrs)) (length (mk___rep l__split_discrs l__split_fields3))))))
(check-sat)
(exit)
