...
(assert (and (= o84 (first (mk___rep l4__split_discrs l4__split_fields4))) (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields4)) 0) true) (= (bool_eq1 o84 no_element) true) (and (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o84) true) (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields4)) o84) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) no_element) true) (= (bool_eq1 no_element no_element) true))))
(check-sat)
(exit)
