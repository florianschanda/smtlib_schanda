...
(assert (and (= o15 (first (mk___rep l4__split_discrs l4__split_fields4))) (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields4)) 0) true) (= (bool_eq1 o15 no_element) true) (and (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o15) true) (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields4)) o15) 1)))))
