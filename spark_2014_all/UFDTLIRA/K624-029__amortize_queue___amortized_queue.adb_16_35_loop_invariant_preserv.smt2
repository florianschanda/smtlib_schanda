...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (and (and (= (length (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields))) (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))) true)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields)))) 1)) o3))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields result____split_fields)))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (mk___split_fields result____split_fields2) (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (length (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 idx3)) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) i5) (get (model__ left) i5))))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (and (=> (<= 1 r4b) (dynamic_property 1 r4b idx3)) (and (<= 1 idx3) (<= idx3 r4b)))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx3 r4b)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx5 (mk_int__ref idx3))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields5 (mk___split_fields__ref (mk___split_fields result____split_fields3)))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx6 idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields6 (mk___split_fields result____split_fields3))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx7 idx5)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields7 result____split_fields5)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx8 idx6)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields8 result____split_fields6)))
(assert (=> (not (and (<= 1 idx2) (<= idx2 r4b))) (= idx7 (mk_int__ref idx2))))
(assert (=> (not (and (<= 1 idx2) (<= idx2 r4b))) (= result____split_fields7 (mk___split_fields__ref (mk___split_fields result____split_fields)))))
(assert (=> (not (and (<= 1 idx2) (<= idx2 r4b))) (= idx8 idx2)))
(assert (=> (not (and (<= 1 idx2) (<= idx2 r4b))) (= result____split_fields8 (mk___split_fields result____split_fields1))))
(assert (= (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields7))) (last (model__ left))))
...
(assert (= result4 (mk_int__ref idx1)))
(assert (= idx9 1))
(assert (<= 1 idx9))
(assert (<= idx9 r10b))
(assert (and (= o10 idx9) (in_range3 idx9)))
(assert (and (= o11 (get (model__ right) o10)) (and (in_range6 o11) (= o11 (get (model__ right) o10)))))
(assert (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields7))) 1)) (= (olt (model__ (mk___rep result____split_discrs (us_split_fields__content result____split_fields7))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (last (model__ (mk___rep result____split_discrs (us_split_fields__content result____split_fields7)))) 1)) o11)))
(assert (= result5 result____split_fields7))
(assert (= result____split_fields9 amortized_queue__my_vectors__append__2__container__fields2))
(assert (= (length (mk___rep result____split_discrs result____split_fields10)) (+ (last (model__ left)) idx10)))
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 (last (model__ left)))) (= (get (model__ (mk___rep result____split_discrs result____split_fields10)) i5) (get (model__ left) i5)))))
(assert (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 idx10)) (= (get (model__ (mk___rep result____split_discrs result____split_fields10)) (+ (last (model__ left)) i5)) (get (model__ right) i5)))))
(assert (and (=> (<= 1 r10b) (dynamic_property1 1 r10b idx10)) (and (<= 1 idx10) (<= idx10 r10b))))
(assert (not (= idx10 r10b)))
(assert (= result7 (mk_int__ref idx10)))
(assert (= idx11 (+ idx10 1)))
(assert (and (= o28 idx11) (in_range3 idx11)))
(assert (and (= o29 (get (model__ right) o28)) (and (in_range6 o29) (= o29 (get (model__ right) o28)))))
(assert (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (length (mk___rep result____split_discrs result____split_fields10)) 1)) (= (olt (model__ (mk___rep result____split_discrs result____split_fields10)) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (last (model__ (mk___rep result____split_discrs result____split_fields10))) 1)) o29)))
(assert (= result8 (mk___split_fields__ref result____split_fields10)))
(assert (= result____split_fields11 amortized_queue__my_vectors__append__2__container__fields3))
(assert (= idx12 (mk_int__ref idx11)))
(assert (= result____split_fields12 (mk___split_fields__ref result____split_fields11)))
(assert (= rho amortized_queue__my_vectors__append__2__container__fields3))
(assert (= idx13 idx11))
(assert (= result____split_fields13 result____split_fields11))
(assert (not (= (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields12))) (+ (last (model__ left)) (int__content idx12)))))
(check-sat)
(exit)
