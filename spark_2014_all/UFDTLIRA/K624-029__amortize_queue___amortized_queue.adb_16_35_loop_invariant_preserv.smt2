...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields)))) 1)) o3))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields14)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (mk___split_fields result____split_fields2) amortized_queue__my_vectors__append__2__container__fields3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= (length (mk___rep result____split_discrs result____split_fields13)) idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx3)) (= (get (model__ (mk___rep result____split_discrs result____split_fields13)) i) (get (model__ left) i))))))
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields4 (mk___split_fields__ref result____split_fields13))))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= idx5 idx3)))
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (= result____split_fields5 result____split_fields13)))
...
(assert (=> (not (and (<= 1 idx2) (<= idx2 r4b))) (= result____split_fields6 result____split_fields14)))
...
(assert (and (= o5 (get (model__ right) o4)) (and (in_range6 o5) (= o5 (get (model__ right) o4)))))
...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ left)))) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) i) (get (model__ left) i)))))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i idx9)) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) (+ (last (model__ left)) i)) (get (model__ right) i)))))
(assert (and (=> (<= 1 r10b) (dynamic_property1 1 r10b idx9)) (and (<= 1 idx9) (<= idx9 r10b))))
(assert (not (= idx9 r10b)))
(assert (= result4 (mk_int__ref idx9)))
(assert (= idx10 (+ idx9 1)))
(assert (and (= o6 idx10) (in_range3 idx10)))
(assert (and (= o7 (get (model__ right) o6)) (and (in_range6 o7) (= o7 (get (model__ right) o6)))))
(assert (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (length (mk___rep result____split_discrs result____split_fields9)) 1)) (= (olt (model__ (mk___rep result____split_discrs result____split_fields9)) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (last (model__ (mk___rep result____split_discrs result____split_fields9))) 1)) o7)))
(assert (= result5 (mk___split_fields__ref result____split_fields9)))
(assert (= result____split_fields10 amortized_queue__my_vectors__append__2__container__fields2))
(assert (= idx11 (mk_int__ref idx10)))
(assert (= result____split_fields11 (mk___split_fields__ref result____split_fields10)))
(assert (= rho amortized_queue__my_vectors__append__2__container__fields2))
(assert (= idx12 idx10))
(assert (= result____split_fields12 result____split_fields10))
(assert (not (= (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields11))) (+ (last (model__ left)) (int__content idx11)))))
(check-sat)
(exit)
