...
(assert (and (= us (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 x)))) (in_range (to_rep (rec__storage_place_attributes__r2__d1 (us_split_discrs1 x))))))
(assert (not (<= 0 storage_place_attributes__r2__d1__first__bit)))
(check-sat)
(exit)
