...
(define-fun s2__split_fields2 () us_split_fields (mk___split_fields s2__split_fields1))
(define-fun s2__split_fields3 () us_split_fields (mk___split_fields s2__split_fields))
...
(assert (and (= (length (mk___rep s2__split_discrs s2__split_fields3)) 0) (= (is_empty (model__ (mk___rep s2__split_discrs s2__split_fields3))) true)))
(assert (and (= result1 (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3))) (= (= result1 true) (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3)) true))))
(assert (= result1 true))
(assert (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (length (mk___rep s2__split_discrs s2__split_fields2)) 1)))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1)) true))))
(assert (forall ((e Int)) (=> (and (in_range2 e) (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1) e))))))
(assert (and (= o (length (mk___rep s2__split_discrs s2__split_fields2))) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result2 (ite (<= 1 i) o1 false)))
(assert (= result2 true))
(assert (and (= o2 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length1 o2) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o2 temp___432) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get o2 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
