...
(define-fun dynamic_invariant ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 1 10)) (in_range1 temp___expr_177)))
(declare-sort pt 0)
...
(define-fun dynamic_invariant1 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 1 20)) (in_range temp___expr_171)))
...
(declare-const po pt)
(declare-const inrange__pt__add_out__i1 Int)
(declare-const us_self__compl1 pt)
(declare-const result2 pt)
...
(assert (not (<= inrange__pt__add_out__i 10)))
(check-sat)
(exit)
