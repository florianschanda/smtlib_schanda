...
(declare-const temp___2921 unsigned_byte)
(declare-const temp___2922 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___292 o5))
(assert (= temp___2921 o6))
(assert (= temp___2922 o7))
...
(assert (= x__split_fields3 (mk___split_fields1 temp___292 (mk___rep (mk___split_fields temp___2921 temp___2922)))))
...
(assert (= o14 o11))
(assert (= o15 o12))
(assert (= temp___295 (mk___rep1 (mk___split_fields1 o13 (mk___rep (mk___split_fields o14 o15))))))
(assert (= result2 (mk___split_fields__ref1 x__split_fields3)))
(assert (= x__split_fields4 (us_split_fields3 temp___295)))
