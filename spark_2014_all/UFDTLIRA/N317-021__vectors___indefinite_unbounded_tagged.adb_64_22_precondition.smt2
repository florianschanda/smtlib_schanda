...
(declare-const temp___646 us_rep1)
...
(assert (and (= temp___646 (f 4)) (= temp___646 (mk___rep1 (mk___split_fields1 (of_rep1 4) us_null_ext__) us_tag))))
(assert (not (<= 2 (last (model__ (mk___rep v__split_discrs v__split_fields7))))))
(check-sat)
(exit)
