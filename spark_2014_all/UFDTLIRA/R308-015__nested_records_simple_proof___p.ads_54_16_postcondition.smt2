...
(declare-const p__create_type_4__result type_4__ref)
...
(declare-const result type_4__ref)
(declare-const p__create_type_4__result1 us_rep2)
(declare-const p__create_type_4__result2 type_4__ref)
(declare-const p__create_type_4__result3 us_rep2)
(declare-const p__create_type_4__result4 type_4__ref)
(declare-const p__create_type_4__result5 us_rep2)
(define-fun o20 () us_rep (mk___rep (mk___split_fields o10 o11 o12 o13 o14 o15 o16 o17)))
(define-fun o21 () us_rep (mk___rep (mk___split_fields o2 o3 o4 o5 o6 o7 o8 o9)))
(declare-const result1 us_rep2)
(assert (= p__create_type_4__result2 (let ((subject p__create_type_4__result)) (mk_type_4__ref p__create_type_4__result1))))
(assert (= p__create_type_4__result3 p__create_type_4__result1))
(assert (and (= o (create_type_2 Tuple0)) (and (= (bool_eq (rec__p__type_2__field_0 (us_split_fields3 o)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_1 (us_split_fields3 o)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_2 (us_split_fields3 o)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_3 (us_split_fields3 o)) (create_type_1 Tuple0)) true) (= (bool_eq (rec__p__type_2__field_4 (us_split_fields3 o)) (create_type_1 Tuple0)) true)))))))
(assert (and (= o1 (create_type_2 Tuple0)) (and (= (bool_eq (rec__p__type_2__field_0 (us_split_fields3 o1)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_1 (us_split_fields3 o1)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_2 (us_split_fields3 o1)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_2__field_3 (us_split_fields3 o1)) (create_type_1 Tuple0)) true) (= (bool_eq (rec__p__type_2__field_4 (us_split_fields3 o1)) (create_type_1 Tuple0)) true)))))))
(assert (and (= o21 (create_type_1 Tuple0)) (and (= (to_rep o2) 0) (and (= (to_rep o3) 0) (and (= (to_rep o4) 0) (and (= (to_rep o5) 0) (and (= (to_rep o6) 0) (and (= (to_rep o7) 0) (and (= (to_rep o8) 0) (= (to_rep o9) 0))))))))))
(assert (and (= o20 (create_type_1 Tuple0)) (and (= (to_rep o10) 0) (and (= (to_rep o11) 0) (and (= (to_rep o12) 0) (and (= (to_rep o13) 0) (and (= (to_rep o14) 0) (and (= (to_rep o15) 0) (and (= (to_rep o16) 0) (= (to_rep o17) 0))))))))))
(assert (= o18 (mk___split_fields2 o20 o21 o1 o)))
(assert (= o19 (mk___rep2 o18)))
(assert (= result p__create_type_4__result))
(assert (= (let ((subject p__create_type_4__result)) p__create_type_4__result1) o19))
(assert (= p__create_type_4__result4 p__create_type_4__result2))
(assert (= p__create_type_4__result5 p__create_type_4__result3))
(assert (= result1 (type_4__content p__create_type_4__result4)))
(assert (not (= (bool_eq (rec__p__type_4__field_0 (us_split_fields5 (type_4__content p__create_type_4__result4))) (create_type_1 Tuple0)) true)))
(check-sat)
(exit)
