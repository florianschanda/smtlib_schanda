...
(assert (and (= o6 (last2 left)) (and (dynamic_property1 first1 last1 o6) (= o6 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o6) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o4 first) (in_range1 first))))
(assert (=> (< offset 0) (and (= o5 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o5 o4) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst1 lst1))
(assert (and (= o3 lst1) (in_range1 lst1)))
(assert (and (= o2 (length right)) (and (in_range3 o2) (<= (+ (- first 1) o2) last))))
