...
(declare-const foo__test_02__tmp__assume integer)
(declare-const foo__test_02__tmp__assume1 integer)
(declare-const foo__test_02__tmp__assume2 integer)
...
(assert (= o o3))
(assert (= rliteral o4))
(assert (= foo__test_02__tmp__assume o2))
(assert (= foo__test_02__tmp__assume1 o3))
(assert (= foo__test_02__tmp__assume2 o4))
...
(assert (<= 1 i1))
(assert (<= i1 3))
(assert (not (in_range1 (+ (to_rep tmp__split_fields4) 1))))
(check-sat)
(exit)
