...
(declare-const temp___6645 et1)
(declare-const temp___66451 et2)
...
(assert (= temp___6645 o1))
(assert (= temp___66451 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___6645 r__split_fields2))
(assert (= temp___66451 r__split_fields3))
