...
(declare-const temp___6586 et1)
(declare-const temp___65861 et2)
...
(assert (= temp___6586 o1))
(assert (= temp___65861 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___6586 r__split_fields2))
(assert (= temp___65861 r__split_fields3))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields4 r__split_fields5)) (mk___rep (mk___split_fields (of_rep e) r__split_fields1))) true)))
(check-sat)
(exit)
