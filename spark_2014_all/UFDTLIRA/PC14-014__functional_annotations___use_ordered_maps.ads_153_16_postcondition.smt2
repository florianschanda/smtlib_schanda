...
(define-fun dynamic_invariant ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 2147483647)) (in_range3 temp___expr_352)))
...
(define-fun default_initial_assumption ((temp___expr_365 us_rep2) (temp___skip_top_level_366 Bool)) Bool (=> (not (= temp___skip_top_level_366 true)) (= (length temp___expr_365) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length result) (length1 container)) (forall ((temp___399 Int)) (=> (and (in_range2 temp___399) (= (iter_has_element result temp___399) true)) (= (has_key (model__ container) (get result temp___399)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_295)))
...
(define-fun dynamic_invariant3 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 1 2147483647)) (in_range6 temp___expr_289)))
...
(define-fun dynamic_invariant4 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_15)))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant5 result true false true)))) :pattern ((find container key2))))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant6 key2 true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant5 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant5 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant5 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant8 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
(declare-const cu count_type)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const o2 Int)
(declare-const temp___831 us_rep2)
...
(assert (let ((temp___405 (keys s))) (forall ((temp___404 Int)) (=> (and (in_range2 temp___404) (= (iter_has_element temp___405 temp___404) true)) (exists ((i us_rep1)) (and (= (has_key1 (positions s) i) true) (= (get (keys s) (get1 (positions s) i)) (get temp___405 temp___404))))))))
(declare-const temp___835 Int)
(assert (in_range2 temp___835))
(assert (= (iter_has_element (keys s) temp___835) true))
(assert (not (= (q (get2 (model__ s) (get (keys s) temp___835))) true)))
(check-sat)
(exit)
