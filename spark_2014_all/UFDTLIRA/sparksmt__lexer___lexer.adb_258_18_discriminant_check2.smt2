...
(assert (= (to_rep1 o) 1))
(assert (= o o7))
(assert (= temp___1023 o7))
(assert (= temp___10231 o3))
(assert (= temp___10232 o4))
(assert (= temp___10233 o5))
(assert (= temp___10234 o6))
(assert (= true temp___10235))
(assert (= t__attr__constrained true))
(assert (not (= temp___1023 t__split_discrs)))
(check-sat)
(exit)
