...
(assert (forall ((i type_7)) (and (<= (- 2147483648) (type_7qtint i)) (<= (type_7qtint i) 2147483647))))
...
(define-fun o16 () us_rep (mk___rep (mk___split_fields o1 o2 o3 o4 o5 o6 o7 o8)))
...
(assert (and (= o16 (create_type_1 Tuple0)) (and (= (to_rep o1) 0) (and (= (to_rep o2) 0) (and (= (to_rep o3) 0) (and (= (to_rep o4) 0) (and (= (to_rep o5) 0) (and (= (to_rep o6) 0) (and (= (to_rep o7) 0) (= (to_rep o8) 0))))))))))
(assert (and (= o9 (create_type_5 Tuple0)) (and (= (to_rep1 (rec__p__type_5__field_0 (us_split_fields7 o9))) 0) (and (= (bool_eq2 (rec__p__type_5__field_1 (us_split_fields7 o9)) (create_type_4 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_5__field_2 (us_split_fields7 o9)) (create_type_2 Tuple0)) true) (and (= (bool_eq2 (rec__p__type_5__field_3 (us_split_fields7 o9)) (create_type_4 Tuple0)) true) (= (bool_eq2 (rec__p__type_5__field_4 (us_split_fields7 o9)) (create_type_4 Tuple0)) true)))))))
(assert (and (= o10 (create_type_6 Tuple0)) (and (= (bool_eq (rec__p__type_6__field_0 (us_split_fields9 o10)) (create_type_1 Tuple0)) true) (and (= (bool_eq3 (rec__p__type_6__field_1 (us_split_fields9 o10)) (create_type_5 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_6__field_2 (us_split_fields9 o10)) (create_type_2 Tuple0)) true) (= (bool_eq3 (rec__p__type_6__field_3 (us_split_fields9 o10)) (create_type_5 Tuple0)) true))))))
(assert (and (= o11 (create_type_4 Tuple0)) (and (= (bool_eq (rec__p__type_4__field_0 (us_split_fields5 o11)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_4__field_1 (us_split_fields5 o11)) (create_type_1 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_4__field_2 (us_split_fields5 o11)) (create_type_2 Tuple0)) true) (= (bool_eq1 (rec__p__type_4__field_3 (us_split_fields5 o11)) (create_type_2 Tuple0)) true))))))
(assert (and (= o12 (create_type_5 Tuple0)) (and (= (to_rep1 (rec__p__type_5__field_0 (us_split_fields7 o12))) 0) (and (= (bool_eq2 (rec__p__type_5__field_1 (us_split_fields7 o12)) (create_type_4 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_5__field_2 (us_split_fields7 o12)) (create_type_2 Tuple0)) true) (and (= (bool_eq2 (rec__p__type_5__field_3 (us_split_fields7 o12)) (create_type_4 Tuple0)) true) (= (bool_eq2 (rec__p__type_5__field_4 (us_split_fields7 o12)) (create_type_4 Tuple0)) true)))))))
(assert (and (= o13 (create_type_4 Tuple0)) (and (= (bool_eq (rec__p__type_4__field_0 (us_split_fields5 o13)) (create_type_1 Tuple0)) true) (and (= (bool_eq (rec__p__type_4__field_1 (us_split_fields5 o13)) (create_type_1 Tuple0)) true) (and (= (bool_eq1 (rec__p__type_4__field_2 (us_split_fields5 o13)) (create_type_2 Tuple0)) true) (= (bool_eq1 (rec__p__type_4__field_3 (us_split_fields5 o13)) (create_type_2 Tuple0)) true))))))
(assert (= o14 (mk___split_fields5 o13 o12 o11 o10 o9 rliteral o16 o)))
(assert (= o15 (mk___rep5 o14)))
(assert (= result p__create_type_8__result))
(assert (= (let ((subject p__create_type_8__result)) p__create_type_8__result1) o15))
...
(assert (not (= (bool_eq3 (rec__p__type_8__field_1 (us_split_fields11 (type_8__content p__create_type_8__result4))) (create_type_5 Tuple0)) true)))
(check-sat)
(exit)
