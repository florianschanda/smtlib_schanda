...
(define-fun dynamic_invariant ((temp___expr_145 us_rep) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (let ((temp___149 (rec__discr__t_record__col_last (us_split_discrs1 temp___expr_145)))) (let ((temp___148 (rec__discr__t_record__col_first (us_split_discrs1 temp___expr_145)))) (let ((temp___147 (rec__discr__t_record__row_last (us_split_discrs1 temp___expr_145)))) (let ((temp___146 (rec__discr__t_record__row_first (us_split_discrs1 temp___expr_145)))) (and (and (dynamic_property7 (to_rep temp___146) (to_rep temp___147) (first5 (rec__discr__t_record__data (us_split_fields1 temp___expr_145))) (last5 (rec__discr__t_record__data (us_split_fields1 temp___expr_145))) (to_rep temp___148) (to_rep temp___149) (first_21 (rec__discr__t_record__data (us_split_fields1 temp___expr_145))) (last_21 (rec__discr__t_record__data (us_split_fields1 temp___expr_145)))) (and (= (first5 (rec__discr__t_record__data (us_split_fields1 temp___expr_145))) (to_rep temp___146)) (= (last5 (rec__discr__t_record__data (us_split_fields1 temp___expr_145))) (to_rep temp___147)))) (and (= (first_21 (rec__discr__t_record__data (us_split_fields1 temp___expr_145))) (to_rep temp___148)) (= (last_21 (rec__discr__t_record__data (us_split_fields1 temp___expr_145))) (to_rep temp___149)))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_139 us_t) (temp___is_init_136 Bool) (temp___skip_constant_137 Bool) (temp___do_toplevel_138 Bool)) Bool (=> (not (= temp___skip_constant_137 true)) (dynamic_property2 1 2147483647 (first2 temp___expr_139) (last2 temp___expr_139) 1 2147483647 (first_2 temp___expr_139) (last_2 temp___expr_139))))
(declare-const data_copy map1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const result map1)
(declare-const data_copy1 map1)
...
(assert (and (= us1 (to_rep (rec__discr__t_record__col_first (us_split_discrs1 rec__)))) (in_range (to_rep (rec__discr__t_record__col_first (us_split_discrs1 rec__))))))
(assert (and (= us2 (to_rep (rec__discr__t_record__row_last (us_split_discrs1 rec__)))) (in_range (to_rep (rec__discr__t_record__row_last (us_split_discrs1 rec__))))))
(assert (and (= us3 (to_rep (rec__discr__t_record__row_first (us_split_discrs1 rec__)))) (in_range (to_rep (rec__discr__t_record__row_first (us_split_discrs1 rec__))))))
(assert (= result data_copy))
(assert (= data_copy1 (elts1 (rec__discr__t_record__data (us_split_fields1 rec__)))))
(assert (= (to_rep1 data_copy__first) (to_rep1 (first (mk (to_rep1 (first3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep1 (last3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (= (to_rep1 data_copy__last) (to_rep1 (last (mk (to_rep1 (first3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep1 (last3 (rt1 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (= (to_rep1 data_copy__first_2) (to_rep1 (first1 (mk1 (to_rep1 (first4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep1 (last4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (= (to_rep1 data_copy__last_2) (to_rep1 (last1 (mk1 (to_rep1 (first4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))) (to_rep1 (last4 (rt_21 (rec__discr__t_record__data (us_split_fields1 rec__))))))))))
(assert (dynamic_property2 1 2147483647 (to_rep1 data_copy__first) (to_rep1 data_copy__last) 1 2147483647 (to_rep1 data_copy__first_2) (to_rep1 data_copy__last_2)))
(assert (not (= (let ((temp___208 (rec__discr__t_record__data (us_split_fields1 rec__)))) (bool_eq data_copy1 (to_rep1 data_copy__first) (to_rep1 data_copy__last) (to_rep1 data_copy__first_2) (to_rep1 data_copy__last_2) (elts1 temp___208) (to_rep1 (first3 (rt1 temp___208))) (to_rep1 (last3 (rt1 temp___208))) (to_rep1 (first4 (rt_21 temp___208))) (to_rep1 (last4 (rt_21 temp___208))))) true)))
(check-sat)
(exit)
