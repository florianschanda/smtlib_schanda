...
(define-fun dynamic_invariant ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_257)))
...
(define-fun default_initial_assumption2 ((temp___expr_280 us_rep1) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__use_lists__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
...
(declare-const temp___610 us_rep2)
(declare-const temp___609 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (forall ((cu us_rep1)) (=> (= (has_key (positions l) cu) true) (= (prop__ (element l cu)) true))))
(assert (let ((temp___309 (model__ l))) (forall ((temp___308 Int)) (=> (and (in_range2 temp___308) (= (iter_has_element temp___309 temp___308) true)) (exists ((i us_rep1)) (and (= (has_key (positions l) i) true) (= (get (model__ l) (get1 (positions l) i)) (get temp___309 temp___308))))))))
