...
(define-fun dynamic_invariant ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_220)))
(define-fun dynamic_invariant1 ((temp___expr_226 Int) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool)) Bool (=> (or (= temp___is_init_223 true) (<= 0 2147483647)) (in_range2 temp___expr_226)))
...
(define-fun default_initial_assumption2 ((temp___expr_240 us_rep1) (temp___skip_top_level_241 Bool)) Bool (= (to_rep (rec__use_lists__my_lists__cursor__node (us_split_fields3 temp___expr_240))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_189)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true))) :pattern ((length1 container)))))
...
(define-fun default_initial_assumption3 ((temp___expr_252 us_rep3) (temp___skip_top_level_253 Bool)) Bool (=> (not (= temp___skip_top_level_253 true)) (and (= (is_empty temp___expr_252) true) (= (length2 temp___expr_252) 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range6 temp___expr_245)))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant4 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant5 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(declare-const cu count_type)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const o2 Int)
(declare-const temp___567 us_rep2)
...
(assert (forall ((cu1 us_rep1)) (=> (= (has_key (positions l) cu1) true) (= (prop__ (element l cu1)) true))))
(assert (let ((temp___266 (model__ l))) (forall ((temp___265 Int)) (=> (and (in_range2 temp___265) (= (iter_has_element temp___266 temp___265) true)) (exists ((i us_rep1)) (and (= (has_key (positions l) i) true) (= (get (model__ l) (get1 (positions l) i)) (get temp___266 temp___265))))))))
(assert (and (= temp___567 (model__ l)) (= (length temp___567) (length1 l))))
(assert (and (= o3 (iter_has_element temp___567 temp___566)) (= (= o3 true) (and (<= 1 temp___566) (<= temp___566 (last temp___567))))))
(assert (= (= o4 true) (in_range2 temp___566)))
(assert (= result1 (ite (= o4 true) o3 false)))
(assert (= result1 true))
(assert (not (<= 1 temp___566)))
(check-sat)
(exit)
