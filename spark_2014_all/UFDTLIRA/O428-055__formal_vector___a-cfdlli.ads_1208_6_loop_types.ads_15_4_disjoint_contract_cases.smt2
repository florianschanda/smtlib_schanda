...
(define-fun dynamic_invariant1 ((temp___expr_408 Int) (temp___is_init_405 Bool) (temp___skip_constant_406 Bool) (temp___do_toplevel_407 Bool)) Bool (=> (or (= temp___is_init_405 true) (<= 1 2147483647)) (in_range2 temp___expr_408)))
...
(declare-const temp___651 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
