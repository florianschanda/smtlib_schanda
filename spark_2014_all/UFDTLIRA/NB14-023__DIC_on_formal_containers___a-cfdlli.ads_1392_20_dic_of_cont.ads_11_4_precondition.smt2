...
(define-fun default_initial_assumption ((temp___expr_337 us_rep1) (temp___skip_top_level_338 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_337))) 0))
...
(define-fun dynamic_invariant ((temp___expr_381 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 1 2147483647)) (in_range2 temp___expr_381)))
...
(define-fun default_initial_assumption1 ((temp___expr_388 us_rep2) (temp___skip_top_level_389 Bool)) Bool (=> (not (= temp___skip_top_level_389 true)) (and (= (is_empty temp___expr_388) true) (= (length temp___expr_388) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_376 us_rep1) (temp___skip_top_level_377 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_376))) 0))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__dic_of_cont__my_dlli__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true))) :pattern ((length1 container1)))))
...
(declare-const temp___1772 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1772 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1772)) no_element))
