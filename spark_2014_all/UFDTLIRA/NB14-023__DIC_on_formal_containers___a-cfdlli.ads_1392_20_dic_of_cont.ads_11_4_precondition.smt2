...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dic_of_cont__my_dlli__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type (rec__dic_of_cont__my_dlli__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 a))) (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 b)))) true false))
...
(assert (< dic_of_cont__my_dlli__cursor__node__first__bit dic_of_cont__my_dlli__cursor__node__last__bit))
...
(define-fun default_initial_assumption ((temp___expr_367 us_rep1) (temp___skip_top_level_368 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_367))) 0))
...
(define-fun dynamic_invariant ((temp___expr_418 Int) (temp___is_init_414 Bool) (temp___skip_constant_415 Bool) (temp___do_toplevel_416 Bool) (temp___do_typ_inv_417 Bool)) Bool (=> (or (= temp___is_init_414 true) (<= 1 2147483647)) (in_range2 temp___expr_418)))
...
(define-fun default_initial_assumption1 ((temp___expr_426 us_rep2) (temp___skip_top_level_427 Bool)) Bool (=> (not (= temp___skip_top_level_427 true)) (and (= (is_empty temp___expr_426) true) (= (length temp___expr_426) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_412 us_rep1) (temp___skip_top_level_413 Bool)) Bool (= (to_rep (rec__dic_of_cont__my_dlli__cursor__node (us_split_fields3 temp___expr_412))) 0))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__dic_of_cont__my_dlli__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(assert true)
(assert (forall ((container1 us_rep2)) (forall ((key us_rep1)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant1 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant1 witness1 true true true true) (= (has_witness container1 witness1) true)) (dynamic_invariant (w_get container1 witness1) true false true true)) :pattern ((w_get container1 witness1))))))
(declare-const position__split_fields count_type)
(declare-const o count_type)
(declare-const o1 count_type)
(declare-const temp___1890 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1890 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1890)) no_element))
