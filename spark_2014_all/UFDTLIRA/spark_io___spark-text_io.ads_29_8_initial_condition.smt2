...
(define-fun dynamic_invariant ((temp___expr_643 Int) (temp___is_init_640 Bool) (temp___skip_constant_641 Bool) (temp___do_toplevel_642 Bool)) Bool (=> (or (= temp___is_init_640 true) (<= 0 10)) (in_range1 temp___expr_643)))
...
(define-fun dynamic_invariant1 ((temp___expr_655 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 0 2)) (in_range2 temp___expr_655)))
