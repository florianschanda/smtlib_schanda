...
(define-fun dynamic_invariant ((temp___expr_637 Int) (temp___is_init_634 Bool) (temp___skip_constant_635 Bool) (temp___do_toplevel_636 Bool)) Bool (=> (or (= temp___is_init_634 true) (<= 0 10)) (in_range1 temp___expr_637)))
...
(define-fun dynamic_invariant1 ((temp___expr_649 Int) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool)) Bool (=> (or (= temp___is_init_646 true) (<= 0 2)) (in_range2 temp___expr_649)))
