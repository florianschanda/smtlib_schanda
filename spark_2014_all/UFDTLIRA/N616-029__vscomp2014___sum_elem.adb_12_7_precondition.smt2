...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (and (= (length (mk___rep1 p__split_discrs (mk___split_fields1 sum_elem__partitions__append__2__container__fields))) (+ (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) 1)) (= (olt (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (model__ (mk___rep1 p__split_discrs (mk___split_fields1 sum_elem__partitions__append__2__container__fields)))) true)) (= (bool_eq (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 sum_elem__partitions__append__2__container__fields))) (+ (last (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) 1)) (mk___rep (mk___split_fields o4 o5))) true)))
(assert (= result p__split_fields))
(assert (= (mk___split_fields1 p__split_fields1) (mk___split_fields1 sum_elem__partitions__append__2__container__fields)))
(assert (not (<= 0 0)))
(check-sat)
(exit)
