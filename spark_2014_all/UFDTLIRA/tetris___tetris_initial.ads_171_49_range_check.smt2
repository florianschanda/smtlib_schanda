...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep3 (rec__tetris_initial__piece__s (us_split_fields1 a))) (to_rep3 (rec__tetris_initial__piece__s (us_split_fields1 b)))) (= (to_rep2 (rec__tetris_initial__piece__d (us_split_fields1 a))) (to_rep2 (rec__tetris_initial__piece__d (us_split_fields1 b))))) (= (to_rep (rec__tetris_initial__piece__x (us_split_fields1 a))) (to_rep (rec__tetris_initial__piece__x (us_split_fields1 b))))) (= (to_rep1 (rec__tetris_initial__piece__y (us_split_fields1 a))) (to_rep1 (rec__tetris_initial__piece__y (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_683 Int) (temp___is_init_679 Bool) (temp___skip_constant_680 Bool) (temp___do_toplevel_681 Bool) (temp___do_typ_inv_682 Bool)) Bool (=> (or (= temp___is_init_679 true) (<= 0 4)) (in_range4 temp___expr_683)))
...
(define-fun dynamic_invariant1 ((temp___expr_609 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range2 temp___expr_609)))
(define-fun dynamic_invariant2 ((temp___expr_697 Int) (temp___is_init_693 Bool) (temp___skip_constant_694 Bool) (temp___do_toplevel_695 Bool) (temp___do_typ_inv_696 Bool)) Bool (=> (or (= temp___is_init_693 true) (<= 3 4)) (in_range5 temp___expr_697)))
...
(define-fun dynamic_invariant3 ((temp___expr_544 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool) (temp___do_typ_inv_543 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 1 7)) (in_range3 temp___expr_544)))
(define-fun dynamic_invariant4 ((temp___expr_595 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= (- 1) 9)) (in_range temp___expr_595)))
(define-fun dynamic_invariant5 ((temp___expr_602 Int) (temp___is_init_598 Bool) (temp___skip_constant_599 Bool) (temp___do_toplevel_600 Bool) (temp___do_typ_inv_601 Bool)) Bool (=> (or (= temp___is_init_598 true) (<= (- 1) 49)) (in_range1 temp___expr_602)))
(assert (in_range4 a))
(assert (not (= a 0)))
(assert (= a 1))
(assert (not (in_range (+ (to_rep (rec__tetris_initial__piece__x (us_split_fields1 p))) 1))))
(check-sat)
(exit)
