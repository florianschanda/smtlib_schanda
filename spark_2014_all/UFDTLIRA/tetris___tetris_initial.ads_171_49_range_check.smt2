...
(define-fun dynamic_invariant ((temp___expr_645 Int) (temp___is_init_642 Bool) (temp___skip_constant_643 Bool) (temp___do_toplevel_644 Bool)) Bool (=> (or (= temp___is_init_642 true) (<= 0 4)) (in_range4 temp___expr_645)))
...
(define-fun dynamic_invariant2 ((temp___expr_657 Int) (temp___is_init_654 Bool) (temp___skip_constant_655 Bool) (temp___do_toplevel_656 Bool)) Bool (=> (or (= temp___is_init_654 true) (<= 3 4)) (in_range5 temp___expr_657)))
