...
(declare-const temp___478 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___478 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___478)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__lists__l__list__capacity (us_split_discrs1 container)))))))
