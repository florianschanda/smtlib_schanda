...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__linked_list__mylists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_234 us_rep1) (temp___skip_top_level_235 Bool)) Bool (= (to_rep (rec__linked_list__mylists__cursor__node (us_split_fields3 temp___expr_234))) 0))
...
(declare-const temp___431 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___431 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___431)) no_element))
