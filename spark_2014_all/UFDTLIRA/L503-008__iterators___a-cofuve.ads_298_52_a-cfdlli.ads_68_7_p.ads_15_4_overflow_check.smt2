...
(define-fun dynamic_invariant ((temp___expr_251 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 1 2147483647)) (in_range1 temp___expr_251)))
...
(define-fun dynamic_invariant1 ((temp___expr_258 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool) (temp___do_typ_inv_257 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_258)))
...
(define-fun dynamic_invariant3 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483647)) (in_range5 temp___expr_265)))
