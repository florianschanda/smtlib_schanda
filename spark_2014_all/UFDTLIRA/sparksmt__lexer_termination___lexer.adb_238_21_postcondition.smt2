...
(declare-const temp___1054 us_rep)
(declare-const temp___1056 Int)
(declare-const temp___1053 read_status)
(declare-const temp___10531 character)
(declare-const temp___10532 Bool)
(declare-const temp___1052 Int)
(declare-const temp___1051 Int)
(declare-const temp___1050 Int)
(declare-const temp___1049 read_status)
(declare-const temp___10491 character)
(declare-const temp___10492 Bool)
...
(declare-const temp___10582 Int)
(declare-const result2 int__ref)
(declare-const temp___10572 Int)
...
(assert (=> (= result true) (= temp___1055 next_idx1)))
(assert (=> (= result true) (= temp___1054 the_file1)))
(assert (=> (= result true) (= temp___1056 current_idx1)))
(assert (=> (= result true) (and (= (mk___split_discrs temp___1053) next_read__split_discrs1) (and (= (mk___split_fields temp___10531) next_read__split_fields1) (= temp___10532 next_read__attr__constrained)))))
(assert (=> (= result true) (= temp___1052 current_idx1)))
(assert (=> (= result true) (= temp___1051 current_col1)))
(assert (=> (= result true) (= temp___1050 current_line1)))
(assert (=> (= result true) (and (= (mk___split_discrs temp___1049) current_read__split_discrs1) (and (= (mk___split_fields temp___10491) current_read__split_fields1) (= temp___10492 current_read__attr__constrained)))))
(assert (=> (= result true) (= 0 temp___1058)))
(assert (=> (= result true) (= 0 temp___1057)))
(assert (=> (= result true) (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= temp___1056 current_idx2))))
...
(assert (=> (= result true) (= result1 (mk_int__ref temp___10581))))
(assert (=> (= result true) (= temp___10582 next_idx2)))
(assert (=> (= result true) (= result2 (mk_int__ref temp___10571))))
(assert (=> (= result true) (= temp___10572 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false) 1 0))))
(assert (=> (= result true) (and (and (and (and (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true) (= (bool_eq1 (mk___rep current_read__split_discrs3 current_read__split_fields3 current_read__attr__constrained) (mk___rep next_read__split_discrs2 next_read__split_fields2 next_read__attr__constrained)) true)) (= current_idx3 next_idx2)) (<= current_idx2 current_idx3)) (and (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_idx3)) (in_range1 next_idx3)))))
...
(assert (not (= (local_invariant (file__content the_file8) (us_split_fields__content current_read__split_fields8) (us_split_discrs__content current_read__split_discrs8) (int__content current_idx8) (us_split_fields__content next_read__split_fields8) (us_split_discrs__content next_read__split_discrs8) (int__content next_idx8)) true)))
(check-sat)
(exit)
