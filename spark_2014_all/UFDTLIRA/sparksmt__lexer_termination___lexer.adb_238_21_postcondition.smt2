...
(assert (=> (= result true) (and (= (mk___split_discrs temp___967) next_read__split_discrs1) (and (= (mk___split_fields temp___9671) next_read__split_fields1) (= temp___9672 next_read__attr__constrained)))))
...
(assert (=> (= result true) (and (= (mk___split_discrs temp___963) current_read__split_discrs1) (and (= (mk___split_fields temp___9631) current_read__split_fields1) (= temp___9632 current_read__attr__constrained)))))
(assert (=> (= result true) (= 0 temp___972)))
(assert (=> (= result true) (= 0 temp___971)))
(assert (=> (= result true) (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= temp___970 current_idx2))))
(assert (=> (= result true) (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2))))
...
(assert (=> (= result true) (= temp___9712 (to_int1 (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false)))))
