...
(define-fun dynamic_invariant ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 0 2147483647)) (in_range3 temp___expr_250)))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length2 container)))))
...
(define-fun o8 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___515 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___515)) no_element))
(assert (and (= o8 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o8 no_element) true) (and (= (has_key (positions l) o8) true) (= (get1 (positions l) o8) 1)))))
(assert (= (mk_cursor__ref (mk___rep1 (mk___split_fields1 result))) (mk_cursor__ref (mk___rep1 (mk___split_fields1 cu)))))
(assert (= cu1 o8))
(assert (and (= result1 (has_key (positions l) cu1)) (= (= result1 true) (= (has_key (positions l) cu1) true))))
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions l) cu2) 1))) (not (= (get (model__ l) i1) 0)))))
(assert (= (has_key (positions l) cu2) true))
(assert (and (= o3 (positions l)) (and (not (= (has_key o3 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o3 i1) true) (and (and (<= 1 (get1 o3 i1)) (<= (get1 o3 i1) (length2 l))) (forall ((j us_rep1)) (=> (= (has_key o3 j) true) (=> (= (get1 o3 i1) (get1 o3 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o4 (get1 o3 cu2)) (and (in_range4 o4) (=> (= (distinct 0 0) true) (and (= o4 (w_get o3 (witness o3 cu2))) (forall ((k us_rep1)) (=> (= (has_key o3 k) true) (= (= (bool_eq1 k cu2) true) (= (witness o3 cu2) (witness o3 k))))))))))
(assert (= o5 (- o4 1)))
(assert (= o6 (ite (<= i o5) true false)))
(assert (= result2 (ite (<= 1 i) o6 false)))
(assert (= result2 true))
(assert (and (= o7 (model__ l)) (= (length o7) (length2 l))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
