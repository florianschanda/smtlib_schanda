...
(declare-const temp___10411 Int)
(declare-const result2 int__ref)
(declare-const temp___10401 Int)
...
(assert (and (and (and (and (in_range2 current_line1) (in_range1 current_col1)) (in_range1 current_idx1)) (in_range1 next_idx1)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs1)) 0) (let ((temp___1043 (to_rep (rec__file_io__read_result__c current_read__split_fields1)))) (or (= temp___1043 10) (or (= temp___1043 13) (or (= temp___1043 32) (= temp___1043 9))))))))
(assert (= result1 (mk_int__ref temp___1041)))
(assert (= temp___10411 next_idx1))
(assert (= result2 (mk_int__ref temp___1040)))
(assert (= temp___10401 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs1)) 0) true false) 1 0)))
...
(assert (not (or (< temp___10411 next_idx2) (and (= next_idx2 temp___10411) (< (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) 1 0) temp___10401)))))
(check-sat)
(exit)
