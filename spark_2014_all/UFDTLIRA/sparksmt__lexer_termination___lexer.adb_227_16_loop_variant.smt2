...
(declare-const temp___10341 Int)
(declare-const result2 int__ref)
(declare-const temp___10331 Int)
...
(assert (=> (= (to_rep1 current_read__split_discrs) 0) (= result (ite (or (= (to_rep current_read__split_fields) 10) (or (= (to_rep current_read__split_fields) 13) (or (= (to_rep current_read__split_fields) 32) (= (to_rep current_read__split_fields) 9)))) true false))))
(assert (=> (not (= (to_rep1 current_read__split_discrs) 0)) (= result false)))
(assert (= result true))
(assert (and (= (local_invariant the_file1 current_read__split_fields1 current_read__split_discrs1 current_idx1 next_read__split_fields1 next_read__split_discrs1 next_idx1) true) (<= current_idx current_idx1)))
(assert (and (and (and (and (in_range2 current_line1) (in_range1 current_col1)) (in_range1 current_idx1)) (in_range1 next_idx1)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs1)) 0) (let ((temp___1036 (to_rep (rec__file_io__read_result__c current_read__split_fields1)))) (or (= temp___1036 10) (or (= temp___1036 13) (or (= temp___1036 32) (= temp___1036 9))))))))
(assert (= result1 (mk_int__ref temp___1034)))
(assert (= temp___10341 next_idx1))
(assert (= result2 (mk_int__ref temp___1033)))
(assert (= temp___10331 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs1)) 0) true false) 1 0)))
(assert (and (and (and (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (= (bool_eq (mk___rep current_read__split_discrs2 current_read__split_fields2 current_read__attr__constrained) (mk___rep next_read__split_discrs1 next_read__split_fields1 next_read__attr__constrained)) true)) (= current_idx2 next_idx1)) (<= current_idx1 current_idx2)) (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (= o (ite (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields2)) 10) (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields2)) 13) (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields2)) 32) (= (to_rep (rec__file_io__read_result__c current_read__split_fields2)) 9)))) true false))))
(assert (=> (not (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0)) (= o false)))
(assert (= result3 (ite (not (= o true)) true false)))
(assert (not (= result3 true)))
(assert (not (or (< temp___10341 next_idx2) (and (= next_idx2 temp___10341) (< (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) 1 0) temp___10331)))))
(check-sat)
(exit)
