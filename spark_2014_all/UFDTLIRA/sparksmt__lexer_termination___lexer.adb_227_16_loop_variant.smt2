...
(declare-const temp___940 read_status)
(declare-const temp___9401 character)
(declare-const temp___9402 Bool)
(declare-const temp___939 Int)
(declare-const temp___938 Int)
(declare-const temp___937 Int)
(declare-const temp___943 Int)
(declare-const temp___936 read_status)
(declare-const temp___9361 character)
(declare-const temp___9362 Bool)
...
(declare-const temp___9451 Int)
(declare-const temp___9441 Int)
(declare-const result1 int__ref)
(declare-const temp___9452 Int)
(declare-const result2 int__ref)
(declare-const temp___9442 Int)
...
(declare-const temp___9453 int__ref)
(declare-const temp___9443 int__ref)
...
(declare-const temp___9454 Int)
(declare-const temp___9444 Int)
...
(assert (= result true))
(assert (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= current_idx current_idx2)))
(assert (and (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (let ((temp___947 (to_rep (rec__file_io__read_result__c current_read__split_fields2)))) (or (= temp___947 10) (or (= temp___947 13) (or (= temp___947 32) (= temp___947 9))))))))
(assert (= result1 (mk_int__ref temp___9451)))
(assert (= temp___9452 next_idx2))
(assert (= result2 (mk_int__ref temp___9441)))
(assert (= temp___9442 (to_int1 (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false))))
(assert (and (and (and (and (= (local_invariant the_file3 current_read__split_fields3 current_read__split_discrs3 current_idx3 next_read__split_fields3 next_read__split_discrs3 next_idx3) true) (= (bool_eq1 (mk___rep current_read__split_discrs3 current_read__split_fields3 current_read__attr__constrained) (mk___rep next_read__split_discrs2 next_read__split_fields2 next_read__attr__constrained)) true)) (= current_idx3 next_idx2)) (<= current_idx2 current_idx3)) (and (and (and (in_range2 current_line3) (in_range1 current_col3)) (in_range1 current_idx3)) (in_range1 next_idx3))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs3)) 0) (= o (ite (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 10) (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 13) (or (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 32) (= (to_rep (rec__file_io__read_result__c current_read__split_fields3)) 9)))) true false))))
...
(assert (not (or (< temp___9452 next_idx3) (and (= next_idx3 temp___9452) (< (to_int1 (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs3)) 0)) temp___9442)))))
(check-sat)
(exit)
