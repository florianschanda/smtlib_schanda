...
(define-fun dynamic_invariant3 ((temp___expr_461 Int) (temp___is_init_458 Bool) (temp___skip_constant_459 Bool) (temp___do_toplevel_460 Bool)) Bool (=> (or (= temp___is_init_458 true) (<= 0 2)) (in_range4 temp___expr_461)))
...
(assert (and (and (and (in_range2 current_line1) (in_range1 current_col1)) (in_range1 current_idx1)) (in_range1 next_idx1)))
(assert (= result1 (mk_int__ref temp___955)))
(assert (= temp___9551 next_idx1))
(assert (= result2 (mk_int__ref temp___954)))
(assert (= temp___9541 (to_int1 (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs1)) 0) true false))))
(assert (and (and (and (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (= (bool_eq1 (mk___rep current_read__split_discrs2 current_read__split_fields2 current_read__attr__constrained) (mk___rep next_read__split_discrs1 next_read__split_fields1 next_read__attr__constrained)) true)) (= current_idx2 next_idx1)) (<= current_idx1 current_idx2)) (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2))))
...
(assert (not (or (< temp___9551 next_idx2) (and (= next_idx2 temp___9551) (< (to_int1 (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0)) temp___9541)))))
(check-sat)
(exit)
