...
(define-fun dynamic_invariant ((temp___expr_367 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= 1 2147483647)) (in_range1 temp___expr_367)))
...
(define-fun dynamic_invariant1 ((temp___expr_373 Int) (temp___is_init_370 Bool) (temp___skip_constant_371 Bool) (temp___do_toplevel_372 Bool)) Bool (=> (or (= temp___is_init_370 true) (<= 1 2147483647)) (in_range2 temp___expr_373)))
