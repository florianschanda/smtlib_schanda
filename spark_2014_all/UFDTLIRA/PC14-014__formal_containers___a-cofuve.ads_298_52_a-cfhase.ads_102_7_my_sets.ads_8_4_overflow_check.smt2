...
(define-fun dynamic_invariant ((temp___expr_401 Int) (temp___is_init_397 Bool) (temp___skip_constant_398 Bool) (temp___do_toplevel_399 Bool) (temp___do_typ_inv_400 Bool)) Bool (=> (or (= temp___is_init_397 true) (<= 1 2147483647)) (in_range1 temp___expr_401)))
...
(define-fun dynamic_invariant1 ((temp___expr_408 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool) (temp___do_typ_inv_407 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range2 temp___expr_408)))
