...
(assert (and (= o6 (length orear)) (and (in_range2 o6) (<= o6 (capacity orear)))))
(assert (and (= o7 (length ofront)) (and (in_range2 o7) (<= o7 (capacity ofront)))))
(assert (= o8 (+ o7 o6)))
(assert (and (= o9 (length (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))) (and (in_range2 o9) (<= o9 (capacity (mk___rep front__split_discrs (us_split_fields__content front__split_fields8)))))))
(assert (= result3 (ite (= o9 o8) true false)))
(assert (= result3 true))
(assert (and (= o5 (length (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))) (and (in_range2 o5) (<= o5 (capacity (mk___rep rear__split_discrs (us_split_fields__content rear__split_fields2)))))))
(assert (= result4 (ite (= o5 0) true false)))
(assert (= result4 true))
...
(assert (not (<= o4 (last (model__ ofront)))))
(check-sat)
(exit)
