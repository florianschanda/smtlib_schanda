...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__my_ordered_maps__m__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields)) count_type (rec__my_ordered_maps__m__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__my_ordered_maps__m__cursor__node (us_split_fields1 a))) (to_rep (rec__my_ordered_maps__m__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun key_type__ref___3__projection ((a key_type__ref)) us_rep (key_type__content a))
...
(define-fun map__ref___3__projection ((a map__ref)) us_rep1 (map__content a))
...
(define-fun default_initial_assumption ((temp___expr_427 us_rep1) (temp___skip_top_level_428 Bool)) Bool (=> (not (= temp___skip_top_level_428 true)) (and (= (is_empty temp___expr_427) true) (= (length temp___expr_427) 0))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__my_ordered_maps__m__map us_main_type1)))))
(define-fun us_split_fields_Map__projection ((a us_split_fields2)) us_main_type1 (rec__my_ordered_maps__m__map a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__my_ordered_maps__m__map__capacity (us_split_discrs1 a))) (to_rep (rec__my_ordered_maps__m__map__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__my_ordered_maps__m__map (us_split_fields3 a)) (rec__my_ordered_maps__m__map (us_split_fields3 b))) true)) true false))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_maps__m__map__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(define-fun default_initial_assumption1 ((temp___expr_368 us_rep3) (temp___skip_top_level_369 Bool)) Bool (=> (not (= temp___skip_top_level_369 true)) (and (= (is_empty1 temp___expr_368) true) (= (length2 temp___expr_368) 0))))
(assert true)
(declare-fun oeq1 (us_rep3 us_rep3) Bool)
(declare-fun oeq__function_guard1 (Bool us_rep3 us_rep3) Bool)
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq left right) true) (= (oeq1 (model__ left) (model__ right)) true)) :pattern ((oeq left right)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (forall ((key us_rep)) (! (=> (= (has_key container1 key) true) (let ((result (witness container1 key))) (and (= (has_witness1 container1 result) true) (dynamic_invariant1 result true false true true)))) :pattern ((witness container1 key))))))
(assert (forall ((container1 us_rep1)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant1 witness2 true true true true) (= (has_witness1 container1 witness2) true)) (dynamic_invariant (w_get container1 witness2) true false true true)) :pattern ((w_get container1 witness2))))))
(declare-const o us_rep1)
(assert (= (mk___rep (mk___split_fields rliteral)) no_element))
(assert (or (= (has_key (positions container) position) true) (= (bool_eq position no_element) true)))
