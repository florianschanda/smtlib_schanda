...
(assert (=> (not (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true)) (= (mk___split_fields1 dst__split_fields6 (mk___rep (mk___split_fields dst__split_fields7 dst__split_fields8))) (mk___split_fields1 dst__split_fields3 (mk___rep (mk___split_fields dst__split_fields4 dst__split_fields5))))))
