...
(define-fun dynamic_invariant ((temp___expr_1666 us_rep2) (temp___is_init_1662 Bool) (temp___skip_constant_1663 Bool) (temp___do_toplevel_1664 Bool) (temp___do_typ_inv_1665 Bool)) Bool (= (valid_combination (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1666))) true))
(define-fun default_initial_assumption ((temp___expr_1668 us_rep2) (temp___skip_top_level_1669 Bool)) Bool (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields3 temp___expr_1668)) time_first) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields3 temp___expr_1668)) (distinct 0 0))) (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1668)))) (distinct 0 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1668)))) (distinct 0 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1668)))) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1668)))) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1668)))) (distinct 0 0)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption1 ((temp___expr_1650 us_rep1) (temp___skip_top_level_1651 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1650)) (distinct 0 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1650)) (distinct 0 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1650)) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1650)) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1650)) (distinct 0 0))))
(assert true)
...
(define-fun dynamic_invariant1 ((temp___expr_1656 us_rep1) (temp___is_init_1652 Bool) (temp___skip_constant_1653 Bool) (temp___do_toplevel_1654 Bool) (temp___do_typ_inv_1655 Bool)) Bool (=> (= temp___do_toplevel_1654 true) (=> (= temp___is_init_1652 true) (= (valid_combination temp___expr_1656) true))))
(define-fun default_initial_assumption2 ((temp___expr_1658 us_rep1) (temp___skip_top_level_1659 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1658)) (distinct 0 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1658)) (distinct 0 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1658)) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1658)) (distinct 1 0))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1658)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___1660 us_rep1)) Bool (= (valid_combination temp___1660) true))
(define-fun dynamic_invariant2 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 97)) (in_range temp___expr_235)))
(assert (not true))
(check-sat)
(exit)
