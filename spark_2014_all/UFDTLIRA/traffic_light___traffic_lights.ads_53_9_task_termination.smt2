...
(define-fun us_rep___29__projection ((a us_rep2)) us_split_fields2 (us_split_fields3 a))
...
(define-fun dynamic_invariant ((temp___expr_1477 us_rep2) (temp___is_init_1474 Bool) (temp___skip_constant_1475 Bool) (temp___do_toplevel_1476 Bool)) Bool (= (valid_combination (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1477))) true))
(define-fun default_initial_assumption ((temp___expr_1479 us_rep2) (temp___skip_top_level_1480 Bool)) Bool (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields3 temp___expr_1479)) time_first) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields3 temp___expr_1479)) (of_int 0))) (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 (rec__traffic_lights__traffic_lightT__lights (us_split_fields3 temp___expr_1479)))) (of_int 0)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption1 ((temp___expr_1463 us_rep1) (temp___skip_top_level_1464 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1463)) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1463)) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1463)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1463)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1463)) (of_int 0))))
(assert true)
...
(define-fun dynamic_invariant1 ((temp___expr_1468 us_rep1) (temp___is_init_1465 Bool) (temp___skip_constant_1466 Bool) (temp___do_toplevel_1467 Bool)) Bool (=> (= temp___do_toplevel_1467 true) (=> (= temp___is_init_1465 true) (= (valid_combination temp___expr_1468) true))))
(define-fun default_initial_assumption2 ((temp___expr_1470 us_rep1) (temp___skip_top_level_1471 Bool)) Bool (and (and (and (and (= (rec__traffic_lights__lights_state__vehicles_green (us_split_fields1 temp___expr_1470)) (of_int 0)) (= (rec__traffic_lights__lights_state__vehicles_yellow (us_split_fields1 temp___expr_1470)) (of_int 0))) (= (rec__traffic_lights__lights_state__vehicles_red (us_split_fields1 temp___expr_1470)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_green (us_split_fields1 temp___expr_1470)) (of_int 1))) (= (rec__traffic_lights__lights_state__pedestrians_red (us_split_fields1 temp___expr_1470)) (of_int 0))))
(define-fun dynamic_predicate ((temp___1472 us_rep1)) Bool (= (valid_combination temp___1472) true))
(define-fun dynamic_invariant2 ((temp___expr_208 Int) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (or (= temp___is_init_205 true) (<= 0 97)) (in_range temp___expr_208)))
