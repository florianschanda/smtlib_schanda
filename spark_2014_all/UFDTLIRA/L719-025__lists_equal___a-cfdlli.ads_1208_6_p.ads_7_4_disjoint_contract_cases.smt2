...
(define-fun default_initial_assumption ((temp___expr_201 us_rep1) (temp___skip_top_level_202 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_201))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_240 us_rep1) (temp___skip_top_level_241 Bool)) Bool (= (to_rep (rec__p__my_lists__cursor__node (us_split_fields3 temp___expr_240))) 0))
...
(declare-const temp___435 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___435 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___435)) no_element))
