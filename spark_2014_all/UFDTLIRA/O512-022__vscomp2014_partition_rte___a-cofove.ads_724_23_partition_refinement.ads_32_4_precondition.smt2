...
(define-fun dynamic_invariant ((temp___expr_712 Int) (temp___is_init_709 Bool) (temp___skip_constant_710 Bool) (temp___do_toplevel_711 Bool)) Bool (=> (or (= temp___is_init_709 true) (<= 0 10000)) (in_range1 temp___expr_712)))
...
(define-fun bool_eq1 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields3 a))) (to_rep1 (rec__partition_refinement__interval__first (us_split_fields3 b)))) (= (to_rep1 (rec__partition_refinement__interval__last (us_split_fields3 a))) (to_rep1 (rec__partition_refinement__interval__last (us_split_fields3 b))))) (= (to_rep (rec__partition_refinement__interval__count (us_split_fields3 a))) (to_rep (rec__partition_refinement__interval__count (us_split_fields3 b))))) true false))
...
(define-fun element_type__ref___9__projection ((a element_type__ref)) us_rep2 (element_type__content a))
...
(define-fun default_initial_assumption ((temp___expr_770 us_rep1) (temp___skip_top_level_771 Bool)) Bool (=> (not (= temp___skip_top_level_771 true)) (= (length temp___expr_770) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_727 Int) (temp___is_init_724 Bool) (temp___skip_constant_725 Bool) (temp___do_toplevel_726 Bool)) Bool (=> (or (= temp___is_init_724 true) (<= (- 1) 10001)) (in_range6 temp___expr_727)))
...
(define-fun element_type__ref___8__projection ((a element_type__ref1)) us_rep2 (element_type__content1 a))
(declare-const item us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const index1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant2 ((temp___expr_299 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 6)) (in_range4 temp___expr_299)))
(define-fun dynamic_invariant3 ((temp___expr_305 Int) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (<= 0 5)) (in_range5 temp___expr_305)))
...
(define-fun dynamic_invariant5 ((temp___expr_733 Int) (temp___is_init_730 Bool) (temp___skip_constant_731 Bool) (temp___do_toplevel_732 Bool)) Bool (=> (or (= temp___is_init_730 true) (<= 0 10001)) (in_range2 temp___expr_733)))
...
(assert (forall ((x capacity_range)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range2 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity (us_split_discrs1 container1))) 10001))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant5 result true false true))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant6 ((temp___expr_763 Int) (temp___is_init_760 Bool) (temp___skip_constant_761 Bool) (temp___do_toplevel_762 Bool)) Bool (=> (or (= temp___is_init_760 true) (<= (- 1) 10000)) (in_range3 temp___expr_763)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant4 result true false true))) :pattern ((length container1)))))
(assert true)
...
(assert (and (= o3 (last (model__ container))) (and (in_range6 o3) (= o3 (last (model__ container))))))
(assert (= result (ite (< o3 index1) true false)))
(assert (not (= result true)))
(assert (and (= o1 (last (model__ container))) (and (in_range6 o1) (= o1 (last (model__ container))))))
