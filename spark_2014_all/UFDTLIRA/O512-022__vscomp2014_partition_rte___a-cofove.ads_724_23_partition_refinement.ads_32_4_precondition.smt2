...
(define-fun dynamic_invariant ((temp___expr_775 Int) (temp___is_init_771 Bool) (temp___skip_constant_772 Bool) (temp___do_toplevel_773 Bool) (temp___do_typ_inv_774 Bool)) Bool (=> (or (= temp___is_init_771 true) (<= 0 10000)) (in_range1 temp___expr_775)))
...
(define-fun dynamic_invariant1 ((temp___expr_792 Int) (temp___is_init_788 Bool) (temp___skip_constant_789 Bool) (temp___do_toplevel_790 Bool) (temp___do_typ_inv_791 Bool)) Bool (=> (or (= temp___is_init_788 true) (<= (- 1) 10001)) (in_range6 temp___expr_792)))
...
(define-fun dynamic_invariant2 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range4 temp___expr_326)))
(define-fun dynamic_invariant3 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range5 temp___expr_333)))
...
(define-fun dynamic_invariant5 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range2 temp___expr_799)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity (us_split_discrs1 container1))) 10001))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant5 result true false true true))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant6 ((temp___expr_833 Int) (temp___is_init_829 Bool) (temp___skip_constant_830 Bool) (temp___do_toplevel_831 Bool) (temp___do_typ_inv_832 Bool)) Bool (=> (or (= temp___is_init_829 true) (<= (- 1) 10000)) (in_range3 temp___expr_833)))
