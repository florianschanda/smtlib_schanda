...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__instances__lists__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields)) count_type (rec__instances__lists__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__instances__lists__cursor__node (us_split_fields1 a))) (to_rep (rec__instances__lists__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_659 Int) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool) (temp___do_typ_inv_658 Bool)) Bool (=> (or (= temp___is_init_655 true) (<= 1 2147483647)) (in_range2 temp___expr_659)))
...
(define-fun default_initial_assumption ((temp___expr_667 us_rep1) (temp___skip_top_level_668 Bool)) Bool (=> (not (= temp___skip_top_level_668 true)) (and (= (is_empty temp___expr_667) true) (= (length temp___expr_667) 0))))
(define-fun default_initial_assumption1 ((temp___expr_653 us_rep) (temp___skip_top_level_654 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields1 temp___expr_653))) 0))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__instances__lists__list us_main_type1)))))
(define-fun us_split_fields_List__projection ((a us_split_fields2)) us_main_type1 (rec__instances__lists__list a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__instances__lists__list__capacity (us_split_discrs1 a))) (to_rep (rec__instances__lists__list__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__instances__lists__list (us_split_fields3 a)) (rec__instances__lists__list (us_split_fields3 b))) true)) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_608 us_rep) (temp___skip_top_level_609 Bool)) Bool (= (to_rep (rec__instances__lists__cursor__node (us_split_fields1 temp___expr_608))) 0))
(declare-const container us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const position us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant1 ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 0 2147483647)) (in_range1 temp___expr_580)))
(declare-const rliteral count_type)
(assert (= (count_typeqtint rliteral) 0))
(assert (= no_element (mk___rep (mk___split_fields rliteral))))
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__instances__lists__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
