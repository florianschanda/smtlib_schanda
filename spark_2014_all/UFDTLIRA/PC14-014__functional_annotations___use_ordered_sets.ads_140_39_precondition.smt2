...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (= (length1 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range3 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_316)))
(assert true)
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant3 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_elements item (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption1 ((temp___expr_361 us_rep2) (temp___skip_top_level_362 Bool)) Bool (=> (not (= temp___skip_top_level_362 true)) (= (is_empty temp___expr_361) true)))
...
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_353)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant (length2 container) true false true true) :pattern ((length2 container)))))
(assert (forall ((container us_rep2)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range4 item) (= (contains container item) true))))) (= (= result true) (= (length2 container) 0)))) :pattern ((is_empty container)))))
...
(define-fun cu1 () us_rep3 (mk___rep1 (mk___split_fields1 cu)))
(assert (and (= o (has_key (positions s) cu1)) (= (= o true) (= (has_key (positions s) cu1) true))))
(assert (= o1 true))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (= (has_key (positions s) cu1) true)))
(check-sat)
(exit)
