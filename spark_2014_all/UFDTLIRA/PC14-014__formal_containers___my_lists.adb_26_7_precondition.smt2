...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___492)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___492)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___492))) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___492))) 1)))))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 c__split_fields))))
(assert (= c__split_fields1 (mk___split_fields1 temp___492)))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___493)) (last1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___493)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___493))) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___493))) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))))
(assert (= result1 (mk___split_fields__ref1 c__split_fields1)))
(assert (= c__split_fields2 (mk___split_fields1 temp___493)))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___494)) (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields2)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___494)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___494))) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___494))) (+ (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields2)) 1))))))
(assert (= result2 (mk___split_fields__ref1 c__split_fields2)))
(assert (= c__split_fields3 (mk___split_fields1 temp___494)))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___495)) (previous (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields3))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) false) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields3)) 1) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___495)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___495))) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___495))) (- (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields3)) 1))))))
(assert (= result3 (mk___split_fields__ref1 c__split_fields3)))
(assert (= c__split_fields4 (mk___split_fields1 temp___495)))
...
(assert (not (not (= (is_empty1 (mk___rep l__split_discrs l__split_fields7)) true))))
(check-sat)
(exit)
