...
(define-fun temp___4951 () us_rep1 (mk___rep1 (mk___split_fields1 temp___495)))
(define-fun temp___4941 () us_rep1 (mk___rep1 (mk___split_fields1 temp___494)))
(define-fun temp___4931 () us_rep1 (mk___rep1 (mk___split_fields1 temp___493)))
(define-fun temp___4921 () us_rep1 (mk___rep1 (mk___split_fields1 temp___492)))
(assert (= (to_rep o) 0))
(assert (= o o1))
...
(assert (and (= temp___4921 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 temp___4921 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4921) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4921) 1)))))
...
(assert (and (= temp___4931 (last1 (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 temp___4931 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4931) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4931) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))))
(assert (= result1 (mk___split_fields__ref1 c__split_fields1)))
(assert (= c__split_fields2 (mk___split_fields1 temp___493)))
(assert (and (= temp___4941 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields2))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields2)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 temp___4941 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4941) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4941) (+ (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields2)) 1))))))
(assert (= result2 (mk___split_fields__ref1 c__split_fields2)))
(assert (= c__split_fields3 (mk___split_fields1 temp___494)))
(assert (and (= temp___4951 (previous (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields3))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) false) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields3)) 1) true) true) (= (bool_eq1 temp___4951 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4951) true) (= (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___4951) (- (get (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields3)) 1))))))
