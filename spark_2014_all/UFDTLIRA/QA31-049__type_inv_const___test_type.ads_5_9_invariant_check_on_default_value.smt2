...
(define-fun default_initial_assumption ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (= (to_rep (rec__test_type__t__f (us_split_fields1 temp___expr_159))) 0))
(define-fun type_invariant ((temp___161 us_rep)) Bool (in_range1 (to_rep (rec__test_type__t__f (us_split_fields1 temp___161)))))
...
(assert (= x (mk___rep (mk___split_fields rliteral))))
(declare-const temp___163 integer)
(assert (= (to_rep temp___163) 0))
(assert (not (in_range1 (to_rep temp___163))))
(check-sat)
(exit)
