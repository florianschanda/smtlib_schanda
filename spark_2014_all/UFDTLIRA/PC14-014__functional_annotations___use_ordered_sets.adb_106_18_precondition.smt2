...
(assert (and (= o10 (length (mk___rep s1__split_discrs s1__split_fields2))) (and (in_range2 o10) (<= o10 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o11 (ite (<= i1 o10) true false)))
(assert (= result3 (ite (<= 1 i1) o11 false)))
(assert (= result3 true))
(assert (and (= o13 (length (mk___rep s2__split_discrs s2__split_fields1))) (and (in_range2 o13) (<= o13 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o14 (+ o13 i1)))
