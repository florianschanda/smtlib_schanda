...
(assert (and (= o (length (mk___rep s1__split_discrs s1__split_fields1))) (and (in_range2 o) (<= o (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result2 (ite (<= 1 i) o1 false)))
(assert (= result2 true))
(assert (and (= o2 (length (mk___rep s2__split_discrs s2__split_fields1))) (and (in_range2 o2) (<= o2 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o3 (+ o2 i)))
