...
(assert (and (= o21 (first (mk___rep l1__split_discrs l1__split_fields4))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields4)) 0) true) (= (bool_eq1 o21 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o21) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o21) 1)))))
(assert (and (= o22 (next (mk___rep l1__split_discrs l1__split_fields4) o21)) (ite (= (ite (= (bool_eq1 o21 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o21) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq1 o22 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o22) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o22) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o21) 1))))))
