...
(declare-const temp___249 status)
(declare-const temp___2491 natural)
(declare-const temp___2492 natural)
(declare-const temp___2493 Bool)
(declare-const temp___2494 Bool)
(assert (in_range i))
...
(assert (= (to_rep1 o) 2))
(assert (= o o6))
(assert (= temp___249 o6))
(assert (= temp___2491 o3))
(assert (= temp___2492 o4))
(assert (= temp___2493 o5))
(assert (= true temp___2494))
(assert (= x__attr__constrained true))
(assert (not (= temp___249 x__split_discrs)))
(check-sat)
(exit)
