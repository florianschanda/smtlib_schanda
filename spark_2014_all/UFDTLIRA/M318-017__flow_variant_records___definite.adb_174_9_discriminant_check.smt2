...
(declare-datatypes () ((t53b__ref (mk_t53b__ref (t53b__content us_rep)))))
(define-fun t53b__ref___projection ((a t53b__ref)) us_rep (t53b__content a))
...
(declare-const temp___225 status)
(declare-const temp___2251 natural)
(declare-const temp___2252 natural)
(declare-const temp___2253 Bool)
(declare-const temp___2254 Bool)
(assert (in_range i))
(assert (= (to_rep1 x__split_discrs) r52b))
(assert (in_range2 r52b))
(assert (and (= o1 i) (in_range1 i)))
(assert (= (to_rep o2) o1))
(assert (= o2 o3))
(assert (= dummy1 o4))
(assert (= true o5))
(assert (= (to_rep1 o) 2))
(assert (= o o6))
(assert (= temp___225 o6))
(assert (= temp___2251 o3))
(assert (= temp___2252 o4))
(assert (= temp___2253 o5))
(assert (= true temp___2254))
(assert (= x__attr__constrained true))
(assert (not (= temp___225 x__split_discrs)))
(check-sat)
(exit)
