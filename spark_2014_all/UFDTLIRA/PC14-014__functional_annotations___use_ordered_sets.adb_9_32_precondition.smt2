...
(assert (and (= o2 (positions s)) (and (not (= (has_key o2 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length2 s))) (forall ((j us_rep1)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq1 i j) true))))))))))
