...
(define-fun dynamic_invariant1 ((temp___expr_1497 Int) (temp___is_init_1494 Bool) (temp___skip_constant_1495 Bool) (temp___do_toplevel_1496 Bool)) Bool (=> (or (= temp___is_init_1494 true) (<= 0 2147483647)) (in_range3 temp___expr_1497)))
...
(define-fun dynamic_invariant2 ((temp___expr_1503 Int) (temp___is_init_1500 Bool) (temp___skip_constant_1501 Bool) (temp___do_toplevel_1502 Bool)) Bool (=> (or (= temp___is_init_1500 true) (<= 0 2147483647)) (in_range4 temp___expr_1503)))
...
(define-fun dynamic_invariant3 ((temp___expr_1485 Int) (temp___is_init_1482 Bool) (temp___skip_constant_1483 Bool) (temp___do_toplevel_1484 Bool)) Bool (=> (or (= temp___is_init_1482 true) (<= 1 2147483647)) (in_range5 temp___expr_1485)))
