...
(define-fun dynamic_invariant1 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 2147483647)) (in_range3 temp___expr_1603)))
...
(define-fun dynamic_invariant2 ((temp___expr_1610 Int) (temp___is_init_1606 Bool) (temp___skip_constant_1607 Bool) (temp___do_toplevel_1608 Bool) (temp___do_typ_inv_1609 Bool)) Bool (=> (or (= temp___is_init_1606 true) (<= 0 2147483647)) (in_range4 temp___expr_1610)))
...
(define-fun dynamic_invariant3 ((temp___expr_1589 Int) (temp___is_init_1585 Bool) (temp___skip_constant_1586 Bool) (temp___do_toplevel_1587 Bool) (temp___do_typ_inv_1588 Bool)) Bool (=> (or (= temp___is_init_1585 true) (<= 1 2147483647)) (in_range5 temp___expr_1589)))
