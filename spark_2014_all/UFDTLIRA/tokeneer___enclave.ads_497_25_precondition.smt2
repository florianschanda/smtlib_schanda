...
(assert (=> (= result true) (and (= o21 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o21))))
(assert (=> (= result true) (= o22 (ite (= o21 3) true false))))
(assert (=> (= result true) (= o23 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result1 true) (and (= o15 (theauthcertrole (us_private__content state3))) (in_range1 o15))))
(assert (=> (= result1 true) (= o16 (ite (= o15 1) true false))))
(assert (=> (= result1 true) (= o13 (authcertvalid (us_private__content state3)))))
(assert (=> (= result1 true) (= o14 (isgood (us_private__content state3)))))
...
(assert (= o8 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))))
(assert (= result2 (ite (not (= o8 true)) true false)))
(assert (=> (= result2 true) (= o9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))))))
...
(assert (=> (= result3 true) (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))))))
(assert (=> (= result3 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result3 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o1))))
(assert (=> (= result3 true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result3 true) (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))))))
