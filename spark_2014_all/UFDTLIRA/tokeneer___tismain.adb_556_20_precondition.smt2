...
(assert (=> (= result true) (= o32 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o33 (ite (not (= o32 true)) true false))))
(assert (=> (= result true) (= o31 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result1 true) (and (= o27 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o27))))
(assert (=> (= result1 true) (= o28 (ite (= o27 0) true false))))
(assert (=> (= result1 true) (= o26 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result2 true) (= o24 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (=> (= result3 true) (= o21 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result3 true) (= o22 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result3 true) (= o23 (ite (= o22 true) o21 false))))
(assert (=> (not (= result3 true)) (= o23 (of_int 1))))
(assert (= o15 (statusiswaitingremoveadmintokenfail (us_private__content state))))
(assert (= o16 (statusisgotadmintoken (us_private__content state))))
(assert (= result4 (ite (= o16 false) o15 true)))
(assert (=> (= result4 true) (= o17 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result4 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (not (= result4 true)) (= o18 (of_int 1))))
(assert (and (= o11 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o11)))
(assert (= o12 (ite (= o11 4) true false)))
(assert (= o13 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result5 (ite (= o13 true) o12 false)))
(assert (=> (= result5 true) (= o14 (statusiswaitingstartadminop (us_private__content state)))))
(assert (=> (not (= result5 true)) (= o14 (of_int 1))))
(assert (= o8 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result6 (ite (not (= o8 true)) true false)))
(assert (=> (= result6 true) (= o9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result6 true) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (not (= result6 true)) (= o10 (of_int 1))))
(assert (and (= o (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o)))
(assert (= result7 (ite (= o 1) true false)))
(assert (=> (= result7 true) (= o4 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result7 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result7 true) (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o1))))
(assert (=> (= result7 true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result7 true) (= o3 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
