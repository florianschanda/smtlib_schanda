...
(define-fun default_initial_assumption3 ((temp___expr_234 us_rep1) (temp___skip_top_level_235 Bool)) Bool (= (to_rep (rec__lists__l__cursor__node (us_split_fields3 temp___expr_234))) 0))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__lists__l__list__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true))) :pattern ((length2 container)))))
...
(declare-const temp___456 count_type)
(declare-const i Int)
...
(declare-const lists__search__result1 count_type)
...
(declare-const lists__search__result2 us_rep1)
(declare-const result4 Bool)
(declare-const result5 Bool)
(declare-const result6 cursor__ref)
(declare-const lists__search__result3 us_rep1)
(declare-const c__split_fields3 us_split_fields2)
(declare-const result7 Bool)
(declare-const c__split_fields4 us_split_fields__ref1)
(declare-const lists__search__result4 cursor__ref)
(declare-const c__split_fields5 us_split_fields2)
(declare-const lists__search__result5 us_rep1)
(declare-const c__split_fields6 us_split_fields__ref1)
(declare-const lists__search__result6 cursor__ref)
(declare-const c__split_fields7 us_split_fields2)
(declare-const lists__search__result7 us_rep1)
(declare-const c__split_fields8 us_split_fields__ref1)
(declare-const lists__search__result8 cursor__ref)
(declare-const c__split_fields9 us_split_fields2)
(declare-const lists__search__result9 us_rep1)
(declare-const result8 cursor__ref)
(declare-const lists__search__result10 us_rep1)
(declare-const lists__search__result11 cursor__ref)
(declare-const lists__search__result12 us_rep1)
(declare-const c__split_fields10 us_split_fields__ref1)
(declare-const lists__search__result13 cursor__ref)
(declare-const c__split_fields11 us_split_fields2)
(declare-const lists__search__result14 us_rep1)
(declare-const c__split_fields12 us_split_fields__ref1)
(declare-const lists__search__result15 cursor__ref)
(declare-const c__split_fields13 us_split_fields2)
(declare-const lists__search__result16 us_rep1)
...
(assert (and (= (mk___rep1 (mk___split_fields1 lists__search__c__assume)) (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 lists__search__c__assume)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 lists__search__c__assume))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 lists__search__c__assume))) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result2)) (mk___split_fields__ref1 (mk___split_fields1 c__split_fields))))
(assert (= lists__search__c__assume c__split_fields1))
(assert (and (= result3 (has_key (positions l) (mk___rep1 (mk___split_fields1 c__split_fields1)))) (= (= result3 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 c__split_fields1))) true))))
(assert (= result3 true))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions l) (mk___rep1 c__split_fields2)) 1))) (not (= (get (model__ l) i2) 0)))))
(assert (= (has_key (positions l) (mk___rep1 c__split_fields2)) true))
(assert (and (= o8 (positions l)) (and (not (= (has_key o8 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key o8 i2) true) (and (and (<= 1 (get1 o8 i2)) (<= (get1 o8 i2) (length2 l))) (forall ((j us_rep1)) (=> (= (has_key o8 j) true) (=> (= (get1 o8 i2) (get1 o8 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o9 (get1 o8 (mk___rep1 c__split_fields2))) (and (in_range4 o9) (=> (= (of_int 0) true) (and (= o9 (w_get o8 (witness o8 (mk___rep1 c__split_fields2)))) (forall ((k us_rep1)) (=> (= (has_key o8 k) true) (= (= (bool_eq1 k (mk___rep1 c__split_fields2)) true) (= (witness o8 (mk___rep1 c__split_fields2)) (witness o8 k))))))))))
(assert (= o10 (- o9 1)))
(assert (= o11 (ite (<= i o10) true false)))
(assert (= result4 (ite (<= 1 i) o11 false)))
(assert (= result4 true))
(assert (and (= o12 (model__ l)) (= (length o12) (length2 l))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
