...
(define-fun prop__23 () bool__ref (mk_bool__ref prop__))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= temp___203 i2)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= temp___202 prop__)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= (mk_bool__ref result1) prop__23)))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= prop__2 (distinct 0 0))))
(assert (=> (and (<= 1 i2) (<= i2 3)) (= (mk_int__ref result2) j22)))
...
(assert (=> (not (and (<= 1 i2) (<= i2 3))) (= j12 j22)))
(assert (=> (not (and (<= 1 i2) (<= i2 3))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= 1 i2) (<= i2 3))) (= prop__12 prop__23)))
