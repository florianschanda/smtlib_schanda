...
(assert (not (<= (length (mk___rep k__split_discrs k__split_fields6)) (- (to_rep (rec__my_lists__m__list__capacity l__split_discrs)) (length (mk___rep l__split_discrs l__split_fields6))))))
(check-sat)
(exit)
