...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) (mk___rep cu__split_fields3)) 1))) (not (= (get (model__ l) i) e)))))
(assert (= (has_key (positions l) (mk___rep cu__split_fields3)) true))
(assert (and (= o (element l (mk___rep cu__split_fields3))) (and (in_range5 o) (= o (get (model__ l) (get1 (positions l) (mk___rep cu__split_fields3)))))))
(assert (= result2 (ite (= o e) true false)))
(assert (not (= result2 true)))
(assert (= use_lists__my_find__result1 (mk___rep (mk___split_fields use_lists__my_find__result))))
(assert (not (or (= (has_key (positions l) (mk___rep cu__split_fields3)) true) (= (bool_eq1 (mk___rep cu__split_fields3) no_element) true))))
(check-sat)
(exit)
