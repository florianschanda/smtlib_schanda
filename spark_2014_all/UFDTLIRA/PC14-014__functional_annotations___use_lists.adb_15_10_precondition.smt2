...
(assert (and (= result1 (has_key (positions l) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))))
(assert (= result1 true))
...
(assert (and (= o8 (element l (mk___rep1 cu__split_fields2))) (and (in_range6 o8) (= o8 (get (model__ l) (get1 (positions l) (mk___rep1 cu__split_fields2)))))))
(assert (= result3 (ite (= o8 e) true false)))
(assert (not (= result3 true)))
(assert (= use_lists__my_find__result3 use_lists__my_find__result2))
(assert (not (or (= (has_key (positions l) (mk___rep1 cu__split_fields2)) true) (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) true))))
(check-sat)
(exit)
