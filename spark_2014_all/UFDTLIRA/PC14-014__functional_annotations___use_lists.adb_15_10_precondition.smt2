...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions l) (mk___rep1 cu__split_fields2)) 1))) (not (= (get (model__ l) i) e)))))
(assert (= (has_key (positions l) (mk___rep1 cu__split_fields2)) true))
(assert (and (= o2 (element l (mk___rep1 cu__split_fields2))) (and (in_range6 o2) (= o2 (get (model__ l) (get1 (positions l) (mk___rep1 cu__split_fields2)))))))
