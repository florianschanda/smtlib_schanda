...
(define-fun dynamic_invariant ((temp___expr_1518 Int) (temp___is_init_1515 Bool) (temp___skip_constant_1516 Bool) (temp___do_toplevel_1517 Bool)) Bool (=> (or (= temp___is_init_1515 true) (<= 1 2147483647)) (in_range2 temp___expr_1518)))
...
(define-fun dynamic_invariant1 ((temp___expr_1530 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2147483647)) (in_range3 temp___expr_1530)))
...
(define-fun default_initial_assumption ((temp___expr_1537 us_rep) (temp___skip_top_level_1538 Bool)) Bool (=> (not (= temp___skip_top_level_1538 true)) (= (length temp___expr_1537) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_1524 Int) (temp___is_init_1521 Bool) (temp___skip_constant_1522 Bool) (temp___do_toplevel_1523 Bool)) Bool (=> (or (= temp___is_init_1521 true) (<= 0 2147483647)) (in_range5 temp___expr_1524)))
