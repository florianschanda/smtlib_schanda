...
(define-fun dynamic_invariant ((temp___expr_1627 Int) (temp___is_init_1623 Bool) (temp___skip_constant_1624 Bool) (temp___do_toplevel_1625 Bool) (temp___do_typ_inv_1626 Bool)) Bool (=> (or (= temp___is_init_1623 true) (<= 1 2147483647)) (in_range2 temp___expr_1627)))
...
(define-fun dynamic_invariant1 ((temp___expr_1641 Int) (temp___is_init_1637 Bool) (temp___skip_constant_1638 Bool) (temp___do_toplevel_1639 Bool) (temp___do_typ_inv_1640 Bool)) Bool (=> (or (= temp___is_init_1637 true) (<= 0 2147483647)) (in_range3 temp___expr_1641)))
