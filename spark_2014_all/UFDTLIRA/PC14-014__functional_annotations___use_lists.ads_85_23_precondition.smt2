...
(assert (and (= o53 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)) (in_range3 o53)))
(assert (and (= o52 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o52) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= 1 i3)))
(check-sat)
(exit)
