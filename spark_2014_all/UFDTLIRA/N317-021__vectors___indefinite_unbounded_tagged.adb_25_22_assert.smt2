...
(assert (not (= (let ((temp___589 (f 3))) (let ((temp___588 (get (model__ (mk___rep v__split_discrs v__split_fields4)) 3))) (ite (= (attr__tag temp___588) (attr__tag temp___589)) (us_dispatch_eq temp___588 temp___589) false))) true)))
(check-sat)
(exit)
