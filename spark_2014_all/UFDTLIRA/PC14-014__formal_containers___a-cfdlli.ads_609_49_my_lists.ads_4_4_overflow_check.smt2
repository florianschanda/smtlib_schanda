...
(define-fun dynamic_invariant1 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 1 2147483647)) (in_range2 temp___expr_214)))
...
(declare-const temp___459 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___459 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___459)) no_element))
(assert (in_range2 new_item))
(assert (in_range1 count))
(assert (not (in_range (- (to_rep (rec__my_lists__m__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
