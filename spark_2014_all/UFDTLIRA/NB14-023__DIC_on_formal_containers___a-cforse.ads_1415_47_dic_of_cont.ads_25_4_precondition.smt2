...
(define-fun dynamic_invariant ((temp___expr_1349 Int) (temp___is_init_1345 Bool) (temp___skip_constant_1346 Bool) (temp___do_toplevel_1347 Bool) (temp___do_typ_inv_1348 Bool)) Bool (=> (or (= temp___is_init_1345 true) (<= 0 2147483647)) (in_range1 temp___expr_1349)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (first_element container))) (and (and (= result (get (elements container) 1)) (= (e_smaller_than_range (elements container) 2 (length container) result) true)) (dynamic_invariant result true false true true)))) :pattern ((first_element container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant (first_element1 attr__tag container) true false true true) :pattern ((first_element1 attr__tag container))))))
...
(define-fun default_initial_assumption ((temp___expr_1423 us_rep1) (temp___skip_top_level_1424 Bool)) Bool (=> (not (= temp___skip_top_level_1424 true)) (= (length2 temp___expr_1423) 0)))
(declare-fun find (us_rep1 Int) Int)
(declare-fun find__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((container1 us_rep1)) (forall ((item1 Int)) (! (=> (dynamic_invariant item1 true true true true) (let ((result (find container1 item1))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item1 (get container1 result)) true))) (dynamic_invariant1 result true false true true)))) :pattern ((find container1 item1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_1387 us_rep2) (temp___skip_top_level_1388 Bool)) Bool (=> (not (= temp___skip_top_level_1388 true)) (= (is_empty2 temp___expr_1387) true)))
...
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_1379 Int) (temp___is_init_1375 Bool) (temp___skip_constant_1376 Bool) (temp___do_toplevel_1377 Bool) (temp___do_typ_inv_1378 Bool)) Bool (=> (or (= temp___is_init_1375 true) (<= 0 2147483647)) (in_range3 temp___expr_1379)))
...
(define-fun dynamic_invariant3 ((temp___expr_1415 Int) (temp___is_init_1411 Bool) (temp___skip_constant_1412 Bool) (temp___do_toplevel_1413 Bool) (temp___do_typ_inv_1414 Bool)) Bool (=> (or (= temp___is_init_1411 true) (<= 0 2147483647)) (in_range4 temp___expr_1415)))
...
(define-fun dynamic_invariant4 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 2147483647)) (in_range5 temp___expr_1408)))
