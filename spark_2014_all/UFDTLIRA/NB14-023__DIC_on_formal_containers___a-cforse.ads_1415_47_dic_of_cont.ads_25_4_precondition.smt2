...
(define-fun dynamic_invariant ((temp___expr_1260 Int) (temp___is_init_1257 Bool) (temp___skip_constant_1258 Bool) (temp___do_toplevel_1259 Bool)) Bool (=> (or (= temp___is_init_1257 true) (<= 0 2147483647)) (in_range1 temp___expr_1260)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun sequence__ref___5__projection ((a sequence__ref)) us_rep1 (sequence__content a))
...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (first_element container))) (and (and (= result (get (elements container) 1)) (= (e_smaller_than_range (elements container) 2 (length container) result) true)) (dynamic_invariant result true false true)))) :pattern ((first_element container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant (first_element1 attr__tag container) true false true) :pattern ((first_element1 attr__tag container))))))
...
(define-fun default_initial_assumption ((temp___expr_1324 us_rep1) (temp___skip_top_level_1325 Bool)) Bool (=> (not (= temp___skip_top_level_1325 true)) (= (length2 temp___expr_1324) 0)))
(declare-fun find (us_rep1 Int) Int)
(declare-fun find__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((container1 us_rep1)) (forall ((item1 Int)) (! (=> (dynamic_invariant item1 true true true) (let ((result (find container1 item1))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item1 (get container1 result)) true))) (dynamic_invariant1 result true false true)))) :pattern ((find container1 item1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_1293 us_rep2) (temp___skip_top_level_1294 Bool)) Bool (=> (not (= temp___skip_top_level_1294 true)) (= (is_empty2 temp___expr_1293) true)))
...
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_1286 Int) (temp___is_init_1283 Bool) (temp___skip_constant_1284 Bool) (temp___do_toplevel_1285 Bool)) Bool (=> (or (= temp___is_init_1283 true) (<= 0 2147483647)) (in_range3 temp___expr_1286)))
(assert (forall ((container1 us_rep2)) (forall ((item1 Int)) (! (=> (dynamic_invariant2 item1 true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container1 e) true)) (= (equivalent_elements e item1) true))) (= (contains container1 item1) true)))) :pattern ((contains container1 item1))))))
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant1 (length3 container1) true false true) :pattern ((length3 container1)))))
(assert (forall ((container1 us_rep2)) (! (let ((result (is_empty2 container1))) (and (= (= result true) (forall ((item1 Int)) (not (and (in_range3 item1) (= (contains container1 item1) true))))) (= (= result true) (= (length3 container1) 0)))) :pattern ((is_empty2 container1)))))
(define-fun dynamic_invariant3 ((temp___expr_1317 Int) (temp___is_init_1314 Bool) (temp___skip_constant_1315 Bool) (temp___do_toplevel_1316 Bool)) Bool (=> (or (= temp___is_init_1314 true) (<= 0 2147483647)) (in_range4 temp___expr_1317)))
...
(define-fun dynamic_invariant4 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2147483647)) (in_range5 temp___expr_1311)))
(assert (forall ((container1 us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant3 position true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant4 (get container1 position) true false true)) :pattern ((get container1 position))))))
(declare-const o Int)
(declare-const o1 Int)
(declare-const result Bool)
(assert (in_range1 item))
(assert (and (= o1 (length container)) (and (in_range2 o1) (<= o1 (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container)))))))
