...
(define-fun dynamic_invariant1 ((temp___expr_1349 Int) (temp___is_init_1345 Bool) (temp___skip_constant_1346 Bool) (temp___do_toplevel_1347 Bool) (temp___do_typ_inv_1348 Bool)) Bool (=> (or (= temp___is_init_1345 true) (<= 0 2147483647)) (in_range2 temp___expr_1349)))
...
(define-fun default_initial_assumption ((temp___expr_1423 us_rep1) (temp___skip_top_level_1424 Bool)) Bool (=> (not (= temp___skip_top_level_1424 true)) (= (length1 temp___expr_1423) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_1387 us_rep2) (temp___skip_top_level_1388 Bool)) Bool (=> (not (= temp___skip_top_level_1388 true)) (= (is_empty1 temp___expr_1387) true)))
...
(assert (and (= o (length container)) (and (in_range1 o) (<= o (to_rep (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 container)))))))
