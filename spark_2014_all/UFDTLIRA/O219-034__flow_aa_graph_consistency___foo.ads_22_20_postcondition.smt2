...
(define-fun us_split_fields_F__projection ((a us_split_fields)) integer (rec__foo__t__f a))
(define-fun us_split_fields_F2__projection ((a us_split_fields)) integer (rec__foo__t__f2 a))
(define-fun us_split_fields_F3__projection ((a us_split_fields)) integer (rec__foo__t__f3 a))
(define-fun us_split_fields_F4__projection ((a us_split_fields)) integer (rec__foo__t__f4 a))
(define-fun us_split_fields_F5__projection ((a us_split_fields)) integer (rec__foo__t__f5 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep (rec__foo__t__f (us_split_fields1 a))) (to_rep (rec__foo__t__f (us_split_fields1 b)))) (= (to_rep (rec__foo__t__f2 (us_split_fields1 a))) (to_rep (rec__foo__t__f2 (us_split_fields1 b))))) (= (to_rep (rec__foo__t__f3 (us_split_fields1 a))) (to_rep (rec__foo__t__f3 (us_split_fields1 b))))) (= (to_rep (rec__foo__t__f4 (us_split_fields1 a))) (to_rep (rec__foo__t__f4 (us_split_fields1 b))))) (= (to_rep (rec__foo__t__f5 (us_split_fields1 a))) (to_rep (rec__foo__t__f5 (us_split_fields1 b))))) true false))
