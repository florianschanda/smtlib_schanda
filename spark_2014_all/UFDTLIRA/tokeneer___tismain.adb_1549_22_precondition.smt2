...
(assert (=> (= result1 true) (= o17 (isdoingop (mk___rep theadmin__split_fields4)))))
(assert (=> (= result1 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (= result1 true) (= o16 (ispresent (mk___rep theadmin__split_fields4)))))
...
(assert (=> (= result2 true) (and (= o12 (rolepresent (mk___rep theadmin__split_fields4))) (in_range1 o12))))
(assert (=> (= result2 true) (= o13 (ite (= o12 0) true false))))
(assert (=> (= result2 true) (= o11 (isdoingop (mk___rep theadmin__split_fields4)))))
...
(assert (=> (= result3 true) (= o9 (isdoingop (mk___rep theadmin__split_fields4)))))
(assert (=> (= result3 true) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (not (= result3 true)) (= o10 (of_int 1))))
(assert (= o4 (statusiswaitingfinishadminop (let ((subject state2)) state17))))
(assert (= o5 (statusiswaitingstartadminop (let ((subject state2)) state17))))
(assert (= result4 (ite (= o5 false) o4 true)))
(assert (=> (= result4 true) (= o6 (ispresent (mk___rep theadmin__split_fields4)))))
(assert (=> (= result4 true) (= o7 (isdoingop (mk___rep theadmin__split_fields4)))))
(assert (=> (= result4 true) (= o8 (ite (= o7 true) o6 false))))
(assert (=> (not (= result4 true)) (= o8 (of_int 1))))
(assert (= o (statusiswaitingremoveadmintokenfail (let ((subject state2)) state17))))
(assert (= o1 (statusisgotadmintoken (let ((subject state2)) state17))))
(assert (= result5 (ite (= o1 false) o true)))
(assert (=> (= result5 true) (= o2 (ispresent (mk___rep theadmin__split_fields4)))))
