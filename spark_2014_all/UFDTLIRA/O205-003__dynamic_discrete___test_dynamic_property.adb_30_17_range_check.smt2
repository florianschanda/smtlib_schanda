...
(define-fun dynamic_invariant2 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 1 last)) (dynamic_property 1 last temp___expr_158)))
(assert (= last c))
(assert (in_range1 c))
(assert (in_range1 x))
(assert (not (< c x)))
(assert (not (dynamic_property 1 last x)))
(check-sat)
(exit)
