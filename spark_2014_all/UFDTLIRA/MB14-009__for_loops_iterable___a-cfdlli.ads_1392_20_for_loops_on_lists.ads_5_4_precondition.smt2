...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 a))) (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 temp___expr_273))) 0))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__for_loops_on_lists__my_lists__list us_main_type1)))))
(define-fun us_split_fields_List__projection ((a us_split_fields2)) us_main_type1 (rec__for_loops_on_lists__my_lists__list a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 a))) (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__for_loops_on_lists__my_lists__list (us_split_fields3 a)) (rec__for_loops_on_lists__my_lists__list (us_split_fields3 b))) true)) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_228 us_rep) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields1 temp___expr_228))) 0))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
