...
(declare-const r Int)
(declare-const shapes4__make_circle__result coordinate_type)
(declare-const shapes4__make_circle__result1 coordinate_type)
(declare-const shapes4__make_circle__result2 radius_type)
(declare-const o Int)
...
(declare-const shapes4__make_circle__result3 coordinate_type)
(declare-const shapes4__make_circle__result4 coordinate_type)
(declare-const shapes4__make_circle__result5 radius_type)
(declare-const shapes4__make_circle__result6 coordinate_type)
(declare-const shapes4__make_circle__result7 coordinate_type)
(declare-const shapes4__make_circle__result8 radius_type)
(declare-const shapes4__make_circle__result9 coordinate_type)
(declare-const shapes4__make_circle__result10 coordinate_type)
(declare-const shapes4__make_circle__result11 radius_type)
(declare-const r6 int__ref)
(declare-const shapes4__make_circle__result12 circle__ref)
(declare-const r7 Int)
(declare-const shapes4__make_circle__result13 us_rep)
(assert (in_range x))
(assert (in_range y))
