...
(assert (forall ((values__val Int)) (! (=> (dynamic_invariant values__val true true true) (dynamic_invariant (get_val values__val) true false true)) :pattern ((get_val values__val)))))
