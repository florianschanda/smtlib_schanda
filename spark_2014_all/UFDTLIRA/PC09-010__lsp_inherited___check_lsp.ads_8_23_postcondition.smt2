...
(declare-const check_lsp__p_overridden__get_f__result Int)
(declare-const result Int)
(declare-const check_lsp__p_overridden__get_f__result1 Int)
(declare-const check_lsp__p_overridden__get_f__result2 Int)
(declare-const check_lsp__p_overridden__get_f__result3 Int)
(declare-const check_lsp__p_overridden__get_f__result4 Int)
(declare-const check_lsp__p_overridden__get_f__result5 Int)
(declare-const result1 Int)
(assert (= check_lsp__p_overridden__get_f__result1 check_lsp__p_overridden__get_f__result2))
(assert (= check_lsp__p_overridden__get_f__result3 check_lsp__p_overridden__get_f__result1))
(assert (= result check_lsp__p_overridden__get_f__result))
(assert (= check_lsp__p_overridden__get_f__result1 (to_rep (rec__check_lsp__p_overridden__root__f (us_split_fields1 x)))))
(assert (= (mk_int__ref check_lsp__p_overridden__get_f__result4) (mk_int__ref check_lsp__p_overridden__get_f__result2)))
(assert (= check_lsp__p_overridden__get_f__result5 check_lsp__p_overridden__get_f__result3))
(assert (= result1 check_lsp__p_overridden__get_f__result4))
(assert (not (= check_lsp__p_overridden__get_f__result4 (to_rep (rec__check_lsp__p_overridden__root__f (us_split_fields1 x))))))
(check-sat)
(exit)
