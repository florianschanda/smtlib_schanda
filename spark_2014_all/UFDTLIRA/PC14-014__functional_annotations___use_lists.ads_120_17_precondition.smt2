...
(assert (and (= temp___561 (model__ l)) (= (length temp___561) (length1 l))))
(assert (and (= o (iter_has_element temp___561 temp___560)) (= (= o true) (and (<= 1 temp___560) (<= temp___560 (last temp___561))))))
(assert (= (= o1 true) (in_range2 temp___560)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 temp___560)))
(check-sat)
(exit)
