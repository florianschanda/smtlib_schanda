...
(define-fun o2 () us_rep1 (mk___rep (mk___split_fields o)))
(assert (= (mk___rep (mk___split_fields rliteral)) no_element))
(assert (and (= o2 (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 o2 no_element) true) (and (= (has_key (positions l) o2) true) (= (get1 (positions l) o2) 1)))))
...
(assert (and (= o1 (element l cu2)) (and (in_range5 o1) (= o1 (get (model__ l) (get1 (positions l) cu2))))))
(assert (= result2 (ite (= o1 0) true false)))
(assert (not (= result2 true)))
(assert (= for_loops_on_lists__search_0_for_in__result1 for_loops_on_lists__search_0_for_in__result))
(assert (not (or (= (has_key (positions l) cu2) true) (= (bool_eq1 cu2 no_element) true))))
(check-sat)
(exit)
