...
(define-fun dynamic_invariant1 ((temp___expr_228 us_rep) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (and (=> (not (= temp___skip_constant_225 true)) (in_range2 c temp___expr_228)) (= (attr__constrained temp___expr_228) true)))
(define-fun default_initial_assumption1 ((temp___expr_230 us_rep) (temp___skip_top_level_231 Bool)) Bool (and (= (attr__constrained temp___expr_230) true) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_230))) c)))
