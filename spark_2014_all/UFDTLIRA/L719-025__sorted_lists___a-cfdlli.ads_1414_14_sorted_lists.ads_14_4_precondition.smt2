...
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__sorted_lists__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 1 100)) (in_range3 temp___expr_221)))
