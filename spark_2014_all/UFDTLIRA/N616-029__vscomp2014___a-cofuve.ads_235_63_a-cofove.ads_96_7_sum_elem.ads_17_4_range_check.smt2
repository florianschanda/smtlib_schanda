...
(define-fun dynamic_invariant ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 10000)) (in_range2 temp___expr_284)))
...
(define-fun dynamic_invariant1 ((temp___expr_300 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= (- 1) 10000)) (in_range3 temp___expr_300)))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range5 temp___expr_165)))
...
(define-fun dynamic_invariant3 ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 5)) (in_range4 temp___expr_221)))
(assert true)
(declare-const o Int)
...
(assert (and (= o (length right)) (and (in_range5 o) (<= (+ (- 1) o) 10000))))
(assert (= o2 (+ (- 1) o)))
(assert (= o3 (- o2 o1)))
