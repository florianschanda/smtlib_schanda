...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (add_one x) true false true)) :pattern ((add_one x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (add_one x) (+ x 1))) :pattern ((add_one x)))))
(declare-const x Int)
(declare-const o Int)
