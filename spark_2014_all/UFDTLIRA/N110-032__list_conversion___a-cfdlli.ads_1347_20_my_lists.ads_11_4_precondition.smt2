...
(define-fun default_initial_assumption ((temp___expr_235 us_rep1) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__my_lists__my_lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_280 us_rep1) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__my_lists__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(declare-const temp___561 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___561 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___561)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 container)))))))
