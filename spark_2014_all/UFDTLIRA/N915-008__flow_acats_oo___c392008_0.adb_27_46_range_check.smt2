...
(assert (forall ((x dollar_amount)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= (- 30000) 30000)) (in_range temp___expr_158)))
(declare-const a__split_fields dollar_amount)
(assert (not (in_range (- (to_rep a__split_fields) 500))))
(check-sat)
(exit)
