...
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields2)) (to_rep (rec__my_ordered_maps__m__map__capacity l__split_discrs))) (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields2)) 1) true))))
(check-sat)
(exit)
