...
(assert (= eq_null_record__always_true__result1 eq_null_record__always_true__result2))
(assert (= eq_null_record__always_true__result3 eq_null_record__always_true__result1))
(assert (= result eq_null_record__always_true__result))
(assert (= eq_null_record__always_true__result1 (distinct 1 0)))
(assert (= (mk_bool__ref eq_null_record__always_true__result4) (mk_bool__ref eq_null_record__always_true__result2)))
(assert (= eq_null_record__always_true__result5 eq_null_record__always_true__result3))
(assert (= result1 eq_null_record__always_true__result4))
(assert (not (= eq_null_record__always_true__result4 true)))
(check-sat)
(exit)
