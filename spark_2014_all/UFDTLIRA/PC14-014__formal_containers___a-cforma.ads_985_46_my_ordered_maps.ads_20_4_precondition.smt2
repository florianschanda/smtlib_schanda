...
(declare-fun first_key1 (Int us_rep1) us_rep)
(declare-fun first_key__function_guard1 (us_rep Int us_rep1) Bool)
...
(define-fun k_is_find ((container1 us_rep2) (key1 us_rep) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container1 1 (- position 1) key1) (distinct 1 0)) (ite (< position (length2 container1)) (k_smaller_than_range container1 (+ position 1) (length2 container1) key1) (distinct 1 0))))
...
(define-fun default_initial_assumption ((temp___expr_631 us_rep2) (temp___skip_top_level_632 Bool)) Bool (=> (not (= temp___skip_top_level_632 true)) (= (length2 temp___expr_631) 0)))
(declare-fun find (us_rep2 us_rep) Int)
(declare-fun find__function_guard (Int us_rep2 us_rep) Bool)
(assert (forall ((container1 us_rep2)) (forall ((key1 us_rep)) (! (let ((result (find container1 key1))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_keys key1 (get container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 key1))))))
...
(define-fun default_initial_assumption1 ((temp___expr_593 us_rep3) (temp___skip_top_level_594 Bool)) Bool (=> (not (= temp___skip_top_level_594 true)) (and (= (is_empty2 temp___expr_593) true) (= (length3 temp___expr_593) 0))))
...
(assert (forall ((container1 us_rep1)) (! (let ((result (keys container1))) (and (and (and (= (length2 result) (length container1)) (forall ((temp___669 Int)) (=> (and (in_range3 temp___669) (= (iter_has_element result temp___669) true)) (= (has_key (model__ container1) (get result temp___669)) true)))) (forall ((key1 us_rep)) (=> (= (has_key (model__ container1) key1) true) (and (< 0 (find result key1)) (= (equivalent_keys (get result (find result key1)) key1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container1)))))
