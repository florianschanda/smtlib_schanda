...
(define-fun o13 () us_rep (mk___rep (mk___split_discrs o6) o7))
(define-fun o14 () us_rep (mk___rep (mk___split_discrs o4) o5))
(assert (in_range c))
...
(assert (= o2 o1))
(assert (= true o3))
(assert (= o14 (mk___rep (mk___split_discrs o2) o3)))
(assert (= o13 o14))
(assert (= (mk___rep (mk___split_discrs discr__r5__d1__assume) discr__r5__d1__assume1) o13))
...
(assert (= (attr__constrained (rec__discr__holder__content h__split_fields2)) true))
(assert (not (= (rec__discr__with_default__c d2__split_discrs1) (rec__discr__with_default__c (us_split_discrs1 (rec__discr__holder__content h__split_fields2))))))
(check-sat)
(exit)
