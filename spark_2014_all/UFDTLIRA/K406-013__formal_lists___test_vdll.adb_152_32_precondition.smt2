...
(assert (and (= o11 (first (mk___rep l3__split_discrs l3__split_fields4))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields4)) 0) true) (= (bool_eq3 o11 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o11) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o11) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o11) true) (= (bool_eq3 o11 no_element) true))))
(check-sat)
(exit)
