...
(define-fun dynamic_invariant ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_189)))
...
(assert (forall ((left Int)) (forall ((right us_rep)) (! (=> (and (dynamic_invariant left true true true) (<= (+ 1 (length right)) 1000)) (let ((result (oconcat__2 left right))) (and (= (length result) (+ 1 (length right))) (and (= (element result 1) left) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last_index right))) (= (element result (+ 1 i)) (element right i)))))))) :pattern ((oconcat__2 left right))))))
...
(define-fun dynamic_invariant2 ((temp___expr_360 us_rep2) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (and (in_range3 1000 (rec__amortized_queue__queue__front (us_split_fields3 temp___expr_360))) (in_range3 1000 (rec__amortized_queue__queue__rear (us_split_fields3 temp___expr_360)))))
...
(assert (forall ((q us_rep2)) (! (=> (and (dynamic_invariant2 q true true true) (= (inv q) true)) (= (is_model q (model__1 q)) true)) :pattern ((model__1 q)))))
(declare-const q us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const v Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant3 ((temp___expr_351 us_rep) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool (=> (not (= temp___skip_constant_349 true)) (in_range3 1000 temp___expr_351)))
...
(define-fun dynamic_invariant4 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range4 temp___expr_141)))
...
(define-fun dynamic_invariant5 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 1001)) (in_range5 temp___expr_207)))
...
(define-fun dynamic_invariant6 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_201)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 1000) (dynamic_invariant4 result true false true))) :pattern ((length1 container)))))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= (mk___rep (mk___split_discrs o) (mk___split_fields o1)) (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ (mk___rep (mk___split_discrs o) (mk___split_fields o1))) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= (mk___rep (mk___split_discrs o2) (mk___split_fields o3)) (mk___rep (mk___split_discrs o) (mk___split_fields o1))))
(assert (= o7 (mk___rep (mk___split_discrs o2) (mk___split_fields o3))))
