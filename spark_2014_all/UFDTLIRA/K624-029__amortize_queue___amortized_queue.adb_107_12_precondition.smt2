...
(define-fun dynamic_invariant ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_221)))
...
(define-fun dynamic_invariant1 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 1000)) (in_range1 temp___expr_249)))
...
(assert (forall ((left Int)) (forall ((right us_rep)) (! (=> (and (dynamic_invariant left true true true true) (<= (+ 1 (length right)) 1000)) (let ((result (oconcat__2 left right))) (and (= (length result) (+ 1 (length right))) (and (= (element result 1) left) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last_index right))) (= (element result (+ 1 i)) (element right i)))))))) :pattern ((oconcat__2 left right))))))
...
(assert (and (= o9 (length (rec__amortized_queue__queue__rear result____split_fields5))) (and (in_range1 o9) (<= o9 (capacity (rec__amortized_queue__queue__rear result____split_fields5))))))
(assert (and (= o10 (length (rec__amortized_queue__queue__front result____split_fields5))) (and (in_range1 o10) (<= o10 (capacity (rec__amortized_queue__queue__front result____split_fields5))))))
(assert (= result2 (ite (< o10 o9) true false)))
(assert (= result2 true))
(assert (and (= o14 (copy (rec__amortized_queue__queue__rear result____split_fields5) 1000)) (and (= (oeq1 (model__ o14) (model__ (rec__amortized_queue__queue__rear result____split_fields5))) true) (ite (= 1000 0) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o14))) (length (rec__amortized_queue__queue__rear result____split_fields5))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o14))) 1000)))))
(assert (= o15 o14))
(assert (= o16 o15))
(assert (and (= o11 (copy (rec__amortized_queue__queue__front result____split_fields5) 1000)) (and (= (oeq1 (model__ o11) (model__ (rec__amortized_queue__queue__front result____split_fields5))) true) (ite (= 1000 0) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o11))) (length (rec__amortized_queue__queue__front result____split_fields5))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 o11))) 1000)))))
(assert (= o12 o11))
(assert (= o13 o12))
(assert (not (< (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__rear result____split_fields5)) (us_split_fields1 (rec__amortized_queue__queue__rear result____split_fields5)))) (- 1000 (length (mk___rep (us_split_discrs1 (rec__amortized_queue__queue__front result____split_fields5)) (us_split_fields1 (rec__amortized_queue__queue__front result____split_fields5))))))))
(check-sat)
(exit)
