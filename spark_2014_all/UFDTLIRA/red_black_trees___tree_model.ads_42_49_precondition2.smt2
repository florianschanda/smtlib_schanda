...
(assert (and (= o3 (length v)) (and (in_range1 o3) (<= (+ 0 o3) 2147483647))))
(assert (and (= o4 (length p)) (and (in_range1 o4) (<= (+ 0 o4) 2147483647))))
(assert (= o5 (- o4 o3)))
(assert (and (= o7 o5) (in_range4 o5)))
(assert (= result (ite (= o7 o6) true false)))
(assert (= result true))
(assert (and (= o (length q)) (and (in_range1 o) (<= (+ 0 o) 2147483647))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result1 (ite (<= 1 i) o1 false)))
(assert (= result1 true))
(assert (and (= o2 (get q i)) (in_range2 o2)))
(assert (not (<= 1 i)))
(check-sat)
(exit)
