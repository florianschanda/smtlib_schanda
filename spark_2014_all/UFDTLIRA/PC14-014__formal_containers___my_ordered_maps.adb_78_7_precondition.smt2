...
(define-fun o23 () us_rep (mk___rep (mk___split_fields o12 o13)))
(define-fun o24 () us_rep (mk___rep (mk___split_fields o6 o7)))
...
(assert (= o6 o4))
(assert (= o7 o5))
(assert (and (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (+ (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1)) (= (has_key1 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o24) true)) (= (bool_eq (get (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o24)) o24) true)) (= (get2 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o24) 1)) (= (ole (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields))) true)) (= (keys_included_except (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) o24) true)) (= (range_equal (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) 1 (- (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o24) 1)) true)) (= (range_shifted (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o24) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (positions (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o24) 1) true)))
...
(assert (= o12 o10))
(assert (= o13 o11))
(assert (and (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (+ (length (mk___rep1 l__split_discrs l__split_fields1)) 1)) (= (has_key1 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o23) true)) (= (bool_eq (get (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o23)) o23) true)) (= (get2 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o23) 2)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields1)) (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1))) true)) (= (keys_included_except (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (model__ (mk___rep1 l__split_discrs l__split_fields1)) o23) true)) (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields1)) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) 1 (- (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o23) 1)) true)) (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields1)) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o23) (length (mk___rep1 l__split_discrs l__split_fields1)) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs l__split_fields1)) (positions (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o23) 1) true)))
...
(assert (not (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields4)) o22) true)))
(check-sat)
(exit)
