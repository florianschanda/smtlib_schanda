...
(define-fun dynamic_invariant2 ((temp___expr_775 us_rep) (temp___is_init_771 Bool) (temp___skip_constant_772 Bool) (temp___do_toplevel_773 Bool) (temp___do_typ_inv_774 Bool)) Bool (=> (not (= temp___skip_constant_772 true)) (in_range5 10 temp___expr_775)))
(define-fun default_initial_assumption ((temp___expr_777 us_rep) (temp___skip_top_level_778 Bool)) Bool (and (= (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 temp___expr_777))) 10) (=> (not (= temp___skip_top_level_778 true)) (= (is_empty temp___expr_777) true))))
...
(define-fun dynamic_invariant3 ((temp___expr_785 us_rep) (temp___is_init_781 Bool) (temp___skip_constant_782 Bool) (temp___do_toplevel_783 Bool) (temp___do_typ_inv_784 Bool)) Bool (=> (not (= temp___skip_constant_782 true)) (in_range6 10 temp___expr_785)))
(define-fun default_initial_assumption1 ((temp___expr_787 us_rep) (temp___skip_top_level_788 Bool)) Bool (and (= (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 temp___expr_787))) 10) (=> (not (= temp___skip_top_level_788 true)) (= (is_empty temp___expr_787) true))))
...
(define-fun temp___10151 () us_rep3 (mk___rep2 (mk___split_fields2 temp___1015)))
(define-fun temp___10141 () us_rep3 (mk___rep2 (mk___split_fields2 temp___1014)))
...
(assert (and (= temp___10141 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq3 temp___10141 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10141) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10141) 1)))))
(assert (= result c__split_fields))
(assert (= temp___1014 c__split_fields1))
(assert (and (= temp___10151 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep2 c__split_fields4))) (ite (= (ite (= (bool_eq3 (mk___rep2 c__split_fields4) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields4)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq3 temp___10151 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___10151) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep2 c__split_fields4)) 1))))))
(assert (= result1 c__split_fields1))
(assert (= c__split_fields2 temp___1015))
...
(assert (not (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 rliteral3 rliteral4))) true)))
(assert (not (= b true)))
...
(assert (not (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields4)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral1))) true)))
(check-sat)
(exit)
