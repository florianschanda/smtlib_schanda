...
(assert (and (= o86 (first (mk___rep l4__split_discrs l4__split_fields4))) (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields4)) 0) true) (= (bool_eq1 o86 no_element) true) (and (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o86) true) (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields4)) o86) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o86) true) (= (bool_eq1 o86 no_element) true))))
(check-sat)
(exit)
