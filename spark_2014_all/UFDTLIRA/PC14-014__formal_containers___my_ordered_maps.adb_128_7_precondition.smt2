...
(assert (= o6 o4))
(assert (= o7 o5))
(assert (and (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (+ (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1)) (= (has_key1 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o27) true)) (= (bool_eq (get (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o27)) o27) true)) (= (get2 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o27) 1)) (= (ole (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields))) true)) (= (keys_included_except (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) o27) true)) (= (range_equal (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) 1 (- (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o27) 1)) true)) (= (range_shifted (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o27) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (positions (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields)) o27) 1) true)))
...
(assert (= o12 o10))
(assert (= o13 o11))
(assert (and (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (+ (length (mk___rep1 l__split_discrs l__split_fields1)) 1)) (= (has_key1 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o26) true)) (= (bool_eq (get (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o26)) o26) true)) (= (get2 (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o26) 2)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields1)) (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1))) true)) (= (keys_included_except (model__ (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (model__ (mk___rep1 l__split_discrs l__split_fields1)) o26) true)) (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields1)) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) 1 (- (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o26) 1)) true)) (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields1)) (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o26) (length (mk___rep1 l__split_discrs l__split_fields1)) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs l__split_fields1)) (positions (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) (find (keys (mk___rep1 l__split_discrs my_ordered_maps__n__insert__2__container__fields1)) o26) 1) true)))
...
(assert (not (or (< (length (mk___rep1 l__split_discrs l__split_fields6)) (to_rep1 (rec__my_ordered_maps__n__map__capacity l__split_discrs))) (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields6)) o25) true))))
(check-sat)
(exit)
