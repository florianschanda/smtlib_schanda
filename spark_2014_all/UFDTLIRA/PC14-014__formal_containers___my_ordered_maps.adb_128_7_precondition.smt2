...
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields6)) (to_rep (rec__my_ordered_maps__n__map__capacity l__split_discrs))) (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields6)) (mk___rep1 (mk___split_fields1 rliteral1 rliteral4))) true))))
(check-sat)
(exit)
