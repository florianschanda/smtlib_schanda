...
(define-fun default_initial_assumption ((temp___expr_147 us_rep) (temp___skip_top_level_148 Bool)) Bool (and (= (attr__tag temp___expr_147) us_tag) (=> (not (= temp___skip_top_level_148 true)) (= (is_ok temp___expr_147) true))))
...
(define-fun default_initial_assumption1 ((temp___expr_136 us_rep) (temp___skip_top_level_137 Bool)) Bool (and (= (attr__tag temp___expr_136) us_tag1) (=> (not (= temp___skip_top_level_137 true)) (= (is_ok2 temp___expr_136) true))))
(assert (forall ((obj us_rep)) (! (= (to_int1 (is_ok2 obj)) (to_int1 (is_ok3 us_tag1 obj))) :pattern ((is_ok3 us_tag1 obj)))))
(assert (forall ((obj us_rep)) (! (= (to_int1 (is_ok obj)) (to_int1 (is_ok3 us_tag obj))) :pattern ((is_ok3 us_tag obj)))))
(declare-const temp___158 us_main_type)
(declare-const temp___1581 us_private)
(declare-const temp___1582 Int)
(assert (= temp___1582 us_tag))
(assert (not (= (is_ok (mk___rep (mk___split_fields temp___158 temp___1581) temp___1582)) true)))
(check-sat)
(exit)
