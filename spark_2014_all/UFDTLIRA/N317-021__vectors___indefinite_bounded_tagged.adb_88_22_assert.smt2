...
(assert (not (= (let ((temp___678 (f 3))) (let ((temp___677 (last_element (mk___rep v__split_discrs v__split_fields9)))) (ite (= (attr__tag temp___677) (attr__tag temp___678)) (us_dispatch_eq temp___677 temp___678) false))) true)))
(check-sat)
(exit)
