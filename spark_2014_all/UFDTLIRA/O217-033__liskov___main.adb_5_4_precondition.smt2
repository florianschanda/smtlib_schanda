...
(assert true)
(assert true)
(define-fun default_initial_assumption1 ((temp___expr_164 us_rep1) (temp___skip_top_level_165 Bool)) Bool (= (attr__tag1 temp___expr_164) us_tag2))
...
(define-fun default_initial_assumption2 ((temp___expr_150 us_rep1) (temp___skip_top_level_151 Bool)) Bool (= (attr__tag1 temp___expr_150) us_tag1))
(assert true)
(assert true)
