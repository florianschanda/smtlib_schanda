...
(assert true)
(assert true)
(define-fun default_initial_assumption1 ((temp___expr_191 us_rep1) (temp___skip_top_level_192 Bool)) Bool (= (attr__tag1 temp___expr_191) us_tag2))
...
(define-fun default_initial_assumption2 ((temp___expr_175 us_rep1) (temp___skip_top_level_176 Bool)) Bool (= (attr__tag1 temp___expr_175) us_tag1))
(assert true)
(assert true)
...
(assert (= rliteral c1__split_fields3))
(assert (= rliteral1 c1__split_fields4))
(assert (= us_null_ext__ c1__split_fields5))
(assert (= c1__attr__tag us_tag2))
(assert (not (= (less_than_max1 c1__attr__tag (mk___rep (mk___split_fields c1__split_fields4 (hide_ext__ c1__split_fields3 c1__split_fields5)) c1__attr__tag)) true)))
(check-sat)
(exit)
