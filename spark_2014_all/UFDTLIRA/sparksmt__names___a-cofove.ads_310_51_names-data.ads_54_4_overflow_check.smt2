...
(define-fun dynamic_invariant1 ((temp___expr_238 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 2147483647)) (in_range3 temp___expr_238)))
...
(define-fun dynamic_invariant4 ((temp___expr_259 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 255)) (in_range6 temp___expr_259)))
...
(assert (=> (not (= before (- 1))) (and (= o6 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (in_range2 o6) (= o6 (last (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range3 o1) (= o1 (ite (= (of_int 0) true) (to_rep (rec__names__data__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
