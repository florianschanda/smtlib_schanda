...
(define-fun dynamic_invariant1 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 2147483647)) (in_range3 temp___expr_277)))
...
(define-fun dynamic_invariant4 ((temp___expr_301 Int) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool) (temp___do_typ_inv_300 Bool)) Bool (=> (or (= temp___is_init_297 true) (<= 0 255)) (in_range6 temp___expr_301)))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range3 o1) (= o1 (ite (= (distinct 0 0) true) (to_rep (rec__names__data__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
