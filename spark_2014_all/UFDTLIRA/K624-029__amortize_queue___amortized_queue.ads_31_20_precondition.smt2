...
(assert (and (= o8 (length left)) (and (in_range5 o8) (<= o8 (capacity left)))))
(assert (= o9 (+ o8 1)))
(assert (and (= o10 (length (vector__content amortized_queue__Oconcat__3__result5))) (and (in_range5 o10) (<= o10 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
...
(assert (and (= o7 (get (model__ left) o6)) (and (in_range6 o7) (= o7 (get (model__ left) o6)))))
