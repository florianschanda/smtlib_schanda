...
(assert (not (= (let ((temp___626 (f 3))) (let ((temp___625 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 6))) (ite (= (attr__tag temp___625) (attr__tag temp___626)) (us_dispatch_eq temp___625 temp___626) false))) true)))
(check-sat)
(exit)
