...
(assert (not (= (let ((temp___583 (f 3))) (let ((temp___582 (get (model__ (mk___rep1 w__split_discrs w__split_fields2)) 6))) (ite (= (attr__tag temp___582) (attr__tag temp___583)) (us_dispatch_eq temp___582 temp___583) false))) true)))
(check-sat)
(exit)
