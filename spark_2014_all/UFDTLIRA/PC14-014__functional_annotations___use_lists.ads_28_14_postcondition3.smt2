...
(assert (= result1 true))
(assert (and (= l2__split_discrs (mk___split_discrs temp___484)) (= temp___4841 l2__split_fields)))
(assert (= temp___483 cu__split_fields1))
...
(assert (= l2__split_fields4 (mk___split_fields__ref (mk___split_fields l2__split_fields2))))
(assert (= cu__split_fields5 (mk___split_fields1 cu__split_fields3)))
(assert (= l2__split_fields5 (mk___split_fields l2__split_fields2)))
(assert (= cu__split_fields6 cu__split_fields4))
(assert (= l2__split_fields6 l2__split_fields4))
(assert (= cu__split_fields7 cu__split_fields5))
(assert (= l2__split_fields7 l2__split_fields5))
