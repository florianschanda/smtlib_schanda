...
(define-fun dynamic_invariant ((temp___expr_184 us_rep2) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (not (= temp___skip_constant_182 true)) (in_range2 1 (to_base1 temp___expr_184))))
(define-fun default_initial_assumption ((temp___expr_186 us_rep2) (temp___skip_top_level_187 Bool)) Bool (= (to_rep (rec__p__tt__x (us_split_discrs3 temp___expr_186))) 1))
