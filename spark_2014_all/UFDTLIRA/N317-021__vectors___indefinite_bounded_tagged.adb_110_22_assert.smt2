...
(assert (not (= (let ((temp___687 (f 4))) (let ((temp___686 (get (model__ (mk___rep1 v__split_discrs v__split_fields10)) 2))) (ite (= (attr__tag temp___686) (attr__tag temp___687)) (us_dispatch_eq temp___686 temp___687) false))) true)))
(check-sat)
(exit)
