...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 5)) (= temp___156 j1)))
(assert (=> (and (<= 1 j1) (<= j1 5)) (and (and (<= 1 u) (<= u 20)) (and (<= 1 v) (<= v 20)))))
(assert (=> (and (<= 1 j1) (<= j1 5)) (and (=> (<= 1 5) (in_range2 j2)) (and (<= 1 j2) (<= j2 5)))))
(assert (=> (and (<= 1 j1) (<= j1 5)) (= j2 5)))
(assert (=> (and (<= 1 j1) (<= j1 5)) (= j2 j3)))
(assert (=> (and (<= 1 j1) (<= j1 5)) (= j4 j2)))
(assert (=> (and (<= 1 j1) (<= j1 5)) (= (mk_int__ref j5) (mk_int__ref j3))))
