...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p__r__fa map1)))))
(define-fun us_split_fields_FA__projection ((a us_split_fields)) map1 (rec__p__r__fa a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (= (bool_eq (rec__p__r__fa (us_split_fields1 a)) 1 10 2 11 (rec__p__r__fa (us_split_fields1 b)) 1 10 2 11) true) true false))
...
(declare-const p__r__fa__first__bit Int)
(declare-const p__r__fa__last__bit Int)
(declare-const p__r__fa__position Int)
