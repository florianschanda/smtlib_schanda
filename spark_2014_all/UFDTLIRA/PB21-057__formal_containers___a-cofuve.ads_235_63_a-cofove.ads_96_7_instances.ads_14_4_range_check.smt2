...
(define-fun dynamic_invariant ((temp___expr_732 Int) (temp___is_init_729 Bool) (temp___skip_constant_730 Bool) (temp___do_toplevel_731 Bool)) Bool (=> (or (= temp___is_init_729 true) (<= 1 1000)) (in_range2 temp___expr_732)))
...
(define-fun dynamic_invariant1 ((temp___expr_744 Int) (temp___is_init_741 Bool) (temp___skip_constant_742 Bool) (temp___do_toplevel_743 Bool)) Bool (=> (or (= temp___is_init_741 true) (<= 0 1000)) (in_range3 temp___expr_744)))
...
(define-fun default_initial_assumption ((temp___expr_751 us_rep) (temp___skip_top_level_752 Bool)) Bool (=> (not (= temp___skip_top_level_752 true)) (= (length temp___expr_751) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_738 Int) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool)) Bool (=> (or (= temp___is_init_735 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_738)))
