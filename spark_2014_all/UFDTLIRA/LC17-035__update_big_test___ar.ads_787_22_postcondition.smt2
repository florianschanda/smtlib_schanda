...
(declare-const temp___6667 et3)
(declare-const temp___66671 et1)
(declare-const temp___66672 et2)
(declare-const temp___66673 enum1ta)
...
(declare-const temp___6670 et3)
(declare-const temp___66701 et1)
(declare-const temp___66702 et2)
(declare-const temp___66703 enum1ta)
...
(assert (= temp___6667 o5))
(assert (= temp___66671 o6))
(assert (= temp___66672 o7))
(assert (= temp___66673 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6667 (mk___rep (mk___split_fields temp___66671 temp___66672)) temp___66673)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6670 o14))
(assert (= temp___66701 o15))
(assert (= temp___66702 o16))
(assert (= temp___66703 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6670 (mk___rep (mk___split_fields temp___66701 temp___66702)) temp___66703)))
