...
(declare-const temp___6726 et3)
(declare-const temp___67261 et1)
(declare-const temp___67262 et2)
(declare-const temp___67263 enum1ta)
...
(declare-const temp___6729 et3)
(declare-const temp___67291 et1)
(declare-const temp___67292 et2)
(declare-const temp___67293 enum1ta)
...
(assert (= temp___6726 o5))
(assert (= temp___67261 o6))
(assert (= temp___67262 o7))
(assert (= temp___67263 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6726 (mk___rep (mk___split_fields temp___67261 temp___67262)) temp___67263)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6729 o14))
(assert (= temp___67291 o15))
(assert (= temp___67292 o16))
(assert (= temp___67293 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6729 (mk___rep (mk___split_fields temp___67291 temp___67292)) temp___67293)))
