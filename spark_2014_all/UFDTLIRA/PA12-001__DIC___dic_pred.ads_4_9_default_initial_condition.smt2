...
(define-fun dynamic_invariant ((temp___expr_135 us_rep) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (= temp___do_toplevel_134 true) (=> (= temp___is_init_132 true) (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___expr_135))))))))
(define-fun default_initial_assumption ((temp___expr_137 us_rep) (temp___skip_top_level_138 Bool)) Bool (and (= (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___expr_137))) 0) (=> (not (= temp___skip_top_level_138 true)) (< 0 (get temp___expr_137)))))
(define-fun dynamic_predicate ((temp___140 us_rep)) Bool (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___140))))))
...
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant1 (get x) true false true)) :pattern ((get x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant x true true true) (= (get x) (id (to_rep (rec__dic_pred__t__f (us_split_fields1 x)))))) :pattern ((get x)))))
...
(assert (not (< 0 (get (mk___rep (mk___split_fields temp___152))))))
(check-sat)
(exit)
