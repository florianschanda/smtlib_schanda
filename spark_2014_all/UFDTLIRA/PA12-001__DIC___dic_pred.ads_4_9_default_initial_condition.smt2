...
(define-fun dynamic_invariant1 ((temp___expr_158 us_rep) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (= temp___do_toplevel_156 true) (=> (= temp___is_init_154 true) (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___expr_158))))))))
(define-fun default_initial_assumption ((temp___expr_160 us_rep) (temp___skip_top_level_161 Bool)) Bool (and (= (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___expr_160))) 0) (=> (not (= temp___skip_top_level_161 true)) (< 0 (get temp___expr_160)))))
(define-fun dynamic_predicate ((temp___163 us_rep)) Bool (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___163))))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant (get x) true false true true)) :pattern ((get x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant1 x true true true true) (= (get x) (id (to_rep (rec__dic_pred__t__f (us_split_fields1 x)))))) :pattern ((get x)))))
...
(declare-const temp___174 natural)
(declare-const temp___176 natural)
(assert (= (to_rep temp___174) 0))
(assert (< 0 (id (to_rep temp___174))))
(assert (and (< 0 (id (to_rep temp___176))) (= (to_rep temp___176) 0)))
(assert (not (< 0 (get (mk___rep (mk___split_fields temp___176))))))
(check-sat)
(exit)
