...
(declare-const temp___331 Bool)
(declare-const temp___3311 positive)
(assert (= (ite (rec__foo__dt__found a__split_discrs) 1 0) 1))
(assert (= (rec__foo__dt__found a__split_discrs) r42b))
(assert (= (to_rep o) 1))
(assert (= o o1))
(assert (= (distinct 1 0) temp___331))
(assert (= temp___3311 o1))
(assert (not (= temp___331 (rec__foo__dt__found a__split_discrs))))
(check-sat)
(exit)
