...
(assert (forall ((x my_range)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x my_range)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep (rec__types__rec__s1 (us_split_fields1 a))) (to_rep (rec__types__rec__s1 (us_split_fields1 b)))) (= (to_rep2 (rec__types__rec__s2 (us_split_fields1 a))) (to_rep2 (rec__types__rec__s2 (us_split_fields1 b))))) (= (to_rep1 (rec__types__rec__s3 (us_split_fields1 a))) (to_rep1 (rec__types__rec__s3 (us_split_fields1 b))))) (= (to_rep (rec__types__rec__s4 (us_split_fields1 a))) (to_rep (rec__types__rec__s4 (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_185 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 1 10)) (in_range1 temp___expr_185)))
...
(declare-const o4 my_range)
(declare-const o5 integer)
(declare-const temp___230 integer)
(declare-const temp___2301 natural)
(declare-const temp___2302 my_range)
(declare-const temp___2303 integer)
(declare-const o6 Int)
(declare-const o7 my_range)
(declare-const o8 integer)
(declare-const o9 natural)
(declare-const o10 my_range)
(declare-const o11 integer)
(declare-const temp___232 integer)
(declare-const temp___2321 natural)
(declare-const temp___2322 my_range)
(declare-const temp___2323 integer)
...
(assert (not (in_range (+ (to_rep r__split_fields) 1))))
(check-sat)
(exit)
