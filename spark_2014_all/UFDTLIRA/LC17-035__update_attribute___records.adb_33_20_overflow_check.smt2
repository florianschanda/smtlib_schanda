...
(assert (forall ((i my_range)) (and (<= 1 (my_rangeqtint i)) (<= (my_rangeqtint i) 10))))
...
(define-fun to_rep1 ((x my_range)) Int (my_rangeqtint x))
...
(define-fun dynamic_invariant2 ((temp___expr_213 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 10)) (in_range1 temp___expr_213)))
