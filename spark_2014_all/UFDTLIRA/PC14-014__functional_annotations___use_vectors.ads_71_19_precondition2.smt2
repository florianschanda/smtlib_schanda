...
(assert (and (= o9 (last1 (model__ v))) (and (dynamic_property3 first2 last4 o9) (= o9 (last1 (model__ v))))))
(assert (= o10 (ite (<= use_vectors__my_find__result13 o9) true false)))
(assert (= result6 (ite (<= first3 use_vectors__my_find__result13) o10 false)))
(assert (=> (= result6 true) (and (= us2 use_vectors__my_find__result13) (dynamic_property2 first1 last3 use_vectors__my_find__result13))))
(assert (=> (= result6 true) (= o7 use_vectors__my_find__result13)))
(assert (=> (= result6 true) (and (= o8 (get (model__ v) o7)) (and (in_range3 o8) (= o8 (get (model__ v) o7))))))
(assert (=> (= result6 true) (= result5 (ite (= o8 e) true false))))
