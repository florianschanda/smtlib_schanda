...
(assert (<= 1 i4))
(assert (<= i4 b))
(assert (and (= o1 r1) (not (= r1 2147483647))))
(assert (= o2 (+ o1 1)))
(assert (= r1 result2))
(assert (= r2 o2))
(assert (= r3 (+ a i5)))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r3)) (=> (<= 1 b) (dynamic_property 1 b i5))) (and (<= 1 i5) (<= i5 b))))
(assert (not (= i5 b)))
(assert (= i5 result3))
(assert (= i6 (+ i5 1)))
(assert (and (= o4 r3) (not (= r3 2147483647))))
(assert (= o5 (+ o4 1)))
(assert (= result4 r3))
(assert (= r4 o5))
(assert (not (= r4 (+ a i6))))
