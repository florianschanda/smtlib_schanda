...
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (and (and (and (and (and (and (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (+ (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1)) (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o29) true)) (= (bool_eq (get (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o29)) o29) true)) (= (ole (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (model__ (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) o29) true)) (= (range_equal (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) 1 (- (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o29) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o29) (length (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields))) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) (find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__2__container__fields)) o29) 1) true)))
...
(assert (= o16 o14))
(assert (= o17 o15))
(assert (and (and (and (and (= (contains (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) o27) true) (= (has_key (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) true)) (= (equivalent_elements (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) o27) true)) (= (e_is_find (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) o27 (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3))) true)) (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields2)) o27) true) (and (and (and (not (= b true)) (= (oeq2 (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq3 (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (elements (mk___rep1 l__split_discrs l__split_fields2))) true)) (= (oeq4 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (positions (mk___rep1 l__split_discrs l__split_fields2))) true)) (and (and (and (and (and (and (and (= b true) (= (length (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (+ (length (mk___rep1 l__split_discrs l__split_fields2)) 1))) (= (bool_eq (element (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields) (mk___rep2 c__split_fields3)) o27) true)) (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields2)) (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields))) true)) (= (included_except (model__ (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (model__ (mk___rep1 l__split_discrs l__split_fields2)) o27) true)) (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) 1 (- (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1)) true)) (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields2)) (elements (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) (length (mk___rep1 l__split_discrs l__split_fields2)) 1) true)) (= (p_positions_shifted (positions (mk___rep1 l__split_discrs l__split_fields2)) (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (get1 (positions (mk___rep1 l__split_discrs my_ordered_sets__n__insert__container__fields)) (mk___rep2 c__split_fields3)) 1) true)))))
...
(assert (not (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields4)) o26) true)))
(check-sat)
(exit)
