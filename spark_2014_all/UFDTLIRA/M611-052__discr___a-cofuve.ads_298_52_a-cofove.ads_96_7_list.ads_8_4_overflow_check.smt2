...
(define-fun dynamic_invariant ((temp___expr_324 Int) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool) (temp___do_typ_inv_323 Bool)) Bool (=> (or (= temp___is_init_320 true) (<= 1 100)) (in_range1 temp___expr_324)))
...
(define-fun dynamic_invariant1 ((temp___expr_331 Int) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool (=> (or (= temp___is_init_327 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_331)))
...
(define-fun dynamic_invariant3 ((temp___expr_338 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool) (temp___do_typ_inv_337 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 0 100)) (in_range5 temp___expr_338)))
