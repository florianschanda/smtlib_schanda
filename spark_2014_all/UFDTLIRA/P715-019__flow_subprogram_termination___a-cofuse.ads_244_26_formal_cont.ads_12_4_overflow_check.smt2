...
(define-fun default_initial_assumption ((temp___expr_154 us_rep) (temp___skip_top_level_155 Bool)) Bool (=> (not (= temp___skip_top_level_155 true)) (= (is_empty temp___expr_154) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_147)))
(declare-const o Int)
