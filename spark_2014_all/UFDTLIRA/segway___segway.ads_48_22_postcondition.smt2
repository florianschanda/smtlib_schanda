...
(assert (=> (not (= status 0)) (and (and (= temp___157 status) (and (= temp___156 speed) (and (= (speed_is_valid speed2 status2) true) (and (and (and (in_range2 speed2) (in_range1 status2)) (not (= status2 0))) (and (ite (< 0 speed2) (and (= (speed_is_valid speed3 status3) true) (and (in_range2 speed3) (in_range1 status3))) (and (and (= (speed_is_valid speed4 status4) true) (and (in_range2 speed4) (in_range1 status4))) (and (= status3 status4) (= speed3 speed4)))) (= status3 0)))))) (and (and (= status3 status7) (= speed3 speed7)) (and (= status8 status3) (= speed8 speed3))))))
(assert (=> (not (= status 0)) (= (mk_int__ref status9) (mk_int__ref status7))))
(assert (=> (not (= status 0)) (= (mk_int__ref speed9) (mk_int__ref speed7))))
(assert (=> (not (= status 0)) (= status10 status8)))
(assert (=> (not (= status 0)) (= speed10 speed8)))
(assert (=> (= status 0) (= (mk_int__ref status9) (mk_int__ref status))))
(assert (=> (= status 0) (= (mk_int__ref speed9) (mk_int__ref speed))))
(assert (=> (= status 0) (= status10 status1)))
(assert (=> (= status 0) (= speed10 speed1)))
(assert (= (mk_int__ref status11) (mk_int__ref status9)))
(assert (= (mk_int__ref speed11) (mk_int__ref speed9)))
(assert (= status12 status10))
(assert (= speed12 speed10))
(assert (not (= (speed_is_valid speed11 status11) true)))
(check-sat)
(exit)
