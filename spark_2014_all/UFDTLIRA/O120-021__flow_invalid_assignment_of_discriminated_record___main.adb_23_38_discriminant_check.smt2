...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__main__variant_type__discr (us_split_discrs1 a))) (to_rep1 (rec__main__variant_type__discr (us_split_discrs1 b)))) (and (= (to_rep (rec__main__variant_type__common (us_split_fields1 a))) (to_rep (rec__main__variant_type__common (us_split_fields1 b)))) (=> (main__variant_type__b_only__pred a) (= (to_rep (rec__main__variant_type__b_only (us_split_fields1 a))) (to_rep (rec__main__variant_type__b_only (us_split_fields1 b))))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_209 us_rep) (temp___skip_top_level_210 Bool)) Bool (and (= (attr__constrained temp___expr_209) false) (= (to_rep1 (rec__main__variant_type__discr (us_split_discrs1 temp___expr_209))) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_220 us_rep) (temp___skip_top_level_221 Bool)) Bool (and (= (attr__constrained temp___expr_220) true) (= (to_rep1 (rec__main__variant_type__discr (us_split_discrs1 temp___expr_220))) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_231 us_rep) (temp___skip_top_level_232 Bool)) Bool (and (= (attr__constrained temp___expr_231) true) (= (to_rep1 (rec__main__variant_type__discr (us_split_discrs1 temp___expr_231))) 1)))
...
(assert (= o24 o25))
(assert (= (mk___rep (mk___split_discrs main__u1__assume) (mk___split_fields main__u1__assume1 main__u1__assume2) main__u1__assume3) o24))
...
(assert (= o23 o22))
(assert (not (= 1 (to_rep1 (rec__main__variant_type__discr (us_split_discrs1 o23))))))
(check-sat)
(exit)
