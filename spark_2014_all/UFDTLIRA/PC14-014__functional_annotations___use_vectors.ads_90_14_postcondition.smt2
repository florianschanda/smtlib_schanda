...
(assert (<= first4 j))
(assert (<= j (- i 1)))
(assert (not (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) j))))
(check-sat)
(exit)
