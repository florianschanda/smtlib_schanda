...
(define-fun tc_pu1S__ref___4__projection ((a tc_pu1S__ref)) us_rep1 (tc_pu1S__content a))
(define-fun dynamic_invariant1 ((temp___expr_229 us_rep1) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (not (= temp___skip_constant_227 true)) (in_range2 0 (to_base temp___expr_229))))
(define-fun default_initial_assumption ((temp___expr_231 us_rep1) (temp___skip_top_level_232 Bool)) Bool (and (= (attr__tag1 temp___expr_231) us_tag3) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_231))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_231))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_231))) 0))))
...
(declare-const record_equality__test_eq_ko_d2__g_pu1__assume natural)
(declare-const record_equality__test_eq_ko_d2__g_pu1__assume1 natural)
(declare-const record_equality__test_eq_ko_d2__g_pu1__assume2 natural)
(declare-const record_equality__test_eq_ko_d2__g_pu1__assume3 natural)
(declare-const record_equality__test_eq_ko_d2__g_pu1__assume4 us_private)
(declare-const record_equality__test_eq_ko_d2__g_pu1__assume5 Int)
...
(declare-const record_equality__test_eq_ko_d2__g_pu2__assume natural)
(declare-const record_equality__test_eq_ko_d2__g_pu2__assume1 natural)
(declare-const record_equality__test_eq_ko_d2__g_pu2__assume2 natural)
(declare-const record_equality__test_eq_ko_d2__g_pu2__assume3 natural)
(declare-const record_equality__test_eq_ko_d2__g_pu2__assume4 us_private)
(declare-const record_equality__test_eq_ko_d2__g_pu2__assume5 Int)
...
(assert (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r10b))
...
(assert (= c_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ko_d2__g_pu1__assume)))
...
(assert (= record_equality__test_eq_ko_d2__g_pu1__assume1 g_pu1__split_fields4))
(assert (= record_equality__test_eq_ko_d2__g_pu1__assume2 g_pu1__split_fields5))
(assert (= record_equality__test_eq_ko_d2__g_pu1__assume3 g_pu1__split_fields6))
(assert (= record_equality__test_eq_ko_d2__g_pu1__assume4 g_pu1__split_fields7))
(assert (= g_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ko_d2__g_pu1__assume)))
(assert (= g_pu1__attr__tag us_tag2))
(assert (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r12b))
...
(assert (= c_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ko_d2__g_pu2__assume)))
...
(assert (= record_equality__test_eq_ko_d2__g_pu2__assume1 g_pu2__split_fields4))
(assert (= record_equality__test_eq_ko_d2__g_pu2__assume2 g_pu2__split_fields5))
(assert (= record_equality__test_eq_ko_d2__g_pu2__assume3 g_pu2__split_fields6))
(assert (= record_equality__test_eq_ko_d2__g_pu2__assume4 g_pu2__split_fields7))
(assert (= g_pu2__split_discrs (mk___split_discrs record_equality__test_eq_ko_d2__g_pu2__assume)))
(assert (= g_pu2__attr__tag us_tag2))
(assert (not (= (ite (= g_pu1__attr__tag g_pu2__attr__tag) (us_dispatch_eq (mk___rep g_pu1__split_discrs (mk___split_fields g_pu1__split_fields5 (hide_ext__1 g_pu1__split_fields4 g_pu1__split_fields6 g_pu1__split_fields7)) g_pu1__attr__tag) (mk___rep g_pu2__split_discrs (mk___split_fields g_pu2__split_fields5 (hide_ext__1 g_pu2__split_fields4 g_pu2__split_fields6 g_pu2__split_fields7)) g_pu2__attr__tag)) false) true)))
(check-sat)
(exit)
