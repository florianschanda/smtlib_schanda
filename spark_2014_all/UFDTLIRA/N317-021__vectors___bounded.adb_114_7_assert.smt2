...
(assert (= v__split_fields13 bounded__vect__clear__container__fields1))
...
(assert (and (and (= (length (mk___rep v__split_discrs bounded__vect__replace_element__container__fields1)) (length (mk___rep v__split_discrs v__split_fields10))) (= (get (model__ (mk___rep v__split_discrs bounded__vect__replace_element__container__fields1)) 1) o2)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields10)) (model__ (mk___rep v__split_discrs bounded__vect__replace_element__container__fields1)) 1) true)))
(assert (= result11 (mk___split_fields__ref v__split_fields10)))
(assert (= v__split_fields11 bounded__vect__replace_element__container__fields1))
