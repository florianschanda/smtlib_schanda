...
(assert (and (= o2 (element x (mk___rep1 (mk___split_fields1 c__split_fields2)))) (and (in_range3 o2) (= o2 (get (model__ x) (get1 (positions x) (mk___rep1 (mk___split_fields1 c__split_fields2))))))))
(assert (= o3 (+ sum2 o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= result2 sum2))
(assert (= sum3 o4))
(assert (not (or (= (has_key (positions x) (mk___rep1 (mk___split_fields1 c__split_fields2))) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 c__split_fields2)) no_element) true))))
(check-sat)
(exit)
