...
(declare-const temp___1029 read_status)
(declare-const temp___10291 character)
(declare-const temp___10292 Bool)
(declare-const temp___1028 Int)
(declare-const temp___1027 Int)
(declare-const temp___1026 Int)
(declare-const temp___1032 Int)
(declare-const temp___1025 read_status)
(declare-const temp___10251 character)
(declare-const temp___10252 Bool)
...
(declare-const temp___10342 Int)
(declare-const result2 int__ref)
(declare-const temp___10332 Int)
...
(assert (=> (= result true) (= temp___1031 next_idx)))
(assert (=> (= result true) (= temp___1030 the_file)))
(assert (=> (= result true) (and (= temp___1029 next_read__split_discrs) (and (= temp___10291 next_read__split_fields) (= temp___10292 next_read__attr__constrained)))))
(assert (=> (= result true) (= temp___1028 current_idx)))
(assert (=> (= result true) (= temp___1027 current_col)))
(assert (=> (= result true) (= temp___1026 current_line)))
(assert (=> (= result true) (= temp___1032 current_idx)))
(assert (=> (= result true) (and (= temp___1025 current_read__split_discrs) (and (= temp___10251 current_read__split_fields) (= temp___10252 current_read__attr__constrained)))))
(assert (=> (= result true) (= 0 temp___1034)))
(assert (=> (= result true) (= 0 temp___1033)))
(assert (=> (= result true) (and (= (local_invariant the_file2 current_read__split_fields2 current_read__split_discrs2 current_idx2 next_read__split_fields2 next_read__split_discrs2 next_idx2) true) (<= temp___1032 current_idx2))))
(assert (=> (= result true) (and (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_idx2)) (in_range1 next_idx2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (let ((temp___1036 (to_rep (rec__file_io__read_result__c current_read__split_fields2)))) (or (= temp___1036 10) (or (= temp___1036 13) (or (= temp___1036 32) (= temp___1036 9)))))))))
(assert (=> (= result true) (= result1 (mk_int__ref temp___10341))))
(assert (=> (= result true) (= temp___10342 next_idx2)))
(assert (=> (= result true) (= result2 (mk_int__ref temp___10331))))
(assert (=> (= result true) (= temp___10332 (ite (ite (= (to_rep1 (rec__file_io__read_result__status next_read__split_discrs2)) 0) true false) 1 0))))
...
(assert (=> (not (= result true)) (= next_read__split_discrs6 (mk___split_discrs__ref (mk___split_discrs next_read__split_discrs)))))
(assert (=> (not (= result true)) (= next_read__split_fields6 (mk___split_fields__ref (mk___split_fields next_read__split_fields)))))
(assert (=> (not (= result true)) (= current_idx6 (mk_int__ref current_idx))))
(assert (=> (not (= result true)) (= current_col6 (mk_int__ref current_col))))
(assert (=> (not (= result true)) (= current_line6 (mk_int__ref current_line))))
(assert (=> (not (= result true)) (= current_read__split_discrs6 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs)))))
(assert (=> (not (= result true)) (= current_read__split_fields6 (mk___split_fields__ref (mk___split_fields current_read__split_fields)))))
