...
(assert (= max 100))
(declare-const temp___c_346 Int)
(declare-const temp___unused_345 Int)
(declare-const temp___c_344 Int)
(declare-const temp___unused_343 Int)
(assert (in_range max))
(assert (in_range temp___c_346))
(assert (in_range temp___unused_345))
(assert (in_range temp___c_344))
(assert (in_range temp___unused_343))
(assert (not (in_range temp___c_344)))
(check-sat)
(exit)
