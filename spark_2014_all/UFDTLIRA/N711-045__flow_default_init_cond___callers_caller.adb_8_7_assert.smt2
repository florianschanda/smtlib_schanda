...
(assert (forall ((r us_rep)) (! (dynamic_invariant (add3 r) true false true) :pattern ((add3 r)))))
(assert (forall ((r us_rep)) (! (= (add3 r) (add2 r)) :pattern ((add3 r)))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (forall ((r us_rep)) (! (dynamic_invariant (add2 r) true false true) :pattern ((add2 r)))))
