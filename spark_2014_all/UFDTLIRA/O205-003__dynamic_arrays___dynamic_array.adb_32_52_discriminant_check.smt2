...
(define-fun dynamic_invariant1 ((temp___expr_150 us_rep) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (and (=> (dynamic_array__rec__f1__pred temp___expr_150) (=> (or (= temp___is_init_147 true) (<= 0 last)) (dynamic_property 0 last (to_rep (rec__dynamic_array__rec__f1 (us_split_fields1 temp___expr_150)))))) (=> (dynamic_array__rec__f2__pred temp___expr_150) (=> (or (= temp___is_init_147 true) (<= 0 last)) (dynamic_property 0 last (to_rep (rec__dynamic_array__rec__f2 (us_split_fields1 temp___expr_150))))))))
...
(assert (not (< (to_rep (rec__dynamic_array__rec__f1 (us_split_fields1 r))) c)))
(assert (not (= (to_int1 (rec__dynamic_array__rec__b (us_split_discrs1 r))) 1)))
(check-sat)
(exit)
