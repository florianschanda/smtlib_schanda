...
(assert (and (= o5 (first (mk___rep l1__split_discrs l1__split_fields2))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields2)) 0) true) (= (bool_eq3 o5 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields2)) o5) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields2)) o5) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields2)) o5) true) (= (bool_eq3 o5 no_element) true))))
(check-sat)
(exit)
