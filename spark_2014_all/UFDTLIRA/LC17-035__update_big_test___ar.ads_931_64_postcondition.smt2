...
(assert (not (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields7))))))) (to_rep1 r__split_fields2))))
(check-sat)
(exit)
