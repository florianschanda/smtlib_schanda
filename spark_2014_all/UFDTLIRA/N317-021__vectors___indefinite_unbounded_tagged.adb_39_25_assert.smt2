...
(assert (not (= (let ((temp___598 (f 2))) (let ((temp___597 (get (model__ (mk___rep1 w__split_discrs w__split_fields1)) 2))) (ite (= (attr__tag temp___597) (attr__tag temp___598)) (us_dispatch_eq temp___597 temp___598) false))) true)))
(check-sat)
(exit)
