...
(assert (and (= o (positions s1)) (and (not (= (has_key o no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length3 s1))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq1 i j) true))))))))))
