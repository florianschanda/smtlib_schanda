...
(declare-const temp___772 us_rep1)
...
(assert (and (= o7 (length s2)) (and (in_range1 o7) (<= o7 (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o5 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range1 o5) (<= o5 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o6 (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs)) o5)))
(assert (and (= o8 o6) (in_range6 o6)))
...
(assert (and (= o2 (iter_has_element temp___776 temp___775)) (= (= o2 true) (and (<= 1 temp___775) (<= temp___775 (last temp___776))))))
(assert (= (= o3 true) (in_range3 temp___775)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (= (= o4 true) (let ((temp___778 (elements s2))) (forall ((temp___777 Int)) (=> (and (in_range3 temp___777) (= (iter_has_element temp___778 temp___777) true)) (= (prop__ (get temp___778 temp___777)) true))))))
(assert (and (= temp___772 (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (and (and (= (length1 temp___772) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element temp___772 temp___432) true)) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get temp___772 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true)) (and (< 0 (find temp___772 item)) (= (equivalent_elements (get temp___772 (find temp___772 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))) (and (= (find temp___772 (get temp___772 i)) i) (= (e_is_find temp___772 (get temp___772 i) i) true)))))))
(assert (and (= o (iter_has_element temp___772 temp___771)) (= (= o true) (and (<= 1 temp___771) (<= temp___771 (last temp___772))))))
(assert (= (= o1 true) (in_range3 temp___771)))
(assert (= result1 (ite (= o1 true) o false)))
(assert (= result1 true))
(assert (not (<= temp___771 (last temp___772))))
(check-sat)
(exit)
