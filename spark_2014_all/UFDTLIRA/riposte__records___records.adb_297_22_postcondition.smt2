...
(declare-const temp___3721 unsigned_byte)
(declare-const temp___3722 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___372 o5))
(assert (= temp___3721 o6))
(assert (= temp___3722 o7))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= result2 x__split_fields2))
(assert (= temp___372 x__split_fields3))
(assert (= temp___3721 x__split_fields4))
(assert (= temp___3722 x__split_fields5))
(assert (= x__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 x__split_fields3 (mk___rep (mk___split_fields x__split_fields4 x__split_fields5))))))
(assert (= x__split_fields7 (mk___split_fields1 x__split_fields3 (mk___rep (mk___split_fields x__split_fields4 x__split_fields5)))))
(assert (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields__content1 x__split_fields6)) true))
