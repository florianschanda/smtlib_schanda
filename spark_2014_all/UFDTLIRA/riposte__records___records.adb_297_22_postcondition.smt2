...
(declare-const temp___405 Bool)
(declare-const temp___4051 unsigned_byte)
(declare-const temp___4052 unsigned_byte)
...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___405 o5))
(assert (= temp___4051 o6))
(assert (= temp___4052 o7))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= result2 x__split_fields2))
(assert (= temp___405 x__split_fields3))
(assert (= temp___4051 x__split_fields4))
(assert (= temp___4052 x__split_fields5))
