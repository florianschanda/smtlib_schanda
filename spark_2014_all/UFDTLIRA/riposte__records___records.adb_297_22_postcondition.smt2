...
(define-fun x__split_fields8 () us_split_fields2 (mk___split_fields1 x__split_fields3 (mk___rep (mk___split_fields x__split_fields4 x__split_fields5))))
(assert (= (to_rep o) 5))
...
(assert (= x__split_fields6 (mk___split_fields__ref1 x__split_fields8)))
(assert (= x__split_fields7 x__split_fields8))
