...
(define-fun default_initial_assumption ((temp___expr_469 us_rep1) (temp___skip_top_level_470 Bool)) Bool (and (= (attr__constrained temp___expr_469) false) (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs1 temp___expr_469))) 2)))
...
(define-fun dynamic_invariant2 ((temp___expr_502 us_rep2) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool)) Bool (=> (not (= temp___skip_constant_500 true)) (in_range7 32 temp___expr_502)))
(define-fun default_initial_assumption1 ((temp___expr_504 us_rep2) (temp___skip_top_level_505 Bool)) Bool (and (= (to_rep2 (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs3 temp___expr_504))) 32) (=> (not (= temp___skip_top_level_505 true)) (= (is_empty temp___expr_504) true))))
...
(define-fun dynamic_invariant5 ((temp___expr_461 Int) (temp___is_init_458 Bool) (temp___skip_constant_459 Bool) (temp___do_toplevel_460 Bool)) Bool (=> (or (= temp___is_init_458 true) (<= 0 2)) (in_range5 temp___expr_461)))
(define-fun dynamic_invariant6 ((temp___expr_491 Int) (temp___is_init_488 Bool) (temp___skip_constant_489 Bool) (temp___do_toplevel_490 Bool)) Bool (=> (or (= temp___is_init_488 true) (<= 0 2147483647)) (in_range6 temp___expr_491)))
...
(define-fun next_read__split_discrs4 () us_split_discrs (mk___split_discrs next_read__split_discrs1))
(define-fun next_read__split_fields4 () us_split_fields (mk___split_fields next_read__split_fields1))
(define-fun current_read__split_discrs4 () us_split_discrs (mk___split_discrs current_read__split_discrs1))
(define-fun current_read__split_fields4 () us_split_fields (mk___split_fields current_read__split_fields1))
(define-fun s__split_fields4 () us_split_fields2 (mk___split_fields1 s__split_fields1))
...
(assert (= (length (mk___rep1 s__split_discrs s__split_fields4)) (+ (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields))) 1)))
(assert (and (and (and (= (local_invariant current_read__split_fields4 current_read__split_discrs4 next_read__split_fields4 next_read__split_discrs4) true) (= (bool_eq1 (mk___rep current_read__split_discrs4 current_read__split_fields4 current_read__attr__constrained) (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)) true)) (<= current_pos current_pos1)) (and (and (in_range3 current_line1) (in_range2 current_col1)) (in_range2 current_pos1))))
(assert (= s__split_fields2 (mk___split_fields__ref1 s__split_fields4)))
(assert (= next_read__split_discrs2 (mk___split_discrs__ref next_read__split_discrs4)))
(assert (= next_read__split_fields2 (mk___split_fields__ref next_read__split_fields4)))
...
(assert (= current_read__split_discrs2 (mk___split_discrs__ref current_read__split_discrs4)))
