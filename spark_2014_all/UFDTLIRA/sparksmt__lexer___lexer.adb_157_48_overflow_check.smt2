...
(assert (and (and (and (= (local_invariant current_read__split_fields4 current_read__split_discrs4 next_read__split_fields4 next_read__split_discrs4) true) (= (bool_eq (mk___rep1 current_read__split_discrs4 current_read__split_fields4 current_read__attr__constrained) (mk___rep1 (mk___split_discrs1 next_read__split_discrs) (mk___split_fields1 next_read__split_fields) next_read__attr__constrained)) true)) (<= current_pos current_pos1)) (and (and (in_range3 current_line1) (in_range2 current_col1)) (in_range2 current_pos1))))
...
(assert (not (in_range1 (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1))))
(check-sat)
(exit)
