...
(define-fun dynamic_invariant2 ((temp___expr_569 us_rep2) (temp___is_init_565 Bool) (temp___skip_constant_566 Bool) (temp___do_toplevel_567 Bool) (temp___do_typ_inv_568 Bool)) Bool (=> (not (= temp___skip_constant_566 true)) (in_range7 32 temp___expr_569)))
(define-fun default_initial_assumption1 ((temp___expr_571 us_rep2) (temp___skip_top_level_572 Bool)) Bool (and (= (to_rep2 (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs3 temp___expr_571))) 32) (=> (not (= temp___skip_top_level_572 true)) (= (length temp___expr_571) 0))))
(assert (forall ((s us_rep2)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant (length s) true false true true)) :pattern ((length s)))))
...
(define-fun dynamic_invariant5 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 2)) (in_range5 temp___expr_522)))
(define-fun dynamic_invariant6 ((temp___expr_556 Int) (temp___is_init_552 Bool) (temp___skip_constant_553 Bool) (temp___do_toplevel_554 Bool) (temp___do_typ_inv_555 Bool)) Bool (=> (or (= temp___is_init_552 true) (<= 0 2147483647)) (in_range6 temp___expr_556)))
