...
(assert (forall ((x read_status)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun in_range7 ((rec__unbounded_strings__char_vectors__vector__capacity1 Int) (a us_rep2)) Bool (= rec__unbounded_strings__char_vectors__vector__capacity1 (to_rep2 (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_496 us_rep2) (temp___is_init_493 Bool) (temp___skip_constant_494 Bool) (temp___do_toplevel_495 Bool)) Bool (=> (not (= temp___skip_constant_494 true)) (in_range7 32 temp___expr_496)))
(define-fun default_initial_assumption1 ((temp___expr_498 us_rep2) (temp___skip_top_level_499 Bool)) Bool (and (= (to_rep2 (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs3 temp___expr_498))) 32) (=> (not (= temp___skip_top_level_499 true)) (= (is_empty temp___expr_498) true))))
(declare-fun length (us_rep2) Int)
(declare-fun length__function_guard (Int us_rep2) Bool)
(assert (forall ((s us_rep2)) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant (length s) true false true)) :pattern ((length s)))))
...
(define-fun dynamic_invariant5 ((temp___expr_455 Int) (temp___is_init_452 Bool) (temp___skip_constant_453 Bool) (temp___do_toplevel_454 Bool)) Bool (=> (or (= temp___is_init_452 true) (<= 0 2)) (in_range5 temp___expr_455)))
(define-fun dynamic_invariant6 ((temp___expr_485 Int) (temp___is_init_482 Bool) (temp___skip_constant_483 Bool) (temp___do_toplevel_484 Bool)) Bool (=> (or (= temp___is_init_482 true) (<= 0 2147483647)) (in_range6 temp___expr_485)))
(define-fun capacity ((container us_rep2)) Int (ite (= (of_int 0) true) (to_rep2 (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs3 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep2) Bool)
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant6 result true false true))) :pattern ((length1 container)))))
(assert (forall ((container us_rep2)) (! (= (= (is_empty container) true) (= (length1 container) 0)) :pattern ((is_empty container)))))
...
(assert (= 32 (to_rep2 (rec__unbounded_strings__char_vectors__vector__capacity s__split_discrs))))
(assert (and (= (local_invariant (mk___split_fields current_read__split_fields) (mk___split_discrs current_read__split_discrs) (mk___split_fields next_read__split_fields) (mk___split_discrs next_read__split_discrs)) true) (= (to_rep1 current_read__split_discrs) 0)))
(assert (and (and (= (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields1))) (+ (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields))) 1)) (and (and (and (= (local_invariant (mk___split_fields current_read__split_fields1) (mk___split_discrs current_read__split_discrs1) (mk___split_fields next_read__split_fields1) (mk___split_discrs next_read__split_discrs1)) true) (= (bool_eq1 (mk___rep (mk___split_discrs current_read__split_discrs1) (mk___split_fields current_read__split_fields1) current_read__attr__constrained) (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)) true)) (<= current_pos current_pos1)) (and (and (in_range3 current_line1) (in_range2 current_col1)) (in_range2 current_pos1)))) (and (and (= s__split_fields2 (mk___split_fields__ref1 (mk___split_fields1 s__split_fields1))) (and (= next_read__split_discrs2 (mk___split_discrs__ref (mk___split_discrs next_read__split_discrs1))) (and (= next_read__split_fields2 (mk___split_fields__ref (mk___split_fields next_read__split_fields1))) (and (= current_pos2 (mk_int__ref current_pos1)) (and (= current_col2 (mk_int__ref current_col1)) (and (= current_line2 (mk_int__ref current_line1)) (and (= current_read__split_discrs2 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs1))) (and (= current_read__split_fields2 current_read__split_fields1) (= the_file the_file1))))))))) (and (= s__split_fields3 (mk___split_fields1 s__split_fields1)) (and (= next_read__split_discrs3 (mk___split_discrs next_read__split_discrs1)) (and (= next_read__split_fields3 (mk___split_fields next_read__split_fields1)) (and (= current_pos3 current_pos1) (and (= current_col3 current_col1) (and (= current_line3 current_line1) (and (= current_read__split_discrs3 (mk___split_discrs current_read__split_discrs1)) (and (= current_read__split_fields3 (mk___split_fields current_read__split_fields1)) (= the_file2 the_file))))))))))))
(assert (not (in_range1 (+ (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields))) 1))))
(check-sat)
(exit)
