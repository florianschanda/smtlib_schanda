...
(define-fun default_initial_assumption1 ((temp___expr_498 us_rep2) (temp___skip_top_level_499 Bool)) Bool (and (= (to_rep2 (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs3 temp___expr_498))) 32) (=> (not (= temp___skip_top_level_499 true)) (= (length temp___expr_498) 0))))
