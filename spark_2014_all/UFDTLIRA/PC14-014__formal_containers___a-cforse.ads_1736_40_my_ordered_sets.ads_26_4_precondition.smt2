...
(define-fun dynamic_invariant2 ((temp___expr_753 Int) (temp___is_init_750 Bool) (temp___skip_constant_751 Bool) (temp___do_toplevel_752 Bool)) Bool (=> (or (= temp___is_init_750 true) (<= 1 2147483647)) (in_range5 temp___expr_753)))
...
(define-fun e_smaller_than_range ((container1 us_rep2) (fst Int) (lst Int) (item us_rep)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_lt item (get container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep2 Int Int us_rep) Bool)
(define-fun e_is_find ((container1 us_rep2) (item us_rep) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (of_int 1)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item) (of_int 1))))
...
(assert (forall ((container1 us_rep2)) (forall ((item us_rep)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant result true false true))) :pattern ((find container1 item))))))
...
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((item us_rep)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep)) (and (= (contains container1 e) true) (= (equivalent_elements e item) true))) (= (contains container1 item) true))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep3)) (! (dynamic_invariant (length3 container1) true false true) :pattern ((length3 container1)))))
(assert (forall ((container1 us_rep3)) (! (let ((result (is_empty2 container1))) (and (= (= result true) (forall ((item us_rep)) (not (= (contains container1 item) true)))) (= (= result true) (= (length3 container1) 0)))) :pattern ((is_empty2 container1)))))
