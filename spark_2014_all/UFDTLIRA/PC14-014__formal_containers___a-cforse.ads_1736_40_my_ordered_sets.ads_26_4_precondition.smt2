...
(define-fun dynamic_invariant2 ((temp___expr_811 Int) (temp___is_init_807 Bool) (temp___skip_constant_808 Bool) (temp___do_toplevel_809 Bool) (temp___do_typ_inv_810 Bool)) Bool (=> (or (= temp___is_init_807 true) (<= 1 2147483647)) (in_range5 temp___expr_811)))
...
(define-fun e_is_find ((container1 us_rep2) (item us_rep) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item) (distinct 1 0))))
...
(assert (forall ((container1 us_rep2)) (forall ((item us_rep)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item))))))
...
(assert true)
(assert (forall ((container1 us_rep3)) (forall ((item us_rep)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep)) (and (= (contains container1 e) true) (= (equivalent_elements e item) true))) (= (contains container1 item) true))) :pattern ((contains container1 item))))))
