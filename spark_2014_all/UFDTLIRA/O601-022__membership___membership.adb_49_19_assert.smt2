...
(define-fun default_initial_assumption ((temp___expr_182 us_rep) (temp___skip_top_level_183 Bool)) Bool (= (attr__tag temp___expr_182) us_tag1))
...
(define-fun default_initial_assumption1 ((temp___expr_192 us_rep) (temp___skip_top_level_193 Bool)) Bool (= (attr__tag temp___expr_192) us_tag2))
(declare-const c__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const g__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption2 ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (= (attr__tag temp___expr_172) us_tag))
(assert (= c__attr__tag us_tag1))
(assert (= g__attr__tag us_tag2))
(assert (= c__attr__tag us_tag1))
(assert (= g__attr__tag us_tag2))
(assert (not (or (= c__attr__tag us_tag) (or (= c__attr__tag us_tag1) (= c__attr__tag us_tag2)))))
(check-sat)
(exit)
