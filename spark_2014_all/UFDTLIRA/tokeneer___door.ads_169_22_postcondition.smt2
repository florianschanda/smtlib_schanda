...
(declare-const dooralarm1 int__ref)
(declare-const alarmtimeout__split_fields us_split_fields__ref)
(declare-const state us_private__ref)
(assert (in_range7 currentdoor))
(assert (in_range1 dooralarm))
(assert (and (= (and (and (= currentdoor 0) (= (islocked (us_private__content state)) true)) (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep (us_split_fields__content alarmtimeout__split_fields))) true)) (= (int__content dooralarm1) 0)) (= (= (islocked (us_private__content state)) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout (us_private__content state))) true))))
(assert (in_range1 (int__content dooralarm1)))
(assert (= (islocked (us_private__content state)) true))
(assert (= (thecurrentdoor currentdoor) 0))
(assert (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout (us_split_fields__content alarmtimeout__split_fields))) true))
(assert (not (= (thedooralarm (int__content dooralarm1)) 0)))
(check-sat)
(exit)
