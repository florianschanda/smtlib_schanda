...
(declare-const temp___273 Bool)
(declare-const temp___2731 natural)
(declare-const temp___2732 Bool)
(declare-const o2 natural)
(declare-const o3 natural)
(declare-const temp___269 Bool)
(declare-const temp___2691 natural)
(declare-const temp___2692 Bool)
...
(declare-const temp___2712 Bool)
...
(assert (=> (= r__split_discrs true) (= r__split_discrs temp___273)))
(assert (=> (= r__split_discrs true) (= temp___2731 o1)))
(assert (=> (= r__split_discrs true) (= r__attr__constrained temp___2732)))
(assert (=> (= r__split_discrs true) (= (mk___split_fields__ref (mk___split_fields result)) r__split_fields6)))
(assert (=> (= r__split_discrs true) (= r__split_fields2 (mk___split_fields temp___2731))))
(assert (=> (= r__split_discrs true) (= result1 r__split_discrs6)))
(assert (=> (= r__split_discrs true) (= r__split_discrs2 (mk___split_discrs temp___273))))
...
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= (distinct 1 0) temp___269))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= temp___2691 o3))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= true temp___2692))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (=> (= r__attr__constrained true) (= temp___269 r__split_discrs)))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1) usq_2) (mk___rep (mk___split_discrs temp___269) (mk___split_fields temp___2691) temp___2692)))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= usq_ temp___271))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= usq_1 temp___2711))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= r__attr__constrained temp___2712))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= result2 r__split_fields6))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= r__split_fields3 (mk___split_fields temp___2711)))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= result3 r__split_discrs6))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= r__split_discrs3 (mk___split_discrs temp___271)))))
...
(assert (not (= (to_rep (rec__split_records__record_with_mutable_discrs__field (us_split_fields__content r__split_fields4))) new_field)))
(check-sat)
(exit)
