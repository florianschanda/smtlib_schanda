...
(assert (=> (= r__split_discrs true) (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields r__split_fields)))))
(assert (=> (= r__split_discrs true) (= r__split_fields2 (mk___split_fields temp___2411))))
(assert (=> (= r__split_discrs true) (= result1 (mk___split_discrs__ref (mk___split_discrs r__split_discrs)))))
...
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= result2 (mk___split_fields__ref (mk___split_fields r__split_fields))))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= r__split_fields3 (mk___split_fields temp___2391)))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= result3 (mk___split_discrs__ref (mk___split_discrs r__split_discrs))))))
(assert (=> (not (= r__split_discrs true)) (=> (not (= r__attr__constrained true)) (= r__split_discrs3 (mk___split_discrs temp___239)))))
(assert (=> (not (= r__split_discrs true)) (=> (= r__attr__constrained true) (= r__split_discrs3 (mk___split_discrs r__split_discrs)))))
(assert (=> (not (= r__split_discrs true)) (=> (= r__attr__constrained true) (= r__split_fields3 (mk___split_fields r__split_fields)))))
(assert (=> (not (= r__split_discrs true)) (=> (= r__attr__constrained true) (= r__split_discrs3 (mk___split_discrs r__split_discrs1)))))
(assert (=> (not (= r__split_discrs true)) (=> (= r__attr__constrained true) (= r__split_fields3 (mk___split_fields r__split_fields1)))))
