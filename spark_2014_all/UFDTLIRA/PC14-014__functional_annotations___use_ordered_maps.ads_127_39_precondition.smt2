...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant6 key2 true true true true) (= (has_key container key2) true)) (let ((result (get1 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant7 result true false true true)))) :pattern ((get1 container key2))))))
...
(assert (and (= o (has_key1 (positions s) cu1)) (= (= o true) (= (has_key1 (positions s) cu1) true))))
(assert (= o1 true))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (= (has_key1 (positions s) cu1) true)))
(check-sat)
(exit)
