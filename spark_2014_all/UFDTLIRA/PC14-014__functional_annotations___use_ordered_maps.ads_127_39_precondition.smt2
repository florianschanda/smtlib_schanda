...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (q (get1 (model__ s) (get (keys s) i1))) true))))
(assert (and (= o5 (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu)))) (= (= o5 true) (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu))) true))))
(assert (= o6 true))
(assert (= result1 (ite (= o6 true) o5 false)))
(assert (= result1 true))
(assert (not (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu))) true)))
(check-sat)
(exit)
