...
(assert (and (= o (capacity (mk___rep1 container__split_discrs (mk___split_fields1 container__split_fields)))) (and (in_range5 o) (= o (ite (= (of_int 0) true) (to_rep1 (rec__indefinite_unbounded_tagged__vect__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
