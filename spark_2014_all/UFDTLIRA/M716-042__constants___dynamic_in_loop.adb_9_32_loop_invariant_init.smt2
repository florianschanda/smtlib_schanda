...
(define-fun dynamic_invariant1 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool) (dynamic_in_loop__B_2__c Int)) Bool (=> (or (= temp___is_init_132 true) (<= 1 (last dynamic_in_loop__B_2__c))) (dynamic_property 1 (last dynamic_in_loop__B_2__c) temp___expr_135)))
