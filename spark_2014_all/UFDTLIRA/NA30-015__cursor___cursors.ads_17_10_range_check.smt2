...
(define-fun cursors__r__c__pred ((a us_rep1)) Bool (= (ite (rec__cursors__r__b (us_split_discrs1 a)) 1 0) 1))
...
(define-fun dynamic_invariant ((temp___expr_404 us_rep1) (temp___is_init_400 Bool) (temp___skip_constant_401 Bool) (temp___do_toplevel_402 Bool) (temp___do_typ_inv_403 Bool)) Bool (=> (not (= temp___skip_constant_401 true)) (in_range2 (distinct 0 0) temp___expr_404)))
(define-fun default_initial_assumption ((temp___expr_406 us_rep1) (temp___skip_top_level_407 Bool)) Bool (and (= (rec__cursors__r__b (us_split_discrs1 temp___expr_406)) (distinct 0 0)) (=> (cursors__r__c__pred temp___expr_406) (= (to_rep (rec__cursors__l__cursor__node (us_split_fields1 (rec__cursors__r__c (us_split_fields3 temp___expr_406))))) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_228 us_rep) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__cursors__l__cursor__node (us_split_fields1 temp___expr_228))) 0))
