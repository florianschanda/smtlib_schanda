...
(define-fun v__split_fields13 () us_split_fields (mk___split_fields v__split_fields1))
...
(assert (= v__split_fields13 indefinite_bounded__vect__clear__container__fields1))
(assert (= (is_empty (mk___rep v__split_discrs v__split_fields13)) true))
(assert (= (oeq (mk___rep v__split_discrs v__split_fields13) (empty_vector Tuple0)) true))
(assert (= (capacity (mk___rep v__split_discrs v__split_fields13)) 5))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded__vect__append__2__container__fields4)) (+ (length (mk___rep v__split_discrs v__split_fields13)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields13)) (model__ (mk___rep v__split_discrs indefinite_bounded__vect__append__2__container__fields4))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_bounded__vect__append__2__container__fields4)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields13))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= v__split_fields12 indefinite_bounded__vect__append__2__container__fields4))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded__vect__append__2__container__fields3)) (+ (length (mk___rep v__split_discrs v__split_fields12)) 1)) (= (olt (model__ (mk___rep v__split_discrs v__split_fields12)) (model__ (mk___rep v__split_discrs indefinite_bounded__vect__append__2__container__fields3))) true)) (= (get (model__ (mk___rep v__split_discrs indefinite_bounded__vect__append__2__container__fields3)) (+ (last (model__ (mk___rep v__split_discrs v__split_fields12))) 1)) 2)))
...
(assert (not (not (= (capacity (mk___rep v__split_discrs v__split_fields11)) 5))))
(check-sat)
(exit)
