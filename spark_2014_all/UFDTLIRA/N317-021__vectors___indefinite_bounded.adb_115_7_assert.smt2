...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__indefinite_bounded__vect__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun default_initial_assumption ((temp___expr_335 us_rep) (temp___skip_top_level_336 Bool)) Bool (and (= (to_rep (rec__indefinite_bounded__vect__vector__capacity (us_split_discrs1 temp___expr_335))) 5) (=> (not (= temp___skip_top_level_336 true)) (= (is_empty temp___expr_335) true))))
...
(declare-const indefinite_bounded__vect__reverse_elements__container__fields us_split_fields)
(declare-const result9 us_split_fields__ref)
(declare-const v__split_fields9 us_split_fields)
(declare-const indefinite_bounded__sort__sort__container__fields us_split_fields)
(declare-const result10 us_split_fields__ref)
(declare-const v__split_fields10 us_split_fields)
(declare-const indefinite_bounded__vect__replace_element__container__fields1 us_split_fields)
...
(assert (= (length (mk___rep v__split_discrs (mk___split_fields indefinite_bounded__vect__clear__container__fields))) 0))
(assert (= result v__split_fields))
(assert (= (mk___split_fields v__split_fields1) (mk___split_fields indefinite_bounded__vect__clear__container__fields)))
...
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields indefinite_bounded__vect__append__2__container__fields))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1))) (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_bounded__vect__append__2__container__fields)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_bounded__vect__append__2__container__fields))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields1)))) 1)) 1)))
(assert (= result1 v__split_fields1))
(assert (= (mk___split_fields v__split_fields2) (mk___split_fields indefinite_bounded__vect__append__2__container__fields)))
(assert (and (and (= (length (mk___rep v__split_discrs (mk___split_fields indefinite_bounded__vect__append__2__container__fields1))) (+ (length (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) 1)) (= (olt (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_bounded__vect__append__2__container__fields1)))) true)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields indefinite_bounded__vect__append__2__container__fields1))) (+ (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))) 1)) 2)))
(assert (= result2 v__split_fields2))
(assert (= v__split_fields3 (mk___split_fields indefinite_bounded__vect__append__2__container__fields1)))
...
(assert (and (= (mk___rep (mk___split_discrs indefinite_bounded__test__B_1__w__assume) (mk___split_fields indefinite_bounded__test__B_1__w__assume1)) (copy (mk___rep v__split_discrs v__split_fields5) 6)) (and (= (oeq1 (model__ (mk___rep (mk___split_discrs indefinite_bounded__test__B_1__w__assume) (mk___split_fields indefinite_bounded__test__B_1__w__assume1))) (model__ (mk___rep v__split_discrs v__split_fields5))) true) (ite (= 6 0) (= (to_rep indefinite_bounded__test__B_1__w__assume) (length (mk___rep v__split_discrs v__split_fields5))) (= (to_rep indefinite_bounded__test__B_1__w__assume) 6)))))
...
(assert (= (m_elements_reversed (model__ (mk___rep v__split_discrs v__split_fields8)) (model__ (mk___rep v__split_discrs indefinite_bounded__vect__reverse_elements__container__fields))) true))
(assert (= result9 (mk___split_fields__ref v__split_fields8)))
(assert (= v__split_fields9 indefinite_bounded__vect__reverse_elements__container__fields))
...
(assert (and (and (and (= (length (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields)) (length (mk___rep v__split_discrs v__split_fields9))) (= (m_elements_sorted (model__ (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields))) true)) (= (m_elements_included (model__ (mk___rep v__split_discrs v__split_fields9)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields))) (model__ (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields)))) true)) (= (m_elements_included (model__ (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields))) (model__ (mk___rep v__split_discrs v__split_fields9)) 1 (last (model__ (mk___rep v__split_discrs indefinite_bounded__sort__sort__container__fields)))) true)))
(assert (= result10 (mk___split_fields__ref v__split_fields9)))
(assert (= v__split_fields10 indefinite_bounded__sort__sort__container__fields))
...
(assert (= (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2) 4))
(assert (= (is_sorted (mk___rep v__split_discrs v__split_fields10)) true))
(assert (and (= o28 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2)) (and (in_range4 o28) (= o28 (get (model__ (mk___rep v__split_discrs v__split_fields10)) 2)))))
(assert (and (and (= (length (mk___rep v__split_discrs indefinite_bounded__vect__replace_element__container__fields1)) (length (mk___rep v__split_discrs v__split_fields10))) (= (get (model__ (mk___rep v__split_discrs indefinite_bounded__vect__replace_element__container__fields1)) 1) o28)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields10)) (model__ (mk___rep v__split_discrs indefinite_bounded__vect__replace_element__container__fields1)) 1) true)))
(assert (= result11 (mk___split_fields__ref v__split_fields10)))
(assert (= v__split_fields11 indefinite_bounded__vect__replace_element__container__fields1))
