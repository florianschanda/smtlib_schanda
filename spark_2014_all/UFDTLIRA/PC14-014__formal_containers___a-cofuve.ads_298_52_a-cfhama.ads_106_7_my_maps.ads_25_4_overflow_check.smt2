...
(define-fun dynamic_invariant ((temp___expr_689 Int) (temp___is_init_685 Bool) (temp___skip_constant_686 Bool) (temp___do_toplevel_687 Bool) (temp___do_typ_inv_688 Bool)) Bool (=> (or (= temp___is_init_685 true) (<= 1 2147483647)) (in_range1 temp___expr_689)))
...
(define-fun dynamic_invariant2 ((temp___expr_705 Int) (temp___is_init_701 Bool) (temp___skip_constant_702 Bool) (temp___do_toplevel_703 Bool) (temp___do_typ_inv_704 Bool)) Bool (=> (or (= temp___is_init_701 true) (<= 0 2147483647)) (in_range6 temp___expr_705)))
