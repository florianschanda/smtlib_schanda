...
(define-fun dynamic_invariant ((temp___expr_635 Int) (temp___is_init_632 Bool) (temp___skip_constant_633 Bool) (temp___do_toplevel_634 Bool)) Bool (=> (or (= temp___is_init_632 true) (<= 1 2147483647)) (in_range1 temp___expr_635)))
...
(define-fun dynamic_invariant2 ((temp___expr_649 Int) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool)) Bool (=> (or (= temp___is_init_646 true) (<= 0 2147483647)) (in_range6 temp___expr_649)))
