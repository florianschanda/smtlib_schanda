...
(declare-const temp___2471 integer)
(declare-const temp___2472 integer)
...
(assert (=> (not (= result____split_fields6 true)) (= temp___247 o9)))
(assert (=> (not (= result____split_fields6 true)) (= temp___2471 o10)))
(assert (=> (not (= result____split_fields6 true)) (= temp___2472 o11)))
...
(assert (=> (not (= result____split_fields6 true)) (= result____split_fields13 (mk___split_fields temp___247 temp___2471 temp___2472))))
...
(assert (and (= result11 (is_valid (mk___rep (us_split_fields__content result____split_fields14)))) (= (= result11 true) (= (rec__inc__increasing_indicator__valid (us_split_fields__content result____split_fields14)) true))))
(assert (= result11 true))
(assert (and (= o12 (first (mk___rep (us_split_fields__content result____split_fields14)))) (and (in_range1 o12) (= o12 (to_rep (rec__inc__increasing_indicator__first (us_split_fields__content result____split_fields14)))))))
(assert (and (= o13 (second (mk___rep (us_split_fields__content result____split_fields14)))) (and (in_range1 o13) (= o13 (to_rep (rec__inc__increasing_indicator__second (us_split_fields__content result____split_fields14)))))))
(assert (= o14 (ite (< o12 o13) true false)))
(assert (= o15 (ite o14 1 0)))
(assert (not (= (is_valid (mk___rep (us_split_fields__content result____split_fields14))) true)))
(check-sat)
(exit)
