...
(assert (forall ((indicator us_rep)) (! (dynamic_invariant (first indicator) true false true true) :pattern ((first indicator)))))
...
(assert (forall ((indicator us_rep)) (! (dynamic_invariant (second indicator) true false true true) :pattern ((second indicator)))))
...
(declare-const temp___243 Bool)
(declare-const temp___2431 integer)
(declare-const temp___2432 integer)
...
(declare-const temp___2492 integer)
...
(declare-const result____split_fields12 Bool)
(declare-const result____split_fields13 integer)
(declare-const result____split_fields14 integer)
...
(define-fun result____split_fields18 () us_split_fields (mk___split_fields result____split_fields12 result____split_fields13 result____split_fields14))
(assert (in_range1 s))
...
(assert (= temp___2431 o2))
(assert (= temp___2432 o3))
...
(assert (= temp___243 result____split_fields3))
(assert (= temp___2431 result____split_fields4))
(assert (= temp___2432 result____split_fields5))
...
(assert (=> (= result____split_fields6 true) (= temp___249 o5)))
(assert (=> (= result____split_fields6 true) (= temp___2491 o6)))
(assert (=> (= result____split_fields6 true) (= temp___2492 o7)))
...
(assert (=> (= result____split_fields6 true) (= temp___249 result____split_fields9)))
(assert (=> (= result____split_fields6 true) (= temp___2491 result____split_fields10)))
(assert (=> (= result____split_fields6 true) (= temp___2492 result____split_fields11)))
(assert (=> (= result____split_fields6 true) (= result9 result____split_fields9)))
(assert (=> (= result____split_fields6 true) (= result10 result____split_fields10)))
(assert (=> (= result____split_fields6 true) (= result11 result____split_fields11)))
(assert (=> (= result____split_fields6 true) (= inc__read__valid1 result____split_fields12)))
(assert (=> (= result____split_fields6 true) (= result____split_fields10 result____split_fields13)))
(assert (=> (= result____split_fields6 true) (= result____split_fields11 result____split_fields14)))
(assert (=> (not (= result____split_fields6 true)) (= result12 (mk___split_fields__ref (mk___split_fields result____split_fields6 result____split_fields7 result____split_fields8)))))
(assert (=> (not (= result____split_fields6 true)) (= result____split_fields15 (mk___split_fields result____split_fields6 result____split_fields7 rliteral))))
(assert (=> (not (= result____split_fields6 true)) (= result____split_fields18 result____split_fields15)))
(assert (= result____split_fields16 (mk___split_fields__ref result____split_fields18)))
(assert (= result____split_fields17 result____split_fields18))
(assert (and (= result13 (is_valid (mk___rep (us_split_fields__content result____split_fields16)))) (= (= result13 true) (= (rec__inc__increasing_indicator__valid (us_split_fields__content result____split_fields16)) true))))
(assert (= result13 true))
(assert (and (= o8 (first (mk___rep (us_split_fields__content result____split_fields16)))) (and (in_range1 o8) (= o8 (to_rep (rec__inc__increasing_indicator__first (us_split_fields__content result____split_fields16)))))))
(assert (and (= o9 (second (mk___rep (us_split_fields__content result____split_fields16)))) (and (in_range1 o9) (= o9 (to_rep (rec__inc__increasing_indicator__second (us_split_fields__content result____split_fields16)))))))
(assert (= o10 (ite (< o8 o9) true false)))
(assert (= o11 (ite o10 1 0)))
(assert (not (= (is_valid (mk___rep (us_split_fields__content result____split_fields16))) true)))
(check-sat)
(exit)
