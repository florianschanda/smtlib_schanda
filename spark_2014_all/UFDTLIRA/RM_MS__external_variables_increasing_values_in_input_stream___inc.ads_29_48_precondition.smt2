...
(assert (and (= o13 (first (mk___rep (us_split_fields__content result____split_fields14)))) (and (in_range1 o13) (= o13 (to_rep (rec__inc__increasing_indicator__first (us_split_fields__content result____split_fields14)))))))
(assert (and (= o14 (second (mk___rep (us_split_fields__content result____split_fields14)))) (and (in_range1 o14) (= o14 (to_rep (rec__inc__increasing_indicator__second (us_split_fields__content result____split_fields14)))))))
(assert (= o15 (ite (< o13 o14) true false)))
