...
(declare-const temp___596 us_rep1)
...
(assert (and (= temp___596 (f 2)) (= temp___596 (mk___rep1 (mk___split_fields1 (of_rep1 2) us_null_ext__) us_tag))))
(assert (not (<= 2 (last (model__ (mk___rep w__split_discrs w__split_fields1))))))
(check-sat)
(exit)
