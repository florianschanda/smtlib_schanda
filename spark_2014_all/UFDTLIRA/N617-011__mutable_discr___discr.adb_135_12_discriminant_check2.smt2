...
(declare-const temp___395 natural)
(declare-const temp___3951 us_main_type)
(declare-const temp___3952 Bool)
(assert (not (= d__attr__constrained true)))
(assert (= (to_rep d__split_discrs) r29b))
(assert (in_range r29b))
(assert (and (= (mk___rep (mk___split_discrs temp___395) (mk___split_fields temp___3951) temp___3952) (new_with_default 0)) (= (to_rep temp___395) 0)))
(assert (= d__attr__constrained true))
(assert (not (= temp___395 d__split_discrs)))
(check-sat)
(exit)
