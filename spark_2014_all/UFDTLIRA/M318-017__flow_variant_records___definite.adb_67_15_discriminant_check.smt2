...
(declare-const temp___171 status)
(declare-const temp___1711 natural)
(declare-const temp___1712 natural)
(declare-const temp___1713 Bool)
(declare-const temp___1714 Bool)
...
(declare-const temp___174 status)
(declare-const temp___1741 natural)
(declare-const temp___1742 natural)
(declare-const temp___1743 Bool)
(declare-const temp___1744 Bool)
...
(declare-const temp___177 status)
(declare-const temp___1771 natural)
(declare-const temp___1772 natural)
(declare-const temp___1773 Bool)
(declare-const temp___1774 Bool)
(assert (not (= (to_rep1 x__split_discrs) 0)))
(assert (= (to_rep1 x__split_discrs) 1))
(assert (= (to_rep1 x__split_discrs) r10b))
...
(assert (= (to_rep1 o7) 1))
(assert (= o7 o12))
(assert (= temp___174 o12))
(assert (= temp___1741 o9))
(assert (= temp___1742 o10))
(assert (= temp___1743 o11))
(assert (= true temp___1744))
(assert (= x__attr__constrained true))
(assert (not (= temp___174 x__split_discrs)))
(check-sat)
(exit)
