...
(assert (not (< (length (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (capacity (mk___rep result____split_discrs (mk___split_fields result____split_fields1))))))
(check-sat)
(exit)
