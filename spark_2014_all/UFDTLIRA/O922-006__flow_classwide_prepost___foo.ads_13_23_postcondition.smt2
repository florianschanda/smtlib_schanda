...
(declare-const p__split_fields integer)
(declare-const p__split_fields1 integer)
(declare-const p__split_fields2 us_private)
(declare-const o integer)
(declare-const o1 integer)
(declare-const o2 integer)
(declare-const o3 us_private)
(declare-const temp___161 integer)
(declare-const temp___1611 integer)
(declare-const temp___1612 us_private)
(declare-const temp___1613 Int)
(declare-const result integer)
(declare-const result1 integer)
(declare-const result2 us_private)
(declare-const p__split_fields3 integer)
(declare-const p__split_fields4 integer)
(declare-const p__split_fields5 us_private)
(declare-const p__split_fields6 integer)
(declare-const p__split_fields7 integer)
(declare-const p__split_fields8 us_private)
...
(assert (<= (to_rep p__split_fields) limit))
(assert (= (to_rep o) (to_rep p__split_fields1)))
(assert (= o o1))
(assert (= p__split_fields1 o2))
(assert (= p__split_fields2 o3))
(assert (= temp___161 o1))
(assert (= temp___1611 o2))
(assert (= temp___1612 o3))
(assert (= p__attr__tag temp___1613))
(assert (= result p__split_fields))
(assert (= result1 p__split_fields1))
(assert (= result2 p__split_fields2))
(assert (= temp___161 p__split_fields3))
(assert (= temp___1611 p__split_fields4))
(assert (= temp___1612 p__split_fields5))
(assert (= p__split_fields6 p__split_fields3))
(assert (= p__split_fields7 p__split_fields4))
(assert (= p__split_fields8 p__split_fields5))
(assert (= p__split_fields9 p__split_fields3))
(assert (= p__split_fields10 p__split_fields4))
(assert (= p__split_fields11 p__split_fields5))
(assert (not (= (to_rep p__split_fields6) (to_rep p__split_fields7))))
(check-sat)
(exit)
