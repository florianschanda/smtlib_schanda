...
(declare-const temp___187 integer)
(declare-const temp___1871 integer)
(declare-const temp___1872 us_private)
...
(assert (= temp___1871 o2))
(assert (= temp___1872 o3))
(assert (= p__attr__tag temp___1873))
(assert (= result p__split_fields))
(assert (= result1 p__split_fields1))
(assert (= result2 p__split_fields2))
(assert (= temp___187 p__split_fields3))
(assert (= temp___1871 p__split_fields4))
(assert (= temp___1872 p__split_fields5))
