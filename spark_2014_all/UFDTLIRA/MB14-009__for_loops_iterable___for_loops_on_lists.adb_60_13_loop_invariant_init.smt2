...
(define-fun dynamic_invariant1 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range3 temp___expr_214)))
...
(define-fun dynamic_invariant2 ((temp___expr_250 Int) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (or (= temp___is_init_246 true) (<= 0 2147483647)) (in_range6 temp___expr_250)))
(define-fun dynamic_invariant3 ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 2147483647)) (in_range5 temp___expr_257)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true true))) :pattern ((length1 container)))))
...
(assert (and (= o3 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 o3 no_element) true) (and (= (has_key (positions l) o3) true) (= (get1 (positions l) o3) 1)))))
(assert (= temp___547 o))
...
(assert (=> (= result2 true) (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___547)))) (and (in_range3 o1) (= o1 (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___547)))))))))
...
(assert (< 0 count_02))
(assert (not (exists ((cu us_rep1)) (and (= (has_key (positions l) cu) true) (= (element l cu) 0)))))
(check-sat)
(exit)
