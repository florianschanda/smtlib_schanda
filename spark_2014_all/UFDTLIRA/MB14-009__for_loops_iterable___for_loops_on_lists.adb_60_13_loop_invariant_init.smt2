...
(define-fun dynamic_invariant1 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range3 temp___expr_183)))
...
(define-fun dynamic_invariant2 ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 2147483647)) (in_range6 temp___expr_214)))
(define-fun dynamic_invariant3 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 2147483647)) (in_range5 temp___expr_220)))
...
(define-fun dynamic_invariant5 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range4 temp___expr_141)))
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep 0)))))
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 1 2147483647)) (in_range7 temp___expr_239)))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant5 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant5 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant6 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const o12 count_type)
(declare-const o13 Int)
(declare-const o14 Int)
(declare-const temp___507 us_rep2)
(declare-const temp___506 Int)
(declare-const o15 Bool)
(declare-const o16 Bool)
(declare-const e1 Int)
(declare-const temp___511 us_rep2)
...
(declare-const temp___5051 count_type)
...
(declare-const result10 cursor__ref)
(declare-const temp___5053 us_rep1)
...
(declare-const count_05 int__ref)
(declare-const count_14 int__ref)
(declare-const e7 int__ref)
(declare-const temp___5054 cursor__ref)
(declare-const count_06 Int)
(declare-const count_15 Int)
(declare-const e8 Int)
(declare-const temp___5055 us_rep1)
(declare-const count_07 int__ref)
(declare-const count_16 int__ref)
(declare-const e9 int__ref)
(declare-const temp___5056 cursor__ref)
(declare-const count_08 Int)
(declare-const count_17 Int)
(declare-const e10 Int)
(declare-const temp___5057 us_rep1)
(declare-const result14 bool__ref)
(declare-const for_loops_on_lists__count_for_of__result1 Bool)
(declare-const for_loops_on_lists__count_for_of__result2 bool__ref)
(declare-const for_loops_on_lists__count_for_of__result3 Bool)
(declare-const count_09 int__ref)
(declare-const count_18 int__ref)
(declare-const e11 int__ref)
(declare-const for_loops_on_lists__count_for_of__result4 bool__ref)
(declare-const count_010 Int)
(declare-const count_19 Int)
(declare-const e12 Int)
(declare-const for_loops_on_lists__count_for_of__result5 Bool)
...
(assert (and (= (mk___rep1 (mk___split_fields1 o)) (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o))) 1)))))
(assert (= temp___505 o))
(assert (and (= result2 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___505)))) (= (= result2 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___505))) true))))
(assert (=> (= result2 true) (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___505)))) (and (in_range3 o1) (= o1 (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___505)))))))))
(assert (=> (= result2 true) (= result3 (mk_int__ref e))))
(assert (=> (= result2 true) (= e4 o1)))
(assert (=> (not (= result2 true)) (= e4 e)))
(assert (=> (not (= result2 true)) (= e4 e3)))
(assert (and (= result4 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___505)))) (= (= result4 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___505))) true))))
(assert (= result4 true))
(assert (=> (= e4 0) (and (= o2 (+ count_01 1)) (in_range1 (+ count_01 1)))))
(assert (=> (= e4 0) (= result5 (mk_int__ref count_01))))
(assert (=> (= e4 0) (= count_02 o2)))
(assert (=> (not (= e4 0)) (= count_02 count_01)))
(assert (< 0 count_02))
(assert (not (exists ((cu2 us_rep1)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 0)))))
(check-sat)
(exit)
