...
(assert (and (= (mk___rep (mk___split_discrs temp___357) (mk___split_fields temp___3571) temp___3572) (new_with_default 0)) (= (to_rep temp___357) 0)))
(assert (= d__attr__constrained true))
(assert (not (= temp___357 d__split_discrs)))
(check-sat)
(exit)
