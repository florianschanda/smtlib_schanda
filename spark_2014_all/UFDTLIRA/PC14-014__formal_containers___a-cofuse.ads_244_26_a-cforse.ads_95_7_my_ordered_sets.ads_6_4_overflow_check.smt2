...
(define-fun default_initial_assumption ((temp___expr_322 us_rep) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (is_empty temp___expr_322) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 0 2147483647)) (in_range3 temp___expr_315)))
(declare-fun contains (us_rep Int) Bool)
(declare-fun contains__function_guard (Bool us_rep Int) Bool)
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant1 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range3 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
