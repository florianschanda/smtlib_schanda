...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true true))) :pattern ((length container1)))))
...
(define-fun e_is_find ((container1 us_rep2) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length3 container1)) (e_smaller_than_range container1 (+ position 1) (length3 container1) item) (distinct 1 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_397 us_rep2) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (= (length3 temp___expr_397) 0)))
(declare-fun find (us_rep2 Int) Int)
(declare-fun find__function_guard (Int us_rep2 Int) Bool)
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant4 result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___435 Int)) (=> (and (in_range7 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container1) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (! (dynamic_invariant4 (length2 container1) true false true true) :pattern ((length2 container1)))))
(assert (forall ((container1 us_rep1)) (! (let ((result (is_empty container1))) (and (= (= result true) (forall ((item Int)) (not (and (in_range2 item) (= (contains container1 item) true))))) (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty container1)))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true true))) :pattern ((length3 container1)))))
