...
(define-fun dynamic_invariant ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 100)) (in_range2 temp___expr_321)))
...
(assert (forall ((container us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= (equivalent_elements e item) true))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant2 ((temp___expr_520 Int) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool)) Bool (=> (or (= temp___is_init_517 true) (<= 1 100)) (in_range4 temp___expr_520)))
(assert (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true) (dynamic_invariant2 (key i) true false true)) :pattern ((key i)))))
(assert (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true) (= (key i) i)) :pattern ((key i)))))
...
(define-fun dynamic_invariant3 ((temp___expr_526 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 1 100)) (in_range5 temp___expr_526)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true))) :pattern ((length container1)))))
...
(define-fun e_is_find ((container1 us_rep2) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (of_int 1)) (ite (< position (length3 container1)) (e_smaller_than_range container1 (+ position 1) (length3 container1) item) (of_int 1))))
...
(define-fun dynamic_invariant5 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 1 100)) (in_range6 temp___expr_295)))
...
(define-fun default_initial_assumption1 ((temp___expr_359 us_rep2) (temp___skip_top_level_360 Bool)) Bool (=> (not (= temp___skip_top_level_360 true)) (= (length3 temp___expr_359) 0)))
(declare-fun find (us_rep2 Int) Int)
(declare-fun find__function_guard (Int us_rep2 Int) Bool)
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant4 result true false true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___393 Int)) (=> (and (in_range7 temp___393) (= (iter_has_element result temp___393) true)) (= (contains (model__ container1) (get result temp___393)) true)))) (forall ((item Int)) (=> (and (in_range2 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
...
(assert true)
(assert (forall ((container1 us_rep1)) (! (dynamic_invariant4 (length2 container1) true false true) :pattern ((length2 container1)))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true))) :pattern ((length3 container1)))))
...
(declare-const temp___656 us_rep1)
(declare-const e Int)
(declare-const o Bool)
(assert (in_range5 key1))
(assert (and (= temp___656 (model__ container)) (= (length2 temp___656) (length container))))
(assert (not true))
(check-sat)
(exit)
