...
(define-fun dynamic_invariant ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 100)) (in_range1 temp___expr_353)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 a))) (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__p__my_sets__set (us_split_fields1 a)) (rec__p__my_sets__set (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_563 Int) (temp___is_init_559 Bool) (temp___skip_constant_560 Bool) (temp___do_toplevel_561 Bool) (temp___do_typ_inv_562 Bool)) Bool (=> (or (= temp___is_init_559 true) (<= 1 100)) (in_range4 temp___expr_563)))
(assert (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true true) (dynamic_invariant2 (key i) true false true true)) :pattern ((key i)))))
(assert (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true true) (= (key i) i)) :pattern ((key i)))))
...
(define-fun dynamic_invariant3 ((temp___expr_570 Int) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool) (temp___do_typ_inv_569 Bool)) Bool (=> (or (= temp___is_init_566 true) (<= 1 100)) (in_range5 temp___expr_570)))
...
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= result (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant4 result true false true true))) :pattern ((length container1)))))
...
(define-fun e_bigger_than_range ((container1 us_rep2) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_inf (get container1 i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep2 Int Int Int) Bool)
(define-fun e_smaller_than_range ((container1 us_rep2) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_inf item (get container1 i)) true))) true false))
(declare-fun e_smaller_than_range__function_guard (Bool us_rep2 Int Int Int) Bool)
(define-fun e_is_find ((container1 us_rep2) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item) (distinct 1 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= 1 100)) (in_range6 temp___expr_323)))
...
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant4 result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep1)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length container1)) (forall ((temp___435 Int)) (=> (and (in_range7 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container1) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range1 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (forall ((container1 us_rep)) (! (dynamic_invariant4 (length1 container1) true false true true) :pattern ((length1 container1)))))
(assert (forall ((container1 us_rep)) (! (let ((result (is_empty container1))) (and (= (= result true) (forall ((item Int)) (not (and (in_range1 item) (= (contains container1 item) true))))) (= (= result true) (= (length1 container1) 0)))) :pattern ((is_empty container1)))))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length2 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant4 result true false true true))) :pattern ((length2 container1)))))
