...
(assert (and (= o5 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o5 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o5) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o5) 1)))))
...
(assert (and (= o4 (positions (mk___rep l__split_discrs l__split_fields1))) (and (not (= (has_key o4 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o4 i) true) (and (and (<= 1 (get1 o4 i)) (<= (get1 o4 i) (length (mk___rep l__split_discrs l__split_fields1)))) (forall ((j us_rep1)) (=> (= (has_key o4 j) true) (=> (= (get1 o4 i) (get1 o4 j)) (= (bool_eq1 i j) true))))))))))
(assert (not (= (has_key o4 cu2) true)))
(check-sat)
(exit)
