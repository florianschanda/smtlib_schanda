...
(assert (and (= o3 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq2 o3 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o3) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o3) 1)))))
...
(assert (and (= o2 (positions (mk___rep l__split_discrs l__split_fields1))) (and (not (= (has_key o2 no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length (mk___rep l__split_discrs l__split_fields1)))) (forall ((j us_rep2)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq2 i j) true))))))))))
(assert (not (= (has_key o2 cu2) true)))
(check-sat)
(exit)
