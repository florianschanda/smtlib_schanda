...
(assert (and (= o4 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o4 no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key o4 i3) true) (and (and (<= 1 (get1 o4 i3)) (<= (get1 o4 i3) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o4 j) true) (=> (= (get1 o4 i3) (get1 o4 j)) (= (bool_eq1 i3 j) true))))))))))
