...
(declare-const temp___191 positive)
(declare-const temp___1911 integer)
(declare-const temp___1912 integer)
(declare-const temp___1913 us_private)
...
(assert (= temp___191 o6))
(assert (= temp___1911 o7))
(assert (= temp___1912 o8))
(assert (= temp___1913 o9))
(assert (= p__attr__tag temp___1914))
...
(assert (= temp___191 p__split_fields8))
(assert (= temp___1911 p__split_fields9))
(assert (= temp___1912 p__split_fields10))
(assert (= temp___1913 p__split_fields11))
