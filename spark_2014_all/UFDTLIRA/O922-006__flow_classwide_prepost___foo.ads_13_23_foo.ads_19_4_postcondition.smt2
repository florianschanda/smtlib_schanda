...
(assert (and (and (or (<= (to_rep p__split_fields1) limit) (<= (to_rep p__split_fields2) limit)) (and (and (and (and (= (to_rep o) (to_rep p__split_fields2)) (and (= p__split_fields o1) (and (= o o2) (and (= p__split_fields2 o3) (= p__split_fields3 o4))))) (and (and (= temp___163 o1) (and (= temp___1631 o2) (and (= temp___1632 o3) (= temp___1633 o4)))) (= p__attr__tag temp___1634))) (and (and (= result p__split_fields) (and (= result1 p__split_fields1) (and (= result2 p__split_fields2) (= result3 p__split_fields3)))) (and (= temp___163 p__split_fields4) (and (= temp___1631 p__split_fields5) (and (= temp___1632 p__split_fields6) (= temp___1633 p__split_fields7)))))) (and (and (and (= (to_rep1 o5) 9001) (and (= o5 o6) (and (= p__split_fields5 o7) (and (= p__split_fields6 o8) (= p__split_fields7 o9))))) (and (and (= temp___165 o6) (and (= temp___1651 o7) (and (= temp___1652 o8) (= temp___1653 o9)))) (= p__attr__tag temp___1654))) (and (and (= result4 p__split_fields4) (and (= result5 p__split_fields5) (and (= result6 p__split_fields6) (= result7 p__split_fields7)))) (and (= temp___165 p__split_fields8) (and (= temp___1651 p__split_fields9) (and (= temp___1652 p__split_fields10) (= temp___1653 p__split_fields11)))))))) (and (and (= p__split_fields12 p__split_fields8) (and (= p__split_fields13 p__split_fields9) (and (= p__split_fields14 p__split_fields10) (= p__split_fields15 p__split_fields11)))) (= (mk___split_fields1 p__split_fields16 p__split_fields17 p__split_fields18 p__split_fields19) (mk___split_fields1 p__split_fields8 p__split_fields9 p__split_fields10 p__split_fields11)))))
