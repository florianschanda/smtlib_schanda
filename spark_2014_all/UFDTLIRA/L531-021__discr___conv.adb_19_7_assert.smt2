...
(define-fun o21 () us_rep (mk___rep (mk___split_discrs o12) (mk___split_fields o13 o14 o15 o16)))
(define-fun o22 () us_rep (mk___rep (mk___split_discrs o7) (mk___split_fields o8 o9 o10 o11)))
(assert (= (to_rep2 o) 0))
(assert (= o o1))
(assert (= o2 o1))
(assert (= rliteral o3))
...
(assert (= true o5))
(assert (= dummy1 o6))
(assert (= o22 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4 o5 o6))))
(assert (= o21 o22))
(assert (= (mk___rep (mk___split_discrs conv__p__x__assume) (mk___split_fields conv__p__x__assume1 conv__p__x__assume2 conv__p__x__assume3 conv__p__x__assume4)) o21))
...
(assert (= 0 (to_rep2 (rec__basic__r__x z__split_discrs))))
