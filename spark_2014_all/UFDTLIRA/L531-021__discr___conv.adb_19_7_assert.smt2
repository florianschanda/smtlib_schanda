...
(define-fun o33 () us_rep (mk___rep (mk___split_discrs o18) (mk___split_fields o19 o20 o21 o22)))
(define-fun o34 () us_rep (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17)))
(assert (= (to_rep o1) 1))
(assert (= (to_rep o2) 1))
(assert (= o2 o3))
(assert (= o1 o4))
...
(assert (= o11 o5))
(assert (= o12 o6))
(assert (= o34 (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
(assert (= o33 o34))
(assert (= (mk___rep (mk___split_discrs conv__p__x__assume) (mk___split_fields conv__p__x__assume1 conv__p__x__assume2 conv__p__x__assume3 conv__p__x__assume4)) o33))
...
(assert (= conv__p__y__assume (mk___rep o30 (mk___split_fields o26 o27 o28 o29))))
...
(assert (and (= o31 (id (mk___rep x__split_discrs x__split_fields4))) (= (bool_eq o31 (mk___rep x__split_discrs x__split_fields4)) true)))
(assert (= o32 o31))
(assert (= conv__p__z__assume o32))
(assert (= result2 (mk___split_fields__ref (mk___split_fields z__split_fields z__split_fields1 z__split_fields2 z__split_fields3))))
...
(assert (not (= (bool_eq (id (mk___rep x__split_discrs x__split_fields4)) (id (mk___rep y__split_discrs y__split_fields4))) true)))
(check-sat)
(exit)
