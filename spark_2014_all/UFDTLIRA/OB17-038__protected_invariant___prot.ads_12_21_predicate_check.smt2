...
(define-fun dynamic_invariant ((temp___expr_178 us_rep) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (= temp___do_toplevel_177 true) (=> (= temp___is_init_175 true) (<= 0 (to_rep (rec__prot__int__v (us_split_fields1 temp___expr_178)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_188 us_rep1) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (<= 0 (to_rep (rec__prot__int__v (us_split_fields1 (rec__prot__t__data (us_split_fields3 temp___expr_188)))))))
...
(assert (not (<= 0 (to_rep temp___192))))
(check-sat)
(exit)
