...
(define-fun default_initial_assumption ((temp___expr_221 us_rep1) (temp___skip_top_level_222 Bool)) Bool (= (rec__prot__t__data (us_split_fields3 temp___expr_221)) (mk___rep (mk___split_fields (of_rep 0)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___223 o1))
(assert (not (<= 0 (to_rep temp___223))))
(check-sat)
(exit)
