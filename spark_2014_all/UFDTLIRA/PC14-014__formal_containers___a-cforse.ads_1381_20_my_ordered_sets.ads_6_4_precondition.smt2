...
(define-fun default_initial_assumption ((temp___expr_413 us_rep2) (temp___skip_top_level_414 Bool)) Bool (=> (not (= temp___skip_top_level_414 true)) (and (= (is_empty temp___expr_413) true) (= (length temp___expr_413) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(declare-const temp___985 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___985 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___985)) no_element))
