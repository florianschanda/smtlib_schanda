...
(define-fun dynamic_invariant ((temp___expr_366 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 2147483647)) (in_range2 temp___expr_366)))
...
(define-fun default_initial_assumption ((temp___expr_373 us_rep2) (temp___skip_top_level_374 Bool)) Bool (=> (not (= temp___skip_top_level_374 true)) (and (= (is_empty temp___expr_373) true) (= (length temp___expr_373) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true))) :pattern ((length1 container1)))))
...
(define-fun dynamic_invariant2 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 0 2147483647)) (in_range3 temp___expr_289)))
...
(define-fun default_initial_assumption1 ((temp___expr_353 us_rep3) (temp___skip_top_level_354 Bool)) Bool (=> (not (= temp___skip_top_level_354 true)) (= (length3 temp___expr_353) 0)))
(declare-fun find (us_rep3 Int) Int)
(declare-fun find__function_guard (Int us_rep3 Int) Bool)
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant1 result true false true)))) :pattern ((find container1 item))))))
...
(define-fun default_initial_assumption2 ((temp___expr_322 us_rep4) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (is_empty1 temp___expr_322) true)))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length1 container1)) (forall ((temp___387 Int)) (=> (and (in_range5 temp___387) (= (iter_has_element result temp___387) true)) (= (contains (model__ container1) (get1 result temp___387)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert true)
(define-fun dynamic_invariant3 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 0 2147483647)) (in_range4 temp___expr_315)))
...
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant1 (length4 container1) true false true) :pattern ((length4 container1)))))
...
(define-fun dynamic_invariant4 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 0 2147483647)) (in_range5 temp___expr_346)))
(assert (forall ((container1 us_rep3)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true))) :pattern ((length3 container1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 2147483647)) (in_range6 temp___expr_340)))
...
(declare-const temp___921 count_type)
(declare-const o2 us_rep2)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___921 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___921)) no_element))
