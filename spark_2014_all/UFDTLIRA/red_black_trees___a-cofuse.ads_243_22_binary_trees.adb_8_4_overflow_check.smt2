...
(define-fun dynamic_invariant1 ((temp___expr_467 Int) (temp___is_init_463 Bool) (temp___skip_constant_464 Bool) (temp___do_toplevel_465 Bool) (temp___do_typ_inv_466 Bool)) Bool (=> (or (= temp___is_init_463 true) (<= 1 100)) (in_range3 temp___expr_467)))
