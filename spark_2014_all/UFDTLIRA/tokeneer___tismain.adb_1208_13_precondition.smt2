...
(assert (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress (us_private__content state3)) true)) (= (privatekeypresent state) true)) (= (= (islocked state2) true) (= (interfac_islocked Tuple0) true))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood state1) true) (= (authcertvalid state1) true)) (= (theauthcertrole state1) 1)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))) (=> (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 4)) (= (statusiswaitingstartadminop (us_private__content state3)) true))) (=> (or (= (statusisgotadmintoken (us_private__content state3)) true) (= (statusiswaitingremoveadmintokenfail (us_private__content state3)) true)) (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (or (= (statusiswaitingstartadminop (us_private__content state3)) true) (= (statusiswaitingfinishadminop (us_private__content state3)) true)) (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (= (statusisenclavequiescent (us_private__content state3)) true) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (= (statusisshutdown (us_private__content state3)) true) (and (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 0)))) (=> (= (enrolmentisinprogress (us_private__content state3)) true) (and (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))))
(assert (and (and (and (and (and (and (= (and (and (= (islocked state5) true) (= (thecurrentdoor state6) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state6)) true)) (= (thedooralarm state6) 0)) (= (= (isgood state1) true) (= (isgood state4) true))) (= (= (authcertvalid state1) true) (= (authcertvalid state4) true))) (= (= (theauthcertrole state1) 1) (= (theauthcertrole state4) 1))) (= (= (islocked state5) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state5)) true))) (or (not (= (islocked state2) true)) (and (and (= (current_latch state5) (current_latch state2)) (= (bool_eq1 (latch_timeout state5) (latch_timeout state2)) true)) (= (islocked state5) true)))) (= (bool_eq1 (latch_timeout state5) (latch_timeout state2)) true)))
(assert (not (= systemfault true)))
(assert (and (=> (= (thedooralarm state6) 0) (= (isalarming Tuple0) true)) (or (= (= (islocked state5) true) (= (latchislocked Tuple0) true)) (= systemfault1 true))))
(assert (not (= systemfault1 true)))
(assert (not (= (enrolmentisinprogress (us_private__content state3)) true)))
