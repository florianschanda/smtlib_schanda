...
(assert (and (= o12 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o12)))
(assert (= result (ite (= o12 1) true false)))
(assert (=> (= result true) (= o16 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o17 (ite (not (= o16 true)) true false))))
(assert (=> (= result true) (and (= o13 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o13))))
(assert (=> (= result true) (= o14 (ite (= o13 3) true false))))
(assert (=> (= result true) (= o15 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (and (= o7 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o7)))
(assert (= o8 (ite (= o7 3) true false)))
(assert (= o9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (= result1 (ite (= o9 true) o8 false)))
(assert (=> (= result1 true) (and (= o10 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o10))))
...
(assert (=> (= result2 true) (and (= o3 (theauthcertrole state)) (in_range1 o3))))
(assert (=> (= result2 true) (= o4 (ite (= o3 1) true false))))
(assert (=> (= result2 true) (= o1 (authcertvalid state))))
(assert (=> (= result2 true) (= o2 (isgood state))))
