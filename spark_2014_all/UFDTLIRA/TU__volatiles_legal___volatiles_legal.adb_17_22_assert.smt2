...
(declare-const temp___255 integer)
...
(assert (= (to_rep o4) o3))
(assert (= o4 o5))
(assert (= temp___253 o5))
(assert (= result (mk___split_fields__ref par__split_fields)))
(assert (= par__split_fields1 (mk___split_fields temp___253)))
...
(assert (= o10 o11))
(assert (= temp___255 o11))
(assert (= result1 (mk___split_fields__ref par__split_fields2)))
(assert (= par__split_fields3 (mk___split_fields temp___255)))
