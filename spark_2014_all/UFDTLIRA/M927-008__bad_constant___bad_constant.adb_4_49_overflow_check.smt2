...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant1 (ident x) true false true)) :pattern ((ident x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (ident x) x)) :pattern ((ident x)))))
(declare-const x Int)
