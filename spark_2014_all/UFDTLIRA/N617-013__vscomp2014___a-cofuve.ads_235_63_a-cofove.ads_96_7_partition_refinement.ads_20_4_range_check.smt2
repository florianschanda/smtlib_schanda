...
(define-fun default_initial_assumption ((temp___expr_374 us_rep) (temp___skip_top_level_375 Bool)) Bool (=> (not (= temp___skip_top_level_375 true)) (= (length temp___expr_374) 0)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant result true false true true))) :pattern ((length container)))))
(declare-sort extended_index 0)
(declare-fun extended_indexqtint (extended_index) Int)
(assert (forall ((i extended_index)) (and (<= (- 1) (extended_indexqtint i)) (<= (extended_indexqtint i) 10000))))
...
(define-fun dynamic_invariant1 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= (- 1) 10000)) (in_range4 temp___expr_366)))
...
(define-fun dynamic_invariant2 ((temp___expr_349 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= 0 10000)) (in_range6 temp___expr_349)))
...
(define-fun dynamic_invariant4 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 5)) (in_range3 temp___expr_284)))
(assert true)
(declare-const o Int)
...
(assert (and (= o7 (last left)) (and (in_range4 o7) (= o7 (+ (- 1) (length left))))))
(assert (= result (ite (<= lst o7) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o6 (- (- 32768) offset)) (in_range5 (- (- 32768) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o6 0) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o1 lst) (in_range5 lst)))
(assert (and (= o (length right)) (and (in_range1 o) (<= (+ (- 1) o) 10000))))
(assert (= o2 (+ (- 1) o)))
(assert (= o3 (- o2 o1)))
(assert (and (= o4 o3) (in_range5 o3)))
(assert (= o5 (ite (<= offset o4) true false)))
(assert (not (in_range5 fst)))
(check-sat)
(exit)
