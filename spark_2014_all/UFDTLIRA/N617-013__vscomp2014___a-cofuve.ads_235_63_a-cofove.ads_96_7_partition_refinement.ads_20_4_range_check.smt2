...
(define-fun dynamic_invariant ((temp___expr_349 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= 0 10000)) (in_range2 temp___expr_349)))
...
(define-fun dynamic_invariant1 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= (- 1) 10000)) (in_range3 temp___expr_366)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 6)) (in_range4 temp___expr_277)))
(define-fun dynamic_invariant4 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 5)) (in_range5 temp___expr_284)))
(assert true)
(declare-const o Int)
...
(assert (and (= o7 (last left)) (and (in_range3 o7) (= o7 (+ (- 1) (length left))))))
(assert (= result (ite (<= lst o7) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o6 (- (- 32768) offset)) (in_range1 (- (- 32768) offset)))))
(assert (=> (< offset 0) (= result1 (ite (<= o6 0) true false))))
(assert (=> (not (< offset 0)) (= result1 (distinct 1 0))))
(assert (= result1 true))
(assert (<= fst lst))
(assert (and (= o1 lst) (in_range1 lst)))
(assert (and (= o (length right)) (and (in_range6 o) (<= (+ (- 1) o) 10000))))
(assert (= o2 (+ (- 1) o)))
(assert (= o3 (- o2 o1)))
