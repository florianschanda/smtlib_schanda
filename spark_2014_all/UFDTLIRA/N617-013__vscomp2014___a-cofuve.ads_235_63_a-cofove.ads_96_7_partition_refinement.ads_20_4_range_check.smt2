...
(define-fun dynamic_invariant ((temp___expr_314 Int) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool)) Bool (=> (or (= temp___is_init_311 true) (<= 0 10000)) (in_range2 temp___expr_314)))
...
(define-fun dynamic_invariant1 ((temp___expr_329 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= (- 1) 10000)) (in_range3 temp___expr_329)))
...
(define-fun default_initial_assumption ((temp___expr_336 us_rep) (temp___skip_top_level_337 Bool)) Bool (=> (not (= temp___skip_top_level_337 true)) (= (length temp___expr_336) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 6)) (in_range4 temp___expr_251)))
(define-fun dynamic_invariant4 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 5)) (in_range5 temp___expr_257)))
(assert true)
(declare-const o Int)
