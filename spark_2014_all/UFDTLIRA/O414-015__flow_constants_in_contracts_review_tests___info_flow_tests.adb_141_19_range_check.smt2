...
(define-fun dynamic_invariant1 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 last)) (dynamic_property 0 last temp___expr_171)))
(assert (= last c2))
...
(assert (not (dynamic_property 0 last c1)))
(check-sat)
(exit)
