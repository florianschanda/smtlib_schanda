...
(define-fun dynamic_invariant ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 4)) (in_range2 temp___expr_421)))
(define-fun dynamic_invariant1 ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 1 4)) (in_range3 temp___expr_427)))
(define-fun dynamic_invariant2 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 3)) (in_range1 temp___expr_359)))
...
(assert (and (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))
...
(assert (not (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) true))))
(check-sat)
(exit)
