...
(define-fun dynamic_invariant ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 4)) (in_range2 temp___expr_377)))
(define-fun dynamic_invariant1 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1 4)) (in_range3 temp___expr_383)))
