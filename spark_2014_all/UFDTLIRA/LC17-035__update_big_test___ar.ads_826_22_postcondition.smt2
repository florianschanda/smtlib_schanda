...
(declare-const temp___6794 et3)
(declare-const temp___67941 et1)
(declare-const temp___67942 et2)
(declare-const temp___67943 enum1ta)
...
(declare-const temp___6797 us_rep1)
...
(assert (= temp___6794 o6))
(assert (= temp___67941 o7))
(assert (= temp___67942 o8))
(assert (= temp___67943 o9))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6794 (mk___rep (mk___split_fields temp___67941 temp___67942)) temp___67943)))
...
(assert (= temp___6797 (mk___rep1 (mk___split_fields1 o15 (mk___rep (mk___split_fields o16 o17)) o18))))
(assert (= result2 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (us_split_fields3 temp___6797)))
