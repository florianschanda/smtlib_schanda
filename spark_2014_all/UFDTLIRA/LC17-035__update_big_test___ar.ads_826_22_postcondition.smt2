...
(define-fun dynamic_invariant ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 1 25)) (in_range1 temp___expr_182)))
...
(define-fun dynamic_invariant1 ((temp___expr_176 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 99)) (in_range temp___expr_176)))
...
(define-fun dynamic_invariant3 ((temp___expr_212 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 4)) (in_range3 temp___expr_212)))
...
(declare-const temp___6735 et3)
(declare-const temp___67351 et1)
(declare-const temp___67352 et2)
(declare-const temp___67353 enum1ta)
...
(declare-const temp___6738 us_rep1)
...
(assert (= temp___6735 o6))
(assert (= temp___67351 o7))
(assert (= temp___67352 o8))
(assert (= temp___67353 o9))
(assert (= result1 (mk___split_fields__ref1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)) r__split_fields3))))
(assert (= r__split_fields4 (mk___split_fields1 temp___6735 (mk___rep (mk___split_fields temp___67351 temp___67352)) temp___67353)))
(assert (= (to_rep1 o10) temp1))
(assert (= (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 r__split_fields4))) o11))
(assert (= o10 o12))
(assert (= o13 o11))
(assert (= o14 o12))
...
(assert (= temp___6738 (mk___rep1 (mk___split_fields1 o15 (mk___rep (mk___split_fields o16 o17)) o18))))
(assert (= result2 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (us_split_fields3 temp___6738)))
...
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields6)) (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep (to_rep1 r__split_fields2)) (of_rep1 (to_rep r__split_fields1)))) r__split_fields3))) true)))
(check-sat)
(exit)
