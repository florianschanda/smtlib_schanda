...
(define-fun dynamic_invariant ((temp___expr_709 Int) (temp___is_init_706 Bool) (temp___skip_constant_707 Bool) (temp___do_toplevel_708 Bool)) Bool (=> (or (= temp___is_init_706 true) (<= 1 2147483647)) (in_range1 temp___expr_709)))
...
(define-fun dynamic_invariant1 ((temp___expr_715 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 1 2147483647)) (in_range2 temp___expr_715)))
...
(define-fun dynamic_invariant3 ((temp___expr_721 Int) (temp___is_init_718 Bool) (temp___skip_constant_719 Bool) (temp___do_toplevel_720 Bool)) Bool (=> (or (= temp___is_init_718 true) (<= 0 2147483647)) (in_range5 temp___expr_721)))
