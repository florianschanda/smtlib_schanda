...
(define-fun dynamic_invariant ((temp___expr_715 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 1 2147483647)) (in_range1 temp___expr_715)))
...
(define-fun dynamic_invariant1 ((temp___expr_721 Int) (temp___is_init_718 Bool) (temp___skip_constant_719 Bool) (temp___do_toplevel_720 Bool)) Bool (=> (or (= temp___is_init_718 true) (<= 1 2147483647)) (in_range2 temp___expr_721)))
...
(define-fun default_initial_assumption ((temp___expr_734 us_rep) (temp___skip_top_level_735 Bool)) Bool (=> (not (= temp___skip_top_level_735 true)) (= (length temp___expr_734) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_160 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 2147483647)) (in_range4 temp___expr_160)))
...
(define-fun dynamic_invariant3 ((temp___expr_727 Int) (temp___is_init_724 Bool) (temp___skip_constant_725 Bool) (temp___do_toplevel_726 Bool)) Bool (=> (or (= temp___is_init_724 true) (<= 0 2147483647)) (in_range5 temp___expr_727)))
