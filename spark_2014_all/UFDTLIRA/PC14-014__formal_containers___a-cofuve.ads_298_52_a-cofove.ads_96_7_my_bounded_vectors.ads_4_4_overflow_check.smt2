...
(define-fun dynamic_invariant ((temp___expr_797 Int) (temp___is_init_793 Bool) (temp___skip_constant_794 Bool) (temp___do_toplevel_795 Bool) (temp___do_typ_inv_796 Bool)) Bool (=> (or (= temp___is_init_793 true) (<= 1 2147483647)) (in_range1 temp___expr_797)))
...
(define-fun dynamic_invariant1 ((temp___expr_804 Int) (temp___is_init_800 Bool) (temp___skip_constant_801 Bool) (temp___do_toplevel_802 Bool) (temp___do_typ_inv_803 Bool)) Bool (=> (or (= temp___is_init_800 true) (<= 1 2147483647)) (in_range2 temp___expr_804)))
...
(define-fun default_initial_assumption ((temp___expr_819 us_rep) (temp___skip_top_level_820 Bool)) Bool (=> (not (= temp___skip_top_level_820 true)) (= (length temp___expr_819) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_811 Int) (temp___is_init_807 Bool) (temp___skip_constant_808 Bool) (temp___do_toplevel_809 Bool) (temp___do_typ_inv_810 Bool)) Bool (=> (or (= temp___is_init_807 true) (<= 0 2147483647)) (in_range5 temp___expr_811)))
