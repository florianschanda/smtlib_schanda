...
(assert (and (= result6 (inv (queue__content amortized_queue__enqueue__result7))) (= (= result6 true) (and (and (<= (length (rec__amortized_queue__queue__rear (us_split_fields3 (queue__content amortized_queue__enqueue__result7)))) (length (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__enqueue__result7))))) (<= (length (rec__amortized_queue__queue__rear (us_split_fields3 (queue__content amortized_queue__enqueue__result7)))) (- (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__enqueue__result7)))))) (length (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__enqueue__result7))))))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__enqueue__result7)))))) (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 (rec__amortized_queue__queue__rear (us_split_fields3 (queue__content amortized_queue__enqueue__result7)))))))))))
(assert (= result6 true))
(assert (and (= o18 (model__1 (queue__content amortized_queue__enqueue__result7))) (= (is_model (queue__content amortized_queue__enqueue__result7) o18) true)))
(assert (and (= o17 (model__1 q)) (= (is_model q o17) true)))
(assert (not (<= (+ 1 (length o17)) 1000)))
(check-sat)
(exit)
