...
(assert (and (= o29 (first (mk___rep l1__split_discrs l1__split_fields4))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields4)) 0) true) (= (bool_eq1 o29 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o29) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o29) 1)))))
(assert (and (= o30 (next (mk___rep l1__split_discrs l1__split_fields4) o29)) (ite (= (ite (= (bool_eq1 o29 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o29) (length (mk___rep l1__split_discrs l1__split_fields4))) true) true) (= (bool_eq1 o30 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o30) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o30) (+ (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o29) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o30) true) (= (bool_eq1 o30 no_element) true))))
(check-sat)
(exit)
