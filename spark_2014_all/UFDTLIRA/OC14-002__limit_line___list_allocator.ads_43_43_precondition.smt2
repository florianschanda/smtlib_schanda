...
(assert (forall ((s us_rep)) (! (dynamic_invariant1 (length s) true false true) :pattern ((length s)))))
(assert (forall ((attr__tag Int)) (forall ((s us_rep)) (! (dynamic_invariant1 (length1 attr__tag s) true false true) :pattern ((length1 attr__tag s))))))
