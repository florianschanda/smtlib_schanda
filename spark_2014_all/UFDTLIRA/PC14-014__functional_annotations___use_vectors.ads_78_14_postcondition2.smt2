...
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (forall ((i Int)) (=> (and (<= fst1 i) (<= i (- current2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i) 0)))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (forall ((i Int)) (=> (and (<= first4 i) (<= i (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i) (get temp___516 i))))))
(assert (=> (and (<= fst1 current1) (<= current1 lst1)) (forall ((i Int)) (=> (and (<= current2 i) (<= i (last2 (model__ (mk___rep v__split_discrs v__split_fields13))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i) (get temp___517 i))))))
...
(declare-const i Int)
(assert (<= first4 i))
(assert (<= i (last2 (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))))))
(assert (<= fst1 i))
(assert (<= i lst1))
(assert (not (= (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) i) 0)))
(check-sat)
(exit)
