...
(define-fun private_types__p1__t__f__pred ((a us_rep)) Bool (= (to_int1 (rec__private_types__p1__t__d (us_split_discrs1 a))) 1))
...
(define-fun default_initial_assumption ((temp___expr_137 us_rep) (temp___skip_top_level_138 Bool)) Bool (and (= (attr__constrained temp___expr_137) false) (and (= (rec__private_types__p1__t__d (us_split_discrs1 temp___expr_137)) (of_int 0)) (=> (private_types__p1__t__f__pred temp___expr_137) (= (to_rep (rec__private_types__p1__t__f (us_split_fields1 temp___expr_137))) (id 0))))))
