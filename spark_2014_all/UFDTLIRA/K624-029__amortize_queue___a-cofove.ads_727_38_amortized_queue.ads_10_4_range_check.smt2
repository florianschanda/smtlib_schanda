...
(define-fun dynamic_invariant ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 1000)) (in_range1 temp___expr_228)))
...
(define-fun dynamic_invariant4 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 1000)) (in_range3 temp___expr_249)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 container1))) 1000))
...
(define-fun dynamic_invariant5 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 0 1000)) (in_range4 temp___expr_280)))
