...
(define-fun dynamic_invariant ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 3)) (in_range2 temp___expr_359)))
...
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (isdoingop theadmin) true) (in_range3 (to_rep (rec__admin__t__currentop (us_split_fields1 theadmin))))) :pattern ((isdoingop theadmin)))))
...
(define-fun dynamic_invariant1 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 4)) (in_range1 temp___expr_421)))
(define-fun dynamic_invariant2 ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 1 4)) (in_range3 temp___expr_427)))
...
(declare-const temp___544 privileget)
(declare-const temp___5441 opandnullt)
...
(assert (= temp___5441 o2))
(assert (= result theadmin__split_fields))
(assert (= result1 theadmin__split_fields1))
(assert (= temp___544 theadmin__split_fields2))
(assert (= temp___5441 theadmin__split_fields3))
