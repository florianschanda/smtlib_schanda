...
(declare-const temp___1002 read_status)
(declare-const temp___10021 character)
(declare-const temp___10022 Bool)
...
(declare-const the_file6 us_rep1)
...
(declare-const the_file8 us_rep1)
...
(declare-const the_file10 us_rep1)
...
(declare-const the_file12 us_rep1)
...
(declare-const the_file14 us_rep1)
...
(assert (= temp___1007 the_file))
(assert (and (= temp___1006 next_read__split_discrs) (and (= temp___10061 next_read__split_fields) (= temp___10062 next_read__attr__constrained))))
(assert (= temp___1005 current_pos))
(assert (= temp___1004 current_col))
(assert (= temp___1003 current_line))
(assert (and (= temp___1002 current_read__split_discrs) (and (= temp___10021 current_read__split_fields) (= temp___10022 current_read__attr__constrained))))
...
(assert (=> (= result true) (= temp___993 the_file1)))
...
(assert (not (= (local_invariant (us_split_fields__content current_read__split_fields14) (us_split_discrs__content current_read__split_discrs14) (us_split_fields__content next_read__split_fields14) (us_split_discrs__content next_read__split_discrs14)) true)))
(check-sat)
(exit)
