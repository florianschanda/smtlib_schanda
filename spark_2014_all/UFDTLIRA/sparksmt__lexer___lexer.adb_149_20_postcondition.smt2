...
(declare-const temp___927 read_status)
(declare-const temp___9271 character)
(declare-const temp___9272 Bool)
(declare-const temp___926 Int)
(declare-const temp___925 Int)
(declare-const temp___924 Int)
(declare-const temp___923 read_status)
(declare-const temp___9231 character)
(declare-const temp___9232 Bool)
...
(assert (= temp___928 the_file))
(assert (and (= temp___927 next_read__split_discrs) (and (= temp___9271 next_read__split_fields) (= temp___9272 next_read__attr__constrained))))
(assert (= temp___926 current_pos))
(assert (= temp___925 current_col))
(assert (= temp___924 current_line))
(assert (and (= temp___923 current_read__split_discrs) (and (= temp___9231 current_read__split_fields) (= temp___9232 current_read__attr__constrained))))
...
(assert (=> (= result true) (= temp___914 the_file1)))
