...
(assert (= temp___918 the_file))
(assert (and (= temp___917 next_read__split_discrs) (and (= temp___9171 next_read__split_fields) (= temp___9172 next_read__attr__constrained))))
(assert (= temp___916 current_pos))
(assert (= temp___915 current_col))
(assert (= temp___914 current_line))
(assert (and (= temp___913 current_read__split_discrs) (and (= temp___9131 current_read__split_fields) (= temp___9132 current_read__attr__constrained))))
...
(assert (= next_read__split_discrs11 next_read__split_discrs6))
(assert (= next_read__split_fields11 next_read__split_fields6))
(assert (= current_pos11 current_pos6))
(assert (= current_col11 current_col6))
(assert (= current_line11 current_line6))
(assert (= current_read__split_discrs11 current_read__split_discrs6))
(assert (= current_read__split_fields11 current_read__split_fields6))
(assert (= the_file7 the_file5))
(assert (= next_read__split_discrs12 next_read__split_discrs7))
(assert (= next_read__split_fields12 next_read__split_fields7))
(assert (= current_pos12 current_pos7))
(assert (= current_col12 current_col7))
(assert (= current_line12 current_line7))
(assert (= current_read__split_discrs12 current_read__split_discrs7))
(assert (= current_read__split_fields12 current_read__split_fields7))
...
(assert (= next_read__split_discrs16 next_read__split_discrs14))
(assert (= next_read__split_fields16 next_read__split_fields14))
(assert (= current_pos16 current_pos14))
(assert (= current_col16 current_col14))
(assert (= current_line16 current_line14))
(assert (= current_read__split_discrs16 current_read__split_discrs14))
(assert (= current_read__split_fields16 current_read__split_fields14))
(assert (= the_file12 the_file10))
(assert (= next_read__split_discrs17 next_read__split_discrs15))
(assert (= next_read__split_fields17 next_read__split_fields15))
(assert (= current_pos17 current_pos15))
(assert (= current_col17 current_col15))
(assert (= current_line17 current_line15))
(assert (= current_read__split_discrs17 current_read__split_discrs15))
(assert (= current_read__split_fields17 current_read__split_fields15))
...
(assert (= current_pos18 current_pos16))
...
(assert (not (= (local_invariant (us_split_fields__content current_read__split_fields17) (us_split_discrs__content current_read__split_discrs17) (us_split_fields__content next_read__split_fields17) (us_split_discrs__content next_read__split_discrs17)) true)))
(check-sat)
(exit)
