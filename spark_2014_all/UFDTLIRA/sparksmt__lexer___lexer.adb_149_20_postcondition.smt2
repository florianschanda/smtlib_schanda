...
(declare-const temp___1013 read_status)
(declare-const temp___10131 character)
(declare-const temp___10132 Bool)
(declare-const temp___1012 Int)
(declare-const temp___1011 Int)
(declare-const temp___1010 Int)
(declare-const temp___1009 read_status)
(declare-const temp___10091 character)
(declare-const temp___10092 Bool)
...
(assert (= temp___1014 the_file))
(assert (and (= temp___1013 next_read__split_discrs) (and (= temp___10131 next_read__split_fields) (= temp___10132 next_read__attr__constrained))))
(assert (= temp___1012 current_pos))
(assert (= temp___1011 current_col))
(assert (= temp___1010 current_line))
(assert (and (= temp___1009 current_read__split_discrs) (and (= temp___10091 current_read__split_fields) (= temp___10092 current_read__attr__constrained))))
...
(assert (=> (= result true) (= temp___1000 the_file1)))
