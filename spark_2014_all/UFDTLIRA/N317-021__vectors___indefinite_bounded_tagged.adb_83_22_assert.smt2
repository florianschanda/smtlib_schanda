...
(assert (not (= (let ((temp___670 (f 3))) (let ((temp___669 (get (model__ (mk___rep v__split_discrs v__split_fields9)) 2))) (ite (= (attr__tag temp___669) (attr__tag temp___670)) (us_dispatch_eq temp___669 temp___670) false))) true)))
(check-sat)
(exit)
