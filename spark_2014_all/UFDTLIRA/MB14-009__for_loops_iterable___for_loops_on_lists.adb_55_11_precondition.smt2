...
(declare-const temp___5471 us_rep1)
...
(assert (and (= o4 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 o4 no_element) true) (and (= (has_key (positions l) o4) true) (= (get1 (positions l) o4) 1)))))
(assert (= temp___547 o))
...
(assert (=> (< 0 count_03) (exists ((cu us_rep1)) (and (= (has_key (positions l) cu) true) (= (element l cu) 0)))))
(assert (=> (< 0 count_12) (exists ((cu us_rep1)) (and (= (has_key (positions l) cu) true) (= (element l cu) 1)))))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 count_03)) (=> (<= 0 2147483647) (in_range2 count_12))) (=> (<= 0 2147483647) (in_range3 e3))) (and (= (has_key (positions l) temp___5471) true) (= e3 (element l temp___5471)))))
...
(assert (not (or (= (has_key (positions l) temp___5471) true) (= (bool_eq1 temp___5471 no_element) true))))
(check-sat)
(exit)
