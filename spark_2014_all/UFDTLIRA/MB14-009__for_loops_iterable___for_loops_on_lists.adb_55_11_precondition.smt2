...
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 count_03)) (=> (<= 0 2147483647) (in_range2 count_12))) (=> (<= 0 2147483647) (in_range3 e3))) (and (= (has_key (positions l) temp___5051) true) (= e3 (element l temp___5051)))))
...
(assert (not (or (= (has_key (positions l) temp___5051) true) (= (bool_eq1 temp___5051 no_element) true))))
(check-sat)
(exit)
