...
(assert (=> (< 0 count_03) (exists ((cu2 us_rep1)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 0)))))
(assert (=> (< 0 count_12) (exists ((cu2 us_rep1)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 1)))))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 count_03)) (=> (<= 0 2147483647) (in_range2 count_12))) (=> (<= 0 2147483647) (in_range3 e5))) (and (= (has_key (positions l) temp___5052) true) (= e5 (element l temp___5052)))))
(assert (=> (= e5 1) (and (= o9 (+ count_12 1)) (in_range1 (+ count_12 1)))))
(assert (=> (= e5 1) (= result8 (mk_int__ref count_12))))
(assert (=> (= e5 1) (= count_13 o9)))
(assert (=> (not (= e5 1)) (= count_13 count_12)))
(assert (not (or (= (has_key (positions l) temp___5052) true) (= (bool_eq1 temp___5052 no_element) true))))
(check-sat)
(exit)
