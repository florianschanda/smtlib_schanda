...
(define-fun dynamic_invariant ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 1 2147483647)) (in_range2 temp___expr_340)))
...
(define-fun dynamic_invariant1 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 0 2147483647)) (in_range3 temp___expr_352)))
...
(define-fun default_initial_assumption ((temp___expr_359 us_rep) (temp___skip_top_level_360 Bool)) Bool (=> (not (= temp___skip_top_level_360 true)) (= (length temp___expr_359) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_346)))
