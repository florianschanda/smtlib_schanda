...
(define-fun dynamic_invariant1 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 2147483647)) (in_range1 temp___expr_422)))
...
(define-fun dynamic_invariant2 ((temp___expr_408 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool) (temp___do_typ_inv_407 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 2147483647)) (in_range3 temp___expr_408)))
...
(define-fun dynamic_invariant3 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_415)))
...
(assert (= result true))
(assert (and (= o1 (last container)) (and (in_range1 o1) (= o1 (+ 0 (length container))))))
(assert (= result1 (ite (< o1 2147483647) true false)))
(assert (= result1 true))
(assert (and (= o (last container)) (and (in_range1 o) (= o (+ 0 (length container))))))
