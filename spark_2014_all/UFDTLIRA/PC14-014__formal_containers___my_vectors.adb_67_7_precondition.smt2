...
(assert (not (or (and (<= 1 o17) (<= o17 (last (model__ (mk___rep k__split_discrs k__split_fields3))))) (and (not (= o17 0)) (= (- o17 1) (last (model__ (mk___rep k__split_discrs k__split_fields3))))))))
(check-sat)
(exit)
