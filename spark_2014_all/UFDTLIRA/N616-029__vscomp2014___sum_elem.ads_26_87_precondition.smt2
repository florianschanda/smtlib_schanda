...
(declare-fun user_eq1 (partition_index partition_index) Bool)
(declare-const dummy1 partition_index)
...
(define-fun dynamic_invariant ((temp___expr_203 Int) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool)) Bool (=> (or (= temp___is_init_200 true) (<= 0 10000)) (in_range2 temp___expr_203)))
...
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 10001)))
...
(define-fun dynamic_invariant1 ((temp___expr_229 Int) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (=> (or (= temp___is_init_226 true) (<= 0 10001)) (in_range4 temp___expr_229)))
...
(assert (forall ((x capacity_range)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= (- 1) 10001)) (in_range5 temp___expr_223)))
(declare-fun first_index__function_guard (Int us_rep1) Bool)
(define-fun dynamic_invariant3 ((temp___expr_209 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 10000)) (in_range3 temp___expr_209)))
...
(define-fun dynamic_invariant4 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 5)) (in_range1 temp___expr_189)))
...
(define-fun dynamic_invariant5 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range6 temp___expr_141)))
...
(define-fun default_initial_assumption ((temp___expr_265 us_rep2) (temp___skip_top_level_266 Bool)) Bool (=> (not (= temp___skip_top_level_266 true)) (= (length1 temp___expr_265) 0)))
...
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant5 result true false true))) :pattern ((length1 container)))))
(assert true)
(declare-const j Int)
(declare-const o Int)
...
(assert (in_range2 x))
(assert (and (= o14 (length p)) (and (in_range4 o14) (<= o14 (capacity p)))))
(assert (and (= o15 o14) (in_range2 o14)))
(assert (= o16 (- o15 1)))
(assert (= o17 (ite (<= x o16) true false)))
(assert (= result (ite (<= 0 x) o17 false)))
(assert (= result true))
(assert (and (= o1 (last (model__ p))) (and (in_range5 o1) (= o1 (last (model__ p))))))
(assert (= o2 (ite (<= j o1) true false)))
(assert (and (= o 0) (and (in_range3 o) (= o 0))))
(assert (= o3 (ite (<= o j) true false)))
(assert (= result1 (ite (= o3 true) o2 false)))
(assert (= result1 true))
(assert (and (= o7 j) (in_range3 j)))
(assert (not (<= 0 o7)))
(check-sat)
(exit)
