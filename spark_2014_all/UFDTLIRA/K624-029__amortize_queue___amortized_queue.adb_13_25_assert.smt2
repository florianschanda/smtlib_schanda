...
(assert (= idx1 1))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= temp___543 idx1)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (= result____split_discrs (mk___split_discrs temp___542)) (= result____split_fields temp___5421))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (= o2 idx1) (in_range6 idx1))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (= o3 (get (model__ left) o2)) (and (in_range4 o3) (= o3 (get (model__ left) o2))))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (and (= (length (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (length (mk___rep result____split_discrs (mk___split_fields result____split_fields))) 1)) (= (olt (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields))) (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1))) true)) (= (get (model__ (mk___rep result____split_discrs amortized_queue__my_vectors__append__2__container__fields1)) (+ (last (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields)))) 1)) o3))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields9)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= (mk___split_fields result____split_fields2) amortized_queue__my_vectors__append__2__container__fields1)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= (length (mk___rep result____split_discrs result____split_fields8)) idx2)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields8)) i) (get (model__ left) i))))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (=> (<= 1 r4b) (dynamic_property 1 r4b idx2)) (and (<= 1 idx2) (<= idx2 r4b)))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx2 r4b)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx3 (mk_int__ref idx2))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= result____split_fields4 (mk___split_fields__ref result____split_fields8))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx4 idx2)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= result____split_fields5 result____split_fields8)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx5 idx3)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= result____split_fields6 result____split_fields4)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= idx6 idx4)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= result____split_fields7 result____split_fields5)))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r4b))) (= idx5 (mk_int__ref idx1))))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r4b))) (= result____split_fields6 result____split_fields9)))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r4b))) (= idx6 idx1)))
(assert (=> (not (and (<= 1 idx1) (<= idx1 r4b))) (= result____split_fields7 (mk___split_fields result____split_fields1))))
(assert (not (= (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields6))) (last (model__ left)))))
(check-sat)
(exit)
