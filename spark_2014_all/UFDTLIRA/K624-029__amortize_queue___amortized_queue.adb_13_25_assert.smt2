...
(assert (= idx1 1))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (= temp___541 idx1)))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (= result____split_discrs (mk___split_discrs temp___540)) (= result____split_fields temp___5401))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (= o2 idx1) (in_range3 idx1))))
(assert (=> (and (<= 1 idx1) (<= idx1 r4b)) (and (= o3 (get (model__ left) o2)) (and (in_range6 o3) (= o3 (get (model__ left) o2))))))
