...
(assert (= result1 true))
(assert (or (= position2 1) (< (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) (- position2 1)) new_item)))
(assert (and (=> (<= 1 100) (in_range3 position2)) (and (<= position2 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (< (get (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))) position2) new_item))))
(assert (and (= o3 1) (and (in_range4 o3) (= o3 1))))
(assert (= result3 (ite (= position2 o3) true false)))
(assert (not (= result3 true)))
(assert (not (in_range4 (- position2 1))))
(check-sat)
(exit)
