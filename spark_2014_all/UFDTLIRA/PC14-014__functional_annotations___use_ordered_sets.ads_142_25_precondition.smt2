...
(assert (let ((temp___441 (elements s))) (forall ((temp___440 Int)) (=> (and (in_range3 temp___440) (= (iter_has_element temp___441 temp___440) true)) (exists ((i1 us_rep1)) (and (= (has_key (positions s) i1) true) (= (get (elements s) (get1 (positions s) i1)) (get temp___441 temp___440))))))))
