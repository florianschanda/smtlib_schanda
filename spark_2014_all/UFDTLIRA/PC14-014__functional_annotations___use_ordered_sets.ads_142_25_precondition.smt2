...
(assert (let ((temp___399 (elements s))) (forall ((temp___398 Int)) (=> (and (in_range3 temp___398) (= (iter_has_element temp___399 temp___398) true)) (exists ((i1 us_rep1)) (and (= (has_key (positions s) i1) true) (= (get (elements s) (get1 (positions s) i1)) (get temp___399 temp___398))))))))
(assert (and (= o3 (length s)) (and (in_range1 o3) (<= o3 (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 s)))))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (= result1 (ite (<= 1 i) o4 false)))
(assert (= result1 true))
(assert (and (= o5 (elements s)) (and (and (and (= (length2 o5) (length s)) (forall ((temp___390 Int)) (=> (and (in_range3 temp___390) (= (iter_has_element o5 temp___390) true)) (= (contains (model__ s) (get o5 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s) item) true)) (and (< 0 (find o5 item)) (= (equivalent_elements (get o5 (find o5 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o5 (get o5 i1)) i1) (= (e_is_find o5 (get o5 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
