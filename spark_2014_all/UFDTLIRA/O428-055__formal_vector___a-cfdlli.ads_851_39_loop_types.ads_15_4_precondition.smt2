...
(define-fun dynamic_invariant1 ((temp___expr_408 Int) (temp___is_init_405 Bool) (temp___skip_constant_406 Bool) (temp___do_toplevel_407 Bool)) Bool (=> (or (= temp___is_init_405 true) (<= 1 2147483647)) (in_range3 temp___expr_408)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption1 ((temp___expr_415 us_rep2) (temp___skip_top_level_416 Bool)) Bool (=> (not (= temp___skip_top_level_416 true)) (and (= (is_empty temp___expr_415) true) (= (length1 temp___expr_415) 0))))
