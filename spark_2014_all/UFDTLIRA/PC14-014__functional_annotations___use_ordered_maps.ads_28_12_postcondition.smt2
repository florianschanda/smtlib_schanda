...
(define-fun dynamic_invariant1 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 1 2147483647)) (in_range2 temp___expr_289)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun k_bigger_than_range ((container us_rep4) (fst Int) (lst Int) (key2 Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (< (get container i) key2))) true false))
(declare-fun k_bigger_than_range__function_guard (Bool us_rep4 Int Int Int) Bool)
(define-fun k_smaller_than_range ((container us_rep4) (fst Int) (lst Int) (key2 Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (< key2 (get container i)))) true false))
(declare-fun k_smaller_than_range__function_guard (Bool us_rep4 Int Int Int) Bool)
(define-fun k_is_find ((container us_rep4) (key2 Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key2) (of_int 1)) (ite (< position (length2 container)) (k_smaller_than_range container (+ position 1) (length2 container) key2) (of_int 1))))
...
(define-fun default_initial_assumption ((temp___expr_365 us_rep4) (temp___skip_top_level_366 Bool)) Bool (=> (not (= temp___skip_top_level_366 true)) (= (length2 temp___expr_365) 0)))
(declare-fun find (us_rep4 Int) Int)
(declare-fun find__function_guard (Int us_rep4 Int) Bool)
(assert (forall ((container us_rep4)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant2 result true false true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___399 Int)) (=> (and (in_range5 temp___399) (= (iter_has_element result temp___399) true)) (= (has_key (model__ container) (get result temp___399)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ container) key2) true)) (and (< 0 (find result key2)) (= (equivalent_keys (get result (find result key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(assert true)
(define-fun dynamic_invariant3 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 2147483647)) (in_range4 temp___expr_321)))
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k1 Int)) (and (and (in_range4 k1) (= (has_key container k1) true)) (= (equivalent_keys k1 key2) true))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant3 key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k1 Int)) (=> (and (in_range4 k1) (= (has_key container k1) true)) (= (= (equivalent_keys k1 key2) true) (= (witness container key2) (witness container k1))))))) (dynamic_invariant4 result true false true)))) :pattern ((get2 container key2))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant3 key2 true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant4 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (forall ((container us_rep4)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 2147483647)) (in_range7 temp___expr_352)))
...
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (get1 container key2))) (and (=> (= (of_int 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k1 us_rep1)) (=> (= (has_key1 container k1) true) (= (= (bool_eq1 k1 key2) true) (= (witness1 container key2) (witness1 container k1))))))) (dynamic_invariant7 result true false true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant2 (length4 container) true false true) :pattern ((length4 container)))))
...
(assert true)
(assert (forall ((container us_rep3)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep3)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant7 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
