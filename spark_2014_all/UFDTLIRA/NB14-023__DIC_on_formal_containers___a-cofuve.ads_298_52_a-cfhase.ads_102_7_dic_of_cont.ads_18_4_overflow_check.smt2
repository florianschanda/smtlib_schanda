...
(define-fun dynamic_invariant ((temp___expr_853 Int) (temp___is_init_849 Bool) (temp___skip_constant_850 Bool) (temp___do_toplevel_851 Bool) (temp___do_typ_inv_852 Bool)) Bool (=> (or (= temp___is_init_849 true) (<= 1 2147483647)) (in_range1 temp___expr_853)))
...
(define-fun dynamic_invariant1 ((temp___expr_860 Int) (temp___is_init_856 Bool) (temp___skip_constant_857 Bool) (temp___do_toplevel_858 Bool) (temp___do_typ_inv_859 Bool)) Bool (=> (or (= temp___is_init_856 true) (<= 0 2147483647)) (in_range2 temp___expr_860)))
...
(define-fun dynamic_invariant3 ((temp___expr_867 Int) (temp___is_init_863 Bool) (temp___skip_constant_864 Bool) (temp___do_toplevel_865 Bool) (temp___do_typ_inv_866 Bool)) Bool (=> (or (= temp___is_init_863 true) (<= 0 2147483647)) (in_range5 temp___expr_867)))
