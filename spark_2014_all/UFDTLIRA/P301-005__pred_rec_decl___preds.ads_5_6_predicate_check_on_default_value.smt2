...
(declare-const x Int)
(declare-const temp___355 int_ok)
(assert (dynamic_invariant i7s true false true true))
(assert (dynamic_invariant x false false true true))
(assert (= (to_rep temp___355) 1))
(define-fun temp___357 () Int (to_rep temp___355))
(assert (not (or (and (<= (- 2147483648) temp___357) (<= temp___357 (- 1))) (and (<= 1 temp___357) (<= temp___357 2147483647)))))
(check-sat)
(exit)
