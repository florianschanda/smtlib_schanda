...
(assert (and (= o43 (last1 (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq1 o43 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o43) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o43) (length (mk___rep l3__split_discrs l3__split_fields2)))))))
