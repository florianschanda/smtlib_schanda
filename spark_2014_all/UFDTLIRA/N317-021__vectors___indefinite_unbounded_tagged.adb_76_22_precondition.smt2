...
(declare-const temp___664 us_rep1)
...
(assert (and (= temp___664 (f 4)) (= temp___664 (mk___rep1 (mk___split_fields1 (of_rep1 4) us_null_ext__) us_tag))))
(assert (not (<= 1 (last (model__ (mk___rep v__split_discrs v__split_fields9))))))
(check-sat)
(exit)
