...
(assert (and (= o8 (last left)) (and (in_range4 o8) (= o8 (+ 0 (length left))))))
(assert (= result (ite (<= lst o8) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o7 (- (- 2147483648) offset)) (in_range5 (- (- 2147483648) offset)))))
