...
(assert (= result1 true))
(assert (not (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1))) (+ (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields))) 1))))
(check-sat)
(exit)
