...
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))))
(assert (and (= o6 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 cu__split_fields3))) (= (= o6 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 cu__split_fields3)) true))))
(assert (= result4 (ite (not (= o6 true)) true false)))
(assert (not (= result4 true)))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) (mk___rep1 cu__split_fields3)) 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields3))) i1) 0)))
(check-sat)
(exit)
