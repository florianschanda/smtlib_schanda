...
(assert (= (= result7 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (last (model__ left)))) (= (get (model__ (vector__content amortized_queue__Oconcat__3__result5)) i2) (get (model__ left) i2))))))
(assert (= result7 true))
(assert (and (= o9 (last (model__ left))) (and (in_range4 o9) (= o9 (last (model__ left))))))
(assert (= o10 (+ o9 1)))
