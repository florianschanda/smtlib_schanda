...
(assert (and (= o7 (length left)) (and (in_range1 o7) (<= o7 (capacity left)))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 (length (vector__content amortized_queue__Oconcat__3__result5))) (and (in_range1 o9) (<= o9 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
(assert (= result4 (ite (= o9 o8) true false)))
(assert (= result4 true))
(assert (and (= o5 (last (model__ left))) (and (in_range2 o5) (= o5 (last (model__ left))))))
