...
(assert (forall ((i capacity_range)) (and (<= 0 (capacity_rangeqtint i)) (<= (capacity_rangeqtint i) 3))))
...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__fail__my_lists__vector__capacity capacity_range)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) capacity_range (rec__fail__my_lists__vector__capacity a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__fail__my_lists__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type1 (rec__fail__my_lists__vector a))
...
(assert (< fail__my_lists__vector__capacity__first__bit fail__my_lists__vector__capacity__last__bit))
...
(define-fun dynamic_invariant ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 4)) (in_range2 temp___expr_269)))
(declare-sort index_type 0)
(declare-fun index_typeqtint (index_type) Int)
(assert (forall ((i index_type)) (and (<= 1 (index_typeqtint i)) (<= (index_typeqtint i) 3))))
...
(define-fun dynamic_invariant1 ((temp___expr_255 Int) (temp___is_init_251 Bool) (temp___skip_constant_252 Bool) (temp___do_toplevel_253 Bool) (temp___do_typ_inv_254 Bool)) Bool (=> (or (= temp___is_init_251 true) (<= 1 3)) (in_range3 temp___expr_255)))
...
(define-fun dynamic_invariant2 ((temp___expr_262 Int) (temp___is_init_258 Bool) (temp___skip_constant_259 Bool) (temp___do_toplevel_260 Bool) (temp___do_typ_inv_261 Bool)) Bool (=> (or (= temp___is_init_258 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_262)))
(declare-sort extended_index1 0)
(declare-fun extended_indexqtint1 (extended_index1) Int)
(assert (forall ((i extended_index1)) (and (<= 0 (extended_indexqtint1 i)) (<= (extended_indexqtint1 i) 3))))
...
(define-fun dynamic_invariant4 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 3)) (in_range1 temp___expr_214)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep (rec__fail__my_lists__vector__capacity (us_split_discrs1 container1))) 3))
...
(define-fun dynamic_invariant5 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= 0 3)) (in_range5 temp___expr_294)))
(assert (forall ((container1 us_rep)) (! (let ((result (length container1))) (and (<= (+ 0 result) 3) (dynamic_invariant3 result true false true true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_287)))
