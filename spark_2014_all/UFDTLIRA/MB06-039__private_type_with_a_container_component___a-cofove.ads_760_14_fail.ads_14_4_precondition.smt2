...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__fail__my_lists__vector us_main_type)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields)) us_main_type (rec__fail__my_lists__vector a))
...
(define-fun dynamic_invariant ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= 1 3)) (in_range2 temp___expr_219)))
...
(define-fun dynamic_invariant1 ((temp___expr_225 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_225)))
...
(define-fun default_initial_assumption ((temp___expr_260 us_rep1) (temp___skip_top_level_261 Bool)) Bool (=> (not (= temp___skip_top_level_261 true)) (= (length temp___expr_260) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 4)) (in_range5 temp___expr_231)))
...
(define-fun dynamic_invariant4 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 3)) (in_range1 temp___expr_183)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__fail__my_lists__vector__capacity (us_split_discrs1 container1))) 3))
...
(define-fun dynamic_invariant5 ((temp___expr_253 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 3)) (in_range4 temp___expr_253)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ 0 result) 3) (dynamic_invariant3 result true false true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_247 Int) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool)) Bool (=> (or (= temp___is_init_244 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_247)))
