...
(assert (and (= o5 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o5 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o5 i4) true) (and (and (<= 1 (get1 o5 i4)) (<= (get1 o5 i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep1)) (=> (= (has_key o5 j) true) (=> (= (get1 o5 i4) (get1 o5 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (and (= result (has_key o5 fst)) (=> (= (of_int 0) true) (=> (exists ((k us_rep1)) (and (= (has_key o5 k) true) (= (bool_eq1 k fst) true))) (= result true)))))
(assert (= result true))
(assert (and (= o4 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o4 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o4 i4) true) (and (and (<= 1 (get1 o4 i4)) (<= (get1 o4 i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep1)) (=> (= (has_key o4 j) true) (=> (= (get1 o4 i4) (get1 o4 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (and (= result1 (has_key o4 lst)) (=> (= (of_int 0) true) (=> (exists ((k us_rep1)) (and (= (has_key o4 k) true) (= (bool_eq1 k lst) true))) (= result1 true)))))
(assert (= result1 true))
(assert (and (= o1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o1 no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o1 i4) true) (and (and (<= 1 (get1 o1 i4)) (<= (get1 o1 i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep1)) (=> (= (has_key o1 j) true) (=> (= (get1 o1 i4) (get1 o1 j)) (= (bool_eq1 i4 j) true))))))))))
(assert (and (= o2 (get1 o1 fst)) (and (in_range4 o2) (=> (= (of_int 0) true) (and (= o2 (w_get o1 (witness o1 fst))) (forall ((k us_rep1)) (=> (= (has_key o1 k) true) (= (= (bool_eq1 k fst) true) (= (witness o1 fst) (witness o1 k))))))))))
(assert (and (= o (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (and (not (= (has_key o no_element) true)) (forall ((i4 us_rep1)) (=> (= (has_key o i4) true) (and (and (<= 1 (get1 o i4)) (<= (get1 o i4) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i4) (get1 o j)) (= (bool_eq1 i4 j) true))))))))))
