...
(assert (and (= result (has_key o4 fst)) (=> (= (of_int 0) true) (=> (exists ((k us_rep1)) (and (= (has_key o4 k) true) (= (bool_eq1 k fst) true))) (= result true)))))
(assert (= result true))
...
(assert (and (= result1 (has_key o3 lst)) (=> (= (of_int 0) true) (=> (exists ((k us_rep1)) (and (= (has_key o3 k) true) (= (bool_eq1 k lst) true))) (= result1 true)))))
(assert (= result1 true))
