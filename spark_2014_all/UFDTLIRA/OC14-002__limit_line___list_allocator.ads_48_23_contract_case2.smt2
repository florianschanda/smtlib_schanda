...
(assert (= j13 j11))
(assert (=> (= (mem s r) true) (and (and (<= 1 list_allocator__m__find__result16) (<= list_allocator__m__find__result16 (length s))) (= (get s list_allocator__m__find__result16) r))))
(assert (not (= (mem s r) true)))
(assert (not (= list_allocator__m__find__result16 0)))
(check-sat)
(exit)
