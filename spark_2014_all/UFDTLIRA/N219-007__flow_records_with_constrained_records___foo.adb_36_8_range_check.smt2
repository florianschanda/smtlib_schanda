...
(assert (forall ((x value_kind)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x value_kind)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun in_range3 ((rec__foo__value__kind1 Int) (a us_rep)) Bool (= rec__foo__value__kind1 (to_rep (rec__foo__value__kind (us_split_discrs1 a)))))
...
(declare-datatypes () ((us_split_discrs2 (mk___split_discrs1 (rec__foo__record_b__kind value_kind)))))
(define-fun us_split_discrs___2__projection ((a us_split_discrs2)) value_kind (rec__foo__record_b__kind a))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__foo__record_b__f us_rep)))))
(define-fun us_split_fields_F__projection ((a us_split_fields2)) us_rep (rec__foo__record_b__f a))
...
(define-fun us_rep___5__projection ((a us_rep1)) us_split_discrs2 (us_split_discrs3 a))
(define-fun us_rep___6__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__foo__record_b__kind (us_split_discrs3 a))) (to_rep (rec__foo__record_b__kind (us_split_discrs3 b)))) (= (bool_eq (rec__foo__record_b__f (us_split_fields3 a)) (rec__foo__record_b__f (us_split_fields3 b))) true)) true false))
...
(declare-datatypes () ((record_b__ref (mk_record_b__ref (record_b__content us_rep1)))))
(define-fun record_b__ref___projection ((a record_b__ref)) us_rep1 (record_b__content a))
(define-fun dynamic_invariant1 ((temp___expr_198 us_rep1) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (and (and (in_range3 (to_rep (rec__foo__record_b__kind (us_split_discrs3 temp___expr_198))) (rec__foo__record_b__f (us_split_fields3 temp___expr_198))) (= (attr__constrained (rec__foo__record_b__f (us_split_fields3 temp___expr_198))) true)) (= (attr__constrained (rec__foo__record_b__f (us_split_fields3 temp___expr_198))) true)))
...
(define-fun default_initial_assumption ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__constrained temp___expr_167) false) (= (to_rep (rec__foo__value__kind (us_split_discrs1 temp___expr_167))) 0)))
...
(assert (dynamic_invariant1 (mk___rep1 v__split_discrs (mk___split_fields1 (mk___rep (mk___split_discrs v__split_fields) (mk___split_fields v__split_fields1 v__split_fields2) v__split_fields3))) true false true true))
(assert (= (to_rep (rec__foo__record_b__kind v__split_discrs)) r6b))
(assert (in_range1 r6b))
(assert (not (in_range1 r6b)))
(check-sat)
(exit)
