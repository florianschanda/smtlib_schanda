...
(define-fun dynamic_invariant1 ((temp___expr_172 us_rep1) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (and (and (in_range3 (to_rep (rec__foo__record_b__kind (us_split_discrs3 temp___expr_172))) (rec__foo__record_b__f (us_split_fields3 temp___expr_172))) (= (attr__constrained (rec__foo__record_b__f (us_split_fields3 temp___expr_172))) true)) (= (attr__constrained (rec__foo__record_b__f (us_split_fields3 temp___expr_172))) true)))
...
(define-fun default_initial_assumption ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (attr__constrained temp___expr_143) false) (= (to_rep (rec__foo__value__kind (us_split_discrs1 temp___expr_143))) 0)))
...
(assert (dynamic_invariant1 (mk___rep1 v__split_discrs (mk___split_fields1 (mk___rep (mk___split_discrs v__split_fields) (mk___split_fields v__split_fields1 v__split_fields2) v__split_fields3))) true false true))
