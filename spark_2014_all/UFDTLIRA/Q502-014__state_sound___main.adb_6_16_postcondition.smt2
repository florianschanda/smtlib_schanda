...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 0)) (in_range1 temp___expr_135)))
...
(assert (forall ((state__s1 Int)) (forall ((state__state us_private)) (! (=> (dynamic_invariant state__s1 true true true) (dynamic_invariant1 (get state__s1 state__state) true false true)) :pattern ((get state__s1 state__state))))))
...
(assert (in_range1 s1))
(assert (and (= (get s11 state) 0) (in_range1 s11)))
(assert (and (= (get s12 state1) 1) (in_range1 s12)))
