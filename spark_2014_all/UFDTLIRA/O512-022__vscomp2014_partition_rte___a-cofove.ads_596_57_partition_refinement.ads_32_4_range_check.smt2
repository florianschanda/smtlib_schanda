...
(define-fun dynamic_invariant1 ((temp___expr_727 Int) (temp___is_init_724 Bool) (temp___skip_constant_725 Bool) (temp___do_toplevel_726 Bool)) Bool (=> (or (= temp___is_init_724 true) (<= (- 1) 10001)) (in_range2 temp___expr_727)))
...
(define-fun dynamic_invariant2 ((temp___expr_733 Int) (temp___is_init_730 Bool) (temp___skip_constant_731 Bool) (temp___do_toplevel_732 Bool)) Bool (=> (or (= temp___is_init_730 true) (<= 0 10001)) (in_range3 temp___expr_733)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__partition_refinement__partitions__vector__capacity (us_split_discrs1 container))) 10001))
...
(define-fun dynamic_invariant3 ((temp___expr_712 Int) (temp___is_init_709 Bool) (temp___skip_constant_710 Bool) (temp___do_toplevel_711 Bool)) Bool (=> (or (= temp___is_init_709 true) (<= 0 10000)) (in_range4 temp___expr_712)))
...
(declare-fun user_eq6 (index_count index_count) Bool)
(declare-const dummy6 index_count)
...
(define-fun dynamic_invariant4 ((temp___expr_299 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 6)) (in_range5 temp___expr_299)))
(declare-sort index1 0)
(define-fun in_range6 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
(declare-fun attr__ATTRIBUTE_IMAGE6 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check6 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE6 (us_image) Int)
(declare-fun user_eq7 (index1 index1) Bool)
(declare-const dummy7 index1)
(declare-datatypes () ((index__ref (mk_index__ref (index__content index1)))))
(define-fun index__ref___projection ((a index__ref)) index1 (index__content a))
(define-fun dynamic_invariant5 ((temp___expr_305 Int) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (<= 0 5)) (in_range6 temp___expr_305)))
...
(assert (forall ((x index_count)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
(declare-fun to_rep2 (index1) Int)
(declare-fun of_rep2 (Int) index1)
(assert (forall ((x index1)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x index1)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range6 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__partition_refinement__interval__first index1) (rec__partition_refinement__interval__last index1) (rec__partition_refinement__interval__count index_count)))))
(define-fun us_split_fields_First__projection ((a us_split_fields2)) index1 (rec__partition_refinement__interval__first a))
(define-fun us_split_fields_Last__projection ((a us_split_fields2)) index1 (rec__partition_refinement__interval__last a))
...
(define-fun default_initial_assumption ((temp___expr_770 us_rep1) (temp___skip_top_level_771 Bool)) Bool (=> (not (= temp___skip_top_level_771 true)) (= (length1 temp___expr_770) 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_763 Int) (temp___is_init_760 Bool) (temp___skip_constant_761 Bool) (temp___do_toplevel_762 Bool)) Bool (=> (or (= temp___is_init_760 true) (<= (- 1) 10000)) (in_range7 temp___expr_763)))
