...
(define-fun dynamic_invariant1 ((temp___expr_350 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 2147483647)) (in_range2 temp___expr_350)))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 a))) (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 b)))) (= (us_main_eq (rec__partition_refinement__partitioning_sets__list (us_split_fields1 a)) (rec__partition_refinement__partitioning_sets__list (us_split_fields1 b))) true)) true false))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 a))) (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_364 us_rep1) (temp___skip_top_level_365 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_364))) 0))
(declare-const no_element us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_409 us_rep1) (temp___skip_top_level_410 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_409))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range4 temp___expr_415)))
...
(declare-const temp___1001 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1001 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1001)) no_element))
(assert (in_range2 new_item))
(assert (in_range1 count))
(assert (not (in_range (- (to_rep (rec__partition_refinement__partitioning_sets__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
