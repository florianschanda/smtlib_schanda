...
(define-fun dynamic_invariant ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range temp___expr_176)))
...
(assert (not (in_range1 (- (to_rep (rec__partition_refinement__partitioning_sets__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
