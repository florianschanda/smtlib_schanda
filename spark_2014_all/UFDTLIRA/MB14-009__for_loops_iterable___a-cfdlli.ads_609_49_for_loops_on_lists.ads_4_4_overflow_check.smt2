...
(define-fun dynamic_invariant1 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range2 temp___expr_183)))
...
(define-fun default_initial_assumption2 ((temp___expr_234 us_rep1) (temp___skip_top_level_235 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields3 temp___expr_234))) 0))
...
(declare-const temp___402 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___402 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___402)) no_element))
(assert (in_range2 new_item))
(assert (in_range1 count))
(assert (not (in_range (- (to_rep (rec__for_loops_on_lists__my_lists__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
