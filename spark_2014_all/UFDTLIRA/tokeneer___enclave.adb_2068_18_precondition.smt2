...
(assert (and (= o12 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range1 o12)))
(assert (= result3 (ite (= o12 1) true false)))
(assert (=> (= result3 true) (= o16 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= result3 true) (= o17 (ite (not (= o16 true)) true false))))
(assert (=> (= result3 true) (and (= o13 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range3 o13))))
(assert (=> (= result3 true) (= o14 (ite (= o13 3) true false))))
(assert (=> (= result3 true) (= o15 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
...
(assert (and (= o7 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range3 o7)))
(assert (= o8 (ite (= o7 3) true false)))
(assert (= o9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))))
(assert (= result4 (ite (= o9 true) o8 false)))
(assert (=> (= result4 true) (and (= o10 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range1 o10))))
...
(assert (=> (= result5 true) (and (= o3 (theauthcertrole state1)) (in_range1 o3))))
