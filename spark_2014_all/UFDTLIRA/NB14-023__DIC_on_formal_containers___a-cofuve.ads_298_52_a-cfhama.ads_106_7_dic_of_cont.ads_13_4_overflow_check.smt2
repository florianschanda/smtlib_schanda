...
(define-fun dynamic_invariant ((temp___expr_557 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 2147483647)) (in_range1 temp___expr_557)))
...
(define-fun dynamic_invariant1 ((temp___expr_563 Int) (temp___is_init_560 Bool) (temp___skip_constant_561 Bool) (temp___do_toplevel_562 Bool)) Bool (=> (or (= temp___is_init_560 true) (<= 0 2147483647)) (in_range2 temp___expr_563)))
...
(define-fun dynamic_invariant3 ((temp___expr_569 Int) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (or (= temp___is_init_566 true) (<= 0 2147483647)) (in_range5 temp___expr_569)))
