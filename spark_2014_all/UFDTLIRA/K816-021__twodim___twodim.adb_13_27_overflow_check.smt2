...
(declare-datatypes () ((any_matrix__ref (mk_any_matrix__ref (any_matrix__content us_t)))))
(define-fun any_matrix__ref___projection ((a any_matrix__ref)) us_t (any_matrix__content a))
(define-fun dynamic_invariant ((temp___expr_186 us_t) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool) (temp___do_typ_inv_185 Bool)) Bool (=> (not (= temp___skip_constant_183 true)) (dynamic_property2 (- 2147483648) 2147483647 (first2 temp___expr_186) (last2 temp___expr_186) (- 2147483648) 2147483647 (first_2 temp___expr_186) (last_2 temp___expr_186))))
