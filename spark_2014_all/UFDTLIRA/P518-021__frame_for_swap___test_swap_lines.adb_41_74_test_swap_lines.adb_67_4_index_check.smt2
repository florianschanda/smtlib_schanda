...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (- c3 1))) (and (= (to_rep (get m2 5 i3)) (to_rep (get temp___232 7 i3))) (= (to_rep (get m2 7 i3)) (to_rep (get temp___233 5 i3))))))))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 c9)) (and (= (to_rep (get m10 5 i3)) (to_rep (get temp___248 7 i3))) (= (to_rep (get m10 7 i3)) (to_rep (get temp___249 5 i3))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i3 Int)) (=> (and (<= (+ c9 1) i3) (<= i3 10)) (and (= (to_rep (get m10 5 i3)) (to_rep (get temp___250 5 i3))) (= (to_rep (get m10 7 i3)) (to_rep (get temp___251 7 i3))))))))
...
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- i2 1))) (forall ((h1 Int)) (=> (and (<= 1 h1) (<= h1 (- i2 1))) (=> (not (= k1 h1)) (= (to_rep (get m18 k1 h1)) (to_rep (get m17 k1 h1)))))))))
