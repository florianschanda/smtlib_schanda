...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (- c3 1))) (and (= (to_rep (get m2 5 i3)) (to_rep (get temp___265 7 i3))) (= (to_rep (get m2 7 i3)) (to_rep (get temp___266 5 i3))))))))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 c9)) (and (= (to_rep (get m10 5 i3)) (to_rep (get temp___281 7 i3))) (= (to_rep (get m10 7 i3)) (to_rep (get temp___282 5 i3))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i3 Int)) (=> (and (<= (+ c9 1) i3) (<= i3 10)) (and (= (to_rep (get m10 5 i3)) (to_rep (get temp___283 5 i3))) (= (to_rep (get m10 7 i3)) (to_rep (get temp___284 7 i3))))))))
