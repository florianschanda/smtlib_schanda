...
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (= (length2 o2) (length s)) (forall ((temp___439 Int)) (=> (and (in_range3 temp___439) (= (iter_has_element o2 temp___439) true)) (= (has_key (model__ s) (get o2 temp___439)) true)))) (forall ((key2 Int)) (=> (and (in_range4 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o2 key2)) (= (equivalent_keys (get o2 (find o2 key2)) key2) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o2 (get o2 i1)) i1) (= (k_is_find o2 (get o2 i1) i1) true)))))))
