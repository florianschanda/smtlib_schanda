...
(assert (and (and (and (and (= (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (- (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields1)) no_element) true)) (= (range_equal (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) 1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true)) (= (range_shifted (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) 1) true)) (= (p_positions_shifted (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields))) 1) true)))
(assert (not (< (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields1))) (to_rep (rec__p__my_lists__list__capacity l__split_discrs)))))
(check-sat)
(exit)
