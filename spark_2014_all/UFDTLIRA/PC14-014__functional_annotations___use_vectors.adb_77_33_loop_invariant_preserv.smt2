...
(assert (and (<= lst1 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))) (<= fst1 lst1)))
(assert (= (mk_int__ref result) (mk_int__ref current)))
(assert (= current1 fst1))
(assert (<= fst1 current1))
(assert (<= current1 lst1))
(assert (= (length (mk___rep v__split_discrs v__split_fields4)) (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))
(assert (forall ((i Int)) (=> (and (<= fst1 i) (<= i (- current2 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) i) 0))))
(assert (forall ((i Int)) (=> (and (<= first i) (<= i (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) i) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i)))))
(assert (forall ((i Int)) (=> (and (<= current2 i) (<= i (last5 (model__ (mk___rep v__split_discrs v__split_fields4))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) i) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i)))))
(assert (and (and (=> (<= fst1 lst1) (dynamic_property6 fst1 lst1 current2)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))) (and (<= fst1 current2) (<= current2 lst1))))
(assert (and (and (and (= (length (mk___rep v__split_discrs v__split_fields3)) (length (mk___rep v__split_discrs v__split_fields4))) (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) current2) 0)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields4)) (model__ (mk___rep v__split_discrs v__split_fields3)) current2) true)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
(assert (not (= current2 lst1)))
(assert (= result1 current2))
(assert (= current3 (+ current2 1)))
(assert (not (= (length (mk___rep v__split_discrs v__split_fields3)) (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(check-sat)
(exit)
