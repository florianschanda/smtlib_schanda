...
(declare-const temp___473 tcount_typeB)
(declare-const temp___4731 us_main_type)
(declare-const temp___472 Int)
(declare-const temp___476 us_rep1)
(declare-const temp___474 Int)
(declare-const temp___475 us_rep1)
(declare-const i Int)
(declare-const o Int)
...
(assert (forall ((i4 Int)) (=> (and (<= fst1 i4) (<= i4 (- current2 1))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) i4) 0))))
(assert (forall ((i4 Int)) (=> (and (<= first i4) (<= i4 (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) i4) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i4)))))
(assert (forall ((i4 Int)) (=> (and (<= current2 i4) (<= i4 (last5 (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) i4) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i4)))))
...
(assert (and (and (and (= (length (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) (length (mk___rep v__split_discrs (mk___split_fields v__split_fields2)))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) current2) 0)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) current2) true)) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
(assert (not (= current2 lst1)))
(assert (= result4 current2))
(assert (= current3 (+ current2 1)))
(assert (not (= (length (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) (length (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(check-sat)
(exit)
