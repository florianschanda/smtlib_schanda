...
(define-fun dynamic_invariant1 ((temp___expr_172 us_rep1) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (= (attr__constrained (rec__discr__holder__content (us_split_fields1 temp___expr_172))) false))
(define-fun default_initial_assumption1 ((temp___expr_174 us_rep1) (temp___skip_top_level_175 Bool)) Bool (and (= (attr__constrained (rec__discr__holder__content (us_split_fields1 temp___expr_174))) false) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 (rec__discr__holder__content (us_split_fields1 temp___expr_174))))) 0)))
(declare-const c Int)
...
(define-fun dynamic_invariant2 ((temp___expr_205 us_rep) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (and (=> (not (= temp___skip_constant_203 true)) (in_range1 c temp___expr_205)) (= (attr__constrained temp___expr_205) true)))
(define-fun default_initial_assumption2 ((temp___expr_207 us_rep) (temp___skip_top_level_208 Bool)) Bool (and (= (attr__constrained temp___expr_207) true) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_207))) c)))
...
(assert (= (mk___rep (mk___split_discrs discr__r5__d1__assume) discr__r5__d1__assume1) (mk___rep (mk___split_discrs o6) o7)))
...
(assert (not (not (= (attr__constrained (rec__discr__holder__content h__split_fields3)) true))))
(check-sat)
(exit)
