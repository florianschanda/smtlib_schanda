...
(define-fun dynamic_invariant1 ((temp___expr_211 Int) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (or (= temp___is_init_208 true) (<= 0 2147483647)) (in_range2 temp___expr_211)))
...
(define-fun dynamic_invariant2 ((temp___expr_217 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 0 1001)) (in_range5 temp___expr_217)))
...
(define-fun dynamic_invariant4 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= 0 1000)) (in_range3 temp___expr_223)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__loop_types__vectors__vector__capacity (us_split_discrs1 container1))) 1000))
...
(define-fun dynamic_invariant5 ((temp___expr_250 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 0 1000)) (in_range4 temp___expr_250)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ 0 result) 1000) (dynamic_invariant3 result true false true))) :pattern ((length container1)))))
...
(define-fun dynamic_invariant6 ((temp___expr_244 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 2147483647)) (in_range7 temp___expr_244)))
...
(assert (and (= o2 (last (model__ container))) (and (in_range5 o2) (= o2 (last (model__ container))))))
(assert (not (in_range4 o2)))
(check-sat)
(exit)
