...
(assert (and (= o15 (first (mk___rep l1__split_discrs l1__split_fields4))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields4)) 0) true) (= (bool_eq1 o15 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o15) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o15) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o15) true) (= (bool_eq1 o15 no_element) true))))
(check-sat)
(exit)
