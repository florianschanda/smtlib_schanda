...
(define-fun dynamic_invariant2 ((temp___expr_418 Int) (temp___is_init_414 Bool) (temp___skip_constant_415 Bool) (temp___do_toplevel_416 Bool) (temp___do_typ_inv_417 Bool)) Bool (=> (or (= temp___is_init_414 true) (<= 1 2147483647)) (in_range3 temp___expr_418)))
...
(define-fun default_initial_assumption1 ((temp___expr_426 us_rep3) (temp___skip_top_level_427 Bool)) Bool (=> (not (= temp___skip_top_level_427 true)) (and (= (is_empty temp___expr_426) true) (= (length2 temp___expr_426) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_404 us_rep2) (temp___skip_top_level_405 Bool)) Bool (=> (not (= temp___skip_top_level_405 true)) (= (length1 temp___expr_404) 0)))
...
(declare-const temp___1898 count_type)
(declare-const o2 us_rep2)
(declare-const o3 us_rep3)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1898 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1898)) no_element))
