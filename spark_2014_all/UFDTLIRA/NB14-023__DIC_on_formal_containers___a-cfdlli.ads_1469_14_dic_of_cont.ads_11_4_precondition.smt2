...
(define-fun dynamic_invariant ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 2147483647)) (in_range2 temp___expr_325)))
...
(define-fun dynamic_invariant2 ((temp___expr_381 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 1 2147483647)) (in_range3 temp___expr_381)))
...
(define-fun default_initial_assumption1 ((temp___expr_388 us_rep3) (temp___skip_top_level_389 Bool)) Bool (=> (not (= temp___skip_top_level_389 true)) (and (= (is_empty temp___expr_388) true) (= (length2 temp___expr_388) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_369 us_rep2) (temp___skip_top_level_370 Bool)) Bool (=> (not (= temp___skip_top_level_370 true)) (= (length1 temp___expr_369) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 2147483647)) (in_range4 temp___expr_362)))
...
(define-fun dynamic_invariant4 ((temp___expr_356 Int) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool)) Bool (=> (or (= temp___is_init_353 true) (<= 0 2147483647)) (in_range5 temp___expr_356)))
...
(assert (=> (= (bool_eq1 position no_element) true) (and (= o4 (length container)) (and (in_range1 o4) (<= o4 (to_rep (rec__dic_of_cont__my_dlli__list__capacity (us_split_discrs1 container))))))))
