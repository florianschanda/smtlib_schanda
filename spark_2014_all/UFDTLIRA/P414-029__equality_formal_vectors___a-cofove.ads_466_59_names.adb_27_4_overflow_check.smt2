...
(define-fun dynamic_invariant ((temp___expr_324 Int) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool) (temp___do_typ_inv_323 Bool)) Bool (=> (or (= temp___is_init_320 true) (<= 0 2147483647)) (in_range1 temp___expr_324)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o) (= o (ite (= (distinct 0 0) true) (to_rep (rec__names__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
