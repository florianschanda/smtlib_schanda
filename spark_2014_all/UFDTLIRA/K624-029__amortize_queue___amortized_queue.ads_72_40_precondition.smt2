...
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o19 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (= amortized_queue__tail__result5 (mk_queue__ref amortized_queue__tail__result4)))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o19 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o19) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o18 o19))
(assert (= o7 o18))
...
(assert (= result5 (mk_queue__ref (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_discrs amortized_queue__tail__result) (mk___split_fields amortized_queue__tail__result1)) (mk___rep (mk___split_discrs amortized_queue__tail__result2) (mk___split_fields amortized_queue__tail__result3)))))))
(assert (= amortized_queue__tail__result4 (mk___rep1 result____split_fields7)))
...
(assert (and (= result6 (inv (queue__content amortized_queue__tail__result7))) (= (= result6 true) (and (and (<= (length (rec__amortized_queue__queue__rear (us_split_fields3 (queue__content amortized_queue__tail__result7)))) (length (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__tail__result7))))) (<= (length (rec__amortized_queue__queue__rear (us_split_fields3 (queue__content amortized_queue__tail__result7)))) (- (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__tail__result7)))))) (length (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__tail__result7))))))) (= (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 (rec__amortized_queue__queue__front (us_split_fields3 (queue__content amortized_queue__tail__result7)))))) (to_rep (rec__amortized_queue__my_vectors__vector__capacity (us_split_discrs1 (rec__amortized_queue__queue__rear (us_split_fields3 (queue__content amortized_queue__tail__result7)))))))))))
(assert (= result6 true))
(assert (and (= o17 (model__1 q)) (= (is_model q o17) true)))
(assert (not (not (= (is_empty o17) true))))
(check-sat)
(exit)
