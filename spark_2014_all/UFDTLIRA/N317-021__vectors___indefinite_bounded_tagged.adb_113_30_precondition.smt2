...
(define-fun o11 () us_rep1 (mk___rep1 (mk___split_fields1 o6 o7) o8))
(define-fun o12 () us_rep1 (mk___rep1 (mk___split_fields1 o3 o4) o5))
(define-fun o13 () us_rep1 (mk___rep1 (mk___split_fields1 o o1) o2))
...
(assert (and (= o13 (f 1)) (and (and (= (of_rep1 1) o) (= us_null_ext__ o1)) (= us_tag o2))))
...
(assert (and (= o12 (f 2)) (and (and (= (of_rep1 2) o3) (= us_null_ext__ o4)) (= us_tag o5))))
...
(assert (and (= o11 (f 3)) (and (and (= (of_rep1 3) o6) (= us_null_ext__ o7)) (= us_tag o8))))
...
(assert (not (<= 2 (last (model__ (mk___rep v__split_discrs v__split_fields10))))))
(check-sat)
(exit)
