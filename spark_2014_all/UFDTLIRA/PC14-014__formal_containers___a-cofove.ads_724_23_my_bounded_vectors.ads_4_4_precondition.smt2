...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__my_bounded_vectors__v__vector us_main_type1)))))
(define-fun us_split_fields_Vector__2__projection ((a us_split_fields)) us_main_type1 (rec__my_bounded_vectors__v__vector a))
...
(define-fun us_rep___5__projection ((a us_rep1)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___6__projection ((a us_rep1)) us_split_fields (us_split_fields1 a))
...
(define-fun default_initial_assumption ((temp___expr_812 us_rep) (temp___skip_top_level_813 Bool)) Bool (=> (not (= temp___skip_top_level_813 true)) (= (length temp___expr_812) 0)))
...
(define-fun dynamic_invariant ((temp___expr_766 Int) (temp___is_init_762 Bool) (temp___skip_constant_763 Bool) (temp___do_toplevel_764 Bool) (temp___do_typ_inv_765 Bool)) Bool (=> (or (= temp___is_init_762 true) (<= 0 2147483647)) (in_range2 temp___expr_766)))
...
(define-fun dynamic_invariant1 ((temp___expr_752 Int) (temp___is_init_748 Bool) (temp___skip_constant_749 Bool) (temp___do_toplevel_750 Bool) (temp___do_typ_inv_751 Bool)) Bool (=> (or (= temp___is_init_748 true) (<= 1 2147483647)) (in_range3 temp___expr_752)))
...
(define-fun dynamic_invariant3 ((temp___expr_184 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range5 temp___expr_184)))
(define-fun dynamic_invariant4 ((temp___expr_773 Int) (temp___is_init_769 Bool) (temp___skip_constant_770 Bool) (temp___do_toplevel_771 Bool) (temp___do_typ_inv_772 Bool)) Bool (=> (or (= temp___is_init_769 true) (<= 0 2147483647)) (in_range1 temp___expr_773)))
...
(define-fun capacity ((container1 us_rep1)) Int (ite (= (distinct 1 0) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_804 Int) (temp___is_init_800 Bool) (temp___skip_constant_801 Bool) (temp___do_toplevel_802 Bool) (temp___do_typ_inv_803 Bool)) Bool (=> (or (= temp___is_init_800 true) (<= 0 2147483647)) (in_range6 temp___expr_804)))
...
(define-fun dynamic_invariant6 ((temp___expr_797 Int) (temp___is_init_793 Bool) (temp___skip_constant_794 Bool) (temp___do_toplevel_795 Bool) (temp___do_typ_inv_796 Bool)) Bool (=> (or (= temp___is_init_793 true) (<= 1 2147483647)) (in_range7 temp___expr_797)))
...
(assert (and (= o2 (last (model__ container))) (and (in_range2 o2) (= o2 (last (model__ container))))))
