...
(assert (= (mk___split_fields result____split_fields3 result____split_fields4 result____split_fields5) (us_split_fields1 x)))
(assert (< (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59))
(assert (not (in_range4 (+ (to_rep2 result____split_fields5) 1))))
(check-sat)
(exit)
