...
(assert (and (= o75 (first (mk___rep l3__split_discrs l3__split_fields4))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields4)) 0) true) (= (bool_eq1 o75 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o75) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o75) 1)))))
(assert (and (= o76 (next (mk___rep l3__split_discrs l3__split_fields4) o75)) (ite (= (ite (= (bool_eq1 o75 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o75) (length (mk___rep l3__split_discrs l3__split_fields4))) true) true) (= (bool_eq1 o76 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o76) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o76) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o75) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o76) true) (= (bool_eq1 o76 no_element) true))))
(check-sat)
(exit)
