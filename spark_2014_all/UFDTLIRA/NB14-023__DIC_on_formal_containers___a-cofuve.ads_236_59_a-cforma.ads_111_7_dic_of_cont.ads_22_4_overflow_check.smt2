...
(define-fun dynamic_invariant ((temp___expr_1122 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 1 2147483647)) (in_range2 temp___expr_1122)))
...
(define-fun dynamic_invariant1 ((temp___expr_1134 Int) (temp___is_init_1131 Bool) (temp___skip_constant_1132 Bool) (temp___do_toplevel_1133 Bool)) Bool (=> (or (= temp___is_init_1131 true) (<= 0 2147483647)) (in_range3 temp___expr_1134)))
...
(define-fun sequence__ref___4__projection ((a sequence__ref)) us_rep (sequence__content a))
...
(define-fun default_initial_assumption ((temp___expr_1141 us_rep) (temp___skip_top_level_1142 Bool)) Bool (=> (not (= temp___skip_top_level_1142 true)) (= (length temp___expr_1141) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 2147483647)) (in_range4 temp___expr_173)))
...
(define-fun element_type__ref___14__projection ((a element_type__ref)) element_type (element_type__content a))
(define-fun dynamic_invariant3 ((temp___expr_1128 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 2147483647)) (in_range5 temp___expr_1128)))
(assert (forall ((container us_rep)) (forall ((position Int)) (! (=> (and (dynamic_invariant1 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant3 (get container position) true false true)) :pattern ((get container position))))))
(declare-const o Int)
...
(assert (and (= o1 (length right)) (and (in_range4 o1) (<= (+ 0 o1) 2147483647))))
(assert (= o2 (+ 0 o1)))
