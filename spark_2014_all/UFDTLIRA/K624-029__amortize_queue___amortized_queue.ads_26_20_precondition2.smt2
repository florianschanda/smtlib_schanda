...
(assert (= o11 (+ 1 o10)))
(assert (and (= o12 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range2 o12) (<= o12 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o12 o11) true false)))
(assert (= result4 true))
(assert (and (= o9 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)) (and (in_range5 o9) (= o9 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)))))
...
(assert (and (= o8 (get (model__ right) o7)) (and (in_range5 o8) (= o8 (get (model__ right) o7)))))
