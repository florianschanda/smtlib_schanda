...
(declare-const temp___681 us_rep1)
...
(assert (and (= temp___681 (f 3)) (= temp___681 (mk___rep1 (mk___split_fields1 (of_rep1 3) us_null_ext__) us_tag))))
(assert (not (<= 1 (last (model__ (mk___rep v__split_discrs v__split_fields10))))))
(check-sat)
(exit)
