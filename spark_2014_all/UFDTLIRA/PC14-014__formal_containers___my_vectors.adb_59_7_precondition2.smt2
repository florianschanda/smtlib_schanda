...
(assert (not (<= (length (mk___rep k__split_discrs k__split_fields2)) (- (capacity (mk___rep k__split_discrs k__split_fields2)) (length (mk___rep l__split_discrs l__split_fields21))))))
(check-sat)
(exit)
