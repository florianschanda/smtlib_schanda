...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___486 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___486)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__int_list__my_lists__list__capacity (us_split_discrs1 container)))))))
