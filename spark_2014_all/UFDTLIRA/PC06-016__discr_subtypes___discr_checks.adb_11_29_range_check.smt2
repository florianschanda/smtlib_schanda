...
(declare-const discr_checks__check_derived_rec__R2b__assume Int)
(assert (and (= discr_checks__check_derived_rec__R2b__assume (bad Tuple0)) (and (in_range discr_checks__check_derived_rec__R2b__assume) (= discr_checks__check_derived_rec__R2b__assume 6))))
