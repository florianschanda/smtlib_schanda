...
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o2) (= o2 (ite (= (of_int 0) true) (to_rep (rec__names__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
