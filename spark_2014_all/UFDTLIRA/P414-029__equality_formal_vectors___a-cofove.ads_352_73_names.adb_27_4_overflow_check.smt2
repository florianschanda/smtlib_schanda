...
(define-fun dynamic_invariant ((temp___expr_268 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 255)) (in_range3 temp___expr_268)))
...
(define-fun dynamic_invariant1 ((temp___expr_274 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 1) 2147483647)) (in_range4 temp___expr_274)))
...
(define-fun dynamic_invariant2 ((temp___expr_280 Int) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (<= 0 2147483647)) (in_range1 temp___expr_280)))
...
(assert (and (= o3 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o3) (= o3 (ite (= (of_int 0) true) (to_rep (rec__names__char_tables__vector__capacity container__split_discrs)) 2147483647)))))
(assert (and (= o4 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o4) (<= o4 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
