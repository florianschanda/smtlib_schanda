...
(assert (not (or (and (<= 1 o25) (<= o25 (last (model__ (mk___rep l__split_discrs l__split_fields29))))) (and (not (= o25 0)) (= (- o25 1) (last (model__ (mk___rep l__split_discrs l__split_fields29))))))))
(check-sat)
(exit)
