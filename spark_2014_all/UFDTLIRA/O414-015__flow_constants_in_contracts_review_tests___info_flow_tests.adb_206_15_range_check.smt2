...
(define-fun t__ref___5__projection ((a1 t__ref)) integer (t__content a1))
...
(define-fun dynamic_invariant2 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= first last)) (dynamic_property first last temp___expr_228)))
(assert (= first a))
(assert (= last a))
(assert (in_range1 a))
(assert (in_range1 b))
