...
(define-fun dynamic_invariant2 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= first last)) (dynamic_property first last temp___expr_195)))
(assert (= first a))
(assert (= last a))
(assert (in_range1 a))
(assert (in_range1 b))
