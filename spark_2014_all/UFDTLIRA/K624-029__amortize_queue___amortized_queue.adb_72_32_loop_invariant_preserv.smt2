...
(assert (and (= o1 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o)) (and (in_range5 o1) (= o1 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o)))))
(assert (and (and (= (length (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (length (mk___rep front__split_discrs (mk___split_fields front__split_fields))) 1)) (= (olt (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields))) (model__ (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))) true)) (= (get (model__ (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields))) (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields)))) 1)) o1)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields front__split_fields))))
(assert (= (mk___split_fields front__split_fields2) (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))
(assert (= (length (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) (+ (- (+ (length ofront) (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) idx2) 1)))
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 (last (model__ ofront)))) (= (get (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) i4) (get (model__ ofront) i4)))))
(assert (forall ((i4 Int)) (=> (and (<= idx2 i4) (<= i4 (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields)))))) (= (get (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) (- (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3)))) idx2) i4)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i4)))))
(assert (and (=> (<= 1 r51b) (dynamic_property 1 r51b idx2)) (and (<= 1 idx2) (<= idx2 r51b))))
(assert (not (= idx2 1)))
(assert (= idx2 result4))
(assert (= idx3 (- idx2 1)))
(assert (and (= o19 idx3) (in_range2 idx3)))
(assert (and (= o20 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o19)) (and (in_range5 o20) (= o20 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o19)))))
(assert (and (and (= (length (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1))) (+ (length (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) 1)) (= (olt (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3))) (model__ (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1)))) true)) (= (get (model__ (mk___rep front__split_discrs (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1))) (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields3)))) 1)) o20)))
(assert (= result5 front__split_fields3))
(assert (= (mk___split_fields front__split_fields4) (mk___split_fields amortized_queue__my_vectors__append__2__container__fields1)))
(assert (not (= (length (mk___rep front__split_discrs (mk___split_fields front__split_fields4))) (+ (- (+ (length ofront) (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) idx3) 1))))
(check-sat)
(exit)
