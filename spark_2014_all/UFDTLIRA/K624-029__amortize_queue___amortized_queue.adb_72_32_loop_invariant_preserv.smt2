...
(define-fun dynamic_invariant6 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 1000)) (in_range5 temp___expr_228)))
...
(assert (<= 1 idx1))
(assert (<= idx1 r51b))
(assert (and (= o idx1) (in_range5 idx1)))
(assert (and (= o1 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o)) (and (in_range4 o1) (= o1 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o)))))
...
(assert (= idx2 result2))
(assert (= idx3 (- idx2 1)))
(assert (and (= o2 idx3) (in_range5 idx3)))
(assert (and (= o3 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o2)) (and (in_range4 o3) (= o3 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o2)))))
