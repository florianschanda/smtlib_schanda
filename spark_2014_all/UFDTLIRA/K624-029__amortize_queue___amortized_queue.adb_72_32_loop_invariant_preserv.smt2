...
(define-fun front__split_fields4 () us_split_fields (mk___split_fields front__split_fields3))
...
(define-fun front__split_fields5 () us_split_fields (mk___split_fields front__split_fields2))
...
(assert (and (and (= (length (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (length (mk___rep front__split_discrs (mk___split_fields front__split_fields))) 1)) (= (olt (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields))) (model__ (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields3))) true)) (= (get (model__ (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields3)) (+ (last (model__ (mk___rep front__split_discrs (mk___split_fields front__split_fields)))) 1)) o1)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields front__split_fields))))
(assert (= (mk___split_fields front__split_fields1) amortized_queue__my_vectors__append__2__container__fields3))
(assert (= (length (mk___rep front__split_discrs front__split_fields5)) (+ (- (+ (length ofront) (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) idx2) 1)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ ofront)))) (= (get (model__ (mk___rep front__split_discrs front__split_fields5)) i) (get (model__ ofront) i)))))
(assert (forall ((i Int)) (=> (and (<= idx2 i) (<= i (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields)))))) (= (get (model__ (mk___rep front__split_discrs front__split_fields5)) (- (+ (last (model__ (mk___rep front__split_discrs front__split_fields5))) idx2) i)) (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) i)))))
(assert (and (=> (<= 1 r51b) (dynamic_property 1 r51b idx2)) (and (<= 1 idx2) (<= idx2 r51b))))
(assert (not (= idx2 1)))
(assert (= idx2 result2))
(assert (= idx3 (- idx2 1)))
(assert (and (= o2 idx3) (in_range2 idx3)))
(assert (and (= o3 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o2)) (and (in_range5 o3) (= o3 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o2)))))
(assert (and (and (= (length (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (length (mk___rep front__split_discrs front__split_fields5)) 1)) (= (olt (model__ (mk___rep front__split_discrs front__split_fields5)) (model__ (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields2))) true)) (= (get (model__ (mk___rep front__split_discrs amortized_queue__my_vectors__append__2__container__fields2)) (+ (last (model__ (mk___rep front__split_discrs front__split_fields5))) 1)) o3)))
(assert (= result3 front__split_fields2))
(assert (= front__split_fields4 amortized_queue__my_vectors__append__2__container__fields2))
(assert (not (= (length (mk___rep front__split_discrs front__split_fields4)) (+ (- (+ (length ofront) (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) idx3) 1))))
(check-sat)
(exit)
