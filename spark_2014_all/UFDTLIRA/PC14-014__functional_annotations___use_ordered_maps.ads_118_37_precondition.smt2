...
(assert (and (= o3 (length s)) (and (in_range1 o3) (<= o3 (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 s)))))))
(assert (= o4 (ite (<= i o3) true false)))
(assert (= result1 (ite (<= 1 i) o4 false)))
(assert (= result1 true))
(assert (and (= o5 (keys s)) (and (and (and (= (length3 o5) (length s)) (forall ((temp___396 Int)) (=> (and (in_range4 temp___396) (= (iter_has_element o5 temp___396) true)) (= (has_key (model__ s) (get o5 temp___396)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ s) key) true)) (and (< 0 (find o5 key)) (= (equivalent_keys (get o5 (find o5 key)) key) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o5 (get o5 i1)) i1) (= (k_is_find o5 (get o5 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
