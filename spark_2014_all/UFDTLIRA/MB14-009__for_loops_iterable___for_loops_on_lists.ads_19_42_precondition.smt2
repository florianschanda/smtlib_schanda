...
(assert (and (= result9 (has_key (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (mk___rep1 (us_split_fields__content1 c__split_fields14)))) (= (= result9 true) (= (has_key (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (mk___rep1 (us_split_fields__content1 c__split_fields14))) true))))
(assert (= result9 true))
(assert (not (= (has_key (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (mk___rep1 (us_split_fields__content1 c__split_fields14))) true)))
(check-sat)
(exit)
