...
(define-fun default_initial_assumption ((temp___expr_559 us_rep) (temp___skip_top_level_560 Bool)) Bool (=> (not (= temp___skip_top_level_560 true)) (= (is_empty temp___expr_559) true)))
...
(assert (forall ((container us_rep)) (forall ((item us_rep1)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
