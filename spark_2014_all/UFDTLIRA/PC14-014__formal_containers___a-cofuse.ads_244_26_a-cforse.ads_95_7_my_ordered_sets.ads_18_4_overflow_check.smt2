...
(define-fun default_initial_assumption ((temp___expr_607 us_rep) (temp___skip_top_level_608 Bool)) Bool (=> (not (= temp___skip_top_level_608 true)) (= (is_empty temp___expr_607) true)))
...
(define-fun my_lt ((x us_rep1) (y us_rep1)) Bool (< (to_rep1 (rec__my_ordered_sets__my_rec__f (us_split_fields1 x))) (to_rep1 (rec__my_ordered_sets__my_rec__f (us_split_fields1 y)))))
...
(define-fun element_type__ref___5__projection ((a element_type__ref)) us_rep1 (element_type__content a))
...
(define-fun equivalent_elements ((left1 us_rep1) (right1 us_rep1)) Bool (and (not (my_lt left1 right1)) (not (my_lt right1 left1))))
...
(define-fun element_type__ref___6__projection ((a element_type__ref1)) us_rep1 (element_type__content1 a))
(declare-fun contains (us_rep us_rep1) Bool)
(declare-fun contains__function_guard (Bool us_rep us_rep1) Bool)
(assert (forall ((container us_rep)) (forall ((item us_rep1)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (equivalent_elements e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
(assert (forall ((left1 us_rep) (right1 us_rep)) (! (= (= (ole left1 right1) true) (forall ((item us_rep1)) (=> (= (contains left1 item) true) (= (contains right1 item) true)))) :pattern ((ole left1 right1)))))
(assert (forall ((container us_rep)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item us_rep1)) (not (= (contains container item) true)))) (= (= result true) (= (length container) 0)))) :pattern ((is_empty container)))))
...
(assert (forall ((container us_rep) (left1 us_rep) (right1 us_rep)) (! (= (= (includes_intersection container left1 right1) true) (forall ((item us_rep1)) (=> (= (contains left1 item) true) (=> (= (contains right1 item) true) (= (contains container item) true))))) :pattern ((includes_intersection container left1 right1)))))
(assert (forall ((left1 us_rep) (right1 us_rep)) (! (= (= (no_overlap left1 right1) true) (forall ((item us_rep1)) (=> (= (contains left1 item) true) (not (= (contains right1 item) true))))) :pattern ((no_overlap left1 right1)))))
