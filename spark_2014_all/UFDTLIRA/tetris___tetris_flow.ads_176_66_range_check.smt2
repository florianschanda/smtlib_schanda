...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep3 (rec__tetris_flow__piece__s (us_split_fields1 a))) (to_rep3 (rec__tetris_flow__piece__s (us_split_fields1 b)))) (= (to_rep2 (rec__tetris_flow__piece__d (us_split_fields1 a))) (to_rep2 (rec__tetris_flow__piece__d (us_split_fields1 b))))) (= (to_rep (rec__tetris_flow__piece__x (us_split_fields1 a))) (to_rep (rec__tetris_flow__piece__x (us_split_fields1 b))))) (= (to_rep1 (rec__tetris_flow__piece__y (us_split_fields1 a))) (to_rep1 (rec__tetris_flow__piece__y (us_split_fields1 b))))) true false))
