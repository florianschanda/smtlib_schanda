...
(define-fun default_initial_assumption ((temp___expr_668 us_rep2) (temp___skip_top_level_669 Bool)) Bool (=> (not (= temp___skip_top_level_669 true)) (and (= (is_empty temp___expr_668) true) (= (length1 temp___expr_668) 0))))
...
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item))))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container)))))))
