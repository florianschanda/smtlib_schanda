...
(define-fun dynamic_invariant1 ((temp___expr_605 Int) (temp___is_init_602 Bool) (temp___skip_constant_603 Bool) (temp___do_toplevel_604 Bool)) Bool (=> (or (= temp___is_init_602 true) (<= 1 2147483647)) (in_range2 temp___expr_605)))
...
(define-fun default_initial_assumption ((temp___expr_612 us_rep2) (temp___skip_top_level_613 Bool)) Bool (=> (not (= temp___skip_top_level_613 true)) (and (= (is_empty temp___expr_612) true) (= (length2 temp___expr_612) 0))))
...
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant result true false true))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep5)) (! (dynamic_invariant (length4 container1) true false true) :pattern ((length4 container1)))))
...
(assert (forall ((container1 us_rep4)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true))) :pattern ((length3 container1)))))
(assert true)
...
(declare-const temp___1012 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1012 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1012)) no_element))
