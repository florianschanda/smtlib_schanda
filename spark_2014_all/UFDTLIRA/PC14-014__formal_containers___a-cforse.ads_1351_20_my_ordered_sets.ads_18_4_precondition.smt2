...
(define-fun dynamic_invariant1 ((temp___expr_660 Int) (temp___is_init_656 Bool) (temp___skip_constant_657 Bool) (temp___do_toplevel_658 Bool) (temp___do_typ_inv_659 Bool)) Bool (=> (or (= temp___is_init_656 true) (<= 1 2147483647)) (in_range2 temp___expr_660)))
...
(define-fun default_initial_assumption ((temp___expr_668 us_rep2) (temp___skip_top_level_669 Bool)) Bool (=> (not (= temp___skip_top_level_669 true)) (and (= (is_empty temp___expr_668) true) (= (length2 temp___expr_668) 0))))
...
(assert (forall ((container1 us_rep4)) (forall ((item us_rep3)) (! (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant result true false true true))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___683 Int)) (=> (and (in_range5 temp___683) (= (iter_has_element result temp___683) true)) (= (contains (model__ container1) (get1 result temp___683)) true)))) (forall ((item us_rep3)) (=> (= (contains (model__ container1) item) true) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (forall ((container1 us_rep5)) (! (dynamic_invariant (length4 container1) true false true true) :pattern ((length4 container1)))))
...
(assert (forall ((container1 us_rep4)) (! (let ((result (length3 container1))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true true))) :pattern ((length3 container1)))))
(assert true)
...
(declare-const temp___1076 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1076 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1076)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__my_ordered_sets__n__set__capacity (us_split_discrs1 container)))))))
