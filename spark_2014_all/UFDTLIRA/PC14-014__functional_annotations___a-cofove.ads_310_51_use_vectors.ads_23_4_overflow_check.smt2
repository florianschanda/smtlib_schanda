...
(assert (=> (not (= before no_index)) (and (= o6 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property1 first1 last1 o6) (= o6 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
(assert (=> (not (= before no_index)) (and (= o7 (- before 1)) (in_range1 (- before 1)))))
(assert (=> (not (= before no_index)) (= o8 (ite (= o7 o6) true false))))
(assert (=> (= before no_index) (= o8 false)))
(assert (and (= o4 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property1 first1 last1 o4) (= o4 (last4 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o5 (ite (<= before o4) true false)))
(assert (= o9 (ite (<= first before) o5 false)))
(assert (= o10 (ite (= o9 false) o8 true)))
(assert (and (= o (length new_item)) (and (dynamic_property2 0 last2 o) (<= o (capacity new_item)))))
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property2 0 last2 o1) (= o1 (ite (= (of_int 0) true) (to_rep1 (rec__use_vectors__my_vectors__vector__capacity container__split_discrs)) last2)))))
(assert (= o2 (- o1 o)))
