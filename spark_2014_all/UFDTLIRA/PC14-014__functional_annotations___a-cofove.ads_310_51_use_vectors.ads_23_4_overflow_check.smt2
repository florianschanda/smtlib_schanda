...
(assert (=> (not (= before no_index)) (and (= o5 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property3 first2 last4 o5) (= o5 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))))
...
(assert (and (= o3 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property3 first2 last4 o3) (= o3 (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o4 (ite (<= before o3) true false)))
(assert (= o8 (ite (<= first1 before) o4 false)))
