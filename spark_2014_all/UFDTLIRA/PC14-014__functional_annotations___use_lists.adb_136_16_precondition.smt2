...
(assert (and (= o6 (get1 o3 (mk___rep1 current__split_fields3))) (and (in_range4 o6) (=> (= (of_int 0) true) (and (= o6 (w_get o3 (witness o3 (mk___rep1 current__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key o3 k) true) (= (= (bool_eq1 k (mk___rep1 current__split_fields3)) true) (= (witness o3 (mk___rep1 current__split_fields3)) (witness o3 k))))))))))
...
(assert (and (= o2 (get1 o1 (mk___rep1 current__split_fields3))) (and (in_range4 o2) (=> (= (of_int 0) true) (and (= o2 (w_get o1 (witness o1 (mk___rep1 current__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key o1 k) true) (= (= (bool_eq1 k (mk___rep1 current__split_fields3)) true) (= (witness o1 (mk___rep1 current__split_fields3)) (witness o1 k))))))))))
