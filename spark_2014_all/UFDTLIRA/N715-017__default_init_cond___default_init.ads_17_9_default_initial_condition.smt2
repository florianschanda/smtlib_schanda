...
(declare-const temp___329 Bool)
(declare-const temp___328 Bool)
(declare-const temp___330 Bool)
(declare-const temp___3301 natural)
(assert (= temp___329 temp___328))
(assert (=> (= (ite temp___330 1 0) 1) (= (to_rep temp___3301) 0)))
(assert (not (= (discr_ok (mk___rep (mk___split_discrs temp___330) (mk___split_fields temp___3301))) true)))
(check-sat)
(exit)
