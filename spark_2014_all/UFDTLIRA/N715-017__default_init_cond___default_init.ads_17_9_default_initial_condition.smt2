...
(declare-const temp___291 Bool)
(declare-const temp___290 Bool)
(declare-const temp___292 Bool)
(declare-const temp___2921 natural)
(assert (= temp___291 temp___290))
(assert (=> (= (to_int1 temp___292) 1) (= (to_rep temp___2921) 0)))
(assert (not (= (discr_ok (mk___rep (mk___split_discrs temp___292) (mk___split_fields temp___2921))) true)))
(check-sat)
(exit)
