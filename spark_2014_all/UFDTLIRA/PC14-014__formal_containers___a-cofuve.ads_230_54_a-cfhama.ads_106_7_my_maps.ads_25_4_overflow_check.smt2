...
(define-fun dynamic_invariant ((temp___expr_689 Int) (temp___is_init_685 Bool) (temp___skip_constant_686 Bool) (temp___do_toplevel_687 Bool) (temp___do_typ_inv_688 Bool)) Bool (=> (or (= temp___is_init_685 true) (<= 1 2147483647)) (in_range2 temp___expr_689)))
...
(define-fun dynamic_invariant1 ((temp___expr_705 Int) (temp___is_init_701 Bool) (temp___skip_constant_702 Bool) (temp___do_toplevel_703 Bool) (temp___do_typ_inv_704 Bool)) Bool (=> (or (= temp___is_init_701 true) (<= 0 2147483647)) (in_range3 temp___expr_705)))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__my_maps__my_rec__f (us_split_fields1 a))) (to_rep1 (rec__my_maps__my_rec__f (us_split_fields1 b)))) (= (to_rep (rec__my_maps__my_rec__g (us_split_fields1 a))) (to_rep (rec__my_maps__my_rec__g (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_713 us_rep) (temp___skip_top_level_714 Bool)) Bool (=> (not (= temp___skip_top_level_714 true)) (= (length temp___expr_713) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range6 temp___expr_197)))
