...
(assert (=> (= result1 true) (= temp___490 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (and (= l__split_discrs (mk___split_discrs temp___489)) (= l__split_fields temp___4891))))
(assert (=> (= result1 true) (= temp___491 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= temp___488 cu__split_fields1)))
(assert (=> (= result1 true) (= temp___492 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (=> (= result1 true) (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) temp___490)))
(assert (=> (= result1 true) (forall ((n3 Int)) (=> (and (<= 1 n3) (<= n3 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (is_incr (get temp___491 n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) n3)) true)))))
(assert (=> (= result1 true) (forall ((n3 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) n3) (<= n3 (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2))))) (= (get temp___492 n3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) n3))))))
(assert (=> (= result1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
...
(assert (and (= o22 (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (in_range2 o22) (<= o22 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o23 (ite (<= n2 o22) true false)))
(assert (= result6 (ite (<= 1 n2) o23 false)))
(assert (= result6 true))
(assert (and (= o25 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (= (length1 o25) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))))))
(assert (not (<= 1 n2)))
(check-sat)
(exit)
