...
(assert (=> (= result1 true) (= (length (mk___rep l__split_discrs l__split_fields11)) temp___490)))
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) 1))) (= (is_incr (get temp___491 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1)) true)))))
(assert (=> (= result1 true) (forall ((n1 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11)) (mk___rep1 cu__split_fields11)) n1) (<= n1 (length (mk___rep l__split_discrs l__split_fields11)))) (= (get temp___492 n1) (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1))))))
...
(assert (and (= o5 (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields8)))) (and (in_range2 o5) (<= o5 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
