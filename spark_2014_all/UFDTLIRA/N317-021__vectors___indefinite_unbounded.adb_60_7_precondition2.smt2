...
(assert (= v__split_fields8 indefinite_unbounded__vect__clear__container__fields1))
...
(assert (= v__split_fields7 indefinite_unbounded__vect__append__2__container__fields4))
