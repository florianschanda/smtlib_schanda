...
(define-fun dynamic_invariant ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 0 2147483647)) (in_range3 temp___expr_383)))
(define-fun dynamic_invariant1 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 0 2147483647)) (in_range2 temp___expr_389)))
...
(define-fun default_initial_assumption1 ((temp___expr_396 us_rep2) (temp___skip_top_level_397 Bool)) Bool (=> (not (= temp___skip_top_level_397 true)) (= (length temp___expr_396) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_408 Int) (temp___is_init_405 Bool) (temp___skip_constant_406 Bool) (temp___do_toplevel_407 Bool)) Bool (=> (or (= temp___is_init_405 true) (<= 1 2147483647)) (in_range4 temp___expr_408)))
...
(define-fun default_initial_assumption2 ((temp___expr_415 us_rep3) (temp___skip_top_level_416 Bool)) Bool (=> (not (= temp___skip_top_level_416 true)) (and (= (is_empty temp___expr_415) true) (= (length1 temp___expr_415) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant3 result true false true))) :pattern ((length2 container)))))
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant3 result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant3 (length1 container) true false true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant2 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const temp___535 us_rep2)
...
(assert (and (= (mk___rep1 (mk___split_fields1 init_list_zero__cu__assume)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 init_list_zero__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 init_list_zero__cu__assume))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 init_list_zero__cu__assume))) 1)))))
...
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) i1) 0))))
