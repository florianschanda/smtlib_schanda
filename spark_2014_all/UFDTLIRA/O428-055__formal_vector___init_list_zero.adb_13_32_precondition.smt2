...
(define-fun dynamic_invariant ((temp___expr_432 Int) (temp___is_init_428 Bool) (temp___skip_constant_429 Bool) (temp___do_toplevel_430 Bool) (temp___do_typ_inv_431 Bool)) Bool (=> (or (= temp___is_init_428 true) (<= 0 2147483647)) (in_range3 temp___expr_432)))
...
(define-fun default_initial_assumption1 ((temp___expr_447 us_rep2) (temp___skip_top_level_448 Bool)) Bool (=> (not (= temp___skip_top_level_448 true)) (= (length temp___expr_447) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_469 us_rep3) (temp___skip_top_level_470 Bool)) Bool (=> (not (= temp___skip_top_level_470 true)) (and (= (is_empty temp___expr_469) true) (= (length1 temp___expr_469) 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant3 result true false true true))) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant3 (length1 container) true false true true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant3 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant2 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
