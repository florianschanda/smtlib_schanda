...
(define-fun init_list_zero__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 init_list_zero__cu__assume)))
(assert (and (= init_list_zero__cu__assume1 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length2 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 init_list_zero__cu__assume1 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) init_list_zero__cu__assume1) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) init_list_zero__cu__assume1) 1)))))
...
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i1) 0))))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields3)) true))
(assert (and (= o (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length2 (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq1 i1 j) true))))))))))
...
(assert (= result2 true))
(assert (and (= o4 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length o4) (length2 (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
