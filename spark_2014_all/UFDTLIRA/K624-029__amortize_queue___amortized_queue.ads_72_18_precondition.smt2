...
(define-fun o19 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o20 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o20 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o20) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o19 o20))
(assert (= o7 o19))
...
(assert (and (= o18 (last_element o17)) (and (in_range2 o18) (= o18 (get (model__ o17) (last (model__ o17)))))))
