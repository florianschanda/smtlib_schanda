...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption ((temp___expr_353 us_rep1) (temp___skip_top_level_354 Bool)) Bool (=> (not (= temp___skip_top_level_354 true)) (= (length2 temp___expr_353) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_322 us_rep2) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (is_empty2 temp___expr_322) true)))
...
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 0 2147483647)) (in_range3 temp___expr_315)))
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 0 2147483647)) (in_range4 temp___expr_346)))
...
(define-fun dynamic_invariant4 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 2147483647)) (in_range5 temp___expr_340)))
...
(assert (and (= o1 (length container)) (and (in_range2 o1) (<= o1 (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container)))))))
