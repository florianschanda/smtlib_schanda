...
(assert (<= 1 idx1))
(assert (<= idx1 r4b))
(assert (and (= o2 idx1) (in_range3 idx1)))
...
(assert (= result____split_fields2 amortized_queue__my_vectors__append__2__container__fields1))
(assert (not (= (length (mk___rep result____split_discrs result____split_fields2)) idx1)))
(check-sat)
(exit)
