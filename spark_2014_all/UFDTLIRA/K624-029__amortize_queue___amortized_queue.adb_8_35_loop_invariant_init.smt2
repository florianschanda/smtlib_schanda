...
(assert (<= 1 idx2))
(assert (<= idx2 r4b))
(assert (and (= o2 idx2) (in_range3 idx2)))
(assert (and (= o3 (get (model__ left) o2)) (and (in_range6 o3) (= o3 (get (model__ left) o2)))))
...
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields result____split_fields))))
(assert (= (mk___split_fields result____split_fields2) (mk___split_fields amortized_queue__my_vectors__append__2__container__fields)))
(assert (not (= (length (mk___rep result____split_discrs (mk___split_fields result____split_fields2))) idx2)))
(check-sat)
(exit)
