...
(define-fun obj__split_fields16 () us_split_fields (mk___split_fields obj__split_fields4 obj__split_fields5 obj__split_fields6 obj__split_fields7))
(assert (=> (<= 0 2147483647) (in_range tmp)))
(assert (and (and (and (= (has_stored_area1 obj__attr__tag (mk___rep obj__split_fields16 obj__attr__tag)) true) (= tmp1 (get_stored_area1 obj__attr__tag (mk___rep obj__split_fields16 obj__attr__tag)))) (in_range tmp1)) (get_area__specific_post obj__attr__tag obj__split_fields16 obj__attr__tag tmp1 (mk___split_fields obj__split_fields obj__split_fields1 obj__split_fields2 obj__split_fields3) tmp)))
(assert (= tmp2 tmp1))
