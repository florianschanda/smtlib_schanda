...
(assert (forall ((object__get_area__obj__fields us_split_fields) (object__get_area__obj__old__fields us_split_fields)) (forall ((obj__attr__tag Int) (object__get_area__result Int) (object__get_area__result__old Int)) (! (=> (get_area__specific_post us_tag1 object__get_area__obj__fields obj__attr__tag object__get_area__result object__get_area__obj__old__fields object__get_area__result__old) (let ((temp___rec___167 (of_base (mk___rep object__get_area__obj__fields obj__attr__tag)))) (and (= object__get_area__result (get_stored_area (to_base temp___rec___167))) (= (has_stored_area (to_base temp___rec___167)) true)))) :pattern ((get_area__specific_post us_tag1 object__get_area__obj__fields obj__attr__tag object__get_area__result object__get_area__obj__old__fields object__get_area__result__old))))))
