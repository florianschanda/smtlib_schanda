...
(declare-fun get_area__specific_post (Int us_split_fields Int Int us_split_fields Int) Bool)
(assert (forall ((object__get_area__obj__fields us_split_fields) (object__get_area__obj__old__fields us_split_fields)) (forall ((obj__attr__tag Int) (object__get_area__result Int) (object__get_area__result__old Int)) (! (=> (get_area__specific_post us_tag object__get_area__obj__fields obj__attr__tag object__get_area__result object__get_area__obj__old__fields object__get_area__result__old) (and (= (has_stored_area (mk___rep object__get_area__obj__fields obj__attr__tag)) true) (= object__get_area__result (get_stored_area (mk___rep object__get_area__obj__fields obj__attr__tag))))) :pattern ((get_area__specific_post us_tag object__get_area__obj__fields obj__attr__tag object__get_area__result object__get_area__obj__old__fields object__get_area__result__old))))))
(assert (forall ((object__get_area__obj__fields us_split_fields) (object__get_area__obj__old__fields us_split_fields)) (forall ((obj__attr__tag Int) (object__get_area__result Int) (object__get_area__result__old Int)) (! (=> (get_area__specific_post us_tag1 object__get_area__obj__fields obj__attr__tag object__get_area__result object__get_area__obj__old__fields object__get_area__result__old) (let ((temp___rec___143 (of_base (mk___rep object__get_area__obj__fields obj__attr__tag)))) (and (= object__get_area__result (get_stored_area (to_base temp___rec___143))) (= (has_stored_area (to_base temp___rec___143)) true)))) :pattern ((get_area__specific_post us_tag1 object__get_area__obj__fields obj__attr__tag object__get_area__result object__get_area__obj__old__fields object__get_area__result__old))))))
...
(assert (and (and (and (= (has_stored_area1 obj__attr__tag (mk___rep (mk___split_fields obj__split_fields4 obj__split_fields5 obj__split_fields6 obj__split_fields7) obj__attr__tag)) true) (= tmp1 (get_stored_area1 obj__attr__tag (mk___rep (mk___split_fields obj__split_fields4 obj__split_fields5 obj__split_fields6 obj__split_fields7) obj__attr__tag)))) (in_range tmp1)) (get_area__specific_post obj__attr__tag (mk___split_fields obj__split_fields4 obj__split_fields5 obj__split_fields6 obj__split_fields7) obj__attr__tag tmp1 (mk___split_fields obj__split_fields obj__split_fields1 obj__split_fields2 obj__split_fields3) tmp)))
(assert (= tmp2 tmp1))
...
(assert (not (= (has_stored_area1 obj__attr__tag (mk___rep (mk___split_fields obj__split_fields8 obj__split_fields9 obj__split_fields10 obj__split_fields11) obj__attr__tag)) true)))
(check-sat)
(exit)
