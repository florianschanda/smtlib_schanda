...
(define-fun dynamic_invariant ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_222)))
...
(define-fun dynamic_invariant2 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= 1 2147483647)) (in_range3 temp___expr_287)))
...
(define-fun default_initial_assumption1 ((temp___expr_295 us_rep3) (temp___skip_top_level_296 Bool)) Bool (=> (not (= temp___skip_top_level_296 true)) (and (= (is_empty temp___expr_295) true) (= (length2 temp___expr_295) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_273 us_rep2) (temp___skip_top_level_274 Bool)) Bool (=> (not (= temp___skip_top_level_274 true)) (= (length1 temp___expr_273) 0)))
