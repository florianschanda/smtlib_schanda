...
(define-fun dynamic_invariant ((temp___expr_190 Int) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool)) Bool (=> (or (= temp___is_init_187 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_190)))
...
(define-fun dynamic_invariant2 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 1 2147483647)) (in_range3 temp___expr_246)))
...
(define-fun default_initial_assumption1 ((temp___expr_253 us_rep3) (temp___skip_top_level_254 Bool)) Bool (=> (not (= temp___skip_top_level_254 true)) (and (= (is_empty temp___expr_253) true) (= (length2 temp___expr_253) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_234 us_rep2) (temp___skip_top_level_235 Bool)) Bool (=> (not (= temp___skip_top_level_235 true)) (= (length1 temp___expr_234) 0)))
...
(assert (=> (= (bool_eq1 position no_element) true) (and (= o4 (length container)) (and (in_range1 o4) (<= o4 (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 container))))))))
