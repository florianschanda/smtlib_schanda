...
(define-fun dynamic_invariant2 ((temp___expr_260 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool) (temp___do_typ_inv_259 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 1000)) (in_range3 temp___expr_260)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__loop_types__vectors__vector__capacity (us_split_discrs1 container))) 1000))
...
(define-fun dynamic_invariant3 ((temp___expr_239 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 1 1000)) (in_range4 temp___expr_239)))
...
(define-fun default_initial_assumption ((temp___expr_299 us_rep1) (temp___skip_top_level_300 Bool)) Bool (=> (not (= temp___skip_top_level_300 true)) (= (length1 temp___expr_299) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_291 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 1000)) (in_range5 temp___expr_291)))
...
(define-fun dynamic_invariant5 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 2147483647)) (in_range6 temp___expr_284)))
