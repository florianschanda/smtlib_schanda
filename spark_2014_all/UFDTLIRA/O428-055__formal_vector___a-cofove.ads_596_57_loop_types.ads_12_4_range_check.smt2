...
(define-fun dynamic_invariant2 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= 0 1000)) (in_range3 temp___expr_223)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__loop_types__vectors__vector__capacity (us_split_discrs1 container))) 1000))
...
(define-fun dynamic_invariant3 ((temp___expr_205 Int) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (=> (or (= temp___is_init_202 true) (<= 1 1000)) (in_range4 temp___expr_205)))
...
(define-fun default_initial_assumption ((temp___expr_257 us_rep1) (temp___skip_top_level_258 Bool)) Bool (=> (not (= temp___skip_top_level_258 true)) (= (length1 temp___expr_257) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_250 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 0 1000)) (in_range5 temp___expr_250)))
...
(define-fun dynamic_invariant5 ((temp___expr_244 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 2147483647)) (in_range6 temp___expr_244)))
