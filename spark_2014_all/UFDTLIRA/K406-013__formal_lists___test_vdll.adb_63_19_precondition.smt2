...
(assert (and (= o26 (last1 (mk___rep l1__split_discrs l1__split_fields4))) (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields4)) 0) true) (= (bool_eq1 o26 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o26) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o26) (length (mk___rep l1__split_discrs l1__split_fields4)))))))
(assert (and (= o27 (previous (mk___rep l1__split_discrs l1__split_fields4) o26)) (ite (= (ite (= (bool_eq1 o26 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o26) 1) true) true) (= (bool_eq1 o27 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o27) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o27) (- (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o26) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) no_element) true) (= (bool_eq1 no_element no_element) true))))
(check-sat)
(exit)
