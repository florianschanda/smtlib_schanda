...
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 a12)) (in_range2 n11)) (=> (<= 0 2147483647) (in_range2 b12))) (=> (<= 0 2147483647) (in_range2 i2))) (< 2 n11)))
(assert (= temp___189 result7))
(assert (= temp___1891 n11))
