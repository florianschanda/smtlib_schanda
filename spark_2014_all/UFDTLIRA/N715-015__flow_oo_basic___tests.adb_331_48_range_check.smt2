...
(define-fun tests__test_15__record_with_mutable_discrs__field__pred ((a us_rep)) Bool (= (to_int1 (rec__tests__test_15__record_with_mutable_discrs__present (us_split_discrs1 a))) 1))
...
(define-fun dynamic_invariant ((temp___expr_260 us_rep1) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool)) Bool (and (and (in_range2 (rec__tests__test_15__holder__present (us_split_discrs3 temp___expr_260)) (rec__tests__test_15__holder__content (us_split_fields3 temp___expr_260))) (= (attr__constrained (rec__tests__test_15__holder__content (us_split_fields3 temp___expr_260))) true)) (= (attr__constrained (rec__tests__test_15__holder__content (us_split_fields3 temp___expr_260))) true)))
(declare-fun id (us_rep1) us_rep1)
(declare-fun id__function_guard (us_rep1 us_rep1) Bool)
(assert (forall ((h us_rep1)) (! (=> (dynamic_invariant h true true true) (dynamic_invariant (id h) true false true)) :pattern ((id h)))))
(assert (forall ((h us_rep1)) (! (=> (dynamic_invariant h true true true) (= (id h) h)) :pattern ((id h)))))
...
(define-fun dynamic_invariant1 ((temp___expr_266 us_rep2) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool)) Bool (and (=> (not (= temp___skip_constant_264 true)) (in_range4 (of_int 0) (to_base temp___expr_266))) (and (and (in_range3 (of_int 0) (rec__tests__test_15__holder__content1 (us_split_fields5 temp___expr_266))) (= (attr__constrained (rec__tests__test_15__holder__content1 (us_split_fields5 temp___expr_266))) true)) (= (attr__constrained (rec__tests__test_15__holder__content1 (us_split_fields5 temp___expr_266))) true))))
(define-fun default_initial_assumption ((temp___expr_269 us_rep2) (temp___skip_top_level_270 Bool)) Bool (and (= (rec__tests__test_15__holder__present (us_split_discrs4 temp___expr_269)) (of_int 0)) (and (= (attr__constrained (rec__tests__test_15__holder__content1 (us_split_fields5 temp___expr_269))) true) (= (rec__tests__test_15__record_with_mutable_discrs__present (us_split_discrs1 (rec__tests__test_15__holder__content1 (us_split_fields5 temp___expr_269)))) (of_int 0)))))
...
(define-fun default_initial_assumption1 ((temp___expr_253 us_rep) (temp___skip_top_level_254 Bool)) Bool (and (= (attr__constrained temp___expr_253) false) (= (rec__tests__test_15__record_with_mutable_discrs__present (us_split_discrs1 temp___expr_253)) (of_int 0))))
(define-fun dynamic_invariant3 ((temp___expr_278 us_rep) (temp___is_init_275 Bool) (temp___skip_constant_276 Bool) (temp___do_toplevel_277 Bool)) Bool (and (=> (not (= temp___skip_constant_276 true)) (in_range5 (rec__tests__test_15__holder__present (us_split_discrs3 r17b)) temp___expr_278)) (= (attr__constrained temp___expr_278) true)))
(define-fun default_initial_assumption2 ((temp___expr_280 us_rep) (temp___skip_top_level_281 Bool)) Bool (and (= (attr__constrained temp___expr_280) true) (= (rec__tests__test_15__record_with_mutable_discrs__present (us_split_discrs1 temp___expr_280)) (rec__tests__test_15__holder__present (us_split_discrs3 r17b)))))
...
(assert (not (in_range (to_int1 temp___present_389))))
(check-sat)
(exit)
