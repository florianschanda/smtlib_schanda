...
(assert (= o10 n))
(assert (and (= o11 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o10)) (and (in_range5 o11) (= o11 (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) o10)))))
(assert (not (dynamic_property3 first2 last3 n)))
(check-sat)
(exit)
