...
(assert (= result3 true))
(assert (and (= o12 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o12) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o13 (get o12 i)) (in_range4 o13)))
(assert (= result4 (ite (< 0 o13) true false)))
(assert (= result4 true))
...
(assert (and (= o10 (get o9 i)) (in_range4 o10)))
(assert (= o11 (- o10 1)))
(assert (and (= o8 (model__ (mk___rep l__split_discrs l__split_fields1))) (= (length1 o8) (length (mk___rep l__split_discrs l__split_fields1)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
