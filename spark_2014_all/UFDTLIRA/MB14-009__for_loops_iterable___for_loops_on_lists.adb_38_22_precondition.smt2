...
(assert (and (= o14 (get o13 i)) (in_range4 o14)))
(assert (= result5 (ite (< 0 o14) true false)))
(assert (= result5 true))
...
(assert (= o11 (- o10 1)))
(assert (and (= o8 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o8) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
