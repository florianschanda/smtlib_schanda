...
(define-fun dynamic_invariant1 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (init_in_loop__B_2__lst Int)) Bool (=> (or (= temp___is_init_168 true) (<= first (last init_in_loop__B_2__lst))) (dynamic_property first (last init_in_loop__B_2__lst) temp___expr_171)))
(assert (= first fst))
...
(assert (=> (not (= (of_int 0) true)) (= init_in_loop__B_2__fst__assume 51)))
