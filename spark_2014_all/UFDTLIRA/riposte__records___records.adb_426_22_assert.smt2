...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___457 o5))
(assert (= temp___4571 o6))
(assert (= temp___4572 o7))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= result2 x__split_fields2))
(assert (= temp___457 x__split_fields3))
(assert (= temp___4571 x__split_fields4))
(assert (= temp___4572 x__split_fields5))
(assert (not (not (= (to_rep x__split_fields4) (to_rep x__split_fields5)))))
(check-sat)
(exit)
