...
(assert (= o9 current2))
(assert (and (= o10 (get (model__ v) o9)) (and (in_range4 o10) (= o10 (get (model__ v) o9)))))
(assert (= result4 (ite (= o10 e) true false)))
(assert (not (= result4 true)))
(assert (= use_vectors__my_find__result3 use_vectors__my_find__result2))
(assert (not (= current2 r27b)))
(assert (= result6 current2))
(assert (= current3 (+ current2 1)))
(declare-const i3 Int)
(assert (<= first i3))
(assert (<= i3 (- current3 1)))
