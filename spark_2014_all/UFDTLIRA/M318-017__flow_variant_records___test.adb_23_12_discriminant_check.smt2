...
(define-fun dynamic_invariant1 ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 2)) (in_range2 temp___expr_161)))
...
(declare-const o5 dt)
(declare-const o6 dt)
(declare-const temp___275 dt)
(declare-const temp___2751 Bool)
(declare-const temp___2752 integer)
(declare-const temp___2753 Bool)
(declare-const temp___2754 dt)
(assert (in_range1 x))
(assert (< 0 x))
...
(assert (= (to_rep1 o) 0))
(assert (= o o6))
(assert (= temp___275 o6))
(assert (= temp___2751 o2))
(assert (= temp___2752 o3))
(assert (= temp___2753 o4))
(assert (= temp___2754 o5))
(assert (not (= temp___275 (rec__test__wibble__d r__split_discrs))))
(check-sat)
(exit)
