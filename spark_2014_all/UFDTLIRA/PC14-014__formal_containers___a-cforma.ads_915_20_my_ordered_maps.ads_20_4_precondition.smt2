...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_ordered_maps__n__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_587 Int) (temp___is_init_584 Bool) (temp___skip_constant_585 Bool) (temp___do_toplevel_586 Bool)) Bool (=> (or (= temp___is_init_584 true) (<= 1 2147483647)) (in_range2 temp___expr_587)))
...
(define-fun default_initial_assumption ((temp___expr_594 us_rep2) (temp___skip_top_level_595 Bool)) Bool (=> (not (= temp___skip_top_level_595 true)) (and (= (is_empty temp___expr_594) true) (= (length2 temp___expr_594) 0))))
...
(assert (forall ((container1 us_rep4)) (! (dynamic_invariant (length3 container1) true false true) :pattern ((length3 container1)))))
...
(assert true)
(assert (forall ((container1 us_rep4)) (forall ((key us_rep3)) (! (=> (= (has_key1 container1 key) true) (let ((result (witness1 container1 key))) (and (= (has_witness container1 result) true) (dynamic_invariant result true false true)))) :pattern ((witness1 container1 key))))))
(assert (forall ((container1 us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true) (= (has_witness container1 witness2) true)) (dynamic_invariant3 (w_get1 container1 witness2) true false true)) :pattern ((w_get1 container1 witness2))))))
