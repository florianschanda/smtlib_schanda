...
(assert (forall ((x tcount_typeB)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant ((temp___expr_231 us_rep) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 temp___expr_231)))))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 container))) last))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(declare-const last_count Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_225 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 last)) (dynamic_property 0 last temp___expr_225)))
(assert (= last last_count))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (=> (dynamic_invariant container true true true) (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant1 result true false true)))) :pattern ((length container)))))
...
(assert (forall ((x Int) (f Int) (l Int)) (! (=> (and (and (dynamic_invariant2 x true true true) (dynamic_invariant2 f true true true)) (dynamic_invariant2 l true true true)) (let ((result (id x f l))) (and (=> (and (<= f x) (<= x l)) (and (<= f result) (<= result l))) (dynamic_invariant2 result true false true)))) :pattern ((id x f l)))))
...
(define-fun dynamic_invariant3 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= first last1)) (dynamic_property1 first last1 temp___expr_207)))
(assert (= first fst))
(assert (= last1 lst))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property 0 last o1) (= o1 (ite (= (of_int 0) true) (to_rep (rec__use_vectors__my_vectors__vector__capacity container__split_discrs)) last)))))
(assert (= o2 (- o1 o)))
