...
(declare-const temp___432 Bool)
(declare-const temp___4321 unsigned_byte)
(declare-const temp___4322 unsigned_byte)
...
(define-fun temp___4323 () us_rep1 (mk___rep1 (mk___split_fields1 temp___432 (mk___rep (mk___split_fields temp___4321 temp___4322)))))
(assert (and (= temp___4323 (update_a (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))) (to_rep x__split_fields2))) (= (bool_eq1 temp___4323 (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields (of_rep (to_rep x__split_fields2)) x__split_fields2))))) true)))
(assert (= result x__split_fields))
(assert (= result1 x__split_fields1))
(assert (= result2 x__split_fields2))
(assert (= temp___432 x__split_fields3))
(assert (= temp___4321 x__split_fields4))
(assert (= temp___4322 x__split_fields5))
