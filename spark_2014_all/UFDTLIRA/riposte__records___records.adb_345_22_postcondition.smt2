...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___399 (mk___rep (mk___split_fields temp___3991 temp___3992)))) (update_a (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields x__split_fields1 x__split_fields2)))) (to_rep x__split_fields2))) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___399 (mk___rep (mk___split_fields temp___3991 temp___3992)))) (mk___rep1 (mk___split_fields1 x__split_fields (mk___rep (mk___split_fields (of_rep (to_rep x__split_fields2)) x__split_fields2))))) true)))
...
(assert (not (= (to_rep x__split_fields7) (to_rep x__split_fields2))))
(check-sat)
(exit)
