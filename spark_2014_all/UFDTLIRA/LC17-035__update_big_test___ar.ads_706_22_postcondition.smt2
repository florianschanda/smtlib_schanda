...
(declare-const temp___6649 et1)
(declare-const temp___66491 et2)
...
(assert (= temp___6649 o1))
(assert (= temp___66491 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___6649 r__split_fields2))
(assert (= temp___66491 r__split_fields3))
...
(assert (not (= (to_rep r__split_fields4) e)))
(check-sat)
(exit)
