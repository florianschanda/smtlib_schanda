...
(assert (<= 1 i2))
(assert (<= i2 r36b))
(assert (and (= (mk___rep (mk___split_fields o o1 o2)) (maximum_date Tuple0)) (and (= (of_rep2 31) o) (and (= (of_rep1 12) o1) (= (of_rep 2099) o2)))))
(assert (= result3 (bool_eq (mk___rep (mk___split_fields current_date__split_fields current_date__split_fields1 current_date__split_fields2)) (mk___rep (mk___split_fields o o1 o2)))))
(assert (not (= result3 true)))
(assert (= valid2 valid1))
(assert (not (not (= (bool_eq (mk___rep (mk___split_fields current_date__split_fields current_date__split_fields1 current_date__split_fields2)) (maximum_date Tuple0)) true))))
(check-sat)
(exit)
