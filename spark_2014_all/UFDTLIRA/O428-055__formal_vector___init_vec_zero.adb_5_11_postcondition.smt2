...
(assert (= j1 r4b))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= temp___529 j1)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= temp___530 (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (and (= v__split_discrs (mk___split_discrs temp___528)) (= v__split_fields temp___5281))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (and (= o j1) (in_range1 j1))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (and (and (= (length1 (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields1)) (length1 (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (= (get (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields1)) o) 0)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields1)) o) true))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= (mk___split_fields__ref (mk___split_fields result1)) v__split_fields11)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= (mk___split_fields v__split_fields2) loop_types__vectors__replace_element__container__fields1)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= (last (model__ (mk___rep v__split_discrs v__split_fields10))) temp___530)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (= (get (model__ (mk___rep v__split_discrs v__split_fields10)) k) 0)))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (and (=> (<= r4b r5b) (dynamic_property r4b r5b j2)) (and (<= r4b j2) (<= j2 r5b)))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= j2 r5b)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= j3 (mk_int__ref j2))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= v__split_fields4 (mk___split_fields__ref v__split_fields10))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= j4 j2)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= v__split_fields5 v__split_fields10)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= j5 j3)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= v__split_fields6 v__split_fields4)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= j6 j4)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= v__split_fields7 v__split_fields5)))
(assert (=> (not (and (<= r4b j1) (<= j1 r5b))) (= j5 (mk_int__ref j1))))
(assert (=> (not (and (<= r4b j1) (<= j1 r5b))) (= v__split_fields6 v__split_fields11)))
(assert (=> (not (and (<= r4b j1) (<= j1 r5b))) (= j6 j1)))
(assert (=> (not (and (<= r4b j1) (<= j1 r5b))) (= v__split_fields7 (mk___split_fields v__split_fields1))))
(assert (= j7 j5))
...
(assert (<= 1 j9))
(assert (<= j9 (last (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))))))
(assert (not (= (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) j9) 0)))
(check-sat)
(exit)
