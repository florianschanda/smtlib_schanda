...
(assert (= j1 r4b))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= temp___587 j1)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= temp___588 (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (and (= v__split_discrs (mk___split_discrs temp___586)) (= v__split_fields temp___5861))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (and (= o j1) (in_range3 j1))))
...
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= (last (model__ (mk___rep v__split_discrs v__split_fields10))) temp___588)))
