...
(define-fun dynamic_invariant1 ((temp___expr_253 Int) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool) (temp___do_typ_inv_252 Bool)) Bool (=> (or (= temp___is_init_249 true) (<= 0 1001)) (in_range2 temp___expr_253)))
...
(define-fun dynamic_invariant5 ((temp___expr_260 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool) (temp___do_typ_inv_259 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 1000)) (in_range3 temp___expr_260)))
...
(declare-const temp___584 capacity_range)
(declare-const temp___5841 us_main_type)
(declare-const o Int)
...
(assert (= j1 r4b))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= temp___585 j1)))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= temp___586 (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (and (= v__split_discrs (mk___split_discrs temp___584)) (= v__split_fields temp___5841))))
...
(assert (=> (and (<= r4b j1) (<= j1 r5b)) (= (last (model__ (mk___rep v__split_discrs v__split_fields10))) temp___586)))
