...
(define-fun dynamic_invariant ((temp___expr_205 Int) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (=> (or (= temp___is_init_202 true) (<= 1 1000)) (in_range1 temp___expr_205)))
...
(define-fun dynamic_invariant1 ((temp___expr_217 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 0 1001)) (in_range2 temp___expr_217)))
...
(define-fun dynamic_invariant2 ((temp___expr_211 Int) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool)) Bool (=> (or (= temp___is_init_208 true) (<= 0 2147483647)) (in_range4 temp___expr_211)))
...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range6 temp___expr_142)))
(define-fun dynamic_invariant5 ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= 0 1000)) (in_range3 temp___expr_223)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep1 (rec__loop_types__vectors__vector__capacity (us_split_discrs1 container))) 1000))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant5 result true false true))) :pattern ((length1 container)))))
...
(define-fun default_initial_assumption ((temp___expr_257 us_rep1) (temp___skip_top_level_258 Bool)) Bool (=> (not (= temp___skip_top_level_258 true)) (= (length temp___expr_257) 0)))
...
(define-fun dynamic_invariant6 ((temp___expr_250 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 0 1000)) (in_range7 temp___expr_250)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= (+ 0 result) 1000) (dynamic_invariant4 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_244 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 2147483647)) (in_range8 temp___expr_244)))
...
(declare-const temp___528 capacity_range)
(declare-const temp___5281 us_main_type)
(declare-const o Int)
(declare-const k Int)
...
(declare-const loop_types__vectors__replace_element__container__fields1 us_main_type)
(declare-const result4 us_main_type)
(declare-const v__split_fields4 us_main_type)
(declare-const v__split_fields5 us_split_fields__ref)
(declare-const j5 int__ref)
(declare-const v__split_fields6 us_split_fields)
(declare-const j6 Int)
(declare-const v__split_fields7 us_split_fields__ref)
(declare-const j7 int__ref)
(declare-const v__split_fields8 us_split_fields)
(declare-const j8 Int)
(declare-const v__split_fields9 us_split_fields__ref)
(declare-const j9 int__ref)
(declare-const v__split_fields10 us_split_fields)
(declare-const j10 Int)
(declare-const result5 Bool)
(assert (and (= init_vec_zero__L_1__R4b__assume 1) (and (in_range1 init_vec_zero__L_1__R4b__assume) (= init_vec_zero__L_1__R4b__assume 1))))
...
(assert (= j2 r4b))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= temp___529 j2)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= temp___530 (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (and (= v__split_discrs (mk___split_discrs temp___528)) (= v__split_fields temp___5281))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (and (= o j2) (in_range1 j2))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (and (and (= (length1 (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields))) (length1 (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields))) o) 0)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields))) o) true))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= (mk___split_fields v__split_fields2) (mk___split_fields loop_types__vectors__replace_element__container__fields))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3)))) temp___530)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j3)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) k1) 0)))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (and (=> (<= r4b r5b) (dynamic_property r4b r5b j3)) (and (<= r4b j3) (<= j3 r5b)))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= j3 r5b)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= j5 (mk_int__ref j3))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= v__split_fields5 (mk___split_fields__ref (mk___split_fields v__split_fields3)))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= j6 j3)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= v__split_fields6 (mk___split_fields v__split_fields3))))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= j7 j5)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= v__split_fields7 v__split_fields5)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= j8 j6)))
(assert (=> (and (<= r4b j2) (<= j2 r5b)) (= v__split_fields8 v__split_fields6)))
(assert (=> (not (and (<= r4b j2) (<= j2 r5b))) (= j7 (mk_int__ref j2))))
(assert (=> (not (and (<= r4b j2) (<= j2 r5b))) (= v__split_fields7 (mk___split_fields__ref (mk___split_fields v__split_fields)))))
(assert (=> (not (and (<= r4b j2) (<= j2 r5b))) (= j8 j2)))
(assert (=> (not (and (<= r4b j2) (<= j2 r5b))) (= v__split_fields8 (mk___split_fields v__split_fields1))))
(assert (= j9 j7))
(assert (= v__split_fields9 v__split_fields7))
(assert (= j10 j8))
(assert (= v__split_fields10 v__split_fields8))
(declare-const j11 Int)
(assert (<= 1 j11))
(assert (<= j11 (last (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields9))))))
(assert (not (= (get (model__ (mk___rep v__split_discrs (us_split_fields__content v__split_fields9))) j11) 0)))
(check-sat)
(exit)
