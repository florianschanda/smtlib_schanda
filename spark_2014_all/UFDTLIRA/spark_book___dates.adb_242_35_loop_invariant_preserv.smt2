...
(declare-const current_date__split_fields3 us_split_fields)
(declare-const valid3 Bool)
(declare-const i2 Int)
(declare-const current_date__split_fields4 us_split_fields)
...
(assert (<= 1 i1))
(assert (<= i1 r38b))
(assert (and (= o7 (minimum_date Tuple0)) (and (= (of_rep2 1) o) (and (= (of_rep1 1) o1) (= (of_rep 2000) o2)))))
(assert (= result3 (bool_eq (mk___rep (mk___split_fields current_date__split_fields current_date__split_fields1 current_date__split_fields2)) o7)))
(assert (not (= result3 true)))
(assert (= valid2 valid1))
(assert (not (= (bool_eq (mk___rep current_date__split_fields3) (minimum_date Tuple0)) true)))
(assert (and (=> (<= 1 r38b) (dynamic_property1 1 r38b i2)) (and (<= 1 i2) (<= i2 r38b))))
(assert (not (= i2 r38b)))
(assert (= result4 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (and (= o6 (minimum_date Tuple0)) (and (= (of_rep2 1) o3) (and (= (of_rep1 1) o4) (= (of_rep 2000) o5)))))
(assert (= result5 (bool_eq (mk___rep current_date__split_fields4) o6)))
(assert (not (= result5 true)))
(assert (= valid4 valid3))
(assert (not (not (= (bool_eq (mk___rep current_date__split_fields4) (minimum_date Tuple0)) true))))
(check-sat)
(exit)
