...
(assert (not (= (bool_eq (mk___rep current_date__split_fields9) (minimum_date Tuple0)) true)))
(assert (and (=> (<= 1 r38b) (dynamic_property1 1 r38b i6)) (and (<= 1 i6) (<= i6 r38b))))
(assert true)
(assert (not (= i6 r38b)))
(assert (= result9 (mk_int__ref i6)))
(assert (= i7 (+ i6 1)))
(assert (and (= (mk___rep (mk___split_fields o9 o10 o11)) (minimum_date Tuple0)) (and (= (of_rep2 1) o9) (and (= (of_rep1 1) o10) (= (of_rep 2000) o11)))))
(assert (= result10 (bool_eq (mk___rep current_date__split_fields10) (mk___rep (mk___split_fields o9 o10 o11)))))
(assert (not (= result10 true)))
(assert (= valid7 valid6))
(assert (not (not (= (bool_eq (mk___rep current_date__split_fields10) (minimum_date Tuple0)) true))))
(check-sat)
(exit)
