...
(assert (<= 1 i1))
(assert (<= i1 r38b))
(assert (and (= o7 (minimum_date Tuple0)) (and (= rliteral3 o) (and (= rliteral4 o1) (= rliteral5 o2)))))
...
(assert (= i3 (+ i2 1)))
(assert (and (= o6 (minimum_date Tuple0)) (and (= rliteral3 o3) (and (= rliteral4 o4) (= rliteral5 o5)))))
