...
(define-fun us_split_discrs___projection ((a us_split_discrs)) capacity_range (rec__unbounded_strings__char_vectors__vector__capacity a))
...
(define-fun dynamic_invariant ((temp___expr_212 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 1 2147483647)) (in_range2 temp___expr_212)))
...
(define-fun dynamic_invariant1 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 255)) (in_range3 temp___expr_218)))
...
(define-fun default_initial_assumption ((temp___expr_253 us_rep1) (temp___skip_top_level_254 Bool)) Bool (=> (not (= temp___skip_top_level_254 true)) (= (length temp___expr_253) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_224 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 0 2147483647)) (in_range4 temp___expr_224)))
...
(define-fun dynamic_invariant4 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 2147483647)) (in_range1 temp___expr_183)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__unbounded_strings__char_vectors__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 0 2147483647)) (in_range6 temp___expr_246)))
...
(define-fun dynamic_invariant6 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 255)) (in_range7 temp___expr_240)))
...
(assert (=> (not (= result true)) (and (= o2 (last (model__ container))) (and (in_range4 o2) (= o2 (last (model__ container)))))))
