...
(define-fun default_initial_assumption ((temp___expr_173 us_rep) (temp___skip_top_level_174 Bool)) Bool (= (to_rep (rec__support__protT__summary (us_split_fields1 temp___expr_173))) 0))
...
(define-fun dynamic_invariant1 ((temp___expr_160 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 97)) (in_range temp___expr_160)))
...
(assert (= result prot__split_fields))
(assert (= prot__split_fields1 us_self__compl1))
(assert (not false))
(check-sat)
(exit)
