...
(assert (forall ((foo__c Int)) (! (=> (dynamic_invariant foo__c true true true) (dynamic_invariant (get_c foo__c) true false true)) :pattern ((get_c foo__c)))))
(assert (forall ((foo__c Int)) (! (=> (dynamic_invariant foo__c true true true) (= (get_c foo__c) foo__c)) :pattern ((get_c foo__c)))))
