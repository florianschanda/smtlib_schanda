...
(assert (and (= o7 (intersection__2 (mk___rep target__split_discrs (mk___split_fields target__split_fields)) source)) (and (and (and (and (and (= (length o7) (num_overlaps (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source))) (= (ole (model__ o7) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (ole (model__ o7) (model__ source)) true)) (= (includes_intersection (model__ o7) (model__ (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source)) true)) (= (e_elements_included (elements o7) (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true)) (= (e_elements_included__2 (elements (mk___rep target__split_discrs (mk___split_fields target__split_fields))) (model__ source) (elements o7)) true))))
(assert (and (= o4 (length o7)) (and (in_range o4) (<= o4 (to_rep o2)))))
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range o) (<= o (to_rep (rec__p__my_sets__set__capacity target__split_discrs))))))
(assert (= o1 (- (to_rep (rec__p__my_sets__set__capacity target__split_discrs)) o)))
(assert (and (= o5 o1) (in_range1 o1)))
(assert (= o6 (+ o5 o4)))
