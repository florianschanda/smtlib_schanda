...
(declare-const temp___1039 capacity_range)
(declare-const temp___10391 capacity_range1)
(declare-const temp___10392 us_main_type)
(declare-const temp___10393 us_private)
(declare-const temp___10394 Int)
(assert (in_range temp___1036))
(assert (and (= (to_rep temp___1039) (to_rep1 temp___10391)) (and (= temp___10394 us_tag) (and (= (to_rep1 temp___10391) (to_rep temp___1039)) (= (is_empty1 (mk___rep (mk___split_discrs temp___10391) (mk___split_fields temp___10392))) true)))))
(assert (not (= (is_empty (mk___rep1 (mk___split_discrs1 temp___1039) (mk___split_fields1 (mk___rep (mk___split_discrs temp___10391) (mk___split_fields temp___10392)) temp___10393) temp___10394)) true)))
(check-sat)
(exit)
