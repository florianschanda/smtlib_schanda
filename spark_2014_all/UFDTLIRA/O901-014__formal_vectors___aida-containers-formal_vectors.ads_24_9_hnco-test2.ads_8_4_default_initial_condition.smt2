...
(assert (and (= (to_rep temp___951) (to_rep1 temp___9511)) (and (= temp___9514 us_tag) (and (= (to_rep1 temp___9511) (to_rep temp___951)) (= (is_empty1 (mk___rep (mk___split_discrs temp___9511) (mk___split_fields temp___9512))) true)))))
(assert (not (= (is_empty (mk___rep1 (mk___split_discrs1 temp___951) (mk___split_fields1 (mk___rep (mk___split_discrs temp___9511) (mk___split_fields temp___9512)) temp___9513) temp___9514)) true)))
(check-sat)
(exit)
