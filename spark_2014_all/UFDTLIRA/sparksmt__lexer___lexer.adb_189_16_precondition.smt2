...
(assert (= result true))
(assert (and (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1 current_pos2)) (and (= (to_rep1 (rec__file_io__read_result__status current_read__split_discrs2)) 0) (let ((temp___1002 (to_rep (rec__file_io__read_result__c current_read__split_fields2)))) (or (= temp___1002 10) (or (= temp___1002 13) (or (= temp___1002 32) (= temp___1002 9))))))))
