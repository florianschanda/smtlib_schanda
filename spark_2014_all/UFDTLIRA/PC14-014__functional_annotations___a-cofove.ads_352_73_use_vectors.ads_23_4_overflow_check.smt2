...
(define-fun dynamic_invariant6 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first1 last3)) (dynamic_property2 first1 last3 temp___expr_242)))
(assert (= first1 fst))
(assert (= last3 lst))
...
(assert (= last5 last1))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first 1) result) last1) (dynamic_invariant5 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true true) (and (<= first position) (<= position (last2 container)))) (dynamic_invariant8 (get container position) true false true true)) :pattern ((get container position))))))
(define-fun dynamic_invariant9 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first last1)) (dynamic_property1 first last1 temp___expr_280)))
(assert (= first fst))
(assert (= last1 lst))
...
(assert (dynamic_property3 first2 last4 before))
(assert (in_range3 new_item))
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property 0 last o2) (= o2 (ite (= (distinct 0 0) true) (to_rep (rec__use_vectors__my_vectors__vector__capacity container__split_discrs)) last)))))
(assert (and (= o3 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property 0 last o3) (<= o3 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
(assert (= result (ite (< o3 o2) true false)))
(assert (= result true))
(assert (and (= o (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))) (and (dynamic_property3 first2 last4 o) (= o (last2 (model__ (mk___rep container__split_discrs (mk___split_fields container__split_fields))))))))
(assert (= o1 (+ o 1)))
