...
(define-fun dynamic_invariant ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_249)))
...
(define-fun dynamic_invariant3 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 last2)) (dynamic_property2 0 last2 temp___expr_263)))
(assert (= last2 last_count))
(declare-fun length (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (=> (dynamic_invariant2 container true true true true) (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant3 result true false true true)))) :pattern ((length container)))))
...
(define-fun dynamic_invariant6 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= first last)) (dynamic_property first last temp___expr_242)))
(assert (= first fst))
(assert (= last lst))
...
(assert (= last5 last3))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first2 1) result) last3) (dynamic_invariant5 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true true) (and (<= first2 position) (<= position (last4 container)))) (dynamic_invariant8 (get container position) true false true true)) :pattern ((get container position))))))
(define-fun dynamic_invariant9 ((temp___expr_280 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= first2 last3)) (dynamic_property3 first2 last3 temp___expr_280)))
(assert (= first2 fst))
(assert (= last3 lst))
...
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property2 0 last2 o2) (= o2 (ite (= (distinct 0 0) true) (to_rep1 (rec__use_vectors__my_vectors__vector__capacity container__split_discrs)) last2)))))
(assert (and (= o3 (length (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (dynamic_property2 0 last2 o3) (<= o3 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))))))
