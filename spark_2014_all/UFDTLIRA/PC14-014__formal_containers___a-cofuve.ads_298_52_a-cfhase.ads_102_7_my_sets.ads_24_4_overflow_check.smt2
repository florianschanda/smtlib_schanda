...
(define-fun dynamic_invariant ((temp___expr_753 Int) (temp___is_init_749 Bool) (temp___skip_constant_750 Bool) (temp___do_toplevel_751 Bool) (temp___do_typ_inv_752 Bool)) Bool (=> (or (= temp___is_init_749 true) (<= 1 2147483647)) (in_range1 temp___expr_753)))
...
(define-fun dynamic_invariant1 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range5 temp___expr_197)))
...
(define-fun dynamic_invariant2 ((temp___expr_769 Int) (temp___is_init_765 Bool) (temp___skip_constant_766 Bool) (temp___do_toplevel_767 Bool) (temp___do_typ_inv_768 Bool)) Bool (=> (or (= temp___is_init_765 true) (<= 0 2147483647)) (in_range6 temp___expr_769)))
