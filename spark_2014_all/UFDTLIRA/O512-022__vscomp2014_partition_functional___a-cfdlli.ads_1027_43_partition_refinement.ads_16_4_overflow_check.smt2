...
(define-fun dynamic_invariant1 ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1 2147483647)) (in_range3 temp___expr_376)))
...
(declare-const temp___958 count_type)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___958 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___958)) no_element))
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__partition_refinement__partitioning_sets__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__partition_refinement__partitioning_sets__list__capacity target__split_discrs)) o2)))
