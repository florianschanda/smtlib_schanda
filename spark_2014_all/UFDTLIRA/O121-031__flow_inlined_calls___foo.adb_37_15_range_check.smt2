...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (bar x) true false true)) :pattern ((bar x)))))
(declare-const a Int)
...
(assert (= tmp_b (bar a)))
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 last)) (dynamic_property 0 last temp___expr_141)))
(assert (= last tmp_b))
(declare-const b Int)
