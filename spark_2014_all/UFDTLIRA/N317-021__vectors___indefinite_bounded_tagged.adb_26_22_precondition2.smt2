...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___583 temp___5831) temp___5832) (f 2)) (and (and (= (of_rep1 2) temp___583) (= us_null_ext__ temp___5831)) (= us_tag temp___5832))))
(assert (not (<= 1 2)))
(check-sat)
(exit)
