...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields1)))) (= (get (elements (mk___rep s2__split_discrs s2__split_fields1)) i) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i)))))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s1__split_discrs s1__split_fields1)))) (= (get (elements (mk___rep s1__split_discrs s1__split_fields1)) i) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (+ (length (mk___rep s2__split_discrs s2__split_fields1)) i))))))
(assert (and (= o (element (mk___rep s1__split_discrs s1__split_fields1) (mk___rep1 cu__split_fields2))) (and (in_range7 o) (= o (get (elements (mk___rep s1__split_discrs s1__split_fields1)) (get1 (positions (mk___rep s1__split_discrs s1__split_fields1)) (mk___rep1 cu__split_fields2)))))))
...
(assert (not (= (has_key (positions (mk___rep s1__split_discrs s1__split_fields1)) (mk___rep1 cu__split_fields2)) true)))
(check-sat)
(exit)
