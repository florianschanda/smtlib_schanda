...
(declare-fun user_eq (index_count index_count) Bool)
(declare-const dummy index_count)
...
(assert (forall ((x index_count)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun element_type__ref___9__projection ((a element_type__ref)) us_rep (element_type__content a))
...
(define-fun contains ((container us_rep1) (fst Int) (lst Int) (item us_rep)) Bool (ite (exists ((i Int)) (and (and (<= fst i) (<= i lst)) (= (bool_eq (get container i) item) true))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__partition_refinement__partitions__vector us_main_type1)))))
(define-fun us_split_fields_Vector__projection ((a us_split_fields2)) us_main_type1 (rec__partition_refinement__partitions__vector a))
...
(define-fun us_rep___14__projection ((a us_rep2)) us_split_discrs (us_split_discrs1 a))
...
(define-fun oeq ((left us_rep1) (right us_rep1)) Bool (and (= (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last left))) (= (bool_eq (get left n) (get right n)) true))) true false)))
(declare-fun oeq__function_guard (Bool us_rep1 us_rep1) Bool)
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq3 a b) (oeq a b)) :pattern ((user_eq3 a b)))))
(define-fun default_initial_assumption ((temp___expr_841 us_rep1) (temp___skip_top_level_842 Bool)) Bool (=> (not (= temp___skip_top_level_842 true)) (= (length temp___expr_841) 0)))
...
(define-fun dynamic_invariant ((temp___expr_792 Int) (temp___is_init_788 Bool) (temp___skip_constant_789 Bool) (temp___do_toplevel_790 Bool) (temp___do_typ_inv_791 Bool)) Bool (=> (or (= temp___is_init_788 true) (<= (- 1) 10001)) (in_range4 temp___expr_792)))
...
(define-fun dynamic_invariant1 ((temp___expr_775 Int) (temp___is_init_771 Bool) (temp___skip_constant_772 Bool) (temp___do_toplevel_773 Bool) (temp___do_typ_inv_774 Bool)) Bool (=> (or (= temp___is_init_771 true) (<= 0 10000)) (in_range5 temp___expr_775)))
...
(define-fun element_type__ref___8__projection ((a element_type__ref1)) us_rep (element_type__content1 a))
(declare-const item us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const index1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant2 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range1 temp___expr_326)))
(define-fun dynamic_invariant3 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range2 temp___expr_333)))
...
(define-fun dynamic_invariant5 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range3 temp___expr_799)))
...
(assert (forall ((x capacity_range)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun capacity ((container1 us_rep2)) Int (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity (us_split_discrs1 container1))) 10001))
(declare-fun capacity__function_guard (Int us_rep2) Bool)
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (capacity container1)) (dynamic_invariant5 result true false true true))) :pattern ((length1 container1)))))
(define-fun dynamic_invariant6 ((temp___expr_833 Int) (temp___is_init_829 Bool) (temp___skip_constant_830 Bool) (temp___do_toplevel_831 Bool) (temp___do_typ_inv_832 Bool)) Bool (=> (or (= temp___is_init_829 true) (<= (- 1) 10000)) (in_range6 temp___expr_833)))
(assert (forall ((container1 us_rep1)) (! (let ((result (length container1))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant4 result true false true true))) :pattern ((length container1)))))
(assert true)
(declare-const o Int)
(declare-const o1 Int)
(declare-const result Bool)
(assert (in_range5 index1))
(assert (and (= o (last (model__ container))) (and (in_range4 o) (= o (last (model__ container))))))
(assert (= result (ite (<= index1 o) true false)))
(assert (not (= result true)))
(assert (and (= o1 (last (model__ container))) (and (in_range4 o1) (= o1 (last (model__ container))))))
(assert (not (in_range6 o1)))
(check-sat)
(exit)
