...
(assert (and (= temp___465 (last4 (model__ container))) (and (dynamic_property4 first3 last5 temp___465) (= temp___465 (last4 (model__ container))))))
(assert (not (dynamic_property3 first2 last3 temp___465)))
(check-sat)
(exit)
