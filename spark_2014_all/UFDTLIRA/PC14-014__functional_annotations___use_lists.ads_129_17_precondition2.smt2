...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__use_lists__my_lists__list us_main_type1)))))
(define-fun us_split_fields_List__projection ((a us_split_fields)) us_main_type1 (rec__use_lists__my_lists__list a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 a))) (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__use_lists__my_lists__list (us_split_fields1 a)) (rec__use_lists__my_lists__list (us_split_fields1 b))) true)) true false))
...
(define-fun default_initial_assumption1 ((temp___expr_280 us_rep2) (temp___skip_top_level_281 Bool)) Bool (= (to_rep (rec__use_lists__my_lists__cursor__node (us_split_fields3 temp___expr_280))) 0))
...
(assert true)
(define-fun default_initial_assumption2 ((temp___expr_235 us_rep2) (temp___skip_top_level_236 Bool)) Bool (= (to_rep (rec__use_lists__my_lists__cursor__node (us_split_fields3 temp___expr_235))) 0))
...
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= result (to_rep (rec__use_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
...
(define-fun default_initial_assumption3 ((temp___expr_294 us_rep3) (temp___skip_top_level_295 Bool)) Bool (=> (not (= temp___skip_top_level_295 true)) (and (= (is_empty temp___expr_294) true) (= (length2 temp___expr_294) 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1 2147483647)) (in_range6 temp___expr_286)))
...
(assert (forall ((container us_rep3)) (! (dynamic_invariant4 (length2 container) true false true true) :pattern ((length2 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant4 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant5 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
(declare-const temp___610 us_rep)
(declare-const temp___609 Int)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const result Bool)
(assert (forall ((cu us_rep2)) (=> (= (has_key (positions l) cu) true) (= (prop__ (element l cu)) true))))
(assert (let ((temp___309 (model__ l))) (forall ((temp___308 Int)) (=> (and (in_range2 temp___308) (= (iter_has_element temp___309 temp___308) true)) (exists ((i us_rep2)) (and (= (has_key (positions l) i) true) (= (get (model__ l) (get1 (positions l) i)) (get temp___309 temp___308))))))))
(assert (and (= temp___610 (model__ l)) (= (length temp___610) (length1 l))))
(assert (and (= o (iter_has_element temp___610 temp___609)) (= (= o true) (and (<= 1 temp___609) (<= temp___609 (last temp___610))))))
(assert (= (= o1 true) (in_range2 temp___609)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= 1 temp___609)))
(check-sat)
(exit)
