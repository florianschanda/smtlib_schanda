...
(assert (and (= o9 (length m)) (and (in_range4 o9) (<= o9 (capacity m)))))
(assert (and (= o7 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))) (and (in_range4 o7) (<= o7 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
(assert (and (= o8 (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (and (in_range4 o8) (<= o8 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
(assert (= o10 (+ o8 o7)))
(assert (= result1 (ite (= o10 o9) true false)))
(assert (=> (= result1 true) (and (= o6 (length m)) (and (in_range4 o6) (<= o6 (capacity m))))))
