...
(assert (and (and (and (= (length (mk___rep l__split_discrs l__split_fields3)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields2)))) (= (oeq1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (positions (mk___rep l__split_discrs l__split_fields3))) true)) (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2)))) 0)) (= (equal_except (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields2))) (model__ (mk___rep l__split_discrs l__split_fields3)) (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2)))) true)))
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 current__split_fields2)) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2))) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 current__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 current__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 current__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 (mk___split_fields1 current__split_fields2))) 1)))))
(assert (not (= (bool_eq1 (mk___rep1 current__split_fields3) (mk___rep1 (mk___split_fields1 n_last__split_fields2))) true)))
(declare-const i4 Int)
(assert (<= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 current__split_fields3)) i4))
(assert (<= i4 (length (mk___rep l__split_discrs l__split_fields3))))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i4) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i4))))
(check-sat)
(exit)
