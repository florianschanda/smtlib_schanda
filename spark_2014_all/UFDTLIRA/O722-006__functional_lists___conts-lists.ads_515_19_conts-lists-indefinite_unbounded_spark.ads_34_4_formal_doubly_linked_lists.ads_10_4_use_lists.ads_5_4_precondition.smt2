...
(declare-fun object__size4 (reference_type) Int)
(declare-const value__alignment4 Int)
(declare-fun object__alignment4 (reference_type) Int)
(assert (<= 0 value__size4))
(assert (forall ((a reference_type)) (<= 0 (object__size4 a))))
(assert (<= 0 value__alignment4))
(assert (forall ((a reference_type)) (<= 0 (object__alignment4 a))))
...
(declare-fun object__size5 (reference_type) Int)
(declare-const value__alignment5 Int)
(declare-fun object__alignment5 (reference_type) Int)
(assert (<= 0 value__size5))
(assert (forall ((a reference_type)) (<= 0 (object__size5 a))))
(assert (<= 0 value__alignment5))
(assert (forall ((a reference_type)) (<= 0 (object__alignment5 a))))
...
(declare-datatypes () ((element_access__ref (mk_element_access__ref (element_access__content us_rep4)))))
(define-fun element_access__ref___projection ((a element_access__ref)) us_rep4 (element_access__content a))
(declare-fun get_reference (us_rep4) reference_type)
(declare-fun get_reference__function_guard (reference_type us_rep4) Bool)
(declare-datatypes () ((stored_element_type__ref (mk_stored_element_type__ref (stored_element_type__content us_rep4)))))
(define-fun stored_element_type__ref___2__projection ((a stored_element_type__ref)) us_rep4 (stored_element_type__content a))
(declare-fun stored_element (us_rep3 us_rep) us_rep4)
(declare-fun stored_element__function_guard (us_rep4 us_rep3 us_rep) Bool)
(declare-fun reference (us_rep3 us_rep) reference_type)
(declare-fun reference__function_guard (reference_type us_rep3 us_rep) Bool)
...
(assert (forall ((self us_rep3)) (forall ((position us_rep)) (! (= (reference self position) (get_reference (stored_element self position))) :pattern ((reference self position))))))
(declare-fun user_eq7 (reference_type reference_type) Bool)
(declare-const value__size7 Int)
(declare-fun object__size7 (reference_type) Int)
(declare-const value__alignment7 Int)
(declare-fun object__alignment7 (reference_type) Int)
(assert (<= 0 value__size7))
(assert (forall ((a reference_type)) (<= 0 (object__size7 a))))
(assert (<= 0 value__alignment7))
(assert (forall ((a reference_type)) (<= 0 (object__alignment7 a))))
(declare-const dummy7 reference_type)
(declare-datatypes () ((reference_type__ref2 (mk_reference_type__ref2 (reference_type__content2 reference_type)))))
(define-fun reference_type__ref___4__projection ((a reference_type__ref2)) reference_type (reference_type__content2 a))
...
(define-fun default_initial_assumption1 ((temp___expr_488 us_rep3) (temp___skip_top_level_489 Bool)) Bool (= (attr__tag2 temp___expr_488) us_tag3))
(declare-const self us_rep3)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const position us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption2 ((temp___expr_252 us_rep1) (temp___skip_top_level_253 Bool)) Bool (= (attr__tag temp___expr_252) us_tag))
(assert true)
(assert (forall ((e us_rep4)) (! (= (get_reference e) dummy4) :pattern ((get_reference e)))))
(define-fun default_initial_assumption3 ((temp___expr_422 us_rep2) (temp___skip_top_level_423 Bool)) Bool (= (attr__tag1 temp___expr_422) us_tag1))
