...
(assert (and (= o16 (previous (mk___rep l1__split_discrs l1__split_fields4) o15)) (ite (= (ite (= (bool_eq1 o15 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o15) 1) true) true) (= (bool_eq1 o16 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o16) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o16) (- (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o15) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o16) true) (= (bool_eq1 o16 no_element) true))))
(check-sat)
(exit)
