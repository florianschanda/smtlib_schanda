...
(assert (and (= o14 (previous (mk___rep l1__split_discrs l1__split_fields4) o13)) (ite (= (ite (= (bool_eq3 o13 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o13) 1) true) true) (= (bool_eq3 o14 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o14) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o14) (- (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o13) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o14) true) (= (bool_eq3 o14 no_element) true))))
(check-sat)
(exit)
