...
(assert (and (= o87 (previous (mk___rep l1__split_discrs l1__split_fields4) o86)) (ite (= (ite (= (bool_eq1 o86 no_element) false) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o86) 1) true) true) (= (bool_eq1 o87 no_element) true) (and (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields4)) o87) true) (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o87) (- (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o86) 1))))))
(assert (not (or (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4)) o87) true) (= (bool_eq1 o87 no_element) true))))
(check-sat)
(exit)
