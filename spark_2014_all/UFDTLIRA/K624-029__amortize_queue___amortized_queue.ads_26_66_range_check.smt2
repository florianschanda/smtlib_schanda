...
(assert (and (= o6 (length right)) (and (in_range6 o6) (<= o6 (capacity right)))))
(assert (= o7 (+ 1 o6)))
(assert (and (= o8 (length (vector__content amortized_queue__Oconcat__2__result5))) (and (in_range6 o8) (<= o8 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
(assert (= result4 (ite (= o8 o7) true false)))
(assert (= result4 true))
(assert (and (= o5 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)) (and (in_range7 o5) (= o5 (get (model__ (vector__content amortized_queue__Oconcat__2__result5)) 1)))))
