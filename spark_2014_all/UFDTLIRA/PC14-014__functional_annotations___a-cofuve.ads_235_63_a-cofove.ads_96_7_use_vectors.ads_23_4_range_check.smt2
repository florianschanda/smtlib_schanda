...
(assert (and (= o12 (last2 left)) (and (dynamic_property1 first1 last1 o12) (= o12 (+ (- first 1) (length left))))))
(assert (= result (ite (<= lst1 o12) true false)))
(assert (= result true))
(assert (=> (< offset 0) (and (= o10 first) (in_range1 first))))
(assert (=> (< offset 0) (and (= o11 (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
