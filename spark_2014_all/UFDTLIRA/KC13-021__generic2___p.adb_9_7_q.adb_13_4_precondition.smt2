...
(define-fun dynamic_invariant1 ((temp___expr_183 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool) (temp___do_typ_inv_182 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_183)))
(declare-fun to_rep1 (t2) Int)
(declare-fun of_rep1 (Int) t2)
(assert (forall ((x t2)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x t2)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 2147483647)) (in_range2 temp___expr_190)))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__q__p2__r__a Bool) (rec__q__p2__r__b t2) (rec__q__p2__r__c t3) (rec__q__p2__r__d integer)))))
(define-fun us_split_fields_A__2__projection ((a us_split_fields)) Bool (rec__q__p2__r__a a))
(define-fun us_split_fields_B__2__projection ((a us_split_fields)) t2 (rec__q__p2__r__b a))
(define-fun us_split_fields_C__2__projection ((a us_split_fields)) t3 (rec__q__p2__r__c a))
(define-fun us_split_fields_D__2__projection ((a us_split_fields)) integer (rec__q__p2__r__d a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (rec__q__p2__r__a (us_split_fields1 a)) (rec__q__p2__r__a (us_split_fields1 b))) (= (to_rep1 (rec__q__p2__r__b (us_split_fields1 a))) (to_rep1 (rec__q__p2__r__b (us_split_fields1 b))))) (= (to_rep2 (rec__q__p2__r__c (us_split_fields1 a))) (to_rep2 (rec__q__p2__r__c (us_split_fields1 b))))) (= (to_rep (rec__q__p2__r__d (us_split_fields1 a))) (to_rep (rec__q__p2__r__d (us_split_fields1 b))))) true false))
