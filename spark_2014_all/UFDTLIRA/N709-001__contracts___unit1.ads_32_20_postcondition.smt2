...
(declare-const temp___1751 us_private)
(declare-const temp___1752 Int)
...
(assert (not (= (is_max (mk___rep (mk___split_fields x__split_fields x__split_fields1) x__attr__tag)) true)))
...
(assert (= x__attr__tag temp___1752))
...
(assert (= temp___175 x__split_fields2))
(assert (= temp___1751 x__split_fields3))
(assert (= x__split_fields4 x__split_fields2))
(assert (= x__split_fields5 x__split_fields3))
(assert (= (mk___split_fields x__split_fields6 x__split_fields7) (mk___split_fields x__split_fields2 x__split_fields3)))
(assert (not (= (to_rep x__split_fields4) (+ (to_rep x__split_fields) 1))))
(check-sat)
(exit)
