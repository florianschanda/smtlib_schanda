...
(define-fun dynamic_invariant3 ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_316)))
(assert true)
...
(declare-const temp___776 us_rep1)
...
(assert (and (= o4 (length s2)) (and (in_range1 o4) (<= o4 (to_rep (rec__use_ordered_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
(assert (and (= o2 (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs))))))
(assert (= o3 (- (to_rep (rec__use_ordered_sets__my_sets__set__capacity s1__split_discrs)) o2)))
(assert (and (= o5 o3) (in_range6 o3)))
(assert (= o6 (ite (< o4 o5) true false)))
(assert (and (= temp___776 (elements s2)) (and (and (and (= (length1 temp___776) (length s2)) (forall ((temp___432 Int)) (=> (and (in_range3 temp___432) (= (iter_has_element temp___776 temp___432) true)) (= (contains (model__ s2) (get temp___776 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ s2) item) true)) (and (< 0 (find temp___776 item)) (= (equivalent_elements (get temp___776 (find temp___776 item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s2))) (and (= (find temp___776 (get temp___776 i)) i) (= (e_is_find temp___776 (get temp___776 i) i) true)))))))
(assert (and (= o (iter_has_element temp___776 temp___775)) (= (= o true) (and (<= 1 temp___775) (<= temp___775 (last temp___776))))))
(assert (= (= o1 true) (in_range3 temp___775)))
(assert (= result (ite (= o1 true) o false)))
(assert (= result true))
(assert (not (<= temp___775 (last temp___776))))
(check-sat)
(exit)
