...
(declare-const result11 count_type)
(assert (= (to_rep o) 0))
(assert (= o o1))
...
(assert (= cu13 cu11))
(assert (= (mk___rep1 (mk___split_fields1 result11)) (cursor__content for_loops_on_lists__search_0_for_in__result15)))
(assert (not (or (and (= (has_key (positions l) (cursor__content for_loops_on_lists__search_0_for_in__result15)) true) (= (element l (cursor__content for_loops_on_lists__search_0_for_in__result15)) 0)) (and (= (bool_eq1 (cursor__content for_loops_on_lists__search_0_for_in__result15) no_element) true) (let ((temp___475 (model__ l))) (forall ((temp___474 Int)) (=> (and (in_range2 temp___474) (= (iter_has_element temp___475 temp___474) true)) (not (= (get temp___475 temp___474) 0)))))))))
(check-sat)
(exit)
