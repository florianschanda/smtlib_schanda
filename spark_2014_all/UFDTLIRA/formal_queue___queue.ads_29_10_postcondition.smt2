...
(assert (and (and (and (and (= (length (mk___rep r__split_discrs r__split_fields5)) (- (length (mk___rep r__split_discrs r__split_fields6)) 1)) (= (ole (model__ (mk___rep r__split_discrs r__split_fields5)) (model__ (mk___rep r__split_discrs r__split_fields6))) true)) (not (= (has_key (positions (mk___rep r__split_discrs r__split_fields5)) (last1 (mk___rep r__split_discrs r__split_fields6))) true))) (= (keys_included_except (positions (mk___rep r__split_discrs r__split_fields6)) (positions (mk___rep r__split_discrs r__split_fields6)) (last1 (mk___rep r__split_discrs r__split_fields6))) true)) (= (ole1 (positions (mk___rep r__split_discrs r__split_fields5)) (positions (mk___rep r__split_discrs r__split_fields6))) true)))
(assert (= queue__tail__result4 queue__tail__result2))
(assert (= queue__tail__result5 queue__tail__result3))
(assert (= queue__tail__result6 (mk___rep (mk___split_discrs queue__tail__result2) (mk___split_fields queue__tail__result3))))
...
(assert (= queue__tail__result7 (mk_list__ref (mk___rep (mk___split_discrs queue__tail__result4) (mk___split_fields queue__tail__result5)))))
...
(assert (not (= (olt (model__ (list__content queue__tail__result7)) (model__ q)) true)))
(check-sat)
(exit)
