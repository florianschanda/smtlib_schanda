...
(assert (in_range1 e))
(assert (and (= o4 (length s)) (and (in_range3 o4) (<= (+ 0 o4) 2147483647))))
(assert (= result1 (ite (< o4 2147483647) true false)))
(assert (=> (= result1 true) (and (= o (length s)) (and (in_range3 o) (<= (+ 0 o) 2147483647)))))
(assert (=> (= result1 true) (= o1 (+ o 1))))
(assert (=> (= result1 true) (and (= o2 o1) (in_range o1))))
(assert (=> (= result1 true) (and (= o3 (length result__)) (and (in_range3 o3) (<= (+ 0 o3) 2147483647)))))
