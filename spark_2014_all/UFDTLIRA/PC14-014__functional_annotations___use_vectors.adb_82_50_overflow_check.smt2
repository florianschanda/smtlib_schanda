...
(assert (forall ((i Int)) (=> (and (<= first i) (<= i (- fst1 1))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i)))))
(assert (forall ((i Int)) (=> (and (<= current2 i) (<= i (last5 (model__ (mk___rep v__split_discrs v__split_fields2))))) (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) i) (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) i)))))
