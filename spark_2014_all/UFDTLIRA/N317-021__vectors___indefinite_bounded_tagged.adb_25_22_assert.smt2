...
(assert (not (= (let ((temp___538 (f 1))) (let ((temp___537 (get (model__ (mk___rep1 v__split_discrs v__split_fields4)) 1))) (ite (= (attr__tag temp___537) (attr__tag temp___538)) (us_dispatch_eq temp___537 temp___538) false))) true)))
(check-sat)
(exit)
