...
(assert (not (= (let ((temp___581 (f 1))) (let ((temp___580 (get (model__ (mk___rep v__split_discrs v__split_fields4)) 1))) (ite (= (attr__tag temp___580) (attr__tag temp___581)) (us_dispatch_eq temp___580 temp___581) false))) true)))
(check-sat)
(exit)
