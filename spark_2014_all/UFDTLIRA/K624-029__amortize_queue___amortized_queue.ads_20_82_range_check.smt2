...
(assert (and (= o10 (length right)) (and (in_range2 o10) (<= o10 (capacity right)))))
(assert (and (= o11 (length left)) (and (in_range2 o11) (<= o11 (capacity left)))))
(assert (= o12 (+ o11 o10)))
(assert (and (= o13 (length (vector__content amortized_queue__Oconcat__result5))) (and (in_range2 o13) (<= o13 (capacity (vector__content amortized_queue__Oconcat__result5))))))
