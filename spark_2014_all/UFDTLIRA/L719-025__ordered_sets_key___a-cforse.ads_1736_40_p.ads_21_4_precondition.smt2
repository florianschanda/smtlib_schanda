...
(define-fun e_smaller_than_range ((container1 us_rep1) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_inf item (get container1 i)) true))) true false))
