...
(declare-fun temp___312 (map1 Int Int Int Int Int Int Int) map1)
(assert (forall ((temp___314 map1)) (forall ((temp___315 Int) (temp___316 Int) (temp___317 Int) (temp___318 Int) (temp___319 Int) (temp___320 Int) (temp___321 Int)) (let ((temp___313 (temp___312 temp___314 temp___315 temp___316 temp___317 temp___318 temp___319 temp___320 temp___321))) (=> (and (and (and (and (and (and (dynamic_invariant temp___315 true true true true) (dynamic_invariant1 temp___316 true true true true)) (dynamic_invariant2 temp___317 true true true true)) (dynamic_invariant temp___318 true true true true)) (dynamic_invariant1 temp___319 true true true true)) (dynamic_invariant2 temp___320 true true true true)) (dynamic_invariant3 temp___321 true true true true)) (forall ((temp___322 Int) (temp___323 Int) (temp___324 Int)) (ite (or (and (and (= temp___322 temp___315) (= temp___323 temp___316)) (= temp___324 temp___317)) (and (and (= temp___322 temp___318) (= temp___323 temp___319)) (= temp___324 temp___320))) (= (to_rep (get temp___313 temp___322 temp___323 temp___324)) temp___321) (= (get temp___313 temp___322 temp___323 temp___324) (get temp___314 temp___322 temp___323 temp___324)))))))))
(declare-const o Int)
(assert (in_range x1))
(assert (in_range x2))
(assert (in_range1 y1))
