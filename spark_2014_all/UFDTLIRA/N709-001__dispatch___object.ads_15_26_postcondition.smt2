...
(assert (not (= value (get_stored_area (mk___rep (mk___split_fields obj__split_fields8 obj__split_fields9 obj__split_fields10 obj__split_fields11) obj__attr__tag)))))
(check-sat)
(exit)
