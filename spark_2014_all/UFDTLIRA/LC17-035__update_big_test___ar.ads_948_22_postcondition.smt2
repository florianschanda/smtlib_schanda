...
(assert (not (= (bool_eq2 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields10 (mk___rep (mk___split_fields r__split_fields11 r__split_fields12)) r__split_fields13)) r__split_fields14)) (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 r__split_fields a r__split_fields3)) r__split_fields4))) true)))
(check-sat)
(exit)
