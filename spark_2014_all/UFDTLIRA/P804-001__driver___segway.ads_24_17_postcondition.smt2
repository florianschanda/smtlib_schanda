...
(assert (=> (not (= speed2 0)) (=> (and (= speed2 1) (= i 2)) (= result3 state))))
(assert (=> (not (= speed2 0)) (=> (and (= speed2 1) (= i 2)) (= state3 1))))
(assert (=> (not (= speed2 0)) (=> (not (and (= speed2 1) (= i 2))) (=> (and (= speed2 (- 1)) (= i 2)) (= result4 state)))))
...
(assert (not (= (speed_is_valid speed4 state5) true)))
(check-sat)
(exit)
