...
(assert (= (is_valid (mk___rep (us_split_fields__content result____split_fields16))) true))
(assert (< (first (mk___rep (us_split_fields__content result____split_fields16))) (second (mk___rep (us_split_fields__content result____split_fields16)))))
(assert (not (= (is_increasing (mk___rep (us_split_fields__content result____split_fields16))) true)))
(check-sat)
(exit)
