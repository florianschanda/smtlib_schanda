...
(define-fun default_initial_assumption1 ((temp___expr_146 us_rep) (temp___skip_top_level_147 Bool)) Bool (= (attr__tag temp___expr_146) us_tag1))
...
(assert (= (mk___split_fields r2__split_fields1) (us_split_fields1 c)))
(assert (= r2__attr__tag us_tag))
(assert (= result1 rc2__split_fields))
(assert (= (mk___split_fields rc2__split_fields1) (mk___split_fields r2__split_fields1)))
(assert (= rc2__attr__tag r2__attr__tag))
(assert (not (us_compatible_tags (attr__tag cc) us_tag1)))
(check-sat)
(exit)
