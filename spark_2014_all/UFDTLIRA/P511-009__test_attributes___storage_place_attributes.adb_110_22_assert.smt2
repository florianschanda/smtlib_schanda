...
(define-fun dynamic_invariant ((temp___expr_197 us_rep) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (and (=> (not (= temp___skip_constant_195 true)) (in_range2 5 temp___expr_197)) (= (attr__constrained temp___expr_197) true)))
(define-fun default_initial_assumption ((temp___expr_199 us_rep) (temp___skip_top_level_200 Bool)) Bool (and (= (attr__constrained temp___expr_199) true) (and (and (= (to_rep1 (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_199))) 5) (= (to_rep (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_199))) 0)) (=> (storage_place_attributes__r2__d2__pred temp___expr_199) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_199)) (of_int 0))))))
...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 10)) (in_range1 temp___expr_172)))
(define-fun default_initial_assumption1 ((temp___expr_191 us_rep) (temp___skip_top_level_192 Bool)) Bool (and (= (attr__constrained temp___expr_191) false) (and (and (= (to_rep1 (rec__storage_place_attributes__r2__d1 (us_split_discrs1 temp___expr_191))) 1) (= (to_rep (rec__storage_place_attributes__r2__d3 (us_split_fields1 temp___expr_191))) 0)) (=> (storage_place_attributes__r2__d2__pred temp___expr_191) (= (rec__storage_place_attributes__r2__d2 (us_split_fields1 temp___expr_191)) (of_int 0))))))
