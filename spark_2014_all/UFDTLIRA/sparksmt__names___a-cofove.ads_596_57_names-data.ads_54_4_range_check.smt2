...
(define-fun dynamic_invariant1 ((temp___expr_232 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= (- 1) 2147483647)) (in_range4 temp___expr_232)))
...
(define-fun dynamic_invariant2 ((temp___expr_238 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 2147483647)) (in_range5 temp___expr_238)))
...
(define-fun dynamic_invariant3 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 2147483646)) (in_range6 temp___expr_220)))
...
(define-fun dynamic_invariant4 ((temp___expr_265 Int) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool)) Bool (=> (or (= temp___is_init_262 true) (<= (- 1) 2147483646)) (in_range7 temp___expr_265)))
...
(define-fun dynamic_invariant5 ((temp___expr_259 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 255)) (in_range8 temp___expr_259)))
