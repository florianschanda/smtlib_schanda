...
(assert (= rliteral c2__split_fields3))
(assert (= rliteral1 c2__split_fields4))
(assert (= us_null_ext__ c2__split_fields5))
(assert (= c2__attr__tag us_tag1))
(assert (= dummy3 1))
(assert (not (= (less_than_max__2 (mk___rep1 (mk___split_fields1 c1__split_fields3 c1__split_fields4 c1__split_fields5) c1__attr__tag)) true)))
(check-sat)
(exit)
