...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields1 a))) (to_rep (rec__loop_types__lists__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_461 Int) (temp___is_init_457 Bool) (temp___skip_constant_458 Bool) (temp___do_toplevel_459 Bool) (temp___do_typ_inv_460 Bool)) Bool (=> (or (= temp___is_init_457 true) (<= 1 2147483647)) (in_range2 temp___expr_461)))
...
(define-fun default_initial_assumption ((temp___expr_469 us_rep1) (temp___skip_top_level_470 Bool)) Bool (=> (not (= temp___skip_top_level_470 true)) (and (= (is_empty temp___expr_469) true) (= (length temp___expr_469) 0))))
(define-fun default_initial_assumption1 ((temp___expr_455 us_rep) (temp___skip_top_level_456 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields1 temp___expr_455))) 0))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__loop_types__lists__list us_main_type1)))))
(define-fun us_split_fields_List__projection ((a us_split_fields2)) us_main_type1 (rec__loop_types__lists__list a))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 a))) (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__loop_types__lists__list (us_split_fields3 a)) (rec__loop_types__lists__list (us_split_fields3 b))) true)) true false))
...
(define-fun default_initial_assumption2 ((temp___expr_410 us_rep) (temp___skip_top_level_411 Bool)) Bool (= (to_rep (rec__loop_types__lists__cursor__node (us_split_fields1 temp___expr_410))) 0))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
