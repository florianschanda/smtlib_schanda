...
(define-fun default_initial_assumption1 ((temp___expr_469 us_rep2) (temp___skip_top_level_470 Bool)) Bool (=> (not (= temp___skip_top_level_470 true)) (and (= (is_empty temp___expr_469) true) (= (length temp___expr_469) 0))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__loop_types__lists__list__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___724 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___724)) no_element))
