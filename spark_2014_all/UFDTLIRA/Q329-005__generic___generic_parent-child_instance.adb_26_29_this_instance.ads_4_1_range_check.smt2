...
(define-fun dynamic_invariant ((temp___expr_520 Int) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool)) Bool (=> (or (= temp___is_init_517 true) (<= 0 9)) (in_range temp___expr_520)))
...
(define-fun default_initial_assumption ((temp___expr_542 us_rep1) (temp___skip_top_level_543 Bool)) Bool (= (attr__tag1 temp___expr_542) us_tag1))
(declare-const this__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption1 ((temp___expr_527 us_rep) (temp___skip_top_level_528 Bool)) Bool (= (attr__tag temp___expr_527) us_tag))
...
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___557 o2)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5571 o3)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5572 o4)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= this__attr__tag temp___5573)))
...
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___557 this__split_fields6)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5571 this__split_fields7)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5572 this__split_fields8)))
