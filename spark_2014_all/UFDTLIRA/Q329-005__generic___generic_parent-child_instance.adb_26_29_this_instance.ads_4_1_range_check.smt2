...
(define-fun dynamic_invariant ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 0 9)) (in_range temp___expr_514)))
...
(define-fun default_initial_assumption ((temp___expr_536 us_rep1) (temp___skip_top_level_537 Bool)) Bool (= (attr__tag1 temp___expr_536) us_tag1))
(declare-const this__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption1 ((temp___expr_521 us_rep) (temp___skip_top_level_522 Bool)) Bool (= (attr__tag temp___expr_521) us_tag))
...
(declare-const temp___551 element)
(declare-const temp___5511 element)
(declare-const temp___5512 us_private)
(declare-const temp___5513 Int)
...
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___551 o2)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5511 o3)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5512 o4)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= this__attr__tag temp___5513)))
...
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___551 this__split_fields6)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5511 this__split_fields7)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___5512 this__split_fields8)))
