...
(assert (forall ((i element)) (and (<= 0 (elementqtint i)) (<= (elementqtint i) 9))))
...
(define-fun dynamic_invariant ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 0 9)) (in_range temp___expr_579)))
(define-fun default_initial_assumption ((temp___expr_599 us_rep1) (temp___skip_top_level_600 Bool)) Bool (= (attr__tag1 temp___expr_599) us_tag1))
(declare-const this__attr__tag Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun default_initial_assumption1 ((temp___expr_587 us_rep) (temp___skip_top_level_588 Bool)) Bool (= (attr__tag temp___expr_587) us_tag))
...
(declare-const temp___610 element)
(declare-const temp___6101 element)
(declare-const temp___6102 us_private)
(declare-const temp___6103 Int)
...
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___610 o2)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___6101 o3)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___6102 o4)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= this__attr__tag temp___6103)))
...
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___610 this__split_fields6)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___6101 this__split_fields7)))
(assert (=> (<= (to_rep this__split_fields1) (- 9 step1)) (= temp___6102 this__split_fields8)))
