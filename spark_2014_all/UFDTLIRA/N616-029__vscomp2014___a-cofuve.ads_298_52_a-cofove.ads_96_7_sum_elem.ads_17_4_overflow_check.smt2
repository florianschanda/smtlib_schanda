...
(define-fun dynamic_invariant ((temp___expr_244 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 10000)) (in_range1 temp___expr_244)))
...
(define-fun dynamic_invariant2 ((temp___expr_258 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= (- 1) 10000)) (in_range5 temp___expr_258)))
...
(define-fun dynamic_invariant3 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 5)) (in_range3 temp___expr_189)))
(assert true)
(declare-const o Int)
