...
(assert (= v__split_fields2 indefinite_unbounded__vect__clear__container__fields1))
(assert (= (is_empty (mk___rep v__split_discrs v__split_fields2)) true))
(assert (not (= (oeq (mk___rep v__split_discrs v__split_fields2) (empty_vector Tuple0)) true)))
(check-sat)
(exit)
