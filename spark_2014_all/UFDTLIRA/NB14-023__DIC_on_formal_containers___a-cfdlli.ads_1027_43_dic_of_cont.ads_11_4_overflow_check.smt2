...
(declare-const temp___1861 count_type)
(declare-const o2 Int)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1861 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1861)) no_element))
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__dic_of_cont__my_dlli__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__dic_of_cont__my_dlli__list__capacity target__split_discrs)) o2)))
