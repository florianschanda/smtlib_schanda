...
(assert (= usq_ temp___892))
(assert (= usq_1 temp___8921))
(assert (= current_read__attr__constrained temp___8922))
...
(assert (= temp___8921 current_read__split_fields1))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs))))
(assert (= current_read__split_discrs1 (mk___split_discrs temp___892)))
