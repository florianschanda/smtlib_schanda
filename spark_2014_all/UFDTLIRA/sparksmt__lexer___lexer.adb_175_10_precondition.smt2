...
(declare-const temp___988 read_status)
(declare-const temp___9881 character)
(declare-const temp___9882 Bool)
...
(assert (= usq_ temp___988))
(assert (= usq_1 temp___9881))
(assert (= current_read__attr__constrained temp___9882))
...
(assert (= temp___9881 current_read__split_fields1))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs))))
(assert (= current_read__split_discrs1 (mk___split_discrs temp___988)))
