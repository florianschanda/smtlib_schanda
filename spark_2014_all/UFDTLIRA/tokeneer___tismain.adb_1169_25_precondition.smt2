...
(assert (=> (= result true) (= o21 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result true) (= o22 (ite (not (= o21 true)) true false))))
(assert (=> (= result true) (= o20 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
...
(assert (=> (= result1 true) (and (= o16 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range1 o16))))
(assert (=> (= result1 true) (= o17 (ite (= o16 0) true false))))
(assert (=> (= result1 true) (= o15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
...
(assert (= result2 (statusisenclavequiescent (us_private__content state48))))
(assert (=> (= result2 true) (= o13 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result2 true) (= o14 (ite (not (= o13 true)) true false))))
(assert (=> (not (= result2 true)) (= o14 (of_int 1))))
(assert (= o4 (statusiswaitingfinishadminop (us_private__content state48))))
(assert (= o5 (statusiswaitingstartadminop (us_private__content state48))))
(assert (= result3 (ite (= o5 false) o4 true)))
(assert (=> (= result3 true) (and (= o8 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range1 o8))))
(assert (=> (= result3 true) (and (= o9 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range1 o9))))
(assert (=> (= result3 true) (= o10 (ite (= o9 o8) true false))))
(assert (=> (= result3 true) (= o6 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
(assert (=> (= result3 true) (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))))))
...
(assert (= o (statusiswaitingremoveadmintokenfail (us_private__content state48))))
(assert (= o1 (statusisgotadmintoken (us_private__content state48))))
(assert (= result4 (ite (= o1 false) o true)))
(assert (=> (= result4 true) (= o2 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))))))
