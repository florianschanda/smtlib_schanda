...
(define-fun dynamic_invariant2 ((temp___expr_780 Int) (temp___is_init_776 Bool) (temp___skip_constant_777 Bool) (temp___do_toplevel_778 Bool) (temp___do_typ_inv_779 Bool)) Bool (=> (or (= temp___is_init_776 true) (<= 0 2147483647)) (in_range3 temp___expr_780)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range3 o) (= o (ite (= (distinct 1 0) true) (to_rep (rec__my_bounded_vectors__v__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
