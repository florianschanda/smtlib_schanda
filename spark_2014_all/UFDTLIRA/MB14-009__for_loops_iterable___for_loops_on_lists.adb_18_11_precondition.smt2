...
(define-fun temp___5202 () us_rep1 (mk___rep1 (mk___split_fields1 temp___5201)))
...
(assert (not (or (= (has_key (positions l) temp___5202) true) (= (bool_eq1 temp___5202 no_element) true))))
(check-sat)
(exit)
