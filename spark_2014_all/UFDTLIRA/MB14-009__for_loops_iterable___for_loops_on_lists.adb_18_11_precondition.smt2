...
(assert (= temp___478 o))
(assert (and (= result (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478)))) (= (= result true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478))) true))))
(assert (=> (= result true) (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___478)))) (and (in_range4 o1) (= o1 (get (model__ l) (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___478)))))))))
(assert (=> (= result true) (= (mk_int__ref result1) (mk_int__ref e))))
(assert (=> (= result true) (= e3 o1)))
(assert (=> (not (= result true)) (= e3 e)))
(assert (=> (not (= result true)) (= e3 e2)))
(assert (and (= result2 (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478)))) (= (= result2 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478))) true))))
(assert (= result2 true))
(assert (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___4782))) true) (= e4 (element l (mk___rep1 (mk___split_fields1 temp___4782))))))
(assert (not (= e4 0)))
(assert (= for_loops_on_lists__contains_0_for_of__result3 for_loops_on_lists__contains_0_for_of__result2))
(assert (not (or (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___4782))) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___4782)) no_element) true))))
(check-sat)
(exit)
