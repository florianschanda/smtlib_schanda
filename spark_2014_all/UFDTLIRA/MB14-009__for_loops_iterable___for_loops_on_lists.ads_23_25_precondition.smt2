...
(assert (=> (= result10 true) (and (= o17 (element (mk___rep l__split_discrs (us_split_fields__content l__split_fields12)) (mk___rep1 (us_split_fields__content1 c__split_fields14)))) (and (in_range2 o17) (= o17 (get (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (get1 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))) (mk___rep1 (us_split_fields__content1 c__split_fields14)))))))))
...
(assert (=> (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 c__split_fields14)) no_element) true)) (and (= o12 (get1 o11 (mk___rep1 (us_split_fields__content1 c__split_fields14)))) (and (in_range5 o12) (=> (= (of_int 0) true) (and (= o12 (w_get o11 (witness o11 (mk___rep1 (us_split_fields__content1 c__split_fields14))))) (forall ((k us_rep1)) (=> (= (has_key o11 k) true) (= (= (bool_eq1 k (mk___rep1 (us_split_fields__content1 c__split_fields14))) true) (= (witness o11 (mk___rep1 (us_split_fields__content1 c__split_fields14))) (witness o11 k)))))))))))
...
(assert (and (= o16 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)) (in_range4 o16)))
(assert (= result12 (ite (< 0 o16) true false)))
(assert (= result12 true))
(assert (and (= o15 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o15) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
