...
(assert (=> (= (bool_eq1 (mk___rep1 (us_split_fields__content1 c__split_fields14)) no_element) true) (and (= o36 (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields12)))) (and (in_range1 o36) (<= o36 (to_rep (rec__for_loops_on_lists__my_lists__list__capacity l__split_discrs)))))))
(assert (=> (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 c__split_fields14)) no_element) true)) (and (= o34 (positions (mk___rep l__split_discrs (us_split_fields__content l__split_fields12)))) (and (not (= (has_key o34 no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key o34 i3) true) (and (and (<= 1 (get1 o34 i3)) (<= (get1 o34 i3) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))))) (forall ((j us_rep1)) (=> (= (has_key o34 j) true) (=> (= (get1 o34 i3) (get1 o34 j)) (= (bool_eq1 i3 j) true)))))))))))
(assert (=> (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 c__split_fields14)) no_element) true)) (and (= o35 (get1 o34 (mk___rep1 (us_split_fields__content1 c__split_fields14)))) (and (in_range5 o35) (=> (= (of_int 0) true) (and (= o35 (w_get o34 (witness o34 (mk___rep1 (us_split_fields__content1 c__split_fields14))))) (forall ((k us_rep1)) (=> (= (has_key o34 k) true) (= (= (bool_eq1 k (mk___rep1 (us_split_fields__content1 c__split_fields14))) true) (= (witness o34 (mk___rep1 (us_split_fields__content1 c__split_fields14))) (witness o34 k)))))))))))
(assert (=> (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 c__split_fields14)) no_element) true)) (= o36 (- o35 1))))
(assert (= o37 (ite (<= i2 o36) true false)))
(assert (= result14 (ite (<= 1 i2) o37 false)))
(assert (= result14 true))
(assert (and (= o43 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i2)) (in_range4 o43)))
(assert (= result15 (ite (< 0 o43) true false)))
(assert (= result15 true))
(assert (and (= o39 (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (= (length1 o39) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))))))
(assert (and (= o40 (get o39 i2)) (in_range4 o40)))
(assert (= o41 (- o40 1)))
(assert (and (= o38 (model__ (mk___rep l__split_discrs (us_split_fields__content l__split_fields12)))) (= (length1 o38) (length (mk___rep l__split_discrs (us_split_fields__content l__split_fields12))))))
(assert (not (<= 1 i2)))
(check-sat)
(exit)
