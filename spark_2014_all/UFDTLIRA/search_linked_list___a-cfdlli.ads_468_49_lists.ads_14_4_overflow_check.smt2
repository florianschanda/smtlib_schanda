...
(declare-const temp___385 count_type)
(declare-const o2 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___385 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___385)) no_element))
(assert (in_range2 new_item))
(assert (in_range1 count))
(assert (not (in_range (- (to_rep (rec__lists__l__list__capacity container__split_discrs)) count))))
(check-sat)
(exit)
