...
(assert (not (or (= (has_key (positions (mk___rep l__split_discrs l__split_fields25)) (mk___rep1 c__split_fields14)) true) (= (bool_eq1 (mk___rep1 c__split_fields14) no_element) true))))
(check-sat)
(exit)
