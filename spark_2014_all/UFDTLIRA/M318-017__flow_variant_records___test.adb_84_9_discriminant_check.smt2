...
(declare-const temp___2961 integer)
(declare-const temp___2962 failure_reason)
(declare-const temp___2963 Bool)
(assert (= x__split_discrs r24b))
(assert (= (to_rep o) 12))
(assert (= o o1))
(assert (= dummy1 o2))
(assert (= (distinct 1 0) temp___296))
(assert (= temp___2961 o1))
(assert (= temp___2962 o2))
(assert (= true temp___2963))
(assert (= x__attr__constrained true))
(assert (not (= temp___296 x__split_discrs)))
(check-sat)
(exit)
