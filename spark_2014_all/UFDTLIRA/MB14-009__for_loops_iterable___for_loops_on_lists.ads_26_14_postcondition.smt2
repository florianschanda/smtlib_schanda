...
(assert (=> (= result4 true) (and (and (and (=> (<= 0 2147483647) (in_range2 count_03)) (=> (<= 0 2147483647) (in_range2 count_12))) (=> (<= 0 2147483647) (in_range3 e3))) (and (= (has_key (positions l) temp___5052) true) (= e3 (element l temp___5052))))))
...
(assert (=> (= result4 true) (and (= o6 (next l temp___5052)) (ite (= (ite (= (bool_eq1 temp___5052 no_element) false) (= (get1 (positions l) temp___5052) (length1 l)) true) true) (= (bool_eq1 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) (+ (get1 (positions l) temp___5052) 1)))))))
...
(assert (=> (not (= result4 true)) (= temp___5055 (mk_cursor__ref (mk___rep1 (mk___split_fields1 temp___505))))))
...
(assert (=> (not (= result4 true)) (= temp___5056 (mk___rep1 (mk___split_fields1 temp___5051)))))
...
(assert (not (exists ((temp___515 Int)) (and (and (in_range5 temp___515) (= (iter_has_element temp___516 temp___515) true)) (= (get temp___516 temp___515) 0)))))
(check-sat)
(exit)
