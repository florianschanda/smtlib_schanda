...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__crtp_pack__crtp_packet_handler__index positive)))))
(define-fun us_split_fields_Index__projection ((a us_split_fields)) positive (rec__crtp_pack__crtp_packet_handler__index a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__crtp_pack__crtp_packet_handler__index (us_split_fields1 a))) (to_rep (rec__crtp_pack__crtp_packet_handler__index (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((crtp_packet_handler__ref (mk_crtp_packet_handler__ref (crtp_packet_handler__content us_rep)))))
(define-fun crtp_packet_handler__ref___projection ((a crtp_packet_handler__ref)) us_rep (crtp_packet_handler__content a))
...
(declare-const handler__split_fields positive)
(assert (not (in_range (+ (to_rep handler__split_fields) 0))))
(check-sat)
(exit)
