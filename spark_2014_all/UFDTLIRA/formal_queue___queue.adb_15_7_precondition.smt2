...
(assert (not (< (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (to_rep (rec__queue__mylists__list__capacity r__split_discrs)))))
(check-sat)
(exit)
