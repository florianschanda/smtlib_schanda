...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (and (= (rec__po_t__p_intT__condition (us_split_fields1 temp___expr_172)) (of_int 1)) (= (to_rep (rec__po_t__the_protected_int (us_split_fields1 temp___expr_172))) 0)))
...
(define-fun default_initial_assumption1 ((temp___expr_178 us_rep1) (temp___skip_top_level_179 Bool)) Bool (and (= (to_rep (rec__po_t__hidden_poT__the_protected_int (us_split_fields3 temp___expr_178))) 0) (= (rec__po_t__hidden_poT__switch (us_split_fields3 temp___expr_178)) (of_int 1))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun get1 (us_rep1) Int)
(declare-fun get__function_guard1 (Int us_rep1) Bool)
(assert (forall ((self__ us_rep1)) (! (dynamic_invariant (get1 self__) true false true) :pattern ((get1 self__)))))
...
(assert (and (= p_int__split_fields (of_int 1)) (= (to_rep p_int__split_fields1) 0)))
(assert (and (= (to_rep hidden_po__split_fields) 0) (= hidden_po__split_fields1 (of_int 1))))
