...
(assert (<= r4b j2))
(assert (<= j2 r5b))
(assert (and (= o j2) (in_range1 j2)))
(assert (and (and (= (length1 (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields))) (length1 (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields))) o) 0)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs (mk___split_fields loop_types__vectors__replace_element__container__fields))) o) true)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields v__split_fields))))
(assert (= (mk___split_fields v__split_fields2) (mk___split_fields loop_types__vectors__replace_element__container__fields)))
(assert (= (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3)))) (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j3)) (= (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields3))) k1) 0))))
(assert (and (=> (<= r4b r5b) (dynamic_property r4b r5b j3)) (and (<= r4b j3) (<= j3 r5b))))
(assert (and (= o1 1) (and (in_range1 o1) (= o1 1))))
(assert (= o2 (ite (<= o1 k) true false)))
(assert (= result2 (ite (= o2 true) (ite (<= k j3) true false) false)))
(assert (= result2 true))
(assert (not (in_range1 k)))
(check-sat)
(exit)
