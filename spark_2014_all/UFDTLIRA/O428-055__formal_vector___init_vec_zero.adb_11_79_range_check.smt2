...
(assert (and (and (= (length1 (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields1)) (length1 (mk___rep v__split_discrs (mk___split_fields v__split_fields)))) (= (get (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields1)) o) 0)) (= (equal_except (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))) (model__ (mk___rep v__split_discrs loop_types__vectors__replace_element__container__fields1)) o) true)))
(assert (= (mk___split_fields__ref (mk___split_fields result1)) (mk___split_fields__ref (mk___split_fields v__split_fields))))
(assert (= (mk___split_fields v__split_fields1) loop_types__vectors__replace_element__container__fields1))
(assert (= (last (model__ (mk___rep v__split_discrs v__split_fields3))) (last (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 j2)) (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) k1) 0))))
(assert (and (=> (<= r4b r5b) (dynamic_property r4b r5b j2)) (and (<= r4b j2) (<= j2 r5b))))
(assert (and (= o1 1) (and (in_range1 o1) (= o1 1))))
(assert (= o2 (ite (<= o1 k) true false)))
(assert (= result2 (ite (= o2 true) (ite (<= k j2) true false) false)))
(assert (= result2 true))
