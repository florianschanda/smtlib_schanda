...
(define-fun dynamic_invariant3 ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 4)) (in_range3 temp___expr_246)))
...
(declare-const temp___6734 et3)
(declare-const temp___67341 et1)
(declare-const temp___67342 et2)
(declare-const temp___67343 enum1ta)
(declare-const o9 et2)
(declare-const o10 et1)
(declare-const o11 et2)
(declare-const o12 et1)
(declare-const o13 et2)
(declare-const o14 et3)
(declare-const o15 et1)
(declare-const o16 et2)
(declare-const o17 enum1ta)
(declare-const temp___6737 et3)
(declare-const temp___67371 et1)
(declare-const temp___67372 et2)
(declare-const temp___67373 enum1ta)
...
(assert (= temp___6734 o5))
(assert (= temp___67341 o6))
(assert (= temp___67342 o7))
(assert (= temp___67343 o8))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields r__split_fields1 r__split_fields2)) r__split_fields3))))
(assert (= r__split_fields4 (mk___split_fields1 temp___6734 (mk___rep (mk___split_fields temp___67341 temp___67342)) temp___67343)))
(assert (= (to_rep1 o9) f))
(assert (= (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 r__split_fields4))) o10))
(assert (= o9 o11))
(assert (= o12 o10))
(assert (= o13 o11))
(assert (= (rec__ar__rec2t__f2 r__split_fields4) o14))
(assert (= o15 o12))
(assert (= o16 o13))
(assert (= (rec__ar__rec2t__h2 r__split_fields4) o17))
(assert (= temp___6737 o14))
(assert (= temp___67371 o15))
(assert (= temp___67372 o16))
(assert (= temp___67373 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6737 (mk___rep (mk___split_fields temp___67371 temp___67372)) temp___67373)))
(assert (= r__split_fields6 (mk___split_fields__ref1 r__split_fields5)))
(assert (= r__split_fields7 r__split_fields5))
(assert (not (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields6)) (mk___rep1 (mk___split_fields1 r__split_fields (mk___rep (mk___split_fields (of_rep e) (of_rep1 f))) r__split_fields3))) true)))
(check-sat)
(exit)
