...
(declare-const temp___6675 et3)
(declare-const temp___66751 et1)
(declare-const temp___66752 et2)
(declare-const temp___66753 enum1ta)
...
(declare-const temp___6678 et3)
(declare-const temp___66781 et1)
(declare-const temp___66782 et2)
(declare-const temp___66783 enum1ta)
...
(assert (= temp___6675 o5))
(assert (= temp___66751 o6))
(assert (= temp___66752 o7))
(assert (= temp___66753 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6675 (mk___rep (mk___split_fields temp___66751 temp___66752)) temp___66753)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6678 o14))
(assert (= temp___66781 o15))
(assert (= temp___66782 o16))
(assert (= temp___66783 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6678 (mk___rep (mk___split_fields temp___66781 temp___66782)) temp___66783)))
