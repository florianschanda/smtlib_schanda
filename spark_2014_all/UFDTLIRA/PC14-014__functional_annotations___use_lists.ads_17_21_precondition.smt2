...
(assert (and (= o16 (get1 o12 (mk___rep1 (mk___split_fields1 o13)))) (and (in_range5 o16) (=> (= (of_int 0) true) (and (= o16 (w_get o12 (witness o12 (mk___rep1 (mk___split_fields1 o13))))) (forall ((k us_rep1)) (=> (= (has_key o12 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 o13))) true) (= (witness o12 (mk___rep1 (mk___split_fields1 o13))) (witness o12 k))))))))))
(assert (= o17 (ite (<= o15 o16) true false)))
(assert (not (= (has_key (positions l) (cursor__content use_lists__my_find__result15)) true)))
(check-sat)
(exit)
