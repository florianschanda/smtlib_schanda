...
(assert (and (= o12 (find l e no_element)) (ite (ite (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (length2 l) e) false) true false) (= (bool_eq1 o12 no_element) true) (and (and (and (= (has_key (positions l) o12) true) (= (get (model__ l) (get1 (positions l) o12)) e)) (=> (not (= (bool_eq1 no_element no_element) true)) (<= (get1 (positions l) no_element) (get1 (positions l) o12)))) (not (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (- (get1 (positions l) o12) 1) e) true))))))
...
(assert (and (= o11 (find l e no_element)) (ite (ite (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (length2 l) e) false) true false) (= (bool_eq1 o11 no_element) true) (and (and (and (= (has_key (positions l) o11) true) (= (get (model__ l) (get1 (positions l) o11)) e)) (=> (not (= (bool_eq1 no_element no_element) true)) (<= (get1 (positions l) no_element) (get1 (positions l) o11)))) (not (= (contains (model__ l) (ite (= (bool_eq1 no_element no_element) true) 1 (get1 (positions l) no_element)) (- (get1 (positions l) o11) 1) e) true))))))
...
(assert (and (= o9 (get1 o5 o11)) (and (in_range5 o9) (=> (= (distinct 0 0) true) (and (= o9 (w_get o5 (witness o5 o11))) (forall ((k us_rep1)) (=> (= (has_key o5 k) true) (= (= (bool_eq1 k o11) true) (= (witness o5 o11) (witness o5 k))))))))))
(assert (= o10 (ite (<= o8 o9) true false)))
(assert (not (= (has_key (positions l) (cursor__content use_lists__my_find__result13)) true)))
(check-sat)
(exit)
