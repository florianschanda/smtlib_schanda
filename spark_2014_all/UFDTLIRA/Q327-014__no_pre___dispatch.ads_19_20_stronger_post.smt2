...
(assert (=> (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647) (= (to_rep dispatch__incr3__result) (+ (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 1))))
(assert (not (= (to_rep dispatch__incr3__result) (+ (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 1))))
(check-sat)
(exit)
