...
(define-fun dynamic_invariant1 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range2 temp___expr_415)))
...
(declare-const temp___1052 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1052 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1052)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))))))
