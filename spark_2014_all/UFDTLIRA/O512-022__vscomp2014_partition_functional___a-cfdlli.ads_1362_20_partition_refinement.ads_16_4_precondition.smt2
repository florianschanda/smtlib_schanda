...
(define-fun default_initial_assumption1 ((temp___expr_409 us_rep1) (temp___skip_top_level_410 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_409))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_364 us_rep1) (temp___skip_top_level_365 Bool)) Bool (= (to_rep (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_364))) 0))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))))))
