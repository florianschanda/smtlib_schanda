...
(define-fun dynamic_invariant1 ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1 2147483647)) (in_range2 temp___expr_376)))
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___979 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___979)) no_element))
