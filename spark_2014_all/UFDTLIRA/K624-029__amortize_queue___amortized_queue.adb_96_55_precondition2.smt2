...
(define-fun o14 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o15 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o15) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o14 o15))
(assert (= o7 o14))
...
(assert (not (or (= 1000 0) (<= (length (rec__amortized_queue__queue__front result____split_fields5)) 1000))))
(check-sat)
(exit)
