...
(assert (forall ((x1 Int)) (! (=> (dynamic_invariant1 x1 true true true true) (dynamic_invariant (priv x1) true false true true)) :pattern ((priv x1)))))
(declare-fun e_priv (Int) Int)
(declare-fun e_priv__function_guard (Int Int) Bool)
(assert (forall ((x1 Int)) (! (=> (dynamic_invariant1 x1 true true true true) (dynamic_invariant (e_priv x1) true false true true)) :pattern ((e_priv x1)))))
(assert (forall ((x1 Int)) (! (=> (dynamic_invariant1 x1 true true true true) (= (e_priv x1) 1)) :pattern ((e_priv x1)))))
