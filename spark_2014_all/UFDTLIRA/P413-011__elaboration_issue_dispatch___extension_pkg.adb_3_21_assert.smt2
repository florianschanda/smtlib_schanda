...
(assert (forall ((flag Bool)) (forall ((rec__ext__2 us_private)) (= (ite (extract__flag (hide_ext__ flag rec__ext__2)) 1 0) (ite flag 1 0)))))
...
(define-fun default_initial_assumption ((temp___expr_171 us_rep1) (temp___skip_top_level_172 Bool)) Bool (= (attr__tag1 temp___expr_171) us_tag1))
...
(assert true)
(assert true)
(assert (forall ((x1 us_rep1)) (forall ((extension_pkg__body_elaborated Bool)) (! (= (ite (get x1 extension_pkg__body_elaborated) 1 0) (ite (get1 us_tag1 x1 extension_pkg__body_elaborated) 1 0)) :pattern ((get1 us_tag1 x1 extension_pkg__body_elaborated))))))
