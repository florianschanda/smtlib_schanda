...
(assert (let ((temp___448 (keys s))) (forall ((temp___447 Int)) (=> (and (in_range3 temp___447) (= (iter_has_element temp___448 temp___447) true)) (exists ((i us_rep1)) (and (= (has_key1 (positions s) i) true) (= (get (keys s) (get1 (positions s) i)) (get temp___448 temp___447))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (length s)))
