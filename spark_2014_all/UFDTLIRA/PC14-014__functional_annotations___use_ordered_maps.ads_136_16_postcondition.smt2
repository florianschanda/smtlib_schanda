...
(assert (let ((temp___405 (keys s))) (forall ((temp___404 Int)) (=> (and (in_range3 temp___404) (= (iter_has_element temp___405 temp___404) true)) (exists ((i1 us_rep1)) (and (= (has_key1 (positions s) i1) true) (= (get (keys s) (get1 (positions s) i1)) (get temp___405 temp___404))))))))
