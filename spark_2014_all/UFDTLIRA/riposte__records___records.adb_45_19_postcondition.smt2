...
(assert (= null_optional_pair (mk___rep1 (mk___split_fields1 (of_int 0) null_pair))))
...
(declare-const records__init_e__result6 optional_pair__ref)
(declare-const records__init_e__result7 us_rep1)
(declare-const records__init_e__result8 optional_pair__ref)
(declare-const records__init_e__result9 us_rep1)
(declare-const result3 Bool)
(declare-const result4 unsigned_byte)
(declare-const result5 unsigned_byte)
(assert (= (mk___rep1 (mk___split_fields1 (of_int 0) null_pair)) null_optional_pair))
(assert (= records__init_e__result6 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__init_e__result3 (mk___rep (mk___split_fields records__init_e__result4 records__init_e__result5)))))))
(assert (= records__init_e__result7 (mk___rep1 (mk___split_fields1 records__init_e__result3 (mk___rep (mk___split_fields records__init_e__result4 records__init_e__result5))))))
(assert (= (to_rep o) 0))
(assert (= (to_rep o1) 0))
(assert (= o1 o2))
(assert (= o o3))
...
(assert (= (mk___rep1 (mk___split_fields1 records__init_e__result3 (mk___rep (mk___split_fields records__init_e__result4 records__init_e__result5)))) (mk___rep1 (mk___split_fields1 o9 (mk___rep (mk___split_fields o10 o11))))))
(assert (= records__init_e__result8 records__init_e__result6))
(assert (= records__init_e__result9 records__init_e__result7))
(assert (= (mk___rep1 (mk___split_fields1 result3 (mk___rep (mk___split_fields result4 result5)))) (optional_pair__content records__init_e__result8)))
(assert (not (= (bool_eq1 (optional_pair__content records__init_e__result8) null_optional_pair) true)))
(check-sat)
(exit)
