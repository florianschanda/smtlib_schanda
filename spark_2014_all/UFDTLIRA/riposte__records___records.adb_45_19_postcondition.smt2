...
(declare-const records__init_e__result Bool)
(declare-const records__init_e__result1 unsigned_byte)
(declare-const records__init_e__result2 unsigned_byte)
(declare-const result Bool)
(declare-const result1 unsigned_byte)
(declare-const result2 unsigned_byte)
(declare-const records__init_e__result3 Bool)
(declare-const records__init_e__result4 unsigned_byte)
(declare-const records__init_e__result5 unsigned_byte)
(declare-const records__init_e__result6 Bool)
(declare-const records__init_e__result7 unsigned_byte)
(declare-const records__init_e__result8 unsigned_byte)
(declare-const records__init_e__result9 Bool)
(declare-const records__init_e__result10 unsigned_byte)
(declare-const records__init_e__result11 unsigned_byte)
(declare-const records__init_e__result12 optional_pair__ref)
(declare-const records__init_e__result13 us_rep1)
(define-fun records__init_e__result14 () us_rep1 (mk___rep1 (mk___split_fields1 records__init_e__result9 (mk___rep (mk___split_fields records__init_e__result10 records__init_e__result11)))))
...
(assert (= records__init_e__result6 records__init_e__result3))
(assert (= records__init_e__result7 records__init_e__result4))
(assert (= records__init_e__result8 records__init_e__result5))
(assert (= records__init_e__result14 (mk___rep1 (mk___split_fields1 records__init_e__result3 (mk___rep (mk___split_fields records__init_e__result4 records__init_e__result5))))))
(assert (= result records__init_e__result))
(assert (= result1 records__init_e__result1))
(assert (= result2 records__init_e__result2))
(assert (= (distinct 0 0) records__init_e__result3))
(assert (= rliteral records__init_e__result4))
(assert (= rliteral records__init_e__result5))
(assert (= records__init_e__result12 (mk_optional_pair__ref (mk___rep1 (mk___split_fields1 records__init_e__result6 (mk___rep (mk___split_fields records__init_e__result7 records__init_e__result8)))))))
(assert (= records__init_e__result13 records__init_e__result14))
(assert (= (mk___rep1 (mk___split_fields1 result3 (mk___rep (mk___split_fields result4 result5)))) (optional_pair__content records__init_e__result12)))
(assert (not (= (bool_eq1 (optional_pair__content records__init_e__result12) null_optional_pair) true)))
(check-sat)
(exit)
