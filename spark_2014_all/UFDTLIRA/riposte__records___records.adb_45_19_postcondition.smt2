...
(define-fun records__init_e__result10 () us_rep1 (mk___rep1 (mk___split_fields1 records__init_e__result3 (mk___rep (mk___split_fields records__init_e__result4 records__init_e__result5)))))
...
(assert (= records__init_e__result6 (mk_optional_pair__ref records__init_e__result10)))
(assert (= records__init_e__result7 records__init_e__result10))
(assert (= (to_rep o) 0))
(assert (= (to_rep o1) 0))
(assert (= o1 o2))
(assert (= o o3))
...
(assert (= records__init_e__result10 (mk___rep1 (mk___split_fields1 o9 (mk___rep (mk___split_fields o10 o11))))))
