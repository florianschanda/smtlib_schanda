...
(declare-const temp___6677 et1)
(declare-const temp___66771 et2)
(declare-const o4 et2)
(declare-const o5 et1)
(declare-const o6 et2)
(declare-const temp___6679 et1)
(declare-const temp___66791 et2)
...
(assert (= temp___6677 o2))
(assert (= temp___66771 o3))
(assert (= result1 r__split_fields))
(assert (= result2 r__split_fields1))
(assert (= temp___6677 r__split_fields2))
(assert (= temp___66771 r__split_fields3))
(assert (= (to_rep1 o4) temp1))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___6679 o5))
(assert (= temp___66791 o6))
(assert (= result3 r__split_fields2))
(assert (= result4 r__split_fields3))
(assert (= temp___6679 r__split_fields4))
(assert (= temp___66791 r__split_fields5))
(assert (= temp2 temp1))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (of_rep (to_rep1 r__split_fields1)) (of_rep1 (to_rep r__split_fields))))) true)))
(check-sat)
(exit)
