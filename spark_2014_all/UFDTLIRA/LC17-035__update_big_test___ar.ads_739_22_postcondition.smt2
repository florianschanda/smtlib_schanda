...
(declare-const temp___6618 et1)
(declare-const temp___66181 et2)
(declare-const o4 et2)
(declare-const o5 et1)
(declare-const o6 et2)
(declare-const temp___6620 et1)
(declare-const temp___66201 et2)
...
(assert (= temp___6618 o2))
(assert (= temp___66181 o3))
(assert (= result1 r__split_fields))
(assert (= result2 r__split_fields1))
(assert (= temp___6618 r__split_fields2))
(assert (= temp___66181 r__split_fields3))
(assert (= (to_rep1 o4) temp1))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___6620 o5))
(assert (= temp___66201 o6))
(assert (= result3 r__split_fields2))
(assert (= result4 r__split_fields3))
(assert (= temp___6620 r__split_fields4))
(assert (= temp___66201 r__split_fields5))
(assert (= temp2 temp1))
