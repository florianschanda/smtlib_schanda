...
(declare-const temp___501 count_type)
(declare-const o2 us_rep3)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___501 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___501)) no_element))
(assert (in_range2 item))
(assert (or (= (has_key (positions container) position) true) (= (bool_eq1 position no_element) true)))
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__for_loops_on_lists__my_lists__list__capacity (us_split_discrs1 container)))))))
