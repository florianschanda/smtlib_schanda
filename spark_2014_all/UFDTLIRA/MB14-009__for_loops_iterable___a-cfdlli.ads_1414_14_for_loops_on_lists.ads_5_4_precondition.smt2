...
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep2) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__for_loops_on_lists__my_lists__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(define-fun dynamic_invariant2 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 2147483647)) (in_range3 temp___expr_214)))
