...
(declare-const temp___650 us_rep1)
...
(assert (and (= temp___650 (f 1)) (= temp___650 (mk___rep1 (mk___split_fields1 (of_rep1 1) us_null_ext__) us_tag))))
(assert (not (<= 3 (last (model__ (mk___rep v__split_discrs v__split_fields7))))))
(check-sat)
(exit)
