...
(assert (and (and (= (length (mk___rep v__split_discrs unbounded__vect__replace_element__container__fields1)) (length (mk___rep v__split_discrs v__split_fields10))) (= (get (model__ (mk___rep v__split_discrs unbounded__vect__replace_element__container__fields1)) 1) o28)) (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields10)) (model__ (mk___rep v__split_discrs unbounded__vect__replace_element__container__fields1)) 1) true)))
(assert (= result11 (mk___split_fields__ref v__split_fields10)))
(assert (= v__split_fields11 unbounded__vect__replace_element__container__fields1))
(assert (not false))
(check-sat)
(exit)
