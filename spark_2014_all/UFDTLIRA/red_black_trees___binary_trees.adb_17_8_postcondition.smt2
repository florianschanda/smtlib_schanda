...
(assert (=> (and (<= 1 i1) (<= i1 100)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- i2 1))) (= (contains s2 j2) true)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (forall ((j2 Int)) (=> (and (in_range2 j2) (= (contains s2 j2) true)) (< j2 i2)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (=> (<= 1 100) (in_range1 i2)) (and (<= 1 i2) (<= i2 100)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (= o2 (add s2 i2)) (and (and (and (= (length o2) (+ (length s2) 1)) (= (contains o2 i2) true)) (= (ole s2 o2) true)) (= (included_except o2 s2 i2) true)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= s2 result1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= s3 o2)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= i2 100)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= i2 i4)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= s3 s4)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= i5 i2)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= s5 s3)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= (mk_int__ref i6) (mk_int__ref i4))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= (mk_set__ref s6) (mk_set__ref s4))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= i7 i5)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= s7 s5)))
(assert (=> (not (and (<= 1 i1) (<= i1 100))) (= i1 i6)))
(assert (=> (not (and (<= 1 i1) (<= i1 100))) (= (mk_set__ref s6) (mk_set__ref s))))
(assert (=> (not (and (<= 1 i1) (<= i1 100))) (= i7 i1)))
...
(assert (= result3 binary_trees__all_indexes__result))
...
(assert (= i9 i7))
(assert (= s9 s7))
(assert (= result4 binary_trees__all_indexes__result4))
(declare-const i10 Int)
(assert (<= 1 i10))
(assert (<= i10 100))
(assert (not (= (contains binary_trees__all_indexes__result4 i10) true)))
(check-sat)
(exit)
