...
(define-fun dynamic_invariant ((temp___expr_334 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 1 2147483647)) (in_range2 temp___expr_334)))
...
(define-fun dynamic_invariant1 ((temp___expr_346 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 0 2147483647)) (in_range3 temp___expr_346)))
...
(define-fun dynamic_invariant3 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 2147483647)) (in_range5 temp___expr_340)))
