...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___1095 i1)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___1094 s)))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= (length s2) (- i2 1))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (= (contains s2 j) true)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (in_range1 j) (= (contains s2 j) true)) (< j i2)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (=> (<= 1 100) (in_range3 i2)) (and (<= 1 i2) (<= i2 100)))))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (= o (add s2 i2)) (and (and (and (= (length o) (+ (length s2) 1)) (= (contains o i2) true)) (= (ole s2 o) true)) (= (included_except o s2 i2) true)))))
...
(assert (= binary_trees__all_indexes__result1 binary_trees__all_indexes__result2))
(assert (= binary_trees__all_indexes__result3 binary_trees__all_indexes__result1))
(assert (= result2 binary_trees__all_indexes__result))
(assert (= binary_trees__all_indexes__result1 s6))
(assert (= (mk_set__ref binary_trees__all_indexes__result4) (mk_set__ref binary_trees__all_indexes__result2)))
(assert (= i7 i5))
(assert (= s8 s6))
(assert (= binary_trees__all_indexes__result5 binary_trees__all_indexes__result3))
(assert (= i8 i6))
(assert (= s9 s7))
(assert (= result3 binary_trees__all_indexes__result4))
(assert (not (= (length binary_trees__all_indexes__result4) 100)))
(check-sat)
(exit)
