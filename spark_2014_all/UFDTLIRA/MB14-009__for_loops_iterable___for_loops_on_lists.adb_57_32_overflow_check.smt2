...
(define-fun o2 () us_rep1 (mk___rep1 (mk___split_fields1 o)))
...
(assert (and (= o2 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 o2 no_element) true) (and (= (has_key (positions l) o2) true) (= (get1 (positions l) o2) 1)))))
(assert (= temp___505 o))
...
(assert (= result4 true))
(assert (= e2 0))
(assert (not (in_range1 (+ count_01 1))))
(check-sat)
(exit)
