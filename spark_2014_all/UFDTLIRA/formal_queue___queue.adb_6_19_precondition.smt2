...
(define-fun dynamic_invariant2 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_220)))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant1 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant2 (get container position) true false true)) :pattern ((get container position))))))
...
(assert (forall ((container us_rep2)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (of_int 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep3)) (=> (= (has_key container k) true) (= (= (bool_eq3 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant3 result true false true)))) :pattern ((get1 container key))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant3 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(declare-const r__split_fields us_main_type)
(declare-const queue__tail__result count_type)
(declare-const queue__tail__result1 us_main_type)
...
(declare-const queue__tail__result2 count_type)
(declare-const queue__tail__result3 us_main_type)
(declare-const queue__tail__result4 count_type)
(declare-const queue__tail__result5 us_main_type)
(declare-const queue__tail__result6 us_rep)
(declare-const r__split_fields3 us_split_fields__ref)
(declare-const queue__tail__result7 list__ref)
(declare-const r__split_fields4 us_split_fields)
(declare-const queue__tail__result8 us_rep)
(assert (< 0 (length q)))
(assert (not true))
(check-sat)
(exit)
