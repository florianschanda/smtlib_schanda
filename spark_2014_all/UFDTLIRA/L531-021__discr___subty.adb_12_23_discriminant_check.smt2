...
(define-fun o24 () us_rep (mk___rep (mk___split_discrs o12) (mk___split_fields o13 o14 o15 o16)))
(define-fun o25 () us_rep (mk___rep (mk___split_discrs o7) (mk___split_fields o8 o9 o10 o11)))
...
(assert (= true o5))
(assert (= dummy1 o6))
(assert (= o25 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4 o5 o6))))
(assert (= o24 o25))
(assert (= (mk___rep (mk___split_discrs subty__p__z__assume) (mk___split_fields subty__p__z__assume1 subty__p__z__assume2 subty__p__z__assume3 subty__p__z__assume4)) o24))
...
(assert (and (= o17 (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1)) (in_range (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))))
(assert (= (to_rep o18) o17))
(assert (= (rec__basic__r__base z__split_fields4) o19))
(assert (= o18 o20))
(assert (= (rec__basic__r__c_field1 z__split_fields4) o21))
(assert (= (rec__basic__r__c_field2 z__split_fields4) o22))
(assert (= z__split_discrs (mk___split_discrs temp___198)))
(assert (= temp___1981 o19))
(assert (= temp___1982 o20))
(assert (= temp___1983 o21))
(assert (= temp___1984 o22))
