...
(define-fun default_initial_assumption ((temp___expr_189 us_rep) (temp___skip_top_level_190 Bool)) Bool (= (to_rep1 (rec__basic__r__x (us_split_discrs1 temp___expr_189))) 0))
...
(declare-const temp___198 enum)
(declare-const temp___1981 integer)
(declare-const temp___1982 integer)
(declare-const temp___1983 Bool)
(declare-const temp___1984 natural)
...
(declare-const z__split_fields5 us_split_fields)
(define-fun o30 () us_rep (mk___rep (mk___split_discrs o18) (mk___split_fields o19 o20 o21 o22)))
(define-fun o31 () us_rep (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17)))
...
(assert (= o11 o5))
(assert (= o12 o6))
(assert (= o31 (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
(assert (= o30 o31))
(assert (= (mk___rep (mk___split_discrs subty__p__z__assume) (mk___split_fields subty__p__z__assume1 subty__p__z__assume2 subty__p__z__assume3 subty__p__z__assume4)) o30))
...
(assert (and (= o23 (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1)) (in_range (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))))
(assert (= (to_rep o24) o23))
(assert (= (rec__basic__r__base z__split_fields4) o25))
(assert (= o24 o26))
(assert (= (rec__basic__r__c_field1 z__split_fields4) o27))
(assert (= (rec__basic__r__c_field2 z__split_fields4) o28))
(assert (= z__split_discrs (mk___split_discrs temp___198)))
(assert (= temp___1981 o25))
(assert (= temp___1982 o26))
(assert (= temp___1983 o27))
(assert (= temp___1984 o28))
(assert (= result4 (mk___split_fields__ref z__split_fields4)))
(assert (= z__split_fields5 (mk___split_fields temp___1981 temp___1982 temp___1983 temp___1984)))
(assert (= z__split_discrs (mk___split_discrs temp___198)))
(assert (and (= o29 (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1)) (in_range (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))))
(assert (not (= (to_rep1 (rec__basic__r__x z__split_discrs)) 0)))
(check-sat)
(exit)
