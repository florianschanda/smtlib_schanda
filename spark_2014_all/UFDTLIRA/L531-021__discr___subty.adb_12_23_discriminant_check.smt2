...
(declare-const temp___171 enum)
(declare-const temp___1711 integer)
(declare-const temp___1712 integer)
(declare-const temp___1713 Bool)
(declare-const temp___1714 natural)
...
(assert (= o11 o5))
(assert (= o12 o6))
(assert (= (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17)) (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
(assert (= (mk___rep (mk___split_discrs o18) (mk___split_fields o19 o20 o21 o22)) (mk___rep (mk___split_discrs o13) (mk___split_fields o14 o15 o16 o17))))
(assert (= (mk___rep (mk___split_discrs subty__p__z__assume) (mk___split_fields subty__p__z__assume1 subty__p__z__assume2 subty__p__z__assume3 subty__p__z__assume4)) (mk___rep (mk___split_discrs o18) (mk___split_fields o19 o20 o21 o22))))
...
(assert (= z__split_discrs (mk___split_discrs temp___171)))
(assert (= temp___1711 o25))
(assert (= temp___1712 o26))
(assert (= temp___1713 o27))
(assert (= temp___1714 o28))
(assert (= result4 (mk___split_fields__ref z__split_fields4)))
(assert (= z__split_fields5 (mk___split_fields temp___1711 temp___1712 temp___1713 temp___1714)))
(assert (= z__split_discrs (mk___split_discrs temp___171)))
