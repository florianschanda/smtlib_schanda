...
(define-fun dynamic_invariant ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 2147483647)) (in_range2 temp___expr_321)))
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= (equivalent_keys k key) true))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant1 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 2147483647)) (in_range4 temp___expr_352)))
(define-fun dynamic_invariant2 ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= 0 2147483647)) (in_range3 temp___expr_358)))
...
(define-fun dynamic_invariant3 ((temp___expr_378 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= 1 2147483647)) (in_range5 temp___expr_378)))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length1 result) (length3 container)) (forall ((temp___399 Int)) (=> (and (in_range3 temp___399) (= (iter_has_element result temp___399) true)) (= (has_key (model__ container) (get result temp___399)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 1 2147483647)) (in_range6 temp___expr_289)))
...
(assert (forall ((container us_rep)) (! (let ((result (length3 container))) (and (<= result (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant5 result true false true))) :pattern ((length3 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant5 (length4 attr__tag container) true false true) :pattern ((length4 attr__tag container))))))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant4 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length1 container)) (= (equivalent_keys key2 (get container result)) true))) (dynamic_invariant5 result true false true)))) :pattern ((find container key2))))))
...
(define-fun dynamic_invariant6 ((temp___expr_327 Int) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool)) Bool (=> (or (= temp___is_init_324 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_327)))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant6 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant5 (length container) true false true) :pattern ((length container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant key2 true true true) (= (has_key container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness container result) true) (dynamic_invariant5 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant5 witness2 true true true) (= (has_witness container witness2) true)) (dynamic_invariant6 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
(assert (forall ((container us_rep3)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep4)) (! (dynamic_invariant5 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant5 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant5 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant3 (w_get container witness2) true false true)) :pattern ((w_get container witness2))))))
...
(declare-const use_ordered_maps__are_disjoint__result4 Bool)
...
(declare-const use_ordered_maps__are_disjoint__result8 bool__ref)
(declare-const cu__split_fields9 us_split_fields2)
(declare-const use_ordered_maps__are_disjoint__result9 Bool)
...
(declare-const use_ordered_maps__are_disjoint__result15 bool__ref)
(declare-const cu__split_fields13 us_split_fields2)
(declare-const use_ordered_maps__are_disjoint__result16 Bool)
(declare-const result8 Bool)
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_maps__are_disjoint__cu__assume)) (first s1)) (ite (= (= (length3 s1) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_maps__are_disjoint__cu__assume)) no_element) true) (and (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 use_ordered_maps__are_disjoint__cu__assume))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 use_ordered_maps__are_disjoint__cu__assume))) 1)))))
...
(assert (and (= result1 (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))))
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (has_key (model__ s2) (get (keys s1) i1)) true)))))
(assert (= (has_key1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true))
(assert (and (= o (positions s1)) (and (not (= (has_key1 o no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key1 o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length3 s1))) (forall ((j us_rep1)) (=> (= (has_key1 o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq1 i1 j) true))))))))))
(assert (not (= (has_key1 o (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
