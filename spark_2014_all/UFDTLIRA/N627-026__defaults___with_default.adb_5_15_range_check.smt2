...
(define-fun dynamic_invariant1 ((temp___expr_151 Int) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (=> (or (= temp___is_init_148 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_151)))
(assert (= first c))
