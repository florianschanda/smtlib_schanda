...
(declare-const temp___6659 et3)
(declare-const temp___66591 et1)
(declare-const temp___66592 et2)
(declare-const temp___66593 enum1ta)
...
(declare-const temp___6662 et3)
(declare-const temp___66621 et1)
(declare-const temp___66622 et2)
(declare-const temp___66623 enum1ta)
...
(assert (= temp___6659 o5))
(assert (= temp___66591 o6))
(assert (= temp___66592 o7))
(assert (= temp___66593 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6659 (mk___rep (mk___split_fields temp___66591 temp___66592)) temp___66593)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6662 o14))
(assert (= temp___66621 o15))
(assert (= temp___66622 o16))
(assert (= temp___66623 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6662 (mk___rep (mk___split_fields temp___66621 temp___66622)) temp___66623)))
(assert (= r__split_fields6 (mk___split_fields__ref1 r__split_fields5)))
(assert (= r__split_fields7 r__split_fields5))
(assert (not (= (to_rep2 (rec__ar__rec2t__f2 (us_split_fields__content1 r__split_fields6))) (to_rep2 r__split_fields))))
(check-sat)
(exit)
