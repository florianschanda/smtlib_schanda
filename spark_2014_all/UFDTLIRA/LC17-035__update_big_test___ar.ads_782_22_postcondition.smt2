...
(declare-const temp___6718 et3)
(declare-const temp___67181 et1)
(declare-const temp___67182 et2)
(declare-const temp___67183 enum1ta)
...
(declare-const temp___6721 et3)
(declare-const temp___67211 et1)
(declare-const temp___67212 et2)
(declare-const temp___67213 enum1ta)
...
(assert (= temp___6718 o5))
(assert (= temp___67181 o6))
(assert (= temp___67182 o7))
(assert (= temp___67183 o8))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6718 (mk___rep (mk___split_fields temp___67181 temp___67182)) temp___67183)))
(assert (= (to_rep1 o9) f))
...
(assert (= temp___6721 o14))
(assert (= temp___67211 o15))
(assert (= temp___67212 o16))
(assert (= temp___67213 o17))
(assert (= result1 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (mk___split_fields1 temp___6721 (mk___rep (mk___split_fields temp___67211 temp___67212)) temp___67213)))
