...
(define-fun dynamic_invariant ((temp___expr_607 Int) (temp___is_init_603 Bool) (temp___skip_constant_604 Bool) (temp___do_toplevel_605 Bool) (temp___do_typ_inv_606 Bool)) Bool (=> (or (= temp___is_init_603 true) (<= 1 2147483647)) (in_range1 temp___expr_607)))
...
(define-fun dynamic_invariant2 ((temp___expr_623 Int) (temp___is_init_619 Bool) (temp___skip_constant_620 Bool) (temp___do_toplevel_621 Bool) (temp___do_typ_inv_622 Bool)) Bool (=> (or (= temp___is_init_619 true) (<= 0 2147483647)) (in_range5 temp___expr_623)))
