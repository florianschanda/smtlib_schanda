...
(define-fun dynamic_invariant ((temp___expr_553 Int) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (<= 1 2147483647)) (in_range1 temp___expr_553)))
...
(define-fun dynamic_invariant2 ((temp___expr_567 Int) (temp___is_init_564 Bool) (temp___skip_constant_565 Bool) (temp___do_toplevel_566 Bool)) Bool (=> (or (= temp___is_init_564 true) (<= 0 2147483647)) (in_range5 temp___expr_567)))
