...
(define-fun us_rep___6__projection ((a us_rep2)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 a))) (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_471 us_rep3) (temp___skip_top_level_472 Bool)) Bool (=> (not (= temp___skip_top_level_472 true)) (and (= (is_empty temp___expr_471) true) (= (length2 temp___expr_471) 0))))
(define-fun default_initial_assumption1 ((temp___expr_457 us_rep2) (temp___skip_top_level_458 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 temp___expr_457))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_449 us_rep1) (temp___skip_top_level_450 Bool)) Bool (=> (not (= temp___skip_top_level_450 true)) (= (length1 temp___expr_449) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_398 Int) (temp___is_init_394 Bool) (temp___skip_constant_395 Bool) (temp___do_toplevel_396 Bool) (temp___do_typ_inv_397 Bool)) Bool (=> (or (= temp___is_init_394 true) (<= 0 2147483647)) (in_range3 temp___expr_398)))
(define-fun default_initial_assumption3 ((temp___expr_412 us_rep2) (temp___skip_top_level_413 Bool)) Bool (= (to_rep (rec__inst_ext_ax__ok_lists2__cursor__node (us_split_fields3 temp___expr_412))) 0))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__inst_ext_ax__ok_lists2__list__capacity (us_split_discrs1 container)))))))
