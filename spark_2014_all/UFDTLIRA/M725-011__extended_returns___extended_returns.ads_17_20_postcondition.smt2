...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep1 (rec__extended_returns__record_t__discr (us_split_discrs1 a))) (to_rep1 (rec__extended_returns__record_t__discr (us_split_discrs1 b)))) (= (to_rep (rec__extended_returns__record_t__a (us_split_fields1 a))) (to_rep (rec__extended_returns__record_t__a (us_split_fields1 b))))) (=> (extended_returns__record_t__b__pred a) (= (to_rep (rec__extended_returns__record_t__b (us_split_fields1 a))) (to_rep (rec__extended_returns__record_t__b (us_split_fields1 b)))))) (=> (extended_returns__record_t__c__pred a) (= (to_rep (rec__extended_returns__record_t__c (us_split_fields1 a))) (to_rep (rec__extended_returns__record_t__c (us_split_fields1 b)))))) (=> (extended_returns__record_t__d__pred a) (= (to_rep (rec__extended_returns__record_t__d (us_split_fields1 a))) (to_rep (rec__extended_returns__record_t__d (us_split_fields1 b)))))) true false))
...
(assert (= result____split_fields4 (mk___split_fields temp___1631 temp___1632 temp___1633 temp___1634)))
(assert (= result____split_discrs (mk___split_discrs temp___163)))
...
(assert (=> (= discr 0) (= result____split_discrs (mk___split_discrs temp___169))))
...
(assert (=> (= discr 0) (= result____split_fields5 (mk___split_fields temp___1691 temp___1692 temp___1693 temp___1694))))
(assert (=> (= discr 0) (= result____split_discrs (mk___split_discrs temp___169))))
...
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____split_discrs (mk___split_discrs temp___165)))))
...
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____attr__constrained temp___1655))))
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result2 (mk___split_fields__ref result____split_fields4)))))
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____split_fields6 (mk___split_fields temp___1651 temp___1652 temp___1653 temp___1654)))))
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____split_discrs (mk___split_discrs temp___165)))))
...
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____split_discrs (mk___split_discrs temp___167)))))
...
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____attr__constrained temp___1675))))
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result3 (mk___split_fields__ref result____split_fields6)))))
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____split_fields7 (mk___split_fields temp___1671 temp___1672 temp___1673 temp___1674)))))
(assert (=> (not (= discr 0)) (=> (= discr 1) (= result____split_discrs (mk___split_discrs temp___167)))))
