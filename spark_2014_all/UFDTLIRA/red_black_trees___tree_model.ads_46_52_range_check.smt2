...
(assert (<= (length q) 100))
(assert (and (= o13 (length q)) (and (in_range3 o13) (<= (+ 0 o13) 2147483647))))
(assert (and (= o10 (length v)) (and (in_range3 o10) (<= (+ 0 o10) 2147483647))))
(assert (and (= o11 (length p)) (and (in_range3 o11) (<= (+ 0 o11) 2147483647))))
(assert (= o12 (- o11 o10)))
(assert (and (= o14 o12) (in_range1 o12)))
(assert (= result2 (ite (= o14 o13) true false)))
(assert (=> (= result2 true) (and (= o8 (length q)) (and (in_range3 o8) (<= (+ 0 o8) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o6 (length v)) (and (in_range3 o6) (<= (+ 0 o6) 2147483647)))))
