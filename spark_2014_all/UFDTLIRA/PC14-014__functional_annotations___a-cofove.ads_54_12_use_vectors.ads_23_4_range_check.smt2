...
(define-fun in_range4 ((x Int)) Bool (and (<= (- 2147483647) x) (<= x 2147483647)))
...
(define-fun dynamic_invariant1 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= (- 2147483647) 2147483647)) (in_range4 temp___expr_183)))
...
(define-fun dynamic_invariant2 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= first 2147483647)) (dynamic_property first 2147483647 temp___expr_189)))
(assert (= first fst))
...
(define-fun dynamic_invariant3 ((temp___expr_219 Int) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (<= first3 last2)) (dynamic_property3 first3 last2 temp___expr_219)))
...
(define-fun dynamic_invariant5 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= first1 last)) (dynamic_property1 first1 last temp___expr_195)))
(assert (= first1 fst))
(assert (= last lst))
(assert (= no_index first3))
(assert (= last_count (ite (< last1 first2) 0 (ite (or (< last1 (- 1)) (< (- last1 2147483647) first2)) (+ (- last1 first2) 1) 2147483647))))
(define-fun dynamic_invariant6 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= first2 last1)) (dynamic_property2 first2 last1 temp___expr_207)))
(assert (= first2 fst))
(assert (= last1 lst))
...
(assert (<= (- first2 1) (+ (ite (< 2147483646 last1) 2147483646 last1) 1)))
(assert (not (<= (- 2147483648) (- first2 1))))
(check-sat)
(exit)
