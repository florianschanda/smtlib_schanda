...
(declare-const use_ordered_maps__my_find__result us_rep1)
(declare-const temp___672 Int)
(declare-const result2 int__ref)
(declare-const temp___6721 Int)
(declare-const result3 Bool)
(declare-const use_ordered_maps__my_find__result1 us_rep1)
...
(assert (= result1 true))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (not (= (get (keys s) i) k)))))
(assert (= (has_key1 (positions s) (mk___rep1 cu__split_fields4)) true))
(assert (= result2 (mk_int__ref temp___672)))
(assert (= temp___6721 (get1 (positions s) (mk___rep1 cu__split_fields4))))
(assert (and (= o2 (key s (mk___rep1 cu__split_fields4))) (and (in_range7 o2) (= o2 (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields4)))))))
(assert (= result3 (ite (= o2 k) true false)))
(assert (not (= result3 true)))
(assert (= use_ordered_maps__my_find__result1 use_ordered_maps__my_find__result))
(assert (and (= temp___6701 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length3 s)) true) true) (= (bool_eq1 temp___6701 no_element) true) (and (= (has_key1 (positions s) temp___6701) true) (= (get1 (positions s) temp___6701) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result4 (mk___split_fields__ref1 cu__split_fields4)))
(assert (= cu__split_fields3 (mk___split_fields1 temp___670)))
