...
(assert (= result1 true))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (not (= (get (keys s) i1) k)))))
(assert (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) true))
(assert (= result3 (mk_int__ref temp___6291)))
(assert (= temp___6292 (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))
(assert (and (= o8 (key s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o8) (= o8 (get (keys s) (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (= result4 (ite (= o8 k) true false)))
(assert (not (= result4 true)))
(assert (= use_ordered_maps__my_find__result3 use_ordered_maps__my_find__result2))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___627)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length3 s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___627)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 temp___627))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___627))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (= result6 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2))))
(assert (= cu__split_fields3 (mk___split_fields1 temp___627)))
(assert (and (= o9 (has_key1 (positions s) (mk___rep1 cu__split_fields3))) (= (= o9 true) (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true))))
(assert (= result7 (ite (not (= o9 true)) true false)))
(assert (not (= result7 true)))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
(assert (not (not (= (get (keys s) i1) k))))
(check-sat)
(exit)
