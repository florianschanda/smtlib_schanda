...
(define-fun default_initial_assumption1 ((temp___expr_143 Int) (temp___skip_top_level_144 Bool)) Bool (and (= temp___expr_143 1) (=> (not (= temp___skip_top_level_144 true)) (= (bar temp___expr_143) true))))
...
(define-fun default_initial_assumption2 ((temp___expr_150 us_rep) (temp___skip_top_level_151 Bool)) Bool (and (let ((temp___152 (rec__dic2__r__x (us_split_fields1 temp___expr_150)))) (and (= (to_rep temp___152) 0) (= (foo (to_rep temp___152)) true))) (let ((temp___154 (rec__dic2__r__y (us_split_fields1 temp___expr_150)))) (and (= (to_rep1 temp___154) 1) (= (bar (to_rep1 temp___154)) true)))))
