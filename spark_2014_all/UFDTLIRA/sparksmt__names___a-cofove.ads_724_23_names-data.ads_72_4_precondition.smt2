...
(define-fun dynamic_invariant ((temp___expr_371 Int) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool)) Bool (=> (or (= temp___is_init_368 true) (<= 1 2147483647)) (in_range1 temp___expr_371)))
...
(define-fun default_initial_assumption ((temp___expr_429 us_rep1) (temp___skip_top_level_430 Bool)) Bool (=> (not (= temp___skip_top_level_430 true)) (= (length temp___expr_429) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_386 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= 0 2147483647)) (in_range6 temp___expr_386)))
...
(define-fun dynamic_invariant4 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 2147483647)) (in_range4 temp___expr_148)))
...
(define-fun dynamic_invariant6 ((temp___expr_392 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 0 2147483647)) (in_range2 temp___expr_392)))
...
(assert (forall ((x capacity_range)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range2 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 0) true) (to_rep3 (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant7 ((temp___expr_422 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 0 2147483647)) (in_range8 temp___expr_422)))
