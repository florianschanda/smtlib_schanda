...
(define-fun dynamic_invariant ((temp___expr_417 Int) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool) (temp___do_typ_inv_416 Bool)) Bool (=> (or (= temp___is_init_413 true) (<= 1 2147483647)) (in_range1 temp___expr_417)))
...
(define-fun dynamic_invariant1 ((temp___expr_434 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool) (temp___do_typ_inv_433 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 0 2147483647)) (in_range6 temp___expr_434)))
...
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 2147483647)) (in_range4 temp___expr_173)))
...
(define-fun dynamic_invariant6 ((temp___expr_441 Int) (temp___is_init_437 Bool) (temp___skip_constant_438 Bool) (temp___do_toplevel_439 Bool) (temp___do_typ_inv_440 Bool)) Bool (=> (or (= temp___is_init_437 true) (<= 0 2147483647)) (in_range2 temp___expr_441)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 0 0) true) (to_rep3 (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
