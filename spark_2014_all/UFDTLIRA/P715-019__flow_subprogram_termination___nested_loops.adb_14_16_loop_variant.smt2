...
(assert (= result1 j1))
(assert (= j2 o))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j3)) (=> (<= (- 2147483648) 2147483647) (in_range1 x1))))
(assert (= result2 temp___162))
(assert (= temp___1621 j3))
(assert (= i result3))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 5))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 x2)) (=> (<= 1 5) (in_range2 i2))) (and (<= 1 i2) (<= i2 5))))
(assert (= temp___159 result4))
(assert (= temp___1591 i2))
(assert (= x2 result5))
(assert (= x3 i2))
(assert (< 0 x3))
(assert (< 0 x3))
(assert (= temp___156 result6))
(assert (= temp___1561 x3))
(assert (< 0 x3))
(assert (not (< temp___1561 x3)))
(check-sat)
(exit)
