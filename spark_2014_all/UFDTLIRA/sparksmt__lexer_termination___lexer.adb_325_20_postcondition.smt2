...
(declare-const temp___1068 token_kind)
(declare-const temp___10681 natural)
(declare-const temp___10682 natural)
(declare-const temp___10683 natural)
(declare-const temp___10684 name_id)
(declare-const temp___10685 Bool)
...
(assert (=> (= kind 1) (= o o8)))
(assert (=> (= kind 1) (= temp___1065 o8)))
(assert (=> (= kind 1) (= temp___10651 o4)))
(assert (=> (= kind 1) (= temp___10652 o5)))
(assert (=> (= kind 1) (= temp___10653 o6)))
(assert (=> (= kind 1) (= temp___10654 o7)))
(assert (=> (= kind 1) (= true temp___10655)))
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___1065 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___1065) (mk___split_fields temp___10651 temp___10652 temp___10653 temp___10654) temp___10655))))
(assert (=> (= kind 1) (= usq_ temp___1067)))
(assert (=> (= kind 1) (= usq_1 temp___10671)))
(assert (=> (= kind 1) (= usq_2 temp___10672)))
(assert (=> (= kind 1) (= usq_3 temp___10673)))
(assert (=> (= kind 1) (= usq_4 temp___10674)))
(assert (=> (= kind 1) (= t__attr__constrained temp___10675)))
(assert (=> (= kind 1) (= result t__split_fields8)))
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___10671 temp___10672 temp___10673 temp___10674))))
(assert (=> (= kind 1) (= result1 t__split_discrs5)))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___1067))))
...
(assert (=> (not (= kind 1)) (= temp___1068 o17)))
(assert (=> (not (= kind 1)) (= temp___10681 o13)))
(assert (=> (not (= kind 1)) (= temp___10682 o14)))
(assert (=> (not (= kind 1)) (= temp___10683 o15)))
(assert (=> (not (= kind 1)) (= temp___10684 o16)))
(assert (=> (not (= kind 1)) (= true temp___10685)))
(assert (=> (not (= kind 1)) (=> (= t__attr__constrained true) (= temp___1068 t__split_discrs))))
(assert (=> (not (= kind 1)) (= usq_6 (mk___rep (mk___split_discrs temp___1068) (mk___split_fields temp___10681 temp___10682 temp___10683 temp___10684) temp___10685))))
(assert (=> (not (= kind 1)) (= temp___1070 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained))))
(assert (=> (not (= kind 1)) (= result2 t__split_fields8)))
(assert (=> (not (= kind 1)) (= t__split_fields5 (us_split_fields1 temp___1070))))
(assert (=> (not (= kind 1)) (= result3 t__split_discrs5)))
(assert (=> (not (= kind 1)) (= t__split_discrs2 (us_split_discrs1 temp___1070))))
