...
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___979 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___979) (mk___split_fields temp___9791 temp___9792 temp___9793 temp___9794) temp___9795))))
...
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___9811 temp___9812 temp___9813 temp___9814))))
(assert (=> (= kind 1) (= result1 t__split_discrs5)))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___981))))
...
(assert (=> (not (= kind 1)) (=> (= t__attr__constrained true) (= temp___982 t__split_discrs))))
(assert (=> (not (= kind 1)) (= usq_6 (mk___rep (mk___split_discrs temp___982) (mk___split_fields temp___9821 temp___9822 temp___9823 temp___9824) temp___9825))))
(assert (=> (not (= kind 1)) (= temp___984 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained))))
(assert (=> (not (= kind 1)) (= result2 t__split_fields8)))
(assert (=> (not (= kind 1)) (= t__split_fields5 (us_split_fields1 temp___984))))
(assert (=> (not (= kind 1)) (= result3 t__split_discrs5)))
(assert (=> (not (= kind 1)) (= t__split_discrs2 (us_split_discrs1 temp___984))))
