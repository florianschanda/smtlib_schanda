...
(declare-const temp___969 token_kind)
(declare-const temp___9691 natural)
(declare-const temp___9692 natural)
(declare-const temp___9693 natural)
(declare-const temp___9694 name_id)
(declare-const temp___9695 Bool)
...
(declare-const temp___971 token_kind)
(declare-const temp___9711 natural)
(declare-const temp___9712 natural)
(declare-const temp___9713 natural)
(declare-const temp___9714 name_id)
(declare-const temp___9715 Bool)
...
(declare-const temp___972 token_kind)
(declare-const temp___9721 natural)
(declare-const temp___9722 natural)
(declare-const temp___9723 natural)
(declare-const temp___9724 name_id)
(declare-const temp___9725 Bool)
(declare-const usq_6 us_rep)
(declare-const temp___974 us_rep)
...
(assert (=> (= kind 1) (= o o8)))
(assert (=> (= kind 1) (= temp___969 o8)))
(assert (=> (= kind 1) (= temp___9691 o4)))
(assert (=> (= kind 1) (= temp___9692 o5)))
(assert (=> (= kind 1) (= temp___9693 o6)))
(assert (=> (= kind 1) (= temp___9694 o7)))
(assert (=> (= kind 1) (= true temp___9695)))
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___969 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___969) (mk___split_fields temp___9691 temp___9692 temp___9693 temp___9694) temp___9695))))
(assert (=> (= kind 1) (= usq_ temp___971)))
(assert (=> (= kind 1) (= usq_1 temp___9711)))
(assert (=> (= kind 1) (= usq_2 temp___9712)))
(assert (=> (= kind 1) (= usq_3 temp___9713)))
(assert (=> (= kind 1) (= usq_4 temp___9714)))
(assert (=> (= kind 1) (= t__attr__constrained temp___9715)))
(assert (=> (= kind 1) (= result (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3)))))
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___9711 temp___9712 temp___9713 temp___9714))))
(assert (=> (= kind 1) (= result1 (mk___split_discrs__ref (mk___split_discrs t__split_discrs)))))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___971))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= (to_rep1 t__split_discrs) r25b))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (in_range3 r25b))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= (to_rep o10) 1))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= (to_rep o11) first_col))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= (to_rep o12) first_line))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= o12 o13))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= o11 o14))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= o10 o15))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= dummy1 o16))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= (to_rep1 o9) 2))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= o9 o17))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___972 o17))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9721 o13))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9722 o14))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9723 o15))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9724 o16))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= true temp___9725))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (=> (= t__attr__constrained true) (= temp___972 t__split_discrs)))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= usq_6 (mk___rep (mk___split_discrs temp___972) (mk___split_fields temp___9721 temp___9722 temp___9723 temp___9724) temp___9725)))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___974 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained)))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= result2 (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3))))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= t__split_fields5 (us_split_fields1 temp___974)))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= result3 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= t__split_discrs2 (us_split_discrs1 temp___974)))))
...
(assert (not (= (to_rep1 (rec__lexer__token__kind (us_split_discrs__content t__split_discrs3))) kind)))
(check-sat)
(exit)
