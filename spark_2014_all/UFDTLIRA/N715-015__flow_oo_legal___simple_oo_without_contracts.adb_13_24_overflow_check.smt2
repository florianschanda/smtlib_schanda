...
(assert (= g1 g2))
(assert (and (= o (+ g3 (to_rep (rec__simple_oo_without_contracts__t__x1 (us_split_fields3 par1))))) (in_range (+ g3 (to_rep (rec__simple_oo_without_contracts__t__x1 (us_split_fields3 par1)))))))
(assert (= o1 (+ o (to_rep (rec__simple_oo_without_contracts__t1__y (us_split_fields3 par1))))))
