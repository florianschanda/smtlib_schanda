...
(declare-const temp___653 count_type)
(declare-const o2 Int)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___653 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___653)) no_element))
(assert (and (= o2 (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o2) (<= o2 (to_rep (rec__inst_ext_ax__ok_lists1__list__capacity target__split_discrs))))))
(assert (= o3 (- (to_rep (rec__inst_ext_ax__ok_lists1__list__capacity target__split_discrs)) o2)))
