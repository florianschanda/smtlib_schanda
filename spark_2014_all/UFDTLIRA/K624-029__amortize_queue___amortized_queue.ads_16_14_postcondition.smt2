...
(declare-const result5 capacity_range)
...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx3)) (= (get (model__ (mk___rep result____split_discrs result____split_fields18)) i) (get (model__ left) i))))))
...
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (last (model__ left)))) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) i) (get (model__ left) i))))))
(assert (=> (and (<= 1 idx8) (<= idx8 r10b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx9)) (= (get (model__ (mk___rep result____split_discrs result____split_fields9)) (+ (last (model__ left)) i)) (get (model__ right) i))))))
...
(assert (= (mk___rep (mk___split_discrs result5) (mk___split_fields result6)) (vector__content amortized_queue__Oconcat__result5)))
