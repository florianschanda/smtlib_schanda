...
(declare-const result14 capacity_range)
(declare-const result15 us_main_type)
...
(assert (= (mk___rep (mk___split_discrs result14) (mk___split_fields result15)) (vector__content amortized_queue__Oconcat__result5)))
(assert (not (= (length (vector__content amortized_queue__Oconcat__result5)) (+ (length left) (length right)))))
(check-sat)
(exit)
