...
(assert (= o10 n1))
(assert (and (= o11 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o10)) (and (in_range5 o11) (= o11 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o10)))))
(assert (not (dynamic_property3 first2 last3 n1)))
(check-sat)
(exit)
