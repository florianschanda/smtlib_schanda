...
(define-fun dynamic_invariant1 ((temp___expr_1491 Int) (temp___is_init_1488 Bool) (temp___skip_constant_1489 Bool) (temp___do_toplevel_1490 Bool)) Bool (=> (or (= temp___is_init_1488 true) (<= 0 2147483647)) (in_range3 temp___expr_1491)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant3 ((temp___expr_1503 Int) (temp___is_init_1500 Bool) (temp___skip_constant_1501 Bool) (temp___do_toplevel_1502 Bool)) Bool (=> (or (= temp___is_init_1500 true) (<= 0 2147483647)) (in_range5 temp___expr_1503)))
...
(define-fun default_initial_assumption ((temp___expr_1537 us_rep1) (temp___skip_top_level_1538 Bool)) Bool (=> (not (= temp___skip_top_level_1538 true)) (= (length1 temp___expr_1537) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_1530 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2147483647)) (in_range6 temp___expr_1530)))
...
(define-fun dynamic_invariant5 ((temp___expr_1524 Int) (temp___is_init_1521 Bool) (temp___skip_constant_1522 Bool) (temp___do_toplevel_1523 Bool)) Bool (=> (or (= temp___is_init_1521 true) (<= 0 2147483647)) (in_range7 temp___expr_1524)))
...
(assert (and (= o (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range5 o) (= o (ite (= (of_int 1) true) (to_rep (rec__dic_of_cont__my_fove__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o1 (- o count)))
