...
(assert (= (mk___rep (mk___split_fields main__get_rec__result__assume)) result__))
(assert (= main__get_rec__result2 main__get_rec__result1))
(assert (= (mk___rep (mk___split_fields main__get_rec__result3)) (mk___rep (mk___split_fields main__get_rec__result1))))
(assert (= result main__get_rec__result))
(assert (= (mk___rep (mk___split_fields main__get_rec__result1)) result__))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields main__get_rec__result4)) (mk___rep (mk___split_fields (of_rep 5678)))) true)))
(check-sat)
(exit)
