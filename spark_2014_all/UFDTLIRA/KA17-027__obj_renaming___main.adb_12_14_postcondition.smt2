...
(assert (= result__ (mk___rep (mk___split_fields rliteral))))
...
(define-fun main__get_rec__result6 () us_rep (mk___rep (mk___split_fields main__get_rec__result1)))
(declare-const result1 natural)
(assert (= (mk___rep (mk___split_fields rliteral)) result__))
(assert (= main__get_rec__result2 main__get_rec__result1))
(assert (= (mk___rep (mk___split_fields main__get_rec__result3)) main__get_rec__result6))
(assert (= result main__get_rec__result))
(assert (= main__get_rec__result6 result__))
(assert (= (mk_rec____ref (mk___rep (mk___split_fields main__get_rec__result4))) (mk_rec____ref (mk___rep (mk___split_fields main__get_rec__result2)))))
(assert (= main__get_rec__result5 main__get_rec__result3))
(assert (= result1 main__get_rec__result4))
(assert (not (= (bool_eq (mk___rep (mk___split_fields main__get_rec__result4)) (mk___rep (mk___split_fields rliteral))) true)))
(check-sat)
(exit)
