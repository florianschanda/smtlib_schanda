...
(declare-const temp___6612 et1)
(declare-const temp___66121 et2)
(declare-const o4 et2)
(declare-const o5 et1)
(declare-const o6 et2)
(declare-const temp___6614 et1)
(declare-const temp___66141 et2)
...
(assert (= temp___6612 o2))
(assert (= temp___66121 o3))
(assert (= result1 r__split_fields))
(assert (= result2 r__split_fields1))
(assert (= temp___6612 r__split_fields2))
(assert (= temp___66121 r__split_fields3))
(assert (= (to_rep1 o4) temp1))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___6614 o5))
(assert (= temp___66141 o6))
(assert (= result3 r__split_fields2))
(assert (= result4 r__split_fields3))
(assert (= temp___6614 r__split_fields4))
(assert (= temp___66141 r__split_fields5))
(assert (= temp2 temp1))
