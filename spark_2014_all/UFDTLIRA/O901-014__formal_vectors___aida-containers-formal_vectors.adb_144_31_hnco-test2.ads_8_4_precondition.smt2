...
(define-fun dynamic_invariant1 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_413)))
...
(define-fun last_element ((container1 us_rep)) Int (get (model__ container1) (last_index container1)))
...
(define-fun dynamic_invariant4 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 2147483647)) (in_range5 temp___expr_420)))
(define-fun dynamic_invariant5 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483647)) (in_range1 temp___expr_256)))
...
(define-fun dynamic_invariant6 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 0 2147483647)) (in_range7 temp___expr_445)))
...
(define-fun dynamic_invariant7 ((temp___expr_438 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool) (temp___do_typ_inv_437 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_438)))
(assert (forall ((container1 us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant7 (get container1 position) true false true true)) :pattern ((get container1 position))))))
...
(assert (and (= us1 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container)))) (in_range1 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))))))
(assert (not (not (= (is_empty1 (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 container))) true))))
(check-sat)
(exit)
