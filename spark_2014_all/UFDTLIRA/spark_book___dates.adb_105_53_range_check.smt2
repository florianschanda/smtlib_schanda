...
(assert (= (day_typeqtint rliteral) 1))
(declare-const rliteral1 month_type)
(assert (= (month_typeqtint rliteral1) 1))
(declare-const rliteral2 year_type)
(assert (= (year_typeqtint rliteral2) 2000))
(assert (forall ((us_void_param tuple0)) (! (= (minimum_date us_void_param) (mk___rep (mk___split_fields rliteral rliteral1 rliteral2))) :pattern ((minimum_date us_void_param)))))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields current_date__split_fields current_date__split_fields1 current_date__split_fields2)) (minimum_date Tuple0)) true)))
(assert (= (to_rep2 current_date__split_fields) 1))
(assert (= (to_rep1 current_date__split_fields1) 1))
(assert (not (in_range (- (to_rep current_date__split_fields2) 1))))
(check-sat)
(exit)
