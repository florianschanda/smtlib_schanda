...
(define-fun capacity ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep1 (rec__indefinite_unbounded_tagged__vect__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun dynamic_invariant4 ((temp___expr_509 us_rep1) (temp___is_init_505 Bool) (temp___skip_constant_506 Bool) (temp___do_toplevel_507 Bool) (temp___do_typ_inv_508 Bool)) Bool (=> (not (= temp___skip_constant_506 true)) (in_range5 2 temp___expr_509)))
(define-fun default_initial_assumption1 ((temp___expr_511 us_rep1) (temp___skip_top_level_512 Bool)) Bool (and (= (to_rep1 (rec__indefinite_unbounded_tagged__vect__vector__capacity (us_split_discrs1 temp___expr_511))) 2) (=> (not (= temp___skip_top_level_512 true)) (= (is_empty temp___expr_511) true))))
...
(assert (and (and (= (length (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__append__2__container__fields)) (+ (length (mk___rep1 v__split_discrs v__split_fields1)) 1)) (= (olt (model__ (mk___rep1 v__split_discrs v__split_fields1)) (model__ (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__append__2__container__fields))) true)) (= (let ((temp___452 (get (model__ (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__append__2__container__fields)) (+ (last (model__ (mk___rep1 v__split_discrs v__split_fields1))) 1)))) (ite (= (attr__tag temp___452) o2) (us_dispatch_eq temp___452 o13) false)) true)))
...
(assert (and (and (= (length (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__replace_element__container__fields)) (length (mk___rep1 v__split_discrs v__split_fields5))) (= (let ((temp___430 (get (model__ (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__replace_element__container__fields)) 2))) (ite (= (attr__tag temp___430) (attr__tag o10)) (us_dispatch_eq temp___430 o10) false)) true)) (= (equal_except (model__ (mk___rep1 v__split_discrs v__split_fields5)) (model__ (mk___rep1 v__split_discrs indefinite_unbounded_tagged__vect__replace_element__container__fields)) 2) true)))
...
(assert (= (let ((temp___631 (f 1))) (let ((temp___630 (get (model__ (mk___rep1 v__split_discrs v__split_fields6)) 1))) (ite (= (attr__tag temp___630) (attr__tag temp___631)) (us_dispatch_eq temp___630 temp___631) false))) true))
(assert (= (let ((temp___635 (f 4))) (let ((temp___634 (get (model__ (mk___rep1 v__split_discrs v__split_fields6)) 2))) (ite (= (attr__tag temp___634) (attr__tag temp___635)) (us_dispatch_eq temp___634 temp___635) false))) true))
(assert (= (let ((temp___639 (f 3))) (let ((temp___638 (get (model__ (mk___rep1 v__split_discrs v__split_fields6)) 3))) (ite (= (attr__tag temp___638) (attr__tag temp___639)) (us_dispatch_eq temp___638 temp___639) false))) true))
...
(assert (= (let ((temp___644 (f 3))) (let ((temp___643 (get (model__ (mk___rep1 v__split_discrs v__split_fields7)) 1))) (ite (= (attr__tag temp___643) (attr__tag temp___644)) (us_dispatch_eq temp___643 temp___644) false))) true))
(assert (= (let ((temp___648 (f 4))) (let ((temp___647 (get (model__ (mk___rep1 v__split_discrs v__split_fields7)) 2))) (ite (= (attr__tag temp___647) (attr__tag temp___648)) (us_dispatch_eq temp___647 temp___648) false))) true))
(assert (= (let ((temp___652 (f 1))) (let ((temp___651 (get (model__ (mk___rep1 v__split_discrs v__split_fields7)) 3))) (ite (= (attr__tag temp___651) (attr__tag temp___652)) (us_dispatch_eq temp___651 temp___652) false))) true))
...
(assert (= (let ((temp___657 (f 3))) (let ((temp___656 (get (model__ (mk___rep1 v__split_discrs v__split_fields8)) 1))) (ite (= (attr__tag temp___656) (attr__tag temp___657)) (us_dispatch_eq temp___656 temp___657) false))) true))
(assert (= (let ((temp___661 (f 4))) (let ((temp___660 (get (model__ (mk___rep1 v__split_discrs v__split_fields8)) 2))) (ite (= (attr__tag temp___660) (attr__tag temp___661)) (us_dispatch_eq temp___660 temp___661) false))) true))
...
(assert (= (let ((temp___666 (f 4))) (let ((temp___665 (get (model__ (mk___rep1 v__split_discrs v__split_fields9)) 1))) (ite (= (attr__tag temp___665) (attr__tag temp___666)) (us_dispatch_eq temp___665 temp___666) false))) true))
(assert (= (let ((temp___670 (f 3))) (let ((temp___669 (get (model__ (mk___rep1 v__split_discrs v__split_fields9)) 2))) (ite (= (attr__tag temp___669) (attr__tag temp___670)) (us_dispatch_eq temp___669 temp___670) false))) true))
(assert (= (last (model__ (mk___rep1 v__split_discrs v__split_fields9))) 2))
(assert (= (let ((temp___674 (f 4))) (let ((temp___673 (get (model__ (mk___rep1 v__split_discrs v__split_fields9)) 1))) (ite (= (attr__tag temp___673) (attr__tag temp___674)) (us_dispatch_eq temp___673 temp___674) false))) true))
(assert (= (let ((temp___678 (f 3))) (let ((temp___677 (last_element (mk___rep1 v__split_discrs v__split_fields9)))) (ite (= (attr__tag temp___677) (attr__tag temp___678)) (us_dispatch_eq temp___677 temp___678) false))) true))
...
(assert (= (let ((temp___683 (f 3))) (let ((temp___682 (get (model__ (mk___rep1 v__split_discrs v__split_fields10)) 1))) (ite (= (attr__tag temp___682) (attr__tag temp___683)) (us_dispatch_eq temp___682 temp___683) false))) true))
(assert (= (let ((temp___687 (f 4))) (let ((temp___686 (get (model__ (mk___rep1 v__split_discrs v__split_fields10)) 2))) (ite (= (attr__tag temp___686) (attr__tag temp___687)) (us_dispatch_eq temp___686 temp___687) false))) true))
