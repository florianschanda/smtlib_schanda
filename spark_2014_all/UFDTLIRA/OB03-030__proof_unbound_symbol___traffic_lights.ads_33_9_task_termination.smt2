...
(define-fun default_initial_assumption ((temp___expr_1710 us_rep1) (temp___skip_top_level_1711 Bool)) Bool (and (and (and (and (and (and (= (rec__traffic_lights__traffic_lightT__last_state_change (us_split_fields1 temp___expr_1710)) time_first) (= (rec__traffic_lights__traffic_lightT__vehicles_green (us_split_fields1 temp___expr_1710)) (distinct 0 0))) (= (rec__traffic_lights__traffic_lightT__vehicles_yellow (us_split_fields1 temp___expr_1710)) (distinct 0 0))) (= (rec__traffic_lights__traffic_lightT__vehicles_red (us_split_fields1 temp___expr_1710)) (distinct 1 0))) (= (rec__traffic_lights__traffic_lightT__pedestrians_green (us_split_fields1 temp___expr_1710)) (distinct 1 0))) (= (rec__traffic_lights__traffic_lightT__pedestrians_red (us_split_fields1 temp___expr_1710)) (distinct 0 0))) (= (rec__traffic_lights__traffic_lightT__change_state (us_split_fields1 temp___expr_1710)) (distinct 0 0))))
