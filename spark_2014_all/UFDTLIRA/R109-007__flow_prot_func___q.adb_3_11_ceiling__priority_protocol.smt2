...
(declare-fun f (poT) Int)
(declare-fun f__function_guard (Int poT) Bool)
(assert (forall ((self__ poT)) (! (dynamic_invariant (f self__) true false true true) :pattern ((f self__)))))
