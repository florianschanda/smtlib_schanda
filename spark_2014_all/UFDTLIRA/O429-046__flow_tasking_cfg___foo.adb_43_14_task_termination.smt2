...
(define-fun us_split_discrs___projection ((a us_split_discrs)) natural (rec__foo__thing__d a))
...
(define-fun us_rep___27__projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
...
(define-fun us_rep___29__projection ((a us_rep1)) us_split_discrs (us_split_discrs2 a))
(define-fun us_rep___30__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun dynamic_invariant1 ((temp___expr_1477 us_rep1) (temp___is_init_1474 Bool) (temp___skip_constant_1475 Bool) (temp___do_toplevel_1476 Bool)) Bool (=> (not (= temp___skip_constant_1475 true)) (in_range2 12 (to_base temp___expr_1477))))
(define-fun default_initial_assumption ((temp___expr_1479 us_rep1) (temp___skip_top_level_1480 Bool)) Bool (and (and (= (to_rep (rec__foo__thing__d (us_split_discrs2 temp___expr_1479))) 12) (= (rec__foo__thing__a1 (us_split_fields3 temp___expr_1479)) (of_int 0))) (= (rec__foo__thing__x1 (us_split_fields3 temp___expr_1479)) (> (to_rep (rec__foo__thing__d (us_split_discrs2 temp___expr_1479))) 5))))
