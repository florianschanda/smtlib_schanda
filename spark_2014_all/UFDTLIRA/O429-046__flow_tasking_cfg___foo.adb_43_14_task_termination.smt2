...
(define-fun dynamic_invariant1 ((temp___expr_1655 us_rep1) (temp___is_init_1651 Bool) (temp___skip_constant_1652 Bool) (temp___do_toplevel_1653 Bool) (temp___do_typ_inv_1654 Bool)) Bool (=> (not (= temp___skip_constant_1652 true)) (in_range2 12 (to_base temp___expr_1655))))
(define-fun default_initial_assumption ((temp___expr_1657 us_rep1) (temp___skip_top_level_1658 Bool)) Bool (and (and (= (to_rep (rec__foo__thing__d (us_split_discrs2 temp___expr_1657))) 12) (= (rec__foo__thing__a1 (us_split_fields3 temp___expr_1657)) (distinct 0 0))) (= (rec__foo__thing__x1 (us_split_fields3 temp___expr_1657)) (> (to_rep (rec__foo__thing__d (us_split_discrs2 temp___expr_1657))) 5))))
