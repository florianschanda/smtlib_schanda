...
(assert (= index1 1))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___189 index1)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___188 t1)))
(assert (=> (and (<= 1 index1) (<= index1 10)) (= t2 (- index2 1))))
(assert (=> (and (<= 1 index1) (<= index1 10)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 t2)) (=> (<= 1 10) (in_range2 index2))) (and (<= 1 index2) (<= index2 10)))))
...
(assert (=> (and (<= 1 index1) (<= index1 10)) (= (mk_int__ref t6) (mk_int__ref t4))))
