...
(assert (forall ((x opandnullt)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x privileget)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (isdoingop theadmin) true) (in_range1 (to_rep (rec__admin__t__currentop (us_split_fields1 theadmin))))) :pattern ((isdoingop theadmin)))))
(declare-const theadmin us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 0 4)) (in_range temp___expr_472)))
(define-fun dynamic_invariant1 ((temp___expr_479 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool) (temp___do_typ_inv_478 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 4)) (in_range1 temp___expr_479)))
(define-fun dynamic_invariant2 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 3)) (in_range2 temp___expr_402)))
(assert (= (isdoingop theadmin) true))
(assert (not (in_range1 (to_rep (rec__admin__t__currentop (us_split_fields1 theadmin))))))
(check-sat)
(exit)
