...
(assert (and (= o2 (elements (mk___rep s1__split_discrs s1__split_fields1))) (and (and (and (= (length2 o2) (length (mk___rep s1__split_discrs s1__split_fields1))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o2 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields1)) (get o2 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields1)) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs s1__split_fields1)))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
