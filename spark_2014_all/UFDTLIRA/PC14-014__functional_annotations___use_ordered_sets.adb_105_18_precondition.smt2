...
(assert (= result2 true))
(assert (and (= o3 (length (mk___rep s2__split_discrs s2__split_fields1))) (and (in_range2 o3) (<= o3 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o4 (+ o3 i)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (and (= o6 (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) o5)) (in_range3 o6)))
(assert (and (= o2 (elements (mk___rep s1__split_discrs s1__split_fields1))) (and (and (and (= (length2 o2) (length (mk___rep s1__split_discrs s1__split_fields1))) (forall ((temp___432 Int)) (=> (and (in_range4 temp___432) (= (iter_has_element o2 temp___432) true)) (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields1)) (get o2 temp___432)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields1)) item) true)) (and (< 0 (find o2 item)) (= (equivalent_elements (get o2 (find o2 item)) item) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s1__split_discrs s1__split_fields1)))) (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
