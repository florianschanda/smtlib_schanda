...
(assert (and (= o16 (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) o15)) (in_range3 o16)))
(assert (and (= o12 (elements (mk___rep s1__split_discrs s1__split_fields2))) (and (and (and (= (length2 o12) (length (mk___rep s1__split_discrs s1__split_fields2))) (forall ((temp___390 Int)) (=> (and (in_range4 temp___390) (= (iter_has_element o12 temp___390) true)) (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields2)) (get o12 temp___390)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields2)) item) true)) (and (< 0 (find o12 item)) (= (equivalent_elements (get o12 (find o12 item)) item) true))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s1__split_discrs s1__split_fields2)))) (and (= (find o12 (get o12 i2)) i2) (= (e_is_find o12 (get o12 i2) i2) true)))))))
(assert (not (<= 1 i1)))
(check-sat)
(exit)
