...
(assert (not (<= 1 (+ (+ 0 (ite (forall ((cu2 us_rep1)) (=> (= (has_key (positions l) cu2) true) (not (= (element l cu2) 0)))) 1 0)) (ite (exists ((cu2 us_rep1)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 0))) 1 0)))))
(check-sat)
(exit)
