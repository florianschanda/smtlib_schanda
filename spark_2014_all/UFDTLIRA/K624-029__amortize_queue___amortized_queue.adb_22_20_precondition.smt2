...
(assert (<= 1 i2))
(assert (<= i2 idx10))
(assert (and (= o25 i2) (in_range3 i2)))
(assert (and (= o26 (get (model__ right) o25)) (and (in_range6 o26) (= o26 (get (model__ right) o25)))))
(assert (and (= o21 (last (model__ left))) (and (in_range4 o21) (= o21 (last (model__ left))))))
(assert (= o22 (+ o21 i2)))
