...
(assert (= c2 1))
(assert (=> (and (<= 1 c2) (<= c2 10)) (and (and (= temp___231 c2) (and (= temp___228 m1) (and (= temp___233 m1) (and (= temp___232 m1) (and (= temp___227 tmp) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 (- c3 1))) (and (= (to_rep (get m2 5 i13)) (to_rep (get temp___232 7 i13))) (= (to_rep (get m2 7 i13)) (to_rep (get temp___233 5 i13)))))) (and (and (and (and (=> (<= 0 2147483647) (in_range2 tmp4)) (forall ((temp___229 Int) (temp___230 Int)) (=> (and (and (<= 1 temp___229) (<= temp___229 10)) (and (<= 1 temp___230) (<= temp___230 10))) (=> (and (or (<= c3 temp___230) (not (= 7 temp___229))) (or (<= c3 temp___230) (not (= 5 temp___229)))) (= (get m2 temp___229 temp___230) (get temp___228 temp___229 temp___230)))))) (=> (<= 1 10) (in_range5 c3))) (and (<= 1 c3) (<= c3 10))) (and (and (= tmp4 result2) (= tmp5 (to_rep (get m2 5 c3)))) (and (and (and (= (to_rep o10) (to_rep (get m2 7 c3))) (= o11 (set m2 5 c3 o10))) (and (= m2 result3) (= m3 o11))) (and (and (and (= (to_rep o12) tmp5) (= o13 (set m3 7 c3 o12))) (and (= m3 result4) (= m4 o13))) (= c3 10))))))))))) (and (and (= c3 c7) (and (= tmp5 tmp8) (= m4 m7))) (and (= c8 c3) (and (= tmp9 tmp5) (= m8 m4)))))))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= (mk_int__ref c9) (mk_int__ref c7))))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= (mk_int__ref tmp10) (mk_int__ref tmp8))))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= (mk_map__ref m9) (mk_map__ref m7))))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= c10 c8)))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= tmp11 tmp9)))
(assert (=> (and (<= 1 c2) (<= c2 10)) (= m10 m8)))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= c2 c9)))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= (mk_int__ref tmp10) (mk_int__ref tmp))))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= m1 m9)))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= c10 c2)))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= tmp11 tmp2)))
(assert (=> (not (and (<= 1 c2) (<= c2 10))) (= m10 m1)))
(assert (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 10)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (ite (= i13 5) (= (to_rep (get m9 i13 j)) 2) (ite (= i13 7) (= (to_rep (get m9 i13 j)) 1) (= (to_rep (get m9 i13 j)) 0))))))))
(assert (= result6 (mk_map__ref m9)))
(assert (= m11 (temp___236 1 2 0)))
(assert (= m11 c77b))
(assert (=> (<= 0 2147483647) (in_range2 tmp1)))
(assert (= result7 (mk_int__ref c1)))
(assert (= c11 0))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= temp___250 m11)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= temp___247 tmp1)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= temp___244 m11)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= temp___243 c11)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= temp___249 m11)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= temp___248 m11)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= temp___251 m11)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 c12)) (and (= (to_rep (get m12 5 i13)) (to_rep (get temp___248 7 i13))) (= (to_rep (get m12 7 i13)) (to_rep (get temp___249 5 i13))))))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (forall ((i13 Int)) (=> (and (<= (+ c12 1) i13) (<= i13 10)) (and (= (to_rep (get m12 5 i13)) (to_rep (get temp___250 5 i13))) (= (to_rep (get m12 7 i13)) (to_rep (get temp___251 7 i13))))))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (and (and (and (=> (<= 0 9) (in_range6 c12)) (forall ((temp___245 Int) (temp___246 Int)) (=> (and (and (<= 1 temp___245) (<= temp___245 10)) (and (<= 1 temp___246) (<= temp___246 10))) (=> (and (not (= 7 temp___245)) (not (= 5 temp___245))) (= (get m12 temp___245 temp___246) (get temp___244 temp___245 temp___246)))))) (=> (<= 0 2147483647) (in_range2 tmp12))) (and (<= 0 c12) (<= c12 9)))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= result8 (mk_int__ref tmp12))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= tmp13 (to_rep (get m12 5 (+ c12 1))))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= (to_rep o34) (to_rep (get m12 7 (+ c12 1))))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= o35 (set m12 5 (+ c12 1) o34))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= result9 (mk_map__ref m12))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= m13 o35)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= (to_rep o36) tmp13)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= o37 (set m13 7 (+ c12 1) o36))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= result10 (mk_map__ref m13))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= m14 o37)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= c12 9)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= c16 (mk_int__ref c12))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= tmp16 (mk_int__ref tmp13))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= m17 (mk_map__ref m14))))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= c17 c12)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= tmp17 tmp13)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= m18 m14)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= c18 c16)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= tmp18 tmp16)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= m19 m17)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= c19 c17)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= tmp19 tmp17)))
(assert (=> (and (<= 0 c11) (<= c11 9)) (= m20 m18)))
(assert (=> (not (and (<= 0 c11) (<= c11 9))) (= c18 (mk_int__ref c11))))
(assert (=> (not (and (<= 0 c11) (<= c11 9))) (= tmp18 (mk_int__ref tmp1))))
(assert (=> (not (and (<= 0 c11) (<= c11 9))) (= m19 (mk_map__ref m11))))
(assert (=> (not (and (<= 0 c11) (<= c11 9))) (= c19 c11)))
(assert (=> (not (and (<= 0 c11) (<= c11 9))) (= tmp19 tmp3)))
(assert (=> (not (and (<= 0 c11) (<= c11 9))) (= m20 m11)))
(assert (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 10)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (ite (= i13 5) (= (to_rep (get (map__content m19) i13 j)) 2) (ite (= i13 7) (= (to_rep (get (map__content m19) i13 j)) 1) (= (to_rep (get (map__content m19) i13 j)) 0))))))))
(assert (= result12 m19))
(assert (= m21 (temp___254 0)))
(assert (= m21 c96b))
(assert (= result13 (mk_int__ref i)))
(assert (= i4 1))
(assert (<= 1 i4))
(assert (<= i4 10))
(assert (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- i5 1))) (= (to_rep (get m22 k2 k2)) (+ (to_rep (get m21 k2 k2)) 1)))))
(assert (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- i5 1))) (forall ((h1 Int)) (=> (and (<= 1 h1) (<= h1 (- i5 1))) (=> (not (= k2 h1)) (= (to_rep (get m22 k2 h1)) (to_rep (get m21 k2 h1)))))))))
(assert (and (and (forall ((temp___260 Int) (temp___261 Int)) (=> (and (and (<= 1 temp___260) (<= temp___260 10)) (and (<= 1 temp___261) (<= temp___261 10))) (=> (or (<= i5 temp___261) (<= i5 temp___260)) (= (get m22 temp___260 temp___261) (get m21 temp___260 temp___261))))) (=> (<= 1 10) (in_range7 i5))) (and (<= 1 i5) (<= i5 10))))
(assert (and (= o50 (+ (to_rep (get m22 i5 i5)) 1)) (in_range1 (+ (to_rep (get m22 i5 i5)) 1))))
(assert (= (to_rep o51) o50))
(assert (= o52 (set m22 i5 i5 o51)))
(assert (= result14 (mk_map__ref m22)))
(assert (= m23 o52))
(assert (not (= i5 10)))
(assert (= result15 (mk_int__ref i5)))
(assert (= i6 (+ i5 1)))
(assert (= i7 (mk_int__ref i6)))
(assert (= m24 (mk_map__ref m23)))
(assert (= i8 i6))
(assert (= m25 m23))
(declare-const k2 Int)
(assert (<= 1 k2))
(assert (<= k2 (- (int__content i7) 1)))
(assert (not (= (to_rep (get (map__content m24) k2 k2)) (+ (to_rep (get m21 k2 k2)) 1))))
(check-sat)
(exit)
