...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 (- c3 1))) (and (= (to_rep (get m2 5 i6)) (to_rep (get temp___232 7 i6))) (= (to_rep (get m2 7 i6)) (to_rep (get temp___233 5 i6))))))))
(assert (=> (and (<= 1 c2) (<= c2 10)) (and (and (and (forall ((temp___228 Int) (temp___229 Int)) (=> (and (and (<= 1 temp___228) (<= temp___228 10)) (and (<= 1 temp___229) (<= temp___229 10))) (=> (and (or (<= c3 temp___229) (not (= 5 temp___228))) (or (<= c3 temp___229) (not (= 7 temp___228)))) (= (get m2 temp___228 temp___229) (get temp___227 temp___228 temp___229))))) (=> (<= 1 10) (in_range5 c3))) (=> (<= 0 2147483647) (in_range2 tmp4))) (and (<= 1 c3) (<= c3 10)))))
...
(assert (=> (and (<= 1 c2) (<= c2 10)) (= m22 (mk_map__ref m5))))
...
(assert (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 10)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (ite (= i6 5) (= (to_rep (get m7 i6 j)) 2) (ite (= i6 7) (= (to_rep (get m7 i6 j)) 1) (= (to_rep (get m7 i6 j)) 0))))))))
(assert (= result5 m22))
...
(assert (= c8 0))
(assert (=> (and (<= 0 c8) (<= c8 9)) (= temp___251 m9)))
(assert (=> (and (<= 0 c8) (<= c8 9)) (= temp___250 m9)))
(assert (=> (and (<= 0 c8) (<= c8 9)) (= temp___245 m9)))
(assert (=> (and (<= 0 c8) (<= c8 9)) (= temp___244 tmp1)))
(assert (=> (and (<= 0 c8) (<= c8 9)) (= temp___243 c8)))
(assert (=> (and (<= 0 c8) (<= c8 9)) (= temp___249 m9)))
(assert (=> (and (<= 0 c8) (<= c8 9)) (= temp___248 m9)))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 c9)) (and (= (to_rep (get m10 5 i6)) (to_rep (get temp___248 7 i6))) (= (to_rep (get m10 7 i6)) (to_rep (get temp___249 5 i6))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i6 Int)) (=> (and (<= (+ c9 1) i6) (<= i6 10)) (and (= (to_rep (get m10 5 i6)) (to_rep (get temp___250 5 i6))) (= (to_rep (get m10 7 i6)) (to_rep (get temp___251 7 i6))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (and (and (and (=> (<= 0 9) (in_range6 c9)) (=> (<= 0 2147483647) (in_range2 tmp10))) (forall ((temp___246 Int) (temp___247 Int)) (=> (and (and (<= 1 temp___246) (<= temp___246 10)) (and (<= 1 temp___247) (<= temp___247 10))) (=> (and (not (= 7 temp___246)) (not (= 5 temp___246))) (= (get m10 temp___246 temp___247) (get temp___245 temp___246 temp___247)))))) (and (<= 0 c9) (<= c9 9)))))
...
(assert (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 10)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (ite (= i6 5) (= (to_rep (get (map__content m15) i6 j)) 2) (ite (= i6 7) (= (to_rep (get (map__content m15) i6 j)) 1) (= (to_rep (get (map__content m15) i6 j)) 0))))))))
(assert (= result10 m15))
(assert (= m17 (temp___254 0)))
(assert (= m17 c96b))
(assert (= result11 (mk_int__ref i)))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i2 1))) (= (to_rep (get m18 k k)) (+ (to_rep (get m17 k k)) 1)))))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i2 1))) (forall ((h Int)) (=> (and (<= 1 h) (<= h (- i2 1))) (=> (not (= k h)) (= (to_rep (get m18 k h)) (to_rep (get m17 k h)))))))))
(assert (and (and (=> (<= 1 10) (in_range7 i2)) (forall ((temp___261 Int) (temp___262 Int)) (=> (and (and (<= 1 temp___261) (<= temp___261 10)) (and (<= 1 temp___262) (<= temp___262 10))) (=> (or (<= i2 temp___262) (<= i2 temp___261)) (= (get m18 temp___261 temp___262) (get m17 temp___261 temp___262)))))) (and (<= 1 i2) (<= i2 10))))
(assert (and (= o8 (+ (to_rep (get m18 i2 i2)) 1)) (in_range1 (+ (to_rep (get m18 i2 i2)) 1))))
(assert (= (to_rep o9) o8))
(assert (= o10 (set m18 i2 i2 o9)))
(assert (= result12 (mk_map__ref m18)))
(assert (= m19 o10))
(assert (not (= i2 10)))
(assert (= result13 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (= i4 (mk_int__ref i3)))
(assert (= m20 (mk_map__ref m19)))
(assert (= i5 i3))
(assert (= m21 m19))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k (- (int__content i4) 1)))
(assert (not (= (to_rep (get (map__content m20) k k)) (+ (to_rep (get m17 k k)) 1))))
(check-sat)
(exit)
