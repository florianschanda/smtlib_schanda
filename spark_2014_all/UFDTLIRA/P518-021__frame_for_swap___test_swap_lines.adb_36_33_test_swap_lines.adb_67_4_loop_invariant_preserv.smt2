...
(assert (=> (and (<= 1 c2) (<= c2 10)) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 (- c3 1))) (and (= (to_rep (get m2 5 i6)) (to_rep (get temp___267 7 i6))) (= (to_rep (get m2 7 i6)) (to_rep (get temp___268 5 i6))))))))
...
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 c9)) (and (= (to_rep (get m10 5 i6)) (to_rep (get temp___283 7 i6))) (= (to_rep (get m10 7 i6)) (to_rep (get temp___284 5 i6))))))))
(assert (=> (and (<= 0 c8) (<= c8 9)) (forall ((i6 Int)) (=> (and (<= (+ c9 1) i6) (<= i6 10)) (and (= (to_rep (get m10 5 i6)) (to_rep (get temp___285 5 i6))) (= (to_rep (get m10 7 i6)) (to_rep (get temp___286 7 i6))))))))
