...
(define-fun o12 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___499 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___499)) no_element))
(assert (and (= o12 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o12 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o12) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o12) 1)))))
...
(assert (and (= o11 (get o9 o10)) (in_range4 o11)))
