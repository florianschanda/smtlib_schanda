...
(declare-fun user_eq4 (tname_idB tname_idB) Bool)
(declare-const dummy4 tname_idB)
...
(assert (and (= o2 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range1 o2) (= o2 (ite (= (distinct 0 0) true) (to_rep (rec__names__entry_tables__vector__capacity container__split_discrs)) 2147483647)))))
