...
(define-fun o20 () us_rep (mk___rep (mk___split_discrs o2) (mk___split_fields o3)))
(define-fun o21 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields o1)))
...
(assert (= o5 o4))
(assert (= o6 o5))
(assert (and (= o21 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000)) (and (= (oeq1 (model__ o21) (model__ (rec__amortized_queue__queue__front (us_split_fields3 q)))) true) (ite (= 1000 0) (= (to_rep o) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) (= (to_rep o) 1000)))))
(assert (= o20 o21))
(assert (= o7 o20))
