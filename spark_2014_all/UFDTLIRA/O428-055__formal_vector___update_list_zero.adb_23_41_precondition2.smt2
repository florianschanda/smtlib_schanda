...
(assert (and (= result1 (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields3))) (= (= result1 true) (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 cu__split_fields3)) true))))
(assert (= result1 true))
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields1)) (mk___rep1 cu__split_fields2)) 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i1) (ite (<= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1) threshold) 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1))))))
(assert (forall ((i1 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields1)) (mk___rep1 cu__split_fields2)) i1) (<= i1 (length (mk___rep l__split_discrs l__split_fields1)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i1) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1)))))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields1)) (mk___rep1 cu__split_fields2)) true))
(assert (and (= o2 (length (mk___rep l__split_discrs l__split_fields1))) (and (in_range1 o2) (<= o2 (to_rep (rec__loop_types__lists__list__capacity l__split_discrs))))))
(assert (= o3 (ite (<= i o2) true false)))
(assert (and (= o (positions (mk___rep l__split_discrs l__split_fields1))) (and (not (= (has_key o no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length (mk___rep l__split_discrs l__split_fields1)))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields2))) (and (in_range4 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields2)))) (forall ((k us_rep2)) (=> (= (has_key o k) true) (= (= (bool_eq2 k (mk___rep1 cu__split_fields2)) true) (= (witness o (mk___rep1 cu__split_fields2)) (witness o k))))))))))
