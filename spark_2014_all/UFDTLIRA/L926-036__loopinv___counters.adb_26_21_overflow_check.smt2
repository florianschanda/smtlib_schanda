...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__counters__counter__mode (us_split_discrs1 a))) (to_rep2 (rec__counters__counter__mode (us_split_discrs1 b)))) (= (to_rep1 (rec__counters__counter__ticks (us_split_discrs1 a))) (to_rep1 (rec__counters__counter__ticks (us_split_discrs1 b))))) (= (to_rep (rec__counters__counter__c (us_split_fields1 a))) (to_rep (rec__counters__counter__c (us_split_fields1 b))))) (= (to_rep1 (rec__counters__counter__t (us_split_fields1 a))) (to_rep1 (rec__counters__counter__t (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 4)) (in_range2 temp___expr_135)))
...
(declare-const temp___168 change_mode)
(declare-const temp___1681 natural)
(declare-const temp___1682 integer)
(declare-const temp___1683 natural)
...
(assert (= c__split_discrs (mk___split_discrs temp___168 temp___1681)))
(assert (not (= (to_rep2 (rec__counters__counter__mode c__split_discrs)) 0)))
(assert (not (= (to_rep2 (rec__counters__counter__mode c__split_discrs)) 1)))
(assert (= (to_rep2 (rec__counters__counter__mode c__split_discrs)) 3))
