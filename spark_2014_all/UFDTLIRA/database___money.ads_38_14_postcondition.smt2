...
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 1000000)) (in_range2 temp___expr_147)))
(declare-const money__Osubtract__result cur)
(declare-const money__Osubtract__result1 raw_amount)
(declare-const o Int)
(declare-const o1 raw_amount)
(declare-const o2 cur)
(declare-const o3 raw_amount)
(declare-const o4 cur)
(declare-const o5 raw_amount)
(declare-const result cur)
(declare-const result1 raw_amount)
(declare-const money__Osubtract__result2 cur)
(declare-const money__Osubtract__result3 raw_amount)
(declare-const money__Osubtract__result4 cur)
(declare-const money__Osubtract__result5 raw_amount)
(declare-const money__Osubtract__result6 cur)
(declare-const money__Osubtract__result7 raw_amount)
(declare-const money__Osubtract__result8 cur)
(declare-const money__Osubtract__result9 raw_amount)
(declare-const money__Osubtract__result10 cur)
(declare-const money__Osubtract__result11 raw_amount)
(define-fun money__Osubtract__result12 () us_rep (mk___rep (mk___split_fields money__Osubtract__result2 money__Osubtract__result3)))
(declare-const result2 cur)
(declare-const result3 raw_amount)
...
(assert (= money__Osubtract__result4 money__Osubtract__result2))
(assert (= money__Osubtract__result5 money__Osubtract__result3))
(assert (= (mk___rep (mk___split_fields money__Osubtract__result6 money__Osubtract__result7)) money__Osubtract__result12))
(assert (and (= o (- (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1 (rec__money__amount__raw (us_split_fields1 b))))) (in_range2 (- (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1 (rec__money__amount__raw (us_split_fields1 b)))))))
(assert (= (to_rep1 o1) o))
(assert (= (rec__money__amount__currency (us_split_fields1 a)) o2))
(assert (= o1 o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= result money__Osubtract__result))
(assert (= result1 money__Osubtract__result1))
(assert (= money__Osubtract__result12 (mk___rep (mk___split_fields o4 o5))))
(assert (= (mk_amount__ref (mk___rep (mk___split_fields money__Osubtract__result8 money__Osubtract__result9))) (mk_amount__ref (mk___rep (mk___split_fields money__Osubtract__result4 money__Osubtract__result5)))))
(assert (= money__Osubtract__result10 money__Osubtract__result6))
(assert (= money__Osubtract__result11 money__Osubtract__result7))
(assert (= result2 money__Osubtract__result8))
(assert (= result3 money__Osubtract__result9))
(assert (not (= (bool_eq (mk___rep (mk___split_fields money__Osubtract__result8 money__Osubtract__result9)) (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 a)) (of_rep1 (- (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1 (rec__money__amount__raw (us_split_fields1 b)))))))) true)))
(check-sat)
(exit)
