...
(assert (= (= temp___2101 true) (< 3 (to_rep temp___210))))
(assert (= (mk___rep (mk___split_fields temp___211 temp___2111)) (mk___rep (mk___split_fields temp___210 temp___2101))))
(assert (= result var__split_fields))
(assert (= result1 var__split_fields1))
(assert (= temp___211 var__split_fields2))
(assert (= temp___2111 var__split_fields3))
