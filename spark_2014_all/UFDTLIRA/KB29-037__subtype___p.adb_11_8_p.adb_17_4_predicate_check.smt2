...
(define-fun dynamic_invariant ((temp___expr_171 us_rep) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (= temp___do_toplevel_170 true) (=> (= temp___is_init_168 true) (= (= (rec__p__t__locked (us_split_fields1 temp___expr_171)) true) (< 3 (to_rep (rec__p__t__access_count (us_split_fields1 temp___expr_171))))))))
(define-fun default_initial_assumption ((temp___expr_173 us_rep) (temp___skip_top_level_174 Bool)) Bool (and (= (to_rep (rec__p__t__access_count (us_split_fields1 temp___expr_173))) 0) (= (rec__p__t__locked (us_split_fields1 temp___expr_173)) (of_int 0))))
(define-fun dynamic_predicate ((temp___175 us_rep)) Bool (= (= (rec__p__t__locked (us_split_fields1 temp___175)) true) (< 3 (to_rep (rec__p__t__access_count (us_split_fields1 temp___175))))))
...
(declare-const temp___1781 Bool)
(declare-const o Int)
...
(assert (and (= (to_rep var__split_fields) 0) (= var__split_fields1 (of_int 0))))
...
(assert (= (mk___rep (mk___split_fields temp___182 temp___1821)) (mk___rep (mk___split_fields temp___181 temp___1811))))
...
(assert (not (< 3 (to_rep var__split_fields2))))
(check-sat)
(exit)
