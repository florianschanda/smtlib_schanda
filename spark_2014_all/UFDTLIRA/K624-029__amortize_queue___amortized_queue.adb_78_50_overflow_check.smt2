...
(assert (and (= o7 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o6)) (and (in_range5 o7) (= o7 (get (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))) o6)))))
