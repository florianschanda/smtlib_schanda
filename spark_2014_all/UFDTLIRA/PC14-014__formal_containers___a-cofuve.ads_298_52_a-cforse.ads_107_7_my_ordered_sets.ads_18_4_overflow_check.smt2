...
(define-fun dynamic_invariant ((temp___expr_621 Int) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool (=> (or (= temp___is_init_617 true) (<= 1 2147483647)) (in_range1 temp___expr_621)))
...
(define-fun dynamic_invariant2 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= 0 2147483647)) (in_range6 temp___expr_637)))
...
(assert (and (= o2 (length container)) (and (in_range5 o2) (<= (+ 0 o2) 2147483647))))
(assert (= result (ite (< o2 2147483647) true false)))
(assert (= result true))
(assert (and (= o1 (last container)) (and (in_range6 o1) (= o1 (+ 0 (length container))))))
(assert (= result1 (ite (< o1 2147483647) true false)))
(assert (= result1 true))
(assert (and (= o (last container)) (and (in_range6 o) (= o (+ 0 (length container))))))
