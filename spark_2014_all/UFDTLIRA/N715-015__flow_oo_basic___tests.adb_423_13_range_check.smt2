...
(define-fun y__split_fields6 () us_split_fields2 (mk___split_fields1 y__split_fields3 y__split_fields4 y__split_fields5))
(assert (in_range a))
...
(assert (= y__split_fields6 (us_split_fields3 (of_base (mk___rep (mk___split_fields (hide_ext__1 x__split_fields4 x__split_fields5 x__split_fields6 x__split_fields7)) x__attr__tag)))))
...
(assert (and (= o8 (hash__21 y__attr__tag (mk___rep1 y__split_fields6 y__attr__tag))) (in_range1 o8)))
