...
(define-fun dynamic_invariant1 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool) (dyn_bounds__L_1__i Int)) Bool (=> (or (= temp___is_init_154 true) (<= 0 (last dyn_bounds__L_1__i))) (dynamic_property1 0 (last dyn_bounds__L_1__i) temp___expr_158)))
...
(assert (and (= temp___170 (+ c1 1)) (in_range (+ c1 1))))
(assert (and (= us temp___170) (dynamic_property1 0 (last i) temp___170)))
(assert (= o temp___170))
