...
(assert (forall ((segway__status Int)) (! (=> (dynamic_invariant segway__status true true true) (dynamic_invariant (current_status segway__status) true false true)) :pattern ((current_status segway__status)))))
(assert (forall ((segway__status Int)) (! (=> (dynamic_invariant segway__status true true true) (= (current_status segway__status) segway__status)) :pattern ((current_status segway__status)))))
...
(assert (forall ((segway__speed Int)) (! (=> (dynamic_invariant1 segway__speed true true true) (dynamic_invariant1 (current_speed segway__speed) true false true)) :pattern ((current_speed segway__speed)))))
(assert (forall ((segway__speed Int)) (! (=> (dynamic_invariant1 segway__speed true true true) (= (current_speed segway__speed) segway__speed)) :pattern ((current_speed segway__speed)))))
...
(assert (not (= status 0)))
(assert (= (speed_is_valid speed2 status2) true))
(assert (and (and (in_range2 speed2) (in_range1 status2)) (not (= status2 0))))
(assert (not (< 0 speed2)))
(assert (not (= (speed_is_valid speed2 status2) true)))
(check-sat)
(exit)
