...
(assert (forall ((x tt1B)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun t1__ref___projection ((a t1__ref)) tt1B (t1__content a))
(declare-sort tt2B 0)
...
(assert (forall ((x tt2B)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun t2__ref___projection ((a t2__ref)) tt2B (t2__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 last)) (dynamic_property 0 last temp___expr_135)))
(assert (= last c1))
(define-fun dynamic_invariant3 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 last1)) (dynamic_property1 0 last1 temp___expr_141)))
(assert (= last1 c2))
(declare-const a Int)
(declare-const b Int)
(assert (in_range1 a))
