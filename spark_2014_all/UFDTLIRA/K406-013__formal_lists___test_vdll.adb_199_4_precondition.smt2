...
(assert (not (<= (length (mk___rep l1__split_discrs (us_split_fields__content l1__split_fields12))) (to_rep (rec__formal_container__vdll__list__capacity l2__split_discrs)))))
(check-sat)
(exit)
