...
(declare-const temp___6774 et3)
(declare-const temp___67741 et1)
(declare-const temp___67742 et2)
(declare-const temp___67743 enum1ta)
...
(declare-const temp___6777 us_rep1)
...
(assert (= temp___6774 o6))
(assert (= temp___67741 o7))
(assert (= temp___67742 o8))
(assert (= temp___67743 o9))
...
(assert (= r__split_fields4 (mk___split_fields1 temp___6774 (mk___rep (mk___split_fields temp___67741 temp___67742)) temp___67743)))
...
(assert (= temp___6777 (mk___rep1 (mk___split_fields1 o15 (mk___rep (mk___split_fields o16 o17)) o18))))
(assert (= result2 (mk___split_fields__ref1 r__split_fields4)))
(assert (= r__split_fields5 (us_split_fields3 temp___6777)))
...
(assert (not (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields__content1 r__split_fields6))))) (to_rep1 r__split_fields2))))
(check-sat)
(exit)
