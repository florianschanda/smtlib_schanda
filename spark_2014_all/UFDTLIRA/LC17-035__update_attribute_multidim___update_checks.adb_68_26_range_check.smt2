...
(declare-fun temp_____aggregate_def_299 (map1 Int Int Int Int Int Int Int) map1)
(assert (forall ((temp___301 map1)) (forall ((temp___302 Int) (temp___303 Int) (temp___304 Int) (temp___305 Int) (temp___306 Int) (temp___307 Int) (temp___308 Int)) (let ((temp___300 (temp_____aggregate_def_299 temp___301 temp___302 temp___303 temp___304 temp___305 temp___306 temp___307 temp___308))) (=> (and (and (and (and (and (and (dynamic_invariant temp___302 true true true true) (dynamic_invariant1 temp___303 true true true true)) (dynamic_invariant2 temp___304 true true true true)) (dynamic_invariant temp___305 true true true true)) (dynamic_invariant1 temp___306 true true true true)) (dynamic_invariant2 temp___307 true true true true)) (dynamic_invariant3 temp___308 true true true true)) (forall ((temp___309 Int) (temp___310 Int) (temp___311 Int)) (ite (or (and (and (= temp___309 temp___302) (= temp___310 temp___303)) (= temp___311 temp___304)) (and (and (= temp___309 temp___305) (= temp___310 temp___306)) (= temp___311 temp___307))) (= (to_rep (get temp___300 temp___309 temp___310 temp___311)) temp___308) (= (get temp___300 temp___309 temp___310 temp___311) (get temp___301 temp___309 temp___310 temp___311)))))))))
(declare-const o Int)
...
(assert (and (= o1 (+ z2 1)) (in_range2 (+ z2 1))))
(assert (and (= o2 (+ y2 1)) (in_range1 (+ y2 1))))
(assert (and (= o3 (+ x2 1)) (in_range (+ x2 1))))
(assert (and (= o4 (- z1 1)) (in_range2 (- z1 1))))
(assert (and (= o5 (- y1 1)) (in_range1 (- y1 1))))
