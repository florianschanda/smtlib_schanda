...
(define-fun dynamic_invariant ((temp___expr_1467 us_rep1) (temp___is_init_1464 Bool) (temp___skip_constant_1465 Bool) (temp___do_toplevel_1466 Bool)) Bool (=> (not (= temp___skip_constant_1465 true)) (in_range2 12 (to_base temp___expr_1467))))
