...
(define-fun dynamic_invariant4 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_413)))
...
(assert (forall ((new_item1 Int) (length3 Int)) (! (=> (and (dynamic_invariant4 new_item1 true true true true) (dynamic_invariant3 length3 true true true true)) (let ((result (to_vector new_item1 length3))) (and (= (length1 result) length3) (= (constant_range (model__ result) 1 (last_index result) new_item1) true)))) :pattern ((to_vector new_item1 length3)))))
...
(define-fun dynamic_invariant6 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 2147483647)) (in_range8 temp___expr_420)))
...
(define-fun default_initial_assumption ((temp___expr_453 us_rep2) (temp___skip_top_level_454 Bool)) Bool (=> (not (= temp___skip_top_level_454 true)) (= (length2 temp___expr_453) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_445 Int) (temp___is_init_441 Bool) (temp___skip_constant_442 Bool) (temp___do_toplevel_443 Bool) (temp___do_typ_inv_444 Bool)) Bool (=> (or (= temp___is_init_441 true) (<= 0 2147483647)) (in_range10 temp___expr_445)))
(assert (forall ((container us_rep2)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_438 Int) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool) (temp___do_typ_inv_437 Bool)) Bool (=> (or (= temp___is_init_434 true) (<= (- 2147483648) 2147483647)) (in_range11 temp___expr_438)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant8 (get container position) true false true true)) :pattern ((get container position))))))
...
(assert (and (= o2 (to_vector new_item length)) (and (= (length1 o2) length) (= (constant_range (model__ o2) 1 (last (model__ o2)) new_item) true))))
