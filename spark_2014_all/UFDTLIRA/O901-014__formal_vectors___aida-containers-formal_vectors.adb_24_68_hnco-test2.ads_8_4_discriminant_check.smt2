...
(define-fun dynamic_invariant4 ((temp___expr_371 Int) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool)) Bool (=> (or (= temp___is_init_368 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_371)))
...
(define-fun constant_range ((container us_rep2) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (get container i) item))) true false))
...
(assert (forall ((new_item1 Int) (length3 Int)) (! (=> (and (dynamic_invariant4 new_item1 true true true) (dynamic_invariant3 length3 true true true)) (let ((result (to_vector new_item1 length3))) (and (= (length1 result) length3) (= (constant_range (model__ result) 1 (last_index result) new_item1) true)))) :pattern ((to_vector new_item1 length3)))))
...
(define-fun us_split_fields_Hidden_Vector__5__projection ((a us_split_fields4)) us_rep (rec__hnco__test2__v_type_owner__vector_type__hidden_vector1 a))
(define-fun us_split_fields___5__projection ((a us_split_fields4)) us_private (rec__ext__1 a))
...
(define-fun us_rep___15__projection ((a us_rep3)) us_split_discrs2 (us_split_discrs4 a))
(define-fun us_rep___16__projection ((a us_rep3)) us_split_fields4 (us_split_fields5 a))
...
(declare-datatypes () ((t202s__ref (mk_t202s__ref (t202s__content us_rep3)))))
(define-fun t202s__ref___projection ((a t202s__ref)) us_rep3 (t202s__content a))
...
(define-fun dynamic_invariant6 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 2147483647)) (in_range8 temp___expr_377)))
...
(define-fun oeq ((left us_rep2) (right us_rep2)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun default_initial_assumption ((temp___expr_406 us_rep2) (temp___skip_top_level_407 Bool)) Bool (=> (not (= temp___skip_top_level_407 true)) (= (length2 temp___expr_406) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 0 2147483647)) (in_range10 temp___expr_399)))
(assert (forall ((container us_rep2)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant5 result true false true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_393 Int) (temp___is_init_390 Bool) (temp___skip_constant_391 Bool) (temp___do_toplevel_392 Bool)) Bool (=> (or (= temp___is_init_390 true) (<= (- 2147483648) 2147483647)) (in_range11 temp___expr_393)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant7 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant8 (get container position) true false true)) :pattern ((get container position))))))
...
(assert (and (= (mk___rep (mk___split_discrs o) (mk___split_fields o1)) (to_vector new_item length)) (and (= (length1 (mk___rep (mk___split_discrs o) (mk___split_fields o1))) length) (= (constant_range (model__ (mk___rep (mk___split_discrs o) (mk___split_fields o1))) 1 (last (model__ (mk___rep (mk___split_discrs o) (mk___split_fields o1)))) new_item) true))))
(assert (not (= length (to_rep1 o))))
(check-sat)
(exit)
