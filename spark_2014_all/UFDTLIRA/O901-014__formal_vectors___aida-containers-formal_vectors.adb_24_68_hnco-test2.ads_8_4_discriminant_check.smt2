...
(assert (forall ((new_item Int) (length2 Int)) (! (=> (and (dynamic_invariant1 new_item true true true true) (dynamic_invariant length2 true true true true)) (let ((result (to_vector new_item length2))) (and (= (length result) length2) (= (constant_range (model__ result) 1 (last_index result) new_item) true)))) :pattern ((to_vector new_item length2)))))
...
(define-fun dynamic_invariant4 ((temp___expr_269 us_rep1) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (in_range2 (to_rep1 (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 temp___expr_269))) (rec__hnco__test2__v_type_owner__vector_type__hidden_vector (us_split_fields3 temp___expr_269))))
...
(assert (in_range length2))
(assert (and (= o2 (to_vector new_item length2)) (and (= (length o2) length2) (= (constant_range (model__ o2) 1 (last (model__ o2)) new_item) true))))
(assert (not (= length2 (to_rep o))))
(check-sat)
(exit)
