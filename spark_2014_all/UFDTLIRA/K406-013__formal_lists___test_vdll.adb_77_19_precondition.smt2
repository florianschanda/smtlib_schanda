...
(assert (and (= o36 (next (mk___rep l3__split_discrs l3__split_fields2) o35)) (ite (= (ite (= (bool_eq1 o35 no_element) false) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o35) (length (mk___rep l3__split_discrs l3__split_fields2))) true) true) (= (bool_eq1 o36 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o36) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o36) (+ (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o35) 1))))))
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o36) true)))
(check-sat)
(exit)
