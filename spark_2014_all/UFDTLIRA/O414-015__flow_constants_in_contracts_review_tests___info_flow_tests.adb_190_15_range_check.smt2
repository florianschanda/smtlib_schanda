...
(define-fun dynamic_invariant2 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= first last)) (dynamic_property first last temp___expr_189)))
(assert (= first a))
(assert (= last a))
(assert (in_range1 a))
(assert (in_range1 b))
