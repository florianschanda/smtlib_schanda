...
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___944 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___944) (mk___split_fields temp___9441 temp___9442 temp___9443 temp___9444) temp___9445))))
...
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___9461 temp___9462 temp___9463 temp___9464))))
(assert (=> (= kind 1) (= result1 t__split_discrs5)))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___946))))
...
(assert (=> (not (= kind 1)) (=> (= t__attr__constrained true) (= temp___947 t__split_discrs))))
(assert (=> (not (= kind 1)) (= usq_6 (mk___rep (mk___split_discrs temp___947) (mk___split_fields temp___9471 temp___9472 temp___9473 temp___9474) temp___9475))))
(assert (=> (not (= kind 1)) (= temp___949 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained))))
(assert (=> (not (= kind 1)) (= result2 t__split_fields8)))
(assert (=> (not (= kind 1)) (= t__split_fields5 (us_split_fields1 temp___949))))
(assert (=> (not (= kind 1)) (= result3 t__split_discrs5)))
(assert (=> (not (= kind 1)) (= t__split_discrs2 (us_split_discrs1 temp___949))))
