...
(assert (=> (= kind 1) (= o o8)))
(assert (=> (= kind 1) (= temp___1030 o8)))
(assert (=> (= kind 1) (= temp___10301 o4)))
(assert (=> (= kind 1) (= temp___10302 o5)))
(assert (=> (= kind 1) (= temp___10303 o6)))
(assert (=> (= kind 1) (= temp___10304 o7)))
(assert (=> (= kind 1) (= true temp___10305)))
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___1030 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___1030) (mk___split_fields temp___10301 temp___10302 temp___10303 temp___10304) temp___10305))))
(assert (=> (= kind 1) (= usq_ temp___1032)))
(assert (=> (= kind 1) (= usq_1 temp___10321)))
(assert (=> (= kind 1) (= usq_2 temp___10322)))
(assert (=> (= kind 1) (= usq_3 temp___10323)))
(assert (=> (= kind 1) (= usq_4 temp___10324)))
(assert (=> (= kind 1) (= t__attr__constrained temp___10325)))
(assert (=> (= kind 1) (= result t__split_fields8)))
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___10321 temp___10322 temp___10323 temp___10324))))
(assert (=> (= kind 1) (= result1 t__split_discrs5)))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___1032))))
...
(assert (=> (not (= kind 1)) (= temp___1033 o17)))
(assert (=> (not (= kind 1)) (= temp___10331 o13)))
(assert (=> (not (= kind 1)) (= temp___10332 o14)))
(assert (=> (not (= kind 1)) (= temp___10333 o15)))
(assert (=> (not (= kind 1)) (= temp___10334 o16)))
(assert (=> (not (= kind 1)) (= true temp___10335)))
(assert (=> (not (= kind 1)) (=> (= t__attr__constrained true) (= temp___1033 t__split_discrs))))
(assert (=> (not (= kind 1)) (= usq_6 (mk___rep (mk___split_discrs temp___1033) (mk___split_fields temp___10331 temp___10332 temp___10333 temp___10334) temp___10335))))
(assert (=> (not (= kind 1)) (= temp___1035 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained))))
(assert (=> (not (= kind 1)) (= result2 t__split_fields8)))
(assert (=> (not (= kind 1)) (= t__split_fields5 (us_split_fields1 temp___1035))))
(assert (=> (not (= kind 1)) (= result3 t__split_discrs5)))
(assert (=> (not (= kind 1)) (= t__split_discrs2 (us_split_discrs1 temp___1035))))
