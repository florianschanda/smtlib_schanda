...
(assert (=> (= kind 1) (= o o8)))
(assert (=> (= kind 1) (= temp___934 o8)))
(assert (=> (= kind 1) (= temp___9341 o4)))
(assert (=> (= kind 1) (= temp___9342 o5)))
(assert (=> (= kind 1) (= temp___9343 o6)))
(assert (=> (= kind 1) (= temp___9344 o7)))
(assert (=> (= kind 1) (= true temp___9345)))
(assert (=> (= kind 1) (=> (= t__attr__constrained true) (= temp___934 t__split_discrs))))
(assert (=> (= kind 1) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___934) (mk___split_fields temp___9341 temp___9342 temp___9343 temp___9344) temp___9345))))
(assert (=> (= kind 1) (= usq_ temp___936)))
(assert (=> (= kind 1) (= usq_1 temp___9361)))
(assert (=> (= kind 1) (= usq_2 temp___9362)))
(assert (=> (= kind 1) (= usq_3 temp___9363)))
(assert (=> (= kind 1) (= usq_4 temp___9364)))
(assert (=> (= kind 1) (= t__attr__constrained temp___9365)))
...
(assert (=> (= kind 1) (= t__split_fields4 (mk___split_fields temp___9361 temp___9362 temp___9363 temp___9364))))
(assert (=> (= kind 1) (= result1 (mk___split_discrs__ref (mk___split_discrs t__split_discrs)))))
(assert (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___936))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= (to_rep1 t__split_discrs) r22b))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (in_range3 r22b))))
...
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___937 o17))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9371 o13))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9372 o14))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9373 o15))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___9374 o16))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= true temp___9375))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (=> (= t__attr__constrained true) (= temp___937 t__split_discrs)))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= usq_6 (mk___rep (mk___split_discrs temp___937) (mk___split_fields temp___9371 temp___9372 temp___9373 temp___9374) temp___9375)))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= temp___939 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained)))))
...
(assert (=> (not (= kind 1)) (=> (= kind 2) (= t__split_fields5 (us_split_fields1 temp___939)))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= result3 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))))))
(assert (=> (not (= kind 1)) (=> (= kind 2) (= t__split_discrs2 (us_split_discrs1 temp___939)))))
