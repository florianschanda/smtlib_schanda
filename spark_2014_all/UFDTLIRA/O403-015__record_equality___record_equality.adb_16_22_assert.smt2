...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 a))) (to_rep (rec__record_equality__root__c (us_split_discrs2 b)))) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 a))) (to_rep (rec__record_equality__child__f2 (us_split_fields3 b))))) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 a))) (to_rep (rec__record_equality__root__f11 (us_split_fields3 b))))) true false))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs3 a))) (to_rep (rec__record_equality__root__c (us_split_discrs3 b)))) (= (to_rep (rec__record_equality__grandchild__f3 (us_split_fields5 a))) (to_rep (rec__record_equality__grandchild__f3 (us_split_fields5 b))))) (= (to_rep (rec__record_equality__root__f12 (us_split_fields5 a))) (to_rep (rec__record_equality__root__f12 (us_split_fields5 b))))) (= (to_rep (rec__record_equality__child__f21 (us_split_fields5 a))) (to_rep (rec__record_equality__child__f21 (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_165 us_rep) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool (=> (not (= temp___skip_constant_163 true)) (in_range2 0 temp___expr_165)))
(define-fun default_initial_assumption ((temp___expr_167 us_rep) (temp___skip_top_level_168 Bool)) Bool (and (= (attr__tag temp___expr_167) us_tag3) (and (= (to_rep (rec__record_equality__root__c (us_split_discrs1 temp___expr_167))) 0) (= (to_rep (rec__record_equality__root__f1 (us_split_fields1 temp___expr_167))) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_173 us_rep1) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (not (= temp___skip_constant_171 true)) (in_range3 0 (to_base temp___expr_173))))
(define-fun default_initial_assumption1 ((temp___expr_175 us_rep1) (temp___skip_top_level_176 Bool)) Bool (and (= (attr__tag1 temp___expr_175) us_tag4) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_175))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_175))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_175))) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_181 us_rep) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (in_range4 0 temp___expr_181)))
(define-fun default_initial_assumption2 ((temp___expr_183 us_rep) (temp___skip_top_level_184 Bool)) Bool (and (= (attr__tag temp___expr_183) us_tag5) (and (= (to_rep (rec__record_equality__root__c (us_split_discrs1 temp___expr_183))) 0) (= (to_rep (rec__record_equality__root__f1 (us_split_fields1 temp___expr_183))) 0))))
...
(define-fun dynamic_invariant4 ((temp___expr_189 us_rep1) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (not (= temp___skip_constant_187 true)) (in_range5 0 (to_base temp___expr_189))))
(define-fun default_initial_assumption3 ((temp___expr_191 us_rep1) (temp___skip_top_level_192 Bool)) Bool (and (= (attr__tag1 temp___expr_191) us_tag6) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_191))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_191))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_191))) 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_197 us_rep1) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (=> (not (= temp___skip_constant_195 true)) (in_range8 0 (to_base temp___expr_197))))
(define-fun default_initial_assumption4 ((temp___expr_199 us_rep1) (temp___skip_top_level_200 Bool)) Bool (and (= (attr__tag1 temp___expr_199) us_tag9) (and (and (= (to_rep (rec__record_equality__root__c (us_split_discrs2 temp___expr_199))) 0) (= (to_rep (rec__record_equality__root__f11 (us_split_fields3 temp___expr_199))) 0)) (= (to_rep (rec__record_equality__child__f2 (us_split_fields3 temp___expr_199))) 0))))
...
(assert (and (= r_pu1__attr__tag us_tag5) (and (= (to_rep (rec__record_equality__root__c r_pu1__split_discrs)) 0) (= (to_rep r_pu1__split_fields) 0))))
(assert (= 0 (to_rep (rec__record_equality__root__c r_pu1__split_discrs))))
(assert (and (= r_pu2__attr__tag us_tag3) (and (= (to_rep (rec__record_equality__root__c r_pu2__split_discrs)) 0) (= (to_rep r_pu2__split_fields) 0))))
(assert (= 0 (to_rep (rec__record_equality__root__c r_pu2__split_discrs))))
(assert (and (= us1 0) (in_range1 0)))
(assert (and (= c_pu1__attr__tag us_tag6) (and (and (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) 0) (= (to_rep c_pu1__split_fields1) 0)) (= (to_rep c_pu1__split_fields) 0))))
(assert (= 0 (to_rep (rec__record_equality__root__c c_pu1__split_discrs))))
(assert (and (= c_pu2__attr__tag us_tag4) (and (and (= (to_rep (rec__record_equality__root__c c_pu2__split_discrs)) 0) (= (to_rep c_pu2__split_fields1) 0)) (= (to_rep c_pu2__split_fields) 0))))
(assert (= 0 (to_rep (rec__record_equality__root__c c_pu2__split_discrs))))
(assert (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r2b))
...
(assert (= c_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ok__g_pu1__assume)))
...
(assert (= g_pu1__split_fields4 (mk___split_fields2 record_equality__test_eq_ok__g_pu1__assume1 record_equality__test_eq_ok__g_pu1__assume2 record_equality__test_eq_ok__g_pu1__assume3 record_equality__test_eq_ok__g_pu1__assume4)))
(assert (= g_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ok__g_pu1__assume)))
(assert (= g_pu1__attr__tag us_tag2))
(assert (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r4b))
...
(assert (= c_pu1__split_discrs (mk___split_discrs record_equality__test_eq_ok__g_pu2__assume)))
...
(assert (= result4 (mk___split_fields__ref2 (mk___split_fields2 g_pu2__split_fields g_pu2__split_fields1 g_pu2__split_fields2 g_pu2__split_fields3))))
(assert (= g_pu2__split_fields4 (mk___split_fields2 record_equality__test_eq_ok__g_pu2__assume1 record_equality__test_eq_ok__g_pu2__assume2 record_equality__test_eq_ok__g_pu2__assume3 record_equality__test_eq_ok__g_pu2__assume4)))
(assert (= g_pu2__split_discrs (mk___split_discrs record_equality__test_eq_ok__g_pu2__assume)))
(assert (= g_pu2__attr__tag us_tag2))
(assert (= (mk___rep1 (us_split_discrs2 (of_base (mk___rep g_pu1__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu1__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu1__split_fields4) (rec__record_equality__child__f21 g_pu1__split_fields4) (rec__ext__2 g_pu1__split_fields4))) g_pu1__attr__tag))) (us_split_fields3 (of_base (mk___rep g_pu1__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu1__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu1__split_fields4) (rec__record_equality__child__f21 g_pu1__split_fields4) (rec__ext__2 g_pu1__split_fields4))) g_pu1__attr__tag))) us_tag1) c_gp1))
(assert (and (= us2 0) (in_range1 0)))
(assert (= (mk___rep1 (us_split_discrs2 (of_base (mk___rep (us_split_discrs2 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag))) (mk___split_fields (rec__record_equality__root__f11 (us_split_fields3 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))) (hide_ext__ (rec__record_equality__child__f2 (us_split_fields3 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))) (rec__ext__1 (us_split_fields3 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))))) (attr__tag1 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))))) (us_split_fields3 (of_base (mk___rep (us_split_discrs2 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag))) (mk___split_fields (rec__record_equality__root__f11 (us_split_fields3 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))) (hide_ext__ (rec__record_equality__child__f2 (us_split_fields3 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))) (rec__ext__1 (us_split_fields3 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))))) (attr__tag1 (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag)))))) us_tag9) c_gp2))
(assert (= 0 (to_rep (rec__record_equality__root__c (us_split_discrs2 c_gp2)))))
(assert (= (bool_eq (mk___rep r_pu1__split_discrs (mk___split_fields r_pu1__split_fields r_pu1__split_fields1) r_pu1__attr__tag) (mk___rep r_pu2__split_discrs (mk___split_fields r_pu2__split_fields r_pu2__split_fields1) r_pu2__attr__tag)) true))
(assert (= (bool_eq (mk___rep c_pu1__split_discrs (mk___split_fields c_pu1__split_fields1 (hide_ext__ c_pu1__split_fields c_pu1__split_fields2)) c_pu1__attr__tag) (mk___rep c_pu2__split_discrs (mk___split_fields c_pu2__split_fields1 (hide_ext__ c_pu2__split_fields c_pu2__split_fields2)) c_pu2__attr__tag)) true))
(assert (= (bool_eq1 (of_base (mk___rep g_pu1__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu1__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu1__split_fields4) (rec__record_equality__child__f21 g_pu1__split_fields4) (rec__ext__2 g_pu1__split_fields4))) g_pu1__attr__tag)) (of_base (mk___rep g_pu2__split_discrs (mk___split_fields (rec__record_equality__root__f12 g_pu2__split_fields4) (hide_ext__1 (rec__record_equality__grandchild__f3 g_pu2__split_fields4) (rec__record_equality__child__f21 g_pu2__split_fields4) (rec__ext__2 g_pu2__split_fields4))) g_pu2__attr__tag))) true))
(assert (= (bool_eq1 c_gp1 c_gp2) true))
(assert (not (not (= (bool_eq2 (mk___rep2 g_pu1__split_discrs g_pu1__split_fields4 g_pu1__attr__tag) (mk___rep2 g_pu2__split_discrs g_pu2__split_fields4 g_pu2__attr__tag)) true))))
(check-sat)
(exit)
