...
(assert (= (to_rep o1) first_col))
(assert (= (to_rep o2) first_line))
(assert (= o2 o3))
(assert (= o1 o4))
(assert (= rliteral o5))
(assert (= dummy1 o6))
(assert (= (to_rep1 o) 2))
(assert (= o o7))
(assert (= temp___1026 o7))
(assert (= temp___10261 o3))
(assert (= temp___10262 o4))
(assert (= temp___10263 o5))
(assert (= temp___10264 o6))
(assert (= true temp___10265))
(assert (= t__attr__constrained true))
(assert (not (= temp___1026 t__split_discrs)))
(check-sat)
(exit)
