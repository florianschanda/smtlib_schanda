...
(declare-const temp___6671 et1)
(declare-const temp___66711 et2)
(declare-const o4 et2)
(declare-const o5 et1)
(declare-const o6 et2)
(declare-const temp___6673 et1)
(declare-const temp___66731 et2)
...
(assert (= temp___6671 o2))
(assert (= temp___66711 o3))
(assert (= result1 r__split_fields))
(assert (= result2 r__split_fields1))
(assert (= temp___6671 r__split_fields2))
(assert (= temp___66711 r__split_fields3))
(assert (= (to_rep1 o4) temp1))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___6673 o5))
(assert (= temp___66731 o6))
(assert (= result3 r__split_fields2))
(assert (= result4 r__split_fields3))
(assert (= temp___6673 r__split_fields4))
(assert (= temp___66731 r__split_fields5))
(assert (= temp2 temp1))
...
(assert (not (= (to_rep r__split_fields6) (to_rep1 r__split_fields1))))
(check-sat)
(exit)
