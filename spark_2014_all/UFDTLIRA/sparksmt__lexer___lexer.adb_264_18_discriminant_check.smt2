...
(declare-const temp___1033 token_kind)
(declare-const temp___10331 natural)
(declare-const temp___10332 natural)
(declare-const temp___10333 natural)
(declare-const temp___10334 name_id)
(declare-const temp___10335 Bool)
...
(assert (= (to_rep1 o) 2))
(assert (= o o8))
(assert (= temp___1033 o8))
(assert (= temp___10331 o4))
(assert (= temp___10332 o5))
(assert (= temp___10333 o6))
(assert (= temp___10334 o7))
(assert (= true temp___10335))
(assert (= t__attr__constrained true))
(assert (not (= temp___1033 t__split_discrs)))
(check-sat)
(exit)
