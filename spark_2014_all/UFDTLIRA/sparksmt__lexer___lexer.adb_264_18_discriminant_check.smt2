...
(assert (= (to_rep1 o) 2))
(assert (= o o8))
(assert (= temp___947 o8))
(assert (= temp___9471 o4))
(assert (= temp___9472 o5))
(assert (= temp___9473 o6))
(assert (= temp___9474 o7))
(assert (= true temp___9475))
(assert (= t__attr__constrained true))
(assert (not (= temp___947 t__split_discrs)))
(check-sat)
(exit)
