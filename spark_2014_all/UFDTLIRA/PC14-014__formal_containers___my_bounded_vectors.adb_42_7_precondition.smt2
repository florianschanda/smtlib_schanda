...
(assert (not (or (and (<= 1 o6) (<= o6 (last (model__ (mk___rep l__split_discrs l__split_fields15))))) (and (not (= o6 0)) (= (- o6 1) (last (model__ (mk___rep l__split_discrs l__split_fields15))))))))
(check-sat)
(exit)
