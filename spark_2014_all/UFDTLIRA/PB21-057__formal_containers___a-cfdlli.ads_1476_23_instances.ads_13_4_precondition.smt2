...
(define-fun dynamic_invariant ((temp___expr_527 Int) (temp___is_init_524 Bool) (temp___skip_constant_525 Bool) (temp___do_toplevel_526 Bool)) Bool (=> (or (= temp___is_init_524 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_527)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__instances__lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_583 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 1 2147483647)) (in_range3 temp___expr_583)))
...
(define-fun default_initial_assumption1 ((temp___expr_590 us_rep3) (temp___skip_top_level_591 Bool)) Bool (=> (not (= temp___skip_top_level_591 true)) (and (= (is_empty temp___expr_590) true) (= (length2 temp___expr_590) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_571 us_rep2) (temp___skip_top_level_572 Bool)) Bool (=> (not (= temp___skip_top_level_572 true)) (= (length1 temp___expr_571) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_564 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 2147483647)) (in_range4 temp___expr_564)))
...
(define-fun dynamic_invariant4 ((temp___expr_558 Int) (temp___is_init_555 Bool) (temp___skip_constant_556 Bool) (temp___do_toplevel_557 Bool)) Bool (=> (or (= temp___is_init_555 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_558)))
...
(declare-const temp___962 count_type)
...
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___962 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___962)) no_element))
