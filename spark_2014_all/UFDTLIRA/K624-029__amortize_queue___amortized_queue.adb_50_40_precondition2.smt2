...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 idx2)) (= (get (model__ (mk___rep result____split_discrs result____split_fields3)) i1) (get (model__ left) i1)))))
(assert (and (=> (<= r33b r34b) (dynamic_property r33b r34b idx2)) (and (<= r33b idx2) (<= idx2 r34b))))
(assert (<= 1 i))
(assert (<= i idx2))
(assert (and (= o3 i) (in_range3 i)))
(assert (not (<= 1 o3)))
(check-sat)
(exit)
