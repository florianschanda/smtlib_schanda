...
(define-fun dynamic_invariant5 ((temp___expr_201 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_201)))
(assert true)
...
(define-fun dynamic_invariant6 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= first last)) (dynamic_property first last temp___expr_195)))
(assert (= first fst))
(assert (= last lst))
...
(define-fun dynamic_invariant7 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range6 temp___expr_141)))
...
(assert (= last6 last3))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first2 1) result) last3) (dynamic_invariant7 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant10 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_246)))
...
(declare-const temp___430 tcount_typeB)
(declare-const temp___4301 us_main_type)
...
(assert (and (= (length (mk___rep v2__split_discrs (mk___split_fields v2__split_fields))) 0) (dynamic_property2 0 last2 (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))
(assert (= lst2 r1b))
...
(assert (<= first i1))
(assert (<= i1 r1b))
(assert (not (= (length (mk___rep v2__split_discrs (mk___split_fields v2__split_fields))) (- i1 first))))
(check-sat)
(exit)
