...
(assert (in_range3 e1))
(assert (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields))) e1) true))
(assert (not (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields))))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i2) e1)))))
(check-sat)
(exit)
