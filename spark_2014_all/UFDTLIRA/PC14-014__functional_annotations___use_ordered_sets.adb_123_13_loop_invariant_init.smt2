...
(define-fun s2__split_fields1 () us_split_fields (mk___split_fields s2__split_fields))
...
(assert (and (= result1 (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields2))) (= (= result1 true) (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields2)) true))))
(assert (= result1 true))
(declare-const e Int)
(assert (in_range2 e))
(assert (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields1)) e) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (length (mk___rep s2__split_discrs s2__split_fields1)))) (= (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i) e)))))
(check-sat)
(exit)
