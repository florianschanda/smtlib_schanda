...
(assert (and (= o18 i1) (in_range3 i1)))
(assert (and (= o17 (model__ (mk___rep l__split_discrs l__split_fields2))) (= (length1 o17) (length (mk___rep l__split_discrs l__split_fields2)))))
(assert (not (<= 1 o18)))
(check-sat)
(exit)
