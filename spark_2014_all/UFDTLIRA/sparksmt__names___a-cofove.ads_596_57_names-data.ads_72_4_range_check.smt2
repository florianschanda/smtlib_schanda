...
(define-fun dynamic_invariant1 ((temp___expr_434 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool) (temp___do_typ_inv_433 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 0 2147483647)) (in_range3 temp___expr_434)))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__names__data__entry_tables__vector us_main_type)))))
(define-fun us_split_fields_Vector__2__projection ((a us_split_fields)) us_main_type (rec__names__data__entry_tables__vector a))
...
(define-fun dynamic_invariant2 ((temp___expr_441 Int) (temp___is_init_437 Bool) (temp___skip_constant_438 Bool) (temp___do_toplevel_439 Bool) (temp___do_typ_inv_440 Bool)) Bool (=> (or (= temp___is_init_437 true) (<= 0 2147483647)) (in_range4 temp___expr_441)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 0 0) true) (to_rep (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun dynamic_invariant3 ((temp___expr_417 Int) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool) (temp___do_typ_inv_416 Bool)) Bool (=> (or (= temp___is_init_413 true) (<= 1 2147483647)) (in_range5 temp___expr_417)))
...
(define-fun dynamic_invariant5 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 2147483646)) (in_range7 temp___expr_249)))
...
(assert (forall ((x positive)) (! (in_range6 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x name_id)) (! (in_range8 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x char_table_index)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq1 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep3 (rec__names__data__name_entry__table_index (us_split_fields3 a))) (to_rep3 (rec__names__data__name_entry__table_index (us_split_fields3 b)))) (= (to_rep1 (rec__names__data__name_entry__length (us_split_fields3 a))) (to_rep1 (rec__names__data__name_entry__length (us_split_fields3 b))))) (= (to_rep2 (rec__names__data__name_entry__next_hash (us_split_fields3 a))) (to_rep2 (rec__names__data__name_entry__next_hash (us_split_fields3 b))))) true false))
...
(define-fun dynamic_invariant6 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 2147483647)) (in_range8 temp___expr_173)))
...
(define-fun default_initial_assumption ((temp___expr_483 us_rep1) (temp___skip_top_level_484 Bool)) Bool (=> (not (= temp___skip_top_level_484 true)) (= (length1 temp___expr_483) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_475 Int) (temp___is_init_471 Bool) (temp___skip_constant_472 Bool) (temp___do_toplevel_473 Bool) (temp___do_typ_inv_474 Bool)) Bool (=> (or (= temp___is_init_471 true) (<= 0 2147483647)) (in_range9 temp___expr_475)))
