...
(define-fun dynamic_invariant1 ((temp___expr_386 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= 0 2147483647)) (in_range3 temp___expr_386)))
...
(define-fun dynamic_invariant2 ((temp___expr_392 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 0 2147483647)) (in_range4 temp___expr_392)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__names__data__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun dynamic_invariant3 ((temp___expr_371 Int) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool)) Bool (=> (or (= temp___is_init_368 true) (<= 1 2147483647)) (in_range5 temp___expr_371)))
...
(define-fun dynamic_invariant4 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range6 temp___expr_39)))
...
(define-fun dynamic_invariant5 ((temp___expr_214 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 2147483646)) (in_range7 temp___expr_214)))
...
(define-fun dynamic_invariant6 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 2147483647)) (in_range8 temp___expr_148)))
...
(define-fun default_initial_assumption ((temp___expr_429 us_rep1) (temp___skip_top_level_430 Bool)) Bool (=> (not (= temp___skip_top_level_430 true)) (= (length1 temp___expr_429) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_422 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 0 2147483647)) (in_range9 temp___expr_422)))
