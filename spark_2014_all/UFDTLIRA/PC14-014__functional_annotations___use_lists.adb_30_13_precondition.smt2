...
(define-fun dynamic_invariant2 ((temp___expr_264 Int) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool) (temp___do_typ_inv_263 Bool)) Bool (=> (or (= temp___is_init_260 true) (<= 0 2147483647)) (in_range5 temp___expr_264)))
...
(define-fun dynamic_invariant3 ((temp___expr_286 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1 2147483647)) (in_range6 temp___expr_286)))
...
(define-fun dynamic_invariant5 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_214)))
(assert true)
...
(define-fun l2__split_fields2 () us_split_fields (mk___split_fields l2__split_fields1))
(define-fun cu__split_fields4 () us_split_fields2 (mk___split_fields1 cu__split_fields1))
(define-fun use_lists__incr_all__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_lists__incr_all__cu__assume)))
(assert (<= (length l1) (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))
(assert (and (= use_lists__incr_all__cu__assume1 (first l1)) (ite (= (= (length l1) 0) true) (= (bool_eq1 use_lists__incr_all__cu__assume1 no_element) true) (and (= (has_key (positions l1) use_lists__incr_all__cu__assume1) true) (= (get1 (positions l1) use_lists__incr_all__cu__assume1) 1)))))
...
(assert (= (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields))) 0))
(assert (and (= result1 (has_key (positions l1) (mk___rep1 cu__split_fields4))) (= (= result1 true) (= (has_key (positions l1) (mk___rep1 cu__split_fields4)) true))))
(assert (= result1 true))
(assert (forall ((n Int)) (=> (and (<= 1 n) (<= n (length (mk___rep l2__split_discrs l2__split_fields2)))) (= (is_incr (get (model__ l1) n) (get (model__ (mk___rep l2__split_discrs l2__split_fields2)) n)) true))))
(assert (= (get1 (positions l1) (mk___rep1 cu__split_fields3)) (+ (length (mk___rep l2__split_discrs l2__split_fields2)) 1)))
(assert (and (= o (element l1 (mk___rep1 cu__split_fields3))) (and (in_range7 o) (= o (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3)))))))
(assert (= result2 (ite (< o 2147483647) true false)))
(assert (= result2 true))
(assert (and (= o1 (element l1 (mk___rep1 cu__split_fields3))) (and (in_range7 o1) (= o1 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3)))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range3 o2)))
(assert (not (< (length (mk___rep l2__split_discrs l2__split_fields2)) (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs)))))
(check-sat)
(exit)
