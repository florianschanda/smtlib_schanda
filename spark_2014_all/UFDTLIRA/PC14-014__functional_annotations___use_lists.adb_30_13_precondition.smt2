...
(assert (and (= o (element l1 (mk___rep1 cu__split_fields3))) (and (in_range5 o) (= o (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3)))))))
(assert (= result2 (ite (< o 2147483647) true false)))
(assert (= result2 true))
(assert (and (= o1 (element l1 (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (= o1 (get (model__ l1) (get1 (positions l1) (mk___rep1 cu__split_fields3)))))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range8 o2)))
