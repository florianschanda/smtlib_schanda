...
(define-fun dynamic_invariant2 ((temp___expr_226 Int) (temp___is_init_223 Bool) (temp___skip_constant_224 Bool) (temp___do_toplevel_225 Bool)) Bool (=> (or (= temp___is_init_223 true) (<= 0 2147483647)) (in_range5 temp___expr_226)))
...
(define-fun dynamic_invariant3 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 2147483647)) (in_range6 temp___expr_245)))
...
(define-fun dynamic_invariant4 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_189)))
...
(define-fun dynamic_invariant5 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_183)))
(assert true)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_lists__incr_all__cu__assume)) (first l1)) (ite (= (= (length l1) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_lists__incr_all__cu__assume)) no_element) true) (and (= (has_key (positions l1) (mk___rep1 (mk___split_fields1 use_lists__incr_all__cu__assume))) true) (= (get1 (positions l1) (mk___rep1 (mk___split_fields1 use_lists__incr_all__cu__assume))) 1)))))
...
(assert (and (= result1 (has_key (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))))
(assert (= result1 true))
(assert (forall ((n2 Int)) (=> (and (<= 1 n2) (<= n2 (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))))) (= (is_incr (get (model__ l1) n2) (get (model__ (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) n2)) true))))
(assert (= (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (+ (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) 1)))
(assert (and (= o11 (element l1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o11) (= o11 (get (model__ l1) (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (= result3 (ite (< o11 2147483647) true false)))
(assert (= result3 true))
(assert (and (= o12 (element l1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o12) (= o12 (get (model__ l1) (get1 (positions l1) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (= o13 (+ o12 1)))
(assert (and (= o14 o13) (in_range3 o13)))
(assert (not (< (length (mk___rep l2__split_discrs (mk___split_fields l2__split_fields1))) (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs)))))
(check-sat)
(exit)
