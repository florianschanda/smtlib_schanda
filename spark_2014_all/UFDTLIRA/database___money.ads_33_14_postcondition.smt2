...
(assert (and (= (to_rep (rec__money__amount__currency (us_split_fields1 a))) (to_rep (rec__money__amount__currency (us_split_fields1 b)))) (<= (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1 (rec__money__amount__raw (us_split_fields1 b)))) 1000000)))
(assert (= money__Oadd__result4 money__Oadd__result2))
(assert (= money__Oadd__result5 money__Oadd__result3))
(assert (= (mk___rep (mk___split_fields money__Oadd__result6 money__Oadd__result7)) (mk___rep (mk___split_fields money__Oadd__result2 money__Oadd__result3))))
...
(assert (= (mk___rep (mk___split_fields money__Oadd__result2 money__Oadd__result3)) (mk___rep (mk___split_fields o4 o5))))
(assert (= (mk_amount__ref (mk___rep (mk___split_fields money__Oadd__result8 money__Oadd__result9))) (mk_amount__ref (mk___rep (mk___split_fields money__Oadd__result4 money__Oadd__result5)))))
...
(assert (not (= (bool_eq (mk___rep (mk___split_fields money__Oadd__result8 money__Oadd__result9)) (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 a)) (of_rep1 (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1 (rec__money__amount__raw (us_split_fields1 b)))))))) true)))
(check-sat)
(exit)
