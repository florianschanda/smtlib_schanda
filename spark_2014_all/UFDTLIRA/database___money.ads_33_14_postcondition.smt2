...
(define-fun money__Oadd__result12 () us_rep (mk___rep (mk___split_fields money__Oadd__result2 money__Oadd__result3)))
...
(assert (= (mk___rep (mk___split_fields money__Oadd__result6 money__Oadd__result7)) money__Oadd__result12))
