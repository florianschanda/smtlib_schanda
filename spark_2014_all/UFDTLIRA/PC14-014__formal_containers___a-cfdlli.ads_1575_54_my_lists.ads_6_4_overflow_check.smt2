...
(assert (and (= o (length (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) (and (in_range1 o) (<= o (to_rep (rec__my_lists__m__list__capacity target__split_discrs))))))
