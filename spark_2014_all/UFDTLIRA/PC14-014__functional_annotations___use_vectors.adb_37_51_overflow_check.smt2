...
(assert (= o1 i2))
(assert (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o1)) (and (in_range5 o2) (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o1)))))
(assert (= result2 (ite (< o2 2147483647) true false)))
(assert (= result2 true))
(assert (and (= us1 i2) (dynamic_property1 first1 last1 i2)))
(assert (= o3 i2))
(assert (and (= o4 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o3)) (and (in_range5 o4) (= o4 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o3)))))
(assert (= o5 (+ o4 1)))
