...
(assert (= o13 i2))
(assert (and (= o14 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o13)) (and (in_range5 o14) (= o14 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o13)))))
(assert (= result4 (ite (< o14 2147483647) true false)))
(assert (= result4 true))
(assert (and (= us6 i2) (dynamic_property1 first1 last1 i2)))
(assert (= o16 i2))
(assert (and (= o17 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o16)) (and (in_range5 o17) (= o17 (get (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields2))) o16)))))
(assert (= o18 (+ o17 1)))
