...
(assert (and (= us (to_rep1 (rec__counters__counter__ticks (us_split_discrs1 c)))) (in_range1 (to_rep1 (rec__counters__counter__ticks (us_split_discrs1 c))))))
(assert (not (in_range2 (to_rep2 (rec__counters__counter__mode (us_split_discrs1 c))))))
(check-sat)
(exit)
