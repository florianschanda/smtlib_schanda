...
(assert (and (=> (<= 1 r4b) (dynamic_property 1 r4b idx2)) (and (<= 1 idx2) (<= idx2 r4b))))
(assert (<= 1 i))
(assert (<= i idx2))
(assert (and (= o5 i) (in_range6 i)))
(assert (and (= o6 (get (model__ left) o5)) (and (in_range4 o6) (= o6 (get (model__ left) o5)))))
