...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (rec__test__search_result__found (us_split_discrs1 a)) (rec__test__search_result__found (us_split_discrs1 b))) (=> (test__search_result__index__pred a) (= (to_rep1 (rec__test__search_result__index (us_split_fields1 a))) (to_rep1 (rec__test__search_result__index (us_split_fields1 b)))))) (=> (test__search_result__reason__pred a) (= (to_rep (rec__test__search_result__reason (us_split_fields1 a))) (to_rep (rec__test__search_result__reason (us_split_fields1 b)))))) true false))
...
(declare-const temp___287 Bool)
(declare-const temp___2871 integer)
(declare-const temp___2872 failure_reason)
(declare-const temp___2873 Bool)
...
(assert (= dummy o1))
(assert (= o o2))
(assert (= (of_int 0) temp___287))
(assert (= temp___2871 o1))
(assert (= temp___2872 o2))
(assert (= true temp___2873))
(assert (= x__attr__constrained true))
(assert (not (= temp___287 x__split_discrs)))
(check-sat)
(exit)
