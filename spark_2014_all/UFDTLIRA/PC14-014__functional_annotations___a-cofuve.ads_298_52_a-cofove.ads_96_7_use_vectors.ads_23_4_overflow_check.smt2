...
(assert (forall ((container1 us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant1 position1 true true true true) (and (<= first position1) (<= position1 (last1 container1)))) (dynamic_invariant3 (get container1 position1) true false true true)) :pattern ((get container1 position1))))))
(declare-const o Int)
...
(assert (and (= o2 (length container)) (and (in_range1 o2) (<= (+ (- first 1) o2) last))))
