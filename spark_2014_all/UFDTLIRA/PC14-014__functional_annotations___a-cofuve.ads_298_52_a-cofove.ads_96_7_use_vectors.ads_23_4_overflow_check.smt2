...
(define-fun dynamic_invariant1 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_246)))
...
(define-fun dynamic_invariant3 ((temp___expr_252 Int) (temp___is_init_249 Bool) (temp___skip_constant_250 Bool) (temp___do_toplevel_251 Bool)) Bool (=> (or (= temp___is_init_249 true) (<= first1 last2)) (dynamic_property1 first1 last2 temp___expr_252)))
...
(assert (forall ((container1 us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant3 position1 true true true) (and (<= first position1) (<= position1 (last1 container1)))) (dynamic_invariant1 (get container1 position1) true false true)) :pattern ((get container1 position1))))))
(declare-const o Int)
...
(assert (and (= o3 (length container)) (and (in_range3 o3) (<= (+ (- first 1) o3) last))))
(assert (= result (ite (< o3 2147483647) true false)))
(assert (= result true))
(assert (and (= o2 (last1 container)) (and (dynamic_property1 first1 last2 o2) (= o2 (+ (- first 1) (length container))))))
(assert (= result1 (ite (< o2 last) true false)))
(assert (= result1 true))
