...
(define-fun dynamic_invariant1 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_287)))
...
(define-fun dynamic_invariant3 ((temp___expr_294 Int) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (or (= temp___is_init_290 true) (<= first1 last2)) (dynamic_property1 first1 last2 temp___expr_294)))
...
(assert (forall ((container1 us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant3 position1 true true true true) (and (<= first position1) (<= position1 (last1 container1)))) (dynamic_invariant1 (get container1 position1) true false true true)) :pattern ((get container1 position1))))))
(declare-const o Int)
...
(assert (and (= o2 (length container)) (and (in_range3 o2) (<= (+ (- first 1) o2) last))))
(assert (= result (ite (< o2 2147483647) true false)))
(assert (= result true))
(assert (and (= o1 (last1 container)) (and (dynamic_property1 first1 last2 o1) (= o1 (+ (- first 1) (length container))))))
(assert (= result1 (ite (< o1 last) true false)))
(assert (= result1 true))
(assert (and (= o (last1 container)) (and (dynamic_property1 first1 last2 o) (= o (+ (- first 1) (length container))))))
