...
(define-fun dynamic_invariant ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 1 2147483647)) (in_range1 temp___expr_429)))
...
(define-fun dynamic_invariant3 ((temp___expr_443 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool) (temp___do_typ_inv_442 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range5 temp___expr_443)))
