...
(define-fun dynamic_invariant ((temp___expr_151 us_rep1) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (and (and (and (and (in_range2 1 (rec__foo__record_a__x (us_split_fields3 temp___expr_151))) (= (attr__constrained (rec__foo__record_a__x (us_split_fields3 temp___expr_151))) true)) (= (attr__constrained (rec__foo__record_a__x (us_split_fields3 temp___expr_151))) true)) (and (and (in_range3 2 (rec__foo__record_a__y (us_split_fields3 temp___expr_151))) (= (attr__constrained (rec__foo__record_a__y (us_split_fields3 temp___expr_151))) true)) (= (attr__constrained (rec__foo__record_a__y (us_split_fields3 temp___expr_151))) true))) (and (and (in_range4 0 (rec__foo__record_a__z (us_split_fields3 temp___expr_151))) (= (attr__constrained (rec__foo__record_a__z (us_split_fields3 temp___expr_151))) true)) (= (attr__constrained (rec__foo__record_a__z (us_split_fields3 temp___expr_151))) true))))
(define-fun default_initial_assumption ((temp___expr_155 us_rep1) (temp___skip_top_level_156 Bool)) Bool (and (and (and (= (attr__constrained (rec__foo__record_a__x (us_split_fields3 temp___expr_155))) true) (= (to_rep1 (rec__foo__value__kind (us_split_discrs1 (rec__foo__record_a__x (us_split_fields3 temp___expr_155))))) 1)) (and (= (attr__constrained (rec__foo__record_a__y (us_split_fields3 temp___expr_155))) true) (= (to_rep1 (rec__foo__value__kind (us_split_discrs1 (rec__foo__record_a__y (us_split_fields3 temp___expr_155))))) 2))) (and (= (attr__constrained (rec__foo__record_a__z (us_split_fields3 temp___expr_155))) true) (= (to_rep1 (rec__foo__value__kind (us_split_discrs1 (rec__foo__record_a__z (us_split_fields3 temp___expr_155))))) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 2)) (in_range1 temp___expr_135)))
(define-fun default_initial_assumption1 ((temp___expr_143 us_rep) (temp___skip_top_level_144 Bool)) Bool (and (= (attr__constrained temp___expr_143) false) (= (to_rep1 (rec__foo__value__kind (us_split_discrs1 temp___expr_143))) 0)))
(declare-const v__split_fields us_split_fields__ref1)
(assert (dynamic_invariant (mk___rep1 (us_split_fields__content1 v__split_fields)) true false true))
(assert (not (= (to_rep1 (rec__foo__value__kind (us_split_discrs1 (rec__foo__record_a__x (us_split_fields__content1 v__split_fields))))) 1)))
(check-sat)
(exit)
