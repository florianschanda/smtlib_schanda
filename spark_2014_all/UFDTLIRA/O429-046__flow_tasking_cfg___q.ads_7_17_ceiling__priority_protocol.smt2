...
(define-fun default_initial_assumption ((temp___expr_172 us_rep) (temp___skip_top_level_173 Bool)) Bool (= (to_rep (rec__p__po1T__content (us_split_fields1 temp___expr_172))) 0))
...
(define-fun default_initial_assumption1 ((temp___expr_178 us_rep1) (temp___skip_top_level_179 Bool)) Bool (= (to_rep (rec__q__po2T__content (us_split_fields3 temp___expr_178))) 0))
