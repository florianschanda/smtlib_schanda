...
(define-fun dynamic_invariant3 ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= first2 last4)) (dynamic_property3 first2 last4 temp___expr_256)))
...
(define-fun dynamic_invariant4 ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_249)))
...
(define-fun dynamic_invariant5 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_235)))
(assert true)
...
(declare-fun user_eq11 (telement_typeB telement_typeB) Bool)
(declare-const dummy11 telement_typeB)
...
(declare-const v1 us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const v2__split_discrs us_split_discrs)
...
(define-fun dynamic_invariant6 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= first3 last5)) (dynamic_property4 first3 last5 temp___expr_228)))
(assert (= first3 fst))
(assert (= last5 lst))
...
(define-fun dynamic_invariant7 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2147483647)) (in_range6 temp___expr_165)))
...
(assert (= last6 last1))
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= (+ (- first 1) result) last1) (dynamic_invariant7 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant10 ((temp___expr_287 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool) (temp___do_typ_inv_286 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 2147483648) 2147483647)) (in_range7 temp___expr_287)))
(assert (forall ((container us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant9 position true true true true) (and (<= first position) (<= position (last2 container)))) (dynamic_invariant10 (get container position) true false true true)) :pattern ((get container position))))))
...
(declare-const i Int)
(declare-const o Int)
(declare-const temp___472 Int)
(declare-const temp___471 tcount_typeB)
(declare-const temp___4711 us_main_type)
...
(declare-const v2__split_fields us_main_type)
(declare-const result1 Int)
(declare-const i1 Int)
(declare-const v2__split_fields1 us_main_type)
(declare-const i2 Int)
(declare-const result2 Bool)
(declare-const v2__split_fields2 us_main_type)
(declare-const v2__split_fields3 us_main_type)
(declare-const v2__split_fields4 us_main_type)
(declare-const i3 Int)
(declare-const v2__split_fields5 us_split_fields)
(declare-const i4 Int)
(declare-const v2__split_fields6 us_split_fields__ref)
(declare-const i5 int__ref)
(declare-const v2__split_fields7 us_split_fields)
(declare-const i6 Int)
(declare-const v2__split_fields8 us_split_fields__ref)
(declare-const lst3 int__ref)
(declare-const i7 int__ref)
(declare-const v2__split_fields9 us_split_fields)
(declare-const lst4 Int)
(declare-const i8 Int)
(declare-const result3 Bool)
(define-fun v2__split_fields10 () us_split_fields (mk___split_fields v2__split_fields3))
(define-fun v2__split_fields11 () us_split_fields (mk___split_fields v2__split_fields2))
(define-fun v2__split_fields12 () us_split_fields (mk___split_fields v2__split_fields1))
(define-fun v2__split_fields13 () us_split_fields (mk___split_fields v2__split_fields))
(assert (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 v1)))))
(assert (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs))))
(assert (and (= o (last2 (model__ v1))) (and (dynamic_property3 first2 last4 o) (= o (last2 (model__ v1))))))
(assert (= (mk_int__ref result) (mk_int__ref lst1)))
(assert (= lst2 o))
(assert (in_range1 lst2))
(assert (and (= (length (mk___rep v2__split_discrs v2__split_fields13)) 0) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))
(assert (= lst2 r1b))
(assert (in_range1 r1b))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 first3))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= temp___472 i1)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (and (= v2__split_discrs (mk___split_discrs temp___471)) (= temp___4711 v2__split_fields))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= (length (mk___rep v2__split_discrs v2__split_fields12)) (- i2 first3))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (forall ((n1 Int)) (=> (and (<= first3 n1) (<= n1 (last2 (model__ (mk___rep v2__split_discrs v2__split_fields12))))) (= (is_incr (get (model__ v1) n1) (get (model__ (mk___rep v2__split_discrs v2__split_fields12)) n1)) true)))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (and (and (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs))) (=> (<= first3 r1b) (dynamic_property5 first3 r1b i2))) (and (<= first3 i2) (<= i2 r1b)))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (and (= us i2) (dynamic_property2 first1 last3 i2))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= o1 i2)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (and (= o2 (get (model__ v1) o1)) (and (in_range3 o2) (= o2 (get (model__ v1) o1))))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= result2 (ite (< o2 2147483647) true false))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (= result2 true) (and (= us1 i2) (dynamic_property2 first1 last3 i2)))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (= result2 true) (= o3 i2))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (= result2 true) (and (= o4 (get (model__ v1) o3)) (and (in_range3 o4) (= o4 (get (model__ v1) o3)))))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (= result2 true) (= o5 (+ o4 1)))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (= result2 true) (and (= o6 o5) (in_range5 o5)))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (= result2 true) (and (and (and (= (length (mk___rep v2__split_discrs v2__split_fields11)) (+ (length (mk___rep v2__split_discrs v2__split_fields12)) 1)) (= (olt (model__ (mk___rep v2__split_discrs v2__split_fields12)) (model__ (mk___rep v2__split_discrs v2__split_fields11))) true)) (= (get (model__ (mk___rep v2__split_discrs v2__split_fields11)) (+ (last2 (model__ (mk___rep v2__split_discrs v2__split_fields12))) 1)) o6)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (not (= result2 true)) (and (= us2 i2) (dynamic_property2 first1 last3 i2)))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (not (= result2 true)) (= o7 i2))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (not (= result2 true)) (and (= o8 (get (model__ v1) o7)) (and (in_range3 o8) (= o8 (get (model__ v1) o7)))))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (not (= result2 true)) (and (and (and (= (length (mk___rep v2__split_discrs v2__split_fields10)) (+ (length (mk___rep v2__split_discrs v2__split_fields12)) 1)) (= (olt (model__ (mk___rep v2__split_discrs v2__split_fields12)) (model__ (mk___rep v2__split_discrs v2__split_fields10))) true)) (= (get (model__ (mk___rep v2__split_discrs v2__split_fields10)) (+ (last2 (model__ (mk___rep v2__split_discrs v2__split_fields12))) 1)) o8)) (dynamic_property 0 last (to_rep (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (=> (not (= result2 true)) (= v2__split_fields11 v2__split_fields10))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= i2 r1b)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= i2 i3)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= v2__split_fields4 v2__split_fields2)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= i4 i2)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= v2__split_fields5 v2__split_fields11)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= i5 (mk_int__ref i3))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= v2__split_fields6 (mk___split_fields__ref (mk___split_fields v2__split_fields4)))))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= i6 i4)))
(assert (=> (and (<= first3 i1) (<= i1 r1b)) (= v2__split_fields7 v2__split_fields5)))
(assert (=> (not (and (<= first3 i1) (<= i1 r1b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= first3 i1) (<= i1 r1b))) (= v2__split_fields6 (mk___split_fields__ref v2__split_fields13))))
(assert (=> (not (and (<= first3 i1) (<= i1 r1b))) (= i6 i1)))
(assert (=> (not (and (<= first3 i1) (<= i1 r1b))) (= v2__split_fields7 v2__split_fields13)))
(assert (= i7 i5))
(assert (= lst3 (mk_int__ref lst2)))
(assert (= v2__split_fields8 v2__split_fields6))
(assert (= i8 i6))
(assert (= lst4 lst2))
(assert (= v2__split_fields9 v2__split_fields7))
(assert (and (= o9 (last2 (model__ v1))) (and (dynamic_property3 first2 last4 o9) (= o9 (last2 (model__ v1))))))
(assert (= o10 (ite (<= n o9) true false)))
(assert (= result3 (ite (<= first3 n) o10 false)))
(assert (= result3 true))
(assert (and (= us3 n) (dynamic_property2 first1 last3 n)))
(assert (= o11 n))
(assert (not (<= first1 o11)))
(check-sat)
(exit)
