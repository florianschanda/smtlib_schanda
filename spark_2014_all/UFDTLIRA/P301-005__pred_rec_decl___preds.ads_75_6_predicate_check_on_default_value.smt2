...
(assert (= (to_rep temp___389) 0))
(define-fun temp___391 () Int (to_rep temp___389))
(assert (not (or (and (<= (- 2147483648) temp___391) (<= temp___391 (- 1))) (and (<= 1 temp___391) (<= temp___391 2147483647)))))
(check-sat)
(exit)
