...
(define-fun dynamic_invariant ((temp___expr_327 Int) (temp___is_init_323 Bool) (temp___skip_constant_324 Bool) (temp___do_toplevel_325 Bool) (temp___do_typ_inv_326 Bool)) Bool (and (=> (or (= temp___is_init_323 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_327)) (=> (= temp___do_toplevel_325 true) (=> (= temp___is_init_323 true) (or (and (<= (- 2147483648) temp___expr_327) (<= temp___expr_327 (- 1))) (and (<= 1 temp___expr_327) (<= temp___expr_327 2147483647)))))))
(define-fun dynamic_predicate ((temp___331 Int)) Bool (or (and (<= (- 2147483648) temp___331) (<= temp___331 (- 1))) (and (<= 1 temp___331) (<= temp___331 2147483647))))
...
(define-fun dynamic_invariant1 ((temp___expr_347 us_rep) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool) (temp___do_typ_inv_346 Bool)) Bool (=> (= temp___is_init_343 true) (let ((temp___349 (to_rep (rec__preds__rec_wrap_bad__x (us_split_fields1 temp___expr_347))))) (or (and (<= (- 2147483648) temp___349) (<= temp___349 (- 1))) (and (<= 1 temp___349) (<= temp___349 2147483647))))))
(define-fun default_initial_assumption ((temp___expr_350 us_rep) (temp___skip_top_level_351 Bool)) Bool (= (to_rep (rec__preds__rec_wrap_bad__x (us_split_fields1 temp___expr_350))) 0))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const x__split_fields rec_int_bad)
(declare-const temp___428 rec_int_bad)
(assert (dynamic_invariant i45s true false true true))
(assert (dynamic_invariant1 (mk___rep (mk___split_fields x__split_fields)) false false true true))
(assert (= (to_rep temp___428) 0))
(define-fun temp___430 () Int (to_rep temp___428))
(assert (not (or (and (<= (- 2147483648) temp___430) (<= temp___430 (- 1))) (and (<= 1 temp___430) (<= temp___430 2147483647)))))
(check-sat)
(exit)
