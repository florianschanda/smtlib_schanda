...
(define-fun dynamic_invariant1 ((temp___expr_284 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= 0 3)) (in_range3 temp___expr_284)))
...
(define-fun default_initial_assumption ((temp___expr_309 us_rep) (temp___skip_top_level_310 Bool)) Bool (=> (not (= temp___skip_top_level_310 true)) (= (length temp___expr_309) 0)))
(assert (forall ((s us_rep)) (! (dynamic_invariant (length s) true false true) :pattern ((length s)))))
(assert (forall ((attr__tag Int)) (forall ((s us_rep)) (! (dynamic_invariant (length1 attr__tag s) true false true) :pattern ((length1 attr__tag s))))))
...
(define-fun dynamic_invariant3 ((temp___expr_302 Int) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool)) Bool (=> (or (= temp___is_init_299 true) (<= 0 3)) (in_range4 temp___expr_302)))
(assert (forall ((s us_rep)) (forall ((n Int)) (! (=> (and (dynamic_invariant2 n true true true) (and (<= 1 n) (<= n (length s)))) (dynamic_invariant3 (get s n) true false true)) :pattern ((get s n))))))
(assert (forall ((attr__tag Int) (n Int)) (forall ((s us_rep)) (! (=> (dynamic_invariant2 n true true true) (dynamic_invariant3 (get1 attr__tag s n) true false true)) :pattern ((get1 attr__tag s n))))))
...
(define-fun dynamic_invariant4 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_15)))
...
(declare-const list_allocator__m__find__result18 Int)
(declare-const j15 Int)
(declare-const list_allocator__m__find__result19 Int)
