...
(assert (= i1 1))
(assert (< i1 11))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 sum2)) (=> (<= (- 2147483648) 2147483647) (in_range1 i2))) (< i2 11)))
(assert (and (= o (+ sum2 i2)) (in_range1 (+ sum2 i2))))
(assert (= result2 sum2))
(assert (= sum3 o))
(assert (= result3 tmp))
(assert (= tmp1 1))
(assert (in_range1 tmp1))
(assert (not (in_range1 (+ i2 tmp1))))
(check-sat)
(exit)
