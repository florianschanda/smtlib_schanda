...
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 last1)) (dynamic_property1 0 last1 temp___expr_165)))
(assert (= last1 c))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun dyn_return (Int) Int)
(declare-fun dyn_return__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant1 (dyn_return x) true false true true)) :pattern ((dyn_return x)))))
...
(assert (in_range c))
(assert (not (dynamic_property 1 last c)))
(check-sat)
(exit)
