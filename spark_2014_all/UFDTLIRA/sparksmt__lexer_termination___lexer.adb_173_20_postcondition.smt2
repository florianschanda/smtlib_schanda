...
(assert (and (= temp___924 next_read__split_discrs) (and (= temp___9241 next_read__split_fields) (= temp___9242 next_read__attr__constrained))))
(assert (= temp___923 current_idx))
(assert (= temp___922 current_col))
(assert (= temp___921 current_line))
(assert (and (= temp___920 current_read__split_discrs) (and (= temp___9201 current_read__split_fields) (= temp___9202 current_read__attr__constrained))))
(assert (= 0 temp___928))
