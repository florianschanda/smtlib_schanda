...
(define-fun dynamic_invariant ((temp___expr_630 Int) (temp___is_init_626 Bool) (temp___skip_constant_627 Bool) (temp___do_toplevel_628 Bool) (temp___do_typ_inv_629 Bool)) Bool (=> (or (= temp___is_init_626 true) (<= 1 2147483647)) (in_range1 temp___expr_630)))
...
(define-fun dynamic_invariant1 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_637)))
...
(define-fun default_initial_assumption ((temp___expr_652 us_rep) (temp___skip_top_level_653 Bool)) Bool (=> (not (= temp___skip_top_level_653 true)) (= (length temp___expr_652) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_587 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool) (temp___do_typ_inv_586 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 0 2147483647)) (in_range4 temp___expr_587)))
...
(define-fun dynamic_invariant3 ((temp___expr_644 Int) (temp___is_init_640 Bool) (temp___skip_constant_641 Bool) (temp___do_toplevel_642 Bool) (temp___do_typ_inv_643 Bool)) Bool (=> (or (= temp___is_init_640 true) (<= 0 2147483647)) (in_range5 temp___expr_644)))
...
(assert (and (= o2 (length container)) (and (in_range4 o2) (<= (+ 0 o2) 2147483647))))
