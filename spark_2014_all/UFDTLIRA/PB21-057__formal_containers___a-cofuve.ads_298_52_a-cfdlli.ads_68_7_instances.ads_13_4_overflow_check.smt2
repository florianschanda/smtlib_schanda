...
(define-fun dynamic_invariant1 ((temp___expr_637 Int) (temp___is_init_633 Bool) (temp___skip_constant_634 Bool) (temp___do_toplevel_635 Bool) (temp___do_typ_inv_636 Bool)) Bool (=> (or (= temp___is_init_633 true) (<= 0 2147483647)) (in_range2 temp___expr_637)))
...
(define-fun dynamic_invariant2 ((temp___expr_623 Int) (temp___is_init_619 Bool) (temp___skip_constant_620 Bool) (temp___do_toplevel_621 Bool) (temp___do_typ_inv_622 Bool)) Bool (=> (or (= temp___is_init_619 true) (<= 1 2147483647)) (in_range4 temp___expr_623)))
...
(define-fun dynamic_invariant3 ((temp___expr_630 Int) (temp___is_init_626 Bool) (temp___skip_constant_627 Bool) (temp___do_toplevel_628 Bool) (temp___do_typ_inv_629 Bool)) Bool (=> (or (= temp___is_init_626 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_630)))
