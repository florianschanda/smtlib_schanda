...
(define-fun dynamic_invariant ((temp___expr_552 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 1 2147483647)) (in_range1 temp___expr_552)))
...
(define-fun dynamic_invariant1 ((temp___expr_558 Int) (temp___is_init_555 Bool) (temp___skip_constant_556 Bool) (temp___do_toplevel_557 Bool)) Bool (=> (or (= temp___is_init_555 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_558)))
...
(define-fun default_initial_assumption ((temp___expr_571 us_rep) (temp___skip_top_level_572 Bool)) Bool (=> (not (= temp___skip_top_level_572 true)) (= (length temp___expr_571) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_515 Int) (temp___is_init_512 Bool) (temp___skip_constant_513 Bool) (temp___do_toplevel_514 Bool)) Bool (=> (or (= temp___is_init_512 true) (<= 0 2147483647)) (in_range4 temp___expr_515)))
...
(define-fun dynamic_invariant3 ((temp___expr_564 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 2147483647)) (in_range5 temp___expr_564)))
