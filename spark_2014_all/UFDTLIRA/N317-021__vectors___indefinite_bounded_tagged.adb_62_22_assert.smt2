...
(assert (not (= (let ((temp___588 (f 1))) (let ((temp___587 (get (model__ (mk___rep1 v__split_discrs v__split_fields6)) 1))) (ite (= (attr__tag temp___587) (attr__tag temp___588)) (us_dispatch_eq temp___587 temp___588) false))) true)))
(check-sat)
(exit)
