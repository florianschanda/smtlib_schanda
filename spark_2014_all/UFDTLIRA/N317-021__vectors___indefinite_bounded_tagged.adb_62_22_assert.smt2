...
(assert (not (= (let ((temp___631 (f 1))) (let ((temp___630 (get (model__ (mk___rep1 v__split_discrs v__split_fields6)) 1))) (ite (= (attr__tag temp___630) (attr__tag temp___631)) (us_dispatch_eq temp___630 temp___631) false))) true)))
(check-sat)
(exit)
