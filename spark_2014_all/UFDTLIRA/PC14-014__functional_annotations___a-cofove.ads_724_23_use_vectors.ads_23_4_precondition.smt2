...
(assert (and (= o3 (last4 (model__ container))) (and (dynamic_property4 first3 last5 o3) (= o3 (last4 (model__ container))))))
...
(assert (and (= us1 temp___460) (dynamic_property3 first2 last3 temp___460)))
(assert (= o2 temp___460))
(assert (and (= us index) (dynamic_property2 first1 last2 index)))
(assert (= o1 index))
(assert (and (= o (model__ container)) (= (length o) (length1 container))))
(assert (not (<= o2 (last4 o))))
(check-sat)
(exit)
