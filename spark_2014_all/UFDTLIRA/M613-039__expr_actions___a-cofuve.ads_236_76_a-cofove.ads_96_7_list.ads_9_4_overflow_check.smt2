...
(define-fun dynamic_invariant ((temp___expr_278 Int) (temp___is_init_275 Bool) (temp___skip_constant_276 Bool) (temp___do_toplevel_277 Bool)) Bool (=> (or (= temp___is_init_275 true) (<= 1 100)) (in_range2 temp___expr_278)))
...
(define-fun dynamic_invariant1 ((temp___expr_290 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 100)) (in_range3 temp___expr_290)))
...
(define-fun default_initial_assumption ((temp___expr_297 us_rep) (temp___skip_top_level_298 Bool)) Bool (=> (not (= temp___skip_top_level_298 true)) (= (length temp___expr_297) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_197 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 2147483647)) (in_range4 temp___expr_197)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 100) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_284 Int) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool)) Bool (=> (or (= temp___is_init_281 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_284)))
...
(assert (and (= o1 (length right)) (and (in_range4 o1) (<= (+ 0 o1) 100))))
(assert (= o2 (+ 0 o1)))
