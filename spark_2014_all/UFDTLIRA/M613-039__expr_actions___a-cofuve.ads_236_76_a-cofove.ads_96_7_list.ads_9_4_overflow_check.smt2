...
(define-fun dynamic_invariant ((temp___expr_320 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool) (temp___do_typ_inv_319 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 100)) (in_range2 temp___expr_320)))
...
(define-fun dynamic_invariant1 ((temp___expr_334 Int) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool) (temp___do_typ_inv_333 Bool)) Bool (=> (or (= temp___is_init_330 true) (<= 0 100)) (in_range3 temp___expr_334)))
...
(define-fun default_initial_assumption ((temp___expr_342 us_rep) (temp___skip_top_level_343 Bool)) Bool (=> (not (= temp___skip_top_level_343 true)) (= (length temp___expr_342) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_226 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool) (temp___do_typ_inv_225 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 2147483647)) (in_range4 temp___expr_226)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 100) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_327 Int) (temp___is_init_323 Bool) (temp___skip_constant_324 Bool) (temp___do_toplevel_325 Bool) (temp___do_typ_inv_326 Bool)) Bool (=> (or (= temp___is_init_323 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_327)))
