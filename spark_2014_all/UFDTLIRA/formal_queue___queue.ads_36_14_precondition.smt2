...
(assert (and (= o11 (get o10 (- i 1))) (in_range4 o11)))
(assert (and (= o9 (model__ (list__content queue__enqueue__result7))) (= (length1 o9) (length (list__content queue__enqueue__result7)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
