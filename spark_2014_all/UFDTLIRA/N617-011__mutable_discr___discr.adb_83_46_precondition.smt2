...
(define-fun default_initial_assumption ((temp___expr_215 us_rep) (temp___skip_top_level_216 Bool)) Bool (and (= (attr__constrained temp___expr_215) false) (= (to_rep (rec__discr__r6__with_bad_default1__d (us_split_discrs1 temp___expr_215))) (+ c 1))))
(declare-const d1__attr__constrained Bool)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun f (Int) Int)
(declare-fun f__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (and (dynamic_invariant x true true true) (< 0 x)) (dynamic_invariant (f x) true false true)) :pattern ((f x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (f x) (- x 1))) :pattern ((f x)))))
...
(define-fun default_initial_assumption1 ((temp___expr_223 us_rep1) (temp___skip_top_level_224 Bool)) Bool (and (= (attr__constrained1 temp___expr_223) false) (= (to_rep (rec__discr__r6__with_bad_default2__d (us_split_discrs3 temp___expr_223))) (f c))))
...
(assert (in_range1 c))
(assert (and (= d1__attr__constrained false) (= (to_rep d1__split_discrs) (+ c 1))))
(assert (not (< 0 c)))
(check-sat)
(exit)
