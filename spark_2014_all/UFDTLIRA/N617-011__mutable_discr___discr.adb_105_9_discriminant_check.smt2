...
(assert (and (= (mk___rep (mk___split_discrs temp___320) (mk___split_fields temp___3201) temp___3202) (new_with_default c)) (= (to_rep temp___320) c)))
(assert (=> (= d__attr__constrained true) (= temp___320 (rec__private_discr__p_with_default__c d__split_discrs1))))
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1) usq_2) (mk___rep (mk___split_discrs temp___320) (mk___split_fields temp___3201) temp___3202)))
...
(assert (and (= temp___323 (new_with_default 0)) (= (to_rep (rec__private_discr__p_with_default__c (us_split_discrs1 temp___323))) 0)))
(assert (= d__attr__constrained true))
(assert (not (= (rec__private_discr__p_with_default__c (us_split_discrs1 temp___323)) (rec__private_discr__p_with_default__c d__split_discrs2))))
(check-sat)
(exit)
