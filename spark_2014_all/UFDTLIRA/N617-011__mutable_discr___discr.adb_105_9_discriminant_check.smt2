...
(define-fun temp___3203 () us_rep (mk___rep (mk___split_discrs temp___320) (mk___split_fields temp___3201) temp___3202))
(assert (in_range c))
...
(assert (and (= temp___3203 (new_with_default c)) (= (to_rep temp___320) c)))
(assert (=> (= d__attr__constrained true) (= temp___320 (rec__private_discr__p_with_default__c d__split_discrs1))))
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1) usq_2) temp___3203))
