...
(assert (and (and (and (and (= (local_invariant the_file1 current_read__split_fields4 current_read__split_discrs4 current_idx1 next_read__split_fields4 next_read__split_discrs4 next_idx1) true) (= (bool_eq1 (mk___rep current_read__split_discrs4 current_read__split_fields4 current_read__attr__constrained) (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)) true)) (= current_idx1 next_idx)) (<= current_idx current_idx1)) (and (and (and (in_range3 current_line1) (in_range2 current_col1)) (in_range2 current_idx1)) (in_range2 next_idx1))))
...
(assert (=> (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs2))) 0) (and (= o (+ current_idx 1)) (in_range1 (+ current_idx 1)))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs2))) 0) (= o1 (ite (= (int__content current_idx2) o) true false))))
(assert (=> (not (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs2))) 0)) (= o1 (ite (= (int__content current_idx2) current_idx) true false))))
