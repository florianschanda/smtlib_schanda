...
(assert (and (and (= (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields1))) (+ (length (mk___rep1 s__split_discrs (mk___split_fields1 s__split_fields))) 1)) (and (and (and (and (= (local_invariant the_file1 (mk___split_fields current_read__split_fields1) (mk___split_discrs current_read__split_discrs1) current_idx1 (mk___split_fields next_read__split_fields1) (mk___split_discrs next_read__split_discrs1) next_idx1) true) (= (bool_eq1 (mk___rep (mk___split_discrs current_read__split_discrs1) (mk___split_fields current_read__split_fields1) current_read__attr__constrained) (mk___rep (mk___split_discrs next_read__split_discrs) (mk___split_fields next_read__split_fields) next_read__attr__constrained)) true)) (= current_idx1 next_idx)) (<= current_idx current_idx1)) (and (and (and (in_range3 current_line1) (in_range2 current_col1)) (in_range2 current_idx1)) (in_range2 next_idx1)))) (and (and (= s__split_fields2 (mk___split_fields__ref1 (mk___split_fields1 s__split_fields1))) (and (= next_idx2 (mk_int__ref next_idx1)) (and (= next_read__split_discrs2 (mk___split_discrs__ref (mk___split_discrs next_read__split_discrs1))) (and (= next_read__split_fields2 (mk___split_fields__ref (mk___split_fields next_read__split_fields1))) (and (= current_idx2 (mk_int__ref current_idx1)) (and (= current_col2 (mk_int__ref current_col1)) (and (= current_line2 (mk_int__ref current_line1)) (and (= current_read__split_discrs2 (mk___split_discrs__ref (mk___split_discrs current_read__split_discrs1))) (and (= current_read__split_fields2 (mk___split_fields__ref (mk___split_fields current_read__split_fields1))) (= the_file1 the_file2)))))))))) (and (= s__split_fields3 (mk___split_fields1 s__split_fields1)) (and (= next_idx3 next_idx1) (and (= next_read__split_discrs3 (mk___split_discrs next_read__split_discrs1)) (and (= next_read__split_fields3 (mk___split_fields next_read__split_fields1)) (and (= current_idx3 current_idx1) (and (= current_col3 current_col1) (and (= current_line3 current_line1) (and (= current_read__split_discrs3 (mk___split_discrs current_read__split_discrs1)) (and (= current_read__split_fields3 (mk___split_fields current_read__split_fields1)) (= the_file3 the_file1)))))))))))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs2))) 0) (and (= o1 (+ current_idx 1)) (in_range1 (+ current_idx 1)))))
(assert (=> (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs2))) 0) (= o2 (ite (= (int__content current_idx2) o1) true false))))
(assert (=> (not (= (to_rep1 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs2))) 0)) (= o2 (ite (= (int__content current_idx2) current_idx) true false))))
