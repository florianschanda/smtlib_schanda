...
(assert (=> (= (to_rep2 (rec__file_io__read_result__status (us_split_discrs__content1 current_read__split_discrs2))) 0) (and (= o (+ current_idx 1)) (in_range1 (+ current_idx 1)))))
(assert (=> (= (to_rep2 (rec__file_io__read_result__status (us_split_discrs__content1 current_read__split_discrs2))) 0) (= o1 (ite (= (int__content current_idx2) o) true false))))
(assert (=> (not (= (to_rep2 (rec__file_io__read_result__status (us_split_discrs__content1 current_read__split_discrs2))) 0)) (= o1 (ite (= (int__content current_idx2) current_idx) true false))))
