...
(assert (and (= o32 (first (mk___rep l3__split_discrs l3__split_fields2))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields2)) 0) true) (= (bool_eq1 o32 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o32) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o32) 1)))))
(assert (not (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields2)) o32) true)))
(check-sat)
(exit)
