...
(define-fun dynamic_invariant1 ((temp___expr_187 us_rep) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (=> (not (= temp___skip_constant_184 true)) (in_range3 2 temp___expr_187)))
(define-fun default_initial_assumption ((temp___expr_189 us_rep) (temp___skip_top_level_190 Bool)) Bool (= (to_rep (rec__test__wibble__d (us_split_discrs1 temp___expr_189))) 2))
...
(declare-const o4 dt)
(declare-const temp___292 dt)
(declare-const temp___2921 Bool)
(declare-const temp___2922 integer)
(declare-const temp___2923 Bool)
(declare-const temp___2924 dt)
...
(assert (= o o4))
(assert (= v__split_discrs (mk___split_discrs temp___292)))
(assert (= temp___2921 o1))
(assert (= temp___2922 o2))
(assert (= temp___2923 o3))
(assert (= temp___2924 o4))
...
(assert (= temp___2921 v__split_fields8))
(assert (= temp___2922 v__split_fields9))
(assert (= temp___2923 v__split_fields10))
(assert (= temp___2924 v__split_fields11))
(assert (= v__split_discrs (mk___split_discrs temp___292)))
