...
(define-fun dynamic_invariant ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= 0 2)) (in_range1 temp___expr_138)))
...
(define-fun dynamic_invariant1 ((temp___expr_161 us_rep) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (=> (not (= temp___skip_constant_159 true)) (in_range3 2 temp___expr_161)))
(define-fun default_initial_assumption ((temp___expr_163 us_rep) (temp___skip_top_level_164 Bool)) Bool (= (to_rep (rec__test__wibble__d (us_split_discrs1 temp___expr_163))) 2))
...
(declare-const o4 dt)
(declare-const temp___259 dt)
(declare-const temp___2591 Bool)
(declare-const temp___2592 integer)
(declare-const temp___2593 Bool)
(declare-const temp___2594 dt)
...
(assert (= v__split_fields5 o2))
(assert (= v__split_fields6 o3))
(assert (= o o4))
(assert (= v__split_discrs (mk___split_discrs temp___259)))
(assert (= temp___2591 o1))
(assert (= temp___2592 o2))
(assert (= temp___2593 o3))
(assert (= temp___2594 o4))
...
(assert (= temp___2591 v__split_fields8))
(assert (= temp___2592 v__split_fields9))
(assert (= temp___2593 v__split_fields10))
(assert (= temp___2594 v__split_fields11))
(assert (= v__split_discrs (mk___split_discrs temp___259)))
(assert (= (to_rep (rec__test__wibble__d r__split_discrs)) r16b))
(assert (in_range1 r16b))
(assert (not (= (rec__test__wibble__d v__split_discrs) (rec__test__wibble__d r__split_discrs))))
(check-sat)
(exit)
