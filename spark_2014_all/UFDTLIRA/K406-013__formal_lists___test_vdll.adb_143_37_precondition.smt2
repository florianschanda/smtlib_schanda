...
(assert (and (= o70 (first (mk___rep l3__split_discrs l3__split_fields4))) (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields4)) 0) true) (= (bool_eq1 o70 no_element) true) (and (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o70) true) (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o70) 1)))))
(assert (not (or (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o70) true) (= (bool_eq1 o70 no_element) true))))
(check-sat)
(exit)
