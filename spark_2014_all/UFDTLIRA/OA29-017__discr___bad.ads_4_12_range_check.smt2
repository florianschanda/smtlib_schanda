...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (too_small us_void_param) true false true true) :pattern ((too_small us_void_param)))))
(assert (forall ((us_void_param tuple0)) (! (= (too_small us_void_param) 0) :pattern ((too_small us_void_param)))))
...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__discr__t__c positive)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) positive (rec__discr__t__c a))
(declare-datatypes () ((us_split_discrs__ref (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref___projection ((a us_split_discrs__ref)) us_split_discrs (us_split_discrs__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__discr__t__a integer)))))
(define-fun us_split_fields_A__projection ((a us_split_fields)) integer (rec__discr__t__a a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_discrs1 us_split_discrs) (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___2__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__discr__t__c (us_split_discrs1 a))) (to_rep1 (rec__discr__t__c (us_split_discrs1 b)))) (= (to_rep (rec__discr__t__a (us_split_fields1 a))) (to_rep (rec__discr__t__a (us_split_fields1 b))))) true false))
...
(define-fun in_range2 ((rec__discr__t__c1 Int) (a us_rep)) Bool (= rec__discr__t__c1 (to_rep1 (rec__discr__t__c (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant1 ((temp___expr_206 us_rep) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (in_range2 r1s temp___expr_206)))
(define-fun default_initial_assumption ((temp___expr_208 us_rep) (temp___skip_top_level_209 Bool)) Bool (= (to_rep1 (rec__discr__t__c (us_split_discrs1 temp___expr_208))) r1s))
...
(assert (and (= bad__R1s__assume (too_small Tuple0)) (and (in_range bad__R1s__assume) (= bad__R1s__assume 0))))
