...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (too_small us_void_param) true false true) :pattern ((too_small us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_176 us_rep) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (not (= temp___skip_constant_174 true)) (in_range2 r1s temp___expr_176)))
(define-fun default_initial_assumption ((temp___expr_178 us_rep) (temp___skip_top_level_179 Bool)) Bool (= (to_rep1 (rec__discr__t__c (us_split_discrs1 temp___expr_178))) r1s))
