...
(assert (or (and (and (and (= for_loops_on_lists__search_0_for_in__result13 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result3)) (= cu10 (mk_cursor__ref cu2))) (and (= for_loops_on_lists__search_0_for_in__result14 for_loops_on_lists__search_0_for_in__result3) (= cu11 cu2))) (and (and (and (= (mk___rep1 (mk___split_fields1 o2)) (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o2)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o2))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o2))) 1)))) (and (= (mk_cursor__ref (mk___rep1 (mk___split_fields1 result))) (mk_cursor__ref (mk___rep1 (mk___split_fields1 cu)))) (= cu1 (mk___rep1 (mk___split_fields1 o2))))) (and (and (= result1 (has_key (positions l) cu1)) (= (= result1 true) (= (has_key (positions l) cu1) true))) (and (= result1 true) (and (= (mk___rep1 (mk___split_fields1 temp___465)) cu1) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions l) cu2) 1))) (not (= (get (model__ l) i1) 0)))) (and (= (has_key (positions l) cu2) true) (and (and (and (= o9 (element l cu2)) (and (in_range5 o9) (= o9 (get (model__ l) (get1 (positions l) cu2))))) (= result3 (ite (= o9 0) true false))) (and (= result3 true) (and (= result4 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result2)) (= for_loops_on_lists__search_0_for_in__result3 cu2))))))))))) (and (and (and (and (= (mk___rep1 (mk___split_fields1 o2)) (first l)) (ite (= (= (length2 l) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o2)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o2))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o2))) 1)))) (and (= (mk_cursor__ref (mk___rep1 (mk___split_fields1 result))) (mk_cursor__ref (mk___rep1 (mk___split_fields1 cu)))) (= cu1 (mk___rep1 (mk___split_fields1 o2))))) (and (and (= result1 (has_key (positions l) cu1)) (= (= result1 true) (= (has_key (positions l) cu1) true))) (ite (= result1 true) (and (and (and (= (mk___rep1 (mk___split_fields1 temp___465)) cu1) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions l) cu2) 1))) (not (= (get (model__ l) i1) 0)))) (and (= (has_key (positions l) cu2) true) (and (and (and (and (= o9 (element l cu2)) (and (in_range5 o9) (= o9 (get (model__ l) (get1 (positions l) cu2))))) (= result3 (ite (= o9 0) true false))) (and (not (= result3 true)) (= for_loops_on_lists__search_0_for_in__result3 for_loops_on_lists__search_0_for_in__result2))) (and (and (and (and (= (mk___rep1 (mk___split_fields1 o10)) (next l cu2)) (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l) cu2) (length2 l)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 o10)) no_element) true) (and (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o10))) true) (= (get1 (positions l) (mk___rep1 (mk___split_fields1 o10))) (+ (get1 (positions l) cu2) 1))))) (and (= o11 (has_key (positions l) (mk___rep1 (mk___split_fields1 o10)))) (= (= o11 true) (= (has_key (positions l) (mk___rep1 (mk___split_fields1 o10))) true)))) (= result5 (ite (not (= o11 true)) true false))) (= result5 true)))))) (and (and (= for_loops_on_lists__search_0_for_in__result6 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result3)) (= cu6 (mk_cursor__ref cu2))) (and (= for_loops_on_lists__search_0_for_in__result7 for_loops_on_lists__search_0_for_in__result3) (= cu7 cu2)))) (and (and (= for_loops_on_lists__search_0_for_in__result8 for_loops_on_lists__search_0_for_in__result6) (= cu8 cu6)) (and (= for_loops_on_lists__search_0_for_in__result9 for_loops_on_lists__search_0_for_in__result7) (= cu9 cu7)))) (and (and (= for_loops_on_lists__search_0_for_in__result8 (mk_cursor__ref (mk___rep1 (mk___split_fields1 for_loops_on_lists__search_0_for_in__result)))) (= cu8 (mk_cursor__ref cu1))) (and (= for_loops_on_lists__search_0_for_in__result9 (mk___rep1 (mk___split_fields1 for_loops_on_lists__search_0_for_in__result1))) (= cu9 cu1)))))) (and (and (and (= for_loops_on_lists__search_0_for_in__result13 for_loops_on_lists__search_0_for_in__result11) (= cu10 cu8)) (and (= for_loops_on_lists__search_0_for_in__result14 for_loops_on_lists__search_0_for_in__result12) (= cu11 cu9))) (and (and (= for_loops_on_lists__search_0_for_in__result11 (mk_cursor__ref for_loops_on_lists__search_0_for_in__result10)) (= for_loops_on_lists__search_0_for_in__result12 for_loops_on_lists__search_0_for_in__result10)) (and (= result7 for_loops_on_lists__search_0_for_in__result8) (= for_loops_on_lists__search_0_for_in__result10 no_element)))))))
(assert (= for_loops_on_lists__search_0_for_in__result15 for_loops_on_lists__search_0_for_in__result13))
(assert (= cu12 cu10))
(assert (= for_loops_on_lists__search_0_for_in__result16 for_loops_on_lists__search_0_for_in__result14))
(assert (= cu13 cu11))
(assert (and (= result9 (has_key (positions l) (cursor__content for_loops_on_lists__search_0_for_in__result15))) (= (= result9 true) (= (has_key (positions l) (cursor__content for_loops_on_lists__search_0_for_in__result15)) true))))
(assert (=> (= result9 true) (and (= o15 (element l (cursor__content for_loops_on_lists__search_0_for_in__result15))) (and (in_range5 o15) (= o15 (get (model__ l) (get1 (positions l) (cursor__content for_loops_on_lists__search_0_for_in__result15))))))))
(assert (=> (= result9 true) (= result8 (ite (= o15 0) true false))))
(assert (=> (not (= result9 true)) (= result8 false)))
(assert (not (= result8 true)))
(assert (= (bool_eq1 (cursor__content for_loops_on_lists__search_0_for_in__result15) no_element) true))
(assert (not true))
(check-sat)
(exit)
