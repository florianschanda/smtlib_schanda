...
(assert (= o outer_rec__split_fields))
(assert (= o o1))
(assert (= o1 o2))
(assert (= o2 o3))
(assert (= o4 o3))
(assert (= o4 us_self__compl))
(assert (= result outer_rec__split_fields))
(assert (= outer_rec__split_fields1 (mk___split_fields1 (mk___rep (mk___split_fields us_self__compl1)))))
(assert (not false))
(check-sat)
(exit)
