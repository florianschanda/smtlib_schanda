...
(declare-const my_sets__my_eq__result Bool)
(declare-const result Bool)
(declare-const my_sets__my_eq__result1 Bool)
(declare-const my_sets__my_eq__result2 Bool)
(declare-const my_sets__my_eq__result3 Bool)
(declare-const my_sets__my_eq__result4 Bool)
(declare-const my_sets__my_eq__result5 Bool)
(declare-const result1 Bool)
(assert (= my_sets__my_eq__result1 my_sets__my_eq__result2))
(assert (= my_sets__my_eq__result3 my_sets__my_eq__result1))
(assert (= result my_sets__my_eq__result))
(assert (= my_sets__my_eq__result1 (ite (= (to_rep (rec__my_sets__my_rec__f (us_split_fields1 x))) (to_rep (rec__my_sets__my_rec__f (us_split_fields1 y)))) true false)))
(assert (= (mk_bool__ref my_sets__my_eq__result4) (mk_bool__ref my_sets__my_eq__result2)))
(assert (= my_sets__my_eq__result5 my_sets__my_eq__result3))
(assert (= result1 my_sets__my_eq__result4))
(assert (= my_sets__my_eq__result4 true))
(assert (not (= (to_rep (rec__my_sets__my_rec__f (us_split_fields1 x))) (to_rep (rec__my_sets__my_rec__f (us_split_fields1 y))))))
(check-sat)
(exit)
