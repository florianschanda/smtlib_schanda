...
(assert (forall ((container us_rep)) (! (=> (not (= (is_empty container) true)) (let ((result (first_element container))) (and (and (= result (get (elements container) 1)) (= (e_smaller_than_range (elements container) 2 (length container) result) true)) (dynamic_invariant2 result true false true)))) :pattern ((first_element container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_520 Int) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool)) Bool (=> (or (= temp___is_init_517 true) (<= 1 100)) (in_range4 temp___expr_520)))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (dynamic_invariant3 (key i) true false true)) :pattern ((key i)))))
...
(define-fun dynamic_invariant4 ((temp___expr_526 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 1 100)) (in_range5 temp___expr_526)))
...
(define-fun e_is_find ((container1 us_rep1) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (of_int 1)) (ite (< position (length2 container1)) (e_smaller_than_range container1 (+ position 1) (length2 container1) item) (of_int 1))))
...
(assert (forall ((container1 us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant1 result true false true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length2 result) (length container1)) (forall ((temp___393 Int)) (=> (and (in_range7 temp___393) (= (iter_has_element result temp___393) true)) (= (contains (model__ container1) (get result temp___393)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 1 100)) (in_range6 temp___expr_321)))
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range6 e) (= (contains container1 e) true)) (= (equivalent_elements e item) true))) (= (contains container1 item) true)))) :pattern ((contains container1 item))))))
...
(assert (forall ((container1 us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant7 (get container1 position) true false true)) :pattern ((get container1 position))))))
(declare-const o Int)
(declare-const o1 Int)
(declare-const result Bool)
(assert (in_range5 key1))
(assert (and (= o1 (length container)) (and (in_range2 o1) (<= o1 (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 container)))))))
