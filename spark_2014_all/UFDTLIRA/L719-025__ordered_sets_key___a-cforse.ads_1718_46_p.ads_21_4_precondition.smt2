...
(define-fun dynamic_invariant3 ((temp___expr_563 Int) (temp___is_init_559 Bool) (temp___skip_constant_560 Bool) (temp___do_toplevel_561 Bool) (temp___do_typ_inv_562 Bool)) Bool (=> (or (= temp___is_init_559 true) (<= 1 100)) (in_range4 temp___expr_563)))
(assert (forall ((i Int)) (! (=> (dynamic_invariant i true true true true) (dynamic_invariant3 (key i) true false true true)) :pattern ((key i)))))
...
(define-fun dynamic_invariant4 ((temp___expr_570 Int) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool) (temp___do_typ_inv_569 Bool)) Bool (=> (or (= temp___is_init_566 true) (<= 1 100)) (in_range5 temp___expr_570)))
...
(define-fun e_bigger_than_range ((container1 us_rep1) (fst Int) (lst Int) (item Int)) Bool (ite (forall ((i Int)) (=> (and (<= fst i) (<= i lst)) (= (my_inf (get container1 i) item) true))) true false))
(declare-fun e_bigger_than_range__function_guard (Bool us_rep1 Int Int Int) Bool)
(define-fun e_is_find ((container1 us_rep1) (item Int) (position Int)) Bool (and (ite (< 0 position) (e_bigger_than_range container1 1 (- position 1) item) (distinct 1 0)) (ite (< position (length1 container1)) (e_smaller_than_range container1 (+ position 1) (length1 container1) item) (distinct 1 0))))
...
(assert (forall ((container1 us_rep1)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length1 container1)) (= (equivalent_elements item (get container1 result)) true))) (dynamic_invariant1 result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length1 result) (length container1)) (forall ((temp___435 Int)) (=> (and (in_range7 temp___435) (= (iter_has_element result temp___435) true)) (= (contains (model__ container1) (get result temp___435)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get result i)) i) (= (e_is_find result (get result i) i) true)))))) :pattern ((elements container1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool) (temp___do_typ_inv_352 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 100)) (in_range6 temp___expr_353)))
(assert (forall ((container1 us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range6 e) (= (contains container1 e) true)) (= (equivalent_elements e item) true))) (= (contains container1 item) true)))) :pattern ((contains container1 item))))))
(assert (forall ((container1 us_rep2)) (! (dynamic_invariant1 (length2 container1) true false true true) :pattern ((length2 container1)))))
(assert (forall ((container1 us_rep2)) (! (let ((result (is_empty1 container1))) (and (= (= result true) (forall ((item Int)) (not (and (in_range6 item) (= (contains container1 item) true))))) (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty1 container1)))))
...
(assert (forall ((container1 us_rep1)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true true) (and (<= 1 position) (<= position (last container1)))) (dynamic_invariant7 (get container1 position) true false true true)) :pattern ((get container1 position))))))
(declare-const o Int)
