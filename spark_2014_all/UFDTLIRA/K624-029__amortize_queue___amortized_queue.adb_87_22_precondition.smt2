...
(define-fun revrear__split_fields3 () us_split_fields (mk___split_fields revrear__split_fields2))
...
(assert (= (m_elements_reversed (model__ (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields1))) (model__ (mk___rep revrear__split_discrs revrear__split_fields3))) true))
(assert (not (<= (+ (length (mk___rep revrear__split_discrs revrear__split_fields3)) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) 1000)))
(check-sat)
(exit)
