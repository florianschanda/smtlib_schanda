...
(assert (not (<= (+ (length (mk___rep revrear__split_discrs (mk___split_fields revrear__split_fields2))) (length (rec__amortized_queue__queue__front (us_split_fields3 q)))) 1000)))
(check-sat)
(exit)
