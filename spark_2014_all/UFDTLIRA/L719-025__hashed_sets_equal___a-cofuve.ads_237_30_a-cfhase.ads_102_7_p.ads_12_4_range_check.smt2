...
(define-fun dynamic_invariant ((temp___expr_373 Int) (temp___is_init_370 Bool) (temp___skip_constant_371 Bool) (temp___do_toplevel_372 Bool)) Bool (=> (or (= temp___is_init_370 true) (<= 1 2147483647)) (in_range2 temp___expr_373)))
...
(define-fun dynamic_invariant1 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range3 temp___expr_385)))
...
(define-fun default_initial_assumption ((temp___expr_392 us_rep) (temp___skip_top_level_393 Bool)) Bool (=> (not (= temp___skip_top_level_393 true)) (= (length temp___expr_392) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 1 100)) (in_range5 temp___expr_379)))
