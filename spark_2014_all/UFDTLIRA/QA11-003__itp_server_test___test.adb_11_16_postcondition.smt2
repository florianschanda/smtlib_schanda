...
(declare-const test__parity__result Int)
(declare-const result Int)
(declare-const test__parity__result1 Int)
(declare-const test__parity__result2 Int)
(declare-const test__parity__result3 Int)
(declare-const test__parity__result4 Int)
(declare-const test__parity__result5 Int)
(declare-const result1 Int)
(assert (in_range1 a))
(assert (< 0 a))
(assert (= test__parity__result1 test__parity__result2))
(assert (= test__parity__result3 test__parity__result1))
(assert (= result test__parity__result))
(assert (= test__parity__result1 a))
