...
(assert (and (= o (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key o i3) true) (and (and (<= 1 (get1 o i3)) (<= (get1 o i3) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i3) (get1 o j)) (= (bool_eq1 i3 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields2))) (and (in_range5 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields2)))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields2)) true) (= (witness o (mk___rep1 cu__split_fields2)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
...
(assert (= result3 (ite (<= o5 threshold) true false)))
