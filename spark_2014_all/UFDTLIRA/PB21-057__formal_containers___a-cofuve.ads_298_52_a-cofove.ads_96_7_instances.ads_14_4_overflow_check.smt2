...
(define-fun dynamic_invariant ((temp___expr_738 Int) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool)) Bool (=> (or (= temp___is_init_735 true) (<= 1 1000)) (in_range1 temp___expr_738)))
...
(define-fun dynamic_invariant1 ((temp___expr_744 Int) (temp___is_init_741 Bool) (temp___skip_constant_742 Bool) (temp___do_toplevel_743 Bool)) Bool (=> (or (= temp___is_init_741 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_744)))
...
(define-fun dynamic_invariant3 ((temp___expr_750 Int) (temp___is_init_747 Bool) (temp___skip_constant_748 Bool) (temp___do_toplevel_749 Bool)) Bool (=> (or (= temp___is_init_747 true) (<= 0 1000)) (in_range5 temp___expr_750)))
