...
(define-fun dynamic_invariant ((temp___expr_823 Int) (temp___is_init_819 Bool) (temp___skip_constant_820 Bool) (temp___do_toplevel_821 Bool) (temp___do_typ_inv_822 Bool)) Bool (=> (or (= temp___is_init_819 true) (<= 1 1000)) (in_range1 temp___expr_823)))
...
(define-fun dynamic_invariant1 ((temp___expr_830 Int) (temp___is_init_826 Bool) (temp___skip_constant_827 Bool) (temp___do_toplevel_828 Bool) (temp___do_typ_inv_829 Bool)) Bool (=> (or (= temp___is_init_826 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_830)))
...
(define-fun dynamic_invariant3 ((temp___expr_837 Int) (temp___is_init_833 Bool) (temp___skip_constant_834 Bool) (temp___do_toplevel_835 Bool) (temp___do_typ_inv_836 Bool)) Bool (=> (or (= temp___is_init_833 true) (<= 0 1000)) (in_range5 temp___expr_837)))
