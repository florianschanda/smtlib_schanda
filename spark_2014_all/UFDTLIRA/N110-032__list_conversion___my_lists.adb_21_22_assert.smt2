...
(define-fun dynamic_invariant ((temp___expr_361 us_rep) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool)) Bool (=> (not (= temp___skip_constant_359 true)) (in_range1 100 temp___expr_361)))
(define-fun default_initial_assumption ((temp___expr_363 us_rep) (temp___skip_top_level_364 Bool)) Bool (and (= (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 temp___expr_363))) 100) (=> (not (= temp___skip_top_level_364 true)) (= (is_empty temp___expr_363) true))))
...
(define-fun dynamic_invariant1 ((temp___expr_370 us_rep) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool)) Bool (=> (not (= temp___skip_constant_368 true)) (in_range2 100 temp___expr_370)))
(define-fun default_initial_assumption1 ((temp___expr_372 us_rep) (temp___skip_top_level_373 Bool)) Bool (and (= (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 temp___expr_372))) 100) (=> (not (= temp___skip_top_level_373 true)) (= (is_empty temp___expr_372) true))))
...
(define-fun dynamic_invariant2 ((temp___expr_389 us_rep) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (not (= temp___skip_constant_387 true)) (in_range3 100 temp___expr_389)))
(define-fun default_initial_assumption2 ((temp___expr_391 us_rep) (temp___skip_top_level_392 Bool)) Bool (and (= (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 temp___expr_391))) 100) (=> (not (= temp___skip_top_level_392 true)) (= (is_empty temp___expr_391) true))))
...
(define-fun dynamic_invariant3 ((temp___expr_398 us_rep) (temp___is_init_395 Bool) (temp___skip_constant_396 Bool) (temp___do_toplevel_397 Bool)) Bool (=> (not (= temp___skip_constant_396 true)) (in_range4 100 temp___expr_398)))
(define-fun default_initial_assumption3 ((temp___expr_400 us_rep) (temp___skip_top_level_401 Bool)) Bool (and (= (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 temp___expr_400))) 100) (=> (not (= temp___skip_top_level_401 true)) (= (is_empty temp___expr_400) true))))
...
(define-fun dynamic_invariant4 ((temp___expr_407 us_rep) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (not (= temp___skip_constant_405 true)) (in_range5 100 temp___expr_407)))
(define-fun default_initial_assumption4 ((temp___expr_409 us_rep) (temp___skip_top_level_410 Bool)) Bool (and (= (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 temp___expr_409))) 100) (=> (not (= temp___skip_top_level_410 true)) (= (is_empty temp___expr_409) true))))
...
(define-fun dynamic_invariant5 ((temp___expr_416 us_rep) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool)) Bool (=> (not (= temp___skip_constant_414 true)) (in_range6 100 temp___expr_416)))
(define-fun default_initial_assumption5 ((temp___expr_418 us_rep) (temp___skip_top_level_419 Bool)) Bool (and (= (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 temp___expr_418))) 100) (=> (not (= temp___skip_top_level_419 true)) (= (is_empty temp___expr_418) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_425 us_rep) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool)) Bool (=> (not (= temp___skip_constant_423 true)) (in_range7 100 temp___expr_425)))
(define-fun default_initial_assumption6 ((temp___expr_427 us_rep) (temp___skip_top_level_428 Bool)) Bool (and (= (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 temp___expr_427))) 100) (=> (not (= temp___skip_top_level_428 true)) (= (is_empty temp___expr_427) true))))
...
(define-fun dynamic_invariant7 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 2147483647)) (in_range temp___expr_141)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_lists__my_lists__list__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true))) :pattern ((length container)))))
...
(assert (= (length (mk___rep l1__split_discrs (mk___split_fields my_lists__my_lists__clear__container__fields))) 0))
(assert (= result1 l1__split_fields))
(assert (= (mk___split_fields l1__split_fields1) (mk___split_fields my_lists__my_lists__clear__container__fields)))
...
(assert (not (= (to_rep (rec__my_lists__my_lists__list__capacity l2__split_discrs)) 100)))
(check-sat)
(exit)
