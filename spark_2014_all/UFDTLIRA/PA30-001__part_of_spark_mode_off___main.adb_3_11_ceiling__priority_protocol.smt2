...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__p__poT us_main_type)))))
(define-fun us_split_fields_POT__projection ((a us_split_fields)) us_main_type (rec__p__poT a))
