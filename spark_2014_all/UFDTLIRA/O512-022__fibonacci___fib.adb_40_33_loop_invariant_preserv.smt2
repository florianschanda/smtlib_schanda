...
(assert (= i10 2))
(assert (< 2 n2))
(assert (and (and (and (= a22 (fibonacci i11)) (= b22 (fibonacci (- i11 1)))) (<= i11 23)) (= (- (+ n22 i11) 2) copy_n21)))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 a22)) (in_range2 n22)) (=> (<= 0 2147483647) (in_range2 b22))) (=> (<= 0 2147483647) (in_range2 i11))) (< 2 n22)))
(assert (= result15 (mk_int__ref temp___1711)))
(assert (= temp___1712 n22))
(assert (and (= o11 (+ a22 b22)) (in_range1 (+ a22 b22))))
(assert (= result16 (mk_int__ref a22)))
(assert (= a23 o11))
(assert (and (= o12 (- a23 b22)) (in_range1 (- a23 b22))))
(assert (and (= o13 o12) (in_range2 o12)))
(assert (= result17 (mk_int__ref b22)))
(assert (= b23 o13))
(assert (and (= o14 (- n22 1)) (in_range2 (- n22 1))))
(assert (= result18 (mk_int__ref n22)))
(assert (= n23 o14))
(assert (and (= o15 (+ i11 1)) (in_range1 (+ i11 1))))
(assert (= result19 (mk_int__ref i11)))
(assert (= i12 o15))
(assert (< 2 n23))
(assert (= temp___1713 (mk_int__ref temp___1712)))
(assert (= i13 (mk_int__ref i12)))
(assert (= b24 (mk_int__ref b23)))
(assert (= a24 (mk_int__ref a23)))
(assert (= n24 (mk_int__ref n23)))
(assert (= temp___1714 temp___1712))
(assert (= i14 i12))
(assert (= b25 b23))
(assert (= a25 a23))
(assert (= n25 n23))
(assert (not (= (int__content a24) (fibonacci (int__content i13)))))
(check-sat)
(exit)
