...
(assert (=> (not (= (bool_eq1 (mk___rep1 current__split_fields11) (mk___rep1 n_last__split_fields5)) true)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields10)) fst) 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i) (get temp___543 i))))))
(assert (=> (not (= (bool_eq1 (mk___rep1 current__split_fields11) (mk___rep1 n_last__split_fields5)) true)) (forall ((i Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) (mk___rep1 current__split_fields10)) i) (<= i (length (mk___rep l__split_discrs l__split_fields10)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i) (get temp___544 i))))))
