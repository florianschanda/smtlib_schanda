...
(assert (and (= o6 (last1 (model__ v))) (and (dynamic_property3 first2 last4 o6) (= o6 (last1 (model__ v))))))
(assert (= o7 (ite (<= use_vectors__my_find__result13 o6) true false)))
(assert (= result6 (ite (<= first3 use_vectors__my_find__result13) o7 false)))
...
(assert (=> (= result6 true) (and (= o5 (get (model__ v) o4)) (and (in_range3 o5) (= o5 (get (model__ v) o4))))))
