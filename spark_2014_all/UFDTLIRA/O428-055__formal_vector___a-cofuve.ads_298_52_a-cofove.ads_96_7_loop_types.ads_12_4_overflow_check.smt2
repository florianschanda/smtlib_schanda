...
(define-fun dynamic_invariant ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 1 1000)) (in_range1 temp___expr_277)))
...
(define-fun dynamic_invariant1 ((temp___expr_284 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 2147483647)) (in_range2 temp___expr_284)))
...
(define-fun default_initial_assumption ((temp___expr_299 us_rep) (temp___skip_top_level_300 Bool)) Bool (=> (not (= temp___skip_top_level_300 true)) (= (length temp___expr_299) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 1000) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_291 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 1000)) (in_range5 temp___expr_291)))
...
(assert (forall ((container1 us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant3 position1 true true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant1 (get container1 position1) true false true true)) :pattern ((get container1 position1))))))
(declare-const o Int)
