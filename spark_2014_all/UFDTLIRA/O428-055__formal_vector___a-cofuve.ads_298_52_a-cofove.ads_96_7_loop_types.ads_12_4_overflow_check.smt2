...
(define-fun dynamic_invariant ((temp___expr_238 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 1 1000)) (in_range1 temp___expr_238)))
...
(define-fun dynamic_invariant1 ((temp___expr_244 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 2147483647)) (in_range2 temp___expr_244)))
...
(define-fun default_initial_assumption ((temp___expr_257 us_rep) (temp___skip_top_level_258 Bool)) Bool (=> (not (= temp___skip_top_level_258 true)) (= (length temp___expr_257) 0)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 1000) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_250 Int) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool)) Bool (=> (or (= temp___is_init_247 true) (<= 0 1000)) (in_range5 temp___expr_250)))
...
(assert (forall ((container1 us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant3 position1 true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant1 (get container1 position1) true false true)) :pattern ((get container1 position1))))))
(declare-const o Int)
...
(assert (and (= o3 (length container)) (and (in_range4 o3) (<= (+ 0 o3) 1000))))
(assert (= result (ite (< o3 2147483647) true false)))
(assert (= result true))
(assert (and (= o2 (last container)) (and (in_range5 o2) (= o2 (+ 0 (length container))))))
(assert (= result1 (ite (< o2 1000) true false)))
(assert (= result1 true))
