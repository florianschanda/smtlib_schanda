...
(assert (= result1 true))
(assert (and (= o13 (length v)) (and (in_range3 o13) (<= (+ 0 o13) 2147483647))))
(assert (= o14 (ite (<= i1 o13) true false)))
(assert (= result4 (ite (<= 1 i1) o14 false)))
(assert (= result4 true))
(assert (and (= o18 (get v i1)) (in_range4 o18)))
(assert (and (= o15 (length q)) (and (in_range3 o15) (<= (+ 0 o15) 2147483647))))
(assert (= o16 (+ i1 o15)))
