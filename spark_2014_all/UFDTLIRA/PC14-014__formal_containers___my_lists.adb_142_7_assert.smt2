...
(assert (and (and (and (= (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) (length (mk___rep l__split_discrs l__split_fields4))) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields4)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields4)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true)))
(assert (= result6 (mk___split_fields__ref l__split_fields4)))
(assert (= l__split_fields5 my_lists__s__sort__container__fields1))
(assert (= (oeq (model__ (mk___rep k__split_discrs my_lists__m__assign__target__fields1)) (model__ (mk___rep l__split_discrs l__split_fields5))) true))
(assert (= result7 (mk___split_fields__ref k__split_fields4)))
(assert (= k__split_fields5 my_lists__m__assign__target__fields1))
(assert (ite (= (<= (length (mk___rep l__split_discrs l__split_fields5)) 5) true) (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields1)) 0) (and (and (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields1)) (- (length (mk___rep l__split_discrs l__split_fields5)) 5)) (= (ole (model__ (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields5))) true)) (= (p_positions_truncated (positions (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields1)) (positions (mk___rep l__split_discrs l__split_fields5)) (+ (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields1)) 1) 5) true))))
(assert (= result8 (mk___split_fields__ref l__split_fields5)))
(assert (= l__split_fields6 my_lists__m__delete_last__2__container__fields1))
(assert (ite (= (<= (length (mk___rep k__split_discrs k__split_fields5)) 5) true) (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields1)) 0) (and (and (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields1)) (- (length (mk___rep k__split_discrs k__split_fields5)) 5)) (= (range_shifted (model__ (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields1)) (model__ (mk___rep k__split_discrs k__split_fields5)) 1 (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields1)) 5) true)) (= (p_positions_shifted (positions (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields1)) (positions (mk___rep k__split_discrs k__split_fields5)) 1 5) true))))
(assert (= result9 (mk___split_fields__ref k__split_fields5)))
(assert (= k__split_fields6 my_lists__m__delete_first__2__container__fields1))
(assert (and (and (and (and (and (= (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) (+ (length (mk___rep l__split_discrs l__split_fields6)) (length (mk___rep k__split_discrs k__split_fields6)))) (= (length (mk___rep k__split_discrs my_lists__s__merge__source__fields1)) 0)) (=> (and (= (m_elements_sorted (model__ (mk___rep l__split_discrs l__split_fields6))) true) (= (m_elements_sorted (model__ (mk___rep k__split_discrs k__split_fields6))) true)) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true))) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields6)) 1 (length (mk___rep l__split_discrs l__split_fields6)) (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true)) (= (m_elements_included (model__ (mk___rep k__split_discrs k__split_fields6)) 1 (length (mk___rep k__split_discrs k__split_fields6)) (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true)) (= (m_elements_in_union (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) (model__ (mk___rep k__split_discrs k__split_fields6)) (model__ (mk___rep l__split_discrs l__split_fields6))) true)))
(assert (= result10 (mk___split_fields__ref l__split_fields6)))
(assert (= l__split_fields7 my_lists__s__merge__target__fields1))
(assert (= result11 (mk___split_fields__ref k__split_fields6)))
(assert (= k__split_fields7 my_lists__s__merge__source__fields1))
(assert (not (not (= (is_sorted (mk___rep l__split_discrs l__split_fields7)) true))))
(check-sat)
(exit)
