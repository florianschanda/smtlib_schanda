...
(assert (and (and (and (and (and (= (length (mk___rep l__split_discrs my_lists__s__merge__target__fields)) (+ (length (mk___rep l__split_discrs l__split_fields39)) (length (mk___rep k__split_discrs k__split_fields12)))) (= (length (mk___rep k__split_discrs my_lists__s__merge__source__fields)) 0)) (=> (and (= (m_elements_sorted (model__ (mk___rep l__split_discrs l__split_fields39))) true) (= (m_elements_sorted (model__ (mk___rep k__split_discrs k__split_fields12))) true)) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields))) true))) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields39)) 1 (length (mk___rep l__split_discrs l__split_fields39)) (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields)) 1 (length (mk___rep l__split_discrs my_lists__s__merge__target__fields))) true)) (= (m_elements_included (model__ (mk___rep k__split_discrs k__split_fields12)) 1 (length (mk___rep k__split_discrs k__split_fields12)) (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields)) 1 (length (mk___rep l__split_discrs my_lists__s__merge__target__fields))) true)) (= (m_elements_in_union (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields)) (model__ (mk___rep k__split_discrs k__split_fields12)) (model__ (mk___rep l__split_discrs l__split_fields39))) true)))
(assert (= result67 (mk___split_fields__ref l__split_fields39)))
(assert (= l__split_fields40 my_lists__s__merge__target__fields))
(assert (= result68 (mk___split_fields__ref k__split_fields12)))
(assert (= k__split_fields13 my_lists__s__merge__source__fields))
(assert (= (length (mk___rep l__split_discrs l__split_fields40)) 10))
(assert (and (and (and (= (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) (length (mk___rep l__split_discrs l__split_fields40))) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields40)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true)) (= (m_elements_included (model__ (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) (model__ (mk___rep l__split_discrs l__split_fields40)) 1 (length (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true)))
(assert (= result69 (mk___split_fields__ref l__split_fields40)))
(assert (= l__split_fields41 my_lists__s__sort__container__fields1))
(assert (= (oeq (model__ (mk___rep k__split_discrs my_lists__m__assign__target__fields3)) (model__ (mk___rep l__split_discrs l__split_fields41))) true))
(assert (= result70 (mk___split_fields__ref k__split_fields13)))
(assert (= k__split_fields14 my_lists__m__assign__target__fields3))
(assert (ite (= (<= (length (mk___rep l__split_discrs l__split_fields41)) 5) true) (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields6)) 0) (and (and (= (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields6)) (- (length (mk___rep l__split_discrs l__split_fields41)) 5)) (= (ole (model__ (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields6)) (model__ (mk___rep l__split_discrs l__split_fields41))) true)) (= (p_positions_truncated (positions (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields6)) (positions (mk___rep l__split_discrs l__split_fields41)) (+ (length (mk___rep l__split_discrs my_lists__m__delete_last__2__container__fields6)) 1) 5) true))))
(assert (= result71 (mk___split_fields__ref l__split_fields41)))
(assert (= l__split_fields42 my_lists__m__delete_last__2__container__fields6))
(assert (ite (= (<= (length (mk___rep k__split_discrs k__split_fields14)) 5) true) (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields6)) 0) (and (and (= (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields6)) (- (length (mk___rep k__split_discrs k__split_fields14)) 5)) (= (range_shifted (model__ (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields6)) (model__ (mk___rep k__split_discrs k__split_fields14)) 1 (length (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields6)) 5) true)) (= (p_positions_shifted (positions (mk___rep k__split_discrs my_lists__m__delete_first__2__container__fields6)) (positions (mk___rep k__split_discrs k__split_fields14)) 1 5) true))))
(assert (= result72 (mk___split_fields__ref k__split_fields14)))
(assert (= k__split_fields15 my_lists__m__delete_first__2__container__fields6))
(assert (and (and (and (and (and (= (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) (+ (length (mk___rep l__split_discrs l__split_fields42)) (length (mk___rep k__split_discrs k__split_fields15)))) (= (length (mk___rep k__split_discrs my_lists__s__merge__source__fields1)) 0)) (=> (and (= (m_elements_sorted (model__ (mk___rep l__split_discrs l__split_fields42))) true) (= (m_elements_sorted (model__ (mk___rep k__split_discrs k__split_fields15))) true)) (= (m_elements_sorted (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true))) (= (m_elements_included (model__ (mk___rep l__split_discrs l__split_fields42)) 1 (length (mk___rep l__split_discrs l__split_fields42)) (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true)) (= (m_elements_included (model__ (mk___rep k__split_discrs k__split_fields15)) 1 (length (mk___rep k__split_discrs k__split_fields15)) (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) 1 (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true)) (= (m_elements_in_union (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) (model__ (mk___rep k__split_discrs k__split_fields15)) (model__ (mk___rep l__split_discrs l__split_fields42))) true)))
(assert (= result73 (mk___split_fields__ref l__split_fields42)))
(assert (= l__split_fields43 my_lists__s__merge__target__fields1))
(assert (= result74 (mk___split_fields__ref k__split_fields15)))
(assert (= k__split_fields16 my_lists__s__merge__source__fields1))
(assert (= (is_sorted (mk___rep l__split_discrs l__split_fields43)) true))
(assert (not false))
(check-sat)
(exit)
