...
(define-fun dynamic_invariant ((temp___expr_185 us_rep1) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (= (attr__constrained (rec__main__node_type__variant_node (us_split_fields1 temp___expr_185))) false))
(define-fun default_initial_assumption ((temp___expr_187 us_rep1) (temp___skip_top_level_188 Bool)) Bool (and (= (attr__constrained (rec__main__node_type__variant_node (us_split_fields1 temp___expr_187))) false) (= (to_rep (rec__main__node_variant_type__m_variant (us_split_discrs1 (rec__main__node_type__variant_node (us_split_fields1 temp___expr_187))))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_171 Int) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (or (= temp___is_init_168 true) (<= 0 0)) (in_range1 temp___expr_171)))
(define-fun default_initial_assumption1 ((temp___expr_179 us_rep) (temp___skip_top_level_180 Bool)) Bool (and (= (attr__constrained temp___expr_179) false) (= (to_rep (rec__main__node_variant_type__m_variant (us_split_discrs1 temp___expr_179))) 0)))
...
(declare-const branch__split_fields Bool)
...
(declare-const temp___199 node_enum)
