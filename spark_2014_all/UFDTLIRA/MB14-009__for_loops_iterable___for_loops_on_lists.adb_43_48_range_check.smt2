...
(assert (and (= o17 (length (mk___rep l__split_discrs l__split_fields2))) (and (in_range1 o17) (<= o17 (to_rep (rec__for_loops_on_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o18 (ite (<= i1 o17) true false)))
(assert (and (= o15 (positions (mk___rep l__split_discrs l__split_fields2))) (and (not (= (has_key o15 no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key o15 i3) true) (and (and (<= 1 (get1 o15 i3)) (<= (get1 o15 i3) (length (mk___rep l__split_discrs l__split_fields2)))) (forall ((j us_rep1)) (=> (= (has_key o15 j) true) (=> (= (get1 o15 i3) (get1 o15 j)) (= (bool_eq1 i3 j) true))))))))))
(assert (and (= o16 (get1 o15 cu2)) (and (in_range5 o16) (=> (= (of_int 0) true) (and (= o16 (w_get o15 (witness o15 cu2))) (forall ((k us_rep1)) (=> (= (has_key o15 k) true) (= (= (bool_eq1 k cu2) true) (= (witness o15 cu2) (witness o15 k))))))))))
(assert (= o19 (ite (<= o16 i1) true false)))
