...
(define-fun o9 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___541 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___541)) no_element))
(assert (and (= o9 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 o9 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o9) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) o9) 1)))))
...
(assert (and (= o6 (length (mk___rep l__split_discrs l__split_fields1))) (and (in_range1 o6) (<= o6 (to_rep (rec__for_loops_on_lists__my_lists__list__capacity l__split_discrs))))))
(assert (= o7 (ite (<= i o6) true false)))
(assert (and (= o4 (positions (mk___rep l__split_discrs l__split_fields1))) (and (not (= (has_key o4 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o4 i1) true) (and (and (<= 1 (get1 o4 i1)) (<= (get1 o4 i1) (length (mk___rep l__split_discrs l__split_fields1)))) (forall ((j us_rep1)) (=> (= (has_key o4 j) true) (=> (= (get1 o4 i1) (get1 o4 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o5 (get1 o4 cu2)) (and (in_range5 o5) (=> (= (distinct 0 0) true) (and (= o5 (w_get o4 (witness o4 cu2))) (forall ((k us_rep1)) (=> (= (has_key o4 k) true) (= (= (bool_eq1 k cu2) true) (= (witness o4 cu2) (witness o4 k))))))))))
(assert (= o8 (ite (<= o5 i) true false)))
(assert (= result3 (ite (= o8 true) o7 false)))
(assert (= result3 true))
