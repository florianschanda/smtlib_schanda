...
(assert (not (= (local_invariant (mk___split_fields current_read__split_fields2) (us_split_discrs__content current_read__split_discrs2) (us_split_fields__content next_read__split_fields2) (us_split_discrs__content next_read__split_discrs2)) true)))
(check-sat)
(exit)
