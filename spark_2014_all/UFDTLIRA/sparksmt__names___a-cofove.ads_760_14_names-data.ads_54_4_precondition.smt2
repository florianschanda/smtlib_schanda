...
(define-fun dynamic_invariant ((temp___expr_256 Int) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (<= 0 2147483646)) (in_range1 temp___expr_256)))
...
(define-fun dynamic_invariant1 ((temp___expr_263 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= 0 255)) (in_range2 temp___expr_263)))
...
(define-fun default_initial_assumption ((temp___expr_316 us_rep1) (temp___skip_top_level_317 Bool)) Bool (=> (not (= temp___skip_top_level_317 true)) (= (length temp___expr_316) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_270 Int) (temp___is_init_266 Bool) (temp___skip_constant_267 Bool) (temp___do_toplevel_268 Bool) (temp___do_typ_inv_269 Bool)) Bool (=> (or (= temp___is_init_266 true) (<= (- 1) 2147483647)) (in_range5 temp___expr_270)))
...
(define-fun dynamic_invariant4 ((temp___expr_277 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool) (temp___do_typ_inv_276 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 2147483647)) (in_range3 temp___expr_277)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 0 0) true) (to_rep (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container1))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_308 Int) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (<= (- 1) 2147483646)) (in_range4 temp___expr_308)))
