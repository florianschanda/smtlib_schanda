...
(assert (not (= (length (mk___rep front__split_discrs (mk___split_fields front__split_fields2))) (+ (- (+ (length ofront) (last (model__ (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))) idx1) 1))))
(check-sat)
(exit)
