...
(assert true)
(assert true)
(assert (forall ((o us_rep)) (! (= (to_int1 (less_than_max o)) (to_int1 (less_than_max1 us_tag o))) :pattern ((less_than_max1 us_tag o)))))
(assert (forall ((o us_rep)) (! (= (to_int1 (less_than_max__2 (of_base o))) (to_int1 (less_than_max1 us_tag1 o))) :pattern ((less_than_max1 us_tag1 o)))))
...
(define-fun default_initial_assumption1 ((temp___expr_151 us_rep1) (temp___skip_top_level_152 Bool)) Bool (= (attr__tag1 temp___expr_151) us_tag1))
(assert true)
(assert true)
