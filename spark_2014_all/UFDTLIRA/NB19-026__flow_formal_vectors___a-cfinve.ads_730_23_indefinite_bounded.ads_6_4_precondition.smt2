...
(define-fun dynamic_invariant3 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 2147483647)) (in_range5 temp___expr_177)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (of_int 1) true) (to_rep (rec__indefinite_bounded__vect__vector__capacity (us_split_discrs1 container1))) 2147483647))
