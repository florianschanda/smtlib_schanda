...
(define-fun dynamic_invariant3 ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 2147483647)) (in_range5 temp___expr_207)))
...
(define-fun capacity ((container1 us_rep)) Int (ite (= (distinct 1 0) true) (to_rep (rec__indefinite_bounded__vect__vector__capacity (us_split_discrs1 container1))) 2147483647))
