...
(assert (= e1 o))
(assert (in_range1 e1))
(assert (and (= (length1 (mk___rep l__split_discrs l__split_fields2)) (- (length1 (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 1)) (= (olt (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)))
(assert (not (< (length1 (mk___rep l__split_discrs l__split_fields2)) (capacity (mk___rep l__split_discrs l__split_fields2)))))
(check-sat)
(exit)
