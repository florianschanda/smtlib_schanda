...
(assert (not (<= 1 (+ (+ (+ 0 (ite (= (< (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59) true) 1 0)) (ite (= (ite (= (= (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59) true) (< (to_rep1 (rec__time__t__minutes (us_split_fields1 x))) 59) false) true) 1 0)) (ite (= (ite (= (= (to_rep2 (rec__time__t__seconds (us_split_fields1 x))) 59) true) (= (to_rep1 (rec__time__t__minutes (us_split_fields1 x))) 59) false) true) 1 0)))))
(check-sat)
(exit)
