...
(define-fun e_is_find ((container1 us_rep3) (item Int) (position1 Int)) Bool (and (ite (< 0 position1) (e_bigger_than_range container1 1 (- position1 1) item) (distinct 1 0)) (ite (< position1 (length3 container1)) (e_smaller_than_range container1 (+ position1 1) (length3 container1) item) (distinct 1 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_390 us_rep3) (temp___skip_top_level_391 Bool)) Bool (=> (not (= temp___skip_top_level_391 true)) (= (length3 temp___expr_390) 0)))
(declare-fun find (us_rep3 Int) Int)
(declare-fun find__function_guard (Int us_rep3 Int) Bool)
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length3 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container1 item))))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___428 Int)) (=> (and (in_range5 temp___428) (= (iter_has_element result temp___428) true)) (= (contains (model__ container1) (get1 result temp___428)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant4 position1 true true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant5 (get1 container1 position1) true false true true)) :pattern ((get1 container1 position1))))))
...
(declare-const temp___973 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___973 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___973)) no_element))
