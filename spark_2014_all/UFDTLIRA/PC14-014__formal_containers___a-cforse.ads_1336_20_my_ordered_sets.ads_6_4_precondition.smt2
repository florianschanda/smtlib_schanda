...
(define-fun e_is_find ((container1 us_rep3) (item Int) (position1 Int)) Bool (and (ite (< 0 position1) (e_bigger_than_range container1 1 (- position1 1) item) (distinct 1 0)) (ite (< position1 (length2 container1)) (e_smaller_than_range container1 (+ position1 1) (length2 container1) item) (distinct 1 0))))
...
(assert (forall ((container1 us_rep3)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container1 item))) (and (=> (< 0 result) (and (<= result (length2 container1)) (= (equivalent_elements item (get1 container1 result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container1 item))))))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container)))))))
