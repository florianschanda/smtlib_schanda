...
(define-fun e_is_find ((container1 us_rep3) (item Int) (position1 Int)) Bool (and (ite (< 0 position1) (e_bigger_than_range container1 1 (- position1 1) item) (of_int 1)) (ite (< position1 (length3 container1)) (e_smaller_than_range container1 (+ position1 1) (length3 container1) item) (of_int 1))))
...
(assert (forall ((container1 us_rep)) (! (let ((result (elements container1))) (and (and (and (= (length3 result) (length container1)) (forall ((temp___387 Int)) (=> (and (in_range5 temp___387) (= (iter_has_element result temp___387) true)) (= (contains (model__ container1) (get1 result temp___387)) true)))) (forall ((item Int)) (=> (and (in_range4 item) (= (contains (model__ container1) item) true)) (and (< 0 (find result item)) (= (equivalent_elements (get1 result (find result item)) item) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container1))) (and (= (find result (get1 result i)) i) (= (e_is_find result (get1 result i) i) true)))))) :pattern ((elements container1)))))
...
(assert (forall ((container1 us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant4 position1 true true true) (and (<= 1 position1) (<= position1 (last container1)))) (dynamic_invariant5 (get1 container1 position1) true false true)) :pattern ((get1 container1 position1))))))
...
(declare-const temp___909 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(declare-const o4 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___909 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___909)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container)))))))
