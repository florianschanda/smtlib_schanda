...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 100)) (in_range temp___expr_135)))
...
(assert (forall ((r us_rep)) (! (=> (< 0 (to_rep (rec__alias__my_rec__modulus (us_split_fields1 r)))) (dynamic_invariant (get_content r) true false true)) :pattern ((get_content r)))))
...
(define-fun default_initial_assumption1 ((temp___expr_148 us_rep) (temp___skip_top_level_149 Bool)) Bool (and (= (to_rep1 (rec__alias__my_rec__content (us_split_fields1 temp___expr_148))) 0) (= (to_rep (rec__alias__my_rec__modulus (us_split_fields1 temp___expr_148))) 0)))
...
(assert (= result1 alias__add__result4))
(assert (not (= alias__add__result4 (+ (get_content r) x))))
(check-sat)
(exit)
