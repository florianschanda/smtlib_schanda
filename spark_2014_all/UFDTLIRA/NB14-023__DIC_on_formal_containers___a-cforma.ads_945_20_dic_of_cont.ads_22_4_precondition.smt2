...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dic_of_cont__my_orma__cursor__node count_type)))))
(define-fun us_split_fields_Node__4__projection ((a us_split_fields)) count_type (rec__dic_of_cont__my_orma__cursor__node a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__dic_of_cont__my_orma__cursor__node (us_split_fields1 a))) (to_rep (rec__dic_of_cont__my_orma__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun cursor__ref___4__projection ((a cursor__ref)) us_rep (cursor__content a))
(declare-datatypes () ((key_type__ref (mk_key_type__ref (key_type__content us_rep)))))
(define-fun key_type__ref___8__projection ((a key_type__ref)) us_rep (key_type__content a))
...
(define-fun map__ref___8__projection ((a map__ref)) us_rep1 (map__content a))
...
(define-fun dynamic_invariant ((temp___expr_1240 Int) (temp___is_init_1236 Bool) (temp___skip_constant_1237 Bool) (temp___do_toplevel_1238 Bool) (temp___do_typ_inv_1239 Bool)) Bool (=> (or (= temp___is_init_1236 true) (<= 1 2147483647)) (in_range2 temp___expr_1240)))
...
(define-fun default_initial_assumption ((temp___expr_1248 us_rep1) (temp___skip_top_level_1249 Bool)) Bool (=> (not (= temp___skip_top_level_1249 true)) (and (= (is_empty temp___expr_1248) true) (= (length temp___expr_1248) 0))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dic_of_cont__my_orma__map us_main_type1)))))
(define-fun us_split_fields_Map__2__projection ((a us_split_fields2)) us_main_type1 (rec__dic_of_cont__my_orma__map a))
...
(define-fun us_rep___16__projection ((a us_rep2)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___17__projection ((a us_rep2)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs1 a))) (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs1 b)))) (= (us_main_eq1 (rec__dic_of_cont__my_orma__map (us_split_fields3 a)) (rec__dic_of_cont__my_orma__map (us_split_fields3 b))) true)) true false))
...
(assert (forall ((container1 us_rep2)) (! (let ((result (length1 container1))) (and (<= result (to_rep (rec__dic_of_cont__my_orma__map__capacity (us_split_discrs1 container1)))) (dynamic_invariant1 result true false true true))) :pattern ((length1 container1)))))
