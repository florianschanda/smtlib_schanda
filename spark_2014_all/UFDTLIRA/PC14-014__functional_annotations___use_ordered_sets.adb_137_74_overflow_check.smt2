...
(assert (and (= o1 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))) (and (in_range2 o1) (<= o1 (to_rep (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
(assert (= o2 (+ o1 1)))
