...
(assert (forall ((i ta4D2)) (and (<= 1 (ta4D2qtint i)) (<= (ta4D2qtint i) 2))))
...
(assert (forall ((temp___185 Int) (temp___186 Int) (temp___187 Int) (temp___188 Int)) (let ((temp___184 (temp_____aggregate_def_183 temp___185 temp___186 temp___187 temp___188))) (=> (and (and (and (dynamic_invariant temp___185 true true true true) (dynamic_invariant temp___186 true true true true)) (dynamic_invariant temp___187 true true true true)) (dynamic_invariant temp___188 true true true true)) (and (and (= (to_rep (get temp___184 1 1)) temp___185) (= (get temp___184 1 2) rliteral)) (and (= (to_rep (get temp___184 2 1)) temp___187) (= (get temp___184 2 2) rliteral)))))))
(assert (forall ((temp___193 Int)) (=> (dynamic_invariant temp___193 true true true true) (forall ((temp___194 Int) (temp___195 Int)) (= (to_rep (get (temp_____aggregate_def_191 temp___193) temp___194 temp___195)) temp___193)))))
(assert (forall ((temp___198 Int) (temp___199 Int) (temp___200 Int)) (let ((temp___197 (temp_____aggregate_def_196 temp___198 temp___199 temp___200))) (=> (and (and (dynamic_invariant temp___198 true true true true) (dynamic_invariant temp___199 true true true true)) (dynamic_invariant temp___200 true true true true)) (forall ((temp___201 Int) (temp___202 Int)) (ite (= temp___201 1) (ite (= temp___202 1) (= (to_rep (get temp___197 temp___201 temp___202)) temp___198) (= (to_rep (get temp___197 temp___201 temp___202)) temp___199)) (=> (= temp___201 2) (= (to_rep (get temp___197 temp___201 temp___202)) temp___200))))))))
(assert (forall ((temp___205 Int) (temp___206 Int) (temp___207 Int)) (let ((temp___204 (temp_____aggregate_def_203 temp___205 temp___206 temp___207))) (=> (and (and (dynamic_invariant temp___205 true true true true) (dynamic_invariant temp___206 true true true true)) (dynamic_invariant temp___207 true true true true)) (forall ((temp___208 Int) (temp___209 Int)) (ite (= temp___208 1) (ite (= temp___209 1) (= (get temp___204 temp___208 temp___209) rliteral) (= (to_rep (get temp___204 temp___208 temp___209)) temp___206)) (=> (= temp___208 2) (= (to_rep (get temp___204 temp___208 temp___209)) temp___207))))))))
(assert (forall ((temp___212 Int) (temp___213 Int) (temp___214 Int) (temp___215 Int)) (let ((temp___211 (temp_____aggregate_def_210 temp___212 temp___213 temp___214 temp___215))) (=> (and (and (and (dynamic_invariant temp___212 true true true true) (dynamic_invariant temp___213 true true true true)) (dynamic_invariant temp___214 true true true true)) (dynamic_invariant temp___215 true true true true)) (forall ((temp___216 Int) (temp___217 Int)) (ite (= temp___216 2) (ite (= temp___217 1) (= (get temp___211 temp___216 temp___217) rliteral) (=> (= temp___217 2) (= (to_rep (get temp___211 temp___216 temp___217)) temp___213))) (ite (= temp___217 1) (= (to_rep (get temp___211 temp___216 temp___217)) temp___214) (=> (= temp___217 2) (= (to_rep (get temp___211 temp___216 temp___217)) temp___215)))))))))
...
(assert (=> (= b 1) (= a1 (temp_____aggregate_def_183 one 2 one 2))))
(assert (=> (not (= b 1)) (=> (= b 2) (= (mk_map__ref result1) a8))))
(assert (=> (not (= b 1)) (=> (= b 2) (= a2 (temp_____aggregate_def_191 one)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= (mk_map__ref result2) a8)))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= a3 (temp_____aggregate_def_196 one one one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= (mk_map__ref result3) a8))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= a4 (temp_____aggregate_def_203 2 one one)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= (mk_map__ref result4) a8))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= a5 (temp_____aggregate_def_210 2 one one one)))))))
...
(assert (<= 1 k))
(assert (<= k 2))
(assert (not (= (to_rep (get a6 k 2)) 2)))
(check-sat)
(exit)
