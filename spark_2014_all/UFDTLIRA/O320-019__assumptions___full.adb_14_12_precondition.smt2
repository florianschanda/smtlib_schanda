...
(assert (forall ((x Int)) (! (=> (and (dynamic_invariant x true true true) (< x 2147483647)) (let ((result (bump x))) (and (= result (+ x 1)) (dynamic_invariant result true false true)))) :pattern ((bump x)))))
(declare-const z Int)
(declare-const o Int)
