...
(define-fun dynamic_invariant ((temp___expr_224 Int) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (=> (or (= temp___is_init_221 true) (<= 0 2147483647)) (in_range3 temp___expr_224)))
...
(define-fun dynamic_invariant3 ((temp___expr_246 Int) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool (=> (or (= temp___is_init_243 true) (<= 0 2147483647)) (in_range5 temp___expr_246)))
...
(define-fun dynamic_invariant4 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 255)) (in_range6 temp___expr_240)))
...
(assert (and (= o1 (capacity (mk___rep container__split_discrs (mk___split_fields container__split_fields)))) (and (in_range2 o1) (= o1 (ite (= (of_int 0) true) (to_rep (rec__unbounded_strings__char_vectors__vector__capacity container__split_discrs)) 2147483647)))))
(assert (= o2 (- o1 o)))
