...
(define-fun dynamic_invariant1 ((temp___expr_189 us_rep) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (and (=> (not (= temp___skip_constant_187 true)) (in_range1 c temp___expr_189)) (= (attr__constrained temp___expr_189) true)))
(define-fun default_initial_assumption ((temp___expr_191 us_rep) (temp___skip_top_level_192 Bool)) Bool (and (= (attr__constrained temp___expr_191) true) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_191))) c)))
...
(define-fun default_initial_assumption1 ((temp___expr_166 us_rep) (temp___skip_top_level_167 Bool)) Bool (and (= (attr__constrained temp___expr_166) false) (= (to_rep (rec__discr__with_default__c (us_split_discrs1 temp___expr_166))) 0)))
