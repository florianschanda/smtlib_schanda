...
(assert (=> (= result2 true) (and (= o6 (length q)) (and (in_range3 o6) (<= (+ 0 o6) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o4 (length v)) (and (in_range3 o4) (<= (+ 0 o4) 2147483647)))))
...
(assert (= result true))
(assert (and (= o2 (length p)) (and (in_range3 o2) (<= (+ 0 o2) 2147483647))))
