...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__p__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_390 Int) (temp___is_init_387 Bool) (temp___skip_constant_388 Bool) (temp___do_toplevel_389 Bool)) Bool (=> (or (= temp___is_init_387 true) (<= 1 2147483647)) (in_range2 temp___expr_390)))
...
(define-fun default_initial_assumption ((temp___expr_397 us_rep2) (temp___skip_top_level_398 Bool)) Bool (=> (not (= temp___skip_top_level_398 true)) (and (= (is_empty temp___expr_397) true) (= (length2 temp___expr_397) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_346 us_rep3) (temp___skip_top_level_347 Bool)) Bool (=> (not (= temp___skip_top_level_347 true)) (and (= (is_empty1 temp___expr_346) true) (= (length3 temp___expr_346) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_333 Int) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool)) Bool (=> (or (= temp___is_init_330 true) (<= 1 100)) (in_range3 temp___expr_333)))
...
(define-fun dynamic_invariant3 ((temp___expr_339 Int) (temp___is_init_336 Bool) (temp___skip_constant_337 Bool) (temp___do_toplevel_338 Bool)) Bool (=> (or (= temp___is_init_336 true) (<= 1 100)) (in_range4 temp___expr_339)))
...
(declare-const temp___558 count_type)
...
(assert (= (mk___rep1 (mk___split_fields1 temp___558)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__p__my_maps__map__capacity (us_split_discrs1 container)))))))
