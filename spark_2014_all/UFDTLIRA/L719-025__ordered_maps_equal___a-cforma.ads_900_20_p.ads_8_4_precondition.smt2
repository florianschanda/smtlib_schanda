...
(define-fun default_initial_assumption ((temp___expr_441 us_rep2) (temp___skip_top_level_442 Bool)) Bool (=> (not (= temp___skip_top_level_442 true)) (and (= (is_empty temp___expr_441) true) (= (length2 temp___expr_441) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_382 us_rep3) (temp___skip_top_level_383 Bool)) Bool (=> (not (= temp___skip_top_level_383 true)) (and (= (is_empty1 temp___expr_382) true) (= (length3 temp___expr_382) 0))))
...
(declare-const temp___603 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___603 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___603)) no_element))
