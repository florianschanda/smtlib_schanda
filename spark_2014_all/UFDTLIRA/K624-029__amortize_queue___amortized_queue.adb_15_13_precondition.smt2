...
(assert (=> (and (<= 1 idx2) (<= idx2 r4b)) (forall ((i Int)) (=> (and (<= 1 i) (<= i idx3)) (= (get (model__ (mk___rep result____split_discrs result____split_fields10)) i) (get (model__ left) i))))))
...
(assert (not (< (length (mk___rep result____split_discrs result____split_fields9)) (capacity (mk___rep result____split_discrs result____split_fields9)))))
(check-sat)
(exit)
