...
(assert (not (< (length (mk___rep result____split_discrs (us_split_fields__content result____split_fields7))) (capacity (mk___rep result____split_discrs (us_split_fields__content result____split_fields7))))))
(check-sat)
(exit)
