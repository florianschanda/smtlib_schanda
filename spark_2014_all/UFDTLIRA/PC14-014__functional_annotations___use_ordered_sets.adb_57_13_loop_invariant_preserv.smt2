...
(assert (= use_ordered_sets__are_disjoint_2__result3 use_ordered_sets__are_disjoint_2__result2))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___715)) (next s1 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length2 s1)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___715)) no_element) true) (and (= (has_key (positions s1) (mk___rep1 (mk___split_fields1 temp___715))) true) (= (get1 (positions s1) (mk___rep1 (mk___split_fields1 temp___715))) (+ (get1 (positions s1) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (= result5 cu__split_fields2))
(assert (= temp___715 cu__split_fields3))
