...
(assert (= use_ordered_sets__are_disjoint_2__result1 use_ordered_sets__are_disjoint_2__result))
(assert (and (= temp___7571 (next s1 (mk___rep1 cu__split_fields5))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields5) no_element) false) (= (get1 (positions s1) (mk___rep1 cu__split_fields5)) (length2 s1)) true) true) (= (bool_eq1 temp___7571 no_element) true) (and (= (has_key (positions s1) temp___7571) true) (= (get1 (positions s1) temp___7571) (+ (get1 (positions s1) (mk___rep1 cu__split_fields5)) 1))))))
(assert (= result3 cu__split_fields2))
(assert (= temp___757 cu__split_fields3))
