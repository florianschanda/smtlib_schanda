...
(define-fun dynamic_invariant1 ((temp___expr_352 Int) (temp___is_init_349 Bool) (temp___skip_constant_350 Bool) (temp___do_toplevel_351 Bool)) Bool (=> (or (= temp___is_init_349 true) (<= 1 2147483647)) (in_range3 temp___expr_352)))
(define-fun dynamic_invariant2 ((temp___expr_358 Int) (temp___is_init_355 Bool) (temp___skip_constant_356 Bool) (temp___do_toplevel_357 Bool)) Bool (=> (or (= temp___is_init_355 true) (<= 0 2147483647)) (in_range2 temp___expr_358)))
...
(define-fun default_initial_assumption ((temp___expr_365 us_rep1) (temp___skip_top_level_366 Bool)) Bool (=> (not (= temp___skip_top_level_366 true)) (= (length2 temp___expr_365) 0)))
...
(define-fun k_is_find ((container us_rep1) (key Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key) (of_int 1)) (ite (< position (length2 container)) (k_smaller_than_range container (+ position 1) (length2 container) key) (of_int 1))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___399 Int)) (=> (and (in_range2 temp___399) (= (iter_has_element result temp___399) true)) (= (has_key (model__ container) (get result temp___399)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_289 Int) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (or (= temp___is_init_286 true) (<= 1 2147483647)) (in_range5 temp___expr_289)))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_keys key (get container result)) true))) (dynamic_invariant result true false true)))) :pattern ((find container key))))))
...
(define-fun default_initial_assumption1 ((temp___expr_334 us_rep2) (temp___skip_top_level_335 Bool)) Bool (=> (not (= temp___skip_top_level_335 true)) (and (= (is_empty temp___expr_334) true) (= (length3 temp___expr_334) 0))))
(assert true)
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant6 key true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range4 k) (= (has_key container k) true)) (= (equivalent_keys k key) true))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant6 key true true true) (= (has_key container key) true)) (let ((result (get1 container key))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range4 k) (= (has_key container k) true)) (= (= (equivalent_keys k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant7 result true false true)))) :pattern ((get1 container key))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant (length3 container) true false true) :pattern ((length3 container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq3 left right) true) (and (forall ((key Int)) (=> (and (in_range4 key) (= (has_key left key) true)) (and (= (has_key right key) true) (= (get1 right key) (get1 left key))))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key right key) true)) (= (has_key left key) true))))) :pattern ((oeq3 left right)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant6 key true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant7 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const temp___814 us_rep1)
(declare-const temp___813 Int)
...
(assert (and (= o (length s)) (and (in_range1 o) (<= o (to_rep (rec__use_ordered_maps__my_maps__map__capacity (us_split_discrs1 s)))))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result (ite (<= 1 i) o1 false)))
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (= (length2 o2) (length s)) (forall ((temp___396 Int)) (=> (and (in_range2 temp___396) (= (iter_has_element o2 temp___396) true)) (= (has_key (model__ s) (get o2 temp___396)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find o2 key)) (= (equivalent_keys (get o2 (find o2 key)) key) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o2 (get o2 i1)) i1) (= (k_is_find o2 (get o2 i1) i1) true)))))))
(assert (and (= o3 (get o2 i)) (in_range3 o3)))
(assert (not (= (has_key (model__ s) o3) true)))
(check-sat)
(exit)
