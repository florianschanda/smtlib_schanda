...
(define-fun dynamic_invariant1 ((temp___expr_389 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 2147483647)) (in_range3 temp___expr_389)))
(define-fun dynamic_invariant2 ((temp___expr_396 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 2147483647)) (in_range2 temp___expr_396)))
...
(define-fun default_initial_assumption ((temp___expr_404 us_rep1) (temp___skip_top_level_405 Bool)) Bool (=> (not (= temp___skip_top_level_405 true)) (= (length2 temp___expr_404) 0)))
...
(define-fun k_is_find ((container us_rep1) (key Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key) (distinct 1 0)) (ite (< position (length2 container)) (k_smaller_than_range container (+ position 1) (length2 container) key) (distinct 1 0))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (= (length2 result) (length container)) (forall ((temp___442 Int)) (=> (and (in_range2 temp___442) (= (iter_has_element result temp___442) true)) (= (has_key (model__ container) (get result temp___442)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (equivalent_keys (get result (find result key)) key) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (and (= (find result (get result i)) i) (= (k_is_find result (get result i) i) true)))))) :pattern ((keys container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_316 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool) (temp___do_typ_inv_315 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= 1 2147483647)) (in_range5 temp___expr_316)))
...
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (dynamic_invariant3 key true true true true) (let ((result (find container key))) (and (=> (< 0 result) (and (<= result (length2 container)) (= (equivalent_keys key (get container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container key))))))
...
(define-fun default_initial_assumption1 ((temp___expr_368 us_rep2) (temp___skip_top_level_369 Bool)) Bool (=> (not (= temp___skip_top_level_369 true)) (and (= (is_empty temp___expr_368) true) (= (length3 temp___expr_368) 0))))
(assert true)
...
(assert (= result true))
(assert (and (= o2 (keys s)) (and (and (and (= (length2 o2) (length s)) (forall ((temp___439 Int)) (=> (and (in_range2 temp___439) (= (iter_has_element o2 temp___439) true)) (= (has_key (model__ s) (get o2 temp___439)) true)))) (forall ((key Int)) (=> (and (in_range4 key) (= (has_key (model__ s) key) true)) (and (< 0 (find o2 key)) (= (equivalent_keys (get o2 (find o2 key)) key) true))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (and (= (find o2 (get o2 i1)) i1) (= (k_is_find o2 (get o2 i1) i1) true)))))))
