...
(define-fun dynamic_invariant ((temp___expr_222 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 10)) (in_range2 temp___expr_222)))
...
(define-fun dynamic_invariant1 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 10)) (in_range3 temp___expr_234)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 10) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range5 temp___expr_228)))
...
(assert (and (= o1 (length right)) (and (in_range4 o1) (<= (+ 0 o1) 10))))
(assert (= o2 (+ 0 o1)))
