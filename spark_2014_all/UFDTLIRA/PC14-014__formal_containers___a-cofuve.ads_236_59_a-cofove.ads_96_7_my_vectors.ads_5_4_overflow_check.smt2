...
(define-fun dynamic_invariant ((temp___expr_259 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool) (temp___do_typ_inv_258 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= 1 10)) (in_range2 temp___expr_259)))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 10) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
