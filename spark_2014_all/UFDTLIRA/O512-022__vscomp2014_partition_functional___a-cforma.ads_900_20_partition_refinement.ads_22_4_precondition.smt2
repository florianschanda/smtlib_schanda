...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep (rec__partition_refinement__inverse_sets__cursor__node (us_split_fields3 a))) (to_rep (rec__partition_refinement__inverse_sets__cursor__node (us_split_fields3 b)))) true false))
...
(declare-const temp___1129 count_type)
(declare-const o2 us_rep2)
(declare-const o3 Int)
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= temp___1129 o1))
(assert (= (mk___rep1 (mk___split_fields1 temp___1129)) no_element))
...
(assert (and (= o3 (length container)) (and (in_range1 o3) (<= o3 (to_rep (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 container)))))))
