...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_586 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 1 2147483647)) (in_range2 temp___expr_586)))
...
(define-fun default_initial_assumption ((temp___expr_593 us_rep2) (temp___skip_top_level_594 Bool)) Bool (=> (not (= temp___skip_top_level_594 true)) (and (= (is_empty temp___expr_593) true) (= (length2 temp___expr_593) 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_542 us_rep3) (temp___skip_top_level_543 Bool)) Bool (=> (not (= temp___skip_top_level_543 true)) (and (= (is_empty1 temp___expr_542) true) (= (length3 temp___expr_542) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_535 Int) (temp___is_init_532 Bool) (temp___skip_constant_533 Bool) (temp___do_toplevel_534 Bool)) Bool (=> (or (= temp___is_init_532 true) (<= 0 5)) (in_range4 temp___expr_535)))
