...
(assert (and (= o5 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq1 o5 no_element) true) (and (= (has_key (positions l) o5) true) (= (get1 (positions l) o5) 1)))))
(assert (= temp___505 o))
...
(assert (< 0 count_03))
(assert (and (= o3 (has_key (positions l) cu1)) (= (= o3 true) (= (has_key (positions l) cu1) true))))
(assert (= o4 true))
