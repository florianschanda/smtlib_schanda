...
(assert (=> (< 0 count_03) (exists ((cu2 us_rep2)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 0)))))
(assert (=> (< 0 count_12) (exists ((cu2 us_rep2)) (and (= (has_key (positions l) cu2) true) (= (element l cu2) 1)))))
