...
(assert (forall ((n Int)) (! (=> (dynamic_invariant n true true true true) (= (= (is_positive_good n) true) (<= 1 n))) :pattern ((is_positive_good n)))))
(declare-fun is_positive_bad (Int) Bool)
(declare-fun is_positive_bad__function_guard (Bool Int) Bool)
(assert (forall ((n Int)) (! (=> (dynamic_invariant n true true true true) (= (= (is_positive_bad n) true) (<= 1 n))) :pattern ((is_positive_bad n)))))
(declare-fun is_positive_ugly (Int) Bool)
(declare-fun is_positive_ugly__function_guard (Bool Int) Bool)
(assert (forall ((n Int)) (! (=> (dynamic_invariant n true true true true) (= (= (is_positive_ugly n) true) (<= 1 n))) :pattern ((is_positive_ugly n)))))
...
(define-fun default_initial_assumption ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (= (to_rep (rec__test_08__t1__n (us_split_fields1 temp___expr_159))) 42))
(define-fun type_invariant ((temp___161 us_rep)) Bool (or (= (is_positive_good (to_rep (rec__test_08__t1__n (us_split_fields1 temp___161)))) true) (= (to_rep (rec__test_08__t1__n (us_split_fields1 temp___161))) (- 5))))
...
(define-fun default_initial_assumption1 ((temp___expr_168 us_rep1) (temp___skip_top_level_169 Bool)) Bool (= (to_rep (rec__test_08__t2__n (us_split_fields3 temp___expr_168))) 42))
(define-fun type_invariant1 ((temp___170 us_rep1)) Bool (or (= (is_positive_bad (to_rep (rec__test_08__t2__n (us_split_fields3 temp___170)))) true) (= (to_rep (rec__test_08__t2__n (us_split_fields3 temp___170))) (- 5))))
...
(define-fun default_initial_assumption2 ((temp___expr_177 us_rep2) (temp___skip_top_level_178 Bool)) Bool (= (to_rep (rec__test_08__t3__n (us_split_fields5 temp___expr_177))) 42))
(define-fun type_invariant2 ((temp___179 us_rep2)) Bool (or (= (is_positive_ugly (to_rep (rec__test_08__t3__n (us_split_fields5 temp___179)))) true) (= (to_rep (rec__test_08__t3__n (us_split_fields5 temp___179))) (- 5))))
(declare-const temp___181 integer)
(assert (= (to_rep temp___181) 42))
(assert (not (type_invariant2 (mk___rep2 (mk___split_fields2 temp___181)))))
(check-sat)
(exit)
