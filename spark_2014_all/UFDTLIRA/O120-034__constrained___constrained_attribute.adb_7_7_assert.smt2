...
(assert (= (mk___split_fields b__split_fields1) (mk___split_fields a__split_fields1)))
...
(assert (= b__attr__constrained true))
(assert (not (= (is_constrained (mk___rep b__split_discrs (mk___split_fields b__split_fields1) b__attr__constrained)) true)))
(check-sat)
(exit)
