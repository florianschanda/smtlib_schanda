...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 a))) (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_287 us_rep3) (temp___skip_top_level_288 Bool)) Bool (=> (not (= temp___skip_top_level_288 true)) (and (= (is_empty temp___expr_287) true) (= (length2 temp___expr_287) 0))))
(define-fun default_initial_assumption1 ((temp___expr_273 us_rep2) (temp___skip_top_level_274 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_273))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_265 us_rep1) (temp___skip_top_level_266 Bool)) Bool (=> (not (= temp___skip_top_level_266 true)) (= (length1 temp___expr_265) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_214)))
(define-fun default_initial_assumption3 ((temp___expr_228 us_rep2) (temp___skip_top_level_229 Bool)) Bool (= (to_rep (rec__formal_container__vdll__cursor__node (us_split_fields3 temp___expr_228))) 0))
...
(assert (and (= o1 (length container)) (and (in_range1 o1) (<= o1 (to_rep (rec__formal_container__vdll__list__capacity (us_split_discrs1 container)))))))
(assert (not (= (bool_eq2 position no_element) true)))
(assert (and (= o (positions container)) (and (not (= (has_key o no_element) true)) (forall ((i us_rep2)) (=> (= (has_key o i) true) (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length container))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i) (get1 o j)) (= (bool_eq2 i j) true))))))))))
