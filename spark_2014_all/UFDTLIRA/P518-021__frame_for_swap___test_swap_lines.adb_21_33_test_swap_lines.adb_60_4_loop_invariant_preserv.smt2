...
(assert (= result8 (mk_int__ref tmp12)))
(assert (= tmp13 (to_rep (get m12 5 (+ c12 1)))))
(assert (= (to_rep o34) (to_rep (get m12 7 (+ c12 1)))))
(assert (= o35 (set m12 5 (+ c12 1) o34)))
(assert (= result9 (mk_map__ref m12)))
(assert (= m13 o35))
(assert (= (to_rep o36) tmp13))
(assert (= o37 (set m13 7 (+ c12 1) o36)))
(assert (= result10 (mk_map__ref m13)))
(assert (= m14 o37))
(assert (not (= c12 9)))
(assert (= result11 (mk_int__ref c12)))
(assert (= c13 (+ c12 1)))
(assert (= c14 (mk_int__ref c13)))
(assert (= tmp14 (mk_int__ref tmp13)))
(assert (= m15 (mk_map__ref m14)))
(assert (= c15 c13))
(assert (= tmp15 tmp13))
(assert (= m16 m14))
(declare-const i13 Int)
(assert (<= 1 i13))
(assert (<= i13 (int__content c14)))
(assert (not (= (to_rep (get (map__content m15) 5 i13)) (to_rep (get m11 7 i13)))))
(check-sat)
(exit)
