...
(assert (= (minutes_tqtint rliteral1) 0))
(declare-const rliteral2 seconds_t)
(assert (= (seconds_tqtint rliteral2) 0))
(assert (= zero (mk___rep (mk___split_fields rliteral rliteral1 rliteral2))))
...
(assert (= (mk___rep (mk___split_fields rliteral rliteral1 rliteral2)) zero))
