...
(assert (not (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields__content2 r__split_fields9))))))) (to_rep r__split_fields5))))
(check-sat)
(exit)
