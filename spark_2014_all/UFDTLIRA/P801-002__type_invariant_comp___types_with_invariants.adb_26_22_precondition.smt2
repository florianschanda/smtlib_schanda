...
(assert (and (= o (to_integer e)) (and (in_range2 o) (= o (ite (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 e)) true) (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 e))) (- (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 e)))))))))
