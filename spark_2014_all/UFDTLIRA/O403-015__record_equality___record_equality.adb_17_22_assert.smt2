...
(assert (not (= (bool_eq2 (mk___rep2 g_pu1__split_discrs g_pu1__split_fields4 g_pu1__attr__tag) (mk___rep2 g_pu2__split_discrs g_pu2__split_fields4 g_pu2__attr__tag)) true)))
(assert (not (= (bool_eq1 (mk___rep1 c_pu1__split_discrs (mk___split_fields1 c_pu1__split_fields c_pu1__split_fields1 c_pu1__split_fields2) c_pu1__attr__tag) (mk___rep1 c_pu2__split_discrs (mk___split_fields1 c_pu2__split_fields c_pu2__split_fields1 c_pu2__split_fields2) c_pu2__attr__tag)) true)))
(check-sat)
(exit)
