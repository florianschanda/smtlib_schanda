...
(define-fun dynamic_invariant ((temp___expr_252 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool) (temp___do_typ_inv_251 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 1 2147483647)) (in_range2 temp___expr_252)))
...
(define-fun dynamic_invariant1 ((temp___expr_266 Int) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool) (temp___do_typ_inv_265 Bool)) Bool (=> (or (= temp___is_init_262 true) (<= 0 2147483647)) (in_range3 temp___expr_266)))
...
(define-fun dynamic_invariant3 ((temp___expr_259 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool) (temp___do_typ_inv_258 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_259)))
