...
(define-fun default_initial_assumption ((temp___expr_691 us_rep) (temp___skip_top_level_692 Bool)) Bool (=> (not (= temp___skip_top_level_692 true)) (= (is_empty temp___expr_691) true)))
...
(assert (forall ((container us_rep)) (forall ((item us_rep1)) (! (=> (= (of_int 1) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (my_eq e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
