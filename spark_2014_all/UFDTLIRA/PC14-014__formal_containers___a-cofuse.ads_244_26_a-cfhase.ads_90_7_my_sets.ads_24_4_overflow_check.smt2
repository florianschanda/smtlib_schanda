...
(define-fun default_initial_assumption ((temp___expr_739 us_rep) (temp___skip_top_level_740 Bool)) Bool (=> (not (= temp___skip_top_level_740 true)) (= (is_empty temp___expr_739) true)))
...
(define-fun my_eq ((x us_rep1) (y us_rep1)) Bool (= (to_rep1 (rec__my_sets__my_rec__f (us_split_fields1 x))) (to_rep1 (rec__my_sets__my_rec__f (us_split_fields1 y)))))
...
(assert (forall ((container us_rep)) (forall ((item us_rep1)) (! (=> (= (distinct 1 0) true) (=> (exists ((e us_rep1)) (and (= (contains container e) true) (= (my_eq e item) true))) (= (contains container item) true))) :pattern ((contains container item))))))
