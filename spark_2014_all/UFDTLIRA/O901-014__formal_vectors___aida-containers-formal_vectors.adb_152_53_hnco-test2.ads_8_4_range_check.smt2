...
(assert (forall ((container1 us_rep)) (forall ((item1 Int) (index1 Int)) (! (=> (and (dynamic_invariant4 item1 true true true true) (dynamic_invariant3 index1 true true true true)) (let ((result (find_index container1 item1 index1))) (and (ite (or (< (last_index container1) index1) (not (= (contains (model__ container1) index1 (last_index container1) item1) true))) (= result 0) (and (and (and (<= index1 result) (<= result (last_index container1))) (= (get (model__ container1) result) item1)) (not (= (contains (model__ container1) index1 (- result 1) item1) true)))) (dynamic_invariant5 result true false true true)))) :pattern ((find_index container1 item1 index1))))))
...
(assert (and (= us (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container)))) (in_range2 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))))))
(assert (not (in_range3 (to_rep (rec__hnco__test2__v_type_owner__vector_type__capacity (us_split_discrs3 container))))))
(check-sat)
(exit)
