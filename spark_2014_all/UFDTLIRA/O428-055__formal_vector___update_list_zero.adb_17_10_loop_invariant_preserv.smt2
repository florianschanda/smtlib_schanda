...
(assert (= result1 true))
(assert (= (length (mk___rep l__split_discrs l__split_fields2)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields2)) 1))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i3) (ite (<= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3) threshold) 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3))))))
(assert (forall ((i3 Int)) (=> (and (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields2)) i3) (<= i3 (length (mk___rep l__split_discrs l__split_fields2)))) (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i3) (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)))))
(assert (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields2)) true))
(assert (and (= o20 (element (mk___rep l__split_discrs l__split_fields2) (mk___rep1 cu__split_fields2))) (and (in_range6 o20) (= o20 (get (model__ (mk___rep l__split_discrs l__split_fields2)) (get1 (positions (mk___rep l__split_discrs l__split_fields2)) (mk___rep1 cu__split_fields2)))))))
(assert (= result5 (ite (<= o20 threshold) true false)))
(assert (=> (= result5 true) (and (and (and (= (length (mk___rep l__split_discrs loop_types__lists__replace_element__container__fields)) (length (mk___rep l__split_discrs l__split_fields2))) (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields2)) (positions (mk___rep l__split_discrs loop_types__lists__replace_element__container__fields))) true)) (= (get (model__ (mk___rep l__split_discrs loop_types__lists__replace_element__container__fields)) (get1 (positions (mk___rep l__split_discrs loop_types__lists__replace_element__container__fields)) (mk___rep1 cu__split_fields2))) 0)) (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields2)) (model__ (mk___rep l__split_discrs loop_types__lists__replace_element__container__fields)) (get1 (positions (mk___rep l__split_discrs loop_types__lists__replace_element__container__fields)) (mk___rep1 cu__split_fields2))) true))))
(assert (=> (= result5 true) (= result6 (mk___split_fields__ref l__split_fields2))))
(assert (=> (= result5 true) (= l__split_fields3 loop_types__lists__replace_element__container__fields)))
(assert (=> (not (= result5 true)) (= l__split_fields3 l__split_fields2)))
(assert (=> (not (= result5 true)) (= loop_types__lists__replace_element__container__fields rho)))
(assert (=> (not (= result5 true)) (= l__split_fields3 l__split_fields2)))
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields2)) (length (mk___rep l__split_discrs l__split_fields3))) true) true) (= (bool_eq1 (mk___rep1 cu__split_fields3) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true) (= (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) (+ (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields2)) 1)))))
(assert (and (= o21 (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3))) (= (= o21 true) (= (has_key (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) true))))
(assert (= result7 (ite (not (= o21 true)) true false)))
(assert (not (= result7 true)))
(declare-const i3 Int)
(assert (<= 1 i3))
(assert (<= i3 (- (get1 (positions (mk___rep l__split_discrs l__split_fields3)) (mk___rep1 cu__split_fields3)) 1)))
(assert (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i3) (ite (<= (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3) threshold) 0 (get (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i3)))))
(check-sat)
(exit)
