...
(assert (< 0 (length q)))
(assert (and (and (and (and (= (mk___rep (mk___split_discrs queue__tail__r__assume) (mk___split_fields queue__tail__r__assume1)) (copy q 0)) (and (and (= (oeq (model__ (mk___rep (mk___split_discrs queue__tail__r__assume) (mk___split_fields queue__tail__r__assume1))) (model__ q)) true) (= (oeq1 (positions (mk___rep (mk___split_discrs queue__tail__r__assume) (mk___split_fields queue__tail__r__assume1))) (positions q)) true)) (= (to_rep queue__tail__r__assume) (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))) (and (and (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields r__split_fields))) (= queue__tail__r__assume1 r__split_fields1)) (= r__split_discrs (mk___split_discrs queue__tail__r__assume)))) (and (and (and (and (and (= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (- (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 1)) (= (ole (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true)) (not (= (has_key (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (last1 (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true))) (= (keys_included_except (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (last1 (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true)) (= (ole1 (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true)) (and (and (and (= queue__tail__result4 queue__tail__result2) (= queue__tail__result5 queue__tail__result3)) (= queue__tail__result6 (mk___rep (mk___split_discrs queue__tail__result2) (mk___split_fields queue__tail__result3)))) (and (and (= result1 queue__tail__result) (= result2 queue__tail__result1)) (and (= r__split_discrs (mk___split_discrs queue__tail__result2)) (= queue__tail__result3 r__split_fields2)))))) (and (and (= queue__tail__result7 (mk_list__ref (mk___rep (mk___split_discrs queue__tail__result4) (mk___split_fields queue__tail__result5)))) (= r__split_fields3 (mk___split_fields__ref (mk___split_fields r__split_fields2)))) (and (= queue__tail__result8 queue__tail__result6) (= r__split_fields4 (mk___split_fields r__split_fields2))))))
(assert (= (mk___rep (mk___split_discrs result3) (mk___split_fields result4)) (list__content queue__tail__result7)))
(assert (not (= (length (list__content queue__tail__result7)) (- (length q) 1))))
(check-sat)
(exit)
