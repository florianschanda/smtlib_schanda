...
(define-fun temp___5203 () us_rep2 (mk___rep1 (mk___split_fields1 temp___5202)))
(define-fun temp___5204 () us_rep2 (mk___rep1 (mk___split_fields1 temp___5201)))
(define-fun o5 () us_rep2 (mk___rep1 (mk___split_fields1 o4)))
(define-fun o6 () us_rep2 (mk___rep1 (mk___split_fields1 o2)))
(define-fun o7 () us_rep2 (mk___rep1 (mk___split_fields1 o)))
(assert (and (= o7 (first l)) (ite (= (= (length1 l) 0) true) (= (bool_eq2 o7 no_element) true) (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) 1)))))
(assert (= temp___520 o))
...
(assert (= result2 true))
(assert (and (= (has_key (positions l) temp___5204) true) (= e3 (element l temp___5204))))
(assert (not (= e3 0)))
(assert (= for_loops_on_lists__contains_0_for_of__result1 for_loops_on_lists__contains_0_for_of__result))
(assert (and (= o6 (next l temp___5204)) (ite (= (ite (= (bool_eq2 temp___5204 no_element) false) (= (get1 (positions l) temp___5204) (length1 l)) true) true) (= (bool_eq2 o6 no_element) true) (and (= (has_key (positions l) o6) true) (= (get1 (positions l) o6) (+ (get1 (positions l) temp___5204) 1))))))
(assert (and (= o3 (has_key (positions l) o6)) (= (= o3 true) (= (has_key (positions l) o6) true))))
(assert (= result3 (ite (not (= o3 true)) true false)))
(assert (not (= result3 true)))
(assert (and (= o5 (next l temp___5204)) (ite (= (ite (= (bool_eq2 temp___5204 no_element) false) (= (get1 (positions l) temp___5204) (length1 l)) true) true) (= (bool_eq2 o5 no_element) true) (and (= (has_key (positions l) o5) true) (= (get1 (positions l) o5) (+ (get1 (positions l) temp___5204) 1))))))
(assert (= result4 temp___5201))
(assert (= temp___5203 o5))
(assert (and (= result5 (has_key (positions l) temp___5203)) (= (= result5 true) (= (has_key (positions l) temp___5203) true))))
(assert (= result5 true))
(assert (not (= (has_key (positions l) temp___5203) true)))
(check-sat)
(exit)
