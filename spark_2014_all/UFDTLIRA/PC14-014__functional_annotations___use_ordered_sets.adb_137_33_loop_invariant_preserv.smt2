...
(declare-const temp___782 count_type)
(declare-const temp___781 count_type)
(declare-const temp___7811 us_main_type)
...
(declare-const temp___780 count_type)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_ordered_sets__move_4__cu__assume)) (first (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) (ite (= (= (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_ordered_sets__move_4__cu__assume)) no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 use_ordered_sets__move_4__cu__assume))) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 use_ordered_sets__move_4__cu__assume))) 1)))))
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))))) (= (get (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) i1) (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1)))))
(assert (and (= o11 (element (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o11) (= o11 (get (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields2))))))))
(assert (and (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) o11) true) (ite (= (contains (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) o11) true) (and (and (and (= (oeq2 (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (model__ (mk___rep s2__split_discrs s2__split_fields2))) true) (= (oeq4 (positions (mk___rep s2__split_discrs s2__split_fields2)) (positions (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1)))) true)) (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o11)) o11)) (= (equal_except (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o11)) true)) (and (and (and (and (and (and (= (length (mk___rep s2__split_discrs s2__split_fields2)) (+ (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) 1)) (= (ole (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (model__ (mk___rep s2__split_discrs s2__split_fields2))) true)) (= (included_except (model__ (mk___rep s2__split_discrs s2__split_fields2)) (model__ (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) o11) true)) (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o11)) o11)) (= (range_equal (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (elements (mk___rep s2__split_discrs s2__split_fields2)) 1 (- (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o11) 1)) true)) (= (range_shifted (elements (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (elements (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o11) (length (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) 1) true)) (= (p_positions_shifted (positions (mk___rep s2__split_discrs (mk___split_fields s2__split_fields1))) (positions (mk___rep s2__split_discrs s2__split_fields2)) (find (elements (mk___rep s2__split_discrs s2__split_fields2)) o11) 1) true)))))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___780)) (next (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___780)) no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 temp___780))) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 temp___780))) (+ (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (= result3 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields2))))
(assert (= cu__split_fields3 (mk___split_fields1 temp___780)))
(assert (and (= o12 (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3))) (= (= o12 true) (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields3)) true))))
(assert (= result4 (ite (not (= o12 true)) true false)))
