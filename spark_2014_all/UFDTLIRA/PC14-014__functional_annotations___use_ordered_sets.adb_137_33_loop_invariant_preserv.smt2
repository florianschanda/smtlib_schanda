...
(define-fun temp___7801 () us_rep1 (mk___rep1 (mk___split_fields1 temp___780)))
...
(assert (and (= temp___7801 (next (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)) (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields4)) (length (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))) true) true) (= (bool_eq1 temp___7801 no_element) true) (and (= (has_key (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___7801) true) (= (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) temp___7801) (+ (get1 (positions (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) (mk___rep1 cu__split_fields4)) 1))))))
