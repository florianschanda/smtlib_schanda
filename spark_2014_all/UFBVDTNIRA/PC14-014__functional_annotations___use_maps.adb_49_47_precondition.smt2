...
(assert (and (= o (positions s)) (and (not (= (has_key1 o no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key1 o i2) true) (and (and (<= 1 (get1 o i2)) (<= (get1 o i2) (length s))) (forall ((j us_rep1)) (=> (= (has_key1 o j) true) (=> (= (get1 o i2) (get1 o j)) (= (bool_eq1 i2 j) true))))))))))
