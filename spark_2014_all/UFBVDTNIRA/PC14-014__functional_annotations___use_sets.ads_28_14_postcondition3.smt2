...
(assert (= result1 true))
(assert (and (= r__split_discrs (mk___split_discrs temp___865 temp___8651)) (= temp___8652 r__split_fields1)))
(assert (= temp___864 cu__split_fields1))
...
(assert (= r__split_fields4 (mk___split_fields__ref (mk___split_fields r__split_fields3))))
(assert (= cu__split_fields5 cu__split_fields3))
(assert (= r__split_fields5 (mk___split_fields r__split_fields3)))
