...
(define-fun use_maps__apply_f_4__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_maps__apply_f_4__cu__assume)))
(assert (and (= use_maps__apply_f_4__cu__assume1 (first (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (ite (= (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true) (= (bool_eq1 use_maps__apply_f_4__cu__assume1 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_maps__apply_f_4__cu__assume1) true) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_maps__apply_f_4__cu__assume1) 1)))))
...
(assert (= result1 true))
(assert (= (capacity (mk___rep s__split_discrs s__split_fields2)) (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
...
(assert (= result2 true))
(assert (and (= o4 (keys (mk___rep s__split_discrs s__split_fields2))) (and (and (and (and (= (length3 o4) (length (mk___rep s__split_discrs s__split_fields2))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element o4 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 o4 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true)) (and (< 0 (find o4 key2)) (= (get1 o4 (find o4 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (= (find o4 (get1 o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs s__split_fields2)))) (=> (= (get1 o4 i1) (get1 o4 j)) (= i1 j)))))))))
(assert (and (= o5 (get1 o4 i)) (in_range5 o5)))
(assert (not (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o5) true)))
(check-sat)
(exit)
