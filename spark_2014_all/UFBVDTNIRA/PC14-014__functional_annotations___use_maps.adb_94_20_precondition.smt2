...
(assert (and (= o (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (not (= (has_key1 o no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key1 o i2) true) (and (and (<= 1 (get2 o i2)) (<= (get2 o i2) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (forall ((j us_rep1)) (=> (= (has_key1 o j) true) (=> (= (get2 o i2) (get2 o j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o1 (get2 o (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range6 o1) (=> (= (of_int 0) true) (and (= o1 (w_get1 o (witness1 o (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k1 us_rep1)) (=> (= (has_key1 o k1) true) (= (= (bool_eq1 k1 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness1 o (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness1 o k1))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o6 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (and (and (and (= (length3 o6) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element o6 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 o6 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) key2) true)) (and (< 0 (find o6 key2)) (= (get1 o6 (find o6 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (= (find o6 (get1 o6 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (=> (= (get1 o6 i2) (get1 o6 j)) (= i2 j)))))))))
(assert (and (= o7 (get1 o6 i)) (in_range5 o7)))
(assert (not (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7) true)))
(check-sat)
(exit)
