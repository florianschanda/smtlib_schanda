...
(assert (= result24 (int__content p__sqrt_von_neumann__result4)))
(assert (not (<= (* (int__content p__sqrt_von_neumann__result4) (int__content p__sqrt_von_neumann__result4)) x)))
(check-sat)
(exit)
