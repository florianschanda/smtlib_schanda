...
(assert (<= 1 i2))
(assert (<= i2 (- (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1)))
(assert (not (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i2)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i2))))))
(check-sat)
(exit)
