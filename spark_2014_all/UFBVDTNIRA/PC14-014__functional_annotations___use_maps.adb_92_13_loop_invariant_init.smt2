...
(assert (and (= result1 (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields2))) (= (= result1 true) (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields2)) true))))
(assert (= result1 true))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (- (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields2)) 1)))
(assert (not (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) i))))))
(check-sat)
(exit)
