...
(assert (= new_v1 o))
(assert (=> (not (= new_v1 #x0000000000000000)) (in_range1 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v1 #x0000000000000000)) (and (= o1 (+ result__2 shift_amount2)) (in_range1 (+ result__2 shift_amount2)))))
