...
(assert (= new_v1 o))
(assert (=> (not (= new_v1 ((_ int2bv 64) 0))) (in_range1 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v1 ((_ int2bv 64) 0))) (and (= o1 (+ result__2 shift_amount2)) (in_range1 (+ result__2 shift_amount2)))))
...
(assert (=> (not (not (= new_v1 ((_ int2bv 64) 0)))) (= result__3 result__2)))
