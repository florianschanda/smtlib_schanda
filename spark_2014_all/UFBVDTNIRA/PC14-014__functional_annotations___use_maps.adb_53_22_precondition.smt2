...
(assert (= result2 true))
(assert (and (= o11 (keys s)) (and (and (and (and (= (length3 o11) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element o11 temp___474) true)) (= (has_key (model__ s) (get o11 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o11 key2)) (= (get o11 (find o11 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o11 (get o11 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o11 i1) (get o11 j)) (= i1 j)))))))))
(assert (and (= o12 (get o11 i)) (in_range4 o12)))
(assert (= o10 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o10 o12)) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o10 k) true)) (= k o12))) (= result3 true)))))
(assert (= result3 true))
