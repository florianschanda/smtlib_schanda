...
(assert (and (= o6 (keys s)) (and (and (and (and (= (length3 o6) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o6 temp___431) true)) (= (has_key (model__ s) (get o6 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o6 key2)) (= (get o6 (find o6 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (= (find o6 (get o6 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o6 i2) (get o6 j)) (= i2 j)))))))))
