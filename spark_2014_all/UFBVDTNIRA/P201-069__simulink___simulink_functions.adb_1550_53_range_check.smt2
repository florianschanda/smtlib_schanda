...
(define-fun source__ref___6__projection ((a source__ref)) source (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_319 (_ BitVec 32)) (temp___is_init_315 Bool) (temp___skip_constant_316 Bool) (temp___do_toplevel_317 Bool) (temp___do_typ_inv_318 Bool)) Bool true)
...
(define-fun target__ref___6__projection ((a target__ref)) target (target__content a))
(define-fun dynamic_invariant2 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_326)))
(declare-fun u32toint32 ((_ BitVec 32)) Int)
(declare-fun u32toint32__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (u32toint32 s) true false true true)) :pattern ((u32toint32 s)))))
