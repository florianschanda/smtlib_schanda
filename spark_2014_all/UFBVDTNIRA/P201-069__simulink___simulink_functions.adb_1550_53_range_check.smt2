...
(define-fun dynamic_invariant1 ((temp___expr_273 (_ BitVec 32)) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_279 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_279)))
(declare-fun u32toint32 ((_ BitVec 32)) Int)
(declare-fun u32toint32__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (u32toint32 s) true false true)) :pattern ((u32toint32 s)))))
