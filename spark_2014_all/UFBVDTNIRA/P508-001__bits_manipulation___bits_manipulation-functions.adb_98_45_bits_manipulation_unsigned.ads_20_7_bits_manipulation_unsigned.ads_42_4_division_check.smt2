...
(assert (= new_v3 o))
(assert (=> (not (= new_v3 ((_ int2bv 8) 0))) (in_range1 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v3 ((_ int2bv 8) 0))) (and (= o1 (+ result__2 shift_amount2)) (in_range1 (+ result__2 shift_amount2)))))
(assert (=> (not (= new_v3 ((_ int2bv 8) 0))) (= result__2 result4)))
(assert (=> (not (= new_v3 ((_ int2bv 8) 0))) (= result__3 o1)))
(assert (=> (not (= new_v3 ((_ int2bv 8) 0))) (= v2 result5)))
(assert (=> (not (= new_v3 ((_ int2bv 8) 0))) (= v3 new_v3)))
(assert (=> (= new_v3 ((_ int2bv 8) 0)) (= v3 v2)))
(assert (=> (= new_v3 ((_ int2bv 8) 0)) (= result__3 result__2)))
