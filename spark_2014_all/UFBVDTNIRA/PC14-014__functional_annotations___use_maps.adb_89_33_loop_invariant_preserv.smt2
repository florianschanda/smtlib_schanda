...
(define-fun temp___8711 () us_rep1 (mk___rep1 (mk___split_fields1 temp___871)))
...
(assert (and (= temp___8711 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get2 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields4)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 temp___8711 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8711) true) (= (get2 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8711) (+ (get2 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields4)) 1))))))
