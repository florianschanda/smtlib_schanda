...
(define-fun dynamic_invariant ((temp___expr_218 (_ BitVec 64)) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool true)
(declare-const null_address (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-sort pvoid 0)
(define-fun in_range1 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 18446744073709551615))))
...
(assert (forall ((x (_ BitVec 64))) (! (let ((y (bvurem x ((_ int2bv 64) 0)))) (=> (in_range1 y) (= (to_rep (of_rep x)) y))) :pattern ((to_rep (of_rep x))))))
...
(define-fun dynamic_invariant2 ((temp___expr_182 (_ BitVec 32)) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool true)
...
(assert (forall ((queuelength (_ BitVec 32))) (forall ((itemsize Int)) (! (=> (and (dynamic_invariant2 queuelength true true true) (dynamic_invariant1 itemsize true true true)) (in_range1 (xqueue_create queuelength itemsize))) :pattern ((xqueue_create queuelength itemsize))))))
(define-fun dynamic_invariant3 ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 2)) (in_range2 temp___expr_446)))
