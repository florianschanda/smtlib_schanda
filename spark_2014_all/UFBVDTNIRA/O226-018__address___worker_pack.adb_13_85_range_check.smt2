...
(define-fun dynamic_invariant3 ((temp___expr_452 Int) (temp___is_init_449 Bool) (temp___skip_constant_450 Bool) (temp___do_toplevel_451 Bool)) Bool (=> (or (= temp___is_init_449 true) (<= 0 2)) (in_range2 temp___expr_452)))
