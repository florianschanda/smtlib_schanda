...
(assert (forall ((x pvoid)) (! (uint_in_range1 (to_int3 x)) :pattern ((to_int3 x)))))
...
(assert (forall ((x action)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 0 2)) (in_range1 temp___expr_503)))
(declare-const worker_queue (_ BitVec 64))
(assert (= worker_queue #x0000000000000000))
