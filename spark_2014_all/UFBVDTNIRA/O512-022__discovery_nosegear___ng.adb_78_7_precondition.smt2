...
(declare-fun user_eq (velocity velocity) Bool)
(declare-const dummy velocity)
...
(define-fun dynamic_invariant1 ((temp___expr_235 (_ BitVec 16)) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_249 (_ BitVec 16)) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool true)
...
(assert (= currtime1 #x0064))
(assert (= result1 thistime))
(assert (= thistime1 #x0005))
(assert (= result2 thiscount))
(assert (= thiscount1 #x0014))
...
(assert (not (not (= thiscount1 prevcount))))
(check-sat)
(exit)
