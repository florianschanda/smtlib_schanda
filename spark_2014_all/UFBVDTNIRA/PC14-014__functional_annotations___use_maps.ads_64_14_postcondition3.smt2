...
(assert (in_range4 temp___890))
(assert (= (iter_has_element (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) temp___890) true))
(assert (not (= (get (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) temp___890)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) temp___890))))))
(check-sat)
(exit)
