...
(assert (<= (get1 (positions s) (mk___rep1 cu__split_fields3)) i3))
(assert (<= i3 (length s)))
(assert (not (not (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (get (keys s) i3)) true))))
(check-sat)
(exit)
