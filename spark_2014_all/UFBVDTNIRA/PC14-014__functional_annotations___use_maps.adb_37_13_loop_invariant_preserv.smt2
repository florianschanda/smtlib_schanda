...
(assert (and (= temp___7961 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq3 temp___7961 no_element) true) (and (= (has_key1 (positions s) temp___7961) true) (= (get1 (positions s) temp___7961) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
...
(assert (<= i (length s)))
(assert (not (not (= (has_key (model__ (mk___rep r__split_discrs r__split_fields3)) (get (keys s) i)) true))))
(check-sat)
(exit)
