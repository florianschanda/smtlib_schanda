...
(declare-const use_maps__apply_f_2__cu__assume count_type)
(declare-const temp___849 count_type)
(declare-const temp___848 count_type)
(declare-const temp___8481 hash_type)
(declare-const temp___8482 us_main_type)
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const temp___847 count_type)
(declare-const o3 Bool)
(declare-const temp___863 us_rep2)
...
(define-fun temp___8471 () us_rep3 (mk___rep1 (mk___split_fields1 temp___847)))
(define-fun use_maps__apply_f_2__cu__assume1 () us_rep3 (mk___rep1 (mk___split_fields1 use_maps__apply_f_2__cu__assume)))
(assert (<= (length s) (to_rep1 (rec__use_maps__my_maps__map__capacity r__split_discrs))))
(assert (and (= use_maps__apply_f_2__cu__assume1 (first s)) (ite (= (= (length s) 0) true) (= (bool_eq3 use_maps__apply_f_2__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_maps__apply_f_2__cu__assume1) true) (= (get1 (positions s) use_maps__apply_f_2__cu__assume1) 1)))))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result)) (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields))))
(assert (= use_maps__apply_f_2__cu__assume cu__split_fields1))
...
(assert (=> (= result1 true) (= temp___849 cu__split_fields1)))
(assert (=> (= result1 true) (and (= r__split_discrs (mk___split_discrs temp___848 temp___8481)) (= temp___8482 r__split_fields))))
(assert (=> (= result1 true) (= (length (mk___rep r__split_discrs r__split_fields10)) (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (and (= (has_key (model__ (mk___rep r__split_discrs r__split_fields10)) (get (keys s) i)) true) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields10)) (get (keys s) i)) (f (get2 (model__ s) (get (keys s) i)))))))))
(assert (=> (= result1 true) (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___854 Int)) (=> (and (in_range4 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get temp___855 temp___854) (get (keys s) i)))))))))
...
(assert (=> (= result1 true) (and (= temp___8471 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq3 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq3 temp___8471 no_element) true) (and (= (has_key1 (positions s) temp___8471) true) (= (get1 (positions s) temp___8471) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___847))))
...
(assert (and (= temp___863 (keys s)) (and (and (and (and (= (length2 temp___863) (length s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element temp___863 temp___474) true)) (= (has_key (model__ s) (get temp___863 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find temp___863 key1)) (= (get temp___863 (find temp___863 key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___863 (get temp___863 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___863 i) (get temp___863 j)) (= i j)))))))))
(assert (and (= o4 (iter_has_element temp___863 temp___862)) (= (= o4 true) (and (<= 1 temp___862) (<= temp___862 (last temp___863))))))
(assert (= (= o5 true) (in_range4 temp___862)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (not (<= 1 temp___862)))
(check-sat)
(exit)
