...
(define-fun dynamic_invariant1 ((temp___expr_249 (_ BitVec 32)) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool true)
...
(assert (forall ((x (_ BitVec 32))) (! (=> (dynamic_invariant1 x true true true true) (let ((result (sqrt_von_neumann_aux32 x))) (and (and (and (bvule (bvmul result result) x) (bvuge (bvsub (bvmul (bvadd result #x00000001) (bvadd result #x00000001)) #x00000001) x)) (=> (bvule x #x7FFFFFFF) (bvule result #x0000B504))) (dynamic_invariant1 result true false true true)))) :pattern ((sqrt_von_neumann_aux32 x)))))
(declare-const x Int)
