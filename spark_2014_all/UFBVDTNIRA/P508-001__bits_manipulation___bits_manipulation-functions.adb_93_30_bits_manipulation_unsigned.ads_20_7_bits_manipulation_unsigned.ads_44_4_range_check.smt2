...
(define-fun dynamic_invariant1 ((temp___expr_366 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool) (temp___do_typ_inv_365 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 0 31)) (in_range1 temp___expr_366)))
...
(assert (not (= v1 #x00000000)))
(assert (and (and (=> (<= 0 31) (in_range1 result__2)) (=> (<= 0 31) (in_range1 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 #x00000000)))))
(assert (and (= o (shift_right v2 shift_amount2)) (= o (ite (and (<= 1 32) (<= 32 8)) ((_ zero_extend 24) (ite (< shift_amount2 8) (bvlshr ((_ extract 7 0) v2) ((_ int2bv 8) shift_amount2)) #x00)) (ite (and (<= 9 32) (<= 32 16)) ((_ zero_extend 16) (ite (< shift_amount2 16) (bvlshr ((_ extract 15 0) v2) ((_ int2bv 16) shift_amount2)) #x0000)) (ite (and (<= 17 32) (<= 32 32)) (bvlshr v2 ((_ int2bv 32) shift_amount2)) ((_ extract 31 0) (bvlshr ((_ zero_extend 32) v2) ((_ int2bv 64) shift_amount2)))))))))
(assert (= new_v result3))
(assert (= new_v1 o))
(assert (not (= new_v1 #x00000000)))
