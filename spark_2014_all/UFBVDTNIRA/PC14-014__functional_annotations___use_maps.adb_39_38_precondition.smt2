...
(assert (let ((temp___812 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___811 Int)) (=> (and (in_range3 temp___811) (= (iter_has_element temp___812 temp___811) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___812 temp___811)) (f (get2 (model__ s) (get (keys s) i))))))))))
