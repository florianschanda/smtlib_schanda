...
(assert (not (or (< (length (mk___rep r__split_discrs r__split_fields3)) (to_rep1 (rec__use_sets__my_sets__set__capacity r__split_discrs))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) o1) true))))
(check-sat)
(exit)
