...
(assert (= (iter_has_element (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___768) true))
(assert (not (exists ((i3 Int)) (and (and (<= 1 i3) (<= i3 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___768)) (f (get2 (model__ s) (get (keys s) i3))))))))
(check-sat)
(exit)
