...
(declare-const temp___808 us_rep2)
...
(assert (and (= temp___808 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length2 temp___808) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element temp___808 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___808 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___808 key1)) (= (get temp___808 (find temp___808 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___808 (get temp___808 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___808 i1) (get temp___808 j)) (= i1 j)))))))))
(assert (and (= o (iter_has_element temp___808 temp___807)) (= (= o true) (and (<= 1 temp___807) (<= temp___807 (last temp___808))))))
(assert (= (= o1 true) (in_range4 temp___807)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= k (get temp___808 temp___807)) (in_range3 k)))
