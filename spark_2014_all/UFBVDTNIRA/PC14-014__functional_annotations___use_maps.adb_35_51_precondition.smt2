...
(assert (and (= temp___808 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length3 temp___808) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___808 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___808 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___808 key2)) (= (get temp___808 (find temp___808 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___808 (get temp___808 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___808 i1) (get temp___808 j)) (= i1 j)))))))))
(assert (and (= o (iter_has_element temp___808 temp___807)) (= (= o true) (and (<= 1 temp___807) (<= temp___807 (last temp___808))))))
(assert (= (= o1 true) (in_range3 temp___807)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= k (get temp___808 temp___807)) (in_range4 k)))
(assert (and (= o2 (positions s)) (and (not (= (has_key1 o2 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key1 o2 i1) true) (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length s))) (forall ((j us_rep1)) (=> (= (has_key1 o2 j) true) (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o3 (get1 o2 (mk___rep1 cu__split_fields3))) (and (in_range5 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 cu__split_fields3)))) (forall ((k1 us_rep1)) (=> (= (has_key1 o2 k1) true) (= (= (bool_eq1 k1 (mk___rep1 cu__split_fields3)) true) (= (witness o2 (mk___rep1 cu__split_fields3)) (witness o2 k1))))))))))
(assert (= o4 (- o3 1)))
