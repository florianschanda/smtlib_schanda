...
(assert (and (= temp___765 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length3 temp___765) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___765 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___765 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___765 key2)) (= (get temp___765 (find temp___765 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___765 (get temp___765 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___765 i) (get temp___765 j)) (= i j)))))))))
