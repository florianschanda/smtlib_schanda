...
(assert (and (= o8 (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7)) (and (in_range3 o8) (=> (= (of_int 1) true) (and (= o8 (w_get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7))) (forall ((k2 Int)) (=> (and (in_range2 k2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k2) true)) (= (= k2 o7) (= (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7) (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k2))))))))))
(assert (and (= o9 (f o8)) (and (in_range9 o9) (= o9 (ite (and (<= (- 100) o8) (<= o8 100)) (* o8 2) o8)))))
(assert (and (= o4 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (and (and (and (= (length3 o4) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element o4 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 o4 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) key2) true)) (and (< 0 (find o4 key2)) (= (get1 o4 (find o4 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (= (find o4 (get1 o4 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (=> (= (get1 o4 i2) (get1 o4 j)) (= i2 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
