...
(assert (= (iter_has_element (elements s) temp___892) true))
(assert (not (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))) (f (get (elements s) temp___892))) true)))
(check-sat)
(exit)
