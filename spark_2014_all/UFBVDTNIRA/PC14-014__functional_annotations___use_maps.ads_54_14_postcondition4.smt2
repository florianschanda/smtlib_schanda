...
(assert (= result1 true))
(assert (and (= s__split_discrs (mk___split_discrs temp___833 temp___8331)) (= s__split_fields temp___8332)))
(assert (= temp___838 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___834 (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___832 cu__split_fields1))
(assert (= temp___836 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___837 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___835 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___834))
(assert (= (oeq3 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___835) true))
(assert (= (oeq2 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___836) true))
