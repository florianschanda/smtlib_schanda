...
(assert (= (iter_has_element (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___811) true))
(assert (not (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___811) (get (keys s) i2))))))
(check-sat)
(exit)
