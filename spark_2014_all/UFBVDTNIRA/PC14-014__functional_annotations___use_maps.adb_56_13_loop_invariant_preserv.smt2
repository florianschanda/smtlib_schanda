...
(assert (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___854 Int)) (=> (and (in_range3 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get temp___855 temp___854) (get (keys s) i))))))))
...
(assert (and (= temp___8471 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___8471 no_element) true) (and (= (has_key1 (positions s) temp___8471) true) (= (get1 (positions s) temp___8471) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
...
(define-fun temp___855 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields3)))
(declare-const temp___854 Int)
(assert (in_range3 temp___854))
(assert (= (iter_has_element temp___855 temp___854) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___855 temp___854) (get (keys s) i))))))
(check-sat)
(exit)
