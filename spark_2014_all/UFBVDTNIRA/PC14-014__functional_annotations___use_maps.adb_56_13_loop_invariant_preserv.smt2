...
(assert (let ((temp___812 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___811 Int)) (=> (and (in_range3 temp___811) (= (iter_has_element temp___812 temp___811) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get temp___812 temp___811) (get (keys s) i))))))))
...
(assert (and (= temp___8041 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___8041 no_element) true) (and (= (has_key1 (positions s) temp___8041) true) (= (get1 (positions s) temp___8041) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
...
(define-fun temp___812 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields3)))
(declare-const temp___811 Int)
(assert (in_range3 temp___811))
(assert (= (iter_has_element temp___812 temp___811) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___812 temp___811) (get (keys s) i))))))
(check-sat)
(exit)
