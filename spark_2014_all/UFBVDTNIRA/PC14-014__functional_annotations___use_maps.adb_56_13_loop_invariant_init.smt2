...
(assert (= (iter_has_element (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields))) temp___811) true))
(assert (not (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1))) (= (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields))) temp___811) (get (keys s) i2))))))
(check-sat)
(exit)
