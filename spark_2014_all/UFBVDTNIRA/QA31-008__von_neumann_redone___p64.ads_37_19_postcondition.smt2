...
(define-fun dynamic_invariant ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 9223372036854775807)) (in_range2 temp___expr_235)))
...
(define-fun dynamic_invariant1 ((temp___expr_249 (_ BitVec 64)) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool true)
...
(assert (forall ((x (_ BitVec 64))) (! (=> (dynamic_invariant1 x true true true true) (let ((result (sqrt_von_neumann_aux64 x))) (and (and (and (bvule (bvmul result result) x) (bvuge (bvsub (bvmul (bvadd result #x0000000000000001) (bvadd result #x0000000000000001)) #x0000000000000001) x)) (=> (bvule x #x7FFFFFFFFFFFFFFF) (bvule result #x00000000B504F333))) (dynamic_invariant1 result true false true true)))) :pattern ((sqrt_von_neumann_aux64 x)))))
(declare-const x Int)
