...
(assert (forall ((x (_ BitVec 64))) (! (=> (dynamic_invariant x true true true true) (let ((result (sqrt_von_neumann_aux64 x))) (and (and (and (bvule (bvmul result result) x) (bvuge (bvsub (bvmul (bvadd result #x0000000000000001) (bvadd result #x0000000000000001)) #x0000000000000001) x)) (=> (bvule x #x7FFFFFFFFFFFFFFF) (bvule result #x00000000B504F333))) (dynamic_invariant result true false true true)))) :pattern ((sqrt_von_neumann_aux64 x)))))
(declare-sort sqrt_domain64 0)
(declare-fun sqrt_domain64qtint (sqrt_domain64) Int)
(assert (forall ((i sqrt_domain64)) (and (<= 0 (sqrt_domain64qtint i)) (<= (sqrt_domain64qtint i) 9223372036854775807))))
(define-fun in_range2 ((x Int)) Bool (and (<= 0 x) (<= x 9223372036854775807)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq2 (sqrt_domain64 sqrt_domain64) Bool)
(declare-const dummy2 sqrt_domain64)
...
(define-fun dynamic_invariant1 ((temp___expr_235 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 9223372036854775807)) (in_range2 temp___expr_235)))
(declare-sort sqrt_range64 0)
(declare-fun sqrt_range64qtint (sqrt_range64) Int)
(assert (forall ((i sqrt_range64)) (and (<= 0 (sqrt_range64qtint i)) (<= (sqrt_range64qtint i) 3037000499))))
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 3037000499)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq3 (sqrt_range64 sqrt_range64) Bool)
(declare-const dummy3 sqrt_range64)
...
(define-fun dynamic_invariant2 ((temp___expr_25 Int) (temp___is_init_21 Bool) (temp___skip_constant_22 Bool) (temp___do_toplevel_23 Bool) (temp___do_typ_inv_24 Bool)) Bool (=> (or (= temp___is_init_21 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_25)))
(define-fun dynamic_invariant3 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 3037000499)) (in_range3 temp___expr_242)))
...
(assert (and (= o (sqrt_von_neumann_aux64 ((_ int2bv 64) x))) (and (and (bvule (bvmul o o) ((_ int2bv 64) x)) (bvuge (bvsub (bvmul (bvadd o #x0000000000000001) (bvadd o #x0000000000000001)) #x0000000000000001) ((_ int2bv 64) x))) (=> (bvule ((_ int2bv 64) x) #x7FFFFFFFFFFFFFFF) (bvule o #x00000000B504F333)))))
(assert (= o1 (bv2nat o)))
...
(assert (< p64__sqrt_von_neumann64__result4 3037000499))
(assert (not (< x (* (+ p64__sqrt_von_neumann64__result4 1) (+ p64__sqrt_von_neumann64__result4 1)))))
(check-sat)
(exit)
