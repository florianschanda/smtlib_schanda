...
(assert (= (iter_has_element (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) temp___870) true))
(assert (not (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) temp___870) (f (get (elements s) i2)))))))
(check-sat)
(exit)
