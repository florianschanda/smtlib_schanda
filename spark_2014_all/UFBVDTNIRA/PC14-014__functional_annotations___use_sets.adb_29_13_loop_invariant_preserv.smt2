...
(define-fun temp___9051 () us_rep1 (mk___rep1 (mk___split_fields1 temp___905)))
...
(assert (let ((temp___913 (elements (mk___rep r__split_discrs r__split_fields5)))) (forall ((temp___912 Int)) (=> (and (in_range2 temp___912) (= (iter_has_element temp___913 temp___912) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get temp___913 temp___912) (f (get (elements s) i)))))))))
...
(assert (and (= temp___9051 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___9051 no_element) true) (and (= (has_key (positions s) temp___9051) true) (= (get1 (positions s) temp___9051) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result2 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___905)))
...
(define-fun temp___913 () us_rep2 (elements (mk___rep r__split_discrs r__split_fields4)))
(declare-const temp___912 Int)
(assert (in_range2 temp___912))
(assert (= (iter_has_element temp___913 temp___912) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___913 temp___912) (f (get (elements s) i)))))))
(check-sat)
(exit)
