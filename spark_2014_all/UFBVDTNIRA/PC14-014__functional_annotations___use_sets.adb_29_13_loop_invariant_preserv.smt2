...
(assert (= result1 true))
(assert (<= (length (mk___rep r__split_discrs r__split_fields5)) (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1)))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (contains (model__ (mk___rep r__split_discrs r__split_fields5)) (f (get (elements s) i))) true))))
(assert (let ((temp___871 (elements (mk___rep r__split_discrs r__split_fields5)))) (forall ((temp___870 Int)) (=> (and (in_range2 temp___870) (= (iter_has_element temp___871 temp___870) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get temp___871 temp___870) (f (get (elements s) i)))))))))
...
(assert (and (= temp___8631 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___8631 no_element) true) (and (= (has_key (positions s) temp___8631) true) (= (get1 (positions s) temp___8631) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
...
(define-fun temp___871 () us_rep2 (elements (mk___rep r__split_discrs r__split_fields4)))
(declare-const temp___870 Int)
(assert (in_range2 temp___870))
(assert (= (iter_has_element temp___871 temp___870) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___871 temp___870) (f (get (elements s) i)))))))
(check-sat)
(exit)
