...
(assert (= result1 true))
(define-fun temp___871 () us_rep2 (elements (mk___rep r__split_discrs r__split_fields2)))
(declare-const temp___870 Int)
(assert (in_range2 temp___870))
(assert (= (iter_has_element temp___871 temp___870) true))
(assert (not (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields2)) 1))) (= (get temp___871 temp___870) (f (get (elements s) i)))))))
(check-sat)
(exit)
