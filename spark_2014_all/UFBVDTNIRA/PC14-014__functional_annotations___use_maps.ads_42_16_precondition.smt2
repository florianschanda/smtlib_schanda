...
(define-fun temp___7531 () us_rep1 (mk___rep1 (mk___split_fields1 temp___753)))
...
(assert (=> (= result1 true) (and (= r__split_discrs (mk___split_discrs temp___754 temp___7541)) (= temp___7542 r__split_fields))))
(assert (=> (= result1 true) (= (length (mk___rep r__split_discrs r__split_fields10)) (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (let ((temp___763 (keys (mk___rep r__split_discrs r__split_fields10)))) (exists ((temp___762 Int)) (and (and (in_range3 temp___762) (= (iter_has_element temp___763 temp___762) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields10)) (get temp___763 temp___762)) (f (get2 (model__ s) (get (keys s) i)))))))))))
(assert (=> (= result1 true) (let ((temp___769 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___768 Int)) (=> (and (in_range3 temp___768) (= (iter_has_element temp___769 temp___768) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields10)) (get temp___769 temp___768)) (f (get2 (model__ s) (get (keys s) i)))))))))))
...
(assert (=> (= result1 true) (and (= temp___7531 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___7531 no_element) true) (and (= (has_key1 (positions s) temp___7531) true) (= (get1 (positions s) temp___7531) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___753))))
...
(assert (and (= temp___783 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___783) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___783 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___783 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___783 key2)) (= (get temp___783 (find temp___783 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___783 (get temp___783 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___783 i) (get temp___783 j)) (= i j)))))))))
(assert (and (= o4 (iter_has_element temp___783 temp___782)) (= (= o4 true) (and (<= 1 temp___782) (<= temp___782 (last temp___783))))))
(assert (= (= o5 true) (in_range3 temp___782)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (and (= l (get temp___783 temp___782)) (in_range4 l)))
(assert (and (= temp___785 (keys s)) (and (and (and (and (= (length3 temp___785) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___785 temp___431) true)) (= (has_key (model__ s) (get temp___785 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___785 key2)) (= (get temp___785 (find temp___785 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___785 (get temp___785 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___785 i) (get temp___785 j)) (= i j)))))))))
(assert (and (= o6 (iter_has_element temp___785 temp___784)) (= (= o6 true) (and (<= 1 temp___784) (<= temp___784 (last temp___785))))))
(assert (= (= o7 true) (in_range3 temp___784)))
(assert (= result5 (ite (= o7 true) o6 false)))
(assert (= result5 true))
(assert (not (<= 1 temp___784)))
(check-sat)
(exit)
