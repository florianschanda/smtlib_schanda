...
(assert (and (= temp___783 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___783) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___783 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___783 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___783 key2)) (= (get temp___783 (find temp___783 key2)) key2))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___783 (get temp___783 i3)) i3)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___783 i3) (get temp___783 j)) (= i3 j)))))))))
(assert (and (= o43 (iter_has_element temp___783 temp___782)) (= (= o43 true) (and (<= 1 temp___782) (<= temp___782 (last temp___783))))))
(assert (= (= o44 true) (in_range3 temp___782)))
(assert (= result9 (ite (= o44 true) o43 false)))
(assert (= result9 true))
(assert (and (= l1 (get temp___783 temp___782)) (in_range4 l1)))
(assert (and (= temp___785 (keys s)) (and (and (and (and (= (length3 temp___785) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___785 temp___431) true)) (= (has_key (model__ s) (get temp___785 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___785 key2)) (= (get temp___785 (find temp___785 key2)) key2))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (= (find temp___785 (get temp___785 i3)) i3)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___785 i3) (get temp___785 j)) (= i3 j)))))))))
(assert (and (= o45 (iter_has_element temp___785 temp___784)) (= (= o45 true) (and (<= 1 temp___784) (<= temp___784 (last temp___785))))))
(assert (= (= o46 true) (in_range3 temp___784)))
(assert (= result10 (ite (= o46 true) o45 false)))
