...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (dynamic_invariant1 key true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= k key))) (= (has_key container key) true)))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant2 ((temp___expr_422 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range4 temp___expr_422)))
(define-fun dynamic_invariant3 ((temp___expr_429 Int) (temp___is_init_425 Bool) (temp___skip_constant_426 Bool) (temp___do_toplevel_427 Bool) (temp___do_typ_inv_428 Bool)) Bool (=> (or (= temp___is_init_425 true) (<= 0 2147483647)) (in_range3 temp___expr_429)))
...
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant5 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= key2 (get container result)))) (dynamic_invariant result true false true true)))) :pattern ((find container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true true) (= (has_key container key2) true)) (let ((result (get2 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= k key2) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant9 result true false true true)))) :pattern ((get2 container key2))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((new_key Int)) (! (=> (dynamic_invariant1 new_key true true true true) (= (= (keys_included_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key left key2) true)) (=> (not (= key2 new_key)) (= (has_key right key2) true)))))) :pattern ((keys_included_except left right new_key))))))
...
(declare-const temp___826 us_rep3)
(declare-const temp___825 Int)
(declare-const o4 Bool)
(declare-const o5 Bool)
(declare-const l Int)
(declare-const temp___828 us_rep3)
...
(define-fun temp___7961 () us_rep1 (mk___rep1 (mk___split_fields1 temp___796)))
(define-fun use_maps__apply_f__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_maps__apply_f__cu__assume)))
(assert (<= (length s) (to_rep (rec__use_maps__my_maps__map__capacity r__split_discrs))))
(assert (and (= use_maps__apply_f__cu__assume1 (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 use_maps__apply_f__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_maps__apply_f__cu__assume1) true) (= (get1 (positions s) use_maps__apply_f__cu__assume1) 1)))))
...
(assert (=> (= result1 true) (and (= temp___7961 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___7961 no_element) true) (and (= (has_key1 (positions s) temp___7961) true) (= (get1 (positions s) temp___7961) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
...
(assert (and (= temp___826 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___826) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___826 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___826 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___826 key2)) (= (get temp___826 (find temp___826 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___826 (get temp___826 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___826 i) (get temp___826 j)) (= i j)))))))))
(assert (and (= o4 (iter_has_element temp___826 temp___825)) (= (= o4 true) (and (<= 1 temp___825) (<= temp___825 (last temp___826))))))
(assert (= (= o5 true) (in_range3 temp___825)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (and (= l (get temp___826 temp___825)) (in_range4 l)))
(assert (and (= temp___828 (keys s)) (and (and (and (and (= (length3 temp___828) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___828 temp___474) true)) (= (has_key (model__ s) (get temp___828 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___828 key2)) (= (get temp___828 (find temp___828 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___828 (get temp___828 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___828 i) (get temp___828 j)) (= i j)))))))))
(assert (and (= o6 (iter_has_element temp___828 temp___827)) (= (= o6 true) (and (<= 1 temp___827) (<= temp___827 (last temp___828))))))
(assert (= (= o7 true) (in_range3 temp___827)))
(assert (= result5 (ite (= o7 true) o6 false)))
(assert (= result5 true))
(assert (not (<= 1 temp___827)))
(check-sat)
(exit)
