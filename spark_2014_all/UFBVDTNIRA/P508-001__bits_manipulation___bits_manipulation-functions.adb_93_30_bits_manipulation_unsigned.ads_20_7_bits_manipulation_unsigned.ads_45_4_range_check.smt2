...
(assert (and (and (=> (<= 0 63) (in_range1 result__2)) (=> (<= 0 63) (in_range1 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 ((_ int2bv 64) 0))))))
(assert (and (= o (shift_right v2 shift_amount2)) (= o (ite (and (<= 1 64) (<= 64 8)) ((_ zero_extend 56) (ite (< shift_amount2 8) (bvlshr ((_ extract 7 0) v2) ((_ int2bv 8) shift_amount2)) ((_ int2bv 8) 0))) (ite (and (<= 9 64) (<= 64 16)) ((_ zero_extend 48) (ite (< shift_amount2 16) (bvlshr ((_ extract 15 0) v2) ((_ int2bv 16) shift_amount2)) ((_ int2bv 16) 0))) (ite (and (<= 17 64) (<= 64 32)) ((_ zero_extend 32) (bvlshr ((_ extract 31 0) v2) ((_ int2bv 32) shift_amount2))) (bvlshr v2 ((_ int2bv 64) shift_amount2))))))))
(assert (= new_v result3))
(assert (= new_v1 o))
(assert (not (= new_v1 ((_ int2bv 64) 0))))
(assert (in_range1 (+ result__2 shift_amount2)))
(assert (not (in_range1 (+ result__2 shift_amount2))))
(check-sat)
(exit)
