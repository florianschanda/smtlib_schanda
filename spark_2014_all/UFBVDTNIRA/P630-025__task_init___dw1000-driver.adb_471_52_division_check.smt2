...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x08))) (=> (in_range2 y) (= (to_rep (of_rep x)) y))) :pattern ((to_rep (of_rep x))))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x80))) (=> (in_range3 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun in_range4 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x03FF)))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x0400))) (=> (in_range4 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range5 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x04))) (=> (in_range6 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun dynamic_invariant2 ((temp___expr_308 (_ BitVec 8)) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (bvule #x00 #x01)) (in_range5 temp___expr_308)))
(define-fun dynamic_invariant3 ((temp___expr_315 (_ BitVec 8)) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (or (= temp___is_init_311 true) (bvule #x00 #x03)) (in_range6 temp___expr_315)))
(define-fun dynamic_invariant4 ((temp___expr_322 (_ BitVec 8)) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool) (temp___do_typ_inv_321 Bool)) Bool (=> (or (= temp___is_init_318 true) (bvule #x00 #x07)) (in_range2 temp___expr_322)))
(define-fun dynamic_invariant5 ((temp___expr_350 (_ BitVec 8)) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (bvule #x00 #x7F)) (in_range3 temp___expr_350)))
...
(define-fun dynamic_invariant7 ((temp___expr_371 (_ BitVec 16)) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool) (temp___do_typ_inv_370 Bool)) Bool (=> (or (= temp___is_init_367 true) (bvule #x0000 #x03FF)) (in_range4 temp___expr_371)))
...
(declare-const temp___3599 bits_7)
(declare-const temp___35991 bits_3)
(declare-const temp___35992 bits_3)
(declare-const temp___35993 bits_2)
(declare-const temp___35994 bits_1)
(declare-const temp___35995 bits_2)
(declare-const temp___35996 bits_2)
(declare-const temp___35997 bits_2)
(declare-const temp___35998 bits_10)
(declare-const temp___35999 bits_8)
...
(assert (= temp___3599 o3))
(assert (= temp___35991 o4))
(assert (= temp___35992 o5))
(assert (= temp___35993 o6))
(assert (= temp___35994 o7))
(assert (= temp___35995 o8))
(assert (= temp___35996 o9))
(assert (= temp___35997 o10))
(assert (= temp___35998 o11))
(assert (= temp___35999 o12))
...
(assert (= temp___3599 tx_fctrl_reg__split_fields20))
(assert (= temp___35991 tx_fctrl_reg__split_fields21))
(assert (= temp___35992 tx_fctrl_reg__split_fields22))
(assert (= temp___35993 tx_fctrl_reg__split_fields23))
(assert (= temp___35994 tx_fctrl_reg__split_fields24))
(assert (= temp___35995 tx_fctrl_reg__split_fields25))
(assert (= temp___35996 tx_fctrl_reg__split_fields26))
(assert (= temp___35997 tx_fctrl_reg__split_fields27))
(assert (= temp___35998 tx_fctrl_reg__split_fields28))
(assert (= temp___35999 tx_fctrl_reg__split_fields29))
