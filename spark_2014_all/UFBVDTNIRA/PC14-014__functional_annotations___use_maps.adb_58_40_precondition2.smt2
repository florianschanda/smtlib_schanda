...
(declare-const temp___851 us_rep2)
...
(assert (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___854 Int)) (=> (and (in_range4 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___855 temp___854) (get (keys s) i1))))))))
(assert (and (= temp___851 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length2 temp___851) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element temp___851 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___851 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___851 key1)) (= (get temp___851 (find temp___851 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___851 (get temp___851 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___851 i1) (get temp___851 j)) (= i1 j)))))))))
(assert (and (= o (iter_has_element temp___851 temp___850)) (= (= o true) (and (<= 1 temp___850) (<= temp___850 (last temp___851))))))
(assert (= (= o1 true) (in_range4 temp___850)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= k (get temp___851 temp___850)) (in_range3 k)))
(assert (and (= o2 (positions s)) (and (not (= (has_key1 o2 no_element) true)) (forall ((i1 us_rep3)) (=> (= (has_key1 o2 i1) true) (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length s))) (forall ((j us_rep3)) (=> (= (has_key1 o2 j) true) (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq3 i1 j) true))))))))))
(assert (and (= o3 (get1 o2 (mk___rep1 cu__split_fields3))) (and (in_range5 o3) (=> (= (distinct 0 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 cu__split_fields3)))) (forall ((k1 us_rep3)) (=> (= (has_key1 o2 k1) true) (= (= (bool_eq3 k1 (mk___rep1 cu__split_fields3)) true) (= (witness o2 (mk___rep1 cu__split_fields3)) (witness o2 k1))))))))))
(assert (= o4 (- o3 1)))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result3 (ite (<= 1 i) o5 false)))
(assert (= result3 true))
(assert (and (= o6 (keys s)) (and (and (and (and (= (length2 o6) (length s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o6 temp___474) true)) (= (has_key (model__ s) (get o6 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o6 key1)) (= (get o6 (find o6 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o6 (get o6 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o6 i1) (get o6 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
