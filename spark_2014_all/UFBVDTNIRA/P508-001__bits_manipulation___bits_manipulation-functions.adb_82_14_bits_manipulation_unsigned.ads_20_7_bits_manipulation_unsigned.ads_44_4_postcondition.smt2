...
(assert true)
(assert true)
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (= temp___451 shift_amount1)))
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (= temp___450 new_v)))
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (= temp___449 v1)))
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (= temp___448 result__1)))
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (and (and (=> (<= 0 31) (in_range1 result__2)) (=> (<= 0 31) (in_range1 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 ((_ int2bv 32) 0)))))))
...
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (=> (= new_v3 ((_ int2bv 32) 0)) (= v3 v2))))
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (=> (= new_v3 ((_ int2bv 32) 0)) (= result__3 result__2))))
...
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 32) 0)))) (= (mk_int__ref shift_amount6) (mk_int__ref shift_amount4))))
