...
(assert (= result2 true))
(assert (and (= o10 (keys s)) (and (and (and (and (= (length3 o10) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o10 temp___431) true)) (= (has_key (model__ s) (get o10 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o10 key2)) (= (get o10 (find o10 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o10 (get o10 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o10 i1) (get o10 j)) (= i1 j)))))))))
(assert (and (= o11 (get o10 i)) (in_range4 o11)))
(assert (= o9 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o9 o11)) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o9 k) true)) (= k o11))) (= result3 true)))))
(assert (= result3 true))
