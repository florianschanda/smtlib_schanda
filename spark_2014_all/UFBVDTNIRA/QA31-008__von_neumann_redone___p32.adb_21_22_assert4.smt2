...
(assert true)
(assert true)
(assert (not (= (mod (* (mod (+ (bv2nat x) (bv2nat y)) 4294967296) (mod (+ (bv2nat x) (bv2nat y)) 4294967296)) 4294967296) (bv2nat (bvadd (bvmul x x) (bvmul y (bvadd (bvmul ((_ int2bv 32) 2) x) y)))))))
(check-sat)
(exit)
