...
(assert (forall ((i storage_offset)) (and (<= (- 9223372036854775808) (storage_offsetqtint i)) (<= (storage_offsetqtint i) 9223372036854775807))))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_201)))
(assert (forall ((left (_ BitVec 64))) (forall ((right Int)) (! (=> (and (dynamic_invariant1 left true true true true) (dynamic_invariant2 right true true true true)) (dynamic_invariant1 (oadd left right) true false true true)) :pattern ((oadd left right))))))
(declare-fun omod ((_ BitVec 64) Int) Int)
(declare-fun omod__function_guard (Int (_ BitVec 64) Int) Bool)
(assert (forall ((left (_ BitVec 64))) (forall ((right Int)) (! (=> (and (dynamic_invariant1 left true true true true) (dynamic_invariant2 right true true true true)) (dynamic_invariant2 (omod left right) true false true true)) :pattern ((omod left right))))))
...
(define-fun dynamic_invariant3 ((temp___expr_228 (_ BitVec 64)) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool true)
(assert (forall ((value (_ BitVec 64))) (! (=> (dynamic_invariant3 value true true true true) (dynamic_invariant1 (to_address value) true false true true)) :pattern ((to_address value)))))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant4 (zero us_void_param) true false true true) :pattern ((zero us_void_param)))))
...
(declare-const o Int)
(assert (= pixel__buffer__assume (to_address #x0000000000000000)))
