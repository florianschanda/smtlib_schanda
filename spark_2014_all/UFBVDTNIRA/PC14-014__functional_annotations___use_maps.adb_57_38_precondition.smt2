...
(assert (and (= temp___808 (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (and (and (and (and (= (length3 temp___808) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___808 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get temp___808 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) key2) true)) (and (< 0 (find temp___808 key2)) (= (get temp___808 (find temp___808 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (= (find temp___808 (get temp___808 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (=> (= (get temp___808 i2) (get temp___808 j)) (= i2 j)))))))))
(assert (and (= o16 (iter_has_element temp___808 temp___807)) (= (= o16 true) (and (<= 1 temp___807) (<= temp___807 (last temp___808))))))
(assert (= (= o17 true) (in_range3 temp___807)))
