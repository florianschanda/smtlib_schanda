...
(assert (let ((temp___812 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___811 Int)) (=> (and (in_range3 temp___811) (= (iter_has_element temp___812 temp___811) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___812 temp___811) (get (keys s) i))))))))
(assert (and (= temp___808 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length3 temp___808) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___808 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___808 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___808 key2)) (= (get temp___808 (find temp___808 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___808 (get temp___808 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___808 i) (get temp___808 j)) (= i j)))))))))
