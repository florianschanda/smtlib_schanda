...
(declare-const temp___851 us_rep3)
...
(assert (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___854 Int)) (=> (and (in_range3 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___855 temp___854) (get (keys s) i))))))))
(assert (and (= temp___851 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length3 temp___851) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___851 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___851 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___851 key2)) (= (get temp___851 (find temp___851 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___851 (get temp___851 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___851 i) (get temp___851 j)) (= i j)))))))))
(assert (and (= o (iter_has_element temp___851 temp___850)) (= (= o true) (and (<= 1 temp___850) (<= temp___850 (last temp___851))))))
(assert (= (= o1 true) (in_range3 temp___850)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= k (get temp___851 temp___850)) (in_range4 k)))
