...
(define-fun dynamic_invariant1 ((temp___expr_347 (_ BitVec 32)) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool) (temp___do_typ_inv_346 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_354 (_ BitVec 8)) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool) (temp___do_typ_inv_353 Bool)) Bool true)
(declare-fun u32tou8 ((_ BitVec 32)) (_ BitVec 8))
(declare-fun u32tou8__function_guard ((_ BitVec 8) (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (u32tou8 s) true false true true)) :pattern ((u32tou8 s)))))
