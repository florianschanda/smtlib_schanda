...
(define-fun dynamic_invariant1 ((temp___expr_297 (_ BitVec 32)) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_303 (_ BitVec 8)) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool)) Bool true)
(declare-fun u32tou8 ((_ BitVec 32)) (_ BitVec 8))
(declare-fun u32tou8__function_guard ((_ BitVec 8) (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (u32tou8 s) true false true)) :pattern ((u32tou8 s)))))
