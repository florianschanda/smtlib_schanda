...
(assert (= result6 true))
(assert (and (= o30 i2) (in_range3 i2)))
(assert (and (= o29 (keys s)) (and (and (and (and (= (length3 o29) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o29 temp___431) true)) (= (has_key (model__ s) (get o29 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o29 key2)) (= (get o29 (find o29 key2)) key2))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (= (find o29 (get o29 i3)) i3)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o29 i3) (get o29 j)) (= i3 j)))))))))
(assert (not (<= 1 o30)))
(check-sat)
(exit)
