...
(define-fun temp___840 () us_rep2 (keys s))
(declare-const temp___839 Int)
(assert (in_range4 temp___839))
(assert (= (iter_has_element temp___840 temp___839) true))
(define-fun temp___842 () us_rep2 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))
(assert (not (exists ((temp___841 Int)) (and (and (in_range4 temp___841) (= (iter_has_element temp___842 temp___841) true)) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___842 temp___841)) (f (get2 (model__ s) (get temp___840 temp___839))))))))
(check-sat)
(exit)
