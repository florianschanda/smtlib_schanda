...
(assert (=> (= result1 true) (let ((temp___913 (elements (mk___rep r__split_discrs r__split_fields11)))) (forall ((temp___912 Int)) (=> (and (in_range2 temp___912) (= (iter_has_element temp___913 temp___912) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get temp___913 temp___912) (f (get (elements s) i))))))))))
...
(assert (=> (= result1 true) (and (= temp___9051 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___9051 no_element) true) (and (= (has_key (positions s) temp___9051) true) (= (get1 (positions s) temp___9051) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
