...
(define-fun temp___8631 () us_rep1 (mk___rep1 (mk___split_fields1 temp___863)))
...
(assert (=> (= result1 true) (let ((temp___871 (elements (mk___rep r__split_discrs r__split_fields11)))) (forall ((temp___870 Int)) (=> (and (in_range2 temp___870) (= (iter_has_element temp___871 temp___870) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get temp___871 temp___870) (f (get (elements s) i))))))))))
