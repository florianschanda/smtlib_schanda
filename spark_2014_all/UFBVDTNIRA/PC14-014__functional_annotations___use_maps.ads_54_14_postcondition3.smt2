...
(assert (in_range4 temp___867))
(assert (= (iter_has_element (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) temp___867) true))
(assert (not (exists ((temp___869 Int)) (and (and (in_range4 temp___869) (= (iter_has_element (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___869) true)) (= (get (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) temp___867)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___869))))))))
(check-sat)
(exit)
