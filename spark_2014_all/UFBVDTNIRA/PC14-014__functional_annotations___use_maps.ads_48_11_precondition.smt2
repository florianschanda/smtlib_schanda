...
(assert (and (= o30 (iter_has_element temp___820 temp___819)) (= (= o30 true) (and (<= 1 temp___819) (<= temp___819 (last temp___820))))))
(assert (= (= o31 true) (in_range3 temp___819)))
(assert (= result8 (ite (= o31 true) o30 false)))
(assert (= (= o36 true) (let ((temp___822 (keys s))) (forall ((temp___821 Int)) (=> (and (in_range3 temp___821) (= (iter_has_element temp___822 temp___821) true)) (let ((k3 (get temp___822 temp___821))) (and (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k3) true) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k3) (f (get2 (model__ s) k3))))))))))
(assert (and (= temp___816 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___816) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___816 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___816 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___816 key2)) (= (get temp___816 (find temp___816 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___816 (get temp___816 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___816 i2) (get temp___816 j)) (= i2 j)))))))))
(assert (and (= o28 (iter_has_element temp___816 temp___815)) (= (= o28 true) (and (<= 1 temp___815) (<= temp___815 (last temp___816))))))
(assert (= (= o29 true) (in_range3 temp___815)))
(assert (= result10 (ite (= o29 true) o28 false)))
