...
(define-fun temp___8041 () us_rep1 (mk___rep1 (mk___split_fields1 temp___804)))
...
(assert (=> (= result1 true) (let ((temp___812 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___811 Int)) (=> (and (in_range3 temp___811) (= (iter_has_element temp___812 temp___811) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get temp___812 temp___811) (get (keys s) i)))))))))
...
(assert (=> (= result1 true) (and (= temp___8041 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___8041 no_element) true) (and (= (has_key1 (positions s) temp___8041) true) (= (get1 (positions s) temp___8041) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
...
(assert (and (= temp___820 (keys s)) (and (and (and (and (= (length3 temp___820) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___820 temp___431) true)) (= (has_key (model__ s) (get temp___820 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___820 key2)) (= (get temp___820 (find temp___820 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___820 (get temp___820 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___820 i) (get temp___820 j)) (= i j)))))))))
(assert (and (= o6 (iter_has_element temp___820 temp___819)) (= (= o6 true) (and (<= 1 temp___819) (<= temp___819 (last temp___820))))))
(assert (= (= o7 true) (in_range3 temp___819)))
(assert (= result4 (ite (= o7 true) o6 false)))
(assert (= (= o8 true) (let ((temp___822 (keys s))) (forall ((temp___821 Int)) (=> (and (in_range3 temp___821) (= (iter_has_element temp___822 temp___821) true)) (let ((k (get temp___822 temp___821))) (and (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k) true) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k) (f (get2 (model__ s) k))))))))))
(assert (and (= temp___816 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___816) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___816 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___816 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___816 key2)) (= (get temp___816 (find temp___816 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___816 (get temp___816 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___816 i) (get temp___816 j)) (= i j)))))))))
