...
(declare-const temp___863 us_rep3)
...
(define-fun temp___8471 () us_rep1 (mk___rep1 (mk___split_fields1 temp___847)))
...
(assert (=> (= result1 true) (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields10)))) (forall ((temp___854 Int)) (=> (and (in_range3 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1))) (= (get temp___855 temp___854) (get (keys s) i)))))))))
...
(assert (=> (= result1 true) (and (= temp___8471 (next s (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields10)) (length s)) true) true) (= (bool_eq1 temp___8471 no_element) true) (and (= (has_key1 (positions s) temp___8471) true) (= (get1 (positions s) temp___8471) (+ (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))))))
...
(assert (and (= temp___863 (keys s)) (and (and (and (and (= (length3 temp___863) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___863 temp___474) true)) (= (has_key (model__ s) (get temp___863 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___863 key2)) (= (get temp___863 (find temp___863 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___863 (get temp___863 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___863 i) (get temp___863 j)) (= i j)))))))))
(assert (and (= o6 (iter_has_element temp___863 temp___862)) (= (= o6 true) (and (<= 1 temp___862) (<= temp___862 (last temp___863))))))
(assert (= (= o7 true) (in_range3 temp___862)))
(assert (= result4 (ite (= o7 true) o6 false)))
(assert (= (= o8 true) (let ((temp___865 (keys s))) (forall ((temp___864 Int)) (=> (and (in_range3 temp___864) (= (iter_has_element temp___865 temp___864) true)) (let ((k (get temp___865 temp___864))) (and (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k) true) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k) (f (get2 (model__ s) k))))))))))
(assert (and (= temp___859 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___859) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___859 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___859 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___859 key2)) (= (get temp___859 (find temp___859 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___859 (get temp___859 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___859 i) (get temp___859 j)) (= i j)))))))))
(assert (and (= o4 (iter_has_element temp___859 temp___858)) (= (= o4 true) (and (<= 1 temp___858) (<= temp___858 (last temp___859))))))
(assert (= (= o5 true) (in_range3 temp___858)))
(assert (= result5 (ite (= o5 true) o4 false)))
(assert (= result5 true))
(assert (not (<= 1 temp___858)))
(check-sat)
(exit)
