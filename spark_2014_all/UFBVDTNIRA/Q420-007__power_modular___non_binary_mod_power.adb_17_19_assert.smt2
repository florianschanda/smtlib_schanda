...
(define-fun dynamic_invariant1 ((temp___expr_171 (_ BitVec 8)) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool true)
(declare-sort t2 0)
...
(define-fun dynamic_invariant2 ((temp___expr_177 (_ BitVec 8)) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 4))) (in_range1 temp___expr_177)))
(declare-fun id ((_ BitVec 8)) (_ BitVec 8))
(declare-fun id__function_guard ((_ BitVec 8) (_ BitVec 8)) Bool)
(assert (forall ((x (_ BitVec 8))) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant1 (id x) true false true)) :pattern ((id x)))))
(assert (forall ((x (_ BitVec 8))) (! (=> (dynamic_invariant1 x true true true) (= (id x) x)) :pattern ((id x)))))
(declare-fun id__2 ((_ BitVec 8)) (_ BitVec 8))
(declare-fun id__2__function_guard ((_ BitVec 8) (_ BitVec 8)) Bool)
(assert (forall ((y (_ BitVec 8))) (! (=> (dynamic_invariant2 y true true true) (dynamic_invariant2 (id__2 y) true false true)) :pattern ((id__2 y)))))
(assert (forall ((y (_ BitVec 8))) (! (=> (dynamic_invariant2 y true true true) (= (id__2 y) y)) :pattern ((id__2 y)))))
(declare-fun id__3 (Int) Int)
(declare-fun id__3__function_guard (Int Int) Bool)
(assert (forall ((z Int)) (! (=> (dynamic_invariant z true true true) (dynamic_invariant (id__3 z) true false true)) :pattern ((id__3 z)))))
(assert (forall ((z Int)) (! (=> (dynamic_invariant z true true true) (= (id__3 z) z)) :pattern ((id__3 z)))))
