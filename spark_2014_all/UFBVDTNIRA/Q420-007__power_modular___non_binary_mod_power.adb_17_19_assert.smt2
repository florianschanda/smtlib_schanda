...
(define-fun dynamic_invariant1 ((temp___expr_200 (_ BitVec 8)) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool true)
(assert (forall ((x (_ BitVec 8))) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant1 (id x) true false true true)) :pattern ((id x)))))
(assert (forall ((x (_ BitVec 8))) (! (=> (dynamic_invariant1 x true true true true) (= (id x) x)) :pattern ((id x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_207 (_ BitVec 8)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (bvule #x00 #x04)) (in_range1 temp___expr_207)))
(assert (forall ((y (_ BitVec 8))) (! (=> (dynamic_invariant2 y true true true true) (dynamic_invariant2 (id__2 y) true false true true)) :pattern ((id__2 y)))))
(assert (forall ((y (_ BitVec 8))) (! (=> (dynamic_invariant2 y true true true true) (= (id__2 y) y)) :pattern ((id__2 y)))))
(declare-fun id__3 (Int) Int)
(declare-fun id__3__function_guard (Int Int) Bool)
(assert (forall ((z Int)) (! (=> (dynamic_invariant z true true true true) (dynamic_invariant (id__3 z) true false true true)) :pattern ((id__3 z)))))
(assert (forall ((z Int)) (! (=> (dynamic_invariant z true true true true) (= (id__3 z) z)) :pattern ((id__3 z)))))
...
(assert (and (= o (id #x02)) (= o #x02)))
(assert (= result x))
(assert (= x1 o))
(assert (and (= o1 (id__2 #x02)) (and (in_range1 o1) (= o1 #x02))))
(assert (= result1 y))
(assert (= y1 o1))
(assert (in_range1 y1))
...
(assert (and (= o3 (power z1 4)) (in_range (power z1 4))))
(assert (= o4 (mod2 o3 5)))
(assert (= result5 z1))
(assert (= z2 o4))
(assert (= z2 (bv2nat y2)))
