...
(assert (not (or (< (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (to_rep (rec__use_maps__my_maps__map__capacity r__split_discrs))) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) o32) true))))
(check-sat)
(exit)
