...
(assert (not (or (< (length (mk___rep r__split_discrs r__split_fields2)) (to_rep (rec__use_maps__my_maps__map__capacity r__split_discrs))) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) o) true))))
(check-sat)
(exit)
