...
(assert (or (and (and (and (= d23 (mk_int__ref d2)) (and (= (mk_int__ref d13) (mk_int__ref d1)) (and (= (mk_int__ref t23) (mk_int__ref t2)) (and (= (mk_int__ref t13) (mk_int__ref t1)) (and (= result__2 result__4) (= success2 success4)))))) (and (= d24 d21) (and (= d14 d11) (and (= t24 t21) (and (= t14 t11) (and (= result__5 result__2) (= success5 success2))))))) (and (bvult (bvsub thiscount prevcount) (bvsub thistime prevtime)) (and (and (= (mk_bool__ref result) (mk_bool__ref success)) (= success2 (of_int 0))) (and (= (mk_int__ref result1) (mk_int__ref result__)) (= result__2 0))))) (and (and (not (bvult (bvsub thiscount prevcount) (bvsub thistime prevtime))) (and (and (= result__2 result__) (= success2 success)) (and (= result__2 result__1) (= success2 success1)))) (and (and (and (= d23 (mk_int__ref d22)) (and (= d12 d13) (and (= t22 t23) (and (= t12 t13) (and (= result__3 result__4) (= success3 success4)))))) (and (= d24 d22) (and (= d14 d12) (and (= t24 t22) (and (= t14 t12) (and (= result__5 result__3) (= success5 success3))))))) (and (and (= (mk_int__ref result2) (mk_int__ref t1)) (= t12 (bv2nat (bvsub thistime prevtime)))) (and (and (= (mk_int__ref result3) (mk_int__ref t2)) (= t22 (bv2nat (bvsub currtime thistime)))) (and (and (and (and (= o (* 207 (bv2nat (bvsub thiscount prevcount)))) (in_range1 (* 207 (bv2nat (bvsub thiscount prevcount))))) (and (= o1 o) (in_range3 o))) (and (= (mk_int__ref result4) (mk_int__ref d1)) (= d12 o1))) (and (and (and (and (and (= o2 (* d12 t22)) (in_range1 (* d12 t22))) (= o3 (div1 o2 t12))) (and (= o4 o3) (in_range3 o3))) (and (= (mk_int__ref result5) (mk_int__ref d2)) (= d22 o4))) (and (and (= success2 result6) (= success3 (of_int 1))) (and (and (and (and (= o8 (+ t12 t22)) (in_range1 (+ t12 t22))) (and (and (and (and (= o5 (+ d12 d22)) (in_range1 (+ d12 d22))) (= o6 (* o5 3600))) (and (= o7 o6) (in_range1 o6))) (= o9 (div1 o7 o8)))) (and (= o10 o9) (in_range4 o9))) (and (= result__2 result7) (= result__3 o10))))))))))))
(assert (= d25 d23))
(assert (= d15 (mk_int__ref d13)))
(assert (= t25 (mk_int__ref t23)))
(assert (= t15 (mk_int__ref t13)))
...
(assert (not (not (= (bv2nat (bvsub thistime prevtime)) 0))))
(check-sat)
(exit)
