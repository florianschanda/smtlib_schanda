...
(declare-sort time 0)
(declare-fun timeqtint (time) Int)
(assert (forall ((i time)) (and (<= 0 (timeqtint i)) (<= (timeqtint i) 2147483647))))
...
(declare-fun distanceqtint (distance) Int)
(assert (forall ((i distance)) (and (<= 0 (distanceqtint i)) (<= (distanceqtint i) 2147483647))))
...
(declare-fun velocityqtint (velocity) Int)
(assert (forall ((i velocity)) (and (<= 0 (velocityqtint i)) (<= (velocityqtint i) 2147483647))))
...
(assert (= d11 o1))
(assert (and (= o2 (* d11 t21)) (in_range1 (* d11 t21))))
(assert (not (not (= t11 0))))
(check-sat)
(exit)
