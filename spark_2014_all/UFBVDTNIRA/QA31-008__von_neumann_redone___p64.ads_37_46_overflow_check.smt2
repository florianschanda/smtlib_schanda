...
(assert (=> (< p64__sqrt_von_neumann64__result4 3037000499) (and (= o4 (* (+ p64__sqrt_von_neumann64__result4 1) (+ p64__sqrt_von_neumann64__result4 1))) (in_range1 (* (+ p64__sqrt_von_neumann64__result4 1) (+ p64__sqrt_von_neumann64__result4 1))))))
(assert (=> (< p64__sqrt_von_neumann64__result4 3037000499) (= o5 (ite (< x o4) true false))))
(assert (=> (not (< p64__sqrt_von_neumann64__result4 3037000499)) (= o5 (of_int 1))))
