...
(assert (=> (< p64__sqrt_von_neumann64__result4 3037000499) (and (= o3 (* (+ p64__sqrt_von_neumann64__result4 1) (+ p64__sqrt_von_neumann64__result4 1))) (in_range1 (* (+ p64__sqrt_von_neumann64__result4 1) (+ p64__sqrt_von_neumann64__result4 1))))))
(assert (=> (< p64__sqrt_von_neumann64__result4 3037000499) (= o4 (ite (< x o3) true false))))
(assert (=> (not (< p64__sqrt_von_neumann64__result4 3037000499)) (= o4 (distinct 1 0))))
(assert (not (in_range1 (* p64__sqrt_von_neumann64__result4 p64__sqrt_von_neumann64__result4))))
(check-sat)
(exit)
