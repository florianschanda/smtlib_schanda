...
(assert (in_range2 temp___894))
(assert (= (iter_has_element (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))) temp___894) true))
(assert (not (exists ((temp___896 Int)) (and (and (in_range2 temp___896) (= (iter_has_element (elements s) temp___896) true)) (= (get (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))) temp___894) (f (get (elements s) temp___896)))))))
(check-sat)
(exit)
