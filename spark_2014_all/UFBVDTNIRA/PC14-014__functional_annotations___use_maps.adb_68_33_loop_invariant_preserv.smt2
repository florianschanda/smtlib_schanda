...
(assert (= result1 true))
(assert (= (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
...
(assert (= cu__split_fields3 (mk___split_fields1 temp___831)))
...
(assert (not (= (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(check-sat)
(exit)
