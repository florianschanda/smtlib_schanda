...
(assert (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields3) (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get2 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields4)) (length (mk___rep s__split_discrs s__split_fields3))) true) true) (= (bool_eq1 temp___8311 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) true) (= (get2 (positions (mk___rep s__split_discrs s__split_fields3)) temp___8311) (+ (get2 (positions (mk___rep s__split_discrs s__split_fields3)) (mk___rep1 cu__split_fields4)) 1))))))
...
(assert (not (= (capacity (mk___rep s__split_discrs s__split_fields3)) (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(check-sat)
(exit)
