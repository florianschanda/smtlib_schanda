...
(declare-const temp___806 count_type)
(declare-const temp___805 count_type)
(declare-const temp___8051 hash_type)
(declare-const temp___8052 us_main_type)
...
(declare-const temp___808 us_rep3)
...
(declare-const temp___804 count_type)
(declare-const o27 Bool)
(declare-const temp___816 us_rep3)
(declare-const temp___815 Int)
(declare-const o28 Bool)
(declare-const o29 Bool)
(declare-const k1 Int)
(declare-const temp___820 us_rep3)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_maps__apply_f_2__cu__assume)) (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_maps__apply_f_2__cu__assume)) no_element) true) (and (= (has_key1 (positions s) (mk___rep1 (mk___split_fields1 use_maps__apply_f_2__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_maps__apply_f_2__cu__assume))) 1)))))
...
(assert (=> (= result1 true) (= temp___806 cu__split_fields1)))
(assert (=> (= result1 true) (and (= r__split_discrs (mk___split_discrs temp___805 temp___8051)) (= temp___8052 r__split_fields))))
...
(assert (=> (= result1 true) (let ((temp___812 (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (forall ((temp___811 Int)) (=> (and (in_range3 temp___811) (= (iter_has_element temp___812 temp___811) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get temp___812 temp___811) (get (keys s) i2)))))))))
...
(assert (and (= temp___820 (keys s)) (and (and (and (and (= (length3 temp___820) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___820 temp___431) true)) (= (has_key (model__ s) (get temp___820 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___820 key2)) (= (get temp___820 (find temp___820 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (= (find temp___820 (get temp___820 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___820 i2) (get temp___820 j)) (= i2 j)))))))))
(assert (not true))
(check-sat)
(exit)
