...
(assert (and (= temp___867 (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2)))) (and (and (and (and (= (length2 temp___867) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2)))) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element temp___867 temp___425) true)) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (get temp___867 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) item) true)) (and (< 0 (find temp___867 item)) (= (get temp___867 (find temp___867 item)) item))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))))) (= (find temp___867 (get temp___867 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))))) (=> (= (get temp___867 i2) (get temp___867 j)) (= i2 j)))))))))
(assert (and (= o8 (iter_has_element temp___867 temp___866)) (= (= o8 true) (and (<= 1 temp___866) (<= temp___866 (last temp___867))))))
(assert (= (= o9 true) (in_range2 temp___866)))
(assert (= result3 (ite (= o9 true) o8 false)))
(assert (= result3 true))
(assert (and (= g (get temp___867 temp___866)) (in_range3 g)))
(assert (and (= o10 (positions s)) (and (not (= (has_key o10 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key o10 i2) true) (and (and (<= 1 (get1 o10 i2)) (<= (get1 o10 i2) (length s))) (forall ((j us_rep1)) (=> (= (has_key o10 j) true) (=> (= (get1 o10 i2) (get1 o10 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o11 (get1 o10 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range4 o11) (=> (= (of_int 0) true) (and (= o11 (w_get o10 (witness o10 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key o10 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o10 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o10 k))))))))))
(assert (= o12 (- o11 1)))
(assert (= o13 (ite (<= i1 o12) true false)))
(assert (= result4 (ite (<= 1 i1) o13 false)))
(assert (= result4 true))
(assert (and (= o14 (elements s)) (and (and (and (and (= (length2 o14) (length s)) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element o14 temp___425) true)) (= (contains (model__ s) (get o14 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s) item) true)) (and (< 0 (find o14 item)) (= (get o14 (find o14 item)) item))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (= (find o14 (get o14 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o14 i2) (get o14 j)) (= i2 j)))))))))
(assert (not (<= 1 i1)))
(check-sat)
(exit)
