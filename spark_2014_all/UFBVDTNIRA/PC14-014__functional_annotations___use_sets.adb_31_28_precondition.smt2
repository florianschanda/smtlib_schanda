...
(declare-const temp___909 us_rep2)
...
(assert (= result3 true))
(assert (and (= o6 (elements s)) (and (and (and (and (= (length2 o6) (length s)) (forall ((temp___467 Int)) (=> (and (in_range2 temp___467) (= (iter_has_element o6 temp___467) true)) (= (contains (model__ s) (get o6 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s) item) true)) (and (< 0 (find o6 item)) (= (get o6 (find o6 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o6 (get o6 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o6 i1) (get o6 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
