...
(assert (and (= temp___867 (elements (mk___rep r__split_discrs r__split_fields3))) (and (and (and (and (= (length2 temp___867) (length (mk___rep r__split_discrs r__split_fields3))) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element temp___867 temp___425) true)) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___867 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) item) true)) (and (< 0 (find temp___867 item)) (= (get temp___867 (find temp___867 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields3)))) (= (find temp___867 (get temp___867 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields3)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields3)))) (=> (= (get temp___867 i1) (get temp___867 j)) (= i1 j)))))))))
(assert (and (= o (iter_has_element temp___867 temp___866)) (= (= o true) (and (<= 1 temp___866) (<= temp___866 (last temp___867))))))
(assert (= (= o1 true) (in_range2 temp___866)))
(assert (= result2 (ite (= o1 true) o false)))
(assert (= result2 true))
(assert (and (= g (get temp___867 temp___866)) (in_range3 g)))
(assert (and (= o2 (positions s)) (and (not (= (has_key o2 no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o2 i1) true) (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length s))) (forall ((j us_rep1)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq1 i1 j) true))))))))))
...
(assert (= result3 true))
(assert (and (= o6 (elements s)) (and (and (and (and (= (length2 o6) (length s)) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element o6 temp___425) true)) (= (contains (model__ s) (get o6 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s) item) true)) (and (< 0 (find o6 item)) (= (get o6 (find o6 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o6 (get o6 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o6 i1) (get o6 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
