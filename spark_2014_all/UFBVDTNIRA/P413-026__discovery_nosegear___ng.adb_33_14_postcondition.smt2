...
(assert (not (= (int__content result__6) (div1 (* (+ (* 207 (bv2nat (bvsub thiscount prevcount))) (div1 (* (* 207 (bv2nat (bvsub thiscount prevcount))) (bv2nat (bvsub currtime thistime))) (bv2nat (bvsub thistime prevtime)))) 3600) (bv2nat (bvsub currtime prevtime))))))
(check-sat)
(exit)
