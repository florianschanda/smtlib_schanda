...
(assert (=> (= result1 true) (and (= r__split_discrs (mk___split_discrs temp___865 temp___8651)) (= temp___8652 r__split_fields1))))
(assert (=> (= result1 true) (= temp___864 cu__split_fields1)))
(assert (=> (= result1 true) (<= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))
(assert (=> (= result1 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (f (get (elements s) i2))) true)))))
(assert (=> (= result1 true) (let ((temp___871 (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))))) (forall ((temp___870 Int)) (=> (and (in_range2 temp___870) (= (iter_has_element temp___871 temp___870) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get temp___871 temp___870) (f (get (elements s) i2))))))))))
...
(assert (=> (= result1 true) (and (= (mk___rep1 (mk___split_fields1 temp___863)) (next s (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length s)) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___863)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 temp___863))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 temp___863))) (+ (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))))))
(assert (=> (= result1 true) (= result5 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___863))))
...
(assert (=> (= result1 true) (= r__split_fields4 (mk___split_fields__ref (mk___split_fields r__split_fields3)))))
(assert (=> (= result1 true) (= cu__split_fields5 cu__split_fields3)))
(assert (=> (= result1 true) (= r__split_fields5 (mk___split_fields r__split_fields3))))
...
(assert (=> (not (= result1 true)) (= r__split_fields6 (mk___split_fields__ref (mk___split_fields r__split_fields1)))))
(assert (=> (not (= result1 true)) (= cu__split_fields7 (mk___split_fields1 cu__split_fields1))))
(assert (=> (not (= result1 true)) (= r__split_fields7 (mk___split_fields r__split_fields1))))
...
(assert (and (= temp___879 (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields8)))) (and (and (and (and (= (length2 temp___879) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields8)))) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element temp___879 temp___425) true)) (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))) (get temp___879 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))) item) true)) (and (< 0 (find temp___879 item)) (= (get temp___879 (find temp___879 item)) item))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))))) (= (find temp___879 (get temp___879 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))))) (=> (= (get temp___879 i2) (get temp___879 j)) (= i2 j)))))))))
(assert (and (= o21 (iter_has_element temp___879 temp___878)) (= (= o21 true) (and (<= 1 temp___878) (<= temp___878 (last temp___879))))))
(assert (= (= o22 true) (in_range2 temp___878)))
(assert (= result7 (ite (= o22 true) o21 false)))
(assert (= (= o25 true) (let ((temp___885 (elements (mk___rep r__split_discrs (us_split_fields__content r__split_fields8))))) (forall ((temp___884 Int)) (=> (and (in_range2 temp___884) (= (iter_has_element temp___885 temp___884) true)) (let ((temp___887 (elements s))) (exists ((temp___886 Int)) (and (and (in_range2 temp___886) (= (iter_has_element temp___887 temp___886) true)) (= (get temp___885 temp___884) (f (get temp___887 temp___886)))))))))))
(assert (not true))
(check-sat)
(exit)
