...
(assert (and (= o26 (length s)) (and (in_range1 o26) (<= o26 (to_rep (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s)))))))
(assert (= o27 (ite (<= i2 o26) true false)))
(assert (and (= o24 (positions s)) (and (not (= (has_key1 o24 no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key1 o24 i3) true) (and (and (<= 1 (get1 o24 i3)) (<= (get1 o24 i3) (length s))) (forall ((j us_rep1)) (=> (= (has_key1 o24 j) true) (=> (= (get1 o24 i3) (get1 o24 j)) (= (bool_eq1 i3 j) true))))))))))
(assert (not (= (has_key1 o24 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true)))
(check-sat)
(exit)
