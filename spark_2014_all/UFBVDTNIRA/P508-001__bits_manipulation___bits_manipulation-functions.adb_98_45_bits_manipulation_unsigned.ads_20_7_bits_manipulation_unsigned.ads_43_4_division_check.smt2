...
(assert (and (and (=> (<= 0 15) (in_range1 shift_amount2)) (=> (<= 0 15) (in_range1 result__2))) (and (not (= shift_amount2 0)) (not (= v2 ((_ int2bv 16) 0))))))
...
(assert (= new_v1 o))
(assert (=> (not (= new_v1 ((_ int2bv 16) 0))) (in_range1 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v1 ((_ int2bv 16) 0))) (and (= o1 (+ result__2 shift_amount2)) (in_range1 (+ result__2 shift_amount2)))))
(assert (=> (not (= new_v1 ((_ int2bv 16) 0))) (= result__2 result4)))
(assert (=> (not (= new_v1 ((_ int2bv 16) 0))) (= result__3 o1)))
(assert (=> (not (= new_v1 ((_ int2bv 16) 0))) (= v2 result5)))
(assert (=> (not (= new_v1 ((_ int2bv 16) 0))) (= v3 new_v1)))
(assert (=> (not (not (= new_v1 ((_ int2bv 16) 0)))) (= v3 v2)))
(assert (=> (not (not (= new_v1 ((_ int2bv 16) 0)))) (= result__3 result__2)))
