...
(assert (not (= v1 #x0000)))
(assert (and (and (=> (<= 0 15) (in_range2 result__2)) (=> (<= 0 15) (in_range2 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 #x0000)))))
...
(assert (= new_v1 o))
(assert (=> (not (= new_v1 #x0000)) (in_range2 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v1 #x0000)) (and (= o1 (+ result__2 shift_amount2)) (in_range2 (+ result__2 shift_amount2)))))
