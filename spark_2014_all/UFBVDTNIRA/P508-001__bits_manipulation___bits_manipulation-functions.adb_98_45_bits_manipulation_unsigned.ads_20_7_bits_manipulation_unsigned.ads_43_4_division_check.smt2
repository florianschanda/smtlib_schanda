...
(define-fun dynamic_invariant1 ((temp___expr_318 Int) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool) (temp___do_typ_inv_317 Bool)) Bool (=> (or (= temp___is_init_314 true) (<= 0 15)) (in_range1 temp___expr_318)))
...
(assert (not (= v1 #x0000)))
(assert (and (and (=> (<= 0 15) (in_range1 result__2)) (=> (<= 0 15) (in_range1 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 #x0000)))))
(assert (and (= o (shift_right v2 shift_amount2)) (= o (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< shift_amount2 8) (bvlshr ((_ extract 7 0) v2) ((_ int2bv 8) shift_amount2)) #x00)) (ite (and (<= 9 16) (<= 16 16)) (ite (< shift_amount2 16) (bvlshr v2 ((_ int2bv 16) shift_amount2)) #x0000) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) v2) ((_ int2bv 32) shift_amount2))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) v2) ((_ int2bv 64) shift_amount2)))))))))
(assert (= new_v result3))
(assert (= new_v1 o))
(assert (=> (not (= new_v1 #x0000)) (in_range1 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v1 #x0000)) (and (= o1 (+ result__2 shift_amount2)) (in_range1 (+ result__2 shift_amount2)))))
(assert (=> (not (= new_v1 #x0000)) (= result__2 result4)))
(assert (=> (not (= new_v1 #x0000)) (= result__3 o1)))
(assert (=> (not (= new_v1 #x0000)) (= v2 result5)))
(assert (=> (not (= new_v1 #x0000)) (= v3 new_v1)))
(assert (=> (not (not (= new_v1 #x0000))) (= v3 v2)))
(assert (=> (not (not (= new_v1 #x0000))) (= result__3 result__2)))
