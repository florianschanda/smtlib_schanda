...
(define-fun dynamic_invariant1 ((temp___expr_273 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 15)) (in_range1 temp___expr_273)))
...
(declare-const new_v (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result Int)
(declare-const temp___422 Int)
(declare-const temp___421 (_ BitVec 16))
(declare-const temp___420 (_ BitVec 16))
(declare-const temp___419 Int)
(declare-const o (_ BitVec 16))
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const new_v1 (_ BitVec 16))
...
(declare-const new_v2 (_ BitVec 16))
(declare-const result3 (_ BitVec 16))
(declare-const new_v3 (_ BitVec 16))
...
(declare-const v4 (_ BitVec 16))
(declare-const new_v4 (_ BitVec 16))
(declare-const shift_amount5 Int)
(declare-const result__5 Int)
(declare-const v5 (_ BitVec 16))
(declare-const new_v5 (_ BitVec 16))
...
(declare-const v7 (_ BitVec 16))
(declare-const new_v7 (_ BitVec 16))
(declare-const result7 int__ref)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result1 Int)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result2 int__ref)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result3 Int)
(declare-const shift_amount8 int__ref)
(declare-const result__8 int__ref)
(declare-const v8 t__ref)
(declare-const new_v8 t__ref)
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result4 int__ref)
(declare-const shift_amount9 Int)
(declare-const result__9 Int)
(declare-const v9 (_ BitVec 16))
(declare-const new_v9 (_ BitVec 16))
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index_fast_inline_always__result5 Int)
(assert true)
(assert (not (= value ((_ int2bv 16) 0))))
(assert (= (mk_int__ref result) (mk_int__ref shift_amount)))
(assert (= shift_amount1 7))
...
(assert (not (= v1 ((_ int2bv 16) 0))))
(assert (and (and (=> (<= 0 15) (in_range1 result__2)) (=> (<= 0 15) (in_range1 shift_amount2))) (and (not (= shift_amount2 0)) (not (= v2 ((_ int2bv 16) 0))))))
(assert (and (= o (shift_right v2 shift_amount2)) (= o (ite (and (<= 1 16) (<= 16 8)) ((_ zero_extend 8) (ite (< shift_amount2 8) (bvlshr ((_ extract 7 0) v2) ((_ int2bv 8) shift_amount2)) ((_ int2bv 8) 0))) (ite (and (<= 9 16) (<= 16 16)) (ite (< shift_amount2 16) (bvlshr v2 ((_ int2bv 16) shift_amount2)) ((_ int2bv 16) 0)) (ite (and (<= 17 16) (<= 16 32)) ((_ extract 15 0) (bvlshr ((_ zero_extend 16) v2) ((_ int2bv 32) shift_amount2))) ((_ extract 15 0) (bvlshr ((_ zero_extend 48) v2) ((_ int2bv 64) shift_amount2)))))))))
(assert (= new_v2 result3))
(assert (= new_v3 o))
(assert (=> (not (= new_v3 ((_ int2bv 16) 0))) (in_range1 (+ result__2 shift_amount2))))
(assert (=> (not (= new_v3 ((_ int2bv 16) 0))) (and (= o1 (+ result__2 shift_amount2)) (in_range1 (+ result__2 shift_amount2)))))
(assert (=> (not (= new_v3 ((_ int2bv 16) 0))) (= result__2 result4)))
(assert (=> (not (= new_v3 ((_ int2bv 16) 0))) (= result__3 o1)))
(assert (=> (not (= new_v3 ((_ int2bv 16) 0))) (= v2 result5)))
(assert (=> (not (= new_v3 ((_ int2bv 16) 0))) (= v3 new_v3)))
(assert (=> (= new_v3 ((_ int2bv 16) 0)) (= v3 v2)))
(assert (=> (= new_v3 ((_ int2bv 16) 0)) (= result__3 result__2)))
