...
(assert (not (or (< (length (mk___rep l__split_discrs l__split_fields7)) (to_rep (rec__my_sets__m__set__capacity l__split_discrs))) (= (contains (model__ (mk___rep l__split_discrs l__split_fields7)) 3) true))))
(check-sat)
(exit)
