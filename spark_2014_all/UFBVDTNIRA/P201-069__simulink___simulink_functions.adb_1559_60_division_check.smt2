...
(define-fun dynamic_invariant1 ((temp___expr_361 (_ BitVec 32)) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool) (temp___do_typ_inv_360 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_368 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool) (temp___do_typ_inv_367 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= (- 32768) 32767)) (in_range1 temp___expr_368)))
(declare-fun u32toint16 ((_ BitVec 32)) Int)
(declare-fun u32toint16__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (u32toint16 s) true false true true)) :pattern ((u32toint16 s)))))
