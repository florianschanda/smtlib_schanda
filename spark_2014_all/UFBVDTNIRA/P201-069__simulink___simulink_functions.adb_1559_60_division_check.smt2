...
(define-fun dynamic_invariant2 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 32768) 32767)) (in_range1 temp___expr_315)))
(declare-fun u32toint16 ((_ BitVec 32)) Int)
(declare-fun u32toint16__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (u32toint16 s) true false true)) :pattern ((u32toint16 s)))))
