...
(define-fun source__ref___9__projection ((a source__ref)) source (source__content a))
(define-fun dynamic_invariant ((temp___expr_361 (_ BitVec 32)) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool) (temp___do_typ_inv_360 Bool)) Bool true)
(declare-sort target 0)
(declare-fun targetqtint (target) Int)
(assert (forall ((i target)) (and (<= (- 32768) (targetqtint i)) (<= (targetqtint i) 32767))))
...
(define-fun target__ref___9__projection ((a target__ref)) target (target__content a))
(define-fun dynamic_invariant1 ((temp___expr_368 Int) (temp___is_init_364 Bool) (temp___skip_constant_365 Bool) (temp___do_toplevel_366 Bool) (temp___do_typ_inv_367 Bool)) Bool (=> (or (= temp___is_init_364 true) (<= (- 32768) 32767)) (in_range1 temp___expr_368)))
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (u32toint16 s) true false true true)) :pattern ((u32toint16 s)))))
