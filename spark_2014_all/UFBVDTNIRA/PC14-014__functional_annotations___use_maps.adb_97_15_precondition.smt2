...
(assert (and (= o13 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (in_range1 o13) (<= o13 (to_rep1 (rec__use_maps__my_maps__map__capacity s__split_discrs))))))
...
(assert (and (= o19 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (and (and (and (= (length3 o19) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element o19 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 o19 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) key2) true)) (and (< 0 (find o19 key2)) (= (get1 o19 (find o19 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (= (find o19 (get1 o19 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (=> (= (get1 o19 i2) (get1 o19 j)) (= i2 j)))))))))
...
(assert (and (= o16 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (and (and (and (and (= (length3 o16) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element o16 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 o16 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) key2) true)) (and (< 0 (find o16 key2)) (= (get1 o16 (find o16 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (= (find o16 (get1 o16 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (=> (= (get1 o16 i2) (get1 o16 j)) (= i2 j)))))))))
