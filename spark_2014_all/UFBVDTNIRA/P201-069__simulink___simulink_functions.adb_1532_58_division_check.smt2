...
(define-fun dynamic_invariant ((temp___expr_333 (_ BitVec 32)) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool true)
...
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant s true true true true) (dynamic_invariant1 (u32tou16 s) true false true true)) :pattern ((u32tou16 s)))))
