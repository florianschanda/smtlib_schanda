...
(define-fun source__ref___7__projection ((a source__ref)) source (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_285 (_ BitVec 32)) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_291 (_ BitVec 16)) (temp___is_init_288 Bool) (temp___skip_constant_289 Bool) (temp___do_toplevel_290 Bool)) Bool true)
(declare-fun u32tou16 ((_ BitVec 32)) (_ BitVec 16))
(declare-fun u32tou16__function_guard ((_ BitVec 16) (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (u32tou16 s) true false true)) :pattern ((u32tou16 s)))))
