...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (let ((temp___806 (keys (mk___rep r__split_discrs r__split_fields4)))) (exists ((temp___805 Int)) (and (and (in_range3 temp___805) (= (iter_has_element temp___806 temp___805) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___806 temp___805)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (let ((temp___812 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___811 Int)) (=> (and (in_range3 temp___811) (= (iter_has_element temp___812 temp___811) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___812 temp___811)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (forall ((i Int)) (=> (and (<= (get1 (positions s) (mk___rep1 cu__split_fields4)) i) (<= i (length s))) (not (= (has_key (model__ (mk___rep r__split_discrs r__split_fields4)) (get (keys s) i)) true)))))
...
(assert (and (and (= (has_key (model__ (mk___rep r__split_discrs r__split_fields3)) o) true) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3)) o) o2)) (ite (= (has_key (model__ (mk___rep r__split_discrs r__split_fields4)) o) true) (and (and (and (and (= (oeq3 (positions (mk___rep r__split_discrs r__split_fields3)) (positions (mk___rep r__split_discrs r__split_fields4))) true) (= (get (keys (mk___rep r__split_discrs r__split_fields3)) (get1 (positions (mk___rep r__split_discrs r__split_fields3)) (find1 (mk___rep r__split_discrs r__split_fields3) o))) o)) (= (equal_except (keys (mk___rep r__split_discrs r__split_fields4)) (keys (mk___rep r__split_discrs r__split_fields3)) (get1 (positions (mk___rep r__split_discrs r__split_fields3)) (find1 (mk___rep r__split_discrs r__split_fields3) o))) true)) (= (same_keys (model__ (mk___rep r__split_discrs r__split_fields3)) (model__ (mk___rep r__split_discrs r__split_fields4))) true)) (= (elements_equal_except (model__ (mk___rep r__split_discrs r__split_fields3)) (model__ (mk___rep r__split_discrs r__split_fields4)) o) true)) (and (and (and (and (and (= (length (mk___rep r__split_discrs r__split_fields3)) (+ (length (mk___rep r__split_discrs r__split_fields4)) 1)) (= (ole (model__ (mk___rep r__split_discrs r__split_fields4)) (model__ (mk___rep r__split_discrs r__split_fields3))) true)) (= (keys_included_except (model__ (mk___rep r__split_discrs r__split_fields3)) (model__ (mk___rep r__split_discrs r__split_fields4)) o) true)) (= (get (keys (mk___rep r__split_discrs r__split_fields3)) (get1 (positions (mk___rep r__split_discrs r__split_fields3)) (find1 (mk___rep r__split_discrs r__split_fields3) o))) o)) (= (mapping_preserved (keys (mk___rep r__split_discrs r__split_fields4)) (keys (mk___rep r__split_discrs r__split_fields3)) (positions (mk___rep r__split_discrs r__split_fields4)) (positions (mk___rep r__split_discrs r__split_fields3))) true)) (= (keys_included_except1 (positions (mk___rep r__split_discrs r__split_fields3)) (positions (mk___rep r__split_discrs r__split_fields4)) (find1 (mk___rep r__split_discrs r__split_fields3) o)) true)))))
(assert (and (= temp___7961 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___7961 no_element) true) (and (= (has_key1 (positions s) temp___7961) true) (= (get1 (positions s) temp___7961) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
(assert (= result2 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___796)))
...
(define-fun temp___806 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields3)))
(assert (not (exists ((temp___805 Int)) (and (and (in_range3 temp___805) (= (iter_has_element temp___806 temp___805) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___806 temp___805)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
