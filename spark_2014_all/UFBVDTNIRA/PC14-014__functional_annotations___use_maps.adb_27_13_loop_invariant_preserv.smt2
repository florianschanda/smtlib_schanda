...
(assert (not (exists ((temp___762 Int)) (and (and (in_range3 temp___762) (= (iter_has_element (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___762) true)) (= (get2 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (get (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) temp___762)) (f (get2 (model__ s) (get (keys s) i3))))))))
(check-sat)
(exit)
