...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (let ((temp___763 (keys (mk___rep r__split_discrs r__split_fields4)))) (exists ((temp___762 Int)) (and (and (in_range3 temp___762) (= (iter_has_element temp___763 temp___762) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___763 temp___762)) (f (get2 (model__ s) (get (keys s) i))))))))))
(assert (let ((temp___769 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___768 Int)) (=> (and (in_range3 temp___768) (= (iter_has_element temp___769 temp___768) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4)) (get temp___769 temp___768)) (f (get2 (model__ s) (get (keys s) i))))))))))
...
(assert (and (= temp___7531 (next s (mk___rep1 cu__split_fields4))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (= (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true) (= (bool_eq1 temp___7531 no_element) true) (and (= (has_key1 (positions s) temp___7531) true) (= (get1 (positions s) temp___7531) (+ (get1 (positions s) (mk___rep1 cu__split_fields4)) 1))))))
...
(define-fun temp___763 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields3)))
(assert (not (exists ((temp___762 Int)) (and (and (in_range3 temp___762) (= (iter_has_element temp___763 temp___762) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___763 temp___762)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
