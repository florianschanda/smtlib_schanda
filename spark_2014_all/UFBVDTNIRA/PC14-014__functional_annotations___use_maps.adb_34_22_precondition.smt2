...
(assert (and (= temp___765 (keys (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (and (and (and (and (= (length3 temp___765) (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___765 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (get temp___765 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) key2) true)) (and (< 0 (find temp___765 key2)) (= (get temp___765 (find temp___765 key2)) key2))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (= (find temp___765 (get temp___765 i3)) i3)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))))) (=> (= (get temp___765 i3) (get temp___765 j)) (= i3 j)))))))))
(assert (and (= o13 (iter_has_element temp___765 temp___764)) (= (= o13 true) (and (<= 1 temp___764) (<= temp___764 (last temp___765))))))
(assert (= (= o14 true) (in_range3 temp___764)))
(assert (= result4 (ite (= o14 true) o13 false)))
(assert (= result4 true))
(assert (and (= k1 (get temp___765 temp___764)) (in_range4 k1)))
(assert (and (= o15 (positions s)) (and (not (= (has_key1 o15 no_element) true)) (forall ((i3 us_rep1)) (=> (= (has_key1 o15 i3) true) (and (and (<= 1 (get1 o15 i3)) (<= (get1 o15 i3) (length s))) (forall ((j us_rep1)) (=> (= (has_key1 o15 j) true) (=> (= (get1 o15 i3) (get1 o15 j)) (= (bool_eq1 i3 j) true))))))))))
(assert (and (= o16 (get1 o15 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range5 o16) (=> (= (of_int 0) true) (and (= o16 (w_get o15 (witness o15 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k4 us_rep1)) (=> (= (has_key1 o15 k4) true) (= (= (bool_eq1 k4 (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o15 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o15 k4))))))))))
(assert (= o17 (- o16 1)))
(assert (= o18 (ite (<= i1 o17) true false)))
(assert (= result5 (ite (<= 1 i1) o18 false)))
(assert (= result5 true))
(assert (and (= o19 (keys s)) (and (and (and (and (= (length3 o19) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o19 temp___431) true)) (= (has_key (model__ s) (get o19 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o19 key2)) (= (get o19 (find o19 key2)) key2))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (= (find o19 (get o19 i3)) i3)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o19 i3) (get o19 j)) (= i3 j)))))))))
(assert (and (= o20 (get o19 i1)) (in_range4 o20)))
(assert (and (= o21 (get2 (model__ s) o20)) (and (in_range7 o21) (= o21 (get2 (model__ s) o20)))))
(assert (and (= o22 (f o21)) (and (in_range8 o22) (= o22 (ite (and (<= (- 100) o21) (<= o21 100)) (* o21 2) o21)))))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) k1) true)))
(check-sat)
(exit)
