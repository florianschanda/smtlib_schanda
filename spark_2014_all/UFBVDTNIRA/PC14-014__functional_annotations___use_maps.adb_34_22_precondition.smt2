...
(assert (and (= temp___765 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length3 temp___765) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___765 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___765 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___765 key2)) (= (get temp___765 (find temp___765 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___765 (get temp___765 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___765 i1) (get temp___765 j)) (= i1 j)))))))))
(assert (and (= o (iter_has_element temp___765 temp___764)) (= (= o true) (and (<= 1 temp___764) (<= temp___764 (last temp___765))))))
...
(assert (and (= o3 (get1 o2 (mk___rep1 cu__split_fields3))) (and (in_range5 o3) (=> (= (of_int 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 cu__split_fields3)))) (forall ((k1 us_rep1)) (=> (= (has_key1 o2 k1) true) (= (= (bool_eq1 k1 (mk___rep1 cu__split_fields3)) true) (= (witness o2 (mk___rep1 cu__split_fields3)) (witness o2 k1))))))))))
(assert (= o4 (- o3 1)))
