...
(assert (= result2 true))
(assert (and (= o6 (keys (mk___rep s__split_discrs s__split_fields2))) (and (and (and (and (= (length3 o6) (length (mk___rep s__split_discrs s__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o6 temp___474) true)) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) (get1 o6 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true)) (and (< 0 (find o6 key2)) (= (get1 o6 (find o6 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (= (find o6 (get1 o6 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep s__split_discrs s__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs s__split_fields2)))) (=> (= (get1 o6 i1) (get1 o6 j)) (= i1 j)))))))))
(assert (and (= o7 (get1 o6 i)) (in_range5 o7)))
(assert (and (= o8 (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7)) (and (in_range3 o8) (=> (= (distinct 1 0) true) (and (= o8 (w_get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k) true)) (= (= k o7) (= (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) o7) (witness (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k))))))))))
