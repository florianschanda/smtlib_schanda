...
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 64) 0)))) (=> (= new_v3 ((_ int2bv 64) 0)) (= v3 v2))))
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 64) 0)))) (=> (= new_v3 ((_ int2bv 64) 0)) (= result__3 result__2))))
...
(assert (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 64) 0)))) (= (mk_int__ref shift_amount6) (mk_int__ref shift_amount4))))
