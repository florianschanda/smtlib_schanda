...
(define-fun dynamic_invariant1 ((temp___expr_321 (_ BitVec 32)) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_327 Int) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool)) Bool (=> (or (= temp___is_init_324 true) (<= (- 128) 127)) (in_range1 temp___expr_327)))
(declare-fun u32toint8 ((_ BitVec 32)) Int)
(declare-fun u32toint8__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (u32toint8 s) true false true)) :pattern ((u32toint8 s)))))
