...
(define-fun dynamic_invariant1 ((temp___expr_375 (_ BitVec 32)) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool) (temp___do_typ_inv_374 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_382 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool) (temp___do_typ_inv_381 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= (- 128) 127)) (in_range1 temp___expr_382)))
(declare-fun u32toint8 ((_ BitVec 32)) Int)
(declare-fun u32toint8__function_guard (Int (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant1 s true true true true) (dynamic_invariant2 (u32toint8 s) true false true true)) :pattern ((u32toint8 s)))))
