...
(declare-fun power4 ((_ BitVec 32) Int) (_ BitVec 32))
...
(define-fun dynamic_invariant2 ((temp___expr_129 Int) (temp___is_init_126 Bool) (temp___skip_constant_127 Bool) (temp___do_toplevel_128 Bool)) Bool (=> (or (= temp___is_init_126 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range1 temp___expr_129)))
...
(assert (<= 0 n))
(assert (<= n 63))
(assert (and (= o2 (power 2 n)) (in_range1 (power 2 n))))
(assert (= o3 (ite (= o2 0) true false)))
(assert (= result (ite (not (= o3 true)) true false)))
(assert (= result true))
(assert (=> (< n 18446744073709551616) (= o (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)))))
(assert (=> (not (< n 18446744073709551616)) (= o ((_ int2bv 64) 0))))
(assert (not (not (= o #x0000000000000000))))
(check-sat)
(exit)
