...
(assert (= o6 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))))
(assert (and (= result5 (has_key o6 k)) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key o6 k1) true)) (= k1 k))) (= result5 true)))))
(assert (= result5 true))
