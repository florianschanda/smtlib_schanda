...
(assert (= result2 true))
(assert (and (= o10 (keys s)) (and (and (and (and (= (length2 o10) (length s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o10 temp___474) true)) (= (has_key (model__ s) (get o10 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o10 key1)) (= (get o10 (find o10 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o10 (get o10 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o10 i1) (get o10 j)) (= i1 j)))))))))
(assert (and (= o11 (get o10 i)) (in_range3 o11)))
(assert (= o9 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o9 o11)) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o9 k) true)) (= k o11))) (= result3 true)))))
(assert (= result3 true))
