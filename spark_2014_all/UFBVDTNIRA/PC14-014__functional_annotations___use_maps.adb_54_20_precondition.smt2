...
(assert (= result2 true))
(assert (and (= o14 (keys s)) (and (and (and (and (= (length3 o14) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o14 temp___431) true)) (= (has_key (model__ s) (get o14 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o14 key2)) (= (get o14 (find o14 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (= (find o14 (get o14 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o14 i2) (get o14 j)) (= i2 j)))))))))
(assert (and (= o15 (get o14 i)) (in_range4 o15)))
(assert (= o13 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))))
(assert (and (= result3 (has_key o13 o15)) (=> (= (of_int 1) true) (=> (exists ((k3 Int)) (and (and (in_range2 k3) (= (has_key o13 k3) true)) (= k3 o15))) (= result3 true)))))
(assert (= result3 true))
(assert (and (= o8 (keys s)) (and (and (and (and (= (length3 o8) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o8 temp___431) true)) (= (has_key (model__ s) (get o8 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o8 key2)) (= (get o8 (find o8 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (= (find o8 (get o8 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o8 i2) (get o8 j)) (= i2 j)))))))))
(assert (and (= o9 (get o8 i)) (in_range4 o9)))
(assert (not (= (has_key (model__ s) o9) true)))
(check-sat)
(exit)
