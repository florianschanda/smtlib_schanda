...
(define-fun use_maps__apply_f_2__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_maps__apply_f_2__cu__assume)))
(assert (<= (length s) (to_rep (rec__use_maps__my_maps__map__capacity r__split_discrs))))
(assert (and (= use_maps__apply_f_2__cu__assume1 (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 use_maps__apply_f_2__cu__assume1 no_element) true) (and (= (has_key1 (positions s) use_maps__apply_f_2__cu__assume1) true) (= (get1 (positions s) use_maps__apply_f_2__cu__assume1) 1)))))
...
(assert (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___854 Int)) (=> (and (in_range3 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___855 temp___854) (get (keys s) i1))))))))
...
(assert (= result2 true))
(assert (and (= o7 (keys s)) (and (and (and (and (= (length3 o7) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element o7 temp___474) true)) (= (has_key (model__ s) (get o7 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o7 key2)) (= (get o7 (find o7 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o7 (get o7 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o7 i1) (get o7 j)) (= i1 j)))))))))
(assert (and (= o8 (get o7 i)) (in_range4 o8)))
...
(assert (= result3 true))
(assert (and (= o4 (keys s)) (and (and (and (and (= (length3 o4) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element o4 temp___474) true)) (= (has_key (model__ s) (get o4 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o4 key2)) (= (get o4 (find o4 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
(assert (and (= o5 (get o4 i)) (in_range4 o5)))
