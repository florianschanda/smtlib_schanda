...
(assert (= result2 true))
(assert (and (= o7 (keys s)) (and (and (and (and (= (length2 o7) (length s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o7 temp___474) true)) (= (has_key (model__ s) (get o7 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o7 key1)) (= (get o7 (find o7 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o7 (get o7 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o7 i1) (get o7 j)) (= i1 j)))))))))
(assert (and (= o8 (get o7 i)) (in_range3 o8)))
(assert (= o6 (model__ (mk___rep r__split_discrs r__split_fields2))))
(assert (and (= result3 (has_key o6 o8)) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key o6 k) true)) (= k o8))) (= result3 true)))))
(assert (= result3 true))
(assert (and (= o4 (keys s)) (and (and (and (and (= (length2 o4) (length s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o4 temp___474) true)) (= (has_key (model__ s) (get o4 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o4 key1)) (= (get o4 (find o4 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
(assert (and (= o5 (get o4 i)) (in_range3 o5)))
(assert (not (= (has_key (model__ s) o5) true)))
(check-sat)
(exit)
