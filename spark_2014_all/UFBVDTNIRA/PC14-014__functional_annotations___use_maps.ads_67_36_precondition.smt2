...
(declare-const temp___921 us_rep2)
(declare-const temp___917 Int)
(declare-const temp___916 count_type)
(declare-const temp___919 us_rep3)
...
(assert (=> (= result1 true) (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields11)) temp___918) true)))
(assert (=> (= result1 true) (= (oeq2 (keys (mk___rep s__split_discrs s__split_fields11)) temp___919) true)))
...
(assert (=> (= result1 true) (and (= temp___9141 (next (mk___rep s__split_discrs s__split_fields10) (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields10)) (length (mk___rep s__split_discrs s__split_fields10))) true) true) (= (bool_eq1 temp___9141 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields10)) temp___9141) true) (= (get2 (positions (mk___rep s__split_discrs s__split_fields10)) temp___9141) (+ (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields10)) 1)))))))
