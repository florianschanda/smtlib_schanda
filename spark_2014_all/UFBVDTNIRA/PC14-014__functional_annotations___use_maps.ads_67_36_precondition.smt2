...
(assert (=> (= result1 true) (= (capacity (mk___rep s__split_discrs s__split_fields11)) temp___874)))
(assert (=> (= result1 true) (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields11)) temp___875) true)))
(assert (=> (= result1 true) (= (oeq2 (keys (mk___rep s__split_discrs s__split_fields11)) temp___876) true)))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get2 (positions (mk___rep s__split_discrs s__split_fields11)) (mk___rep1 cu__split_fields10)) 1))) (= (get (model__ (mk___rep s__split_discrs s__split_fields11)) (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i)) (f (get temp___877 (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i))))))))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= (get2 (positions (mk___rep s__split_discrs s__split_fields11)) (mk___rep1 cu__split_fields10)) i) (<= i (length (mk___rep s__split_discrs s__split_fields11)))) (= (get temp___878 (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i)) (get (model__ (mk___rep s__split_discrs s__split_fields11)) (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i)))))))
...
(assert (=> (= result1 true) (and (= temp___8711 (next (mk___rep s__split_discrs s__split_fields10) (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields10)) (length (mk___rep s__split_discrs s__split_fields10))) true) true) (= (bool_eq1 temp___8711 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields10)) temp___8711) true) (= (get2 (positions (mk___rep s__split_discrs s__split_fields10)) temp___8711) (+ (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields10)) 1)))))))
