...
(assert true)
(assert true)
(assert (forall ((a Int) (b Int) (y1 Int)) (=> (< 0 y1) (= (mod (* (mod a y1) (mod b y1)) y1) (mod (* a b) y1)))))
(assert (forall ((a Int) (b Int) (y1 Int)) (=> (< 0 y1) (= (mod (+ (mod a y1) (mod b y1)) y1) (mod (+ a b) y1)))))
(assert (not (= (mod (* (mod (+ (bv2nat x) (bv2nat y)) 18446744073709551616) (mod (+ (bv2nat x) (bv2nat y)) 18446744073709551616)) 18446744073709551616) (bv2nat (bvadd (bvmul x x) (bvmul y (bvadd (bvmul ((_ int2bv 64) 2) x) y)))))))
(check-sat)
(exit)
