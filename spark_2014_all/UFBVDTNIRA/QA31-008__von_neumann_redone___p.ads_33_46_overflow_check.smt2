...
(assert (=> (< p__sqrt_von_neumann16__result4 181) (and (= o4 (* (+ p__sqrt_von_neumann16__result4 1) (+ p__sqrt_von_neumann16__result4 1))) (in_range1 (* (+ p__sqrt_von_neumann16__result4 1) (+ p__sqrt_von_neumann16__result4 1))))))
(assert (=> (< p__sqrt_von_neumann16__result4 181) (= o5 (ite (< x o4) true false))))
(assert (=> (not (< p__sqrt_von_neumann16__result4 181)) (= o5 (of_int 1))))
