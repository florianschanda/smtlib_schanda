...
(define-fun dynamic_invariant ((temp___expr_249 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 0 32767)) (in_range2 temp___expr_249)))
...
(define-fun dynamic_invariant1 ((temp___expr_263 (_ BitVec 16)) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool) (temp___do_typ_inv_262 Bool)) Bool true)
...
(assert (forall ((x (_ BitVec 16))) (! (=> (dynamic_invariant1 x true true true true) (let ((result (sqrt_von_neumann_aux16 x))) (and (and (and (bvule (bvmul result result) x) (bvuge (bvsub (bvmul (bvadd result #x0001) (bvadd result #x0001)) #x0001) x)) (=> (bvule x #x7FFF) (bvule result #x00B5))) (dynamic_invariant1 result true false true true)))) :pattern ((sqrt_von_neumann_aux16 x)))))
(declare-const x Int)
