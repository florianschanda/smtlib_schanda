...
(assert (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields4)))) (forall ((temp___854 Int)) (=> (and (in_range4 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___855 temp___854) (get (keys s) i))))))))
