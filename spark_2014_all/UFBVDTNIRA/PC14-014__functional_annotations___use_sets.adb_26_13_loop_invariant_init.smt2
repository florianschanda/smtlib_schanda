...
(assert (and (= (length (mk___rep r__split_discrs r__split_fields2)) 0) (= (is_empty1 (model__ (mk___rep r__split_discrs r__split_fields2))) true)))
...
(assert (not (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) (f (get (elements s) i))) true)))
(check-sat)
(exit)
