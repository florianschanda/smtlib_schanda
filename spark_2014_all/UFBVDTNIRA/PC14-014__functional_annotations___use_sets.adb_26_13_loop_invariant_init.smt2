...
(assert (<= 1 i2))
(assert (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields1))) 1)))
(assert (not (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) (f (get (elements s) i2))) true)))
(check-sat)
(exit)
