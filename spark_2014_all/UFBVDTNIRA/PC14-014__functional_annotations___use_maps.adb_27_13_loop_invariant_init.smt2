...
(define-fun temp___763 () us_rep3 (keys (mk___rep r__split_discrs r__split_fields1)))
(assert (not (exists ((temp___762 Int)) (and (and (in_range3 temp___762) (= (iter_has_element temp___763 temp___762) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields1)) (get temp___763 temp___762)) (f (get2 (model__ s) (get (keys s) i))))))))
(check-sat)
(exit)
