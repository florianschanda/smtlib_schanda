...
(assert (= (= o5 true) (in_range3 temp___862)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (and (= k (get temp___863 temp___862)) (in_range4 k)))
(assert (= o8 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))))
(assert (and (= result5 (has_key o8 k)) (=> (= (distinct 1 0) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key o8 k1) true)) (= k1 k))) (= result5 true)))))
(assert (= result5 true))
(assert (and (= o6 (get2 (model__ s) k)) (and (in_range7 o6) (= o6 (get2 (model__ s) k)))))
(assert (and (= o7 (f o6)) (and (in_range8 o7) (= o7 (ite (and (<= (- 100) o6) (<= o6 100)) (* o6 2) o6)))))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k) true)))
(check-sat)
(exit)
