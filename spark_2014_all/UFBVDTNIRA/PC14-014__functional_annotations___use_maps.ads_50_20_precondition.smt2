...
(assert (and (= o4 (iter_has_element temp___820 temp___819)) (= (= o4 true) (and (<= 1 temp___819) (<= temp___819 (last temp___820))))))
(assert (= (= o5 true) (in_range3 temp___819)))
...
(assert (and (= result5 (has_key o8 k)) (=> (= (of_int 1) true) (=> (exists ((k1 Int)) (and (and (in_range2 k1) (= (has_key o8 k1) true)) (= k1 k))) (= result5 true)))))
(assert (= result5 true))
