...
(assert (= result8 true))
(assert (and (= k2 (get temp___820 temp___819)) (in_range4 k2)))
(assert (= o35 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))))
(assert (and (= result9 (has_key o35 k2)) (=> (= (of_int 1) true) (=> (exists ((k3 Int)) (and (and (in_range2 k3) (= (has_key o35 k3) true)) (= k3 k2))) (= result9 true)))))
(assert (= result9 true))
(assert (and (= o32 (get2 (model__ s) k2)) (and (in_range7 o32) (= o32 (get2 (model__ s) k2)))))
(assert (and (= o33 (f o32)) (and (in_range8 o33) (= o33 (ite (and (<= (- 100) o32) (<= o32 100)) (* o32 2) o32)))))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) k2) true)))
(check-sat)
(exit)
