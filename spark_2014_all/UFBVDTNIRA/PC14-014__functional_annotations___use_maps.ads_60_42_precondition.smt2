...
(assert (= result6 true))
(assert (and (= l1 (get1 temp___853 temp___852)) (in_range5 l1)))
(assert (and (= o37 (iter_has_element (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___855)) (= (= o37 true) (and (<= 1 temp___855) (<= temp___855 (last (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))))))
(assert (= (= o38 true) (in_range4 temp___855)))
(assert (= result7 (ite (= o38 true) o37 false)))
(assert (= result7 true))
(assert (and (= k1 (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___855)) (in_range5 k1)))
(assert (not (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k1) true)))
(check-sat)
(exit)
