...
(assert (and (= o4 (iter_has_element temp___853 temp___852)) (= (= o4 true) (and (<= 1 temp___852) (<= temp___852 (last temp___853))))))
(assert (= (= o5 true) (in_range4 temp___852)))
(assert (= result4 (ite (= o5 true) o4 false)))
(assert (= result4 true))
(assert (and (= l (get1 temp___853 temp___852)) (in_range5 l)))
(assert (and (= o6 (iter_has_element (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___855)) (= (= o6 true) (and (<= 1 temp___855) (<= temp___855 (last (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))))))
(assert (= (= o7 true) (in_range4 temp___855)))
(assert (= result5 (ite (= o7 true) o6 false)))
(assert (= result5 true))
(assert (and (= k (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___855)) (in_range5 k)))
