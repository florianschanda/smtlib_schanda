...
(assert (and (= o10 (get2 (model__ s) o9)) (and (in_range7 o10) (= o10 (get2 (model__ s) o9)))))
(assert (and (= o11 (f o10)) (and (in_range8 o11) (= o11 (ite (and (<= (- 100) o10) (<= o10 100)) (* o10 2) o10)))))
(assert (not (= (has_key (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) k) true)))
(check-sat)
(exit)
