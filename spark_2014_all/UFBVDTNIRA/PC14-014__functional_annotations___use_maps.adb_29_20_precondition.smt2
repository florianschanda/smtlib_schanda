...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (let ((temp___763 (keys (mk___rep r__split_discrs r__split_fields2)))) (exists ((temp___762 Int)) (and (and (in_range3 temp___762) (= (iter_has_element temp___763 temp___762) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___763 temp___762)) (f (get2 (model__ s) (get (keys s) i1))))))))))
(assert (let ((temp___769 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___768 Int)) (=> (and (in_range3 temp___768) (= (iter_has_element temp___769 temp___768) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___769 temp___768)) (f (get2 (model__ s) (get (keys s) i1))))))))))
...
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range5 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k1 us_rep1)) (=> (= (has_key1 o k1) true) (= (= (bool_eq1 k1 (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k1))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= temp___757 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length3 temp___757) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___757 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___757 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true)) (and (< 0 (find temp___757 key2)) (= (get temp___757 (find temp___757 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___757 (get temp___757 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___757 i1) (get temp___757 j)) (= i1 j)))))))))
(assert (and (= o4 (iter_has_element temp___757 temp___756)) (= (= o4 true) (and (<= 1 temp___756) (<= temp___756 (last temp___757))))))
(assert (= (= o5 true) (in_range3 temp___756)))
(assert (= result3 (ite (= o5 true) o4 false)))
(assert (= result3 true))
(assert (and (= k (get temp___757 temp___756)) (in_range4 k)))
(assert (and (= o6 (keys s)) (and (and (and (and (= (length3 o6) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element o6 temp___431) true)) (= (has_key (model__ s) (get o6 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find o6 key2)) (= (get o6 (find o6 key2)) key2))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o6 (get o6 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o6 i1) (get o6 j)) (= i1 j)))))))))
