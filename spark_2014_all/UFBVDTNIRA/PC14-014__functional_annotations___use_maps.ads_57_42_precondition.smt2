...
(define-fun temp___8311 () us_rep1 (mk___rep1 (mk___split_fields1 temp___831)))
(define-fun use_maps__apply_f_3__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_maps__apply_f_3__cu__assume)))
(assert (and (= use_maps__apply_f_3__cu__assume1 (first (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (ite (= (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true) (= (bool_eq1 use_maps__apply_f_3__cu__assume1 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_maps__apply_f_3__cu__assume1) true) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) use_maps__apply_f_3__cu__assume1) 1)))))
...
(assert (and (= result1 (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields11))) (= (= result1 true) (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 cu__split_fields11)) true))))
...
(assert (=> (= result1 true) (= (capacity (mk___rep s__split_discrs s__split_fields11)) temp___834)))
(assert (=> (= result1 true) (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields11)) temp___835) true)))
(assert (=> (= result1 true) (= (oeq2 (keys (mk___rep s__split_discrs s__split_fields11)) temp___836) true)))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (- (get2 (positions (mk___rep s__split_discrs s__split_fields11)) (mk___rep1 cu__split_fields10)) 1))) (= (get (model__ (mk___rep s__split_discrs s__split_fields11)) (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i)) (f (get temp___837 (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i))))))))
(assert (=> (= result1 true) (forall ((i Int)) (=> (and (<= (get2 (positions (mk___rep s__split_discrs s__split_fields11)) (mk___rep1 cu__split_fields10)) i) (<= i (length (mk___rep s__split_discrs s__split_fields11)))) (= (get temp___838 (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i)) (get (model__ (mk___rep s__split_discrs s__split_fields11)) (get1 (keys (mk___rep s__split_discrs s__split_fields11)) i)))))))
(assert (=> (= result1 true) (and (= o1 (element (mk___rep s__split_discrs s__split_fields11) (mk___rep1 cu__split_fields10))) (and (in_range8 o1) (= o1 (get (model__ (mk___rep s__split_discrs s__split_fields11)) (key (mk___rep s__split_discrs s__split_fields11) (mk___rep1 cu__split_fields10))))))))
(assert (=> (= result1 true) (and (= o2 (f o1)) (and (in_range9 o2) (= o2 (ite (and (<= (- 100) o1) (<= o1 100)) (* o1 2) o1))))))
(assert (=> (= result1 true) (and (= o (key (mk___rep s__split_discrs s__split_fields11) (mk___rep1 cu__split_fields10))) (and (in_range7 o) (= o (get1 (keys (mk___rep s__split_discrs s__split_fields11)) (get2 (positions (mk___rep s__split_discrs s__split_fields11)) (mk___rep1 cu__split_fields10))))))))
(assert (=> (= result1 true) (and (and (= (has_key (model__ (mk___rep s__split_discrs s__split_fields10)) o) true) (= (get (model__ (mk___rep s__split_discrs s__split_fields10)) o) o2)) (ite (= (has_key (model__ (mk___rep s__split_discrs s__split_fields11)) o) true) (and (and (and (and (= (oeq3 (positions (mk___rep s__split_discrs s__split_fields10)) (positions (mk___rep s__split_discrs s__split_fields11))) true) (= (get1 (keys (mk___rep s__split_discrs s__split_fields10)) (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (find1 (mk___rep s__split_discrs s__split_fields10) o))) o)) (= (equal_except (keys (mk___rep s__split_discrs s__split_fields11)) (keys (mk___rep s__split_discrs s__split_fields10)) (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (find1 (mk___rep s__split_discrs s__split_fields10) o))) true)) (= (same_keys (model__ (mk___rep s__split_discrs s__split_fields10)) (model__ (mk___rep s__split_discrs s__split_fields11))) true)) (= (elements_equal_except (model__ (mk___rep s__split_discrs s__split_fields10)) (model__ (mk___rep s__split_discrs s__split_fields11)) o) true)) (and (and (and (and (and (= (length (mk___rep s__split_discrs s__split_fields10)) (+ (length (mk___rep s__split_discrs s__split_fields11)) 1)) (= (ole (model__ (mk___rep s__split_discrs s__split_fields11)) (model__ (mk___rep s__split_discrs s__split_fields10))) true)) (= (keys_included_except (model__ (mk___rep s__split_discrs s__split_fields10)) (model__ (mk___rep s__split_discrs s__split_fields11)) o) true)) (= (get1 (keys (mk___rep s__split_discrs s__split_fields10)) (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (find1 (mk___rep s__split_discrs s__split_fields10) o))) o)) (= (mapping_preserved (keys (mk___rep s__split_discrs s__split_fields11)) (keys (mk___rep s__split_discrs s__split_fields10)) (positions (mk___rep s__split_discrs s__split_fields11)) (positions (mk___rep s__split_discrs s__split_fields10))) true)) (= (keys_included_except1 (positions (mk___rep s__split_discrs s__split_fields10)) (positions (mk___rep s__split_discrs s__split_fields11)) (find1 (mk___rep s__split_discrs s__split_fields10) o)) true))))))
(assert (=> (= result1 true) (and (= temp___8311 (next (mk___rep s__split_discrs s__split_fields10) (mk___rep1 cu__split_fields10))) (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (= (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields10)) (length (mk___rep s__split_discrs s__split_fields10))) true) true) (= (bool_eq1 temp___8311 no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields10)) temp___8311) true) (= (get2 (positions (mk___rep s__split_discrs s__split_fields10)) temp___8311) (+ (get2 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields10)) 1)))))))
(assert (=> (= result1 true) (= result2 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___831))))
(assert (=> (= result1 true) (and (= o3 (has_key1 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields3))) (= (= o3 true) (= (has_key1 (positions (mk___rep s__split_discrs s__split_fields10)) (mk___rep1 cu__split_fields3)) true)))))
...
(assert (=> (= result1 true) (= s__split_fields4 (mk___split_fields__ref s__split_fields10))))
...
(assert (and (= temp___845 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (and (= (length3 temp___845) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element temp___845 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 temp___845 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) key2) true)) (and (< 0 (find temp___845 key2)) (= (get1 temp___845 (find temp___845 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (= (find temp___845 (get1 temp___845 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (=> (= (get1 temp___845 i) (get1 temp___845 j)) (= i j)))))))))
(assert (and (= o6 (iter_has_element temp___845 temp___844)) (= (= o6 true) (and (<= 1 temp___844) (<= temp___844 (last temp___845))))))
(assert (= (= o7 true) (in_range4 temp___844)))
