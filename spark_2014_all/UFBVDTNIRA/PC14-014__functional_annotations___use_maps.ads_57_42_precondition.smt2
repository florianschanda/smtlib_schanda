...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__use_maps__my_maps__cursor__node (us_split_fields3 a))) (to_rep1 (rec__use_maps__my_maps__cursor__node (us_split_fields3 b)))) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_360)))
...
(assert (forall ((container us_rep2)) (forall ((key Int)) (! (=> (and (dynamic_invariant1 key true true true) (= (has_key container key) true)) (let ((result (get container key))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key))) (forall ((k Int)) (=> (and (in_range2 k) (= (has_key container k) true)) (= (= k key) (= (witness container key) (witness container k))))))) (dynamic_invariant2 result true false true)))) :pattern ((get container key))))))
...
(define-fun dynamic_invariant3 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range5 temp___expr_385)))
(define-fun dynamic_invariant4 ((temp___expr_391 Int) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool)) Bool (=> (or (= temp___is_init_388 true) (<= 0 2147483647)) (in_range4 temp___expr_391)))
...
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant4 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant3 (get1 container position) true false true)) :pattern ((get1 container position))))))
...
(define-fun dynamic_invariant5 ((temp___expr_411 Int) (temp___is_init_408 Bool) (temp___skip_constant_409 Bool) (temp___do_toplevel_410 Bool)) Bool (=> (or (= temp___is_init_408 true) (<= 1 2147483647)) (in_range6 temp___expr_411)))
...
(assert (forall ((container us_rep4)) (forall ((key us_rep1)) (! (=> (= (has_key1 container key) true) (let ((result (get2 container key))) (and (=> (= (of_int 0) true) (and (= result (w_get1 container (witness1 container key))) (forall ((k us_rep1)) (=> (= (has_key1 container k) true) (= (= (bool_eq1 k key) true) (= (witness1 container key) (witness1 container k))))))) (dynamic_invariant5 result true false true)))) :pattern ((get2 container key))))))
(declare-fun oeq3 (us_rep4 us_rep4) Bool)
(declare-fun oeq__function_guard3 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (oeq3 left right) true) (and (forall ((key us_rep1)) (=> (= (has_key1 left key) true) (and (= (has_key1 right key) true) (= (get2 right key) (get2 left key))))) (forall ((key us_rep1)) (=> (= (has_key1 right key) true) (= (has_key1 left key) true))))) :pattern ((oeq3 left right)))))
...
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length3 result) (length container)) (forall ((temp___435 Int)) (=> (and (in_range4 temp___435) (= (iter_has_element result temp___435) true)) (= (has_key (model__ container) (get1 result temp___435)) true)))) (forall ((key Int)) (=> (and (in_range2 key) (= (has_key (model__ container) key) true)) (and (< 0 (find result key)) (= (get1 result (find result key)) key))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get1 result i) (get1 result j)) (= i j)))))))) :pattern ((keys container)))))
...
(assert (forall ((container us_rep)) (! (let ((result (capacity container))) (and (= result (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true))) :pattern ((capacity container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant (capacity1 attr__tag container) true false true) :pattern ((capacity1 attr__tag container))))))
...
(define-fun dynamic_invariant6 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range7 temp___expr_319)))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep1)) (! (dynamic_invariant6 (key1 attr__tag container position) true false true) :pattern ((key1 attr__tag container position)))))))
...
(define-fun dynamic_invariant7 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_325)))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep1)) (! (dynamic_invariant7 (element1 attr__tag container position) true false true) :pattern ((element1 attr__tag container position)))))))
...
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant6 key2 true true true) (dynamic_invariant7 (element__21 attr__tag container key2) true false true)) :pattern ((element__21 attr__tag container key2))))))
...
(define-fun dynamic_invariant8 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range9 temp___expr_15)))
(assert (forall ((e Int)) (! (=> (dynamic_invariant8 e true true true) (dynamic_invariant8 (f e) true false true)) :pattern ((f e)))))
(assert (forall ((e Int)) (! (=> (dynamic_invariant8 e true true true) (= (f e) (ite (and (<= (- 100) e) (<= e 100)) (* e 2) e))) :pattern ((f e)))))
(declare-const s__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant9 ((temp___expr_167 (_ BitVec 32)) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool true)
(assert (= no_element (mk___rep1 (mk___split_fields1 (of_rep1 0)))))
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant6 key2 true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= key2 (get1 container result)))) (dynamic_invariant result true false true)))) :pattern ((find container key2))))))
...
(assert true)
(assert (forall ((container us_rep)) (forall ((key2 Int)) (! (=> (dynamic_invariant6 key2 true true true) (let ((result (find1 container key2))) (ite (not (= (has_key (model__ container) key2) true)) (= (bool_eq1 result no_element) true) (and (and (= (has_key1 (positions container) result) true) (= (get2 (positions container) result) (find (keys container) key2))) (= (key container result) key2))))) :pattern ((find1 container key2))))))
(assert true)
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range2 k) (= (has_key container k) true)) (= k key2))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant (length2 container) true false true) :pattern ((length2 container)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (ole left right) true) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get right key2) (get left key2)))))) :pattern ((ole left right)))))
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (oeq4 left right) true) (and (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get right key2) (get left key2))))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key right key2) true)) (= (has_key left key2) true))))) :pattern ((oeq4 left right)))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((new_key Int)) (! (=> (dynamic_invariant1 new_key true true true) (= (= (elements_equal_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key left key2) true)) (=> (not (= key2 new_key)) (and (= (has_key right key2) true) (= (get left key2) (get right key2)))))))) :pattern ((elements_equal_except left right new_key))))))
(declare-fun has_witness (us_rep2 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep2 Int) Bool)
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant1 key2 true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true) (= (has_witness container witness2) true)) (dynamic_invariant2 (w_get container witness2) true false true)) :pattern ((w_get container witness2))))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep1)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant5 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
...
(declare-const temp___833 count_type)
(declare-const temp___8331 hash_type)
(declare-const temp___8332 us_main_type)
(declare-const temp___838 us_rep2)
(declare-const temp___834 Int)
(declare-const temp___832 count_type)
(declare-const temp___836 us_rep3)
(declare-const temp___837 us_rep2)
(declare-const temp___835 us_rep4)
(declare-const i Int)
...
(declare-const temp___853 us_rep3)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_maps__apply_f_3__cu__assume)) (first (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (ite (= (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_maps__apply_f_3__cu__assume)) no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 use_maps__apply_f_3__cu__assume))) true) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 use_maps__apply_f_3__cu__assume))) 1)))))
...
(assert (and (= result1 (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1)))) (= (= result1 true) (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 cu__split_fields1))) true))))
(assert (=> (= result1 true) (and (= s__split_discrs (mk___split_discrs temp___833 temp___8331)) (= s__split_fields temp___8332))))
(assert (=> (= result1 true) (= temp___838 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___834 (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___832 cu__split_fields1)))
(assert (=> (= result1 true) (= temp___836 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___837 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___835 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___834)))
(assert (=> (= result1 true) (= (oeq3 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___835) true)))
(assert (=> (= result1 true) (= (oeq2 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___836) true)))
(assert (=> (= result1 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2)) (f (get temp___837 (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2))))))))
(assert (=> (= result1 true) (forall ((i2 Int)) (=> (and (<= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (= (get temp___838 (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2)) (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2)))))))
(assert (=> (= result1 true) (and (= o25 (element (mk___rep s__split_discrs (mk___split_fields s__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range8 o25) (= o25 (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (key (mk___rep s__split_discrs (mk___split_fields s__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result1 true) (and (= o26 (f o25)) (and (in_range9 o26) (= o26 (ite (and (<= (- 100) o25) (<= o25 100)) (* o25 2) o25))))))
(assert (=> (= result1 true) (and (= o24 (key (mk___rep s__split_discrs (mk___split_fields s__split_fields2)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range7 o24) (= o24 (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2)))))))))
(assert (=> (= result1 true) (and (and (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) o24) true) (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) o24) o26)) (ite (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) o24) true) (and (and (and (and (= (oeq3 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) true) (= (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find1 (mk___rep s__split_discrs (mk___split_fields s__split_fields3)) o24))) o24)) (= (equal_except (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find1 (mk___rep s__split_discrs (mk___split_fields s__split_fields3)) o24))) true)) (= (same_keys (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2)))) true)) (= (elements_equal_except (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) o24) true)) (and (and (and (and (and (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) 1)) (= (ole (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3)))) true)) (= (keys_included_except (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) o24) true)) (= (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (find1 (mk___rep s__split_discrs (mk___split_fields s__split_fields3)) o24))) o24)) (= (mapping_preserved (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3)))) true)) (= (keys_included_except1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (find1 (mk___rep s__split_discrs (mk___split_fields s__split_fields3)) o24)) true))))))
(assert (=> (= result1 true) (and (= (mk___rep1 (mk___split_fields1 temp___831)) (next (mk___rep s__split_discrs (mk___split_fields s__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields3)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___831)) no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 temp___831))) true) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 temp___831))) (+ (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))))))
(assert (=> (= result1 true) (= result4 cu__split_fields2)))
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___831))))
(assert (=> (= result1 true) (and (= o27 (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 cu__split_fields3))) (= (= o27 true) (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 cu__split_fields3)) true)))))
(assert (=> (= result1 true) (= result5 (ite (not (= o27 true)) true false))))
(assert (=> (= result1 true) (= result5 true)))
(assert (=> (= result1 true) (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3))))
(assert (=> (= result1 true) (= s__split_fields4 (mk___split_fields__ref (mk___split_fields s__split_fields3)))))
(assert (=> (= result1 true) (= cu__split_fields5 cu__split_fields3)))
(assert (=> (= result1 true) (= s__split_fields5 (mk___split_fields s__split_fields3))))
...
(assert (=> (not (= result1 true)) (= cu__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 cu__split_fields1)))))
(assert (=> (not (= result1 true)) (= s__split_fields6 (mk___split_fields__ref (mk___split_fields s__split_fields)))))
(assert (=> (not (= result1 true)) (= cu__split_fields7 (mk___split_fields1 cu__split_fields1))))
(assert (=> (not (= result1 true)) (= s__split_fields7 (mk___split_fields s__split_fields1))))
...
(assert (and (= temp___853 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (and (= (length3 temp___853) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element temp___853 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 temp___853 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) key2) true)) (and (< 0 (find temp___853 key2)) (= (get1 temp___853 (find temp___853 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (= (find temp___853 (get1 temp___853 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (=> (= (get1 temp___853 i2) (get1 temp___853 j)) (= i2 j)))))))))
(assert (and (= o35 (iter_has_element temp___853 temp___852)) (= (= o35 true) (and (<= 1 temp___852) (<= temp___852 (last temp___853))))))
(assert (= (= o36 true) (in_range4 temp___852)))
(assert (= result6 (ite (= o36 true) o35 false)))
(assert (= (= o42 true) (let ((temp___859 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (forall ((temp___858 Int)) (=> (and (in_range4 temp___858) (= (iter_has_element temp___859 temp___858) true)) (exists ((temp___860 Int)) (and (and (in_range4 temp___860) (= (iter_has_element (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___860) true)) (= (get (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 temp___859 temp___858)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___860)))))))))))
(assert (and (= o28 (iter_has_element (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___843)) (= (= o28 true) (and (<= 1 temp___843) (<= temp___843 (last (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))))))
(assert (= (= o29 true) (in_range4 temp___843)))
(assert (= result8 (ite (= o29 true) o28 false)))
(assert (= result8 true))
(assert (and (= k (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___843)) (in_range5 k)))
(assert (and (= temp___845 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (and (= (length3 temp___845) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element temp___845 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 temp___845 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) key2) true)) (and (< 0 (find temp___845 key2)) (= (get1 temp___845 (find temp___845 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (= (find temp___845 (get1 temp___845 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (=> (= (get1 temp___845 i2) (get1 temp___845 j)) (= i2 j)))))))))
(assert (and (= o30 (iter_has_element temp___845 temp___844)) (= (= o30 true) (and (<= 1 temp___844) (<= temp___844 (last temp___845))))))
(assert (= (= o31 true) (in_range4 temp___844)))
(assert (= result9 (ite (= o31 true) o30 false)))
(assert (= result9 true))
(assert (and (= l (get1 temp___845 temp___844)) (in_range5 l)))
(assert (not (= (has_key (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) k) true)))
(check-sat)
(exit)
