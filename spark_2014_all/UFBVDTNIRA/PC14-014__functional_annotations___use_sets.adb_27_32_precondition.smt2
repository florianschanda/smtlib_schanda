...
(define-fun dynamic_invariant1 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 0 2147483647)) (in_range3 temp___expr_379)))
(define-fun dynamic_invariant2 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 2147483647)) (in_range2 temp___expr_385)))
...
(define-fun dynamic_invariant3 ((temp___expr_405 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 1 2147483647)) (in_range4 temp___expr_405)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___429 Int)) (=> (and (in_range2 temp___429) (= (iter_has_element result temp___429) true)) (= (contains (model__ container) (get result temp___429)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 2147483647)) (in_range7 temp___expr_319)))
(assert (forall ((e Int)) (! (=> (dynamic_invariant5 e true true true) (dynamic_invariant5 (f e) true false true)) :pattern ((f e)))))
(assert (forall ((e Int)) (! (=> (dynamic_invariant5 e true true true) (= (f e) (ite (and (<= (- 100) e) (<= e 100)) (* e 2) e))) :pattern ((f e)))))
(declare-const s us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const r__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant6 ((temp___expr_167 (_ BitVec 32)) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool true)
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= 0 2147483647)) (in_range5 temp___expr_354)))
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range5 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range5 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(declare-const temp___865 count_type)
(declare-const temp___8651 hash_type)
(declare-const temp___8652 us_main_type)
(declare-const temp___864 count_type)
...
(declare-const temp___863 count_type)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_sets__apply_f__cu__assume)) (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_sets__apply_f__cu__assume)) no_element) true) (and (= (has_key (positions s) (mk___rep1 (mk___split_fields1 use_sets__apply_f__cu__assume))) true) (= (get1 (positions s) (mk___rep1 (mk___split_fields1 use_sets__apply_f__cu__assume))) 1)))))
...
(assert (and (= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields1))) 0) (= (is_empty1 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields1)))) true)))
...
(assert (= result1 true))
(assert (<= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1)))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (f (get (elements s) i2))) true))))
(assert (let ((temp___871 (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))))) (forall ((temp___870 Int)) (=> (and (in_range2 temp___870) (= (iter_has_element temp___871 temp___870) true)) (exists ((i2 Int)) (and (and (<= 1 i2) (<= i2 (- (get1 (positions s) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get temp___871 temp___870) (f (get (elements s) i2)))))))))
(assert (and (= o2 (positions s)) (and (not (= (has_key o2 no_element) true)) (forall ((i2 us_rep1)) (=> (= (has_key o2 i2) true) (and (and (<= 1 (get1 o2 i2)) (<= (get1 o2 i2) (length s))) (forall ((j us_rep1)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i2) (get1 o2 j)) (= (bool_eq1 i2 j) true))))))))))
(assert (and (= o3 (get1 o2 (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (and (in_range4 o3) (=> (= (of_int 0) true) (and (= o3 (w_get o2 (witness o2 (mk___rep1 (mk___split_fields1 cu__split_fields2))))) (forall ((k us_rep1)) (=> (= (has_key o2 k) true) (= (= (bool_eq1 k (mk___rep1 (mk___split_fields1 cu__split_fields2))) true) (= (witness o2 (mk___rep1 (mk___split_fields1 cu__split_fields2))) (witness o2 k))))))))))
(assert (= o4 (- o3 1)))
(assert (= o5 (ite (<= i o4) true false)))
(assert (= result2 (ite (<= 1 i) o5 false)))
(assert (= result2 true))
(assert (and (= o6 (elements s)) (and (and (and (and (= (length2 o6) (length s)) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element o6 temp___425) true)) (= (contains (model__ s) (get o6 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s) item) true)) (and (< 0 (find o6 item)) (= (get o6 (find o6 item)) item))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (= (find o6 (get o6 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o6 i2) (get o6 j)) (= i2 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
