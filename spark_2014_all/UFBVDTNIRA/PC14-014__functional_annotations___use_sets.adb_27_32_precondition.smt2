...
(assert (and (= o (positions s)) (and (not (= (has_key o no_element) true)) (forall ((i1 us_rep2)) (=> (= (has_key o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length s))) (forall ((j us_rep2)) (=> (= (has_key o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq2 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range4 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep2)) (=> (= (has_key o k) true) (= (= (bool_eq2 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (elements s)) (and (and (and (and (= (length1 o4) (length s)) (forall ((temp___467 Int)) (=> (and (in_range3 temp___467) (= (iter_has_element o4 temp___467) true)) (= (contains (model__ s) (get o4 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s) item) true)) (and (< 0 (find o4 item)) (= (get o4 (find o4 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
