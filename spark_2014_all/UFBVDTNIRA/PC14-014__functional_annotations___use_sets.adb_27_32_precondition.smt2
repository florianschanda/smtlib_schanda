...
(define-fun use_sets__apply_f__cu__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 use_sets__apply_f__cu__assume)))
(assert (<= (length s) (capacity (mk___rep r__split_discrs (mk___split_fields r__split_fields)))))
(assert (and (= use_sets__apply_f__cu__assume1 (first s)) (ite (= (= (length s) 0) true) (= (bool_eq1 use_sets__apply_f__cu__assume1 no_element) true) (and (= (has_key (positions s) use_sets__apply_f__cu__assume1) true) (= (get1 (positions s) use_sets__apply_f__cu__assume1) 1)))))
...
(assert (let ((temp___871 (elements (mk___rep r__split_discrs r__split_fields3)))) (forall ((temp___870 Int)) (=> (and (in_range2 temp___870) (= (iter_has_element temp___871 temp___870) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___871 temp___870) (f (get (elements s) i1)))))))))
(assert (and (= o (positions s)) (and (not (= (has_key o no_element) true)) (forall ((i1 us_rep1)) (=> (= (has_key o i1) true) (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length s))) (forall ((j us_rep1)) (=> (= (has_key o j) true) (=> (= (get1 o i1) (get1 o j)) (= (bool_eq1 i1 j) true))))))))))
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range4 o1) (=> (= (of_int 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (elements s)) (and (and (and (and (= (length2 o4) (length s)) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element o4 temp___425) true)) (= (contains (model__ s) (get o4 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s) item) true)) (and (< 0 (find o4 item)) (= (get o4 (find o4 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
