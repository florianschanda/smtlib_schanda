...
(define-fun dynamic_invariant1 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 2147483647)) (in_range3 temp___expr_415)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___471 Int)) (=> (and (in_range2 temp___471) (= (iter_has_element result temp___471) true)) (= (contains (model__ container) (get result temp___471)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (let ((temp___913 (elements (mk___rep r__split_discrs r__split_fields3)))) (forall ((temp___912 Int)) (=> (and (in_range2 temp___912) (= (iter_has_element temp___913 temp___912) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___913 temp___912) (f (get (elements s) i1)))))))))
...
(assert (and (= o1 (get1 o (mk___rep1 cu__split_fields3))) (and (in_range4 o1) (=> (= (distinct 0 0) true) (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3)))) (forall ((k us_rep1)) (=> (= (has_key o k) true) (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true) (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= i o2) true false)))
(assert (= result2 (ite (<= 1 i) o3 false)))
(assert (= result2 true))
(assert (and (= o4 (elements s)) (and (and (and (and (= (length2 o4) (length s)) (forall ((temp___467 Int)) (=> (and (in_range2 temp___467) (= (iter_has_element o4 temp___467) true)) (= (contains (model__ s) (get o4 temp___467)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ s) item) true)) (and (< 0 (find o4 item)) (= (get o4 (find o4 item)) item))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o4 (get o4 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
