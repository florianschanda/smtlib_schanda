...
(assert (let ((temp___855 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___854 Int)) (=> (and (in_range4 temp___854) (= (iter_has_element temp___855 temp___854) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___855 temp___854) (get (keys s) i))))))))
(assert (and (= temp___851 (keys (mk___rep r__split_discrs r__split_fields2))) (and (and (and (and (= (length2 temp___851) (length (mk___rep r__split_discrs r__split_fields2))) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element temp___851 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___851 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key1) true)) (and (< 0 (find temp___851 key1)) (= (get temp___851 (find temp___851 key1)) key1))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (= (find temp___851 (get temp___851 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2)))) (=> (= (get temp___851 i) (get temp___851 j)) (= i j)))))))))
...
(assert (= result2 true))
(assert (not (<= temp___850 (last temp___851))))
(check-sat)
(exit)
