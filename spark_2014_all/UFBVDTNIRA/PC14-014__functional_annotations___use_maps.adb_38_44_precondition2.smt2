...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (let ((temp___806 (keys (mk___rep r__split_discrs r__split_fields2)))) (exists ((temp___805 Int)) (and (and (in_range4 temp___805) (= (iter_has_element temp___806 temp___805) true)) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___806 temp___805)) (f (get2 (model__ s) (get (keys s) i1))))))))))
(assert (let ((temp___812 (keys (mk___rep r__split_discrs r__split_fields2)))) (forall ((temp___811 Int)) (=> (and (in_range4 temp___811) (= (iter_has_element temp___812 temp___811) true)) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2)) (get temp___812 temp___811)) (f (get2 (model__ s) (get (keys s) i1))))))))))
...
(assert (and (= o2 (length s)) (and (in_range1 o2) (<= o2 (to_rep1 (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s)))))))
...
(assert (and (= o5 (keys s)) (and (and (and (and (= (length2 o5) (length s)) (forall ((temp___474 Int)) (=> (and (in_range4 temp___474) (= (iter_has_element o5 temp___474) true)) (= (has_key (model__ s) (get o5 temp___474)) true)))) (forall ((key1 Int)) (=> (and (in_range2 key1) (= (has_key (model__ s) key1) true)) (and (< 0 (find o5 key1)) (= (get o5 (find o5 key1)) key1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o5 (get o5 i1)) i1)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get o5 i1) (get o5 j)) (= i1 j)))))))))
(assert (not (<= 1 o6)))
(check-sat)
(exit)
