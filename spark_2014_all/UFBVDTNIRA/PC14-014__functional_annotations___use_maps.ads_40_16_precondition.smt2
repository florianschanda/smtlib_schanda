...
(assert (= (= o50 true) (let ((temp___789 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((temp___788 Int)) (=> (and (in_range3 temp___788) (= (iter_has_element temp___789 temp___788) true)) (let ((temp___791 (keys s))) (exists ((temp___790 Int)) (and (and (in_range3 temp___790) (= (iter_has_element temp___791 temp___790) true)) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___789 temp___788)) (f (get2 (model__ s) (get temp___791 temp___790))))))))))))
(assert (and (= temp___773 (keys s)) (and (and (and (and (= (length3 temp___773) (length s)) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___773 temp___431) true)) (= (has_key (model__ s) (get temp___773 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___773 key2)) (= (get temp___773 (find temp___773 key2)) key2))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (= (find temp___773 (get temp___773 i3)) i3)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___773 i3) (get temp___773 j)) (= i3 j)))))))))
(assert (and (= o36 (iter_has_element temp___773 temp___772)) (= (= o36 true) (and (<= 1 temp___772) (<= temp___772 (last temp___773))))))
(assert (= (= o37 true) (in_range3 temp___772)))
(assert (= result11 (ite (= o37 true) o36 false)))
(assert (= result11 true))
(assert (and (= k2 (get temp___773 temp___772)) (in_range4 k2)))
(assert (and (= temp___775 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___775) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___431 Int)) (=> (and (in_range3 temp___431) (= (iter_has_element temp___775 temp___431) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___775 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___775 key2)) (= (get temp___775 (find temp___775 key2)) key2))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___775 (get temp___775 i3)) i3)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___775 i3) (get temp___775 j)) (= i3 j)))))))))
(assert (and (= o38 (iter_has_element temp___775 temp___774)) (= (= o38 true) (and (<= 1 temp___774) (<= temp___774 (last temp___775))))))
(assert (= (= o39 true) (in_range3 temp___774)))
(assert (= result12 (ite (= o39 true) o38 false)))
(assert (= result12 true))
(assert (not (<= 1 temp___774)))
(check-sat)
(exit)
