...
(assert (= (= o9 true) (in_range3 temp___825)))
(assert (= result4 (ite (= o9 true) o8 false)))
(assert (= (= o10 true) (let ((temp___832 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((temp___831 Int)) (=> (and (in_range3 temp___831) (= (iter_has_element temp___832 temp___831) true)) (let ((temp___834 (keys s))) (exists ((temp___833 Int)) (and (and (in_range3 temp___833) (= (iter_has_element temp___834 temp___833) true)) (= (get2 (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___832 temp___831)) (f (get2 (model__ s) (get temp___834 temp___833))))))))))))
(assert (and (= temp___816 (keys s)) (and (and (and (and (= (length3 temp___816) (length s)) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___816 temp___474) true)) (= (has_key (model__ s) (get temp___816 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true)) (and (< 0 (find temp___816 key2)) (= (get temp___816 (find temp___816 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (= (find temp___816 (get temp___816 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length s))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length s))) (=> (= (get temp___816 i) (get temp___816 j)) (= i j)))))))))
(assert (and (= o4 (iter_has_element temp___816 temp___815)) (= (= o4 true) (and (<= 1 temp___815) (<= temp___815 (last temp___816))))))
(assert (= (= o5 true) (in_range3 temp___815)))
(assert (= result5 (ite (= o5 true) o4 false)))
(assert (= result5 true))
(assert (and (= k (get temp___816 temp___815)) (in_range4 k)))
(assert (and (= temp___818 (keys (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (and (and (and (and (= (length3 temp___818) (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))) (forall ((temp___474 Int)) (=> (and (in_range3 temp___474) (= (iter_has_element temp___818 temp___474) true)) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) (get temp___818 temp___474)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))) key2) true)) (and (< 0 (find temp___818 key2)) (= (get temp___818 (find temp___818 key2)) key2))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (= (find temp___818 (get temp___818 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs (us_split_fields__content r__split_fields7))))) (=> (= (get temp___818 i) (get temp___818 j)) (= i j)))))))))
(assert (and (= o6 (iter_has_element temp___818 temp___817)) (= (= o6 true) (and (<= 1 temp___817) (<= temp___817 (last temp___818))))))
(assert (= (= o7 true) (in_range3 temp___817)))
