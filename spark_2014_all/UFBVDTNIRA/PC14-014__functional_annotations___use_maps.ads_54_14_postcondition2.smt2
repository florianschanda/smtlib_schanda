...
(assert (in_range4 temp___863))
(assert (= (iter_has_element (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___863) true))
(assert (not (exists ((temp___865 Int)) (and (and (in_range4 temp___865) (= (iter_has_element (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) temp___865) true)) (= (get (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) temp___865)) (f (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))) temp___863))))))))
(check-sat)
(exit)
