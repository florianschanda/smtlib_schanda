...
(declare-const temp___877 us_rep2)
(declare-const temp___875 us_rep4)
(declare-const temp___878 us_rep2)
(declare-const temp___874 Int)
(declare-const temp___873 count_type)
(declare-const temp___876 us_rep3)
(declare-const temp___872 count_type)
(declare-const temp___8721 hash_type)
(declare-const temp___8722 us_main_type)
(declare-const i Int)
...
(declare-const temp___871 count_type)
(declare-const o27 Bool)
(declare-const temp___884 us_rep3)
...
(assert (and (= (mk___rep1 (mk___split_fields1 use_maps__apply_f_4__cu__assume)) (first (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) (ite (= (= (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 use_maps__apply_f_4__cu__assume)) no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 use_maps__apply_f_4__cu__assume))) true) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))) (mk___rep1 (mk___split_fields1 use_maps__apply_f_4__cu__assume))) 1)))))
...
(assert (= result1 true))
(assert (= temp___877 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___875 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___878 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___874 (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (= temp___873 cu__split_fields1))
(assert (= temp___876 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
(assert (and (= s__split_discrs (mk___split_discrs temp___872 temp___8721)) (= s__split_fields temp___8722)))
(assert (= (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___874))
(assert (= (oeq3 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___875) true))
(assert (= (oeq2 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___876) true))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (- (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))) (= (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2)) (f (get temp___877 (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2)))))))
(assert (forall ((i2 Int)) (=> (and (<= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) i2) (<= i2 (length (mk___rep s__split_discrs (mk___split_fields s__split_fields2))))) (= (get temp___878 (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2)) (get (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) (get1 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) i2))))))
...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___871)) (next (mk___rep s__split_discrs (mk___split_fields s__split_fields3)) (mk___rep1 (mk___split_fields1 cu__split_fields2)))) (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields2)) no_element) false) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) (length (mk___rep s__split_discrs (mk___split_fields s__split_fields3)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___871)) no_element) true) (and (= (has_key1 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 temp___871))) true) (= (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 temp___871))) (+ (get2 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields3))) (mk___rep1 (mk___split_fields1 cu__split_fields2))) 1))))))
(assert (= result4 cu__split_fields2))
(assert (= cu__split_fields3 (mk___split_fields1 temp___871)))
...
(assert (= result5 true))
(assert (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3)))
(assert (= s__split_fields4 (mk___split_fields__ref (mk___split_fields s__split_fields3))))
(assert (= cu__split_fields5 cu__split_fields3))
(assert (= s__split_fields5 (mk___split_fields s__split_fields3)))
(assert (= cu__split_fields6 cu__split_fields4))
(assert (= s__split_fields6 s__split_fields4))
(assert (= cu__split_fields7 cu__split_fields5))
...
(assert (and (= temp___884 (keys (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (and (and (and (and (= (length3 temp___884) (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))) (forall ((temp___431 Int)) (=> (and (in_range4 temp___431) (= (iter_has_element temp___884 temp___431) true)) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) (get1 temp___884 temp___431)) true)))) (forall ((key2 Int)) (=> (and (in_range2 key2) (= (has_key (model__ (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))) key2) true)) (and (< 0 (find temp___884 key2)) (= (get1 temp___884 (find temp___884 key2)) key2))))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (= (find temp___884 (get1 temp___884 i2)) i2)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep s__split_discrs (us_split_fields__content s__split_fields8))))) (=> (= (get1 temp___884 i2) (get1 temp___884 j)) (= i2 j)))))))))
(assert (and (= o28 (iter_has_element temp___884 temp___883)) (= (= o28 true) (and (<= 1 temp___883) (<= temp___883 (last temp___884))))))
(assert (= (= o29 true) (in_range4 temp___883)))
(assert (= result6 (ite (= o29 true) o28 false)))
(assert (= result6 true))
(assert (and (= k (get1 temp___884 temp___883)) (in_range5 k)))
