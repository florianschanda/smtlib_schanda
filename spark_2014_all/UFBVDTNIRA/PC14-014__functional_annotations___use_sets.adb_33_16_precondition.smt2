...
(assert (let ((temp___913 (elements (mk___rep r__split_discrs r__split_fields5)))) (forall ((temp___912 Int)) (=> (and (in_range2 temp___912) (= (iter_has_element temp___913 temp___912) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___913 temp___912) (f (get (elements s) i)))))))))
