...
(assert (and (and (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) o17) true) (= (element (mk___rep r__split_discrs (mk___split_fields r__split_fields3)) (find1 (mk___rep r__split_discrs (mk___split_fields r__split_fields3)) o17)) o17)) (ite (= (contains (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17) true) (and (and (= (oeq3 (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2)))) true) (= (oeq4 (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2)))) true)) (= (equal_except (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (get1 (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (find1 (mk___rep r__split_discrs (mk___split_fields r__split_fields3)) o17))) true)) (and (and (and (and (= (length (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (+ (length (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) 1)) (= (ole (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields3)))) true)) (= (included_except (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (model__ (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) o17) true)) (= (mapping_preserved (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (elements (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields3)))) true)) (= (keys_included_except (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields3))) (positions (mk___rep r__split_discrs (mk___split_fields r__split_fields2))) (find1 (mk___rep r__split_discrs (mk___split_fields r__split_fields3)) o17)) true)))))
