...
(assert (let ((temp___871 (elements (mk___rep r__split_discrs r__split_fields5)))) (forall ((temp___870 Int)) (=> (and (in_range2 temp___870) (= (iter_has_element temp___871 temp___870) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___871 temp___870) (f (get (elements s) i)))))))))
