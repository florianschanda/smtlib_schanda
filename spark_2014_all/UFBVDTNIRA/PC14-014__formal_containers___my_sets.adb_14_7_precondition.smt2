...
(define-fun dynamic_invariant1 ((temp___expr_197 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool) (temp___do_typ_inv_196 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range1 temp___expr_197)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant2 ((temp___expr_346 Int) (temp___is_init_342 Bool) (temp___skip_constant_343 Bool) (temp___do_toplevel_344 Bool) (temp___do_typ_inv_345 Bool)) Bool (=> (or (= temp___is_init_342 true) (<= 1 2147483647)) (in_range3 temp___expr_346)))
(assert true)
...
(define-fun default_initial_assumption ((temp___expr_1081 us_rep) (temp___skip_top_level_1082 Bool)) Bool (and (and (= (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 temp___expr_1081))) 10) (= (to_rep1 (rec__my_sets__m__set__modulus (us_split_discrs1 temp___expr_1081))) r2b)) (=> (not (= temp___skip_top_level_1082 true)) (= (is_empty temp___expr_1081) true))))
...
(define-fun default_initial_assumption1 ((temp___expr_1093 us_rep) (temp___skip_top_level_1094 Bool)) Bool (and (and (= (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 temp___expr_1093))) 10) (= (to_rep1 (rec__my_sets__m__set__modulus (us_split_discrs1 temp___expr_1093))) r5b)) (=> (not (= temp___skip_top_level_1094 true)) (= (is_empty temp___expr_1093) true))))
...
(define-fun default_initial_assumption2 ((temp___expr_423 us_rep2) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (= (length2 temp___expr_423) 0)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= item (get container result)))) (dynamic_invariant1 result true false true true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption3 ((temp___expr_446 us_rep3) (temp___skip_top_level_447 Bool)) Bool (=> (not (= temp___skip_top_level_447 true)) (and (= (is_empty2 temp___expr_446) true) (= (length3 temp___expr_446) 0))))
...
(define-fun default_initial_assumption4 ((temp___expr_387 us_rep4) (temp___skip_top_level_388 Bool)) Bool (=> (not (= temp___skip_top_level_388 true)) (= (is_empty3 temp___expr_387) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___464 Int)) (=> (and (in_range2 temp___464) (= (iter_has_element result temp___464) true)) (= (contains (model__ container) (get result temp___464)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert (forall ((container us_rep4)) (! (dynamic_invariant1 (length4 container) true false true true) :pattern ((length4 container)))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (! (let ((result (num_overlaps left right))) (and (and (and (and (= result (length4 (intersection1 left right))) (ite (= (ole left right) true) (= result (length4 left)) (< result (length4 left)))) (ite (= (ole right left) true) (= result (length4 right)) (< result (length4 right)))) (= (= result 0) (= (no_overlap left right) true))) (dynamic_invariant1 result true false true true))) :pattern ((num_overlaps left right)))))
...
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant7 (get container position) true false true true)) :pattern ((get container position))))))
...
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant8 result true false true true)))) :pattern ((get1 container key))))))
(assert (forall ((container us_rep3)) (! (dynamic_invariant1 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant1 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(define-fun temp___14381 () us_rep1 (mk___rep1 (mk___split_fields1 temp___1438)))
(define-fun temp___14371 () us_rep1 (mk___rep1 (mk___split_fields1 temp___1437)))
...
(assert (and (= temp___14371 (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 temp___14371 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___14371) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___14371) 1)))))
...
(assert (and (= temp___14381 (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields1))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields1) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 temp___14381 no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___14381) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) temp___14381) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) 1))))))
