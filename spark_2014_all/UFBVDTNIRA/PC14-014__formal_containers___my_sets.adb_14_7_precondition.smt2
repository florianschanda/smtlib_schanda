...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 container)))) (dynamic_invariant1 result true false true))) :pattern ((length container)))))
...
(declare-fun mapping_preserved_except (us_rep2 us_rep2 us_rep3 us_rep3 us_rep1) Bool)
(declare-fun mapping_preserved_except__function_guard (Bool us_rep2 us_rep2 us_rep3 us_rep3 us_rep1) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 1 2147483647)) (in_range3 temp___expr_319)))
(assert true)
...
(define-fun e_elements_included__2 ((left us_rep2) (model__1 us_rep4) (right us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 left))) (=> (= (contains model__1 (get left i)) true) (and (< 0 (find right (get left i))) (= (get right (find right (get left i))) (get left i)))))) true false))
(declare-fun e_elements_included__2__function_guard (Bool us_rep2 us_rep4 us_rep2) Bool)
...
(define-fun e_elements_included__3 ((container us_rep2) (model__1 us_rep4) (left us_rep2) (right us_rep2)) Bool (ite (forall ((i Int)) (=> (and (<= 1 i) (<= i (length2 container))) (ite (= (contains model__1 (get container i)) true) (and (< 0 (find left (get container i))) (= (get left (find left (get container i))) (get container i))) (and (< 0 (find right (get container i))) (= (get right (find right (get container i))) (get container i)))))) true false))
(declare-fun e_elements_included__3__function_guard (Bool us_rep2 us_rep4 us_rep2 us_rep2) Bool)
...
(define-fun in_range4 ((rec__my_sets__m__set__capacity1 Int) (rec__my_sets__m__set__modulus1 (_ BitVec 32)) (a us_rep)) Bool (and (= rec__my_sets__m__set__capacity1 (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 a)))) (= rec__my_sets__m__set__modulus1 (to_rep1 (rec__my_sets__m__set__modulus (us_split_discrs1 a))))))
...
(define-fun dynamic_invariant3 ((temp___expr_1019 us_rep) (temp___is_init_1016 Bool) (temp___skip_constant_1017 Bool) (temp___do_toplevel_1018 Bool)) Bool (=> (not (= temp___skip_constant_1017 true)) (in_range4 10 r2b temp___expr_1019)))
(define-fun default_initial_assumption ((temp___expr_1022 us_rep) (temp___skip_top_level_1023 Bool)) Bool (and (and (= (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 temp___expr_1022))) 10) (= (to_rep1 (rec__my_sets__m__set__modulus (us_split_discrs1 temp___expr_1022))) r2b)) (=> (not (= temp___skip_top_level_1023 true)) (= (is_empty temp___expr_1022) true))))
(declare-const l__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const r5b (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun in_range5 ((rec__my_sets__m__set__capacity1 Int) (rec__my_sets__m__set__modulus1 (_ BitVec 32)) (a us_rep)) Bool (and (= rec__my_sets__m__set__capacity1 (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 a)))) (= rec__my_sets__m__set__modulus1 (to_rep1 (rec__my_sets__m__set__modulus (us_split_discrs1 a))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1030 us_rep) (temp___is_init_1027 Bool) (temp___skip_constant_1028 Bool) (temp___do_toplevel_1029 Bool)) Bool (=> (not (= temp___skip_constant_1028 true)) (in_range5 10 r5b temp___expr_1030)))
(define-fun default_initial_assumption1 ((temp___expr_1033 us_rep) (temp___skip_top_level_1034 Bool)) Bool (and (and (= (to_rep (rec__my_sets__m__set__capacity (us_split_discrs1 temp___expr_1033))) 10) (= (to_rep1 (rec__my_sets__m__set__modulus (us_split_discrs1 temp___expr_1033))) r5b)) (=> (not (= temp___skip_top_level_1034 true)) (= (is_empty temp___expr_1033) true))))
...
(define-fun default_initial_assumption2 ((temp___expr_386 us_rep2) (temp___skip_top_level_387 Bool)) Bool (=> (not (= temp___skip_top_level_387 true)) (= (length2 temp___expr_386) 0)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant2 item true true true) (let ((result (find container item))) (and (=> (< 0 result) (and (<= result (length2 container)) (= item (get container result)))) (dynamic_invariant1 result true false true)))) :pattern ((find container item))))))
...
(define-fun default_initial_assumption3 ((temp___expr_406 us_rep3) (temp___skip_top_level_407 Bool)) Bool (=> (not (= temp___skip_top_level_407 true)) (and (= (is_empty2 temp___expr_406) true) (= (length3 temp___expr_406) 0))))
...
(assert (forall ((e_left us_rep2) (e_right us_rep2)) (forall ((p_left us_rep3) (p_right us_rep3)) (forall ((position us_rep1)) (! (=> (= (mapping_preserved_except e_left e_right p_left p_right position) true) (and (= (keys_included p_left p_right) true) (forall ((c us_rep1)) (=> (= (has_key p_left c) true) (=> (not (= (bool_eq1 c position) true)) (= (get e_left (get1 p_left c)) (get e_right (get1 p_right c)))))))) :pattern ((mapping_preserved_except e_left e_right p_left p_right position)))))))
(declare-fun is_empty3 (us_rep4) Bool)
(declare-fun is_empty__function_guard3 (Bool us_rep4) Bool)
(define-fun default_initial_assumption4 ((temp___expr_355 us_rep4) (temp___skip_top_level_356 Bool)) Bool (=> (not (= temp___skip_top_level_356 true)) (= (is_empty3 temp___expr_355) true)))
...
(assert (forall ((container us_rep)) (! (let ((result (elements container))) (and (and (and (and (= (length2 result) (length container)) (forall ((temp___423 Int)) (=> (and (in_range2 temp___423) (= (iter_has_element result temp___423) true)) (= (contains (model__ container) (get result temp___423)) true)))) (forall ((item Int)) (=> (and (in_range6 item) (= (contains (model__ container) item) true)) (and (< 0 (find result item)) (= (get result (find result item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (= (find result (get result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length container))) (=> (= (get result i) (get result j)) (= i j)))))))) :pattern ((elements container)))))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_348 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= 1 2147483647)) (in_range6 temp___expr_348)))
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range6 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep4)) (! (let ((result (is_empty3 container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range6 item) (= (contains container item) true))))) (= (= result true) (= (length4 container) 0)))) :pattern ((is_empty3 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant5 item true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range6 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (! (let ((result (num_overlaps left right))) (and (and (and (and (= result (length4 (intersection1 left right))) (ite (= (ole left right) true) (= result (length4 left)) (< result (length4 left)))) (ite (= (ole right left) true) (= result (length4 right)) (< result (length4 right)))) (= (= result 0) (= (no_overlap left right) true))) (dynamic_invariant1 result true false true))) :pattern ((num_overlaps left right)))))
...
(define-fun dynamic_invariant6 ((temp___expr_379 Int) (temp___is_init_376 Bool) (temp___skip_constant_377 Bool) (temp___do_toplevel_378 Bool)) Bool (=> (or (= temp___is_init_376 true) (<= 0 2147483647)) (in_range2 temp___expr_379)))
...
(define-fun dynamic_invariant7 ((temp___expr_373 Int) (temp___is_init_370 Bool) (temp___skip_constant_371 Bool) (temp___do_toplevel_372 Bool)) Bool (=> (or (= temp___is_init_370 true) (<= 1 2147483647)) (in_range7 temp___expr_373)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant6 position true true true) (and (<= 1 position) (<= position (last container)))) (dynamic_invariant7 (get container position) true false true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant8 ((temp___expr_399 Int) (temp___is_init_396 Bool) (temp___skip_constant_397 Bool) (temp___do_toplevel_398 Bool)) Bool (=> (or (= temp___is_init_396 true) (<= 1 2147483647)) (in_range8 temp___expr_399)))
...
(assert (forall ((container us_rep3)) (forall ((key us_rep1)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (of_int 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep1)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant8 result true false true)))) :pattern ((get1 container key))))))
...
(assert (forall ((container us_rep3)) (! (= (= (is_empty2 container) true) (forall ((key us_rep1)) (not (= (has_key container key) true)))) :pattern ((is_empty2 container)))))
...
(assert (forall ((container us_rep3)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant1 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const temp___1387 us_rep1)
(declare-const temp___1389 us_rep1)
...
(declare-const my_sets__m__delete__2__container__fields us_split_fields)
...
(declare-const my_sets__m__exclude__container__fields us_split_fields)
(declare-const result21 us_split_fields__ref)
(declare-const l__split_fields11 us_split_fields)
(declare-const my_sets__m__exclude__container__fields1 us_split_fields)
...
(assert (and (= 10 (to_rep (rec__my_sets__m__set__capacity l__split_discrs))) (= r2b (to_rep1 (rec__my_sets__m__set__modulus l__split_discrs)))))
...
(assert (and (= 10 (to_rep (rec__my_sets__m__set__capacity k__split_discrs))) (= r5b (to_rep1 (rec__my_sets__m__set__modulus k__split_discrs)))))
(assert (= (is_empty (mk___rep l__split_discrs (mk___split_fields l__split_fields))) true))
(assert (and (= (mk___rep1 (mk___split_fields1 temp___1373)) (first (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) (ite (= (= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___1373)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1373))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1373))) 1)))))
...
(assert (and (= (mk___rep1 (mk___split_fields1 temp___1374)) (next (mk___rep l__split_discrs (mk___split_fields l__split_fields)) (mk___rep1 c__split_fields1))) (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields1) no_element) false) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true) (= (bool_eq1 (mk___rep1 (mk___split_fields1 temp___1374)) no_element) true) (and (= (has_key (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1374))) true) (= (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 (mk___split_fields1 temp___1374))) (+ (get1 (positions (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (mk___rep1 c__split_fields1)) 1))))))
(assert (= result1 (mk___split_fields__ref1 c__split_fields1)))
(assert (= c__split_fields2 (mk___split_fields1 temp___1374)))
(assert (not (< (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) (to_rep (rec__my_sets__m__set__capacity l__split_discrs)))))
(check-sat)
(exit)
