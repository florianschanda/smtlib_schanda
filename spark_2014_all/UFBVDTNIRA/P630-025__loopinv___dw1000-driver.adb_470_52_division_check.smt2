...
(assert (forall ((x bits_1)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range2 y) (= (to_rep (of_rep x)) y))) :pattern ((to_rep (of_rep x))))))
...
(assert (forall ((x bits_2)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x04))) (=> (in_range3 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(assert (forall ((x bits_7)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x80))) (=> (in_range5 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int6 ((x bits_7)) Int (bv2nat (to_rep3 x)))
...
(define-fun to_int7 ((x bits_8)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x bits_8)) (! (uint_in_range (to_int7 x)) :pattern ((to_int7 x)))))
(declare-sort bits_10 0)
(define-fun in_range6 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x03FF)))
(define-fun in_range_int4 ((x Int)) Bool (and (<= 0 x) (<= x 1023)))
...
(declare-fun user_eq7 (bits_10 bits_10) Bool)
(declare-const dummy7 bits_10)
...
(declare-fun to_rep5 (bits_10) (_ BitVec 16))
(declare-fun of_rep5 ((_ BitVec 16)) bits_10)
(assert (forall ((x bits_10)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x bits_10)) (! (in_range6 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x0400))) (=> (in_range6 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
(define-fun to_int8 ((x bits_10)) Int (bv2nat (to_rep5 x)))
(assert (forall ((x bits_10)) (! (in_range_int4 (to_int8 x)) :pattern ((to_int8 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (and (and (and (= (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__tflen (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__tx_fctrl_type__tflen (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__tfle (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__tfle (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__r (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__tx_fctrl_type__r (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txbr (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txbr (us_split_fields1 b))))) (= (to_rep (rec__dw1000__register_types__tx_fctrl_type__tr (us_split_fields1 a))) (to_rep (rec__dw1000__register_types__tx_fctrl_type__tr (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txprf (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txprf (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txpsr (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__txpsr (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__pe (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_fctrl_type__pe (us_split_fields1 b))))) (= (to_rep5 (rec__dw1000__register_types__tx_fctrl_type__txboffs (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_types__tx_fctrl_type__txboffs (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__ifsdelay (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__tx_fctrl_type__ifsdelay (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_308 (_ BitVec 8)) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool) (temp___do_typ_inv_307 Bool)) Bool (=> (or (= temp___is_init_304 true) (bvule #x00 #x01)) (in_range2 temp___expr_308)))
(define-fun dynamic_invariant3 ((temp___expr_315 (_ BitVec 8)) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (or (= temp___is_init_311 true) (bvule #x00 #x03)) (in_range3 temp___expr_315)))
(define-fun dynamic_invariant4 ((temp___expr_322 (_ BitVec 8)) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool) (temp___do_typ_inv_321 Bool)) Bool (=> (or (= temp___is_init_318 true) (bvule #x00 #x07)) (in_range4 temp___expr_322)))
(define-fun dynamic_invariant5 ((temp___expr_350 (_ BitVec 8)) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (bvule #x00 #x7F)) (in_range5 temp___expr_350)))
(define-fun dynamic_invariant6 ((temp___expr_357 (_ BitVec 8)) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool) (temp___do_typ_inv_356 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_371 (_ BitVec 16)) (temp___is_init_367 Bool) (temp___skip_constant_368 Bool) (temp___do_toplevel_369 Bool) (temp___do_typ_inv_370 Bool)) Bool (=> (or (= temp___is_init_367 true) (bvule #x0000 #x03FF)) (in_range6 temp___expr_371)))
