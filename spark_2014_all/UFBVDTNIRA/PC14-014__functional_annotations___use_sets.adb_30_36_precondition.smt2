...
(assert (let ((temp___871 (elements (mk___rep r__split_discrs r__split_fields3)))) (forall ((temp___870 Int)) (=> (and (in_range2 temp___870) (= (iter_has_element temp___871 temp___870) true)) (exists ((i Int)) (and (and (<= 1 i) (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1))) (= (get temp___871 temp___870) (f (get (elements s) i)))))))))
(assert (and (= temp___867 (elements (mk___rep r__split_discrs r__split_fields3))) (and (and (and (and (= (length2 temp___867) (length (mk___rep r__split_discrs r__split_fields3))) (forall ((temp___425 Int)) (=> (and (in_range2 temp___425) (= (iter_has_element temp___867 temp___425) true)) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) (get temp___867 temp___425)) true)))) (forall ((item Int)) (=> (and (in_range5 item) (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) item) true)) (and (< 0 (find temp___867 item)) (= (get temp___867 (find temp___867 item)) item))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields3)))) (= (find temp___867 (get temp___867 i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields3)))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields3)))) (=> (= (get temp___867 i) (get temp___867 j)) (= i j)))))))))
...
(assert (and (= o2 (positions s)) (and (not (= (has_key o2 no_element) true)) (forall ((i us_rep1)) (=> (= (has_key o2 i) true) (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length s))) (forall ((j us_rep1)) (=> (= (has_key o2 j) true) (=> (= (get1 o2 i) (get1 o2 j)) (= (bool_eq1 i j) true))))))))))
