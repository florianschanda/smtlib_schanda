...
(assert (=> (= result1 true) (= temp___877 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___875 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___878 (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___874 (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (= temp___873 cu__split_fields1)))
(assert (=> (= result1 true) (= temp___876 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields))))))
(assert (=> (= result1 true) (and (= s__split_discrs (mk___split_discrs temp___872 temp___8721)) (= s__split_fields temp___8722))))
(assert (=> (= result1 true) (= (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___874)))
(assert (=> (= result1 true) (= (oeq3 (positions (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___875) true)))
(assert (=> (= result1 true) (= (oeq2 (keys (mk___rep s__split_discrs (mk___split_fields s__split_fields2))) temp___876) true)))
...
(assert (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___871))))
