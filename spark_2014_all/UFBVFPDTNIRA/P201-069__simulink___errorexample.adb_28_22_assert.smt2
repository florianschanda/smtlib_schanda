...
(define-fun dynamic_invariant ((temp___expr_177 (_ BitVec 32)) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool true)
(declare-sort unsigned_32_m1_0_m100_0 0)
(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 32))
(define-fun in_range ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 1) x) (bvule x ((_ int2bv 32) 100))))
...
(define-fun dynamic_invariant1 ((temp___expr_201 (_ BitVec 32)) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (bvule ((_ int2bv 32) 1) ((_ int2bv 32) 100))) (in_range temp___expr_201)))
...
(assert true)
(assert (not (not (= requested_force ((_ int2bv 32) 0)))))
(check-sat)
(exit)
