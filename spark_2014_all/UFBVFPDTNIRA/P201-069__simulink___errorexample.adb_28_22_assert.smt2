...
(define-fun dynamic_invariant ((temp___expr_207 (_ BitVec 32)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool true)
(declare-sort unsigned_32_m1_0_m100_0 0)
(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 32))
(define-fun in_range ((x (_ BitVec 32))) Bool (and (bvule #x00000001 x) (bvule x #x00000064)))
...
(declare-datatypes () ((unsigned_32_m1_0_m100_0__ref (mk_unsigned_32_m1_0_m100_0__ref (unsigned_32_m1_0_m100_0__content unsigned_32_m1_0_m100_0)))))
(define-fun unsigned_32_m1_0_m100_0__ref___projection ((a unsigned_32_m1_0_m100_0__ref)) unsigned_32_m1_0_m100_0 (unsigned_32_m1_0_m100_0__content a))
(define-fun dynamic_invariant1 ((temp___expr_235 (_ BitVec 32)) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool (=> (or (= temp___is_init_231 true) (bvule #x00000001 #x00000064)) (in_range temp___expr_235)))
...
(assert (not (not (= requested_force #x00000000))))
(check-sat)
(exit)
