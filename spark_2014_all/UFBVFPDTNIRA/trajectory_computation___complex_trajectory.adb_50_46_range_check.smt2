...
(define-fun dynamic_invariant1 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 25000)) (in_range1 temp___expr_242)))
(assert (forall ((n Int)) (! (=> (dynamic_invariant1 n true true true true) (dynamic_invariant (low_bound n) true false true true)) :pattern ((low_bound n)))))
(assert (forall ((n Int)) (! (=> (dynamic_invariant1 n true true true true) (= (low_bound n) (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))) :pattern ((low_bound n)))))
...
(assert (forall ((n Int)) (! (=> (dynamic_invariant1 n true true true true) (dynamic_invariant (high_bound n) true false true true)) :pattern ((high_bound n)))))
(assert (forall ((n Int)) (! (=> (dynamic_invariant1 n true true true true) (= (high_bound n) (fp.mul RNE (of_int RNE n) bound))) :pattern ((high_bound n)))))
...
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true true) (dynamic_invariant (t n) true false true true)) :pattern ((t n)))))
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true true) (= (t n) (of_int RNE n))) :pattern ((t n)))))
...
(define-fun dynamic_invariant3 ((temp___expr_193 (_ BitVec 16)) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool true)
(declare-sort tfloat64B 0)
(declare-fun user_eq4 (tfloat64B tfloat64B) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE5 (Float64) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Float64)
(declare-const dummy4 tfloat64B)
...
(define-fun dynamic_invariant4 ((temp___expr_249 Float64) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (in_range3 temp___expr_249)))
(declare-sort drag_t 0)
(define-fun in_range4 ((x Float64)) Bool (and (fp.isFinite64 x) (and (fp.leq (fp.neg (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000)) x) (fp.leq x (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000)))))
(declare-fun user_eq6 (drag_t drag_t) Bool)
(declare-fun attr__ATTRIBUTE_IMAGE7 (Float64) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Float64)
(declare-const dummy6 drag_t)
...
(assert (= bound (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))
...
(assert (= (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000) bound))
(assert (in_range1 n))
...
(assert (= speed1 o))
(assert (and (fp.leq (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) delta_speed) (fp.leq delta_speed bound)))
(assert (= (in_bounds (high_bound n)) true))
(assert (= (in_bounds (low_bound n)) true))
(assert (fp.eq (fp.add RNE (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE n_bv) bound) bound) (fp.mul RNE (fp.add RNE ((_ to_fp_unsigned 11 53) RNE n_bv) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) bound)))
(assert (fp.eq (fp.add RNE (fp.mul RNE (of_int RNE n) bound) bound) (fp.mul RNE (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) bound)))
(assert (fp.eq (fp.sub RNE (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) bound) (fp.mul RNE (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))
...
(assert (fp.leq (fp.sub RNE (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) bound) speed1))
...
(assert (fp.leq speed1 (fp.add RNE (fp.mul RNE (of_int RNE n) bound) bound)))
(assert (fp.leq speed1 (fp.mul RNE (of_int RNE (+ n 1)) bound)))
...
(assert (and (= o4 (high_bound o3)) (and (fp.isFinite64 o4) (= o4 (fp.mul RNE (of_int RNE o3) bound)))))
