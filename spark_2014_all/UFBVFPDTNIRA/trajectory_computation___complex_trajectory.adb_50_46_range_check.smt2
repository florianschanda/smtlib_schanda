...
(define-fun dynamic_invariant2 ((temp___expr_242 Int) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (or (= temp___is_init_238 true) (<= 0 25000)) (in_range1 temp___expr_242)))
(declare-sort ratio_t 0)
(define-fun in_range2 ((x Float64)) Bool (and (fp.isFinite64 x) (and (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) x) (fp.leq x (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))))
...
(define-fun dynamic_invariant3 ((temp___expr_249 Float64) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool) (temp___do_typ_inv_248 Bool)) Bool (=> (or (= temp___is_init_245 true) (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (in_range2 temp___expr_249)))
(declare-sort drag_t 0)
(define-fun in_range3 ((x Float64)) Bool (and (fp.isFinite64 x) (and (fp.leq (fp.neg (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000)) x) (fp.leq x (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000)))))
...
(declare-datatypes () ((drag_t__ref (mk_drag_t__ref (drag_t__content drag_t)))))
(define-fun drag_t__ref___projection ((a drag_t__ref)) drag_t (drag_t__content a))
(define-fun dynamic_invariant4 ((temp___expr_256 Float64) (temp___is_init_252 Bool) (temp___skip_constant_253 Bool) (temp___do_toplevel_254 Bool) (temp___do_typ_inv_255 Bool)) Bool (=> (or (= temp___is_init_252 true) (fp.leq (fp.neg (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000))) (in_range3 temp___expr_256)))
(declare-fun low_bound (Int) Float64)
(declare-fun low_bound__function_guard (Float64 Int) Bool)
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true true) (dynamic_invariant1 (low_bound n) true false true true)) :pattern ((low_bound n)))))
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true true) (= (low_bound n) (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))) :pattern ((low_bound n)))))
(declare-fun high_bound (Int) Float64)
(declare-fun high_bound__function_guard (Float64 Int) Bool)
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true true) (dynamic_invariant1 (high_bound n) true false true true)) :pattern ((high_bound n)))))
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true true) (= (high_bound n) (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))) :pattern ((high_bound n)))))
...
(assert true)
(assert (forall ((n Int)) (forall ((speed Float64) (distance Float64)) (! (= (= (invariant__ n speed distance) true) (and (and (fp.leq (low_bound n) speed) (fp.leq speed (high_bound n))) (and (fp.leq (fp.mul RNE (fp.mul RNE (fp.mul RNE (of_int RNE n) (of_int RNE (+ n 1))) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)) distance) (fp.leq distance (fp.mul RNE (fp.mul RNE (fp.mul RNE (of_int RNE n) (of_int RNE (+ n 1))) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)))))) :pattern ((invariant__ n speed distance))))))
(declare-const n Int)
...
(define-fun dynamic_invariant5 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_18)))
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant5 n1 true true true true) (dynamic_invariant1 (t n1) true false true true)) :pattern ((t n1)))))
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant5 n1 true true true true) (= (t n1) (of_int RNE n1))) :pattern ((t n1)))))
...
(assert (= (fp.add RNE drag (fp.mul RNE (fp.mul RNE factor (fp #b0 #b10000000010 #b0011100111010010111100011010100111111011111001110111)) (fp #b0 #b01111111001 #b0001000100010001000100010001000100010001000100010001))) delta_speed))
(assert (fp.isFinite64 delta_speed))
(assert (= ((_ int2bv 16) n) n_bv))
(assert (and (= o (fp.add RNE speed delta_speed)) (fp.isFinite64 (fp.add RNE speed delta_speed))))
(assert (= (mk_t__ref1 result) (mk_t__ref1 speed)))
(assert (= speed1 o))
(assert (and (fp.leq (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) delta_speed) (fp.leq delta_speed (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))
(assert (= (in_bounds (high_bound n)) true))
(assert (= (in_bounds (low_bound n)) true))
(assert (fp.eq (fp.add RNE (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE n_bv) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.add RNE ((_ to_fp_unsigned 11 53) RNE n_bv) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))
(assert (fp.eq (fp.add RNE (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))
(assert (fp.eq (fp.sub RNE (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))))
(assert (fp.eq (t 1) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))
(assert (fp.eq (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (of_int RNE (+ n 1))))
(assert (fp.leq (fp.sub RNE (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) speed1))
(assert (fp.leq (fp.mul RNE (of_int RNE (+ n 1)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) speed1))
(assert (fp.leq speed1 (fp.add RNE (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))
(assert (fp.leq speed1 (fp.mul RNE (of_int RNE (+ n 1)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))
(assert (and (= o1 (fp.add RNE old_speed speed1)) (fp.isFinite64 (fp.add RNE old_speed speed1))))
...
(assert (= average1 o2))
(assert (and (fp.leq (low_bound (+ n 1)) old_speed) (fp.leq old_speed (high_bound (+ n 1)))))
(assert (=> (fp.leq old_speed speed1) (and (fp.leq old_speed average1) (fp.leq average1 speed1))))
(assert (=> (not (fp.leq old_speed speed1)) (and (fp.leq speed1 average1) (fp.leq average1 old_speed))))
(assert (and (= o3 (+ n 1)) (in_range1 (+ n 1))))
(assert (and (= o4 (high_bound o3)) (and (fp.isFinite64 o4) (= o4 (fp.mul RNE (of_int RNE o3) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
(assert (= o5 (ite (fp.leq average1 o4) true false)))
(assert (not (in_range1 (+ n 1))))
(check-sat)
(exit)
