...
(define-fun dynamic_invariant1 ((temp___expr_201 Float64) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (fp.leq (fp.neg (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111)) (fp #b0 #b11111111110 #b1111111111111111111111111111111111111111111111111111))) (fp.isFinite64 temp___expr_201)))
...
(define-fun dynamic_invariant2 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 25000)) (in_range1 temp___expr_207)))
...
(define-fun dynamic_invariant3 ((temp___expr_213 Float64) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool)) Bool (=> (or (= temp___is_init_210 true) (fp.leq (fp.neg (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))) (in_range2 temp___expr_213)))
...
(define-fun dynamic_invariant4 ((temp___expr_219 Float64) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool (=> (or (= temp___is_init_216 true) (fp.leq (fp.neg (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000000000000000000000000000000000000000000000000000))) (in_range3 temp___expr_219)))
(declare-fun low_bound (Int) Float64)
(declare-fun low_bound__function_guard (Float64 Int) Bool)
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true) (dynamic_invariant1 (low_bound n) true false true)) :pattern ((low_bound n)))))
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true) (= (low_bound n) (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))) :pattern ((low_bound n)))))
(declare-fun high_bound (Int) Float64)
(declare-fun high_bound__function_guard (Float64 Int) Bool)
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true) (dynamic_invariant1 (high_bound n) true false true)) :pattern ((high_bound n)))))
(assert (forall ((n Int)) (! (=> (dynamic_invariant2 n true true true) (= (high_bound n) (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))) :pattern ((high_bound n)))))
...
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant5 n1 true true true) (dynamic_invariant1 (t n1) true false true)) :pattern ((t n1)))))
(assert (forall ((n1 Int)) (! (=> (dynamic_invariant5 n1 true true true) (= (t n1) (of_int RNE n1))) :pattern ((t n1)))))
...
(assert (and (= o9 (high_bound o8)) (and (fp.isFinite64 o9) (= o9 (fp.mul RNE (of_int RNE o8) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))))))
