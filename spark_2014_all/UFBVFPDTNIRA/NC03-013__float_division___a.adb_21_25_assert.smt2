...
(define-fun in_range ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 32767))))
...
(define-fun dynamic_invariant1 ((temp___expr_135 (_ BitVec 16)) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 32767))) (in_range temp___expr_135)))
(declare-sort output_t 0)
(define-fun in_range1 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10001100 #b10101101101100000000000)))))
...
(define-fun dynamic_invariant2 ((temp___expr_141 Float32) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b10101101101100000000000))) (in_range1 temp___expr_141)))
...
(assert (in_range x))
(assert (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b10101101101100000000000)) (in_range1 y)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 h)))
(assert (not (= x ((_ int2bv 16) 0))))
(assert (not (fp.leq (fp #b0 #b01111110 #b11001100110011001100110) ((_ to_fp_unsigned 8 24) RNE x))))
(check-sat)
(exit)
