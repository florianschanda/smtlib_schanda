...
(define-fun in_range ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x7FFF)))
...
(define-fun dynamic_invariant1 ((temp___expr_158 (_ BitVec 16)) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (bvule #x0000 #x7FFF)) (in_range temp___expr_158)))
...
(define-fun dynamic_invariant2 ((temp___expr_165 Float32) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10001100 #b10101101101100000000000))) (in_range1 temp___expr_165)))
