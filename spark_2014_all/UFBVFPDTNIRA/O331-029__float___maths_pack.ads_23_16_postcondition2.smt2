...
(assert (= y1 result5))
(assert (= y2 o1))
(assert (and (= o2 (fp.mul RNE half_x1 y2)) (fp.isFinite32 (fp.mul RNE half_x1 y2))))
(assert (= o3 (fp.mul RNE o2 y2)))
(assert (and (= o4 o3) (fp.isFinite32 o3)))
(assert (= o5 (fp.sub RNE (fp #b0 #b01111111 #b10000000000000000000000) o4)))
...
(assert (= (mk_t__ref1 maths_pack__inv_sqrt__result4) (mk_t__ref1 maths_pack__inv_sqrt__result2)))
(assert (= i3 i2))
...
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) maths_pack__inv_sqrt__result4)))
(check-sat)
(exit)
