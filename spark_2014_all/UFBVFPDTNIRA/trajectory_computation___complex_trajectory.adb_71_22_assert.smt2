...
(assert (not (fp.leq (fp.mul RNE (fp.mul RNE (fp.mul RNE (of_int RNE (+ n 1)) (of_int RNE (+ n 2))) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b01111111110 #b0000000000000000000000000000000000000000000000000000)) distance1)))
(check-sat)
(exit)
