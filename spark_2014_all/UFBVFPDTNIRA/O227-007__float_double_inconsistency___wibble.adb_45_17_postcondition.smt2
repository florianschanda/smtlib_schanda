...
(declare-datatypes () ((tfloat32B__ref (mk_tfloat32B__ref (tfloat32B__content tfloat32B)))))
(define-fun tfloat32B__ref___projection ((a tfloat32B__ref)) tfloat32B (tfloat32B__content a))
...
(declare-datatypes () ((float32__ref (mk_float32__ref (float32__content float32)))))
(define-fun float32__ref___projection ((a float32__ref)) float32 (float32__content a))
...
(assert (in_range1 x))
(assert (and (bvult x ((_ int2bv 32) 1000000)) (or (= state (fp #b0 #b00000000 #b00000000000000000000000)) (and (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) state) (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 8 24) RNE x) (fp #b0 #b10000010 #b01000000000000000000000)))))))
...
(assert (not (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) state2)))
(check-sat)
(exit)
