...
(define-fun dynamic_invariant ((temp___expr_207 (_ BitVec 16)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool true)
(declare-const i (_ BitVec 16))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(assert (not (or (fp.isZero ((_ to_fp_unsigned 8 24) RNE i)) (fp.isPositive ((_ to_fp_unsigned 8 24) RNE i)))))
(check-sat)
(exit)
