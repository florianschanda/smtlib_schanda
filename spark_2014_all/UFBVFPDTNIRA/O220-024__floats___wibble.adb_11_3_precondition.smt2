...
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o5)))
(assert (not (fp.leq (to_rep x__split_fields2) (fp.add RNE (fp #b0 #b11111110 #b11111111111111111111111) o5))))
(check-sat)
(exit)
