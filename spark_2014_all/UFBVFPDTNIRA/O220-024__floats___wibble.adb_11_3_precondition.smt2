...
(define-fun default_initial_assumption ((temp___expr_136 us_rep) (temp___skip_top_level_137 Bool)) Bool (and (= (to_rep (rec__test_pack__pid_obj__desired (us_split_fields1 temp___expr_136))) (fp #b0 #b00000000 #b00000000000000000000000)) (= (to_rep (rec__test_pack__pid_obj__error (us_split_fields1 temp___expr_136))) (fp #b0 #b00000000 #b00000000000000000000000))))
...
(define-fun dynamic_invariant1 ((temp___expr_189 Float32) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_189)))
(declare-fun to_fp1 ((_ BitVec 32)) Float32)
(declare-fun to_fp__function_guard (Float32 (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant s true true true) (dynamic_invariant1 (to_fp1 s) true false true)) :pattern ((to_fp1 s)))))
...
(assert (and (= o (to_fp1 ((_ int2bv 32) 2139094902))) (fp.isFinite32 o)))
(assert (= (to_rep o2) o))
(assert (= o2 o3))
(assert (= o1 o4))
...
(assert (and (= o5 (to_fp1 ((_ int2bv 32) 4144594944))) (fp.isFinite32 o5)))
