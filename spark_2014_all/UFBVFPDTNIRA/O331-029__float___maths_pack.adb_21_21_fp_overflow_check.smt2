...
(define-fun dynamic_invariant1 ((temp___expr_182 (_ BitVec 32)) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_1348 Float32) (temp___is_init_1345 Bool) (temp___skip_constant_1346 Bool) (temp___do_toplevel_1347 Bool)) Bool (=> (or (= temp___is_init_1345 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_1348)))
...
(define-fun dynamic_invariant3 ((temp___expr_1354 (_ BitVec 32)) (temp___is_init_1351 Bool) (temp___skip_constant_1352 Bool) (temp___do_toplevel_1353 Bool)) Bool true)
...
(assert (forall ((s Float32)) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (float_to_unsigned_32 s) true false true)) :pattern ((float_to_unsigned_32 s)))))
...
(define-fun dynamic_invariant4 ((temp___expr_1360 (_ BitVec 32)) (temp___is_init_1357 Bool) (temp___skip_constant_1358 Bool) (temp___do_toplevel_1359 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_1366 Float32) (temp___is_init_1363 Bool) (temp___skip_constant_1364 Bool) (temp___do_toplevel_1365 Bool)) Bool (=> (or (= temp___is_init_1363 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_1366)))
...
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant4 s true true true) (dynamic_invariant5 (unsigned_32_to_float s) true false true)) :pattern ((unsigned_32_to_float s)))))
