...
(define-fun dynamic_invariant1 ((temp___expr_212 (_ BitVec 32)) (temp___is_init_208 Bool) (temp___skip_constant_209 Bool) (temp___do_toplevel_210 Bool) (temp___do_typ_inv_211 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_1571 (_ BitVec 32)) (temp___is_init_1567 Bool) (temp___skip_constant_1568 Bool) (temp___do_toplevel_1569 Bool) (temp___do_typ_inv_1570 Bool)) Bool true)
...
(assert (forall ((s Float32)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant3 (float_to_unsigned_32 s) true false true true)) :pattern ((float_to_unsigned_32 s)))))
...
(define-fun dynamic_invariant4 ((temp___expr_1578 (_ BitVec 32)) (temp___is_init_1574 Bool) (temp___skip_constant_1575 Bool) (temp___do_toplevel_1576 Bool) (temp___do_typ_inv_1577 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_1585 Float32) (temp___is_init_1581 Bool) (temp___skip_constant_1582 Bool) (temp___do_toplevel_1583 Bool) (temp___do_typ_inv_1584 Bool)) Bool (=> (or (= temp___is_init_1581 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_1585)))
...
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant4 s true true true true) (dynamic_invariant5 (unsigned_32_to_float s) true false true true)) :pattern ((unsigned_32_to_float s)))))
