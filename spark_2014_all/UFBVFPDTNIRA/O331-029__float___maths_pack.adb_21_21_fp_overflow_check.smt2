...
(define-fun dynamic_invariant2 ((temp___expr_1342 Float32) (temp___is_init_1339 Bool) (temp___skip_constant_1340 Bool) (temp___do_toplevel_1341 Bool)) Bool (=> (or (= temp___is_init_1339 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_1342)))
...
(define-fun dynamic_invariant3 ((temp___expr_1348 (_ BitVec 32)) (temp___is_init_1345 Bool) (temp___skip_constant_1346 Bool) (temp___do_toplevel_1347 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_1354 (_ BitVec 32)) (temp___is_init_1351 Bool) (temp___skip_constant_1352 Bool) (temp___do_toplevel_1353 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_1360 Float32) (temp___is_init_1357 Bool) (temp___skip_constant_1358 Bool) (temp___do_toplevel_1359 Bool)) Bool (=> (or (= temp___is_init_1357 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_1360)))
