...
(assert (and (and (not (= requested_force ((_ int2bv 32) 0))) (and (and (= (mk_t__ref result) (mk_t__ref abs_out1)) (= abs_out11 (bvudiv (bvsub requested_force calculated_force) requested_force))) (and (fp.leq ((_ to_fp_unsigned 11 53) RNE abs_out11) (fp #b0 #b01111111000 #b0100011110101110000101000111101011100001010001111011)) (and (= (mk_t__ref result1) (mk_t__ref relative_error)) (= relative_error1 abs_out11))))) (and (and (= abs_out11 abs_out12) (= relative_error1 relative_error2)) (and (= abs_out13 abs_out11) (= relative_error3 relative_error1)))))
(assert (not (= relative_error2 (bvudiv (bvsub requested_force calculated_force) requested_force))))
(check-sat)
(exit)
