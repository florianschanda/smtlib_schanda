...
(define-fun in_range1 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 1000000))))
...
(define-fun dynamic_invariant1 ((temp___expr_153 (_ BitVec 32)) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 1000000))) (in_range1 temp___expr_153)))
...
(assert (in_range1 x))
(assert (and (bvult x ((_ int2bv 32) 1000000)) (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE x) (fp #b0 #b10000000010 #b0110000000000000000000000000000000000000000000000000)))))
