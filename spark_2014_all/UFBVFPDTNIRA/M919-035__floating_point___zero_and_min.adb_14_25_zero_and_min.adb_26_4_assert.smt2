...
(define-fun dynamic_invariant3 ((temp___expr_195 Float32) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_195)))
(declare-fun convert ((_ BitVec 32)) Float32)
(declare-fun convert__function_guard (Float32 (_ BitVec 32)) Bool)
(assert (forall ((s (_ BitVec 32))) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (convert s) true false true)) :pattern ((convert s)))))
...
(define-fun dynamic_invariant4 ((temp___expr_201 Float32) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (or (= temp___is_init_198 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_201)))
...
(define-fun dynamic_invariant5 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_207)))
(declare-fun magic (Float32) Int)
(declare-fun magic__function_guard (Int Float32) Bool)
(assert (forall ((s Float32)) (! (=> (dynamic_invariant4 s true true true) (dynamic_invariant5 (magic s) true false true)) :pattern ((magic s)))))
(declare-const x Int)
...
(assert (and (= zero_and_min__zero_plus__assume (convert ((_ int2bv 32) 0))) (fp.isFinite32 zero_and_min__zero_plus__assume)))
(assert (= zero_and_min__zero_plus__assume zero_plus))
(assert (fp.isFinite32 zero_plus))
(assert (and (= zero_and_min__zero_neg__assume (convert ((_ int2bv 32) 2147483648))) (fp.isFinite32 zero_and_min__zero_neg__assume)))
...
(assert (and (= zero_and_min__B3b__x__assume (magic (fp.min c1b c2b))) (in_range1 zero_and_min__B3b__x__assume)))
(assert (= zero_and_min__B3b__x__assume x))
(assert (in_range x))
(assert (and (= zero_and_min__B3b__y__assume (magic (fp.min c2b c1b))) (in_range1 zero_and_min__B3b__y__assume)))
(assert (= zero_and_min__B3b__y__assume y))
(assert (in_range y))
(assert (not (= x y)))
(assert (not (not (fp.eq (fp.min c1b c2b) (fp.min c2b c1b)))))
(check-sat)
(exit)
