...
(assert (and (= zero_and_min__zero_plus__assume (convert #x00000000)) (fp.isFinite32 zero_and_min__zero_plus__assume)))
(assert (= zero_and_min__zero_plus__assume zero_plus))
(assert (fp.isFinite32 zero_plus))
(assert (and (= zero_and_min__zero_neg__assume (convert #x80000000)) (fp.isFinite32 zero_and_min__zero_neg__assume)))
