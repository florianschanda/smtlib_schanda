...
(assert (and (= o4 (fp.add RNE old_speed speed1)) (fp.isFinite64 (fp.add RNE old_speed speed1))))
(assert (not (not (fp.isZero (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000)))))
(check-sat)
(exit)
