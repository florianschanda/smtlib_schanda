...
(assert (in_range1 x))
(assert (and (bvult x ((_ int2bv 32) 1000000)) (or (= state (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) state) (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE x) (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000)))))))
