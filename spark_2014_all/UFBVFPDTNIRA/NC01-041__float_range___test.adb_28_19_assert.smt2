...
(assert (and (fp.leq (fp.neg (fp #b0 #b01110001 #b10100011011011100010111)) value1) (fp.leq value1 (fp #b0 #b01110001 #b10100011011011100010111))))
(assert (in_range1 value2))
(assert (and (fp.leq (fp.neg (fp #b0 #b01110101 #b10001001001101110100110)) value2) (fp.leq value2 (fp.neg (fp #b0 #b01110101 #b00000110001001001101111)))))
(assert (in_range1 value3))
(assert (not (fp.leq (fp #b0 #b10000011 #b11111111111110111110100) value3)))
(check-sat)
(exit)
