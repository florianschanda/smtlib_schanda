...
(assert (= result res))
(assert (= res1 (fp.div RNE ((_ to_fp_unsigned 8 24) RNE x) (fp #b0 #b10001010 #b10011001100110011001101))))
(assert (=> (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) res1) (and (= o (fp.sub RNE res1 (fp #b0 #b10000011 #b01000000000000000000000))) (fp.isFinite32 (fp.sub RNE res1 (fp #b0 #b10000011 #b01000000000000000000000))))))
(assert (=> (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) res1) (= result1 res1)))
(assert (=> (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) res1) (= res2 o)))
(assert (=> (not (fp.leq (fp #b0 #b10000010 #b01000000000000000000000) res1)) (= res2 res1)))
(assert (not (fp.isFinite32 (fp.div RNE res2 y))))
(check-sat)
(exit)
