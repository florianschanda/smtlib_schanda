...
(assert (=> (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) #x0000) (= result46 avoid_div_by_zero_out1)))
(assert (=> (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) #x0000) (= (let ((subject avoid_div_by_zero_out1)) avoid_div_by_zero_out11) (let ((subject elapsed_time_h_out1)) elapsed_time_h_out11))))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) #x0000)) (= result47 avoid_div_by_zero_out1)))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) #x0000)) (= (let ((subject avoid_div_by_zero_out1)) avoid_div_by_zero_out12) ms_in_our1_out11)))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) #x0000)) (= (let ((subject avoid_div_by_zero_out1)) (mk_t__ref1 avoid_div_by_zero_out11)) (let ((subject avoid_div_by_zero_out1)) (mk_t__ref1 avoid_div_by_zero_out12)))))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) #x0000)) (= avoid_div_by_zero_out11 avoid_div_by_zero_out12)))
...
(assert (= (let ((subject relational_operator_out1_1)) relational_operator_out1_11) (ite (= (ite (let ((subject relational_operator_out1)) relational_operator_out11) 1 0) (ite (let ((subject compare_to_constant_out1)) compare_to_constant_out11) 1 0)) true false)))
