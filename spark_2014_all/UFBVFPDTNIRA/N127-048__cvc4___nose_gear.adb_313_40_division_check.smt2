...
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_147)))
...
(define-fun dynamic_invariant2 ((temp___expr_165 (_ BitVec 16)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool true)
...
(assert (and (= o3 (- to_int32_left_1_out11 (let ((subject to_int32_right_1_out1)) to_int32_right_1_out11))) (in_range1 (- to_int32_left_1_out11 (let ((subject to_int32_right_1_out1)) to_int32_right_1_out11)))))
(assert (= result26 sum2_1_out1))
(assert (= (let ((subject sum2_1_out1)) sum2_1_out11) o3))
(assert (and (= o4 (- (let ((subject to_int32_right_2_out1)) to_int32_right_2_out11) (let ((subject to_int32_left_2_out1)) to_int32_left_2_out11))) (in_range1 (- (let ((subject to_int32_right_2_out1)) to_int32_right_2_out11) (let ((subject to_int32_left_2_out1)) to_int32_left_2_out11)))))
(assert (= result27 sum1_1_1_out1))
(assert (= (let ((subject sum1_1_1_out1)) sum1_1_1_out11) o4))
(assert (and (= o5 (- (let ((subject data_type_conversion1_out1)) data_type_conversion1_out11) (let ((subject data_type_conversion_out1)) data_type_conversion_out11))) (in_range1 (- (let ((subject data_type_conversion1_out1)) data_type_conversion1_out11) (let ((subject data_type_conversion_out1)) data_type_conversion_out11)))))
(assert (= result28 sum_out1))
(assert (= (let ((subject sum_out1)) sum_out11) o5))
(assert (and (= o6 (- (let ((subject to_int32_left_2_out1)) to_int32_left_2_out11) (let ((subject to_int32_right_2_out1)) to_int32_right_2_out11))) (in_range1 (- (let ((subject to_int32_left_2_out1)) to_int32_left_2_out11) (let ((subject to_int32_right_2_out1)) to_int32_right_2_out11)))))
(assert (= result29 sum2_2_out1))
(assert (= (let ((subject sum2_2_out1)) sum2_2_out11) o6))
(assert (= result30 compare_to_constant_out1))
(assert (= (let ((subject compare_to_constant_out1)) compare_to_constant_out11) (ite (fp.leq (of_int RNE (let ((subject sum_out1)) sum_out11)) (fp #b0 #b10000001010 #b0111011100000000000000000000000000000000000000000000)) true false)))
(assert (and (= o7 (- max_uint16_out11 (let ((subject sum1_out1)) sum1_out11))) (in_range1 (- max_uint16_out11 (let ((subject sum1_out1)) sum1_out11)))))
(assert (= result31 sum_1_out1))
(assert (= (let ((subject sum_1_out1)) sum_1_out11) o7))
(assert (and (= o8 (- max_uint16_1_out11 (let ((subject sum1_1_out1)) sum1_1_out11))) (in_range1 (- max_uint16_1_out11 (let ((subject sum1_1_out1)) sum1_1_out11)))))
(assert (= result32 sum_2_out1))
(assert (= (let ((subject sum_2_out1)) sum_2_out11) o8))
(assert (and (= o9 (- max_uint16_2_out11 (let ((subject sum1_1_1_out1)) sum1_1_1_out11))) (in_range1 (- max_uint16_2_out11 (let ((subject sum1_1_1_out1)) sum1_1_1_out11)))))
(assert (= result33 sum_3_out1))
(assert (= (let ((subject sum_3_out1)) sum_3_out11) o9))
(assert (=> (<= 0 (let ((subject sum2_out1)) sum2_out11)) (= result34 left_out1)))
(assert (=> (<= 0 (let ((subject sum2_out1)) sum2_out11)) (= (let ((subject left_out1)) left_out11) (let ((subject sum2_out1)) sum2_out11))))
(assert (=> (not (<= 0 (let ((subject sum2_out1)) sum2_out11))) (= result35 left_out1)))
(assert (=> (not (<= 0 (let ((subject sum2_out1)) sum2_out11))) (= (let ((subject left_out1)) left_out12) (let ((subject sum_1_out1)) sum_1_out11))))
(assert (=> (not (<= 0 (let ((subject sum2_out1)) sum2_out11))) (= (let ((subject left_out1)) (mk_int__ref left_out11)) (let ((subject left_out1)) (mk_int__ref left_out12)))))
(assert (=> (not (<= 0 (let ((subject sum2_out1)) sum2_out11))) (= left_out11 left_out12)))
(assert (=> (<= 0 (let ((subject sum2_1_out1)) sum2_1_out11)) (= result36 left_1_out1)))
(assert (=> (<= 0 (let ((subject sum2_1_out1)) sum2_1_out11)) (= (let ((subject left_1_out1)) left_1_out11) (let ((subject sum2_1_out1)) sum2_1_out11))))
(assert (=> (not (<= 0 (let ((subject sum2_1_out1)) sum2_1_out11))) (= result37 left_1_out1)))
(assert (=> (not (<= 0 (let ((subject sum2_1_out1)) sum2_1_out11))) (= (let ((subject left_1_out1)) left_1_out12) (let ((subject sum_2_out1)) sum_2_out11))))
(assert (=> (not (<= 0 (let ((subject sum2_1_out1)) sum2_1_out11))) (= (let ((subject left_1_out1)) (mk_int__ref left_1_out11)) (let ((subject left_1_out1)) (mk_int__ref left_1_out12)))))
(assert (=> (not (<= 0 (let ((subject sum2_1_out1)) sum2_1_out11))) (= left_1_out11 left_1_out12)))
(assert (=> (<= 0 (let ((subject sum2_2_out1)) sum2_2_out11)) (= result38 left_2_out1)))
(assert (=> (<= 0 (let ((subject sum2_2_out1)) sum2_2_out11)) (= (let ((subject left_2_out1)) left_2_out11) (let ((subject sum2_2_out1)) sum2_2_out11))))
(assert (=> (not (<= 0 (let ((subject sum2_2_out1)) sum2_2_out11))) (= result39 left_2_out1)))
(assert (=> (not (<= 0 (let ((subject sum2_2_out1)) sum2_2_out11))) (= (let ((subject left_2_out1)) left_2_out12) (let ((subject sum_3_out1)) sum_3_out11))))
(assert (=> (not (<= 0 (let ((subject sum2_2_out1)) sum2_2_out11))) (= (let ((subject left_2_out1)) (mk_int__ref left_2_out11)) (let ((subject left_2_out1)) (mk_int__ref left_2_out12)))))
(assert (=> (not (<= 0 (let ((subject sum2_2_out1)) sum2_2_out11))) (= left_2_out11 left_2_out12)))
(assert (and (= o10 (let ((subject left_out1)) left_out11)) (uint_in_range (let ((subject left_out1)) left_out11))))
(assert (= o11 ((_ int2bv 16) o10)))
(assert (= result40 to_uint16_result_out1))
(assert (= (let ((subject to_uint16_result_out1)) to_uint16_result_out11) o11))
(assert (<= (let ((subject left_1_out1)) left_1_out11) 65535))
(assert (and (= o12 (let ((subject left_1_out1)) left_1_out11)) (uint_in_range (let ((subject left_1_out1)) left_1_out11))))
(assert (= o13 ((_ int2bv 16) o12)))
(assert (= result41 to_uint16_result_1_out1))
(assert (= (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) o13))
(assert (and (= o14 (let ((subject left_2_out1)) left_2_out11)) (uint_in_range (let ((subject left_2_out1)) left_2_out11))))
(assert (= o15 ((_ int2bv 16) o14)))
(assert (= result42 to_uint16_result_2_out1))
(assert (= (let ((subject to_uint16_result_2_out1)) to_uint16_result_2_out11) o15))
(assert (and (= o16 (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE (let ((subject to_uint16_result_out1)) to_uint16_result_out11)) wheel_circunference_out11)) (fp.isFinite64 (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE (let ((subject to_uint16_result_out1)) to_uint16_result_out11)) wheel_circunference_out11))))
(assert (= result43 distance_km_out1))
(assert (= (let ((subject distance_km_out1)) distance_km_out11) o16))
(assert (and (= o17 (fp.div RNE ((_ to_fp_unsigned 11 53) RNE (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11)) ms_in_hour_out11)) (fp.isFinite64 (fp.div RNE ((_ to_fp_unsigned 11 53) RNE (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11)) ms_in_hour_out11))))
(assert (= result44 elapsed_time_h_out1))
(assert (= (let ((subject elapsed_time_h_out1)) elapsed_time_h_out11) o17))
(assert (= result45 relational_operator_out1))
(assert (= (let ((subject relational_operator_out1)) relational_operator_out11) (ite (bvule (let ((subject to_uint16_result_2_out1)) to_uint16_result_2_out11) (let ((subject sum1_2_out1)) sum1_2_out11)) true false)))
(assert (=> (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) ((_ int2bv 16) 0)) (= result46 avoid_div_by_zero_out1)))
(assert (=> (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) ((_ int2bv 16) 0)) (= (let ((subject avoid_div_by_zero_out1)) avoid_div_by_zero_out11) (let ((subject elapsed_time_h_out1)) elapsed_time_h_out11))))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) ((_ int2bv 16) 0))) (= result47 avoid_div_by_zero_out1)))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) ((_ int2bv 16) 0))) (= (let ((subject avoid_div_by_zero_out1)) avoid_div_by_zero_out12) ms_in_our1_out11)))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) ((_ int2bv 16) 0))) (= (let ((subject avoid_div_by_zero_out1)) (mk_t__ref1 avoid_div_by_zero_out11)) (let ((subject avoid_div_by_zero_out1)) (mk_t__ref1 avoid_div_by_zero_out12)))))
(assert (=> (not (bvugt (let ((subject to_uint16_result_1_out1)) to_uint16_result_1_out11) ((_ int2bv 16) 0))) (= avoid_div_by_zero_out11 avoid_div_by_zero_out12)))
(assert (= result48 (mk_bool__ref estimatedgroundvelocityisavailable)))
(assert (= estimatedgroundvelocityisavailable1 (let ((subject relational_operator_out1)) relational_operator_out11)))
(assert (= result49 relational_operator_out1_1))
(assert (= (let ((subject relational_operator_out1_1)) relational_operator_out1_11) (ite (= (to_int6 (let ((subject relational_operator_out1)) relational_operator_out11)) (to_int6 (let ((subject compare_to_constant_out1)) compare_to_constant_out11))) true false)))
(assert (not (not (fp.isZero (let ((subject avoid_div_by_zero_out1)) avoid_div_by_zero_out11)))))
(check-sat)
(exit)
