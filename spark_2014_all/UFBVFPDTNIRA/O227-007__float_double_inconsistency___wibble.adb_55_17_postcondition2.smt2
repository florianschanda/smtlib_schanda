...
(define-fun in_range1 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x000F4240)))
...
(define-fun dynamic_invariant1 ((temp___expr_179 (_ BitVec 32)) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (or (= temp___is_init_175 true) (bvule #x00000000 #x000F4240)) (in_range1 temp___expr_179)))
...
(assert (in_range1 x))
(assert (and (bvult x #x000F4240) (or (= state (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)) (and (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) state) (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE x) (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000)))))))
(assert (and (= o (fp.add RNE state (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000))) (fp.isFinite64 (fp.add RNE state (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000)))))
(assert (= result state))
(assert (= state1 o))
(assert (= state1 state2))
(assert (= state3 state1))
(assert (not (fp.leq (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) state2)))
(check-sat)
(exit)
