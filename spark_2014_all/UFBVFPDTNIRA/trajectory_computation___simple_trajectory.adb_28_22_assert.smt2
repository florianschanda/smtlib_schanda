...
(assert (not (fp.eq (fp.add RNE (fp.mul RNE (of_int RNE n) bound) bound) (fp.mul RNE (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) bound))))
(check-sat)
(exit)
