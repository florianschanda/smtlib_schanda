...
(define-fun dynamic_invariant ((temp___expr_154 (_ BitVec 16)) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool true)
...
(assert (and (fp.leq (fp #b0 #b01111101 #b00000000000000000000000) y) (fp.leq y (fp #b0 #b01111111 #b00000000000000000000000))))
(assert (not (not (fp.isZero (fp #b0 #b10001010 #b10011001100110011001101)))))
(check-sat)
(exit)
