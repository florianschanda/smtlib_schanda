...
(assert (and (= o (fp.div RNE (fp #b0 #b10010101 #b11000000110001000110000) ((_ to_fp_unsigned 8 24) RNE x))) (fp.isFinite32 (fp.div RNE (fp #b0 #b10010101 #b11000000110001000110000) ((_ to_fp_unsigned 8 24) RNE x)))))
(assert (= result h))
(assert (= h1 o))
(assert (not (fp.leq (fp #b0 #b10001100 #b10101101101100000000000) h1)))
(assert (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) h1))
(assert (not (in_range1 h1)))
(check-sat)
(exit)
