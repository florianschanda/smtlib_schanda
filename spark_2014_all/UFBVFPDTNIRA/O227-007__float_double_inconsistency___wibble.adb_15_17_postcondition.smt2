...
(assert (in_range1 x))
(assert (and (bvult x #x000F4240) (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 8 24) RNE x) (fp #b0 #b10000010 #b01100000000000000000000)))))
...
(assert (not (fp.leq state2 (fp.mul RNE ((_ to_fp_unsigned 8 24) RNE (bvadd x #x00000001)) (fp #b0 #b10000010 #b01100000000000000000000)))))
(check-sat)
(exit)
