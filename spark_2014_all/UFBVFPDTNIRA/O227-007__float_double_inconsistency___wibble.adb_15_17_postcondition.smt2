...
(assert (in_range1 x))
(assert (and (bvult x ((_ int2bv 32) 1000000)) (fp.leq state (fp.mul RNE ((_ to_fp_unsigned 8 24) RNE x) (fp #b0 #b10000010 #b01100000000000000000000)))))
...
(assert (not (fp.leq state2 (fp.mul RNE ((_ to_fp_unsigned 8 24) RNE (bvadd x ((_ int2bv 32) 1))) (fp #b0 #b10000010 #b01100000000000000000000)))))
(check-sat)
(exit)
