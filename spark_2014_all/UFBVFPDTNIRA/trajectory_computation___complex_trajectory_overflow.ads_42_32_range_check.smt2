...
(assert (and (and (= speed old_speed) (and (fp.isFinite64 old_speed) (and (= (fp.add RNE drag (fp.mul RNE (fp.mul RNE factor (fp #b0 #b10000000010 #b0011100111010010111100011010100111111011111001110111)) (fp #b0 #b01111111001 #b0001000100010001000100010001000100010001000100010001))) delta_speed) (and (fp.isFinite64 delta_speed) (and (= ((_ int2bv 16) n) n_bv) (and (and (and (= o (fp.add RNE speed delta_speed)) (fp.isFinite64 (fp.add RNE speed delta_speed))) (and (= (mk_t__ref1 result) (mk_t__ref1 speed)) (= speed1 o))) (and (and (fp.leq (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) delta_speed) (fp.leq delta_speed (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (and (= (in_bounds (high_bound n)) true) (and (= (in_bounds (low_bound n)) true) (and (fp.eq (fp.add RNE (fp.mul RNE ((_ to_fp_unsigned 11 53) RNE n_bv) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.add RNE ((_ to_fp_unsigned 11 53) RNE n_bv) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (and (fp.eq (fp.add RNE (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (and (fp.eq (fp.sub RNE (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp.mul RNE (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)))) (and (fp.eq (t 1) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (and (fp.eq (fp.add RNE (of_int RNE n) (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)) (of_int RNE (+ n 1))) (and (fp.leq (fp.sub RNE (fp.mul RNE (of_int RNE n) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) speed1) (and (fp.leq (fp.mul RNE (of_int RNE (+ n 1)) (fp.neg (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) speed1) (and (fp.leq speed1 (fp.add RNE (fp.mul RNE (of_int RNE n) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (and (fp.leq speed1 (fp.mul RNE (of_int RNE (+ n 1)) (fp #b0 #b10000000101 #b0000010000000000000000000000000000000000000000000000))) (and (fp.leq (low_bound (+ n 1)) speed1) (and (fp.leq speed1 (high_bound (+ n 1))) (and (= (invariant__ (+ n 1) speed1) true) (and (and (and (and (= o4 (fp.add RNE old_speed speed1)) (fp.isFinite64 (fp.add RNE old_speed speed1))) (= o5 (fp.div RNE o4 (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000)))) (and (= (mk_t__ref1 result1) (mk_t__ref1 average)) (= average1 o5))) (and (and (= o6 (fp.add RNE distance (fp.mul RNE average1 (fp #b0 #b01111111001 #b0001000100010001000100010001000100010001000100010001)))) (fp.isFinite64 (fp.add RNE distance (fp.mul RNE average1 (fp #b0 #b01111111001 #b0001000100010001000100010001000100010001000100010001))))) (and (= (mk_t__ref1 result2) (mk_t__ref1 distance)) (= distance1 o6))))))))))))))))))))))))) (and (and (= average1 average2) (and (= distance1 distance2) (= speed1 speed2))) (and (= average3 average1) (and (= distance3 distance1) (= speed3 speed1))))))
