...
(define-fun in_range1 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)) x) (fp.leq x (fp #b0 #b10000100 #b00000000000000000000000)))))
...
(define-fun dynamic_invariant ((temp___expr_147 Float32) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (fp.leq (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)) (fp #b0 #b10000100 #b00000000000000000000000))) (in_range1 temp___expr_147)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const value Float32)
(declare-const value1 Float32)
(declare-const value2 Float32)
(declare-const value3 Float32)
(assert (=> (fp.leq (fp.neg (fp #b0 #b10000100 #b00000000000000000000000)) (fp #b0 #b10000100 #b00000000000000000000000)) (in_range1 value)))
(assert (in_range1 value1))
(assert (not (fp.leq (fp.neg (fp #b0 #b01110001 #b10100011011011100010111)) value1)))
(check-sat)
(exit)
