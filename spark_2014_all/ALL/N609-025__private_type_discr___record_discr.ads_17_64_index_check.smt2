...
(declare-fun record_discr__interm_result__upto__first__bit () Int)

(declare-fun record_discr__interm_result__upto__last__bit () Int)

(declare-fun record_discr__interm_result__upto__position () Int)
...
(declare-fun record_discr__interm_result__to_search__first__bit () Int)

(declare-fun record_discr__interm_result__to_search__last__bit () Int)

(declare-fun record_discr__interm_result__to_search__position () Int)
...
(declare-fun dummy7 () tT5sP1)

(declare-datatypes ()
((tT5sP1__ref (mk_tT5sP1__ref (tT5sP1__content tT5sP1)))))
(define-fun tT5sP1__ref___projection ((a tT5sP1__ref)) tT5sP1 (tT5sP1__content
                                                              a))
...
(define-fun us_split_fields_To_Search2__projection ((a us_split_fields4)) (Array Int natural)
...
(define-fun us_rep_5__projection ((a us_rep2)) us_split_discrs2 (us_split_discrs4
                                                                a))
...
(define-fun to_base ((a us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a)
                                          ...
                                          (us_split_fields5 a)) 1 3))))

(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r)
                                          (mk___split_fields2
                                          (let ((temp___133 (rec__record_discr__interm_result__to_search
                                                            (us_split_fields3
                                                            r))))
                                          (to_array temp___133)))))
...
(declare-fun record_discr__interm_result__upto__first__bit1 () Int)

(declare-fun record_discr__interm_result__upto__last__bit1 () Int)

(declare-fun record_discr__interm_result__upto__position1 () Int)
...
(declare-fun record_discr__interm_result__to_search__first__bit1 () Int)

(declare-fun record_discr__interm_result__to_search__last__bit1 () Int)

(declare-fun record_discr__interm_result__to_search__position1 () Int)
...
(declare-datatypes ()
((result_3__ref (mk_result_3__ref (result_3__content us_rep2)))))
...
(declare-fun record_discr__search_upto_3__result1 () us_main_type)
...
(declare-fun record_discr__search_upto_3__result2 () Bool)

(declare-fun record_discr__search_upto_3__result3 () us_main_type)

(declare-fun result2 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result4 () us_rep)

(declare-fun result3 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result5 () us_rep)

(declare-fun result4 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result6 () us_rep)

(declare-fun record_discr__search_upto_3__result7 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result8 () us_rep)

(declare-fun record_discr__search_upto_3__result9 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result10 () us_rep)

(declare-fun record_discr__search_upto_3__result11 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result12 () us_rep)

(declare-fun record_discr__search_upto_3__result13 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result14 () us_rep)

(declare-fun record_discr__search_upto_3__result15 () result_ty__ref)

(declare-fun record_discr__search_upto_3__result16 () us_rep)

(define-fun record_discr__search_upto_3__result17 () us_rep (mk___rep
                                                            (mk___split_discrs
                                                            record_discr__search_upto_3__result2)
                                                            (mk___split_fields
                                                            record_discr__search_upto_3__result3)))

(define-fun o8 () us_rep (mk___rep (mk___split_discrs o6)
                         (mk___split_fields o7)))

(define-fun o9 () us_rep (mk___rep (mk___split_discrs o4)
                         (mk___split_fields o5)))

(define-fun o10 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o11 () us_rep (mk___rep (mk___split_discrs o)
                          (mk___split_fields o1)))

(define-fun record_discr__search_upto_3__result18 () result_ty__ref (mk_result_ty__ref
                                                                    (mk___rep
                                                                    (mk___split_discrs
                                                                    record_discr__search_upto_3__result)
                                                                    (mk___split_fields
                                                                    record_discr__search_upto_3__result1))))
...
;; H
  (assert
  (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 r))) 3))

;; H
  (assert
  (= record_discr__search_upto_3__result13 record_discr__search_upto_3__result11))

;; H
  (assert
  (= record_discr__search_upto_3__result14 record_discr__search_upto_3__result12))
...
;; H
  ...
  (= record_discr__search_upto_3__result11 (mk_result_ty__ref
                                           record_discr__search_upto_3__result17))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 1)) e)
  (= record_discr__search_upto_3__result12 record_discr__search_upto_3__result17)))
...
;; H
  ...
  record_discr__search_upto_3__result18)))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 1)) e)
  (= record_discr__search_upto_3__result17 o11)))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 1)) e))
  (= record_discr__search_upto_3__result11 record_discr__search_upto_3__result9)))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 1)) e))
  (= record_discr__search_upto_3__result12 record_discr__search_upto_3__result10)))
...
;; H
  ...
  (= record_discr__search_upto_3__result9 (mk_result_ty__ref
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 2)) e)
  (= record_discr__search_upto_3__result10 record_discr__search_upto_3__result4))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 2)) e)
  (= result2 record_discr__search_upto_3__result18))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 2)) e)
  (= record_discr__search_upto_3__result4 o10))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 2)) e))
  (= record_discr__search_upto_3__result9 record_discr__search_upto_3__result7))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 2)) e))
  (= record_discr__search_upto_3__result10 record_discr__search_upto_3__result8))))
...
;; H
  ...
  (= record_discr__search_upto_3__result7 (mk_result_ty__ref
                                          record_discr__search_upto_3__result5))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e)
  (= record_discr__search_upto_3__result8 record_discr__search_upto_3__result5)))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e)
  (= result3 record_discr__search_upto_3__result18)))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e)
  (= record_discr__search_upto_3__result5 o9)))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e))
  (= record_discr__search_upto_3__result7 (mk_result_ty__ref
                                          record_discr__search_upto_3__result6))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e))
  (= record_discr__search_upto_3__result8 record_discr__search_upto_3__result6)))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e))
  (= result4 record_discr__search_upto_3__result18)))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e))
  (= record_discr__search_upto_3__result6 o8)))))

;; H
  (assert
  (= record_discr__search_upto_3__result15 record_discr__search_upto_3__result13))
...
;; H
  (assert
  (<= i (to_rep
        (rec__record_discr__interm_result__upto (us_split_discrs4 r)))))
