...
;; WP_parameter_def
 ;; File "p.adb", line 4, characters 0-0
  ...
  (and
  (and
  (and (and (= o po2) (= o us_self__compl))
  (and (= result po2) (= po3 us_self__compl1))) (not (= (of_int 1) true)))
  (and (= po3 po4) (= po5 po3))) (and (= po8 (mk_pt__ref po4)) (= po7 po5)))
  (and (= po8 (mk_pt__ref po)) (= po7 po1))))))
(check-sat)
(exit)
