...
(declare-fun new_carry4 () Bool)

(declare-fun i4 () Int)

(declare-fun a6 () map__ref)

(declare-fun carry6 () bool__ref)

(declare-fun j6 () int__ref)

(declare-fun new_carry5 () bool__ref)
...
(declare-fun new_carry6 () Bool)

(declare-fun i6 () Int)

(declare-fun a8 () map__ref)

(declare-fun carry8 () bool__ref)

(declare-fun j8 () int__ref)

(declare-fun new_carry7 () bool__ref)
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry2 new_carry3)))
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry4 new_carry2)))
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last))
  (= new_carry5 (mk_bool__ref new_carry3))))
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (= carry6 (mk_bool__ref carry4))))
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry6 new_carry4)))
...
;; H
  ...
  (= new_carry5 (mk_bool__ref new_carry))))

;; H
  (assert
  (=> (not (and (<= a_first i1) (<= i1 a_last))) (= j6 (mk_int__ref j))))

;; H
  (assert
  (=> (not (and (<= a_first i1) (<= i1 a_last)))
  (= carry6 (mk_bool__ref carry1))))

;; H
  (assert
  (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a6 (mk_map__ref a))))
...
;; H
  (assert
  (=> (not (and (<= a_first i1) (<= i1 a_last))) (= new_carry6 new_carry1)))
...
;; H
  (assert (= o19 (num_of_boolean (bool__content carry8))))
