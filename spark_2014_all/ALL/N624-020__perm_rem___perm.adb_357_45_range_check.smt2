...
(define-fun o10 () us_t (mk___t o8 o9))

(define-fun o11 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and (= o4 (get_witness bb2 aa o3))
  (and (in_range3 o4)
  (and
  (and (<= (to_rep1 (first (rt aa))) o4) (<= o4 (to_rep1 (last (rt aa)))))
  (and (= (to_rep (select (elts bb2) o3)) (to_rep (select (elts aa) o4)))
  (= (is_perm (remove bb2 o3) (remove aa o4)) true))))))
...
;; H
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (+ ia21 1) k) (<= k (to_rep1 (last (rt aa)))))
  (= (to_rep (select (elts aa) k)) (to_rep (select o6 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ia21 k) (<= k (- (to_rep1 (last (rt aa))) 1)))
