...
;; H
  ...
  (and (= temp___470 r27b)
  (and (and (= result8 current12) (= current1 temp___469))
...
;; H
  (assert
  (and (= o9 (last4 (model__ v)))
  (and (dynamic_property4 first3 last5 o9) (= o9 (last4 (model__ v))))))
...
;; H
  (assert
  (= result6 (ite (<= first use_vectors__my_find__result13) o10 false)))

;; H
  (assert
  (=> (= result6 true)
  (and (= us2 use_vectors__my_find__result13) (dynamic_property1 first1
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o8 (get (model__ v) o7))
  (and (in_range4 o8) (= o8 (get (model__ v) o7))))))
...
;; H
  (assert (and (= us1 i) (dynamic_property1 first1 last1 i)))
