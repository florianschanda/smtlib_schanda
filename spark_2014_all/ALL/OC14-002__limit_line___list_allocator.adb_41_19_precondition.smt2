...
;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o10) true false))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o9 first_available) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o7) true false)))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o6 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_allocated 0))) (= result (ite (= o8 0) true false)))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o4 (get model____split_fields o3)) (in_range7 o4))))
