...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters
                                                      i3)))
  (=> (and (<= 0 j3) (<= j3 (- i3 1))) (= j17 (mk_int__ref j5))))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters
                                                      i3)))
  (=> (and (<= 0 j3) (<= j3 (- i3 1))) (= winners27 (mk_map__ref1 winners6))))))
...
;; H
  (assert
  (=> (and (<= (+ last_candidate 1) i8) (<= i8 20)) (= temp___716 i8)))
...
;; H
  (assert
  (=> (and (<= (+ last_candidate 1) i8) (<= i8 20))
  (= winners20 (store winners19 i9 (of_int 0)))))
...
;; H
  (assert
  (=> (and (<= (+ last_candidate 1) i8) (<= i8 20)) (= i10 (mk_int__ref i9))))
...
;; H
  (assert
  (=> (and (<= (+ last_candidate 1) i8) (<= i8 20)) (= winners22 winners20)))
...
;; H
  (assert
  (=> (and (<= (+ last_candidate 1) i8) (<= i8 20)) (= winners23 winners21)))
...
;; H
  (assert
  (=> (and (<= (+ last_candidate 1) i8) (<= i8 20)) (= winners24 winners22)))

;; H
  (assert
  (=> (not (and (<= (+ last_candidate 1) i8) (<= i8 20)))
  (= i12 (mk_int__ref i8))))
...
;; H
  (assert
  (=> (not (and (<= (+ last_candidate 1) i8) (<= i8 20))) (= i13 i8)))
...
;; WP_parameter_def
 ;; File "evoting.ads", line 48, characters 0-0
  (not (< (to_rep (select counters i18)) (to_rep (select counters winner)))))
(check-sat)
(exit)
