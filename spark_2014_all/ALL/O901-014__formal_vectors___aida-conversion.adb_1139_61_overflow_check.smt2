...
;; H
  (assert
  (and (= temp___1791 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1791)
  (<= temp___1791 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1791))
