...
(declare-datatypes ((tS8bP1__ref 0))
(((mk_tS8bP1__ref (tS8bP1__content tdigit_count_typeB)))))
(define-fun tS8bP1__ref___projection ((a tS8bP1__ref)) tdigit_count_typeB
  (tS8bP1__content a))
...
(declare-datatypes ((s8b__ref 0)) (((mk_s8b__ref (s8b__content us_t1)))))
...
(((mk_t10b__ref (t10b__content tdigit_count_typeB)))))
(define-fun t10b__ref___projection ((a t10b__ref)) tdigit_count_typeB
  (t10b__content a))
...
(declare-datatypes ((t11b__ref 0)) (((mk_t11b__ref (t11b__content us_t2)))))
...
(((mk_t12b__ref (t12b__content tdigit_count_typeB)))))
(define-fun t12b__ref___projection ((a t12b__ref)) tdigit_count_typeB
  (t12b__content a))
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property7 1 65536 temp___1125 temp___1126)
  (and (= (first5 temp___1123) temp___1125)
  (= (last5 temp___1123) temp___1126)))
  (forall ((temp___1127 Int))
  (= (select (to_array2 temp___1123) temp___1127) (of_rep1 temp___1124))))))))

(define-fun dynamic_invariant5 ((temp___expr_342 us_t1)
  (temp___is_init_339 Bool) (temp___skip_constant_340 Bool)
  (temp___do_toplevel_341 Bool)) Bool (=>
                                      (not (= temp___skip_constant_340 true))
                                      (and (dynamic_property3 1 r9b
                                      (first3 temp___expr_342)
                                      (last3 temp___expr_342))
                                      (and (= (first3 temp___expr_342) 1)
                                      (= (last3 temp___expr_342) r9b)))))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1122 ((_ int2bv 8) 0) 1 r9b)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1122 ((_ int2bv 8) 0) 1 r9b)))) r9b))

;; H
  (assert
  (= (mk___t2 temp___1129 temp___11291) (temp___1122 ((_ int2bv 8) 0) 1 r9b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11291)) (to_rep2 (last4 temp___11291)))
     (+ (- (to_rep2 (last4 temp___11291)) (to_rep2 (first4 temp___11291))) 1)
     0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11291)) (to_rep2 (last4 temp___11291)))
  temp___11301))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___11301)) (to_rep2 (last2 temp___11301)))
     (+ (- (to_rep2 (last2 temp___11301)) (to_rep2 (first2 temp___11301))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1132 temp___11321) (mk___t1 temp___1130 temp___11301)))
...
;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11321)) (to_rep2 (last2 temp___11321)))
  o1))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___11341 temp___11342))))
...
;; H
  ...
  (forall ((temp___1143 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1143)
  (<= temp___1143 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1143) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1143))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert
;; WP_parameter_def
 ;; File "very_longs.adb", line 33, characters 0-0
  (not
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))
