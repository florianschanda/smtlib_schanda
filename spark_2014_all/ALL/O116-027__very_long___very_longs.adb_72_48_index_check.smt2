...
(declare-datatypes ()
((tS8bP1__ref (mk_tS8bP1__ref (tS8bP1__content tdigit_count_typeB)))))
...
(declare-datatypes ()
((t10b__ref (mk_t10b__ref (t10b__content tdigit_count_typeB)))))
...
(declare-datatypes ()
((t12b__ref (mk_t12b__ref (t12b__content tdigit_count_typeB)))))
...
(declare-fun temp___1129 () (Array Int octet))

(declare-fun temp___11291 () t2)

(declare-fun temp___1130 () (Array Int octet))

(declare-fun temp___11301 () t1)

(declare-fun temp___1132 () (Array Int octet))

(declare-fun temp___11321 () t1)
...
(declare-fun temp___1134 () digit_index_type)

(declare-fun temp___11341 () (Array Int octet))

(declare-fun temp___11342 () t)
