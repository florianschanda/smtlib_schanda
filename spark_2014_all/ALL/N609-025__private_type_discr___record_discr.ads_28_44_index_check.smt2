...
(define-fun o21 () us_rep (mk___rep (mk___split_discrs o18)
                          (mk___split_fields o19)))

(define-fun o22 () us_rep1 (mk___rep1 (mk___split_discrs1 o15)
...
;; H
  (assert
  (=> (not (= result true))
  (and (= o21 (search_upto o22 e))
  (ite (= o18 true)
  (and (<= (get_content o21) (to_rep o15))
  (= (to_rep (select o16 (get_content o21))) e))
  (forall ((i Int))
...
;; H
  (assert
  (=> (not (= result true)) (= record_discr__search_upto__result3 o21)))
...
;; H
  (assert
  (and
  (= temp___270 (get_content
                (result_ty__content record_discr__search_upto__result8)))
  (in_range2 temp___270)))
