...
(declare-datatypes ((dx_time_type__ref 0))
(((mk_dx_time_type__ref (dx_time_type__content us_rep)))))
...
(declare-const temp___7582 (Array Int bits_8))

(declare-const temp___75821 t2)
