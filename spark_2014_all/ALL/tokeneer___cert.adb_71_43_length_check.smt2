...
(declare-const temp___1235 (Array Int character))

(declare-const temp___12351 t1)
...
;; H
  (assert (= o18 temp___1235))

;; H
  (assert (= (mk1 1 (to_rep1 fullstring__last)) temp___12351))

(assert
;; WP_parameter_def
 ;; File "audittypes.ads", line 103, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___12321)) (to_rep1 (last2 temp___12321)))
     (+ (- (to_rep1 (last2 temp___12321)) (to_rep1 (first2 temp___12321))) 1)
     0) (ite (<= (to_rep1 (first2 temp___12351)) (to_rep1
                                                 (last2 temp___12351)))
        (+ (- (to_rep1 (last2 temp___12351)) (to_rep1 (first2 temp___12351))) 1)
        0))))
(check-sat)
(exit)
