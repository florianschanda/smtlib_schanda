...
(declare-fun temp___1172 () us_rep5)

(declare-fun o17 () Int)

(declare-fun o18 () Int)

(declare-fun temp___1086 () (Array Int us_rep1))
...
(declare-fun temp___1087 () (Array Int us_rep1))
...
(declare-fun temp___1088 () (Array Int us_rep1))
...
(declare-fun temp___1089 () (Array Int us_rep1))
...
;; H
  ...
  (= o (root
       ...
       (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
       t__split_fields3))))
  (and (in_range3 o) (= o (to_rep1 t__split_fields)))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields) y1) j6))) true))))
  (and
  (forall ((j6 Int))
  (=> (and (<= 1 j6) (<= j6 100))
  (=>
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields) y1) j6)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields1) x1) j6))) true))))
  (and
  (forall ((j6 Int))
  (=> (and (<= 1 j6) (<= j6 100))
  (=>
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields1) x1) j6)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f_2__split_fields3) y1) j6))) true)
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
  ...
  (= (get
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f_2__split_fields3) y1) j6)))
     (+ (length
        (rec__tree_model__path_type__a
        (us_split_fields1
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f_3__split_fields3) xr1) j6))) true))
  (< (to_rep
...
;; H
  (assert (=> (= is_root true) (= temp___1172 (mk___rep3 o16))))
...
;; H
  (assert
  (=> (= is_root true) (= t__split_fields10 (us_split_fields7 temp___1172))))
...
;; H
  ...
  (= (size (mk___rep2 binary_trees__plug__f__fields2)) (size
                                                       ...
                                                       (rec__search_trees__search_tree__struct
                                                       t__split_fields9)))))
  (and (= x1 (peek (mk___rep2 binary_trees__plug__f__fields2) j3 d2))
  (and
  (forall ((j6 Int))
  (=> (and (<= 1 j6) (<= j6 100))
  (=>
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o17) j6))) true))))
  (and
  (forall ((j6 Int))
  (=> (and (<= 1 j6) (<= j6 100))
  (=>
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o17) j6)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
...
;; H
  (assert
  (=> (not (= is_root true))
  (and (= temp___1089 (model__ (mk___rep2 f_old__split_fields2) o30))
  (and (dynamic_invariant6 temp___1089 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1089 o30))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1089 o30)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o30))
  (ite (and (not (= (parent (mk___rep2 f_old__split_fields2) i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1089 (parent (mk___rep2 f_old__split_fields2) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1089 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1089 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select temp___1089 (parent (mk___rep2 f_old__split_fields2) i1))))
     (position (mk___rep2 f_old__split_fields2) i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1089 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1089 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1089 j6))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1089 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1089 j6)))) true))
  (= j6 i1)))))))))))))))

;; H
  (assert (=> (not (= is_root true)) (= o31 (select temp___1089 y1))))
...
;; H
  ...
  (= temp___1088 (model__
                 ...
                 o26))
  (and (dynamic_invariant6 temp___1088 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1088 o26))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1088 o26)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o26))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1088 (parent
                              (rec__search_trees__search_tree__struct
                              t__split_fields11) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1088 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1088 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1088 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1088 j6))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1088 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1088 j6)))) true))
  (= j6 i1)))))))))))))))

;; H
  (assert (=> (not (= is_root true)) (= o27 (select temp___1088 x1))))
...
;; H
  (assert
  (=> (not (= is_root true))
  (and (= temp___1087 (model__ (mk___rep2 f_old__split_fields2) o22))
  (and (dynamic_invariant6 temp___1087 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1087 o22))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1087 o22)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o22))
  (ite (and (not (= (parent (mk___rep2 f_old__split_fields2) i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1087 (parent (mk___rep2 f_old__split_fields2) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1087 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1087 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select temp___1087 (parent (mk___rep2 f_old__split_fields2) i1))))
     (position (mk___rep2 f_old__split_fields2) i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1087 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1087 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1087 j6))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1087 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1087 j6)))) true))
  (= j6 i1)))))))))))))))

;; H
  (assert (=> (not (= is_root true)) (= o23 (select temp___1087 j3))))
...
;; H
  ...
  (= temp___1086 (model__
                 (rec__search_trees__search_tree__struct t__split_fields11)
                 o18))
  (and (dynamic_invariant6 temp___1086 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1086 o18))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1086 o18)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o18))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1086 (parent
                              (rec__search_trees__search_tree__struct
                              t__split_fields11) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1086 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1086 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1086 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1086 j6))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1086 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1086 j6)))) true))
  (= j6 i1)))))))))))))))

;; H
  (assert (=> (not (= is_root true)) (= o19 (select temp___1086 j3))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__1 (mk___rep3 t_old__split_fields4)) j6))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields10)) j6))) true)))))
...
;; H
  (assert
  (and
  (= o103 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range4 o103)
  (= o103 (size
          (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i))
  (and
  (= o100 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o100)
  (= o100 (to_rep1
          (rec__search_trees__search_tree__root
          (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i)))
  (and
  (= o102 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o102)
  (= o102 (to_rep1
          (rec__search_trees__search_tree__root
          (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3))) i)))
  (= result27 (ite (= o102 o101) true false))))
...
;; H
  (assert
  (and
  (= o99 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range4 o99)
  (and
  (= o99 (parent
...
;; H
  (assert
  (and
  (= o97 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range5 o97)
  (= o97 (position
         (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (and
  (= o96 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o94))
  (and (in_range4 o96)
  (and
  (= o96 (parent
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields12)) o94))
  (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields12))) 0)
  (= o96 0))))))
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i))
  (and
  (= o90 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o88))
  (and (in_range5 o90)
  (= o90 (position
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (root
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3))) i))
  (= result31 (ite (= o90 o89) true false))))
...
;; H
  ...
  (=> (= result33 true)
  (and
  (= o84 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o83))
  (and (in_range4 o84)
  (and
  (= o84 (parent
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o60 o59) (in_range3 o59)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o62 o61) (in_range3 o61)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o64 o63) (in_range3 o63)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o66 o65) (in_range3 o65)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o68 o67) (in_range3 o67)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o70 o69) (in_range3 o69)))))
...
;; H
  ...
  (=> (= result34 true)
  (and
  (= o71 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o70))
  (and (in_range5 o71)
  (= o71 (position
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields12)) o70)))))))

;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (= result32 (ite (= o71 0) true false)))))
...
;; H
  (assert
  (=> (not (= j1 i)) (= result38 (ite (not (= o51 true)) true false))))
...
;; H
  (assert
  (=> (= result38 true) (= result39 (ite (not (= o49 true)) true false))))
...
;; H
  (assert
  (=> (= result38 true)
  (=> (not (= result39 true)) (= result37 (ite (= o47 1) true false)))))
...
;; H
  (assert
  (=> (= result37 true) (= result41 (ite (not (= o46 true)) true false))))
...
;; H
  (assert
  (=> (= result37 true)
  (=> (not (= result41 true)) (and (= o37 o36) (in_range3 o36)))))
...
;; H
  (assert
  (=> (= result37 true)
  (=> (not (= result41 true)) (and (= o39 o38) (in_range3 o38)))))
...
;; H
  (assert
  (=> (= result37 true)
  (=> (not (= result41 true)) (= result40 (ite (= o40 1) true false)))))
...
;; H
  (assert
  (=> (= result37 true)
  (=> (not (= result40 true)) (= result36 (ite (= o35 0) true false)))))
