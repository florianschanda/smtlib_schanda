...
;; range_axiom
  (assert
  (forall ((x bits_5)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__otp_addr_type__otp_addr bits_11)(rec__dw1000__register_types__otp_addr_type__reserved bits_5)))))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep3
                           (rec__dw1000__register_types__otp_addr_type__otp_addr
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__otp_addr_type__otp_addr
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__otp_addr_type__reserved
...
(declare-fun dw1000__register_types__otp_addr_type__otp_addr__first__bit () Int)

(declare-fun dw1000__register_types__otp_addr_type__otp_addr__last__bit () Int)

(declare-fun dw1000__register_types__otp_addr_type__otp_addr__position () Int)

;; dw1000__register_types__otp_addr_type__otp_addr__first__bit_axiom
  (assert (<= 0 dw1000__register_types__otp_addr_type__otp_addr__first__bit))

;; dw1000__register_types__otp_addr_type__otp_addr__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_addr_type__otp_addr__first__bit dw1000__register_types__otp_addr_type__otp_addr__last__bit))

;; dw1000__register_types__otp_addr_type__otp_addr__position_axiom
  (assert (<= 0 dw1000__register_types__otp_addr_type__otp_addr__position))

(declare-fun dw1000__register_types__otp_addr_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__otp_addr_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__otp_addr_type__reserved__position () Int)

;; dw1000__register_types__otp_addr_type__reserved__first__bit_axiom
  (assert (<= 0 dw1000__register_types__otp_addr_type__reserved__first__bit))

;; dw1000__register_types__otp_addr_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_addr_type__reserved__first__bit dw1000__register_types__otp_addr_type__reserved__last__bit))

;; dw1000__register_types__otp_addr_type__reserved__position_axiom
...
(declare-datatypes ()
((otp_addr_type__ref (mk_otp_addr_type__ref (otp_addr_type__content us_rep)))))
(define-fun otp_addr_type__ref___projection ((a otp_addr_type__ref)) us_rep
  (otp_addr_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_181__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_127__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_127__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6224 us_t1)
  (temp___is_init_6221 Bool) (temp___skip_constant_6222 Bool)
  (temp___do_toplevel_6223 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6222 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6224)
                                       (last3 temp___expr_6224))
                                       (and (= (first3 temp___expr_6224) 1)
                                       (= (last3 temp___expr_6224) 2)))))
...
(define-fun target__ref_55__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_55__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6241 us_t2)
  (temp___is_init_6238 Bool) (temp___skip_constant_6239 Bool)
  (temp___do_toplevel_6240 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6239 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6241)
                                       (last5 temp___expr_6241))
                                       (and (= (first5 temp___expr_6241) 1)
                                       (= (last5 temp___expr_6241) 2)))))
...
(declare-fun temp___7961 () (Array Int bits_8))

(declare-fun temp___79611 () t2)

(declare-fun temp___7962 () (Array Int bits_8))

(declare-fun temp___79621 () t1)

(define-fun temp___79612 () us_t2 (mk___t2 temp___7961 temp___79611))
...
;; H
  (assert
  (and (= temp___79612 (register_to_bytes reg)) (dynamic_invariant1
  temp___79612 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79611)) (to_rep (last4 temp___79611)))
     (+ (- (to_rep (last4 temp___79611)) (to_rep (first4 temp___79611))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7961 temp___7962))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79611)) (to_rep (last4 temp___79611)))
  temp___79621))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___79621)) (to_rep (last2 temp___79621)))
     (+ (- (to_rep (last2 temp___79621)) (to_rep (first2 temp___79621))) 1)
