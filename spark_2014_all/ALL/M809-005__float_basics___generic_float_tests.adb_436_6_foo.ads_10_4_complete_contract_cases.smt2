...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 4096.0)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 160000002384185791015625.0 100000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 139999997615814208984375.0 100000000000000000000000.0))))

(declare-fun fliteral6 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) (/ 0.0 10.0))))
...
;; H
  (assert (and (le (neg fliteral2) x) (le x fliteral2)))

(assert
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not
  (<= 1 (+ (+ (+ (+ (+ (+ (+ (+ (+ 0 (ite (= (bool_eq x (neg fliteral3)) true)
                                     1 0)) (ite (= (bool_eq x
                                                   (neg fliteral4)) true)
                                           1 0)) (ite (= (bool_eq x
                                                         (neg fliteral5)) true)
                                                 1 0)) (ite (= (bool_eq 
                                                       ...
                                                       1 0)) (ite (= 
                                                             ...
                                                             1 0)) (ite (= 
                                                                   ...
                                                                   fliteral) true)
                                                                   1 0)) 
  (ite (= (bool_eq x fliteral5) true) 1 0)) (ite (= (bool_eq x fliteral4) true)
                                            1 0)) (ite (= (bool_eq x
                                                          fliteral3) true)
                                                  1 0)))))
(check-sat)
