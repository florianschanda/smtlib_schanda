...
(define-fun tnumber_array_typeD1__ref___10__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___10__projection ((a number_array_type__ref)) us_t1
...
(((mk_t248b__ref (t248b__content integer)))))
...
(declare-datatypes ((t249b__ref 0))
(((mk_t249b__ref (t249b__content us_t2)))))
...
(declare-datatypes ((t250b__ref 0))
(((mk_t250b__ref (t250b__content integer)))))
...
(define-fun tnumber_array_typeB__ref___10__projection ((a tnumber_array_typeB__ref)) us_t3
...
;; H
  (assert
  (and (= temp___1555 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1555)
  (<= temp___1555 (to_rep1 n__last))))

;; H
  (assert (= o54 temp___1555))
