...
(declare-fun temp___1838 () (Array Int us_rep1))
...
(declare-fun temp___1842 () (Array Int us_rep1))
...
;; H
  (assert (<= root (to_rep f_old__split_fields)))

;; H
  (assert (not (= v 0)))

;; H
  (assert (<= (to_rep f_old__split_fields) (to_rep f__split_fields)))
...
;; H
  ...
  (and (dynamic_invariant3 temp___1842 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1842 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1842 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1842 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1842 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1842 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1842 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1842 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1842 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1842 j1)))) true))
  (= j1 i))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o5 o6)) (select temp___1842 v)))
...
;; H
  ...
  (= temp___1838 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1838 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1838 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1838 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1838 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1838 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1838 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1838 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1838 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1838 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1838 j1)))) true))
  (= j1 i))))))))))))))
...
;; H
  ...
  (<= 1 (to_rep
        (rec__binary_trees__cell__parent
        (us_split_fields3 (select f__split_fields1 v)))))
  (<= (to_rep
      (rec__binary_trees__cell__parent
      (us_split_fields3 (select f__split_fields1 v)))) 100)))
...
;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1838 o)))
...
;; H
  ...
  (= (to_rep
     (rec__binary_trees__cell__left
     (us_split_fields3 (select f__split_fields1 j1)))) (to_rep
                                                       (rec__binary_trees__cell__left
                                                       (us_split_fields3
                                                       (select f_old__split_fields1 j1))))))))))
