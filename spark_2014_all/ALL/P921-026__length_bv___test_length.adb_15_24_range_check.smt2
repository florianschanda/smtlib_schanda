...
;; create__post_axiom
  ...
  (! (=> (dynamic_invariant c true true true)
     ...
     (dynamic_invariant1 result true false true)))) :pattern ((create c)) )))

(declare-fun a1__first () mod_16)

(declare-fun a1__last () mod_16)
...
(declare-fun test_length__p2__a1__assume () (Array (_ BitVec 16) natural))

(declare-fun test_length__p2__a1__assume1 () t)

(declare-fun o () Int)

(declare-fun result () (Array (_ BitVec 16) natural))

(declare-fun a11 () (Array (_ BitVec 16) natural))

(define-fun test_length__p2__a1__assume2 () us_t (mk___t
                                                 test_length__p2__a1__assume
                                                 test_length__p2__a1__assume1))

;; H
  (assert
  (and (= test_length__p2__a1__assume2 (create ((_ int2bv 16) 65535)))
  (and (dynamic_invariant1 test_length__p2__a1__assume2 true false true)
  (and (= (to_rep (first test_length__p2__a1__assume1)) ((_ int2bv 16) 0))
  (= (to_rep (last test_length__p2__a1__assume1)) ((_ int2bv 16) 65535))))))
...
;; H
  (assert
  (= (to_rep a1__first) (to_rep (first test_length__p2__a1__assume1))))
...
;; H
  ...
  (to_rep a1__first) (to_rep a1__last)))

;; H
  (assert
  (=> (<= (bv2nat (to_rep a1__first)) (bv2nat (to_rep a1__last)))
  (= o (+ (- (bv2nat (to_rep a1__last)) (bv2nat (to_rep a1__first))) 1))))

;; H
  (assert
  (=> (not (<= (bv2nat (to_rep a1__first)) (bv2nat (to_rep a1__last))))
  (= o 0)))
