...
;; H
  (assert
  (and
  (= o3 (get (model__ (index_map__content find_map__find_all__result6)) e))
  (and (in_range5 o3)
  (= o3 (get (model__ (index_map__content find_map__find_all__result6)) e)))))

;; H
  (assert (= o4 (ite (<= o3 (to_rep1 (last (rt a)))) true false)))

;; H
  (assert
  (and
  (= o2 (get (model__ (index_map__content find_map__find_all__result6)) e))
  (and (in_range5 o2)
  (= o2 (get (model__ (index_map__content find_map__find_all__result6)) e)))))

;; H
  (assert (= o5 (ite (<= (to_rep1 (first (rt a))) o2) true false)))
