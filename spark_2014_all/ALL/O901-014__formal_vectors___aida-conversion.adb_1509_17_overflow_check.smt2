...
(define-fun tint_arrayD1__ref___12__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___12__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t461b__ref 0))
(((mk_t461b__ref (t461b__content integer)))))
...
(declare-datatypes ((t462b__ref 0))
(((mk_t462b__ref (t462b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___21__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___21__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t465b__ref 0))
(((mk_t465b__ref (t465b__content integer)))))
...
(((mk_t466b__ref (t466b__content us_t4)))))
...
(declare-datatypes ((t467b__ref 0))
(((mk_t467b__ref (t467b__content integer)))))
...
(define-fun tint_arrayB__ref___12__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___21__projection ((a tnumber_array_typeB__ref)) us_t6
