...
(declare-datatypes ((tristate__ref 0))
(((mk_tristate__ref (tristate__content tristate)))))
...
(declare-datatypes ((decision_kind__ref 0))
...
(declare-datatypes ((node_id__ref 0))
(((mk_node_id__ref (node_id__content node_id)))))
...
(declare-datatypes ((decision__ref 0))
(((mk_decision__ref (decision__content us_rep)))))
...
(((mk_map__ref1 (map__content1 (Array Int tristate))))))
...
(define-fun d__split_discrs2 () us_split_discrs (mk___split_discrs
                                                d__split_discrs1))

(define-fun d__split_fields8 () us_split_fields (mk___split_fields
                                                d__split_fields4
                                                d__split_fields5
                                                d__split_fields6
                                                d__split_fields7))
...
;; H
  (assert
  (= d__split_fields8 (us_split_fields1 (select decision_table root_id))))
...
;; H
  (assert
  (= d__split_discrs2 (us_split_discrs1 (select decision_table root_id))))
...
;; H
  (assert
  (and
  (= o (decision_eval (to_rep2 d__split_fields7) decision_table
       condition_values))
...
;; WP_parameter_def
 ;; File "tristates.ads", line 3, characters 0-0
  (not (var__decision__left__pred
  (mk___rep d__split_discrs2 d__split_fields8 d__attr__constrained))))
(check-sat)
(exit)
