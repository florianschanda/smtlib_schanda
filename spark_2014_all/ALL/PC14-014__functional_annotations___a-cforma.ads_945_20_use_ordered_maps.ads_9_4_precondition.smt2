...
(define-fun dynamic_invariant ((temp___expr_378 Int)
...
(declare-const temp___617 count_type)
...
;; H
  (assert (= temp___617 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___617)) no_element))
