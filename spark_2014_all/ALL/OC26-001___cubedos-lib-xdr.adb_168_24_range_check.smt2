...
(declare-fun temp___522 () (_ BitVec 32))

(declare-fun temp___521 () (_ BitVec 32))

(declare-fun temp___520 () (_ BitVec 32))
...
(declare-fun value2 () (_ BitVec 32))
...
(declare-fun value5 () (_ BitVec 32))
...
(declare-fun value6 () (_ BitVec 32))
...
(declare-fun value7 () (_ BitVec 32))

(declare-fun temporary_17 () (_ BitVec 32))

(declare-fun temporary_28 () (_ BitVec 32))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temp___522 temporary_2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temp___521 temporary_11)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temp___520 value)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (and (<= 1 i2) (<= i2 3))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_22 result2)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 3))
  (= temporary_23 (bvmul temporary_12 ((_ int2bv 32) 256)))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= o4 (+ position i2))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= o5 (select (elts data) o4))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= o6 (to_rep o5))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= o7 ((_ zero_extend 24) o6))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= o8 (bvadd temporary_23 o7))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_23 result3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_24 o8)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= value2 result4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= value3 temporary_24)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_12 result5)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_13 value3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= i2 3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= i2 i3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_24 temporary_25)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_13 temporary_14)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= value3 value4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= i4 i2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_26 temporary_24)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_15 temporary_13)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= value5 value3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= i5 (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 3)) (= temporary_27 (mk_t__ref1 temporary_25))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= value8 (mk_t__ref1 value4))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= i6 i4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_28 temporary_26)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= temporary_17 temporary_15)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 3)) (= value7 value5)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 3))) (= i5 (mk_int__ref i1))))
...
;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 3))) (= temporary_11 temporary_16)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 3))) (= value8 (mk_t__ref1 value))))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 3))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 3))) (= temporary_28 temporary_21)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 3))) (= temporary_17 temporary_11)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 3))) (= value7 value1)))

(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 179, characters 0-0
  (not (in_range1 (+ position 3))))
(check-sat)
