...
(declare-fun user_eq3 (octet_array_extended_index
  octet_array_extended_index) Bool)

(declare-const dummy3 octet_array_extended_index)
...
;; length_with_padding__post_axiom
  (assert
  (forall ((length1 Int))
  (! (=> (dynamic_invariant3 length1 true true true) (dynamic_invariant3
     (length_with_padding length1) true false true)) :pattern ((length_with_padding
                                                               length1)) )))

;; length_with_padding__def_axiom
  (assert
  (forall ((length1 Int))
  (! (=> (dynamic_invariant3 length1 true true true)
...
(declare-fun temp___481 ((_ BitVec 8) Int Int) us_t3)

;; def_axiom
  (assert
  (forall ((temp___483 (_ BitVec 8)))
  (forall ((temp___484 Int) (temp___485 Int))
  (let ((temp___482 (temp___481 temp___483 temp___484 temp___485)))
  (and
  (=> (dynamic_property 0 65535 temp___484 temp___485)
  (and (= (first7 temp___482) temp___484) (= (last7 temp___482) temp___485)))
  (forall ((temp___486 Int))
  (= (select (to_array3 temp___482) temp___486) (of_rep1 temp___483))))))))
...
(declare-const temp___476 (Array Int octet))

(declare-const temp___4761 t1)
...
(declare-const temp___478 (Array Int octet))

(declare-const temp___4781 t1)

(declare-const temp___479 (Array Int octet))

(declare-const temp___4791 t1)
...
(declare-const temp___488 (Array Int octet))

(declare-const temp___4881 t3)

(declare-const temp___489 (Array Int octet))

(declare-const temp___4891 t2)

(declare-const o12 (Array Int octet))

(declare-const temp___490 (Array Int octet))

(declare-const temp___4901 t2)

(declare-const temp___491 (Array Int octet))

(declare-const temp___4911 t2)
...
(declare-const padding_start1 Int)

(declare-const padding_stop1 Int)
...
(declare-const padding_start2 Int)

(declare-const result2 Int)

(declare-const padding_stop2 Int)
...
(declare-const padding_start3 Int)

(declare-const padding_stop3 Int)

(declare-const data4 (Array Int octet))

(declare-const last11 Int)

(declare-const padding_start4 Int)

(declare-const padding_stop4 Int)

;; H
  (assert (dynamic_invariant2 value true false true))
...
;; H
  (assert (=> (<= (- 1) 65535) (in_range3 last8)))
...
;; H
  ...
  (<= (length_with_padding (length value)) (+ (- (to_rep data__last)
  position) 1)))))))

;; H
  (assert (=> (<= 0 65535) (in_range2 padding_start)))

;; H
  (assert (=> (<= 0 65535) (in_range2 padding_stop)))

;; H
  (assert
  (= (ite (<= (to_rep (first (rt value))) (to_rep (last (rt value))))
     (+ (- (to_rep (last (rt value))) (to_rep (first (rt value)))) 1) 0)
  (ite (<= position (- (+ position (length value)) 1))
  (+ (- (- (+ position (length value)) 1) position) 1) 0)))

;; H
  (assert
  (= (slide (elts value) (to_rep (first (rt value))) position) temp___476))

;; H
  (assert (= (mk1 position (- (+ position (length value)) 1)) temp___4761))
...
;; H
  ...
  (and
  (and (<= (to_rep data__first) position) (<= position (to_rep data__last)))
  (and (<= (to_rep data__first) temp___477)
  (<= temp___477 (to_rep data__last))))))

;; H
  (assert (= o2 data))

;; H
  (assert (= o2 temp___478))

;; H
  (assert (= (mk1 position temp___477) temp___4781))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___4761)) (to_rep (last2 temp___4761)))
     (+ (- (to_rep (last2 temp___4761)) (to_rep (first2 temp___4761))) 1) 0)
  (ite (<= (to_rep (first2 temp___4781)) (to_rep (last2 temp___4781)))
  (+ (- (to_rep (last2 temp___4781)) (to_rep (first2 temp___4781))) 1) 0)))

;; H
  (assert
  (= (mk___t1 temp___479 temp___4791) (mk___t1 temp___476 temp___4761)))

;; H
  (assert
  (forall ((temp___480 Int))
  (ite (and (<= position temp___480)
       (<= temp___480 (- (+ position (length value)) 1)))
  (= (select o3 temp___480) (select temp___479 temp___480))
  (= (select o3 temp___480) (select data temp___480)))))
...
;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (and (= o4 (length value)) (in_range1 (length value)))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o5 (+ position o4))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (and (= o6 o5) (in_range2 o5))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (mk_int__ref result1) (mk_int__ref padding_start))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_start2 o6)))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (and (= o7 (length value)) (in_range1 (length value)))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o8 (mod1 o7 4))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o9 (- 3 o8))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (= o10 (+ padding_start2 o9))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (and (= o11 o10) (in_range2 o10))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (mk_int__ref result2) (mk_int__ref padding_stop))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_stop2 o11)))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_start2 r12b)))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (in_range2 r12b)))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_stop2 r13b)))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (in_range2 r13b)))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (to_rep (first6 (rt3 (temp___481 ((_ int2bv 8) 0) r12b r13b))))
  r12b)))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (to_rep (last6 (rt3 (temp___481 ((_ int2bv 8) 0) r12b r13b)))) r13b)))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (mk___t3 temp___488 temp___4881) (temp___481 ((_ int2bv 8) 0) r12b r13b))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (ite (<= (to_rep (first6 temp___4881)) (to_rep (last6 temp___4881)))
     (+ (- (to_rep (last6 temp___4881)) (to_rep (first6 temp___4881))) 1) 0)
  (ite (<= r12b r13b) (+ (- r13b r12b) 1) 0))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (slide temp___488 (to_rep (first6 temp___4881)) r12b) temp___489)))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (= (mk2 r12b r13b) temp___4891)))
...
;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o12 data1)))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o12 temp___490)))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (= (mk2 r12b r13b) temp___4901)))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (ite (<= (to_rep (first4 temp___4891)) (to_rep (last4 temp___4891)))
     (+ (- (to_rep (last4 temp___4891)) (to_rep (first4 temp___4891))) 1) 0)
  (ite (<= (to_rep (first4 temp___4901)) (to_rep (last4 temp___4901)))
  (+ (- (to_rep (last4 temp___4901)) (to_rep (first4 temp___4901))) 1) 0))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (= (mk___t2 temp___491 temp___4911) (mk___t2 temp___489 temp___4891))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0))
  (forall ((temp___492 Int))
  (ite (and (<= r12b temp___492) (<= temp___492 r13b))
  (= (select o13 temp___492) (select temp___491 temp___492))
  (= (select o13 temp___492) (select data1 temp___492))))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= data1 result3)))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= data2 o13)))

;; H
  (assert
  (=> (not (not (= (mod1 (length value) 4) 0)))
  (= padding_stop2 padding_stop)))

;; H
  (assert
  (=> (not (not (= (mod1 (length value) 4) 0)))
  (= padding_start2 padding_start)))

;; H
  (assert (=> (not (not (= (mod1 (length value) 4) 0))) (= data2 data1)))

;; H
  (assert
  (=> (not (not (= (mod1 (length value) 4) 0)))
  (= padding_stop2 padding_stop1)))

;; H
  (assert
  (=> (not (not (= (mod1 (length value) 4) 0)))
  (= padding_start2 padding_start1)))

;; H
  (assert (=> (not (not (= (mod1 (length value) 4) 0))) (= data2 data1)))

;; H
  (assert (and (= o14 (length value)) (in_range4 (length value))))

;; H
  (assert
  (and (= o15 (length_with_padding o14))
  (and (in_range4 o15)
  (= o15 (+ o14 (ite (= (mod1 o14 4) 0) 0 (- 4 (mod1 o14 4))))))))

;; H
  (assert (= o16 (- o15 1)))

;; H
  (assert (= o17 (+ position o16)))

;; H
  (assert (and (= o18 o17) (in_range3 o17)))

;; H
  (assert (= (mk_int__ref result4) (mk_int__ref last8)))

;; H
  (assert (= last9 o18))

;; H
  (assert (= padding_stop2 padding_stop3))

;; H
  (assert (= padding_start2 padding_start3))
...
;; H
  (assert (= padding_stop4 padding_stop2))

;; H
  (assert (= padding_start4 padding_start2))
...
(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 45, characters 0-0
  (not (in_range4 (length value))))
(check-sat)
(exit)
