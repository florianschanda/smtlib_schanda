...
(((mk_t10b__ref (t10b__content integer)))))
...
(declare-datatypes ((t11b__ref 0)) (((mk_t11b__ref (t11b__content us_t1)))))
...
(declare-datatypes ((t15b__ref 0)) (((mk_t15b__ref (t15b__content us_t2)))))
...
(declare-datatypes ((t17b__ref 0)) (((mk_t17b__ref (t17b__content us_t3)))))
...
;; H
  ...
  (ite (<= (to_rep (first2 (mk1 position (- (+ position (length value)) 1))))
  (to_rep (last2 (mk1 position (- (+ position (length value)) 1)))))
  (+ (- (to_rep (last2 (mk1 position (- (+ position (length value)) 1))))
  (to_rep (first2 (mk1 position (- (+ position (length value)) 1))))) 1) 0)))
...
;; H
  ...
  (= (select o temp___480) (select temp___479 temp___480))
  (= (select o temp___480) (select data temp___480)))))
...
;; H
  ...
  (and (= o1 (length value)) (in_range1 (length value)))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o2 (+ position o1))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (and (= o3 o2) (in_range2 o2))))
...
;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_start2 o3)))
...
;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o5 (mod1 o4 4))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= o6 (- 3 o5))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (= o7 (+ padding_start2 o6))))

;; H
  (assert
  (=> (not (= (mod1 (length value) 4) 0)) (and (= o8 o7) (in_range2 o7))))
...
;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= padding_stop2 o8)))
...
;; H
  ...
  (ite (<= (to_rep (first4 (mk2 r12b r13b))) (to_rep (last4 (mk2 r12b r13b))))
  (+ (- (to_rep (last4 (mk2 r12b r13b))) (to_rep (first4 (mk2 r12b r13b)))) 1)
  0))))
...
;; H
  ...
  (= (select o9 temp___492) (select temp___491 temp___492))
  (= (select o9 temp___492) (select data1 temp___492))))))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= data1 result3)))

;; H
  (assert (=> (not (= (mod1 (length value) 4) 0)) (= data2 o9)))
...
;; H
  (assert (and (= o10 (length value)) (in_range4 (length value))))

;; H
  (assert
  (and (= o11 (length_with_padding o10))
  (and (in_range4 o11)
  (= o11 (+ o10 (ite (= (mod1 o10 4) 0) 0 (- 4 (mod1 o10 4))))))))

;; H
  (assert (= o12 (- o11 1)))

;; H
  (assert (= o13 (+ position o12)))
