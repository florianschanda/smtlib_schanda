...
(declare-fun writereghigh8post ((_ BitVec 64) (_ BitVec 64)
  (_ BitVec 8)) Bool)

(declare-fun writereghigh8post__function_guard (Bool (_ BitVec 64)
...
;; H
  (assert
  (= reg1 (bvor (bvand reg ((_ int2bv 64) 18446744073709486335)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8)
  val__) ((_ int2bv 16) 256))))))
...
(assert
;; WP_parameter_def
 ;; File "x86.adb", line 77, characters 0-0
  (not (= (writereghigh8post reg reg2 val__) true)))
(check-sat)
(exit)
