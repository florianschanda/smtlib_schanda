...
(define-fun tTmy_s2SP1__ref___2__projection ((a tTmy_s2SP1__ref)) tTmy_s2SP1
...
(define-fun tTmy_aSP1__ref___3__projection ((a tTmy_aSP1__ref)) tTmy_aSP1
...
;; def_axiom
  ...
  (= (select (pack__an21__my_a__aggregate_def temp___146) temp___147)
  (of_rep1 temp___146)))))
...
(declare-datatypes ((t73b__ref 0)) (((mk_t73b__ref (t73b__content t73b)))))
...
(declare-datatypes ((t75b__ref 0)) (((mk_t75b__ref (t75b__content t75b)))))
...
(declare-datatypes ((t78b__ref 0)) (((mk_t78b__ref (t78b__content t78b)))))
...
(assert
;; WP_parameter_def
 ;; File "pack.adb", line 22, characters 0-0
  (not (<= 1 1)))
(check-sat)
(exit)
