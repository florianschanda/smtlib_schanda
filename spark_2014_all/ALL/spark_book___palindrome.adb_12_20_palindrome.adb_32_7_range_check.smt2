...
(declare-datatypes ((tline_typeP1__ref 0))
...
(declare-datatypes ((t18b__ref 0)) (((mk_t18b__ref (t18b__content us_t3)))))
...
(declare-datatypes ((t20b__ref 0)) (((mk_t20b__ref (t20b__content us_t4)))))
...
(declare-const temp___537 (Array Int character))

(declare-const temp___5371 t4)
...
;; H
  ...
  (to_rep1 (last2 (rt1 c9b))))
  (and (= (to_rep1 (first2 (rt1 c9b))) 1)
  (= (to_rep1 (last2 (rt1 c9b))) r5b))))
...
;; H
  (assert
  (and (<= (to_rep1 (first8 temp___5371)) left_index2)
  (<= left_index2 (to_rep1 (last8 temp___5371)))))

;; H
  (assert (= o9 left_index2))

;; H
  (assert (= o10 (select temp___537 o9)))
