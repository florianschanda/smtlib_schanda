...
(define-fun us_split_fields_F1__projection ((a us_split_fields)) scalar_with_default
...
(declare-fun with_default__bad_record1__simple_rec__f1__first__bit () Int)

(declare-fun with_default__bad_record1__simple_rec__f1__last__bit () Int)

(declare-fun with_default__bad_record1__simple_rec__f1__position () Int)
...
(declare-fun with_default__bad_record1__simple_rec__f2__first__bit () Int)

(declare-fun with_default__bad_record1__simple_rec__f2__last__bit () Int)

(declare-fun with_default__bad_record1__simple_rec__f2__position () Int)
...
(define-fun simple_rec__ref___projection ((a simple_rec__ref)) us_rep
...
(assert
;; WP_parameter_def
 ;; File "with_default.adb", line 126, characters 0-0
