...
;; H
  (assert
  (=> (< remaining1 bytes_to_squeeze1)
  (= result9 (mk_int__ref bytes_to_squeeze1))))

;; H
  (assert
  (=> (< remaining1 bytes_to_squeeze1) (= bytes_to_squeeze2 remaining1)))

;; H
  (assert
  (=> (not (< remaining1 bytes_to_squeeze1))
  (= bytes_to_squeeze2 bytes_to_squeeze1)))
...
;; H
  (assert (= keccak__keccak_1600__sponge__squeeze__B_2__R140s__assume
  r140s))
...
;; H
  (assert
  (and (= o23 (+ offset1 bytes_to_squeeze2)) (in_range1
  (+ offset1 bytes_to_squeeze2))))

;; H
  (assert (= o24 (- o23 1)))

;; H
  (assert (= o25 (+ (to_rep digest__first) o24)))
...
;; H
  (assert (= keccak__keccak_1600__sponge__squeeze__B_2__R141s__assume
  r141s))
...
;; H
  ...
  (= keccak__keccak_1600__sponge__squeeze__B_2__R145s__assume (+ (to_rep3
                                                                 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
                                                                 ctx__split_fields10)) (-
  bytes_to_squeeze2 1))) (in_range1
  (+ (to_rep3
     (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
     ctx__split_fields10)) (- bytes_to_squeeze2 1)))))

;; H
  (assert (= keccak__keccak_1600__sponge__squeeze__B_2__R145s__assume
  r145s))
...
;; H
  (assert (= o26 temp___918))

;; H
  (assert (= (mk4 r144s r145s) temp___9181))
...
;; H
  (assert (= (mk3 r140s r141s) temp___9191))
...
;; H
  (assert (= result10 (mk_map__ref digest1)))
...
;; H
  ...
  (= o28 (+ (to_rep3
            (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
            ctx__split_fields10)) bytes_to_squeeze2))
  (in_range1
  (+ (to_rep3
     (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
     ctx__split_fields10)) bytes_to_squeeze2))))
...
;; H
  (assert (and (= o29 o28) (in_range6 o28)))

;; H
  (assert (= (to_rep3 o30) o29))
...
;; H
  (assert (= ctx__split_fields11 (us_split_fields1 temp___924)))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range1 (+ offset1 bytes_to_squeeze2))))
(check-sat)
(exit)
