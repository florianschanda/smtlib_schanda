...
;; H
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields6))
     (find (elements (mk___rep s__split_discrs s__split_fields6)) 1)) 1))
  (= (equal_except
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields6))
     (find (elements (mk___rep s__split_discrs s__split_fields6)) 1)) true))
  (and
  (and
  (and
  (and
  ...
  (= (range_equal
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields6)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields6)) 1) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields6))
     (find (elements (mk___rep s__split_discrs s__split_fields6)) 1)
     (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
...
;; H
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields5))
     (find (elements (mk___rep s__split_discrs s__split_fields5)) 2)) 2))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields6))
     (elements (mk___rep s__split_discrs s__split_fields5))
     (find (elements (mk___rep s__split_discrs s__split_fields5)) 2)) true))
  (and
  (and
  (and
  (and
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields5))
     (find (elements (mk___rep s__split_discrs s__split_fields5)) 2)) 2))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields6))
     (elements (mk___rep s__split_discrs s__split_fields5)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields5)) 2) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields6))
     (elements (mk___rep s__split_discrs s__split_fields5))
     (find (elements (mk___rep s__split_discrs s__split_fields5)) 2)
     (length (mk___rep s__split_discrs s__split_fields6)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields6))
...
;; H
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields4))
     (find (elements (mk___rep s__split_discrs s__split_fields4)) 3)) 3))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields5))
     (elements (mk___rep s__split_discrs s__split_fields4))
     (find (elements (mk___rep s__split_discrs s__split_fields4)) 3)) true))
  (and
  (and
  (and
  (and
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields4))
     (find (elements (mk___rep s__split_discrs s__split_fields4)) 3)) 3))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields5))
     (elements (mk___rep s__split_discrs s__split_fields4)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields4)) 3) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields5))
     (elements (mk___rep s__split_discrs s__split_fields4))
     (find (elements (mk___rep s__split_discrs s__split_fields4)) 3)
     (length (mk___rep s__split_discrs s__split_fields5)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields5))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields4)) (to_rep
                                                          (rec__use_ordered_sets__my_sets__set__capacity
                                                          s__split_discrs)))
