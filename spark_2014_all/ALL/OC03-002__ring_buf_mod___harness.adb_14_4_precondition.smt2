...
;; H
  (assert
  (= (let ((temp___223 (to_model (mk___rep r__split_fields15))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields15)) x)))
     (let ((temp___230 (to_model (mk___rep r__split_fields14))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields14)) y)))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields13)))))
     (let ((temp___234 (to_model (mk___rep r__split_fields12))))
