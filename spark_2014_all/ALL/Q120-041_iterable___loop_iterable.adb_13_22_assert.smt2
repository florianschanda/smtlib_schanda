...
(declare-fun temp___2743 () map__ref)

(declare-fun e7 () Int)

(declare-fun temp___2744 () (Array Int natural))

(declare-fun e8 () int__ref)

(declare-fun temp___2745 () map__ref)

(declare-fun e9 () Int)

(declare-fun temp___2746 () (Array Int natural))
...
(declare-fun temp___2771 () us_rep1)
...
;; H
  (assert
  (=> (= result4 true)
  (and (= (has_element (mk___rep c1__split_fields2) temp___2742) true)
  (= e5 (element (mk___rep c1__split_fields2) temp___2742)))))
...
;; H
  (assert
  (=> (= result4 true)
  (and (= o8 (next (mk___rep c1__split_fields2) temp___2742))
  (= o8 (temp___176 (+ (to_rep (select temp___2742 1)) 1))))))
...
;; H
  (assert
  (=> (= result4 true) (= result5 (ite (not (= o9 true)) true false))))
...
;; H
  (assert
  (=> (not (= result4 true)) (= temp___2745 (mk_map__ref temp___274))))
...
;; H
  (assert
  (and
  (= (mk___rep1 (mk___split_fields1 o10)) (first__2
                                          (mk___rep2 c2__split_fields2)))
  (= (of_rep 1) o10)))
...
;; H
  ...
  (= result6 (has_element__2 (mk___rep2 c2__split_fields2)
             (mk___rep1 (mk___split_fields1 temp___277))))
  (= (= result6 true)
  (and (<= 1 (to_rep temp___277))
  (<= (to_rep temp___277) (to_rep
                          (rec__composite_cursors__cont2__length
                          c2__split_fields2)))))))
...
;; H
  ...
  (=> (= result6 true)
  (and
  (= o11 (element__2 (mk___rep2 c2__split_fields2)
         (mk___rep1 (mk___split_fields1 temp___277))))
  (and (in_range1 o11)
  (= o11 (to_rep
...
;; H
  (assert
  (and (= (has_element__2 (mk___rep2 c2__split_fields2) temp___2771) true)
  (= e13 (element__2 (mk___rep2 c2__split_fields2) temp___2771))))
