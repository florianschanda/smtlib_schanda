...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result1
  bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result3
  bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result1))

;; H
  (assert
  (= (mk_t__ref result1) (mk_t__ref
                         bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result)))
...
;; H
  (assert
  (= (mk_t__ref
     bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4)
  (mk_t__ref
  bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result5
  bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result3))
...
;; H
  (assert
  (and (= o6 (make_mask o5))
  (= o6 (shift_right ((_ int2bv 8) 255) (- 8 o5)))))
...
;; H
  (assert
  (= result2 (ite (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4
             o8) true false)))
...
;; H
  (assert
  (and (= o4 (make_mask o3))
  (= o4 (shift_right ((_ int2bv 8) 255) (- 8 o3)))))

;; H
  (assert
  (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4
             o4) true false)))
