...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result () (_ BitVec 8))
...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result1 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result2 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result3 () (_ BitVec 8))

(declare-fun result__2 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result4 () (_ BitVec 8))

(declare-fun result__3 () (_ BitVec 8))

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline_always__result5 () (_ BitVec 8))
