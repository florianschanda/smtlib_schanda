...
(declare-fun o91 () us_rep)

(declare-fun o92 () us_rep)
...
;; H
  (assert (= o91 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (and (= o88 o87) (in_range2 o87)))

;; H
  (assert (= o89 (num_of_big_int m m_first o88)))

;; H
  (assert (= o84 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o90 (omultiply o84 o89)))

;; H
  (assert (= o92 (osubtract o90 o91)))

;; H
  (assert (= o81 (from_word32 a_msw3)))
...
;; H
  (assert
  (and (= o75 (base Tuple0))
  (= o75 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o80 (oexpon o75 o79)))

;; H
  (assert (= o82 (omultiply o80 o81)))
...
;; H
  (assert
  (= o74 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o73)))

;; H
  (assert (= o83 (oadd o74 o82)))

;; H
  (assert (= o93 (olt o83 o92)))
...
;; H
  (assert (and (= o58 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o59 (- o58 a_first)))
...
;; H
  (assert
  (and (= o56 (base Tuple0))
  (= o56 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert (= o55 (num_of_big_int m m_first o54)))

;; H
  (assert (= o57 (inverse o55 o56)))
...
;; H
  (assert (= o49 (num_of_big_int c c_first o48)))

;; H
  (assert (and (= o40 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o41 (- o40 a_first)))
...
;; H
  (assert (= o63 (omultiply o50 o62)))

;; H
  (assert (= o69 (omod o63 o68)))
