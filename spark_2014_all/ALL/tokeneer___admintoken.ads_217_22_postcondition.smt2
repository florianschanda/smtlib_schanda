...
(declare-fun dummy3 () adminprivileget)
...
(declare-fun dummy10 () serialnumbert)
...
(declare-fun dummy17 () privileget)
...
(declare-fun dummy22 () keylengtht)
...
(declare-fun tokenpresence () Int)

(declare-fun tokentry () Int)

(declare-fun tokenid () Int)

(declare-fun authcert__split_fields () us_split_fields__ref7)

(declare-fun idcert__split_fields () us_split_fields__ref8)

(declare-fun authcertcontents__split_fields () us_split_fields__ref4)

(declare-fun idcertcontents__split_fields () us_split_fields__ref6)

(declare-fun result () Int)

(declare-fun tokenpresence1 () Int)
...
(declare-fun result3 () us_split_fields__ref7)

(declare-fun authcert__split_fields1 () us_split_fields14)

(declare-fun idcertcontents__split_fields1 () us_split_fields12)

(declare-fun result4 () us_split_fields__ref8)

(declare-fun idcert__split_fields1 () us_split_fields16)

(declare-fun tokenpresence2 () Int)

(declare-fun tokentry2 () Int)

(declare-fun tokenid2 () Int)

(declare-fun authcert__split_fields2 () us_split_fields__ref7)

(declare-fun idcert__split_fields2 () us_split_fields__ref8)

(declare-fun authcertcontents__split_fields2 () us_split_fields__ref4)

(declare-fun idcertcontents__split_fields2 () us_split_fields__ref6)

(declare-fun tokenpresence3 () Int)

(declare-fun tokentry3 () Int)

(declare-fun tokenid3 () Int)

(declare-fun authcert__split_fields3 () us_split_fields14)

(declare-fun idcert__split_fields3 () us_split_fields16)

(declare-fun authcertcontents__split_fields3 () us_split_fields8)

(declare-fun idcertcontents__split_fields3 () us_split_fields12)
...
;; H
  (assert
  (= (let ((subject idcert__split_fields)) idcert__split_fields1) (mk___split_fields8
                                                                  (of_int 0)
                                                                  (mk___rep6
                                                                  (let ((subject
                                                                  idcertcontents__split_fields))
                                                                  idcertcontents__split_fields1)))))

;; H
  (assert
  (= idcertcontents__split_fields2 (let ((subject idcertcontents__split_fields))
                                   (mk___split_fields__ref6
                                   idcertcontents__split_fields1))))

;; H
  (assert
  (= authcertcontents__split_fields2 (let ((subject authcertcontents__split_fields))
...
;; H
  (assert
  (= authcertcontents__split_fields3 authcertcontents__split_fields1))
