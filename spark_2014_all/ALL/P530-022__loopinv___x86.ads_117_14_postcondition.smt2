...
(declare-const x86__writereglow8post__result Bool)
...
(declare-const x86__writereglow8post__result1 Bool)

(declare-const x86__writereglow8post__result2 Bool)

(declare-const x86__writereglow8post__result3 Bool)

(declare-const x86__writereglow8post__result4 Bool)

(declare-const x86__writereglow8post__result5 Bool)

(declare-const result1 Bool)

;; H
  (assert (= x86__writereglow8post__result1 x86__writereglow8post__result2))

;; H
  (assert (= x86__writereglow8post__result3 x86__writereglow8post__result1))

;; H
  (assert
  (and (= o (readreglow8 regnew))
  (= o ((_ extract 7 0) (bvand regnew ((_ int2bv 64) 255))))))
...
;; H
  (assert
  (= o2 (ite (= o1 true) (ite (= (bvand regnew ((_ int2bv 64) 18446744073709551360)) (bvand
                         regold ((_ int2bv 64) 18446744073709551360))) true
                         false) false)))

;; H
  (assert (= result x86__writereglow8post__result))

;; H
  (assert (= x86__writereglow8post__result1 o2))

;; H
  (assert
  (= (mk_bool__ref x86__writereglow8post__result4) (mk_bool__ref
                                                   x86__writereglow8post__result2)))

;; H
  (assert (= x86__writereglow8post__result5 x86__writereglow8post__result3))

;; H
  (assert (= result1 x86__writereglow8post__result4))

;; H
  (assert (= x86__writereglow8post__result4 true))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 115, characters 0-0
  (not (= (readreglow8 regnew) val__)))
(check-sat)
(exit)
