...
(((mk_vec_t__ref (vec_t__content us_rep)))))
...
;; H
  (assert
  (= (mk___split_fields v__split_fields1) loop_types__vectors__replace_element__container__fields1))

;; H
  (assert
  (= (last (model__ (mk___rep v__split_discrs v__split_fields3))) (last
                                                                  (model__
                                                                  (mk___rep
                                                                  v__split_discrs
                                                                  (mk___split_fields
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 j2))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) k1) 0))))

;; H
  (assert
  (and (=> (<= r4b r5b) (dynamic_property r4b r5b j2))
  (and (<= r4b j2) (<= j2 r5b))))
