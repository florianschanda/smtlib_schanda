...
;; H
  (assert
  (not
  (= (bool_eq1 (mk___rep1 current__split_fields5)
     (mk___rep1 n_last__split_fields3)) true)))
...
;; H
  (assert
  (ite (= (ite (= (bool_eq1 (mk___rep1 current__split_fields4) no_element) false) (=
          (get1 (positions (mk___rep l__split_discrs l__split_fields2))
          (mk___rep1 current__split_fields4)) (length
                                              (mk___rep l__split_discrs
                                              l__split_fields2))) true) true)
  (= (bool_eq1 (mk___rep1 current__split_fields3) no_element) true)
  (and
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) 0)))
(check-sat)
(exit)
