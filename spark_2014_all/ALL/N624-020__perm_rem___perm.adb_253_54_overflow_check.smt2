...
;; H
  (assert (and (= o7 ia1) (in_range4 ia1)))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o8))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o7 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o8) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o7 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o8) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o7 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o8) k))))))))))))

;; H
  (assert
  (and
  (= o9 (remove o8 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
  (and (dynamic_invariant2 o9 true false true)
  (and (= (invariant__ o9) true)
  (and (= (to_rep2 (last (rt o9))) (- (to_rep2 (last (rt o8))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o8) k)) (to_rep (select (elts o9) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o8)))))
  (= (to_rep (select (elts o8) k)) (to_rep (select (elts o9) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o8))) 1)))
  (= (to_rep (select (elts o8) (+ k 1))) (to_rep (select (elts o9) k))))))))))))

;; H
  (assert
  (and (= o6 (remove bb ib1))
  (and (dynamic_invariant2 o6 true false true)
  (and (= (invariant__ o6) true)
  (and (= (to_rep2 (last (rt o6))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o6) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o6) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o6) k))))))))))))
