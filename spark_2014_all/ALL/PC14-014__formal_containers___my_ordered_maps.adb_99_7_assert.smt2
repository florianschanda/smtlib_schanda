...
(declare-fun temp___962 () us_rep2)
...
(define-fun o51 () us_rep (mk___rep (mk___split_fields o12 o13)))

(define-fun o52 () us_rep (mk___rep (mk___split_fields o6 o7)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o52) true))
  (= (bool_eq
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o52)) o52) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o52) 1))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields)) o52) 1)) true))
  (= (range_shifted
     (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o52)
     (length
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o51) true))
  (= (bool_eq
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o51)) o51) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o51) 2))
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o51) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields1)) o51) 1)) true))
  (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o51)
...
;; H
  ...
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___960) true))
  (= (bool_eq2 temp___960 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___960) true)
...
;; H
  (assert
  (and
  (= temp___962 (find1 (mk___rep1 l__split_discrs l__split_fields10) o42))
  (ite (ite (= (has_key1
  ...
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___962) true))
  (= (bool_eq2 temp___962 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___962) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___962) (find (keys (mk___rep1 l__split_discrs l__split_fields10))
                 o42)))
  (= (equivalent_keys
     (key (mk___rep1 l__split_discrs l__split_fields10) temp___962) o42) true)))))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields)) o46) true))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
  ...
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields10))
     ...
     (- (find (keys (mk___rep1 l__split_discrs l__split_fields10)) o46) 1)) true))
  (= (range_shifted
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields10))
     (find (keys (mk___rep1 l__split_discrs l__split_fields10)) o46)
     (length
     (mk___rep1 l__split_discrs
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1)) o50) true))
  (ite (ite (= (has_key1
  ...
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields11))
     ...
     (- (find (keys (mk___rep1 l__split_discrs l__split_fields11)) o50) 1)) true))
  (= (range_shifted
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__exclude__container__fields1))
     (keys (mk___rep1 l__split_discrs l__split_fields11))
     (find (keys (mk___rep1 l__split_discrs l__split_fields11)) o50)
     (length
     (mk___rep1 l__split_discrs
