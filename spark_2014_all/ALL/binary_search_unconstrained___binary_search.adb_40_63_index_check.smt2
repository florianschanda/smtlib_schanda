...
;; H
  ...
  (forall ((i11 Int))
  (=>
  (and (<= (to_rep1 (first (rt a))) i11) (<= i11 (to_rep1 (last (rt a)))))
  (forall ((i2 Int))
  (=> (and (<= i11 i2) (<= i2 (to_rep1 (last (rt a)))))
  (<= (to_rep (select (elts a) i11)) (to_rep (select (elts a) i2))))))))
...
;; H
  (assert (and (= o19 (+ med2 1)) (in_range2 (+ med2 1))))

;; H
  (assert (and (= o20 o19) (in_range3 o19)))

;; H
  (assert (= left2 result8))
