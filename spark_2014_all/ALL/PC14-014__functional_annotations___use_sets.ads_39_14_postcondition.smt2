...
(declare-fun use_sets__are_disjoint_2__result2 () Bool)

(declare-fun result2 () Bool)

(declare-fun result3 () Bool)

(declare-fun use_sets__are_disjoint_2__result3 () Bool)
...
(declare-fun use_sets__are_disjoint_2__result4 () bool__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_sets__are_disjoint_2__result5 () Bool)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_sets__are_disjoint_2__result6 () bool__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_sets__are_disjoint_2__result7 () Bool)

(declare-fun result6 () bool__ref)

(declare-fun use_sets__are_disjoint_2__result8 () Bool)

(declare-fun use_sets__are_disjoint_2__result9 () bool__ref)

(declare-fun use_sets__are_disjoint_2__result10 () Bool)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_sets__are_disjoint_2__result11 () bool__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_sets__are_disjoint_2__result12 () Bool)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_sets__are_disjoint_2__result13 () bool__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_sets__are_disjoint_2__result14 () Bool)
...
;; H
  ...
  (= (bool_eq3 use_sets__are_disjoint_2__cu__assume1 no_element) true)
  (and
...
;; H
  ...
  (and
  (and
  (= use_sets__are_disjoint_2__result11 (mk_bool__ref
                                        use_sets__are_disjoint_2__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields13)))
  (and
  (= use_sets__are_disjoint_2__result12 use_sets__are_disjoint_2__result3)
  ...
  (and (= result1 true)
  (and (= temp___905 cu__split_fields1)
  (and
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  ...
  (and (= result2 true)
  (and (= use_sets__are_disjoint_2__result2 result3)
  (= use_sets__are_disjoint_2__result3 (of_int 0)))))))))))
  (and
  (and
  (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields14)))
  (= (= result1 true)
  ...
  (= use_sets__are_disjoint_2__result3 use_sets__are_disjoint_2__result2)))
  (and
  (and
  (and (= temp___9041 (next s1 (mk___rep1 cu__split_fields13)))
  ...
  (= (bool_eq3 temp___9041 no_element) true)
  (and (= (has_key (positions s1) temp___9041) true)
  (= (get1 (positions s1) temp___9041) (+ (get1 (positions s1)
                                          (mk___rep1 cu__split_fields13)) 1)))))
  (and (= result4 cu__split_fields2) (= temp___904 cu__split_fields3)))
  (and
  (and
  ...
  (and
  (and
  (= use_sets__are_disjoint_2__result4 (mk_bool__ref
                                       use_sets__are_disjoint_2__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields12)))
  (and
  (= use_sets__are_disjoint_2__result5 use_sets__are_disjoint_2__result3)
  (= cu__split_fields5 cu__split_fields12))))
  (and
  (and
  (= use_sets__are_disjoint_2__result6 use_sets__are_disjoint_2__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and
  (= use_sets__are_disjoint_2__result7 use_sets__are_disjoint_2__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= use_sets__are_disjoint_2__result6 (mk_bool__ref
                                       use_sets__are_disjoint_2__result))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields14)))
  (and
  (= use_sets__are_disjoint_2__result7 use_sets__are_disjoint_2__result1)
  (= cu__split_fields7 cu__split_fields14)))))
  (and
  (and
  (and
  (= use_sets__are_disjoint_2__result11 use_sets__are_disjoint_2__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and
  (= use_sets__are_disjoint_2__result12 use_sets__are_disjoint_2__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= use_sets__are_disjoint_2__result9 (mk_bool__ref
                                       use_sets__are_disjoint_2__result8))
  (= use_sets__are_disjoint_2__result10 use_sets__are_disjoint_2__result8))
  (and (= result6 use_sets__are_disjoint_2__result6)
  (= use_sets__are_disjoint_2__result8 (of_int 1))))))))

;; H
  (assert
  (= use_sets__are_disjoint_2__result13 use_sets__are_disjoint_2__result11))
...
;; H
  (assert
  (= use_sets__are_disjoint_2__result14 use_sets__are_disjoint_2__result12))
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 38, characters 0-0
  (not (not (= (contains (model__ s1) e) true))))
(check-sat)
