...
(define-fun bool_eq8 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq7 (select a temp___idx_148)
...
(define-fun dynamic_invariant5 ((temp___expr_158 t) (temp___is_init_155 Bool)
...
;; a_gradient__def_axiom
  (assert
  (forall ((d Int))
  (! (=> (dynamic_invariant1 d true true true) (= (a_gradient d) fliteral2)) :pattern (
  (a_gradient d)) )))
