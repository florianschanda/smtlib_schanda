...
(declare-fun temp___188 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8)
  Int) map1)

;; def_axiom
  (assert
  (forall ((temp___190 map1))
  (forall ((temp___191 Int) (temp___193 Int) (temp___194 Int)
  (temp___196 Int))
  (forall ((temp___192 (_ BitVec 8)) (temp___195 (_ BitVec 8)))
  ...
  (forall ((temp___198 (_ BitVec 8)))
  (ite (and (= temp___197 temp___194) (= temp___198 temp___195))
  (= (get temp___189 temp___197 temp___198) (of_rep temp___196))
  (ite (and (= temp___197 temp___191) (= temp___198 temp___192))
  (= (get temp___189 temp___197 temp___198) (of_rep temp___193))
  (= (get temp___189 temp___197 temp___198) (get temp___190 temp___197
                                            temp___198)))))))))))

(declare-fun temp___345 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8)
  Int) map1)

;; def_axiom
  (assert
  (forall ((temp___347 map1))
  (forall ((temp___348 Int) (temp___350 Int) (temp___351 Int)
  (temp___353 Int))
  (forall ((temp___349 (_ BitVec 8)) (temp___352 (_ BitVec 8)))
  (let ((temp___346 (temp___345 temp___347 temp___348 temp___349 temp___350
                    temp___351 temp___352 temp___353)))
  (forall ((temp___354 Int))
  (forall ((temp___355 (_ BitVec 8)))
  (ite (and (= temp___354 temp___351) (= temp___355 temp___352))
  (= (get temp___346 temp___354 temp___355) (of_rep temp___353))
  (ite (and (= temp___354 temp___348) (= temp___355 temp___349))
  (= (get temp___346 temp___354 temp___355) (of_rep temp___350))
  (= (get temp___346 temp___354 temp___355) (get temp___347 temp___354
                                            temp___355)))))))))))
...
(assert
;; WP_parameter_def
 ;; File "update_logic_fn.ads", line 13, characters 0-0
  (not
  (= (bool_eq3 a2 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7)
     (temp___188 a_2d_arr 5 ((_ int2bv 8) 7) v1 x y v2) 1 10 ((_ int2bv 8) 0)
     ((_ int2bv 8) 7)) true)))
(check-sat)
