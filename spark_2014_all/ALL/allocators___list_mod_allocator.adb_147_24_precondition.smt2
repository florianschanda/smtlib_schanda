...
(define-fun o6 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
;; H
  (assert
  (and (= o6 (model__ data first_available))
  (= (model_is_well_formed o6 data first_available) true)))
...
;; H
  (assert
  (and (= o5 (length o4)) (and (in_range4 o5) (<= (+ 0 o5) 2147483647))))
