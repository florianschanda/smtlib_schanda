...
(define-fun tint_arrayD1__ref___23__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___23__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t736b__ref 0))
(((mk_t736b__ref (t736b__content integer)))))
...
(declare-datatypes ((t737b__ref 0))
(((mk_t737b__ref (t737b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___32__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___32__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t740b__ref 0))
(((mk_t740b__ref (t740b__content integer)))))
...
(((mk_t741b__ref (t741b__content us_t4)))))
...
(declare-datatypes ((t742b__ref 0))
(((mk_t742b__ref (t742b__content integer)))))
...
(define-fun tint_arrayB__ref___23__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___32__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; H
  ...
  (<= index4 (+ (to_rep1 (first (rt source))) 5)))
...
;; H
  ...
  (=> (< index2 temp___2345)
  (= (select n3 temp___2345) (select n1 temp___2345)))))
  (=>
