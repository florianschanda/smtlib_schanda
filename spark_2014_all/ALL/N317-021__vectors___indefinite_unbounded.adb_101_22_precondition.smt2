...
;; H
  (assert
  (= v__split_fields12 indefinite_unbounded__vect__clear__container__fields1))
...
;; H
  (assert
  (= v__split_fields11 indefinite_unbounded__vect__append__2__container__fields4))
...
;; H
  ...
  (= (length
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__replace_element__container__fields))
  (length (mk___rep v__split_discrs v__split_fields5)))
  (= (get
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__replace_element__container__fields)) 2) 4))
  (= (equal_except (model__ (mk___rep v__split_discrs v__split_fields5))
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__replace_element__container__fields)) 2) true)))
...
;; H
  (assert
  (= v__split_fields6 indefinite_unbounded__vect__replace_element__container__fields))
...
;; H
  ...
  (= (m_elements_swapped
     ...
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__swap__container__fields)) 1 3) true))
...
;; H
  (assert
  (= v__split_fields7 indefinite_unbounded__vect__swap__container__fields))
...
;; H
  ...
  (= (length
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__delete_last__container__fields)) (-
...
;; H
  (assert
  (= v__split_fields8 indefinite_unbounded__vect__delete_last__container__fields))
...
;; H
  ...
  (= (m_elements_reversed
     ...
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__reverse_elements__container__fields))) true))
...
;; H
  (assert
  (= v__split_fields9 indefinite_unbounded__vect__reverse_elements__container__fields))
...
;; H
  ...
  (= (length
     (mk___rep v__split_discrs
     indefinite_unbounded__sort__sort__container__fields)) (length
                                                           (mk___rep
                                                           v__split_discrs
                                                           v__split_fields9)))
  (= (m_elements_sorted
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__sort__sort__container__fields))) true))
  (= (m_elements_included
     (model__ (mk___rep v__split_discrs v__split_fields9)) 1
     (last
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__sort__sort__container__fields)))
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__sort__sort__container__fields)) 1
     (last
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__sort__sort__container__fields)))) true))
...
;; H
  (assert
  (= v__split_fields10 indefinite_unbounded__sort__sort__container__fields))
