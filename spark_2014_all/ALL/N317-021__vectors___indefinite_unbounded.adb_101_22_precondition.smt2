...
(declare-fun indefinite_unbounded__vect__replace_element__container__fields () us_split_fields)

(declare-fun result6 () us_split_fields__ref)

(declare-fun v__split_fields6 () us_split_fields)

(declare-fun indefinite_unbounded__vect__swap__container__fields () us_split_fields)

(declare-fun result7 () us_split_fields__ref)

(declare-fun v__split_fields7 () us_split_fields)

(declare-fun indefinite_unbounded__vect__delete_last__container__fields () us_split_fields)

(declare-fun result8 () us_split_fields__ref)

(declare-fun v__split_fields8 () us_split_fields)

(declare-fun indefinite_unbounded__vect__reverse_elements__container__fields () us_split_fields)

(declare-fun result9 () us_split_fields__ref)

(declare-fun v__split_fields9 () us_split_fields)

(declare-fun indefinite_unbounded__sort__sort__container__fields () us_split_fields)
