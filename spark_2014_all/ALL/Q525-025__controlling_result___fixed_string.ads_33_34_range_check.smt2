...
;; H
  (assert
  (=> (<= (to_rep1 out_string__first) r19b)
  (and
  (and (<= (to_rep1 out_string__first) (to_rep1 out_string__first))
  (<= (to_rep1 out_string__first) (to_rep1 out_string__last)))
  (and (<= (to_rep1 out_string__first) r19b)
  (<= r19b (to_rep1 out_string__last))))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first2 temp___2341)) (to_rep1 (last2 temp___2341)))
     ...
     0) (ite (<= (to_rep1 (first2 temp___2361)) (to_rep1 (last2 temp___2361)))
        (+ (- (to_rep1 (last2 temp___2361)) (to_rep1 (first2 temp___2361))) 1)
        0)))
...
;; H
  ...
  (= (select o5 temp___238) (select temp___237 temp___238))
  (= (select o5 temp___238) (select out_string1 temp___238)))))
...
;; H
  (assert
  (and (= o6 (elements this))
  (and (in_range3 o6)
  (= o6 (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this)))))))
