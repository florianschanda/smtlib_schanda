...
(declare-fun out_string__first () integer)

(declare-fun out_string__last () integer)
...
(declare-fun out_string () (Array Int character))

(declare-fun fixed_string__convert__result () (Array Int character))

(declare-fun fixed_string__convert__result1 () t)
...
(declare-fun fixed_string__convert__out_string__assume () (Array Int character))

(declare-fun fixed_string__convert__out_string__assume1 () t)

(declare-fun fixed_string__convert__R19b__assume () Int)

(declare-fun fixed_string__convert__R22b__assume () Int)

(declare-fun o3 () (Array Int character))

(declare-fun temp___233 () (Array Int character))

(declare-fun temp___2331 () t2)

(declare-fun temp___234 () (Array Int character))

(declare-fun temp___2341 () t1)

(declare-fun temp___237 () (Array Int character))
...
(declare-fun out_string1 () (Array Int character))

(declare-fun result2 () (Array Int character))

(declare-fun out_string2 () (Array Int character))

(declare-fun result3 () (Array Int character))

(declare-fun result4 () t)

(declare-fun fixed_string__convert__result2 () (Array Int character))

(declare-fun fixed_string__convert__result3 () t)

(declare-fun fixed_string__convert__result4 () (Array Int character))

(declare-fun fixed_string__convert__result5 () t)

(declare-fun fixed_string__convert__result6 () (Array Int character))

(declare-fun fixed_string__convert__result7 () t)

(declare-fun len2 () Int)

(declare-fun out_string3 () (Array Int character))

(declare-fun fixed_string__convert__result8 () (Array Int character))

(declare-fun fixed_string__convert__result9 () t)

(declare-fun len3 () Int)

(declare-fun out_string4 () (Array Int character))

(declare-fun fixed_string__convert__result10 () us_t)
