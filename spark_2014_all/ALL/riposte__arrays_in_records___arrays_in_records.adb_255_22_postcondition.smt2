...
(declare-const temp___377 index)

(declare-const temp___3771 (Array Int value))

(declare-const temp___3772 (Array Int value))
...
(declare-const temp___380 index)

(declare-const temp___3801 (Array Int value))

(declare-const temp___3802 (Array Int value))
...
;; H
  (assert (= (to_rep o) (to_rep (select b__split_fields2 j))))
...
;; H
  (assert (= temp___377 o2))

;; H
  (assert (= temp___3771 o3))

;; H
  (assert (= temp___3772 o4))
...
;; H
  (assert (= temp___377 a__split_fields3))

;; H
  (assert (= temp___3771 a__split_fields4))

;; H
  (assert (= temp___3772 a__split_fields5))

;; H
  (assert (= (to_rep o5) tmp1))

;; H
  (assert (= o6 (store b__split_fields2 j o5)))
...
;; H
  (assert (= temp___380 o7))

;; H
  (assert (= temp___3801 o8))

;; H
  (assert (= temp___3802 o9))
...
;; H
  (assert (= temp___380 b__split_fields3))

;; H
  (assert (= temp___3801 b__split_fields4))

;; H
  (assert (= temp___3802 b__split_fields5))
