...
;; H
  ...
  (or
  (and
  (and (= connection_attemps12 connection_attemps10)
  (= connection_attemps13 connection_attemps11))
  (ite (= start_of_mission true)
  (and
  ...
  (= o5 (ite (= o4 false) (ite (= order_to_contact_different_rbc true)
                          contact_order_not_for_accepting_rbc false) true)))
  (= o6 (ite (= o5 false) train_passes_rbc_rbc_border true)))
  (= o7 (ite (= o6 false) train_passes_start_of_announced_radio_hole true)))
  (= result3 (ite (= o7 false) (ite (not (= ertms_etcs_level 1)) true false) true)))
  (= result3 true)))))
  (and
  (and (= start_of_mission true)
  (and
  ...
  (and (= result2 connection_attemps2) (= connection_attemps3 o)))
  (not (<= connection_attemps3 3))))))
  (and (= connection_attemps4 (mk_int__ref connection_attemps3))
  (= connection_attemps5 connection_attemps3)))
  (and (= connection_attemps6 connection_attemps4)
  (= connection_attemps7 connection_attemps5)))
  (and (= connection_attemps6 (mk_int__ref connection_attemps1))
  (= connection_attemps7 connection_attemps1)))
  (and (= connection_attemps8 connection_attemps6)
  (= connection_attemps9 connection_attemps7))))
  (and (= connection_attemps12 connection_attemps8)
  (= connection_attemps13 connection_attemps9)))))
