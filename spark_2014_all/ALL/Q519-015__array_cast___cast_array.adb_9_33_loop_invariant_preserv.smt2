...
(declare-datatypes ((tint_array1D1__ref 0))
...
(declare-datatypes ((tint_array2D1__ref 0))
...
(((mk_map__ref1 (map__content1 (Array Int integer_subtype))))))
...
(declare-const o2 integer_subtype)

(declare-const o3 (Array Int integer_subtype))
...
;; H
  ...
  (=> (< i2 temp___163)
  (= (select result__2 temp___163) (select result__ temp___163)))))
...
;; H
  (assert (= (to_rep1 o2) (to_rep (select input_array i3))))

;; H
  (assert (= o3 (store result__2 i3 o2)))

;; H
  (assert (= result3 result__2))
...
;; WP_parameter_def
 ;; File "cast_array.ads", line 7, characters 0-0
  (not (= (to_rep1 (select result__3 k)) (to_rep (select input_array k)))))
(check-sat)
(exit)
