...
;; H
  (assert
  (and
  (forall ((temp___748 Int))
  (=> (and (<= 1 temp___748) (<= temp___748 50))
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___748))
  (= (select cur_board1 temp___748) (select cur_board temp___748)))))
  (and (<= 0 x2) (<= x2 2))))
...
;; H
  (assert
  (= temp___743 (get1 possible_three_shapes o
