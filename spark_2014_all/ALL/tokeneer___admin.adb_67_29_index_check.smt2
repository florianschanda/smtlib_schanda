...
(declare-fun dummy1 () datalengtht)
...
(declare-fun keyboard__datat__length__first__bit () Int)

(declare-fun keyboard__datat__length__last__bit () Int)

(declare-fun keyboard__datat__length__position () Int)
...
(declare-fun keyboard__datat__text__first__bit () Int)

(declare-fun keyboard__datat__text__last__bit () Int)

(declare-fun keyboard__datat__text__position () Int)
...
(declare-fun dummy6 () datalengtht1)
...
(declare-fun dummy7 () datai1)

(declare-datatypes ()
((datai__ref1 (mk_datai__ref1 (datai__content1 datai1)))))
...
(declare-fun admin__datat__length__first__bit () Int)

(declare-fun admin__datat__length__last__bit () Int)

(declare-fun admin__datat__length__position () Int)
...
(declare-fun admin__datat__minmatchlength__first__bit () Int)

(declare-fun admin__datat__minmatchlength__last__bit () Int)

(declare-fun admin__datat__minmatchlength__position () Int)
...
(declare-fun admin__datat__text__first__bit () Int)

(declare-fun admin__datat__text__last__bit () Int)

(declare-fun admin__datat__text__position () Int)
...
(declare-datatypes ()
((datat__ref1 (mk_datat__ref1 (datat__content1 us_rep1)))))
...
(declare-fun optokeyed () (Array Int us_rep1))
...
(declare-fun o () datai1)

(declare-fun o1 () datalengtht1)

(declare-fun o2 () datalengtht1)

(declare-fun o3 () datai1)

(declare-fun o4 () (Array Int character))

(declare-fun o5 () datai1)

(declare-fun o6 () datalengtht1)

(declare-fun o7 () datalengtht1)

(declare-fun o8 () datai1)

(declare-fun o9 () (Array Int character))

(declare-fun o10 () datai1)

(declare-fun o11 () datalengtht1)

(declare-fun o12 () datalengtht1)

(declare-fun o13 () datai1)

(declare-fun o14 () (Array Int character))

(declare-fun o15 () datai1)

(declare-fun o16 () datalengtht1)

(declare-fun o17 () datalengtht1)

(declare-fun o18 () datai1)

(declare-fun o19 () (Array Int character))

(declare-fun o20 () datalengtht1)

(declare-fun o21 () datai1)

(declare-fun o22 () (Array Int character))

(declare-fun o23 () datalengtht1)

(declare-fun o24 () datai1)

(declare-fun o25 () (Array Int character))

(declare-fun o26 () datalengtht1)

(declare-fun o27 () datai1)

(declare-fun o28 () (Array Int character))

(declare-fun o29 () datalengtht1)

(declare-fun o30 () datai1)

(declare-fun o31 () (Array Int character))

(declare-fun temp___353 () (Array Int us_rep1))
...
;; H
  (assert
  (= o33 (select (rec__keyboard__datat__text (us_split_fields1 keyedop))
  o32)))
