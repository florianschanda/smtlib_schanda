...
;; H
  (assert
  (=> (= (length temp___845) 0)
  (= o14 (mk___t (temp___String_Literal_844 Tuple0) (mk 1 1)))))

;; H
  (assert
  (=> (not (= (length temp___845) 0)) (=> (<= 1 1) (= o8 (+ (- 1 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length temp___845) 0))
  (=> (<= (to_rep1 (first (rt temp___845))) (to_rep1 (last (rt temp___845))))
  (= o9 (+ (- (to_rep1 (last (rt temp___845))) (to_rep1
                                               (first (rt temp___845)))) 1)))))
...
;; H
  (assert
  (=> (not (= (length temp___845) 0))
  (= o11 (+ (to_rep1 (first (rt temp___845))) o10))))
...
;; H
  (assert
  (=> (not (= (length temp___845) 0)) (and (= o13 o12) (in_range2 o12))))

;; H
  (assert
  (=> (not (= (length temp___845) 0))
  (= o14 (mk___t
         (concat1 (elts temp___845) (to_rep1 (first (rt temp___845)))
         (to_rep1 (last (rt temp___845))) (temp___String_Literal_844 Tuple0)
         1 1) (mk (to_rep1 (first (rt temp___845))) o13)))))
