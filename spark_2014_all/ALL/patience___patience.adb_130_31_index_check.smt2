...
;; H
  (assert
  (= o123 (select (rec__patience__state__preds
...
;; H
  (assert (= o126 (ite (<= (- 1) o121) true false)))

;; H
  (assert (= result27 (ite (= o126 true) o125 false)))

;; H
  (assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))

;; H
  (assert (=> (= result27 true) (= o116 i1)))
...
;; H
  (assert (=> (= result27 true) (= o118 (to_rep1 o117))))

;; H
  (assert (=> (= result27 true) (= result26 (ite (< o118 i1) true false))))
...
;; H
  (assert
  (= o113 (select (rec__patience__state__values
...
;; H
  (assert (= o115 (to_rep o111)))

;; H
  (assert (= result29 (ite (< o115 o114) true false)))
