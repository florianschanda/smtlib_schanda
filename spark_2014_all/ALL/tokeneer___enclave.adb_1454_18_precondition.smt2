...
;; H
  ...
  (= (bool_eq1 (latch_timeout state28) (latch_timeout state2)) true))
...
;; H
  (assert (= o11 (islocked (us_private__content state36))))

;; H
  (assert (= o12 (ite (not (= o11 true)) true false)))

;; H
  (assert (= result3 (ite (= o12 true) (islocked state2) false)))
...
;; H
  (assert (=> (= result3 true) (= o16 (ite (= o15 true) o14 false))))

;; H
  (assert (=> (not (= result3 true)) (= o16 (of_int 1))))
...
;; H
  (assert (= result4 (ite (= o3 1) true false)))
...
;; H
  (assert (=> (= result4 true) (= o8 (ite (not (= o7 true)) true false))))
...
;; H
  (assert (=> (= result4 true) (= o5 (ite (= o4 3) true false))))
...
;; H
  (assert (=> (= result4 true) (= o9 (ite (= o6 true) o5 false))))

;; H
  (assert (=> (= result4 true) (= o10 (ite (= o9 false) o8 true))))

;; H
  (assert (=> (not (= result4 true)) (= o10 (of_int 1))))
