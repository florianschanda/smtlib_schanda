...
;; H
  (assert
  (and (= o4 (+ archivedfilecount2 1)) (in_range7 (+ archivedfilecount2 1))))

;; H
  (assert (= result10 (mk_int__ref archivedfilecount2)))

;; H
  (assert (= archivedfilecount3 o4))

;; H
  (assert
  (and (= o5 (nextlistindex fileindexinusedlist2))
  (and (in_range8 o5)
  (= o5 (ite (= fileindexinusedlist2 17) 1 (+ fileindexinusedlist2 1))))))

;; H
  (assert (= result11 (mk_int__ref fileindexinusedlist2)))

;; H
  (assert (= fileindexinusedlist3 o5))

;; H
  (assert (< archivedfilecount3 4))

;; H
  (assert (< archivedfilecount3 (to_rep3 usedlogfiles__split_fields3)))
