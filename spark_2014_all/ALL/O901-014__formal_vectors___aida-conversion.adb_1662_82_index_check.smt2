...
;; H
  ...
  (forall ((index3 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 4) index3)
...
;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 4) i1) (<= i1 index2))
...
;; H
  ...
  (=> (< index2 temp___2035)
  (= (select n3 temp___2035) (select n1 temp___2035)))))
  (=>
...
;; H
  (assert
  (and (= o9 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))
