...
;; H
  (assert
  (and (= o40 (remove (mk___t values2 (mk 1 100)) o39))
  (and (dynamic_invariant4 o40 true false true)
  (and (= (invariant__ o40) true)
  (and (= (to_rep1 (last (rt o40))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o39 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o40) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o39 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o40) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o39 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o40) k))))))))))))

;; H
  (assert
  (and (= o42 (remove o40 o41))
  (and (dynamic_invariant4 o42 true false true)
  (and (= (invariant__ o42) true)
  (and (= (to_rep1 (last (rt o42))) (- (to_rep1 (last (rt o40))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o41 1)))
  (= (to_rep (select (elts o40) k)) (to_rep (select (elts o42) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o41 1) k) (<= k (to_rep1 (last (rt o40)))))
  (= (to_rep (select (elts o40) k)) (to_rep (select (elts o42) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o41 k) (<= k (- (to_rep1 (last (rt o40))) 1)))
  (= (to_rep (select (elts o40) (+ k 1))) (to_rep (select (elts o42) k))))))))))))

;; H
  (assert (and (= o37 (- y 1)) (in_range5 (- y 1))))
...
;; H
  (assert
  (and (= o36 (remove (mk___t values2 (mk 1 100)) o35))
  (and (dynamic_invariant4 o36 true false true)
  (and (= (invariant__ o36) true)
  (and (= (to_rep1 (last (rt o36))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o35 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o36) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o35 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o36) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o35 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o36) k))))))))))))

;; H
  (assert
  (and (= o38 (remove o36 o37))
  (and (dynamic_invariant4 o38 true false true)
  (and (= (invariant__ o38) true)
  (and (= (to_rep1 (last (rt o38))) (- (to_rep1 (last (rt o36))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o37 1)))
  (= (to_rep (select (elts o36) k)) (to_rep (select (elts o38) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o37 1) k) (<= k (to_rep1 (last (rt o36)))))
  (= (to_rep (select (elts o36) k)) (to_rep (select (elts o38) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o37 k) (<= k (- (to_rep1 (last (rt o36))) 1)))
  (= (to_rep (select (elts o36) (+ k 1))) (to_rep (select (elts o38) k))))))))))))
