...
(declare-fun tokenok () bool__ref)

(declare-fun tokentry1 () int__ref)

(declare-fun tokenid1 () int__ref)
...
;; H
  (assert
  (= (= (bool__content tokenok) true)
  (and
  (and
  (= (rec__admintoken__valididcertt__valid
     (us_split_fields__content8 idcert__split_fields)) true)
  (= (rec__admintoken__validauthcertt__valid
     (us_split_fields__content7 authcert__split_fields)) true))
  (in_range6
  (therole
  (rec__admintoken__validauthcertt__contents
  (us_split_fields__content7 authcert__split_fields)))))))

;; H
  (assert
  (and (in_range5 (int__content tokentry1)) (in_range4
  (int__content tokenid1))))
...
;; WP_parameter_def
 ;; File "admintoken.ads", line 40, characters 0-0
  (not (= (isgood (us_split_fields__content8 idcert__split_fields)) true)))
(check-sat)
(exit)
