...
(declare-fun time_span_first () duration)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun time_span_last () duration)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun time_span_zero () duration)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun time_span_unit () duration)
