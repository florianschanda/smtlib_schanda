...
(declare-const temp___1142 (Array Int character))

(declare-const temp___11421 t1)
...
;; H
  (assert
  (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1142))

;; H
  (assert (= (mk1 1 (length thestring)) temp___11421))

;; H
  (assert
  (and (= temp___1144 (length thestring)) (in_range1 (length thestring))))

;; H
  (assert (<= 1 temp___1144))
