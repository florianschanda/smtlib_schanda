...
;; H
  (assert
  (and (= o20 (rate_of (mk___rep ctx__split_fields7)))
  (and (in_range3 o20)
  (and
  (= o20 (* (to_rep6
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert
  (and (= o17 (rate_of (mk___rep ctx__split_fields7)))
  (and (in_range3 o17)
  (and
  (= o17 (* (to_rep6
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert
  (and (= o18 (in_queue_bit_length (mk___rep ctx__split_fields7)))
  (and (in_range2 o18)
  (and
  (= o18 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
...
;; H
  (assert
  (and (= o16 (+ bit_length suffix_len)) (in_range1
  (+ bit_length suffix_len))))
