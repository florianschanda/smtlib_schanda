...
(define-fun default_initial_assumption3 ((temp___expr_402 us_rep2)
...
(define-fun dynamic_invariant3 ((temp___expr_395 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_389 Int)
...
;; H
  (assert (= temp___682 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___682)) no_element))
