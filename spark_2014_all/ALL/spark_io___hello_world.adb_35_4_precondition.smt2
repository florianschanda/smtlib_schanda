...
;; temp___String_Literal_808__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_808 us_void_param) 1)) 72)
     (= (to_rep (select (temp___String_Literal_808 us_void_param) 2)) 101))
     (= (to_rep (select (temp___String_Literal_808 us_void_param) 3)) 108))
     (= (to_rep (select (temp___String_Literal_808 us_void_param) 4)) 108))
     (= (to_rep (select (temp___String_Literal_808 us_void_param) 5)) 111))
...
;; temp___String_Literal_809__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_809 us_void_param) 1)) 87)
     (= (to_rep (select (temp___String_Literal_809 us_void_param) 2)) 111))
     (= (to_rep (select (temp___String_Literal_809 us_void_param) 3)) 114))
     (= (to_rep (select (temp___String_Literal_809 us_void_param) 4)) 108))
     (= (to_rep (select (temp___String_Literal_809 us_void_param) 5)) 100))
     (= (to_rep (select (temp___String_Literal_809 us_void_param) 6)) 46)) :pattern (
  (temp___String_Literal_809 us_void_param)) )))
...
(declare-fun user_eq6 (file_mode file_mode) Bool)

(declare-fun dummy6 () file_mode)
...
;; H
  (assert
  (and (= (status standard_output) 1) (= (is_writable standard_output) true)))

(assert
;; WP_parameter_def
 ;; File "spark-text_io.ads", line 81, characters 0-0
  (not (= (status standard_output) 1)))
(check-sat)
(exit)
