...
;; H
  (assert (<= (- 2147483648) i1))

;; H
  (assert (<= i1 2147483647))

;; H
  (assert (= (to_rep o) (to_rep (select b i1))))
...
;; H
  ...
  (= (to_rep (select a2 j)) (to_rep (select b j))))))
...
;; H
  ...
  (=> (< i2 temp___293) (= (select a2 temp___293) (select a temp___293))))))
...
;; H
  (assert (= (to_rep o2) (to_rep (select b i3))))
...
;; WP_parameter_def
 ;; File "simple_arrays.adb", line 25, characters 0-0
  (not (= (to_rep (select a3 j)) (to_rep (select b j)))))
(check-sat)
