...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o33) true))
  (= (bool_eq
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o33)) o33) true))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields)) o33) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (elements
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o33)
     (length
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o32) true))
  (= (bool_eq
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o32)) o32) true))
  ...
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields1)) o32) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o32)
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o31) true)
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs
  ...
  (= (e_is_find
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o31
     (get1
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields))
...
;; WP_parameter_def
 ;; File "my_ordered_sets.adb", line 4, characters 0-0
  (not
  (or
  (< (length (mk___rep1 l__split_discrs l__split_fields6)) (to_rep2
                                                           (rec__my_ordered_sets__n__set__capacity
                                                           l__split_discrs)))
  (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields6)) o30) true))))
(check-sat)
(exit)
