...
;; H
  ...
  (forall ((index9 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 3) index9)
...
;; H
  (assert
  (and (= temp___2087 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2087)
  (<= temp___2087 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= o63 (- target8 2100000000)) (in_range1 (- target8 2100000000))))
