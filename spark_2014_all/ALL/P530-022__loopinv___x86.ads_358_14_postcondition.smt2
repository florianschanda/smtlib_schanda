...
(declare-fun x86__esp__result () (_ BitVec 32))

(declare-fun result () (_ BitVec 32))

(declare-fun x86__esp__result1 () (_ BitVec 32))

(declare-fun x86__esp__result2 () (_ BitVec 32))

(declare-fun x86__esp__result3 () (_ BitVec 32))

(declare-fun x86__esp__result4 () (_ BitVec 32))

(declare-fun x86__esp__result5 () (_ BitVec 32))
...
;; H
  (assert (= result x86__esp__result))

;; H
  (assert
  (= x86__esp__result1 ((_ extract 31 0) (bvand rsp ((_ int2bv 64) 4294967295)))))

;; H
  (assert (= (mk_t__ref x86__esp__result4) (mk_t__ref x86__esp__result2)))

;; H
  (assert (= x86__esp__result5 x86__esp__result3))

;; H
  (assert (= result1 x86__esp__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not (= x86__esp__result4 (readreg32 rsp))))
(check-sat)
(exit)
