...
(declare-fun to_rep1 (et3) Int)

(declare-fun of_rep1 (Int) et3)

;; inversion_axiom
  (assert
  (forall ((x et3)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)) )))

;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-fun to_rep2 (et4) Int)

(declare-fun of_rep2 (Int) et4)

;; inversion_axiom
  (assert
  (forall ((x et4)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)) )))

;; range_axiom
  (assert
  (forall ((x et4)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (and
                         ...
                         (to_rep1 (rec__ar__rec2t__f2 (us_split_fields3 b))))
                         (= (bool_eq
...
(define-fun bool_eq2 ((a us_rep2)
  (b us_rep2)) Bool (ite (and
                         ...
                         (to_rep2 (rec__ar__rec3t__g3 (us_split_fields5 b)))))
                    true false))
...
(declare-const temp___6860 us_rep2)
...
(declare-const temp___6863 us_rep2)

(declare-const o22 et4)

(declare-const o23 us_split_fields4)

(declare-const temp___6865 us_rep2)
...
(declare-const temp___6868 us_rep2)
...
;; H
  (assert (= r__split_fields5 (us_split_fields5 temp___6860)))
...
;; H
  (assert (= temp___6863 (mk___rep2 o21)))

;; H
  (assert (= result1 (mk___split_fields__ref2 r__split_fields5)))

;; H
  (assert (= r__split_fields6 (us_split_fields5 temp___6863)))
...
;; H
  (assert (= temp___6865 (mk___rep2 o23)))

;; H
  (assert (= result2 (mk___split_fields__ref2 r__split_fields6)))

;; H
  (assert (= r__split_fields7 (us_split_fields5 temp___6865)))
...
;; H
  (assert (= temp___6868 (mk___rep2 o27)))

;; H
  (assert (= result3 (mk___split_fields__ref2 r__split_fields7)))

;; H
  (assert (= r__split_fields8 (us_split_fields5 temp___6868)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 902, characters 0-0
  (not
  (= (to_rep2
