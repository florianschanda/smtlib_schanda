...
(declare-fun q_v12 () Int)

(declare-fun result2 () Int)

(declare-fun t_v12 () Int)
...
;; H
  ...
  (ite (< k q_v12)
  (= (to_rep1 (select h_v11 k)) (to_rep1 (select h_v1 (+ k m_v11))))
  (ite (< (+ q_v12 m_v11) k)
  (= (to_rep1 (select h_v11 k)) (to_rep1 (select h_v1 (- k m_v11))))
  (= (to_rep1 (select h_v11 k)) (to_rep1 (select h_v1 k))))))))

;; H
  (assert
  (and
  (and (=> (<= (- 2147483648) 2147483647) (in_range2 t_v11))
  (=> (<= (to_rep h_v1__first) r11b) (dynamic_property1 (to_rep h_v1__first)
  r11b q_v12))) (and (<= (to_rep h_v1__first) q_v12) (<= q_v12 r11b))))

;; H
  (assert
  (and (<= (to_rep h_v1__first) q_v12) (<= q_v12 (to_rep h_v1__last))))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 61, characters 0-0
  (not (<= (to_rep h_v1__first) temp___378)))
(check-sat)
(exit)
