...
;; H
  ...
  (and (dynamic_property1 first1 last1 o5)
  (= o5 (last4
        (model__
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields)))))))))
...
;; H
  (assert
  (=> (not (= before no_index))
  (and (= o6 (- before 1)) (in_range1 (- before 1)))))

;; H
  (assert (=> (not (= before no_index)) (= o7 (ite (= o6 o5) true false))))

;; H
  (assert (=> (not (not (= before no_index))) (= o7 false)))
...
;; H
  ...
  (= o3 (last4
        ...
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields)))))
  (and (dynamic_property1 first1 last1 o3)
  (= o3 (last4
        (model__
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields))))))))
...
;; H
  ...
  (and (dynamic_property2 0 last2 o) (<= o (capacity new_item)))))
...
;; H
  ...
  (= o1 (capacity
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields))))
  (and (dynamic_property2 0 last2 o1)
