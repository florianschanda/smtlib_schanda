...
(declare-datatypes () ((t50b__ref (mk_t50b__ref (t50b__content us_t)))))
(define-fun t50b__ref___projection ((a t50b__ref)) us_t (t50b__content a))
...
(declare-datatypes () ((t53b__ref (mk_t53b__ref (t53b__content us_t1)))))
(define-fun t53b__ref___projection ((a t53b__ref)) us_t1 (t53b__content a))
...
(declare-datatypes () ((t56b__ref (mk_t56b__ref (t56b__content us_t2)))))
(define-fun t56b__ref___projection ((a t56b__ref)) us_t2 (t56b__content a))
...
(declare-fun temp___180 () (Array Int character))

(declare-fun temp___1801 () t)
...
;; H
  (assert (in_range r48b))

;; H
  (assert
  (=> (<= r48b 5)
  (and (and (<= 1 r48b) (<= r48b 5)) (and (<= 1 5) (<= 5 5)))))
...
;; H
  (assert (= (mk r48b 5) temp___1801))

;; H
  (assert
  (= o1 (bool_eq temp___180 (to_rep1 (first temp___1801))
        (to_rep1 (last temp___1801)) new_sub 1 5)))
...
(assert
;; WP_parameter_def
 ;; File "foo.adb", line 41, characters 0-0
  (not (<= 1 y1)))
(check-sat)
(exit)
