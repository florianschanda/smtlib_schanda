...
(declare-fun dummy4 () tTmy_arraySP1)

(declare-datatypes ()
((tTmy_arraySP1__ref
 (mk_tTmy_arraySP1__ref (tTmy_arraySP1__content tTmy_arraySP1)))))
(define-fun tTmy_arraySP1__ref___projection ((a tTmy_arraySP1__ref)) tTmy_arraySP1
...
;; def_axiom
  ...
  (= (select (main__my_array__aggregate_def temp___199) temp___200) (of_rep1
                                                                    temp___199)))))
...
(define-fun dynamic_invariant3 ((temp___expr_136 Int)
  ...
  (temp___do_toplevel_135 Bool)) Bool (=>
                                      ...
                                      (<= 0 20)) (in_range1 temp___expr_136)))

(declare-fun my_array () (Array Int item))

(declare-fun o () integer)

(declare-fun o1 () integer)

(declare-fun result () (Array Int item))

(declare-fun my_array1 () (Array Int item))
