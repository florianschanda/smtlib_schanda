...
(((mk_instruction__ref (instruction__content instruction)))))
...
(((mk___split_discrs (rec__tokens__token__kind token_kind)))))
...
;; WP_parameter_def
 ;; File "tokens.adb", line 13, characters 0-0
  (not (in_range5
  (to_rep3 (rec__tokens__token__kind (us_split_discrs1 t))))))
(check-sat)
(exit)
