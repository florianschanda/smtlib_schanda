...
(define-fun tab17 () map__ref (mk_map__ref tab))
...
;; H
  (assert (=> (<= j1 b) (= (mk_map__ref result1) tab17)))
...
;; H
  (assert (and (= o16 (+ k10 1)) (in_range1 (+ k10 1))))

;; H
  (assert (= result17 (mk_int__ref k10)))
...
;; H
  (assert (= result18 (mk_int__ref temp___162)))

;; H
  (assert (= temp___1621 j19))

;; H
  (assert (= result19 (mk_int__ref temp___163)))

;; H
  (assert (= temp___1631 k12))

;; H
  (assert (<= j19 b))

;; H
  (assert (= (to_rep o17) j19))

;; H
  (assert (and (<= (to_rep tab__first) j19) (<= j19 (to_rep tab__last))))

;; H
  (assert (= o18 j19))

;; H
  (assert (= o19 (store tab15 o18 o17)))

;; H
  (assert (= result20 (mk_map__ref tab15)))

;; H
  (assert (= tab16 o19))

;; H
  (assert (and (= o20 (+ j19 1)) (in_range1 (+ j19 1))))

;; H
  (assert (= result21 (mk_int__ref j19)))

;; H
  (assert (= j20 o20))

;; H
  (assert (and (= o21 (+ k12 1)) (in_range1 (+ k12 1))))

;; H
  (assert (= result22 (mk_int__ref k12)))
