...
;; H
  ...
  (=>
  (and (<= 1 n1)
  (<= n1 (length (mk___rep l2__split_discrs l2__split_fields2))))
  (= (is_incr (get (model__ l1) n1)
     (get (model__ (mk___rep l2__split_discrs l2__split_fields2)) n1)) true))))
...
;; H
  (assert
  (and (= o (length (mk___rep l2__split_discrs l2__split_fields2)))
  (and (in_range2 o)
  (<= o (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))))
...
;; H
  (assert
  (and (= o3 (model__ (mk___rep l2__split_discrs l2__split_fields2)))
  (= (length1 o3) (length (mk___rep l2__split_discrs l2__split_fields2)))))

;; H
  (assert (and (= o4 (get o3 n)) (in_range4 o4)))
