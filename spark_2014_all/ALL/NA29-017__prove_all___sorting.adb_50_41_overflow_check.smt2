...
;; H
  (assert (= o12 (ite (<= j o11) true false)))

;; H
  (assert (= o13 (ite (<= b_first j) o12 false)))

;; H
  (assert (= result2 (ite (not (= o13 true)) true false)))
...
;; H
  (assert (=> (= result2 true) (= o16 j)))

;; H
  (assert (=> (= result2 true) (= o17 (select b o16))))

;; H
  (assert (=> (= result2 true) (= o18 (to_rep o17))))
...
;; H
  (assert (=> (= result2 true) (= o14 j)))

;; H
  (assert (=> (= result2 true) (= o15 (select b2 o14))))

;; H
  (assert (=> (= result2 true) (= o19 (to_rep o15))))

;; H
  (assert (=> (= result2 true) (= o20 (ite (= o19 o18) true false))))
