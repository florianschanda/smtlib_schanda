...
(declare-fun temp___7282 () int__ref)

(declare-fun temp___7272 () int__ref)
...
(declare-fun temp___7283 () Int)

(declare-fun temp___7273 () Int)
...
;; H
  (assert (= result14 (mk_int__ref remaining_bits2)))

;; H
  (assert (= remaining_bits3 o19))

;; H
  (assert (<= 64 remaining_bits3))

;; H
  (assert (= temp___7272 (mk_int__ref temp___7271)))

;; H
  (assert (= temp___7282 (mk_int__ref temp___7281)))
...
;; H
  (assert (= remaining_bits4 (mk_int__ref remaining_bits3)))
...
;; H
  (assert (= a2 (mk_map__ref1 a1)))

;; H
  (assert (= temp___7273 temp___7271))

;; H
  (assert (= temp___7283 temp___7281))
...
;; H
  (assert (= remaining_bits5 remaining_bits3))
