...
;; H
  (assert
  (=> (not (= time_idle 0))
  (and (= o (ite (< 50 (- time_idle 1)) 50 (- time_idle 1))) (in_range2
  (ite (< 50 (- time_idle 1)) 50 (- time_idle 1))))))

;; H
  (assert
  (=> (not (= time_idle 0))
  (and (= result (always_set_until_now o idle_history))
  (= (= result true)
  (forall ((t Int))
  (=> (and (<= 0 t) (<= t o)) (= (select idle_history t) true)))))))
