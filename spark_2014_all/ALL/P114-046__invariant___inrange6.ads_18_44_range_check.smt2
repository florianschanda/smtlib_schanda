...
(declare-fun inrange6__inrange64__result () Bool)
...
(declare-fun inrange6__inrange64__result1 () Bool)

(declare-fun inrange6__inrange64__result2 () Bool)

(declare-fun inrange6__inrange64__result3 () Bool)

(declare-fun i2 () (_ BitVec 64))

(declare-fun matched3 () Bool)

(declare-fun inrange6__inrange64__result4 () Bool)

(declare-fun i3 () (_ BitVec 64))

(declare-fun matched4 () Bool)

(declare-fun inrange6__inrange64__result5 () Bool)
...
;; H
  (assert
  (=>
  (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1)))
  (= (mk_bool__ref result1) matched5)))

;; H
  (assert
  (=>
  (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1)))
  (= matched1 (ite (bvule bottom var)
              (ite (bvule var (bvsub (bvadd bottom range_size) ((_ int2bv 64) 1)))
              true false) false))))
...
;; H
  ...
  (not
  (bvule bottom (bvadd (bvsub ((_ int2bv 64) 18446744073709551615) range_size) ((_ int2bv 64) 1))))
  (= matched2 (ite (= (ite (bvule bottom var) (of_int 1) false) false)
              (ite (bvult var (bvsub (bvsub range_size (bvsub ((_ int2bv 64) 18446744073709551615)
              bottom)) ((_ int2bv 64) 1))) true false) true))))
...
;; H
  (assert
  (= (mk_bool__ref result3) (mk_bool__ref inrange6__inrange64__result)))
...
;; H
  (assert
  (= (mk_bool__ref inrange6__inrange64__result4) (mk_bool__ref
                                                 inrange6__inrange64__result2)))
