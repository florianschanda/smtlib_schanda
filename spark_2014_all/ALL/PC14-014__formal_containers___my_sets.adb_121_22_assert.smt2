...
(((mk___split_fields1 (rec__my_sets__n__set us_main_type)))))
...
(define-fun dynamic_invariant2 ((temp___expr_981 Int)
  (temp___is_init_978 Bool) (temp___skip_constant_979 Bool)
  (temp___do_toplevel_980 Bool)) Bool (=>
                                      (or (= temp___is_init_978 true)
...
;; contains__post_axiom
  ...
  (forall ((container us_rep1))
  (forall ((key Int))
  (! (=> (dynamic_invariant2 key true true true)
     (= (= (contains3 container key) true)
     (exists ((e us_rep))
     (and (= (contains (model__ container) e) true) (= key (get_f e)))))) :pattern (
  (contains3 container key)) ))))

(define-fun key__2 ((container us_rep1)
  (position us_rep2)) Int (get_f (element container position)))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 key true true true)
     ...
     (= (bool_eq2 result no_element) true)
     (and (= (has_key (positions container) result) true)
     (= (key__2 container result) key))))) :pattern ((find3 container key)) ))))
...
(define-fun element2 ((container us_rep1)
  (key Int)) us_rep (element container (find3 container key)))
...
(define-fun dynamic_invariant3 ((temp___expr_1041 us_rep1)
  (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool)
  (temp___do_toplevel_1040 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_1039 true))
                                       (in_range6 10 r9b temp___expr_1041)))

(define-fun default_initial_assumption ((temp___expr_1044 us_rep1)
  (temp___skip_top_level_1045 Bool)) Bool (and
                                          (and
                                          (= (to_rep3
                                             (rec__my_sets__n__set__capacity
                                             (us_split_discrs1
                                          ...
                                          (= (to_rep2
                                             (rec__my_sets__n__set__modulus
                                             (us_split_discrs1
                                             temp___expr_1044))) r9b))
                                          (=>
                                          (not
                                          (= temp___skip_top_level_1045 true))
                                          (= (is_empty temp___expr_1044) true))))
...
(define-fun in_range7 ((rec__my_sets__n__set__capacity1 Int)
  (rec__my_sets__n__set__modulus1 (_ BitVec 32))
  (a us_rep1)) Bool (and
                    (= rec__my_sets__n__set__capacity1 (to_rep3
                                                       (rec__my_sets__n__set__capacity
...
(define-fun dynamic_invariant4 ((temp___expr_1052 us_rep1)
  (temp___is_init_1049 Bool) (temp___skip_constant_1050 Bool)
  (temp___do_toplevel_1051 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_1050 true))
                                       (in_range7 10 r12b temp___expr_1052)))

(define-fun default_initial_assumption1 ((temp___expr_1055 us_rep1)
  (temp___skip_top_level_1056 Bool)) Bool (and
                                          (and
                                          (= (to_rep3
                                             (rec__my_sets__n__set__capacity
                                             (us_split_discrs1
                                          ...
                                          (= (to_rep2
                                             (rec__my_sets__n__set__modulus
                                             (us_split_discrs1
                                             temp___expr_1055))) r12b))
                                          (=>
                                          (not
                                          (= temp___skip_top_level_1056 true))
                                          (= (is_empty temp___expr_1055) true))))
...
(define-fun dynamic_invariant7 ((temp___expr_717 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_737 Int)
...
;; m_included_except__post_axiom
  ...
  (! (=> (dynamic_invariant2 key true true true)
     ...
     (forall ((e us_rep))
     (=> (= (contains left e) true)
     (or (= (contains right e) true) (= (get_f e) key)))))) :pattern (
  (m_included_except left right key)) ))))
...
(define-fun temp___14031 () us_rep2 (mk___rep2
                                    (mk___split_fields2 temp___1403)))

(define-fun temp___14021 () us_rep2 (mk___rep2
                                    (mk___split_fields2 temp___1402)))
...
;; H
  ...
  (= r9b (to_rep2 (rec__my_sets__n__set__modulus l__split_discrs)))))
...
;; H
  ...
  (= r12b (to_rep2 (rec__my_sets__n__set__modulus k__split_discrs)))))
...
;; H
  ...
  (= (bool_eq2 temp___14021 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= (bool_eq2 temp___14031 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs my_sets__n__include__container__fields1))
     o34) true)
  (= (bool_eq
     (element
     (mk___rep1 l__split_discrs my_sets__n__include__container__fields1)
  ...
  (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields7))
     (model__
     (mk___rep1 l__split_discrs my_sets__n__include__container__fields1))) true))
  (= (included_except
     (model__
     (mk___rep1 l__split_discrs my_sets__n__include__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields7)) o34) true))
  (= (mapping_preserved
     (elements (mk___rep1 l__split_discrs l__split_fields7))
     (elements
     (mk___rep1 l__split_discrs my_sets__n__include__container__fields1))
...
;; H
  ...
  (= (oeq2
     (model__
     (mk___rep1 k__split_discrs my_sets__n__assign__target__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields8))) true)
  (= (length (mk___rep1 k__split_discrs my_sets__n__assign__target__fields1))
  ...
  (= (e_elements_included
     ...
     (elements
     (mk___rep1 k__split_discrs my_sets__n__assign__target__fields1))) true)))
...
;; H
  ...
  (and
  (= (length
     (mk___rep1 l__split_discrs my_sets__n__delete__container__fields)) (-
  ...
  (= (keys_included_except
     ...
     (positions
     (mk___rep1 l__split_discrs my_sets__n__delete__container__fields))
     (find1 (mk___rep1 l__split_discrs l__split_fields8) o38)) true)))
...
;; H
  (assert
  (and
  (= temp___1416 (find1 (mk___rep1 l__split_discrs l__split_fields9) o42))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields9))
               o42) false) true false)
  (= (bool_eq2 temp___1416 no_element) true)
  (and
  (and
  ...
  (= (= (to_rep1
        (rec__my_sets__my_rec__f
        (us_split_fields1
        (element (mk___rep1 l__split_discrs l__split_fields9) temp___1416))))
  (to_rep1 (rec__my_sets__my_rec__f (us_split_fields1 o42)))) true)))))
...
;; H
  ...
  (= (length
     (mk___rep1 l__split_discrs my_sets__n__delete__2__container__fields)) (-
...
;; H
  (assert
  (and
  (= temp___1418 (find1 (mk___rep1 l__split_discrs l__split_fields10) o46))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
               o46) false) true false)
  (= (bool_eq2 temp___1418 no_element) true)
  (and
  (and
  ...
  (= (= (to_rep1
        (rec__my_sets__my_rec__f
        (us_split_fields1
        (element (mk___rep1 l__split_discrs l__split_fields10) temp___1418))))
  (to_rep1 (rec__my_sets__my_rec__f (us_split_fields1 o46)))) true)))))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs my_sets__n__exclude__container__fields))
     o50) true))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
  ...
  (= (keys_included_except
     ...
     (positions
     (mk___rep1 l__split_discrs my_sets__n__exclude__container__fields))
     (find1 (mk___rep1 l__split_discrs l__split_fields10) o50)) true)))))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs my_sets__n__exclude__container__fields1))
     o54) true))
  (ite (ite (= (contains
  ...
  (= (keys_included_except
     ...
     (positions
     (mk___rep1 l__split_discrs my_sets__n__exclude__container__fields1))
     (find1 (mk___rep1 l__split_discrs l__split_fields11) o54)) true)))))
...
(assert
;; WP_parameter_def
 ;; File "my_sets.adb", line 4, characters 0-0
