...
;; def_axiom
  (assert
  (forall ((temp___4297 (Array Int us_rep)))
  (forall ((temp___4298 Int))
  (forall ((temp___4299 us_rep))
  (let ((temp___4296 (temp___4295 temp___4297 temp___4298 temp___4299)))
  (forall ((temp___4300 Int))
  (ite (= temp___4300 temp___4298)
  (= (select temp___4296 temp___4300) temp___4299)
  (= (select temp___4296 temp___4300) (select temp___4297 temp___4300)))))))))

(declare-fun temp___4301 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___4303 (Array Int et1)))
  (forall ((temp___4304 Int) (temp___4305 Int))
  (let ((temp___4302 (temp___4301 temp___4303 temp___4304 temp___4305)))
  (forall ((temp___4306 Int))
  (ite (= temp___4306 temp___4304)
  (= (select temp___4302 temp___4306) (of_rep temp___4305))
  (= (select temp___4302 temp___4306) (select temp___4303 temp___4306))))))))
...
(declare-fun temp___10074 () (Array Int us_rep))

(declare-fun temp___100741 () (Array Int et1))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1886, characters 0-0
  (not
  (= (bool_eq3
     (mk___rep1 (mk___split_fields1 r__split_fields4 r__split_fields5))
     (mk___rep1
     (mk___split_fields1
     (temp___4295 r__split_fields i
     (mk___rep
     (mk___split_fields
     (temp___4301
