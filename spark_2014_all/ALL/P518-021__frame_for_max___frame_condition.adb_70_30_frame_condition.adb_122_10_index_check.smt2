...
;; H
  (assert
  (and
  (= o30 (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last)))
         (map__content a7)))
  (= (= o30 true)
  (forall ((i1 Int))
...
;; H
  ...
  (<= (to_rep
      (rec__frame_condition__cell__value
      (us_split_fields1 (select (map__content a7) j1)))) (get_max_left i1
                                                         (map__content a7)))))))))
...
;; H
  (assert
  (and (= o28 (get_max_left o27 (map__content a7)))
  (and (in_range2 o28)
  (= o28 (to_rep
         (rec__frame_condition__cell__max_left
