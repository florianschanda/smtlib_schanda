...
;; H
  ...
  (=>
  (and (<= 1 n)
  (<= n (- (get1 (positions (mk___rep l__split_discrs l__split_fields2))
           (mk___rep1 cu__split_fields3)) 1)))
  (= (is_incr
     (get
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     n) (get (model__ (mk___rep l__split_discrs l__split_fields2)) n)) true))))
...
;; H
  ...
  (<= n (length (mk___rep l__split_discrs l__split_fields2))))
  (= (get
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     n) (get (model__ (mk___rep l__split_discrs l__split_fields2)) n)))))
...
;; H
  (assert
  (and
  (= o (element (mk___rep l__split_discrs l__split_fields2)
       (mk___rep1 cu__split_fields3)))
  (and (in_range6 o)
  (= o (get (model__ (mk___rep l__split_discrs l__split_fields2))
       (get1 (positions (mk___rep l__split_discrs l__split_fields2))
       (mk___rep1 cu__split_fields3)))))))
...
;; H
  (assert
  (and
  (= o1 (element (mk___rep l__split_discrs l__split_fields2)
        (mk___rep1 cu__split_fields3)))
  (and (in_range6 o1)
  (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields2))
        (get1 (positions (mk___rep l__split_discrs l__split_fields2))
        (mk___rep1 cu__split_fields3)))))))
