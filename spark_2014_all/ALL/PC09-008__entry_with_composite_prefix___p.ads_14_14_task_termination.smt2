...
(declare-fun p__pt__g__first__bit () Int)

(declare-fun p__pt__g__last__bit () Int)

(declare-fun p__pt__g__position () Int)
...
(declare-fun p__r__c__first__bit () Int)

(declare-fun p__r__c__last__bit () Int)

(declare-fun p__r__c__position () Int)
