...
;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= result1 y12)))

;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= y4 o18)))
...
;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= result2 y12)))

;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= y5 o22)))

;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= y4 y5)))
...
;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= result5 y11)))

;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= y6 o50)))
...
;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= result6 y11)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y7 o54)))
...
;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= result9 y10)))

;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= y8 o82)))
...
;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= result10 y10)))

;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= y9 o86)))
...
;; H
  (assert (not (bvule x7 ((_ int2bv 32) 2147483647))))

;; H
  (assert (and (= o114 (bv2nat (bvnot x7))) (in_range1 (bv2nat (bvnot x7)))))
