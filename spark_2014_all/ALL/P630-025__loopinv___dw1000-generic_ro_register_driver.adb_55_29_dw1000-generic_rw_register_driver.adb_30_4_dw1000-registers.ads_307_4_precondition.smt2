...
(define-fun register_type__ref_66__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_47__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_47__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3554 us_t1)
  (temp___is_init_3551 Bool) (temp___skip_constant_3552 Bool)
  (temp___do_toplevel_3553 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3552 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3554)
                                       (last3 temp___expr_3554))
                                       (and (= (first3 temp___expr_3554) 1)
                                       (= (last3 temp___expr_3554) 2)))))
