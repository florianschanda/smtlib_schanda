...
(define-fun register_type__ref___66__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___47__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___47__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3598 us_t1)
  (temp___is_init_3595 Bool) (temp___skip_constant_3596 Bool)
  (temp___do_toplevel_3597 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3596 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3598)
                                       (last3 temp___expr_3598))
                                       (and (= (first3 temp___expr_3598) 1)
                                       (= (last3 temp___expr_3598) 2)))))
