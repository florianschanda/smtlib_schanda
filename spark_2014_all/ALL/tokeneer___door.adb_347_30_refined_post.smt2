...
(declare-fun temp___859 () yearst)

(declare-fun temp___8591 () monthst)

(declare-fun temp___8592 () dayst)

(declare-fun temp___8593 () millisecst)

(declare-fun state () us_private)

(declare-fun result () yearst)

(declare-fun result1 () monthst)

(declare-fun result2 () dayst)

(declare-fun result3 () millisecst)

(declare-fun alarmtimeout__split_fields4 () yearst)

(declare-fun alarmtimeout__split_fields5 () monthst)

(declare-fun alarmtimeout__split_fields6 () dayst)

(declare-fun alarmtimeout__split_fields7 () millisecst)
...
(declare-fun alarmtimeout__split_fields8 () yearst)

(declare-fun alarmtimeout__split_fields9 () monthst)

(declare-fun alarmtimeout__split_fields10 () dayst)

(declare-fun alarmtimeout__split_fields11 () millisecst)
...
(declare-fun alarmtimeout__split_fields12 () us_split_fields)
...
;; H
  (assert (= (bool_eq5 (latch_timeout state) o4) true))
...
;; H
  ...
  (= (bool_eq5 (latch_timeout state1) (latch_timeout state)) true)))
