...
(declare-fun dummy1 () adminprivileget)
...
(declare-fun dummy2 () datalengtht)
...
(declare-fun dummy9 () datalengtht1)
...
(declare-fun dummy10 () datai)

(declare-datatypes () ((datai__ref (mk_datai__ref (datai__content datai)))))
(define-fun datai__ref_2__projection ((a datai__ref)) datai (datai__content
                                                            a))
...
(define-fun us_split_fields_Length2__projection ((a us_split_fields4)) datalengtht1
...
(declare-datatypes ()
((datat__ref1 (mk_datat__ref1 (datat__content1 us_rep2)))))
(define-fun datat__ref_2__projection ((a datat__ref1)) us_rep2 (datat__content1
                                                               a))
...
(declare-fun optokeyed () (Array Int us_rep2))
...
(declare-fun dummy13 () (Array Int Bool))
...
(declare-datatypes ()
((map__ref3 (mk_map__ref3 (map__content3 (Array Int (Array Int Bool)))))))
...
(declare-fun isavailable () (Array Int (Array Int Bool)))
...
(declare-fun theop1 () Int)

(declare-fun result1 () Int)

(declare-fun op1 () Int)

(declare-fun theop2 () Int)

(declare-fun op2 () Int)

(declare-fun result2 () Bool)

(declare-fun theop3 () Int)
...
;; H
  (assert
  (and (and (=> (<= 0 4) (in_range5 theop2)) (=> (<= 1 4) (in_range6 op2)))
  (and (<= 1 op2) (<= op2 4))))

;; H
  (assert
  (and (= result2 (str_comp keyedop op2))
  (= (= result2 true)
  (and
  (and
  (<= (to_rep5
      (rec__admin__datat__minmatchlength
      (us_split_fields5 (select optokeyed op2)))) (to_rep1
                                                  (rec__keyboard__datat__length
                                                  (us_split_fields1 keyedop))))
  (<= (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop)))
  (to_rep4
  (rec__admin__datat__length (us_split_fields5 (select optokeyed op2))))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  ...
  (= (to_rep2
     (select (rec__admin__datat__text
             (us_split_fields5 (select optokeyed op2))) i)) (to_rep2
