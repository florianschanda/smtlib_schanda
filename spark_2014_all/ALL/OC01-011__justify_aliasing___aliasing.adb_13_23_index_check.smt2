...
(declare-datatypes ()
((p_array__ref (mk_p_array__ref (p_array__content us_t)))))
(define-fun p_array__ref___projection ((a p_array__ref)) us_t (p_array__content
                                                              a))
...
(declare-fun aliasing__swap__y () Int)
...
(declare-fun aliasing__swap__x () Int)

(declare-fun o6 () positive)

(declare-fun o7 () Int)

(declare-fun o8 () (Array Int positive))

(declare-fun o9 () positive)

(declare-fun aliasing__swap__y1 () Int)

(declare-fun aliasing__swap__x1 () Int)
...
;; H
  (assert (dynamic_property 0 2147483647 (to_rep1 a__first)
  (to_rep1 a__last)))
...
;; H
  (assert
  (and (in_range1 aliasing__swap__x1) (in_range1 aliasing__swap__y1)))
...
(assert
;; WP_parameter_def
 ;; File "aliasing.adb", line 4, characters 0-0
