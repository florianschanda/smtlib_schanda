...
;; range_axiom
  (assert
  (forall ((x et4)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(declare-fun temp___2956 ((Array Int us_rep2) Int
  us_rep2) (Array Int us_rep2))

;; def_axiom
  (assert
  (forall ((temp___2958 (Array Int us_rep2)))
  (forall ((temp___2959 Int))
  (forall ((temp___2960 us_rep2))
  (let ((temp___2957 (temp___2956 temp___2958 temp___2959 temp___2960)))
  (forall ((temp___2961 Int))
  (ite (= temp___2961 temp___2959)
  (= (select temp___2957 temp___2961) temp___2960)
  (= (select temp___2957 temp___2961) (select temp___2958 temp___2961)))))))))
...
(declare-fun o33 () us_split_fields4)

(declare-fun o34 () us_rep2)
...
(declare-fun o43 () (Array Int us_rep2))

(declare-fun o44 () enum1ta)

(declare-fun o45 () us_split_fields2)

(declare-fun o46 () us_rep1)

(declare-fun o47 () us_split_fields4)

(declare-fun o48 () us_rep2)

(declare-fun o49 () (Array Int us_rep2))
...
(declare-fun a2 () (Array Int us_rep2))
...
(declare-fun a4 () (Array Int us_rep2))

(declare-fun result4 () map__ref)

(declare-fun a5 () (Array Int us_rep2))

(declare-fun a6 () map__ref)

(declare-fun a7 () (Array Int us_rep2))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1370, characters 0-0
  (not
  (= (bool_eq3 (map__content a6) 1 16
     (temp___2956 a i
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1 (of_rep2 e)
     (mk___rep (mk___split_fields (of_rep f) (of_rep1 g))) (of_rep4 h)))
     (of_rep3 d)))) 1 16) true)))
(check-sat)
(exit)
