...
(declare-fun temp___4891 () us_main_type)

(declare-fun temp___491 () us_rep)

(declare-fun temp___486 () us_rep1)
...
(define-fun temp___4892 () us_rep (mk___rep (mk___split_discrs temp___489)
                                  (mk___split_fields temp___4891)))
...
;; H
  ...
  (and
  (and (= l__split_discrs (mk___split_discrs temp___489))
  (= l__split_fields temp___4891))
  (and
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1)))
  (and (< 0 (get (model__ temp___4902) i))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (- 
  (get (model__ temp___491) i) 1)))))
  (and
  (forall ((i Int))
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) i)
  ...
  (ite (= (ite (= (bool_eq3 cu2 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      l__split_discrs
                                                      l__split_fields3)) 
...
;; H
  (assert
  (not
  (= (bool_eq3 (mk___rep1 (us_split_fields__content1 c__split_fields14))
     no_element) true)))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o11 j) true)
  (=> (= (get1 o11 i) (get1 o11 j)) (= (bool_eq3 i j) true))))))))))

(assert
;; WP_parameter_def
 ;; File "for_loops_on_lists.adb", line 16, characters 0-0
  (not
  (= (has_key o11 (mk___rep1 (us_split_fields__content1 c__split_fields14))) true)))
(check-sat)
