...
(declare-const temp___1621 integer)
...
(declare-const temp___1642 Bool)

(declare-const temp___165 Bool)

(declare-const temp___1651 integer)

(declare-const temp___1652 Bool)
...
;; WP_parameter_def
 ;; File "q.ads", line 2, characters 0-0
  (not (= temp___165 (rec__q__t__b y__split_discrs))))
(check-sat)
(exit)
