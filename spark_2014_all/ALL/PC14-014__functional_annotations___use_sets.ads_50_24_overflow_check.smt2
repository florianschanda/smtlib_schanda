...
;; H
  ...
  (and (in_range2 o3)
  (<= o3 (to_rep1
         (rec__use_sets__my_sets__set__capacity (us_split_discrs1 s2)))))))
...
;; H
  ...
  (and (in_range2 o)
  (<= o (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
...
;; H
  ...
  (= o1 (capacity
        (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))))
  (and (in_range2 o1)
  (= o1 (to_rep1 (rec__use_sets__my_sets__set__capacity s1__split_discrs))))))
