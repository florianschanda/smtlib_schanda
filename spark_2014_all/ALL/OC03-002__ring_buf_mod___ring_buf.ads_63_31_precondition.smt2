...
(declare-fun dummy3 () length_type)
...
(declare-fun ring_buf__head__result () Int)

(declare-fun o () (Array (_ BitVec 16) integer))

(declare-fun o1 () t)

(declare-fun result () Int)

(declare-fun ring_buf__head__result1 () Int)

(declare-fun ring_buf__head__result2 () Int)

(declare-fun ring_buf__head__result3 () Int)

(declare-fun ring_buf__head__result4 () Int)

(declare-fun ring_buf__head__result5 () Int)
