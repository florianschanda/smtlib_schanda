...
;; func_head__post_axiom
  (assert
  (forall ((m us_t))
  (! (=> (and (dynamic_invariant m true true true) (< 0 (length m)))
     (dynamic_invariant1 (func_head m) true false true)) :pattern ((func_head
                                                                   m)) )))

;; func_head__def_axiom
  (assert
  (forall ((m us_t))
  (! (=> (dynamic_invariant m true true true)
...
(declare-const ring_buf__head__result Int)

(declare-const o (Array (_ BitVec 16) integer))

(declare-const o1 t)

(declare-const result Int)

(declare-const ring_buf__head__result1 Int)

(declare-const ring_buf__head__result2 Int)

(declare-const ring_buf__head__result3 Int)

(declare-const ring_buf__head__result4 Int)

(declare-const ring_buf__head__result5 Int)

(define-fun o2 () us_t (mk___t o o1))

;; H
  (assert (not (= (is_empty r) true)))

;; H
  (assert (= ring_buf__head__result1 ring_buf__head__result2))

;; H
  (assert (= ring_buf__head__result3 ring_buf__head__result1))

;; H
  (assert (= (mk_int__ref result) (mk_int__ref ring_buf__head__result)))

;; H
  (assert
  (= ring_buf__head__result1 (to_rep
                             (select (rec__ring_buf__ring_buffer__data
                                     (us_split_fields1 r)) (to_rep1
                                                           (rec__ring_buf__ring_buffer__first
                                                           (us_split_fields1
                                                           r)))))))
...
;; H
  (assert
  (= (mk_int__ref ring_buf__head__result4) (mk_int__ref
                                           ring_buf__head__result2)))

;; H
  (assert (= ring_buf__head__result5 ring_buf__head__result3))

;; H
  (assert
  (and (= o2 (to_model r))
  (and (dynamic_invariant o2 true false true)
  (= o2 (ite (< 65535 (- (+ (bv2nat (to_rep1
                                    (rec__ring_buf__ring_buffer__first
                                    (us_split_fields1 r)))) (to_rep2
                                                            (rec__ring_buf__ring_buffer__length
                                                            (us_split_fields1
                                                            r)))) 1))
        (ite (= (length1
                ...
                (mk1
                (to_rep1
                (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))
                ((_ int2bv 16) 65535)))) 0)
        (mk___t (rec__ring_buf__ring_buffer__data (us_split_fields1 r))
        (mk
        (to_rep1
        (first4
        (mk2 ((_ int2bv 16) 0)
        (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2
                                                              (rec__ring_buf__ring_buffer__length
                                                              (us_split_fields1
                                                              r))))) (bvsub ((_ int2bv 16) 65535)
        (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1)))))
        (to_rep1
        (last4
        (mk2 ((_ int2bv 16) 0)
        (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2
        ...
        (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1)))))))
        (mk___t
        (concat1 (rec__ring_buf__ring_buffer__data (us_split_fields1 r))
        (to_rep1
        (first2
        (mk1
        (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))
        ((_ int2bv 16) 65535))))
        (to_rep1
        (last2
        (mk1
        ...
        (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))
        ((_ int2bv 16) 65535))))
        ((_ int2bv 16) (- (+ (bv2nat (to_rep1
                                     (first2
                                     (mk1
                                     (to_rep1
                                     (rec__ring_buf__ring_buffer__first
                                     (us_split_fields1 r)))
                                     ((_ int2bv 16) 65535))))) (+ (ite (<= (bv2nat
                                                                  (to_rep1
                                                                  (first2
                                                                  (mk1
                                                                  (to_rep1
        ...
        (ite (<= (bv2nat (to_rep1
                         (first4
                         (mk2 ((_ int2bv 16) 0)
                         (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16)
                         (to_rep2
                         (rec__ring_buf__ring_buffer__length
                         (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535)
                         (to_rep1
                         (rec__ring_buf__ring_buffer__first
                         (us_split_fields1 r))))) ((_ int2bv 16) 1)))))) (bv2nat
        (to_rep1
        (last4
        (mk2 ((_ int2bv 16) 0)
        (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2
        ...
        (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2
                                                              ...
                                                              (us_split_fields1
                                                              r))))) (bvsub ((_ int2bv 16) 65535)
        (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1))))))) 1)
        0))) 1)))))
        (mk___t (rec__ring_buf__ring_buffer__data (us_split_fields1 r))
        (mk
        (to_rep1
        ...
        (bvsub (bvadd (to_rep1
                      (rec__ring_buf__ring_buffer__first
                      (us_split_fields1 r))) ((_ int2bv 16) (to_rep2
                                                            (rec__ring_buf__ring_buffer__length
                                                            (us_split_fields1
                                                            r))))) ((_ int2bv 16) 1)))))
        (to_rep1
