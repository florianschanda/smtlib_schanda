...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 (- i 1)))
  (= (to_rep (select b2 j1)) (to_rep (select temp___192 j1))))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 i))
  (= (to_rep (select b4 j1)) (to_rep (select b3 j1)))))))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 i))
  (= (to_rep (select o2 j1)) (to_rep (select b3 j1)))))))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 i))
  (= (to_rep (select b5 j1)) (to_rep (select b3 j1)))))))))
