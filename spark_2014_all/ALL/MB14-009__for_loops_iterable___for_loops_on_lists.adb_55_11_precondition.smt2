...
(declare-fun count_03 () Int)

(declare-fun count_12 () Int)

(declare-fun e3 () Int)

(declare-fun temp___5051 () us_rep1)

(declare-fun result6 () int__ref)

(declare-fun count_13 () Int)
...
;; H
  (assert
  (and (= o4 (first l))
  (ite (= (= (length1 l) 0) true) (= (bool_eq1 o4 no_element) true)
  (and (= (has_key (positions l) o4) true) (= (get1 (positions l) o4) 1)))))
...
;; WP_parameter_def
 ;; File "for_loops_on_lists.ads", line 25, characters 0-0
  (not
  (or (= (has_key (positions l) temp___5051) true)
  (= (bool_eq1 temp___5051 no_element) true))))
(check-sat)
(exit)
