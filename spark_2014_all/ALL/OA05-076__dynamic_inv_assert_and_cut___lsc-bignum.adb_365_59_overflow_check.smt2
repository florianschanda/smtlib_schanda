...
(declare-fun o93 () us_rep)

(declare-fun o94 () us_rep)
...
;; H
  (assert
  (and (= o88 (base Tuple0))
  (= o88 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert
  (= o87 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o86)))
...
;; H
  (assert
  (and (= o69 (base Tuple0))
  (= o69 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert (= o68 (num_of_big_int m m_first o67)))

;; H
  (assert (= o70 (inverse o68 o69)))
...
;; H
  (assert (= o62 (num_of_big_int c c_first o61)))
...
;; H
  (assert (= o57 (num_of_big_int b b_first o56)))

;; H
  (assert (= o63 (omultiply o57 o62)))

;; H
  (assert (= o76 (omultiply o63 o75)))
