...
(declare-fun temp___4501 () unsigned_byte)

(declare-fun temp___4502 () unsigned_byte)
...
;; H
  (assert
  (= r__split_fields3 (mk___split_fields1 temp___450
                      (mk___rep (mk___split_fields temp___4501 temp___4502)))))
