...
;; H
  (assert (and (= o (sub RNE1 a11 t21)) (tqtisFinite (sub RNE1 a11 t21))))
...
;; H
  (assert (and (= o1 (add RNE1 a21 t31)) (tqtisFinite (add RNE1 a21 t31))))
...
;; H
  (assert (and (= o2 (sub RNE1 a31 t41)) (tqtisFinite (sub RNE1 a31 t41))))
...
;; H
  (assert (and (= o3 (add RNE1 a41 t51)) (tqtisFinite (add RNE1 a41 t51))))
...
;; H
  (assert (and (= o4 (sub RNE1 a51 t61)) (tqtisFinite (sub RNE1 a51 t61))))
...
;; H
  (assert (and (= o5 (add RNE1 a61 t71)) (tqtisFinite (add RNE1 a61 t71))))
...
;; H
  (assert (and (= o6 (sub RNE1 a71 t81)) (tqtisFinite (sub RNE1 a71 t81))))
...
;; H
  (assert (and (= o7 (add RNE1 a81 t91)) (tqtisFinite (add RNE1 a81 t91))))
...
;; H
  (assert (and (= o8 (sub RNE1 a91 t101)) (tqtisFinite (sub RNE1 a91 t101))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (mul RNE1 a91 a91))))
(check-sat)
