...
(define-fun dynamic_invariant ((temp___expr_4867 us_t1)
  ...
  (temp___do_toplevel_4866 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_4867))
                                       (and (= (first3 temp___expr_4867) 1)
                                       (= (last3 temp___expr_4867) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_4883 us_t2)
  ...
  (temp___do_toplevel_4882 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_4883))
                                       (and (= (first5 temp___expr_4883) 1)
                                       (= (last5 temp___expr_4883) 4)))))
...
(declare-const temp___7806 (Array Int bits_8))

(declare-const temp___78061 t2)
...
;; H
  (assert
  (and (= temp___78062 (register_to_bytes reg)) (dynamic_invariant1
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___78061)) (to_rep (last4 temp___78061)))
     (+ (- (to_rep (last4 temp___78061)) (to_rep (first4 temp___78061))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
