...
(define-fun register_type__ref___114__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___81__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___81__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4939 us_t1)
  (temp___is_init_4936 Bool) (temp___skip_constant_4937 Bool)
  (temp___do_toplevel_4938 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4937 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_4939)
                                       (last3 temp___expr_4939))
                                       (and (= (first3 temp___expr_4939) 1)
                                       (= (last3 temp___expr_4939) 4)))))
...
(define-fun target__ref___34__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___34__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_4955 us_t2)
  (temp___is_init_4952 Bool) (temp___skip_constant_4953 Bool)
  (temp___do_toplevel_4954 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4953 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_4955)
                                       (last5 temp___expr_4955))
                                       (and (= (first5 temp___expr_4955) 1)
                                       (= (last5 temp___expr_4955) 4)))))
...
(declare-const temp___7956 (Array Int bits_8))

(declare-const temp___79561 t2)

(define-fun temp___79562 () us_t2 (mk___t2 temp___7956 temp___79561))
...
;; H
  (assert
  (and (= temp___79562 (register_to_bytes reg)) (dynamic_invariant1
  temp___79562 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___79561)) (to_rep (last4 temp___79561)))
     (+ (- (to_rep (last4 temp___79561)) (to_rep (first4 temp___79561))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
