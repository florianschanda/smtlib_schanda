...
(declare-fun temp___6922 () us_rep2)
...
(declare-fun temp___6926 () us_rep2)
...
;; H
  (assert (= r__split_fields5 (us_split_fields5 temp___6922)))
...
;; H
  (assert (= temp___6926 (mk___rep2 o24)))

;; H
  (assert (= result2 (mk___split_fields__ref2 r__split_fields5)))

;; H
  (assert (= r__split_fields6 (us_split_fields5 temp___6926)))
