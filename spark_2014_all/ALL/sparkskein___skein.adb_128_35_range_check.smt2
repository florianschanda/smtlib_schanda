...
(declare-fun dummy6 () word_count_t)
...
(define-fun bool_eq2 ((a (Array (_ BitVec 64) u64)) (a__first (_ BitVec 64))
  ...
  (b__last (_ BitVec 64))) Bool (ite (and
                                     ...
                                     (= (to_rep3 (select a temp___idx_133))
                                     (to_rep3
...
;; compare_def_lt
  ...
  (! (= (< (compare1 a a_first a_last b b_first b_last) 0)
     ...
     (or (= i a_last)
     (and (bvult i a_last)
     (bvult (to_rep3 (select a (bvadd i #x0000000000000001))) (to_rep3
...
;; compare_def_gt
  ...
  (! (= (< 0 (compare1 a a_first a_last b b_first b_last))
     ...
     (or (= i b_last)
     (and (bvult i b_last)
     (bvugt (to_rep3 (select a (bvadd j #x0000000000000001))) (to_rep3
...
(define-fun dynamic_invariant2 ((temp___expr_470 us_t1)
...
(define-fun dynamic_invariant6 ((temp___expr_458 (_ BitVec 64))
