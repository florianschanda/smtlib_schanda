...
(define-fun us_split_fields_Reserved27__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__evc_ffr_type__reserved a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_92__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_92__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(define-fun register_type__ref_217__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_154__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_154__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6953 us_t1)
  (temp___is_init_6950 Bool) (temp___skip_constant_6951 Bool)
  (temp___do_toplevel_6952 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6951 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6953)
                                       (last3 temp___expr_6953))
                                       (and (= (first3 temp___expr_6953) 1)
                                       (= (last3 temp___expr_6953) 2)))))
