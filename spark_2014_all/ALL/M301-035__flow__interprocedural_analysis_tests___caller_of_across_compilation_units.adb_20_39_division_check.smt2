...
(declare-fun caller_of_across_compilation_units__coprime__result () Bool)

(declare-fun caller_of_across_compilation_units__coprime__L_1__R4b__assume () Int)

(declare-fun caller_of_across_compilation_units__coprime__result1 () Bool)

(declare-fun result () Bool)

(declare-fun result1 () Bool)

(declare-fun caller_of_across_compilation_units__coprime__result2 () Bool)
