...
(declare-fun user_eq5 (bits_13 bits_13) Bool)

(declare-const dummy5 bits_13)

(declare-datatypes ((bits_13__ref 0))
(((mk_bits_13__ref (bits_13__content bits_13)))))
(define-fun bits_13__ref___projection ((a bits_13__ref)) bits_13 (bits_13__content
                                                                 a))

(declare-fun to_rep3 (bits_13) (_ BitVec 16))

(declare-fun of_rep3 ((_ BitVec 16)) bits_13)
...
;; range_axiom
  (assert
  (forall ((x bits_13)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun to_int5 ((x bits_13)) Int (bv2nat (to_rep3 x)))

;; range_int_axiom
  (assert
  (forall ((x bits_13)) (! (in_range_int1
...
(define-fun us_split_fields_Reserved__19__projection ((a us_split_fields)) bits_13
  (rec__dw1000__register_types__aon_cfg1_type__reserved a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___72__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___72__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-datatypes ((aon_cfg1_type__ref 0))
(((mk_aon_cfg1_type__ref (aon_cfg1_type__content us_rep)))))
...
(define-fun register_type__ref___175__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___123__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___123__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6218 us_t1)
  (temp___is_init_6215 Bool) (temp___skip_constant_6216 Bool)
  (temp___do_toplevel_6217 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6216 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6218)
                                       (last3 temp___expr_6218))
                                       (and (= (first3 temp___expr_6218) 1)
                                       (= (last3 temp___expr_6218) 2)))))
...
(define-fun target__ref___53__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___53__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_6237 us_t2)
  (temp___is_init_6234 Bool) (temp___skip_constant_6235 Bool)
  (temp___do_toplevel_6236 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6235 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6237)
                                       (last5 temp___expr_6237))
                                       (and (= (first5 temp___expr_6237) 1)
                                       (= (last5 temp___expr_6237) 2)))))
...
(declare-const temp___8097 (Array Int bits_8))

(declare-const temp___80971 t2)

(declare-const temp___8098 (Array Int bits_8))

(declare-const temp___80981 t1)
...
(define-fun temp___80972 () us_t2 (mk___t2 temp___8097 temp___80971))
...
;; H
  (assert
  (and (= temp___80972 (register_to_bytes reg)) (dynamic_invariant1
  temp___80972 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80971)) (to_rep (last4 temp___80971)))
     (+ (- (to_rep (last4 temp___80971)) (to_rep (first4 temp___80971))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___8097 temp___8098))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80971)) (to_rep (last4 temp___80971)))
  temp___80981))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80981)) (to_rep (last2 temp___80981)))
     (+ (- (to_rep (last2 temp___80981)) (to_rep (first2 temp___80981))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8098 temp___80981)))
