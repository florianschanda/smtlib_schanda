...
(define-fun register_type__ref_175__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_123__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_123__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6108 us_t1)
  (temp___is_init_6105 Bool) (temp___skip_constant_6106 Bool)
  (temp___do_toplevel_6107 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6106 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6108)
                                       (last3 temp___expr_6108))
                                       (and (= (first3 temp___expr_6108) 1)
                                       (= (last3 temp___expr_6108) 2)))))
...
(define-fun target__ref_53__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_53__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6127 us_t2)
  (temp___is_init_6124 Bool) (temp___skip_constant_6125 Bool)
  (temp___do_toplevel_6126 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6125 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6127)
                                       (last5 temp___expr_6127))
                                       (and (= (first5 temp___expr_6127) 1)
                                       (= (last5 temp___expr_6127) 2)))))
...
(declare-fun temp___7947 () (Array Int bits_8))

(declare-fun temp___79471 () t2)

(declare-fun temp___7948 () (Array Int bits_8))

(declare-fun temp___79481 () t1)
...
(define-fun temp___79472 () us_t2 (mk___t2 temp___7947 temp___79471))
...
;; H
  (assert
  (and (= temp___79472 (register_to_bytes reg)) (dynamic_invariant1
  temp___79472 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79471)) (to_rep (last4 temp___79471)))
     (+ (- (to_rep (last4 temp___79471)) (to_rep (first4 temp___79471))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7947 temp___7948))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79471)) (to_rep (last4 temp___79471)))
  temp___79481))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79481)) (to_rep (last2 temp___79481)))
     (+ (- (to_rep (last2 temp___79481)) (to_rep (first2 temp___79481))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7948 temp___79481)))
