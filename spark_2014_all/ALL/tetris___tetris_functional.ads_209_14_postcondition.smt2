...
(define-fun bool_eq1 ((a (Array Int cell)) (a__first Int) (a__last Int)
...
(define-fun bool_eq2 ((a (Array Int (Array Int cell))) (a__first Int)
...
(declare-fun temp___714 () shape)

(declare-fun temp___7141 () direction)

(declare-fun temp___7142 () px_coord)

(declare-fun temp___7143 () py_coord)
...
(define-fun cur_piece__split_fields20 () us_split_fields (mk___split_fields
                                                         cur_piece__split_fields4
                                                         cur_piece__split_fields5
                                                         cur_piece__split_fields6
                                                         cur_piece__split_fields7))

(define-fun temp___7144 () us_rep (mk___rep
                                  (mk___split_fields temp___714 temp___7141
                                  temp___7142 temp___7143)))
...
;; H
  ...
  (and (= success4 (mk_bool__ref success2))
  ...
  (and (= success5 success2)
  (= cur_piece__split_fields16 cur_piece__split_fields19))))
  (and
  (and
  ...
  (and (= temp___714 candidate__split_fields8)
  (and (= temp___7141 candidate__split_fields9)
  (and (= temp___7142 candidate__split_fields10)
  (= temp___7143 candidate__split_fields11))))))
  (and
  (and
  ...
  (= cur_piece__split_fields19 candidate__split_fields16))
  (and (= result10 success) (= success2 (of_int 1))))))))))
  (and
  (and
  (and
  (= result (move_is_possible
  ...
  (= cur_piece__split_fields19 cur_piece__split_fields20))))))
  (and
  (and
  ...
  (= candidate__split_fields12 (mk___split_fields__ref
                               candidate__split_fields16))
  (and (= success4 (mk_bool__ref success3))
  (and (= cur_piece__split_fields12 cur_piece__split_fields8)
  (and (= cur_piece__split_fields13 cur_piece__split_fields9)
  (and (= cur_piece__split_fields14 cur_piece__split_fields10)
  (= cur_piece__split_fields15 cur_piece__split_fields11))))))
  (and (= candidate__split_fields13 candidate__split_fields16)
  (and (= success5 success3)
  (= cur_piece__split_fields16 cur_piece__split_fields19))))
  (and (= result11 success2) (= success3 (of_int 0)))))))
...
;; H
  (assert
  (= cur_piece__split_fields17 (mk___split_fields__ref
                               (mk___split_fields cur_piece__split_fields12
...
;; WP_parameter_def
 ;; File "tetris_functional.ads", line 65, characters 0-0
  (not
  (= (valid_configuration cur_board
     (us_split_fields__content cur_piece__split_fields17) cur_state) true)))
(check-sat)
