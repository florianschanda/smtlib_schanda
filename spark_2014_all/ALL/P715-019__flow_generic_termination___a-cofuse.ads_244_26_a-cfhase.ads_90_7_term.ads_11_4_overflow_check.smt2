...
(((mk___split_fields (rec__term__tset__set us_main_type1)))))
(define-fun us_split_fields_Set__projection ((a us_split_fields)) us_main_type1
...
(define-fun oeq2 ((left1 us_rep2)
  (right1 us_rep2)) Bool (and (= (length3 left1) (length3 right1)) (ite
                                                                   (forall
                                                                   ((n Int))
                                                                   (=>
                                                                   (and
