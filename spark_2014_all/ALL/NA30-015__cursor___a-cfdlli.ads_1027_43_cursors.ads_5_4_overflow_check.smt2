...
(((mk___split_fields (rec__cursors__l__list us_main_type)))))
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep (rec__cursors__l__list__capacity target__split_discrs))))))

;; H
  (assert
  (= o3 (- (to_rep (rec__cursors__l__list__capacity target__split_discrs))
  o2)))
