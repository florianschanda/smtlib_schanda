...
;; H
  (assert
  (= (capacity (mk___rep s__split_discrs s__split_fields4)) (capacity
                                                            (mk___rep
                                                            s__split_discrs
                                                            (mk___split_fields
                                                            s__split_fields)))))
...
;; H
  ...
  (= (get1 (keys (mk___rep s__split_discrs s__split_fields3))
     ...
     (find1 (mk___rep s__split_discrs s__split_fields3) o))) o))
  (= (equal_except (keys (mk___rep s__split_discrs s__split_fields4))
     (keys (mk___rep s__split_discrs s__split_fields3))
     (get2 (positions (mk___rep s__split_discrs s__split_fields3))
     (find1 (mk___rep s__split_discrs s__split_fields3) o))) true))
  ...
  (= (get1 (keys (mk___rep s__split_discrs s__split_fields3))
     (get2 (positions (mk___rep s__split_discrs s__split_fields3))
     (find1 (mk___rep s__split_discrs s__split_fields3) o))) o))
  (= (mapping_preserved (keys (mk___rep s__split_discrs s__split_fields4))
     (keys (mk___rep s__split_discrs s__split_fields3))
     (positions (mk___rep s__split_discrs s__split_fields4))
     (positions (mk___rep s__split_discrs s__split_fields3))) true))
...
;; H
  (assert
  (and
  (= temp___8711 (next (mk___rep s__split_discrs s__split_fields3)
                 (mk___rep1 cu__split_fields4)))
