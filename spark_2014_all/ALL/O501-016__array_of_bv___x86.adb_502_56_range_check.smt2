...
;; readmem8__post_axiom
  ...
  (! (=> (dynamic_invariant addr1 true true true)
     ...
     result true false true)))) :pattern ((readmem8 addr1 x86__memory)) ))))
...
;; readmem32__post_axiom
  ...
  (! (=> (dynamic_invariant addr1 true true true)
     ...
     (readmem16 (bvadd addr1 ((_ int2bv 64) 2)) x86__memory)) ((_ int2bv 32) 16))))
...
;; H
  (assert
  (and
  (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
...
;; H
  (assert
  (and
  (= (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory2) ((_ extract 7 0) (bvand (bvlshr
  val__ ((_ int2bv 64) 8)) ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= i (bvadd addr ((_ int2bv 64) 1))))
  (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))

;; H
  (assert
  (and
  (= (readmem8 (bvadd addr ((_ int2bv 64) 2)) memory3) ((_ extract 7 0) (bvand (bvlshr
  val__ ((_ int2bv 64) 16)) ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= i (bvadd addr ((_ int2bv 64) 2))))
  (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))

;; H
  (assert
  (and
  (= (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory4) ((_ extract 7 0) (bvand (bvlshr
  val__ ((_ int2bv 64) 24)) ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= i (bvadd addr ((_ int2bv 64) 3))))
  (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))))

;; H
  (assert
  (and
  (= (readmem8 (bvadd addr ((_ int2bv 64) 4)) memory5) ((_ extract 7 0) (bvand (bvlshr
  val__ ((_ int2bv 64) 32)) ((_ int2bv 64) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= i (bvadd addr ((_ int2bv 64) 4))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  (not
  (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand (bvlshr val__ ((_ int2bv 64) 40)) ((_ int2bv 64) 255)))))
(check-sat)
(exit)
