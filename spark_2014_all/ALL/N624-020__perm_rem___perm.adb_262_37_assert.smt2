...
;; H
  ...
  (= (let ((temp___157 (remove
                       ...
                       ib1)))
     (let ((temp___156 (remove (remove b ib1)
                       (- (to_rep1
...
;; H
  (assert
  (and
  (= o20 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o19 (remove b ib1))
  (and (dynamic_invariant2 o19 true false true)
  (and (= (invariant__ o19) true)
  (and (= (to_rep2 (last (rt o19))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o19) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o19) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o19) k))))))))))))

;; H
  (assert
  (and (= o21 (remove o19 o20))
  (and (dynamic_invariant2 o21 true false true)
  (and (= (invariant__ o21) true)
  (and (= (to_rep2 (last (rt o21))) (- (to_rep2 (last (rt o19))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o20 1)))
  (= (to_rep (select (elts o19) k)) (to_rep (select (elts o21) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o20 1) k) (<= k (to_rep2 (last (rt o19)))))
  (= (to_rep (select (elts o19) k)) (to_rep (select (elts o21) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o20 k) (<= k (- (to_rep2 (last (rt o19))) 1)))
  (= (to_rep (select (elts o19) (+ k 1))) (to_rep (select (elts o21) k))))))))))))

;; H
  (assert
  (and (= o18 (remove bb ib1))
  (and (dynamic_invariant2 o18 true false true)
  (and (= (invariant__ o18) true)
  (and (= (to_rep2 (last (rt o18))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o18) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o18) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o18) k))))))))))))
...
;; H
  (assert
  (and (= o16 (remove a o15))
  (and (dynamic_invariant2 o16 true false true)
  (and (= (invariant__ o16) true)
  (and (= (to_rep2 (last (rt o16))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o15 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o16) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o15 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o16) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o15 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o16) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o17))) (- (to_rep2 (last (rt o16))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o16) k)) (to_rep (select (elts o17) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o16)))))
  (= (to_rep (select (elts o16) k)) (to_rep (select (elts o17) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o16))) 1)))
  (= (to_rep (select (elts o16) (+ k 1))) (to_rep (select (elts o17) k))))))))))))

;; H
  (assert
  (and (= o22 (shift_perm_r o17 o18 o21))
  (and (in_range3 o22) (=> (= (of_int o22) true) (= (is_perm o17 o21) true)))))
