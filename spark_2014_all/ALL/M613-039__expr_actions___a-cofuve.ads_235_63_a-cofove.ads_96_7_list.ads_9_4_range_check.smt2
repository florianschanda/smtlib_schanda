...
(define-fun dynamic_invariant ((temp___expr_278 Int)
...
(define-fun default_initial_assumption ((temp___expr_297 us_rep)
  (temp___skip_top_level_298 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_298 true))
                                         (= (length temp___expr_297) 0)))
