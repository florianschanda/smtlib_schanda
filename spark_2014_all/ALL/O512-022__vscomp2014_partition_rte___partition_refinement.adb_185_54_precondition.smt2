...
;; H
  ...
  (= (has_key1
     (positions1
     (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true)
  (= (to_rep
     (select a (element1
               (mk___rep3 d__split_discrs
               (mk___split_fields3 d__split_fields)) c1))) (key
                                                           (mk___rep3
                                                           d__split_discrs
                                                           (mk___split_fields3
                                                           d__split_fields))
...
;; H
  ...
  (= (capacity (mk___rep5 p__split_discrs p__split_fields1)) (capacity
                                                             ...
                                                             p__split_fields))))
  (and
  (= (length2 (mk___rep5 p__split_discrs p__split_fields1)) (length2
                                                            (mk___rep5
                                                            p__split_discrs
                                                            (mk___split_fields5
                                                            p__split_fields))))
  ...
  (forall ((c1 us_rep4))
  (=>
  (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c1) true)
  (= (to_rep
     (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c1)))
  (key (mk___rep3 d__split_discrs d__split_fields1) c1))))
  (= (oeq2
     (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)))
     (keys (mk___rep3 d__split_discrs d__split_fields1))) true)))))))
...
;; H
  ...
  (forall ((c1 us_rep4))
  (=>
  (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c1) true)
  (= (to_rep
     (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c1)))
  (key (mk___rep3 d__split_discrs d__split_fields2) c1)))))
...
;; H
  (assert
  (and
  (= o3 (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2))
        c))
  (= (= o3 true)
...
;; H
  (assert
  (and (= o5 (key (mk___rep3 d__split_discrs d__split_fields2) c))
  (and (in_range8 o5)
  (= o5 (get2 (keys (mk___rep3 d__split_discrs d__split_fields2))
        (get3 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c))))))
