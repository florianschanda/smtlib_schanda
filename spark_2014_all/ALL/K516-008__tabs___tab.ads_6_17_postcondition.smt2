...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (and (<= temp___155 cur2) (<= cur2 (prev i2)))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (< threshold (to_rep (select b i2))) (= cur2 result2))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (< threshold (to_rep (select b i2))) (= cur3 o))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (< threshold (to_rep (select b i2))) (= o2 cur3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (< threshold (to_rep (select b i2))) (= o3 (store a2 o2 o1)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (< threshold (to_rep (select b i2))) (= a2 result3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (< threshold (to_rep (select b i2))) (= a3 o3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (not (< threshold (to_rep (select b i2)))) (= cur3 cur2))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (=> (not (< threshold (to_rep (select b i2)))) (= a3 a2))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref cur6) (mk_int__ref cur4))))
...
;; WP_parameter_def
 ;; File "tab.adb", line 6, characters 0-0
  ...
  (exists ((k Int))
  (and (and (<= 1 k) (<= k 10))
  (= (to_rep (select a8 k)) (to_rep (select b j)))))))
(check-sat)
