...
(define-fun o32 () us_rep (mk___rep (mk___split_discrs o18)
                          (mk___split_fields o19 o20 o21 o22)))

(define-fun o33 () us_rep (mk___rep (mk___split_discrs o13)
...
;; H
  (assert
  (= o33 (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs conv__p__x__assume)
     ...
     conv__p__x__assume3 conv__p__x__assume4)) o32))
...
;; WP_parameter_def
 ;; File "conv.adb", line 5, characters 0-0
  (not (= 0 (to_rep1 (rec__basic__r__x (us_split_discrs1 o31))))))
(check-sat)
(exit)
