...
(declare-datatypes ()
((tT98bP1__ref (mk_tT98bP1__ref (tT98bP1__content tdigit_count_typeB)))))
(define-fun tT98bP1__ref___projection ((a tT98bP1__ref)) tdigit_count_typeB
  (tT98bP1__content a))
...
(declare-datatypes ()
((t99b__ref (mk_t99b__ref (t99b__content tdigit_count_typeB)))))
(define-fun t99b__ref___projection ((a t99b__ref)) tdigit_count_typeB
  (t99b__content a))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___1032 (mk___rep1 result____split_discrs result____split_fields3))))
...
;; H
  (assert (= o25 (takelsb_from16 (t__content1 carry6))))
