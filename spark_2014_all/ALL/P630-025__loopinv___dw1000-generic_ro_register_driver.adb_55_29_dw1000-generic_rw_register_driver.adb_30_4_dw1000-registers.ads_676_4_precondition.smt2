...
(define-fun register_type__ref___238__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___170__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___170__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7573 us_t1)
  (temp___is_init_7570 Bool) (temp___skip_constant_7571 Bool)
  (temp___do_toplevel_7572 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7571 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_7573)
                                       (last3 temp___expr_7573))
                                       (and (= (first3 temp___expr_7573) 1)
                                       (= (last3 temp___expr_7573) 2)))))
