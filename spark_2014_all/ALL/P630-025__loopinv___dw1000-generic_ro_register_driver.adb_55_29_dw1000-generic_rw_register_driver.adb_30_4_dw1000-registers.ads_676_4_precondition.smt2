...
(define-fun register_type__ref_238__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_170__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_170__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7431 us_t1)
  (temp___is_init_7428 Bool) (temp___skip_constant_7429 Bool)
  (temp___do_toplevel_7430 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7429 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_7431)
                                       (last3 temp___expr_7431))
                                       (and (= (first3 temp___expr_7431) 1)
                                       (= (last3 temp___expr_7431) 2)))))
