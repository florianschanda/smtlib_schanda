...
(declare-fun m () duration)

(declare-fun o () duration)

(declare-fun o1 () my_duration)

(declare-fun o2 () Int)

(declare-fun result () duration)

(declare-fun m1 () duration)
...
;; H
  (assert (= (to_fixed1 o1) (to_fixed m1)))

;; H
  (assert (= o2 (to_fixed1 o1)))

(assert
;; WP_parameter_def
 ;; File "fxp_false_check_3.adb", line 3, characters 0-0
  (not (in_range2 o2)))
(check-sat)
(exit)
