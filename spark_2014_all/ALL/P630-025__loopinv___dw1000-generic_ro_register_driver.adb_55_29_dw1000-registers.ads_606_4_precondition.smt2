...
(declare-fun dw1000__register_types__evc_fcg_type__evc_fcg__first__bit () Int)

(declare-fun dw1000__register_types__evc_fcg_type__evc_fcg__last__bit () Int)

(declare-fun dw1000__register_types__evc_fcg_type__evc_fcg__position () Int)
...
(declare-fun dw1000__register_types__evc_fcg_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__evc_fcg_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__evc_fcg_type__reserved__position () Int)
...
(declare-datatypes ()
((evc_fcg_type__ref (mk_evc_fcg_type__ref (evc_fcg_type__content us_rep)))))
