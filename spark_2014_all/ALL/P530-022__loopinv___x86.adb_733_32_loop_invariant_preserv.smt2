...
(declare-fun mem2 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun result3 () (Array (_ BitVec 64) unsigned8))

(declare-fun mem3 () (Array (_ BitVec 64) unsigned8))
...
;; H
  ...
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= (inrange64 i rdi (bvmul rcx ((_ int2bv 64) 8))) true))
  (= (to_rep (select memory i)) (to_rep (select memory2 i)))))))
...
;; H
  (assert
  (= (readmem64 (bvadd rdi (bvmul (bvsub rcx rcx1) ((_ int2bv 64) 8)))
     memory2) rax))

;; H
  (assert
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx rcx1)))
  (= (readmem64 (bvadd rdi (bvmul i ((_ int2bv 64) 8))) memory2) rax))))
...
;; H
  (assert
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx rcx2)))
  (=> (not (= i (bvsub rcx rcx2)))
  (= (readmem64 (bvadd rdi (bvmul i ((_ int2bv 64) 8))) memory2) rax)))))
...
;; H
  (assert
  (and (= (hasmem64 memory3 rdi2 rax) true)
  (= (nooverlap8equal memory3 memory2 rdi2) true)))

;; H
  (assert
  (forall ((i (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx2)))
  (=> (not (= i (bvsub rcx_start rcx2)))
  (= (hasmem64 mem3 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) rax) true)))))
...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx2)))
  (=> (not (= i (bvsub rcx_start rcx2)))
  (= (readmem64 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) memory3)
  rax)))))

;; H
  (assert
  (= (readmem64
     (bvadd rdi_start (bvmul (bvsub rcx_start rcx2) ((_ int2bv 64) 8)))
     memory3) rax))
