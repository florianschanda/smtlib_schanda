...
;; H
  ...
  (=> (<= 3 x)
  (=> (<= 3 y)
  (and (= o9 (one_free_slot 3 3 my_board))
  (and (in_range o9)
  (= o9 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))
...
;; H
  ...
  (=> (<= 3 x)
  (=> (<= 2 y)
  (and (= o6 (one_free_slot 3 2 my_board))
  (and (in_range o6)
  (= o6 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))
...
;; H
  (assert
  (=> (<= 3 x)
  (and (= o7 (one_free_slot 3 1 my_board))
  (and (in_range o7)
  (= o7 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0))))))
