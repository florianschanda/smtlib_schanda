...
;; H
  ...
  (= (length1 (mk___rep l__split_discrs l__split_fields4)) (- (length1
                                                              ...
                                                              l__split_fields))) 1)))
  (not
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields4))
  ...
  (= (range_equal
     (elements
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (elements (mk___rep l__split_discrs l__split_fields4)) 1
     (- (get
        (positions
        (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
        (mk___rep1 (mk___split_fields1 cu__split_fields))) 1)) true))
  (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields4))
     (elements
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (get
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 (mk___split_fields1 cu__split_fields)))
     (length1 (mk___rep l__split_discrs l__split_fields4)) 1) true))
  (= (p_positions_shifted
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields3)) e1) true)
  ...
  (= (equivalent_elements
     ...
     (mk___rep1 cu__split_fields3)) e1) true))
  (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields3))
     e1
     (get (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 cu__split_fields3))) true))
  (ite (= (contains (model__ (mk___rep l__split_discrs l__split_fields4)) e1) true)
  (and
  (and
  (and (not (= i true))
  (= (oeq4 (model__ (mk___rep l__split_discrs l__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields4))) true))
  (= (oeq3 (elements (mk___rep l__split_discrs l__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields4))) true))
  (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields3))
  ...
  (and
  (and (= i true)
  (= (length1 (mk___rep l__split_discrs l__split_fields3)) (+ (length1
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields4)) 1)))
  (= (element (mk___rep l__split_discrs l__split_fields3)
     (mk___rep1 cu__split_fields3)) e1))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields4))
     (model__ (mk___rep l__split_discrs l__split_fields3))) true))
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields4)) e1) true))
  (= (range_equal (elements (mk___rep l__split_discrs l__split_fields4))
     (elements (mk___rep l__split_discrs l__split_fields3)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields3))
        (mk___rep1 cu__split_fields3)) 1)) true))
  (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields4))
