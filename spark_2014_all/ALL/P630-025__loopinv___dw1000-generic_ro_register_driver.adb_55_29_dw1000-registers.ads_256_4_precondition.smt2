...
(declare-fun dummy7 () bits_19)

(declare-datatypes ()
((bits_19__ref (mk_bits_19__ref (bits_19__content bits_19)))))
(define-fun bits_19__ref___projection ((a bits_19__ref)) bits_19 (bits_19__content
                                                                 a))
...
;; range_axiom
  (assert
  (forall ((x bits_19)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))

;; coerce_axiom
  (assert
  (forall ((x (_ BitVec 32)))
  (! (let ((y (bvurem x ((_ int2bv 32) 524288))))
...
;; range_int_axiom
  (assert
  (forall ((x bits_19)) (! (in_range_int3
  (to_int8 x)) :pattern ((to_int8 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__rx_ttcko_type__rxtofs bits_19)(rec__dw1000__register_types__rx_ttcko_type__rsmpdel bits_8)(rec__dw1000__register_types__rx_ttcko_type__rcphase bits_7)(rec__dw1000__register_types__rx_ttcko_type__reserved_1 bits_5)(rec__dw1000__register_types__rx_ttcko_type__reserved_2 bits_1)))))
(define-fun us_split_fields_RXTOFS__projection ((a us_split_fields)) bits_19
  (rec__dw1000__register_types__rx_ttcko_type__rxtofs a))

(define-fun us_split_fields_RSMPDEL__projection ((a us_split_fields)) bits_8
  (rec__dw1000__register_types__rx_ttcko_type__rsmpdel a))

(define-fun us_split_fields_RCPHASE__projection ((a us_split_fields)) bits_7
  (rec__dw1000__register_types__rx_ttcko_type__rcphase a))

(define-fun us_split_fields_Reserved_15__projection ((a us_split_fields)) bits_5
  (rec__dw1000__register_types__rx_ttcko_type__reserved_1 a))

(define-fun us_split_fields_Reserved_25__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__rx_ttcko_type__reserved_2 a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_17__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (and
                        (= (to_rep5
                           (rec__dw1000__register_types__rx_ttcko_type__rxtofs
                           (us_split_fields1 a))) (to_rep5
                                                  (rec__dw1000__register_types__rx_ttcko_type__rxtofs
                                                  (us_split_fields1 b))))
                        (= (to_rep1
                           (rec__dw1000__register_types__rx_ttcko_type__rsmpdel
                           (us_split_fields1 a))) (to_rep1
                                                  (rec__dw1000__register_types__rx_ttcko_type__rsmpdel
                                                  (us_split_fields1 b)))))
                        (= (to_rep4
                           (rec__dw1000__register_types__rx_ttcko_type__rcphase
                           (us_split_fields1 a))) (to_rep4
                                                  (rec__dw1000__register_types__rx_ttcko_type__rcphase
                                                  (us_split_fields1 b)))))
                        (= (to_rep3
                           (rec__dw1000__register_types__rx_ttcko_type__reserved_1
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__rx_ttcko_type__reserved_1
                                                  (us_split_fields1 b)))))
                        (= (to_rep2
                           (rec__dw1000__register_types__rx_ttcko_type__reserved_2
...
(declare-fun dw1000__register_types__rx_ttcko_type__rxtofs__first__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__rxtofs__last__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__rxtofs__position () Int)

;; dw1000__register_types__rx_ttcko_type__rxtofs__first__bit_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcko_type__rxtofs__first__bit))

;; dw1000__register_types__rx_ttcko_type__rxtofs__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_ttcko_type__rxtofs__first__bit dw1000__register_types__rx_ttcko_type__rxtofs__last__bit))

;; dw1000__register_types__rx_ttcko_type__rxtofs__position_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcko_type__rxtofs__position))

(declare-fun dw1000__register_types__rx_ttcko_type__rsmpdel__first__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__rsmpdel__last__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__rsmpdel__position () Int)

;; dw1000__register_types__rx_ttcko_type__rsmpdel__first__bit_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcko_type__rsmpdel__first__bit))

;; dw1000__register_types__rx_ttcko_type__rsmpdel__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_ttcko_type__rsmpdel__first__bit dw1000__register_types__rx_ttcko_type__rsmpdel__last__bit))

;; dw1000__register_types__rx_ttcko_type__rsmpdel__position_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcko_type__rsmpdel__position))

(declare-fun dw1000__register_types__rx_ttcko_type__rcphase__first__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__rcphase__last__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__rcphase__position () Int)

;; dw1000__register_types__rx_ttcko_type__rcphase__first__bit_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcko_type__rcphase__first__bit))

;; dw1000__register_types__rx_ttcko_type__rcphase__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_ttcko_type__rcphase__first__bit dw1000__register_types__rx_ttcko_type__rcphase__last__bit))

;; dw1000__register_types__rx_ttcko_type__rcphase__position_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcko_type__rcphase__position))

(declare-fun dw1000__register_types__rx_ttcko_type__reserved_1__first__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__reserved_1__last__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__reserved_1__position () Int)

;; dw1000__register_types__rx_ttcko_type__reserved_1__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rx_ttcko_type__reserved_1__first__bit))

;; dw1000__register_types__rx_ttcko_type__reserved_1__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_ttcko_type__reserved_1__first__bit dw1000__register_types__rx_ttcko_type__reserved_1__last__bit))

;; dw1000__register_types__rx_ttcko_type__reserved_1__position_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcko_type__reserved_1__position))

(declare-fun dw1000__register_types__rx_ttcko_type__reserved_2__first__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__reserved_2__last__bit () Int)

(declare-fun dw1000__register_types__rx_ttcko_type__reserved_2__position () Int)

;; dw1000__register_types__rx_ttcko_type__reserved_2__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rx_ttcko_type__reserved_2__first__bit))

;; dw1000__register_types__rx_ttcko_type__reserved_2__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_ttcko_type__reserved_2__first__bit dw1000__register_types__rx_ttcko_type__reserved_2__last__bit))

;; dw1000__register_types__rx_ttcko_type__reserved_2__position_axiom
...
(declare-datatypes ()
((rx_ttcko_type__ref (mk_rx_ttcko_type__ref (rx_ttcko_type__content us_rep)))))
(define-fun rx_ttcko_type__ref___projection ((a rx_ttcko_type__ref)) us_rep
  (rx_ttcko_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_35__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_26__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_26__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2918 us_t1)
  (temp___is_init_2915 Bool) (temp___skip_constant_2916 Bool)
  (temp___do_toplevel_2917 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2916 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2918)
                                       (last3 temp___expr_2918))
                                       (and (= (first3 temp___expr_2918) 1)
                                       (= (last3 temp___expr_2918) 5)))))
