...
(declare-fun o56 () (Array (_ BitVec 8) us_rep1))
...
(declare-fun result6 () receiver_type__ref)

(declare-fun self__8 () us_rep2)
...
;; H
  (assert (= o59 temp___45734))

;; H
  (assert
  (= o32 (store (rec__decadriver__receiver_type__frame_queue
                (us_split_fields5 self__5)) next_idx1 o59)))
...
;; H
  (assert (dynamic_predicate temp___4581))

;; H
  (assert (= o55 temp___4581))

;; H
  (assert
  (= o56 (store (rec__decadriver__receiver_type__frame_queue
                (us_split_fields5 self__7)) next_idx1 o55)))

;; H
  (assert
  (= o57 (mk___split_fields2 o56
         (rec__decadriver__receiver_type__queue_head
         (us_split_fields5 self__7))
         (rec__decadriver__receiver_type__rx_count
         (us_split_fields5 self__7))
         (rec__decadriver__receiver_type__overrun_occurred
         (us_split_fields5 self__7))
...
;; H
  (assert (= o58 (mk___rep2 o57)))

;; H
  (assert (= result6 (mk_receiver_type__ref self__7)))
...
;; WP_parameter_def
 ;; File "decadriver.ads", line 77, characters 0-0
  ...
  (us_split_fields3
  (select (rec__decadriver__receiver_type__frame_queue
          (us_split_fields5 self__8)) next_idx1)))
  (rec__decadriver__rx_frame_type__frame
  (us_split_fields3
  (select (rec__decadriver__receiver_type__frame_queue
          (us_split_fields5 self__8)) next_idx1)))
