...
(declare-fun dummy1 () (Array Int cell))
...
;; range_axiom
  (assert
  (forall ((x px_coord)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x py_coord)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
((us_split_fields
 (mk___split_fields
 (rec__tetris_functional__piece__s shape)(rec__tetris_functional__piece__d direction)(rec__tetris_functional__piece__x px_coord)(rec__tetris_functional__piece__y py_coord)))))
(define-fun us_split_fields_S__projection ((a us_split_fields)) shape
  (rec__tetris_functional__piece__s a))

(define-fun us_split_fields_D__projection ((a us_split_fields)) direction
  (rec__tetris_functional__piece__d a))

(define-fun us_split_fields_X__projection ((a us_split_fields)) px_coord
  (rec__tetris_functional__piece__x a))

(define-fun us_split_fields_Y__projection ((a us_split_fields)) py_coord
  (rec__tetris_functional__piece__y a))
  ...
  (b us_rep)) Bool (ite (and
                        ...
                        (= (to_rep4
                           ...
                           (us_split_fields1 a))) (to_rep4
                                                  ...
                                                  (us_split_fields1 b)))))
                        (= (to_rep2
                           (rec__tetris_functional__piece__x
...
(declare-fun tetris_functional__piece__s__first__bit () Int)

(declare-fun tetris_functional__piece__s__last__bit () Int)

(declare-fun tetris_functional__piece__s__position () Int)

;; tetris_functional__piece__s__first__bit_axiom
  (assert (<= 0 tetris_functional__piece__s__first__bit))

;; tetris_functional__piece__s__last__bit_axiom
  (assert
  (< tetris_functional__piece__s__first__bit tetris_functional__piece__s__last__bit))

;; tetris_functional__piece__s__position_axiom
  (assert (<= 0 tetris_functional__piece__s__position))

(declare-fun tetris_functional__piece__d__first__bit () Int)

(declare-fun tetris_functional__piece__d__last__bit () Int)

(declare-fun tetris_functional__piece__d__position () Int)

;; tetris_functional__piece__d__first__bit_axiom
  (assert (<= 0 tetris_functional__piece__d__first__bit))

;; tetris_functional__piece__d__last__bit_axiom
  (assert
  (< tetris_functional__piece__d__first__bit tetris_functional__piece__d__last__bit))

;; tetris_functional__piece__d__position_axiom
  (assert (<= 0 tetris_functional__piece__d__position))

(declare-fun tetris_functional__piece__x__first__bit () Int)

(declare-fun tetris_functional__piece__x__last__bit () Int)

(declare-fun tetris_functional__piece__x__position () Int)

;; tetris_functional__piece__x__first__bit_axiom
  (assert (<= 0 tetris_functional__piece__x__first__bit))

;; tetris_functional__piece__x__last__bit_axiom
  (assert
  (< tetris_functional__piece__x__first__bit tetris_functional__piece__x__last__bit))

;; tetris_functional__piece__x__position_axiom
  (assert (<= 0 tetris_functional__piece__x__position))

(declare-fun tetris_functional__piece__y__first__bit () Int)

(declare-fun tetris_functional__piece__y__last__bit () Int)

(declare-fun tetris_functional__piece__y__position () Int)

;; tetris_functional__piece__y__first__bit_axiom
  (assert (<= 0 tetris_functional__piece__y__first__bit))

;; tetris_functional__piece__y__last__bit_axiom
  (assert
  (< tetris_functional__piece__y__first__bit tetris_functional__piece__y__last__bit))
...
;; no_overlap__def_axiom
  ...
  (! (= (= (no_overlap b p) true)
     ...
     (= (is_empty b
        ...
        (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p)))) true)
     (= (is_empty b
        (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p)))
        (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) true))
     (= (is_empty b
     ...
     (= (is_empty b
        ...
        (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1)) true))
     (ite (= (to_rep1
             (rec__tetris_functional__piece__s (us_split_fields1 p))) 1)
     (forall ((y Int))
     (=> (and (<= 0 y) (<= y 3))
     (forall ((x Int))
     (=> (and (<= 0 x) (<= x 3))
...
;; valid_configuration__def_axiom
  ...
  (! (=
     ...
     (ite (or (= tetris_functional__cur_state 0)
          (= tetris_functional__cur_state 1))
...
;; move_is_possible__def_axiom
  ...
  (! (= (= (move_is_possible p a) true)
     ...
     (+ (to_rep2 (rec__tetris_functional__piece__x (us_split_fields1 p))) 1))
     (=> (= a 2) (in_range4
     (+ (to_rep3 (rec__tetris_functional__piece__y (us_split_fields1 p))) 1)))))) :pattern (
...
;; move__def_axiom
  ...
  (! (=> (dynamic_invariant1 a true true true)
     (= (move p a) (ite (= a 0)
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__tetris_functional__piece__s usq_)
                   (rec__tetris_functional__piece__d usq_)
                   (of_rep2
                   (- (to_rep2
                      (rec__tetris_functional__piece__x (us_split_fields1 p))) 1))
                   (rec__tetris_functional__piece__y usq_))))
                   (ite (= a 1)
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__tetris_functional__piece__s usq_)
                   ...
                   (mk___split_fields (rec__tetris_functional__piece__s usq_)
                   (rec__tetris_functional__piece__d usq_)
                   (rec__tetris_functional__piece__x usq_)
                   (of_rep3
                   (+ (to_rep3
                      (rec__tetris_functional__piece__y (us_split_fields1 p))) 1)))))
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__tetris_functional__piece__s usq_)
                   (of_rep4
                   (turn_direction
                   (to_rep4
                   (rec__tetris_functional__piece__d (us_split_fields1 p)))
                   a)) (rec__tetris_functional__piece__x usq_)
                   (rec__tetris_functional__piece__y usq_))))))))) :pattern (
  (move p a)) ))))
...
(define-fun dynamic_invariant4 ((temp___expr_520 Int)
...
(define-fun x_coord__ref___projection ((a1 x_coord__ref)) x_coord (x_coord__content
                                                                  a1))

(define-fun dynamic_invariant5 ((temp___expr_532 Int)
  (temp___is_init_529 Bool) (temp___skip_constant_530 Bool)
  (temp___do_toplevel_531 Bool)) Bool (=>
                                      (or (= temp___is_init_529 true)
                                      (<= 1 10)) (in_range9 temp___expr_532)))

(declare-sort y_coord 0)

(define-fun in_range10 ((x Int)) Bool (and (<= 1 x) (<= x 50)))
...
(declare-fun dummy13 () y_coord)

(declare-datatypes ()
((y_coord__ref (mk_y_coord__ref (y_coord__content y_coord)))))
(define-fun y_coord__ref___projection ((a1 y_coord__ref)) y_coord (y_coord__content
                                                                  a1))

(define-fun dynamic_invariant6 ((temp___expr_538 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_577 Int)
  ...
  (temp___do_toplevel_576 Bool)) Bool (=>
                                      ...
                                      (<= 0 3)) (in_range5 temp___expr_577)))

(declare-fun tetris_functional__possible_i_shapes__aggregate_def (map1 map1
  map1 map1) (Array Int map1))

;; def_axiom
  (assert
  (forall ((temp___138 map1) (temp___139 map1) (temp___140 map1)
  (temp___141 map1))
  (let ((temp___137 (tetris_functional__possible_i_shapes__aggregate_def
                    temp___138 temp___139 temp___140 temp___141)))
  (and
  (and
...
;; possible_i_shapes__def_axiom
  (assert
  (= possible_i_shapes (tetris_functional__possible_i_shapes__aggregate_def
...
(declare-fun tetris_functional__possible_three_shapes__aggregate_def (map1
  map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1 map1
  map1 map1 map1 map1) map2)
...
;; def_axiom
  ...
  (temp___245 map1))
  (let ((temp___225 (tetris_functional__possible_three_shapes__aggregate_def
...
;; possible_three_shapes__def_axiom
  (assert
  (= possible_three_shapes (tetris_functional__possible_three_shapes__aggregate_def
...
(declare-fun dummy14 () turn_action)

(declare-datatypes ()
((turn_action__ref (mk_turn_action__ref (turn_action__content turn_action)))))
(define-fun turn_action__ref___projection ((a1 turn_action__ref)) turn_action
  (turn_action__content a1))

(define-fun dynamic_invariant10 ((temp___expr_671 Int)
  (temp___is_init_668 Bool) (temp___skip_constant_669 Bool)
  (temp___do_toplevel_670 Bool)) Bool (=>
                                      (or (= temp___is_init_668 true)
                                      (<= 3 4)) (in_range11 temp___expr_671)))

;; turn_direction__post_axiom
  (assert
  (forall ((d Int) (t Int))
  (! (=>
     (and (dynamic_invariant9 d true true true) (dynamic_invariant10 t true
     true true)) (dynamic_invariant9 (turn_direction d t) true false true)) :pattern (
  (turn_direction d t)) )))
...
;; H
  ...
  (= (valid_configuration cur_board
     ...
     cur_piece__split_fields2 cur_piece__split_fields3) cur_state) true))

;; H
  (assert
  (and
  (= result (move_is_possible
            (mk___rep
            (mk___split_fields cur_piece__split_fields
            cur_piece__split_fields1 cur_piece__split_fields2
            cur_piece__split_fields3)) a))
  (= (= result true)
  (ite (= a 0) (in_range3 (- (to_rep2 cur_piece__split_fields2) 1))
  (ite (= a 1) (in_range3 (+ (to_rep2 cur_piece__split_fields2) 1))
  (=> (= a 2) (in_range4 (+ (to_rep3 cur_piece__split_fields3) 1))))))))
...
(assert
;; WP_parameter_def
 ;; File "tetris_functional.ads", line 65, characters 0-0
  (not
  (= (move_is_possible
     (mk___rep
     (mk___split_fields cur_piece__split_fields cur_piece__split_fields1
     cur_piece__split_fields2 cur_piece__split_fields3)) a) true)))
(check-sat)
(exit)
