...
;; H
  ...
  (and (<= (to_rep1 (first (rt s2))) from2)
  (<= from2 (to_rep1 (last (rt s2))))))
  (and (<= (to_rep1 (first (rt s2))) (- (+ from2 n) 1))
  (<= (- (+ from2 n) 1) (to_rep1 (last (rt s2))))))))

(assert
;; WP_parameter_def
 ;; File "helpers.ads", line 12, characters 0-0
  (not
