...
;; H
  (assert
  (and (= o16 (shift_perm_l o42 o41 o39))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o39 o41) true)))))
...
;; H
  (assert
  (and (= o31 (shift_perm_r o37 o36 o34))
  (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o37 o34) true)))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o33))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o33) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o33) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o33) k))))))))))))
