...
;; H
  (assert
  (and (= o31 (+ x (int__content lcp__result4))) (in_range1
...
;; H
  (assert
  (and (= o26 (+ (to_rep (last (rt a))) 1)) (in_range1
  (+ (to_rep (last (rt a))) 1))))

;; H
  (assert
  (and (= o27 (+ x (int__content lcp__result4))) (in_range1
  (+ x (int__content lcp__result4)))))
...
;; H
  (assert
  (=> (not (= result14 true)) (= result13 (ite (= o25 o24) true false))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1 (+ y (int__content lcp__result4)))))
(check-sat)
(exit)
