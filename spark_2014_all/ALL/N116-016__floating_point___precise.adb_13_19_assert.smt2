...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 4000000059604644775390625.0 10000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 1039999008178710937500.0 100000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 1040001010894775390625.0 100000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral6) (/ 959998989105224609375.0 100000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral7) (/ 960000991821289062500.0 100000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral8) (/ 33999900817871093750000.0 10000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral9) (/ 4000010013580322265625.0 1000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral10) (/ 249999904632568359375.0 10000000000000000000.0))))
...
;; H
  (assert (and (le fliteral4 z1) (le z1 fliteral5)))

;; H
  (assert (and (= o1 (sub RNE1 x1 y1)) (tqtisFinite (sub RNE1 x1 y1))))
...
;; H
  (assert (and (le fliteral6 z2) (le z2 fliteral7)))

;; H
  (assert (and (= o2 (mul RNE1 x1 y1)) (tqtisFinite (mul RNE1 x1 y1))))
...
;; H
  (assert (and (le fliteral8 z3) (le z3 fliteral9)))

;; H
  (assert (and (= o3 (div1 RNE1 x1 y1)) (tqtisFinite (div1 RNE1 x1 y1))))
