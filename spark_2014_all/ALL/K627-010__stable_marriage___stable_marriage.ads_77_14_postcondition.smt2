...
(declare-const stable_marriage__is_preferred_1__result Bool)
...
(declare-const stable_marriage__is_preferred_1__result1 Bool)

(declare-const stable_marriage__is_preferred_1__result2 Bool)

(declare-const stable_marriage__is_preferred_1__result3 Bool)

(declare-const inverted2 (Array Int ranking))

(declare-const stable_marriage__is_preferred_1__result4 Bool)

(declare-const inverted3 (Array Int ranking))

(declare-const stable_marriage__is_preferred_1__result5 Bool)
