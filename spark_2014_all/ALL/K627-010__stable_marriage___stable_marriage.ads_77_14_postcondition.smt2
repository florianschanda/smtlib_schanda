...
;; inversion_axiom
  (assert
  (forall ((x ranking)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)) )))

;; range_axiom
  (assert
  (forall ((x ranking)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-fun to_rep1 (group1_id) Int)
...
;; is_permutation_1__post_axiom
  ...
  (! (= (= (is_permutation_1 r1) true)
     ...
     (=> (and (<= 1 g1) (<= g1 64))
     (exists ((rank Int))
     (and (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select r1 rank)) g1)))))) :pattern (
  (is_permutation_1 r1)) )))
...
(define-fun bool_eq1 ((a (Array Int ranking)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep (select a temp___idx_136)) (to_rep
...
;; invert_1__post_axiom
  ...
  (! (=> (= (is_permutation_1 r1) true)
     ...
     (forall ((rank Int))
     (=> (and (<= 1 rank) (<= rank 64))
     (= (to_rep (select result (to_rep1 (select r1 rank)))) rank)))
     (forall ((g1 Int))
     (=> (and (<= 1 g1) (<= g1 64))
     (= (to_rep1 (select r1 (to_rep (select result g1)))) g1)))))) :pattern (
  (invert_1 r1)) )))

(declare-fun g1_a () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun g1_b () Int)
...
(declare-fun inverted () (Array Int ranking))

(declare-fun stable_marriage__is_preferred_1__result () Bool)

(declare-fun o () (Array Int ranking))

(declare-fun result () (Array Int ranking))

(declare-fun inverted1 () (Array Int ranking))

(declare-fun result1 () Bool)

(declare-fun stable_marriage__is_preferred_1__result1 () Bool)

(declare-fun stable_marriage__is_preferred_1__result2 () Bool)

(declare-fun stable_marriage__is_preferred_1__result3 () Bool)

(declare-fun inverted2 () (Array Int ranking))

(declare-fun stable_marriage__is_preferred_1__result4 () Bool)

(declare-fun inverted3 () (Array Int ranking))

(declare-fun stable_marriage__is_preferred_1__result5 () Bool)

(declare-fun result2 () Bool)

;; H
  (assert (in_range1 g1_a))

;; H
  (assert (in_range1 g1_b))
...
;; H
  ...
  (forall ((rank Int))
  (=> (and (<= 1 rank) (<= rank 64))
  (= (to_rep (select o (to_rep1 (select r1 rank)))) rank)))
  (forall ((g1 Int))
  (=> (and (<= 1 g1) (<= g1 64))
  (= (to_rep1 (select r1 (to_rep (select o g1)))) g1))))))

;; H
  (assert (= (mk_map__ref1 result) (mk_map__ref1 inverted)))
...
;; H
  (assert
  (= stable_marriage__is_preferred_1__result1 stable_marriage__is_preferred_1__result2))

;; H
  (assert
  (= stable_marriage__is_preferred_1__result3 stable_marriage__is_preferred_1__result1))

;; H
  (assert
  (= (mk_bool__ref result1) (mk_bool__ref
                            stable_marriage__is_preferred_1__result)))

;; H
  (assert
  (= stable_marriage__is_preferred_1__result1 (ite (<= (to_rep
                                                       (select inverted1
                                                       g1_a)) (to_rep
                                                              (select
                                                              inverted1
...
;; H
  (assert
  (= (mk_bool__ref stable_marriage__is_preferred_1__result4) (mk_bool__ref
                                                             stable_marriage__is_preferred_1__result2)))

;; H
  (assert (= inverted1 inverted2))

;; H
  (assert
  (= stable_marriage__is_preferred_1__result5 stable_marriage__is_preferred_1__result3))

;; H
  (assert (= inverted3 inverted1))

;; H
  (assert (= result2 stable_marriage__is_preferred_1__result4))

;; H
  (assert (= stable_marriage__is_preferred_1__result4 true))

(assert
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 74, characters 0-0
  (not
  (<= (to_rep (select (invert_1 r1) g1_a)) (to_rep
                                           (select (invert_1 r1) g1_b)))))
(check-sat)
(exit)
