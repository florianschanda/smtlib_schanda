...
(declare-fun dummy () xdr_unsigned)
...
(declare-fun user_eq1 (xdr_boolean xdr_boolean) Bool)

(declare-fun dummy1 () xdr_boolean)
...
;; H
  ...
  (<= (+ position 3) (to_rep (last (rt data))))))

(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 195, characters 0-0
