...
(declare-fun o38 () message_count)

(declare-fun o39 () (Array (_ BitVec 8) us_rep))

(declare-fun o40 () message_index)

(declare-fun o41 () message_index)

(declare-fun o42 () message_count)

(declare-fun o43 () (Array (_ BitVec 8) us_rep))

(declare-fun o44 () message_index)

(declare-fun o45 () message_index)

(declare-fun o46 () message_count)
...
(declare-fun result3 () mailboxT__ref)

(declare-fun self__8 () us_rep1)

(declare-fun self__9 () mailboxT__ref)

(declare-fun self__10 () us_rep1)
...
;; H
  (assert
  (=> (< (to_rep3 self__3) 16)
  (= self__5 (mk___rep1 (mk___split_fields1 o10 o11 o12 o13)))))
...
;; H
  (assert
  (=> (< (to_rep3 self__3) 16)
  (= self__6 (mk___rep1 (mk___split_fields1 o24 o25 o26 o27)))))
...
;; H
  (assert
  (=> (< (to_rep3 self__3) 16)
  (= self__7 (mk___rep1 (mk___split_fields1 o33 o34 o35 o36)))))
