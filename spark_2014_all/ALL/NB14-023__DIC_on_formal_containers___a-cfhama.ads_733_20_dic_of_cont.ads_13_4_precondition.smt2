...
(declare-const dic_of_cont__my_hama__cursor__node__first__bit Int)

(declare-const dic_of_cont__my_hama__cursor__node__last__bit Int)

(declare-const dic_of_cont__my_hama__cursor__node__position Int)
...
(declare-const temp___1871 count_type)
