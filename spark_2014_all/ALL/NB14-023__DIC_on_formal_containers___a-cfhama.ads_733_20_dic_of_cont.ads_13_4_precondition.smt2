...
(define-fun us_split_discrs___3__projection ((a us_split_discrs)) hash_type
...
(define-fun map__ref___4__projection ((a map__ref1)) us_rep2 (map__content1
                                                             a))
...
(define-fun element_type__ref___7__projection ((a element_type__ref)) element_type
