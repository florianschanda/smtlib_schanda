...
(define-fun us_split_discrs_3__projection ((a us_split_discrs)) hash_type
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__dic_of_cont__my_hama__map us_main_type)))))
...
(define-fun map__ref_2__projection ((a map__ref)) us_rep (map__content a))
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__dic_of_cont__my_hama__cursor__node count_type)))))
(define-fun us_split_fields_Node2__projection ((a us_split_fields2)) count_type
  (rec__dic_of_cont__my_hama__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__dic_of_cont__my_hama__cursor__node
...
(declare-fun dic_of_cont__my_hama__cursor__node__first__bit () Int)

(declare-fun dic_of_cont__my_hama__cursor__node__last__bit () Int)

(declare-fun dic_of_cont__my_hama__cursor__node__position () Int)

;; dic_of_cont__my_hama__cursor__node__first__bit_axiom
  (assert (<= 0 dic_of_cont__my_hama__cursor__node__first__bit))

;; dic_of_cont__my_hama__cursor__node__last__bit_axiom
  (assert
  (< dic_of_cont__my_hama__cursor__node__first__bit dic_of_cont__my_hama__cursor__node__last__bit))

;; dic_of_cont__my_hama__cursor__node__position_axiom
  (assert (<= 0 dic_of_cont__my_hama__cursor__node__position))
...
(define-fun map__ref_4__projection ((a map__ref1)) us_rep2 (map__content1 a))
...
(define-fun element_type__ref_7__projection ((a element_type__ref)) element_type
...
(define-fun default_initial_assumption1 ((temp___expr_545 us_rep3)
  (temp___skip_top_level_546 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_546 true))
                                         (and
                                         (= (is_empty1 temp___expr_545) true)
                                         (= (length3 temp___expr_545) 0))))
...
(declare-fun temp___1871 () count_type)
...
;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1871)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cfhama.ads", line 712, characters 0-0
  (not
