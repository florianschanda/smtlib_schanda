...
;; H
  (assert
  (and (= o3 (elements (mk___rep s__split_discrs s__split_fields1)))
  (and
  (and
  (and (= (length2 o3) (length (mk___rep s__split_discrs s__split_fields1)))
...
;; H
  (assert (and (= o9 (get o3 o7)) (in_range5 o9)))
