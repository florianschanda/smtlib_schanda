...
(define-fun default_initial_assumption ((temp___expr_397 us_rep2)
...
(define-fun dynamic_invariant3 ((temp___expr_339 Int)
...
(declare-fun temp___562 () count_type)
...
;; H
  (assert (= temp___562 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___562)) no_element))
