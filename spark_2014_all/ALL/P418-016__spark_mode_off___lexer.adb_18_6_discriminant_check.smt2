...
(declare-datatypes ()
((name_id__ref (mk_name_id__ref (name_id__content us_rep)))))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__lexer__token__name us_rep)))))
...
(define-fun us_rep_3__projection ((a us_rep1)) Bool (attr__constrained a))
...
(declare-fun lexer__token__name__first__bit () Int)

(declare-fun lexer__token__name__last__bit () Int)

(declare-fun lexer__token__name__position () Int)
...
(declare-fun lexer__token__name__first__bit1 () Int)

(declare-fun lexer__token__name__last__bit1 () Int)

(declare-fun lexer__token__name__position1 () Int)
...
(declare-fun temp___194 () token_kind)

(declare-fun temp___1941 () us_rep)

(declare-fun temp___1942 () Bool)
