...
(declare-datatypes ((ack_resp_t_type__ref 0))
...
(define-fun register_type__ref_42__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_31__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_31__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3036 us_t1)
  (temp___is_init_3033 Bool) (temp___skip_constant_3034 Bool)
  (temp___do_toplevel_3035 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3034 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3036)
                                       (last3 temp___expr_3036))
                                       (and (= (first3 temp___expr_3036) 1)
                                       (= (last3 temp___expr_3036) 4)))))
