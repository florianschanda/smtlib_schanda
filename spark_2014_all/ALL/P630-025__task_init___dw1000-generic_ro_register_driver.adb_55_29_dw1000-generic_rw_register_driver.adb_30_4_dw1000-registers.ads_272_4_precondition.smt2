...
(define-fun us_split_fields_Reserved__2__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__ack_resp_t_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___21__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___21__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun register_type__ref___42__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___31__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___31__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3060 us_t1)
  (temp___is_init_3057 Bool) (temp___skip_constant_3058 Bool)
  (temp___do_toplevel_3059 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3058 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3060)
                                       (last3 temp___expr_3060))
                                       (and (= (first3 temp___expr_3060) 1)
                                       (= (last3 temp___expr_3060) 4)))))
