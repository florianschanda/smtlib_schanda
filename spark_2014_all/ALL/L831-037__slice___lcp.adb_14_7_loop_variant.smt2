...
;; H
  (assert
  (= (bool_eq (elts a) (to_rep (first6 (mk3 x r6b2)))
     (to_rep (last6 (mk3 x r6b2))) (elts a) (to_rep (first8 (mk4 y r9b2)))
     (to_rep (last8 (mk4 y r9b2)))) true))

;; H
  (assert
  (and
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 r6b2))
  (=> (<= (- 2147483648) 2147483647) (in_range1 r9b2)))
