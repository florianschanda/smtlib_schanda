...
(declare-fun next_avail6 () Int)

(declare-fun i11 () Int)

(declare-fun result6 () Bool)

(define-fun o24 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
;; H
  (assert
  (and (= o24 (model__ data first_available))
  (= (model_is_well_formed o24 data first_available) true)))
...
;; H
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data2 r)))) 0)
  (not
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1 (select data2 r)))) 0)))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (and (= o19 (model__ data2 first_available2))
  (= (model_is_well_formed o19 data2 first_available2) true))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= list_mod_allocator__alloc__C83b__assume c83b)))

;; H
  (assert (=> (not (= first_available 0)) (= ma c84b)))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= list_mod_allocator__alloc__B85b__L_4__R86b__assume r86b)))

;; H
  (assert (=> (not (= first_available 0)) (in_range1 r86b)))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (= temp___307 i2))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (<= (+ i3 1) (length c84b)))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r86b))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i3)) (= (get c83b j) (get c84b (+ j 1))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r86b))
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (+ i3 1))) (= (get c83b (- j 1)) (get c84b j)))))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b))
  (and (=> (<= 1 r86b) (dynamic_property 1 r86b i3))
  (and (<= 1 i3) (<= i3 r86b))))))
...
;; H
  ...
  (= (get c84b j) (to_rep
                  (rec__list_mod_allocator__cell__next
                  (us_split_fields1 (select data2 (get c83b i3))))))))))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (= i3 r86b))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (= i4 (mk_int__ref i3)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (= i5 i3))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (= i6 i4))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r86b)) (= i7 i5))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (and (<= 1 i2) (<= i2 r86b))) (= i6 (mk_int__ref i2)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (and (<= 1 i2) (<= i2 r86b))) (= i7 i2))))
...
;; H
  (assert
  (=> (not (= first_available 0)) (= next_avail3 (mk_int__ref next_avail2))))

;; H
  (assert
  (=> (not (= first_available 0))
  (= first_available3 (mk_int__ref first_available2))))
...
;; H
  (assert
  (=> (not (= first_available 0)) (= first_available4 first_available2)))
...
;; H
  ...
  (= first_available3 first_available7)))
...
;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= first_available4 first_available1)))
...
;; H
  ...
  (and (= (int__content res5) 0)
  (= (oeq1 (model__ (map__content data5) (int__content first_available5))
     (model__ data first_available)) true))))
...
;; H
  (assert
  (and (= o21 (model__ (map__content data5) (int__content first_available5)))
  (= (model_is_well_formed o21 (map__content data5)
     (int__content first_available5)) true)))

;; H
  (assert (= o22 (us_split_fields3 o21)))

;; H
  (assert (= o23 (rec__list_mod_allocator__m__t__available o22)))

;; H
  (assert
  (and
  (= result6 (is_prepend o23 (int__content res5)
             (rec__list_mod_allocator__m__t__available
             (us_split_fields3 (model__ data first_available)))))
  (= (= result6 true)
  (and
  (and
  (and (< (length o23) 2147483647)
  (= (length
     (rec__list_mod_allocator__m__t__available
     (us_split_fields3 (model__ data first_available)))) (+ (length o23) 1)))
  (= (get
     (rec__list_mod_allocator__m__t__available
     (us_split_fields3 (model__ data first_available))) 1) (int__content
                                                           res5)))
  (= (range_shifted o23
     (rec__list_mod_allocator__m__t__available
     (us_split_fields3 (model__ data first_available))) 1 (last o23) 1) true)))))
