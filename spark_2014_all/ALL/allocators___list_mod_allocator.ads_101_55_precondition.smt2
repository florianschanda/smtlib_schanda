...
;; H
  (assert
  (=> (not (= first_available 0))
  (= list_mod_allocator__alloc__C96b__assume c96b)))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= list_mod_allocator__alloc__B98b__L_4__R99b__assume r99b)))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b)) (= temp___307 i2))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b)) (<= (+ i3 1) (length c97b)))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r99b))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i3)) (= (get c96b j) (get c97b (+ j 1))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r99b))
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (+ i3 1))) (= (get c96b (- j 1)) (get c97b j)))))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b))
  (and (=> (<= 1 r99b) (dynamic_property 1 r99b i3))
  (and (<= 1 i3) (<= i3 r99b))))))
...
;; H
  ...
  (= (get c97b j) (to_rep
                  (rec__list_mod_allocator__cell__next
                  (us_split_fields1 (select data2 (get c96b i3))))))))))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b)) (= i3 r99b))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b)) (= i4 (mk_int__ref i3)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b)) (= i5 i3))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b)) (= i6 i4))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (and (<= 1 i2) (<= i2 r99b)) (= i7 i5))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (and (<= 1 i2) (<= i2 r99b))) (= i6 (mk_int__ref i2)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (and (<= 1 i2) (<= i2 r99b))) (= i7 i2))))
