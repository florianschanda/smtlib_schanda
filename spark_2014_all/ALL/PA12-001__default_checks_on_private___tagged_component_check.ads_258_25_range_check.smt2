...
(define-fun us_split_fields_F__33__projection ((a us_split_fields)) natural
  (rec__tagged_component_check__s__p4__root__f a))

(define-fun us_split_fields___37__projection ((a us_split_fields)) us_private
  (rec__ext__ a))
...
(define-fun us_rep___74__projection ((a us_rep)) Int (attr__tag a))
...
(define-fun root__ref___14__projection ((a root__ref)) us_rep (root__content
                                                              a))
...
(define-fun us_split_fields_C__9__projection ((a us_split_fields2)) us_main_type
  (rec__tagged_component_check__s__p4__c a))

(define-fun us_split_fields_F__34__projection ((a us_split_fields2)) natural
  (rec__tagged_component_check__s__p4__root__f1 a))

(define-fun us_split_fields___38__projection ((a us_split_fields2)) us_private
  (rec__ext__1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___38__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1 (us_split_fields3 us_split_fields2)(attr__tag1 Int)))))
(define-fun us_rep___75__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))

(define-fun us_rep___76__projection ((a us_rep1)) Int (attr__tag1 a))
...
(define-fun c__ref___14__projection ((a c__ref)) us_rep1 (c__content a))
...
(define-fun us_split_fields_C__11__projection ((a us_split_fields4)) us_main_type
  (rec__tagged_component_check__s__p4__c1 a))

(define-fun us_split_fields_H__14__projection ((a us_split_fields4)) natural
  (rec__tagged_component_check__s__d4__h a))

(define-fun us_split_fields_F__39__projection ((a us_split_fields4)) natural
  (rec__tagged_component_check__s__p4__root__f2 a))

(define-fun us_split_fields___44__projection ((a us_split_fields4)) us_private
  (rec__ext__2 a))

(declare-datatypes ((us_split_fields__ref2 0))
(((mk___split_fields__ref2 (us_split_fields__content2 us_split_fields4)))))
(define-fun us_split_fields__ref___44__projection ((a us_split_fields__ref2)) us_split_fields4
  (us_split_fields__content2 a))

(declare-datatypes ((us_rep2 0))
(((mk___rep2 (us_split_fields5 us_split_fields4)(attr__tag2 Int)))))
(define-fun us_rep___87__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                   a))

(define-fun us_rep___88__projection ((a us_rep2)) Int (attr__tag2 a))
...
(declare-datatypes ((d4__ref 0)) (((mk_d4__ref (d4__content us_rep2)))))
(define-fun d4__ref___3__projection ((a d4__ref)) us_rep2 (d4__content a))
...
(define-fun default_initial_assumption1 ((temp___expr_506 us_rep1)
  (temp___skip_top_level_507 Bool)) Bool (and
                                         (= (attr__tag1 temp___expr_506)
                                         us_tag1)
                                         (= (to_rep
                                            (rec__tagged_component_check__s__p4__root__f1
                                            (us_split_fields3
...
(define-fun default_initial_assumption2 ((temp___expr_554 us_rep2)
  (temp___skip_top_level_555 Bool)) Bool (and
                                         (= (attr__tag2 temp___expr_554)
                                         us_tag2)
                                         (and
                                         (= (to_rep
                                            (rec__tagged_component_check__s__d4__h
