...
;; H
  (assert (and (= o25 x215) (in_range4 x215)))

;; H
  (assert (and (= o24 (- x19 1)) (in_range1 (- x19 1))))

;; H
  (assert
  (and (= o26 (get_length o24 o25 (map__content1 lengths12)))
  (and (dynamic_property3 0 last4 o26)
  (= o26 (ite (and (dynamic_property1 first2 last2 o24) (dynamic_property2
              first3 last3 o25))
         (to_rep2 (get (map__content1 lengths12) o24 o25)) 0)))))
