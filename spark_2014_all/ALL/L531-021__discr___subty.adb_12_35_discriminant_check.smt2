...
(declare-fun temp___171 () enum)

(declare-fun temp___1711 () integer)

(declare-fun temp___1712 () integer)

(declare-fun temp___1713 () Bool)

(declare-fun temp___1714 () natural)
...
(declare-fun z__split_fields5 () us_split_fields)

(define-fun o29 () us_rep (mk___rep (mk___split_discrs o18)
                          (mk___split_fields o19 o20 o21 o22)))

(define-fun o30 () us_rep (mk___rep (mk___split_discrs o13)
...
;; H
  (assert
  (= o30 (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs subty__p__z__assume)
     ...
     subty__p__z__assume3 subty__p__z__assume4)) o29))
...
;; H
  (assert
  (and (= o23 (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))
  (in_range (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))))
...
;; H
  (assert
  (= z__split_fields5 (mk___split_fields temp___1711 temp___1712 temp___1713
                      temp___1714)))
