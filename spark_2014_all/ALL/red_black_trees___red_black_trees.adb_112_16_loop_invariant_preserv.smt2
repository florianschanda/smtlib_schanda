...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res2 i4)))) (to_rep
                                             (rec__red_black_trees__black_count__depth
                                             (us_split_fields11
                                             (select res2 i4))))))))
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i4)))) 100)
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res2 i4)))) n2)))))
...
;; H
  ...
  (=> (and (<= 1 i4) (<= i4 100))
  (ite (and
       (= (rec__tree_model__path_type__k (us_split_fields1 (select m i4))) true)
       (< n2 (to_rep
             (rec__red_black_trees__black_count__depth
             (us_split_fields11 (select res2 i4))))))
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m i4)))) (- 100 
  n2))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i4))) true)
  (and
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select res2 i4))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select res2 (peek
                  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i4
                  0))))) (to_rep
                         (rec__red_black_trees__black_count__count
                         (us_split_fields11
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i4 1))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i4)))) (+ 1 (ite (< (to_rep
                                                         (rec__red_black_trees__black_count__depth
                                                         (us_split_fields11
                                                         (select res2 
                                                         (peek
  ...
  (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t))
               i4 1))))) (to_rep
                         ...
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i4 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select res2 i4)))) (+ (ite (= (to_rep3
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res3 i4)))) (to_rep
                                             (rec__red_black_trees__black_count__depth
                                             (us_split_fields11
                                             (select res3 i4))))))))
...
;; H
  ...
  (=> (<= i2 temp___1004)
  (= (select res3 temp___1004) (select res2 temp___1004)))))
...
;; WP_parameter_def
 ;; File "red_black_trees.adb", line 20, characters 0-0
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res6 i4)))) (to_rep
                                             (rec__red_black_trees__black_count__depth
                                             (us_split_fields11
                                             (select res6 i4)))))))
(check-sat)
