...
(declare-fun a_old () (Array Int integer))
...
;; H
  (assert
  (= (bool_eq1 (temp___333 a_old i 1 j 2 k 3) (- 2147483648) 2147483647
     (temp___343 a_old i 1 k 3 j 2) (- 2147483648) 2147483647) true))

;; H
  (assert
  (= (bool_eq1 (temp___357 a_old i 1 k 3 j 2) (- 2147483648) 2147483647
     (temp___367 a_old k 3 i 1 j 2) (- 2147483648) 2147483647) true))

;; H
  (assert
  (= (bool_eq1 (temp___381 a_old k 3 i 1 j 2) (- 2147483648) 2147483647
     (temp___391 a_old k 3 j 2 i 1) (- 2147483648) 2147483647) true))
...
;; WP_parameter_def
 ;; File "simple_arrays.adb", line 127, characters 0-0
  (not
  (= (bool_eq1 a4 (- 2147483648) 2147483647 (temp___240 a i 1 j 2 k 3)
