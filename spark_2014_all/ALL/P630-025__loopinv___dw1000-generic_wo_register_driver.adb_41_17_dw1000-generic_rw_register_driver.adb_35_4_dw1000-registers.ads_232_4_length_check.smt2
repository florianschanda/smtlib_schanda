...
(((mk_sys_mask_type__ref (sys_mask_type__content us_rep)))))
...
(define-fun dynamic_invariant ((temp___expr_2578 us_t1)
  ...
  (temp___do_toplevel_2577 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_2578))
                                       (and (= (first3 temp___expr_2578) 1)
                                       (= (last3 temp___expr_2578) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2624 us_t2)
  ...
  (temp___do_toplevel_2623 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_2624))
                                       (and (= (first5 temp___expr_2624) 1)
                                       (= (last5 temp___expr_2624) 4)))))
...
(declare-const temp___7603 (Array Int bits_8))

(declare-const temp___76031 t2)

(declare-const temp___7604 (Array Int bits_8))

(declare-const temp___76041 t1)
...
;; H
  (assert
  (and (= temp___76032 (register_to_bytes reg)) (dynamic_invariant1
  temp___76032 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76031)) (to_rep (last4 temp___76031)))
     (+ (- (to_rep (last4 temp___76031)) (to_rep (first4 temp___76031))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76031)) (to_rep (last4 temp___76031)))
  temp___76041))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76041)) (to_rep (last2 temp___76041)))
     (+ (- (to_rep (last2 temp___76041)) (to_rep (first2 temp___76041))) 1)
