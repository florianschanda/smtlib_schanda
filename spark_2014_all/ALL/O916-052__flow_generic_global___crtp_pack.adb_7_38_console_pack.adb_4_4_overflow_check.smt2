...
(((mk___split_fields (rec__crtp_pack__crtp_packet_handler__index positive)))))
...
(((mk_crtp_packet_handler__ref (crtp_packet_handler__content us_rep)))))
(define-fun crtp_packet_handler__ref___projection ((a crtp_packet_handler__ref)) us_rep
...
(assert
;; WP_parameter_def
 ;; File "console_pack.adb", line 3, characters 0-0
  (not (in_range (+ (to_rep handler__split_fields) 0))))
(check-sat)
(exit)
