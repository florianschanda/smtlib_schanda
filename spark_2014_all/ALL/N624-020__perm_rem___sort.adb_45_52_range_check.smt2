...
;; H
  (assert
  (and (= o33 (remove (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and (= o34 (remove (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and (= o20 (remove_eq o34 o33 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o33 o19)))
     (let ((temp___162 (remove o34 o19)))
...
;; H
  (assert
  (and (= o32 (remove (mk___t values2 (mk 1 100)) o27))
