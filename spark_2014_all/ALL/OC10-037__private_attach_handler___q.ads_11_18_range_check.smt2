...
(((mk___split_fields (rec__q__pt us_main_type)))))
...
(((mk___split_fields1 (rec__q__pt1 us_main_type)))))
(define-fun us_split_fields_PT__2__projection ((a us_split_fields2)) us_main_type
  (rec__q__pt1 a))
...
(define-fun us_rep___31__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                  a))

(define-fun us_rep___32__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))
...
(((mk_tpoS__ref (tpoS__content us_rep1)))))
