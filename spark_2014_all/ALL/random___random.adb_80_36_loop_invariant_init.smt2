...
(((mk_t4b__ref (t4b__content long_long_integer)))))
...
;; H
  (assert (= o1 (select (rec__random__generator__state g__split_fields2)
  o)))
...
;; H
  (assert (= o8 (bvmul o7 ((_ int2bv 32) 1664525))))
...
;; H
  (assert (= temp___276 o18))

;; H
  (assert (= temp___2761 o19))

;; H
  (assert (= result4 (mk___split_fields__ref g__split_fields2)))

;; H
  (assert (= g__split_fields3 (mk___split_fields temp___276 temp___2761)))
...
;; H
  (assert (=> (= i1 623) (= temp___280 o22)))

;; H
  (assert (=> (= i1 623) (= temp___2801 o23)))
