...
(declare-fun x86__readmem8ghost__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__readmem8ghost__result1 () (_ BitVec 8))

(declare-fun x86__readmem8ghost__result2 () (_ BitVec 8))

(declare-fun x86__readmem8ghost__result3 () (_ BitVec 8))

(declare-fun x86__readmem8ghost__result4 () (_ BitVec 8))

(declare-fun x86__readmem8ghost__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= (mk_t__ref x86__readmem8ghost__result4) (mk_t__ref
                                             x86__readmem8ghost__result2)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= x86__readmem8ghost__result4 (to_rep (select mem addr)))))
(check-sat)
(exit)
