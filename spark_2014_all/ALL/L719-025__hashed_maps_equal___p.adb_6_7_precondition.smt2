...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k1 us_rep1))
     (and (= (has_key container k1) true) (= (bool_eq1 k1 key2) true)))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields2)) (+ (length
                                                             ...
                                                             (mk___split_fields
                                                             l__split_fields))) 1))
  (= (has_key1 (model__ (mk___rep l__split_discrs l__split_fields2)) k) true))
  (= (key (mk___rep l__split_discrs l__split_fields2)
     (find (mk___rep l__split_discrs l__split_fields2) k)) k))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) k) 1))
  (= (ole
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  ...
  (= (mapping_preserved
     ...
     (keys (mk___rep l__split_discrs l__split_fields2))
     (positions
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (find (mk___rep l__split_discrs l__split_fields2) k)) true)))
