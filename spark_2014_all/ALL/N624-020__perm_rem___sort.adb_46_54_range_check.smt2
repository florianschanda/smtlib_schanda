...
;; H
  (assert
  (and (= o28 (remove (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and (= o29 (remove (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and (= o20 (remove_eq o29 o28 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o28 o19)))
     (let ((temp___162 (remove o29 o19)))
