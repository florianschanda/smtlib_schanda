...
(declare-fun dummy3 () (Array Int character))
...
(define-fun dynamic_invariant ((temp___expr_146 us_rep)
  ...
  (temp___do_toplevel_145 Bool)) Bool (=> (= temp___do_toplevel_145 true)
                                      (=> (= temp___is_init_143 true)
                                      (<= (let ((temp___149 (rec__messages__message__received
                                                            (us_split_fields1
                                                            temp___expr_146))))
                                          (let ((temp___148 (rec__messages__message__sent
                                                            (us_split_fields1
                                                            temp___expr_146))))
                                          (compare temp___148 1 10 temp___149
                                          1 10))) 0))))

(define-fun dynamic_predicate ((temp___160 us_rep)) Bool (<= (let ((temp___163
                                                             (rec__messages__message__received
                                                             (us_split_fields1
                                                             temp___160))))
                                                             (let ((temp___162
...
(define-fun dynamic_invariant1 ((temp___expr_185 us_rep1)
  ...
  (temp___do_toplevel_184 Bool)) Bool (and
                                      (forall ((idx Int))
                                      (=>
                                      (and (<= 1 idx)
                                      (<= idx (- (to_rep
                                                 ...
                                                 (us_split_discrs1
                                                 temp___expr_185))) 1)))
                                      (<= (let ((temp___190 (rec__messages__message__received
                                                            (us_split_fields1
                                                            (let ((temp___188
                                                            (rec__communications__communication__msgs
                                                            (us_split_fields3
                                                            ...
                                                            (select (to_array1
                                                                    temp___188) (+ idx 1)))))))
                                          (let ((temp___189 (rec__messages__message__received
                                                            (us_split_fields1
                                                            (let ((temp___187
                                                            (rec__communications__communication__msgs
                                                            (us_split_fields3
                                                            ...
                                                            (select (to_array1
                                                                    temp___187) idx))))))
                                          (compare temp___189 1 10 temp___190
                                          1 10))) 0)))
                                      (let ((temp___191 (rec__communications__communication__num
                                                        (us_split_discrs1
                                                        temp___expr_185))))
                                      (and
                                      ...
                                      (= (first3
                                         (rec__communications__communication__msgs
                                         (us_split_fields3 temp___expr_185))) 1)
                                      (= (last3
                                         (rec__communications__communication__msgs
                                         (us_split_fields3 temp___expr_185)))
                                      (to_rep temp___191))))
                                      ...
                                      (<= (first3
                                          (rec__communications__communication__msgs
                                          (us_split_fields3 temp___expr_185))) temp___192)
                                      (<= temp___192 (last3
                                                     (rec__communications__communication__msgs
                                                     (us_split_fields3
                                                     temp___expr_185)))))
                                      (=> (= temp___is_init_182 true)
                                      (let ((temp___193 (select (to_array1
                                                                (rec__communications__communication__msgs
                                                                (us_split_fields3
                                                                temp___expr_185))) temp___192)))
                                      (<= (let ((temp___195 (rec__messages__message__received
                                                            (us_split_fields1
                                                            temp___193))))
                                          (let ((temp___194 (rec__messages__message__sent
                                                            (us_split_fields1
                                                            temp___193))))
                                          (compare temp___194 1 10 temp___195
                                          1 10))) 0)))))))))

(define-fun type_invariant ((temp___198 us_rep1)) Bool (forall ((idx Int))
                                                       (=>
                                                       (and (<= 1 idx)
                                                       (<= idx (- (to_rep
                                                                  (rec__communications__communication__num
...
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs1 r)
                                          (mk___split_fields2
                                          (let ((temp___133 (rec__communications__communication__msgs
                                                            (us_split_fields3
                                                            r))))
...
(define-fun in_range6 ((rec__communications__communication__num1 Int)
...
(declare-fun communications__communication__num__first__bit1 () Int)

(declare-fun communications__communication__num__last__bit1 () Int)

(declare-fun communications__communication__num__position1 () Int)
...
(declare-fun communications__communication__msgs__first__bit1 () Int)

(declare-fun communications__communication__msgs__last__bit1 () Int)

(declare-fun communications__communication__msgs__position1 () Int)
...
(define-fun tcomsS__ref___projection ((a tcomsS__ref)) us_rep2 (tcomsS__content
                                                               a))

(declare-fun coms__split_discrs () us_split_discrs)
...
;; def_axiom
  (assert
  (forall ((temp___263 us_rep) (temp___264 us_rep))
  (let ((temp___262 (main__a__aggregate_def temp___263 temp___264)))
  (and (= (select temp___262 (- 2147483648)) temp___263)
  (= (select temp___262 (- 2147483647)) temp___264)))))
...
;; temp___String_Literal_266__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 1)) 48)
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 2)) 48))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 3)) 48))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 4)) 48))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 5)) 45))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 6)) 49))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 7)) 50))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 8)) 45))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 9)) 50))
     (= (to_rep2 (select (temp___String_Literal_266 us_void_param) 10)) 53)) :pattern (
...
;; temp___String_Literal_267__def_axiom
  ...
  (! (and
     ...
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 2)) 48))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 3)) 51))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 4)) 51))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 5)) 45))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 6)) 48))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 7)) 52))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 8)) 45))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 9)) 48))
     (= (to_rep2 (select (temp___String_Literal_267 us_void_param) 10)) 51)) :pattern (
...
;; temp___String_Literal_269__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 1)) 48)
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 2)) 53))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 3)) 55))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 4)) 48))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 5)) 45))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 6)) 48))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 7)) 48))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 8)) 45))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 9)) 48))
     (= (to_rep2 (select (temp___String_Literal_269 us_void_param) 10)) 48)) :pattern (
...
;; temp___String_Literal_270__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 1)) 48)
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 2)) 54))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 3)) 51))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 4)) 50))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 5)) 45))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 6)) 48))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 7)) 54))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 8)) 45))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 9)) 48))
     (= (to_rep2 (select (temp___String_Literal_270 us_void_param) 10)) 56)) :pattern (
...
(define-fun dynamic_invariant5 ((temp___expr_175 us_t)
  ...
  (temp___do_toplevel_174 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_173 true))
                                      (dynamic_property (- 2147483648)
                                      2147483647 (first1 temp___expr_175)
                                      (last1 temp___expr_175)))
                                      (forall ((temp___176 Int))
                                      (=>
                                      (and
                                      (<= (first1 temp___expr_175) temp___176)
                                      (<= temp___176 (last1 temp___expr_175)))
                                      (=> (= temp___is_init_172 true)
                                      (let ((temp___177 (select (to_array
                                                                temp___expr_175) temp___176)))
                                      (<= (let ((temp___179 (rec__messages__message__received
                                                            (us_split_fields1
                                                            temp___177))))
                                          (let ((temp___178 (rec__messages__message__sent
                                                            (us_split_fields1
                                                            temp___177))))
                                          (compare temp___178 1 10 temp___179
                                          1 10))) 0)))))))
...
(declare-fun main__a__assume () (Array Int us_rep))

(declare-fun main__a__assume1 () t)
...
;; H
  (assert
  (<= (compare (temp___String_Literal_269 Tuple0) 1 10
      (temp___String_Literal_270 Tuple0) 1 10) 0))

;; H
  (assert (= (temp___String_Literal_269 Tuple0) o))

;; H
  (assert (= (temp___String_Literal_270 Tuple0) o1))

;; H
  (assert
  (<= (compare (temp___String_Literal_266 Tuple0) 1 10
      (temp___String_Literal_267 Tuple0) 1 10) 0))

;; H
  (assert (= (temp___String_Literal_266 Tuple0) o2))

;; H
  (assert (= (temp___String_Literal_267 Tuple0) o3))

;; H
  (assert
  (= o4 (main__a__aggregate_def (mk___rep (mk___split_fields o2 o3))
        (mk___rep (mk___split_fields o o1)))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 a__first) temp___272) (<= temp___272 (to_rep1 a__last)))
  (let ((temp___147 (select a1 temp___272)))
  (<= (compare (rec__messages__message__sent (us_split_fields1 temp___147)) 1
      10 (rec__messages__message__received (us_split_fields1 temp___147)) 1
      10) 0))))))
