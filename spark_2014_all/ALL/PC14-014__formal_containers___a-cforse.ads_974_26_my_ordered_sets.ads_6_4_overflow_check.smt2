...
(define-fun default_initial_assumption ((temp___expr_353 us_rep2)
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (= (contains (model__ container) (get result temp___387)) true))))
     (forall ((item Int))
...
;; H
  ...
  (and (in_range1 o)
  (<= o (to_rep
        (rec__my_ordered_sets__m__set__capacity target__split_discrs))))))
