...
(declare-const dummy5 severityt)
...
(define-fun dynamic_invariant5 ((temp___expr_1049 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_919 Int)
  ...
  (temp___do_toplevel_918 Bool)) Bool (=>
                                      ...
                                      (<= 0 17)) (in_range8 temp___expr_919)))

(define-fun dynamic_invariant10 ((temp___expr_931 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_1055 Int)
...
(declare-const usedlogfiles__split_fields12 (Array Int logfileindext))

(declare-const usedlogfiles__split_fields13 logfileindext)

(declare-const usedlogfiles__split_fields14 logfileindext)

(declare-const usedlogfiles__split_fields15 logfilecountt)
...
(declare-const usedlogfiles__split_fields16 us_split_fields)
...
(define-fun usedlogfiles__split_fields17 () us_split_fields (mk___split_fields
...
;; H
  ...
  (and (and (in_range10 numberlogentries2) (in_range6 auditalarm3))
  (in_range9 currentlogfile2)))))

;; H
  (assert
  (=> (not (not (= oldalarm1 auditalarm2)))
  (= auditsystemfault1 auditsystemfault)))

;; H
  (assert
  (=> (not (not (= oldalarm1 auditalarm2))) (= auditalarm3 auditalarm2)))

;; H
  (assert
  (=> (not (not (= oldalarm1 auditalarm2)))
  (= logfileentries2 logfileentries1)))

;; H
  (assert
  (=> (not (not (= oldalarm1 auditalarm2)))
  (= usedlogfiles__split_fields17 (mk___split_fields
...
;; H
  (assert
  (=> (not (not (= oldalarm1 auditalarm2)))
  (= numberlogentries2 numberlogentries1)))

;; H
  (assert
  (=> (not (not (= oldalarm1 auditalarm2)))
  (= logfilesstatus1 logfilesstatus)))
...
;; H
  (assert (= auditalarm3 auditalarm4))

;; H
  (assert (= logfileentries2 logfileentries3))

;; H
  (assert (= usedlogfiles__split_fields12 usedlogfiles__split_fields8))

;; H
  (assert (= usedlogfiles__split_fields13 usedlogfiles__split_fields9))

;; H
  (assert (= usedlogfiles__split_fields14 usedlogfiles__split_fields10))

;; H
  (assert (= usedlogfiles__split_fields15 usedlogfiles__split_fields11))

;; H
  (assert (= numberlogentries2 numberlogentries3))

;; H
  (assert (= logfilesstatus1 logfilesstatus2))

;; H
  (assert (= currentlogfile2 currentlogfile3))
...
;; H
  (assert (= logfileentries4 logfileentries2))

;; H
  (assert (= usedlogfiles__split_fields16 usedlogfiles__split_fields17))

;; H
  (assert (= numberlogentries4 numberlogentries2))

;; H
  (assert (= logfilesstatus3 logfilesstatus1))

;; H
  (assert (= currentlogfile4 currentlogfile2))
...
;; WP_parameter_def
 ;; File "auditlog.ads", line 33, characters 0-0
  (not (<= 1 (to_rep3 usedlogfiles__split_fields15))))
(check-sat)
(exit)
