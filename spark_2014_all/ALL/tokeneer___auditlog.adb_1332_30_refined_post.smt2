...
(declare-fun usedlogfiles__split_fields12 () (Array Int logfileindext))

(declare-fun usedlogfiles__split_fields13 () logfileindext)

(declare-fun usedlogfiles__split_fields14 () logfileindext)

(declare-fun usedlogfiles__split_fields15 () logfilecountt)

(declare-fun logfileentries3 () (Array Int fileentrycountt))

(declare-fun auditalarm4 () Int)

(declare-fun auditsystemfault2 () bool__ref)
