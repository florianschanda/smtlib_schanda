...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1089 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1088 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1087 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (=> (not (= is_root true)) (= o23 (select temp___1087 j2))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1086 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (=> (not (= is_root true)) (= o19 (select temp___1086 j2))))
...
;; H
  (assert
  (and
  (= o52 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range4 o52)
  (= o52 (size
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i))
  (and
  (= o49 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o49)
  (= o49 (to_rep1
         (rec__search_trees__search_tree__root
         (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i)))
  (and
  (= o51 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o51)
  (= o51 (to_rep1
         (rec__search_trees__search_tree__root
         (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3))) i)))
  (= result27 (ite (= o51 o50) true false))))
...
;; H
  (assert
  (and
  (= o48 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range4 o48)
  (and
  (= o48 (parent
...
;; H
  (assert (= result28 (ite (= o48 o47) true false)))
...
;; H
  (assert
  (and
  (= o46 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range5 o46)
  (= o46 (position
         (rec__search_trees__search_tree__struct
...
;; H
  (assert (= result29 (ite (= o46 1) true false)))
...
;; H
  (assert
  (and
  (= o45 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o43))
  (and (in_range4 o45)
  (and
  (= o45 (parent
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields12)) o43))
  (=> (= (size1 (mk___rep3 (us_split_fields__content3 t__split_fields12))) 0)
  (= o45 0))))))

;; H
  (assert (= result30 (ite (= o45 o44) true false)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (not
  (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12)) o38) 0))))
(check-sat)
