...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__eq_null_record__s__x t)))))
...
(declare-fun eq_null_record__s__x__first__bit () Int)

(declare-fun eq_null_record__s__x__last__bit () Int)

(declare-fun eq_null_record__s__x__position () Int)
...
(declare-fun eq_null_record__always_true__result () Bool)

(declare-fun result () Bool)

(declare-fun eq_null_record__always_true__result1 () Bool)

(declare-fun eq_null_record__always_true__result2 () Bool)

(declare-fun eq_null_record__always_true__result3 () Bool)

(declare-fun eq_null_record__always_true__result4 () Bool)

(declare-fun eq_null_record__always_true__result5 () Bool)
