...
;; H
  (assert
  (and (= o9 (element l (cursor__content lists__search__result13)))
  (and (in_range5 o9)
  (= o9 (get (model__ l)
...
;; H
  ...
  (forall ((i1 us_rep1))
  (=> (= (has_key o4 i1) true)
  (and (and (<= 1 (get1 o4 i1)) (<= (get1 o4 i1) (length2 l)))
  (forall ((j us_rep1))
  (=> (= (has_key o4 j) true)
...
;; H
  (assert
  (and (= o5 (get1 o4 (cursor__content lists__search__result13)))
  (and (in_range4 o5)
  (=> (= (of_int 0) true)
  (and
  (= o5 (w_get o4 (witness o4 (cursor__content lists__search__result13))))
  (forall ((k us_rep1))
  (=> (= (has_key o4 k) true)
  (= (= (bool_eq1 k (cursor__content lists__search__result13)) true)
  (= (witness o4 (cursor__content lists__search__result13)) (witness o4 k))))))))))
