...
;; H
  (assert
  (= o17 (select (rec__patience__state__posstack (us_split_fields1 s))
  o16)))
...
;; H
  (assert
  (=> (= result2 true)
  (= o8 (select (rec__patience__state__posstack (us_split_fields1 s))
  o7))))

;; H
  (assert (=> (= result2 true) (= temp___408 (to_rep1 o8))))

;; H
  (assert (=> (= result2 true) (and (<= 0 temp___408) (<= temp___408 99))))

;; H
  (assert (=> (= result2 true) (= o9 temp___408)))

;; H
  (assert
  (=> (= result2 true)
  (= o10 (select (rec__patience__state__stacksizes (us_split_fields1 s))
  o9))))

;; H
  (assert (=> (= result2 true) (= o11 (to_rep1 o10))))
...
;; H
  (assert (=> (= result2 true) (= o13 (to_rep1 o6))))
...
;; H
  (assert
  (=> (= result2 true)
  (= o3 (select (rec__patience__state__posheight (us_split_fields1 s))
  o2))))

;; H
  (assert (=> (= result2 true) (= o4 (to_rep1 o3))))
