...
(define-fun bool_eq2 ((x1 Int) (y Int)) Bool (ite (= x1 y) true false))
...
(declare-fun of_o () Int)

(declare-fun og () Int)

(declare-fun dynamic__p__result () Int)
...
(declare-fun dynamic__p__result1 () Int)

(declare-fun dynamic__p__result2 () Int)

(declare-fun dynamic__p__result3 () Int)
...
(declare-fun of_o2 () Int)

(declare-fun og2 () int__ref)

(declare-fun dynamic__p__result4 () int__ref)
...
(declare-fun of_o3 () Int)

(declare-fun og3 () Int)

(declare-fun dynamic__p__result5 () Int)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (+ x 2) (int__content dynamic__p__result4))))
(check-sat)
