...
;; H
  (assert (= o18 (bvadd o17 ((_ int2bv 64) 1))))

;; H
  (assert (= o19 (bvmul o18 ((_ int2bv 64) 32))))

;; H
  (assert (= o20 (ite (bvult i2 o19) true false)))
...
;; H
  (assert (= o14 (ole o10 o13)))

;; H
  (assert (and (= o8 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o9 (ite (<= j3 o8) true false)))
