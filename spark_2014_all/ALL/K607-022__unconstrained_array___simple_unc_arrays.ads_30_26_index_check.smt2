...
(((mk_tS21bP1__ref (tS21bP1__content integer)))))
...
(declare-datatypes ((s21b__ref 0)) (((mk_s21b__ref (s21b__content us_t2)))))
...
(declare-const temp___829 (Array Int value))

(declare-const temp___8291 t1)

(declare-const temp___822 natural)

(declare-const temp___8221 (Array Int value))

(declare-const temp___8222 t1)

(declare-const temp___821 Int)

(declare-const temp___825 (Array Int value))

(declare-const temp___8251 t1)
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 (- low2 1)))
  (= (to_rep2 (select a__split_fields4 j1)) (to_rep2
                                            (select temp___825 (+ (-
                                            (to_rep
                                            (rec__simple_unc_arrays__table__last
                                            a__split_discrs)) j1) 1))))))
  (forall ((j1 Int))
  (=>
  (and (<= (- low2 1) j1)
  (<= j1 (to_rep (rec__simple_unc_arrays__table__last a__split_discrs))))
  (= (to_rep2 (select a__split_fields4 j1)) (to_rep2 (select temp___829 j1))))))))
...
;; H
  ...
  (and
  (= temp___837 (+ (- (to_rep
                      (rec__simple_unc_arrays__table__last a__split_discrs))
  j) 1)) (in_range1
  (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs))
  j) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first2 a__split_fields1)) temp___837)
  (<= temp___837 (to_rep1 (last2 a__split_fields1)))))

;; H
  (assert (= o5 temp___837))

;; H
  (assert (= o6 (select a__split_fields o5)))
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 10, characters 0-0
  ...
  (<= (to_rep1
      ...
      (rt1
      (rec__simple_unc_arrays__table__v
      (us_split_fields__content a__split_fields11))))) j)))
(check-sat)
(exit)
