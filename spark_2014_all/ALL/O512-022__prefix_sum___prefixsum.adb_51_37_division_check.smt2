...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (ite (and (and (<= 0 k1) (<= k1 (- left3 space2)))
       (= (mod2 (+ k1 1) (* 2 space2)) 0))
...
;; H
  (assert
  (=> (= (mod2 (+ left3 1) space2) 0)
  (and (= o1 (* (* space2 2) 1000000)) (in_range3 (* (* space2 2) 1000000)))))

;; H
  (assert
  (=> (= (mod2 (+ left3 1) space2) 0)
  (and (= result5 (all_left_elements_in a2 left3 o1))
  (= (= result5 true)
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (=> (< k1 left3)
  (and (<= (- o1) (to_rep (select a2 k1))) (<= (to_rep (select a2 k1)) o1)))))))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o (* space2 1000000)) (in_range3 (* space2 1000000)))))

;; H
  (assert
  (=> (= result5 true)
  (and (= result4 (all_right_elements_in a2 (- left3 1) o))
  (= (= result4 true)
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (=> (< (- left3 1) k1)
  (and (<= (- o) (to_rep (select a2 k1))) (<= (to_rep (select a2 k1)) o)))))))))
...
;; H
  (assert
  (=> (= result4 true)
  (= o2 (ite (= (mod2 (+ left3 1) (* space2 2)) space2) true false))))

;; H
  (assert (=> (not (= result4 true)) (= o2 false)))

;; H
  (assert (=> (<= 8 left3) (= o3 (of_int 0))))
