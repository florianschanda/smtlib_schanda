...
(define-fun register_type__ref_144__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_102__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_102__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5441 us_t1)
  (temp___is_init_5438 Bool) (temp___skip_constant_5439 Bool)
  (temp___do_toplevel_5440 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5439 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5441)
                                       (last3 temp___expr_5441))
                                       (and (= (first3 temp___expr_5441) 1)
                                       (= (last3 temp___expr_5441) 1)))))
