...
;; H
  (assert
  (and (= o16 (+ (to_rep1 (first (rt source))) 5)) (in_range1
...
;; H
  (assert
  (and (= temp___2010 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2010)
  (<= temp___2010 (to_rep1 (last (rt source))))))

;; H
  (assert (= o12 temp___2010))
...
;; H
  (assert
  (and (= temp___2009 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2009)
  (<= temp___2009 (to_rep1 (last (rt source))))))

;; H
  (assert (= o8 temp___2009))
...
;; H
  (assert
  (and (= temp___2008 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2008)
  (<= temp___2008 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___2008))
...
;; H
  (assert
  (and (= temp___2007 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2007)
  (<= temp___2007 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___2007))
