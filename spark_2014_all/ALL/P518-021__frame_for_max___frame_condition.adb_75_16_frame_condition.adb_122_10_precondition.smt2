...
(declare-const temp___276 (Array Int us_rep))
...
;; H
  (assert (= temp___281 c239b))

;; H
  (assert (= temp___280 max1))

;; H
  (assert (= temp___282 a))

;; H
  (assert (= temp___279 c238b))

;; H
  (assert (= temp___278 k1))
...
;; H
  (assert
  (= (frame_left
     (mk___t temp___282 (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true))
...
;; WP_parameter_def
 ;; File "frame_condition.adb", line 60, characters 0-0
  (not
  (= (to_rep1 (first (mk (to_rep1 a__first) (to_rep1 a__last)))) (to_rep1
                                                                 a__first))))
(check-sat)
(exit)
