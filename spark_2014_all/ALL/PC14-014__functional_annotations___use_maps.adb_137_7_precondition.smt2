...
;; H
  ...
  (= (key (mk___rep m__split_discrs m__split_fields6)
     (find1 (mk___rep m__split_discrs m__split_fields6) 1)) 1))
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (find1 (mk___rep m__split_discrs m__split_fields6) 1)) true)))
...
;; H
  ...
  (= (key (mk___rep m__split_discrs m__split_fields5)
     (find1 (mk___rep m__split_discrs m__split_fields5) 2)) 2))
  ...
  (= (keys_included_except1
     ...
     (positions (mk___rep m__split_discrs m__split_fields6))
     (find1 (mk___rep m__split_discrs m__split_fields5) 2)) true)))
...
;; H
  ...
  (= (key (mk___rep m__split_discrs m__split_fields4)
     (find1 (mk___rep m__split_discrs m__split_fields4) 3)) 3))
  ...
  (= (mapping_preserved (keys (mk___rep m__split_discrs m__split_fields5))
  ...
  (= (keys_included_except1
     ...
     (positions (mk___rep m__split_discrs m__split_fields5))
     (find1 (mk___rep m__split_discrs m__split_fields4) 3)) true)))
