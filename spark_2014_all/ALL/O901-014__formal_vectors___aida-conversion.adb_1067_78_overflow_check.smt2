...
(define-fun tnumber_array_typeD1__ref___18__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___18__projection ((a number_array_type__ref)) us_t1
...
(((mk_t360b__ref (t360b__content integer)))))
...
(declare-datatypes ((t361b__ref 0))
(((mk_t361b__ref (t361b__content us_t2)))))
...
(declare-datatypes ((t362b__ref 0))
(((mk_t362b__ref (t362b__content integer)))))
...
(define-fun tnumber_array_typeB__ref___18__projection ((a tnumber_array_typeB__ref)) us_t3
...
;; def_axiom
  (assert
  (forall ((temp___1741 Int) (temp___1742 Int) (temp___1743 Int))
  (let ((temp___1740 (aida__conversion__calculate_positive_target_length_2__n__aggregate_def
                     temp___1741 temp___1742 temp___1743)))
  (and
  (=> (dynamic_property6 (first1 source) (+ (first1 source) 1) temp___1742
  temp___1743)
  (and (= (first5 temp___1740) temp___1742)
  (= (last5 temp___1740) temp___1743)))
  (forall ((temp___1744 Int))
...
(define-fun dynamic_invariant4 ((temp___expr_473 us_t1)
  (temp___is_init_470 Bool) (temp___skip_constant_471 Bool)
  (temp___do_toplevel_472 Bool)) Bool (=>
                                      (not (= temp___skip_constant_471 true))
                                      (and (dynamic_property2 (first1 source)
                                      (+ (first1 source) 1)
                                      (first3 temp___expr_473)
                                      (last3 temp___expr_473))
                                      (and
                                      (= (first3 temp___expr_473) (first1
                                                                  source))
                                      (= (last3 temp___expr_473) (+ (first1
                                                                    source) 1))))))
...
;; H
  ...
  (= (to_rep1
     (first4
     (rt2
     (aida__conversion__calculate_positive_target_length_2__n__aggregate_def
     0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1)))))
...
;; H
  (assert
  (= (mk___t2 temp___1746 temp___17461) (aida__conversion__calculate_positive_target_length_2__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___17461)) (to_rep1 (last4 temp___17461)))
     (+ (- (to_rep1 (last4 temp___17461)) (to_rep1 (first4 temp___17461))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 1))
        (+ (- (+ (to_rep1 (first (rt source))) 1) (to_rep1
                                                  (first (rt source)))) 1)
        0)))

;; H
  (assert
  (= (slide1 temp___1746 (to_rep1 (first4 temp___17461))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_2__n__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1))
  aida__conversion__calculate_positive_target_length_2__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_positive_target_length_2__n__assume))
...
;; H
  ...
  (+ (to_rep1 (first (rt source))) 1) (to_rep1 n__first) (to_rep1 n__last))
  (and (= (to_rep1 n__first) (to_rep1 (first (rt source))))
  (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 1)))))

;; H
  (assert
  (and (= temp___1753 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753))
  (= temp___1751 index1)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1750 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1750)
  (<= temp___1750 (to_rep1 n__last)))
  (=> (< index2 temp___1750)
  (= (select n3 temp___1750) (select temp___1749 temp___1750)))))
  (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1))
  (dynamic_property5 (to_rep1 (first (rt source)))
  (+ (to_rep1 (first (rt source))) 1) index2)))
  (and (<= (to_rep1 (first (rt source))) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 1))))))
...
;; H
  (assert
  (and (= temp___1754 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1754)
  (<= temp___1754 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1755 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1755)
  (<= temp___1755 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1757 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1757)
  (<= temp___1757 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= o27 (convert_character_digit_to_integer o26))
  (and (in_range1 o27)
  (and (and (<= 0 o27) (<= o27 9))
  (ite (= (= o26 48) true) (= o27 0)
  (ite (= (= o26 49) true) (= o27 1)
  (ite (= (= o26 50) true) (= o27 2)
  (ite (= (= o26 51) true) (= o27 3)
  (ite (= (= o26 52) true) (= o27 4)
  (ite (= (= o26 53) true) (= o27 5)
  (ite (= (= o26 54) true) (= o27 6)
  (ite (= (= o26 55) true) (= o27 7)
  (ite (= (= o26 56) true) (= o27 8) (=> (= (= o26 57) true) (= o27 9)))))))))))))))

;; H
  (assert
  (and (= temp___1756 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1756)
  (<= temp___1756 (to_rep1 (last (rt source))))))
...
;; H
  ...
  (ite (= (= o21 49) true) (= o22 1)
  (ite (= (= o21 50) true) (= o22 2)
  (ite (= (= o21 51) true) (= o22 3)
  (ite (= (= o21 52) true) (= o22 4)
  (ite (= (= o21 53) true) (= o22 5)
  (ite (= (= o21 54) true) (= o22 6)
  (ite (= (= o21 55) true) (= o22 7)
  (ite (= (= o21 56) true) (= o22 8) (=> (= (= o21 57) true) (= o22 9)))))))))))))))
