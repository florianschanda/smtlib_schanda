...
;; H
  ...
  (forall ((i16 Int))
  (=>
  (and (<= (to_rep1 (first (rt a))) i16)
  (<= i16 (- (int__content location13) 1)))
  (= (to_rep (select (elts a) i16)) (to_rep (select (elts b) i16)))))))

(assert
;; WP_parameter_def
 ;; File "array_algorithms.ads", line 20, characters 0-0
  (not (<= (to_rep1 (first (rt b))) (int__content location13))))
(check-sat)
