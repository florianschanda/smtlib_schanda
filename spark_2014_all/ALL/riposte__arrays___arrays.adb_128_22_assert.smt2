...
(declare-fun dummy1 () (Array Int enum_t))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int enum_t))) (<= 0 (object__component__size a))))
...
(declare-datatypes ()
((map__ref1 (mk_map__ref1 (map__content1 (Array Int (Array Int enum_t)))))))
...
(declare-fun concat2 ((Array Int (Array Int enum_t)) Int Int
  (Array Int (Array Int enum_t)) Int Int) (Array Int (Array Int enum_t)))
...
(declare-fun singleton2 ((Array Int enum_t)
  Int) (Array Int (Array Int enum_t)))

;; singleton_def
  (assert
  (forall ((v (Array Int enum_t)))
  (forall ((i Int))
  (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i)) ))))

(define-fun bool_eq2 ((a (Array Int (Array Int enum_t))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq1 (select a temp___idx_135) 0 2
...
;; bool_eq_rev
  ...
  (= (bool_eq1 (select a temp___idx_135) 0 2
     (select b (+ (- b__first a__first) temp___idx_135)) 0 2) true))))))))
...
(declare-fun mm () (Array Int (Array Int enum_t)))

(declare-fun o () enum_t)

(declare-fun o1 () (Array Int enum_t))

(declare-fun o2 () (Array Int (Array Int enum_t)))

(declare-fun result () (Array Int (Array Int enum_t)))

(declare-fun mm1 () (Array Int (Array Int enum_t)))
