...
;; H
  (assert
  (and
  (= o8 (length (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and (in_range4 o8)
  (<= o8 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o6 (length m)) (and (in_range4 o6) (<= o6 (capacity m))))))
