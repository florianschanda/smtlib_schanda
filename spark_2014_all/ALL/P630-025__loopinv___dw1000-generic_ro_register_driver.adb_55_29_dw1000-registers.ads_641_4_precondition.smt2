...
(declare-fun dw1000__register_types__evc_txfs_type__evc_txfs__first__bit () Int)

(declare-fun dw1000__register_types__evc_txfs_type__evc_txfs__last__bit () Int)

(declare-fun dw1000__register_types__evc_txfs_type__evc_txfs__position () Int)
...
(declare-fun dw1000__register_types__evc_txfs_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__evc_txfs_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__evc_txfs_type__reserved__position () Int)
...
(declare-datatypes ()
((evc_txfs_type__ref (mk_evc_txfs_type__ref (evc_txfs_type__content us_rep)))))
