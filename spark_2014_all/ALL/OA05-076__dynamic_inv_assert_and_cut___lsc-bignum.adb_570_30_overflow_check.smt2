...
;; H
  (assert (and (= o48 o47) (uint_in_range1 o47)))

;; H
  (assert (= o49 ((_ int2bv 64) o48)))

;; H
  (assert (= o50 (bvadd o49 ((_ int2bv 64) 1))))

;; H
  (assert (= o51 (bvmul o50 ((_ int2bv 64) 32))))

;; H
  (assert (= o52 (ite (bvult i2 o51) true false)))

;; H
  (assert (= o44 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o43 (from_word64 i2)))

;; H
  (assert (= o45 (oadd o43 o44)))

;; H
  (assert (= o42 (from_integer j3)))

;; H
  (assert (= o46 (ole o42 o45)))

;; H
  (assert (and (= o40 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o41 (ite (<= j3 o40) true false)))

;; H
  (assert (= o36 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o37 (oexpon o36 j3)))

;; H
  (assert (= o31 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o30 (from_integer j3)))

;; H
  (assert (= o32 (osubtract o30 o31)))

;; H
  (assert (= o29 (from_word64 i2)))

;; H
  (assert (= o33 (osubtract o29 o32)))

;; H
  (assert (= o28 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o34 (oexpon__2 o28 o33)))
...
;; H
  (assert (= o27 (num_of_big_int e e_first o26)))

;; H
  (assert (= o35 (odivide o27 o34)))

;; H
  (assert (= o38 (omod o35 o37)))

;; H
  (assert (and (= o17 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert (= o21 (oexpon o16 o20)))

;; H
  (assert (= o15 (from_word32 w2)))

;; H
  (assert (= o22 (omultiply o15 o21)))

;; H
  (assert (= o39 (oeq o22 o38)))

;; H
  (assert (and (= o10 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o13 (ite (<= n o12) true false)))

;; H
  (assert (= result6 (ite (<= 0 n) o13 false)))
