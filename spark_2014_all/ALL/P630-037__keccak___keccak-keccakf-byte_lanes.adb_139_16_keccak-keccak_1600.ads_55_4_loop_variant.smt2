...
(declare-fun remaining_bytes9 () Int)
...
;; H
  (assert
  (and (= o108 (- remaining_bytes8 1)) (in_range2 (- remaining_bytes8 1))))
...
;; WP_parameter_def
 ;; File "keccak-keccakf-byte_lanes.adb", line 30, characters 0-0
  (not
  (or (< temp___7751 offset9)
  (and (= offset9 temp___7751)
  (or (< temp___7741 shift3)
  (and (= shift3 temp___7741) (< remaining_bytes9 temp___7731)))))))
(check-sat)
(exit)
