...
(declare-fun dummy () tcountB)

(declare-datatypes ()
((tcountB__ref (mk_tcountB__ref (tcountB__content tcountB)))))
(define-fun tcountB__ref___projection ((a tcountB__ref)) tcountB (tcountB__content
                                                                 a))
...
(define-fun positive_count__ref___projection ((a positive_count__ref)) positive_count
...
(assert
;; WP_parameter_def
 ;; File "a-textio.ads", line 68, characters 0-0
