...
;; H
  (assert
  (= (valid_configuration__2 cur_state
     (mk___split_fields cur_piece__split_fields4 cur_piece__split_fields5
     cur_piece__split_fields6 cur_piece__split_fields7) cur_board) true))
...
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  (not (in_range1 (+ action_request_nbr 1))))
(check-sat)
(exit)
