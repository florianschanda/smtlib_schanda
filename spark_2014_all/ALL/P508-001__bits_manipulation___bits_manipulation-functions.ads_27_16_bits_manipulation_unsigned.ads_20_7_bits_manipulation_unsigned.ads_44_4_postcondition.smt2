...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index__result Int)
...
(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index__result1 Int)

(declare-const result__3 Int)

(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index__result2 Int)

(declare-const result__4 Int)

(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index__result3 Int)

(declare-const result__5 Int)

(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index__result4 Int)

(declare-const result__6 Int)

(declare-const bits_manipulation_unsigned__unsigned_32__functions__msb_index__result5 Int)
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index__result1
  bits_manipulation_unsigned__unsigned_32__functions__msb_index__result2))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index__result3
  bits_manipulation_unsigned__unsigned_32__functions__msb_index__result1))
...
;; H
  (assert
  (= result2 bits_manipulation_unsigned__unsigned_32__functions__msb_index__result))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index__result5
  bits_manipulation_unsigned__unsigned_32__functions__msb_index__result3))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  (not
  (= (shift_right value
     bits_manipulation_unsigned__unsigned_32__functions__msb_index__result4) ((_ int2bv 32) 1))))
(check-sat)
(exit)
