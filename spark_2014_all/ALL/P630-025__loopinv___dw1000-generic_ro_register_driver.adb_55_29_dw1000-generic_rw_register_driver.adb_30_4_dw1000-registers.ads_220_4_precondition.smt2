...
(define-fun register_type__ref___17__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___12__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___12__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2275 us_t1)
  (temp___is_init_2272 Bool) (temp___skip_constant_2273 Bool)
  (temp___do_toplevel_2274 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2273 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2275)
                                       (last3 temp___expr_2275))
                                       (and (= (first3 temp___expr_2275) 1)
                                       (= (last3 temp___expr_2275) 5)))))
