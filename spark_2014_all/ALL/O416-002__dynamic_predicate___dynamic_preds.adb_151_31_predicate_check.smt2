...
(declare-const dynamic_preds__update_even_close_pair__x__compl even)

(declare-const dynamic_preds__update_even_close_pair__x__compl1 even)

(declare-const dynamic_preds__update_even_close_pair__x__fields even)

(declare-const dynamic_preds__update_even_close_pair__x__fields1 even)
...
(define-fun dynamic_preds__update_even_close_pair__x__fields2 () us_split_fields
  (mk___split_fields dynamic_preds__update_even_close_pair__x__fields
  dynamic_preds__update_even_close_pair__x__fields1))
...
;; H
  (assert (= (to_rep x__split_fields1) (+ (to_rep x__split_fields) 2)))

;; H
  (assert
  (= x__split_fields dynamic_preds__update_even_close_pair__x__compl))

;; H
  (assert
  (= x__split_fields1 dynamic_preds__update_even_close_pair__x__compl1))

;; H
  (assert (dynamic_invariant2
  (mk___rep dynamic_preds__update_even_close_pair__x__fields2) true true
  true))
...
;; H
  (assert
  (= (mk___split_fields x__split_fields2 x__split_fields3) dynamic_preds__update_even_close_pair__x__fields2))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds.ads", line 25, characters 0-0
  (not (= (to_rep x__split_fields3) (+ (to_rep x__split_fields2) 2))))
(check-sat)
(exit)
