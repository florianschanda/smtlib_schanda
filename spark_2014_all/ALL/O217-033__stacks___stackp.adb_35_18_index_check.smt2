...
(declare-datatypes ((t25s__ref 0)) (((mk_t25s__ref (t25s__content t25s)))))
...
(declare-const temp___583 positive_less_than_max)

(declare-const temp___5831 (Array Int element))

(declare-const temp___5832 less_than_max)

(declare-const temp___5833 us_private)

(declare-const temp___5834 Int)
...
;; H
  (assert
  (and (= temp___585 (last2 (mk___rep1 s__split_fields8 s__attr__tag)))
