...
(declare-fun dummy4 () coordinate_type)
...
(declare-fun dummy5 () radius_type)
...
;; make_circle__post_axiom
  (assert
  (forall ((x Int) (y Int) (radius Int) (shapes5__wild_man Int))
  (! (=>
     (and
     (and
...
(declare-fun my_circle__split_fields () coordinate_type)

(declare-fun my_circle__split_fields1 () coordinate_type)

(declare-fun my_circle__split_fields2 () radius_type)

(declare-fun temp___534 () coordinate_type)

(declare-fun temp___5341 () coordinate_type)

(declare-fun temp___5342 () radius_type)

(declare-fun result () coordinate_type)

(declare-fun result1 () coordinate_type)

(declare-fun result2 () radius_type)

(declare-fun my_circle__split_fields3 () coordinate_type)

(declare-fun my_circle__split_fields4 () coordinate_type)

(declare-fun my_circle__split_fields5 () radius_type)
...
;; H
  (assert
  (and (= temp___5343 (make_circle 0 0 5 wild_man))
