...
;; H
  (assert
  (and (= o105 (- offset8 initial_offset1)) (in_range1
...
;; H
  (assert (= o108 (ite (= shift2 o107) true false)))

;; H
  (assert
  (=> (<= (to_rep data__first) (to_rep data__last))
  (= o103 (+ (- (to_rep data__last) (to_rep data__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep data__first) (to_rep data__last))) (= o103 0)))
...
;; WP_parameter_def
 ;; File "keccak-keccakf-byte_lanes.adb", line 30, characters 0-0
  (not (in_range1 (+ offset8 remaining_bytes8))))
(check-sat)
(exit)
