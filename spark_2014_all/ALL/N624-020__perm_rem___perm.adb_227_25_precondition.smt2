...
;; H
  (assert
  (and (= o30 (remove b ib1))
  (and (dynamic_invariant2 o30 true false true)
  (and (= (invariant__ o30) true)
  (and (= (to_rep2 (last o25)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o24 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o24 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o24 k))))))))))))

;; H
  (assert
  (and (= o29 (remove o30 o26))
  (and (dynamic_invariant2 o29 true false true)
  (and (= (invariant__ o29) true)
  (and (= (to_rep2 (last o28)) (- (to_rep2 (last o25)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o26 1)))
  (= (to_rep (select o24 k)) (to_rep (select o27 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o26 1) k) (<= k (to_rep2 (last o25))))
  (= (to_rep (select o24 k)) (to_rep (select o27 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o26 k) (<= k (- (to_rep2 (last o25)) 1)))
  (= (to_rep (select o24 (+ k 1))) (to_rep (select o27 k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last o23)) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select o22 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select o22 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o22 k))))))))))))
