...
(((mk___split_fields (rec__dic__pr_t__x integer)))))
...
(declare-const dic__pr_t__x__first__bit Int)

(declare-const dic__pr_t__x__last__bit Int)

(declare-const dic__pr_t__x__position Int)
...
(declare-datatypes ((pr_t__ref 0)) (((mk_pr_t__ref (pr_t__content us_rep)))))
...
(((mk_pr_record_t__ref (pr_record_t__content us_rep1)))))
