...
(declare-const prev us_rep1)

(declare-const attr__ATTRIBUTE_ADDRESS4 Int)

(declare-const nxt us_rep1)
...
(declare-const p__nearly_identity__prev__assume count_type)

(declare-const p__nearly_identity__nxt__assume count_type)
