...
(declare-fun prev () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun nxt () us_rep1)
...
;; length__post_axiom
  ...
  (! (let ((result (length2 container)))
     ...
     (dynamic_invariant2 result true false true))) :pattern ((length2
                                                             container)) )))
...
(declare-fun dummy7 () positive_count_type)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant2 (length1 container)
...
(declare-fun p__nearly_identity__prev__assume () count_type)

(declare-fun p__nearly_identity__nxt__assume () count_type)

(declare-fun result () Int)

(declare-fun e1 () Int)

(define-fun p__nearly_identity__nxt__assume1 () us_rep1 (mk___rep1
                                                        (mk___split_fields1
                                                        p__nearly_identity__nxt__assume)))

(define-fun p__nearly_identity__prev__assume1 () us_rep1 (mk___rep1
                                                         (mk___split_fields1
                                                         p__nearly_identity__prev__assume)))
...
;; H
  (assert
  (and
  (= p__nearly_identity__prev__assume1 (previous
                                       (mk___rep l__split_discrs
                                       (mk___split_fields l__split_fields))
                                       (mk___rep1
                                       (mk___split_fields1 cu__split_fields))))
  (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields))
                  no_element) false) (= (get1
                                        (positions
                                        (mk___rep l__split_discrs
                                        (mk___split_fields l__split_fields)))
                                        (mk___rep1
                                        (mk___split_fields1 cu__split_fields))) 1) true) true)
  (= (bool_eq1 p__nearly_identity__prev__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     p__nearly_identity__prev__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     p__nearly_identity__prev__assume1) (- (get1
                                           (positions
                                           (mk___rep l__split_discrs
                                           (mk___split_fields
                                           l__split_fields)))
...
;; H
  (assert (= p__nearly_identity__prev__assume1 prev))

;; H
  (assert
  (and
  (= p__nearly_identity__nxt__assume1 (next
                                      (mk___rep l__split_discrs
                                      (mk___split_fields l__split_fields))
                                      (mk___rep1
                                      (mk___split_fields1 cu__split_fields))))
  (ite (= (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields))
                  no_element) false) (= (get1
                                        ...
                                        (mk___split_fields1 cu__split_fields)))
          (length2
          (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true) true)
  (= (bool_eq1 p__nearly_identity__nxt__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     p__nearly_identity__nxt__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     p__nearly_identity__nxt__assume1) (+ (get1
                                          (positions
                                          (mk___rep l__split_discrs
                                          (mk___split_fields l__split_fields)))
                                          (mk___rep1
...
;; H
  (assert (= p__nearly_identity__nxt__assume1 nxt))
