...
(define-fun default_initial_assumption ((temp___expr_263 us_rep)
  (temp___skip_top_level_264 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_264 true))
                                         (= (length temp___expr_263) 0)))
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     (and (<= (+ 0 result) 1000) (dynamic_invariant2 result true false true))) :pattern (
  (length container)) )))
