...
(define-fun dynamic_invariant2 ((temp___expr_144 us_rep)
...
(declare-fun x__split_fields () even)

(declare-fun x__split_fields1 () even)
...
(declare-fun temp___302 () even)

(declare-fun temp___3021 () even)

(declare-fun result () even)

(declare-fun result1 () even)

(declare-fun x__split_fields2 () even)

(declare-fun x__split_fields3 () even)
...
;; H
  (assert (= temp___302 o2))

;; H
  (assert (= temp___3021 o3))
...
;; H
  (assert (= x__split_fields2 temp___302))

;; H
  (assert (= x__split_fields3 temp___3021))
