...
(define-fun us_split_fields__ref___14__projection ((a us_split_fields__ref)) us_split_fields
...
(declare-datatypes ((rx_buffer_type__ref 0))
...
(define-fun register_type__ref___32__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___23__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___23__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2885 us_t1)
  (temp___is_init_2882 Bool) (temp___skip_constant_2883 Bool)
  (temp___do_toplevel_2884 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2883 true))
                                       (and (dynamic_property2 1 1024
                                       (first3 temp___expr_2885)
                                       (last3 temp___expr_2885))
                                       (and (= (first3 temp___expr_2885) 1)
                                       (= (last3 temp___expr_2885) 1024)))))
