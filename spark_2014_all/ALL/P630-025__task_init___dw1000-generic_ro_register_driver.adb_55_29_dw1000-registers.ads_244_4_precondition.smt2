...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__rx_buffer_type__rx_buffer (Array Int bits_8))))))
(define-fun us_split_fields_RX_BUFFER__projection ((a us_split_fields)) (Array Int bits_8)
  (rec__dw1000__register_types__rx_buffer_type__rx_buffer a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_14__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (bool_eq
                           (rec__dw1000__register_types__rx_buffer_type__rx_buffer
...
(declare-fun dw1000__register_types__rx_buffer_type__rx_buffer__first__bit () Int)

(declare-fun dw1000__register_types__rx_buffer_type__rx_buffer__last__bit () Int)

(declare-fun dw1000__register_types__rx_buffer_type__rx_buffer__position () Int)

;; dw1000__register_types__rx_buffer_type__rx_buffer__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rx_buffer_type__rx_buffer__first__bit))

;; dw1000__register_types__rx_buffer_type__rx_buffer__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_buffer_type__rx_buffer__first__bit dw1000__register_types__rx_buffer_type__rx_buffer__last__bit))

;; dw1000__register_types__rx_buffer_type__rx_buffer__position_axiom
...
(declare-datatypes ()
((rx_buffer_type__ref
 (mk_rx_buffer_type__ref (rx_buffer_type__content us_rep)))))
(define-fun rx_buffer_type__ref___projection ((a rx_buffer_type__ref)) us_rep
  (rx_buffer_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_32__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_23__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_23__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2863 us_t1)
  (temp___is_init_2860 Bool) (temp___skip_constant_2861 Bool)
  (temp___do_toplevel_2862 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2861 true))
                                       (and (dynamic_property2 1 1024
                                       (first3 temp___expr_2863)
                                       (last3 temp___expr_2863))
                                       (and (= (first3 temp___expr_2863) 1)
                                       (= (last3 temp___expr_2863) 1024)))))
