...
;; H
  (assert
  (= o14 (statusiswaitingfinishadminop (let ((subject state)) state15))))

;; H
  (assert
  (= o15 (statusiswaitingstartadminop (let ((subject state)) state15))))
...
;; H
  (assert
  (= o10 (statusiswaitingremoveadmintokenfail
         (let ((subject state)) state15))))

;; H
  (assert (= o11 (statusisgotadmintoken (let ((subject state)) state15))))
...
;; H
  (assert
  (=> (= result6 true)
  (= o9 (statusiswaitingstartadminop (let ((subject state)) state15)))))
