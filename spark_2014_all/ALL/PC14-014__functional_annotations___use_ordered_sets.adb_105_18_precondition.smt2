...
;; H
  (assert
  (and (= o3 (length (mk___rep s2__split_discrs s2__split_fields1)))
  (and (in_range2 o3)
  (<= o3 (to_rep
...
;; H
  (assert
  (and (= o2 (elements (mk___rep s1__split_discrs s1__split_fields1)))
  (and
  (and
  (and
  (= (length2 o2) (length (mk___rep s1__split_discrs s1__split_fields1)))
  (forall ((temp___390 Int))
  (=> (and (in_range4 temp___390) (= (iter_has_element o2 temp___390) true))
  (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields1))
     (get o2 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range6 item)
  (= (contains (model__ (mk___rep s1__split_discrs s1__split_fields1)) item) true))
  (and (< 0 (find o2 item))
