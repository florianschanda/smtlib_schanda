...
(((mk_times__ref (times__content times)))))
...
;; H
  (assert (= (mk_int__ref result) (mk_int__ref t)))

;; H
  (assert (= t1 (mod2 (+ t clockoffset) 86400)))
...
(assert
;; WP_parameter_def
 ;; File "heatingsystem_dfa.adb", line 77, characters 0-0
  (not (= t2 (mod2 (+ t clockoffset) 86400))))
(check-sat)
(exit)
