...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (=> (= result3 true) (= (mk_map__ref1 result4) cur_board9))))
...
;; H
  (assert
  (and (= o (+ num_deleted1 (int__content to_line6))) (in_range1
  (+ num_deleted1 (int__content to_line6)))))

(assert
;; WP_parameter_def
 ;; File "tetris_functional.ads", line 170, characters 0-0
  (not (in_range1 (+ num_deleted2 to_line8))))
(check-sat)
(exit)
