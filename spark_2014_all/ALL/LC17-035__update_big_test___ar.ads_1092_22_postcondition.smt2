...
(declare-fun temp___7255 () us_rep3)

(declare-fun o17 () enum1t)

(declare-fun o18 () us_split_fields6)

(declare-fun temp___7257 () us_rep3)
...
;; H
  (assert
  (and (= o (to_rep4 r__split_fields5)) (in_range5
...
;; H
  (assert (= temp___7255 (mk___rep3 o16)))
...
;; H
  (assert (= r__split_fields6 (us_split_fields7 temp___7255)))
...
;; H
  (assert (= temp___7257 (mk___rep3 o18)))

;; H
  (assert (= result2 (mk___split_fields__ref3 r__split_fields6)))

;; H
  (assert (= r__split_fields7 (us_split_fields7 temp___7257)))
