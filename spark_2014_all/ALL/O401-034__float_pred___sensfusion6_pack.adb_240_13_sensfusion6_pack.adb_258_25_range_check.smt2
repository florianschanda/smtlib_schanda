...
;; H
  (assert
  (and (= o100 (mul RNE1 (let ((subject q1_tmp)) q1_tmp1) recip_norm3))
  (tqtisFinite (mul RNE1 (let ((subject q1_tmp)) q1_tmp1) recip_norm3))))
...
;; H
  (assert
  (and (= o103 (mul RNE1 (let ((subject q2_tmp)) q2_tmp1) recip_norm3))
  (tqtisFinite (mul RNE1 (let ((subject q2_tmp)) q2_tmp1) recip_norm3))))
