...
;; H
  ...
  (and
  (and
  (and (=> (= (to_rep1 current_date__split_fields1) 1) (= o 31))
  (=> (= (to_rep1 current_date__split_fields1) 2) (or (= o 28) (= o 29))))
  (=> (= (to_rep1 current_date__split_fields1) 3) (= o 31)))
  (=> (= (to_rep1 current_date__split_fields1) 4) (= o 30)))
  (=> (= (to_rep1 current_date__split_fields1) 5) (= o 31)))
  (=> (= (to_rep1 current_date__split_fields1) 6) (= o 30)))
  (=> (= (to_rep1 current_date__split_fields1) 7) (= o 31)))
  (=> (= (to_rep1 current_date__split_fields1) 8) (= o 31)))
  (=> (= (to_rep1 current_date__split_fields1) 9) (= o 30)))
  (=> (= (to_rep1 current_date__split_fields1) 10) (= o 31)))
  (=> (= (to_rep1 current_date__split_fields1) 11) (= o 30)))
  (=> (= (to_rep1 current_date__split_fields1) 12) (= o 31))))))

;; H
  (assert
  (= result (ite (< (to_rep2 current_date__split_fields) o) true false)))
