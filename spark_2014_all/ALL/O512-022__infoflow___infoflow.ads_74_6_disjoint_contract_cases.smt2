...
;; WP_parameter_def
 ;; File "infoflow.ads", line 61, characters 0-0
  (not
  (<= (+ (+ 0 (ite (= (ite (= (ite (= (ite (= (ite (= (ite (<= (to_rep
                                                               h_v1__first)
                                                      i)
                                                      (ite (<= i (to_rep
                                                                 h_v1__last))
                                                      (= (to_rep h_v1__first) 1)
                                                      false) false) true) (=
                                              (to_rep h_v2__first) 1) false) true) (=
                                      (to_rep h_v1__last) (to_rep h_v2__last)) false) true) (<=
                              i (div1 (to_rep h_v1__last) 2)) false) true) (=
                      (to_rep1
                      (select h_v1 (+ i (div1 (to_rep h_v1__last) 2))))
                      (to_rep1
                      (select h_v2 (+ i (div1 (to_rep h_v2__last) 2))))) false) true)
              1 0)) (ite (= (ite (= (ite (= (ite (= (ite (= (ite (<=
                                                            (to_rep
                                                            h_v1__first)
                                                            i)
                                                            (ite (<=
                                                            ...
                                                            false) false) true) (=
                                                    (to_rep h_v2__first) 1) false) true) (=
                                            (to_rep h_v1__last) (to_rep
                                                                h_v2__last)) false) true) (>
                                    i (div1 (to_rep h_v1__last) 2)) false) true) (=
                            (to_rep1
                            (select h_v1 (- i (div1 (to_rep h_v1__last) 2))))
                            (to_rep1
