...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__otp_rdat_type__otp_rdat bits_32)))))
(define-fun us_split_fields_OTP_RDAT__projection ((a us_split_fields)) bits_32
  (rec__dw1000__register_types__otp_rdat_type__otp_rdat a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_77__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_77__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__otp_rdat_type__otp_rdat
...
(declare-fun dw1000__register_types__otp_rdat_type__otp_rdat__first__bit () Int)

(declare-fun dw1000__register_types__otp_rdat_type__otp_rdat__last__bit () Int)

(declare-fun dw1000__register_types__otp_rdat_type__otp_rdat__position () Int)

;; dw1000__register_types__otp_rdat_type__otp_rdat__first__bit_axiom
  (assert (<= 0 dw1000__register_types__otp_rdat_type__otp_rdat__first__bit))

;; dw1000__register_types__otp_rdat_type__otp_rdat__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_rdat_type__otp_rdat__first__bit dw1000__register_types__otp_rdat_type__otp_rdat__last__bit))

;; dw1000__register_types__otp_rdat_type__otp_rdat__position_axiom
...
(declare-datatypes ()
((otp_rdat_type__ref (mk_otp_rdat_type__ref (otp_rdat_type__content us_rep)))))
(define-fun otp_rdat_type__ref___projection ((a otp_rdat_type__ref)) us_rep
  (otp_rdat_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_188__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_132__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_132__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6407 us_t1)
  (temp___is_init_6404 Bool) (temp___skip_constant_6405 Bool)
  (temp___do_toplevel_6406 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6405 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6407)
                                       (last3 temp___expr_6407))
                                       (and (= (first3 temp___expr_6407) 1)
                                       (= (last3 temp___expr_6407) 4)))))
