...
(define-fun us_split_fields__ref___77__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___77__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-datatypes ((otp_rdat_type__ref 0))
(((mk_otp_rdat_type__ref (otp_rdat_type__content us_rep)))))
...
(define-fun register_type__ref___188__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___132__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___132__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6527 us_t1)
  (temp___is_init_6524 Bool) (temp___skip_constant_6525 Bool)
  (temp___do_toplevel_6526 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6525 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6527)
                                       (last3 temp___expr_6527))
                                       (and (= (first3 temp___expr_6527) 1)
                                       (= (last3 temp___expr_6527) 4)))))
