...
;; H
  ...
  (and (in_range5 o24)
  (=> (= (of_int 0) true)
  (and (= o24 (w_get o20 (witness o20 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o20 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o20 cu) (witness o20 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o18 j) true)
  (=> (= (get1 o18 i3) (get1 o18 j)) (= (bool_eq1 i3 j) true))))))))))

;; H
  (assert
  (and (= o19 (has_key o18 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o18 k) true) (= (bool_eq1 k cu) true))) (= o19 true)))))
...
;; H
  ...
  (= o14 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o14)
  (<= o14 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
