...
(declare-const temp___7676 (Array Int bits_8))

(declare-const temp___76761 t2)

(declare-const temp___7677 (Array Int bits_8))

(declare-const temp___76771 t1)
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76761)) (to_rep (last4 temp___76761)))
  temp___76771))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76771)) (to_rep (last2 temp___76771)))
     (+ (- (to_rep (last2 temp___76771)) (to_rep (first2 temp___76771))) 1)
