...
(define-fun bool_eq2 ((a us_rep2)
  (b us_rep2)) Bool (ite (and
                         ...
                         (to_rep (rec__ar__rec3t__g3 (us_split_fields5 b)))))
                    true false))
...
(define-fun dynamic_invariant3 ((temp___expr_194 Int)
  ...
  (temp___do_toplevel_193 Bool)) Bool (=>
                                      ...
                                      (<= 50 59)) (in_range temp___expr_194)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 991, characters 0-0
  (not
  (= (bool_eq1
     (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields11))
     (mk___rep1
