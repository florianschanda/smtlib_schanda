...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__cursors__r__b Bool)))))
...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__cursors__r__c us_rep)))))
...
(declare-fun cursors__r__b__first__bit () Int)

(declare-fun cursors__r__b__last__bit () Int)

(declare-fun cursors__r__b__position () Int)
...
(declare-fun cursors__r__c__first__bit () Int)

(declare-fun cursors__r__c__last__bit () Int)

(declare-fun cursors__r__c__position () Int)
...
(declare-fun cursors__r__b__first__bit1 () Int)

(declare-fun cursors__r__b__last__bit1 () Int)

(declare-fun cursors__r__b__position1 () Int)
...
(declare-fun cursors__r__c__first__bit1 () Int)

(declare-fun cursors__r__c__last__bit1 () Int)

(declare-fun cursors__r__c__position1 () Int)
