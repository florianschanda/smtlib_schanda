...
;; H
  (assert (and (= o24 (- e_last e_first)) (in_range1 (- e_last e_first))))

;; H
  (assert (and (= o25 o24) (uint_in_range1 o24)))

;; H
  (assert (= o26 ((_ int2bv 64) o25)))

;; H
  (assert (= o27 (bvadd o26 ((_ int2bv 64) 1))))

;; H
  (assert (= o28 (bvmul o27 ((_ int2bv 64) 32))))

;; H
  (assert (= o29 (ite (bvult i2 o28) true false)))

;; H
  (assert (= o21 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (= o19 (from_integer j3)))

;; H
  (assert (= o23 (ole o19 o22)))

;; H
  (assert (and (= o17 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o18 (ite (<= j3 o17) true false)))

;; H
  (assert (= o15 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o16 (oexpon o15 j3)))

;; H
  (assert (= o11 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o10 (from_integer j3)))

;; H
  (assert (= o12 (osubtract o10 o11)))

;; H
  (assert (= o9 (from_word64 i2)))

;; H
  (assert (= o13 (osubtract o9 o12)))

;; H
  (assert (= o8 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o14 (oexpon__2 o8 o13)))
