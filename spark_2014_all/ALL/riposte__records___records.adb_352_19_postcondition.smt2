...
(declare-fun records__is_null_a__result () Bool)

(declare-fun result () Bool)

(declare-fun records__is_null_a__result1 () Bool)

(declare-fun records__is_null_a__result2 () Bool)

(declare-fun records__is_null_a__result3 () Bool)

(declare-fun records__is_null_a__result4 () Bool)

(declare-fun records__is_null_a__result5 () Bool)
...
;; H
  (assert
  (= (mk_bool__ref records__is_null_a__result4) (mk_bool__ref
                                                records__is_null_a__result2)))
