...
(define-fun y7 () int__ref (mk_int__ref y1))

(define-fun y8 () int__ref (mk_int__ref y))
...
;; H
  (assert
  (=> (bvule x2 ((_ int2bv 32) 2147483647))
  (and (= o18 (bv2nat x2)) (in_range1 (bv2nat x2)))))

;; H
  (assert (=> (bvule x2 ((_ int2bv 32) 2147483647)) (= result1 y8)))

;; H
  (assert (=> (bvule x2 ((_ int2bv 32) 2147483647)) (= y3 o18)))

;; H
  (assert
  (=> (not (bvule x2 ((_ int2bv 32) 2147483647)))
  (and (= o19 (bv2nat (bvnot x2))) (in_range1 (bv2nat (bvnot x2))))))

;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= o20 (- o19))))

;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= o21 (- o20 1))))
...
;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= result2 y8)))

;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= y4 o22)))

;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= y3 y4)))

;; H
  (assert (= (to_rep1 o23) y3))
...
;; H
  ...
  (and (= o50 (bv2nat x3)) (in_range1 (bv2nat x3)))))

;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= result5 y7)))

;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= y5 o50)))

;; H
  (assert
  (=> (not (bvule x3 ((_ int2bv 32) 2147483647)))
  (and (= o51 (bv2nat (bvnot x3))) (in_range1 (bv2nat (bvnot x3))))))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= o52 (- o51))))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= o53 (- o52 1))))
...
;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= result6 y7)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y6 o54)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y5 y6)))

;; H
  (assert (= (to_rep1 o55) y5))
...
;; H
  (assert (= o64 (select temp___429 1)))

;; H
  (assert (= o65 (to_rep o64)))

;; H
  (assert (= o66 ((_ zero_extend 24) o65)))

;; H
  (assert (= o67 (bvshl o66 ((_ int2bv 32) 24))))
