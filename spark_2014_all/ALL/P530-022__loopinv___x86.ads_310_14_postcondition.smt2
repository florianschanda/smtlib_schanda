...
(declare-fun x86__bh__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__bh__result1 () (_ BitVec 8))

(declare-fun x86__bh__result2 () (_ BitVec 8))

(declare-fun x86__bh__result3 () (_ BitVec 8))

(declare-fun x86__bh__result4 () (_ BitVec 8))

(declare-fun x86__bh__result5 () (_ BitVec 8))
...
;; H
  (assert (= result x86__bh__result))

;; H
  (assert
  (= x86__bh__result1 ((_ extract 7 0) (bvudiv (bvand rbx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= x86__bh__result4 (readreghigh8 rbx))))
(check-sat)
(exit)
