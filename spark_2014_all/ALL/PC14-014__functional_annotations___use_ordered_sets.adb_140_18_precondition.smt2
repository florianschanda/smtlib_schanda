...
;; H
  ...
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) i1)
  (get
...
;; H
  ...
  (=> (and (in_range4 temp___390) (= (iter_has_element o3 temp___390) true))
  (= (contains
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (get o3 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range6 item)
  (= (contains
  ...
  (and (< 0 (find o3 item))
  (= (equivalent_elements (get o3 (find o3 item)) item) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length
         (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))
  (and (= (find o3 (get o3 i1)) i1) (= (e_is_find o3 (get o3 i1) i1) true)))))))
...
;; H
  (assert
  (and (= o2 (elements (mk___rep s2__split_discrs s2__split_fields2)))
  (and
  (and
  (and
  (= (length2 o2) (length (mk___rep s2__split_discrs s2__split_fields2)))
  (forall ((temp___390 Int))
  ...
  (=>
  (and (in_range6 item)
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) item) true))
  (and (< 0 (find o2 item))
