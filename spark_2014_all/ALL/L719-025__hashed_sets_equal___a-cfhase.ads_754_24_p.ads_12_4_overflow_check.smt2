...
(define-fun o9 () us_rep (mk___rep (mk___split_discrs o o1)
...
;; H
  (assert
  (= o7 (- (to_rep (rec__p__my_sets__set__capacity target__split_discrs))
  o6)))
...
;; H
  ...
  (= (ole (model__ o9) (model__ source)) true))
  (= (includes_intersection (model__ o9)
     (model__
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source)) true))
  (= (e_elements_included (elements o9)
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true))
  (= (e_elements_included__2
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source) (elements o9)) true))))

;; H
  (assert (and (= o3 (length o9)) (and (in_range1 o3) (<= o3 (to_rep o)))))

;; H
  (assert
  (and (= o4 (length source))
  (and (in_range1 o4)
  (<= o4 (to_rep (rec__p__my_sets__set__capacity (us_split_discrs1 source)))))))
