...
;; H
  (assert (= (to_rep o2) (to_rep (get a1 0 1 2))))

;; H
  (assert (= o3 (set a1 i j k o2)))
...
(assert
;; WP_parameter_def
 ;; File "arrays_multidim.adb", line 159, characters 0-0
  (not (= (to_rep (get a3 i j k)) (to_rep (get a3 j i k)))))
(check-sat)
(exit)
