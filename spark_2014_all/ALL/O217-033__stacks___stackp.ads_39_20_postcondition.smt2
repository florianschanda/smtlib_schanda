...
(declare-fun dummy9 () t19s)

(declare-datatypes () ((t19s__ref (mk_t19s__ref (t19s__content t19s)))))
...
(declare-fun dummy10 () positive_less_than_max)
...
(declare-fun stackp__stack_root__content__first__bit2 () Int)

(declare-fun stackp__stack_root__content__last__bit2 () Int)

(declare-fun stackp__stack_root__content__position2 () Int)
...
(declare-fun stackp__stack_root__length__first__bit2 () Int)

(declare-fun stackp__stack_root__length__last__bit2 () Int)

(declare-fun stackp__stack_root__length__position2 () Int)
...
(declare-fun s__split_fields () (Array Int element))

(declare-fun s__split_fields1 () less_than_max)

(declare-fun s__split_fields2 () us_private)
...
(declare-fun o6 () less_than_max)

(declare-fun o7 () us_private)

(declare-fun temp___470 () (Array Int element))

(declare-fun temp___4701 () less_than_max)

(declare-fun temp___4702 () us_private)

(declare-fun temp___4703 () Int)
...
(declare-fun s__split_fields3 () (Array Int element))

(declare-fun s__split_fields4 () less_than_max)

(declare-fun s__split_fields5 () us_private)

(declare-fun s__split_fields6 () (Array Int element))

(declare-fun s__split_fields7 () less_than_max)

(declare-fun s__split_fields8 () us_private)
