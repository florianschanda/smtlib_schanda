...
(declare-datatypes ((model____ref 0))
(((mk_model____ref (model____content us_t)))))
...
(declare-fun user_eq9 (t19s t19s) Bool)

(declare-const dummy9 t19s)

(declare-datatypes ((t19s__ref 0)) (((mk_t19s__ref (t19s__content t19s)))))
(define-fun t19s__ref___projection ((a t19s__ref)) t19s (t19s__content a))

(declare-fun temp___213 (Int) (Array Int element))

;; def_axiom
  (assert
  (forall ((temp___215 Int))
  (= (select (temp___213 temp___215) 1) (of_rep1 temp___215))))
...
(declare-fun user_eq10 (positive_less_than_max positive_less_than_max) Bool)

(declare-const dummy10 positive_less_than_max)
...
;; range_axiom
  (assert
  (forall ((x positive_less_than_max)) (! (in_range6
...
;; stackp__stack_root__content__last__bit_axiom
  (assert
  (< stackp__stack_root__content__first__bit2 stackp__stack_root__content__last__bit2))
...
;; stackp__stack_root__length__last__bit_axiom
  (assert
  (< stackp__stack_root__length__first__bit2 stackp__stack_root__length__last__bit2))
...
(((mk_buffer__ref (buffer__content us_rep1)))))
...
(((mk_t49s__ref (t49s__content integer)))))
...
(declare-datatypes ((t50s__ref 0)) (((mk_t50s__ref (t50s__content us_t1)))))
(define-fun t50s__ref___projection ((a t50s__ref)) us_t1 (t50s__content a))

;; get_model__2__post_axiom
  (assert
  (forall ((s us_rep))
  (! (let ((result (get_model__2 s)))
     (and (= (length result) (size s)) (dynamic_invariant4 result true false
     true))) :pattern ((get_model__2 s)) )))

;; get_model__2__post__dispatch_axiom
  (assert
  (forall ((attr__tag2 Int))
  (forall ((s us_rep))
  (! (let ((result (get_model__21 attr__tag2 s)))
     (and (= (length result) (size s)) (dynamic_invariant4 result true false
     true))) :pattern ((get_model__21 attr__tag2 s)) ))))

;; stackp__stack__compat_axiom
  (assert
  (forall ((s us_rep))
  (! (= (get_model__2 s) (get_model__21 us_tag1 s)) :pattern ((get_model__21
                                                              us_tag1 s)) )))

;; stackp__buffer__compat_axiom
  (assert
  (forall ((s us_rep))
  (! (= (get_model__3 (of_base s)) (get_model__21 us_tag2 s)) :pattern (
  (get_model__21 us_tag2 s)) )))

;; get_model__2__def_axiom
  (assert
  (forall ((s us_rep))
  (! (= (get_model__2 s) (let ((temp___298 (let ((temp___296 (to_rep
                                                             (rec__stackp__stack_root__length
                                                             (us_split_fields1
                                                             s)))))
                                           (let ((temp___295 1))
                                           (let ((temp___297 (rec__stackp__stack_root__content
                                                             (us_split_fields1
                                                             s))))
                                           (of_array1 temp___297 temp___295
                                           temp___296))))))
                         (of_array (to_array1 temp___298) (first3 temp___298)
                         (last3 temp___298)))) :pattern ((get_model__2 s)) )))
...
(((mk_telement_arrayB__ref (telement_arrayB__content us_t2)))))
(define-fun telement_arrayB__ref___projection ((a telement_arrayB__ref)) us_t2
  (telement_arrayB__content a))

(define-fun default_initial_assumption2 ((temp___expr_361 us_rep1)
...
(declare-datatypes ((t82s__ref 0))
(((mk_t82s__ref (t82s__content integer)))))
...
(declare-datatypes ((t83s__ref 0)) (((mk_t83s__ref (t83s__content us_t3)))))
...
(declare-datatypes ((t85s__ref 0))
(((mk_t85s__ref (t85s__content integer)))))
...
(declare-datatypes ((t86s__ref 0)) (((mk_t86s__ref (t86s__content us_t4)))))
...
(declare-datatypes ((t88s__ref 0))
(((mk_t88s__ref (t88s__content integer)))))
...
(define-fun length5 ((a us_t5)) Int (ite (<= (first11 a) (last13 a))
...
(define-fun bool_eq8 ((x us_t5)
  (y us_t5)) Bool (bool_eq (elts5 x) (to_rep2 (first10 (rt5 x)))
                  ...
                  (to_rep2 (first10 (rt5 y))) (to_rep2 (last12 (rt5 y)))))

(declare-fun user_eq20 (us_t5 us_t5) Bool)

(declare-const dummy20 us_t5)

(declare-datatypes ((t89s__ref 0)) (((mk_t89s__ref (t89s__content us_t5)))))
...
;; stackp__buffer__compat_axiom
  (assert
  (forall ((s us_rep1))
  (! (= (get_model__3 s) (get_model__31 us_tag2 s)) :pattern ((get_model__31
                                                              us_tag2 s)) )))
...
;; get_model__3__def_axiom
  ...
  (! (= (get_model__3 s) (ite (= (wraps_around s) true)
                         (let ((stackp__get_model__3__R84s (last6 s)))
                         (let ((temp___394 (let ((temp___393 (let ((temp___390 1))
                                           ...
                                           (let ((temp___392 (let ((temp___388 100))
                                                             ...
                                                             temp___387
                                                             temp___388))))))
                                           (ite (= (length3 temp___392) 0)
                                           (of_array2 (to_array4 temp___393)
                                           (first9 temp___393)
                                           (last11 temp___393))
                                           (of_array2
                                           (slide
                                           (concat1 (to_array3 temp___392)
                                           (first7 temp___392)
                                           (last9 temp___392)
                                           (to_array4 temp___393)
                                           (first9 temp___393)
                                           (last11 temp___393))
                                           (first7 temp___392) 1) 1
                                           (- (+ 1 (+ (ite (<= (first7
                                                               temp___392)
                                                      (last9 temp___392))
                                                      (+ (- (last9
                                                      ...
                                                      0) (ite (<= (first9
                                                         ...
                                                         (first9 temp___393)) 1)
                                                         0))) 1)))))))
                         (of_array (to_array2 temp___394) (first5 temp___394)
                         (last5 temp___394))))
                         (let ((stackp__get_model__3__R87s (last6 s)))
                         (let ((temp___397 (let ((temp___395 (to_rep3
                                           ...
                                           (let ((temp___396 (rec__stackp__stack_root__content1
                                                             (us_split_fields3
                                                             s))))
                                           (of_array5 temp___396 temp___395
                                           stackp__get_model__3__R87s)))))
                         (of_array (to_array5 temp___397)
                         (first11 temp___397) (last13 temp___397)))))) :pattern (
  (get_model__3 s)) )))
...
;; stackp__buffer__compat_axiom
  (assert
  (forall ((s us_rep1))
  (! (= (to_int1 (wraps_around s)) (to_int1 (wraps_around1 us_tag2 s))) :pattern (
...
;; last__post_axiom
  (assert
  (forall ((s us_rep1)) (! (dynamic_invariant3 (last6 s) true false
  true) :pattern ((last6 s)) )))

;; last__post__dispatch_axiom
  (assert
  (forall ((attr__tag2 Int))
  (forall ((s us_rep1)) (! (dynamic_invariant3 (last7 attr__tag2 s) true
  false true) :pattern ((last7 attr__tag2 s)) ))))

;; stackp__buffer__compat_axiom
  (assert
  (forall ((s us_rep1))
  (! (= (last6 s) (last7 us_tag2 s)) :pattern ((last7 us_tag2 s)) )))

;; last__def_axiom
  (assert
  (forall ((s us_rep1))
  (! (= (last6 s) (ite (not (= (wraps_around s) true))
                  (- (+ (to_rep3
...
(declare-const o6 less_than_max)

(declare-const o7 us_private)

(declare-const temp___470 (Array Int element))

(declare-const temp___4701 less_than_max)

(declare-const temp___4702 us_private)

(declare-const temp___4703 Int)
...
;; H
  (assert
  (and (<= 1 (to_rep s__split_fields1)) (<= (to_rep s__split_fields1) 100)))

;; H
  (assert (= o (to_rep s__split_fields1)))
...
;; H
  (assert
  (and (= o3 (- (to_rep s__split_fields1) 1)) (in_range
  (- (to_rep s__split_fields1) 1))))
...
;; H
  (assert (= temp___470 o5))

;; H
  (assert (= temp___4701 o6))

;; H
  (assert (= temp___4702 o7))

;; H
  (assert (= s__attr__tag temp___4703))
...
;; H
  (assert (= temp___470 s__split_fields3))

;; H
  (assert (= temp___4701 s__split_fields4))

;; H
  (assert (= temp___4702 s__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "stackp.ads", line 36, characters 0-0
  (not
  (= (let ((temp___476 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1
                       s__split_fields2) s__attr__tag))))
     (bool_eq
     (let ((temp___474 (temp___213 e2)))
     (let ((temp___473 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields6 s__split_fields7
                       s__split_fields8) s__attr__tag))))
     (ite (= (length temp___473) 0) temp___474
     (concat1 (elts temp___473) (to_rep2 (first (rt temp___473)))
     (to_rep2 (last (rt temp___473))) temp___474 1 1))))
     (to_rep2
     (first
     (let ((temp___473 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields6 s__split_fields7
                       s__split_fields8) s__attr__tag))))
     (ite (= (length temp___473) 0) (mk 1 1)
     (mk (to_rep2 (first (rt temp___473)))
     (- (+ (to_rep2 (first (rt temp___473))) (+ (ite (<= (to_rep2
                                                         (first
                                                         (rt temp___473)))
                                                (to_rep2
                                                (last (rt temp___473))))
     ...
     (- (+ (to_rep2 (first (rt temp___473))) (+ (ite (<= (to_rep2
                                                ...
                                                0) (ite (<= 1 1)
                                                   (+ (- 1 1) 1) 0))) 1))))))
     (elts temp___476) (to_rep2 (first (rt temp___476)))
     (to_rep2 (last (rt temp___476))))) true)))
(check-sat)
(exit)
