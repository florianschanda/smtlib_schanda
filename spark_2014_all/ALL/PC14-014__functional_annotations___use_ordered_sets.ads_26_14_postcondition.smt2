...
(declare-fun use_ordered_sets__apply_f__cu__assume () count_type)

(declare-fun temp___684 () count_type)

(declare-fun temp___683 () count_type)

(declare-fun temp___6831 () us_main_type)

(declare-fun o () Int)

(declare-fun o1 () Int)

(declare-fun temp___682 () count_type)
...
(declare-fun r__split_fields3 () us_split_fields__ref)
...
(declare-fun r__split_fields5 () us_split_fields__ref)
...
(declare-fun r__split_fields7 () us_split_fields__ref)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun r__split_fields8 () us_split_fields)
...
(define-fun temp___6821 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___682)))
...
;; H
  ...
  (ite (= (= (length s) 0) true)
  (= (bool_eq2 use_ordered_sets__apply_f__cu__assume1 no_element) true)
  (and
...
;; H
  (assert
  (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields11)))
  (= (= result1 true)
  (= (has_key (positions s) (mk___rep1 cu__split_fields11)) true))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= r__split_discrs (mk___split_discrs temp___683))
  (= temp___6831 r__split_fields))))
...
;; H
  ...
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields10))
...
;; H
  ...
  (=>
  (and (in_range2 g)
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields10)) g) true))
  (exists ((i Int))
  (and
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))
...
;; H
  (assert
  (=> (= result1 true)
  (= (has_key (positions s) (mk___rep1 cu__split_fields10)) true)))

;; H
  (assert
  (=> (= result1 true)
  (and (= o (element s (mk___rep1 cu__split_fields10)))
  (and (in_range6 o)
  (= o (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields10))))))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields9)) o1) true)
  (ite (= (contains (model__ (mk___rep r__split_discrs r__split_fields10))
          o1) true)
  (and
  (and
  (and
  (= (oeq3 (model__ (mk___rep r__split_discrs r__split_fields10))
     (model__ (mk___rep r__split_discrs r__split_fields9))) true)
  (= (oeq4 (positions (mk___rep r__split_discrs r__split_fields9))
     (positions (mk___rep r__split_discrs r__split_fields10))) true))
  (= (get (elements (mk___rep r__split_discrs r__split_fields9))
     (find (elements (mk___rep r__split_discrs r__split_fields9)) o1)) 
  o1))
  (= (equal_except (elements (mk___rep r__split_discrs r__split_fields10))
     (elements (mk___rep r__split_discrs r__split_fields9))
     (find (elements (mk___rep r__split_discrs r__split_fields9)) o1)) true))
  (and
  (and
  (and
  (and
  ...
  (= (ole (model__ (mk___rep r__split_discrs r__split_fields10))
     (model__ (mk___rep r__split_discrs r__split_fields9))) true))
  (= (included_except (model__ (mk___rep r__split_discrs r__split_fields9))
     (model__ (mk___rep r__split_discrs r__split_fields10)) o1) true))
  (= (get (elements (mk___rep r__split_discrs r__split_fields9))
     (find (elements (mk___rep r__split_discrs r__split_fields9)) o1)) 
  o1))
  (= (range_equal (elements (mk___rep r__split_discrs r__split_fields10))
     (elements (mk___rep r__split_discrs r__split_fields9)) 1
     (- (find (elements (mk___rep r__split_discrs r__split_fields9)) o1) 1)) true))
  (= (range_shifted (elements (mk___rep r__split_discrs r__split_fields10))
     (elements (mk___rep r__split_discrs r__split_fields9))
     (find (elements (mk___rep r__split_discrs r__split_fields9)) o1)
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___6821 (next s (mk___rep1 cu__split_fields10)))
  ...
  (= (bool_eq2 temp___6821 no_element) true)
  (and (= (has_key (positions s) temp___6821) true)
  (= (get1 (positions s) temp___6821) (+ (get1 (positions s)
...
;; H
  (assert
  (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___682))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o2 (has_key (positions s) (mk___rep1 cu__split_fields3)))
  (= (= o2 true)
  (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true)))))
...
(define-fun temp___706 () us_rep3 (elements s))

(declare-fun temp___705 () Int)

;; H
  (assert (in_range3 temp___705))

;; H
  (assert (= (iter_has_element temp___706 temp___705) true))
...
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 6, characters 0-0
  ...
  (= (contains
     ...
     (f (get temp___706 temp___705))) true)))
(check-sat)
