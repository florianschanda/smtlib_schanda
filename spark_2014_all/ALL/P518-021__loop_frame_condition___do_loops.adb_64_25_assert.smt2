...
;; H
  (assert (=> (< 1 i23) (= temp___306 (mk___rep1 o39))))

;; H
  (assert
  (=> (< 1 i23) (= result13 (mk___split_fields__ref1 d__split_fields26))))

;; H
  (assert (=> (< 1 i23) (= d__split_fields27 (us_split_fields3 temp___306))))
...
;; WP_parameter_def
 ;; File "do_loops.adb", line 16, characters 0-0
  ...
  (= (to_rep
     ...
     (us_split_fields1
     (select (rec__do_loops__r_array_record__f3
             (us_split_fields__content1 d__split_fields28)) i23)))) (to_rep
                                                                    (rec__do_loops__r__f1
                                                                    (us_split_fields1
                                                                    (select
                                                                    (rec__do_loops__r_array_record__f3
