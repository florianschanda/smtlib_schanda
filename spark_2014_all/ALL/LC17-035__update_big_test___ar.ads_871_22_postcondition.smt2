...
;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x enum1ta)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(declare-fun temp___6788 () et3)

(declare-fun temp___67881 () et1)

(declare-fun temp___67882 () et2)

(declare-fun temp___67883 () enum1ta)
...
;; H
  (assert
  (= r__split_fields8 (mk___split_fields1 temp___6788
                      (mk___rep
                      (mk___split_fields temp___67881 temp___67882))
                      temp___67883)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 864, characters 0-0
  (not
