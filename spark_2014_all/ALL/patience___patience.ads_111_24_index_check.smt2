...
;; H
  (assert (= o18 (ite (<= (- 1) o13) true false)))
...
;; H
  (assert
  (=> (= result6 true)
  (= o9 (select (rec__patience__state__preds (us_split_fields1 s)) o8))))

;; H
  (assert (=> (= result6 true) (= o10 (to_rep1 o9))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (< o10 i) true false))))
