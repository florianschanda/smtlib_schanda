...
(declare-fun p__y__assume () integer)

(declare-fun p__y__assume1 () Bool)

(declare-fun o8 () integer)

(declare-fun o9 () integer)

(declare-fun temp___188 () integer)

(declare-fun temp___1881 () Bool)

(declare-fun usq_ () integer)

(declare-fun usq_1 () Bool)

(declare-fun temp___190 () integer)

(declare-fun temp___1901 () Bool)
...
;; H
  (assert
  (= result (mk___split_discrs__ref (mk___split_discrs x__split_discrs))))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not (= 2 (to_rep (rec__p__t__x (us_split_discrs1 o14))))))
(check-sat)
