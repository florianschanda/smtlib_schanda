...
(define-fun dynamic_invariant ((temp___expr_586 Int)
...
(define-fun default_initial_assumption ((temp___expr_593 us_rep2)
  (temp___skip_top_level_594 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_594 true))
                                         (and
                                         (= (is_empty temp___expr_593) true)
                                         (= (length temp___expr_593) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_529 Int)
...
(declare-const temp___1067 count_type)
...
;; H
  (assert (= temp___1067 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1067)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cforma.ads", line 924, characters 0-0
  (not
