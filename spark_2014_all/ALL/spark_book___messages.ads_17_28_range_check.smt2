...
(declare-datatypes ((char__ref 0)) (((mk_char__ref (char__content char)))))
...
(((mk_map__ref (map__content (Array (_ BitVec 64) char))))))
...
(((mk___t (elts (Array (_ BitVec 64) char))(rt t)))))
...
(((mk_char_array__ref (char_array__content us_t)))))
