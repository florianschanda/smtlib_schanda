...
;; H
  (assert (and (= o15 (- i9 first4)) (in_range1 (- i9 first4))))

;; H
  (assert
  (and (= o16 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o16)
  (<= o16 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))

;; H
  (assert (= result6 (ite (= o16 o15) true false)))

;; H
  (assert
  (=> (= result6 true) (and (= o11 (- last5 i9)) (in_range1 (- last5 i9)))))

;; H
  (assert (=> (= result6 true) (= o12 (+ o11 1))))

;; H
  (assert (=> (= result6 true) (and (= o13 o12) (in_range1 o12))))

;; H
  (assert
  (=> (= result6 true)
  (and (= o10 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o10 true false true)
  (and (= (to_rep (first (rt o10))) 1) (<= 0 (to_rep (last (rt o10)))))))))

;; H
  (assert (=> (= result6 true) (= o14 (to_rep (last (rt o10))))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o6 (- last5 i9)) (in_range1 (- last5 i9)))))

;; H
  (assert (=> (= result5 true) (= o7 (+ o6 1))))

;; H
  (assert (=> (= result5 true) (and (= o8 o7) (in_range1 o7))))

;; H
  (assert (=> (= result5 true) (= o9 (ite (<= j1 o8) true false))))

;; H
  (assert (=> (= result5 true) (= result7 (ite (<= 1 j1) o9 false))))
