...
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o16 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  (assert
  (and
  (= o16 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o16)
...
;; H
  (assert
  (and
  (= o12 (copy (rec__amortized_queue__queue__rear result____split_fields5)
         1000))
  (and
  (= (oeq1 (model__ o12)
