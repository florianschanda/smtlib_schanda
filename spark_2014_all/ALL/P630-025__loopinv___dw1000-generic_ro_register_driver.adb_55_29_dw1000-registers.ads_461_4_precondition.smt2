...
(define-fun us_split_fields__ref_61__projection ((a us_split_fields__ref)) us_split_fields
...
(declare-fun dw1000__register_types__tc_sarw_type__sar_wvbat__first__bit () Int)

(declare-fun dw1000__register_types__tc_sarw_type__sar_wvbat__last__bit () Int)

(declare-fun dw1000__register_types__tc_sarw_type__sar_wvbat__position () Int)
...
(declare-fun dw1000__register_types__tc_sarw_type__sar_wtemp__first__bit () Int)

(declare-fun dw1000__register_types__tc_sarw_type__sar_wtemp__last__bit () Int)

(declare-fun dw1000__register_types__tc_sarw_type__sar_wtemp__position () Int)
...
(define-fun register_type__ref_142__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_101__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_101__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5418 us_t1)
  (temp___is_init_5415 Bool) (temp___skip_constant_5416 Bool)
  (temp___do_toplevel_5417 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5416 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5418)
                                       (last3 temp___expr_5418))
                                       (and (= (first3 temp___expr_5418) 1)
                                       (= (last3 temp___expr_5418) 2)))))
