...
(define-fun y4 () int__ref (mk_int__ref y))
...
;; H
  (assert (=> (bvule x2 ((_ int2bv 32) 2147483647)) (= result1 y4)))

;; H
  (assert (=> (bvule x2 ((_ int2bv 32) 2147483647)) (= y2 o18)))
...
;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= result2 y4)))

;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= y3 o22)))

;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= y2 y3)))

;; H
  (assert (= (to_rep1 o23) y2))
...
;; H
  (assert (not (bvule x3 ((_ int2bv 32) 2147483647))))

;; H
  (assert (and (= o50 (bv2nat (bvnot x3))) (in_range1 (bv2nat (bvnot x3)))))
