...
(declare-fun hello__to_camel_case__result () (Array Int character))

(declare-fun hello__to_camel_case__result1 () t)
...
(declare-fun temp___595 () (Array Int character))
...
(declare-fun ret4 () (Array Int character))

(declare-fun to_up2 () Bool)

(declare-fun idx2 () Int)

(declare-fun result5 () Bool)

(declare-fun to_up3 () Bool)

(declare-fun result6 () Bool)

(declare-fun to_up4 () Bool)

(declare-fun ret5 () (Array Int character))

(declare-fun to_up5 () Bool)

(declare-fun idx3 () int__ref)

(declare-fun ret6 () (Array Int character))

(declare-fun to_up6 () Bool)

(declare-fun idx4 () Int)

(declare-fun ret7 () map__ref)

(declare-fun to_up7 () bool__ref)

(declare-fun idx5 () int__ref)

(declare-fun ret8 () (Array Int character))

(declare-fun to_up8 () Bool)

(declare-fun idx6 () Int)

(declare-fun result7 () string__ref)

(declare-fun hello__to_camel_case__result2 () us_t)

(declare-fun hello__to_camel_case__result3 () string__ref)

(declare-fun hello__to_camel_case__result4 () us_t)

(declare-fun ret9 () map__ref)

(declare-fun to_up9 () bool__ref)

(declare-fun idx7 () int__ref)

(declare-fun hello__to_camel_case__result5 () string__ref)

(declare-fun ret10 () (Array Int character))

(declare-fun to_up10 () Bool)

(declare-fun idx8 () Int)

(declare-fun hello__to_camel_case__result6 () us_t)
