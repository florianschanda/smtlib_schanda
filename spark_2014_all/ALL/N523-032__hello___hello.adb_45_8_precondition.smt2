...
(declare-datatypes ((tTretSP1__ref 0))
(((mk_tTretSP1__ref (tTretSP1__content integer)))))
...
(((mk_tretS__ref (tretS__content us_t1)))))
...
;; H
  ...
  (<= idx1 (to_rep1 (last (rt str))))) (= temp___598 idx1)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= temp___597 to_up1)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= temp___595 ret1)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))
  (=> (= to_up1 true) (= o2 (store ret1 idx1 o1)))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (=> (= to_up1 true) (= ret1 result3))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (=> (= to_up1 true) (= ret2 o2))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))
  (=> (not (= to_up1 true)) (= o5 (store ret1 idx1 o4)))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))
  (and (<= (to_rep1 ret__first) idx1) (<= idx1 (to_rep1 ret__last)))))
...
;; H
  ...
  (<= idx1 (to_rep1 (last (rt str)))))
  (forall ((j Int))
  (=> (and (<= idx2 j) (<= j (to_rep1 (last (rt str)))))
  (=> (< idx2 j) (= (to_rep (select ret4 j)) (to_rep (select (elts str) j))))))))
...
;; H
  ...
  (=> (< idx2 temp___596)
  (= (select ret4 temp___596) (select temp___595 temp___596)))))
  (=> (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str))))
  (dynamic_property3 (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))
  idx2)))
  (and (<= (to_rep1 (first (rt str))) idx2)
  (<= idx2 (to_rep1 (last (rt str))))))))
...
;; H
  ...
  (and
  (not
  (and (<= 65 (to_rep (select (elts str) idx2)))
  (<= (to_rep (select (elts str) idx2)) 90)))
  (not
  (and (<= 97 (to_rep (select (elts str) idx2)))
  (<= (to_rep (select (elts str) idx2)) 122)))) (= to_up2 result5))))
...
;; H
  ...
  (not
  (and (<= 97 (to_rep (select (elts str) idx2)))
  (<= (to_rep (select (elts str) idx2)) 122)))) (= to_up3 (of_int 1)))))
...
;; H
  ...
  (not
  (and (<= 97 (to_rep (select (elts str) idx2)))
  (<= (to_rep (select (elts str) idx2)) 122))))) (= to_up2 result6))))
...
;; H
  ...
  (not
  (and (<= 97 (to_rep (select (elts str) idx2)))
  (<= (to_rep (select (elts str) idx2)) 122))))) (= to_up4 (of_int 0)))))
...
;; H
  ...
  (not
  (and (<= 97 (to_rep (select (elts str) idx2)))
  (<= (to_rep (select (elts str) idx2)) 122))))) (= to_up3 to_up4))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= idx2 (to_rep1 (last (rt str))))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= idx3 (mk_int__ref idx2))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= to_up3 to_up5)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= ret4 ret5)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= idx4 idx2)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= to_up6 to_up3)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= ret6 ret4)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= idx5 idx3)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= to_up7 (mk_bool__ref to_up5))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= ret7 (mk_map__ref ret5))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= idx6 idx4)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= to_up8 to_up6)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str))))) (= ret8 ret6)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))) (= idx5 (mk_int__ref idx1))))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))) (= to_up7 (mk_bool__ref to_up1))))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))) (= ret7 (mk_map__ref ret1))))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))) (= idx6 idx1)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))) (= to_up8 to_up1)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt str))) idx1)
  (<= idx1 (to_rep1 (last (rt str)))))) (= ret8 ret1)))

;; H
  (assert
  (= hello__to_camel_case__result3 (mk_string__ref
                                   hello__to_camel_case__result2)))
...
;; H
  (assert
  (= result7 (mk_string__ref
             (mk___t hello__to_camel_case__result
             hello__to_camel_case__result1))))

;; H
  (assert
  (= hello__to_camel_case__result2 (mk___t (map__content ret7)
                                   (mk (to_rep1 ret__first)
                                   (to_rep1 ret__last)))))
...
;; H
  (assert
  (= (to_rep1 (first (rt (string__content hello__to_camel_case__result5))))
  (to_rep1 (first (rt str)))))

;; H
  (assert
  (= (to_rep1 (last (rt (string__content hello__to_camel_case__result5))))
  (to_rep1 (last (rt str)))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep1 (last (rt str))) (to_rep1 (last (rt str))))))
(check-sat)
(exit)
