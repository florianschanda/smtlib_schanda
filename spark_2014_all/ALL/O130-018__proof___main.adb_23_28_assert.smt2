...
(((mk___split_fields (rec__main__branch_type__m_nodes us_t)))))
...
(((mk_branch_type__ref (branch_type__content us_rep)))))
...
(declare-datatypes ((tS6bP1__ref 0))
(((mk_tS6bP1__ref (tS6bP1__content integer)))))
...
(declare-datatypes ((s6b__ref 0)) (((mk_s6b__ref (s6b__content us_t1)))))
...
(declare-datatypes ((t9b__ref 0)) (((mk_t9b__ref (t9b__content us_t2)))))
...
(((mk_array_type__ref (array_type__content us_t3)))))
...
;; H
  (assert
  (= (mk___t1 temp___202 temp___2021) (mk___t1 temp___200 temp___2001)))
...
;; H
  (assert
  (= (mk (to_rep (first2 temp___2021)) (to_rep (last2 temp___2021)))
  o1))
...
;; H
  ...
  (= result (mk___split_fields__ref
            (mk___split_fields
            (mk___t branch__split_fields branch__split_fields1)))))

;; H
  (assert
  (= branch__split_fields2 (mk___split_fields
                           (mk___t temp___2041 temp___2042))))
...
;; H
  (assert
  (= (to_rep
     (last (rt (rec__main__branch_type__m_nodes branch__split_fields2))))
  r10b))
...
;; H
  ...
  (and (<= 0 i2)
  (<= i2 (to_rep
         (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))))
  (= (to_rep
     (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))
  (to_rep
  (last (rt (rec__main__branch_type__m_nodes branch__split_fields2)))))))
...
;; H
  ...
  (mk___rep branch__split_discrs branch__split_fields3) false true true)
  (forall ((temp___210 Int))
  (=>
  (and
  (<= (to_rep
      (first (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) temp___210)
  (<= temp___210 (to_rep
                 (last
                 (rt (rec__main__branch_type__m_nodes branch__split_fields3))))))
  (=> (<= i2 temp___210)
  (= (select (elts (rec__main__branch_type__m_nodes branch__split_fields3)) temp___210) (select
  (elts (rec__main__branch_type__m_nodes branch__split_fields2)) temp___210))))))
  (=> (<= 0 r10b) (dynamic_property6 0 r10b i2)))
  (and (<= 0 i2) (<= i2 r10b))))
