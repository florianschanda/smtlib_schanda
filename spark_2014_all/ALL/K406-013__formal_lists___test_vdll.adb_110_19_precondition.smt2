...
;; H
  (assert
  (and (= o11 (first (mk___rep l4__split_discrs l4__split_fields2)))
  (ite (= (= (length (mk___rep l4__split_discrs l4__split_fields2)) 0) true)
  (= (bool_eq1 o11 no_element) true)
  (and
  (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields2)) o11) true)
  (= (get1 (positions (mk___rep l4__split_discrs l4__split_fields2)) o11) 1)))))
