...
(define-fun in_range2 ((rec__storage_place_attributes__r2__d11 Int)
...
;; H
  (assert
  (and
  (= 5 (to_rep1 (rec__storage_place_attributes__r2__d1 (us_split_discrs1 x))))
  (= (attr__constrained x) true)))

(assert
;; WP_parameter_def
 ;; File "storage_place_attributes.adb", line 81, characters 0-0
  (not (<= 0 storage_place_attributes__r2__d1__first__bit1)))
(check-sat)
(exit)
