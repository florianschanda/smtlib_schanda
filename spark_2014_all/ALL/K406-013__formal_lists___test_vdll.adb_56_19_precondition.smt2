...
;; H
  (assert
  (and (= o10 (next (mk___rep l2__split_discrs l2__split_fields4) o9))
  (ite (= (ite (= (bool_eq1 o9 no_element) false) (= (get1
                                                     ...
                                                     o9) (length
                                                         (mk___rep
                                                         l2__split_discrs
                                                         l2__split_fields4))) true) true)
  (= (bool_eq1 o10 no_element) true)
  (and
  (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields4)) o10) true)
  (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o10) (+
  (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o9) 1))))))
...
;; WP_parameter_def
 ;; File "test_vdll.adb", line 18, characters 0-0
  (not
  (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields3)) o10) true)))
(check-sat)
(exit)
