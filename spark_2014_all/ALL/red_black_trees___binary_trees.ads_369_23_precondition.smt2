...
;; H
  (assert
  (and
  (= o46 (size (mk___rep2 (us_split_fields__content2 f__split_fields7))))
  (and (in_range2 o46)
  (= o46 (to_rep
         (rec__binary_trees__forest__s
...
;; H
  (assert (= o44 (select temp___957 i)))
...
;; H
  (assert
  (and
  (= o43 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
  (and (in_range2 o43)
  (and
  (= o43 (ite (= d 0)
         (to_rep
  ...
  (ite (not (= o43 0))
  (and
  (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o43) 
  d)
  (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o43) 
  i))
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 100))
  (=>
...
;; H
  (assert (= o41 (select temp___955 (int__content v2))))
