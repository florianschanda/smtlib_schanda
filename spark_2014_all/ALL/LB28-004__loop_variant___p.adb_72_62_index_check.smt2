...
;; H
  ...
  (=> (<= j24 b)
  (forall ((l1 Int))
  (=> (and (<= a l1) (<= l1 (- j26 1))) (= (to_rep (select tab21 l1)) l1)))))
...
;; H
  ...
  (=> (<= j31 b)
  (forall ((l1 Int))
  (=> (and (<= a l1) (<= l1 (- j33 1))) (= (to_rep (select tab27 l1)) l1)))))
...
;; H
  (assert
  (forall ((l1 Int))
  (=> (and (<= a l1) (<= l1 (- j40 1))) (= (to_rep (select tab33 l1)) l1))))

;; H
  (assert
  (forall ((l1 Int))
  (=> (and (<= a l1) (<= l1 (- (+ a k19) 1)))
  (= (to_rep (select tab33 l1)) l1))))
...
;; H
  (assert (and (= o30 (- j40 1)) (in_range1 (- j40 1))))

;; H
  (assert (= o31 (ite (<= l o30) true false)))

;; H
  (assert (= result33 (ite (<= a l) o31 false)))
