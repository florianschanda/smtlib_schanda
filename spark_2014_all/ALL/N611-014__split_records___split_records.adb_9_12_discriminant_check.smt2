...
(declare-fun r__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun new_field () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun r2b () Bool)
...
(declare-fun r__split_discrs () Bool)
...
(declare-fun temp___2371 () natural)

(declare-fun temp___2372 () Bool)

;; H
  (assert (in_range1 new_field))

;; H
  (assert (not (= r__split_discrs true)))

;; H
  (assert (not (= r__attr__constrained true)))

;; H
  (assert (= r__split_discrs r2b))

;; H
  (assert (= (to_rep o) new_field))

;; H
  (assert (= o o1))

;; H
  (assert (= (of_int 1) temp___237))

;; H
  (assert (= temp___2371 o1))

;; H
  (assert (= true temp___2372))

;; H
  (assert (= r__attr__constrained true))

(assert
;; WP_parameter_def
 ;; File "split_records.ads", line 16, characters 0-0
  (not (= temp___237 r__split_discrs)))
(check-sat)
(exit)
