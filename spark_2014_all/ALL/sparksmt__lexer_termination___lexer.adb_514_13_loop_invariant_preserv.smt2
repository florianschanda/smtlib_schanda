...
(declare-const temp___7942 int__ref)
...
;; H
  (assert (= result11 (mk_int__ref temp___794)))

;; H
  (assert (= temp___7941 current_idx8))
...
;; H
  (assert (= temp___7942 (mk_int__ref temp___7941)))
...
;; H
  (assert (= temp___7943 temp___7941))
