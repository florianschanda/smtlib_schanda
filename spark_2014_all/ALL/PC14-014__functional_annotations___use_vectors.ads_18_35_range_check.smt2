...
;; id__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant1 x true true true) (dynamic_invariant1 f true
     true true)) (dynamic_invariant1 l true true true))
     (let ((result (id x f l)))
     (and (=> (and (<= f x) (<= x l)) (and (<= f result) (<= result l)))
     (dynamic_invariant1 result true false true)))) :pattern ((id x f l)) )))

(declare-sort smaller 0)

(define-fun in_range3 ((x Int)) Bool (and (<= (- 2147483647) x)
                                     (<= x 2147483647)))
...
;; last_count__def_axiom
  (assert
  (= last_count (ite (< last first1) 0
                (ite (or (< last (- 1)) (< (- last 2147483647) first1))
                (+ (- last first1) 1) 2147483647))))
...
(declare-fun use_vectors__fst__assume () Int)
...
;; H
  (assert
  (=> (not (< last first1))
  (=> (=> (not (< last (- 1))) (< (- last 2147483647) first1))
  (= temp___363 (+ (- last first1) 1)))))

;; H
  (assert
  (=> (not (< last first1))
  (=> (not (=> (not (< last (- 1))) (< (- last 2147483647) first1)))
  (= temp___363 2147483647))))
...
;; H
  (assert
  (and (= o (id 1 (- 2147483647) 2147483647))
  (and (in_range1 o)
  (=> (and (<= (- 2147483647) 1) (<= 1 2147483647))
  (and (<= (- 2147483647) o) (<= o 2147483647))))))
...
;; H
  (assert
  (and (= temp___361 (id 2147483647 fst 2147483647))
  (and (in_range1 temp___361)
  (=> (and (<= fst 2147483647) (<= 2147483647 2147483647))
  (and (<= fst temp___361) (<= temp___361 2147483647))))))

(assert
;; WP_parameter_def
 ;; File "use_vectors.ads", line 85, characters 0-0
  (not (dynamic_property first 2147483647 temp___361)))
(check-sat)
(exit)
