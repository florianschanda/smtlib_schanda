...
;; H
  (assert (= o27 (bvand o26 ((_ int2bv 32) 7))))
...
;; H
  (assert (= zeroflag2 (ite (= rax4 ((_ int2bv 64) 0)) true false)))
...
;; H
  (assert (= o30 (bvand o29 ((_ int2bv 32) 7))))
...
;; H
  (assert (= zeroflag3 (ite (= rax6 ((_ int2bv 64) 0)) true false)))
