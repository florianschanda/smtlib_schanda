...
;; H
  (assert
  (and (= o4 binary_trees__extract__v) (in_range3 binary_trees__extract__v)))

;; H
  (assert (= result12 (mk_int__ref x)))
...
;; H
  ...
  (=> (not (= is_root true))
  (and
  (= o5 (to_rep1 (rec__search_trees__search_tree__root t__split_fields4)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields4))))))

;; H
  (assert
  (=> (not (= is_root true))
  (and
  (= (ordered_leafs (rec__search_trees__search_tree__struct t__split_fields4)
     o5 (rec__search_trees__search_tree__values t__split_fields4)) true)
  (and
  (= (ordered_leafs (rec__search_trees__search_tree__struct t__split_fields4)
     x1 (rec__search_trees__search_tree__values t__split_fields4)) true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (and
  ...
  (= (olt
     ...
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f_old__split_fields2) o5) x1)))) true))
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 f_old__split_fields2) o5) x1)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1
             (select (model__
                     (rec__search_trees__search_tree__struct
                     t__split_fields4) o5) i1)))) 1)) 0)
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             x1) j3))) true)
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields4) j3))
  (to_rep
  (select (rec__search_trees__search_tree__values t__split_fields4) i1))))))
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
  (= (rec__tree_model__path_type__k
...
;; H
  ...
  (= (valid_root
     (mk___rep2
     (us_split_fields5
     (rec__search_trees__search_tree__struct t__split_fields4))) t) true)
...
;; H
  (assert
  (= t__split_fields5 (mk___split_fields3
...
;; H
  (assert
  (and (= o6 binary_trees__extract__v1) (in_range3
  binary_trees__extract__v1)))

;; H
  (assert (= result15 (mk_int__ref y)))
...
;; H
  (assert (and (= o8 yl1) (in_range3 yl1)))
...
;; H
  ...
  (= (olt
     ...
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f_2__split_fields3) y1) o8)))) true))
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 f_2__split_fields3) y1) o8)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1
             (select (model__
...
;; H
  ...
  (= (valid_root
     (mk___rep2
     (us_split_fields5
     (rec__search_trees__search_tree__struct t__split_fields6))) j3) true)
  (not (= j3 yl1)))
...
;; H
  ...
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields7)
     x1)) (to_rep
...
;; H
  ...
  (= (ordered_leafs (mk___rep2 f_3__split_fields3) x1
     (rec__search_trees__search_tree__values t__split_fields7)) true))
...
;; H
  (assert (and (= o10 yl1) (in_range3 yl1)))
...
;; H
  (assert
  (= result20 (let ((subject f_4__split_fields))
...
;; H
  ...
  (to_rep
  (select (rec__search_trees__search_tree__values t__split_fields8) x1)))))))
...
;; H
  (assert
  (= result22 (let ((subject f_5__split_fields))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o13) j3))) true))))
  (and
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o13) i1))) true)
  (ite (and (not (= y1 0))
       (= (ole1
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o13)
          y1)))
          (rec__tree_model__path_type__a
          (us_split_fields1
          (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o13) i1)))) true))
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 binary_trees__plug__f__fields2) o13) j3)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
...
;; H
  ...
  (= (oeq1
     ...
     (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))) true))

;; H
  (assert
  (and
  (= o26 (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))))

;; H
  (assert
  (and (= temp___864 (model__ (mk___rep2 f_old__split_fields2) o26))
  (and (dynamic_invariant6 temp___864 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___864 o26))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___864 o26)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o26))
...
;; H
  (assert (= o27 (select temp___864 x1)))
...
;; H
  (assert
  (and
  (= o22 (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___863 o22))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___863 o22)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o22))
  (ite (and
       (not
       (= (parent (rec__search_trees__search_tree__struct t__split_fields9)
          i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___863 (parent
                             (rec__search_trees__search_tree__struct
                             t__split_fields9) i1)))) true))
  (= (rec__tree_model__path_type__k
  ...
  (= (is_add
     ...
     (select temp___863 (parent
                        (rec__search_trees__search_tree__struct
                        t__split_fields9) i1))))
     (position (rec__search_trees__search_tree__struct t__split_fields9) i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___863 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o23 (select temp___863 y1)))
...
;; H
  (assert
  (and
  (= o18 (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))))

;; H
  (assert
  (and (= temp___862 (model__ (mk___rep2 f_old__split_fields2) o18))
  (and (dynamic_invariant6 temp___862 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___862 o18))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___862 o18)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o18))
...
;; H
  (assert (= o19 (select temp___862 j2)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___861 o14))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___861 o14)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o14))
...
;; H
  (assert (= o15 (select temp___861 j2)))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (let ((subject f_5__split_fields)) f_5__split_fields2))
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields9))) i1))) true)
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             ...
             (let ((subject f_5__split_fields)) f_5__split_fields2))
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields9))) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields9)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields9)))
     y1)))) true))
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1
...
;; H
  ...
  (= (get
     ...
     (+ (length
        ...
        (select (model__ (mk___rep2 f_1__split_fields3)
                (to_rep1
                (rec__search_trees__search_tree__root t__split_fields9))) i1)))) 1))
  (get
  (rec__tree_model__path_type__a
  (us_split_fields1
  (select (model__ (rec__search_trees__search_tree__struct t__split_fields9)
          (to_rep1 (rec__search_trees__search_tree__root t__split_fields9)))
  y1)))
  (+ (length
     (rec__tree_model__path_type__a
