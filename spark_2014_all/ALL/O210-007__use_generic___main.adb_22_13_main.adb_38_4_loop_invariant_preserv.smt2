...
;; H
  ...
  (=> (and (<= 0 temp___212) (<= temp___212 7))
  (=> (<= i2 temp___212)
  (= (select b__split_fields2 temp___212) (select b__split_fields1 temp___212)))))
  (=> (<= 0 7) (dynamic_property2 0 7 i2))) (and (<= 0 i2) (<= i2 7))))

;; H
  (assert (=> (= i2 7) (and (<= 0 i2) (<= i2 7))))

;; H
  (assert (=> (= i2 7) (= (to_rep o) 0)))

;; H
  (assert (=> (= i2 7) (= o1 (store b__split_fields2 i2 o))))

;; H
  (assert (=> (= i2 7) (= o1 o2)))

;; H
  (assert (=> (= i2 7) (= b__split_discrs (mk___split_discrs temp___209))))

;; H
  (assert (=> (= i2 7) (= temp___2091 o2)))

;; H
  (assert (=> (= i2 7) (= result2 b__split_fields2)))

;; H
  (assert (=> (= i2 7) (= temp___2091 b__split_fields3)))
...
;; H
  (assert
  (=> (not (= i2 7))
  (= (mk___split_fields1 b__split_fields3) (mk___split_fields1
                                           b__split_fields2))))
