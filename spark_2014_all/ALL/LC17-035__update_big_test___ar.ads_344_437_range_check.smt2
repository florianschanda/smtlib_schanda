...
(declare-fun temp___4745 () (Array Int (Array Int et1)))
...
(declare-fun temp___4740 () (Array Int (Array Int et1)))
...
(declare-fun a2 () (Array Int (Array Int et1)))

(declare-fun a3 () (Array Int (Array Int et1)))

(declare-fun j_next2 () Int)

(declare-fun f3 () Int)

(declare-fun t1 () (Array Int (Array Int et1)))

(declare-fun a4 () (Array Int (Array Int et1)))

(declare-fun j_next3 () Int)

(declare-fun f4 () Int)

(declare-fun t2 () (Array Int (Array Int et1)))
...
;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (and (= o9 (- e 1)) (in_range3 (- e 1))))))

;; H
  (assert (=> (< j 50) (=> (< 0 e) (and (<= 5 (+ j 1)) (<= (+ j 1) 50)))))

;; H
  (assert (=> (< j 50) (=> (< 0 e) (= o8 (+ j 1)))))

;; H
  (assert (=> (< j 50) (=> (< 0 e) (= o10 (select a o8)))))

;; H
  (assert (=> (< j 50) (=> (< 0 e) (= o11 (temp___1083 o10 i o9)))))

;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (and (= o12 (+ j 1)) (in_range2 (+ j 1))))))

;; H
  (assert
  (=> (< j 50)
  (=> (< 0 e)
  (= temp___4740 (temp___1068 a j (temp___1076 (select a j) i e) o12 o11)))))

;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (= result4 (bool_eq1 a3 5 50 temp___4740 5 50)))))

;; H
  (assert (=> (< j 50) (=> (not (< 0 e)) (= result4 false))))

;; H
  (assert (=> (< j 50) (=> (= result4 true) (= result3 true))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result4 true))
  (=> (= e 0) (and (<= 5 (+ j 1)) (<= (+ j 1) 50))))))

;; H
  (assert
  (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= o4 (+ j 1))))))

;; H
  (assert
  (=> (< j 50) (=> (not (= result4 true)) (=> (= e 0) (= o5 (select a o4))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result4 true)) (=> (= e 0) (= o6 (temp___1106 o5 i 99))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result4 true))
  (=> (= e 0) (and (= o7 (+ j 1)) (in_range2 (+ j 1)))))))
...
;; H
  ...
  (=> (not (= result4 true))
  (=> (= e 0)
  (= temp___4745 (temp___1091 a j (temp___1099 (select a j) i e) o7 o6))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result4 true))
  (=> (= e 0) (= result3 (bool_eq1 a3 5 50 temp___4745 5 50))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result4 true)) (=> (not (= e 0)) (= result3 false)))))

;; H
  (assert (=> (not (< j 50)) (= result3 false)))
