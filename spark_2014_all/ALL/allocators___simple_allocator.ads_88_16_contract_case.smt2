...
;; length__post_axiom
  (assert
  (forall ((container us_rep)) (! (dynamic_invariant4 (length container) true
...
;; H
  ...
  (= (contains
     (rec__simple_allocator__m__t__allocated
     (us_split_fields1 (model__ data))) res) true)
  (and
  (= (is_add
     (rec__simple_allocator__m__t__available
     (us_split_fields1 (model__ data))) res
     (rec__simple_allocator__m__t__available
     (us_split_fields1 (model__ data3)))) true)
  (= (is_add
     (rec__simple_allocator__m__t__allocated
     (us_split_fields1 (model__ data3))) res
     (rec__simple_allocator__m__t__allocated
...
;; WP_parameter_def
 ;; File "simple_allocator.adb", line 9, characters 0-0
  (not (= (oeq (model__ data3) (model__ data)) true)))
(check-sat)
(exit)
