...
(((mk___split_fields
  (rec__dw1000__register_types__evc_ovr_type__evc_ovr bits_12)(rec__dw1000__register_types__evc_ovr_type__reserved bits_4)))))
(define-fun us_split_fields_EVC_OVR__projection ((a us_split_fields)) bits_12
  (rec__dw1000__register_types__evc_ovr_type__evc_ovr a))

(define-fun us_split_fields_Reserved__28__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__evc_ovr_type__reserved a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___93__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___93__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep3
                           (rec__dw1000__register_types__evc_ovr_type__evc_ovr
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__evc_ovr_type__evc_ovr
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__evc_ovr_type__reserved
...
(declare-const dw1000__register_types__evc_ovr_type__evc_ovr__first__bit Int)

(declare-const dw1000__register_types__evc_ovr_type__evc_ovr__last__bit Int)

(declare-const dw1000__register_types__evc_ovr_type__evc_ovr__position Int)

;; dw1000__register_types__evc_ovr_type__evc_ovr__first__bit_axiom
  (assert (<= 0 dw1000__register_types__evc_ovr_type__evc_ovr__first__bit))

;; dw1000__register_types__evc_ovr_type__evc_ovr__last__bit_axiom
  (assert
  (< dw1000__register_types__evc_ovr_type__evc_ovr__first__bit dw1000__register_types__evc_ovr_type__evc_ovr__last__bit))

;; dw1000__register_types__evc_ovr_type__evc_ovr__position_axiom
  (assert (<= 0 dw1000__register_types__evc_ovr_type__evc_ovr__position))

(declare-const dw1000__register_types__evc_ovr_type__reserved__first__bit Int)

(declare-const dw1000__register_types__evc_ovr_type__reserved__last__bit Int)

(declare-const dw1000__register_types__evc_ovr_type__reserved__position Int)

;; dw1000__register_types__evc_ovr_type__reserved__first__bit_axiom
  (assert (<= 0 dw1000__register_types__evc_ovr_type__reserved__first__bit))

;; dw1000__register_types__evc_ovr_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__evc_ovr_type__reserved__first__bit dw1000__register_types__evc_ovr_type__reserved__last__bit))

;; dw1000__register_types__evc_ovr_type__reserved__position_axiom
  (assert (<= 0 dw1000__register_types__evc_ovr_type__reserved__position))

(declare-fun user_eq6 (us_rep us_rep) Bool)

(declare-const dummy6 us_rep)

(declare-datatypes ((evc_ovr_type__ref 0))
(((mk_evc_ovr_type__ref (evc_ovr_type__content us_rep)))))
(define-fun evc_ovr_type__ref___projection ((a evc_ovr_type__ref)) us_rep
  (evc_ovr_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___218__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___155__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___155__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7104 us_t1)
  (temp___is_init_7101 Bool) (temp___skip_constant_7102 Bool)
  (temp___do_toplevel_7103 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7102 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_7104)
                                       (last3 temp___expr_7104))
                                       (and (= (first3 temp___expr_7104) 1)
                                       (= (last3 temp___expr_7104) 2)))))
