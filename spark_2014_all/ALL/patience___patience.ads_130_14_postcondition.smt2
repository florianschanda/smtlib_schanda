...
(declare-const result9 state__ref)
...
(declare-const result10 cardindex)

(declare-const result11 (Array Int card))

(declare-const result12 cardindex)

(declare-const result13 (Array Int cardindex))

(declare-const result14 (Array Int (Array Int cardindex)))

(declare-const result15 (Array Int cardindex))

(declare-const result16 (Array Int cardindex))

(declare-const result17 (Array Int cardindex))
