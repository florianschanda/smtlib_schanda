...
;; H
  (assert (= rad_gx4 (mul RNE1 rad_gx3 (mul RNE1 fliteral11 c9b))))

;; H
  (assert (= result29 (mk_t__ref rad_gy3)))

;; H
  (assert (= rad_gy4 (mul RNE1 rad_gy3 (mul RNE1 fliteral11 c9b))))

;; H
  (assert (= result30 (mk_t__ref rad_gz3)))

;; H
  (assert (= rad_gz4 (mul RNE1 rad_gz3 (mul RNE1 fliteral11 c9b))))
...
;; H
  (assert
  (and
  (= o88 (mul RNE1 (let ((subject q3_tmp)) q3_tmp1)
         (let ((subject q3_tmp)) q3_tmp1)))
  (tqtisFinite
  (mul RNE1 (let ((subject q3_tmp)) q3_tmp1)
  (let ((subject q3_tmp)) q3_tmp1)))))

;; H
  (assert
  (and
  (= o87 (mul RNE1 (let ((subject q2_tmp)) q2_tmp1)
         (let ((subject q2_tmp)) q2_tmp1)))
  (tqtisFinite
  (mul RNE1 (let ((subject q2_tmp)) q2_tmp1)
  (let ((subject q2_tmp)) q2_tmp1)))))

;; H
  (assert
  (and
  (= o86 (mul RNE1 (let ((subject q1_tmp)) q1_tmp1)
         (let ((subject q1_tmp)) q1_tmp1)))
  (tqtisFinite
  (mul RNE1 (let ((subject q1_tmp)) q1_tmp1)
  (let ((subject q1_tmp)) q1_tmp1)))))
...
;; WP_parameter_def
 ;; File "i-cexten.ads", line 59, characters 0-0
  (not (tqtisFinite
  (mul RNE1 (let ((subject q0_tmp)) q0_tmp1)
