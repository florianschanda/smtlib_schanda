...
(define-fun o7 () us_rep (mk___rep (mk___split_discrs o2)
...
;; H
  ...
  (= (ole (model__ o7) (model__ source)) true))
  (= (includes_intersection (model__ o7)
     (model__
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source)) true))
  (= (e_elements_included (elements o7)
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true))
  (= (e_elements_included__2
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source) (elements o7)) true))))

;; H
  (assert (and (= o4 (length o7)) (and (in_range1 o4) (<= o4 (to_rep o2)))))
