...
;; H
  (assert
  (=> (= result10 true)
  (= result9 (ite (< o34 (to_rep1 s__split_fields2)) true false))))
...
;; H
  (assert (=> (= result8 true) (= temp___544 (to_rep1 o24))))

;; H
  (assert (=> (= result8 true) (and (<= 0 temp___544) (<= temp___544 99))))

;; H
  (assert (=> (= result8 true) (= o25 temp___544)))
...
;; H
  (assert (=> (= result7 true) (= temp___547 (to_rep1 o14))))

;; H
  (assert (=> (= result7 true) (and (<= 0 temp___547) (<= temp___547 99))))

;; H
  (assert (=> (= result7 true) (= o15 temp___547)))

;; H
  (assert (=> (= result7 true) (= temp___548 (select s__split_fields4 o15))))
...
;; H
  (assert (=> (= result7 true) (= temp___550 (to_rep1 o17))))

;; H
  (assert (=> (= result7 true) (and (<= 0 temp___550) (<= temp___550 99))))

;; H
  (assert (=> (= result7 true) (= o18 temp___550)))

;; H
  (assert (=> (= result7 true) (= o19 (select temp___548 o18))))
...
;; H
  (assert
  (=> (= result7 true) (= result6 (ite (= o20 topstacki2) true false))))
