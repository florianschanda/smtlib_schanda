...
;; H
  (assert
  (and (= o5 (length (mk___rep l__split_discrs l__split_fields7)))
  (and (in_range2 o5)
  (<= o5 (to_rep (rec__my_lists__m__list__capacity l__split_discrs))))))

;; H
  (assert
  (and (= o4 (positions (mk___rep l__split_discrs l__split_fields7)))
  (and (not (= (has_key o4 no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o4 i) true)
  (and
  (and (<= 1 (get o4 i))
  (<= (get o4 i) (length (mk___rep l__split_discrs l__split_fields7))))
  (forall ((j us_rep1))
  (=> (= (has_key o4 j) true)
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not (= (has_key o4 (mk___rep1 d__split_fields5)) true)))
(check-sat)
(exit)
