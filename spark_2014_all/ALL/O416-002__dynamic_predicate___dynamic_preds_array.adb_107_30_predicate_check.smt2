...
;; H
  (assert
  (=> (= (mod2 above 2) 0)
  (and (= temp___295 (+ above 1)) (in_range (+ above 1)))))

;; H
  (assert (=> (= (mod2 above 2) 0) (= (mod2 temp___295 2) 0)))

;; H
  (assert (=> (= (mod2 above 2) 0) (= o1 temp___295)))

;; H
  (assert (=> (= (mod2 above 2) 0) (= (to_rep o2) o1)))

;; H
  (assert (=> (= (mod2 above 2) 0) (= o3 (store result__1 1 o2))))

;; H
  (assert (=> (= (mod2 above 2) 0) (= result1 result__1)))

;; H
  (assert (=> (= (mod2 above 2) 0) (= result__2 o3)))

;; H
  (assert
  (=> (not (= (mod2 above 2) 0))
  (and (= temp___293 (+ above 1)) (in_range (+ above 1)))))

;; H
  (assert (=> (not (= (mod2 above 2) 0)) (= (mod2 temp___293 2) 0)))

;; H
  (assert (=> (not (= (mod2 above 2) 0)) (= o4 temp___293)))

;; H
  (assert (=> (not (= (mod2 above 2) 0)) (= (to_rep o5) o4)))

;; H
  (assert (=> (not (= (mod2 above 2) 0)) (= o6 (store result__1 1 o5))))

;; H
  (assert (=> (not (= (mod2 above 2) 0)) (= result2 result__1)))

;; H
  (assert (=> (not (= (mod2 above 2) 0)) (= result__3 o6)))

;; H
  (assert (=> (not (= (mod2 above 2) 0)) (= result__2 result__3)))

;; H
  (assert
  (and (= temp___297 (+ (to_rep (select result__2 1)) 4)) (in_range
  (+ (to_rep (select result__2 1)) 4))))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds_array.ads", line 20, characters 0-0
  (not (= (mod2 temp___297 2) 0)))
(check-sat)
(exit)
