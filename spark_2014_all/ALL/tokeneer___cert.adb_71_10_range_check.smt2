...
(declare-const temp___1226 (Array Int character))

(declare-const temp___12261 t)
...
;; H
  (assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1232))

;; H
  (assert (= (mk1 1 (to_rep1 fullstring__last)) temp___12321))
