...
;; H
  ...
  (=> (<= 3 x)
  (=> (<= 3 y)
  (and (= o14 (one_free_slot 3 3 my_board))
  (and (in_range o14)
  (= o14 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))
...
;; H
  ...
  (=> (<= 3 x)
  (=> (<= 2 y)
  (and (= o11 (one_free_slot 3 2 my_board))
  (and (in_range o11)
  (= o11 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))
...
;; H
  (assert
  (=> (<= 3 x)
  (and (= o12 (one_free_slot 3 1 my_board))
  (and (in_range o12)
  (= o12 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0))))))
...
;; H
  ...
  (=> (<= 2 x)
  (=> (<= 3 y)
  (and (= o7 (one_free_slot 2 3 my_board))
  (and (in_range o7)
  (= o7 (ite (= (to_rep (select (select my_board 2) 3)) 0) 1 0)))))))
...
;; H
  (assert
  (=> (<= 2 x)
  (and (= o5 (one_free_slot 2 1 my_board))
  (and (in_range o5)
  (= o5 (ite (= (to_rep (select (select my_board 2) 1)) 0) 1 0))))))
