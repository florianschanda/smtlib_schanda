...
;; H
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1120)
  (<= temp___1120 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1120)
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1120) (select (elts
                                                             (rec__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1120))))))
  (and (<= 1 divisor_index2) (<= divisor_index2 r144b))))
