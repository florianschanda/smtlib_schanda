...
;; my_find__post_axiom
  ...
  (! (=> (dynamic_invariant k true true true)
     ...
     (ite (not (= (bool_eq1 result no_element) true))
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     ...
     (dynamic_invariant3 result true false true))) :pattern ((length
                                                             container)) )))
...
(define-fun default_initial_assumption ((temp___expr_398 us_rep4)
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant1 key2 true true true)
     ...
     (dynamic_invariant3 result true false true)))) :pattern ((find container
                                                              key2)) ))))
...
(define-fun default_initial_assumption1 ((temp___expr_367 us_rep2)
...
(define-fun default_initial_assumption2 ((temp___expr_418 us_rep3)
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant4 key2 true true true)
     ...
     (=>
     (exists ((k1 Int))
     (and (and (in_range4 k1) (= (has_key container k1) true)) (= k1 key2)))
...
;; get__post_axiom
  ...
  (forall ((key2 Int))
  (! (=>
     (and (dynamic_invariant4 key2 true true true)
     ...
     (= (= k1 key2) (= (witness container key2) (witness container k1)))))))
     (dynamic_invariant5 result true false true)))) :pattern ((get2 container
                                                              key2)) ))))

;; length__post_axiom
  (assert
  (forall ((container us_rep2)) (! (dynamic_invariant3 (length3 container)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant3 (length4 container)
...
;; witness__post_axiom
  ...
  (! (=> (= (has_key1 container key2) true)
     ...
     (and (= (has_witness1 container result) true) (dynamic_invariant3 result
...
;; w_get__post_axiom
  ...
  (forall ((witness2 Int))
  (! (=>
     (and (dynamic_invariant3 witness2 true true true)
     (= (has_witness1 container witness2) true)) (dynamic_invariant8
     (w_get1 container witness2) true false true)) :pattern ((w_get1
                                                             container
                                                             witness2)) ))))

(declare-const use_maps__my_contains__result Bool)

(declare-const o count_type)

(declare-const o1 count_type)

(declare-const temp___752 count_type)

(declare-const o2 Bool)

(declare-const result Bool)

(declare-const use_maps__my_contains__result1 Bool)

(declare-const use_maps__my_contains__result2 Bool)

(declare-const use_maps__my_contains__result3 Bool)

(declare-const use_maps__my_contains__result4 Bool)

(declare-const use_maps__my_contains__result5 Bool)
...
;; H
  (assert (= temp___752 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___752)) no_element))

;; H
  (assert (in_range k))

;; H
  (assert (= use_maps__my_contains__result1 use_maps__my_contains__result2))

;; H
  (assert (= use_maps__my_contains__result3 use_maps__my_contains__result1))
...
;; H
  (assert (= result use_maps__my_contains__result))

;; H
  (assert (= use_maps__my_contains__result1 o2))

;; H
  (assert
  (= (mk_bool__ref use_maps__my_contains__result4) (mk_bool__ref
                                                   use_maps__my_contains__result2)))

;; H
  (assert (= use_maps__my_contains__result5 use_maps__my_contains__result3))

;; H
  (assert (= result1 use_maps__my_contains__result4))

;; H
  (assert (= use_maps__my_contains__result4 true))

(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 28, characters 0-0
  (not (not (= (bool_eq1 (my_find s k) no_element) true))))
(check-sat)
(exit)
