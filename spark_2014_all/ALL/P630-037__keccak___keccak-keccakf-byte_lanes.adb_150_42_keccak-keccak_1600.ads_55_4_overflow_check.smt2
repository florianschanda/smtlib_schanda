...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (= temp___750 data2))))
...
;; H
  (assert
  (=> (<= 8 remaining_bytes1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (= temp___748 o4) (in_range1 o4)))))
...
;; H
  (assert (= result17 (mk_int__ref temp___775)))

;; H
  (assert (= temp___7751 offset8))

;; H
  (assert (= result18 (mk_int__ref temp___774)))

;; H
  (assert (= temp___7741 shift2))

;; H
  (assert (= result19 (mk_int__ref temp___773)))
...
;; H
  (assert
  (and (<= (to_rep data__first) temp___766)
  (<= temp___766 (to_rep data__last))))

;; H
  (assert (= o20 temp___766))
...
;; H
  (assert (and (= o22 (+ shift2 8)) (in_range1 (+ shift2 8))))

;; H
  (assert (= result21 (mk_int__ref shift2)))
