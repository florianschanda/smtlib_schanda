...
(define-fun dynamic_invariant ((temp___expr_316 (_ BitVec 8))
...
(declare-datatypes ((t43b__ref 0)) (((mk_t43b__ref (t43b__content us_t1)))))
...
;; def_axiom
  (assert
  (forall ((temp___3355 (_ BitVec 8)))
  (forall ((temp___3356 Int) (temp___3357 Int))
  (let ((temp___3354 (temp___3353 temp___3355 temp___3356 temp___3357)))
  (and
  (=> (dynamic_property 0 2147483647 temp___3356 temp___3357)
  (and (= (first3 temp___3354) temp___3356)
  (= (last3 temp___3354) temp___3357)))
  (forall ((temp___3358 Int))
  (= (select (to_array1 temp___3354) temp___3358) (of_rep3 temp___3355))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_658 us_t)
...
;; H
  (assert (= result (ite (<= o3 256) true false)))
...
(assert
;; WP_parameter_def
 ;; File "dw1000-driver.adb", line 898, characters 0-0
  (not (in_range1 o2)))
(check-sat)
(exit)
