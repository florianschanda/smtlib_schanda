...
(declare-fun p_positions_swapped__function_guard (Bool us_rep3 us_rep3
...
(declare-fun elements_equal_except__2__function_guard (Bool us_rep3 us_rep3
  us_rep1 us_rep1) Bool)
...
;; p_positions_swapped__post_axiom
  ...
  (! (= (= (p_positions_swapped left right x y) true)
     ...
     (= (get1 left x) (get1 right y))) (= (get1 left y) (get1 right x)))) :pattern (
...
;; elements_equal_except__2__post_axiom
  ...
  (! (= (= (elements_equal_except__2 left right x y) true)
     ...
     (and (= (has_key right key) true) (= (get1 left key) (get1 right key))))))) :pattern (
