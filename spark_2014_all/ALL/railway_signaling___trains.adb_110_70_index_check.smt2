...
;; H
  (assert
  (and (= o17 (get_previous_track o26 id1))
  (and (in_range1 o17)
  (= o17 (to_rep3
         (select (select previous_tracks (to_rep1
                                         (rec__trains__track__from
...
;; H
  (assert
  (=> (= result9 true)
  (and (= temp___375 (get_previous_track o25 id1))
  (and (in_range1 temp___375)
  (= temp___375 (to_rep3
                (select (select previous_tracks (to_rep1
                                                (rec__trains__track__from
                                                (us_split_fields1
                                                (select tracks (to_rep o22))))))
                id1)))))))
...
;; H
  (assert
  (=> (= result9 true) (= o24 (select (map__content4 track_signals6) o23))))
...
;; H
  (assert
  (and (= o11 (get_other_previous_track o27 id1))
  (and (in_range1 o11)
  (= o11 (ite (= (to_rep3
                 (select (select previous_tracks (to_rep1
                                                 (rec__trains__track__from
