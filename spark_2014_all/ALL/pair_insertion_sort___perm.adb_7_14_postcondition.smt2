...
;; H
  ...
  (= o (to_rep (last (rt a))))) (= o1 (select (elts a) o)))
  (= o2 (to_rep o1))) (= result (ite (= o2 e) true false)))
  (ite (= result true)
  ...
  (= (mk
     (to_rep
     (first2 (mk1 (to_rep (first (rt b))) (- (to_rep (last (rt b))) 1))))
     (to_rep
     (last2 (mk1 (to_rep (first (rt b))) (- (to_rep (last (rt b))) 1)))))
  o6))))
  (and
