...
;; H
  (assert (and (= o6 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o7 (ite (<= k o6) true false)))

;; H
  (assert (= result1 (ite (<= i2 k) o7 false)))
...
;; H
  (assert (= o1 (from_word32 carry11)))

;; H
  (assert (= o5 (oadd o1 o4)))
