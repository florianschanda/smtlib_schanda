...
;; H
  (assert
  (=> (= (= source 57) true)
  (= aida__conversion__convert_character_digit_to_integer__result4 9)))

;; H
  (assert
  (= result1 aida__conversion__convert_character_digit_to_integer__result4))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= 0 aida__conversion__convert_character_digit_to_integer__result4)))
(check-sat)
(exit)
