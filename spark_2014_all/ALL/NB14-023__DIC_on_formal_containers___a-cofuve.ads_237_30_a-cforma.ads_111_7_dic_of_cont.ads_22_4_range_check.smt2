...
(define-fun dynamic_invariant ((temp___expr_1122 Int)
  (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool)
  (temp___do_toplevel_1121 Bool)) Bool (=>
                                       (or (= temp___is_init_1119 true)
...
(define-fun dynamic_invariant1 ((temp___expr_1134 Int)
  (temp___is_init_1131 Bool) (temp___skip_constant_1132 Bool)
  (temp___do_toplevel_1133 Bool)) Bool (=>
                                       (or (= temp___is_init_1131 true)
...
(define-fun sequence__ref_4__projection ((a sequence__ref)) us_rep (sequence__content
                                                                   a))
...
(define-fun default_initial_assumption ((temp___expr_1141 us_rep)
  (temp___skip_top_level_1142 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1142 true))
                                          (= (length temp___expr_1141) 0)))
...
(define-fun element_type__ref_14__projection ((a element_type__ref)) element_type
  (element_type__content a))

(define-fun dynamic_invariant3 ((temp___expr_1128 Int)
  (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool)
  (temp___do_toplevel_1127 Bool)) Bool (=>
                                       (or (= temp___is_init_1125 true)
...
;; H
  (assert
  (and (= o1 (last left)) (and (in_range3 o1) (= o1 (+ 0 (length left))))))
...
;; H
  (assert
  (=> (< offset 0)
  (and (= o (- (- 2147483648) offset)) (in_range1 (- (- 2147483648) offset)))))
