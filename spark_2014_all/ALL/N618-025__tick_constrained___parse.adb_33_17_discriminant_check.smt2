...
(declare-fun o8 () return_code_t)

(declare-fun o9 () us_split_discrs)

(declare-fun temp___321 () us_rep2)
...
;; H
  (assert (not (= opcode1 ((_ int2bv 8) 0))))

;; H
  (assert (not (= opcode1 ((_ int2bv 8) 1))))

;; H
  (assert
  (= (to_rep2
     (rec__parse__parse_result_t__return_code result____split_discrs2))
  r6b))
...
;; H
  (assert (= o9 (mk___split_discrs o8)))

;; H
  (assert (= temp___321 (mk___rep2 o9 (mk___split_fields2 dummy6) true)))
...
;; WP_parameter_def
 ;; File "parse.ads", line 16, characters 0-0
  (not
  (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___321))
  (rec__parse__parse_result_t__return_code result____split_discrs2))))
(check-sat)
(exit)
