...
;; H
  ...
  (and (in_range5 o12) (<= (+ 0 o12) 2147483647))))
...
;; H
  (assert
  (=> (= result3 true)
  (=> (not (= first_available 0)) (= result4 (ite (< 0 o10) true false)))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (= o9 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
        1))
  (in_range6 o9))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= first_available 0))
  (=> (= result4 true) (= result2 (ite (= o9 first_available) true false))))))

;; H
  (assert
  (=> (= result3 true)
  (=> (not (= first_available 0))
  (=> (not (= result4 true)) (= result2 false)))))
