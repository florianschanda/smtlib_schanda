...
;; H
  (assert
  (and (= (to_rep2 (first2 (rt1 s))) ((_ int2bv 64) 0))
  (bvule count (ite (bvule (to_rep2 (first2 (rt1 s))) (to_rep2
                                                      (last2 (rt1 s))))
               (bvadd (bvsub (to_rep2 (last2 (rt1 s))) (to_rep2
                                                       (first2 (rt1 s)))) ((_ int2bv 64) 1))
               ((_ int2bv 64) 0)))))
