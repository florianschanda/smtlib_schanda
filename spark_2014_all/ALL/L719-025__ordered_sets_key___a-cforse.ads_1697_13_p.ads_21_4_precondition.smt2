...
;; key__post_axiom
  (assert
  (forall ((i Int))
  (! (=> (dynamic_invariant1 i true true true) (dynamic_invariant2 (key i)
     true false true)) :pattern ((key i)) )))

;; key__def_axiom
  (assert
  (forall ((i Int))
  (! (=> (dynamic_invariant1 i true true true) (= (key i) i)) :pattern (
  (key i)) )))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant5 item true true true)
     ...
     (dynamic_invariant4 result true false true)))) :pattern ((find
                                                              container1
                                                              item)) ))))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (forall ((item Int))
     (=> (and (in_range2 item) (= (contains (model__ container1) item) true))
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep1)) (! (dynamic_invariant4 (length2 container1)
...
;; is_empty__post_axiom
  ...
  (! (let ((result (is_empty container1)))
     ...
     (= (= result true)
     (forall ((item Int))
     (not (and (in_range2 item) (= (contains container1 item) true)))))
