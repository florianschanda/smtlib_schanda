...
;; def_axiom
  ...
  (forall ((temp___640 (_ BitVec 32)))
  (= (select (names__hash_table__aggregate_def temp___639) temp___640)
  (of_rep temp___639)))))
...
(((mk_sequence__ref1 (sequence__content1 us_rep3)))))
(define-fun sequence__ref___2__projection ((a sequence__ref1)) us_rep3
...
(define-fun us_rep___3__projection ((a us_rep4)) us_split_fields4 (us_split_fields5
                                                                  a))
...
(((mk_name_entry__ref (name_entry__content us_rep4)))))
...
(define-fun element_type__ref___3__projection ((a element_type__ref)) us_rep4
...
(define-fun element_type__ref___4__projection ((a element_type__ref1)) us_rep4
...
(define-fun dynamic_invariant6 ((temp___expr_282 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_288 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_309 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_436 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_442 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length3 container)))
     (and (<= result (capacity1 container)) (dynamic_invariant11 result true
...
(define-fun dynamic_invariant12 ((temp___expr_421 Int)
