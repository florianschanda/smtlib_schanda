...
(declare-fun user_eq (tparent_intB tparent_intB) Bool)

(declare-const dummy tparent_intB)

(declare-datatypes ((tparent_intB__ref 0))
...
(declare-fun user_eq1 (parent_int parent_int) Bool)

(declare-const dummy1 parent_int)

(declare-datatypes ((parent_int__ref 0))
(((mk_parent_int__ref (parent_int__content parent_int)))))
