...
(declare-fun usq_ () read_status)

(declare-fun usq_1 () character)

(declare-fun usq_2 () Bool)

(declare-fun temp___750 () read_status)

(declare-fun temp___7501 () character)

(declare-fun temp___7502 () Bool)
...
(declare-fun current_read__split_fields () us_split_fields)
...
(declare-fun the_filename2 () int__ref)

(declare-fun the_file3 () file__ref)

(declare-fun current_read__split_fields1 () us_split_fields__ref)

(declare-fun current_read__split_discrs1 () us_split_discrs__ref)

(declare-fun current_line3 () int__ref)

(declare-fun current_col3 () int__ref)
...
(declare-fun next_idx3 () int__ref)

(declare-fun name_table3 () us_private)

(declare-fun the_filename3 () Int)
...
(define-fun next_idx5 () int__ref (mk_int__ref next_idx))
...
;; H
  ...
  (and
  (and
  (and (= (size the_file2) (size the_file1))
  (<= (index the_file2) (size the_file2)))
  (or
  (not
  (= (to_rep2 (rec__file_io__read_result__status next_read__split_discrs1)) 0))
  (= (index the_file2) (+ (index the_file1) 1))))
  (or
  (= (to_rep2 (rec__file_io__read_result__status next_read__split_discrs1)) 0)
  (= (index the_file2) (index the_file1))))))

;; H
  (assert
  (=>
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0)
  (and (= o1 (index the_file2))
  (and (in_range1 o1) (<= o1 (size the_file2))))))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= current_read__split_discrs (mk___split_discrs usq_))))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= current_read__split_fields (mk___split_fields usq_1))))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= current_read__attr__constrained usq_2)))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= result5 (mk___split_discrs__ref
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= next_read__split_discrs1 next_read__split_discrs2)))
...
;; H
  ...
  (not
  (= (to_rep2 (rec__file_io__read_result__status current_read__split_discrs)) 0))
  (= next_read__split_fields1 next_read__split_fields2)))
...
;; H
  (assert (= next_idx3 (mk_int__ref next_idx1)))
...
;; H
  (assert
  (= current_read__split_discrs1 (mk___split_discrs__ref
                                 current_read__split_discrs)))

;; H
  (assert
  (= current_read__split_fields1 (mk___split_fields__ref
                                 current_read__split_fields)))

;; H
  (assert (= the_file3 (mk_file__ref the_file2)))
...
;; H
  (assert (= next_idx4 next_idx1))

;; H
  (assert (= next_read__split_discrs4 next_read__split_discrs1))

;; H
  (assert (= next_read__split_fields4 next_read__split_fields1))
...
;; H
  (assert (= current_read__split_discrs2 current_read__split_discrs))

;; H
  (assert (= current_read__split_fields2 current_read__split_fields))
...
;; WP_parameter_def
 ;; File "lexer.ads", line 65, characters 0-0
  ...
  (= (invariant__1 (us_private__content name_table2)
     (file__content the_file3)
     (us_split_fields__content current_read__split_fields1)
     (us_split_discrs__content current_read__split_discrs1)
     (int__content current_idx2)
     (us_split_fields__content next_read__split_fields3)
     (us_split_discrs__content next_read__split_discrs3)
     (int__content next_idx3)) true)))
(check-sat)
(exit)
