...
(declare-datatypes ((txS__ref 0)) (((mk_txS__ref (txS__content us_rep3)))))
...
(((mk_tT8sP1__ref (tT8sP1__content integer)))))
...
(((mk___split_fields4 (rec__p__my_rec__content2 us_t2)))))
...
(declare-datatypes ((t7s__ref 0)) (((mk_t7s__ref (t7s__content us_rep4)))))
...
(declare-datatypes ((t10s__ref 0)) (((mk_t10s__ref (t10s__content us_t3)))))
...
(((mk_nat_array__ref (nat_array__content us_t4)))))
