...
(define-fun us_split_fields_Dummy2__projection ((a us_split_fields6)) Bool 
  (rec__p__pp__dummy1 a))

(define-fun us_split_fields_R2__projection ((a us_split_fields6)) us_rep1 
  (rec__p__pp__r1 a))
...
(define-fun us_rep_9__projection ((a us_rep3)) us_split_discrs3 (us_split_discrs5
                                                                a))
...
(declare-fun p__pp__b__first__bit1 () Int)

(declare-fun p__pp__b__last__bit1 () Int)

(declare-fun p__pp__b__position1 () Int)
...
(declare-fun p__pp__c__first__bit1 () Int)

(declare-fun p__pp__c__last__bit1 () Int)

(declare-fun p__pp__c__position1 () Int)
...
(declare-fun p__pp__dummy__first__bit1 () Int)

(declare-fun p__pp__dummy__last__bit1 () Int)

(declare-fun p__pp__dummy__position1 () Int)
...
(declare-fun p__pp__r__first__bit1 () Int)

(declare-fun p__pp__r__last__bit1 () Int)

(declare-fun p__pp__r__position1 () Int)
...
(define-fun us_split_fields_Content3__projection ((a us_split_fields8)) us_t2 
  (rec__p__my_rec__content2 a))

(declare-datatypes ()
((us_split_fields__ref4
 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref_3__projection ((a us_split_fields__ref4)) us_split_fields8 
...
(define-fun us_rep_5__projection ((a us_rep4)) us_split_discrs (us_split_discrs6
                                                               a))

(define-fun us_rep_6__projection ((a us_rep4)) us_split_fields8 (us_split_fields9
                                                                a))
...
(declare-fun p__my_rec__c__first__bit2 () Int)

(declare-fun p__my_rec__c__last__bit2 () Int)

(declare-fun p__my_rec__c__position2 () Int)
...
(declare-fun p__my_rec__content__first__bit2 () Int)

(declare-fun p__my_rec__content__last__bit2 () Int)

(declare-fun p__my_rec__content__position2 () Int)
...
(declare-fun x__split_discrs () us_split_discrs3)
...
(declare-fun x__split_fields2 () (Array Int natural))

(declare-fun x__split_fields3 () t1)

(declare-fun temp___c_226 () Int)
...
(declare-fun p__d__assume () Bool)

(declare-fun o15 () us_rep3)

(declare-fun o16 () us_rep2)

(declare-fun p__e__assume () Bool)

(declare-fun x__split_fields4 () us_split_fields6)

(declare-fun x__split_fields5 () us_split_fields6)

(declare-fun x__split_fields6 () us_split_fields6)
...
;; H
  ...
  (mk___rep3 x__split_discrs
  (mk___split_fields3 x__split_fields
  (mk___rep1 (mk___split_discrs x__split_fields1)
  (mk___split_fields1 (mk___t1 x__split_fields2 x__split_fields3))))) false))
...
;; H
  (assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields4)
  true true true))
...
;; H
  (assert
  (= x__split_fields4 (mk___split_fields3 o2
                      (mk___rep1 (mk___split_discrs o3)
                      (mk___split_fields1 (mk___t1 o4 o5))))))
...
;; H
  (assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields5)
  true true true))

;; H
  (assert (= x__split_discrs (mk___split_discrs1 o8 o9)))

;; H
  (assert
  (= x__split_fields5 (mk___split_fields3 o10
                      (mk___rep1 (mk___split_discrs o11)
                      (mk___split_fields1 (mk___t1 o12 o13))))))

;; H
  (assert
  (= o14 (mk___rep2 (mk___split_discrs1 o8 o9)
         (mk___split_fields2 o10
         (mk___rep1 (mk___split_discrs o11)
         (mk___split_fields1 (mk___t1 o12 o13)))))))

;; H
  (assert
  (and (= p__d__assume (prot o14))
  (= (= p__d__assume true)
  (and (= (rec__p__pp__b (us_split_discrs4 o14)) true)
  (= (rec__p__pp__dummy (us_split_fields5 o14)) true)))))

;; H
  (assert (= p__d__assume d))

;; H
  (assert (= d true))

;; H
  (assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields6)
  true true true))

;; H
  (assert (= o15 (mk___rep3 x__split_discrs x__split_fields6)))

;; H
  (assert
  (= o16 (mk___rep2 (us_split_discrs5 o15)
         (mk___split_fields2 (rec__p__pp__dummy1 (us_split_fields7 o15))
         (rec__p__pp__r1 (us_split_fields7 o15))))))

;; H
  (assert
  (and (= p__e__assume (prot o16))
  (= (= p__e__assume true)
  (and (= (rec__p__pp__b (us_split_discrs4 o16)) true)
  (= (rec__p__pp__dummy (us_split_fields5 o16)) true)))))

;; H
  (assert (= p__e__assume e))
