...
(declare-fun saturate__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun saturate__result1 () (_ BitVec 16))

(declare-fun saturate__result2 () (_ BitVec 16))

(declare-fun saturate__result3 () (_ BitVec 16))

(declare-fun saturate__result4 () (_ BitVec 16))

(declare-fun saturate__result5 () (_ BitVec 16))
...
;; WP_parameter_def
 ;; File "interfac.ads", line 66, characters 0-0
  (not (bvult saturate__result4 ((_ int2bv 16) 256))))
(check-sat)
