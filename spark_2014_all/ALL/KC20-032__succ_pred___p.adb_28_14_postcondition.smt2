...
(declare-fun p__ident__3__result () volt)

(declare-fun o () volt)

(declare-fun result () volt)

(declare-fun p__ident__3__result1 () volt)

(declare-fun p__ident__3__result2 () volt)

(declare-fun p__ident__3__result3 () volt)

(declare-fun p__ident__3__result4 () volt)

(declare-fun p__ident__3__result5 () volt)

(declare-fun result1 () volt)

;; H
  (assert (not (= (to_fixed1 v) 2040)))

;; H
  (assert (= p__ident__3__result1 p__ident__3__result2))

;; H
  (assert (= p__ident__3__result3 p__ident__3__result1))

;; H
  (assert (= (to_fixed1 o) (- (+ (to_fixed1 v) 1) 1)))

;; H
  (assert (= result p__ident__3__result))

;; H
  (assert (= p__ident__3__result1 o))

;; H
  (assert
  (= (mk_volt__ref p__ident__3__result4) (mk_volt__ref p__ident__3__result2)))

;; H
  (assert (= p__ident__3__result5 p__ident__3__result3))

;; H
  (assert (= result1 p__ident__3__result4))

(assert
;; WP_parameter_def
 ;; File "p.adb", line 4, characters 0-0
  (not (= (to_fixed1 p__ident__3__result4) (to_fixed1 v))))
(check-sat)
(exit)
