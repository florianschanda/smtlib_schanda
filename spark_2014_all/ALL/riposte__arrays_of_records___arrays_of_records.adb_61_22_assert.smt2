...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a1 17))) o1))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a1 17))) o3))
...
;; H
  (assert (= o7 (store a1 17 (mk___rep (mk___split_fields o4 o5 o6)))))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a2 101))) o9))

;; H
  (assert
  (= (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a2 101))) o10))
...
;; H
  (assert (= o15 (store a2 101 (mk___rep (mk___split_fields o12 o13 o14)))))
...
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 42, characters 0-0
  ...
  (= (to_rep
     (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a3 101)))) 23)))
(check-sat)
(exit)
