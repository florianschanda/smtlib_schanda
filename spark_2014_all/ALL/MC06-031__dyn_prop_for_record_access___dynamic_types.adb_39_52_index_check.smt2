...
;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (- from2 1)))
  (not (= (to_rep (select (elts a) i1)) c)))))
...
;; H
  (assert (and (= o1 (- from2 1)) (in_range1 (- from2 1))))

;; H
  (assert (= o2 (ite (<= i o1) true false)))

;; H
  (assert (= result1 (ite (<= (to_rep1 (first (rt a))) i) o2 false)))
