...
(declare-datatypes ((tbS__ref 0)) (((mk_tbS__ref (tbS__content us_rep)))))
...
(define-fun b__split_fields2 () us_split_fields (mk___split_fields
                                                b__split_fields1))
...
;; H
  (assert
  (and
  (= 0 (to_rep (rec__constrained_attribute__mut_rec__d b__split_discrs)))
