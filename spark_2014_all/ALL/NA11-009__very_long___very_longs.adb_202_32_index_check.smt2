...
(define-fun i13 () int__ref (mk_int__ref i9))

(define-fun digit_count12 () int__ref (mk_int__ref digit_count8))

(define-fun i14 () int__ref (mk_int__ref i7))
...
;; H
  (assert (=> (= result1 true) (= (mk_int__ref result2) i15)))

;; H
  (assert (=> (= result1 true) (= i3 1)))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (=> (= result3 true) (and (= o5 i3) (in_range1 i3))))))
...
;; H
  (assert (<= (+ very_longs__number_of_digits__result4 1) i1))
