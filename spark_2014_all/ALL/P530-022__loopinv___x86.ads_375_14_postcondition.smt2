...
(declare-fun x86__bp__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__bp__result1 () (_ BitVec 16))

(declare-fun x86__bp__result2 () (_ BitVec 16))

(declare-fun x86__bp__result3 () (_ BitVec 16))

(declare-fun x86__bp__result4 () (_ BitVec 16))

(declare-fun x86__bp__result5 () (_ BitVec 16))

(declare-fun result1 () (_ BitVec 16))

;; H
  (assert (= x86__bp__result1 x86__bp__result2))

;; H
  (assert (= x86__bp__result3 x86__bp__result1))

;; H
  (assert (= result x86__bp__result))

;; H
  (assert
  (= x86__bp__result1 ((_ extract 15 0) (bvand rbp ((_ int2bv 64) 65535)))))

;; H
  (assert (= (mk_t__ref x86__bp__result4) (mk_t__ref x86__bp__result2)))

;; H
  (assert (= x86__bp__result5 x86__bp__result3))

;; H
  (assert (= result1 x86__bp__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not (= x86__bp__result4 (readreg16 rbp))))
(check-sat)
