...
(declare-fun arithmetic__halve_b__result () Int)
...
(declare-fun arithmetic__halve_b__result1 () Int)

(declare-fun arithmetic__halve_b__result2 () Int)

(declare-fun arithmetic__halve_b__result3 () Int)

(declare-fun r13 () Int)

(declare-fun i12 () Int)

(declare-fun arithmetic__halve_b__result4 () int__ref)

(declare-fun r14 () Int)

(declare-fun i13 () Int)

(declare-fun arithmetic__halve_b__result5 () Int)
...
;; H
  (assert
  (= arithmetic__halve_b__result4 (mk_int__ref arithmetic__halve_b__result2)))
...
;; WP_parameter_def
 ;; File "arithmetic.adb", line 3, characters 0-0
  (not
  (or
  (= (+ (int__content arithmetic__halve_b__result4) (int__content
                                                    arithmetic__halve_b__result4))
  n)
  (= (+ (+ (int__content arithmetic__halve_b__result4) (int__content
                                                       arithmetic__halve_b__result4)) 1)
  n))))
(check-sat)
(exit)
