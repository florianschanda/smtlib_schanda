...
;; H
  (assert
  (and (= o28 (+ (to_rep1 (first (rt source))) 9)) (in_range1
...
;; H
  (assert
  (and (= temp___1856 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1856)
  (<= temp___1856 (to_rep1 (last (rt source))))))

;; H
  (assert (= o8 temp___1856))
...
;; H
  (assert
  (and (= temp___1855 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1855)
  (<= temp___1855 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___1855))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1854)
  (<= temp___1854 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1854))
