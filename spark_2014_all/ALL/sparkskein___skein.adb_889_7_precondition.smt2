...
(define-fun ctx__split_fields12 () us_split_fields4 (mk___split_fields2
                                                    (mk___rep1
                                                    (mk___split_fields1
                                                    (mk___rep
                                                    (mk___split_fields
...
;; H
  ...
  (and
  (and
  (and (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields12)))
  (= (hash_bit_len_of (mk___rep2 ctx__split_fields12)) ((_ int2bv 64) 512)))
  (= (byte_count_of (mk___rep2 ctx__split_fields12)) ((_ int2bv 64) 0)))
  (in_range7 (byte_count_of (mk___rep2 ctx__split_fields12))))
  (bvult (to_rep (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615))))

(assert
;; WP_parameter_def
 ;; File "skein.ads", line 110, characters 0-0
  (not (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields12)))))
(check-sat)
(exit)
