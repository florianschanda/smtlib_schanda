...
;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= k10 i1) (<= i1 (to_rep1 a__last)))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a8 i1))))
  max12))))
...
;; H
  ...
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a8 j1))))
  (to_rep
  (rec__frame_condition__cell__max_right (us_split_fields1 (select a8 i1))))))))))
