...
(declare-const temp___425 Bool)

(declare-const temp___4251 unsigned_byte)

(declare-const temp___4252 unsigned_byte)
...
;; H
  (assert (= temp___425 o6))

;; H
  (assert (= temp___4251 o7))

;; H
  (assert (= temp___4252 o8))
...
;; H
  (assert (= temp___425 x__split_fields3))

;; H
  (assert (= temp___4251 x__split_fields4))

;; H
  (assert (= temp___4252 x__split_fields5))

(assert
;; WP_parameter_def
 ;; File "records.adb", line 421, characters 0-0
  (not (not (= x__split_fields3 true))))
(check-sat)
(exit)
