...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___864 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___863 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___862 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (=> (not (= is_root true)) (= o22 (select temp___862 j2))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___861 j5))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (=> (not (= is_root true)) (= o18 (select temp___861 j2))))
...
;; H
  (assert
  (and
  (= o97 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range4 o97)
  (= o97 (size
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i))
  (and
  (= o94 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o94)
  (= o94 (to_rep1
         (rec__search_trees__search_tree__root
         (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i)))
  (and
  (= o96 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o96)
  (= o96 (to_rep1
         (rec__search_trees__search_tree__root
         (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3))) i)))
  (= result27 (ite (= o96 o95) true false))))
...
;; H
  (assert
  (and
  (= o93 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range4 o93)
  (and
  (= o93 (parent
...
;; H
  (assert
  (and
  (= o91 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range5 o91)
  (= o91 (position
         (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (and
  (= o90 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o88))
  (and (in_range4 o90)
  (and
  (= o90 (parent
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i))
  (and
  (= o84 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o82))
  (and (in_range5 o84)
  (= o84 (position
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (root
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3))) i))
  (= result31 (ite (= o84 o83) true false))))
...
;; H
  ...
  (=> (= result33 true)
  (and
  (= o78 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o77))
  (and (in_range4 o78)
  (and
  (= o78 (parent
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o54 o53) (in_range3 o53)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o56 o55) (in_range3 o55)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o58 o57) (in_range3 o57)))))
...
;; H
  ...
  (=> (= result34 true)
  (and
  (= o65 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o64))
  (and (in_range5 o65)
  (= o65 (position
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields12)) o64)))))))

;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (= result32 (ite (= o65 1) true false)))))
...
;; H
  ...
  (= (parent1
     ...
     (mk___split_fields3 t__split_fields
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3)) j5) i))
  (= (position1
     (mk___rep3
     (mk___split_fields3 t__split_fields
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3)) j5) 0)))
  (or
  (or
  (or
  (= (parent1
  ...
  (= (position1
     ...
     (mk___split_fields3 t__split_fields
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3)) j5) 1)))
  (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12)) j5) 
  (parent1
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
...
;; H
  ...
  (= (position1
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3)) j5) 1)))
  (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12)) j5) 
  (position1
  (mk___rep3
  (mk___split_fields3 t__split_fields
  (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__1
             (mk___rep3 (us_split_fields__content3 t__split_fields12))) j5))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__1
             (mk___rep3
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (mk___rep2
             (mk___split_fields2 t__split_fields1 t__split_fields2))
             (to_rep1 t__split_fields)) i1))) true)
  (= (contains o46 (to_rep (select t__split_fields3 i1))) true))))
  (forall ((v Int))
  (=> (and (<= 0 v) (<= v 2147483647))
  (=> (= (contains o46 v) true)
  (exists ((i1 Int))
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (mk___split_fields2 t__split_fields1 t__split_fields2))
             (to_rep1 t__split_fields)) i1))) true)
  (= (to_rep (select t__split_fields3 i1)) v)))))))))))
...
;; H
  (assert
  (and
  (= o45 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (ite (= (size
          (rec__search_trees__search_tree__struct
          (us_split_fields__content3 t__split_fields12))) 0)
  (= (is_empty o45) true)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (to_rep1
             (rec__search_trees__search_tree__root
             (us_split_fields__content3 t__split_fields12)))) i1))) true)
  (= (contains o45
     (to_rep
  ...
  (= (to_rep
     (select (rec__search_trees__search_tree__values
             (us_split_fields__content3 t__split_fields12)) i1)) v)))))))))))

;; H
  (assert
  (and (= result39 (oeq2 o45 o46))
  (= (= result39 true) (and (= (ole o45 o46) true) (= (ole o46 o45) true)))))
...
;; H
  (assert
  (and
  (= o44 (peek1 (mk___rep3 (us_split_fields__content3 t__split_fields12)) 
         i 1))
  (and (in_range4 o44)
  (= o44 (peek
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields12)) i 1)))))
