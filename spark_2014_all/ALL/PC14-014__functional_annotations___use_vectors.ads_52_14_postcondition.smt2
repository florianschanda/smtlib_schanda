...
;; H
  (assert (=> (and (<= first i1) (<= i1 r17b)) (= temp___448 i1)))
...
;; H
  (assert (=> (and (<= first i1) (<= i1 r17b)) (= o1 i2)))
...
;; H
  (assert (=> (and (<= first i1) (<= i1 r17b)) (= i2 r17b)))

;; H
  (assert (=> (and (<= first i1) (<= i1 r17b)) (= i2 i3)))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r17b)) (= v__split_fields4 v__split_fields3)))

;; H
  (assert (=> (and (<= first i1) (<= i1 r17b)) (= i4 i2)))
...
;; H
  (assert (=> (and (<= first i1) (<= i1 r17b)) (= i5 (mk_int__ref i3))))
...
;; H
  (assert (=> (and (<= first i1) (<= i1 r17b)) (= i6 i4)))
...
;; H
  (assert
  (=> (not (and (<= first i1) (<= i1 r17b))) (= i5 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (and (<= first i1) (<= i1 r17b)))
  (= v__split_fields6 (mk___split_fields__ref
                      (mk___split_fields v__split_fields)))))

;; H
  (assert (=> (not (and (<= first i1) (<= i1 r17b))) (= i6 i1)))
...
;; WP_parameter_def
 ;; File "use_vectors.ads", line 43, characters 0-0
  (not
  (= (length
     (mk___rep v__split_discrs (us_split_fields__content v__split_fields8))) (* 2
  (length (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))))
(check-sat)
(exit)
