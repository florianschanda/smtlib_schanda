...
(define-fun us_split_fields__ref___12__projection ((a us_split_fields__ref3)) us_split_fields6
...
(define-fun us_split_fields_IsDisplayed__2__projection ((a us_split_fields8)) Bool
  (rec__screen__screenconfigt__isdisplayed a))

(define-fun us_split_fields_Data__2__projection ((a us_split_fields8)) us_rep3
