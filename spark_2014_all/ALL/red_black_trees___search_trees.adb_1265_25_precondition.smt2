...
(declare-fun temp___2074 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= o10 (to_rep1 t_old__split_fields)) (in_range3
...
;; H
  ...
  (= temp___2092 (model__
                 ...
                 t_old__split_fields2)) o10))
  (and (dynamic_invariant8 temp___2092 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 o10))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 o10)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o10))
...
;; H
  (assert (= o11 (select temp___2092 l)))
...
;; H
  (assert
  (and
  (= o8 (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))
  (in_range4 o8)))
...
;; H
  (assert
  (and
  (= o4 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) 
        l d))
  (and (in_range4 o4)
  (and
  (ite (not (= o4 0))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2074 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2074 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2074 o)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2074 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2074 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2074 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2074 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2074 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2074 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2074 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o1 (select temp___2074 j)))
...
;; H
  (assert
  (and
  (= o3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
