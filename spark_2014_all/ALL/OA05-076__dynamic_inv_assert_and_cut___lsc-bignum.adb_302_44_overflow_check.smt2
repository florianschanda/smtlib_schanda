...
;; H
  (assert (and (= o40 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o41 (ite (<= k o40) true false)))

;; H
  (assert (and (= o39 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o42 (ite (<= o39 k) true false)))

;; H
  (assert (= result3 (ite (= o42 true) o41 false)))
...
;; H
  (assert (= o34 (from_word32 carry22)))
...
;; H
  (assert (= o32 (from_word32 carry12)))
...
;; H
  (assert
  (= o25 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o24)))
