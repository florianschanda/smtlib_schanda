...
(declare-fun string_search__brute_force__result2 () int__ref)

(declare-fun string_search__brute_force__result3 () Int)

(define-fun j12 () int__ref (mk_int__ref j8))

(define-fun diff13 () bool__ref (mk_bool__ref diff9))

(define-fun j13 () int__ref (mk_int__ref j6))

(define-fun diff14 () bool__ref (mk_bool__ref diff7))
...
;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= temp___266 j1)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= temp___265 diff1)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle)))))
  (and (= temp___264 (+ j1 (- i1 1))) (in_range1 (+ j1 (- i1 1))))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= o5 temp___264)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= o6 (select (elts haystack)
  o5))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= o7 (to_rep o6))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle)))))
  (= o8 (ite (= (to_rep (select (elts needle) j1)) o7) true false))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= diff1 result3)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= diff2 o9)))
...
;; H
  ...
  (<= j1 (to_rep1 (last (rt needle)))))
  (or
  (and (and (and (= j1 j6) (= diff2 diff7)) (and (= j7 j1) (= diff8 diff2)))
  (= diff2 true))
  (and (not (= diff2 true))
  (and
  (and (and (= j13 (mk_int__ref j4)) (= diff14 (mk_bool__ref diff5)))
  (and (= j7 j5) (= diff8 diff6)))
  (and
  (and (= (partial_match_at needle haystack i1 j2) true)
  (= (= diff3 true)
  (not
  ...
  (or
  (and (and (and (= j2 j4) (= diff3 diff5)) (and (= j5 j2) (= diff6 diff3)))
  (= j2 (to_rep1 (last (rt needle)))))
  (and (not (= j2 (to_rep1 (last (rt needle)))))
  (and (and (and (= j3 j4) (= diff4 diff5)) (and (= j5 j3) (= diff6 diff4)))
  (and (and (= j2 result4) (= j3 (+ j2 1)))
  (and
  (and
  (and
  (and
  (and
  (and
  (and (and (= temp___2641 (+ j3 (- i1 1))) (in_range1 (+ j3 (- i1 1))))
  (and
  ...
  (= o13 (ite (= (to_rep (select (elts needle) j3)) o12) true false)))
  (= o14 (ite (not (= o13 true)) true false)))
  (and (= diff3 result5) (= diff4 o14))) (= diff4 true)))))))))))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= j12 j13)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= diff13 diff14)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= j9 j7)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= diff10 diff8)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= (mk_int__ref j10) j12)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= (mk_bool__ref diff11) diff13)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= j11 j9)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle))))) (= diff12 diff10)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle)))))) (= j1 j10)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle)))))) (= diff1 diff11)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle)))))) (= j11 j1)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt needle))) j1)
  (<= j1 (to_rep1 (last (rt needle)))))) (= diff12 diff1)))
...
;; H
  (assert
  (= string_search__brute_force__result2 (mk_int__ref
                                         string_search__brute_force__result)))

;; H
  (assert
  (= string_search__brute_force__result3 string_search__brute_force__result1))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (match_at needle haystack k) true))))
(check-sat)
(exit)
