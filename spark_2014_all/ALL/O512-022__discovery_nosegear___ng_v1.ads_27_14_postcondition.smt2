...
;; WP_parameter_def
 ;; File "interfac.ads", line 66, characters 0-0
  (not
  (= (t__content estimatedgroundvelocity5) (bvudiv (bvmul (bvadd (bvmul ((_ int2bv 16) 207) (bvsub
  thiscount prevcount)) (bvudiv (bvmul (bvmul ((_ int2bv 16) 207) (bvsub
  thiscount prevcount)) (bvsub currtime thistime)) (bvsub thistime prevtime))) ((_ int2bv 16) 3600)) (bvsub
  currtime prevtime)))))
(check-sat)
(exit)
