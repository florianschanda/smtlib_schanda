...
(declare-const o2 (Array (_ BitVec 8) integer))

(declare-const o3 message_index)

(declare-const o4 message_index)

(declare-const o5 message_count)

(declare-const o6 (Array (_ BitVec 8) integer))
...
(declare-const o10 message_index)

(declare-const o11 (Array (_ BitVec 8) integer))

(declare-const o12 message_index)

(declare-const o13 message_index)

(declare-const o14 message_count)

(declare-const o15 (Array (_ BitVec 8) integer))
...
(declare-const result (Array (_ BitVec 8) integer))
...
(declare-const result4 (Array (_ BitVec 8) integer))

(declare-const result5 message_index)

(declare-const result6 message_index)

(declare-const result7 message_count)

(declare-const self__8 us_rep)
