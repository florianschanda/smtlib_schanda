...
;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= i2 j1) (<= j1 (to_rep sq__last)))
  (= (to_rep1 (select sq1 j1)) (to_rep1 (select sq j1))))))
...
;; H
  (assert (and (<= (to_rep sq__first) j) (<= j (to_rep sq__last))))

;; H
  (assert (= o j))

;; H
  (assert (= o1 (select sq o)))
