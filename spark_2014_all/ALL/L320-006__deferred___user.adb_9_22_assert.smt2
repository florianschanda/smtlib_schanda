...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__pack__t1__x Bool)))))
...
(declare-fun pack__t1__x__first__bit () Int)

(declare-fun pack__t1__x__last__bit () Int)

(declare-fun pack__t1__x__position () Int)
