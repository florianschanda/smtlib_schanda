...
(declare-fun integer_stacks__stack__capacity__first__bit () Int)

(declare-fun integer_stacks__stack__capacity__last__bit () Int)

(declare-fun integer_stacks__stack__capacity__position () Int)
...
(declare-fun integer_stacks__stack__values__first__bit () Int)

(declare-fun integer_stacks__stack__values__last__bit () Int)

(declare-fun integer_stacks__stack__values__position () Int)
...
(declare-fun integer_stacks__stack__top__first__bit () Int)

(declare-fun integer_stacks__stack__top__last__bit () Int)

(declare-fun integer_stacks__stack__top__position () Int)
...
(declare-fun this__split_discrs () us_split_discrs)
...
(declare-datatypes ()
((tT21bP1__ref (mk_tT21bP1__ref (tT21bP1__content integer)))))
(define-fun tT21bP1__ref___projection ((a tT21bP1__ref)) integer (tT21bP1__content
                                                                 a))
...
(define-fun us_split_fields_Values2__projection ((a us_split_fields2)) us_t1
  (rec__integer_stacks__stack__values1 a))

(define-fun us_split_fields_Top2__projection ((a us_split_fields2)) natural
...
(declare-fun integer_stacks__stack__capacity__first__bit1 () Int)

(declare-fun integer_stacks__stack__capacity__last__bit1 () Int)

(declare-fun integer_stacks__stack__capacity__position1 () Int)
...
(declare-fun integer_stacks__stack__values__first__bit1 () Int)

(declare-fun integer_stacks__stack__values__last__bit1 () Int)

(declare-fun integer_stacks__stack__values__position1 () Int)
...
(declare-fun integer_stacks__stack__top__first__bit1 () Int)

(declare-fun integer_stacks__stack__top__last__bit1 () Int)

(declare-fun integer_stacks__stack__top__position1 () Int)
...
(declare-datatypes ()
((contents__ref (mk_contents__ref (contents__content us_t3)))))
(define-fun contents__ref___projection ((a contents__ref)) us_t3 (contents__content
                                                                 a))
...
;; def_axiom
  ...
  (let ((temp___261 (temp___260 temp___262 temp___263 temp___264)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___263 temp___264)
  (and (= (first5 temp___261) temp___263) (= (last5 temp___261) temp___264)))
  (forall ((temp___265 Int))
  (= (select (to_array2 temp___261) temp___265) (of_rep3 temp___262)))))))
...
((us_split_fields4
 (mk___split_fields2
 (rec__integer_stacks__stack__values2 us_t4)(rec__integer_stacks__stack__top2 natural)(rec__ext__2 us_private)))))
(define-fun us_split_fields_Values3__projection ((a us_split_fields4)) us_t4
  (rec__integer_stacks__stack__values2 a))

(define-fun us_split_fields_Top3__projection ((a us_split_fields4)) natural
...
(declare-fun integer_stacks__stack__capacity__first__bit2 () Int)

(declare-fun integer_stacks__stack__capacity__last__bit2 () Int)

(declare-fun integer_stacks__stack__capacity__position2 () Int)
...
(declare-fun integer_stacks__stack__values__first__bit2 () Int)

(declare-fun integer_stacks__stack__values__last__bit2 () Int)

(declare-fun integer_stacks__stack__values__position2 () Int)
...
(declare-fun integer_stacks__stack__top__first__bit2 () Int)

(declare-fun integer_stacks__stack__top__last__bit2 () Int)

(declare-fun integer_stacks__stack__top__position2 () Int)
...
;; mk_def
  ...
  (! (=> (in_range2 f)
     (=> (in_range2 l)
     (and (= (to_rep2 (first10 (mk5 f l))) f)
     (= (to_rep2 (last10 (mk5 f l))) l)))) :pattern ((mk5 f l)) )))
...
(declare-datatypes ()
((us_t5 (mk___t5 (elts5 (Array Int element))(rt5 t5)))))
(define-fun to_array5 ((a us_t5)) (Array Int element) (elts5 a))

(define-fun of_array5 ((a (Array Int element)) (f Int)
...
(define-fun bool_eq9 ((x us_t5)
  (y us_t5)) Bool (bool_eq (elts5 x) (to_rep2 (first10 (rt5 x)))
                  (to_rep2 (last10 (rt5 x))) (elts5 y)
                  (to_rep2 (first10 (rt5 y))) (to_rep2 (last10 (rt5 y)))))

(declare-fun user_eq17 (us_t5 us_t5) Bool)

(declare-fun dummy17 () us_t5)
...
((us_split_fields6
 (mk___split_fields3
 (rec__integer_stacks__stack__values3 us_t5)(rec__integer_stacks__stack__top3 natural)(rec__ext__3 us_private)))))
(define-fun us_split_fields_Values4__projection ((a us_split_fields6)) us_t5
  (rec__integer_stacks__stack__values3 a))

(define-fun us_split_fields_Top4__projection ((a us_split_fields6)) natural
...
(define-fun us_rep_10__projection ((a us_rep3)) us_split_discrs (us_split_discrs4
                                                                a))

(define-fun us_rep_11__projection ((a us_rep3)) us_split_fields6 (us_split_fields7
                                                                 a))

(define-fun us_rep_12__projection ((a us_rep3)) Int (attr__tag3 a))
...
(declare-fun integer_stacks__stack__capacity__first__bit3 () Int)

(declare-fun integer_stacks__stack__capacity__last__bit3 () Int)

(declare-fun integer_stacks__stack__capacity__position3 () Int)
...
(declare-fun integer_stacks__stack__values__first__bit3 () Int)

(declare-fun integer_stacks__stack__values__last__bit3 () Int)

(declare-fun integer_stacks__stack__values__position3 () Int)
...
(declare-fun integer_stacks__stack__top__first__bit3 () Int)

(declare-fun integer_stacks__stack__top__last__bit3 () Int)

(declare-fun integer_stacks__stack__top__position3 () Int)
...
;; mk_def
  ...
  (! (=> (in_range2 f)
     (=> (in_range2 l)
     (and (= (to_rep2 (first12 (mk6 f l))) f)
     (= (to_rep2 (last12 (mk6 f l))) l)))) :pattern ((mk6 f l)) )))
...
(declare-datatypes ()
((us_t6 (mk___t6 (elts6 (Array Int element))(rt6 t6)))))
(define-fun to_array6 ((a us_t6)) (Array Int element) (elts6 a))

(define-fun of_array6 ((a (Array Int element)) (f Int)
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int element))) (<= 0 (object__component__size6 a))))
...
(define-fun bool_eq11 ((x us_t6)
  (y us_t6)) Bool (bool_eq (elts6 x) (to_rep2 (first12 (rt6 x)))
                  (to_rep2 (last12 (rt6 x))) (elts6 y)
                  (to_rep2 (first12 (rt6 y))) (to_rep2 (last12 (rt6 y)))))

(declare-fun user_eq20 (us_t6 us_t6) Bool)

(declare-fun dummy20 () us_t6)
...
;; def_axiom
  (assert
  (forall ((temp___220 Int) (temp___221 Int) (temp___222 Int))
  (let ((temp___219 (temp___218 temp___220 temp___221 temp___222)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___221 temp___222)
  (and (= (first13 temp___219) temp___221)
  (= (last13 temp___219) temp___222)))
  (forall ((temp___223 Int))
  (= (select (to_array6 temp___219) temp___223) (of_rep3 temp___220)))))))

;; user_eq__def_axiom
  (assert
  (forall ((a us_rep3) (b us_rep3))
  (! (= (user_eq18 a b) (oeq (to_base2 a) (to_base2 b))) :pattern ((user_eq18
                                                                   a b)) )))

(define-fun dynamic_invariant5 ((temp___expr_229 us_rep3)
  (temp___is_init_226 Bool) (temp___skip_constant_227 Bool)
  (temp___do_toplevel_228 Bool)) Bool (and
                                      (=>
                                      ...
                                      (to_base2 temp___expr_229)))
                                      (and (dynamic_property10 1
                                      (to_rep1
                                      (rec__integer_stacks__stack__capacity
                                      (us_split_discrs1 left)))
                                      (first11
                                      (rec__integer_stacks__stack__values3
                                      (us_split_fields7 temp___expr_229)))
                                      (last11
                                      (rec__integer_stacks__stack__values3
                                      (us_split_fields7 temp___expr_229))))
                                      (and
                                      (= (first11
                                         (rec__integer_stacks__stack__values3
                                         (us_split_fields7 temp___expr_229))) 1)
                                      (= (last11
                                         (rec__integer_stacks__stack__values3
                                         (us_split_fields7 temp___expr_229)))
                                      (to_rep1
...
(define-fun default_initial_assumption ((temp___expr_232 us_rep3)
  (temp___skip_top_level_233 Bool)) Bool (and
                                         (and
                                         (= (attr__tag3 temp___expr_232)
                                         us_tag3)
                                         (and
                                         (and
                                         (= (to_rep1
                                            (rec__integer_stacks__stack__capacity
                                            (us_split_discrs4
                                            temp___expr_232))) (to_rep1
                                                               (rec__integer_stacks__stack__capacity
                                                               (us_split_discrs1
                                                               left))))
                                         (= (rec__integer_stacks__stack__values3
                                            (us_split_fields7
                                            temp___expr_232)) (let ((temp___235
                                                              (temp___218 0 1
                                                              (to_rep1
                                                              (rec__integer_stacks__stack__capacity
                                                              (us_split_discrs4
                                         ...
                                         (=>
                                         (not
                                         (= temp___skip_top_level_233 true))
                                         (= (empty
                                            (to_base2 temp___expr_232)) true))))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq15 a b) (oeq (to_base1 a) (to_base1 b))) :pattern ((user_eq15
                                                                   a b)) )))

(define-fun dynamic_invariant6 ((temp___expr_212 us_rep2)
  ...
  (temp___do_toplevel_211 Bool)) Bool (and
                                      ...
                                      (to_base1 temp___expr_212)))
                                      (and (dynamic_property8 1
                                      (to_rep1
                                      (rec__integer_stacks__stack__capacity
                                      (us_split_discrs1 right)))
                                      (first9
                                      (rec__integer_stacks__stack__values2
                                      (us_split_fields5 temp___expr_212)))
                                      (last9
                                      (rec__integer_stacks__stack__values2
                                      (us_split_fields5 temp___expr_212))))
                                      (and
                                      (= (first9
                                         (rec__integer_stacks__stack__values2
                                         (us_split_fields5 temp___expr_212))) 1)
                                      (= (last9
                                         (rec__integer_stacks__stack__values2
                                         (us_split_fields5 temp___expr_212)))
                                      (to_rep1
...
(define-fun default_initial_assumption1 ((temp___expr_215 us_rep2)
  (temp___skip_top_level_216 Bool)) Bool (and
                                         ...
                                         (= (to_rep1
                                            (rec__integer_stacks__stack__capacity
                                            (us_split_discrs3
                                            temp___expr_215))) (to_rep1
                                                               (rec__integer_stacks__stack__capacity
                                                               (us_split_discrs1
                                                               right))))
                                         (= (rec__integer_stacks__stack__values2
                                            (us_split_fields5
                                            temp___expr_215)) (let ((temp___224
                                                              (temp___218 0 1
                                                              (to_rep1
                                                              (rec__integer_stacks__stack__capacity
                                                              (us_split_discrs3
                                         ...
                                         (= (empty
                                            (to_base1 temp___expr_215)) true))))

(declare-fun this__split_fields () (Array Int element))

(declare-fun this__split_fields1 () t)

(declare-fun this__split_fields2 () natural)

(declare-fun this__split_fields3 () us_private)

(declare-fun temp___267 () (Array Int element))

(declare-fun temp___2671 () t2)

(declare-fun o () natural)

(declare-fun o1 () (Array Int element))
...
(declare-fun temp___268 () positive)

(declare-fun temp___2681 () (Array Int element))

(declare-fun temp___2682 () t)

(declare-fun temp___2683 () natural)

(declare-fun temp___2684 () us_private)

(declare-fun temp___2685 () Int)

;; H
  (assert (dynamic_invariant1
  (mk___rep this__split_discrs
  (mk___split_fields (mk___t this__split_fields this__split_fields1)
  this__split_fields2 this__split_fields3) this__attr__tag) false false
  true))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___2671)) (to_rep2 (last4 temp___2671)))
     (+ (- (to_rep2 (last4 temp___2671)) (to_rep2 (first4 temp___2671))) 1)
     0) (ite (<= 1 r20b) (+ (- r20b 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___2671)) (to_rep2 (last4 temp___2671)))
  o2))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs temp___268)
     (mk___split_fields (mk___t temp___2681 temp___2682) temp___2683
     temp___2684) temp___2685) (to_base
                               (mk___rep1 (mk___split_discrs o7)
                               (mk___split_fields1 (mk___t1 o8 o9) o10 o11)
                               o12))))

(assert
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 15, characters 0-0
  (not
  (= temp___268 (rec__integer_stacks__stack__capacity this__split_discrs))))
(check-sat)
(exit)
