...
(declare-datatypes ()
((byte_index__ref (mk_byte_index__ref (byte_index__content byte_index)))))
(define-fun byte_index__ref___projection ((a byte_index__ref)) byte_index
...
((payload_byte_index__ref
 (mk_payload_byte_index__ref
 (payload_byte_index__content payload_byte_index)))))
(define-fun payload_byte_index__ref___projection ((a payload_byte_index__ref)) payload_byte_index
...
;; serialize__post_axiom
  ...
  (serialize us_void_param) true false
  true) :pattern ((serialize us_void_param)) )))
...
;; def_axiom
  ...
  (= (select (main__payload_bytes__aggregate_def temp___225) temp___226)
  (of_rep temp___225)))))
...
(define-fun main__C8b__assume2 () us_t (mk___t main__C8b__assume
                                       main__C8b__assume1))
...
;; H
  (assert
  (= payload_bytes1 (main__payload_bytes__aggregate_def ((_ int2bv 8) 0))))

;; H
  (assert
  (and (= main__C8b__assume2 (serialize Tuple0)) (dynamic_invariant
  main__C8b__assume2 true false true)))
...
;; H
  (assert
  (= (slide (elts c8b) (to_rep1 (first (rt c8b))) (to_rep1 (first (rt c8b))))
  temp___227))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))) temp___2271))

;; H
  (assert (<= (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))))

(assert
;; WP_parameter_def
 ;; File "main.adb", line 4, characters 0-0
  (not (<= 1 (to_rep1 (first (rt c8b))))))
(check-sat)
(exit)
