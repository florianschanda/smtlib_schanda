...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78131)) (to_rep (last4 temp___78131))) 
  temp___78141))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78141)) (to_rep (last2 temp___78141)))
     (+ (- (to_rep (last2 temp___78141)) (to_rep (first2 temp___78141))) 1)
