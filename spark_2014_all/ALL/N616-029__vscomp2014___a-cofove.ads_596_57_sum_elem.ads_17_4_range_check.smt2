...
(define-fun dynamic_invariant4 ((temp___expr_189 Int)
  ...
  (temp___do_toplevel_188 Bool)) Bool (=>
                                      ...
                                      (<= 0 5)) (in_range5 temp___expr_189)))

(declare-fun to_rep1 (index1) Int)
...
;; range_axiom
  (assert
  (forall ((x index1)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
((us_split_fields2
 (mk___split_fields1
 (rec__sum_elem__interval__first index1)(rec__sum_elem__interval__last index1)))))
