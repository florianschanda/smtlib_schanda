...
(declare-fun o148 () (_ BitVec 32))

(declare-fun o149 () (_ BitVec 32))

(declare-fun temp___491 () (Array Int storage_element))

(declare-fun temp___492 () (Array Int storage_element))

(declare-fun o150 () storage_element)

(declare-fun o151 () (_ BitVec 8))
...
;; H
  (assert (= o150 (select temp___492 1)))

;; H
  (assert (= o151 (to_rep o150)))

;; H
  (assert (= o152 ((_ zero_extend 24) o151)))

;; H
  (assert (= o153 (bvshl o152 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o146 (select temp___488 2)))

;; H
  (assert (= o147 (to_rep o146)))

;; H
  (assert (= o148 ((_ zero_extend 24) o147)))

;; H
  (assert (= o149 (bvshl o148 ((_ int2bv 32) 16))))
