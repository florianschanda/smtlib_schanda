...
(declare-fun fliteral18 () t)

;; fliteral_axiom
  (assert
  (and (tqtisFinite fliteral18)
  (= (tqtreal fliteral18) (/ 1000000047497451305389404296875.0 1000000000000000000000000000000000.0))))

(declare-fun f () t)

(declare-fun dummy5 () t)

(declare-fun temp___519 () t)

(declare-fun temp___518 () t)

(declare-fun o () t)

(declare-fun temp___523 () t)

(declare-fun temp___522 () t)

(declare-fun o1 () t)

(declare-fun temp___527 () t)

(declare-fun temp___526 () t)
...
;; WP_parameter_def
 ;; File "test_trigo.adb", line 5, characters 0-0
  (not (lt (abs1 (sub RNE1 (tan1 f23) (div1 RNE1 (sin1 f23) (cos1 f23))))
  fliteral18)))
(check-sat)
