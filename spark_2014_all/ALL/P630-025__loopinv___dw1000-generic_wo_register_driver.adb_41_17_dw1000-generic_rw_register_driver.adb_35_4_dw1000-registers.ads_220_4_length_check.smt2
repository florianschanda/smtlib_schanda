...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__dx_time_type__dx_time bits_40)))))
(define-fun us_split_fields_DX_TIME__projection ((a us_split_fields)) bits_40
  (rec__dw1000__register_types__dx_time_type__dx_time a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__dx_time_type__dx_time
...
(declare-const dw1000__register_types__dx_time_type__dx_time__first__bit Int)

(declare-const dw1000__register_types__dx_time_type__dx_time__last__bit Int)

(declare-const dw1000__register_types__dx_time_type__dx_time__position Int)

;; dw1000__register_types__dx_time_type__dx_time__first__bit_axiom
  (assert (<= 0 dw1000__register_types__dx_time_type__dx_time__first__bit))

;; dw1000__register_types__dx_time_type__dx_time__last__bit_axiom
  (assert
  (< dw1000__register_types__dx_time_type__dx_time__first__bit dw1000__register_types__dx_time_type__dx_time__last__bit))

;; dw1000__register_types__dx_time_type__dx_time__position_axiom
  (assert (<= 0 dw1000__register_types__dx_time_type__dx_time__position))
...
(declare-datatypes ()
((dx_time_type__ref (mk_dx_time_type__ref (dx_time_type__content us_rep)))))
(define-fun dx_time_type__ref___projection ((a dx_time_type__ref)) us_rep
  (dx_time_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___18__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___13__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___13__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2291 us_t1)
  (temp___is_init_2288 Bool) (temp___skip_constant_2289 Bool)
  (temp___do_toplevel_2290 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2289 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2291)
                                       (last3 temp___expr_2291))
                                       (and (= (first3 temp___expr_2291) 1)
                                       (= (last3 temp___expr_2291) 5)))))
...
(define-fun target__ref___6__projection ((a target__ref)) us_t2 (target__content
                                                                a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___6__projection ((a source__ref)) us_rep (source__content
                                                                 a))

(define-fun dynamic_invariant1 ((temp___expr_2307 us_t2)
  (temp___is_init_2304 Bool) (temp___skip_constant_2305 Bool)
  (temp___do_toplevel_2306 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2305 true))
                                       (and (dynamic_property3 1 5
                                       (first5 temp___expr_2307)
                                       (last5 temp___expr_2307))
                                       (and (= (first5 temp___expr_2307) 1)
                                       (= (last5 temp___expr_2307) 5)))))
...
(declare-const temp___7729 (Array Int bits_8))

(declare-const temp___77291 t2)

(declare-const temp___7730 (Array Int bits_8))

(declare-const temp___77301 t1)

(define-fun temp___77292 () us_t2 (mk___t2 temp___7729 temp___77291))
...
;; H
  (assert
  (and (= temp___77292 (register_to_bytes reg)) (dynamic_invariant1
  temp___77292 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77291)) (to_rep (last4 temp___77291)))
     (+ (- (to_rep (last4 temp___77291)) (to_rep (first4 temp___77291))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))

;; H
  (assert (= temp___7729 temp___7730))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77291)) (to_rep (last4 temp___77291)))
  temp___77301))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___77301)) (to_rep (last2 temp___77301)))
     (+ (- (to_rep (last2 temp___77301)) (to_rep (first2 temp___77301))) 1)
