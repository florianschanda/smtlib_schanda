...
(declare-datatypes ()
((tT70bP1__ref (mk_tT70bP1__ref (tT70bP1__content tdigit_index_typeB)))))
(define-fun tT70bP1__ref___projection ((a tT70bP1__ref)) tdigit_index_typeB 
  (tT70bP1__content a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___170 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___170)
                                         (first3 temp___170)
                                         (last3 temp___170))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1)
                                          (mk___split_fields1
                                          (let ((temp___169 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array1 (to_array temp___169)
                                          (first1 temp___169)
                                          (last1 temp___169))))))
...
(define-fun dynamic_invariant3 ((temp___expr_578 us_rep1)
  ...
  (temp___do_toplevel_577 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_578)))
                                      (last3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_578))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_578))) 1)
                                      (= (last3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_578))) 
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_581 us_rep1)
  (temp___skip_top_level_582 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_581))) (to_rep
                                                               (rec__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-datatypes ()
((t71b__ref (mk_t71b__ref (t71b__content tdigit_index_typeB)))))
(define-fun t71b__ref___projection ((a t71b__ref)) tdigit_index_typeB 
  (t71b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___938 (_ BitVec 8)))
  (forall ((temp___939 Int) (temp___940 Int))
  (let ((temp___937 (temp___936 temp___938 temp___939 temp___940)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___939 temp___940)
  (and (= (first5 temp___937) temp___939) (= (last5 temp___937) temp___940)))
  (forall ((temp___941 Int))
  (= (select (to_array2 temp___937) temp___941) (of_rep1 temp___938))))))))
...
(declare-fun temp___943 () (Array Int octet))

(declare-fun temp___9431 () t2)

(declare-fun temp___944 () (Array Int octet))

(declare-fun temp___9441 () t1)
...
;; H
  (assert
  (= (mk___t2 temp___943 temp___9431) (temp___936 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__octet_length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9431)) (to_rep2 (last4 temp___9431)))
     (+ (- (to_rep2 (last4 temp___9431)) (to_rep2 (first4 temp___9431))) 1)
     0) (ite (<= 1 (to_rep
                   (rec__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9431)) (to_rep2 (last4 temp___9431))) 
  temp___9441))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 85, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___9441)) (to_rep2 (last2 temp___9441)))
     (+ (- (to_rep2 (last2 temp___9441)) (to_rep2 (first2 temp___9441))) 1)
