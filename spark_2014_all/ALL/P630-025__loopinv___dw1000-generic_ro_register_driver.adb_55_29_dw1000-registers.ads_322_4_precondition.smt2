...
(((mk___split_fields
  (rec__dw1000__register_types__ec_rxtc_type__rx_ts_est bits_32)))))
(define-fun us_split_fields_RX_TS_EST__projection ((a us_split_fields)) bits_32
  (rec__dw1000__register_types__ec_rxtc_type__rx_ts_est a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___32__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__ec_rxtc_type__rx_ts_est
...
(declare-const dw1000__register_types__ec_rxtc_type__rx_ts_est__first__bit Int)

(declare-const dw1000__register_types__ec_rxtc_type__rx_ts_est__last__bit Int)

(declare-const dw1000__register_types__ec_rxtc_type__rx_ts_est__position Int)

;; dw1000__register_types__ec_rxtc_type__rx_ts_est__first__bit_axiom
  (assert (<= 0 dw1000__register_types__ec_rxtc_type__rx_ts_est__first__bit))

;; dw1000__register_types__ec_rxtc_type__rx_ts_est__last__bit_axiom
  (assert
  (< dw1000__register_types__ec_rxtc_type__rx_ts_est__first__bit dw1000__register_types__ec_rxtc_type__rx_ts_est__last__bit))

;; dw1000__register_types__ec_rxtc_type__rx_ts_est__position_axiom
  (assert (<= 0 dw1000__register_types__ec_rxtc_type__rx_ts_est__position))

(declare-fun user_eq5 (us_rep us_rep) Bool)

(declare-const dummy5 us_rep)

(declare-datatypes ((ec_rxtc_type__ref 0))
(((mk_ec_rxtc_type__ref (ec_rxtc_type__content us_rep)))))
(define-fun ec_rxtc_type__ref___projection ((a ec_rxtc_type__ref)) us_rep
  (ec_rxtc_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___72__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___52__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___52__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3744 us_t1)
  (temp___is_init_3741 Bool) (temp___skip_constant_3742 Bool)
  (temp___do_toplevel_3743 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3742 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3744)
                                       (last3 temp___expr_3744))
                                       (and (= (first3 temp___expr_3744) 1)
                                       (= (last3 temp___expr_3744) 4)))))
