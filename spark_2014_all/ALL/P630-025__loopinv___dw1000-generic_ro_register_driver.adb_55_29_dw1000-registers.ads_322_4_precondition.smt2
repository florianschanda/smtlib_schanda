...
(declare-fun dw1000__register_types__ec_rxtc_type__rx_ts_est__first__bit () Int)

(declare-fun dw1000__register_types__ec_rxtc_type__rx_ts_est__last__bit () Int)

(declare-fun dw1000__register_types__ec_rxtc_type__rx_ts_est__position () Int)
...
(declare-datatypes ()
((ec_rxtc_type__ref (mk_ec_rxtc_type__ref (ec_rxtc_type__content us_rep)))))
