...
(define-fun us_split_fields__ref_32__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun register_type__ref_72__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_52__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_52__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3696 us_t1)
  (temp___is_init_3693 Bool) (temp___skip_constant_3694 Bool)
  (temp___do_toplevel_3695 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3694 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3696)
                                       (last3 temp___expr_3696))
                                       (and (= (first3 temp___expr_3696) 1)
                                       (= (last3 temp___expr_3696) 4)))))
