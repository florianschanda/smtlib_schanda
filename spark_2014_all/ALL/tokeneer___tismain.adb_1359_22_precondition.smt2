...
;; H
  (assert
  (= o19 (statusiswaitingfinishadminop (let ((subject state)) state7))))

;; H
  (assert
  (= o20 (statusiswaitingstartadminop (let ((subject state)) state7))))
...
;; H
  (assert
  (=> (= result5 true)
  (= o14 (statusiswaitingstartadminop (let ((subject state)) state7)))))
