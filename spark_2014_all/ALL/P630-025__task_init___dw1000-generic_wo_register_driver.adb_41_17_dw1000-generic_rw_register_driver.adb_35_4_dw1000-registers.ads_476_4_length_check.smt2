...
;; H
  (assert (= temp___8041 temp___8042))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80411)) (to_rep (last4 temp___80411)))
  temp___80421))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80421)) (to_rep (last2 temp___80421)))
     (+ (- (to_rep (last2 temp___80421)) (to_rep (first2 temp___80421))) 1)
