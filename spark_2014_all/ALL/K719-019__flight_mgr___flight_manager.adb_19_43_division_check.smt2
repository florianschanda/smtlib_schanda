...
(declare-fun distance_to_target () t)
...
;; H
  (assert (tqtisFinite distance_to_target))

;; H
  (assert (lt distance_to_target fliteral2))

;; H
  (assert
  (and (= o (mul RNE1 f distance_to_target)) (tqtisFinite
  (mul RNE1 f distance_to_target))))
