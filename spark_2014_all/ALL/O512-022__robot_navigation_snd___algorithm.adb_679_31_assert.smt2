...
(declare-fun temp___955 () us_rep10)
...
(declare-fun disttoclosestobstacle4 () t__ref)

(declare-fun disttoclosestobstacle5 () Float32)

(declare-fun this__split_fields6 () us_split_fields__ref10)

(declare-fun disttoclosestobstacle6 () t__ref)
...
(declare-fun disttoclosestobstacle8 () t__ref)

(declare-fun i5 () int__ref)

(declare-fun this__split_fields9 () us_split_fields20)

(declare-fun disttoclosestobstacle9 () Float32)
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= temp___955 (mk___rep10 (us_split_fields__content10 this__split_fields1)))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= temp___954 disttoclosestobstacle1)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= temp___953 (let ((subject i)) i1))))
...
;; H
  ...
  (= (attr__constrained
     ...
     (us_split_fields9
     (rec__algorithm__controller__robot
     (let ((subject this__split_fields)) this__split_fields3))))) false)
  (= 1000 (to_rep11
          (rec__algorithm__gap_vectors__list__capacity
          (us_split_discrs5
          (rec__algorithm__controller__gapvec
  ...
  (and
  (= (rec__algorithm__controller__laserscan
     (let ((subject this__split_fields)) this__split_fields3)) (rec__algorithm__controller__laserscan
                                                               (us_split_fields21
                                                               temp___955)))
  (= (rec__algorithm__controller__gapvec
     (let ((subject this__split_fields)) this__split_fields3)) (rec__algorithm__controller__gapvec
                                                               (us_split_fields21
                                                               temp___955))))
  (= (rec__algorithm__controller__obsavoiddelta
     (let ((subject this__split_fields)) this__split_fields3)) (rec__algorithm__controller__obsavoiddelta
                                                               (us_split_fields21
                                                               temp___955))))
  (= (rec__algorithm__controller__driveangle
     (let ((subject this__split_fields)) this__split_fields3)) (rec__algorithm__controller__driveangle
                                                               (us_split_fields21
                                                               temp___955)))))
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= this__split_fields5 this__split_fields3)))
...
;; H
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields4))))) (to_rep4
                                                              (rec__algorithm__laser_scan_data__first
                                                              (us_split_fields19
                                                              (select
                                                              (rec__algorithm__controller__laserscan
...
;; H
  ...
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (and
  (= o3 (fp.add RNE (to_rep3
                    (rec__robot_iface__proxy__obstacle_avoid_dist
                    (us_split_fields9
                    (rec__algorithm__controller__robot
                    (us_split_fields__content10 this__split_fields4)))))
  (to_rep3
  (rec__robot_iface__proxy__robot_radius
  (us_split_fields9
  (rec__algorithm__controller__robot
  ...
  (not (or (fp.isInfinite (fp.add RNE (to_rep3
                                      ...
                                      (rec__algorithm__controller__robot
                                      (us_split_fields__content10
                                      this__split_fields4))))) (to_rep3
                                                               (rec__robot_iface__proxy__robot_radius
                                                               (us_split_fields9
                                                               (rec__algorithm__controller__robot
                                                               (us_split_fields__content10
                                                               this__split_fields4))))))) (fp.isNaN (fp.add RNE
  (to_rep3
  (rec__robot_iface__proxy__obstacle_avoid_dist
  (us_split_fields9
  (rec__algorithm__controller__robot
  (us_split_fields__content10 this__split_fields4))))) (to_rep3
                                                       (rec__robot_iface__proxy__robot_radius
                                                       (us_split_fields9
                                                       (rec__algorithm__controller__robot
                                                       (us_split_fields__content10
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= result4 (ite (fp.leq (to_rep4
                          (rec__algorithm__laser_scan_data__first
                          (us_split_fields19
                          (select (rec__algorithm__controller__laserscan
                                  (us_split_fields__content10
                                  this__split_fields4)) (let ((subject
                                                        i)) i2))))) o3)
             true false))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (= o4 (fp.min disttoclosestobstacle2 (to_rep4
                                       (rec__algorithm__laser_scan_data__first
                                       (us_split_fields19
                                       (select (rec__algorithm__controller__laserscan
                                               (us_split_fields__content10
                                               this__split_fields4))
                                       (let ((subject i)) i2)))))))
  (not (or (fp.isInfinite (fp.min disttoclosestobstacle2 (to_rep4
                                                         (rec__algorithm__laser_scan_data__first
                                                         (us_split_fields19
                                                         (select (rec__algorithm__controller__laserscan
                                                                 (us_split_fields__content10
                                                                 this__split_fields4))
                                                         (let ((subject
                                                         i)) i2))))))) (fp.isNaN (fp.min
  disttoclosestobstacle2 (to_rep4
                         (rec__algorithm__laser_scan_data__first
                         (us_split_fields19
                         (select (rec__algorithm__controller__laserscan
                                 (us_split_fields__content10
                                 this__split_fields4)) (let ((subject i)) i2)))))))))))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (=> (= result4 true) (= result5 (mk_t__ref disttoclosestobstacle2)))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (=> (= result4 true) (= disttoclosestobstacle3 o4))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (=> (= result4 true)
  (= disttoclosestobstacle4 (mk_t__ref disttoclosestobstacle3)))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (=> (= result4 true) (= disttoclosestobstacle5 disttoclosestobstacle3))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (=> (not (= result4 true))
  (= disttoclosestobstacle4 (mk_t__ref disttoclosestobstacle2)))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (=> (not (= result4 true))
  (= disttoclosestobstacle5 disttoclosestobstacle2))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= (let ((subject i)) i2) 1000)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= i3 (let ((subject i)) (mk_int__ref i2)))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= disttoclosestobstacle6 disttoclosestobstacle4)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= this__split_fields6 this__split_fields4)))
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= disttoclosestobstacle7 disttoclosestobstacle5)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= this__split_fields7 this__split_fields5)))
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= disttoclosestobstacle8 disttoclosestobstacle6)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= this__split_fields8 this__split_fields6)))
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= disttoclosestobstacle9 disttoclosestobstacle7)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000))
  (= this__split_fields9 this__split_fields7)))

;; H
  (assert
  (=>
  (not (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000)))
  (= i5 (let ((subject i)) (mk_int__ref i1)))))

;; H
  (assert
  (=>
  (not (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000)))
  (= disttoclosestobstacle8 (mk_t__ref disttoclosestobstacle1))))

;; H
  (assert
  (=>
  (not (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000)))
  (= this__split_fields8 this__split_fields1)))
...
;; H
  ...
  (=>
  (not (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000)))
  (= disttoclosestobstacle9 disttoclosestobstacle1)))

;; H
  (assert
  (=>
  (not (and (<= 1 (let ((subject i)) i1)) (<= (let ((subject i)) i1) 1000)))
  (= this__split_fields9 this__split_fields2)))
