...
;; H
  (assert
  (and (= o21 (remove (mk___t values2 (mk 1 100)) o16))
  (and (dynamic_invariant4 o21 true false true)
...
;; H
  (assert
  (and (= o22 (remove (mk___t interm1 (mk 1 100)) o13))
  (and (dynamic_invariant4 o22 true false true)
...
;; H
  (assert
  (and (= o20 (remove_eq o22 o21 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o21 o19)))
     (let ((temp___162 (remove o22 o19)))
