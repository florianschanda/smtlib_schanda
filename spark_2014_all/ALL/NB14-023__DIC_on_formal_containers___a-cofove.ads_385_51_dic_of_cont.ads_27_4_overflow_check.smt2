...
(define-fun dynamic_invariant1 ((temp___expr_1491 Int)
  (temp___is_init_1488 Bool) (temp___skip_constant_1489 Bool)
  (temp___do_toplevel_1490 Bool)) Bool (=>
                                       (or (= temp___is_init_1488 true)
...
(define-fun dynamic_invariant2 ((temp___expr_1497 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_1503 Int)
...
(define-fun element_type__ref___21__projection ((a element_type__ref1)) element_type1
