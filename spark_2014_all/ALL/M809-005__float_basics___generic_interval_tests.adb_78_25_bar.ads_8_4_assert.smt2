...
;; H
  (assert
  (and
  (and (fp.leq (fp.neg (fp #b0 #b10000001 #b01000000000000000000000))
  x) (fp.leq x (fp #b0 #b10000010 #b01000000000000000000000)))
  (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000))
  y) (fp.leq y (fp #b0 #b10000010 #b01000000000000000000000)))))

;; H
  (assert
  (and (= o (fp.mul RNE x y))
  (not (or (fp.isInfinite (fp.mul RNE x y)) (fp.isNaN (fp.mul RNE x y))))))

;; H
  (assert
  (= result (ite (fp.leq o (fp.neg (fp #b0 #b10000011 #b11100000000000000000000)))
            true false)))
...
(assert
;; WP_parameter_def
 ;; File "generic_interval_tests.adb", line 64, characters 0-0
