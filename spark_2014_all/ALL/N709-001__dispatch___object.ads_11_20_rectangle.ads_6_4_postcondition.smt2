...
(declare-fun rec____split_fields20 () integer)

(declare-fun rec____split_fields21 () integer)

(declare-fun rec____split_fields22 () integer)

(declare-fun rec____split_fields23 () us_private)
...
(declare-fun rec____split_fields26 () integer)

(declare-fun rec____split_fields27 () integer)

(declare-fun rec____split_fields28 () integer)

(declare-fun rec____split_fields29 () us_private)

(declare-fun result__3 () Int)

(define-fun rec____split_fields30 () us_split_fields2 (mk___split_fields1
...
;; H
  (assert
  (=> (= result true)
  (= rec____split_fields30 (us_split_fields3
                           (of_base
...
;; H
  (assert
  (=> (not (= result true))
  (= rec____split_fields30 (mk___split_fields1 rec____split_fields6
...
;; H
  ...
  (and (in_range1 o3) (= o3 (to_rep1 rec____split_fields14)))))
...
;; WP_parameter_def
 ;; File "rectangle.ads", line 9, characters 0-0
  (not
  (= result__2 (get_stored_area
               (mk___rep
               (mk___split_fields rec____split_fields20 rec____split_fields21
               rec____split_fields22
               (hide_ext__ rec____split_fields18 rec____split_fields19
               rec____split_fields23)) rec____attr__tag)))))
(check-sat)
(exit)
