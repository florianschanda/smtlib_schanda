...
(define-fun default_initial_assumption ((temp___expr_573 us_rep2)
...
(define-fun k_is_find ((container us_rep2) (key Int)
  (position Int)) Bool (and (ite (< 0 position)
                            ...
                            key) (of_int 1)) (ite (< position (length
                                                              container))
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     (and
     (and
     (and (= (length result) (length1 container))
     (forall ((temp___607 Int))
     (=>
     (and (in_range6 temp___607)
     (= (iter_has_element result temp___607) true))
     (= (has_key (model__ container) (get result temp___607)) true))))
     (forall ((key Int))
     (=> (and (in_range5 key) (= (has_key (model__ container) key) true))
...
(define-fun map__ref_4__projection ((a map__ref3)) us_rep4 (map__content3 a))

(declare-datatypes ()
((key_type__ref1 (mk_key_type__ref1 (key_type__content1 us_rep1)))))
(define-fun key_type__ref_4__projection ((a key_type__ref1)) us_rep1
...
(declare-fun dummy15 () partition_index)
...
(declare-fun dummy16 () capacity_range)
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     ...
     (dynamic_invariant7 result true false true))) :pattern ((length1
                                                             container)) )))
...
(define-fun default_initial_assumption1 ((temp___expr_542 us_rep3)
...
(define-fun default_initial_assumption2 ((temp___expr_593 us_rep4)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (and
     (and (<= 1 (get1 result i1)) (<= (get1 result i1) (length1 container)))
     (forall ((j1 us_rep1))
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq1 left right) true)
     (= (oeq4 (model__ left) (model__ right)) true)) :pattern ((oeq1 left
                                                               right)) )))
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant8 key2 true true true)
     ...
     (=>
     (exists ((k Int))
     (and (and (in_range5 k) (= (has_key container k) true))
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (forall ((k Int))
     (=> (and (in_range5 k) (= (has_key container k) true))
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq4 left right) true)
     (and
     (forall ((key2 Int))
     (=> (and (in_range5 key2) (= (has_key left key2) true))
     (and (= (has_key right key2) true)
     (= (get2 right key2) (get2 left key2)))))
     (forall ((key2 Int))
     (=> (and (in_range5 key2) (= (has_key right key2) true))
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty container) true)
     (forall ((key2 Int))
     (not (and (in_range5 key2) (= (has_key container key2) true))))) :pattern (
  (is_empty container)) )))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq18 a b) (oeq5 a b)) :pattern ((user_eq18 a b)) )))
...
(define-fun default_initial_assumption3 ((temp___expr_770 us_rep7)
  (temp___skip_top_level_771 Bool)) Bool (=>
                                         ...
                                         (= (length4 temp___expr_770) 0)))

;; model____post_axiom
  (assert
  (forall ((container us_rep6))
  (! (= (length4 (model__1 container)) (length3 container)) :pattern (
  (model__1 container)) )))
...
;; length__post_axiom
  ...
  (! (let ((result (length4 container)))
     ...
     true))) :pattern ((length4 container)) )))
...
(declare-fun temp___1187 () us_rep5)
...
;; H
  ...
  (<= (to_rep4
      (select f (get2
                (model__
                (mk___rep d__split_discrs
                (mk___split_fields d__split_fields))) x_elem))) (- (length3
                                                                   (mk___rep3
                                                                   p__split_discrs
                                                                   (mk___split_fields3
                                                                   p__split_fields))) 1)))
...
;; H
  ...
  (and (in_range8 partition_refinement__refine_one__i__assume)
  (= partition_refinement__refine_one__i__assume (get2
                                                 (model__
                                                 (mk___rep d__split_discrs
                                                 (mk___split_fields
...
;; H
  ...
  (forall ((c1 us_rep1))
  (=>
  (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c1) true)
  (=>
  (and
  (not
...
;; H
  ...
  (forall ((c1 us_rep1))
  (=>
  (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c1) true)
  (=>
  (and
  (not
...
;; H
  (assert (= temp___1187 (mk___rep2 o2)))

;; H
  (assert (= result3 (mk___split_fields__ref2 p_elem__split_fields3)))

;; H
  (assert (= p_elem__split_fields4 (us_split_fields5 temp___1187)))
...
;; H
  ...
  (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))))
  (= (bool_eq6
     (get3
     (model__1
     (mk___rep3 p__split_discrs
