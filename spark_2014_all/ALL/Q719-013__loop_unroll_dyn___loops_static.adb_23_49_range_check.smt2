...
;; H
  ...
  (=>
  (and (<= (to_rep1 a__first) temp___393) (<= temp___393 (to_rep1 a__last)))
  (=> (<= i2 temp___393) (= (select a1 temp___393) (select a temp___393)))))
  (and (<= 1 i2) (<= i2 2))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 a__first) temp___388) (<= temp___388 (to_rep1 a__last)))
  (=> (not (= i2 temp___388))
  (= (select a2 temp___388) (select a1 temp___388)))))
  (and (<= 1 j2) (<= j2 2))))
...
;; H
  (assert (<= (to_rep1 a__first) i2))

(assert
;; WP_parameter_def
 ;; File "loops_static.ads", line 2, characters 0-0
  (not (<= (to_rep1 a__first) (to_rep1 a__first))))
(check-sat)
(exit)
