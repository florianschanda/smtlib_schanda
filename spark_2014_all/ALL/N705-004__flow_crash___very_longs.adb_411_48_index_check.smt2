...
;; H
  ...
  true true true)
  (forall ((temp___1277 Int))
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1277)
  (<= temp___1277 (to_rep1 (last number__split_fields3))))
  (=> (<= temp___1277 i2)
  (= (select number__split_fields2 temp___1277) (select number__split_fields temp___1277))))))
  (and (<= 1 i2) (<= i2 r130b))))
