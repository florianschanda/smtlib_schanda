...
;; range_axiom
  (assert
  (forall ((x fart)) (! (in_range13 (to_rep11 x)) :pattern ((to_rep11 x)) )))
...
;; range_axiom
  (assert
  (forall ((x bytet)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)) )))
...
(declare-fun dummy22 () (Array Int bytet))
...
(declare-fun dummy23 () templatelengtht)
...
;; range_axiom
  (assert
  (forall ((x templatelengtht)) (! (in_range15
...
(declare-fun dummy24 () (Array Int character))
...
(define-fun us_split_fields_Length__projection ((a us_split_fields14)) templatelengtht
  (rec__iandatypes__templatet__length a))

(define-fun us_split_fields_RequiredMaxFAR__projection ((a us_split_fields14)) fart
  (rec__iandatypes__templatet__requiredmaxfar a))

(define-fun us_split_fields_ID2__projection ((a us_split_fields14)) (Array Int character)
  (rec__iandatypes__templatet__id a))

(define-fun us_split_fields_Pad__projection ((a us_split_fields14)) (Array Int bytet)
...
(define-fun us_split_fields__ref_9__projection ((a us_split_fields__ref7)) us_split_fields14
  (us_split_fields__content7 a))

(declare-datatypes ()
((us_rep7 (mk___rep7 (us_split_fields15 us_split_fields14)))))
(define-fun us_rep_10__projection ((a us_rep7)) us_split_fields14 (us_split_fields15
                                                                  a))
...
(define-fun bool_eq9 ((a us_rep7)
  (b us_rep7)) Bool (ite (and
                         ...
                         (= (bool_eq
                            ...
                            (us_split_fields15 a)) 1 40
                            (rec__iandatypes__templatet__id
                            (us_split_fields15 b)) 1 40) true))
                         (= (bool_eq8
                            (rec__iandatypes__templatet__pad
                            (us_split_fields15 a)) 1 452
                            (rec__iandatypes__templatet__pad
                            (us_split_fields15 b)) 1 452) true))
                    true false))
...
(declare-datatypes ()
((templatet__ref (mk_templatet__ref (templatet__content us_rep7)))))
(define-fun templatet__ref___projection ((a templatet__ref)) us_rep7
  (templatet__content a))

(declare-datatypes ()
((us_split_fields16
 (mk___split_fields8
 (rec__cert__attr__ianda__contentst__id us_rep1)(rec__cert__attr__ianda__contentst__notbefore us_rep2)(rec__cert__attr__ianda__contentst__notafter us_rep2)(rec__cert__attr__ianda__contentst__mechanism algorithmt)(rec__cert__attr__ianda__contentst__basecertid us_rep1)(rec__cert__attr__ianda__contentst__template us_rep7)))))
(define-fun us_split_fields_ID8__projection ((a us_split_fields16)) us_rep1
  (rec__cert__attr__ianda__contentst__id a))

(define-fun us_split_fields_NotBefore6__projection ((a us_split_fields16)) us_rep2
  (rec__cert__attr__ianda__contentst__notbefore a))

(define-fun us_split_fields_NotAfter6__projection ((a us_split_fields16)) us_rep2
  (rec__cert__attr__ianda__contentst__notafter a))

(define-fun us_split_fields_Mechanism6__projection ((a us_split_fields16)) algorithmt
  (rec__cert__attr__ianda__contentst__mechanism a))

(define-fun us_split_fields_BaseCertID4__projection ((a us_split_fields16)) us_rep1
  (rec__cert__attr__ianda__contentst__basecertid a))

(define-fun us_split_fields_Template__projection ((a us_split_fields16)) us_rep7
...
(define-fun contentst__ref_6__projection ((a contentst__ref3)) us_rep8
...
;; cert_attr_ianda_to_cert__post_axiom
  (assert true)

(declare-fun cert_attr_ianda_to_cert_attr (us_rep8) us_rep6)

(declare-fun cert_attr_ianda_to_cert_attr__function_guard (us_rep6
  us_rep8) Bool)

;; cert_attr_ianda_to_cert_attr__post_axiom
  (assert true)
...
(declare-fun dummy27 () certificatestatus)
...
(declare-fun c64b () (Array Int character))
...
(declare-fun c80b () (Array Int character))
...
;; temp___String_Literal_2057__def_axiom
  (assert
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 1)) 73)
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 2)) 38))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 3)) 65))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 4)) 32))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 5)) 67))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 6)) 101))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 7)) 114))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 8)) 116))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 9)) 105))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 10)) 102))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 11)) 105))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 12)) 99))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 13)) 97))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 14)) 116))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 15)) 101))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 16)) 32))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 17)) 78))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 18)) 111))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 19)) 116))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 20)) 32))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 21)) 67))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 22)) 117))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 23)) 114))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 24)) 114))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 25)) 101))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 26)) 110))
     (= (to_rep (select (temp___String_Literal_2057 us_void_param) 27)) 116)) :pattern (
  (temp___String_Literal_2057 us_void_param)) )))

(declare-fun temp___String_Literal_2062 (tuple0) (Array Int character))

;; temp___String_Literal_2062__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 1)) 73)
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 2)) 38))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 3)) 65))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 4)) 32))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 5)) 67))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 6)) 101))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 7)) 114))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 8)) 116))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 9)) 105))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 10)) 102))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 11)) 105))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 12)) 99))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 13)) 97))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 14)) 116))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 15)) 101))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 16)) 32))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 17)) 78))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 18)) 111))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 19)) 116))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 20)) 32))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 21)) 86))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 22)) 101))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 23)) 114))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 24)) 105))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 25)) 102))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 26)) 105))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 27)) 97))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 28)) 98))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 29)) 108))
     (= (to_rep (select (temp___String_Literal_2062 us_void_param) 30)) 101)) :pattern (
  (temp___String_Literal_2062 us_void_param)) )))

(declare-fun temp___String_Literal_2067 (tuple0) (Array Int character))

;; temp___String_Literal_2067__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 1)) 73)
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 2)) 38))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 3)) 65))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 4)) 32))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 5)) 67))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 6)) 101))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 7)) 114))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 8)) 116))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 9)) 105))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 10)) 102))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 11)) 105))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 12)) 99))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 13)) 97))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 14)) 116))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 15)) 101))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 16)) 32))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 17)) 66))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 18)) 97))
     (= (to_rep (select (temp___String_Literal_2067 us_void_param) 19)) 100)) :pattern (
  (temp___String_Literal_2067 us_void_param)) )))
...
(define-fun dynamic_invariant8 ((temp___expr_846 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_873 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_179 Int)
  (temp___is_init_176 Bool) (temp___skip_constant_177 Bool)
  (temp___do_toplevel_178 Bool)) Bool (=>
                                      (or (= temp___is_init_176 true)
                                      (<= 0 40)) (in_range2 temp___expr_179)))

(define-fun dynamic_invariant11 ((temp___expr_200 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_218 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_230 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_236 Int)
...
(declare-fun iandacertcontents__split_fields () us_split_fields__ref8)
...
(declare-fun iandacertcontents__split_fields1 () us_split_fields16)
...
(declare-fun iandacertcontents__split_fields2 () us_split_fields16)
...
;; H
  ...
  (=> (= certfound true)
  (=> (= extractok2 true)
  (= o1 (cert_attr_ianda_to_cert_attr
        (mk___rep8
        (let ((subject iandacertcontents__split_fields))
        iandacertcontents__split_fields2)))))))
...
;; H
  ...
  (=> (not (= certfound true))
  (= (let ((subject iandacertcontents__split_fields))
     (mk___split_fields__ref8 iandacertcontents__split_fields2)) iandacertcontents__split_fields)))
...
;; H
  (assert
  (=> (not (= certfound true))
  (= iandacertcontents__split_fields2 iandacertcontents__split_fields1)))
...
;; H
  (assert
  (= iandavalid1 (ite (= (ite (= (ite (= (ite (= certfound true) extractok2 false) true)
