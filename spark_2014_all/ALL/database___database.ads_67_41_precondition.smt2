...
(declare-fun dummy5 () ext_account_num)
...
(declare-fun dummy6 () account_num)
...
(declare-fun dummy9 () (Array Int num))
...
(declare-fun o5 () (Array Int num))

(declare-fun o6 () ext_account_num)

(declare-fun o7 () (Array Int us_rep2))

(declare-fun o8 () raw_amount)

(declare-fun o9 () cur)

(declare-fun o10 () cur)

(declare-fun o11 () raw_amount)

(declare-fun o12 () ext_account_num)

(declare-fun o13 () cur)

(declare-fun o14 () raw_amount)

(declare-fun o15 () cur)

(declare-fun o16 () raw_amount)

(declare-fun o17 () ext_account_num)

(declare-fun o18 () cur)

(declare-fun o19 () raw_amount)

(declare-fun o20 () ext_account_num)

(declare-fun o21 () (Array Int us_rep3))

(declare-fun account1 () Int)

(declare-fun links1 () (Array Int us_rep1))

(declare-fun first_available1 () Int)

(declare-fun accounts1 () (Array Int us_rep2))

(declare-fun accounts_balance1 () (Array Int us_rep3))

(declare-fun result () Bool)

(declare-fun result1 () Int)

(declare-fun account2 () Int)

(declare-fun account3 () Int)

(declare-fun links2 () (Array Int us_rep1))

(declare-fun first_available2 () Int)

(declare-fun result2 () map__ref3)

(declare-fun accounts2 () (Array Int us_rep2))

(declare-fun result3 () map__ref4)

(declare-fun accounts_balance2 () (Array Int us_rep3))

(declare-fun account4 () int__ref)

(declare-fun links3 () map__ref2)

(declare-fun first_available3 () int__ref)

(declare-fun accounts3 () map__ref3)

(declare-fun accounts_balance3 () map__ref4)

(declare-fun account5 () Int)

(declare-fun links4 () (Array Int us_rep1))

(declare-fun first_available4 () Int)

(declare-fun accounts4 () (Array Int us_rep2))

(declare-fun accounts_balance4 () (Array Int us_rep3))

(declare-fun account6 () int__ref)

(declare-fun links5 () map__ref2)

(declare-fun first_available5 () int__ref)

(declare-fun accounts5 () map__ref3)

(declare-fun accounts_balance5 () map__ref4)

(declare-fun account7 () Int)

(declare-fun links6 () (Array Int us_rep1))

(declare-fun first_available6 () Int)

(declare-fun accounts6 () (Array Int us_rep2))

(declare-fun accounts_balance6 () (Array Int us_rep3))
...
;; H
  ...
  (and (= accounts3 accounts7)
  (and (= first_available3 (mk_int__ref first_available))
  (and (= links3 (mk_map__ref2 links)) (= account4 (mk_int__ref account2))))))
  (and (= accounts_balance4 accounts_balance1)
  (and (= accounts4 accounts1)
  ...
  (and
  (and
  (and (= accounts_balance3 (mk_map__ref4 accounts_balance2))
  (and (= accounts3 (mk_map__ref3 accounts2))
  (and (= first_available3 (mk_int__ref first_available2))
  (and (= links3 (mk_map__ref2 links2)) (= account4 (mk_int__ref account3))))))
  (and (= accounts_balance4 accounts_balance2)
  (and (= accounts4 accounts2)
  (and (= first_available4 first_available2)
  (and (= links4 links2) (= account5 account3))))))
  (and
  (and
  (and (not (= (is_available account3 links2) true))
  (forall ((act Int))
  (=> (and (<= 1 act) (<= act 200000))
  (=> (not (= act account3))
  (=
  (= (rec__database__availability__account_link__available
     (us_split_fields3 (select links2 act))) true)
  (= (rec__database__availability__account_link__available
     (us_split_fields3 (select links act))) true))))))
  (and (in_range5 account3) (in_range4 first_available2)))
  (and
  (and
  (and
  (and
  (and (= (to_rep4 o) account3)
  (and (= customer o1) (and (= id o2) (= o o3))))
  (and (= o4 o1) (and (= o5 o2) (= o6 o3))))
  (= o7 (store accounts account3 (mk___rep2 (mk___split_fields2 o4 o5 o6)))))
  (and (= result2 accounts7) (= accounts2 o7)))
  (and
  (and
  (and
  (and (= (to_rep4 o12) account3)
  (and
  (and
  (and (= (to_rep3 o8) 0)
  (and (= (to_rep2 o9) cur1) (and (= o9 o10) (= o8 o11))))
  (and (= o13 o10) (= o14 o11)))
  (and (and (= o15 o13) (= o16 o14)) (= o12 o17))))
  (and (and (= o18 o15) (= o19 o16)) (= o20 o17)))
  (= o21 (store accounts_balance account3 (mk___rep3
                                          (mk___split_fields3
                                          (mk___rep
                                          (mk___split_fields o18 o19))
                                          o20)))))
  (and (= result3 accounts_balance7) (= accounts_balance2 o21)))))))))
...
;; H
  (assert
  (and (= result4 (existing (int__content account6) (map__content2 links5)))
  (= (= result4 true)
  (not
  (= (is_available (int__content account6) (map__content2 links5)) true)))))
...
;; H
  (assert
  (and
  (= result5 (belongs_to (int__content account6) customer id
             (map__content3 accounts5)))
  (= (= result5 true)
  (= (bool_eq5 (select (map__content3 accounts5) (int__content account6))
     (mk___rep2
     (mk___split_fields2 customer id (of_rep4 (int__content account6))))) true))))
...
;; WP_parameter_def
 ;; File "money.ads", line 17, characters 0-0
  (not (= (existing (int__content account6) (map__content2 links5)) true)))
(check-sat)
(exit)
