...
;; H
  (assert
  (and (= o10 (get_previous_track o19 id))
  (and (in_range7 o10)
  (= o10 (to_rep5
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___338 (get_previous_track o18 id))
  (and (in_range7 temp___338)
  (= temp___338 (to_rep5
                (select (select previous_tracks (to_rep3
                                                (rec__trains__track__from
                                                (us_split_fields3
                                                (select tracks (to_rep1 o15))))))
                id)))))))
...
;; H
  (assert (=> (= result1 true) (= o16 temp___338)))

;; H
  (assert (=> (= result1 true) (= o17 (select track_signals o16))))

;; H
  (assert (=> (= result1 true) (= temp___339 (to_rep2 o17))))
...
;; H
  (assert
  (and (= o4 (get_other_previous_track o20 id))
  (and (in_range7 o4)
  (= o4 (ite (= (to_rep5
                (select (select previous_tracks (to_rep3
                                                (rec__trains__track__from
