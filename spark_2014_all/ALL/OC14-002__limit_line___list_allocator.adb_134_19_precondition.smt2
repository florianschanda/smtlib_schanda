...
;; H
  (assert (and (= o43 (length ma1)) (in_range6 o43)))

;; H
  (assert (= o44 (- o43 2)))

;; H
  (assert (= o45 (ite (<= j o44) true false)))

;; H
  (assert (= result10 (ite (<= 1 j) o45 false)))

;; H
  (assert (= result10 true))

;; H
  (assert (and (= o47 (+ j 2)) (in_range1 (+ j 2))))

;; H
  (assert (and (= o48 (get ma1 o47)) (in_range7 o48)))
