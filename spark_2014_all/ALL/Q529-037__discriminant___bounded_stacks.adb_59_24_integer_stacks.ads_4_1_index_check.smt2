...
(define-fun dynamic_invariant ((temp___expr_153 us_rep)
...
;; extent__post_axiom
  (assert
  (forall ((this1 us_rep))
  (! (=> (dynamic_invariant this1 true true true) (dynamic_invariant1
     (extent this1) true false true)) :pattern ((extent this1)) )))
...
;; extent__post__dispatch_axiom
  ...
  (forall ((this1 us_rep))
  (! (=> (dynamic_invariant this1 true true true) (dynamic_invariant1
     (extent1 attr__tag4 this1) true false true)) :pattern ((extent1
                                                            attr__tag4 this1)) ))))
...
;; integer_stacks__reset__T19b__compat_axiom
  (assert
  (forall ((this1 us_rep))
  (! (= (extent this1) (extent1 us_tag1 this1)) :pattern ((extent1 us_tag1
                                                          this1)) )))

;; integer_stacks__Oeq__S25b__compat_axiom
  (assert
  (forall ((this1 us_rep))
  (! (= (extent this1) (extent1 us_tag3 this1)) :pattern ((extent1 us_tag3
                                                          this1)) )))

;; integer_stacks__Oeq__S27b__compat_axiom
  (assert
  (forall ((this1 us_rep))
  (! (= (extent this1) (extent1 us_tag2 this1)) :pattern ((extent1 us_tag2
                                                          this1)) )))

;; extent__def_axiom
  (assert
  (forall ((this1 us_rep))
  (! (=> (dynamic_invariant this1 true true true)
     (= (extent this1) (to_rep
                       (rec__integer_stacks__stack__top
...
;; integer_stacks__stack__compat_axiom
  (assert
  (forall ((this1 us_rep))
  (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag this1))) :pattern (
  (empty1 us_tag this1)) )))

;; integer_stacks__reset__T19b__compat_axiom
  (assert
  (forall ((this1 us_rep))
  (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag1 this1))) :pattern (
  (empty1 us_tag1 this1)) )))

;; integer_stacks__Oeq__S25b__compat_axiom
  (assert
  (forall ((this1 us_rep))
  (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag3 this1))) :pattern (
  (empty1 us_tag3 this1)) )))

;; integer_stacks__Oeq__S27b__compat_axiom
  (assert
  (forall ((this1 us_rep))
  (! (= (to_int1 (empty this1)) (to_int1 (empty1 us_tag2 this1))) :pattern (
...
(declare-datatypes ((t12s__ref 0)) (((mk_t12s__ref (t12s__content us_t4)))))
...
;; mk_def
  ...
  (! (=> (in_range3 f)
     (=> (in_range3 l)
     (and (= (to_rep3 (first10 (mk5 f l))) f)
     (= (to_rep3 (last10 (mk5 f l))) l)))) :pattern ((mk5 f l)) )))
...
(define-fun first11 ((a us_t5)) Int (to_rep3 (first10 (rt5 a))))

(define-fun last11 ((a us_t5)) Int (to_rep3 (last10 (rt5 a))))
...
(define-fun bool_eq10 ((x us_t5)
  (y us_t5)) Bool (bool_eq (elts5 x) (to_rep3 (first10 (rt5 x)))
                  (to_rep3 (last10 (rt5 x))) (elts5 y)
                  (to_rep3 (first10 (rt5 y))) (to_rep3 (last10 (rt5 y)))))
...
;; def_axiom
  ...
  (and (= (first9 temp___219) temp___221) (= (last9 temp___219) temp___222)))
  (forall ((temp___223 Int))
  (= (select (to_array4 temp___219) temp___223) (of_rep2 temp___220)))))))
...
(assert
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 2, characters 0-0
  (not
  (<= (to_rep3
      (first
      (rt (rec__integer_stacks__stack__values (us_split_fields1 this)))))
