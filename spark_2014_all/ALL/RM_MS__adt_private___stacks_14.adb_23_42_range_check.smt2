...
((us_split_fields
 (mk___split_fields
 (rec__stacks_14__stack__stack_vector (Array Int integer))(rec__stacks_14__stack__stack_pointer pointer_range)))))
...
(declare-fun s__split_fields1 () pointer_range)
...
;; H
  (assert
  (and (<= 1 (to_rep1 s__split_fields1)) (<= (to_rep1 s__split_fields1) 100)))
...
(assert
;; WP_parameter_def
 ;; File "stacks_14.adb", line 14, characters 0-0
  (not (in_range2 (- (to_rep1 s__split_fields1) 1))))
(check-sat)
(exit)
