...
;; H
  (assert
  (=> (= result1 true) (and (= o22 (theauthcertrole state)) (in_range4 o22))))

;; H
  (assert (=> (= result1 true) (= o23 (ite (= o22 1) true false))))

;; H
  (assert (=> (= result1 true) (= o20 (authcertvalid state))))

;; H
  (assert (=> (= result1 true) (= o21 (isgood state))))
...
;; H
  (assert (and (= o14 (thedooralarm state2)) (in_range15 o14)))
...
;; H
  (assert (= o34 (alarm_timeout state2)))

;; H
  (assert (= o35 (thecurrenttime currenttime)))

;; H
  (assert (= o11 (greaterthanorequal o35 o34)))
