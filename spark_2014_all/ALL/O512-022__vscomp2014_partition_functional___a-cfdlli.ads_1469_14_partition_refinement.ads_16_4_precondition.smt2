...
(define-fun dynamic_invariant2 ((temp___expr_376 Int)
...
(define-fun default_initial_assumption3 ((temp___expr_364 us_rep2)
...
(define-fun dynamic_invariant4 ((temp___expr_351 Int)
...
(declare-const temp___995 count_type)
...
;; H
  (assert (= temp___995 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___995)) no_element))
