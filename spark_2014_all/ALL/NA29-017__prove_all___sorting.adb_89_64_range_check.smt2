...
;; H
  ...
  (= (bool_eq a (to_rep a__first) (to_rep a__last) a (to_rep a__first)
     (to_rep a__last)) true)))
...
;; H
  (assert (and (= o6 (- length2 j2)) (in_range1 (- length2 j2))))

;; H
  (assert (and (= o7 o6) (in_range2 o6)))

;; H
  (assert (and (= o5 (+ i2 j2)) (in_range1 (+ i2 j2))))

;; H
  (assert (and (= o2 (+ a_first length1)) (in_range1 (+ a_first length1))))
...
;; H
  (assert
  (= o8 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last)))
        (mk___t a (mk (to_rep a__first) (to_rep a__last))) o1 o4 o5 o7)))

;; H
  (assert (and (= o (- length1 i2)) (in_range1 (- length1 i2))))
