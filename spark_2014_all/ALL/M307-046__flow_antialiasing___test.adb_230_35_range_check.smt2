...
(declare-datatypes () ((t51b__ref (mk_t51b__ref (t51b__content us_t1)))))
(define-fun t51b__ref___projection ((a t51b__ref)) us_t1 (t51b__content a))
...
(declare-datatypes () ((t53b__ref (mk_t53b__ref (t53b__content us_t2)))))
(define-fun t53b__ref___projection ((a t53b__ref)) us_t2 (t53b__content a))
...
(declare-fun test__op_string_io_i__x__compl () (Array Int character))

(declare-fun test__op_string_io_i__x__compl1 () t1)
...
;; H
  (assert
  (=> (<= 1 n)
  (and (and (<= (to_rep1 a__first) 1) (<= 1 (to_rep1 a__last)))
  (and (<= (to_rep1 a__first) n) (<= n (to_rep1 a__last))))))

;; H
  (assert (= o a))

;; H
  (assert (= test__op_string_io_i__x__compl o))

;; H
  (assert (= test__op_string_io_i__x__compl1 (mk1 1 n)))

;; H
  (assert (and (= temp___434 (+ n 1)) (in_range (+ n 1))))

;; H
  (assert (<= temp___434 (to_rep1 a__last)))

(assert
;; WP_parameter_def
 ;; File "test.adb", line 219, characters 0-0
  (not (<= (to_rep1 a__first) temp___434)))
(check-sat)
(exit)
