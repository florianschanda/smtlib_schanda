...
(declare-fun conv__id__result () enum)

(declare-fun conv__id__result1 () integer)

(declare-fun conv__id__result2 () integer)

(declare-fun conv__id__result3 () Bool)

(declare-fun conv__id__result4 () natural)

(declare-fun us () Int)

(declare-fun result () enum)
...
(declare-fun conv__id__result5 () enum)

(declare-fun conv__id__result6 () integer)

(declare-fun conv__id__result7 () integer)

(declare-fun conv__id__result8 () Bool)

(declare-fun conv__id__result9 () natural)

(declare-fun conv__id__result10 () enum)

(declare-fun conv__id__result11 () integer)

(declare-fun conv__id__result12 () integer)

(declare-fun conv__id__result13 () Bool)

(declare-fun conv__id__result14 () natural)

(declare-fun conv__id__result15 () enum)

(declare-fun conv__id__result16 () integer)

(declare-fun conv__id__result17 () integer)

(declare-fun conv__id__result18 () Bool)

(declare-fun conv__id__result19 () natural)

(declare-fun conv__id__result20 () enum)

(declare-fun conv__id__result21 () integer)

(declare-fun conv__id__result22 () integer)

(declare-fun conv__id__result23 () Bool)

(declare-fun conv__id__result24 () natural)

(declare-fun conv__id__result25 () us_rep)

(define-fun conv__id__result26 () us_rep (mk___rep
                                         (mk___split_discrs
                                         conv__id__result15)
                                         (mk___split_fields
                                         conv__id__result16
...
(define-fun conv__id__result27 () us_rep (mk___rep
                                         (mk___split_discrs
                                         conv__id__result5)
                                         (mk___split_fields conv__id__result6
                                         conv__id__result7 conv__id__result8
                                         conv__id__result9)))

(declare-fun result5 () enum)
...
;; H
  (assert
  (and (= us (to_rep (rec__basic__r__x (us_split_discrs1 x)))) (in_range
  (to_rep (rec__basic__r__x (us_split_discrs1 x))))))
...
;; H
  (assert
  (= (mk_r__ref
     (mk___rep (mk___split_discrs conv__id__result20)
     (mk___split_fields conv__id__result21 conv__id__result22
     conv__id__result23 conv__id__result24))) (mk_r__ref
                                              (mk___rep
                                              (mk___split_discrs
                                              conv__id__result10)
                                              (mk___split_fields
...
;; WP_parameter_def
 ;; File "basic.ads", line 4, characters 0-0
  ...
  (= (bool_eq
     (mk___rep (mk___split_discrs conv__id__result20)
     (mk___split_fields conv__id__result21 conv__id__result22
     conv__id__result23 conv__id__result24)) x) true)))
(check-sat)
(exit)
