...
(declare-fun pack__next255__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun pack__next255__result1 () (_ BitVec 8))

(declare-fun pack__next255__result2 () (_ BitVec 8))

(declare-fun pack__next255__result3 () (_ BitVec 8))

(declare-fun pack__next255__result4 () (_ BitVec 8))

(declare-fun pack__next255__result5 () (_ BitVec 8))
...
;; H
  (assert (= pack__next255__result1 (bvadd m ((_ int2bv 8) 1))))

;; H
  (assert
  (= (mk_t__ref pack__next255__result4) (mk_t__ref pack__next255__result2)))
...
;; WP_parameter_def
 ;; File "pack.ads", line 3, characters 0-0
  (not (= pack__next255__result4 ((_ int2bv 8) 0))))
(check-sat)
(exit)
