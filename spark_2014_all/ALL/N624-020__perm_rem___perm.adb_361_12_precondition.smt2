...
;; H
  (assert
  (=> (< ib ib2)
  (and (= o12 (shift_perm_l o29 o28 o27))
  (and (in_range2 o12) (=> (= (of_int o12) true) (= (is_perm o27 o28) true))))))
...
;; H
  (assert (=> (not (< ib ib2)) (= (of_int h6) true)))

;; H
  (assert
  (=> (not (< ib ib2))
  (and (= o24 (remove bb ib2))
...
;; H
  (assert
  (=> (not (< ib ib2))
  (and (= o23 (shift_perm_l o26 o25 o24))
  (and (in_range2 o23) (=> (= (of_int o23) true) (= (is_perm o24 o25) true))))))
...
;; H
  (assert (=> (not (< ib ib2)) (= (of_int h7) true)))
