...
;; H
  ...
  (= tmp1 (to_rep
          (rec__arrays_of_records__basic_record__first_value
          (us_split_fields1 (select a i))))))

;; H
  (assert
  (= (to_rep o) (to_rep
                (rec__arrays_of_records__basic_record__second_value
                (us_split_fields1 (select b j))))))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a i))) o3))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select b j))) o9))

;; H
  (assert
  (= (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select b j))) o10))
...
(assert
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 250, characters 0-0
  (not (not (= (bool_eq1 a2 0 1001 a 0 1001) true))))
(check-sat)
(exit)
