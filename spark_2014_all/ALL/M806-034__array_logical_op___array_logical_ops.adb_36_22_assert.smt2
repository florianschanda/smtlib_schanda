...
(declare-datatypes ((t19b__ref 0)) (((mk_t19b__ref (t19b__content t19b)))))
...
(declare-datatypes ((t21b__ref 0)) (((mk_t21b__ref (t21b__content t21b)))))
...
;; H
  (assert
  (= (mk___t
     (xorb (elts v) (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))
     (elts x) (to_rep1 (first (rt x))) (to_rep1 (last (rt x))))
     (mk (to_rep1 (first (rt v))) (to_rep1 (last (rt v))))) r3))
