...
;; H
  (assert
  (and (= o1 (add1 fliteral2 fliteral3))
  (and (tqtisFinite o1) (eq o1 (add RNE1 fliteral2 fliteral3)))))

;; H
  (assert
  (and (= o2 (add1 fliteral4 o1))
  (and (tqtisFinite o2) (eq o2 (add RNE1 fliteral4 o1)))))

;; H
  (assert
  (and (= o (add1 fliteral4 fliteral2))
  (and (tqtisFinite o) (eq o (add RNE1 fliteral4 fliteral2)))))
