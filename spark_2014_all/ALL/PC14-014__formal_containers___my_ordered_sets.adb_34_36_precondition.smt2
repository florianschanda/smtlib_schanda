...
;; H
  (assert
  (and (= o3 (ceiling (mk___rep l__split_discrs l__split_fields8) 1))
  (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (<
          (last_element (mk___rep l__split_discrs l__split_fields8)) 1) true) true)
  ...
  (< (get1 (elements (mk___rep l__split_discrs l__split_fields8))
     (get (positions (mk___rep l__split_discrs l__split_fields8)) o3)) 1)))
