...
(declare-fun a__first () tindex_aB)

(declare-fun a__last () tindex_aB)
...
(declare-fun dummy7 () tindex_aB)

(declare-datatypes ()
((tTC23bSP1__ref (mk_tTC23bSP1__ref (tTC23bSP1__content tindex_aB)))))
(define-fun tTC23bSP1__ref___projection ((a tTC23bSP1__ref)) tindex_aB
  (tTC23bSP1__content a))
...
(declare-datatypes ()
((tC23bS__ref (mk_tC23bS__ref (tC23bS__content us_t2)))))
(define-fun tC23bS__ref___projection ((a tC23bS__ref)) us_t2 (tC23bS__content
                                                             a))

(define-fun dynamic_invariant ((temp___expr_234 us_t2)
  ...
  (temp___do_toplevel_233 Bool)) Bool (=>
                                      ...
                                      (first5 temp___expr_234)
                                      (last5 temp___expr_234))
                                      (and
                                      (= (first5 temp___expr_234) (to_rep
                                                                  a__first))
                                      (= (last5 temp___expr_234) (to_rep
                                                                 a__last))))))

(declare-fun c23b__first () tindex_aB)

(declare-fun c23b__last () tindex_aB)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun b__first () tindex_aB)

(declare-fun b__last () tindex_aB)
...
;; def_axiom
  ...
  (let ((temp___249 (essai05__a__aggregate_def temp___250 temp___251
                    temp___252)))
  (and
  (and (= (select temp___249 (- 3)) (of_rep1 temp___250))
  (= (select temp___249 (- 2)) (of_rep1 temp___251)))
  (= (select temp___249 (- 1)) (of_rep1 temp___252))))))
