...
(((mk_tT71bP1__ref (tT71bP1__content tdigit_count_typeB)))))
...
(declare-datatypes ((t71b__ref 0)) (((mk_t71b__ref (t71b__content us_t1)))))
...
(((mk_t72b__ref (t72b__content tdigit_count_typeB)))))
...
(declare-datatypes ((t73b__ref 0)) (((mk_t73b__ref (t73b__content us_t2)))))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___912)
  (<= temp___912 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___912) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           result____split_fields2)) temp___912))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
