...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__discr_init__r1__j integer)))))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__discr_init__r1__arr us_t1)))))
...
(declare-fun discr_init__r1__j__first__bit () Int)

(declare-fun discr_init__r1__j__last__bit () Int)

(declare-fun discr_init__r1__j__position () Int)
...
(declare-fun discr_init__r1__arr__first__bit () Int)

(declare-fun discr_init__r1__arr__last__bit () Int)

(declare-fun discr_init__r1__arr__position () Int)
...
(declare-fun dummy8 () (Array Int Bool))
...
(declare-fun discr_init__r1__j__first__bit1 () Int)

(declare-fun discr_init__r1__j__last__bit1 () Int)

(declare-fun discr_init__r1__j__position1 () Int)
...
(declare-fun discr_init__r1__arr__first__bit1 () Int)

(declare-fun discr_init__r1__arr__last__bit1 () Int)

(declare-fun discr_init__r1__arr__position1 () Int)
...
(declare-fun temp___j_197 () Int)

(declare-fun us () Int)

(declare-fun temp___198 () integer)

(declare-fun temp___1981 () (Array Int Bool))

(declare-fun temp___201 () (Array Int Bool))
...
;; H
  (assert (= 10 (to_rep temp___198)))

;; H
  (assert (discr_init__r1__arr__pred1
  (mk___rep1 (mk___split_discrs temp___198) (mk___split_fields1 temp___1981))))

;; H
  (assert (= (to_rep (first (rt (temp___190 (of_int 1) 1 10)))) 1))

;; H
  (assert (= (to_rep (last (rt (temp___190 (of_int 1) 1 10)))) 10))

;; H
  (assert (= (mk___t temp___201 temp___2011) (temp___190 (of_int 1) 1 10)))

(assert
;; WP_parameter_def
 ;; File "discr_init.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep (first temp___2011)) (to_rep (last temp___2011)))
     (+ (- (to_rep (last temp___2011)) (to_rep (first temp___2011))) 1) 0)
  (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
