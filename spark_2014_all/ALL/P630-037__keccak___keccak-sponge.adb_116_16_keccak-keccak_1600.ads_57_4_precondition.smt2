...
(((mk_t76s__ref (t76s__content integer)))))
...
(declare-datatypes ((t77s__ref 0)) (((mk_t77s__ref (t77s__content us_t1)))))
...
(declare-datatypes ((t79s__ref 0))
(((mk_t79s__ref (t79s__content integer)))))
...
(declare-datatypes ((t80s__ref 0)) (((mk_t80s__ref (t80s__content us_t2)))))
...
(declare-datatypes ((t83s__ref 0))
(((mk_t83s__ref (t83s__content integer)))))
...
(declare-datatypes ((t84s__ref 0)) (((mk_t84s__ref (t84s__content us_t3)))))
...
(((mk_t86s__ref (t86s__content integer)))))
...
(declare-datatypes ((t87s__ref 0)) (((mk_t87s__ref (t87s__content us_t4)))))
...
(((mk_t89s__ref (t89s__content integer)))))
...
(declare-datatypes ((t90s__ref 0)) (((mk_t90s__ref (t90s__content us_t5)))))
...
(((mk_t93s__ref (t93s__content integer)))))
...
(declare-datatypes ((t94s__ref 0)) (((mk_t94s__ref (t94s__content us_t6)))))
...
(declare-datatypes ((t96s__ref 0))
(((mk_t96s__ref (t96s__content integer)))))
...
(declare-datatypes ((t97s__ref 0)) (((mk_t97s__ref (t97s__content us_t7)))))
...
(declare-datatypes ((t100s__ref 0))
(((mk_t100s__ref (t100s__content integer)))))
...
(((mk_t101s__ref (t101s__content us_t8)))))
...
(declare-const temp___817 (Array Int byte))

(declare-const temp___8171 t4)
...
;; H
  (assert (=> (< 0 free_bits_in_block1) (= o10 temp___817)))
...
;; H
  ...
  (= (select o11 temp___823) (select (elts3 temp___822) temp___823))
  (= (select o11 temp___823) (select ctx__split_fields1 temp___823))))))
...
;; H
  (assert (=> (< 0 free_bits_in_block1) (= temp___825 (mk___rep o12))))
...
;; H
  (assert
  (= o18 (rec__keccak__keccak_1600__sponge__context__block
         ctx__split_fields7)))

;; H
  (assert (= temp___828 (mk___t5 o18 (mk5 0 r88s))))

;; H
  (assert
  (= o19 (mk___t (elts5 temp___828)
...
;; H
  (assert (= o21 (+ (to_rep1 (first (rt data))) o20)))

;; H
  (assert
  (and (= keccak__keccak_1600__sponge__absorb__L_1__R92s__assume o21)
  (in_range1 o21)))
...
;; H
  (assert (= o22 (elts data)))

;; H
  (assert (= temp___833 (mk___t6 o22 (mk6 r91s r92s))))

;; H
  (assert
  (= o23 (mk___t (elts6 temp___833)
