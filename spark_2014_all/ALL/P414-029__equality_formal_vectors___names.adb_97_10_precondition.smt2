...
(define-fun dynamic_invariant8 ((temp___expr_437 Int)
...
(define-fun dynamic_invariant17 ((temp___expr_443 Int)
...
(define-fun default_initial_assumption3 ((temp___expr_480 us_rep4)
  (temp___skip_top_level_481 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_481 true))
                                         (= (length3 temp___expr_480) 0)))
...
(define-fun dynamic_invariant18 ((temp___expr_422 Int)
...
(define-fun dynamic_invariant19 ((temp___expr_473 Int)
...
(define-fun o33 () us_rep3 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
;; H
  ...
  (=> (in_range9 n3)
  (and
  (= temp___6042 (to_string1 ptr3
                 (mk___split_fields entry_table__split_fields)
                 (mk___split_fields1 char_table__split_fields)))
  (dynamic_invariant temp___6042 true false true))))

;; H
  (assert
  (=> (in_range9 n3)
  (= result3 (bool_eq temp___604 (to_rep1 (first temp___6041))
             (to_rep1 (last temp___6041)) (elts s) (to_rep1 (first (rt s)))
             (to_rep1 (last (rt s)))))))
...
;; H
  ...
  (and (= char_table__split_discrs (mk___split_discrs1 temp___608))
  (= char_table__split_fields temp___6081))))
...
;; H
  (assert (= (to_rep3 o18) 0))

;; H
  (assert (and (= o17 (length s)) (in_range2 (length s))))

;; H
  (assert (= (to_rep2 o19) o17))
...
;; H
  (assert (and (= o16 o15) (in_range12 o15)))

;; H
  (assert (= (to_rep6 o20) o16))
...
;; H
  ...
  (= (length4
     (mk___rep entry_table__split_discrs
     names__entry_tables__append__2__container__fields)) (+ (length4
                                                            (mk___rep
                                                            entry_table__split_discrs
                                                            (mk___split_fields
  ...
  (= (olt1
     ...
     (model__1
     (mk___rep entry_table__split_discrs
     names__entry_tables__append__2__container__fields))) true))
  (= (bool_eq4
     (get1
     (model__1
     (mk___rep entry_table__split_discrs
     ...
     (+ (last3
        (model__1
        (mk___rep entry_table__split_discrs
        (mk___split_fields entry_table__split_fields)))) 1))
     (mk___rep2 (mk___split_fields2 o24 o25 o26))) true)))

;; H
  (assert
  (= result7 (mk___split_fields__ref
             (mk___split_fields entry_table__split_fields))))
...
;; H
  ...
  (= o27 (last3
         (model__1
         (mk___rep entry_table__split_discrs entry_table__split_fields1))))
  (and (in_range15 o27)
  (= o27 (last3
         (model__1
         (mk___rep entry_table__split_discrs entry_table__split_fields1)))))))
...
;; H
  (assert
  (and (= o29 (int__content ptr10)) (in_range14 (int__content ptr10))))
...
;; H
  ...
  (= temp___612 (get1
                (model__1
                (mk___rep entry_table__split_discrs
                entry_table__split_fields1)) o29))
  (= (bool_eq4 temp___612
     (get1
     (model__1
     (mk___rep entry_table__split_discrs entry_table__split_fields1))
...
;; H
  (assert (= (to_rep3 o30) n12))

;; H
  (assert
  (= o31 (mk___split_fields2
         (rec__names__name_entry__table_index (us_split_fields5 temp___612))
         (rec__names__name_entry__length (us_split_fields5 temp___612))
         o30)))

;; H
  (assert (= o32 (mk___rep2 o31)))

;; H
  (assert
  (and (= o28 (int__content ptr10)) (in_range14 (int__content ptr10))))
