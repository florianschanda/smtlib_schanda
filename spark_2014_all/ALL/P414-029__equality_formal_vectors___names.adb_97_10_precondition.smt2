...
(declare-fun temp___430 () Int)

(declare-fun temp___429 () Int)
...
(declare-fun temp___432 () capacity_range1)

(declare-fun temp___4321 () us_main_type1)
...
(declare-fun o18 () name_id)

(declare-fun o19 () positive)

(declare-fun o20 () char_table_index)

(declare-fun o21 () char_table_index)

(declare-fun o22 () positive)

(declare-fun o23 () name_id)

(declare-fun o24 () char_table_index)

(declare-fun o25 () positive)

(declare-fun o26 () name_id)
...
(declare-fun temp___436 () us_rep3)

(declare-fun o30 () name_id)

(declare-fun o31 () us_split_fields4)

(declare-fun o32 () us_rep3)
...
(declare-fun names__entry_tables__append__2__container__fields () us_split_fields)

(declare-fun result7 () us_split_fields__ref)

(declare-fun entry_table__split_fields1 () us_split_fields)
...
;; H
  (assert (=> (in_range9 n3) (= temp___430 n3)))

;; H
  (assert (=> (in_range9 n3) (= temp___429 ptr2)))
...
;; H
  ...
  (and (= char_table__split_discrs (mk___split_discrs1 temp___432))
  (= char_table__split_fields temp___4321))))
...
;; H
  ...
  (= o31 (mk___split_fields2
         (rec__names__name_entry__table_index (us_split_fields5 temp___436))
         (rec__names__name_entry__length (us_split_fields5 temp___436))
         o30)))
