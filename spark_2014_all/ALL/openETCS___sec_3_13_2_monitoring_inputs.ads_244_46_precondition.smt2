...
(define-fun dynamic_invariant1 ((temp___expr_169 t) (temp___is_init_166 Bool)
...
(define-fun dynamic_invariant3 ((temp___expr_181 t) (temp___is_init_178 Bool)
  (temp___skip_constant_179 Bool)
  (temp___do_toplevel_180 Bool)) Bool (=>
                                      (or (= temp___is_init_178 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_181)))
...
(define-fun dynamic_invariant4 ((temp___expr_157 t) (temp___is_init_154 Bool)
  (temp___skip_constant_155 Bool)
  (temp___do_toplevel_156 Bool)) Bool (=>
                                      (or (= temp___is_init_154 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_157)))
...
;; m_per_s_from_km_per_h__def_axiom
  ...
  (! (=> (dynamic_invariant4 speed true true true)
     (= (m_per_s_from_km_per_h speed) (div1 RNE1 (mul RNE1 speed fliteral3)
...
;; maximum_train_speed__def_axiom
  (assert (= maximum_train_speed (m_per_s_from_km_per_h fliteral9)))
