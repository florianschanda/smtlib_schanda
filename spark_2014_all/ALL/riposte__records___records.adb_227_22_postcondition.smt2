...
(declare-fun temp___323 () Bool)

(declare-fun temp___3231 () unsigned_byte)

(declare-fun temp___3232 () unsigned_byte)
...
(declare-fun x__split_fields5 () us_split_fields2)

(declare-fun x__split_fields6 () us_split_fields__ref1)

(declare-fun tmp3 () int__ref)

(declare-fun x__split_fields7 () us_split_fields2)
...
;; H
  (assert (=> (= x__split_fields true) (= temp___323 o5)))

;; H
  (assert (=> (= x__split_fields true) (= temp___3231 o6)))

;; H
  (assert (=> (= x__split_fields true) (= temp___3232 o7)))
...
;; H
  (assert
  (=> (= x__split_fields true)
  (= x__split_fields4 (mk___split_fields1 temp___323
                      (mk___rep (mk___split_fields temp___3231 temp___3232))))))
...
;; H
  (assert
  (=> (= x__split_fields true)
  (= x__split_fields5 (us_split_fields3 temp___326))))
...
;; H
  (assert
  (= (rec__records_prooffuncs__optional_pair__exists
     (us_split_fields__content1 x__split_fields6)) true))

(assert
;; WP_parameter_def
 ;; File "records.adb", line 207, characters 0-0
  (not (= x__split_fields true)))
(check-sat)
(exit)
