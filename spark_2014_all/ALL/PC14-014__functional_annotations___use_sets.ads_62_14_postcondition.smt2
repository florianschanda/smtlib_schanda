...
(declare-const temp___9561 hash_type)

(declare-const temp___9562 us_main_type)
...
(define-fun s2__split_fields11 () us_split_fields (mk___split_fields
                                                  s2__split_fields1))
...
;; H
  (assert
  (and (= (length (mk___rep s2__split_discrs s2__split_fields11)) 0)
  (= (is_empty (model__ (mk___rep s2__split_discrs s2__split_fields11))) true)))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (length (mk___rep s2__split_discrs s2__split_fields10))))
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields10))
     (get
     (elements
...
;; H
  ...
  (ite (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields10))
          o) true)
  (and
  (and
  (= (oeq2 (model__ (mk___rep s2__split_discrs s2__split_fields3))
     (model__ (mk___rep s2__split_discrs s2__split_fields10))) true)
  (= (oeq4 (positions (mk___rep s2__split_discrs s2__split_fields3))
     (positions (mk___rep s2__split_discrs s2__split_fields10))) true))
  (= (equal_except (elements (mk___rep s2__split_discrs s2__split_fields10))
  ...
  (= (length (mk___rep s2__split_discrs s2__split_fields3)) (+ (length
                                                               ...
                                                               s2__split_discrs
                                                               s2__split_fields10)) 1))
  (= (ole (model__ (mk___rep s2__split_discrs s2__split_fields10))
  ...
  (= (included_except (model__ (mk___rep s2__split_discrs s2__split_fields3))
     (model__ (mk___rep s2__split_discrs s2__split_fields10)) o) true))
  (= (mapping_preserved
     (elements (mk___rep s2__split_discrs s2__split_fields10))
     (elements (mk___rep s2__split_discrs s2__split_fields3))
     (positions (mk___rep s2__split_discrs s2__split_fields10))
...
;; H
  ...
  (= (bool_eq1 temp___9551 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= s2__split_fields6 (mk___split_fields__ref s2__split_fields11))))
...
;; H
  (assert
  (=> (not (= result1 true)) (= s2__split_fields7 s2__split_fields11)))
