...
(declare-fun dummy () subtree_height_type)

(declare-datatypes ()
((subtree_height_type__ref
...
(define-fun us_split_discrs_2__projection ((a us_split_discrs2)) subtree_height_type
...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__main__branch_type__n us_rep1)))))
...
(define-fun us_rep_4__projection ((a us_rep2)) us_split_discrs2 (us_split_discrs3
                                                                a))
...
(declare-fun main__branch_type__n__first__bit () Int)

(declare-fun main__branch_type__n__last__bit () Int)

(declare-fun main__branch_type__n__position () Int)
...
(declare-datatypes ()
((branch_type__ref (mk_branch_type__ref (branch_type__content us_rep2)))))
...
(declare-fun main__branch_type__n__first__bit1 () Int)

(declare-fun main__branch_type__n__last__bit1 () Int)

(declare-fun main__branch_type__n__position1 () Int)
...
(declare-fun main__null_node__assume () node_enum)

(declare-fun main__null_node__assume1 () Bool)
