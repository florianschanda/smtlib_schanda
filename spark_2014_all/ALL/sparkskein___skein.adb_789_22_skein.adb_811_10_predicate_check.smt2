...
;; H
  (assert (= result3 (mk_t__ref3 i)))

;; H
  (assert (= i1 r250b))

;; H
  (assert (bvule r250b i1))

;; H
  (assert (bvule i1 ((_ int2bv 64) 63)))
...
;; H
  ...
  (and
  (and
  (= (rec__skein__skein_512_context__h local_ctx__split_fields14) (rec__skein__skein_512_context__h
...
;; H
  (assert (= (to_rep1 o1) ((_ int2bv 8) 0)))
