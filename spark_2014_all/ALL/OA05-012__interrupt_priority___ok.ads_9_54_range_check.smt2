...
(declare-fun p3__split_fields () integer)

(declare-fun p4__split_fields () integer)
...
;; H
  (assert (and (= us2 0) (in_range 0)))

;; H
  (assert
  (and
  (= (to_rep
     (rec__interrupt_priority__no_interrupt_needed_2__c p3__split_discrs)) 0)
  (= (to_rep1 p3__split_fields) 0)))

;; H
  (assert
  (= 0 (to_rep
       (rec__interrupt_priority__no_interrupt_needed_2__c p3__split_discrs))))

;; H
  (assert (and (= us3 98) (in_range 98)))

;; H
  (assert
  (and
  (= (to_rep
     (rec__interrupt_priority__no_interrupt_needed_2__c p4__split_discrs)) 98)
  (= (to_rep1 p4__split_fields) 0)))

;; H
  (assert
  (= 98 (to_rep
        (rec__interrupt_priority__no_interrupt_needed_2__c p4__split_discrs))))
