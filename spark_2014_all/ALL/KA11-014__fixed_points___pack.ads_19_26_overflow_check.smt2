...
(declare-fun o3 () money)

(declare-fun stash1 () money)

(declare-fun pocket1 () money)

(declare-fun result () Bool)

(declare-fun result1 () money)

(declare-fun stash2 () money)

(declare-fun result2 () money)

(declare-fun pocket2 () money)

(declare-fun stash3 () money)

(declare-fun pocket3 () money)

(declare-fun stash4 () money)

(declare-fun pocket4 () money)
...
;; H
  (assert
  (=> (= result true) (= (to_fixed1 o2) (- (to_fixed1 stash) (to_fixed2 s)))))

;; H
  (assert
  (=> (= result true) (= (mk_money__ref result1) (mk_money__ref stash))))

;; H
  (assert (=> (= result true) (= stash2 o2)))

;; H
  (assert
  (=> (= result true)
  (= (to_fixed1 o3) (+ (to_fixed1 pocket) (to_fixed2 s)))))

;; H
  (assert
  (=> (= result true) (= (mk_money__ref result2) (mk_money__ref pocket))))

;; H
  (assert (=> (= result true) (= pocket2 o3)))

;; H
  (assert (=> (not (= result true)) (= pocket2 pocket)))

;; H
  (assert (=> (not (= result true)) (= stash2 stash)))

;; H
  (assert (=> (not (= result true)) (= pocket2 pocket1)))

;; H
  (assert (=> (not (= result true)) (= stash2 stash1)))

;; H
  (assert (= pocket2 pocket3))

;; H
  (assert (= stash2 stash3))

;; H
  (assert (= pocket4 pocket2))

;; H
  (assert (= stash4 stash2))

(assert
;; WP_parameter_def
 ;; File "pack.ads", line 6, characters 0-0
  (not (in_range (+ (to_fixed1 stash3) (to_fixed1 pocket3)))))
(check-sat)
(exit)
