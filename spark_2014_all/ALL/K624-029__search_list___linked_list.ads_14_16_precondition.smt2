...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (- (get1 (positions l) (mk___rep1 cu__split_fields12)) 1)))
  (not (= (get (model__ l) i1) 0)))))
...
;; H
  ...
  (and (= o9 (contains l 0))
  (= (= o9 true) (= (contains1 (model__ l) 1 (length2 l) 0) true)))))

;; H
  (assert
  (=>
  (= (bool_eq1 (cursor__content linked_list__search__result13) no_element) true)
  (= result4 (ite (not (= o9 true)) true false))))
...
;; H
  (assert
  (and
  (= result6 (has_key (positions l)
             (cursor__content linked_list__search__result13)))
  (= (= result6 true)
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o8 (element l (cursor__content linked_list__search__result13)))
  (and (in_range5 o8)
  (= o8 (get (model__ l)
        (get1 (positions l) (cursor__content linked_list__search__result13))))))))
...
;; H
  ...
  (forall ((i1 us_rep1))
  (=> (= (has_key o3 i1) true)
  (and (and (<= 1 (get1 o3 i1)) (<= (get1 o3 i1) (length2 l)))
  (forall ((j us_rep1))
  (=> (= (has_key o3 j) true)
...
;; H
  (assert
  (and (= o4 (get1 o3 (cursor__content linked_list__search__result13)))
  (and (in_range4 o4)
  (=> (= (of_int 0) true)
  (and
  (= o4 (w_get o3
        (witness o3 (cursor__content linked_list__search__result13))))
  (forall ((k us_rep1))
  (=> (= (has_key o3 k) true)
  (= (= (bool_eq1 k (cursor__content linked_list__search__result13)) true)
  (= (witness o3 (cursor__content linked_list__search__result13)) (witness
                                                                  o3 k))))))))))
