...
(declare-datatypes ((us_t 0)) (((mk___t (elts map1)(rt t)(rt_2 t1)))))
...
(((mk_t_array__ref (t_array__content us_t)))))
...
(declare-datatypes ((us_t1 0)) (((mk___t1 (elts1 map1)(rt1 t2)(rt_21 t3)))))
...
(define-fun bool_eq2 ((x us_t1)
  (y us_t1)) Bool (bool_eq (elts1 x) (to_rep1 (first3 (rt1 x)))
...
(define-fun us_split_discrs___2__projection ((a us_split_discrs)) positive
  (rec__discr__t_record__row_last a))

(define-fun us_split_discrs___3__projection ((a us_split_discrs)) positive
  (rec__discr__t_record__col_first a))

(define-fun us_split_discrs___4__projection ((a us_split_discrs)) positive
...
(((mk___split_fields (rec__discr__t_record__data us_t1)))))
...
(((mk_t_record__ref (t_record__content us_rep)))))
...
;; WP_parameter_def
 ;; File "discr.ads", line 12, characters 0-0
  ...
  (= (let ((temp___208 (rec__discr__t_record__data (us_split_fields1 rec__))))
     (bool_eq data_copy1 (to_rep1 data_copy__first) (to_rep1 data_copy__last)
     (to_rep1 data_copy__first_2) (to_rep1 data_copy__last_2)
     (elts1 temp___208) (to_rep1 (first3 (rt1 temp___208)))
     (to_rep1 (last3 (rt1 temp___208))) (to_rep1 (first4 (rt_21 temp___208)))
