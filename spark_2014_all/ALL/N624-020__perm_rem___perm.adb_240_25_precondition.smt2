...
;; H
  (assert
  (and (= o16 (shift_perm_l o29 o28 o26))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o26 o28) true)))))
...
;; H
  (assert
  (and (= o23 (remove bb o22))
  (and (dynamic_invariant2 o23 true false true)
  (and (= (invariant__ o23) true)
  (and (= (to_rep2 (last (rt o23))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o22 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o23) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o22 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o23) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o22 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o23) k))))))))))))
