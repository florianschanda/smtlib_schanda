...
(declare-const temp___1356 (Array Int character))

(declare-const temp___13561 t)
...
;; H
  (assert
  (=> (= (length (mk___t temp___1354 temp___13541)) 0)
  (= (temp___String_Literal_1353 Tuple0) temp___1356)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1354 temp___13541)) 0))
  (=> (<= 1 5) (= o8 (+ (- 5 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1354 temp___13541)) 0))
  (= o11 (+ (to_rep1 (first temp___13541)) o10))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1354 temp___13541)) 0))
  (= (concat1 temp___1354 (to_rep1 (first temp___13541))
     (to_rep1 (last temp___13541)) (temp___String_Literal_1353 Tuple0) 1 5)
  temp___1356)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1354 temp___13541)) 0))
  (= (mk (to_rep1 (first temp___13541)) o13) temp___13561)))

;; H
  (assert (not (= (length (mk___t temp___1356 temp___13561)) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___13561)) (to_rep1 (last temp___13561)))
  (= o15 (+ (- (to_rep1 (last temp___13561)) (to_rep1 (first temp___13561))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___13561)) (to_rep1 (last temp___13561))))
  (= o15 0)))
...
;; H
  (assert (= o17 (+ (to_rep1 (first temp___13561)) o16)))
