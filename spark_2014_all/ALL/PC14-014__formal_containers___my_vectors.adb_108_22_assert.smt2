...
(declare-fun my_vectors__v__assign__target__fields () us_split_fields)

(declare-fun result1 () us_split_fields__ref)

(declare-fun k__split_fields2 () us_split_fields)

(declare-fun my_vectors__s__sort__container__fields () us_split_fields)
...
(declare-fun my_vectors__s__merge__source__fields () us_split_fields)

(declare-fun my_vectors__s__merge__target__fields () us_split_fields)
...
(declare-fun my_vectors__s__sort__container__fields1 () us_split_fields)

(declare-fun result7 () us_split_fields__ref)

(declare-fun l__split_fields5 () us_split_fields)

(declare-fun my_vectors__v__assign__target__fields1 () us_split_fields)
...
(declare-fun my_vectors__s__merge__source__fields1 () us_split_fields)

(declare-fun my_vectors__s__merge__target__fields1 () us_split_fields)
...
;; H
  ...
  (= (oeq
     (model__
     (mk___rep k__split_discrs my_vectors__v__assign__target__fields))
     (model__ (mk___rep l__split_discrs l__split_fields1))) true))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields))
  (length (mk___rep l__split_discrs l__split_fields1)))
  (= (m_elements_sorted
     (model__
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields))) true))
  (= (m_elements_included
     (model__ (mk___rep l__split_discrs l__split_fields1)) 1
     (last
     (model__
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields)))
     (model__
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields)) 1
     (last
     (model__
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields)))) true))
  (= (m_elements_included
...
;; H
  (assert
  (ite (= (<= (length (mk___rep l__split_discrs l__split_fields2)) 5) true)
  (= (length
...
;; H
  (assert
  (= l__split_fields3 my_vectors__v__delete_last__2__container__fields))

;; H
  (assert
  (ite (= (<= (length (mk___rep k__split_discrs k__split_fields2)) 5) true)
  (= (length
  ...
  (= (range_shifted
     ...
     (model__
     (mk___rep k__split_discrs
     my_vectors__v__delete_first__2__container__fields))) 5) true))))
...
;; H
  (assert
  (= k__split_fields3 my_vectors__v__delete_first__2__container__fields))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep l__split_discrs my_vectors__s__merge__target__fields)) (+
  (length (mk___rep l__split_discrs l__split_fields3)) (length
                                                       (mk___rep
                                                       k__split_discrs
                                                       k__split_fields3))))
  (= (length (mk___rep k__split_discrs my_vectors__s__merge__source__fields)) 0))
  (=>
  (and
  (= (m_elements_sorted
  ...
  (= (m_elements_sorted
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields))) true)))
  (= (m_elements_included
     (model__ (mk___rep l__split_discrs l__split_fields3)) 1
     (last (model__ (mk___rep l__split_discrs l__split_fields3)))
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields)) 1
     (last
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields)))) true))
  (= (m_elements_included
     (model__ (mk___rep k__split_discrs k__split_fields3)) 1
  ...
  (= (m_elements_in_union
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields1))
  (length (mk___rep l__split_discrs l__split_fields4)))
  (= (m_elements_sorted
     (model__
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields1))) true))
  (= (m_elements_included
     ...
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)))
     (model__
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)) 1
     (last
     (model__
     (mk___rep l__split_discrs my_vectors__s__sort__container__fields1)))) true))
  (= (m_elements_included
...
;; H
  ...
  (= (oeq
     (model__
     (mk___rep k__split_discrs my_vectors__v__assign__target__fields1))
     (model__ (mk___rep l__split_discrs l__split_fields5))) true))

;; H
  (assert (= result8 (mk___split_fields__ref k__split_fields4)))

;; H
  (assert (= k__split_fields5 my_vectors__v__assign__target__fields1))

;; H
  (assert
  (ite (= (<= (length (mk___rep l__split_discrs l__split_fields5)) 5) true)
  (= (length
     (mk___rep l__split_discrs
...
;; H
  (assert
  (= l__split_fields6 my_vectors__v__delete_last__2__container__fields1))

;; H
  (assert
  (ite (= (<= (length (mk___rep k__split_discrs k__split_fields5)) 5) true)
  (= (length
     (mk___rep k__split_discrs
  ...
  (= (range_shifted
     ...
     (model__
     (mk___rep k__split_discrs
     my_vectors__v__delete_first__2__container__fields1))) 5) true))))

;; H
  (assert (= result10 (mk___split_fields__ref k__split_fields5)))

;; H
  (assert
  (= k__split_fields6 my_vectors__v__delete_first__2__container__fields1))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields1)) (+
  (length (mk___rep l__split_discrs l__split_fields6)) (length
                                                       (mk___rep
                                                       k__split_discrs
                                                       k__split_fields6))))
  (= (length
     (mk___rep k__split_discrs my_vectors__s__merge__source__fields1)) 0))
  (=>
  (and
  (= (m_elements_sorted
     (model__ (mk___rep l__split_discrs l__split_fields6))) true)
  (= (m_elements_sorted
     (model__ (mk___rep k__split_discrs k__split_fields6))) true))
  (= (m_elements_sorted
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields1))) true)))
  (= (m_elements_included
     (model__ (mk___rep l__split_discrs l__split_fields6)) 1
     (last (model__ (mk___rep l__split_discrs l__split_fields6)))
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields1)) 1
     (last
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields1)))) true))
  (= (m_elements_included
     (model__ (mk___rep k__split_discrs k__split_fields6)) 1
     (last (model__ (mk___rep k__split_discrs k__split_fields6)))
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields1)) 1
     (last
     (model__
  ...
  (= (m_elements_in_union
     (model__
     (mk___rep l__split_discrs my_vectors__s__merge__target__fields1))
     (model__ (mk___rep k__split_discrs k__split_fields6))
     (model__ (mk___rep l__split_discrs l__split_fields6))) true)))
...
;; H
  (assert (= l__split_fields7 my_vectors__s__merge__target__fields1))

;; H
  (assert (= result12 (mk___split_fields__ref k__split_fields6)))

;; H
  (assert (= k__split_fields7 my_vectors__s__merge__source__fields1))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 855, characters 0-0
  (not (= (is_sorted (mk___rep l__split_discrs l__split_fields7)) true)))
(check-sat)
(exit)
