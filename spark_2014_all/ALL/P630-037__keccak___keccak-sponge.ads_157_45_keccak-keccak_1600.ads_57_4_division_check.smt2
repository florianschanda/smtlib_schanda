...
;; H
  (assert
  (and
  (= o54 (rate_of (mk___rep (us_split_fields__content ctx__split_fields27))))
  (and (in_range3 o54)
  (and
  (= o54 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
            (us_split_fields__content ctx__split_fields27))) 8))
  (< o54 1600)))))

;; H
  (assert
  (and
  (= o55 (in_queue_bit_length
         (mk___rep (us_split_fields__content ctx__split_fields27))))
  (and (in_range2 o55)
  (and
  (= o55 (to_rep3
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
         (us_split_fields__content ctx__split_fields27))))
  (< o55 1600)))))
