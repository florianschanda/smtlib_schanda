...
(declare-datatypes ((statscountstringi__ref 0))
...
(declare-datatypes ((t254b__ref 0))
(((mk_t254b__ref (t254b__content integer)))))
...
(((mk_t255b__ref (t255b__content us_t1)))))
...
(declare-datatypes ((t257b__ref 0))
(((mk_t257b__ref (t257b__content integer)))))
...
(((mk_t258b__ref (t258b__content us_t2)))))
...
(declare-datatypes ((t265b__ref 0))
(((mk_t265b__ref (t265b__content integer)))))
...
(declare-datatypes ((t266b__ref 0))
(((mk_t266b__ref (t266b__content us_t3)))))
...
(declare-datatypes ((t268b__ref 0))
(((mk_t268b__ref (t268b__content integer)))))
...
(declare-datatypes ((t269b__ref 0))
(((mk_t269b__ref (t269b__content us_t4)))))
...
(declare-datatypes ((t276b__ref 0))
(((mk_t276b__ref (t276b__content integer)))))
...
(declare-datatypes ((t277b__ref 0))
(((mk_t277b__ref (t277b__content us_t5)))))
...
(declare-datatypes ((t279b__ref 0))
(((mk_t279b__ref (t279b__content integer)))))
...
(((mk_t280b__ref (t280b__content us_t6)))))
...
(declare-datatypes ((t287b__ref 0))
(((mk_t287b__ref (t287b__content integer)))))
...
(declare-datatypes ((t288b__ref 0))
(((mk_t288b__ref (t288b__content us_t7)))))
...
(declare-datatypes ((t290b__ref 0))
(((mk_t290b__ref (t290b__content integer)))))
...
(((mk_t291b__ref (t291b__content us_t8)))))
...
(declare-const o2 screenycoordt)

(declare-const o3 screenxcoordt)
...
(declare-const o8 screenycoordt)

(declare-const o9 screenxcoordt)
...
;; H
  (assert (= data3 (elts (to_string (attr__ATTRIBUTE_IMAGE4 c248b)))))
...
;; H
  (assert
  (= result__3 (screen__writestatsdata__B251b__result__aggregate_def 32)))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first2 (rt1 temp___1402))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first2 (mk1 1 (- (to_rep1 data__last) 1))))
        (to_rep1 (last2 (mk1 1 (- (to_rep1 data__last) 1)))))
        (+ (- (to_rep1 (last2 (mk1 1 (- (to_rep1 data__last) 1)))) (to_rep1
                                                                   (first2
                                                                   (mk1 1
                                                                   (-
                                                                   (to_rep1
...
;; H
  ...
  (= (select o1 temp___1407) (select (elts1 temp___1406) temp___1407))
  (= (select o1 temp___1407) (select result__3 temp___1407)))))

;; H
  (assert (= result2 (mk_map__ref result__3)))
...
;; H
  (assert (= c249b1 result__4))

;; H
  (assert (= (to_rep4 o2) 26))

;; H
  (assert (= (to_rep3 o3) 50))

;; H
  (assert (= o4 (mk___split_fields2 o3 o2)))

;; H
  (assert (= o5 (mk___rep2 o4)))
...
;; H
  (assert (= data4 (elts (to_string (attr__ATTRIBUTE_IMAGE4 c259b)))))
...
;; H
  (assert
  (= result__5 (screen__writestatsdata__B262b__result__aggregate_def 32)))
...
;; H
  (assert (= temp___1414 (mk___t4 o6 (mk4 2 (to_rep1 data__last1)))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first6 (rt3 temp___1415))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first6 (mk3 1 (- (to_rep1 data__last1) 1))))
        (to_rep1 (last6 (mk3 1 (- (to_rep1 data__last1) 1)))))
        (+ (- (to_rep1 (last6 (mk3 1 (- (to_rep1 data__last1) 1)))) (to_rep1
                                                                    (first6
                                                                    (mk3 1
                                                                    (-
                                                                    (to_rep1
...
;; H
  ...
  (= (select o7 temp___1420) (select (elts3 temp___1419) temp___1420))
  (= (select o7 temp___1420) (select result__5 temp___1420)))))

;; H
  (assert (= result7 (mk_map__ref result__5)))
...
;; H
  (assert (= c260b1 result__6))

;; H
  (assert (= (to_rep4 o8) 26))

;; H
  (assert (= (to_rep3 o9) 65))

;; H
  (assert (= o10 (mk___split_fields2 o9 o8)))

;; H
  (assert (= o11 (mk___rep2 o10)))
...
;; H
  (assert (= data5 (elts (to_string (attr__ATTRIBUTE_IMAGE4 c270b)))))
...
;; H
  (assert
  (= result__7 (screen__writestatsdata__B273b__result__aggregate_def 32)))

;; H
  (assert (<= 2 (to_rep1 data__last2)))

(assert
;; WP_parameter_def
 ;; File "screen.adb", line 712, characters 0-0
  (not (<= (to_rep1 data__first2) 2)))
(check-sat)
(exit)
