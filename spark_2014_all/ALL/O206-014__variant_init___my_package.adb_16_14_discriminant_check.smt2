...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__my_package__variant_type__m_v enum_type)))))
...
(declare-fun my_package__variant_type__m_v__first__bit () Int)

(declare-fun my_package__variant_type__m_v__last__bit () Int)

(declare-fun my_package__variant_type__m_v__position () Int)
...
(declare-fun my_package__variant_type__m_c__first__bit () Int)

(declare-fun my_package__variant_type__m_c__last__bit () Int)

(declare-fun my_package__variant_type__m_c__position () Int)
...
(declare-fun my_package__variant_type__m_a__first__bit () Int)

(declare-fun my_package__variant_type__m_a__last__bit () Int)

(declare-fun my_package__variant_type__m_a__position () Int)
...
(declare-fun my_package__variant_type__m_b__first__bit () Int)

(declare-fun my_package__variant_type__m_b__last__bit () Int)

(declare-fun my_package__variant_type__m_b__position () Int)
...
;; H
  (assert
  (not (= (to_rep1 (rec__my_package__variant_type__m_v v__split_discrs)) 0)))

(assert
;; WP_parameter_def
 ;; File "my_package.ads", line 21, characters 0-0
  (not (= (to_rep1 (rec__my_package__variant_type__m_v v__split_discrs)) 1)))
(check-sat)
