...
(declare-fun prev_value () Int)

(declare-fun tmp_value () Int)
...
(declare-fun tmp_value1 () Int)

(declare-fun result3 () Int)

(declare-fun prev_value2 () Int)

(declare-fun result4 () (Array Int value))

(declare-fun v1 () (Array Int value))

(declare-fun v2 () (Array Int value))

(declare-fun prev_value3 () Int)

(declare-fun tmp_value2 () Int)
...
(declare-fun tmp_value3 () Int)

(declare-fun result7 () Int)

(declare-fun prev_value4 () Int)
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k j2))
  (= (to_rep (select v2 k)) (to_rep (select v (ite (< 1 (- k 1)) (- k 1) 1)))))))

;; H
  (assert
  (forall ((k Int))
  (=> (and (<= (+ j2 1) k) (<= k 100))
  (= (to_rep (select v2 k)) (to_rep (select v k))))))
...
(assert
;; WP_parameter_def
 ;; File "math.ads", line 11, characters 0-0
  (not (= (to_rep (select v3 k)) (to_rep (select v k)))))
(check-sat)
(exit)
