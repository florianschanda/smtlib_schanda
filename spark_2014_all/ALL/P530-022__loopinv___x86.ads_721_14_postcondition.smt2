...
(declare-fun rdi8 () t__ref1)

(declare-fun memory8 () map__ref)

(declare-fun mem8 () map__ref)
...
(declare-fun mem9 () (Array (_ BitVec 64) unsigned8))
...
;; H
  (assert
  (=> (not (= rcx ((_ int2bv 64) 0))) (= (mk_map__ref result) mem11)))
...
;; H
  (assert (=> (not (= rcx ((_ int2bv 64) 0))) (= mem10 (mk_map__ref mem4))))

;; H
  (assert
  (=> (not (= rcx ((_ int2bv 64) 0))) (= memory10 (mk_map__ref memory4))))

;; H
  (assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi10 (mk_t__ref1 rdi4))))

;; H
  (assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx10 (mk_t__ref1 rcx4))))
...
;; H
  (assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= mem10 mem11)))

;; H
  (assert
  (=> (not (not (= rcx ((_ int2bv 64) 0))))
  (= memory10 (mk_map__ref memory))))

;; H
  (assert
  (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rdi10 (mk_t__ref1 rdi))))

;; H
  (assert
  (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rcx10 (mk_t__ref1 rcx))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 714, characters 0-0
  (not (= (t__content1 rcx8) ((_ int2bv 64) 0))))
(check-sat)
