...
;; H
  (assert
  (and (= o26 (remove (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and (= o27 (remove (mk___t interm1 (mk 1 100)) o13))
  (and (dynamic_invariant4 o27 true false true)
...
;; H
  (assert
  (and (= o20 (remove_eq o27 o26 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o26 o19)))
     (let ((temp___162 (remove o27 o19)))
...
;; WP_parameter_def
 ;; File "sort.ads", line 4, characters 0-0
  (not (= (invariant__ (mk___t values2 (mk 1 100))) true)))
(check-sat)
(exit)
