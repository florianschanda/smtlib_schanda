...
(declare-fun stack_pointer1 () Int)
...
;; H
  (assert (and (= o (+ stack_pointer 1)) (in_range1 (+ stack_pointer 1))))

;; H
  (assert (= result stack_pointer))

;; H
  (assert (= stack_pointer1 o))
...
(assert
;; WP_parameter_def
 ;; File "pre_post_exercise.adb", line 8, characters 0-0
