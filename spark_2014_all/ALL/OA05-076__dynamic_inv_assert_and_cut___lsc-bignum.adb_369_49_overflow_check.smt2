...
;; H
  (assert (= o76 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (= o69 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o75 (omultiply o69 o74)))

;; H
  (assert (= o77 (osubtract o75 o76)))

;; H
  (assert (= o66 (from_word32 a_msw3)))
...
;; H
  (assert
  (and (= o60 (base Tuple0))
  (= o60 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o65 (oexpon o60 o64)))

;; H
  (assert (= o67 (omultiply o65 o66)))
...
;; H
  (assert
  (= o59 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o58)))

;; H
  (assert (= o68 (oadd o59 o67)))

;; H
  (assert (= o78 (olt o68 o77)))

;; H
  (assert (and (= o50 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert (= o54 (num_of_big_int m m_first o53)))

;; H
  (assert (and (= o45 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o46 (- o45 a_first)))
...
;; H
  (assert
  (and (= o43 (base Tuple0))
  (= o43 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert (= o42 (num_of_big_int m m_first o41)))

;; H
  (assert (= o44 (inverse o42 o43)))

;; H
  (assert (= o49 (oexpon o44 o48)))
