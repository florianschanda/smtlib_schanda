...
(declare-fun temp___285 () (Array Int map1))

(declare-fun temp___280 () Int)

(declare-fun temp___275 () (Array Int map1))

(declare-fun temp___259 () Int)

(declare-fun temp___264 () (Array Int map1))

(declare-fun temp___254 () (Array Int map1))

(declare-fun temp___238 () Int)

(declare-fun temp___233 () (Array Int map1))

(declare-fun temp___243 () (Array Int map1))
...
(declare-fun x19 () map__ref2)

(declare-fun i34 () int__ref)

(declare-fun i217 () int__ref)

(declare-fun i2212 () int__ref)

(declare-fun i117 () int__ref)
...
;; H
  ...
  (= (bool_eq2 x3 (to_rep (first4 (mk2 (+ i32 1) 3)))
     (to_rep (last4 (mk2 (+ i32 1) 3))) temp___285
...
;; H
  ...
  (= (select x3 temp___276) (select temp___275 temp___276))
...
;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3)) (= temp___259 i222))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3)) (= temp___264 x3))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3)) (= temp___254 x3))))
...
;; H
  ...
  (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3)))
     (to_rep (last8 (mk4 (+ i32 1) 3))) temp___264
...
;; H
  ...
  (= (select x4 temp___255) (select temp___254 temp___255))
  (forall ((temp___256 Int) (temp___257 Int))
  (=>
  (and (and (<= 1 temp___256) (<= temp___256 3))
  (and (<= 1 temp___257) (<= temp___257 3)))
  (=> (or (<= i223 temp___257) (not (= i212 temp___256)))
  (= (get (select x4 temp___255) temp___256 temp___257) (get
                                                        (select temp___254 temp___255)
                                                        temp___256
                                                        temp___257))))))))
  (=> (<= 1 3) (in_range2 i223))) (and (<= 1 i223) (<= i223 3))))))
...
;; H
  ...
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= temp___238 i13)))))
...
;; H
  ...
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3))
  (= o1 (store (get (select x4 i32) i212 i223) i13 o))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= o2 (set (select x4 i32) i212 i223 o1))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= o3 (store x4 i32 o2))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= x4 result5)))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= x5 o3)))))
...
;; H
  ...
  (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3)))
     (to_rep (last12 (mk6 (+ i32 1) 3))) temp___243
...
;; H
  ...
  (= (select x6 temp___234) (select temp___233 temp___234))
  ...
  (=> (<= 1 3) (in_range2 i14))) (and (<= 1 i14) (<= i14 3)))))))
...
;; H
  ...
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= i17 (mk_int__ref i15))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (and (<= 1 i13) (<= i13 3)) (= x9 (mk_map__ref2 x7))))))
...
;; H
  ...
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (not (and (<= 1 i13) (<= i13 3))) (= i17 (mk_int__ref i13))))))

;; H
  (assert
  (=> (and (<= 1 i211) (<= i211 3))
  (=> (and (<= 1 i222) (<= i222 3))
  (=> (not (and (<= 1 i13) (<= i13 3))) (= x9 (mk_map__ref2 x4))))))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq2 (map__content2 x19)
     (to_rep (first (mk (+ (int__content i34) 1) 3)))
     (to_rep (last (mk (+ (int__content i34) 1) 3))) x1
     (to_rep (first2 (mk1 (+ (int__content i34) 1) 3)))
     (to_rep (last2 (mk1 (+ (int__content i34) 1) 3)))) true)))
(check-sat)
(exit)
