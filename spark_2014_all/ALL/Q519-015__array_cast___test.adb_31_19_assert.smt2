...
(define-fun o13 () us_rep (mk___rep (mk___split_discrs o10)
                          (mk___split_fields o11)))

(define-fun o14 () us_rep (mk___rep (mk___split_discrs o8)
                          (mk___split_fields o9)))

(define-fun o15 () us_rep (mk___rep (mk___split_discrs o6)
...
;; WP_parameter_def
 ;; File "test.adb", line 5, characters 0-0
  (not (= (to_rep (rec__test__rec__y (us_split_fields1 (select z1 i)))) 1)))
(check-sat)
(exit)
