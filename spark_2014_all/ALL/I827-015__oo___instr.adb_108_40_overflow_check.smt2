...
(((mk_speed__ref (speed__content speed)))))
...
(declare-datatypes ((speedometer__ref 0))
(((mk_speedometer__ref (speedometer__content us_rep1)))))
...
(declare-datatypes ((gauge__ref 0))
(((mk_gauge__ref (gauge__content us_rep2)))))
...
(declare-datatypes ((graphic_gauge__ref 0))
...
(((mk_clock__ref (clock__content us_rep4)))))
...
(((mk_chronometer__ref (chronometer__content us_rep4)))))
