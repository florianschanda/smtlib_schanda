...
(define-fun s2__split_fields2 () us_split_fields (mk___split_fields
                                                 s2__split_fields1))
...
;; H
  (assert
  (and (= (length (mk___rep s2__split_discrs s2__split_fields3)) 0)
  (= (is_empty (model__ (mk___rep s2__split_discrs s2__split_fields3))) true)))
...
;; H
  (assert
  (and (= o1 (length (mk___rep s2__split_discrs s2__split_fields2)))
  (and (in_range2 o1)
  (<= o1 (to_rep
