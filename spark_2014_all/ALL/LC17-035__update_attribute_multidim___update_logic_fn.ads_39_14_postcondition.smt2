...
(declare-fun temp___202 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8)
  Int) map1)

;; def_axiom
  (assert
  (forall ((temp___204 map1))
  (forall ((temp___205 Int) (temp___207 Int) (temp___208 Int)
  (temp___210 Int))
  (forall ((temp___206 (_ BitVec 8)) (temp___209 (_ BitVec 8)))
  ...
  (ite (and (= temp___211 temp___208) (= temp___212 temp___209))
  (= (get temp___203 temp___211 temp___212) (of_rep temp___210))
  (ite (and (= temp___211 temp___205) (= temp___212 temp___206))
  (= (get temp___203 temp___211 temp___212) (of_rep temp___207))
  (= (get temp___203 temp___211 temp___212) (get temp___204 temp___211
                                            temp___212)))))))))))
...
(assert
;; WP_parameter_def
 ;; File "update_logic_fn.ads", line 29, characters 0-0
  (not
  (= (bool_eq a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7)
     (temp___202 a_2d_arr 5 ((_ int2bv 8) 7) v1 x y v2) 1 10 ((_ int2bv 8) 0)
     ((_ int2bv 8) 7)) true)))
(check-sat)
(exit)
