...
(define-fun tint_arrayD1__ref___17__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___17__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t586b__ref 0))
(((mk_t586b__ref (t586b__content integer)))))
...
(declare-datatypes ((t587b__ref 0))
(((mk_t587b__ref (t587b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___26__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___26__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t590b__ref 0))
(((mk_t590b__ref (t590b__content integer)))))
...
(declare-datatypes ((t591b__ref 0))
(((mk_t591b__ref (t591b__content us_t4)))))
...
(declare-datatypes ((t592b__ref 0))
(((mk_t592b__ref (t592b__content integer)))))
...
(define-fun tint_arrayB__ref___17__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___26__projection ((a tnumber_array_typeB__ref)) us_t6
