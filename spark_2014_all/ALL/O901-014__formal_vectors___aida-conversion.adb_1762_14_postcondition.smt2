...
(define-fun tint_arrayD1__ref_17__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref_17__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ()
((t586b__ref (mk_t586b__ref (t586b__content integer)))))
(define-fun t586b__ref___projection ((a t586b__ref)) integer (t586b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_26__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref_26__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ()
((t590b__ref (mk_t590b__ref (t590b__content integer)))))
(define-fun t590b__ref___projection ((a t590b__ref)) integer (t590b__content
                                                             a))
...
(declare-datatypes ()
((t592b__ref (mk_t592b__ref (t592b__content integer)))))
(define-fun t592b__ref___projection ((a t592b__ref)) integer (t592b__content
                                                             a))
...
(define-fun tint_arrayB__ref_17__projection ((a tint_arrayB__ref)) us_t5
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2093 Int) (temp___2094 Int) (temp___2095 Int)
  (temp___2096 Int) (temp___2097 Int) (temp___2098 Int) (temp___2099 Int)
  (temp___2100 Int) (temp___2101 Int) (temp___2102 Int) (temp___2103 Int))
  (let ((temp___2092 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def
                     temp___2093 temp___2094 temp___2095 temp___2096
                     temp___2097 temp___2098 temp___2099 temp___2100
                     temp___2101 temp___2102 temp___2103)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 2) (+ (first1 source) 10)
  temp___2102 temp___2103)
  (and (= (first5 temp___2092) temp___2102)
  (= (last5 temp___2092) temp___2103)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 0)) (of_rep1
                                                                  temp___2093))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 1)) (of_rep1
                                                                  temp___2094)))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 2)) (of_rep1
                                                                  temp___2095)))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 3)) (of_rep1
                                                                  temp___2096)))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 4)) (of_rep1
                                                                  temp___2097)))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 5)) (of_rep1
                                                                  temp___2098)))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 6)) (of_rep1
                                                                  temp___2099)))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 7)) (of_rep1
                                                                  temp___2100)))
  (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 8)) (of_rep1
                                                                  temp___2101)))))))
...
(define-fun tnumber_array_typeB__ref_26__projection ((a tnumber_array_typeB__ref)) us_t6
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2109 Int) (temp___2110 Int) (temp___2111 Int))
  (let ((temp___2108 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def
                     temp___2109 temp___2110 temp___2111)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 2) (+ (first1 source) 10)
  temp___2110 temp___2111)
  (and (= (first9 temp___2108) temp___2110)
  (= (last9 temp___2108) temp___2111)))
  (forall ((temp___2112 Int))
  (= (select (to_array4 temp___2108) temp___2112) (of_rep1 temp___2109)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_653 us_t3)
  (temp___is_init_650 Bool) (temp___skip_constant_651 Bool)
  (temp___do_toplevel_652 Bool)) Bool (=>
                                      (not (= temp___skip_constant_651 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 2)
                                      (+ (first1 source) 10)
                                      (first7 temp___expr_653)
                                      (last7 temp___expr_653))
                                      (and
                                      (= (first7 temp___expr_653) (+
                                      (first1 source) 2))
                                      (= (last7 temp___expr_653) (+ (first1
                                                                    source) 10))))))
...
(declare-fun temp___2106 () (Array Int integer))

(declare-fun temp___21061 () t2)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1 () t1)

(declare-fun temp___2114 () (Array Int integer))

(declare-fun temp___21141 () t4)

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1 () t3)

(declare-fun temp___2120 () Int)

(declare-fun temp___2121 () Int)

(declare-fun temp___2118 () (Array Int integer))
...
(declare-fun temp___2129 () Int)

(declare-fun o56 () Int)

(declare-fun o57 () integer)
...
(declare-fun int_array2 () map__ref1)
...
(declare-fun int_array3 () (Array Int integer))
...
;; H
  ...
  (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 48))
  (forall ((index9 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 2) index9)
  (<= index9 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
;; H
  ...
  (= (to_rep1
     (first4
     (rt2
     (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def
     0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2)
     (+ (+ (to_rep1 (first (rt source))) 2) 8))))) (+ (to_rep1
                                                      (first (rt source))) 2)))
...
;; H
  (assert
  (= (mk___t2 temp___2106 temp___21061) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def
                                        0 9 9 9 9 9 9 9 9
                                        (+ (to_rep1 (first (rt source))) 2)
                                        (+ (+ (to_rep1 (first (rt source))) 2) 8))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___21061)) (to_rep1 (last4 temp___21061)))
     (+ (- (to_rep1 (last4 temp___21061)) (to_rep1 (first4 temp___21061))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1
                                                        (first (rt source))) 10))
...
;; H
  (assert
  (= (slide1 temp___2106 (to_rep1 (first4 temp___21061))
     (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 2)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first2
                                aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1))))
...
;; H
  (assert
  (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 2)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 2))
...
;; H
  ...
  (= (to_rep1
     (first8
     (rt4
     (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 2)
     (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1
                                                 (first (rt source))) 2)))
...
;; H
  (assert
  (= (mk___t4 temp___2114 temp___21141) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 2)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___21141)) (to_rep1 (last8 temp___21141)))
     (+ (- (to_rep1 (last8 temp___21141)) (to_rep1 (first8 temp___21141))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 2)) 1)
...
;; H
  (assert
  (= (slide1 temp___2114 (to_rep1 (first8 temp___21141))
     (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 2)
     (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first6
                        aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1))))
...
;; H
  (assert
  (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 2)
  (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last))
  (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 2))
  (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))

;; H
  (assert
  (and (= temp___2120 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (= temp___2121 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121))
  (= temp___2118 n1)))
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= n2 o8)))

;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121))
  (forall ((i Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 2) i) (<= i index2))
...
;; H
  ...
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121))
  (forall ((j Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j) (<= j index2))
...
;; H
  ...
  (and
  (=>
  (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))
  (dynamic_property9 (+ (to_rep1 (first (rt source))) 2)
  (+ (to_rep1 (first (rt source))) 10) index2))
  (forall ((temp___2119 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2119)
  (<= temp___2119 (to_rep1 n__last)))
  (=> (< index2 temp___2119)
  (= (select n3 temp___2119) (select temp___2118 temp___2119))))))
  (and (<= (+ (to_rep1 (first (rt source))) 2) index2)
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2120 index1) (<= index1 temp___2121)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2120 index1) (<= index1 temp___2121)))
...
;; H
  (assert
  (=> (not (and (<= temp___2120 index1) (<= index1 temp___2121))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2122 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2122)
  (<= temp___2122 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2123 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2123)
  (<= temp___2123 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2124 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2124)
  (<= temp___2124 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2125 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2125)
  (<= temp___2125 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2126 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2126)
  (<= temp___2126 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2127 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2127)
  (<= temp___2127 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2128 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2128)
  (<= temp___2128 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2129 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2129)
  (<= temp___2129 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= o63 (- target8 2000000000)) (in_range1 (- target8 2000000000))))
...
;; H
  (assert (<= (- 2099999999) target9))

;; H
  (assert (= result13 (mk_bool__ref has_failed)))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1703, characters 0-0
