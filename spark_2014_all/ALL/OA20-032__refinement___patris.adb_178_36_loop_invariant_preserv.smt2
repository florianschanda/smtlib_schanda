...
;; H
  (assert (=> (= result8 true) (= result9 (mk_map__ref1 cur_board8))))
...
;; H
  (assert (=> (= result8 true) (= result10 (mk_map__ref1 cur_board9))))
...
;; H
  (assert
  (=> (= result8 true)
  (and (= o2 (- to_line8 1)) (in_range5 (- to_line8 1)))))

;; H
  (assert (=> (= result8 true) (= result11 (mk_int__ref to_line8))))

;; H
  (assert (=> (= result8 true) (= to_line9 o2)))
...
;; H
  (assert (=> (= result8 true) (= to_line10 (mk_int__ref to_line9))))

;; H
  (assert (=> (= result8 true) (= cur_board11 (mk_map__ref1 cur_board10))))

;; H
  (assert (=> (= result8 true) (= to_line11 to_line9)))

;; H
  (assert (=> (= result8 true) (= cur_board12 cur_board10)))

;; H
  (assert (=> (not (= result8 true)) (= to_line10 (mk_int__ref to_line8))))
...
;; H
  (assert (=> (not (= result8 true)) (= to_line11 to_line8)))

;; H
  (assert (=> (not (= result8 true)) (= cur_board12 cur_board8)))

;; H
  (assert (not (= from_line2 1)))

;; H
  (assert (= result12 (mk_int__ref from_line2)))
