...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__a__rec__disc pred)))))
...
(declare-fun a__rec__disc__first__bit () Int)

(declare-fun a__rec__disc__last__bit () Int)

(declare-fun a__rec__disc__position () Int)
...
(declare-fun a__rec__a__first__bit () Int)

(declare-fun a__rec__a__last__bit () Int)

(declare-fun a__rec__a__position () Int)
...
(declare-fun a__rec__b__first__bit () Int)

(declare-fun a__rec__b__last__bit () Int)

(declare-fun a__rec__b__position () Int)
