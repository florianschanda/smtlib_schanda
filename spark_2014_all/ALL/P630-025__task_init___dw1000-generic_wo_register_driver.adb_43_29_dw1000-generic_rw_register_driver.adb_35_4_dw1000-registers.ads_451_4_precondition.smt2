...
(define-fun us_split_fields_Reserved__15__projection ((a us_split_fields)) bits_15
  (rec__dw1000__register_types__tc_sarc_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___59__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___59__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-const dw1000__register_types__tc_sarc_type__sar_ctrl__first__bit Int)

(declare-const dw1000__register_types__tc_sarc_type__sar_ctrl__last__bit Int)

(declare-const dw1000__register_types__tc_sarc_type__sar_ctrl__position Int)
...
(declare-const dw1000__register_types__tc_sarc_type__reserved__first__bit Int)

(declare-const dw1000__register_types__tc_sarc_type__reserved__last__bit Int)

(declare-const dw1000__register_types__tc_sarc_type__reserved__position Int)
...
(define-fun register_type__ref___140__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___99__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___99__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5454 us_t1)
  (temp___is_init_5451 Bool) (temp___skip_constant_5452 Bool)
  (temp___do_toplevel_5453 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5452 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5454)
                                       (last3 temp___expr_5454))
                                       (and (= (first3 temp___expr_5454) 1)
                                       (= (last3 temp___expr_5454) 2)))))
...
(define-fun target__ref___42__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___42__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_5471 us_t2)
  (temp___is_init_5468 Bool) (temp___skip_constant_5469 Bool)
  (temp___do_toplevel_5470 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5469 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_5471)
                                       (last5 temp___expr_5471))
                                       (and (= (first5 temp___expr_5471) 1)
                                       (= (last5 temp___expr_5471) 2)))))
...
(declare-const temp___8016 (Array Int bits_8))

(declare-const temp___80161 t2)

(declare-const temp___8017 (Array Int bits_8))

(declare-const temp___80171 t1)
...
(define-fun temp___80162 () us_t2 (mk___t2 temp___8016 temp___80161))
...
;; H
  (assert
  (and (= temp___80162 (register_to_bytes reg)) (dynamic_invariant1
  temp___80162 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80161)) (to_rep (last4 temp___80161)))
     (+ (- (to_rep (last4 temp___80161)) (to_rep (first4 temp___80161))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___8016 temp___8017))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80161)) (to_rep (last4 temp___80161)))
  temp___80171))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80171)) (to_rep (last2 temp___80171)))
     (+ (- (to_rep (last2 temp___80171)) (to_rep (first2 temp___80171))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8017 temp___80171)))
