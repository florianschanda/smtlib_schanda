...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__tc_sarc_type__sar_ctrl bits_1)(rec__dw1000__register_types__tc_sarc_type__reserved bits_15)))))
(define-fun us_split_fields_SAR_CTRL__projection ((a us_split_fields)) bits_1 
  (rec__dw1000__register_types__tc_sarc_type__sar_ctrl a))

(define-fun us_split_fields_Reserved15__projection ((a us_split_fields)) bits_15 
  (rec__dw1000__register_types__tc_sarc_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_59__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_59__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq7 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep2
                           (rec__dw1000__register_types__tc_sarc_type__sar_ctrl
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__tc_sarc_type__sar_ctrl
                                                  (us_split_fields1 b))))
                        (= (to_rep3
                           (rec__dw1000__register_types__tc_sarc_type__reserved
...
(declare-fun dw1000__register_types__tc_sarc_type__sar_ctrl__first__bit () Int)

(declare-fun dw1000__register_types__tc_sarc_type__sar_ctrl__last__bit () Int)

(declare-fun dw1000__register_types__tc_sarc_type__sar_ctrl__position () Int)

;; dw1000__register_types__tc_sarc_type__sar_ctrl__first__bit_axiom
  (assert (<= 0 dw1000__register_types__tc_sarc_type__sar_ctrl__first__bit))

;; dw1000__register_types__tc_sarc_type__sar_ctrl__last__bit_axiom
  (assert
  (< dw1000__register_types__tc_sarc_type__sar_ctrl__first__bit dw1000__register_types__tc_sarc_type__sar_ctrl__last__bit))

;; dw1000__register_types__tc_sarc_type__sar_ctrl__position_axiom
  (assert (<= 0 dw1000__register_types__tc_sarc_type__sar_ctrl__position))

(declare-fun dw1000__register_types__tc_sarc_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__tc_sarc_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__tc_sarc_type__reserved__position () Int)

;; dw1000__register_types__tc_sarc_type__reserved__first__bit_axiom
  (assert (<= 0 dw1000__register_types__tc_sarc_type__reserved__first__bit))

;; dw1000__register_types__tc_sarc_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__tc_sarc_type__reserved__first__bit dw1000__register_types__tc_sarc_type__reserved__last__bit))

;; dw1000__register_types__tc_sarc_type__reserved__position_axiom
  (assert (<= 0 dw1000__register_types__tc_sarc_type__reserved__position))

(declare-fun dummy6 () us_rep)

(declare-datatypes ()
((tc_sarc_type__ref (mk_tc_sarc_type__ref (tc_sarc_type__content us_rep)))))
(define-fun tc_sarc_type__ref___projection ((a tc_sarc_type__ref)) us_rep 
  (tc_sarc_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_140__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_99__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_99__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5366 us_t1)
  (temp___is_init_5363 Bool) (temp___skip_constant_5364 Bool)
  (temp___do_toplevel_5365 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5364 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5366)
                                       (last3 temp___expr_5366))
                                       (and (= (first3 temp___expr_5366) 1)
                                       (= (last3 temp___expr_5366) 2)))))
...
(define-fun target__ref_42__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_42__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_5383 us_t2)
  (temp___is_init_5380 Bool) (temp___skip_constant_5381 Bool)
  (temp___do_toplevel_5382 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5381 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_5383)
                                       (last5 temp___expr_5383))
                                       (and (= (first5 temp___expr_5383) 1)
                                       (= (last5 temp___expr_5383) 2)))))
...
(declare-fun temp___7866 () (Array Int bits_8))

(declare-fun temp___78661 () t2)

(declare-fun temp___7867 () (Array Int bits_8))

(declare-fun temp___78671 () t1)
...
(define-fun temp___78662 () us_t2 (mk___t2 temp___7866 temp___78661))
...
;; H
  (assert
  (and (= temp___78662 (register_to_bytes reg)) (dynamic_invariant1
  temp___78662 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78661)) (to_rep (last4 temp___78661)))
     (+ (- (to_rep (last4 temp___78661)) (to_rep (first4 temp___78661))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7866 temp___7867))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78661)) (to_rep (last4 temp___78661))) 
  temp___78671))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78671)) (to_rep (last2 temp___78671)))
     (+ (- (to_rep (last2 temp___78671)) (to_rep (first2 temp___78671))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7867 temp___78671)))
