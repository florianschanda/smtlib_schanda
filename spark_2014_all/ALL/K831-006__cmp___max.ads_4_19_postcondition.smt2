...
(declare-fun max__max__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun max__max__result1 () t)

(declare-fun max__max__result2 () t)

(declare-fun max__max__result3 () t)

(declare-fun max__max__result4 () t)

(declare-fun max__max__result5 () t)
...
;; H
  (assert (=> (lt left right) (= o right)))

;; H
  (assert (=> (not (lt left right)) (= o left)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (eq max__max__result4 right)))
(check-sat)
