...
(declare-const temp___264 unsigned_byte)

(declare-const temp___2641 unsigned_byte)
...
(declare-const temp___263 unsigned_byte)

(declare-const temp___2631 unsigned_byte)
...
(declare-const records__init_c__result6 us_rep)

(declare-const r__split_fields4 us_split_fields__ref)

(declare-const records__init_c__result7 pair__ref)

(declare-const r__split_fields5 us_split_fields)

(declare-const records__init_c__result8 us_rep)
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 11, characters 0-0
  (not
  (= (bool_eq (pair__content records__init_c__result7) null_pair) true)))
(check-sat)
(exit)
