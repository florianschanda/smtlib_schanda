...
;; H
  (assert
  (and (= o11 (get_previous_track o20 id1))
  (and (in_range1 o11)
  (= o11 (to_rep3
         (select (select previous_tracks (to_rep1
                                         (rec__trains__track__from
...
;; H
  (assert
  (=> (= result9 true)
  (and (= temp___375 (get_previous_track o19 id1))
...
;; H
  (assert
  (=> (= result9 true) (= o18 (select (map__content4 track_signals6) o17))))
