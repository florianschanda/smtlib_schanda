...
;; H
  (assert
  (and (= o13 (first (mk___rep l3__split_discrs l3__split_fields4)))
  (ite (= (= (length (mk___rep l3__split_discrs l3__split_fields4)) 0) true)
...
;; H
  (assert
  (and (= o14 (next (mk___rep l3__split_discrs l3__split_fields4) o13))
  (ite (= (ite (= (bool_eq1 o13 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      l3__split_discrs
                                                      l3__split_fields4))
                                                      o13) (length
                                                           (mk___rep
                                                           l3__split_discrs
                                                           l3__split_fields4))) true) true)
  (= (bool_eq1 o14 no_element) true)
  (and
  (= (has_key (positions (mk___rep l3__split_discrs l3__split_fields4)) o14) true)
  (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o14) (+
  (get1 (positions (mk___rep l3__split_discrs l3__split_fields4)) o13) 1))))))
