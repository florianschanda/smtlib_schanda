...
(declare-const c1__split_fields1 integer)

(declare-const c1__split_fields2 us_private)
...
(declare-const main__c1__assume1 integer)

(declare-const main__c1__assume2 us_private)

(declare-const main__c1__assume3 Int)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (less_than_max__2
     (mk___rep1
     (mk___split_fields1 c1__split_fields3 c1__split_fields4
     c1__split_fields5) c1__attr__tag)) true)))
(check-sat)
(exit)
