...
(declare-const temp___357 natural)

(declare-const temp___3571 us_main_type)

(declare-const temp___3572 Bool)
...
;; H
  (assert
  (and
  (= (mk___rep (mk___split_discrs temp___357) (mk___split_fields temp___3571)
     temp___3572) (new_with_default 0))
  (= (to_rep temp___357) 0)))
...
(assert
;; WP_parameter_def
 ;; File "discr.adb", line 125, characters 0-0
  (not (= temp___357 d__split_discrs)))
(check-sat)
(exit)
