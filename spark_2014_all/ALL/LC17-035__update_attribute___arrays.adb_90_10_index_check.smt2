...
;; def_axiom
  (assert
  (forall ((temp___355 us_t))
  (forall ((temp___356 Int) (temp___357 Int))
  (let ((temp___354 (temp___353 temp___355 temp___356 temp___357)))
  (and
  (and (= (first1 temp___354) (first1 temp___355))
  (= (last1 temp___354) (last1 temp___355)))
  (forall ((temp___358 Int))
  (ite (= temp___358 temp___356)
  (= (select (to_array temp___354) temp___358) (of_rep temp___357))
  (= (select (to_array temp___354) temp___358) (select (to_array temp___355) temp___358)))))))))
