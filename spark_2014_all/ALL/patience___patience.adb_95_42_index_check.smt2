...
;; H
  (assert
  (= o123 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o122)))
...
;; H
  (assert
  (= o120 (select (rec__patience__state__posstack
...
;; H
  (assert
  (=> (= result23 true)
  (= o113 (select (rec__patience__state__stacksizes
                  (us_split_fields__content s__split_fields20)) o112))))
...
;; H
  (assert
  (=> (= result23 true)
  (= o106 (select (rec__patience__state__posheight
