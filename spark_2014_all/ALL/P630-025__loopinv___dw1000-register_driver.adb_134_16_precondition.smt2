...
(define-fun dw1000__register_driver__write_register__B_6__header__assume6 () us_rep2
  (mk___rep2
  (mk___split_fields2
  dw1000__register_driver__write_register__B_6__header__assume
  dw1000__register_driver__write_register__B_6__header__assume1
  dw1000__register_driver__write_register__B_6__header__assume2
  dw1000__register_driver__write_register__B_6__header__assume3
  dw1000__register_driver__write_register__B_6__header__assume4
...
;; H
  (assert
  (= (to_rep2 o) ((_ extract 7 0) (bvudiv sub_address ((_ int2bv 16) 128)))))
...
;; H
  (assert
  (= (to_rep1 o2) ((_ extract 7 0) (bvand sub_address ((_ int2bv 16) 127)))))
...
;; H
  (assert
  (= dw1000__register_driver__write_register__B_6__header__assume6 (mk___rep2
                                                                   (mk___split_fields2
                                                                   temp___755
                                                                   temp___7551
                                                                   temp___7552
...
;; H
  (assert
  (= dw1000__register_driver__write_register__B_6__header__assume6 header2))

;; H
  (assert
  (let ((temp___633 header2))
  (and
  (= (to_rep5
     (rec__dw1000__register_driver__long_indexed_header__sub_index
     (us_split_fields5 temp___633))) 1)
  (= (to_rep6
     (rec__dw1000__register_driver__long_indexed_header__extended_address
     (us_split_fields5 temp___633))) 1))))
...
;; H
  (assert
  (let ((temp___716 header2))
  (and
  (= (to_rep5
     (rec__dw1000__register_driver__long_indexed_header__sub_index
     (us_split_fields5 temp___716))) 1)
  (= (to_rep6
     (rec__dw1000__register_driver__long_indexed_header__extended_address
     (us_split_fields5 temp___716))) 1))))
