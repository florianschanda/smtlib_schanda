...
(declare-fun mixed__rec__b__first__bit () Int)

(declare-fun mixed__rec__b__last__bit () Int)

(declare-fun mixed__rec__b__position () Int)
...
(declare-fun mixed__rec__e__first__bit () Int)

(declare-fun mixed__rec__e__last__bit () Int)

(declare-fun mixed__rec__e__position () Int)
...
(declare-fun mixed__rec__i__first__bit () Int)

(declare-fun mixed__rec__i__last__bit () Int)

(declare-fun mixed__rec__i__position () Int)
...
(declare-fun mixed__id__result () Bool)

(declare-fun mixed__id__result1 () enum_t)

(declare-fun mixed__id__result2 () integer)

(declare-fun result () Bool)

(declare-fun result1 () enum_t)

(declare-fun result2 () integer)

(declare-fun mixed__id__result3 () Bool)

(declare-fun mixed__id__result4 () enum_t)

(declare-fun mixed__id__result5 () integer)

(declare-fun mixed__id__result6 () Bool)

(declare-fun mixed__id__result7 () enum_t)

(declare-fun mixed__id__result8 () integer)

(declare-fun mixed__id__result9 () Bool)

(declare-fun mixed__id__result10 () enum_t)

(declare-fun mixed__id__result11 () integer)

(declare-fun mixed__id__result12 () Bool)

(declare-fun mixed__id__result13 () enum_t)

(declare-fun mixed__id__result14 () integer)

(declare-fun mixed__id__result15 () Bool)

(declare-fun mixed__id__result16 () enum_t)

(declare-fun mixed__id__result17 () integer)

(define-fun mixed__id__result18 () us_rep (mk___rep
                                          (mk___split_fields
                                          mixed__id__result3
                                          mixed__id__result4
                                          mixed__id__result5)))
...
;; H
  (assert
  (= (mk___rep
     (mk___split_fields mixed__id__result9 mixed__id__result10
     mixed__id__result11)) mixed__id__result18))
...
;; H
  ...
  (= (mk_rec____ref
     (mk___rep
     (mk___split_fields mixed__id__result12 mixed__id__result13
     mixed__id__result14))) (mk_rec____ref
                            (mk___rep
                            (mk___split_fields mixed__id__result6
                            mixed__id__result7 mixed__id__result8)))))
