...
;; H
  ...
  (= temp___879 (elements
                (mk___rep r__split_discrs
                (us_split_fields__content r__split_fields8))))
  (and
  (and
  (and
  (and
  (= (length2 temp___879) (length
                          (mk___rep r__split_discrs
                          (us_split_fields__content r__split_fields8))))
  (forall ((temp___425 Int))
  (=>
  (and (in_range2 temp___425)
  (= (iter_has_element temp___879 temp___425) true))
  (= (contains
     (model__
     (mk___rep r__split_discrs (us_split_fields__content r__split_fields8)))
     (get temp___879 temp___425)) true))))
  (forall ((item Int))
  (=>
  (and (in_range5 item)
  (= (contains
     ...
     (mk___rep r__split_discrs (us_split_fields__content r__split_fields8)))
     item) true))
  (and (< 0 (find temp___879 item))
  (= (get temp___879 (find temp___879 item)) item)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep r__split_discrs
        (us_split_fields__content r__split_fields8)))))
  (= (find temp___879 (get temp___879 i)) i))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
  ...
  (<= j (length
        (mk___rep r__split_discrs
        (us_split_fields__content r__split_fields8)))))
  (=> (= (get temp___879 i) (get temp___879 j)) (= i j)))))))))

;; H
  (assert
  (and (= o3 (iter_has_element temp___879 temp___878))
  (= (= o3 true) (and (<= 1 temp___878) (<= temp___878 (last temp___879))))))
