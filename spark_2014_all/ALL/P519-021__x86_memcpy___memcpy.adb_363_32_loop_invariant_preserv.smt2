...
;; H
  (assert
  (and (= (to_rep (select memory2 rdx2)) o28)
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
...
;; H
  (assert
  (and (= o29 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2))
  (and
  (and
  (and
  (and
...
;; H
  (assert
  (and (= o32 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2))
  (and
  (and
  (and
  (and
...
;; H
  (assert
  (and (= o35 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (and (= o39 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (not
  (and (not (= signflag5 true))
  (bvugt rax7 ((_ int2bv 64) 9223372036854775807)))) (= o40 false)))

;; H
  (assert
  (=> (= signflag5 true)
  (and (= o37 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2))
  (and
  (and
  (and
  (and
...
;; WP_parameter_def
 ;; File "x86.ads", line 334, characters 0-0
  (not (= saved_721 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2))))
(check-sat)
(exit)
