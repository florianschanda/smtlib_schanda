...
(declare-fun temp___449 () tcount_typeB)

(declare-fun temp___4491 () us_main_type)

(declare-fun temp___453 () Int)

(declare-fun temp___450 () Int)

(declare-fun temp___452 () us_rep1)

(declare-fun temp___451 () Int)

(declare-fun temp___448 () Int)

(declare-fun temp___455 () us_rep1)
...
(declare-fun v__split_fields6 () us_split_fields__ref)
...
;; H
  ...
  (div1
  (capacity (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
  2)))
...
;; H
  (assert
  (=> (and (<= first i2) (<= i2 r17b))
  (and (= v__split_discrs (mk___split_discrs temp___449))
  (= v__split_fields temp___4491))))
...
;; H
  (assert (=> (and (<= first i2) (<= i2 r17b)) (= temp___448 i2)))
...
;; H
  (assert
  (=> (and (<= first i2) (<= i2 r17b))
  (= (length (mk___rep v__split_discrs v__split_fields12)) (+ temp___450 (-
  i3 first)))))
...
;; H
  ...
  (=> (and (<= first i2) (<= i2 r17b))
  (forall ((j Int))
  (=> (and (<= first j) (<= j temp___451))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields12)) j) (get
                                                                    temp___452
                                                                    j))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= first j) (<= j (- i3 1)))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields12))
     (+ j temp___453)) (get temp___455 j))))))

;; H
  (assert
  (=> (and (<= first i2) (<= i2 r17b))
  (and
  (and (=> (<= first r17b) (dynamic_property6 first r17b i3))
  (dynamic_property2 0 last2
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))
  (and (<= first i3) (<= i3 r17b)))))

;; H
  (assert
  (=> (and (<= first i2) (<= i2 r17b))
  (and (= us i3) (dynamic_property1 first1 last1 i3))))
...
;; H
  ...
  (= (olt (model__ (mk___rep v__split_discrs v__split_fields12))
     (model__ (mk___rep v__split_discrs v__split_fields11))) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields11))
     (+ (last5 (model__ (mk___rep v__split_discrs v__split_fields12))) 1))
  o2)) (dynamic_property2 0 last2
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs))))))
...
;; H
  (assert
  (=> (and (<= first i2) (<= i2 r17b)) (= v__split_fields4 v__split_fields3)))
...
;; H
  (assert
  (=> (and (<= first i2) (<= i2 r17b))
  (= v__split_fields7 v__split_fields10)))

;; H
  (assert
  (=> (not (and (<= first i2) (<= i2 r17b))) (= i6 (mk_int__ref i2))))

;; H
  (assert
  (=> (not (and (<= first i2) (<= i2 r17b)))
  (= v__split_fields6 (mk___split_fields__ref
                      (mk___split_fields v__split_fields)))))
...
;; H
  (assert (and (= us1 i1) (dynamic_property3 first2 last3 i1)))
...
(assert
;; WP_parameter_def
 ;; File "use_vectors.ads", line 43, characters 0-0
  (not (<= first3 o3)))
(check-sat)
(exit)
