...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o45) true))
  (= (bool_eq3
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o45)) o45) true))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields)) o45) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (elements
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o45)
     (length
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o44) true))
  (= (bool_eq3
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o44)) o44) true))
  ...
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields1)) o44) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o44)
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o43) true)
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs
  ...
  (= (e_is_find
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o43
     (get1
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields))
