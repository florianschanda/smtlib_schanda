...
(define-fun tint_arrayD1__ref___5__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___5__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t128b__ref 0))
(((mk_t128b__ref (t128b__content integer)))))
...
(((mk_t129b__ref (t129b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___5__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___5__projection ((a number_array_type__ref)) us_t3
...
(((mk_t132b__ref (t132b__content integer)))))
...
(((mk_t133b__ref (t133b__content us_t4)))))
...
(((mk_t134b__ref (t134b__content integer)))))
...
(define-fun tint_arrayB__ref___5__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___5__projection ((a tnumber_array_typeB__ref)) us_t6
