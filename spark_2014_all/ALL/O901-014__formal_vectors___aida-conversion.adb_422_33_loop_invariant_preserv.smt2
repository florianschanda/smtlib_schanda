...
;; def_axiom
  (assert
  (forall ((temp___1326 Int) (temp___1327 Int) (temp___1328 Int)
  (temp___1329 Int) (temp___1330 Int) (temp___1331 Int) (temp___1332 Int)
  (temp___1333 Int) (temp___1334 Int) (temp___1335 Int) (temp___1336 Int)
  (temp___1337 Int))
  (let ((temp___1325 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def
                     temp___1326 temp___1327 temp___1328 temp___1329
                     temp___1330 temp___1331 temp___1332 temp___1333
                     temp___1334 temp___1335 temp___1336 temp___1337)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1336
  temp___1337)
  (and (= (first5 temp___1325) temp___1336)
  (= (last5 temp___1325) temp___1337)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1325) (+ (first1 source) 0)) (of_rep1
                                                            temp___1326))
  (= (select (to_array2 temp___1325) (+ (first1 source) 1)) (of_rep1
                                                            temp___1327)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 2)) (of_rep1
                                                            temp___1328)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 3)) (of_rep1
                                                            temp___1329)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 4)) (of_rep1
                                                            temp___1330)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 5)) (of_rep1
                                                            temp___1331)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 6)) (of_rep1
                                                            temp___1332)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 7)) (of_rep1
                                                            temp___1333)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 8)) (of_rep1
                                                            temp___1334)))
  (= (select (to_array2 temp___1325) (+ (first1 source) 9)) (of_rep1
                                                            temp___1335)))))))
...
;; def_axiom
  (assert
  (forall ((temp___1343 Int) (temp___1344 Int) (temp___1345 Int))
  (let ((temp___1342 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def
                     temp___1343 temp___1344 temp___1345)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1344
  temp___1345)
  (and (= (first9 temp___1342) temp___1344)
  (= (last9 temp___1342) temp___1345)))
  (forall ((temp___1346 Int))
  (= (select (to_array4 temp___1342) temp___1346) (of_rep1 temp___1343)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_239 us_t3)
  ...
  (temp___do_toplevel_238 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first7 temp___expr_239)
                                      (last7 temp___expr_239))
                                      (and
                                      (= (first7 temp___expr_239) (first1
                                                                  source))
                                      (= (last7 temp___expr_239) (+ (first1
                                                                    source) 9))))))
...
(declare-fun temp___1340 () (Array Int integer))

(declare-fun temp___13401 () t2)
...
(declare-fun temp___1348 () (Array Int integer))

(declare-fun temp___13481 () t4)
...
;; H
  (assert
  (= (mk___t2 temp___1340 temp___13401) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def
                                        2 1 4 7 4 7 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___13401)) (to_rep1 (last4 temp___13401)))
     (+ (- (to_rep1 (last4 temp___13401)) (to_rep1 (first4 temp___13401))) 1)
...
;; H
  (assert
  (= (slide1 temp___1340 (to_rep1 (first4 temp___13401))
...
;; H
  (assert
  (= (mk___t4 temp___1348 temp___13481) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___13481)) (to_rep1 (last8 temp___13481)))
     (+ (- (to_rep1 (last8 temp___13481)) (to_rep1 (first8 temp___13481))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1348 (to_rep1 (first8 temp___13481))
...
;; H
  (assert
  (and (= temp___1355 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 n__first) temp___1353)
  (<= temp___1353 (to_rep1 n__last)))
  (=> (< index2 temp___1353)
  (= (select n3 temp___1353) (select n1 temp___1353))))))
