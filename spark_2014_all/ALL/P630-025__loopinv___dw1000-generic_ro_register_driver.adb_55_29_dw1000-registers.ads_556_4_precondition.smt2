...
(define-fun us_split_fields__ref___80__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___80__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-datatypes ((lde_thresh_type__ref 0))
...
(define-fun register_type__ref___195__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___137__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___137__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6673 us_t1)
  (temp___is_init_6670 Bool) (temp___skip_constant_6671 Bool)
  (temp___do_toplevel_6672 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6671 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6673)
                                       (last3 temp___expr_6673))
                                       (and (= (first3 temp___expr_6673) 1)
                                       (= (last3 temp___expr_6673) 2)))))
