...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__lde_thresh_type__lde_thresh bits_16)))))
(define-fun us_split_fields_LDE_THRESH__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__lde_thresh_type__lde_thresh a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_80__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_80__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__lde_thresh_type__lde_thresh
...
(declare-fun dw1000__register_types__lde_thresh_type__lde_thresh__first__bit () Int)

(declare-fun dw1000__register_types__lde_thresh_type__lde_thresh__last__bit () Int)

(declare-fun dw1000__register_types__lde_thresh_type__lde_thresh__position () Int)

;; dw1000__register_types__lde_thresh_type__lde_thresh__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__lde_thresh_type__lde_thresh__first__bit))

;; dw1000__register_types__lde_thresh_type__lde_thresh__last__bit_axiom
  (assert
  (< dw1000__register_types__lde_thresh_type__lde_thresh__first__bit
  dw1000__register_types__lde_thresh_type__lde_thresh__last__bit))

;; dw1000__register_types__lde_thresh_type__lde_thresh__position_axiom
  (assert
  (<= 0 dw1000__register_types__lde_thresh_type__lde_thresh__position))
...
(declare-datatypes ()
((lde_thresh_type__ref
 (mk_lde_thresh_type__ref (lde_thresh_type__content us_rep)))))
(define-fun lde_thresh_type__ref___projection ((a lde_thresh_type__ref)) us_rep
  (lde_thresh_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_195__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_137__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_137__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6549 us_t1)
  (temp___is_init_6546 Bool) (temp___skip_constant_6547 Bool)
  (temp___do_toplevel_6548 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6547 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6549)
                                       (last3 temp___expr_6549))
                                       (and (= (first3 temp___expr_6549) 1)
                                       (= (last3 temp___expr_6549) 2)))))
