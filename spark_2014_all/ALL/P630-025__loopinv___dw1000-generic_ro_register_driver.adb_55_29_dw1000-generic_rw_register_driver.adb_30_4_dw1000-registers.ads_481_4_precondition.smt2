...
(define-fun register_type__ref_153__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_108__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_108__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5606 us_t1)
  (temp___is_init_5603 Bool) (temp___skip_constant_5604 Bool)
  (temp___do_toplevel_5605 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5604 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5606)
                                       (last3 temp___expr_5606))
                                       (and (= (first3 temp___expr_5606) 1)
                                       (= (last3 temp___expr_5606) 1)))))
