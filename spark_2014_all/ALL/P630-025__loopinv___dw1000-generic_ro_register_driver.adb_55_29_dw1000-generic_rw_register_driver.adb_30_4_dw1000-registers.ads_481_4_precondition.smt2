...
(define-fun register_type__ref___153__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___108__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___108__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5702 us_t1)
  (temp___is_init_5699 Bool) (temp___skip_constant_5700 Bool)
  (temp___do_toplevel_5701 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5700 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5702)
                                       (last3 temp___expr_5702))
                                       (and (= (first3 temp___expr_5702) 1)
                                       (= (last3 temp___expr_5702) 1)))))
