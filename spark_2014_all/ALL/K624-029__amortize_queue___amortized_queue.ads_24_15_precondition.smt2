...
;; H
  (assert
  (and (= o3 (length right)) (and (in_range6 o3) (<= o3 (capacity right)))))
...
;; H
  (assert
  (and (= o5 (length (vector__content amortized_queue__Oconcat__2__result5)))
  (and (in_range6 o5)
  (<= o5 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
