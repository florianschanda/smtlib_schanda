...
((us_split_fields2
 (mk___split_fields1
 (rec__base__ext__u__d integer)(rec__base__t__c1 integer)(rec__ext__1 us_private)))))
(define-fun us_split_fields_D__projection ((a us_split_fields2)) integer
  (rec__base__ext__u__d a))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (and
                         (= (to_rep
                            (rec__base__ext__u__d (us_split_fields3 a)))
                         (to_rep (rec__base__ext__u__d (us_split_fields3 b))))
...
(declare-fun base__ext__u__d__first__bit () Int)

(declare-fun base__ext__u__d__last__bit () Int)

(declare-fun base__ext__u__d__position () Int)

;; base__ext__u__d__first__bit_axiom
  (assert (<= 0 base__ext__u__d__first__bit))

;; base__ext__u__d__last__bit_axiom
  (assert (< base__ext__u__d__first__bit base__ext__u__d__last__bit))

;; base__ext__u__d__position_axiom
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range
  (+ (to_rep (rec__base__t__c1 (us_split_fields3 x))) (to_rep
                                                      (rec__base__ext__u__d
                                                      (us_split_fields3 x)))))))
(check-sat)
(exit)
