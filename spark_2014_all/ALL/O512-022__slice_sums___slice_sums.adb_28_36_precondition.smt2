...
(declare-fun o9 () slice_bounds)

(declare-fun hi_index1 () Int)
...
;; H
  ...
  (forall ((hi_index2 Int))
  (=>
  (and (<= (to_rep3 (first (rt x))) hi_index2)
  (<= hi_index2 (to_rep3 (last (rt x)))))
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index2)))) max_sum2))))))
...
;; H
  ...
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index2)))) max_sum3)))))
  (forall ((hi_index2 Int))
  (=> (and (<= (to_rep3 (first (rt x))) hi_index2) (<= hi_index2 (- hi2 1)))
  (<= (sum__logic x
      (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index2))))
  max_sum3)))))
...
;; H
  (assert (and (= o10 (- hi2 1)) (in_range1 (- hi2 1))))

;; H
  (assert (= o11 (ite (<= hi_index1 o10) true false)))

;; H
  (assert
  (= result4 (ite (<= (to_rep3 (first (rt x))) hi_index1) o11 false)))
...
;; H
  (assert (= (to_rep1 o6) hi_index))

;; H
  (assert (= (to_rep o7) lo_index))

;; H
  (assert (= o8 (mk___split_fields o7 o6)))

;; H
  (assert (= o9 (mk_slice_bounds o8)))
...
;; WP_parameter_def
 ;; File "sums.ads", line 12, characters 0-0
  (not
  (or
  (< (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o9))) (to_rep
                                                                   (rec__sums__slice_bounds__lo
                                                                   (us_split_fields1
                                                                   o9))))
  (and
  (<= (to_rep3 (first (rt x))) (to_rep
                               (rec__sums__slice_bounds__lo
                               (us_split_fields1 o9))))
  (<= (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o9))) (to_rep3
                                                                    (last
                                                                    (rt x))))))))
(check-sat)
(exit)
