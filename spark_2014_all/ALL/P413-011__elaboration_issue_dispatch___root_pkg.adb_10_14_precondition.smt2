...
(declare-fun extension_pkg__ext__flag__first__bit () Int)

(declare-fun extension_pkg__ext__flag__last__bit () Int)

(declare-fun extension_pkg__ext__flag__position () Int)
...
;; root_pkg__root__compat_axiom
  ...
  (forall ((x us_rep))
  (forall ((extension_pkg__body_elaborated Bool))
  (! (= (to_int1 (op x extension_pkg__body_elaborated)) (to_int1
                                                        (op1 us_tag x
                                                        extension_pkg__body_elaborated))) :pattern (
...
;; extension_pkg__ext__compat_axiom
  ...
  (forall ((x us_rep))
  (forall ((extension_pkg__body_elaborated Bool))
  (! (= (to_int1 (op2 (of_base x) extension_pkg__body_elaborated)) (to_int1
                                                                   (op1
                                                                   us_tag1 x
                                                                   extension_pkg__body_elaborated))) :pattern (
  (op1 us_tag1 x extension_pkg__body_elaborated)) ))))
...
;; extension_pkg__ext__compat_axiom
  ...
  (forall ((x us_rep1))
  (forall ((extension_pkg__body_elaborated Bool))
  (! (= (to_int1 (op2 x extension_pkg__body_elaborated)) (to_int1
                                                         (op3 us_tag1 x
                                                         extension_pkg__body_elaborated))) :pattern (
  (op3 us_tag1 x extension_pkg__body_elaborated)) ))))
...
;; WP_parameter_def
 ;; File "root_pkg.ads", line 9, characters 0-0
  (not (= (get1 (attr__tag y) y body_elaborated) true)))
(check-sat)
(exit)
