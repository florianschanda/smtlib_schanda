...
(declare-fun bounded_queue_v2__dequeue__item1 () Int)

(declare-fun bounded_queue_v2__dequeue__queue__fields1 () us_split_fields)
...
(declare-fun bounded_queue_v2__dequeue__item2 () Int)

(declare-fun bounded_queue_v2__dequeue__queue__fields2 () us_split_fields)
...
(declare-fun bounded_queue_v2__dequeue__item3 () Int)

(declare-fun bounded_queue_v2__dequeue__queue__fields3 () us_split_fields)
...
(declare-fun bounded_queue_v2__dequeue__item4 () Int)

(declare-fun bounded_queue_v2__dequeue__queue__fields4 () us_split_fields)
...
;; H
  ...
  (and
  (and
  (= bounded_queue_v2__dequeue__item1 (first_element
                                      (mk___rep my_queue__split_discrs
                                      (mk___split_fields
                                      (rec__bounded_queue_v2__queue_type__count1
  ...
  (= (size
     (mk___rep my_queue__split_discrs
     bounded_queue_v2__dequeue__queue__fields1)) (- (size
                                                    (mk___rep
                                                    my_queue__split_discrs
                                                    (mk___split_fields
                                                    (rec__bounded_queue_v2__queue_type__count1
                                                    ...
                                                    (mk1 1 100))))) 1)))
  (and (dynamic_invariant3
  (mk___rep my_queue__split_discrs bounded_queue_v2__dequeue__queue__fields1)
  true true true) (in_range5 bounded_queue_v2__dequeue__item1))))
...
;; H
  ...
  (and
  (and
  (= bounded_queue_v2__dequeue__item2 (first_element
                                      (mk___rep my_queue__split_discrs
                                      (mk___split_fields
                                      (rec__bounded_queue_v2__queue_type__count1
  ...
  (= (size
     (mk___rep my_queue__split_discrs
     bounded_queue_v2__dequeue__queue__fields2)) (- (size
                                                    (mk___rep
                                                    my_queue__split_discrs
                                                    (mk___split_fields
                                                    (rec__bounded_queue_v2__queue_type__count1
                                                    ...
                                                    (mk1 1 100))))) 1)))
  (and (dynamic_invariant3
  (mk___rep my_queue__split_discrs bounded_queue_v2__dequeue__queue__fields2)
...
;; H
  ...
  (and
  (and
  (= bounded_queue_v2__dequeue__item3 (first_element
                                      (mk___rep my_queue__split_discrs
                                      (mk___split_fields
                                      (rec__bounded_queue_v2__queue_type__count1
  ...
  (= (size
     (mk___rep my_queue__split_discrs
     bounded_queue_v2__dequeue__queue__fields3)) (- (size
                                                    (mk___rep
                                                    my_queue__split_discrs
                                                    (mk___split_fields
                                                    (rec__bounded_queue_v2__queue_type__count1
                                                    ...
                                                    (mk1 1 100))))) 1)))
  (and (dynamic_invariant3
  (mk___rep my_queue__split_discrs bounded_queue_v2__dequeue__queue__fields3)
  true true true) (in_range5 bounded_queue_v2__dequeue__item3))))
...
;; H
  ...
  (= my_queue__split_fields23 (mk___split_fields1
                              (rec__bounded_queue_v2__queue_type__count
                              bounded_queue_v2__dequeue__queue__fields3)
                              (rec__bounded_queue_v2__queue_type__front
                              bounded_queue_v2__dequeue__queue__fields3)
                              (rec__bounded_queue_v2__queue_type__rear
                              bounded_queue_v2__dequeue__queue__fields3)
...
;; H
  ...
  (and
  (and
  (= bounded_queue_v2__dequeue__item4 (first_element
                                      (mk___rep my_queue__split_discrs
                                      (mk___split_fields
                                      (rec__bounded_queue_v2__queue_type__count1
  ...
  (= (size
     (mk___rep my_queue__split_discrs
     bounded_queue_v2__dequeue__queue__fields4)) (- (size
                                                    (mk___rep
                                                    my_queue__split_discrs
                                                    (mk___split_fields
                                                    (rec__bounded_queue_v2__queue_type__count1
                                                    ...
                                                    (mk1 1 100))))) 1)))
  (and (dynamic_invariant3
  (mk___rep my_queue__split_discrs bounded_queue_v2__dequeue__queue__fields4)
...
;; H
  ...
  (= o (size
       (mk___rep my_queue__split_discrs
       (mk___split_fields
       (rec__bounded_queue_v2__queue_type__count1 my_queue__split_fields25)
       (rec__bounded_queue_v2__queue_type__front1 my_queue__split_fields25)
       (rec__bounded_queue_v2__queue_type__rear1 my_queue__split_fields25)
       (mk___t1
       (rec__bounded_queue_v2__queue_type__items1 my_queue__split_fields25)
       (mk1 1 100))))))
  (in_range4 o)))
