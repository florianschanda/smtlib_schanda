...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant f true true true) (dynamic_invariant1 (size f)
...
;; valid_root__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant f true true true) (dynamic_invariant2 i true
...
;; model____post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant f true true true) (dynamic_invariant2 root true
...
(declare-fun temp___599 () extended_index_type)

(declare-fun temp___5991 () extended_index_type)

(declare-fun temp___5992 () (Array Int us_rep))
...
;; H
  (assert
  (= (tree_structure
     (mk___rep1 (mk___split_fields1 temp___5991 temp___5992))) true))

;; H
  (assert
  (and (= o (size (mk___rep1 (mk___split_fields1 temp___5991 temp___5992))))
  (in_range1 o)))
...
;; H
  (assert (not (= (to_rep temp___599) 0)))

(assert
;; WP_parameter_def
 ;; File "search_trees.ads", line 311, characters 0-0
  (not (in_range (to_rep temp___599))))
(check-sat)
