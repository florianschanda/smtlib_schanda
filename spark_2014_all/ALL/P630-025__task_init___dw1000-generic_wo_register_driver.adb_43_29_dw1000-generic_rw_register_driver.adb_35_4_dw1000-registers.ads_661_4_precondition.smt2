...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80701)) (to_rep (last4 temp___80701))) 
  temp___80711))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80711)) (to_rep (last2 temp___80711)))
     (+ (- (to_rep (last2 temp___80711)) (to_rep (first2 temp___80711))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8071 temp___80711)))
