...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___82201)) (to_rep (last4 temp___82201)))
  temp___82211))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___82211)) (to_rep (last2 temp___82211)))
     (+ (- (to_rep (last2 temp___82211)) (to_rep (first2 temp___82211))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8221 temp___82211)))
