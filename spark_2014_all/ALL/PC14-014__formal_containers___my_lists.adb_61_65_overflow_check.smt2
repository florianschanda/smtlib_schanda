...
;; H
  (assert
  (and (= o7 (length (mk___rep l__split_discrs l__split_fields7)))
  (and (in_range2 o7)
...
;; H
  (assert
  (and (= o5 (get o4 (mk___rep1 d__split_fields5)))
  (and (in_range3 o5)
  (=> (= (of_int 0) true)
  (and (= o5 (w_get o4 (witness o4 (mk___rep1 d__split_fields5))))
  (forall ((k us_rep1))
  (=> (= (has_key o4 k) true)
  (= (= (bool_eq1 k (mk___rep1 d__split_fields5)) true)
  (= (witness o4 (mk___rep1 d__split_fields5)) (witness o4 k))))))))))
