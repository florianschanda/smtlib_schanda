...
(declare-fun records__is_valid_c__result () Bool)
...
(declare-fun temp___279 () unsigned_byte)

(declare-fun temp___2791 () unsigned_byte)
...
(declare-fun records__is_valid_c__result1 () Bool)

(declare-fun records__is_valid_c__result2 () Bool)

(declare-fun records__is_valid_c__result3 () Bool)

(declare-fun records__is_valid_c__result4 () Bool)

(declare-fun records__is_valid_c__result5 () Bool)
