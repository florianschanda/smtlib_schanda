...
(declare-const records__is_valid_c__result Bool)
...
(declare-const temp___279 unsigned_byte)

(declare-const temp___2791 unsigned_byte)
...
(declare-const records__is_valid_c__result1 Bool)

(declare-const records__is_valid_c__result2 Bool)

(declare-const records__is_valid_c__result3 Bool)

(declare-const records__is_valid_c__result4 Bool)

(declare-const records__is_valid_c__result5 Bool)
...
;; H
  (assert (= temp___279 o2))

;; H
  (assert (= temp___2791 o3))

;; H
  (assert
  (= (mk___rep (mk___split_fields temp___279 temp___2791)) null_pair))

;; H
  (assert (= records__is_valid_c__result1 records__is_valid_c__result2))

;; H
  (assert (= records__is_valid_c__result3 records__is_valid_c__result1))
...
;; H
  (assert (= result records__is_valid_c__result))

;; H
  (assert (= records__is_valid_c__result1 o10))

;; H
  (assert
  (= (mk_bool__ref records__is_valid_c__result4) (mk_bool__ref
                                                 records__is_valid_c__result2)))

;; H
  (assert (= records__is_valid_c__result5 records__is_valid_c__result3))

;; H
  (assert (= result1 records__is_valid_c__result4))

;; H
  (assert (= records__is_valid_c__result4 true))
