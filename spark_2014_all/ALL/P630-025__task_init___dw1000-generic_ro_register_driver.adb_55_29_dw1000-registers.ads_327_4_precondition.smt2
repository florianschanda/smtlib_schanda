...
(declare-datatypes ((bits_26__ref 0))
(((mk_bits_26__ref (bits_26__content bits_26)))))
...
(declare-datatypes ((ec_golp_type__ref 0))
(((mk_ec_golp_type__ref (ec_golp_type__content us_rep)))))
