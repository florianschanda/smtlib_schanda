...
;; H
  ...
  (and
  (= o7 (+ (to_rep4
           (rec__auditlog__logfilelistt__lasti usedlogfiles__split_fields5)) 1))
  (in_range7
  (+ (to_rep4
     (rec__auditlog__logfilelistt__lasti usedlogfiles__split_fields5)) 1))))
...
;; H
  ...
  (= o9 (mk___split_fields
        ...
        (rec__auditlog__logfilelistt__head usedlogfiles__split_fields5)
        o8 (rec__auditlog__logfilelistt__length usedlogfiles__split_fields5))))

;; H
  (assert (= temp___1187 (mk___rep o9)))

;; H
  (assert (= result6 (mk___split_fields__ref usedlogfiles__split_fields5)))

;; H
  (assert (= usedlogfiles__split_fields6 (us_split_fields1 temp___1187)))

;; H
  (assert
  (and
  (= o10 (+ (to_rep3
            (rec__auditlog__logfilelistt__length usedlogfiles__split_fields6)) 1))
  (in_range6
  (+ (to_rep3
     (rec__auditlog__logfilelistt__length usedlogfiles__split_fields6)) 1))))
...
;; H
  (assert (= temp___1189 (mk___rep o12)))

;; H
  (assert (= result7 (mk___split_fields__ref usedlogfiles__split_fields6)))

;; H
  (assert (= usedlogfiles__split_fields7 (us_split_fields1 temp___1189)))

;; H
  (assert (= result8 (mk_int__ref r97b)))
...
;; H
  (assert (in_range7 r97b1))

;; H
  (assert (and (= temp___1197 (+ j2 1)) (in_range10 (+ j2 1))))

;; H
  (assert (= result9 (mk_int__ref k)))

;; H
  (assert (= k1 r97b1))

;; H
  (assert (<= temp___1197 k1))
...
;; H
  ...
  (=> (<= temp___1196 k2)
  (= (select (rec__auditlog__logfilelistt__list usedlogfiles__split_fields8) temp___1196) (select
  (rec__auditlog__logfilelistt__list usedlogfiles__split_fields7) temp___1196)))))
