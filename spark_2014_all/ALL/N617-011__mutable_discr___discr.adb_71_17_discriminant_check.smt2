...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__discr__holder__content us_rep)))))
(define-fun us_split_fields_Content2__projection ((a us_split_fields)) us_rep
...
(declare-fun discr__holder__content__first__bit () Int)

(declare-fun discr__holder__content__last__bit () Int)

(declare-fun discr__holder__content__position () Int)
...
(define-fun td1S__ref_2__projection ((a td1S__ref)) us_rep (td1S__content a))
...
(declare-fun h__split_fields () natural)

(declare-fun h__split_fields1 () Bool)
...
(declare-fun discr__r5__d1__assume () natural)

(declare-fun discr__r5__d1__assume1 () Bool)

(declare-fun o8 () natural)

(declare-fun o9 () natural)

(declare-fun discr__r5__d2__assume () natural)

(declare-fun discr__r5__d2__assume1 () Bool)
...
(declare-fun d2__split_discrs1 () us_split_discrs)

(declare-fun result1 () us_split_fields__ref)

(declare-fun h__split_fields2 () us_split_fields)
