...
(((mk_map__ref (map__content (Array (_ BitVec 16) integer))))))
...
(((mk___t (elts (Array (_ BitVec 16) integer))(rt t)))))
...
(((mk_t21s__ref (t21s__content ar_index)))))
...
(((mk___t1 (elts1 (Array (_ BitVec 16) integer))(rt1 t1)))))
...
(declare-datatypes ((t23s__ref 0))
(((mk_t23s__ref (t23s__content ar_index)))))
...
(((mk___t2 (elts2 (Array (_ BitVec 16) integer))(rt2 t2)))))
...
(declare-datatypes ((t24s__ref 0)) (((mk_t24s__ref (t24s__content us_t2)))))
...
(((mk_t25s__ref (t25s__content ar_index)))))
...
(((mk___t3 (elts3 (Array (_ BitVec 16) integer))(rt3 t3)))))
...
(declare-datatypes ((t26s__ref 0)) (((mk_t26s__ref (t26s__content us_t3)))))
...
(((mk_t31s__ref (t31s__content ar_index)))))
...
(((mk___t4 (elts4 (Array (_ BitVec 16) integer))(rt4 t4)))))
...
(declare-datatypes ((t32s__ref 0)) (((mk_t32s__ref (t32s__content us_t4)))))
...
;; H
  ...
  (= (let ((temp___223 (to_model (mk___rep r__split_fields19))))
     (bool_eq (elts temp___223) (to_rep (first (rt temp___223)))
...
;; H
  ...
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields19)) x)))
     ...
     (bool_eq (elts temp___230) (to_rep (first (rt temp___230)))
...
;; H
  ...
  (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields17)))))
     ...
     (bool_eq (elts temp___234) (to_rep (first (rt temp___234)))
