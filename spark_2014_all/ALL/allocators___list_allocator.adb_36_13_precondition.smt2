...
;; H
  ...
  (and (= o3 (length model____split_fields))
  (and (in_range6 o3) (<= (+ 0 o3) 2147483647))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result4 (ite (< 0 o3) true false)))))
...
;; H
  ...
  (=> (not (= first_available 0))
  (=> (= result4 true)
  (and (= o2 (get model____split_fields 1)) (in_range7 o2))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result4 true) (= result (ite (= o2 first_available) true false))))))
