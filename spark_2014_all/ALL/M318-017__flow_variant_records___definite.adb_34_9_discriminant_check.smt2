...
(declare-const temp___161 status)

(declare-const temp___1611 natural)

(declare-const temp___1612 natural)

(declare-const temp___1613 Bool)

(declare-const temp___1614 Bool)
...
(declare-const temp___162 us_rep)
...
;; H
  (assert (=> (= x__attr__constrained true) (= temp___159 x__split_discrs)))

;; H
  (assert
  (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3)
     usq_4) (mk___rep (mk___split_discrs temp___159)
            (mk___split_fields temp___1591 temp___1592 temp___1593)
            temp___1594)))

;; H
  (assert (= usq_ temp___161))

;; H
  (assert (= usq_1 temp___1611))

;; H
  (assert (= usq_2 temp___1612))

;; H
  (assert (= usq_3 temp___1613))

;; H
  (assert (= x__attr__constrained temp___1614))
...
;; H
  (assert
  (= x__split_fields3 (mk___split_fields temp___1611 temp___1612 temp___1613)))
...
;; H
  (assert (= x__split_discrs1 (mk___split_discrs temp___161)))
...
;; H
  (assert (= temp___162 (mk___rep o11 (mk___split_fields o8 o9 o10) true)))
...
;; WP_parameter_def
 ;; File "definite.adb", line 22, characters 0-0
  (not
  (= (rec__definite__t__d (us_split_discrs1 temp___162)) g__split_discrs)))
(check-sat)
(exit)
