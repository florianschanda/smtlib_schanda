...
(define-fun bool_eq1 ((a (Array Int bits_8)) (a__first Int) (a__last Int)
...
(define-fun bool_eq3 ((a (Array (_ BitVec 8) us_rep1))
...
(declare-fun us_self__compl () (Array (_ BitVec 8) us_rep1))

(declare-fun us_self__compl1 () rx_frame_queue_index)

(declare-fun us_self__compl2 () natural)
...
(declare-fun us_self__compl5 () (Array (_ BitVec 8) us_rep1))

(declare-fun us_self__compl6 () rx_frame_queue_index)

(declare-fun us_self__compl7 () natural)

(declare-fun us_self__compl8 () Bool)

(declare-fun us_self__compl9 () Bool)
...
(declare-fun us_self__compl10 () (Array (_ BitVec 8) us_rep1))

(declare-fun us_self__compl11 () rx_frame_queue_index)

(declare-fun us_self__compl12 () natural)

(declare-fun us_self__compl13 () Bool)

(declare-fun us_self__compl14 () Bool)

(declare-fun receiver__split_fields5 () us_split_fields4)
...
(declare-fun receiver__split_fields6 () us_split_fields4)

(declare-fun us_self__compl15 () us_rep2)

(declare-fun result2 () us_split_fields__ref2)

(declare-fun receiver__split_fields7 () us_split_fields4)

(declare-fun result3 () us_split_fields__ref)

(declare-fun sys_status_clear__split_fields2 () us_split_fields)

(declare-fun receiver__split_fields8 () us_split_fields4)

(declare-fun us_self__compl16 () us_rep2)

(declare-fun result4 () us_split_fields__ref2)

(declare-fun receiver__split_fields9 () us_split_fields4)

(declare-fun result5 () us_split_fields__ref)

(declare-fun sys_status_clear__split_fields3 () us_split_fields)

(declare-fun receiver__split_fields10 () us_split_fields4)
...
;; H
  ...
  (dynamic_invariant (mk___rep2 receiver__split_fields6) true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= receiver__split_fields6 (mk___split_fields2 o37 o38 o39 o40 o41)))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (dynamic_invariant us_self__compl15 true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= result2 (mk___split_fields__ref2 receiver__split_fields6)))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= receiver__split_fields7 (us_split_fields5 us_self__compl15)))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true))
  (= receiver__split_fields7 (mk___split_fields2 receiver__split_fields
                             receiver__split_fields1 receiver__split_fields2
                             receiver__split_fields3 receiver__split_fields4)))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true))
  (= receiver__split_fields7 receiver__split_fields5))))
...
;; H
  ...
  (= (to_rep
     ...
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1))
  (= (let ((subject sys_status_clear__split_fields))
     sys_status_clear__split_fields2) (us_split_fields1 temp___4605))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (dynamic_invariant (mk___rep2 receiver__split_fields8) true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= receiver__split_fields8 (mk___split_fields2 o44 o45 o46 o47 o48)))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (dynamic_invariant us_self__compl16 true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= result4 (mk___split_fields__ref2 receiver__split_fields8)))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= receiver__split_fields9 (us_split_fields5 us_self__compl16)))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_sfd_timeout
     (us_split_fields11 (driver_type__content self__))) true))
  (= receiver__split_fields9 receiver__split_fields7))))
...
;; H
  ...
  (= (to_rep
     ...
     (let ((subject sys_status_reg__split_fields))
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1))
  (= result5 (let ((subject sys_status_clear__split_fields))
...
;; H
  ...
  (= (to_rep
     ...
     sys_status_reg__split_fields1))) ((_ int2bv 8) 1))
  (= (let ((subject sys_status_clear__split_fields))
     sys_status_clear__split_fields3) (us_split_fields1 temp___4607))))
...
;; H
  (assert (dynamic_invariant (mk___rep2 receiver__split_fields10) true true
  true))

;; H
  (assert
  (= receiver__split_fields10 (mk___split_fields2 o51 o52 o53 o54 o55)))
