...
;; H
  ...
  (<= i3 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i3) (get
                                                                    (model__
                                                                    (mk___rep
                                                                    l__split_discrs
                                                                    (mk___split_fields
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
     (mk___rep1 cu__split_fields3)) i2))
...
;; H
  ...
  (and
  (and (<= 1 (get1 o1 i3))
  (<= (get1 o1 i3) (length (mk___rep l__split_discrs l__split_fields2))))
  (forall ((j us_rep1))
  (=> (= (has_key o1 j) true)
  (=> (= (get1 o1 i3) (get1 o1 j)) (= (bool_eq1 i3 j) true))))))))))

(assert
;; WP_parameter_def
 ;; File "use_lists.ads", line 42, characters 0-0
  (not (= (has_key o1 (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
