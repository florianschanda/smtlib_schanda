...
(declare-fun o24 () us_rep5)

(declare-fun o25 () us_split_fields12)

(define-fun o26 () us_rep (mk___rep (mk___split_discrs o18 o19)
                          (mk___split_fields (mk___t1 o20 o21))))

(define-fun o27 () us_rep (mk___rep (mk___split_discrs o14 o15)
                          (mk___split_fields (mk___t1 o16 o17))))
...
;; H
  (assert
  (and (= o22 (to_rep1 (last (rt a)))) (in_range2 (to_rep1 (last (rt a))))))
...
;; H
  (assert (= (slide (elts a) (to_rep1 (first (rt a))) 1) o4))

;; H
  (assert (= (mk5 1 (to_rep1 (last (rt a)))) o5))
...
;; H
  (assert
  (= o27 (to_base5
         (mk___rep7 (mk___split_discrs o10 o11)
         (mk___split_fields7 (mk___t5 o12 o13))))))

;; H
  (assert (= o26 o27))

;; H
  (assert (= o24 (of_base3 o26)))

;; H
  (assert (= o25 (mk___split_fields6 o24 o23)))
