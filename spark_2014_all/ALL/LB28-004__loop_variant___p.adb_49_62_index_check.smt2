...
(define-fun tab22 () map__ref (mk_map__ref tab))
...
;; H
  (assert (=> (<= j1 b) (= (mk_map__ref result1) tab22)))
...
;; H
  (assert (= o19 (store (map__content tab18) o18 o17)))
...
;; H
  (assert (and (= o20 (+ j24 1)) (in_range1 (+ j24 1))))
...
;; H
  (assert (and (= o21 (- j26 1)) (in_range1 (- j26 1))))

;; H
  (assert (= o22 (ite (<= l o21) true false)))

;; H
  (assert (= result23 (ite (<= a l) o22 false)))
