...
(declare-fun alias__add__result () Int)
...
(declare-fun alias__add__result1 () Int)

(declare-fun alias__add__result2 () Int)

(declare-fun alias__add__result3 () Int)

(declare-fun alias__add__result4 () Int)

(declare-fun alias__add__result5 () Int)

;; H
  (assert (in_range x))

;; H
  (assert (= alias__add__result1 alias__add__result2))
...
;; H
  (assert (= (mk_int__ref result) (mk_int__ref alias__add__result)))

;; H
  (assert (= alias__add__result1 o1))

;; H
  (assert
  (= (mk_int__ref alias__add__result4) (mk_int__ref alias__add__result2)))

;; H
  (assert (= alias__add__result5 alias__add__result3))
