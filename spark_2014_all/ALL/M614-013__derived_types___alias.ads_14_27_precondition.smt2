...
(((mk_my_alias__ref (my_alias__content us_rep)))))
...
(declare-const alias__add__result3 Int)

(declare-const alias__add__result4 Int)

(declare-const alias__add__result5 Int)
