...
;; H
  (assert (= temp___206 (mk___rep1 result____split_discrs o10)))

;; H
  (assert (= result3 (mk___split_fields__ref1 result____split_fields3)))

;; H
  (assert (= result____split_fields4 (us_split_fields3 temp___206)))

;; H
  (assert (= result____split_discrs (us_split_discrs2 temp___206)))
