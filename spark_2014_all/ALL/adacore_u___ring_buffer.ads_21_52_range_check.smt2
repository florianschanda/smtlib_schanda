...
;; H
  (assert (and (= o6 (length s2)) (and (in_range4 o6) (<= (+ 0 o6) 100))))

;; H
  (assert (= o7 (- o6 1)))

;; H
  (assert (and (= o8 (length s1)) (and (in_range4 o8) (<= (+ 0 o8) 100))))

;; H
  (assert (= result1 (ite (= o8 o7) true false)))

;; H
  (assert (=> (= result1 true) (and (= o5 (get s2 1)) (in_range5 o5))))

;; H
  (assert (=> (= result1 true) (= result (ite (= o5 e) true false))))
...
;; H
  (assert (and (= o4 (get s2 o3)) (in_range5 o4)))
