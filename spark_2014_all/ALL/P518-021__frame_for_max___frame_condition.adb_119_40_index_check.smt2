...
(define-fun dynamic_invariant ((temp___expr_145 us_t)
...
;; H
  (assert
  (and (= (to_rep1 (first (rt old_a))) (to_rep1 a__first))
  (= (to_rep1 (last (rt old_a))) (to_rep1 a__last))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt old_a))) i)
  (<= i (to_rep1 (last (rt old_a))))))
...
;; H
  (assert
  (= (mk___rep (mk___split_fields o1 o2 o3)) (select (elts old_a) o)))
...
(assert
;; WP_parameter_def
 ;; File "frame_condition.adb", line 118, characters 0-0
