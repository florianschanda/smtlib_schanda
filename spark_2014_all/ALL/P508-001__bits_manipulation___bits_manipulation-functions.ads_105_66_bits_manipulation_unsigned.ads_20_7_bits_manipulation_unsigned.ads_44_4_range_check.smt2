...
;; H
  ...
  (= o (ite (and (<= 1 32) (<= 32 8))
       ((_ zero_extend 24) (ite (< n 8)
                           (bvlshr ((_ extract 7 0) val__) ((_ int2bv 8)
                           n)) ((_ int2bv 8) 0)))
       (ite (and (<= 9 32) (<= 32 16))
       ((_ zero_extend 16) (ite (< n 16)
                           (bvlshr ((_ extract 15 0) val__) ((_ int2bv 16)
                           n)) ((_ int2bv 16) 0)))
       (ite (and (<= 17 32) (<= 32 32)) (bvlshr val__ ((_ int2bv 32)
       n))
       ((_ extract 31 0) (bvlshr ((_ zero_extend 32) val__) ((_ int2bv 64)
       n)))))))))

;; H
  (assert (= result1 (ite (= o ((_ int2bv 32) 1)) true false)))
