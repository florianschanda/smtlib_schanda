...
(declare-fun dummy4 () less_than_max)
...
(declare-fun dummy5 () (Array Int element))
...
(declare-fun user_eq11 (t42s t42s) Bool)

(declare-fun dummy12 () t42s)

(declare-datatypes () ((t42s__ref (mk_t42s__ref (t42s__content t42s)))))
(define-fun t42s__ref___projection ((a t42s__ref)) t42s (t42s__content a))
...
(declare-fun user_eq12 (t21s t21s) Bool)

(declare-fun dummy13 () t21s)
...
(declare-fun user_eq13 (telement_arrayD1 telement_arrayD1) Bool)

(declare-fun dummy14 () telement_arrayD1)
