...
(define-fun dynamic_invariant ((temp___expr_313 Int)
  ...
  (temp___do_toplevel_312 Bool)) Bool (=>
                                      ...
                                      (<= 0 43)) (in_range9 temp___expr_313)))
...
(define-fun dynamic_invariant1 ((temp___expr_319 Int)
  ...
  (temp___do_toplevel_318 Bool)) Bool (=>
                                      ...
                                      (<= 0 2)) (in_range10 temp___expr_319)))
...
(declare-datatypes ()
((elementtexti__ref
 (mk_elementtexti__ref (elementtexti__content elementtexti)))))
(define-fun elementtexti__ref___projection ((a elementtexti__ref)) elementtexti
  (elementtexti__content a))
...
;; def_axiom
  ...
  (= (select (auditlog__noelement__aggregate_def temp___160) temp___161)
  (of_rep temp___160)))))
...
(define-fun dynamic_invariant10 ((temp___expr_233 Int)
  ...
  (temp___do_toplevel_232 Bool)) Bool (=>
                                      ...
                                      (<= 1 12)) (in_range5 temp___expr_233)))
...
(define-fun dynamic_invariant11 ((temp___expr_239 Int)
  ...
  (temp___do_toplevel_238 Bool)) Bool (=>
                                      ...
                                      (<= 1 31)) (in_range6 temp___expr_239)))
...
(define-fun dynamic_invariant13 ((temp___expr_279 Int)
  ...
  (temp___do_toplevel_278 Bool)) Bool (=>
                                      ...
                                      (<= 1 21)) (in_range8 temp___expr_279)))
...
;; H
  (assert
  (= (ite (<= (to_rep1
              (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))
     (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))))
     (+ (- (to_rep1
           (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))
     (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) 1)
     0) (ite (<= 1 (to_rep1
                   (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))))
        (+ (- (to_rep1
              (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) 1) 1)
        0)))

;; H
  (assert
  (= (slide (elts (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))
     (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) 1)
  temp___1376))
...
;; H
  (assert
  (=>
  (<= 1 (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))))
  (and (and (<= 1 1) (<= 1 20))
  (and
  (<= 1 (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))))
  (<= (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) 20)))))

;; H
  (assert (= o3 elementtext1))

;; H
  (assert (= o3 temp___1379))
