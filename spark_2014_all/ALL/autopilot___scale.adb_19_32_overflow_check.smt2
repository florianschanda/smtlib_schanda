...
;; H
  (assert (and (= o1 (+ flatness val__)) (in_range1 (+ flatness val__))))

;; H
  (assert (and (= o (* 100 flatness)) (in_range1 (* 100 flatness))))
...
(assert
;; WP_parameter_def
 ;; File "scale.adb", line 8, characters 0-0
  (not (in_range1 o2)))
(check-sat)
(exit)
