...
;; H
  (assert
  (and (= o33 (remove (mk___t values2 (mk 1 100)) o24))
...
;; H
  (assert
  (and (= temp___2502 (remove o33 o27))
...
;; H
  (assert
  (and (= o32 (remove (mk___t interm1 (mk 1 100)) o28))
  (and (dynamic_invariant4 o32 true false true)
  (and (= (invariant__ o32) true)
  (and (= (to_rep1 (last o30)) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o28 1)))
  (= (to_rep (select interm1 k)) (to_rep (select o29 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o28 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select interm1 k)) (to_rep (select o29 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o28 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select interm1 (+ k 1))) (to_rep (select o29 k))))))))))))
