...
;; H
  (assert
  (and
  (= temp___6474 (to_string1 ptr4 hash_table
                 (mk___split_fields char_table__split_fields)
                 (mk___split_fields1 entry_table__split_fields)))
  (dynamic_invariant temp___6474 true false true)))

;; H
  (assert
  (= result6 (bool_eq temp___6472 (to_rep1 (first temp___6473))
             (to_rep1 (last temp___6473)) (elts s) (to_rep1 (first (rt s)))
             (to_rep1 (last (rt s))))))
