...
(declare-datatypes ()
((tTxSP1__ref (mk_tTxSP1__ref (tTxSP1__content integer)))))
(define-fun tTxSP1__ref___projection ((a tTxSP1__ref)) integer (tTxSP1__content
                                                               a))
...
;; mk_def
  ...
  (! (=> (in_range f1)
     (=> (in_range l)
     (and (= (to_rep1 (first (mk f1 l))) f1)
     (= (to_rep1 (last (mk f1 l))) l)))) :pattern ((mk f1 l)) )))
...
(define-fun of_array ((a (Array Int character)) (f1 Int)
...
;; mk_def
  ...
  (! (=> (in_range f1)
     (=> (in_range l)
     (and (= (to_rep1 (first2 (mk1 f1 l))) f1)
     (= (to_rep1 (last2 (mk1 f1 l))) l)))) :pattern ((mk1 f1 l)) )))
...
(define-fun of_array1 ((a (Array Int character)) (f1 Int)
...
;; mk_def
  ...
  (! (=> (in_range f1)
     (=> (in_range l)
     (and (= (to_rep1 (first4 (mk2 f1 l))) f1)
     (= (to_rep1 (last4 (mk2 f1 l))) l)))) :pattern ((mk2 f1 l)) )))
...
(define-fun of_array2 ((a (Array Int character)) (f1 Int)
...
;; def_axiom
  ...
  (let ((temp___177 (dyn__x__aggregate_def temp___178 temp___179 temp___180)))
  (and
  (=> (dynamic_property4 1 2147483647 temp___179 temp___180)
  (and (= (first3 temp___177) temp___179) (= (last3 temp___177) temp___180)))
  (forall ((temp___181 Int))
  (= (select (to_array1 temp___177) temp___181) (of_rep temp___178)))))))
...
(define-fun dynamic_invariant3 ((temp___expr_171 us_t)
  ...
  (temp___do_toplevel_170 Bool)) Bool (=>
                                      ...
                                      (and (dynamic_property1 r1b r2b
                                      (first1 temp___expr_171)
                                      (last1 temp___expr_171))
                                      (and (= (first1 temp___expr_171)
                                      r1b) (= (last1 temp___expr_171)
                                      r2b)))))

(declare-fun dyn__R1b__assume () Int)

(declare-fun dyn__R2b__assume () Int)

;; H
  (assert
  (and (= dyn__R1b__assume (f Tuple0))
  (and (in_range dyn__R1b__assume) (= dyn__R1b__assume 1))))
...
;; H
  (assert
  (and (= dyn__R2b__assume (f Tuple0))
  (and (in_range dyn__R2b__assume) (= dyn__R2b__assume 1))))
...
(assert
;; WP_parameter_def
 ;; File "dyn.adb", line 2, characters 0-0
  (not (<= 1 r1b)))
(check-sat)
(exit)
