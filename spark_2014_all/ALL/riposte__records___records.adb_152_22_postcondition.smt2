...
(define-fun dst__split_fields13 () us_split_fields2 (mk___split_fields1
                                                    dst__split_fields6
                                                    (mk___rep
                                                    (mk___split_fields
                                                    dst__split_fields7
...
;; H
  (assert
  (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src))
  dst__split_fields3))
...
;; H
  (assert
  (=>
  (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true)
  (= result3 dst__split_fields3)))

;; H
  (assert
  (=>
  (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true)
  (= result4 dst__split_fields4)))

;; H
  (assert
  (=>
  (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true)
  (= result5 dst__split_fields5)))

;; H
  (assert
  (=>
  (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true)
  (= dst__split_fields3 dst__split_fields6)))
...
;; H
  ...
  (not
  (= (rec__records_prooffuncs__optional_pair__exists (us_split_fields3 src)) true))
  (= dst__split_fields13 (mk___split_fields1 dst__split_fields3
                         (mk___rep
                         (mk___split_fields dst__split_fields4
                         dst__split_fields5))))))
