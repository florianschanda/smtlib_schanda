...
(declare-fun dummy () tindex_tB)

(declare-datatypes ()
((tindex_tB__ref (mk_tindex_tB__ref (tindex_tB__content tindex_tB)))))
(define-fun tindex_tB__ref___projection ((a tindex_tB__ref)) tindex_tB
  (tindex_tB__content a))
