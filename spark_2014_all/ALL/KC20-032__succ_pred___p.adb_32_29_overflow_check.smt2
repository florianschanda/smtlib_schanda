...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int1 x) 0)
     (ite (< 0 x) (pos_div_relation (to_int1 x) x 8) (pos_div_relation
     (- (to_int1 x)) (- x) 8))) :pattern ((to_int1 x)) )))
...
(declare-datatypes ((tvoltB__ref 0))
(((mk_tvoltB__ref (tvoltB__content tvoltB)))))
(define-fun tvoltB__ref___projection ((a tvoltB__ref)) tvoltB (tvoltB__content
                                                              a))
...
;; fxp_mult_def
  ...
  (! (ite (or (= x 0) (= y 0)) (= (fxp_mult1 x y) 0)
     ...
     (fxp_mult1 x y) (* x y) 8) (pos_div_relation1 (- (fxp_mult1 x y))
     (- (* x y)) 8))) :pattern ((fxp_mult1 x y)) ))))
...
;; fxp_div_def
  ...
  (! (ite (= x 0) (= (fxp_div1 x y) 0)
     (ite (and (< 0 x) (< 0 y)) (pos_div_relation1 (fxp_div1 x y) (* x 8) y)
     (ite (and (< x 0) (< y 0)) (pos_div_relation1 (fxp_div1 x y) (* (- x) 8)
     (- y))
     (ite (and (< x 0) (< 0 y)) (pos_div_relation1 (- (fxp_div1 x y))
     (* (- x) 8) y)
     (=> (and (< 0 x) (< y 0)) (pos_div_relation1 (- (fxp_div1 x y)) (* x 8)
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int2 x) 0)
     (ite (< 0 x) (pos_div_relation1 (to_int2 x) x 8) (pos_div_relation1
...
(declare-datatypes ((volt__ref 0)) (((mk_volt__ref (volt__content volt)))))
