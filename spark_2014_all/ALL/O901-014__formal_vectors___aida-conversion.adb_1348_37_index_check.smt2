...
;; H
  (assert
  (and (= o29 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert (= o30 (ite (<= index o29) true false)))

;; H
  (assert
  (and (= o28 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert (= o31 (ite (<= o28 index) true false)))
...
;; H
  ...
  (forall ((index1 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 10) index1)
  (<= index1 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index1))) true)))))

;; H
  (assert
  (and (= temp___1825 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1825)
  (<= temp___1825 (to_rep1 (last (rt source))))))

;; H
  (assert (= o24 temp___1825))
...
;; H
  (assert (= o27 (ite (< o26 57) true false)))

;; H
  (assert
  (and (= temp___1824 (+ (to_rep1 (first (rt source))) 9)) (in_range1
...
;; H
  (assert (= o23 (ite (= o22 52) true false)))

;; H
  (assert
  (and (= temp___1823 (+ (to_rep1 (first (rt source))) 8)) (in_range1
...
;; H
  (assert
  (and (= temp___1822 (+ (to_rep1 (first (rt source))) 7)) (in_range1
...
;; H
  (assert
  (and (= temp___1821 (+ (to_rep1 (first (rt source))) 6)) (in_range1
...
;; H
  (assert
  (and (= temp___1820 (+ (to_rep1 (first (rt source))) 5)) (in_range1
...
;; H
  (assert
  (and (= temp___1819 (+ (to_rep1 (first (rt source))) 4)) (in_range1
...
;; H
  (assert
  (and (= temp___1818 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1111, characters 0-0
  (not (<= (to_rep1 (first (rt source))) temp___1818)))
(check-sat)
(exit)
