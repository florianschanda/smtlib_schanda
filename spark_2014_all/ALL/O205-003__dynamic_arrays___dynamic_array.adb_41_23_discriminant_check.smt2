...
(declare-fun o28 () us_split_discrs)
...
;; H
  (assert
  (and (= o21 (new_holder c))
  (and (dynamic_invariant2 o21 true false true)
  (ite (= c 0)
  (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21))) 0)
  (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o21)))
  c)))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt temp___218))) j)
  (<= j (to_rep1 (last1 (rt temp___218))))))
...
;; H
  (assert
  (and (= o25 (increment o24))
  (and (in_range2 o25)
  (= o25 (ite (= (rec__dynamic_array__rec__b (us_split_discrs1 o24)) true)
         (ite (< (to_rep1
                 (rec__dynamic_array__rec__f1 (us_split_fields1 o24)))
         c)
         (+ (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o24))) 1)
         (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o24))))
         (ite (< (to_rep1
                 (rec__dynamic_array__rec__f2 (us_split_fields1 o24)))
         c)
         (+ (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o24))) 1)
         (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o24)))))))))
...
;; WP_parameter_def
 ;; File "dynamic_array.adb", line 31, characters 0-0
  (not (= (to_int1 (rec__dynamic_array__rec__b (us_split_discrs1 o20))) 1)))
(check-sat)
(exit)
