...
(define-fun o4 () us_rep1 (mk___rep1 (mk___split_fields1 o)))
...
;; H
  ...
  (not (= (has_key (positions l) o4) true))
  (=>
  (exists ((cu2 us_rep1))
  (and (= (has_key (positions l) cu2) true) (= (element l cu2) 0)))
  (and (= (element l o4) 0)
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (- (get (positions l) o4) 1)))
...
;; H
  (assert (= lists__search2__result7 o4))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not
  (= (has_key o3 (mk___rep1 (mk___split_fields1 lists__search2__result4))) true)))
(check-sat)
(exit)
