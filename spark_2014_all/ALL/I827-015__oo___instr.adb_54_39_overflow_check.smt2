...
(declare-datatypes ((tTs1SP1__ref 0))
(((mk_tTs1SP1__ref (tTs1SP1__content integer)))))
...
(declare-datatypes ((ts1S__ref 0)) (((mk_ts1S__ref (ts1S__content us_t1)))))
...
(declare-datatypes ((tTs2SP1__ref 0))
(((mk_tTs2SP1__ref (tTs2SP1__content integer)))))
...
(define-fun bool_eq9 ((x1 us_t3)
  (y us_t3)) Bool (bool_eq (elts3 x1) (to_rep1 (first6 (rt3 x1)))
...
(declare-datatypes ((ts2S__ref 0)) (((mk_ts2S__ref (ts2S__content us_t3)))))
...
(define-fun bool_eq10 ((x1 us_t4)
  (y us_t4)) Bool (bool_eq (elts4 x1) (to_rep1 (first8 (rt4 x1)))
