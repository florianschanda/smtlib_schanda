...
(declare-fun temp___3644 ((Array Int us_rep) Int us_rep Int
  us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___3646 (Array Int us_rep)))
  (forall ((temp___3647 Int) (temp___3649 Int))
  (forall ((temp___3648 us_rep) (temp___3650 us_rep))
  (let ((temp___3645 (temp___3644 temp___3646 temp___3647 temp___3648
                     temp___3649 temp___3650)))
  (forall ((temp___3651 Int))
  (ite (= temp___3651 temp___3649)
  (= (select temp___3645 temp___3651) temp___3650)
  (ite (= temp___3651 temp___3647)
  (= (select temp___3645 temp___3651) temp___3648)
  (= (select temp___3645 temp___3651) (select temp___3646 temp___3651))))))))))

(declare-fun temp___3652 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3654 (Array Int et1)))
  (forall ((temp___3655 Int) (temp___3656 Int))
  (let ((temp___3653 (temp___3652 temp___3654 temp___3655 temp___3656)))
  (forall ((temp___3657 Int))
  (ite (= temp___3657 temp___3655)
  (= (select temp___3653 temp___3657) (of_rep temp___3656))
  (= (select temp___3653 temp___3657) (select temp___3654 temp___3657))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1673, characters 0-0
  (not
  (= (bool_eq2 a3 1 16
     (temp___3644 a i
     (mk___rep
     (mk___split_fields
     (temp___3652 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e)
