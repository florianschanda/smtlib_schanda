...
;; H
  ...
  (= o6 (ite (= (to_rep1 (select logfileentries3 currentlogfile3)) (+
...
;; H
  (assert
  (=> (= (to_rep1 (select logfileentries3 currentlogfile)) 1024)
  (= o5 (ite (= (to_rep1 (select logfileentries3 currentlogfile3)) 1)
        (ite (= (to_rep2 usedlogfiles__split_fields15) (+ (to_rep2
                                                          usedlogfiles__split_fields3) 1))
        true false) false))))
...
;; H
  (assert (= o4 (+ o3 (to_rep1 (select logfileentries3 currentlogfile3)))))
