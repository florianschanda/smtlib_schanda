...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= current1 j1) (<= j1 limit))
  (<= (to_rep (select values o)) (to_rep (select values j1)))))))))
...
;; H
  ...
  (and
  (and
  (= (to_rep (select values2 current1)) (to_rep (select values smallest1)))
  (= (to_rep (select values2 smallest1)) (to_rep (select values current1))))
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 64))
  (=> (and (not (= j1 current1)) (not (= j1 smallest1)))
