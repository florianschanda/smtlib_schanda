...
(define-fun dynamic_invariant2 ((temp___expr_138 us_t)
...
;; H
  (assert
  (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))
  (and (= o i1) (in_range2 i1))))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))
  (and (= (to_rep (select a2 o)) 0)
  (forall ((j Int))
  (=> (and (<= (to_rep a__first) j) (<= j (to_rep a__last)))
  (=> (not (= o j)) (= (to_rep (select a2 j)) (to_rep (select a j)))))))))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))
  (forall ((j Int))
  (=> (and (<= (to_rep a__first) j) (<= j i2)) (= (to_rep (select a3 j)) 0)))))

;; H
  (assert
  (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))
  (and
  (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1
  (to_rep a__first) (to_rep a__last) i2))
...
;; H
  (assert
  (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a3 a4)))
...
;; H
  (assert
  (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a5 a3)))
...
;; H
  (assert
  (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a7 a5)))
