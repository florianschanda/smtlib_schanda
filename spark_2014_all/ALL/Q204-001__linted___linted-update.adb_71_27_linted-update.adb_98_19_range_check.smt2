...
(define-fun y12 () t__ref1 (mk_t__ref1 y3))

(define-fun y13 () t__ref1 (mk_t__ref1 y2))

(define-fun y14 () t__ref1 (mk_t__ref1 y1))
...
;; H
  (assert (=> (not (< c206b 0)) (= y5 o5)))

;; H
  (assert (=> (not (< c206b 0)) (= y4 y5)))
...
;; H
  (assert (=> (< c216b 0) (= result3 y14)))

;; H
  (assert (=> (< c216b 0) (= y6 o9)))
...
;; H
  (assert (=> (not (< c216b 0)) (= result4 y14)))

;; H
  (assert (=> (not (< c216b 0)) (= y7 o11)))

;; H
  (assert (=> (not (< c216b 0)) (= y6 y7)))
...
;; H
  (assert (=> (< c226b 0) (= result6 y13)))

;; H
  (assert (=> (< c226b 0) (= y8 o15)))
...
;; H
  (assert (=> (not (< c226b 0)) (= result7 y13)))

;; H
  (assert (=> (not (< c226b 0)) (= y9 o17)))

;; H
  (assert (=> (not (< c226b 0)) (= y8 y9)))
...
;; H
  (assert (=> (< c236b 0) (= result9 y12)))

;; H
  (assert (=> (< c236b 0) (= y10 o21)))
...
;; H
  (assert (=> (not (< c236b 0)) (= result10 y12)))

;; H
  (assert (=> (not (< c236b 0)) (= y11 o23)))

;; H
  (assert (=> (not (< c236b 0)) (= y10 y11)))
