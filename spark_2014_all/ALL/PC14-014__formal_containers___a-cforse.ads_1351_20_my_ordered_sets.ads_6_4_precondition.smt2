...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (=>
     (and (in_range5 temp___387)
     (= (iter_has_element result temp___387) true))
     (= (contains (model__ container1) (get1 result temp___387)) true))))
     (forall ((item Int))
...
(define-fun dynamic_invariant5 ((temp___expr_340 Int)
...
(declare-const temp___913 count_type)
...
;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___913)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 1330, characters 0-0
  (not
