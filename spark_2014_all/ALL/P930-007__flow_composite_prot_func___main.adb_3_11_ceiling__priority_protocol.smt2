...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__p__pr__c pt)))))
(define-fun us_split_fields_C__projection ((a us_split_fields)) pt (rec__p__pr__c
                                                                   a))
...
(declare-fun p__pr__c__first__bit () Int)

(declare-fun p__pr__c__last__bit () Int)

(declare-fun p__pr__c__position () Int)
