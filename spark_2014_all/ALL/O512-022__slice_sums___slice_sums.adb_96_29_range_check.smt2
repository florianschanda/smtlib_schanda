...
;; H
  (assert (< max_sum2 current_sum3))

;; H
  (assert (and (= o6 current_sum3) (in_range2 current_sum3)))

;; H
  (assert (= result6 (mk_int__ref max_sum2)))

;; H
  (assert (= max_sum3 o6))

;; H
  (assert (= (to_rep1 o7) current_lo2))
...
;; H
  (assert (= temp___178 (mk_slice_bounds o8)))

;; H
  (assert (= result7 (mk___split_fields__ref result____split_fields3)))

;; H
  (assert (= result____split_fields4 (us_split_fields1 temp___178)))

(assert
;; WP_parameter_def
 ;; File "sums.ads", line 12, characters 0-0
  (not (in_range5 current_hi2)))
(check-sat)
(exit)
