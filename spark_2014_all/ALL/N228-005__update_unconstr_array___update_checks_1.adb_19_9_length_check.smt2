...
(declare-datatypes ()
((tS3bP1__ref (mk_tS3bP1__ref (tS3bP1__content tindexB)))))
(define-fun tS3bP1__ref___projection ((a tS3bP1__ref)) tindexB (tS3bP1__content
                                                               a))
...
;; def_axiom
  (assert
  (forall ((temp___236 us_t))
  (forall ((temp___237 Int) (temp___238 Int) (temp___239 Int))
  (let ((temp___235 (temp___234 temp___236 temp___237 temp___238 temp___239)))
  (and
  (and (= (first1 temp___235) (first1 temp___236))
  (= (last1 temp___235) (last1 temp___236)))
  (forall ((temp___240 Int))
  (ite (and (<= temp___237 temp___240) (<= temp___240 temp___238))
  (= (select (to_array temp___235) temp___240) (of_rep1 temp___239))
  (= (select (to_array temp___235) temp___240) (select (to_array temp___236) temp___240)))))))))

(declare-fun temp___406 (us_t Int Int Int) us_t)

;; def_axiom
  (assert
  (forall ((temp___408 us_t))
  (forall ((temp___409 Int) (temp___410 Int) (temp___411 Int))
  (let ((temp___407 (temp___406 temp___408 temp___409 temp___410 temp___411)))
  (and
  (and (= (first1 temp___407) (first1 temp___408))
  (= (last1 temp___407) (last1 temp___408)))
  (forall ((temp___412 Int))
  (ite (and (<= temp___409 temp___412) (<= temp___412 temp___410))
  (= (select (to_array temp___407) temp___412) (of_rep1 temp___411))
  (= (select (to_array temp___407) temp___412) (select (to_array temp___408) temp___412)))))))))
...
(declare-fun temp___413 () (Array Int integer))

(declare-fun temp___4131 () t)
...
;; H
  (assert
  (= (mk___t temp___413 temp___4131) (temp___406
                                     (mk___t a
...
(assert
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 9, characters 0-0
  (not
  (= (ite (<= (to_rep (first temp___4131)) (to_rep (last temp___4131)))
     (+ (- (to_rep (last temp___4131)) (to_rep (first temp___4131))) 1) 0) 
