...
(declare-fun record_discr__search__result () Bool)

(declare-fun record_discr__search__result1 () us_main_type)
...
(declare-fun record_discr__search__init__assume () natural)

(declare-fun record_discr__search__init__assume1 () (Array Int natural))

(declare-fun record_discr__search__init__assume2 () t2)

(declare-fun o16 () us_rep)

(declare-fun i () Int)

(declare-fun result () result_ty__ref)

(declare-fun record_discr__search__result2 () us_rep)

(declare-fun record_discr__search__result3 () result_ty__ref)

(declare-fun record_discr__search__result4 () us_rep)

(declare-fun record_discr__search__result5 () result_ty__ref)

(declare-fun record_discr__search__result6 () us_rep)
