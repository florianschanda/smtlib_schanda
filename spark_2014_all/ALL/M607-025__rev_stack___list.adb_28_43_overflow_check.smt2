...
(declare-fun temp___472 () (Array Int integer))

(declare-fun temp___4721 () t)
...
(define-fun temp___4722 () us_t (mk___t temp___472 temp___4721))
...
;; H
  (assert
  (and
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i2
  first4) 1))
  (forall ((j1 Int))
  (=> (and (<= first4 j1) (<= j1 i2))
  (= (to_rep
     (select (elts (to__ (mk___rep s__split_fields4))) (+ (- j1 first4) 1)))
  (get (model__ l) j1))))))

;; H
  (assert
  (and (=> (<= first4 last5) (dynamic_property3 first4 last5 i2))
  (and (<= first4 i2) (<= i2 last5))))

;; H
  (assert (and (= o8 (- i2 first4)) (in_range1 (- i2 first4))))
...
;; H
  (assert
  (and (= o12 (to__ (mk___rep s__split_fields4)))
  (and (dynamic_invariant1 o12 true false true)
  (and (= (to_rep (first o7)) 1) (<= 0 (to_rep (last o7)))))))

;; H
  (assert (= o11 (to_rep (last o7))))
...
;; H
  (assert (and (= o4 j) (in_range5 j)))

;; H
  (assert
  (and (= o5 (get (model__ l) o4))
  (and (in_range8 o5) (= o5 (get (model__ l) o4)))))

;; H
  (assert
  (and (= temp___4722 (to__ (mk___rep s__split_fields4)))
  (and (dynamic_invariant1 temp___4722 true false true)
  (and (= (to_rep (first temp___4721)) 1) (<= 0 (to_rep (last temp___4721)))))))

;; H
  (assert (and (= o2 (- j first4)) (in_range1 (- j first4))))
