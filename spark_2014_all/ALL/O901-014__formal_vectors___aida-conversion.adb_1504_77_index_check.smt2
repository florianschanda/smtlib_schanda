...
;; H
  ...
  (forall ((index3 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 7) index3)
...
;; H
  (assert (<= temp___1920 index1))

;; H
  (assert (<= index1 temp___1921))
...
;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 7) j1) (<= j1 index2))
...
;; H
  ...
  (=> (< index2 temp___1919)
  (= (select n3 temp___1919) (select n1 temp___1919))))))
  (and (<= (+ (to_rep1 (first (rt source))) 7) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 10)))))

;; H
  (assert
  (and (= o9 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))
