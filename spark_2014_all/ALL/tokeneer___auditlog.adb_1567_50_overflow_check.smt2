...
(define-fun dynamic_invariant9 ((temp___expr_1055 Int)
...
(declare-fun temp___1296 () (Array Int fileentrycountt))

(declare-fun temp___1297 () (Array Int us_rep1))

(declare-fun temp___1295 () (Array Int logfileindext))

(declare-fun temp___12951 () logfileindext)

(declare-fun temp___12952 () logfileindext)

(declare-fun temp___12953 () logfilecountt)

(declare-fun temp___1294 () Int)

(declare-fun temp___1293 () (Array Int filestatust))

(declare-fun temp___1292 () Bool)
...
(declare-fun temp___1289 () (Array Int logfileindext))

(declare-fun temp___12891 () logfileindext)

(declare-fun temp___12892 () logfileindext)

(declare-fun temp___12893 () logfilecountt)
...
(declare-fun temp___1291 () (Array Int logfileindext))

(declare-fun temp___12911 () logfileindext)

(declare-fun temp___12912 () logfileindext)

(declare-fun temp___12913 () logfilecountt)
...
;; H
  ...
  (= temp___1296 logfileentries)))

;; H
  (assert
  (=> (< 1 (to_rep3 usedlogfiles__split_fields3)) (= temp___1297 logfiles)))

;; H
  (assert
  (=> (< 1 (to_rep3 usedlogfiles__split_fields3))
  (and (= usedlogfiles__split_fields temp___1295)
  (and (= usedlogfiles__split_fields1 temp___12951)
  (and (= usedlogfiles__split_fields2 temp___12952)
  (= usedlogfiles__split_fields3 temp___12953))))))

;; H
  (assert
  (=> (< 1 (to_rep3 usedlogfiles__split_fields3))
  (= temp___1294 numberlogentries)))

;; H
  (assert
  (=> (< 1 (to_rep3 usedlogfiles__split_fields3))
  (= temp___1293 logfilesstatus)))

;; H
  (assert
  (=> (< 1 (to_rep3 usedlogfiles__split_fields3))
  (= temp___1292 auditsystemfault)))
...
;; H
  ...
  (and (= usedlogfiles__split_fields8 temp___1295)
  (= usedlogfiles__split_fields10 temp___12952)))
  (and
  (not
  (= (to_rep4
     (select usedlogfiles__split_fields8 (to_rep4
  ...
  (and (= temp___1289 o2)
  (and (= temp___12891 o3) (and (= temp___12892 o4) (= temp___12893 o5)))))
  (and
  ...
  (= usedlogfiles__split_fields12 (mk___split_fields temp___1289 temp___12891
                                  temp___12892 temp___12893))))
  (and
  (and
  (and
  (and
  ...
  o11)))))
  (and (= temp___1291 o8)
  (and (= temp___12911 o9) (and (= temp___12912 o10) (= temp___12913 o11)))))
  (and (= result4 (mk___split_fields__ref usedlogfiles__split_fields12))
  (= usedlogfiles__split_fields13 (mk___split_fields temp___1291 temp___12911
                                  temp___12912 temp___12913))))
  (and
  (and
...
;; H
  (assert (and (= o15 o14) (in_range11 o14)))

;; H
  (assert
  (= o16 (+ o15 (to_rep2
                (select (map__content1 logfileentries14) (int__content
                                                         currentlogfile6))))))
