...
(((mk_my_boolean__ref (my_boolean__content my_boolean)))))
...
(((mk_map__ref (map__content (Array Int my_boolean))))))
...
(((mk___t (elts (Array Int my_boolean))(rt t)))))
...
(((mk_bool_array__ref (bool_array__content us_t)))))
...
;; def_axiom
  (assert
  (forall ((temp___146 Int) (temp___147 Int) (temp___148 Int))
  (let ((temp___145 (array_logical_ops__test_ok2__v__aggregate_def temp___146
                    temp___147 temp___148)))
  (forall ((temp___149 Int))
  (ite (and (<= 36 temp___149) (<= temp___149 45))
  (= (select temp___145 temp___149) (of_rep temp___148))
  (ite (and (<= 16 temp___149) (<= temp___149 35))
  (= (select temp___145 temp___149) (of_rep temp___147))
  (=> (and (<= 6 temp___149) (<= temp___149 15))
  (= (select temp___145 temp___149) (of_rep temp___146)))))))))
...
(declare-datatypes ((t13b__ref 0)) (((mk_t13b__ref (t13b__content t13b)))))
...
;; def_axiom
  ...
  (temp___154 Int))
  (let ((temp___150 (array_logical_ops__test_ok2__x__aggregate_def temp___151
                    temp___152 temp___153 temp___154)))
  (forall ((temp___155 Int))
  (ite (and (<= 31 temp___155) (<= temp___155 40))
  (= (select temp___150 temp___155) (of_rep temp___154))
  (ite (and (<= 21 temp___155) (<= temp___155 30))
  (= (select temp___150 temp___155) (of_rep temp___153))
  (ite (and (<= 11 temp___155) (<= temp___155 20))
  (= (select temp___150 temp___155) (of_rep temp___152))
  (=> (and (<= 1 temp___155) (<= temp___155 10))
  (= (select temp___150 temp___155) (of_rep temp___151))))))))))
...
;; H
  (assert
  (= (mk___t (array_logical_ops__test_ok2__v__aggregate_def 0 1 0) (mk 6 45))
  v))
...
;; H
  (assert
  (= (mk___t (array_logical_ops__test_ok2__x__aggregate_def 1 0 1 0)
     (mk 1 40)) x))
...
;; H
  (assert
  (= (mk___t
     (orb (elts x) (to_rep1 (first (rt x))) (to_rep1 (last (rt x))) (elts v)
     (to_rep1 (first (rt v))) (to_rep1 (last (rt v))))
     (mk (to_rep1 (first (rt x))) (to_rep1 (last (rt x))))) r2))

;; H
  (assert (dynamic_invariant r2 true false true))

;; H
  (assert (= (to_rep1 (first (rt r2))) 1))

;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= (to_rep1 (first (rt r2))) i1) (<= i1 30))
  (= (of_int (to_rep (select (elts r2) i1))) true))))

;; H
  (assert (<= 31 i))

;; H
  (assert (<= i (to_rep1 (last (rt r2)))))

(assert
;; WP_parameter_def
 ;; File "array_logical_ops.adb", line 4, characters 0-0
  (not (<= (to_rep1 (first (rt r2))) i)))
(check-sat)
(exit)
