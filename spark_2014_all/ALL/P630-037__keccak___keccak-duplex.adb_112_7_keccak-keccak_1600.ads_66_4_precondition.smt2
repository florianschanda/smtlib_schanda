...
(declare-fun dummy6 () rate_number)
...
(declare-fun dummy10 () tTblockSP1)

(declare-datatypes ()
((tTblockSP1__ref (mk_tTblockSP1__ref (tTblockSP1__content tTblockSP1)))))
(define-fun tTblockSP1__ref_3__projection ((a tTblockSP1__ref)) tTblockSP1
...
(declare-datatypes ()
((t194s__ref (mk_t194s__ref (t194s__content integer)))))
(define-fun t194s__ref___projection ((a t194s__ref)) integer (t194s__content
                                                             a))
...
(declare-datatypes ()
((t197s__ref (mk_t197s__ref (t197s__content integer)))))
(define-fun t197s__ref___projection ((a t197s__ref)) integer (t197s__content
                                                             a))
...
(declare-datatypes ()
((t200s__ref (mk_t200s__ref (t200s__content integer)))))
(define-fun t200s__ref___projection ((a t200s__ref)) integer (t200s__content
                                                             a))
...
;; def_axiom
  (assert
  (forall ((temp___1101 (_ BitVec 8)))
  (forall ((temp___1102 Int))
  (= (select (keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def
             temp___1101) temp___1102) (of_rep1 temp___1101)))))
...
(declare-fun temp___1103 () (Array Int byte))

(declare-fun temp___11031 () t1)

(declare-fun temp___1107 () (Array Int byte))

(declare-fun temp___11071 () t1)
...
(declare-fun keccak__keccak_1600__duplex__duplex_mute__R196s__assume () Int)

(declare-fun o4 () (Array Int byte))

(declare-fun keccak__padding__pad101_single_block__block__compl () (Array Int byte))

(declare-fun keccak__padding__pad101_single_block__block__compl1 () t2)
...
(declare-fun keccak__padding__pad101_single_block__block () (Array Int byte))

(declare-fun result2 () (Array Int byte))

(declare-fun block3 () (Array Int byte))
...
;; H
  (assert
  (= block1 (keccak__keccak_1600__duplex__duplex_mute__block__aggregate_def
            ((_ int2bv 8) 0))))

;; H
  (assert
  (= (ite (<= (to_rep (first (rt in_data))) (to_rep (last (rt in_data))))
     (+ (- (to_rep (last (rt in_data))) (to_rep (first (rt in_data)))) 1) 0)
  (ite (<= 0 (- (length in_data) 1)) (+ (- (- (length in_data) 1) 0) 1) 0)))

;; H
  (assert
  (= (slide (elts in_data) (to_rep (first (rt in_data))) 0) temp___1103))
...
;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___11031)) (to_rep (last2 temp___11031)))
     (+ (- (to_rep (last2 temp___11031)) (to_rep (first2 temp___11031))) 1)
     0) (ite (<= (to_rep (first2 (mk1 0 (- (length in_data) 1)))) (to_rep
                                                                  (last2
                                                                  (mk1 0
                                                                  (-
                                                                  (length
                                                                  in_data) 1)))))
        (+ (- (to_rep (last2 (mk1 0 (- (length in_data) 1)))) (to_rep
                                                              (first2
                                                              (mk1 0
                                                              (- (length
                                                                 in_data) 1))))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1107 temp___11071) (mk___t1 temp___1103 temp___11031)))

;; H
  (assert
  (forall ((temp___1108 Int))
  (ite (and (<= 0 temp___1108) (<= temp___1108 (- (length in_data) 1)))
  (= (select o temp___1108) (select temp___1107 temp___1108))
  (= (select o temp___1108) (select block1 temp___1108)))))
...
;; H
  ...
  (and (in_range3 o1) (= o1 (to_rep3 ctx__split_fields1)))))
...
;; H
  (assert
  (= keccak__keccak_1600__duplex__duplex_mute__R196s__assume (- o3 1)))

;; H
  (assert (= keccak__keccak_1600__duplex__duplex_mute__R196s__assume
  r196s))
...
;; H
  (assert
  (=> (<= 0 r196s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r196s) (<= r196s 199)))))

;; H
  (assert (= o4 block2))

;; H
  (assert (= o4 keccak__padding__pad101_single_block__block__compl))

;; H
  (assert
  (= (mk2 0 r196s) keccak__padding__pad101_single_block__block__compl1))
...
;; H
  ...
  (= o7 (rate_of
        (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range3 o7) (= o7 (to_rep3 ctx__split_fields1)))))

;; H
  (assert
  (= (to_rep o6) (to_rep
                 (last4 keccak__padding__pad101_single_block__block__compl1))))

;; H
  (assert
  (= (to_rep o5) (to_rep
                 (first4 keccak__padding__pad101_single_block__block__compl1))))

;; H
  (assert
  (forall ((temp___1112 Int))
  (ite (and (<= 0 temp___1112) (<= temp___1112 r196s))
  (= (select o8 temp___1112) (select (slide
                                     ...
                                     keccak__padding__pad101_single_block__block__compl1)))))
                                     0) temp___1112))
  (= (select o8 temp___1112) (select block2 temp___1112)))))
...
;; H
  ...
  (= o9 (rate_of
        (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1))))
  (and (in_range3 o9) (= o9 (to_rep3 ctx__split_fields1)))))
