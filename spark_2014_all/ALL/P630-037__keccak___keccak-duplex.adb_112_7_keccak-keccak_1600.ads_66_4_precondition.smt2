...
(define-fun tTblockSP1__ref___3__projection ((a tTblockSP1__ref)) tTblockSP1
...
;; H
  ...
  (=> (<= 0 temp___1105)
  (and (and (<= 0 0) (<= 0 199))
  (and (<= 0 temp___1105) (<= temp___1105 199)))))
...
;; H
  ...
  (= (ite (<= (to_rep (first2 temp___11031)) (to_rep (last2 temp___11031)))
     ...
     0) (ite (<= (to_rep (first2 temp___11061)) (to_rep (last2 temp___11061)))
        (+ (- (to_rep (last2 temp___11061)) (to_rep (first2 temp___11061))) 1)
        0)))
...
;; H
  ...
  (= (select o2 temp___1108) (select temp___1107 temp___1108))
  (= (select o2 temp___1108) (select block1 temp___1108)))))
...
;; H
  ...
  (and (in_range3 o3) (= o3 (to_rep3 ctx__split_fields1)))))
...
;; H
  (assert
  (= keccak__keccak_1600__duplex__duplex_mute__R196s__assume (- o5 1)))
...
;; H
  ...
  (= (select o10 temp___1112) (select (slide
                                      ...
                                      keccak__padding__pad101_single_block__block__compl1)))))
                                      0) temp___1112))
  (= (select o10 temp___1112) (select block2 temp___1112)))))
