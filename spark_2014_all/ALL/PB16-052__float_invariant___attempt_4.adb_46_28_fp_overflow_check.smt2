...
;; WP_parameter_def
 ;; File "attempt_4.adb", line 22, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.add RNE distance (fp.mul RNE average1 (fp #b0 #b01111111000 #b0100011110101110000101000111101011100001010001111011)))) (fp.isNaN (fp.add RNE
  distance (fp.mul RNE average1 (fp #b0 #b01111111000 #b0100011110101110000101000111101011100001010001111011))))))))
(check-sat)
(exit)
