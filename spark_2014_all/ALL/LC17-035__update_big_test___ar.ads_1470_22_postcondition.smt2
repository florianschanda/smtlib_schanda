...
(declare-fun temp___7991 () (Array Int et1))

(declare-fun temp___79911 () enum2t)
...
(declare-fun temp___7994 () (Array Int et1))

(declare-fun temp___79941 () enum2t)
...
;; WP_parameter_def
 ;; File "ar.ads", line 1463, characters 0-0
  (not
  (= (bool_eq3 r__split_fields6 1 10 (temp___3067 r__split_fields i e) 1 10) true)))
(check-sat)
