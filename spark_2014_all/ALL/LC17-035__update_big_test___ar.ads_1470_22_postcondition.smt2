...
(declare-fun temp___3067 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3069 (Array Int et1)))
  (forall ((temp___3070 Int) (temp___3071 Int))
  (let ((temp___3068 (temp___3067 temp___3069 temp___3070 temp___3071)))
  (forall ((temp___3072 Int))
  (ite (= temp___3072 temp___3070)
  (= (select temp___3068 temp___3072) (of_rep temp___3071))
  (= (select temp___3068 temp___3072) (select temp___3069 temp___3072))))))))
...
(declare-const temp___7991 (Array Int et1))

(declare-const temp___79911 enum2t)
...
(declare-const temp___7994 (Array Int et1))

(declare-const temp___79941 enum2t)
...
;; H
  (assert (= temp___7991 o1))

;; H
  (assert (= temp___79911 o2))
...
;; H
  (assert (= temp___7991 r__split_fields2))

;; H
  (assert (= temp___79911 r__split_fields3))
...
;; H
  (assert (= temp___7994 o5))

;; H
  (assert (= temp___79941 o6))
...
;; H
  (assert (= temp___7994 r__split_fields4))

;; H
  (assert (= temp___79941 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1463, characters 0-0
  (not
  (= (bool_eq r__split_fields6 1 10 (temp___3067 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
