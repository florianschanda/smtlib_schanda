...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1355))
  (= temp___1352 n1)))
...
;; H
  ...
  (=> (< index2 temp___1353)
  (= (select n3 temp___1353) (select temp___1352 temp___1353))))))
...
;; H
  (assert
  (and (= temp___1356 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1356)
  (<= temp___1356 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1357 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1357)
  (<= temp___1357 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1358 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1358)
  (<= temp___1358 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1359 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1359)
  (<= temp___1359 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1360 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1360)
  (<= temp___1360 (to_rep1 n__last))))

;; H
  (assert (= o33 temp___1360))
