...
(define-fun default_initial_assumption ((temp___expr_256 us_rep)
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     (and (<= (+ 0 result) 3) (dynamic_invariant2 result true false true))) :pattern (
  (length container)) )))
