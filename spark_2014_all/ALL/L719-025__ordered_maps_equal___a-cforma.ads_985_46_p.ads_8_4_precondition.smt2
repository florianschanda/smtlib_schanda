...
;; first_key__post_axiom
  ...
  (! (=> (not (= (is_empty container) true))
     ...
     (dynamic_invariant result true false true)))) :pattern ((first_key
                                                             container)) )))
...
(define-fun k_bigger_than_range ((container1 us_rep1) (fst Int) (lst Int)
  (key1 Int)) Bool (ite (forall ((i Int))
                        (=> (and (<= fst i) (<= i lst))
                        (< (get container1 i) key1)))
                   true false))
...
(define-fun default_initial_assumption ((temp___expr_377 us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_346 us_rep2)
  (temp___skip_top_level_347 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_347 true))
                                         (and
                                         (= (is_empty2 temp___expr_346) true)
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container1)))
     ...
     (=>
     (and (in_range4 temp___411)
     (= (iter_has_element result temp___411) true))
     (= (has_key (model__ container1) (get result temp___411)) true))))
     (forall ((key1 Int))
...
(assert
;; WP_parameter_def
 ;; File "a-cforma.ads", line 954, characters 0-0
