...
(declare-datatypes ()
((map__ref1 (mk_map__ref1 (map__content1 (Array (_ BitVec 64) byte))))))
...
;; object__alignment_axiom
  (assert
  (forall ((a (Array (_ BitVec 64) byte))) (<= 0 (object__alignment1 a))))
...
(declare-datatypes ()
((byte_seq__ref (mk_byte_seq__ref (byte_seq__content us_t1)))))
(define-fun byte_seq__ref___projection ((a byte_seq__ref)) us_t1 (byte_seq__content
                                                                 a))

(define-fun dynamic_invariant2 ((temp___expr_368 us_t1)
  ...
  (temp___do_toplevel_367 Bool)) Bool (and
                                      ...
                                      (first3 temp___expr_368)
                                      (last3 temp___expr_368)))
                                      (=> (= temp___do_toplevel_367 true)
                                      (=> (= temp___is_init_365 true)
                                      (bvult (last3 temp___expr_368) ((_ int2bv 64) 18446744073709551615))))))

(define-fun dynamic_predicate ((temp___371 us_t1)) Bool (bvult (last3
...
(assert
;; WP_parameter_def
 ;; File "skein.adb", line 901, characters 0-0
