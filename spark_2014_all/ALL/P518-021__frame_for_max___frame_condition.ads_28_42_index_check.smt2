...
;; H
  ...
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a3 i1))))
  (to_rep
  (rec__frame_condition__cell__max_left (us_split_fields1 (select a3 j1)))))))))))
  (and
  (and
  (and
  (and
  ...
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a12 j1))))
  (to_rep
...
;; H
  (assert (= o53 (select (map__content a19) o52)))

;; H
  (assert (= o54 (us_split_fields1 o53)))

;; H
  (assert (= o55 (rec__frame_condition__cell__max_right o54)))
...
;; H
  (assert (= o57 (to_rep o51)))

;; H
  (assert (= o58 (ite (<= o57 o56) true false)))
