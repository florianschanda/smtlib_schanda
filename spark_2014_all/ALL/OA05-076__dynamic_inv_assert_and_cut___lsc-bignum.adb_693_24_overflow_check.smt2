...
;; H
  (assert (= o66 (from_integer (int__content s12))))

;; H
  (assert (= o70 (ole o66 o69)))

;; H
  (assert (and (= o61 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o64 (ite (<= n o63) true false)))

;; H
  (assert (= result9 (ite (<= 0 n) o64 false)))
...
;; H
  (assert (and (= o57 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert (= o58 (num_of_big_int m m_first o57)))

;; H
  (assert (and (= o54 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert
  (and (= o53 (base Tuple0))
  (= o53 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o55 (oexpon o53 o54)))

;; H
  (assert (= o48 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o46 (from_integer (int__content s12))))

;; H
  (assert (= o45 (from_word64 i2)))

;; H
  (assert (= o47 (osubtract o45 o46)))
...
;; H
  (assert (= o38 (num_of_big_int x x_first o37)))

;; H
  (assert (= o52 (oexpon__2 o38 o51)))

;; H
  (assert (= o56 (omultiply o52 o55)))
...
;; H
  ...
  (= o36 (num_of_big_int
         ...
         (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o35)))

;; H
  (assert (= o60 (oeq o36 o59)))
...
;; H
  (assert (= o25 (num_of_big_int x x_first o24)))
...
;; H
  (assert
  (= o17 (num_of_big_int
         (mk___t aux1 (mk (to_rep aux1__first) (to_rep aux1__last)))
         aux1_first o16)))

;; H
  (assert (= o19 (oeq o17 o18)))
