...
;; H
  (assert (= o53 (select temp___1485 o52)))
...
;; H
  (assert (= o49 (select temp___1484 ki1)))
...
;; H
  (assert (= o46 (select temp___1483 ki1)))
...
;; H
  (assert (= o41 (select temp___1480 o40)))
...
;; H
  (assert (= o37 (select temp___1477 o36)))
