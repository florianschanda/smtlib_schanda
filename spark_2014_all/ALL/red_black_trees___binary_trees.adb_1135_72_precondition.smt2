...
(declare-fun dummy9 () tcount_typeB)
...
;; range_axiom
  (assert
  (forall ((x tcount_typeB)) (! (in_range5
...
(declare-datatypes ()
((t314b__ref (mk_t314b__ref (t314b__content tcount_typeB)))))
(define-fun t314b__ref___projection ((a t314b__ref)) tcount_typeB (t314b__content
                                                                  a))
...
;; H
  (assert
  (and
  (and (<= (+ (to_rep f_old__split_fields) 1) root)
  (<= root (to_rep f__split_fields)))
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (= (to_rep
...
;; H
  (assert (=> (and (<= 0 n1) (<= n1 100)) (= temp___1870 n1)))
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 100))
  (and (=> (<= 0 100) (in_range2 n2)) (and (<= 0 n2) (<= n2 100)))))
...
;; H
  (assert
  (=> (and (<= 0 n1) (<= n1 100)) (= (mk_int__ref n5) (mk_int__ref n3))))
...
;; H
  (assert (= (to_rep f_old__split_fields) r313b))

;; H
  (assert (in_range2 r313b))
...
;; H
  (assert
  (and (=> (<= 1 r313b) (dynamic_property 1 r313b r2))
  (and (<= 1 r2) (<= r2 r313b))))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 o1 o2 o3 o4)) (select f_old__split_fields1 
  o)))
