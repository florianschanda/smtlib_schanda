...
;; H
  ...
  (forall ((g21 Int))
  (=> (and (<= 1 g21) (<= g21 64))
  (= (bool_eq4 (select o3 g21) 1 64 (invert_1 (select ranking_2 g21)) 1 64) true)))))
...
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 18, characters 0-0
  ...
  (exists ((g21 Int))
  (and (and (<= 1 g21) (<= g21 64))
  (= (to_rep (select (map__content stable_marriage__matching__result4) g21))
  g110)))))
(check-sat)
(exit)
