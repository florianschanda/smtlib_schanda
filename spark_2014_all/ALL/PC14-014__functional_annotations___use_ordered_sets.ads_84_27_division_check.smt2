...
(declare-fun temp___806 () us_rep2)
...
;; H
  ...
  (= (contains
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     item) true))
  (and (< 0 (find temp___806 item))
  (= (equivalent_elements (get temp___806 (find temp___806 item)) item) true)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep s__split_discrs (mk___split_fields s__split_fields)))))
  (and (= (find temp___806 (get temp___806 i)) i)
  (= (e_is_find temp___806 (get temp___806 i) i) true)))))))

;; H
  (assert
  (and (= o (iter_has_element temp___806 temp___805))
  (= (= o true) (and (<= 1 temp___805) (<= temp___805 (last temp___806))))))

;; H
  (assert (= (= o1 true) (in_range4 temp___805)))
...
;; H
  (assert (and (= e (get temp___806 temp___805)) (in_range5 e)))
