...
;; H
  (assert (= o49 (ite (<= j3 o48) true false)))

;; H
  (assert (= o44 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o45 (oexpon o44 j3)))

;; H
  (assert (= o39 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o38 (from_integer j3)))
...
;; H
  (assert (and (= o25 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert (= o23 (from_word32 w2)))

;; H
  (assert (= o30 (omultiply o23 o29)))
...
;; H
  (assert (= result6 (ite (<= 0 n) o21 false)))
