...
;; H
  ...
  (and (= o11 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1
  (- 2147483647 (to_rep1 (first (rt new_val))))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (and (= o12 (- i (to_rep1 change__first))) (in_range1
  (- i (to_rep1 change__first))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (= result3 (ite (<= o12 o11) true false))))
