...
(define-fun bool_eq4 ((a (Array Int (Array Int cell))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq3 (select a temp___idx_140) 1 10
...
(define-fun bool_eq14 ((a1 map1) (a__first Int) (a__last Int)
  (a__first_2 Int) (a__last_2 Int) (b map1) (b__first Int) (b__last Int)
  (b__first_2 Int)
...
;; bool_eq_rev
  ...
  (=>
  (= (bool_eq14 b b__first b__last b__first_2 b__last_2 a1 a__first a__last
...
(define-fun bool_eq15 ((a1 (Array Int map1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq14 (select a1 temp___idx_143) 0 3 0 3
...
;; bool_eq_rev
  ...
  (forall ((a1 (Array Int map1)) (b (Array Int map1)))
  (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int))
  (=> (= (bool_eq15 b b__first b__last a1 a__first a__last) true)
  (and
  (ite (<= a__first a__last)
  (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first)))
  (< b__last b__first))
...
(define-fun bool_eq16 ((a1 map2) (a__first Int) (a__last Int)
  (a__first_2 Int) (a__last_2 Int) (b map2) (b__first Int) (b__last Int)
  (b__first_2 Int)
  (b__last_2 Int)) Bool (ite (and
                             (and
                             (ite (<= a__first a__last)
...
;; bool_eq_rev
  ...
  (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int))
  (=>
  (= (bool_eq16 b b__first b__last b__first_2 b__last_2 a1 a__first a__last
     a__first_2 a__last_2) true)
  (and
  (and
  (ite (<= a__first a__last)
  ...
  (= (bool_eq14 (get1 a1 temp___idx_230 temp___idx_231) 0 2 0 2
...
(declare-fun cur_piece__split_fields12 () shape)

(declare-fun cur_piece__split_fields13 () direction)

(declare-fun cur_piece__split_fields14 () px_coord)

(declare-fun cur_piece__split_fields15 () py_coord)
...
(declare-fun cur_piece__split_fields16 () shape)

(declare-fun cur_piece__split_fields17 () direction)

(declare-fun cur_piece__split_fields18 () px_coord)

(declare-fun cur_piece__split_fields19 () py_coord)
...
(declare-fun cur_piece__split_fields20 () shape)

(declare-fun cur_piece__split_fields21 () direction)

(declare-fun cur_piece__split_fields22 () px_coord)

(declare-fun cur_piece__split_fields23 () py_coord)

(declare-fun action_request_nbr5 () int__ref)

(declare-fun speed_up5 () bool__ref)

(declare-fun success5 () bool__ref)

(declare-fun cur_piece__split_fields24 () us_split_fields)

(declare-fun action_request_nbr6 () Int)

(declare-fun speed_up6 () Bool)

(declare-fun success6 () Bool)

(define-fun cur_piece__split_fields25 () us_split_fields (mk___split_fields
                                                         cur_piece__split_fields16
                                                         cur_piece__split_fields17
                                                         cur_piece__split_fields18
                                                         cur_piece__split_fields19))

(define-fun success7 () bool__ref (mk_bool__ref success3))

(define-fun action_request_nbr7 () int__ref (mk_int__ref action_request_nbr3))

(define-fun cur_piece__split_fields26 () us_split_fields__ref (mk___split_fields__ref
                                                              (mk___split_fields
                                                              cur_piece__split_fields12
                                                              cur_piece__split_fields13
                                                              cur_piece__split_fields14
                                                              cur_piece__split_fields15)))

(define-fun cur_piece__split_fields27 () us_split_fields (mk___split_fields
                                                         cur_piece__split_fields8
                                                         cur_piece__split_fields9
                                                         cur_piece__split_fields10
                                                         cur_piece__split_fields11))

(define-fun cur_piece__split_fields28 () us_split_fields (mk___split_fields
...
;; H
  ...
  (and
  (and
  (and (= success7 (mk_bool__ref success))
  (and (= speed_up2 speed_up3)
  (and (= action_request_nbr7 (mk_int__ref action_request_nbr))
  (= cur_piece__split_fields26 (mk___split_fields__ref
  ...
  (and (= speed_up4 speed_up2)
  (and (= action_request_nbr4 action_request_nbr1)
  (= cur_piece__split_fields25 cur_piece__split_fields28)))))
  (and (= cur_state 0)
  (and (= a 2) (and (= result speed_up) (= speed_up2 (of_int 1))))))
  (and
  (ite (= cur_state 0)
  (and
  (and (not (= a 2)) (and (= speed_up2 speed_up) (= speed_up2 speed_up1)))
  (ite (< action_request_nbr 2)
  (and
  (= (valid_configuration__2 cur_state cur_piece__split_fields27 cur_board
     (mk___split_fields next_piece__split_fields next_piece__split_fields1
     next_piece__split_fields2 next_piece__split_fields3) speed_up2
     action_request_nbr) true)
  (ite (= success2 true)
  (and
  (and (= o (+ action_request_nbr 1)) (in_range1 (+ action_request_nbr 1)))
  (and (= result1 action_request_nbr) (= action_request_nbr2 o)))
  (and (= action_request_nbr2 action_request_nbr)
  (= action_request_nbr2 action_request_nbr1))))
  (and
  (and (= success2 success)
  (and (= action_request_nbr2 action_request_nbr)
  (and (= cur_piece__split_fields cur_piece__split_fields8)
  (and (= cur_piece__split_fields1 cur_piece__split_fields9)
  (and (= cur_piece__split_fields2 cur_piece__split_fields10)
  (= cur_piece__split_fields3 cur_piece__split_fields11))))))
  (and (= success2 success1)
  (and (= action_request_nbr2 action_request_nbr1)
  (= cur_piece__split_fields27 cur_piece__split_fields28))))))
  (and
  (and (= success2 success)
  (and (= speed_up2 speed_up)
  (and (= action_request_nbr2 action_request_nbr)
  (and (= cur_piece__split_fields cur_piece__split_fields8)
  (and (= cur_piece__split_fields1 cur_piece__split_fields9)
  (and (= cur_piece__split_fields2 cur_piece__split_fields10)
  (= cur_piece__split_fields3 cur_piece__split_fields11)))))))
  (and (= success2 success1)
  (and (= speed_up2 speed_up1)
  (and (= action_request_nbr2 action_request_nbr1)
  (= cur_piece__split_fields27 cur_piece__split_fields28))))))
  (and
  (and (= success2 success3)
  (and (= speed_up2 speed_up3)
  (and (= action_request_nbr2 action_request_nbr3)
  (and (= cur_piece__split_fields12 cur_piece__split_fields8)
  (and (= cur_piece__split_fields13 cur_piece__split_fields9)
  ...
  (and (= speed_up4 speed_up2)
  (and (= action_request_nbr4 action_request_nbr2)
  (= cur_piece__split_fields25 cur_piece__split_fields27))))))))

;; H
  (assert (= success5 success7))

;; H
  (assert (= speed_up5 (mk_bool__ref speed_up3)))

;; H
  (assert (= action_request_nbr5 action_request_nbr7))

;; H
  (assert
  (= (mk___split_fields__ref
     (mk___split_fields cur_piece__split_fields20 cur_piece__split_fields21
     cur_piece__split_fields22 cur_piece__split_fields23)) cur_piece__split_fields26))
...
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  ...
  (= (valid_configuration__2 cur_state
     (mk___split_fields cur_piece__split_fields20 cur_piece__split_fields21
     cur_piece__split_fields22 cur_piece__split_fields23) cur_board
     (mk___split_fields next_piece__split_fields next_piece__split_fields1
     next_piece__split_fields2 next_piece__split_fields3)
     (bool__content speed_up5) (int__content action_request_nbr5)) true)))
(check-sat)
