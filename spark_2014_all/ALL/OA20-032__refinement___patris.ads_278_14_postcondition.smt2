...
(declare-fun action_request_nbr5 () Int)

(declare-fun speed_up5 () Bool)
...
;; H
  ...
  (and
  (= (valid_configuration__2 cur_state cur_piece__split_fields27 cur_board) true)
  (ite (= success2 true)
  (and
...
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  ...
  (= (valid_configuration__2 cur_state
     (mk___split_fields cur_piece__split_fields20 cur_piece__split_fields21
     cur_piece__split_fields22 cur_piece__split_fields23) cur_board) true)))
(check-sat)
(exit)
