...
(declare-fun dummy2 () (Array Int (Array Int et1)))
...
(declare-fun user_eq2 ((Array Int (Array Int et1))
...
(define-fun bool_eq3 ((a (Array Int (Array Int (Array Int et1))))
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq2 (select a temp___idx_134) 5 50
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 555, characters 0-0
  (not (in_range1 (to_rep (select (select (select a2 o) n) m)))))
(check-sat)
