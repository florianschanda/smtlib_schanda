...
(define-fun integral_fbz3 () t__ref (mk_t__ref integral_fbz))

(define-fun integral_fby3 () t__ref (mk_t__ref integral_fby))

(define-fun integral_fbx3 () t__ref (mk_t__ref integral_fbx))
...
;; H
  (assert (= rad_gx1 (div1 RNE1 (mul RNE1 c3b fliteral9) fliteral10)))
...
;; H
  (assert (= rad_gy1 (div1 RNE1 (mul RNE1 c4b fliteral9) fliteral10)))
...
;; H
  (assert (= rad_gz1 (div1 RNE1 (mul RNE1 c5b fliteral9) fliteral10)))
...
;; H
  (assert
  (= half_vz1 (add RNE1 (sub RNE1 (mul RNE1 q0 q0) fliteral11)
              (mul RNE1 q3 q3))))
...
;; H
  (assert
  (and (= o1 (mul RNE1 c6b recip_norm1)) (tqtisFinite
  (mul RNE1 c6b recip_norm1))))
...
;; H
  (assert (and (= o3 o2) (tqtisFinite o2)))
...
;; H
  (assert
  (and (= o4 (mul RNE1 c7b recip_norm1)) (tqtisFinite
  (mul RNE1 c7b recip_norm1))))
...
;; H
  (assert
  (and (= o7 (mul RNE1 c8b recip_norm1)) (tqtisFinite
  (mul RNE1 c8b recip_norm1))))
...
;; H
  (assert (and (= o9 o8) (tqtisFinite o8)))
...
;; H
  (assert
  (and (= o10 (mul RNE1 norm_az1 half_vy1)) (tqtisFinite
  (mul RNE1 norm_az1 half_vy1))))

;; H
  (assert
  (and (= o11 (mul RNE1 norm_ay1 half_vz1)) (tqtisFinite
  (mul RNE1 norm_ay1 half_vz1))))

;; H
  (assert (= o12 (sub RNE1 o11 o10)))

;; H
  (assert (and (= o13 o12) (tqtisFinite o12)))
...
;; H
  (assert
  (and (= o14 (mul RNE1 norm_ax1 half_vz1)) (tqtisFinite
  (mul RNE1 norm_ax1 half_vz1))))

;; H
  (assert
  (and (= o15 (mul RNE1 norm_az1 half_vx1)) (tqtisFinite
  (mul RNE1 norm_az1 half_vx1))))

;; H
  (assert (= o16 (sub RNE1 o15 o14)))
...
;; H
  (assert
  (and (= o18 (mul RNE1 norm_ay1 half_vx1)) (tqtisFinite
  (mul RNE1 norm_ay1 half_vx1))))

;; H
  (assert
  (and (= o19 (mul RNE1 norm_ax1 half_vy1)) (tqtisFinite
  (mul RNE1 norm_ax1 half_vy1))))

;; H
  (assert (= o20 (sub RNE1 o19 o18)))
...
;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o22 (mul RNE1 two_ki half_ex1)) (tqtisFinite
  (mul RNE1 two_ki half_ex1)))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o23 (mul RNE1 o22 c9b))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o24 o23) (tqtisFinite o23))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o25 (add RNE1 integral_fbx o24))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o26 o25) (tqtisFinite o25))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= result16 integral_fbx3)))

;; H
  (assert (=> (lt fliteral4 two_ki) (= integral_fbx1 o26)))

;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o27 (mul RNE1 two_ki (let ((subject half_ey)) half_ey1)))
  (tqtisFinite (mul RNE1 two_ki (let ((subject half_ey)) half_ey1))))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o28 (mul RNE1 o27 c9b))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o29 o28) (tqtisFinite o28))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o30 (add RNE1 integral_fby o29))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o31 o30) (tqtisFinite o30))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= result17 integral_fby3)))

;; H
  (assert (=> (lt fliteral4 two_ki) (= integral_fby1 o31)))

;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o32 (mul RNE1 two_ki (let ((subject half_ez)) half_ez1)))
  (tqtisFinite (mul RNE1 two_ki (let ((subject half_ez)) half_ez1))))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o33 (mul RNE1 o32 c9b))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o34 o33) (tqtisFinite o33))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= o35 (add RNE1 integral_fbz o34))))

;; H
  (assert (=> (lt fliteral4 two_ki) (and (= o36 o35) (tqtisFinite o35))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= result18 integral_fbz3)))

;; H
  (assert (=> (lt fliteral4 two_ki) (= integral_fbz1 o36)))

;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o37 (add RNE1 rad_gx1 integral_fbx1)) (tqtisFinite
  (add RNE1 rad_gx1 integral_fbx1)))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= result19 (mk_t__ref rad_gx1))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= rad_gx2 o37)))

;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o38 (add RNE1 rad_gy1 integral_fby1)) (tqtisFinite
  (add RNE1 rad_gy1 integral_fby1)))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= result20 (mk_t__ref rad_gy1))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= rad_gy2 o38)))

;; H
  (assert
  (=> (lt fliteral4 two_ki)
  (and (= o39 (add RNE1 rad_gz1 integral_fbz1)) (tqtisFinite
  (add RNE1 rad_gz1 integral_fbz1)))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= result21 (mk_t__ref rad_gz1))))

;; H
  (assert (=> (lt fliteral4 two_ki) (= rad_gz2 o39)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= result22 integral_fbx3)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= integral_fbx2 fliteral4)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= result23 integral_fby3)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= integral_fby2 fliteral4)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= result24 integral_fbz3)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= integral_fbz2 fliteral4)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= rad_gz2 rad_gz1)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= rad_gy2 rad_gy1)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= rad_gx2 rad_gx1)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= integral_fbz1 integral_fbz2)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= integral_fby1 integral_fby2)))

;; H
  (assert (=> (not (lt fliteral4 two_ki)) (= integral_fbx1 integral_fbx2)))

;; H
  (assert
  (and (= o40 (mul RNE1 two_kp half_ex1)) (tqtisFinite
  (mul RNE1 two_kp half_ex1))))

;; H
  (assert (= o41 (add RNE1 rad_gx2 o40)))

;; H
  (assert (and (= o42 o41) (tqtisFinite o41)))
...
;; H
  (assert
  (and (= o43 (mul RNE1 two_kp (let ((subject half_ey)) half_ey1)))
  (tqtisFinite (mul RNE1 two_kp (let ((subject half_ey)) half_ey1)))))

;; H
  (assert (= o44 (add RNE1 rad_gy2 o43)))

;; H
  (assert (and (= o45 o44) (tqtisFinite o44)))

;; H
  (assert (= result26 (mk_t__ref rad_gy2)))
...
;; H
  (assert
  (and (= o46 (mul RNE1 two_kp (let ((subject half_ez)) half_ez1)))
  (tqtisFinite (mul RNE1 two_kp (let ((subject half_ez)) half_ez1)))))

;; H
  (assert (= o47 (add RNE1 rad_gz2 o46)))
