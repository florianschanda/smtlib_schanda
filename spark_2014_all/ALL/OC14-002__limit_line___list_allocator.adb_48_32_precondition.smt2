...
;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o33) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true)
  (and (= o32 (get model____split_fields 1)) (in_range7 o32)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o32 first_available) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o30) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result3 true)
  (and (= o29 (get model____split_fields1 1)) (in_range7 o29))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o29 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true) (and (= o25 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true)
  (and (= o26 (get model____split_fields o25)) (in_range7 o26)))))
...
;; H
  (assert
  (=> (= result6 true)
  (=> (< 1 j) (and (= o14 (get model____split_fields o13)) (in_range7 o14)))))
