...
(declare-datatypes ((tS31bP1__ref 0))
(((mk_tS31bP1__ref (tS31bP1__content tdigit_count_typeB)))))
...
(declare-datatypes ((s31b__ref 0)) (((mk_s31b__ref (s31b__content us_t2)))))
...
(((mk_t33b__ref (t33b__content tdigit_count_typeB)))))
...
(declare-datatypes ((t34b__ref 0)) (((mk_t34b__ref (t34b__content us_t3)))))
...
;; H
  ...
  (and
  (= o (* 2 (to_rep2
            (rec__very_longs__very_long__length result____split_discrs))))
  (in_range4
