...
;; H
  ...
  (and
  (and
  (and (= (is_writable standard_output2) true)
  (= (is_open standard_output2) true))
  (= (mode__2 standard_output2) (mode__2 standard_output1)))
  (= (let ((temp___725 (name standard_output1)))
     (let ((temp___724 (name standard_output2)))
     (bool_eq (elts temp___724) (to_rep1 (first (rt temp___724)))
     (to_rep1 (last (rt temp___724))) (elts temp___725)
     (to_rep1 (first (rt temp___725))) (to_rep1 (last (rt temp___725)))))) true))
  (= (let ((temp___727 (form standard_output1)))
     (let ((temp___726 (form standard_output2)))
  ...
  (= (= (is_standard_file standard_output2) true)
  (= (is_standard_file standard_output1) true))))
