...
(declare-fun temp___837 () (Array Int us_rep1))

(declare-fun o42 () us_rep1)

(declare-fun o43 () us_split_fields)

(declare-fun temp___835 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___837 (model__
                ...
                root))
  (and (dynamic_invariant3 temp___837 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___837 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___837 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___837 (parent
                             (mk___rep2
                             (mk___split_fields2 f__split_fields
                             f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___837 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___837 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___837 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___837 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___837 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___837 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o42 (select temp___837 j)))
...
;; H
  ...
  (= temp___835 (model__
                ...
                (mk___split_fields2 f__split_fields f__split_fields1)) 
                root))
  (and (dynamic_invariant3 temp___835 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___835 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___835 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___835 (parent
                             (mk___rep2
                             (mk___split_fields2 f__split_fields
                             f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___835 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___835 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___835 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___835 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___835 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___835 j1)))) true))
  (= j1 i1))))))))))))))

;; H
  (assert (= o44 (select temp___835 j)))
