...
;; H
  (assert (and (= o7 o5) (in_range2 o5)))

;; H
  (assert (= result (ite (<= o7 o6) true false)))
...
;; H
  (assert (= result1 (ite (<= o3 5000) true false)))
...
;; H
  (assert
  (and
  (= o2 (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))
        c))
  (and (in_range7 o2)
  (= o2 (get2
        (keys
