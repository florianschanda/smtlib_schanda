...
(define-fun o29 () us_rep (mk___rep (mk___split_fields o10 o11)))

(define-fun o30 () us_rep (mk___rep (mk___split_fields o4 o5)))
...
;; H
  ...
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o29) true))
...
;; WP_parameter_def
 ;; File "my_maps.adb", line 4, characters 0-0
  (not
  (or
  (< (length (mk___rep1 l__split_discrs l__split_fields7)) (to_rep3
                                                           (rec__my_maps__n__map__capacity
                                                           l__split_discrs)))
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields7)) o28) true))))
(check-sat)
