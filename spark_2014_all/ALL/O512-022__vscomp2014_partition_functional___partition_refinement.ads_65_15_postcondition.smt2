...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j 5))
  (and (<= 0 (to_rep4 (select f1 j)))
  (<= (to_rep4 (select f1 j)) (- (length1
                                 (mk___rep5 p__split_discrs p__split_fields8)) 1)))))
  (and
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j 5))
  (and
  ...
  (=>
  (and (<= 0 j)
  (<= j (- (length1 (mk___rep5 p__split_discrs p__split_fields8)) 1)))
  (forall ((k Int))
  (=>
  (and
  (<= (to_rep2
      (rec__partition_refinement__interval__first
      (us_split_fields9
      (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields8)) j)))) k)
  (<= k (to_rep2
        (rec__partition_refinement__interval__last
        (us_split_fields9
        (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields8)) j))))))
  (= (to_rep4 (select f1 k)) j))))))))
