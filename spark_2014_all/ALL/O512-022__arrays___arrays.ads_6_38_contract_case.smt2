...
(declare-const arrays__sum__result Int)
...
(declare-const arrays__sum__result1 Int)

(declare-const arrays__sum__result2 Int)

(declare-const arrays__sum__result3 Int)

(declare-const s8 Int)

(declare-const j7 Int)

(declare-const arrays__sum__result4 Int)

(declare-const s9 Int)

(declare-const j8 Int)

(declare-const arrays__sum__result5 Int)

(define-fun j9 () int__ref (mk_int__ref j5))

(define-fun s10 () int__ref (mk_int__ref s6))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))
  (and (=> (<= 0 2147483647) (in_range2 s2))
  (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))
  (and (= o (+ s2 (to_rep (select (elts x) j2)))) (in_range1
  (+ s2 (to_rep (select (elts x) j2)))))))
...
;; H
  (assert (= arrays__sum__result1 arrays__sum__result2))

;; H
  (assert (= arrays__sum__result3 arrays__sum__result1))

;; H
  (assert (= (mk_int__ref result3) (mk_int__ref arrays__sum__result)))

;; H
  (assert (= arrays__sum__result1 s6))

;; H
  (assert
  (= (mk_int__ref arrays__sum__result4) (mk_int__ref arrays__sum__result2)))

;; H
  (assert (= (mk_int__ref j7) j9))

;; H
  (assert (= (mk_int__ref s8) s10))

;; H
  (assert (= arrays__sum__result5 arrays__sum__result3))
...
;; H
  (assert (= (= (length x) 0) true))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= arrays__sum__result4 0)))
(check-sat)
(exit)
