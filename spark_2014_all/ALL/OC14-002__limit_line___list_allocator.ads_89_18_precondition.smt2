...
;; H
  ...
  (and (in_range4
  (get (rec__list_allocator__m__t__available model____split_fields4) j1))
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1
     (select data4 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields4) j1))))) (ite (< j1 (length
                                                              (rec__list_allocator__m__t__available
...
;; H
  ...
  (in_range4
  (get (rec__list_allocator__m__t__allocated model____split_fields4) j1))))))
...
;; H
  ...
  (= (to_rep
     ...
     (select data4 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields4) j1))))) (ite (< 1 j1)
                                                   (get
                                                   (rec__list_allocator__m__t__available
                                                   model____split_fields4)
                                                   (- j1 1)) 0)))
...
;; H
  (assert
  (and
  (= result11 (is_prepend model____split_fields res
              (rec__list_allocator__m__t__available
  ...
  (= (length
     ...
     (us_split_fields__content1 model____split_fields5))) (+ (length
                                                             model____split_fields) 1))
  (= (get
     (rec__list_allocator__m__t__available
     (us_split_fields__content1 model____split_fields5)) 1) res))
  (forall ((m Int))
  (=>
  (and (<= 2 m)
  (<= m (length
  ...
  (= (get
     (rec__list_allocator__m__t__available
     (us_split_fields__content1 model____split_fields5)) m) (get
...
;; H
  (assert
  (=> (= result11 true)
  (= result10 (ite (= o58 (- (length model____split_fields1) 1)) true false))))
