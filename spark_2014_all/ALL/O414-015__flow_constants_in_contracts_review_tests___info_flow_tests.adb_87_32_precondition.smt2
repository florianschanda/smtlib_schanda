...
;; H
  (assert
  (and (= info_flow_tests__test_04__c4__assume (f3 5 a))
  (and (in_range info_flow_tests__test_04__c4__assume)
...
;; H
  (assert
  (and (= info_flow_tests__test_04__c6__assume (f4 5 c3))
  (and (in_range info_flow_tests__test_04__c6__assume)
  (and (= info_flow_tests__test_04__c6__assume 5) (< 0 c3)))))
