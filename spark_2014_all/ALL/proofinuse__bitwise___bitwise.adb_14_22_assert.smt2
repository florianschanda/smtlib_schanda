...
(declare-fun lmask_8 () (_ BitVec 8))

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

;; lmask_8__def_axiom
  (assert (= lmask_8 ((_ int2bv 8) 255)))
...
;; H
  (assert (= res1 ((_ int2bv 32) 255)))

(assert
;; WP_parameter_def
 ;; File "bitwise.adb", line 4, characters 0-0
  (not (= (bvand x res1) (bvand x ((_ int2bv 32) 255)))))
(check-sat)
(exit)
