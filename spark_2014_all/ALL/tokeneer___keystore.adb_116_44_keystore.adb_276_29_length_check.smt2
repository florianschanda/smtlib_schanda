...
(declare-fun result__6 () map__ref)
...
;; H
  ...
  (= (select o16 temp___1227) (select result__3 temp___1227)))))))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (not (= result12 true)) (= result__5 o17))))
...
;; H
  (assert (=> (<= 1 39) (= o19 (+ (- 39 1) 1))))

;; H
  (assert (=> (not (<= 1 39)) (= o19 0)))
...
;; H
  (assert (and (= o24 (length thestring1)) (in_range1 (length thestring1))))

;; H
  (assert (= result17 (ite (<= o24 150) true false)))
