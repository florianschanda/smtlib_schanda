...
(declare-fun result8 () (Array Int character))
...
;; H
  (assert
  (=> (= to_up3 true)
  (and (= o6 (to_upper (to_rep (select ret4 idx3)))) (in_range3 o6))))
...
;; H
  (assert
  (=> (not (= to_up3 true))
  (and (= o9 (to_lower (to_rep (select ret4 idx3)))) (in_range3 o9))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt str))) idx3)
  (<= idx3 (to_rep1 (last (rt str))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (to_caml_char2 str
     (mk___t ret5 (mk (to_rep1 ret__first) (to_rep1 ret__last))) idx3) true)))
(check-sat)
