...
(declare-datatypes ()
((tT68bP1__ref (mk_tT68bP1__ref (tT68bP1__content tdigit_index_typeB)))))
(define-fun tT68bP1__ref___projection ((a tT68bP1__ref)) tdigit_index_typeB
  (tT68bP1__content a))
...
(declare-datatypes () ((t68b__ref (mk_t68b__ref (t68b__content us_t1)))))
(define-fun t68b__ref___projection ((a t68b__ref)) us_t1 (t68b__content a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___173 (rec__aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___173)
                                         (first3 temp___173)
                                         (last3 temp___173))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1)
                                          (mk___split_fields1
                                          (let ((temp___172 (rec__aco__math__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array1 (to_array temp___172)
                                          (first1 temp___172)
                                          (last1 temp___172))))))
...
(define-fun dynamic_invariant3 ((temp___expr_693 us_rep1)
  ...
  (temp___do_toplevel_692 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_693)))
                                      (last3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_693))))
                                      (and
                                      (= (first3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_693))) 1)
                                      (= (last3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_693)))
                                      (to_rep1
...
(define-fun default_initial_assumption ((temp___expr_696 us_rep1)
  (temp___skip_top_level_697 Bool)) Bool (= (to_rep1
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_696))) (to_rep1
                                                               (rec__aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-datatypes ()
((t69b__ref (mk_t69b__ref (t69b__content tdigit_index_typeB)))))
(define-fun t69b__ref___projection ((a t69b__ref)) tdigit_index_typeB
  (t69b__content a))
...
(declare-fun temp___1147 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1149 (_ BitVec 8)))
  (forall ((temp___1150 Int) (temp___1151 Int))
  (let ((temp___1148 (temp___1147 temp___1149 temp___1150 temp___1151)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___1150 temp___1151)
  (and (= (first5 temp___1148) temp___1150)
  (= (last5 temp___1148) temp___1151)))
  (forall ((temp___1152 Int))
  (= (select (to_array2 temp___1148) temp___1152) (of_rep temp___1149))))))))
...
;; H
  (assert (dynamic_invariant2 l true false true))
