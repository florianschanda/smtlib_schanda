...
(declare-fun test__bit_set__result () Bool)
...
(declare-fun test__bit_set__result1 () Bool)

(declare-fun test__bit_set__result2 () Bool)

(declare-fun test__bit_set__result3 () Bool)

(declare-fun test__bit_set__result4 () Bool)

(declare-fun test__bit_set__result5 () Bool)
...
;; H
  (assert
  (and (= temp___224 (bv2nat (bvurem i ((_ int2bv 64) 32)))) (in_range2
  (bv2nat (bvurem i ((_ int2bv 64) 32))))))

;; H
  (assert
  (=> (< temp___224 4294967296)
  (= o4 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___224)))))

;; H
  (assert (=> (not (< temp___224 4294967296)) (= o4 ((_ int2bv 32) 0))))
...
;; H
  (assert (and (= temp___223 o1) (in_range1 o1)))

;; H
  (assert
  (and (<= (to_rep1 (first (rt a))) temp___223)
  (<= temp___223 (to_rep1 (last (rt a))))))

;; H
  (assert (= o2 temp___223))
...
;; H
  (assert
  (= (mk_bool__ref test__bit_set__result4) (mk_bool__ref
                                           test__bit_set__result2)))
...
;; H
  (assert
  (and (= temp___226 (bv2nat (bvurem i ((_ int2bv 64) 32)))) (in_range2
  (bv2nat (bvurem i ((_ int2bv 64) 32))))))

;; H
  (assert
  (=> (< temp___226 4294967296)
  (= o11 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___226)))))

;; H
  (assert (=> (not (< temp___226 4294967296)) (= o11 ((_ int2bv 32) 0))))
