...
(define-fun o28 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
;; H
  (assert
  (and (= o28 (model__ data first_available))
  (= (model_is_well_formed o28 data first_available) true)))
...
;; H
  (assert (and (= temp___306 (get c96b i2)) (in_range6 temp___306)))

;; H
  (assert (and (<= 1 temp___306) (<= temp___306 10000)))

;; H
  (assert (= o23 temp___306))

;; H
  (assert (= o24 (select data1 o23)))

;; H
  (assert (= o25 (us_split_fields1 o24)))

;; H
  (assert (= o26 (rec__list_mod_allocator__cell__next o25)))
