...
;; H
  ...
  (not (= (to_rep (select unmatched_g1_set__split_fields idx1)) g1_id))))
...
;; H
  ...
  (exists ((idx1 Int))
  (and (and (<= 1 idx1) (<= idx1 (to_rep3 unmatched_g1_set__split_fields1)))
  (= (to_rep (select unmatched_g1_set__split_fields idx1)) g1_id))))))))
