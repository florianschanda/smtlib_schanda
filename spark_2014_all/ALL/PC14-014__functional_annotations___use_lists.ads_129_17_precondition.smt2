...
(declare-fun temp___567 () us_rep2)
...
;; H
  (assert
  (and (= temp___567 (model__ l)) (= (length temp___567) (length1 l))))

;; H
  (assert
  (and (= o (iter_has_element temp___567 temp___566))
  (= (= o true) (and (<= 1 temp___566) (<= temp___566 (last temp___567))))))

;; H
  (assert (= (= o1 true) (in_range2 temp___566)))
