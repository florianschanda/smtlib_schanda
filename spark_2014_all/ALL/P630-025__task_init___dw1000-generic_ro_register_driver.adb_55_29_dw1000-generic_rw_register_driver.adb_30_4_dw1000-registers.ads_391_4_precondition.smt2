...
(define-fun register_type__ref_107__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_76__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_76__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4741 us_t1)
  (temp___is_init_4738 Bool) (temp___skip_constant_4739 Bool)
  (temp___do_toplevel_4740 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4739 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_4741)
                                       (last3 temp___expr_4741))
                                       (and (= (first3 temp___expr_4741) 1)
                                       (= (last3 temp___expr_4741) 2)))))
