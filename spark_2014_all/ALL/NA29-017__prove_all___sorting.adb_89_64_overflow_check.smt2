...
;; H
  (assert (and (= o5 (- length2 j2)) (in_range1 (- length2 j2))))

;; H
  (assert (and (= o6 o5) (in_range2 o5)))

;; H
  (assert (and (= o4 (+ i2 j2)) (in_range1 (+ i2 j2))))

;; H
  (assert (and (= o1 (+ a_first length1)) (in_range1 (+ a_first length1))))
