...
;; H
  (assert (= o74 (us_split_fields5 o73)))

;; H
  (assert (= o75 (rec__gaps__gap__bearing o74)))

;; H
  (assert
  (and (= o77 (aldiff o75 o76))
  (and (not (or (fp.isInfinite o77) (fp.isNaN o77)))
  (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011))
  o77) (fp.leq o77 (fp #b0 #b10000000 #b10010010000111111011011))))))

;; H
  (assert (= o78 (fp.abs o77)))
