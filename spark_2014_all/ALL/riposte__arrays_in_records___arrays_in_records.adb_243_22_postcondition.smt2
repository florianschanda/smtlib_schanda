...
(declare-fun b__split_fields () index)

(declare-fun b__split_fields1 () (Array Int value))

(declare-fun b__split_fields2 () (Array Int value))
...
(declare-fun temp___367 () index)

(declare-fun temp___3671 () (Array Int value))

(declare-fun temp___3672 () (Array Int value))
...
(declare-fun temp___370 () index)

(declare-fun temp___3701 () (Array Int value))

(declare-fun temp___3702 () (Array Int value))
...
(declare-fun b__split_fields3 () index)

(declare-fun b__split_fields4 () (Array Int value))

(declare-fun b__split_fields5 () (Array Int value))
...
(declare-fun b__split_fields6 () index)

(declare-fun b__split_fields7 () (Array Int value))

(declare-fun b__split_fields8 () (Array Int value))

(declare-fun tmp2 () int__ref)

(declare-fun a__split_fields9 () us_split_fields)

(declare-fun b__split_fields9 () us_split_fields)
