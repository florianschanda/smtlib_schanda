...
(declare-const b__split_fields index)

(declare-const b__split_fields1 (Array Int value))

(declare-const b__split_fields2 (Array Int value))
...
(declare-const temp___367 index)

(declare-const temp___3671 (Array Int value))

(declare-const temp___3672 (Array Int value))
...
(declare-const temp___370 index)

(declare-const temp___3701 (Array Int value))

(declare-const temp___3702 (Array Int value))
...
(declare-const b__split_fields3 index)

(declare-const b__split_fields4 (Array Int value))

(declare-const b__split_fields5 (Array Int value))
...
(declare-const b__split_fields6 index)

(declare-const b__split_fields7 (Array Int value))

(declare-const b__split_fields8 (Array Int value))

(declare-const tmp2 int__ref)

(declare-const a__split_fields9 us_split_fields)

(declare-const b__split_fields9 us_split_fields)
...
;; H
  (assert (= (to_rep o) (to_rep (select b__split_fields2 5))))
...
;; H
  (assert (= temp___367 o2))

;; H
  (assert (= temp___3671 o3))

;; H
  (assert (= temp___3672 o4))
...
;; H
  (assert (= temp___367 a__split_fields3))

;; H
  (assert (= temp___3671 a__split_fields4))

;; H
  (assert (= temp___3672 a__split_fields5))

;; H
  (assert (= (to_rep o5) tmp1))

;; H
  (assert (= o6 (store b__split_fields2 5 o5)))

;; H
  (assert (= b__split_fields o7))

;; H
  (assert (= b__split_fields1 o8))

;; H
  (assert (= o6 o9))

;; H
  (assert (= temp___370 o7))

;; H
  (assert (= temp___3701 o8))

;; H
  (assert (= temp___3702 o9))

;; H
  (assert (= result4 b__split_fields))

;; H
  (assert (= result5 b__split_fields1))

;; H
  (assert (= result6 b__split_fields2))

;; H
  (assert (= temp___370 b__split_fields3))

;; H
  (assert (= temp___3701 b__split_fields4))

;; H
  (assert (= temp___3702 b__split_fields5))

;; H
  (assert (= tmp2 (mk_int__ref tmp1)))

;; H
  (assert (= b__split_fields6 b__split_fields3))

;; H
  (assert (= b__split_fields7 b__split_fields4))

;; H
  (assert (= b__split_fields8 b__split_fields5))
...
;; H
  (assert
  (= b__split_fields9 (mk___split_fields b__split_fields3 b__split_fields4
                      b__split_fields5)))

;; H
  (assert
  (= a__split_fields9 (mk___split_fields a__split_fields3 a__split_fields4
                      a__split_fields5)))

(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 224, characters 0-0
  (not
  (not
  (= (bool_eq1
     (mk___rep
     (mk___split_fields a__split_fields6 a__split_fields7 a__split_fields8))
     (mk___rep
