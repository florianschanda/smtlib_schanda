...
;; H
  (assert
  (and (= o3 (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 o3)
  (= o3 (last4 (model__ container))))))
...
;; H
  (assert
  (and (= us1 temp___421) (dynamic_property3 first2 last3 temp___421)))
