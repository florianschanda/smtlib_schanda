...
;; inversion_axiom
  (assert
  (forall ((x et3)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)) )))

;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range (to_rep x)) :pattern ((to_rep x)) )))
...
;; range_axiom
  (assert
  (forall ((x et1)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (and
                         ...
                         (to_rep (rec__ar__rec2t__f2 (us_split_fields3 b))))
                         (= (bool_eq
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 829, characters 0-0
  (not (= (to_rep r__split_fields8) (to_rep r__split_fields))))
(check-sat)
(exit)
