  ...
  (! (=>
     ...
     (= (to_rep1
        (select (to_array a) (to_rep
                             ...
                             (us_split_fields1 result))))) (to_rep1
                                                           (select (to_array
                                                                   b)
                                                           (to_rep
...
;; ih__def_axiom
  ...
  (= ih (induction_hypothesis
        (remove a (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))))
        (remove b (to_rep (rec__perm__witnesses__ib (us_split_fields1 w))))
        (remove c (to_rep (rec__perm__witnesses__ia (us_split_fields1 w)))))))

(declare-fun perm__shift_perm_l__induction_hypothesis__result () Int)

(declare-fun perm__shift_perm_l__induction_hypothesis__B_5__w__assume () index)

(declare-fun perm__shift_perm_l__induction_hypothesis__B_5__w__assume1 () index)
...
(declare-fun perm__shift_perm_l__induction_hypothesis__B_5__ih__assume () Int)

(declare-fun perm__shift_perm_l__induction_hypothesis__result1 () Int)

(declare-fun perm__shift_perm_l__induction_hypothesis__result2 () Int)
...
(define-fun perm__shift_perm_l__induction_hypothesis__B_5__w__assume2 () us_rep
  (mk___rep
  (mk___split_fields perm__shift_perm_l__induction_hypothesis__B_5__w__assume
...
;; H
  ...
  (and
  (= (bool_eq (elts a) (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))
     (elts c) (to_rep2 (first (rt c))) (to_rep2 (last (rt c)))) true)
  (= (is_perm a b) true))))))
...
;; H
  (assert
  (= perm__shift_perm_l__induction_hypothesis__result2 perm__shift_perm_l__induction_hypothesis__result))

;; H
  (assert
  (= perm__shift_perm_l__induction_hypothesis__result2 perm__shift_perm_l__induction_hypothesis__result1))

;; H
  (assert
  (and
  (= perm__shift_perm_l__induction_hypothesis__B_5__w__assume2 (get_witnesses
                                                               a b))
  (and
  (and
  (<= (to_rep2 (first (rt a))) (to_rep
                               perm__shift_perm_l__induction_hypothesis__B_5__w__assume))
  (<= (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume)
  (to_rep2 (last (rt a)))))
  (and
  (and
  (<= (to_rep2 (first (rt b))) (to_rep
                               perm__shift_perm_l__induction_hypothesis__B_5__w__assume1))
  ...
  (= (is_perm
     ...
     (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume))
     (remove b
     (to_rep perm__shift_perm_l__induction_hypothesis__B_5__w__assume1))) true))))))
...
;; H
  (assert
  (and
  (= o6 (remove c (to_rep (rec__perm__witnesses__ia (us_split_fields1 w)))))
  (and (dynamic_invariant1 o6 true false true)
  (and (= (invariant__ o6) true)
  (and (= (to_rep2 (last o5)) (- (to_rep2 (last (rt c))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1)))
  (= (to_rep1 (select (elts c) k)) (to_rep1 (select o4 k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt c)))))
  (= (to_rep1 (select (elts c) k)) (to_rep1 (select o4 (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt c))) 1)))
  (= (to_rep1 (select (elts c) (+ k 1))) (to_rep1 (select o4 k))))))))))))

;; H
  (assert
  (and
  (= o7 (remove b (to_rep (rec__perm__witnesses__ib (us_split_fields1 w)))))
  ...
  (= (to_rep1 (select (elts b) k)) (to_rep1 (select o2 k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt b)))))
  (= (to_rep1 (select (elts b) k)) (to_rep1 (select o2 (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep1 (select (elts b) (+ k 1))) (to_rep1 (select o2 k))))))))))))

;; H
  (assert
  (and
  (= o8 (remove a (to_rep (rec__perm__witnesses__ia (us_split_fields1 w)))))
  ...
  (and (<= 1 k)
  (<= k (- (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1)))
  (= (to_rep1 (select (elts a) k)) (to_rep1 (select o k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt a)))))
  (= (to_rep1 (select (elts a) k)) (to_rep1 (select o (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep (rec__perm__witnesses__ia (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep1 (select (elts a) (+ k 1))) (to_rep1 (select o k))))))))))))

;; H
  (assert
  (and
  (= perm__shift_perm_l__induction_hypothesis__B_5__ih__assume (induction_hypothesis
                                                               o8 o7
                                                               o6))
  (and (in_range1 perm__shift_perm_l__induction_hypothesis__B_5__ih__assume)
  (=>
  (= (of_int perm__shift_perm_l__induction_hypothesis__B_5__ih__assume) true)
  (= (is_perm o6 o7) true)))))

;; H
  (assert (= perm__shift_perm_l__induction_hypothesis__B_5__ih__assume ih))
