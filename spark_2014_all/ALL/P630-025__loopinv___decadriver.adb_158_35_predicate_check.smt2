...
;; H
  ...
  (= o25 (store (rec__decadriver__receiver_type__frame_queue
                (us_split_fields3 self__5)) next_idx1 o53)))
...
;; H
  (assert
  (= o45 (store (rec__decadriver__receiver_type__frame_queue
                (us_split_fields3 self__6)) next_idx1 o52)))
...
;; H
  (assert
  (= (rec__decadriver__receiver_type__queue_head (us_split_fields3 self__6))
  o47))

;; H
  (assert
  (= (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__6))
  o48))

;; H
  (assert
  (= (rec__decadriver__receiver_type__overrun_occurred
     (us_split_fields3 self__6)) o49))

;; H
  (assert
  (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 self__6))
  o50))
...
;; WP_parameter_def
 ;; File "decadriver.ads", line 77, characters 0-0
  ...
  (us_split_fields1
  (select (rec__decadriver__receiver_type__frame_queue
          (us_split_fields3 self__7)) next_idx1)))
  (rec__decadriver__rx_frame_type__frame
  (us_split_fields1
  (select (rec__decadriver__receiver_type__frame_queue
          (us_split_fields3 self__7)) next_idx1)))
