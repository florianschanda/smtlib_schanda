...
(declare-const o15 us_split_fields20)
...
(declare-const result6 us_split_fields__ref10)
...
(declare-const this__split_fields7 us_split_fields__ref10)

(declare-const driveturnrate3 t__ref)
...
(declare-const this__split_fields8 us_split_fields20)
...
(declare-const this__split_fields9 us_split_fields__ref10)

(declare-const driveturnrate5 t__ref)
...
;; H
  (assert
  (=> (= result2 true)
  (= o12 (bearing (mk___rep1 disttogoal__split_fields)))))

;; H
  (assert
  (=> (= result2 true) (and (= o13 (dcast o12)) (fp.isFinite32 o13))))

;; H
  (assert (=> (= result2 true) (= o14 (create__2 o13))))
...
;; H
  (assert (=> (= result2 true) (= temp___981 (mk___rep10 o15))))
...
;; H
  (assert
  (=> (not (= result2 true))
  (= algorithm__step__B_18__safetydeltaangle__assume (create__2 o17))))
...
;; H
  ...
  o19) (fp.leq o19 (fp #b0 #b10000000 #b10010010000111111011011)))))))

;; H
  (assert (=> (not (= result2 true)) (= o20 (fp.abs o19))))
...
;; H
  ...
  (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011))
  o18) (fp.leq o18 (fp #b0 #b10000000 #b10010010000111111011011)))))))

;; H
  (assert (=> (not (= result2 true)) (= o21 (fp.abs o18))))

;; H
  (assert
  (=> (not (= result2 true)) (= result4 (ite (fp.lt o21 o20) true false))))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  ...
  (fp.lt (to_rep3
         ...
         (us_split_fields9
         (rec__algorithm__controller__robot
         (us_split_fields__content10 this__split_fields9))))) (t__content
