...
(declare-fun user_eq4 (long_long_integer long_long_integer) Bool)

(declare-fun dummy4 () long_long_integer)
...
(define-fun bool_eq7 ((a (Array (_ BitVec 64) Bool)) (a__first (_ BitVec 64))
...
(define-fun bool_eq8 ((x us_t1)
  (y us_t1)) Bool (bool_eq7 (elts1 x) (to_rep2 (first2 (rt1 x)))
...
(define-fun dynamic_invariant5 ((temp___expr_27 Int) (temp___is_init_24 Bool)
