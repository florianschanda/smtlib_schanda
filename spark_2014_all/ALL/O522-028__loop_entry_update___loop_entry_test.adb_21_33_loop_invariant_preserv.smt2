...
(declare-const o2 component_t)

(declare-const o3 (Array Int component_t))
...
(declare-const result4 (Array Int component_t))
...
;; H
  (assert
  (= (bool_eq a2 1 1000 (temp___564 a_loop_entry1 first j2 0) 1 1000) true))
...
;; WP_parameter_def
 ;; File "loop_entry_test.ads", line 8, characters 0-0
  (not
  (= (bool_eq a3 1 1000 (temp___564 a_loop_entry1 first j3 0) 1 1000) true)))
(check-sat)
(exit)
