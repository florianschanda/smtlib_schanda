...
(((mk___split_discrs (rec__variants__t__c e)))))
...
(declare-datatypes ((ta__ref 0)) (((mk_ta__ref (ta__content us_rep)))))
...
(declare-datatypes ((tb__ref 0)) (((mk_tb__ref (tb__content us_rep)))))
