...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 index2))
  (= (to_rep (select dest2 j1)) (to_rep (select src j1)))))
  (forall ((j1 Int))
  (=> (and (<= (+ index2 1) j1) (<= j1 10))
  (= (to_rep (select src2 j1)) (to_rep (select src j1)))))))
...
;; H
  ...
  (=> (< index2 temp___171)
  (= (select dest2 temp___171) (select dest temp___171)))))
  (forall ((temp___173 Int))
  (=> (and (<= 1 temp___173) (<= temp___173 10))
  (=> (< index2 temp___173)
  (= (select src2 temp___173) (select src temp___173))))))
