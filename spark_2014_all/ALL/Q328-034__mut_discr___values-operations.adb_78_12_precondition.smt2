...
(((mk_operation__ref (operation__content operation)))))
...
(declare-const v2__split_fields integer)

(declare-const last2 Int)

(declare-const v1__split_fields integer)
...
;; H
  (assert
  (=> (= op 0)
  (and (= o (+ (to_rep v1__split_fields) (to_rep v2__split_fields)))
  (in_range1 (+ (to_rep v1__split_fields) (to_rep v2__split_fields))))))

;; H
  (assert (=> (= op 0) (= result result__)))

;; H
  (assert (=> (= op 0) (= result__1 o)))

;; H
  (assert
  (=> (not (= op 0))
  (=> (= op 1)
  (and (= o1 (div1 (to_rep v1__split_fields) (to_rep v2__split_fields)))
  (in_range1 (div1 (to_rep v1__split_fields) (to_rep v2__split_fields)))))))

;; H
  (assert (=> (not (= op 0)) (=> (= op 1) (= result1 result__))))

;; H
  (assert (=> (not (= op 0)) (=> (= op 1) (= result__2 o1))))
...
;; H
  ...
  (=> (not (= op 1))
  (=> (= op 2)
  (and (= o2 (* (to_rep v1__split_fields) (to_rep v2__split_fields)))
  (in_range1 (* (to_rep v1__split_fields) (to_rep v2__split_fields))))))))

;; H
  (assert
  (=> (not (= op 0)) (=> (not (= op 1)) (=> (= op 2) (= result2 result__)))))

;; H
  (assert
  (=> (not (= op 0)) (=> (not (= op 1)) (=> (= op 2) (= result__3 o2)))))
...
;; H
  ...
  (=> (not (= op 1))
  (=> (not (= op 2))
  (and (= o3 (- (to_rep v1__split_fields) (to_rep v2__split_fields)))
  (in_range1 (- (to_rep v1__split_fields) (to_rep v2__split_fields))))))))

;; H
  (assert
  (=> (not (= op 0))
  (=> (not (= op 1)) (=> (not (= op 2)) (= result3 result__)))))

;; H
  (assert
  (=> (not (= op 0))
  (=> (not (= op 1)) (=> (not (= op 2)) (= result__4 o3)))))

;; H
  (assert
  (=> (not (= op 0))
  (=> (not (= op 1)) (=> (not (= op 2)) (= result__3 result__4)))))

;; H
  (assert (=> (not (= op 0)) (=> (not (= op 1)) (= result__2 result__3))))

;; H
  (assert (=> (not (= op 0)) (= result__1 result__2)))

;; H
  (assert (= (to_rep o4) result__1))
