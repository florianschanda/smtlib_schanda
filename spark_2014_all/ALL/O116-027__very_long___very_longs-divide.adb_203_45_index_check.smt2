...
;; H
  (assert (<= divisor_index1 r129b))

;; H
  (assert
  (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields2) true
  true true) (and (<= 1 divisor_index2) (<= divisor_index2 r129b))))
...
;; H
  ...
  (<= (to_rep1
      (first2
      (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2))))
  temp___1306)
  (<= temp___1306 (to_rep1
                  (last3
                  (rt1
                  (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))

;; H
  (assert (= o17 temp___1306))
