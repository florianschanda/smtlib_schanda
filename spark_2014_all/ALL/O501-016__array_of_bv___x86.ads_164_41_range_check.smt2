...
(declare-fun x86__bl__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__bl__result1 () (_ BitVec 8))

(declare-fun x86__bl__result2 () (_ BitVec 8))

(declare-fun x86__bl__result3 () (_ BitVec 8))

(declare-fun x86__bl__result4 () (_ BitVec 8))

(declare-fun x86__bl__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= x86__bl__result1 ((_ extract 7 0) (bvand rbx ((_ int2bv 64) 255)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand rbx ((_ int2bv 64) 255)))))
(check-sat)
(exit)
