...
(declare-fun temp___186 () status)

(declare-fun temp___1861 () natural)

(declare-fun temp___1862 () natural)

(declare-fun temp___1863 () Bool)

(declare-fun temp___1864 () Bool)
...
;; H
  (assert (= temp___186 o5))

;; H
  (assert (= temp___1861 o2))

;; H
  (assert (= temp___1862 o3))

;; H
  (assert (= temp___1863 o4))
...
;; WP_parameter_def
 ;; File "definite.adb", line 58, characters 0-0
  (not (= temp___186 g__split_discrs)))
(check-sat)
(exit)
