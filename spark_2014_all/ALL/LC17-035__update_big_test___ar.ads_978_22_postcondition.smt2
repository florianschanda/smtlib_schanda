...
(declare-const temp___7012 us_rep2)
...
;; H
  (assert (= r__split_fields6 (us_split_fields5 temp___7012)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 971, characters 0-0
  (not
  (= (to_rep2
     (rec__ar__rec2t__f2
     (us_split_fields3
     (rec__ar__rec3t__f3 (us_split_fields__content2 r__split_fields7)))))
  (to_rep2 (rec__ar__rec2t__f2 (us_split_fields3 a))))))
(check-sat)
(exit)
