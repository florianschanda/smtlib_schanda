...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__gen__segment_type__selector word64)))))
(define-fun us_split_fields_Selector__projection ((a us_split_fields)) word64
...
(declare-fun gen__segment_type__selector__first__bit () Int)

(declare-fun gen__segment_type__selector__last__bit () Int)

(declare-fun gen__segment_type__selector__position () Int)
...
(declare-datatypes ()
((segment_type__ref (mk_segment_type__ref (segment_type__content us_rep)))))
(define-fun segment_type__ref___projection ((a segment_type__ref)) us_rep
...
(define-fun us_split_fields_Regs__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__regs a))

(define-fun us_split_fields_Exit_Reason__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__exit_reason a))

(define-fun us_split_fields_Exit_Qualification__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__exit_qualification a))

(define-fun us_split_fields_Guest_Phys_Addr__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__guest_phys_addr a))

(define-fun us_split_fields_Instruction_Len__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__instruction_len a))

(define-fun us_split_fields_RIP__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__rip a))

(define-fun us_split_fields_RSP__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__rsp a))

(define-fun us_split_fields_CR0__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__cr0 a))

(define-fun us_split_fields_SHADOW_CR0__projection ((a us_split_fields2)) word64
  (rec__gen__subject_state_type__shadow_cr0 a))

(define-fun us_split_fields_LDTR__projection ((a us_split_fields2)) us_rep
...
(declare-fun gen__subject_state_type__regs__first__bit () Int)

(declare-fun gen__subject_state_type__regs__last__bit () Int)

(declare-fun gen__subject_state_type__regs__position () Int)
...
(declare-fun gen__subject_state_type__exit_reason__first__bit () Int)

(declare-fun gen__subject_state_type__exit_reason__last__bit () Int)

(declare-fun gen__subject_state_type__exit_reason__position () Int)
...
(declare-fun gen__subject_state_type__exit_qualification__first__bit () Int)

(declare-fun gen__subject_state_type__exit_qualification__last__bit () Int)

(declare-fun gen__subject_state_type__exit_qualification__position () Int)
...
(declare-fun gen__subject_state_type__guest_phys_addr__first__bit () Int)

(declare-fun gen__subject_state_type__guest_phys_addr__last__bit () Int)

(declare-fun gen__subject_state_type__guest_phys_addr__position () Int)
...
(declare-fun gen__subject_state_type__instruction_len__first__bit () Int)

(declare-fun gen__subject_state_type__instruction_len__last__bit () Int)

(declare-fun gen__subject_state_type__instruction_len__position () Int)
...
(declare-fun gen__subject_state_type__rip__first__bit () Int)

(declare-fun gen__subject_state_type__rip__last__bit () Int)

(declare-fun gen__subject_state_type__rip__position () Int)
...
(declare-fun gen__subject_state_type__rsp__first__bit () Int)

(declare-fun gen__subject_state_type__rsp__last__bit () Int)

(declare-fun gen__subject_state_type__rsp__position () Int)
...
(declare-fun gen__subject_state_type__cr0__first__bit () Int)

(declare-fun gen__subject_state_type__cr0__last__bit () Int)

(declare-fun gen__subject_state_type__cr0__position () Int)
...
(declare-fun gen__subject_state_type__shadow_cr0__first__bit () Int)

(declare-fun gen__subject_state_type__shadow_cr0__last__bit () Int)

(declare-fun gen__subject_state_type__shadow_cr0__position () Int)
...
(declare-fun gen__subject_state_type__ldtr__first__bit () Int)

(declare-fun gen__subject_state_type__ldtr__last__bit () Int)

(declare-fun gen__subject_state_type__ldtr__position () Int)
...
((subject_state_type__ref
 (mk_subject_state_type__ref (subject_state_type__content us_rep1)))))
(define-fun subject_state_type__ref___projection ((a subject_state_type__ref)) us_rep1
  (subject_state_type__content a))

(declare-fun e () us_rep1)
...
(declare-fun gen__get_val__result () Int)

(declare-fun result () Int)

(declare-fun gen__get_val__result1 () Int)

(declare-fun gen__get_val__result2 () Int)

(declare-fun gen__get_val__result3 () Int)

(declare-fun gen__get_val__result4 () Int)

(declare-fun gen__get_val__result5 () Int)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (and
  (and
  (and (= gen__get_val__result1 gen__get_val__result2)
  (= gen__get_val__result3 gen__get_val__result1))
  (and (= result gen__get_val__result) (= gen__get_val__result1 0)))
  (and
  (= (mk_int__ref gen__get_val__result4) (mk_int__ref gen__get_val__result2))
  (= gen__get_val__result5 gen__get_val__result3)))
  (= result1 gen__get_val__result4)))))
(check-sat)
(exit)
