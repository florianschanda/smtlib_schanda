...
(define-fun dynamic_invariant3 ((temp___expr_279 Int)
  ...
  (temp___do_toplevel_278 Bool)) Bool (=>
                                      ...
                                      (<= 1 16)) (in_range1 temp___expr_279)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result1
  bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result3
  bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result1))
...
;; H
  ...
  (= (mk_t__ref result) (mk_t__ref
                        bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result)))
...
;; H
  (assert
  (= (mk_t__ref
     bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result4)
  (mk_t__ref
  bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result2)))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result5
  bits_manipulation_unsigned__unsigned_16__functions__extract_bits_inline__result3))
