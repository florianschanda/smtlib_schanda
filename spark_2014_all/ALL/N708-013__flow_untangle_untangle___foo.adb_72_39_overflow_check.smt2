...
(declare-fun foo__t__g__first__bit () Int)

(declare-fun foo__t__g__last__bit () Int)

(declare-fun foo__t__g__position () Int)
...
(declare-fun temp___2153 () integer)

(declare-fun temp___2154 () integer)

(declare-fun temp___2155 () integer)

(declare-fun result () us_split_fields__ref1)

(declare-fun tmp__split_fields6 () us_split_fields2)
