...
(define-fun register_type__ref_3__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_2__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_2__projection ((a register_byte_array__ref)) us_t1
