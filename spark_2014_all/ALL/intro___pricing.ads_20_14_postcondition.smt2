...
(declare-fun it () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun pricing__price_of_item__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun pricing__price_of_item__result1 () Int)

(declare-fun pricing__price_of_item__result2 () Int)

(declare-fun pricing__price_of_item__result3 () Int)

(declare-fun pricing__price_of_item__result4 () Int)

(declare-fun pricing__price_of_item__result5 () Int)
