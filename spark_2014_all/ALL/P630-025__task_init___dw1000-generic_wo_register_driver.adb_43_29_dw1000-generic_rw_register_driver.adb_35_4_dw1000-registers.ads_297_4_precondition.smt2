...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78331)) (to_rep (last4 temp___78331)))
  temp___78341))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78341)) (to_rep (last2 temp___78341)))
     (+ (- (to_rep (last2 temp___78341)) (to_rep (first2 temp___78341))) 1)
