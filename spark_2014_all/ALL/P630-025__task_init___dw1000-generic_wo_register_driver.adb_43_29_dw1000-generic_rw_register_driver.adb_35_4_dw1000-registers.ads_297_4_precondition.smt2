...
(declare-fun temp___7684 () (Array Int bits_8))

(declare-fun temp___76841 () t1)
...
;; H
  (assert (= temp___7683 temp___7684))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76831)) (to_rep (last4 temp___76831)))
  temp___76841))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76841)) (to_rep (last2 temp___76841)))
     (+ (- (to_rep (last2 temp___76841)) (to_rep (first2 temp___76841))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7684 temp___76841)))
