...
(declare-fun use_private_types__p_holder__content__first__bit () Int)

(declare-fun use_private_types__p_holder__content__last__bit () Int)

(declare-fun use_private_types__p_holder__content__position () Int)
