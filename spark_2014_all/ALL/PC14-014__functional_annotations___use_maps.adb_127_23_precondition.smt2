...
;; H
  (assert
  (and (= o (element s2 (mk___rep1 cu__split_fields3)))
  (and (in_range9 o)
  (= o (get (model__ s2) (key s2 (mk___rep1 cu__split_fields3)))))))

(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 75, characters 0-0
  (not (= (has_key1 (positions s2) (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
