...
(declare-fun b8 () (Array Int element))

(declare-fun i7 () Int)

(declare-fun b9 () (Array Int element))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 100))
  (=> (= (to_rep (select a i10)) (to_rep (select a j))) (= i10 j))))))
  (forall ((i10 Int))
  (=> (and (<= 1 i10) (<= i10 100))
  (not
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 100)) (not (= (to_rep (select a j)) i10)))))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 100))
  (= (to_rep (select b6 (to_rep (select a j)))) j))))
