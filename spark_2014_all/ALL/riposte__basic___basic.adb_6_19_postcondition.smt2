...
(define-fun dynamic_invariant ((temp___expr_135 Int)
  ...
  (temp___do_toplevel_134 Bool)) Bool (=>
                                      ...
                                      (<= 0 255)) (in_range temp___expr_135)))
...
(declare-fun basic__add_ub__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun basic__add_ub__result1 () Int)

(declare-fun basic__add_ub__result2 () Int)

(declare-fun basic__add_ub__result3 () Int)

(declare-fun basic__add_ub__result4 () Int)

(declare-fun basic__add_ub__result5 () Int)
...
;; H
  (assert
  (= (mk_int__ref basic__add_ub__result4) (mk_int__ref
                                          basic__add_ub__result2)))
...
;; WP_parameter_def
 ;; File "basic.adb", line 3, characters 0-0
  (not (= basic__add_ub__result4 (+ a b))))
(check-sat)
(exit)
