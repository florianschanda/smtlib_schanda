...
;; lemma6__def_axiom
  ...
  (! (= (= (lemma61 us_void_param) true)
     ...
     (=> (not (= val__ ((_ int2bv 32) 0)))
     (and (= (shift_right val__ 0) val__)
     (exists ((n Int))
     (and (and (<= 0 n) (<= n 31))
     (and
     (and (= (shift_right val__ n) ((_ int2bv 32) 1))
     (forall ((j Int))
     (=> (and (<= 0 j) (<= j n))
...
;; H
  (assert (= result2 (ite (= o ((_ int2bv 32) 1)) true false)))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i2))
  (bvugt (shift_right value j) ((_ int2bv 32) 1)))))

;; H
  (assert
  (and
  (and (=> (<= 0 31) (in_range1 result__2)) (=> (<= 0 31) (in_range1 i2)))
  (and (<= 0 i2) (<= i2 31))))
...
;; H
  ...
  (= o1 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< i3 8)
                            (bvlshr ((_ extract 7 0) value) ((_ int2bv 8)
                            i3)) ((_ int2bv 8) 0)))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< i3 16)
                            (bvlshr ((_ extract 15 0) value) ((_ int2bv 16)
                            i3)) ((_ int2bv 16) 0)))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32)
        i3))
...
;; H
  (assert (= result5 (ite (= o1 ((_ int2bv 32) 1)) true false)))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  (not (bvugt (shift_right value j) ((_ int2bv 32) 1))))
(check-sat)
(exit)
