...
;; H
  (assert
  (and
  (= o37 (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1135 o37))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1135 o37)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o37))
...
;; H
  (assert (= o38 (select temp___1135 x1)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1134 o33))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1134 o33)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o33))
...
;; H
  (assert (= o34 (select temp___1134 i1)))
...
;; H
  ...
  (and (= o41 (olt o36 o40))
  (= (= o41 true)
  (and (< (length o36) (length o40))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o36))) (= (get o36 n) (get o40 n))))))))
