...
(declare-fun temp___414 () (Array Int integer))
...
;; H
  (assert
  (= o1 (slide temp___414 (to_rep (first temp___4141)) (to_rep a__first))))
...
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 9, characters 0-0
  (not
  (= (let ((temp___421 (temp___234
                       (mk___t a (mk (to_rep a__first) (to_rep a__last))) 1
                       i new_val)))
     (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___421)
     (to_rep (first (rt temp___421))) (to_rep (last (rt temp___421))))) true)))
(check-sat)
(exit)
