...
;; H
  ...
  (and (in_range5 o12)
  (=> (= (of_int 0) true)
  (and (= o12 (w_get o8 (witness o8 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o8 k) true)
  (= (= (bool_eq3 k cu) true) (= (witness o8 cu) (witness o8 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o6 j) true)
  (=> (= (get1 o6 i1) (get1 o6 j)) (= (bool_eq3 i1 j) true))))))))))

;; H
  (assert
  (and (= o7 (has_key o6 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o6 k) true) (= (bool_eq3 k cu) true))) (= o7 true)))))
