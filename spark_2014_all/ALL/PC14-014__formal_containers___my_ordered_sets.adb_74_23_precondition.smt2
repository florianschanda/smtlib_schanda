...
(declare-fun m__split_fields3 () us_split_fields)
...
;; H
  (assert
  (= m__split_fields3 (us_split_fields1
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs m__split_fields4))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs m__split_fields4))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
  (= (length (mk___rep m__split_discrs m__split_fields4)) (length
                                                          (mk___rep
                                                          k__split_discrs
                                                          k__split_fields3)))))
...
;; H
  (assert
  (= (oeq
     (intersection__2 (mk___rep m__split_discrs m__split_fields4)
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep m__split_discrs m__split_fields5)) (num_overlaps
                                                          (model__
                                                          (mk___rep
                                                          m__split_discrs
                                                          m__split_fields4))
                                                          ...
                                                          l__split_discrs
                                                          l__split_fields11))))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields5))
     (model__ (mk___rep m__split_discrs m__split_fields4))) true))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields5))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (includes_intersection
  ...
  (= (e_elements_included
     ...
     (elements (mk___rep m__split_discrs m__split_fields4))) true))
  (= (e_elements_included__2
     (elements (mk___rep m__split_discrs m__split_fields4))
     (model__ (mk___rep l__split_discrs l__split_fields11))
  ...
  (= (mapping_preserved
     ...
     (positions (mk___rep m__split_discrs m__split_fields4))) true)))
...
;; H
  (assert
  (= m__split_fields6 (us_split_fields1
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs1 m__split_fields7))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs1 m__split_fields7))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
  (= (length (mk___rep m__split_discrs1 m__split_fields7)) (length
                                                           (mk___rep
                                                           k__split_discrs
                                                           k__split_fields3)))))
...
;; H
  (assert
  (= (oeq
     (union__2 (mk___rep m__split_discrs1 m__split_fields7)
     (mk___rep l__split_discrs l__split_fields11))
...
;; H
  (assert
  (= (equivalent_sets
     (intersection__2 (mk___rep m__split_discrs1 m__split_fields7)
     (mk___rep l__split_discrs l__split_fields11))
     (intersection__2 (mk___rep k__split_discrs k__split_fields3)
     (mk___rep l__split_discrs l__split_fields11))) true))
...
;; H
  ...
  (= (length (mk___rep m__split_discrs1 m__split_fields8)) (+ (- (length
                                                                 ...
                                                                 m__split_discrs1
                                                                 m__split_fields7))
  (num_overlaps (model__ (mk___rep m__split_discrs1 m__split_fields7))
  (model__ (mk___rep l__split_discrs l__split_fields11)))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields11))))
  (= (ole (model__ (mk___rep m__split_discrs1 m__split_fields7))
  ...
  (= (included_in_union
     ...
     (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep m__split_discrs1 m__split_fields7))) true))
  (= (e_elements_included__3
     (elements (mk___rep m__split_discrs1 m__split_fields8))
     (model__ (mk___rep m__split_discrs1 m__split_fields7))
     (elements (mk___rep m__split_discrs1 m__split_fields7))
     (elements (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included__2
     (elements (mk___rep m__split_discrs1 m__split_fields7))
     (model__ (mk___rep m__split_discrs1 m__split_fields7))
  ...
  (= (mapping_preserved
     (elements (mk___rep m__split_discrs1 m__split_fields7))
     (elements (mk___rep m__split_discrs1 m__split_fields8))
     (positions (mk___rep m__split_discrs1 m__split_fields7))
     (positions (mk___rep m__split_discrs1 m__split_fields8))) true)))
...
;; H
  (assert
  (= m__split_fields9 (us_split_fields1
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs2 m__split_fields10))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs2 m__split_fields10))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
  (= (length (mk___rep m__split_discrs2 m__split_fields10)) (length
                                                            (mk___rep
                                                            k__split_discrs
                                                            k__split_fields3)))))
...
;; H
  (assert
  (= (oeq
     (difference__2 (mk___rep m__split_discrs2 m__split_fields10)
     (mk___rep l__split_discrs l__split_fields11))
...
;; H
  ...
  (= (length (mk___rep m__split_discrs2 m__split_fields11)) (- (length
                                                               ...
                                                               m__split_discrs2
                                                               m__split_fields10))
  (num_overlaps (model__ (mk___rep m__split_discrs2 m__split_fields10))
  (model__ (mk___rep l__split_discrs l__split_fields11)))))
  (= (ole (model__ (mk___rep m__split_discrs2 m__split_fields11))
     (model__ (mk___rep m__split_discrs2 m__split_fields10))) true))
  (= (no_overlap (model__ (mk___rep m__split_discrs2 m__split_fields11))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union
     (model__ (mk___rep m__split_discrs2 m__split_fields10))
     (model__ (mk___rep m__split_discrs2 m__split_fields11))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included
     (elements (mk___rep m__split_discrs2 m__split_fields11))
     (elements (mk___rep m__split_discrs2 m__split_fields10))) true))
  (= (e_elements_included__2
     (elements (mk___rep m__split_discrs2 m__split_fields10))
     (model__ (mk___rep m__split_discrs2 m__split_fields11))
     (elements (mk___rep m__split_discrs2 m__split_fields11))) true))
  (= (mapping_preserved
     (elements (mk___rep m__split_discrs2 m__split_fields11))
     (elements (mk___rep m__split_discrs2 m__split_fields10))
     (positions (mk___rep m__split_discrs2 m__split_fields11))
     (positions (mk___rep m__split_discrs2 m__split_fields10))) true)))

(assert
;; WP_parameter_def
 ;; File "my_ordered_sets.adb", line 189, characters 0-0
  (not
  (<= (length (mk___rep k__split_discrs k__split_fields3)) (- 2147483647
  (length (mk___rep l__split_discrs l__split_fields11))))))
(check-sat)
(exit)
