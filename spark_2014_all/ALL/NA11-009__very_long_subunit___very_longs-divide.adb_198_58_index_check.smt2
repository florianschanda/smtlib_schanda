...
(declare-const temp___1298 digit_index_type)

(declare-const temp___12981 (Array Int octet))

(declare-const temp___12982 t)
...
;; H
  (assert (= quotient__split_discrs (mk___split_discrs temp___1298)))

;; H
  (assert (= temp___12981 o5))

;; H
  (assert (= temp___12982 o6))
...
;; H
  ...
  (= quotient__split_fields2 (mk___split_fields
                             (mk___t temp___12981 temp___12982))))
