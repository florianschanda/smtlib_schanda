...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o51) true false))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o50 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o48) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result14 true)
  (= result11 (ite (= o47 first_allocated1) true false))))))
