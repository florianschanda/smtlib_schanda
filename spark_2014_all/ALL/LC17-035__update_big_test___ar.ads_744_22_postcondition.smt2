...
(declare-fun temp___6624 () et1)

(declare-fun temp___66241 () et2)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 736, characters 0-0
  (not
  (= (bool_eq2
     (mk___rep (mk___split_fields r__split_fields6 r__split_fields7))
     (mk___rep
     (mk___split_fields (of_rep 25)
     (rec__ar__rec1t__g1 (us_split_fields1 s))))) true)))
(check-sat)
