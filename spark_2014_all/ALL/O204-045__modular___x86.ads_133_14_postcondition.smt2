...
;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__dh__result)))

;; H
  (assert
  (= x86__dh__result1 ((_ extract 7 0) (bvurem (bvudiv (bvand rdx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= x86__dh__result4 ((_ extract 7 0) (bvurem (bvudiv (bvand rdx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256))))))
(check-sat)
(exit)
