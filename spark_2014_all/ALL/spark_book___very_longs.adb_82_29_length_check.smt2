...
;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1151 ((_ int2bv 8) 0) 1 r19b)))) r19b))
...
;; WP_parameter_def
 ;; File "very_longs.adb", line 49, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first4 temp___11581)) (to_rep2 (last4 temp___11581)))
     (+ (- (to_rep2 (last4 temp___11581)) (to_rep2 (first4 temp___11581))) 1)
