...
(declare-datatypes ((t45s__ref 0)) (((mk_t45s__ref (t45s__content t45s)))))
...
(declare-datatypes ((t47s__ref 0)) (((mk_t47s__ref (t47s__content t47s)))))
...
(declare-datatypes ((t49s__ref 0)) (((mk_t49s__ref (t49s__content t49s)))))
...
(declare-datatypes ((t51s__ref 0)) (((mk_t51s__ref (t51s__content t51s)))))
...
(declare-datatypes ((t53s__ref 0)) (((mk_t53s__ref (t53s__content t53s)))))
...
;; WP_parameter_def
 ;; File "arr_aggregate.ads", line 3, characters 0-0
  (not (= (bool_eq a1 1 2 (temp___192 one 2) 1 2) true)))
(check-sat)
(exit)
