...
;; H
  (assert
  (= o109 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o108)))
...
;; H
  (assert (= o112 (ite (<= 0 o107) true false)))

;; H
  (assert (= result22 (ite (= o112 true) o111 false)))
