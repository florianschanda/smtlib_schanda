...
(declare-fun dummy8 () descriptioni)
...
(declare-fun dummy14 () adminprivileget)
...
(declare-fun dummy15 () t1)

(declare-datatypes () ((t__ref1 (mk_t__ref1 (t__content1 t1)))))
(define-fun t__ref_3__projection ((a t__ref1)) t1 (t__content1 a))
...
(declare-fun dummy16 () t2)

(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 t2)))))
(define-fun t__ref_4__projection ((a t__ref2)) t2 (t__content2 a))
...
(declare-fun o5 () yearst)

(declare-fun o6 () monthst)

(declare-fun o7 () dayst)

(declare-fun o8 () millisecst)

(declare-fun o9 () yearst)

(declare-fun o10 () monthst)

(declare-fun o11 () dayst)

(declare-fun o12 () millisecst)
...
(declare-fun filestate2 () us_private__ref)
...
(declare-fun state22 () us_private__ref)
...
(define-fun o49 () us_rep1 (mk___rep1 (mk___split_fields1 o9 o10 o11 o12)))

(define-fun o50 () us_rep1 (mk___rep1 (mk___split_fields1 o5 o6 o7 o8)))
...
;; H
  (assert (= result2 (ite (= o41 1) true false)))
...
;; H
  (assert (=> (= result2 true) (= o46 (ite (not (= o45 true)) true false))))
...
;; H
  (assert (=> (= result2 true) (= o43 (ite (= o42 3) true false))))
...
;; H
  (assert (=> (= result2 true) (= o47 (ite (= o44 true) o43 false))))

;; H
  (assert (=> (= result2 true) (= o48 (ite (= o47 false) o46 true))))

;; H
  (assert (=> (not (= result2 true)) (= o48 (of_int 1))))
...
;; H
  (assert (= o37 (ite (= o36 3) true false)))
...
;; H
  (assert (= result3 (ite (= o38 true) o37 false)))
...
;; H
  (assert (=> (= result3 true) (= o40 (ite (= o39 1) true false))))

;; H
  (assert (=> (not (= result3 true)) (= o40 (of_int 1))))

;; H
  (assert (= o28 (islocked (us_private__content state21))))

;; H
  (assert (= o29 (ite (not (= o28 true)) true false)))

;; H
  (assert (= result4 (ite (= o29 true) (islocked state1) false)))

;; H
  (assert
  (=> (= result4 true)
  (and (= o32 (theauthcertrole (us_private__content state20))) (in_range4
  o32))))

;; H
  (assert (=> (= result4 true) (= o33 (ite (= o32 1) true false))))

;; H
  (assert
  (=> (= result4 true) (= o30 (authcertvalid (us_private__content state20)))))

;; H
  (assert
  (=> (= result4 true) (= o31 (isgood (us_private__content state20)))))

;; H
  (assert (=> (= result4 true) (= o34 (ite (= o31 true) o30 false))))

;; H
  (assert (=> (= result4 true) (= o35 (ite (= o34 true) o33 false))))

;; H
  (assert (=> (not (= result4 true)) (= o35 (of_int 1))))
...
;; H
  (assert (= result5 (ite (= o21 1) true false)))

;; H
  (assert
  (=> (= result5 true)
  (and (= o24 (theauthcertrole (us_private__content state20))) (in_range4
  o24))))

;; H
  (assert (=> (= result5 true) (= o25 (ite (= o24 1) true false))))

;; H
  (assert
  (=> (= result5 true) (= o22 (authcertvalid (us_private__content state20)))))

;; H
  (assert
  (=> (= result5 true) (= o23 (isgood (us_private__content state20)))))

;; H
  (assert (=> (= result5 true) (= o26 (ite (= o23 true) o22 false))))

;; H
  (assert (=> (= result5 true) (= o27 (ite (= o26 true) o25 false))))

;; H
  (assert (=> (not (= result5 true)) (= o27 (of_int 1))))

;; H
  (assert
  (and (= o16 (thedooralarm (us_private__content state22))) (in_range15 o16)))

;; H
  (assert (= o17 (ite (= o16 0) true false)))

;; H
  (assert (= o18 (to_int1 o17)))

;; H
  (assert (= o49 (alarm_timeout (us_private__content state22))))

;; H
  (assert (= o50 (thecurrenttime currenttime)))

;; H
  (assert (= o13 (greaterthanorequal o50 o49)))

;; H
  (assert
  (and (= o2 (thecurrentdoor (us_private__content state22))) (in_range14 o2)))

;; H
  (assert (= o3 (ite (= o2 0) true false)))

;; H
  (assert (= o4 (islocked (us_private__content state21))))

;; H
  (assert (= o14 (ite (= o4 true) o3 false)))

;; H
  (assert (= o15 (ite (= o14 true) o13 false)))

;; H
  (assert (= o19 (to_int1 o15)))

;; H
  (assert (= o20 (ite (= o19 o18) true false)))
