...
(declare-fun temp___4667 () (Array Int (Array Int et1)))
...
;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (and (= o10 (- e 1)) (in_range2 (- e 1))))))
...
;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (and (= o13 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (< j 50)
  (=> (< 0 e)
  (= temp___4662 (temp___967 a j (temp___975 (select a j) i e) o13 o12)))))

;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (= result6 (bool_eq1 a3 5 50 temp___4662 5 50)))))
...
;; H
  (assert
  (=> (< j 50) (=> (not (= result6 true)) (=> (= e 0) (= o5 (+ j 1))))))

;; H
  (assert
  (=> (< j 50) (=> (not (= result6 true)) (=> (= e 0) (= o6 (select a o5))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result6 true)) (=> (= e 0) (= o7 (temp___1005 o6 i 99))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result6 true))
  (=> (= e 0) (and (= o8 (+ j 1)) (in_range1 (+ j 1)))))))
...
;; H
  ...
  (=> (not (= result6 true))
  (=> (= e 0)
  (= temp___4667 (temp___990 a j (temp___998 (select a j) i e) o8 o7))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result6 true))
  (=> (= e 0) (= result5 (bool_eq1 a3 5 50 temp___4667 5 50))))))
