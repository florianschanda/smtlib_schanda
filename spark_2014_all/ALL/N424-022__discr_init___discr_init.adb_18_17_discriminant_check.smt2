...
;; H
  ...
  (mk___rep1 x__split_discrs (mk___split_fields1 x__split_fields)) false))
...
;; H
  (assert (default_initial_assumption
  (mk___rep1 y__split_discrs (mk___split_fields1 y__split_fields)) false))
...
;; WP_parameter_def
 ;; File "discr_init.adb", line 1, characters 0-0
  (not (discr_init__r1__arr__pred1
  (mk___rep1 y__split_discrs (mk___split_fields1 y__split_fields)))))
(check-sat)
(exit)
