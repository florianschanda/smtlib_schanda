...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 62.0)))

(declare-fun fliteral3 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 2835.0)))
...
;; H
  ...
  (= o (mul RNE1
       (mul RNE1
       (mul RNE1
       (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 x x) x) x) x) x) 
       x) x) x)))))

;; H
  (assert (= o1 (mul RNE1 fliteral2 o)))
