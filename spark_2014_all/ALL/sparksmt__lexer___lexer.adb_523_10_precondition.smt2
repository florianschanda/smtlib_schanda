...
;; WP_parameter_def
 ;; File "lexer.ads", line 65, characters 0-0
  (not
  (= (local_invariant (us_split_fields__content current_read__split_fields29)
     (us_split_discrs__content current_read__split_discrs29)
     (us_split_fields__content next_read__split_fields29)
     (us_split_discrs__content next_read__split_discrs29)) true)))
(check-sat)
(exit)
