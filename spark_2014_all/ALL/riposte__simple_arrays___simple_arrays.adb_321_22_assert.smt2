...
;; def_axiom
  (assert
  (forall ((temp___550 (Array Int integer)))
  (forall ((temp___551 Int) (temp___552 Int))
  (let ((temp___549 (temp___548 temp___550 temp___551 temp___552)))
  (forall ((temp___553 Int))
  (ite (= temp___553 temp___551)
  (= (select temp___549 temp___553) (of_rep temp___552))
  (= (select temp___549 temp___553) (select temp___550 temp___553))))))))

(declare-fun temp___555 ((Array Int integer) Int Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___557 (Array Int integer)))
  (forall ((temp___558 Int) (temp___559 Int))
  (let ((temp___556 (temp___555 temp___557 temp___558 temp___559)))
  (forall ((temp___560 Int))
  (ite (= temp___560 temp___558)
  (= (select temp___556 temp___560) (of_rep temp___559))
  (= (select temp___556 temp___560) (select temp___557 temp___560))))))))
...
;; H
  (assert
  (= (bool_eq1 d (- 2147483648) 2147483647 (temp___548 c i 42) (- 2147483648)
     2147483647) true))
...
;; H
  (assert
  (= (bool_eq1 g (- 2147483648) 2147483647 (temp___555 f i 42) (- 2147483648)
     2147483647) true))
