...
(declare-const temp___7961 (Array Int bits_8))

(declare-const temp___79611 t2)

(declare-const temp___7962 (Array Int bits_8))

(declare-const temp___79621 t1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7962 temp___79621)))
