...
(define-fun dynamic_invariant ((temp___expr_558 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_570 Int)
...
(define-fun default_initial_assumption ((temp___expr_577 us_rep)
  (temp___skip_top_level_578 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_578 true))
                                         (= (length temp___expr_577) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_564 Int)
  (temp___is_init_561 Bool) (temp___skip_constant_562 Bool)
  (temp___do_toplevel_563 Bool)) Bool (=>
                                      (or (= temp___is_init_561 true)
                                      (<= (- 2147483648) 2147483647))
                                      (in_range5 temp___expr_564)))
