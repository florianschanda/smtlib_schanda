...
(declare-fun temp___185 (us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___187 us_rep))
  (forall ((temp___188 Int))
  (= (select (temp___185 temp___187) temp___188) temp___187))))

(declare-fun temp___189 (Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___191 Int))
  (forall ((temp___192 Int))
  (= (select (temp___189 temp___191) temp___192) (of_rep1 temp___191)))))

(declare-fun temp___193 (Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___195 Int))
  (forall ((temp___196 Int))
  (= (select (temp___193 temp___195) temp___196) (of_rep1 temp___195)))))
...
;; H
  (assert (= o5 (temp___185 (mk___rep (mk___split_fields o3 o4)))))
...
(assert
;; WP_parameter_def
 ;; File "array_aggregates.adb", line 15, characters 0-0
  (not
  (= (bool_eq1 (select x1 n)
     (mk___rep (mk___split_fields (of_rep 0) (temp___193 32)))) true)))
(check-sat)
(exit)
