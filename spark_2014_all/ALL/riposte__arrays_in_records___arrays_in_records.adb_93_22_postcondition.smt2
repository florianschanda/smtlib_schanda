...
(declare-const temp___235 index)

(declare-const temp___2351 (Array Int value))

(declare-const temp___2352 (Array Int value))
...
(declare-const temp___238 index)

(declare-const temp___2381 (Array Int value))

(declare-const temp___2382 (Array Int value))
...
;; H
  (assert (= temp___235 o2))

;; H
  (assert (= temp___2351 o3))

;; H
  (assert (= temp___2352 o4))
...
;; H
  (assert (= temp___235 a__split_fields3))

;; H
  (assert (= temp___2351 a__split_fields4))

;; H
  (assert (= temp___2352 a__split_fields5))

;; H
  (assert (= (to_rep o5) 23))

;; H
  (assert (= o6 (store a__split_fields4 i o5)))
...
;; H
  (assert (= temp___238 a__split_fields6))

;; H
  (assert (= temp___2381 a__split_fields7))

;; H
  (assert (= temp___2382 a__split_fields8))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 83, characters 0-0
  (not (= (to_rep (select a__split_fields10 i)) 42)))
(check-sat)
(exit)
