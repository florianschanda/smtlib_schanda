...
(declare-fun loops_static__loop9__result () Bool)
...
(declare-fun loops_static__loop9__result1 () Bool)
...
(declare-fun loops_static__loop9__result2 () Bool)

(declare-fun bad3 () Bool)

(declare-fun j4 () Int)

(declare-fun loops_static__loop9__result3 () Bool)
...
;; H
  (assert
  (= (mk_bool__ref loops_static__loop9__result2) (mk_bool__ref
                                                 loops_static__loop9__result)))
