...
;; H
  (assert
  (and (= o16 (current_line line last_char)) (dynamic_invariant2 o16 true
  false true)))
...
;; H
  (assert
  (=> (= (length temp___6112) 0)
  (= (temp___String_Literal_610 Tuple0) temp___613)))
...
;; H
  (assert
  (=> (not (= (length temp___6112) 0)) (=> (<= 1 2) (= o5 (+ (- 2 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length temp___6112) 0))
  (= o8 (+ (to_rep1 (first temp___6111)) o7))))
...
;; H
  (assert
  (=> (not (= (length temp___6112) 0)) (and (= o10 o9) (in_range2 o9))))

;; H
  (assert
  (=> (not (= (length temp___6112) 0))
  (= (concat1 temp___611 (to_rep1 (first temp___6111))
     (to_rep1 (last temp___6111)) (temp___String_Literal_610 Tuple0) 1 2) 
  temp___613)))

;; H
  (assert
  (=> (not (= (length temp___6112) 0))
  (= (mk (to_rep1 (first temp___6111)) o10) temp___6131)))
...
;; H
  ...
  (= o11 (+ (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))) (= o11 0)))

;; H
  (assert
  (=> (<= (to_rep1 (first temp___6131)) (to_rep1 (last temp___6131)))
  (= o12 (+ (- (to_rep1 (last temp___6131)) (to_rep1 (first temp___6131))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___6131)) (to_rep1 (last temp___6131))))
  (= o12 0)))
