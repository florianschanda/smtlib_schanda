...
;; H
  (assert (= result1 (ite (<= o7 10000) true false)))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o5) true false)))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
        1))
  (in_range6 o4))))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result (ite (= o4 first_available) true false))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (not (= result2 true)) (= result false)))))
...
;; H
  (assert
  (and
  (= o3 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
        j))
  (in_range6 o3)))

;; H
  (assert (= result4 (ite (in_range3 o3) true false)))
