...
(declare-fun temp___254 () integer)

(declare-fun temp___2541 () natural)

(declare-fun temp___2542 () my_range)

(declare-fun temp___2543 () integer)
...
(declare-fun temp___256 () integer)

(declare-fun temp___2561 () natural)

(declare-fun temp___2562 () my_range)

(declare-fun temp___2563 () integer)
...
;; H
  (assert (= temp___254 o1))

;; H
  (assert (= temp___2541 o2))

;; H
  (assert (= temp___2542 o3))

;; H
  (assert (= temp___2543 o4))
...
;; H
  (assert (= temp___254 r__split_fields4))

;; H
  (assert (= temp___2541 r__split_fields5))

;; H
  (assert (= temp___2542 r__split_fields6))

;; H
  (assert (= temp___2543 r__split_fields7))

;; H
  (assert (= (to_rep o5) (to_rep r__split_fields4)))
...
;; H
  (assert (= temp___256 o6))

;; H
  (assert (= temp___2561 o7))

;; H
  (assert (= temp___2562 o8))

;; H
  (assert (= temp___2563 o9))
...
;; H
  (assert (= temp___256 r__split_fields8))

;; H
  (assert (= temp___2561 r__split_fields9))

;; H
  (assert (= temp___2562 r__split_fields10))

;; H
  (assert (= temp___2563 r__split_fields11))
...
;; H
  (assert (= r__split_fields16 r__split_fields8))

;; H
  (assert (= r__split_fields17 r__split_fields9))

;; H
  (assert (= r__split_fields18 r__split_fields10))

;; H
  (assert (= r__split_fields19 r__split_fields11))

(assert
;; WP_parameter_def
 ;; File "records.ads", line 40, characters 0-0
  (not
  (= (bool_eq3
     (mk___rep
     ...
     r__split_fields15))
     (mk___rep
     (mk___split_fields r__split_fields (of_rep1 2) r__split_fields2
