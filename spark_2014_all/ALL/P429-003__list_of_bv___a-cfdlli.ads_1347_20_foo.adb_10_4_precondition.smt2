...
(declare-const temp___445 count_type)
...
;; H
  (assert (= temp___445 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___445)) no_element))
...
;; H
  ...
  (and (in_range1 o3)
  (<= o3 (to_rep
         (rec__foo__lists__list__capacity (us_split_discrs1 container)))))))
