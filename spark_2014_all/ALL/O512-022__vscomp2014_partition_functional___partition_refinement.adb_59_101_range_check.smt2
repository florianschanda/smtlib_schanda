...
;; H
  ...
  (<= (to_rep1
      ...
      (get
      (model__
      (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j10)))) k1)
  (<= k1 (to_rep1
         (rec__partition_refinement__interval__last
         (us_split_fields1
         (get
...
;; H
  ...
  (and
  (<= (to_rep1
      (rec__partition_refinement__interval__first p_prime__split_fields5)) k1)
  (<= k1 i4)) (= (to_rep2 (select f4 k1)) p_prime_index3)))))))
...
;; H
  ...
  (= (to_rep2 (select f4 k1)) (to_rep2 (select f_loop_entry k1)))))))))
...
;; H
  ...
  (<= k1 (to_rep1
         (rec__partition_refinement__interval__last p_prime__split_fields5))))
  (= (to_rep2 (select (map__content f7) k1)) (- (length
                                                (mk___rep1 p__split_discrs
                                                p__split_fields4)) 1)))))))
...
;; H
  ...
  (<= k1 (- (to_rep1
            (rec__partition_refinement__interval__first
            p_prime__split_fields5)) 1)))
  (and (<= 0 (to_rep2 (select (map__content f7) k1)))
  (<= (to_rep2 (select (map__content f7) k1)) (- (length
                                                 (mk___rep1 p__split_discrs
                                                 p__split_fields4)) 1))))))))
...
;; H
  ...
  (and
  (<= (+ (to_rep1
         (rec__partition_refinement__interval__last p_prime__split_fields5)) 1) k1)
  (<= k1 5))
  (and (<= 0 (to_rep2 (select (map__content f7) k1)))
  (<= (to_rep2 (select (map__content f7) k1)) (- (length
                                                 (mk___rep1 p__split_discrs
...
;; H
  ...
  (and
  (<= (to_rep1
      (rec__partition_refinement__interval__first p_elem__split_fields7)) k1)
  (<= k1 (to_rep1
...
;; H
  ...
  (<= (to_rep1
      ...
      (us_split_fields1
      (get (model__ (mk___rep1 p__split_discrs p__split_fields4))
      (to_rep2 (select (map__content f7) k1)))))) k1)
  (<= k1 (to_rep1
         (rec__partition_refinement__interval__last
         (us_split_fields1
         (get (model__ (mk___rep1 p__split_discrs p__split_fields4))
...
;; H
  ...
  (<= (to_rep1
      (rec__partition_refinement__interval__first
      (us_split_fields1
      (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) k1)))) l)
  (<= l (to_rep1
        (rec__partition_refinement__interval__last
        (us_split_fields1
        (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) k1))))))
  (= (to_rep2 (select (map__content f7) l)) k1))))))))
...
;; H
  ...
  (=>
  (and (<= (+ j3 1) k1)
  (<= k1 (- (length (mk___rep1 p__split_discrs p__split_fields4)) 1)))
  (forall ((l Int))
  (=>
  (and
  (<= (to_rep1
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 5))
  (and (<= 0 (to_rep2 (select (map__content f9) k1)))
  (<= (to_rep2 (select (map__content f9) k1)) (- (length
                                                 (mk___rep1 p__split_discrs
...
;; H
  ...
  (<= (to_rep1
      ...
      (to_rep2 (select (map__content f9) k1)))))) k1)
  (<= k1 (to_rep1
         (rec__partition_refinement__interval__last
         (us_split_fields1
         (get
         ...
         (mk___rep1 p__split_discrs
         (us_split_fields__content1 p__split_fields5)))
         (to_rep2 (select (map__content f9) k1))))))))))))
...
;; H
  ...
  (<= (to_rep1
      ...
      (model__
      (mk___rep1 p__split_discrs
      (us_split_fields__content1 p__split_fields5))) k1)))) l)
  (<= l (to_rep1
        (rec__partition_refinement__interval__last
        (us_split_fields1
        (get
        (model__
        (mk___rep1 p__split_discrs
        (us_split_fields__content1 p__split_fields5))) k1))))))
  (= (to_rep2 (select (map__content f9) l)) k1)))))))
...
;; H
  ...
  (= o18 (get
         (model__
         (mk___rep1 p__split_discrs
         (us_split_fields__content1 p__split_fields11))) o17))
  (= (bool_eq o18
     (get
     (model__
     (mk___rep1 p__split_discrs
     (us_split_fields__content1 p__split_fields11))) o17)) true)))

;; H
  (assert (= o19 (us_split_fields1 o18)))

;; H
  (assert (= o20 (rec__partition_refinement__interval__last o19)))

;; H
  (assert (= o21 (to_rep1 o20)))

;; H
  (assert (= o22 (ite (<= k o21) true false)))
