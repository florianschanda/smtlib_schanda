...
(declare-fun temp___6122 () Int)

(declare-fun int__5 () int__ref)

(declare-fun int__6 () Int)

(declare-fun rho () Int)

(declare-fun int__7 () int__ref)

(declare-fun int__8 () Int)
...
;; H
  (assert
  (and (= o5 (next c12b temp___6172))
  (= o5 (ite (< (to_rep1 temp___6171) 200)
        (mk___rep1
        (mk___split_fields1 (of_rep1 (+ (to_rep1 temp___6171) 1))))
        (mk___rep1 (mk___split_fields1 (of_rep1 0)))))))

;; H
  (assert
  (and (= o4 (has_element c12b o5))
  (= (= o4 true) (and (<= 1 (to_rep1 o3)) (<= (to_rep1 o3) 200)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (has_element c12b temp___6172) true)))
(check-sat)
(exit)
