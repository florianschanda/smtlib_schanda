...
(declare-fun dummy6 () descriptioni)
...
;; range_axiom
  (assert
  (forall ((x yearst)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x monthst)) (! (in_range8 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
;; range_axiom
  (assert
  (forall ((x dayst)) (! (in_range9 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(declare-fun dummy10 () millisecst)
...
(define-fun dynamic_invariant2 ((temp___expr_833 Int)
  ...
  (temp___do_toplevel_832 Bool)) Bool (=>
                                      ...
                                      (<= 0 1)) (in_range11 temp___expr_833)))
...
;; thecurrentdoor__post_axiom
  ...
  (! (=> (dynamic_invariant3 door__currentdoor true true true)
     (dynamic_invariant3 (thecurrentdoor door__currentdoor) true false true)) :pattern (
...
;; temp___String_Literal_844__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 1)) 68)
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 2)) 79))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 3)) 79))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 4)) 82))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 5)) 32))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 6)) 83))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 7)) 84))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 8)) 65))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 9)) 84))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 10)) 69))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 11)) 32))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 12)) 67))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 13)) 65))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 14)) 78))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 15)) 78))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 16)) 79))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 17)) 84))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 18)) 32))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 19)) 66))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 20)) 69))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 21)) 32))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 22)) 68))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 23)) 69))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 24)) 84))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 25)) 69))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 26)) 82))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 27)) 77))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 28)) 73))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 29)) 78))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 30)) 69))
     (= (to_rep (select (temp___String_Literal_844 us_void_param) 31)) 68)) :pattern (
...
(define-fun dynamic_invariant10 ((temp___expr_242 Int)
  ...
  (temp___do_toplevel_241 Bool)) Bool (=>
                                      ...
                                      (<= 1 12)) (in_range8 temp___expr_242)))
...
(define-fun dynamic_invariant11 ((temp___expr_248 Int)
  ...
  (temp___do_toplevel_247 Bool)) Bool (=>
                                      ...
                                      (<= 1 31)) (in_range9 temp___expr_248)))
...
(declare-fun currentdoor1 () Int)

(declare-fun id1 () Int)

(declare-fun systemfault () Bool)

(declare-fun newdoor1 () Int)
...
(declare-fun currentdoor3 () Int)

(declare-fun dooralarm2 () Int)

(declare-fun newdoor2 () int__ref)
...
(declare-fun currentdoor4 () Int)

(declare-fun dooralarm3 () Int)

(declare-fun newdoor3 () Int)
...
;; H
  (assert (=> (= systemfault true) (= (valid_numberlogentries state3) true)))
...
;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1))
  (=> (= newdoor1 1) (= (mk_int__ref result) id6)))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1)) (=> (= newdoor1 1) (= id2 6)))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1))
  (=> (not (= newdoor1 1)) (= (mk_int__ref result1) id6)))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1)) (=> (not (= newdoor1 1)) (= id3 7)))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1)) (=> (not (= newdoor1 1)) (= id2 id3)))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1))
  (= (valid_numberlogentries state4) true))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1)) (= result2 currentdoor))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (= currentdoor newdoor1)) (= currentdoor2 newdoor1))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= id2 id))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= currentdoor2 currentdoor))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= state4 state))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= filestate3 filestate))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= id2 id1))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= currentdoor2 currentdoor1))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= state4 state2))))

;; H
  (assert
  (=> (not (= systemfault true))
  (=> (not (not (= currentdoor newdoor1))) (= filestate3 filestate1))))

;; H
  (assert (=> (not (= systemfault true)) (= result3 systemfault)))
...
;; H
  (assert
  (and
  (= (= (islocked state5) true)
  (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state5)) true))
  (= (bool_eq2 (latch_timeout state5) (latch_timeout state1)) true)))

;; H
  (assert
  (and
  (=
  (and (and (= currentdoor2 0) (= (islocked state5) true))
  ...
  (= dooralarm1 0)) (in_range4 dooralarm1)))
...
;; H
  (assert (= currentdoor2 currentdoor3))

;; H
  (assert (= systemfault2 systemfault1))
...
;; WP_parameter_def
 ;; File "alarmtypes.ads", line 24, characters 0-0
  (not
  (< (to_int1 (islocked state1)) (to_int1
                                 (ite (= (ite (= (= (current_latch state8)
                                         (current_latch state1)) true)
                                         (bool_eq2 (latch_timeout state8)
                                         (latch_timeout state1)) false) true)
                                 (islocked state8) false)))))
(check-sat)
(exit)
