...
(declare-fun o129 () cardindex)

(declare-fun o130 () Int)

(declare-fun o131 () Int)

(declare-fun o132 () cardindex)
...
;; H
  (assert
  (= o132 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o131)))
...
;; H
  (assert
  (= o129 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o128)))
...
;; H
  (assert
  (=> (= result27 true)
  (= o126 (select (rec__patience__state__preds
...
;; H
  (assert
  (= o118 (select (rec__patience__state__preds
