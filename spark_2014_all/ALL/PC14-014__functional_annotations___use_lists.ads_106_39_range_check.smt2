...
(declare-fun o7 () us_rep3)

(declare-fun o8 () Bool)

(declare-fun o9 () us_rep3)
...
;; H
  ...
  (and (not (= (has_key o9 no_element) true))
  (forall ((i1 us_rep1))
  (=> (= (has_key o9 i1) true)
  (and
  (and (<= 1 (get1 o9 i1))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o9 j) true)
  (=> (= (get1 o9 i1) (get1 o9 j)) (= (bool_eq1 i1 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o13)
  (=> (= (of_int 0) true)
  (and (= o13 (w_get o9 (witness o9 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o9 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o9 cu) (witness o9 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o7 j) true)
  (=> (= (get1 o7 i1) (get1 o7 j)) (= (bool_eq1 i1 j) true))))))))))

;; H
  (assert
  (and (= o8 (has_key o7 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o7 k) true) (= (bool_eq1 k cu) true))) (= o8 true)))))
