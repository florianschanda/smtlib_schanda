...
(declare-fun temp___204 () status)

(declare-fun temp___2041 () natural)

(declare-fun temp___2042 () natural)

(declare-fun temp___2043 () Bool)

(declare-fun temp___2044 () Bool)
...
;; WP_parameter_def
 ;; File "definite.adb", line 99, characters 0-0
  (not (= temp___204 x__split_discrs)))
(check-sat)
