...
(declare-fun pricing__price_of_basket__result () Int)
...
(declare-fun pricing__price_of_basket__result1 () Int)

(declare-fun pricing__price_of_basket__result2 () Int)

(declare-fun pricing__price_of_basket__result3 () Int)

(declare-fun total8 () Int)

(declare-fun it8 () Int)

(declare-fun pricing__price_of_basket__result4 () Int)

(declare-fun total9 () Int)

(declare-fun it9 () Int)

(declare-fun pricing__price_of_basket__result5 () Int)
...
;; H
  ...
  (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))
  (forall ((k Int))
  (=> (and (<= (to_rep1 (first (rt bk))) k) (<= k (- it3 1)))
...
;; H
  ...
  it3)))
  (and (<= (to_rep1 (first (rt bk))) it3) (<= it3 (to_rep1 (last (rt bk))))))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))
  (and (= o (price_of_item (select (elts bk) it3)))
  (and (in_range3 o)
  (= o (mult
       (to_rep
       (rec__pricing__item__price (us_split_fields1 (select (elts bk) it3))))
       (to_rep
       (rec__pricing__item__number (us_split_fields1 (select (elts bk) it3))))))))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))
  (= it10 (mk_int__ref it4))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))
  (= total10 (mk_int__ref total4))))
...
;; H
  (assert
  (= pricing__price_of_basket__result1 pricing__price_of_basket__result2))

;; H
  (assert
  (= pricing__price_of_basket__result3 pricing__price_of_basket__result1))

;; H
  (assert
  (= (mk_int__ref result3) (mk_int__ref pricing__price_of_basket__result)))
...
;; H
  (assert
  (= (mk_int__ref pricing__price_of_basket__result4) (mk_int__ref
                                                     pricing__price_of_basket__result2)))
...
;; H
  (assert
  (= pricing__price_of_basket__result5 pricing__price_of_basket__result3))
