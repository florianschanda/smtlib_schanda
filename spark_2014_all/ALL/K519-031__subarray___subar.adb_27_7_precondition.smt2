...
;; range_axiom
  (assert
  (forall ((x one_ten)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int one_ten))))))
...
(define-fun bool_eq1 ((a (Array Int one_ten)) (a__first Int) (a__last Int)
...
(declare-fun dummy3 () tTadSP1)

(declare-datatypes ()
((tTadSP1__ref (mk_tTadSP1__ref (tTadSP1__content tTadSP1)))))
(define-fun tTadSP1__ref___projection ((a tTadSP1__ref)) tTadSP1 (tTadSP1__content
                                                                 a))
...
;; def_axiom
  ...
  (= (select (temp___248 temp___250) temp___251) (of_rep temp___250)))))
...
(declare-fun ad1 () (Array Int one_ten))

(declare-fun result1 () (Array Int one_ten))
...
;; WP_parameter_def
 ;; File "subar.adb", line 9, characters 0-0
  (not (= (to_rep (select ad2 (to_rep1 (first (mk 1 10))))) 1)))
(check-sat)
