...
(declare-const o18 yearst)

(declare-const o19 monthst)

(declare-const o20 dayst)

(declare-const o21 millisecst)

(declare-const o22 yearst)

(declare-const o23 monthst)

(declare-const o24 dayst)

(declare-const o25 millisecst)
...
(define-fun o62 () us_rep1 (mk___rep1 (mk___split_fields1 o22 o23 o24 o25)))

(define-fun o63 () us_rep1 (mk___rep1 (mk___split_fields1 o18 o19 o20 o21)))
...
;; H
  (assert (= result2 (ite (= o54 1) true false)))
...
;; H
  (assert (=> (= result2 true) (= o59 (ite (not (= o58 true)) true false))))
...
;; H
  (assert (=> (= result2 true) (= o56 (ite (= o55 3) true false))))
...
;; H
  (assert (=> (= result2 true) (= o60 (ite (= o57 true) o56 false))))

;; H
  (assert (=> (= result2 true) (= o61 (ite (= o60 false) o59 true))))

;; H
  (assert (=> (not (= result2 true)) (= o61 (of_int 1))))
...
;; H
  (assert (= o50 (ite (= o49 3) true false)))
...
;; H
  (assert (=> (= result3 true) (= o53 (ite (= o52 1) true false))))

;; H
  (assert (=> (not (= result3 true)) (= o53 (of_int 1))))

;; H
  (assert (= o41 (islocked (us_private__content state21))))

;; H
  (assert (= o42 (ite (not (= o41 true)) true false)))

;; H
  (assert (= result4 (ite (= o42 true) (islocked state1) false)))

;; H
  (assert
  (=> (= result4 true)
  (and (= o45 (theauthcertrole (us_private__content state20))) (in_range4
  o45))))

;; H
  (assert (=> (= result4 true) (= o46 (ite (= o45 1) true false))))

;; H
  (assert
  (=> (= result4 true) (= o43 (authcertvalid (us_private__content state20)))))

;; H
  (assert
  (=> (= result4 true) (= o44 (isgood (us_private__content state20)))))

;; H
  (assert (=> (= result4 true) (= o47 (ite (= o44 true) o43 false))))

;; H
  (assert (=> (= result4 true) (= o48 (ite (= o47 true) o46 false))))

;; H
  (assert (=> (not (= result4 true)) (= o48 (of_int 1))))
...
;; H
  (assert (= result5 (ite (= o34 1) true false)))

;; H
  (assert
  (=> (= result5 true)
  (and (= o37 (theauthcertrole (us_private__content state20))) (in_range4
  o37))))

;; H
  (assert (=> (= result5 true) (= o38 (ite (= o37 1) true false))))

;; H
  (assert
  (=> (= result5 true) (= o35 (authcertvalid (us_private__content state20)))))

;; H
  (assert
  (=> (= result5 true) (= o36 (isgood (us_private__content state20)))))

;; H
  (assert (=> (= result5 true) (= o39 (ite (= o36 true) o35 false))))

;; H
  (assert (=> (= result5 true) (= o40 (ite (= o39 true) o38 false))))

;; H
  (assert (=> (not (= result5 true)) (= o40 (of_int 1))))

;; H
  (assert
  (and (= o29 (thedooralarm (us_private__content state22))) (in_range15 o29)))

;; H
  (assert (= o30 (ite (= o29 0) true false)))

;; H
  (assert (= o31 (to_int1 o30)))

;; H
  (assert (= o62 (alarm_timeout (us_private__content state22))))

;; H
  (assert (= o63 (thecurrenttime currenttime)))

;; H
  (assert (= o26 (greaterthanorequal o63 o62)))

;; H
  (assert
  (and (= o15 (thecurrentdoor (us_private__content state22))) (in_range14
  o15)))
...
;; H
  (assert (= o17 (islocked (us_private__content state21))))

;; H
  (assert (= o27 (ite (= o17 true) o16 false)))

;; H
  (assert (= o28 (ite (= o27 true) o26 false)))

;; H
  (assert (= o32 (to_int1 o28)))
...
;; H
  (assert (= o10 (ite (= o9 4) true false)))
...
;; H
  (assert
  (= o14 (ite (= o13 (to_int1 (ite (= (int__content status3) 6) true false)))
         true false)))
...
;; H
  (assert
  (=> (= (int__content status3) 8) (= o6 (ite (not (= o5 true)) true false))))

;; H
  (assert
  (=> (= (int__content status3) 8)
  (= o3 (islocked (us_private__content state21)))))
...
;; H
  (assert (=> (= (int__content status3) 8) (= o4 (ite (= o2 0) true false))))

;; H
  (assert
  (=> (= (int__content status3) 8) (= o7 (ite (= o4 true) o3 false))))

;; H
  (assert
  (=> (= (int__content status3) 8) (= o8 (ite (= o7 true) o6 false))))

;; H
  (assert (=> (not (= (int__content status3) 8)) (= o8 (of_int 1))))
