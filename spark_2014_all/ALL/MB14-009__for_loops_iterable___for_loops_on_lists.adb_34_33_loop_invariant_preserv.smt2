...
;; H
  (assert
  (and (= o4 (element (mk___rep l__split_discrs l__split_fields1) cu2))
  (and (in_range2 o4)
  (= o4 (get (model__ (mk___rep l__split_discrs l__split_fields1))
        (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2))))))
...
;; H
  ...
  (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields1))
     ...
     (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2)) true)))

;; H
  (assert
  (and (= o7 (next (mk___rep l__split_discrs l__split_fields2) cu2))
  ...
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o7) true)
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) o7) (+
  (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))))))

;; H
  (assert
  (and
  (= o8 (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o7))
  (= (= o8 true)
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o7) true))))
...
;; H
  (assert
  (and (= o9 (next (mk___rep l__split_discrs l__split_fields2) cu2))
  (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      l__split_discrs
  ...
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields2)) o9) true)
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) o9) (+
  (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu2) 1))))))
...
;; H
  (assert
  (and (= o10 (element (mk___rep l__split_discrs l__split_fields2) cu3))
  (and (in_range2 o10)
  (= o10 (get (model__ (mk___rep l__split_discrs l__split_fields2))
         (get1 (positions (mk___rep l__split_discrs l__split_fields2)) cu3))))))
