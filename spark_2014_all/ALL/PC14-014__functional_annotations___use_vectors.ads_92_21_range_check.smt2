...
;; H
  ...
  (and (dynamic_property2 first2 last2 o16)
  (= o16 (last6
         (model__
         (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))

;; H
  (assert (= o17 (ite (<= j2 o16) true false)))

;; H
  (assert (and (= o15 (+ i 7)) (in_range1 (+ i 7))))

;; H
  (assert (= o18 (ite (<= o15 j2) true false)))

;; H
  (assert (= result (ite (= o18 true) o17 false)))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j3)
  (get
  (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
  (- j3 7)))))))
...
;; H
  (assert (= result1 (ite (<= i j1) o13 false)))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep v__split_discrs (mk___split_fields v__split_fields8))) j3) 0)))))
...
;; H
  (assert (and (= us7 j) (dynamic_property4 first3 last4 j)))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not (dynamic_property1 first1 last1 j)))
(check-sat)
(exit)
