...
(declare-datatypes ((tTiSP1__ref 0))
(((mk_tTiSP1__ref (tTiSP1__content integer)))))
(define-fun tTiSP1__ref___projection ((a tTiSP1__ref)) integer (tTiSP1__content
                                                               a))
...
(declare-datatypes ((tiS__ref 0)) (((mk_tiS__ref (tiS__content us_t1)))))
...
(define-fun dynamic_invariant3 ((temp___expr_151 us_t)
...
(define-fun dynamic_invariant4 ((temp___expr_156 us_t1)
  ...
  (temp___do_toplevel_155 Bool)) Bool (=>
                                      ...
                                      (first3 temp___expr_156)
                                      (last3 temp___expr_156))
                                      (and (= (first3 temp___expr_156) 1)
                                      (= (last3 temp___expr_156) c)))))
...
;; H
  (assert
  (and (dynamic_property2 1 c (to_rep1 i__first) (to_rep1 i__last))
...
(assert
;; WP_parameter_def
 ;; File "alias.adb", line 17, characters 0-0
  (not (<= (to_rep1 i__first) 1)))
(check-sat)
(exit)
