...
(((mk___split_fields
  (rec__dw1000__register_types__dev_id_type__rev bits_4)(rec__dw1000__register_types__dev_id_type__ver bits_4)(rec__dw1000__register_types__dev_id_type__model bits_8)(rec__dw1000__register_types__dev_id_type__ridtag bits_16)))))
(define-fun us_split_fields_REV__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__dev_id_type__rev a))

(define-fun us_split_fields_VER__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__dev_id_type__ver a))

(define-fun us_split_fields_MODEL__projection ((a us_split_fields)) bits_8
  (rec__dw1000__register_types__dev_id_type__model a))

(define-fun us_split_fields_RIDTAG__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__dev_id_type__ridtag a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (and
                        (= (to_rep2
                           (rec__dw1000__register_types__dev_id_type__rev
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__dev_id_type__rev
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__dev_id_type__ver
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__dev_id_type__ver
                                                  (us_split_fields1 b)))))
                        (= (to_rep1
                           (rec__dw1000__register_types__dev_id_type__model
                           (us_split_fields1 a))) (to_rep1
                                                  (rec__dw1000__register_types__dev_id_type__model
                                                  (us_split_fields1 b)))))
                        (= (to_rep3
                           (rec__dw1000__register_types__dev_id_type__ridtag
...
(declare-const dw1000__register_types__dev_id_type__rev__first__bit Int)

(declare-const dw1000__register_types__dev_id_type__rev__last__bit Int)

(declare-const dw1000__register_types__dev_id_type__rev__position Int)

;; dw1000__register_types__dev_id_type__rev__first__bit_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__rev__first__bit))

;; dw1000__register_types__dev_id_type__rev__last__bit_axiom
  (assert
  (< dw1000__register_types__dev_id_type__rev__first__bit dw1000__register_types__dev_id_type__rev__last__bit))

;; dw1000__register_types__dev_id_type__rev__position_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__rev__position))

(declare-const dw1000__register_types__dev_id_type__ver__first__bit Int)

(declare-const dw1000__register_types__dev_id_type__ver__last__bit Int)

(declare-const dw1000__register_types__dev_id_type__ver__position Int)

;; dw1000__register_types__dev_id_type__ver__first__bit_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__ver__first__bit))

;; dw1000__register_types__dev_id_type__ver__last__bit_axiom
  (assert
  (< dw1000__register_types__dev_id_type__ver__first__bit dw1000__register_types__dev_id_type__ver__last__bit))

;; dw1000__register_types__dev_id_type__ver__position_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__ver__position))

(declare-const dw1000__register_types__dev_id_type__model__first__bit Int)

(declare-const dw1000__register_types__dev_id_type__model__last__bit Int)

(declare-const dw1000__register_types__dev_id_type__model__position Int)

;; dw1000__register_types__dev_id_type__model__first__bit_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__model__first__bit))

;; dw1000__register_types__dev_id_type__model__last__bit_axiom
  (assert
  (< dw1000__register_types__dev_id_type__model__first__bit dw1000__register_types__dev_id_type__model__last__bit))

;; dw1000__register_types__dev_id_type__model__position_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__model__position))

(declare-const dw1000__register_types__dev_id_type__ridtag__first__bit Int)

(declare-const dw1000__register_types__dev_id_type__ridtag__last__bit Int)

(declare-const dw1000__register_types__dev_id_type__ridtag__position Int)

;; dw1000__register_types__dev_id_type__ridtag__first__bit_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__ridtag__first__bit))

;; dw1000__register_types__dev_id_type__ridtag__last__bit_axiom
  (assert
  (< dw1000__register_types__dev_id_type__ridtag__first__bit dw1000__register_types__dev_id_type__ridtag__last__bit))

;; dw1000__register_types__dev_id_type__ridtag__position_axiom
  (assert (<= 0 dw1000__register_types__dev_id_type__ridtag__position))

(declare-fun user_eq6 (us_rep us_rep) Bool)

(declare-const dummy6 us_rep)

(declare-datatypes ((dev_id_type__ref 0))
(((mk_dev_id_type__ref (dev_id_type__content us_rep)))))
(define-fun dev_id_type__ref___projection ((a dev_id_type__ref)) us_rep
  (dev_id_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_1829 us_t1)
  (temp___is_init_1826 Bool) (temp___skip_constant_1827 Bool)
  (temp___do_toplevel_1828 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_1827 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_1829)
                                       (last3 temp___expr_1829))
                                       (and (= (first3 temp___expr_1829) 1)
                                       (= (last3 temp___expr_1829) 4)))))
