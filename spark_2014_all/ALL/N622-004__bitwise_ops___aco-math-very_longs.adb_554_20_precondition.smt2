  ...
  (! (=>
     ...
     (= (to_rep
        ...
        (us_split_discrs1 result))) (to_rep
                                    (rec__aco__math__very_longs__very_long__octet_length
                                    (us_split_discrs1 l))))
     (dynamic_invariant1 result true false true)))) :pattern ((modsubtract l
                                                              r)) )))
...
(declare-datatypes ((tT150bP1__ref 0))
(((mk_tT150bP1__ref (tT150bP1__content tdigit_index_typeB)))))
(define-fun tT150bP1__ref___projection ((a tT150bP1__ref)) tdigit_index_typeB
  (tT150bP1__content a))
...
(((mk_t150b__ref (t150b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits36__projection ((a us_split_fields2)) us_t1
  (rec__aco__math__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref_36__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep_71__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                a))

(define-fun us_rep_72__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))

(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___205 (rec__aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___205)
                                         (first3 temp___205)
                                         (last3 temp___205))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1)
                                          (mk___split_fields1
                                          (let ((temp___204 (rec__aco__math__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array1 (to_array temp___204)
                                          (first1 temp___204)
                                          (last1 temp___204))))))
...
(define-fun tresultS__ref_6__projection ((a tresultS__ref)) us_rep1 (tresultS__content
                                                                    a))

(define-fun dynamic_invariant2 ((temp___expr_954 us_rep1)
  (temp___is_init_951 Bool) (temp___skip_constant_952 Bool)
  (temp___do_toplevel_953 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_952 true))
                                      (in_range3
                                      (to_rep
                                      (rec__aco__math__very_longs__very_long__octet_length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_954)))
                                      ...
                                      (first3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_954)))
                                      (last3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_954))))
                                      (and
                                      (= (first3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_954))) 1)
                                      (= (last3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_954)))
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_957 us_rep1)
  (temp___skip_top_level_958 Bool)) Bool (= (to_rep
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_957))) (to_rep
                                                               (rec__aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
;; H
  ...
  aco__math__very_longs__modadd_and_carry__result__fields) true true true)))
...
;; H
  ...
  (= result____split_fields2 (us_split_fields3
                             (of_base
                             (mk___rep result____split_discrs
                             aco__math__very_longs__modadd_and_carry__result__fields)))))
...
;; H
  (assert (=> (= carry ((_ int2bv 16) 1)) (= result1 true)))

;; H
  (assert
  (=> (not (= carry ((_ int2bv 16) 1)))
  (= result1 (oge
             (to_base
