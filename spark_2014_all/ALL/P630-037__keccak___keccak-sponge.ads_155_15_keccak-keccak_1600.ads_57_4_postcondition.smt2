...
(define-fun free_bytes_in_block7 () int__ref (mk_int__ref
                                             free_bytes_in_block))

(define-fun ctx__split_fields29 () us_split_fields__ref (mk___split_fields__ref
                                                        (mk___split_fields
                                                        ctx__split_fields
                                                        ctx__split_fields1
                                                        ctx__split_fields2
...
;; H
  (assert
  (=> (< 0 initial_data_len1) (= o7 (- o6 (to_rep3 ctx__split_fields2)))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (= free_bytes_in_block2 (div1 free_bits_in_block2 8))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= result8 block_offset10))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= block_offset2 r74s))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (in_range2 r74s))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (and (= o10 (+ block_offset2 remaining_bytes1)) (in_range1
  (+ block_offset2 remaining_bytes1))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= keccak__keccak_1600__sponge__absorb__R75s__assume (- o10 1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= keccak__keccak_1600__sponge__absorb__R75s__assume r75s))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (in_range1 r75s))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= data_last2 r78s))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (in_range4 r78s))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= o11 (elts data)))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= o12 ctx__split_fields1))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= o12 temp___861))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= (mk1 r74s r75s) temp___8611))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= ctx__split_fields o14))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= o13 o15))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= ctx__split_fields2 o16))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= ctx__split_fields3 o17))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= ctx__split_fields4 o18))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= ctx__split_fields5 o19))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___866 o14))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8661 o15))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8662 o16))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8663 o17))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8664 o18))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8665 o19))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= result9 ctx__split_fields29))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (and (= o21 o20) (in_range7 o20)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= (to_rep3 o22) o21))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= (rec__keccak__keccak_1600__sponge__context__state ctx__split_fields7)
  o23))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= (rec__keccak__keccak_1600__sponge__context__block ctx__split_fields7)
  o24))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= o22 o25))))
...
;; H
  ...
  (=> (< bit_length free_bits_in_block2)
  (= (rec__keccak__keccak_1600__sponge__context__curr_state
     ctx__split_fields7) o28))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___868 o23))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8681 o24))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8682 o25))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8683 o26))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8684 o27))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= temp___8685 o28))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= result10 (mk___split_fields__ref ctx__split_fields7)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= block_offset4 (mk_int__ref block_offset2)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= remaining_bytes9 (mk_int__ref remaining_bytes1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= remaining_bits9 (mk_int__ref remaining_bits1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= offset9 (mk_int__ref offset1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= ctx__split_fields23 (mk___split_fields__ref ctx__split_fields8)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= block_offset5 block_offset2))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= remaining_bytes10 remaining_bytes1))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= remaining_bits10 remaining_bits1))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2) (= offset10 offset1))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (< bit_length free_bits_in_block2)
  (= ctx__split_fields24 ctx__split_fields8))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= result11 block_offset10)))))
...
;; H
  ...
  (= block_offset3 (div1 (to_rep3 ctx__split_fields2) 8))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= block_offset3 r81s)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (in_range2 r81s)))))
...
;; H
  ...
  (=> (< 0 free_bits_in_block2)
  (and
  (= keccak__keccak_1600__sponge__absorb__R82s__assume (+ block_offset3 (-
  free_bytes_in_block2 1))) (in_range1
  (+ block_offset3 (- free_bytes_in_block2 1))))))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (in_range1 r82s)))))
...
;; H
  ...
  (= keccak__keccak_1600__sponge__absorb__R85s__assume (+ (to_rep1
                                                          (first (rt data))) (-
  free_bytes_in_block2 1))) (in_range1
  (+ (to_rep1 (first (rt data))) (- free_bytes_in_block2 1))))))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (in_range1 r85s)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= o29 (elts data))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2)
  (= temp___817 (mk___t4 o29 (mk4 (to_rep1 (first (rt data))) r85s)))))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= o30 ctx__split_fields1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= temp___820 (mk___t3 o30 (mk3 r81s r82s)))))))
...
;; H
  ...
  (= (select o31 temp___823) (select (elts3 temp___822) temp___823))
  (= (select o31 temp___823) (select ctx__split_fields1 temp___823))))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2)
  (= o32 (mk___split_fields ctx__split_fields o31 ctx__split_fields2
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= temp___825 (mk___rep o32))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= result12 ctx__split_fields29)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2)
  (and (= o33 (+ offset1 free_bytes_in_block2)) (in_range1
  (+ offset1 free_bytes_in_block2)))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= result13 (mk_int__ref offset1))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= offset2 o33)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2)
  (and (= o34 (- remaining_bytes1 free_bytes_in_block2)) (in_range1
  (- remaining_bytes1 free_bytes_in_block2)))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (and (= o35 o34) (in_range2 o34))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= result14 (mk_int__ref remaining_bytes1))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= remaining_bytes2 o35)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2)
  (and (= o36 (- remaining_bits1 free_bits_in_block2)) (in_range1
  (- remaining_bits1 free_bits_in_block2)))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (and (= o37 o36) (in_range2 o36))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= result15 (mk_int__ref remaining_bits1))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 free_bits_in_block2) (= remaining_bits2 o37)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 free_bits_in_block2)) (= block_offset3 block_offset)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 free_bits_in_block2)) (= remaining_bytes2 remaining_bytes1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 free_bits_in_block2)) (= remaining_bits2 remaining_bits1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 free_bits_in_block2)) (= offset2 offset1)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 free_bits_in_block2))
  (= ctx__split_fields9 (mk___split_fields ctx__split_fields
                        ctx__split_fields1 ctx__split_fields2
                        ctx__split_fields3 ctx__split_fields4
                        ctx__split_fields5))))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 free_bits_in_block2)) (= block_offset3 block_offset1)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 free_bits_in_block2))
  (= ctx__split_fields9 ctx__split_fields6)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (= (- (to_rep4
        (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields9)) 1)
  r88s))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2)) (in_range1 r88s))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= temp___828 (mk___t5 o38 (mk5 0 r88s))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= o39 (mk___t (elts5 temp___828)
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= result16 (mk___split_fields__ref ctx__split_fields9)))))
...
;; H
  ...
  (= (state_of (mk___rep ctx__split_fields12)) 0))
  (= (rate_of (mk___rep ctx__split_fields12)) initial_bit_rate1))))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (in_range1 r91s)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (in_range1 r92s)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (= o42 (elts data))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= temp___833 (mk___t6 o42 (mk6 r91s r92s)))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= result21 (mk___split_fields__ref ctx__split_fields12))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= result23 (mk_int__ref offset3))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (= offset4 o44)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= result24 (mk_int__ref remaining_bytes3))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes4 o45)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2)
  (and (= o46 (- remaining_bits3 initial_bit_rate1)) (in_range2
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= result25 (mk_int__ref remaining_bits3))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits4 o46)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= ctx__split_fields15 (mk___split_fields__ref ctx__split_fields14))))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (= offset6 offset4)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (= offset7 offset5)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (<= initial_bit_rate1 remaining_bits2) (= offset8 offset6)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (<= initial_bit_rate1 remaining_bits2))
  (= ctx__split_fields17 (mk___split_fields__ref ctx__split_fields11))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (<= initial_bit_rate1 remaining_bits2))
  (= ctx__split_fields18 ctx__split_fields11)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7)) (in_range1 r95s)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7)) (in_range1 r98s)))))
...
;; H
  ...
  (=> (< 0 (int__content remaining_bits7))
  (and
  (= o47 (+ (int__content offset7) (- (int__content remaining_bytes7) 1)))
  (in_range1
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7))
  (and (= keccak__keccak_1600__sponge__absorb__R99s__assume o48) (in_range1
  o48))))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7)) (in_range1 r99s)))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7)) (= o49 (elts data))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7))
  (= temp___845 (mk___t8 o49 (mk8 r98s r99s)))))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7))
  (= temp___849 (mk___t7 o50 (mk7 0 r95s)))))))
...
;; H
  ...
  (= (select o51 temp___852) (select (elts7 temp___851) temp___852))
  (= (select o51 temp___852) (select (rec__keccak__keccak_1600__sponge__context__block
...
;; H
  ...
  (= o52 (mk___split_fields
         (rec__keccak__keccak_1600__sponge__context__state
         (us_split_fields__content ctx__split_fields17)) o51
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
         (us_split_fields__content ctx__split_fields17))
         (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
         (us_split_fields__content ctx__split_fields17))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7)) (= temp___854 (mk___rep o52))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (=> (< 0 (int__content remaining_bits7)) (= result26 ctx__split_fields17)))))
...
;; H
  ...
  (= ctx__split_fields20 ctx__split_fields17)))))
...
;; H
  ...
  (=> (not (< bit_length free_bits_in_block2))
  (=> (not (< 0 (int__content remaining_bits7)))
  (= ctx__split_fields21 ctx__split_fields18)))))
...
;; H
  ...
  (= (state_of (mk___rep (us_split_fields__content ctx__split_fields20))) 0))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (and (= o53 (int__content remaining_bits7)) (in_range7
  (int__content remaining_bits7))))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2)) (= (to_rep3 o54) o53))))
...
;; H
  ...
  (= o55 (mk___split_fields
         ...
         (rec__keccak__keccak_1600__sponge__context__block
         (us_split_fields__content ctx__split_fields20)) o54
         (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
         (us_split_fields__content ctx__split_fields20))
         (rec__keccak__keccak_1600__sponge__context__rate
         (us_split_fields__content ctx__split_fields20))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2)) (= temp___856 (mk___rep o55)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= result27 ctx__split_fields20))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= block_offset4 (mk_int__ref block_offset3)))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= remaining_bytes9 remaining_bytes7))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= remaining_bits9 remaining_bits7))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2)) (= offset9 offset7))))
...
;; H
  ...
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= block_offset5 block_offset3))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= remaining_bytes10 remaining_bytes8))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2))
  (= remaining_bits10 remaining_bits8))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (=> (not (< bit_length free_bits_in_block2)) (= offset10 offset8))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1) (= data_last3 (mk_int__ref data_last2))))
...
;; H
  (assert
  (=> (< 0 initial_data_len1)
  (= free_bits_in_block3 (mk_int__ref free_bits_in_block2))))

;; H
  (assert
  (=> (< 0 initial_data_len1)
  (= free_bytes_in_block3 (mk_int__ref free_bytes_in_block2))))

;; H
  (assert
  (=> (< 0 initial_data_len1) (= remaining_bytes11 remaining_bytes9)))
...
;; H
  (assert
  (=> (< 0 initial_data_len1) (= ctx__split_fields25 ctx__split_fields23)))
...
;; H
  (assert
  (=> (< 0 initial_data_len1) (= free_bits_in_block4 free_bits_in_block2)))

;; H
  (assert
  (=> (< 0 initial_data_len1) (= free_bytes_in_block4 free_bytes_in_block2)))

;; H
  (assert
  (=> (< 0 initial_data_len1) (= remaining_bytes12 remaining_bytes10)))
...
;; H
  (assert
  (=> (< 0 initial_data_len1) (= ctx__split_fields26 ctx__split_fields24)))
...
;; H
  (assert
  (=> (not (< 0 initial_data_len1)) (= block_offset6 block_offset10)))

;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= free_bits_in_block3 free_bits_in_block7)))

;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= free_bytes_in_block3 free_bytes_in_block7)))

;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= remaining_bytes11 (mk_int__ref remaining_bytes1))))

;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= remaining_bits11 (mk_int__ref remaining_bits1))))

;; H
  (assert
  (=> (not (< 0 initial_data_len1)) (= offset11 (mk_int__ref offset1))))

;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= ctx__split_fields25 ctx__split_fields29)))
...
;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= free_bits_in_block4 free_bits_in_block1)))

;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= free_bytes_in_block4 free_bytes_in_block1)))

;; H
  (assert
  (=> (not (< 0 initial_data_len1)) (= remaining_bytes12 remaining_bytes1)))

;; H
  (assert
  (=> (not (< 0 initial_data_len1)) (= remaining_bits12 remaining_bits1)))
...
;; H
  (assert
  (=> (not (< 0 initial_data_len1))
  (= ctx__split_fields26 ctx__split_fields6)))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not
  (= (state_of (mk___rep (us_split_fields__content ctx__split_fields27))) 0)))
(check-sat)
(exit)
