...
(define-fun r__split_fields20 () us_split_fields (mk___split_fields
                                                 r__split_fields6
                                                 r__split_fields7
                                                 r__split_fields8))

(define-fun r__split_fields21 () us_split_fields (mk___split_fields
                                                 r__split_fields3
                                                 r__split_fields4
                                                 r__split_fields5))

(define-fun r__split_fields22 () us_split_fields (mk___split_fields
                                                 r__split_fields
                                                 r__split_fields1
                                                 r__split_fields2))
...
;; H
  (assert
  (= (let ((temp___223 (to_model (mk___rep r__split_fields22))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields22)) x)))
     (let ((temp___230 (to_model (mk___rep r__split_fields21))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields21)) y)))
     (let ((temp___230 (to_model (mk___rep r__split_fields20))))
     (bool_eq3 (elts temp___230) (to_rep (first (rt temp___230)))
     (to_rep (last (rt temp___230))) (elts temp___231)
     (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields20)))))
     (let ((temp___234 (to_model (mk___rep r__split_fields19))))
  ...
  (= h1 (func_head (to_model (mk___rep r__split_fields20))))) (in_range 
  h1)))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields19)) z)))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields18)))))
     (let ((temp___234 (to_model
                       (mk___rep
                       (mk___split_fields r__split_fields15 r__split_fields16
                       r__split_fields17)))))
     (bool_eq3 (elts temp___234) (to_rep (first (rt temp___234)))
     (to_rep (last (rt temp___234))) (elts temp___235)
     (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true)
  (= h2 (func_head (to_model (mk___rep r__split_fields18))))) (in_range 
  h2)))
