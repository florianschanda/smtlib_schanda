...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o8 (next (mk___rep s__split_discrs s__split_fields3)
        (mk___rep1 cu__split_fields2)))
  ...
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o8) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o8) (+
  (get1 (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o8))
  (ite (= (ite (= (bool_eq1 o8 no_element) false) (= (get1
                                                     (positions
                                                     (mk___rep
                                                     s__split_discrs
                                                     s__split_fields3))
