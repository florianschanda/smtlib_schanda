...
;; H
  ...
  (and
  (and
  (= (bool_eq4 a1 5 50 (temp___4717 t j (temp___4723 (select t j) i e)) 5 50) true)
...
;; WP_parameter_def
 ;; File "ar.ads", line 339, characters 0-0
  ...
  (and (< 0 e)
  (= (bool_eq4 a3 5 50
     (temp___1068 a j (temp___1076 (select a j) i e) (+ j 1)
     (temp___1083 (select a (+ j 1)) i (- e 1))) 5 50) true))
  (and (= e 0)
  (= (bool_eq4 a3 5 50
     (temp___1091 a j (temp___1099 (select a j) i e) (+ j 1)
     (temp___1106 (select a (+ j 1)) i 99)) 5 50) true))))
  (and (= j 50)
  (or
  (and (< 0 e)
  (= (bool_eq4 a3 5 50
     (temp___1114 a j (temp___1122 (select a j) i e) 5
     (temp___1129 (select a 5) i (- e 1))) 5 50) true))
  (and (= e 0)
  (= (bool_eq4 a3 5 50
     (temp___1137 a j (temp___1145 (select a j) i e) 5
     (temp___1152 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
