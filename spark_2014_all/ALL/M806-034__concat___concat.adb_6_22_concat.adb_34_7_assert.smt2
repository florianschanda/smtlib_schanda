...
(declare-datatypes ((tcbB__ref 0)) (((mk_tcbB__ref (tcbB__content us_t1)))))
...
(declare-datatypes ((t31b__ref 0)) (((mk_t31b__ref (t31b__content t31b)))))
...
(declare-datatypes ((t36b__ref 0)) (((mk_t36b__ref (t36b__content t36b)))))
...
(declare-datatypes ((t38b__ref 0)) (((mk_t38b__ref (t38b__content t38b)))))
...
;; WP_parameter_def
 ;; File "concat.ads", line 8, characters 0-0
  (not (= (to_rep (select d1 1)) (to_rep (select x 6)))))
(check-sat)
(exit)
