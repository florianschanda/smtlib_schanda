...
(declare-fun dummy2 () three_shape)
...
(define-fun dynamic_invariant4 ((temp___expr_526 Int)
...
(declare-fun o2 () (Array Int cell))

(declare-fun o3 () Int)

(declare-fun o4 () (Array Int (Array Int cell)))

(declare-fun o5 () cell)

(declare-fun o6 () Int)

(declare-fun o7 () (Array Int cell))

(declare-fun o8 () Int)

(declare-fun o9 () (Array Int (Array Int cell)))

(declare-fun o10 () cell)

(declare-fun result () (Array Int (Array Int cell)))

(declare-fun cur_board1 () (Array Int (Array Int cell)))

(declare-fun result1 () (Array Int (Array Int cell)))
...
;; H
  (assert
  (and (<= 1 (to_rep2 cur_piece__split_fields2))
...
;; H
  (assert
  (= o2 (store (select cur_board (to_rep3 cur_piece__split_fields3))
  o1 o)))

;; H
  (assert
  (and (<= 1 (to_rep3 cur_piece__split_fields3))
...
;; H
  (assert
  (= o7 (store (select cur_board1 (+ (to_rep3 cur_piece__split_fields3) 1))
  o6 o5)))

;; H
  (assert
  (and (<= 1 (+ (to_rep3 cur_piece__split_fields3) 1))
  (<= (+ (to_rep3 cur_piece__split_fields3) 1) 50)))
...
;; WP_parameter_def
 ;; File "tetris_functional.ads", line 170, characters 0-0
  (not (<= 1 (+ (to_rep2 cur_piece__split_fields2) 1))))
(check-sat)
(exit)
