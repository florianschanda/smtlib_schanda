...
;; H
  (assert
  (=> (= result6 true) (and (= o9 (- last5 i9)) (in_range1 (- last5 i9)))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o8 (to__ (mk___rep s__split_fields9)))
...
;; H
  (assert
  (=> (= result5 true) (and (= o4 (- last5 i9)) (in_range1 (- last5 i9)))))
