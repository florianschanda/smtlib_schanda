...
;; H
  (assert
  (and
  (= o55 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         j))
  (in_range7 o55)))

;; H
  (assert (= result12 (ite (in_range4 o55) true false)))
...
;; H
  (assert (=> (= result12 true) (= result13 (ite (< j o51) true false))))

;; H
  (assert
  (=> (= result12 true)
  (=> (= result13 true) (and (= o52 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o53 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o52))
  (in_range7 o53)))))

;; H
  (assert (=> (= result12 true) (=> (not (= result13 true)) (= o53 0))))
...
;; H
  ...
  (= temp___400 (get
                (rec__list_allocator__m__t__allocated model____split_fields3)
                j))
  (in_range7 temp___400))))

;; H
  (assert (=> (= result12 true) (and (<= 1 temp___400) (<= temp___400 3))))

;; H
  (assert (=> (= result12 true) (= o47 temp___400)))

;; H
  (assert (=> (= result12 true) (= o48 (select data3 o47))))

;; H
  (assert (=> (= result12 true) (= o49 (us_split_fields1 o48))))

;; H
  (assert
  (=> (= result12 true) (= o50 (rec__list_allocator__cell__next o49))))

;; H
  (assert (=> (= result12 true) (= o54 (to_rep o50))))

;; H
  (assert (=> (= result12 true) (= result11 (ite (= o54 o53) true false))))
...
;; H
  (assert (=> (< 1 j) (and (= o45 (- j 1)) (in_range2 (- j 1)))))
