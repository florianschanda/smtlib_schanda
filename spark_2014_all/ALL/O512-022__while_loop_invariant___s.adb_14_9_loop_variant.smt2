...
;; H
  (assert (not (= found2 true)))

;; H
  (assert (and (=> (<= 1 10) (in_range2 index2)) (<= index2 10)))

;; H
  (assert (= temp___153 result2))

;; H
  (assert (= temp___1531 index2))

;; H
  (assert (not (= (to_rep (select table index2)) value)))

;; H
  (assert (= found3 found2))

;; H
  (assert (not (= index2 10)))

;; H
  (assert (and (= o (+ index2 1)) (in_range2 (+ index2 1))))
