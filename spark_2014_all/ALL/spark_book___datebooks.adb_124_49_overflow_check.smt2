...
(declare-fun dummy13 () description_count_type)
...
;; range_axiom
  (assert
  (forall ((x description_count_type)) (! (in_range10
...
(declare-fun dummy14 () (Array Int character))
...
(declare-fun dummy16 () event_index_type)
...
(define-fun bool_eq17 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq15 (select a temp___idx_132)
...
(declare-fun dummy17 () status_type)
...
(declare-fun description__first () integer)

(declare-fun description__last () integer)
...
(define-fun dynamic_invariant7 ((temp___expr_136 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_142 Int)
  (temp___is_init_139 Bool) (temp___skip_constant_140 Bool)
  (temp___do_toplevel_141 Bool)) Bool (=>
                                      (or (= temp___is_init_139 true)
                                      (<= 1 12)) (in_range5 temp___expr_142)))

(define-fun dynamic_invariant9 ((temp___expr_148 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_154 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_160 Int)
  (temp___is_init_157 Bool) (temp___skip_constant_158 Bool)
  (temp___do_toplevel_159 Bool)) Bool (=>
                                      (or (= temp___is_init_157 true)
                                      (<= 0 59)) (in_range8 temp___expr_160)))

(define-fun dynamic_invariant12 ((temp___expr_166 Int)
...
;; H
  (assert (dynamic_property 1 2147483647 (to_rep1 description__first)
...
;; H
  (assert
  (and (=> (<= 0 3) (in_range12 status2)) (=> (<= 1 64) (in_range11 i2))))

;; H
  (assert
  (= (bool_eq13
     (rec__datebooks__event_record__date (us_split_fields7 (select book i2)))
     date) true))

;; H
  (assert
  (=> (<= (to_rep1 description__first) (to_rep1 description__last))
  (= o1 (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 description__first) (to_rep1 description__last)))
  (= o1 0)))
...
;; H
  (assert
  (= result3 (ite (< o2 (to_rep8
                        (rec__datebooks__event_record__description_size
                        (us_split_fields7 (select book i2)))))
             true false)))
...
;; H
  ...
  (= (to_rep8
     (rec__datebooks__event_record__description_size
     (us_split_fields7 (select book i2)))) r12b))
...
;; H
  ...
  (<= (to_rep8
      (rec__datebooks__event_record__description_size
      (us_split_fields7 (select book i2)))) (ite (<= (to_rep1
                                                     description__first) 
                                            (to_rep1 description__last))
                                            (+ (- (to_rep1 description__last) 
                                            (to_rep1 description__first)) 1)
                                            0))
  (< (- j2 1) (ite (<= (to_rep1 description__first) (to_rep1
                                                    description__last))
              (+ (- (to_rep1 description__last) (to_rep1 description__first)) 1)
              0))))

;; H
  (assert
  (and (=> (<= 1 r12b) (dynamic_property3 1 r12b j2))
  (and (<= 1 j2) (<= j2 r12b))))

;; H
  (assert
  (= (to_rep o3) (to_rep
                 (select (rec__datebooks__event_record__description_text
                         (us_split_fields7 (select book i2))) j2))))

(assert
;; WP_parameter_def
 ;; File "datebooks.adb", line 81, characters 0-0
  (not (in_range1 (+ (to_rep1 description__first) (- j2 1)))))
(check-sat)
