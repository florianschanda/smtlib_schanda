...
(declare-fun dummy7 () (Array Int integer))
...
(define-fun us_split_fields_M_Array2__projection ((a us_split_fields2)) (Array Int integer)
...
(declare-fun temp___discr_204 () Int)

;; H
  (assert (in_range1 temp___discr_204))

;; H
  (assert (<= 0 temp___discr_204))
