...
;; H
  ...
  (<= temp___2761 (to_rep1 (last (rt haystack))))))))
...
;; H
  (assert
  (= result3 (bool_eq (elts needle) (to_rep1 (first (rt needle)))
...
;; H
  (assert
  (= string_search__brute_force_slice__result4 string_search__brute_force_slice__result3))
