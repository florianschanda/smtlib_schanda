...
;; H
  (assert
  (=> (= result3 true)
  (=> (= slowadvance1 true) (= result4 (mk_int__ref clockoffset2)))))
...
;; H
  (assert
  (=> (= result3 true)
  (=> (not (= slowadvance1 true)) (= clockoffset3 clockoffset2))))
...
;; H
  (assert (=> (= result3 true) (= changetoslowmode1 changetoslowmode)))

;; H
  (assert (=> (= result3 true) (= fastadvance1 fastadvance)))

;; H
  (assert
  (=> (not (= result3 true))
  (=> (= fastadvance1 true) (= result5 (mk_int__ref clockoffset2)))))
...
;; H
  (assert
  (=> (not (= result3 true))
  (=> (not (= fastadvance1 true)) (= clockoffset4 clockoffset2))))
...
;; H
  (assert (=> (not (= result3 true)) (= advtimer advtimer1)))

;; H
  (assert (=> (not (= result3 true)) (= advpressed advpressed1)))

;; H
  (assert (=> (not (= result3 true)) (= advancemode1 advancemode2)))

;; H
  (assert (=> (not (= result3 true)) (= changetofastmode1 changetofastmode)))

;; H
  (assert (=> (not (= result3 true)) (= slowadvance1 slowadvance)))

;; H
  (assert (=> (not (= result3 true)) (= clockoffset3 clockoffset4)))
