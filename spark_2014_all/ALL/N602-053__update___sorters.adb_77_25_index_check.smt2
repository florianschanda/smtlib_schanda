...
;; H
  (assert (and (= temp___186 (+ j 1)) (in_range1 (+ j 1))))

;; H
  (assert
  (and (<= (to_rep values__first) temp___186)
  (<= temp___186 (to_rep values__last))))

;; H
  (assert (= o7 temp___186))

;; H
  (assert (= o8 (select values3 o7)))
