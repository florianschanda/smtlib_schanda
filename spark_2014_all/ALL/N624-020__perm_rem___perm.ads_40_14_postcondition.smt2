...
(declare-fun perm__perm_reflexive__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun perm__perm_reflexive__result1 () Int)

(declare-fun perm__perm_reflexive__result2 () Int)

(declare-fun perm__perm_reflexive__result3 () Int)

(declare-fun perm__perm_reflexive__result4 () Int)

(declare-fun perm__perm_reflexive__result5 () Int)
...
;; H
  ...
  (and (in_range4 o) (=> (= (of_int o) true) (= (is_perm a b) true)))))

;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref perm__perm_reflexive__result)))
...
;; H
  (assert
  (= (mk_int__ref perm__perm_reflexive__result4) (mk_int__ref
                                                 perm__perm_reflexive__result2)))
