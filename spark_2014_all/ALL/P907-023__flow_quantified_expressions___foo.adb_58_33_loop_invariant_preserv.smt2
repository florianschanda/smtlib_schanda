...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i2))
  (= (rec__foo__r__x (us_split_fields1 (select a2 j))) true))))
...
;; H
  (assert
  (= a3 (store a2 i3 (mk___rep
                     (mk___split_fields
                     (ite (= (rec__foo__r__x
                             (us_split_fields1 (select a2 i3))) false)
                     (ite (not
                          (= (rec__foo__r__x
                             (us_split_fields1 (select a2 i3))) true))
                     true false) true))))))
