...
(declare-fun r10 () (_ BitVec 64))

(declare-fun result () (_ BitVec 64))

(declare-fun r101 () (_ BitVec 64))

(declare-fun r102 () (_ BitVec 64))

(declare-fun r103 () (_ BitVec 64))
...
;; H
  (assert
  (= r101 (bvor (bvand r10 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56)
  val__))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= r102 (bvor (bvand r10 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56)
  val__)))))
(check-sat)
(exit)
