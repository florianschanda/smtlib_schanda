...
(declare-fun to_fixed (tfB) Int)

(declare-fun of_fixed (Int) tfB)
...
;; fxp_mult_def
  ...
  (! (ite (or (= x 0) (= y 0)) (= (fxp_mult x y) 0)
     ...
     (fxp_mult x y) (* x y) 4) (pos_div_relation (- (fxp_mult x y))
     (- (* x y)) 4))) :pattern ((fxp_mult x y)) ))))
...
;; fxp_div_def
  ...
  (! (ite (= x 0) (= (fxp_div x y) 0)
     (ite (and (< 0 x) (< 0 y)) (pos_div_relation (fxp_div x y) (* x 4) y)
     (ite (and (< x 0) (< y 0)) (pos_div_relation (fxp_div x y) (* (- x) 4)
     (- y))
     (ite (and (< x 0) (< 0 y)) (pos_div_relation (- (fxp_div x y))
     (* (- x) 4) y)
     (=> (and (< 0 x) (< y 0)) (pos_div_relation (- (fxp_div x y)) (* x 4)
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int1 x) 0)
     (ite (< 0 x) (pos_div_relation (to_int1 x) x 4) (pos_div_relation
     (- (to_int1 x)) (- x) 4))) :pattern ((to_int1 x)) )))
...
;; range_axiom
  (assert (forall ((x tfB)) (in_range (to_fixed x))))
...
(declare-datatypes ((tfB__ref 0)) (((mk_tfB__ref (tfB__content tfB)))))
...
(declare-fun to_fixed1 (f) Int)

(declare-fun of_fixed1 (Int) f)
...
;; fxp_mult_def
  ...
  (! (ite (or (= x 0) (= y 0)) (= (fxp_mult1 x y) 0)
     ...
     (fxp_mult1 x y) (* x y) 4) (pos_div_relation1 (- (fxp_mult1 x y))
     (- (* x y)) 4))) :pattern ((fxp_mult1 x y)) ))))
...
;; fxp_div_def
  ...
  (! (ite (= x 0) (= (fxp_div1 x y) 0)
     (ite (and (< 0 x) (< 0 y)) (pos_div_relation1 (fxp_div1 x y) (* x 4) y)
     (ite (and (< x 0) (< y 0)) (pos_div_relation1 (fxp_div1 x y) (* (- x) 4)
     (- y))
     (ite (and (< x 0) (< 0 y)) (pos_div_relation1 (- (fxp_div1 x y))
     (* (- x) 4) y)
     (=> (and (< 0 x) (< y 0)) (pos_div_relation1 (- (fxp_div1 x y)) (* x 4)
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int2 x) 0)
     (ite (< 0 x) (pos_div_relation1 (to_int2 x) x 4) (pos_div_relation1
     (- (to_int2 x)) (- x) 4))) :pattern ((to_int2 x)) )))
...
;; range_axiom
  (assert (forall ((x f)) (in_range1 (to_fixed1 x))))
...
(declare-datatypes ((f__ref 0)) (((mk_f__ref (f__content f)))))
...
;; H
  (assert (= (to_fixed1 o2) (fxp_div (to_fixed1 x1) (to_fixed1 y1))))
