...
(declare-fun o34 () (Array Int natural))

(declare-fun o35 () t)

(declare-fun o36 () Int)

(declare-fun o37 () (Array Int natural))
...
;; H
  (assert
  (and (= o16 (shift_perm_l o49 o48 o46))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o46 o48) true)))))
...
;; H
  (assert
  (and (= o31 (shift_perm_r o44 o43 o41))
  (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o44 o41) true)))))
...
;; H
  (assert
  (and
  (= o36 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o40 (remove b ib1))
  (and (dynamic_invariant2 o40 true false true)
  (and (= (invariant__ o40) true)
  (and (= (to_rep2 (last o35)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o34 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o34 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o34 k))))))))))))

;; H
  (assert
  (and (= o39 (remove o40 o36))
  (and (dynamic_invariant2 o39 true false true)
  (and (= (invariant__ o39) true)
  (and (= (to_rep2 (last o38)) (- (to_rep2 (last o35)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o36 1)))
  (= (to_rep (select o34 k)) (to_rep (select o37 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o36 1) k) (<= k (to_rep2 (last o35))))
  (= (to_rep (select o34 k)) (to_rep (select o37 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o36 k) (<= k (- (to_rep2 (last o35)) 1)))
  (= (to_rep (select o34 (+ k 1))) (to_rep (select o37 k))))))))))))

;; H
  (assert
  (and
  (= o33 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
