...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___1170 (length thestring)) (in_range1 (length thestring)))))
...
;; H
  ...
  (=> (<= 1 temp___1170)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1170) (<= temp___1170 150))))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first2 temp___11681)) (to_rep1 (last2 temp___11681)))
     ...
     0) (ite (<= (to_rep1 (first2 temp___11711)) (to_rep1
                                                 (last2 temp___11711)))
        (+ (- (to_rep1 (last2 temp___11711)) (to_rep1 (first2 temp___11711))) 1)
        0))))
...
;; H
  ...
  (= (select o8 temp___1173) (select temp___1172 temp___1173))
  (= (select o8 temp___1173) (select result__1 temp___1173))))))
