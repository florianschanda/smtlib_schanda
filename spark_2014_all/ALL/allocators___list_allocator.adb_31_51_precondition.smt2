...
;; H
  (assert (= result2 (ite (<= o6 10000) true false)))

;; H
  (assert
  (=> (= result2 true)
  (and (= o5 (length1 model____split_fields1)) (in_range6 o5))))

;; H
  (assert (=> (= result2 true) (= result1 (ite (<= o5 10000) true false))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o1 (length1 model____split_fields1)) (in_range6 o1))))
...
;; H
  (assert (=> (= result1 true) (= o3 (+ o2 o1))))

;; H
  (assert (=> (= result1 true) (and (= o4 o3) (in_range2 o3))))

;; H
  (assert (=> (= result1 true) (= result (ite (= o4 10000) true false))))
...
;; H
  (assert (= result3 (ite (< 0 o) true false)))
