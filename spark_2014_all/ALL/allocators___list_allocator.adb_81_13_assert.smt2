...
;; H
  (assert (= model____split_fields1 o17))

;; H
  (assert (= temp___283 o16))

;; H
  (assert (= temp___2831 o17))
...
;; H
  (assert
  (= model____split_fields2 (mk___split_fields1 temp___283 temp___2831)))

;; H
  (assert
  (and
  (= o18 (add (rec__list_allocator__m__t__allocated model____split_fields2)
         res1))
  (and
  (and
  (and
  (= (length1 o18) (+ (length1
                      (rec__list_allocator__m__t__allocated
                      model____split_fields2)) 1))
  (= (contains o18 res1) true))
  (= (ole (rec__list_allocator__m__t__allocated model____split_fields2) o18) true))
  (= (included_except o18
     (rec__list_allocator__m__t__allocated model____split_fields2) res1) true))))

;; H
  (assert
  (= (rec__list_allocator__m__t__available model____split_fields2) o19))

;; H
  (assert (= o18 o20))

;; H
  (assert (= temp___285 o19))

;; H
  (assert (= temp___2851 o20))

;; H
  (assert (= result6 (mk___split_fields__ref1 model____split_fields2)))

;; H
  (assert
  (= model____split_fields3 (mk___split_fields1 temp___285 temp___2851)))
