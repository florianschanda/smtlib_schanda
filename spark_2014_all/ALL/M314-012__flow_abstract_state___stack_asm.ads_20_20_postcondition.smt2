...
(declare-fun the_ptr1 () Int)

(declare-fun the_ptr2 () Int)

(declare-fun the_ptr3 () Int)
...
(assert
;; WP_parameter_def
 ;; File "stack_asm.ads", line 7, characters 0-0
  (not (= (is_empty the_ptr2) true)))
(check-sat)
(exit)
