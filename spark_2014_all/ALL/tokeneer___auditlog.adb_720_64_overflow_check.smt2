...
;; H
  ...
  (= o4 (ite (= (to_rep1 (select logfileentries3 currentlogfile3)) (+
        (to_rep1 (select logfileentries3 currentlogfile)) 1))
        (ite (= (to_rep2 usedlogfiles__split_fields15) (to_rep2
                                                       usedlogfiles__split_fields3))
        true false) false))))

;; H
  (assert
  (=> (not (< (to_rep1 (select logfileentries3 currentlogfile)) 1024))
  (= o4 (of_int 1))))

;; H
  (assert
  (=> (= (to_rep1 (select logfileentries3 currentlogfile)) 1024)
  (= o3 (ite (= (to_rep1 (select logfileentries3 currentlogfile3)) 1)
        (ite (= (to_rep2 usedlogfiles__split_fields15) (+ (to_rep2
                                                          usedlogfiles__split_fields3) 1))
        true false) false))))
...
;; H
  (assert
  (and (= o1 (- (to_rep2 usedlogfiles__split_fields15) 1)) (in_range9
  (- (to_rep2 usedlogfiles__split_fields15) 1))))
