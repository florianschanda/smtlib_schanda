...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i4))) true)
  (=>
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields5))) i4)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields5)
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     t__split_fields5)
                     (to_rep1
                     (rec__search_trees__search_tree__root t__split_fields5))) i4)))) 1)) 0)
  (< v (to_rep
       (select (rec__search_trees__search_tree__values t__split_fields5) i4)))
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields5) i4)) 
  v)))))))
