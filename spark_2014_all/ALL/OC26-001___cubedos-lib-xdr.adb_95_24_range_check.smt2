...
(declare-fun temp___468 () (Array Int octet))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temp___470 temporary_11)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temp___468 data)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 8)) (= temp___466 temporary_2)))
