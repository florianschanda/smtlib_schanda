...
;; H
  (assert
  (and
  (= o70 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         j))
  (in_range7 o70)))

;; H
  (assert (= result12 (ite (in_range4 o70) true false)))
...
;; H
  (assert (=> (= result12 true) (= result13 (ite (< j o66) true false))))

;; H
  (assert
  (=> (= result12 true)
  (=> (= result13 true) (and (= o67 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o68 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o67))
  (in_range7 o68)))))

;; H
  (assert (=> (= result12 true) (=> (not (= result13 true)) (= o68 0))))
...
;; H
  (assert (=> (= result12 true) (= o62 temp___429)))
...
;; H
  (assert
  (=> (= result12 true) (= o65 (rec__list_allocator__cell__next o64))))

;; H
  (assert (=> (= result12 true) (= o69 (to_rep o65))))
...
;; H
  (assert (=> (< 1 j) (and (= o60 (- j 1)) (in_range2 (- j 1)))))

;; H
  (assert
  (=> (< 1 j)
  (and
  (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o60))
  (in_range7 o61))))

;; H
  (assert (=> (not (< 1 j)) (= o61 0)))
