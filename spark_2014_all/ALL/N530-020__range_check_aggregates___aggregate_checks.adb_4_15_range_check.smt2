...
(((mk___split_fields
  (rec__aggregate_checks__do_wrong_aggregate__wrapper__content integer)))))
(define-fun us_split_fields_Content__projection ((a1 us_split_fields)) integer
  (rec__aggregate_checks__do_wrong_aggregate__wrapper__content a1))
...
(define-fun bool_eq2 ((a1 us_rep)
  (b us_rep)) Bool (ite (= (to_rep
                           (rec__aggregate_checks__do_wrong_aggregate__wrapper__content
...
;; aggregate_checks__do_wrong_aggregate__wrapper__content__first__bit_axiom
  (assert
  (<= 0 aggregate_checks__do_wrong_aggregate__wrapper__content__first__bit))

;; aggregate_checks__do_wrong_aggregate__wrapper__content__last__bit_axiom
  (assert
  (< aggregate_checks__do_wrong_aggregate__wrapper__content__first__bit
  aggregate_checks__do_wrong_aggregate__wrapper__content__last__bit))

;; aggregate_checks__do_wrong_aggregate__wrapper__content__position_axiom
  (assert
  (<= 0 aggregate_checks__do_wrong_aggregate__wrapper__content__position))

(declare-fun user_eq5 (us_rep us_rep) Bool)

(declare-const dummy5 us_rep)

(declare-datatypes ((wrapper__ref 0))
(((mk_wrapper__ref (wrapper__content us_rep)))))
(define-fun wrapper__ref___projection ((a1 wrapper__ref)) us_rep (wrapper__content
                                                                 a1))

(define-fun dynamic_invariant1 ((temp___expr_175 us_rep)
  ...
  (temp___do_toplevel_174 Bool)) Bool (=>
                                      ...
                                      (to_rep
                                      (rec__aggregate_checks__do_wrong_aggregate__wrapper__content
                                      (us_split_fields1 temp___expr_175))))))
