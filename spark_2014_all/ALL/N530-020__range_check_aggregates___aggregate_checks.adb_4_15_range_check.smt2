...
(declare-fun aggregate_checks__do_wrong_aggregate__wrapper__content__first__bit () Int)

(declare-fun aggregate_checks__do_wrong_aggregate__wrapper__content__last__bit () Int)

(declare-fun aggregate_checks__do_wrong_aggregate__wrapper__content__position () Int)
...
(declare-fun should_fail () us_rep)
