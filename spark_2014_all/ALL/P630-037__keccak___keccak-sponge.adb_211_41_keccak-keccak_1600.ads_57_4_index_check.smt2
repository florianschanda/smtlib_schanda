...
(declare-fun temp___885 () (Array Int byte))

(declare-fun temp___8851 () t1)
...
(define-fun ctx__split_fields18 () us_split_fields (mk___split_fields
                                                   ctx__split_fields12
                                                   ctx__split_fields13
                                                   ctx__split_fields14
                                                   ctx__split_fields15
...
;; H
  (assert
  (=> (< 1 message_byte_length1)
  (and (= o14 (- bit_length (mod2 bit_length 8))) (in_range1
...
;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk1 (to_rep1 (first (rt message))) r105s) temp___8851)))
...
;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk (to_rep1 (first2 temp___8851)) (to_rep1 (last2 temp___8851)))
  o13)))
...
;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields18 (mk___split_fields ctx__split_fields6
...
;; H
  (assert
  (=> (< (mod2 bit_length 8) 8)
  (= o18 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))

;; H
  (assert (=> (not (< (mod2 bit_length 8) 8)) (= o18 ((_ int2bv 8) 0))))

;; H
  (assert
  (=> (< (mod2 bit_length 8) 256)
  (= o16 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_length 8))))))

;; H
  (assert (=> (not (< (mod2 bit_length 8) 256)) (= o16 ((_ int2bv 8) 0))))

;; H
  (assert (= o17 (bvsub o16 ((_ int2bv 8) 1))))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (<= (to_rep1 (first (rt message))) message_last1)))
(check-sat)
(exit)
