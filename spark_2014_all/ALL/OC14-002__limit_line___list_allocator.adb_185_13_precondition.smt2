...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result12 (ite (< 0 o49) true false))))
...
;; H
  ...
  (=> (= result12 true)
  (and
  (= o48 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o48)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result12 true)
  (= result11 (ite (= o48 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o46) true false)))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o45 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o45))))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result13 true)
  (= result10 (ite (= o45 first_allocated1) true false))))))
