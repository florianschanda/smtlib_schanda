...
(define-fun us_split_fields_F2__projection ((a us_split_fields)) (Array Int integer)
  (rec__vs__vr__f2 a))
...
(declare-fun vs__vr__f1__first__bit () Int)

(declare-fun vs__vr__f1__last__bit () Int)

(declare-fun vs__vr__f1__position () Int)
...
(declare-fun vs__vr__f2__first__bit () Int)

(declare-fun vs__vr__f2__last__bit () Int)

(declare-fun vs__vr__f2__position () Int)
...
(declare-fun v3__split_fields () integer)

(declare-fun v3__split_fields1 () (Array Int integer))
...
(assert
;; WP_parameter_def
 ;; File "vs.adb", line 12, characters 0-0
  (not (<= 1 1)))
(check-sat)
(exit)
