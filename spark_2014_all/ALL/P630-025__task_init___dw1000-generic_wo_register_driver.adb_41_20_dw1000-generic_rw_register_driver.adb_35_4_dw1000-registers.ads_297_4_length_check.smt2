...
(define-fun us_rep_27__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(define-fun register_type__ref_61__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_44__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_44__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3460 us_t1)
  (temp___is_init_3457 Bool) (temp___skip_constant_3458 Bool)
  (temp___do_toplevel_3459 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3458 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3460)
                                       (last3 temp___expr_3460))
                                       (and (= (first3 temp___expr_3460) 1)
                                       (= (last3 temp___expr_3460) 2)))))
...
(define-fun target__ref_18__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref_18__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3476 us_t2)
  (temp___is_init_3473 Bool) (temp___skip_constant_3474 Bool)
  (temp___do_toplevel_3475 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3474 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_3476)
                                       (last5 temp___expr_3476))
                                       (and (= (first5 temp___expr_3476) 1)
                                       (= (last5 temp___expr_3476) 2)))))
...
(declare-const temp___7683 (Array Int bits_8))

(declare-const temp___76831 t2)

(define-fun temp___76832 () us_t2 (mk___t2 temp___7683 temp___76831))
...
;; H
  (assert
  (and (= temp___76832 (register_to_bytes reg)) (dynamic_invariant1
  temp___76832 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___76831)) (to_rep (last4 temp___76831)))
     (+ (- (to_rep (last4 temp___76831)) (to_rep (first4 temp___76831))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
