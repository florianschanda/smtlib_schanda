...
;; def_axiom
  ...
  (= (select (pack__a4__my_s4__aggregate_def temp___493) temp___494)
  (of_rep temp___493)))))
...
(declare-fun g () (Array Int character))

(declare-fun my_s4 () (Array Int character))
...
(declare-fun my_s42 () (Array Int character))
...
;; H
  (assert (= (to_rep (select my_s42 2)) (to_rep (select g 2))))

(assert
;; WP_parameter_def
 ;; File "pack.adb", line 53, characters 0-0
  (not (not (= (to_rep (select my_s42 2)) (to_rep (select g 2))))))
(check-sat)
(exit)
