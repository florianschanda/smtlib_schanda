...
(declare-fun temp___1272 () digit_index_type)

(declare-fun temp___12721 () (Array Int octet))

(declare-fun temp___12722 () t1)
...
;; H
  ...
  (= temp___1279 current_borrow1)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= temp___1278 future_borrow)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= temp___1277 temporary_digit)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (and (= (mk___split_discrs temp___1272) u__split_discrs)
  (and (= temp___12721 u__split_fields) (= temp___12722 u__split_fields1)))))
