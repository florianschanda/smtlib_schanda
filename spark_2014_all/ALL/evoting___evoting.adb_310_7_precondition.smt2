...
;; H
  ...
  (and
  (and
  (and (=> (< 0 i3) (<= (to_rep2 (select counters 0)) total2))
  (<= last_candidate 20)) (and (<= 0 i3) (<= i3 20)))
  (<= total2 (* i3 10000)))))
...
;; H
  ...
  (=> (<= 0 last_candidate) (dynamic_property1 0 last_candidate i3)))
  (and (<= 0 i3) (<= i3 last_candidate)))))

;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 last_candidate))
  (and (= o (+ total2 (to_rep2 (select counters i3)))) (in_range8
  (+ total2 (to_rep2 (select counters i3)))))))
...
;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 last_candidate))
  (= (mk_int__ref i6) (mk_int__ref i4))))

;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 last_candidate))
  (= (mk_int__ref total6) (mk_int__ref total4))))
...
;; H
  (assert
  (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= total1 total6)))
...
;; H
  (assert
  (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= total7 total1)))

;; H
  (assert
  (and (= o1 (- total6 (to_rep2 (select counters 0)))) (in_range8
  (- total6 (to_rep2 (select counters 0))))))
...
;; H
  (assert
  (=> (and (<= 0 i8) (<= i8 last_candidate))
  (and (<= 0 i9) (<= i9 last_candidate))))
...
;; H
  (assert
  (=> (and (<= 0 i8) (<= i8 last_candidate))
  (= (mk_int__ref i12) (mk_int__ref i10))))
