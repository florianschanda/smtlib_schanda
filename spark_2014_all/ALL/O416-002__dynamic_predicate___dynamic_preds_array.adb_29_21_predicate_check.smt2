...
;; H
  (assert
  (and
  (and (in_range dynamic_preds_array__init_ok_even__x)
  (= (mod2 dynamic_preds_array__init_ok_even__x 2) 0)) (in_range2
  dynamic_preds_array__init_ok_even__x)))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds_array.adb", line 20, characters 0-0
  (not (= (mod2 dynamic_preds_array__init_ok_even__x 2) 0)))
(check-sat)
(exit)
