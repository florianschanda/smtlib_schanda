...
;; H
  (assert (= o15 (create__2 fliteral4)))
...
;; H
  (assert
  (and (= o11 (add RNE1 deltaareasum2 (mul RNE1 deltamag2 deltamag2)))
  (tqtisFinite (add RNE1 deltaareasum2 (mul RNE1 deltamag2 deltamag2)))))
...
;; H
  (assert
  (and
  (= o12 (mul RNE1 (mul RNE1 (mul RNE1 deltamag2 deltamag2) deltamag2)
         deltaangle2))
  (tqtisFinite
  (mul RNE1 (mul RNE1 (mul RNE1 deltamag2 deltamag2) deltamag2) deltaangle2))))

;; H
  (assert (= o13 (add RNE1 obstacleavoiddelta2 o12)))
