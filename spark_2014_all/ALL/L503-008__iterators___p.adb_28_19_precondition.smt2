...
;; H
  ...
  (ite (= (= (length x) 0) true) (= (bool_eq1 temp___4641 no_element) true)
...
;; H
  (assert
  (not
  (= (bool_eq1 (mk___rep1 (mk___split_fields1 c__split_fields1)) no_element) true)))

;; H
  (assert
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 sum2))
  (not (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true))))
