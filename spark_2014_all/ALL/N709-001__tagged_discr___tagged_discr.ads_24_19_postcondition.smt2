...
;; tagged_discr__t__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero1 v)) (to_int1 (is_zero2 us_tag v))) :pattern (
  (is_zero2 us_tag v)) )))

;; tagged_discr__u1__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__2 (of_base v))) (to_int1 (is_zero2 us_tag1 v))) :pattern (
  (is_zero2 us_tag1 v)) )))

;; tagged_discr__u2__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__3 (of_base1 v))) (to_int1 (is_zero2 us_tag2 v))) :pattern (
  (is_zero2 us_tag2 v)) )))

;; tagged_discr__init__T3b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero1 v)) (to_int1 (is_zero2 us_tag3 v))) :pattern (
  (is_zero2 us_tag3 v)) )))

;; tagged_discr__init__2__T6b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero1 v)) (to_int1 (is_zero2 us_tag4 v))) :pattern (
  (is_zero2 us_tag4 v)) )))

;; tagged_discr__init__2__T8b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__2 (of_base v))) (to_int1 (is_zero2 us_tag5 v))) :pattern (
  (is_zero2 us_tag5 v)) )))

;; tagged_discr__init__3__T11b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero1 v)) (to_int1 (is_zero2 us_tag6 v))) :pattern (
  (is_zero2 us_tag6 v)) )))

;; tagged_discr__init__3__T13b__compat_axiom
  (assert
  (forall ((v us_rep))
  (! (= (to_int1 (is_zero__3 (of_base1 v))) (to_int1 (is_zero2 us_tag7 v))) :pattern (
  (is_zero2 us_tag7 v)) )))
...
;; is_zero__def_axiom
  ...
  (! (= (= (is_zero1 v) true)
     ...
     (to_rep2 (rec__tagged_discr__t__y (us_split_fields1 v))) fliteral1)))) :pattern (
  (is_zero1 v)) )))
...
;; is_zero__3__def_axiom
  ...
  (! (= (= (is_zero__3 v) true)
     ...
     (to_rep2 (rec__tagged_discr__u2__yy (us_split_fields5 v))) fliteral1))) :pattern (
  (is_zero__3 v)) )))
