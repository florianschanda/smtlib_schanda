...
(declare-fun use_sets__are_disjoint_2__cu__assume () count_type)
...
(declare-fun use_sets__are_disjoint_2__result () Bool)

(declare-fun result2 () Bool)

(declare-fun use_sets__are_disjoint_2__result1 () Bool)
