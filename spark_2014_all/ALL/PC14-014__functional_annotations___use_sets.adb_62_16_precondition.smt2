...
;; length__post_axiom
  (assert
  (forall ((container us_rep2)) (! (dynamic_invariant6 (length4 container)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep4)) (! (dynamic_invariant6 (length1 container)
...
(define-fun use_sets__are_disjoint_2__cu__assume1 () us_rep1 (mk___rep1
                                                             (mk___split_fields1
                                                             use_sets__are_disjoint_2__cu__assume)))

;; H
  (assert
  (and (= use_sets__are_disjoint_2__cu__assume1 (first s1))
  (ite (= (= (length2 s1) 0) true)
  (= (bool_eq1 use_sets__are_disjoint_2__cu__assume1 no_element) true)
  (and
  (= (has_key (positions s1) use_sets__are_disjoint_2__cu__assume1) true)
  (= (get1 (positions s1) use_sets__are_disjoint_2__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields4)))
  (= (= result1 true)
  (= (has_key (positions s1) (mk___rep1 cu__split_fields4)) true))))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions s1) (mk___rep1 cu__split_fields3)) 1)))
...
;; H
  (assert
  (and (= o (element s1 (mk___rep1 cu__split_fields3)))
  (and (in_range6 o)
  (= o (get (elements s1)
       (get1 (positions s1) (mk___rep1 cu__split_fields3)))))))
...
;; H
  (assert
  (= use_sets__are_disjoint_2__result1 use_sets__are_disjoint_2__result))

(assert
;; WP_parameter_def
 ;; File "use_sets.ads", line 38, characters 0-0
  (not
  (or (= (has_key (positions s1) (mk___rep1 cu__split_fields3)) true)
