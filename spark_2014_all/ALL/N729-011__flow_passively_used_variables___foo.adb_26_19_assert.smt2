...
(declare-fun foo__nested__glob__f__first__bit () Int)

(declare-fun foo__nested__glob__f__last__bit () Int)

(declare-fun foo__nested__glob__f__position () Int)
...
(declare-fun g1__split_fields () natural)
