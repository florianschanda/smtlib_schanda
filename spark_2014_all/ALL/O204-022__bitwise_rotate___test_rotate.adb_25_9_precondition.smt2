...
(((mk_longword_t__ref (longword_t__content longword_t)))))
...
(declare-fun r__function_guard ((_ BitVec 64) (_ BitVec 64)
  (_ BitVec 64)) Bool)
...
;; r__post_axiom
  ...
  (! (=>
     ...
     (let ((result (r a b)))
     (and (not (= result ((_ int2bv 64) 0))) (dynamic_invariant result true
     false true)))) :pattern ((r a b)) )))
...
;; WP_parameter_def
 ;; File "test_rotate.adb", line 8, characters 0-0
  (not (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 18446744073709551615))))
(check-sat)
(exit)
