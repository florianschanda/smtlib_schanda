...
;; H
  (assert
  (and (= o13 (length orear))
  (and (in_range4 o13) (<= o13 (capacity orear)))))

;; H
  (assert
  (and (= o14 (length ofront))
  (and (in_range4 o14) (<= o14 (capacity ofront)))))
...
;; H
  (assert (= result4 (ite (= o12 0) true false)))
...
;; H
  (assert
  (and (= o10 (last (model__ ofront)))
  (and (in_range3 o10) (= o10 (last (model__ ofront))))))

;; H
  (assert (= o11 (ite (<= i1 o10) true false)))

;; H
  (assert (= result6 (ite (<= 1 i1) o11 false)))
...
;; H
  (assert
  (and (= o9 (get (model__ orear) o8))
  (and (in_range5 o9) (= o9 (get (model__ orear) o8)))))
