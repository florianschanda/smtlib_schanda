...
(declare-fun temp___7157 () us_rep3)
...
(declare-fun o27 () us_split_fields6)

(declare-fun temp___7162 () us_rep3)
...
;; H
  (assert
  (= o27 (mk___split_fields3 o26 (rec__ar__rec4t__g4 r__split_fields6))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1044, characters 0-0
  (not
  (= (to_rep4
     (rec__ar__rec4t__g4 (us_split_fields__content3 r__split_fields8)))
  (to_rep4 r__split_fields5))))
(check-sat)
(exit)
