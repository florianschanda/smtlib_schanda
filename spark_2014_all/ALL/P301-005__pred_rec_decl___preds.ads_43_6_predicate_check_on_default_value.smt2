...
(define-fun dynamic_invariant ((temp___expr_211 (Array Int integer))
  ...
  (temp___do_toplevel_210 Bool)) Bool (=> (= temp___do_toplevel_210 true)
                                      ...
                                      (=> (and (<= 1 k) (<= k 10))
                                      (not
                                      (= (to_rep (select temp___expr_211 k)) 0)))))))
...
(define-fun dynamic_predicate ((temp___217 (Array Int integer))) Bool
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep (select temp___217 k)) 0)))))
...
(declare-const temp___346 (Array Int integer))

;; H
  (assert (dynamic_invariant i19s true false true))

;; H
  (assert (dynamic_invariant x false false true))

;; H
  (assert (default_initial_assumption temp___346 false))

(assert
;; WP_parameter_def
 ;; File "preds.ads", line 45, characters 0-0
  (not (dynamic_predicate temp___346)))
(check-sat)
(exit)
