...
;; H
  (assert
  (and (= o6 (length left)) (and (in_range5 o6) (<= o6 (capacity left)))))
...
;; H
  (assert
  (and (= o8 (length (vector__content amortized_queue__Oconcat__3__result5)))
  (and (in_range5 o8)
  (<= o8 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
