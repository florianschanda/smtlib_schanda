...
;; H
  ...
  (= (bool_eq6 temp___1418 no_element) true)
  (and
  (and
...
;; H
  ...
  (= (bool_eq6 temp___1423 no_element) true)
  (and
...
;; H
  ...
  (and
  (and
  (and (= (bool_eq6 (mk___rep2 c__split_fields8) no_element) true)
  (= (length
...
;; H
  ...
  (ite (forall ((e us_rep))
       ...
       (not (= 2 (to_rep1 (rec__my_sets__my_rec__f (us_split_fields1 e)))))))
  (= (bool_eq6 temp___1425 no_element) true)
  (and
...
;; WP_parameter_def
 ;; File "my_sets.adb", line 4, characters 0-0
  (not (not (= (length (mk___rep1 k__split_discrs k__split_fields8)) 0))))
(check-sat)
