...
(declare-fun xdi6 () (Array Int unsigned_8))
...
;; WP_parameter_def
 ;; File "x86.ads", line 5, characters 0-0
  ...
  (to_rep (select xdi5 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24)
  (to_rep (select xdi5 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24)
  (to_rep (select xdi5 3))) ((_ int2bv 32) 16777216))) val__)))
(check-sat)
(exit)
