...
;; H
  (assert
  (and
  (= o (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c))
  (= (= o true)
...
;; H
  (assert
  (and (= o4 (key (mk___rep d__split_discrs d__split_fields2) c))
  (and (in_range7 o4)
  (= o4 (get (keys (mk___rep d__split_discrs d__split_fields2))
        (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
...
;; H
  (assert
  (and (= o2 (key (mk___rep d__split_discrs d__split_fields2) c))
  (and (in_range7 o2)
  (= o2 (get (keys (mk___rep d__split_discrs d__split_fields2))
        (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c))))))
