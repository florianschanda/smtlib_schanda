...
(declare-fun dw1000__register_types__evc_ffr_type__evc_ffr__first__bit () Int)

(declare-fun dw1000__register_types__evc_ffr_type__evc_ffr__last__bit () Int)

(declare-fun dw1000__register_types__evc_ffr_type__evc_ffr__position () Int)
...
(declare-fun dw1000__register_types__evc_ffr_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__evc_ffr_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__evc_ffr_type__reserved__position () Int)
