...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100))
  (= o5 (store (rec__do_loops__r_array_record__f3 d__split_fields3) i3
  o4))))
...
;; H
  ...
  (= (to_rep
     (rec__do_loops__r__f2
     (us_split_fields1
     (select (rec__do_loops__r_array_record__f3 d__split_fields4) i3))))
  (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___236 i3)))))))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100)) (= d__split_fields6 d__split_fields4)))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100)) (= d__split_fields7 d__split_fields5)))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 100)) (= d__split_fields8 d__split_fields6)))
...
;; H
  ...
  (rec__do_loops__r_array_record__f3
  (us_split_fields__content1 d__split_fields7)) temp___262))
  (= (rec__do_loops__r__f2
     (us_split_fields1
  ...
  (rec__do_loops__r_array_record__f4
  (us_split_fields__content1 d__split_fields7)) temp___263))
  (= (rec__do_loops__r__f2
     (us_split_fields1
...
;; H
  ...
  (= (to_rep
     (rec__do_loops__r__f2
     (us_split_fields1
     (select (rec__do_loops__r_array_record__f3 d__split_fields11) i9))))
  (to_rep
  (rec__do_loops__r__f2
  (us_split_fields1
  (select (rec__do_loops__r_array_record__f3
          (us_split_fields__content1 d__split_fields7)) i9))))))
...
;; WP_parameter_def
 ;; File "do_loops.adb", line 16, characters 0-0
  ...
  (= (bool_eq1 (rec__do_loops__r_array_record__f4 d__split_fields11) 1 100
     (rec__do_loops__r_array_record__f4
     (us_split_fields__content1 d__split_fields7)) 1 100) true)))
(check-sat)
(exit)
