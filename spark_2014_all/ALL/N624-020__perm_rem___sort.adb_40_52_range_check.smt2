...
(declare-fun temp___246 () (Array Int natural))
...
;; H
  (assert
  (and (= o30 (remove (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and (= o31 (remove (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and (= o20 (remove_eq o31 o30 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o30 o19)))
     (let ((temp___162 (remove o31 o19)))
...
;; H
  (assert
  (and (= o29 (remove (mk___t interm1 (mk 1 100)) o24))
  (and (dynamic_invariant4 o29 true false true)
  (and (= (invariant__ o29) true)
  (and (= (to_rep1 (last o26)) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o24 1)))
  (= (to_rep (select interm1 k)) (to_rep (select o25 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select interm1 k)) (to_rep (select o25 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o24 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select interm1 (+ k 1))) (to_rep (select o25 k))))))))))))

;; H
  (assert
  (and (= temp___2462 (remove o29 o27))
  (and (dynamic_invariant4 temp___2462 true false true)
  (and (= (invariant__ temp___2462) true)
  (and (= (to_rep1 (last temp___2461)) (- (to_rep1 (last o26)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o27 1)))
  (= (to_rep (select o25 k)) (to_rep (select temp___246 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last o26))))
  (= (to_rep (select o25 k)) (to_rep (select temp___246 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o27 k) (<= k (- (to_rep1 (last o26)) 1)))
  (= (to_rep (select o25 (+ k 1))) (to_rep (select temp___246 k))))))))))))
