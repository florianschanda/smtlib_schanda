...
(declare-fun temp___278 () positive)

(declare-fun temp___2781 () (Array Int element))

(declare-fun temp___2782 () t)

(declare-fun temp___2783 () natural)

(declare-fun temp___2784 () us_private)
...
(declare-fun this__split_fields8 () us_split_fields)
...
;; H
  ...
  (<= (to_rep this__split_fields6) (to_rep3 (last this__split_fields5)))))
...
;; H
  (assert (= this__split_discrs (mk___split_discrs temp___278)))

;; H
  (assert (= temp___2781 o11))

;; H
  (assert (= temp___2782 o12))

;; H
  (assert (= temp___2783 o13))

;; H
  (assert (= temp___2784 o14))

;; H
  (assert (= this__attr__tag temp___2785))
...
;; H
  (assert
  (= this__split_fields8 (mk___split_fields (mk___t temp___2781 temp___2782)
                         temp___2783 temp___2784)))
...
;; H
  (assert
  (= this__split_fields9 (mk___split_fields__ref this__split_fields8)))
...
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 17, characters 0-0
  ...
  (= (empty
     (mk___rep this__split_discrs
     (us_split_fields__content this__split_fields9) this__attr__tag)) true))))
(check-sat)
(exit)
