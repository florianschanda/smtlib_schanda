...
;; range_axiom
  (assert
  (forall ((x bits_4)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(define-fun us_split_fields_SYSCLKS__projection ((a us_split_fields)) bits_2
  (rec__dw1000__register_types__pmsc_ctrl0_type__sysclks a))

(define-fun us_split_fields_RXCLKS__projection ((a us_split_fields)) bits_2
  (rec__dw1000__register_types__pmsc_ctrl0_type__rxclks a))

(define-fun us_split_fields_TXCLKS__projection ((a us_split_fields)) bits_2
  (rec__dw1000__register_types__pmsc_ctrl0_type__txclks a))

(define-fun us_split_fields_FACE__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__face a))

(define-fun us_split_fields_ADCCE__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__adcce a))

(define-fun us_split_fields_AMCE__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__amce a))

(define-fun us_split_fields_GPCE__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__gpce a))

(define-fun us_split_fields_GPRN__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__gprn a))

(define-fun us_split_fields_GPDCE__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__gpdce a))

(define-fun us_split_fields_GPDRN__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__gpdrn a))

(define-fun us_split_fields_KHZCLKEN__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl0_type__khzclken a))

(define-fun us_split_fields_SOFTRESET__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__pmsc_ctrl0_type__softreset a))

(define-fun us_split_fields_Reserved_116__projection ((a us_split_fields)) bits_3
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_1 a))

(define-fun us_split_fields_Reserved_216__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_2 a))

(define-fun us_split_fields_Reserved_35__projection ((a us_split_fields)) bits_3
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_3 a))

(define-fun us_split_fields_Reserved_42__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_4 a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_101__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_101__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                a))
...
(declare-datatypes ((pmsc_ctrl0_type__ref 0))
(((mk_pmsc_ctrl0_type__ref (pmsc_ctrl0_type__content us_rep)))))
(define-fun pmsc_ctrl0_type__ref___projection ((a pmsc_ctrl0_type__ref)) us_rep
  (pmsc_ctrl0_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_230__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_165__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_165__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7219 us_t1)
  (temp___is_init_7216 Bool) (temp___skip_constant_7217 Bool)
  (temp___do_toplevel_7218 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7217 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_7219)
                                       (last3 temp___expr_7219))
                                       (and (= (first3 temp___expr_7219) 1)
                                       (= (last3 temp___expr_7219) 4)))))
...
(define-fun target__ref_66__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref_66__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_7250 us_t2)
  (temp___is_init_7247 Bool) (temp___skip_constant_7248 Bool)
  (temp___do_toplevel_7249 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7248 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_7250)
                                       (last5 temp___expr_7250))
                                       (and (= (first5 temp___expr_7250) 1)
                                       (= (last5 temp___expr_7250) 4)))))
...
(declare-const temp___80701 t2)

(define-fun temp___80702 () us_t2 (mk___t2 temp___8070 temp___80701))
...
;; H
  (assert
  (and (= temp___80702 (register_to_bytes reg)) (dynamic_invariant1
  temp___80702 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___80701)) (to_rep (last4 temp___80701)))
     (+ (- (to_rep (last4 temp___80701)) (to_rep (first4 temp___80701))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
