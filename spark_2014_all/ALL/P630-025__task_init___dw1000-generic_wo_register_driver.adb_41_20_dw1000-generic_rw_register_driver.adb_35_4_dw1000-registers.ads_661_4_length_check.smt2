...
(define-fun us_split_fields_Reserved_1__16__projection ((a us_split_fields)) bits_3
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_1 a))

(define-fun us_split_fields_Reserved_2__16__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_2 a))

(define-fun us_split_fields_Reserved_3__5__projection ((a us_split_fields)) bits_3
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_3 a))

(define-fun us_split_fields_Reserved_4__2__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_4 a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___101__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___101__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                  a))
...
(define-fun register_type__ref___230__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___165__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___165__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7355 us_t1)
  (temp___is_init_7352 Bool) (temp___skip_constant_7353 Bool)
  (temp___do_toplevel_7354 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7353 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_7355)
                                       (last3 temp___expr_7355))
                                       (and (= (first3 temp___expr_7355) 1)
                                       (= (last3 temp___expr_7355) 4)))))
...
(define-fun target__ref___66__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___66__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_7386 us_t2)
  (temp___is_init_7383 Bool) (temp___skip_constant_7384 Bool)
  (temp___do_toplevel_7385 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7384 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_7386)
                                       (last5 temp___expr_7386))
                                       (and (= (first5 temp___expr_7386) 1)
                                       (= (last5 temp___expr_7386) 4)))))
...
(define-fun temp___82202 () us_t2 (mk___t2 temp___8220 temp___82201))
...
;; H
  (assert
  (and (= temp___82202 (register_to_bytes reg)) (dynamic_invariant1
  temp___82202 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___82201)) (to_rep (last4 temp___82201)))
     (+ (- (to_rep (last4 temp___82201)) (to_rep (first4 temp___82201))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
