...
;; range_axiom
  (assert
  (forall ((x enum1t)) (! (in_range4 (to_rep x)) :pattern ((to_rep x)) )))
...
;; range_axiom
  (assert
  (forall ((x enum1ta)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
;; inversion_axiom
  (assert
  (forall ((x et1)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)) )))

;; range_axiom
  (assert
  (forall ((x et1)) (! (in_range (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; inversion_axiom
  (assert
  (forall ((x et2)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)) )))

;; range_axiom
  (assert
  (forall ((x et2)) (! (in_range1 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (to_rep2 (rec__ar__rec1t__f1 (us_split_fields1 b))))
                        (= (to_rep3
                           (rec__ar__rec1t__g1 (us_split_fields1 a)))
                        (to_rep3 (rec__ar__rec1t__g1 (us_split_fields1 b)))))
                   true false))
...
(declare-fun to_rep4 (et3) Int)

(declare-fun of_rep4 (Int) et3)

;; inversion_axiom
  (assert
  (forall ((x et3)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)) )))

;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range2 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (and
                         ...
                         (to_rep4 (rec__ar__rec2t__f2 (us_split_fields3 b))))
                         (= (bool_eq
...
;; range_axiom
  (assert
  (forall ((x et4)) (! (in_range3 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(declare-fun o7 () enum1t)

(declare-fun temp___7225 () et3)

(declare-fun temp___72251 () et1)

(declare-fun temp___72252 () et2)

(declare-fun temp___72253 () enum1ta)

(declare-fun temp___72254 () et4)

(declare-fun temp___72255 () enum1t)
...
(declare-fun o13 () us_split_fields6)

(declare-fun temp___7229 () us_rep3)
...
;; H
  (assert (in_range5 (to_rep r__split_fields5)))
...
;; H
  (assert
  (and (= o (to_rep r__split_fields5)) (in_range5 (to_rep r__split_fields5))))
...
;; H
  (assert (= (to_rep o1) (to_rep1 r__split_fields3)))
...
;; H
  (assert (= temp___7225 o2))

;; H
  (assert (= temp___72251 o3))

;; H
  (assert (= temp___72252 o4))

;; H
  (assert (= temp___72253 o5))

;; H
  (assert (= temp___72254 o6))

;; H
  (assert (= temp___72255 o7))
...
;; H
  (assert
  (= r__split_fields6 (mk___split_fields3
                      (mk___rep2
                      (mk___split_fields2
                      (mk___rep1
                      (mk___split_fields1 temp___7225
                      (mk___rep
                      (mk___split_fields temp___72251 temp___72252))
                      temp___72253)) temp___72254)) temp___72255)))

;; H
  (assert (= (to_rep1 o8) temp1))

;; H
  (assert
  (= o9 (mk___split_fields1
        (rec__ar__rec2t__f2
        (us_split_fields3
        (rec__ar__rec3t__f3
        (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6)))))
        (rec__ar__rec2t__g2
        (us_split_fields3
        (rec__ar__rec3t__f3
        (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))) o8)))

;; H
  (assert (= o10 (mk___rep1 o9)))

;; H
  (assert
  (= o11 (mk___split_fields2 o10
         (rec__ar__rec3t__g3
         (us_split_fields5 (rec__ar__rec4t__f4 r__split_fields6))))))

;; H
  (assert (= o12 (mk___rep2 o11)))

;; H
  (assert
  (= o13 (mk___split_fields3 o12 (rec__ar__rec4t__g4 r__split_fields6))))

;; H
  (assert (= temp___7229 (mk___rep3 o13)))

;; H
  (assert (= result2 (mk___split_fields__ref3 r__split_fields6)))

;; H
  (assert (= r__split_fields7 (us_split_fields7 temp___7229)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1071, characters 0-0
  (not
  (= (bool_eq3 (mk___rep3 (us_split_fields__content3 r__split_fields8))
     (mk___rep3
     (mk___split_fields3
     (mk___rep2
     (mk___split_fields2
