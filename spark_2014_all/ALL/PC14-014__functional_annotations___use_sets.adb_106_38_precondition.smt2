...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s2__split_discrs s2__split_fields3))))
...
;; H
  ...
  (= (get
     (elements
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1)
...
;; H
  (assert
  (and
  (= temp___959 (elements (mk___rep s2__split_discrs s2__split_fields3)))
  (and
  (and
  (and
  (and
  (= (length2 temp___959) (length
                          (mk___rep s2__split_discrs s2__split_fields3)))
  (forall ((temp___425 Int))
  (=>
  (and (in_range3 temp___425)
  (= (iter_has_element temp___959 temp___425) true))
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields3))
     (get temp___959 temp___425)) true))))
  (forall ((item Int))
  (=>
  (and (in_range6 item)
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields3)) item) true))
  (and (< 0 (find temp___959 item))
  (= (get temp___959 (find temp___959 item)) item)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s2__split_discrs s2__split_fields3))))
  (= (find temp___959 (get temp___959 i1)) i1))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s2__split_discrs s2__split_fields3))))
  ...
  (=>
  (and (<= 1 j)
  (<= j (length (mk___rep s2__split_discrs s2__split_fields3))))
  (=> (= (get temp___959 i1) (get temp___959 j)) (= i1 j)))))))))

;; H
  (assert
  (and (= o (iter_has_element temp___959 temp___958))
  (= (= o true) (and (<= 1 temp___958) (<= temp___958 (last temp___959))))))
...
;; H
  (assert
  (and (= o2 (length (mk___rep s2__split_discrs s2__split_fields3)))
  (and (in_range2 o2)
  (<= o2 (to_rep1 (rec__use_sets__my_sets__set__capacity s2__split_discrs))))))
...
;; H
  ...
  (= (length2 o4) (length
                  ...
                  (mk___split_fields s1__split_fields))))
  (forall ((temp___425 Int))
  (=> (and (in_range3 temp___425) (= (iter_has_element o4 temp___425) true))
  (= (contains
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (get o4 temp___425)) true))))
  (forall ((item Int))
  (=>
  (and (in_range6 item)
  (= (contains
