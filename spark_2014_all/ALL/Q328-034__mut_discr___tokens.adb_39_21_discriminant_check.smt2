...
(declare-fun o30 () token_kind)

(declare-fun o31 () Int)

(declare-fun o32 () operation)

(declare-fun o33 () us_split_fields2)

(declare-fun o34 () us_split_discrs)

(declare-fun temp___235 () us_rep1)
...
;; H
  (assert (= temp___235 (mk___rep1 o34 o33 true)))
...
;; WP_parameter_def
 ;; File "tokens.ads", line 14, characters 0-0
  (not
  (= (rec__tokens__token__kind (us_split_discrs1 temp___235)) (rec__tokens__token__kind
                                                              v__split_discrs))))
(check-sat)
(exit)
