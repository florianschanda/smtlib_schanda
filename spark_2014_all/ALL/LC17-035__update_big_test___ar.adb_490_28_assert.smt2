...
(declare-fun temp___4613 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___4615 (Array Int (Array Int et1))))
  (forall ((temp___4616 Int))
  (forall ((temp___4617 (Array Int et1)))
  (let ((temp___4614 (temp___4613 temp___4615 temp___4616 temp___4617)))
  (forall ((temp___4618 Int))
  (ite (= temp___4618 temp___4616)
  (= (select temp___4614 temp___4618) temp___4617)
  (= (select temp___4614 temp___4618) (select temp___4615 temp___4618)))))))))

(declare-fun temp___4619 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___4621 (Array Int et1)))
  (forall ((temp___4622 Int) (temp___4623 Int))
  (let ((temp___4620 (temp___4619 temp___4621 temp___4622 temp___4623)))
  (forall ((temp___4624 Int))
  (ite (= temp___4624 temp___4622)
  (= (select temp___4620 temp___4624) (of_rep temp___4623))
  (= (select temp___4620 temp___4624) (select temp___4621 temp___4624))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 324, characters 0-0
  (not
  (= (bool_eq1 a1 5 50 (temp___4613 t1 j (temp___4619 (select t1 j) i e)) 5
     50) true)))
(check-sat)
(exit)
