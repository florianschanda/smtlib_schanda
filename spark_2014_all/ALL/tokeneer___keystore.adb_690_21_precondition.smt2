...
;; H
  ...
  (=> (<= 1 temp___1144)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1144) (<= temp___1144 150))))))
...
;; H
  (assert
  (=> (= result2 true)
  (= (ite (<= (to_rep1 (first2 temp___11421)) (to_rep1 (last2 temp___11421)))
     (+ (- (to_rep1 (last2 temp___11421)) (to_rep1 (first2 temp___11421))) 1)
     0) (ite (<= (to_rep1 (first2 temp___11451)) (to_rep1
                                                 (last2 temp___11451)))
        (+ (- (to_rep1 (last2 temp___11451)) (to_rep1 (first2 temp___11451))) 1)
        0))))

;; H
  (assert
  (=> (= result2 true)
  (= (mk___t1 temp___1146 temp___11461) (mk___t1 temp___1142 temp___11421))))

;; H
  (assert
  (=> (= result2 true)
  (forall ((temp___1147 Int))
  (ite (and (<= 1 temp___1147) (<= temp___1147 (length thestring)))
  (= (select o8 temp___1147) (select temp___1146 temp___1147))
  (= (select o8 temp___1147) (select result__1 temp___1147))))))
...
;; H
  (assert
  (=> (not (= result2 true)) (= (mk___t temp___1141 temp___11411) thestring)))
