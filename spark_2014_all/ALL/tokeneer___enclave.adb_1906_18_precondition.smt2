...
(declare-datatypes ((nonquiescentstates__ref 0))
...
;; H
  (assert (= o32 (islocked (us_private__content state36))))

;; H
  (assert (= o33 (ite (not (= o32 true)) true false)))

;; H
  (assert (= result1 (ite (= o33 true) (islocked state3) false)))
...
;; H
  (assert (=> (= result1 true) (= o35 (ite (= o34 3) true false))))
...
;; H
  (assert (=> (= result1 true) (= o37 (ite (= o36 true) o35 false))))

;; H
  (assert (=> (not (= result1 true)) (= o37 (of_int 1))))
...
;; H
  (assert (= o29 (ite (= o28 4) true false)))
...
;; H
  (assert
  (=> (= result2 true) (= o31 (ite (= (int__content status9) 6) true false))))

;; H
  (assert (=> (not (= result2 true)) (= o31 (of_int 1))))
...
;; H
  (assert
  (=> (= (int__content status9) 8) (= o25 (ite (= o24 0) true false))))
...
;; H
  (assert
  (=> (= (int__content status9) 8)
  (= o26 (ite (not (= o23 true)) true false))))

;; H
  (assert
  (=> (= (int__content status9) 8) (= o27 (ite (= o26 true) o25 false))))

;; H
  (assert (=> (not (= (int__content status9) 8)) (= o27 (of_int 1))))
...
;; H
  (assert
  (=> (= (int__content status9) 3)
  (= o22 (ite (not (= o21 true)) true false))))

;; H
  (assert (=> (not (= (int__content status9) 3)) (= o22 (of_int 1))))
...
;; H
  (assert
  (=> (=> (not (= (int__content status9) 6)) (= (int__content status9) 7))
  (= o19 (ite (= o15 true) o14 false))))

;; H
  (assert
  (=> (=> (not (= (int__content status9) 6)) (= (int__content status9) 7))
  (= o20 (ite (= o19 true) o18 false))))
...
;; H
  (assert
  (=> (=> (not (= (int__content status9) 5)) (= (int__content status9) 4))
  (= o13 (ite (not (= o12 true)) true false))))
...
;; H
  (assert (= result3 (ite (not (= o9 true)) true false)))
...
;; H
  (assert (=> (= result4 true) (= o6 (ite (not (= o5 true)) true false))))
...
;; H
  (assert (=> (= result4 true) (= o3 (ite (= o2 3) true false))))
...
;; H
  (assert (=> (= result4 true) (= o7 (ite (= o4 true) o3 false))))

;; H
  (assert (=> (= result4 true) (= o8 (ite (= o7 false) o6 true))))

;; H
  (assert (=> (not (= result4 true)) (= o8 (of_int 1))))
