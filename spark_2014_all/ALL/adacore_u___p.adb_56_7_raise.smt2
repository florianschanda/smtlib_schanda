...
(define-fun result__8 () int__ref (mk_int__ref result__6))
...
;; H
  (assert
  (exists ((i7 Int))
  (and (and (<= (to_rep1 (first (rt a))) i7) (<= i7 (to_rep1 (last (rt a)))))
  (= (to_rep (select (elts a) i7)) e))))

(assert
;; WP_parameter_def
 ;; File "p.adb", line 59, characters 0-0
  (not
  (not
  (and
  (and (= (mk_int__ref result) (mk_int__ref i))
  (= i1 (to_rep1 (first (rt a)))))
  (ite (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (and
  (and
  (and (= temp___261 i1)
  (and (= temp___260 result__)
  (and
  (and (not (= (to_rep (select (elts a) i1)) e))
  (and (= result__2 result__) (= result__2 result__1)))
  (and
  (forall ((k Int))
  (=> (and (<= (to_rep1 (first (rt a))) k) (<= k i2))
  (not (= (to_rep (select (elts a) k)) e))))
  (and
  (and
  ...
  (and (and (= i2 i3) (= result__3 result__4))
  (and (= i4 i2) (= result__5 result__3))))
  (and
  (and (= (mk_int__ref i5) (mk_int__ref i3))
  (= result__8 (mk_int__ref result__4)))
  (and (= i6 i4) (= result__7 result__5))))
  (and (and (= i1 i5) (= result__8 (mk_int__ref result__)))
  (and (= i6 i1) (= result__7 result__1))))))))
(check-sat)
(exit)
