...
(define-fun dynamic_invariant1 ((temp___expr_2016 Int)
...
;; move_is_possible__def_axiom
  ...
  (! (= (= (move_is_possible p a) true)
     ...
     (+ (to_rep2 (rec__patris__piece__x (us_split_fields1 p))) 1))
     (=> (= a 2) (in_range4
     (+ (to_rep3 (rec__patris__piece__y (us_split_fields1 p))) 1)))))) :pattern (
...
;; move__def_axiom
  ...
  (! (=> (dynamic_invariant1 a true true true)
     (= (move p a) (ite (= a 0)
                   ...
                   (mk___split_fields (rec__patris__piece__s usq_)
                   (rec__patris__piece__d usq_)
                   (of_rep2
                   (- (to_rep2 (rec__patris__piece__x (us_split_fields1 p))) 1))
                   (rec__patris__piece__y usq_))))
                   (ite (= a 1)
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__patris__piece__s usq_)
                   ...
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__patris__piece__s usq_)
                   (rec__patris__piece__d usq_) (rec__patris__piece__x usq_)
                   (of_rep3
                   (+ (to_rep3 (rec__patris__piece__y (us_split_fields1 p))) 1)))))
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   ...
                   (of_rep4
                   (turn_direction
                   (to_rep4 (rec__patris__piece__d (us_split_fields1 p))) a))
                   (rec__patris__piece__x usq_) (rec__patris__piece__y usq_))))))))) :pattern (
  (move p a)) ))))
...
(define-fun dynamic_invariant10 ((temp___expr_2028 Int)
