...
(define-fun tregister_byte_arrayP1__ref_9__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_9__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2151 us_t1)
  (temp___is_init_2148 Bool) (temp___skip_constant_2149 Bool)
  (temp___do_toplevel_2150 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2149 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2151)
                                       (last3 temp___expr_2151))
                                       (and (= (first3 temp___expr_2151) 1)
                                       (= (last3 temp___expr_2151) 5)))))
