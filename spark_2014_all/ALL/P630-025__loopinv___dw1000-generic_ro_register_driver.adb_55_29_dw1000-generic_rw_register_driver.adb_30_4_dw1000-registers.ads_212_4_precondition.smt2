...
(define-fun tregister_byte_arrayP1__ref___9__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___9__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2157 us_t1)
  (temp___is_init_2154 Bool) (temp___skip_constant_2155 Bool)
  (temp___do_toplevel_2156 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2155 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2157)
                                       (last3 temp___expr_2157))
                                       (and (= (first3 temp___expr_2157) 1)
                                       (= (last3 temp___expr_2157) 5)))))
