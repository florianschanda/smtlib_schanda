...
(declare-fun user_eq4 (tTtSP1 tTtSP1) Bool)

(declare-const dummy4 tTtSP1)

(declare-datatypes ((tTtSP1__ref 0))
(((mk_tTtSP1__ref (tTtSP1__content tTtSP1)))))
...
;; temp___String_Literal_181__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     (and
     (= (to_rep (select (temp___String_Literal_181 us_void_param) 1)) 116)
     (= (to_rep (select (temp___String_Literal_181 us_void_param) 2)) 111))
     (= (to_rep (select (temp___String_Literal_181 us_void_param) 3)) 116))
     (= (to_rep (select (temp___String_Literal_181 us_void_param) 4)) 111)) :pattern (
  (temp___String_Literal_181 us_void_param)) )))
...
;; temp___String_Literal_183__def_axiom
  ...
  (! (and
     (and
     (and
     (= (to_rep (select (temp___String_Literal_183 us_void_param) 5)) 116)
     (= (to_rep (select (temp___String_Literal_183 us_void_param) 6)) 111))
     (= (to_rep (select (temp___String_Literal_183 us_void_param) 7)) 116))
     (= (to_rep (select (temp___String_Literal_183 us_void_param) 8)) 111)) :pattern (
...
(declare-const t1 (Array Int character))
...
(declare-const t2 (Array Int character))

;; H
  (assert (= result s))

;; H
  (assert (= s1 (temp___String_Literal_181 Tuple0)))
...
;; H
  (assert (= (to_rep1 (first (rt (id (mk___t t2 (mk 5 8)))))) 5))

(assert
;; WP_parameter_def
 ;; File "test_string_literals.adb", line 5, characters 0-0
  (not
  (= (let ((temp___185 (id (mk___t t2 (mk 5 8)))))
     (bool_eq s1 (to_rep1 s__first) (to_rep1 s__last) (elts temp___185)
     (to_rep1 (first (rt temp___185))) (to_rep1 (last (rt temp___185))))) true)))
(check-sat)
(exit)
