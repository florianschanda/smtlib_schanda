...
(((mk_t106b__ref (t106b__content tdigit_index_typeB)))))
...
;; H
  ...
  (<= i2 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= o3 (ite (= o2 ((_ int2bv 8) 0)) true false))))
...
;; H
  ...
  (<= i2 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= result2 (ite (not (= o3 true)) true false))))
...
;; H
  ...
  (<= i2 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (=> (= result2 true) (= digit_index1 result3))))
...
;; H
  ...
  (<= i2 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (=> (not (= result2 true)) (= digit_index2 digit_index1))))
...
;; H
  ...
  (<= i2 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number)))))))
  (= digit_index10 (mk_int__ref digit_index4))))
...
;; H
  ...
  (<= i2 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 number))))))))
  (= digit_index7 digit_index1)))

;; H
  (assert
  (= aco__math__very_longs__divide__get_msd__result1 aco__math__very_longs__divide__get_msd__result2))

;; H
  (assert
  (= aco__math__very_longs__divide__get_msd__result3 aco__math__very_longs__divide__get_msd__result1))

;; H
  (assert
  (= (mk_int__ref result4) (mk_int__ref
                           aco__math__very_longs__divide__get_msd__result)))
...
;; H
  (assert
  (= (mk_int__ref aco__math__very_longs__divide__get_msd__result4) (mk_int__ref
                                                                   aco__math__very_longs__divide__get_msd__result2)))
...
;; H
  (assert
  (= aco__math__very_longs__divide__get_msd__result5 aco__math__very_longs__divide__get_msd__result3))
...
;; H
  (assert
  (and (= o4 (+ aco__math__very_longs__divide__get_msd__result4 1))
  (in_range1 (+ aco__math__very_longs__divide__get_msd__result4 1))))
