...
(declare-const temp___1304 us_t3)
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true) (=> (not (<= 1 43)) (= o1 0))))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true) (and (= o5 o4) (in_range2 o4))))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (= (mk 1 o5) keystore__dofind__B74b__thestring__assume1)))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (and (= o6 (length thestring)) (in_range1 (length thestring)))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (= result4 (ite (<= o6 150) true false))))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true) (= (mk1 1 (length thestring)) temp___12781))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true)
  (and (= temp___1280 (length thestring)) (in_range1 (length thestring))))))
...
;; H
  ...
  (=> (<= 1 temp___1280)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1280) (<= temp___1280 150)))))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true) (= o7 result__5))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true) (= o7 temp___1281))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true) (= (mk1 1 temp___1280) temp___12811))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true)
  (= (ite (<= (to_rep1 (first2 temp___12781)) (to_rep1 (last2 temp___12781)))
     (+ (- (to_rep1 (last2 temp___12781)) (to_rep1 (first2 temp___12781))) 1)
     0) (ite (<= (to_rep1 (first2 temp___12811)) (to_rep1
                                                 (last2 temp___12811)))
        (+ (- (to_rep1 (last2 temp___12811)) (to_rep1 (first2 temp___12811))) 1)
        0)))))
...
;; H
  ...
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true)
  (= (mk___t1 temp___1282 temp___12821) (mk___t1 temp___1278 temp___12781)))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (= result4 true)
  (forall ((temp___1283 Int))
  (ite (and (<= 1 temp___1283) (<= temp___1283 (length thestring)))
  (= (select o8 temp___1283) (select temp___1282 temp___1283))
  (= (select o8 temp___1283) (select result__5 temp___1283)))))))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (not (= result4 true)) (= (mk___t temp___1277 temp___12771) thestring))))

;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (not (= result4 true)) (= o9 temp___1277))))
...
;; H
  ...
  (=> (= (select issystem retvaldo2) true)
  (=>
  (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))))
  (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b))))))
  (= o10 (+ (- (to_rep1
               (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))))
  (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))))) 1)))))
...
;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (= (concat1 (temp___String_Literal_1297 Tuple0) 1 39
     (elts (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))
     (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))))
     (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b))))))
...
;; H
  ...
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true)
  (= (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) temp___1291))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true) (= (mk2 1 (length thestring1)) temp___12911))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true)
  (and (= temp___1293 (length thestring1)) (in_range1 (length thestring1))))))
...
;; H
  ...
  (=> (<= 1 temp___1293)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1293) (<= temp___1293 150)))))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true) (= o17 result__8))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true) (= o17 temp___1294))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true) (= (mk2 1 temp___1293) temp___12941))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true)
  (= (ite (<= (to_rep1 (first4 temp___12911)) (to_rep1 (last4 temp___12911)))
     (+ (- (to_rep1 (last4 temp___12911)) (to_rep1 (first4 temp___12911))) 1)
     0) (ite (<= (to_rep1 (first4 temp___12941)) (to_rep1
                                                 (last4 temp___12941)))
        (+ (- (to_rep1 (last4 temp___12941)) (to_rep1 (first4 temp___12941))) 1)
        0)))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true) (= temp___1295 (mk___t2 temp___1291 temp___12911)))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true)
  (forall ((temp___1296 Int))
  (ite (and (<= 1 temp___1296) (<= temp___1296 (length thestring1)))
  (= (select o18 temp___1296) (select (elts2 temp___1295) temp___1296))
  (= (select o18 temp___1296) (select result__8 temp___1296)))))))
...
;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (not (= result9 true)) (= temp___1290 thestring1))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (not (= result9 true)) (= o19 (elts temp___1290)))))
...
;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (not (= result9 true)) (= result__10 o19))))
...
;; H
  (assert
  (=>
  (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c94b)))))
  (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c94b))))))
  (= o20 (+ (- (to_rep1
               (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c94b)))))
  (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c94b)))))) 1))))
...
;; H
  ...
  (= keystore__dofind__B98b__thestring__assume (mk___t
                                               (concat1
                                               (temp___String_Literal_1310
                                               Tuple0) 1 44
                                               (elts
                                               (to_string
                                               (attr__ATTRIBUTE_IMAGE9 c94b)))
                                               (to_rep1
                                               (first
                                               (rt
                                               (to_string
