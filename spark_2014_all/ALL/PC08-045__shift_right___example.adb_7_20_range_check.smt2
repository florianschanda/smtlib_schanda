...
(define-fun dynamic_invariant ((temp___expr_141 (_ BitVec 16))
...
(define-fun dynamic_invariant2 ((temp___expr_135 (_ BitVec 8))
...
;; H
  (assert
  (and (= o (shift_right value 8))
  (= o (bvudiv value (ite (< 8 65536)
                     (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8))
                     ((_ int2bv 16) 0))))))

(assert
;; WP_parameter_def
 ;; File "example.ads", line 5, characters 0-0
