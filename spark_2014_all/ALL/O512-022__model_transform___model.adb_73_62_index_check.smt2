...
(declare-fun temp___448 () (Array Int us_rep))

(declare-fun temp___449 () (Array Int us_rep1))

(declare-fun o6 () Int)

(declare-fun o7 () uml_action_access)

(declare-fun o8 () uml_action_access)

(declare-fun o9 () Int)

(declare-fun o10 () name_t)
...
(declare-fun o13 () uml_state_access)

(declare-fun o14 () uml_state_access)
...
;; H
  (assert
  (=> (and (<= 0 s2) (<= s2 100))
  (and (= o1 (name o27)) (and (in_range1 o1) (= o1 (to_rep o))))))
...
;; H
  ...
  (and (in_range4 o19)
  (= o19 (to_rep2
         (rec__model__uml_control_flow__to_data (us_split_fields9 o18)))))))
...
;; H
  ...
  (and (= o21 (name__2 o20))
  (and (in_range1 o21)
  (= o21 (to_rep (rec__model__uml_action__name_data (us_split_fields7 o20)))))))
...
;; H
  (assert
  (and (= o15 (to__ o24)) (and (in_range2 o15) (= o15 (to_rep1 o14)))))
...
;; H
  ...
  (and (= o22 (name o16))
  (and (in_range1 o22)
  (= o22 (to_rep (rec__model__uml_state__name_data (us_split_fields1 o16)))))))
...
;; H
  (assert
  (and (= o9 (from__2 o26)) (and (in_range4 o9) (= o9 (to_rep2 o7)))))
...
;; H
  (assert
  (and (= o11 (name__2 o25)) (and (in_range1 o11) (= o11 (to_rep o10)))))

;; H
  (assert
  (and (= temp___448 (owned_state sm))
  (= temp___448 (rec__model__uml_state_machine__owned_state_data
                (us_split_fields5 sm)))))

;; H
  (assert
  (and (= temp___449 (owned_transition sm))
  (= temp___449 (rec__model__uml_state_machine__owned_transition_data
                (us_split_fields5 sm)))))
