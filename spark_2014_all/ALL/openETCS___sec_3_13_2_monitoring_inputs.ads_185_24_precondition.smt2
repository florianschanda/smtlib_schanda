...
(define-fun dynamic_invariant ((temp___expr_151 t) (temp___is_init_148 Bool)
  (temp___skip_constant_149 Bool)
  (temp___do_toplevel_150 Bool)) Bool (=>
                                      (or (= temp___is_init_148 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_151)))
...
;; kdry_rst_model__def_axiom
  ...
  (= kdry_rst_model (mk___rep1
                    ...
                    (temp___138
                    (mk___rep
                    (mk___split_fields (of_rep2 0) (of_rep fliteral)))
                    (mk___rep
                    (mk___split_fields (of_rep2 0) (of_rep fliteral2))))))))
...
(declare-fun sec_3_13_2_monitoring_inputs__kdry_rst__result () t)
...
(declare-fun sec_3_13_2_monitoring_inputs__kdry_rst__result1 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kdry_rst__result2 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kdry_rst__result3 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kdry_rst__result4 () t)

(declare-fun sec_3_13_2_monitoring_inputs__kdry_rst__result5 () t)

;; H
  (assert (= (to_rep o4) fliteral2))
...
;; H
  (assert (and (= o16 (to_int1 RNA1 v)) (in_range2 (to_int1 RNA1 v))))
...
;; H
  (assert (and (= o18 (to_int1 RNA1 v)) (in_range2 (to_int1 RNA1 v))))
