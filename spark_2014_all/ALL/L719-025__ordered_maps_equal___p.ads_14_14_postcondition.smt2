...
;; H
  ...
  (= (equal_except
     ...
     (find (keys (mk___rep l__split_discrs l__split_fields6)) k)) true))
...
;; H
  ...
  (= (get1 (keys (mk___rep l__split_discrs l__split_fields5))
     (find (keys (mk___rep l__split_discrs l__split_fields5)) k)) k))
  ...
  (= (range_equal
     ...
     (- (find (keys (mk___rep l__split_discrs l__split_fields5)) k) 1)) true))
  (= (range_shifted
     (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (keys (mk___rep l__split_discrs l__split_fields5))
     (find (keys (mk___rep l__split_discrs l__split_fields5)) k)
     (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
