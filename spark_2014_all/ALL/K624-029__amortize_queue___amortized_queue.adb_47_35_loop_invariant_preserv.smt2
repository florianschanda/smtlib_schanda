...
;; H
  (assert
  (= (mk___split_fields result____split_fields1) amortized_queue__my_vectors__append__2__container__fields3))

;; H
  (assert
  (= (length (mk___rep result____split_discrs result____split_fields4))
  idx2))
