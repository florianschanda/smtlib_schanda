...
(declare-fun o22 () us_t)

(declare-fun o23 () Int)

(declare-fun o24 () Int)

(declare-fun o25 () us_t)
...
;; H
  ...
  (exists ((ib3 Int))
  (and
  (and (<= (to_rep2 (first (rt bb))) ib3) (<= ib3 (to_rep2 (last (rt bb)))))
  (and (= (to_rep (select (elts aa) ia2)) (to_rep (select (elts bb) ib3)))
  (= (is_perm (remove aa ia2) (remove bb ib3)) true))))))))))
...
;; H
  ...
  (= (let ((temp___157 (remove (remove a o1)
     ...
     (let ((temp___156 (remove
                       ...
                       (rec__perm__witnesses__ia (us_split_fields1 w))))
                       (- o1 1))))
     (bool_eq (elts temp___156) (to_rep2 (first (rt temp___156)))
...
;; H
  (assert
  (and (= o5 (get_witness aa bb o4))
  (and (in_range4 o5)
  (and
  (and (<= (to_rep2 (first (rt bb))) o5) (<= o5 (to_rep2 (last (rt bb)))))
  (and (= (to_rep (select (elts aa) o4)) (to_rep (select (elts bb) o5)))
  (= (is_perm (remove aa o4) (remove bb o5)) true))))))
...
;; H
  (assert
  (and (= o11 (remove a o10))
  (and (dynamic_invariant2 o11 true false true)
  (and (= (invariant__ o11) true)
  (and (= (to_rep2 (last (rt o11))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o10 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o11) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o10 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o11) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o10 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o11) k))))))))))))
...
;; H
  ...
  (and (dynamic_invariant2 o12 true false true)
  (and (= (invariant__ o12) true)
  (and (= (to_rep2 (last (rt o12))) (- (to_rep2 (last (rt o11))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o11) k)) (to_rep (select (elts o12) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o11)))))
  (= (to_rep (select (elts o11) k)) (to_rep (select (elts o12) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o11))) 1)))
  (= (to_rep (select (elts o11) (+ k 1))) (to_rep (select (elts o12) k))))))))))))

;; H
  (assert
  (and (= o9 (remove bb ib1))
  (and (dynamic_invariant2 o9 true false true)
  (and (= (invariant__ o9) true)
  (and (= (to_rep2 (last (rt o9))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o9) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o9) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o9) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o8))) (- (to_rep2 (last (rt aa))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o7 1)))
  (= (to_rep (select (elts aa) k)) (to_rep (select (elts o8) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o7 1) k) (<= k (to_rep2 (last (rt aa)))))
  (= (to_rep (select (elts aa) k)) (to_rep (select (elts o8) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o7 k) (<= k (- (to_rep2 (last (rt aa))) 1)))
  (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select (elts o8) k))))))))))))

;; H
  (assert
  (and (= o13 (shift_perm_l o8 o9 o12))
  (and (in_range3 o13) (=> (= (of_int o13) true) (= (is_perm o12 o9) true)))))
...
;; H
  (assert
  (not (< ib1 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))))
...
;; H
  ...
  (and
  (= o15 (remove_swap b
         (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) ib2))
  (and (in_range3 o15)
  (=> (= (of_int o15) true)
  (= (let ((temp___157 (remove (remove b ib2)
                       (to_rep1
...
;; H
  (assert
  (and (= o21 (remove b ib2))
  (and (dynamic_invariant2 o21 true false true)
  (and (= (invariant__ o21) true)
  (and (= (to_rep2 (last (rt o21))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o21) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o21) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o21) k))))))))))))
...
;; H
  ...
  (and (dynamic_invariant2 o22 true false true)
  (and (= (invariant__ o22) true)
  (and (= (to_rep2 (last (rt o22))) (- (to_rep2 (last (rt o21))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o21) k)) (to_rep (select (elts o22) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o21)))))
  (= (to_rep (select (elts o21) k)) (to_rep (select (elts o22) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o21))) 1)))
  (= (to_rep (select (elts o21) (+ k 1))) (to_rep (select (elts o22) k))))))))))))
...
;; H
  (assert
  (and (= o20 (remove bb o19))
  (and (dynamic_invariant2 o20 true false true)
  (and (= (invariant__ o20) true)
  (and (= (to_rep2 (last (rt o20))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o19 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o20) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o19 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o20) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o19 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o20) k))))))))))))
...
;; H
  (assert
  (and (= o17 (remove a o16))
  (and (dynamic_invariant2 o17 true false true)
  (and (= (invariant__ o17) true)
  (and (= (to_rep2 (last (rt o17))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o16 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o17) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o16 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o17) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o16 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o17) k))))))))))))
...
;; H
  ...
  (= o18 (remove o17
         (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
  (and (dynamic_invariant2 o18 true false true)
  (and (= (invariant__ o18) true)
  (and (= (to_rep2 (last (rt o18))) (- (to_rep2 (last (rt o17))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o17) k)) (to_rep (select (elts o18) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o17)))))
  (= (to_rep (select (elts o17) k)) (to_rep (select (elts o18) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o17))) 1)))
  (= (to_rep (select (elts o17) (+ k 1))) (to_rep (select (elts o18) k))))))))))))

;; H
  (assert
  (and (= o23 (shift_perm_r o18 o20 o22))
  (and (in_range3 o23) (=> (= (of_int o23) true) (= (is_perm o18 o22) true)))))
...
;; H
  (assert
  (and (= o26 (remove b ib2))
  (and (dynamic_invariant2 o26 true false true)
  (and (= (invariant__ o26) true)
  (and (= (to_rep2 (last (rt o26))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o26) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o26) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o26) k))))))))))))
...
;; H
  ...
  (= o27 (remove o26
         (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
  (and (dynamic_invariant2 o27 true false true)
  (and (= (invariant__ o27) true)
  (and (= (to_rep2 (last (rt o27))) (- (to_rep2 (last (rt o26))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o26) k)) (to_rep (select (elts o27) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o26)))))
  (= (to_rep (select (elts o26) k)) (to_rep (select (elts o27) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o26))) 1)))
  (= (to_rep (select (elts o26) (+ k 1))) (to_rep (select (elts o27) k))))))))))))
...
;; H
  (assert
  (and (= o25 (remove a o24))
  (and (dynamic_invariant2 o25 true false true)
  (and (= (invariant__ o25) true)
  (and (= (to_rep2 (last (rt o25))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o24 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o25) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o24 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o25) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o24 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o25) k))))))))))))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (= (invariant__ o25) true)))
(check-sat)
(exit)
