...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields5))
     (last1 (mk___rep l__split_discrs l__split_fields5))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields5)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields6))
     (last1 (mk___rep l__split_discrs l__split_fields5))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields6))
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields6))
     ...
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields6))
     (model__ (mk___rep l__split_discrs l__split_fields5))
     (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu)
     (length (mk___rep l__split_discrs l__split_fields6)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields5))
     (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields6))
     (positions (mk___rep l__split_discrs l__split_fields5))
     (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu) 1) true)))))
...
;; H
  ...
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields5))
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields5))
     ...
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields5)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields5))
     (model__ (mk___rep l__split_discrs l__split_fields4))
     (get1 (positions (mk___rep l__split_discrs l__split_fields5)) cu)
     (length (mk___rep l__split_discrs l__split_fields5)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields4))
     (get1 (positions (mk___rep l__split_discrs l__split_fields5)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields5))
     (positions (mk___rep l__split_discrs l__split_fields4))
     (get1 (positions (mk___rep l__split_discrs l__split_fields5)) cu) 1) true)))))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (< (length (mk___rep l__split_discrs l__split_fields4)) (to_rep
                                                          (rec__use_lists__my_lists__list__capacity
                                                          l__split_discrs)))))
(check-sat)
