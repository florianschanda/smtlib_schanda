...
(declare-const tab28 (Array Int integer))

(declare-const result29 int__ref)

(declare-const j34 Int)

(define-fun tab29 () map__ref (mk_map__ref tab))
...
;; H
  (assert (=> (<= j1 b) (= (mk_map__ref result1) tab29)))
...
;; H
  (assert (= result27 (mk_int__ref temp___173)))

;; H
  (assert (= temp___1731 j33))

;; H
  (assert (<= j33 b))

;; H
  (assert (= (to_rep o25) j33))

;; H
  (assert (and (<= (to_rep tab__first) j33) (<= j33 (to_rep tab__last))))

;; H
  (assert (= o26 j33))

;; H
  (assert (= o27 (store tab27 o26 o25)))

;; H
  (assert (= result28 (mk_map__ref tab27)))

;; H
  (assert (= tab28 o27))

;; H
  (assert (and (= o28 (+ j33 1)) (in_range1 (+ j33 1))))

;; H
  (assert (= result29 (mk_int__ref j33)))
