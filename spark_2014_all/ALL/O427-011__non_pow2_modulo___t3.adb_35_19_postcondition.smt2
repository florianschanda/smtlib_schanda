...
(declare-const t3__mmul__result (_ BitVec 64))

(declare-const result (_ BitVec 64))

(declare-const t3__mmul__result1 (_ BitVec 64))

(declare-const t3__mmul__result2 (_ BitVec 64))

(declare-const t3__mmul__result3 (_ BitVec 64))

(declare-const t3__mmul__result4 (_ BitVec 64))

(declare-const t3__mmul__result5 (_ BitVec 64))
...
;; H
  (assert (= t3__mmul__result1 t3__mmul__result2))

;; H
  (assert (= t3__mmul__result3 t3__mmul__result1))

;; H
  (assert (= (mk_t__ref1 result) (mk_t__ref1 t3__mmul__result)))

;; H
  (assert (= t3__mmul__result1 (bvurem (bvmul x y) ((_ int2bv 64) 230))))

;; H
  (assert (= (mk_t__ref1 t3__mmul__result4) (mk_t__ref1 t3__mmul__result2)))

;; H
  (assert (= t3__mmul__result5 t3__mmul__result3))

;; H
  (assert (= result1 t3__mmul__result4))

(assert
;; WP_parameter_def
 ;; File "t3.adb", line 6, characters 0-0
  (not
  (= ((_ extract 15 0) t3__mmul__result4) (bvurem (bvmul ((_ extract 15 0)
