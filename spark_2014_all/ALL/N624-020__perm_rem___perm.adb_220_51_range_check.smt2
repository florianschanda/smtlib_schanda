...
;; H
  (assert
  (and
  (= o10 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))
  (in_range4
...
;; H
  ...
  (and (= (to_rep2 (last o9)) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o7 1)))
...
;; H
  (assert
  (and (= o13 (remove o14 o10))
  (and (dynamic_invariant2 o13 true false true)
  (and (= (invariant__ o13) true)
  (and (= (to_rep2 (last o12)) (- (to_rep2 (last o9)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o10 1)))
  (= (to_rep (select o8 k)) (to_rep (select o11 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o10 1) k) (<= k (to_rep2 (last o9))))
  (= (to_rep (select o8 k)) (to_rep (select o11 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o10 k) (<= k (- (to_rep2 (last o9)) 1)))
  (= (to_rep (select o8 (+ k 1))) (to_rep (select o11 k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last o6)) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select o5 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select o5 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o5 k))))))))))))
