...
;; H
  ...
  (and (= o12 (shift_perm_l o33 o32 o31))
  (and (in_range2 o12) (=> (= (of_int o12) true) (= (is_perm o31 o32) true)))))))
  ...
  (and (= o23 (shift_perm_l o30 o29 o28))
  (and (in_range2 o23) (=> (= (of_int o23) true) (= (is_perm o28 o29) true)))))))
...
;; H
  ...
  (and (= (to_rep1 (last o26)) (- (to_rep1 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o25 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o25 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o25 k))))))))))))
