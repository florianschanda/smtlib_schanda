...
(declare-fun o34 () us_t)

(declare-fun o35 () Int)

(declare-fun temp___262 () us_t)
...
(define-fun o39 () us_t (mk___t o17 o18))
...
;; H
  ...
  (= (let ((temp___215 (remove (mk___t interm1 (mk 1 100)) x)))
     ...
     (bool_eq (elts temp___214) (to_rep1 (first (rt temp___214)))
...
;; H
  ...
  (= (let ((temp___219 (remove (mk___t values2 (mk 1 100)) y)))
     ...
     (bool_eq (elts temp___218) (to_rep1 (first (rt temp___218)))
...
;; H
  (assert
  (and (= o39 (remove (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and (= o40 (remove (mk___t interm1 (mk 1 100)) o13))
  (and (dynamic_invariant4 o40 true false true)
...
;; H
  (assert
  (and (= o20 (remove_eq o40 o39 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o39 o19)))
     (let ((temp___162 (remove o40 o19)))
     (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162)))
...
;; H
  ...
  (and (in_range4 o23)
  (=> (= (of_int o23) true)
  (= (let ((temp___157 (remove (remove (mk___t interm1 (mk 1 100)) o22) o21)))
     (let ((temp___156 (remove (remove (mk___t interm1 (mk 1 100)) o21)
                       (- o22 1))))
...
;; H
  (assert
  (= (let ((temp___248 (remove (remove (mk___t interm1 (mk 1 100)) y)
                       (- x 1))))
     (let ((temp___247 (remove (remove (mk___t interm1 (mk 1 100)) x) y)))
     (bool_eq (elts temp___247) (to_rep1 (first (rt temp___247)))
     (to_rep1 (last (rt temp___247))) (elts temp___248)
     (to_rep1 (first (rt temp___248))) (to_rep1 (last (rt temp___248)))))) true))

;; H
  (assert
  (= (let ((temp___252 (remove (remove (mk___t values2 (mk 1 100)) y)
                       (- x 1))))
     (let ((temp___251 (remove (remove (mk___t interm1 (mk 1 100)) x) y)))
     (bool_eq (elts temp___251) (to_rep1 (first (rt temp___251)))
     (to_rep1 (last (rt temp___251))) (elts temp___252)
     (to_rep1 (first (rt temp___252))) (to_rep1 (last (rt temp___252)))))) true))
...
;; H
  ...
  (and (in_range4 o26)
  (=> (= (of_int o26) true)
  (= (let ((temp___157 (remove (remove (mk___t values2 (mk 1 100)) o25) o24)))
     (let ((temp___156 (remove (remove (mk___t values2 (mk 1 100)) o24)
                       (- o25 1))))
     (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156)))
     (to_rep1 (last (rt temp___156))) (elts temp___157)
     (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
...
;; H
  (assert
  (= (let ((temp___256 (remove (remove (mk___t values2 (mk 1 100)) x) y)))
     (let ((temp___255 (remove (remove (mk___t interm1 (mk 1 100)) x) y)))
     (bool_eq (elts temp___255) (to_rep1 (first (rt temp___255)))
     (to_rep1 (last (rt temp___255))) (elts temp___256)
     (to_rep1 (first (rt temp___256))) (to_rep1 (last (rt temp___256)))))) true))

;; H
  (assert (and (= o31 y) (in_range5 y)))

;; H
  (assert (and (= o29 x) (in_range5 x)))

;; H
  (assert
  (and (= o30 (remove (mk___t interm1 (mk 1 100)) o29))
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o29 1)))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o30) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o29 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o30) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o29 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o30) k))))))))))))
...
;; H
  (assert
  (and (= o28 (remove (mk___t init (mk 1 100)) o27))
  (and (dynamic_invariant4 o28 true false true)
  (and (= (invariant__ o28) true)
  (and (= (to_rep1 (last (rt o28))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o27 1)))
  (= (to_rep (select init k)) (to_rep (select (elts o28) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select init k)) (to_rep (select (elts o28) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select init (+ k 1))) (to_rep (select (elts o28) k))))))))))))

;; H
  (assert
  (and (= o32 (remove_eq o28 o30 o31))
  (and (in_range4 o32)
  (=> (= (of_int o32) true)
  (= (let ((temp___163 (remove o30 o31)))
     (let ((temp___162 (remove o28 o31)))
     (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162)))
     (to_rep1 (last (rt temp___162))) (elts temp___163)
     (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
...
;; H
  (assert (and (= o33 x) (in_range5 x)))

;; H
  (assert
  (and (= o34 (remove (mk___t values2 (mk 1 100)) o33))
  (and (dynamic_invariant4 o34 true false true)
  (and (= (invariant__ o34) true)
  (and (= (to_rep1 (last (rt o34))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o33 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o34) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o34) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o33 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o34) k))))))))))))

;; H
  (assert
  (and (= temp___262 (remove o34 o35))
  (and (dynamic_invariant4 temp___262 true false true)
  (and (= (invariant__ temp___262) true)
  (and (= (to_rep1 (last (rt temp___262))) (- (to_rep1 (last (rt o34))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o35 1)))
  (= (to_rep (select (elts o34) k)) (to_rep (select (elts temp___262) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o35 1) k) (<= k (to_rep1 (last (rt o34)))))
  (= (to_rep (select (elts o34) k)) (to_rep
                                    (select (elts temp___262) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o35 k) (<= k (- (to_rep1 (last (rt o34))) 1)))
  (= (to_rep (select (elts o34) (+ k 1))) (to_rep
                                          (select (elts temp___262) k))))))))))))

;; H
  (assert (and (= o38 y) (in_range5 y)))

;; H
  (assert (and (= o36 x) (in_range5 x)))

;; H
  (assert
  (and (= o37 (remove (mk___t init (mk 1 100)) o36))
  (and (dynamic_invariant4 o37 true false true)
  (and (= (invariant__ o37) true)
  (and (= (to_rep1 (last (rt o37))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o36 1)))
  (= (to_rep (select init k)) (to_rep (select (elts o37) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o36 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select init k)) (to_rep (select (elts o37) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o36 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select init (+ k 1))) (to_rep (select (elts o37) k))))))))))))

(assert
;; WP_parameter_def
 ;; File "sort.ads", line 4, characters 0-0
  (not (= (invariant__ o37) true)))
(check-sat)
(exit)
