...
(declare-fun temp___250 () positive)

(declare-fun temp___2501 () natural)

(declare-fun temp___2502 () Int)

(declare-fun temp___256 () positive)

(declare-fun temp___2561 () (Array Int element))

(declare-fun temp___2562 () t)

(declare-fun temp___2563 () natural)

(declare-fun temp___2564 () us_private)

(declare-fun temp___2565 () Int)

(define-fun temp___2566 () us_rep (mk___rep (mk___split_discrs temp___256)
                                  (mk___split_fields
                                  (mk___t temp___2561 temp___2562)
                                  temp___2563 temp___2564) temp___2565))
...
;; H
  (assert
  (and (dynamic_invariant2 temp___2566 true false true)
  (and (= temp___2565 us_tag) (= (to_rep temp___2563) 0))))

(assert
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 48, characters 0-0
  (not (= (empty temp___2566) true)))
(check-sat)
(exit)
