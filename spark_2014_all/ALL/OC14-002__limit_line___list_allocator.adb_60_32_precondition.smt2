...
(declare-fun o17 () status)

(declare-fun o18 () resource)
...
;; H
  ...
  (and (= o35 (length model____split_fields)) (in_range6 o35))))

;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o35) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o34 (get model____split_fields 1)) (in_range7 o34)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o34 first_available) true false)))))
...
;; H
  ...
  (and (= o36 (length model____split_fields)) (in_range6 o36))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= result2 (ite (= o36 0) true false))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (and (= o32 (length model____split_fields1)) (in_range6 o32)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o32) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o31 (get model____split_fields1 1)) (in_range7 o31))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o31 first_allocated) true false))))))
...
;; H
  ...
  (and (= o33 (length model____split_fields1)) (in_range6 o33)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (not (= first_allocated 0)))
  (= result1 (ite (= o33 0) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o29 (length model____split_fields)) (in_range6 o29))))
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 (length model____split_fields)))
  (=> (not (= j2 k1))
  (not (= (get model____split_fields j2) (get model____split_fields k1))))))))))))
...
;; H
  (assert (and (= o28 (get model____split_fields1 j)) (in_range7 o28)))

;; H
  (assert (= result9 (ite (in_range4 o28) true false)))

;; H
  (assert
  (=> (= result9 true)
  (and (= o24 (length model____split_fields1)) (in_range6 o24))))
...
;; H
  (assert
  (=> (= result9 true)
  (=> (= result10 true) (and (= o25 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result9 true)
  (=> (= result10 true)
  (and (= o26 (get model____split_fields1 o25)) (in_range7 o26)))))
...
;; H
  (assert (=> (= result9 true) (and (<= 1 temp___387) (<= temp___387 3))))

;; H
  (assert (=> (= result9 true) (= o16 temp___387)))

;; H
  (assert
  (=> (= result9 true)
  (= (mk___rep (mk___split_fields o17 o18 o19)) (select data o16))))
...
;; H
  (assert
  (=> (= result8 true)
  (=> (< 1 j) (and (= o13 (- j 1)) (in_range2 (- j 1))))))

;; H
  (assert
  (=> (= result8 true)
  (=> (< 1 j) (and (= o14 (get model____split_fields1 o13)) (in_range7 o14)))))
...
;; H
  (assert
  (=> (= result8 true)
  (and (= temp___388 (get model____split_fields1 j)) (in_range7 temp___388))))

;; H
  (assert (=> (= result8 true) (and (<= 1 temp___388) (<= temp___388 3))))

;; H
  (assert (=> (= result8 true) (= o5 temp___388)))

;; H
  (assert
  (=> (= result8 true)
  (= (mk___rep (mk___split_fields o6 o7 o8)) (select data o5))))
...
;; H
  (assert (and (= o4 (get model____split_fields1 k)) (in_range7 o4)))
