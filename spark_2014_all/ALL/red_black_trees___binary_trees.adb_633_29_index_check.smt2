...
(define-fun f__split_fields7 () us_split_fields__ref2 (mk___split_fields__ref2
                                                      (mk___split_fields2
                                                      f__split_fields
                                                      f__split_fields1)))
...
;; H
  (assert
  (=> (not (= v1 0)) (=> (not (= d 0)) (= result3 f__split_fields7))))
...
;; H
  ...
  (= (to_rep
     (rec__binary_trees__cell__parent
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields6) i2)))) 0))
  (= (to_rep1
     (rec__binary_trees__cell__position
     (us_split_fields3
     (select (rec__binary_trees__forest__c f__split_fields6) i2)))) 0))
...
;; WP_parameter_def
 ;; File "binary_trees.ads", line 119, characters 0-0
  ...
  (<= 1 (to_rep
        (rec__binary_trees__cell__parent
        (us_split_fields3
        (select (rec__binary_trees__forest__c f__split_fields6) i1)))))))
(check-sat)
