...
;; H
  (assert
  (and (= o16 (shift_perm_l o27 o26 o24))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o24 o26) true)))))
...
;; H
  (assert
  (and (= o22 (remove b ib2))
  (and (dynamic_invariant2 o22 true false true)
  (and (= (invariant__ o22) true)
  (and (= (to_rep2 (last (rt o22))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o22) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o22) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o22) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o23))) (- (to_rep2 (last (rt o22))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o22) k)) (to_rep (select (elts o23) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o22)))))
  (= (to_rep (select (elts o22) k)) (to_rep (select (elts o23) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o22))) 1)))
  (= (to_rep (select (elts o22) (+ k 1))) (to_rep (select (elts o23) k))))))))))))
...
;; H
  (assert
  (and (= o21 (remove bb o20))
  (and (dynamic_invariant2 o21 true false true)
  (and (= (invariant__ o21) true)
  (and (= (to_rep2 (last (rt o21))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o20 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o21) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o20 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o21) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o20 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o21) k))))))))))))
