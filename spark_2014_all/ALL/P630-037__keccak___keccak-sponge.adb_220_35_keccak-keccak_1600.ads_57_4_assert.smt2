...
;; H
  (assert
  (=> (< (mod2 bit_length 8) 8)
  (= o21 (bvshl suffix ((_ int2bv 8) (mod2 bit_length 8))))))
...
;; H
  ...
  (= o18 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (mod2 bit_length 8))))))
...
;; H
  (assert
  (and (= o26 (+ (mod2 bit_length 8) suffix_len)) (in_range1
  (+ (mod2 bit_length 8) suffix_len))))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (= (state_of (mk___rep ctx__split_fields18)) 0)))
(check-sat)
(exit)
