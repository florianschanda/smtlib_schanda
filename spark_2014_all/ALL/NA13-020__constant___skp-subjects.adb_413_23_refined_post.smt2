...
(declare-fun skp__subjects__get_pml4_address__result1 () (_ BitVec 64))

(declare-fun skp__subjects__get_pml4_address__result2 () (_ BitVec 64))

(declare-fun skp__subjects__get_pml4_address__result3 () (_ BitVec 64))

(declare-fun skp__subjects__get_pml4_address__result4 () (_ BitVec 64))

(declare-fun skp__subjects__get_pml4_address__result5 () (_ BitVec 64))
...
;; H
  ...
  (= (bvurem (to_rep
             (rec__skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs 6)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))
...
;; H
  (assert
  (= skp__subjects__get_pml4_address__result1 skp__subjects__get_pml4_address__result2))

;; H
  (assert
  (= skp__subjects__get_pml4_address__result3 skp__subjects__get_pml4_address__result1))

;; H
  (assert
  (= (mk_t__ref result) (mk_t__ref skp__subjects__get_pml4_address__result)))

;; H
  (assert
  (= skp__subjects__get_pml4_address__result1 (to_rep
                                              (rec__skp__subjects__subject_spec_type__pml4_address
                                              (us_split_fields7
                                              (select subject_specs subject_id))))))

;; H
  (assert
  (= (mk_t__ref skp__subjects__get_pml4_address__result4) (mk_t__ref
                                                          skp__subjects__get_pml4_address__result2)))

;; H
  (assert
  (= skp__subjects__get_pml4_address__result5 skp__subjects__get_pml4_address__result3))

(assert
;; WP_parameter_def
 ;; File "sk.ads", line 23, characters 0-0
  (not
  (= (bvurem skp__subjects__get_pml4_address__result4 ((_ int2bv 64) 4096)) ((_ int2bv 64) 0))))
(check-sat)
