...
;; H
  (assert
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= temp___299 bad1)))
...
;; H
  (assert (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o3 j3)))
...
;; H
  (assert
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1))
  (= (mk_int__ref j6) (mk_int__ref j4))))

;; H
  (assert
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1))
  (= (mk_bool__ref bad6) (mk_bool__ref bad4))))
...
(assert
;; WP_parameter_def
 ;; File "loops_static.adb", line 33, characters 0-0
