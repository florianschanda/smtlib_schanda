...
(declare-fun temp___922 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___864 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___863 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___862 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o20 (select temp___862 j3)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___861 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o16 (select temp___861 j3)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___926 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___925 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___924 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___923 o48))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___923 o48)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o48))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___923 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o49 (select temp___923 i1)))
...
;; H
  ...
  (= temp___922 (model__
                (rec__search_trees__search_tree__struct t__split_fields10)
                o44))
  (and (dynamic_invariant6 temp___922 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___922 o44))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___922 o44)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o44))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___922 (parent
                             (rec__search_trees__search_tree__struct
                             t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___922 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___922 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___922 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___922 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___922 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___922 j4)))) true))
  (= j4 i2))))))))))))))

;; H
  (assert (= o45 (select temp___922 y1)))
