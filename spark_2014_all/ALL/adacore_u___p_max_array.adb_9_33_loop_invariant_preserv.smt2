...
(declare-const temp___240 (Array Int natural))

(declare-const temp___2401 t2)

(declare-const p_max_array__max_array_1__r__assume (Array Int natural))

(declare-const p_max_array__max_array_1__r__assume1 t1)
...
;; H
  (assert
  (= (slide temp___240 (to_rep1 (first4 temp___2401))
     (to_rep1 (first (rt a)))) p_max_array__max_array_1__r__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) p_max_array__max_array_1__r__assume1))

;; H
  (assert (= result r))

;; H
  (assert (= r1 p_max_array__max_array_1__r__assume))

;; H
  (assert
  (= (to_rep1 r__first) (to_rep1
                        (first2 p_max_array__max_array_1__r__assume1))))

;; H
  (assert
  (= (to_rep1 r__last) (to_rep1 (last2 p_max_array__max_array_1__r__assume1))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 r__first) temp___244) (<= temp___244 (to_rep1 r__last)))
  (=> (<= i2 temp___244) (= (select r2 temp___244) (select r1 temp___244)))))
...
;; H
  (assert (= result3 (ite (< o2 (to_rep (select (elts a) i2))) true false)))
...
;; H
  (assert (=> (= result3 true) (= o4 (store r2 i2 o3))))

;; H
  (assert (=> (= result3 true) (= r2 result4)))

;; H
  (assert (=> (= result3 true) (= r3 o4)))
...
;; H
  (assert (=> (not (= result3 true)) (= o6 (select (elts b) o5))))

;; H
  (assert (=> (not (= result3 true)) (= o7 (to_rep o6))))

;; H
  (assert (=> (not (= result3 true)) (= (to_rep o8) o7)))

;; H
  (assert (=> (not (= result3 true)) (= o9 (store r2 i2 o8))))

;; H
  (assert (=> (not (= result3 true)) (= r2 result5)))

;; H
  (assert (=> (not (= result3 true)) (= r4 o9)))

;; H
  (assert (=> (not (= result3 true)) (= r3 r4)))

;; H
  (assert (and (= o10 (+ j2 1)) (in_range1 (+ j2 1))))
...
;; WP_parameter_def
 ;; File "p_max_array.ads", line 3, characters 0-0
  (not (= j3 (+ (- i3 (to_rep1 (first (rt a)))) (to_rep1 (first (rt b)))))))
(check-sat)
(exit)
