...
;; range_axiom
  (assert
  (forall ((x t)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-datatypes ((us_t 0)) (((mk___t (elts (Array Int t))(rt t1)))))
...
(((mk_t_arr__ref (t_arr__content us_t)))))
...
;; is_equal__def_axiom
  ...
  (forall ((size Int))
  (! (= (= (is_equal a b size) true)
     (forall ((i Int))
     (=> (and (<= 0 i) (<= i (- size 1)))
     (= (to_rep1 (select (to_array a) (+ (first1 a) i))) (to_rep1
                                                         (select (to_array b) (+
                                                         (first1 b) i))))))) :pattern (
  (is_equal a b size)) ))))
...
(((mk_t22s__ref (t22s__content integer)))))
(define-fun t22s__ref___projection ((a1 t22s__ref)) integer (t22s__content
                                                            a1))
...
(declare-datatypes ((us_t1 0)) (((mk___t1 (elts1 (Array Int t))(rt1 t2)))))
(define-fun to_array1 ((a1 us_t1)) (Array Int t) (elts1 a1))

(define-fun of_array1 ((a1 (Array Int t)) (f Int)
...
(declare-datatypes ((t23s__ref 0)) (((mk_t23s__ref (t23s__content us_t1)))))
