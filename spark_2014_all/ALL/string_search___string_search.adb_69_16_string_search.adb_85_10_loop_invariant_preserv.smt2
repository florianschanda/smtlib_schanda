...
;; H
  ...
  (forall ((k4 Int))
  (=>
  (and (<= (to_rep2 (first (rt needle))) k4)
  (<= k4 (to_rep2 (last (rt needle)))))
  (not (= c (to_rep1 (select (elts needle) k4))))))
  (and
  (= (to_rep1
  ...
  (forall ((k4 Int))
  (=>
  (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k4)
  (<= k4 (to_rep2 (last (rt needle)))))
  (not (= (to_rep1 (select (elts needle) k4)) c))))))))))
