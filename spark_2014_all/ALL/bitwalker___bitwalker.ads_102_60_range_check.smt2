...
(((mk___t (elts (Array Int unsigned_8))(rt t)))))
...
(declare-datatypes ((byte_sequence__ref 0))
(((mk_byte_sequence__ref (byte_sequence__content us_t)))))
...
;; H
  ...
  (and
  (and (and (= (mk_int__ref result4) i13) (= i2 0))
  (ite (and (<= 0 i2) (<= i2 (- len 1)))
  (and
  (and
  (and (= temp___299 i2)
  (and (= temp___300 addr)
  ...
  (and
  (and (=> (<= 0 (- len 1)) (dynamic_property1 0 (- len 1) i3))
  (and (<= 0 i3) (<= i3 (- len 1))))
  (and
  (and
  (and
  (and (and (= o6 (+ (- 64 len) i3)) (in_range1 (+ (- 64 len) i3)))
  ...
  (and
  (and (and (= o9 (+ start i3)) (in_range1 (+ start i3)))
  (and
  (forall ((i14 Int))
  (=>
  (and (<= 0 i14)
  (<= i14 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                  (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))
  (=> (not (= i14 o9))
  (=
  (= (nth8_stream
     (mk___t addr3 (mk (to_rep addr__first) (to_rep addr__last))) i14) true)
  (= (nth8_stream
     (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i14) true)))))
  (=
  (= (nth8_stream
  ...
  (= (nth8_stream
     ...
     (+ start i3)) true)
  (= (nth value (- (- len i3) 1)) true))
  (and
  (forall ((k Int))
  (=> (and (<= start k) (<= k (- (+ start i3) 1)))
  (and
  (and (not (= k (+ start i3)))
  (and (<= 0 k)
  ...
  (= (nth value (- (- (+ start len) k) 1)) true))))) (= i3 (- len 1)))))))))))))
  (and (and (= i3 i4) (and (= flag3 flag4) (= addr3 addr4)))
  (and (= i5 i3) (and (= flag5 flag3) (= addr5 addr3)))))
  (and
  (and (= i12 (mk_int__ref i4))
  (and (= flag12 (mk_bool__ref flag4)) (= addr13 (mk_map__ref addr4))))
  (and (= i7 i5) (and (= flag7 flag5) (= addr7 addr5)))))
  (and (and (= i2 i6) (and (= flag12 flag13) (= addr13 addr14)))
  (and (= i7 i2) (and (= flag7 flag1) (= addr7 addr1))))))
...
;; H
  (assert (= o22 (ite (< o21 (+ start len)) true false)))

;; H
  (assert (= o23 (to_int2 o22)))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o12 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o12 0)))
...
;; H
  (assert (= o15 (ite (<= (+ start len) o14) true false)))

;; H
  (assert
  (and (= o11 (maxvalue len))
  (= o11 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))

;; H
  (assert (= o16 (ite (bvule o11 value) true false)))

;; H
  (assert (= o17 (ite (= o16 true) o15 false)))

;; H
  (assert (= o18 (to_int2 o17)))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o10 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
