...
(define-fun tint_arrayD1__ref___21__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___21__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t686b__ref 0))
(((mk_t686b__ref (t686b__content integer)))))
...
(declare-datatypes ((t687b__ref 0))
(((mk_t687b__ref (t687b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___30__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___30__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t690b__ref 0))
(((mk_t690b__ref (t690b__content integer)))))
...
(declare-datatypes ((t691b__ref 0))
(((mk_t691b__ref (t691b__content us_t4)))))
...
(declare-datatypes ((t692b__ref 0))
(((mk_t692b__ref (t692b__content integer)))))
...
(define-fun tint_arrayB__ref___21__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___30__projection ((a tnumber_array_typeB__ref)) us_t6
