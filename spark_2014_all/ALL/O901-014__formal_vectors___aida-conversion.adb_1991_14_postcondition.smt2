...
(define-fun tint_arrayD1__ref_21__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref_21__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ()
((t686b__ref (mk_t686b__ref (t686b__content integer)))))
(define-fun t686b__ref___projection ((a t686b__ref)) integer (t686b__content
                                                             a))
...
(define-fun tnumber_array_typeD1__ref_30__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref_30__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ()
((t690b__ref (mk_t690b__ref (t690b__content integer)))))
(define-fun t690b__ref___projection ((a t690b__ref)) integer (t690b__content
                                                             a))
...
(declare-datatypes ()
((t692b__ref (mk_t692b__ref (t692b__content integer)))))
(define-fun t692b__ref___projection ((a t692b__ref)) integer (t692b__content
                                                             a))
...
(define-fun tint_arrayB__ref_21__projection ((a tint_arrayB__ref)) us_t5
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___2254 Int) (temp___2255 Int) (temp___2256 Int)
  (temp___2257 Int) (temp___2258 Int) (temp___2259 Int) (temp___2260 Int)
  (temp___2261 Int) (temp___2262 Int))
  (let ((temp___2253 (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def
                     temp___2254 temp___2255 temp___2256 temp___2257
                     temp___2258 temp___2259 temp___2260 temp___2261
                     temp___2262)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 7)
  temp___2261 temp___2262)
  (and (= (first5 temp___2253) temp___2261)
  (= (last5 temp___2253) temp___2262)))
  (and
  (and
  (and
  (and
  (and
  (and
  (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2254))
  (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2255)))
  (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2256)))
  (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 3)) (of_rep1
                                                                  temp___2257)))
  (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 4)) (of_rep1
                                                                  temp___2258)))
  (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 5)) (of_rep1
                                                                  temp___2259)))
  (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 6)) (of_rep1
                                                                  temp___2260)))))))
...
(define-fun tnumber_array_typeB__ref_30__projection ((a tnumber_array_typeB__ref)) us_t6
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_negative_target_length_8__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___2268 Int) (temp___2269 Int) (temp___2270 Int))
  (let ((temp___2267 (aida__conversion__calculate_negative_target_length_8__n__aggregate_def
                     temp___2268 temp___2269 temp___2270)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 7)
  temp___2269 temp___2270)
  (and (= (first9 temp___2267) temp___2269)
  (= (last9 temp___2267) temp___2270)))
  (forall ((temp___2271 Int))
  (= (select (to_array4 temp___2267) temp___2271) (of_rep1 temp___2268)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_725 us_t3)
  (temp___is_init_722 Bool) (temp___skip_constant_723 Bool)
  (temp___do_toplevel_724 Bool)) Bool (=>
                                      (not (= temp___skip_constant_723 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 7)
                                      (first7 temp___expr_725)
                                      (last7 temp___expr_725))
                                      (and
                                      (= (first7 temp___expr_725) (+
                                      (first1 source) 1))
                                      (= (last7 temp___expr_725) (+ (first1
                                                                    source) 7))))))
...
(declare-fun temp___2265 () (Array Int integer))

(declare-fun temp___22651 () t2)

(declare-fun aida__conversion__calculate_negative_target_length_8__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_8__int_array__assume1 () t1)

(declare-fun temp___2273 () (Array Int integer))

(declare-fun temp___22731 () t4)

(declare-fun aida__conversion__calculate_negative_target_length_8__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_negative_target_length_8__n__assume1 () t3)

(declare-fun temp___2279 () Int)

(declare-fun temp___2280 () Int)

(declare-fun temp___2278 () Int)
...
;; H
  ...
  (forall ((index9 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 1) index9)
  (<= index9 (+ (to_rep1 (first (rt source))) 7)))
...
;; H
  ...
  (= (to_rep1
     (first4
     (rt2
     (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def
     9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1)
     (+ (+ (to_rep1 (first (rt source))) 1) 6))))) (+ (to_rep1
                                                      (first (rt source))) 1)))
...
;; H
  (assert
  (= (mk___t2 temp___2265 temp___22651) (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def
                                        9 9 9 9 9 9 9
                                        (+ (to_rep1 (first (rt source))) 1)
                                        (+ (+ (to_rep1 (first (rt source))) 1) 6))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___22651)) (to_rep1 (last4 temp___22651)))
     (+ (- (to_rep1 (last4 temp___22651)) (to_rep1 (first4 temp___22651))) 1)
...
;; H
  ...
  (= (slide1 temp___2265 (to_rep1 (first4 temp___22651))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__int_array__assume))

;; H
  (assert
  (= (mk1 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_length_8__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_negative_target_length_8__int_array__assume))

;; H
  (assert
  (= (to_rep1 int_array__first) (to_rep1
                                (first2
                                aida__conversion__calculate_negative_target_length_8__int_array__assume1))))
...
;; H
  ...
  (+ (to_rep1 (first (rt source))) 7) (to_rep1 int_array__first)
  (to_rep1 int_array__last))
  (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1))
  (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 7)))))
...
;; H
  ...
  (= (to_rep1
     (first8
     (rt4
     (aida__conversion__calculate_negative_target_length_8__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 7))))) (+ (to_rep1 (first (rt source))) 1)))
...
;; H
  ...
  (= (to_rep1
     ...
     (aida__conversion__calculate_negative_target_length_8__n__aggregate_def
     0 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 7))))) (+ (to_rep1 (first (rt source))) 7)))

;; H
  (assert
  (= (mk___t4 temp___2273 temp___22731) (aida__conversion__calculate_negative_target_length_8__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___22731)) (to_rep1 (last8 temp___22731)))
     (+ (- (to_rep1 (last8 temp___22731)) (to_rep1 (first8 temp___22731))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 7))
        (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  ...
  (= (slide1 temp___2273 (to_rep1 (first8 temp___22731))
     (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__n__assume))

;; H
  (assert
  (= (mk3 (+ (to_rep1 (first (rt source))) 1)
     (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_length_8__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_negative_target_length_8__n__assume))

;; H
  (assert
  (= (to_rep1 n__first) (to_rep1
                        (first6
                        aida__conversion__calculate_negative_target_length_8__n__assume1))))
...
;; H
  (assert
  (and (= temp___2279 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2280 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280))
  (= temp___2278 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= n2 o8)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2277 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2277)
  (<= temp___2277 (to_rep1 n__last)))
  (=> (< index2 temp___2277)
  (= (select n3 temp___2277) (select temp___2276 temp___2277)))))
  (=>
  (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2279 index1) (<= index1 temp___2280)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2279 index1) (<= index1 temp___2280)))
...
;; H
  (assert
  (=> (not (and (<= temp___2279 index1) (<= index1 temp___2280))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2281 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2281)
  (<= temp___2281 (to_rep1 n__last))))
...
;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2282)
  (<= temp___2282 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2283 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2283)
  (<= temp___2283 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2284 (+ (to_rep1 (first (rt source))) 4)) (in_range1
...
;; H
  (assert
  (and (= temp___2285 (+ (to_rep1 (first (rt source))) 3)) (in_range1
...
;; H
  (assert
  (and (= temp___2286 (+ (to_rep1 (first (rt source))) 2)) (in_range1
...
;; H
  (assert
  (and (= temp___2287 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))
