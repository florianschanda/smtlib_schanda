...
(declare-fun temp___460 () (Array Int integer))
...
(declare-fun i_v27 () int__ref)

(declare-fun a_v27 () (Array Int integer))

(declare-fun i_v28 () Int)

(declare-fun a_v12 () map__ref)

(declare-fun a_v28 () map__ref)

(declare-fun i_v14 () int__ref)

(declare-fun i_v15 () int__ref)

(declare-fun i_v29 () int__ref)

(declare-fun i_v210 () int__ref)

(declare-fun a_v13 () (Array Int integer))

(declare-fun a_v29 () (Array Int integer))

(declare-fun i_v16 () Int)

(declare-fun i_v17 () Int)

(declare-fun i_v211 () Int)

(declare-fun i_v212 () Int)
...
;; H
  (assert
  (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))
  (= temp___462 i_v23)))

;; H
  (assert
  (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))
  (= temp___460 (map__content a_v2))))
...
;; H
  ...
  (forall ((m Int))
  (=> (and (<= (+ k_2 1) m) (<= m (- i_v24 1)))
  (= (to_rep (select a_v22 m)) (to_rep (select (elts c_v2) (- m k_2)))))))))
...
;; H
  ...
  (=> (<= i_v24 temp___461)
  (= (select a_v22 temp___461) (select temp___460 temp___461)))))
  (=> (<= (+ k_2 1) (to_rep a_v2__last)) (dynamic_property4 (+ k_2 1)
  (to_rep a_v2__last) i_v24)))
  (and (<= (+ k_2 1) i_v24) (<= i_v24 (to_rep a_v2__last))))))

;; H
  (assert
  (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))
  (and (= temp___458 (- i_v24 k_2)) (in_range1 (- i_v24 k_2)))))
...
;; H
  (assert
  (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))
  (and (<= (to_rep a_v2__first) i_v24) (<= i_v24 (to_rep a_v2__last)))))
...
;; H
  (assert
  (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))
  (= i_v24 (to_rep a_v2__last))))

;; H
  (assert
  (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))
  (= i_v25 (mk_int__ref i_v24))))
...
;; H
  (assert
  (=> (not (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))))
  (= i_v27 (mk_int__ref i_v23))))
...
;; H
  (assert
  (= (ite (= (= k_1 k_2) true) (ite (<= (to_rep a_v1__first) i)
                               (ite (<= i k_1)
                               (= (to_rep (select (elts b_v1) i)) (to_rep
                                                                  (select
                                                                  (elts
                                                                  b_v2)
                                                                  i)))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 89, characters 0-0
  (not
  (= (to_rep (select (map__content a_v12) i)) (to_rep
                                              (select (map__content a_v28)
                                              i)))))
(check-sat)
(exit)
