...
;; H
  ...
  (=> (not (= result true))
  (=> (= result3 true)
  (=> (and (<= 1 id4) (<= id4 3)) (= temp___371 track_signals2)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result3 true) (=> (and (<= 1 id4) (<= id4 3)) (= temp___370 prev)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result3 true)
  (=> (and (<= 1 id4) (<= id4 3)) (= temp___369 track_signals2)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result3 true)
  (=> (and (<= 1 id4) (<= id4 3)) (= temp___372 track_signals2)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result3 true) (=> (and (<= 1 id4) (<= id4 3)) (= temp___367 id4)))))
...
;; H
  ...
  (= (to_rep5
     (select track_signals (to_rep
                           (rec__trains__train_position__track_begin
                           (us_split_fields3 new_position))))) 2))
  (=> (and (<= 1 id10) (<= id10 3)) (= temp___364 track_signals9))))))
...
;; H
  ...
  (= (to_rep5
     (select track_signals (to_rep
                           (rec__trains__train_position__track_begin
                           (us_split_fields3 new_position))))) 2))
  (=> (and (<= 1 id10) (<= id10 3)) (= temp___358 prev))))))
...
;; H
  ...
  (= (to_rep5
     (select track_signals (to_rep
                           (rec__trains__train_position__track_begin
                           (us_split_fields3 new_position))))) 2))
  (=> (and (<= 1 id10) (<= id10 3)) (= temp___363 track_signals9))))))
...
;; H
  ...
  (= (to_rep5
     (select track_signals (to_rep
                           (rec__trains__train_position__track_begin
                           (us_split_fields3 new_position))))) 2))
  (=> (and (<= 1 id10) (<= id10 3)) (= temp___356 track_signals9))))))
...
;; H
  ...
  (= (to_rep5
     (select track_signals (to_rep
                           (rec__trains__train_position__track_begin
                           (us_split_fields3 new_position))))) 2))
  (=> (and (<= 1 id10) (<= id10 3)) (= temp___354 id10))))))
