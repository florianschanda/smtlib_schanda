...
;; H
  (assert (and (= o6 (length alloc3)) (in_range5 o6)))

;; H
  (assert (and (= o7 (length avail3)) (in_range5 o7)))
...
;; H
  (assert (= result5 (ite (= o9 r2) true false)))

;; H
  (assert
  (=> (= result5 true)
  (and (= o4 (contains avail3 e1))
  (=> (= (of_int 1) true)
  (=>
  (exists ((e2 Int))
...
;; H
  (assert (=> (= result5 true) (= (= o5 true) (in_range4 e1))))

;; H
  (assert (=> (= result5 true) (= result6 (ite (= o5 true) o4 false))))
...
;; H
  (assert (=> (= result4 true) (= (= o3 true) (in_range4 e))))

;; H
  (assert (=> (= result4 true) (= result7 (ite (= o3 true) o2 false))))
