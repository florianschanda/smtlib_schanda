...
(declare-fun numerics__Oadd__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun numerics__Oadd__result1 () t)

(declare-fun numerics__Oadd__result2 () t)

(declare-fun numerics__Oadd__result3 () t)

(declare-fun numerics__Oadd__result4 () t)

(declare-fun numerics__Oadd__result5 () t)
...
;; H
  (assert
  (and (= o (add RNE1 left right)) (tqtisFinite (add RNE1 left right))))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref numerics__Oadd__result)))
...
;; H
  (assert
  (= (mk_t__ref numerics__Oadd__result4) (mk_t__ref numerics__Oadd__result2)))

;; H
  (assert (= numerics__Oadd__result5 numerics__Oadd__result3))

;; H
  (assert (= result1 numerics__Oadd__result4))

(assert
;; WP_parameter_def
 ;; File "numerics.ads", line 7, characters 0-0
  (not (eq numerics__Oadd__result4 (add RNE1 left right))))
(check-sat)
