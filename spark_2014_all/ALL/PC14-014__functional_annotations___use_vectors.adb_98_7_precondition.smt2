...
;; H
  ...
  (= (range_equal
     ...
     o 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields10)) o) 0))
  (= (range_shifted
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
     (model__ (mk___rep v__split_discrs v__split_fields10)) o
     (last6
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))
     1) true))
...
;; H
  ...
  (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields10))
     ...
     o1 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields9)) o1) 0))
  (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields10))
     (model__ (mk___rep v__split_discrs v__split_fields9)) o1
...
;; H
  ...
  (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields9))
     ...
     o2 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields8)) o2) 0))
  (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields9))
     (model__ (mk___rep v__split_discrs v__split_fields8)) o2
...
;; H
  ...
  (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields8))
     ...
     o3 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields7)) o3) 0))
  (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields8))
     (model__ (mk___rep v__split_discrs v__split_fields7)) o3
...
;; H
  ...
  (= (length (mk___rep v__split_discrs v__split_fields6)) (+ (length
                                                             ...
                                                             v__split_discrs
                                                             v__split_fields7)) 1))
  (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields7))
     (model__ (mk___rep v__split_discrs v__split_fields6)) first1 (- 
     o4 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields6)) o4) 0))
  (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields7))
     (model__ (mk___rep v__split_discrs v__split_fields6)) o4
     (last6 (model__ (mk___rep v__split_discrs v__split_fields7))) 1) true))
  (dynamic_property3 0 last3
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (< (length (mk___rep v__split_discrs v__split_fields6)) (capacity
                                                          (mk___rep
                                                          v__split_discrs
                                                          v__split_fields6)))))
(check-sat)
