...
(declare-fun user_eq (xdr_hyper xdr_hyper) Bool)

(declare-const dummy xdr_hyper)

(declare-datatypes ()
((xdr_hyper__ref (mk_xdr_hyper__ref (xdr_hyper__content xdr_hyper)))))
...
(define-fun dynamic_invariant3 ((temp___expr_190 us_t)
...
(declare-fun user_eq6 (source source) Bool)

(declare-const dummy6 source)
...
(define-fun dynamic_invariant4 ((temp___expr_265 (_ BitVec 64))
...
(declare-fun user_eq7 (target target) Bool)

(declare-const dummy7 target)
...
;; xdr_unsigned_to_hyper__post_axiom
  ...
  (! (=> (dynamic_invariant4 s true true true) (dynamic_invariant5
     (xdr_unsigned_to_hyper s) true false true)) :pattern ((xdr_unsigned_to_hyper
                                                           s)) )))
...
(define-fun dynamic_invariant7 ((temp___expr_166 (_ BitVec 8))
...
;; H
  (assert (dynamic_invariant3 data true false true))
...
;; H
  (assert
  (=> (<= (- 9223372036854775808) 9223372036854775807) (in_range1 value)))
...
;; H
  ...
  (<= (+ position 7) (to_rep (last (rt data))))))

(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 212, characters 0-0
  (not (= (mod1 position 4) 0)))
(check-sat)
(exit)
