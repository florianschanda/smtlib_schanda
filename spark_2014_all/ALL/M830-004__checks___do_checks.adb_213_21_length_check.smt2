...
(declare-datatypes ((a1__ref 0)) (((mk_a1__ref (a1__content us_t)))))
...
(assert
;; WP_parameter_def
 ;; File "do_checks.adb", line 296, characters 0-0
  (not
  (= (ite (<= (to_rep (first (mk (to_rep x__first) (to_rep x__last))))
     (to_rep (last (mk (to_rep x__first) (to_rep x__last)))))
     (+ (- (to_rep (last (mk (to_rep x__first) (to_rep x__last)))) (to_rep
                                                                   (first
                                                                   (mk
                                                                   (to_rep
                                                                   x__first)
                                                                   (to_rep
                                                                   x__last))))) 1)
     0) (ite (<= (to_rep x__first) (to_rep x__last))
