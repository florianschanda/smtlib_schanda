...
(declare-const o14 partition_index)

(declare-const o15 (Array Int partition_index))
...
;; H
  (assert (= (to_rep2 o12) p_prime_index2))

;; H
  (assert (= o13 (store f1 i1 o12)))
...
;; H
  ...
  (=> (< i2 temp___1221) (= (select f3 temp___1221) (select f1 temp___1221)))))
...
;; H
  (assert (= result10 (mk_int__ref i2)))

;; H
  (assert (= i3 (+ i2 1)))

;; H
  (assert (= (to_rep2 o14) p_prime_index2))

;; H
  (assert (= o15 (store f3 i3 o14)))

;; H
  (assert (= result11 (mk_map__ref f3)))
...
;; WP_parameter_def
 ;; File "partition_refinement.adb", line 18, characters 0-0
  (not (= (to_rep2 (select f4 k)) (to_rep2 (select f_loop_entry k)))))
(check-sat)
(exit)
