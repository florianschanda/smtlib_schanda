...
;; H
  (assert
  (forall ((i Int))
  (=> (and (<= k10 i) (<= i (to_rep1 a__last)))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a8 i))))
  max12))))
...
;; H
  ...
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a8 j))))
  (to_rep
  (rec__frame_condition__cell__max_right (us_split_fields1 (select a8 i))))))))))

;; H
  (assert
  (and
  (and (=> (<= 1 2147483647) (in_range3 k10))
  (forall ((temp___233 Int))
  (=>
  (and (<= (to_rep1 a__first) temp___233) (<= temp___233 (to_rep1 a__last)))
  (and
  (= (rec__frame_condition__cell__value
     (us_split_fields1 (select a8 temp___233))) (rec__frame_condition__cell__value
                                                (us_split_fields1
                                                (select (map__content a5) temp___233))))
  (= (rec__frame_condition__cell__max_left
     (us_split_fields1 (select a8 temp___233))) (rec__frame_condition__cell__max_left
                                                (us_split_fields1
                                                (select (map__content a5) temp___233))))))))
  (=> (<= 0 2147483647) (in_range2 max12))))
...
;; H
  (assert
  (=> (= result12 true)
  (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last)))))
...
;; H
  (assert
  (=> (= result12 true) (= o54 (rec__frame_condition__cell__value o53))))
...
;; H
  ...
  (= o57 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select a8 k11)))
         (rec__frame_condition__cell__max_left
         (us_split_fields1 (select a8 k11))) o56)))
...
;; WP_parameter_def
 ;; File "frame_condition.ads", line 17, characters 0-0
  (not (<= (to_rep1 a__first) (int__content k12))))
(check-sat)
(exit)
