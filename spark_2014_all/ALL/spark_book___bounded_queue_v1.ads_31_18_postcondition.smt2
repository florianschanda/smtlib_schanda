...
(declare-const temp___2831 natural)

(declare-const temp___2832 positive)

(declare-const temp___2833 positive)

(declare-const temp___2834 (Array Int element_type))

(declare-const temp___2835 t)
...
(declare-const temp___285 positive)

(declare-const temp___2851 natural)

(declare-const temp___2852 positive)

(declare-const temp___2853 positive)

(declare-const temp___2854 (Array Int element_type))

(declare-const temp___2855 t)
...
(declare-const temp___2871 natural)

(declare-const temp___2872 positive)

(declare-const temp___2873 positive)

(declare-const temp___2874 (Array Int element_type))

(declare-const temp___2875 t)
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___283)))

;; H
  (assert (= temp___2831 o1))

;; H
  (assert (= temp___2832 o2))

;; H
  (assert (= temp___2833 o3))

;; H
  (assert (= temp___2834 o4))

;; H
  (assert (= temp___2835 o5))
...
;; H
  (assert
  (= queue__split_fields5 (mk___split_fields temp___2831 temp___2832
                          temp___2833 (mk___t temp___2834 temp___2835))))
...
;; H
  (assert
  (= (rec__bounded_queue_v1__queue_type__rear queue__split_fields5) o9))

;; H
  (assert
  (= (rec__bounded_queue_v1__queue_type__items queue__split_fields5)
  (mk___t o10 o11)))

;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___285)))

;; H
  (assert (= temp___2851 o7))

;; H
  (assert (= temp___2852 o8))

;; H
  (assert (= temp___2853 o9))

;; H
  (assert (= temp___2854 o10))

;; H
  (assert (= temp___2855 o11))
...
;; H
  (assert
  (= queue__split_fields6 (mk___split_fields temp___2851 temp___2852
                          temp___2853 (mk___t temp___2854 temp___2855))))
...
;; H
  (assert
  (= (rec__bounded_queue_v1__queue_type__count queue__split_fields6)
  o13))
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___287)))

;; H
  (assert (= temp___2871 o13))

;; H
  (assert (= temp___2872 o14))

;; H
  (assert (= temp___2873 o15))

;; H
  (assert (= temp___2874 o16))

;; H
  (assert (= temp___2875 o17))
...
;; H
  (assert
  (= queue__split_fields7 (mk___split_fields temp___2871 temp___2872
                          temp___2873 (mk___t temp___2874 temp___2875))))
