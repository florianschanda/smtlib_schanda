...
;; H
  (assert
  (= x86__edi__result1 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep
                                                                (select
                                                                xdi 0))) (bvmul ((_ zero_extend 24)
  (to_rep (select xdi 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24)
  (to_rep (select xdi 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24)
  (to_rep (select xdi 3))) ((_ int2bv 32) 16777216)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 5, characters 0-0
  (not
  (= x86__edi__result4 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep
                                                                (select
                                                                xdi 0))) (bvmul ((_ zero_extend 24)
  (to_rep (select xdi 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24)
  (to_rep (select xdi 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24)
