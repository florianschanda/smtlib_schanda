...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (ite (= space3 4) (= (to_rep (select a2 k1)) (to_rep (select a1 k1)))
  (ite (and (= space3 2) (= (mod2 (+ k1 1) 8) 0))
  (= (to_rep (select a2 k1)) (+ (to_rep (select a1 k1)) (to_rep
                                                        (select a1 (- k1 (* 2
                                                        space3))))))
  (ite (and (= space3 2) (= (mod2 (+ k1 1) 4) 0))
  (= (to_rep (select a2 k1)) (to_rep (select a1 (+ k1 (* 2 space3)))))
  (ite (= space3 2) (= (to_rep (select a2 k1)) (to_rep (select a1 k1)))
  (ite (and (= space3 1) (= (mod2 (+ k1 1) 2) 0))
  (and
  (and
  ...
  (= (to_rep (select a2 7)) (+ (+ (to_rep (select a1 5)) (to_rep
                                                         (select a1 7)))
  (to_rep (select a1 3)))))
  (= (to_rep (select a2 k1)) (to_rep (select a1 k1))))))))))))
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (ite (and (<= 0 k1) (<= k1 (- right3 (* space3 2))))
  (ite (= (mod2 (+ k1 1) (* 2 space3)) 0)
  (= (to_rep (select a3 k1)) (+ (to_rep (select a2 k1)) (to_rep
                                                        (select a2 (- k1
                                                        space3)))))
  (ite (= (mod2 (+ k1 1) space3) 0)
  (= (to_rep (select a3 k1)) (to_rep (select a2 (+ k1 space3))))
  (= (to_rep (select a3 k1)) (to_rep (select a2 k1)))))
  (= (to_rep (select a3 k1)) (to_rep (select a2 k1))))))
...
;; H
  (assert (<= k (- right3 (* space3 2))))

;; H
  (assert (not (= (mod2 (+ k 1) (* 2 space3)) 0)))
