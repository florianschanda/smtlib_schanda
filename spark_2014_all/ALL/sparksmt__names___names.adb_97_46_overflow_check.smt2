...
(define-fun char_table__split_fields3 () us_split_fields (mk___split_fields
                                                         char_table__split_fields2))
...
;; H
  (assert (and (= temp___504 o1) (in_range1 o1)))
...
;; H
  (assert
  (= (mk___split_fields char_table__split_fields1) names__data__char_tables__append__2__container__fields1))

;; H
  (assert
  (and
  (= (invariant__ hash_table char_table__split_fields3
     (mk___split_fields1 entry_table__split_fields)) true)
  (= (length1 (mk___rep char_table__split_discrs char_table__split_fields3)) (+ 
  (length1
  (mk___rep char_table__split_discrs
  (mk___split_fields char_table__split_fields))) i2))))
