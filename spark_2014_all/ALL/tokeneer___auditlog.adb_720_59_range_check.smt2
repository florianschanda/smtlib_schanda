...
;; H
  ...
  (= o2 (ite (= (to_rep1 (select logfileentries3 currentlogfile3)) (+
...
;; H
  (assert
  (=> (= (to_rep1 (select logfileentries3 currentlogfile)) 1024)
  (= o1 (ite (= (to_rep1 (select logfileentries3 currentlogfile3)) 1)
        (ite (= (to_rep2 usedlogfiles__split_fields15) (+ (to_rep2
                                                          usedlogfiles__split_fields3) 1))
        true false) false))))
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 553, characters 0-0
  (not (in_range9 (- (to_rep2 usedlogfiles__split_fields15) 1))))
(check-sat)
(exit)
