...
(define-fun o35 () us_t (mk___t o11 o12))

(define-fun o36 () us_t (mk___t o8 o9))

(define-fun o37 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and (= o16 (shift_perm_l o37 o36 o34))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o34 o36) true)))))
...
;; H
  (assert
  (and (= o32 (remove b ib2))
  (and (dynamic_invariant2 o32 true false true)
  (and (= (invariant__ o32) true)
  (and (= (to_rep2 (last (rt o32))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o32) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o32) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o32) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o33))) (- (to_rep2 (last (rt o32))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o32) k)) (to_rep (select (elts o33) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o32)))))
  (= (to_rep (select (elts o32) k)) (to_rep (select (elts o33) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o32))) 1)))
  (= (to_rep (select (elts o32) (+ k 1))) (to_rep (select (elts o33) k))))))))))))
...
;; H
  (assert
  (and (= o31 (remove o29 o30))
  (and (dynamic_invariant2 o31 true false true)
  (and (= (invariant__ o31) true)
  (and (= (to_rep2 (last (rt o31))) (- (to_rep2 (last (rt o29))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o30 1)))
  (= (to_rep (select (elts o29) k)) (to_rep (select (elts o31) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o30 1) k) (<= k (to_rep2 (last (rt o29)))))
  (= (to_rep (select (elts o29) k)) (to_rep (select (elts o31) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o30 k) (<= k (- (to_rep2 (last (rt o29))) 1)))
  (= (to_rep (select (elts o29) (+ k 1))) (to_rep (select (elts o31) k))))))))))))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (= (invariant__ o31) true)))
(check-sat)
(exit)
