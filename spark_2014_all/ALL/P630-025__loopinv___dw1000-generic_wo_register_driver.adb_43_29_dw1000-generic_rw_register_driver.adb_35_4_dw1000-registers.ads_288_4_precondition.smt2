...
(define-fun register_type__ref___55__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___40__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___40__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3377 us_t1)
  (temp___is_init_3374 Bool) (temp___skip_constant_3375 Bool)
  (temp___do_toplevel_3376 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3375 true))
                                       (and (dynamic_property2 1 41
                                       (first3 temp___expr_3377)
                                       (last3 temp___expr_3377))
                                       (and (= (first3 temp___expr_3377) 1)
                                       (= (last3 temp___expr_3377) 41)))))
...
(define-fun target__ref___16__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___16__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_3396 us_t2)
  (temp___is_init_3393 Bool) (temp___skip_constant_3394 Bool)
  (temp___do_toplevel_3395 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3394 true))
                                       (and (dynamic_property3 1 41
                                       (first5 temp___expr_3396)
                                       (last5 temp___expr_3396))
                                       (and (= (first5 temp___expr_3396) 1)
                                       (= (last5 temp___expr_3396) 41)))))
...
;; H
  (assert
  (and (= temp___78172 (register_to_bytes reg)) (dynamic_invariant1
  temp___78172 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78171)) (to_rep (last4 temp___78171)))
     (+ (- (to_rep (last4 temp___78171)) (to_rep (first4 temp___78171))) 1)
     0) (ite (<= 1 41) (+ (- 41 1) 1) 0)))

;; H
  (assert (= temp___7817 temp___7818))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78171)) (to_rep (last4 temp___78171)))
  temp___78181))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78181)) (to_rep (last2 temp___78181)))
     (+ (- (to_rep (last2 temp___78181)) (to_rep (first2 temp___78181))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7818 temp___78181)))
