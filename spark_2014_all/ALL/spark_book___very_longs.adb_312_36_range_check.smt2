...
(((mk_tT99bP1__ref (tT99bP1__content tdigit_count_typeB)))))
(define-fun tT99bP1__ref___projection ((a tT99bP1__ref)) tdigit_count_typeB
  (tT99bP1__content a))
...
(declare-datatypes ((t99b__ref 0)) (((mk_t99b__ref (t99b__content us_t1)))))
...
(((mk_t100b__ref (t100b__content tdigit_count_typeB)))))
(define-fun t100b__ref___projection ((a t100b__ref)) tdigit_count_typeB
  (t100b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___1015 (_ BitVec 8)))
  (forall ((temp___1016 Int) (temp___1017 Int))
  (let ((temp___1014 (temp___1013 temp___1015 temp___1016 temp___1017)))
  (and
  (=> (dynamic_property6 1 65536 temp___1016 temp___1017)
  (and (= (first5 temp___1014) temp___1016)
  (= (last5 temp___1014) temp___1017)))
  (forall ((temp___1018 Int))
  (= (select (to_array2 temp___1014) temp___1018) (of_rep1 temp___1015))))))))
