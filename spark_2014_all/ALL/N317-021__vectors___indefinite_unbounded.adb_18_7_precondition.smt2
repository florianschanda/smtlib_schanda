...
(define-fun indefinite_unbounded__vect__append__2__container__fields1 () us_split_fields
  (mk___split_fields
...
;; H
  (assert
  (= v__split_fields4 indefinite_unbounded__vect__clear__container__fields1))
...
;; H
  ...
  (= (length
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__append__2__container__fields1)) (+ (length
                                                                    (mk___rep
                                                                    v__split_discrs
                                                                    v__split_fields4)) 1))
  (= (olt (model__ (mk___rep v__split_discrs v__split_fields4))
     (model__
     (mk___rep v__split_discrs
     indefinite_unbounded__vect__append__2__container__fields1))) true))
  (= (get
     (model__
     (mk___rep v__split_discrs
...
;; H
  (assert
  (= v__split_fields3 indefinite_unbounded__vect__append__2__container__fields1))
