...
;; H
  (assert (= o56 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o62 (omultiply o56 o61)))

;; H
  (assert (= o64 (osubtract o62 o63)))

;; H
  (assert (= o53 (from_word32 a_msw2)))
...
;; H
  (assert
  (and (= o47 (base Tuple0))
  (= o47 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o52 (oexpon o47 o51)))

;; H
  (assert (= o54 (omultiply o52 o53)))
...
;; H
  (assert
  (= o46 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
         a_first o45)))

;; H
  (assert (= o55 (oadd o46 o54)))

;; H
  (assert (= o65 (olt o55 o64)))
...
;; H
  (assert
  (and (= o30 (base Tuple0))
  (= o30 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert (= o31 (inverse o29 o30)))

;; H
  (assert (= o34 (oexpon o31 o33)))
...
;; H
  (assert (= o18 (num_of_big_int b b_first o17)))

;; H
  (assert (= o24 (omultiply o18 o23)))

;; H
  (assert (= o35 (omultiply o24 o34)))

;; H
  (assert (= o41 (omod o35 o40)))
