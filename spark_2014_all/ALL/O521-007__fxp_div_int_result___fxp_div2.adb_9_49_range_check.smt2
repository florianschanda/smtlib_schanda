...
(declare-fun dummy1 () tduration_repB)
...
(declare-fun dummy2 () duration_rep)
...
(declare-fun x () duration)

(declare-fun o () duration)

(declare-fun o1 () Int)

(declare-fun fxp_div2__y__assume () Int)

(declare-fun o2 () Int)

(declare-fun result () duration)

(declare-fun x1 () duration)
...
;; H
  (assert
  (and (= o1 (fxp_div_result_int (to_fixed x1) (to_fixed x1))) (in_range1
  (fxp_div_result_int (to_fixed x1) (to_fixed x1)))))
...
;; H
  (assert
  (and (= o2 (fxp_div_result_int (to_fixed x1) 2)) (in_range1
  (fxp_div_result_int (to_fixed x1) 2))))
