...
;; H
  (assert
  (=> (= result16 true) (= o44 (select (select ranking_1 g1_id) o43))))
...
;; H
  (assert
  (=> (= result16 true) (= o39 (select (select ranking_1 g1_id) o38))))
...
;; H
  (assert
  (=> (= result16 true)
  (and (= o47 (is_preferred_1 g1_id o42 o46))
  (= (= o47 true)
  (<= (to_rep2 (select (invert_1 o46) g1_id)) (to_rep2
                                              (select (invert_1 o46)
                                              o42)))))))
