...
;; H
  (assert
  (and (= o27 (+ x (int__content lcp__result16))) (in_range1
...
;; H
  (assert
  (and (= o26 (+ x (int__content lcp__result16))) (in_range1
  (+ x (int__content lcp__result16)))))
...
;; H
  (assert
  (=> (not (= result11 true))
  (and (= o22 (+ y (int__content lcp__result16))) (in_range1
  (+ y (int__content lcp__result16))))))

;; H
  (assert
  (=> (not (= result11 true))
  (= o23 (ite (<= o22 (to_rep (last (rt a)))) true false))))

;; H
  (assert
  (=> (not (= result11 true))
  (and (= o21 (+ y (int__content lcp__result16))) (in_range1
  (+ y (int__content lcp__result16))))))

;; H
  (assert
  (=> (not (= result11 true))
  (= o24 (ite (<= (to_rep (first (rt a))) o21) true false))))
...
;; H
  (assert
  (=> (not (= result11 true))
  (= result10 (ite (not (= o25 true)) true false))))
...
;; H
  (assert
  (and (<= (to_rep (first (rt a))) temp___161)
  (<= temp___161 (to_rep (last (rt a))))))
