...
;; def_axiom
  (assert
  (forall ((temp___3900 (Array Int us_rep)))
  (forall ((temp___3901 Int))
  (forall ((temp___3902 us_rep))
  (let ((temp___3899 (temp___3898 temp___3900 temp___3901 temp___3902)))
  (forall ((temp___3903 Int))
  (ite (= temp___3903 temp___3901)
  (= (select temp___3899 temp___3903) temp___3902)
  (= (select temp___3899 temp___3903) (select temp___3900 temp___3903)))))))))

(declare-fun temp___3905 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___3907 (Array Int (Array Int et1))))
  (forall ((temp___3908 Int))
  (forall ((temp___3909 (Array Int et1)))
  (let ((temp___3906 (temp___3905 temp___3907 temp___3908 temp___3909)))
  (forall ((temp___3910 Int))
  (ite (= temp___3910 temp___3908)
  (= (select temp___3906 temp___3910) temp___3909)
  (= (select temp___3906 temp___3910) (select temp___3907 temp___3910)))))))))

(declare-fun temp___3912 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3914 (Array Int et1)))
  (forall ((temp___3915 Int) (temp___3916 Int))
  (let ((temp___3913 (temp___3912 temp___3914 temp___3915 temp___3916)))
  (forall ((temp___3917 Int))
  (ite (= temp___3917 temp___3915)
  (= (select temp___3913 temp___3917) (of_rep temp___3916))
  (= (select temp___3913 temp___3917) (select temp___3914 temp___3917))))))))

(declare-fun temp___3920 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3922 (Array Int et1)))
  (forall ((temp___3923 Int) (temp___3924 Int))
  (let ((temp___3921 (temp___3920 temp___3922 temp___3923 temp___3924)))
  (forall ((temp___3925 Int))
  (ite (= temp___3925 temp___3923)
  (= (select temp___3921 temp___3925) (of_rep temp___3924))
  (= (select temp___3921 temp___3925) (select temp___3922 temp___3925))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1746, characters 0-0
  (not
  (= (bool_eq7 a3 90 99
     (temp___3898 a i
     (mk___rep
     (mk___split_fields
     (temp___3920 (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) k f)
     (temp___3905 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) 
     j
     (temp___3912
