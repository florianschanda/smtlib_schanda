...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o54) true false))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o53 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o51) true false)))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o50 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o50))))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result14 true)
  (= result11 (ite (= o50 first_allocated1) true false))))))
...
;; H
  (assert (=> (= result11 true) (= o49 (ite (<= j1 o48) true false))))

;; H
  (assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o49 false))))
...
;; H
  (assert (= result17 (ite (in_range4 o47) true false)))
