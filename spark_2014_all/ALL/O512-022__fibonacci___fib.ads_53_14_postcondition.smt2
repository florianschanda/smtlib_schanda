...
(declare-fun a210 () map__ref)

(declare-fun i24 () int__ref)

(declare-fun a211 () (Array Int integer))

(declare-fun i25 () Int)

(declare-fun a212 () map__ref)

(declare-fun i26 () int__ref)

(declare-fun a213 () (Array Int integer))

(declare-fun i27 () Int)

(declare-fun a114 () map__ref)

(declare-fun a214 () map__ref)

(declare-fun i28 () int__ref)

(declare-fun i29 () int__ref)

(declare-fun i30 () int__ref)

(declare-fun i31 () int__ref)

(declare-fun a115 () (Array Int integer))

(declare-fun a215 () (Array Int integer))
...
;; H
  ...
  (forall ((i37 Int))
  (=> (and (<= 0 i37) (<= i37 k))
  (= (to_rep (select b1 i37)) (to_rep (select b2 i37)))))
  (forall ((i37 Int))
  (=> (and (<= (+ k 1) i37) (<= i37 100))
  (= (to_rep (select c1 (- i37 k))) (to_rep (select c2 (- i37 k))))))))))
...
;; H
  (assert (=> (and (<= 0 i4) (<= i4 k)) (= temp___221 a1)))
...
;; H
  (assert (= i10 temp___228))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= temp___226 a16)))

;; H
  (assert
  (=> (and (<= temp___228 i10) (<= i10 100))
  (and
...
;; H
  (assert
  (=> (and (<= temp___228 i10) (<= i10 100))
  (and (= temp___225 (- i11 k)) (in_range1 (- i11 k)))))
...
;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= o6 temp___225)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= o7 (select c1 o6))))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= o8 (to_rep o7))))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= (to_rep o9) o8)))

;; H
  (assert
  (=> (and (<= temp___228 i10) (<= i10 100)) (and (<= 0 i11) (<= i11 100))))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= o10 i11)))

;; H
  (assert
  (=> (and (<= temp___228 i10) (<= i10 100)) (= o11 (store a18 o10 o9))))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= a18 result3)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= a19 o11)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= i11 100)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= i11 i12)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= a19 a110)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= i13 i11)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= a111 a19)))

;; H
  (assert
  (=> (and (<= temp___228 i10) (<= i10 100)) (= i14 (mk_int__ref i12))))

;; H
  (assert
  (=> (and (<= temp___228 i10) (<= i10 100)) (= a116 (mk_map__ref a110))))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= i15 i13)))

;; H
  (assert (=> (and (<= temp___228 i10) (<= i10 100)) (= a113 a111)))

;; H
  (assert
  (=> (not (and (<= temp___228 i10) (<= i10 100))) (= i14 (mk_int__ref i10))))

;; H
  (assert (=> (not (and (<= temp___228 i10) (<= i10 100))) (= a116 a117)))

;; H
  (assert (=> (not (and (<= temp___228 i10) (<= i10 100))) (= i15 i10)))

;; H
  (assert (=> (not (and (<= temp___228 i10) (<= i10 100))) (= a113 a17)))
...
;; H
  (assert (=> (and (<= 0 i16) (<= i16 k)) (= temp___230 a2)))
...
;; H
  ...
  (=> (and (<= 0 temp___231) (<= temp___231 100))
  (=> (<= i17 temp___231)
  (= (select a22 temp___231) (select temp___230 temp___231)))))
  (and (<= 0 i17) (<= i17 k)))))
...
;; H
  (assert (and (= temp___237 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= result6 (mk_int__ref i3)))

;; H
  (assert (= i22 temp___237))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100))
  (= temp___235 (map__content a26))))
...
;; H
  ...
  (=> (and (<= 0 temp___236) (<= temp___236 100))
  (=> (<= i23 temp___236)
  (= (select a28 temp___236) (select temp___235 temp___236)))))
  (and (<= (+ k 1) i23) (<= i23 100)))))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100))
  (and (= temp___234 (- i23 k)) (in_range1 (- i23 k)))))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100))
  (and (<= 0 temp___234) (<= temp___234 100))))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= o18 temp___234)))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100)) (= o19 (select c2 o18))))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= o20 (to_rep o19))))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= (to_rep o21) o20)))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100)) (and (<= 0 i23) (<= i23 100))))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= o22 i23)))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100)) (= o23 (store a28 o22 o21))))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100)) (= result7 (mk_map__ref a28))))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= a29 o23)))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= i23 100)))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100)) (= i24 (mk_int__ref i23))))

;; H
  (assert
  (=> (and (<= temp___237 i22) (<= i22 100)) (= a210 (mk_map__ref a29))))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= i25 i23)))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= a211 a29)))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= i26 i24)))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= a212 a210)))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= i27 i25)))

;; H
  (assert (=> (and (<= temp___237 i22) (<= i22 100)) (= a213 a211)))

;; H
  (assert
  (=> (not (and (<= temp___237 i22) (<= i22 100))) (= i26 (mk_int__ref i22))))

;; H
  (assert (=> (not (and (<= temp___237 i22) (<= i22 100))) (= a212 a26)))

;; H
  (assert (=> (not (and (<= temp___237 i22) (<= i22 100))) (= i27 i22)))

;; H
  (assert (=> (not (and (<= temp___237 i22) (<= i22 100))) (= a213 a27)))
...
;; WP_parameter_def
 ;; File "fib.ads", line 2, characters 0-0
  (not
  (= (to_rep (select (map__content a114) i37)) (to_rep
                                               (select (map__content a214) 
                                               i37)))))
(check-sat)
