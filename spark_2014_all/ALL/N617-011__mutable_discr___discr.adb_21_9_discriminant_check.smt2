...
(declare-fun temp___2721 () Bool)

(declare-fun usq_ () natural)

(declare-fun usq_1 () Bool)

(declare-fun temp___274 () natural)

(declare-fun temp___2741 () Bool)

(declare-fun o4 () natural)

(declare-fun o5 () natural)

(declare-fun temp___275 () natural)

(declare-fun temp___2751 () Bool)
...
;; H
  ...
  (= temp___272 (rec__discr__with_default__c d__split_discrs1))))

;; H
  (assert
  (= (mk___rep (mk___split_discrs usq_) usq_1) (mk___rep
                                               (mk___split_discrs temp___272)
                                               temp___2721)))
...
;; WP_parameter_def
 ;; File "discr.adb", line 4, characters 0-0
  (not (= temp___275 (rec__discr__with_default__c d__split_discrs2))))
(check-sat)
(exit)
