...
(declare-fun temp___497 () (Array Int element))

(declare-fun temp___4971 () less_than_max)

(declare-fun temp___4972 () us_private)

(declare-fun temp___4973 () Int)
...
(declare-fun result3 () (Array Int element))

(declare-fun result4 () less_than_max)
...
(declare-fun s__split_fields12 () (Array Int element))

(declare-fun s__split_fields13 () less_than_max)

(declare-fun s__split_fields14 () us_private)
...
;; H
  (assert
  (and (<= 1 (to_rep s__split_fields4)) (<= (to_rep s__split_fields4) 100)))
...
;; H
  (assert (= temp___497 o8))

;; H
  (assert (= temp___4971 o9))

;; H
  (assert (= temp___4972 o10))

;; H
  (assert (= s__attr__tag temp___4973))
...
;; H
  (assert (= temp___497 s__split_fields6))

;; H
  (assert (= temp___4971 s__split_fields7))

;; H
  (assert (= temp___4972 s__split_fields8))
...
;; WP_parameter_def
 ;; File "stackp.ads", line 22, characters 0-0
  (not
  (= (let ((temp___502 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields9 s__split_fields10
                       s__split_fields11) s__attr__tag))))
     (bool_eq (elts temp___502) (to_rep2 (first (rt temp___502)))
     (to_rep2 (last (rt temp___502)))
     (let ((temp___501 (temp___255 e)))
     (let ((temp___500 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1
                       s__split_fields2) s__attr__tag))))
     (ite (= (length temp___500) 0) temp___501
     (concat1 (elts temp___500) (to_rep2 (first (rt temp___500)))
     (to_rep2 (last (rt temp___500))) temp___501 1 1))))
     (to_rep2
     (first
     (let ((temp___500 (get_model__2
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1
                       s__split_fields2) s__attr__tag))))
     (ite (= (length temp___500) 0) (mk 1 1)
     (mk (to_rep2 (first (rt temp___500)))
     (- (+ (to_rep2 (first (rt temp___500))) (+ (ite (<= (to_rep2
                                                         (first
                                                         (rt temp___500)))
                                                (to_rep2
                                                (last (rt temp___500))))
