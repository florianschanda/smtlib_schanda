...
(define-fun dynamic_invariant ((temp___expr_189 Int)
  ...
  (temp___do_toplevel_188 Bool)) Bool (=>
                                      ...
                                      (<= 1 10)) (in_range1 temp___expr_189)))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int)
  ...
  (temp___do_toplevel_200 Bool)) Bool (=>
                                      ...
                                      (<= 0 11)) (in_range5 temp___expr_201)))
...
(define-fun dynamic_invariant4 ((temp___expr_207 Int)
  ...
  (temp___do_toplevel_206 Bool)) Bool (=>
                                      ...
                                      (<= 0 10)) (in_range3 temp___expr_207)))
...
(define-fun dynamic_invariant5 ((temp___expr_234 Int)
  ...
  (temp___do_toplevel_233 Bool)) Bool (=>
                                      ...
                                      (<= 0 10)) (in_range4 temp___expr_234)))

;; length__post_axiom
  (assert
  (forall ((container1 us_rep1))
  (! (let ((result (length container1)))
     (and (<= (+ 0 result) 10) (dynamic_invariant3 result true false true))) :pattern (
  (length container1)) )))
