...
;; H
  (assert
  (and
  (= o25 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
...
;; H
  (assert
  (and (= o26 (remove o24 o25))
  (and (dynamic_invariant2 o26 true false true)
  (and (= (invariant__ o26) true)
  (and (= (to_rep2 (last (rt o26))) (- (to_rep2 (last (rt o24))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o25 1)))
  (= (to_rep (select (elts o24) k)) (to_rep (select (elts o26) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o25 1) k) (<= k (to_rep2 (last (rt o24)))))
  (= (to_rep (select (elts o24) k)) (to_rep (select (elts o26) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o25 k) (<= k (- (to_rep2 (last (rt o24))) 1)))
  (= (to_rep (select (elts o24) (+ k 1))) (to_rep (select (elts o26) k))))))))))))
