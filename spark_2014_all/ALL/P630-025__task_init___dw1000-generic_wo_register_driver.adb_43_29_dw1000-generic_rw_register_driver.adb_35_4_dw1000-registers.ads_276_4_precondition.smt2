...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__rx_sniff_type__sniff_ont bits_4)(rec__dw1000__register_types__rx_sniff_type__sniff_offt bits_8)(rec__dw1000__register_types__rx_sniff_type__reserved_1 bits_4)(rec__dw1000__register_types__rx_sniff_type__reserved_2 bits_16)))))
(define-fun us_split_fields_SNIFF_ONT__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__rx_sniff_type__sniff_ont a))

(define-fun us_split_fields_SNIFF_OFFT__projection ((a us_split_fields)) bits_8
  (rec__dw1000__register_types__rx_sniff_type__sniff_offt a))

(define-fun us_split_fields_Reserved_1__6__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__rx_sniff_type__reserved_1 a))

(define-fun us_split_fields_Reserved_2__6__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__rx_sniff_type__reserved_2 a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___22__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (and
                        (= (to_rep2
                           (rec__dw1000__register_types__rx_sniff_type__sniff_ont
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__rx_sniff_type__sniff_ont
                                                  (us_split_fields1 b))))
                        (= (to_rep1
                           (rec__dw1000__register_types__rx_sniff_type__sniff_offt
                           (us_split_fields1 a))) (to_rep1
                                                  (rec__dw1000__register_types__rx_sniff_type__sniff_offt
                                                  (us_split_fields1 b)))))
                        (= (to_rep2
                           (rec__dw1000__register_types__rx_sniff_type__reserved_1
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__rx_sniff_type__reserved_1
                                                  (us_split_fields1 b)))))
                        (= (to_rep3
                           (rec__dw1000__register_types__rx_sniff_type__reserved_2
...
;; dw1000__register_types__rx_sniff_type__sniff_ont__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rx_sniff_type__sniff_ont__first__bit))

;; dw1000__register_types__rx_sniff_type__sniff_ont__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_sniff_type__sniff_ont__first__bit dw1000__register_types__rx_sniff_type__sniff_ont__last__bit))

;; dw1000__register_types__rx_sniff_type__sniff_ont__position_axiom
...
;; dw1000__register_types__rx_sniff_type__sniff_offt__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rx_sniff_type__sniff_offt__first__bit))

;; dw1000__register_types__rx_sniff_type__sniff_offt__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_sniff_type__sniff_offt__first__bit dw1000__register_types__rx_sniff_type__sniff_offt__last__bit))

;; dw1000__register_types__rx_sniff_type__sniff_offt__position_axiom
...
;; dw1000__register_types__rx_sniff_type__reserved_1__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rx_sniff_type__reserved_1__first__bit))

;; dw1000__register_types__rx_sniff_type__reserved_1__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_sniff_type__reserved_1__first__bit dw1000__register_types__rx_sniff_type__reserved_1__last__bit))

;; dw1000__register_types__rx_sniff_type__reserved_1__position_axiom
...
;; dw1000__register_types__rx_sniff_type__reserved_2__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rx_sniff_type__reserved_2__first__bit))

;; dw1000__register_types__rx_sniff_type__reserved_2__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_sniff_type__reserved_2__first__bit dw1000__register_types__rx_sniff_type__reserved_2__last__bit))

;; dw1000__register_types__rx_sniff_type__reserved_2__position_axiom
...
(declare-datatypes ()
((rx_sniff_type__ref (mk_rx_sniff_type__ref (rx_sniff_type__content us_rep)))))
(define-fun rx_sniff_type__ref___projection ((a rx_sniff_type__ref)) us_rep
  (rx_sniff_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___46__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___34__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___34__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3146 us_t1)
  (temp___is_init_3143 Bool) (temp___skip_constant_3144 Bool)
  (temp___do_toplevel_3145 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3144 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3146)
                                       (last3 temp___expr_3146))
                                       (and (= (first3 temp___expr_3146) 1)
                                       (= (last3 temp___expr_3146) 4)))))
...
(define-fun target__ref___13__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___13__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_3165 us_t2)
  (temp___is_init_3162 Bool) (temp___skip_constant_3163 Bool)
  (temp___do_toplevel_3164 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3163 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_3165)
                                       (last5 temp___expr_3165))
                                       (and (= (first5 temp___expr_3165) 1)
                                       (= (last5 temp___expr_3165) 4)))))
...
;; H
  (assert
  (and (= temp___77932 (register_to_bytes reg)) (dynamic_invariant1
  temp___77932 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77931)) (to_rep (last4 temp___77931)))
     (+ (- (to_rep (last4 temp___77931)) (to_rep (first4 temp___77931))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77931)) (to_rep (last4 temp___77931)))
  temp___77941))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77941)) (to_rep (last2 temp___77941)))
     (+ (- (to_rep (last2 temp___77941)) (to_rep (first2 temp___77941))) 1)
