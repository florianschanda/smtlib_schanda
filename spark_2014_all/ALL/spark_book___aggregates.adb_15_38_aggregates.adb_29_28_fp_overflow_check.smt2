...
(define-fun bool_eq2 ((a (Array Int float)) (a__first Int) (a__last Int)
...
(declare-fun tolerance () t)

(declare-fun attr__ATTRIBUTE_ADDRESS7 () Int)

(declare-fun temp___208 (t t t t t t t t t t) (Array Int float))

;; def_axiom
  (assert
  (forall ((temp___210 t) (temp___211 t) (temp___212 t) (temp___213 t)
  (temp___214 t) (temp___215 t) (temp___216 t) (temp___217 t) (temp___218 t)
  (temp___219 t))
...
(declare-fun temp___221 (t) (Array Int float))
...
(declare-fun temp___225 (t t) (Array Int float))

;; def_axiom
  (assert
  (forall ((temp___227 t) (temp___228 t))
...
(declare-fun temp___230 (t t) (Array Int float))

;; def_axiom
  (assert
  (forall ((temp___232 t) (temp___233 t))
...
(declare-fun temp___236 (t) (Array Int float))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 233999996185302734375.0 10000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 198999996185302734375.0 10000000000000000000.0))))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 3.0)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral9) (/ 9999999974752427078783512115478515625.0 10000000000000000000000000000000000000000000.0))))
...
(declare-fun approx1 () t)

(declare-fun result7 () Bool)

(declare-fun approx2 () t)
...
;; H
  (assert
  (= small1 (temp___208 fliteral4 fliteral fliteral5 fliteral6 fliteral7
            fliteral8 fliteral7 fliteral6 fliteral5 fliteral)))

;; H
  (assert (= result3 small1))

;; H
  (assert (= small2 (temp___221 fliteral4)))

;; H
  (assert (= result4 small2))

;; H
  (assert (= small3 (temp___225 fliteral4 fliteral)))

;; H
  (assert (= result5 small3))

;; H
  (assert (= small4 (temp___230 fliteral4 fliteral)))

;; H
  (assert (= b1 c13b))

;; H
  (assert (tqtisFinite c13b))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite c14b)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite approx)))

;; H
  (assert (= (mul RNE1 fliteral9 c13b) tolerance))
...
;; H
  (assert (= approx1 (div1 RNE1 c13b fliteral5)))

;; H
  (assert
  (and (= o (mul RNE1 approx1 approx1)) (tqtisFinite
  (mul RNE1 approx1 approx1))))

;; H
  (assert (= o1 (sub RNE1 c13b o)))
...
;; H
  (assert (= result7 (ite (lt tolerance o3) true false)))
...
;; H
  (assert
  (and (=> (le (neg fliteral1) fliteral1) (tqtisFinite approx2)) (lt
  tolerance (abs1 (sub RNE1 c13b (mul RNE1 approx2 approx2))))))

(assert
;; WP_parameter_def
 ;; File "aggregates.adb", line 1, characters 0-0
  (not (tqtisFinite (div1 RNE1 c13b approx2))))
(check-sat)
