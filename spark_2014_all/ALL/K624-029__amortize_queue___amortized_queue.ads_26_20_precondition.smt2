...
;; H
  ...
  (and (in_range6 o10) (<= o10 (capacity right)))))
...
;; H
  (assert
  (and
  (= o12 (length (vector__content amortized_queue__Oconcat__2__result5)))
  (and (in_range6 o12)
  (<= o12 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
...
;; H
  (assert
  (and
  (= o9 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1))
  (and (in_range7 o9)
  (= o9 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1)))))
...
;; H
  (assert (= result5 (ite (= o9 left) true false)))
...
;; H
  (assert
  (and (= o8 (get (model__ right) o7))
  (and (in_range7 o8) (= o8 (get (model__ right) o7)))))
