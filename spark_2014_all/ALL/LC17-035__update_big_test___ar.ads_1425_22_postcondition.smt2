...
(declare-fun temp___3004 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3006 (Array Int et1)))
  (forall ((temp___3007 Int) (temp___3008 Int))
  (let ((temp___3005 (temp___3004 temp___3006 temp___3007 temp___3008)))
  (forall ((temp___3009 Int))
  (ite (= temp___3009 temp___3007)
  (= (select temp___3005 temp___3009) (of_rep temp___3008))
  (= (select temp___3005 temp___3009) (select temp___3006 temp___3009))))))))
...
(declare-const temp___7889 (Array Int et1))

(declare-const temp___78891 enum2t)
...
;; H
  (assert (= temp___7889 o2))

;; H
  (assert (= temp___78891 o3))
...
;; H
  (assert (= temp___7889 r__split_fields2))

;; H
  (assert (= temp___78891 r__split_fields3))
...
;; WP_parameter_def
 ;; File "ar.ads", line 1418, characters 0-0
  ...
  (= (bool_eq1
     ...
     (mk___rep
     (mk___split_fields (temp___3004 r__split_fields i e) r__split_fields1))) true)))
(check-sat)
(exit)
