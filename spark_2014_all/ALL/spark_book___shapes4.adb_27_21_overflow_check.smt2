...
;; H
  (assert
  (and
  (= o5 (* (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 c)))
  (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 c))))) (in_range
  (* (to_rep1 (rec__shapes4__circle__radius (us_split_fields1 c))) (to_rep1
                                                                   (rec__shapes4__circle__radius
                                                                   (us_split_fields1
                                                                   c)))))))
