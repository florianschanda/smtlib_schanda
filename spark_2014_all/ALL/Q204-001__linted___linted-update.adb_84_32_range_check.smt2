...
(define-fun y12 () int__ref (mk_int__ref y3))

(define-fun y13 () int__ref (mk_int__ref y2))

(define-fun y14 () int__ref (mk_int__ref y1))

(define-fun y15 () int__ref (mk_int__ref y))
...
;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= result1 y15)))
...
;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= result2 y15)))
...
;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= result5 y14)))
...
;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= result6 y14)))
...
;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= result9 y13)))
...
;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= result10 y13)))
...
;; H
  (assert (=> (bvule x7 ((_ int2bv 32) 2147483647)) (= result13 y12)))

;; H
  (assert (=> (bvule x7 ((_ int2bv 32) 2147483647)) (= y10 o114)))
...
;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= result14 y12)))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= y11 o118)))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= y10 y11)))

;; H
  (assert (= (to_rep1 o119) y10))
