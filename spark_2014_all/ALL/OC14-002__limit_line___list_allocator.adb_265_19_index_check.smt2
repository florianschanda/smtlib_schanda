...
;; H
  (assert
  (and
  (= o63 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         j))
  (in_range7 o63)))

;; H
  (assert (= result11 (ite (in_range4 o63) true false)))
...
;; H
  (assert (=> (= result12 true) (and (= o61 (+ j 1)) (in_range1 (+ j 1)))))
...
;; H
  (assert (=> (not (= result12 true)) (= o62 0)))
