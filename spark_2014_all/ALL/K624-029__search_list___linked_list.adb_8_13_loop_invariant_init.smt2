...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__linked_list__mylists__list__capacity count_type)))))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__linked_list__mylists__list us_main_type)))))
...
(declare-fun linked_list__mylists__list__capacity__first__bit () Int)

(declare-fun linked_list__mylists__list__capacity__last__bit () Int)

(declare-fun linked_list__mylists__list__capacity__position () Int)
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__linked_list__mylists__cursor__node count_type)))))
...
(declare-fun linked_list__mylists__cursor__node__first__bit () Int)

(declare-fun linked_list__mylists__cursor__node__last__bit () Int)

(declare-fun linked_list__mylists__cursor__node__position () Int)
...
(define-fun contains1 ((container us_rep2) (fst Int) (lst Int)
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant3 item true true true)
     ...
     (= (contains1 (model__ container) 1 (length2 container) item) true))) :pattern (
...
(declare-fun temp___455 () count_type)

(declare-fun linked_list__search__cu__assume () count_type)
...
(define-fun linked_list__search__cu__assume1 () us_rep1 (mk___rep1
                                                        (mk___split_fields1
...
;; H
  (assert
  (and (= linked_list__search__cu__assume1 (first l))
  (ite (= (= (length2 l) 0) true)
  (= (bool_eq1 linked_list__search__cu__assume1 no_element) true)
  (and (= (has_key (positions l) linked_list__search__cu__assume1) true)
  (= (get1 (positions l) linked_list__search__cu__assume1) 1)))))
...
;; H
  (assert (not (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) true)))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not (= (has_key (positions l) (mk___rep1 cu__split_fields2)) true)))
(check-sat)
(exit)
