...
;; H
  (assert
  (=> (= (to_rep (first (rt r))) (to_rep (first (rt a))))
  (= result1 (ite (= (to_rep (last (rt r))) (to_rep (last (rt a)))) true
             false))))

;; H
  (assert
  (=> (not (= (to_rep (first (rt r))) (to_rep (first (rt a)))))
  (= result1 false)))

;; H
  (assert
  (=> (= result1 true)
  (and (<= (to_rep (first (rt r))) i) (<= i (to_rep (last (rt r)))))))

;; H
  (assert (=> (= result1 true) (= o3 i)))

;; H
  (assert (=> (= result1 true) (= o4 (select (elts r) o3))))

;; H
  (assert (=> (= result1 true) (= o5 (to_rep o4))))

;; H
  (assert (=> (= result1 true) (= result (ite (= o5 v) true false))))
...
;; H
  (assert (and (<= (to_rep (first (rt a))) j) (<= j (to_rep (last (rt a))))))
