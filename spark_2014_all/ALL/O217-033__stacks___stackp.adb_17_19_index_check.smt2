...
(declare-fun user_eq9 (t21s t21s) Bool)

(declare-const dummy9 t21s)

(declare-datatypes ((t21s__ref 0)) (((mk_t21s__ref (t21s__content t21s)))))
...
;; def_axiom
  ...
  (= (select (temp___255 temp___257) 1) (of_rep1 temp___257))))
...
(declare-const temp___493 (Array Int element))

(declare-const temp___4931 less_than_max)

(declare-const temp___4932 us_private)

(declare-const temp___4933 Int)
...
;; H
  (assert
  (and (= o (+ (to_rep s__split_fields1) 1)) (in_range
...
;; H
  (assert (= temp___493 o2))

;; H
  (assert (= temp___4931 o3))

;; H
  (assert (= temp___4932 o4))

;; H
  (assert (= s__attr__tag temp___4933))
...
;; H
  (assert (= temp___493 s__split_fields3))

;; H
  (assert (= temp___4931 s__split_fields4))

;; H
  (assert (= temp___4932 s__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "stackp.ads", line 22, characters 0-0
  (not (<= 1 (to_rep s__split_fields4))))
(check-sat)
(exit)
