...
(declare-fun user_eq8 (t21s t21s) Bool)

(declare-fun dummy9 () t21s)
...
(define-fun bool_eq17 ((x us_t4)
  (y us_t4)) Bool (bool_eq3 (elts4 x) (to_rep2 (first8 (rt4 x)))
...
(define-fun bool_eq19 ((x us_t5)
  (y us_t5)) Bool (bool_eq3 (elts5 x) (to_rep2 (first10 (rt5 x)))
...
(declare-fun temp___493 () (Array Int element))

(declare-fun temp___4931 () less_than_max)

(declare-fun temp___4932 () us_private)

(declare-fun temp___4933 () Int)

(declare-fun o5 () element)

(declare-fun result () (Array Int element))

(declare-fun result1 () less_than_max)
