...
(declare-const temp___333 (Array Int us_rep))

(declare-const temp___3331 t1)

(declare-const temp___335 (Array Int us_rep))

(declare-const temp___3351 t1)
...
(declare-const temp___337 positive)

(declare-const temp___3371 (Array Int us_rep))

(declare-const temp___3372 t)

(declare-const result (Array Int us_rep))

(declare-const result1 t)

(declare-const com__split_fields2 (Array Int us_rep))

(declare-const com__split_fields3 t)

(declare-const com__split_fields4 (Array Int us_rep))

(declare-const com__split_fields5 t)

(declare-const com__split_fields6 us_split_fields2)
