...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields4)) 1) true)
  (ite (= (contains
          (model__
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields4))
     (find (elements (mk___rep s__split_discrs s__split_fields4)) 1)) 1))
  (= (equal_except
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields4))
     (find (elements (mk___rep s__split_discrs s__split_fields4)) 1)) true))
  (and
  (and
  (and
  (and
  ...
  (= (range_equal
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields4)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields4)) 1) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields4))
     (find (elements (mk___rep s__split_discrs s__split_fields4)) 1)
     (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields3)) 2) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields4)) 2) true)
  (and
  (and
  (and
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) 2)) 2))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields4))
     (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) 2)) true))
  (and
  (and
  (and
  (and
  ...
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields3))
     (model__ (mk___rep s__split_discrs s__split_fields4)) 2) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) 2)) 2))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields4))
     (elements (mk___rep s__split_discrs s__split_fields3)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields3)) 2) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields4))
     (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) 2)
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields3)) (to_rep
                                                          (rec__use_ordered_sets__my_sets__set__capacity
                                                          s__split_discrs)))
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields3)) 3) true))))
(check-sat)
(exit)
