...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 110000002384185791015625.0 100000000000000000000000.0))))
...
;; H
  (assert (lt fliteral2 (next_representable x1)))

;; H
  (assert (lt (next_representable x1) fliteral))

;; H
  (assert (lt (prev_representable x1) fliteral2))

;; H
  (assert (lt (neg fliteral) (prev_representable x1)))
...
;; H
  (assert (lt fliteral (next_representable x2)))

;; H
  (assert (lt (next_representable x2) fliteral3))

;; H
  (assert (lt (prev_representable x2) fliteral))

;; H
  (assert (lt fliteral4 (prev_representable x2)))
...
;; H
  (assert (=> (= a true) (= x4 (next_representable x3))))

;; H
  (assert (=> (not (= a true)) (lt (prev_representable x3) fliteral1)))

;; H
  (assert (=> (not (= a true)) (= x4 x3)))

;; H
  (assert (lt fliteral2 (prev_representable x4)))

;; H
  (assert (= result4 x4))

;; H
  (assert (= x5 (neg fliteral1)))

;; H
  (assert (=> (= b true) (= result5 x5)))

;; H
  (assert (=> (= b true) (= x6 (prev_representable x5))))

;; H
  (assert (=> (not (= b true)) (lt (neg fliteral1) (next_representable x5))))

;; H
  (assert (=> (not (= b true)) (= x6 x5)))

(assert
;; WP_parameter_def
 ;; File "succ_floats.adb", line 1, characters 0-0
  (not (lt (next_representable x6) fliteral2)))
(check-sat)
