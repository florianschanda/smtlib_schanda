...
(declare-fun o5 () ext_account_num)

(declare-fun o6 () ext_account_num)

(declare-fun o7 () Bool)

(declare-fun o8 () ext_account_num)

(declare-fun o9 () ext_account_num)

(declare-fun o10 () ext_account_num)
...
(declare-fun links2 () (Array Int us_rep))

(declare-fun first_available2 () Int)

(declare-fun account2 () Int)

(declare-fun links3 () (Array Int us_rep))
...
;; H
  (assert
  (= o2 (store links o1 (mk___rep
                        (mk___split_fields (of_int 0)
                        (rec__database__availability__account_link__prev
                        (us_split_fields1 (select links first_available)))
                        (rec__database__availability__account_link__next
                        (us_split_fields1 (select links first_available))))))))
...
;; WP_parameter_def
 ;; File "database.adb", line 46, characters 0-0
  (not (not (= (is_available account2 links2) true))))
(check-sat)
