...
(declare-const temp___560 positive_less_than_max)

(declare-const temp___5601 (Array Int element))

(declare-const temp___5602 less_than_max)

(declare-const temp___5603 us_private)

(declare-const temp___5604 Int)
