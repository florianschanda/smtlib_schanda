...
(declare-fun user_eq12 (partition_index partition_index) Bool)
...
(declare-fun user_eq13 (capacity_range capacity_range) Bool)
...
(declare-fun bool_eq15 (us_rep7 us_rep7) Bool)
...
(define-fun bool_eq16 ((a (Array Int partition_index)) (a__first Int)
...
(declare-fun user_eq16 (key_type1 key_type1) Bool)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (=> (= (get1 result i1) (get1 result j1)) (= (bool_eq6 i1 j1) true))))))))) :pattern (
  (positions container)) )))
...
(declare-fun user_eq20 (element_type3 element_type3) Bool)
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq15 a b) (oeq5 a b)) :pattern ((user_eq15 a b)) )))
...
(declare-fun user_eq22 (index_type index_type) Bool)
...
;; H
  ...
  (= (has_key
     (positions
     (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c) true)
  (= (to_rep
     (select a (element
               (mk___rep d__split_discrs (mk___split_fields d__split_fields))
               c))) (key
                    (mk___rep d__split_discrs
                    (mk___split_fields d__split_fields)) c)))))))))
...
;; H
  ...
  (= partition_refinement__refine_one__p_elem__assume3 (get3
                                                       ...
                                                       p__split_fields)))
                                                       (to_rep4 (select f i))))
  (= (bool_eq12 partition_refinement__refine_one__p_elem__assume3
     (get3
     (model__1
...
;; H
  (assert (= (bool_eq3 a1 0 5 a_update 0 5) true))
...
;; H
  ...
  (and
  (not
  (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c) 
  (to_rep (select a1 i))))
  (not
  (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c) 
  (to_rep (select a1 j)))))
  (= (to_rep
     (select a1 (element
                (mk___rep d__split_discrs
                (mk___split_fields d__split_fields)) c))) (key
                                                          (mk___rep
                                                          d__split_discrs
                                                          (mk___split_fields
                                                          d__split_fields))
...
;; H
  ...
  (forall ((c us_rep1))
  (=>
  (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c) true)
  (=>
  (and
  (not
  (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep
                                                         (select a1 i))))
  (not
  (= (key (mk___rep d__split_discrs d__split_fields1) c) (to_rep
                                                         (select a1 j)))))
  (= (to_rep
     (select a1 (element (mk___rep d__split_discrs d__split_fields1) c))) 
  (key (mk___rep d__split_discrs d__split_fields1) c))))))
...
;; H
  ...
  (forall ((c us_rep1))
  (=>
  (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true)
  (=>
  (and
  (not
  (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep
                                                         (select a1 i))))
  (not
  (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep
                                                         (select a1 j)))))
  (= (to_rep
     (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) 
  (key (mk___rep d__split_discrs d__split_fields2) c))))))
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 5))
  (= (to_rep (select a1 k1)) (ite (= k1 i) (to_rep (select a_old j))
                             (ite (= k1 j) (to_rep (select a_old i))
                             (to_rep (select a_old k1))))))))
...
;; WP_parameter_def
 ;; File "partition_refinement.adb", line 14, characters 0-0
  ...
  (us_split_fields5
  (get3
  (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))
  (to_rep4
  (select f (get2
            (model__
            (mk___rep d__split_discrs (mk___split_fields d__split_fields)))
