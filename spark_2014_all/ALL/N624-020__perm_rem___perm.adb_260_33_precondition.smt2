...
;; H
  ...
  (and (= (to_rep2 (last (rt o19))) (- (to_rep2 (last (rt o17))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o18 1)))
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (+ o18 1) k) (<= k (to_rep2 (last (rt o17)))))
  (= (to_rep (select (elts o17) k)) (to_rep (select (elts o19) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o18 k) (<= k (- (to_rep2 (last (rt o17))) 1)))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o16))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o16) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o16) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o16) k))))))))))))
