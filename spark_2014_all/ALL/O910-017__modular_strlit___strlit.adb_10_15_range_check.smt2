...
(((mk_map__ref (map__content (Array (_ BitVec 8) character))))))
...
(((mk___t (elts (Array (_ BitVec 8) character))(rt t)))))
...
(declare-datatypes ((mod_string__ref 0))
(((mk_mod_string__ref (mod_string__content us_t)))))
