...
(define-fun model____split_fields8 () us_split_fields (mk___split_fields
                                                      model____split_fields6
                                                      model____split_fields7))

(define-fun model____split_fields9 () us_split_fields (mk___split_fields
...
;; H
  (assert
  (and
  (and (= (is_valid state1 model____split_fields10) true)
...
;; H
  (assert
  (and
  (and (= (is_valid state2 model____split_fields9) true)
  (ite (= (= (length model____split_fields2) 0) true)
  (and (= res21 0)
  (= (oeq (mk___rep model____split_fields9)
     (mk___rep model____split_fields10)) true))
  (and
...
;; H
  (assert
  (and
  (and (= (is_valid state3 model____split_fields8) true)
  (ite (= (= (length model____split_fields4) 0) true)
  (and (= res31 0)
  (= (oeq (mk___rep model____split_fields8)
     (mk___rep model____split_fields9)) true))
  (and
...
;; WP_parameter_def
 ;; File "list_allocator.ads", line 80, characters 0-0
  (not (= (is_allocated res31 state3) true)))
(check-sat)
(exit)
