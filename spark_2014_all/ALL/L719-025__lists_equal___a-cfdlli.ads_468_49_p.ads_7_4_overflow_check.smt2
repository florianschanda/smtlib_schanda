...
(declare-const temp___397 count_type)
...
;; H
  (assert (= temp___397 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___397)) no_element))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 55, characters 0-0
  (not (in_range
  (- (to_rep (rec__p__my_lists__list__capacity container__split_discrs))
  count))))
(check-sat)
(exit)
