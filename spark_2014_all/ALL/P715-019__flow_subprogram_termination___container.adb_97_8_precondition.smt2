...
(declare-fun temp___581 () Int)

(declare-fun temp___580 () Int)

(declare-fun temp___583 () int__ref)

(declare-fun temp___582 () int__ref)
...
(declare-fun temp___5931 () us_rep1)

(declare-fun temp___590 () Int)
...
(declare-fun temp___5831 () Int)

(declare-fun temp___5821 () Int)

(declare-fun result35 () int__ref)

(declare-fun temp___5822 () Int)

(declare-fun result36 () int__ref)

(declare-fun temp___5832 () Int)

(declare-fun x34 () int__ref)
...
;; H
  (assert
  (and (= o20 (first (mk___rep my_container__split_fields1)))
  (= (of_rep 1) o7)))

;; H
  (assert (= temp___572 (mk_cursor__ref o20)))
...
;; H
  (assert
  (and (= o18 (- (int__content r6) 1)) (in_range3 (- (int__content r6) 1))))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 1 200) (in_range3 r9))
  (=> (<= (- 2147483648) 2147483647) (in_range1 e25)))
  (=> (<= 1 200) (in_range3 x31)))
  (and
  (= (has_element (mk___rep my_container__split_fields1)
     (let ((subject temp___593)) temp___5931)) true)
  (= e25 (element (mk___rep my_container__split_fields1)
         (let ((subject temp___593)) temp___5931))))))
...
;; H
  (assert
  (=> (and (<= 1 i9) (<= i9 200))
  (and (and (=> (<= 1 200) (in_range3 i10)) (=> (<= 1 200) (in_range3 x33)))
  (and (<= 1 i10) (<= i10 200)))))

;; H
  (assert
  (=> (and (<= 1 i9) (<= i9 200))
  (= result35 (let ((subject temp___582)) (mk_int__ref temp___5821)))))

;; H
  (assert
  (=> (and (<= 1 i9) (<= i9 200))
  (= (let ((subject temp___582)) temp___5822) i10)))

;; H
  (assert
  (=> (and (<= 1 i9) (<= i9 200))
  (= result36 (let ((subject temp___583)) (mk_int__ref temp___5831)))))

;; H
  (assert
  (=> (and (<= 1 i9) (<= i9 200))
  (= (let ((subject temp___583)) temp___5832) x33)))
