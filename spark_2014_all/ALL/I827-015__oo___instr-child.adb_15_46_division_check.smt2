...
(((mk_instrument__ref (instrument__content us_rep)))))
...
(declare-datatypes ((sixty__ref 0))
(((mk_sixty__ref (sixty__content sixty)))))
...
(declare-datatypes ((twenty_four__ref 0))
(((mk_twenty_four__ref (twenty_four__content twenty_four)))))
...
(declare-datatypes ((clock__ref 0))
(((mk_clock__ref (clock__content us_rep1)))))
...
(declare-datatypes ((chronometer__ref 0))
(((mk_chronometer__ref (chronometer__content us_rep1)))))
...
(declare-const dummy8 thousand)

(declare-datatypes ((thousand__ref 0))
(((mk_thousand__ref (thousand__content thousand)))))
...
(declare-datatypes ((accurate_clock__ref 0))
...
(declare-const x__split_fields thousand)
