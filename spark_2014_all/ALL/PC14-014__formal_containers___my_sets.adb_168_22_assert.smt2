...
;; H
  (assert
  (and
  (= temp___1451 (find1 (mk___rep1 l__split_discrs l__split_fields9) o42))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields9))
               o42) false) true false)
  (= (bool_eq2 temp___1451 no_element) true)
  (and
  (and
  ...
  (= (= (to_rep1
        (rec__my_sets__my_rec__f
        (us_split_fields1
        (element (mk___rep1 l__split_discrs l__split_fields9) temp___1451))))
