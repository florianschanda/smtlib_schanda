...
(declare-const h__split_fields (Array Int natural))

(declare-const e Int)

(declare-const for_loop_iterable__p4__g__assume (Array Int natural))
...
(declare-const h__split_fields1 (Array Int natural))
...
(declare-const h__split_fields2 us_split_fields2)
