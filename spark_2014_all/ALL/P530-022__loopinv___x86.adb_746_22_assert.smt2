...
(declare-fun mem4 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun mem5 () (Array (_ BitVec 64) unsigned8))

(declare-fun rcx6 () (_ BitVec 64))

(declare-fun rdi6 () (_ BitVec 64))

(declare-fun memory6 () (Array (_ BitVec 64) unsigned8))

(declare-fun mem6 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun mem7 () (Array (_ BitVec 64) unsigned8))
...
;; H
  (assert
  (=> (not (= rcx ((_ int2bv 64) 0))) (= (readmem64 rdi2 memory3) rax)))
...
;; H
  (assert
  (=> (not (= rcx ((_ int2bv 64) 0))) (= memory8 (mk_map__ref memory4))))
...
;; H
  (assert
  (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= memory8 (mk_map__ref memory))))

;; H
  (assert
  (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rdi8 (mk_t__ref1 rdi))))

;; H
  (assert
  (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rcx8 (mk_t__ref1 rcx))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 714, characters 0-0
  (not
  (= (all_equal_rax rdi_start (bvsub rcx_start ((_ int2bv 64) 1)) memory6
     rax) true)))
(check-sat)
(exit)
