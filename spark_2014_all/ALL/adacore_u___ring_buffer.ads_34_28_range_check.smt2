...
(declare-const dummy5 tTcontentSP1)
...
;; H
  (assert
  (and (= o (get_model content first length1))
  (= (valid_model__21 o content first length1) true)))

;; H
  (assert (and (= o1 (length o)) (and (in_range3 o1) (<= (+ 0 o1) 100))))
