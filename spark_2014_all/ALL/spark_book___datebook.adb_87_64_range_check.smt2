...
(((mk_status_type__ref (status_type__content status_type)))))
...
(declare-datatypes ((description_count_type__ref 0))
...
(declare-datatypes ((event_record__ref 0))
(((mk_event_record__ref (event_record__content us_rep3)))))
...
(declare-datatypes ((description_index_type__ref 0))
...
(declare-datatypes ((event_index_type__ref 0))
...
(declare-datatypes ((t9b__ref 0)) (((mk_t9b__ref (t9b__content us_t1)))))
