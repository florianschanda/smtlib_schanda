...
;; first__post_axiom
  ...
  (! (let ((result (first container)))
     (ite (= (length3 container) 0) (= (bool_eq4 result no_element) true)
...
(declare-fun use_maps__my_find__result () count_type)
...
(declare-fun use_maps__my_find__result1 () count_type)
...
(declare-fun use_maps__my_find__result2 () us_rep1)

(declare-fun temp___7461 () Int)

(declare-fun result2 () int__ref)

(declare-fun temp___7462 () Int)

(declare-fun result3 () Bool)

(declare-fun result4 () cursor__ref)

(declare-fun use_maps__my_find__result3 () us_rep1)
...
(declare-fun use_maps__my_find__result4 () cursor__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_maps__my_find__result5 () us_rep1)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_maps__my_find__result6 () cursor__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_maps__my_find__result7 () us_rep1)

(declare-fun result7 () cursor__ref)

(declare-fun use_maps__my_find__result8 () us_rep1)

(declare-fun use_maps__my_find__result9 () cursor__ref)

(declare-fun use_maps__my_find__result10 () us_rep1)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_maps__my_find__result11 () cursor__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_maps__my_find__result12 () us_rep1)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_maps__my_find__result13 () cursor__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_maps__my_find__result14 () us_rep1)
...
(declare-fun result8 () count_type)
...
;; H
  ...
  (= (bool_eq4 use_maps__my_find__cu__assume1 no_element) true)
...
;; H
  ...
  (and
  (and
  (= use_maps__my_find__result11 (mk_cursor__ref use_maps__my_find__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields12)))
  (and (= use_maps__my_find__result12 use_maps__my_find__result3)
  ...
  (and (= result1 true)
  (and (= temp___745 cu__split_fields1)
  (and (= 0 temp___746)
  (and
  (forall ((i Int))
  (=>
  ...
  (and
  (and (= result2 (mk_int__ref temp___7461))
  (= temp___7462 (get1 (positions s) (mk___rep1 cu__split_fields12))))
  (and
  (and
  ...
  (and (= result3 true)
  (and (= result4 (mk_cursor__ref use_maps__my_find__result2))
  (= use_maps__my_find__result3 (mk___rep1 cu__split_fields12)))))))))))))
  (and
  (and
  (and (= result1 (has_key1 (positions s) (mk___rep1 cu__split_fields13)))
  (= (= result1 true)
  ...
  (= use_maps__my_find__result3 use_maps__my_find__result2)))
  (and
  (and
  (and (= temp___7441 (next s (mk___rep1 cu__split_fields12)))
  (ite (= (ite (= (bool_eq4 (mk___rep1 cu__split_fields12) no_element) false) (= 
          (get1 (positions s) (mk___rep1 cu__split_fields12)) (length3 s)) true) true)
  (= (bool_eq4 temp___7441 no_element) true)
  ...
  (= cu__split_fields3 (mk___split_fields1 temp___744))))
  (and
  (and
  ...
  (and
  (and
  (= use_maps__my_find__result4 (mk_cursor__ref use_maps__my_find__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3)))
  (and (= use_maps__my_find__result5 use_maps__my_find__result3)
  (= cu__split_fields5 cu__split_fields3))))
  (and
  (and (= use_maps__my_find__result6 use_maps__my_find__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and (= use_maps__my_find__result7 use_maps__my_find__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= use_maps__my_find__result6 (mk_cursor__ref
                                (mk___rep1
                                (mk___split_fields1
                                use_maps__my_find__result))))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields13)))
  (and
  (= use_maps__my_find__result7 (mk___rep1
                                (mk___split_fields1
                                use_maps__my_find__result1)))
  (= cu__split_fields7 cu__split_fields13)))))
  (and
  (and
  (and (= use_maps__my_find__result11 use_maps__my_find__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and (= use_maps__my_find__result12 use_maps__my_find__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= use_maps__my_find__result9 (mk_cursor__ref use_maps__my_find__result8))
  (= use_maps__my_find__result10 use_maps__my_find__result8))
  (and (= result7 use_maps__my_find__result6)
  (= use_maps__my_find__result8 no_element)))))))

;; H
  (assert (= use_maps__my_find__result13 use_maps__my_find__result11))

;; H
  (assert (= cu__split_fields10 cu__split_fields8))

;; H
  (assert (= use_maps__my_find__result14 use_maps__my_find__result12))
...
;; H
  ...
  (= (mk___rep1 (mk___split_fields1 result8)) (cursor__content
                                              use_maps__my_find__result13)))

;; H
  (assert
  (not
  (= (bool_eq4 (cursor__content use_maps__my_find__result13) no_element) true)))

(assert
;; WP_parameter_def
 ;; File "a-cfhama.ads", line 78, characters 0-0
  (not
  (= (has_key1 (positions s) (cursor__content use_maps__my_find__result13)) true)))
(check-sat)
