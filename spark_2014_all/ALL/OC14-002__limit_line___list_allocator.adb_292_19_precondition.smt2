...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result12 (ite (< 0 o68) true false))))
...
;; H
  ...
  (=> (= result12 true)
  (and
  (= o67 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o67)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result12 true)
  (= result11 (ite (= o67 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o65) true false)))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o64 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o64))))))
...
;; H
  ...
  (=> (not (= first_allocated2 0))
  (=> (= result13 true)
  (= result10 (ite (= o64 first_allocated2) true false))))))
...
;; H
  (assert
  (and
  (= o63 (get (rec__list_allocator__m__t__available model____split_fields3)
         j))
  (in_range7 o63)))

;; H
  (assert (= result15 (ite (in_range4 o63) true false)))
...
;; H
  (assert (=> (= result16 true) (and (= o61 (+ j 1)) (in_range1 (+ j 1)))))
...
;; H
  (assert (=> (not (= result16 true)) (= o62 0)))
