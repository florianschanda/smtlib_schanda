...
(declare-const temp___219 r1)

(declare-const temp___2191 (Array Int integer))
...
(declare-const stack__empty_stack__result6 us_rep)

(declare-const e__split_fields6 us_split_fields__ref)

(declare-const stack__empty_stack__result7 stack__ref)

(declare-const e__split_fields7 us_split_fields)

(declare-const stack__empty_stack__result8 us_rep)
