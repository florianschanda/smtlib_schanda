...
(define-fun o19 () us_t (mk___t o14 o15))

(define-fun o20 () us_t (mk___t o11 o12))

(define-fun o21 () us_t (mk___t o8 o9))

(define-fun o22 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and (= o16 (shift_perm_l o22 o21 o19))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o19 o21) true)))))
...
;; H
  (assert
  (and
  (= o18 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
