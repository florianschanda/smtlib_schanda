...
;; H
  (assert
  (and (= o32 (+ (to_rep1 (first (rt source))) 9)) (in_range1
...
;; H
  (assert
  (and (= temp___1853 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1853)
  (<= temp___1853 (to_rep1 (last (rt source))))))
