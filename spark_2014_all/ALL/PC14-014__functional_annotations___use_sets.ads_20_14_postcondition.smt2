...
(define-fun use_sets__my_find__result15 () us_rep1 (mk___rep1
                                                   (mk___split_fields1
                                                   use_sets__my_find__result2)))
...
;; H
  ...
  (and
  (and
  (= use_sets__my_find__result11 (mk_cursor__ref use_sets__my_find__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields12)))
  (and (= use_sets__my_find__result12 use_sets__my_find__result3)
  (= cu__split_fields9 cu__split_fields12)))
  (and
  (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields13)))
  (= (= result1 true)
  (= (has_key (positions s) (mk___rep1 cu__split_fields13)) true)))
  (and (= result1 true)
  (and (= temp___859 cu__split_fields1)
  (and
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  ...
  (and (= (has_key (positions s) (mk___rep1 cu__split_fields12)) true)
  (and
  (and
  (and (= o2 (element s (mk___rep1 cu__split_fields12)))
  (and (in_range7 o2)
  (= o2 (get (elements s)
        (get1 (positions s) (mk___rep1 cu__split_fields12))))))
  (= result2 (ite (= o2 e) true false)))
  (and (= result2 true)
  (and (= result3 (mk_cursor__ref use_sets__my_find__result15))
  (= use_sets__my_find__result3 (mk___rep1 cu__split_fields12)))))))))))
  (and
  (and
  (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields13)))
  (= (= result1 true)
  ...
  (= use_sets__my_find__result3 use_sets__my_find__result15)))
  (and
  (and
  (and (= temp___8581 (next s (mk___rep1 cu__split_fields12)))
  (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields12) no_element) false) (=
          (get1 (positions s) (mk___rep1 cu__split_fields12)) (length2 s)) true) true)
  (= (bool_eq1 temp___8581 no_element) true)
  (and (= (has_key (positions s) temp___8581) true)
  (= (get1 (positions s) temp___8581) (+ (get1 (positions s)
                                         (mk___rep1 cu__split_fields12)) 1)))))
  (and (= result4 (mk___split_fields__ref1 cu__split_fields12))
  (= cu__split_fields3 (mk___split_fields1 temp___858))))
  (and
  (and
  (and (= o3 (has_key (positions s) (mk___rep1 cu__split_fields3)))
  (= (= o3 true)
  (= (has_key (positions s) (mk___rep1 cu__split_fields3)) true)))
  (= result5 (ite (not (= o3 true)) true false))) (= result5 true)))))))
  (and
  (and
  (= use_sets__my_find__result4 (mk_cursor__ref use_sets__my_find__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3)))
  (and (= use_sets__my_find__result5 use_sets__my_find__result3)
  (= cu__split_fields5 cu__split_fields3))))
  (and
  (and (= use_sets__my_find__result6 use_sets__my_find__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and (= use_sets__my_find__result7 use_sets__my_find__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= use_sets__my_find__result6 (mk_cursor__ref
                                (mk___rep1
                                (mk___split_fields1
                                use_sets__my_find__result))))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields13)))
  (and
  (= use_sets__my_find__result7 (mk___rep1
                                (mk___split_fields1
                                use_sets__my_find__result1)))
  (= cu__split_fields7 cu__split_fields13)))))
  (and
  (and
  (and (= use_sets__my_find__result11 use_sets__my_find__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and (= use_sets__my_find__result12 use_sets__my_find__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= use_sets__my_find__result9 (mk_cursor__ref use_sets__my_find__result8))
  (= use_sets__my_find__result10 use_sets__my_find__result8))
  (and (= result6 use_sets__my_find__result6)
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 result7)) (cursor__content
                                              use_sets__my_find__result13)))

(assert
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 75, characters 0-0
  (not
  (= (bool_eq1 (cursor__content use_sets__my_find__result13) (find1 s e)) true)))
(check-sat)
(exit)
