...
;; H
  (assert
  (forall ((y1 Int))
  (=> (and (<= 1 y1) (<= y1 del_line2))
  (not (= (is_complete_line (select cur_board3 y1)) true)))))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2175 Int))
  (=> (and (<= 1 temp___2175) (<= temp___2175 20))
  (=> (< del_line2 temp___2175)
  (= (select cur_board3 temp___2175) (select cur_board temp___2175)))))
  (=> (<= 1 20) (in_range4 to_line3)))
  (=> (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 99999)) (in_range2
  complete_lines3))) (=> (<= 1 20) (in_range4 del_line2)))
