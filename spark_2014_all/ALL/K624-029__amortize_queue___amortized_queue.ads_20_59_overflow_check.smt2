...
;; H
  (assert
  (and (= o14 (length right))
  (and (in_range5 o14) (<= o14 (capacity right)))))

;; H
  (assert
  (and (= o15 (length left)) (and (in_range5 o15) (<= o15 (capacity left)))))
...
;; H
  (assert
  (and (= o17 (length (vector__content amortized_queue__Oconcat__result5)))
  (and (in_range5 o17)
  (<= o17 (capacity (vector__content amortized_queue__Oconcat__result5))))))
...
;; H
  (assert
  (and (= o12 (last (model__ left)))
  (and (in_range4 o12) (= o12 (last (model__ left))))))
...
;; H
  (assert
  (and (= o11 (get (model__ right) o10))
  (and (in_range6 o11) (= o11 (get (model__ right) o10)))))
