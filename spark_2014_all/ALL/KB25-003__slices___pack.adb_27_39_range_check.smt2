...
;; def_axiom
  ...
  (= (select (pack__a2__my_a__aggregate_def temp___141) temp___142) (of_rep1
                                                                    temp___141)))))
...
(declare-fun temp___383 () (Array Int character))

(declare-fun o () (Array Int character))

(declare-fun pack__a2__my_b__assume () (Array Int integer))
...
(assert
;; WP_parameter_def
 ;; File "pack.adb", line 11, characters 0-0
