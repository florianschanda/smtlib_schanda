...
;; H
  (assert
  (and (= o29 (remove (mk___t values2 (mk 1 100)) o28))
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o28 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o29) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o28 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o29) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o28 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o29) k))))))))))))
...
;; H
  ...
  (and (= (to_rep1 (last (rt o31))) (- (to_rep1 (last (rt o29))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o30 1)))
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (+ o30 1) k) (<= k (to_rep1 (last (rt o29)))))
  (= (to_rep (select (elts o29) k)) (to_rep (select (elts o31) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o30 k) (<= k (- (to_rep1 (last (rt o29))) 1)))
