...
(declare-fun queue__front__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun queue__front__result1 () Int)

(declare-fun queue__front__result2 () Int)

(declare-fun queue__front__result3 () Int)

(declare-fun queue__front__result4 () Int)

(declare-fun queue__front__result5 () Int)
...
;; H
  (assert
  (and (= o (last_element q))
  (and (in_range1 o) (= o (get (model__ q) (length q))))))
...
;; H
  (assert
  (= (mk_int__ref queue__front__result4) (mk_int__ref queue__front__result2)))

;; H
  (assert (= queue__front__result5 queue__front__result3))

;; H
  (assert (= result1 queue__front__result4))

(assert
;; WP_parameter_def
 ;; File "queue.ads", line 17, characters 0-0
  (not (= (last_element q) queue__front__result4)))
(check-sat)
(exit)
