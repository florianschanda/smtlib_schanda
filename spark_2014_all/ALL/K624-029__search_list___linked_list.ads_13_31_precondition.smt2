...
;; H
  ...
  (and (= o5 (contains l 0))
  (= (= o5 true) (= (contains1 (model__ l) 1 (length2 l) 0) true)))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o4 (element l (cursor__content linked_list__search__result13)))
  (and (in_range5 o4)
  (= o4 (get (model__ l)
...
;; H
  ...
  (forall ((i us_rep1))
  (=> (= (has_key o3 i) true)
  (and (and (<= 1 (get1 o3 i)) (<= (get1 o3 i) (length2 l)))
  (forall ((j us_rep1))
  (=> (= (has_key o3 j) true)
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not
  (= (has_key o3 (cursor__content linked_list__search__result13)) true)))
(check-sat)
(exit)
