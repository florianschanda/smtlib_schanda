...
(declare-fun temp___466 () count_type)
...
(define-fun temp___4661 () us_rep1 (mk___rep1
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields6)) (+ (length
                                                             ...
                                                             (mk___split_fields
                                                             l__split_fields))) 1))
  (ite (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields))
          no_element) true)
  (and
  (and
  (and
...
;; H
  ...
  (=>
  (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true)
  (and (= temp___4661 (last1 (mk___rep l__split_discrs l__split_fields6)))
  (ite (= (= (length (mk___rep l__split_discrs l__split_fields6)) 0) true)
  (= (bool_eq1 temp___4661 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields6))
     temp___4661) true)
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields6))
     temp___4661) (length (mk___rep l__split_discrs l__split_fields6))))))))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true))
  (and
  (= temp___4661 (previous (mk___rep l__split_discrs l__split_fields6)
                 (mk___rep1 (mk___split_fields1 cu__split_fields))))
