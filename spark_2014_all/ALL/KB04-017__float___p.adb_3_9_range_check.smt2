...
(declare-fun id__function_guard (t t) Bool)
...
(declare-fun t_FIRST () t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun t_LAST () t)
...
(declare-fun p__t_FIRST__assume () t)

(declare-fun p__t_LAST__assume () t)

;; H
  (assert
  (and (= p__t_FIRST__assume (id fliteral2))
  (and (tqtisFinite p__t_FIRST__assume) (= p__t_FIRST__assume fliteral2))))

;; H
  (assert (= p__t_FIRST__assume t_FIRST))

;; H
  (assert (tqtisFinite t_FIRST))

;; H
  (assert
  (and (= p__t_LAST__assume (id fliteral))
  (and (tqtisFinite p__t_LAST__assume) (= p__t_LAST__assume fliteral))))

;; H
  (assert (= p__t_LAST__assume t_LAST))

;; H
  (assert (tqtisFinite t_LAST))

;; H
  (assert (le t_FIRST t_LAST))

(assert
;; WP_parameter_def
 ;; File "p.adb", line 2, characters 0-0
  (not (le (neg fliteral1) t_FIRST)))
(check-sat)
