...
;; H
  (assert
  (=> (and (<= r4b j1) (<= j1 (- (ite (< a b) a b) 1)))
  (and (= o3 (ite (< a b) a b)) (in_range1 (ite (< a b) a b)))))

;; H
  (assert
  (=> (and (<= r4b j1) (<= j1 (- (ite (< a b) a b) 1)))
  (and (= o2 j1) (in_range1 j1))))
...
;; H
  ...
  (forall ((x Int))
  (=> (and (<= (+ c2 1) x) (<= x j2))
  (not (= (divides x (ite (< a b) a b)) true))))))
...
;; H
  (assert
  (=> (not (and (<= r4b j1) (<= j1 (- (ite (< a b) a b) 1)))) (= j1 j5)))

;; H
  (assert
  (=> (not (and (<= r4b j1) (<= j1 (- (ite (< a b) a b) 1)))) (= j6 j1)))
