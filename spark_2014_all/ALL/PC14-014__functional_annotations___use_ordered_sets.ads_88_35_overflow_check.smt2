...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o9 (next (mk___rep s__split_discrs s__split_fields3)
        (mk___rep1 cu__split_fields2)))
  ...
  (= (bool_eq4 o9 no_element) true)
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o9) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o9) (+ 
  (get1 (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o9))
  (ite (= (ite (= (bool_eq4 o9 no_element) false) (= (get1
                                                     (positions
                                                     (mk___rep
                                                     s__split_discrs
                                                     s__split_fields3)) 
