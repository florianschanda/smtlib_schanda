...
(declare-const dummy1 algorithmt)
...
(declare-const dummy2 namecountt)
...
(declare-const dummy14 privileget)
...
(define-fun us_split_fields__ref___14__projection ((a us_split_fields__ref5)) us_split_fields10
...
(declare-const dummy20 keylengtht)
...
(define-fun us_split_fields__ref___2__projection ((a us_split_fields__ref6)) us_split_fields12
  (us_split_fields__content6 a))

(declare-datatypes ()
((us_rep6 (mk___rep6 (us_split_fields13 us_split_fields12)))))
(define-fun us_rep___2__projection ((a us_rep6)) us_split_fields12 (us_split_fields13
                                                                   a))
...
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep1
  (rec__cert__id__contentst__id a))

(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields14)) us_rep2
  (rec__cert__id__contentst__notbefore a))

(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields14)) us_rep2
  (rec__cert__id__contentst__notafter a))

(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields14)) algorithmt
...
(define-fun us_split_fields__ref___13__projection ((a us_split_fields__ref7)) us_split_fields14
  (us_split_fields__content7 a))

(declare-datatypes ()
((us_rep7 (mk___rep7 (us_split_fields15 us_split_fields14)))))
(define-fun us_rep___14__projection ((a us_rep7)) us_split_fields14 (us_split_fields15
                                                                    a))
...
(define-fun contentst__ref___4__projection ((a contentst__ref1)) us_rep7
...
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields16)) us_rep7
