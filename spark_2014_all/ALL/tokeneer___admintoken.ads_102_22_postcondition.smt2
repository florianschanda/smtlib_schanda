...
;; range_axiom
  (assert
  (forall ((x algorithmt)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)) )))
...
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 40)))
...
;; range_axiom
  (assert
  (forall ((x privileget)) (! (in_range11
...
;; theauthcertrole__post_axiom
  ...
  (! (dynamic_invariant1 (theauthcertrole admintoken__authcert__fields) true
...
(define-fun dynamic_invariant4 ((temp___expr_347 Int)
  ...
  (temp___do_toplevel_346 Bool)) Bool (=>
                                      ...
                                      (<= 1 12)) (in_range8 temp___expr_347)))
...
(define-fun dynamic_invariant5 ((temp___expr_353 Int)
  ...
  (temp___do_toplevel_352 Bool)) Bool (=>
                                      ...
                                      (<= 1 31)) (in_range9 temp___expr_353)))
...
(define-fun dynamic_invariant7 ((temp___expr_179 Int)
  ...
  (temp___do_toplevel_178 Bool)) Bool (=>
                                      ...
                                      (<= 0 40)) (in_range3 temp___expr_179)))
...
(define-fun dynamic_invariant9 ((temp___expr_218 Int)
  ...
  (temp___do_toplevel_217 Bool)) Bool (=>
                                      ...
                                      (<= 0 10)) (in_range2 temp___expr_218)))
...
(define-fun dynamic_invariant12 ((temp___expr_897 Int)
  ...
  (temp___do_toplevel_896 Bool)) Bool (=>
                                      ...
                                      (<= 0 5)) (in_range12 temp___expr_897)))
...
;; therole__post_axiom
  (assert
  (forall ((contents us_rep4)) (! (dynamic_invariant1 (therole contents) true
