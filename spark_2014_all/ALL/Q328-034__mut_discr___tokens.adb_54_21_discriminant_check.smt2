...
(declare-fun o51 () token_kind)

(declare-fun o52 () Int)

(declare-fun o53 () instruction)

(declare-fun o54 () us_split_fields2)

(declare-fun o55 () us_split_discrs)

(declare-fun temp___244 () us_rep1)
...
;; WP_parameter_def
 ;; File "tokens.ads", line 14, characters 0-0
  (not
  (= (rec__tokens__token__kind (us_split_discrs1 temp___244)) (rec__tokens__token__kind
                                                              v__split_discrs))))
(check-sat)
(exit)
