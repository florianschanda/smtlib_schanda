...
;; H
  (assert
  (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= temp___299 bad1)))
...
;; H
  (assert
  (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1))
  (and (<= (to_rep1 a__first) j2) (<= j2 (to_rep1 a__last)))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= o4 (select a1 o3))))

;; H
  (assert
  (=> (and (<= (to_rep1 a__first) j1) (<= j1 i1)) (= o5 (to_rep o4))))
...
;; H
  (assert
  (=> (not (and (<= (to_rep1 a__first) j1) (<= j1 i1))) (= bad1 bad6)))
...
;; H
  (assert
  (=> (not (and (<= (to_rep1 a__first) j1) (<= j1 i1))) (= bad7 bad1)))
