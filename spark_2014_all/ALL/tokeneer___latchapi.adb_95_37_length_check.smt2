...
(declare-datatypes ((messagelengtht__ref 0))
...
(declare-datatypes ((messageindext__ref 0))
...
(declare-datatypes ((messaget__ref 0))
(((mk_messaget__ref (messaget__content us_rep)))))
...
;; def_axiom
  ...
  (= (select (temp___174 temp___176) temp___177) (of_rep temp___176)))))
...
;; def_axiom
  ...
  (= (select (temp___132 temp___134) temp___135) (of_rep temp___134)))))
...
;; temp___String_Literal_151__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 1)) 100)
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 2)) 111))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 3)) 111))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 4)) 114))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 5)) 46))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 6)) 117))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 7)) 110))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 8)) 108))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 9)) 111))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 10)) 99))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 11)) 107))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 12)) 40))
     (= (to_rep (select (temp___String_Literal_151 us_void_param) 13)) 41)) :pattern (
...
;; outmsg__def_axiom
  ...
  (= outmsg (mk___rep
            (mk___split_fields
            (let ((temp___152 (overwrite
                              (of_array
                              (rec__tcpip__messaget__data
                              (us_split_fields1 nullmsg)) 1 4096) 1
                              (of_array (temp___String_Literal_151 Tuple0) 1
                              13))))
            (slide (to_array temp___152) (first1 temp___152) 1))
            (of_rep2 13)))))
...
;; nullmsg__def_axiom
  (assert
  (= nullmsg (mk___rep (mk___split_fields (temp___132 0) (of_rep2 0)))))
...
;; H
  (assert
  (and (= inmsg__split_fields (temp___174 0))
...
;; H
  (assert
  (and
  (= temp___7482 (overwrite
                 (mk___t
                 (rec__tcpip__messaget__data (us_split_fields1 nullmsg))
                 (mk 1 4096)) 1
                 (mk___t (temp___String_Literal_151 Tuple0) (mk 1 13))))
  (dynamic_invariant1 temp___7482 true false true)))

(assert
;; WP_parameter_def
 ;; File "latchapi.adb", line 39, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___7481)) (to_rep1 (last temp___7481)))
     (+ (- (to_rep1 (last temp___7481)) (to_rep1 (first temp___7481))) 1) 0)
