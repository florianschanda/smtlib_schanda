...
;; temp___String_Literal_853__def_axiom
  ...
  (! (= (to_rep (select (temp___String_Literal_853 us_void_param) 1)) 58) :pattern (
...
;; temp___String_Literal_854__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (= (to_rep (select (temp___String_Literal_854 us_void_param) 1)) 58) :pattern (
...
;; temp___String_Literal_855__def_axiom
  ...
  (forall ((us_void_param tuple0))
  (! (and
     (= (to_rep (select (temp___String_Literal_855 us_void_param) 1)) 58)
     (= (to_rep (select (temp___String_Literal_855 us_void_param) 2)) 32)) :pattern (
