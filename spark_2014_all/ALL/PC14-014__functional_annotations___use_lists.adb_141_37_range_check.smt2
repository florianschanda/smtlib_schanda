...
(define-fun current__split_fields3 () us_split_fields2 (mk___split_fields1
...
;; H
  (assert
  (ite (= (ite (= (bool_eq1 (mk___rep1 n_last__split_fields4) no_element) false) (=
          (get1
          (positions
          (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  ...
  (= (bool_eq1 (mk___rep1 n_last__split_fields3) no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  (assert
  (not
  (= (bool_eq1 (mk___rep1 current__split_fields4)
     (mk___rep1 n_last__split_fields3)) true)))
...
;; H
  (assert
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) fst)
  (get1 (positions (mk___rep l__split_discrs l__split_fields2))
  (mk___rep1 current__split_fields3)))
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
      (mk___rep1 current__split_fields3)) (get1
                                          (positions
                                          (mk___rep l__split_discrs
                                          l__split_fields2)) lst))))
...
;; H
  ...
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) fst) i1)
  (<= i1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2))
            (mk___rep1 current__split_fields3)) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i1) 0))))
...
;; H
  ...
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
      (mk___rep1 current__split_fields3)) i1)
...
;; H
  (assert
  (not
  (= (bool_eq1 (mk___rep1 current__split_fields3)
     (mk___rep1 n_last__split_fields3)) true)))

;; H
  (assert
  (and (= o2 (positions (mk___rep l__split_discrs l__split_fields2)))
  (and (not (= (has_key o2 no_element) true))
  (forall ((i1 us_rep1))
  (=> (= (has_key o2 i1) true)
  (and
  (and (<= 1 (get1 o2 i1))
  (<= (get1 o2 i1) (length (mk___rep l__split_discrs l__split_fields2))))
  (forall ((j us_rep1))
  (=> (= (has_key o2 j) true)
...
;; H
  (assert
  (and (= o3 (get1 o2 (mk___rep1 current__split_fields3)))
  (and (in_range4 o3)
  (=> (= (of_int 0) true)
  (and (= o3 (w_get o2 (witness o2 (mk___rep1 current__split_fields3))))
  (forall ((k us_rep1))
  (=> (= (has_key o2 k) true)
  (= (= (bool_eq1 k (mk___rep1 current__split_fields3)) true)
  (= (witness o2 (mk___rep1 current__split_fields3)) (witness o2 k))))))))))
...
;; H
  ...
  (and
  (and (<= 1 (get1 o i1))
  (<= (get1 o i1) (length (mk___rep l__split_discrs l__split_fields2))))
  (forall ((j us_rep1))
  (=> (= (has_key o j) true)
...
;; H
  ...
  (and (in_range4 o1)
  (=> (= (of_int 0) true)
  (and (= o1 (w_get o (witness o fst)))
  (forall ((k us_rep1))
  (=> (= (has_key o k) true)
  (= (= (bool_eq1 k fst) true) (= (witness o fst) (witness o k))))))))))

;; H
  (assert (= o6 (ite (<= o1 i) true false)))

;; H
  (assert (= result2 (ite (= o6 true) o5 false)))
