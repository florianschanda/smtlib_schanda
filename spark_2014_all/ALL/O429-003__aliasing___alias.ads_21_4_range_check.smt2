...
(declare-datatypes ((tiS__ref 0)) (((mk_tiS__ref (tiS__content us_t)))))
(define-fun tiS__ref___projection ((a tiS__ref)) us_t (tiS__content a))

(define-fun dynamic_invariant1 ((temp___expr_156 us_t)
  ...
  (temp___do_toplevel_155 Bool)) Bool (=>
                                      ...
                                      (and (= (first1 temp___expr_156) 1)
                                      (= (last1 temp___expr_156) c)))))
...
;; H
  (assert
  (and (= h__attr__constrained false) (= h__split_discrs (of_int 1))))
...
(assert
;; WP_parameter_def
 ;; File "alias.ads", line 28, characters 0-0
  (not (<= 1 1)))
(check-sat)
(exit)
