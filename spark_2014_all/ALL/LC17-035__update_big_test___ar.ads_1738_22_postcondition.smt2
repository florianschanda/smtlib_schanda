...
;; def_axiom
  (assert
  (forall ((temp___3833 (Array Int us_rep)))
  (forall ((temp___3834 Int))
  (forall ((temp___3835 us_rep))
  (let ((temp___3832 (temp___3831 temp___3833 temp___3834 temp___3835)))
  (forall ((temp___3836 Int))
  (ite (= temp___3836 temp___3834)
  (= (select temp___3832 temp___3836) temp___3835)
  (= (select temp___3832 temp___3836) (select temp___3833 temp___3836)))))))))

(declare-fun temp___3838 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___3840 (Array Int (Array Int et1))))
  (forall ((temp___3841 Int))
  (forall ((temp___3842 (Array Int et1)))
  (let ((temp___3839 (temp___3838 temp___3840 temp___3841 temp___3842)))
  (forall ((temp___3843 Int))
  (ite (= temp___3843 temp___3841)
  (= (select temp___3839 temp___3843) temp___3842)
  (= (select temp___3839 temp___3843) (select temp___3840 temp___3843)))))))))

(declare-fun temp___3845 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3847 (Array Int et1)))
  (forall ((temp___3848 Int) (temp___3849 Int))
  (let ((temp___3846 (temp___3845 temp___3847 temp___3848 temp___3849)))
  (forall ((temp___3850 Int))
  (ite (= temp___3850 temp___3848)
  (= (select temp___3846 temp___3850) (of_rep temp___3849))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1733, characters 0-0
  (not
  (= (bool_eq7 a2 90 99
     (temp___3831 a i
     (mk___rep
     (mk___split_fields (rec__ar__rofa4__s4 (us_split_fields1 (select a i)))
     (temp___3838 (rec__ar__rofa4__t4 (us_split_fields1 (select a i))) 
     j
     (temp___3845
