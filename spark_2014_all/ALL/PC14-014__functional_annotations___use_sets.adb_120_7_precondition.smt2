...
;; element__post__dispatch_axiom
  ...
  (forall ((attr__tag Int))
  (forall ((container us_rep))
  (forall ((position us_rep3)) (! (dynamic_invariant4
...
;; keys_included_except__post_axiom
  ...
  (! (= (= (keys_included_except left right new_key) true)
     (forall ((key us_rep3))
     (=> (= (has_key left key) true)
     (=> (not (= (bool_eq10 key new_key) true)) (= (has_key right key) true))))) :pattern (
...
;; H
  ...
  (capacity (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 6)))

;; H
  (assert
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields10)) 1) true)
  (= (element (mk___rep s__split_discrs s__split_fields10)
     (find1 (mk___rep s__split_discrs s__split_fields10) 1)) 1))
  (ite (= (contains
          (model__
  ...
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields10))
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true)
  ...
  (= (equal_except
     ...
     (get1 (positions (mk___rep s__split_discrs s__split_fields10))
     (find1 (mk___rep s__split_discrs s__split_fields10) 1))) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields9)) 2) true)
  (= (element (mk___rep s__split_discrs s__split_fields9)
     (find1 (mk___rep s__split_discrs s__split_fields9) 2)) 2))
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields10)) 2) true)
  (and
  (and
  ...
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields10))
     ...
     (get1 (positions (mk___rep s__split_discrs s__split_fields9))
     (find1 (mk___rep s__split_discrs s__split_fields9) 2))) true))
  (and
  (and
  (and
  (and
  ...
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields9))
     (model__ (mk___rep s__split_discrs s__split_fields10)) 2) true))
  (= (mapping_preserved
     (elements (mk___rep s__split_discrs s__split_fields10))
     (elements (mk___rep s__split_discrs s__split_fields9))
     (positions (mk___rep s__split_discrs s__split_fields10))
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields8)) 3) true)
  (= (element (mk___rep s__split_discrs s__split_fields8)
     (find1 (mk___rep s__split_discrs s__split_fields8) 3)) 3))
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields9)) 3) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields8))
     (model__ (mk___rep s__split_discrs s__split_fields9))) true)
  ...
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields9))
     ...
     (find1 (mk___rep s__split_discrs s__split_fields8) 3))) true))
  (and
  (and
  (and
  (and
  ...
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields8))
     (model__ (mk___rep s__split_discrs s__split_fields9)) 3) true))
  (= (mapping_preserved
     (elements (mk___rep s__split_discrs s__split_fields9))
     (elements (mk___rep s__split_discrs s__split_fields8))
     (positions (mk___rep s__split_discrs s__split_fields9))
     (positions (mk___rep s__split_discrs s__split_fields8))) true))
  (= (keys_included_except
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields7)) 4) true)
  (= (element (mk___rep s__split_discrs s__split_fields7)
     (find1 (mk___rep s__split_discrs s__split_fields7) 4)) 4))
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields8)) 4) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields7))
     (model__ (mk___rep s__split_discrs s__split_fields8))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields7))
     (positions (mk___rep s__split_discrs s__split_fields8))) true))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields8))
     (elements (mk___rep s__split_discrs s__split_fields7))
     (get1 (positions (mk___rep s__split_discrs s__split_fields7))
     (find1 (mk___rep s__split_discrs s__split_fields7) 4))) true))
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields7)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields8)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields8))
     (model__ (mk___rep s__split_discrs s__split_fields7))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields7))
     (model__ (mk___rep s__split_discrs s__split_fields8)) 4) true))
  (= (mapping_preserved
     (elements (mk___rep s__split_discrs s__split_fields8))
     (elements (mk___rep s__split_discrs s__split_fields7))
     (positions (mk___rep s__split_discrs s__split_fields8))
     (positions (mk___rep s__split_discrs s__split_fields7))) true))
  (= (keys_included_except
     (positions (mk___rep s__split_discrs s__split_fields7))
     (positions (mk___rep s__split_discrs s__split_fields8))
     (find1 (mk___rep s__split_discrs s__split_fields7) 4)) true)))))
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields6)) 5) true)
  (= (element (mk___rep s__split_discrs s__split_fields6)
     (find1 (mk___rep s__split_discrs s__split_fields6) 5)) 5))
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields7)) 5) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields6))
     (model__ (mk___rep s__split_discrs s__split_fields7))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields6))
     (positions (mk___rep s__split_discrs s__split_fields7))) true))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields7))
     (elements (mk___rep s__split_discrs s__split_fields6))
     (get1 (positions (mk___rep s__split_discrs s__split_fields6))
     (find1 (mk___rep s__split_discrs s__split_fields6) 5))) true))
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields6)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields7)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields7))
     (model__ (mk___rep s__split_discrs s__split_fields6))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields6))
     (model__ (mk___rep s__split_discrs s__split_fields7)) 5) true))
  (= (mapping_preserved
     (elements (mk___rep s__split_discrs s__split_fields7))
     (elements (mk___rep s__split_discrs s__split_fields6))
     (positions (mk___rep s__split_discrs s__split_fields7))
     (positions (mk___rep s__split_discrs s__split_fields6))) true))
  (= (keys_included_except
     (positions (mk___rep s__split_discrs s__split_fields6))
     (positions (mk___rep s__split_discrs s__split_fields7))
     (find1 (mk___rep s__split_discrs s__split_fields6) 5)) true)))))

(assert
;; WP_parameter_def
 ;; File "use_sets.ads", line 60, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields6)) (to_rep1
                                                          (rec__use_sets__my_sets__set__capacity
                                                          s__split_discrs)))
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields6)) 6) true))))
(check-sat)
