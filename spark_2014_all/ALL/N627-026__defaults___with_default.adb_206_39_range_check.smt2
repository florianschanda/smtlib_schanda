...
(declare-fun with_default__bad_nested_defaults1__empty_rec__d__first__bit () Int)

(declare-fun with_default__bad_nested_defaults1__empty_rec__d__last__bit () Int)

(declare-fun with_default__bad_nested_defaults1__empty_rec__d__position () Int)
...
(define-fun empty_rec__ref___projection ((a empty_rec__ref)) us_rep (empty_rec__content
                                                                    a))
...
(define-fun us_split_fields_E__projection ((a us_split_fields)) us_rep 
...
(declare-fun with_default__bad_nested_defaults1__non_init__e__first__bit () Int)

(declare-fun with_default__bad_nested_defaults1__non_init__e__last__bit () Int)

(declare-fun with_default__bad_nested_defaults1__non_init__e__position () Int)
...
(declare-fun with_default__bad_nested_defaults1__non_init__f__first__bit () Int)

(declare-fun with_default__bad_nested_defaults1__non_init__f__last__bit () Int)

(declare-fun with_default__bad_nested_defaults1__non_init__f__position () Int)
...
(define-fun non_init__ref___projection ((a non_init__ref)) us_rep1 (non_init__content
                                                                   a))

(define-fun dynamic_invariant1 ((temp___expr_516 us_rep1)
  (temp___is_init_513 Bool) (temp___skip_constant_514 Bool)
  (temp___do_toplevel_515 Bool)) Bool (= (attr__constrained
                                         (rec__with_default__bad_nested_defaults1__non_init__e
                                         (us_split_fields1 temp___expr_516))) false))
...
(define-fun default_initial_assumption1 ((temp___expr_510 us_rep)
  (temp___skip_top_level_511 Bool)) Bool (and
                                         (= (attr__constrained
                                            temp___expr_510) false)
                                         (= (to_rep1
                                            (rec__with_default__bad_nested_defaults1__empty_rec__d
                                            (us_split_discrs1
                                            temp___expr_510))) c)))
