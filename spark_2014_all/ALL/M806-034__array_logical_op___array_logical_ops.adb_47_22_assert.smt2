...
;; H
  (assert
  (= (mk___t
     (andb (elts z) (to_rep1 (first (rt z))) (to_rep1 (last (rt z)))
     (elts w) (to_rep1 (first (rt w))) (to_rep1 (last (rt w))))
     (mk (to_rep1 (first (rt z))) (to_rep1 (last (rt z))))) r4))
...
;; WP_parameter_def
 ;; File "array_logical_ops.adb", line 29, characters 0-0
  (not (= (of_int (to_rep (select (elts r4) i))) true)))
(check-sat)
(exit)
