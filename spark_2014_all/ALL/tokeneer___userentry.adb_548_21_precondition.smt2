...
;; range_axiom
  (assert
  (forall ((x fart)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(declare-fun dummy5 () matchresultt)
...
;; range_axiom
  (assert
  (forall ((x bytet)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun bool_eq8 ((a (Array Int bytet)) (a__first Int) (a__last Int)
...
(declare-fun dummy7 () (Array Int bytet))
...
(declare-fun dummy8 () templatelengtht)
...
;; range_axiom
  (assert
  (forall ((x templatelengtht)) (! (in_range6
...
(declare-fun dummy11 () descriptioni)
...
(declare-fun achievedfardescription__function_guard ((Array Int character)
  Int) Bool)

;; achievedfardescription__post_axiom
  (assert true)
...
(declare-fun thetemplate__split_fields () templatelengtht)

(declare-fun thetemplate__split_fields1 () fart)

(declare-fun thetemplate__split_fields2 () (Array Int character))

(declare-fun thetemplate__split_fields3 () (Array Int bytet))

(declare-fun matchresult () Int)
...
(declare-fun result1 () templatelengtht)

(declare-fun result2 () fart)

(declare-fun result3 () (Array Int character))

(declare-fun result4 () (Array Int bytet))

(declare-fun thetemplate__split_fields4 () templatelengtht)

(declare-fun thetemplate__split_fields5 () fart)

(declare-fun thetemplate__split_fields6 () (Array Int character))

(declare-fun thetemplate__split_fields7 () (Array Int bytet))
...
(declare-fun maxfar2 () Int)

(declare-fun state2 () us_private)

(declare-fun matchresult1 () Int)
...
;; H
  (assert
  (=> (< (to_rep2 thetemplate__split_fields5) maxfar1) (= result6 maxfar1)))

;; H
  (assert
  (=> (< (to_rep2 thetemplate__split_fields5) maxfar1)
  (= maxfar2 (to_rep2 thetemplate__split_fields5))))

;; H
  (assert
  (=> (not (< (to_rep2 thetemplate__split_fields5) maxfar1))
  (= maxfar2 maxfar1)))
