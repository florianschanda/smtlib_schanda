...
(declare-const temp___396 index)

(declare-const temp___3961 (Array Int value))

(declare-const temp___3962 (Array Int value))
...
(declare-const temp___399 index)

(declare-const temp___3991 (Array Int value))

(declare-const temp___3992 (Array Int value))
...
;; H
  (assert (= (to_rep o) (to_rep (select a__split_fields2 j))))
...
;; H
  (assert (= temp___396 o2))

;; H
  (assert (= temp___3961 o3))

;; H
  (assert (= temp___3962 o4))
...
;; H
  (assert (= temp___396 a__split_fields3))

;; H
  (assert (= temp___3961 a__split_fields4))

;; H
  (assert (= temp___3962 a__split_fields5))

;; H
  (assert (= (to_rep o5) tmp1))

;; H
  (assert (= o6 (store a__split_fields5 j o5)))

;; H
  (assert (= a__split_fields3 o7))

;; H
  (assert (= a__split_fields4 o8))

;; H
  (assert (= o6 o9))

;; H
  (assert (= temp___399 o7))

;; H
  (assert (= temp___3991 o8))

;; H
  (assert (= temp___3992 o9))
...
;; H
  (assert (= temp___399 a__split_fields6))

;; H
  (assert (= temp___3991 a__split_fields7))

;; H
  (assert (= temp___3992 a__split_fields8))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 265, characters 0-0
  (not
  (not
  (= (bool_eq1
     (mk___rep
