...
;; H
  (assert
  (and (= o9 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1
  o9 true false true)))
...
;; H
  (assert
  (=> (= result4 true) (= temp___472 (mk___t2 o7 (mk2 first2 temp___470)))))
...
;; H
  (assert
  (=> (= result4 true) (= temp___471 (mk___t1 o8 (mk1 first2 temp___469)))))
