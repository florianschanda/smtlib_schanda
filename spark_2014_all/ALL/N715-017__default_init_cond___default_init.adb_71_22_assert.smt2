...
(define-fun us_split_fields_F4__projection ((a us_split_fields)) natural
...
(declare-fun default_init__discr__b__first__bit () Int)

(declare-fun default_init__discr__b__last__bit () Int)

(declare-fun default_init__discr__b__position () Int)
...
(declare-fun default_init__discr__f__first__bit () Int)

(declare-fun default_init__discr__f__last__bit () Int)

(declare-fun default_init__discr__f__position () Int)
...
(declare-datatypes ()
((us_split_discrs2
 (mk___split_discrs1 (rec__default_init__mut_discr__b Bool)))))
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__default_init__mut_discr__f natural)))))
(define-fun us_split_fields_F5__projection ((a us_split_fields2)) natural
...
((us_rep1
 (mk___rep1
 (us_split_discrs3 us_split_discrs2)(us_split_fields3 us_split_fields2)(attr__constrained Bool)))))
(define-fun us_rep_6__projection ((a us_rep1)) us_split_discrs2 (us_split_discrs3
                                                                a))
...
(define-fun default_init__mut_discr__f__pred ((a us_rep1)) Bool (= (to_int1
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (and
                         (= (rec__default_init__mut_discr__b
                            (us_split_discrs3 a)) (rec__default_init__mut_discr__b
                                                  (us_split_discrs3 b)))
...
(declare-fun default_init__mut_discr__b__first__bit () Int)

(declare-fun default_init__mut_discr__b__last__bit () Int)

(declare-fun default_init__mut_discr__b__position () Int)
...
(declare-fun default_init__mut_discr__f__first__bit () Int)

(declare-fun default_init__mut_discr__f__last__bit () Int)

(declare-fun default_init__mut_discr__f__position () Int)
...
(declare-datatypes ()
((mut_discr__ref (mk_mut_discr__ref (mut_discr__content us_rep1)))))
(define-fun mut_discr__ref___projection ((a mut_discr__ref)) us_rep1
...
(declare-fun default_init__discr__b__first__bit1 () Int)

(declare-fun default_init__discr__b__last__bit1 () Int)

(declare-fun default_init__discr__b__position1 () Int)
...
(declare-fun default_init__discr__f__first__bit1 () Int)

(declare-fun default_init__discr__f__last__bit1 () Int)

(declare-fun default_init__discr__f__position1 () Int)
...
(define-fun dynamic_invariant1 ((temp___expr_235 us_rep)
  (temp___is_init_232 Bool) (temp___skip_constant_233 Bool)
  (temp___do_toplevel_234 Bool)) Bool (=>
                                      (not (= temp___skip_constant_233 true))
                                      (in_range2 (of_int 1) temp___expr_235)))

(define-fun default_initial_assumption1 ((temp___expr_237 us_rep)
  (temp___skip_top_level_238 Bool)) Bool (and
                                         (and
                                         (= (rec__default_init__discr__b
                                            (us_split_discrs1
                                            temp___expr_237)) (of_int 1))
                                         ...
                                         (= (discr_ok temp___expr_237) true))))

(declare-fun d1__split_discrs () us_split_discrs)
...
(declare-fun default_init__discr__b__first__bit2 () Int)

(declare-fun default_init__discr__b__last__bit2 () Int)

(declare-fun default_init__discr__b__position2 () Int)
...
(declare-fun default_init__discr__f__first__bit2 () Int)

(declare-fun default_init__discr__f__last__bit2 () Int)

(declare-fun default_init__discr__f__position2 () Int)
...
(define-fun dynamic_invariant2 ((temp___expr_244 us_rep)
  ...
  (temp___do_toplevel_243 Bool)) Bool (=>
                                      ...
                                      (in_range3 (of_int 0) temp___expr_244)))

(define-fun default_initial_assumption2 ((temp___expr_246 us_rep)
  (temp___skip_top_level_247 Bool)) Bool (and
                                         (and
                                         (= (rec__default_init__discr__b
                                            (us_split_discrs1
                                            temp___expr_246)) (of_int 0))
                                         (=> (default_init__discr__f__pred
                                         temp___expr_246)
                                         (= (to_rep
                                            (rec__default_init__discr__f
                                         ...
                                         (= (discr_ok temp___expr_246) true))))

(declare-fun d2__split_discrs () us_split_discrs)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun d3__attr__constrained () Bool)
...
(declare-fun default_init__mut_discr__b__first__bit1 () Int)

(declare-fun default_init__mut_discr__b__last__bit1 () Int)

(declare-fun default_init__mut_discr__b__position1 () Int)
...
(declare-fun default_init__mut_discr__f__first__bit1 () Int)

(declare-fun default_init__mut_discr__f__last__bit1 () Int)

(declare-fun default_init__mut_discr__f__position1 () Int)
...
(define-fun default_initial_assumption3 ((temp___expr_255 us_rep1)
  (temp___skip_top_level_256 Bool)) Bool (and
                                         ...
                                         (= (to_rep
                                            (rec__default_init__mut_discr__f
                                            (us_split_fields3
                                            temp___expr_255))) (init 0)))))
                                         (=>
                                         (not
                                         (= temp___skip_top_level_256 true))
                                         (= (mut_discr_ok temp___expr_255) true))))

(declare-fun d4__split_discrs () us_split_discrs2)

(declare-fun d4__attr__constrained () Bool)
...
(declare-fun default_init__mut_discr__b__first__bit2 () Int)

(declare-fun default_init__mut_discr__b__last__bit2 () Int)

(declare-fun default_init__mut_discr__b__position2 () Int)
...
(declare-fun default_init__mut_discr__f__first__bit2 () Int)

(declare-fun default_init__mut_discr__f__last__bit2 () Int)

(declare-fun default_init__mut_discr__f__position2 () Int)
...
(define-fun dynamic_invariant4 ((temp___expr_262 us_rep1)
  ...
  (temp___do_toplevel_261 Bool)) Bool (and
                                      ...
                                      (in_range5 (of_int 1) temp___expr_262))
                                      (= (attr__constrained temp___expr_262) true)))

(define-fun default_initial_assumption4 ((temp___expr_264 us_rep1)
  (temp___skip_top_level_265 Bool)) Bool (and
                                         ...
                                         (= (to_rep
                                            (rec__default_init__mut_discr__f
                                            (us_split_fields3
                                            temp___expr_264))) (init 0)))))
                                         (=>
                                         (not
                                         (= temp___skip_top_level_265 true))
                                         (= (mut_discr_ok temp___expr_264) true))))

(declare-fun d5__split_discrs () us_split_discrs2)

(declare-fun d5__attr__constrained () Bool)
...
(declare-fun d1__split_fields () natural)

(declare-fun d2__split_fields () natural)

(declare-fun d3__split_fields () natural)

(declare-fun d3__split_discrs () Bool)

(declare-fun d4__split_fields () natural)

(declare-fun d5__split_fields () natural)

;; H
  (assert (default_initial_assumption1
  (mk___rep d1__split_discrs (mk___split_fields d1__split_fields)) false))
...
;; H
  ...
  (mk___rep d2__split_discrs (mk___split_fields d2__split_fields)) false))

;; H
  (assert (= (of_int 0) (rec__default_init__discr__b d2__split_discrs)))

;; H
  (assert (default_initial_assumption
  (mk___rep1 (mk___split_discrs1 d3__split_discrs)
  (mk___split_fields1 d3__split_fields) d3__attr__constrained) false))

;; H
  (assert (default_initial_assumption3
  (mk___rep1 d4__split_discrs (mk___split_fields1 d4__split_fields)
  d4__attr__constrained) false))

;; H
  (assert
  (and (= (of_int 0) (rec__default_init__mut_discr__b d4__split_discrs))
  (= d4__attr__constrained true)))

;; H
  (assert (default_initial_assumption4
  (mk___rep1 d5__split_discrs (mk___split_fields1 d5__split_fields)
  d5__attr__constrained) false))

;; H
  (assert
  (and (= (of_int 1) (rec__default_init__mut_discr__b d5__split_discrs))
  (= d5__attr__constrained true)))
