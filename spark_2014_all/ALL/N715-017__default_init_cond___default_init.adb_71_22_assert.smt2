...
(((mk___split_discrs (rec__default_init__discr__b Bool)))))
...
(((mk___split_fields (rec__default_init__discr__f natural)))))
...
(((mk_discr__ref (discr__content us_rep)))))
...
(((mk_mut_discr__ref (mut_discr__content us_rep1)))))
...
(((mk_td4S__ref (td4S__content us_rep1)))))
...
(((mk_td5S__ref (td5S__content us_rep1)))))
