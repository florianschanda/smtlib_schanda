...
(declare-fun temp___407 () (_ BitVec 16))

(declare-fun temp___406 () (_ BitVec 16))
...
;; H
  (assert
  (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 16) 0))))
  (= temp___405 result__1)))

;; H
  (assert
  (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 16) 0))))
  (and
  (and (=> (<= 0 15) (in_range1 result__2))
  (=> (<= 0 15) (in_range1 shift_amount2)))
