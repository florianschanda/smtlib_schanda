...
;; H
  (assert
  (and (= o13 (rate_of (mk___rep ctx__split_fields35)))
  (and (in_range3 o13)
  (and (= o13 (* (to_rep6 ctx__split_fields10) 8)) (< o13 1600)))))

;; H
  (assert
  (and (= o14 (in_queue_bit_length (mk___rep ctx__split_fields35)))
  (and (in_range2 o14)
  (and (= o14 (to_rep5 ctx__split_fields8)) (< o14 1600)))))
