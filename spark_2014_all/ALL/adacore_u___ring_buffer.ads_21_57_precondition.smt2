...
;; H
  (assert (and (= o5 (length s2)) (and (in_range4 o5) (<= (+ 0 o5) 100))))

;; H
  (assert (= o6 (- o5 1)))

;; H
  (assert (and (= o7 (length s1)) (and (in_range4 o7) (<= (+ 0 o7) 100))))

;; H
  (assert (= result1 (ite (= o7 o6) true false)))

;; H
  (assert (=> (= result1 true) (and (= o4 (get s2 1)) (in_range5 o4))))

;; H
  (assert (=> (= result1 true) (= result (ite (= o4 e) true false))))
