...
;; H
  (assert
  (and
  (= o2 (symmetric_difference__2 (mk___rep k__split_discrs k__split_fields3)
        (mk___rep l__split_discrs l__split_fields11)))
  (and
  (and
  (and
  ...
  (and
  (and
  (= (length o2) (+ (- (length (mk___rep k__split_discrs k__split_fields3)) (* 2
  (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3))
  (model__ (mk___rep l__split_discrs l__split_fields11))))) (length
                                                            (mk___rep
                                                            l__split_discrs
                                                            l__split_fields11))))
  (= (not_in_both (model__ o2)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ o2) (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union
     (model__ (mk___rep l__split_discrs l__split_fields11)) (model__ o2)
     (model__ (mk___rep k__split_discrs k__split_fields3))) true))
  (= (e_elements_included__3 (elements o2)
     ...
     (elements (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included__2
     (elements (mk___rep k__split_discrs k__split_fields3)) (model__ o2)
     (elements o2)) true))
  (= (e_elements_included__2
     (elements (mk___rep l__split_discrs l__split_fields11)) (model__ o2)
     (elements o2)) true))))
