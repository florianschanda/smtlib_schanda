...
(declare-fun o26 () us_split_discrs)
...
;; H
  (assert
  (and (= o23 (increment o22))
  (and (in_range2 o23)
  (= o23 (ite (= (rec__dynamic_array__rec__b (us_split_discrs1 o22)) true)
         (ite (< (to_rep1
                 (rec__dynamic_array__rec__f1 (us_split_fields1 o22)))
         c)
         (+ (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o22))) 1)
         (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 o22))))
         (ite (< (to_rep1
                 (rec__dynamic_array__rec__f2 (us_split_fields1 o22)))
         c)
         (+ (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o22))) 1)
         (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 o22)))))))))
