...
;; H
  (assert
  (=> (<= (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b))))
  (and
  (and (<= 1 (to_rep1 (first (rt c8b)))) (<= (to_rep1 (first (rt c8b))) 100))
  (and (<= 1 (to_rep1 (last (rt c8b)))) (<= (to_rep1 (last (rt c8b))) 100)))))
...
;; H
  (assert
  (= (mk1 (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))) temp___2301))

(assert
;; WP_parameter_def
 ;; File "main.adb", line 4, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___2271)) (to_rep1 (last2 temp___2271)))
     (+ (- (to_rep1 (last2 temp___2271)) (to_rep1 (first2 temp___2271))) 1)
     0) (ite (<= (to_rep1 (first2 temp___2301)) (to_rep1 (last2 temp___2301)))
        (+ (- (to_rep1 (last2 temp___2301)) (to_rep1 (first2 temp___2301))) 1)
        0))))
(check-sat)
(exit)
