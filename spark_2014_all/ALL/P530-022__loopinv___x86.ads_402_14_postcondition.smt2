...
(declare-fun x86__si__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__si__result1 () (_ BitVec 16))

(declare-fun x86__si__result2 () (_ BitVec 16))

(declare-fun x86__si__result3 () (_ BitVec 16))

(declare-fun x86__si__result4 () (_ BitVec 16))

(declare-fun x86__si__result5 () (_ BitVec 16))
...
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not (= x86__si__result4 (readreg16 rsi))))
(check-sat)
(exit)
