...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f root) j13))) true))
  (= (olt
     (rec__tree_model__path_type__a
  ...
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f root) j13)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f root) k)))) 1)) 0)
  (< (to_rep (select values j13)) (to_rep (select values k)))
  (< (to_rep (select values k)) (to_rep (select values j13)))))))))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1293 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (and (<= 1 j3) (<= j3 100)) (= o8 (select temp___1293 i2)))))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1294 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1296 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1295 j13))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= j6 j4))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= j7 j5))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= j8 j6))))
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 12, characters 0-0
  (not (< (to_rep (select values j13)) (to_rep (select values k)))))
(check-sat)
