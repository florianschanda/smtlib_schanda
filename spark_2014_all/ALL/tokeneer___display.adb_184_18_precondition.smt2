...
(declare-const temp___1006 us_rep2)

(declare-const temp___1009 us_rep1)
...
(declare-const o88 scrolltextcount)

(declare-const o89 us_split_fields4)

(declare-const temp___1013 us_rep2)
...
(declare-const result____split_fields18 us_split_fields__ref2)

(declare-const i12 int__ref)

(declare-const result____split_fields19 us_split_fields4)
...
(declare-const c28b__split_fields2 us_split_fields4)
