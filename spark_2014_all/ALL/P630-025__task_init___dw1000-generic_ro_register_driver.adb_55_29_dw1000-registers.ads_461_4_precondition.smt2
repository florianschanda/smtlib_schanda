...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__tc_sarw_type__sar_wvbat bits_8)(rec__dw1000__register_types__tc_sarw_type__sar_wtemp bits_8)))))
(define-fun us_split_fields_SAR_WVBAT__projection ((a us_split_fields)) bits_8
  (rec__dw1000__register_types__tc_sarw_type__sar_wvbat a))

(define-fun us_split_fields_SAR_WTEMP__projection ((a us_split_fields)) bits_8
  (rec__dw1000__register_types__tc_sarw_type__sar_wtemp a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___61__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep1
                           (rec__dw1000__register_types__tc_sarw_type__sar_wvbat
                           (us_split_fields1 a))) (to_rep1
                                                  (rec__dw1000__register_types__tc_sarw_type__sar_wvbat
                                                  (us_split_fields1 b))))
                        (= (to_rep1
                           (rec__dw1000__register_types__tc_sarw_type__sar_wtemp
                           (us_split_fields1 a))) (to_rep1
                                                  (rec__dw1000__register_types__tc_sarw_type__sar_wtemp
                                                  (us_split_fields1 b)))))
                   true false))
...
;; dw1000__register_types__tc_sarw_type__sar_wvbat__first__bit_axiom
  (assert (<= 0 dw1000__register_types__tc_sarw_type__sar_wvbat__first__bit))

;; dw1000__register_types__tc_sarw_type__sar_wvbat__last__bit_axiom
  (assert
  (< dw1000__register_types__tc_sarw_type__sar_wvbat__first__bit dw1000__register_types__tc_sarw_type__sar_wvbat__last__bit))

;; dw1000__register_types__tc_sarw_type__sar_wvbat__position_axiom
...
;; dw1000__register_types__tc_sarw_type__sar_wtemp__first__bit_axiom
  (assert (<= 0 dw1000__register_types__tc_sarw_type__sar_wtemp__first__bit))

;; dw1000__register_types__tc_sarw_type__sar_wtemp__last__bit_axiom
  (assert
  (< dw1000__register_types__tc_sarw_type__sar_wtemp__first__bit dw1000__register_types__tc_sarw_type__sar_wtemp__last__bit))

;; dw1000__register_types__tc_sarw_type__sar_wtemp__position_axiom
...
(declare-datatypes ()
((tc_sarw_type__ref (mk_tc_sarw_type__ref (tc_sarw_type__content us_rep)))))
(define-fun tc_sarw_type__ref___projection ((a tc_sarw_type__ref)) us_rep
  (tc_sarw_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___142__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___101__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___101__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5508 us_t1)
  (temp___is_init_5505 Bool) (temp___skip_constant_5506 Bool)
  (temp___do_toplevel_5507 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5506 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5508)
                                       (last3 temp___expr_5508))
                                       (and (= (first3 temp___expr_5508) 1)
                                       (= (last3 temp___expr_5508) 2)))))
