...
(declare-const max (_ BitVec 32))

(declare-const attr__ATTRIBUTE_ADDRESS1 Int)

(declare-const min (_ BitVec 32))
...
(declare-const saturation_dynamic_out12 (_ BitVec 32))

(declare-const result2 (_ BitVec 32))

(declare-const saturation_dynamic_out13 (_ BitVec 32))

(declare-const result3 (_ BitVec 32))

(declare-const saturated_value1 (_ BitVec 32))
