...
(((mk_map__ref2 (map__content2 (Array Int (Array Int group2_id)))))))
...
(((mk_map__ref3 (map__content3 (Array Int (Array Int group1_id)))))))
...
(((mk_map__ref4 (map__content4 (Array Int ranking))))))
...
(((mk_map__ref5 (map__content5 (Array Int Bool))))))
...
(((mk_map__ref6 (map__content6 (Array Int (Array Int ranking)))))))
...
(((mk_map__ref7 (map__content7 (Array Int count))))))
...
(((mk_group1_set__ref (group1_set__content us_rep)))))
