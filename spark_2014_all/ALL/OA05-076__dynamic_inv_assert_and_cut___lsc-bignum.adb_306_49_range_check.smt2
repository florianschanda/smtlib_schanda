...
;; H
  (assert (and (= o32 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o33 (ite (<= k o32) true false)))

;; H
  (assert (and (= o31 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o34 (ite (<= o31 k) true false)))

;; H
  (assert (= result3 (ite (= o34 true) o33 false)))
...
;; H
  (assert (= o27 (from_word32 carry22)))
...
;; H
  (assert (= o25 (from_word32 carry12)))
