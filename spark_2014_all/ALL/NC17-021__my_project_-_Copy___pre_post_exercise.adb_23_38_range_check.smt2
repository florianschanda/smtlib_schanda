...
(declare-fun dummy2 () stack_range)

(declare-datatypes ()
((stack_range__ref (mk_stack_range__ref (stack_range__content stack_range)))))
(define-fun stack_range__ref___projection ((a stack_range__ref)) stack_range
...
(declare-fun stack () (Array Int integer))

(declare-fun stack_pointer () Int)
...
;; H
  (assert (in_range1 stack_pointer))

;; H
  (assert (=> (<= (- 2147483648) 2147483647) (in_range x)))

;; H
  (assert (and (<= 1 stack_pointer) (<= stack_pointer 100)))

;; H
  (assert (= o stack_pointer))

;; H
  (assert (= o1 (select stack o)))
...
(assert
;; WP_parameter_def
 ;; File "pre_post_exercise.adb", line 14, characters 0-0
