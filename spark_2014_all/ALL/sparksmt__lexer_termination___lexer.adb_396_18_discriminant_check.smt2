...
(declare-fun dummy7 () valued_tokens)
...
(declare-fun lexer__token__kind__first__bit3 () Int)

(declare-fun lexer__token__kind__last__bit3 () Int)

(declare-fun lexer__token__kind__position3 () Int)
...
(declare-fun lexer__token__line__first__bit3 () Int)

(declare-fun lexer__token__line__last__bit3 () Int)

(declare-fun lexer__token__line__position3 () Int)
...
(declare-fun lexer__token__col__first__bit3 () Int)

(declare-fun lexer__token__col__last__bit3 () Int)

(declare-fun lexer__token__col__position3 () Int)
...
(declare-fun lexer__token__length__first__bit3 () Int)

(declare-fun lexer__token__length__last__bit3 () Int)

(declare-fun lexer__token__length__position3 () Int)
...
(declare-fun lexer__token__value__first__bit3 () Int)

(declare-fun lexer__token__value__last__bit3 () Int)

(declare-fun lexer__token__value__position3 () Int)
...
(declare-fun lexer__token__kind__first__bit4 () Int)

(declare-fun lexer__token__kind__last__bit4 () Int)

(declare-fun lexer__token__kind__position4 () Int)
...
(declare-fun lexer__token__line__first__bit4 () Int)

(declare-fun lexer__token__line__last__bit4 () Int)

(declare-fun lexer__token__line__position4 () Int)
...
(declare-fun lexer__token__col__first__bit4 () Int)

(declare-fun lexer__token__col__last__bit4 () Int)

(declare-fun lexer__token__col__position4 () Int)
...
(declare-fun lexer__token__length__first__bit4 () Int)

(declare-fun lexer__token__length__last__bit4 () Int)

(declare-fun lexer__token__length__position4 () Int)
...
(declare-fun lexer__token__value__first__bit4 () Int)

(declare-fun lexer__token__value__last__bit4 () Int)

(declare-fun lexer__token__value__position4 () Int)
...
(declare-fun lexer__token__kind__first__bit5 () Int)

(declare-fun lexer__token__kind__last__bit5 () Int)

(declare-fun lexer__token__kind__position5 () Int)
...
(declare-fun lexer__token__line__first__bit5 () Int)

(declare-fun lexer__token__line__last__bit5 () Int)

(declare-fun lexer__token__line__position5 () Int)
...
(declare-fun lexer__token__col__first__bit5 () Int)

(declare-fun lexer__token__col__last__bit5 () Int)

(declare-fun lexer__token__col__position5 () Int)
...
(declare-fun lexer__token__length__first__bit5 () Int)

(declare-fun lexer__token__length__last__bit5 () Int)

(declare-fun lexer__token__length__position5 () Int)
...
(declare-fun lexer__token__value__first__bit5 () Int)

(declare-fun lexer__token__value__last__bit5 () Int)

(declare-fun lexer__token__value__position5 () Int)
...
(declare-fun lexer__token__kind__first__bit6 () Int)

(declare-fun lexer__token__kind__last__bit6 () Int)

(declare-fun lexer__token__kind__position6 () Int)
...
(declare-fun lexer__token__line__first__bit6 () Int)

(declare-fun lexer__token__line__last__bit6 () Int)

(declare-fun lexer__token__line__position6 () Int)
...
(declare-fun lexer__token__col__first__bit6 () Int)

(declare-fun lexer__token__col__last__bit6 () Int)

(declare-fun lexer__token__col__position6 () Int)
...
(declare-fun lexer__token__length__first__bit6 () Int)

(declare-fun lexer__token__length__last__bit6 () Int)

(declare-fun lexer__token__length__position6 () Int)
...
(declare-fun lexer__token__value__first__bit6 () Int)

(declare-fun lexer__token__value__last__bit6 () Int)

(declare-fun lexer__token__value__position6 () Int)
...
(declare-fun first_idx () Int)

(declare-fun n () Int)

(declare-fun o () Int)

(declare-fun lexer__read_token__new_token__2__t_length__assume () Int)

(declare-fun o1 () token_kind)

(declare-fun o2 () name_id)
...
(declare-fun o7 () us_split_discrs)

(declare-fun temp___910 () us_rep)
...
;; H
  (assert
  (and (= o (- current_idx first_idx)) (in_range1 (- current_idx first_idx))))
...
;; H
  (assert (= (to_rep4 t__split_discrs) r43b))

;; H
  (assert (in_range6 r43b))
...
;; H
  (assert (= temp___910 (mk___rep o7 o6 true)))
...
;; WP_parameter_def
 ;; File "lexer.ads", line 79, characters 0-0
  (not
  (= (rec__lexer__token__kind (us_split_discrs1 temp___910)) t__split_discrs)))
(check-sat)
(exit)
