...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o7) true false)))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o6 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
        1))
  (in_range6 o6))))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result (ite (= o6 first_available) true false))))))
