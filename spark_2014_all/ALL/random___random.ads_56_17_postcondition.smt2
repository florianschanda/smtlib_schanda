...
(declare-fun g__split_fields10 () (Array Int unsigned_32))

(declare-fun g__split_fields11 () state_range)

(declare-fun x5 () (_ BitVec 32))

(declare-fun g__split_fields12 () us_split_fields)
...
(declare-fun g__split_fields13 () us_split_fields__ref)
...
(declare-fun g__split_fields15 () us_split_fields__ref)

(declare-fun value2 () int__ref)

(declare-fun x10 () t__ref)
...
(define-fun g__split_fields17 () us_split_fields__ref (mk___split_fields__ref
                                                      (mk___split_fields
                                                      g__split_fields10
                                                      g__split_fields11)))

(define-fun g__split_fields18 () us_split_fields (mk___split_fields
                                                 g__split_fields8
                                                 g__split_fields9))

(define-fun g__split_fields19 () us_split_fields (mk___split_fields
                                                 g__split_fields2
                                                 g__split_fields3))
...
;; H
  (assert
  (=> (and (= min (- 2147483648)) (= max 2147483647)) (= x8 (mk_t__ref x1))))

;; H
  (assert
  (=> (and (= min (- 2147483648)) (= max 2147483647))
  (= g__split_fields13 (mk___split_fields__ref g__split_fields19))))
...
;; H
  (assert
  (=> (and (= min (- 2147483648)) (= max 2147483647))
  (= g__split_fields14 g__split_fields19)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (and (= o (+ (- max min) 1)) (uint_in_range (+ (- max min) 1)))))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (= random__random_integer__B_4__n__assume ((_ int2bv 32) o))))
...
;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= temp___328 x)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (or (= slop n) (bvule x2 (bvsub ((_ int2bv 32) 4294967295) slop)))))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x2 x3)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (= g__split_fields6 g__split_fields4)))
...
;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x4 x2)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (= g__split_fields18 (mk___split_fields g__split_fields4 g__split_fields5))))
...
;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (= g__split_fields17 (mk___split_fields__ref
                       (mk___split_fields g__split_fields6 g__split_fields7)))))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x6 x4)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (= g__split_fields12 g__split_fields18)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= result x12)))
...
;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (and (bvule ((_ int2bv 32) 0) x7) (bvule x7 (bvsub n ((_ int2bv 32) 1))))))
...
;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (= g__split_fields13 g__split_fields17)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647))) (= x9 x7)))

;; H
  (assert
  (=> (not (and (= min (- 2147483648)) (= max 2147483647)))
  (= g__split_fields14 g__split_fields12)))

;; H
  (assert
  (and (= o1 (+ min (bv2nat (t__content x8)))) (in_range1
  (+ min (bv2nat (t__content x8))))))
