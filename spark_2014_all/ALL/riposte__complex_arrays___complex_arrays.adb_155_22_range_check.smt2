...
(((mk_tcounterB__ref (tcounterB__content tcounterB)))))
...
(((mk_t24b__ref (t24b__content tcounterB)))))
...
(((mk_t29b__ref (t29b__content tcounterB)))))
...
;; H
  ...
  (=> (< j2 temp___243)
  (= (select tmp3 temp___243) (select tmp1 temp___243)))))
  (=> (<= 0 i) (dynamic_property 0 i j2))) (and (<= 0 j2) (<= j2 i))))
