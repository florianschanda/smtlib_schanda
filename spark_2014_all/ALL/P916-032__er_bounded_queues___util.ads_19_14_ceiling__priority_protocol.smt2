...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__util__p__flag Bool)))))
...
(declare-fun util__p__flag__first__bit () Int)

(declare-fun util__p__flag__last__bit () Int)

(declare-fun util__p__flag__position () Int)
