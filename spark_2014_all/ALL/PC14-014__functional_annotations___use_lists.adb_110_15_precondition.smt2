...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 n2))
  (and
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (* 2 i1))
  (get
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2))
     (- (* 2 i1) 1)) (get
                     (model__
                     (mk___rep l__split_discrs
                     (mk___split_fields l__split_fields))) i1))))))
...
;; H
  ...
  (<= i1 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) (+ i1 n2))
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  i1)))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
     (mk___rep1 cu__split_fields3)) (+ (* 2 n2) 1)))
...
;; H
  (assert (and (= o5 (* 2 i)) (in_range1 (* 2 i))))
...
;; H
  (assert (and (= o10 (get o4 o8)) (in_range4 o10)))
...
;; H
  (assert
  (and (= o (model__ (mk___rep l__split_discrs l__split_fields2)))
  (= (length1 o) (length (mk___rep l__split_discrs l__split_fields2)))))
