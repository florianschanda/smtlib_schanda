...
;; H
  (assert
  (=> (= (= source 53) true)
  (= aida__conversion__convert_character_digit_to_integer__result4 5)))

;; H
  (assert
  (=> (= (= source 54) true)
  (= aida__conversion__convert_character_digit_to_integer__result4 6)))

;; H
  (assert
  (=> (= (= source 55) true)
  (= aida__conversion__convert_character_digit_to_integer__result4 7)))

;; H
  (assert
  (=> (= (= source 56) true)
  (= aida__conversion__convert_character_digit_to_integer__result4 8)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= aida__conversion__convert_character_digit_to_integer__result4 9)))
(check-sat)
(exit)
