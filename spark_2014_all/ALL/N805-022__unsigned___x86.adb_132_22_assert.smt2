...
(define-fun dynamic_invariant ((temp___expr_137 (_ BitVec 64))
...
(define-fun bool_eq3 ((a (Array (_ BitVec 64) unsigned_8))
...
(declare-fun o1 () (Array (_ BitVec 64) unsigned_8))

(declare-fun o2 () unsigned_8)

(declare-fun o3 () (Array (_ BitVec 64) unsigned_8))

(declare-fun o4 () unsigned_8)

(declare-fun o5 () (Array (_ BitVec 64) unsigned_8))

(declare-fun o6 () unsigned_8)

(declare-fun o7 () (Array (_ BitVec 64) unsigned_8))

(declare-fun result () (Array (_ BitVec 64) unsigned_8))

(declare-fun memory1 () (Array (_ BitVec 64) unsigned_8))

(declare-fun result1 () (Array (_ BitVec 64) unsigned_8))

(declare-fun memory2 () (Array (_ BitVec 64) unsigned_8))

(declare-fun result2 () (Array (_ BitVec 64) unsigned_8))

(declare-fun memory3 () (Array (_ BitVec 64) unsigned_8))

(declare-fun result3 () (Array (_ BitVec 64) unsigned_8))

(declare-fun memory4 () (Array (_ BitVec 64) unsigned_8))
...
;; H
  ...
  (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 32) 256))) (bvurem 
  val__ ((_ int2bv 32) 65536))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 5, characters 0-0
  ...
  (= (bvadd ((_ zero_extend 24) (to_rep
                                (select memory4 (bvadd addr ((_ int2bv 64) 2))))) (bvmul ((_ zero_extend 24) 
  (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 3))))) ((_ int2bv 32) 256))) (bvurem (bvudiv 
  val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))))
(check-sat)
