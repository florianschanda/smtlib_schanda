...
(declare-fun perm__shift_perm_l__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun perm__shift_perm_l__result1 () Int)

(declare-fun perm__shift_perm_l__result2 () Int)

(declare-fun perm__shift_perm_l__result3 () Int)

(declare-fun perm__shift_perm_l__result4 () Int)

(declare-fun perm__shift_perm_l__result5 () Int)
...
;; H
  ...
  (and (in_range4 o) (=> (= (of_int o) true) (= (is_perm c b) true)))))
...
;; H
  (assert
  (= (mk_int__ref perm__shift_perm_l__result4) (mk_int__ref
                                               perm__shift_perm_l__result2)))
