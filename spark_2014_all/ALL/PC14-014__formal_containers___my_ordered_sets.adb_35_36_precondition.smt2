...
;; H
  (assert
  (and (= o3 (ceiling (mk___rep l__split_discrs l__split_fields8) 3))
  (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (<
          (last_element (mk___rep l__split_discrs l__split_fields8)) 3) true) true)
  (= (bool_eq1 o3 no_element) true)
  (and
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o3) true)
  (not
  (< (get1 (elements (mk___rep l__split_discrs l__split_fields8))
     (get (positions (mk___rep l__split_discrs l__split_fields8)) o3)) 3)))
  (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields8)) 3
     (get (positions (mk___rep l__split_discrs l__split_fields8)) o3)) true)))))

;; H
  (assert
  (and (= o2 (positions (mk___rep l__split_discrs l__split_fields8)))
  (and (not (= (has_key o2 no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o2 i) true)
  (and
  (and (<= 1 (get o2 i))
  (<= (get o2 i) (length (mk___rep l__split_discrs l__split_fields8))))
  (forall ((j us_rep1))
  (=> (= (has_key o2 j) true)
