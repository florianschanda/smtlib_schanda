...
(declare-fun dummy () barrier_limit)

(declare-datatypes ()
((barrier_limit__ref
 (mk_barrier_limit__ref (barrier_limit__content barrier_limit)))))
(define-fun barrier_limit__ref___projection ((a barrier_limit__ref)) barrier_limit
...
(define-fun us_split_discrs___projection ((a us_split_discrs)) barrier_limit
...
(declare-fun synchronous_barriers__synchronous_barrier__release_threshold__first__bit () Int)

(declare-fun synchronous_barriers__synchronous_barrier__release_threshold__last__bit () Int)

(declare-fun synchronous_barriers__synchronous_barrier__release_threshold__position () Int)
...
(declare-datatypes ()
((synchronous_barrier__ref
 (mk_synchronous_barrier__ref (synchronous_barrier__content us_rep)))))
(define-fun synchronous_barrier__ref___projection ((a synchronous_barrier__ref)) us_rep
...
(declare-fun synchronous_barriers__synchronous_barrier__release_threshold__first__bit1 () Int)

(declare-fun synchronous_barriers__synchronous_barrier__release_threshold__last__bit1 () Int)

(declare-fun synchronous_barriers__synchronous_barrier__release_threshold__position1 () Int)
...
(declare-datatypes ()
((tTsbSP__ref (mk_tTsbSP__ref (tTsbSP__content us_rep1)))))
(define-fun tTsbSP__ref___projection ((a tTsbSP__ref)) us_rep1 (tTsbSP__content
                                                               a))

(declare-fun sb__split_discrs () us_split_discrs)
