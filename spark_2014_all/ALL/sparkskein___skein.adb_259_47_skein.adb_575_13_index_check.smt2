...
;; H
  (assert (= o62 (bvadd src_index1 ((_ int2bv 64) 7))))
...
;; H
  (assert (= o66 (bvshl o65 ((_ int2bv 64) 56))))
...
;; H
  (assert (= o57 (bvadd src_index1 ((_ int2bv 64) 6))))
...
;; H
  (assert (= o61 (bvshl o60 ((_ int2bv 64) 48))))
...
;; H
  (assert (= o52 (bvadd src_index1 ((_ int2bv 64) 5))))
...
;; H
  (assert (= o56 (bvshl o55 ((_ int2bv 64) 40))))
...
;; H
  (assert (= o47 (bvadd src_index1 ((_ int2bv 64) 4))))
...
;; H
  (assert (= o51 (bvshl o50 ((_ int2bv 64) 32))))
