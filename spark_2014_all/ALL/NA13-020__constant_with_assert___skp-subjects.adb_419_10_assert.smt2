...
(declare-fun dummy1 () subject_id_type)
...
(declare-fun dummy4 () profile_kind)
...
(declare-fun dummy6 () dst_subject_type)
...
(declare-fun dummy7 () dst_vector_range)
...
(define-fun bool_eq9 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq8 (select a temp___idx_132)
...
(declare-fun dummy9 () (Array Int us_rep1))
...
(define-fun bool_eq11 ((a (Array Int us_rep2)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq10 (select a temp___idx_136)
...
(define-fun bool_eq13 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq12 (select a temp___idx_140)
...
(declare-fun null_trap () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun null_trap_table () (Array Int us_rep1))
...
(declare-fun null_event () us_rep2)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun null_event_table () (Array Int us_rep2))
...
;; WP_parameter_def
 ;; File "sk.ads", line 23, characters 0-0
  ...
  (= (bvurem (to_rep
             (rec__skp__subjects__subject_spec_type__pml4_address
             (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0))))
(check-sat)
