...
;; H
  ...
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1 (select data3 rr1)))) (ite (= rr1 10000) 0 (+ rr1 1))))))
...
;; H
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data3 rr1)))) 0))))
...
;; H
  (assert (=> (= rr 10000) (= o14 0)))

;; H
  (assert
  (=> (not (= rr 10000)) (and (= o14 (+ rr 1)) (in_range2 (+ rr 1)))))
