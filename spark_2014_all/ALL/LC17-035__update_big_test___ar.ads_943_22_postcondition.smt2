...
(declare-fun temp___6950 () us_rep2)
...
(declare-fun temp___6954 () us_rep2)
...
;; H
  (assert (= temp___6954 (mk___rep2 o24)))

;; H
  (assert (= result2 (mk___split_fields__ref2 r__split_fields5)))

;; H
  (assert (= r__split_fields6 (us_split_fields5 temp___6954)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 934, characters 0-0
  (not
