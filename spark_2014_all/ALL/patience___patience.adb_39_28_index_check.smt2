...
;; H
  (assert (=> (= result8 true) (= o25 (to_rep1 o24))))

;; H
  (assert
  (=> (= result8 true)
  (= result7 (ite (< o25 (to_rep1 s__split_fields2)) true false))))
...
;; H
  (assert (=> (= result7 true) (= o22 (to_rep1 o21))))
...
;; H
  (assert (=> (= result6 true) (= temp___544 (to_rep1 o15))))

;; H
  (assert (=> (= result6 true) (and (<= 0 temp___544) (<= temp___544 99))))

;; H
  (assert (=> (= result6 true) (= o16 temp___544)))

;; H
  (assert (=> (= result6 true) (= o17 (select s__split_fields3 o16))))

;; H
  (assert (=> (= result6 true) (= o18 (to_rep1 o17))))
...
;; H
  (assert (=> (= result6 true) (= o19 (to_rep1 o13))))
