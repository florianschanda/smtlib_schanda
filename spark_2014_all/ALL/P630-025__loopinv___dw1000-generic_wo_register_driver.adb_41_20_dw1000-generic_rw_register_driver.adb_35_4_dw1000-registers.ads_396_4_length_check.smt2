...
(define-fun us_split_fields__ref_48__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_48__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(declare-fun dw1000__register_types__drx_tune1b_type__drx_tune1b__first__bit () Int)

(declare-fun dw1000__register_types__drx_tune1b_type__drx_tune1b__last__bit () Int)

(declare-fun dw1000__register_types__drx_tune1b_type__drx_tune1b__position () Int)
...
(define-fun register_type__ref_111__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_79__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_79__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4812 us_t1)
  (temp___is_init_4809 Bool) (temp___skip_constant_4810 Bool)
  (temp___do_toplevel_4811 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4810 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_4812)
                                       (last3 temp___expr_4812))
                                       (and (= (first3 temp___expr_4812) 1)
                                       (= (last3 temp___expr_4812) 2)))))
...
(define-fun target__ref_33__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_33__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_4828 us_t2)
  (temp___is_init_4825 Bool) (temp___skip_constant_4826 Bool)
  (temp___do_toplevel_4827 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4826 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_4828)
                                       (last5 temp___expr_4828))
                                       (and (= (first5 temp___expr_4828) 1)
                                       (= (last5 temp___expr_4828) 2)))))
...
(declare-fun temp___7799 () (Array Int bits_8))

(declare-fun temp___77991 () t2)

(define-fun temp___77992 () us_t2 (mk___t2 temp___7799 temp___77991))
...
;; H
  (assert
  (and (= temp___77992 (register_to_bytes reg)) (dynamic_invariant1
  temp___77992 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___77991)) (to_rep (last4 temp___77991)))
     (+ (- (to_rep (last4 temp___77991)) (to_rep (first4 temp___77991))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
