...
(declare-fun o230 () u64)

(declare-fun o231 () (Array (_ BitVec 64) u64))
...
(declare-fun result134 () map__ref)

(declare-fun x116 () (Array (_ BitVec 64) u64))
...
;; H
  (assert
  (= (to_rep o230) (bvadd (to_rep (select x115 ((_ int2bv 64) 5))) (to_rep
                                                                   (select
                                                                   ts (bvurem
                                                                   c190b1 ((_ int2bv 64) 3)))))))

;; H
  (assert (= o231 (store x115 ((_ int2bv 64) 5) o230)))
