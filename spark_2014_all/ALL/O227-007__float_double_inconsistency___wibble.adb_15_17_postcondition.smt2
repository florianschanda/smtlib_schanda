...
(declare-fun state1 () t)

(declare-fun state2 () t)

(declare-fun state3 () t)
...
;; H
  (assert
  (and (= o (add RNE1 state fliteral3)) (tqtisFinite
  (add RNE1 state fliteral3))))
...
;; WP_parameter_def
 ;; File "wibble.adb", line 51, characters 0-0
  (not (le state2
  (mul RNE1 (of_ubv32 RNA1 (bvadd x ((_ int2bv 32) 1))) fliteral2))))
(check-sat)
