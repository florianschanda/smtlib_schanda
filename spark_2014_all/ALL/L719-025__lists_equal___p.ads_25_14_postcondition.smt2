...
;; H
  (assert
  (= (element (mk___rep l__split_discrs l__split_fields6) cu1) (element
                                                               l_in cu2)))
...
;; H
  ...
  (= (m_elements_swapped
     ...
     (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu1)
     (get1 (positions (mk___rep l__split_discrs l__split_fields6)) cu2)) true)
  (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields5))
