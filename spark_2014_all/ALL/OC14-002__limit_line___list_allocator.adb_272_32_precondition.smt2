...
;; H
  (assert
  (and
  (= o78 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         j))
  (in_range7 o78)))
...
;; H
  (assert
  (=> (= result13 true)
  (=> (= result14 true) (and (= o75 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o76 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o75))
  (in_range7 o76)))))
...
;; H
  (assert
  (=> (= result13 true) (= o73 (rec__list_allocator__cell__next o72))))
...
;; H
  (assert
  (=> (= result12 true) (= o66 (rec__list_allocator__cell__prev o65))))
