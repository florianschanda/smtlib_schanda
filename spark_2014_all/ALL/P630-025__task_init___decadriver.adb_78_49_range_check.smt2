...
;; H
  (assert
  (=> (<= (to_rep1 frame__first) (to_rep1 frame__last))
  (= o2 (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 frame__first) (to_rep1 frame__last))) (= o2 0)))

;; H
  (assert (and (= temp___4541 o2) (in_range1 o2)))

;; H
  (assert (<= 1 temp___4541))
