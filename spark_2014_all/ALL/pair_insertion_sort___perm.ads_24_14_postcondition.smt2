...
(define-fun t17s__ref___projection ((a1 t17s__ref)) integer (t17s__content
                                                            a1))
...
;; remove_last__post_axiom
  (assert
  (forall ((a1 us_t))
  (! (=> (and (dynamic_invariant1 a1 true true true) (< 0 (length a1)))
     (dynamic_invariant1 (remove_last a1) true false true)) :pattern (
  (remove_last a1)) )))

;; remove_last__def_axiom
  (assert
  (forall ((a1 us_t))
  (! (=> (dynamic_invariant1 a1 true true true)
     (= (remove_last a1) (let ((temp___164 (let ((temp___163 (- (last1 a1) 1)))
                                           (let ((temp___162 (first1 a1)))
                                           (of_array1 (to_array a1)
                                           temp___162 temp___163)))))
                         (of_array (to_array1 temp___164) (first3 temp___164)
                         (last3 temp___164))))) :pattern ((remove_last a1)) )))
...
(declare-fun perm__occ__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun perm__occ__result1 () Int)

(declare-fun perm__occ__result2 () Int)

(declare-fun perm__occ__result3 () Int)

(declare-fun perm__occ__result4 () Int)

(declare-fun perm__occ__result5 () Int)
...
;; H
  ...
  (and
  (= o (ite (= (length a) 0) 0
       (ite (= (to_rep (select (elts a) (to_rep (last (rt a))))) e)
       (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e))))
  (<= o (length a))))))
...
;; H
  (assert
  (= (mk_int__ref perm__occ__result4) (mk_int__ref perm__occ__result2)))
...
(assert
;; WP_parameter_def
 ;; File "perm.ads", line 7, characters 0-0
  (not (<= perm__occ__result4 (length a))))
(check-sat)
(exit)
