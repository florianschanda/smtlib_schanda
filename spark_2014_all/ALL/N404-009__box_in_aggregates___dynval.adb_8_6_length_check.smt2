...
(declare-const temp___1561 t1)

(declare-const temp___157 (Array Int integer))

(declare-const temp___1571 t)
...
;; H
  ...
  (mk___t x (mk (to_rep x__first) (to_rep x__last))) false))
...
;; H
  ...
  (=>
  (and (<= (to_rep x__first) temp___149) (<= temp___149 (to_rep x__last)))
  (=> (<= first last) (dynamic_property first last
  (to_rep (select x temp___149))))))))

;; H
  (assert (= (to_rep (first3 (rt1 (temp___150 l u)))) l))

;; H
  (assert (= (to_rep (last3 (rt1 (temp___150 l u)))) u))

;; H
  (assert (= (mk___t1 temp___156 temp___1561) (temp___150 l u)))

;; H
  (assert
  (= (ite (<= (to_rep (first3 temp___1561)) (to_rep (last3 temp___1561)))
     (+ (- (to_rep (last3 temp___1561)) (to_rep (first3 temp___1561))) 1) 0)
  (ite (<= first last) (+ (- last first) 1) 0)))

;; H
  (assert
  (= (slide temp___156 (to_rep (first3 temp___1561)) first) temp___157))

;; H
  (assert (= (mk first last) temp___1571))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep (first1 temp___1571)) (to_rep (last1 temp___1571)))
     (+ (- (to_rep (last1 temp___1571)) (to_rep (first1 temp___1571))) 1) 0)
