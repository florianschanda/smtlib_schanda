...
(define-fun temp___1355 () Float32 x)
...
;; WP_parameter_def
 ;; File "types.ads", line 65, characters 0-0
  (not
  (or
  (or (fp.eq temp___1355 (fp #b0 #b00000000 #b00000000000000000000000))
  (fp.leq temp___1355 (fp.neg (fp #b0 #b00110101 #b00000000000000000000000))))
  (fp.leq (fp #b0 #b00110101 #b00000000000000000000000) temp___1355))))
(check-sat)
(exit)
