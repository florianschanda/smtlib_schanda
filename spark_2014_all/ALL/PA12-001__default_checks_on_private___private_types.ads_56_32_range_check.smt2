...
(declare-fun private_types__p4__t__d__first__bit () Int)

(declare-fun private_types__p4__t__d__last__bit () Int)

(declare-fun private_types__p4__t__d__position () Int)
...
(declare-fun private_types__p4__t__f__first__bit () Int)

(declare-fun private_types__p4__t__f__last__bit () Int)

(declare-fun private_types__p4__t__f__position () Int)
...
(declare-fun private_types__p4__t__d__first__bit1 () Int)

(declare-fun private_types__p4__t__d__last__bit1 () Int)

(declare-fun private_types__p4__t__d__position1 () Int)
...
(declare-fun private_types__p4__t__f__first__bit1 () Int)

(declare-fun private_types__p4__t__f__last__bit1 () Int)

(declare-fun private_types__p4__t__f__position1 () Int)
