...
(declare-fun temp___1615 () (Array Int us_rep1))

(declare-fun o57 () us_rep1)

(declare-fun o58 () us_split_fields)

(declare-fun temp___1614 () (Array Int us_rep1))

(declare-fun o59 () us_rep1)

(declare-fun o60 () us_split_fields)
...
;; H
  ...
  (= temp___1615 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (and (dynamic_invariant3 temp___1615 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1615 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1615 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1615 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1615 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1615 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1615 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1615 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1615 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1615 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o57 (select temp___1615 i)))
...
;; H
  ...
  (= temp___1614 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (and (dynamic_invariant3 temp___1614 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1614 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1614 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1614 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1614 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1614 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1614 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o59 (select temp___1614 i)))

;; H
  (assert (= o60 (us_split_fields1 o59)))

;; H
  (assert (= o61 (rec__tree_model__path_type__a o60)))
