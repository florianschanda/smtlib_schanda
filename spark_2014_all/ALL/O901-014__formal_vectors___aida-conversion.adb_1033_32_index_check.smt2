...
;; H
  (assert
  (and (= o35 (convert_character_digit_to_integer o34))
  (and (in_range1 o35)
  (and (and (<= 0 o35) (<= o35 9))
  (ite (= (= o34 48) true) (= o35 0)
  (ite (= (= o34 49) true) (= o35 1)
  (ite (= (= o34 50) true) (= o35 2)
  (ite (= (= o34 51) true) (= o35 3)
  (ite (= (= o34 52) true) (= o35 4)
  (ite (= (= o34 53) true) (= o35 5)
  (ite (= (= o34 54) true) (= o35 6)
  (ite (= (= o34 55) true) (= o35 7)
  (ite (= (= o34 56) true) (= o35 8) (=> (= (= o34 57) true) (= o35 9)))))))))))))))
...
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 997, characters 0-0
  (not (<= (to_rep1 (first (rt source))) temp___1737)))
(check-sat)
(exit)
