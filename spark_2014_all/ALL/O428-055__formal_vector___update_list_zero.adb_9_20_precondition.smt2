...
(declare-fun temp___533 () us_rep2)

(declare-fun temp___534 () count_type)

(declare-fun temp___5341 () us_main_type)

(declare-fun temp___530 () count_type)
...
(declare-fun temp___532 () count_type)

(declare-fun temp___5321 () us_main_type)
...
;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___534))
  (= l__split_fields temp___5341))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___529))
  (= l__split_fields temp___5291))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___532))
  (= l__split_fields temp___5321))))

;; H
  (assert
  (=> (= result1 true)
  (= (length (mk___rep l__split_discrs l__split_fields2)) temp___531)))
...
;; H
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i1) (ite (<=
                                                                    (get
                                                                    temp___533
                                                                    i1)
                                                                    threshold)
...
;; H
  (assert
  (=> (= result1 true) (= result2 (ite (<= o threshold) true false))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= result2 true) (= result3 (mk___split_fields__ref l__split_fields2)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (= result2 true)
  (= l__split_fields3 loop_types__lists__replace_element__container__fields))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result2 true)) (= l__split_fields3 l__split_fields2))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (= o1 (has_key (positions (mk___rep l__split_discrs l__split_fields3))
...
;; H
  (assert
  (=> (= result1 true) (= result4 (ite (not (= o1 true)) true false))))
...
;; H
  (assert
  (=> (not (= result1 true)) (= cu__split_fields7 cu__split_fields10)))
