...
;; H
  ...
  (= (range_equal
     ...
     o 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields4)) o) 0))
  (= (range_shifted
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
     (model__ (mk___rep v__split_discrs v__split_fields4)) o
     (last6
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))
     1) true))
...
;; H
  ...
  (= (length (mk___rep v__split_discrs v__split_fields3)) (+ (length
                                                             ...
                                                             v__split_discrs
                                                             v__split_fields4)) 1))
  (= (range_equal (model__ (mk___rep v__split_discrs v__split_fields4))
     (model__ (mk___rep v__split_discrs v__split_fields3)) first1 (-
     o1 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields3)) o1) 0))
  (= (range_shifted (model__ (mk___rep v__split_discrs v__split_fields4))
     (model__ (mk___rep v__split_discrs v__split_fields3)) o1
     (last6 (model__ (mk___rep v__split_discrs v__split_fields4))) 1) true))
  (dynamic_property3 0 last3
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v__split_discrs)))))
