...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 27.0)))
...
;; H
  (assert (and (= o8 (mul RNE1 x x)) (tqtisFinite (mul RNE1 x x))))

;; H
  (assert
  (and (= o3 (mul RNE1 x (mul RNE1 x x))) (tqtisFinite
  (mul RNE1 x (mul RNE1 x x)))))

;; H
  (assert (= o4 (mul RNE1 fliteral3 o3)))
...
;; H
  (assert (= o2 (mul RNE1 fliteral4 o1)))

;; H
  (assert (and (= o6 o2) (tqtisFinite o2)))

;; H
  (assert (= o7 (add RNE1 o6 o5)))

;; H
  (assert (and (= o9 o7) (tqtisFinite o7)))

;; H
  (assert (= o10 (sub RNE1 o9 o8)))

;; H
  (assert (and (= o11 o10) (tqtisFinite o10)))

;; H
  (assert (= o12 (add RNE1 o11 (mul RNE1 fliteral5 x))))
