...
;; H
  (assert
  (= o25 (select (rec__patience__state__preds (us_split_fields1 s)) o24)))
...
;; H
  (assert
  (= o22 (select (rec__patience__state__preds (us_split_fields1 s)) o21)))
...
;; H
  (assert
  (=> (= result6 true)
  (= o19 (select (rec__patience__state__preds (us_split_fields1 s)) o18))))
...
;; H
  (assert
  (= o11 (select (rec__patience__state__preds (us_split_fields1 s)) o10)))
...
;; H
  (assert
  (= o13 (select (rec__patience__state__values (us_split_fields1 s))
  o12)))
