...
(((mk_word64_pos__ref (word64_pos__content word64_pos)))))
...
(declare-const bitset__bit_test__result1 Bool)

(declare-const bitset__bit_test__result2 Bool)

(declare-const bitset__bit_test__result3 Bool)

(declare-const mask2 (_ BitVec 64))

(declare-const bitset__bit_test__result4 Bool)

(declare-const mask3 (_ BitVec 64))

(declare-const bitset__bit_test__result5 Bool)
