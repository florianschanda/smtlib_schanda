...
(declare-datatypes () ((t9b__ref (mk_t9b__ref (t9b__content us_rep2)))))
(define-fun t9b__ref___projection ((a t9b__ref)) us_rep2 (t9b__content a))
...
(declare-fun record_equality__test_eq_ko_d2__g_pu1__assume () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu1__assume1 () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu1__assume2 () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu1__assume3 () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu1__assume4 () us_private)

(declare-fun record_equality__test_eq_ko_d2__g_pu1__assume5 () Int)
...
(declare-fun record_equality__test_eq_ko_d2__g_pu2__assume () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu2__assume1 () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu2__assume2 () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu2__assume3 () natural)

(declare-fun record_equality__test_eq_ko_d2__g_pu2__assume4 () us_private)

(declare-fun record_equality__test_eq_ko_d2__g_pu2__assume5 () Int)
...
(declare-fun g_pu1__split_fields4 () natural)

(declare-fun g_pu1__split_fields5 () natural)

(declare-fun g_pu1__split_fields6 () natural)

(declare-fun g_pu1__split_fields7 () us_private)
...
(declare-fun g_pu2__split_fields4 () natural)

(declare-fun g_pu2__split_fields5 () natural)

(declare-fun g_pu2__split_fields6 () natural)

(declare-fun g_pu2__split_fields7 () us_private)
...
;; H
  (assert
  (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r10b))
...
;; H
  ...
  (= c_pu1__split_discrs (mk___split_discrs
                         record_equality__test_eq_ko_d2__g_pu1__assume)))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu1__assume1 o1))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu1__assume2 o2))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu1__assume3 o3))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu1__assume4 o4))

;; H
  (assert (= us_tag4 record_equality__test_eq_ko_d2__g_pu1__assume5))
...
;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu1__assume1 g_pu1__split_fields4))

;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu1__assume2 g_pu1__split_fields5))

;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu1__assume3 g_pu1__split_fields6))

;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu1__assume4 g_pu1__split_fields7))
...
;; H
  (assert
  (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r12b))
...
;; H
  (assert
  (= c_pu1__split_discrs (mk___split_discrs
                         record_equality__test_eq_ko_d2__g_pu2__assume)))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu2__assume1 o6))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu2__assume2 o7))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu2__assume3 o8))

;; H
  (assert (= record_equality__test_eq_ko_d2__g_pu2__assume4 o9))

;; H
  (assert (= us_tag5 record_equality__test_eq_ko_d2__g_pu2__assume5))
...
;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu2__assume1 g_pu2__split_fields4))

;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu2__assume2 g_pu2__split_fields5))

;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu2__assume3 g_pu2__split_fields6))

;; H
  (assert
  (= record_equality__test_eq_ko_d2__g_pu2__assume4 g_pu2__split_fields7))
...
(assert
;; WP_parameter_def
 ;; File "record_equality.adb", line 27, characters 0-0
  (not
  (= (ite (= g_pu1__attr__tag g_pu2__attr__tag)
     (us_dispatch_eq
     (mk___rep g_pu1__split_discrs
     (mk___split_fields g_pu1__split_fields5
     (hide_ext__1 g_pu1__split_fields4 g_pu1__split_fields6
     g_pu1__split_fields7)) g_pu1__attr__tag)
     (mk___rep g_pu2__split_discrs
     (mk___split_fields g_pu2__split_fields5
     (hide_ext__1 g_pu2__split_fields4 g_pu2__split_fields6
     g_pu2__split_fields7)) g_pu2__attr__tag)) false) true)))
(check-sat)
(exit)
