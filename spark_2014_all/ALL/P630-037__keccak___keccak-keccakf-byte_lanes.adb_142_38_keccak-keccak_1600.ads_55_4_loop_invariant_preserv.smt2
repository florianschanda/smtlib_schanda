...
(declare-fun data17 () map__ref)

(declare-fun remaining_bytes10 () int__ref)

(declare-fun offset10 () int__ref)

(declare-fun shift4 () int__ref)

(declare-fun temp___7752 () int__ref)

(declare-fun temp___7742 () int__ref)

(declare-fun temp___7732 () int__ref)

(declare-fun data18 () (Array Int byte))

(declare-fun remaining_bytes11 () Int)

(declare-fun offset11 () Int)

(declare-fun shift5 () Int)

(declare-fun temp___7753 () Int)

(declare-fun temp___7743 () Int)

(declare-fun temp___7733 () Int)
...
;; WP_parameter_def
 ;; File "keccak-keccakf-byte_lanes.adb", line 30, characters 0-0
  (not
  (= (+ (int__content offset10) (int__content remaining_bytes10)) (ite (<=
                                                                  (to_rep
                                                                  data__first)
                                                                  (to_rep
                                                                  data__last))
