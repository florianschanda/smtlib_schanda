...
(declare-datatypes ((feet__ref 0)) (((mk_feet__ref (feet__content feet)))))
...
(((mk_feetpermin__ref (feetpermin__content feetpermin)))))
...
(((mk_pitchangle__ref (pitchangle__content pitchangle)))))
...
(((mk_floorfpm__ref (floorfpm__content floorfpm)))))
...
;; H
  (assert (= result__1 (div1 (- target_climb_rate1 floor_climb_rate1) 12)))

;; H
  (assert (=> (< 10 result__1) (= result2 result__1)))

;; H
  (assert (=> (< 10 result__1) (= result__2 10)))

;; H
  (assert
  (=> (not (< 10 result__1)) (=> (< result__1 (- 10)) (= result3 result__1))))

;; H
  (assert
  (=> (not (< 10 result__1)) (=> (< result__1 (- 10)) (= result__3 (- 10)))))

;; H
  (assert
  (=> (not (< 10 result__1))
  (=> (not (< result__1 (- 10))) (= result__3 result__1))))

;; H
  (assert (=> (not (< 10 result__1)) (= result__2 result__3)))

;; H
  (assert (= result4 target_pitchrate))

;; H
  (assert (= target_pitchrate1 result__2))
