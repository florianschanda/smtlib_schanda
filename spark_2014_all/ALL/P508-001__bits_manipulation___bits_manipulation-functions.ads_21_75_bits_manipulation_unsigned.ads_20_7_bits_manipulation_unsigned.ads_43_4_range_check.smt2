...
;; H
  (assert
  (= result4 (ite (= bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4
             o8) true false)))
...
;; H
  (assert
  (= result5 (ite (bvule bits_manipulation_unsigned__unsigned_16__functions__extract_bits__result4
             o4) true false)))
