...
(define-fun dynamic_invariant1 ((temp___expr_1855 Int)
...
(define-fun dynamic_invariant2 ((temp___expr_1861 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_1867 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_1873 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_1879 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_1914 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_1920 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_1926 Int)
...
;; H
  (assert (not (= (to_rep (rec__patris__piece__s (us_split_fields1 p))) 2)))

;; H
  (assert (not (= (to_rep (rec__patris__piece__s (us_split_fields1 p))) 1)))
...
;; WP_parameter_def
 ;; File "patris.ads", line 173, characters 0-0
  (not (<= 3 (to_rep (rec__patris__piece__s (us_split_fields1 p))))))
(check-sat)
(exit)
