...
(declare-const o8 description_count_type)
...
(declare-const o12 hour_type)

(declare-const o13 minute_type)

(declare-const o14 second_type)

(declare-const o15 Bool)

(declare-const o16 (Array Int character))

(declare-const o17 description_count_type)

(declare-const o18 day_type)

(declare-const o19 month_type)

(declare-const o20 year_type)

(declare-const o21 hour_type)

(declare-const o22 minute_type)

(declare-const o23 second_type)

(declare-const o24 Bool)

(declare-const o25 (Array Int us_rep3))
