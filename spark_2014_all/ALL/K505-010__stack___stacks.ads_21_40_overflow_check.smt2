...
(declare-fun user_eq1 (state state) Bool)

(declare-fun dummy1 () state)
...
;; range_axiom
  (assert
  (forall ((x element)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun bool_eq ((a (Array Int element)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep3 (select a temp___idx_133)) (to_rep3
...
;; H
  (assert (in_range1 mystate))

;; H
  (assert
  (and (dynamic_invariant2
  (mk___rep s__split_discrs
  (mk___split_fields s__split_fields4
  (mk___t s__split_fields5 s__split_fields6) s__split_fields7) s__attr__tag)
  true true true) (in_range1 mystate1)))
