...
(define-fun tint_arrayD1__ref___25__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___25__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t786b__ref 0))
(((mk_t786b__ref (t786b__content integer)))))
...
(declare-datatypes ((t787b__ref 0))
(((mk_t787b__ref (t787b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___34__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___34__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t790b__ref 0))
(((mk_t790b__ref (t790b__content integer)))))
...
(declare-datatypes ((t791b__ref 0))
(((mk_t791b__ref (t791b__content us_t4)))))
...
(((mk_t792b__ref (t792b__content integer)))))
...
(define-fun tint_arrayB__ref___25__projection ((a tint_arrayB__ref)) us_t5
...
;; def_axiom
  (assert
  (forall ((temp___2386 Int) (temp___2387 Int) (temp___2388 Int)
  (temp___2389 Int) (temp___2390 Int))
  ...
  temp___2389 temp___2390)
  (and (= (first5 temp___2385) temp___2389)
  (= (last5 temp___2385) temp___2390)))
  (and
  (and
  (= (select (to_array2 temp___2385) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2386))
  (= (select (to_array2 temp___2385) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2387)))
  (= (select (to_array2 temp___2385) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2388)))))))
...
(define-fun tnumber_array_typeB__ref___34__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; def_axiom
  (assert
  (forall ((temp___2396 Int) (temp___2397 Int) (temp___2398 Int))
  (let ((temp___2395 (aida__conversion__calculate_negative_target_length_4__n__aggregate_def
                     temp___2396 temp___2397 temp___2398)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 3)
  temp___2397 temp___2398)
  (and (= (first9 temp___2395) temp___2397)
  (= (last9 temp___2395) temp___2398)))
  (forall ((temp___2399 Int))
  (= (select (to_array4 temp___2395) temp___2399) (of_rep1 temp___2396)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_797 us_t3)
  ...
  (temp___do_toplevel_796 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 3)
                                      (first7 temp___expr_797)
                                      (last7 temp___expr_797))
                                      (and
                                      (= (first7 temp___expr_797) (+
                                      (first1 source) 1))
                                      (= (last7 temp___expr_797) (+ (first1
                                                                    source) 3))))))
...
;; H
  (assert
  (= (mk___t2 temp___2393 temp___23931) (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def
                                        9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___23931)) (to_rep1 (last4 temp___23931)))
     (+ (- (to_rep1 (last4 temp___23931)) (to_rep1 (first4 temp___23931))) 1)
...
;; H
  (assert
  (= (slide1 temp___2393 (to_rep1 (first4 temp___23931))
...
;; H
  (assert
  (= (mk___t4 temp___2401 temp___24011) (aida__conversion__calculate_negative_target_length_4__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___24011)) (to_rep1 (last8 temp___24011)))
     (+ (- (to_rep1 (last8 temp___24011)) (to_rep1 (first8 temp___24011))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 3))
        (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2401 (to_rep1 (first8 temp___24011))
...
;; H
  (assert
  (and (= temp___2407 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408))
  (= temp___2405 n1)))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= n2 o8)))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2407 index1) (<= index1 temp___2408)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2407 index1) (<= index1 temp___2408)))
...
;; H
  (assert
  (=> (not (and (<= temp___2407 index1) (<= index1 temp___2408))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___2409 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2409)
  (<= temp___2409 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2410 (+ (to_rep1 (first (rt source))) 2)) (in_range1
...
;; H
  (assert
  (and (= temp___2411 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))
