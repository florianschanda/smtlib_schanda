...
(declare-fun user_eq1 (enum1t enum1t) Bool)

(declare-fun dummy1 () enum1t)
...
;; range_axiom
  (assert
  (forall ((x enum1t)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
;; range_axiom
  (assert
  (forall ((x enum1ta)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
;; range_axiom
  (assert
  (forall ((x et1)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x et2)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(define-fun dynamic_invariant3 ((temp___expr_188 Int)
  ...
  (temp___do_toplevel_187 Bool)) Bool (=>
                                      ...
                                      (<= 10 90)) (in_range temp___expr_188)))
...
(declare-fun temp___7267 () us_rep3)

(declare-fun o17 () enum1t)

(declare-fun o18 () us_split_fields6)

(declare-fun temp___7269 () us_rep3)
...
;; H
  (assert (in_range2 (to_rep r__split_fields5)))

;; H
  (assert (=> (<= 1 4) (in_range2 temp)))
...
;; H
  (assert
  (and (= o (to_rep r__split_fields5)) (in_range2 (to_rep r__split_fields5))))
...
;; H
  (assert (= temp___7267 (mk___rep3 o16)))
...
;; H
  (assert (= r__split_fields6 (us_split_fields7 temp___7267)))
...
;; H
  (assert (= temp___7269 (mk___rep3 o18)))

;; H
  (assert (= result2 (mk___split_fields__ref3 r__split_fields6)))

;; H
  (assert (= r__split_fields7 (us_split_fields7 temp___7269)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1089, characters 0-0
  (not
