...
;; H
  (assert
  (= o63 (store (rec__patience__state__posstack s__split_fields12) o62
  o61)))

;; H
  (assert
  (= o64 (mk___split_fields (rec__patience__state__numelts s__split_fields12)
         (rec__patience__state__values s__split_fields12)
         (rec__patience__state__numstacks s__split_fields12)
         (rec__patience__state__stacksizes s__split_fields12)
         (rec__patience__state__stacks s__split_fields12) o63
         (rec__patience__state__posheight s__split_fields12)
         (rec__patience__state__preds s__split_fields12))))

;; H
  (assert (= temp___601 (mk___rep o64)))

;; H
  (assert (= result14 (mk___split_fields__ref s__split_fields12)))

;; H
  (assert (= s__split_fields13 (us_split_fields1 temp___601)))

;; H
  (assert (= (to_rep1 o65) stackisize8))
