...
;; H
  ...
  (= (to_rep
     (select (elts a) (get
                      (model__
                      (mk___rep result____split_discrs
                      result____split_fields4)) (to_rep (select (elts a) i)))))
  (to_rep (select (elts a) i)))))))
...
;; H
  ...
  (=>
  (= (has_key
     (model__ (mk___rep result____split_discrs result____split_fields4)) e1) true)
  (and
  (and
  (<= (to_rep1 (first (rt a))) (get
                               (model__
                               (mk___rep result____split_discrs
                               result____split_fields4)) e1))
  (<= (get
      (model__ (mk___rep result____split_discrs result____split_fields4)) e1)
  k2))
  (= (equivalent_keys
     (to_rep
     (select (elts a) (get
...
;; WP_parameter_def
 ;; File "find_map.ads", line 23, characters 0-0
  (not (<= (to_rep1 (first (rt a))) temp___708)))
(check-sat)
(exit)
