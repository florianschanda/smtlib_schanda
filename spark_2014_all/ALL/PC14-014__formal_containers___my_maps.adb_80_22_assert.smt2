...
(define-fun o45 () us_rep (mk___rep (mk___split_fields o10 o11)))

(define-fun o46 () us_rep (mk___rep (mk___split_fields o4 o5)))
...
;; H
  ...
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o45) true))
