...
(declare-datatypes ((r2__ref 0)) (((mk_r2__ref (r2__content r2)))))
...
(declare-const stack__model__to__result (Array Int integer))

(declare-const stack__model__to__result1 t)

(declare-const o (Array Int integer))

(declare-const temp___211 (Array Int integer))

(declare-const temp___2111 t1)
...
(declare-const stack__model__to__result2 (Array Int integer))

(declare-const stack__model__to__result3 t)

(declare-const stack__model__to__result4 (Array Int integer))

(declare-const stack__model__to__result5 t)

(declare-const stack__model__to__result6 (Array Int integer))

(declare-const stack__model__to__result7 t)

(declare-const stack__model__to__result8 (Array Int integer))

(declare-const stack__model__to__result9 t)

(declare-const stack__model__to__result10 (Array Int integer))

(declare-const stack__model__to__result11 t)

(define-fun stack__model__to__result12 () us_t (mk___t
                                               stack__model__to__result2
                                               stack__model__to__result3))
...
;; H
  (assert (= stack__model__to__result4 stack__model__to__result2))

;; H
  (assert (= stack__model__to__result5 stack__model__to__result3))

;; H
  (assert
  (= (mk___t stack__model__to__result6 stack__model__to__result7) stack__model__to__result12))

;; H
  (assert
  (=> (<= 1 (to_rep (rec__stack__stack__top (us_split_fields1 s))))
  (and (and (<= 1 1) (<= 1 100))
  (and (<= 1 (to_rep (rec__stack__stack__top (us_split_fields1 s))))
  (<= (to_rep (rec__stack__stack__top (us_split_fields1 s))) 100)))))
...
;; H
  (assert
  (= (mk1 1 (to_rep (rec__stack__stack__top (us_split_fields1 s)))) temp___2111))

;; H
  (assert (dynamic_property 1 2147483647 (to_rep1 (first2 temp___2111))
  (to_rep1 (last2 temp___2111))))
...
;; H
  (assert
  (= (mk (to_rep1 (first2 temp___2111)) (to_rep1 (last2 temp___2111)))
  o2))

;; H
  (assert (= result stack__model__to__result))

;; H
  (assert (= result1 stack__model__to__result1))

;; H
  (assert (= stack__model__to__result12 (mk___t o1 o2)))

;; H
  (assert
  (= (mk_m__ref (mk___t stack__model__to__result8 stack__model__to__result9))
  (mk_m__ref (mk___t stack__model__to__result4 stack__model__to__result5))))

;; H
  (assert (= stack__model__to__result10 stack__model__to__result6))

;; H
  (assert (= stack__model__to__result11 stack__model__to__result7))

;; H
  (assert (= result2 stack__model__to__result8))

;; H
  (assert (= result3 stack__model__to__result9))

(assert
;; WP_parameter_def
 ;; File "stack.ads", line 9, characters 0-0
  (not (= (to_rep1 (first stack__model__to__result9)) 1)))
(check-sat)
(exit)
