...
(declare-fun stack__model__to__result () (Array Int integer))

(declare-fun stack__model__to__result1 () t)

(declare-fun o () (Array Int integer))

(declare-fun temp___211 () (Array Int integer))

(declare-fun temp___2111 () t1)
...
(declare-fun stack__model__to__result2 () (Array Int integer))

(declare-fun stack__model__to__result3 () t)

(declare-fun stack__model__to__result4 () (Array Int integer))

(declare-fun stack__model__to__result5 () t)

(declare-fun stack__model__to__result6 () (Array Int integer))

(declare-fun stack__model__to__result7 () t)

(declare-fun stack__model__to__result8 () (Array Int integer))

(declare-fun stack__model__to__result9 () t)

(declare-fun stack__model__to__result10 () (Array Int integer))

(declare-fun stack__model__to__result11 () t)
