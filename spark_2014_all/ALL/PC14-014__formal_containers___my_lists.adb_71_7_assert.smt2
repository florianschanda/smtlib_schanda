...
(declare-fun my_lists__m__delete__2__container__fields2 () us_split_fields)

(declare-fun result16 () us_split_fields__ref)

(declare-fun l__split_fields9 () us_split_fields)

(declare-fun my_lists__m__clear__container__fields () us_split_fields)
...
;; H
  ...
  (and
  (and
  (<= (- (length (mk___rep l__split_discrs l__split_fields8)) 3) (length
                                                                 (mk___rep
                                                                 l__split_discrs
                                                                 my_lists__m__delete__2__container__fields2)))
  (<= (length
      (mk___rep l__split_discrs my_lists__m__delete__2__container__fields2))
  (length (mk___rep l__split_discrs l__split_fields8))))
  (= (bool_eq1 (mk___rep1 d__split_fields8) no_element) true))
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields8))
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields2)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields8))
        (mk___rep1 d__split_fields7)) 1)) true))
  (ite (= (< (- (length (mk___rep l__split_discrs l__split_fields8)) 3)
  (get (positions (mk___rep l__split_discrs l__split_fields8))
  ...
  (= (length
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields2)) (-
  (get (positions (mk___rep l__split_discrs l__split_fields8))
  (mk___rep1 d__split_fields7)) 1))
  (= (p_positions_truncated
     (positions
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields2))
     (positions (mk___rep l__split_discrs l__split_fields8))
     (get (positions (mk___rep l__split_discrs l__split_fields8))
     (mk___rep1 d__split_fields7)) 3) true))
  (and
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields2)) (-
  (length (mk___rep l__split_discrs l__split_fields8)) 3))
  (= (range_shifted
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields2))
     (model__ (mk___rep l__split_discrs l__split_fields8))
     (get (positions (mk___rep l__split_discrs l__split_fields8))
     (mk___rep1 d__split_fields7))
     (length
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields2))
     3) true))
  (= (p_positions_shifted
...
;; H
  (assert
  (= (length
     (mk___rep l__split_discrs my_lists__m__clear__container__fields)) 0))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not
  (not
  (and (= result18 (mk___split_fields__ref1 c__split_fields9))
  (= c__split_fields10 (us_split_fields3 no_element))))))
(check-sat)
(exit)
