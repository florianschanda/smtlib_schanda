...
;; H
  ...
  (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j1)))))))))))
...
;; H
  ...
  (not
  (exists ((j1 Int))
  (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (- possible4 1)))
  (= (to_rep (select (elts s) courant3)) (to_rep (select (elts c) j1)))))))
...
;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result17))
  (<= (int__content indexbis__result17) (to_rep1 (last (rt s)))))
  (= (= o8 true)
  (exists ((i Int))
  (and
  (and (<= (to_rep1 (first (rt s))) i)
  (<= i (- (int__content indexbis__result17) 1)))
  (exists ((j1 Int))
  (and (and (<= (to_rep1 (first (rt c))) j1) (<= j1 (to_rep1 (last (rt c)))))
  (= (to_rep (select (elts s) i)) (to_rep (select (elts c) j1))))))))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result17))
  (<= (int__content indexbis__result17) (to_rep1 (last (rt s)))))
  (= result7 (ite (not (= o8 true)) true false))))
