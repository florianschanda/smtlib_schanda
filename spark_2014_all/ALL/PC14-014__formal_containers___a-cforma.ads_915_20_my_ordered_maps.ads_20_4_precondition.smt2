...
(define-fun dynamic_invariant1 ((temp___expr_587 Int)
...
(declare-const temp___888 count_type)
...
;; H
  (assert (= temp___888 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___888)) no_element))
