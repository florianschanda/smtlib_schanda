...
;; remove__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant1 a1 true true true) (dynamic_invariant4 i true
     true true))
     ...
     (= (to_rep (select (to_array a1) (+ k 1))) (to_rep
                                                (select (to_array result) k)))))))))
     (dynamic_invariant1 result true false true)))) :pattern ((remove a1 i)) ))))
...
;; H
  ...
  (forall ((ia1 Int))
  (=>
  (and (<= (to_rep1 (first (rt a))) ia1) (<= ia1 (to_rep1 (last (rt a)))))
  (exists ((ib1 Int))
  (and
  (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b)))))
  (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib1)))
  (= (is_perm (remove a ia1) (remove b ib1)) true))))))))))
...
;; H
  (assert
  (= (mk_int__ref perm__perm_eq__result4) (mk_int__ref
                                          perm__perm_eq__result2)))
