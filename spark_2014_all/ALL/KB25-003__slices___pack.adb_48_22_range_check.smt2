...
(define-fun tTmy_s2SP1__ref___3__projection ((a tTmy_s2SP1__ref)) tTmy_s2SP1
...
(define-fun tTmy_aSP1__ref___4__projection ((a tTmy_aSP1__ref)) tTmy_aSP1
...
(((mk_t109b__ref (t109b__content t109b)))))
...
(declare-datatypes ((t112b__ref 0))
(((mk_t112b__ref (t112b__content t112b)))))
...
(((mk_t117b__ref (t117b__content t117b)))))
...
(declare-const temp___455 (Array Int character))

(declare-const o (Array Int character))

(declare-const pack__an22__my_b__assume (Array Int integer))

(declare-const temp___462 (Array Int character))

(declare-const temp___464 (Array Int character))
...
;; H
  ...
  (=> (<= 1 3)
  (and (and (<= (to_rep1 glob__first) 1) (<= 1 (to_rep1 glob__last)))
  (and (<= (to_rep1 glob__first) 3) (<= 3 (to_rep1 glob__last))))))

;; H
  (assert (= temp___462 glob))

;; H
  (assert (= temp___464 temp___462))
