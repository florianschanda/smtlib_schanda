...
(define-fun tint_arrayD1__ref___13__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___13__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t486b__ref 0))
(((mk_t486b__ref (t486b__content integer)))))
...
(declare-datatypes ((t487b__ref 0))
(((mk_t487b__ref (t487b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___22__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___22__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t490b__ref 0))
(((mk_t490b__ref (t490b__content integer)))))
...
(declare-datatypes ((t491b__ref 0))
(((mk_t491b__ref (t491b__content us_t4)))))
...
(declare-datatypes ((t492b__ref 0))
(((mk_t492b__ref (t492b__content integer)))))
...
(define-fun tint_arrayB__ref___13__projection ((a tint_arrayB__ref)) us_t5
...
;; def_axiom
  (assert
  (forall ((temp___1935 Int) (temp___1936 Int) (temp___1937 Int)
  (temp___1938 Int) (temp___1939 Int) (temp___1940 Int) (temp___1941 Int))
  (let ((temp___1934 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def
                     temp___1935 temp___1936 temp___1937 temp___1938
                     temp___1939 temp___1940 temp___1941)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 6) (+ (first1 source) 10)
  temp___1940 temp___1941)
  (and (= (first5 temp___1934) temp___1940)
  (= (last5 temp___1934) temp___1941)))
  (and
  (and
  (and
  (and
  (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 0)) (of_rep1
                                                                  temp___1935))
  (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 1)) (of_rep1
                                                                  temp___1936)))
  (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 2)) (of_rep1
                                                                  temp___1937)))
  (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 3)) (of_rep1
                                                                  temp___1938)))
  (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 4)) (of_rep1
                                                                  temp___1939)))))))
...
(define-fun tnumber_array_typeB__ref___22__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; def_axiom
  (assert
  (forall ((temp___1947 Int) (temp___1948 Int) (temp___1949 Int))
  (let ((temp___1946 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def
                     temp___1947 temp___1948 temp___1949)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 6) (+ (first1 source) 10)
  temp___1948 temp___1949)
  (and (= (first9 temp___1946) temp___1948)
  (= (last9 temp___1946) temp___1949)))
  (forall ((temp___1950 Int))
  (= (select (to_array4 temp___1946) temp___1950) (of_rep1 temp___1947)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_581 us_t3)
  (temp___is_init_578 Bool) (temp___skip_constant_579 Bool)
  (temp___do_toplevel_580 Bool)) Bool (=>
                                      (not (= temp___skip_constant_579 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 6)
                                      (+ (first1 source) 10)
                                      (first7 temp___expr_581)
                                      (last7 temp___expr_581))
                                      (and
                                      (= (first7 temp___expr_581) (+
                                      (first1 source) 6))
                                      (= (last7 temp___expr_581) (+ (first1
                                                                    source) 10))))))
...
;; H
  (assert
  (= (mk___t2 temp___1944 temp___19441) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def
                                        7 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___19441)) (to_rep1 (last4 temp___19441)))
     (+ (- (to_rep1 (last4 temp___19441)) (to_rep1 (first4 temp___19441))) 1)
...
;; H
  (assert
  (= (slide1 temp___1944 (to_rep1 (first4 temp___19441))
...
;; H
  (assert
  (= (mk___t4 temp___1952 temp___19521) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 6)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___19521)) (to_rep1 (last8 temp___19521)))
     (+ (- (to_rep1 (last8 temp___19521)) (to_rep1 (first8 temp___19521))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 6)) 1)
...
;; H
  (assert
  (= (slide1 temp___1952 (to_rep1 (first8 temp___19521))
...
;; H
  (assert
  (and (= temp___1958 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (= temp___1959 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959))
  (= temp___1957 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= n2 o8)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1956 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1956)
  (<= temp___1956 (to_rep1 n__last)))
  (=> (< index2 temp___1956)
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___1958 index1) (<= index1 temp___1959)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___1958 index1) (<= index1 temp___1959)))
...
;; H
  (assert
  (=> (not (and (<= temp___1958 index1) (<= index1 temp___1959))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___1960 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1960)
  (<= temp___1960 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1961 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1961)
  (<= temp___1961 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1962 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1962)
  (<= temp___1962 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1963 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1963)
  (<= temp___1963 (to_rep1 n__last))))

;; H
  (assert (= o28 temp___1963))
...
;; H
  (assert
  (and (= temp___1964 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1964)
  (<= temp___1964 (to_rep1 n__last))))

;; H
  (assert (= o35 temp___1964))
...
;; H
  (assert (<= (- 79999) target5))

;; H
  (assert
  (and (= o42 (- target5 2147400000)) (in_range1 (- target5 2147400000))))
