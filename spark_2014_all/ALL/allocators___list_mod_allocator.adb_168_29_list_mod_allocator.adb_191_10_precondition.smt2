...
(define-fun o22 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
;; H
  (assert
  (and (= o22 (model__ data first_available))
  (= (model_is_well_formed o22 data first_available) true)))
...
;; H
  (assert (and (= o21 (+ j 1)) (in_range1 (+ j 1))))
