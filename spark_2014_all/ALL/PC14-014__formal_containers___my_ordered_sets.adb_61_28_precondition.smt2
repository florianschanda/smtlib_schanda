...
;; H
  (assert
  (= m__split_fields2 (us_split_fields1
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs m__split_fields3))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs m__split_fields3))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs1 m__split_fields6))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs1 m__split_fields6))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
...
;; H
  (assert
  (and
  (= o2 (union__2 (mk___rep k__split_discrs k__split_fields3)
        (mk___rep l__split_discrs l__split_fields11)))
  (and
  (and
  (and
  ...
  (and
  (and
  (= (length o2) (+ (- (length (mk___rep k__split_discrs k__split_fields3))
  (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3))
  (model__ (mk___rep l__split_discrs l__split_fields11)))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields11))))
  (= (ole (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ o2)) true))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ o2)) true))
  (= (included_in_union (model__ o2)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included__3 (elements o2)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included__2
     (elements (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep k__split_discrs k__split_fields3)) (elements o2)) true))
  (= (e_elements_included__3
     (elements (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields11)) (elements o2)) true))))
