...
;; H
  (assert
  (and (= o2 (add RNE1 index_float2 fliteral)) (tqtisFinite
  (add RNE1 index_float2 fliteral))))
...
;; H
  (assert (not (lt erreur3 fliteral3)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le fliteral index_float3)))
(check-sat)
