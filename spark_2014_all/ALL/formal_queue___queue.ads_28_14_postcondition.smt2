...
(declare-fun queue__tail__result () count_type)

(declare-fun queue__tail__result1 () us_main_type)
...
(declare-fun queue__tail__result2 () count_type)

(declare-fun queue__tail__result3 () us_main_type)

(declare-fun queue__tail__result4 () count_type)

(declare-fun queue__tail__result5 () us_main_type)

(declare-fun queue__tail__result6 () us_rep)

(declare-fun r__split_fields3 () us_split_fields__ref)

(declare-fun queue__tail__result7 () list__ref)

(declare-fun r__split_fields4 () us_split_fields)

(declare-fun queue__tail__result8 () us_rep)
...
;; H
  ...
  (= (ole (model__ (mk___rep r__split_discrs r__split_fields5))
     (model__ (mk___rep r__split_discrs r__split_fields6))) true))
  (not
  (= (has_key (positions (mk___rep r__split_discrs r__split_fields5))
     (last1 (mk___rep r__split_discrs r__split_fields6))) true)))
  (= (keys_included_except
     (positions (mk___rep r__split_discrs r__split_fields6))
     (positions (mk___rep r__split_discrs r__split_fields6))
     (last1 (mk___rep r__split_discrs r__split_fields6))) true))
  (= (ole1 (positions (mk___rep r__split_discrs r__split_fields5))
     (positions (mk___rep r__split_discrs r__split_fields6))) true)))

;; H
  (assert (= queue__tail__result4 queue__tail__result2))

;; H
  (assert (= queue__tail__result5 queue__tail__result3))

;; H
  (assert
  (= queue__tail__result6 (mk___rep (mk___split_discrs queue__tail__result2)
                          (mk___split_fields queue__tail__result3))))

;; H
  (assert (= result1 queue__tail__result))

;; H
  (assert (= result2 queue__tail__result1))

;; H
  (assert (= r__split_discrs (mk___split_discrs queue__tail__result2)))

;; H
  (assert (= queue__tail__result3 r__split_fields2))

;; H
  (assert
  (= queue__tail__result7 (mk_list__ref
                          (mk___rep (mk___split_discrs queue__tail__result4)
                          (mk___split_fields queue__tail__result5)))))

;; H
  (assert (= r__split_fields3 (mk___split_fields__ref r__split_fields5)))

;; H
  (assert (= queue__tail__result8 queue__tail__result6))
...
;; H
  ...
  (list__content queue__tail__result7)))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 43, characters 0-0
  (not (= (length (list__content queue__tail__result7)) (- (length q) 1))))
(check-sat)
