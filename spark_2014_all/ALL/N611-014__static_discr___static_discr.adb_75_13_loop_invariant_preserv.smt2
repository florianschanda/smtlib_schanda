...
;; H
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields6)) 1) i)
  (<= i (to_rep1 (last (rt a))))) (not (= (to_rep (select (elts a) i)) e))))))
...
;; H
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields7)) 1) i)
  (<= i (to_rep (rec__static_discr__holder__length1 current__split_fields6))))
  (not
  (= (to_rep
     (select (elts3
             (rec__static_discr__i_holder__content2
             (us_split_fields7
             (rec__static_discr__holder__content1 current__split_fields7)))) i))
  e))))
  (and
  (and
  (<= (to_rep (rec__static_discr__holder__length1 current__split_fields7))
