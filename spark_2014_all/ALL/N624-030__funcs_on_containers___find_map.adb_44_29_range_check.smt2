...
(declare-fun find_map__find_upto__find_map_bad__result () Int)
...
(declare-fun find_map__find_upto__find_map_bad__result1 () Int)

(declare-fun find_map__find_upto__find_map_bad__result2 () Int)

(declare-fun find_map__find_upto__find_map_bad__result3 () Int)

(declare-fun find_map__find_upto__find_map_bad__result4 () Int)

(declare-fun find_map__find_upto__find_map_bad__result5 () Int)
...
;; H
  ...
  (and (< 0 (length a))
  (and
  (=> (= (has_key (model__ m) e) true)
  (and (<= (to_rep1 (first (rt a))) (get (model__ m) e))
  (<= (get (model__ m) e) (to_rep1 (last (rt a))))))
  (and
  (forall ((i Int))
  (=> (and (<= (to_rep1 (first (rt a))) i) (<= i (- (get (model__ m) e) 1)))
  (not (= (to_rep (select (elts a) i)) e))))
  (= (has_key (model__ m) e) true)))))

;; H
  (assert
  (= find_map__find_upto__find_map_bad__result1 find_map__find_upto__find_map_bad__result2))

;; H
  (assert
  (= find_map__find_upto__find_map_bad__result3 find_map__find_upto__find_map_bad__result1))
...
;; H
  (assert
  (=> (= result true)
  (and (= o1 (get (model__ m) e))
  (and (in_range6 o1) (= o1 (get (model__ m) e))))))
...
;; H
  (assert
  (= (mk_int__ref result1) (mk_int__ref
                           find_map__find_upto__find_map_bad__result)))
...
;; H
  (assert
  (= (mk_int__ref find_map__find_upto__find_map_bad__result4) (mk_int__ref
                                                              find_map__find_upto__find_map_bad__result2)))

;; H
  (assert
  (= find_map__find_upto__find_map_bad__result5 find_map__find_upto__find_map_bad__result3))

;; H
  (assert (= find_map__find_upto__find_map_bad__result4 0))

;; H
  (assert (<= (to_rep1 (first (rt a))) last2))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= 1 (to_rep1 (first (rt a))))))
(check-sat)
(exit)
