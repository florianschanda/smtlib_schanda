...
(declare-fun mutable__t__k__first__bit () Int)

(declare-fun mutable__t__k__last__bit () Int)

(declare-fun mutable__t__k__position () Int)
...
(declare-fun mutable__t__som__first__bit () Int)

(declare-fun mutable__t__som__last__bit () Int)

(declare-fun mutable__t__som__position () Int)
...
(declare-fun mutable__t__arr__first__bit () Int)

(declare-fun mutable__t__arr__last__bit () Int)

(declare-fun mutable__t__arr__position () Int)
...
(define-fun dynamic_invariant2 ((temp___expr_139 Int)
...
;; H
  (assert
  (and (= us (to_rep1 (rec__mutable__t__k (us_split_discrs1 x)))) (in_range1
  (to_rep1 (rec__mutable__t__k (us_split_discrs1 x))))))

;; H
  (assert (=> (<= (- 2147483648) 2147483647) (in_range z)))

;; H
  (assert (< 0 (to_rep1 (rec__mutable__t__k (us_split_discrs1 x)))))

(assert
;; WP_parameter_def
 ;; File "mutable.ads", line 9, characters 0-0
  (not
  (<= (to_rep2 (first (rt (rec__mutable__t__arr (us_split_fields1 x))))) 1)))
(check-sat)
(exit)
