...
(declare-fun loop_types__lists__replace_element__container__fields () us_split_fields)
...
;; H
  ...
  (= (bool_eq3 update_list_zero__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i) (ite (<= 
                                                                   (get
                                                                   (model__
                                                                   (mk___rep
                                                                   l__split_discrs
...
;; H
  (assert
  (=> (= result2 true) (= result3 (mk___split_fields__ref l__split_fields1))))
...
;; H
  (assert
  (=> (not (= result2 true))
  (= loop_types__lists__replace_element__container__fields rho)))
...
;; WP_parameter_def
 ;; File "update_list_zero.adb", line 5, characters 0-0
  ...
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields2))
     (mk___rep1 cu__split_fields2)) true)
  (= (bool_eq3 (mk___rep1 cu__split_fields2) no_element) true))))
(check-sat)
