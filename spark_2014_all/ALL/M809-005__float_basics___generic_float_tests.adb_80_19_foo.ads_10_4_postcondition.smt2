...
(declare-fun foo__float_tests__underflow_1__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun foo__float_tests__underflow_1__result1 () t)

(declare-fun foo__float_tests__underflow_1__result2 () t)

(declare-fun foo__float_tests__underflow_1__result3 () t)

(declare-fun foo__float_tests__underflow_1__result4 () t)

(declare-fun foo__float_tests__underflow_1__result5 () t)
...
;; H
  (assert (and (lt fliteral2 a) (lt fliteral2 b)))

;; H
  (assert
  (= foo__float_tests__underflow_1__result1 foo__float_tests__underflow_1__result2))

;; H
  (assert
  (= foo__float_tests__underflow_1__result3 foo__float_tests__underflow_1__result1))

;; H
  (assert (and (= o (div1 RNE1 a b)) (tqtisFinite (div1 RNE1 a b))))

;; H
  (assert (= result foo__float_tests__underflow_1__result))

;; H
  (assert (= foo__float_tests__underflow_1__result1 o))

;; H
  (assert
  (= (mk_t__ref foo__float_tests__underflow_1__result4) (mk_t__ref
                                                        foo__float_tests__underflow_1__result2)))

;; H
  (assert
  (= foo__float_tests__underflow_1__result5 foo__float_tests__underflow_1__result3))

;; H
  (assert (= result1 foo__float_tests__underflow_1__result4))

(assert
;; WP_parameter_def
 ;; File "generic_float_tests.ads", line 2, characters 0-0
  (not (lt fliteral2 foo__float_tests__underflow_1__result4)))
(check-sat)
