...
(declare-fun p__split_fields8 () us_split_fields10)

(declare-fun f1 () (Array Int partition_index))

(declare-fun a8 () map__ref)

(declare-fun d__split_fields8 () us_split_fields__ref3)

(declare-fun p__split_fields9 () us_split_fields__ref5)

(declare-fun f2 () map__ref5)

(declare-fun c__split_fields8 () us_split_fields__ref)

(declare-fun a9 () (Array Int positive))

(declare-fun d__split_fields9 () us_split_fields6)

(declare-fun p__split_fields10 () us_split_fields10)

(declare-fun f3 () (Array Int partition_index))

(declare-fun c__split_fields9 () us_split_fields)
...
;; H
  ...
  (=>
  (and (<= 0 j1)
  (<= j1 (- (length1 (mk___rep5 p__split_discrs p__split_fields3)) 1)))
  (forall ((k Int))
  (=>
  (and
  (<= (to_rep2
      (rec__partition_refinement__interval__first
      (us_split_fields9
      (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) j1)))) k)
  (<= k (to_rep2
        (rec__partition_refinement__interval__last
        (us_split_fields9
        (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) j1))))))
  (= (to_rep4 (select f k)) j1)))))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 0 j1) (<= j1 5))
  (and (<= 0 (to_rep4 (select f1 j1)))
  (<= (to_rep4 (select f1 j1)) (- (length1
                                  (mk___rep5 p__split_discrs
                                  p__split_fields8)) 1)))))
  (and
  (forall ((j1 Int))
  ...
  (<= (to_rep2
      (rec__partition_refinement__interval__first
      (us_split_fields9
      (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields8))
      (to_rep4 (select f1 j1)))))) j1)
  (<= j1 (to_rep2
         (rec__partition_refinement__interval__last
         (us_split_fields9
         (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields8))
         (to_rep4 (select f1 j1))))))))))
  (forall ((j1 Int))
  (=>
  (and (<= 0 j1)
  (<= j1 (- (length1 (mk___rep5 p__split_discrs p__split_fields8)) 1)))
  (forall ((k Int))
  (=>
  (and
  (<= (to_rep2
      (rec__partition_refinement__interval__first
      (us_split_fields9
      (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields8)) j1)))) k)
  (<= k (to_rep2
        (rec__partition_refinement__interval__last
        (us_split_fields9
        (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields8)) j1))))))
  (= (to_rep4 (select f1 k)) j1))))))))
...
;; H
  (assert (= p__split_fields9 (mk___split_fields__ref5 p__split_fields8)))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 0 j1) (<= j1 5))
  (and (<= 0 (to_rep4 (select (map__content5 f2) j1)))
  (<= (to_rep4 (select (map__content5 f2) j1)) (- (length1
                                                  (mk___rep5 p__split_discrs
...
;; H
  ...
  (= o2 (get5
        (model__2
        (mk___rep5 p__split_discrs
        (us_split_fields__content5 p__split_fields9)))
        (to_rep4 (select (map__content5 f2) j))))
  (= (bool_eq10 o2
     (get5
     (model__2
     (mk___rep5 p__split_discrs (us_split_fields__content5 p__split_fields9)))
     (to_rep4 (select (map__content5 f2) j)))) true)))

;; H
  (assert (= o3 (us_split_fields9 o2)))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 807, characters 0-0
  (not (<= 0 (to_rep4 (select (map__content5 f2) j)))))
(check-sat)
(exit)
