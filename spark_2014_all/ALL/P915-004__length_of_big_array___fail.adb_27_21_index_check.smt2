...
(((mk_map__ref1 (map__content1 (Array (_ BitVec 64) Bool))))))
...
(declare-datatypes ((a__ref 0)) (((mk_a__ref (a__content us_t1)))))
...
;; temp___String_Literal_645__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     (= (to_rep (select (temp___String_Literal_645 us_void_param) 1)) 63)
     (= (to_rep (select (temp___String_Literal_645 us_void_param) 2)) 63))
     (= (to_rep (select (temp___String_Literal_645 us_void_param) 3)) 63)) :pattern (
  (temp___String_Literal_645 us_void_param)) )))
...
(define-fun dynamic_invariant5 ((temp___expr_286 (_ BitVec 64))
...
;; H
  (assert
  (and (bvule (to_rep2 (first2 (rt1 c))) ((_ int2bv 64) 0))
  (bvule ((_ int2bv 64) 0) (to_rep2 (last2 (rt1 c))))))

;; H
  (assert (= o ((_ int2bv 64) 0)))
...
;; WP_parameter_def
 ;; File "fail.adb", line 14, characters 0-0
  (not
  (bvule (to_rep2 (first2 (rt1 c))) ((_ int2bv 64) 18446744073709551615))))
(check-sat)
(exit)
