...
(declare-datatypes ((d_simple_0__ref 0))
(((mk_d_simple_0__ref (d_simple_0__content us_rep)))))
...
(define-fun us_split_fields_Content__3__projection ((a us_split_fields2)) us_rep
...
(declare-datatypes ((d_holder_0__ref 0))
(((mk_d_holder_0__ref (d_holder_0__content us_rep1)))))
...
;; WP_parameter_def
 ;; File "use_private_types.ads", line 37, characters 0-0
  (not (or (= (to_rep s__split_fields) 0) (not (= s__split_fields2 true)))))
(check-sat)
(exit)
