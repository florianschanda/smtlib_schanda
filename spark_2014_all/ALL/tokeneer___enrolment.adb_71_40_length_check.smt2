...
(declare-const temp___1055 (Array Int character))

(declare-const temp___10551 t)
...
(declare-const temp___10611 t1)

(declare-const o18 (Array Int character))

(declare-const temp___1064 (Array Int character))

(declare-const temp___10641 t1)
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first (rt thedesc))) (to_rep1 (last (rt thedesc))))
     (+ (- (to_rep1 (last (rt thedesc))) (to_rep1 (first (rt thedesc)))) 1)
     0) (ite (<= 1 (to_rep1 (last (rt thedesc))))
        (+ (- (to_rep1 (last (rt thedesc))) 1) 1) 0)))

;; H
  (assert
  (= (slide (elts thedesc) (to_rep1 (first (rt thedesc))) 1) temp___1061))

;; H
  (assert (= (mk1 1 (to_rep1 (last (rt thedesc)))) temp___10611))

;; H
  (assert
  (=> (<= 1 (to_rep1 (last (rt thedesc))))
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 (to_rep1 (last (rt thedesc))))
  (<= (to_rep1 (last (rt thedesc))) 150)))))

;; H
  (assert (= o18 result__1))

;; H
  (assert (= o18 temp___1064))

;; H
  (assert (= (mk1 1 (to_rep1 (last (rt thedesc)))) temp___10641))

(assert
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___10611)) (to_rep1 (last2 temp___10611)))
     (+ (- (to_rep1 (last2 temp___10611)) (to_rep1 (first2 temp___10611))) 1)
     0) (ite (<= (to_rep1 (first2 temp___10641)) (to_rep1
                                                 (last2 temp___10641)))
        (+ (- (to_rep1 (last2 temp___10641)) (to_rep1 (first2 temp___10641))) 1)
        0))))
(check-sat)
(exit)
