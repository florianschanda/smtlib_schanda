...
(declare-datatypes ()
((tT24bP1__ref (mk_tT24bP1__ref (tT24bP1__content tdigit_count_typeB)))))
(define-fun tT24bP1__ref___projection ((a tT24bP1__ref)) tdigit_count_typeB
  (tT24bP1__content a))
...
(declare-datatypes ()
((t25b__ref (mk_t25b__ref (t25b__content tdigit_count_typeB)))))
(define-fun t25b__ref___projection ((a t25b__ref)) tdigit_count_typeB
  (t25b__content a))
