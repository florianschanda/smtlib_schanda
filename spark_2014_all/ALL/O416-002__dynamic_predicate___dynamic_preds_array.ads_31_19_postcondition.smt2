...
(declare-const dynamic_preds_array__get_constant_even_pair__result (Array Int even))
...
(declare-const dynamic_preds_array__get_constant_even_pair__result1 (Array Int even))

(declare-const dynamic_preds_array__get_constant_even_pair__result2 (Array Int even))

(declare-const dynamic_preds_array__get_constant_even_pair__result3 (Array Int even))

(declare-const result__3 (Array Int even))

(declare-const dynamic_preds_array__get_constant_even_pair__result4 (Array Int even))

(declare-const result__4 (Array Int even))

(declare-const dynamic_preds_array__get_constant_even_pair__result5 (Array Int even))
