...
(declare-fun temp___3331 ((Array Int (Array Int (Array Int et1))) Int
  (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))

;; def_axiom
  (assert
  (forall ((temp___3333 (Array Int (Array Int (Array Int et1)))))
  (forall ((temp___3334 Int))
  (forall ((temp___3335 (Array Int (Array Int et1))))
  (let ((temp___3332 (temp___3331 temp___3333 temp___3334 temp___3335)))
  (forall ((temp___3336 Int))
  (ite (= temp___3336 temp___3334)
  (= (select temp___3332 temp___3336) temp___3335)
  (= (select temp___3332 temp___3336) (select temp___3333 temp___3336)))))))))

(declare-fun temp___3337 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___3339 (Array Int (Array Int et1))))
  (forall ((temp___3340 Int))
  (forall ((temp___3341 (Array Int et1)))
  (let ((temp___3338 (temp___3337 temp___3339 temp___3340 temp___3341)))
  (forall ((temp___3342 Int))
  (ite (= temp___3342 temp___3340)
  (= (select temp___3338 temp___3342) temp___3341)
  (= (select temp___3338 temp___3342) (select temp___3339 temp___3342)))))))))

(declare-fun temp___3344 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3346 (Array Int et1)))
  (forall ((temp___3347 Int) (temp___3348 Int))
  (let ((temp___3345 (temp___3344 temp___3346 temp___3347 temp___3348)))
  (forall ((temp___3349 Int))
  (ite (= temp___3349 temp___3347)
  (= (select temp___3345 temp___3349) (of_rep temp___3348))
  (= (select temp___3345 temp___3349) (select temp___3346 temp___3349))))))))
...
(declare-fun temp___8464 () enum1tb)

(declare-fun temp___84641 () (Array Int (Array Int (Array Int et1))))

(declare-fun temp___84642 () Bool)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1579, characters 0-0
  (not
  (= (bool_eq2 r__split_fields7 1 16
     (temp___3331 r__split_fields1 i
     (temp___3337 (select r__split_fields1 i) j
     (temp___3344 (select (select r__split_fields1 i) j) k e))) 1 16) true)))
(check-sat)
(exit)
