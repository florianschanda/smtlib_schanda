...
(define-fun f__split_fields6 () us_split_fields__ref2 (mk___split_fields__ref2
                                                      (mk___split_fields2
                                                      f__split_fields
                                                      f__split_fields1)))
...
;; H
  (assert (=> (= d 0) (= temp___808 o10)))

;; H
  (assert (=> (= d 0) (= temp___8081 o11)))

;; H
  (assert (=> (= d 0) (= result1 f__split_fields6)))

;; H
  (assert
  (=> (= d 0)
  (= f__split_fields2 (mk___split_fields2 temp___808 temp___8081))))
...
;; H
  (assert (=> (not (= d 0)) (= temp___803 o22)))

;; H
  (assert (=> (not (= d 0)) (= temp___8031 o23)))

;; H
  (assert (=> (not (= d 0)) (= result2 f__split_fields6)))

;; H
  (assert
  (=> (not (= d 0))
  (= f__split_fields3 (mk___split_fields2 temp___803 temp___8031))))
...
;; H
  (assert
  (= o34 (store (rec__binary_trees__forest__c f__split_fields2) o33 (mk___rep1
                                                                    (mk___split_fields1
                                                                    o29 
                                                                    o30 
                                                                    o31 
...
;; H
  (assert
  (= o35 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields2)
         o34)))

;; H
  (assert (= temp___813 (mk___rep2 o35)))

;; H
  (assert (= result3 (mk___split_fields__ref2 f__split_fields2)))

;; H
  (assert (= f__split_fields4 (us_split_fields5 temp___813)))
...
;; H
  ...
  (= o37 (mk___split_fields1
         (rec__binary_trees__cell__left
         (us_split_fields3
         (select (rec__binary_trees__forest__c f__split_fields4) v)))
         (rec__binary_trees__cell__right
         (us_split_fields3
         (select (rec__binary_trees__forest__c f__split_fields4) v))) 
         o36
...
;; H
  (assert
  (= o40 (store (rec__binary_trees__forest__c f__split_fields4) o39 o38)))

;; H
  (assert
  (= o41 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields4)
         o40)))

;; H
  (assert (= temp___818 (mk___rep2 o41)))

;; H
  (assert (= result4 (mk___split_fields__ref2 f__split_fields4)))

;; H
  (assert (= f__split_fields5 (us_split_fields5 temp___818)))

;; H
  (assert
  (and (= (tree_structure (mk___rep2 f_old__split_fields2)) true)
  (= (tree_structure (mk___rep2 f__split_fields5)) true)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (to_rep (rec__binary_trees__forest__s f__split_fields5)) (to_rep
                                                              (rec__binary_trees__forest__s
