...
(declare-fun pack__p5__r__x__first__bit () Int)

(declare-fun pack__p5__r__x__last__bit () Int)

(declare-fun pack__p5__r__x__position () Int)
...
(declare-fun pack__p5__r__y__first__bit () Int)

(declare-fun pack__p5__r__y__last__bit () Int)

(declare-fun pack__p5__r__y__position () Int)
...
(declare-fun pack__p5__r__z__first__bit () Int)

(declare-fun pack__p5__r__z__last__bit () Int)

(declare-fun pack__p5__r__z__position () Int)
