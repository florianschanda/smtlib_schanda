...
;; H
  ...
  (= (bool_eq1 use_sets__move_2__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  (assert
  (and (= o1 (length (mk___rep s2__split_discrs s2__split_fields3)))
  (and (in_range2 o1)
  (<= o1 (to_rep1 (rec__use_sets__my_sets__set__capacity s2__split_discrs))))))
