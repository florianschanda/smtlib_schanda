...
(declare-fun p__xs__assume () (_ BitVec 8))

(declare-fun p__a__assume () (_ BitVec 8))
...
;; H
  (assert
  (and (= p__xs__assume (bvurem (bvsub u v) ((_ int2bv 8) 16))) (in_range3
  (bvurem (bvsub u v) ((_ int2bv 8) 16)))))
