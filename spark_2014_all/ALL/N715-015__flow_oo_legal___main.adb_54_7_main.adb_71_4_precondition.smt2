...
;; WP_parameter_def
 ;; File "main.adb", line 8, characters 0-0
  ...
  (= (is_alive
     (mk___rep
     (mk___split_fields (rec__people__person__name1 rambo__split_fields20)
     (rec__people__person__dob1 rambo__split_fields20)
     (rec__people__person__alive1 rambo__split_fields20)
     (hide_ext__
     (rec__professionals__professional__profession rambo__split_fields20)
     (rec__professionals__professional__skilled_in rambo__split_fields20)
     (rec__professionals__professional__number_of_people_killed
     rambo__split_fields20) (rec__ext__1 rambo__split_fields20)))
