...
;; H
  (assert (<= 1 (to_rep1 (rec__stacks__stack__top (us_split_fields1 s)))))

;; H
  (assert (<= (to_rep1 (rec__stacks__stack__top (us_split_fields1 s))) 100))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= 1 (to_rep1 (rec__stacks__stack__top (us_split_fields1 s))))))
(check-sat)
(exit)
