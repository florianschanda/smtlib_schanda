...
;; temp___String_Literal_143__def_axiom
  ...
  (! (and
     ...
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 2)) 108))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 3)) 97))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 4)) 114))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 5)) 109))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 6)) 46))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 7)) 97))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 8)) 99))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 9)) 116))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 10)) 105))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 11)) 118))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 12)) 97))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 13)) 116))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 14)) 101))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 15)) 40))
     (= (to_rep (select (temp___String_Literal_143 us_void_param) 16)) 41)) :pattern (
...
(declare-fun temp___625 () (Array Int character))

(declare-fun temp___6251 () messagelengtht)

(declare-fun temp___624 () (Array Int character))

(declare-fun temp___6241 () t)
...
;; H
  (assert
  (and
  (= temp___6242 (overwrite
                 (mk___t
                 (rec__tcpip__messaget__data (us_split_fields1 nullmsg))
                 (mk 1 4096)) 1
                 (mk___t (temp___String_Literal_143 Tuple0) (mk 1 16))))
  (dynamic_invariant1 temp___6242 true false true)))

(assert
;; WP_parameter_def
 ;; File "alarmapi.ads", line 38, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___6241)) (to_rep1 (last temp___6241)))
     (+ (- (to_rep1 (last temp___6241)) (to_rep1 (first temp___6241))) 1) 0)
