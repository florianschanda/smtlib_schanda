...
;; H
  (assert (=> (= result5 true) (= o6 i)))

;; H
  (assert (=> (= result5 true) (= o7 (select (elts a) o6))))

;; H
  (assert (=> (= result5 true) (= o8 (to_rep o7))))
...
;; H
  (assert (=> (= result5 true) (= o10 (ite (<= o9 i) true false))))
...
;; H
  (assert (=> (= result5 true) (= o2 i)))

;; H
  (assert (=> (= result5 true) (= o3 (select (elts a) o2))))

;; H
  (assert (=> (= result5 true) (= o4 (to_rep o3))))
...
;; H
  (assert
  (=> (= result5 true)
  (= o11 (ite (<= (to_rep1 (first (rt a))) o5) true false))))

;; H
  (assert (=> (= result5 true) (= result4 (ite (= o11 true) o10 false))))
