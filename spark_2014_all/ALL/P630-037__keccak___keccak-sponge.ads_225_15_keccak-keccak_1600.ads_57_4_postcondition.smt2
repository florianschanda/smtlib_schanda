...
;; H
  (assert
  (=> (< 0 (int__content remaining7)) (= o58 (+ (to_rep digest__first) o57))))
...
;; H
  (assert
  (=> (< 0 (int__content remaining7))
  (= temp___965 (mk___t10 o59 (mk10 0 r165s)))))
...
;; H
  (assert
  (=> (< 0 (int__content remaining7)) (= o60 (map__content digest7))))

;; H
  (assert
  (=> (< 0 (int__content remaining7))
  (= temp___967 (mk___t9 o60 (mk9 r161s r162s)))))
...
;; H
  (assert
  (=> (< 0 (int__content remaining7))
  (and (= o62 (int__content remaining7)) (in_range6
...
;; H
  (assert
  (=> (< 0 (int__content remaining7))
  (= o64 (mk___split_fields
         (rec__keccak__keccak_1600__sponge__context__state
         (us_split_fields__content ctx__split_fields20))
         (rec__keccak__keccak_1600__sponge__context__block
         (us_split_fields__content ctx__split_fields20))
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
         (us_split_fields__content ctx__split_fields20)) o63
         (rec__keccak__keccak_1600__sponge__context__rate
         (us_split_fields__content ctx__split_fields20))
         (rec__keccak__keccak_1600__sponge__context__curr_state
         (us_split_fields__content ctx__split_fields20))))))
