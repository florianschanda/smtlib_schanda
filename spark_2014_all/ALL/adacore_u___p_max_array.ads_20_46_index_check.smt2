...
;; H
  (assert
  (and (= o17 (- k (to_rep1 a__first))) (in_range1 (- k (to_rep1 a__first)))))

;; H
  (assert (= o18 (+ o17 (to_rep1 (first (rt b))))))

;; H
  (assert (and (= temp___288 o18) (in_range1 o18)))

(assert
;; WP_parameter_def
 ;; File "p_max_array.ads", line 3, characters 0-0
  (not (<= (to_rep1 (first (rt b))) temp___288)))
(check-sat)
(exit)
