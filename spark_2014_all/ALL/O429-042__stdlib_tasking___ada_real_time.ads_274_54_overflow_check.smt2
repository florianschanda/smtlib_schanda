...
(declare-fun o6 () duration)

(declare-fun o7 () duration)
...
;; H
  (assert (and (= o18 (* 3 9223372036)) (in_range2 (* 3 9223372036))))

;; H
  (assert (= o19 (ite (<= sc o18) true false)))

;; H
  (assert
  (and (= o17 (* 3 (- 9223372036))) (in_range2 (* 3 (- 9223372036)))))

;; H
  (assert (= o20 (ite (<= o17 sc) true false)))

;; H
  (assert (= result (ite (= o20 true) o19 false)))
...
;; H
  (assert
  (and (= o12 (- (- 9223372036) 1)) (in_range2 (- (- 9223372036) 1))))

;; H
  (assert (= o16 (ite (<= o12 o11) true false)))

;; H
  (assert (= result1 (ite (= o16 true) o15 false)))
