...
;; H
  (assert (= o21 (from_integer j3)))

;; H
  (assert (= o25 (ole o21 o24)))

;; H
  (assert (and (= o19 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o20 (ite (<= j3 o19) true false)))

;; H
  (assert (= o17 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o18 (oexpon o17 j3)))

;; H
  (assert (= o13 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o12 (from_integer j3)))

;; H
  (assert (= o14 (osubtract o12 o13)))

;; H
  (assert (= o11 (from_word64 i2)))

;; H
  (assert (= o15 (osubtract o11 o14)))

;; H
  (assert (= o10 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o16 (oexpon__2 o10 o15)))
