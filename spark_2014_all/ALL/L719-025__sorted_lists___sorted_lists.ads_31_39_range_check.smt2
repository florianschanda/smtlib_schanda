...
;; H
  (assert (= result6 (ite (= o17 new_item) true false)))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o13 j) true)
  (=> (= (get1 o13 i2) (get1 o13 j)) (= (bool_eq1 i2 j) true))))))))))
...
;; H
  (assert (= result8 (ite (<= 1 i1) o16 false)))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o3 j) true)
  (=> (= (get1 o3 i2) (get1 o3 j)) (= (bool_eq1 i2 j) true))))))))))
...
;; H
  (assert (and (= o12 (get o10 o11)) (in_range5 o12)))
