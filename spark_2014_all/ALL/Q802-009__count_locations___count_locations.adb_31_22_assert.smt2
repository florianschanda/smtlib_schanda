...
;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100))
  (=> (= (select sel st2) true) (= st_count2 result3))))

;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100))
  (=> (= (select sel st2) true) (= st_count3 o))))
...
;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100))
  (=> (not (= (select sel st2) true)) (= lowest_max3 lowest_max2))))

;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100))
  (=> (not (= (select sel st2) true)) (= st_count3 st_count2))))
...
;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100)) (= (mk_int__ref st5) (mk_int__ref st3))))

;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100))
  (= (mk_int__ref lowest_max6) (mk_int__ref lowest_max4))))

;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100))
  (= (mk_int__ref st_count6) (mk_int__ref st_count4))))
...
;; H
  (assert
  (=> (not (and (<= 1 st1) (<= st1 100))) (= lowest_max1 lowest_max6)))
...
;; H
  (assert
  (=> (not (and (<= 1 st1) (<= st1 100))) (= lowest_max7 lowest_max1)))
...
;; WP_parameter_def
 ;; File "count_locations.ads", line 22, characters 0-0
  (not (= st_count6 (count_selected_locations sel))))
(check-sat)
(exit)
