...
(declare-fun o33 () name_id)

(declare-fun o34 () (Array (_ BitVec 32) name_id))
...
(declare-fun c344b4 () int__ref)

(declare-fun char_table__split_fields5 () us_split_fields2)

(declare-fun c344b5 () Int)

(declare-fun char_table__split_fields6 () us_split_fields__ref1)

(declare-fun c344b6 () int__ref)

(declare-fun char_table__split_fields7 () us_split_fields2)

(declare-fun c344b7 () Int)

(declare-fun names__entry_tables__append__2__container__fields () us_split_fields)

(declare-fun result9 () us_split_fields__ref)

(declare-fun entry_table__split_fields2 () us_split_fields)

(declare-fun result10 () int__ref)

(declare-fun n12 () Int)

(declare-fun names__entry_tables__replace_element__container__fields () us_split_fields)

(declare-fun result11 () us_split_fields__ref)

(declare-fun entry_table__split_fields3 () us_split_fields)

(declare-fun result12 () map__ref1)

(declare-fun hash_table2 () (Array (_ BitVec 32) name_id))

(declare-fun hash_table3 () map__ref1)

(declare-fun entry_table__split_fields4 () us_split_fields__ref)

(declare-fun hash_table4 () (Array (_ BitVec 32) name_id))

(declare-fun entry_table__split_fields5 () us_split_fields)

(declare-fun n13 () int__ref)

(declare-fun hash_table5 () map__ref1)

(declare-fun char_table__split_fields8 () us_split_fields__ref1)

(declare-fun entry_table__split_fields6 () us_split_fields__ref)

(declare-fun ptr12 () int__ref)

(declare-fun c344b8 () int__ref)

(declare-fun n14 () Int)

(declare-fun hash_table6 () (Array (_ BitVec 32) name_id))

(declare-fun char_table__split_fields9 () us_split_fields2)

(declare-fun entry_table__split_fields7 () us_split_fields)

(declare-fun ptr13 () Int)

(declare-fun c344b9 () Int)

(declare-fun n15 () int__ref)

(declare-fun hash_table7 () map__ref1)

(declare-fun char_table__split_fields10 () us_split_fields__ref1)

(declare-fun entry_table__split_fields8 () us_split_fields__ref)

(declare-fun ptr14 () int__ref)

(declare-fun c344b10 () int__ref)

(declare-fun n16 () Int)

(declare-fun hash_table8 () (Array (_ BitVec 32) name_id))

(declare-fun char_table__split_fields11 () us_split_fields2)

(declare-fun entry_table__split_fields9 () us_split_fields)

(declare-fun ptr15 () Int)

(declare-fun c344b11 () Int)

(declare-fun n17 () int__ref)

(declare-fun hash_table9 () map__ref1)

(declare-fun char_table__split_fields12 () us_split_fields__ref1)

(declare-fun entry_table__split_fields10 () us_split_fields__ref)

(declare-fun ptr16 () int__ref)

(declare-fun c344b12 () int__ref)

(declare-fun n18 () Int)

(declare-fun hash_table10 () (Array (_ BitVec 32) name_id))

(declare-fun char_table__split_fields13 () us_split_fields2)

(declare-fun entry_table__split_fields11 () us_split_fields)

(declare-fun ptr17 () Int)

(declare-fun c344b13 () Int)
...
(define-fun entry_table__split_fields12 () us_split_fields__ref (mk___split_fields__ref
                                                                (mk___split_fields
                                                                entry_table__split_fields)))

(define-fun char_table__split_fields14 () us_split_fields__ref1 (mk___split_fields__ref1
                                                                (mk___split_fields1
...
;; H
  ...
  (and
  (and (= c344b10 c344b14)
  (and (= ptr14 (mk_int__ref ptr1))
  (and (= entry_table__split_fields8 entry_table__split_fields12)
  (and (= char_table__split_fields10 char_table__split_fields14)
  (and (= hash_table7 hash_table11) (= n15 (mk_int__ref n2)))))))
  (and (= c344b11 c344b1)
  (and (= ptr15 ptr1)
  (and (= entry_table__split_fields9 entry_table__split_fields1)
  (and (= char_table__split_fields11 char_table__split_fields1)
  (and (= hash_table8 hash_table1) (= n16 n2)))))))
  (and (= (length s) 0) (and (= result1 (mk_int__ref n)) (= n2 0))))
  (and (and (not (= (length s) 0)) (and (= n2 n) (= n2 n1)))
  (and
  (and
  (and (= c344b10 c344b8)
  (and (= ptr14 ptr12)
  (and (= entry_table__split_fields8 entry_table__split_fields6)
  (and (= char_table__split_fields10 char_table__split_fields8)
  (and (= hash_table7 hash_table5) (= n15 n13))))))
  (and (= c344b11 c344b9)
  (and (= ptr15 ptr13)
  (and (= entry_table__split_fields9 entry_table__split_fields7)
  (and (= char_table__split_fields11 char_table__split_fields9)
  (and (= hash_table8 hash_table6) (= n16 n14)))))))
  (and
  (and (= result2 (mk_int__ref n2)) (= n3 (to_rep3 (select hash_table h))))
  (or
  (and
  (and
  (and (= c344b8 c344b14)
  (and (= ptr12 (mk_int__ref ptr3))
  (and (= entry_table__split_fields6 entry_table__split_fields12)
  (and (= char_table__split_fields8 char_table__split_fields14)
  (and (= hash_table5 hash_table11) (= n13 (mk_int__ref n5)))))))
  (and (= c344b9 c344b1)
  (and (= ptr13 ptr3)
  (and (= entry_table__split_fields7 entry_table__split_fields1)
  (and (= char_table__split_fields9 char_table__split_fields1)
  (and (= hash_table6 hash_table1) (= n14 n5)))))))
  (and (in_range9 n3)
  (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3))
  (and (= temp___430 n3)
  (and (= temp___429 ptr2)
  (and
  ...
  (= result4 (bool_eq temp___428 (to_rep1 (first temp___4281))
             (to_rep1 (last temp___4281)) (elts s) (to_rep1 (first (rt s)))
             (to_rep1 (last (rt s))))))
  (and (= result4 true) (and (= result5 (mk_int__ref n4)) (= n5 ptr3))))))))))
  (and
  (ite (in_range9 n3)
  (and
  (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3))
  ...
  (= result4 (bool_eq temp___428 (to_rep1 (first temp___4281))
             (to_rep1 (last temp___4281)) (elts s) (to_rep1 (first (rt s)))
             (to_rep1 (last (rt s))))))
  (and (not (= result4 true)) (= n5 n4)))
  (and (and (= ptr4 (mk_int__ref ptr3)) (= ptr5 ptr3))
  (and
  (and
  (and
  (and
  (and
  (and (and (= o2 ptr3) (in_range14 ptr3))
  (and
  (= o35 (get1
         (model__1
  ...
  (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o8)) (= o10 (to_rep3 o9)))
  (= result6 (ite (= o10 0) true false))) (= result6 true)))))))
  (and (and (= ptr6 ptr4) (= n6 (mk_int__ref n5)))
  (and (= ptr7 ptr5) (= n7 n5))))
  (and (and (= ptr8 ptr6) (= n8 n6)) (and (= ptr9 ptr7) (= n9 n7)))))
  (and (and (= ptr10 ptr8) (= n10 n8)) (and (= ptr11 ptr9) (= n11 n9))))
  (and (and (= ptr10 (mk_int__ref ptr1)) (= n10 (mk_int__ref n3)))
  (and (= ptr11 ptr1) (= n11 n3))))
  (and
  (and
  (and (= c344b8 c344b6)
  (and (= ptr12 ptr10)
  (and (= entry_table__split_fields6 entry_table__split_fields4)
  (and (= char_table__split_fields8 char_table__split_fields6)
  (and (= hash_table5 hash_table3) (= n13 (mk_int__ref n12)))))))
  (and (= c344b9 c344b7)
  (and (= ptr13 ptr11)
  (and (= entry_table__split_fields7 entry_table__split_fields5)
  (and (= char_table__split_fields9 char_table__split_fields7)
  (and (= hash_table6 hash_table4) (= n14 n12)))))))
  (and
  (and (and (= result7 c344b14) (= c344b2 (to_rep1 (first (rt s)))))
  (ite (and (<= (to_rep1 (first (rt s))) c344b2)
  ...
  (and
  (and (<= (to_rep1 (first (rt s))) c344b3)
  (<= c344b3 (to_rep1 (last (rt s)))))
  (and
  (and
  (and
  (and
  ...
  (to_rep (select (elts s) c344b3))))
  (and (= result8 (mk___split_fields__ref1 char_table__split_fields2))
  (= char_table__split_fields3 names__char_tables__append__2__container__fields)))
  (= c344b3 (to_rep1 (last (rt s)))))))
  (and
  (and (= c344b4 (mk_int__ref c344b3))
  ...
  (and
  (and (= c344b6 (mk_int__ref c344b2))
  (= char_table__split_fields6 char_table__split_fields14))
  (and (= c344b7 c344b2)
  ...
  (and (= (to_rep3 o18) 0)
  (and
  (and (and (= o17 (length s)) (in_range2 (length s))) (= (to_rep2 o19) o17))
  (and
  (and
  (and
  (and
  (and
  (and (and (= o11 (length s)) (in_range11 (length s))) (= o12 (- o11 1)))
  (and
  (and
  (= o13 (last2
         (model__
  ...
  (= o13 (last2
         ...
         (mk___rep1 char_table__split_discrs
         (us_split_fields__content1 char_table__split_fields6)))))))
  (= o14 (- o13 o12)))) (and (= o15 o14) (in_range11 o14)))
  (and (= o16 o15) (in_range12 o15))) (= (to_rep6 o20) o16))
  (and (= o20 o21) (and (= o19 o22) (= o18 o23))))))
  (and (= o24 o21) (and (= o25 o22) (= o26 o23))))
  (and
  (and
  (= (length4
     (mk___rep entry_table__split_discrs
  ...
  (and (= result9 entry_table__split_fields12)
  (= entry_table__split_fields2 names__entry_tables__append__2__container__fields)))
  (and
  (and
  (and
  (= o27 (last3
         (model__1
         (mk___rep entry_table__split_discrs entry_table__split_fields2))))
  (and (in_range15 o27)
  (= o27 (last3
         (model__1
         (mk___rep entry_table__split_discrs entry_table__split_fields2))))))
  (and (= result10 n10) (= n12 o27)))
  (ite (in_range9 (int__content ptr10))
  (and
  (and
  (and
  (and
  (and (and (= o29 (int__content ptr10)) (in_range14 (int__content ptr10)))
  (and
  (= temp___436 (get1
                (model__1
                (mk___rep entry_table__split_discrs
                entry_table__split_fields2)) o29))
  (= (bool_eq4 temp___436
     (get1
     (model__1
     (mk___rep entry_table__split_discrs entry_table__split_fields2))
  ...
  (= o31 (mk___split_fields2
         ...
         o30)))
  (= o32 (mk___rep2 o31))))
  (and (and (= o28 (int__content ptr10)) (in_range14 (int__content ptr10)))
  (and
  (and
  (= (length4
     (mk___rep entry_table__split_discrs
     names__entry_tables__replace_element__container__fields)) (length4
                                                               (mk___rep
                                                               entry_table__split_discrs
                                                               entry_table__split_fields2)))
  (= (bool_eq4
     (get1
     (model__1
     (mk___rep entry_table__split_discrs
     names__entry_tables__replace_element__container__fields)) o28) o32) true))
  (= (equal_except
     (model__1
     (mk___rep entry_table__split_discrs entry_table__split_fields2))
     (model__1
     (mk___rep entry_table__split_discrs
     names__entry_tables__replace_element__container__fields)) o28) true))))
  (and (= result11 (mk___split_fields__ref entry_table__split_fields2))
  (= entry_table__split_fields3 names__entry_tables__replace_element__container__fields)))
  (and
  (and
  (= entry_table__split_fields4 (mk___split_fields__ref
                                entry_table__split_fields3))
  (= hash_table3 hash_table11))
  (and (= entry_table__split_fields5 entry_table__split_fields3)
  (= hash_table4 hash_table1))))
  (and
  (and (and (= (to_rep3 o33) n12) (= o34 (store hash_table h o33)))
  (and (= result12 hash_table11) (= hash_table2 o34)))
  (and
  (and
  (= entry_table__split_fields4 (mk___split_fields__ref
                                entry_table__split_fields2))
  (= hash_table3 (mk_map__ref1 hash_table2)))
  (and (= entry_table__split_fields5 entry_table__split_fields2)
  (= hash_table4 hash_table2)))))))))))))))))))
