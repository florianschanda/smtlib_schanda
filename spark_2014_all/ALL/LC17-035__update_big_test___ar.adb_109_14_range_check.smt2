...
;; def_axiom
  (assert
  (forall ((temp___4355 (Array Int et1)))
  (forall ((temp___4356 Int) (temp___4357 Int))
  (let ((temp___4354 (temp___4353 temp___4355 temp___4356 temp___4357)))
  (forall ((temp___4358 Int))
  (ite (= temp___4358 temp___4356)
  (= (select temp___4354 temp___4358) (of_rep temp___4357))
  (= (select temp___4354 temp___4358) (select temp___4355 temp___4358))))))))
...
;; H
  (assert (= (bool_eq a 1 10 (temp___4353 t i e) 1 10) true))
...
;; H
  (assert (=> (not (= i 10)) (and (= o (+ i 1)) (in_range1 (+ i 1)))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 174, characters 0-0
  (not (in_range2 (- e 1))))
(check-sat)
(exit)
