...
(define-fun o18 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o19 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  (assert
  (and
  (= o19 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o19)
