...
;; H
  (assert (= result13 (ite (in_range4 o63) true false)))
...
;; H
  (assert (=> (= result13 true) (= result14 (ite (< j o59) true false))))

;; H
  (assert
  (=> (= result13 true)
  (=> (= result14 true) (and (= o60 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  (assert (=> (= result13 true) (=> (not (= result14 true)) (= o61 0))))
...
;; H
  (assert (=> (= result13 true) (= o55 temp___400)))

;; H
  (assert (=> (= result13 true) (= o56 (select data3 o55))))

;; H
  (assert (=> (= result13 true) (= o57 (us_split_fields1 o56))))

;; H
  (assert
  (=> (= result13 true) (= o58 (rec__list_allocator__cell__next o57))))

;; H
  (assert (=> (= result13 true) (= o62 (to_rep o58))))

;; H
  (assert (=> (= result13 true) (= result12 (ite (= o62 o61) true false))))
...
;; H
  (assert (=> (= result12 true) (=> (not (< 1 j)) (= o53 0))))
...
;; H
  (assert (=> (= result12 true) (= o48 temp___401)))

;; H
  (assert (=> (= result12 true) (= o49 (select data3 o48))))

;; H
  (assert (=> (= result12 true) (= o50 (us_split_fields1 o49))))

;; H
  (assert
  (=> (= result12 true) (= o51 (rec__list_allocator__cell__prev o50))))

;; H
  (assert (=> (= result12 true) (= o54 (to_rep o51))))
