...
(define-fun tint_arrayD1__ref___14__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___14__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t511b__ref 0))
(((mk_t511b__ref (t511b__content integer)))))
...
(declare-datatypes ((t512b__ref 0))
(((mk_t512b__ref (t512b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___23__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___23__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t515b__ref 0))
(((mk_t515b__ref (t515b__content integer)))))
...
(declare-datatypes ((t516b__ref 0))
(((mk_t516b__ref (t516b__content us_t4)))))
...
(declare-datatypes ((t517b__ref 0))
(((mk_t517b__ref (t517b__content integer)))))
...
(define-fun tint_arrayB__ref___14__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___23__projection ((a tnumber_array_typeB__ref)) us_t6
