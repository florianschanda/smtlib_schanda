...
(declare-const temp___2741 (Array Int element))

(declare-const temp___2742 t)

(declare-const temp___2743 natural)

(declare-const temp___2744 us_private)

(declare-const temp___2745 Int)
...
;; H
  (assert (= this__split_discrs (mk___split_discrs temp___274)))

;; H
  (assert (= temp___2741 o2))

;; H
  (assert (= temp___2742 o3))

;; H
  (assert (= temp___2743 o4))

;; H
  (assert (= temp___2744 o5))

;; H
  (assert (= this__attr__tag temp___2745))

;; H
  (assert
  (= (mk___split_fields__ref
     (mk___split_fields (mk___t result result1) result2 result3)) (mk___split_fields__ref
                                                                  (mk___split_fields
                                                                  (mk___t
                                                                  this__split_fields
                                                                  this__split_fields1)
...
;; H
  (assert (= temp___2741 this__split_fields4))

;; H
  (assert (= temp___2742 this__split_fields5))

;; H
  (assert (= temp___2743 this__split_fields6))

;; H
  (assert (= temp___2744 this__split_fields7))
...
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 17, characters 0-0
  (not
  (<= (to_rep3 (first this__split_fields5)) (to_rep this__split_fields6))))
(check-sat)
(exit)
