...
(declare-datatypes ((unit_t__ref 0))
(((mk_unit_t__ref (unit_t__content unit_t)))))
...
(declare-datatypes ((inv_t__ref 0))
(((mk_inv_t__ref (inv_t__content inv_t)))))
...
;; H
  ...
  x)
  (fp.leq x (fp.neg (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))))
