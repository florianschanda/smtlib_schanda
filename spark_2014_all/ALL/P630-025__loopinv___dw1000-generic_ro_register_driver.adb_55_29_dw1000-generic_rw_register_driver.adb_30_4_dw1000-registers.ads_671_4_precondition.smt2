...
(define-fun register_type__ref___235__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___168__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___168__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7516 us_t1)
  (temp___is_init_7513 Bool) (temp___skip_constant_7514 Bool)
  (temp___do_toplevel_7515 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7514 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_7516)
                                       (last3 temp___expr_7516))
                                       (and (= (first3 temp___expr_7516) 1)
                                       (= (last3 temp___expr_7516) 1)))))
