...
(declare-fun dummy1 () skein_512_block_bytes_index)
...
(declare-fun dummy10 () (Array (_ BitVec 64) u64))
...
(declare-fun dummy11 () (Array (_ BitVec 64) byte))
...
(declare-fun start_index () (_ BitVec 64))
