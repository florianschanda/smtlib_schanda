...
;; H
  (assert
  (= my_maps__my_eq__result1 (ite (= (to_rep
...
;; H
  (assert
  (= (mk_bool__ref my_maps__my_eq__result4) (mk_bool__ref
                                            my_maps__my_eq__result2)))
...
(assert
;; WP_parameter_def
 ;; File "my_maps.ads", line 19, characters 0-0
  (not
  (= (to_rep (rec__my_maps__my_rec__f (us_split_fields1 x))) (to_rep
                                                             (rec__my_maps__my_rec__f
                                                             (us_split_fields1
                                                             y))))))
(check-sat)
