...
;; H
  ...
  (or
  (and
  (and (and (= j10 j15) (and (= i10 i15) (= a8 a13)))
  (and (= j11 j1) (and (= i11 i1) (= a9 a1))))
  (< (to_rep a__last) (to_rep a__first)))
  (and (not (< (to_rep a__last) (to_rep a__first)))
  (and
  (and (and (= j10 j14) (and (= i10 i14) (= a8 a12)))
  (and (= j11 j9) (and (= i11 i9) (= a9 a7))))
  (and
  ...
  (and (= (mk_int__ref result1) j15) (= j2 o1)))
  (ite (<= i2 j2)
  (and
  (and
  (and (= temp___170 j2)
  ...
  (and (<= (to_rep a__first) j3) (<= j3 (to_rep a__last))))
  (forall ((k Int))
  (=> (and (<= (to_rep a__first) k) (<= k (- i3 1)))
  (not (= (select a2 k) true)))))
  (forall ((k Int))
  (=> (and (<= (+ j3 1) k) (<= k (to_rep a__last))) (= (select a2 k) true))))
  (and
  (and
  (and (=> (<= 0 1000000) (in_range2 i3)) (=> (<= 0 1000000) (in_range2 j3)))
  (<= i3 j3))
  (and (and (= temp___1711 result2) (= temp___1712 (- j3 i3)))
  (and
  (and
  (and
  (and
  ...
  (and (= i3 result4) (= i4 o4))) (and (= j4 j3) (= a3 a2)))
  (and
  (and
  (and
  (and (and (<= (to_rep a__first) j3) (<= j3 (to_rep a__last))) (= o5 j3))
  (= result5 (select a2 o5)))
  (ite (= result5 true)
  (and
  (and (and (= o6 (- j3 1)) (in_range2 (- j3 1)))
  (and (= j3 result6) (= j4 o6))) (and (= i5 i3) (= a3 a2)))
  (and
  (and
  (and
  (and (= (= (select a3 i3) true) (= (select a2 j3) true))
  (= (= (select a3 j3) true) (= (select a2 i3) true)))
  (forall ((k Int))
  (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last)))
  (=> (and (not (= k i3)) (not (= k j3)))
  (= (= (select a3 k) true) (= (select a2 k) true))))))
  (and
  (and (and (= o7 (+ i3 1)) (in_range2 (+ i3 1)))
  (and (= i3 result7) (= i5 o7)))
  (and (and (= o8 (- j3 1)) (in_range2 (- j3 1)))
  (and (= j3 result8) (= j5 o8))))) (= j4 j5)))) (= i4 i5))))
  (not (<= i4 j4))))))))))
  (and (and (= j4 j6) (and (= i4 i6) (= a3 a4)))
  (and (= j7 j4) (and (= i7 i4) (= a5 a3)))))
  (and
  (and (= j14 (mk_int__ref j6))
  (and (= i14 (mk_int__ref i6)) (= a12 (mk_map__ref a4))))
  (and (= j9 j7) (and (= i9 i7) (= a7 a5)))))
  (and (and (= j2 j8) (and (= i2 i8) (= a12 a13)))
  (and (= j9 j2) (and (= i9 i2) (= a7 a1)))))))))))
...
;; WP_parameter_def
 ;; File "p1.adb", line 2, characters 0-0
  (not
  (or (< (to_rep a__last) (to_rep a__first))
  (exists ((k Int))
  (and (and (<= (to_rep a__first) k) (<= k (to_rep a__last)))
  (and
  (forall ((j16 Int))
  (=> (and (<= (to_rep a__first) j16) (<= j16 k))
  (not (= (select (map__content a10) j16) true))))
  (forall ((j16 Int))
  (=> (and (<= (+ k 1) j16) (<= j16 (to_rep a__last)))
  (= (select (map__content a10) j16) true)))))))))
(check-sat)
(exit)
