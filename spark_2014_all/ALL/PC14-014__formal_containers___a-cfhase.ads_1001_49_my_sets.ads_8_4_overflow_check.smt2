...
(define-fun default_initial_assumption ((temp___expr_386 us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_355 us_rep2)
...
;; H
  ...
  (and (= o (length right))
  (and (in_range1 o)
  (<= o (to_rep1 (rec__my_sets__m__set__capacity (us_split_discrs1 right)))))))
