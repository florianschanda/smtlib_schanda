...
(define-fun us_split_fields_length__projection ((a us_split_fields)) integer
  (rec__union_init__basic_record__length a))

(define-fun us_split_fields_basic_array__projection ((a us_split_fields)) (Array Int integer)
...
(declare-fun union_init__basic_record__length__first__bit () Int)

(declare-fun union_init__basic_record__length__last__bit () Int)

(declare-fun union_init__basic_record__length__position () Int)
...
(declare-fun union_init__basic_record__basic_array__first__bit () Int)

(declare-fun union_init__basic_record__basic_array__last__bit () Int)

(declare-fun union_init__basic_record__basic_array__position () Int)
...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__union_init__union_test__discr integer)))))
...
(define-fun us_split_fields_field1__projection ((a us_split_fields2)) integer
  (rec__union_init__union_test__field1 a))

(define-fun us_split_fields_field2__projection ((a us_split_fields2)) us_rep
  (rec__union_init__union_test__field2 a))

(define-fun us_split_fields_field3__projection ((a us_split_fields2)) natural
...
(declare-fun union_init__union_test__discr__first__bit () Int)

(declare-fun union_init__union_test__discr__last__bit () Int)

(declare-fun union_init__union_test__discr__position () Int)
...
(declare-fun union_init__union_test__field1__first__bit () Int)

(declare-fun union_init__union_test__field1__last__bit () Int)

(declare-fun union_init__union_test__field1__position () Int)
...
(declare-fun union_init__union_test__field2__first__bit () Int)

(declare-fun union_init__union_test__field2__last__bit () Int)

(declare-fun union_init__union_test__field2__position () Int)
...
(declare-fun union_init__union_test__field3__first__bit () Int)

(declare-fun union_init__union_test__field3__last__bit () Int)

(declare-fun union_init__union_test__field3__position () Int)
...
(declare-datatypes ()
((union_test__ref (mk_union_test__ref (union_test__content us_rep1)))))
(define-fun union_test__ref___projection ((a union_test__ref)) us_rep1
...
;; def_axiom
  ...
  (= (select (temp___149 temp___151) temp___152) (of_rep temp___151)))))
...
(declare-fun test__attr__constrained () Bool)
...
(declare-fun union_init__union_test__discr__first__bit1 () Int)

(declare-fun union_init__union_test__discr__last__bit1 () Int)

(declare-fun union_init__union_test__discr__position1 () Int)
...
(declare-fun union_init__union_test__field1__first__bit1 () Int)

(declare-fun union_init__union_test__field1__last__bit1 () Int)

(declare-fun union_init__union_test__field1__position1 () Int)
...
(declare-fun union_init__union_test__field3__first__bit1 () Int)

(declare-fun union_init__union_test__field3__last__bit1 () Int)

(declare-fun union_init__union_test__field3__position1 () Int)
...
(declare-fun union_init__union_test__field2__first__bit1 () Int)

(declare-fun union_init__union_test__field2__last__bit1 () Int)

(declare-fun union_init__union_test__field2__position1 () Int)
...
(define-fun default_initial_assumption1 ((temp___expr_147 us_rep)
  (temp___skip_top_level_148 Bool)) Bool (and
                                         ...
                                         (= (rec__union_init__basic_record__basic_array
                                            (us_split_fields1
                                            temp___expr_147)) (temp___149 0))))

(declare-fun test__split_discrs () integer)
...
(declare-fun temp___1663 () (Array Int integer))

(declare-fun temp___1664 () natural)

(declare-fun temp___1665 () Bool)
...
;; WP_parameter_def
 ;; File "union_init.ads", line 23, characters 0-0
  (not (= temp___166 test__split_discrs)))
(check-sat)
(exit)
