...
(declare-fun list_mod_allocator__C130b__assume () us_rep1)

(declare-fun list_mod_allocator__B131b__L_5__R132b__assume () Int)

(declare-fun temp___262 () Int)

(declare-fun o18 () us_rep1)

(declare-fun o19 () us_rep2)
...
;; H
  (assert
  (and (= o30 (model__ (map__content data6) first_available1))
  (= (model_is_well_formed o30 (map__content data6) first_available1) true)))
...
;; H
  (assert (= list_mod_allocator__C130b__assume o16))

;; H
  (assert (= list_mod_allocator__C130b__assume c130b))

;; H
  (assert
  (and (= list_mod_allocator__B131b__L_5__R132b__assume (length c130b))
  (and (in_range6 list_mod_allocator__B131b__L_5__R132b__assume)
  (<= (+ 0 list_mod_allocator__B131b__L_5__R132b__assume) 2147483647))))

;; H
  (assert (= list_mod_allocator__B131b__L_5__R132b__assume r132b))

;; H
  (assert (in_range1 r132b))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 r132b)) (= temp___262 i1)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r132b))
  (forall ((j Int)) (=> (and (<= 1 j) (<= j i2)) (= (get c130b j) j)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r132b))
  (and (=> (<= 1 r132b) (dynamic_property 1 r132b i2))
  (and (<= 1 i2) (<= i2 r132b)))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r132b)) (= i2 r132b)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r132b)) (= i3 (mk_int__ref i2))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r132b)) (= i4 i2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r132b)) (= i5 i3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r132b)) (= i6 i4)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 r132b))) (= i5 (mk_int__ref i1))))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 r132b))) (= i6 i1)))

;; H
  (assert
  (and (= o28 (model__ (map__content data6) first_available1))
  (= (model_is_well_formed o28 (map__content data6) first_available1) true)))
...
;; H
  (assert
  (and (= o27 (length o26)) (and (in_range6 o27) (<= (+ 0 o27) 2147483647))))

;; H
  (assert
  (and (= o29 (model__ (map__content data6) first_available1))
  (= (model_is_well_formed o29 (map__content data6) first_available1) true)))
...
;; H
  (assert (and (= temp___265 (get o22 o27)) (in_range7 temp___265)))
