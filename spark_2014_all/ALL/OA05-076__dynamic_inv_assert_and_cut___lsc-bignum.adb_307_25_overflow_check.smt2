...
;; H
  (assert (and (= o22 (+ a_last 1)) (in_range1 (+ a_last 1))))
...
;; H
  (assert (= o24 (ite (<= o21 k) true false)))
...
;; H
  (assert (= o18 (from_word32 carry22)))
...
;; H
  (assert (= o16 (from_word32 carry12)))

;; H
  (assert (= o20 (oadd o16 o19)))
