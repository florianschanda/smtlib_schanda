...
;; H
  (assert
  (and
  (and (= (bool_eq a1 1 10 (temp___4401 t i e) 1 10) true)
...
;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (and (= o4 (- e 1)) (in_range2 (- e 1))))))

;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (and (= o5 (+ i 1)) (in_range1 (+ i 1))))))

;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (= temp___4413 (temp___681 a i e o5 o4)))))

;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (= result4 (bool_eq a3 1 10 temp___4413 1 10)))))

;; H
  (assert (=> (< i 10) (=> (not (< 0 e)) (= result4 false))))

;; H
  (assert (=> (< i 10) (=> (= result4 true) (= result3 true))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result4 true))
  (=> (= e 0) (and (= o3 (+ i 1)) (in_range1 (+ i 1)))))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result4 true))
  (=> (= e 0) (= temp___4415 (temp___690 a i e o3 99))))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result4 true))
  (=> (= e 0) (= result3 (bool_eq a3 1 10 temp___4415 1 10))))))
