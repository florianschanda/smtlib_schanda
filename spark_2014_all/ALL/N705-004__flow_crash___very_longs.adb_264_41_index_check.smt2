...
(declare-datatypes ((tT79bP1__ref 0))
(((mk_tT79bP1__ref (tT79bP1__content tdigit_index_typeB)))))
(define-fun tT79bP1__ref___projection ((a tT79bP1__ref)) tdigit_index_typeB
  (tT79bP1__content a))
...
(declare-datatypes ((t79b__ref 0)) (((mk_t79b__ref (t79b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits__23__projection ((a us_split_fields2)) us_t1
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___23__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep___45__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                  a))

(define-fun us_rep___46__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))

(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___176 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___176)
                                         (first3 temp___176)
                                         (last3 temp___176))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1)
                                          (mk___split_fields1
                                          (let ((temp___175 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array1 (to_array temp___175)
                                          (first1 temp___175)
                                          (last1 temp___175))))))
...
(define-fun dynamic_invariant4 ((temp___expr_614 us_rep1)
  (temp___is_init_611 Bool) (temp___skip_constant_612 Bool)
  (temp___do_toplevel_613 Bool)) Bool (and
                                      (=>
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_614)))
                                      (last3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_614))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_614))) 1)
                                      (= (last3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_614)))
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_617 us_rep1)
  (temp___skip_top_level_618 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_617))) (to_rep
                                                               (rec__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
(((mk_t80b__ref (t80b__content tdigit_index_typeB)))))
(define-fun t80b__ref___projection ((a t80b__ref)) tdigit_index_typeB
  (t80b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___973 (_ BitVec 8)))
  (forall ((temp___974 Int) (temp___975 Int))
  (let ((temp___972 (temp___971 temp___973 temp___974 temp___975)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___974 temp___975)
  (and (= (first5 temp___972) temp___974) (= (last5 temp___972) temp___975)))
  (forall ((temp___976 Int))
  (= (select (to_array2 temp___972) temp___976) (of_rep1 temp___973))))))))
...
;; H
  (assert
  (= (mk___t2 temp___978 temp___9781) (temp___971 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__octet_length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9781)) (to_rep2 (last4 temp___9781)))
     (+ (- (to_rep2 (last4 temp___9781)) (to_rep2 (first4 temp___9781))) 1)
     0) (ite (<= 1 (to_rep
                   (rec__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep
              (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1)
        0)))

;; H
  (assert (= temp___978 temp___979))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9781)) (to_rep2 (last4 temp___9781)))
  temp___9791))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9791)) (to_rep2 (last2 temp___9791)))
     (+ (- (to_rep2 (last2 temp___9791)) (to_rep2 (first2 temp___9791))) 1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___979 temp___9791)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___982)))

;; H
  (assert (= temp___9821 o2))

;; H
  (assert (= temp___9822 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9821 temp___9822))))
...
;; H
  (assert (= o16 (ite (<= o15 r84b) true false)))
...
;; H
  (assert (= o24 (takelsb_from16 temp1)))
