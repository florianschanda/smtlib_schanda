...
;; H
  ...
  (forall ((k14 Int))
  (=>
  (and (<= (to_rep2 (first (rt needle))) k14)
  (<= k14 (to_rep2 (last (rt needle)))))
  (not (= c (to_rep1 (select (elts needle) k14))))))
  (and
  (= (to_rep1
  ...
  (forall ((k14 Int))
  (=>
  (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k14)
  (<= k14 (to_rep2 (last (rt needle)))))
  (not (= (to_rep1 (select (elts needle) k14)) c))))))))))
  ...
  (<= k14 (- (+ i2 (to_rep
                   (select bad_shift (to_rep1
                                     (select (elts haystack) (+ i2 (length
                                                                   needle))))))) 1)))
  (not (= (match_at needle haystack k14) true)))))
