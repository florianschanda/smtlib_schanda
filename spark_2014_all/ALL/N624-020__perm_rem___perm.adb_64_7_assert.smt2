...
(declare-fun ia3 () int__ref)

(declare-fun perm__get_witnesses__result6 () witnesses__ref)

(declare-fun ia4 () Int)

(declare-fun perm__get_witnesses__result7 () us_rep)

(declare-fun ia5 () int__ref)

(declare-fun perm__get_witnesses__result8 () witnesses__ref)

(declare-fun ia6 () Int)

(declare-fun perm__get_witnesses__result9 () us_rep)

(define-fun perm__get_witnesses__result10 () us_rep (mk___rep
                                                    (mk___split_fields
...
;; WP_parameter_def
 ;; File "perm.adb", line 37, characters 0-0
  ...
  (not
  (and
  (and (= (mk_int__ref result) (mk_int__ref ia))
  (= ia1 (to_rep2 (first (rt a)))))
  (ite (and (<= (to_rep2 (first (rt a))) ia1)
       (<= ia1 (to_rep2 (last (rt a)))))
  (and
  (and
  (and (= temp___586 ia1)
  (and
  ...
  (= perm__get_witnesses__result4 perm__get_witnesses__result10))))
  (and
  (forall ((ka Int))
  (=> (and (<= 1 ka) (<= ka ia2))
  (forall ((kb Int))
  ...
  (= ia2 (to_rep2 (last (rt a))))))))
  (and
  (and
  (= perm__get_witnesses__result6 (mk_witnesses__ref
                                  perm__get_witnesses__result5))
  (= ia3 (mk_int__ref ia2)))
  (and (= perm__get_witnesses__result7 perm__get_witnesses__result5)
  (= ia4 ia2))))
  (and
  (and (= perm__get_witnesses__result8 perm__get_witnesses__result6)
  (= ia5 ia3))
  (and (= perm__get_witnesses__result9 perm__get_witnesses__result7)
  (= ia6 ia4))))
  (and
  (and
  (= perm__get_witnesses__result8 (mk_witnesses__ref
                                  (mk___rep
                                  (mk___split_fields
                                  perm__get_witnesses__result
                                  perm__get_witnesses__result1))))
  (= ia5 (mk_int__ref ia1)))
  (and (= perm__get_witnesses__result9 perm__get_witnesses__result10)
  (= ia6 ia1))))))))
(check-sat)
(exit)
