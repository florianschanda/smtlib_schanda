...
(declare-const ia3 int__ref)

(declare-const perm__get_witnesses__result6 witnesses__ref)

(declare-const ia4 Int)

(declare-const perm__get_witnesses__result7 us_rep)

(declare-const ia5 int__ref)

(declare-const perm__get_witnesses__result8 witnesses__ref)

(declare-const ia6 Int)

(declare-const perm__get_witnesses__result9 us_rep)
