...
(declare-datatypes ((tT23bP1__ref 0))
(((mk_tT23bP1__ref (tT23bP1__content tdigit_index_typeB)))))
(define-fun tT23bP1__ref___projection ((a tT23bP1__ref)) tdigit_index_typeB
  (tT23bP1__content a))
...
(declare-datatypes ((t23b__ref 0)) (((mk_t23b__ref (t23b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits__6__projection ((a us_split_fields2)) us_t1
...
(define-fun us_rep___11__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                  a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___145 (rec__aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___145)
                                         (first3 temp___145)
                                         (last3 temp___145))))))

(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r)
                                         (mk___split_fields1
                                         (let ((temp___144 (rec__aco__math__very_longs__very_long__long_digits
                                                           (us_split_fields1
                                                           r))))
                                         (of_array1 (to_array temp___144)
                                         (first1 temp___144)
                                         (last1 temp___144))))))
...
(define-fun tresultS__ref___projection ((a tresultS__ref)) us_rep1 (tresultS__content
                                                                   a))

(define-fun dynamic_invariant2 ((temp___expr_507 us_rep1)
  (temp___is_init_504 Bool) (temp___skip_constant_505 Bool)
  (temp___do_toplevel_506 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_505 true))
                                      (in_range4 octet_length
                                      (to_base temp___expr_507)))
                                      (and (dynamic_property3 1 octet_length
                                      (first3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_507)))
                                      (last3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_507))))
                                      (and
                                      (= (first3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_507))) 1)
                                      (= (last3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_507)))
                                      octet_length)))))

(define-fun default_initial_assumption ((temp___expr_510 us_rep1)
  (temp___skip_top_level_511 Bool)) Bool (= (to_rep1
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_510))) octet_length))
...
(((mk_t24b__ref (t24b__content tdigit_index_typeB)))))
(define-fun t24b__ref___projection ((a t24b__ref)) tdigit_index_typeB
  (t24b__content a))
...
(declare-datatypes ((t25b__ref 0)) (((mk_t25b__ref (t25b__content us_t2)))))
...
(declare-fun temp___1029 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1031 (_ BitVec 8)))
  (forall ((temp___1032 Int) (temp___1033 Int))
  (let ((temp___1030 (temp___1029 temp___1031 temp___1032 temp___1033)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___1032 temp___1033)
  (and (= (first5 temp___1030) temp___1032)
  (= (last5 temp___1030) temp___1033)))
  (forall ((temp___1034 Int))
  (= (select (to_array2 temp___1030) temp___1034) (of_rep temp___1031))))))))
...
(declare-const aco__math__very_longs__make_from_natural__result digit_index_type)

(declare-const aco__math__very_longs__make_from_natural__result1 (Array Int octet))

(declare-const aco__math__very_longs__make_from_natural__result2 t)

(declare-const us Int)

(declare-const temp___1036 (Array Int octet))

(declare-const temp___10361 t2)

(declare-const temp___1037 (Array Int octet))

(declare-const temp___10371 t1)
...
(declare-const temp___1040 digit_index_type)

(declare-const temp___10401 (Array Int octet))

(declare-const temp___10402 t1)
...
(declare-const temp___1043 us_rep1)
...
(declare-const aco__math__very_longs__make_from_natural__result3 us_rep)

(declare-const aco__math__very_longs__make_from_natural__result4 very_long__ref)

(declare-const aco__math__very_longs__make_from_natural__result5 us_rep)
...
(declare-const aco__math__very_longs__make_from_natural__result6 very_long__ref)
...
(declare-const aco__math__very_longs__make_from_natural__result7 us_rep)

(declare-const result6 digit_index_type)
...
;; H
  ...
  (= (to_rep1
     (rec__aco__math__very_longs__very_long__octet_length
     result____split_discrs)) octet_length))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1029 ((_ int2bv 8) 0) 1 octet_length)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1029 ((_ int2bv 8) 0) 1 octet_length))))
  octet_length))

;; H
  (assert
  (= (mk___t2 temp___1036 temp___10361) (temp___1029 ((_ int2bv 8) 0) 1
                                        octet_length)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___10361)) (to_rep2 (last4 temp___10361)))
     (+ (- (to_rep2 (last4 temp___10361)) (to_rep2 (first4 temp___10361))) 1)
     0) (ite (<= 1 octet_length) (+ (- octet_length 1) 1) 0)))

;; H
  (assert (= temp___1036 temp___1037))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___10361)) (to_rep2 (last4 temp___10361)))
  temp___10371))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___10371)) (to_rep2 (last2 temp___10371)))
     (+ (- (to_rep2 (last2 temp___10371)) (to_rep2 (first2 temp___10371))) 1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___1037 temp___10371)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1040)))

;; H
  (assert (= temp___10401 o2))

;; H
  (assert (= temp___10402 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___10401 temp___10402))))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___1047 temp1)))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (and (= result____split_discrs (mk___split_discrs temp___1044))
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___10441 temp___10442))))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      result____split_fields3)))) temp___1046)
  (<= temp___1046 (to_rep2
                  (last2
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__aco__math__very_longs__very_long__long_digits1
             result____split_fields3)) temp___1046) (select temp___10441 temp___1046))))))
  (=> (<= 0 2147483647) (in_range1 temp2)))
  (and (<= 1 index2) (<= index2 r26b)))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (and (= o4 (mod1 temp2 256)) (uint_in_range (mod1 temp2 256)))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= o5 ((_ int2bv 8) o4))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= (to_rep o6) o5)))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      result____split_fields3)))) index2)
  (<= index2 (to_rep2
             (last2
             (rt1
             (rec__aco__math__very_longs__very_long__long_digits1
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= o7 index2)))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b)) (= o10 (mk___split_fields1 o9))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= temp___1043 (mk___rep1 result____split_discrs o10))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= result3 (mk___split_fields__ref1 result____split_fields3))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= result____split_fields4 (us_split_fields3 temp___1043))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= result____split_discrs (us_split_discrs2 temp___1043))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b)) (= result4 (mk_int__ref temp2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b)) (= temp3 (div1 temp2 256))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= index2 r26b)))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b)) (= index3 (mk_int__ref index2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b)) (= temp4 (mk_int__ref temp3))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= result____split_fields5 (mk___split_fields__ref1
                             result____split_fields4))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= index4 index2)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp5 temp3)))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= index5 index3)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp6 temp4)))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= index6 index4)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp7 temp5)))
...
;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 r26b)))
  (= index5 (mk_int__ref index1))))

;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 r26b)))
  (= temp6 (mk_int__ref temp1))))

;; H
  (assert
  (=> (not (and (<= 1 index1) (<= index1 r26b)))
  (= result____split_fields7 (mk___split_fields__ref1
                             result____split_fields2))))

;; H
  (assert (=> (not (and (<= 1 index1) (<= index1 r26b))) (= index6 index1)))

;; H
  (assert (=> (not (and (<= 1 index1) (<= index1 r26b))) (= temp7 temp1)))
...
;; H
  (assert
  (= aco__math__very_longs__make_from_natural__result4 (mk_very_long__ref
                                                       aco__math__very_longs__make_from_natural__result3)))

;; H
  (assert
  (= aco__math__very_longs__make_from_natural__result5 aco__math__very_longs__make_from_natural__result3))

;; H
  (assert
  (= result5 (mk_very_long__ref
             (mk___rep
             (mk___split_discrs
             aco__math__very_longs__make_from_natural__result)
             (mk___split_fields
             (mk___t aco__math__very_longs__make_from_natural__result1
             aco__math__very_longs__make_from_natural__result2))))))

;; H
  (assert
  (= aco__math__very_longs__make_from_natural__result3 (to_base
                                                       (mk___rep1
...
;; H
  (assert
  (= aco__math__very_longs__make_from_natural__result6 aco__math__very_longs__make_from_natural__result4))
...
;; H
  (assert
  (= aco__math__very_longs__make_from_natural__result7 aco__math__very_longs__make_from_natural__result5))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result6)
     (mk___split_fields (mk___t result7 result8))) (very_long__content
                                                   aco__math__very_longs__make_from_natural__result6)))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  ...
  (= (to_rep1
     (rec__aco__math__very_longs__very_long__octet_length
     (us_split_discrs1
     (very_long__content aco__math__very_longs__make_from_natural__result6))))
  octet_length)))
(check-sat)
(exit)
