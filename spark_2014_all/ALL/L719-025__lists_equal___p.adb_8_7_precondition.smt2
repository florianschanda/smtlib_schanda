...
;; H
  ...
  (=>
  (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true)
  (and (= temp___4661 (last1 (mk___rep l__split_discrs l__split_fields2)))
  (ite (= (= (length (mk___rep l__split_discrs l__split_fields2)) 0) true)
  (= (bool_eq1 temp___4661 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields2))
     temp___4661) true)
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
     temp___4661) (length (mk___rep l__split_discrs l__split_fields2))))))))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 (mk___split_fields1 cu__split_fields)) no_element) true))
  (and
  (= temp___4661 (previous (mk___rep l__split_discrs l__split_fields2)
                 (mk___rep1 (mk___split_fields1 cu__split_fields))))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1514, characters 0-0
  (not
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields2))
     (mk___rep1 (mk___split_fields1 cu__split_fields1))) true)))
(check-sat)
(exit)
