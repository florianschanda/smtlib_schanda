...
;; H
  ...
  (= o (ite (and (<= 1 8) (<= 8 8))
       ...
       (ite (and (<= 9 8) (<= 8 16))
       ((_ extract 7 0) (ite (< n 16)
                        (bvlshr ((_ zero_extend 8) val__) ((_ int2bv 16)
                        n)) ((_ int2bv 16) 0)))
       (ite (and (<= 17 8) (<= 8 32))
       ((_ extract 7 0) (bvlshr ((_ zero_extend 24) val__) ((_ int2bv 32)
       n)))
       ((_ extract 7 0) (bvlshr ((_ zero_extend 56) val__) ((_ int2bv 64)
       n)))))))))

;; H
  (assert (= result1 (ite (= o ((_ int2bv 8) 1)) true false)))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 0 j1) (<= j1 n))
  (bvuge (shift_right val__ j1) ((_ int2bv 8) 1)))))))
