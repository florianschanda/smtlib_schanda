...
;; H
  ...
  i9) 1)))
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 (+ (- last5 i9) 1)))
  (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j1)) (to_rep
                                                                    (select
                                                                    (elts
                                                                    (to__
                                                                    (mk___rep
...
;; H
  (assert (and (= o11 (- i9 first4)) (in_range1 (- i9 first4))))

;; H
  (assert
  (and (= o12 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o12)
  (<= o12 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))

;; H
  (assert (= result5 (ite (= o12 o11) true false)))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o6 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o6 true false true)
  (and (= (to_rep (first (rt o6))) 1) (<= 0 (to_rep (last (rt o6)))))))))

;; H
  (assert (=> (= result5 true) (= o10 (to_rep (last (rt o6))))))

;; H
  (assert (=> (= result5 true) (= result4 (ite (= o10 o9) true false))))
...
;; H
  (assert
  (and
  (= temp___484 (to__ (mk___rep (us_split_fields__content s__split_fields7))))
  (and (dynamic_invariant1 temp___484 true false true)
  (and (= (to_rep (first (rt temp___484))) 1)
  (<= 0 (to_rep (last (rt temp___484))))))))

(assert
;; WP_parameter_def
 ;; File "list.ads", line 9, characters 0-0
  (not (<= (to_rep (first (rt temp___484))) j)))
(check-sat)
(exit)
