...
;; H
  (assert
  (and (= o9 (last1 (mk___rep l3__split_discrs l3__split_fields2)))
  ...
  (= (get1 (positions (mk___rep l3__split_discrs l3__split_fields2)) o9)
  (length (mk___rep l3__split_discrs l3__split_fields2)))))))

;; H
  (assert
  (and (= o10 (previous (mk___rep l3__split_discrs l3__split_fields2) o9))
