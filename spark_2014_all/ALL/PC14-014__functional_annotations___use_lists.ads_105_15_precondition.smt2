...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o13 j) true)
  (=> (= (get1 o13 i1) (get1 o13 j)) (= (bool_eq1 i1 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o17)
  (=> (= (of_int 0) true)
  (and (= o17 (w_get o13 (witness o13 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o13 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o13 cu) (witness o13 k))))))))))
...
;; H
  (assert
  (and (= o12 (has_key o11 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o11 k) true) (= (bool_eq1 k cu) true))) (= o12 true)))))
...
;; H
  (assert (and (= o8 (- i 7)) (in_range1 (- i 7))))
