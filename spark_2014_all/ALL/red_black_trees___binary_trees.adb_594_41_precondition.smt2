...
;; H
  (assert (= o77 (select temp___1254 o76)))
...
;; H
  ...
  (= temp___1253 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 o71))
  (and (dynamic_invariant3 temp___1253 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1253 o71))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1253 o71)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o71))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1253 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o73 (select temp___1253 o72)))
