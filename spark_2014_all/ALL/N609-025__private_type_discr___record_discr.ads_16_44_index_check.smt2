...
(define-fun o10 () us_rep (mk___rep (mk___split_discrs o4)
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 1)) e)
  (and (= o12 (mk_result (of_int 1) 1))
  (and (= (= o true) (= (of_int 1) true))
  (=> (= (of_int 1) true) (= (get_content o12) 1))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 1)) e)
  (= record_discr__search_upto_3__result17 o12)))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 2)) e)
  (and (= o11 (mk_result (of_int 1) 2))
  (and (= (= o2 true) (= (of_int 1) true))
  (=> (= (of_int 1) true) (= (get_content o11) 2)))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 2)) e)
  (= record_discr__search_upto_3__result4 o11))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e)
  (and (= o10 (mk_result (of_int 1) 3))
  (and (= (= o4 true) (= (of_int 1) true))
  (=> (= (of_int 1) true) (= (get_content o10) 3))))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e)
  (= record_discr__search_upto_3__result5 o10)))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e))
  (and (= o9 (mk_result (of_int 0) 1))
  (and (= (= o6 true) (= (of_int 0) true))
  (=> (= (of_int 0) true) (= (get_content o9) 1))))))))
...
;; H
  ...
  (= (to_rep
     (select (rec__record_discr__interm_result__to_search1
             (us_split_fields5 r)) 3)) e))
  (= record_discr__search_upto_3__result6 o9)))))
...
;; H
  (assert
  (and
  (= temp___251 (get_content
                (result_ty__content record_discr__search_upto_3__result15)))
  (in_range2 temp___251)))
