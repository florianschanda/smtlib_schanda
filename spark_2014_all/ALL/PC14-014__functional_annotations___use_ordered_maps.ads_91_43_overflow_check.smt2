...
(define-fun key_type__ref___3__projection ((a key_type__ref2)) us_rep4
...
;; H
  ...
  (to_rep (rec__use_ordered_maps__my_maps__map__capacity m__split_discrs)) 4))
  (or
  (= (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 0)
  (< 4 (first_key
...
;; H
  ...
  (= (length (mk___rep m__split_discrs m__split_fields10)) (+ (length
                                                              ...
                                                              (mk___split_fields
                                                              m__split_fields))) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields10)) 1) true))
  (= (get1 (keys (mk___rep m__split_discrs m__split_fields10))
     (find (keys (mk___rep m__split_discrs m__split_fields10)) 1)) 1))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields10)) 1) 0))
  (= (ole
  ...
  (= (range_equal
     ...
     (keys (mk___rep m__split_discrs m__split_fields10)) 1
     (- (find (keys (mk___rep m__split_discrs m__split_fields10)) 1) 1)) true))
  (= (range_shifted
     (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (keys (mk___rep m__split_discrs m__split_fields10))
     (find (keys (mk___rep m__split_discrs m__split_fields10)) 1)
     (length (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
...
;; H
  ...
  (= (length (mk___rep m__split_discrs m__split_fields9)) (+ (length
                                                             ...
                                                             m__split_discrs
                                                             m__split_fields10)) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields9)) 2) true))
  (= (get1 (keys (mk___rep m__split_discrs m__split_fields9))
     (find (keys (mk___rep m__split_discrs m__split_fields9)) 2)) 2))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields9)) 2) 0))
  ...
  (= (keys_included_except
     ...
     (model__ (mk___rep m__split_discrs m__split_fields10)) 2) true))
  (= (range_equal (keys (mk___rep m__split_discrs m__split_fields10))
     (keys (mk___rep m__split_discrs m__split_fields9)) 1
     (- (find (keys (mk___rep m__split_discrs m__split_fields9)) 2) 1)) true))
  (= (range_shifted (keys (mk___rep m__split_discrs m__split_fields10))
     (keys (mk___rep m__split_discrs m__split_fields9))
     (find (keys (mk___rep m__split_discrs m__split_fields9)) 2)
     (length (mk___rep m__split_discrs m__split_fields10)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep m__split_discrs m__split_fields10))
...
;; H
  ...
  (= (length (mk___rep m__split_discrs m__split_fields8)) (+ (length
                                                             ...
                                                             m__split_discrs
                                                             m__split_fields9)) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields8)) 3) true))
  (= (get1 (keys (mk___rep m__split_discrs m__split_fields8))
     (find (keys (mk___rep m__split_discrs m__split_fields8)) 3)) 3))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields8)) 3) 0))
  ...
  (= (keys_included_except
     ...
     (model__ (mk___rep m__split_discrs m__split_fields9)) 3) true))
  (= (range_equal (keys (mk___rep m__split_discrs m__split_fields9))
     (keys (mk___rep m__split_discrs m__split_fields8)) 1
     (- (find (keys (mk___rep m__split_discrs m__split_fields8)) 3) 1)) true))
  (= (range_shifted (keys (mk___rep m__split_discrs m__split_fields9))
     (keys (mk___rep m__split_discrs m__split_fields8))
     (find (keys (mk___rep m__split_discrs m__split_fields8)) 3)
     (length (mk___rep m__split_discrs m__split_fields9)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep m__split_discrs m__split_fields9))
...
;; H
  ...
  (= (length (mk___rep m__split_discrs m__split_fields7)) (+ (length
                                                             ...
                                                             m__split_discrs
                                                             m__split_fields8)) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields7)) 4) true))
  (= (get1 (keys (mk___rep m__split_discrs m__split_fields7))
     (find (keys (mk___rep m__split_discrs m__split_fields7)) 4)) 4))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields7)) 4) 0))
  ...
  (= (keys_included_except
     ...
     (model__ (mk___rep m__split_discrs m__split_fields8)) 4) true))
  (= (range_equal (keys (mk___rep m__split_discrs m__split_fields8))
     (keys (mk___rep m__split_discrs m__split_fields7)) 1
     (- (find (keys (mk___rep m__split_discrs m__split_fields7)) 4) 1)) true))
  (= (range_shifted (keys (mk___rep m__split_discrs m__split_fields8))
     (keys (mk___rep m__split_discrs m__split_fields7))
     (find (keys (mk___rep m__split_discrs m__split_fields7)) 4)
     (length (mk___rep m__split_discrs m__split_fields8)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep m__split_discrs m__split_fields8))
...
;; H
  ...
  (= (has_key
     (model__
     (mk___rep m__split_discrs (mk___split_fields m__split_fields5))) k) true)
  (= (get
     (model__
     (mk___rep m__split_discrs (mk___split_fields m__split_fields5))) k) 0))))))
...
;; H
  ...
  (=>
  (and (in_range5 temp___808)
  (= (iter_has_element temp___809 temp___808) true))
  (let ((k (get1 temp___809 temp___808)))
  (=> (< 4 k)
  (and
  (= (has_key
     (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
  ...
  (= (get
     (model__
     (mk___rep m__split_discrs (mk___split_fields m__split_fields5))) k)
  (get
...
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 76, characters 0-0
  (not (in_range1
  (+ (length (mk___rep m__split_discrs (mk___split_fields m__split_fields))) 4))))
(check-sat)
(exit)
