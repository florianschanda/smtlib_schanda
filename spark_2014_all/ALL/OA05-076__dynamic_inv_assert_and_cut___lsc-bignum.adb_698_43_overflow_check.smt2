...
;; H
  (assert (= o52 (from_integer (int__content s12))))

;; H
  (assert (= o56 (ole o52 o55)))

;; H
  (assert (and (= o47 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o50 (ite (<= n o49) true false)))

;; H
  (assert (= result9 (ite (<= 0 n) o50 false)))
...
;; H
  (assert (and (= o43 (+ l1 1)) (in_range1 (+ l1 1))))
...
;; H
  (assert
  (and (= o39 (base Tuple0))
  (= o39 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o41 (oexpon o39 o40)))

;; H
  (assert (= o34 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o32 (from_integer (int__content s12))))
...
;; H
  (assert (= o38 (oexpon__2 o24 o37)))

;; H
  (assert (= o42 (omultiply o38 o41)))
...
;; H
  ...
  (= o22 (num_of_big_int
         ...
         (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o21)))

;; H
  (assert (= o46 (oeq o22 o45)))
