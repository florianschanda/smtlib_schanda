...
(declare-const temp___257 Bool)

(declare-const temp___256 (_ BitVec 8))

(declare-const temp___255 Bool)

(declare-const temp___254 (_ BitVec 8))

(declare-const temp___253 (Array Int unsigned_8))

(declare-const temp___252 (Array Int unsigned_8))

(declare-const temp___251 (Array Int unsigned_8))
...
(declare-const xcx4 map__ref1)

(declare-const xsi6 map__ref1)

(declare-const xdi6 map__ref1)
...
(declare-const xcx6 map__ref1)

(declare-const xsi8 map__ref1)

(declare-const xdi8 map__ref1)
...
(declare-const xcx8 map__ref1)

(declare-const xsi10 map__ref1)

(declare-const xdi10 map__ref1)
