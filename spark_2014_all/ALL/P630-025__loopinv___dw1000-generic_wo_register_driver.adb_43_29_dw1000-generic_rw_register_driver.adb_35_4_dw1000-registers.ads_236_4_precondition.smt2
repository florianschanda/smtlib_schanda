...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77571)) (to_rep (last4 temp___77571)))
  temp___77581))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77581)) (to_rep (last2 temp___77581)))
     (+ (- (to_rep (last2 temp___77581)) (to_rep (first2 temp___77581))) 1)
