...
;; H
  ...
  (forall ((ia4 Int))
  (=>
  (and (<= (to_rep2 (first (rt aa))) ia4) (<= ia4 (to_rep2 (last (rt aa)))))
  (exists ((ib1 Int))
  (and
  (and (<= (to_rep2 (first (rt bb))) ib1) (<= ib1 (to_rep2 (last (rt bb)))))
  (and (= (to_rep (select (elts aa) ia4)) (to_rep (select (elts bb) ib1)))
  (= (is_perm (remove aa ia4) (remove bb ib1)) true))))))))))
...
;; H
  ...
  (and
  (and (<= (to_rep2 (first (rt b))) ib1) (<= ib1 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib1)))
...
;; H
  ...
  (and
  (and (<= (to_rep2 (first (rt b))) ib1) (<= ib1 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib1)))
  (= (is_perm (remove a ia3) (remove b ib1)) true)))))
