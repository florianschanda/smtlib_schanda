...
;; H
  ...
  (exists ((index1 Int))
  (and
  (and (<= (to_rep (first (rt list))) index1)
  (<= index1 (to_rep (last (rt list)))))
  (= (to_rep (select (elts list) index1)) value))))
...
;; H
  (assert
  (and (<= (to_rep (first (rt list))) position10)
  (<= position10 (to_rep (last (rt list))))))

;; H
  (assert (= o8 position10))

;; H
  (assert (= o9 (select (elts list) o8)))

;; H
  (assert (= o10 (to_rep o9)))

;; H
  (assert (= result4 (ite (= o10 value) true false)))
