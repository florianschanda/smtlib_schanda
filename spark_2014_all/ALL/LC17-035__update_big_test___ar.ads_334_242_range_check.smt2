...
(declare-fun temp___4662 () (Array Int (Array Int et1)))
...
(declare-fun result4 () (Array Int (Array Int et1)))
...
;; H
  (assert
  (= (bool_eq1 a1 5 50 (temp___4639 t j (temp___4645 (select t j) i e)) 5 50) true))
...
;; H
  (assert (=> (< 0 e) (and (= o9 (- e 1)) (in_range2 (- e 1)))))
...
;; H
  (assert (=> (< 0 e) (= o10 (select a o8))))

;; H
  (assert (=> (< 0 e) (= o11 (temp___982 o10 i o9))))

;; H
  (assert (=> (< 0 e) (and (= o12 (+ j 1)) (in_range1 (+ j 1)))))

;; H
  (assert
  (=> (< 0 e)
  (= temp___4662 (temp___967 a j (temp___975 (select a j) i e) o12 o11))))

;; H
  (assert (=> (< 0 e) (= result5 (bool_eq1 a3 5 50 temp___4662 5 50))))
...
;; H
  (assert (= o6 (select a o5)))

;; H
  (assert (= o7 (temp___1005 o6 i 99)))
