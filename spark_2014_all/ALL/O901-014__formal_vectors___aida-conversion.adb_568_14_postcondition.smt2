...
(declare-fun temp___1479 () Int)

(declare-fun temp___1477 () (Array Int integer))
...
;; H
  ...
  (forall ((index9 Int))
  (=>
  (and (<= (to_rep1 (first (rt source))) index9)
  (<= index9 (to_rep1 (last (rt source)))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1481))
  (= temp___1479 index1)))
...
;; H
  ...
  (=> (< index2 temp___1478)
  (= (select n3 temp___1478) (select temp___1477 temp___1478)))))
...
;; H
  (assert
  (and (= temp___1482 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1482)
  (<= temp___1482 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1483 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1483)
  (<= temp___1483 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1484 (+ (to_rep1 (first (rt source))) 7)) (in_range1
...
;; H
  (assert
  (and (= temp___1485 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1485)
  (<= temp___1485 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1486 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1486)
  (<= temp___1486 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1487 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1487)
  (<= temp___1487 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1488 (+ (to_rep1 (first (rt source))) 3)) (in_range1
...
;; H
  (assert
  (and (= temp___1489 (+ (to_rep1 (first (rt source))) 2)) (in_range1
...
;; H
  (assert (<= target8 39999999))

;; H
  (assert
  (and (= o61 (+ target8 2100000000)) (in_range1 (+ target8 2100000000))))
