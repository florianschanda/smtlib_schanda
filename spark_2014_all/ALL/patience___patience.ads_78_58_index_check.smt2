...
;; H
  (assert
  (= o21 (select (rec__patience__state__posstack (us_split_fields1 s))
  o20)))
...
;; H
  (assert
  (=> (= result2 true)
  (= o9 (select (rec__patience__state__posstack (us_split_fields1 s))
  o8))))
...
;; H
  (assert
  (=> (= result2 true)
  (= o11 (select (rec__patience__state__stacksizes (us_split_fields1 s))
  o10))))
...
;; H
  (assert
  (=> (= result2 true)
  (= o7 (select (rec__patience__state__posheight (us_split_fields1 s))
  o6))))
