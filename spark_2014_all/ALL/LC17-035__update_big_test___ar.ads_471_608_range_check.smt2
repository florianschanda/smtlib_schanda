...
(declare-fun temp___5221 () (Array Int (Array Int et1)))
...
(declare-fun temp___5222 () (Array Int (Array Int (Array Int et1))))
...
(declare-fun o20 () (Array Int et1))

(declare-fun o21 () (Array Int et1))

(declare-fun o22 () (Array Int (Array Int et1)))

(declare-fun o23 () (Array Int (Array Int et1)))

(declare-fun o24 () Int)

(declare-fun temp___5212 () (Array Int (Array Int (Array Int et1))))
...
;; H
  (assert
  (=> (< k 16) (=> (< 0 e) (and (= o19 (- e 1)) (in_range3 (- e 1))))))
...
;; H
  (assert
  (=> (< k 16) (=> (< 0 e) (and (= o24 (+ k 1)) (in_range2 (+ k 1))))))

;; H
  (assert
  (=> (< k 16)
  (=> (< 0 e)
  (= temp___5212 (temp___1475 a k
                 (temp___1483 (select a k) j
                 (temp___1490 (select (select a k) j) i e)) o24 o23)))))

;; H
  (assert
  (=> (< k 16) (=> (< 0 e) (= result7 (bool_eq2 a3 1 16 temp___5212 1 16)))))
...
;; H
  (assert
  (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (= o11 (+ k 1))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result7 true)) (=> (= e 0) (= temp___5221 (select a o11))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result7 true)) (=> (= e 0) (= o12 (select temp___5221 j))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result7 true)) (=> (= e 0) (= o13 (temp___1544 o12 i 99))))))
...
;; H
  (assert
  (=> (< k 16) (=> (not (= result7 true)) (=> (= e 0) (= o10 (+ k 1))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result7 true)) (=> (= e 0) (= o14 (select a o10))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result7 true)) (=> (= e 0) (= o15 (temp___1537 o14 j o13))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result7 true))
  (=> (= e 0) (and (= o16 (+ k 1)) (in_range2 (+ k 1)))))))
...
;; H
  ...
  (=> (not (= result7 true))
  (=> (= e 0)
  (= temp___5222 (temp___1514 a k
                 (temp___1522 (select a k) j
                 (temp___1529 (select (select a k) j) i e)) o16 o15))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result7 true))
  (=> (= e 0) (= result6 (bool_eq2 a3 1 16 temp___5222 1 16))))))
