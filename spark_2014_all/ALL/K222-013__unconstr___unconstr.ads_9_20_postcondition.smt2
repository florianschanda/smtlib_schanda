...
(((mk___t1 (elts1 (Array Int myint))(rt1 t1)))))
...
;; def_axiom
  ...
  (and (= (first3 temp___174) temp___176) (= (last3 temp___174) temp___177)))
...
;; H
  (assert
  (= (to_rep
     (first2 (rt1 (temp___173 0 (to_rep x__first) (to_rep x__last)))))
  (to_rep x__first)))

;; H
  (assert
  (= (to_rep (last2 (rt1 (temp___173 0 (to_rep x__first) (to_rep x__last)))))
  (to_rep x__last)))
...
;; H
  (assert
  (= (mk (to_rep (first2 temp___1801)) (to_rep (last2 temp___1801)))
  temp___1811))
