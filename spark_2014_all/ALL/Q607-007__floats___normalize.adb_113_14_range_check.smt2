...
;; H
  (assert
  (and (= o (r3 (div1 RNE1 x fliteral5)))
  (and (in_range3 o)
  (and (= o (roundToIntegral RTN1 (div1 RNE1 x fliteral5)))
  (and (le o (div1 RNE1 x fliteral5)) (le
  (sub RNE1 (div1 RNE1 x fliteral5) fliteral) o))))))
