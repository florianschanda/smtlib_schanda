...
(define-fun us_split_fields_F__31__projection ((a us_split_fields)) natural
  (rec__tagged_component_check__s__p3__root__f a))

(define-fun us_split_fields___35__projection ((a us_split_fields)) us_private
  (rec__ext__ a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___35__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun root__ref___13__projection ((a root__ref)) us_rep (root__content
                                                              a))
...
(define-fun us_split_fields_G__15__projection ((a us_split_fields2)) natural
  (rec__tagged_component_check__s__p3__c__g a))

(define-fun us_split_fields_F__32__projection ((a us_split_fields2)) natural
  (rec__tagged_component_check__s__p3__root__f1 a))

(define-fun us_split_fields___36__projection ((a us_split_fields2)) us_private
  (rec__ext__1 a))
...
(define-fun us_rep___71__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))
