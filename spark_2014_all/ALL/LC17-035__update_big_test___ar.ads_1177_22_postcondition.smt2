...
(declare-datatypes ((rec5t__ref 0))
(((mk_rec5t__ref (rec5t__content us_rep2)))))
...
(declare-const temp__split_fields et1)

(declare-const temp__split_fields1 et2)

(declare-const result et1)

(declare-const result1 et2)

(declare-const temp__split_fields2 et1)

(declare-const temp__split_fields3 et2)

(declare-const result2 et3)

(declare-const result3 et1)

(declare-const result4 et2)

(declare-const result5 enum1ta)

(declare-const result6 Bool)

(declare-const result7 et1)

(declare-const result8 et2)
...
(declare-const temp__split_fields4 us_split_fields__ref)

(declare-const r__split_fields10 us_split_fields4)

(declare-const temp__split_fields5 us_split_fields)

(define-fun temp__split_fields6 () us_split_fields (mk___split_fields
                                                   temp__split_fields2
                                                   temp__split_fields3))

;; H
  (assert (= result temp__split_fields))

;; H
  (assert (= result1 temp__split_fields1))

;; H
  (assert (= r__split_fields1 temp__split_fields2))

;; H
  (assert (= r__split_fields2 temp__split_fields3))

;; H
  (assert (= result2 r__split_fields))

;; H
  (assert (= result3 r__split_fields1))

;; H
  (assert (= result4 r__split_fields2))

;; H
  (assert (= result5 r__split_fields3))

;; H
  (assert (= result6 r__split_fields4))

;; H
  (assert (= result7 r__split_fields5))

;; H
  (assert (= result8 r__split_fields6))

;; H
  (assert
  (= r__split_fields7 (mk___split_fields2
                      (mk___rep1
                      (mk___split_fields1 r__split_fields
                      (mk___rep
                      (mk___split_fields r__split_fields5 r__split_fields6))
                      r__split_fields3)) r__split_fields4
                      (mk___rep
                      (mk___split_fields r__split_fields5 r__split_fields6)))))

;; H
  (assert (= result9 (mk___split_fields__ref2 r__split_fields7)))

;; H
  (assert
  (= r__split_fields8 (mk___split_fields2
                      (rec__ar__rec5t__f5 r__split_fields7)
                      (rec__ar__rec5t__g5 r__split_fields7)
                      (mk___rep temp__split_fields6))))

;; H
  (assert
  (= temp__split_fields4 (mk___split_fields__ref temp__split_fields6)))

;; H
  (assert (= r__split_fields9 (mk___split_fields__ref2 r__split_fields8)))

;; H
  (assert (= temp__split_fields5 temp__split_fields6))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1170, characters 0-0
  (not
  (= (to_rep2
     (rec__ar__rec2t__f2
     (us_split_fields3
     (rec__ar__rec5t__f5 (us_split_fields__content2 r__split_fields9)))))
  (to_rep2 r__split_fields))))
(check-sat)
(exit)
