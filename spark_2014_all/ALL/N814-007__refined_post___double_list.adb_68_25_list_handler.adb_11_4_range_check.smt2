...
(define-fun us_split_fields_Pointer__projection ((a us_split_fields2)) index_type
...
(declare-fun list_handler__integer_list__iterator__pointer__first__bit () Int)

(declare-fun list_handler__integer_list__iterator__pointer__last__bit () Int)

(declare-fun list_handler__integer_list__iterator__pointer__position () Int)
...
(declare-datatypes ()
((iterator__ref (mk_iterator__ref (iterator__content us_rep1)))))
(define-fun iterator__ref___projection ((a iterator__ref)) us_rep1 (iterator__content
                                                                   a))

(declare-fun it () us_rep1)
...
(declare-fun o () element_type)

(declare-fun o1 () element_type)

(declare-fun o2 () index_type)

(declare-fun o3 () index_type)

(declare-fun o4 () element_type)

(declare-fun o5 () index_type)

(declare-fun o6 () index_type)

(declare-fun o7 () (Array Int us_rep))

(declare-fun o8 () index_type)

(declare-fun o9 () element_type)

(declare-fun o10 () index_type)

(declare-fun o11 () index_type)

(declare-fun o12 () element_type)

(declare-fun o13 () index_type)

(declare-fun o14 () index_type)

(declare-fun o15 () (Array Int us_rep))

(declare-fun o16 () index_type)

(declare-fun o17 () element_type)

(declare-fun o18 () index_type)

(declare-fun o19 () index_type)

(declare-fun o20 () element_type)

(declare-fun o21 () index_type)
...
;; H
  (assert
  (= (rec__list_handler__integer_list__iterator__pointer
     (us_split_fields3 it)) o2))

;; H
  (assert
  (= (rec__list_handler__integer_list__list_node__previous
     (us_split_fields1
     (select memory (to_rep1
                    (rec__list_handler__integer_list__iterator__pointer
                    (us_split_fields3 it)))))) o3))
...
;; H
  (assert
  (= o7 (store memory new_pointer1 (mk___rep (mk___split_fields o4 o5 o6)))))
...
;; H
  (assert
  (= o15 (store memory1 (to_rep1
                        (rec__list_handler__integer_list__list_node__previous
                        (us_split_fields1
                        (select memory1 (to_rep1
                                        (rec__list_handler__integer_list__iterator__pointer
                                        (us_split_fields3 it))))))) (mk___rep
                                                                    (mk___split_fields
                                                                    o12
                                                                    o13
                                                                    o14)))))
...
;; H
  ...
  (= (rec__list_handler__integer_list__list_node__value
     (us_split_fields1
     (select memory2 (to_rep1
                     (rec__list_handler__integer_list__iterator__pointer
                     (us_split_fields3 it)))))) o17))
...
;; H
  (assert
  (= o23 (store memory2 (to_rep1
                        (rec__list_handler__integer_list__iterator__pointer
                        (us_split_fields3 it))) (mk___rep
                                                (mk___split_fields o20
                                                o21 o22)))))
