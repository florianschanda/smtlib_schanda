...
;; H
  (assert (= o102 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (and (= o96 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert (= o100 (num_of_big_int m m_first o99)))

;; H
  (assert (= o95 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o101 (omultiply o95 o100)))

;; H
  (assert (= o103 (osubtract o101 o102)))

;; H
  (assert (= o92 (from_word32 a_msw3)))
...
;; H
  (assert
  (and (= o86 (base Tuple0))
  (= o86 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o91 (oexpon o86 o90)))

;; H
  (assert (= o93 (omultiply o91 o92)))
...
;; H
  (assert
  (= o85 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o84)))

;; H
  (assert (= o94 (oadd o85 o93)))

;; H
  (assert (= o104 (olt o94 o103)))
...
;; H
  (assert (and (= o69 (+ i2 1)) (in_range1 (+ i2 1))))
...
;; H
  (assert (= o60 (num_of_big_int c c_first o59)))

;; H
  (assert (and (= o51 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o52 (- o51 a_first)))
...
;; H
  (assert (= o55 (num_of_big_int b b_first o54)))

;; H
  (assert (= o61 (omultiply o55 o60)))

;; H
  (assert (= o74 (omultiply o61 o73)))

;; H
  (assert (= o80 (omod o74 o79)))
