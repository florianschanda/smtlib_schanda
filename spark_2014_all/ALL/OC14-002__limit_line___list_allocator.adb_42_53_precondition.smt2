...
;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o9) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true)
  (and (= o8 (get model____split_fields 1)) (in_range7 o8)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o8 first_available) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o6) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result3 true)
  (and (= o5 (get model____split_fields1 1)) (in_range7 o5))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o5 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_allocated 0))) (= result (ite (= o7 0) true false)))))
