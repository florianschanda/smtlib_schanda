...
;; H
  (assert
  (and
  (= o26 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o25 (remove b ib1))
...
;; H
  (assert
  (and (= o27 (remove o25 o26))
  (and (dynamic_invariant2 o27 true false true)
  (and (= (invariant__ o27) true)
  (and (= (to_rep2 (last (rt o27))) (- (to_rep2 (last (rt o25))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o26 1)))
  (= (to_rep (select (elts o25) k)) (to_rep (select (elts o27) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o26 1) k) (<= k (to_rep2 (last (rt o25)))))
  (= (to_rep (select (elts o25) k)) (to_rep (select (elts o27) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o26 k) (<= k (- (to_rep2 (last (rt o25))) 1)))
  (= (to_rep (select (elts o25) (+ k 1))) (to_rep (select (elts o27) k))))))))))))
...
;; H
  (assert
  (and (= o24 (remove a o23))
  (and (dynamic_invariant2 o24 true false true)
  (and (= (invariant__ o24) true)
  (and (= (to_rep2 (last (rt o24))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o23 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o24) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o23 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o24) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o23 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o24) k))))))))))))
