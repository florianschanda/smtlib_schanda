...
(declare-datatypes ()
((t133b__ref (mk_t133b__ref (t133b__content integer)))))
(define-fun t133b__ref___projection ((a t133b__ref)) integer (t133b__content
                                                             a))
...
;; H
  (assert (= result4 (mk_int__ref r2)))

;; H
  (assert (= r3 (+ r2 1)))

;; H
  (assert (=> (< r3 10000) (and (= o14 (+ r3 1)) (in_range3 (+ r3 1)))))
...
;; H
  ...
  (=> (< r3 10000)
  (= (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data3 r3))) o16)))
...
;; H
  (assert (=> (< r3 10000) (= result5 (mk_map__ref data3))))
...
;; WP_parameter_def
 ;; File "list_mod_allocator.adb", line 15, characters 0-0
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data4 rr)))) 0)))
(check-sat)
