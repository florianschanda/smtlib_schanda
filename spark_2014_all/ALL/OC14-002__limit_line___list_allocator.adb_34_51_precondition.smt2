...
;; H
  (assert
  (=> (not (= first_available 0)) (= result1 (ite (< 0 o2) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result1 true)
  (and (= o1 (get model____split_fields 1)) (in_range7 o1)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result1 true) (= result (ite (= o1 first_available) true false)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (not (= result1 true)) (= result false))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (and (= o3 (length model____split_fields)) (in_range6 o3))))

;; H
  (assert
  (=> (not (not (= first_available 0))) (= result (ite (= o3 0) true false))))
