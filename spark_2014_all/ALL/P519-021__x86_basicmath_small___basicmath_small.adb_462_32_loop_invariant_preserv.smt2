...
;; H
  (assert
  (= rsi1 (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104))))
...
;; H
  ...
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= (inrange64 i rsi1 ((_ int2bv 64) 8)) true))
...
;; H
  (assert (= (writereg32post rdx o) true))

;; H
  (assert (and (= o1 (ebx rbx)) (= o1 (readreg32 rbx))))

;; H
  (assert (= (writereg32post rsi2 o1) true))

;; H
  (assert (= (writereg32post rax ((_ int2bv 32) 0)) true))

;; H
  (assert (= (writereg32post rdi2 ((_ int2bv 32) 4198703)) true))

;; H
  (assert (= rbx result3))

;; H
  (assert (= rbx1 (bvadd rbx ((_ int2bv 64) 1))))
...
;; H
  (assert (= zeroflag result5))

;; H
  (assert
  (= zeroflag1 (ite (= (bvsub rbx1 ((_ int2bv 64) 1001)) ((_ int2bv 64) 0))
               true false)))
...
;; H
  (assert
  (= signflag1 (ite (bvugt (bvsub rbx1 ((_ int2bv 64) 1001)) ((_ int2bv 64) 9223372036854775807))
               true false)))
...
;; H
  (assert (= carryflag1 (ite (bvult rbx1 ((_ int2bv 64) 1001)) true false)))
...
;; H
  (assert
  (= overflowflag1 (ite (and (and (= signflag1 true) (= (of_int 0) true))
                        (bvule rbx1 ((_ int2bv 64) 9223372036854775807)))
                   true
                   (ite (and
                        (and (not (= signflag1 true))
                        (bvugt rbx1 ((_ int2bv 64) 9223372036854775807)))
                        (= (of_int 1) true))
                   true false))))
...
;; H
  (assert
  (not (= i (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 1)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 2)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 3)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 4)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 5)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 6)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd rsp5 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 7)))))
