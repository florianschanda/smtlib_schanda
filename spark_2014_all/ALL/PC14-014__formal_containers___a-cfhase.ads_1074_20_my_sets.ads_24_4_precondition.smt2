...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__my_sets__n__cursor__node count_type)))))
...
(define-fun dynamic_invariant1 ((temp___expr_737 Int)
...
(define-fun default_initial_assumption ((temp___expr_744 us_rep2)
  (temp___skip_top_level_745 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_745 true))
                                         (and
                                         (= (is_empty temp___expr_744) true)
                                         (= (length2 temp___expr_744) 0))))
...
(define-fun bool_eq3 ((a us_rep3)
  (b us_rep3)) Bool (ite (and
                         (= (to_rep3
                            (rec__my_sets__my_rec__f (us_split_fields5 a)))
                         (to_rep3
                         (rec__my_sets__my_rec__f (us_split_fields5 b))))
                         (= (to_rep2
                            (rec__my_sets__my_rec__g (us_split_fields5 a)))
                         (to_rep2
                         (rec__my_sets__my_rec__g (us_split_fields5 b)))))
                    true false))
...
(define-fun my_eq ((x us_rep3)
  (y us_rep3)) Bool (= (to_rep3
                       (rec__my_sets__my_rec__f (us_split_fields5 x)))
  (to_rep3 (rec__my_sets__my_rec__f (us_split_fields5 y)))))
...
(define-fun element_type__ref_7__projection ((a element_type__ref2)) us_rep3
...
(define-fun sequence__ref_2__projection ((a sequence__ref)) us_rep4 (sequence__content
                                                                    a))
...
(define-fun default_initial_assumption1 ((temp___expr_724 us_rep4)
  (temp___skip_top_level_725 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_725 true))
                                         (= (length3 temp___expr_724) 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_691 us_rep5)
  (temp___skip_top_level_692 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_692 true))
                                         (= (is_empty1 temp___expr_691) true)))
...
(define-fun element_type__ref_6__projection ((a element_type__ref3)) us_rep3
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (= (contains (model__ container1) (get1 result temp___761)) true))))
     (forall ((item us_rep3))
...
;; contains__post_axiom
  ...
  (! (=> (= (of_int 1) true)
     (=>
     (exists ((e us_rep3))
     (and (= (contains container1 e) true) (= (my_eq e item) true)))
...
(define-fun dynamic_invariant5 ((temp___expr_717 Int)
...
(declare-fun temp___1336 () count_type)
...
;; H
  (assert (= temp___1336 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1336)) no_element))
