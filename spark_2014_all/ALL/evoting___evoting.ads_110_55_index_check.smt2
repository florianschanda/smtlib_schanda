...
(declare-fun o6 () counter_range_t)
...
;; H
  (assert
  (= result14 (ite (= (select (map__content1 winners25) winner) true)
              o4 false)))
...
;; H
  (assert
  (=> (= result14 true)
  (= result13 (ite (< o7 (to_rep (select counters winner))) true false))))

;; H
  (assert (=> (not (= result14 true)) (= result13 (of_int 1))))
