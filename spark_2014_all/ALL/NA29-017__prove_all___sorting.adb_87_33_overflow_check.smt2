...
;; H
  (assert
  (= o16 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last)))
         (mk___t a (mk (to_rep a__first) (to_rep a__last))) o9 o12 o13
         o15)))
...
;; H
  ...
  (= o8 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last)))
        (mk___t a (mk (to_rep a__first) (to_rep a__last))) o3 o4 o5 o7)))
...
;; H
  (assert
  (= o2 (perm2 (mk___t a (mk (to_rep a__first) (to_rep a__last)))
        (mk___t b (mk (to_rep b__first) (to_rep b__last))) a_first o
        o1 i2 j2)))
