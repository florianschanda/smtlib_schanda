...
(define-fun o17 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o18 () us_rep (mk___rep (mk___split_discrs o)
...
(declare-fun result8 () capacity_range)

(declare-fun result9 () us_main_type)
...
;; H
  (assert
  (and
  (= o18 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o18)
...
;; H
  ...
  (= (mk___rep1
     (mk___split_fields1
     (mk___rep (mk___split_discrs result6) (mk___split_fields result7))
     (mk___rep (mk___split_discrs result8) (mk___split_fields result9))))
  (queue__content amortized_queue__tail__result7)))

(assert
;; WP_parameter_def
 ;; File "amortized_queue.ads", line 41, characters 0-0
  (not (= (inv (queue__content amortized_queue__tail__result7)) true)))
(check-sat)
(exit)
