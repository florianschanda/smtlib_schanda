...
;; H
  (assert (= result6 (ite (= o12 o11) true false)))

;; H
  (assert
  (=> (= result6 true) (and (= o7 (- last5 i9)) (in_range1 (- last5 i9)))))

;; H
  (assert (=> (= result6 true) (= o8 (+ o7 1))))

;; H
  (assert (=> (= result6 true) (and (= o9 o8) (in_range1 o8))))
...
;; H
  (assert (=> (= result6 true) (= o10 (to_rep (last (rt o6))))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (= o10 o9) true false))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o2 (- last5 i9)) (in_range1 (- last5 i9)))))

;; H
  (assert (=> (= result5 true) (= o3 (+ o2 1))))

;; H
  (assert (=> (= result5 true) (and (= o4 o3) (in_range1 o3))))

;; H
  (assert (=> (= result5 true) (= o5 (ite (<= j o4) true false))))

;; H
  (assert (=> (= result5 true) (= result7 (ite (<= 1 j) o5 false))))
