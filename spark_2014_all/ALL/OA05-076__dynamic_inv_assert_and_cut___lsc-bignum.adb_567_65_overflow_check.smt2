...
;; H
  (assert (= o51 (ite (<= j3 o50) true false)))

;; H
  (assert (= o46 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o47 (oexpon o46 j3)))
...
;; H
  (assert (and (= o27 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert (= o25 (from_word32 w2)))

;; H
  (assert (= o32 (omultiply o25 o31)))
...
;; H
  (assert (= result6 (ite (<= 0 n) o23 false)))
