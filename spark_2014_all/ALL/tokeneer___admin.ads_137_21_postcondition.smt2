...
(declare-fun admin__opisavailable__result () Int)

(declare-fun temp___361 () Int)

(declare-fun temp___360 () Int)

(declare-fun o () Int)

(declare-fun temp___359 () (Array Int Bool))
...
(declare-fun theop5 () Int)

(declare-fun theop6 () Int)

(declare-fun op3 () Int)

(declare-fun theop7 () Int)

(declare-fun op4 () Int)

(declare-fun theop8 () Int)

(declare-fun op5 () Int)

(declare-fun theop9 () Int)

(declare-fun op6 () Int)

(declare-fun result5 () Int)

(declare-fun admin__opisavailable__result1 () Int)

(declare-fun admin__opisavailable__result2 () Int)

(declare-fun admin__opisavailable__result3 () Int)

(declare-fun theop10 () Int)

(declare-fun op7 () Int)

(declare-fun admin__opisavailable__result4 () Int)

(declare-fun theop11 () Int)

(declare-fun op8 () Int)

(declare-fun admin__opisavailable__result5 () Int)
...
;; H
  (assert (=> (and (<= 1 op1) (<= op1 4)) (= temp___361 op1)))

;; H
  (assert (=> (and (<= 1 op1) (<= op1 4)) (= temp___360 theop1)))
...
;; H
  ...
  op2)))
  (ite (= result3 true) (and (= theop2 result4) (= theop3 op2))
  (= theop3 theop2))))))
  (and
  (and
  (and (= result2 (str_comp keyedop op2))
  ...
  (and (and (= theop3 theop4) (= theop5 theop3)) (= op2 4))))))
...
;; WP_parameter_def
 ;; File "admin.ads", line 30, characters 0-0
  (not
  (ite (= (ite (exists ((op10 Int))
               (and (and (<= 1 op10) (<= op10 4))
               (and
               (and (= (str_comp keyedop op10) true)
               (= (allowedop theadmin op10) true))
               (= admin__opisavailable__result4 op10))))
          true (= admin__opisavailable__result4 0)) true) (ite (= (ite
                                                                  (exists
                                                                  ((op10 Int))
                                                                  (and
                                                                  (and
                                                                  ...
                                                                  admin__opisavailable__result4 op10))))
                                                                  (=
                                                                  admin__opisavailable__result4 0)
