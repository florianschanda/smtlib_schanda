...
;; H
  (assert
  (and (= o16 (shift_perm_l o24 o23 o21))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o21 o23) true)))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o20))) (- (to_rep2 (last (rt o19))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o19) k)) (to_rep (select (elts o20) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o19)))))
  (= (to_rep (select (elts o19) k)) (to_rep (select (elts o20) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o19))) 1)))
  (= (to_rep (select (elts o19) (+ k 1))) (to_rep (select (elts o20) k))))))))))))
