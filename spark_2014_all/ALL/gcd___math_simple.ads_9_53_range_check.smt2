...
(declare-fun math_simple__gcd__result () Int)
...
(declare-fun math_simple__gcd__result1 () Int)

(declare-fun math_simple__gcd__result2 () Int)

(declare-fun math_simple__gcd__result3 () Int)

(declare-fun c10 () Int)

(declare-fun math_simple__gcd__result4 () Int)

(declare-fun c11 () Int)

(declare-fun math_simple__gcd__result5 () Int)
...
;; H
  (assert
  (= (mk_int__ref math_simple__gcd__result4) (mk_int__ref
                                             math_simple__gcd__result2)))
...
;; H
  (assert (<= (+ math_simple__gcd__result4 1) x))
