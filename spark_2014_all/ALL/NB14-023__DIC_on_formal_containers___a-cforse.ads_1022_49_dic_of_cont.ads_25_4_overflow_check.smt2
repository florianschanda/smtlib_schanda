...
(define-fun equivalent_elements ((left1 Int)
  (right1 Int)) Bool (and (not (< left1 right1)) (not (< right1 left1))))
...
(define-fun sequence__ref___5__projection ((a sequence__ref)) us_rep1
  (sequence__content a))
...
(define-fun set__ref___4__projection ((a set__ref1)) us_rep2 (set__content1
                                                             a))
...
;; H
  ...
  (and (in_range1 o)
  (<= o (to_rep
        (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 right)))))))
...
(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 970, characters 0-0
  (not (in_range o1)))
(check-sat)
(exit)
