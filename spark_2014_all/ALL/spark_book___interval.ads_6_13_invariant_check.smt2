...
;; H
  (assert (tqtisFinite low))

;; H
  (assert (tqtisFinite high))
...
;; H
  (assert
  (=> (le low high) (= interval__make__result6 interval__make__result2)))

;; H
  (assert
  (=> (le low high) (= interval__make__result7 interval__make__result3)))

;; H
  (assert
  (=> (le low high) (= interval__make__result8 interval__make__result14)))

;; H
  (assert (=> (le low high) (= (to_rep o) high)))

;; H
  (assert (=> (le low high) (= (to_rep o1) low)))

;; H
  (assert (=> (le low high) (= o1 o2)))

;; H
  (assert (=> (le low high) (= o o3)))

;; H
  (assert (=> (le low high) (= o4 o2)))

;; H
  (assert (=> (le low high) (= o5 o3)))

;; H
  (assert (=> (le low high) (= result interval__make__result)))

;; H
  (assert (=> (le low high) (= result1 interval__make__result1)))
...
;; H
  (assert (=> (not (le low high)) (= (to_rep o6) low)))

;; H
  (assert (=> (not (le low high)) (= (to_rep o7) high)))

;; H
  (assert (=> (not (le low high)) (= o7 o8)))

;; H
  (assert (=> (not (le low high)) (= o6 o9)))

;; H
  (assert (=> (not (le low high)) (= o10 o8)))

;; H
  (assert (=> (not (le low high)) (= o11 o9)))

;; H
  (assert (=> (not (le low high)) (= result2 interval__make__result)))

;; H
  (assert (=> (not (le low high)) (= result3 interval__make__result1)))
