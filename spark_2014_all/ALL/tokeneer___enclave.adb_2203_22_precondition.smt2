...
;; H
  (assert
  (=> (= (int__content status3) 8) (= o26 (ite (= o25 0) true false))))
...
;; H
  (assert
  (=> (= (int__content status3) 8)
  (= o27 (ite (not (= o24 true)) true false))))

;; H
  (assert
  (=> (= (int__content status3) 8) (= o28 (ite (= o27 true) o26 false))))

;; H
  (assert (=> (not (= (int__content status3) 8)) (= o28 (of_int 1))))
...
;; H
  (assert
  (=> (= (int__content status3) 3) (= o21 (ite (= o20 o19) true false))))
...
;; H
  (assert
  (=> (= (int__content status3) 3)
  (= o22 (ite (not (= o18 true)) true false))))

;; H
  (assert
  (=> (= (int__content status3) 3) (= o23 (ite (= o22 true) o21 false))))

;; H
  (assert (=> (not (= (int__content status3) 3)) (= o23 (of_int 1))))
...
;; H
  (assert
  (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7))
  (= o16 (ite (= o12 true) o11 false))))

;; H
  (assert
  (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7))
  (= o17 (ite (= o16 true) o15 false))))
...
;; H
  (assert
  (=> (= result2 true) (= o10 (ite (= (int__content status3) 6) true false))))
