...
(declare-fun records__safe_add_pair_b__result () unsigned_byte)
...
(declare-fun records__safe_add_pair_b__result2 () unsigned_byte)

(declare-fun records__safe_add_pair_b__result3 () unsigned_byte)

(declare-fun records__safe_add_pair_b__result4 () pair__ref)

(declare-fun records__safe_add_pair_b__result5 () us_rep)

(declare-fun r__split_fields6 () us_split_fields__ref)

(declare-fun records__safe_add_pair_b__result6 () pair__ref)

(declare-fun r__split_fields7 () us_split_fields)

(declare-fun records__safe_add_pair_b__result7 () us_rep)
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 11, characters 0-0
  (not
  (= (bool_eq1 (pair__content records__safe_add_pair_b__result6)
     (mk___rep
     (mk___split_fields
     (of_rep
     (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) 
