...
;; H
  ...
  (=> (or (<= x26 temp___255) (not (= x14 temp___254)))
...
;; H
  (assert
  (and (= o25 (slow_lcs_length s1 s2))
  (and (in_range4 o25)
  (= o25 (ite (or
              (= (bool_eq (elts s1) (to_rep1 (first (rt s1)))
                 (to_rep1 (last (rt s1))) (temp___String_Literal_152 Tuple0)
                 1 0) true)
              (= (bool_eq (elts s2) (to_rep1 (first (rt s2)))
                 (to_rep1 (last (rt s2))) (temp___String_Literal_154 Tuple0)
                 1 0) true))
         0
         (ite (= (head s1) (head s2))
