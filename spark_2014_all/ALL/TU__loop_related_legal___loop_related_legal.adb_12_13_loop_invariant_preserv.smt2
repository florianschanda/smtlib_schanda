...
(declare-fun arr3 () (Array Int natural))
...
(declare-fun arr4 () (Array Int natural))
...
;; H
  ...
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 10))
  (<= (to_rep (select arr i)) (to_rep (select arr3 i))))))

;; H
  (assert
  (and
  (and (=> (<= 1 10) (in_range4 n2))
  (forall ((temp___144 Int))
  (=> (and (<= 1 temp___144) (<= temp___144 10))
  (=> (< n2 temp___144) (= (select arr3 temp___144) (select arr temp___144))))))
  (and (<= 1 n2) (<= n2 10))))
...
;; H
  (assert
  (=> (< (to_rep (select arr3 n3)) 2147483647)
  (and (= o3 (+ (to_rep (select arr3 n3)) 1)) (in_range1
  (+ (to_rep (select arr3 n3)) 1)))))
...
;; H
  (assert
  (=> (< (to_rep (select arr3 n3)) 2147483647) (= o5 (store arr3 n3 o4))))
...
;; WP_parameter_def
 ;; File "loop_related_legal.adb", line 17, characters 0-0
  (not (<= (to_rep (select arr i)) (to_rep (select arr4 i)))))
(check-sat)
