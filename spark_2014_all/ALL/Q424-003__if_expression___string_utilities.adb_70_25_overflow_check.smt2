...
;; H
  (assert
  (and (= o27 (get_length o25 o26 (map__content1 lengths12)))
  (and (dynamic_property3 0 last4 o27)
  (= o27 (ite (and (dynamic_property1 first2 last2 o25) (dynamic_property2
              first3 last3 o26))
         (to_rep2 (get (map__content1 lengths12) o25 o26)) 0)))))
...
;; H
  (assert
  (and (= o28 (get_length x19 o24 (map__content1 lengths12)))
  (and (dynamic_property3 0 last4 o28)
  (= o28 (ite (and (dynamic_property1 first2 last2 x19) (dynamic_property2
              first3 last3 o24))
         (to_rep2 (get (map__content1 lengths12) x19 o24)) 0)))))
