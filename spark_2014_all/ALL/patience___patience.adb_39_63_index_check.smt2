...
;; H
  (assert (= o27 topstacki2))

;; H
  (assert (= o28 (select s__split_fields5 o27)))

;; H
  (assert (= o29 (to_rep1 o28)))

;; H
  (assert (= result8 (ite (<= 0 o29) true false)))

;; H
  (assert (=> (= result8 true) (and (<= 0 topstacki2) (<= topstacki2 99))))

;; H
  (assert (=> (= result8 true) (= o24 topstacki2)))

;; H
  (assert (=> (= result8 true) (= o25 (select s__split_fields5 o24))))

;; H
  (assert (=> (= result8 true) (= o26 (to_rep1 o25))))

;; H
  (assert
  (=> (= result8 true)
  (= result7 (ite (< o26 (to_rep1 s__split_fields2)) true false))))
...
;; H
  (assert (=> (= result7 true) (= o21 topstacki2)))

;; H
  (assert (=> (= result7 true) (= o22 (select s__split_fields6 o21))))

;; H
  (assert (=> (= result7 true) (= o23 (to_rep1 o22))))

;; H
  (assert (=> (= result7 true) (= result6 (ite (<= 0 o23) true false))))
...
;; H
  (assert (=> (= result6 true) (= o16 (select s__split_fields5 o15))))

;; H
  (assert (=> (= result6 true) (= temp___544 (to_rep1 o16))))

;; H
  (assert (=> (= result6 true) (and (<= 0 temp___544) (<= temp___544 99))))

;; H
  (assert (=> (= result6 true) (= o17 temp___544)))

;; H
  (assert (=> (= result6 true) (= o18 (select s__split_fields3 o17))))

;; H
  (assert (=> (= result6 true) (= o19 (to_rep1 o18))))
...
;; H
  (assert (=> (= result6 true) (= o20 (to_rep1 o14))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (< o20 o19) true false))))
...
;; H
  (assert (= temp___547 (to_rep1 o11)))

;; H
  (assert (and (<= 0 temp___547) (<= temp___547 99)))

;; H
  (assert (= o12 temp___547))

;; H
  (assert (= temp___548 (select s__split_fields4 o12)))
