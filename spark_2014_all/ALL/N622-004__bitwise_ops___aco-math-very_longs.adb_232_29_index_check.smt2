...
(declare-const temp___1158 digit_index_type)

(declare-const temp___11581 (Array Int octet))

(declare-const temp___11582 t1)
...
;; H
  (assert
  (= (mk___t2 temp___1154 temp___11541) (temp___1147 ((_ int2bv 8) 0) 1
                                        (to_rep1
                                        (rec__aco__math__very_longs__very_long__octet_length
                                        (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11541)) (to_rep2 (last4 temp___11541)))
     (+ (- (to_rep2 (last4 temp___11541)) (to_rep2 (first4 temp___11541))) 1)
     0) (ite (<= 1 (to_rep1
                   (rec__aco__math__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep1
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11541)) (to_rep2 (last4 temp___11541)))
  temp___11551))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___11551)) (to_rep2 (last2 temp___11551)))
     (+ (- (to_rep2 (last2 temp___11551)) (to_rep2 (first2 temp___11551))) 1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___1155 temp___11551)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1158)))

;; H
  (assert (= temp___11581 o2))

;; H
  (assert (= temp___11582 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___11581 temp___11582))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      result____split_fields3)))) temp___1166)
  (<= temp___1166 (to_rep2
                  (last2
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__aco__math__very_longs__very_long__long_digits1
             result____split_fields3)) temp___1166) (select (elts1
                                                            (rec__aco__math__very_longs__very_long__long_digits1
                                                            result____split_fields2)) temp___1166))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
