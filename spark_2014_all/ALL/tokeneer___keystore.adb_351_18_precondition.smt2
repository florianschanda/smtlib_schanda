...
;; H
  ...
  (= (select o16 temp___1296) (select result__6 temp___1296))))))

;; H
  (assert (=> (= result9 true) (= result10 (mk_map__ref result__6))))

;; H
  (assert (=> (= result9 true) (= result__7 o16)))
...
;; H
  (assert (=> (not (= result9 true)) (= o17 temp___1290)))

;; H
  (assert (=> (not (= result9 true)) (= result11 (mk_map__ref result__6))))

;; H
  (assert (=> (not (= result9 true)) (= result__8 o17)))
