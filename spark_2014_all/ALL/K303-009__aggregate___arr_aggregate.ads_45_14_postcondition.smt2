...
(declare-datatypes ((ta3D1__ref 0))
(((mk_ta3D1__ref (ta3D1__content ta3D1)))))
...
(((mk_map__ref1 (map__content1 (Array Int (Array Int integer)))))))
...
(declare-datatypes ((t59s__ref 0)) (((mk_t59s__ref (t59s__content t59s)))))
...
(declare-datatypes ((t65s__ref 0)) (((mk_t65s__ref (t65s__content t65s)))))
...
(declare-datatypes ((t71s__ref 0)) (((mk_t71s__ref (t71s__content t71s)))))
...
(declare-datatypes ((t77s__ref 0)) (((mk_t77s__ref (t77s__content t77s)))))
...
(declare-datatypes ((t83s__ref 0)) (((mk_t83s__ref (t83s__content t83s)))))
...
;; WP_parameter_def
 ;; File "arr_aggregate.ads", line 41, characters 0-0
  (not
  (= (bool_eq1 a1 1 2 (temp___224 (temp___229 one 2) (temp___234 one 2)) 1 2) true)))
(check-sat)
(exit)
