...
(((mk___split_fields
  (rec__unbounded_strings__char_vectors__vector us_main_type)))))
...
(define-fun default_initial_assumption ((temp___expr_249 us_rep1)
  (temp___skip_top_level_250 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_250 true))
                                         (= (length1 temp___expr_249) 0)))
...
;; H
  (assert
  (=> (not (= before 0)) (= o5 (ite (= (- before 1) o4) true false))))
