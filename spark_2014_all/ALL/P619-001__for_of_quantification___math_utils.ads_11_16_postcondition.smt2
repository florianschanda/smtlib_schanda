...
(declare-fun math_utils__max__result () Int)
...
(declare-fun math_utils__max__result1 () Int)

(declare-fun math_utils__max__result2 () Int)

(declare-fun math_utils__max__result3 () Int)

(declare-fun result__8 () Int)

(declare-fun i7 () Int)

(declare-fun math_utils__max__result4 () int__ref)

(declare-fun result__9 () Int)

(declare-fun i8 () Int)

(declare-fun math_utils__max__result5 () Int)
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v)))))
  (= result__10 (mk_int__ref result__4))))
...
;; H
  (assert
  (= math_utils__max__result4 (mk_int__ref math_utils__max__result2)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (<= (to_rep (select (elts v) temp___172)) (int__content
                                            math_utils__max__result4))))
(check-sat)
(exit)
