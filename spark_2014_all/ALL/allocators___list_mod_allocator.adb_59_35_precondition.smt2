...
;; H
  ...
  (and (in_range5 o10) (<= (+ 0 o10) 2147483647))))
...
;; H
  (assert
  (=> (= result4 true)
  (=> (not (= first_available 0)) (= result5 (ite (< 0 o8) true false)))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (= o7 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
        1))
  (in_range6 o7))))))
...
;; H
  ...
  (=> (= result4 true)
  (=> (not (= first_available 0))
  (=> (= result5 true) (= result3 (ite (= o7 first_available) true false))))))

;; H
  (assert
  (=> (= result4 true)
  (=> (not (= first_available 0))
  (=> (not (= result5 true)) (= result3 false)))))
...
;; H
  ...
  (= o9 (length
        (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o9) (<= (+ 0 o9) 2147483647))))))

;; H
  (assert
  (=> (= result4 true)
  (=> (not (not (= first_available 0)))
  (= result3 (ite (= o9 0) true false)))))
...
;; H
  ...
  (= o5 (length
        (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o5) (<= (+ 0 o5) 2147483647)))))
...
;; H
  ...
  (<= j3 (length
         (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))))
  (and (in_range3
  (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j3))
  (=>
  (< j3 (length
        (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (= (to_rep
...
;; H
  ...
  (= o1 (length
        (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o1) (<= (+ 0 o1) 2147483647)))))
...
;; H
  ...
  (=>
  (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j3)
  (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) k))
  (= j3 k)))))))))
