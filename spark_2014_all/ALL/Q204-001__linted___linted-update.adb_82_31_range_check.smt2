...
(define-fun y6 () int__ref (mk_int__ref y1))

(define-fun y7 () int__ref (mk_int__ref y))
...
;; H
  (assert (=> (bvule x2 ((_ int2bv 32) 2147483647)) (= result1 y7)))
...
;; H
  (assert (=> (not (bvule x2 ((_ int2bv 32) 2147483647))) (= result2 y7)))
...
;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= result5 y6)))

;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= y4 o50)))
...
;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= result6 y6)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y5 o54)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y4 y5)))

;; H
  (assert (= (to_rep1 o55) y4))
