...
;; H
  (assert
  (and (= o21 (length model____split_fields))
  (and (in_range6 o21) (<= (+ 0 o21) 2147483647))))
...
;; H
  (assert
  (=> (= result3 true)
  (and (= o20 (length1 model____split_fields1)) (in_range6 o20))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o16 (length1 model____split_fields1)) (in_range6 o16))))

;; H
  (assert
  (=> (= result2 true)
  (and (= o17 (length model____split_fields))
  (and (in_range6 o17) (<= (+ 0 o17) 2147483647)))))
...
;; H
  ...
  (and (= o14 (length model____split_fields))
  (and (in_range6 o14) (<= (+ 0 o14) 2147483647))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result4 (ite (< 0 o14) true false)))))
...
;; H
  ...
  (=> (not (= first_available 0))
  (=> (= result4 true)
  (and (= o13 (get model____split_fields 1)) (in_range7 o13))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result4 true) (= result (ite (= o13 first_available) true false))))))
...
;; H
  ...
  (and (= o15 (length model____split_fields))
  (and (in_range6 o15) (<= (+ 0 o15) 2147483647))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_available 0)))
  (= result (ite (= o15 0) true false)))))
...
;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true) (and (= o9 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true)
  (and (= o10 (get model____split_fields o9)) (in_range7 o10)))))
...
;; H
  (assert
  (=> (= result7 true)
  (and (= temp___276 (get model____split_fields j)) (in_range7 temp___276))))

;; H
  (assert
  (=> (= result7 true) (and (<= 1 temp___276) (<= temp___276 10000))))
...
;; H
  (assert
  (=> (= result7 true)
  (= (mk___rep (mk___split_fields o3 o4)) (select data o2))))
