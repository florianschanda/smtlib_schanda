...
(((mk_tT59bP1__ref (tT59bP1__content tdigit_index_typeB)))))
(define-fun tT59bP1__ref___projection ((a tT59bP1__ref)) tdigit_index_typeB
  (tT59bP1__content a))
...
(declare-datatypes ((t59b__ref 0)) (((mk_t59b__ref (t59b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits17__projection ((a us_split_fields2)) us_t1
  (rec__aco__math__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref_17__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep_33__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                a))

(define-fun us_rep_34__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))

(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___167 (rec__aco__math__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___167)
                                         (first3 temp___167)
                                         (last3 temp___167))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1)
                                          (mk___split_fields1
                                          (let ((temp___166 (rec__aco__math__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array1 (to_array temp___166)
                                          (first1 temp___166)
                                          (last1 temp___166))))))
...
(define-fun tresultS__ref_2__projection ((a tresultS__ref)) us_rep1 (tresultS__content
                                                                    a))

(define-fun dynamic_invariant4 ((temp___expr_657 us_rep1)
  (temp___is_init_654 Bool) (temp___skip_constant_655 Bool)
  (temp___do_toplevel_656 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_655 true))
                                      (in_range4
                                      (to_rep1
                                      (rec__aco__math__very_longs__very_long__octet_length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_657)))
                                      ...
                                      (first3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_657)))
                                      (last3
                                      (rec__aco__math__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_657))))
                                      (and
                                      (= (first3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_657))) 1)
                                      (= (last3
                                         (rec__aco__math__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_657)))
                                      (to_rep1
...
(define-fun default_initial_assumption ((temp___expr_660 us_rep1)
  (temp___skip_top_level_661 Bool)) Bool (= (to_rep1
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_660))) (to_rep1
                                                               (rec__aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               l)))))
...
(((mk_t60b__ref (t60b__content tdigit_index_typeB)))))
(define-fun t60b__ref___projection ((a t60b__ref)) tdigit_index_typeB
  (t60b__content a))
...
(declare-datatypes ((t61b__ref 0)) (((mk_t61b__ref (t61b__content us_t2)))))
...
;; def_axiom
  ...
  (let ((temp___1113 (temp___1112 temp___1114 temp___1115 temp___1116)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___1115 temp___1116)
  (and (= (first5 temp___1113) temp___1115)
  (= (last5 temp___1113) temp___1116)))
  (forall ((temp___1117 Int))
  (= (select (to_array2 temp___1113) temp___1117) (of_rep temp___1114))))))))
...
;; H
  (assert
  (= (mk___t2 temp___1119 temp___11191) (temp___1112 ((_ int2bv 8) 0) 1
                                        (to_rep1
                                        (rec__aco__math__very_longs__very_long__octet_length
                                        (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11191)) (to_rep2 (last4 temp___11191)))
     (+ (- (to_rep2 (last4 temp___11191)) (to_rep2 (first4 temp___11191))) 1)
     0) (ite (<= 1 (to_rep1
                   (rec__aco__math__very_longs__very_long__octet_length
                   (us_split_discrs1 l))))
        (+ (- (to_rep1
              (rec__aco__math__very_longs__very_long__octet_length
              (us_split_discrs1 l))) 1) 1)
        0)))

;; H
  (assert (= temp___1119 temp___1120))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11191)) (to_rep2 (last4 temp___11191)))
  temp___11201))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___11201)) (to_rep2 (last2 temp___11201)))
     (+ (- (to_rep2 (last2 temp___11201)) (to_rep2 (first2 temp___11201))) 1)
