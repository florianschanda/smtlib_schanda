...
(declare-fun temp___1113 () (_ BitVec 16))

(declare-fun temp___1112 () Int)

(declare-fun temp___1111 () us_rep)

(declare-fun temp___1110 () us_rep1)

(declare-fun temp___1109 () (_ BitVec 16))
...
(declare-fun q_hat2 () t__ref1)

(declare-fun current_borrow2 () t__ref1)
...
;; H
  (assert (= temp___1113 q_hat))

;; H
  (assert (= temp___1112 j1))

;; H
  (assert
  (= temp___1111 (mk___rep quotient__split_discrs quotient__split_fields2)))

;; H
  (assert (= temp___1110 (mk___rep1 u__split_discrs u__split_fields2)))

;; H
  (assert (= temp___1109 current_borrow))

;; H
  (assert
  (and
  (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) false
  true true) (dynamic_invariant1
  (mk___rep quotient__split_discrs quotient__split_fields3) false true true))
  (=> (<= 1 2147483647) (in_range2 j2))))
...
;; H
  ...
  (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields5) true true
  true)))
...
;; H
  (assert (dynamic_property2 1 last2 r144b))
