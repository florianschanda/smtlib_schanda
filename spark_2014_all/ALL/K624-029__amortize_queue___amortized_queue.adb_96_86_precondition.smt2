...
(define-fun o11 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o12 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  (assert
  (and
  (= o12 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o12)
...
;; WP_parameter_def
 ;; File "amortized_queue.ads", line 41, characters 0-0
  (not
  (or (= 1000 0)
  (<= (length (rec__amortized_queue__queue__rear result____split_fields5)) 1000))))
(check-sat)
(exit)
