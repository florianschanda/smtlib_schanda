...
;; range_axiom
  (assert
  (forall ((x bits_6)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(declare-fun dummy5 () bits_26)

(declare-datatypes ()
((bits_26__ref (mk_bits_26__ref (bits_26__content bits_26)))))
(define-fun bits_26__ref___projection ((a bits_26__ref)) bits_26 (bits_26__content
                                                                 a))
...
;; range_axiom
  (assert
  (forall ((x bits_26)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)) )))

;; coerce_axiom
  (assert
  (forall ((x (_ BitVec 32)))
  (! (let ((y (bvurem x ((_ int2bv 32) 67108864))))
...
;; range_int_axiom
  (assert
  (forall ((x bits_26)) (! (in_range_int1
  (to_int6 x)) :pattern ((to_int6 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__ec_golp_type__offset_ext bits_6)(rec__dw1000__register_types__ec_golp_type__reserved bits_26)))))
(define-fun us_split_fields_OFFSET_EXT__projection ((a us_split_fields)) bits_6
  (rec__dw1000__register_types__ec_golp_type__offset_ext a))

(define-fun us_split_fields_Reserved6__projection ((a us_split_fields)) bits_26
  (rec__dw1000__register_types__ec_golp_type__reserved a))
...
(define-fun us_rep_33__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep2
                           (rec__dw1000__register_types__ec_golp_type__offset_ext
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__ec_golp_type__offset_ext
                                                  (us_split_fields1 b))))
                        (= (to_rep3
                           (rec__dw1000__register_types__ec_golp_type__reserved
...
(declare-fun dw1000__register_types__ec_golp_type__offset_ext__first__bit () Int)

(declare-fun dw1000__register_types__ec_golp_type__offset_ext__last__bit () Int)

(declare-fun dw1000__register_types__ec_golp_type__offset_ext__position () Int)

;; dw1000__register_types__ec_golp_type__offset_ext__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__ec_golp_type__offset_ext__first__bit))

;; dw1000__register_types__ec_golp_type__offset_ext__last__bit_axiom
  (assert
  (< dw1000__register_types__ec_golp_type__offset_ext__first__bit dw1000__register_types__ec_golp_type__offset_ext__last__bit))

;; dw1000__register_types__ec_golp_type__offset_ext__position_axiom
  (assert (<= 0 dw1000__register_types__ec_golp_type__offset_ext__position))

(declare-fun dw1000__register_types__ec_golp_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__ec_golp_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__ec_golp_type__reserved__position () Int)

;; dw1000__register_types__ec_golp_type__reserved__first__bit_axiom
  (assert (<= 0 dw1000__register_types__ec_golp_type__reserved__first__bit))

;; dw1000__register_types__ec_golp_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__ec_golp_type__reserved__first__bit dw1000__register_types__ec_golp_type__reserved__last__bit))

;; dw1000__register_types__ec_golp_type__reserved__position_axiom
...
(declare-datatypes ()
((ec_golp_type__ref (mk_ec_golp_type__ref (ec_golp_type__content us_rep)))))
(define-fun ec_golp_type__ref___projection ((a ec_golp_type__ref)) us_rep
  (ec_golp_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_73__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_53__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_53__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3713 us_t1)
  (temp___is_init_3710 Bool) (temp___skip_constant_3711 Bool)
  (temp___do_toplevel_3712 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3711 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3713)
                                       (last3 temp___expr_3713))
                                       (and (= (first3 temp___expr_3713) 1)
                                       (= (last3 temp___expr_3713) 4)))))
