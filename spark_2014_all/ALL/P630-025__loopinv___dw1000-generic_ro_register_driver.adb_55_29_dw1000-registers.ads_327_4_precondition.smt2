...
(define-fun us_split_fields_Reserved__6__projection ((a us_split_fields)) bits_26
...
(define-fun us_rep___33__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun register_type__ref___73__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___53__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___53__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3761 us_t1)
  (temp___is_init_3758 Bool) (temp___skip_constant_3759 Bool)
  (temp___do_toplevel_3760 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3759 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3761)
                                       (last3 temp___expr_3761))
                                       (and (= (first3 temp___expr_3761) 1)
                                       (= (last3 temp___expr_3761) 4)))))
