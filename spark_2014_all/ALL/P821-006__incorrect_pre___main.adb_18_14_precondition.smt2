...
(declare-fun dummy5 () tbyte_array_4D1)

(declare-datatypes ()
((tbyte_array_4D1__ref
 (mk_tbyte_array_4D1__ref (tbyte_array_4D1__content tbyte_array_4D1)))))
(define-fun tbyte_array_4D1__ref___projection ((a tbyte_array_4D1__ref)) tbyte_array_4D1
...
(declare-fun dummy6 () tTarrSP1)

(declare-datatypes ()
((tTarrSP1__ref (mk_tTarrSP1__ref (tTarrSP1__content tTarrSP1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_236 Int)
...
(declare-fun arr1 () (Array Int byte))
