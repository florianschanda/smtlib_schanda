...
;; H
  (assert (= result13 (ite (in_range4 o62) true false)))
...
;; H
  (assert (=> (= result13 true) (= result14 (ite (< j o58) true false))))

;; H
  (assert
  (=> (= result13 true)
  (=> (= result14 true) (and (= o59 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o60 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o59))
  (in_range7 o60)))))

;; H
  (assert (=> (= result13 true) (=> (not (= result14 true)) (= o60 0))))
...
;; H
  (assert (=> (= result13 true) (and (<= 1 temp___400) (<= temp___400 3))))

;; H
  (assert (=> (= result13 true) (= o54 temp___400)))

;; H
  (assert (=> (= result13 true) (= o55 (select data3 o54))))

;; H
  (assert (=> (= result13 true) (= o56 (us_split_fields1 o55))))

;; H
  (assert
  (=> (= result13 true) (= o57 (rec__list_allocator__cell__next o56))))

;; H
  (assert (=> (= result13 true) (= o61 (to_rep o57))))

;; H
  (assert (=> (= result13 true) (= result12 (ite (= o61 o60) true false))))
...
;; H
  ...
  (=> (< 1 j)
  (and
  (= o52 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o51))
  (in_range7 o52)))))

;; H
  (assert (=> (= result12 true) (=> (not (< 1 j)) (= o52 0))))
...
;; H
  ...
  (= temp___401 (get
                (rec__list_allocator__m__t__allocated model____split_fields3)
                j))
  (in_range7 temp___401))))

;; H
  (assert (=> (= result12 true) (and (<= 1 temp___401) (<= temp___401 3))))

;; H
  (assert (=> (= result12 true) (= o47 temp___401)))
...
;; H
  (assert
  (=> (= result12 true) (= o50 (rec__list_allocator__cell__prev o49))))

;; H
  (assert (=> (= result12 true) (= o53 (to_rep o50))))
...
;; H
  (assert (= o46 (ite (<= k o45) true false)))

;; H
  (assert (= result15 (ite (<= 1 k) o46 false)))
