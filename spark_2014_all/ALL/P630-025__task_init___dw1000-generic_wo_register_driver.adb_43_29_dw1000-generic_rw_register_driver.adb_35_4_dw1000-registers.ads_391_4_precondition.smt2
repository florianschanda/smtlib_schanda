...
(define-fun us_split_fields__ref___47__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___47__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-datatypes ((drx_tune1a_type__ref 0))
...
(define-fun register_type__ref___108__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___77__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___77__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4825 us_t1)
  (temp___is_init_4822 Bool) (temp___skip_constant_4823 Bool)
  (temp___do_toplevel_4824 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4823 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_4825)
                                       (last3 temp___expr_4825))
                                       (and (= (first3 temp___expr_4825) 1)
                                       (= (last3 temp___expr_4825) 2)))))
...
(define-fun target__ref___32__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___32__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_4841 us_t2)
  (temp___is_init_4838 Bool) (temp___skip_constant_4839 Bool)
  (temp___do_toplevel_4840 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4839 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_4841)
                                       (last5 temp___expr_4841))
                                       (and (= (first5 temp___expr_4841) 1)
                                       (= (last5 temp___expr_4841) 2)))))
...
;; H
  (assert
  (and (= temp___79422 (register_to_bytes reg)) (dynamic_invariant1
  temp___79422 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79421)) (to_rep (last4 temp___79421)))
     (+ (- (to_rep (last4 temp___79421)) (to_rep (first4 temp___79421))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79421)) (to_rep (last4 temp___79421)))
  temp___79431))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79431)) (to_rep (last2 temp___79431)))
     (+ (- (to_rep (last2 temp___79431)) (to_rep (first2 temp___79431))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7943 temp___79431)))
