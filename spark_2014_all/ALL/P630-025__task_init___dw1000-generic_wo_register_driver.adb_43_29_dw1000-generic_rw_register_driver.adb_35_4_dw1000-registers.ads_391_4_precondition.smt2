...
(define-fun dynamic_invariant ((temp___expr_4757 us_t1)
  ...
  (temp___do_toplevel_4756 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_4757))
                                       (and (= (first3 temp___expr_4757) 1)
                                       (= (last3 temp___expr_4757) 2)))))
...
(define-fun dynamic_invariant1 ((temp___expr_4773 us_t2)
  ...
  (temp___do_toplevel_4772 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_4773))
                                       (and (= (first5 temp___expr_4773) 1)
                                       (= (last5 temp___expr_4773) 2)))))
...
;; H
  (assert
  (and (= temp___77922 (register_to_bytes reg)) (dynamic_invariant1
  temp___77922 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77921)) (to_rep (last4 temp___77921)))
     (+ (- (to_rep (last4 temp___77921)) (to_rep (first4 temp___77921))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77921)) (to_rep (last4 temp___77921)))
  temp___77931))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77931)) (to_rep (last2 temp___77931)))
     (+ (- (to_rep (last2 temp___77931)) (to_rep (first2 temp___77931))) 1)
