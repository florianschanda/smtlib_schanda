...
(declare-fun temp___1324 () us_rep1)

(declare-fun temp___1323 () (_ BitVec 16))

(declare-fun temp___1322 () us_rep)

(declare-fun temp___1321 () (_ BitVec 16))

(declare-fun temp___1320 () Int)

(declare-fun o15 () Int)

(declare-fun o16 () octet)
...
;; H
  (assert
  (= temp___1322 (mk___rep quotient__split_discrs quotient__split_fields2)))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      remainder__split_fields3)))) temp___1331)
  (<= temp___1331 (to_rep2
                  (last
                  (rt
                  (rec__aco__math__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1331)
  (= (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1331) (select (elts
                                                             (rec__aco__math__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1331))))))
...
;; H
  ...
  (<= divisor_index2 (to_rep2
                     (last4
                     (rt1
                     (rec__aco__math__very_longs__very_long__long_digits1
                     (us_split_fields__content1 u__split_fields8))))))))
...
;; H
  ...
  (= o16 (select (elts1
                 (rec__aco__math__very_longs__very_long__long_digits1
                 (us_split_fields__content1 u__split_fields8))) o15)))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      remainder__split_fields3)))) divisor_index2)))
(check-sat)
(exit)
