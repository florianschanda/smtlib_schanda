...
;; H
  (assert
  (= o10 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
         a_first o9)))

;; H
  (assert (= o19 (oadd o10 o18)))

;; H
  (assert (= o29 (olt o19 o28)))
