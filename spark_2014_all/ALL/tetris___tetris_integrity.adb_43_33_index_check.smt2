...
(declare-fun tetris_integrity__piece__s__first__bit () Int)

(declare-fun tetris_integrity__piece__s__last__bit () Int)

(declare-fun tetris_integrity__piece__s__position () Int)
...
(declare-fun tetris_integrity__piece__d__first__bit () Int)

(declare-fun tetris_integrity__piece__d__last__bit () Int)

(declare-fun tetris_integrity__piece__d__position () Int)
...
(declare-fun tetris_integrity__piece__x__first__bit () Int)

(declare-fun tetris_integrity__piece__x__last__bit () Int)

(declare-fun tetris_integrity__piece__x__position () Int)
...
(declare-fun tetris_integrity__piece__y__first__bit () Int)

(declare-fun tetris_integrity__piece__y__last__bit () Int)

(declare-fun tetris_integrity__piece__y__position () Int)
...
(declare-fun tetris_integrity__possible_i_shapes__aggregate_def (map1 map1
...
;; def_axiom
  ...
  (temp___141 map1))
  (let ((temp___137 (tetris_integrity__possible_i_shapes__aggregate_def
...
(declare-fun tetris_integrity__possible_three_shapes__aggregate_def (map1
...
;; def_axiom
  ...
  (temp___245 map1))
  (let ((temp___225 (tetris_integrity__possible_three_shapes__aggregate_def
...
;; within_bounds__2__def_axiom
  ...
  (! (= (= (within_bounds__2 p) true)
     ...
     (= (within_bounds
        ...
        (to_rep2 (rec__tetris_integrity__piece__x (us_split_fields1 p)))) true)
     (= (within_bounds
        (+ (to_rep3 (rec__tetris_integrity__piece__y (us_split_fields1 p))) 1)
        (+ (to_rep2 (rec__tetris_integrity__piece__x (us_split_fields1 p))) 1)) true))
     (ite (= (to_rep1 (rec__tetris_integrity__piece__s (us_split_fields1 p))) 1)
     (forall ((y Int))
     (=> (and (<= 0 y) (<= y 3))
     (forall ((x Int))
     (=> (and (<= 0 x) (<= x 3))
...
;; possible_i_shapes__def_axiom
  (assert
  (= possible_i_shapes (tetris_integrity__possible_i_shapes__aggregate_def
...
;; possible_three_shapes__def_axiom
  (assert
  (= possible_three_shapes (tetris_integrity__possible_three_shapes__aggregate_def
...
(declare-fun o12 () (Array Int cell))
...
;; H
  (assert
  (= (tetris_integrity__possible_three_shapes__aggregate_def
...
;; H
  ...
  (= (within_bounds__2
     ...
     cur_piece__split_fields2 cur_piece__split_fields3))) true))
...
;; H
  (assert
  (and (<= 1 (+ (to_rep2 cur_piece__split_fields2) 1))
  (<= (+ (to_rep2 cur_piece__split_fields2) 1) 10)))
...
;; H
  (assert
  (= o12 (store (select cur_board2 (to_rep3 cur_piece__split_fields3))
  o11 o10)))

(assert
;; WP_parameter_def
 ;; File "tetris_integrity.adb", line 109, characters 0-0
