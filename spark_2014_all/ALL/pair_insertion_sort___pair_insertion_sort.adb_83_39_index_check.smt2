...
(((mk_tTbSP1__ref (tTbSP1__content integer)))))
...
(declare-datatypes ((tbS__ref 0)) (((mk_tbS__ref (tbS__content us_t1)))))
...
(declare-datatypes ((t18s__ref 0)) (((mk_t18s__ref (t18s__content us_t2)))))
...
;; H
  ...
  (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last)))
     (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))) true)
  (and (= (to_rep (select a1 o14)) (to_rep (select a o15)))
  (and (= (to_rep (select a1 o15)) (to_rep (select a o14)))
  (forall ((z3 Int))
  (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last)))
  (=> (and (not (= z3 o14)) (not (= z3 o15)))
  (= (to_rep (select a1 z3)) (to_rep (select a z3)))))))))
  (= (to_rep a__first) 0)))
...
;; H
  (assert
  (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true))

;; H
  (assert
  (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2)
     (+ i1 1)) true))

;; H
  (assert
  (=> (< 0 j2)
  (<= (to_rep (select a2 (- j2 1))) (to_rep (select a2 (+ j2 2))))))

;; H
  (assert (< x2 (to_rep (select a2 (+ j2 2)))))
...
;; H
  (assert
  (or
  (and (= (to_rep (select a2 j2)) x2) (= (to_rep (select a2 (+ j2 1))) y2))
  (and (= (to_rep (select a2 j2)) y2) (= (to_rep (select a2 (+ j2 1))) x2))))
...
;; H
  (assert (and (= temp___263 (+ j2 1)) (in_range1 (+ j2 1))))

;; H
  (assert
  (and (<= (to_rep a__first) temp___263) (<= temp___263 (to_rep a__last))))

;; H
  (assert (= o23 temp___263))

;; H
  (assert (= o24 (select a2 o23)))

;; H
  (assert (= o25 (to_rep o24)))

;; H
  (assert (= o26 (ite (= o25 x2) true false)))

;; H
  (assert (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last))))

;; H
  (assert (= o20 j2))

;; H
  (assert (= o21 (select a2 o20)))

;; H
  (assert (= o22 (to_rep o21)))

;; H
  (assert (= o27 (ite (= o22 y2) true false)))

;; H
  (assert (= o28 (ite (= o27 true) o26 false)))

;; H
  (assert (and (= temp___262 (+ j2 1)) (in_range1 (+ j2 1))))

;; H
  (assert
  (and (<= (to_rep a__first) temp___262) (<= temp___262 (to_rep a__last))))

;; H
  (assert (= o16 temp___262))

;; H
  (assert (= o17 (select a2 o16)))

;; H
  (assert (= o18 (to_rep o17)))

;; H
  (assert (= o19 (ite (= o18 y2) true false)))

(assert
;; WP_parameter_def
 ;; File "pair_insertion_sort.ads", line 7, characters 0-0
  (not (<= (to_rep a__first) j2)))
(check-sat)
(exit)
