...
(declare-fun temp___1100 () (Array Int us_rep1))
...
(declare-fun temp___1101 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___1101 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o37))
  (and (dynamic_invariant6 temp___1101 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1101 o37))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1101 o37)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o37))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1101 (parent
                              (rec__search_trees__search_tree__struct
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1101 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1101 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1101 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1101 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1101 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1101 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o38 (select temp___1101 x1)))
...
;; H
  ...
  (= temp___1100 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o33))
  (and (dynamic_invariant6 temp___1100 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1100 o33))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1100 o33)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o33))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1100 (parent
                              (mk___rep2
                              (let ((subject f_5__split_fields))
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1100 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1100 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1100 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1100 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1100 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1100 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o34 (select temp___1100 i1)))
