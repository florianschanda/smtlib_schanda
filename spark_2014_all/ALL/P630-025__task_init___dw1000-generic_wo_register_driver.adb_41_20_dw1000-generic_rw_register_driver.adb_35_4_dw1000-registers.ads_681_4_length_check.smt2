...
(declare-datatypes ((pmsc_ledc_type__ref 0))
...
(define-fun register_type__ref___242__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___173__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___173__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7658 us_t1)
  (temp___is_init_7655 Bool) (temp___skip_constant_7656 Bool)
  (temp___do_toplevel_7657 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7656 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_7658)
                                       (last3 temp___expr_7658))
                                       (and (= (first3 temp___expr_7658) 1)
                                       (= (last3 temp___expr_7658) 4)))))
...
(define-fun target__ref___70__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___70__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_7678 us_t2)
  (temp___is_init_7675 Bool) (temp___skip_constant_7676 Bool)
  (temp___do_toplevel_7677 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7676 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_7678)
                                       (last5 temp___expr_7678))
                                       (and (= (first5 temp___expr_7678) 1)
                                       (= (last5 temp___expr_7678) 4)))))
...
;; H
  (assert
  (and (= temp___82482 (register_to_bytes reg)) (dynamic_invariant1
  temp___82482 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___82481)) (to_rep (last4 temp___82481)))
     (+ (- (to_rep (last4 temp___82481)) (to_rep (first4 temp___82481))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
