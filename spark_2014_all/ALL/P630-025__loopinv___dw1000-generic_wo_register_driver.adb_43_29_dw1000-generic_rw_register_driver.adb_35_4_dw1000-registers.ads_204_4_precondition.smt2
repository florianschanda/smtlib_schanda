...
(define-fun register_type__ref___10__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___7__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___7__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2058 us_t1)
  (temp___is_init_2055 Bool) (temp___skip_constant_2056 Bool)
  (temp___do_toplevel_2057 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2056 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2058)
                                       (last3 temp___expr_2058))
                                       (and (= (first3 temp___expr_2058) 1)
                                       (= (last3 temp___expr_2058) 4)))))
...
(define-fun target__ref___3__projection ((a target__ref)) us_t2 (target__content
                                                                a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___3__projection ((a source__ref)) us_rep (source__content
                                                                 a))

(define-fun dynamic_invariant1 ((temp___expr_2098 us_t2)
  (temp___is_init_2095 Bool) (temp___skip_constant_2096 Bool)
  (temp___do_toplevel_2097 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2096 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_2098)
                                       (last5 temp___expr_2098))
                                       (and (= (first5 temp___expr_2098) 1)
                                       (= (last5 temp___expr_2098) 4)))))
...
(declare-const temp___77071 t2)

(declare-const temp___7708 (Array Int bits_8))

(declare-const temp___77081 t1)
...
(define-fun temp___77072 () us_t2 (mk___t2 temp___7707 temp___77071))
...
;; H
  (assert
  (and (= temp___77072 (register_to_bytes reg)) (dynamic_invariant1
  temp___77072 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77071)) (to_rep (last4 temp___77071)))
     (+ (- (to_rep (last4 temp___77071)) (to_rep (first4 temp___77071))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7707 temp___7708))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77071)) (to_rep (last4 temp___77071)))
  temp___77081))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77081)) (to_rep (last2 temp___77081)))
     (+ (- (to_rep (last2 temp___77081)) (to_rep (first2 temp___77081))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7708 temp___77081)))
