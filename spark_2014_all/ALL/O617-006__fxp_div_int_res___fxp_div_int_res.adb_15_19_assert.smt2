...
(declare-fun d1 () duration)

(declare-fun d2 () duration)
...
(declare-fun d11 () duration)

(declare-fun result1 () duration)

(declare-fun d21 () duration)
...
;; H
  (assert
  (and (= o2 (fxp_div_result_int (to_fixed d11) 1)) (in_range
  (fxp_div_result_int (to_fixed d11) 1))))
...
(assert
;; WP_parameter_def
 ;; File "fxp_div_int_res.adb", line 3, characters 0-0
  (not (= r1 4)))
(check-sat)
(exit)
