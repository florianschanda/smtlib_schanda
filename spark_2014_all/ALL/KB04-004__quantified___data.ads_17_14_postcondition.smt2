...
(declare-datatypes ((ttD1__ref 0)) (((mk_ttD1__ref (ttD1__content ttD1)))))
...
(declare-const temp___163 (Array Int Bool))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___165 i1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___163 x)))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- i2 1)))
  (= (= (select x2 k) true) (not (= (select x_old k) true)))))
  (forall ((k Int))
  (=> (and (<= i2 k) (<= k 10))
  (= (= (select x2 k) true) (= (select x_old k) true)))))))
...
;; H
  ...
  (=> (<= i2 temp___164)
  (= (select x2 temp___164) (select temp___163 temp___164)))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 10))
  (= x3 (store x2 i2 (ite (not (= (select x2 i2) true)) true false)))))
