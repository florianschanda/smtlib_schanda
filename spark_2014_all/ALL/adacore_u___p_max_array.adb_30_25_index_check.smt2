...
;; H
  (assert
  (and (= o4 (- k (to_rep1 (first (rt a))))) (in_range1
  (- k (to_rep1 (first (rt a)))))))

;; H
  (assert (= o5 (+ o4 (to_rep1 (first (rt b))))))

;; H
  (assert (and (= temp___266 o5) (in_range1 o5)))

;; H
  (assert
  (and (<= (to_rep1 (first (rt b))) temp___266)
  (<= temp___266 (to_rep1 (last (rt b))))))

;; H
  (assert (= o6 temp___266))
...
;; H
  (assert (= result4 (ite (< o8 o9) true false)))
