...
(((mk_very_small__ref (very_small__content very_small)))))
...
(((mk_small_pair__ref (small_pair__content us_rep)))))
(define-fun small_pair__ref___projection ((a small_pair__ref)) us_rep
  (small_pair__content a))

(define-fun dynamic_invariant2 ((temp___expr_154 us_rep)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range
  (+ (to_rep (rec__dynamic_preds_rte__small_pair__a (us_split_fields1 x)))
  (to_rep1 (rec__dynamic_preds_rte__small_pair__b (us_split_fields1 x)))))))
(check-sat)
(exit)
