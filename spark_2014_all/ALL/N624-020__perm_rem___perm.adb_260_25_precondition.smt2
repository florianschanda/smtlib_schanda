...
;; H
  (assert
  (and
  (= o19 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o18 (remove b ib1))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o20))) (- (to_rep2 (last (rt o18))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o19 1)))
