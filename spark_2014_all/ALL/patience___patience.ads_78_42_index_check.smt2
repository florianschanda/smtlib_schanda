...
(declare-fun o15 () cardindex)

(declare-fun o16 () Int)

(declare-fun o17 () Int)

(declare-fun o18 () cardindex)
...
;; H
  (assert
  (= o18 (select (rec__patience__state__posstack (us_split_fields1 s))
  o17)))
...
;; H
  (assert
  (= o15 (select (rec__patience__state__posstack (us_split_fields1 s))
  o14)))
...
;; H
  (assert (= o21 (ite (<= 0 o16) true false)))

;; H
  (assert (= result2 (ite (= o21 true) o20 false)))
...
;; H
  (assert
  (=> (= result2 true)
  (= o6 (select (rec__patience__state__posstack (us_split_fields1 s))
  o5))))

;; H
  (assert (=> (= result2 true) (= temp___408 (to_rep1 o6))))

;; H
  (assert (=> (= result2 true) (and (<= 0 temp___408) (<= temp___408 99))))

;; H
  (assert (=> (= result2 true) (= o7 temp___408)))

;; H
  (assert
  (=> (= result2 true)
  (= o8 (select (rec__patience__state__stacksizes (us_split_fields1 s))
  o7))))

;; H
  (assert (=> (= result2 true) (= o9 (to_rep1 o8))))

;; H
  (assert (=> (= result2 true) (= o10 (- o9 1))))
...
;; H
  (assert (=> (= result2 true) (= o11 (to_rep1 o4))))

;; H
  (assert (=> (= result2 true) (= o12 (ite (<= o11 o10) true false))))

;; H
  (assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))

;; H
  (assert (=> (= result2 true) (= o i)))

;; H
  (assert
  (=> (= result2 true)
  (= o1 (select (rec__patience__state__posheight (us_split_fields1 s))
  o))))

;; H
  (assert (=> (= result2 true) (= o2 (to_rep1 o1))))

;; H
  (assert (=> (= result2 true) (= o13 (ite (<= 0 o2) true false))))

;; H
  (assert (=> (= result2 true) (= result1 (ite (= o13 true) o12 false))))
