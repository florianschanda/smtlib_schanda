...
(declare-fun bitwalker__lemmafunction__result () Int)

(declare-fun o () Int)

(declare-fun bitwalker__lemmafunction__len_bv__assume () (_ BitVec 64))

(declare-fun result () Int)

(declare-fun bitwalker__lemmafunction__result1 () Int)

(declare-fun bitwalker__lemmafunction__result2 () Int)

(declare-fun bitwalker__lemmafunction__result3 () Int)

(declare-fun bitwalker__lemmafunction__result4 () Int)

(declare-fun bitwalker__lemmafunction__result5 () Int)
...
;; H
  ...
  (forall ((i Int)) (=> (and (<= len i) (<= i 63)) (not (= (nth x i) true))))))
...
;; H
  (assert
  (and (bvule ((_ int2bv 64) 0) ((_ int2bv 64) len))
  (bvule ((_ int2bv 64) len) ((_ int2bv 64) 63))))

;; H
  (assert
  (= bitwalker__lemmafunction__result1 bitwalker__lemmafunction__result2))

;; H
  (assert
  (= bitwalker__lemmafunction__result3 bitwalker__lemmafunction__result1))

;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref bitwalker__lemmafunction__result)))
...
;; H
  (assert
  (= (mk_int__ref bitwalker__lemmafunction__result4) (mk_int__ref
                                                     bitwalker__lemmafunction__result2)))

;; H
  (assert
  (= bitwalker__lemmafunction__result5 bitwalker__lemmafunction__result3))
