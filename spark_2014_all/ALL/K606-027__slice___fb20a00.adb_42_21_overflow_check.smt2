...
;; H
  ...
  (let ((fb20a00__find__L_2__R7b1 (- (+ pos2 (ite (<= (to_rep1
                                                      new_sub__first)
                                             (to_rep1 new_sub__last))
                                             (+ (- (to_rep1 new_sub__last)
  ...
  (<= pos2 (+ (- (to_rep1 new_str__last) (ite (<= (to_rep1 new_sub__first)
                                         ...
                                         (to_rep1 new_sub__first)) 1) 0)) 1))
  (not
  (= (bool_eq new_str1 (to_rep1 (first6 (mk3 pos2 fb20a00__find__L_2__R7b1)))
     (to_rep1 (last6 (mk3 pos2 fb20a00__find__L_2__R7b1))) new_sub1
