...
(declare-datatypes ((stb__ref 0)) (((mk_stb__ref (stb__content stb)))))
...
(((mk___split_discrs (rec__discr_dyn__r2__a stb)))))
...
(declare-const dummy5 tT10bP1)

(declare-datatypes ((tT10bP1__ref 0))
(((mk_tT10bP1__ref (tT10bP1__content tT10bP1)))))
...
(define-fun us_split_fields_B__2__projection ((a us_split_fields2)) (Array Int integer)
  (rec__discr_dyn__r2__b1 a))

(define-fun us_split_fields_C__2__projection ((a us_split_fields2)) Bool
...
(declare-datatypes ((tb1S__ref 0))
(((mk_tb1S__ref (tb1S__content us_rep1)))))
...
(declare-const dummy8 tT15bP1)

(declare-datatypes ((tT15bP1__ref 0))
(((mk_tT15bP1__ref (tT15bP1__content tT15bP1)))))
...
(define-fun us_split_fields_B__3__projection ((a us_split_fields4)) (Array Int integer)
  (rec__discr_dyn__r2__b2 a))

(define-fun us_split_fields_C__3__projection ((a us_split_fields4)) Bool
...
(define-fun us_rep___5__projection ((a us_rep2)) us_split_discrs (us_split_discrs3
                                                                 a))
...
(((mk_t14b__ref (t14b__content us_rep2)))))
...
(declare-const temp___a_201 Int)
