...
;; H
  (assert
  (and
  (= o54 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         j))
  (in_range7 o54)))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (= result13 true) (and (= o51 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  (assert
  (=> (= result12 true) (= o49 (rec__list_allocator__cell__next o48))))
