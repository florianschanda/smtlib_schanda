...
;; H
  (assert
  (= x86__readreg32__result1 ((_ extract 31 0) (bvand reg ((_ int2bv 64) 4294967295)))))

;; H
  (assert
  (= (mk_t__ref x86__readreg32__result4) (mk_t__ref x86__readreg32__result2)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not
  (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvand reg ((_ int2bv 64) 4294967295)))))
(check-sat)
(exit)
