...
(declare-fun temp___881 () (Array Int byte))

(declare-fun temp___8811 () t2)
...
;; H
  ...
  (and (= o14 (+ (- bit_length 8) (- 8 (mod2 bit_length 8)))) (in_range1
...
;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk2 (to_rep1 (first (rt message))) r108s) temp___8811)))
...
;; H
  (assert
  (=> (< 1 message_byte_length1)
  (= (mk (to_rep1 (first4 temp___8811)) (to_rep1 (last4 temp___8811))) 
  o13)))
...
;; H
  ...
  (and
  (and
  (and (= (state_of (mk___rep ctx__split_fields12)) 0)
  (= (rate_of (mk___rep ctx__split_fields12)) (rate_of
                                              (mk___rep
                                              (mk___split_fields
                                              ctx__split_fields
                                              ctx__split_fields1
                                              ...
                                              ctx__split_fields4
                                              ctx__split_fields5)))))
  (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields12)) 8) (mod2 
                                                                   o15 8)))
  (< (in_queue_bit_length (mk___rep ctx__split_fields12)) (rate_of
                                                          (mk___rep
                                                          ctx__split_fields12))))))
...
;; H
  ...
  (= ctx__split_fields12 (mk___split_fields ctx__split_fields
                         ctx__split_fields1 ctx__split_fields2
                         ctx__split_fields3 ctx__split_fields4
                         ctx__split_fields5))))
...
;; H
  (assert
  (=> (not (< 1 message_byte_length1))
  (= ctx__split_fields12 (mk___split_fields ctx__split_fields6
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (<= (to_rep1 (first (rt message))) (to_rep1 (last (rt message))))))
(check-sat)
