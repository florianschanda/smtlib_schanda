...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__my_lists__my_lists__cursor__node count_type)))))
...
(declare-fun my_lists__my_lists__cursor__node__first__bit () Int)

(declare-fun my_lists__my_lists__cursor__node__last__bit () Int)

(declare-fun my_lists__my_lists__cursor__node__position () Int)
...
;; H
  (assert (= temp___529 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___529)) no_element))
