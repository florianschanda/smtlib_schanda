...
(declare-fun temp___950 () (_ BitVec 16))
...
(declare-fun temp___944 () us_rep1)
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___944 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (forall ((temp___946 Int))
  (=>
  (and
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___946)
  (<= temp___946 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___946) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           temp___944))) temp___946))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___943 (mk___rep1 result____split_discrs o17))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields3 temp___943))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___943))))
