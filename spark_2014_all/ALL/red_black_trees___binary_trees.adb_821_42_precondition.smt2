...
;; H
  (assert (= o49 (select temp___1485 o48)))
...
;; H
  (assert (= o45 (select temp___1484 ki1)))
...
;; H
  ...
  (= temp___1483 (model__
                 (mk___rep2
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) o41))
  (and (dynamic_invariant3 temp___1483 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1483 o41))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1483 o41)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o41))
...
;; H
  (assert (= o42 (select temp___1483 ki1)))
...
;; H
  (assert (= o37 (select temp___1480 o36)))
