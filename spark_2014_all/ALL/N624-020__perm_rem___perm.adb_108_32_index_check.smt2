...
;; H
  (assert
  (and
  (= o7 (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
...
;; H
  (assert
  (and
  (= o8 (remove a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
...
;; H
  (assert (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume
  ih))
...
;; H
  ...
  (<= (to_rep2 (first (rt a))) (to_rep1
                               (rec__perm__witnesses__ia
                               (us_split_fields1 w))))
  (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) (to_rep2
                                                                (last (rt a))))))

;; H
  (assert (= o4 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))
