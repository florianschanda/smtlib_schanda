...
(declare-fun sc_status_type__duplicate_status_type__prime__first__bit () Int)

(declare-fun sc_status_type__duplicate_status_type__prime__last__bit () Int)

(declare-fun sc_status_type__duplicate_status_type__prime__position () Int)
...
(declare-fun sc_status_type__duplicate_status_type__shadow__first__bit () Int)

(declare-fun sc_status_type__duplicate_status_type__shadow__last__bit () Int)

(declare-fun sc_status_type__duplicate_status_type__shadow__position () Int)
...
(declare-fun sc_status_type__object_type__sc_state__first__bit () Int)

(declare-fun sc_status_type__object_type__sc_state__last__bit () Int)

(declare-fun sc_status_type__object_type__sc_state__position () Int)
...
(declare-fun dummy4 () internal_state)
...
(declare-fun my_internal_state () Int)

(declare-fun state_item__split_fields () Bool)

(declare-fun state_item__split_fields1 () Bool)

(declare-fun o () Bool)

(declare-fun state_item__split_fields2 () Bool)

(declare-fun state_item__split_fields3 () Bool)

(declare-fun result () Bool)

(declare-fun state_item__split_fields4 () Bool)

(declare-fun state_item__split_fields5 () Bool)

(declare-fun state_item__split_fields6 () Bool)

(declare-fun state_item__split_fields7 () Bool)

(declare-fun state_item__split_fields8 () Bool)

(declare-fun state_item__split_fields9 () Bool)
...
;; H
  (assert
  (=> (not (= result true))
  (= state_item__split_fields10 (mk___split_fields1
                                (mk___rep
                                (mk___split_fields state_item__split_fields2
...
;; H
  ...
  (= (mk___split_fields1
     (mk___rep
     (mk___split_fields state_item__split_fields8 state_item__split_fields9)))
