...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= first2 j1) (<= j1 i2))
  (= (to_rep (select (elts (to__ (mk___rep s__split_fields3))) j1)) (get
                                                                    (model__
                                                                    l) j1))))))
...
;; H
  (assert (and (= o5 (- i2 first2)) (in_range1 (- i2 first2))))
...
;; H
  (assert
  (and (= o9 (to__ (mk___rep s__split_fields3))) (dynamic_invariant1
  o9 true false true)))
