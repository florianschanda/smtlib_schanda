...
(declare-const kmp__init_next__result2 (Array Int integer))

(declare-const kmp__init_next__result3 t)

(declare-const kmp__init_next__result4 (Array Int integer))

(declare-const kmp__init_next__result5 t)

(declare-const kmp__init_next__result6 (Array Int integer))

(declare-const kmp__init_next__result7 t)

(declare-const next2 (Array Int integer))

(declare-const kmp__init_next__result8 (Array Int integer))

(declare-const kmp__init_next__result9 t)

(declare-const next3 (Array Int integer))

(declare-const kmp__init_next__result10 (Array Int integer))

(declare-const kmp__init_next__result11 t)
