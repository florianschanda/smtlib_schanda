...
(define-fun dynamic_invariant1 ((temp___expr_183 (Array Int even))
...
(define-fun dynamic_predicate ((temp___191 (Array Int even))) Bool (=
...
;; H
  (assert
  (=> (not (= (mod2 above 2) 0))
  (and (= temp___301 (+ above 1)) (in_range (+ above 1)))))
...
;; H
  (assert
  (=> (not (= (mod2 above 2) 0)) (= temp___303 (store result__ 1 o4))))
...
;; H
  (assert
  (and (= temp___307 (+ (to_rep (select result__1 1)) 2)) (in_range
  (+ (to_rep (select result__1 1)) 2))))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds_array.ads", line 20, characters 0-0
  (not (= (mod2 temp___307 2) 0)))
(check-sat)
(exit)
