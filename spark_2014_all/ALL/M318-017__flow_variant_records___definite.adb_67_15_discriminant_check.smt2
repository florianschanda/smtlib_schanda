...
(declare-fun temp___174 () status)

(declare-fun temp___1741 () natural)

(declare-fun temp___1742 () natural)

(declare-fun temp___1743 () Bool)

(declare-fun temp___1744 () Bool)
...
;; WP_parameter_def
 ;; File "definite.adb", line 48, characters 0-0
  (not (= temp___174 x__split_discrs)))
(check-sat)
