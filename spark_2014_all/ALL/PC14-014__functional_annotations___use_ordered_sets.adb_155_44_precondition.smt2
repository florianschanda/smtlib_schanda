...
;; H
  (assert
  (and (= o (elements (mk___rep s__split_discrs s__split_fields1)))
  (and
  (and
  (and (= (length2 o) (length (mk___rep s__split_discrs s__split_fields1)))
  (forall ((temp___390 Int))
  (=> (and (in_range4 temp___390) (= (iter_has_element o temp___390) true))
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields1))
     (get o temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range7 item)
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields1)) item) true))
  (and (< 0 (find o item))
  (= (equivalent_elements (get o (find o item)) item) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields1))))
  (and (= (find o (get o i1)) i1) (= (e_is_find o (get o i1) i1) true)))))))
