...
(declare-fun o24 () return_code_t)

(declare-fun o25 () us_split_discrs)

(declare-fun temp___341 () us_rep2)
...
(declare-fun result____split_discrs7 () us_split_discrs)

(declare-fun result10 () t__ref1)

(declare-fun count3 () (_ BitVec 16))

(declare-fun result____split_fields10 () us_split_fields4)

(declare-fun result____split_discrs8 () us_split_discrs)
...
;; H
  (assert
  (= (to_rep2
     (rec__parse__parse_result_t__return_code result____split_discrs8))
  r30b))
...
;; H
  (assert
  (= temp___341 (mk___rep2 o25
                (mk___split_fields2 (mk___rep1 header__split_fields6)) true)))
...
;; WP_parameter_def
 ;; File "parse.ads", line 16, characters 0-0
  (not
  (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___341))
  (rec__parse__parse_result_t__return_code result____split_discrs8))))
(check-sat)
(exit)
