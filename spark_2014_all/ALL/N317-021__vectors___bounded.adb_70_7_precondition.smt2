...
;; H
  (assert (= v__split_fields9 bounded__vect__clear__container__fields1))
...
;; H
  ...
  (length (mk___rep v__split_discrs v__split_fields9)) 1))
...
;; H
  (assert (= v__split_fields8 bounded__vect__append__2__container__fields4))
...
;; H
  ...
  (length (mk___rep v__split_discrs v__split_fields8)) 1))
