...
;; H
  (assert
  (and (= o25 (+ y (int__content lcp__result4))) (in_range1
...
;; H
  (assert (and (= temp___179 o26) (in_range1 o26)))
...
;; H
  (assert
  (and (= o28 (+ x (int__content lcp__result4))) (in_range1
...
;; H
  (assert (and (= temp___178 o29) (in_range1 o29)))
...
;; H
  (assert
  (and (= o24 (+ (to_rep (last (rt a))) 1)) (in_range1
  (+ (to_rep (last (rt a))) 1))))
