...
;; H
  (assert
  (=> (= (length temp___852) 0)
  (= o14 (mk___t (temp___String_Literal_851 Tuple0) (mk 1 1)))))

;; H
  (assert
  (=> (not (= (length temp___852) 0)) (=> (<= 1 1) (= o8 (+ (- 1 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length temp___852) 0))
  (=> (<= (to_rep1 (first (rt temp___852))) (to_rep1 (last (rt temp___852))))
  (= o9 (+ (- (to_rep1 (last (rt temp___852))) (to_rep1
...
;; H
  (assert
  (=> (not (= (length temp___852) 0))
  (= o11 (+ (to_rep1 (first (rt temp___852))) o10))))
...
;; H
  (assert
  (=> (not (= (length temp___852) 0)) (and (= o13 o12) (in_range2 o12))))
...
;; H
  ...
  (= o14 (mk___t
         ...
         1 1) (mk (to_rep1 (first (rt temp___852))) o13)))))
