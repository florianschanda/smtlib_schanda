...
(define-fun use_lists__double_size_2__cu__assume1 () us_rep1 (mk___rep1
                                                             (mk___split_fields1
                                                             use_lists__double_size_2__cu__assume)))

;; H
  (assert
  (<= (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  (div1 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))
  2)))

;; H
  (assert
  (and
  (= use_lists__double_size_2__cu__assume1 (first
                                           (mk___rep l__split_discrs
                                           (mk___split_fields
                                           l__split_fields))))
  (ite (= (= (length
             (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true)
  (= (bool_eq1 use_lists__double_size_2__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__double_size_2__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__double_size_2__cu__assume1) 1)))))
...
;; H
  ...
  (=> (and (<= 1 i) (<= i n2))
  (and
  (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (* 2 i))
  (get temp___529 i))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields11))
     (- (* 2 i) 1)) (get temp___530 i)))))))

;; H
  (assert
  (=> (= result2 true)
  (forall ((i Int))
  (=> (and (<= (+ n2 1) i) (<= i temp___531))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) (+ i n2))
  (get temp___532 i))))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields11))
     (mk___rep1 cu__split_fields11)) (+ (* 2 n2) 1))))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields10)) (+ (length
                                                              ...
                                                              l__split_discrs
                                                              l__split_fields11)) 1))
  (ite (= (bool_eq1 (mk___rep1 cu__split_fields11) no_element) true)
  (and
  (and
  (and
  (and
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10))
     (length (mk___rep l__split_discrs l__split_fields10))) o))
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields11))
     ...
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields11))
        (mk___rep1 cu__split_fields11)) 1)) true)
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10))
     (get1 (positions (mk___rep l__split_discrs l__split_fields11))
     (mk___rep1 cu__split_fields11))) o))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields11))
     (positions (mk___rep l__split_discrs l__split_fields10))
     (get1 (positions (mk___rep l__split_discrs l__split_fields11))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o2 (has_key (positions (mk___rep l__split_discrs l__split_fields10))
...
;; H
  (assert
  (=> (= result2 true) (= result4 (ite (not (= o2 true)) true false))))
...
;; H
  (assert
  (=> (not (= result2 true)) (= cu__split_fields7 cu__split_fields12)))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (= (length
     (mk___rep l__split_discrs (us_split_fields__content l__split_fields8))) (* 2
  (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))))
(check-sat)
(exit)
