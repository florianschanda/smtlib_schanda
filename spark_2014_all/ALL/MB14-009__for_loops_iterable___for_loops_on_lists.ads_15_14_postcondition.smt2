...
(declare-fun for_loops_on_lists__contains_0_for_of__result () Bool)

(declare-fun o () count_type)

(declare-fun temp___478 () count_type)
...
(declare-fun for_loops_on_lists__contains_0_for_of__result1 () Bool)

(declare-fun temp___4781 () count_type)
...
(declare-fun for_loops_on_lists__contains_0_for_of__result2 () Bool)

(declare-fun temp___4782 () count_type)

(declare-fun result3 () Bool)

(declare-fun for_loops_on_lists__contains_0_for_of__result3 () Bool)

(declare-fun result4 () Bool)

(declare-fun e4 () int__ref)

(declare-fun for_loops_on_lists__contains_0_for_of__result4 () bool__ref)

(declare-fun temp___4783 () cursor__ref)

(declare-fun e5 () Int)

(declare-fun for_loops_on_lists__contains_0_for_of__result5 () Bool)

(declare-fun temp___4784 () us_rep1)

(declare-fun e6 () int__ref)

(declare-fun for_loops_on_lists__contains_0_for_of__result6 () bool__ref)

(declare-fun temp___4785 () cursor__ref)

(declare-fun e7 () Int)

(declare-fun for_loops_on_lists__contains_0_for_of__result7 () Bool)

(declare-fun temp___4786 () us_rep1)

(declare-fun result5 () bool__ref)

(declare-fun for_loops_on_lists__contains_0_for_of__result8 () Bool)

(declare-fun for_loops_on_lists__contains_0_for_of__result9 () bool__ref)

(declare-fun for_loops_on_lists__contains_0_for_of__result10 () Bool)

(declare-fun e8 () int__ref)

(declare-fun for_loops_on_lists__contains_0_for_of__result11 () bool__ref)

(declare-fun e9 () Int)

(declare-fun for_loops_on_lists__contains_0_for_of__result12 () Bool)

(declare-fun e10 () int__ref)

(declare-fun for_loops_on_lists__contains_0_for_of__result13 () bool__ref)

(declare-fun e11 () Int)

(declare-fun for_loops_on_lists__contains_0_for_of__result14 () Bool)

(define-fun temp___4787 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___4782)))
...
;; H
  ...
  (and
  (and
  (= for_loops_on_lists__contains_0_for_of__result11 (mk_bool__ref
                                                     for_loops_on_lists__contains_0_for_of__result3))
  (= e8 (mk_int__ref e3)))
  (and
  (= for_loops_on_lists__contains_0_for_of__result12 for_loops_on_lists__contains_0_for_of__result3)
  (= e9 e3)))
  (and
  (and
  (and (= o5 (first l))
  (ite (= (= (length1 l) 0) true) (= (bool_eq1 o5 no_element) true)
  (and (= (has_key (positions l) o5) true) (= (get1 (positions l) o5) 1))))
  (= temp___478 o))
  (and
  (and
  (and
  (= result (has_key (positions l)
            (mk___rep1 (mk___split_fields1 temp___478))))
  (= (= result true)
  (= (has_key (positions l) (mk___rep1 (mk___split_fields1 temp___478))) true)))
  (ite (= result true)
  (and
  (and (= o1 (element l (mk___rep1 (mk___split_fields1 temp___478))))
  (and (in_range4 o1)
  (= o1 (get (model__ l)
        (get1 (positions l) (mk___rep1 (mk___split_fields1 temp___478)))))))
  (and (= result6 e12) (= e2 o1))) (and (= e2 e) (= e2 e1))))
  (and
  (and
  ...
  (and (= result2 true)
  (and
  (and (= (has_key (positions l) temp___4787) true)
  (= e3 (element l temp___4787)))
  (and (= e3 0)
  (and (= for_loops_on_lists__contains_0_for_of__result2 result3)
  (= for_loops_on_lists__contains_0_for_of__result3 (of_int 1))))))))))
  (and
  (and
  (and
  (and (= o5 (first l))
  ...
  (and
  (and (not (= e3 0))
  (= for_loops_on_lists__contains_0_for_of__result3 for_loops_on_lists__contains_0_for_of__result2))
  (and
  (and
  (and
  (and (= o4 (next l temp___4787))
  (ite (= (ite (= (bool_eq1 temp___4787 no_element) false) (= (get1
                                                              (positions l)
                                                              temp___4787)
          (length1 l)) true) true)
  (= (bool_eq1 o4 no_element) true)
  (and (= (has_key (positions l) o4) true)
  (= (get1 (positions l) o4) (+ (get1 (positions l) temp___4787) 1)))))
  (and (= o3 (has_key (positions l) o4))
  (= (= o3 true) (= (has_key (positions l) o4) true))))
  (= result4 (ite (not (= o3 true)) true false))) (= result4 true))))
  (and
  (and (= temp___4783 (mk_cursor__ref temp___4787))
  (and
  (= for_loops_on_lists__contains_0_for_of__result4 (mk_bool__ref
                                                    for_loops_on_lists__contains_0_for_of__result3))
  (= e4 (mk_int__ref e3))))
  (and (= temp___4784 temp___4787)
  (and
  (= for_loops_on_lists__contains_0_for_of__result5 for_loops_on_lists__contains_0_for_of__result3)
  (= e5 e3)))))
  (and
  (and (= temp___4785 temp___4783)
  (and
  (= for_loops_on_lists__contains_0_for_of__result6 for_loops_on_lists__contains_0_for_of__result4)
  (= e6 e4)))
  (and (= temp___4786 temp___4784)
  (and
  (= for_loops_on_lists__contains_0_for_of__result7 for_loops_on_lists__contains_0_for_of__result5)
  (= e7 e5)))))
  (and
  (and
  (= temp___4785 (mk_cursor__ref (mk___rep1 (mk___split_fields1 temp___478))))
  (and
  (= for_loops_on_lists__contains_0_for_of__result6 (mk_bool__ref
                                                    for_loops_on_lists__contains_0_for_of__result))
  (= e6 (mk_int__ref e2))))
  (and (= temp___4786 (mk___rep1 (mk___split_fields1 temp___4781)))
  (and
  (= for_loops_on_lists__contains_0_for_of__result7 for_loops_on_lists__contains_0_for_of__result1)
  (= e7 e2))))))))
  (and
  (and
  (and
  (= for_loops_on_lists__contains_0_for_of__result11 for_loops_on_lists__contains_0_for_of__result9)
  (= e8 e6))
  (and
  (= for_loops_on_lists__contains_0_for_of__result12 for_loops_on_lists__contains_0_for_of__result10)
  (= e9 e7)))
  (and
  (and
  (= for_loops_on_lists__contains_0_for_of__result9 (mk_bool__ref
                                                    for_loops_on_lists__contains_0_for_of__result8))
  (= for_loops_on_lists__contains_0_for_of__result10 for_loops_on_lists__contains_0_for_of__result8))
  (and (= result5 for_loops_on_lists__contains_0_for_of__result6)
  (= for_loops_on_lists__contains_0_for_of__result8 (of_int 0))))))))

;; H
  (assert
  (= for_loops_on_lists__contains_0_for_of__result13 for_loops_on_lists__contains_0_for_of__result11))
...
;; H
  (assert
  (= for_loops_on_lists__contains_0_for_of__result14 for_loops_on_lists__contains_0_for_of__result12))
...
;; H
  (assert
  (= result7 (bool__content for_loops_on_lists__contains_0_for_of__result13)))

;; H
  (assert
  (= (bool__content for_loops_on_lists__contains_0_for_of__result13) true))

(define-fun temp___485 () us_rep2 (model__ l))

(assert
;; WP_parameter_def
 ;; File "for_loops_on_lists.ads", line 14, characters 0-0
  (not
  (exists ((temp___484 Int))
  (and
  (and (in_range2 temp___484)
  (= (iter_has_element temp___485 temp___484) true))
  (= (get temp___485 temp___484) 0)))))
(check-sat)
(exit)
