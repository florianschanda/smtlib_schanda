...
(define-fun bool_eq5 ((a (Array Int element)) (a__first Int) (a__last Int)
...
(declare-fun stackp__get_model__2__result () (Array Int element))

(declare-fun stackp__get_model__2__result1 () t)
...
(declare-fun stackp__get_model__2__result2 () (Array Int element))

(declare-fun stackp__get_model__2__result3 () t)

(declare-fun stackp__get_model__2__result4 () (Array Int element))

(declare-fun stackp__get_model__2__result5 () t)

(declare-fun stackp__get_model__2__result6 () (Array Int element))

(declare-fun stackp__get_model__2__result7 () t)

(declare-fun stackp__get_model__2__result8 () (Array Int element))

(declare-fun stackp__get_model__2__result9 () t)

(declare-fun stackp__get_model__2__result10 () (Array Int element))

(declare-fun stackp__get_model__2__result11 () t)

(define-fun stackp__get_model__2__result12 () us_t (mk___t
                                                   stackp__get_model__2__result2
                                                   stackp__get_model__2__result3))

(declare-fun result2 () (Array Int element))
