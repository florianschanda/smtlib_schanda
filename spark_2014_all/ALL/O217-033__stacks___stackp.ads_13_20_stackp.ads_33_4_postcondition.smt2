...
(declare-const stackp__get_model__2__result (Array Int element))

(declare-const stackp__get_model__2__result1 t)

(declare-const o (Array Int element))

(declare-const temp___461 (Array Int element))

(declare-const temp___4611 t1)
...
(declare-const stackp__get_model__2__result2 (Array Int element))

(declare-const stackp__get_model__2__result3 t)

(declare-const stackp__get_model__2__result4 (Array Int element))

(declare-const stackp__get_model__2__result5 t)

(declare-const stackp__get_model__2__result6 (Array Int element))

(declare-const stackp__get_model__2__result7 t)

(declare-const stackp__get_model__2__result8 (Array Int element))

(declare-const stackp__get_model__2__result9 t)

(declare-const stackp__get_model__2__result10 (Array Int element))

(declare-const stackp__get_model__2__result11 t)

(define-fun stackp__get_model__2__result12 () us_t (mk___t
                                                   stackp__get_model__2__result2
                                                   stackp__get_model__2__result3))
...
;; H
  (assert (= stackp__get_model__2__result4 stackp__get_model__2__result2))

;; H
  (assert (= stackp__get_model__2__result5 stackp__get_model__2__result3))

;; H
  (assert
  (= (mk___t stackp__get_model__2__result6 stackp__get_model__2__result7)
  stackp__get_model__2__result12))
...
;; H
  (assert (dynamic_property 1 2147483647 (to_rep1 (first2 temp___4611))
...
;; H
  (assert
  (= (mk (to_rep1 (first2 temp___4611)) (to_rep1 (last2 temp___4611)))
  o2))

;; H
  (assert (= result stackp__get_model__2__result))

;; H
  (assert (= result1 stackp__get_model__2__result1))

;; H
  (assert (= stackp__get_model__2__result12 (mk___t o1 o2)))

;; H
  (assert
  (= (mk_model____ref
     (mk___t stackp__get_model__2__result8 stackp__get_model__2__result9))
  (mk_model____ref
  (mk___t stackp__get_model__2__result4 stackp__get_model__2__result5))))

;; H
  (assert (= stackp__get_model__2__result10 stackp__get_model__2__result6))

;; H
  (assert (= stackp__get_model__2__result11 stackp__get_model__2__result7))

;; H
  (assert (= result2 stackp__get_model__2__result8))

;; H
  (assert (= result3 stackp__get_model__2__result9))
