...
;; H
  (assert
  (= o122 (select (rec__patience__state__posstack
...
;; H
  (assert
  (=> (= result23 true)
  (= o115 (select (rec__patience__state__stacksizes
...
;; H
  (assert
  (=> (= result23 true)
  (= o108 (select (rec__patience__state__posheight
