...
(declare-fun savestackptr () (_ BitVec 64))

(declare-fun ra0 () (_ BitVec 8))

(declare-fun ra1 () (_ BitVec 8))

(declare-fun ra2 () (_ BitVec 8))

(declare-fun ra3 () (_ BitVec 8))

(declare-fun ra4 () (_ BitVec 8))

(declare-fun ra5 () (_ BitVec 8))

(declare-fun ra6 () (_ BitVec 8))

(declare-fun ra7 () (_ BitVec 8))
...
(declare-fun result10 () t__ref2)

(declare-fun rsp2 () (_ BitVec 64))

(declare-fun zeroflag1 () bool__ref)

(declare-fun carryflag1 () bool__ref)

(declare-fun signflag1 () bool__ref)

(declare-fun overflowflag1 () bool__ref)

(declare-fun rax2 () t__ref2)

(declare-fun rcx1 () t__ref2)

(declare-fun rdx2 () t__ref2)

(declare-fun rsp3 () t__ref2)

(declare-fun rdi1 () t__ref2)

(declare-fun r83 () t__ref2)

(declare-fun memory2 () map__ref)

(declare-fun savestackptr2 () t__ref2)
...
;; H
  (assert
  (not
  (= (inrange64 rsi (bvsub rsp ((_ int2bv 64) 7)) ((_ int2bv 64) 15)) true)))
...
;; H
  (assert
  (and (= o1 (readmem8 rsp memory)) (= o1 (to_rep (select memory rsp)))))
...
;; H
  (assert
  (and (= o3 (readmem8 (bvadd rsp ((_ int2bv 64) 1)) memory))
  (= o3 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 1)))))))
...
;; H
  (assert
  (and (= o5 (readmem8 (bvadd rsp ((_ int2bv 64) 2)) memory))
  (= o5 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 2)))))))
...
;; H
  (assert
  (and (= o7 (readmem8 (bvadd rsp ((_ int2bv 64) 3)) memory))
  (= o7 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 3)))))))
...
;; H
  (assert
  (and (= o9 (readmem8 (bvadd rsp ((_ int2bv 64) 4)) memory))
  (= o9 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 4)))))))
...
;; H
  (assert
  (and (= o11 (readmem8 (bvadd rsp ((_ int2bv 64) 5)) memory))
  (= o11 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 5)))))))
...
;; H
  (assert
  (and (= o13 (readmem8 (bvadd rsp ((_ int2bv 64) 6)) memory))
  (= o13 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 6)))))))
...
;; H
  (assert
  (and (= o15 (readmem8 (bvadd rsp ((_ int2bv 64) 7)) memory))
  (= o15 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 7)))))))
...
;; H
  ...
  (= (bvand rax1 ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep
                                                                   (select
                                                                   memory1 (bvadd
                                                                   rsi ((_ int2bv 64) 1))))) ((_ int2bv 64) 256))))
  (= (bvand rax1 ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56)
  (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536))))
  (= (bvand rax1 ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56)
  (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216))))
  (= (bvand rax1 ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56)
  (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296))))
  (= (bvand rax1 ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56)
  (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776))))
  (= (bvand rax1 ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56)
  (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656))))
  (= (bvand rax1 ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56)
  (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936))))
  (forall ((i (_ BitVec 64)))
  (=>
  ...
  (and
  (and
  (and (and (not (= i rsi)) (not (= i (bvadd rsi ((_ int2bv 64) 1)))))
  (not (= i (bvadd rsi ((_ int2bv 64) 2)))))
  (not (= i (bvadd rsi ((_ int2bv 64) 3)))))
  (not (= i (bvadd rsi ((_ int2bv 64) 4)))))
  (not (= i (bvadd rsi ((_ int2bv 64) 5)))))
  (not (= i (bvadd rsi ((_ int2bv 64) 6)))))
  (not (= i (bvadd rsi ((_ int2bv 64) 7)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 334, characters 0-0
  (not (= (t__content2 rsp3) (bvadd rsp ((_ int2bv 64) 8)))))
(check-sat)
(exit)
