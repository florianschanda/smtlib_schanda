...
(declare-fun dummy () subject_id_type)
...
(declare-fun dummy1 () dst_subject_type)
...
(declare-fun dummy2 () dst_vector_range)
...
(define-fun us_split_fields_Dst_Subject2__projection ((a us_split_fields)) dst_subject_type
  (rec__skp__subjects__event_entry_type__dst_subject a))

(define-fun us_split_fields_Dst_Vector2__projection ((a us_split_fields)) dst_vector_range
  (rec__skp__subjects__event_entry_type__dst_vector a))

(define-fun us_split_fields_Handover__projection ((a us_split_fields)) Bool
  (rec__skp__subjects__event_entry_type__handover a))

(define-fun us_split_fields_Send_IPI__projection ((a us_split_fields)) Bool
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (= (rec__skp__subjects__event_entry_type__handover
                           (us_split_fields1 a)) (rec__skp__subjects__event_entry_type__handover
                                                 (us_split_fields1 b))))
                        (= (rec__skp__subjects__event_entry_type__send_ipi
                           (us_split_fields1 a)) (rec__skp__subjects__event_entry_type__send_ipi
                                                 (us_split_fields1 b))))
                   true false))
...
(declare-fun skp__subjects__event_entry_type__dst_subject__first__bit () Int)

(declare-fun skp__subjects__event_entry_type__dst_subject__last__bit () Int)

(declare-fun skp__subjects__event_entry_type__dst_subject__position () Int)
...
(declare-fun skp__subjects__event_entry_type__dst_vector__first__bit () Int)

(declare-fun skp__subjects__event_entry_type__dst_vector__last__bit () Int)

(declare-fun skp__subjects__event_entry_type__dst_vector__position () Int)
...
(declare-fun skp__subjects__event_entry_type__handover__first__bit () Int)

(declare-fun skp__subjects__event_entry_type__handover__last__bit () Int)

(declare-fun skp__subjects__event_entry_type__handover__position () Int)
...
(declare-fun skp__subjects__event_entry_type__send_ipi__first__bit () Int)

(declare-fun skp__subjects__event_entry_type__send_ipi__last__bit () Int)

(declare-fun skp__subjects__event_entry_type__send_ipi__position () Int)
...
((event_entry_type__ref
 (mk_event_entry_type__ref (event_entry_type__content us_rep)))))
(define-fun event_entry_type__ref___projection ((a event_entry_type__ref)) us_rep
  (event_entry_type__content a))

(declare-sort event_range 0)

(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 31)))
...
(declare-fun dummy4 () event_range)

(declare-datatypes ()
((event_range__ref (mk_event_range__ref (event_range__content event_range)))))
(define-fun event_range__ref___projection ((a event_range__ref)) event_range
  (event_range__content a))

(define-fun dynamic_invariant1 ((temp___expr_380 Int)
  (temp___is_init_377 Bool) (temp___skip_constant_378 Bool)
  (temp___do_toplevel_379 Bool)) Bool (=>
                                      (or (= temp___is_init_377 true)
                                      (<= 0 31)) (in_range4 temp___expr_380)))

(declare-fun subject_id () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun event_nr () Int)
...
(define-fun to_int4 ((x word32)) Int (bv2nat (to_rep2 x)))
...
(define-fun to_int5 ((x word64)) Int (bv2nat (to_rep3 x)))
...
(declare-fun dummy7 () cpu_range)

(declare-datatypes ()
((cpu_range__ref (mk_cpu_range__ref (cpu_range__content cpu_range)))))
...
(declare-fun dummy8 () profile_kind)
...
;; range_axiom
  (assert
  (forall ((x profile_kind)) (! (in_range6
...
(define-fun us_split_fields_Exec_Pin__projection ((a us_split_fields2)) word32
  (rec__skp__subjects__vmx_controls_type__exec_pin a))

(define-fun us_split_fields_Exec_Proc__projection ((a us_split_fields2)) word32
  (rec__skp__subjects__vmx_controls_type__exec_proc a))

(define-fun us_split_fields_Exec_Proc2__projection ((a us_split_fields2)) word32
  (rec__skp__subjects__vmx_controls_type__exec_proc2 a))

(define-fun us_split_fields_Exit_Ctrls__projection ((a us_split_fields2)) word32
  (rec__skp__subjects__vmx_controls_type__exit_ctrls a))

(define-fun us_split_fields_Entry_Ctrls__projection ((a us_split_fields2)) word32
...
(declare-fun skp__subjects__vmx_controls_type__exec_pin__first__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exec_pin__last__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exec_pin__position () Int)
...
(declare-fun skp__subjects__vmx_controls_type__exec_proc__first__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exec_proc__last__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exec_proc__position () Int)
...
(declare-fun skp__subjects__vmx_controls_type__exec_proc2__first__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exec_proc2__last__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exec_proc2__position () Int)
...
(declare-fun skp__subjects__vmx_controls_type__exit_ctrls__first__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exit_ctrls__last__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__exit_ctrls__position () Int)
...
(declare-fun skp__subjects__vmx_controls_type__entry_ctrls__first__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__entry_ctrls__last__bit () Int)

(declare-fun skp__subjects__vmx_controls_type__entry_ctrls__position () Int)
...
((vmx_controls_type__ref
 (mk_vmx_controls_type__ref (vmx_controls_type__content us_rep1)))))
(define-fun vmx_controls_type__ref___projection ((a vmx_controls_type__ref)) us_rep1
...
(define-fun us_split_fields_Dst_Subject__projection ((a us_split_fields4)) dst_subject_type
  (rec__skp__subjects__trap_entry_type__dst_subject a))

(define-fun us_split_fields_Dst_Vector__projection ((a us_split_fields4)) dst_vector_range
...
(declare-fun skp__subjects__trap_entry_type__dst_subject__first__bit () Int)

(declare-fun skp__subjects__trap_entry_type__dst_subject__last__bit () Int)

(declare-fun skp__subjects__trap_entry_type__dst_subject__position () Int)
...
(declare-fun skp__subjects__trap_entry_type__dst_vector__first__bit () Int)

(declare-fun skp__subjects__trap_entry_type__dst_vector__last__bit () Int)

(declare-fun skp__subjects__trap_entry_type__dst_vector__position () Int)
...
((trap_entry_type__ref
 (mk_trap_entry_type__ref (trap_entry_type__content us_rep2)))))
(define-fun trap_entry_type__ref___projection ((a trap_entry_type__ref)) us_rep2
...
(declare-fun dummy12 () (Array Int us_rep))
...
(define-fun us_split_fields_VMX_Controls__projection ((a us_split_fields6)) us_rep1
  (rec__skp__subjects__subject_spec_type__vmx_controls a))

(define-fun us_split_fields_Trap_Table__projection ((a us_split_fields6)) (Array Int us_rep2)
  (rec__skp__subjects__subject_spec_type__trap_table a))

(define-fun us_split_fields_Event_Table__projection ((a us_split_fields6)) (Array Int us_rep)
...
(declare-fun skp__subjects__subject_spec_type__cpu_id__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cpu_id__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cpu_id__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__profile__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__profile__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__profile__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__pml4_address__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__pml4_address__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__pml4_address__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__ept_pointer__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__ept_pointer__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__ept_pointer__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__vmcs_address__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__vmcs_address__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__vmcs_address__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__io_bitmap_address__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__io_bitmap_address__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__io_bitmap_address__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__msr_bitmap_address__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__msr_bitmap_address__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__msr_bitmap_address__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__msr_store_address__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__msr_store_address__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__msr_store_address__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__stack_address__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__stack_address__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__stack_address__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__entry_point__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__entry_point__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__entry_point__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__cr0_value__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr0_value__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr0_value__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__cr0_mask__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr0_mask__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr0_mask__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__cr4_value__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr4_value__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr4_value__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__cr4_mask__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr4_mask__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cr4_mask__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__cs_access__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cs_access__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__cs_access__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__exception_bitmap__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__exception_bitmap__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__exception_bitmap__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__msr_count__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__msr_count__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__msr_count__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__vmx_controls__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__vmx_controls__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__vmx_controls__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__trap_table__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__trap_table__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__trap_table__position () Int)
...
(declare-fun skp__subjects__subject_spec_type__event_table__first__bit () Int)

(declare-fun skp__subjects__subject_spec_type__event_table__last__bit () Int)

(declare-fun skp__subjects__subject_spec_type__event_table__position () Int)
...
(declare-datatypes ()
((map__ref2 (mk_map__ref2 (map__content2 (Array Int us_rep3))))))
...
(declare-fun subject_specs () (Array Int us_rep3))

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun null_trap () us_rep2)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun null_trap_table () (Array Int us_rep2))
...
(declare-fun null_event () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun null_event_table () (Array Int us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___152 us_rep) (temp___153 us_rep) (temp___154 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___158 us_rep) (temp___159 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___163 us_rep) (temp___164 us_rep) (temp___165 us_rep))
...
;; def_axiom
  (assert
  (forall ((temp___169 us_rep) (temp___170 us_rep) (temp___171 us_rep))
...
(declare-fun temp___173 (us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2) (Array Int us_rep2))

;; def_axiom
  (assert
  (forall ((temp___175 us_rep2) (temp___176 us_rep2) (temp___177 us_rep2)
  (temp___178 us_rep2) (temp___179 us_rep2) (temp___180 us_rep2)
  (temp___181 us_rep2) (temp___182 us_rep2) (temp___183 us_rep2)
  (temp___184 us_rep2) (temp___185 us_rep2) (temp___186 us_rep2)
  (temp___187 us_rep2) (temp___188 us_rep2) (temp___189 us_rep2)
  (temp___190 us_rep2) (temp___191 us_rep2) (temp___192 us_rep2)
  (temp___193 us_rep2) (temp___194 us_rep2) (temp___195 us_rep2)
  (temp___196 us_rep2) (temp___197 us_rep2) (temp___198 us_rep2)
  (temp___199 us_rep2) (temp___200 us_rep2) (temp___201 us_rep2)
...
;; def_axiom
  (assert
  (forall ((temp___236 us_rep) (temp___237 us_rep))
...
(declare-fun temp___239 (us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
  us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2 us_rep2
...
;; def_axiom
  (assert
  (forall ((temp___241 us_rep2) (temp___242 us_rep2) (temp___243 us_rep2)
  ...
  (temp___256 us_rep2) (temp___257 us_rep2) (temp___258 us_rep2)
  (temp___259 us_rep2) (temp___260 us_rep2) (temp___261 us_rep2)
  (temp___262 us_rep2) (temp___263 us_rep2) (temp___264 us_rep2)
  (temp___265 us_rep2) (temp___266 us_rep2) (temp___267 us_rep2)
...
;; def_axiom
  (assert
  (forall ((temp___302 us_rep) (temp___303 us_rep))
...
;; subject_specs__def_axiom
  ...
  (= subject_specs (skp__subjects__subject_specs__aggregate_def
                   (mk___rep3
                   (mk___split_fields3 (of_rep4 0) (of_rep5 0)
                   (of_rep3 ((_ int2bv 64) 16031744))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 20480))
                   (of_rep3 ((_ int2bv 64) 16121856))
                   (of_rep3 ((_ int2bv 64) 16195584))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 12288))
                   (of_rep3 ((_ int2bv 64) 24576))
                   (of_rep3 ((_ int2bv 64) 2147549235))
                   (of_rep3 ((_ int2bv 64) 3758424127))
                   (of_rep3 ((_ int2bv 64) 8736))
                   (of_rep3 ((_ int2bv 64) 1533951))
                   (of_rep2 ((_ int2bv 32) 41115))
                   (of_rep2 ((_ int2bv 32) 4294967295))
                   (of_rep2 ((_ int2bv 32) 0))
                   (mk___rep1
                   (mk___split_fields1 (of_rep2 ((_ int2bv 32) 73))
                   (of_rep2 ((_ int2bv 32) 2996411904))
                   (of_rep2 ((_ int2bv 32) 64))
                   (of_rep2 ((_ int2bv 32) 4227584))
                   (of_rep2 ((_ int2bv 32) 512)))) null_trap_table
                   null_event_table))
                   (mk___rep3
                   (mk___split_fields3 (of_rep4 0) (of_rep5 0)
                   (of_rep3 ((_ int2bv 64) 16080896))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 24576))
                   (of_rep3 ((_ int2bv 64) 16162816))
                   (of_rep3 ((_ int2bv 64) 16244736))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 12288))
                   (of_rep3 ((_ int2bv 64) 24576))
                   (of_rep3 ((_ int2bv 64) 2147549235))
                   ...
                   (temp___150
                   (mk___rep
                   (mk___split_fields (of_rep 5) (of_rep1 49) (of_int 0)
                   (of_int 1)))
                   (mk___rep
                   (mk___split_fields (of_rep 6) (of_rep1 49) (of_int 0)
                   (of_int 1))) null_event)))
                   (mk___rep3
                   (mk___split_fields3 (of_rep4 2) (of_rep5 0)
                   (of_rep3 ((_ int2bv 64) 16048128))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 28672))
                   (of_rep3 ((_ int2bv 64) 16130048))
                   (of_rep3 ((_ int2bv 64) 16199680))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 12288))
                   (of_rep3 ((_ int2bv 64) 24576))
                   (of_rep3 ((_ int2bv 64) 2147549235))
                   ...
                   (temp___156
                   (mk___rep
                   (mk___split_fields (of_rep 1) (of_rep1 38) (of_int 0)
                   (of_int 1))) null_event)))
                   (mk___rep3
                   (mk___split_fields3 (of_rep4 1) (of_rep5 0)
                   (of_rep3 ((_ int2bv 64) 16015360))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 32768))
                   (of_rep3 ((_ int2bv 64) 16113664))
                   (of_rep3 ((_ int2bv 64) 16191488))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 12288))
                   (of_rep3 ((_ int2bv 64) 24576))
                   (of_rep3 ((_ int2bv 64) 2147549235))
                   ...
                   (temp___161
                   (mk___rep
                   (mk___split_fields (of_rep 5) (of_rep1 256) (of_int 1)
                   (of_int 0)))
                   (mk___rep
                   (mk___split_fields (of_rep 1) (of_rep1 36) (of_int 0)
                   (of_int 1))) null_event)))
                   (mk___rep3
                   (mk___split_fields3 (of_rep4 3) (of_rep5 0)
                   (of_rep3 ((_ int2bv 64) 16064512))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 36864))
                   (of_rep3 ((_ int2bv 64) 16154624))
                   (of_rep3 ((_ int2bv 64) 16228352))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 12288))
                   (of_rep3 ((_ int2bv 64) 24576))
                   (of_rep3 ((_ int2bv 64) 2147549235))
                   ...
                   (temp___167
                   (mk___rep
                   (mk___split_fields (of_rep 6) (of_rep1 256) (of_int 1)
                   (of_int 0)))
                   (mk___rep
                   (mk___split_fields (of_rep 1) (of_rep1 37) (of_int 0)
                   (of_int 1))) null_event)))
                   (mk___rep3
                   (mk___split_fields3 (of_rep4 1) (of_rep5 1)
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 14348318))
                   (of_rep3 ((_ int2bv 64) 40960))
                   (of_rep3 ((_ int2bv 64) 16097280))
                   (of_rep3 ((_ int2bv 64) 16183296))
                   (of_rep3 ((_ int2bv 64) 16187392))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 4194304))
                   (of_rep3 ((_ int2bv 64) 53)) (of_rep3 ((_ int2bv 64) 32))
                   (of_rep3 ((_ int2bv 64) 8224))
                   (of_rep3 ((_ int2bv 64) 8192))
                   (of_rep2 ((_ int2bv 32) 49307))
                   (of_rep2 ((_ int2bv 32) 4293951490))
                   (of_rep2 ((_ int2bv 32) 5))
                   (mk___rep1
                   (mk___split_fields1 (of_rep2 ((_ int2bv 32) 73))
                   (of_rep2 ((_ int2bv 32) 2996313600))
                   (of_rep2 ((_ int2bv 32) 194))
                   (of_rep2 ((_ int2bv 32) 7373312))
                   (of_rep2 ((_ int2bv 32) 32768))))
                   (temp___173
                   (mk___rep2 (mk___split_fields2 (of_rep 3) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 3) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 3) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 3) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 3) (of_rep1 36)))
                   ...
                   (temp___234
                   (mk___rep
                   (mk___split_fields (of_rep 1) (of_rep1 34) (of_int 0)
                   (of_int 1))) null_event)))
                   (mk___rep3
                   (mk___split_fields3 (of_rep4 3) (of_rep5 1)
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 10092574))
                   (of_rep3 ((_ int2bv 64) 45056))
                   (of_rep3 ((_ int2bv 64) 16138240))
                   (of_rep3 ((_ int2bv 64) 16220160))
                   (of_rep3 ((_ int2bv 64) 16224256))
                   (of_rep3 ((_ int2bv 64) 0))
                   (of_rep3 ((_ int2bv 64) 4194304))
                   (of_rep3 ((_ int2bv 64) 53)) (of_rep3 ((_ int2bv 64) 32))
                   (of_rep3 ((_ int2bv 64) 8224))
                   ...
                   (of_rep2 ((_ int2bv 32) 32768))))
                   (temp___239
                   (mk___rep2 (mk___split_fields2 (of_rep 4) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 4) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 4) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 4) (of_rep1 36)))
                   (mk___rep2 (mk___split_fields2 (of_rep 4) (of_rep1 36)))
                   ...
                   (temp___300
                   (mk___rep
                   (mk___split_fields (of_rep 1) (of_rep1 35) (of_int 0)
                   (of_int 1))) null_event))))))

(define-fun dynamic_invariant2 ((temp___expr_350 Int)
  (temp___is_init_347 Bool) (temp___skip_constant_348 Bool)
  (temp___do_toplevel_349 Bool)) Bool (=>
                                      (or (= temp___is_init_347 true)
                                      (<= 0 1)) (in_range6 temp___expr_350)))

;; null_trap__def_axiom
  (assert
  (= null_trap (mk___rep2 (mk___split_fields2 (of_rep 7) (of_rep1 256)))))

;; null_event__def_axiom
  (assert
  (= null_event (mk___rep
                (mk___split_fields (of_rep 7) (of_rep1 256) (of_int 0)
                (of_int 0)))))

(define-fun dynamic_invariant3 ((temp___expr_320 Int)
  (temp___is_init_317 Bool) (temp___skip_constant_318 Bool)
  (temp___do_toplevel_319 Bool)) Bool (=>
                                      (or (= temp___is_init_317 true)
                                      (<= 0 3)) (in_range5 temp___expr_320)))

(define-fun dynamic_invariant4 ((temp___expr_332 Int)
  (temp___is_init_329 Bool) (temp___skip_constant_330 Bool)
  (temp___do_toplevel_331 Bool)) Bool (=>
                                      (or (= temp___is_init_329 true)
                                      (<= 0 7)) (in_range2 temp___expr_332)))

(define-fun dynamic_invariant5 ((temp___expr_344 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_314 (_ BitVec 64))
...
;; H
  (assert (in_range4 event_nr))

(declare-fun subject () Int)
...
(assert
;; WP_parameter_def
 ;; File "skp-subjects.ads", line 21, characters 0-0
  (not
  (not
  (= (to_rep
     (rec__skp__subjects__event_entry_type__dst_subject
     (us_split_fields1
     (select (rec__skp__subjects__subject_spec_type__event_table
