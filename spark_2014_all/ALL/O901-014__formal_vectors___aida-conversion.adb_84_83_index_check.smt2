...
;; H
  (assert (= o1 (ite (<= o index) true false)))

;; H
  (assert
  (= result (ite (= o1 true) (ite (<= index (to_rep1 (last (rt source))))
                             true false) false)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep1 (first (rt source))) (to_rep1 (first (rt source))))))
(check-sat)
(exit)
