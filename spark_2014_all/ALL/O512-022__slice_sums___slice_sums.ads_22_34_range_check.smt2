...
(declare-fun slice_sums__maximal_sum_slice_bounds_2__result () index)

(declare-fun slice_sums__maximal_sum_slice_bounds_2__result1 () extended_index)

(declare-fun o () extended_index)

(declare-fun o1 () index)

(declare-fun o2 () index)

(declare-fun o3 () extended_index)

(declare-fun temp___188 () index)

(declare-fun temp___1881 () extended_index)

(declare-fun o4 () Int)

(declare-fun o5 () extended_index)

(declare-fun o6 () index)

(declare-fun o7 () index)

(declare-fun o8 () extended_index)

(declare-fun temp___176 () index)

(declare-fun temp___1761 () extended_index)

(declare-fun temp___185 () index)

(declare-fun temp___1851 () extended_index)
...
(declare-fun o14 () extended_index)
...
(declare-fun current_lo4 () Int)

(declare-fun result11 () int__ref)

(declare-fun current_sum4 () Int)

(declare-fun max_sum4 () int__ref)

(declare-fun current_sum5 () int__ref)

(declare-fun current_lo5 () int__ref)

(declare-fun result____split_fields7 () us_split_fields__ref)

(declare-fun current_hi4 () int__ref)

(declare-fun max_sum5 () Int)

(declare-fun current_sum6 () Int)

(declare-fun current_lo6 () Int)

(declare-fun result____split_fields8 () us_split_fields)

(declare-fun current_hi5 () Int)

(declare-fun max_sum6 () int__ref)

(declare-fun current_sum7 () int__ref)

(declare-fun current_lo7 () int__ref)

(declare-fun result____split_fields9 () us_split_fields__ref)

(declare-fun current_hi6 () int__ref)

(declare-fun max_sum7 () Int)

(declare-fun current_sum8 () Int)

(declare-fun current_lo8 () Int)

(declare-fun result____split_fields10 () us_split_fields)

(declare-fun current_hi7 () Int)

(declare-fun max_sum8 () int__ref)

(declare-fun current_sum9 () int__ref)

(declare-fun current_lo9 () int__ref)

(declare-fun result____split_fields11 () us_split_fields__ref)

(declare-fun current_hi8 () int__ref)

(declare-fun max_sum9 () Int)

(declare-fun current_sum10 () Int)

(declare-fun current_lo10 () Int)

(declare-fun result____split_fields12 () us_split_fields)

(declare-fun current_hi9 () Int)

(declare-fun result12 () slice_bounds__ref)

(declare-fun slice_sums__maximal_sum_slice_bounds_2__result2 () slice_bounds)

(declare-fun slice_sums__maximal_sum_slice_bounds_2__result3 () slice_bounds__ref)

(declare-fun slice_sums__maximal_sum_slice_bounds_2__result4 () slice_bounds)

(declare-fun max_sum10 () int__ref)

(declare-fun current_sum11 () int__ref)

(declare-fun current_lo11 () int__ref)

(declare-fun result____split_fields13 () us_split_fields__ref)

(declare-fun current_hi10 () int__ref)

(declare-fun slice_sums__maximal_sum_slice_bounds_2__result5 () slice_bounds__ref)

(declare-fun max_sum11 () Int)

(declare-fun current_sum12 () Int)

(declare-fun current_lo12 () Int)

(declare-fun result____split_fields14 () us_split_fields)

(declare-fun current_hi11 () Int)

(declare-fun slice_sums__maximal_sum_slice_bounds_2__result6 () slice_bounds)

(declare-fun result13 () Bool)

(define-fun current_hi12 () int__ref (mk_int__ref current_hi))

(define-fun result____split_fields15 () us_split_fields__ref (mk___split_fields__ref
                                                             (mk___split_fields
...
;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))) (= (to_rep2 o) 0)))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= (to_rep1 o1) 1)))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))) (= o1 o2)))
...
;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))) (= temp___188 o2)))
...
;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= result2 result____split_fields15)))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= result____split_fields2 (mk___split_fields temp___188 temp___1881))))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= current_hi8 current_hi12)))
...
;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= current_lo9 current_lo13)))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= current_sum9 (mk_int__ref current_sum1))))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= max_sum8 (mk_int__ref max_sum1))))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= current_hi9 current_hi1)))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= result____split_fields12 result____split_fields2)))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= current_lo10 current_lo1)))

;; H
  (assert
  (=> (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))
  (= current_sum10 current_sum1)))
...
;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= (to_rep2 o5) 0)))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (and (= o4 (to_rep3 (first (rt x)))) (in_range4 (to_rep3 (first (rt x)))))))
...
;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))) (= o6 o7)))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x))))) (= o5 o8)))
...
;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= result3 result____split_fields15)))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= result____split_fields3 (mk___split_fields temp___176 temp___1761))))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= result4 current_lo13)))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= current_lo2 (to_rep1
                 (rec__sums__slice_bounds__lo result____split_fields3)))))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= result5 current_hi12)))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= current_hi2 (to_rep3 (first (rt x))))))
...
;; H
  ...
  (= result____split_fields3 (mk___split_fields temp___185 temp___1851)))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= temp___184 current_hi2))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= temp___183 current_lo2))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= temp___182 current_sum1))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= temp___181 max_sum1))))
...
;; H
  ...
  (and
  (and
  (and (<= (to_rep3 (first (rt x))) current_lo3)
  (<= current_lo3 current_hi3)) (<= 0 current_sum2))
  (<= current_sum2 (* (- current_hi3 current_lo3) 32767))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=>
  (<= (to_rep1 (rec__sums__slice_bounds__lo result____split_fields4))
  (to_rep2 (rec__sums__slice_bounds__hi result____split_fields4)))
  (and
  (and
  ...
  (<= (to_rep2 (rec__sums__slice_bounds__hi result____split_fields4))
  (to_rep3 (last (rt x)))))
  (= max_sum2 (sum__logic x (mk_slice_bounds result____split_fields4))))))))
...
;; H
  ...
  (<= lo_index (- current_hi3 1)))
  (forall ((hi_index Int))
  (=>
  (and (<= (to_rep3 (first (rt x))) hi_index)
  (<= hi_index (- current_hi3 1)))
  (<= (sum__logic x
      (mk_slice_bounds
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) lo_index)
  (<= lo_index (- current_lo3 1)))
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep1 lo_index) (of_rep2 (- current_lo3 1))))) 0))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (forall ((hi_index Int))
  (=> (and (<= current_lo3 hi_index) (<= hi_index (- current_hi3 1)))
  (<= 0 (sum__logic x
        (mk_slice_bounds
        (mk___split_fields (of_rep1 current_lo3) (of_rep2 hi_index))))))))))
...
;; H
  ...
  current_hi3)))
  (and (<= (to_rep3 (first (rt x))) current_hi3)
  (<= current_hi3 (to_rep3 (last (rt x)))))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (and (= o9 (+ current_sum2 (to_rep (select (elts x) current_hi3))))
  (in_range1 (+ current_sum2 (to_rep (select (elts x) current_hi3))))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (= result6 (mk_int__ref current_sum2)))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_sum3 o9))))
...
;; H
  ...
  (and (= o10 current_sum3) (in_range2 current_sum3))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= result7 (mk_int__ref max_sum2))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= max_sum3 o10)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= (to_rep1 o11) current_lo3)))))
...
;; H
  ...
  (= o12 (mk___split_fields o11
         (rec__sums__slice_bounds__hi result____split_fields4)))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= temp___178 (mk_slice_bounds o12))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3)
  (= result____split_fields5 (us_split_fields1 temp___178))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3)
  (and (= o13 current_hi3) (in_range5 current_hi3))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= (to_rep2 o14) o13)))))
...
;; H
  ...
  (= o15 (mk___split_fields
         (rec__sums__slice_bounds__lo result____split_fields5) o14))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= temp___180 (mk_slice_bounds o15))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3)
  (= result9 (mk___split_fields__ref result____split_fields5))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3)
  (= result____split_fields6 (us_split_fields1 temp___180))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= current_lo4 current_lo3)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (< max_sum2 current_sum3) (= current_sum4 current_sum3)))))
...
;; H
  ...
  (=> (< current_sum3 0)
  (=> (not (= current_hi3 65536))
  (and (= o16 (+ current_hi3 1)) (in_range1 (+ current_hi3 1)))))))))
...
;; H
  ...
  (=> (not (< max_sum2 current_sum3))
  (=> (< current_sum3 0)
  (=> (not (= current_hi3 65536)) (and (= o17 o16) (in_range4 o16))))))))
...
;; H
  ...
  (=> (not (< max_sum2 current_sum3))
  (=> (< current_sum3 0)
  (=> (not (= current_hi3 65536)) (= result10 (mk_int__ref current_lo3))))))))
...
;; H
  ...
  (=> (not (< max_sum2 current_sum3))
  (=> (< current_sum3 0)
  (=> (not (= current_hi3 65536)) (= current_lo4 o17)))))))
...
;; H
  ...
  (=> (not (< max_sum2 current_sum3))
  (=> (< current_sum3 0)
  (=> (not (= current_hi3 65536)) (= result11 (mk_int__ref current_sum3))))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (not (< max_sum2 current_sum3))
  (=> (< current_sum3 0) (=> (not (= current_hi3 65536)) (= current_sum4 0)))))))
...
;; H
  ...
  (=> (not (< max_sum2 current_sum3))
  (=> (< current_sum3 0)
  (=> (not (not (= current_hi3 65536))) (= current_lo4 current_lo3)))))))
...
;; H
  ...
  (=> (not (< max_sum2 current_sum3))
  (=> (< current_sum3 0)
  (=> (not (not (= current_hi3 65536))) (= current_sum4 current_sum3)))))))
...
;; H
  ...
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (not (< max_sum2 current_sum3))
  (=> (not (< current_sum3 0)) (= current_lo4 current_lo3))))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (=> (not (< max_sum2 current_sum3)) (= max_sum3 max_sum2)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (= current_hi4 (mk_int__ref current_hi3)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (= result____split_fields7 (mk___split_fields__ref result____split_fields6)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))
  (= current_lo5 (mk_int__ref current_lo4)))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_hi5 current_hi3))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_lo6 current_lo4))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_sum6 current_sum4))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= max_sum5 max_sum3))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_hi6 current_hi4))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_lo7 current_lo5))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_sum7 current_sum5))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= max_sum6 max_sum4))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_hi7 current_hi5))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_lo8 current_lo6))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= current_sum8 current_sum6))))
...
;; H
  ...
  (=>
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))) (= max_sum7 max_sum5))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))))
  (= current_hi6 (mk_int__ref current_hi2)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))))
  (= result____split_fields9 (mk___split_fields__ref result____split_fields3)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))))
  (= current_lo7 (mk_int__ref current_lo2)))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))))
  (= current_sum7 (mk_int__ref current_sum1)))))
...
;; H
  ...
  (not
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))) (= current_hi7 current_hi2))))
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x))))))
  (= result____split_fields10 result____split_fields3))))
...
;; H
  ...
  (not
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))) (= current_lo8 current_lo2))))
...
;; H
  ...
  (not
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))) (= current_sum8 current_sum1))))
...
;; H
  ...
  (not
  (and (<= (to_rep3 (first (rt x))) current_hi2)
  (<= current_hi2 (to_rep3 (last (rt x)))))) (= max_sum7 max_sum1))))

;; H
  (assert
  (=> (not (< (to_rep3 (last (rt x))) (to_rep3 (first (rt x)))))
  (= current_hi8 current_hi6)))
...
;; H
  (assert
  (= slice_sums__maximal_sum_slice_bounds_2__result3 (mk_slice_bounds__ref
                                                     slice_sums__maximal_sum_slice_bounds_2__result2)))

;; H
  (assert
  (= slice_sums__maximal_sum_slice_bounds_2__result4 slice_sums__maximal_sum_slice_bounds_2__result2))

;; H
  (assert
  (= result12 (mk_slice_bounds__ref
              (mk_slice_bounds
              (mk___split_fields
              slice_sums__maximal_sum_slice_bounds_2__result
              slice_sums__maximal_sum_slice_bounds_2__result1)))))

;; H
  (assert
  (= slice_sums__maximal_sum_slice_bounds_2__result2 (mk_slice_bounds
                                                     (us_split_fields__content
                                                     result____split_fields11))))

;; H
  (assert
  (= slice_sums__maximal_sum_slice_bounds_2__result5 slice_sums__maximal_sum_slice_bounds_2__result3))
...
;; H
  (assert
  (= slice_sums__maximal_sum_slice_bounds_2__result6 slice_sums__maximal_sum_slice_bounds_2__result4))
...
;; H
  ...
  (<= (to_rep1
      (rec__sums__slice_bounds__lo
      (us_split_fields1
      (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))
  (to_rep2
  (rec__sums__slice_bounds__hi
  (us_split_fields1
  (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))))
...
;; H
  ...
  (<= (to_rep3 (first (rt x))) (to_rep1
                               ...
                               slice_sums__maximal_sum_slice_bounds_2__result5)))))
  (= result13 (ite (<= (to_rep2
                       (rec__sums__slice_bounds__hi
                       (us_split_fields1
                       (slice_bounds__content
                       slice_sums__maximal_sum_slice_bounds_2__result5))))
