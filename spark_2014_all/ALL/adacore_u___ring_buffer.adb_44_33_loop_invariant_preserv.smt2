...
(declare-const r2 us_rep)

(declare-const j3 Int)

(declare-const result1 us_rep)

(declare-const r3 us_rep)

(declare-const r4 us_rep)

(declare-const j4 Int)

(declare-const r5 us_rep)

(declare-const j5 Int)

(declare-const r6 us_rep)

(declare-const j6 Int)

(declare-const r7 us_rep)
...
(declare-const r8 us_rep)

(declare-const j9 Int)

(declare-const result3 us_rep)

(declare-const r9 us_rep)

(declare-const result4 Int)

(declare-const j10 Int)

(declare-const r10 us_rep)

(declare-const j11 Int)

(declare-const r11 us_rep)

(declare-const j12 Int)

(define-fun r12 () model_type__ref (mk_model_type__ref r6))
...
;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= temp___223 j2)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= temp___222 r)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= (length r2) (- j3 first))))
...
;; H
  (assert
  (=> (and (<= r17b j2) (<= j2 c))
  (and (=> (<= r17b c) (dynamic_property r17b c j3))
  (and (<= r17b j3) (<= j3 c)))))
...
;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= o1 o)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= r2 result1)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= r3 o1)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= j3 c)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= j3 j4)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= r3 r4)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= j5 j3)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= r5 r3)))

;; H
  (assert
  (=> (and (<= r17b j2) (<= j2 c)) (= (mk_int__ref j6) (mk_int__ref j4))))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= r12 (mk_model_type__ref r4))))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= j7 j5)))

;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= r7 r5)))

;; H
  (assert (=> (not (and (<= r17b j2) (<= j2 c))) (= j2 j6)))

;; H
  (assert
  (=> (not (and (<= r17b j2) (<= j2 c))) (= r12 (mk_model_type__ref r))))

;; H
  (assert (=> (not (and (<= r17b j2) (<= j2 c))) (= j7 j2)))

;; H
  (assert (=> (not (and (<= r17b j2) (<= j2 c))) (= r7 r1)))

;; H
  (assert (= (- (- (+ first length1) 1) 100) r23b))

;; H
  (assert (in_range1 r23b))
...
;; H
  ...
  (= (to_rep (select content i)) (get r8 (+ (- i first) 1)))
  (=> (and (<= 1 i) (<= i (- j9 1)))
  (= (to_rep (select content i)) (get r8 (+ (- (+ i 100) first) 1))))))))

;; H
  (assert
  (and (=> (<= 1 r23b) (dynamic_property1 1 r23b j9))
  (and (<= 1 j9) (<= j9 r23b))))

;; H
  (assert
  (and (= o2 (add r8 (to_rep (select content j9))))
  (and (= (length o2) (+ (length r8) 1))
  (and (= (get o2 (last o2)) (to_rep (select content j9)))
  (= (ole r8 o2) true)))))
