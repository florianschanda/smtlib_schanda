...
(define-fun us_split_fields__ref___84__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___84__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-const dw1000__register_types__lde_rxantd_type__lde_rxantd__first__bit Int)

(declare-const dw1000__register_types__lde_rxantd_type__lde_rxantd__last__bit Int)

(declare-const dw1000__register_types__lde_rxantd_type__lde_rxantd__position Int)
...
(declare-datatypes ((lde_rxantd_type__ref 0))
...
(define-fun register_type__ref___203__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___143__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___143__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6805 us_t1)
  (temp___is_init_6802 Bool) (temp___skip_constant_6803 Bool)
  (temp___do_toplevel_6804 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6803 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6805)
                                       (last3 temp___expr_6805))
                                       (and (= (first3 temp___expr_6805) 1)
                                       (= (last3 temp___expr_6805) 2)))))
...
(define-fun target__ref___61__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___61__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_6821 us_t2)
  (temp___is_init_6818 Bool) (temp___skip_constant_6819 Bool)
  (temp___do_toplevel_6820 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6819 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6821)
                                       (last5 temp___expr_6821))
                                       (and (= (first5 temp___expr_6821) 1)
                                       (= (last5 temp___expr_6821) 2)))))
...
(declare-const temp___8161 (Array Int bits_8))

(declare-const temp___81611 t2)

(declare-const temp___8162 (Array Int bits_8))

(declare-const temp___81621 t1)
...
(define-fun temp___81612 () us_t2 (mk___t2 temp___8161 temp___81611))
...
;; H
  (assert
  (and (= temp___81612 (register_to_bytes reg)) (dynamic_invariant1
  temp___81612 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___81611)) (to_rep (last4 temp___81611)))
     (+ (- (to_rep (last4 temp___81611)) (to_rep (first4 temp___81611))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___8161 temp___8162))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___81611)) (to_rep (last4 temp___81611)))
  temp___81621))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___81621)) (to_rep (last2 temp___81621)))
     (+ (- (to_rep (last2 temp___81621)) (to_rep (first2 temp___81621))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8162 temp___81621)))
