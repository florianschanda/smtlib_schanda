...
(((mk_map__ref1 (map__content1 (Array Int signal))))))
...
(declare-datatypes ((ttrain_idB__ref 0))
(((mk_ttrain_idB__ref (ttrain_idB__content ttrain_idB)))))
(define-fun ttrain_idB__ref___projection ((a ttrain_idB__ref)) ttrain_idB
  (ttrain_idB__content a))

(declare-fun to_rep3 (ttrain_idB) Int)
...
(((mk_t8b__ref (t8b__content ttrain_idB)))))
...
(declare-fun to_rep5 (location) Int)
...
;; range_axiom
  (assert
  (forall ((x location)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(((mk_track__ref (track__content us_rep1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_202 Int)
  ...
  (temp___do_toplevel_201 Bool)) Bool (=>
                                      ...
                                      (<= 0 8)) (in_range8 temp___expr_202)))

(declare-datatypes ((map__ref2 0))
(((mk_map__ref2 (map__content2 (Array Int us_rep1))))))
...
;; tracks__def_axiom
  ...
  (= tracks (trains__tracks__aggregate_def
            (mk___rep1
            (mk___split_fields1 (of_rep5 1) (of_rep5 2) (of_rep4 10)))
            (mk___rep1
            (mk___split_fields1 (of_rep5 1) (of_rep5 3) (of_rep4 10)))
            (mk___rep1
            (mk___split_fields1 (of_rep5 2) (of_rep5 3) (of_rep4 10)))
            (mk___rep1
            (mk___split_fields1 (of_rep5 2) (of_rep5 5) (of_rep4 10)))
            (mk___rep1
            (mk___split_fields1 (of_rep5 3) (of_rep5 4) (of_rep4 10)))
            (mk___rep1
            (mk___split_fields1 (of_rep5 3) (of_rep5 5) (of_rep4 10)))
            (mk___rep1
            (mk___split_fields1 (of_rep5 4) (of_rep5 5) (of_rep4 10)))
            (mk___rep1
            (mk___split_fields1 (of_rep5 5) (of_rep5 1) (of_rep4 10))))))
...
(define-fun dynamic_invariant6 ((temp___expr_214 Int)
  (temp___is_init_211 Bool) (temp___skip_constant_212 Bool)
  (temp___do_toplevel_213 Bool)) Bool (=>
                                      (or (= temp___is_init_211 true)
                                      (<= 1 3)) (in_range9 temp___expr_214)))

(declare-fun to_rep6 (track_opt_id) Int)
...
;; range_axiom
  (assert
  (forall ((x track_opt_id)) (! (in_range8
...
(((mk_map__ref3 (map__content3 (Array Int track_opt_id))))))
...
(define-fun bool_eq5 ((a (Array Int track_opt_id)) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep6 (select a temp___idx_143)) (to_rep6
...
(declare-fun user_eq12 ((Array Int track_opt_id)
...
;; def_axiom
  ...
  (and
  (and (= (select temp___153 1) (of_rep6 temp___154))
  (= (select temp___153 2) (of_rep6 temp___155)))
  (= (select temp___153 3) (of_rep6 temp___156))))))
...
;; def_axiom
  ...
  (and
  (and (= (select temp___159 1) (of_rep6 temp___160))
  (= (select temp___159 2) (of_rep6 temp___161)))
  (= (select temp___159 3) (of_rep6 temp___162))))))
...
;; def_axiom
  ...
  (and
  (and (= (select temp___165 1) (of_rep6 temp___166))
  (= (select temp___165 2) (of_rep6 temp___167)))
  (= (select temp___165 3) (of_rep6 temp___168))))))
...
;; def_axiom
  ...
  (and
  (and (= (select temp___171 1) (of_rep6 temp___172))
  (= (select temp___171 2) (of_rep6 temp___173)))
  (= (select temp___171 3) (of_rep6 temp___174))))))
...
;; def_axiom
  ...
  (and
  (and (= (select temp___177 1) (of_rep6 temp___178))
  (= (select temp___177 2) (of_rep6 temp___179)))
  (= (select temp___177 3) (of_rep6 temp___180))))))
...
;; H
  ...
  (exists ((id Int))
  (and (and (<= 1 id) (<= id 3))
  (or (= track (get_previous_track (select trains train1) id))
  (= track (get_other_previous_track (select trains train1) id))))))))
...
;; H
  ...
  (forall ((t1 Int))
  (=> (and (<= 1 t1) (<= t1 train2))
  (not (= (is_previous_track (select trains t1) track) true)))))

;; H
  (assert
  (and (=> (<= 1 r7b) (dynamic_property 1 r7b train2))
  (and (<= 1 train2) (<= train2 r7b))))
...
(assert
;; WP_parameter_def
 ;; File "trains.ads", line 155, characters 0-0
  (not (<= 1 t)))
(check-sat)
(exit)
