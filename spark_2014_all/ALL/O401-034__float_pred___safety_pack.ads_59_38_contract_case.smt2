...
(declare-fun safety_pack__lift_away_from_zero__result () t)
...
(declare-fun safety_pack__lift_away_from_zero__result1 () t)

(declare-fun safety_pack__lift_away_from_zero__result2 () t)

(declare-fun safety_pack__lift_away_from_zero__result3 () t)

(declare-fun res5 () t)

(declare-fun safety_pack__lift_away_from_zero__result4 () t)

(declare-fun res6 () t)

(declare-fun safety_pack__lift_away_from_zero__result5 () t)
...
;; H
  (assert
  (=> (eq x fliteral2)
  (or (or (eq fliteral2 fliteral2) (le fliteral2 (neg fliteral3))) (le
  fliteral3 fliteral2))))

;; H
  (assert (=> (eq x fliteral2) (= o fliteral2)))

;; H
  (assert (=> (eq x fliteral2) (= result res)))

;; H
  (assert (=> (eq x fliteral2) (= res1 o)))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (and (le (neg fliteral3) x) (le x fliteral2))
  (let ((temp___1352 (neg fliteral3)))
  (or (or (eq temp___1352 fliteral2) (le temp___1352 (neg fliteral3))) (le
  fliteral3 temp___1352))))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (and (le (neg fliteral3) x) (le x fliteral2)) (= o1 (neg fliteral3)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (and (le (neg fliteral3) x) (le x fliteral2)) (= result1 res))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (and (le (neg fliteral3) x) (le x fliteral2)) (= res2 o1))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (and (le fliteral2 x) (le x fliteral3))
  (or (or (eq fliteral3 fliteral2) (le fliteral3 (neg fliteral3))) (le
  fliteral3 fliteral3))))))
...
;; H
  ...
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (and (le fliteral2 x) (le x fliteral3)) (= o2 fliteral3)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (and (le fliteral2 x) (le x fliteral3)) (= result2 res)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (and (le fliteral2 x) (le x fliteral3)) (= res3 o2)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (not (and (le fliteral2 x) (le x fliteral3)))
  (let ((temp___1348 x))
  (or (or (eq temp___1348 fliteral2) (le temp___1348 (neg fliteral3))) (le
  fliteral3 temp___1348)))))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (not (and (le fliteral2 x) (le x fliteral3))) (= o3 x)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (not (and (le fliteral2 x) (le x fliteral3))) (= result3 res)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (not (and (le fliteral2 x) (le x fliteral3))) (= res4 o3)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (not (and (le fliteral2 x) (le x fliteral3))) (= res3 res4)))))

;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2))) (= res2 res3))))

;; H
  (assert (=> (not (eq x fliteral2)) (= res1 res2)))
...
;; H
  (assert (= (bool_eq x fliteral2) true))

(assert
;; WP_parameter_def
 ;; File "imu_pack.ads", line 16, characters 0-0
  (not (eq safety_pack__lift_away_from_zero__result4 fliteral2)))
(check-sat)
