...
(declare-fun temp___1008 () (_ BitVec 16))

(declare-fun temp___1007 () (_ BitVec 16))

(declare-fun temp___1006 () (_ BitVec 16))

(declare-fun temp___1003 () us_rep1)

(declare-fun temp___1002 () (_ BitVec 16))

(declare-fun temp___1001 () (_ BitVec 16))
...
(declare-fun temp___993 () us_rep1)

(declare-fun temp___992 () (_ BitVec 16))

(declare-fun temp___991 () (_ BitVec 16))
...
(declare-fun temp___990 () us_rep1)
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= temp___1003 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= i3 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___993 (mk___rep1 result____split_discrs result____split_fields3)))))
...
;; H
  ...
  (<= i3 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (=> (= result6 true) (= temp___990 (mk___rep1 result____split_discrs o29))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (=> (= result6 true)
  (= result____split_fields5 (us_split_fields3 temp___990))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (=> (= result6 true)
  (= result____split_discrs (us_split_discrs2 temp___990))))))
