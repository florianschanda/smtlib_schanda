...
;; H
  (assert (=> (and (<= 1 i4) (<= i4 100)) (= temp___236 d__split_fields)))
...
;; H
  (assert (=> (and (<= 1 i4) (<= i4 100)) (= temp___238 d__split_fields1)))
...
;; H
  (assert (=> (and (<= 1 i4) (<= i4 100)) (= (to_rep o2) 0)))
...
;; H
  (assert (=> (and (<= 1 i4) (<= i4 100)) (= o4 (mk___rep o3))))

;; H
  (assert
  (=> (and (<= 1 i4) (<= i4 100))
  (= o5 (store (rec__do_loops__r_array_record__f3 d__split_fields3) i5
  o4))))
...
;; H
  (assert (=> (and (<= 1 i4) (<= i4 100)) (= temp___234 (mk___rep1 o6))))
...
;; H
  ...
  (= (to_rep
     (rec__do_loops__r__f2
     (us_split_fields1
     (select (rec__do_loops__r_array_record__f3 d__split_fields4) i5))))
  (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___236 i5)))))))
...
;; H
  (assert
  (=> (and (<= 1 i4) (<= i4 100)) (= d__split_fields6 d__split_fields4)))
...
;; H
  (assert
  (=> (and (<= 1 i4) (<= i4 100)) (= d__split_fields7 d__split_fields5)))
...
;; H
  (assert
  (=> (and (<= 1 i4) (<= i4 100)) (= d__split_fields8 d__split_fields6)))
...
;; H
  (assert (=> (and (<= 1 i10) (<= i10 100)) (= (to_rep o7) 0)))
...
;; H
  (assert (=> (and (<= 1 i10) (<= i10 100)) (= o9 (mk___rep o8))))
...
;; H
  (assert (=> (and (<= 1 i10) (<= i10 100)) (= temp___249 (mk___rep1 o11))))
...
;; H
  (assert (=> (and (<= 1 i10) (<= i10 100)) (= (to_rep o12) 0)))
...
;; H
  (assert (=> (and (<= 1 i10) (<= i10 100)) (= o14 (mk___rep o13))))
...
;; H
  (assert (=> (and (<= 1 i10) (<= i10 100)) (= temp___254 (mk___rep1 o16))))
...
;; H
  ...
  (= (to_rep
     (rec__do_loops__r__f2
     (us_split_fields1
     (select (rec__do_loops__r_array_record__f3 d__split_fields11) i11))))
  (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___256 i11)))))))
...
;; H
  (assert
  (=> (and (<= 1 i10) (<= i10 100)) (= d__split_fields13 d__split_fields11)))
...
;; H
  (assert
  (=> (and (<= 1 i10) (<= i10 100)) (= d__split_fields14 d__split_fields12)))
...
;; H
  (assert
  (=> (and (<= 1 i10) (<= i10 100)) (= d__split_fields15 d__split_fields13)))
...
;; H
  (assert
  (=> (and (<= 1 i16) (<= i16 100)) (default_initial_assumption1
  (mk___rep1
  (mk___split_fields1 d_outer__split_fields d_outer__split_fields1)) false)))

;; H
  (assert (=> (and (<= 1 i16) (<= i16 100)) (= (to_rep o17) 0)))
...
;; H
  (assert (=> (and (<= 1 i16) (<= i16 100)) (= o19 (mk___rep o18))))
...
;; H
  (assert (=> (and (<= 1 i16) (<= i16 100)) (= temp___274 (mk___rep1 o21))))
...
;; H
  (assert (=> (and (<= 1 i16) (<= i16 100)) (= (to_rep o22) 0)))
...
;; H
  (assert (=> (and (<= 1 i16) (<= i16 100)) (= o24 (mk___rep o23))))
...
;; H
  (assert (=> (and (<= 1 i16) (<= i16 100)) (= temp___279 (mk___rep1 o26))))
...
;; H
  ...
  (= (to_rep
     (rec__do_loops__r__f1
     (us_split_fields1
     (select (rec__do_loops__r_array_record__f3 d__split_fields19) i17))))
  (to_rep (rec__do_loops__r__f1 (us_split_fields1 (select temp___282 i17)))))))
...
;; H
  ...
  (= (to_rep
     ...
     (us_split_fields1
     (select (rec__do_loops__r_array_record__f3 d__split_fields19) i17))))
  (to_rep (rec__do_loops__r__f2 (us_split_fields1 (select temp___285 i17)))))))
...
;; H
  (assert
  (=> (and (<= 1 i16) (<= i16 100)) (= d__split_fields21 d__split_fields19)))
...
;; H
  (assert
  (=> (and (<= 1 i16) (<= i16 100)) (= d__split_fields22 d__split_fields20)))
...
;; H
  (assert
  (=> (and (<= 1 i16) (<= i16 100)) (= d__split_fields23 d__split_fields21)))
...
;; H
  ...
  (rec__do_loops__r_array_record__f4
  (us_split_fields__content1 d__split_fields22)) temp___315))
  (= (rec__do_loops__r__f2
     (us_split_fields1
...
;; H
  (assert (= temp___296 (mk___rep1 o31)))

;; H
  (assert (= result11 (mk___split_fields__ref1 d__split_fields24)))

;; H
  (assert (= d__split_fields25 (us_split_fields3 temp___296)))
...
;; H
  (assert (= temp___301 (mk___rep1 o36)))

;; H
  (assert (= result12 (mk___split_fields__ref1 d__split_fields25)))

;; H
  (assert (= d__split_fields26 (us_split_fields3 temp___301)))
