...
;; H
  ...
  (and (dynamic_property2 first2 last2 o8)
  (= o8 (last6
        (model__
        (mk___rep v__split_discrs (mk___split_fields v__split_fields8))))))))
...
;; H
  (assert (and (= temp___486 (- j 7)) (in_range1 (- j 7))))

;; H
  (assert
  (and (= us8 temp___486) (dynamic_property4 first3 last4 temp___486)))

;; H
  (assert (= o12 temp___486))
