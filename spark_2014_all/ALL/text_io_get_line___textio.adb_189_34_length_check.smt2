...
;; H
  ...
  (and (<= (to_rep1 result____first) r77b)
  (<= r77b (to_rep1 result____last))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first6 temp___6551)) (to_rep1 (last6 temp___6551)))
     (+ (- (to_rep1 (last6 temp___6551)) (to_rep1 (first6 temp___6551))) 1)
     0) (ite (<= (to_rep1 (first6 temp___6571)) (to_rep1 (last6 temp___6571)))
        (+ (- (to_rep1 (last6 temp___6571)) (to_rep1 (first6 temp___6571))) 1)
        0))))
(check-sat)
(exit)
