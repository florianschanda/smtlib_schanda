...
(declare-fun temp___1123 () digit_index_type)

(declare-fun temp___11231 () (Array Int octet))

(declare-fun temp___11232 () t1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___11231 temp___11232))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      result____split_fields3)))) temp___1135)
  (<= temp___1135 (to_rep2
                  (last2
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__aco__math__very_longs__very_long__long_digits1
             result____split_fields3)) temp___1135) (select (elts1
                                                            (rec__aco__math__very_longs__very_long__long_digits1
                                                            result____split_fields2)) temp___1135))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
