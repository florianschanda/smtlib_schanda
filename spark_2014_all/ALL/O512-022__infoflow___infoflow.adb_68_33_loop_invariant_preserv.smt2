...
(declare-fun cache_v24 () (Array Int integer))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k 10))
  (=> (<= k i9) (= (to_rep (select cache_v22 k)) 0)))))
...
;; H
  ...
  (=> (< i9 temp___356)
  (= (select cache_v22 temp___356) (select cache_v2 temp___356))))))
  (and (<= 1 i9) (<= i9 10))))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 35, characters 0-0
  (not (= (to_rep (select cache_v24 k)) 0)))
(check-sat)
(exit)
