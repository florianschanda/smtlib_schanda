...
(declare-const temp___510 count_type)

(declare-const temp___509 count_type)

(declare-const temp___5091 us_main_type)
...
;; H
  (assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___510 cu__split_fields1)))
...
;; H
  (assert (=> (and (<= 1 i2) (<= i2 r27b)) (= temp___508 i2)))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r27b))
  (forall ((i10 Int))
  (=> (and (<= 1 i10) (<= i10 temp___512))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i10)
  (get temp___513 i10))))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields10))
     (mk___rep1 cu__split_fields10)) i3)))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 r27b))
  (and (=> (<= 1 r27b) (dynamic_property 1 r27b i3))
  (and (<= 1 i3) (<= i3 r27b)))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r27b))
  (and
  (= o1 (element (mk___rep l__split_discrs l__split_fields10)
        (mk___rep1 cu__split_fields10)))
  (and (in_range6 o1)
  (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields10))
        (get1 (positions (mk___rep l__split_discrs l__split_fields10))
        (mk___rep1 cu__split_fields10))))))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields3))
     (last1 (mk___rep l__split_discrs l__split_fields3))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields3))))
  ...
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields10))
     (positions (mk___rep l__split_discrs l__split_fields3))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields3))
     (length (mk___rep l__split_discrs l__split_fields3))) o1))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields10))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 r27b)) (= cu__split_fields5 cu__split_fields3)))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 r27b)) (= l__split_fields5 l__split_fields3)))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 r27b)) (= cu__split_fields6 cu__split_fields4)))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 r27b)) (= l__split_fields6 l__split_fields4)))
...
;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 r27b)) (= cu__split_fields7 cu__split_fields5)))

;; H
  (assert
  (=> (and (<= 1 i2) (<= i2 r27b)) (= l__split_fields7 l__split_fields5)))
...
;; H
  (assert
  (=> (not (and (<= 1 i2) (<= i2 r27b)))
  (= cu__split_fields7 cu__split_fields11)))
...
;; H
  (assert (and (= o7 (get o4 o5)) (in_range3 o7)))
