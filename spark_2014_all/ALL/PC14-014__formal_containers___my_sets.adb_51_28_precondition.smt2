...
(declare-fun m__split_fields2 () us_split_fields)
...
;; H
  (assert
  (= m__split_fields2 (mk___split_fields
                      my_sets__test_set_pos__B_1__m__assume2)))
...
;; H
  ...
  (and
  (and
  (= (oeq2 (model__ (mk___rep m__split_discrs m__split_fields3))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (length (mk___rep m__split_discrs m__split_fields3)) (length
                                                          (mk___rep
                                                          k__split_discrs
                                                          k__split_fields3))))
  (= (e_elements_included
     (elements (mk___rep m__split_discrs m__split_fields3))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
  (= (e_elements_included
     (elements (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep m__split_discrs m__split_fields3))) true)))

;; H
  (assert
  (= (oeq
     (intersection__2 (mk___rep m__split_discrs m__split_fields3)
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep m__split_discrs m__split_fields4)) (num_overlaps
                                                          (model__
                                                          (mk___rep
                                                          m__split_discrs
                                                          m__split_fields3))
                                                          ...
                                                          l__split_discrs
                                                          l__split_fields9))))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields4))
     (model__ (mk___rep m__split_discrs m__split_fields3))) true))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields4))
     (model__ (mk___rep l__split_discrs l__split_fields9))) true))
  (= (includes_intersection
     (model__ (mk___rep m__split_discrs m__split_fields4))
     (model__ (mk___rep l__split_discrs l__split_fields9))
     (model__ (mk___rep m__split_discrs m__split_fields3))) true))
  (= (e_elements_included
  ...
  (= (mapping_preserved
     (elements (mk___rep m__split_discrs m__split_fields4))
     (elements (mk___rep m__split_discrs m__split_fields3))
     (positions (mk___rep m__split_discrs m__split_fields4))
     (positions (mk___rep m__split_discrs m__split_fields3))) true)))
...
;; H
  (assert
  (= m__split_fields5 (us_split_fields1
...
;; H
  ...
  (and
  (and
  (= (oeq2 (model__ (mk___rep m__split_discrs1 m__split_fields6))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (length (mk___rep m__split_discrs1 m__split_fields6)) (length
                                                           (mk___rep
                                                           k__split_discrs
                                                           k__split_fields3))))
  (= (e_elements_included
     (elements (mk___rep m__split_discrs1 m__split_fields6))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
  (= (e_elements_included
     (elements (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep m__split_discrs1 m__split_fields6))) true)))

;; H
  (assert
  (and
  (= o (union__2 (mk___rep k__split_discrs k__split_fields3)
       (mk___rep l__split_discrs l__split_fields9)))
  (and
  (and
  (and
  ...
  (and
  (and
  (= (length o) (+ (- (length (mk___rep k__split_discrs k__split_fields3)) 
  (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3))
  (model__ (mk___rep l__split_discrs l__split_fields9)))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields9))))
  (= (ole (model__ (mk___rep k__split_discrs k__split_fields3)) (model__ o)) true))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields9)) (model__ o)) true))
  (= (included_in_union (model__ o)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields9))) true))
  (= (e_elements_included__3 (elements o)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields9))) true))
  (= (e_elements_included__2
     (elements (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep k__split_discrs k__split_fields3)) (elements o)) true))
  (= (e_elements_included__3
     (elements (mk___rep l__split_discrs l__split_fields9))
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields9)) (elements o)) true))))

(assert
;; WP_parameter_def
 ;; File "my_sets.adb", line 177, characters 0-0
  (not
  (<= (length (mk___rep m__split_discrs1 m__split_fields6)) (- 2147483647 
