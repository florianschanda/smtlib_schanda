...
(declare-fun temp___151 () (Array Int element))

(declare-fun o () element)

(declare-fun o1 () (Array Int element))

(declare-fun b1 () (Array Int element))

(declare-fun result () Int)

(declare-fun i1 () Int)

(declare-fun b2 () (Array Int element))

(declare-fun i2 () Int)

(declare-fun result1 () (Array Int element))

(declare-fun b3 () (Array Int element))

(declare-fun b4 () (Array Int element))

(declare-fun i3 () Int)

(declare-fun b5 () (Array Int element))

(declare-fun i4 () Int)

(declare-fun b6 () (Array Int element))

(declare-fun i5 () Int)

(declare-fun b7 () (Array Int element))

(declare-fun i6 () Int)

(define-fun b8 () map__ref (mk_map__ref b6))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 100))
  (=> (= (to_rep (select a i7)) (to_rep (select a j))) (= i7 j))))))
  (forall ((i7 Int))
  (=> (and (<= 1 i7) (<= i7 100))
  (not
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 100)) (not (= (to_rep (select a j)) i7)))))))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___153 i1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___151 b)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100)) (= o1 (store b2 (to_rep (select a i2)) o))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 100)) (= b8 (mk_map__ref b4))))
...
;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 100))) (= b8 (mk_map__ref b))))
...
;; WP_parameter_def
 ;; File "invertinjection.ads", line 3, characters 0-0
  (not (= (to_rep (select b6 (to_rep (select a j)))) j)))
(check-sat)
(exit)
