...
(declare-fun temp___293 () (Array Int integer))

(declare-fun temp___2931 () t1)
...
(declare-fun temp___297 () (Array Int integer))

(declare-fun o8 () (Array Int integer))

(declare-fun temp___299 () (Array Int integer))

(declare-fun temp___2991 () t2)

(declare-fun temp___300 () (Array Int integer))

(declare-fun temp___3001 () t2)
...
(declare-fun temp___301 () (Array Int integer))
...
;; H
  ...
  (forall ((e Int))
  (=> (and (<= (- 2147483648) e) (<= e 2147483647))
  (= (occ (mk___t values (mk (to_rep values__first) (to_rep values__last)))
     e) (occ
        (mk___t values3 (mk (to_rep values__first) (to_rep values__last))) e)))))))
...
;; H
  (assert (= o25 (select values3 o24)))

;; H
  (assert (= o29 (to_rep o25)))

;; H
  (assert (= result5 (ite (= o29 o28) true false)))
...
;; H
  (assert (= result6 (ite (= o23 o22) true false)))

;; H
  (assert (= result6 true))

;; H
  (assert (<= (to_rep values__first) z))

;; H
  (assert (<= z (to_rep values__last)))
...
;; H
  (assert (and (<= (to_rep values__first) z) (<= z (to_rep values__last))))

;; H
  (assert (= o15 z))

;; H
  (assert (= o16 (select values o15)))
