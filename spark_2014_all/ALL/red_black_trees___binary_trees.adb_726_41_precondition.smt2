...
;; H
  (assert (= o72 (select temp___1667 o71)))
...
;; H
  (assert (= o68 (select temp___1637 i)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1636 o64))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1636 o64)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o64))
...
;; H
  (assert (= o65 (select temp___1636 i)))
