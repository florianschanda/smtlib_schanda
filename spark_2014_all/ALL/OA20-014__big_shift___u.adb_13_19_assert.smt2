...
(define-fun dynamic_invariant ((temp___expr_159 (_ BitVec 8))
...
;; WP_parameter_def
 ;; File "u.adb", line 3, characters 0-0
  (not
  (= (ite (< 256 8) (bvshl ((_ int2bv 8) 10) ((_ int2bv 8) 256))
