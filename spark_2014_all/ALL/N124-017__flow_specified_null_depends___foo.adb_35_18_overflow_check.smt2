...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__foo__r__x integer)))))
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep (rec__foo__r__x (us_split_fields1 a)))
                   (to_rep (rec__foo__r__x (us_split_fields1 b)))) true
                   false))
...
;; WP_parameter_def
 ;; File "foo.adb", line 19, characters 0-0
  (not (in_range (+ (to_rep g__split_fields) 1))))
(check-sat)
(exit)
