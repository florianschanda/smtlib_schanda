...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__inst_ext_ax__ok_lists1__list__capacity count_type)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) count_type
  (rec__inst_ext_ax__ok_lists1__list__capacity a))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__inst_ext_ax__ok_lists1__list us_main_type)))))
(define-fun us_split_fields_List__projection ((a us_split_fields)) us_main_type
  (rec__inst_ext_ax__ok_lists1__list a))
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep
                           (rec__inst_ext_ax__ok_lists1__list__capacity
                           (us_split_discrs1 a))) (to_rep
                                                  (rec__inst_ext_ax__ok_lists1__list__capacity
                                                  (us_split_discrs1 b))))
                        (= (us_main_eq
                           (rec__inst_ext_ax__ok_lists1__list
                           (us_split_fields1 a))
                           (rec__inst_ext_ax__ok_lists1__list
...
;; inst_ext_ax__ok_lists1__list__capacity__first__bit_axiom
  (assert (<= 0 inst_ext_ax__ok_lists1__list__capacity__first__bit))

;; inst_ext_ax__ok_lists1__list__capacity__last__bit_axiom
  (assert
  (< inst_ext_ax__ok_lists1__list__capacity__first__bit inst_ext_ax__ok_lists1__list__capacity__last__bit))

;; inst_ext_ax__ok_lists1__list__capacity__position_axiom
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__inst_ext_ax__ok_lists1__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type
  (rec__inst_ext_ax__ok_lists1__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__inst_ext_ax__ok_lists1__cursor__node
...
;; inst_ext_ax__ok_lists1__cursor__node__first__bit_axiom
  (assert (<= 0 inst_ext_ax__ok_lists1__cursor__node__first__bit))

;; inst_ext_ax__ok_lists1__cursor__node__last__bit_axiom
  (assert
  (< inst_ext_ax__ok_lists1__cursor__node__first__bit inst_ext_ax__ok_lists1__cursor__node__last__bit))

;; inst_ext_ax__ok_lists1__cursor__node__position_axiom
...
(declare-const temp___622 count_type)
...
;; H
  (assert (= temp___622 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___622)) no_element))
