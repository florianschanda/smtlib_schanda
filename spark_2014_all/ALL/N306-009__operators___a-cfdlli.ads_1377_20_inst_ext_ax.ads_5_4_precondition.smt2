...
(declare-fun inst_ext_ax__ok_lists1__list__capacity__first__bit () Int)

(declare-fun inst_ext_ax__ok_lists1__list__capacity__last__bit () Int)

(declare-fun inst_ext_ax__ok_lists1__list__capacity__position () Int)
...
(declare-fun inst_ext_ax__ok_lists1__cursor__node__first__bit () Int)

(declare-fun inst_ext_ax__ok_lists1__cursor__node__last__bit () Int)

(declare-fun inst_ext_ax__ok_lists1__cursor__node__position () Int)
...
(declare-fun temp___622 () count_type)
