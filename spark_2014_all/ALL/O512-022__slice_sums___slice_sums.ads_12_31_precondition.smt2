...
(declare-const o13 slice_bounds)
...
;; H
  ...
  (and (<= (to_rep3 (first (rt x))) lo2) (<= lo2 (to_rep3 (last (rt x)))))
  (forall ((lo_index Int))
  (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- lo3 1)))
  (forall ((hi_index Int))
  (=>
...
;; H
  ...
  lo3))) (=> (<= 0 2147483647) (in_range2 max_sum2)))
  (and (<= (to_rep3 (first (rt x))) lo3) (<= lo3 (to_rep3 (last (rt x))))))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) lo2) (<= lo2 (to_rep3 (last (rt x)))))
  (= result3 (mk_int__ref hi3))))

;; H
  (assert
  (=>
  (and (<= (to_rep3 (first (rt x))) lo2) (<= lo2 (to_rep3 (last (rt x)))))
  (= hi4 (to_rep3 (first (rt x))))))
...
;; H
  ...
  (forall ((hi_index Int))
  (=> (and (<= (to_rep3 (first (rt x))) hi_index) (<= hi_index (- hi5 1)))
  (<= (sum__logic x
      (mk_slice_bounds (mk___split_fields (of_rep lo3) (of_rep1 hi_index))))
  max_sum3)))))))
...
;; H
  ...
  hi5))) (=> (<= 0 2147483647) (in_range2 max_sum3)))
  (and (<= (to_rep3 (first (rt x))) hi5) (<= hi5 (to_rep3 (last (rt x)))))))))
...
;; H
  (assert (= (to_rep1 o10) hi1))

;; H
  (assert (= (to_rep o11) lo1))

;; H
  (assert (= o12 (mk___split_fields o11 o10)))

;; H
  (assert (= o13 (mk_slice_bounds o12)))

;; H
  (assert (= o14 (sum__logic x o13)))
