...
(declare-fun temp___281 () index)

(declare-fun temp___2811 () (Array Int value))

(declare-fun temp___2812 () (Array Int value))
...
(declare-fun temp___284 () index)

(declare-fun temp___2841 () (Array Int value))

(declare-fun temp___2842 () (Array Int value))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 133, characters 0-0
  (not (not (= (to_rep (select a__split_fields10 i)) 23))))
(check-sat)
(exit)
