...
(declare-fun new_value () t)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun prior_value () t)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun smoothing_factor () t)
...
(declare-fun smoothed_value () t)

(declare-fun abs_delta_out1 () t)

(declare-fun compare_to_zero_out1 () Bool)

(declare-fun smoother_value_out1 () t)

(declare-fun abs_new_delta_out1 () t)
...
;; H
  (assert (tqtisFinite new_value))

;; H
  (assert (tqtisFinite prior_value))

;; H
  (assert (tqtisFinite smoothing_factor))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite smoothed_value)))

;; H
  (assert
  (and (lt fliteral smoothing_factor)
  (and (le fliteral2 new_value) (le fliteral2 prior_value))))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite abs_delta_out1)))

;; H
  (assert
  (=> (le (neg fliteral1) fliteral1) (tqtisFinite smoother_value_out1)))

;; H
  (assert
  (=> (le (neg fliteral1) fliteral1) (tqtisFinite abs_new_delta_out1)))

;; H
  (assert
  (and (= o (sub RNE1 new_value prior_value)) (tqtisFinite
  (sub RNE1 new_value prior_value))))
...
;; H
  (assert
  (= compare_to_zero_out11 (ite (eq abs_delta_out11 fliteral2) true false)))

;; H
  (assert (lt fliteral smoothing_factor))

;; H
  (assert (neq smoothing_factor fliteral2))

;; H
  (assert
  (and (= o2 (sub RNE1 new_value prior_value)) (tqtisFinite
  (sub RNE1 new_value prior_value))))

;; H
  (assert (= o3 (div1 RNE1 o2 smoothing_factor)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (add RNE1 prior_value o4)))
