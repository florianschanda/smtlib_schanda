...
(define-fun dynamic_invariant7 ((temp___expr_173 Int)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (= (= k1 key2) (= (witness1 container key2) (witness1 container k1)))))))
     (dynamic_invariant8 result true false true)))) :pattern ((get2 container
                                                              key2)) ))))

;; length__post_axiom
  (assert
  (forall ((container us_rep2)) (! (dynamic_invariant7 (length container)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep4)) (! (dynamic_invariant7 (length2 container)
...
(declare-const use_maps__my_find__result us_rep1)

(declare-const temp___746 Int)

(declare-const result2 int__ref)

(declare-const temp___7461 Int)

(declare-const result3 Bool)

(declare-const use_maps__my_find__result1 us_rep1)
...
(define-fun temp___7441 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___744)))

(define-fun use_maps__my_find__cu__assume1 () us_rep1 (mk___rep1
                                                      (mk___split_fields1
                                                      use_maps__my_find__cu__assume)))
...
;; H
  (assert
  (and (= use_maps__my_find__cu__assume1 (first s))
  (ite (= (= (length3 s) 0) true)
  (= (bool_eq1 use_maps__my_find__cu__assume1 no_element) true)
  (and (= (has_key1 (positions s) use_maps__my_find__cu__assume1) true)
  (= (get1 (positions s) use_maps__my_find__cu__assume1) 1)))))
...
;; H
  (assert (= result2 (mk_int__ref temp___746)))

;; H
  (assert (= temp___7461 (get1 (positions s) (mk___rep1 cu__split_fields4))))

;; H
  (assert
  (and (= o2 (key s (mk___rep1 cu__split_fields4)))
  (and (in_range7 o2)
  (= o2 (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields4)))))))
...
;; H
  (assert (= use_maps__my_find__result1 use_maps__my_find__result))

;; H
  (assert
  (and (= temp___7441 (next s (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq1 temp___7441 no_element) true)
  (and (= (has_key1 (positions s) temp___7441) true)
  (= (get1 (positions s) temp___7441) (+ (get1 (positions s)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___744)))
...
(assert
;; WP_parameter_def
 ;; File "a-cfhama.ads", line 78, characters 0-0
