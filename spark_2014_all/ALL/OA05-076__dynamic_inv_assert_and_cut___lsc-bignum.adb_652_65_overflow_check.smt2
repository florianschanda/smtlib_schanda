...
;; H
  (assert (= o47 (ite (<= s10 o46) true false)))

;; H
  (assert (= o42 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o43 (oexpon o42 s10)))
...
;; H
  (assert (= o28 (from_word32 (t__content w7))))

;; H
  (assert (= o45 (oeq o28 o44)))

;; H
  (assert (and (= o23 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o26 (ite (<= n o25) true false)))

;; H
  (assert (= result8 (ite (<= 0 n) o26 false)))
...
;; H
  (assert (= o17 (oexpon o16 h9)))

;; H
  (assert (= o13 (from_word32 ((_ int2bv 32) 1))))
