...
(define-fun bool_eq3 ((a (Array Int us_rep2)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq2 (select a temp___idx_139)
...
;; inversion_axiom
  (assert
  (forall ((x it4)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)) )))

;; range_axiom
  (assert
  (forall ((x it4)) (! (in_range (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(declare-datatypes ((rofaofr2__ref 0))
(((mk_rofaofr2__ref (rofaofr2__content us_rep3)))))
...
(declare-fun temp___4068 ((Array Int us_rep2) Int
  us_rep2) (Array Int us_rep2))

;; def_axiom
  (assert
  (forall ((temp___4070 (Array Int us_rep2)))
  (forall ((temp___4071 Int))
  (forall ((temp___4072 us_rep2))
  (let ((temp___4069 (temp___4068 temp___4070 temp___4071 temp___4072)))
  (forall ((temp___4073 Int))
  (ite (= temp___4073 temp___4071)
  (= (select temp___4069 temp___4073) temp___4072)
  (= (select temp___4069 temp___4073) (select temp___4070 temp___4073)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1812, characters 0-0
  (not
  (= (bool_eq4 (mk___rep3 (us_split_fields__content3 r__split_fields3))
     (mk___rep3
     (mk___split_fields3 r__split_fields
     (temp___4068 r__split_fields1 i
     (mk___rep2
