...
;; H
  ...
  (= (is_prepend
     (rec__list_mod_allocator__m__t__available
     (us_split_fields3
     (model__ (map__content data5) (int__content first_available5))))
     (int__content res5)
     (rec__list_mod_allocator__m__t__available
     (us_split_fields3 (model__ data first_available)))) true)
  (= (is_add
     (rec__list_mod_allocator__m__t__allocated
     (us_split_fields3 (model__ data first_available))) (int__content res5)
     (rec__list_mod_allocator__m__t__allocated
     (us_split_fields3
     (model__ (map__content data5) (int__content first_available5))))) true))))

(assert
;; WP_parameter_def
 ;; File "list_mod_allocator.adb", line 143, characters 0-0
  (not
  (= (is_valid (map__content data5) (int__content first_available5)) true)))
(check-sat)
(exit)
