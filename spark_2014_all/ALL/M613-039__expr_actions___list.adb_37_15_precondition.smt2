...
(define-fun bool_eq5 ((x us_t2)
  (y us_t2)) Bool (bool_eq (elts2 x) (to_rep (first5 (rt2 x)))
...
;; H
  ...
  (= (let ((temp___185 (to__ (mk___rep s__split_fields9))))
     ...
     (bool_eq (elts temp___184) (to_rep (first (rt temp___184)))
...
;; H
  ...
  i9))
  (= (bool_eq (elts (to__ (mk___rep s__split_fields10)))
...
;; H
  (assert (and (= o14 (- last3 i9)) (in_range1 (- last3 i9))))

;; H
  (assert
  (and (= o13 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1
  o13 true false true)))

;; H
  (assert (= o15 (to_rep (last (rt o13)))))

;; H
  (assert (= result4 (ite (= o15 o14) true false)))
...
;; H
  (assert (=> (= result4 true) (= o11 (elts list__reverse_list__L_2__R20b))))

;; H
  (assert
  (=> (= result4 true) (= temp___472 (mk___t2 o11 (mk2 first2 temp___470)))))
...
;; H
  (assert (=> (= result4 true) (= o12 (elts list__reverse_list__L_2__R16b))))

;; H
  (assert
  (=> (= result4 true) (= temp___471 (mk___t1 o12 (mk1 first2 temp___469)))))

;; H
  (assert
  (=> (= result4 true)
  (= result3 (bool_eq (elts1 temp___471) (to_rep (first3 (rt1 temp___471)))
...
;; H
  (assert
  (and (= o10 (get (model__ l) o9))
  (and (in_range7 o10) (= o10 (get (model__ l) o9)))))
