...
(declare-fun records__update_a__result () Bool)

(declare-fun records__update_a__result1 () unsigned_byte)

(declare-fun records__update_a__result2 () unsigned_byte)
...
(declare-fun temp___381 () Bool)

(declare-fun temp___3811 () unsigned_byte)

(declare-fun temp___3812 () unsigned_byte)
...
(declare-fun records__update_a__result3 () us_rep1)

(declare-fun records__update_a__result4 () optional_pair__ref)

(declare-fun records__update_a__result5 () us_rep1)

(declare-fun tmp__split_fields5 () us_split_fields__ref1)

(declare-fun records__update_a__result6 () optional_pair__ref)

(declare-fun tmp__split_fields6 () us_split_fields2)

(declare-fun records__update_a__result7 () us_rep1)
...
;; H
  (assert
  (= tmp__split_fields4 (mk___split_fields1 temp___381
                        (mk___rep
                        (mk___split_fields temp___3811 temp___3812)))))

;; H
  (assert
  (= records__update_a__result4 (mk_optional_pair__ref
                                records__update_a__result3)))
...
;; H
  ...
  (= result4 (mk_optional_pair__ref
             (mk___rep1
             (mk___split_fields1 records__update_a__result
             (mk___rep
             (mk___split_fields records__update_a__result1
             records__update_a__result2)))))))
...
;; H
  ...
  (= (mk___rep1
     ...
     (mk___rep (mk___split_fields result6 result7)))) (optional_pair__content
                                                      records__update_a__result6)))

(assert
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 19, characters 0-0
  (not
  (= (bool_eq2 (optional_pair__content records__update_a__result6)
     (mk___rep1
     (mk___split_fields1
