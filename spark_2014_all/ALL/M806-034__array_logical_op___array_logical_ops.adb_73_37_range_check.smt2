...
(((mk_only_true__ref (only_true__content only_true)))))
...
(((mk_map__ref (map__content (Array Int only_true))))))
...
(((mk___t (elts (Array Int only_true))(rt t)))))
...
(((mk_true_array__ref (true_array__content us_t)))))
...
(declare-datatypes ((t46b__ref 0)) (((mk_t46b__ref (t46b__content t46b)))))
...
;; def_axiom
  ...
  (= (select (array_logical_ops__failing_content_check__w__aggregate_def
             temp___183) temp___184) (of_rep temp___183)))))
...
;; def_axiom
  ...
  (= (select (array_logical_ops__failing_content_check__v__aggregate_def
             temp___186) temp___187) (of_rep temp___186)))))
...
;; H
  (assert
  (= (mk___t (array_logical_ops__failing_content_check__w__aggregate_def 1)
     (mk 1 20)) w))
...
;; H
  (assert
  (= (mk___t (array_logical_ops__failing_content_check__v__aggregate_def 1)
     (mk 6 25)) v))
...
(assert
;; WP_parameter_def
 ;; File "array_logical_ops.adb", line 63, characters 0-0
  (not
  (not
