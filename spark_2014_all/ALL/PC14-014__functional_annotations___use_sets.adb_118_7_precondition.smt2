...
(define-fun s__split_fields5 () us_split_fields (mk___split_fields
                                                s__split_fields2))
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields6)) 1) true)
  (= (element (mk___rep s__split_discrs s__split_fields6)
     (find1 (mk___rep s__split_discrs s__split_fields6) 1)) 1))
  (ite (= (contains
          (model__
  ...
  (= (equal_except
     ...
     (find1 (mk___rep s__split_discrs s__split_fields6) 1))) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields5)) 2) true)
  (= (element (mk___rep s__split_discrs s__split_fields5)
     (find1 (mk___rep s__split_discrs s__split_fields5) 2)) 2))
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields6)) 2) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields5))
     (model__ (mk___rep s__split_discrs s__split_fields6))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields5))
     (positions (mk___rep s__split_discrs s__split_fields6))) true))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields6))
     (elements (mk___rep s__split_discrs s__split_fields5))
     (get1 (positions (mk___rep s__split_discrs s__split_fields5))
     (find1 (mk___rep s__split_discrs s__split_fields5) 2))) true))
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields5)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields6)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields6))
     (model__ (mk___rep s__split_discrs s__split_fields5))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields5))
     (model__ (mk___rep s__split_discrs s__split_fields6)) 2) true))
  (= (mapping_preserved
     (elements (mk___rep s__split_discrs s__split_fields6))
     (elements (mk___rep s__split_discrs s__split_fields5))
     (positions (mk___rep s__split_discrs s__split_fields6))
     (positions (mk___rep s__split_discrs s__split_fields5))) true))
  (= (keys_included_except
     (positions (mk___rep s__split_discrs s__split_fields5))
     (positions (mk___rep s__split_discrs s__split_fields6))
     (find1 (mk___rep s__split_discrs s__split_fields5) 2)) true)))))
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields4)) 3) true)
  (= (element (mk___rep s__split_discrs s__split_fields4)
     (find1 (mk___rep s__split_discrs s__split_fields4) 3)) 3))
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields5)) 3) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields4))
     (model__ (mk___rep s__split_discrs s__split_fields5))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields4))
     (positions (mk___rep s__split_discrs s__split_fields5))) true))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields5))
     (elements (mk___rep s__split_discrs s__split_fields4))
     (get1 (positions (mk___rep s__split_discrs s__split_fields4))
     (find1 (mk___rep s__split_discrs s__split_fields4) 3))) true))
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields4)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields5)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields5))
     (model__ (mk___rep s__split_discrs s__split_fields4))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields4))
     (model__ (mk___rep s__split_discrs s__split_fields5)) 3) true))
  (= (mapping_preserved
     (elements (mk___rep s__split_discrs s__split_fields5))
     (elements (mk___rep s__split_discrs s__split_fields4))
     (positions (mk___rep s__split_discrs s__split_fields5))
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 60, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields4)) (to_rep1
                                                          (rec__use_sets__my_sets__set__capacity
                                                          s__split_discrs)))
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields4)) 4) true))))
(check-sat)
(exit)
