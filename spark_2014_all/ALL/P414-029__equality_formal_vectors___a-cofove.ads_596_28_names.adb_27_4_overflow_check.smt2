...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__names__char_tables__vector us_main_type)))))
...
(declare-fun user_eq4 (tchar_table_indexB tchar_table_indexB) Bool)

(declare-fun dummy4 () tchar_table_indexB)
...
(define-fun in_range7 ((x Int)) Bool (and (<= (- 1) x) (<= x 2147483646)))
...
(declare-fun dummy8 () extended_index1)
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant result true
...
;; H
  (assert (and (= o2 (- index 0)) (in_range4 (- index 0))))
