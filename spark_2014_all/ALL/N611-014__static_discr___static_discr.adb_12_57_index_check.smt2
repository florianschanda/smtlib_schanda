...
(((mk_tT8sP1__ref (tT8sP1__content tT8sP1)))))
...
(declare-datatypes ((t7s__ref 0)) (((mk_t7s__ref (t7s__content us_rep3)))))
...
(((mk_holder_max__ref (holder_max__content us_rep4)))))
...
(declare-const temp___373 natural)

(declare-const temp___3731 natural)

(declare-const temp___3732 natural)

(declare-const temp___3733 natural)

(declare-const temp___3734 (Array Int natural))

(declare-const temp___3735 natural)
