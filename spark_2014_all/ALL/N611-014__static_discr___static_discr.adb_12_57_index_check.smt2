...
(declare-fun dummy9 () tT8sP1)

(declare-datatypes ()
((tT8sP1__ref (mk_tT8sP1__ref (tT8sP1__content tT8sP1)))))
(define-fun tT8sP1__ref___projection ((a tT8sP1__ref)) tT8sP1 (tT8sP1__content
                                                              a))
...
(define-fun us_split_fields_Content4__projection ((a us_split_fields6)) (Array Int natural)
...
(define-fun us_rep_7__projection ((a us_rep3)) us_split_discrs (us_split_discrs5
                                                               a))
...
(define-fun of_base1 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r)
                                          (mk___split_fields3
                                          (let ((temp___135 (rec__static_discr__i_holder__content
                                                            (us_split_fields1
                                                            r))))
                                          (to_array temp___135)))))
...
(define-fun us_split_fields_Content5__projection ((a us_split_fields8)) us_rep3
  (rec__static_discr__holder__content1 a))

(define-fun us_split_fields_Length2__projection ((a us_split_fields8)) natural
...
(define-fun us_rep_9__projection ((a us_rep4)) us_split_discrs3 (us_split_discrs6
                                                                a))
...
(declare-datatypes ()
((holder_max__ref (mk_holder_max__ref (holder_max__content us_rep4)))))
(define-fun holder_max__ref___projection ((a holder_max__ref)) us_rep4
  (holder_max__content a))

(define-fun dynamic_invariant1 ((temp___expr_176 us_rep4)
  (temp___is_init_173 Bool) (temp___skip_constant_174 Bool)
  (temp___do_toplevel_175 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_174 true))
                                      (in_range6 100 100
                                      (to_base2 temp___expr_176))) (in_range5
                                      100 100
                                      (to_base1
                                      (rec__static_discr__holder__content1
                                      (us_split_fields9 temp___expr_176))))))

(define-fun default_initial_assumption ((temp___expr_182 us_rep4)
...
(define-fun dynamic_invariant4 ((temp___expr_167 us_rep2)
...
(declare-fun current__split_fields3 () natural)
...
(declare-fun temp___373 () natural)

(declare-fun temp___3731 () natural)

(declare-fun temp___3732 () natural)

(declare-fun temp___3733 () natural)

(declare-fun temp___3734 () (Array Int natural))

(declare-fun temp___3735 () natural)
...
(declare-fun current__split_fields4 () us_split_fields8)

(declare-fun current__split_fields5 () us_split_fields__ref4)
...
;; H
  ...
  (and
  (and
  (= 100 (to_rep (rec__static_discr__holder__unused current__split_discrs)))
  (= 100 (to_rep (rec__static_discr__holder__c current__split_discrs))))
  (and (= 100 (to_rep current__split_fields))
  (= 100 (to_rep current__split_fields1)))))
...
;; H
  (assert
  (and (<= 1 (to_rep current__split_fields3))
  (<= (to_rep current__split_fields3) (to_rep
                                      (rec__static_discr__holder__c
...
;; H
  (assert
  (and (<= 1 (to_rep current__split_fields3))
  (<= (to_rep current__split_fields3) 100)))
...
;; H
  (assert
  (and (= o3 (- (to_rep current__split_fields3) 1)) (in_range2
  (- (to_rep current__split_fields3) 1))))
...
;; H
  (assert
  (= current__split_discrs (mk___split_discrs1 temp___373 temp___3731)))

;; H
  (assert (= temp___3732 o5))

;; H
  (assert (= temp___3733 o6))

;; H
  (assert (= temp___3734 o7))

;; H
  (assert (= temp___3735 o8))

;; H
  (assert
  (= (mk___split_fields__ref4
     (mk___split_fields4
     (mk___rep3 (mk___split_discrs result3 result4)
     (mk___split_fields3 result5)) result6)) (mk___split_fields__ref4
                                             (mk___split_fields4
                                             (mk___rep3
                                             (mk___split_discrs
...
;; H
  (assert
  (= current__split_fields4 (mk___split_fields4
                            (mk___rep3
                            (mk___split_discrs temp___3732 temp___3733)
                            (mk___split_fields3 temp___3734)) temp___3735)))
...
;; H
  (assert
  (= current__split_fields5 (mk___split_fields__ref4 current__split_fields4)))
...
;; H
  ...
  (= (bool_eq
     ...
     (us_split_fields7
     (rec__static_discr__holder__content1
     (us_split_fields__content4 current__split_fields5)))) 1 100
     current__split_fields2 1 100) true))

;; H
  (assert
  (< (to_rep
     (rec__static_discr__holder__length1
     (us_split_fields__content4 current__split_fields5))) (to_rep
                                                          current__split_fields3)))
...
;; H
  ...
  (= o9 (+ (to_rep
           (rec__static_discr__holder__length1
           (us_split_fields__content4 current__split_fields5))) 1))
  (in_range1
  (+ (to_rep
     (rec__static_discr__holder__length1
     (us_split_fields__content4 current__split_fields5))) 1))))
...
;; H
  (assert
  (= result7 (ite (= o10 true) (ite (<= i (to_rep current__split_fields3))
                               true false) false)))
