...
;; key__post_axiom
  (assert
  (forall ((i Int))
  (! (=> (dynamic_invariant i true true true) (dynamic_invariant2 (key i)
...
(define-fun dynamic_invariant3 ((temp___expr_655 Int)
...
;; length__post__dispatch_axiom
  ...
  (forall ((container1 us_rep)) (! (dynamic_invariant5
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant6 item true true true)
     ...
     (= (my_eq item (get container1 result)) true))) (dynamic_invariant5
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (= (contains (model__ container1) (get result temp___429)) true))))
     (forall ((item Int))
     (=> (and (in_range3 item) (= (contains (model__ container1) item) true))
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep1)) (! (dynamic_invariant5 (length2 container1)
