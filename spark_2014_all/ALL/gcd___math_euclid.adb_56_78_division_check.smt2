...
;; H
  (assert
  (=> (= result8 true) (and (= o1 (mod2 a b)) (in_range1 (mod2 a b)))))

;; H
  (assert
  (=> (= result8 true)
  (and (= result7 (divides x1 o1)) (= (= result7 true) (= (mod2 o1 x1) 0)))))
...
;; H
  (assert
  (=> (= result7 true)
  (and (= result6 (divides x1 b)) (= (= result6 true) (= (mod2 b x1) 0)))))
...
;; H
  ...
  (forall ((y1 Int))
  (=> (and (<= 1 y1) (<= y1 x2))
  (= (and (= (divides y1 a) true) (= (divides y1 b) true))
  (and (= (divides y1 b) true)
  (or (= (divides b a) true) (= (divides y1 (mod2 a b)) true)))))))

;; H
  (assert
  (and (=> (<= 1 2147483647) (in_range1 x2))
  (and (<= 1 x2) (<= x2 2147483647))))
...
;; H
  (assert
  (and (= result9 (divides y b)) (= (= result9 true) (= (mod2 b y) 0))))
...
;; H
  (assert
  (and (= result10 (divides b a)) (= (= result10 true) (= (mod2 a b) 0))))
