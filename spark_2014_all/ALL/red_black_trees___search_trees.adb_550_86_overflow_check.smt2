...
;; H
  (assert (= o31 (select temp___1741 i)))
...
;; H
  (assert (=> (= result5 true) (= o29 (select temp___1742 j))))
...
;; H
  (assert (=> (= result4 true) (= o26 (select temp___1744 j))))
...
;; H
  (assert (=> (= result4 true) (= o23 (select temp___1743 i))))
...
;; H
  (assert (= o18 (select temp___1748 i)))
