...
(declare-datatypes ((tvar_outS__ref 0))
(((mk_tvar_outS__ref (tvar_outS__content tvar_outS)))))
...
(declare-datatypes ((taS__ref 0)) (((mk_taS__ref (taS__content taS)))))
...
(declare-datatypes ((tbS__ref 0)) (((mk_tbS__ref (tbS__content tbS)))))
...
(((mk_map__ref1 (map__content1 (Array Int float))))))
...
(declare-datatypes ((tmy_array1D1__ref 0))
...
(((mk_map__ref2 (map__content2 (Array Int integer))))))
...
(declare-datatypes ((tmy_array2D1__ref 0))
