...
(declare-fun o14 () lane_type)

(declare-fun o15 () map1)
...
;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= temp___715 lane3))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (<= 0 i4) (<= i4 7)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (= o8 (* i4 8)) (in_range1 (* i4 8))))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (= o9 o8) (in_range2 o8)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o10 ((_ int2bv 64) o9)))))
...
;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o4 (+ o3 i4)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (and (= temp___714 o4) (in_range1 o4)))))
...
;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o5 temp___714))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o6 (select (elts data) o5)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o7 (to_rep o6)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o11 ((_ zero_extend 56) o7)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o12 (bvshl o11 o10)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= o13 (bvor lane4 o12)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= result9 (mk_t__ref1 lane4)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= lane5 o13))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= i4 7))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= i5 (mk_int__ref i4)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (and (<= 0 i3) (<= i3 7)) (= lane6 (mk_t__ref1 lane5)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= i6 i4))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= lane7 lane5))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= i7 i5))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= lane8 lane6))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= i8 i6))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (and (<= 0 i3) (<= i3 7)) (= lane9 lane7))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (and (<= 0 i3) (<= i3 7))) (= i7 (mk_int__ref i3)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (and (<= 0 i3) (<= i3 7))) (= lane8 (mk_t__ref1 lane3)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (not (and (<= 0 i3) (<= i3 7))) (= i8 i3))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (and (<= 0 i3) (<= i3 7))) (= lane9 lane3))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (= (to_rep2 o14) (bvxor (to_rep2 (get a2 x2 y2)) (t__content1 lane8)))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= o15 (set a2 x2 y2 o14))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= result10 (mk_map__ref1 a2))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= a3 o15)))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1))
  (= o16 (bvsub (bvadd x2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1)))
  (= o16 (bvadd x2 ((_ int2bv 8) 1))))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= result11 (mk_t__ref x2))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= x3 o16)))
...
;; H
  ...
  (= o17 (bvsub (bvadd y2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5)))))))
...
;; H
  ...
  (= o17 (bvadd y2 ((_ int2bv 8) 1)))))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (= x3 ((_ int2bv 8) 0)) (= result12 (mk_t__ref y2)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (= x3 ((_ int2bv 8) 0)) (= y3 o17))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (= x3 ((_ int2bv 8) 0)) (= y4 (mk_t__ref y3)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (= x3 ((_ int2bv 8) 0)) (= y5 y3))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (=> (not (= x3 ((_ int2bv 8) 0))) (= y4 (mk_t__ref y2)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (=> (not (= x3 ((_ int2bv 8) 0))) (= y5 y2))))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (and (= o18 (+ offset2 8)) (in_range1 (+ offset2 8)))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= result13 (mk_int__ref offset2))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= offset3 o18)))

;; H
  (assert
  (=> (<= 64 remaining_bits1)
  (and (= o19 (- remaining_bits2 64)) (in_range2 (- remaining_bits2 64)))))

;; H
  (assert
  (=> (<= 64 remaining_bits1) (= result14 (mk_int__ref remaining_bits2))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= remaining_bits3 o19)))

;; H
  (assert (=> (<= 64 remaining_bits1) (not (<= 64 remaining_bits3))))

;; H
  (assert (=> (<= 64 remaining_bits1) (= i9 i7)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= lane10 lane8)))
...
;; H
  (assert (=> (<= 64 remaining_bits1) (= i10 i8)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= lane11 lane9)))
...
;; H
  (assert (=> (<= 64 remaining_bits1) (= i11 i9)))

;; H
  (assert (=> (<= 64 remaining_bits1) (= lane12 lane10)))
...
;; H
  (assert (=> (not (<= 64 remaining_bits1)) (= i11 (mk_int__ref i))))

;; H
  (assert (=> (not (<= 64 remaining_bits1)) (= lane12 (mk_t__ref1 lane))))
...
;; H
  (assert (=> (not (<= 64 remaining_bits1)) (= i12 i1)))

;; H
  (assert (=> (not (<= 64 remaining_bits1)) (= lane13 lane1)))
...
;; H
  (assert (= result15 (mk_t__ref1 word)))
...
;; H
  (assert
  (and (= o20 (+ (int__content remaining_bits6) 7)) (in_range1
  (+ (int__content remaining_bits6) 7))))

;; H
  (assert (= o21 (div1 o20 8)))
