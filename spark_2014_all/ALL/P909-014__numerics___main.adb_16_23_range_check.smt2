...
(define-fun dynamic_invariant ((temp___expr_520 t) (temp___is_init_517 Bool)
  (temp___skip_constant_518 Bool)
  (temp___do_toplevel_519 Bool)) Bool (=>
                                      (or (= temp___is_init_517 true) (le
                                      (neg fliteral1) fliteral1))
                                      (tqtisFinite temp___expr_520)))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite x21)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite x22)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite x23)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite x24)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite x25)))

;; H
  (assert
  (and
  (and (and (and (tqtisFinite x211) (tqtisFinite x221)) (tqtisFinite x231))
  (tqtisFinite x241)) (tqtisFinite x251)))
