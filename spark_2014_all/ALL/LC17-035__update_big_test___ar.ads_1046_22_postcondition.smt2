...
;; range_axiom
  (assert
  (forall ((x enum1t)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun bool_eq9 ((a us_rep3)
  (b us_rep3)) Bool (ite (and
                         ...
                         (to_rep2 (rec__ar__rec4t__g4 (us_split_fields7 b)))))
                    true false))
...
(declare-fun temp___7137 () us_rep3)
...
(declare-fun temp___7142 () us_rep3)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1039, characters 0-0
  (not
  (= (bool_eq8
     (rec__ar__rec4t__f4 (us_split_fields__content3 r__split_fields8))
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1 r__split_fields
     (mk___rep (mk___split_fields (of_rep e) (of_rep1 f))) r__split_fields3))
