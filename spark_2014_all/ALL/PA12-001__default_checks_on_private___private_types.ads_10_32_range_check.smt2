...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__private_types__p1__t__d Bool)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) Bool (rec__private_types__p1__t__d
                                                                    a))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__private_types__p1__t__f positive)))))
...
(define-fun private_types__p1__t__f__pred ((a us_rep)) Bool (= (to_int1
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (rec__private_types__p1__t__d
                           (us_split_discrs1 a)) (rec__private_types__p1__t__d
                                                 (us_split_discrs1 b)))
...
(declare-fun private_types__p1__t__d__first__bit () Int)

(declare-fun private_types__p1__t__d__last__bit () Int)

(declare-fun private_types__p1__t__d__position () Int)
...
(declare-fun private_types__p1__t__f__first__bit () Int)

(declare-fun private_types__p1__t__f__last__bit () Int)

(declare-fun private_types__p1__t__f__position () Int)
