...
;; H
  (assert
  (and (= result1 (has_key (positions l) (mk___rep1 cu__split_fields4)))
  (= (= result1 true)
  (= (has_key (positions l) (mk___rep1 cu__split_fields4)) true))))
...
;; H
  (assert (<= i (- (get1 (positions l) (mk___rep1 cu__split_fields3)) 1)))
