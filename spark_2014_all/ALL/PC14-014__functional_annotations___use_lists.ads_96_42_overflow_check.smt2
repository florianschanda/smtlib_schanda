...
;; H
  ...
  (and (not (= (has_key o21 no_element) true))
  (forall ((i3 us_rep1))
  (=> (= (has_key o21 i3) true)
  (and
  (and (<= 1 (get1 o21 i3))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o21 j) true)
  (=> (= (get1 o21 i3) (get1 o21 j)) (= (bool_eq1 i3 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o25)
  (=> (= (of_int 0) true)
  (and (= o25 (w_get o21 (witness o21 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o21 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o21 cu) (witness o21 k))))))))))
...
;; H
  ...
  (= o19 (positions
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (not (= (has_key o19 no_element) true))
  (forall ((i3 us_rep1))
  (=> (= (has_key o19 i3) true)
  (and
  (and (<= 1 (get1 o19 i3))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o19 j) true)
  (=> (= (get1 o19 i3) (get1 o19 j)) (= (bool_eq1 i3 j) true))))))))))

;; H
  (assert
  (and (= o20 (has_key o19 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o19 k) true) (= (bool_eq1 k cu) true))) (= o20 true)))))
...
;; H
  ...
  (= o15 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o15)
  (<= o15 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not (in_range1
  (+ (length (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 7))))
(check-sat)
(exit)
