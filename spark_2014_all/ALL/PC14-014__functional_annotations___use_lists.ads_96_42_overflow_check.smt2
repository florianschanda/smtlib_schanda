...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o21 j) true)
  (=> (= (get1 o21 i3) (get1 o21 j)) (= (bool_eq3 i3 j) true))))))))))
...
;; H
  ...
  (forall ((k us_rep1))
  (=> (= (has_key o21 k) true)
  (= (= (bool_eq3 k cu) true) (= (witness o21 cu) (witness o21 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o19 j) true)
  (=> (= (get1 o19 i3) (get1 o19 j)) (= (bool_eq3 i3 j) true))))))))))
...
;; H
  ...
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o19 k) true) (= (bool_eq3 k cu) true))) (= o20 true)))))
