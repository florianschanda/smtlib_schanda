...
(define-fun usedlogfiles__split_fields20 () us_split_fields (mk___split_fields
                                                            usedlogfiles__split_fields4
                                                            usedlogfiles__split_fields5
                                                            usedlogfiles__split_fields6
                                                            usedlogfiles__split_fields7))

(define-fun auditsystemfault9 () bool__ref (mk_bool__ref auditsystemfault))

(define-fun logfileentries10 () map__ref1 (mk_map__ref1 logfileentries))

(define-fun usedlogfiles__split_fields21 () us_split_fields__ref (mk___split_fields__ref
                                                                 (mk___split_fields
...
(define-fun numberlogentries10 () int__ref (mk_int__ref numberlogentries))

(define-fun logfilesstatus10 () map__ref4 (mk_map__ref4 logfilesstatus))

(define-fun logfiles9 () map__ref3 (mk_map__ref3 logfiles))
...
;; H
  ...
  (and
  (and
  (and (= auditsystemfault3 auditsystemfault9)
  (and (= logfileentries4 logfileentries10)
  (and (= usedlogfiles__split_fields14 usedlogfiles__split_fields21)
  (and (= numberlogentries4 numberlogentries10)
  (and (= logfilesstatus4 logfilesstatus10) (= logfiles3 logfiles9))))))
  (and (= auditsystemfault4 auditsystemfault1)
  (and (= logfileentries5 logfileentries1)
  (and (= usedlogfiles__split_fields15 usedlogfiles__split_fields20)
...
;; H
  ...
  (= auditsystemfault7 auditsystemfault9)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= logfileentries8 logfileentries10)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= usedlogfiles__split_fields18 usedlogfiles__split_fields21)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= numberlogentries8 numberlogentries10)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= logfilesstatus8 logfilesstatus10)))
...
;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= usedlogfiles__split_fields19 usedlogfiles__split_fields20)))
...
;; H
  (assert (not (= oldalarm1 auditalarm2)))

(assert
;; WP_parameter_def
 ;; File "auditlog.ads", line 33, characters 0-0
  (not
  (= (valid_numberlogentries (map__content1 logfileentries8)
     (int__content numberlogentries8) currentlogfile
     (us_split_fields__content usedlogfiles__split_fields18)) true)))
(check-sat)
(exit)
