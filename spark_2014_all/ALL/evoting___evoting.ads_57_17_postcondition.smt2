...
(declare-datatypes ((t22b__ref 0)) (((mk_t22b__ref (t22b__content us_t2)))))
...
(declare-const temp___646 (Array Int (Array Int character)))

(declare-const temp___645 (Array Int character))
...
(declare-const temp___6421 t1)

(declare-const o8 (Array Int character))

(declare-const o9 (Array Int (Array Int character)))
