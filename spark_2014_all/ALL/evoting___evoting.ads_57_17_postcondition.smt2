...
;; H
  (assert
  (=> (= result3 true) (= o8 (select candidates3 current_candidate3))))

;; H
  (assert (=> (= result3 true) (= o8 temp___640)))

;; H
  (assert (=> (= result3 true) (= (mk1 1 r17b) temp___6401)))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first2 temp___6371)) (to_rep1 (last2 temp___6371)))
     ...
     0) (ite (<= (to_rep1 (first2 temp___6401)) (to_rep1 (last2 temp___6401)))
        (+ (- (to_rep1 (last2 temp___6401)) (to_rep1 (first2 temp___6401))) 1)
        0))))
...
;; H
  ...
  (= (select o9 temp___643) (select temp___642 temp___643))
  (= (select o9 temp___643) (select (select candidates3 current_candidate3) temp___643))))))

;; H
  (assert
  (=> (= result3 true) (= o10 (store candidates3 current_candidate3 o9))))
...
;; H
  (assert
  (=> (= result3 true)
  (= o13 (ite (= o12 true) (ite (< current_candidate3 20) true false) false))))

;; H
  (assert
  (=> (= result3 true) (= result7 (ite (not (= o13 true)) true false))))
