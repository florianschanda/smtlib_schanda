...
(declare-fun dummy7 () program_phase_t)
...
(declare-fun dummy8 () candidate_number_t)
...
(define-fun bool_eq10 ((a (Array Int (Array Int character))) (a__first Int)
...
(declare-fun temp___646 () (Array Int (Array Int character)))

(declare-fun temp___645 () (Array Int character))
...
(declare-fun temp___637 () (Array Int character))

(declare-fun temp___6371 () t1)

(declare-fun temp___642 () (Array Int character))

(declare-fun temp___6421 () t1)

(declare-fun o8 () (Array Int character))

(declare-fun o9 () (Array Int (Array Int character)))
...
(declare-fun result6 () (Array Int (Array Int character)))

(declare-fun candidates4 () (Array Int (Array Int character)))

(declare-fun result7 () Bool)

(declare-fun candidates5 () (Array Int (Array Int character)))

(declare-fun current_candidate4 () int__ref)

(declare-fun last10 () int__ref)

(declare-fun item4 () map__ref)

(declare-fun candidates6 () (Array Int (Array Int character)))

(declare-fun current_candidate5 () Int)

(declare-fun last11 () Int)

(declare-fun item5 () (Array Int character))

(declare-fun candidates7 () map__ref1)

(declare-fun current_candidate6 () int__ref)

(declare-fun last12 () int__ref)

(declare-fun item6 () map__ref)

(declare-fun candidates8 () (Array Int (Array Int character)))

(declare-fun current_candidate7 () Int)

(declare-fun last13 () Int)

(declare-fun item7 () (Array Int character))

(declare-fun file1 () us_rep)

(declare-fun result8 () int__ref)

(declare-fun last_candidate1 () Int)

(declare-fun candidates9 () map__ref1)

(declare-fun last_candidate2 () int__ref)

(declare-fun file2 () file_type__ref)

(declare-fun current_candidate8 () int__ref)

(declare-fun last14 () int__ref)

(declare-fun item8 () map__ref)

(declare-fun candidates10 () (Array Int (Array Int character)))

(declare-fun last_candidate3 () Int)

(declare-fun file3 () us_rep)

(declare-fun current_candidate9 () Int)
...
;; H
  (assert (=> (= result3 true) (= temp___649 current_candidate1)))

;; H
  (assert (=> (= result3 true) (= temp___646 candidates2)))

;; H
  (assert (=> (= result3 true) (= temp___645 item)))

;; H
  (assert (=> (= result3 true) (= temp___644 last6)))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (and (=> (<= 0 2147483647) (in_range4 last8))
  ...
  temp___646 temp___647) temp___648))))))))
...
;; H
  (assert
  (=> (= result3 true)
  (= item3 (slide ada__text_io__get_line__item (to_rep1 (first (mk 1 70))) 1))))
...
;; H
  (assert (=> (= result3 true) (= o7 temp___636)))

;; H
  (assert (=> (= result3 true) (= (mk2 1 r20b) temp___6361)))

;; H
  (assert
  (=> (= result3 true)
  (= (ite (<= (to_rep1 (first4 temp___6361)) (to_rep1 (last4 temp___6361)))
     (+ (- (to_rep1 (last4 temp___6361)) (to_rep1 (first4 temp___6361))) 1)
     0) (ite (<= 1 r17b) (+ (- r17b 1) 1) 0))))

;; H
  (assert (=> (= result3 true) (= temp___636 temp___637)))

;; H
  (assert
  (=> (= result3 true)
  (= (mk1 (to_rep1 (first4 temp___6361)) (to_rep1 (last4 temp___6361))) 
  temp___6371)))

;; H
  (assert
  (=> (= result3 true)
  (= (ite (<= (to_rep1 (first2 temp___6371)) (to_rep1 (last2 temp___6371)))
     (+ (- (to_rep1 (last2 temp___6371)) (to_rep1 (first2 temp___6371))) 1)
     0) (ite (<= (to_rep1 (first2 (mk1 1 r17b))) (to_rep1
                                                 (last2 (mk1 1 r17b))))
        (+ (- (to_rep1 (last2 (mk1 1 r17b))) (to_rep1 (first2 (mk1 1 r17b)))) 1)
        0))))

;; H
  (assert
  (=> (= result3 true)
  (= (mk___t1 temp___642 temp___6421) (mk___t1 temp___637 temp___6371))))

;; H
  (assert
  (=> (= result3 true)
  (forall ((temp___643 Int))
  (ite (and (<= 1 temp___643) (<= temp___643 r17b))
  (= (select o8 temp___643) (select temp___642 temp___643))
  (= (select o8 temp___643) (select (select candidates3 current_candidate3) temp___643))))))

;; H
  (assert
  (=> (= result3 true) (= o9 (store candidates3 current_candidate3 o8))))

;; H
  (assert (=> (= result3 true) (= candidates3 result6)))

;; H
  (assert (=> (= result3 true) (= candidates4 o9)))

;; H
  (assert (=> (= result3 true) (= o10 (end_of_file file))))
...
;; H
  (assert
  (=> (= result3 true)
  (= o12 (ite (= o11 true) (ite (< current_candidate3 20) true false) false))))

;; H
  (assert
  (=> (= result3 true) (= result7 (ite (not (= o12 true)) true false))))
...
;; H
  (assert
  (=> (= result3 true)
  (= current_candidate4 (mk_int__ref current_candidate3))))

;; H
  (assert (=> (= result3 true) (= candidates4 candidates5)))
...
;; H
  (assert (=> (= result3 true) (= candidates7 (mk_map__ref1 candidates5))))
...
;; H
  (assert
  (=> (not (= result3 true))
  (= current_candidate6 (mk_int__ref current_candidate1))))

;; H
  (assert
  (=> (not (= result3 true)) (= candidates7 (mk_map__ref1 candidates2))))
...
;; H
  (assert
  (=> (not (= result3 true)) (= current_candidate7 current_candidate1)))
...
;; WP_parameter_def
 ;; File "evoting.adb", line 34, characters 0-0
  (not (= (to_rep (select (select (map__content1 candidates9) i) j)) 32)))
(check-sat)
