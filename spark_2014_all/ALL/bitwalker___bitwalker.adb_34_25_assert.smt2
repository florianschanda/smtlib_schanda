...
(declare-fun left_bv () (_ BitVec 64))
...
(declare-fun bitwalker__pokebit64__B_1__mask__assume () (_ BitVec 64))

(declare-fun bitwalker__pokebit64__B_1__r__assume () (_ BitVec 64))
...
;; H
  (assert (bvult left_bv ((_ int2bv 64) 64)))

;; H
  (assert (= (bvsub ((_ int2bv 64) 63) left_bv) ((_ int2bv 64) (- 63
  left))))
...
;; H
  (assert
  (= bitwalker__pokebit64__B_1__mask__assume (bvshl ((_ int2bv 64) 1)
  o1)))
...
;; H
  (assert
  (=> (not (= flag true))
  (= bitwalker__pokebit64__B_1__r__assume (bvand value (bvnot mask)))))
...
;; H
  (assert (bvule i ((_ int2bv 64) 63)))

;; H
  (assert (not (= i (bvsub ((_ int2bv 64) 63) left_bv))))
