...
;; H
  (assert (= result3 (ite (= o5 1) true false)))
...
;; H
  (assert (=> (= result3 true) (= o7 (ite (= o6 3) true false))))
...
;; H
  (assert (=> (= result3 true) (= o11 (ite (= o8 true) o7 false))))

;; H
  (assert (=> (= result3 true) (= o12 (ite (= o11 false) o10 true))))
