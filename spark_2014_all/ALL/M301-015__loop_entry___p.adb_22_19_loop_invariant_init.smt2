...
(declare-datatypes ((t17b__ref 0)) (((mk_t17b__ref (t17b__content us_t)))))
...
(((mk___t2 (elts2 (Array Int map1))(rt2 t2)))))
...
(((mk___t3 (elts3 (Array Int map1))(rt3 t3)))))
...
(declare-datatypes ((t27b__ref 0)) (((mk_t27b__ref (t27b__content us_t3)))))
...
(((mk___t4 (elts4 (Array Int map1))(rt4 t4)))))
...
(declare-datatypes ((t33b__ref 0)) (((mk_t33b__ref (t33b__content us_t4)))))
...
(((mk___t5 (elts5 (Array Int map1))(rt5 t5)))))
...
(declare-datatypes ((t35b__ref 0)) (((mk_t35b__ref (t35b__content us_t5)))))
...
(((mk_t40b__ref (t40b__content integer)))))
...
(((mk___t6 (elts6 (Array Int map1))(rt6 t6)))))
...
(declare-datatypes ((t41b__ref 0)) (((mk_t41b__ref (t41b__content us_t6)))))
...
(((mk___t7 (elts7 (Array Int map1))(rt7 t7)))))
...
(declare-datatypes ((t43b__ref 0)) (((mk_t43b__ref (t43b__content us_t7)))))
...
;; H
  (assert
  (= (bool_eq2 x3 (to_rep (first4 (mk2 (+ i32 1) 3)))
     (to_rep (last4 (mk2 (+ i32 1) 3))) x2
     (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true))
...
;; H
  ...
  (ite (not (= i32 temp___276))
  (= (select x3 temp___276) (select x2 temp___276))
  (forall ((temp___277 Int) (temp___278 Int))
  (=>
  (and (and (<= 1 temp___277) (<= temp___277 3))
  (and (<= 1 temp___278) (<= temp___278 3)))
  (=> (<= i212 temp___277)
  (= (get (select x3 temp___276) temp___277 temp___278) (get
                                                        (select x2 temp___276)
                                                        temp___277
                                                        temp___278))))))))
  (=> (<= 1 3) (in_range2 i212))) (and (<= 1 i212) (<= i212 3))))
...
;; H
  (assert
  (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3)))
     (to_rep (last8 (mk4 (+ i32 1) 3))) x3
     (to_rep (first10 (mk5 (+ i32 1) 3)))
...
;; H
  ...
  (ite (not (= i32 temp___255))
  (= (select x4 temp___255) (select x3 temp___255))
  (forall ((temp___256 Int) (temp___257 Int))
  (=>
  (and (and (<= 1 temp___256) (<= temp___256 3))
  (and (<= 1 temp___257) (<= temp___257 3)))
  (=> (or (<= i222 temp___257) (not (= i212 temp___256)))
  (= (get (select x4 temp___255) temp___256 temp___257) (get
                                                        (select x3 temp___255)
                                                        temp___256
                                                        temp___257))))))))
  (=> (<= 1 3) (in_range2 i222))) (and (<= 1 i222) (<= i222 3))))
...
;; H
  (assert (= o1 (store (get (select x4 i32) i212 i222) i11 o)))

;; H
  (assert (= o2 (set (select x4 i32) i212 i222 o1)))

;; H
  (assert (= o3 (store x4 i32 o2)))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq2 x5 (to_rep (first12 (mk6 (+ i32 1) 3)))
     (to_rep (last12 (mk6 (+ i32 1) 3))) x4
     (to_rep (first14 (mk7 (+ i32 1) 3)))
     (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))
(check-sat)
(exit)
