...
;; H
  (assert (= o1 temp___152))

;; H
  (assert (= (mk i j) temp___1521))

(assert
;; WP_parameter_def
 ;; File "slice_test_3.ads", line 9, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___1511)) (to_rep1 (last temp___1511)))
     (+ (- (to_rep1 (last temp___1511)) (to_rep1 (first temp___1511))) 1) 0)
  (ite (<= (to_rep1 (first temp___1521)) (to_rep1 (last temp___1521)))
  (+ (- (to_rep1 (last temp___1521)) (to_rep1 (first temp___1521))) 1) 0))))
(check-sat)
(exit)
