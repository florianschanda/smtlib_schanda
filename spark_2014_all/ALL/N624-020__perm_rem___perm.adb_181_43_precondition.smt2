...
(declare-fun perm__shift_perm_r__result () Int)

(declare-fun result () Int)

(declare-fun perm__shift_perm_r__result1 () Int)

(declare-fun perm__shift_perm_r__result2 () Int)

(declare-fun perm__shift_perm_r__result3 () Int)

(declare-fun perm__shift_perm_r__result4 () Int)

(declare-fun perm__shift_perm_r__result5 () Int)
...
;; H
  (assert (= (of_int (perm_symmetric c a)) true))
...
;; H
  (assert
  (= (mk_int__ref perm__shift_perm_r__result4) (mk_int__ref
                                               perm__shift_perm_r__result2)))

;; H
  (assert (= perm__shift_perm_r__result5 perm__shift_perm_r__result3))

;; H
  (assert (= (of_int perm__shift_perm_r__result4) true))
