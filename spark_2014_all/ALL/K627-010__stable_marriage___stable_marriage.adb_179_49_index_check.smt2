...
(((mk_map__ref1 (map__content1 (Array Int (Array Int group1_id)))))))
...
(((mk_map__ref2 (map__content2 (Array Int ranking))))))
...
(((mk_map__ref3 (map__content3 (Array Int (Array Int ranking)))))))
...
;; H
  (assert
  (forall ((prev1 Int))
  (=> (and (<= 1 prev1) (<= prev1 (- g22 1)))
  (= (bool_eq2 (select result__2 prev1) 1 64 (invert_1 (select r2 prev1)) 1
     64) true))))
