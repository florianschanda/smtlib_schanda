...
;; H
  (assert
  (and (= o7 (first (mk___rep l1__split_discrs l1__split_fields2)))
  (ite (= (= (length (mk___rep l1__split_discrs l1__split_fields2)) 0) true)
  (= (bool_eq1 o7 no_element) true)
  (and
  (= (has_key (positions (mk___rep l1__split_discrs l1__split_fields2)) o7) true)
  (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields2)) o7) 1)))))
