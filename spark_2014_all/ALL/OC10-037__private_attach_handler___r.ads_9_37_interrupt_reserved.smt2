...
(declare-fun dummy1 () interrupt_priority)
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__r__pt us_main_type)))))
...
(declare-fun r__pt__x__first__bit () Int)

(declare-fun r__pt__x__last__bit () Int)

(declare-fun r__pt__x__position () Int)
...
(declare-fun r__pt__y__first__bit () Int)

(declare-fun r__pt__y__last__bit () Int)

(declare-fun r__pt__y__position () Int)
...
(declare-fun r__pt__z__first__bit () Int)

(declare-fun r__pt__z__last__bit () Int)

(declare-fun r__pt__z__position () Int)
