...
;; H
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields8)) 1) i1)
  (<= i1 (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a)))))
  (not
  (= (to_rep
     (select (rec__static_discr__i_holder__content2
             (us_split_fields7
             (rec__static_discr__holder__content1 (us_split_fields9 a)))) i1))
  e)))))))
...
;; H
  ...
  (=>
  (and
  (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields9)) 1) i1)
  (<= i1 (to_rep (rec__static_discr__holder__length1 current__split_fields8))))
  (not
  (= (to_rep
     (select (rec__static_discr__i_holder__content2
             (us_split_fields7
             (rec__static_discr__holder__content1 current__split_fields9))) i1))
  e))))
  (and
  (and
  (<= (to_rep (rec__static_discr__holder__length1 current__split_fields9))
