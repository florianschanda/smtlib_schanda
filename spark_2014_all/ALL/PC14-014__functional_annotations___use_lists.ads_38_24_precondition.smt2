...
(declare-fun dummy () telement_typeB)
...
(declare-fun use_lists__incr_all_2__cu__assume () count_type)

(declare-fun temp___491 () us_rep2)

(declare-fun temp___489 () count_type)

(declare-fun temp___492 () us_rep2)

(declare-fun temp___490 () Int)

(declare-fun temp___488 () count_type)

(declare-fun temp___4881 () us_main_type)
...
(declare-fun l__split_fields4 () us_split_fields__ref)
...
(declare-fun l__split_fields6 () us_split_fields__ref)
...
(declare-fun l__split_fields8 () us_split_fields__ref)
...
(define-fun use_lists__incr_all_2__cu__assume1 () us_rep1 (mk___rep1
                                                          (mk___split_fields1
                                                          use_lists__incr_all_2__cu__assume)))

;; H
  (assert
  (and
  (= use_lists__incr_all_2__cu__assume1 (first
  ...
  (= (bool_eq1 use_lists__incr_all_2__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__incr_all_2__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__incr_all_2__cu__assume1) 1)))))
...
;; H
  ...
  (= result1 (has_key
             (positions
             (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
             (mk___rep1 cu__split_fields12)))
  (= (= result1 true)
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 cu__split_fields12)) true))))
...
;; H
  (assert (=> (= result1 true) (= temp___489 cu__split_fields1)))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___488))
  (= l__split_fields temp___4881))))

;; H
  (assert
  (=> (= result1 true)
  (= (length (mk___rep l__split_discrs l__split_fields11)) temp___490)))
...
;; H
  ...
  (=>
  (and (<= 1 n1)
  (<= n1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields11))
            (mk___rep1 cu__split_fields11)) 1)))
  (= (is_incr (get temp___491 n1)
     (get (model__ (mk___rep l__split_discrs l__split_fields11)) n1)) true)))))
...
;; H
  ...
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields11))
      (mk___rep1 cu__split_fields11)) n1)
  (<= n1 (length (mk___rep l__split_discrs l__split_fields11))))
  (= (get temp___492 n1) (get
                         (model__
                         (mk___rep l__split_discrs l__split_fields11)) n1))))))

;; H
  (assert
  (=> (= result1 true)
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields11))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (= o (element (mk___rep l__split_discrs l__split_fields11)
       (mk___rep1 cu__split_fields11)))
  (and (in_range6 o)
  (= o (get (model__ (mk___rep l__split_discrs l__split_fields11))
       (get1 (positions (mk___rep l__split_discrs l__split_fields11))
       (mk___rep1 cu__split_fields11))))))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o1 (element (mk___rep l__split_discrs l__split_fields11)
        (mk___rep1 cu__split_fields11)))
  (and (in_range6 o1)
  (= o1 (get (model__ (mk___rep l__split_discrs l__split_fields11))
        (get1 (positions (mk___rep l__split_discrs l__split_fields11))
        (mk___rep1 cu__split_fields11)))))))))
...
;; H
  (assert
  (=> (= result1 true) (=> (= result2 true) (and (= o3 o2) (in_range1 o2)))))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields10)) (length
                                                           ...
                                                           l__split_discrs
                                                           l__split_fields11)))
  (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields11))
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10))
     ...
     (mk___rep1 cu__split_fields11))) o3))
  (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields11))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= result2 true)) (= l__split_fields10 l__split_fields11))))
...
;; H
  ...
  (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields11) no_element) false) (=
          (get1 (positions (mk___rep l__split_discrs l__split_fields10))
          (mk___rep1 cu__split_fields11)) (length
                                          (mk___rep l__split_discrs
                                          l__split_fields10))) true) true)
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields10))
     (mk___rep1 cu__split_fields10)) (+ (get1
                                        (positions
                                        (mk___rep l__split_discrs
                                        l__split_fields10))
                                        (mk___rep1 cu__split_fields11)) 1))))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (= o4 (has_key (positions (mk___rep l__split_discrs l__split_fields10))
...
;; H
  (assert
  (=> (= result1 true)
  (= l__split_fields4 (mk___split_fields__ref l__split_fields10))))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= l__split_fields6 (mk___split_fields__ref
                      (mk___split_fields l__split_fields)))))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= l__split_fields7 (mk___split_fields l__split_fields1))))
...
;; H
  ...
  (= o5 (length
        (mk___rep l__split_discrs
        (us_split_fields__content l__split_fields8))))
  (and (in_range2 o5)
...
;; H
  (assert (and (= o8 (get o7 n)) (in_range4 o8)))

(assert
;; WP_parameter_def
 ;; File "use_lists.ads", line 26, characters 0-0
  (not (<= 1 n)))
(check-sat)
(exit)
