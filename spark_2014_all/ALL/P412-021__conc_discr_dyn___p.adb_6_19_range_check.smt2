...
(((mk___split_discrs (rec__p__my_rec__c natural)))))
...
(((mk___split_fields (rec__p__my_rec__content us_t)))))
...
(((mk___split_fields1 (rec__p__my_rec__content1 us_t1)))))
...
(declare-datatypes ((pp__ref 0)) (((mk_pp__ref (pp__content us_rep2)))))
