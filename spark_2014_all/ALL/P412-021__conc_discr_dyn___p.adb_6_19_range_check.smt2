...
(declare-fun p__my_rec__c__first__bit () Int)

(declare-fun p__my_rec__c__last__bit () Int)

(declare-fun p__my_rec__c__position () Int)
...
(declare-fun p__my_rec__content__first__bit () Int)

(declare-fun p__my_rec__content__last__bit () Int)

(declare-fun p__my_rec__content__position () Int)
...
(define-fun in_range2 ((rec__p__my_rec__c1 Int)
...
(declare-fun p__my_rec__c__first__bit1 () Int)

(declare-fun p__my_rec__c__last__bit1 () Int)

(declare-fun p__my_rec__c__position1 () Int)
...
(declare-fun p__my_rec__content__first__bit1 () Int)

(declare-fun p__my_rec__content__last__bit1 () Int)

(declare-fun p__my_rec__content__position1 () Int)
...
(define-fun us_split_discrs_2__projection ((a us_split_discrs3)) Bool 
  (rec__p__pp__b a))
...
(define-fun us_rep_7__projection ((a us_rep2)) us_split_discrs3 (us_split_discrs4
                                                                a))
...
(declare-fun p__pp__b__first__bit () Int)

(declare-fun p__pp__b__last__bit () Int)

(declare-fun p__pp__b__position () Int)
...
(declare-fun p__pp__c__first__bit () Int)

(declare-fun p__pp__c__last__bit () Int)

(declare-fun p__pp__c__position () Int)
...
(declare-fun p__pp__dummy__first__bit () Int)

(declare-fun p__pp__dummy__last__bit () Int)

(declare-fun p__pp__dummy__position () Int)
...
(declare-fun p__pp__r__first__bit () Int)

(declare-fun p__pp__r__last__bit () Int)

(declare-fun p__pp__r__position () Int)
...
(define-fun dynamic_invariant ((temp___expr_187 us_rep2)
  (temp___is_init_184 Bool) (temp___skip_constant_185 Bool)
  (temp___do_toplevel_186 Bool)) Bool (let ((temp___189 (rec__p__pp__c
                                                        (us_split_discrs4
                                                        temp___expr_187))))
                                      (and (in_range2 (to_rep temp___189)
                                      (to_base
                                      (rec__p__pp__r
...
;; range_axiom
  (assert
  (forall ((x ttB)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun dynamic_invariant1 ((temp___expr_195 Int)
  ...
  (self__ us_rep2)) Bool (=>
                         ...
                         (<= 1 (last4 self__))) (dynamic_property4 1
                         (last4 self__) temp___expr_195)))

;; last__def_axiom
  (assert
  (forall ((self__ us_rep2))
  (! (= (last4 self__) (to_rep (rec__p__pp__c (us_split_discrs4 self__)))) :pattern (
  (last4 self__)) )))
...
(define-fun dynamic_invariant4 ((temp___expr_181 us_rep)
...
(declare-fun self__1 () natural)

(declare-fun self__2 () Bool)

(declare-fun self__3 () natural)

(declare-fun self__4 () (Array Int natural))

(declare-fun self__5 () t1)

;; H
  (assert (dynamic_invariant
  (mk___rep2 (mk___split_discrs1 self__ self__1)
  (mk___split_fields2 self__2
  (mk___rep1 (mk___split_discrs self__3)
  (mk___split_fields1 (mk___t1 self__4 self__5))))) true false true))

(assert
;; WP_parameter_def
 ;; File "p.ads", line 9, characters 0-0
  (not (dynamic_property4 1
  (last4
  (mk___rep2 (mk___split_discrs1 self__ self__1)
  (mk___split_fields2 self__2
  (mk___rep1 (mk___split_discrs self__3)
  (mk___split_fields1 (mk___t1 self__4 self__5)))))) 3)))
(check-sat)
