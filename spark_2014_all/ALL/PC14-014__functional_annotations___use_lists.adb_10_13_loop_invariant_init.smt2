...
;; H
  ...
  (= (bool_eq3 use_lists__my_find__cu__assume1 no_element) true)
...
;; H
  (assert
  (and (= result1 (has_key (positions l) (mk___rep1 cu__split_fields2)))
  (= (= result1 true)
  (= (has_key (positions l) (mk___rep1 cu__split_fields2)) true))))
...
;; H
  (assert (<= i (- (get1 (positions l) (mk___rep1 cu__split_fields2)) 1)))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not (not (= (get (model__ l) i) e))))
(check-sat)
