...
(declare-datatypes ()
((xdr_integer__ref (mk_xdr_integer__ref (xdr_integer__content xdr_integer)))))
(define-fun xdr_integer__ref___projection ((a xdr_integer__ref)) xdr_integer
...
(define-fun dynamic_invariant1 ((temp___expr_142 (_ BitVec 32))
...
(define-fun dynamic_invariant4 ((temp___expr_241 (_ BitVec 32))
  ...
  (temp___do_toplevel_240 Bool)) Bool true)
...
;; xdr_unsigned_to_integer__post_axiom
  ...
  (! (=> (dynamic_invariant4 s true true true) (dynamic_invariant5
     (xdr_unsigned_to_integer s) true false true)) :pattern ((xdr_unsigned_to_integer
                                                             s)) )))
...
(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 155, characters 0-0
  (not (not (= 4 0))))
(check-sat)
(exit)
