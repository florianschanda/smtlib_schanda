...
(declare-const r__split_fields enum1ta)

(declare-const r__split_fields1 enum1t)
...
;; H
  (assert (in_range5 (to_rep r__split_fields1)))
...
;; H
  (assert (= temp1 (to_rep1 r__split_fields)))

(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1095, characters 0-0
  (not (in_range5 (to_rep r__split_fields1))))
(check-sat)
(exit)
