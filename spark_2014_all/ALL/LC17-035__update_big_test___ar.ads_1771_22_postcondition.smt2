...
(declare-const temp___9292 (Array Int us_rep))

(declare-const temp___92921 Bool)

(declare-const temp___92922 enum1t)
...
;; H
  (assert (= temp___9292 o6))

;; H
  (assert (= temp___92921 o7))

;; H
  (assert (= temp___92922 o8))
...
;; H
  (assert (= temp___9292 r__split_fields3))

;; H
  (assert (= temp___92921 r__split_fields4))

;; H
  (assert (= temp___92922 r__split_fields5))
...
;; WP_parameter_def
 ;; File "ar.ads", line 106, characters 0-0
  (not
  (= (bool_eq (select r__split_fields6 n) (select r__split_fields n)) true)))
(check-sat)
(exit)
