...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__use_private_types__holder__content us_rep)))))
...
(declare-fun use_private_types__holder__content__first__bit () Int)

(declare-fun use_private_types__holder__content__last__bit () Int)

(declare-fun use_private_types__holder__content__position () Int)
...
(define-fun dynamic_invariant ((temp___expr_177 us_rep1)
  ...
  (temp___do_toplevel_176 Bool)) Bool (= (attr__constrained
                                         (rec__use_private_types__holder__content
                                         (us_split_fields3 temp___expr_177))) false))
...
(declare-fun s__split_fields1 () Bool)
...
(assert
;; WP_parameter_def
 ;; File "use_private_types.ads", line 16, characters 0-0
  (not (or (= (to_rep s__split_fields) 0) (not (= s__split_fields1 true)))))
(check-sat)
(exit)
