...
;; def_axiom
  (assert
  (forall ((temp___3563 (Array Int us_rep)))
  (forall ((temp___3564 Int))
  (forall ((temp___3565 us_rep))
  (let ((temp___3562 (temp___3561 temp___3563 temp___3564 temp___3565)))
  (forall ((temp___3566 Int))
  (ite (= temp___3566 temp___3564)
  (= (select temp___3562 temp___3566) temp___3565)
  (= (select temp___3562 temp___3566) (select temp___3563 temp___3566)))))))))

(declare-fun temp___3568 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3570 (Array Int et1)))
  (forall ((temp___3571 Int) (temp___3572 Int))
  (let ((temp___3569 (temp___3568 temp___3570 temp___3571 temp___3572)))
  (forall ((temp___3573 Int))
  (ite (= temp___3573 temp___3571)
  (= (select temp___3569 temp___3573) (of_rep temp___3572))
  (= (select temp___3569 temp___3573) (select temp___3570 temp___3573))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1644, characters 0-0
  (not
  (= (bool_eq2 a2 1 16
     (temp___3561 a i
     (mk___rep
     (mk___split_fields
     (temp___3568 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e)
