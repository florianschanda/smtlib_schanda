...
(define-fun set__ref___2__projection ((a set__ref1)) us_rep3 (set__content1
                                                             a))
...
;; H
  ...
  (exists ((i1 us_rep1))
  (and (= (has_key (positions s) i1) true)
  (= (get (elements s) (get1 (positions s) i1)) (get temp___399 temp___398))))))))
...
;; H
  ...
  (=> (and (in_range3 temp___390) (= (iter_has_element o2 temp___390) true))
  (= (contains (model__ s) (get o2 temp___390)) true))))
  (forall ((item Int))
  (=> (and (in_range4 item) (= (contains (model__ s) item) true))
  (and (< 0 (find o2 item))
