...
(define-fun register_type__ref___174__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___122__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___122__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6199 us_t1)
  (temp___is_init_6196 Bool) (temp___skip_constant_6197 Bool)
  (temp___do_toplevel_6198 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6197 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6199)
                                       (last3 temp___expr_6199))
                                       (and (= (first3 temp___expr_6199) 1)
                                       (= (last3 temp___expr_6199) 2)))))
