...
(((mk_tTnew_strSP1__ref (tTnew_strSP1__content integer)))))
...
(declare-datatypes ((tnew_strS__ref 0))
(((mk_tnew_strS__ref (tnew_strS__content us_t1)))))
...
(define-fun dynamic_invariant2 ((temp___expr_155 us_t1)
  ...
  (temp___do_toplevel_154 Bool)) Bool (=>
                                      ...
                                      (last1 str) (first3 temp___expr_155)
                                      (last3 temp___expr_155))
                                      (and
                                      (= (first3 temp___expr_155) (first1
                                                                  str))
...
(((mk_tTnew_subSP1__ref (tTnew_subSP1__content integer)))))
...
(declare-datatypes ((tnew_subS__ref 0))
(((mk_tnew_subS__ref (tnew_subS__content us_t2)))))
...
(define-fun dynamic_invariant3 ((temp___expr_164 us_t2)
  ...
  (temp___do_toplevel_163 Bool)) Bool (=>
                                      ...
                                      (last1 sub) (first5 temp___expr_164)
                                      (last5 temp___expr_164))
                                      (and
                                      (= (first5 temp___expr_164) (first1
                                                                  sub))
                                      (= (last5 temp___expr_164) (last1 sub))))))
...
;; upper_case__post_axiom
  (assert
  (forall ((str1 us_t))
  (! (=> (dynamic_invariant1 str1 true true true) (dynamic_invariant1
     (upper_case str1) true false true)) :pattern ((upper_case str1)) )))
...
(declare-datatypes ((t9b__ref 0)) (((mk_t9b__ref (t9b__content us_t3)))))
...
;; H
  (assert
  (and (= temp___2042 (upper_case str)) (dynamic_invariant1 temp___2042 true
  false true)))
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first2 temp___2051)) (to_rep1 (last2 temp___2051)))
     (+ (- (to_rep1 (last2 temp___2051)) (to_rep1 (first2 temp___2051))) 1)
...
;; H
  (assert
  (and (= temp___2062 (upper_case sub)) (dynamic_invariant1 temp___2062 true
  false true)))
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___2071)) (to_rep1 (last4 temp___2071)))
     (+ (- (to_rep1 (last4 temp___2071)) (to_rep1 (first4 temp___2071))) 1)
...
;; H
  (assert
  (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))
  (= o6 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o6 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))
  (= o13 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o13 0)))
...
;; H
  ...
  (and
  (and (<= (to_rep1 new_str__first) pos1) (<= pos1 (to_rep1 new_str__last)))
  (and (<= (to_rep1 new_str__first) fb20a00__find__L_2__R7b)
  (<= fb20a00__find__L_2__R7b (to_rep1 new_str__last)))))))
...
;; H
  (assert
  (=> (= result4 true) (= (mk3 pos1 fb20a00__find__L_2__R7b) temp___2091)))

;; H
  (assert
  (=> (= result4 true)
  (= o12 (bool_eq temp___209 (to_rep1 (first6 temp___2091))
         (to_rep1 (last6 temp___2091)) new_sub1 (to_rep1 new_sub__first)
         (to_rep1 new_sub__last)))))

;; H
  (assert
  (=> (= result4 true) (= result3 (ite (not (= o12 true)) true false))))

;; H
  (assert (=> (not (= result4 true)) (= result3 false)))

;; H
  (assert (=> (= result3 true) (= temp___208 pos1)))

;; H
  (assert
  (=> (= result3 true)
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos2))
  (let ((fb20a00__find__L_2__R7b2 (- (+ pos2 (ite (<= (to_rep1
                                                      new_sub__first)
                                             (to_rep1 new_sub__last))
                                             (+ (- (to_rep1 new_sub__last)
                                             (to_rep1 new_sub__first)) 1) 0)) 1)))
  (and
  (<= pos2 (+ (- (to_rep1 new_str__last) (ite (<= (to_rep1 new_sub__first)
                                         (to_rep1 new_sub__last))
                                         (+ (- (to_rep1 new_sub__last)
                                         (to_rep1 new_sub__first)) 1) 0)) 1))
  (not
  (= (bool_eq new_str1 (to_rep1 (first6 (mk3 pos2 fb20a00__find__L_2__R7b2)))
     (to_rep1 (last6 (mk3 pos2 fb20a00__find__L_2__R7b2))) new_sub1
     (to_rep1 new_sub__first) (to_rep1 new_sub__last)) true)))))))

;; H
  (assert
  (=> (= result3 true) (and (= o19 (+ pos2 1)) (in_range1 (+ pos2 1)))))

;; H
  (assert (=> (= result3 true) (= pos2 result5)))

;; H
  (assert (=> (= result3 true) (= pos3 o19)))

;; H
  (assert
  (=> (= result3 true)
  (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))
  (= o20 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1)))))

;; H
  (assert
  (=> (= result3 true)
  (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o20 0))))

;; H
  (assert (=> (= result3 true) (and (= o21 o20) (in_range1 o20))))

;; H
  (assert (=> (= result3 true) (= o22 (+ pos3 o21))))

;; H
  (assert (=> (= result3 true) (and (= o23 o22) (in_range1 o22))))

;; H
  (assert (=> (= result3 true) (= o24 (- o23 1))))

;; H
  (assert
  (=> (= result3 true)
  (and (= fb20a00__find__L_2__R7b1 o24) (in_range1 o24))))

;; H
  (assert
  (=> (= result3 true)
  (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))
  (= o27 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1)))))

;; H
  (assert
  (=> (= result3 true)
  (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o27 0))))

;; H
  (assert (=> (= result3 true) (and (= o28 o27) (in_range1 o27))))

;; H
  (assert (=> (= result3 true) (= o29 (- (to_rep1 new_str__last) o28))))

;; H
  (assert (=> (= result3 true) (and (= o30 o29) (in_range1 o29))))

;; H
  (assert (=> (= result3 true) (= o31 (+ o30 1))))

;; H
  (assert (=> (= result3 true) (and (= o32 o31) (in_range1 o31))))

;; H
  (assert (=> (= result3 true) (= result7 (ite (<= pos3 o32) true false))))
...
;; H
  ...
  (and
  (and (<= (to_rep1 new_str__first) pos3) (<= pos3 (to_rep1 new_str__last)))
  (and (<= (to_rep1 new_str__first) fb20a00__find__L_2__R7b1)
  (<= fb20a00__find__L_2__R7b1 (to_rep1 new_str__last))))))))

;; H
  (assert (=> (= result3 true) (=> (= result7 true) (= o25 new_str1))))

;; H
  (assert (=> (= result3 true) (=> (= result7 true) (= o25 temp___2092))))

;; H
  (assert
  (=> (= result3 true)
  (=> (= result7 true) (= (mk3 pos3 fb20a00__find__L_2__R7b1) temp___2093))))

;; H
  (assert
  (=> (= result3 true)
  (=> (= result7 true)
  (= o26 (bool_eq temp___2092 (to_rep1 (first6 temp___2093))
         (to_rep1 (last6 temp___2093)) new_sub1 (to_rep1 new_sub__first)
         (to_rep1 new_sub__last))))))

;; H
  (assert
  (=> (= result3 true)
  (=> (= result7 true) (= o33 (ite (not (= o26 true)) true false)))))

;; H
  (assert (=> (= result3 true) (=> (not (= result7 true)) (= o33 false))))

;; H
  (assert
  (=> (= result3 true) (= result6 (ite (not (= o33 true)) true false))))

;; H
  (assert (=> (= result3 true) (= result6 true)))

;; H
  (assert (=> (= result3 true) (= pos3 pos4)))

;; H
  (assert (=> (= result3 true) (= pos5 pos3)))

;; H
  (assert (=> (= result3 true) (= (mk_int__ref pos6) (mk_int__ref pos4))))

;; H
  (assert (=> (= result3 true) (= pos7 pos5)))

;; H
  (assert (=> (not (= result3 true)) (= pos1 pos6)))

;; H
  (assert (=> (not (= result3 true)) (= pos7 pos1)))

;; H
  (assert
  (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))
  (= o34 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o34 0)))

;; H
  (assert (and (= o35 o34) (in_range1 o34)))

;; H
  (assert (= o36 (- (to_rep1 new_str__last) o35)))
