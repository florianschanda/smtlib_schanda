...
;; H
  (assert (= (bool_eq a2 1 2 (temp___191 o_a 2 0) 1 2) true))
...
;; H
  (assert
  (= b1 (update_proof__B_2__b__aggregate_def (temp___245 11 12)
        (temp___250 21 22))))
...
;; H
  (assert (= b2 (store b1 2 (temp___203 0))))
...
;; WP_parameter_def
 ;; File "update_proof.adb", line 1, characters 0-0
  (not (= (bool_eq (select b2 2) 1 2 (temp___211 0) 1 2) true)))
(check-sat)
(exit)
