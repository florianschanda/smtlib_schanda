...
(declare-fun temp___180 () status)

(declare-fun temp___1801 () natural)

(declare-fun temp___1802 () natural)

(declare-fun temp___1803 () Bool)

(declare-fun temp___1804 () Bool)

;; H
  (assert (= g__attr__constrained false))

;; H
  (assert (= (to_rep1 g__split_discrs) 0))
...
;; H
  (assert (= temp___1803 o5))

;; H
  (assert (= true temp___1804))
...
;; WP_parameter_def
 ;; File "definite.adb", line 58, characters 0-0
  (not (= temp___180 g__split_discrs)))
(check-sat)
(exit)
