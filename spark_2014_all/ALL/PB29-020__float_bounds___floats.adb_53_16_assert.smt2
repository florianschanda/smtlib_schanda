...
;; H
  (assert
  (and (= o27 (add1 RNE1 (to_rep1 (select c5 2)) (to_rep1 (select b5 2))))
  (tqtisFinite1 (add1 RNE1 (to_rep1 (select c5 2)) (to_rep1 (select b5 2))))))
...
;; H
  (assert
  (and (= o30 (add1 RNE1 (to_rep1 (select c5 3)) (to_rep1 (select b5 3))))
  (tqtisFinite1 (add1 RNE1 (to_rep1 (select c5 3)) (to_rep1 (select b5 3))))))
...
;; H
  (assert
  (and (= o33 (add1 RNE1 (to_rep1 (select c5 4)) (to_rep1 (select b5 4))))
  (tqtisFinite1 (add1 RNE1 (to_rep1 (select c5 4)) (to_rep1 (select b5 4))))))
...
;; WP_parameter_def
 ;; File "floats.ads", line 6, characters 0-0
  (not (le1 (neg1 fliteral6) (to_rep1 (select d5 1)))))
(check-sat)
