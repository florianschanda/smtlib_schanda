...
(define-fun in_range6 ((rec__names__data__char_tables__vector__capacity1 Int)
...
(define-fun dynamic_invariant2 ((temp___expr_569 us_rep)
  ...
  (temp___do_toplevel_568 Bool)) Bool (=>
                                      ...
                                      (in_range6 1024 temp___expr_569)))
...
(define-fun in_range8 ((rec__names__data__entry_tables__vector__capacity1 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_276 Int)
  ...
  (temp___do_toplevel_275 Bool)) Bool (=>
...
(define-fun index_type__ref___3__projection ((a index_type__ref1)) index_type1
  (index_type__content1 a))

(declare-datatypes ((element_type__ref1 0))
(((mk_element_type__ref1 (element_type__content1 us_rep3)))))
(define-fun element_type__ref___3__projection ((a element_type__ref1)) us_rep3
...
(define-fun dynamic_invariant5 ((temp___expr_436 Int)
...
(define-fun element_type__ref___4__projection ((a element_type__ref2)) us_rep3
...
(declare-datatypes ((tsS__ref 0)) (((mk_tsS__ref (tsS__content us_t1)))))
(define-fun tsS__ref___projection ((a tsS__ref)) us_t1 (tsS__content a))

(define-fun dynamic_invariant6 ((temp___expr_626 us_t1)
  ...
  (temp___do_toplevel_625 Bool)) Bool (=>
                                      ...
                                      (and (= (first3 temp___expr_626) 1)
                                      (= (last5 temp___expr_626) l)))))
...
;; temp___String_Literal_659__def_axiom
  (assert true)
...
;; valid_entry__def_axiom
  ...
  (! (=
     ...
     (and
     (<= (to_rep3
         (rec__names__data__name_entry__next_hash (us_split_fields5 e1)))
     (last_index1
     (mk___rep1 entry_table__split_discrs names__entry_table__fields)))
     (<= (- (to_rep2
            (rec__names__data__name_entry__length (us_split_fields5 e1))) 1) (-
     (last_index
...
;; l__def_axiom
  (assert
  (= l (to_rep2 (rec__names__data__name_entry__length (us_split_fields5 e)))))
...
(define-fun dynamic_invariant11 ((temp___expr_264 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_282 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_288 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_270 Int)
  (temp___is_init_267 Bool) (temp___skip_constant_268 Bool)
  (temp___do_toplevel_269 Bool)) Bool (=>
...
(define-fun dynamic_invariant15 ((temp___expr_315 Int)
...
(define-fun element_type__ref___2__projection ((a element_type__ref3)) element_type1
  (element_type__content3 a))

(define-fun dynamic_invariant16 ((temp___expr_309 Int)
...
(define-fun dynamic_invariant18 ((temp___expr_421 Int)
...
(define-fun dynamic_invariant19 ((temp___expr_472 Int)
...
(define-fun names__to_string__B_3__e__assume3 () us_rep3 (mk___rep2
                                                         (mk___split_fields2
                                                         names__to_string__B_3__e__assume
                                                         names__to_string__B_3__e__assume1
                                                         names__to_string__B_3__e__assume2)))
...
;; H
  (assert
  (and
  (= names__to_string__B_3__e__assume3 (get1
                                       (model__1
                                       (mk___rep1 entry_table__split_discrs
                                       (mk___split_fields1
                                       entry_table__split_fields))) o))
  (= (bool_eq4 names__to_string__B_3__e__assume3
     (get1
     (model__1
     (mk___rep1 entry_table__split_discrs
...
;; H
  (assert
  (= (to_rep2 (rec__names__data__name_entry__length (us_split_fields5 e)))
  l))
...
;; H
  (assert
  (and (dynamic_property2 1 l (to_rep1 s__first) (to_rep1 s__last))
  (and (= (to_rep1 s__first) 1) (= (to_rep1 s__last) l))))
...
;; H
  ...
  (and
  (= o1 (+ (to_rep6
           (rec__names__data__name_entry__table_index (us_split_fields5 e))) (-
  i1 1))) (in_range9
  (+ (to_rep6
     (rec__names__data__name_entry__table_index (us_split_fields5 e))) (-
  i1 1)))))
...
;; H
  (assert (and (= o2 o1) (in_range11 o1)))
...
;; H
  ...
  (= o3 (get
        ...
        (mk___split_fields char_table__split_fields))) o2))
  (and (in_range12 o3)
  (= o3 (get
        (model__
        (mk___rep char_table__split_discrs
