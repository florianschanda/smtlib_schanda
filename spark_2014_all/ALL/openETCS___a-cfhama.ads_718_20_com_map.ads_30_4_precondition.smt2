...
(((mk___split_fields1
  (rec__com_map__com_to_rbc_map__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type
  (rec__com_map__com_to_rbc_map__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__com_map__com_to_rbc_map__cursor__node
...
(declare-const com_map__com_to_rbc_map__cursor__node__first__bit Int)

(declare-const com_map__com_to_rbc_map__cursor__node__last__bit Int)

(declare-const com_map__com_to_rbc_map__cursor__node__position Int)
...
(define-fun map__ref___3__projection ((a map__ref1)) us_rep2 (map__content1
                                                             a))
...
(define-fun default_initial_assumption ((temp___expr_424 us_rep2)
  (temp___skip_top_level_425 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_425 true))
                                         (and
                                         (= (is_empty temp___expr_424) true)
                                         (= (length2 temp___expr_424) 0))))
...
(define-fun map__ref___2__projection ((a map__ref2)) us_rep3 (map__content2
                                                             a))
...
(define-fun default_initial_assumption1 ((temp___expr_373 us_rep3)
  (temp___skip_top_level_374 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_374 true))
                                         (and
                                         (= (is_empty1 temp___expr_373) true)
                                         (= (length3 temp___expr_373) 0))))
...
(declare-fun w_get1 (us_rep3 Int) Bool)

(declare-fun w_get__function_guard1 (Bool us_rep3 Int) Bool)

(declare-fun get1 (us_rep3 Int) Bool)

(declare-fun get__function_guard1 (Bool us_rep3 Int) Bool)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (=> (= (of_int 1) true)
     (and
     (= (= (get1 container1 key) true)
     (= (w_get1 container1 (witness1 container1 key)) true))
     (forall ((k Int))
     (=> (and (in_range3 k) (= (has_key1 container1 k) true))
     (= (= k key) (= (witness1 container1 key) (witness1 container1 k)))))))) :pattern (
  (get1 container1 key)) ))))
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq2 left right) true)
     ...
     (= (= (get1 right key) true) (= (get1 left key) true)))))
     (forall ((key Int))
