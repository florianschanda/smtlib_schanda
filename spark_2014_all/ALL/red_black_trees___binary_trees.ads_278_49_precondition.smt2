...
;; position__post_axiom
  ...
  (! (=>
     ...
     (not (= (parent f i) 0))) (dynamic_invariant2 (position f i) true false
...
(declare-fun temp___808 () extended_index_type)

(declare-fun temp___8081 () (Array Int us_rep2))
...
(declare-fun temp___803 () extended_index_type)

(declare-fun temp___8031 () (Array Int us_rep2))
...
(declare-fun temp___813 () us_rep3)
...
(declare-fun temp___847 () (Array Int us_rep1))

(declare-fun o42 () us_rep1)

(declare-fun o43 () us_split_fields)

(declare-fun temp___846 () (Array Int us_rep1))
...
;; H
  (assert (=> (not (= v 0)) (=> (= d 0) (= temp___808 o10))))

;; H
  (assert (=> (not (= v 0)) (=> (= d 0) (= temp___8081 o11))))
...
;; H
  ...
  (=> (not (= v 0))
  (=> (= d 0)
  (= f__split_fields3 (mk___split_fields2 temp___808 temp___8081)))))
...
;; H
  (assert (=> (not (= v 0)) (=> (not (= d 0)) (= temp___803 o22))))

;; H
  (assert (=> (not (= v 0)) (=> (not (= d 0)) (= temp___8031 o23))))
...
;; H
  ...
  (=> (not (= v 0))
  (=> (not (= d 0))
  (= f__split_fields4 (mk___split_fields2 temp___803 temp___8031)))))
...
;; H
  (assert (=> (not (= v 0)) (= temp___813 (mk___rep2 o35))))
...
;; H
  (assert
  (=> (not (= v 0)) (= f__split_fields5 (us_split_fields5 temp___813))))
...
;; H
  (assert (=> (not (= v 0)) (= temp___818 (mk___rep2 o41))))
...
;; H
  (assert
  (=> (not (= v 0)) (= f__split_fields6 (us_split_fields5 temp___818))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f__split_fields6) root) i2))) true)
  (ite (= (ole
          (rec__tree_model__path_type__a
          (us_split_fields1
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f_old__split_fields2) v) i2))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep2 f_old__split_fields2) root) i2))) true)))))
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f__split_fields6) root) i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f_old__split_fields2) root) i2)))) true))))
  (and
  ...
  (= (is_concat
     ...
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f_old__split_fields2) v) i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__ (mk___rep2 f__split_fields6) root) i2)))) true))))
  (forall ((r Int))
...
;; H
  ...
  (= o48 (size
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))))
  (and (in_range2 o48) (= o48 (to_rep f__split_fields)))))
...
;; H
  (assert (= result5 (ite (= o49 o48) true false)))
...
;; H
  (assert (= result6 (ite (= v o47) true false)))
...
;; H
  ...
  (and
  (= (valid_root
     (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) true)
  (not (= j v)))
  (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) true))))))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (mk___rep2
             (mk___split_fields2 f__split_fields f__split_fields1)) root) j))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (mk___rep2
             (mk___split_fields2 f__split_fields f__split_fields1)) v) j))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (mk___rep2 (us_split_fields__content2 f__split_fields7)) 
...
;; H
  ...
  (= temp___847 (model__
                (mk___rep2 (us_split_fields__content2 f__split_fields7))
                root))
  (and (dynamic_invariant3 temp___847 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___847 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___847 root)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___847 (parent
                             (mk___rep2
                             (us_split_fields__content2 f__split_fields7))
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___847 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___847 i2))) true))))))
  (and
  ...
  (= (is_add
     ...
     (select temp___847 (parent
                        (mk___rep2
                        (us_split_fields__content2 f__split_fields7)) i2))))
     (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___847 i2)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___847 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___847 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___847 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___847 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o42 (select temp___847 i1)))
...
;; H
  ...
  (= temp___846 (model__
                (mk___rep2 (us_split_fields__content2 f__split_fields7))
                root))
  (and (dynamic_invariant3 temp___846 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___846 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___846 root)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___846 (parent
                             (mk___rep2
                             (us_split_fields__content2 f__split_fields7))
                             i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___846 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___846 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___846 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___846 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___846 i2)))
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___846 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o44 (select temp___846 i1)))
