...
(declare-fun temp___224 () natural)

(declare-fun temp___2241 () (Array Int integer))

(declare-fun temp___2242 () t)
...
(declare-fun branch__split_fields4 () us_split_fields)
...
;; H
  (assert
  (= (mk___t1 temp___219 temp___2191) (mk___t1 temp___217 temp___2171)))
...
;; H
  (assert
  (= (mk (to_rep (first2 temp___2191)) (to_rep (last2 temp___2191)))
  o1))
...
;; H
  ...
  (= branch__split_fields2 (mk___split_fields
                           (mk___t temp___2211 temp___2212))))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 0 r9b) (dynamic_property6 0 r9b i2)) (dynamic_invariant2
  (mk___rep branch__split_discrs branch__split_fields3) false true true))
  (forall ((temp___228 Int))
  (=>
  (and
  (<= (to_rep
      (first (rt (rec__main__branch_type__m_nodes branch__split_fields3)))) temp___228)
  (<= temp___228 (to_rep
                 (last
                 (rt (rec__main__branch_type__m_nodes branch__split_fields3))))))
  (=> (<= i2 temp___228)
  (= (select (elts (rec__main__branch_type__m_nodes branch__split_fields3)) temp___228) (select
  (elts (rec__main__branch_type__m_nodes branch__split_fields2)) temp___228))))))
  (and (<= 0 i2) (<= i2 r9b))))
...
;; H
  ...
  (= i2 (to_rep
        (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))
  (= o6 (store (elts (rec__main__branch_type__m_nodes branch__split_fields3))
  o5 o4))))
...
;; H
  ...
  (= i2 (to_rep
        (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))
  (= (rt (rec__main__branch_type__m_nodes branch__split_fields3)) o8)))
...
;; H
  ...
  (= i2 (to_rep
        (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))
  (= branch__split_discrs (mk___split_discrs temp___224))))
...
;; H
  ...
  (= i2 (to_rep
        (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))
  (= result2 (mk___split_fields__ref branch__split_fields3))))
...
;; H
  ...
  (= i2 (to_rep
        (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))
  (= branch__split_fields4 (mk___split_fields
                           (mk___t temp___2241 temp___2242)))))
...
;; H
  ...
  (= i2 (to_rep
        (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))))
  (= branch__split_fields4 branch__split_fields3)))
