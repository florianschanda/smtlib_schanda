...
;; H
  (assert
  (and
  (= o (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c))
  (= (= o true)
...
;; H
  (assert (= result3 (ite (= o2 (to_rep (select a1 i))) true false)))
...
;; H
  (assert
  (and (= o3 (key (mk___rep d__split_discrs d__split_fields1) c))
  (and (in_range7 o3)
  (= o3 (get (keys (mk___rep d__split_discrs d__split_fields1))
        (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
