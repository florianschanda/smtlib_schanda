...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a2 j))) o9))

;; H
  (assert
  (= (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a2 j))) o10))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a3 j))) o17))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a3 j))) o19))
...
(assert
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 218, characters 0-0
