...
(define-fun dynamic_invariant1 ((temp___expr_2028 Int)
...
(assert
;; WP_parameter_def
 ;; File "patris.ads", line 70, characters 0-0
  (not (not (= d 3))))
(check-sat)
(exit)
