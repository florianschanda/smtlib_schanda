...
;; shift_right__2__post_axiom
  ...
  (! (=>
     ...
     (= result (bvudiv value (ite (< count 256)
                             ...
                             ((_ int2bv 8) 0))))
     (dynamic_invariant result true false true)))) :pattern ((shift_right__2
                                                             value count)) ))))
...
(define-fun dynamic_invariant3 ((temp___expr_698 Int)
...
;; H
  (assert
  (=> (< (- 8 distance) 8)
  (= o (bvshl ((_ int2bv 8) 255) ((_ int2bv 8) (- 8 distance))))))
...
;; H
  ...
  true true true)
  (forall ((temp___1263 Int))
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1263)
  (<= temp___1263 (to_rep1 (last number__split_fields3))))
  (=> (<= i2 temp___1263)
  (= (select number__split_fields2 temp___1263) (select number__split_fields temp___1263))))))
  (and (<= 1 i2) (<= i2 r128b))))
...
;; H
  (assert
  (and (= o5 (shift_right__2 o4 (- 8 distance)))
  (= o5 (bvudiv o4 (ite (< (- 8 distance) 256)
...
;; H
  ...
  (= number__split_fields4 (mk___split_fields
                           (mk___t temp___12541 temp___12542))))
...
;; H
  ...
  (<= (to_rep1
      (first
      (rt (rec__very_longs__very_long__long_digits number__split_fields4))))
  i2)
  (<= i2 (to_rep1
         (last
         (rt (rec__very_longs__very_long__long_digits number__split_fields4)))))))
