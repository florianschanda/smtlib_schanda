...
(declare-datatypes ((drx_tune4h_type__ref 0))
...
(define-fun register_type__ref_122__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_86__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_86__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5016 us_t1)
  (temp___is_init_5013 Bool) (temp___skip_constant_5014 Bool)
  (temp___do_toplevel_5015 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5014 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5016)
                                       (last3 temp___expr_5016))
                                       (and (= (first3 temp___expr_5016) 1)
                                       (= (last3 temp___expr_5016) 2)))))
