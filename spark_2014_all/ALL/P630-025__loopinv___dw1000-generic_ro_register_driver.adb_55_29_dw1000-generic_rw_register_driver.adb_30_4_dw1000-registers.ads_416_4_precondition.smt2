...
(define-fun register_type__ref___122__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___86__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___86__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5094 us_t1)
  (temp___is_init_5091 Bool) (temp___skip_constant_5092 Bool)
  (temp___do_toplevel_5093 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5092 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5094)
                                       (last3 temp___expr_5094))
                                       (and (= (first3 temp___expr_5094) 1)
                                       (= (last3 temp___expr_5094) 2)))))
