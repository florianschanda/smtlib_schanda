...
(declare-fun money__Oadd__result () cur)

(declare-fun money__Oadd__result1 () raw_amount)
...
(declare-fun o5 () raw_amount)

(declare-fun result () cur)

(declare-fun result1 () raw_amount)

(declare-fun money__Oadd__result2 () cur)

(declare-fun money__Oadd__result3 () raw_amount)

(declare-fun money__Oadd__result4 () cur)

(declare-fun money__Oadd__result5 () raw_amount)

(declare-fun money__Oadd__result6 () cur)

(declare-fun money__Oadd__result7 () raw_amount)

(declare-fun money__Oadd__result8 () cur)

(declare-fun money__Oadd__result9 () raw_amount)

(declare-fun money__Oadd__result10 () cur)

(declare-fun money__Oadd__result11 () raw_amount)
...
(declare-fun result2 () cur)

(declare-fun result3 () raw_amount)
