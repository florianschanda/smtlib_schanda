...
(declare-const money__Oadd__result cur)

(declare-const money__Oadd__result1 raw_amount)
...
(declare-const money__Oadd__result2 cur)

(declare-const money__Oadd__result3 raw_amount)

(declare-const money__Oadd__result4 cur)

(declare-const money__Oadd__result5 raw_amount)

(declare-const money__Oadd__result6 cur)

(declare-const money__Oadd__result7 raw_amount)

(declare-const money__Oadd__result8 cur)

(declare-const money__Oadd__result9 raw_amount)

(declare-const money__Oadd__result10 cur)

(declare-const money__Oadd__result11 raw_amount)

(define-fun money__Oadd__result12 () us_rep (mk___rep
                                            (mk___split_fields
                                            money__Oadd__result2
                                            money__Oadd__result3)))
...
;; H
  (assert (= money__Oadd__result4 money__Oadd__result2))

;; H
  (assert (= money__Oadd__result5 money__Oadd__result3))

;; H
  (assert
  (= (mk___rep (mk___split_fields money__Oadd__result6 money__Oadd__result7))
  money__Oadd__result12))

;; H
  (assert
  (and
  (= o (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1
                                                                   (rec__money__amount__raw
                                                                   (us_split_fields1
                                                                   b)))))
  (in_range2
...
;; H
  (assert (= result money__Oadd__result))

;; H
  (assert (= result1 money__Oadd__result1))

;; H
  (assert (= money__Oadd__result12 (mk___rep (mk___split_fields o4 o5))))

;; H
  (assert
  (= (mk_amount__ref
     (mk___rep (mk___split_fields money__Oadd__result8 money__Oadd__result9)))
  (mk_amount__ref
  (mk___rep (mk___split_fields money__Oadd__result4 money__Oadd__result5)))))

;; H
  (assert (= money__Oadd__result10 money__Oadd__result6))

;; H
  (assert (= money__Oadd__result11 money__Oadd__result7))

;; H
  (assert (= result2 money__Oadd__result8))

;; H
  (assert (= result3 money__Oadd__result9))
...
;; WP_parameter_def
 ;; File "money.ads", line 17, characters 0-0
  ...
  (= (bool_eq
     (mk___rep (mk___split_fields money__Oadd__result8 money__Oadd__result9))
     (mk___rep
     (mk___split_fields (rec__money__amount__currency (us_split_fields1 a))
     (of_rep1
     (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1
                                                                 (rec__money__amount__raw
                                                                 (us_split_fields1
