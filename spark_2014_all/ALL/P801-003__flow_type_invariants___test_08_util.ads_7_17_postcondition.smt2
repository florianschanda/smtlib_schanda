...
(define-fun us_split_fields_N2__projection ((a us_split_fields)) integer
...
(declare-fun test_08_util__is_positive_bad__result () Bool)

(declare-fun result () Bool)

(declare-fun test_08_util__is_positive_bad__result1 () Bool)

(declare-fun test_08_util__is_positive_bad__result2 () Bool)

(declare-fun test_08_util__is_positive_bad__result3 () Bool)

(declare-fun test_08_util__is_positive_bad__result4 () Bool)

(declare-fun test_08_util__is_positive_bad__result5 () Bool)
