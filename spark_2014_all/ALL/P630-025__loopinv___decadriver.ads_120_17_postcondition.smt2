...
(declare-fun user_eq (result_type result_type) Bool)

(declare-fun dummy () result_type)
...
(define-fun dynamic_invariant ((temp___expr_4311 Int)
  (temp___is_init_4308 Bool) (temp___skip_constant_4309 Bool)
  (temp___do_toplevel_4310 Bool)) Bool (=>
                                       (or (= temp___is_init_4308 true)
                                       (<= 0 1)) (in_range1
                                       temp___expr_4311)))
...
(declare-fun user_eq2 (rx_frame_queue_index rx_frame_queue_index) Bool)

(declare-fun dummy2 () rx_frame_queue_index)
...
(declare-fun user_eq3 (frame_length frame_length) Bool)

(declare-fun dummy3 () frame_length)
...
;; range_axiom
  (assert
  (forall ((x frame_length)) (! (in_range4
...
(declare-fun user_eq4 (rx_errors rx_errors) Bool)

(declare-fun dummy4 () rx_errors)
...
;; range_axiom
  (assert
  (forall ((x rx_frame_queue_index)) (! (in_range3
...
(define-fun dynamic_invariant1 ((temp___expr_4469 us_rep1)
...
(define-fun dynamic_invariant3 ((temp___expr_4407 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_4413 Int)
...
(define-fun dynamic_predicate ((temp___4430 us_rep)) Bool (ite (= (to_rep1
                                                                  (rec__decadriver__rx_frame_type__error
                                                                  (us_split_fields1
                                                                  temp___4430))) 0)
                                                          (< 0 (to_rep
...
;; H
  (assert (=> (<= 0 1) (in_range1 result__)))

;; H
  (assert
  (and (=> (not (= delayed true)) (= result__1 0)) (in_range1 result__1)))

;; H
  (assert (= result__1 result__2))

;; H
  (assert (= device_state1 device_state))

;; H
  (assert (= result__3 result__1))

;; H
  (assert (= device_state2 device_state))
