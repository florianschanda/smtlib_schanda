...
(declare-fun current_candidate4 () Int)
...
;; H
  (assert (= o9 (store candidates3 current_candidate3 o8)))

;; H
  (assert (= candidates3 result6))

;; H
  (assert (= candidates4 o9))

;; H
  (assert (= o10 (end_of_file file)))
...
;; H
  (assert
  (and (= o13 (+ current_candidate3 1)) (in_range7 (+ current_candidate3 1))))

;; H
  (assert (= result8 current_candidate3))

;; H
  (assert (= current_candidate4 o13))

(declare-fun i () Int)

;; H
  (assert (<= current_candidate4 i))
