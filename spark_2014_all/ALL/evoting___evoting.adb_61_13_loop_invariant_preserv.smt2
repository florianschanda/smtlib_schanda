...
;; H
  (assert (= o10 (store candidates3 current_candidate3 o9)))

;; H
  (assert (= candidates3 result6))

;; H
  (assert (= candidates4 o10))

;; H
  (assert (= o11 (end_of_file file)))
...
;; H
  (assert
  (and (= o14 (+ current_candidate3 1)) (in_range7 (+ current_candidate3 1))))

;; H
  (assert (= result8 current_candidate3))

;; H
  (assert (= current_candidate4 o14))
