...
(declare-datatypes ()
((d_simple_1__ref (mk_d_simple_1__ref (d_simple_1__content us_rep)))))
(define-fun d_simple_1__ref___projection ((a d_simple_1__ref)) us_rep
  (d_simple_1__content a))

(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__use_private_types__d_holder_1__content us_rep)))))
(define-fun us_split_fields_Content4__projection ((a us_split_fields2)) us_rep
...
(declare-fun use_private_types__d_holder_1__content__first__bit () Int)

(declare-fun use_private_types__d_holder_1__content__last__bit () Int)

(declare-fun use_private_types__d_holder_1__content__position () Int)
...
(declare-datatypes ()
((d_holder_1__ref (mk_d_holder_1__ref (d_holder_1__content us_rep1)))))
(define-fun d_holder_1__ref___projection ((a d_holder_1__ref)) us_rep1
  (d_holder_1__content a))

(define-fun dynamic_invariant ((temp___expr_204 us_rep1)
  (temp___is_init_201 Bool) (temp___skip_constant_202 Bool)
  (temp___do_toplevel_203 Bool)) Bool (and
                                      (and (in_range2 1
                                      (rec__use_private_types__d_holder_1__content
                                      (us_split_fields3 temp___expr_204)))
                                      (= (attr__constrained
                                         (rec__use_private_types__d_holder_1__content
...
(define-fun dynamic_invariant2 ((temp___expr_169 us_rep)
  (temp___is_init_166 Bool) (temp___skip_constant_167 Bool)
  (temp___do_toplevel_168 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_167 true))
                                      (in_range2 1 temp___expr_169))
                                      (= (attr__constrained temp___expr_169) true)))
...
(assert
;; WP_parameter_def
 ;; File "use_private_types.ads", line 11, characters 0-0
