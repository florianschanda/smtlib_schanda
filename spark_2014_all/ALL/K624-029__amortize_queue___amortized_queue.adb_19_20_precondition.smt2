...
;; H
  (assert
  (=> (and (<= 1 idx2) (<= idx2 r4b))
  (= (mk___split_fields__ref (mk___split_fields result1)) result____split_fields11)))
...
;; H
  (assert
  (=> (and (<= 1 idx2) (<= idx2 r4b))
  (= (length (mk___rep result____split_discrs result____split_fields10))
  idx3)))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 idx3))
  (= (get
     (model__ (mk___rep result____split_discrs result____split_fields10)) i1)
  (get (model__ left) i1))))))
...
;; H
  ...
  (= result____split_fields6 result____split_fields11)))
...
;; H
  (assert (= result4 (ite (<= 1 i) o7 false)))
...
;; H
  (assert
  (and (= o10 (get (model__ left) o9))
  (and (in_range6 o10) (= o10 (get (model__ left) o9)))))
