...
;; H
  (assert
  (= result__2 (screen__writestatsdata__B251b__result__aggregate_def 32)))
...
;; H
  ...
  (= (select o2 temp___1407) (select result__2 temp___1407)))))
...
;; H
  (assert
  (= result__4 (screen__writestatsdata__B262b__result__aggregate_def 32)))
