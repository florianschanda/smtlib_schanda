...
;; H
  ...
  (and (= o32 (length model____split_fields)) (in_range6 o32))))

;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o32) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true)
  (and (= o31 (get model____split_fields 1)) (in_range7 o31)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o31 first_available) true false)))))
...
;; H
  ...
  (and (= o33 (length model____split_fields)) (in_range6 o33))))
...
;; H
  ...
  (and (= o29 (length model____split_fields1)) (in_range6 o29)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o29) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result3 true)
  (and (= o28 (get model____split_fields1 1)) (in_range7 o28))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o28 first_allocated) true false))))))
...
;; H
  ...
  (and (= o30 (length model____split_fields1)) (in_range6 o30)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_allocated 0)))
  (= result (ite (= o30 0) true false)))))
...
;; H
  (assert (and (= o27 (get model____split_fields j)) (in_range7 o27)))

;; H
  (assert (= result7 (ite (in_range4 o27) true false)))
...
;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true) (and (= o24 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true)
  (and (= o25 (get model____split_fields o24)) (in_range7 o25)))))
...
;; H
  (assert (=> (= result7 true) (and (<= 1 temp___385) (<= temp___385 3))))

;; H
  (assert (=> (= result7 true) (= o15 temp___385)))

;; H
  (assert
  (=> (= result7 true)
  (= (mk___rep (mk___split_fields o16 o17 o18)) (select data o15))))
...
;; H
  (assert
  (=> (= result6 true)
  (=> (< 1 j) (and (= o12 (- j 1)) (in_range2 (- j 1))))))

;; H
  (assert
  (=> (= result6 true)
  (=> (< 1 j) (and (= o13 (get model____split_fields o12)) (in_range7 o13)))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= temp___386 (get model____split_fields j)) (in_range7 temp___386))))

;; H
  (assert (=> (= result6 true) (and (<= 1 temp___386) (<= temp___386 3))))

;; H
  (assert (=> (= result6 true) (= o4 temp___386)))
