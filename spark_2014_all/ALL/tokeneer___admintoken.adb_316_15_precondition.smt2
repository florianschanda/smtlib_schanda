...
(define-fun us_split_fields_ID__6__projection ((a us_split_fields10)) us_rep1
  (rec__cert__id__contentst__id a))

(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields10)) us_rep2
  (rec__cert__id__contentst__notbefore a))

(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields10)) us_rep2
  (rec__cert__id__contentst__notafter a))

(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields10)) algorithmt
...
(define-fun us_split_fields__ref___13__projection ((a us_split_fields__ref5)) us_split_fields10
...
(define-fun contentst__ref___4__projection ((a contentst__ref1)) us_rep5
