...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1101 q_hat)))
...
;; H
  ...
  (= o14 (select (elts1
                 (rec__very_longs__very_long__long_digits1
                 (us_split_fields__content1 u__split_fields8))) o13)))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits remainder__split_fields3))))
  divisor_index2)))
(check-sat)
(exit)
