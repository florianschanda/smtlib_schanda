...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___429 i1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___428 result__1)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 amount))
  (= (bvand result__3 (let ((temp___432 (- i2 1)))
                      (ite (< temp___432 65536)
                      (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___432))
                      ((_ int2bv 16) 0)))) (let ((temp___433 (- i2 1)))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  ...
  (let ((temp___440 (- i9 1)))
  (ite (< temp___440 65536)
  (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___440)) ((_ int2bv 16) 0))))
  (let ((temp___441 (- i9 1)))
  (ite (< temp___441 65536)
  (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___441)) ((_ int2bv 16) 0))))))
(check-sat)
(exit)
