...
(declare-fun basic__r__x__first__bit3 () Int)

(declare-fun basic__r__x__last__bit3 () Int)

(declare-fun basic__r__x__position3 () Int)
...
(declare-fun basic__r__c_field1__first__bit3 () Int)

(declare-fun basic__r__c_field1__last__bit3 () Int)

(declare-fun basic__r__c_field1__position3 () Int)
...
(declare-fun basic__r__c_field2__first__bit3 () Int)

(declare-fun basic__r__c_field2__last__bit3 () Int)

(declare-fun basic__r__c_field2__position3 () Int)
...
(declare-fun basic__r__base__first__bit3 () Int)

(declare-fun basic__r__base__last__bit3 () Int)

(declare-fun basic__r__base__position3 () Int)
...
(declare-fun basic__r__a_field__first__bit3 () Int)

(declare-fun basic__r__a_field__last__bit3 () Int)

(declare-fun basic__r__a_field__position3 () Int)
...
(declare-fun x__split_fields3 () natural)

(declare-fun y__split_fields () integer)

(declare-fun y__split_fields1 () integer)

(declare-fun y__split_fields2 () Bool)

(declare-fun y__split_fields3 () natural)
...
(declare-fun conv__p__x__assume () enum)

(declare-fun conv__p__x__assume1 () integer)

(declare-fun conv__p__x__assume2 () integer)

(declare-fun conv__p__x__assume3 () Bool)

(declare-fun conv__p__x__assume4 () natural)

(declare-fun o23 () enum)
...
(declare-fun o30 () us_split_discrs)

(declare-fun conv__p__y__assume () us_rep)

(declare-fun o31 () us_rep)

(declare-fun o32 () us_rep)

(declare-fun conv__p__z__assume () us_rep)

(declare-fun result () us_split_fields__ref)

(declare-fun x__split_fields4 () us_split_fields)
