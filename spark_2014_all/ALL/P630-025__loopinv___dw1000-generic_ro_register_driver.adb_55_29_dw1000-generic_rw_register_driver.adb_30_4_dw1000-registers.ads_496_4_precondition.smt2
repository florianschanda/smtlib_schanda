...
(define-fun register_type__ref_162__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_114__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_114__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5829 us_t1)
  (temp___is_init_5826 Bool) (temp___skip_constant_5827 Bool)
  (temp___do_toplevel_5828 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5827 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5829)
                                       (last3 temp___expr_5829))
                                       (and (= (first3 temp___expr_5829) 1)
                                       (= (last3 temp___expr_5829) 1)))))
