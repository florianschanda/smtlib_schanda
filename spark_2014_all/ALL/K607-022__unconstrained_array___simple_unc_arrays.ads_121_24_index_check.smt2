...
(declare-fun a1 () (Array Int value))

(declare-fun result3 () (Array Int value))

(declare-fun a2 () (Array Int value))

(declare-fun a3 () (Array Int value))

(declare-fun tmp3 () Int)

(declare-fun a4 () (Array Int value))
...
;; H
  ...
  (=> (and (not (= k i)) (not (= k j)))
  (= (to_rep1 (select a3 k)) (to_rep1 (select a k))))))))
