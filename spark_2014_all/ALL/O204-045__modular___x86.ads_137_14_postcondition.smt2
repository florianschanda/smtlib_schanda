...
;; H
  (assert
  (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8)
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= rdx2 (bvor (bvand rdx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8)
  val__) ((_ int2bv 16) 256)))))))
(check-sat)
(exit)
