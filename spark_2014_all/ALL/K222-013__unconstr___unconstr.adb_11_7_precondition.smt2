...
(((mk_myint__ref (myint__content myint)))))
...
(((mk_map__ref (map__content (Array Int myint))))))
...
(declare-datatypes ((us_t 0)) (((mk___t (elts (Array Int myint))(rt t)))))
...
(declare-datatypes ((vec__ref 0)) (((mk_vec__ref (vec__content us_t)))))
...
(declare-const dummy3 tvec_10_subP1)
