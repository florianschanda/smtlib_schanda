...
(declare-fun temp___1198 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___1198 (model__
                 ...
                 o1))
  (and (dynamic_invariant3 temp___1198 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1198 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1198 o1)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1198 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1198 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1198 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1198 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1198 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1198 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1198 j)))) true))
  (= j i1)))))))))))))))
...
;; H
  ...
  (< 0 (to_rep
       (rec__binary_trees__cell__parent
       (us_split_fields3 (select f__split_fields1 i)))))
  (= (mk___rep (mk___split_fields o3 o4)) (select temp___1198 o2))))
