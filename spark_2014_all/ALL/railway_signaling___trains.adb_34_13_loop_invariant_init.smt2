...
(define-fun bool_eq4 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq3 (select a temp___idx_182)
...
(define-fun bool_eq13 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
...
(define-fun bool_eq15 ((a (Array Int track_opt_id)) (a__first Int)
...
(define-fun bool_eq16 ((a (Array Int (Array Int track_opt_id)))
  (a__first Int) (a__last Int) (b (Array Int (Array Int track_opt_id)))
  (b__first Int)
  (b__last Int)) Bool (ite (and
                           (ite (<= a__first a__last)
                           (and (<= b__first b__last)
                           ...
                           (= (bool_eq15 (select a temp___idx_144) 1 3
...
;; WP_parameter_def
 ;; File "trains.ads", line 155, characters 0-0
  (not (not (= (is_previous_track (select trains t) track) true))))
(check-sat)
