...
;; def_axiom
  (assert
  (forall ((temp___511 (Array Int unsigned_byte)))
  (forall ((temp___512 Int))
  (= (select (temp___509 temp___511) temp___512) temp___511))))

(declare-fun temp___513 (Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___515 Int) (temp___516 Int))
  (let ((temp___514 (temp___513 temp___515 temp___516)))
  (forall ((temp___517 Int))
  (ite (= temp___517 5)
  (= (select temp___514 temp___517) (of_rep temp___515))
  (= (select temp___514 temp___517) (of_rep temp___516)))))))
