...
(declare-const the_stack us_private)

(declare-const p_stack us_private)
...
;; H
  (assert
  (and (not (= (is_empty the_stack) true))
  (not (= (is_empty2 p_top p_stack p_content) true))))
...
;; H
  (assert (=> (<= 1 2147483647) (in_range1 f)))
