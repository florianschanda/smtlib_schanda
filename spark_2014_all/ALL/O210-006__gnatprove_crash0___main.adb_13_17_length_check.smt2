...
(declare-datatypes ((tS5bP1__ref 0))
(((mk_tS5bP1__ref (tS5bP1__content integer)))))
...
(declare-datatypes ((s5b__ref 0)) (((mk_s5b__ref (s5b__content us_t1)))))
...
;; def_axiom
  ...
  (and (= (first5 temp___210) temp___212) (= (last5 temp___210) temp___213)))
...
;; H
  (assert (= (to_rep1 (last4 (rt2 (temp___209 0 0 r6b)))) r6b))
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___2161)) (to_rep1 (last4 temp___2161)))
     (+ (- (to_rep1 (last4 temp___2161)) (to_rep1 (first4 temp___2161))) 1)
...
;; H
  (assert
  (= (mk1 (to_rep1 (first4 temp___2161)) (to_rep1 (last4 temp___2161)))
  temp___2171))
...
;; WP_parameter_def
 ;; File "main.adb", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___2171)) (to_rep1 (last2 temp___2171)))
     (+ (- (to_rep1 (last2 temp___2171)) (to_rep1 (first2 temp___2171))) 1)
