...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__default_init__t2__a integer)))))
...
(declare-fun default_init__t2__a__first__bit () Int)

(declare-fun default_init__t2__a__last__bit () Int)

(declare-fun default_init__t2__a__position () Int)
...
(define-fun default_initial_assumption1 ((temp___expr_150 (Array Int integer))
  (temp___skip_top_level_151 Bool)) Bool (forall ((temp___152 Int))
                                         (=>
                                         (and (<= 1 temp___152)
                                         (<= temp___152 10))
                                         (= (to_rep
                                            (select temp___expr_150 temp___152)) 100))))
...
;; H
  (assert (= (to_rep x2__split_fields) 100))

;; H
  (assert (default_initial_assumption1 x3 false))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (to_rep x2__split_fields) 100)))
(check-sat)
(exit)
