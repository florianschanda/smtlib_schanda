...
(((mk_empty_rec1__ref (empty_rec1__content us_rep)))))
...
(((mk_non_init1__ref (non_init1__content us_rep1)))))
...
(declare-datatypes ((t37b__ref 0)) (((mk_t37b__ref (t37b__content t37b)))))
...
(((mk_empty_rec2__ref (empty_rec2__content us_rep2)))))
...
(((mk___rep3 (us_split_fields3 us_split_fields2)))))
...
(((mk_non_init2__ref (non_init2__content us_rep3)))))
