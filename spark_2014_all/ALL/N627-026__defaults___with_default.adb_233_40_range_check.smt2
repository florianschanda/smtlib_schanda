...
(define-fun us_split_discrs_11__projection ((a us_split_discrs)) positive
  (rec__with_default__ok_nested_defaults__empty_rec1__d a))

(declare-datatypes ()
((us_split_discrs__ref
 (mk___split_discrs__ref (us_split_discrs__content us_split_discrs)))))
(define-fun us_split_discrs__ref_11__projection ((a us_split_discrs__ref)) us_split_discrs
...
(define-fun us_rep_32__projection ((a us_rep)) Bool (attr__constrained a))
...
(declare-fun with_default__ok_nested_defaults__empty_rec1__d__first__bit () Int)

(declare-fun with_default__ok_nested_defaults__empty_rec1__d__last__bit () Int)

(declare-fun with_default__ok_nested_defaults__empty_rec1__d__position () Int)
...
(declare-datatypes ()
((empty_rec1__ref (mk_empty_rec1__ref (empty_rec1__content us_rep)))))
(define-fun empty_rec1__ref___projection ((a empty_rec1__ref)) us_rep
...
(define-fun bool_eq1 ((a (Array Int us_rep)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq (select a temp___idx_140)
...
(define-fun us_split_fields_E3__projection ((a us_split_fields)) (Array Int us_rep)
...
(define-fun us_rep_33__projection ((a us_rep1)) us_split_fields (us_split_fields1
                                                                a))
...
(declare-fun with_default__ok_nested_defaults__non_init1__e__first__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init1__e__last__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init1__e__position () Int)
...
(declare-fun with_default__ok_nested_defaults__non_init1__f__first__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init1__f__last__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init1__f__position () Int)
...
(declare-datatypes ()
((non_init1__ref (mk_non_init1__ref (non_init1__content us_rep1)))))
(define-fun non_init1__ref___projection ((a non_init1__ref)) us_rep1
  (non_init1__content a))

(define-fun dynamic_invariant1 ((temp___expr_567 us_rep1)
  (temp___is_init_564 Bool) (temp___skip_constant_565 Bool)
  (temp___do_toplevel_566 Bool)) Bool (forall ((temp___568 Int))
                                      (=>
                                      (and (<= 1 temp___568)
                                      (<= temp___568 0))
                                      (= (attr__constrained
                                         (select (rec__with_default__ok_nested_defaults__non_init1__e
                                                 (us_split_fields1
                                                 temp___expr_567)) temp___568)) false))))

(define-fun default_initial_assumption ((temp___expr_570 us_rep1)
  (temp___skip_top_level_571 Bool)) Bool (forall ((temp___573 Int))
                                         (=>
                                         (and (<= 1 temp___573)
                                         (<= temp___573 0))
                                         (and
                                         (= (attr__constrained
                                            (select (rec__with_default__ok_nested_defaults__non_init1__e
                                                    (us_split_fields1
                                                    temp___expr_570)) temp___573)) false)
                                         (= (to_rep1
                                            (rec__with_default__ok_nested_defaults__empty_rec1__d
                                            (us_split_discrs1
                                            (select (rec__with_default__ok_nested_defaults__non_init1__e
                                                    (us_split_fields1
                                                    temp___expr_570)) temp___573))))
                                         c)))))
...
(define-fun us_split_discrs_12__projection ((a us_split_discrs2)) positive
...
(define-fun us_split_discrs__ref_12__projection ((a us_split_discrs__ref1)) us_split_discrs2
  (us_split_discrs__content1 a))

(declare-datatypes ()
((us_rep2
 (mk___rep2 (us_split_discrs3 us_split_discrs2)(attr__constrained1 Bool)))))
(define-fun us_rep_34__projection ((a us_rep2)) us_split_discrs2 (us_split_discrs3
                                                                 a))

(define-fun us_rep_35__projection ((a us_rep2)) Bool (attr__constrained1 a))
...
(declare-fun with_default__ok_nested_defaults__empty_rec2__d__first__bit () Int)

(declare-fun with_default__ok_nested_defaults__empty_rec2__d__last__bit () Int)

(declare-fun with_default__ok_nested_defaults__empty_rec2__d__position () Int)
...
(declare-datatypes ()
((empty_rec2__ref (mk_empty_rec2__ref (empty_rec2__content us_rep2)))))
(define-fun empty_rec2__ref___projection ((a empty_rec2__ref)) us_rep2
...
(define-fun us_split_fields_E4__projection ((a us_split_fields2)) (Array Int us_rep2)
...
(declare-datatypes ()
((us_rep3 (mk___rep3 (us_split_fields3 us_split_fields2)))))
(define-fun us_rep_36__projection ((a us_rep3)) us_split_fields2 (us_split_fields3
                                                                 a))
...
(declare-fun with_default__ok_nested_defaults__non_init2__e__first__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init2__e__last__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init2__e__position () Int)
...
(declare-fun with_default__ok_nested_defaults__non_init2__f__first__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init2__f__last__bit () Int)

(declare-fun with_default__ok_nested_defaults__non_init2__f__position () Int)
...
(declare-datatypes ()
((non_init2__ref (mk_non_init2__ref (non_init2__content us_rep3)))))
(define-fun non_init2__ref___projection ((a non_init2__ref)) us_rep3
  (non_init2__content a))

(define-fun dynamic_invariant2 ((temp___expr_594 us_rep3)
  (temp___is_init_591 Bool) (temp___skip_constant_592 Bool)
  (temp___do_toplevel_593 Bool)) Bool (forall ((temp___595 Int))
                                      (=>
                                      (and (<= 1 temp___595)
                                      (<= temp___595 100))
                                      (= (attr__constrained1
                                         (select (rec__with_default__ok_nested_defaults__non_init2__e
                                                 (us_split_fields3
                                                 temp___expr_594)) temp___595)) false))))

(define-fun default_initial_assumption1 ((temp___expr_597 us_rep3)
  (temp___skip_top_level_598 Bool)) Bool (forall ((temp___600 Int))
                                         (=>
                                         (and (<= 1 temp___600)
                                         (<= temp___600 100))
                                         (and
                                         (= (attr__constrained1
                                            (select (rec__with_default__ok_nested_defaults__non_init2__e
                                                    (us_split_fields3
                                                    temp___expr_597)) temp___600)) false)
                                         (= (to_rep1
                                            (rec__with_default__ok_nested_defaults__empty_rec2__d
                                            (us_split_discrs3
                                            (select (rec__with_default__ok_nested_defaults__non_init2__e
                                                    (us_split_fields3
                                                    temp___expr_597)) temp___600)))) 1)))))
...
(define-fun default_initial_assumption2 ((temp___expr_555 us_rep)
  (temp___skip_top_level_556 Bool)) Bool (and
                                         (= (attr__constrained
                                            temp___expr_555) false)
                                         (= (to_rep1
                                            (rec__with_default__ok_nested_defaults__empty_rec1__d
                                            (us_split_discrs1
                                            temp___expr_555))) c)))

(define-fun default_initial_assumption3 ((temp___expr_582 us_rep2)
  (temp___skip_top_level_583 Bool)) Bool (and
                                         (= (attr__constrained1
                                            temp___expr_582) false)
                                         (= (to_rep1
                                            (rec__with_default__ok_nested_defaults__empty_rec2__d
                                            (us_split_discrs3
                                            temp___expr_582))) 1)))
