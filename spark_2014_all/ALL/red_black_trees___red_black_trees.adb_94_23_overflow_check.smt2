...
(declare-fun o21 () us_split_fields10)
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__count
      (us_split_fields11 (select res2 i1)))) (to_rep
                                             (rec__red_black_trees__black_count__depth
                                             (us_split_fields11
                                             (select res2 i1))))))))
...
;; H
  ...
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i1)))) 100)
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select res2 i1)))) n2)))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 100))
  (ite (and
       (= (rec__tree_model__path_type__k (us_split_fields1 (select m i1))) true)
       (< n2 (to_rep
             (rec__red_black_trees__black_count__depth
             (us_split_fields11 (select res2 i1))))))
  (< (length
     (rec__tree_model__path_type__a (us_split_fields1 (select m i1)))) (- 100 
  n2))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i1))) true)
  (and
  ...
  (=
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11 (select res2 i1))) true)
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11
     (select res2 (peek
                  (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i1
                  0))))) (to_rep
                         (rec__red_black_trees__black_count__count
                         (us_split_fields11
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i1 1))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i1)))) (+ 1 (ite (< (to_rep
                                                         (rec__red_black_trees__black_count__depth
                                                         (us_split_fields11
                                                         (select res2 
                                                         (peek
  ...
  (select res2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t))
               i1 1))))) (to_rep
                         ...
                         (select res2 (peek
                                      (rec__red_black_trees__rbt__struct
                                      (us_split_fields9 t)) i1 0)))))))))
  (= (to_rep
     (rec__red_black_trees__black_count__count
     (us_split_fields11 (select res2 i1)))) (+ (ite (= (to_rep3
...
;; H
  (assert
  (not
  (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select m i))) true) (< 
  n2 (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select res2 i))))) false)))

;; H
  (assert
  (= (rec__tree_model__path_type__k (us_split_fields1 (select m i))) true))

;; H
  (assert
  (and
  (= o17 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i 0))
  (and (in_range3 o17)
  (= o17 (peek1
         (rec__search_trees__search_tree__struct
         (us_split_fields7
...
;; H
  (assert (= (mk___rep5 (mk___split_fields5 o18 o19 o20)) (select res2 
  o17)))

;; H
  (assert (= o21 (mk___split_fields5 o18 o19 o20)))

;; H
  (assert (= o22 (rec__red_black_trees__black_count__count o21)))
