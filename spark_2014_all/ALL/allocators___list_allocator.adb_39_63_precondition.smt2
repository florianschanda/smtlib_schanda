...
;; H
  (assert
  (and (= o13 (length model____split_fields))
  (and (in_range6 o13) (<= (+ 0 o13) 2147483647))))

;; H
  (assert (= result3 (ite (<= o13 10000) true false)))

;; H
  (assert
  (=> (= result3 true)
  (and (= o12 (length1 model____split_fields1)) (in_range6 o12))))

;; H
  (assert (=> (= result3 true) (= result2 (ite (<= o12 10000) true false))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o8 (length1 model____split_fields1)) (in_range6 o8))))

;; H
  (assert
  (=> (= result2 true)
  (and (= o9 (length model____split_fields))
  (and (in_range6 o9) (<= (+ 0 o9) 2147483647)))))

;; H
  (assert (=> (= result2 true) (= o10 (+ o9 o8))))

;; H
  (assert (=> (= result2 true) (and (= o11 o10) (in_range2 o10))))

;; H
  (assert (=> (= result2 true) (= result1 (ite (= o11 10000) true false))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result4 (ite (< 0 o6) true false)))))
...
;; H
  ...
  (=> (not (= first_available 0))
  (=> (= result4 true)
  (and (= o5 (get model____split_fields 1)) (in_range7 o5))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result4 true) (= result (ite (= o5 first_available) true false))))))
...
;; H
  ...
  (and (= o7 (length model____split_fields))
  (and (in_range6 o7) (<= (+ 0 o7) 2147483647))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_available 0))) (= result (ite (= o7 0) true false)))))
...
;; H
  (assert (and (= o4 (get model____split_fields j)) (in_range7 o4)))

;; H
  (assert (= result6 (ite (in_range4 o4) true false)))
