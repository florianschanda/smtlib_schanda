...
(declare-fun dynamic_preds__call_init_even__x () Int)

(declare-fun dynamic_preds__call_init_even__x1 () Int)
...
;; H
  (assert (= o dynamic_preds__call_init_even__x))

;; H
  (assert (dynamic_invariant1 dynamic_preds__call_init_even__x1 true true
  true))
...
;; H
  (assert (= x1 dynamic_preds__call_init_even__x1))
