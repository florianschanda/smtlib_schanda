...
(define-fun us_rep___2__projection ((a us_rep3)) us_split_fields2 (us_split_fields3
                                                                  a))
...
(define-fun us_rep___4__projection ((a us_rep5)) us_split_fields6 (us_split_fields7
                                                                  a))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields10)
     i1)) (to_rep
          (select (rec__search_trees__search_tree__values t__split_fields10)
          j3)))))
(check-sat)
