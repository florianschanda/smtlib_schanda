...
;; H
  (assert
  (and
  (= o (symmetric_difference__2 (mk___rep k__split_discrs k__split_fields3)
       (mk___rep l__split_discrs l__split_fields9)))
  (and
  (and
  (and
  ...
  (and
  (and
  (= (length o) (+ (- (length (mk___rep k__split_discrs k__split_fields3)) (* 2
  (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3))
  (model__ (mk___rep l__split_discrs l__split_fields9))))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields9))))
  (= (not_in_both (model__ o)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields9))) true))
  (= (included_in_union (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ o) (model__ (mk___rep l__split_discrs l__split_fields9))) true))
  (= (included_in_union (model__ (mk___rep l__split_discrs l__split_fields9))
     (model__ o) (model__ (mk___rep k__split_discrs k__split_fields3))) true))
  (= (e_elements_included__3 (elements o)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields9))) true))
  (= (e_elements_included__2
     (elements (mk___rep k__split_discrs k__split_fields3)) (model__ o)
     (elements o)) true))
  (= (e_elements_included__2
     (elements (mk___rep l__split_discrs l__split_fields9)) (model__ o)
     (elements o)) true))))
...
;; WP_parameter_def
 ;; File "my_sets.adb", line 177, characters 0-0
  (not
  (<= (length (mk___rep m__split_discrs3 m__split_fields14)) (- 2147483647
