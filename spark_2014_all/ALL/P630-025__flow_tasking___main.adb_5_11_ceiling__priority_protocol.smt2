...
(declare-fun user_eq1 (example_pt example_pt) Bool)
...
(declare-datatypes ((example_pt__ref 0))
(((mk_example_pt__ref (example_pt__content example_pt)))))
...
(define-fun dynamic_invariant ((temp___expr_214 Int)
  ...
  (temp___do_toplevel_213 Bool)) Bool (=>
                                      ...
                                      (<= 98 98)) (in_range temp___expr_214)))

(assert
;; WP_parameter_def
 ;; File "gnat_bug.ads", line 20, characters 0-0
  (not (<= 48 98)))
(check-sat)
(exit)
