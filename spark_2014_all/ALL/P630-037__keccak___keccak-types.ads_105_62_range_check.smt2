...
(declare-fun dummy1 () unsigned_2)

(declare-datatypes ()
((unsigned_2__ref (mk_unsigned_2__ref (unsigned_2__content unsigned_2)))))
(define-fun unsigned_2__ref___projection ((a unsigned_2__ref)) unsigned_2
...
(assert
;; WP_parameter_def
 ;; File "keccak-types.ads", line 40, characters 0-0
  (not (in_range1 o1)))
(check-sat)
(exit)
