...
;; H
  (assert
  (and (= us (to_rep1 (rec__const__t__k (us_split_discrs1 x)))) (in_range1
  (to_rep1 (rec__const__t__k (us_split_discrs1 x))))))
...
;; WP_parameter_def
 ;; File "const.ads", line 9, characters 0-0
  (not
  (<= (to_rep2 (first (rt (rec__const__t__arr (us_split_fields1 x))))) 1)))
(check-sat)
(exit)
