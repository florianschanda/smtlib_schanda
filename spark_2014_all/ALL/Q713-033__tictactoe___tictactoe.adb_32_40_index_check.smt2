...
(declare-fun dummy6 () (Array Int slot))
...
(declare-fun tictactoe__player_play__B_2__s__assume () (Array Int character))

(declare-fun tictactoe__player_play__B_2__s__assume1 () t)
