...
;; writereghigh8post__post_axiom
  ...
  (! (=>
     ...
     (= (= (writereghigh8post regold regnew val__) true)
     (and (= (readreghigh8 regnew) val__)
     (= (bvand regnew ((_ int2bv 64) 18446744073709486335)) (bvand regold ((_ int2bv 64) 18446744073709486335)))))) :pattern (
  (writereghigh8post regold regnew val__)) ))))
...
;; H
  (assert
  (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744073709486335)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8)
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= (writereghigh8post rdx rdx2 val__) true)))
(check-sat)
(exit)
