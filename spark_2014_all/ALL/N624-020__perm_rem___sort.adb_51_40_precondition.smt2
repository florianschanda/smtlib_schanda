...
;; H
  (assert
  (and (= o18 (remove o16 o17))
  (and (dynamic_invariant4 o18 true false true)
  (and (= (invariant__ o18) true)
  (and (= (to_rep1 (last (rt o18))) (- (to_rep1 (last (rt o16))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o17 1)))
  (= (to_rep (select (elts o16) k)) (to_rep (select (elts o18) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o17 1) k) (<= k (to_rep1 (last (rt o16)))))
  (= (to_rep (select (elts o16) k)) (to_rep (select (elts o18) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o17 k) (<= k (- (to_rep1 (last (rt o16))) 1)))
  (= (to_rep (select (elts o16) (+ k 1))) (to_rep (select (elts o18) k))))))))))))
