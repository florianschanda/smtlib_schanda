...
;; range_axiom
  (assert
  (forall ((x enum2t)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-fun ar__rofaofrofa__d1__first__bit () Int)

(declare-fun ar__rofaofrofa__d1__last__bit () Int)

(declare-fun ar__rofaofrofa__d1__position () Int)
...
(declare-fun ar__rofaofrofa__e1__first__bit () Int)

(declare-fun ar__rofaofrofa__e1__last__bit () Int)

(declare-fun ar__rofaofrofa__e1__position () Int)
...
(declare-datatypes ()
((rofaofrofa__ref (mk_rofaofrofa__ref (rofaofrofa__content us_rep1)))))
...
(define-fun dynamic_invariant3 ((temp___expr_206 Int)
  ...
  (temp___do_toplevel_205 Bool)) Bool (=>
                                      ...
                                      (<= 0 5)) (in_range4 temp___expr_206)))

(declare-fun r__split_fields () (Array Int us_rep))

(declare-fun r__split_fields1 () (Array Int et1))
...
(declare-fun o5 () enum2t)

(declare-fun o6 () (Array Int us_rep))

(declare-fun o7 () (Array Int us_rep))

(declare-fun o8 () (Array Int et1))

(declare-fun temp___9982 () (Array Int us_rep))

(declare-fun temp___99821 () (Array Int et1))

(declare-fun result () (Array Int us_rep))

(declare-fun result1 () (Array Int et1))

(declare-fun r__split_fields2 () (Array Int us_rep))

(declare-fun r__split_fields3 () (Array Int et1))

(declare-fun r__split_fields4 () (Array Int us_rep))

(declare-fun r__split_fields5 () (Array Int et1))

(declare-fun r__split_fields6 () (Array Int us_rep))

(declare-fun r__split_fields7 () (Array Int et1))
...
;; H
  (assert (= temp___9982 o7))

;; H
  (assert (= temp___99821 o8))
...
;; H
  (assert (= temp___9982 r__split_fields2))

;; H
  (assert (= temp___99821 r__split_fields3))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1868, characters 0-0
  (not (in_range4
  (to_rep1
  (rec__ar__rofa1__t1 (us_split_fields1 (select r__split_fields4 m)))))))
(check-sat)
