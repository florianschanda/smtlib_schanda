...
(declare-fun usedlogfiles__split_fields4 () logfilecountt)
...
;; H
  (assert
  (and
  (and (<= 1 (to_rep3 usedlogfiles__split_fields4))
  (= numberlogentries1 (+ (* (- (to_rep3 usedlogfiles__split_fields4) 1) 1024)
...
;; WP_parameter_def
 ;; File "auditlog.ads", line 33, characters 0-0
  (not (<= 1 (to_rep3 usedlogfiles__split_fields4))))
(check-sat)
(exit)
