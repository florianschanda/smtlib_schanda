...
;; H
  (assert
  (and (= o5 (length left)) (and (in_range5 o5) (<= o5 (capacity left)))))
...
;; H
  (assert
  (and (= o7 (length (vector__content amortized_queue__Oconcat__3__result5)))
  (and (in_range5 o7)
  (<= o7 (capacity (vector__content amortized_queue__Oconcat__3__result5))))))
