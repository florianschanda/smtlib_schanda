...
;; H
  (assert (and (<= 1 temp___1191) (<= temp___1191 17)))

;; H
  (assert (= o13 temp___1191))

;; H
  (assert
  (= o14 (select (rec__auditlog__logfilelistt__list
                 usedlogfiles__split_fields8) o13)))

;; H
  (assert (= o15 (to_rep4 o14)))

;; H
  (assert (= (to_rep4 o16) o15))
