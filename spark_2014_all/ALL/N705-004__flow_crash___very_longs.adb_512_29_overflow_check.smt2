...
(((mk_t17s__ref (t17s__content tdigit_index_typeB)))))
...
(define-fun dynamic_invariant3 ((temp___expr_686 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_692 Int)
  (temp___is_init_689 Bool) (temp___skip_constant_690 Bool)
  (temp___do_toplevel_691 Bool)) Bool (=>
                                      (or (= temp___is_init_689 true)
                                      (<= first2 last3)) (dynamic_property3
                                      first2 last3 temp___expr_692)))
...
(declare-datatypes ((tT100bP1__ref 0))
(((mk_tT100bP1__ref (tT100bP1__content tdigit_index_typeB)))))
...
(((mk_t100b__ref (t100b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits__29__projection ((a us_split_fields2)) us_t1
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___29__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep___57__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                  a))

(define-fun us_rep___58__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))
...
(define-fun dynamic_invariant6 ((temp___expr_704 us_rep1)
...
(define-fun default_initial_assumption ((temp___expr_707 us_rep1)
  (temp___skip_top_level_708 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_707))) (+ (* 2
  (to_rep
...
(declare-datatypes ((tT101bP1__ref 0))
(((mk_tT101bP1__ref (tT101bP1__content tdigit_index_typeB)))))
...
(((mk_t101b__ref (t101b__content us_t2)))))
...
(define-fun us_split_fields_Long_Digits__30__projection ((a us_split_fields4)) us_t2
  (rec__very_longs__very_long__long_digits2 a))

(declare-datatypes ((us_split_fields__ref2 0))
(((mk___split_fields__ref2 (us_split_fields__content2 us_split_fields4)))))
(define-fun us_split_fields__ref___30__projection ((a us_split_fields__ref2)) us_split_fields4
  (us_split_fields__content2 a))

(declare-datatypes ((us_rep2 0))
(((mk___rep2
  (us_split_discrs3 us_split_discrs)(us_split_fields5 us_split_fields4)))))
(define-fun us_rep___59__projection ((a us_rep2)) us_split_discrs (us_split_discrs3
                                                                  a))

(define-fun us_rep___60__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                   a))
...
(define-fun dynamic_invariant7 ((temp___expr_716 us_rep2)
...
(define-fun default_initial_assumption1 ((temp___expr_719 us_rep2)
  (temp___skip_top_level_720 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__octet_length
                                            (us_split_discrs3
                                            temp___expr_719))) (to_rep
                                                               (rec__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               divisor)))))
...
;; get_msd__post_axiom
  ...
  (! (=>
     ...
     (not
     (= (to_rep1
        (let ((temp___727 (rec__very_longs__very_long__long_digits
                          (us_split_fields1 number))))
        (select (to_array temp___727) result))) ((_ int2bv 8) 0)))
     (forall ((i Int))
     (=>
     (and (<= (+ result 1) i)
     (<= i (last1
           ...
           (us_split_fields1 number)))))
     (= (to_rep1
        (let ((temp___728 (rec__very_longs__very_long__long_digits
                          (us_split_fields1 number))))
        (select (to_array temp___728) i))) ((_ int2bv 8) 0)))))
     (dynamic_invariant result true false true)))) :pattern ((get_msd number)) )))
...
(declare-datatypes ((tS136bP1__ref 0))
(((mk_tS136bP1__ref (tS136bP1__content tdigit_index_typeB)))))
...
(((mk_s136b__ref (s136b__content us_t3)))))
...
(((mk_t138b__ref (t138b__content tdigit_index_typeB)))))
...
(((mk_t139b__ref (t139b__content us_t4)))))
...
(declare-datatypes ((tS140bP1__ref 0))
(((mk_tS140bP1__ref (tS140bP1__content tdigit_index_typeB)))))
...
(((mk_s140b__ref (s140b__content us_t5)))))
...
(((mk_t142b__ref (t142b__content tdigit_index_typeB)))))
...
(((mk_t143b__ref (t143b__content us_t6)))))
...
;; def_axiom
  (assert
  (forall ((temp___1078 (_ BitVec 8)))
  (forall ((temp___1079 Int) (temp___1080 Int))
  (let ((temp___1077 (temp___1076 temp___1078 temp___1079 temp___1080)))
  (and
  (=> (dynamic_property16 1 2147483647 temp___1079 temp___1080)
  (and (= (first10 temp___1077) temp___1079)
  (= (last11 temp___1077) temp___1080)))
  (forall ((temp___1081 Int))
  (= (select (to_array4 temp___1077) temp___1081) (of_rep1 temp___1078))))))))

(declare-fun temp___1089 ((_ BitVec 8) Int Int) us_t6)

;; def_axiom
  (assert
  (forall ((temp___1091 (_ BitVec 8)))
  (forall ((temp___1092 Int) (temp___1093 Int))
  (let ((temp___1090 (temp___1089 temp___1091 temp___1092 temp___1093)))
  (and
  (=> (dynamic_property16 1 2147483647 temp___1092 temp___1093)
  (and (= (first14 temp___1090) temp___1092)
  (= (last15 temp___1090) temp___1093)))
  (forall ((temp___1094 Int))
  (= (select (to_array6 temp___1090) temp___1094) (of_rep1 temp___1091))))))))

(define-fun dynamic_invariant9 ((temp___expr_785 us_t3)
  (temp___is_init_782 Bool) (temp___skip_constant_783 Bool)
  (temp___do_toplevel_784 Bool)) Bool (=>
                                      (not (= temp___skip_constant_783 true))
                                      (and (dynamic_property9 1 r137b
                                      (first8 temp___expr_785)
                                      (last9 temp___expr_785))
                                      (and (= (first8 temp___expr_785) 1)
                                      (= (last9 temp___expr_785) r137b)))))

(define-fun dynamic_invariant10 ((temp___expr_794 us_t5)
  (temp___is_init_791 Bool) (temp___skip_constant_792 Bool)
  (temp___do_toplevel_793 Bool)) Bool (=>
                                      (not (= temp___skip_constant_792 true))
                                      (and (dynamic_property13 1 r141b
                                      (first12 temp___expr_794)
                                      (last13 temp___expr_794))
                                      (and (= (first12 temp___expr_794) 1)
                                      (= (last13 temp___expr_794) r141b)))))
...
;; H
  (assert
  (= (to_rep (rec__very_longs__very_long__octet_length u__split_discrs)) (+ (* 2
  (to_rep
  (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))) 1)))
...
;; H
  (assert
  (= (to_rep (rec__very_longs__very_long__octet_length v__split_discrs))
  (to_rep
  (rec__very_longs__very_long__octet_length (us_split_discrs1 divisor)))))
...
;; H
  (assert
  (= (to_rep
     (rec__very_longs__very_long__octet_length quotient__split_discrs))
  r137b))

;; H
  (assert (in_range2 r137b))

;; H
  (assert
  (= (to_rep2 (first9 (rt4 (temp___1076 ((_ int2bv 8) 0) 1 r137b)))) 1))

;; H
  (assert
  (= (to_rep2 (last10 (rt4 (temp___1076 ((_ int2bv 8) 0) 1 r137b))))
  r137b))

;; H
  (assert
  (= (mk___t4 temp___1083 temp___10831) (temp___1076 ((_ int2bv 8) 0) 1
                                        r137b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first9 temp___10831)) (to_rep2 (last10 temp___10831)))
     (+ (- (to_rep2 (last10 temp___10831)) (to_rep2 (first9 temp___10831))) 1)
     0) (ite (<= 1 r137b) (+ (- r137b 1) 1) 0)))

;; H
  (assert (= temp___1083 temp___1084))

;; H
  (assert
  (= (mk3 (to_rep2 (first9 temp___10831)) (to_rep2 (last10 temp___10831)))
  temp___10841))

;; H
  (assert
  (= (ite (<= (to_rep2 (first7 temp___10841)) (to_rep2 (last8 temp___10841)))
     (+ (- (to_rep2 (last8 temp___10841)) (to_rep2 (first7 temp___10841))) 1)
...
;; H
  (assert (= temp___1086 (mk___t3 temp___1084 temp___10841)))

;; H
  (assert
  (= o3 (mk___t (elts3 temp___1086)
        (mk (to_rep2 (first7 (rt3 temp___1086)))
        (to_rep2 (last8 (rt3 temp___1086)))))))

;; H
  (assert (= o4 (mk___split_fields o3)))

;; H
  (assert (= temp___1088 (mk___rep quotient__split_discrs o4)))
...
;; H
  (assert (= quotient__split_fields2 (us_split_fields1 temp___1088)))

;; H
  (assert (= quotient__split_discrs (us_split_discrs1 temp___1088)))

;; H
  (assert
  (= (to_rep
     (rec__very_longs__very_long__octet_length remainder__split_discrs))
  r141b))

;; H
  (assert (in_range2 r141b))

;; H
  (assert
  (= (to_rep2 (first13 (rt6 (temp___1089 ((_ int2bv 8) 0) 1 r141b)))) 1))

;; H
  (assert
  (= (to_rep2 (last14 (rt6 (temp___1089 ((_ int2bv 8) 0) 1 r141b))))
  r141b))

;; H
  (assert (= temp___1096 (temp___1089 ((_ int2bv 8) 0) 1 r141b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first13 (rt6 temp___1096))) (to_rep2
                                                    (last14
                                                    (rt6 temp___1096))))
     (+ (- (to_rep2 (last14 (rt6 temp___1096))) (to_rep2
                                                (first13 (rt6 temp___1096)))) 1)
     0) (ite (<= 1 r141b) (+ (- r141b 1) 1) 0)))

;; H
  (assert
  (= temp___1097 (mk___t5 (elts6 temp___1096)
                 (mk5 (to_rep2 (first13 (rt6 temp___1096)))
                 (to_rep2 (last14 (rt6 temp___1096)))))))

;; H
  (assert
  (= (ite (<= (to_rep2 (first11 (rt5 temp___1097))) (to_rep2
                                                    (last12
                                                    (rt5 temp___1097))))
     (+ (- (to_rep2 (last12 (rt5 temp___1097))) (to_rep2
                                                (first11 (rt5 temp___1097)))) 1)
...
;; H
  (assert (= temp___1099 temp___1097))

;; H
  (assert
  (= o5 (mk___t (elts5 temp___1099)
        (mk (to_rep2 (first11 (rt5 temp___1099)))
        (to_rep2 (last12 (rt5 temp___1099)))))))

;; H
  (assert (= o6 (mk___split_fields o5)))

;; H
  (assert (= temp___1101 (mk___rep remainder__split_discrs o6)))
...
;; H
  (assert (= remainder__split_fields2 (us_split_fields1 temp___1101)))

;; H
  (assert (= remainder__split_discrs (us_split_discrs1 temp___1101)))

;; H
  (assert
  (and (= o7 (get_msd divisor))
  (and (in_range2 o7)
  (and
  (not
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 divisor))) o7)) ((_ int2bv 8) 0)))
  (forall ((i Int))
  (=>
  (and (<= (+ o7 1) i)
  (<= i (to_rep2
