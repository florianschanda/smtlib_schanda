...
;; H
  (assert (= result__2 (power n j2)))

;; H
  (assert
  (and
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 result__2))
  (=> (<= 1 5) (in_range2 j2))) (and (<= 1 j2) (<= j2 5))))

;; H
  (assert (and (= o (* result__2 n)) (in_range1 (* result__2 n))))
