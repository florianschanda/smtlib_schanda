...
;; H
  (assert (= o83 (+ x_first o82)))

;; H
  (assert (and (= o84 o83) (in_range1 o83)))

;; H
  (assert (= o85 (ite (<= o84 (to_rep (last (rt x)))) true false)))
...
;; H
  (assert (= o86 (ite (<= (to_rep (first (rt x))) o81) true false)))

;; H
  (assert (= result (ite (= o86 true) o85 false)))
...
;; H
  (assert (= o75 (+ m_first o74)))

;; H
  (assert (and (= o76 o75) (in_range1 o75)))

;; H
  (assert (= o77 (ite (<= o76 (to_rep (last (rt m)))) true false)))
...
;; H
  (assert (= o78 (ite (<= (to_rep (first (rt m))) o73) true false)))

;; H
  (assert (= result1 (ite (= o78 true) o77 false)))
...
;; H
  (assert (= o67 (+ aux1_first o66)))

;; H
  (assert (and (= o68 o67) (in_range1 o67)))

;; H
  (assert (= o69 (ite (<= o68 (to_rep aux1__last)) true false)))
...
;; H
  (assert (= o70 (ite (<= (to_rep aux1__first) o65) true false)))

;; H
  (assert (= result2 (ite (= o70 true) o69 false)))
...
;; H
  (assert (= o59 (+ aux2_first o58)))

;; H
  (assert (and (= o60 o59) (in_range1 o59)))

;; H
  (assert (= o61 (ite (<= o60 (to_rep aux2__last)) true false)))
...
;; H
  (assert (= o62 (ite (<= (to_rep aux2__first) o57) true false)))

;; H
  (assert (= result3 (ite (= o62 true) o61 false)))
...
;; H
  (assert (= o51 (+ aux3_first o50)))

;; H
  (assert (and (= o52 o51) (in_range1 o51)))

;; H
  (assert (= o53 (ite (<= o52 (to_rep aux3__last)) true false)))
...
;; H
  (assert (= o54 (ite (<= (to_rep aux3__first) o49) true false)))

;; H
  (assert (= result4 (ite (= o54 true) o53 false)))
...
;; H
  (assert (= o43 (+ aux4_first o42)))

;; H
  (assert (and (= o44 o43) (in_range1 o43)))

;; H
  (assert (= o45 (ite (<= o44 (to_rep aux4__last)) true false)))
...
;; H
  (assert (= o46 (ite (<= (to_rep aux4__first) o34) true false)))

;; H
  (assert (= result5 (ite (= o46 true) o45 false)))
...
;; H
  (assert (= o21 (+ r_first o20)))

;; H
  (assert (and (= o22 o21) (in_range1 o21)))

;; H
  (assert (= o23 (ite (<= o22 (to_rep (last (rt r)))) true false)))
...
;; H
  (assert (= o24 (ite (<= (to_rep (first (rt r))) o19) true false)))
...
;; H
  (assert (= o8 (from_integer o7)))

;; H
  (assert (= o4 (from_integer 2)))

;; H
  (assert (= o9 (omultiply o4 o8)))
...
;; H
  (assert (= o10 (oexpon__2 o3 o9)))

;; H
  (assert (= o16 (omod o10 o15)))
