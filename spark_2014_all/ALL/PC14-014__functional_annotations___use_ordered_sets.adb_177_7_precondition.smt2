...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) 1) true)
  (ite (= (contains
          (model__
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields2))
     (find (elements (mk___rep s__split_discrs s__split_fields2)) 1)) 1))
  (= (equal_except
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields2))
     (find (elements (mk___rep s__split_discrs s__split_fields2)) 1)) true))
  (and
  (and
  (and
  (and
  ...
  (= (range_equal
     ...
     (- (find (elements (mk___rep s__split_discrs s__split_fields2)) 1) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields2))
     (find (elements (mk___rep s__split_discrs s__split_fields2)) 1)
     (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields2)) (to_rep
                                                          (rec__use_ordered_sets__my_sets__set__capacity
                                                          s__split_discrs)))
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) 2) true))))
(check-sat)
(exit)
