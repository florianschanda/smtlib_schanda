...
;; H
  (assert
  (and (= o22 (remove (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and (= o23 (remove (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and (= o20 (remove_eq o23 o22 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o22 o19)))
     (let ((temp___162 (remove o23 o19)))
