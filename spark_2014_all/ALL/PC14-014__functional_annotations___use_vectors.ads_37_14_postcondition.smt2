...
;; H
  ...
  (=>
  (and (<= first n)
  (<= n (last4 (model__ (mk___rep v2__split_discrs v2__split_fields12)))))
  (= (is_incr (get (model__ v1) n)
     (get (model__ (mk___rep v2__split_discrs v2__split_fields12)) n)) true)))))
...
;; WP_parameter_def
 ;; File "use_vectors.ads", line 33, characters 0-0
  (not
  (= (length
     (mk___rep v2__split_discrs (us_split_fields__content v2__split_fields8)))
  (length v1))))
(check-sat)
(exit)
