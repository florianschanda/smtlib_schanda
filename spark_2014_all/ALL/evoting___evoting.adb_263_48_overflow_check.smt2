...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters
                                                      i3)))
  (=> (and (<= 0 j3) (<= j3 (- i3 1))) (= winners20 (mk_map__ref1 winners6))))))
...
;; H
  ...
  (< (to_rep (select counters latest_highest_score2)) (to_rep
                                                      (select counters
                                                      i3)))
  (= (mk_map__ref1 result6) winners20))))
...
;; H
  ...
  (and
  (forall ((j16 Int))
  (=> (and (<= (+ last_candidate 1) j16) (<= j16 (- i9 1)))
  (not (= (select winners19 j16) true))))
  (forall ((j16 Int))
  (=> (and (<= 0 j16) (<= j16 last_candidate))
  (= (= (select winners19 j16) true)
  (= (select (map__content1 winners17) j16) true))))))
...
;; H
  ...
  (=> (<= i9 temp___718)
  (= (select winners19 temp___718) (select (map__content1 winners17) temp___718))))))
