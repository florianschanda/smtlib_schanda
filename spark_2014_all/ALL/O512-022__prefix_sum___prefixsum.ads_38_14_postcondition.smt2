...
(declare-fun output_space1 () Int)

(declare-fun a13 () map__ref)

(declare-fun output_space2 () int__ref)

(declare-fun space8 () int__ref)

(declare-fun left14 () int__ref)

(declare-fun right13 () int__ref)

(declare-fun a14 () (Array Int integer))

(declare-fun output_space3 () Int)

(declare-fun space9 () Int)

(declare-fun left15 () Int)
...
;; H
  ...
  (and
  (and
  (and (= (mod2 (+ left4 1) space2) 0)
  (= (all_left_elements_in a3 left4 (* (* space2 2) 1000000)) true))
  (= (all_right_elements_in a3 (- left4 1) (* space2 1000000)) true))
  (= (mod2 (+ left4 1) (* space2 2)) space2)) (not (<= 8 left4)))
  (forall ((k Int))
  (=> (and (<= 0 k) (<= k 7))
...
;; H
  ...
  (=> (< left3 8)
  (and
  (and (=> (<= 0 2147483647) (in_range2 left4))
...
;; H
  (assert
  (=> (< space1 8)
  (=> (< left3 8) (and (= o (+ left4 space2)) (in_range1 (+ left4 space2))))))
...
;; H
  (assert
  (=> (< space1 8) (=> (< left3 8) (and (<= 0 right4) (<= right4 7)))))
...
;; H
  (assert
  (=> (< space1 8)
  (=> (< left3 8) (and (= o12 (* space2 2)) (in_range1 (* space2 2))))))
...
;; H
  (assert
  (=> (< space1 8) (=> (< left3 8) (and (= o14 o13) (in_range1 o13)))))

;; H
  (assert
  (=> (< space1 8) (=> (< left3 8) (and (= o15 o14) (in_range2 o14)))))
...
;; H
  (assert
  (=> (< space1 8) (=> (not (< left3 8)) (= right7 (mk_int__ref right2)))))

;; H
  (assert
  (=> (< space1 8) (=> (not (< left3 8)) (= left8 (mk_int__ref left3)))))
...
;; H
  (assert
  (=> (< space1 8) (and (= o16 (* space2 2)) (in_range1 (* space2 2)))))
...
;; WP_parameter_def
 ;; File "prefixsum.ads", line 24, characters 0-0
  (not (= (all_elements_in (map__content a13) 8000000) true)))
(check-sat)
(exit)
