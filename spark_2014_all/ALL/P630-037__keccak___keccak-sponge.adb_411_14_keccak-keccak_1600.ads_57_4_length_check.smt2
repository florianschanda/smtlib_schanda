...
;; H
  ...
  (=> (<= r161s r162s)
  (and
  (and (<= (to_rep digest__first) r161s) (<= r161s (to_rep digest__last)))
  (and (<= (to_rep digest__first) r162s) (<= r162s (to_rep digest__last))))))

;; H
  (assert (= o60 (map__content digest7)))

;; H
  (assert (= temp___967 (mk___t9 o60 (mk9 r161s r162s))))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  ...
  (= (ite (<= (to_rep (first18 (rt9 temp___966))) (to_rep
     ...
     0) (ite (<= (to_rep (first18 (rt9 temp___967))) (to_rep
                                                     (last18
                                                     (rt9 temp___967))))
        (+ (- (to_rep (last18 (rt9 temp___967))) (to_rep
                                                 (first18 (rt9 temp___967)))) 1)
        0))))
(check-sat)
(exit)
