...
;; range_axiom
  (assert
  (forall ((x flagvalue)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-fun flag_v1 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun flag_v2 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun value_v1 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun value_v2 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun flags_v1 () (Array Int flagvalue))

(declare-fun flags_v2 () (Array Int flagvalue))

(declare-fun o () flagvalue)

(declare-fun o1 () (Array Int flagvalue))

(declare-fun o2 () flagvalue)

(declare-fun o3 () (Array Int flagvalue))

(declare-fun result () (Array Int flagvalue))

(declare-fun flags_v11 () (Array Int flagvalue))

(declare-fun result1 () (Array Int flagvalue))

(declare-fun flags_v21 () (Array Int flagvalue))

(declare-fun flags_v12 () (Array Int flagvalue))

(declare-fun flags_v22 () (Array Int flagvalue))

(declare-fun flags_v13 () (Array Int flagvalue))

(declare-fun flags_v23 () (Array Int flagvalue))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (to_rep (select flags_v12 flag_v1)) (to_rep (select flags_v22 flag_v2)))))
(check-sat)
(exit)
