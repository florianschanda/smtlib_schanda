...
(declare-fun rdx_400586 () t__ref3)

(declare-fun rdi_400586 () t__ref3)
...
(declare-fun rdx_4005861 () (_ BitVec 64))

(declare-fun result1 () t__ref3)

(declare-fun rdi_4005861 () (_ BitVec 64))
...
(declare-fun zeroflag2 () bool__ref)
...
(declare-fun rsp4 () t__ref3)

(declare-fun rbp3 () t__ref3)

(declare-fun memory11 () map__ref)

(declare-fun rdx_4005862 () t__ref3)

(declare-fun rdi_4005862 () t__ref3)
...
(declare-fun rdx_4005863 () (_ BitVec 64))

(declare-fun rdi_4005863 () (_ BitVec 64))
