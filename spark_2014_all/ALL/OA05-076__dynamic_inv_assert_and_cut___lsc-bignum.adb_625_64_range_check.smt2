...
;; H
  (assert (and (= o29 o28) (uint_in_range1 o28)))

;; H
  (assert (= o30 ((_ int2bv 64) o29)))

;; H
  (assert (= o31 (bvadd o30 ((_ int2bv 64) 1))))

;; H
  (assert (= o32 (bvmul o31 ((_ int2bv 64) 32))))

;; H
  (assert (= o33 (ite (bvult i2 o32) true false)))
...
;; H
  (assert (= o23 (from_integer s10)))

;; H
  (assert (= o27 (ole o23 o26)))

;; H
  (assert (and (= o21 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o22 (ite (<= s10 o21) true false)))

;; H
  (assert (= o19 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o20 (oexpon o19 s10)))

;; H
  (assert (= o15 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o14 (from_integer s10)))

;; H
  (assert (= o16 (osubtract o14 o15)))

;; H
  (assert (= o13 (from_word64 i2)))

;; H
  (assert (= o17 (osubtract o13 o16)))

;; H
  (assert (= o12 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o18 (oexpon__2 o12 o17)))
