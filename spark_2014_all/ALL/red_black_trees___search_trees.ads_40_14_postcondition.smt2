...
(declare-fun search_trees__values__result () value_set__ref)

(declare-fun result () us_rep2)
...
;; H
  ...
  (= (is_empty (value_set__content search_trees__values__result)) true)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  ...
  (= (contains (value_set__content search_trees__values__result)
     (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) true))))
  (forall ((v Int))
  (=> (and (<= 0 v) (<= v 2147483647))
  (=> (= (contains (value_set__content search_trees__values__result) v) true)
  (exists ((i Int))
  (and (and (<= 1 i) (<= i 100))
  (and
  (= (rec__tree_model__path_type__k
