...
;; H
  (assert
  (= (let ((temp___260 (remove (remove (mk___t values2 (mk 1 100)) x) y)))
     (let ((temp___259 (remove (remove (mk___t init (mk 1 100)) x) y)))
     (bool_eq (elts temp___259) (to_rep1 (first (rt temp___259)))
     (to_rep1 (last (rt temp___259))) (elts temp___260)
     (to_rep1 (first (rt temp___260))) (to_rep1 (last (rt temp___260)))))) true))
...
;; H
  (assert
  (and (= o14 (remove (mk___t init (mk 1 100)) o13))
...
;; H
  (assert
  (and (= o21 (perm_reflexive o16 o20))
...
;; H
  (assert
  (and (= o33 (perm_reflexive o28 o32))
...
;; H
  (assert (and (= o43 (- x 1)) (in_range5 (- x 1))))

;; H
  (assert (and (= o41 y) (in_range5 y)))

;; H
  (assert
  (and (= o42 (remove (mk___t values2 (mk 1 100)) o41))
  (and (dynamic_invariant4 o42 true false true)
  (and (= (invariant__ o42) true)
  (and (= (to_rep1 (last (rt o42))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o41 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o42) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o41 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o42) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o41 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o42) k))))))))))))

;; H
  (assert
  (and (= o44 (remove o42 o43))
  (and (dynamic_invariant4 o44 true false true)
  (and (= (invariant__ o44) true)
  (and (= (to_rep1 (last (rt o44))) (- (to_rep1 (last (rt o42))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o43 1)))
  (= (to_rep (select (elts o42) k)) (to_rep (select (elts o44) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o43 1) k) (<= k (to_rep1 (last (rt o42)))))
  (= (to_rep (select (elts o42) k)) (to_rep (select (elts o44) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o43 k) (<= k (- (to_rep1 (last (rt o42))) 1)))
  (= (to_rep (select (elts o42) (+ k 1))) (to_rep (select (elts o44) k))))))))))))

;; H
  (assert (and (= o39 y) (in_range5 y)))
...
;; H
  (assert
  (and (= o38 (remove (mk___t values2 (mk 1 100)) o37))
  (and (dynamic_invariant4 o38 true false true)
  (and (= (invariant__ o38) true)
  (and (= (to_rep1 (last (rt o38))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o37 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o38) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o37 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o38) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o37 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o38) k))))))))))))

;; H
  (assert
  (and (= o40 (remove o38 o39))
  (and (dynamic_invariant4 o40 true false true)
  (and (= (invariant__ o40) true)
  (and (= (to_rep1 (last (rt o40))) (- (to_rep1 (last (rt o38))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o39 1)))
  (= (to_rep (select (elts o38) k)) (to_rep (select (elts o40) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o39 1) k) (<= k (to_rep1 (last (rt o38)))))
  (= (to_rep (select (elts o38) k)) (to_rep (select (elts o40) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o39 k) (<= k (- (to_rep1 (last (rt o38))) 1)))
  (= (to_rep (select (elts o38) (+ k 1))) (to_rep (select (elts o40) k))))))))))))
...
;; H
  (assert
  (and (= o35 (remove (mk___t init (mk 1 100)) o34))
