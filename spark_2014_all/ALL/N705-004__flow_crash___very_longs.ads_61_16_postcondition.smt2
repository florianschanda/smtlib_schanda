...
(declare-fun temp___1061 () (_ BitVec 16))

(declare-fun temp___1060 () (_ BitVec 16))

(declare-fun temp___1059 () (_ BitVec 16))

(declare-fun temp___1058 () (_ BitVec 16))

(declare-fun temp___1055 () us_rep1)
...
(declare-fun temp___1053 () us_rep1)
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= temp___1055 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= temp___1053 (mk___rep1 result____split_discrs o31))))
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= result____split_fields10 (us_split_fields3 temp___1053))))
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= result____split_discrs (us_split_discrs2 temp___1053))))
