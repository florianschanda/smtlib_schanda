...
(declare-fun res31 () Int)

(declare-fun state4 () us_private)

(declare-fun model____split_fields8 () us_rep)

(declare-fun model____split_fields9 () us_rep1)

(declare-fun res41 () Int)

(declare-fun state5 () us_private)

(declare-fun model____split_fields10 () us_rep)

(declare-fun model____split_fields11 () us_rep1)

(declare-fun state6 () us_private)

(declare-fun model____split_fields12 () us_rep)

(declare-fun model____split_fields13 () us_rep1)

(define-fun model____split_fields14 () us_split_fields (mk___split_fields
                                                       model____split_fields12
                                                       model____split_fields13))

(define-fun model____split_fields15 () us_split_fields (mk___split_fields
                                                       model____split_fields10
                                                       model____split_fields11))

(define-fun model____split_fields16 () us_split_fields (mk___split_fields
                                                       model____split_fields8
                                                       model____split_fields9))

(define-fun model____split_fields17 () us_split_fields (mk___split_fields
                                                       model____split_fields6
                                                       model____split_fields7))

(define-fun model____split_fields18 () us_split_fields (mk___split_fields
                                                       model____split_fields4
                                                       model____split_fields5))

(define-fun model____split_fields19 () us_split_fields (mk___split_fields
...
;; H
  (assert
  (and
  (and (= (is_valid state1 model____split_fields19) true)
  (ite (= (= (length model____split_fields) 0) true)
  (and (= res11 0)
  (= (oeq (mk___rep model____split_fields19)
     (mk___rep
     (mk___split_fields model____split_fields model____split_fields1))) true))
  (and
...
;; H
  (assert
  (and
  (and (= (is_valid state2 model____split_fields18) true)
  (ite (= (= (length model____split_fields2) 0) true)
  (and (= res21 0)
  (= (oeq (mk___rep model____split_fields18)
     (mk___rep model____split_fields19)) true))
  (and
...
;; H
  (assert
  (and
  (and (= (is_valid state3 model____split_fields17) true)
  (ite (= (= (length model____split_fields4) 0) true)
  (and (= res31 0)
  (= (oeq (mk___rep model____split_fields17)
     (mk___rep model____split_fields18)) true))
  (and
  (= (is_prepend model____split_fields6 res31 model____split_fields4) true)
  (= (is_add model____split_fields5 res31 model____split_fields7) true))))
  (in_range res31)))
...
;; H
  (assert
  (and
  (and (= (is_valid state4 model____split_fields16) true)
  (ite (= (= (length model____split_fields6) 0) true)
  (and (= res41 0)
  (= (oeq (mk___rep model____split_fields16)
     (mk___rep model____split_fields17)) true))
  (and
  (= (is_prepend model____split_fields8 res41 model____split_fields6) true)
  (= (is_add model____split_fields7 res41 model____split_fields9) true))))
  (in_range res41)))
...
;; H
  (assert
  (and (= (is_valid state5 model____split_fields15) true)
  (ite (= (contains model____split_fields9 res11) true)
  (and
  (= (is_prepend model____split_fields8 res11 model____split_fields10) true)
  (= (is_add model____split_fields11 res11 model____split_fields9) true))
  (= (oeq (mk___rep model____split_fields15)
     (mk___rep model____split_fields16)) true))))

;; H
  (assert (= (is_available res11 state5) true))

;; H
  (assert
  (and (= (is_valid state6 model____split_fields14) true)
  (ite (= (contains model____split_fields11 res21) true)
  (and
  (= (is_prepend model____split_fields10 res21 model____split_fields12) true)
  (= (is_add model____split_fields13 res21 model____split_fields11) true))
  (= (oeq (mk___rep model____split_fields14)
     (mk___rep model____split_fields15)) true))))

;; H
  (assert (= (is_available res21 state6) true))

(assert
;; WP_parameter_def
 ;; File "list_allocator.ads", line 80, characters 0-0
  (not (= (is_valid state6 model____split_fields14) true)))
(check-sat)
(exit)
