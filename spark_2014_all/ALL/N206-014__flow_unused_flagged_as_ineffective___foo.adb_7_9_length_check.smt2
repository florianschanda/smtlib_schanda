...
(declare-fun temp___150 (Int Int Int) us_t1)

;; def_axiom
  (assert
  (forall ((temp___152 Int) (temp___153 Int) (temp___154 Int))
  (let ((temp___151 (temp___150 temp___152 temp___153 temp___154)))
  (and
  (=> (dynamic_property 1 2147483647 temp___153 temp___154)
  (and (= (first3 temp___151) temp___153) (= (last3 temp___151) temp___154)))
  (forall ((temp___155 Int))
  (= (select (to_array1 temp___151) temp___155) (of_rep temp___152)))))))
...
(declare-const temp___157 (Array Int character))

(declare-const temp___1571 t1)

(declare-const temp___158 (Array Int character))

(declare-const temp___1581 t)
...
;; H
  (assert
  (= (to_rep1
     (first2 (rt1 (temp___150 120 (to_rep1 x__first) (to_rep1 x__last)))))
  (to_rep1 x__first)))

;; H
  (assert
  (= (to_rep1
     (last2 (rt1 (temp___150 120 (to_rep1 x__first) (to_rep1 x__last)))))
  (to_rep1 x__last)))

;; H
  (assert
  (= (mk___t1 temp___157 temp___1571) (temp___150 120 (to_rep1 x__first)
                                      (to_rep1 x__last))))

;; H
  (assert (= temp___157 temp___158))

;; H
  (assert
  (= (mk (to_rep1 (first2 temp___1571)) (to_rep1 (last2 temp___1571)))
  temp___1581))
...
;; WP_parameter_def
 ;; File "foo.adb", line 13, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first temp___1581)) (to_rep1 (last temp___1581)))
     (+ (- (to_rep1 (last temp___1581)) (to_rep1 (first temp___1581))) 1) 0)
