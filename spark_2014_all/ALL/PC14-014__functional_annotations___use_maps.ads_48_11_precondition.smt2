...
(declare-fun temp___816 () us_rep3)
...
;; H
  (assert
  (= (= o8 true)
  (let ((temp___822 (keys s)))
  (forall ((temp___821 Int))
  (=>
  (and (in_range3 temp___821)
  (= (iter_has_element temp___822 temp___821) true))
  (let ((k (get temp___822 temp___821)))
  (and
  (= (has_key
     (model__
...
;; H
  ...
  (and
  (and
  (= (length3 temp___816) (length
                          (mk___rep r__split_discrs
                          (us_split_fields__content r__split_fields7))))
  (forall ((temp___431 Int))
  (=>
  (and (in_range3 temp___431)
  (= (iter_has_element temp___816 temp___431) true))
  (= (has_key
     (model__
     (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))
     (get temp___816 temp___431)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key
     ...
     (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))
     key2) true))
  (and (< 0 (find temp___816 key2))
  (= (get temp___816 (find temp___816 key2)) key2)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep r__split_discrs
        (us_split_fields__content r__split_fields7)))))
  (= (find temp___816 (get temp___816 i)) i))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
  ...
  (<= j (length
        (mk___rep r__split_discrs
        (us_split_fields__content r__split_fields7)))))
  (=> (= (get temp___816 i) (get temp___816 j)) (= i j)))))))))

;; H
  (assert
  (and (= o4 (iter_has_element temp___816 temp___815))
  (= (= o4 true) (and (<= 1 temp___815) (<= temp___815 (last temp___816))))))
