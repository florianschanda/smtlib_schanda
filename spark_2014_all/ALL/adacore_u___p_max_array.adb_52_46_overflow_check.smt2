...
;; H
  (assert
  (and (= o4 (- k (to_rep1 a__first))) (in_range1 (- k (to_rep1 a__first)))))

;; H
  (assert (= o5 (+ o4 (to_rep1 (first (rt b))))))

;; H
  (assert (and (= temp___282 o5) (in_range1 o5)))
...
;; H
  (assert (= result3 (ite (< o8 o9) true false)))
...
;; H
  (assert
  (and (= o10 (- k (to_rep1 a__first))) (in_range1 (- k (to_rep1 a__first)))))

;; H
  (assert (= o11 (+ o10 (to_rep1 (first (rt b))))))
