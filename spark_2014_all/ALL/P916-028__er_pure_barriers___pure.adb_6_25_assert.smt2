...
(declare-fun pure__pt__n__first__bit () Int)

(declare-fun pure__pt__n__last__bit () Int)

(declare-fun pure__pt__n__position () Int)
...
(declare-fun pure__pt__b__first__bit () Int)

(declare-fun pure__pt__b__last__bit () Int)

(declare-fun pure__pt__b__position () Int)
