...
;; def_axiom
  ...
  (= (select (tetris_functional__delete_complete_lines__empty_line__aggregate_def
...
;; empty_line__def_axiom
  (assert
  (= empty_line (tetris_functional__delete_complete_lines__empty_line__aggregate_def
                0)))

(define-fun dynamic_invariant4 ((temp___expr_514 Int)
  (temp___is_init_511 Bool) (temp___skip_constant_512 Bool)
  (temp___do_toplevel_513 Bool)) Bool (=>
                                      (or (= temp___is_init_511 true)
                                      (<= 0 7)) (in_range3 temp___expr_514)))
...
(declare-fun has_complete_lines4 () bool__ref)
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (=> (= result3 true) (= (mk_map__ref1 result4) cur_board15))))
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (=> (= result3 true) (= has_complete_lines1 result5))))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (=> (= result3 true) (= has_complete_lines2 (of_int 1)))))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (=> (= result3 true) (= to_line1 result6))))
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (=> (not (= result3 true)) (= has_complete_lines2 has_complete_lines1))))
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (= has_complete_lines4 (mk_bool__ref has_complete_lines3))))
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= del_line5 del_line3)))
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= to_line6 to_line4)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= cur_board6 cur_board4)))
...
;; H
  (assert
  (=> (= result9 true)
  (and (= o1 (- to_line8 1)) (in_range4 (- to_line8 1)))))
...
;; H
  (assert
  (=> (= result9 true)
  (= (to_rep (select (select cur_board10 from_line2) 1)) 0)))
...
(assert
;; WP_parameter_def
 ;; File "tetris_functional.ads", line 170, characters 0-0
  (not (= (no_complete_lines (map__content1 cur_board13)) true)))
(check-sat)
(exit)
