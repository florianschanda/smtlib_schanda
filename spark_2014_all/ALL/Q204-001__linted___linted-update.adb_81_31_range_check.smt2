...
;; H
  (assert
  (=> (bvule x1 ((_ int2bv 32) 2147483647))
  (and (= o18 (bv2nat x1)) (in_range1 (bv2nat x1)))))

;; H
  (assert (=> (bvule x1 ((_ int2bv 32) 2147483647)) (= result1 y3)))

;; H
  (assert (=> (bvule x1 ((_ int2bv 32) 2147483647)) (= y1 o18)))

;; H
  (assert
  (=> (not (bvule x1 ((_ int2bv 32) 2147483647)))
  (and (= o19 (bv2nat (bvnot x1))) (in_range1 (bv2nat (bvnot x1))))))

;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= o20 (- o19))))

;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= o21 (- o20 1))))
...
;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= result2 y3)))

;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= y2 o22)))

;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= y1 y2)))

;; H
  (assert (= (to_rep1 o23) y1))
