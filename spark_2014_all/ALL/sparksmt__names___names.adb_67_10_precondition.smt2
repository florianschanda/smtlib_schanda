...
(define-fun dynamic_invariant2 ((temp___expr_436 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_442 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_472 Int)
...
;; H
  ...
  (= o8 (get
        (model__
        (mk___rep1 entry_table__split_discrs
        (mk___split_fields1 entry_table__split_fields))) o4))
  (= (bool_eq o8
     (get
     (model__
     (mk___rep1 entry_table__split_discrs
     (mk___split_fields1 entry_table__split_fields))) o4)) true)))
