...
;; H
  ...
  (and (= temp___470 r27b)
  (and (and (= result7 current12) (= current1 temp___469))
  ...
  (and
  (and (and (= result7 current12) (= current1 first))
...
;; H
  (assert
  (and (= o6 (last4 (model__ v)))
  (and (dynamic_property4 first3 last5 o6) (= o6 (last4 (model__ v))))))

;; H
  (assert (= o7 (ite (<= use_vectors__my_find__result13 o6) true false)))

;; H
  (assert
  (= result6 (ite (<= first use_vectors__my_find__result13) o7 false)))

;; H
  (assert
  (=> (= result6 true)
  (and (= us1 use_vectors__my_find__result13) (dynamic_property1 first1
  last1 use_vectors__my_find__result13))))

;; H
  (assert (=> (= result6 true) (= o4 use_vectors__my_find__result13)))

;; H
  (assert
  (=> (= result6 true)
  (and (= o5 (get (model__ v) o4))
  (and (in_range4 o5) (= o5 (get (model__ v) o4))))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (= o5 e) true false))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1 (- use_vectors__my_find__result13 1))))
(check-sat)
(exit)
