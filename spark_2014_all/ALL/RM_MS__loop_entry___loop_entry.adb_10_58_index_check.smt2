...
(((mk_elementtype__ref (elementtype__content elementtype)))))
...
(((mk_indextype__ref (indextype__content indextype)))))
...
(((mk_map__ref (map__content (Array Int elementtype))))))
...
;; H
  ...
  (and
  (forall ((n1 Int))
  (=> (and (<= l n1) (<= n1 i2)) (= (to_rep (select a2 n1)) 0)))
  (forall ((n1 Int))
  (=> (and (<= 1 n1) (<= n1 100))
  (=> (or (< n1 l) (< i2 n1))
  (= (to_rep (select a2 n1)) (to_rep (select a n1))))))))
