...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r43b)) (= (mk_int__ref i5) (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r43b)) (= (mk_int__ref sum6) (mk_int__ref sum4))))
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 4, characters 0-0
  (not
  (not
  (= (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 0))))
(check-sat)
(exit)
