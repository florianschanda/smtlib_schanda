...
(declare-fun c111b () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun c112b () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun r114b () Int)
...
(declare-datatypes ()
((t115b__ref (mk_t115b__ref (t115b__content integer)))))
(define-fun t115b__ref___projection ((a t115b__ref)) integer (t115b__content
                                                             a))
...
;; H
  (assert
  (and (= o19 (model__ data first_available))
  (= (model_is_well_formed o19 data first_available) true)))
...
;; WP_parameter_def
 ;; File "list_mod_allocator.ads", line 17, characters 0-0
  (not (= (is_well_formed data1 first_available1) true)))
(check-sat)
(exit)
