...
;; H
  (assert
  (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3)))
...
;; H
  ...
  (= (select x6 temp___234) (select x4 temp___234))
  (forall ((temp___235 Int) (temp___236 Int))
  (=>
  (and (and (<= 1 temp___235) (<= temp___235 3))
  (and (<= 1 temp___236) (<= temp___236 3)))
  (ite (or (not (= i222 temp___236)) (not (= i212 temp___235)))
  (= (get (select x6 temp___234) temp___235 temp___236) (get
                                                        (select x4 temp___234)
                                                        temp___235
                                                        temp___236))
  (forall ((temp___237 Int))
  (=> (and (<= 1 temp___237) (<= temp___237 3))
  (=> (< i12 temp___237)
  (= (select (get (select x6 temp___234) temp___235 temp___236) temp___237) (select
  (get (select x4 temp___234) temp___235 temp___236) temp___237)))))))))))
  (=> (<= 1 3) (in_range2 i12))) (and (<= 1 i12) (<= i12 3))))
...
;; WP_parameter_def
 ;; File "p.adb", line 1, characters 0-0
  (not
  (= (bool_eq2 x7 (to_rep (first12 (mk6 (+ i32 1) 3)))
     (to_rep (last12 (mk6 (+ i32 1) 3))) x4
     (to_rep (first14 (mk7 (+ i32 1) 3)))
     (to_rep (last14 (mk7 (+ i32 1) 3)))) true)))
(check-sat)
