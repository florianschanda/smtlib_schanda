...
;; H
  ...
  (forall ((idx1 Int))
  (=>
  (and (<= (to_rep1 (first (rt s))) idx1) (<= idx1 (to_rep1 (last (rt s)))))
  (= (to_rep (select (elts s) idx1)) (to_rep
...
;; H
  ...
  (forall ((idx1 Int))
  (=> (and (<= (to_rep1 buffer__first) idx1) (<= idx1 last11))
  (= (to_rep (select buffer idx1)) (to_rep
                                   (select the_file (+ (- idx1 (to_rep1
                                                               buffer__first))
                                   cur_position)))))))
...
;; H
  (assert
  (=> (< last11 (to_rep1 buffer__last))
  (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___655)))

;; H
  (assert
  (=> (< last11 (to_rep1 buffer__last)) (= (mk3 1 r77b) temp___6551)))
...
;; H
  (assert
  (=> (< last11 (to_rep1 buffer__last)) (= (mk3 1 r77b) temp___6571)))
...
;; H
  (assert
  (=> (< last11 (to_rep1 buffer__last))
  (= (mk___t3 temp___658 temp___6581) (mk___t3 temp___655 temp___6551))))

;; H
  (assert
  (=> (< last11 (to_rep1 buffer__last))
  (forall ((temp___659 Int))
  (ite (and (<= 1 temp___659) (<= temp___659 r77b))
  (= (select o14 temp___659) (select temp___658 temp___659))
  (= (select o14 temp___659) (select result__ temp___659))))))

;; H
  (assert
  (=> (< last11 (to_rep1 buffer__last)) (= (mk_map__ref result1) result__6)))
...
;; H
  (assert
  (=> (< last11 (to_rep1 buffer__last)) (= cur_position2 cur_position1)))
...
;; H
  ...
  (=> (not (< last11 (to_rep1 buffer__last)))
  (=> (= result2 true)
  (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___650))))

;; H
  (assert
  (=> (not (< last11 (to_rep1 buffer__last)))
  (=> (= result2 true) (= (mk4 1 r80b) temp___6501))))
...
;; H
  ...
  (=> (<= 1 r80b)
  (and (and (<= (to_rep1 result____first) 1) (<= 1 (to_rep1 result____last)))
  (and (<= (to_rep1 result____first) r80b)
  (<= r80b (to_rep1 result____last))))))))

;; H
  (assert
  (=> (not (< last11 (to_rep1 buffer__last)))
  (=> (= result2 true) (= o15 result__))))

;; H
  (assert
  (=> (not (< last11 (to_rep1 buffer__last)))
  (=> (= result2 true) (= o15 temp___652))))

;; H
  (assert
  (=> (not (< last11 (to_rep1 buffer__last)))
  (=> (= result2 true) (= (mk4 1 r80b) temp___6521))))

;; H
  (assert
  (=> (not (< last11 (to_rep1 buffer__last)))
  (=> (= result2 true)
  (= (ite (<= (to_rep1 (first8 temp___6501)) (to_rep1 (last8 temp___6501)))
     (+ (- (to_rep1 (last8 temp___6501)) (to_rep1 (first8 temp___6501))) 1)
     0) (ite (<= (to_rep1 (first8 temp___6521)) (to_rep1 (last8 temp___6521)))
        (+ (- (to_rep1 (last8 temp___6521)) (to_rep1 (first8 temp___6521))) 1)
        0)))))
...
;; H
  ...
  (=> (not (< last11 (to_rep1 buffer__last)))
  (=> (= result2 true)
  (= (mk___t4 temp___653 temp___6531) (mk___t4 temp___650 temp___6501)))))
...
;; H
  ...
  (ite (and (<= 1 temp___654) (<= temp___654 r80b))
  (= (select o16 temp___654) (select temp___653 temp___654))
  (= (select o16 temp___654) (select result__ temp___654)))))))
...
;; H
  ...
  (and
  (forall ((idx1 Int))
  (=> (and (<= 1 idx1) (<= idx1 num2))
  (= (to_rep (select result__3 idx1)) (to_rep
                                      (select the_file2 (+ (- idx1 1)
                                      cur_position_at_start))))))
...
;; H
  (assert
  (=> (not (< last11 (to_rep1 buffer__last))) (= result__1 result__2)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep1 result____first) idx)))
(check-sat)
(exit)
