...
(declare-datatypes ((tT158bP1__ref 0))
(((mk_tT158bP1__ref (tT158bP1__content tdigit_index_typeB)))))
...
(((mk_t158b__ref (t158b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits40__projection ((a us_split_fields2)) us_t1
  (rec__aco__math__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref_40__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep_79__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                a))

(define-fun us_rep_80__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))
...
(define-fun tresultS__ref_7__projection ((a tresultS__ref)) us_rep1 (tresultS__content
                                                                    a))
...
;; H
  ...
  (= o3 (modadd
        ...
        p))
  (and (dynamic_invariant1 o3 true false true)
  (= (to_rep o) (to_rep
                (rec__aco__math__very_longs__very_long__octet_length
                (us_split_discrs1
                (to_base
