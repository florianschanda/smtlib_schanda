...
(define-fun tc_pu1S__ref_2__projection ((a tc_pu1S__ref)) us_rep1 (tc_pu1S__content
                                                                  a))
...
(declare-fun record_equality__test_eq_ko__g_pu1__assume () natural)

(declare-fun record_equality__test_eq_ko__g_pu1__assume1 () natural)

(declare-fun record_equality__test_eq_ko__g_pu1__assume2 () natural)

(declare-fun record_equality__test_eq_ko__g_pu1__assume3 () natural)

(declare-fun record_equality__test_eq_ko__g_pu1__assume4 () us_private)

(declare-fun record_equality__test_eq_ko__g_pu1__assume5 () Int)
...
(declare-fun record_equality__test_eq_ko__g_pu2__assume () natural)

(declare-fun record_equality__test_eq_ko__g_pu2__assume1 () natural)

(declare-fun record_equality__test_eq_ko__g_pu2__assume2 () natural)

(declare-fun record_equality__test_eq_ko__g_pu2__assume3 () natural)

(declare-fun record_equality__test_eq_ko__g_pu2__assume4 () us_private)

(declare-fun record_equality__test_eq_ko__g_pu2__assume5 () Int)
...
;; H
  (assert
  (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r6b))
...
;; H
  ...
  (= c_pu1__split_discrs (mk___split_discrs
                         record_equality__test_eq_ko__g_pu1__assume)))
...
;; H
  (assert
  (= record_equality__test_eq_ko__g_pu1__assume1 g_pu1__split_fields4))

;; H
  (assert
  (= record_equality__test_eq_ko__g_pu1__assume2 g_pu1__split_fields5))

;; H
  (assert
  (= record_equality__test_eq_ko__g_pu1__assume3 g_pu1__split_fields6))

;; H
  (assert
  (= record_equality__test_eq_ko__g_pu1__assume4 g_pu1__split_fields7))
...
;; H
  (assert
  (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r8b))
...
;; H
  (assert
  (= c_pu1__split_discrs (mk___split_discrs
                         record_equality__test_eq_ko__g_pu2__assume)))
...
;; H
  (assert
  (= record_equality__test_eq_ko__g_pu2__assume1 g_pu2__split_fields4))

;; H
  (assert
  (= record_equality__test_eq_ko__g_pu2__assume2 g_pu2__split_fields5))

;; H
  (assert
  (= record_equality__test_eq_ko__g_pu2__assume3 g_pu2__split_fields6))

;; H
  (assert
  (= record_equality__test_eq_ko__g_pu2__assume4 g_pu2__split_fields7))
...
(assert
;; WP_parameter_def
 ;; File "record_equality.adb", line 2, characters 0-0
  (not
  (= (bool_eq2
     (mk___rep2 g_pu1__split_discrs
     (mk___split_fields2 g_pu1__split_fields4 g_pu1__split_fields5
     g_pu1__split_fields6 g_pu1__split_fields7) g_pu1__attr__tag)
     (mk___rep2 g_pu2__split_discrs
     (mk___split_fields2 g_pu2__split_fields4 g_pu2__split_fields5
     g_pu2__split_fields6 g_pu2__split_fields7) g_pu2__attr__tag)) true)))
(check-sat)
(exit)
