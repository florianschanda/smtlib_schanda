...
(define-fun bool_eq12 ((x us_t2)
  (y us_t2)) Bool (bool_eq9 (elts2 x) (to_rep1 (first4 (rt2 x)))
...
(declare-fun temporary_array__first () integer)

(declare-fun temporary_array__last () integer)
...
(define-fun bool_eq14 ((x us_t3)
  (y us_t3)) Bool (bool_eq9 (elts3 x) (to_rep1 (first6 (rt3 x)))
...
(declare-fun temporary_array () (Array Int octet))

(declare-fun i () Int)

(declare-fun temp___506 () (Array Int octet))

(declare-fun temp___5061 () t3)

(declare-fun temp___507 () (Array Int octet))

(declare-fun temp___5071 () t2)
...
(declare-fun temp___510 () (Array Int octet))
...
(declare-fun temporary_array1 () (Array Int octet))

(declare-fun result1 () Int)

(declare-fun i1 () Int)

(declare-fun temporary_array2 () (Array Int octet))

(declare-fun i2 () Int)

(declare-fun result2 () (Array Int octet))

(declare-fun temporary_array3 () (Array Int octet))

(declare-fun temporary_array4 () (Array Int octet))

(declare-fun i3 () Int)

(declare-fun temporary_array5 () (Array Int octet))

(declare-fun i4 () Int)

(declare-fun temporary_array6 () (Array Int octet))

(declare-fun i5 () Int)

(declare-fun temporary_array7 () (Array Int octet))
...
(declare-fun temporary_array8 () (Array Int octet))
...
(declare-fun temporary_array9 () (Array Int octet))
...
;; H
  ...
  (= (mod1
     ...
     (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1) 0) 4) 0)
  (and (<= (length value) 65536)
  (and
  (and (<= (to_rep1 data__first) position)
  (<= position (to_rep1 data__last)))
  (<= (length_with_padding (length value)) (+ (- (to_rep1 data__last) 
  position) 1))))))))

;; H
  (assert
  (and (dynamic_property3 0 (- (length value) 1)
  (to_rep1 temporary_array__first) (to_rep1 temporary_array__last))
  (and (= (to_rep1 temporary_array__first) 0)
  (= (to_rep1 temporary_array__last) (- (length value) 1)))))

;; H
  (assert
  (= (to_rep1
     (first6 (rt3 (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))) 0))

;; H
  (assert
  (= (to_rep1
     (last6 (rt3 (temp___499 ((_ int2bv 8) 0) 0 (- (length value) 1))))) (- 
  (length value) 1)))

;; H
  (assert
  (= (mk___t3 temp___506 temp___5061) (temp___499 ((_ int2bv 8) 0) 0
                                      (- (length value) 1))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___5061)) (to_rep1 (last6 temp___5061)))
     (+ (- (to_rep1 (last6 temp___5061)) (to_rep1 (first6 temp___5061))) 1)
     0) (ite (<= 0 (- (length value) 1)) (+ (- (- (length value) 1) 0) 1) 0)))

;; H
  (assert (= temp___506 temp___507))

;; H
  (assert
  (= (mk2 (to_rep1 (first6 temp___5061)) (to_rep1 (last6 temp___5061))) 
  temp___5071))

;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___5071)) (to_rep1 (last4 temp___5071)))
     (+ (- (to_rep1 (last4 temp___5071)) (to_rep1 (first4 temp___5071))) 1)
     0) (ite (<= (to_rep1 temporary_array__first) (to_rep1
                                                  temporary_array__last))
        (+ (- (to_rep1 temporary_array__last) (to_rep1
                                              temporary_array__first)) 1)
        0)))

;; H
  (assert (= (mk___t2 o o1) (mk___t2 temp___507 temp___5071)))
...
;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= temp___510 temporary_array1)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value)))))
  (and (<= (to_rep1 (first (rt value))) i2)
  (<= i2 (to_rep1 (last (rt value)))))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value)))))
  (= (to_rep2 o3) ((_ int2bv 8) (to_rep (select (elts value) i2))))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value)))))
  (and (= temp___508 (- i2 (to_rep1 (first (rt value))))) (in_range1
  (- i2 (to_rep1 (first (rt value))))))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value)))))
  (and (<= (to_rep1 temporary_array__first) temp___508)
  (<= temp___508 (to_rep1 temporary_array__last)))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= o4 temp___508)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= o5 (store temporary_array2 
  o4 o3))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= temporary_array2 result2)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= temporary_array3 o5)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= i2 (to_rep1 (last (rt value))))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= i2 i3)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= temporary_array3 temporary_array4)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= i4 i2)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= temporary_array5 temporary_array3)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= i9 (mk_int__ref i3))))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value)))))
  (= temporary_array10 (mk_map__ref1 temporary_array4))))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= i6 i4)))

;; H
  (assert
  (=>
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))) (= temporary_array7 temporary_array5)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value)))))) (= i1 i5)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))))
  (= temporary_array1 temporary_array6)))
...
;; H
  ...
  (not
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value)))))) (= i6 i1)))
...
;; H
  ...
  (and (<= (to_rep1 (first (rt value))) i1)
  (<= i1 (to_rep1 (last (rt value))))))
  (= temporary_array7 temporary_array1)))

;; H
  (assert
  (and
  (= last9 (+ position (- (length_with_padding
                          (length1
                          (mk___t1 temporary_array6
                          (mk1 (to_rep1 temporary_array__first)
                          (to_rep1 temporary_array__last))))) 1)))
  (in_range5 last9)))
...
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 138, characters 0-0
  (not (= last10 (+ position (- (length_with_padding (length value)) 1)))))
(check-sat)
