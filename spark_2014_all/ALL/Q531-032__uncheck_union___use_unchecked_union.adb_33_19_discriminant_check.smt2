...
(declare-fun output__split_fields () integer)

(declare-fun output__split_fields1 () (Array Int integer))

(declare-fun output__split_fields2 () integer)

(declare-fun output__split_fields3 () (Array Int integer))
...
(declare-fun temp___231 () integer)

(declare-fun temp___2311 () integer)

(declare-fun temp___2312 () (Array Int integer))

(declare-fun temp___2313 () integer)

(declare-fun temp___2314 () (Array Int integer))

(declare-fun temp___2315 () Bool)

(declare-fun result () us_split_fields__ref2)

(declare-fun output__split_fields4 () us_split_fields4)

(declare-fun result1 () us_split_discrs__ref)

(declare-fun output__split_discrs1 () us_split_discrs)
...
;; H
  (assert (= output__split_fields1 o2))
...
;; H
  (assert (= output__split_fields2 o7))

;; H
  (assert (= output__split_fields3 o8))

;; H
  (assert (= output__split_discrs temp___231))

;; H
  (assert (= temp___2311 o5))

;; H
  (assert (= temp___2312 o6))

;; H
  (assert (= temp___2313 o7))

;; H
  (assert (= temp___2314 o8))

;; H
  (assert (= output__attr__constrained temp___2315))
...
;; H
  ...
  (= result (mk___split_fields__ref2
            (mk___split_fields2
            (mk___rep
            (mk___split_fields output__split_fields output__split_fields1))
            (mk___rep1
            (mk___split_fields1 output__split_fields2 output__split_fields3))))))

;; H
  (assert
  (= output__split_fields4 (mk___split_fields2
                           (mk___rep
                           (mk___split_fields temp___2311 temp___2312))
                           (mk___rep1
                           (mk___split_fields1 temp___2313 temp___2314)))))

;; H
  (assert
  (= result1 (mk___split_discrs__ref
             (mk___split_discrs output__split_discrs))))

;; H
  (assert (= output__split_discrs1 (mk___split_discrs temp___231)))
...
;; WP_parameter_def
 ;; File "use_unchecked_union.adb", line 9, characters 0-0
  (not
  (= (to_rep
     (rec__use_unchecked_union__myunion__discr output__split_discrs1)) 0)))
(check-sat)
(exit)
