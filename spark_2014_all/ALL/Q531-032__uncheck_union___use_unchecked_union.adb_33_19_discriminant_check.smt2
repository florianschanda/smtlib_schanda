...
(declare-const output__split_fields integer)

(declare-const output__split_fields1 (Array Int integer))

(declare-const output__split_fields2 integer)

(declare-const output__split_fields3 (Array Int integer))
...
(declare-const temp___2312 (Array Int integer))

(declare-const temp___2313 integer)

(declare-const temp___2314 (Array Int integer))

(declare-const temp___2315 Bool)

(declare-const result us_split_fields__ref2)

(declare-const output__split_fields4 us_split_fields4)

(declare-const result1 us_split_discrs__ref)

(declare-const output__split_discrs1 us_split_discrs)
