...
;; H
  (assert (=> (= result2 true) (= o15 (select b o14))))

;; H
  (assert (=> (= result2 true) (= o16 (to_rep o15))))
...
;; H
  (assert (=> (= result2 true) (= o12 j)))

;; H
  (assert (=> (= result2 true) (= o13 (select b2 o12))))

;; H
  (assert (=> (= result2 true) (= o17 (to_rep o13))))

;; H
  (assert (=> (= result2 true) (= o18 (ite (= o17 o16) true false))))
