...
(define-fun o23 () us_t (mk___t o21 o22))

(define-fun o24 () us_t (mk___t o18 o19))
...
;; H
  (assert
  (and (= o16 (shift_perm_l o28 o27 o25))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o25 o27) true)))))
...
;; H
  (assert
  (and (= o23 (remove o24 o20))
  (and (dynamic_invariant2 o23 true false true)
  (and (= (invariant__ o23) true)
  (and (= (to_rep2 (last o22)) (- (to_rep2 (last o19)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o20 1)))
  (= (to_rep (select o18 k)) (to_rep (select o21 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o20 1) k) (<= k (to_rep2 (last o19))))
  (= (to_rep (select o18 k)) (to_rep (select o21 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o20 k) (<= k (- (to_rep2 (last o19)) 1)))
  (= (to_rep (select o18 (+ k 1))) (to_rep (select o21 k))))))))))))
