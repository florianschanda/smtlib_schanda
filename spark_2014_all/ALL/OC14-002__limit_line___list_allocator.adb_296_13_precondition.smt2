...
;; H
  ...
  (and (in_range4
  (get (rec__list_allocator__m__t__available model____split_fields3) j2))
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1
     (select data3 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields3) j2))))) (ite (< j2 (length
                                                              (rec__list_allocator__m__t__available
...
;; H
  ...
  (in_range4
  (get (rec__list_allocator__m__t__allocated model____split_fields3) j2)))))
...
;; H
  ...
  (= (to_rep
     ...
     (select data3 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields3) j2))))) (ite (< 1 j2)
                                                   (get
                                                   (rec__list_allocator__m__t__available
                                                   model____split_fields3)
                                                   (- j2 1)) 0)))
...
;; H
  ...
  (ite (= (to_rep1
          (rec__list_allocator__cell__stat
          (us_split_fields1 (select data3 r)))) 0)
  (and
  (= (mem (rec__list_allocator__m__t__available model____split_fields3) r) true)
  (not
  (= (mem (rec__list_allocator__m__t__allocated model____split_fields3) r) true)))
  (and
  (not
  (= (mem (rec__list_allocator__m__t__available model____split_fields3) r) true))
  (= (mem (rec__list_allocator__m__t__allocated model____split_fields3) r) true))))))
...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o66) true false))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o65 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o65)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o65 first_available1) true false)))))

;; H
  (assert
  (=> (not (= first_available1 0))
  (=> (not (= result13 true)) (= result12 false))))

;; H
  (assert
  (=> (not (not (= first_available1 0)))
  (and
  (= o67 (length
         (rec__list_allocator__m__t__available model____split_fields3)))
  (in_range6 o67))))
...
;; H
  (assert
  (=> (not (not (= first_available1 0)))
  (= result12 (ite (= o67 0) true false))))

;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated2 0))
  (and
  (= o63 (length
         (rec__list_allocator__m__t__allocated model____split_fields3)))
  (in_range6 o63)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o63) true false)))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o62 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o62))))))
...
;; H
  ...
  (=> (not (= first_allocated2 0))
  (=> (= result14 true)
  (= result11 (ite (= o62 first_allocated2) true false))))))

;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated2 0))
  (=> (not (= result14 true)) (= result11 false)))))

;; H
  (assert
  (=> (= result12 true)
  (=> (not (not (= first_allocated2 0)))
  (and
  (= o64 (length
         (rec__list_allocator__m__t__allocated model____split_fields3)))
  (in_range6 o64)))))
...
;; H
  (assert (=> (= result11 true) (= o61 (ite (<= j1 o60) true false))))

;; H
  (assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o61 false))))
