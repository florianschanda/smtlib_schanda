...
(declare-fun definite__t__d__first__bit3 () Int)

(declare-fun definite__t__d__last__bit3 () Int)

(declare-fun definite__t__d__position3 () Int)
...
(declare-fun definite__t__b__first__bit3 () Int)

(declare-fun definite__t__b__last__bit3 () Int)

(declare-fun definite__t__b__position3 () Int)
...
(declare-fun definite__t__x__first__bit3 () Int)

(declare-fun definite__t__x__last__bit3 () Int)

(declare-fun definite__t__x__position3 () Int)
...
(declare-fun definite__t__a__first__bit3 () Int)

(declare-fun definite__t__a__last__bit3 () Int)

(declare-fun definite__t__a__position3 () Int)
...
(declare-fun temp___207 () status)

(declare-fun temp___2071 () natural)

(declare-fun temp___2072 () natural)

(declare-fun temp___2073 () Bool)

(declare-fun temp___2074 () Bool)
...
;; H
  (assert (= (to_rep1 x__split_discrs) r32b))
...
;; H
  (assert (= temp___207 o6))

;; H
  (assert (= temp___2071 o3))

;; H
  (assert (= temp___2072 o4))

;; H
  (assert (= temp___2073 o5))
...
(assert
;; WP_parameter_def
 ;; File "definite.adb", line 107, characters 0-0
  (not (= temp___207 x__split_discrs)))
(check-sat)
(exit)
