...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (length (mk___rep s1__split_discrs s1__split_fields1))))
  (= (get (elements (mk___rep s1__split_discrs s1__split_fields1)) i)
  (get
  (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  ...
  (= (oeq3 (elements (mk___rep s1__split_discrs s1__split_fields2))
     (elements (mk___rep s1__split_discrs s1__split_fields1))) true))
  (= (oeq4 (positions (mk___rep s1__split_discrs s1__split_fields2))
...
;; H
  ...
  (= (bool_eq1 temp___7561 no_element) true)
  (and
...
;; H
  (assert (<= i (length (mk___rep s2__split_discrs s2__split_fields2))))

(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 53, characters 0-0
  (not
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields2)) i)
  (get
  (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
  i))))
(check-sat)
