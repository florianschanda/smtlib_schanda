...
;; H
  ...
  (and (= o3 (* (* (div1 4 space3) 8) 1000000)) (in_range3
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 7))
  (and (<= (- o3) (to_rep (select a2 k1))) (<= (to_rep (select a2 k1)) o3))))))))

;; H
  (assert
  (=> (not (=> (not (= space3 4)) (=> (not (= space3 2)) (= space3 1))))
  (= result3 false)))
...
;; H
  (assert
  (=> (= space3 2) (= result4 (ite (= (mod2 (+ k 1) 8) 0) true false))))
...
;; H
  (assert
  (=> (= space3 2) (= result5 (ite (= (mod2 (+ k 1) 4) 0) true false))))

;; H
  (assert (=> (not (= space3 2)) (= result5 false)))
