...
(define-fun element_type__ref___8__projection ((a element_type__ref)) us_rep
...
(define-fun us_rep___14__projection ((a us_rep1)) us_split_discrs (us_split_discrs1
                                                                  a))
...
(define-fun element_type__ref___9__projection ((a element_type__ref1)) us_rep
...
(define-fun sequence__ref___3__projection ((a sequence__ref)) us_rep2
  (sequence__content a))
...
(((mk_t56b__ref (t56b__content tindex_countB)))))
...
(define-fun extended_index__ref___4__projection ((a extended_index__ref1)) extended_index1
...
;; H
  ...
  (<= (to_rep1
      ...
      (get
      (model__
      (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j3)))) k)
  (<= k (to_rep1
        (rec__partition_refinement__interval__last
        (us_split_fields1
        (get
        (model__
        (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j3))))))
  (= (to_rep2 (select f k)) j3))))))))))
...
;; H
  ...
  (and
  (<= (to_rep1
      (rec__partition_refinement__interval__first p_prime__split_fields1)) k)
  (<= k i2)) (= (to_rep2 (select f3 k)) p_prime_index2)))))
...
;; H
  ...
  (= (to_rep2 (select f3 k)) (to_rep2 (select f_loop_entry k)))))))
...
;; H
  ...
  (<= k (to_rep1
        (rec__partition_refinement__interval__last p_prime__split_fields1))))
  (= (to_rep2 (select (map__content f6) k)) (- (length
                                               (mk___rep1 p__split_discrs
                                               p__split_fields3)) 1)))))
...
;; H
  ...
  (<= k (- (to_rep1
           (rec__partition_refinement__interval__first
           p_prime__split_fields1)) 1)))
  (and (<= 0 (to_rep2 (select (map__content f6) k)))
  (<= (to_rep2 (select (map__content f6) k)) (- (length
                                                (mk___rep1 p__split_discrs
                                                p__split_fields3)) 1))))))
...
;; H
  ...
  (and
  (<= (+ (to_rep1
         (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k)
  (<= k 5))
  (and (<= 0 (to_rep2 (select (map__content f6) k)))
  (<= (to_rep2 (select (map__content f6) k)) (- (length
                                                (mk___rep1 p__split_discrs
...
;; H
  ...
  (and
  (<= (to_rep1
      (rec__partition_refinement__interval__first p_elem__split_fields3)) k)
  (<= k (to_rep1
        (rec__partition_refinement__interval__last p_elem__split_fields3))))
  (= (bool_eq
     (get (model__ (mk___rep1 p__split_discrs p__split_fields3))
     (to_rep2 (select (map__content f6) k)))
...
;; H
  ...
  (<= (to_rep1
      ...
      (us_split_fields1
      (get (model__ (mk___rep1 p__split_discrs p__split_fields3))
      (to_rep2 (select (map__content f6) k)))))) k)
  (<= k (to_rep1
        (rec__partition_refinement__interval__last
        (us_split_fields1
        (get (model__ (mk___rep1 p__split_discrs p__split_fields3))
...
;; H
  ...
  (and (<= 0 k)
  (<= k (- (to_rep1
           (rec__partition_refinement__interval__first p_elem__split_fields3)) 1)))
  (and
  (<= (to_rep1
      (rec__partition_refinement__interval__first
      (us_split_fields1
...
;; H
  ...
  (<= (to_rep1
      (rec__partition_refinement__interval__first
      (us_split_fields1
      (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k)))) l1)
  (<= l1 (to_rep1
         (rec__partition_refinement__interval__last
         (us_split_fields1
         (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k))))))
  (= (to_rep2 (select (map__content f6) l1)) k))))))

;; H
  (assert (and (= o19 j2) (in_range8 j2)))

;; H
  (assert
  (and
  (= o20 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o19))
  (= (bool_eq o20
     (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o19)) true)))
...
;; H
  (assert (= o24 (ite (<= l o23) true false)))
...
;; H
  (assert
  (and
  (= o15 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o14))
  (= (bool_eq o15
     (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o14)) true)))

;; H
  (assert (= o16 (us_split_fields1 o15)))

;; H
  (assert (= o17 (rec__partition_refinement__interval__first o16)))

;; H
  (assert (= o18 (to_rep1 o17)))

;; H
  (assert (= o25 (ite (<= o18 l) true false)))

;; H
  (assert (= result10 (ite (= o25 true) o24 false)))
