...
(declare-fun x__split_fields1 () (Array Int character))

(declare-fun x__split_fields2 () sixty)

(declare-fun x__split_fields3 () sixty)

(declare-fun x__split_fields4 () twenty_four)
...
(declare-fun instr__increment__x__fields () sixty)

(declare-fun instr__increment__x__fields1 () sixty)

(declare-fun instr__increment__x__fields2 () twenty_four)

(declare-fun instr__increment__x__fields3 () (Array Int character))

(declare-fun instr__increment__x__fields4 () us_private)

(declare-fun result () thousand)

(declare-fun result1 () (Array Int character))

(declare-fun result2 () sixty)

(declare-fun result3 () sixty)

(declare-fun result4 () twenty_four)

(declare-fun result5 () us_private)

(declare-fun x__split_fields6 () thousand)

(declare-fun x__split_fields7 () (Array Int character))

(declare-fun x__split_fields8 () sixty)

(declare-fun x__split_fields9 () sixty)

(declare-fun x__split_fields10 () twenty_four)

(declare-fun x__split_fields11 () us_private)
...
;; H
  (assert
  (= (mk___split_fields2 x__split_fields6 x__split_fields7 x__split_fields8
     x__split_fields9 x__split_fields10 x__split_fields11) (us_split_fields5
                                                           (of_base1
                                                           (mk___rep
                                                           (mk___split_fields
                                                           instr__increment__x__fields3
                                                           (hide_ext__
                                                           instr__increment__x__fields
                                                           instr__increment__x__fields1
                                                           instr__increment__x__fields2
                                                           instr__increment__x__fields4))
                                                           (attr__tag1
                                                           (of_base
                                                           (mk___rep
                                                           (mk___split_fields
...
;; WP_parameter_def
 ;; File "instr-child.ads", line 7, characters 0-0
  (not (in_range (+ (to_rep3 x__split_fields6) inc))))
(check-sat)
(exit)
