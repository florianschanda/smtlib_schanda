...
(declare-fun temp___376 () (Array Int natural))

(declare-fun temp___3761 () t1)
...
;; H
  ...
  (and (= (to_rep1 res__first) (to_rep1 (first (rt a))))
  (= (to_rep1 res__last) (to_rep1 (last (rt a)))))))

;; H
  (assert
  (= (ite (<= (to_rep1 r__first) (to_rep1 r__last))
     (+ (- (to_rep1 r__last) (to_rep1 r__first)) 1) 0) (ite (<= (to_rep1
                                                                (first
                                                                (rt a)))
                                                       (to_rep1
                                                       (last (rt a))))
...
;; H
  (assert
  (= (slide r3 (to_rep1 r__first) (to_rep1 (first (rt a)))) temp___376))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) temp___3761))

(assert
;; WP_parameter_def
 ;; File "loops_static.ads", line 2, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___3761)) (to_rep1 (last2 temp___3761)))
     (+ (- (to_rep1 (last2 temp___3761)) (to_rep1 (first2 temp___3761))) 1)
     0) (ite (<= (to_rep1 res__first) (to_rep1 res__last))
        (+ (- (to_rep1 res__last) (to_rep1 res__first)) 1) 0))))
(check-sat)
(exit)
