...
;; H
  ...
  (to_rep1
  (select (select (rec__patience__state__stacks
                  (us_split_fields__content s__split_fields20)) i14) k))))))))))))
...
;; H
  (assert
  (= o120 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o119)))
...
;; H
  (assert
  (= o117 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o116)))

;; H
  (assert (= o118 (to_rep1 o117)))

;; H
  (assert (= o123 (ite (<= (- 1) o118) true false)))

;; H
  (assert (= result27 (ite (= o123 true) o122 false)))

;; H
  (assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))

;; H
  (assert (=> (= result27 true) (= o113 i1)))

;; H
  (assert
  (=> (= result27 true)
  (= o114 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o113))))

;; H
  (assert (=> (= result27 true) (= o115 (to_rep1 o114))))

;; H
  (assert (=> (= result27 true) (= result26 (ite (< o115 i1) true false))))
...
;; H
  (assert
  (= o106 (select (rec__patience__state__preds
...
;; H
  (assert (= result28 (ite (< o107 0) true false)))
...
;; H
  (assert
  (= o111 (select (rec__patience__state__values
...
;; H
  (assert
  (= o109 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o108)))

;; H
  (assert (= temp___750 (to_rep1 o109)))
