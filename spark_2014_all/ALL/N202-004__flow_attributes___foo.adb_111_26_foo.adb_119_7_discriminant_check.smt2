...
(declare-datatypes ((t43b__ref 0)) (((mk_t43b__ref (t43b__content us_rep)))))
...
(declare-datatypes ((t46b__ref 0)) (((mk_t46b__ref (t46b__content us_rep)))))
...
;; H
  (assert (not (= (to_int1 (rec__foo__dt__found a__split_discrs)) 1)))
...
;; WP_parameter_def
 ;; File "foo.adb", line 98, characters 0-0
  (not (= (of_int 0) (rec__foo__dt__found a__split_discrs))))
(check-sat)
(exit)
