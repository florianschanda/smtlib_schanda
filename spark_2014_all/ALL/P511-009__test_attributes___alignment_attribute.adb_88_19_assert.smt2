...
(declare-datatypes ((sr2__ref 0)) (((mk_sr2__ref (sr2__content us_rep)))))
...
(declare-datatypes ((r4__ref 0)) (((mk_r4__ref (r4__content us_rep2)))))
...
(((mk_map__ref2 (map__content2 (Array Int natural))))))
...
(declare-datatypes ((unconstr_array__ref 0))
...
(((mk_trt2S__ref (trt2S__content us_rep)))))
