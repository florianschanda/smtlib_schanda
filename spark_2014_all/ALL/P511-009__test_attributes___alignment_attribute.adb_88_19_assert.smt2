...
(declare-fun alignment_attribute__r2__d1__first__bit () Int)

(declare-fun alignment_attribute__r2__d1__last__bit () Int)

(declare-fun alignment_attribute__r2__d1__position () Int)
...
(declare-fun alignment_attribute__r2__d2__first__bit () Int)

(declare-fun alignment_attribute__r2__d2__last__bit () Int)

(declare-fun alignment_attribute__r2__d2__position () Int)
...
(declare-fun alignment_attribute__r2__d1__first__bit1 () Int)

(declare-fun alignment_attribute__r2__d1__last__bit1 () Int)

(declare-fun alignment_attribute__r2__d1__position1 () Int)
...
(declare-fun alignment_attribute__r2__d2__first__bit1 () Int)

(declare-fun alignment_attribute__r2__d2__last__bit1 () Int)

(declare-fun alignment_attribute__r2__d2__position1 () Int)
...
(declare-fun alignment_attribute__r3__i__first__bit () Int)

(declare-fun alignment_attribute__r3__i__last__bit () Int)

(declare-fun alignment_attribute__r3__i__position () Int)
...
(define-fun us_split_fields_I2__projection ((a us_split_fields4)) integer
...
(declare-fun alignment_attribute__r4__j__first__bit () Int)

(declare-fun alignment_attribute__r4__j__last__bit () Int)

(declare-fun alignment_attribute__r4__j__position () Int)
...
(declare-fun alignment_attribute__r3__i__first__bit1 () Int)

(declare-fun alignment_attribute__r3__i__last__bit1 () Int)

(declare-fun alignment_attribute__r3__i__position1 () Int)
...
(declare-fun dummy10 () (Array Int positive))
...
(declare-fun alignment_attribute__r2__d1__first__bit2 () Int)

(declare-fun alignment_attribute__r2__d1__last__bit2 () Int)

(declare-fun alignment_attribute__r2__d1__position2 () Int)
...
(declare-fun alignment_attribute__r2__d2__first__bit2 () Int)

(declare-fun alignment_attribute__r2__d2__last__bit2 () Int)

(declare-fun alignment_attribute__r2__d2__position2 () Int)
...
(declare-fun rt2__split_discrs () us_split_discrs)

(declare-fun rt2__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun rst2__split_discrs () us_split_discrs)

(declare-fun rst2__attr__constrained () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS6 () Int)

(declare-fun rt3__attr__tag () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS7 () Int)

(declare-fun rt4__attr__tag () Int)
...
(declare-fun rt2__split_fields () Bool)

(declare-fun rst2__split_fields () Bool)

(declare-fun rt3__split_fields () integer)

(declare-fun rt3__split_fields1 () us_private)

(declare-fun rt4__split_fields () integer)

(declare-fun rt4__split_fields1 () integer)

(declare-fun rt4__split_fields2 () us_private)

(declare-fun ca () (Array Int positive))
...
(declare-fun result3 () (Array Int positive))

(declare-fun ca1 () (Array Int positive))
...
;; H
  (assert
  (<= 0 (object__alignment8
        (mk___rep rt2__split_discrs (mk___split_fields rt2__split_fields)
        rt2__attr__constrained))))

;; H
  (assert
  (<= 0 (object__alignment3
        (mk___rep rst2__split_discrs (mk___split_fields rst2__split_fields)
        rst2__attr__constrained))))

;; H
  (assert
  (<= 0 (object__alignment4
        (mk___rep1 (mk___split_fields1 rt3__split_fields rt3__split_fields1)
        rt3__attr__tag))))
...
;; WP_parameter_def
 ;; File "alignment_attribute.adb", line 33, characters 0-0
  (not
  (<= 0 (object__alignment5
        (mk___rep2
        (mk___split_fields2 rt4__split_fields rt4__split_fields1
        rt4__split_fields2) rt4__attr__tag)))))
(check-sat)
(exit)
