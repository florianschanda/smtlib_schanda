...
;; H
  (assert
  (=> (not (and (<= 0 i1) (<= i1 last_candidate))) (= total1 total6)))
...
;; H
  (assert
  (=> (not (and (<= 0 i1) (<= i1 last_candidate))) (= total7 total1)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range8 (- total6 (to_rep2 (select counters 0))))))
(check-sat)
(exit)
