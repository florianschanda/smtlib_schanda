...
(declare-fun result6 () count_type)
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 result6)) (cursor__content
                                              use_lists__my_find__result13)))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not
  (= (bool_eq1 (cursor__content use_lists__my_find__result13) no_element) true)))
(check-sat)
(exit)
