...
(declare-const x86__readreghigh8__result (_ BitVec 8))

(declare-const result (_ BitVec 8))

(declare-const x86__readreghigh8__result1 (_ BitVec 8))

(declare-const x86__readreghigh8__result2 (_ BitVec 8))

(declare-const x86__readreghigh8__result3 (_ BitVec 8))

(declare-const x86__readreghigh8__result4 (_ BitVec 8))

(declare-const x86__readreghigh8__result5 (_ BitVec 8))

(declare-const result1 (_ BitVec 8))

;; H
  (assert (= x86__readreghigh8__result1 x86__readreghigh8__result2))

;; H
  (assert (= x86__readreghigh8__result3 x86__readreghigh8__result1))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__readreghigh8__result)))

;; H
  (assert
  (= x86__readreghigh8__result1 ((_ extract 7 0) (bvudiv (bvand reg ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)))))

;; H
  (assert
  (= (mk_t__ref x86__readreghigh8__result4) (mk_t__ref
                                            x86__readreghigh8__result2)))

;; H
  (assert (= x86__readreghigh8__result5 x86__readreghigh8__result3))

;; H
  (assert (= result1 x86__readreghigh8__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= x86__readreghigh8__result4 ((_ extract 7 0) (bvurem (bvudiv (bvand
  reg ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256))))))
(check-sat)
(exit)
