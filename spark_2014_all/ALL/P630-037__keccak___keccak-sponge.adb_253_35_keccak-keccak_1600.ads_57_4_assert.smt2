...
;; H
  ...
  (and
  (and
  (and (= (state_of (mk___rep ctx__split_fields7)) 0)
  (= (rate_of (mk___rep ctx__split_fields7)) (rate_of
                                             (mk___rep ctx__split_fields6))))
  (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields7)) 8) (mod2
                                                                  o15 8)))
  (< (in_queue_bit_length (mk___rep ctx__split_fields7)) (rate_of
                                                         (mk___rep
                                                         ctx__split_fields7)))))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (= (state_of (mk___rep ctx__split_fields7)) 0)))
(check-sat)
(exit)
