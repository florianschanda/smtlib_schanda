...
(((mk___split_fields (rec__foo__g Bool)))))
...
(declare-datatypes ((p1T__ref 0)) (((mk_p1T__ref (p1T__content us_rep)))))
...
(define-fun default_initial_assumption ((temp___expr_184 us_rep)
  (temp___skip_top_level_185 Bool)) Bool (= (rec__foo__g
                                            (us_split_fields1
...
(assert
;; WP_parameter_def
 ;; File "foo.adb", line 17, characters 0-0
  (not true))
(check-sat)
(exit)
