...
(declare-fun temp___351 () index)

(declare-fun temp___3511 () (Array Int value))

(declare-fun temp___3512 () (Array Int value))
...
(declare-fun temp___355 () index)

(declare-fun temp___3551 () (Array Int value))

(declare-fun temp___3552 () (Array Int value))
...
(declare-fun temp___358 () index)

(declare-fun temp___3581 () (Array Int value))

(declare-fun temp___3582 () (Array Int value))

(declare-fun o14 () value)

(declare-fun o15 () (Array Int value))
...
(declare-fun temp___361 () index)

(declare-fun temp___3611 () (Array Int value))

(declare-fun temp___3612 () (Array Int value))
...
;; H
  (assert (= temp___351 o1))

;; H
  (assert (= temp___3511 o2))

;; H
  (assert (= temp___3512 o3))
...
;; H
  (assert (= temp___351 a__split_fields3))

;; H
  (assert (= temp___3511 a__split_fields4))

;; H
  (assert (= temp___3512 a__split_fields5))
...
;; H
  (assert (= temp___355 o6))

;; H
  (assert (= temp___3551 o7))

;; H
  (assert (= temp___3552 o8))
...
;; H
  (assert
  (= a__split_fields6 (mk___split_fields temp___355 temp___3551 temp___3552)))
...
;; H
  (assert
  (= o10 (store (rec__arrays_in_records__record_with_arrays__second_array
                a__split_fields6) j o9)))

;; H
  (assert
  (= (rec__arrays_in_records__record_with_arrays__counter a__split_fields6)
  o11))

;; H
  (assert
  (= (rec__arrays_in_records__record_with_arrays__first_array
     a__split_fields6) o12))

;; H
  (assert (= o10 o13))

;; H
  (assert (= temp___358 o11))

;; H
  (assert (= temp___3581 o12))

;; H
  (assert (= temp___3582 o13))
...
;; H
  (assert
  (= a__split_fields7 (mk___split_fields temp___358 temp___3581 temp___3582)))
...
;; H
  (assert
  (= o15 (store (rec__arrays_in_records__record_with_arrays__first_array
                a__split_fields7) j o14)))

;; H
  (assert
  (= (rec__arrays_in_records__record_with_arrays__counter a__split_fields7)
  o16))
...
;; H
  (assert
  (= (rec__arrays_in_records__record_with_arrays__second_array
     a__split_fields7) o18))

;; H
  (assert (= temp___361 o16))

;; H
  (assert (= temp___3611 o17))

;; H
  (assert (= temp___3612 o18))
...
;; H
  (assert
  (= a__split_fields8 (mk___split_fields temp___361 temp___3611 temp___3612)))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 210, characters 0-0
  (not
  (not
  (= (bool_eq1 (mk___rep (us_split_fields__content a__split_fields9))
     (mk___rep
