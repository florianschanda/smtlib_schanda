...
;; H
  (assert (and (= o16 (- i9 first4)) (in_range1 (- i9 first4))))

;; H
  (assert
  (and (= o17 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o17)
  (<= o17 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))

;; H
  (assert (= result6 (ite (= o17 o16) true false)))

;; H
  (assert
  (=> (= result6 true) (and (= o12 (- last5 i9)) (in_range1 (- last5 i9)))))

;; H
  (assert (=> (= result6 true) (= o13 (+ o12 1))))

;; H
  (assert (=> (= result6 true) (and (= o14 o13) (in_range1 o13))))

;; H
  (assert
  (=> (= result6 true)
  (and (= o11 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o11 true false true)
  (and (= (to_rep (first (rt o11))) 1) (<= 0 (to_rep (last (rt o11)))))))))

;; H
  (assert (=> (= result6 true) (= o15 (to_rep (last (rt o11))))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o7 (- last5 i9)) (in_range1 (- last5 i9)))))

;; H
  (assert (=> (= result5 true) (= o8 (+ o7 1))))

;; H
  (assert (=> (= result5 true) (and (= o9 o8) (in_range1 o8))))

;; H
  (assert (=> (= result5 true) (= o10 (ite (<= j1 o9) true false))))

;; H
  (assert (=> (= result5 true) (= result7 (ite (<= 1 j1) o10 false))))
