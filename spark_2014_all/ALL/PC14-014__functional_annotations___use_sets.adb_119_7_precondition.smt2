...
;; H
  ...
  (= (element (mk___rep s__split_discrs s__split_fields8)
     (find1 (mk___rep s__split_discrs s__split_fields8) 1)) 1))
  (ite (= (contains
          (model__
  ...
  (= (equal_except
     ...
     (find1 (mk___rep s__split_discrs s__split_fields8) 1))) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (= (element (mk___rep s__split_discrs s__split_fields7)
     (find1 (mk___rep s__split_discrs s__split_fields7) 2)) 2))
  ...
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields8))
     ...
     (find1 (mk___rep s__split_discrs s__split_fields7) 2))) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (= (element (mk___rep s__split_discrs s__split_fields6)
     (find1 (mk___rep s__split_discrs s__split_fields6) 3)) 3))
  ...
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields7))
     ...
     (find1 (mk___rep s__split_discrs s__split_fields6) 3))) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (= (element (mk___rep s__split_discrs s__split_fields5)
     (find1 (mk___rep s__split_discrs s__split_fields5) 4)) 4))
  ...
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields6))
     ...
     (find1 (mk___rep s__split_discrs s__split_fields5) 4))) true))
  (and
  (and
  (and
  (and
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 60, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields5)) (to_rep1
                                                          (rec__use_sets__my_sets__set__capacity
                                                          s__split_discrs)))
