...
(declare-fun o12 () normalized2pi)

(declare-fun o13 () float)

(declare-fun o14 () idir_t)
...
;; H
  (assert
  (= (mk___rep1
     (mk___split_fields1 (mk___rep (mk___split_fields o12)) o13 o14))
  (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields2)
