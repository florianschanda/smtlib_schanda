...
(declare-fun temp___552 () (Array Int component_t))
...
(declare-fun result1 () (Array Int component_t))

(declare-fun a3 () (Array Int component_t))

(declare-fun a4 () (Array Int component_t))

(declare-fun j3 () Int)

(declare-fun a5 () (Array Int component_t))

(declare-fun j4 () Int)

(declare-fun a6 () (Array Int component_t))

(declare-fun j5 () Int)

(declare-fun a7 () (Array Int component_t))

(declare-fun j6 () Int)

(declare-fun a8 () (Array Int component_t))

(declare-fun j7 () Int)

(declare-fun a9 () (Array Int component_t))
...
;; WP_parameter_def
 ;; File "loop_entry_test.ads", line 10, characters 0-0
  (not (= (bool_eq2 a8 1 1000 (temp___532 a first last 0) 1 1000) true)))
(check-sat)
