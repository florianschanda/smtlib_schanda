...
;; H
  (assert
  (and
  (= o4 (length (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and (in_range4 o4)
  (<= o4 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o2 (length m)) (and (in_range4 o2) (<= o2 (capacity m))))))
...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))))
  (= (get (model__ m) i1) (get
                          (model__
                          (rec__amortized_queue__queue__rear
                          (us_split_fields3 q)))
                          (+ (- (length
                                (rec__amortized_queue__queue__rear
                                (us_split_fields3 q))) i1) 1))))))))
