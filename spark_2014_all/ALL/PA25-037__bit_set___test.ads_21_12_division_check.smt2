...
(((mk_map__ref (map__content (Array Int unsigned_32))))))
...
(((mk___t (elts (Array Int unsigned_32))(rt t)))))
...
(define-fun dynamic_invariant5 ((temp___expr_178 (_ BitVec 32))
...
;; H
  (assert
  (and (= o (- (to_rep1 (last (rt a))) a_first)) (in_range1
  (- (to_rep1 (last (rt a))) a_first))))
...
;; WP_parameter_def
 ;; File "test.ads", line 13, characters 0-0
  (not (not (= ((_ int2bv 64) 32) #x0000000000000000))))
(check-sat)
(exit)
