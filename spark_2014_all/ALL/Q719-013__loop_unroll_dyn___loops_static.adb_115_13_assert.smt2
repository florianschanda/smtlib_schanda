...
(declare-fun bad11 () Bool)

(declare-fun j10 () Int)

(declare-fun bad12 () Bool)

(declare-fun j11 () Int)

(define-fun j12 () int__ref (mk_int__ref j10))

(define-fun j13 () int__ref (mk_int__ref j8))
...
;; H
  (assert (=> (= i1 (to_rep1 a__first)) (= j12 j15)))

;; H
  (assert (=> (= i1 (to_rep1 a__first)) (= bad2 bad11)))

;; H
  (assert (=> (= i1 (to_rep1 a__first)) (= j11 j1)))
...
;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last)) (= (mk_int__ref result4) j15))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last)) (= j2 (to_rep1 a__first)))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= temp___337 bad1)))))
...
;; H
  ...
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j14 (mk_int__ref j4))))))
...
;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last)) (= j13 j14))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last)) (= bad13 bad14))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last)) (= j9 j7))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last)) (= bad10 bad8))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (not (= i1 (to_rep1 a__last))) (= j13 j15))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (not (= i1 (to_rep1 a__last))) (= bad1 bad9))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (not (= i1 (to_rep1 a__last))) (= j9 j1))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (not (= i1 (to_rep1 a__last))) (= bad10 bad1))))

;; H
  (assert (=> (not (= i1 (to_rep1 a__first))) (= j12 j13)))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first))) (= (mk_bool__ref bad11) bad13)))
