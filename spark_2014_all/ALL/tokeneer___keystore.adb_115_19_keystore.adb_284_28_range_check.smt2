...
(declare-fun temp___1260 () unsigned32t)

(declare-fun temp___12601 () returnvaluet)

(declare-fun temp___12602 () returnvaluet)

(declare-fun temp___12603 () (Array Int bytet))

(declare-fun temp___1214 () Int)

(declare-fun temp___1213 () Int)

(declare-fun temp___1212 () Int)

(declare-fun temp___1211 () (Array Int character))

(declare-fun temp___1215 () Int)

(declare-fun temp___1210 () Int)
...
(declare-fun temp___1222 () us_t1)

(declare-fun temp___1226 () us_t1)

(declare-fun o16 () (Array Int character))

(declare-fun temp___1221 () us_t)
...
(declare-fun temp___1235 () us_t2)

(declare-fun temp___1239 () us_t2)

(declare-fun o25 () (Array Int character))

(declare-fun temp___1234 () us_t)
...
(declare-fun keystore__digest__B60b__thestring__assume () us_t)
...
;; H
  ...
  (= (ite (<= (to_rep1 (first2 (rt1 temp___1222))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first2 (mk1 1 (length thestring)))) (to_rep1
                                                               ...
                                                               (length
                                                               thestring)))))
        (+ (- (to_rep1 (last2 (mk1 1 (length thestring)))) (to_rep1
                                                           (first2
                                                           (mk1 1
                                                           (length thestring))))) 1)
        0)))))
...
;; H
  ...
  (= (select o16 temp___1227) (select (elts1 temp___1226) temp___1227))
  (= (select o16 temp___1227) (select result__5 temp___1227)))))))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (not (= result12 true)) (= o17 (elts temp___1221)))))
...
;; H
  ...
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (= result17 true)
  (= (ite (<= (to_rep1 (first4 (rt2 temp___1235))) (to_rep1
                                                   (last4 (rt2 temp___1235))))
     (+ (- (to_rep1 (last4 (rt2 temp___1235))) (to_rep1
                                               (first4 (rt2 temp___1235)))) 1)
     0) (ite (<= (to_rep1 (first4 (mk2 1 (length thestring1)))) (to_rep1
                                                                (last4
                                                                (mk2 1
                                                                (length
                                                                thestring1)))))
        (+ (- (to_rep1 (last4 (mk2 1 (length thestring1)))) (to_rep1
                                                            (first4
                                                            (mk2 1
                                                            (length
                                                            thestring1))))) 1)
...
;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (= result17 true) (= temp___1239 temp___1235))))

;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (= result17 true)
  (forall ((temp___1240 Int))
  (ite (and (<= 1 temp___1240) (<= temp___1240 (length thestring1)))
  (= (select o25 temp___1240) (select (elts2 temp___1239) temp___1240))
  (= (select o25 temp___1240) (select result__12 temp___1240)))))))
...
;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (not (= result17 true)) (= temp___1234 thestring1))))

;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (not (= result17 true)) (= o26 (elts temp___1234)))))
...
;; H
  (assert (and (= o32 o31) (in_range2 o31)))

;; H
  (assert
  (= keystore__digest__B60b__thestring__assume (mk___t
                                               (concat1
                                               (temp___String_Literal_1254
                                               Tuple0) 1 38
                                               (elts
                                               (to_string
                                               (attr__ATTRIBUTE_IMAGE8 c56b)))
                                               (to_rep1
                                               (first
                                               (rt
                                               (to_string
