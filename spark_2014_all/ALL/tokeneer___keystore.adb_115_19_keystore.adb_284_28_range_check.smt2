...
;; H
  ...
  (= (select o17 temp___1227) (select result__5 temp___1227)))))))
...
;; H
  (assert
  (=> (= (select issystem retvalini1) true)
  (=> (not (= result12 true)) (= result__7 o18))))
...
;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true) (= o22 (+ 1 o21))))

;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true) (= o23 (- o22 1))))
...
;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (and (= o25 (length thestring1)) (in_range1 (length thestring1)))))

;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (= result17 (ite (<= o25 150) true false))))
...
;; H
  ...
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (= result17 true)
  (and (= temp___1237 (length thestring1)) (in_range1 (length thestring1))))))
...
;; H
  ...
  (=> (<= 1 temp___1237)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1237) (<= temp___1237 150)))))))

;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (= result17 true) (= o26 result__12))))

;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (= result17 true) (= temp___1238 (mk___t2 o26 (mk2 1 temp___1237))))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first4 (rt2 temp___1235))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first4 (rt2 temp___1238))) (to_rep1
                                                      (last4
                                                      (rt2 temp___1238))))
        (+ (- (to_rep1 (last4 (rt2 temp___1238))) (to_rep1
                                                  (first4 (rt2 temp___1238)))) 1)
        0)))))
...
;; H
  ...
  (= (select o27 temp___1240) (select (elts2 temp___1239) temp___1240))
  (= (select o27 temp___1240) (select result__12 temp___1240)))))))
...
;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (not (= result17 true)) (= o28 (elts temp___1234)))))
...
;; H
  (assert
  (=> (= (select issystem (int__content retvalupd8)) true)
  (=> (not (= result17 true)) (= result__14 o28))))
