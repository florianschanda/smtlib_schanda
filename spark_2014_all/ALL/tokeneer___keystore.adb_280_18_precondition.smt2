...
;; H
  (assert
  (=> (= result22 true)
  (and (= temp___1250 (length thestring2)) (in_range1 (length thestring2)))))
...
;; H
  ...
  (=> (<= 1 temp___1250)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1250) (<= temp___1250 150))))))
...
;; H
  (assert
  (=> (= result22 true) (= temp___1251 (mk___t3 o36 (mk3 1 temp___1250)))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first6 (rt3 temp___1248))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first6 (rt3 temp___1251))) (to_rep1
                                                      (last6
                                                      (rt3 temp___1251))))
        (+ (- (to_rep1 (last6 (rt3 temp___1251))) (to_rep1
                                                  (first6 (rt3 temp___1251)))) 1)
        0))))
...
;; H
  ...
  (= (select o37 temp___1253) (select (elts3 temp___1252) temp___1253))
  (= (select o37 temp___1253) (select result__19 temp___1253))))))
