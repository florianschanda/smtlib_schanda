...
(declare-fun temp___1248 () us_t3)

(declare-fun temp___1252 () us_t3)

(declare-fun o34 () (Array Int character))

(declare-fun temp___1247 () us_t)
...
;; H
  (assert
  (=> (= result22 true)
  (= (ite (<= (to_rep1 (first6 (rt3 temp___1248))) (to_rep1
                                                   (last6 (rt3 temp___1248))))
     (+ (- (to_rep1 (last6 (rt3 temp___1248))) (to_rep1
                                               (first6 (rt3 temp___1248)))) 1)
...
;; H
  ...
  (ite (and (<= 1 temp___1253) (<= temp___1253 (length thestring2)))
  (= (select o34 temp___1253) (select (elts3 temp___1252) temp___1253))
  (= (select o34 temp___1253) (select result__19 temp___1253))))))
...
;; H
  (assert (=> (not (= result22 true)) (= o35 (elts temp___1247))))
