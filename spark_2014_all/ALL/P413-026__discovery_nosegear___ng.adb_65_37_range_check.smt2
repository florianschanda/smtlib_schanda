...
;; H
  (assert (= o3 (div1 o2 t11)))

;; H
  (assert (and (= o4 o3) (in_range3 o3)))

;; H
  (assert (= (mk_int__ref result3) (mk_int__ref d2)))

;; H
  (assert (= d21 o4))

;; H
  (assert (= success2 result4))

;; H
  (assert (= success3 (of_int 1)))

;; H
  (assert (and (= o8 (+ t11 t21)) (in_range1 (+ t11 t21))))

;; H
  (assert (and (= o5 (+ d11 d21)) (in_range1 (+ d11 d21))))
