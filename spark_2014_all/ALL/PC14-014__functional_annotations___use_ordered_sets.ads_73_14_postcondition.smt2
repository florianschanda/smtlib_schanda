...
(declare-const temp___7821 us_main_type)
...
;; H
  (assert
  (=> (= result1 true)
  (and (= (mk___split_discrs temp___782) s2__split_discrs)
  (= temp___7821 s2__split_fields))))

;; H
  (assert (=> (= result1 true) (= temp___781 cu__split_fields1)))
