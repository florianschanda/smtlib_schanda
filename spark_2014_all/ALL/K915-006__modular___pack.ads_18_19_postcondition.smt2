...
(declare-fun pack__minus__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun pack__minus__result1 () (_ BitVec 8))

(declare-fun pack__minus__result2 () (_ BitVec 8))

(declare-fun pack__minus__result3 () (_ BitVec 8))

(declare-fun pack__minus__result4 () (_ BitVec 8))

(declare-fun pack__minus__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= (mk_t__ref pack__minus__result4) (mk_t__ref pack__minus__result2)))
...
;; WP_parameter_def
 ;; File "pack.ads", line 3, characters 0-0
  (not (not (= pack__minus__result4 ((_ int2bv 8) 0)))))
(check-sat)
