...
(declare-const temp___6600 et1)

(declare-const temp___66001 et2)
...
(declare-const temp___6602 et1)

(declare-const temp___66021 et2)
...
;; H
  (assert (= temp___6600 o1))

;; H
  (assert (= temp___66001 o2))
...
;; H
  (assert (= temp___6600 r__split_fields2))

;; H
  (assert (= temp___66001 r__split_fields3))
...
;; H
  (assert (= temp___6602 o4))

;; H
  (assert (= temp___66021 o5))
...
;; H
  (assert (= temp___6602 r__split_fields4))

;; H
  (assert (= temp___66021 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 714, characters 0-0
  (not
  (= (bool_eq
     (mk___rep (mk___split_fields r__split_fields6 r__split_fields7))
     (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) true)))
(check-sat)
(exit)
