...
(declare-fun result2 () (Array Int (Array Int (Array Int (Array Int et1)))))

(declare-fun a3 () (Array Int (Array Int (Array Int (Array Int et1)))))

(declare-fun a4 () (Array Int (Array Int (Array Int (Array Int et1)))))

(declare-fun a5 () (Array Int (Array Int (Array Int (Array Int et1)))))
...
;; H
  (assert
  (= a3 (store a2 i (store (select a2 i) j (store (select (select a2
  i) j) k d)))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 653, characters 0-0
  (not (= (bool_eq2 (select a4 n) 1 16 (select a n) 1 16) true)))
(check-sat)
(exit)
