...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___835)
  (<= temp___835 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___835) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           result____split_fields2)) temp___835))))))
...
;; H
  (assert (= temp___832 (mk___rep1 result____split_discrs o10)))

;; H
  (assert (= result3 (mk___split_fields__ref1 result____split_fields3)))

;; H
  (assert (= result____split_fields4 (us_split_fields3 temp___832)))

;; H
  (assert (= result____split_discrs (us_split_discrs2 temp___832)))
