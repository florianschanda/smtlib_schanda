...
;; def_axiom
  (assert
  (forall ((temp___306 (Array Int int5)))
  (forall ((temp___307 Int))
  (= (select (temp___304 temp___306) temp___307) temp___306))))

(declare-fun temp___308 (Int Int) (Array Int int5))

;; def_axiom
  (assert
  (forall ((temp___310 Int) (temp___311 Int))
  (let ((temp___309 (temp___308 temp___310 temp___311)))
  (forall ((temp___312 Int))
  (ite (= temp___312 3)
  (= (select temp___309 temp___312) (of_rep temp___310))
  (= (select temp___309 temp___312) (of_rep temp___311)))))))
...
(declare-fun temp___303 () (Array Int int5))
...
(declare-fun temp___313 () (Array Int int5))
...
;; H
  (assert (= temp___313 (select a o5)))

(assert
;; WP_parameter_def
 ;; File "r.adb", line 41, characters 0-0
  (not (<= 2 n)))
(check-sat)
(exit)
