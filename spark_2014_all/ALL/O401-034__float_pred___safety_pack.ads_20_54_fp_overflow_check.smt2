...
(define-fun dynamic_invariant1 ((temp___expr_1297 t)
...
(declare-fun safety_pack__dead_band__result () t)
...
(declare-fun safety_pack__dead_band__result1 () t)

(declare-fun safety_pack__dead_band__result2 () t)

(declare-fun safety_pack__dead_band__result3 () t)

(declare-fun res5 () t)

(declare-fun safety_pack__dead_band__result4 () t)

(declare-fun res6 () t)

(declare-fun safety_pack__dead_band__result5 () t)

;; H
  (assert (tqtisFinite value))
...
;; H
  (assert (tqtisFinite res1))

;; H
  (assert
  (=> (and (le (neg threshold) value) (le value threshold)) (= result1 res1)))

;; H
  (assert
  (=> (and (le (neg threshold) value) (le value threshold))
  (= res2 fliteral2)))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (lt fliteral2 value)
  (and (= o (sub RNE1 res1 threshold)) (tqtisFinite
  (sub RNE1 res1 threshold))))))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (lt fliteral2 value) (= result2 res1))))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (lt fliteral2 value) (= res3 o))))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (not (lt fliteral2 value))
  (=> (lt value fliteral2)
  (and (= o1 (add RNE1 res1 threshold)) (tqtisFinite
  (add RNE1 res1 threshold)))))))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (not (lt fliteral2 value)) (=> (lt value fliteral2) (= result3 res1)))))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (not (lt fliteral2 value)) (=> (lt value fliteral2) (= res4 o1)))))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (not (lt fliteral2 value))
  (=> (not (lt value fliteral2)) (= res4 res1)))))

;; H
  (assert
  (=> (not (and (le (neg threshold) value) (le value threshold)))
  (=> (not (lt fliteral2 value)) (= res3 res4))))
...
;; H
  (assert
  (=> (and (le (neg threshold) value) (le value threshold)) (eq
  safety_pack__dead_band__result4 fliteral2)))

;; H
  (assert
  (=> (= (bool_gt value threshold) true) (eq safety_pack__dead_band__result4
  (sub RNE1 value threshold))))

;; H
  (assert (= (bool_lt value (neg threshold)) true))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (add RNE1 value threshold))))
(check-sat)
