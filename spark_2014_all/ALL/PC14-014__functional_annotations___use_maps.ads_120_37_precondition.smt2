...
;; element__2__post__dispatch_axiom
  ...
  (forall ((container us_rep))
  (! (=> (dynamic_invariant4 key true true true) (dynamic_invariant5
...
;; find__post_axiom
  ...
  (forall ((container us_rep2))
  (forall ((key Int))
  (! (=> (dynamic_invariant4 key true true true)
     (let ((result (find container key)))
     (and
     (=> (< 0 result)
     (and (<= result (length3 container)) (= key (get container result))))
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq3 left right) true)
     (and
     (forall ((key Int))
     (=> (and (in_range2 key) (= (has_key left key) true))
     (and (= (has_key right key) true) (= (get1 right key) (get1 left key)))))
     (forall ((key Int))
     (=> (and (in_range2 key) (= (has_key right key) true))
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty container) true)
     (forall ((key Int))
     (not (and (in_range2 key) (= (has_key container key) true))))) :pattern (
  (is_empty container)) )))
...
;; H
  ...
  (and (in_range1 o)
  (<= o (to_rep1
        (rec__use_maps__my_maps__map__capacity (us_split_discrs1 s)))))))
...
;; H
  ...
  (and
  (and
  (and (= (length3 o2) (length s))
  (forall ((temp___431 Int))
  (=> (and (in_range4 temp___431) (= (iter_has_element o2 temp___431) true))
  (= (has_key (model__ s) (get o2 temp___431)) true))))
  (forall ((key Int))
  (=> (and (in_range2 key) (= (has_key (model__ s) key) true))
  (and (< 0 (find o2 key)) (= (get o2 (find o2 key)) key)))))
  (forall ((i1 Int))
...
(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 106, characters 0-0
  (not (<= 1 i)))
(check-sat)
(exit)
