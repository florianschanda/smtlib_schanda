...
(define-fun us_split_fields_Reserved__32__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__evc_txfs_type__reserved a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___97__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___97__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun register_type__ref___222__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___159__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___159__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7172 us_t1)
  (temp___is_init_7169 Bool) (temp___skip_constant_7170 Bool)
  (temp___do_toplevel_7171 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7170 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_7172)
                                       (last3 temp___expr_7172))
                                       (and (= (first3 temp___expr_7172) 1)
                                       (= (last3 temp___expr_7172) 2)))))
