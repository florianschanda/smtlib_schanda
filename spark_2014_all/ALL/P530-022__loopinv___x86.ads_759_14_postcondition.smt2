...
;; H
  (assert
  (= x86__readmem64ghost__result1 (bvor (bvor (bvor (bvor (bvor (bvor (bvor ((_ zero_extend 56)
  (to_rep (select mem addr))) (bvshl ((_ zero_extend 56) (to_rep
                                                         (select mem (bvadd
                                                         addr ((_ int2bv 64) 1))))) ((_ int2bv 64) 8))) (bvshl ((_ zero_extend 56)
...
;; H
  (assert
  (= (mk_t__ref1 x86__readmem64ghost__result4) (mk_t__ref1
                                               x86__readmem64ghost__result2)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  (not
  (= x86__readmem64ghost__result4 (bvor (bvor (bvor (bvor (bvor (bvor (bvor ((_ zero_extend 56)
  (to_rep (select mem addr))) (bvshl ((_ zero_extend 56) (to_rep
                                                         (select mem (bvadd
                                                         addr ((_ int2bv 64) 1))))) ((_ int2bv 64) 8))) (bvshl ((_ zero_extend 56)
  (to_rep (select mem (bvadd addr ((_ int2bv 64) 2))))) ((_ int2bv 64) 16))) (bvshl ((_ zero_extend 56)
