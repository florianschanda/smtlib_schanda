...
;; H
  (assert
  (and (= (top (mk___rep s__split_fields2)) o1)
  (= (let ((temp___181 (to__
                       (mk___rep
                       (mk___split_fields s__split_fields s__split_fields1)))))
     (let ((temp___180 (to_but_top (mk___rep s__split_fields2))))
...
;; H
  (assert
  (and
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields3))))) (+ (- i2
  first2) 1))
  (forall ((j Int))
  (=> (and (<= first2 j) (<= j i2))
  (= (to_rep (select (elts (to__ (mk___rep s__split_fields3))) j)) (get
                                                                   (model__
                                                                   l) j))))))

;; H
  (assert
  (and (=> (<= first2 last3) (dynamic_property1 first2 last3 i2))
  (and (<= first2 i2) (<= i2 last3))))

;; H
  (assert (and (= o2 (- i2 first2)) (in_range1 (- i2 first2))))
