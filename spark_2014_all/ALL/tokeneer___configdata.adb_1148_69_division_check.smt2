...
(declare-fun c49b () (Array Int character))
...
(declare-fun localtext16 () (Array Int character))

(declare-fun result23 () map__ref)

(declare-fun localtext17 () (Array Int character))

(declare-fun result24 () map__ref)

(declare-fun c49b1 () (Array Int character))
...
;; H
  (assert
  (and (= o57 (+ 48 (div1 localvalue8 10))) (in_range3
  (+ 48 (div1 localvalue8 10)))))
