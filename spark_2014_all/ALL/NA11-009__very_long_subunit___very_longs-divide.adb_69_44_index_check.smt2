...
(declare-fun temp___1202 () digit_index_type)

(declare-fun temp___12021 () (Array Int octet))

(declare-fun temp___12022 () t)

(declare-fun temp___1201 () (_ BitVec 8))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (and (= result____split_discrs (mk___split_discrs temp___1202))
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___12021 temp___12022))))))
...
;; H
  ...
  (and
  (= (rec__very_longs__very_long__length result____split_discrs) temp___1202)
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1204) (select temp___12021 temp___1204)))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= temp___1196 (mk___rep result____split_discrs o18))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_fields4 (us_split_fields1 temp___1196))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_discrs (us_split_discrs1 temp___1196))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= temp___1200 (mk___rep result____split_discrs o27))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rt
         (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
  (= result____split_fields5 (us_split_fields1 temp___1200))))
