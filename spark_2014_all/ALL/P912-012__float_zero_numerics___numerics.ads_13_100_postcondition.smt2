...
(declare-const numerics__Osubtract__result Float32)

(declare-const o Float32)

(declare-const result Float32)

(declare-const numerics__Osubtract__result1 Float32)

(declare-const numerics__Osubtract__result2 Float32)

(declare-const numerics__Osubtract__result3 Float32)

(declare-const numerics__Osubtract__result4 Float32)
...
;; H
  (assert (= numerics__Osubtract__result3 numerics__Osubtract__result1))
...
;; H
  (assert (= (mk_t__ref result) (mk_t__ref numerics__Osubtract__result)))
...
;; H
  (assert
  (= (mk_t__ref numerics__Osubtract__result4) (mk_t__ref
                                              numerics__Osubtract__result2)))

;; H
  (assert (= numerics__Osubtract__result5 numerics__Osubtract__result3))

;; H
  (assert (= result1 numerics__Osubtract__result4))

(assert
;; WP_parameter_def
 ;; File "numerics.ads", line 7, characters 0-0
  (not (fp.eq numerics__Osubtract__result4 (fp.sub RNE left right))))
(check-sat)
(exit)
