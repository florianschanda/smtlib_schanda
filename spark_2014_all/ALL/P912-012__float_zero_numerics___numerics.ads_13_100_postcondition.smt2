...
(declare-fun numerics__Osubtract__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun numerics__Osubtract__result1 () t)

(declare-fun numerics__Osubtract__result2 () t)

(declare-fun numerics__Osubtract__result3 () t)

(declare-fun numerics__Osubtract__result4 () t)

(declare-fun numerics__Osubtract__result5 () t)
...
;; H
  (assert
  (and (= o (sub RNE1 left right)) (tqtisFinite (sub RNE1 left right))))
...
;; WP_parameter_def
 ;; File "numerics.ads", line 7, characters 0-0
  (not (eq numerics__Osubtract__result4 (sub RNE1 left right))))
(check-sat)
