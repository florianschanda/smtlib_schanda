...
;; H
  ...
  (and
  (and
  (and (<= 0 (to_rep1 (select s__split_fields5 topstacki2)))
  (< (to_rep1 (select s__split_fields5 topstacki2)) (to_rep1
                                                    s__split_fields2)))
  (<= 0 (to_rep1 (select s__split_fields6 topstacki2))))
  (< (to_rep1 (select s__split_fields6 topstacki2)) (to_rep1
                                                    (select s__split_fields3
                                                    (to_rep1
  ...
  (= (to_rep1
     (select (select s__split_fields4 (to_rep1
                                      (select s__split_fields5 topstacki2)))
     (to_rep1 (select s__split_fields6 topstacki2)))) topstacki2))
  (= (to_rep1 (select s__split_fields5 topstacki2)) i2))
