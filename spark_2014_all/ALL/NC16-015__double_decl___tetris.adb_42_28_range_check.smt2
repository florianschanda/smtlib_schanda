...
(declare-datatypes ((action_type__ref 0))
(((mk_action_type__ref (action_type__content action_type)))))
...
(declare-datatypes ((piece_type__ref 0))
(((mk_piece_type__ref (piece_type__content piece_type)))))
