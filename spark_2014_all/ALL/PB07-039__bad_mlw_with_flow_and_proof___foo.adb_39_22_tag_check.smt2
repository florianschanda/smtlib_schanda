...
(declare-datatypes ((t3__ref 0)) (((mk_t3__ref (t3__content us_rep)))))
...
(define-fun temp___2062 () us_rep (mk___rep (mk___split_fields temp___206)
                                  temp___2061))

;; H
  (assert
  (and (= temp___2062 (prim_func (mk___split_fields t1_var__split_fields)))
...
;; H
  (assert
  (and
  (= (mk___rep (mk___split_fields temp___205) temp___2051) (prim_func
                                                           (mk___split_fields
                                                           t1_var__split_fields)))
  (and (= t1_var__split_fields temp___205) (= t1_var__attr__tag temp___2051))))

(assert
;; WP_parameter_def
 ;; File "foo.adb", line 34, characters 0-0
  (not (us_compatible_tags temp___2051 us_tag1)))
(check-sat)
(exit)
