...
(declare-fun linked_list__search__result () count_type)
...
(declare-fun temp___453 () count_type)

(declare-fun o2 () Int)

(declare-fun linked_list__search__result1 () count_type)
...
(declare-fun linked_list__search__result2 () count_type)

(declare-fun result1 () Bool)

(declare-fun result2 () count_type)

(declare-fun linked_list__search__result3 () us_rep1)

(declare-fun cu__split_fields3 () us_split_fields2)

(declare-fun cu__split_fields4 () us_split_fields__ref1)

(declare-fun linked_list__search__result4 () cursor__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun linked_list__search__result5 () us_rep1)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun linked_list__search__result6 () cursor__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun linked_list__search__result7 () us_rep1)

(declare-fun result3 () cursor__ref)

(declare-fun linked_list__search__result8 () us_rep1)

(declare-fun linked_list__search__result9 () cursor__ref)

(declare-fun linked_list__search__result10 () us_rep1)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun linked_list__search__result11 () cursor__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun linked_list__search__result12 () us_rep1)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun linked_list__search__result13 () cursor__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun linked_list__search__result14 () us_rep1)
...
;; H
  ...
  (= (bool_eq2 linked_list__search__cu__assume1 no_element) true)
...
;; H
  ...
  (and
  (and
  (= linked_list__search__result11 (mk_cursor__ref
                                   linked_list__search__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields12)))
  (and (= linked_list__search__result12 linked_list__search__result3)
  (= cu__split_fields9 cu__split_fields12)))
  (and (not (= (bool_eq2 (mk___rep1 cu__split_fields13) no_element) true))
  (and (= temp___453 cu__split_fields1)
  (and
  (and (= (has_key (positions l) (mk___rep1 cu__split_fields12)) true)
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions l) (mk___rep1 cu__split_fields12)) 1)))
  (not (= (get (model__ l) i) 0)))))
  (and (not (= (bool_eq2 (mk___rep1 cu__split_fields12) no_element) true))
  (and
  (and
  (and (= o2 (element l (mk___rep1 cu__split_fields12)))
  (and (in_range5 o2)
  (= o2 (get (model__ l) (get1 (positions l) (mk___rep1 cu__split_fields12))))))
  (= result1 (ite (= o2 0) true false)))
  (and (= result1 true)
  (and (= result2 linked_list__search__result2)
  (= linked_list__search__result3 (mk___rep1 cu__split_fields12))))))))))
  (and
  (ite (not (= (bool_eq2 (mk___rep1 cu__split_fields13) no_element) true))
  (and
  (and
  (and (= temp___453 cu__split_fields1)
  (and
  ...
  (= linked_list__search__result3 (mk___rep1
                                  (mk___split_fields1
                                  linked_list__search__result2)))))
  (and
  (ite (= (ite (= (bool_eq2 (mk___rep1 cu__split_fields12) no_element) false) (= 
          (get1 (positions l) (mk___rep1 cu__split_fields12)) (length2 l)) true) true)
  (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true)
  (and (= (has_key (positions l) (mk___rep1 cu__split_fields3)) true)
  (= (get1 (positions l) (mk___rep1 cu__split_fields3)) (+ (get1
                                                           (positions l)
                                                           (mk___rep1
                                                           cu__split_fields12)) 1))))
  (= (bool_eq2 (mk___rep1 cu__split_fields3) no_element) true))))))
  (and
  (and
  (= linked_list__search__result4 (mk_cursor__ref
                                  linked_list__search__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields3)))
  (and (= linked_list__search__result5 linked_list__search__result3)
  (= cu__split_fields5 cu__split_fields3))))
  (and
  (and (= linked_list__search__result6 linked_list__search__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and (= linked_list__search__result7 linked_list__search__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= linked_list__search__result6 (mk_cursor__ref
                                  (mk___rep1
                                  (mk___split_fields1
                                  linked_list__search__result))))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields13)))
  (and
  (= linked_list__search__result7 (mk___rep1
                                  (mk___split_fields1
                                  linked_list__search__result1)))
  (= cu__split_fields7 cu__split_fields13))))
  (and
  (and
  (and (= linked_list__search__result11 linked_list__search__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and (= linked_list__search__result12 linked_list__search__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= linked_list__search__result9 (mk_cursor__ref
                                  linked_list__search__result8))
  (= linked_list__search__result10 linked_list__search__result8))
  (and (= result3 linked_list__search__result6)
  (= linked_list__search__result8 no_element)))))))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 result4)) (cursor__content
                                              linked_list__search__result13)))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  ...
  (or
  (and
  (= (bool_eq2 (cursor__content linked_list__search__result13) no_element) true)
  (not (= (contains l 0) true)))
  (and
  (and
  (= (has_key (positions l) (cursor__content linked_list__search__result13)) true)
  (= (element l (cursor__content linked_list__search__result13)) 0))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions l)
           (cursor__content linked_list__search__result13)) 1)))
  (not (= (get (model__ l) i) 0))))))))
(check-sat)
