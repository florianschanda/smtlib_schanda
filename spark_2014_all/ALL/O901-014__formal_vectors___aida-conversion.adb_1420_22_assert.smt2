...
(define-fun tint_arrayD1__ref___10__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___10__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t411b__ref 0))
(((mk_t411b__ref (t411b__content integer)))))
...
(declare-datatypes ((t412b__ref 0))
(((mk_t412b__ref (t412b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___19__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___19__projection ((a number_array_type__ref)) us_t3
...
(((mk_t415b__ref (t415b__content integer)))))
...
(declare-datatypes ((t416b__ref 0))
(((mk_t416b__ref (t416b__content us_t4)))))
...
(declare-datatypes ((t417b__ref 0))
(((mk_t417b__ref (t417b__content integer)))))
...
(define-fun tint_arrayB__ref___10__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___19__projection ((a tnumber_array_typeB__ref)) us_t6
