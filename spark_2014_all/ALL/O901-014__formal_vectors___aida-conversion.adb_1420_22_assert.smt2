...
(declare-fun temp___1846 () Int)

(declare-fun temp___1844 () (Array Int integer))
...
;; H
  ...
  (forall ((index7 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 9) index7)
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848))
  (= temp___1846 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= n2 o8)))
...
;; H
  ...
  (=> (< index2 temp___1845)
  (= (select n3 temp___1845) (select temp___1844 temp___1845)))))
  (=>
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___1847 index1) (<= index1 temp___1848)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___1847 index1) (<= index1 temp___1848)))
...
;; H
  (assert
  (=> (not (and (<= temp___1847 index1) (<= index1 temp___1848))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___1849 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1849)
  (<= temp___1849 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1850 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1850)
  (<= temp___1850 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= o21 (- target2 2147483600)) (in_range1 (- target2 2147483600))))
