...
;; lemma6__def_axiom
  ...
  (! (= (= (lemma61 us_void_param) true)
     ...
     (=> (not (= val__ ((_ int2bv 8) 0)))
     (and (= (shift_right val__ 0) val__)
     (exists ((n Int))
     (and (and (<= 0 n) (<= n 7))
     (and
     (and (= (shift_right val__ n) ((_ int2bv 8) 1))
     (forall ((j Int))
     (=> (and (<= 0 j) (<= j n))
...
(declare-fun bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result1 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result2 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result3 () Int)

(declare-fun result__13 () Int)

(declare-fun i12 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result4 () int__ref)

(declare-fun result__14 () Int)

(declare-fun i13 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result5 () Int)
...
;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 7)) (= (mk_int__ref result1) result__18)))
...
;; H
  ...
  (= o (ite (and (<= 1 8) (<= 8 8))
       ...
       i1))))))))
  (= result2 (ite (= o ((_ int2bv 8) 1)) true false))) (= result2 true)))
  (and
  (and
  (and
  (and (= o (shift_right value i1))
  (= o (ite (and (<= 1 8) (<= 8 8))
       ...
       ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64)
       i1))))))))
  (= result2 (ite (= o ((_ int2bv 8) 1)) true false)))
  (not (= result2 true)))
  (and
  ...
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i2))
  (bvugt (shift_right value j) ((_ int2bv 8) 1))))
  (and
  (and (and (=> (<= 0 7) (in_range1 i2)) (=> (<= 0 7) (in_range1 result__3)))
  (and (<= 0 i2) (<= i2 7)))
  (or
  (and
  (and (and (= i2 i4) (= result__3 result__5))
  (and (= i5 i2) (= result__6 result__3))) (= i2 7))
  (and (not (= i2 7))
  (and
  ...
  (= o1 (ite (and (<= 1 8) (<= 8 8))
        ...
        ((_ extract 7 0) (bvlshr ((_ zero_extend 56) value) ((_ int2bv 64)
        i3))))))))
  (= result5 (ite (= o1 ((_ int2bv 8) 1)) true false))) (= result5 true))))))))))))))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result1
  bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result3
  bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result1))

;; H
  (assert
  (= result6 bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result5
  bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result3))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  ...
  (= (shift_right value
     (int__content
     bits_manipulation_unsigned__unsigned_8__functions__msb_index_slow_inline_always__result4)) ((_ int2bv 8) 1))))
(check-sat)
(exit)
