...
(define-fun source__ref___6__projection ((a source__ref)) source (source__content
                                                                 a))
...
(define-fun target__ref___6__projection ((a target__ref)) target (target__content
                                                                 a))
...
;; u32toint32__post_axiom
  ...
  (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2
     (u32toint32 s) true false true)) :pattern ((u32toint32 s)) )))
