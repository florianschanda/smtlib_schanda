...
(define-fun dynamic_invariant1 ((temp___expr_665 us_t)
...
(((mk___split_fields (rec__decadriver__transmitter_type__tx_idle Bool)))))
(define-fun us_split_fields_Tx_Idle__projection ((a us_split_fields)) Bool
  (rec__decadriver__transmitter_type__tx_idle a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___139__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___140__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                  a))
...
(((mk_transmitter_type__ref (transmitter_type__content us_rep)))))
...
(define-fun dynamic_invariant3 ((temp___expr_323 (_ BitVec 8))
...
(assert
;; WP_parameter_def
 ;; File "decadriver.ads", line 163, characters 0-0
  (not (in_range1 o1)))
(check-sat)
(exit)
