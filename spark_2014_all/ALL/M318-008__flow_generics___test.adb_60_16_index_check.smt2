...
(declare-datatypes () ((table__ref (mk_table__ref (table__content us_t)))))
(define-fun table__ref___projection ((a table__ref)) us_t (table__content a))

(define-fun dynamic_invariant1 ((temp___expr_151 us_t)
...
(declare-datatypes ()
((vector_t__ref (mk_vector_t__ref (vector_t__content us_t1)))))
(define-fun vector_t__ref___projection ((a vector_t__ref)) us_t1 (vector_t__content
                                                                 a))
...
;; H
  (assert (dynamic_property 1 2147483647 (to_rep c__first) (to_rep c__last)))

;; H
  (assert
  (and
  (and (= (to_rep (first (rt a))) (to_rep c__first))
  (= (to_rep (last (rt a))) (to_rep c__last))) (= (length a) (length b))))

;; H
  (assert (dynamic_property1 1 2147483647 (to_rep (first (rt b)))
  (to_rep (last (rt b)))))
...
;; H
  (assert (= (mk1 (to_rep (first (rt b))) (to_rep (last (rt b)))) o3))

;; H
  (assert (dynamic_property1 1 2147483647 (to_rep (first (rt a)))
  (to_rep (last (rt a)))))
...
;; H
  (assert (and (<= (to_rep c__first) i2) (<= i2 (to_rep c__last))))

;; H
  (assert (= o4 i2))

;; H
  (assert (= o5 (select c o4)))
...
;; H
  (assert
  (and (= o7 (- (to_rep c__last) i2)) (in_range1 (- (to_rep c__last) i2))))
