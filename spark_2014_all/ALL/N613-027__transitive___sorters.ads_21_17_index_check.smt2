...
(declare-fun values4 () map__ref)

(declare-fun values_last4 () map__ref)
...
(declare-fun values_last5 () (Array Int integer))
...
(declare-fun values_last6 () map__ref)
...
(declare-fun values_last7 () (Array Int integer))
...
(declare-fun values_last8 () map__ref)
...
(declare-fun values_last9 () (Array Int integer))
...
;; H
  ...
  (and (= (to_rep (select values2 smallest2)) (to_rep (select values o7)))
  (forall ((j1 Int))
  (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last)))
  (=> (and (not (= j1 o7)) (not (= j1 smallest2)))
...
;; H
  ...
  (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202))
  (and
  (and (=> (<= 1 2147483647) (in_range2 smallest3))
...
;; H
  (assert
  (and (= o8 (- (to_rep values__last) 1)) (in_range1
  (- (to_rep values__last) 1))))
...
;; H
  (assert (and (= temp___204 (+ j 1)) (in_range1 (+ j 1))))

;; H
  (assert
  (and (<= (to_rep values__first) temp___204)
  (<= temp___204 (to_rep values__last))))

;; H
  (assert (= o10 temp___204))

;; H
  (assert (= o11 (select (map__content values8) o10)))
