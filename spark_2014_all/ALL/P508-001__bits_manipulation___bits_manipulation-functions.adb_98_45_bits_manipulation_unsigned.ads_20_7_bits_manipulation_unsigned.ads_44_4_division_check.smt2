...
;; H
  (assert
  (=> (not (= new_v1 ((_ int2bv 32) 0))) (in_range1
  (+ result__2 shift_amount2))))

;; H
  (assert
  (=> (not (= new_v1 ((_ int2bv 32) 0)))
  (and (= o1 (+ result__2 shift_amount2)) (in_range1
  (+ result__2 shift_amount2)))))

;; H
  (assert (=> (not (= new_v1 ((_ int2bv 32) 0))) (= result__2 result4)))

;; H
  (assert (=> (not (= new_v1 ((_ int2bv 32) 0))) (= result__3 o1)))

;; H
  (assert (=> (not (= new_v1 ((_ int2bv 32) 0))) (= v2 result5)))

;; H
  (assert (=> (not (= new_v1 ((_ int2bv 32) 0))) (= v3 new_v1)))

;; H
  (assert (=> (not (not (= new_v1 ((_ int2bv 32) 0)))) (= v3 v2)))

;; H
  (assert
  (=> (not (not (= new_v1 ((_ int2bv 32) 0)))) (= result__3 result__2)))
