...
(define-fun dynamic_invariant ((temp___expr_345 Int)
  (temp___is_init_342 Bool) (temp___skip_constant_343 Bool)
  (temp___do_toplevel_344 Bool)) Bool (=>
                                      (or (= temp___is_init_342 true)
...
(define-fun dynamic_invariant3 ((temp___expr_351 Int)
