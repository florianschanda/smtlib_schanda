...
(declare-fun temp___1978 () (Array Int us_rep1))
...
(declare-fun temp___1979 () (Array Int us_rep1))
...
(declare-fun temp___1977 () (Array Int us_rep1))
...
(declare-fun temp___1976 () (Array Int us_rep1))
...
(declare-fun temp___1975 () (Array Int us_rep1))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (mk___rep2
             (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
             (to_rep1 t_old__split_fields)) i2))) true)
  (=>
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
             (mk___split_fields2 t_old__split_fields1 t_old__split_fields2))
             (to_rep1 t_old__split_fields)) i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (mk___rep2
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     (mk___rep2
                     (mk___split_fields2 t_old__split_fields1
                     t_old__split_fields2)) (to_rep1 t_old__split_fields)) i2)))) 1)) 0)
  (< v (to_rep (select t_old__split_fields3 i2)))
  (< (to_rep (select t_old__split_fields3 i2)) v))))))
  (and
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) i2))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
  ...
  (= (olt
     ...
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
             (to_rep1
             (rec__search_trees__search_tree__root (us_split_fields7 t)))) i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct (us_split_fields7 t))
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     (to_rep1
                     (rec__search_trees__search_tree__root
                     (us_split_fields7 t)))) i2)))) 1)) 0)
  (< (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1)) 
  (to_rep
  (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i2)))
  (< (to_rep
     (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i2)) 
  (to_rep
  (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1))))))))))
...
;; H
  ...
  (= temp___1976 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o13))
  (and (dynamic_invariant8 temp___1976 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1976 o13))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1976 o13)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o13))
  (ite (and
       (not
       (= (parent
          (rec__search_trees__search_tree__struct (us_split_fields7 t)) i2) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1976 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1976 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1976 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1976 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1976 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1976 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1976 j1)))) true))
  (= j1 i2))))))))))))))
...
;; H
  (assert (= o15 (select temp___1976 o14)))
...
;; H
  ...
  (= temp___1977 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o10))
  (and (dynamic_invariant8 temp___1977 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1977 o10))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1977 o10)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o10))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1977 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1977 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1977 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1977 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1977 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1977 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1977 j1)))) true))
  (= j1 i2)))))))))))))))

;; H
  (assert (=> (= result3 true) (= o11 (select temp___1977 j))))
...
;; H
  (assert
  (=> (= result3 true) (= result2 (rec__tree_model__path_type__k o12))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o6 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))))))
...
;; H
  ...
  (= temp___1979 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o6))
  (and (dynamic_invariant8 temp___1979 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1979 o6))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1979 o6)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o6))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1979 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1979 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1979 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1979 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1979 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1979 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1979 j1)))) true))
  (= j1 i2)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o7 (select temp___1979 j))))
...
;; H
  ...
  (and (dynamic_invariant8 temp___1978 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1978 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1978 o1)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1978 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1978 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1978 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1978 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1978 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1978 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1978 j1)))) true))
  (= j1 i2)))))))))))))))
...
;; H
  (assert (=> (= result2 true) (= o3 (select temp___1978 o2))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= result1 (olt o5 o9))
  (= (= result1 true)
  (and (< (length o5) (length o9))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o5))) (= (get o5 n) (get o9 n)))))))))
...
;; H
  ...
  (= temp___1975 (model__
                 (rec__search_trees__search_tree__struct
                 (us_split_fields7 t)) o17))
  (and (dynamic_invariant8 temp___1975 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1975 o17))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1975 o17)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o17))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1975 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1975 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1975 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1975 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1975 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1975 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1975 j1)))) true))
  (= j1 i2))))))))))))))
...
;; H
  (assert (= o19 (select temp___1975 o18)))
...
;; H
  (assert
  (and (= o22 (length o21)) (and (in_range6 o22) (<= (+ 0 o22) 2147483647))))
