...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__sorted_vectors__my_vectors__vector us_main_type)))))
...
(declare-fun sorted_vectors__my_vectors__vector__capacity__first__bit () Int)

(declare-fun sorted_vectors__my_vectors__vector__capacity__last__bit () Int)

(declare-fun sorted_vectors__my_vectors__vector__capacity__position () Int)
...
(define-fun default_initial_assumption ((temp___expr_247 us_rep1)
...
(declare-fun container__split_fields2 () us_main_type)

(declare-fun position8 () Int)

(declare-fun container__split_fields3 () us_main_type)
...
(define-fun container__split_fields4 () us_split_fields (mk___split_fields
...
;; H
  ...
  (= o1 (get
        (model__
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields))) position1))
  (and (in_range8 o1)
  (= o1 (get
        (model__
        (mk___rep container__split_discrs
...
;; H
  ...
  (< (get
     (model__
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) (- position2 1)) new_item))))

;; H
  (assert
  (=> (= result1 true)
  (and (=> (<= 1 100) (in_range3 position2))
  (and
  (<= position2 (length
                (mk___rep container__split_discrs
                (mk___split_fields container__split_fields))))
  (< (get
     (model__
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) position2) new_item)))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o3 (+ position2 1)) (in_range3 (+ position2 1)))))
...
;; H
  (assert
  (=> (= result1 true) (= result5 (ite (<= position3 o5) true false))))
...
;; H
  ...
  (= o4 (get
        (model__
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields))) position3))
  (and (in_range8 o4)
  (= o4 (get
        (model__
        (mk___rep container__split_discrs
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= result5 true) (= o6 (ite (< o4 new_item) true false)))))
...
;; H
  (assert
  (=> (= result1 true) (= result4 (ite (not (= o6 true)) true false))))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep container__split_discrs container__split_fields4)) (+
  (length
  (mk___rep container__split_discrs
  ...
  (= (range_equal
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (model__ (mk___rep container__split_discrs container__split_fields4)) 1
     (- position6 1)) true))
  (= (get
     (model__ (mk___rep container__split_discrs container__split_fields4))
     position6) new_item))
  (= (range_shifted
     (model__
     (mk___rep container__split_discrs
...
;; H
  (assert
  (= (mk___split_fields container__split_fields3) container__split_fields4))
...
;; H
  ...
  (= o17 (length
         (mk___rep container__split_discrs
         (mk___split_fields container__split_fields2))))
  (and (in_range5 o17)
  (<= o17 (capacity
          (mk___rep container__split_discrs
          (mk___split_fields container__split_fields2)))))))
...
;; H
  (assert (= o18 (ite (<= position8 o17) true false)))

;; H
  (assert (and (= o16 1) (and (in_range4 o16) (= o16 1))))

;; H
  (assert (= o19 (ite (<= o16 position8) true false)))

;; H
  (assert (= result6 (ite (= o19 true) o18 false)))
...
;; H
  ...
  (= o14 (get
         (model__
         (mk___rep container__split_discrs
         (mk___split_fields container__split_fields2))) position8))
  (and (in_range8 o14)
  (= o14 (get
         (model__
         (mk___rep container__split_discrs
...
;; H
  (assert (= result8 (ite (= o14 new_item) true false)))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) i2) (get
                                                       (model__
                                                       (mk___rep
                                                       container__split_discrs
                                                       (mk___split_fields
...
;; H
  ...
  (= (m_elements_sorted
     (model__
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields2)))) true)))))
...
;; H
  (assert (= o11 (ite (<= i1 o10) true false)))

;; H
  (assert (= result10 (ite (<= (+ position8 1) i1) o11 false)))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields2))) i2) (get
                                                        (model__
                                                        (mk___rep
                                                        container__split_discrs
                                                        (mk___split_fields
...
;; H
  ...
  (= o9 (get
        (model__
        (mk___rep container__split_discrs
        (mk___split_fields container__split_fields))) o8))
  (in_range7 o9)))
