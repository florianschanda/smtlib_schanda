...
(declare-fun temp___6612 () et1)

(declare-fun temp___66121 () et2)
...
(declare-fun temp___6614 () et1)

(declare-fun temp___66141 () et2)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 724, characters 0-0
  (not (= (to_rep r__split_fields6) (to_rep1 r__split_fields1))))
(check-sat)
(exit)
