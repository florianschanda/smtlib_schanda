...
;; H
  (assert (= result4 (ite (<= o7 (to_rep (last (rt a)))) true false)))

;; H
  (assert (=> (= result4 true) (and (= o6 (+ y l1)) (in_range1 (+ y l1)))))
...
;; H
  (assert
  (=> (= result3 true) (and (= temp___159 (+ y l1)) (in_range1 (+ y l1)))))
...
;; H
  (assert (=> (= result3 true) (= o2 temp___159)))

;; H
  (assert (=> (= result3 true) (= o3 (select (elts a) o2))))

;; H
  (assert (=> (= result3 true) (= o4 (to_rep o3))))

;; H
  (assert
  (=> (= result3 true) (and (= temp___158 (+ x l1)) (in_range1 (+ x l1)))))

;; H
  (assert
  (=> (= result3 true)
  (and (<= (to_rep (first (rt a))) temp___158)
  (<= temp___158 (to_rep (last (rt a)))))))

;; H
  (assert (=> (= result3 true) (= o temp___158)))

;; H
  (assert (=> (= result3 true) (= o1 (select (elts a) o))))

;; H
  (assert (=> (= result3 true) (= o5 (to_rep o1))))

;; H
  (assert (=> (= result3 true) (= o8 (ite (= o5 o4) true false))))

;; H
  (assert (=> (not (= result3 true)) (= o8 false)))

;; H
  (assert (= result2 (ite (not (= o8 true)) true false)))
