...
;; H
  ...
  o1))))
  (= (occ (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) e) (occ o14 e)))
  (= b2 b1))
  (and
  (and
  (and
  ...
  (= (mk
     ...
     (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))))
  o6))))
  (= (occ o13 e) (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e)))
  (and
  ...
  (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (occ o12 e))
  (ite (= v e)
