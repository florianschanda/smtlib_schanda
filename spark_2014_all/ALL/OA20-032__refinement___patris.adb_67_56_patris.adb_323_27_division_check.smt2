...
(declare-const o17 py_coord)

(declare-const o18 px_coord)

(declare-const o19 direction)
...
;; H
  (assert (= (to_rep3 o17) 1))

;; H
  (assert (= (to_rep2 o18) 5))

;; H
  (assert (and (= o15 (rand Tuple0)) (in_range2 o15)))

;; H
  (assert (= o16 (mod2 o15 4)))

;; H
  (assert (= (to_rep4 o19) o16))
