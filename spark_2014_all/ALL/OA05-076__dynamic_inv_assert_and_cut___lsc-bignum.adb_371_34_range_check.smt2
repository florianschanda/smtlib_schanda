...
;; H
  (assert (= o67 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (= o65 (num_of_big_int m m_first o64)))

;; H
  (assert (= o60 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o66 (omultiply o60 o65)))

;; H
  (assert (= o68 (osubtract o66 o67)))

;; H
  (assert (= o57 (from_word32 a_msw3)))
...
;; H
  (assert
  (= o50 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o49)))

;; H
  (assert (= o59 (oadd o50 o58)))

;; H
  (assert (= o69 (olt o59 o68)))
