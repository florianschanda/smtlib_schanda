...
(define-fun dynamic_invariant ((temp___expr_554 Int)
  (temp___is_init_551 Bool) (temp___skip_constant_552 Bool)
  (temp___do_toplevel_553 Bool)) Bool (=>
...
(define-fun dynamic_invariant1 ((temp___expr_566 Int)
...
(define-fun default_initial_assumption ((temp___expr_573 us_rep)
...
(define-fun dynamic_invariant3 ((temp___expr_560 Int)
