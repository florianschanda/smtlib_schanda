...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r27b)) (= o10 (mk___split_fields1 o9))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r27b)) (= result4 (mk_int__ref temp2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r27b)) (= temp3 (div1 temp2 256))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r27b)) (= index3 (mk_int__ref index2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r27b)) (= temp4 (mk_int__ref temp3))))
