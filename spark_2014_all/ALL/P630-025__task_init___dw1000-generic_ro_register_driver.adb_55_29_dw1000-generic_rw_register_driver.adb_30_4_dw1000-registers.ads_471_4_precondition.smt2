...
(define-fun register_type__ref___147__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___104__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___104__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5588 us_t1)
  (temp___is_init_5585 Bool) (temp___skip_constant_5586 Bool)
  (temp___do_toplevel_5587 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5586 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5588)
                                       (last3 temp___expr_5588))
                                       (and (= (first3 temp___expr_5588) 1)
                                       (= (last3 temp___expr_5588) 1)))))
