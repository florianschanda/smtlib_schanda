...
(declare-fun dw1000__register_types__tc_pgtest_type__tc_pgtest__first__bit () Int)

(declare-fun dw1000__register_types__tc_pgtest_type__tc_pgtest__last__bit () Int)

(declare-fun dw1000__register_types__tc_pgtest_type__tc_pgtest__position () Int)
...
(define-fun register_type__ref_147__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_104__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_104__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5496 us_t1)
  (temp___is_init_5493 Bool) (temp___skip_constant_5494 Bool)
  (temp___do_toplevel_5495 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5494 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5496)
                                       (last3 temp___expr_5496))
                                       (and (= (first3 temp___expr_5496) 1)
                                       (= (last3 temp___expr_5496) 1)))))
