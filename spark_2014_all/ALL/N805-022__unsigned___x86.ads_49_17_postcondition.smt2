...
(((mk_map__ref (map__content (Array Int unsigned_8))))))
...
;; H
  ...
  (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))))

;; H
  (assert
  (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 2))) (bvmul ((_ zero_extend 24)
  (to_rep (select xsi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))))

;; H
  (assert
  (= (bvadd (bvurem val__ ((_ int2bv 32) 65536)) (bvmul (bvurem (bvudiv
  val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))
  val__))
...
;; H
  ...
  (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24)
  (to_rep (select xsi4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24)
  (to_rep (select xsi4 3))) ((_ int2bv 32) 16777216))) val__)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 5, characters 0-0
  (not
  (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi5 0))) (bvmul ((_ zero_extend 24)
  (to_rep (select xsi5 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24)
  (to_rep (select xsi5 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24)
  (to_rep (select xsi5 3))) ((_ int2bv 32) 16777216))) val__)))
(check-sat)
(exit)
