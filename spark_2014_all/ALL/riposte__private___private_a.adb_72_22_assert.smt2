...
(declare-fun stack__push__the_stack__fields () us_split_fields)
...
;; H
  (assert
  (and
  (= (get_length (mk___rep stack__push__the_stack__fields)) (+ (get_length
                                                               (mk___rep
                                                               (mk___split_fields
                                                               s__split_fields4
                                                               s__split_fields5))) 1))
  (= (top (mk___rep stack__push__the_stack__fields)) n)))

;; H
  (assert
  (= result3 (mk___split_fields__ref1
             (mk___split_fields1 s__split_fields3
...
;; WP_parameter_def
 ;; File "private_a.adb", line 49, characters 0-0
  (not
  (= (get_length
     (rec__private_a__optional_stack__the_stack s__split_fields6)) 2)))
(check-sat)
(exit)
