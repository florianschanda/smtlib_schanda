...
(declare-const temp___9392 (Array Int us_rep))

(declare-const temp___93921 Bool)

(declare-const temp___93922 enum1t)
...
(declare-const temp___9399 (Array Int us_rep))

(declare-const temp___93991 Bool)

(declare-const temp___93992 enum1t)
