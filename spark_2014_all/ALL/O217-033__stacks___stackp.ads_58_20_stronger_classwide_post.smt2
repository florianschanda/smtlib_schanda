...
(declare-datatypes ((t67s__ref 0)) (((mk_t67s__ref (t67s__content t67s)))))
...
(declare-datatypes ((t23s__ref 0)) (((mk_t23s__ref (t23s__content t23s)))))
...
;; def_axiom
  ...
  (= (select (temp___222 temp___224) 1) (of_rep temp___224))))

(declare-fun temp___567 (Int) (Array Int element))

;; def_axiom
  (assert
  (forall ((temp___569 Int))
  (= (select (temp___567 temp___569) 1) (of_rep temp___569))))
...
(define-fun s__split_fields8 () us_split_fields2 (mk___split_fields1
                                                 s__split_fields4
                                                 s__split_fields5
                                                 s__split_fields6
                                                 s__split_fields7))
...
;; H
  (assert
  (= (bool_eq
     (let ((temp___576 (temp___222 e2)))
     (let ((temp___575 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___575) 0) temp___576
     (concat1 (elts temp___575) (to_rep1 (first (rt temp___575)))
     (to_rep1 (last (rt temp___575))) temp___576 1 1))))
     (to_rep1
     (first
     (let ((temp___575 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___575) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___575)))
     (- (+ (to_rep1 (first (rt temp___575))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___575)))
                                                (to_rep1
                                                (last (rt temp___575))))
     ...
     (mk___rep1
     (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2
     s__split_fields3) s__attr__tag)))))) true))

(assert
;; WP_parameter_def
 ;; File "stackp.adb", line 26, characters 0-0
  (not
  (= (bool_eq
     (let ((temp___572 (temp___567 e2)))
     (let ((temp___571 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___571) 0) temp___572
     (concat1 (elts temp___571) (to_rep1 (first (rt temp___571)))
     (to_rep1 (last (rt temp___571))) temp___572 1 1))))
     (to_rep1
     (first
     (let ((temp___571 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (ite (= (length temp___571) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___571)))
     (- (+ (to_rep1 (first (rt temp___571))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___571)))
                                                (to_rep1
                                                (last (rt temp___571))))
