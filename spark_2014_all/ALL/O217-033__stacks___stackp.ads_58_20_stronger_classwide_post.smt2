...
(declare-fun dummy7 () positive_less_than_max)
...
(declare-fun dummy9 () telement_arrayD1)
...
(declare-fun user_eq17 (t61s t61s) Bool)

(declare-fun dummy17 () t61s)
