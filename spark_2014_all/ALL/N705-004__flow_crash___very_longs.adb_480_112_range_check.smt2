...
(define-fun in_range4 ((rec__very_longs__very_long__octet_length1 Int)
  (a us_rep)) Bool (= rec__very_longs__very_long__octet_length1 (to_rep1
                                                                (rec__very_longs__very_long__octet_length
                                                                (us_split_discrs1
                                                                a)))))
...
(define-fun dynamic_invariant7 ((temp___expr_206 (_ BitVec 8))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= product3 o5)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= carry3 o6)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= o21 o20)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= o25 o26)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= o28 o26)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= o29 o27)))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1326)
  (<= temp___1326 (to_rep2
                  (last3
                  (rt1
                  (rec__very_longs__very_long__long_digits1
...
;; WP_parameter_def
 ;; File "very_longs.adb", line 418, characters 0-0
  (not (bvule ((_ zero_extend 8) ((_ int2bv 8) 0)) o42)))
(check-sat)
(exit)
