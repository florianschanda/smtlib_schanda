...
(declare-fun temp___477 () (Array Int ranking))
...
;; H
  (assert
  (and (= temp___477 (invert_2 r2))
  (and
  (forall ((rank Int))
  (=> (and (<= 1 rank) (<= rank 64))
  (= (to_rep (select temp___477 (to_rep1 (select r2 rank)))) rank)))
  (forall ((g2 Int))
  (=> (and (<= 1 g2) (<= g2 64))
  (= (to_rep1 (select r2 (to_rep (select temp___477 g2)))) g2))))))
