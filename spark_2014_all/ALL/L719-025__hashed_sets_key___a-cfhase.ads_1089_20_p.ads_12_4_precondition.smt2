...
(define-fun dynamic_invariant1 ((temp___expr_405 Int)
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant4 item true true true)
     ...
     result true false true)))) :pattern ((find container1 item)) ))))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (=>
     (and (in_range6 temp___429)
     (= (iter_has_element result temp___429) true))
     (= (contains (model__ container1) (get1 result temp___429)) true))))
     (forall ((item Int))
...
(define-fun dynamic_invariant7 ((temp___expr_379 Int)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant7 (get1 container1 position) true false true)) :pattern (
...
(declare-fun temp___823 () count_type)
...
;; H
  (assert (= temp___823 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___823)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 1068, characters 0-0
  (not
