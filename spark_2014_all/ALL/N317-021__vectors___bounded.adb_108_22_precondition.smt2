...
(declare-fun bounded__test__B_1__w__assume () capacity_range)

(declare-fun bounded__test__B_1__w__assume1 () us_main_type)

(declare-fun o () capacity_range)

(declare-fun o1 () us_main_type)

(declare-fun bounded__vect__clear__container__fields () us_main_type)

(declare-fun result () us_main_type)

(declare-fun v__split_fields1 () us_main_type)

(declare-fun bounded__vect__append__2__container__fields () us_main_type)

(declare-fun result1 () us_main_type)

(declare-fun v__split_fields2 () us_main_type)

(declare-fun bounded__vect__append__2__container__fields1 () us_main_type)

(declare-fun result2 () us_main_type)

(declare-fun v__split_fields3 () us_split_fields)

(declare-fun bounded__vect__append__2__container__fields2 () us_split_fields)

(declare-fun result3 () us_split_fields__ref)

(declare-fun v__split_fields4 () us_split_fields)

(declare-fun bounded__vect__reserve_capacity__container__fields () us_split_fields)
...
(declare-fun bounded__vect__replace_element__container__fields () us_split_fields)

(declare-fun result6 () us_split_fields__ref)

(declare-fun v__split_fields6 () us_split_fields)

(declare-fun bounded__vect__swap__container__fields () us_split_fields)

(declare-fun result7 () us_split_fields__ref)

(declare-fun v__split_fields7 () us_split_fields)

(declare-fun bounded__vect__delete_last__container__fields () us_split_fields)

(declare-fun result8 () us_split_fields__ref)

(declare-fun v__split_fields8 () us_split_fields)

(declare-fun bounded__vect__reverse_elements__container__fields () us_split_fields)

(declare-fun result9 () us_split_fields__ref)

(declare-fun v__split_fields9 () us_split_fields)

(declare-fun bounded__sort__sort__container__fields () us_split_fields)
...
;; H
  ...
  (length (mk___rep v__split_discrs v__split_fields12)) 1))
...
;; H
  ...
  (and
  (= (length
     (mk___rep v__split_discrs bounded__sort__sort__container__fields))
  (length (mk___rep v__split_discrs v__split_fields9)))
  (= (m_elements_sorted
     (model__
     (mk___rep v__split_discrs bounded__sort__sort__container__fields))) true))
  (= (m_elements_included
     ...
     (mk___rep v__split_discrs bounded__sort__sort__container__fields)))
     (model__
     (mk___rep v__split_discrs bounded__sort__sort__container__fields)) 1
     (last
     (model__
     (mk___rep v__split_discrs bounded__sort__sort__container__fields)))) true))
  (= (m_elements_included
