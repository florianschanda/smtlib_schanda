...
;; H
  (assert (and (= o4 (- i9 first4)) (in_range1 (- i9 first4))))

;; H
  (assert
  (and (= o5 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o5)
  (<= o5 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
;; H
  (assert (and (= o2 (- last5 i9)) (in_range1 (- last5 i9))))
