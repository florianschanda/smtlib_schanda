...
;; H
  ...
  (and (= (to_rep2 (last (rt o29))) (- (to_rep2 (last (rt o28))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o28) k)) (to_rep (select (elts o29) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o28)))))
  (= (to_rep (select (elts o28) k)) (to_rep (select (elts o29) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o28))) 1)))
  (= (to_rep (select (elts o28) (+ k 1))) (to_rep (select (elts o29) k))))))))))))
