...
(declare-fun temp___669 () (Array Int cardindex))
...
;; H
  (assert (= o115 (select temp___673 o114)))

;; H
  (assert (= temp___674 (to_rep1 o115)))

;; H
  (assert (and (<= 0 temp___674) (<= temp___674 99)))

;; H
  (assert (= o116 temp___674))

;; H
  (assert
  (= o117 (select (rec__patience__state__posheight
...
;; H
  (assert (= o119 (ite (= ip o118) true false)))
...
;; H
  (assert
  (= temp___669 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20))
  o110)))
...
;; H
  (assert (= o112 (select temp___669 o111)))

;; H
  (assert (= temp___670 (to_rep1 o112)))
