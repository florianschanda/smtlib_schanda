...
(define-fun register_type__ref___177__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___124__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___124__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6262 us_t1)
  (temp___is_init_6259 Bool) (temp___skip_constant_6260 Bool)
  (temp___do_toplevel_6261 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6260 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6262)
                                       (last3 temp___expr_6262))
                                       (and (= (first3 temp___expr_6262) 1)
                                       (= (last3 temp___expr_6262) 4)))))
