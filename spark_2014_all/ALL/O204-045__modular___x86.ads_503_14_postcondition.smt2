...
;; H
  (assert
  (=> (= carryflag true)
  (= rdx1 (bvor (bvand rdx ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) ((_ int2bv 8) 1))))))

;; H
  (assert
  (=> (not (= carryflag true))
  (= rdx2 (bvor (bvand rdx ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56) ((_ int2bv 8) 0))))))
...
(assert
;; WP_parameter_def
 ;; File "x86.ads", line 494, characters 0-0
  (not (= (dl rdx3) ((_ int2bv 8) 1))))
(check-sat)
(exit)
