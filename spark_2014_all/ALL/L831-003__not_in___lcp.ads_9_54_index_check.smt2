...
;; H
  ...
  (and (and (= result12 j12) (= j1 temp___158))
  ...
  (and
  (and (and (= result12 j12) (= j1 (to_rep (first (rt a)))))
...
;; H
  (assert
  (and (= o24 (+ x (int__content lcp__result16))) (in_range1
...
;; H
  (assert
  (and (= o23 (+ x (int__content lcp__result16))) (in_range1
  (+ x (int__content lcp__result16)))))
...
;; H
  (assert
  (=> (not (= result11 true))
  (and (= o19 (+ y (int__content lcp__result16))) (in_range1
  (+ y (int__content lcp__result16))))))

;; H
  (assert
  (=> (not (= result11 true))
  (= o20 (ite (<= o19 (to_rep (last (rt a)))) true false))))

;; H
  (assert
  (=> (not (= result11 true))
  (and (= o18 (+ y (int__content lcp__result16))) (in_range1
  (+ y (int__content lcp__result16))))))

;; H
  (assert
  (=> (not (= result11 true))
  (= o21 (ite (<= (to_rep (first (rt a))) o18) true false))))
...
;; H
  (assert
  (=> (not (= result11 true))
  (= result10 (ite (not (= o22 true)) true false))))
...
;; H
  (assert
  (and (= temp___161 (+ y (int__content lcp__result16))) (in_range1
  (+ y (int__content lcp__result16)))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep (first (rt a))) temp___161)))
(check-sat)
(exit)
