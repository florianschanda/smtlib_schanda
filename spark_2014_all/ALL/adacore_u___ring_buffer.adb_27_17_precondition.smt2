...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     (and (<= (+ 0 result) 100) (dynamic_invariant2 result true false true))) :pattern (
  (length container)) )))
...
(declare-fun user_eq8 (tTcontentSP1 tTcontentSP1) Bool)

(declare-const dummy8 tTcontentSP1)
...
(declare-const ring_buffer__valid_model__2__result Bool)
...
(declare-const ring_buffer__valid_model__2__result1 Bool)

(declare-const ring_buffer__valid_model__2__result2 Bool)

(declare-const ring_buffer__valid_model__2__result3 Bool)

(declare-const ring_buffer__valid_model__2__result4 Bool)

(declare-const ring_buffer__valid_model__2__result5 Bool)
...
;; H
  (assert
  (= ring_buffer__valid_model__2__result1 ring_buffer__valid_model__2__result2))

;; H
  (assert
  (= ring_buffer__valid_model__2__result3 ring_buffer__valid_model__2__result1))

;; H
  (assert (and (= o (length m)) (and (in_range6 o) (<= (+ 0 o) 100))))

;; H
  (assert (and (= o1 o) (in_range3 o)))

;; H
  (assert (= result (ite (= length1 o1) true false)))
...
;; H
  ...
  (= (to_rep (select content i1)) (get m (+ (- i1 first) 1)))
  (=> (and (<= 1 i1) (<= i1 (- (- (+ first length1) 1) 100)))
  (= (to_rep (select content i1)) (get m (+ (- (+ i1 100) first) 1))))))))))

;; H
  (assert (=> (not (= result true)) (= o2 false)))

;; H
  (assert
  (= (mk_bool__ref result1) (mk_bool__ref
                            ring_buffer__valid_model__2__result)))

;; H
  (assert (= ring_buffer__valid_model__2__result1 o2))

;; H
  (assert
  (= (mk_bool__ref ring_buffer__valid_model__2__result4) (mk_bool__ref
                                                         ring_buffer__valid_model__2__result2)))

;; H
  (assert
  (= ring_buffer__valid_model__2__result5 ring_buffer__valid_model__2__result3))

;; H
  (assert (= ring_buffer__valid_model__2__result4 true))

;; H
  (assert (<= (+ (- 100 first) 2) i))

;; H
  (assert (<= i length1))

;; H
  (assert (and (= o4 (- i 100)) (in_range1 (- i 100))))
...
;; H
  (assert (and (= temp___219 o7) (in_range1 o7)))

;; H
  (assert (and (<= 1 temp___219) (<= temp___219 100)))

;; H
  (assert (= o8 temp___219))

;; H
  (assert (= o9 (select content o8)))

;; H
  (assert (= o10 (to_rep o9)))

;; H
  (assert (and (= o3 i) (in_range5 i)))
