...
(declare-fun dummy8 () tTcontentSP1)
...
(declare-fun ring_buffer__valid_model__2__result () Bool)
...
(declare-fun ring_buffer__valid_model__2__result1 () Bool)

(declare-fun ring_buffer__valid_model__2__result2 () Bool)

(declare-fun ring_buffer__valid_model__2__result3 () Bool)

(declare-fun ring_buffer__valid_model__2__result4 () Bool)

(declare-fun ring_buffer__valid_model__2__result5 () Bool)
