...
;; partial_count_selected_locations__def_axiom
  ...
  (forall ((from1 Int))
  (! (=> (dynamic_invariant from1 true true true)
...
;; H
  (assert
  (= count_locations__partial_count_selected_locations__result1 count_locations__partial_count_selected_locations__result2))

;; H
  (assert
  (= count_locations__partial_count_selected_locations__result3 count_locations__partial_count_selected_locations__result1))
...
;; H
  (assert
  (=> (< from 100)
  (and (= o1 (partial_count_selected_locations sel o))
  (and (in_range1 o1)
  (and
  (= o1 (+ (ite (= (select sel o) true) 1 0) (ite (< o 100)
                                             (partial_count_selected_locations
                                             sel (+ o 1)) 0)))
  (<= o1 (+ (- 100 o) 1)))))))
...
;; H
  (assert
  (= result count_locations__partial_count_selected_locations__result))

;; H
  (assert (= count_locations__partial_count_selected_locations__result1
  o5))

;; H
  (assert
  (= (mk_int__ref count_locations__partial_count_selected_locations__result4)
  (mk_int__ref count_locations__partial_count_selected_locations__result2)))

;; H
  (assert
  (= count_locations__partial_count_selected_locations__result5 count_locations__partial_count_selected_locations__result3))

;; H
  (assert
  (= result1 count_locations__partial_count_selected_locations__result4))

(assert
;; WP_parameter_def
 ;; File "count_locations.ads", line 7, characters 0-0
  (not
  (<= count_locations__partial_count_selected_locations__result4 (+ (- 100
  from) 1))))
(check-sat)
(exit)
