...
;; H
  ...
  (=> (not (= prev_alloc1 0))
  (= (rec__list_allocator__cell__stat
     (us_split_fields1 (select data1 prev_alloc1))) o39)))

;; H
  (assert
  (=> (not (= prev_alloc1 0))
  (= (rec__list_allocator__cell__prev
     (us_split_fields1 (select data1 prev_alloc1))) o40)))
...
;; H
  (assert
  (=> (not (= prev_alloc1 0)) (and (<= 1 prev_alloc1) (<= prev_alloc1 3))))
...
;; H
  (assert
  (=> (not (= prev_alloc1 0))
  (= o46 (store data1 o45 (mk___rep (mk___split_fields o42 o43 o44))))))
...
;; H
  ...
  (= o48 (mk___split_fields
         (rec__list_allocator__cell__stat
         (us_split_fields1 (select data2 next_alloc1))) o47
         (rec__list_allocator__cell__next
         (us_split_fields1 (select data2 next_alloc1)))))))
...
;; H
  (assert
  (=> (not (= next_alloc1 0)) (and (<= 1 next_alloc1) (<= next_alloc1 3))))
...
;; H
  ...
  (not
  (= (get (rec__list_allocator__m__t__available model____split_fields3) j1)
  (get (rec__list_allocator__m__t__available model____split_fields3) k1))))))))))
...
;; H
  (assert
  (and
  (= o77 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         j))
  (in_range7 o77)))

;; H
  (assert (= result13 (ite (in_range4 o77) true false)))
...
;; H
  (assert
  (=> (= result13 true)
  (=> (= result14 true) (and (= o74 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o75 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o74))
  (in_range7 o75)))))
...
;; H
  ...
  (= temp___429 (get
                (rec__list_allocator__m__t__allocated model____split_fields3)
                j))
  (in_range7 temp___429))))

;; H
  (assert (=> (= result13 true) (and (<= 1 temp___429) (<= temp___429 3))))

;; H
  (assert (=> (= result13 true) (= o69 temp___429)))

;; H
  (assert (=> (= result13 true) (= o70 (select data3 o69))))

;; H
  (assert (=> (= result13 true) (= o71 (us_split_fields1 o70))))

;; H
  (assert
  (=> (= result13 true) (= o72 (rec__list_allocator__cell__next o71))))
...
;; H
  ...
  (=> (< 1 j)
  (and
  (= o67 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         o66))
  (in_range7 o67)))))
...
;; H
  ...
  (= temp___430 (get
                (rec__list_allocator__m__t__allocated model____split_fields3)
                j))
  (in_range7 temp___430))))

;; H
  (assert (=> (= result12 true) (and (<= 1 temp___430) (<= temp___430 3))))

;; H
  (assert (=> (= result12 true) (= o62 temp___430)))

;; H
  (assert (=> (= result12 true) (= o63 (select data3 o62))))

;; H
  (assert (=> (= result12 true) (= o64 (us_split_fields1 o63))))

;; H
  (assert
  (=> (= result12 true) (= o65 (rec__list_allocator__cell__prev o64))))
...
;; H
  (assert (= o61 (ite (<= k o60) true false)))

;; H
  (assert (= result15 (ite (<= 1 k) o61 false)))
