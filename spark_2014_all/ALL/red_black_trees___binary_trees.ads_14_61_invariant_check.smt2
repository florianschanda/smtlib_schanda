...
(declare-fun temp___574 () extended_index_type)

(declare-fun temp___5741 () (Array Int us_rep))

;; H
  (assert
  (and (= (to_rep temp___574) 0) (default_initial_assumption temp___5741
  false)))
...
;; WP_parameter_def
 ;; File "binary_trees.ads", line 418, characters 0-0
  (not
  (= (tree_structure (mk___rep1 (mk___split_fields1 temp___574 temp___5741))) true)))
(check-sat)
