...
(declare-fun temp___1732 () (Array Int integer))

(declare-fun temp___1733 () t1)
...
;; H
  (assert (not (= current2 temp___180)))
...
;; H
  (assert (= o5 temp___1732))

;; H
  (assert (= (mk1 current3 (to_rep values__last)) temp___1733))

;; H
  (assert (= temp___1732 o6))

;; H
  (assert
  (= (mk (to_rep (first2 temp___1733)) (to_rep (last2 temp___1733)))
  o7))

;; H
  (assert
  (and (= o8 (index_of_minimum (mk___t o6 o7)))
  (and (in_range2 o8)
  (and (and (<= (to_rep (first o7)) o8) (<= o8 (to_rep (last o7))))
  (forall ((j Int))
  (=> (and (<= (to_rep (first o7)) j) (<= j (to_rep (last o7))))
  (<= (to_rep (select o6 o8)) (to_rep (select o6 j)))))))))
...
;; H
  ...
  (and (= o9 current3) (in_range2 current3))))

;; H
  (assert
  (=> (not (= smallest3 current3))
  (and (= (to_rep (select values4 o9)) (to_rep (select values3 smallest3)))
  (and (= (to_rep (select values4 smallest3)) (to_rep (select values3 o9)))
  (forall ((j Int))
  (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last)))
  (=> (and (not (= j o9)) (not (= j smallest3)))
...
;; WP_parameter_def
 ;; File "sorters.adb", line 29, characters 0-0
  (not (<= (to_rep values__first) current3)))
(check-sat)
(exit)
