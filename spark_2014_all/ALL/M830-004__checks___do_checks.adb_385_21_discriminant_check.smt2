...
(define-fun dynamic_invariant1 ((temp___expr_509 us_rep)
...
(define-fun dynamic_invariant2 ((temp___expr_515 us_rep1)
...
;; H
  (assert
  (= (to_rep (rec__do_checks__do_discriminant_check__r1__j x__split_discrs))
  r102b))
...
(assert
;; WP_parameter_def
 ;; File "do_checks.adb", line 370, characters 0-0
  (not
  (= 10 (to_rep
