...
(declare-fun foo__double_tests__sqrt_comedy_1__result () Bool)

(declare-fun result () Bool)

(declare-fun foo__double_tests__sqrt_comedy_1__result1 () Bool)

(declare-fun foo__double_tests__sqrt_comedy_1__result2 () Bool)

(declare-fun foo__double_tests__sqrt_comedy_1__result3 () Bool)

(declare-fun foo__double_tests__sqrt_comedy_1__result4 () Bool)

(declare-fun foo__double_tests__sqrt_comedy_1__result5 () Bool)
...
;; H
  (assert (and (eq (mul RNE1 a a) c) (eq (mul RNE1 b b) c)))

;; H
  (assert
  (= foo__double_tests__sqrt_comedy_1__result1 foo__double_tests__sqrt_comedy_1__result2))

;; H
  (assert
  (= foo__double_tests__sqrt_comedy_1__result3 foo__double_tests__sqrt_comedy_1__result1))
...
;; H
  (assert
  (= foo__double_tests__sqrt_comedy_1__result1 (ite (eq a b) true false)))

;; H
  (assert
  (= (mk_bool__ref foo__double_tests__sqrt_comedy_1__result4) (mk_bool__ref
                                                              foo__double_tests__sqrt_comedy_1__result2)))

;; H
  (assert
  (= foo__double_tests__sqrt_comedy_1__result5 foo__double_tests__sqrt_comedy_1__result3))
...
;; WP_parameter_def
 ;; File "generic_float_tests.adb", line 112, characters 0-0
  (not (= foo__double_tests__sqrt_comedy_1__result4 true)))
(check-sat)
