...
(declare-datatypes ()
((tTresSP1__ref (mk_tTresSP1__ref (tTresSP1__content integer)))))
(define-fun tTresSP1__ref___projection ((a1 tTresSP1__ref)) integer (tTresSP1__content
                                                                    a1))
...
(define-fun tresS__ref___projection ((a1 tresS__ref)) us_t1 (tresS__content
                                                            a1))

(define-fun dynamic_invariant1 ((temp___expr_274 us_t1)
  (temp___is_init_271 Bool) (temp___skip_constant_272 Bool)
  (temp___do_toplevel_273 Bool)) Bool (=>
                                      (not (= temp___skip_constant_272 true))
                                      (and (dynamic_property2 (first1 a)
                                      (last1 a) (first3 temp___expr_274)
                                      (last3 temp___expr_274))
                                      (and
                                      (= (first3 temp___expr_274) (first1 a))
                                      (= (last3 temp___expr_274) (last1 a))))))

(declare-fun res__first () integer)

(declare-fun res__last () integer)
...
(declare-fun res () (Array Int natural))

(declare-fun loops_static__loop10__result () (Array Int natural))

(declare-fun loops_static__loop10__result1 () t)

(declare-fun result2 () (Array Int natural))

(declare-fun r3 () (Array Int natural))

(declare-fun res1 () (Array Int natural))

(declare-fun loops_static__loop10__result2 () (Array Int natural))

(declare-fun loops_static__loop10__result3 () t)
...
;; H
  ...
  (=>
  (and (<= (to_rep1 r__first) temp___379) (<= temp___379 (to_rep1 r__last)))
  (=> (<= i2 temp___379) (= (select r2 temp___379) (select r1 temp___379)))))
  (and (<= 1 i2) (<= i2 2))))
...
;; H
  (assert
  (= (mk___t loops_static__loop10__result2 loops_static__loop10__result3)
  (mk___t loops_static__loop10__result loops_static__loop10__result1)))
...
(assert
;; WP_parameter_def
 ;; File "loops_static.ads", line 2, characters 0-0
  (not (= (to_rep (select r3 j)) 0)))
(check-sat)
(exit)
