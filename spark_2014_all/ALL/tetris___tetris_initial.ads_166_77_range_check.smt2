...
(define-fun dynamic_invariant1 ((temp___expr_657 Int)
  (temp___is_init_654 Bool) (temp___skip_constant_655 Bool)
  (temp___do_toplevel_656 Bool)) Bool (=>
                                      (or (= temp___is_init_654 true)
                                      (<= 3 4)) (in_range1 temp___expr_657)))
...
(assert
;; WP_parameter_def
 ;; File "tetris_initial.ads", line 63, characters 0-0
  (not (not (= d 3))))
(check-sat)
(exit)
