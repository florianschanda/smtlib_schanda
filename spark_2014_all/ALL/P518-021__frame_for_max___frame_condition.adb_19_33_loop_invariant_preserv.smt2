...
;; H
  (assert (and (= o29 (+ k2 1)) (in_range1 (+ k2 1))))
...
;; H
  (assert (= (mk___rep (mk___split_fields o31 o32 o33)) (select a2 o30)))
...
;; H
  (assert (= result7 (ite (< max3 o38) true false)))
...
;; H
  (assert (=> (= result7 true) (= o39 k3)))

;; H
  (assert
  (=> (= result7 true)
  (= (mk___rep (mk___split_fields o40 o41 o42)) (select a2 o39))))

;; H
  (assert (=> (= result7 true) (= o40 o43)))

;; H
  (assert (=> (= result7 true) (= o41 o44)))

;; H
  (assert (=> (= result7 true) (= o42 o45)))

;; H
  (assert (=> (= result7 true) (= o46 o43)))

;; H
  (assert (=> (= result7 true) (= o47 (to_rep o46))))

;; H
  (assert (=> (= result7 true) (= result8 (mk_int__ref max3))))

;; H
  (assert (=> (= result7 true) (= max4 o47)))

;; H
  (assert (=> (not (= result7 true)) (= max4 max3)))

;; H
  (assert (= (to_rep o48) max4))

;; H
  (assert
  (= o49 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select a2 k3))) o48
         (rec__frame_condition__cell__max_right
         (us_split_fields1 (select a2 k3))))))
