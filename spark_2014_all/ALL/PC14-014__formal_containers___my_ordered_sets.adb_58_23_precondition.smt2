...
(declare-fun m__split_fields1 () us_split_fields)
...
;; H
  (assert
  (= m__split_fields1 (us_split_fields1
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs m__split_fields2))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs m__split_fields2))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
  (= (length (mk___rep m__split_discrs m__split_fields2)) (length
                                                          (mk___rep
                                                          k__split_discrs
                                                          k__split_fields3)))))
...
;; H
  (assert
  (= (oeq
     (intersection__2 (mk___rep m__split_discrs m__split_fields2)
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep m__split_discrs m__split_fields3)) (num_overlaps
                                                          (model__
                                                          (mk___rep
                                                          m__split_discrs
                                                          m__split_fields2))
                                                          ...
                                                          l__split_discrs
                                                          l__split_fields11))))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields3))
     (model__ (mk___rep m__split_discrs m__split_fields2))) true))
  (= (ole (model__ (mk___rep m__split_discrs m__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (includes_intersection
     (model__ (mk___rep m__split_discrs m__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep m__split_discrs m__split_fields2))) true))
  (= (e_elements_included
     (elements (mk___rep m__split_discrs m__split_fields3))
     (elements (mk___rep m__split_discrs m__split_fields2))) true))
  (= (e_elements_included__2
     (elements (mk___rep m__split_discrs m__split_fields2))
     (model__ (mk___rep l__split_discrs l__split_fields11))
     (elements (mk___rep m__split_discrs m__split_fields3))) true))
  (= (mapping_preserved
     (elements (mk___rep m__split_discrs m__split_fields3))
     (elements (mk___rep m__split_discrs m__split_fields2))
     (positions (mk___rep m__split_discrs m__split_fields3))
     (positions (mk___rep m__split_discrs m__split_fields2))) true)))
