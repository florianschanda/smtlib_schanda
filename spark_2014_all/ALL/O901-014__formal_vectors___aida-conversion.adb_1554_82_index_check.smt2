...
;; H
  ...
  (forall ((index3 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 6) index3)
...
;; H
  (assert (<= temp___1958 index1))

;; H
  (assert (<= index1 temp___1959))
...
;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 6) i1) (<= i1 index2))
...
;; H
  ...
  (=> (< index2 temp___1956)
  (= (select n3 temp___1956) (select n1 temp___1956)))))
  (=>
...
;; H
  (assert
  (and (= o9 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))
