...
(declare-fun user_eq2 (t645s t645s) Bool)

(declare-fun dummy2 () t645s)

(declare-datatypes () ((t645s__ref (mk_t645s__ref (t645s__content t645s)))))
(define-fun t645s__ref___projection ((a t645s__ref)) t645s (t645s__content a))
...
;; H
  (assert
  (= (make_mask i3) (bvsub (ite (< i3 18446744073709551616)
                           (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) i3))
                           ((_ int2bv 64) 0)) ((_ int2bv 64) 1))))
