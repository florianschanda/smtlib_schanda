...
(declare-fun dummy1 () rx_frame_queue_index)
...
(declare-fun decadriver__receiver_type__pending_frames_count__result () Int)
...
(declare-fun decadriver__receiver_type__pending_frames_count__result1 () Int)

(declare-fun decadriver__receiver_type__pending_frames_count__result2 () Int)

(declare-fun decadriver__receiver_type__pending_frames_count__result3 () Int)

(declare-fun decadriver__receiver_type__pending_frames_count__result4 () Int)

(declare-fun decadriver__receiver_type__pending_frames_count__result5 () Int)
