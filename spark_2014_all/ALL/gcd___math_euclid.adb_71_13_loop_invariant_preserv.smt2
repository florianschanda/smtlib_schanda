...
;; H
  ...
  (= (and (= (divides x c1) true) (= (divides x an2) true))
...
;; H
  ...
  (forall ((x Int))
  (=> (and (<= 1 x) (<= x 2147483647))
  (= (and (= (divides x c3) true) (= (divides x an4) true))
  (and (= (divides x an4) true)
  (or (= (divides an4 c3) true) (= (divides x (mod2 c3 an4)) true)))))))
