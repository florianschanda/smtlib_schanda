...
(define-fun tint_arrayD1__ref___11__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___11__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t436b__ref 0))
(((mk_t436b__ref (t436b__content integer)))))
...
(declare-datatypes ((t437b__ref 0))
(((mk_t437b__ref (t437b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___20__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___20__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t440b__ref 0))
(((mk_t440b__ref (t440b__content integer)))))
...
(declare-datatypes ((t441b__ref 0))
(((mk_t441b__ref (t441b__content us_t4)))))
...
(((mk_t442b__ref (t442b__content integer)))))
...
(define-fun tint_arrayB__ref___11__projection ((a tint_arrayB__ref)) us_t5
...
;; def_axiom
  (assert
  (forall ((temp___1862 Int) (temp___1863 Int) (temp___1864 Int)
  (temp___1865 Int) (temp___1866 Int))
  (let ((temp___1861 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def
                     temp___1862 temp___1863 temp___1864 temp___1865
                     temp___1866)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 8) (+ (first1 source) 10)
  temp___1865 temp___1866)
  (and (= (first5 temp___1861) temp___1865)
  (= (last5 temp___1861) temp___1866)))
  (and
  (and
  (= (select (to_array2 temp___1861) (+ (+ (first1 source) 8) 0)) (of_rep1
                                                                  temp___1862))
  (= (select (to_array2 temp___1861) (+ (+ (first1 source) 8) 1)) (of_rep1
                                                                  temp___1863)))
  (= (select (to_array2 temp___1861) (+ (+ (first1 source) 8) 2)) (of_rep1
                                                                  temp___1864)))))))
...
(define-fun tnumber_array_typeB__ref___20__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; def_axiom
  (assert
  (forall ((temp___1872 Int) (temp___1873 Int) (temp___1874 Int))
  (let ((temp___1871 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def
                     temp___1872 temp___1873 temp___1874)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 8) (+ (first1 source) 10)
  temp___1873 temp___1874)
  (and (= (first9 temp___1871) temp___1873)
  (= (last9 temp___1871) temp___1874)))
  (forall ((temp___1875 Int))
  (= (select (to_array4 temp___1871) temp___1875) (of_rep1 temp___1872)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_545 us_t3)
  ...
  (temp___do_toplevel_544 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 8)
                                      (+ (first1 source) 10)
                                      (first7 temp___expr_545)
                                      (last7 temp___expr_545))
                                      (and
                                      (= (first7 temp___expr_545) (+
                                      (first1 source) 8))
                                      (= (last7 temp___expr_545) (+ (first1
                                                                    source) 10))))))
...
;; H
  (assert
  (= (mk___t2 temp___1869 temp___18691) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def
                                        5 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___18691)) (to_rep1 (last4 temp___18691)))
     (+ (- (to_rep1 (last4 temp___18691)) (to_rep1 (first4 temp___18691))) 1)
...
;; H
  (assert
  (= (slide1 temp___1869 (to_rep1 (first4 temp___18691))
...
;; H
  (assert
  (= (mk___t4 temp___1877 temp___18771) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 8)
                                        (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___18771)) (to_rep1 (last8 temp___18771)))
     (+ (- (to_rep1 (last8 temp___18771)) (to_rep1 (first8 temp___18771))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1
                                                        (first (rt source))) 10))
        (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1
                                                      (first (rt source))) 8)) 1)
...
;; H
  (assert
  (= (slide1 temp___1877 (to_rep1 (first8 temp___18771))
...
;; H
  (assert
  (and (= temp___1883 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (= temp___1884 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884))
  (= temp___1882 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= n2 o8)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1881 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1881)
  (<= temp___1881 (to_rep1 n__last)))
  (=> (< index2 temp___1881)
  (= (select n3 temp___1881) (select temp___1880 temp___1881)))))
  (=>
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___1883 index1) (<= index1 temp___1884)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___1883 index1) (<= index1 temp___1884)))
...
;; H
  (assert
  (=> (not (and (<= temp___1883 index1) (<= index1 temp___1884))) (= n7 n1)))
...
;; H
  (assert
  (and (= temp___1885 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1885)
  (<= temp___1885 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1886 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1886)
  (<= temp___1886 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1887 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1887)
  (<= temp___1887 (to_rep1 n__last))))

;; H
  (assert (= o21 temp___1887))
...
;; H
  (assert
  (and (= o28 (- target3 2147483000)) (in_range1 (- target3 2147483000))))
