...
(declare-fun p__pt__y__first__bit () Int)

(declare-fun p__pt__y__last__bit () Int)

(declare-fun p__pt__y__position () Int)
...
(declare-fun p__pt__z__first__bit () Int)

(declare-fun p__pt__z__last__bit () Int)

(declare-fun p__pt__z__position () Int)
