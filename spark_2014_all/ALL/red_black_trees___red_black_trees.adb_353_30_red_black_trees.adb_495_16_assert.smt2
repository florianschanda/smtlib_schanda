...
;; H
  (assert
  (=> (and (<= 1 (let ((subject n1)) n11)) (<= (let ((subject n1)) n11) 100))
  (= temp___700 (let ((subject n1)) n11))))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11
      (select (nb_blacks c105b) (parent
                                (rec__red_black_trees__rbt__struct
                                (us_split_fields9 c106b)) y3))))) (let ((subject 
                                                                  n1)) 
                                                                  n12))
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11
     (select (nb_blacks c106b) (parent
                               (rec__red_black_trees__rbt__struct
                               (us_split_fields9 c106b)) y3)))) true))))

;; H
  (assert
  (=> (and (<= 1 (let ((subject n1)) n11)) (<= (let ((subject n1)) n11) 100))
  (= (let ((subject n1)) n12) 100)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject n1)) n11)) (<= (let ((subject n1)) n11) 100))
  (= n13 (let ((subject n1)) (mk_int__ref n12)))))
...
;; H
  ...
  (not
  (and (<= 1 (let ((subject n1)) n11)) (<= (let ((subject n1)) n11) 100)))
  (= n15 (let ((subject n1)) (mk_int__ref n11)))))
