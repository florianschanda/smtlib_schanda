...
(declare-fun test_08__t1__n__first__bit () Int)

(declare-fun test_08__t1__n__last__bit () Int)

(declare-fun test_08__t1__n__position () Int)
...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__test_08__t2__n integer)))))
...
(define-fun bool_eq2 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__test_08__t2__n (us_split_fields3 a))) 
                    (to_rep (rec__test_08__t2__n (us_split_fields3 b)))) true
                    false))
...
(declare-fun test_08__t2__n__first__bit () Int)

(declare-fun test_08__t2__n__last__bit () Int)

(declare-fun test_08__t2__n__position () Int)
...
(declare-fun test_08__t3__n__first__bit () Int)

(declare-fun test_08__t3__n__last__bit () Int)

(declare-fun test_08__t3__n__position () Int)
...
(declare-fun temp___158 () integer)
...
;; WP_parameter_def
 ;; File "test_08_util.ads", line 9, characters 0-0
  (not (type_invariant (mk___rep (mk___split_fields temp___158)))))
(check-sat)
