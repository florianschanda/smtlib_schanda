...
(declare-fun o179 () storage_element)
...
;; H
  (assert (= o179 (select temp___513 1)))

;; H
  (assert (= o180 (to_rep o179)))

;; H
  (assert (= o181 ((_ zero_extend 24) o180)))

;; H
  (assert (= o182 (bvshl o181 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o175 (select temp___509 2)))
...
;; H
  (assert (= o178 (bvshl o177 ((_ int2bv 32) 16))))
...
;; H
  (assert (= o171 (select temp___505 3)))
...
;; H
  (assert (= o174 (bvshl o173 ((_ int2bv 32) 8))))
