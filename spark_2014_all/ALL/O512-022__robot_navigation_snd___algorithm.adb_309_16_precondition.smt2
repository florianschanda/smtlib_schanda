...
(declare-datatypes ((gap__ref 0)) (((mk_gap__ref (gap__content us_rep3)))))
...
(((mk_cursor__ref (cursor__content us_rep5)))))
...
(((mk_key_type__ref (key_type__content us_rep5)))))
...
(((mk_map__ref3 (map__content3 (Array Int us_rep8))))))
...
(((mk_controller__ref (controller__content us_rep9)))))
