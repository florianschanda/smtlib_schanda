...
(declare-fun temp___1032 () Float32)
...
;; H
  ...
  (= (bool_eq8 temp___10191 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (=> (= result2 true)
  (=> (= result3 true)
  (= result6 (bool_eq8 (mk___rep5 iterr__split_fields2) o27)))))
...
;; H
  ...
  (= (bool_eq8 (mk___rep5 iterr__split_fields3) no_element) true))
  (= (range_equal
     (model__
     (mk___rep4
     (us_split_discrs3
...
;; H
  ...
  (= (bool_eq8 temp___1027 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (= temp___1022 (previous
                 ...
                 (let ((subject this__split_fields)) this__split_fields2))
                 (mk___rep5 iterr__split_fields2)))
  (ite (= (ite (= (bool_eq8 (mk___rep5 iterr__split_fields2) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
          (let ((subject this__split_fields)) this__split_fields2)))
          (mk___rep5 iterr__split_fields2)) 1) true) true)
  (= (bool_eq8 temp___1022 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (= (length1
     ...
     algorithm__gap_vectors__delete__container__fields1)) (- (length1
                                                             ...
                                                             this__split_fields))
                                                             this__split_fields2))))) 1))
  (= (bool_eq8 (mk___rep5 iterr__split_fields4) no_element) true))
  (= (range_equal
     (model__
     (mk___rep4
     (us_split_discrs3
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= result6 true))
  (ite (= (ite (= (bool_eq8 (mk___rep5 iterl__split_fields5) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
  ...
  (= (bool_eq8 (mk___rep5 iterl__split_fields6) no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  (assert
  (=> (= result2 true)
  (ite (= (ite (= (bool_eq8 (mk___rep5 iterl__split_fields4) no_element) false) (=
          (get1
          (positions
          (rec__algorithm__controller__gapvec
          (let ((subject this__split_fields)) this__split_fields3)))
  ...
  (= (bool_eq8 (mk___rep5 iterl__split_fields7) no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  ...
  (=> (= result2 true)
  (=>
  (and (not (= (bool_eq8 (mk___rep5 iterl__split_fields7) no_element) true))
  (not (= (bool_eq8 (mk___rep5 iterr__split_fields5) no_element) true)))
  (and
  (= o28 (length1
         (rec__algorithm__controller__gapvec
         (let ((subject this__split_fields)) this__split_fields3))))
...
;; H
  ...
  (=>
  (not
  (= (bool_eq8 (mk___rep5 (us_split_fields__content5 iterr__split_fields8))
     no_element) true))
  (and
  (= o30 (length1
         (rec__algorithm__controller__gapvec
...
;; H
  ...
  (= (bool_eq8 temp___1033 no_element) true)
  (and
  (= (has_key
     (positions
     (rec__algorithm__controller__gapvec
...
;; H
  (assert
  (and
  (= o45 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep2
                                                                   (rec__robot_iface__proxy__scan_res
                                                                   (us_split_fields5
                                                                   (rec__algorithm__controller__robot
                                                                   (us_split_fields__content7
...
;; H
  (assert
  (and (= o46 (ccwdiff o41 o44))
  (not (or (fp.isInfinite o46) (fp.isNaN o46)))))
