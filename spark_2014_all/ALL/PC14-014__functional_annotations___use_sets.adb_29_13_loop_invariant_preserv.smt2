...
(define-fun dynamic_invariant6 ((temp___expr_167 (_ BitVec 32))
...
(define-fun temp___8631 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___863)))

(define-fun use_sets__apply_f__cu__assume1 () us_rep1 (mk___rep1
                                                      (mk___split_fields1
                                                      use_sets__apply_f__cu__assume)))
...
;; H
  (assert
  (and (= use_sets__apply_f__cu__assume1 (first s))
  (ite (= (= (length s) 0) true)
  (= (bool_eq1 use_sets__apply_f__cu__assume1 no_element) true)
  (and (= (has_key (positions s) use_sets__apply_f__cu__assume1) true)
  (= (get1 (positions s) use_sets__apply_f__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= (length (mk___rep r__split_discrs r__split_fields6)) 0)
  (= (is_empty1 (model__ (mk___rep r__split_discrs r__split_fields6))) true)))

;; H
  (assert
  (and (= result1 (has_key (positions s) (mk___rep1 cu__split_fields5)))
  (= (= result1 true)
  (= (has_key (positions s) (mk___rep1 cu__split_fields5)) true))))
...
;; H
  (assert
  (<= (length (mk___rep r__split_discrs r__split_fields5)) (- (get1
                                                              (positions s)
                                                              (mk___rep1
                                                              cu__split_fields4)) 1)))
...
;; H
  ...
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields5))
     (f (get (elements s) i))) true))))

;; H
  (assert
  (let ((temp___871 (elements (mk___rep r__split_discrs r__split_fields5))))
...
;; H
  (assert (= (has_key (positions s) (mk___rep1 cu__split_fields4)) true))

;; H
  (assert
  (and (= o (element s (mk___rep1 cu__split_fields4)))
  (and (in_range6 o)
  (= o (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields4)))))))
...
;; H
  ...
  (and
  (and
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields4)) o1) true)
  (= (element (mk___rep r__split_discrs r__split_fields4)
     (find1 (mk___rep r__split_discrs r__split_fields4) o1)) o1))
  (ite (= (contains (model__ (mk___rep r__split_discrs r__split_fields5)) o1) true)
  (and
  (and
  (= (oeq3 (model__ (mk___rep r__split_discrs r__split_fields4))
     (model__ (mk___rep r__split_discrs r__split_fields5))) true)
  (= (oeq4 (positions (mk___rep r__split_discrs r__split_fields4))
     (positions (mk___rep r__split_discrs r__split_fields5))) true))
  (= (equal_except (elements (mk___rep r__split_discrs r__split_fields5))
     (elements (mk___rep r__split_discrs r__split_fields4))
     (get1 (positions (mk___rep r__split_discrs r__split_fields4))
     (find1 (mk___rep r__split_discrs r__split_fields4) o1))) true))
  (and
  (and
  (and
  (and
  (= (length (mk___rep r__split_discrs r__split_fields4)) (+ (length
                                                             (mk___rep
                                                             r__split_discrs
                                                             r__split_fields5)) 1))
  (= (ole (model__ (mk___rep r__split_discrs r__split_fields5))
     (model__ (mk___rep r__split_discrs r__split_fields4))) true))
  (= (included_except (model__ (mk___rep r__split_discrs r__split_fields4))
     (model__ (mk___rep r__split_discrs r__split_fields5)) o1) true))
  (= (mapping_preserved
     (elements (mk___rep r__split_discrs r__split_fields5))
     (elements (mk___rep r__split_discrs r__split_fields4))
     (positions (mk___rep r__split_discrs r__split_fields5))
...
;; H
  (assert
  (and (= temp___8631 (next s (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq1 temp___8631 no_element) true)
  (and (= (has_key (positions s) temp___8631) true)
  (= (get1 (positions s) temp___8631) (+ (get1 (positions s)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___863)))
...
(define-fun temp___871 () us_rep2 (elements
                                  (mk___rep r__split_discrs r__split_fields4)))

(declare-const temp___870 Int)

;; H
  (assert (in_range2 temp___870))

;; H
  (assert (= (iter_has_element temp___871 temp___870) true))
