...
;; H
  ...
  (=> (<= 1 10) (in_range5 c2))) (=> (<= 0 2147483647) (in_range2 tmp2)))
  (and (<= 1 c2) (<= c2 10)))))
...
;; H
  (assert
  (=> (and (<= 1 c1) (<= c1 10)) (= (to_rep o) (to_rep (get m2 7 c2)))))
...
;; H
  (assert
  (=> (and (<= 1 c1) (<= c1 10)) (= (mk_int__ref c5) (mk_int__ref c3))))
...
;; H
  (assert
  (=> (and (<= 1 c1) (<= c1 10)) (= (mk_map__ref m7) (mk_map__ref m5))))
