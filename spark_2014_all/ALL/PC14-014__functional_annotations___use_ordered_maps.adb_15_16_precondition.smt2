...
;; H
  (assert (= temp___6291 (get1 (positions s) (mk___rep1 cu__split_fields3))))

;; H
  (assert
  (and (= o2 (key s (mk___rep1 cu__split_fields3)))
  (and (in_range7 o2)
  (= o2 (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields3)))))))
...
;; H
  (assert
  (= use_ordered_maps__my_find__result1 use_ordered_maps__my_find__result))
