...
;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o13) true false)))))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (= o12 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
         1))
  (in_range6 o12))))))
...
;; H
  ...
  (=> (= result2 true)
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result1 (ite (= o12 first_available) true false))))))
...
;; H
  ...
  (= o14 (length
         (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o14) (<= (+ 0 o14) 2147483647))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (not (= first_available 0)))
  (= result1 (ite (= o14 0) true false)))))
