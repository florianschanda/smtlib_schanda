...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__agc_tune2_type__agc_tune2 bits_32)))))
(define-fun us_split_fields_AGC_TUNE2__projection ((a us_split_fields)) bits_32 
  (rec__dw1000__register_types__agc_tune2_type__agc_tune2 a))
...
(define-fun us_rep_28__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__agc_tune2_type__agc_tune2
...
(declare-fun dw1000__register_types__agc_tune2_type__agc_tune2__first__bit () Int)

(declare-fun dw1000__register_types__agc_tune2_type__agc_tune2__last__bit () Int)

(declare-fun dw1000__register_types__agc_tune2_type__agc_tune2__position () Int)

;; dw1000__register_types__agc_tune2_type__agc_tune2__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__agc_tune2_type__agc_tune2__first__bit))

;; dw1000__register_types__agc_tune2_type__agc_tune2__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_tune2_type__agc_tune2__first__bit dw1000__register_types__agc_tune2_type__agc_tune2__last__bit))

;; dw1000__register_types__agc_tune2_type__agc_tune2__position_axiom
...
(declare-datatypes ()
((agc_tune2_type__ref
 (mk_agc_tune2_type__ref (agc_tune2_type__content us_rep)))))
(define-fun agc_tune2_type__ref___projection ((a agc_tune2_type__ref)) us_rep 
  (agc_tune2_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_64__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_46__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_46__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3515 us_t1)
  (temp___is_init_3512 Bool) (temp___skip_constant_3513 Bool)
  (temp___do_toplevel_3514 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3513 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3515)
                                       (last3 temp___expr_3515))
                                       (and (= (first3 temp___expr_3515) 1)
                                       (= (last3 temp___expr_3515) 4)))))
...
(define-fun target__ref_19__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_19__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3531 us_t2)
  (temp___is_init_3528 Bool) (temp___skip_constant_3529 Bool)
  (temp___do_toplevel_3530 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3529 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_3531)
                                       (last5 temp___expr_3531))
                                       (and (= (first5 temp___expr_3531) 1)
                                       (= (last5 temp___expr_3531) 4)))))
...
(declare-fun temp___7690 () (Array Int bits_8))

(declare-fun temp___76901 () t2)

(declare-fun temp___7691 () (Array Int bits_8))

(declare-fun temp___76911 () t1)
...
(define-fun temp___76902 () us_t2 (mk___t2 temp___7690 temp___76901))
...
;; H
  (assert
  (and (= temp___76902 (register_to_bytes reg)) (dynamic_invariant1
  temp___76902 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76901)) (to_rep (last4 temp___76901)))
     (+ (- (to_rep (last4 temp___76901)) (to_rep (first4 temp___76901))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7690 temp___7691))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76901)) (to_rep (last4 temp___76901))) 
  temp___76911))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___76911)) (to_rep (last2 temp___76911)))
     (+ (- (to_rep (last2 temp___76911)) (to_rep (first2 temp___76911))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7691 temp___76911)))
