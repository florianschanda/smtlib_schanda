...
(declare-datatypes ((agc_tune2_type__ref 0))
...
(declare-const temp___7690 (Array Int bits_8))

(declare-const temp___76901 t2)

(declare-const temp___7691 (Array Int bits_8))

(declare-const temp___76911 t1)
