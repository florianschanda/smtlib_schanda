...
(define-fun register_type__ref___64__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___46__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___46__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3557 us_t1)
  (temp___is_init_3554 Bool) (temp___skip_constant_3555 Bool)
  (temp___do_toplevel_3556 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3555 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3557)
                                       (last3 temp___expr_3557))
                                       (and (= (first3 temp___expr_3557) 1)
                                       (= (last3 temp___expr_3557) 4)))))
...
(define-fun target__ref___19__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___19__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_3573 us_t2)
  (temp___is_init_3570 Bool) (temp___skip_constant_3571 Bool)
  (temp___do_toplevel_3572 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3571 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_3573)
                                       (last5 temp___expr_3573))
                                       (and (= (first5 temp___expr_3573) 1)
                                       (= (last5 temp___expr_3573) 4)))))
...
;; H
  (assert
  (and (= temp___78402 (register_to_bytes reg)) (dynamic_invariant1
  temp___78402 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78401)) (to_rep (last4 temp___78401)))
     (+ (- (to_rep (last4 temp___78401)) (to_rep (first4 temp___78401))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78401)) (to_rep (last4 temp___78401)))
  temp___78411))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78411)) (to_rep (last2 temp___78411)))
     (+ (- (to_rep (last2 temp___78411)) (to_rep (first2 temp___78411))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7841 temp___78411)))
