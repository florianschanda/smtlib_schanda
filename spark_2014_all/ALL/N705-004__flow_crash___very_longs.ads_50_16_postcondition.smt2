...
(declare-fun temp___947 () digit_index_type)

(declare-fun temp___9471 () (Array Int octet))

(declare-fun temp___9472 () t1)

(declare-fun temp___959 () (_ BitVec 16))

(declare-fun temp___958 () (_ BitVec 16))

(declare-fun temp___955 () us_rep1)

(declare-fun temp___954 () (_ BitVec 16))

(declare-fun temp___953 () (_ BitVec 16))
...
(declare-fun temp___952 () us_rep1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9471 temp___9472))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___955 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___957)
  (<= temp___957 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___957) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           temp___955))) temp___957))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___952 (mk___rep1 result____split_discrs o17))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields3 temp___952))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___952))))
