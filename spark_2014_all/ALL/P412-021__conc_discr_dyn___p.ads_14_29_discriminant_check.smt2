...
;; H
  (assert
  (= (mk2 (to_rep1 (first6 temp___2301)) (to_rep1 (last6 temp___2301)))
  o1))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs o7) (mk___split_fields (mk___t o8 o9)))
  (to_base1
  (mk___rep2 (mk___split_discrs o4) (mk___split_fields2 (mk___t2 o5 o6))))))

(assert
;; WP_parameter_def
 ;; File "p.ads", line 9, characters 0-0
  (not (= (to_rep (rec__p__pp__c (us_split_discrs5 self__))) (to_rep o7))))
(check-sat)
(exit)
