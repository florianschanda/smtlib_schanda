...
;; H
  (assert
  (and (= o (div1 RNE1 right left)) (tqtisFinite (div1 RNE1 right left))))

;; H
  (assert (= o1 (neg o)))

;; H
  (assert (and (= o2 (atan__2 o1)) (tqtisFinite o2)))
...
;; H
  (assert (not (le left fliteral4)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (add RNE1 result__1 fliteral3))))
(check-sat)
