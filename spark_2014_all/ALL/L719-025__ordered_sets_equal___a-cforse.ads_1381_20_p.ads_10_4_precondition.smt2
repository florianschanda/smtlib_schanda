...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (= (contains (model__ container1) (get1 result temp___393)) true))))
     (forall ((item Int))
     (=> (and (in_range5 item) (= (contains (model__ container1) item) true))
...
(define-fun element_type__ref___4__projection ((a element_type__ref4)) element_type4
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant6 (get1 container1 position) true false true)) :pattern (
