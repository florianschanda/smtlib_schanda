...
(declare-fun dummy1 () max_lsid_type)
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int max_lsid_type))))))
...
(define-fun bool_eq2 ((a (Array Int max_lsid_type)) (a__first Int)
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__foo__subject_state__states us_t)))))
...
(declare-fun foo__subject_state__max_id__first__bit () Int)

(declare-fun foo__subject_state__max_id__last__bit () Int)

(declare-fun foo__subject_state__max_id__position () Int)
...
(declare-fun foo__subject_state__states__first__bit () Int)

(declare-fun foo__subject_state__states__last__bit () Int)

(declare-fun foo__subject_state__states__position () Int)
...
(declare-fun foo__subject_state__max_id__first__bit1 () Int)

(declare-fun foo__subject_state__max_id__last__bit1 () Int)

(declare-fun foo__subject_state__max_id__position1 () Int)
...
(declare-fun foo__subject_state__states__first__bit1 () Int)

(declare-fun foo__subject_state__states__last__bit1 () Int)

(declare-fun foo__subject_state__states__position1 () Int)
...
(declare-fun states__split_discrs () us_split_discrs)
...
(declare-fun dummy10 () local_subject_id_type)

(declare-datatypes ()
((local_subject_id_type__ref
...
(declare-fun states__split_fields () (Array Int natural))

(declare-fun states__split_fields1 () t1)
