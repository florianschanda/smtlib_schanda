...
(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result () (_ BitVec 32))

(declare-fun o () (_ BitVec 32))

(declare-fun result () (_ BitVec 32))

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result1 () (_ BitVec 32))

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result2 () (_ BitVec 32))

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result3 () (_ BitVec 32))

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result4 () (_ BitVec 32))

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__extract_bits_not_inline__result5 () (_ BitVec 32))
