...
(define-fun dynamic_invariant ((temp___expr_208 (_ BitVec 32))
...
(declare-fun x86__signedlt_32__result () Bool)

(declare-fun result () Bool)

(declare-fun x86__signedlt_32__result1 () Bool)

(declare-fun x86__signedlt_32__result2 () Bool)

(declare-fun x86__signedlt_32__result3 () Bool)

(declare-fun x86__signedlt_32__result4 () Bool)

(declare-fun x86__signedlt_32__result5 () Bool)
...
;; H
  (assert
  (= x86__signedlt_32__result1 (ite (bvugt (bvadd ((_ zero_extend 32)
                               val1) ((_ zero_extend 32) val2)) ((_ zero_extend 32) (bvadd
                               val1 val2))) true false)))

;; H
  (assert
  (= (mk_bool__ref x86__signedlt_32__result4) (mk_bool__ref
                                              x86__signedlt_32__result2)))

;; H
  (assert (= x86__signedlt_32__result5 x86__signedlt_32__result3))

;; H
  (assert (= result1 x86__signedlt_32__result4))

;; H
  (assert (= x86__signedlt_32__result4 true))
