...
;; H
  ...
  (= (key (mk___rep m__split_discrs m__split_fields4)
     (find1 (mk___rep m__split_discrs m__split_fields4) 1)) 1))
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (find1 (mk___rep m__split_discrs m__split_fields4) 1)) true)))
...
;; H
  ...
  (= (key (mk___rep m__split_discrs m__split_fields3)
     (find1 (mk___rep m__split_discrs m__split_fields3) 2)) 2))
  ...
  (= (mapping_preserved (keys (mk___rep m__split_discrs m__split_fields4))
  ...
  (= (keys_included_except1
     ...
     (positions (mk___rep m__split_discrs m__split_fields4))
     (find1 (mk___rep m__split_discrs m__split_fields3) 2)) true)))
