...
(declare-fun perm__perm_symmetric__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun perm__perm_symmetric__result1 () Int)

(declare-fun perm__perm_symmetric__result2 () Int)

(declare-fun perm__perm_symmetric__result3 () Int)

(declare-fun perm__perm_symmetric__result4 () Int)

(declare-fun perm__perm_symmetric__result5 () Int)
...
;; H
  (assert
  (and (= o (induction_hypothesis a b))
  (and (in_range4 o) (=> (= (of_int o) true) (= (is_perm b a) true)))))

;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref perm__perm_symmetric__result)))
...
;; H
  (assert
  (= (mk_int__ref perm__perm_symmetric__result4) (mk_int__ref
                                                 perm__perm_symmetric__result2)))

;; H
  (assert (= perm__perm_symmetric__result5 perm__perm_symmetric__result3))

;; H
  (assert (= result1 perm__perm_symmetric__result4))
