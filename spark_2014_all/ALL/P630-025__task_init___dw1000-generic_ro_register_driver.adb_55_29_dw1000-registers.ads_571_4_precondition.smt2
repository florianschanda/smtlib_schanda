...
(((mk___split_fields
  (rec__dw1000__register_types__lde_ppampl_type__lde_ppampl bits_16)))))
(define-fun us_split_fields_LDE_PPAMPL__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__lde_ppampl_type__lde_ppampl a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_83__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_83__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__lde_ppampl_type__lde_ppampl
...
(declare-const dw1000__register_types__lde_ppampl_type__lde_ppampl__first__bit Int)

(declare-const dw1000__register_types__lde_ppampl_type__lde_ppampl__last__bit Int)

(declare-const dw1000__register_types__lde_ppampl_type__lde_ppampl__position Int)

;; dw1000__register_types__lde_ppampl_type__lde_ppampl__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__lde_ppampl_type__lde_ppampl__first__bit))

;; dw1000__register_types__lde_ppampl_type__lde_ppampl__last__bit_axiom
  (assert
  (< dw1000__register_types__lde_ppampl_type__lde_ppampl__first__bit
  dw1000__register_types__lde_ppampl_type__lde_ppampl__last__bit))

;; dw1000__register_types__lde_ppampl_type__lde_ppampl__position_axiom
  (assert
  (<= 0 dw1000__register_types__lde_ppampl_type__lde_ppampl__position))

(declare-fun user_eq5 (us_rep us_rep) Bool)

(declare-const dummy5 us_rep)

(declare-datatypes ((lde_ppampl_type__ref 0))
(((mk_lde_ppampl_type__ref (lde_ppampl_type__content us_rep)))))
(define-fun lde_ppampl_type__ref___projection ((a lde_ppampl_type__ref)) us_rep
  (lde_ppampl_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_200__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_141__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_141__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6640 us_t1)
  (temp___is_init_6637 Bool) (temp___skip_constant_6638 Bool)
  (temp___do_toplevel_6639 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6638 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6640)
                                       (last3 temp___expr_6640))
                                       (and (= (first3 temp___expr_6640) 1)
                                       (= (last3 temp___expr_6640) 2)))))
