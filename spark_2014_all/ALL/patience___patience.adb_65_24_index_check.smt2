...
(declare-fun o51 () (Array Int cardindex))
...
(declare-fun o54 () cardindex)

(declare-fun o55 () Int)

(declare-fun o56 () (Array Int cardindex))

(declare-fun o57 () Int)

(declare-fun o58 () (Array Int (Array Int cardindex)))
...
;; H
  (assert (and (<= 0 (int__content i8)) (<= (int__content i8) 99)))

;; H
  (assert (= o45 (int__content i8)))

;; H
  (assert
  (= o46 (select (rec__patience__state__stacksizes s__split_fields10)
  o45)))
...
;; H
  (assert (= result11 stackisize6))

;; H
  (assert (= stackisize8 o47))

;; H
  (assert (and (= o48 (+ stackisize8 1)) (in_range3 (+ stackisize8 1))))

;; H
  (assert (= (to_rep1 o49) o48))

;; H
  (assert (and (<= 0 (int__content i8)) (<= (int__content i8) 99)))

;; H
  (assert (= o50 (int__content i8)))

;; H
  (assert
  (= o51 (store (rec__patience__state__stacksizes s__split_fields10)
  o50 o49)))

;; H
  (assert
  (= o52 (mk___split_fields (rec__patience__state__numelts s__split_fields10)
         (rec__patience__state__values s__split_fields10)
         (rec__patience__state__numstacks s__split_fields10) o51
...
;; H
  (assert (= temp___593 (mk___rep o52)))

;; H
  (assert (= result12 (mk___split_fields__ref s__split_fields10)))

;; H
  (assert (= s__split_fields11 (us_split_fields1 temp___593)))

;; H
  (assert (and (= o53 idx1) (in_range3 idx1)))

;; H
  (assert (= (to_rep1 o54) o53))

;; H
  (assert (and (<= 0 stackisize8) (<= stackisize8 99)))

;; H
  (assert (= o55 stackisize8))

;; H
  (assert
  (= o56 (store (select (rec__patience__state__stacks s__split_fields11)
  (int__content i8)) o55 o54)))

;; H
  (assert (and (<= 0 (int__content i8)) (<= (int__content i8) 99)))

;; H
  (assert (= o57 (int__content i8)))

;; H
  (assert
  (= o58 (store (rec__patience__state__stacks s__split_fields11) o57
  o56)))

;; H
  (assert
  (= o59 (mk___split_fields (rec__patience__state__numelts s__split_fields11)
         (rec__patience__state__values s__split_fields11)
         (rec__patience__state__numstacks s__split_fields11)
         (rec__patience__state__stacksizes s__split_fields11) o58
         (rec__patience__state__posstack s__split_fields11)
         (rec__patience__state__posheight s__split_fields11)
         (rec__patience__state__preds s__split_fields11))))

;; H
  (assert (= temp___598 (mk___rep o59)))

;; H
  (assert (= result13 (mk___split_fields__ref s__split_fields11)))

;; H
  (assert (= s__split_fields12 (us_split_fields1 temp___598)))

;; H
  (assert (and (= o60 (int__content i8)) (in_range3 (int__content i8))))
