...
;; H
  (assert
  (= (to_rep1 (first2 (rt1 (dyn__x__aggregate_def 48 r3b r3b)))) r3b))

;; H
  (assert (= (to_rep1 (last2 (rt1 (dyn__x__aggregate_def 48 r3b r3b))))
  r3b))
...
;; WP_parameter_def
 ;; File "dyn.adb", line 2, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___1831)) (to_rep1 (last2 temp___1831)))
     (+ (- (to_rep1 (last2 temp___1831)) (to_rep1 (first2 temp___1831))) 1)
