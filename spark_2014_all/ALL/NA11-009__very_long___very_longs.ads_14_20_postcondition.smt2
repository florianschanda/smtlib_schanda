...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___812 temp1)))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (and (= result____split_discrs (mk___split_discrs temp___809))
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___8091 temp___8092))))))
...
;; H
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___811) (select temp___8091 temp___811))))))
