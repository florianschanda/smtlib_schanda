...
;; range_axiom
  (assert
  (forall ((x count)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-fun unmatched_g1_set__split_fields () count)
