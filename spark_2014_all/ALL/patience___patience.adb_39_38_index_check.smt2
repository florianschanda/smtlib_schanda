...
;; H
  (assert (= result8 (ite (<= 0 o26) true false)))
...
;; H
  (assert (=> (= result8 true) (= o22 (select s__split_fields5 o21))))

;; H
  (assert (=> (= result8 true) (= o23 (to_rep1 o22))))

;; H
  (assert
  (=> (= result8 true)
  (= result7 (ite (< o23 (to_rep1 s__split_fields2)) true false))))
...
;; H
  (assert (=> (= result7 true) (= o20 (to_rep1 o19))))

;; H
  (assert (=> (= result7 true) (= result6 (ite (<= 0 o20) true false))))
...
;; H
  (assert (=> (= result6 true) (= o13 (select s__split_fields5 o12))))

;; H
  (assert (=> (= result6 true) (= temp___544 (to_rep1 o13))))

;; H
  (assert (=> (= result6 true) (and (<= 0 temp___544) (<= temp___544 99))))

;; H
  (assert (=> (= result6 true) (= o14 temp___544)))

;; H
  (assert (=> (= result6 true) (= o15 (select s__split_fields3 o14))))
...
;; H
  (assert (=> (= result6 true) (= o11 (select s__split_fields6 o10))))

;; H
  (assert (=> (= result6 true) (= o17 (to_rep1 o11))))
