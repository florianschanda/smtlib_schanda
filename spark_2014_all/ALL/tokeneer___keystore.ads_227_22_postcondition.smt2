...
(declare-const temp___1194 us_t1)
...
;; H
  ...
  (=> (= (select issystem retval1) true)
  (=> (= result4 true)
  (and (= temp___1193 (length thestring)) (in_range1 (length thestring))))))
...
;; H
  ...
  (=> (<= 1 temp___1193)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1193) (<= temp___1193 150)))))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (= result4 true) (= o17 result__2))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (= result4 true) (= temp___1194 (mk___t1 o17 (mk1 1 temp___1193))))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first2 (rt1 temp___1191))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first2 (rt1 temp___1194))) (to_rep1
                                                      (last2
                                                      (rt1 temp___1194))))
        (+ (- (to_rep1 (last2 (rt1 temp___1194))) (to_rep1
                                                  (first2 (rt1 temp___1194)))) 1)
        0)))))
...
;; H
  ...
  (= (select o18 temp___1196) (select (elts1 temp___1195) temp___1196))
  (= (select o18 temp___1196) (select result__2 temp___1196)))))))
...
;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (not (= result4 true)) (= o19 (elts temp___1190)))))
...
;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (not (= result4 true)) (= result__4 o19))))
