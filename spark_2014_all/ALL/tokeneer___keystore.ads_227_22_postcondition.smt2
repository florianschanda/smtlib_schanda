...
(declare-fun dummy11 () keylengtht)
...
(declare-fun dummy12 () algorithmt)
...
(declare-datatypes ()
((keypartt__ref (mk_keypartt__ref (keypartt__content us_rep1)))))
...
(define-fun us_split_fields_Owner2__projection ((a us_split_fields4)) us_rep
...
(declare-fun keystore__optionalprivatekeyt__ispresent__first__bit () Int)

(declare-fun keystore__optionalprivatekeyt__ispresent__last__bit () Int)

(declare-fun keystore__optionalprivatekeyt__ispresent__position () Int)
...
(declare-fun keystore__optionalprivatekeyt__owner__first__bit () Int)

(declare-fun keystore__optionalprivatekeyt__owner__last__bit () Int)

(declare-fun keystore__optionalprivatekeyt__owner__position () Int)
...
(declare-fun theowner () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun thekey () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun ispublic () Bool)
...
(define-fun to_int3 ((x maskt)) Int (bv2nat (to_rep8 x)))
...
(define-fun us_split_fields_KeyID2__projection ((a us_split_fields6)) unsigned32t
  (rec__keystore__interfac__keytemplatet__keyid a))

(define-fun us_split_fields_KeyLength2__projection ((a us_split_fields6)) unsigned32t
...
(declare-datatypes ()
((keytemplatet__ref (mk_keytemplatet__ref (keytemplatet__content us_rep3)))))
...
(declare-fun dummy17 () returnvaluet)
...
(declare-datatypes ()
((t155b__ref (mk_t155b__ref (t155b__content integer)))))
...
(declare-datatypes () ((t156b__ref (mk_t156b__ref (t156b__content us_t1)))))
...
(declare-fun added () Bool)

(declare-fun thistisinfo__split_fields () Bool)

(declare-fun thistisinfo__split_fields1 () issueridt)

(declare-fun thistisinfo__split_fields2 () namecountt)

(declare-fun thistisinfo__split_fields3 () (Array Int character))

(declare-fun thekeytemplate__split_fields () maskt)

(declare-fun thekeytemplate__split_fields1 () issueridt)

(declare-fun thekeytemplate__split_fields2 () namecountt)

(declare-fun thekeytemplate__split_fields3 () (Array Int character))

(declare-fun thekeytemplate__split_fields4 () unsigned32t)

(declare-fun thekeytemplate__split_fields5 () unsigned32t)

(declare-fun thekeytemplate__split_fields6 () Bool)

(declare-fun retval () Int)

(declare-fun c151b () (Array Int character))

(declare-fun result__ () (Array Int character))

(declare-fun o () unsigned32t)

(declare-fun o1 () unsigned32t)

(declare-fun o2 () maskt)

(declare-fun o3 () maskt)

(declare-fun o4 () issueridt)

(declare-fun o5 () namecountt)

(declare-fun o6 () (Array Int character))

(declare-fun o7 () unsigned32t)

(declare-fun o8 () unsigned32t)

(declare-fun o9 () Bool)

(declare-fun temp___1185 () maskt)

(declare-fun temp___11851 () issueridt)

(declare-fun temp___11852 () namecountt)

(declare-fun temp___11853 () (Array Int character))

(declare-fun temp___11854 () unsigned32t)

(declare-fun temp___11855 () unsigned32t)

(declare-fun temp___11856 () Bool)
...
(declare-fun keystore__addkey__B153b__thestring__assume () us_t)

(declare-fun o16 () Int)

(declare-fun temp___1191 () us_t1)

(declare-fun temp___1195 () us_t1)

(declare-fun o17 () (Array Int character))

(declare-fun temp___1190 () us_t)
...
(declare-fun thistisinfo__split_fields4 () us_split_fields4)

(declare-fun c151b1 () (Array Int character))

(declare-fun result__1 () (Array Int character))

(declare-fun result () us_split_fields__ref3)

(declare-fun thekeytemplate__split_fields7 () us_split_fields6)
...
(declare-fun added1 () Bool)

(declare-fun result2 () us_split_fields__ref2)

(declare-fun thistisinfo__split_fields5 () us_split_fields4)
...
(declare-fun c151b2 () (Array Int character))
...
(declare-fun added2 () bool__ref)

(declare-fun store2 () us_private__ref)

(declare-fun thistisinfo__split_fields6 () us_split_fields__ref2)

(declare-fun thekeytemplate__split_fields8 () us_split_fields__ref3)

(declare-fun retval2 () int__ref)

(declare-fun c151b3 () map__ref)
...
(declare-fun added3 () Bool)

(declare-fun store3 () us_private)

(declare-fun thistisinfo__split_fields7 () us_split_fields4)

(declare-fun thekeytemplate__split_fields9 () us_split_fields6)

(declare-fun retval3 () Int)

(declare-fun c151b4 () (Array Int character))
...
;; H
  ...
  (= result (mk___split_fields__ref3
            (mk___split_fields3 thekeytemplate__split_fields
            (mk___rep
            (mk___split_fields thekeytemplate__split_fields1
            thekeytemplate__split_fields2 thekeytemplate__split_fields3))
            thekeytemplate__split_fields4 thekeytemplate__split_fields5
...
;; H
  ...
  (= result2 (mk___split_fields__ref2
             (mk___split_fields2 thistisinfo__split_fields
             (mk___rep
             (mk___split_fields thistisinfo__split_fields1
             thistisinfo__split_fields2 thistisinfo__split_fields3)))))))
...
;; H
  (assert (=> (= (select issystem retval1) true) (= retval1 c149b)))

;; H
  (assert (=> (= (select issystem retval1) true) (in_range12 c149b)))

;; H
  (assert
  (=> (= (select issystem retval1) true) (= result3 (mk_map__ref result__))))

;; H
  (assert
  (=> (= (select issystem retval1) true) (= result__2 nodescription)))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=>
...
;; H
  (assert
  (=> (= (select issystem retval1) true) (=> (not (<= 1 33)) (= o11 0))))

;; H
  (assert (=> (= (select issystem retval1) true) (= o12 (+ o11 o10))))

;; H
  (assert (=> (= (select issystem retval1) true) (= o13 (+ 1 o12))))

;; H
  (assert (=> (= (select issystem retval1) true) (= o14 (- o13 1))))

;; H
  (assert
  (=> (= (select issystem retval1) true) (and (= o15 o14) (in_range2 o14))))
...
;; H
  (assert
  (=> (= (select issystem retval1) true)
  (= keystore__addkey__B153b__thestring__assume thestring)))

;; H
  (assert
  (=> (= (select issystem retval1) true) (dynamic_invariant thestring true
  false true)))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (and (= o16 (length thestring)) (in_range1 (length thestring)))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (= result4 (ite (<= o16 150) true false))))
...
;; H
  ...
  (=> (= (select issystem retval1) true)
  (=> (= result4 true)
  (= (ite (<= (to_rep1 (first2 (rt1 temp___1191))) (to_rep1
                                                   (last2 (rt1 temp___1191))))
     (+ (- (to_rep1 (last2 (rt1 temp___1191))) (to_rep1
                                               (first2 (rt1 temp___1191)))) 1)
...
;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (= result4 true) (= temp___1195 temp___1191))))
...
;; H
  ...
  (ite (and (<= 1 temp___1196) (<= temp___1196 (length thestring)))
  (= (select o17 temp___1196) (select (elts1 temp___1195) temp___1196))
  (= (select o17 temp___1196) (select result__2 temp___1196)))))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (= result4 true) (= result5 (mk_map__ref result__2)))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (= result4 true) (= result__3 o17))))
...
;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (not (= result4 true)) (= temp___1190 thestring))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (not (= result4 true)) (= o18 (elts temp___1190)))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (not (= result4 true)) (= result6 (mk_map__ref result__2)))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (not (= result4 true)) (= result__4 o18))))

;; H
  (assert
  (=> (= (select issystem retval1) true)
  (=> (not (= result4 true)) (= result__3 result__4))))

;; H
  (assert
  (=> (= (select issystem retval1) true) (= result7 (mk_map__ref c151b))))

;; H
  (assert (=> (= (select issystem retval1) true) (= c151b2 result__3)))
...
;; H
  (assert
  (=> (not (= (select issystem retval1) true)) (= result__3 result__)))

;; H
  (assert (=> (not (= (select issystem retval1) true)) (= c151b2 c151b)))
...
;; H
  (assert
  (=> (not (= (select issystem retval1) true)) (= filestate2 filestate)))

;; H
  (assert
  (=> (not (= (select issystem retval1) true)) (= result__3 result__1)))

;; H
  (assert (=> (not (= (select issystem retval1) true)) (= c151b2 c151b1)))
...
;; H
  (assert
  (=> (not (= (select issystem retval1) true)) (= filestate2 filestate1)))

;; H
  (assert (= result__5 (mk_map__ref result__3)))

;; H
  (assert (= c151b3 (mk_map__ref c151b2)))
...
;; H
  (assert
  (= thekeytemplate__split_fields8 (mk___split_fields__ref3
                                   thekeytemplate__split_fields7)))

;; H
  (assert
  (= thistisinfo__split_fields6 (mk___split_fields__ref2
                                thistisinfo__split_fields5)))
...
;; H
  (assert (= result__6 result__3))

;; H
  (assert (= c151b4 c151b2))
...
;; WP_parameter_def
 ;; File "keystore.adb", line 714, characters 0-0
  (not
  (ite (= (ite (= (ite (= (bool__content added2) true) (ite (= ispublic false)
                                                       (privatekeypresent
                                                       (us_split_fields__content2
                                                       thistisinfo__split_fields6)) false) false) false)
          (ite (= (bool__content added2) true) (ite (= ispublic false) false (=
                                               (to_int2
                                               (privatekeypresent
                                               (us_split_fields__content2
                                               thistisinfo__split_fields6)))
                                               (to_int2
                                               (privatekeypresent
                                               (mk___split_fields2
          ...
          (to_int2
          (privatekeypresent
          (us_split_fields__content2 thistisinfo__split_fields6))) (to_int2
                                                                   (privatekeypresent
                                                                   (mk___split_fields2
                                                                   thistisinfo__split_fields
                                                                   (mk___rep
                                                                   ...
                                                                   thistisinfo__split_fields1
                                                                   thistisinfo__split_fields2
                                                                   thistisinfo__split_fields3))))))) true) true)
  (ite (= (ite (= (ite (= (bool__content added2) true) (ite (= ispublic false)
                                                       (privatekeypresent
                                                       (us_split_fields__content2
                                                       thistisinfo__split_fields6)) false) false) true)
          (ite (= (bool__content added2) true) (ite (= ispublic false) false (=
                                               (to_int2
                                               (privatekeypresent
                                               (us_split_fields__content2
          ...
          (us_split_fields__content2 thistisinfo__split_fields6))) (to_int2
                                                                   ...
                                                                   thistisinfo__split_fields1
                                                                   thistisinfo__split_fields2
                                                                   thistisinfo__split_fields3))))))) false) false) true true) true)))
(check-sat)
(exit)
