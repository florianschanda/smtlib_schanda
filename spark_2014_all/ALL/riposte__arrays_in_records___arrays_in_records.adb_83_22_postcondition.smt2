...
(declare-const temp___227 index)

(declare-const temp___2271 (Array Int value))

(declare-const temp___2272 (Array Int value))
...
(declare-const temp___230 index)

(declare-const temp___2301 (Array Int value))

(declare-const temp___2302 (Array Int value))
...
;; H
  (assert (= temp___227 a__split_fields3))

;; H
  (assert (= temp___2271 a__split_fields4))

;; H
  (assert (= temp___2272 a__split_fields5))
...
;; H
  (assert (= temp___230 o7))

;; H
  (assert (= temp___2301 o8))

;; H
  (assert (= temp___2302 o9))
...
;; H
  (assert (= temp___230 a__split_fields6))

;; H
  (assert (= temp___2301 a__split_fields7))

;; H
  (assert (= temp___2302 a__split_fields8))
...
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 66, characters 0-0
  (not (= (to_rep (select a__split_fields10 17)) 42)))
(check-sat)
(exit)
