...
;; H
  ...
  (and (and (= result9 i15) (= i1 temp___263))
  ...
  (and (= result8 e16) (= e2 o2))) (in_range1 e2))
  (or
  (and
  (and
  (and
  ...
  (and
  (and (and (= result9 i15) (= i1 (to_rep (first (rt a)))))
...
;; H
  (assert
  (=> (= (int__content dynamic_ranges__search_0__nested__result16) 0)
  (= (= result7 true)
  (forall ((i16 Int))
...
;; H
  (assert
  (=> (not (= (int__content dynamic_ranges__search_0__nested__result16) 0))
  (= result7 false)))
