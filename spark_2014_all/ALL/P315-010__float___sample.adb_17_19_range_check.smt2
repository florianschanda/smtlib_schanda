...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) 340282326356119256160033759537265639424.0)))
...
(define-fun dynamic_invariant4 ((temp___expr_159 t) (temp___is_init_156 Bool)
  (temp___skip_constant_157 Bool)
  (temp___do_toplevel_158 Bool)) Bool (=>
                                      (or (= temp___is_init_156 true) (le
                                      (neg fliteral1) fliteral4)) (in_range5
                                      temp___expr_159)))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 200.0)))

(define-fun in_range6 ((x t)) Bool (and (tqtisFinite x)
                                   (and (le fliteral2 x) (le x fliteral5))))
...
(define-fun dynamic_invariant5 ((temp___expr_165 t) (temp___is_init_162 Bool)
  (temp___skip_constant_163 Bool)
  (temp___do_toplevel_164 Bool)) Bool (=>
                                      (or (= temp___is_init_162 true) (le
                                      fliteral2 fliteral5)) (in_range6
                                      temp___expr_165)))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 50.0)))

(define-fun in_range7 ((x t)) Bool (and (tqtisFinite x)
                                   (and (le fliteral2 x) (le x fliteral6))))
...
(define-fun dynamic_invariant6 ((temp___expr_171 t) (temp___is_init_168 Bool)
  (temp___skip_constant_169 Bool)
  (temp___do_toplevel_170 Bool)) Bool (=>
                                      (or (= temp___is_init_168 true) (le
                                      fliteral2 fliteral6)) (in_range7
                                      temp___expr_171)))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral7) (/ 500000000000000000000000.0 1000000000000000000000000.0))))
...
;; H
  (assert (tqtisFinite time))

;; H
  (assert
  (and
  (and (and (< 0 nb_of_pp) (lt fliteral2 delta_time)) (le
  (mul RNE1 (mul RNE1 fliteral7 (of_int RNE1 (+ nb_of_fp nb_of_pp)))
  delta_time) time)) (le time fliteral4)))

;; H
  (assert (=> (le fliteral2 fliteral3) (in_range3 d)))

;; H
  (assert (=> (le (neg fliteral1) fliteral4) (in_range5 t_fp)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite t_pp)))

;; H
  (assert (=> (le fliteral2 fliteral5) (in_range6 tmp1)))

;; H
  (assert (=> (le fliteral2 fliteral6) (in_range7 tmp2)))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref d)))

;; H
  (assert (= d1 (mul RNE1 (of_int RNE1 (+ nb_of_fp nb_of_pp)) delta_time)))

;; H
  (assert
  (and (= o (sub RNE1 time (div1 RNE1 d1 fliteral8))) (tqtisFinite
  (sub RNE1 time (div1 RNE1 d1 fliteral8)))))
