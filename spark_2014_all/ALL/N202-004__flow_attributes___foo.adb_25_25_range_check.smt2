...
(declare-fun tmp__first () integer)

(declare-fun tmp__last () integer)
...
;; temp___String_Literal_247__def_axiom
  ...
  (! (and
     (and
     (= (to_rep (select (temp___String_Literal_247 us_void_param) 1)) 102)
     (= (to_rep (select (temp___String_Literal_247 us_void_param) 2)) 111))
     (= (to_rep (select (temp___String_Literal_247 us_void_param) 3)) 111)) :pattern (
...
;; H
  ...
  (= o1 (+ (- (to_rep1 (last (rt a))) (to_rep1 (first (rt a)))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a))))) (= o1 0)))
