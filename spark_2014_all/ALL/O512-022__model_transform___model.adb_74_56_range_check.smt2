...
(declare-fun o7 () uml_state_access)

(declare-fun o8 () uml_state_access)
...
;; H
  (assert
  (=> (and (<= 0 s2) (<= s2 100))
  (and (= o1 (name o19)) (and (in_range1 o1) (= o1 (to_rep o))))))
...
;; H
  ...
  (and (in_range4 o13)
  (= o13 (to_rep2
         (rec__model__uml_control_flow__to_data (us_split_fields9 o12)))))))
...
;; H
  ...
  (and (= o16 (name o10))
  (and (in_range1 o16)
  (= o16 (to_rep (rec__model__uml_state__name_data (us_split_fields1 o10)))))))
