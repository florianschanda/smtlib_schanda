...
(declare-fun user_eq5 (tT12bP1 tT12bP1) Bool)

(declare-const dummy5 tT12bP1)

(declare-datatypes ((tT12bP1__ref 0))
(((mk_tT12bP1__ref (tT12bP1__content tT12bP1)))))
(define-fun tT12bP1__ref___projection ((a tT12bP1__ref)) tT12bP1 (tT12bP1__content
                                                                 a))
...
(define-fun us_split_fields_M_Nodes__2__projection ((a us_split_fields2)) (Array Int integer)
...
(declare-datatypes ((tbS__ref 0)) (((mk_tbS__ref (tbS__content us_rep1)))))
(define-fun tbS__ref___projection ((a tbS__ref)) us_rep1 (tbS__content a))

(define-fun dynamic_invariant2 ((temp___expr_195 us_rep1)
...
(declare-const temp___m_height_204 Int)

;; H
  (assert (in_range temp___m_height_204))

(assert
;; WP_parameter_def
 ;; File "main.adb", line 13, characters 0-0
  (not (in_range 7)))
(check-sat)
(exit)
