...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o3 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o4) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o3 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o4) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o3 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o4) k))))))))))))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o1 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o2) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o1 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o2) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o1 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o2) k))))))))))))
