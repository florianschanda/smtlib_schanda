...
(((mk_t57b__ref (t57b__content integer)))))
...
(declare-datatypes ((t58b__ref 0)) (((mk_t58b__ref (t58b__content us_t1)))))
...
(declare-const auditlog__updateendtimefromfile__overwritetimeintext__R55b__assume Int)

(declare-const auditlog__updateendtimefromfile__overwritetimeintext__R56b__assume Int)

(declare-const o (Array Int character))

(declare-const temp___1344 (Array Int character))

(declare-const temp___13441 t1)
...
;; H
  (assert
  (=> (<= r55b r56b)
  (and (and (<= 1 r55b) (<= r55b 150)) (and (<= 1 r56b) (<= r56b 150)))))

;; H
  (assert (= o description))

;; H
  (assert (= o temp___1344))

;; H
  (assert (= (mk1 r55b r56b) temp___13441))

;; H
  (assert
  (= (ite (<= (to_rep1 (first2 temp___13441)) (to_rep1 (last2 temp___13441)))
     (+ (- (to_rep1 (last2 temp___13441)) (to_rep1 (first2 temp___13441))) 1)
     0) (ite (<= 1 21) (+ (- 21 1) 1) 0)))

;; H
  (assert (= o1 (slide temp___1344 (to_rep1 (first2 temp___13441)) 1)))
