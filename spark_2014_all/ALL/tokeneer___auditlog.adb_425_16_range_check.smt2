...
(declare-fun firsttime () (Array Int character))
...
(declare-fun temp___1344 () (Array Int character))

(declare-fun temp___13441 () t1)
...
(declare-fun firsttime1 () (Array Int character))
