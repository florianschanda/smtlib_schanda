...
(declare-const temp___213 status)

(declare-const temp___2131 natural)

(declare-const temp___2132 natural)

(declare-const temp___2133 Bool)

(declare-const temp___2134 Bool)
...
;; H
  (assert (= (to_rep1 x__split_discrs) r38b))

;; H
  (assert (in_range2 r38b))
...
;; H
  (assert (= temp___2133 o4))

;; H
  (assert (= true temp___2134))
...
;; WP_parameter_def
 ;; File "definite.adb", line 107, characters 0-0
  (not (= temp___213 x__split_discrs)))
(check-sat)
(exit)
