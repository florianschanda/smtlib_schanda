...
(define-fun default_initial_assumption2 ((temp___expr_355 us_rep4)
  (temp___skip_top_level_356 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_356 true))
                                         (= (is_empty1 temp___expr_355) true)))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (= (contains (model__ container1) (get1 result temp___423)) true))))
     (forall ((item Int))
...
(define-fun dynamic_invariant4 ((temp___expr_348 Int)
...
(declare-const temp___1206 count_type)
...
;; H
  (assert (= temp___1206 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1206)) no_element))
