...
;; H
  ...
  (ite (< k1 q2) (= (to_rep1 (select h1 k1)) (to_rep1 (select h (+ k1 m1))))
  (ite (< (+ q2 m1) k1)
  (= (to_rep1 (select h1 k1)) (to_rep1 (select h (- k1 m1))))
  (= (to_rep1 (select h1 k1)) (to_rep1 (select h k1))))))))
...
;; H
  (assert
  (and (<= (to_rep h__first) (- k m1)) (<= (- k m1) (to_rep h__last))))
