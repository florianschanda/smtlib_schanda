...
(declare-const temp___6628 et1)

(declare-const temp___66281 et2)
...
;; H
  (assert (= temp___6628 o1))

;; H
  (assert (= temp___66281 o2))
...
;; H
  (assert (= temp___6628 r__split_fields4))

;; H
  (assert (= temp___66281 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 747, characters 0-0
  (not
  (= (bool_eq
