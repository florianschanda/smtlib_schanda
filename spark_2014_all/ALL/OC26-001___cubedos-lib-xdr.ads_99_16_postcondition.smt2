...
(declare-fun dummy1 () xdr_unsigned)
...
(declare-fun user_eq2 (xdr_boolean xdr_boolean) Bool)

(declare-fun dummy2 () xdr_boolean)

(declare-datatypes ()
((xdr_boolean__ref (mk_xdr_boolean__ref (xdr_boolean__content xdr_boolean)))))
(define-fun xdr_boolean__ref___projection ((a xdr_boolean__ref)) xdr_boolean
...
(declare-fun temporary () (_ BitVec 32))

(declare-fun result () (_ BitVec 32))

(declare-fun temporary1 () (_ BitVec 32))

(declare-fun result1 () (_ BitVec 32))

(declare-fun temporary2 () (_ BitVec 32))
...
(declare-fun temporary3 () (_ BitVec 32))

(declare-fun data2 () (Array Int octet))

(declare-fun last5 () Int)

(declare-fun temporary4 () (_ BitVec 32))

(define-fun temporary5 () t__ref (mk_t__ref temporary))
...
;; H
  (assert (=> (= value 0) (= (mk_t__ref result) temporary5)))

;; H
  (assert (=> (= value 0) (= temporary1 ((_ int2bv 32) 0))))

;; H
  (assert (=> (not (= value 0)) (= (mk_t__ref result1) temporary5)))

;; H
  (assert (=> (not (= value 0)) (= temporary2 ((_ int2bv 32) 1))))

;; H
  (assert (=> (not (= value 0)) (= temporary1 temporary2)))

;; H
  (assert (and (= last3 (+ position 3)) (in_range3 last3)))

;; H
  (assert (= temporary1 temporary3))
...
(assert
;; WP_parameter_def
 ;; File "cubedos-lib-xdr.ads", line 73, characters 0-0
  (not (= last4 (+ position 3))))
(check-sat)
(exit)
