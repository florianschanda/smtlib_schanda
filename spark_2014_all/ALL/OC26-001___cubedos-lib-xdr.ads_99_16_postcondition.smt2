...
(declare-const dummy2 xdr_boolean)
...
(declare-const temporary (_ BitVec 32))

(declare-const result (_ BitVec 32))

(declare-const temporary1 (_ BitVec 32))

(declare-const result1 (_ BitVec 32))

(declare-const temporary2 (_ BitVec 32))
...
(declare-const temporary3 (_ BitVec 32))

(declare-const data2 (Array Int octet))

(declare-const last5 Int)

(declare-const temporary4 (_ BitVec 32))
