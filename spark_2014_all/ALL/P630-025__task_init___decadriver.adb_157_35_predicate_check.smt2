...
(declare-fun dummy2 () frame_length)
...
(declare-fun dummy5 () (Array Int bits_8))
...
(declare-fun dummy7 () rx_frame_queue_index)
...
(define-fun bool_eq8 ((a (Array (_ BitVec 8) us_rep)) (a__first (_ BitVec 8))
  ...
  (b__last (_ BitVec 8))) Bool (ite (and
                                    ...
                                    (= (bool_eq6 (select a temp___idx_183)
...
(declare-fun o11 () (Array (_ BitVec 8) us_rep))

(declare-fun o12 () rx_frame_queue_index)
...
(declare-fun o16 () frame_length)

(declare-fun o17 () frame_length)

(declare-fun o18 () (Array Int bits_8))

(declare-fun o19 () rx_errors)
...
(declare-fun o22 () (Array Int bits_8))

(declare-fun o23 () rx_errors)

(declare-fun o24 () Bool)

(declare-fun o25 () (Array (_ BitVec 8) us_rep))

(declare-fun o26 () (Array (_ BitVec 8) us_rep))

(declare-fun o27 () rx_frame_queue_index)
...
(declare-fun o31 () (Array (_ BitVec 8) us_rep))

(declare-fun o32 () rx_frame_queue_index)
...
(declare-fun o36 () rx_errors)

(declare-fun o37 () frame_length)

(declare-fun o38 () (Array Int bits_8))

(declare-fun o39 () rx_errors)
...
(declare-fun result1 () receiver_type__ref)

(declare-fun self__5 () us_rep1)

(declare-fun result2 () receiver_type__ref)
...
;; H
  (assert
  (= o25 (store (rec__decadriver__receiver_type__frame_queue
                (us_split_fields3 self__5)) next_idx1 o41)))
...
;; H
  (assert
  (= (rec__decadriver__receiver_type__queue_head (us_split_fields3 self__5)) 
  o27))

;; H
  (assert
  (= (rec__decadriver__receiver_type__rx_count (us_split_fields3 self__5)) 
  o28))

;; H
  (assert
  (= (rec__decadriver__receiver_type__overrun_occurred
     (us_split_fields3 self__5)) o29))

;; H
  (assert
  (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 self__5)) 
  o30))
...
;; H
  ...
  (= (rec__decadriver__rx_frame_type__size
     (us_split_fields1
     (select (rec__decadriver__receiver_type__frame_queue
             (us_split_fields3 self__6)) next_idx1))) o37))
...
;; H
  ...
  (= (rec__decadriver__rx_frame_type__frame
     (us_split_fields1
     (select (rec__decadriver__receiver_type__frame_queue
             (us_split_fields3 self__6)) next_idx1))) o38))
...
;; WP_parameter_def
 ;; File "decadriver.ads", line 77, characters 0-0
  ...
  (mk___rep
  (mk___split_fields temp___4593 temp___45931 temp___45932 temp___45933)))))
(check-sat)
