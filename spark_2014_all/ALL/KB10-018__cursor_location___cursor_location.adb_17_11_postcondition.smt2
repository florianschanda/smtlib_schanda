...
(declare-fun du_available () (Array Int Bool))

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun cursor_location__none_available__result () Bool)

(declare-fun result () Bool)

(declare-fun cursor_location__none_available__result1 () Bool)

(declare-fun cursor_location__none_available__result2 () Bool)

(declare-fun cursor_location__none_available__result3 () Bool)

(declare-fun cursor_location__none_available__result4 () Bool)

(declare-fun cursor_location__none_available__result5 () Bool)

(declare-fun result1 () Bool)

;; H
  (assert
  (= cursor_location__none_available__result1 cursor_location__none_available__result2))

;; H
  (assert
  (= cursor_location__none_available__result3 cursor_location__none_available__result1))

;; H
  (assert
  (= (mk_bool__ref result) (mk_bool__ref
                           cursor_location__none_available__result)))

;; H
  (assert
  (= cursor_location__none_available__result1 (ite (and
                                                   (not
                                                   (= (select du_available 1) true))
                                                   (not
                                                   (= (select du_available 2) true)))
                                              true false)))

;; H
  (assert
  (= (mk_bool__ref cursor_location__none_available__result4) (mk_bool__ref
                                                             cursor_location__none_available__result2)))

;; H
  (assert
  (= cursor_location__none_available__result5 cursor_location__none_available__result3))
