...
(declare-fun dummy3 () scalar_with_default)
...
;; range_axiom
  (assert
  (forall ((x scalar_with_default)) (! (in_range4
...
(declare-fun dummy4 () tscalar_with_defaultB)
...
;; range_axiom
  (assert
  (forall ((x tscalar_with_defaultB)) (! (in_range5
...
(declare-fun dummy5 () tscalar_with_defaultB)
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int scalar_with_default))))))
(declare-fun slide ((Array Int scalar_with_default) Int
  Int) (Array Int scalar_with_default))

;; slide_eq
  (assert
  (forall ((a (Array Int scalar_with_default)))
  (forall ((first2 Int))
...
(declare-fun concat1 ((Array Int scalar_with_default) Int Int
  (Array Int scalar_with_default) Int Int) (Array Int scalar_with_default))

;; concat_def
  (assert
  (forall ((a (Array Int scalar_with_default))
  (b (Array Int scalar_with_default)))
...
(declare-fun singleton1 (scalar_with_default
  Int) (Array Int scalar_with_default))

;; singleton_def
  (assert
  (forall ((v scalar_with_default))
  (forall ((i Int))
  (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i)) ))))

(define-fun bool_eq ((a (Array Int scalar_with_default)) (a__first Int)
  (a__last Int) (b (Array Int scalar_with_default)) (b__first Int)
...
(declare-fun compare ((Array Int scalar_with_default) Int Int
  (Array Int scalar_with_default) Int Int) Int)
...
(define-fun bool_eq1 ((a (Array Int natural)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep (select a temp___idx_135)) (to_rep
...
(declare-datatypes ()
((map__ref2 (mk_map__ref2 (map__content2 (Array Int tscalar_with_defaultB))))))
(declare-fun slide2 ((Array Int tscalar_with_defaultB) Int
...
(declare-fun concat3 ((Array Int tscalar_with_defaultB) Int Int
...
(declare-fun singleton3 (tscalar_with_defaultB
  Int) (Array Int tscalar_with_defaultB))
...
(define-fun bool_eq2 ((a (Array Int tscalar_with_defaultB)) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep3 (select a temp___idx_136)) (to_rep3
...
(declare-fun compare2 ((Array Int tscalar_with_defaultB) Int Int
...
(declare-datatypes ()
((map__ref3 (mk_map__ref3 (map__content3 (Array Int integer))))))
...
(declare-fun concat4 ((Array Int integer) Int Int (Array Int integer) Int
...
(define-fun bool_eq3 ((a (Array Int integer)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep1 (select a temp___idx_137)) (to_rep1
...
(declare-fun compare3 ((Array Int integer) Int Int (Array Int integer) Int
  Int) Int)
...
;; mk_def
  ...
  (! (=> (in_range3 f)
     (=> (in_range3 l)
     (and (= (to_rep1 (first2 (mk f l))) f) (= (to_rep1 (last (mk f l))) l)))) :pattern (
  (mk f l)) )))
...
(define-fun bool_eq4 ((x us_t)
  (y us_t)) Bool (bool_eq3 (elts x) (to_rep1 (first2 (rt x)))
                 (to_rep1 (last (rt x))) (elts y) (to_rep1 (first2 (rt y)))
                 (to_rep1 (last (rt y)))))
...
(define-fun dynamic_invariant1 ((temp___expr_268 (Array Int tscalar_with_defaultB))
  ...
  (temp___do_toplevel_267 Bool)) Bool (forall ((temp___269 Int))
                                      (=>
                                      (and (<= 1 temp___269)
                                      (<= temp___269 0))
                                      (=>
                                      ...
                                      (to_rep3
                                      (select temp___expr_268 temp___269)))))))

(define-fun default_initial_assumption ((temp___expr_270 (Array Int tscalar_with_defaultB))
  (temp___skip_top_level_271 Bool)) Bool (forall ((temp___272 Int))
                                         (=>
                                         (and (<= 1 temp___272)
                                         (<= temp___272 0))
                                         (= (to_rep3
                                            (select temp___expr_270 temp___272)) 0))))

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(define-fun dynamic_invariant2 ((temp___expr_277 (Array Int integer))
  (temp___is_init_274 Bool) (temp___skip_constant_275 Bool)
  (temp___do_toplevel_276 Bool)) Bool (forall ((temp___278 Int))
                                      (=>
                                      (and (<= 1 temp___278)
                                      (<= temp___278 0))
                                      (=>
                                      ...
                                      (to_rep1
                                      (select temp___expr_277 temp___278)))))))

(define-fun default_initial_assumption1 ((temp___expr_279 (Array Int integer))
...
(declare-fun no_def__first () integer)

(declare-fun no_def__last () integer)
...
(declare-fun dummy9 () tTall_0SP1)

(declare-datatypes ()
((tTall_0SP1__ref (mk_tTall_0SP1__ref (tTall_0SP1__content tTall_0SP1)))))
(define-fun tTall_0SP1__ref___projection ((a tTall_0SP1__ref)) tTall_0SP1
  (tTall_0SP1__content a))

(define-fun default_initial_assumption2 ((temp___expr_296 (Array Int scalar_with_default))
  (temp___skip_top_level_297 Bool)) Bool (forall ((temp___298 Int))
                                         (=>
                                         (and (<= 1 temp___298)
                                         (<= temp___298 100))
                                         (= (to_rep2
                                            (select temp___expr_296 temp___298)) 0))))
...
(declare-fun dummy10 () tTall_1SP1)

(declare-datatypes ()
((tTall_1SP1__ref (mk_tTall_1SP1__ref (tTall_1SP1__content tTall_1SP1)))))
(define-fun tTall_1SP1__ref___projection ((a tTall_1SP1__ref)) tTall_1SP1
  (tTall_1SP1__content a))

(define-fun default_initial_assumption3 ((temp___expr_305 (Array Int natural))
  (temp___skip_top_level_306 Bool)) Bool (forall ((temp___307 Int))
                                         (=>
                                         (and (<= 1 temp___307)
                                         (<= temp___307 100))
                                         (= (to_rep
                                            (select temp___expr_305 temp___307)) 1))))
...
(declare-fun dummy11 () tTall_2SP1)

(declare-datatypes ()
((tTall_2SP1__ref (mk_tTall_2SP1__ref (tTall_2SP1__content tTall_2SP1)))))
(define-fun tTall_2SP1__ref___projection ((a tTall_2SP1__ref)) tTall_2SP1
  (tTall_2SP1__content a))

(define-fun dynamic_invariant3 ((temp___expr_311 (Array Int tscalar_with_defaultB))
  (temp___is_init_308 Bool) (temp___skip_constant_309 Bool)
  (temp___do_toplevel_310 Bool)) Bool (forall ((temp___312 Int))
                                      (=>
                                      (and (<= 1 temp___312)
                                      (<= temp___312 100))
                                      (=>
                                      ...
                                      (dynamic_property first 2147483647
                                      (to_rep3
                                      (select temp___expr_311 temp___312)))))))

(define-fun default_initial_assumption4 ((temp___expr_313 (Array Int tscalar_with_defaultB))
  (temp___skip_top_level_314 Bool)) Bool (forall ((temp___315 Int))
                                         (=>
                                         (and (<= 1 temp___315)
                                         (<= temp___315 100))
                                         (= (to_rep3
                                            (select temp___expr_313 temp___315)) 2))))
...
;; def_axiom
  ...
  (forall ((temp___611 Int))
  (= (select (with_default__ok_array__no_def__aggregate_def temp___610) temp___611)
  (of_rep1 temp___610)))))
...
(define-fun dynamic_invariant8 ((temp___expr_232 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_263 us_t)
  (temp___is_init_260 Bool) (temp___skip_constant_261 Bool)
  (temp___do_toplevel_262 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_261 true))
                                      (dynamic_property2 1 2147483647
                                      (first3 temp___expr_263)
                                      (last1 temp___expr_263)))
                                      (forall ((temp___264 Int))
                                      (=>
                                      (and
                                      (<= (first3 temp___expr_263) temp___264)
                                      (<= temp___264 (last1 temp___expr_263)))
                                      (=>
                                      (or (= temp___is_init_260 true)
                                      (<= first1 2147483647))
                                      (dynamic_property1 first1 2147483647
                                      (to_rep1
                                      (select (to_array temp___expr_263) temp___264))))))))

(declare-fun empty1 () (Array Int tscalar_with_defaultB))

(declare-fun empty2 () (Array Int integer))

(declare-fun no_def () (Array Int integer))
...
(declare-fun with_default__ok_array__no_def__assume () (Array Int integer))

(declare-fun with_default__ok_array__no_def__assume1 () t)

(declare-fun o2 () Int)

(declare-fun result () (Array Int integer))

(declare-fun no_def1 () (Array Int integer))
...
;; H
  (assert
  (= (to_rep1 no_def__first) (to_rep1
                             (first2 with_default__ok_array__no_def__assume1))))

;; H
  (assert
  (= (to_rep1 no_def__last) (to_rep1
                            (last with_default__ok_array__no_def__assume1))))

;; H
  (assert
  (and (dynamic_property2 1 2147483647 (to_rep1 no_def__first)
  (to_rep1 no_def__last))
  (forall ((temp___612 Int))
  (=>
  (and (<= (to_rep1 no_def__first) temp___612)
  (<= temp___612 (to_rep1 no_def__last))) (dynamic_property1 first1
  2147483647 (to_rep1 (select no_def1 temp___612)))))))
...
(assert
;; WP_parameter_def
 ;; File "with_default.adb", line 36, characters 0-0
  (not (in_range4 0)))
(check-sat)
(exit)
