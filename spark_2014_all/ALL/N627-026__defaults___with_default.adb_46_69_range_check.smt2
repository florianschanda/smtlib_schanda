...
(((mk_map__ref (map__content (Array Int scalar_with_default))))))
...
(((mk_map__ref2 (map__content2 (Array Int tscalar_with_defaultB))))))
...
(((mk_map__ref3 (map__content3 (Array Int integer))))))
...
(declare-datatypes ((tTall_0SP1__ref 0))
(((mk_tTall_0SP1__ref (tTall_0SP1__content tTall_0SP1)))))
...
(declare-datatypes ((tTall_1SP1__ref 0))
(((mk_tTall_1SP1__ref (tTall_1SP1__content tTall_1SP1)))))
...
(declare-datatypes ((tTall_2SP1__ref 0))
(((mk_tTall_2SP1__ref (tTall_2SP1__content tTall_2SP1)))))
