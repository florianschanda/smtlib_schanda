...
(declare-fun thestats__split_fields () statscount)

(declare-fun thestats__split_fields1 () statscount)

(declare-fun thestats__split_fields2 () statscount)

(declare-fun thestats__split_fields3 () statscount)
...
(declare-fun thestats__split_fields4 () statscount)

(declare-fun thestats__split_fields5 () statscount)

(declare-fun thestats__split_fields6 () statscount)

(declare-fun thestats__split_fields7 () statscount)
...
(declare-fun thestats__split_fields8 () statscount)

(declare-fun thestats__split_fields9 () statscount)

(declare-fun thestats__split_fields10 () statscount)

(declare-fun thestats__split_fields11 () statscount)
...
(declare-fun thestats__split_fields12 () us_split_fields__ref1)
...
(declare-fun thestats__split_fields13 () us_split_fields2)

(define-fun thestats__split_fields14 () us_split_fields2 (mk___split_fields1
                                                         thestats__split_fields8
                                                         thestats__split_fields9
                                                         thestats__split_fields10
                                                         thestats__split_fields11))
...
;; H
  ...
  (= (thedooralarm state11) 0))
  (= (= (islocked state10) true)
  (= (greaterthanorequal (thecurrenttime currenttime)
     (latch_timeout state10)) true)))))
...
;; H
  (assert
  (=> (not (= result true))
  (=> (= result2 true) (= o5 (extractuser state4)))))

;; H
  (assert
  (=> (not (= result true))
  (=> (= result2 true) (= (valid_numberlogentries state15) true))))

;; H
  (assert
  (=> (not (= result true)) (=> (= result2 true) (= result3 status))))
...
;; H
  (assert
  (=> (not (= result true)) (=> (not (= result2 true)) (= state17 state3))))

;; H
  (assert
  (=> (not (= result true)) (=> (not (= result2 true)) (= state16 state))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result2 true)) (= filestate3 filestate))))
...
;; H
  (assert
  (=> (not (= result true)) (=> (not (= result2 true)) (= state17 state8))))

;; H
  (assert
  (=> (not (= result true)) (=> (not (= result2 true)) (= state16 state5))))

;; H
  (assert
  (=> (not (= result true))
  (=> (not (= result2 true)) (= filestate3 filestate1))))

;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields thestats__split_fields8)))

;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields1 thestats__split_fields9)))

;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields2 thestats__split_fields10)))

;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields3 thestats__split_fields11)))
...
;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields4 thestats__split_fields8)))

;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields5 thestats__split_fields9)))

;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields6 thestats__split_fields10)))

;; H
  (assert
  (=> (not (= result true))
  (= thestats__split_fields7 thestats__split_fields11)))
...
;; H
  (assert
  (= thestats__split_fields12 (mk___split_fields__ref1
                              thestats__split_fields14)))
...
;; H
  (assert (= state10 state19))

;; H
  (assert (= state18 state13))

;; H
  (assert (= filestate4 filestate2))

;; H
  (assert (= thestats__split_fields13 thestats__split_fields14))
...
;; H
  (assert
  (= (greaterthanorequal (thecurrenttime currenttime)
     (alarm_timeout (us_private__content state20))) true))

(assert
;; WP_parameter_def
 ;; File "userentry.adb", line 711, characters 0-0
  (not (= (thedooralarm (us_private__content state20)) 0)))
(check-sat)
