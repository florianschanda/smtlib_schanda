...
;; H
  (assert (and (= o9 (+ b_first a_last)) (in_range1 (+ b_first a_last))))

;; H
  (assert (= o10 (- o9 a_first)))
...
;; H
  (assert (= o13 (ite (<= b_first k) o12 false)))

;; H
  (assert (= result1 (ite (not (= o13 true)) true false)))
...
;; H
  (assert (=> (= result1 true) (= o16 k)))

;; H
  (assert (=> (= result1 true) (= o17 (select b o16))))

;; H
  (assert (=> (= result1 true) (= o18 (to_rep1 o17))))
...
;; H
  (assert (=> (= result1 true) (= o14 k)))

;; H
  (assert (=> (= result1 true) (= o15 (select b8 o14))))

;; H
  (assert (=> (= result1 true) (= o19 (to_rep1 o15))))

;; H
  (assert (=> (= result1 true) (= o20 (ite (= o19 o18) true false))))
...
;; H
  (assert
  (and (<= (to_rep (first (rt a))) temp___570)
  (<= temp___570 (to_rep (last (rt a))))))

;; H
  (assert (= o6 temp___570))
