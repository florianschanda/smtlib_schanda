...
(define-fun o12 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o13 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  (assert
  (and
  (= o13 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o13)
