...
;; H
  (assert
  (=> (not (= a__ppcm__result4 0)) (and (= o6 (* a b)) (in_range1 (* a b)))))
...
;; H
  ...
  (= o9 (ite (<= a__ppcm__result4 o8) true false))))

;; H
  (assert
  (=> (not (= a__ppcm__result4 0)) (and (= o5 (abs a)) (in_range1 (abs a)))))

;; H
  (assert
  (=> (not (= a__ppcm__result4 0))
  (= o10 (ite (<= o5 a__ppcm__result4) true false))))

;; H
  (assert
  (=> (not (= a__ppcm__result4 0)) (= result3 (ite (= o10 true) o9 false))))
