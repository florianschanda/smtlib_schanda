...
;; def_axiom
  (assert
  (forall ((temp___4235 (Array Int us_rep)))
  (forall ((temp___4236 Int))
  (forall ((temp___4237 us_rep))
  (let ((temp___4234 (temp___4233 temp___4235 temp___4236 temp___4237)))
  (forall ((temp___4238 Int))
  (ite (= temp___4238 temp___4236)
  (= (select temp___4234 temp___4238) temp___4237)
  (= (select temp___4234 temp___4238) (select temp___4235 temp___4238)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1865, characters 0-0
  (not
  (= (bool_eq2 (select a2 i)
     (mk___rep1
     (mk___split_fields1
     (temp___4233 (rec__ar__rofaofr1__a1 (us_split_fields3 (select a i)))
     j
     (mk___rep
     ...
     (us_split_fields1
     (select (rec__ar__rofaofr1__a1 (us_split_fields3 (select a i)))
     j)))))) (rec__ar__rofaofr1__b1 (us_split_fields3 (select a i)))
     (rec__ar__rofaofr1__c1 (us_split_fields3 (select a i)))))) true)))
(check-sat)
(exit)
