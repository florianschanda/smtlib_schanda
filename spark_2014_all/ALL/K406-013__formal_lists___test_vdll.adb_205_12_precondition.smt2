...
(((mk___split_discrs
  (rec__formal_container__vdll__list__capacity count_type)))))
...
(declare-datatypes ((tl2S__ref 0)) (((mk_tl2S__ref (tl2S__content us_rep)))))
...
(declare-datatypes ((tl3S__ref 0)) (((mk_tl3S__ref (tl3S__content us_rep)))))
...
(declare-datatypes ((tl4S__ref 0)) (((mk_tl4S__ref (tl4S__content us_rep)))))
...
(declare-datatypes ((t7b__ref 0)) (((mk_t7b__ref (t7b__content t7b)))))
...
(declare-const l1__split_fields12 us_split_fields)
