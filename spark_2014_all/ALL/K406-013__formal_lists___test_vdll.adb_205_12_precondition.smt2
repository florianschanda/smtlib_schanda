...
(declare-fun formal_container__vdll__list__capacity__first__bit () Int)

(declare-fun formal_container__vdll__list__capacity__last__bit () Int)

(declare-fun formal_container__vdll__list__capacity__position () Int)
...
(declare-fun formal_container__vdll__cursor__node__first__bit () Int)

(declare-fun formal_container__vdll__cursor__node__last__bit () Int)

(declare-fun formal_container__vdll__cursor__node__position () Int)
...
(declare-fun formal_container__vdll__list__capacity__first__bit1 () Int)

(declare-fun formal_container__vdll__list__capacity__last__bit1 () Int)

(declare-fun formal_container__vdll__list__capacity__position1 () Int)
...
(declare-fun l1__split_discrs () us_split_discrs)
...
(declare-fun formal_container__vdll__list__capacity__first__bit2 () Int)

(declare-fun formal_container__vdll__list__capacity__last__bit2 () Int)

(declare-fun formal_container__vdll__list__capacity__position2 () Int)
...
(declare-fun l2__split_discrs () us_split_discrs)
...
(declare-fun formal_container__vdll__list__capacity__first__bit3 () Int)

(declare-fun formal_container__vdll__list__capacity__last__bit3 () Int)

(declare-fun formal_container__vdll__list__capacity__position3 () Int)
...
(declare-fun l3__split_discrs () us_split_discrs)
...
(declare-fun formal_container__vdll__list__capacity__first__bit4 () Int)

(declare-fun formal_container__vdll__list__capacity__last__bit4 () Int)

(declare-fun formal_container__vdll__list__capacity__position4 () Int)
...
(declare-fun l4__split_discrs () us_split_discrs)
...
(declare-fun l1__split_fields () us_main_type)

(declare-fun l2__split_fields () us_main_type)

(declare-fun l3__split_fields () us_main_type)

(declare-fun l4__split_fields () us_main_type)

(declare-fun c__split_fields () count_type)

(declare-fun e__split_fields () count_type)

(declare-fun e__split_fields1 () count_type)

(declare-fun e__split_fields2 () count_type)

(declare-fun e__split_fields3 () count_type)
...
(declare-fun temp___430 () us_rep)

(declare-fun temp___438 () Int)

(declare-fun temp___437 () us_rep)

(declare-fun formal_container__vdll__insert__container__fields () us_split_fields)

(declare-fun result () us_split_fields__ref)

(declare-fun l1__split_fields1 () us_split_fields)

(declare-fun result1 () us_split_fields__ref)

(declare-fun l2__split_fields1 () us_split_fields)

(declare-fun formal_container__vdll__append__container__fields () us_split_fields)

(declare-fun result2 () us_split_fields__ref)

(declare-fun l2__split_fields2 () us_split_fields)

(declare-fun formal_container__vdll__append__container__fields1 () us_split_fields)

(declare-fun result3 () us_split_fields__ref)

(declare-fun l2__split_fields3 () us_split_fields)

(declare-fun result4 () us_split_fields__ref)

(declare-fun l1__split_fields2 () us_split_fields)
...
(declare-fun formal_container__vdll__delete__container__fields () us_split_fields)

(declare-fun result6 () us_split_fields__ref)

(declare-fun l2__split_fields4 () us_split_fields)

(declare-fun result7 () us_split_fields__ref)

(declare-fun l1__split_fields3 () us_split_fields)

(declare-fun formal_container__vdll__append__container__fields2 () us_split_fields)

(declare-fun result8 () us_split_fields__ref)

(declare-fun l1__split_fields4 () us_split_fields)

(declare-fun result9 () us_split_fields__ref)

(declare-fun l3__split_fields1 () us_split_fields)

(declare-fun formal_container__vdll__delete_last__container__fields () us_split_fields)

(declare-fun result10 () us_split_fields__ref)

(declare-fun l3__split_fields2 () us_split_fields)

(declare-fun result11 () us_split_fields__ref)

(declare-fun l4__split_fields1 () us_split_fields)

(declare-fun formal_container__vdll__delete_last__2__container__fields () us_split_fields)

(declare-fun result12 () us_split_fields__ref)

(declare-fun l4__split_fields2 () us_split_fields)

(declare-fun result13 () us_split_fields__ref)

(declare-fun l2__split_fields5 () us_split_fields)

(declare-fun formal_container__vdll__delete_last__container__fields1 () us_split_fields)

(declare-fun result14 () us_split_fields__ref)

(declare-fun l2__split_fields6 () us_split_fields)

(declare-fun result15 () us_split_fields__ref)

(declare-fun l3__split_fields3 () us_split_fields)

(declare-fun formal_container__vdll__delete_first__container__fields () us_split_fields)

(declare-fun result16 () us_split_fields__ref)

(declare-fun l3__split_fields4 () us_split_fields)

(declare-fun result17 () us_split_fields__ref)

(declare-fun l4__split_fields3 () us_split_fields)

(declare-fun formal_container__vdll__delete_first__2__container__fields () us_split_fields)

(declare-fun result18 () us_split_fields__ref)

(declare-fun l4__split_fields4 () us_split_fields)

(declare-fun formal_container__vdll__clear__container__fields () us_split_fields)

(declare-fun result19 () us_split_fields__ref)

(declare-fun l1__split_fields5 () us_split_fields)

(declare-fun result20 () int__ref)

(declare-fun e2 () Int)

(declare-fun l1__split_fields6 () us_split_fields)

(declare-fun e3 () Int)

(declare-fun formal_container__vdll__append__container__fields3 () us_split_fields)

(declare-fun result21 () us_split_fields__ref)

(declare-fun l1__split_fields7 () us_split_fields)

(declare-fun l1__split_fields8 () us_split_fields__ref)

(declare-fun e4 () int__ref)

(declare-fun l1__split_fields9 () us_split_fields)

(declare-fun e5 () Int)

(declare-fun l1__split_fields10 () us_split_fields__ref)

(declare-fun e6 () int__ref)

(declare-fun l1__split_fields11 () us_split_fields)

(declare-fun e7 () Int)

(declare-fun formal_container__vdll__move__source__fields () us_split_fields)

(declare-fun formal_container__vdll__move__target__fields () us_split_fields)

(declare-fun result22 () us_split_fields__ref)

(declare-fun l2__split_fields7 () us_split_fields)

(declare-fun result23 () us_split_fields__ref)

(declare-fun l1__split_fields12 () us_split_fields)
...
;; H
  ...
  (= (test_element (mk___rep l3__split_discrs l3__split_fields4)
     (next (mk___rep l3__split_discrs l3__split_fields4)
     (first (mk___rep l3__split_discrs l3__split_fields4))) 4) true))
...
;; H
  (assert
  (= (bool_eq3
     (find (mk___rep l3__split_discrs l3__split_fields4) 4 no_element)
     (next (mk___rep l3__split_discrs l3__split_fields4)
     (first (mk___rep l3__split_discrs l3__split_fields4)))) true))
...
;; H
  (assert
  (= (bool_eq3
     (find (mk___rep l3__split_discrs l3__split_fields4) 3
     (next (mk___rep l3__split_discrs l3__split_fields4)
     (first (mk___rep l3__split_discrs l3__split_fields4)))) no_element) true))
...
;; H
  (assert
  (and
  (= o13 (copy (mk___rep l1__split_discrs l1__split_fields4)
         (to_rep
         (rec__formal_container__vdll__list__capacity l4__split_discrs))))
  (and
  (and
  ...
  (ite (= (to_rep
          (rec__formal_container__vdll__list__capacity l4__split_discrs)) 0)
  (= (to_rep
     (rec__formal_container__vdll__list__capacity (us_split_discrs1 o13))) 
  (to_rep (rec__formal_container__vdll__list__capacity l1__split_discrs)))
  (= (to_rep
     (rec__formal_container__vdll__list__capacity (us_split_discrs1 o13))) 
  (to_rep (rec__formal_container__vdll__list__capacity l4__split_discrs)))))))
...
;; H
  (assert
  (ite (= (<= (length (mk___rep l4__split_discrs l4__split_fields3)) 2) true)
  (= (length
     (mk___rep l4__split_discrs
     formal_container__vdll__delete_first__2__container__fields)) 0)
  (and
  (and
  (= (length
     (mk___rep l4__split_discrs
     formal_container__vdll__delete_first__2__container__fields)) (- 
  (length (mk___rep l4__split_discrs l4__split_fields3)) 2))
  (= (range_shifted
     (model__
     (mk___rep l4__split_discrs
     formal_container__vdll__delete_first__2__container__fields))
     (model__ (mk___rep l4__split_discrs l4__split_fields3)) 1
     (length
     (mk___rep l4__split_discrs
     formal_container__vdll__delete_first__2__container__fields)) 2) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l4__split_discrs
     formal_container__vdll__delete_first__2__container__fields))
...
;; H
  (assert
  (= l4__split_fields4 formal_container__vdll__delete_first__2__container__fields))
...
;; H
  (assert
  (= (has_key (positions (mk___rep l4__split_discrs l4__split_fields4))
     (first (mk___rep l4__split_discrs l4__split_fields4))) true))

;; H
  (assert
  (= (test_element (mk___rep l4__split_discrs l4__split_fields4)
     (first (mk___rep l4__split_discrs l4__split_fields4)) 4) true))
...
;; H
  (assert
  (= (bool_eq3
     (find (mk___rep l4__split_discrs l4__split_fields4) 4 no_element)
     (first (mk___rep l4__split_discrs l4__split_fields4))) true))
...
;; H
  ...
  (= (length
     (mk___rep l1__split_discrs
     formal_container__vdll__clear__container__fields)) 0))
...
;; H
  (assert
  (= l1__split_fields5 formal_container__vdll__clear__container__fields))
...
;; H
  (assert (=> (and (<= 1 e2) (<= e2 3)) (= temp___438 e2)))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3))
  (= temp___437 (mk___rep l1__split_discrs l1__split_fields5))))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3))
  (= (length (mk___rep l1__split_discrs l1__split_fields6)) (- e3 1))))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3))
  (and (=> (<= 1 3) (in_range8 e3)) (and (<= 1 e3) (<= e3 3)))))
...
;; H
  ...
  (= (length
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3)) (+ (length
                                                             (mk___rep
                                                             l1__split_discrs
                                                             l1__split_fields6)) 1))
  (= (get1
     (positions
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))
     (last1
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))) (length
                                                           (mk___rep
  ...
  (= (keys_included_except
     ...
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))
     (positions (mk___rep l1__split_discrs l1__split_fields6))
     (last1
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))) true))
  (= (ole1 (positions (mk___rep l1__split_discrs l1__split_fields6))
     (positions
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))) true))
  (= (get
     ...
     (length
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))) e3))
  (= (ole (model__ (mk___rep l1__split_discrs l1__split_fields6))
     (model__
     (mk___rep l1__split_discrs
     formal_container__vdll__append__container__fields3))) true))))
...
;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3))
  (= result21 (mk___split_fields__ref l1__split_fields6))))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3))
  (= l1__split_fields7 formal_container__vdll__append__container__fields3)))

;; H
  (assert (=> (and (<= 1 e2) (<= e2 3)) (= e3 3)))

;; H
  (assert (=> (and (<= 1 e2) (<= e2 3)) (= e4 (mk_int__ref e3))))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3))
  (= l1__split_fields8 (mk___split_fields__ref l1__split_fields7))))

;; H
  (assert (=> (and (<= 1 e2) (<= e2 3)) (= e5 e3)))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields9 l1__split_fields7)))

;; H
  (assert (=> (and (<= 1 e2) (<= e2 3)) (= e6 e4)))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields10 l1__split_fields8)))

;; H
  (assert (=> (and (<= 1 e2) (<= e2 3)) (= e7 e5)))

;; H
  (assert
  (=> (and (<= 1 e2) (<= e2 3)) (= l1__split_fields11 l1__split_fields9)))

;; H
  (assert (=> (not (and (<= 1 e2) (<= e2 3))) (= e6 (mk_int__ref e2))))

;; H
  (assert
  (=> (not (and (<= 1 e2) (<= e2 3)))
  (= l1__split_fields10 (mk___split_fields__ref l1__split_fields5))))

;; H
  (assert (=> (not (and (<= 1 e2) (<= e2 3))) (= e7 e2)))

;; H
  (assert
  (=> (not (and (<= 1 e2) (<= e2 3)))
  (= l1__split_fields11 l1__split_fields5)))
...
;; H
  ...
  (= (oeq
     (model__
     (mk___rep l2__split_discrs formal_container__vdll__move__target__fields))
     (model__
     (mk___rep l1__split_discrs
     (us_split_fields__content l1__split_fields10)))) true)
  (= (length
     (mk___rep l1__split_discrs formal_container__vdll__move__source__fields)) 0)))

;; H
  (assert (= result22 (mk___split_fields__ref l2__split_fields6)))

;; H
  (assert (= l2__split_fields7 formal_container__vdll__move__target__fields))

;; H
  (assert (= result23 l1__split_fields10))

;; H
  (assert
  (= l1__split_fields12 formal_container__vdll__move__source__fields))

;; H
  (assert (=> (<= (- 2147483648) 2147483647) (in_range1 e1)))

(assert
;; WP_parameter_def
 ;; File "test_vdll.adb", line 18, characters 0-0
  (not
  (not (= (is_empty (mk___rep l1__split_discrs l1__split_fields12)) true))))
(check-sat)
