...
(declare-datatypes ((buffer_count_type__ref 0))
...
(declare-datatypes ((buffer_index_type__ref 0))
...
(declare-const temp___282 (Array Int character))

(declare-const temp___2821 t1)

(declare-const temp___283 (Array Int character))

(declare-const temp___2831 t)

(declare-const temp___284 (Array Int character))

(declare-const temp___2841 t)
