...
(declare-fun x86__bx__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__bx__result1 () (_ BitVec 16))

(declare-fun x86__bx__result2 () (_ BitVec 16))

(declare-fun x86__bx__result3 () (_ BitVec 16))

(declare-fun x86__bx__result4 () (_ BitVec 16))

(declare-fun x86__bx__result5 () (_ BitVec 16))
...
;; H
  (assert
  (= x86__bx__result1 ((_ extract 15 0) (bvand rbx ((_ int2bv 64) 65535)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not
  (bvule ((_ zero_extend 48) ((_ int2bv 16) 0)) (bvand rbx ((_ int2bv 64) 65535)))))
(check-sat)
(exit)
