...
;; H
  ...
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2)) fst) i)
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields2))
           (mk___rep1 current__split_fields3)) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) 0))))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields2)) fst) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (get
                                                                   (model__
                                                                   (mk___rep
                                                                   l__split_discrs
                                                                   (mk___split_fields
...
;; H
  ...
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
      (mk___rep1 current__split_fields3)) i)
  (<= i (length (mk___rep l__split_discrs l__split_fields2))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields2)) i) (get
                                                                   (model__
                                                                   (mk___rep
                                                                   l__split_discrs
