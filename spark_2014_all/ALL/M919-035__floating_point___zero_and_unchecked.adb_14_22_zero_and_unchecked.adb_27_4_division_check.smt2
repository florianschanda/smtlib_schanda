...
(define-fun dynamic_invariant4 ((temp___expr_201 t) (temp___is_init_198 Bool)
...
;; H
  ...
  (tqtisFinite zero_and_unchecked__zero_plus__assume)))
...
;; H
  ...
  (tqtisFinite zero_and_unchecked__zero_neg__assume)))
