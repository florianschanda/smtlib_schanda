...
(declare-fun very_longs__divide__get_msd__result () Int)
...
(declare-fun very_longs__divide__get_msd__result1 () Int)

(declare-fun very_longs__divide__get_msd__result2 () Int)

(declare-fun very_longs__divide__get_msd__result3 () Int)

(declare-fun digit_index8 () Int)

(declare-fun i8 () Int)

(declare-fun very_longs__divide__get_msd__result4 () Int)

(declare-fun digit_index9 () Int)

(declare-fun i9 () Int)

(declare-fun very_longs__divide__get_msd__result5 () Int)
...
;; H
  (assert
  (= very_longs__divide__get_msd__result1 very_longs__divide__get_msd__result2))

;; H
  (assert
  (= very_longs__divide__get_msd__result3 very_longs__divide__get_msd__result1))

;; H
  (assert
  (= (mk_int__ref result4) (mk_int__ref very_longs__divide__get_msd__result)))
...
;; H
  (assert
  (= (mk_int__ref very_longs__divide__get_msd__result4) (mk_int__ref
                                                        very_longs__divide__get_msd__result2)))
...
;; H
  (assert
  (= very_longs__divide__get_msd__result5 very_longs__divide__get_msd__result3))
...
;; H
  (assert
  (and (= o4 (+ very_longs__divide__get_msd__result4 1)) (in_range1
  (+ very_longs__divide__get_msd__result4 1))))
...
;; H
  ...
  (forall ((i11 Int))
  (=>
  (and (<= (+ very_longs__divide__get_msd__result4 1) i11)
  (<= i11 (to_rep2
          (last
          (rt
          (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 5, characters 0-0
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))
  very_longs__divide__get_msd__result4)))
(check-sat)
(exit)
