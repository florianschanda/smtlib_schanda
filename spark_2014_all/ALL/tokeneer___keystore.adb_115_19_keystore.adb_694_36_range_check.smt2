...
(declare-fun dummy11 () rawcertificatei)
...
(define-fun us_rep_9__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                a))
...
(declare-fun rawcertdata () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun signature () us_rep2)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun theissuer () us_rep)
...
(declare-fun dummy19 () (Array Int bytet))
...
(define-fun us_split_fields_Pad2__projection ((a us_split_fields6)) (Array Int bytet)
...
(declare-fun keystore__isverifiedby__B127b__thestring__assume () (Array Int character))

(declare-fun keystore__isverifiedby__B127b__thestring__assume1 () t)

(declare-fun digested () Bool)

(declare-fun theissuerkey1 () Int)
