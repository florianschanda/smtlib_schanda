...
;; H
  (assert
  (and (= temp___808 (keys (mk___rep r__split_discrs r__split_fields2)))
  (and
  (and
  (and
  (and
...
;; H
  (assert
  (and (= o (iter_has_element temp___808 temp___807))
  (= (= o true) (and (<= 1 temp___807) (<= temp___807 (last temp___808))))))
