...
(declare-fun temp___697 () us_rep3)
...
;; H
  (assert
  (=> (= result1 true)
  (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields10))))
...
;; H
  ...
  (and (= (has_key1 (positions s) temp___6821) true)
...
;; H
  (assert
  (and (= temp___697 (keys s))
  (and
  (and
  (and (= (length3 temp___697) (length s))
  (forall ((temp___396 Int))
  (=>
  (and (in_range3 temp___396)
  (= (iter_has_element temp___697 temp___396) true))
  (= (has_key (model__ s) (get temp___697 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find temp___697 key2))
  (= (equivalent_keys (get temp___697 (find temp___697 key2)) key2) true)))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (length s)))
  (and (= (find temp___697 (get temp___697 i)) i)
  (= (k_is_find temp___697 (get temp___697 i) i) true)))))))

;; H
  (assert
  (and (= o4 (iter_has_element temp___697 temp___696))
  (= (= o4 true) (and (<= 1 temp___696) (<= temp___696 (last temp___697))))))

;; H
  (assert (= (= o5 true) (in_range3 temp___696)))
...
;; H
  (assert (and (= k (get temp___697 temp___696)) (in_range4 k)))
...
;; H
  (assert
  (and (= result5 (has_key o8 k))
  (=> (= (of_int 1) true)
  (=>
  (exists ((k1 Int))
  (and (and (in_range2 k1) (= (has_key o8 k1) true))
  (= (equivalent_keys k1 k) true))) (= result5 true)))))
...
;; H
  (assert
  (and (= o6 (get2 (model__ s) k))
  (and (in_range7 o6) (= o6 (get2 (model__ s) k)))))

;; H
  (assert
  (and (= o7 (f o6))
  (and (in_range8 o7)
  (= o7 (ite (and (<= (- 100) o6) (<= o6 100)) (* o6 2) o6)))))
