...
(declare-fun temp___1270 () Int)

(declare-fun temp___1267 () (Array Int us_rep))

(declare-fun temp___1269 () us_rep)

(declare-fun temp___1266 () (Array Int character))

(declare-fun temp___1265 () Int)

(declare-fun temp___1264 () Int)

(declare-fun temp___1263 () Bool)

(declare-fun temp___1261 () (Array Int filestatust))

(declare-fun temp___1260 () Bool)

(declare-fun temp___1259 () Bool)

(declare-fun temp___1258 () us_rep)
...
(declare-fun logfiles17 () (Array Int us_rep))

(declare-fun currentlogfile5 () Int)

(declare-fun logfilesstatus17 () (Array Int filestatust))

(declare-fun numberlogentries5 () Int)

(declare-fun usedlogfiles__split_fields11 () us_split_fields)

(declare-fun logfileentries5 () (Array Int fileentrycountt))

(declare-fun auditalarm5 () Int)

(declare-fun auditsystemfault18 () Bool)

(declare-fun archive15 () t__ref)

(declare-fun logfiles18 () map__ref3)

(declare-fun currentlogfile6 () int__ref)

(declare-fun logfilesstatus18 () map__ref4)

(declare-fun numberlogentries6 () int__ref)

(declare-fun usedlogfiles__split_fields12 () us_split_fields__ref)

(declare-fun logfileentries6 () map__ref1)

(declare-fun auditalarm6 () int__ref)

(declare-fun auditsystemfault19 () bool__ref)

(declare-fun description15 () map__ref)

(declare-fun thefile17 () t__ref)

(declare-fun ok15 () bool__ref)

(declare-fun archivefault14 () bool__ref)

(declare-fun archivedfilecount15 () int__ref)

(declare-fun fileindex10 () int__ref)

(declare-fun fileindexinusedlist15 () int__ref)

(declare-fun archive16 () us_rep)

(declare-fun logfiles19 () (Array Int us_rep))

(declare-fun currentlogfile7 () Int)

(declare-fun logfilesstatus19 () (Array Int filestatust))

(declare-fun numberlogentries7 () Int)

(declare-fun usedlogfiles__split_fields13 () us_split_fields)

(declare-fun logfileentries7 () (Array Int fileentrycountt))

(declare-fun auditalarm7 () Int)

(declare-fun auditsystemfault20 () Bool)

(declare-fun description16 () (Array Int character))

(declare-fun thefile18 () us_rep)

(declare-fun ok16 () Bool)

(declare-fun archivefault15 () Bool)

(declare-fun archivedfilecount16 () Int)

(declare-fun fileindex11 () Int)

(declare-fun fileindexinusedlist16 () Int)

(define-fun fileindexinusedlist17 () int__ref (mk_int__ref
                                              fileindexinusedlist))
...
;; H
  (assert (= o (construct (mk___t archivefilename (mk 1 17)))))
...
;; H
  ...
  (= o1 (converttoauditdescription
        (mk___t (temp___String_Literal_1256 Tuple0) (mk 1 16)))))
...
;; H
  ...
  (< (to_rep2
     (select logfileentries (to_rep4
                            (select usedlogfiles__split_fields (to_rep4
                                                               usedlogfiles__split_fields1))))) 1024)))
  (= fileindexinusedlist13 fileindexinusedlist17)))
...
;; H
  ...
  (< (to_rep2
     (select logfileentries (to_rep4
                            (select usedlogfiles__split_fields (to_rep4
                                                               usedlogfiles__split_fields1))))) 1024)))
  (= archivedfilecount13 archivedfilecount17)))
...
;; H
  ...
  (< (to_rep2
     (select logfileentries (to_rep4
                            (select usedlogfiles__split_fields (to_rep4
                                                               usedlogfiles__split_fields1))))) 1024)))
  (= auditsystemfault13 auditsystemfault21)))
...
;; H
  ...
  (< (to_rep2
     (select logfileentries (to_rep4
                            (select usedlogfiles__split_fields (to_rep4
                                                               usedlogfiles__split_fields1))))) 1024)))
  (= logfilesstatus12 logfilesstatus20)))
...
;; H
  ...
  (= temp___1270 fileindexinusedlist2))))
...
;; H
  ...
  (and (< archivedfilecount2 4)
  (< archivedfilecount2 (to_rep3 usedlogfiles__split_fields3)))
  (= temp___1264 archivedfilecount2))))
...
;; H
  ...
  (and (< archivedfilecount2 4)
  (< archivedfilecount2 (to_rep3 usedlogfiles__split_fields3))))
  (= auditsystemfault11 auditsystemfault21))))
...
;; H
  ...
  (and (< archivedfilecount2 4)
  (< archivedfilecount2 (to_rep3 usedlogfiles__split_fields3))))
  (= logfilesstatus10 logfilesstatus20))))
...
;; H
  ...
  (and
  (<= 1 (to_rep3
        (rec__auditlog__logfilelistt__length usedlogfiles__split_fields11)))
  (= numberlogentries5 (+ (* (- (to_rep3
                                (rec__auditlog__logfilelistt__length
                                usedlogfiles__split_fields11)) 1) 1024)
  (to_rep2 (select logfileentries5 currentlogfile5)))))
  (and (and (in_range9 numberlogentries5) (in_range5 auditalarm5)) (in_range8
  currentlogfile5))))
...
;; H
  (assert (= logfileentries6 (mk_map__ref1 logfileentries5)))

;; H
  (assert
  (= usedlogfiles__split_fields12 (mk___split_fields__ref
                                  usedlogfiles__split_fields11)))

;; H
  (assert (= numberlogentries6 (mk_int__ref numberlogentries5)))

;; H
  (assert (= logfilesstatus18 (mk_map__ref4 logfilesstatus17)))

;; H
  (assert (= currentlogfile6 (mk_int__ref currentlogfile5)))
...
;; H
  (assert (= logfileentries7 logfileentries5))

;; H
  (assert (= usedlogfiles__split_fields13 usedlogfiles__split_fields11))

;; H
  (assert (= numberlogentries7 numberlogentries5))

;; H
  (assert (= logfilesstatus19 logfilesstatus17))

;; H
  (assert (= currentlogfile7 currentlogfile5))
...
;; WP_parameter_def
 ;; File "auditlog.ads", line 33, characters 0-0
  ...
  (<= 1 (to_rep3
        (rec__auditlog__logfilelistt__length
        (us_split_fields__content usedlogfiles__split_fields12))))))
(check-sat)
(exit)
