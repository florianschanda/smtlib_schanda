...
(define-fun us_split_fields_Reserved_1__2__projection ((a us_split_fields)) bits_2
  (rec__dw1000__register_types__sys_ctrl_type__reserved_1 a))

(define-fun us_split_fields_Reserved_2__2__projection ((a us_split_fields)) bits_14
...
(define-fun register_type__ref___24__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___17__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___17__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2438 us_t1)
  (temp___is_init_2435 Bool) (temp___skip_constant_2436 Bool)
  (temp___do_toplevel_2437 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2436 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2438)
                                       (last3 temp___expr_2438))
                                       (and (= (first3 temp___expr_2438) 1)
                                       (= (last3 temp___expr_2438) 4)))))
...
(define-fun target__ref___8__projection ((a target__ref)) us_t2 (target__content
                                                                a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___8__projection ((a source__ref)) us_rep (source__content
                                                                 a))

(define-fun dynamic_invariant1 ((temp___expr_2465 us_t2)
  (temp___is_init_2462 Bool) (temp___skip_constant_2463 Bool)
  (temp___do_toplevel_2464 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2463 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_2465)
                                       (last5 temp___expr_2465))
                                       (and (= (first5 temp___expr_2465) 1)
                                       (= (last5 temp___expr_2465) 4)))))
...
(define-fun temp___77432 () us_t2 (mk___t2 temp___7743 temp___77431))
...
;; H
  (assert
  (and (= temp___77432 (register_to_bytes reg)) (dynamic_invariant1
  temp___77432 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77431)) (to_rep (last4 temp___77431)))
     (+ (- (to_rep (last4 temp___77431)) (to_rep (first4 temp___77431))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77431)) (to_rep (last4 temp___77431)))
  temp___77441))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___77441)) (to_rep (last2 temp___77441)))
     (+ (- (to_rep (last2 temp___77441)) (to_rep (first2 temp___77441))) 1)
