...
;; H
  ...
  (and
  (and
  (and (= (state_of (mk___rep ctx__split_fields6)) 0)
  (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields6)) 8) 0))
  (< (in_queue_bit_length (mk___rep ctx__split_fields6)) (rate_of
                                                         (mk___rep
                                                         ctx__split_fields6))))
  (= (rate_of (mk___rep ctx__split_fields6)) initial_rate1)))
...
;; H
  (assert
  (=> (< (- 8 (mod2 bit_length 8)) 8)
  (= o11 (bvlshr suffix ((_ int2bv 8) (- 8 (mod2 bit_length 8)))))))

;; H
  (assert
  (=> (not (< (- 8 (mod2 bit_length 8)) 8)) (= o11 ((_ int2bv 8) 0))))
...
;; H
  (assert
  (and (= o14 (+ bit_length suffix_len)) (in_range1
