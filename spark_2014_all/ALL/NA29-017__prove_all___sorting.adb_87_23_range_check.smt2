...
;; H
  (assert
  (= o17 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last)))
         (mk___t a (mk (to_rep a__first) (to_rep a__last))) o10 o13 o14
         o16)))
...
;; H
  (assert
  (= o9 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last)))
        (mk___t a (mk (to_rep a__first) (to_rep a__last))) o4 o5 o6 o8)))
...
;; H
  (assert
  (= o3 (perm2 (mk___t a (mk (to_rep a__first) (to_rep a__last)))
        (mk___t b (mk (to_rep b__first) (to_rep b__last))) a_first o1
        o2 i2 j2)))
