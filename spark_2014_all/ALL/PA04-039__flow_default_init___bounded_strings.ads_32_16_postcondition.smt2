...
(((mk_tS1bP1__ref (tS1bP1__content integer)))))
...
(declare-datatypes ((s1b__ref 0)) (((mk_s1b__ref (s1b__content us_t1)))))
...
(((mk_string__ref (string__content us_t3)))))
...
(declare-const o4 length_type)

(declare-const temp___209 index_type)

(declare-const temp___2091 (Array Int character))

(declare-const temp___2092 t)

(declare-const temp___2093 length_type)
...
(declare-const temp___211 index_type)

(declare-const temp___2111 (Array Int character))

(declare-const temp___2112 t)

(declare-const temp___2113 length_type)
...
(declare-const target__split_fields3 us_split_fields)

(declare-const result3 us_split_fields__ref)

(declare-const target__split_fields4 us_split_fields)

(declare-const target__split_fields5 us_split_fields__ref)
