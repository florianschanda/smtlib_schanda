...
(declare-fun target__split_fields () (Array Int character))

(declare-fun target__split_fields1 () t)

(declare-fun target__split_fields2 () length_type)

(declare-fun temp___204 () (Array Int character))

(declare-fun temp___2041 () t2)
...
(declare-fun temp___209 () index_type)

(declare-fun temp___2091 () (Array Int character))

(declare-fun temp___2092 () t)

(declare-fun temp___2093 () length_type)
...
(declare-fun temp___211 () index_type)

(declare-fun temp___2111 () (Array Int character))

(declare-fun temp___2112 () t)

(declare-fun temp___2113 () length_type)
...
(declare-fun target__split_fields3 () us_split_fields)

(declare-fun result3 () us_split_fields__ref)

(declare-fun target__split_fields4 () us_split_fields)

(declare-fun target__split_fields5 () us_split_fields__ref)

(declare-fun target__split_fields6 () us_split_fields)
...
;; H
  (assert (= temp___204 temp___205))

;; H
  (assert
  (= (mk1 (to_rep3 (first4 temp___2041)) (to_rep3 (last4 temp___2041)))
  temp___2051))

;; H
  (assert
  (= (ite (<= (to_rep3 (first2 temp___2051)) (to_rep3 (last2 temp___2051)))
     (+ (- (to_rep3 (last2 temp___2051)) (to_rep3 (first2 temp___2051))) 1)
     0) (ite (<= (to_rep3 (first target__split_fields1)) (to_rep3
                                                         (last
                                                         target__split_fields1)))
        (+ (- (to_rep3 (last target__split_fields1)) (to_rep3
                                                     (first
                                                     target__split_fields1))) 1)
        0)))

;; H
  (assert
  (= (mk___t1 temp___207 temp___2071) (mk___t1 temp___205 temp___2051)))
...
;; H
  (assert
  (= (mk (to_rep3 (first2 temp___2071)) (to_rep3 (last2 temp___2071)))
  o1))
...
;; H
  (assert (= target__split_fields2 o4))

;; H
  (assert (= target__split_discrs (mk___split_discrs temp___209)))
...
;; H
  (assert (= result2 target__split_fields2))

;; H
  (assert
  (= target__split_fields3 (mk___split_fields
                           (mk___t temp___2091 temp___2092) temp___2093)))
...
;; H
  (assert
  (= (rec__bounded_strings__bounded_string__text target__split_fields3)
  (mk___t o6 o7)))
...
;; H
  (assert (= target__split_discrs (mk___split_discrs temp___211)))

;; H
  (assert (= temp___2111 o6))

;; H
  (assert (= temp___2112 o7))

;; H
  (assert (= temp___2113 o8))

;; H
  (assert (= result3 (mk___split_fields__ref target__split_fields3)))

;; H
  (assert
  (= target__split_fields4 (mk___split_fields
                           (mk___t temp___2111 temp___2112) temp___2113)))
...
;; H
  (assert
  (= target__split_fields5 (mk___split_fields__ref target__split_fields4)))

;; H
  (assert (= target__split_fields6 target__split_fields4))
...
;; WP_parameter_def
 ;; File "bounded_strings.ads", line 25, characters 0-0
  ...
  (= (length1
     (mk___rep target__split_discrs
     (us_split_fields__content target__split_fields5))) 0)))
(check-sat)
(exit)
