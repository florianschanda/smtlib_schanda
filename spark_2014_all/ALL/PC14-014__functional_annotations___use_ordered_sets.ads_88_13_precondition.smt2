...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o12 (next (mk___rep s__split_discrs s__split_fields3)
         (mk___rep1 cu__split_fields2)))
  ...
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o12) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o12) (+
  (get1 (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o12))
  (ite (= (ite (= (bool_eq1 o12 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      s__split_discrs
                                                      s__split_fields3))
