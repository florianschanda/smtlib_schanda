...
(define-fun set__ref_4__projection ((a set__ref1)) us_rep1 (set__content1 a))
...
(define-fun sequence__ref_5__projection ((a sequence__ref)) us_rep2 (sequence__content
                                                                    a))
...
(declare-fun o7 () count_type)

(declare-fun o8 () us_main_type)
