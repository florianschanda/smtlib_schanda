...
(define-fun sequence__ref___5__projection ((a sequence__ref)) us_rep2
  (sequence__content a))
...
(define-fun element_type__ref___16__projection ((a element_type__ref)) element_type
  (element_type__content a))

(define-fun dynamic_invariant1 ((temp___expr_1260 Int)
...
(define-fun default_initial_assumption ((temp___expr_1324 us_rep2)
...
(define-fun default_initial_assumption1 ((temp___expr_1293 us_rep1)
  (temp___skip_top_level_1294 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1294 true))
                                          (= (is_empty temp___expr_1293) true)))
...
(define-fun element_type__ref___17__projection ((a element_type__ref1)) element_type1
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (= (contains (model__ container) (get result temp___1358)) true))))
     (forall ((item Int))
...
(define-fun element_type__ref___18__projection ((a element_type__ref2)) element_type2
...
(define-fun o13 () us_rep (mk___rep (mk___split_discrs o7)
                          (mk___split_fields o8)))

(define-fun o14 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  ...
  (= (ole (model__ o13) (model__ source)) true))
  (= (includes_intersection (model__ o13)
     (model__
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source)) true))
  (= (e_elements_included (elements o13)
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true))
  (= (e_elements_included__2
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source) (elements o13)) true))))
...
;; H
  ...
  (and (in_range1 o5)
  (<= o5 (to_rep
         (rec__dic_of_cont__my_orse__set__capacity target__split_discrs))))))
...
;; H
  ...
  (= (ole (model__ o14)
     (model__
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true))
  (= (ole (model__ o14) (model__ source)) true))
  (= (includes_intersection (model__ o14)
     (model__
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source)) true))
  (= (e_elements_included (elements o14)
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))) true))
  (= (e_elements_included__2
     (elements
     (mk___rep target__split_discrs (mk___split_fields target__split_fields)))
     (model__ source) (elements o14)) true))))
...
;; H
  ...
  (and (in_range1 o3)
  (<= o3 (to_rep
         (rec__dic_of_cont__my_orse__set__capacity (us_split_discrs1 source)))))))
