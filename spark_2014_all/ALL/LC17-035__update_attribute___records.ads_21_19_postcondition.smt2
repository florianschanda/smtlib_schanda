...
(declare-fun temp___2182 () my_range)
...
;; H
  ...
  (= (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14
     r__split_fields15) (mk___split_fields r__split_fields4 r__split_fields5
                        r__split_fields6 r__split_fields7)))
...
;; WP_parameter_def
 ;; File "records.ads", line 16, characters 0-0
  ...
  (= (bool_eq3
     ...
     r__split_fields11))
     (mk___rep
     (mk___split_fields r__split_fields (of_rep new_data)
     (of_rep1 new_data_2) r__split_fields3))) true)))
(check-sat)
