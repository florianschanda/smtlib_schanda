...
(define-fun a__split_fields13 () us_split_fields (mk___split_fields
...
;; H
  ...
  (and
  (and
  (and (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields13) true
  true true)
...
;; H
  (assert (= a__split_fields4 (mk___split_fields__ref a__split_fields13)))
...
;; H
  (assert (= a__split_fields5 a__split_fields13))
...
;; H
  (assert
  (=> (< first4 (int__content right13))
  (and (= o23 (- (int__content right13) 1)) (in_range2
  (- (int__content right13) 1)))))

;; H
  (assert
  (=> (< first4 (int__content right13)) (dynamic_invariant2
  (mk___rep a__split_discrs a__split_fields10) true true true)))

;; H
  (assert
  (=> (< first4 (int__content right13))
  (= a__split_fields11 (mk___split_fields__ref a__split_fields10))))

;; H
  (assert
  (=> (< first4 (int__content right13))
  (= a__split_fields12 a__split_fields10)))

;; H
  (assert
  (=> (not (< first4 (int__content right13)))
  (= a__split_fields11 a__split_fields8)))

;; H
  (assert
  (=> (not (< first4 (int__content right13)))
  (= a__split_fields12 a__split_fields9)))

;; H
  (assert (< (int__content left13) last4))

(assert
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 126, characters 0-0
  (not (or (= last4 0) (<= (int__content left13) last4))))
(check-sat)
(exit)
