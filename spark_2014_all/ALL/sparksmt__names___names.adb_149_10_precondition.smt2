...
(declare-fun temp___474 () char_table_index)

(declare-fun temp___4741 () positive)

(declare-fun temp___4742 () name_id)

(declare-fun o13 () name_id)
...
(declare-fun o17 () char_table_index)
...
(declare-fun char_table__split_fields1 () us_split_fields)

(declare-fun entry_table__split_fields1 () us_split_fields2)

(define-fun temp___4743 () us_rep2 (mk___rep2
                                   (mk___split_fields2 temp___474 temp___4741
                                   temp___4742)))

(define-fun o20 () us_rep2 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
;; H
  (assert (=> (in_range9 n3) (= temp___473 n3)))

;; H
  (assert (=> (in_range9 n3) (= temp___472 ptr2)))
...
;; H
  ...
  (and
  (and
  (= (invariant__ hash_table char_table__split_fields1
     entry_table__split_fields1) true)
  (= (length2
  ...
  (<= (length3
      ...
      (mk___split_fields char_table__split_fields))) (length3
                                                     (mk___rep
                                                     char_table__split_discrs
...
;; H
  (assert
  (and (= o12 (int__content ptr10)) (in_range11 (int__content ptr10))))
...
;; H
  ...
  (= temp___4743 (get
                 (model__
                 (mk___rep1 entry_table__split_discrs
                 entry_table__split_fields1)) o12))
  (= (bool_eq3 temp___4743
     (get
     (model__
     (mk___rep1 entry_table__split_discrs entry_table__split_fields1))
     o12)) true)))
...
;; H
  (assert (= (to_rep2 o13) n12))

;; H
  (assert (= temp___474 o14))

;; H
  (assert (= temp___4741 o15))
...
;; H
  (assert
  (and (= o11 (int__content ptr10)) (in_range11 (int__content ptr10))))
