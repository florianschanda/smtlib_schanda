...
;; H
  (assert (and (= o1 (+ current_col1 1)) (in_range1 (+ current_col1 1))))

;; H
  (assert (= (to_rep2 o3) o1))

;; H
  (assert (= (to_rep2 o4) current_line1))

;; H
  (assert (= o5 (mk___split_fields2 o4 o3 o2 dummy11)))

;; H
  (assert (= (to_rep5 o) 0))

;; H
  (assert (= o6 (mk___split_discrs2 o)))

;; H
  (assert (= temp___846 (mk___rep2 o6 o5 true)))
