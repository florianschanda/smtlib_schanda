...
(declare-fun dummy5 () number_kind)
...
(declare-fun int_val () Int)

(declare-fun real_val () Float32)

(declare-fun kind () Int)

(declare-fun int_val1 () Int)

(declare-fun real_val1 () Float32)
...
;; H
  (assert (=> (<= (- 2147483648) 2147483647) (in_range1 int_val)))

;; H
  (assert
  (=>
  (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))
  (not (or (fp.isInfinite real_val) (fp.isNaN real_val)))))

;; H
  (assert (=> (<= 0 2) (in_range4 kind)))

;; H
  (assert
  (and
  (and (in_range1 int_val1)
  (not (or (fp.isInfinite real_val1) (fp.isNaN real_val1)))) (in_range4
  kind1)))
