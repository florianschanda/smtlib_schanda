...
(declare-const temp___190 length_type)

(declare-const temp___1901 entry_id)

(declare-const temp___1902 (Array (_ BitVec 8) integer))
...
(declare-const o8 entry_id)

(declare-const o9 (Array (_ BitVec 8) integer))

(declare-const temp___193 length_type)

(declare-const temp___1931 entry_id)

(declare-const temp___1932 (Array (_ BitVec 8) integer))

(declare-const result Int)

(declare-const tmp1 Int)

(declare-const result1 length_type)

(declare-const result2 entry_id)

(declare-const result3 (Array (_ BitVec 8) integer))
...
(declare-const result4 length_type)

(declare-const result5 entry_id)

(declare-const result6 (Array (_ BitVec 8) integer))
