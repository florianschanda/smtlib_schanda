...
(declare-datatypes ()
((grand_child__ref (mk_grand_child__ref (grand_child__content us_rep1)))))
...
;; H
  ...
  (= (less_than_max__2
     ...
     o__attr__tag)) true)
  (< (to_rep o__split_fields) 2147483647)))

(assert
;; WP_parameter_def
 ;; File "dispatch_in_contract.ads", line 16, characters 0-0
  (not (in_range (+ (to_rep o__split_fields1) 1))))
(check-sat)
(exit)
