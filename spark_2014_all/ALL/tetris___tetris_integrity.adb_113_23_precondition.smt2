...
;; no_overlap__def_axiom
  ...
  (! (= (= (no_overlap b p) true)
     ...
     (=> (and (<= 0 x) (<= x 3))
     (=>
     (= (let ((temp___640 (select possible_i_shapes (to_rep4
                                                    (rec__tetris_integrity__piece__d
                                                    (us_split_fields1 p))))))
        (get temp___640 y x)) true)
     (= (is_empty b
     ...
     (=> (and (<= 0 x) (<= x 2))
     (=>
     (= (let ((temp___641 (get1 possible_three_shapes
                          (to_rep1
                          (rec__tetris_integrity__piece__s
                          (us_split_fields1 p)))
                          (to_rep4
...
;; move_is_possible__def_axiom
  ...
  (! (= (= (move_is_possible p a) true)
     ...
     (+ (to_rep2 (rec__tetris_integrity__piece__x (us_split_fields1 p))) 1))
     (=> (= a 2) (in_range4
     (+ (to_rep3 (rec__tetris_integrity__piece__y (us_split_fields1 p))) 1)))))) :pattern (
...
;; move__def_axiom
  ...
  (forall ((p us_rep))
  (forall ((a Int))
  (! (=> (dynamic_invariant a true true true)
     (= (move p a) (ite (= a 0)
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__tetris_integrity__piece__s usq_)
                   (rec__tetris_integrity__piece__d usq_)
                   (of_rep2
                   (- (to_rep2
                      (rec__tetris_integrity__piece__x (us_split_fields1 p))) 1))
                   (rec__tetris_integrity__piece__y usq_))))
                   (ite (= a 1)
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__tetris_integrity__piece__s usq_)
                   ...
                   (mk___split_fields (rec__tetris_integrity__piece__s usq_)
                   (rec__tetris_integrity__piece__d usq_)
                   (rec__tetris_integrity__piece__x usq_)
                   (of_rep3
                   (+ (to_rep3
                      (rec__tetris_integrity__piece__y (us_split_fields1 p))) 1)))))
                   (mk___rep
                   (let ((usq_ (us_split_fields1 p)))
                   (mk___split_fields (rec__tetris_integrity__piece__s usq_)
                   (of_rep4
                   (turn_direction
                   (to_rep4
                   (rec__tetris_integrity__piece__d (us_split_fields1 p))) a))
                   (rec__tetris_integrity__piece__x usq_)
                   (rec__tetris_integrity__piece__y usq_))))))))) :pattern (
  (move p a)) ))))
...
;; is_empty__def_axiom
  ...
  (! (= (= (is_empty b y x) true)
     ...
     (= (to_rep (let ((temp___629 (select b y))) (select temp___629 x))) 0))) :pattern (
  (is_empty b y x)) ))))
...
(define-fun dynamic_invariant9 ((temp___expr_661 Int)
  (temp___is_init_658 Bool) (temp___skip_constant_659 Bool)
  (temp___do_toplevel_660 Bool)) Bool (=>
                                      (or (= temp___is_init_658 true)
                                      (<= 3 4)) (in_range10 temp___expr_661)))

;; turn_direction__post_axiom
  (assert
  (forall ((d Int) (t Int))
  (! (=>
     (and (dynamic_invariant8 d true true true) (dynamic_invariant9 t true
     true true)) (dynamic_invariant8 (turn_direction d t) true false true)) :pattern (
  (turn_direction d t)) )))
