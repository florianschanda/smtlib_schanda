...
(define-fun t5b__ref___projection ((a1 t5b__ref)) us_t1 (t5b__content a1))
...
(declare-datatypes ((ttB__ref 0)) (((mk_ttB__ref (ttB__content us_t2)))))
(define-fun ttB__ref___projection ((a1 ttB__ref)) us_t2 (ttB__content a1))

(declare-fun p__x__aggregate_def (Int Int Int) us_t1)

;; def_axiom
  (assert
  (forall ((temp___143 Int) (temp___144 Int) (temp___145 Int))
  (let ((temp___142 (p__x__aggregate_def temp___143 temp___144 temp___145)))
  (and
  ...
  (= (select (to_array1 temp___142) temp___146) (of_rep temp___143)))))))
...
(declare-const temp___148 (Array Int integer))
...
;; H
  (assert (= (to_rep (first2 (rt1 (p__x__aggregate_def a a b)))) a))

;; H
  (assert (= (to_rep (last2 (rt1 (p__x__aggregate_def a a b)))) b))

;; H
  (assert (= (mk___t1 temp___148 temp___1481) (p__x__aggregate_def a a b)))

(assert
;; WP_parameter_def
 ;; File "p.adb", line 2, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___1481)) (to_rep (last2 temp___1481)))
     (+ (- (to_rep (last2 temp___1481)) (to_rep (first2 temp___1481))) 1) 0)
  (ite (<= a b) (+ (- b a) 1) 0))))
(check-sat)
(exit)
