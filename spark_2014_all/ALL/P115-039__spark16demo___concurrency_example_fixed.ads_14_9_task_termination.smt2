...
(define-fun bool_eq2 ((a (Array Int integer)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep (select a temp___idx_198)) (to_rep
...
;; def_axiom
  ...
  (= (select (concurrency_example_fixed__all_zeroes__aggregate_def
             temp___200) temp___201) (of_rep temp___200)))))
...
(declare-fun concurrency_example_fixed__dataT__value__first__bit () Int)

(declare-fun concurrency_example_fixed__dataT__value__last__bit () Int)

(declare-fun concurrency_example_fixed__dataT__value__position () Int)
...
(define-fun dynamic_invariant1 ((temp___expr_232 Int)
  ...
  (temp___do_toplevel_231 Bool)) Bool (=>
                                      ...
                                      (<= 0 97)) (in_range1 temp___expr_232)))

(assert
;; WP_parameter_def
 ;; File "concurrency_example_fixed.adb", line 9, characters 0-0
  (not true))
(check-sat)
(exit)
