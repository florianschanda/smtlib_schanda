...
;; H
  ...
  (= (is_add
     ...
     (select temp___863 (parent
                        (rec__search_trees__search_tree__struct
                        t__split_fields10) i1))))
     (position (rec__search_trees__search_tree__struct t__split_fields10) i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___863 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             (let ((subject f_5__split_fields)) f_5__split_fields2))
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields10))) i1))) true)
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             ...
             (let ((subject f_5__split_fields)) f_5__split_fields2))
             (to_rep1
             (rec__search_trees__search_tree__root t__split_fields10))) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select (model__
             (rec__search_trees__search_tree__struct t__split_fields10)
...
;; H
  ...
  (= (get
     ...
     (+ (length
        ...
        (select (model__ (mk___rep2 f_1__split_fields3)
                (to_rep1
                (rec__search_trees__search_tree__root t__split_fields10))) i1)))) 1)) 
  (get
  (rec__tree_model__path_type__a
  (us_split_fields1
  ...
  (ite (= (get
          ...
          (+ (length
             ...
             (select (model__
                     ...
                     (let ((subject f_5__split_fields)) f_5__split_fields2))
                     (to_rep1
                     (rec__search_trees__search_tree__root t__split_fields10))) i1)))) 1)) 0)
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
  (= (rec__tree_model__path_type__k
     ...
     (select (model__
             ...
             y1) j3))) true)
  (< (to_rep
     (select (rec__search_trees__search_tree__values t__split_fields10) j3)) 
  (to_rep
  (select (rec__search_trees__search_tree__values t__split_fields10) i1))))))
  (forall ((j3 Int))
  (=> (and (<= 1 j3) (<= j3 100))
  (=>
  (= (rec__tree_model__path_type__k
