...
(declare-const temp___3201 us_main_type)

(declare-const temp___3202 Bool)
...
(declare-const temp___322 natural)

(declare-const temp___3221 us_main_type)

(declare-const temp___3222 Bool)

(declare-const temp___323 us_rep)

(declare-const usq_3 us_rep)

(declare-const temp___325 us_rep)
...
(declare-const d__split_fields3 us_split_fields)
