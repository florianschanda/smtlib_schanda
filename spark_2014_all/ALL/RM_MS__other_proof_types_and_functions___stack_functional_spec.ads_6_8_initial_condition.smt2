...
(declare-const o pointer_range)

(declare-const o1 (Array Int integer))

(declare-const o2 pointer_range)

(declare-const stack_functional_spec__initial_stack__assume (Array Int integer))

(declare-const stack_functional_spec__initial_stack__assume1 pointer_range)
...
;; H
  (assert
  (= (mk___rep
     (mk___split_fields stack_functional_spec__initial_stack__assume
     stack_functional_spec__initial_stack__assume1)) initial_stack))
...
(assert
;; WP_parameter_def
 ;; File "stack_functional_spec.adb", line 20, characters 0-0
