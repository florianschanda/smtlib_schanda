...
(define-fun dynamic_invariant ((temp___expr_519 Int)
...
(declare-fun dummy2 () (Array Int slot))
...
;; one_free_slot__post_axiom
  ...
  (! (=>
     ...
     true true)) (dynamic_invariant2 (one_free_slot x y tictactoe__my_board)
...
(declare-fun o1 () (Array Int slot))

(declare-fun o2 () (Array Int (Array Int slot)))

(declare-fun result () (Array Int (Array Int slot)))
...
;; H
  (assert
  (= o1 (store (select my_board (to_rep1
                                (rec__tictactoe__position__x
                                (us_split_fields1 p)))) (to_rep1
                                                        (rec__tictactoe__position__y
                                                        (us_split_fields1 p)))
...
;; H
  (assert
  (= o2 (store my_board (to_rep1
                        (rec__tictactoe__position__x (us_split_fields1 p)))
  o1)))
...
(assert
;; WP_parameter_def
 ;; File "tictactoe.adb", line 156, characters 0-0
  (not (= (num_free_slots my_board2) (- (num_free_slots my_board) 1))))
(check-sat)
(exit)
