...
(define-fun us_split_fields_Content3__projection ((a us_split_fields4)) us_t2
...
(define-fun us_split_discrs_2__projection ((a us_split_discrs4)) Bool
  (rec__p__pp__b a))

(define-fun us_split_discrs_3__projection ((a us_split_discrs4)) natural
  (rec__p__pp__c a))

(declare-datatypes ((us_split_discrs__ref1 0))
(((mk___split_discrs__ref1 (us_split_discrs__content1 us_split_discrs4)))))
(define-fun us_split_discrs__ref_2__projection ((a us_split_discrs__ref1)) us_split_discrs4
...
(define-fun us_rep_7__projection ((a us_rep3)) us_split_discrs4 (us_split_discrs5
                                                                a))
