...
(declare-datatypes ()
((us_split_fields4 (mk___split_fields2 (rec__p__my_rec__content2 us_t2)))))
...
(declare-fun self__ () us_rep3)

(declare-fun temp___230 () (Array Int natural))

(declare-fun temp___2301 () t3)
