...
(((mk___split_fields2 (rec__p__my_rec__content2 us_t2)))))
(define-fun us_split_fields_Content__3__projection ((a us_split_fields4)) us_t2
...
(define-fun bool_eq6 ((a us_rep2)
  (b us_rep2)) Bool (ite (and
                         (= (to_rep (rec__p__my_rec__c (us_split_discrs3 a)))
                         (to_rep (rec__p__my_rec__c (us_split_discrs3 b))))
                         (= (bool_eq5
                            (rec__p__my_rec__content2 (us_split_fields5 a))
                            (rec__p__my_rec__content2 (us_split_fields5 b))) true))
                    true false))
...
(declare-datatypes ((t7s__ref 0)) (((mk_t7s__ref (t7s__content us_rep2)))))
...
(define-fun us_split_discrs___2__projection ((a us_split_discrs4)) Bool
  (rec__p__pp__b a))

(define-fun us_split_discrs___3__projection ((a us_split_discrs4)) natural
  (rec__p__pp__c a))

(declare-datatypes ((us_split_discrs__ref1 0))
(((mk___split_discrs__ref1 (us_split_discrs__content1 us_split_discrs4)))))
(define-fun us_split_discrs__ref___2__projection ((a us_split_discrs__ref1)) us_split_discrs4
  (us_split_discrs__content1 a))

(declare-datatypes ((us_split_fields6 0))
(((mk___split_fields3 (rec__p__pp__dummy Bool)(rec__p__pp__r us_rep1)))))
(define-fun us_split_fields_Dummy__projection ((a us_split_fields6)) Bool
  (rec__p__pp__dummy a))

(define-fun us_split_fields_R__projection ((a us_split_fields6)) us_rep1
  (rec__p__pp__r a))
...
(define-fun us_rep___7__projection ((a us_rep3)) us_split_discrs4 (us_split_discrs5
                                                                  a))
...
(declare-datatypes ((pp__ref 0)) (((mk_pp__ref (pp__content us_rep3)))))
...
(define-fun dynamic_invariant3 ((temp___expr_187 us_rep3)
  (temp___is_init_184 Bool) (temp___skip_constant_185 Bool)
  (temp___do_toplevel_186 Bool)) Bool (let ((temp___189 (rec__p__pp__c
                                                        (us_split_discrs5
                                                        temp___expr_187))))
                                      (and (in_range3 (to_rep temp___189)
                                      (to_base
                                      (rec__p__pp__r
                                      (us_split_fields7 temp___expr_187))))
                                      ...
                                      (= (first3
                                         ...
                                         (us_split_fields3
                                         (rec__p__pp__r
                                         (us_split_fields7 temp___expr_187))))) 1)
                                      (= (last3
                                         (rec__p__my_rec__content1
                                         (us_split_fields3
                                         (rec__p__pp__r
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt3
     (temp___210 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))))) 1))
...
;; H
  ...
  (= (to_rep1
     (last6
     (rt3
     (temp___210 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__)))))))
  (to_rep (rec__p__pp__c (us_split_discrs5 self__)))))

;; H
  (assert
  (= (mk___t3 temp___230 temp___2301) (temp___210 0 1
                                      (to_rep
                                      (rec__p__pp__c
                                      (us_split_discrs5 self__))))))

(assert
;; WP_parameter_def
 ;; File "p.ads", line 9, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first6 temp___2301)) (to_rep1 (last6 temp___2301)))
     (+ (- (to_rep1 (last6 temp___2301)) (to_rep1 (first6 temp___2301))) 1)
     0) (ite (<= 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))
        (+ (- (to_rep (rec__p__pp__c (us_split_discrs5 self__))) 1) 1) 0))))
(check-sat)
(exit)
