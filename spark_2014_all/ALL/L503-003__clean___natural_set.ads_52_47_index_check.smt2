...
;; members__def_axiom
  (assert
  (forall ((s us_rep))
  (! (= (members s) (to_rep1 (rec__natural_set__t__len (us_split_fields1 s)))) :pattern (
  (members s)) )))
...
(define-fun dynamic_invariant2 ((temp___expr_136 Int)
  ...
  (temp___do_toplevel_135 Bool)) Bool (=>
                                      ...
                                      (<= 0 10)) (in_range4 temp___expr_136)))
...
;; H
  ...
  (and (= o (members s))
  (and (in_range1 o)
  (and (= o (to_rep1 (rec__natural_set__t__len (us_split_fields1 s))))
  (and (<= 0 o) (<= o 10))))))
...
(assert
;; WP_parameter_def
 ;; File "natural_set.ads", line 18, characters 0-0
  (not (<= 1 i)))
(check-sat)
(exit)
