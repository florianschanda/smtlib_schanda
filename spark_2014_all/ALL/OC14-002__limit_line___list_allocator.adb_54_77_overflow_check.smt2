...
;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o10) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o9 (get model____split_fields 1)) (in_range7 o9)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o9 first_available) true false)))))
...
;; H
  ...
  (and (= o11 (length model____split_fields)) (in_range6 o11))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= result2 (ite (= o11 0) true false))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (and (= o7 (length model____split_fields1)) (in_range6 o7)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o7) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o6 (get model____split_fields1 1)) (in_range7 o6))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o6 first_allocated) true false))))))
...
;; H
  ...
  (and (= o8 (length model____split_fields1)) (in_range6 o8)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (not (= first_allocated 0)))
  (= result1 (ite (= o8 0) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o4 (length model____split_fields)) (in_range6 o4))))

;; H
  (assert (=> (= result1 true) (= o5 (ite (<= j1 o4) true false))))

;; H
  (assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o5 false))))
...
;; H
  (assert (and (= o3 (get model____split_fields1 j)) (in_range7 o3)))

;; H
  (assert (= result7 (ite (in_range4 o3) true false)))

;; H
  (assert (= result7 true))

;; H
  (assert (and (= o2 (length model____split_fields1)) (in_range6 o2)))

;; H
  (assert (= result8 (ite (< j o2) true false)))
