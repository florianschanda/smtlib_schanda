...
;; H
  (assert (=> (< present target) (= result gap)))

;; H
  (assert (=> (< present target) (= gap1 (- target present))))

;; H
  (assert (=> (not (< present target)) (= result1 gap)))

;; H
  (assert (=> (not (< present target)) (= gap2 (- present target))))

;; H
  (assert (=> (not (< present target)) (= gap1 gap2)))

;; H
  (assert (=> (< 100 gap1) (= result2 gap1)))

;; H
  (assert (=> (< 100 gap1) (= gap3 100)))

;; H
  (assert (=> (not (< 100 gap1)) (= gap3 gap1)))
