...
;; H
  ...
  (and (= i11 i16) (and (= flag10 flag15) (= retval11 retval17))))
  (and (= bitwalker__peek__result7 bitwalker__peek__result2)
  (and (= i12 i2) (and (= flag11 flag1) (= retval12 retval1)))))
  (and
  (and
  (and
  ...
  (and (= i11 i9) (and (= flag10 flag8) (= retval11 retval15))))
  (and (= bitwalker__peek__result7 bitwalker__peek__result5)
  (and (= i12 i10) (and (= flag11 flag9) (= retval12 retval10)))))
  (and
  (and
  (and (= bitwalker__peek__result4 (mk_t__ref bitwalker__peek__result3))
  (and (= i9 i15) (and (= flag8 flag14) (= retval15 retval16))))
  (and (= bitwalker__peek__result5 bitwalker__peek__result3)
  (and (= i10 i8) (and (= flag9 flag7) (= retval10 retval8)))))
  (and (and (= (mk_t__ref result2) retval17) (= retval2 ((_ int2bv 64) 0)))
  (and
  (and (and (= (mk_int__ref result3) i16) (= i3 0))
  (ite (and (<= 0 i3) (<= i3 (- length1 1)))
  (and
  (and
  (and (= temp___285 i3)
  (and (= temp___284 flag)
  ...
  (and
  (forall ((j Int))
  (=> (and (<= (- length1 i4) j) (<= j (- length1 1)))
  (= (= (nth8_stream addr (- (- (+ start length1) j) 1)) true)
  (= (nth retval3 j) true))))
  (forall ((j Int))
  (=> (and (<= length1 j) (<= j 63)) (not (= (nth retval3 j) true)))))
  (and
  (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i4))
  (and (<= 0 i4) (<= i4 (- length1 1))))
  (and
  (and
  (and (and (= o4 (+ start i4)) (in_range1 (+ start i4)))
  ...
  (and
  (and
  (and (and (= o6 (+ (- 64 length1) i4)) (in_range1 (+ (- 64 length1) i4)))
  ...
  (=> (and (<= 0 i17) (<= i17 63))
  (=> (not (= i17 (- 63 o7)))
  (= (= (nth o8 i17) true) (= (nth retval3 i17) true)))))
  (= (= flag3 true) (= (nth o8 (- 63 o7)) true)))))
  (and (= retval3 result5) (= retval4 o8))) (= i4 (- length1 1)))))))))
  (and (and (= i4 i5) (and (= flag3 flag4) (= retval4 retval5)))
  (and (= i6 i4) (and (= flag5 flag3) (= retval6 retval4)))))
  (and
  (and (= i15 (mk_int__ref i5))
  (and (= flag14 (mk_bool__ref flag4)) (= retval16 (mk_t__ref retval5))))
  (and (= i8 i6) (and (= flag7 flag5) (= retval8 retval6)))))
  (and (and (= i3 i7) (and (= flag14 flag15) (= retval2 retval7)))
  (and (= i8 i3) (and (= flag7 flag1) (= retval8 retval2))))))
...
;; H
  ...
  (= (= result7 true)
  (forall ((i17 Int))
  (=> (and (<= 0 i17) (<= i17 (- length1 1)))
  (= (= (nth8_stream addr (- (- (+ start length1) i17) 1)) true)
  (= (nth (t__content bitwalker__peek__result8) i17) true))))))
