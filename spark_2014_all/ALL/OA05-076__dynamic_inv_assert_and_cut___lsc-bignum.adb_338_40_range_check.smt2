...
;; H
  (assert (= o55 (omultiply o49 o54)))

;; H
  (assert (= o57 (osubtract o55 o56)))

;; H
  (assert (= o46 (from_word32 a_msw2)))
...
;; H
  (assert
  (= o39 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
         a_first o38)))

;; H
  (assert (= o48 (oadd o39 o47)))

;; H
  (assert (= o58 (olt o48 o57)))
...
;; H
  (assert (and (= o25 (- i2 a_first)) (in_range1 (- i2 a_first))))
...
;; H
  (assert (= o24 (inverse o22 o23)))

;; H
  (assert (= o27 (oexpon o24 o26)))
...
;; H
  (assert (= o16 (num_of_big_int c c_first o15)))
...
;; H
  (assert (= o11 (num_of_big_int b b_first o10)))

;; H
  (assert (= o17 (omultiply o11 o16)))

;; H
  (assert (= o28 (omultiply o17 o27)))

;; H
  (assert (= o34 (omod o28 o33)))
