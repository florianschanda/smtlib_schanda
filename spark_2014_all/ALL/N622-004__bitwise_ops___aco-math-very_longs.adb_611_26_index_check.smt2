...
(declare-fun digit1 () (_ BitVec 8))

(declare-fun result3 () (_ BitVec 8))

(declare-fun digit2 () (_ BitVec 8))

(declare-fun result4 () (_ BitVec 8))

(declare-fun digit3 () (_ BitVec 8))
...
;; H
  (assert
  (and (<= (to_rep1 (first number__split_fields1)) digit_number1)
  (<= digit_number1 (to_rep1 (last number__split_fields1)))))

;; H
  (assert (= o digit_number1))

;; H
  (assert (= o1 (select number__split_fields o)))

;; H
  (assert (= o2 (to_rep o1)))

;; H
  (assert (= result2 digit))
...
;; H
  ...
  (=> (= bit_value 1)
  (=> (< bit_position1 8)
  (= o3 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) bit_position1))))))

;; H
  (assert
  (=> (= bit_value 1) (=> (not (< bit_position1 8)) (= o3 ((_ int2bv 8) 0)))))

;; H
  (assert (=> (= bit_value 1) (= o4 (bvor digit1 o3))))

;; H
  (assert (=> (= bit_value 1) (= result3 digit1)))

;; H
  (assert (=> (= bit_value 1) (= digit2 o4)))

;; H
  (assert
  (=> (not (= bit_value 1))
  (=> (< bit_position1 8)
  (= o5 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) bit_position1))))))

;; H
  (assert
  (=> (not (= bit_value 1))
  (=> (not (< bit_position1 8)) (= o5 ((_ int2bv 8) 0)))))

;; H
  (assert (=> (not (= bit_value 1)) (= o6 (bvnot o5))))

;; H
  (assert (=> (not (= bit_value 1)) (= o7 (bvand digit1 o6))))

;; H
  (assert (=> (not (= bit_value 1)) (= result4 digit1)))

;; H
  (assert (=> (not (= bit_value 1)) (= digit3 o7)))

;; H
  (assert (=> (not (= bit_value 1)) (= digit2 digit3)))

;; H
  (assert (= (to_rep o8) digit2))
