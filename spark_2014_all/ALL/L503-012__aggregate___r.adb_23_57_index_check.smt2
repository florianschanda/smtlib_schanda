...
(define-fun bool_eq2 ((a (Array Int int5)) (a__first Int) (a__last Int)
...
(define-fun bool_eq4 ((a us_rep)
  (b us_rep)) Bool (ite (= (bool_eq2 (rec__r__r__f (us_split_fields1 a)) 2 6
...
(declare-fun temp___260 (us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___262 us_rep))
  (forall ((temp___263 Int))
  (= (select (temp___260 temp___262) temp___263) temp___262))))

(declare-fun temp___264 (Int Int) (Array Int int5))

;; def_axiom
  (assert
  (forall ((temp___266 Int) (temp___267 Int))
  (let ((temp___265 (temp___264 temp___266 temp___267)))
  (forall ((temp___268 Int))
  (ite (= temp___268 2)
  (= (select temp___265 temp___268) (of_rep temp___266))
  (= (select temp___265 temp___268) (of_rep temp___267)))))))
...
(declare-fun o1 () (Array Int int5))

(declare-fun o2 () (Array Int int5))

(declare-fun temp___269 () (Array Int int5))
