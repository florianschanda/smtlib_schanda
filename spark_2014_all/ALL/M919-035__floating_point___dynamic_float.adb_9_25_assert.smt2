...
(declare-fun to_rep (ttB) t)

(declare-fun of_rep (t) ttB)
...
;; range_axiom
  (assert
  (forall ((x ttB)) (! (tqtisFinite (to_rep x)) :pattern ((to_rep x)) )))
...
(define-fun bool_eq4 ((x t) (y t)) Bool (ite (eq1 x y) true false))
...
(define-fun dynamic_invariant ((temp___expr_177 t) (temp___is_init_174 Bool)
  (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)
  (dynamic_float__L_1__i Int)) Bool (=>
                                    (or (= temp___is_init_174 true) (le
                                    fliteral1 (last dynamic_float__L_1__i)))
                                    (dynamic_property fliteral1
...
;; last__def_axiom
  ...
  (! (= (last dynamic_float__L_1__i) (of_int RNE1 dynamic_float__L_1__i)) :pattern (
  (last dynamic_float__L_1__i)) )))
...
;; H
  (assert
  (and (= us fliteral) (dynamic_property fliteral1 (last i2) fliteral)))
...
;; H
  (assert (dynamic_invariant x1 true false true i2))

(assert
;; WP_parameter_def
 ;; File "dynamic_float.adb", line 1, characters 0-0
  (not (= (to_int1 RNA1 (last i2)) i2)))
(check-sat)
