...
;; H
  (assert
  (and (= o36 (+ (to_rep1 (first (rt source))) 9)) (in_range1
...
;; H
  (assert
  (and (= temp___1852 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1852)
  (<= temp___1852 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1852))
