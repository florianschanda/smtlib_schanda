...
(((mk___split_fields
  (rec__alarm__blinken_poT__blinken_state Bool)(rec__alarm__the_light Bool)))))
...
(declare-datatypes ((blinken_poT__ref 0))
(((mk_blinken_poT__ref (blinken_poT__content us_rep)))))
