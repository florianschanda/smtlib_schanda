...
(declare-fun mixed_basket__split_fields () item_t)

(declare-fun mixed_basket__split_fields1 () item_t)

(declare-fun mixed_basket__split_fields2 () item_t)

(declare-fun mixed_basket__split_fields3 () (Array Int item_t))
...
;; WP_parameter_def
 ;; File "test.adb", line 71, characters 0-0
  ...
  (mk___rep (mk___split_discrs mixed_basket__split_discrs)
  (mk___split_fields mixed_basket__split_fields mixed_basket__split_fields1
  mixed_basket__split_fields2 mixed_basket__split_fields3)
  mixed_basket__attr__constrained))))
(check-sat)
(exit)
