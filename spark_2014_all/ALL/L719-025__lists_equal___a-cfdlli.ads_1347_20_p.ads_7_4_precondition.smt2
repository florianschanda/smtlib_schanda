...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep2)) (! (dynamic_invariant (length1 container1)
  true false true) :pattern ((length1 container1)) )))
...
(declare-fun temp___444 () count_type)
...
;; H
  (assert (= temp___444 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___444)) no_element))
...
;; H
  ...
  (and (in_range1 o3)
  (<= o3 (to_rep
         (rec__p__my_lists__list__capacity (us_split_discrs1 container)))))))
...
(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1335, characters 0-0
