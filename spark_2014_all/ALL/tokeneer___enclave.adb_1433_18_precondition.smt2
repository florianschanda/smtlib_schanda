...
;; H
  (assert
  (=> (= result6 true)
  (and (= o27 (theauthcertrole (us_private__content state35))) (in_range1
  o27))))
...
;; H
  (assert
  (=> (= result6 true) (= o25 (authcertvalid (us_private__content state35)))))

;; H
  (assert
  (=> (= result6 true) (= o26 (isgood (us_private__content state35)))))
...
;; H
  (assert
  (=> (= result7 true)
  (and (= o19 (theauthcertrole (us_private__content state35))) (in_range1
  o19))))
...
;; H
  (assert
  (=> (= result7 true) (= o17 (authcertvalid (us_private__content state35)))))

;; H
  (assert
  (=> (= result7 true) (= o18 (isgood (us_private__content state35)))))
...
;; H
  (assert
  (and (= o11 (thedooralarm (us_private__content state37))) (in_range9 o11)))
...
;; H
  (assert
  (and (= o3 (thecurrentdoor (us_private__content state37))) (in_range8 o3)))
