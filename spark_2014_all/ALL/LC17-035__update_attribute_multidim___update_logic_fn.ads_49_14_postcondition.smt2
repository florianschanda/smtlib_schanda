...
(declare-fun temp___216 (map1 Int (_ BitVec 8) Int Int (_ BitVec 8)
  Int) map1)

;; def_axiom
  (assert
  (forall ((temp___218 map1))
  (forall ((temp___219 Int) (temp___221 Int) (temp___222 Int)
  (temp___224 Int))
  (forall ((temp___220 (_ BitVec 8)) (temp___223 (_ BitVec 8)))
  ...
  (ite (and (= temp___225 temp___222) (= temp___226 temp___223))
  (= (get temp___217 temp___225 temp___226) (of_rep temp___224))
  (ite (and (= temp___225 temp___219) (= temp___226 temp___220))
  (= (get temp___217 temp___225 temp___226) (of_rep temp___221))
  (= (get temp___217 temp___225 temp___226) (get temp___218 temp___225
                                            temp___226)))))))))))
...
(assert
;; WP_parameter_def
 ;; File "update_logic_fn.ads", line 39, characters 0-0
  (not
  (= (bool_eq a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7)
     (temp___216 a_2d_arr 4 ((_ int2bv 8) 7) v1 x y v2) 1 10 ((_ int2bv 8) 0)
     ((_ int2bv 8) 7)) true)))
(check-sat)
(exit)
