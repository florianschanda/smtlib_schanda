...
;; move_is_possible__def_axiom
  ...
  (! (= (= (move_is_possible p a) true)
     (ite (= a 0) (in_range
     (- (to_rep (rec__tetris_functional__piece__x (us_split_fields1 p))) 1))
     (ite (= a 1) (in_range
     (+ (to_rep (rec__tetris_functional__piece__x (us_split_fields1 p))) 1))
     (=> (= a 2) (in_range1
     (+ (to_rep1 (rec__tetris_functional__piece__y (us_split_fields1 p))) 1)))))) :pattern (
