...
(declare-fun fixed_stream__convert__result () (Array Int stream_element))

(declare-fun fixed_stream__convert__result1 () t1)
...
(declare-fun o10 () (Array Int stream_element))
...
(declare-fun out_stream2 () (Array Int stream_element))

(declare-fun i2 () Int)

(declare-fun result3 () (Array Int stream_element))

(declare-fun out_stream3 () (Array Int stream_element))

(declare-fun out_stream4 () (Array Int stream_element))

(declare-fun i3 () Int)

(declare-fun out_stream5 () (Array Int stream_element))

(declare-fun i4 () Int)

(declare-fun out_stream6 () (Array Int stream_element))

(declare-fun i5 () Int)

(declare-fun out_stream7 () (Array Int stream_element))

(declare-fun i6 () Int)

(declare-fun result4 () (Array Int stream_element))

(declare-fun result5 () t1)

(declare-fun fixed_stream__convert__result2 () (Array Int stream_element))

(declare-fun fixed_stream__convert__result3 () t1)

(declare-fun fixed_stream__convert__result4 () (Array Int stream_element))

(declare-fun fixed_stream__convert__result5 () t1)

(declare-fun fixed_stream__convert__result6 () us_t1)

(declare-fun len2 () int__ref)

(declare-fun out_stream8 () map__ref1)

(declare-fun i7 () int__ref)

(declare-fun fixed_stream__convert__result7 () stream_element_array__ref)

(declare-fun len3 () Int)

(declare-fun out_stream9 () (Array Int stream_element))

(declare-fun i8 () Int)

(declare-fun fixed_stream__convert__result8 () us_t1)
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r19b)) (= o4 (select (elts in_string) o3))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r19b)) (and (= o6 o5) (uint_in_range o5))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o7 ((_ int2bv 8) o6))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r19b)) (= (to_rep3 o8) o7)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r19b)) (= o10 (store out_stream2 o9 o8))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r19b))
  (= out_stream10 (mk_map__ref1 out_stream4))))
...
;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 r19b))) (= out_stream1 out_stream6)))
...
;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 r19b))) (= out_stream7 out_stream1)))
...
;; H
  (assert
  (= fixed_stream__convert__result6 (mk___t1 fixed_stream__convert__result2
                                    fixed_stream__convert__result3)))

;; H
  (assert
  (= (mk_stream_element_array__ref (mk___t1 result4 result5)) (mk_stream_element_array__ref
                                                              (mk___t1
                                                              fixed_stream__convert__result
                                                              fixed_stream__convert__result1))))
...
;; H
  (assert
  (= (mk1 (to_rep4 out_stream__first) (to_rep4 out_stream__last)) fixed_stream__convert__result3))

;; H
  (assert
  (= fixed_stream__convert__result7 (mk_stream_element_array__ref
                                    (mk___t1 fixed_stream__convert__result4
                                    fixed_stream__convert__result5))))
...
;; H
  (assert
  (and (= o11 (elements this))
  (and (in_range4 o11)
  (= o11 (to_rep2 (rec__fixed_stream__object__width (us_split_fields1 this)))))))

(assert
;; WP_parameter_def
 ;; File "a-stream.ads", line 54, characters 0-0
  (not (in_range1
  (length1 (stream_element_array__content fixed_stream__convert__result7)))))
(check-sat)
(exit)
