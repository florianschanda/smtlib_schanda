...
(declare-datatypes ((drx_tune1b_type__ref 0))
...
(declare-const temp___7799 (Array Int bits_8))

(declare-const temp___77991 t2)

(declare-const temp___7800 (Array Int bits_8))

(declare-const temp___78001 t1)
...
;; H
  (assert (= temp___7799 temp___7800))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77991)) (to_rep (last4 temp___77991)))
  temp___78001))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78001)) (to_rep (last2 temp___78001)))
     (+ (- (to_rep (last2 temp___78001)) (to_rep (first2 temp___78001))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7800 temp___78001)))
