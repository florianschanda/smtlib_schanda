...
(declare-const temp___7950 (Array Int bits_8))

(declare-const temp___79501 t1)
...
;; H
  (assert (= temp___7949 temp___7950))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79491)) (to_rep (last4 temp___79491)))
  temp___79501))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79501)) (to_rep (last2 temp___79501)))
     (+ (- (to_rep (last2 temp___79501)) (to_rep (first2 temp___79501))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7950 temp___79501)))
