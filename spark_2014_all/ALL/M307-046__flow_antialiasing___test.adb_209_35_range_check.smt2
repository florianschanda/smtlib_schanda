...
(declare-fun temp___411 () (Array Int character))
...
;; H
  (assert
  (=> (<= 2 5)
  (and (and (<= (to_rep1 s__first) 2) (<= 2 (to_rep1 s__last)))
  (and (<= (to_rep1 s__first) 5) (<= 5 (to_rep1 s__last))))))

;; H
  (assert (= temp___411 s))

;; H
  (assert (= test__op_string_io_i__x__compl temp___411))
