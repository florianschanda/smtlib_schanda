...
(define-fun model____split_fields13 () us_split_fields (mk___split_fields
...
;; H
  (assert
  (and
  (and (= (is_valid state1 model____split_fields16) true)
...
;; H
  (assert
  (and
  (and (= (is_valid state2 model____split_fields15) true)
...
;; H
  (assert
  (and
  (and (= (is_valid state3 model____split_fields14) true)
...
;; H
  (assert
  (and
  (and (= (is_valid state4 model____split_fields13) true)
  (ite (= (= (length model____split_fields6) 0) true)
  (and (= res41 0)
  (= (oeq (mk___rep model____split_fields13)
     (mk___rep model____split_fields14)) true))
  (and
...
;; WP_parameter_def
 ;; File "list_allocator.ads", line 80, characters 0-0
  (not (= (is_available res11 state5) true)))
(check-sat)
(exit)
