...
;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x enum1ta)) (! (in_range1 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(declare-fun result5 () et1)

(declare-fun result6 () et2)

(declare-fun r__split_fields7 () et3)

(declare-fun r__split_fields8 () et1)

(declare-fun r__split_fields9 () et2)

(declare-fun r__split_fields10 () enum1ta)

(declare-fun r__split_fields11 () Bool)

(declare-fun r__split_fields12 () et1)

(declare-fun r__split_fields13 () et2)

(declare-fun result7 () us_split_fields__ref2)

(declare-fun r__split_fields14 () us_split_fields4)

(declare-fun r__split_fields15 () us_split_fields__ref2)

(declare-fun r__split_fields16 () us_split_fields4)
...
;; H
  (assert
  (= a (mk___rep (mk___split_fields r__split_fields8 r__split_fields9))))
...
;; H
  (assert
  (= result7 (mk___split_fields__ref2
             (mk___split_fields2
             (mk___rep1
             (mk___split_fields1 r__split_fields7
             (mk___rep (mk___split_fields r__split_fields8 r__split_fields9))
...
;; H
  (assert
  (= r__split_fields14 (mk___split_fields2
                       (mk___rep1
                       (mk___split_fields1 r__split_fields7
                       (mk___rep
                       (mk___split_fields r__split_fields8 r__split_fields9))
                       r__split_fields10)) r__split_fields11 b)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1135, characters 0-0
  (not
  (= (bool_eq2 (mk___rep2 (us_split_fields__content2 r__split_fields15))
     (mk___rep2
     (mk___split_fields2
     (mk___rep1 (mk___split_fields1 r__split_fields a r__split_fields3))
     r__split_fields4 b))) true)))
(check-sat)
(exit)
