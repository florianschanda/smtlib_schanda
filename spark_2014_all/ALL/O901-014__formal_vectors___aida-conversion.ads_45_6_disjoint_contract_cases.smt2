...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (<= (+ (+ (+ (+ (+ (+ 0 (ite (= (= (length source) 0) true) 1 0)) (ite (= (=
                                                                    (length
                                                                    source) 1) true)
                                                                    1 0))
  (ite (= (ite (= (> (length source) 1) true) (< (length source) 10) false) true)
  1 0)) (ite (= (= (length source) 10) true) 1 0)) (ite (= (= (length source) 11) true)
                                                   1 0)) (ite (= (>=
                                                         (length source) 12) true)
                                                         1 0)) 1)))
(check-sat)
(exit)
