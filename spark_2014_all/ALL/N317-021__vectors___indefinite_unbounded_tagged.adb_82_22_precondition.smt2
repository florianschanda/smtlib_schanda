...
(declare-fun indefinite_unbounded_tagged__vect__reverse_elements__container__fields () us_split_fields2)
...
;; H
  (assert
  (and (= temp___625 (f 3))
  (= temp___625 (mk___rep (mk___split_fields (of_rep 3) us_null_ext__)
                us_tag))))
