...
;; H
  (assert
  (and (= o25 (+ (to_rep1 (first (rt source))) 10)) (in_range1
...
;; H
  (assert
  (and (= o24 (+ (to_rep1 (first (rt source))) 7)) (in_range1
...
;; H
  ...
  (forall ((index1 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 7) index1)
  (<= index1 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index1))) true)))))

;; H
  (assert
  (and (= temp___1933 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))
...
;; H
  (assert
  (and (= temp___1932 (+ (to_rep1 (first (rt source))) 6)) (in_range1
...
;; H
  (assert
  (and (= temp___1931 (+ (to_rep1 (first (rt source))) 5)) (in_range1
...
;; H
  (assert
  (and (= temp___1930 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1930)
  (<= temp___1930 (to_rep1 (last (rt source))))))

;; H
  (assert (= o8 temp___1930))
...
;; H
  (assert
  (and (= temp___1929 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1929)
  (<= temp___1929 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___1929))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1928)
  (<= temp___1928 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1928))
