...
(declare-fun very_longs__divide__L_7__R137b__assume () Int)

(declare-fun temp___1102 () us_rep1)

(declare-fun temp___1101 () (_ BitVec 16))

(declare-fun temp___1100 () us_rep)

(declare-fun temp___1099 () (_ BitVec 16))
...
(declare-fun remainder__split_fields3 () us_split_fields)
...
;; H
  (assert
  (and (= very_longs__divide__L_7__R137b__assume (+ m1 1)) (in_range1
  (+ m1 1))))
...
;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b))
  (= temp___1102 (mk___rep1 u__split_discrs u__split_fields2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1101 current_borrow)))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= temp___1099 q_hat)))
...
;; H
  ...
  (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields3) false true
  true)) (and (<= 1 j2) (<= j2 r137b)))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o10 j2) (in_range2 j2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o11 j2) (in_range2 j2))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b)) (dynamic_invariant7
  (mk___rep1 u__split_discrs u__split_fields4) true true true)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (and (= o12 j2) (in_range2 j2))))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j2 1)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j3 (mk_int__ref j2))))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat3 (mk_t__ref1 q_hat2))))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j4 j2)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow4 current_borrow2)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat4 q_hat2)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b)) (= u__split_fields7 u__split_fields5)))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j5 j3)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow5 current_borrow3)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat5 q_hat3)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b)) (= u__split_fields8 u__split_fields6)))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= j6 j4)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b)) (= current_borrow6 current_borrow4)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r137b)) (= q_hat6 q_hat4)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r137b)) (= u__split_fields9 u__split_fields7)))
...
;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= j5 (mk_int__ref j1))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r137b)))
  (= current_borrow5 (mk_t__ref1 current_borrow))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r137b))) (= q_hat5 (mk_t__ref1 q_hat))))
...
;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= j6 j1)))
...
;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r137b))) (= q_hat6 q_hat1)))
...
;; H
  (assert (dynamic_property2 1 last2 r139b))
...
;; H
  (assert (<= divisor_index1 r139b))

;; H
  (assert
  (and
  (and (dynamic_invariant1
  (mk___rep remainder__split_discrs remainder__split_fields3) false true
  true)
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits remainder__split_fields3)))) temp___1111)
  (<= temp___1111 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
                  remainder__split_fields3))))))
  (=> (<= divisor_index2 temp___1111)
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             remainder__split_fields3)) temp___1111) (select (elts
                                                             (rec__very_longs__very_long__long_digits
                                                             remainder__split_fields2)) temp___1111))))))
  (and (<= 1 divisor_index2) (<= divisor_index2 r139b))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields8))))) divisor_index2)))
(check-sat)
(exit)
