...
;; H
  ...
  (and (in_range5 o18) (<= (+ 0 o18) 2147483647))))
...
;; H
  ...
  (= o16 (length
         (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o16) (<= (+ 0 o16) 2147483647))))))

;; H
  (assert
  (=> (= result4 true)
  (=> (not (= first_available 0)) (= result5 (ite (< 0 o16) true false)))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (= o15 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
         1))
  (in_range6 o15))))))
...
;; H
  ...
  (=> (= result4 true)
  (=> (not (= first_available 0))
  (=> (= result5 true) (= result3 (ite (= o15 first_available) true false))))))
...
;; H
  ...
  (= o17 (length
         (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o17) (<= (+ 0 o17) 2147483647))))))

;; H
  (assert
  (=> (= result4 true)
  (=> (not (not (= first_available 0)))
  (= result3 (ite (= o17 0) true false)))))
...
;; H
  ...
  (= o11 (length
         (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o11) (<= (+ 0 o11) 2147483647)))))
...
;; H
  ...
  (in_range6 temp___281))))

;; H
  (assert
  (=> (not (= first_available 0))
  (and (<= 1 temp___281) (<= temp___281 10000))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= (mk___rep (mk___split_fields o2 o3)) (select data o1))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (= result9 (ite (in_range3 o7) true false))))
...
;; H
  ...
  (= temp___280 (get
                (rec__list_mod_allocator__m__t__available
                (us_split_fields3 m)) o8))
  (in_range6 temp___280)))
