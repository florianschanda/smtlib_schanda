...
;; H
  ...
  (=>
  (and
  (and (<= (to_rep1 lengths__first) temp___296)
  (<= temp___296 (to_rep1 lengths__last)))
  (and (<= (to_rep1 lengths__first_2) temp___297)
  (<= temp___297 (to_rep1 lengths__last_2)))) (dynamic_property3 0 last4
  (to_rep2 (get lengths temp___296 temp___297)))))))
