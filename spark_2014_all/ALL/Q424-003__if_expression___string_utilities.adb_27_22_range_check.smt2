...
;; H
  ...
  (=>
  (and
  (and (<= (to_rep1 lengths__first) temp___292)
  (<= temp___292 (to_rep1 lengths__last)))
  (and (<= (to_rep1 lengths__first_2) temp___293)
  (<= temp___293 (to_rep1 lengths__last_2)))) (dynamic_property3 0 last4
