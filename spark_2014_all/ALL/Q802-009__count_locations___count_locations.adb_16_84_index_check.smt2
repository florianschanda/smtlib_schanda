...
;; H
  ...
  (forall ((s1 Int))
  (=> (and (<= 1 s1) (<= s1 (- st2 1)))
  (=> (= (select sel s1) true) (<= lowest_max2 (to_rep (select max s1)))))))
...
;; H
  ...
  (and
  (forall ((s1 Int))
  (=> (and (<= 1 s1) (<= s1 (- st2 1))) (not (= (select sel s1) true))))
  (= lowest_max2 2147483647))
  (exists ((s1 Int))
  (and (and (<= 1 s1) (<= s1 (- st2 1)))
  (and (= (select sel s1) true) (= (to_rep (select max s1)) lowest_max2))))))
