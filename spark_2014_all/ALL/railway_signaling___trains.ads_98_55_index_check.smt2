...
(declare-fun o44 () track_id)

(declare-fun o45 () track_id)

(declare-fun o46 () Int)

(declare-fun o47 () track_id)

(declare-fun o48 () natural)

(declare-fun o49 () track_id)
...
;; H
  (assert (= (mk___rep (mk___split_fields o47 o48 o49)) (select trains
  o46)))
...
;; H
  (assert (= (mk___rep (mk___split_fields o39 o40 o41)) (select trains
  o38)))
...
;; H
  (assert
  (=> (= result2 true)
  (= (mk___rep (mk___split_fields o28 o29 o30)) (select trains o27))))
...
;; H
  (assert
  (=> (= result2 true)
  (= (mk___rep (mk___split_fields o20 o21 o22)) (select trains o19))))
...
;; H
  (assert
  (=> (= result2 true) (= result1 (ite (not (= o37 true)) true false))))
