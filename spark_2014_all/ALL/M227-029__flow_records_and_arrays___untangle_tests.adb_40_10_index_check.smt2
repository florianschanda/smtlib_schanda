...
(declare-fun l () (Array Int us_rep1))

(declare-fun tmp__split_fields () (Array Int us_rep))

(declare-fun tmp__split_fields1 () float)

(declare-fun tmp__split_fields2 () float)

(declare-fun tmp__split_fields3 () float)

(declare-fun tmp__split_fields4 () float)

(declare-fun o () Int)

(declare-fun untangle_tests__swap_triangle__tmp__assume () (Array Int us_rep))

(declare-fun untangle_tests__swap_triangle__tmp__assume1 () float)

(declare-fun untangle_tests__swap_triangle__tmp__assume2 () float)

(declare-fun untangle_tests__swap_triangle__tmp__assume3 () float)

(declare-fun untangle_tests__swap_triangle__tmp__assume4 () float)
...
(declare-fun o8 () (Array Int us_rep1))
...
(declare-fun result4 () float)

(declare-fun tmp__split_fields5 () (Array Int us_rep))

(declare-fun tmp__split_fields6 () float)

(declare-fun tmp__split_fields7 () float)

(declare-fun tmp__split_fields8 () float)

(declare-fun tmp__split_fields9 () float)

(declare-fun result5 () (Array Int us_rep1))

(declare-fun l1 () (Array Int us_rep1))

(define-fun o9 () us_rep1 (mk___rep1
                          (mk___split_fields1 o2
                          (mk___rep (mk___split_fields o3 o4 o5 o6)))))
