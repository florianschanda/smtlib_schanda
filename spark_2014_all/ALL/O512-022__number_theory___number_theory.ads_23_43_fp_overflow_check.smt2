...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 161810004711151123046875.0 100000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 22360000610351562500000.0 10000000000000000000000.0))))
...
;; H
  ...
  (lt (of_int RNE1 o2)
  (add RNE1 (div1 RNE1 (power fliteral2 o1) fliteral3) fliteral)))))))
...
;; H
  ...
  (lt (of_int RNE1 o3)
  (add RNE1 (div1 RNE1 (power fliteral2 o) fliteral3) fliteral)))))))
...
;; H
  (assert (=> (< n 0) (neq fliteral2 zeroF)))

;; H
  (assert (= o6 (power fliteral2 n)))
