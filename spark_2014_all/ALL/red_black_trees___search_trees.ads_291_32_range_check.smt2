...
;; H
  (assert
  (and
  (= o98 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range4 o98)
  (= o98 (size
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i))
  (and
  (= o95 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o95)
  (= o95 (to_rep1
         (rec__search_trees__search_tree__root
         (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i)))
  (and
  (= o97 (root (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (and (in_range3 o97)
  (= o97 (to_rep1
         (rec__search_trees__search_tree__root
         (us_split_fields__content3 t__split_fields12))))))))
...
;; H
  ...
  (= (root
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3))) i)))
  (= result27 (ite (= o97 o96) true false))))
...
;; H
  (assert
  (and
  (= o94 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range4 o94)
  (and
  (= o94 (parent
...
;; H
  (assert
  (and
  (= o92 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         i))
  (and (in_range5 o92)
  (= o92 (position
         (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (and
  (= o91 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o89))
  (and (in_range4 o91)
  (and
  (= o91 (parent
...
;; H
  ...
  (= (root
     ...
     t__split_fields3))) i))
  (and
  (= o85 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o83))
  (and (in_range5 o85)
  (= o85 (position
         (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (root
     ...
     (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
     t__split_fields3))) i))
  (= result31 (ite (= o85 o84) true false))))
...
;; H
  ...
  (=> (= result33 true)
  (and
  (= o79 (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o78))
  (and (in_range4 o79)
  (and
  (= o79 (parent
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o55 o54) (in_range3 o54)))))
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (and (= o57 o56) (in_range3 o56)))))
...
;; H
  ...
  (=> (= result34 true)
  (and
  (= o66 (position1 (mk___rep3 (us_split_fields__content3 t__split_fields12))
         o65))
  (and (in_range5 o66)
  (= o66 (position
         (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (=> (= result33 true)
  (=> (= result34 true) (= result32 (ite (= o66 0) true false)))))
...
;; H
  ...
  (= (contains o47 (to_rep (select t__split_fields3 i1))) true))))
  (forall ((v Int))
  (=> (and (<= 0 v) (<= v 2147483647))
  (=> (= (contains o47 v) true)
  (exists ((i1 Int))
...
;; H
  (assert
  (and
  (= o46 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields12))))
  (ite (= (size
          (rec__search_trees__search_tree__struct
...
;; H
  (assert
  (and (= result39 (oeq2 o46 o47))
  (= (= result39 true) (and (= (ole o46 o47) true) (= (ole o47 o46) true)))))
...
;; H
  (assert
  (and
  (= o45 (peek1 (mk___rep3 (us_split_fields__content3 t__split_fields12)) 
         i 0))
  (and (in_range4 o45)
  (= o45 (peek
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields12)) i 0)))))
