...
(define-fun default_initial_assumption ((temp___expr_328 us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_359 us_rep2)
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (=> (= (get1 result i) (get1 result j)) (= (bool_eq10 i j) true))))))))) :pattern (
  (positions container)) )))
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k us_rep4))
     (and (= (has_key container k) true) (= (bool_eq10 k key) true)))
...
(declare-fun temp___815 () us_rep2)
...
(declare-fun s__split_fields4 () us_main_type)

(declare-fun s__split_fields5 () us_main_type)

(declare-fun s__split_fields6 () us_main_type)

(declare-fun s__split_fields7 () us_main_type)

(declare-fun result () Bool)

(define-fun s__split_fields8 () us_split_fields (mk___split_fields
                                                s__split_fields5))

(define-fun s__split_fields9 () us_split_fields (mk___split_fields
                                                s__split_fields4))
...
;; H
  ...
  (to_rep (rec__use_ordered_sets__my_sets__set__capacity s__split_discrs)) 5)))

;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields12)) 1) true)
  (ite (= (contains
          (model__
          (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 1) true)
  (and
  (and
  (and
  (= (oeq3
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (model__ (mk___rep s__split_discrs s__split_fields12))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields12))
     (positions
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields12))
     (find (elements (mk___rep s__split_discrs s__split_fields12)) 1)) 1))
  (= (equal_except
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields12))
     (find (elements (mk___rep s__split_discrs s__split_fields12)) 1)) true))
  (and
  (and
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields12)) (+ (length
                                                              (mk___rep
                                                              s__split_discrs
                                                              (mk___split_fields
                                                              s__split_fields))) 1))
  (= (ole
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (model__ (mk___rep s__split_discrs s__split_fields12))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields12))
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     1) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields12))
     (find (elements (mk___rep s__split_discrs s__split_fields12)) 1)) 1))
  (= (range_equal
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields12)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields12)) 1) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (elements (mk___rep s__split_discrs s__split_fields12))
     (find (elements (mk___rep s__split_discrs s__split_fields12)) 1)
     (length (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (positions (mk___rep s__split_discrs s__split_fields12))
     (find (elements (mk___rep s__split_discrs s__split_fields12)) 1) 1) true)))))

;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields11)) 2) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields12)) 2) true)
  (and
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields12))
     (model__ (mk___rep s__split_discrs s__split_fields11))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields11))
     (positions (mk___rep s__split_discrs s__split_fields12))) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields11))
     (find (elements (mk___rep s__split_discrs s__split_fields11)) 2)) 2))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields12))
     (elements (mk___rep s__split_discrs s__split_fields11))
     (find (elements (mk___rep s__split_discrs s__split_fields11)) 2)) true))
  (and
  (and
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields11)) (+ (length
                                                              (mk___rep
                                                              s__split_discrs
                                                              s__split_fields12)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields12))
     (model__ (mk___rep s__split_discrs s__split_fields11))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields11))
     (model__ (mk___rep s__split_discrs s__split_fields12)) 2) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields11))
     (find (elements (mk___rep s__split_discrs s__split_fields11)) 2)) 2))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields12))
     (elements (mk___rep s__split_discrs s__split_fields11)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields11)) 2) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields12))
     (elements (mk___rep s__split_discrs s__split_fields11))
     (find (elements (mk___rep s__split_discrs s__split_fields11)) 2)
     (length (mk___rep s__split_discrs s__split_fields12)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields12))
...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields10)) 3) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields11)) 3) true)
  (and
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields11))
     (model__ (mk___rep s__split_discrs s__split_fields10))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields10))
     (positions (mk___rep s__split_discrs s__split_fields11))) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields10))
     (find (elements (mk___rep s__split_discrs s__split_fields10)) 3)) 3))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields11))
     (elements (mk___rep s__split_discrs s__split_fields10))
     (find (elements (mk___rep s__split_discrs s__split_fields10)) 3)) true))
  (and
  (and
  (and
  (and
  ...
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields11))
     (model__ (mk___rep s__split_discrs s__split_fields10))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields10))
     (model__ (mk___rep s__split_discrs s__split_fields11)) 3) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields10))
     (find (elements (mk___rep s__split_discrs s__split_fields10)) 3)) 3))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields11))
     (elements (mk___rep s__split_discrs s__split_fields10)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields10)) 3) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields11))
     (elements (mk___rep s__split_discrs s__split_fields10))
     (find (elements (mk___rep s__split_discrs s__split_fields10)) 3)
...
;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields9)) 4) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields10)) 4) true)
  (and
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields10))
     (model__ (mk___rep s__split_discrs s__split_fields9))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields9))
     (positions (mk___rep s__split_discrs s__split_fields10))) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields9))
     (find (elements (mk___rep s__split_discrs s__split_fields9)) 4)) 4))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields10))
     (elements (mk___rep s__split_discrs s__split_fields9))
     (find (elements (mk___rep s__split_discrs s__split_fields9)) 4)) true))
  (and
  (and
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields9)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields10)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields10))
     (model__ (mk___rep s__split_discrs s__split_fields9))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields9))
     (model__ (mk___rep s__split_discrs s__split_fields10)) 4) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields9))
     (find (elements (mk___rep s__split_discrs s__split_fields9)) 4)) 4))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields10))
     (elements (mk___rep s__split_discrs s__split_fields9)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields9)) 4) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields10))
     (elements (mk___rep s__split_discrs s__split_fields9))
     (find (elements (mk___rep s__split_discrs s__split_fields9)) 4)
     (length (mk___rep s__split_discrs s__split_fields10)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields10))
     (positions (mk___rep s__split_discrs s__split_fields9))
     (find (elements (mk___rep s__split_discrs s__split_fields9)) 4) 1) true)))))

;; H
  (assert
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields8)) 5) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields9)) 5) true)
  (and
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields9))
     (model__ (mk___rep s__split_discrs s__split_fields8))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields8))
     (positions (mk___rep s__split_discrs s__split_fields9))) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields8))
     (find (elements (mk___rep s__split_discrs s__split_fields8)) 5)) 5))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields9))
     (elements (mk___rep s__split_discrs s__split_fields8))
     (find (elements (mk___rep s__split_discrs s__split_fields8)) 5)) true))
  (and
  (and
  (and
  (and
  (and
  (and
  (= (length (mk___rep s__split_discrs s__split_fields8)) (+ (length
                                                             (mk___rep
                                                             s__split_discrs
                                                             s__split_fields9)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields9))
     (model__ (mk___rep s__split_discrs s__split_fields8))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields8))
     (model__ (mk___rep s__split_discrs s__split_fields9)) 5) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields8))
     (find (elements (mk___rep s__split_discrs s__split_fields8)) 5)) 5))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields9))
     (elements (mk___rep s__split_discrs s__split_fields8)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields8)) 5) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields9))
     (elements (mk___rep s__split_discrs s__split_fields8))
     (find (elements (mk___rep s__split_discrs s__split_fields8)) 5)
     (length (mk___rep s__split_discrs s__split_fields9)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep s__split_discrs s__split_fields9))
...
;; H
  ...
  (and
  (and
  (= (length2 temp___815) (length
                          (mk___rep s__split_discrs
                          (mk___split_fields s__split_fields6))))
  (forall ((temp___390 Int))
  (=>
  (and (in_range4 temp___390)
  (= (iter_has_element temp___815 temp___390) true))
  (= (contains
     (model__
     (mk___rep s__split_discrs (mk___split_fields s__split_fields6)))
     (get temp___815 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range3 item)
  (= (contains
     (model__
     (mk___rep s__split_discrs (mk___split_fields s__split_fields6))) item) true))
  (and (< 0 (find temp___815 item))
  (= (equivalent_elements (get temp___815 (find temp___815 item)) item) true)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep s__split_discrs (mk___split_fields s__split_fields6)))))
  (and (= (find temp___815 (get temp___815 i)) i)
  (= (e_is_find temp___815 (get temp___815 i) i) true)))))))

;; H
  (assert
  (and (= o3 (iter_has_element temp___815 temp___814))
  (= (= o3 true) (and (<= 1 temp___814) (<= temp___814 (last temp___815))))))

;; H
  (assert (= (= o4 true) (in_range4 temp___814)))
...
;; H
  (assert
  (= (= o5 true)
  (let ((temp___818 (elements
                    (mk___rep s__split_discrs
                    (mk___split_fields s__split_fields6)))))
  (forall ((temp___817 Int))
  (=>
  (and (in_range4 temp___817)
  (= (iter_has_element temp___818 temp___817) true))
  (let ((e (get temp___818 temp___817)))
  (or
  (= (contains
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     e) true)
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep s__split_discrs (mk___split_fields s__split_fields6))) e) true)))))
...
;; H
  ...
  (= (contains
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     item) true))
  (= (contains o item) true))))))

(assert
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not (in_range1
  (+ (length (mk___rep s__split_discrs (mk___split_fields s__split_fields))) 5))))
(check-sat)
