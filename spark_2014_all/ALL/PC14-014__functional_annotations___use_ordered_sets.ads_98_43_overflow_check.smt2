...
(((mk_cursor__ref (cursor__content us_rep4)))))
...
(((mk_key_type__ref (key_type__content us_rep4)))))
...
(define-fun element_type__ref___5__projection ((a element_type__ref3)) element_type3
