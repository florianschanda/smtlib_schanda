...
;; H
  (assert
  (and (= o15 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o15)
  (<= o15 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o9 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o9 true false true)
  (and (= (to_rep (first (rt o9))) 1) (<= 0 (to_rep (last (rt o9)))))))))
...
;; H
  (assert
  (and (<= (to_rep (first (rt temp___484))) j)
  (<= j (to_rep (last (rt temp___484))))))
...
;; H
  (assert
  (and (= temp___482 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 temp___482 true false true)
  (and (= (to_rep (first (rt temp___482))) 1)
  (<= 0 (to_rep (last (rt temp___482))))))))

(assert
;; WP_parameter_def
 ;; File "list.ads", line 9, characters 0-0
  (not (<= (to_rep (first (rt temp___482))) j)))
(check-sat)
(exit)
