...
(declare-datatypes ((tS129bP1__ref 0))
(((mk_tS129bP1__ref (tS129bP1__content tdigit_count_typeB)))))
...
(((mk_s129b__ref (s129b__content us_t3)))))
...
(((mk_t131b__ref (t131b__content tdigit_count_typeB)))))
...
(((mk_t132b__ref (t132b__content us_t4)))))
...
(declare-datatypes ((tS133bP1__ref 0))
(((mk_tS133bP1__ref (tS133bP1__content tdigit_count_typeB)))))
...
(((mk_s133b__ref (s133b__content us_t5)))))
...
(declare-datatypes ((t135b__ref 0))
(((mk_t135b__ref (t135b__content tdigit_count_typeB)))))
...
(((mk_t136b__ref (t136b__content us_t6)))))
...
;; H
  (assert
  (= (to_rep2 (first9 (rt4 (temp___1067 ((_ int2bv 8) 0) 1 r130b)))) 1))

;; H
  (assert
  (= (to_rep2 (last10 (rt4 (temp___1067 ((_ int2bv 8) 0) 1 r130b))))
  r130b))
...
;; H
  (assert
  (= (to_rep2 (first13 (rt6 (temp___1080 ((_ int2bv 8) 0) 1 r134b)))) 1))

;; H
  (assert
  (= (to_rep2 (last14 (rt6 (temp___1080 ((_ int2bv 8) 0) 1 r134b))))
  r134b))
