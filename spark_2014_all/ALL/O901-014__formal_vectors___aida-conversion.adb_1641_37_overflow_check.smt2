...
;; H
  (assert
  (and (= o12 (+ (to_rep1 (first (rt source))) 4)) (in_range1
...
;; H
  ...
  (forall ((index1 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 4) index1)
  (<= index1 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index1))) true)))))

;; H
  (assert
  (and (= temp___2050 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2050)
  (<= temp___2050 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___2049 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2049)
  (<= temp___2049 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___2048 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2048)
  (<= temp___2048 (to_rep1 (last (rt source))))))
