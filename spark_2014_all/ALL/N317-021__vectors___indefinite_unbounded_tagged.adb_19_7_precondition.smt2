...
(define-fun o6 () us_rep (mk___rep (mk___split_fields o o1) o2))
...
;; H
  ...
  (= (let ((temp___410 (get
     ...
     (ite (= (attr__tag temp___410) o2) (us_dispatch_eq temp___410 o6) false)) true)))
...
;; H
  (assert
  (and (= (mk___rep (mk___split_fields o3 o4) o5) (f 2))
...
;; WP_parameter_def
 ;; File "a-cfinve.ads", line 813, characters 0-0
  (not
  (< (length (mk___rep1 v__split_discrs v__split_fields2)) (capacity
                                                           (mk___rep1
                                                           v__split_discrs
                                                           v__split_fields2)))))
(check-sat)
