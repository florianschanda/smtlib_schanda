...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__rec__sub_arr__content us_t)))))
...
(declare-datatypes ()
((sub_arr__ref (mk_sub_arr__ref (sub_arr__content us_rep)))))
...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__rec__sub_arr__content1 us_t1)))))
(define-fun us_split_fields_Content__3__projection ((a us_split_fields2)) us_t1
