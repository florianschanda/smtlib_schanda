...
(declare-fun temp___411 () Int)

(declare-fun o2 () Int)

(declare-fun temp___412 () (Array Int cardindex))

(declare-fun o3 () Int)

(declare-fun o4 () cardindex)

(declare-fun temp___414 () Int)
...
(declare-fun o9 () cardindex)

(declare-fun o10 () Int)

(declare-fun o11 () cardindex)

(declare-fun temp___408 () Int)

(declare-fun o12 () Int)

(declare-fun o13 () cardindex)
...
;; H
  (assert
  (= o23 (select (rec__patience__state__posstack (us_split_fields1 s))
  o22)))
...
;; H
  (assert
  (= o20 (select (rec__patience__state__posstack (us_split_fields1 s))
  o19)))
...
;; H
  (assert (= o26 (ite (<= 0 o21) true false)))

;; H
  (assert (= result2 (ite (= o26 true) o25 false)))

;; H
  (assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))

;; H
  (assert (=> (= result2 true) (= o10 i)))

;; H
  (assert
  (=> (= result2 true)
  (= o11 (select (rec__patience__state__posstack (us_split_fields1 s))
  o10))))

;; H
  (assert (=> (= result2 true) (= temp___408 (to_rep1 o11))))

;; H
  (assert (=> (= result2 true) (and (<= 0 temp___408) (<= temp___408 99))))

;; H
  (assert (=> (= result2 true) (= o12 temp___408)))

;; H
  (assert
  (=> (= result2 true)
  (= o13 (select (rec__patience__state__stacksizes (us_split_fields1 s))
  o12))))

;; H
  (assert (=> (= result2 true) (= o14 (to_rep1 o13))))

;; H
  (assert (=> (= result2 true) (= o15 (- o14 1))))

;; H
  (assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))

;; H
  (assert (=> (= result2 true) (= o8 i)))

;; H
  (assert
  (=> (= result2 true)
  (= o9 (select (rec__patience__state__posheight (us_split_fields1 s))
  o8))))

;; H
  (assert (=> (= result2 true) (= o16 (to_rep1 o9))))

;; H
  (assert (=> (= result2 true) (= o17 (ite (<= o16 o15) true false))))

;; H
  (assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))

;; H
  (assert (=> (= result2 true) (= o5 i)))

;; H
  (assert
  (=> (= result2 true)
  (= o6 (select (rec__patience__state__posheight (us_split_fields1 s))
  o5))))

;; H
  (assert (=> (= result2 true) (= o7 (to_rep1 o6))))

;; H
  (assert (=> (= result2 true) (= o18 (ite (<= 0 o7) true false))))

;; H
  (assert (=> (= result2 true) (= result1 (ite (= o18 true) o17 false))))
...
;; H
  (assert
  (= o1 (select (rec__patience__state__posstack (us_split_fields1 s))
  o)))

;; H
  (assert (= temp___411 (to_rep1 o1)))

;; H
  (assert (and (<= 0 temp___411) (<= temp___411 99)))

;; H
  (assert (= o2 temp___411))

;; H
  (assert
  (= temp___412 (select (rec__patience__state__stacks (us_split_fields1 s))
  o2)))
...
;; H
  (assert
  (= o4 (select (rec__patience__state__posheight (us_split_fields1 s))
  o3)))

;; H
  (assert (= temp___414 (to_rep1 o4)))
