...
;; H
  ...
  (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields2))
     e
  ...
  (and
  (and (not (= i true))
  (= (oeq4 (model__ (mk___rep l__split_discrs l__split_fields2))
  ...
  (= (oeq2 (positions (mk___rep l__split_discrs l__split_fields2))
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true))
  (and
  (and
  ...
  (= (range_equal
     ...
     (- (get (positions (mk___rep l__split_discrs l__split_fields2))
        (mk___rep1 cu__split_fields1)) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
