...
(((mk_tTrSP1__ref (tTrSP1__content my_index)))))
...
(((mk___t1 (elts1 (Array (_ BitVec 64) Bool))(rt1 t1)))))
...
(declare-datatypes ((t2b__ref 0)) (((mk_t2b__ref (t2b__content my_index)))))
...
(((mk___t2 (elts2 (Array (_ BitVec 64) Bool))(rt2 t2)))))
...
;; H
  (assert (bvule ((_ int2bv 64) 0) last2))
