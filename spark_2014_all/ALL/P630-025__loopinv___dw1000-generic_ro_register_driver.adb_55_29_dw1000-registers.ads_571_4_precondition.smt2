...
(define-fun us_split_fields__ref___83__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___83__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun register_type__ref___200__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___141__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___141__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6766 us_t1)
  (temp___is_init_6763 Bool) (temp___skip_constant_6764 Bool)
  (temp___do_toplevel_6765 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6764 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6766)
                                       (last3 temp___expr_6766))
                                       (and (= (first3 temp___expr_6766) 1)
                                       (= (last3 temp___expr_6766) 2)))))
