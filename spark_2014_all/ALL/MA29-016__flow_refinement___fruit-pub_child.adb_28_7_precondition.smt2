...
(declare-fun fruits1 () us_private)
...
(declare-fun price_related_stuff1 () us_private)
...
;; H
  ...
  (and
  (and
  (and (and (in_range1 apples1) (in_range1 oranges1)) (in_range1
  price_of_apple1)) (in_range1 price_of_orange1)) (in_range1 extra_cost1)))

;; H
  (assert
  (and (= o11 (* fruit_salads_made1 oranges_in_fruit_salad)) (in_range
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (<= o12 (number_of_oranges apples1 fruits1 oranges1 price_of_apple1
          price_of_orange1 extra_cost1 price_related_stuff1))))
(check-sat)
(exit)
