...
;; H
  (assert
  (= (let ((temp___223 (to_model (mk___rep r__split_fields7))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields7)) x)))
     (let ((temp___230 (to_model (mk___rep r__split_fields6))))
