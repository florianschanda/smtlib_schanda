...
(declare-fun atan__2 (t) t)

(declare-fun atan__2__function_guard (t t) Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 3141592653589793115997963468544185161590576171875000.0 1000000000000000000000000000000000000000000000000000.0))))

;; pi__def_axiom
  (assert (= pi1 fliteral2))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 15707963267948965579989817342720925807952880859375000.0 10000000000000000000000000000000000000000000000000000.0))))

;; pi_over_two__def_axiom
  (assert (= pi_over_two fliteral3))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite result__)))

;; H
  (assert (tqtisFinite pi1))

;; H
  (assert (tqtisFinite pi_over_two))

;; H
  (assert (not (and (eq left fliteral4) (eq right fliteral4))))

;; H
  (assert (not (le (abs1 left) (abs1 right))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (div1 RNE1 right left))))
(check-sat)
