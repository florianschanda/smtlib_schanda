...
(declare-fun o22 () return_code_t)

(declare-fun o23 () us_split_discrs)

(declare-fun temp___332 () us_rep2)
...
;; H
  (assert (not (= count1 ((_ int2bv 16) 0))))

;; H
  (assert
  (= (to_rep2
     (rec__parse__parse_result_t__return_code result____split_discrs5))
  r18b))
...
;; H
  (assert (= (to_rep2 o22) 1))

;; H
  (assert (= o23 (mk___split_discrs o22)))

;; H
  (assert (= temp___332 (mk___rep2 o23 (mk___split_fields2 dummy6) true)))
...
;; WP_parameter_def
 ;; File "parse.ads", line 16, characters 0-0
  (not
  (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___332))
  (rec__parse__parse_result_t__return_code result____split_discrs5))))
(check-sat)
(exit)
