...
(((mk_tuint_64B__ref (tuint_64B__content tuint_64B)))))
...
(((mk_uint_64__ref (uint_64__content uint_64)))))
...
;; H
  (assert
  (and (= o12 (* result_hi1 4294967296)) (in_range1
  (* result_hi1 4294967296))))
...
;; H
  (assert
  (and (= o14 (* remainder1 4294967296)) (in_range1
  (* remainder1 4294967296))))
