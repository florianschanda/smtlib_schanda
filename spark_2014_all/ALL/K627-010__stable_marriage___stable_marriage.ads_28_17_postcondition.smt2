...
(define-fun bool_eq1 ((a (Array Int group1_id)) (a__first Int) (a__last Int)
...
(assert
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 3, characters 0-0
  (not (not (= (to_rep (select r1 rank1)) (to_rep (select r1 rank2))))))
(check-sat)
