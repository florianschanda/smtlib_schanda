...
(declare-fun temp___389 () (Array Int cardindex))

(declare-fun o6 () Int)

(declare-fun temp___391 () (Array Int cardindex))
...
;; H
  (assert
  (= temp___391 (select (rec__patience__state__stacks (us_split_fields1 s))
  o6)))
...
;; H
  (assert (= o8 (select temp___391 o7)))
...
;; H
  (assert
  (= temp___389 (select (rec__patience__state__stacks (us_split_fields1 s))
  o5)))
