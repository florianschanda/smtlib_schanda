...
(((mk___split_fields (rec__p__po1T__content integer)))))
...
(declare-datatypes ((po1T__ref 0)) (((mk_po1T__ref (po1T__content us_rep)))))
...
(((mk___split_fields1 (rec__q__po2T__content integer)))))
...
(((mk_po2T__ref (po2T__content us_rep1)))))
