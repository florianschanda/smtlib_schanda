...
(declare-datatypes ((tT78bP1__ref 0))
(((mk_tT78bP1__ref (tT78bP1__content tdigit_count_typeB)))))
(define-fun tT78bP1__ref___projection ((a tT78bP1__ref)) tdigit_count_typeB
  (tT78bP1__content a))
...
(declare-datatypes ((t78b__ref 0)) (((mk_t78b__ref (t78b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits__21__projection ((a us_split_fields2)) us_t1
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ((us_split_fields__ref1 0))
(((mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___21__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1
  (us_split_discrs2 us_split_discrs)(us_split_fields3 us_split_fields2)))))
(define-fun us_rep___41__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                  a))

(define-fun us_rep___42__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))
...
(((mk_t79b__ref (t79b__content tdigit_count_typeB)))))
(define-fun t79b__ref___projection ((a t79b__ref)) tdigit_count_typeB
  (t79b__content a))
...
(declare-datatypes ((t80b__ref 0)) (((mk_t80b__ref (t80b__content us_t2)))))
...
;; def_axiom
  (assert
  (forall ((temp___929 (_ BitVec 8)))
  (forall ((temp___930 Int) (temp___931 Int))
  (let ((temp___928 (temp___927 temp___929 temp___930 temp___931)))
  (and
  (=> (dynamic_property6 1 65536 temp___930 temp___931)
  (and (= (first5 temp___928) temp___930) (= (last5 temp___928) temp___931)))
  (forall ((temp___932 Int))
  (= (select (to_array2 temp___928) temp___932) (of_rep1 temp___929))))))))
...
;; H
  (assert
  (= (mk___t2 temp___934 temp___9341) (temp___927 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9341)) (to_rep2 (last4 temp___9341)))
     (+ (- (to_rep2 (last4 temp___9341)) (to_rep2 (first4 temp___9341))) 1)
     0) (ite (<= 1 (to_rep
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9341)) (to_rep2 (last4 temp___9341)))
  temp___9351))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9351)) (to_rep2 (last2 temp___9351)))
     (+ (- (to_rep2 (last2 temp___9351)) (to_rep2 (first2 temp___9351))) 1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9381 temp___9382))))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___947)
  (<= temp___947 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___947) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           result____split_fields2)) temp___947))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
