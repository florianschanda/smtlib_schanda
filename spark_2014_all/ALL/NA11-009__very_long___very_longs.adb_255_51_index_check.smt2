...
(declare-datatypes ()
((tT78bP1__ref (mk_tT78bP1__ref (tT78bP1__content tdigit_count_typeB)))))
...
(declare-datatypes ()
((t79b__ref (mk_t79b__ref (t79b__content tdigit_count_typeB)))))
...
(declare-fun temp___934 () (Array Int octet))

(declare-fun temp___9341 () t2)

(declare-fun temp___935 () (Array Int octet))

(declare-fun temp___9351 () t1)
...
(declare-fun temp___938 () digit_index_type)

(declare-fun temp___9381 () (Array Int octet))

(declare-fun temp___9382 () t1)
