...
(define-fun dynamic_invariant1 ((temp___expr_219 (_ BitVec 8))
...
;; takelsb_from16__post_axiom
  ...
  (! (=> (dynamic_invariant value true true true) (dynamic_invariant1
     (takelsb_from16 value) true false true)) :pattern ((takelsb_from16
                                                        value)) )))
...
;; shift_right__post_axiom
  ...
  (forall ((count Int))
  (! (=>
     (and (dynamic_invariant value true true true) (dynamic_invariant2 count
     true true true))
...
(define-fun dynamic_invariant4 ((temp___expr_282 us_rep)
...
(define-fun dynamic_invariant5 ((temp___expr_801 Int)
...
(define-fun default_initial_assumption ((temp___expr_822 us_rep1)
  (temp___skip_top_level_823 Bool)) Bool (= (to_rep2
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs2
                                            temp___expr_822))) (+ (* 2
  (to_rep2
...
(define-fun default_initial_assumption1 ((temp___expr_834 us_rep2)
  (temp___skip_top_level_835 Bool)) Bool (= (to_rep2
                                            (rec__aco__math__very_longs__very_long__octet_length
                                            (us_split_discrs3
                                            temp___expr_834))) (to_rep2
                                                               (rec__aco__math__very_longs__very_long__octet_length
                                                               (us_split_discrs1
                                                               divisor)))))
...
;; H
  (assert
  (and (<= (to_rep1 (first quotient__split_fields1)) j)
  (<= j (to_rep1 (last quotient__split_fields1)))))
...
;; H
  (assert
  (= quotient__split_fields2 (mk___split_fields
                             (mk___t temp___15761 temp___15762))))
...
;; H
  ...
  (<= (to_rep1
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      quotient__split_fields2)))) j)
  (<= j (to_rep1
        (last
        (rt
        (rec__aco__math__very_longs__very_long__long_digits
        quotient__split_fields2)))))))
...
;; H
  ...
  (= o13 (store (elts
                (rec__aco__math__very_longs__very_long__long_digits
                quotient__split_fields2)) o12 o11)))
...
;; H
  ...
  (= temp___1590 (mk___rep1 u__split_discrs
                 (mk___split_fields1
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) true
  true true) (and (<= 1 divisor_index2) (<= divisor_index2 r132b)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (and (<= (to_rep1 (first4 v__split_fields1)) divisor_index2)
  (<= divisor_index2 (to_rep1 (last5 v__split_fields1))))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= o21 (select v__split_fields o20))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= o23 ((_ zero_extend 8) o22))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (and (= o16 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= o26 (bvadd o25 carry2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= result4 (mk_t__ref1 sum2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= sum3 o26)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= o28 (takelsb_from16 sum3))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (and (= o27 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= o33 (mk___split_fields1 o32))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= temp___1587 (mk___rep1 u__split_discrs o33))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= result5 (mk___split_fields__ref1 u__split_fields3))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= u__split_fields4 (us_split_fields3 temp___1587))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= u__split_discrs (us_split_discrs2 temp___1587))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (and (= o34 (shift_right sum3 8))
  (= o34 (bvudiv sum3 (ite (< 8 65536)
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= result6 (mk_t__ref1 carry2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= carry3 o34)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b))
  (= divisor_index2 r132b)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= sum5 sum3)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= sum6 sum4)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r132b)) (= sum7 sum5)))
...
;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r132b)))
...
;; H
  ...
  (<= (to_rep1
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1596)
  (<= temp___1596 (to_rep1
                  (last3
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
...
;; H
  (assert (= o36 temp___1596))

;; H
  (assert
  (= o37 (select (elts1
                 (rec__aco__math__very_longs__very_long__long_digits1
                 (us_split_fields__content1 u__split_fields7))) o36)))
