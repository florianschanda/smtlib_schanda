...
(define-fun use_ordered_maps__apply_f_2__cu__assume1 () us_rep1 (mk___rep1
                                                                (mk___split_fields1
                                                                use_ordered_maps__apply_f_2__cu__assume)))
...
;; H
  (assert
  (and (= use_ordered_maps__apply_f_2__cu__assume1 (first s))
  (ite (= (= (length s) 0) true)
  (= (bool_eq1 use_ordered_maps__apply_f_2__cu__assume1 no_element) true)
  (and
  (= (has_key1 (positions s) use_ordered_maps__apply_f_2__cu__assume1) true)
  (= (get1 (positions s) use_ordered_maps__apply_f_2__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= result1 (has_key1 (positions s) (mk___rep1 cu__split_fields4)))
  (= (= result1 true)
  (= (has_key1 (positions s) (mk___rep1 cu__split_fields4)) true))))
...
;; H
  (assert
  (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields4))))
  (forall ((temp___689 Int))
  (=>
  (and (in_range3 temp___689)
  (= (iter_has_element temp___690 temp___689) true))
  (exists ((i Int))
  (and
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
  (= (get temp___690 temp___689) (get (keys s) i))))))))
...
;; H
  (assert
  (and (= o1 (element s (mk___rep1 cu__split_fields3)))
  (and (in_range7 o1)
  (= o1 (get2 (model__ s) (key s (mk___rep1 cu__split_fields3)))))))
...
;; H
  (assert
  (and (= o (key s (mk___rep1 cu__split_fields3)))
  (and (in_range6 o)
  (= o (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields3)))))))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 34, characters 0-0
  (not
  (or (= (has_key1 (positions s) (mk___rep1 cu__split_fields3)) true)
