...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ 0 result) 3) (dynamic_invariant result true false true))) :pattern (
  (length1 container)) )))
