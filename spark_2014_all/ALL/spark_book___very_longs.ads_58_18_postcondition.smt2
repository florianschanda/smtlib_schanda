...
(declare-fun temp___999 () us_rep1)
...
(declare-fun temp___983 () us_rep1)
...
;; H
  ...
  (= temp___999 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (= temp___989 (mk___rep1 result____split_discrs result____split_fields3)))))
...
;; H
  ...
  (<= i3 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (=> (= result6 true) (= temp___983 (mk___rep1 result____split_discrs o29))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (=> (= result6 true)
  (= result____split_fields5 (us_split_fields3 temp___983))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (=> (= result6 true)
  (= result____split_discrs (us_split_discrs2 temp___983))))))
