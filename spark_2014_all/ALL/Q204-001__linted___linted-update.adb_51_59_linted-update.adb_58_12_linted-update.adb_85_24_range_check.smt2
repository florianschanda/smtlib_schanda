...
(((mk_map__ref (map__content (Array Int storage_element))))))
...
(((mk_tintB__ref (tintB__content tintB)))))
...
(declare-datatypes ((nat__ref 0)) (((mk_nat__ref (nat__content nat)))))
...
(((mk_packet__ref (packet__content us_rep)))))
...
(((mk_tstorageP1__ref (tstorageP1__content tstorageP1)))))
...
(((mk_ttupleP1__ref (ttupleP1__content ttupleP1)))))
...
(declare-datatypes ((t43b__ref 0)) (((mk_t43b__ref (t43b__content t43b)))))
...
(declare-datatypes ((t56b__ref 0)) (((mk_t56b__ref (t56b__content t56b)))))
...
(declare-datatypes ((t60b__ref 0)) (((mk_t60b__ref (t60b__content t60b)))))
...
(declare-datatypes ((t68b__ref 0)) (((mk_t68b__ref (t68b__content t68b)))))
...
(declare-datatypes ((t70b__ref 0)) (((mk_t70b__ref (t70b__content t70b)))))
...
(declare-datatypes ((t83b__ref 0)) (((mk_t83b__ref (t83b__content t83b)))))
...
(declare-datatypes ((t87b__ref 0)) (((mk_t87b__ref (t87b__content t87b)))))
...
(declare-datatypes ((t91b__ref 0)) (((mk_t91b__ref (t91b__content t91b)))))
...
(declare-datatypes ((t95b__ref 0)) (((mk_t95b__ref (t95b__content t95b)))))
...
(declare-datatypes ((t97b__ref 0)) (((mk_t97b__ref (t97b__content t97b)))))
...
(((mk_t110b__ref (t110b__content t110b)))))
...
(((mk_t114b__ref (t114b__content t114b)))))
...
(((mk_t118b__ref (t118b__content t118b)))))
...
(((mk_t122b__ref (t122b__content t122b)))))
...
(((mk_t124b__ref (t124b__content t124b)))))
...
(((mk_t137b__ref (t137b__content t137b)))))
...
(((mk_t141b__ref (t141b__content t141b)))))
...
(((mk_t145b__ref (t145b__content t145b)))))
...
(((mk_t149b__ref (t149b__content t149b)))))
...
(((mk_t151b__ref (t151b__content t151b)))))
...
(((mk_t164b__ref (t164b__content t164b)))))
...
(((mk_t168b__ref (t168b__content t168b)))))
...
(((mk_t172b__ref (t172b__content t172b)))))
...
(((mk_t176b__ref (t176b__content t176b)))))
...
(((mk_t178b__ref (t178b__content t178b)))))
...
(((mk_t184b__ref (t184b__content t184b)))))
...
(((mk_t186b__ref (t186b__content t186b)))))
...
(((mk_t188b__ref (t188b__content t188b)))))
...
(((mk_t190b__ref (t190b__content t190b)))))
...
(((mk_t192b__ref (t192b__content t192b)))))
...
(((mk_t198b__ref (t198b__content t198b)))))
...
(((mk_t200b__ref (t200b__content t200b)))))
...
(((mk_t202b__ref (t202b__content t202b)))))
...
(((mk_t204b__ref (t204b__content t204b)))))
...
(define-fun y16 () int__ref (mk_int__ref y4))

(define-fun y17 () int__ref (mk_int__ref y3))

(define-fun y18 () int__ref (mk_int__ref y2))

(define-fun y19 () int__ref (mk_int__ref y1))

(define-fun y20 () int__ref (mk_int__ref y))
...
;; H
  ...
  (and (= o18 (bv2nat x5)) (in_range1 (bv2nat x5)))))

;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= result1 y20)))

;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= y6 o18)))

;; H
  (assert
  (=> (not (bvule x5 ((_ int2bv 32) 2147483647)))
  (and (= o19 (bv2nat (bvnot x5))) (in_range1 (bv2nat (bvnot x5))))))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= o20 (- o19))))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= o21 (- o20 1))))
...
;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= result2 y20)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y7 o22)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y6 y7)))
...
;; H
  ...
  (and (= o50 (bv2nat x6)) (in_range1 (bv2nat x6)))))

;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= result5 y19)))

;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= y8 o50)))

;; H
  (assert
  (=> (not (bvule x6 ((_ int2bv 32) 2147483647)))
  (and (= o51 (bv2nat (bvnot x6))) (in_range1 (bv2nat (bvnot x6))))))

;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= o52 (- o51))))

;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= o53 (- o52 1))))
...
;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= result6 y19)))

;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= y9 o54)))

;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= y8 y9)))
...
;; H
  ...
  (and (= o82 (bv2nat x7)) (in_range1 (bv2nat x7)))))

;; H
  (assert (=> (bvule x7 ((_ int2bv 32) 2147483647)) (= result9 y18)))

;; H
  (assert (=> (bvule x7 ((_ int2bv 32) 2147483647)) (= y10 o82)))

;; H
  (assert
  (=> (not (bvule x7 ((_ int2bv 32) 2147483647)))
  (and (= o83 (bv2nat (bvnot x7))) (in_range1 (bv2nat (bvnot x7))))))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= o84 (- o83))))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= o85 (- o84 1))))
...
;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= result10 y18)))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= y11 o86)))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= y10 y11)))
...
;; H
  ...
  (and (= o114 (bv2nat x8)) (in_range1 (bv2nat x8)))))

;; H
  (assert (=> (bvule x8 ((_ int2bv 32) 2147483647)) (= result13 y17)))

;; H
  (assert (=> (bvule x8 ((_ int2bv 32) 2147483647)) (= y12 o114)))

;; H
  (assert
  (=> (not (bvule x8 ((_ int2bv 32) 2147483647)))
  (and (= o115 (bv2nat (bvnot x8))) (in_range1 (bv2nat (bvnot x8))))))

;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= o116 (- o115))))

;; H
  (assert
  (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= o117 (- o116 1))))
...
;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= result14 y17)))

;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= y13 o118)))

;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= y12 y13)))
...
;; H
  ...
  (and (= o139 (bv2nat x9)) (in_range1 (bv2nat x9)))))

;; H
  (assert (=> (bvule x9 ((_ int2bv 32) 2147483647)) (= result17 y16)))

;; H
  (assert (=> (bvule x9 ((_ int2bv 32) 2147483647)) (= y14 o139)))

;; H
  (assert
  (=> (not (bvule x9 ((_ int2bv 32) 2147483647)))
  (and (= o140 (bv2nat (bvnot x9))) (in_range1 (bv2nat (bvnot x9))))))

;; H
  (assert (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= o141 (- o140))))

;; H
  (assert
  (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= o142 (- o141 1))))
...
;; H
  (assert (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= result18 y16)))

;; H
  (assert (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= y15 o143)))

;; H
  (assert (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= y14 y15)))
