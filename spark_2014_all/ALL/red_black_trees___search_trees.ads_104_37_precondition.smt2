...
;; H
  (assert
  (=> (not (= (int__content i14) 0)) (= o35 (select temp___776 o34))))
...
;; H
  (assert
  (=> (not (= (int__content i14) 0))
  (= result23 (rec__tree_model__path_type__k o36))))
...
;; H
  ...
  (= o32 (root
         ...
         (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))
         t__split_fields3))))
  (and (in_range3 o32) (= o32 (to_rep1 t__split_fields))))))
...
;; H
  ...
  (=> (= result23 true)
  (and
  (= o33 (root (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (and (in_range3 o33)
  (= o33 (to_rep1
         (rec__search_trees__search_tree__root
         (us_split_fields__content3 t__split_fields14))))))))
...
;; H
  ...
  (=> (= result22 true)
  (and
  (= o31 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (and (in_range4 o31)
  (= o31 (size
         (rec__search_trees__search_tree__struct
         (us_split_fields__content3 t__split_fields14))))))))
...
;; H
  ...
  (=> (= result21 true)
  (and
  (= o30 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14))))
  (ite (= (size
          (rec__search_trees__search_tree__struct
...
;; H
  ...
  (= (contains o29 (to_rep (select t__split_fields3 i16))) true))))
  (forall ((v1 Int))
  (=> (and (<= 0 v1) (<= v1 2147483647))
...
;; H
  (assert
  (=> (= result21 true)
  (and (= result20 (is_add__2 o29 v o30))
  (= (= result20 true)
  (and
  (and (and (not (= (contains o29 v) true)) (= (contains o30 v) true))
  (= (ole o29 o30) true)) (= (included_except o30 o29 v) true))))))
