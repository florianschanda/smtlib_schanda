...
;; H
  (assert
  (and (= o32 (+ 48 (div1 localvalue1 10))) (in_range3
  (+ 48 (div1 localvalue1 10)))))

;; H
  (assert (= (to_rep o33) o32))

;; H
  (assert (= o34 (store localtext1 1 o33)))

;; H
  (assert (= result3 (mk_map__ref localtext1)))

;; H
  (assert (= localtext2 o34))

;; H
  (assert (= (to_rep o35) (+ 48 (mod2 localvalue1 10))))

;; H
  (assert (= o36 (store localtext2 2 o35)))

;; H
  (assert (= result4 (mk_map__ref localtext2)))

;; H
  (assert (= localtext3 o36))

;; H
  (assert (= result5 (mk_int__ref localvalue1)))

;; H
  (assert (= localvalue2 (div1 (mod2 c38b 36000) 600)))
