...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 16000000000000000888178419700125232338905334472656250.0 10000000000000000000000000000000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 15000000000000000000000000000000000000000000000000000.0 10000000000000000000000000000000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 13999999999999999111821580299874767661094665527343750.0 10000000000000000000000000000000000000000000000000000.0))))
...
;; H
  (assert (=> (= (bool_eq x (neg fliteral4)) true) (= i2 (- 2))))

;; H
  (assert (=> (= (bool_eq x (neg fliteral5)) true) (= i2 (- 1))))

;; H
  (assert (=> (= (bool_eq x (neg fliteral)) true) (= i2 (- 1))))

;; H
  (assert (=> (= (bool_eq x fliteral6) true) (= i2 0)))

;; H
  (assert (=> (= (bool_eq x fliteral) true) (= i2 1)))

;; H
  (assert (=> (= (bool_eq x fliteral5) true) (= i2 1)))

;; H
  (assert (= (bool_eq x fliteral4) true))
