...
(define-fun o30 () us_rep (mk___rep (mk___split_discrs o18)
                          (mk___split_fields o19 o20 o21 o22)))

(define-fun o31 () us_rep (mk___rep (mk___split_discrs o13)
...
;; H
  (assert
  (= o31 (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12))))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs subty__p__z__assume)
     ...
     subty__p__z__assume3 subty__p__z__assume4)) o30))
...
;; H
  (assert
  (and (= o29 (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))
  (in_range (+ (to_rep (rec__basic__r__a_field (us_split_fields1 v))) 1))))
