...
(define-fun register_type__ref_113__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_80__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_80__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4851 us_t1)
  (temp___is_init_4848 Bool) (temp___skip_constant_4849 Bool)
  (temp___do_toplevel_4850 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4849 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_4851)
                                       (last3 temp___expr_4851))
                                       (and (= (first3 temp___expr_4851) 1)
                                       (= (last3 temp___expr_4851) 4)))))
