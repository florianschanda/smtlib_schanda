...
(define-fun o21 () us_rep1 (mk___rep1 (mk___split_fields1 o7)))
...
;; H
  (assert
  (and (= o21 (first (mk___rep my_container__split_fields1)))
  (= (of_rep 1) o7)))

;; H
  (assert (= temp___572 (mk_cursor__ref o21)))
...
;; H
  (assert (and (= o19 (+ x31 1)) (in_range3 (+ x31 1))))
...
;; H
  (assert (= result35 (mk_int__ref temp___582)))

;; H
  (assert (= temp___5821 i10))

;; H
  (assert (= result36 (mk_int__ref temp___583)))

;; H
  (assert (= temp___5831 x33))
...
;; H
  (assert (and (= o20 (+ x33 1)) (in_range3 (+ x33 1))))
