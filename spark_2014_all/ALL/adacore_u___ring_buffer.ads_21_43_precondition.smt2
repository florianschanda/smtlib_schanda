...
;; H
  (assert (and (= o7 (length s2)) (and (in_range4 o7) (<= (+ 0 o7) 100))))

;; H
  (assert (= o8 (- o7 1)))

;; H
  (assert (and (= o9 (length s1)) (and (in_range4 o9) (<= (+ 0 o9) 100))))

;; H
  (assert (= result1 (ite (= o9 o8) true false)))

;; H
  (assert (=> (= result1 true) (and (= o6 (get s2 1)) (in_range5 o6))))

;; H
  (assert (=> (= result1 true) (= result (ite (= o6 e) true false))))
...
;; H
  (assert (and (= o3 (+ i 1)) (in_range1 (+ i 1))))

;; H
  (assert (and (= o4 o3) (in_range3 o3)))

;; H
  (assert (and (= o5 (get s2 o4)) (in_range5 o5)))
