...
;; H
  ...
  (= o2 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
...
;; H
  ...
  (= o3 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))
...
;; H
  (assert (= result1 (ite (<= o1 268435455) true false)))
