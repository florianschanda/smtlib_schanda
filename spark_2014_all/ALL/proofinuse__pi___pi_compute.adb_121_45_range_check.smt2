...
(declare-fun leibniz_float (tuple0) t)

(declare-fun leibniz_float__function_guard (t tuple0) Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 30418395996093750000000.0 10000000000000000000000.0))))

;; leibniz_float__post_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (let ((result (leibniz_float us_void_param)))
     (and (eq result fliteral2) (dynamic_invariant result true false true))) :pattern (
  (leibniz_float us_void_param)) )))
...
(declare-fun shanks_float (tuple0) t)

(declare-fun shanks_float__function_guard (t tuple0) Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 31412551403045654296875.0 10000000000000000000000.0))))

;; shanks_float__post_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (let ((result (shanks_float us_void_param)))
     (and (eq result fliteral3) (dynamic_invariant result true false true))) :pattern (
  (shanks_float us_void_param)) )))
...
(declare-fun o12 () us_image)

(declare-fun temp___522 () (Array Int character))

(declare-fun temp___5221 () t1)
...
(declare-fun o23 () us_image)

(declare-fun temp___525 () (Array Int character))

(declare-fun temp___5251 () t1)
...
;; H
  ...
  (and (tqtisFinite o11) (eq o11 fliteral2))))
...
;; H
  (assert
  (= o19 (concat1 (temp___String_Literal_520 Tuple0) 1 30 temp___522
         (to_rep1 (first temp___5221)) (to_rep1 (last temp___5221)))))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___5251)) (to_rep1 (last temp___5251)))
  (= o24 (+ (- (to_rep1 (last temp___5251)) (to_rep1 (first temp___5251))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___5251)) (to_rep1 (last temp___5251))))
  (= o24 0)))
