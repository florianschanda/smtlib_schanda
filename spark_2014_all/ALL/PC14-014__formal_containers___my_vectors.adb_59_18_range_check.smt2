...
(define-fun l__split_fields22 () us_split_fields (mk___split_fields
                                                 l__split_fields2))
...
(define-fun l__split_fields23 () us_split_fields (mk___split_fields
                                                 l__split_fields1))
...
;; H
  ...
  (length (mk___rep l__split_discrs l__split_fields23)) 4))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields23))
     (model__
  ...
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1))
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields23))) 1)
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields23))) 4) 9) true))))
...
;; H
  ...
  (= (olt
     ...
     (model__ (mk___rep l__split_discrs l__split_fields22))) true)))
