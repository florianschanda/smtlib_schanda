...
;; H
  (assert (and (= o7 (length m)) (and (in_range4 o7) (<= o7 (capacity m)))))

;; H
  (assert
  (and
  (= o5 (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))
  (and (in_range4 o5)
  (<= o5 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))

;; H
  (assert
  (and
  (= o6 (length (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and (in_range4 o6)
  (<= o6 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o4 (length m)) (and (in_range4 o4) (<= o4 (capacity m))))))

;; H
  (assert (=> (= result2 true) (= result1 (ite (<= o4 1000) true false))))
...
;; H
  (assert (=> (= result1 true) (= result3 (ite (<= 1 i1) o3 false))))
