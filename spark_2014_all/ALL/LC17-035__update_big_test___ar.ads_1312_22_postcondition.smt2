...
(declare-fun temp___2894 ((Array Int us_rep1) Int
  us_rep1) (Array Int us_rep1))

;; def_axiom
  (assert
  (forall ((temp___2896 (Array Int us_rep1)))
  (forall ((temp___2897 Int))
  (forall ((temp___2898 us_rep1))
  (let ((temp___2895 (temp___2894 temp___2896 temp___2897 temp___2898)))
  (forall ((temp___2899 Int))
  (ite (= temp___2899 temp___2897)
  (= (select temp___2895 temp___2899) temp___2898)
  (= (select temp___2895 temp___2899) (select temp___2896 temp___2899)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1305, characters 0-0
  (not
  (= (bool_eq2 a2 5 50
     (temp___2894 a i
     (mk___rep1
     ...
     (rec__ar__rec1t__g1
     (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (select a i)))))))
     (rec__ar__rec2t__h2 usq_))))) 5 50) true)))
(check-sat)
(exit)
