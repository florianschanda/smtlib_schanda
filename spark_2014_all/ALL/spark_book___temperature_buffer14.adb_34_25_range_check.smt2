...
(declare-datatypes ((time_type__ref 0))
(((mk_time_type__ref (time_type__content time_type)))))
...
(declare-datatypes ((temperature_type__ref 0))
...
(declare-datatypes ((temperature_record__ref 0))
