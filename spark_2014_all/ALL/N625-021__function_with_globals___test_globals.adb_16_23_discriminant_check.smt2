...
(declare-datatypes ()
((my_array_dyn__ref (mk_my_array_dyn__ref (my_array_dyn__content us_t1)))))
(define-fun my_array_dyn__ref___projection ((a my_array_dyn__ref)) us_t1
  (my_array_dyn__content a))

(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__test_globals__my_rec__d natural)))))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__test_globals__my_rec__f natural)))))
...
(declare-fun test_globals__my_rec__d__first__bit () Int)

(declare-fun test_globals__my_rec__d__last__bit () Int)

(declare-fun test_globals__my_rec__d__position () Int)
...
(declare-fun test_globals__my_rec__f__first__bit () Int)

(declare-fun test_globals__my_rec__f__last__bit () Int)

(declare-fun test_globals__my_rec__f__position () Int)
...
(declare-fun test_globals__my_rec__d__first__bit1 () Int)

(declare-fun test_globals__my_rec__d__last__bit1 () Int)

(declare-fun test_globals__my_rec__d__position1 () Int)
...
(declare-fun test_globals__my_rec__f__first__bit1 () Int)

(declare-fun test_globals__my_rec__f__last__bit1 () Int)

(declare-fun test_globals__my_rec__f__position1 () Int)
...
(declare-datatypes ()
((my_rec_stat__ref (mk_my_rec_stat__ref (my_rec_stat__content us_rep)))))
...
(declare-fun test_globals__my_rec__d__first__bit2 () Int)

(declare-fun test_globals__my_rec__d__last__bit2 () Int)

(declare-fun test_globals__my_rec__d__position2 () Int)
...
(declare-fun test_globals__my_rec__f__first__bit2 () Int)

(declare-fun test_globals__my_rec__f__last__bit2 () Int)

(declare-fun test_globals__my_rec__f__position2 () Int)
...
(declare-datatypes ()
((my_rec_dyn__ref (mk_my_rec_dyn__ref (my_rec_dyn__content us_rep)))))
...
(declare-fun au__first () integer)

(declare-fun au__last () integer)
...
(declare-fun ad__first () integer)

(declare-fun ad__last () integer)
...
(declare-fun test_globals__my_rec__d__first__bit3 () Int)

(declare-fun test_globals__my_rec__d__last__bit3 () Int)

(declare-fun test_globals__my_rec__d__position3 () Int)
...
(declare-fun test_globals__my_rec__f__first__bit3 () Int)

(declare-fun test_globals__my_rec__f__last__bit3 () Int)

(declare-fun test_globals__my_rec__f__position3 () Int)
...
(declare-fun ru__split_discrs () us_split_discrs)
...
(declare-fun test_globals__my_rec__d__first__bit4 () Int)

(declare-fun test_globals__my_rec__d__last__bit4 () Int)

(declare-fun test_globals__my_rec__d__position4 () Int)
...
(declare-fun test_globals__my_rec__f__first__bit4 () Int)

(declare-fun test_globals__my_rec__f__last__bit4 () Int)

(declare-fun test_globals__my_rec__f__position4 () Int)
...
(declare-fun rs__split_discrs () us_split_discrs)
...
(declare-fun test_globals__my_rec__d__first__bit5 () Int)

(declare-fun test_globals__my_rec__d__last__bit5 () Int)

(declare-fun test_globals__my_rec__d__position5 () Int)
...
(declare-fun test_globals__my_rec__f__first__bit5 () Int)

(declare-fun test_globals__my_rec__f__last__bit5 () Int)

(declare-fun test_globals__my_rec__f__position5 () Int)
...
(declare-fun rd__split_discrs () us_split_discrs)
...
(declare-fun au () (Array Int natural))

(declare-fun as__ () (Array Int natural))

(declare-fun ad () (Array Int natural))

(declare-fun ru__split_fields () natural)

(declare-fun rs__split_fields () natural)

(declare-fun us () Int)

(declare-fun us1 () Int)

(declare-fun temp___200 () (Array Int natural))

(declare-fun temp___2001 () t2)

(declare-fun test_globals__au__assume () (Array Int natural))

(declare-fun test_globals__au__assume1 () t)

(declare-fun temp___211 () (Array Int natural))

(declare-fun temp___2111 () t3)

(declare-fun test_globals__ad__assume () (Array Int natural))

(declare-fun test_globals__ad__assume1 () t1)
...
(declare-fun test_globals__ru__assume () natural)

(declare-fun test_globals__ru__assume1 () natural)
...
(declare-fun test_globals__rs__assume () us_rep)
...
(declare-fun o15 () us_split_discrs)
...
(declare-fun au1 () (Array Int natural))

(declare-fun result1 () map__ref)

(declare-fun as__1 () (Array Int natural))

(declare-fun result2 () map__ref)

(declare-fun ad1 () (Array Int natural))

(declare-fun result3 () us_split_fields__ref)

(declare-fun ru__split_fields1 () us_split_fields)

(declare-fun result4 () us_split_fields__ref)

(declare-fun rs__split_fields1 () us_split_fields)
...
;; H
  (assert
  (= (mk1 (to_rep1 (first6 temp___2111)) (to_rep1 (last6 temp___2111)))
  test_globals__ad__assume1))
...
;; H
  (assert
  (= (to_rep1 ad__first) (to_rep1 (first2 test_globals__ad__assume1))))
...
;; H
  (assert
  (= result3 (mk___split_fields__ref (mk___split_fields ru__split_fields))))

;; H
  (assert
  (= ru__split_fields1 (mk___split_fields test_globals__ru__assume1)))
...
;; H
  (assert
  (= result4 (mk___split_fields__ref (mk___split_fields rs__split_fields))))
...
;; WP_parameter_def
 ;; File "test_globals.adb", line 16, characters 0-0
  (not (= c (to_rep (rec__test_globals__my_rec__d (us_split_discrs1 o17))))))
(check-sat)
(exit)
