...
(declare-const temp___167 status)

(declare-const temp___1671 natural)

(declare-const temp___1672 natural)

(declare-const temp___1673 Bool)

(declare-const temp___1674 Bool)
...
;; H
  (assert (= y1 (to_rep1 g__split_discrs)))
...
;; H
  (assert (= temp___167 o5))

;; H
  (assert (= temp___1671 o2))

;; H
  (assert (= temp___1672 o3))

;; H
  (assert (= temp___1673 o4))

;; H
  (assert (= true temp___1674))
...
(assert
;; WP_parameter_def
 ;; File "definite.adb", line 37, characters 0-0
  (not (= temp___167 g__split_discrs)))
(check-sat)
(exit)
