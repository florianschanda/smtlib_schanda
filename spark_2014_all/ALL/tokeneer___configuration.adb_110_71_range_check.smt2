...
(declare-datatypes ((t12b__ref 0)) (((mk_t12b__ref (t12b__content t12b)))))
...
;; H
  (assert (not (= (length temp___993) 0)))

;; H
  (assert (=> (<= 1 2) (= o132 (+ (- 2 1) 1))))

;; H
  (assert (=> (not (<= 1 2)) (= o132 0)))
...
;; H
  (assert (= o134 (+ o133 o132)))

;; H
  (assert (= o135 (+ (to_rep1 (first (rt temp___993))) o134)))
