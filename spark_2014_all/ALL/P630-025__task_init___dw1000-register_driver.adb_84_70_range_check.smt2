...
(declare-datatypes ((bits_15__ref 0))
(((mk_bits_15__ref (bits_15__content bits_15)))))
...
(declare-datatypes ((operation_type__ref 0))
...
(declare-datatypes ((sub_index_type__ref 0))
...
(declare-datatypes ((extended_address_type__ref 0))
...
(declare-datatypes ((non_indexed_header__ref 0))
...
(declare-datatypes ((short_indexed_header__ref 0))
...
(declare-datatypes ((long_indexed_header__ref 0))
...
(declare-datatypes ((tnon_indexed_header_bytesP1__ref 0))
...
(declare-datatypes ((tshort_indexed_header_bytesP1__ref 0))
...
(declare-datatypes ((tlong_indexed_header_bytesP1__ref 0))
...
(((mk_source__ref1 (source__content1 us_rep1)))))
...
(declare-datatypes ((source__ref2 0))
(((mk_source__ref2 (source__content2 us_rep2)))))
