...
(declare-const temp___9594 us_rep3)

(declare-const o29 it4)

(declare-const o30 us_split_fields6)

(declare-const temp___9596 us_rep3)
...
(declare-const temp___9605 us_rep3)
...
;; H
  (assert (= temp___9594 (mk___rep3 o28)))
...
;; H
  (assert (= r__split_fields2 (us_split_fields7 temp___9594)))
...
;; H
  (assert (= temp___9596 (mk___rep3 o30)))

;; H
  (assert (= result1 (mk___split_fields__ref3 r__split_fields2)))

;; H
  (assert (= r__split_fields3 (us_split_fields7 temp___9596)))
...
;; H
  (assert (= temp___9605 (mk___rep3 o39)))

;; H
  (assert (= result2 (mk___split_fields__ref3 r__split_fields3)))

;; H
  (assert (= r__split_fields4 (us_split_fields7 temp___9605)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1822, characters 0-0
  (not (in_range4
  (to_rep3
  (rec__ar__rec2t__f2
  (us_split_fields3
  ...
  (select (rec__ar__rofaofr2__b2
          (us_split_fields__content3 r__split_fields5)) n)))))))))
(check-sat)
(exit)
