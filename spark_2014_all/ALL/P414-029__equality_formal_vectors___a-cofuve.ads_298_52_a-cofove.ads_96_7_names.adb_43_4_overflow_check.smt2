...
(declare-fun dummy () tname_idB)

(declare-datatypes ()
((tname_idB__ref (mk_tname_idB__ref (tname_idB__content tname_idB)))))
(define-fun tname_idB__ref___projection ((a tname_idB__ref)) tname_idB
...
;; range_axiom
  (assert
  (forall ((x name_id)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-fun dummy5 () char_table_index)
