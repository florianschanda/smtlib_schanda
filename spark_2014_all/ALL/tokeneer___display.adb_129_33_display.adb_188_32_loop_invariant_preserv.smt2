...
;; H
  ...
  (rec__display__scrollstrt__text result____split_fields2) temp___980)))))
...
;; H
  (assert (= temp___978 (mk___rep2 o65)))

;; H
  (assert (= result2 (mk___split_fields__ref2 result____split_fields3)))

;; H
  (assert (= result____split_fields4 (us_split_fields5 temp___978)))
