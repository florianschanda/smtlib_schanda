...
(declare-fun temp___256 () natural)

(declare-fun temp___2561 () (Array Int character))

(declare-fun temp___2562 () us_private)

(declare-fun temp___2563 () Int)
...
(declare-fun fixed_stream__create__result8 () natural)

(declare-fun fixed_stream__create__result9 () (Array Int character))

(declare-fun fixed_stream__create__result10 () us_private)

(declare-fun fixed_stream__create__result11 () Int)

(declare-fun fixed_stream__create__result12 () us_rep)

(declare-fun this__split_fields9 () us_split_fields__ref)

(declare-fun fixed_stream__create__result13 () object__ref)

(declare-fun this__split_fields10 () us_split_fields)

(declare-fun fixed_stream__create__result14 () us_rep)
