...
(declare-fun floating_point__angle_between__length_bc__assume () t)
...
;; H
  (assert
  (and (= floating_point__angle_between__length_bc__assume (sqrt2 o10))
  (and (tqtisFinite floating_point__angle_between__length_bc__assume)
  (and (le fliteral2 floating_point__angle_between__length_bc__assume)
  (and
  (=> (eq o10 fliteral2) (eq floating_point__angle_between__length_bc__assume
  fliteral2))
  (and
  (=> (eq o10 fliteral) (eq floating_point__angle_between__length_bc__assume
  fliteral))
  (=> (le fliteral3 o10) (lt fliteral2
...
;; H
  (assert (tqtisFinite length_bc))

;; H
  (assert (lt fliteral5 length_ba))

;; H
  (assert (lt fliteral5 length_bc))

;; H
  (assert
  (and (= o11 (mul RNE1 length_ba length_bc)) (tqtisFinite
  (mul RNE1 length_ba length_bc))))

;; H
  (assert (= o12 (div1 RNE1 ba_dot_bc o11)))
