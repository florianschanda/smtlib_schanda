...
;; H
  (assert
  (and (= result12 (divides x3 a)) (= (= result12 true) (= (mod2 a x3) 0))))

;; H
  (assert
  (=> (= result12 true)
  (and (= result11 (divides x3 b)) (= (= result11 true) (= (mod2 b x3) 0)))))
...
;; H
  (assert
  (=> (= result11 true)
  (and (= o3 (divides b a)) (= (= o3 true) (= (mod2 a b) 0)))))

;; H
  (assert
  (=> (= result11 true) (= result10 (ite (not (= o3 true)) true false))))
...
;; H
  (assert
  (and (= result14 (divides b a)) (= (= result14 true) (= (mod2 a b) 0))))

;; H
  (assert
  (=> (= result14 true)
  (and (= result13 (divides x3 b)) (= (= result13 true) (= (mod2 b x3) 0)))))
...
;; H
  (assert
  (=> (= result17 true) (and (= o4 (mod2 a b)) (in_range1 (mod2 a b)))))

;; H
  (assert
  (=> (= result17 true)
  (and (= result16 (divides x3 o4)) (= (= result16 true) (= (mod2 o4 x3) 0)))))
...
;; H
  (assert
  (=> (= result16 true)
  (and (= result15 (divides x3 b)) (= (= result15 true) (= (mod2 b x3) 0)))))
