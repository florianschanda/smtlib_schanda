...
;; H
  ...
  (= (range_equal
     ...
     (model__ (mk___rep v__split_discrs v__split_fields2)) first1 (-
     o 1)) true))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) o) 0))
  (= (range_shifted
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
     (model__ (mk___rep v__split_discrs v__split_fields2)) o
     (last6
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields))))
     1) true))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (< (length (mk___rep v__split_discrs v__split_fields2)) (capacity
                                                          (mk___rep
                                                          v__split_discrs
                                                          v__split_fields2)))))
(check-sat)
