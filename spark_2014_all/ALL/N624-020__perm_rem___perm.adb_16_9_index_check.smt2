...
;; H
  ...
  (and (= o23 (remove b o2))
  (and (dynamic_invariant1 o23 true false true)
  ...
  (and
  (and (= o24 (remove a ia))
  (and (dynamic_invariant1 o24 true false true)
  ...
  (and (= result1 (is_perm o24 o23))
  (= (= result1 true)
  (or (and (= (length o24) 0) (= (length o23) 0))
  (exists ((ia1 Int))
  ...
  (= (is_perm (remove o24 ia1) (remove o23 ib10)) true)))))))))))
  (= result1 false)))
  (and (= result1 true)
  ...
  (= (is_perm (remove o22 ia1) (remove o21 ib10)) true)))))))))))
  (= result5 false)))
  (and (= result5 true)
