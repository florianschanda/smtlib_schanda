...
;; H
  (assert
  (and (= o4 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1
  o4 true false true)))
...
;; H
  (assert (= temp___472 (mk___t2 o3 (mk2 first2 temp___470))))

;; H
  (assert (and (= temp___469 (- last3 i9)) (in_range1 (- last3 i9))))

;; H
  (assert (<= first2 temp___469))

(assert
;; WP_parameter_def
 ;; File "list.ads", line 10, characters 0-0
  (not (<= (to_rep (first (rt list__reverse_list__L_2__R16b))) first2)))
(check-sat)
(exit)
