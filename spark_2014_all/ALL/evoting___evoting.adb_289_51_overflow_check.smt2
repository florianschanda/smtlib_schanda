...
(declare-datatypes ((ttotal_range_tB__ref 0))
...
(declare-datatypes ((total_range_t__ref 0))
...
(((mk_map__ref1 (map__content1 (Array Int (Array Int character)))))))
...
(((mk_map__ref2 (map__content2 (Array Int counter_range_t))))))
...
(((mk_map__ref3 (map__content3 (Array Int Bool))))))
...
(((mk_t83b__ref (t83b__content tcandidate_number_tB)))))
