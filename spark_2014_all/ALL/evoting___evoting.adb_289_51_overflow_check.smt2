...
(declare-fun dummy4 () program_phase_t)
...
(declare-fun dummy5 () counter_range_t)
...
(declare-fun dummy6 () candidate_number_t)
...
(declare-fun dummy7 () ttotal_range_tB)
...
(declare-fun dummy8 () total_range_t)
...
(declare-fun dummy10 () tcandidate_number_tB)
...
(declare-fun dummy11 () tcandidate_number_tB)
...
;; H
  ...
  (and
  (and
  (and (=> (< 0 i2) (<= (to_rep2 (select counters 0)) total2))
  (<= last_candidate 20)) (and (<= 0 i2) (<= i2 20)))
  (<= total2 (* i2 10000))))

;; H
  (assert
  (and
  (and (=> (<= 0 210000) (in_range8 total2))
  (=> (<= 0 last_candidate) (dynamic_property1 0 last_candidate i2)))
  (and (<= 0 i2) (<= i2 last_candidate))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range7 (* i2 10000))))
(check-sat)
(exit)
