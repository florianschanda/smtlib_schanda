...
(declare-fun temp___655 () (Array Int cardindex))

(declare-fun o108 () Int)

(declare-fun o109 () cardindex)

(declare-fun temp___657 () Int)
...
(declare-fun o116 () cardindex)

(declare-fun temp___651 () Int)

(declare-fun o117 () Int)

(declare-fun o118 () cardindex)
...
(declare-fun o125 () cardindex)

(declare-fun o126 () Int)

(declare-fun o127 () Int)

(declare-fun o128 () cardindex)
...
;; H
  (assert
  (= o128 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o127)))
...
;; H
  (assert
  (= o125 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o124)))

;; H
  (assert (= o126 (to_rep1 o125)))

;; H
  (assert (= o131 (ite (<= 0 o126) true false)))

;; H
  (assert (= result23 (ite (= o131 true) o130 false)))

;; H
  (assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))

;; H
  (assert (=> (= result23 true) (= o115 i1)))

;; H
  (assert
  (=> (= result23 true)
  (= o116 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o115))))

;; H
  (assert (=> (= result23 true) (= temp___651 (to_rep1 o116))))

;; H
  (assert (=> (= result23 true) (and (<= 0 temp___651) (<= temp___651 99))))

;; H
  (assert (=> (= result23 true) (= o117 temp___651)))

;; H
  (assert
  (=> (= result23 true)
  (= o118 (select (rec__patience__state__stacksizes
                  (us_split_fields__content s__split_fields20)) o117))))

;; H
  (assert (=> (= result23 true) (= o119 (to_rep1 o118))))

;; H
  (assert (=> (= result23 true) (= o120 (- o119 1))))
...
;; H
  (assert (=> (= result23 true) (= o121 (to_rep1 o114))))

;; H
  (assert (=> (= result23 true) (= o122 (ite (<= o121 o120) true false))))
...
;; H
  (assert
  (=> (= result23 true)
  (= o111 (select (rec__patience__state__posheight
                  (us_split_fields__content s__split_fields20)) o110))))

;; H
  (assert (=> (= result23 true) (= o112 (to_rep1 o111))))

;; H
  (assert (=> (= result23 true) (= o123 (ite (<= 0 o112) true false))))

;; H
  (assert (=> (= result23 true) (= result22 (ite (= o123 true) o122 false))))
...
;; H
  (assert (and (<= 0 temp___654) (<= temp___654 99)))

;; H
  (assert (= o107 temp___654))

;; H
  (assert
  (= temp___655 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20))
  o107)))
...
;; H
  (assert
  (= o109 (select (rec__patience__state__posheight
                  (us_split_fields__content s__split_fields20)) o108)))

;; H
  (assert (= temp___657 (to_rep1 o109)))
