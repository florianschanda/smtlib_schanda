...
(declare-fun temp___863 () us_rep)

(declare-fun temp___862 () read_status)

(declare-fun temp___8621 () character)

(declare-fun temp___8622 () Bool)

(declare-fun temp___861 () Int)

(declare-fun temp___860 () Int)

(declare-fun temp___859 () Int)

(declare-fun temp___865 () Int)

(declare-fun temp___858 () read_status)

(declare-fun temp___8581 () character)

(declare-fun temp___8582 () Bool)
...
(declare-fun temp___8671 () Int)

(declare-fun temp___8661 () Int)

(declare-fun result1 () int__ref)

(declare-fun temp___8672 () Int)

(declare-fun result2 () int__ref)

(declare-fun temp___8662 () Int)
...
;; H
  ...
  (= result (ite (or (= (to_rep current_read__split_fields) 10)
                 (or (= (to_rep current_read__split_fields) 13)
                 (or (= (to_rep current_read__split_fields) 32)
                 (= (to_rep current_read__split_fields) 9))))
            true false))))
...
;; H
  ...
  (= o (ite (or
            ...
            (or
            (= (to_rep
               (rec__file_io__read_result__c current_read__split_fields3)) 13)
            (or
            (= (to_rep
               (rec__file_io__read_result__c current_read__split_fields3)) 32)
            (= (to_rep
               (rec__file_io__read_result__c current_read__split_fields3)) 9))))
       true false)))))
...
;; H
  (assert (=> (not (= result true)) (= next_idx6 (mk_int__ref next_idx))))
...
;; H
  (assert
  (=> (not (= result true)) (= current_idx6 (mk_int__ref current_idx))))

;; H
  (assert
  (=> (not (= result true)) (= current_col6 (mk_int__ref current_col))))

;; H
  (assert
  (=> (not (= result true)) (= current_line6 (mk_int__ref current_line))))
...
;; H
  (assert (=> (not (= result true)) (= the_file6 (mk_file__ref the_file))))
