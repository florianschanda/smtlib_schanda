...
(((mk___split_fields (rec__my_sets__n__set us_main_type)))))
...
(define-fun element_type__ref_7__projection ((a element_type__ref1)) us_rep1
...
(define-fun element_type__ref_6__projection ((a element_type__ref2)) us_rep1
...
;; H
  ...
  (and (= o (length right))
  (and (in_range1 o)
  (<= o (to_rep1 (rec__my_sets__n__set__capacity (us_split_discrs1 right)))))))
...
(assert
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 961, characters 0-0
  (not (in_range o1)))
(check-sat)
(exit)
