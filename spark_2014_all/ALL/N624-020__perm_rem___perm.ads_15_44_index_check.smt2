...
(declare-datatypes ((tresult_tyP1__ref 0))
(((mk_tresult_tyP1__ref (tresult_tyP1__content integer)))))
...
(((mk_result_ty__ref (result_ty__content us_t1)))))
...
(declare-datatypes ((t5b__ref 0)) (((mk_t5b__ref (t5b__content us_t3)))))
...
(define-fun dynamic_invariant4 ((temp___expr_202 us_t1)
  ...
  (temp___do_toplevel_201 Bool)) Bool (=>
                                      ...
                                      (and (= (first3 temp___expr_202) 1)
                                      (= (last3 temp___expr_202) (- (last1 a) 1))))))
...
;; H
  (assert
  (=> (= (length2 (mk___t2 temp___545 temp___5451)) 0)
  (= temp___546 temp___547)))

;; H
  (assert
  (=> (= (length2 (mk___t2 temp___545 temp___5451)) 0)
  (= (mk (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461)))
  temp___5471)))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0))
  (=> (<= (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461)))
  (= o2 (+ (- (to_rep1 (last6 temp___5461)) (to_rep1 (first6 temp___5461))) 1)))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0))
  (=> (not (<= (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461))))
  (= o2 0))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0))
  (=> (<= (to_rep1 (first4 temp___5451)) (to_rep1 (last4 temp___5451)))
  (= o3 (+ (- (to_rep1 (last4 temp___5451)) (to_rep1 (first4 temp___5451))) 1)))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0))
  (=> (not (<= (to_rep1 (first4 temp___5451)) (to_rep1 (last4 temp___5451))))
  (= o3 0))))
...
;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0))
  (= o5 (+ (to_rep1 (first4 temp___5451)) o4))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (= o6 (- o5 1))))
...
;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0))
  (= (concat1 temp___545 (to_rep1 (first4 temp___5451))
     (to_rep1 (last4 temp___5451)) temp___546 (to_rep1 (first6 temp___5461))
     (to_rep1 (last6 temp___5461))) temp___547)))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0))
  (= (mk (to_rep1 (first4 temp___5451)) o7) temp___5471)))
...
;; H
  (assert
  (= (slide temp___547 (to_rep1 (first temp___5471)) 1) perm__remove__result__assume))
...
;; H
  (assert
  (= (to_rep1 result____last) (to_rep1 (last2 perm__remove__result__assume1))))
...
;; H
  (assert
  (and (= o13 (- (to_rep1 (last (rt a))) 1)) (in_range1
  (- (to_rep1 (last (rt a))) 1))))

;; H
  (assert
  (= result4 (ite (= (to_rep1 (last perm__remove__result9)) o13) true false)))
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 (- i 1)))
  (= (to_rep (select (elts a) k1)) (to_rep (select perm__remove__result8 k1)))))))
...
;; H
  ...
  (= (= result6 true)
  (forall ((k1 Int))
  (=> (and (<= (+ i 1) k1) (<= k1 (to_rep1 (last (rt a)))))
  (= (to_rep (select (elts a) k1)) (to_rep
                                   (select perm__remove__result8 (- k1 1))))))))
...
;; H
  (assert
  (and (= o8 (- (to_rep1 (last (rt a))) 1)) (in_range1
  (- (to_rep1 (last (rt a))) 1))))
...
;; WP_parameter_def
 ;; File "perm.ads", line 4, characters 0-0
  (not (<= (to_rep1 (first (rt a))) temp___550)))
(check-sat)
(exit)
