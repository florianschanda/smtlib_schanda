...
(declare-const temp___439 count_type)
...
;; H
  (assert (= temp___439 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___439)) no_element))
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep (rec__my_lists__m__list__capacity target__split_discrs))))))

;; H
  (assert
  (= o3 (- (to_rep (rec__my_lists__m__list__capacity target__split_discrs))
  o2)))
