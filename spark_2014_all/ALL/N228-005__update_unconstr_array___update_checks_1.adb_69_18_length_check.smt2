...
(declare-const temp___470 (Array Int integer))

(declare-const temp___4701 t3)
...
;; H
  (assert
  (=> (<= 2 i)
  (and (and (<= (to_rep a__first) 2) (<= 2 (to_rep a__last)))
  (and (<= (to_rep a__first) i) (<= i (to_rep a__last))))))
...
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 23, characters 0-0
  ...
  (ite (<= (to_rep (first6 temp___4701)) (to_rep (last6 temp___4701)))
  (+ (- (to_rep (last6 temp___4701)) (to_rep (first6 temp___4701))) 1) 0))))
(check-sat)
(exit)
