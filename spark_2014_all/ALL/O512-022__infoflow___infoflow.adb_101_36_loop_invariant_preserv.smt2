...
;; H
  (assert
  (and (<= (to_rep h_v1__first) temp___379)
  (<= temp___379 (to_rep h_v1__last))))

;; H
  (assert (= o10 temp___379))

;; H
  (assert (= o11 (store h_v12 o10 o9)))

;; H
  (assert (= result4 h_v12))

;; H
  (assert (= h_v13 o11))

;; H
  (assert (not (= q_v12 r11b)))

;; H
  (assert (= result5 q_v12))

;; H
  (assert (= q_v13 (+ q_v12 1)))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 61, characters 0-0
  (not (= (to_rep1 (select h_v13 k)) (to_rep1 (select h_v1 (+ k m_v11))))))
(check-sat)
(exit)
