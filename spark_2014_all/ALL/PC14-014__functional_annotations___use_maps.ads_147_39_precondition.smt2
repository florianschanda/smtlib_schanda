...
(define-fun default_initial_assumption1 ((temp___expr_398 us_rep4)
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     ...
     (and (< 0 (find result key2)) (= (get1 result (find result key2)) key2)))))
     (forall ((i Int))
...
(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 134, characters 0-0
