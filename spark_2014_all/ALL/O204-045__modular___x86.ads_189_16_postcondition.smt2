...
(declare-const x86__ebx__result (_ BitVec 32))

(declare-const result (_ BitVec 32))

(declare-const x86__ebx__result1 (_ BitVec 32))

(declare-const x86__ebx__result2 (_ BitVec 32))

(declare-const x86__ebx__result3 (_ BitVec 32))

(declare-const x86__ebx__result4 (_ BitVec 32))

(declare-const x86__ebx__result5 (_ BitVec 32))

(declare-const result1 (_ BitVec 32))

;; H
  (assert (= x86__ebx__result1 x86__ebx__result2))

;; H
  (assert (= x86__ebx__result3 x86__ebx__result1))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__ebx__result)))

;; H
  (assert
  (= x86__ebx__result1 ((_ extract 31 0) (bvand rbx ((_ int2bv 64) 4294967295)))))

;; H
  (assert (= (mk_t__ref x86__ebx__result4) (mk_t__ref x86__ebx__result2)))

;; H
  (assert (= x86__ebx__result5 x86__ebx__result3))

;; H
  (assert (= result1 x86__ebx__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not
  (= x86__ebx__result4 ((_ extract 31 0) (bvand rbx ((_ int2bv 64) 4294967295))))))
(check-sat)
(exit)
