...
;; H
  ...
  (=> (<= (- 2147483648) 2147483647) (in_range1 e2)))
...
;; H
  (assert
  (and (<= (to_rep (first (rt a))) i3) (<= i3 (to_rep (last (rt a))))))
...
;; H
  (assert
  (= dynamic_ranges__search_0__nested__result4 dynamic_ranges__search_0__nested__result3))
