...
(declare-fun dummy1 () (Array Int character))
...
(define-fun us_split_fields_Program__projection ((a us_split_fields)) (Array Int character)
...
(declare-fun regpat__pattern_matcher__program__first__bit () Int)

(declare-fun regpat__pattern_matcher__program__last__bit () Int)

(declare-fun regpat__pattern_matcher__program__position () Int)
...
(declare-datatypes ()
((pattern_matcher__ref
 (mk_pattern_matcher__ref (pattern_matcher__content us_rep)))))
(define-fun pattern_matcher__ref___projection ((a pattern_matcher__ref)) us_rep
  (pattern_matcher__content a))

(declare-fun temp___144 (Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___146 Int))
  (forall ((temp___147 Int))
  (= (select (temp___144 temp___146) temp___147) (of_rep temp___146)))))

(define-fun default_initial_assumption ((temp___expr_142 us_rep)
  (temp___skip_top_level_143 Bool)) Bool (= (rec__regpat__pattern_matcher__program
                                            (us_split_fields1
                                            temp___expr_142)) (temp___144 0)))
