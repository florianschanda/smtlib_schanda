...
;; H
  (assert
  (= (bool_eq1 (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))
...
;; H
  (assert
  (=> (= result true)
  (= (to_rep (select (elts b) (to_rep1 (last (rt b))))) e)))

;; H
  (assert
  (=> (not (= result true))
  (not (= (to_rep (select (elts b) (to_rep1 (last (rt b))))) e))))

;; H
  (assert
  (and (= o7 (remove_last b))
  (and (dynamic_invariant1 o7 true false true)
  (and (= (elts b) o5)
  (= (mk
     (to_rep1
     (first2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1))))
     (to_rep1
     (last2 (mk1 (to_rep1 (first (rt b))) (- (to_rep1 (last (rt b))) 1))))) 
  o6)))))

;; H
  (assert
  (and (= o8 (remove_last a))
...
;; WP_parameter_def
 ;; File "perm.ads", line 39, characters 0-0
  (not
  (= (bool_eq1 o3 (to_rep1 (first o4)) (to_rep1 (last o4)) o5
     (to_rep1 (first o6)) (to_rep1 (last o6))) true)))
(check-sat)
