...
;; H
  (assert (= temp___202 a__split_fields3))

;; H
  (assert (= temp___2021 a__split_fields4))

;; H
  (assert (= temp___2022 a__split_fields5))

;; H
  (assert (= (to_rep1 o4) 42))

;; H
  (assert (= o5 (store a__split_fields4 17 o4)))
...
;; H
  (assert (= temp___205 a__split_fields6))

;; H
  (assert (= temp___2051 a__split_fields7))

;; H
  (assert (= temp___2052 a__split_fields8))

;; H
  (assert (= (to_rep1 o9) 23))

;; H
  (assert (= o10 (store a__split_fields8 101 o9)))
...
;; H
  (assert (= temp___208 o11))

;; H
  (assert (= temp___2081 o12))

;; H
  (assert (= temp___2082 o13))
...
;; H
  (assert (= temp___208 a__split_fields9))

;; H
  (assert (= temp___2081 a__split_fields10))

;; H
  (assert (= temp___2082 a__split_fields11))

;; H
  (assert (= (to_rep1 (select a__split_fields11 101)) 23))
...
;; H
  (assert
  (= a__split_fields15 (mk___split_fields a__split_fields9 a__split_fields10
                       a__split_fields11)))

(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 44, characters 0-0
  (not (= (to_rep1 (select a__split_fields13 17)) 23)))
(check-sat)
(exit)
