...
(declare-fun temp___202 () index)

(declare-fun temp___2021 () (Array Int value))

(declare-fun temp___2022 () (Array Int value))
...
(declare-fun temp___205 () index)

(declare-fun temp___2051 () (Array Int value))

(declare-fun temp___2052 () (Array Int value))
...
(declare-fun temp___208 () index)

(declare-fun temp___2081 () (Array Int value))

(declare-fun temp___2082 () (Array Int value))
...
(declare-fun a__split_fields15 () us_split_fields)
