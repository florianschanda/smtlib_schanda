...
;; H
  (assert
  (= (slide temp___1053 (to_rep1 (first8 temp___10531)) r13b) temp___1054))

;; H
  (assert (= (mk3 r13b 10) temp___10541))

;; H
  (assert
  (=> (<= r13b 10)
  (and (and (<= 1 r13b) (<= r13b 10)) (and (<= 1 10) (<= 10 10)))))

;; H
  (assert (= o7 text1))

;; H
  (assert (= o7 temp___1056))

;; H
  (assert (= (mk3 r13b 10) temp___10561))

(assert
;; WP_parameter_def
 ;; File "certificatestore.adb", line 188, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first6 temp___10541)) (to_rep1 (last6 temp___10541)))
     (+ (- (to_rep1 (last6 temp___10541)) (to_rep1 (first6 temp___10541))) 1)
     0) (ite (<= (to_rep1 (first6 temp___10561)) (to_rep1
                                                 (last6 temp___10561)))
        (+ (- (to_rep1 (last6 temp___10561)) (to_rep1 (first6 temp___10561))) 1)
        0))))
(check-sat)
(exit)
