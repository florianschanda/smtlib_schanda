...
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index__result Int)
...
(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index__result1 Int)

(declare-const result__3 Int)

(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index__result2 Int)

(declare-const result__4 Int)

(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index__result3 Int)

(declare-const result__5 Int)

(declare-const bits_manipulation_unsigned__unsigned_16__functions__msb_index__result4 Int)
