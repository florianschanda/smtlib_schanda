...
(define-fun last_element ((container1 us_rep)) Int (get (model__ container1)
                                                   (last_index container1)))
...
;; is_empty__post_axiom
  (assert
  (forall ((container1 us_rep))
  (! (= (= (is_empty1 container1) true) (= (length1 container1) 0)) :pattern (
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant7 (get container1 position) true false true)) :pattern (
