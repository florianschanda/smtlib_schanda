...
(declare-datatypes ((t247b__ref 0))
(((mk_t247b__ref (t247b__content unsigned_64)))))
...
(((mk___t1 (elts1 (Array (_ BitVec 64) byte))(rt1 t1)))))
...
(declare-datatypes ((t248b__ref 0))
(((mk_t248b__ref (t248b__content us_t1)))))
...
(declare-datatypes ((t255b__ref 0))
(((mk_t255b__ref (t255b__content unsigned_64)))))
...
(declare-const temp___1480 (Array (_ BitVec 64) byte))
...
(declare-const o56 (Array (_ BitVec 64) byte))
...
;; H
  ...
  (= local_ctx__split_fields13 (mk___split_fields2
                               ...
                               (mk___split_fields1
                               (mk___rep
                               (mk___split_fields temp___1424 temp___14241
                               temp___14242 temp___14243 temp___14244
                               temp___14245 temp___14246 temp___14247))
                               temp___14248 temp___14249)) temp___142410
                               temp___142411)))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63)))
  (= local_ctx__split_fields15 (us_split_fields5 temp___1423)))))
...
;; H
  (assert
  (= temp___1436 (store (rec__skein__skein_512_context__b
...
;; H
  (assert
  (= temp___1440 (store (rec__skein__skein_512_context__b
...
;; H
  (assert
  (= temp___1444 (store (rec__skein__skein_512_context__b
...
;; H
  (assert
  (= temp___1448 (store (rec__skein__skein_512_context__b
...
;; H
  (assert
  (= temp___1452 (store (rec__skein__skein_512_context__b
...
;; H
  (assert
  (= temp___1456 (store (rec__skein__skein_512_context__b
...
;; H
  (assert
  (= temp___1460 (store (rec__skein__skein_512_context__b
...
;; H
  (assert
  (= temp___1464 (store (rec__skein__skein_512_context__b
...
;; H
  ...
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= temp___1480 hash2))))
...
;; H
  ...
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
  (= temp___1476 (store hash3 o55 o54)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o56 temp___1476))))
