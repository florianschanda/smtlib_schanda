...
(define-fun dynamic_invariant ((temp___expr_266 (_ BitVec 64))
...
(declare-fun dummy7 () hash_bit_length)
...
(define-fun in_range_int1 ((x Int)) Bool (and (<= 1 x)
                                         (<= x 18446744073709551608)))
...
(declare-fun user_eq8 (initialized_hash_bit_length
  initialized_hash_bit_length) Bool)

(declare-fun dummy8 () initialized_hash_bit_length)
...
(declare-fun user_eq9 (skein_512_state_words_index
  skein_512_state_words_index) Bool)

(declare-fun dummy9 () skein_512_state_words_index)
...
(declare-fun user_eq10 (skein_512_block_bytes_count
  skein_512_block_bytes_count) Bool)

(declare-fun dummy10 () skein_512_block_bytes_count)
...
(declare-fun user_eq11 (skein_512_block_bytes_index
  skein_512_block_bytes_index) Bool)

(declare-fun dummy11 () skein_512_block_bytes_index)
...
(declare-fun i25s () (Array (_ BitVec 64) byte))
...
;; range_axiom
  (assert
  (forall ((x u7)) (! (in_range7 (to_rep6 x)) :pattern ((to_rep6 x)) )))

;; coerce_axiom
  (assert
  (forall ((x (_ BitVec 8)))
  (! (let ((y (bvurem x ((_ int2bv 8) 128))))
     (=> (in_range7 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6
                                                               (of_rep6 x))) )))
...
;; range_axiom
  (assert
  (forall ((x u6)) (! (in_range8 (to_rep7 x)) :pattern ((to_rep7 x)) )))

;; coerce_axiom
  (assert
  (forall ((x (_ BitVec 8)))
  (! (let ((y (bvurem x ((_ int2bv 8) 64))))
     (=> (in_range8 y) (= (to_rep7 (of_rep7 x)) y))) :pattern ((to_rep7
                                                               (of_rep7 x))) )))
...
(declare-fun dummy16 () (Array (_ BitVec 64) u64))
...
(declare-fun user_eq16 ((Array (_ BitVec 64) u64)
  (Array (_ BitVec 64) u64)) Bool)

(declare-fun dummy17 () (Array (_ BitVec 64) byte))
...
(declare-fun user_eq17 ((Array (_ BitVec 64) byte)
...
(define-fun dynamic_invariant5 ((temp___expr_520 (_ BitVec 64))
  ...
  (temp___do_toplevel_519 Bool)) Bool (=>
                                      ...
                                      (in_range2 temp___expr_520)))

;; hash_bit_len_of__post_axiom
  (assert
  (forall ((ctx us_rep2))
  (! (=> (dynamic_invariant4 ctx true true true) (dynamic_invariant5
     (hash_bit_len_of ctx) true false true)) :pattern ((hash_bit_len_of ctx)) )))

;; hash_bit_len_of__def_axiom
  (assert
  (forall ((ctx us_rep2))
  (! (=> (dynamic_invariant4 ctx true true true)
     (= (hash_bit_len_of ctx) (to_rep5
                              (rec__skein__context_header__hash_bit_len
                              (us_split_fields3
                              (rec__skein__skein_512_context__h
...
;; byte_count_of__post_axiom
  (assert
  (forall ((ctx us_rep2))
  (! (=> (dynamic_invariant4 ctx true true true) (dynamic_invariant1
...
(declare-fun dummy19 () output_byte_count_t)
...
(define-fun in_range_int8 ((x Int)) Bool (and (<= 1 x)
                                         (<= x 36028797018963968)))
...
(declare-fun user_eq20 (positive_output_block_count_t
  positive_output_block_count_t) Bool)

(declare-fun dummy20 () positive_output_block_count_t)
...
(declare-fun dummy21 () unsigned_64)

(declare-datatypes ()
((t247b__ref (mk_t247b__ref (t247b__content unsigned_64)))))
(define-fun t247b__ref___projection ((a t247b__ref)) unsigned_64 (t247b__content
                                                                 a))
...
(declare-fun r250b () (_ BitVec 64))

(declare-fun attr__ATTRIBUTE_ADDRESS10 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS11 () Int)

(declare-fun r254b () (_ BitVec 64))
...
(declare-fun dummy23 () unsigned_64)

(declare-datatypes ()
((t255b__ref (mk_t255b__ref (t255b__content unsigned_64)))))
(define-fun t255b__ref___projection ((a t255b__ref)) unsigned_64 (t255b__content
                                                                 a))

(declare-fun attr__ATTRIBUTE_ADDRESS13 () Int)

(declare-fun c256b () (_ BitVec 64))

(declare-fun attr__ATTRIBUTE_ADDRESS14 () Int)

(declare-fun c258b () (_ BitVec 8))

(declare-fun attr__ATTRIBUTE_ADDRESS15 () Int)

(declare-fun c264b () (_ BitVec 64))

(declare-fun attr__ATTRIBUTE_ADDRESS16 () Int)

(declare-fun c266b () (Array (_ BitVec 64) u64))

(declare-fun attr__ATTRIBUTE_ADDRESS17 () Int)

(declare-fun c267b () (_ BitVec 64))
...
(define-fun dynamic_invariant14 ((temp___expr_532 (_ BitVec 64))
  ...
  (temp___do_toplevel_531 Bool)) Bool (=>
                                      ...
                                      (in_range4 temp___expr_532)))

(define-fun dynamic_invariant15 ((temp___expr_547 (_ BitVec 64))
...
(define-fun dynamic_invariant16 ((temp___expr_553 (_ BitVec 64))
...
(define-fun dynamic_invariant17 ((temp___expr_609 (_ BitVec 8))
  ...
  (temp___do_toplevel_608 Bool)) Bool (=>
                                      ...
                                      (in_range7 temp___expr_609)))

(declare-fun hash () (Array (_ BitVec 64) byte))

(declare-fun local_ctx__split_fields () u64)

(declare-fun local_ctx__split_fields1 () u32)

(declare-fun local_ctx__split_fields2 () u16)

(declare-fun local_ctx__split_fields3 () u7)

(declare-fun local_ctx__split_fields4 () Bool)

(declare-fun local_ctx__split_fields5 () u6)

(declare-fun local_ctx__split_fields6 () Bool)

(declare-fun local_ctx__split_fields7 () Bool)

(declare-fun local_ctx__split_fields8 () hash_bit_length)

(declare-fun local_ctx__split_fields9 () u64)

(declare-fun local_ctx__split_fields10 () (Array (_ BitVec 64) u64))

(declare-fun local_ctx__split_fields11 () (Array (_ BitVec 64) byte))

(declare-fun blocks_required () (_ BitVec 64))

(declare-fun byte_count () (_ BitVec 64))

(declare-fun x () (Array (_ BitVec 64) u64))

(declare-fun tmp_b () (Array (_ BitVec 64) byte))

(declare-fun tmp_byte_count_add () (_ BitVec 64))

(declare-fun i () (_ BitVec 64))

(declare-fun blocks_done () (_ BitVec 64))

(declare-fun temp___1407 () (Array (_ BitVec 64) byte))

(declare-fun temp___14071 () t1)

(declare-fun temp___1408 () (Array (_ BitVec 64) byte))

(declare-fun temp___14081 () t)

(declare-fun temp___1409 () (Array (_ BitVec 64) byte))

(declare-fun temp___14091 () t)

(declare-fun o () (Array (_ BitVec 64) byte))

(declare-fun temp___1418 () u64)

(declare-fun temp___14181 () u32)

(declare-fun temp___14182 () u16)

(declare-fun temp___14183 () u7)

(declare-fun temp___14184 () Bool)

(declare-fun temp___14185 () u6)

(declare-fun temp___14186 () Bool)

(declare-fun temp___14187 () Bool)

(declare-fun temp___14188 () hash_bit_length)

(declare-fun temp___14189 () u64)

(declare-fun temp___141810 () (Array (_ BitVec 64) u64))

(declare-fun temp___141811 () (Array (_ BitVec 64) byte))

(declare-fun o1 () byte)

(declare-fun temp___1415 () (Array (_ BitVec 64) byte))

(declare-fun o2 () (Array (_ BitVec 64) byte))

(declare-fun o3 () us_split_fields4)

(declare-fun temp___1417 () us_rep2)

(declare-fun o4 () (_ BitVec 64))

(declare-fun o5 () (Array (_ BitVec 64) byte))

(declare-fun o6 () us_split_fields4)

(declare-fun temp___1428 () us_rep2)

(declare-fun o7 () byte)

(declare-fun temp___1430 () (Array (_ BitVec 64) byte))

(declare-fun o8 () (Array (_ BitVec 64) byte))

(declare-fun o9 () us_split_fields4)

(declare-fun temp___1432 () us_rep2)

(declare-fun o10 () byte)

(declare-fun temp___1434 () (Array (_ BitVec 64) byte))

(declare-fun o11 () (Array (_ BitVec 64) byte))

(declare-fun o12 () us_split_fields4)

(declare-fun temp___1436 () us_rep2)

(declare-fun o13 () byte)

(declare-fun temp___1438 () (Array (_ BitVec 64) byte))

(declare-fun o14 () (Array (_ BitVec 64) byte))

(declare-fun o15 () us_split_fields4)

(declare-fun temp___1440 () us_rep2)

(declare-fun o16 () byte)

(declare-fun temp___1442 () (Array (_ BitVec 64) byte))

(declare-fun o17 () (Array (_ BitVec 64) byte))

(declare-fun o18 () us_split_fields4)

(declare-fun temp___1444 () us_rep2)

(declare-fun o19 () byte)

(declare-fun temp___1446 () (Array (_ BitVec 64) byte))

(declare-fun o20 () (Array (_ BitVec 64) byte))

(declare-fun o21 () us_split_fields4)

(declare-fun temp___1448 () us_rep2)

(declare-fun o22 () byte)

(declare-fun temp___1450 () (Array (_ BitVec 64) byte))

(declare-fun o23 () (Array (_ BitVec 64) byte))

(declare-fun o24 () us_split_fields4)

(declare-fun temp___1452 () us_rep2)

(declare-fun o25 () byte)

(declare-fun temp___1454 () (Array (_ BitVec 64) byte))

(declare-fun o26 () (Array (_ BitVec 64) byte))

(declare-fun o27 () us_split_fields4)

(declare-fun temp___1456 () us_rep2)

(declare-fun o28 () byte)

(declare-fun temp___1458 () (Array (_ BitVec 64) byte))

(declare-fun o29 () (Array (_ BitVec 64) byte))

(declare-fun o30 () us_split_fields4)

(declare-fun temp___1460 () us_rep2)
...
(declare-fun o38 () us_split_fields2)

(declare-fun o39 () us_rep1)

(declare-fun o40 () us_split_fields4)

(declare-fun temp___1463 () us_rep2)
...
(declare-fun o44 () us_split_fields4)

(declare-fun temp___1466 () us_rep2)

(declare-fun temp___1474 () (Array (_ BitVec 64) byte))
...
(declare-fun o54 () byte)

(declare-fun o55 () (_ BitVec 64))

(declare-fun temp___1470 () (Array (_ BitVec 64) byte))

(declare-fun o56 () (Array (_ BitVec 64) byte))

(declare-fun i1 () (_ BitVec 64))

(declare-fun result () us_split_fields__ref2)

(declare-fun local_ctx__split_fields12 () us_split_fields4)

(declare-fun result1 () map__ref)

(declare-fun hash1 () (Array (_ BitVec 64) byte))

(declare-fun result2 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields13 () us_split_fields4)

(declare-fun result3 () t__ref3)

(declare-fun i2 () (_ BitVec 64))

(declare-fun local_ctx__split_fields14 () us_split_fields4)

(declare-fun i3 () (_ BitVec 64))

(declare-fun result4 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields15 () us_split_fields4)

(declare-fun local_ctx__split_fields16 () us_split_fields__ref2)

(declare-fun i4 () t__ref3)

(declare-fun local_ctx__split_fields17 () us_split_fields4)

(declare-fun i5 () (_ BitVec 64))

(declare-fun local_ctx__split_fields18 () us_split_fields__ref2)

(declare-fun i6 () t__ref3)

(declare-fun local_ctx__split_fields19 () us_split_fields4)

(declare-fun i7 () (_ BitVec 64))

(declare-fun local_ctx__split_fields20 () us_split_fields__ref2)

(declare-fun i8 () t__ref3)

(declare-fun local_ctx__split_fields21 () us_split_fields4)

(declare-fun i9 () (_ BitVec 64))

(declare-fun result5 () map__ref)

(declare-fun tmp_b1 () (Array (_ BitVec 64) byte))

(declare-fun result6 () t__ref3)

(declare-fun tmp_byte_count_add1 () (_ BitVec 64))

(declare-fun local_ctx__split_fields22 () us_split_fields4)

(declare-fun result7 () t__ref3)

(declare-fun byte_count1 () (_ BitVec 64))

(declare-fun result8 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields23 () us_split_fields4)

(declare-fun result9 () map__ref1)

(declare-fun x1 () (Array (_ BitVec 64) u64))

(declare-fun result10 () t__ref3)

(declare-fun blocks_required1 () (_ BitVec 64))

(declare-fun result11 () t__ref3)

(declare-fun blocks_done1 () (_ BitVec 64))

(declare-fun hash2 () (Array (_ BitVec 64) byte))

(declare-fun local_ctx__split_fields24 () us_split_fields4)

(declare-fun n () (_ BitVec 64))

(declare-fun tmp_b2 () (Array (_ BitVec 64) byte))

(declare-fun blocks_done2 () (_ BitVec 64))

(declare-fun n1 () (_ BitVec 64))

(declare-fun result12 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields25 () us_split_fields4)

(declare-fun result13 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields26 () us_split_fields4)

(declare-fun result14 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields27 () us_split_fields4)

(declare-fun result15 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields28 () us_split_fields4)

(declare-fun result16 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields29 () us_split_fields4)

(declare-fun result17 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields30 () us_split_fields4)

(declare-fun result18 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields31 () us_split_fields4)

(declare-fun result19 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields32 () us_split_fields4)

(declare-fun result20 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields33 () us_split_fields4)

(declare-fun result21 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields34 () us_split_fields4)

(declare-fun result22 () map__ref)

(declare-fun tmp_b3 () (Array (_ BitVec 64) byte))

(declare-fun local_ctx__split_fields35 () us_split_fields4)
...
(declare-fun hash3 () (Array (_ BitVec 64) byte))

(declare-fun n7 () (_ BitVec 64))

(declare-fun result26 () map__ref)

(declare-fun hash4 () (Array (_ BitVec 64) byte))

(declare-fun hash5 () map__ref)

(declare-fun n8 () t__ref3)

(declare-fun hash6 () (Array (_ BitVec 64) byte))

(declare-fun n9 () (_ BitVec 64))

(declare-fun hash7 () map__ref)

(declare-fun n10 () t__ref3)

(declare-fun hash8 () (Array (_ BitVec 64) byte))

(declare-fun n11 () (_ BitVec 64))

(declare-fun hash9 () map__ref)

(declare-fun n12 () t__ref3)

(declare-fun hash10 () (Array (_ BitVec 64) byte))

(declare-fun n13 () (_ BitVec 64))

(declare-fun result27 () us_split_fields__ref2)

(declare-fun local_ctx__split_fields36 () us_split_fields4)

(declare-fun result28 () t__ref3)

(declare-fun blocks_done3 () (_ BitVec 64))

(declare-fun hash11 () map__ref)

(declare-fun local_ctx__split_fields37 () us_split_fields__ref2)

(declare-fun n14 () t__ref3)

(declare-fun tmp_b4 () map__ref)

(declare-fun blocks_done4 () t__ref3)

(declare-fun n15 () t__ref3)

(declare-fun hash12 () (Array (_ BitVec 64) byte))

(declare-fun local_ctx__split_fields38 () us_split_fields4)

(declare-fun n16 () (_ BitVec 64))

(declare-fun tmp_b5 () (Array (_ BitVec 64) byte))

(declare-fun blocks_done5 () (_ BitVec 64))
...
;; H
  (assert
  (bvult (to_rep (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615)))
...
;; H
  ...
  (and
  (and
  (and (in_range3 (hash_bit_len_of ctx)) (in_range5 (byte_count_of ctx)))
  (= (to_rep hash__first) ((_ int2bv 64) 0)))
  (bvult (to_rep hash__last) ((_ int2bv 64) 18446744073709551615)))
  (bvule (bvsub (bvudiv (bvadd (hash_bit_len_of ctx) ((_ int2bv 64) 7)) ((_ int2bv 64) 8)) ((_ int2bv 64) 1))
  (to_rep hash__last))))

;; H
  (assert
  (=> (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 36028797018963968)) (in_range10
  blocks_required)))

;; H
  (assert
  (=> (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 2305843009213693951))
  (in_range9 byte_count)))
...
;; H
  ...
  (= local_ctx__split_fields13 (mk___split_fields2
                               ...
                               (mk___split_fields1
                               (mk___rep
                               (mk___split_fields temp___1418 temp___14181
                               temp___14182 temp___14183 temp___14184
                               temp___14185 temp___14186 temp___14187))
                               temp___14188 temp___14189)) temp___141810
                               temp___141811)))))
...
;; H
  ...
  (= temp___1415 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields14) i3 o1)))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (dynamic_predicate
  temp___1415))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63)))
  (= local_ctx__split_fields15 (us_split_fields5 temp___1417)))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= i5 i3))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= i6 i4))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= i7 i5))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (not (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))))
  (= i6 (mk_t__ref3 i2)))))
...
;; H
  ...
  (bvult (to_rep4
         ...
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))
  (=> (not (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63)))) (= i7 i2))))
...
;; H
  (assert
  (= tmp_b1 (rec__skein__skein_512_context__b
            (us_split_fields__content2 local_ctx__split_fields20))))
...
;; H
  ...
  (rec__skein__context_header__hash_bit_len
  (us_split_fields3
  (rec__skein__skein_512_context__h local_ctx__split_fields22)))))
  (= (to_rep5
     (rec__skein__context_header__hash_bit_len
     (us_split_fields3
     (rec__skein__skein_512_context__h local_ctx__split_fields22))))
  ...
  (us_split_fields3
  (rec__skein__skein_512_context__h
  (us_split_fields__content2 local_ctx__split_fields20))))))) (in_range5
  (to_rep4
  (rec__skein__context_header__byte_count
  (us_split_fields3
  (rec__skein__skein_512_context__h local_ctx__split_fields22))))))
...
;; H
  ...
  (= o4 (bvudiv (bvadd (to_rep5
                       ...
                       (us_split_fields3
                       (rec__skein__skein_512_context__h
                       local_ctx__split_fields22)))) ((_ int2bv 64) 7)) ((_ int2bv 64) 8)))
  (in_range9
  (bvudiv (bvadd (to_rep5
                 (rec__skein__context_header__hash_bit_len
                 (us_split_fields3
                 (rec__skein__skein_512_context__h local_ctx__split_fields22)))) ((_ int2bv 64) 7)) ((_ int2bv 64) 8)))))
...
;; H
  (assert (= o5 (temp___1422 ((_ int2bv 8) 0))))

;; H
  (assert
  (= o6 (mk___split_fields2
        (rec__skein__skein_512_context__h local_ctx__split_fields22)
        (rec__skein__skein_512_context__x local_ctx__split_fields22)
        o5)))

;; H
  (assert (= temp___1428 (mk___rep2 o6)))
...
;; H
  (assert
  (= x1 (rec__skein__skein_512_context__x local_ctx__split_fields23)))
...
;; H
  (assert
  (and
  (=> (bvule ((_ int2bv 64) 0) r254b) (dynamic_property3 ((_ int2bv 64) 0)
  r254b blocks_done2))
  (and (bvule ((_ int2bv 64) 0) blocks_done2) (bvule blocks_done2 r254b))))
...
;; H
  (assert
  (= (to_rep1 o7) ((_ extract 7 0) (bvand c256b ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1430 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields24) ((_ int2bv 64) 0)
  o7)))
...
;; H
  (assert (= o8 temp___1430))

;; H
  (assert
  (= o9 (mk___split_fields2
        (rec__skein__skein_512_context__h local_ctx__split_fields24)
        (rec__skein__skein_512_context__x local_ctx__split_fields24)
        o8)))

;; H
  (assert (= temp___1432 (mk___rep2 o9)))
...
;; H
  (assert
  (= (to_rep1 o10) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 8)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1434 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields25) ((_ int2bv 64) 1)
  o10)))
...
;; H
  (assert
  (= (to_rep1 o13) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 16)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1438 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields26) ((_ int2bv 64) 2)
  o13)))
...
;; H
  (assert (= o14 temp___1438))

;; H
  (assert
  (= o15 (mk___split_fields2
         (rec__skein__skein_512_context__h local_ctx__split_fields26)
         (rec__skein__skein_512_context__x local_ctx__split_fields26)
         o14)))

;; H
  (assert (= temp___1440 (mk___rep2 o15)))
...
;; H
  (assert
  (= (to_rep1 o16) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 24)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1442 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields27) ((_ int2bv 64) 3)
  o16)))
...
;; H
  (assert (= o17 temp___1442))

;; H
  (assert
  (= o18 (mk___split_fields2
         (rec__skein__skein_512_context__h local_ctx__split_fields27)
         (rec__skein__skein_512_context__x local_ctx__split_fields27)
         o17)))

;; H
  (assert (= temp___1444 (mk___rep2 o18)))
...
;; H
  (assert
  (= (to_rep1 o19) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 32)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1446 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields28) ((_ int2bv 64) 4)
  o19)))
...
;; H
  (assert (= o20 temp___1446))

;; H
  (assert
  (= o21 (mk___split_fields2
         (rec__skein__skein_512_context__h local_ctx__split_fields28)
         (rec__skein__skein_512_context__x local_ctx__split_fields28)
         o20)))

;; H
  (assert (= temp___1448 (mk___rep2 o21)))
...
;; H
  (assert
  (= (to_rep1 o22) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 40)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1450 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields29) ((_ int2bv 64) 5)
  o22)))
...
;; H
  (assert (= o23 temp___1450))

;; H
  (assert
  (= o24 (mk___split_fields2
         (rec__skein__skein_512_context__h local_ctx__split_fields29)
         (rec__skein__skein_512_context__x local_ctx__split_fields29)
         o23)))

;; H
  (assert (= temp___1452 (mk___rep2 o24)))
...
;; H
  (assert
  (= (to_rep1 o25) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 48)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1454 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields30) ((_ int2bv 64) 6)
  o25)))
...
;; H
  (assert (= o26 temp___1454))

;; H
  (assert
  (= o27 (mk___split_fields2
         (rec__skein__skein_512_context__h local_ctx__split_fields30)
         (rec__skein__skein_512_context__x local_ctx__split_fields30)
         o26)))

;; H
  (assert (= temp___1456 (mk___rep2 o27)))
...
;; H
  (assert
  (= (to_rep1 o28) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 56)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (= temp___1458 (store (rec__skein__skein_512_context__b
                        local_ctx__split_fields31) ((_ int2bv 64) 7)
  o28)))
...
;; H
  (assert (= o29 temp___1458))

;; H
  (assert
  (= o30 (mk___split_fields2
         (rec__skein__skein_512_context__h local_ctx__split_fields31)
         (rec__skein__skein_512_context__x local_ctx__split_fields31)
         o29)))

;; H
  (assert (= temp___1460 (mk___rep2 o30)))
...
;; H
  (assert
  (= o36 (mk___split_fields o35 o34 o33 o32 (of_int 0) o31 (of_int 1)
         (of_int 1))))
...
;; H
  (assert
  (= o38 (mk___split_fields1 o37
         (rec__skein__context_header__hash_bit_len
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields32)))
         (rec__skein__context_header__byte_count
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields32))))))
...
;; H
  (assert
  (= o40 (mk___split_fields2 o39
         (rec__skein__skein_512_context__x local_ctx__split_fields32)
         (rec__skein__skein_512_context__b local_ctx__split_fields32))))

;; H
  (assert (= temp___1463 (mk___rep2 o40)))
...
;; H
  ...
  (= o42 (mk___split_fields1
         (rec__skein__context_header__tweak_words
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields33)))
         (rec__skein__context_header__hash_bit_len
         (us_split_fields3
         (rec__skein__skein_512_context__h local_ctx__split_fields33)))
         o41)))
...
;; H
  (assert
  (= o44 (mk___split_fields2 o43
         (rec__skein__skein_512_context__x local_ctx__split_fields33)
         (rec__skein__skein_512_context__b local_ctx__split_fields33))))

;; H
  (assert (= temp___1466 (mk___rep2 o44)))
...
;; H
  (assert
  (= tmp_b3 (rec__skein__skein_512_context__b local_ctx__split_fields34)))
...
;; H
  ...
  (rec__skein__context_header__hash_bit_len
  (us_split_fields3
  (rec__skein__skein_512_context__h local_ctx__split_fields35)))))
  (= (to_rep5
     (rec__skein__context_header__hash_bit_len
     (us_split_fields3
     (rec__skein__skein_512_context__h local_ctx__split_fields35))))
  ...
  (rec__skein__context_header__hash_bit_len
  (us_split_fields3
  (rec__skein__skein_512_context__h local_ctx__split_fields34))))))
  (in_range5
  (to_rep4
  (rec__skein__context_header__byte_count
  (us_split_fields3
...
;; H
  (assert
  (= (rec__skein__skein_512_context__x local_ctx__split_fields35) c266b))

;; H
  (assert (= (t__content3 n4) c267b))

;; H
  (assert (=> (bvuge c267b ((_ int2bv 64) 1)) (= result25 (mk_t__ref3 n1))))

;; H
  (assert (=> (bvuge c267b ((_ int2bv 64) 1)) (= n6 ((_ int2bv 64) 0))))

;; H
  (assert
  (=> (bvuge c267b ((_ int2bv 64) 1))
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= temp___1474 hash2))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
  (and (bvule ((_ int2bv 64) 0) n7)
  (bvule n7 (bvsub c267b ((_ int2bv 64) 1)))))))
...
;; H
  ...
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
  (and
  (= o47 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7)))))
  (in_range1
  (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7)))))))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o48 ((_ int2bv 64) o47)))))
...
;; H
  ...
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
  (and (bvule ((_ int2bv 64) 0) (bvudiv n7 ((_ int2bv 64) 8)))
  (bvule (bvudiv n7 ((_ int2bv 64) 8)) ((_ int2bv 64) 7))))))
...
;; H
  ...
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
  (= o46 (select (rec__skein__skein_512_context__x local_ctx__split_fields35)
  o45)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o49 (to_rep4 o46)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o50 (bvlshr o49 o48)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o52 o51))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o53 ((_ extract 7 0)
  o52)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= (to_rep1 o54) o53))))
...
;; H
  ...
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
  (and (bvule (to_rep hash__first) (bvadd c264b n7))
  (bvule (bvadd c264b n7) (to_rep hash__last))))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o55 (bvadd c264b n7)))))
...
;; H
  ...
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
  (= temp___1470 (store hash3 o55 o54)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= o56 temp___1470))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= hash4 o56))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= n8 (mk_t__ref3 n7)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= hash5 (mk_map__ref hash4)))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= n9 n7))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= hash6 hash4))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= n10 n8))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= hash7 hash5))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= n11 n9))))
...
;; H
  ...
  (=>
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1)))) (= hash8 hash6))))
...
;; H
  ...
  (not
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))) (= n10 (mk_t__ref3 n6)))))
...
;; H
  ...
  (not
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))) (= hash7 (mk_map__ref hash2)))))
...
;; H
  ...
  (not
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))) (= n11 n6))))
...
;; H
  ...
  (not
  (and (bvule ((_ int2bv 64) 0) n6)
  (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))) (= hash8 hash2))))

;; H
  (assert (=> (bvuge c267b ((_ int2bv 64) 1)) (= n12 n10)))

;; H
  (assert (=> (bvuge c267b ((_ int2bv 64) 1)) (= hash9 hash7)))

;; H
  (assert (=> (bvuge c267b ((_ int2bv 64) 1)) (= n13 n11)))

;; H
  (assert (=> (bvuge c267b ((_ int2bv 64) 1)) (= hash10 hash8)))

;; H
  (assert (=> (not (bvuge c267b ((_ int2bv 64) 1))) (= n12 (mk_t__ref3 n1))))

;; H
  (assert
  (=> (not (bvuge c267b ((_ int2bv 64) 1))) (= hash9 (mk_map__ref hash2))))

;; H
  (assert (=> (not (bvuge c267b ((_ int2bv 64) 1))) (= n13 n1)))

;; H
  (assert (=> (not (bvuge c267b ((_ int2bv 64) 1))) (= hash10 hash2)))

;; H
  (assert (= result27 (mk___split_fields__ref2 local_ctx__split_fields35)))

;; H
  (assert
  (= local_ctx__split_fields36 (mk___split_fields2
                               (rec__skein__skein_512_context__h
                               local_ctx__split_fields35) x1
                               (rec__skein__skein_512_context__b
                               local_ctx__split_fields35))))

;; H
  (assert (not (= blocks_done2 r254b)))

;; H
  (assert (= result28 (mk_t__ref3 blocks_done2)))

;; H
  (assert (= blocks_done3 (bvadd blocks_done2 ((_ int2bv 64) 1))))

;; H
  (assert (= n15 n12))

;; H
  (assert (= blocks_done4 (mk_t__ref3 blocks_done3)))

;; H
  (assert (= tmp_b4 (mk_map__ref tmp_b3)))
...
;; H
  (assert
  (= local_ctx__split_fields37 (mk___split_fields__ref2
                               local_ctx__split_fields36)))
...
;; H
  (assert (= blocks_done5 blocks_done3))

;; H
  (assert (= tmp_b5 tmp_b3))

;; H
  (assert (= n16 n5))

;; H
  (assert (= local_ctx__split_fields38 local_ctx__split_fields36))

;; H
  (assert (= hash12 hash10))
...
;; WP_parameter_def
 ;; File "skein.ads", line 361, characters 0-0
  ...
  (= (to_rep5
     ...
     (us_split_fields3
     (rec__skein__skein_512_context__h
     (us_split_fields__content2 local_ctx__split_fields37))))) (to_rep5
                                                               (rec__skein__context_header__hash_bit_len
                                                               (us_split_fields3
                                                               (rec__skein__skein_512_context__h
                                                               local_ctx__split_fields23)))))))
(check-sat)
(exit)
