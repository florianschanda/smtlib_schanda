...
;; H
  ...
  (forall ((g211 Int))
  (=> (and (<= 1 g211) (<= g211 64))
  (= (is_permutation_1 (select r2 g211)) true))))
...
;; H
  (assert
  (=> (and (<= 1 g22) (<= g22 64))
  (and (= o (invert_1 (select r2 g23)))
  (and
  (forall ((rank Int))
  (=> (and (<= 1 rank) (<= rank 64))
  (= (to_rep1 (select o (to_rep (select (select r2 g23) rank)))) rank)))
  (forall ((g1 Int))
  (=> (and (<= 1 g1) (<= g1 64))
  (= (to_rep (select (select r2 g23) (to_rep1 (select o g1)))) g1)))))))
...
;; H
  (assert
  (=> (and (<= 1 g22) (<= g22 64)) (= result__10 (mk_map__ref3 result__4))))
...
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 127, characters 0-0
  (not (= (is_permutation_1 (select r2 g21)) true)))
(check-sat)
(exit)
