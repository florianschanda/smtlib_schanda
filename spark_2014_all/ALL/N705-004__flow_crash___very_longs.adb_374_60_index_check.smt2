...
(declare-datatypes ((tS123bP1__ref 0))
(((mk_tS123bP1__ref (tS123bP1__content tdigit_index_typeB)))))
...
(((mk_s123b__ref (s123b__content us_t1)))))
...
(((mk_t125b__ref (t125b__content tdigit_index_typeB)))))
...
(((mk_t126b__ref (t126b__content us_t2)))))
...
;; def_axiom
  (assert
  (forall ((temp___1219 (_ BitVec 8)))
  (forall ((temp___1220 Int) (temp___1221 Int))
  (let ((temp___1218 (temp___1217 temp___1219 temp___1220 temp___1221)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___1220 temp___1221)
  (and (= (first5 temp___1218) temp___1220)
  (= (last5 temp___1218) temp___1221)))
  (forall ((temp___1222 Int))
  (= (select (to_array2 temp___1218) temp___1222) (of_rep1 temp___1219))))))))

(define-fun dynamic_invariant5 ((temp___expr_756 us_t1)
  (temp___is_init_753 Bool) (temp___skip_constant_754 Bool)
  (temp___do_toplevel_755 Bool)) Bool (=>
                                      (not (= temp___skip_constant_754 true))
                                      (and (dynamic_property3 1 r124b
                                      (first3 temp___expr_756)
                                      (last3 temp___expr_756))
                                      (and (= (first3 temp___expr_756) 1)
                                      (= (last3 temp___expr_756) r124b)))))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1217 ((_ int2bv 8) 0) 1 r124b)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1217 ((_ int2bv 8) 0) 1 r124b)))) r124b))

;; H
  (assert
  (= (mk___t2 temp___1224 temp___12241) (temp___1217 ((_ int2bv 8) 0) 1
                                        r124b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___12241)) (to_rep2 (last4 temp___12241)))
     (+ (- (to_rep2 (last4 temp___12241)) (to_rep2 (first4 temp___12241))) 1)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___12241)) (to_rep2 (last4 temp___12241)))
  temp___12251))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___12251)) (to_rep2 (last2 temp___12251)))
     (+ (- (to_rep2 (last2 temp___12251)) (to_rep2 (first2 temp___12251))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1227 temp___12271) (mk___t1 temp___1225 temp___12251)))
...
;; H
  (assert
  (= (mk (to_rep2 (first2 temp___12271)) (to_rep2 (last2 temp___12271)))
  o1))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___12291 temp___12292))))
...
;; H
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1242)
  (<= temp___1242 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1242) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1242))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
