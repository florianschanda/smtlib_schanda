...
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result (_ BitVec 64))
...
(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result1 (_ BitVec 64))

(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result2 (_ BitVec 64))

(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result3 (_ BitVec 64))

(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4 (_ BitVec 64))

(declare-const bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result5 (_ BitVec 64))
