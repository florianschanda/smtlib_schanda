...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result () (_ BitVec 64))
...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result1 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result2 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result3 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result5 () (_ BitVec 64))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result1
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result3
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result1))
...
;; H
  ...
  (= (mk_t__ref result) (mk_t__ref
                        bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result)))
...
;; H
  (assert
  (= (mk_t__ref
     bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4)
  (mk_t__ref
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result2)))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result5
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result3))
...
;; H
  (assert
  (and (= o5 (shift_right value from))
  (= o5 (ite (and (<= 1 64) (<= 64 8))
...
;; H
  (assert
  (= result1 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4
             o6) true false)))
...
;; H
  (assert (and (= o1 (+ (- to__ from) 1)) (in_range1 (+ (- to__ from) 1))))

;; H
  (assert
  (and (= o2 (make_mask o1))
  (= o2 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o1)))))

;; H
  (assert
  (= result2 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline__result4
             o2) true false)))
