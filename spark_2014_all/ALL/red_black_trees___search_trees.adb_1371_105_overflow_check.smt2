...
(declare-fun temp___2021 () (Array Int us_rep1))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2021 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2021 o1))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2021 o1)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2021 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2021 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2021 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2021 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2021 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2021 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2021 j1)))) true))
  (= j1 i2))))))))))))))

;; H
  (assert (= o2 (select temp___2021 i1)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2018 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2018 o12))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2018 o12)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o12))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2018 (parent
                              ...
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2018 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2018 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2018 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2018 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2018 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2018 j1)))) true))
  (= j1 i2))))))))))))))

;; H
  (assert (= o13 (select temp___2018 j)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2020 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2020 o8))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2020 o8)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o8))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2020 (parent
                              ...
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2020 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2020 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2020 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2020 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2020 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2020 j1)))) true))
  (= j1 i2)))))))))))))))

;; H
  (assert (=> (= result3 true) (= o9 (select temp___2020 j))))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2019 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 o4))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 o4)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o4))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2019 (parent
                              ...
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2019 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2019 j1)))) true))
  (= j1 i2)))))))))))))))

;; H
  (assert (=> (= result3 true) (= o5 (select temp___2019 i1))))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2017 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2017 o15))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2017 o15)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o15))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          ...
          (select temp___2017 (parent
                              ...
                              (us_split_fields7 t)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2017 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2017 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2017 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2017 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2017 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2017 j1)))) true))
  (= j1 i2))))))))))))))

;; H
  (assert (= o16 (select temp___2017 i1)))
