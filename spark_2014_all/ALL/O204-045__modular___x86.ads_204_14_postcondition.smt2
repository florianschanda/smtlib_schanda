...
(declare-fun x86__sp__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__sp__result1 () (_ BitVec 16))

(declare-fun x86__sp__result2 () (_ BitVec 16))

(declare-fun x86__sp__result3 () (_ BitVec 16))

(declare-fun x86__sp__result4 () (_ BitVec 16))

(declare-fun x86__sp__result5 () (_ BitVec 16))
...
;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__sp__result)))

;; H
  (assert
  (= x86__sp__result1 ((_ extract 15 0) (bvand rsp ((_ int2bv 64) 65535)))))
...
;; H
  (assert (= result1 x86__sp__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not
  (= x86__sp__result4 ((_ extract 15 0) (bvand rsp ((_ int2bv 64) 65535))))))
(check-sat)
(exit)
