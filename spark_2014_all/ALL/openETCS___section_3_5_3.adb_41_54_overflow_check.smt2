...
(declare-fun dummy2 () telephone_number_t)
...
(declare-fun dummy3 () rbc_riu_id_t)
...
(declare-fun dummy4 () ertms_etcs_level_t)
...
(declare-fun connections__split_fields () us_main_type)
