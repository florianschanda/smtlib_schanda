...
;; H
  ...
  (= (bool_eq1 use_maps__apply_f_3__cu__assume1 no_element) true)
  (and
  (= (has_key1
     (positions
...
;; H
  (assert
  (and (= o4 (keys (mk___rep s__split_discrs s__split_fields2)))
  (and
  (and
  (and
  (and (= (length3 o4) (length (mk___rep s__split_discrs s__split_fields2)))
  (forall ((temp___431 Int))
  (=> (and (in_range4 temp___431) (= (iter_has_element o4 temp___431) true))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 o4 temp___431)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true))
  (and (< 0 (find o4 key2)) (= (get1 o4 (find o4 key2)) key2)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
  (= (find o4 (get1 o4 i1)) i1))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
