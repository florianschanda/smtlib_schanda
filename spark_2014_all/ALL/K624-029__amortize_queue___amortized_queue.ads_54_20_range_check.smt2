...
;; H
  (assert
  (and
  (= o1 (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))
  (and (in_range4 o1)
  (<= o1 (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))

;; H
  (assert
  (and
  (= o2 (length (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and (in_range4 o2)
  (<= o2 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o (length m)) (and (in_range4 o) (<= o (capacity m))))))
...
;; H
  (assert
  (<= 1 (length (rec__amortized_queue__queue__rear (us_split_fields3 q)))))
