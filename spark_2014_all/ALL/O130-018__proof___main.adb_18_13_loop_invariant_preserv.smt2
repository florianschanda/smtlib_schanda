...
(declare-fun temp___207 () natural)

(declare-fun temp___2071 () (Array Int integer))

(declare-fun temp___2072 () t)
...
;; H
  ...
  (= i2 (to_rep
        (last (rt (rec__main__branch_type__m_nodes branch__split_fields3)))))
  (= branch__split_discrs (mk___split_discrs temp___207))))
...
;; H
  ...
  (= branch__split_fields4 (mk___split_fields
                           (mk___t temp___2071 temp___2072)))))
