...
;; WP_parameter_def
 ;; File "private_record.ads", line 2, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651)))
     (+ (- (to_rep1 (last4 temp___2651)) (to_rep1 (first4 temp___2651))) 1)
     0) (ite (<= 1 (- (to_rep
                      (rec__record_discr__interm_result__upto
