...
;; H
  (assert (= o55 (select (map__content a16) o54)))

;; H
  (assert (= o56 (us_split_fields1 o55)))

;; H
  (assert (= o57 (rec__frame_condition__cell__max_right o56)))
...
;; H
  (assert (= o51 (select (map__content a16) o50)))
...
;; H
  (assert (= o48 (rec__frame_condition__cell__max_left o47)))
