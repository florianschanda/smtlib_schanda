...
;; H
  (assert (= o78 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (= o76 (num_of_big_int m m_first o75)))

;; H
  (assert (= o71 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o77 (omultiply o71 o76)))

;; H
  (assert (= o79 (osubtract o77 o78)))

;; H
  (assert (= o68 (from_word32 a_msw3)))
...
;; H
  (assert (= o67 (oexpon o62 o66)))

;; H
  (assert (= o69 (omultiply o67 o68)))
...
;; H
  (assert
  (= o61 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o60)))

;; H
  (assert (= o70 (oadd o61 o69)))

;; H
  (assert (= o80 (olt o70 o79)))
...
;; H
  (assert
  (and (= o45 (base Tuple0))
  (= o45 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
