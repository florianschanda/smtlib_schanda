...
;; H
  ...
  value o))) 1) 0) v2) (<= v2 value)) (not (= (select is_prime1 v2) true))))
  (forall ((v2 Int))
  (=>
  (and (<= value v2)
  (<= v2 (ite (< 100000 (- (+ value (abs (- value o))) 1)) 100000 (- (+
  value (abs (- value o))) 1)))) (not (= (select is_prime1 v2) true)))))))))))))
...
;; H
  ...
  (=>
  (and (<= value v2)
  (<= v2 (- test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1)))
  (not (= (is_prime v2) true)))))))
...
;; H
  ...
  (=>
  (and
  (<= (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1) v2)
  (<= v2 value)) (not (= (is_prime v2) true)))))))
...
;; H
  (assert
  (and
  (= o10 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
  (in_range1
  (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))))
...
;; H
  (assert
  (= result2 (ite (= o18 true) (ite (<= v1 value) true false) false)))
...
;; H
  ...
  value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1) 0) v2)
  (<= v2 value)) (not (= (is_prime v2) true))))))
