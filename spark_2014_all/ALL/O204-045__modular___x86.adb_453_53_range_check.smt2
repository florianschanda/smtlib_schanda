...
(declare-fun o10 () unsigned8)

(declare-fun o11 () (Array (_ BitVec 64) unsigned8))

(declare-fun o12 () unsigned8)

(declare-fun o13 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun result5 () (Array (_ BitVec 64) unsigned8))

(declare-fun memory6 () (Array (_ BitVec 64) unsigned8))

(declare-fun result6 () (Array (_ BitVec 64) unsigned8))
...
;; H
  (assert
  (= (to_rep o12) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 281474976710656)) ((_ int2bv 64) 256)))))

;; H
  (assert (= o13 (store memory6 (bvadd addr ((_ int2bv 64) 6)) o12)))

;; H
  (assert (= memory6 result6))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  (not
  (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvurem (bvudiv val__ ((_ int2bv 64) 72057594037927936)) ((_ int2bv 64) 256)))))
(check-sat)
(exit)
