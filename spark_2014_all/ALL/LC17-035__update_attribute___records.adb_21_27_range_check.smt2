...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (to_rep2 (rec__types__rec__s1 (us_split_fields1 b))))
                        (= (to_rep
                        ...
                        (to_rep2 (rec__types__rec__s4 (us_split_fields1 b)))))
                   true false))
