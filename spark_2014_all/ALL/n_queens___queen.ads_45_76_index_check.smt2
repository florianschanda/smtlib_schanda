...
;; H
  ...
  (=> (<= 1 i) (dynamic_property 1 i j4))) (and (<= 1 j4) (<= j4 i)))))

;; H
  (assert
  (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep o) (to_rep (select b j4)))))
...
;; H
  ...
  (=> (<= (+ i 1) 8) (dynamic_property1 (+ i 1) 8 j10)))
  (and (<= (+ i 1) j10) (<= j10 8)))))

;; H
  (assert
  (=> (and (<= (+ i 1) j9) (<= j9 8))
  (= (to_rep o2) (to_rep (select c j10)))))
...
;; H
  (assert
  (=> (not (and (<= (+ i 1) j9) (<= j9 8))) (= j13 (mk_int__ref j9))))
