...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 (- i2 1)))
  (= (make_mask j1) (bvsub (ite (< j1 256)
                           (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j1))
                           ((_ int2bv 8) 0)) ((_ int2bv 8) 1))))))
...
;; H
  (assert (=> (< j 256) (= o (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) j)))))

;; H
  (assert (=> (not (< j 256)) (= o ((_ int2bv 8) 0))))

;; H
  (assert (= o1 (bvsub o ((_ int2bv 8) 1))))
