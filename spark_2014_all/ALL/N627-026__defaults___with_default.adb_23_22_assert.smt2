...
(declare-fun ok_def () Int)

(declare-fun no_def () Int)

(declare-fun no_ini () Int)
...
;; H
  (assert (dynamic_property first 2147483647 no_def1))

;; H
  (assert
  (=> (<= first1 2147483647) (dynamic_property1 first1 2147483647 no_ini)))
