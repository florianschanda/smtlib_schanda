...
(define-fun ctx__split_fields32 () us_split_fields (mk___split_fields
                                                   ctx__split_fields24
                                                   ctx__split_fields25
                                                   ctx__split_fields26
                                                   ctx__split_fields27
...
(define-fun ctx__split_fields33 () us_split_fields (mk___split_fields
                                                   ctx__split_fields18
                                                   ctx__split_fields19
                                                   ctx__split_fields20
                                                   ctx__split_fields21
...
;; H
  ...
  (and
  (and
  (and (= (state_of (mk___rep ctx__split_fields33)) 0)
  (= (rate_of (mk___rep ctx__split_fields33)) (rate_of
                                              (mk___rep
                                              (mk___split_fields
                                              ctx__split_fields
                                              ctx__split_fields1
                                              ...
                                              ctx__split_fields4
                                              ctx__split_fields5)))))
  (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields33)) 8) (mod2
                                                                   bit_length
                                                                   8)))
  (< (in_queue_bit_length (mk___rep ctx__split_fields33)) (rate_of
                                                          (mk___rep
                                                          ctx__split_fields33))))))))
...
;; H
  ...
  (and
  (and
  (and (= (state_of (mk___rep ctx__split_fields32)) 0)
  (= (rate_of (mk___rep ctx__split_fields32)) (rate_of
                                              (mk___rep ctx__split_fields33))))
  (= (mod2 (in_queue_bit_length (mk___rep ctx__split_fields32)) 8) (mod2
                                                                   suffix_len
                                                                   8)))
  (< (in_queue_bit_length (mk___rep ctx__split_fields32)) (rate_of
                                                          (mk___rep
                                                          ctx__split_fields32))))))))
...
;; H
  ...
  (=> (not (= suffix_len 0))
  (=> (not (= (mod2 bit_length 8) 0))
  (= ctx__split_fields32 ctx__split_fields30)))))

;; H
  (assert
  (=> (not (and (= bit_length 0) (< 0 suffix_len)))
  (=> (not (= suffix_len 0)) (= ctx__split_fields34 ctx__split_fields32))))

;; H
  (assert
  (=> (not (and (= bit_length 0) (< 0 suffix_len)))
  (= ctx__split_fields35 ctx__split_fields34)))

;; H
  (assert
  (and (= o19 (rate_of (mk___rep ctx__split_fields35)))
  (and (in_range3 o19)
  (and (= o19 (* (to_rep6 ctx__split_fields10) 8)) (< o19 1600)))))

;; H
  (assert (= o20 (ite (= o19 initial_rate1) true false)))

;; H
  (assert
  (and (= o16 (rate_of (mk___rep ctx__split_fields35)))
  (and (in_range3 o16)
  (and (= o16 (* (to_rep6 ctx__split_fields10) 8)) (< o16 1600)))))

;; H
  (assert
  (and (= o17 (in_queue_bit_length (mk___rep ctx__split_fields35)))
  (and (in_range2 o17)
  (and (= o17 (to_rep5 ctx__split_fields8)) (< o17 1600)))))
...
;; H
  (assert
  (and (= o13 (in_queue_bit_length (mk___rep ctx__split_fields35)))
  (and (in_range2 o13)
  (and (= o13 (to_rep5 ctx__split_fields8)) (< o13 1600)))))
