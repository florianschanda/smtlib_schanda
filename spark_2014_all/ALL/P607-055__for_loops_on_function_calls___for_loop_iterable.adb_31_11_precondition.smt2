...
(declare-fun dummy3 () valid_cursor)
...
(declare-fun g__split_fields () (Array Int natural))

(declare-fun e () Int)

(declare-fun for_loop_iterable__p3__g__assume () (Array Int natural))
...
(declare-fun g__split_fields1 () (Array Int natural))
...
(declare-fun g__split_fields2 () (Array Int natural))

(declare-fun e3 () Int)

(declare-fun temp___2531 () Int)

(declare-fun g__split_fields3 () (Array Int natural))
...
(define-fun g__split_fields5 () us_split_fields (mk___split_fields
                                                g__split_fields2))

(define-fun g__split_fields6 () us_split_fields (mk___split_fields
                                                g__split_fields1))
...
;; H
  (assert
  (and (= o (first (mk___rep g__split_fields6))) (and (in_range3 o) (= o 1))))
...
;; H
  (assert
  (and (= result2 (has_element (mk___rep g__split_fields6) temp___253))
  (= (= result2 true) (in_range2 temp___253))))

;; H
  (assert
  (=> (= result2 true)
  (and (= o1 (element (mk___rep g__split_fields6) temp___253))
...
;; H
  (assert
  (and (= result4 (has_element (mk___rep g__split_fields6) temp___253))
...
;; H
  (assert
  (and (= (has_element (mk___rep g__split_fields5) temp___2531) true)
  (= e3 (element (mk___rep g__split_fields5) temp___2531))))
...
;; H
  (assert
  (and (= o2 (next (mk___rep g__split_fields4) temp___2531))
  (and (in_range3 o2) (= o2 (ite (= temp___2531 100) 0 (+ temp___2531 1))))))

;; H
  (assert
  (and (= o3 (has_element (mk___rep g__split_fields4) o2))
  (= (= o3 true) (in_range2 o2))))
...
;; WP_parameter_def
 ;; File "for_loop_iterable.adb", line 18, characters 0-0
  (not (= (has_element (mk___rep g__split_fields4) temp___2531) true)))
(check-sat)
(exit)
