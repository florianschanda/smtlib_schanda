...
(declare-const temp___526 (Array Int element))

(declare-const temp___5261 t3)

(declare-const o1 (Array Int element))

(declare-const temp___525 (Array Int element))

(declare-const temp___5251 t2)
...
(declare-const temp___527 (Array Int element))

(declare-const temp___5271 t)
...
;; H
  (assert (= (mk3 1 stackp__get_model__3__R84s) temp___5261))
...
;; H
  (assert
  (=> (= (length2 (mk___t2 temp___525 temp___5251)) 0)
  (= temp___526 temp___527)))

;; H
  (assert
  (=> (= (length2 (mk___t2 temp___525 temp___5251)) 0)
  (= (mk (to_rep1 (first6 temp___5261)) (to_rep1 (last8 temp___5261)))
  temp___5271)))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___525 temp___5251)) 0))
  (=> (<= (to_rep1 (first6 temp___5261)) (to_rep1 (last8 temp___5261)))
  (= o2 (+ (- (to_rep1 (last8 temp___5261)) (to_rep1 (first6 temp___5261))) 1)))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___525 temp___5251)) 0))
  (=> (not (<= (to_rep1 (first6 temp___5261)) (to_rep1 (last8 temp___5261))))
  (= o2 0))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___525 temp___5251)) 0))
  (=> (<= (to_rep1 (first4 temp___5251)) (to_rep1 (last6 temp___5251)))
  (= o3 (+ (- (to_rep1 (last6 temp___5251)) (to_rep1 (first4 temp___5251))) 1)))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___525 temp___5251)) 0))
  (=> (not (<= (to_rep1 (first4 temp___5251)) (to_rep1 (last6 temp___5251))))
  (= o3 0))))
...
;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___525 temp___5251)) 0)) (= o5 (+ 1 o4))))

;; H
  (assert
  (=> (not (= (length2 (mk___t2 temp___525 temp___5251)) 0)) (= o6 (- o5 1))))
...
;; H
  ...
  (=> (not (= (length2 (mk___t2 temp___525 temp___5251)) 0))
  (= (slide
     (concat1 temp___525 (to_rep1 (first4 temp___5251))
     (to_rep1 (last6 temp___5251)) temp___526 (to_rep1 (first6 temp___5261))
     (to_rep1 (last8 temp___5261))) (to_rep1 (first4 temp___5251)) 1)
  temp___527)))
...
;; WP_parameter_def
 ;; File "stackp.ads", line 9, characters 0-0
  (not (dynamic_property1 1 2147483647 (to_rep1 (first temp___5271))
  (to_rep1 (last temp___5271)))))
(check-sat)
(exit)
