...
;; H
  ...
  (forall ((kb1 Int))
  (=>
  (and (<= (to_rep2 (first (rt b))) kb1) (<= kb1 (to_rep2 (last (rt b)))))
  (not
  (and (= (to_rep (select (elts a) ka1)) (to_rep (select (elts b) kb1)))
  (= (is_perm (remove a ka1) (remove b kb1)) true))))))))
...
;; H
  (assert
  (and (<= (to_rep2 (first (rt a))) ka) (<= ka (to_rep2 (last (rt a))))))
...
;; H
  (assert (= result2 (ite (= o11 o10) true false)))

;; H
  (assert (= result2 true))

;; H
  (assert (and (= o3 kb) (in_range2 kb)))

;; H
  (assert
  (and (= o12 (remove b o3))
  (and (dynamic_invariant o12 true false true)
  (and (= (invariant__ o12) true)
  (and (= (to_rep2 (last o5)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o3 1)))
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (+ o3 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o4 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o3 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o4 k))))))))))))

;; H
  (assert (and (= o ka) (in_range2 ka)))

;; H
  (assert
  (and (= o13 (remove a o))
  (and (dynamic_invariant o13 true false true)
  (and (= (invariant__ o13) true)
  (and (= (to_rep2 (last o2)) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o 1)))
