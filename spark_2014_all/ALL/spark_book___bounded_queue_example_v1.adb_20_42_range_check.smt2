...
(declare-datatypes ((tT1bP1__ref 0))
(((mk_tT1bP1__ref (tT1bP1__content tT1bP1)))))
...
(define-fun us_split_fields_Count__2__projection ((a us_split_fields2)) natural
  (rec__bounded_queue_v1__queue_type__count1 a))

(define-fun us_split_fields_Front__2__projection ((a us_split_fields2)) positive
  (rec__bounded_queue_v1__queue_type__front1 a))

(define-fun us_split_fields_Rear__2__projection ((a us_split_fields2)) positive
  (rec__bounded_queue_v1__queue_type__rear1 a))

(define-fun us_split_fields_Items__2__projection ((a us_split_fields2)) (Array Int element_type)
...
(define-fun us_rep___5__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                 a))
