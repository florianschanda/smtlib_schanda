...
(declare-fun temp___242 () (Array Int natural))

(declare-fun temp___243 () Int)

(declare-fun temp___247 () (Array Int natural))
...
;; H
  ...
  (ite (and (<= (to_rep1 values__first) current2) (<= current2 temp___249))
  (and
  (and
  (and (= temp___246 previous)
  (and (= temp___244 smallest)
  (and (= temp___242 values)
  (and (= temp___243 current2)
  (and (= temp___247 values)
  (and
  (and
  (and
  (and
  ...
  (and (= o1 temp___239)
  (= (mk2 current2 (to_rep1 values__last)) temp___2391)))
  (and (= temp___239 o2)
  ...
  (= (mk___t1 o5 o6) (mk___t1 temp___240 temp___2401)))) (= o7 o5))
  ...
  (= (is_perm
     (mk___t temp___247 (mk (to_rep1 values__first) (to_rep1 values__last)))
  ...
  (<= current3 (- (to_rep1 values__last) 1)))) (= current3 temp___249))))))))))
  (and
...
;; H
  (assert (and (= temp___251 (+ i 1)) (in_range1 (+ i 1))))

;; H
  (assert
  (and (<= (to_rep1 values__first) temp___251)
  (<= temp___251 (to_rep1 values__last))))

;; H
  (assert (= o12 temp___251))

;; H
  (assert (= o13 (select (map__content values10) o12)))
