...
(declare-const previous4 map__ref)
...
(declare-const previous5 (Array Int natural))
...
(declare-const previous6 map__ref)
...
(declare-const previous7 (Array Int natural))
...
(declare-const previous8 map__ref)
...
(declare-const previous9 (Array Int natural))
...
(declare-const previous10 map__ref)
...
(declare-const previous11 (Array Int natural))
