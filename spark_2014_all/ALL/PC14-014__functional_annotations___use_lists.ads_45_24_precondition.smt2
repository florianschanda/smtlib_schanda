...
(declare-const temp___4971 us_main_type)
...
(define-fun use_lists__incr_all_3__cu__assume1 () us_rep1 (mk___rep1
                                                          (mk___split_fields1
                                                          use_lists__incr_all_3__cu__assume)))
...
;; H
  ...
  (= (bool_eq1 use_lists__incr_all_3__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__incr_all_3__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     use_lists__incr_all_3__cu__assume1) 1)))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o9 j) true)
  (=> (= (get1 o9 i) (get1 o9 j)) (= (bool_eq1 i j) true))))))))))
...
;; H
  ...
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields))) key) true)
  (and (= (has_key o9 key) true)
  (= (get1 o9 key) (get1
                   (positions
                   (mk___rep l__split_discrs
                   (mk___split_fields l__split_fields))) key)))))
  (forall ((key us_rep1))
  (=> (= (has_key o9 key) true)
  (= (has_key
     (positions
...
(assert
;; WP_parameter_def
 ;; File "use_lists.ads", line 35, characters 0-0
  (not (<= 1 n)))
(check-sat)
(exit)
