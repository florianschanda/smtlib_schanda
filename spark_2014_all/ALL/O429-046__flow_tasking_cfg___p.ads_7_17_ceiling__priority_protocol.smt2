...
(((mk___split_fields (rec__q__po2T__content integer)))))
...
(declare-datatypes ((po2T__ref 0)) (((mk_po2T__ref (po2T__content us_rep)))))
...
(((mk___split_fields1 (rec__p__po1T__content integer)))))
(define-fun us_split_fields_Content__2__projection ((a us_split_fields2)) integer
...
(((mk_po1T__ref (po1T__content us_rep1)))))
