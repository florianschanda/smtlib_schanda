...
;; range_axiom
  (assert
  (forall ((x et2)) (! (in_range (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-fun temp___6631 () et3)

(declare-fun temp___66311 () et1)

(declare-fun temp___66312 () et2)

(declare-fun temp___66313 () enum1ta)

(declare-fun result () et3)

(declare-fun result1 () et1)

(declare-fun result2 () et2)

(declare-fun result3 () enum1ta)

(declare-fun r__split_fields4 () et3)

(declare-fun r__split_fields5 () et1)

(declare-fun r__split_fields6 () et2)

(declare-fun r__split_fields7 () enum1ta)

(declare-fun r__split_fields8 () us_split_fields__ref1)

(declare-fun r__split_fields9 () us_split_fields2)

(define-fun r__split_fields10 () us_split_fields2 (mk___split_fields1
                                                  r__split_fields4
                                                  (mk___rep
                                                  (mk___split_fields
                                                  r__split_fields5
...
;; H
  (assert (= temp___6631 o5))

;; H
  (assert (= temp___66311 o6))

;; H
  (assert (= temp___66312 o7))

;; H
  (assert (= temp___66313 o8))
...
;; H
  (assert (= temp___6631 r__split_fields4))

;; H
  (assert (= temp___66311 r__split_fields5))

;; H
  (assert (= temp___66312 r__split_fields6))

;; H
  (assert (= temp___66313 r__split_fields7))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 752, characters 0-0
  (not
  (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields8))
     (mk___rep1
     (mk___split_fields1 r__split_fields
     (mk___rep (mk___split_fields r__split_fields1 (of_rep e)))
