...
(declare-fun temp___457 () Bool)

(declare-fun temp___4571 () unsigned_byte)

(declare-fun temp___4572 () unsigned_byte)
...
;; H
  (assert
  (= r__split_fields4 (mk___split_fields1 temp___457
                      (mk___rep (mk___split_fields temp___4571 temp___4572)))))
