...
(define-fun tnumber_array_typeD1__ref___15__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___15__projection ((a number_array_type__ref)) us_t1
...
(declare-datatypes ((t318b__ref 0))
(((mk_t318b__ref (t318b__content integer)))))
(define-fun t318b__ref___projection ((a t318b__ref)) integer (t318b__content
                                                             a))
...
(declare-datatypes ((t319b__ref 0))
(((mk_t319b__ref (t319b__content us_t2)))))
...
(declare-datatypes ((t320b__ref 0))
(((mk_t320b__ref (t320b__content integer)))))
(define-fun t320b__ref___projection ((a t320b__ref)) integer (t320b__content
                                                             a))
...
(define-fun tnumber_array_typeB__ref___15__projection ((a tnumber_array_typeB__ref)) us_t3
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_positive_target_length_5__n__aggregate_def (Int
  Int Int) us_t2)
...
;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4))
...
;; H
  ...
  (=> (< index2 temp___1685)
  (= (select n3 temp___1685) (select n1 temp___1685))))))
