...
(declare-fun dummy21 () (Array Int natural))
...
(declare-fun user_eq19 ((Array Int natural) (Array Int natural)) Bool)
...
(declare-fun user_eq20 (map1 map1) Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS16 () Int)

(declare-fun dummy23 () map2)
...
(declare-fun user_eq21 (map2 map2) Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS17 () Int)

(declare-fun dummy24 () map3)
...
(declare-fun user_eq22 (map3 map3) Bool)
...
(declare-fun v1__split_fields () character)

(declare-fun v2__split_fields () character)

(declare-fun v2__split_discrs () Bool)

(declare-fun v3__split_fields () character)
...
;; H
  (assert (<= 0 (object__size19 (let ((subject ua4)) ua41))))

;; H
  (assert (<= 0 (object__size1 v)))

;; H
  (assert
  (<= 0 (object__size15
        (mk___rep v1__split_discrs (mk___split_fields v1__split_fields)
        v1__attr__constrained))))

;; H
  (assert
  (<= 0 (object__size2
        (mk___rep (mk___split_discrs v2__split_discrs)
        (mk___split_fields v2__split_fields) v2__attr__constrained))))
...
;; WP_parameter_def
 ;; File "size_attr.adb", line 3, characters 0-0
  (not
  (<= 0 (object__size3
        (mk___rep v3__split_discrs (mk___split_fields v3__split_fields)
        v3__attr__constrained)))))
(check-sat)
