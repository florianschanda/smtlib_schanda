...
(define-fun bool_eq9 ((x us_t2)
  (y us_t2)) Bool (bool_eq8 (elts2 x) (to_rep1 (first4 (rt2 x)))
...
(define-fun bool_eq10 ((a map2) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (=>
  (= (bool_eq10 b b__first b__last b__first_2 b__last_2 b__first_3 b__last_3
...
(define-fun bool_eq11 ((x us_t3)
  (y us_t3)) Bool (bool_eq10 (elts3 x) (to_rep1 (first7 (rt3 x)))
...
(define-fun bool_eq12 ((a map3) (a__first Int) (a__last Int) (a__first_2 Int)
...
;; bool_eq_rev
  ...
  (=>
  (= (bool_eq12 b b__first b__last b__first_2 b__last_2 b__first_3 b__last_3
...
(define-fun bool_eq13 ((x us_t4)
  (y us_t4)) Bool (bool_eq12 (elts4 x) (to_rep1 (first11 (rt4 x)))
