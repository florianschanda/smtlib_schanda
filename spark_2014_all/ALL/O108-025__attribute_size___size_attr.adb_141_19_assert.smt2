...
(((mk___split_discrs (rec__size_attr__r1__a Bool)))))
...
(((mk___split_fields (rec__size_attr__r1__x character)))))
...
(declare-datatypes ((r1f__ref 0)) (((mk_r1f__ref (r1f__content us_rep)))))
...
(((mk___split_fields1 (rec__size_attr__r2__x integer)))))
...
(((mk___rep2 (us_split_fields5 us_split_fields4)(attr__tag Int)))))
...
(((mk___rep3 (us_split_fields7 us_split_fields6)(attr__tag1 Int)))))
...
(declare-datatypes ((r4__ref 0)) (((mk_r4__ref (r4__content us_rep3)))))
...
(declare-datatypes ((unconstrained_array__ref 0))
...
(declare-datatypes ((us_t2 0)) (((mk___t2 (elts2 map1)(rt2 t2)(rt_2 t3)))))
...
(declare-datatypes ((unconstrained_array_2__ref 0))
...
(declare-datatypes ((map__ref3 0)) (((mk_map__ref3 (map__content3 map2)))))
...
(((mk___t3 (elts3 map2)(rt3 t4)(rt_21 t5)(rt_3 t6)))))
...
(declare-datatypes ((unconstrained_array_3__ref 0))
...
(declare-datatypes ((map__ref4 0)) (((mk_map__ref4 (map__content4 map3)))))
...
(((mk___t4 (elts4 map3)(rt4 t7)(rt_22 t8)(rt_31 t9)(rt_4 t10)))))
...
(declare-datatypes ((unconstrained_array_4__ref 0))
...
(declare-datatypes ((tv1S__ref 0)) (((mk_tv1S__ref (tv1S__content us_rep)))))
