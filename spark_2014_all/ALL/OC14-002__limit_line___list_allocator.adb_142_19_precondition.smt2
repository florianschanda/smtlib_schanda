...
;; H
  (assert (= result11 (ite (< j o46) true false)))

;; H
  (assert (=> (= result11 true) (and (= o47 (+ j 2)) (in_range1 (+ j 2)))))

;; H
  (assert (=> (= result11 true) (and (= o48 (get ma1 o47)) (in_range7 o48))))

;; H
  (assert (=> (not (= result11 true)) (= o48 0)))

;; H
  (assert (and (= o45 (+ j 1)) (in_range1 (+ j 1))))
