...
(define-fun dynamic_invariant ((temp___expr_422 Int)
...
(define-fun element_type__ref___3__projection ((a element_type__ref1)) us_rep2
...
(define-fun dynamic_invariant6 ((temp___expr_443 Int)
