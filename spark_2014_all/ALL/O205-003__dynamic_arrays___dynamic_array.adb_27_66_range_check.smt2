...
(define-fun us_split_fields_Content__2__projection ((a us_split_fields4)) (Array Int us_rep)
...
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r)
                                          (mk___split_fields2
                                          (let ((temp___133 (rec__dynamic_array__holder__content
                                                            (us_split_fields3
                                                            r))))
                                          (to_array temp___133)))))
...
(((mk_tT14bP1__ref (tT14bP1__content integer)))))
...
(declare-datatypes ((t14b__ref 0)) (((mk_t14b__ref (t14b__content us_t1)))))
(define-fun t14b__ref___projection ((a t14b__ref)) us_t1 (t14b__content a))

(declare-datatypes ((us_split_fields6 0))
(((mk___split_fields3 (rec__dynamic_array__holder__content2 us_t1)))))
(define-fun us_split_fields_Content__3__projection ((a us_split_fields6)) us_t1
...
(define-fun us_rep___8__projection ((a us_rep3)) us_split_discrs2 (us_split_discrs5
                                                                  a))
...
(define-fun to_base1 ((a us_rep3)) us_rep1 (mk___rep1 (us_split_discrs5 a)
                                           (mk___split_fields1
                                           (let ((temp___135 (rec__dynamic_array__holder__content2
                                                             (us_split_fields7
                                                             a))))
                                           (of_array (to_array1 temp___135)
                                           (first3 temp___135)
                                           (last4 temp___135))))))

(define-fun of_base1 ((r us_rep1)) us_rep3 (mk___rep3 (us_split_discrs3 r)
                                           (mk___split_fields3
                                           (let ((temp___134 (rec__dynamic_array__holder__content
                                                             (us_split_fields3
                                                             r))))
                                           (of_array1 (to_array temp___134)
                                           (first1 temp___134)
                                           (last2 temp___134))))))
...
(((mk_t13b__ref (t13b__content us_rep3)))))
...
(((mk_rec_array__ref (rec_array__content us_t3)))))
(define-fun rec_array__ref___projection ((a rec_array__ref)) us_t3 (rec_array__content
                                                                   a))
...
;; def_axiom
  (assert
  (forall ((temp___232 us_rep))
  (forall ((temp___233 Int) (temp___234 Int))
  (let ((temp___231 (temp___230 temp___232 temp___233 temp___234)))
  (and
  (=> (dynamic_property7 1 2147483647 temp___233 temp___234)
  (and (= (first5 temp___231) temp___233) (= (last6 temp___231) temp___234)))
  (forall ((temp___235 Int))
  (= (select (to_array2 temp___231) temp___235) temp___232)))))))

(declare-fun temp___238 (us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___240 us_rep))
  (forall ((temp___241 Int))
  (= (select (temp___238 temp___240) temp___241) temp___240))))
...
(define-fun dynamic_invariant4 ((temp___expr_150 us_rep)
...
(define-fun dynamic_invariant5 ((temp___expr_166 us_rep1)
...
(assert
;; WP_parameter_def
 ;; File "dynamic_array.adb", line 14, characters 0-0
