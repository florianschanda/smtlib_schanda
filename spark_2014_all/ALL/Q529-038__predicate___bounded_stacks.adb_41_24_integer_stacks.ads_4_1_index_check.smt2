...
(((mk_tT23bP1__ref (tT23bP1__content integer)))))
...
(((mk_t21b__ref (t21b__content us_rep1)))))
...
(declare-datatypes ((t28b__ref 0)) (((mk_t28b__ref (t28b__content us_t2)))))
...
(declare-datatypes ((t26b__ref 0)) (((mk_t26b__ref (t26b__content us_t3)))))
...
(declare-const temp___283 positive)

(declare-const temp___2831 (Array Int element))

(declare-const temp___2832 t)

(declare-const temp___2833 natural)

(declare-const temp___2834 us_private)

(declare-const temp___2835 Int)

(declare-const temp___284 positive)

(declare-const temp___2841 (Array Int element))

(declare-const temp___2842 t)

(declare-const temp___2843 natural)

(declare-const temp___2844 us_private)

(declare-const temp___2845 Int)
