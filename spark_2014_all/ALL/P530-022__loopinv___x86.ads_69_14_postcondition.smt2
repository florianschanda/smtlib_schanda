...
;; H
  (assert
  (=> (not (= range_size ((_ int2bv 64) 0)))
  (=>
  (bvule bottom (bvsub ((_ int2bv 64) 18446744073709551615) (bvsub range_size ((_ int2bv 64) 1))))
  (= o (ite (bvule bottom var)
       (ite (bvule var (bvadd bottom (bvsub range_size ((_ int2bv 64) 1))))
       true false) false)))))
...
(assert
;; WP_parameter_def
 ;; File "x86.ads", line 64, characters 0-0
  (not (not (= range_size ((_ int2bv 64) 0)))))
(check-sat)
(exit)
