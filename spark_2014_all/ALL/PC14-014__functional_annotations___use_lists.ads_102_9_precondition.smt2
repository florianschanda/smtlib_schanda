...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o18 j) true)
  (=> (= (get1 o18 i2) (get1 o18 j)) (= (bool_eq1 i2 j) true))))))))))
...
;; H
  ...
  (forall ((k us_rep1))
  (=> (= (has_key o18 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o18 cu) (witness o18 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o16 j) true)
  (=> (= (get1 o16 i2) (get1 o16 j)) (= (bool_eq1 i2 j) true))))))))))
...
;; H
  ...
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o16 k) true) (= (bool_eq1 k cu) true))) (= o17 true)))))
