...
(declare-fun x86__readreg16__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__readreg16__result1 () (_ BitVec 16))

(declare-fun x86__readreg16__result2 () (_ BitVec 16))

(declare-fun x86__readreg16__result3 () (_ BitVec 16))

(declare-fun x86__readreg16__result4 () (_ BitVec 16))

(declare-fun x86__readreg16__result5 () (_ BitVec 16))
...
;; H
  (assert
  (= x86__readreg16__result1 ((_ extract 15 0) (bvand reg ((_ int2bv 64) 65535)))))

;; H
  (assert
  (= (mk_t__ref x86__readreg16__result4) (mk_t__ref x86__readreg16__result2)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not
  (= x86__readreg16__result4 ((_ extract 15 0) (bvand reg ((_ int2bv 64) 65535))))))
(check-sat)
(exit)
