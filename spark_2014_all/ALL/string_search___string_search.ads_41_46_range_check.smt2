...
;; H
  ...
  (and (and (= result8 i16) (= i1 temp___279))
...
;; H
  (assert
  (= o17 (ite (<= (int__content string_search__brute_force_slice__result16)
         o16) true false)))

;; H
  (assert
  (= result7 (ite (<= 0 (int__content
                        string_search__brute_force_slice__result16))
             o17 false)))
