...
(declare-fun res__split_fields4 () us_split_fields__ref)

(declare-fun res__split_discrs4 () us_split_discrs__ref)

(declare-fun linear_search__search__result6 () search_result__ref)

(declare-fun pos5 () Int)

(declare-fun res__split_fields5 () us_split_fields)

(declare-fun res__split_discrs5 () us_split_discrs)

(declare-fun linear_search__search__result7 () us_rep)

(declare-fun pos6 () int__ref)

(declare-fun res__split_fields6 () us_split_fields__ref)

(declare-fun res__split_discrs6 () us_split_discrs__ref)

(declare-fun linear_search__search__result8 () search_result__ref)

(declare-fun pos7 () Int)

(declare-fun res__split_fields7 () us_split_fields)

(declare-fun res__split_discrs7 () us_split_discrs)

(declare-fun linear_search__search__result9 () us_rep)
