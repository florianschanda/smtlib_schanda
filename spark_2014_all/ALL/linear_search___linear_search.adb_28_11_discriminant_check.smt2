...
(declare-const res__split_fields4 us_split_fields__ref)

(declare-const res__split_discrs4 us_split_discrs__ref)

(declare-const linear_search__search__result6 search_result__ref)

(declare-const pos5 Int)

(declare-const res__split_fields5 us_split_fields)

(declare-const res__split_discrs5 us_split_discrs)

(declare-const linear_search__search__result7 us_rep)

(declare-const pos6 int__ref)

(declare-const res__split_fields6 us_split_fields__ref)

(declare-const res__split_discrs6 us_split_discrs__ref)

(declare-const linear_search__search__result8 search_result__ref)

(declare-const pos7 Int)

(declare-const res__split_fields7 us_split_fields)

(declare-const res__split_discrs7 us_split_discrs)

(declare-const linear_search__search__result9 us_rep)
...
;; H
  (assert (=> (<= pos1 10) (= temp___180 pos1)))

;; H
  (assert (=> (<= pos1 10) (= 0 temp___182)))

;; H
  (assert (=> (<= pos1 10) (and (<= 1 pos1) (<= pos1 10))))

;; H
  (assert (=> (<= pos1 10) (= o pos1)))

;; H
  (assert (=> (<= pos1 10) (= o1 (select a o))))

;; H
  (assert (=> (<= pos1 10) (= o2 (to_rep1 o1))))

;; H
  (assert (=> (<= pos1 10) (= result1 (ite (= o2 val__) true false))))

;; H
  (assert (=> (<= pos1 10) (not (= result1 true))))
...
;; H
  (assert
  (=> (<= pos1 10)
  (= res__split_discrs2 (mk___split_discrs res__split_discrs))))
...
;; H
  (assert
  (=> (<= pos1 10)
  (= linear_search__search__result4 linear_search__search__result3)))

;; H
  (assert (=> (<= pos1 10) (= res__split_discrs2 res__split_discrs1)))

;; H
  (assert (=> (<= pos1 10) (= res__split_fields2 res__split_fields1)))
...
;; H
  (assert (=> (<= pos1 10) (=> (<= (- 128) 127) (in_range1 pos2))))

;; H
  (assert (=> (<= pos1 10) (= result2 (mk_int__ref temp___1821))))

;; H
  (assert (=> (<= pos1 10) (= temp___1822 pos2)))

;; H
  (assert (=> (<= pos1 10) (and (= o3 (+ pos2 1)) (in_range1 (+ pos2 1)))))

;; H
  (assert (=> (<= pos1 10) (= result3 (mk_int__ref pos2))))

;; H
  (assert (=> (<= pos1 10) (= pos3 o3)))

;; H
  (assert (=> (<= pos1 10) (not (<= pos3 10))))

;; H
  (assert
  (=> (<= pos1 10)
  (= linear_search__search__result6 (mk_search_result__ref
                                    linear_search__search__result5))))

;; H
  (assert
  (=> (<= pos1 10)
  (= res__split_discrs4 (mk___split_discrs__ref res__split_discrs3))))

;; H
  (assert
  (=> (<= pos1 10)
  (= res__split_fields4 (mk___split_fields__ref res__split_fields3))))

;; H
  (assert (=> (<= pos1 10) (= pos4 (mk_int__ref pos3))))

;; H
  (assert
  (=> (<= pos1 10)
  (= linear_search__search__result7 linear_search__search__result5)))

;; H
  (assert (=> (<= pos1 10) (= res__split_discrs5 res__split_discrs3)))

;; H
  (assert (=> (<= pos1 10) (= res__split_fields5 res__split_fields3)))

;; H
  (assert (=> (<= pos1 10) (= pos5 pos3)))

;; H
  (assert
  (=> (<= pos1 10)
  (= linear_search__search__result8 linear_search__search__result6)))

;; H
  (assert (=> (<= pos1 10) (= res__split_discrs6 res__split_discrs4)))

;; H
  (assert (=> (<= pos1 10) (= res__split_fields6 res__split_fields4)))

;; H
  (assert (=> (<= pos1 10) (= pos6 pos4)))

;; H
  (assert
  (=> (<= pos1 10)
  (= linear_search__search__result9 linear_search__search__result7)))

;; H
  (assert (=> (<= pos1 10) (= res__split_discrs7 res__split_discrs5)))

;; H
  (assert (=> (<= pos1 10) (= res__split_fields7 res__split_fields5)))

;; H
  (assert (=> (<= pos1 10) (= pos7 pos5)))

;; H
  (assert
  (=> (not (<= pos1 10))
  (= linear_search__search__result8 (mk_search_result__ref
                                    (mk___rep
                                    (mk___split_discrs
                                    linear_search__search__result)
                                    (mk___split_fields
...
;; H
  (assert
  (=> (not (<= pos1 10))
  (= res__split_discrs6 (mk___split_discrs__ref
                        (mk___split_discrs res__split_discrs)))))

;; H
  (assert
  (=> (not (<= pos1 10))
  (= res__split_fields6 (mk___split_fields__ref
                        (mk___split_fields res__split_fields)))))

;; H
  (assert (=> (not (<= pos1 10)) (= pos6 (mk_int__ref pos1))))

;; H
  (assert
  (=> (not (<= pos1 10))
  (= linear_search__search__result9 linear_search__search__result3)))

;; H
  (assert (=> (not (<= pos1 10)) (= res__split_discrs7 res__split_discrs1)))

;; H
  (assert (=> (not (<= pos1 10)) (= res__split_fields7 res__split_fields1)))

;; H
  (assert (=> (not (<= pos1 10)) (= pos7 pos1)))
...
;; WP_parameter_def
 ;; File "linear_search.ads", line 18, characters 0-0
  ...
  (= (of_int 0) (rec__linear_search__search_result__found
                (us_split_discrs__content res__split_discrs6)))))
(check-sat)
(exit)
