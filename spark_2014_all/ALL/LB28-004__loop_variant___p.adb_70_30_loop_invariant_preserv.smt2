...
(declare-fun tab34 () (Array Int integer))
...
(declare-fun tab35 () map__ref)

(declare-fun j42 () int__ref)

(declare-fun k21 () int__ref)

(declare-fun temp___1802 () int__ref)

(declare-fun temp___1792 () int__ref)

(declare-fun tab36 () (Array Int integer))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (int__content j42) (+ a (int__content k21)))))
(check-sat)
(exit)
