...
(declare-datatypes ((rx_fwto_type__ref 0))
(((mk_rx_fwto_type__ref (rx_fwto_type__content us_rep)))))
...
(define-fun register_type__ref___21__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___15__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___15__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2348 us_t1)
  (temp___is_init_2345 Bool) (temp___skip_constant_2346 Bool)
  (temp___do_toplevel_2347 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2346 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_2348)
                                       (last3 temp___expr_2348))
                                       (and (= (first3 temp___expr_2348) 1)
                                       (= (last3 temp___expr_2348) 2)))))
...
(define-fun target__ref___7__projection ((a target__ref)) us_t2 (target__content
                                                                a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___7__projection ((a source__ref)) us_rep (source__content
                                                                 a))

(define-fun dynamic_invariant1 ((temp___expr_2364 us_t2)
  (temp___is_init_2361 Bool) (temp___skip_constant_2362 Bool)
  (temp___do_toplevel_2363 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2362 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_2364)
                                       (last5 temp___expr_2364))
                                       (and (= (first5 temp___expr_2364) 1)
                                       (= (last5 temp___expr_2364) 2)))))
...
(define-fun temp___77362 () us_t2 (mk___t2 temp___7736 temp___77361))
...
;; H
  (assert
  (and (= temp___77362 (register_to_bytes reg)) (dynamic_invariant1
  temp___77362 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77361)) (to_rep (last4 temp___77361)))
     (+ (- (to_rep (last4 temp___77361)) (to_rep (first4 temp___77361))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7736 temp___7737))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77361)) (to_rep (last4 temp___77361)))
  temp___77371))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77371)) (to_rep (last2 temp___77371)))
     (+ (- (to_rep (last2 temp___77371)) (to_rep (first2 temp___77371))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7737 temp___77371)))
