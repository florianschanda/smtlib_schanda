...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__rx_fwto_type__rxfwto bits_16)))))
(define-fun us_split_fields_RXFWTO__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__rx_fwto_type__rxfwto a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__rx_fwto_type__rxfwto
...
(declare-fun dw1000__register_types__rx_fwto_type__rxfwto__first__bit () Int)

(declare-fun dw1000__register_types__rx_fwto_type__rxfwto__last__bit () Int)

(declare-fun dw1000__register_types__rx_fwto_type__rxfwto__position () Int)

;; dw1000__register_types__rx_fwto_type__rxfwto__first__bit_axiom
  (assert (<= 0 dw1000__register_types__rx_fwto_type__rxfwto__first__bit))

;; dw1000__register_types__rx_fwto_type__rxfwto__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_fwto_type__rxfwto__first__bit dw1000__register_types__rx_fwto_type__rxfwto__last__bit))

;; dw1000__register_types__rx_fwto_type__rxfwto__position_axiom
...
(declare-datatypes ()
((rx_fwto_type__ref (mk_rx_fwto_type__ref (rx_fwto_type__content us_rep)))))
(define-fun rx_fwto_type__ref___projection ((a rx_fwto_type__ref)) us_rep
  (rx_fwto_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_21__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_15__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_15__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2334 us_t1)
  (temp___is_init_2331 Bool) (temp___skip_constant_2332 Bool)
  (temp___do_toplevel_2333 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2332 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_2334)
                                       (last3 temp___expr_2334))
                                       (and (= (first3 temp___expr_2334) 1)
                                       (= (last3 temp___expr_2334) 2)))))
...
(define-fun target__ref_7__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_7__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_2350 us_t2)
  (temp___is_init_2347 Bool) (temp___skip_constant_2348 Bool)
  (temp___do_toplevel_2349 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2348 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_2350)
                                       (last5 temp___expr_2350))
                                       (and (= (first5 temp___expr_2350) 1)
                                       (= (last5 temp___expr_2350) 2)))))
...
(declare-fun temp___7589 () (Array Int bits_8))

(declare-fun temp___75891 () t2)

(declare-fun temp___7590 () (Array Int bits_8))

(declare-fun temp___75901 () t1)
...
(define-fun temp___75892 () us_t2 (mk___t2 temp___7589 temp___75891))
...
;; H
  (assert
  (and (= temp___75892 (register_to_bytes reg)) (dynamic_invariant1
  temp___75892 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75891)) (to_rep (last4 temp___75891)))
     (+ (- (to_rep (last4 temp___75891)) (to_rep (first4 temp___75891))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7589 temp___7590))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75891)) (to_rep (last4 temp___75891)))
  temp___75901))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___75901)) (to_rep (last2 temp___75901)))
     (+ (- (to_rep (last2 temp___75901)) (to_rep (first2 temp___75901))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7590 temp___75901)))
