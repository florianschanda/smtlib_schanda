...
;; H
  ...
  (= o5 (- (rate_of
           (mk___rep
           (mk___split_fields ctx__split_fields ctx__split_fields1))) 2)))))
...
;; H
  (assert
  (and (= o2 (+ in_data_bit_length 7)) (in_range (+ in_data_bit_length 7))))
...
;; H
  (assert
  (and (= o (+ out_data_bit_length 7)) (in_range (+ out_data_bit_length 7))))
