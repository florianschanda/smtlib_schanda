...
;; def_axiom
  (assert
  (forall ((temp___1151 (_ BitVec 8)))
  (forall ((temp___1152 Int) (temp___1153 Int))
  (let ((temp___1150 (temp___1149 temp___1151 temp___1152 temp___1153)))
  (and
  (=> (dynamic_property6 1 65536 temp___1152 temp___1153)
  (and (= (first5 temp___1150) temp___1152)
  (= (last5 temp___1150) temp___1153)))
  (forall ((temp___1154 Int))
  (= (select (to_array2 temp___1150) temp___1154) (of_rep1 temp___1151))))))))
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1149 ((_ int2bv 8) 0) 1 r19b)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1149 ((_ int2bv 8) 0) 1 r19b)))) r19b))

;; H
  (assert
  (= (mk___t2 temp___1156 temp___11561) (temp___1149 ((_ int2bv 8) 0) 1 r19b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11561)) (to_rep2 (last4 temp___11561)))
     (+ (- (to_rep2 (last4 temp___11561)) (to_rep2 (first4 temp___11561))) 1)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11561)) (to_rep2 (last4 temp___11561)))
  temp___11571))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___11571)) (to_rep2 (last2 temp___11571)))
     (+ (- (to_rep2 (last2 temp___11571)) (to_rep2 (first2 temp___11571))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1159 temp___11591) (mk___t1 temp___1157 temp___11571)))
...
;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11591)) (to_rep2 (last2 temp___11591)))
  o1))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___11611 temp___11612))))
...
;; H
  ...
  (forall ((temp___1172 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1172)
  (<= temp___1172 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1172) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1172))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
