...
;; H
  ...
  (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib2)))
  (= (is_perm (remove a ia) (remove b ib2)) true))))))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= result1 (is_perm o9 o8))
  (= (= result1 true)
  (or (and (= (length o9) 0) (= (length o8) 0))
  (exists ((ia1 Int))
  (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1))))
  (exists ((ib2 Int))
  (and (and (<= (to_rep1 (first o4)) ib2) (<= ib2 (to_rep1 (last o4))))
  (and (= (to_rep (select o ia1)) (to_rep (select o3 ib2)))
  (= (is_perm (remove o9 ia1) (remove o8 ib2)) true)))))))))))
