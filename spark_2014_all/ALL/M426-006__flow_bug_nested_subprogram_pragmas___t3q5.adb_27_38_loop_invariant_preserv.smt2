...
;; H
  (assert
  (=> (< (to_rep (select arr i3)) (to_rep (select arr k3))) (= result3 k3)))

;; H
  (assert
  (=> (< (to_rep (select arr i3)) (to_rep (select arr k3))) (= k4 i3)))

;; H
  (assert
  (=> (not (< (to_rep (select arr i3)) (to_rep (select arr k3)))) (= k4 k3)))
