...
(declare-fun temp___1427 () us_t6)

(declare-fun temp___1428 () us_t5)

(declare-fun temp___1432 () us_t5)

(declare-fun o13 () (Array Int character))

(declare-fun o14 () screenycoordt)

(declare-fun o15 () screenxcoordt)
...
;; H
  ...
  (= (select o1 temp___1407) (select result__4 temp___1407)))))
...
;; H
  ...
  (= (select o7 temp___1420) (select result__6 temp___1420)))))
...
;; H
  (assert (= temp___1427 (mk___t6 o12 (mk6 2 (to_rep1 data__last2)))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first10 (rt5 temp___1428))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first10 (mk5 1 (- (to_rep1 data__last2) 1)))) 
        (to_rep1 (last10 (mk5 1 (- (to_rep1 data__last2) 1)))))
        (+ (- (to_rep1 (last10 (mk5 1 (- (to_rep1 data__last2) 1)))) 
...
;; H
  ...
  (= (select o13 temp___1433) (select (elts5 temp___1432) temp___1433))
  (= (select o13 temp___1433) (select result__8 temp___1433)))))

;; H
  (assert (= result12 (mk_map__ref result__8)))

;; H
  (assert (= result__9 o13))
...
;; H
  (assert (= (to_rep4 o14) 25))

;; H
  (assert (= (to_rep3 o15) 50))
