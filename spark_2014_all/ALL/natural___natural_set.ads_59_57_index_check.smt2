...
(((mk_set_length__ref (set_length__content set_length)))))
...
(declare-datatypes ((set_index__ref 0))
(((mk_set_index__ref (set_index__content set_index)))))
...
;; H
  ...
  (forall ((i1 Int))
  (=>
  (and (<= (+ (to_rep (rec__natural_set__t__len (us_split_fields1 s))) 1) i1)
  (<= i1 10))
  (= (to_rep1 (select (rec__natural_set__t__m (us_split_fields1 s)) i1)) (- 1))))))
