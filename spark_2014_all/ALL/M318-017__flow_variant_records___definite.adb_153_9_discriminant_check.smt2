...
(declare-fun temp___219 () status)

(declare-fun temp___2191 () natural)

(declare-fun temp___2192 () natural)

(declare-fun temp___2193 () Bool)

(declare-fun temp___2194 () Bool)
...
(assert
;; WP_parameter_def
 ;; File "definite.adb", line 141, characters 0-0
  (not (= temp___219 x__split_discrs)))
(check-sat)
