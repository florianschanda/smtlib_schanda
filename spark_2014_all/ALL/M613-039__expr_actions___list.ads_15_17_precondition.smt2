...
(declare-fun temp___468 () capacity_range)

(declare-fun temp___4681 () us_main_type)

(declare-fun temp___467 () Int)

(declare-fun temp___473 () r1)

(declare-fun temp___4731 () (Array Int integer))

(declare-fun temp___466 () r1)

(declare-fun temp___4661 () (Array Int integer))
...
;; H
  ...
  (and (= res__split_discrs (mk___split_discrs temp___468))
  (= res__split_fields temp___4681))))
...
;; H
  ...
  (= (us_split_fields__content s__split_fields7) (mk___split_fields
                                                 temp___473 temp___4731))))

;; H
  (assert
  (=> (and (<= first2 i9) (<= i9 last3))
  (= (us_split_fields__content s__split_fields7) (mk___split_fields
                                                 temp___466 temp___4661))))
...
;; H
  ...
  (= (bool_eq1 (elts (to__ (mk___rep s__split_fields10)))
     (to_rep (first3 (mk1 first2 (- last3 i10))))
     (to_rep (last4 (mk1 first2 (- last3 i10))))
     (elts (to__ (mk___rep (mk___split_fields temp___473 temp___4731))))
     (to_rep (first5 (mk2 first2 (- last3 i10))))
     (to_rep (last6 (mk2 first2 (- last3 i10))))) true))
  (forall ((j Int))
  (=> (and (<= first2 j) (<= j i10))
...
;; H
  (assert
  (and (= o8 (last2 (model__ l)))
  (and (in_range6 o8) (= o8 (last2 (model__ l))))))
