...
(declare-fun temp___424 (Int Int Int) (Array Int unsigned_byte))

;; def_axiom
  (assert
  (forall ((temp___426 Int) (temp___427 Int) (temp___428 Int))
  (let ((temp___425 (temp___424 temp___426 temp___427 temp___428)))
  (forall ((temp___429 Int))
  (ite (= temp___429 7)
  (= (select temp___425 temp___429) (of_rep temp___427))
  (ite (= temp___429 2)
  (= (select temp___425 temp___429) (of_rep temp___426))
  (= (select temp___425 temp___429) (of_rep temp___428))))))))
