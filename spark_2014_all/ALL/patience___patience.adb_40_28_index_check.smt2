...
(declare-fun o11 () cardindex)

(declare-fun temp___547 () Int)

(declare-fun o12 () Int)

(declare-fun temp___548 () (Array Int cardindex))
...
(declare-fun o19 () cardindex)

(declare-fun o20 () Int)

(declare-fun o21 () cardindex)

(declare-fun temp___544 () Int)

(declare-fun o22 () Int)

(declare-fun o23 () cardindex)
...
(declare-fun o30 () cardindex)

(declare-fun o31 () Int)

(declare-fun o32 () Int)

(declare-fun o33 () cardindex)
...
;; H
  ...
  (=> (<= (- 1) 100) (in_range3 stackisize1)))
  (=> (<= (- 1) 100) (in_range3 topstacki1)))
...
;; H
  (assert (=> (= result9 true) (= o31 (to_rep1 o30))))

;; H
  (assert
  (=> (= result9 true)
  (= result8 (ite (< o31 (to_rep1 s__split_fields2)) true false))))
...
;; H
  (assert (=> (= result8 true) (= o28 (to_rep1 o27))))
...
;; H
  (assert (=> (= result7 true) (= temp___544 (to_rep1 o21))))

;; H
  (assert (=> (= result7 true) (and (<= 0 temp___544) (<= temp___544 99))))

;; H
  (assert (=> (= result7 true) (= o22 temp___544)))

;; H
  (assert (=> (= result7 true) (= o23 (select s__split_fields3 o22))))

;; H
  (assert (=> (= result7 true) (= o24 (to_rep1 o23))))
...
;; H
  (assert (=> (= result7 true) (= o25 (to_rep1 o19))))
...
;; H
  (assert (=> (= result6 true) (= temp___547 (to_rep1 o11))))

;; H
  (assert (=> (= result6 true) (and (<= 0 temp___547) (<= temp___547 99))))

;; H
  (assert (=> (= result6 true) (= o12 temp___547)))

;; H
  (assert (=> (= result6 true) (= temp___548 (select s__split_fields4 o12))))
...
;; H
  (assert (=> (= result6 true) (= temp___550 (to_rep1 o14))))

;; H
  (assert (=> (= result6 true) (and (<= 0 temp___550) (<= temp___550 99))))

;; H
  (assert (=> (= result6 true) (= o15 temp___550)))

;; H
  (assert (=> (= result6 true) (= o16 (select temp___548 o15))))

;; H
  (assert (=> (= result6 true) (= o17 (to_rep1 o16))))

;; H
  (assert
  (=> (= result6 true) (= result5 (ite (= o17 topstacki2) true false))))
