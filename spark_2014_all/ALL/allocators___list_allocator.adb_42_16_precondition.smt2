...
;; H
  (assert
  (and (= o22 (length model____split_fields))
  (and (in_range6 o22) (<= (+ 0 o22) 2147483647))))
...
;; H
  (assert
  (=> (= result3 true)
  (and (= o21 (length1 model____split_fields1)) (in_range6 o21))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o17 (length1 model____split_fields1)) (in_range6 o17))))

;; H
  (assert
  (=> (= result2 true)
  (and (= o18 (length model____split_fields))
  (and (in_range6 o18) (<= (+ 0 o18) 2147483647)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result4 (ite (< 0 o15) true false)))))
...
;; H
  ...
  (=> (not (= first_available 0))
  (=> (= result4 true)
  (and (= o14 (get model____split_fields 1)) (in_range7 o14))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result4 true) (= result (ite (= o14 first_available) true false))))))
...
;; H
  ...
  (and (= o16 (length model____split_fields))
  (and (in_range6 o16) (<= (+ 0 o16) 2147483647))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_available 0)))
  (= result (ite (= o16 0) true false)))))
...
;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true) (and (= o10 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result7 true)
  (=> (= result8 true)
  (and (= o11 (get model____split_fields o10)) (in_range7 o11)))))
...
;; H
  (assert
  (=> (= result7 true)
  (= (mk___rep (mk___split_fields o4 o5)) (select data o3))))
