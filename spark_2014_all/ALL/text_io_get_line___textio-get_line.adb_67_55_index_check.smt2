...
;; H
  ...
  (and (= (to_rep1 o) 1)
  (forall ((idx1 Int))
  (=> (and (<= (to_rep1 o) idx1) (<= idx1 (to_rep1 o1)))
  (ite (< idx1 (+ (to_rep1 o) n))
  ...
  (ite (and (<= o7 idx1) (<= idx1 (- (+ o7 (- n 1)) 1)))
  (= (to_rep (select item2 idx1)) (to_rep (select buf3 (+ (- idx1 o7) 1))))
  ...
  (forall ((idx1 Int))
  (=> (and (<= (to_rep1 item__first) idx1) (<= idx1 (to_rep1 item__last)))
  (ite (and (<= o16 idx1) (<= idx1 (- (+ o16 k3) 1)))
  (= (to_rep (select item3 idx1)) (to_rep (select buf3 (+ (- idx1 o16) 1))))
...
;; H
  (assert
  (and (= result18 (no_char_in_slice 10 cur_position o19 the_file))
  (= (= result18 true)
  (forall ((idx1 Int))
...
;; H
  (assert
  (=> (= result18 true)
  (and (= o18 (- (+ cur_position n) 2)) (in_range2 (- (+ cur_position n) 2)))))

;; H
  (assert
  (=> (= result18 true)
  (and (= result17 (no_char_in_slice eof_ch cur_position o18 the_file))
  (= (= result17 true)
  (forall ((idx1 Int))
  (=> (and (<= cur_position idx1) (<= idx1 o18))
...
;; H
  (assert
  (and (= result19 (no_char_in_slice eof_ch cur_position o20 the_file))
  (= (= result19 true)
  (forall ((idx1 Int))
...
;; H
  (assert
  (and (= o28 (- (+ cur_position n) 2)) (in_range2 (- (+ cur_position n) 2))))

;; H
  (assert
  (and (= o29 (find_char_in_slice eof_ch cur_position o28 the_file))
  (and (in_range2 o29)
  (and (and (<= cur_position o29) (<= o29 o28))
  (and (= (no_char_in_slice eof_ch cur_position (- o29 1) the_file) true)
  (= (to_rep (select the_file o29)) eof_ch))))))

;; H
  (assert (= o30 (+ last2 o29)))

;; H
  (assert (= o31 (- o30 cur_position)))

;; H
  (assert (= result20 (ite (= (int__content last14) o31) true false)))
...
;; H
  (assert
  (and (= o22 (find_char_in_slice eof_ch cur_position o21 the_file))
  (and (in_range2 o22)
  (and (and (<= cur_position o22) (<= o22 o21))
  (and (= (no_char_in_slice eof_ch cur_position (- o22 1) the_file) true)
  (= (to_rep (select the_file o22)) eof_ch))))))
...
;; H
  (assert (= o26 (select the_file o25)))
