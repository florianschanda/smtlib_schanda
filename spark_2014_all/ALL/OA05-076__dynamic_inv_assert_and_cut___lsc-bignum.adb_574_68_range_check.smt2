...
;; H
  (assert (= o46 (ite (<= j3 o45) true false)))

;; H
  (assert (= o41 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o42 (oexpon o41 j3)))

;; H
  (assert (= o36 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o35 (from_integer j3)))
...
;; H
  (assert (and (= o22 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert (= o26 (oexpon o21 o25)))

;; H
  (assert (= o20 (from_word32 w2)))

;; H
  (assert (= o27 (omultiply o20 o26)))
