...
(declare-fun res__split_fields () Bool)

(declare-fun res__split_fields1 () index)

(declare-fun linear_search__search__result () Bool)

(declare-fun linear_search__search__result1 () index)

(declare-fun res__split_fields2 () Bool)

(declare-fun res__split_fields3 () index)

(declare-fun linear_search__search__result2 () Bool)

(declare-fun linear_search__search__result3 () index)
