...
(declare-datatypes ((unconstr_ar__ref 0))
(((mk_unconstr_ar__ref (unconstr_ar__content us_t)))))
(define-fun unconstr_ar__ref___projection ((a unconstr_ar__ref)) us_t
  (unconstr_ar__content a))
...
(define-fun dynamic_invariant ((temp___expr_145 us_t)
  ...
  (temp___do_toplevel_144 Bool)) Bool (=>
                                      ...
                                      2147483647 (first1 temp___expr_145)
