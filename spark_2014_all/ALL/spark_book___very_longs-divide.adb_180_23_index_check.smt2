...
(define-fun in_range4 ((rec__very_longs__very_long__length1 Int)
  (a us_rep)) Bool (= rec__very_longs__very_long__length1 (to_rep1
                                                          (rec__very_longs__very_long__length
                                                          (us_split_discrs1
                                                          a)))))
...
(define-fun dynamic_invariant5 ((temp___expr_708 us_rep1)
...
(define-fun default_initial_assumption ((temp___expr_711 us_rep1)
  (temp___skip_top_level_712 Bool)) Bool (= (to_rep1
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_711))) (+ (to_rep1
                                                                  (rec__very_longs__very_long__length
                                                                  (us_split_discrs1
                                                                  dividend))) 1)))
...
(declare-fun dummy12 () tdigit_count_typeB)
...
(define-fun dynamic_invariant6 ((temp___expr_720 us_rep2)
...
(define-fun default_initial_assumption1 ((temp___expr_723 us_rep2)
  (temp___skip_top_level_724 Bool)) Bool (= (to_rep1
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs3
                                            temp___expr_723))) (to_rep1
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               divisor)))))
...
(declare-fun temp___1281 () (_ BitVec 16))

(declare-fun temp___1278 () digit_index_type)

(declare-fun temp___12781 () (Array Int octet))

(declare-fun temp___12782 () t1)

(declare-fun temp___1277 () (_ BitVec 16))

(declare-fun temp___1276 () (_ BitVec 16))

(declare-fun temp___1275 () (_ BitVec 16))

(declare-fun temp___1274 () (_ BitVec 16))
...
(declare-fun temp___1273 () us_rep1)

(declare-fun temp___1285 () Int)

(declare-fun o30 () Int)

(declare-fun o31 () octet)

(declare-fun o32 () (_ BitVec 8))

(declare-fun o33 () (_ BitVec 16))
...
(declare-fun o35 () octet)

(declare-fun o36 () (_ BitVec 8))

(declare-fun o37 () (_ BitVec 16))

(declare-fun o38 () (_ BitVec 16))

(declare-fun o39 () (_ BitVec 16))

(declare-fun o40 () (_ BitVec 16))

(declare-fun o41 () (_ BitVec 16))

(declare-fun o42 () (_ BitVec 8))

(declare-fun o43 () octet)
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (= temp___1281 carry1)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (and (= (mk___split_discrs temp___1278) u__split_discrs)
  (and (= temp___12781 u__split_fields) (= temp___12782 u__split_fields1)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (= temp___1277 current_borrow1)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (= temp___1276 future_borrow)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (= temp___1275 temporary_digit)))
...
;; H
  ...
  true true) (and (<= 1 divisor_index2) (<= divisor_index2 r126b)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b)) (= product3 o5)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b)) (= carry3 o6)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (and (= o7 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (and (= o13 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b)) (= o21 o20)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (and (= o12 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b)) (= o25 o26)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b)) (= o28 o26)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b)) (= o29 o27)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (= temp___1273 (mk___rep1 u__split_discrs
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (= u__split_fields4 (us_split_fields3 temp___1273))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r126b))
  (= u__split_discrs (us_split_discrs2 temp___1273))))
...
;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r126b)))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1285)
  (<= temp___1285 (to_rep2
                  (last3
                  (rt1
                  (rec__very_longs__very_long__long_digits1
...
;; H
  (assert (= o30 temp___1285))

;; H
  (assert
  (= o31 (select (elts1
                 (rec__very_longs__very_long__long_digits1
                 (us_split_fields__content1 u__split_fields7))) o30)))
...
;; H
  (assert
  (= result11 (ite (bvuge o33 (bvadd (t__content1 carry6) (t__content1
                                                          current_borrow6)))
              true false)))
...
;; H
  (assert (and (= temp___1287 (+ j n)) (in_range1 (+ j n))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1287)
  (<= temp___1287 (to_rep2
                  (last3
                  (rt1
                  (rec__very_longs__very_long__long_digits1
...
;; H
  (assert (= o34 temp___1287))

;; H
  (assert
  (= o35 (select (elts1
                 (rec__very_longs__very_long__long_digits1
                 (us_split_fields__content1 u__split_fields7))) o34)))
...
;; H
  (assert (and (= temp___1289 (+ j n)) (in_range1 (+ j n))))
...
;; WP_parameter_def
 ;; File "very_longs-divide.adb", line 109, characters 0-0
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1289)))
(check-sat)
(exit)
