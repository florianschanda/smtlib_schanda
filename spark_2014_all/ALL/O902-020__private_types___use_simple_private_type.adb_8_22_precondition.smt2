...
(declare-fun use_simple_private_type__add__result () us_rep)

(declare-fun use_simple_private_type__add__result1 () us_rep)

(declare-fun result () Bool)

(declare-fun use_simple_private_type__add__result2 () us_rep)
...
;; H
  (assert
  (= use_simple_private_type__add__result2 use_simple_private_type__add__result))

;; H
  (assert
  (= use_simple_private_type__add__result2 use_simple_private_type__add__result1))
