...
(declare-fun dummy7 () (Array Int Bool))
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__main__discr_type__m_array1 (Array Int Bool))))))
(define-fun us_split_fields_M_Array2__projection ((a us_split_fields2)) (Array Int Bool)
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r)
                                         (mk___split_fields1
                                         (let ((temp___134 (rec__main__discr_type__m_array
                                                           (us_split_fields1
                                                           r))))
                                         (to_array temp___134)))))
...
(declare-fun main__discr_type__discr__first__bit1 () Int)

(declare-fun main__discr_type__discr__last__bit1 () Int)

(declare-fun main__discr_type__discr__position1 () Int)
...
(declare-fun main__discr_type__m_array__first__bit1 () Int)

(declare-fun main__discr_type__m_array__last__bit1 () Int)

(declare-fun main__discr_type__m_array__position1 () Int)
...
(define-fun dynamic_invariant2 ((temp___expr_290 us_rep1)
  (temp___is_init_287 Bool) (temp___skip_constant_288 Bool)
  (temp___do_toplevel_289 Bool)) Bool (=>
                                      (not (= temp___skip_constant_288 true))
                                      (in_range5 15
                                      (to_base temp___expr_290))))

(define-fun default_initial_assumption ((temp___expr_293 us_rep1)
...
(declare-fun temp___discr_299 () Int)
