...
(declare-fun temp___1051 () us_rep1)
...
(declare-fun temp___1046 () us_rep1)
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= temp___1051 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= temp___1046 (mk___rep1 result____split_discrs o30))))
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= result____split_fields10 (us_split_fields3 temp___1046))))
...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= result____split_discrs (us_split_discrs2 temp___1046))))
