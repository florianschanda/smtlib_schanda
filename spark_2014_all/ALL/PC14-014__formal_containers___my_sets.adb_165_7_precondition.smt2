...
;; mapping_preserved__post_axiom
  ...
  (! (=> (= (mapping_preserved e_left e_right p_left p_right) true)
     ...
     (= (bool_eq4 (get e_left (get1 p_left c))
        (get e_right (get1 p_right c))) true))))) :pattern ((mapping_preserved
                                                            e_left e_right
                                                            p_left p_right)) ))))
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k us_rep2))
     (and (= (has_key container k) true) (= (bool_eq6 k key) true)))
...
;; keys_included_except__post_axiom
  ...
  (! (= (= (keys_included_except left right new_key) true)
     (forall ((key us_rep2))
     (=> (= (has_key left key) true)
     (=> (not (= (bool_eq6 key new_key) true)) (= (has_key right key) true))))) :pattern (
...
;; H
  ...
  (= (bool_eq6 temp___14381 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= (bool_eq6 temp___14391 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
