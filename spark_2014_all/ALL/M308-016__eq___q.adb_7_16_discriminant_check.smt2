...
(declare-const res__split_fields integer)

(declare-const res__split_fields1 Bool)

(declare-const result integer)

(declare-const result1 Bool)

(declare-const res__split_fields2 integer)

(declare-const res__split_fields3 Bool)

;; H
  (assert (= result res__split_fields))

;; H
  (assert (= result1 res__split_fields1))

;; H
  (assert
  (= (mk___split_fields res__split_fields2 res__split_fields3) (us_split_fields1
                                                               x)))

;; H
  (assert (= res__split_discrs (us_split_discrs1 x)))

;; H
  (assert (= (to_int1 (rec__q__t__b res__split_discrs)) 1))

(assert
;; WP_parameter_def
 ;; File "q.ads", line 2, characters 0-0
  (not (= (to_int1 (rec__q__t__b res__split_discrs)) 1)))
(check-sat)
(exit)
