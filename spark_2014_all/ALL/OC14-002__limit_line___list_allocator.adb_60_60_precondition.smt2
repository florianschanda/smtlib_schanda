...
;; H
  ...
  (and (= o34 (length model____split_fields)) (in_range6 o34))))

;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o34) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o33 (get model____split_fields 1)) (in_range7 o33)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o33 first_available) true false)))))
...
;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= result2 (ite (= o35 0) true false))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (and (= o31 (length model____split_fields1)) (in_range6 o31)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o31) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o30 (get model____split_fields1 1)) (in_range7 o30))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o30 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o28 (length model____split_fields)) (in_range6 o28))))
...
;; H
  (assert
  (=> (= result9 true)
  (and (= o23 (length model____split_fields1)) (in_range6 o23))))
...
;; H
  (assert
  (=> (= result9 true)
  (=> (= result10 true) (and (= o24 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result9 true)
  (=> (= result10 true)
  (and (= o25 (get model____split_fields1 o24)) (in_range7 o25)))))
...
;; H
  (assert
  (=> (= result8 true)
  (=> (< 1 j) (and (= o13 (get model____split_fields1 o12)) (in_range7 o13)))))
