...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 5.0)))
...
;; H
  (assert
  (and (and (le (neg fliteral2) x) (le x fliteral3))
  (and (le (neg fliteral) y) (le y fliteral3))))

;; H
  (assert (and (= o (mul RNE1 x y)) (tqtisFinite (mul RNE1 x y))))

;; H
  (assert (= result (ite (le o (neg fliteral3)) true false)))
