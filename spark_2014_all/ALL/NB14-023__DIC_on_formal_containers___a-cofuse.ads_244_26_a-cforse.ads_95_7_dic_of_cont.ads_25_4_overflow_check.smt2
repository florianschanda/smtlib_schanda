...
(define-fun default_initial_assumption ((temp___expr_1293 us_rep)
...
(define-fun element_type__ref___17__projection ((a element_type__ref)) element_type
  (element_type__content a))

(define-fun dynamic_invariant1 ((temp___expr_1286 Int)
