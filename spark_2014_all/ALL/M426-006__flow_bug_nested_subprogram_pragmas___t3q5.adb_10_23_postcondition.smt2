...
(declare-fun t3q5__sort__find_smallest__result1 () Int)

(declare-fun t3q5__sort__find_smallest__result2 () Int)

(declare-fun t3q5__sort__find_smallest__result3 () Int)

(declare-fun k10 () Int)

(declare-fun i10 () Int)

(declare-fun t3q5__sort__find_smallest__result4 () Int)

(declare-fun k11 () Int)

(declare-fun i11 () Int)

(declare-fun t3q5__sort__find_smallest__result5 () Int)
...
;; H
  ...
  (=> (< l u)
  (=> (and (<= (+ l 1) i2) (<= i2 u))
  (=> (< (to_rep (select arr i2)) (to_rep (select arr k1))) (= k1 result1)))))

;; H
  (assert
  (=> (< l u)
  (=> (and (<= (+ l 1) i2) (<= i2 u))
  (=> (< (to_rep (select arr i2)) (to_rep (select arr k1))) (= k2 i2)))))

;; H
  (assert
  (=> (< l u)
  (=> (and (<= (+ l 1) i2) (<= i2 u))
  (=> (not (< (to_rep (select arr i2)) (to_rep (select arr k1)))) (= k2 k1)))))
...
;; H
  ...
  (=> (and (<= (+ l 1) i2) (<= i2 u))
  (and
  (and (=> (<= (+ l 1) u) (dynamic_property (+ l 1) u i3))
  (=> (<= 1 100) (in_range1 k3))) (and (<= (+ l 1) i3) (<= i3 u))))))
...
;; H
  (assert
  (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (= i13 (mk_int__ref i4)))))

;; H
  (assert
  (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (= k13 (mk_int__ref k4)))))
...
;; H
  (assert
  (= t3q5__sort__find_smallest__result1 t3q5__sort__find_smallest__result2))

;; H
  (assert
  (= t3q5__sort__find_smallest__result3 t3q5__sort__find_smallest__result1))

;; H
  (assert
  (= (mk_int__ref result2) (mk_int__ref t3q5__sort__find_smallest__result)))
...
;; H
  (assert
  (= (mk_int__ref t3q5__sort__find_smallest__result4) (mk_int__ref
                                                      t3q5__sort__find_smallest__result2)))
...
;; H
  (assert
  (= t3q5__sort__find_smallest__result5 t3q5__sort__find_smallest__result3))
...
;; WP_parameter_def
 ;; File "t3q5.ads", line 6, characters 0-0
  (not (<= l t3q5__sort__find_smallest__result4)))
(check-sat)
(exit)
