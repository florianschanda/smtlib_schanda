...
(declare-fun o1 () message_count_type)
...
(declare-fun result2 () message_index_type)

(declare-fun result3 () message_count_type)

(declare-fun result4 () Bool)

(declare-fun result5 () (Array Int message_type))
...
(declare-fun result7 () message_index_type)

(declare-fun result8 () message_count_type)

(declare-fun result9 () Bool)

(declare-fun result10 () (Array Int message_type))
...
(define-fun self__15 () us_rep (mk___rep
                               (mk___split_fields self__5 self__6 self__7
                               self__8 self__9)))
...
;; H
  (assert
  (and (= o (- (to_rep2 self__2) 1)) (in_range3 (- (to_rep2 self__2) 1))))
...
;; WP_parameter_def
 ;; File "tasking.ads", line 11, characters 0-0
  (not (in_range2 (+ (to_rep1 self__11) 1))))
(check-sat)
