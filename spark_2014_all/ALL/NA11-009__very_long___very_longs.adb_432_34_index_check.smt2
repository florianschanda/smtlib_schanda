...
;; H
  (assert
  (and (= o (shift_right__2 ((_ int2bv 8) 255) (- 8 distance)))
...
;; H
  ...
  true true true)
  (forall ((temp___1241 Int))
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1241)
  (<= temp___1241 (to_rep1 (last number__split_fields3))))
  (=> (<= temp___1241 i2)
  (= (select number__split_fields2 temp___1241) (select number__split_fields temp___1241))))))
  (and (<= 1 i2) (<= i2 r122b))))
...
;; H
  (assert
  (and (= o8 (shift_right__2 o7 distance))
...
;; H
  ...
  (= number__split_fields4 (mk___split_fields
                           (mk___t temp___12321 temp___12322))))
...
;; H
  (assert
  (=> (< (- 8 distance) 8)
  (= o16 (bvshl old_overflow2 ((_ int2bv 8) (- 8 distance))))))

;; H
  (assert (=> (not (< (- 8 distance) 8)) (= o16 ((_ int2bv 8) 0))))
