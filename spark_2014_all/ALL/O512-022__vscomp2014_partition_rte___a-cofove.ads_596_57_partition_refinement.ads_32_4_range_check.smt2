...
(define-fun dynamic_invariant3 ((temp___expr_712 Int)
...
(((mk_index__ref (index__content index1)))))
(define-fun index__ref___projection ((a index__ref)) index1 (index__content
                                                            a))

(define-fun dynamic_invariant5 ((temp___expr_305 Int)
  (temp___is_init_302 Bool) (temp___skip_constant_303 Bool)
  (temp___do_toplevel_304 Bool)) Bool (=>
                                      (or (= temp___is_init_302 true)
                                      (<= 0 5)) (in_range6 temp___expr_305)))
...
;; range_axiom
  (assert
  (forall ((x index_count)) (! (in_range5
...
;; range_axiom
  (assert
  (forall ((x index1)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(((mk___split_fields1
  (rec__partition_refinement__interval__first index1)(rec__partition_refinement__interval__last index1)(rec__partition_refinement__interval__count index_count)))))
(define-fun us_split_fields_First__projection ((a us_split_fields2)) index1
  (rec__partition_refinement__interval__first a))

(define-fun us_split_fields_Last__projection ((a us_split_fields2)) index1
