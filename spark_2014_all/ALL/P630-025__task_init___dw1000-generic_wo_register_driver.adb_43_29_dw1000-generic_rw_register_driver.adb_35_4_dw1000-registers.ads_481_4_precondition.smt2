...
(define-fun us_split_fields__ref___65__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___65__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-const dw1000__register_types__fs_plltune_type__fs_plltune__first__bit Int)

(declare-const dw1000__register_types__fs_plltune_type__fs_plltune__last__bit Int)

(declare-const dw1000__register_types__fs_plltune_type__fs_plltune__position Int)
...
(declare-datatypes ((fs_plltune_type__ref 0))
...
(define-fun register_type__ref___154__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___109__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___109__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5718 us_t1)
  (temp___is_init_5715 Bool) (temp___skip_constant_5716 Bool)
  (temp___do_toplevel_5717 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5716 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5718)
                                       (last3 temp___expr_5718))
                                       (and (= (first3 temp___expr_5718) 1)
                                       (= (last3 temp___expr_5718) 1)))))
...
(define-fun target__ref___46__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___46__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_5734 us_t2)
  (temp___is_init_5731 Bool) (temp___skip_constant_5732 Bool)
  (temp___do_toplevel_5733 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5732 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_5734)
                                       (last5 temp___expr_5734))
                                       (and (= (first5 temp___expr_5734) 1)
                                       (= (last5 temp___expr_5734) 1)))))
...
(declare-const temp___8048 (Array Int bits_8))

(declare-const temp___80481 t2)

(declare-const temp___8049 (Array Int bits_8))

(declare-const temp___80491 t1)
...
(define-fun temp___80482 () us_t2 (mk___t2 temp___8048 temp___80481))
...
;; H
  (assert
  (and (= temp___80482 (register_to_bytes reg)) (dynamic_invariant1
  temp___80482 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80481)) (to_rep (last4 temp___80481)))
     (+ (- (to_rep (last4 temp___80481)) (to_rep (first4 temp___80481))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))

;; H
  (assert (= temp___8048 temp___8049))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80481)) (to_rep (last4 temp___80481)))
  temp___80491))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80491)) (to_rep (last2 temp___80491)))
     (+ (- (to_rep (last2 temp___80491)) (to_rep (first2 temp___80491))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8049 temp___80491)))
