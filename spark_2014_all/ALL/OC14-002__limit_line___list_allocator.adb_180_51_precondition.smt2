...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result11 (ite (< 0 o45) true false))))
...
;; H
  ...
  (=> (= result11 true)
  (and
  (= o44 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o44)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result11 true)
  (= result10 (ite (= o44 first_available1) true false)))))
...
;; H
  (assert
  (=> (not (not (= first_available1 0)))
  (= result10 (ite (= o46 0) true false))))

;; H
  (assert (= result10 true))

;; H
  (assert (not (= first_allocated1 0)))
...
;; H
  (assert (= result12 (ite (< 0 o43) true false)))
