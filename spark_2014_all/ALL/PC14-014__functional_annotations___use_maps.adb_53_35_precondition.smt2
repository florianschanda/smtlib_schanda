...
;; H
  ...
  (=> (and (in_range3 temp___431) (= (iter_has_element o10 temp___431) true))
  (= (has_key (model__ s) (get o10 temp___431)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o10 key2)) (= (get o10 (find o10 key2)) key2)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o10 (get o10 i1)) i1))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length s)))
  (=> (= (get o10 i1) (get o10 j)) (= i1 j)))))))))
...
;; H
  ...
  (=>
  (exists ((k Int))
  (and (and (in_range2 k) (= (has_key o9 k) true)) (= k o11)))
  (= result3 true)))))
