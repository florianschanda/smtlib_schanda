...
;; H
  (assert
  (and (= o41 (remove (mk___t values2 (mk 1 100)) o40))
  (and (dynamic_invariant4 o41 true false true)
  (and (= (invariant__ o41) true)
  (and (= (to_rep1 (last (rt o41))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o40 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o41) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o40 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o41) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o40 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o41) k))))))))))))

;; H
  (assert
  (and (= o43 (remove o41 o42))
  (and (dynamic_invariant4 o43 true false true)
  (and (= (invariant__ o43) true)
  (and (= (to_rep1 (last (rt o43))) (- (to_rep1 (last (rt o41))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o42 1)))
  (= (to_rep (select (elts o41) k)) (to_rep (select (elts o43) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o42 1) k) (<= k (to_rep1 (last (rt o41)))))
  (= (to_rep (select (elts o41) k)) (to_rep (select (elts o43) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o42 k) (<= k (- (to_rep1 (last (rt o41))) 1)))
  (= (to_rep (select (elts o41) (+ k 1))) (to_rep (select (elts o43) k))))))))))))

;; H
  (assert (and (= o38 (- y 1)) (in_range5 (- y 1))))
