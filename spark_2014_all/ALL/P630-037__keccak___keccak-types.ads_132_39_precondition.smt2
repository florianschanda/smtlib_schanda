...
;; shift_left_2__post_axiom
  ...
  (! (=>
     ...
     true true true)) (<= amount 2)) (dynamic_invariant1
     (shift_left_2 value amount) true false true)) :pattern ((shift_left_2
                                                             value amount)) ))))
...
;; shift_left_2__def_axiom
  ...
  (! (=>
     ...
     (= (shift_left_2 value amount) (bvand (ite (< amount 8)
                                           ...
                                           ((_ int2bv 8) 0)) ((_ int2bv 8) 3)))) :pattern (
  (shift_left_2 value amount)) ))))
...
;; shift_right_2__post_axiom
  ...
  (! (=>
     ...
     (and (dynamic_invariant1 value true true true) (dynamic_invariant amount
     true true true)) (<= amount 2)) (dynamic_invariant1
     (shift_right_2 value amount) true false true)) :pattern ((shift_right_2
                                                              value amount)) ))))
