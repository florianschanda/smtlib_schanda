...
(declare-const p__identity1__result integer)

(declare-const p__identity1__result1 us_main_type)

(declare-const result integer)

(declare-const result1 us_main_type)

(declare-const p__identity1__result2 integer)

(declare-const p__identity1__result3 us_main_type)

(declare-const p__identity1__result4 integer)

(declare-const p__identity1__result5 us_main_type)

(declare-const p__identity1__result6 integer)

(declare-const p__identity1__result7 us_main_type)

(declare-const p__identity1__result8 integer)

(declare-const p__identity1__result9 us_main_type)

(declare-const p__identity1__result10 us_rep)
