...
(declare-fun bool_eq9 (us_rep5 us_rep5) Bool)
...
(define-fun range_equal ((left us_rep3) (right us_rep3) (fst Int)
  (lst Int)) Bool (ite (forall ((i Int))
                       (=> (and (<= fst i) (<= i lst))
                       (= (bool_eq3 (get left i) (get right i)) true)))
                  true false))
...
;; first__post_axiom
  ...
  (! (let ((result (first container)))
     (ite (= (length container) 0) (= (bool_eq5 result no_element) true)
...
;; mapping_preserved_except__post_axiom
  ...
  (! (=>
     ...
     (=> (not (= (bool_eq5 c position) true))
     (= (bool_eq3 (get e_left (get1 p_left c))
        (get e_right (get1 p_right c))) true)))))) :pattern ((mapping_preserved_except
                                                             e_left e_right
                                                             p_left p_right
                                                             position)) )))))
...
;; H
  ...
  (= (bool_eq5 temp___10901 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (ite (= (ite (= (bool_eq5 (mk___rep2 c__split_fields1) no_element) false) (= 
          (get1
          (positions
          (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
  ...
  (= (bool_eq5 temp___10911 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
...
;; H
  ...
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1104) true))
  (= (bool_eq5 temp___1104 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1104) true)
...
;; H
  ...
  (and
  (and
  (and (= (bool_eq5 (mk___rep2 c__split_fields5) no_element) true)
  (= (length
     (mk___rep1 l__split_discrs
...
;; H
  ...
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1106) true))
  (= (bool_eq5 temp___1106 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1106) true)
...
;; WP_parameter_def
 ;; File "my_ordered_sets.adb", line 4, characters 0-0
  (not (= (contains3 (mk___rep1 k__split_discrs k__split_fields4) 4) true)))
(check-sat)
