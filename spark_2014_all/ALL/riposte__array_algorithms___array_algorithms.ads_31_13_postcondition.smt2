...
(((mk_map__ref (map__content (Array Int value_type))))))
...
(((mk___t (elts (Array Int value_type))(rt t)))))
...
(((mk_generic_array__ref (generic_array__content us_t)))))
...
(((mk_t3b__ref (t3b__content tindex_typeB)))))
...
;; H
  ...
  (and
  (and
  (and (and (<= (to_rep1 (first (rt b))) i1) (<= i1 (to_rep1 (last (rt b)))))
  (= o i1)) (= o1 (select (elts b) o))) (= o2 (to_rep o1)))
  (= o3 (ite (= (to_rep (select (elts a) i1)) o2) true false)))
  (= result3 (ite (not (= o3 true)) true false)))
  (and (= result3 true)
  (and (and (= found1 result4) (= found2 (of_int 1)))
  (and (= location1 result5) (= location2 i1))))))
  (and
  (and
  (and
  (and
  ...
  (and (and (= i2 result6) (= i3 (+ i2 1)))
  (and
  (and
  (and
  (and
  (and
  (and (and (<= (to_rep1 (first (rt b))) i3) (<= i3 (to_rep1 (last (rt b)))))
  (= o4 i3)) (= o5 (select (elts b) o4))) (= o6 (to_rep o5)))
  (= o7 (ite (= (to_rep (select (elts a) i3)) o6) true false)))
  (= result7 (ite (not (= o7 true)) true false)))
  (and (= result7 true)
  (and (and (= found3 result8) (= found4 (of_int 1)))
  (and (= location3 result9) (= location4 i3))))))))))))))))
...
;; WP_parameter_def
 ;; File "array_algorithms.ads", line 20, characters 0-0
  (not (<= (to_rep1 (first (rt a))) (int__content location13))))
(check-sat)
(exit)
