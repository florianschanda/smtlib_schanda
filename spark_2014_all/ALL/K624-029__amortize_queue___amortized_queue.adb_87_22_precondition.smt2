...
(declare-const revrear__split_discrs us_split_discrs)
...
(declare-const revrear__split_fields us_main_type)

(declare-const amortized_queue__model__revrear__assume capacity_range)

(declare-const amortized_queue__model__revrear__assume1 us_main_type)

(declare-const result us_main_type)

(declare-const revrear__split_fields1 us_main_type)

(declare-const revrear__split_fields2 us_main_type)

(define-fun revrear__split_fields3 () us_split_fields (mk___split_fields
...
;; H
  ...
  (= (m_elements_reversed
     ...
     (model__ (mk___rep revrear__split_discrs revrear__split_fields3))) true))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 76, characters 0-0
  (not
  (<= (+ (length (mk___rep revrear__split_discrs revrear__split_fields3))
