...
;; H
  ...
  true true true)
  (forall ((temp___1243 Int))
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1243)
  (<= temp___1243 (to_rep1 (last number__split_fields3))))
  (=> (<= temp___1243 i2)
  (= (select number__split_fields2 temp___1243) (select number__split_fields temp___1243))))))
  (and (<= 1 i2) (<= i2 r124b))))
