...
;; H
  (assert
  (= (valid_configuration__2 cur_state cur_piece__split_fields4 cur_board) true))
...
;; H
  (assert
  (and
  (and (= (get_state cur_state2) 2)
  (= (valid_configuration__2 cur_state2 cur_piece__split_fields4 cur_board1) true))
  (in_range9 cur_state2)))

(assert
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  (not (= (get_state cur_state2) 2)))
(check-sat)
(exit)
