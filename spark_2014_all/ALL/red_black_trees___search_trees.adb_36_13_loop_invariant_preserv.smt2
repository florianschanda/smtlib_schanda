...
(declare-fun temp___6251 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___625 j4))) true)
  (= (oeq
...
;; H
  ...
  (and (dynamic_invariant5 temp___6251 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___6251 o9))) true)
  (and
  (= (length1
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___6251 o9)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o9))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___6251 (parent
                              (rec__search_trees__search_tree__struct
                              (us_split_fields7 t)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___6251 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___6251 i))) true))))))
  (and
  ...
  (= (length1
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___6251 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___6251 j4))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___6251 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___6251 j4)))) true))
  (= j4 i))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o10 o11)) (select temp___6251 
  j3)))
