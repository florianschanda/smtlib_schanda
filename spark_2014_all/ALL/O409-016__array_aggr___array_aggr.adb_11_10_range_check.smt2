...
(declare-fun user_eq3 (tTdSP2 tTdSP2) Bool)

(declare-const dummy3 tTdSP2)

(declare-datatypes ((tTdSP2__ref 0))
(((mk_tTdSP2__ref (tTdSP2__content tTdSP2)))))
...
(declare-fun user_eq5 (tTeSP2 tTeSP2) Bool)

(declare-const dummy5 tTeSP2)

(declare-datatypes ((tTeSP2__ref 0))
(((mk_tTeSP2__ref (tTeSP2__content tTeSP2)))))
