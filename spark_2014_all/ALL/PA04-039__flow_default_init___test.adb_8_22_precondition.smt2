...
(define-fun dynamic_invariant ((temp___expr_148 us_rep)
  (temp___is_init_145 Bool) (temp___skip_constant_146 Bool)
  (temp___do_toplevel_147 Bool)) Bool (let ((temp___149 (rec__bounded_strings__bounded_string__bound
                                                        (us_split_discrs1
                                                        temp___expr_148))))
                                      ...
                                      (first1
                                      (rec__bounded_strings__bounded_string__text
                                      (us_split_fields1 temp___expr_148)))
                                      (last1
                                      (rec__bounded_strings__bounded_string__text
                                      (us_split_fields1 temp___expr_148))))
                                      (and
                                      (= (first1
                                         (rec__bounded_strings__bounded_string__text
                                         (us_split_fields1 temp___expr_148))) 1)
                                      (= (last1
                                         (rec__bounded_strings__bounded_string__text
                                         (us_split_fields1 temp___expr_148))) 
                                      (to_rep temp___149))))))
...
(declare-fun dummy7 () tT2sP1)

(declare-datatypes ()
((tT2sP1__ref (mk_tT2sP1__ref (tT2sP1__content tT2sP1)))))
(define-fun tT2sP1__ref___projection ((a tT2sP1__ref)) tT2sP1 (tT2sP1__content
                                                              a))
...
(define-fun us_split_fields_Length2__projection ((a us_split_fields2)) length_type 
...
(declare-fun bounded_strings__bounded_string__length__first__bit1 () Int)

(declare-fun bounded_strings__bounded_string__length__last__bit1 () Int)

(declare-fun bounded_strings__bounded_string__length__position1 () Int)
...
(declare-datatypes ()
((us_split_fields4
 (mk___split_fields2 (rec__test__tlv_record__filestore_message us_rep1)))))
(define-fun us_split_fields_Filestore_Message__projection ((a us_split_fields4)) us_rep1 
...
(declare-fun test__tlv_record__filestore_message__first__bit () Int)

(declare-fun test__tlv_record__filestore_message__last__bit () Int)

(declare-fun test__tlv_record__filestore_message__position () Int)
...
(declare-datatypes ()
((tlv_record__ref (mk_tlv_record__ref (tlv_record__content us_rep2)))))
(define-fun tlv_record__ref___projection ((a tlv_record__ref)) us_rep2 
...
;; def_axiom
  ...
  (and (= (first3 temp___172) temp___174) (= (last3 temp___172) temp___175)))
  (forall ((temp___176 Int))
  (= (select (to_array1 temp___172) temp___176) (of_rep2 temp___173)))))))

(define-fun dynamic_invariant1 ((temp___expr_164 us_rep2)
  (temp___is_init_161 Bool) (temp___skip_constant_162 Bool)
  (temp___do_toplevel_163 Bool)) Bool (in_range5 60
  (to_base
  (rec__test__tlv_record__filestore_message
  (us_split_fields5 temp___expr_164)))))

(define-fun default_initial_assumption ((temp___expr_167 us_rep2)
  (temp___skip_top_level_168 Bool)) Bool (and
                                         ...
                                         (= (rec__bounded_strings__bounded_string__text1
                                            ...
                                            (rec__test__tlv_record__filestore_message
                                            (us_split_fields5
                                            temp___expr_167)))) (let ((temp___177 
                                                                (temp___171
                                                                32 1
                                                                (to_rep
                                                                (rec__bounded_strings__bounded_string__bound
...
;; length__post_axiom
  ...
  (! (=> (dynamic_invariant source true true true) (dynamic_invariant5
     (length1 source) true false true)) :pattern ((length1 source)) )))

;; length__def_axiom
  (assert
  (forall ((source us_rep))
  (! (=> (dynamic_invariant source true true true)
     (= (length1 source) (to_rep1
                         (rec__bounded_strings__bounded_string__length
                         (us_split_fields1 source))))) :pattern ((length1
                                                                 source)) )))

(declare-fun tlv_information__split_fields () index_type)

(declare-fun tlv_information__split_fields1 () (Array Int character))

(declare-fun tlv_information__split_fields2 () length_type)
...
;; WP_parameter_def
 ;; File "test.ads", line 9, characters 0-0
  (not
  (<= (+ (length1
         (mk___rep (mk___split_discrs tlv_information__split_fields)
         (mk___split_fields (mk___t tlv_information__split_fields1 (mk 1 60))
         tlv_information__split_fields2))) 1) (to_rep
