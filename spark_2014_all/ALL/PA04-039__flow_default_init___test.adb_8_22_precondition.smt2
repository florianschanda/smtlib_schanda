...
(((mk_tT2sP1__ref (tT2sP1__content tT2sP1)))))
...
(define-fun us_split_fields_Length__2__projection ((a us_split_fields2)) length_type
...
(declare-datatypes ((t1s__ref 0)) (((mk_t1s__ref (t1s__content us_rep1)))))
...
(((mk_tlv_record__ref (tlv_record__content us_rep2)))))
...
(declare-datatypes ((t6s__ref 0)) (((mk_t6s__ref (t6s__content integer)))))
...
(declare-datatypes ((t7s__ref 0)) (((mk_t7s__ref (t7s__content us_t1)))))
...
(((mk_string__ref (string__content us_t2)))))
