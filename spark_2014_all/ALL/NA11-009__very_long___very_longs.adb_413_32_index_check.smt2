...
(declare-fun temp___1216 () digit_index_type)

(declare-fun temp___12161 () (Array Int octet))

(declare-fun temp___12162 () t)
...
;; H
  (assert (= number__split_discrs (mk___split_discrs temp___1216)))

;; H
  (assert (= temp___12161 o15))

;; H
  (assert (= temp___12162 o16))
...
;; H
  ...
  (= number__split_fields4 (mk___split_fields
                           (mk___t temp___12161 temp___12162))))
