...
;; H
  ...
  (and (= o8 (length model____split_fields)) (in_range6 o8))))

;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o8) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o7 (get model____split_fields 1)) (in_range7 o7)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o7 first_available) true false)))))
...
;; H
  ...
  (and (= o9 (length model____split_fields)) (in_range6 o9))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= result2 (ite (= o9 0) true false))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (and (= o5 (length model____split_fields1)) (in_range6 o5)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o5) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o4 (get model____split_fields1 1)) (in_range7 o4))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o4 first_allocated) true false))))))
...
;; H
  ...
  (and (= o6 (length model____split_fields1)) (in_range6 o6)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (not (= first_allocated 0)))
  (= result1 (ite (= o6 0) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o2 (length model____split_fields)) (in_range6 o2))))
