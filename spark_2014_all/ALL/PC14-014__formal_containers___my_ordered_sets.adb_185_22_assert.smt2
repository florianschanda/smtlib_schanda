...
(declare-fun temp___1124 () count_type)

(declare-fun temp___1125 () count_type)
...
(declare-fun temp___1137 () us_rep2)
...
(declare-fun temp___1139 () us_rep2)
...
(define-fun temp___11251 () us_rep2 (mk___rep2
                                    (mk___split_fields2 temp___1125)))

(define-fun temp___11241 () us_rep2 (mk___rep2
                                    (mk___split_fields2 temp___1124)))
...
;; H
  ...
  (= (bool_eq5 temp___11241 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= (bool_eq5 temp___11251 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o57) true))
  (= (bool_eq3
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o57)) o57) true))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields)) o57) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (elements
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o57)
     (length
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o56) true))
  (= (bool_eq3
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o56)) o56) true))
  ...
  (= (included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o56) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields1)) o56) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o56)
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o55) true)
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs
  ...
  (= (equivalent_elements
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)
     (mk___rep2 c__split_fields3)) o55) true))
  (= (e_is_find
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o55
     (get1
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields))
  ...
  (= (included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields2)) o55) true))
...
;; H
  (assert
  (and
  (= temp___1137 (find1 (mk___rep1 l__split_discrs l__split_fields9) o42))
  (ite (ite (= (contains
  ...
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1137) true))
  (= (bool_eq5 temp___1137 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1137) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1137) (find
                  ...
                  o42)))
  (= (equivalent_elements
     (element (mk___rep1 l__split_discrs l__split_fields9) temp___1137) 
     o42) true)))))
...
;; H
  (assert
  (and
  (= temp___1139 (find1 (mk___rep1 l__split_discrs l__split_fields10) o46))
  (ite (ite (= (contains
  ...
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1139) true))
  (= (bool_eq5 temp___1139 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1139) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1139) (find
                  ...
                  o46)))
  (= (equivalent_elements
     (element (mk___rep1 l__split_discrs l__split_fields10) temp___1139) 
     o46) true)))))
...
;; H
  (assert (= c__split_fields6 (us_split_fields5 temp___1139)))
