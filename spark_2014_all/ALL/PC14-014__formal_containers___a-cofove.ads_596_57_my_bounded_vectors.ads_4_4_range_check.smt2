...
(define-fun dynamic_invariant1 ((temp___expr_694 Int)
  (temp___is_init_691 Bool) (temp___skip_constant_692 Bool)
  (temp___do_toplevel_693 Bool)) Bool (=>
                                      (or (= temp___is_init_691 true)
...
(define-fun dynamic_invariant3 ((temp___expr_682 Int)
  (temp___is_init_679 Bool) (temp___skip_constant_680 Bool)
  (temp___do_toplevel_681 Bool)) Bool (=>
...
(define-fun default_initial_assumption ((temp___expr_734 us_rep1)
  (temp___skip_top_level_735 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_735 true))
                                         (= (length1 temp___expr_734) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_727 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_721 Int)
