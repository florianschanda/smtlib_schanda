...
(declare-fun temp___759 () Int)

(declare-fun temp___757 () (Array Int (Array Int cell)))

(declare-fun temp___756 () Bool)
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___759 to_line1)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___757 cur_board)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (= temp___756 has_complete_lines1)))
...
;; H
  ...
  (=> (and (<= 1 temp___758) (<= temp___758 50))
  (=> (<= del_line2 temp___758)
  (= (select cur_board2 temp___758) (select temp___757 temp___758)))))
  (=> (<= 1 50) (in_range3 to_line2)))
...
(assert
;; WP_parameter_def
 ;; File "tetris_flow.adb", line 37, characters 0-0
  (not (in_range3 (- to_line8 1))))
(check-sat)
(exit)
