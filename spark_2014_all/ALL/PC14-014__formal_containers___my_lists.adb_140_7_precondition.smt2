...
(declare-fun my_lists__s__sort__container__fields () us_split_fields)
...
(declare-fun my_lists__s__merge__source__fields () us_split_fields)

(declare-fun my_lists__s__merge__target__fields () us_split_fields)
...
(declare-fun my_lists__s__sort__container__fields1 () us_split_fields)
...
;; H
  ...
  (= (m_elements_sorted
     (model__
     (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true))
  (= (m_elements_included
     (model__ (mk___rep l__split_discrs l__split_fields1)) 1
     (length (mk___rep l__split_discrs my_lists__s__sort__container__fields))
     (model__
     (mk___rep l__split_discrs my_lists__s__sort__container__fields)) 1
     (length (mk___rep l__split_discrs my_lists__s__sort__container__fields))) true))
  (= (m_elements_included
     (model__
     (mk___rep l__split_discrs my_lists__s__sort__container__fields)) 1
     (length (mk___rep l__split_discrs my_lists__s__sort__container__fields))
...
;; H
  (assert
  (= l__split_fields3 my_lists__m__delete_last__2__container__fields))
...
;; H
  ...
  (= (p_positions_shifted
     ...
     (mk___rep k__split_discrs
     my_lists__m__delete_first__2__container__fields))
     (positions (mk___rep k__split_discrs k__split_fields2)) 1 5) true))))
...
;; H
  (assert
  (= k__split_fields3 my_lists__m__delete_first__2__container__fields))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep l__split_discrs my_lists__s__merge__target__fields)) (+ 
  (length (mk___rep l__split_discrs l__split_fields3)) (length
                                                       (mk___rep
                                                       k__split_discrs
                                                       k__split_fields3))))
  (= (length (mk___rep k__split_discrs my_lists__s__merge__source__fields)) 0))
  (=>
  (and
  (= (m_elements_sorted
  ...
  (= (m_elements_sorted
     (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields))) true)))
  (= (m_elements_included
     (model__ (mk___rep l__split_discrs l__split_fields3)) 1
     (length (mk___rep l__split_discrs l__split_fields3))
     (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields))
     1
     (length (mk___rep l__split_discrs my_lists__s__merge__target__fields))) true))
  (= (m_elements_included
     (model__ (mk___rep k__split_discrs k__split_fields3)) 1
     (length (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields))
     1
     (length (mk___rep l__split_discrs my_lists__s__merge__target__fields))) true))
  (= (m_elements_in_union
...
;; H
  (assert (= l__split_fields4 my_lists__s__merge__target__fields))

;; H
  (assert (= result5 (mk___split_fields__ref k__split_fields3)))

;; H
  (assert (= k__split_fields4 my_lists__s__merge__source__fields))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) 
  (length (mk___rep l__split_discrs l__split_fields4)))
  (= (m_elements_sorted
     (model__
     (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true))
  (= (m_elements_included
     (model__ (mk___rep l__split_discrs l__split_fields4)) 1
     (length
     (mk___rep l__split_discrs my_lists__s__sort__container__fields1))
     (model__
     (mk___rep l__split_discrs my_lists__s__sort__container__fields1)) 1
     (length
     (mk___rep l__split_discrs my_lists__s__sort__container__fields1))) true))
  (= (m_elements_included
     (model__
...
;; H
  (assert (= l__split_fields5 my_lists__s__sort__container__fields1))
...
;; H
  (assert (= result7 (mk___split_fields__ref k__split_fields4)))

;; H
  (assert (= k__split_fields5 my_lists__m__assign__target__fields1))
...
;; H
  (assert
  (= l__split_fields6 my_lists__m__delete_last__2__container__fields1))
...
;; H
  ...
  (= (range_shifted
     ...
     (length
     (mk___rep k__split_discrs
     my_lists__m__delete_first__2__container__fields1)) 5) true))
  (= (p_positions_shifted
     (positions
     (mk___rep k__split_discrs
     my_lists__m__delete_first__2__container__fields1))
     (positions (mk___rep k__split_discrs k__split_fields5)) 1 5) true))))

;; H
  (assert (= result9 (mk___split_fields__ref k__split_fields5)))

;; H
  (assert
  (= k__split_fields6 my_lists__m__delete_first__2__container__fields1))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not
  (<= (length (mk___rep k__split_discrs k__split_fields6)) (- (to_rep
                                                              (rec__my_lists__m__list__capacity
                                                              l__split_discrs)) 
