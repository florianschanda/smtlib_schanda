...
(declare-fun dummy () uml_transition_access)
...
(declare-fun dummy1 () uml_state_access)
...
(declare-datatypes ()
((uml_state__ref (mk_uml_state__ref (uml_state__content us_rep1)))))
...
(declare-fun dummy5 () (Array Int us_rep1))
...
(declare-fun self__split_fields () (Array Int us_rep1))

(declare-fun self__split_fields1 () (Array Int us_rep))

(declare-fun result () (Array Int us_rep1))

(declare-fun result1 () (Array Int us_rep))

(declare-fun self__split_fields2 () (Array Int us_rep1))

(declare-fun self__split_fields3 () (Array Int us_rep))

(declare-fun self__split_fields4 () (Array Int us_rep1))

(declare-fun self__split_fields5 () (Array Int us_rep))

(declare-fun self__split_fields6 () (Array Int us_rep1))

(declare-fun self__split_fields7 () (Array Int us_rep))
