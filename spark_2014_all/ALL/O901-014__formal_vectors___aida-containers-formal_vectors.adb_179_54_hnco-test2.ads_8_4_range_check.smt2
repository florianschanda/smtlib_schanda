...
(declare-fun dummy9 () extended_index2)
...
;; get__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant6 position1 true true true)
     (and (<= 1 position1) (<= position1 (last container1))))
     (dynamic_invariant7 (get container1 position1) true false true)) :pattern (
