...
(define-fun us_split_fields__ref___64__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___64__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-datatypes ((fs_pllcfg_type__ref 0))
...
(define-fun register_type__ref___150__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___106__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___106__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5645 us_t1)
  (temp___is_init_5642 Bool) (temp___skip_constant_5643 Bool)
  (temp___do_toplevel_5644 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5643 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_5645)
                                       (last3 temp___expr_5645))
                                       (and (= (first3 temp___expr_5645) 1)
                                       (= (last3 temp___expr_5645) 4)))))
