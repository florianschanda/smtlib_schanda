...
;; H
  (assert
  (= (to_rep1
     (first2 (rt1 (temp___284 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__first)))

;; H
  (assert
  (= (to_rep1
     (last2 (rt1 (temp___284 32 (to_rep1 a__first) (to_rep1 a__last))))) 
  (to_rep1 a__last)))

;; H
  (assert
  (= (mk___t1 temp___291 temp___2911) (temp___284 32 (to_rep1 a__first)
                                      (to_rep1 a__last))))
...
(assert
;; WP_parameter_def
 ;; File "foo.adb", line 84, characters 0-0
  (not
