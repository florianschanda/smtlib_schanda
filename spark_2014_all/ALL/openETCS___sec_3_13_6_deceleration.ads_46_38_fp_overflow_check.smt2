...
(define-fun dynamic_invariant3 ((temp___expr_169 t) (temp___is_init_166 Bool)
  (temp___skip_constant_167 Bool)
  (temp___do_toplevel_168 Bool)) Bool (=>
                                      (or (= temp___is_init_166 true) (le
                                      fliteral2 fliteral1)) (in_range1
                                      temp___expr_169)))
...
;; kdry_rst_model__def_axiom
  ...
  (= kdry_rst_model (mk___rep1
                    ...
                    (temp___138
                    (mk___rep
                    (mk___split_fields (of_rep2 0) (of_rep1 fliteral)))
                    (mk___rep
                    (mk___split_fields (of_rep2 0) (of_rep1 fliteral2))))))))
...
;; H
  ...
  (and (in_range1 o6) (eq o6
  (get_value a_brake_emergency_model (to_int1 RNA1 v))))))

;; H
  (assert
  (and (= o (kwet_rst v))
  (and (tqtisFinite o) (eq o (get_value kwet_rst_model (to_int1 RNA1 v))))))
...
;; H
  (assert (= o3 (mul RNE1 fliteral2 o2)))

;; H
  (assert
  (and (= o4 (kwet_rst v))
  (and (tqtisFinite o4) (eq o4 (get_value kwet_rst_model (to_int1 RNA1 v))))))
