...
;; H
  ...
  (and
  (and
  (= (is_perm (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
     (mk___t a3 (mk (to_rep a__first) (to_rep a__last)))) true)
  (and (= (to_rep (select a3 o22)) (to_rep (select a2 o23)))
  (and (= (to_rep (select a3 o23)) (to_rep (select a2 o22)))
  (forall ((z3 Int))
  (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last)))
  (=> (and (not (= z3 o22)) (not (= z3 o23)))
  (= (to_rep (select a3 z3)) (to_rep (select a2 z3)))))))))
  (= (to_rep a__first) 0)))
