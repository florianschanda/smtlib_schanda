...
(declare-fun temp___421 () (Array Int character))
...
;; H
  ...
  (and (<= (to_rep1 a__first) 3) (<= 3 (to_rep1 a__last))))))

;; H
  (assert (= temp___421 a))

;; H
  (assert (= test__op_string_io_i__x__compl temp___421))
