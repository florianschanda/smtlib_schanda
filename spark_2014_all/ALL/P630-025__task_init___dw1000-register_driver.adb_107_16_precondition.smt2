...
(define-fun dynamic_invariant7 ((temp___expr_691 us_rep1)
...
(define-fun dynamic_invariant8 ((temp___expr_711 us_rep2)
...
(define-fun dw1000__register_driver__write_register__B_4__header__assume3 () us_rep
  (mk___rep
  (mk___split_fields
  dw1000__register_driver__write_register__B_4__header__assume
  dw1000__register_driver__write_register__B_4__header__assume1
  dw1000__register_driver__write_register__B_4__header__assume2)))
...
;; H
  (assert (= sub_address ((_ int2bv 16) 0)))
...
;; H
  (assert (= temp___759 o3))

;; H
  (assert (= temp___7591 o4))

;; H
  (assert (= temp___7592 o5))

;; H
  (assert (= (to_rep5 temp___7591) 0))

;; H
  (assert
  (= dw1000__register_driver__write_register__B_4__header__assume3 (mk___rep
                                                                   (mk___split_fields
                                                                   temp___759
                                                                   temp___7591
                                                                   temp___7592))))
...
;; H
  (assert
  (= dw1000__register_driver__write_register__B_4__header__assume3 header))

;; H
  (assert
  (= (to_rep5
     (rec__dw1000__register_driver__non_indexed_header__sub_index
     (us_split_fields1 header))) 0))
