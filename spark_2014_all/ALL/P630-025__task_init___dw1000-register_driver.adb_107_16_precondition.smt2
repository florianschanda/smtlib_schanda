...
(declare-fun o () operation_type)

(declare-fun o1 () sub_index_type)

(declare-fun o2 () bits_6)

(declare-fun o3 () bits_6)

(declare-fun o4 () sub_index_type)

(declare-fun o5 () operation_type)

(declare-fun temp___753 () bits_6)

(declare-fun temp___7531 () sub_index_type)

(declare-fun temp___7532 () operation_type)

(declare-fun dw1000__register_driver__write_register__B_4__header__assume () bits_6)

(declare-fun dw1000__register_driver__write_register__B_4__header__assume1 () sub_index_type)

(declare-fun dw1000__register_driver__write_register__B_4__header__assume2 () operation_type)
...
(declare-fun o9 () (Array Int bits_8))

(declare-fun o10 () (Array Int bits_8))
...
;; H
  (assert (= temp___753 o3))

;; H
  (assert (= temp___7531 o4))

;; H
  (assert (= temp___7532 o5))

;; H
  (assert (= (to_rep5 temp___7531) 0))
