...
(declare-const temp___1333 (Array Int character))

(declare-const temp___13331 t)
...
;; H
  (assert
  (= (concat1 (temp___String_Literal_1076 Tuple0) 1 6 firsttime 1 21)
  temp___1333))

;; H
  (assert (= (mk 1 o5) temp___13331))

;; H
  (assert (not (= (length (mk___t temp___1333 temp___13331)) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___13331)) (to_rep1 (last temp___13331)))
  (= o7 (+ (- (to_rep1 (last temp___13331)) (to_rep1 (first temp___13331))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___13331)) (to_rep1 (last temp___13331))))
  (= o7 0)))
...
;; H
  (assert (= o9 (+ (to_rep1 (first temp___13331)) o8)))
