...
(((mk___split_discrs (rec__foo__dt__found Bool)))))
...
(((mk___split_fields (rec__foo__dt__index positive)))))
...
(declare-datatypes ((dt__ref 0)) (((mk_dt__ref (dt__content us_rep)))))
...
(declare-const temp___278 Bool)

(declare-const temp___2781 positive)
