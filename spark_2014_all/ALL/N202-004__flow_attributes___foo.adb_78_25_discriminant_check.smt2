...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__foo__dt__found Bool)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) Bool (rec__foo__dt__found
                                                                    a))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__foo__dt__index positive)))))
(define-fun us_split_fields_Index__projection ((a us_split_fields)) positive
...
(define-fun foo__dt__index__pred ((a us_rep)) Bool (= (to_int1
                                                      (rec__foo__dt__found
                                                      (us_split_discrs1 a))) 1))

(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (rec__foo__dt__found (us_split_discrs1 a))
                        (rec__foo__dt__found (us_split_discrs1 b)))
...
(declare-fun foo__dt__found__first__bit () Int)

(declare-fun foo__dt__found__last__bit () Int)

(declare-fun foo__dt__found__position () Int)
...
(declare-fun foo__dt__index__first__bit () Int)

(declare-fun foo__dt__index__last__bit () Int)

(declare-fun foo__dt__index__position () Int)
...
(declare-fun foo__dt__found__first__bit1 () Int)

(declare-fun foo__dt__found__last__bit1 () Int)

(declare-fun foo__dt__found__position1 () Int)
...
(declare-fun foo__dt__index__first__bit1 () Int)

(declare-fun foo__dt__index__last__bit1 () Int)

(declare-fun foo__dt__index__position1 () Int)
...
(declare-fun foo__dt__found__first__bit2 () Int)

(declare-fun foo__dt__found__last__bit2 () Int)

(declare-fun foo__dt__found__position2 () Int)
...
(declare-fun foo__dt__index__first__bit2 () Int)

(declare-fun foo__dt__index__last__bit2 () Int)

(declare-fun foo__dt__index__position2 () Int)
...
(declare-fun temp___278 () Bool)

(declare-fun temp___2781 () positive)

;; H
  (assert (= (to_int1 (rec__foo__dt__found a__split_discrs)) 1))
...
;; H
  (assert (= (of_int 1) temp___278))

;; H
  (assert (= temp___2781 o1))

(assert
;; WP_parameter_def
 ;; File "foo.adb", line 66, characters 0-0
  (not (= temp___278 (rec__foo__dt__found a__split_discrs))))
(check-sat)
(exit)
