...
(define-fun us_split_fields___3__projection ((a us_split_fields)) us_private
  (rec__ext__ a))
...
(((mk_person__ref (person__content us_rep1)))))
...
(((mk_professions__ref (professions__content professions)))))
...
(((mk_skills__ref (skills__content skills)))))
...
(((mk_map__ref1 (map__content1 (Array Int skills))))))
...
(define-fun us_rep___15__projection ((a us_rep2)) us_split_fields2 (us_split_fields3
                                                                   a))
...
(((mk_professional__ref (professional__content us_rep2)))))
...
(declare-const temp___1131 professions)

(declare-const temp___11311 (Array Int skills))

(declare-const temp___11312 natural)

(declare-const temp___11313 us_rep)

(declare-const temp___11314 integer)

(declare-const temp___11315 Bool)

(declare-const temp___11316 us_private)

(declare-const temp___11317 Int)
