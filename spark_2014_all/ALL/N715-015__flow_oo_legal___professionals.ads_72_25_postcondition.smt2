...
;; temp___String_Literal_928__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 1)) 78)
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 2)) 97))
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 3)) 109))
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 4)) 101))
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 5)) 108))
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 6)) 101))
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 7)) 115))
     (= (to_rep2 (select (temp___String_Literal_928 us_void_param) 8)) 115)) :pattern (
...
(declare-fun killer__attr__tag () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun victim__attr__tag () Int)
...
(declare-fun killer__split_fields1 () (Array Int skills))

(declare-fun killer__split_fields2 () natural)

(declare-fun killer__split_fields3 () us_rep)

(declare-fun killer__split_fields4 () integer)

(declare-fun killer__split_fields5 () Bool)

(declare-fun killer__split_fields6 () us_private)

(declare-fun victim__split_fields () us_rep)

(declare-fun victim__split_fields1 () integer)
...
(declare-fun o2 () professions)

(declare-fun o3 () (Array Int skills))
...
(declare-fun temp___1131 () professions)

(declare-fun temp___11311 () (Array Int skills))

(declare-fun temp___11312 () natural)

(declare-fun temp___11313 () us_rep)

(declare-fun temp___11314 () integer)

(declare-fun temp___11315 () Bool)

(declare-fun temp___11316 () us_private)

(declare-fun temp___11317 () Int)

(declare-fun result () professions)

(declare-fun result1 () (Array Int skills))
...
(declare-fun killer__split_fields7 () professions)

(declare-fun killer__split_fields8 () (Array Int skills))

(declare-fun killer__split_fields9 () natural)

(declare-fun killer__split_fields10 () us_rep)

(declare-fun killer__split_fields11 () integer)

(declare-fun killer__split_fields12 () Bool)

(declare-fun killer__split_fields13 () us_private)

(declare-fun victim__split_fields4 () us_rep)

(declare-fun victim__split_fields5 () integer)

(declare-fun victim__split_fields6 () Bool)

(declare-fun victim__split_fields7 () us_private)

(declare-fun killer__split_fields14 () professions)

(declare-fun killer__split_fields15 () (Array Int skills))

(declare-fun killer__split_fields16 () natural)

(declare-fun killer__split_fields17 () us_rep)

(declare-fun killer__split_fields18 () integer)

(declare-fun killer__split_fields19 () Bool)

(declare-fun killer__split_fields20 () us_private)

(declare-fun victim__split_fields8 () us_rep)

(declare-fun victim__split_fields9 () integer)

(declare-fun victim__split_fields10 () Bool)

(declare-fun victim__split_fields11 () us_private)

(declare-fun killer__split_fields21 () professions)

(declare-fun killer__split_fields22 () (Array Int skills))

(declare-fun killer__split_fields23 () natural)

(declare-fun killer__split_fields24 () us_rep)

(declare-fun killer__split_fields25 () integer)

(declare-fun killer__split_fields26 () Bool)

(declare-fun killer__split_fields27 () us_private)

(declare-fun victim__split_fields12 () us_rep)

(declare-fun victim__split_fields13 () integer)

(declare-fun victim__split_fields14 () Bool)

(declare-fun victim__split_fields15 () us_private)
...
;; H
  ...
  (= (is_alive
     ...
     killer__split_fields2 killer__split_fields6)) killer__attr__tag)) true)
  (= (is_alive1 victim__attr__tag
     (mk___rep
     (mk___split_fields victim__split_fields victim__split_fields1
     victim__split_fields2 victim__split_fields3) victim__attr__tag)) true))
  (= (has_licence_to_kill
     (mk___rep1
     ...
     killer__split_fields5 killer__split_fields6) killer__attr__tag)) true)))

;; H
  (assert
  (and (= o (+ (to_rep killer__split_fields2) 1)) (in_range
  (+ (to_rep killer__split_fields2) 1))))
...
;; H
  (assert (= temp___1131 o2))

;; H
  (assert (= temp___11311 o3))

;; H
  (assert (= temp___11312 o4))

;; H
  (assert (= temp___11313 o5))

;; H
  (assert (= temp___11314 o6))

;; H
  (assert (= temp___11315 o7))

;; H
  (assert (= temp___11316 o8))

;; H
  (assert (= killer__attr__tag temp___11317))
...
;; H
  (assert (= temp___1131 killer__split_fields7))

;; H
  (assert (= temp___11311 killer__split_fields8))

;; H
  (assert (= temp___11312 killer__split_fields9))

;; H
  (assert (= temp___11313 killer__split_fields10))

;; H
  (assert (= temp___11314 killer__split_fields11))

;; H
  (assert (= temp___11315 killer__split_fields12))

;; H
  (assert (= temp___11316 killer__split_fields13))

;; H
  (assert (rip__specific_post victim__attr__tag
  (mk___split_fields victim__split_fields4 victim__split_fields5
  victim__split_fields6 victim__split_fields7) victim__attr__tag
  (mk___split_fields victim__split_fields victim__split_fields1
  victim__split_fields2 victim__split_fields3)))
...
(assert
;; WP_parameter_def
 ;; File "professionals.ads", line 65, characters 0-0
  (not
  (= (is_alive
     (mk___rep
     (mk___split_fields killer__split_fields17 killer__split_fields18
     killer__split_fields19
     (hide_ext__ killer__split_fields14 killer__split_fields15
     killer__split_fields16 killer__split_fields20)) killer__attr__tag)) true)))
(check-sat)
(exit)
