...
(declare-fun o4 () (Array Int (Array Int (Array Int et1))))
...
(declare-fun result2 () (Array Int (Array Int (Array Int et1))))
...
;; H
  ...
  (= (bool_eq2 a 1 16
     (temp___5423 t k
     (temp___5429 (select t k) j (temp___5435 (select (select t k) j) i e)))
     1 16) true)
...
;; WP_parameter_def
 ;; File "ar.ads", line 481, characters 0-0
  (not (in_range4 (to_rep (select (select (select a2 m) n) o5)))))
(check-sat)
(exit)
