...
(declare-fun perm__occ_def__result () Int)
...
(declare-fun perm__occ_def__result1 () Int)

(declare-fun perm__occ_def__result2 () Int)

(declare-fun perm__occ_def__result3 () Int)

(declare-fun perm__occ_def__result4 () Int)

(declare-fun perm__occ_def__result5 () Int)
...
;; H
  ...
  (=> (not (= (length a) 0))
  (=> (= result true)
  (and (= o5 (occ_def o11 e))
  (and (in_range3 o5)
  (and
  (= o5 (ite (= (length o11) 0) 0
        (ite (= (to_rep (select o3 (to_rep1 (last o4)))) e)
        (+ (occ_def (remove_last o11) e) 1) (occ_def (remove_last o11) e))))
  (<= o5 (length o11))))))))
...
;; H
  (assert
  (=> (not (= (length a) 0))
  (=> (= result true) (and (= o9 o6) (in_range3 o6)))))

;; H
  (assert
  (=> (not (= (length a) 0))
  (=> (not (= result true))
  (and (= o10 (remove_last a))
...
;; H
  ...
  (=> (not (= (length a) 0))
  (=> (not (= result true))
  (and (= o9 (occ_def o10 e))
  (and (in_range3 o9)
  (and
  (= o9 (ite (= (length o10) 0) 0
        (ite (= (to_rep (select o7 (to_rep1 (last o8)))) e)
        (+ (occ_def (remove_last o10) e) 1) (occ_def (remove_last o10) e))))
  (<= o9 (length o10))))))))
...
;; H
  (assert
  (= (mk_int__ref perm__occ_def__result4) (mk_int__ref
                                          perm__occ_def__result2)))
