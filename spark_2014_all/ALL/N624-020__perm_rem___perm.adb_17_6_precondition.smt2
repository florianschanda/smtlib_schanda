...
;; H
  ...
  (and (= o32 (remove b o2))
  (and (dynamic_invariant1 o32 true false true)
  ...
  (and
  (and (= o33 (remove a ia))
  (and (dynamic_invariant1 o33 true false true)
  ...
  (and (= result1 (is_perm o33 o32))
  (= (= result1 true)
  (or (and (= (length o33) 0) (= (length o32) 0))
  (exists ((ia1 Int))
  ...
  (= (is_perm (remove o33 ia1) (remove o32 ib10)) true)))))))))))
  (= result1 false)))
  (and (= result1 true)
  ...
  (and (= o30 (remove b o11))
  (and (dynamic_invariant1 o30 true false true)
  ...
  (and
  (and (= o31 (remove a ia))
  (and (dynamic_invariant1 o31 true false true)
  ...
  (and (= result5 (is_perm o31 o30))
  (= (= result5 true)
  (or (and (= (length o31) 0) (= (length o30) 0))
  (exists ((ia1 Int))
  ...
  (= (is_perm (remove o31 ia1) (remove o30 ib10)) true)))))))))))
  (= result5 false)))
  (and (= result5 true)
...
;; H
  (assert
  (and (= o28 (remove b (int__content perm__get_witness__result9)))
  (and (dynamic_invariant1 o28 true false true)
  (and (= (invariant__ o28) true)
  (and (= (to_rep1 (last o21)) (- (to_rep1 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- (int__content perm__get_witness__result9) 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o20 k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (int__content perm__get_witness__result9) 1) k)
  (<= k (to_rep1 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o20 (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (int__content perm__get_witness__result9) k)
...
;; H
  (assert
  (and (= o29 (remove a ia))
  (and (dynamic_invariant1 o29 true false true)
  (and (= (invariant__ o29) true)
  (and (= (to_rep1 (last o19)) (- (to_rep1 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ia 1)))
