...
(declare-const dummy5 less_than_max)
...
(((mk_model____ref (model____content us_t1)))))
...
;; last__post_axiom
  (assert
  (forall ((s1 us_rep1)) (! (dynamic_invariant (last4 s1) true false
  true) :pattern ((last4 s1)) )))

;; last__post__dispatch_axiom
  (assert
  (forall ((attr__tag2 Int))
  (forall ((s1 us_rep1)) (! (dynamic_invariant (last5 attr__tag2 s1) true
  false true) :pattern ((last5 attr__tag2 s1)) ))))
...
(declare-datatypes ((t83s__ref 0)) (((mk_t83s__ref (t83s__content us_t2)))))
...
(declare-datatypes ((t86s__ref 0)) (((mk_t86s__ref (t86s__content us_t3)))))
...
(declare-datatypes ((t89s__ref 0)) (((mk_t89s__ref (t89s__content us_t4)))))
...
(define-fun dynamic_invariant4 ((temp___expr_168 us_t1)
...
(declare-const stackp__get_model__3__R84s Int)

(declare-const result Bool)

;; H
  (assert
  (and (= result (wraps_around s))
  (= (= result true)
...
;; H
  (assert
  (and (= stackp__get_model__3__R84s (last4 s))
  (and (in_range4 stackp__get_model__3__R84s)
  (= stackp__get_model__3__R84s (ite (not (= (wraps_around s) true))
                                (- (+ (to_rep3
                                      (rec__stackp__buffer__first
...
;; H
  (assert (<= 1 stackp__get_model__3__R84s))
