...
;; def_axiom
  (assert
  (forall ((temp___626 Int) (temp___627 Int))
  (let ((temp___625 (temp___624 temp___626 temp___627)))
  (forall ((temp___628 Int))
  (ite (and (<= 2 temp___628) (<= temp___628 5))
  (= (select temp___625 temp___628) (of_rep temp___626))
  (= (select temp___625 temp___628) (of_rep temp___627)))))))
