...
;; H
  (assert (=> (= result47 true) (= o21 (add RNE1 approx2 o20))))

;; H
  (assert (=> (= result47 true) (and (= o22 o21) (tqtisFinite o21))))

;; H
  (assert (=> (= result47 true) (= o23 (mul RNE1 fliteral7 o22))))
...
;; H
  (assert
  (=> (= result47 true)
  (and (= o24 (mul RNE1 approx3 approx3)) (tqtisFinite
  (mul RNE1 approx3 approx3)))))

;; H
  (assert (=> (= result47 true) (= o25 (sub RNE1 x1 o24))))
