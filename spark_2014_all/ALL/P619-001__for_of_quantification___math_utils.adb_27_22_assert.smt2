...
(declare-datatypes ((t2b__ref 0)) (((mk_t2b__ref (t2b__content tindexB)))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v)))))
  (= (mk_int__ref result__6) (mk_int__ref result__4))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (exists ((temp___166 Int))
  (and
  (and (<= (to_rep1 (first (rt v))) temp___166)
  (<= temp___166 (to_rep1 (last (rt v)))))
  (= result__6 (to_rep (select (elts v) temp___166)))))))
(check-sat)
(exit)
