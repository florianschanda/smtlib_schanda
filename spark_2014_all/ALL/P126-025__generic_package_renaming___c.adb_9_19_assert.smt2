...
;; id__post_axiom
  (assert
  (forall ((e Int))
  (! (=> (dynamic_invariant1 e true true true) (dynamic_invariant1 (id e)
     true false true)) :pattern ((id e)) )))

;; id__def_axiom
  (assert
  (forall ((e Int))
  (! (=> (dynamic_invariant1 e true true true) (= (id e) e)) :pattern (
  (id e)) )))
...
(assert
;; WP_parameter_def
 ;; File "s.ads", line 6, characters 0-0
  (not (= x1 0)))
(check-sat)
(exit)
