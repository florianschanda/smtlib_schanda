...
;; H
  ...
  (and
  (forall ((idx1 Int))
  (=> (and (<= (+ last6 1) idx1) (<= idx1 last7))
  (= (to_rep (select item3 idx1)) (to_rep
                                  (select the_file (+ (- (- idx1 last6) 1)
                                  cur_position2))))))
  ...
  (= (to_rep (select item3 (+ last6 idx1))) (to_rep
  ...
  (<= idx1 (- (find_char_in_slice 10 cur_position2 (- (+ cur_position2 80) 2)
              the_file) 1)))
  (= (to_rep (select item3 (+ (- (+ last6 idx1) cur_position2) 1))) (to_rep
                                                                    (select
                                                                    the_file idx1))))))
  ...
  (and
  (forall ((idx1 Int))
  (=> (and (<= (to_rep1 item__first) idx1) (<= idx1 (int__content last10)))
  ...
  (and
  (forall ((idx1 Int))
  (=> (and (<= (+ (int__content last10) 1) idx1) (<= idx1 last12))
  ...
  (= (to_rep (select item8 (+ (int__content last10) idx1))) (to_rep
                                                            (select the_file (- (+
                                                            (int__content
  ...
  (= (to_rep
     (select item8 (+ (- (+ (int__content last10) idx1) (int__content
                                                        cur_position6)) 1)))
...
;; H
  ...
  (<= (to_rep1 item__first) (int__content last28))))
