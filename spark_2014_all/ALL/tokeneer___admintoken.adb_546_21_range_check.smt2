...
(declare-const dummy adminprivileget)
...
;; therole__post_axiom
  (assert
  (forall ((contents us_rep4)) (! (dynamic_invariant (therole contents) true
...
;; theauthcertrole__post_axiom
  ...
  (! (dynamic_invariant (theauthcertrole admintoken__authcert__fields) true
