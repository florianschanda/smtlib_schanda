...
;; H
  (assert
  (= a1 (store a 23 (mk___rep
                    (mk___split_fields (of_int 1)
                    (rec__arrays_of_records__basic_record__first_value
                    (us_split_fields1 (select a 23)))
                    (rec__arrays_of_records__basic_record__second_value
                    (us_split_fields1 (select a 23))))))))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a2 23))) o9))

;; H
  (assert
  (= (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a2 23))) o10))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a3 5))) o17))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a3 5))) o19))
...
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 202, characters 0-0
  (not (not (= (bool_eq1 a5 0 1001 a 0 1001) true))))
(check-sat)
(exit)
