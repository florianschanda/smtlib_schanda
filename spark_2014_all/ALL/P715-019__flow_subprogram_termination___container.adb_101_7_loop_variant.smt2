...
(declare-fun result38 () cursor__ref)

(declare-fun temp___5932 () us_rep1)
...
(define-fun e29 () int__ref (mk_int__ref e2))

(define-fun e30 () int__ref (mk_int__ref e1))

(define-fun e31 () int__ref (mk_int__ref e))
...
;; H
  (assert
  (and (= o25 (first (mk___rep my_container__split_fields1)))
  (= (of_rep 1) o7)))
...
;; H
  (assert (=> (= result15 true) (= result16 e31)))
...
;; H
  (assert (=> (not (= result15 true)) (= e7 e31)))
...
;; H
  (assert (=> (= result20 true) (= result21 e30)))
...
;; H
  (assert (=> (not (= result20 true)) (= e15 e30)))
...
;; H
  (assert (=> (= result27 true) (= result28 e29)))
...
;; H
  (assert (=> (not (= result27 true)) (= e23 e29)))
...
;; H
  (assert
  (and
  (= o20 (next (mk___rep my_container__split_fields1)
         (let ((subject temp___593)) temp___5931)))
  (= o20 (ite (< (to_rep
                 (rec__container__cursor__index
                 (us_split_fields3 (let ((subject temp___593)) temp___5931)))) 200)
         (mk___rep1
         (mk___split_fields1
         (of_rep
         (+ (to_rep
            (rec__container__cursor__index
            (us_split_fields3 (let ((subject temp___593)) temp___5931)))) 1))))
         (mk___rep1 (mk___split_fields1 (of_rep 0)))))))

;; H
  (assert
  (and (= o21 (has_element (mk___rep my_container__split_fields1) o20))
  (= (= o21 true)
  (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 o20))))
  (<= (to_rep (rec__container__cursor__index (us_split_fields3 o20))) 200)))))
...
;; H
  (assert
  (and
  (= o22 (next (mk___rep my_container__split_fields1)
         (let ((subject temp___593)) temp___5931)))
  (= o22 (ite (< (to_rep
                 (rec__container__cursor__index
                 (us_split_fields3 (let ((subject temp___593)) temp___5931)))) 200)
...
;; H
  (assert
  (= result38 (let ((subject temp___593)) (mk_cursor__ref temp___5931))))
...
;; H
  (assert
  (and
  (= result39 (has_element (mk___rep my_container__split_fields1)
              (let ((subject temp___593)) temp___5932)))
  (= (= result39 true)
  (and
  (<= 1 (to_rep
        (rec__container__cursor__index
        (us_split_fields3 (let ((subject temp___593)) temp___5932)))))
  (<= (to_rep
      (rec__container__cursor__index
...
;; H
  ...
  (=> (= result39 true)
  (and
  (= o23 (element (mk___rep my_container__split_fields1)
         (let ((subject temp___593)) temp___5932)))
  (and (in_range1 o23)
  (= o23 (to_rep1
         (select (rec__container__container__a my_container__split_fields1)
