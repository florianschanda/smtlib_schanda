...
(declare-fun pump__pump_record__name__first__bit () Int)

(declare-fun pump__pump_record__name__last__bit () Int)

(declare-fun pump__pump_record__name__position () Int)
...
(declare-fun pump__pump_record__resevoir__first__bit () Int)

(declare-fun pump__pump_record__resevoir__last__bit () Int)

(declare-fun pump__pump_record__resevoir__position () Int)
...
(declare-fun pump__pump_record__price__first__bit () Int)

(declare-fun pump__pump_record__price__last__bit () Int)

(declare-fun pump__pump_record__price__position () Int)
...
(declare-fun pump__pump_record__remaining__first__bit () Int)

(declare-fun pump__pump_record__remaining__last__bit () Int)

(declare-fun pump__pump_record__remaining__position () Int)
...
(define-fun dynamic_invariant1 ((temp___expr_516 Int)
...
(declare-fun dummy9 () internal_state)
...
(declare-fun cur_pump__split_fields () (Array Int character))

(declare-fun cur_pump__split_fields1 () nat_type)

(declare-fun cur_pump__split_fields2 () nat_type)

(declare-fun cur_pump__split_fields3 () nat_type)
...
;; H
  ...
  (< (get_outstanding outstanding) (- 2147483647 (get_cur_price
                                                 ...
                                                 cur_pump__split_fields2
                                                 cur_pump__split_fields3))))
  (< 0 (get_cur_resevoir
...
;; WP_parameter_def
 ;; File "pumpunit.adb", line 71, characters 0-0
  (not (in_range (+ outstanding (to_rep2 cur_pump__split_fields2)))))
(check-sat)
(exit)
