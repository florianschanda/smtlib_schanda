...
;; H
  (assert
  (= (bool_eq4 a 5 50 (temp___4613 t j (temp___4619 (select t j) i e)) 5 50) true))
...
;; H
  (assert (=> (not (= j 50)) (and (= o (+ j 1)) (in_range2 (+ j 1)))))
...
;; H
  (assert (= o3 (store (select a j_next1) i o2)))

;; H
  (assert (= o4 (store a j_next1 o3)))
...
;; WP_parameter_def
 ;; File "ar.ads", line 324, characters 0-0
  (not (in_range3 (to_rep (select (select a2 m) n)))))
(check-sat)
