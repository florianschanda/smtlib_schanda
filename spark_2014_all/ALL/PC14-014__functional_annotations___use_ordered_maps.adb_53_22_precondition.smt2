...
(define-fun r__split_fields2 () us_split_fields (mk___split_fields
                                                r__split_fields1))
...
;; H
  (assert
  (and (= (length (mk___rep r__split_discrs r__split_fields3)) 0)
  (= (is_empty (model__ (mk___rep r__split_discrs r__split_fields3))) true)))
...
;; H
  ...
  (and
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2))
     (get (keys s) i1)) true)
  (= (get2 (model__ (mk___rep r__split_discrs r__split_fields2))
     (get (keys s) i1)) (f (get2 (model__ s) (get (keys s) i1))))))))

;; H
  (assert
  (let ((temp___690 (keys (mk___rep r__split_discrs r__split_fields2))))
  ...
  (and (<= 1 i1)
  (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
  (= (get temp___690 temp___689) (get (keys s) i1))))))))
...
;; H
  ...
  (forall ((i1 us_rep1))
  (=> (= (has_key1 o i1) true)
  (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length s)))
  (forall ((j us_rep1))
  (=> (= (has_key1 o j) true)
  (=> (= (get1 o i1) (get1 o j)) (= (bool_eq1 i1 j) true))))))))))

;; H
  (assert
  (and (= o1 (get1 o (mk___rep1 cu__split_fields3)))
  (and (in_range5 o1)
  (=> (= (of_int 0) true)
  (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields3))))
  (forall ((k us_rep1))
  (=> (= (has_key1 o k) true)
  (= (= (bool_eq1 k (mk___rep1 cu__split_fields3)) true)
  (= (witness o (mk___rep1 cu__split_fields3)) (witness o k))))))))))
...
;; H
  ...
  (and
  (and
  (and (= (length3 o11) (length s))
  (forall ((temp___396 Int))
  (=> (and (in_range3 temp___396) (= (iter_has_element o11 temp___396) true))
  (= (has_key (model__ s) (get o11 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o11 key2))
  (= (equivalent_keys (get o11 (find o11 key2)) key2) true)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (and (= (find o11 (get o11 i1)) i1)
  (= (k_is_find o11 (get o11 i1) i1) true)))))))

;; H
  (assert (and (= o12 (get o11 i)) (in_range4 o12)))

;; H
  (assert (= o10 (model__ (mk___rep r__split_discrs r__split_fields2))))

;; H
  (assert
  (and (= result3 (has_key o10 o12))
  (=> (= (of_int 1) true)
  (=>
  (exists ((k Int))
  (and (and (in_range2 k) (= (has_key o10 k) true))
  (= (equivalent_keys k o12) true))) (= result3 true)))))
...
;; H
  ...
  (and
  (and
  (and (= (length3 o6) (length s))
  (forall ((temp___396 Int))
  (=> (and (in_range3 temp___396) (= (iter_has_element o6 temp___396) true))
  (= (has_key (model__ s) (get o6 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o6 key2))
  (= (equivalent_keys (get o6 (find o6 key2)) key2) true)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (and (= (find o6 (get o6 i1)) i1) (= (k_is_find o6 (get o6 i1) i1) true)))))))
...
;; H
  (assert
  (and (= o8 (get2 (model__ s) o7))
  (and (in_range7 o8) (= o8 (get2 (model__ s) o7)))))
...
;; H
  ...
  (and
  (and
  (and (= (length3 o4) (length s))
  (forall ((temp___396 Int))
  (=> (and (in_range3 temp___396) (= (iter_has_element o4 temp___396) true))
  (= (has_key (model__ s) (get o4 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o4 key2))
  (= (equivalent_keys (get o4 (find o4 key2)) key2) true)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (and (= (find o4 (get o4 i1)) i1) (= (k_is_find o4 (get o4 i1) i1) true)))))))
...
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 34, characters 0-0
  (not
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) o5) true)))
(check-sat)
(exit)
