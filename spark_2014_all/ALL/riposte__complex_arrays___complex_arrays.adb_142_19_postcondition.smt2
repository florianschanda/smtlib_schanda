...
;; H
  ...
  (=> (< j9 temp___250)
  (= (select tmp9 temp___250) (select temp___249 temp___250))))))
  (and (<= i j9) (<= j9 1001)))))
...
;; H
  (assert
  (= complex_arrays__create_step_array__result2 (mk_map__ref
                                                complex_arrays__create_step_array__result1)))

;; H
  (assert
  (= complex_arrays__create_step_array__result3 complex_arrays__create_step_array__result1))

;; H
  (assert
  (= result5 (mk_map__ref complex_arrays__create_step_array__result)))

;; H
  (assert
  (= complex_arrays__create_step_array__result1 (map__content tmp12)))

;; H
  (assert
  (= complex_arrays__create_step_array__result4 complex_arrays__create_step_array__result2))
...
;; H
  (assert
  (= complex_arrays__create_step_array__result5 complex_arrays__create_step_array__result3))
...
;; H
  (assert
  (= result6 (map__content complex_arrays__create_step_array__result4)))
...
;; WP_parameter_def
 ;; File "complex_arrays.adb", line 9, characters 0-0
  (not
  (= (to_rep
     (select (map__content complex_arrays__create_step_array__result4)
     j19)) (- 23))))
(check-sat)
(exit)
