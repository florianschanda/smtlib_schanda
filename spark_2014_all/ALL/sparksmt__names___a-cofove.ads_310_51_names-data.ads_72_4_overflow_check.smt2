...
(define-fun dynamic_invariant ((temp___expr_386 Int)
...
;; range_axiom
  (assert
  (forall ((x name_id)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun dynamic_invariant6 ((temp___expr_422 Int)
