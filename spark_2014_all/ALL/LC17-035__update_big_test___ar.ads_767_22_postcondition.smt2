...
;; range_axiom
  (assert
  (forall ((x enum1ta)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (and
                         ...
                         (to_rep2 (rec__ar__rec2t__h2 (us_split_fields3 b)))))
                    true false))
...
(declare-const temp___6639 et3)

(declare-const temp___66391 et1)

(declare-const temp___66392 et2)

(declare-const temp___66393 enum1ta)
...
;; H
  (assert (= temp___6639 o5))

;; H
  (assert (= temp___66391 o6))

;; H
  (assert (= temp___66392 o7))

;; H
  (assert (= temp___66393 o8))
...
;; H
  (assert (= temp___6639 r__split_fields4))

;; H
  (assert (= temp___66391 r__split_fields5))

;; H
  (assert (= temp___66392 r__split_fields6))

;; H
  (assert (= temp___66393 r__split_fields7))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 760, characters 0-0
  (not
  (= (to_rep1
     (rec__ar__rec2t__f2 (us_split_fields__content1 r__split_fields8)))
  (to_rep1 r__split_fields))))
(check-sat)
(exit)
