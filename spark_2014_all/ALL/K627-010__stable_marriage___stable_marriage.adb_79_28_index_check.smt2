...
;; H
  ...
  (=> (not (= rank11 rank21))
  (not (= (to_rep (select r2 rank11)) (to_rep (select r2 rank21))))))))))
...
;; H
  (assert
  (forall ((prev1 Int))
  (=> (and (<= 1 prev1) (<= prev1 (- rank2 1)))
  (= (to_rep1 (select result__2 (to_rep (select r2 prev1)))) prev1))))
...
;; H
  ...
  (=>
  (exists ((prev1 Int))
  (and (and (<= 1 prev1) (<= prev1 (- rank2 1)))
  (= (to_rep (select r2 prev1)) g21)))
  (= (to_rep (select r2 (to_rep1 (select result__2 g21)))) g21)))))
