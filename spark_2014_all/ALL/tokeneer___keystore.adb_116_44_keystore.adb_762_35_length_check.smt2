...
;; range_axiom
  (assert
  (forall ((x sigdatai)) (! (in_range8 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun us_split_fields_SigData__projection ((a us_split_fields2)) (Array Int character)
  (rec__certtypes__signaturet__sigdata a))

(define-fun us_split_fields_SigLength__projection ((a us_split_fields2)) sigdatai
...
(declare-fun certtypes__signaturet__sigdata__first__bit () Int)

(declare-fun certtypes__signaturet__sigdata__last__bit () Int)

(declare-fun certtypes__signaturet__sigdata__position () Int)
...
(declare-fun certtypes__signaturet__siglength__first__bit () Int)

(declare-fun certtypes__signaturet__siglength__last__bit () Int)

(declare-fun certtypes__signaturet__siglength__position () Int)
...
(declare-datatypes ()
((signaturet__ref (mk_signaturet__ref (signaturet__content us_rep1)))))
(define-fun signaturet__ref___projection ((a signaturet__ref)) us_rep1
...
;; range_axiom
  (assert
  (forall ((x returnvaluet)) (! (in_range9
...
;; range_axiom
  (assert
  (forall ((x bytet)) (! (in_range10 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(define-fun bool_eq4 ((a (Array Int bytet)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep6 (select a temp___idx_141)) (to_rep6
...
;; compare_def_lt
  ...
  (! (= (< (compare1 a a_first a_last b b_first b_last) 0)
     ...
     (or (= i a_last)
     (and (< i a_last)
     (< (to_rep6 (select a (+ i 1))) (to_rep6 (select b (+ j 1))))))))))) :pattern (
  (compare1 a a_first a_last b b_first b_last)) ))))
...
;; compare_def_gt
  ...
  (! (= (< 0 (compare1 a a_first a_last b b_first b_last))
     ...
     (or (= i b_last)
     (and (< i b_last)
     (< (to_rep6 (select b (+ i 1))) (to_rep6 (select a (+ j 1))))))))))) :pattern (
  (compare1 a a_first a_last b b_first b_last)) ))))

(declare-fun dummy15 () (Array Int bytet))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int bytet))) (<= 0 (object__component__size3 a))))
...
(define-fun us_split_fields_DigestID__projection ((a us_split_fields4)) unsigned32t
  (rec__keystore__interfac__digestt__digestid a))

(define-fun us_split_fields_SignReturn__projection ((a us_split_fields4)) returnvaluet
  (rec__keystore__interfac__digestt__signreturn a))

(define-fun us_split_fields_VerifyReturn__projection ((a us_split_fields4)) returnvaluet
  (rec__keystore__interfac__digestt__verifyreturn a))

(define-fun us_split_fields_Pad2__projection ((a us_split_fields4)) (Array Int bytet)
...
(define-fun us_rep_12__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                 a))
...
(define-fun bool_eq5 ((a us_rep2)
  (b us_rep2)) Bool (ite (and
                         ...
                         (= (bool_eq4
                            ...
                            (us_split_fields5 a)) 1 20
                            (rec__keystore__interfac__digestt__pad
                            (us_split_fields5 b)) 1 20) true))
                    true false))
...
(declare-datatypes ()
((digestt__ref (mk_digestt__ref (digestt__content us_rep2)))))
(define-fun digestt__ref___projection ((a digestt__ref)) us_rep2 (digestt__content
                                                                 a))
...
(declare-datatypes ()
((t141b__ref (mk_t141b__ref (t141b__content integer)))))
(define-fun t141b__ref___projection ((a t141b__ref)) integer (t141b__content
                                                             a))
...
;; def_axiom
  (assert
  (forall ((temp___1161 Int))
  (forall ((temp___1162 Int))
  (= (select (temp___1159 temp___1161) temp___1162) (of_rep temp___1161)))))
...
;; temp___String_Literal_1164__def_axiom
  ...
  (! (and
     (and
     (and
     (= (to_rep (select (temp___String_Literal_1164 us_void_param) 1)) 83)
     (= (to_rep (select (temp___String_Literal_1164 us_void_param) 2)) 105))
     (= (to_rep (select (temp___String_Literal_1164 us_void_param) 3)) 103))
     (= (to_rep (select (temp___String_Literal_1164 us_void_param) 4)) 110)) :pattern (
  (temp___String_Literal_1164 us_void_param)) )))

(declare-fun temp___String_Literal_1174 (tuple0) (Array Int character))

;; temp___String_Literal_1174__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 1)) 67)
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 2)) 114))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 3)) 121))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 4)) 112))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 5)) 116))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 6)) 111))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 7)) 32))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 8)) 76))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 9)) 105))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 10)) 98))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 11)) 114))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 12)) 97))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 13)) 114))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 14)) 121))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 15)) 32))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 16)) 69))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 17)) 114))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 18)) 114))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 19)) 111))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 20)) 114))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 21)) 32))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 22)) 105))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 23)) 110))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 24)) 32))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 25)) 83))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 26)) 105))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 27)) 103))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 28)) 110))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 29)) 32))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 30)) 58))
     (= (to_rep (select (temp___String_Literal_1174 us_void_param) 31)) 32)) :pattern (
  (temp___String_Literal_1174 us_void_param)) )))
...
(define-fun dynamic_invariant10 ((temp___expr_217 Int)
...
(declare-fun signed () Bool)

(declare-fun theprivatekeyh () Int)
...
(declare-fun keystore__sign__B139b__thestring__assume () (Array Int character))

(declare-fun keystore__sign__B139b__thestring__assume1 () t)

(declare-fun o6 () Int)

(declare-fun digested () Bool)

(declare-fun theprivatekeyh1 () Int)

(declare-fun retval1 () Int)

(declare-fun result () Bool)

(declare-fun signed1 () Bool)
...
;; H
  (assert
  (=>
  (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c135b)))))
  (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c135b))))))
  (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c135b)))))
  (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c135b)))))) 1))))
...
;; H
  (assert
  (= (concat1 (temp___String_Literal_1174 Tuple0) 1 31
     (elts (to_string (attr__ATTRIBUTE_IMAGE9 c135b)))
     (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c135b)))))
     (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c135b))))))
  keystore__sign__B139b__thestring__assume))
...
;; H
  (assert
  (= (mk___t keystore__sign__B139b__thestring__assume
     keystore__sign__B139b__thestring__assume1) thestring))
...
(assert
;; WP_parameter_def
 ;; File "keystore.adb", line 641, characters 0-0
  (not
