...
(declare-datatypes ((rawdatat__ref 0))
(((mk_rawdatat__ref (rawdatat__content us_rep)))))
...
(declare-datatypes ((sigdatai__ref 0))
(((mk_sigdatai__ref (sigdatai__content sigdatai)))))
...
(declare-datatypes ((signaturet__ref 0))
(((mk_signaturet__ref (signaturet__content us_rep1)))))
...
(declare-datatypes ((bytet__ref 0))
(((mk_bytet__ref (bytet__content bytet)))))
...
(((mk_map__ref1 (map__content1 (Array Int bytet))))))
...
(declare-datatypes ((digestt__ref 0))
(((mk_digestt__ref (digestt__content us_rep2)))))
...
(((mk_t141b__ref (t141b__content integer)))))
...
(((mk_t142b__ref (t142b__content us_t1)))))
