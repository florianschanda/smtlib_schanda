...
(declare-fun counterex_forall__single_char_set_broken__result () (Array Int Bool))
...
(declare-fun counterex_forall__single_char_set_broken__result1 () (Array Int Bool))

(declare-fun counterex_forall__single_char_set_broken__result2 () (Array Int Bool))

(declare-fun counterex_forall__single_char_set_broken__result3 () (Array Int Bool))

(declare-fun r8 () (Array Int Bool))

(declare-fun x7 () Int)

(declare-fun counterex_forall__single_char_set_broken__result4 () (Array Int Bool))

(declare-fun r9 () (Array Int Bool))

(declare-fun x8 () Int)

(declare-fun counterex_forall__single_char_set_broken__result5 () (Array Int Bool))
