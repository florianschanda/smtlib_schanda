...
;; H
  (assert
  (= (oeq (mk___rep v__split_discrs v__split_fields8) (empty_vector Tuple0)) true))
...
;; H
  ...
  (= (get
     ...
     (+ (last (model__ (mk___rep v__split_discrs v__split_fields8))) 1)) 1)))
...
;; H
  (assert
  (= v__split_fields7 unbounded__vect__append__2__container__fields4))
...
;; H
  ...
  (= (get
     ...
     (+ (last (model__ (mk___rep v__split_discrs v__split_fields7))) 1)) 2)))
