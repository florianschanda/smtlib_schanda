...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___150 pos2)))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 10))
  (and
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos3))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 10))
  (or
  (and (and (= pos4 pos5) (= pos6 pos4))
  (and (= (to_rep (select t i2)) v) (and (= pos3 result2) (= pos4 i2))))
  (and (and (not (= (to_rep (select t i2)) v)) (= pos4 pos3))
  (and (and (= pos4 pos5) (= pos6 pos4)) (= i2 10))))))
...
;; H
  ...
  (= (= result4 true)
  (forall ((pos15 Int))
  (=> (and (<= 1 pos15) (<= pos15 10)) (not (= (to_rep (select t pos15)) v)))))))
...
;; H
  (assert
  (and (= o3 (- search__search__result4 1)) (in_range1
