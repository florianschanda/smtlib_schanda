...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1555 o14))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1555 o14)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o14))
...
;; H
  (assert (= o15 (select temp___1555 i)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1556 o8))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1556 o8)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o8))
...
;; H
  (assert (=> (= result3 true) (= o9 (select temp___1556 i))))
...
;; H
  (assert (=> (= result2 true) (= temp___1559 (to_rep o3))))

;; H
  (assert
  (=> (= result2 true) (and (<= 1 temp___1559) (<= temp___1559 100))))

;; H
  (assert (=> (= result2 true) (= o4 temp___1559)))

;; H
  (assert (=> (= result2 true) (= o5 (select temp___1557 o4))))
