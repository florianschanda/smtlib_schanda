...
(declare-fun test__xor2__result () (_ BitVec 32))

(declare-fun result () (_ BitVec 32))

(declare-fun test__xor2__result1 () (_ BitVec 32))

(declare-fun test__xor2__result2 () (_ BitVec 32))

(declare-fun test__xor2__result3 () (_ BitVec 32))

(declare-fun test__xor2__result4 () (_ BitVec 32))

(declare-fun test__xor2__result5 () (_ BitVec 32))
...
;; H
  (assert (= test__xor2__result1 (bvxor v0 v1)))

;; H
  (assert
  (= (mk_t__ref test__xor2__result4) (mk_t__ref test__xor2__result2)))

;; H
  (assert (= test__xor2__result5 test__xor2__result3))

;; H
  (assert (= result1 test__xor2__result4))

(assert
;; WP_parameter_def
 ;; File "test.ads", line 10, characters 0-0
  (not (= test__xor2__result4 (bvxor v0 v1))))
(check-sat)
(exit)
