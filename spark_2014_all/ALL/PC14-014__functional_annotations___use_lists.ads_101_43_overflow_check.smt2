...
;; H
  ...
  (and (in_range5 o15)
  (=> (= (of_int 0) true)
  (and (= o15 (w_get o11 (witness o11 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o11 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o11 cu) (witness o11 k))))))))))
...
;; H
  (assert
  (and (= o10 (has_key o9 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o9 k) true) (= (bool_eq1 k cu) true))) (= o10 true)))))
...
;; H
  ...
  (= o5 (length
        (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o5)
  (<= o5 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  (assert (= o7 (ite (<= o4 i) true false)))

;; H
  (assert (= result (ite (= o7 true) o6 false)))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep l__split_discrs (mk___split_fields l__split_fields8))) i1)
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  (- i1 7)))))))
