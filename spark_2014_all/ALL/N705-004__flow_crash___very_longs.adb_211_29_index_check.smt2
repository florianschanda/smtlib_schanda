...
(declare-fun temp___912 () digit_index_type)

(declare-fun temp___9121 () (Array Int octet))

(declare-fun temp___9122 () t1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___909 temp___9091)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___912)))

;; H
  (assert (= temp___9121 o2))

;; H
  (assert (= temp___9122 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9121 temp___9122))))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___923)
  (<= temp___923 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___923) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           result____split_fields2)) temp___923))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
