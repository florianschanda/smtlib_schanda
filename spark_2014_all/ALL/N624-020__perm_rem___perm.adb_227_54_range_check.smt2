...
;; H
  (assert
  (and (= o16 (shift_perm_l o31 o30 o28))
...
;; H
  (assert
  (and
  (= o22 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o26 (remove b ib1))
...
;; H
  (assert
  (and (= o25 (remove o26 o22))
  (and (dynamic_invariant2 o25 true false true)
  (and (= (invariant__ o25) true)
  (and (= (to_rep2 (last o24)) (- (to_rep2 (last o21)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o22 1)))
  (= (to_rep (select o20 k)) (to_rep (select o23 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o22 1) k) (<= k (to_rep2 (last o21))))
  (= (to_rep (select o20 k)) (to_rep (select o23 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o22 k) (<= k (- (to_rep2 (last o21)) 1)))
  (= (to_rep (select o20 (+ k 1))) (to_rep (select o23 k))))))))))))

;; H
  (assert
  (and (= o27 (remove bb ib1))
  (and (dynamic_invariant2 o27 true false true)
  (and (= (invariant__ o27) true)
  (and (= (to_rep2 (last o19)) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select o18 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select o18 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o18 k))))))))))))
