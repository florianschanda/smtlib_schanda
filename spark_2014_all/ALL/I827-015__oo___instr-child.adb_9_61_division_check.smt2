...
;; range_axiom
  (assert
  (forall ((x sixty)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(declare-fun dummy7 () twenty_four)
...
;; range_axiom
  (assert
  (forall ((x twenty_four)) (! (in_range4
...
;; range_axiom
  (assert
  (forall ((x thousand)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(define-fun default_initial_assumption ((temp___expr_293 us_rep2)
...
;; temp___String_Literal_306__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (= (to_rep (select (temp___String_Literal_306 us_void_param) 1)) 58) :pattern (
...
(define-fun dynamic_invariant6 ((temp___expr_231 Int)
  ...
  (temp___do_toplevel_230 Bool)) Bool (=>
                                      ...
                                      (<= 0 24)) (in_range4 temp___expr_231)))
...
(define-fun default_initial_assumption2 ((temp___expr_239 us_rep1)
...
(assert
;; WP_parameter_def
 ;; File "instr-child.ads", line 3, characters 0-0
  (not (not (= 10 0))))
(check-sat)
(exit)
