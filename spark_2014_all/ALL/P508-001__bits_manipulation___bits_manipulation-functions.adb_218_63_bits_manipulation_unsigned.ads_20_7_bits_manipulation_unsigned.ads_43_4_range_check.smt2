...
(declare-fun user_eq2 (t519s t519s) Bool)

(declare-fun dummy2 () t519s)

(declare-datatypes () ((t519s__ref (mk_t519s__ref (t519s__content t519s)))))
(define-fun t519s__ref___projection ((a t519s__ref)) t519s (t519s__content a))
