...
(declare-datatypes ((t33b__ref 0)) (((mk_t33b__ref (t33b__content us_rep)))))
...
(declare-datatypes ((t36b__ref 0)) (((mk_t36b__ref (t36b__content us_rep)))))
...
(declare-datatypes ((t39b__ref 0)) (((mk_t39b__ref (t39b__content us_rep)))))
...
(declare-const temp___210 status)

(declare-const temp___2101 natural)

(declare-const temp___2102 natural)

(declare-const temp___2103 Bool)

(declare-const temp___2104 Bool)
