...
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 2040)))
...
;; range_axiom
  (assert (forall ((x volt)) (in_range3 (to_fixed x))))
...
;; range_axiom
  (assert (forall ((x money)) (in_range4 (to_fixed1 x))))
...
(((mk_money__ref (money__content money)))))
