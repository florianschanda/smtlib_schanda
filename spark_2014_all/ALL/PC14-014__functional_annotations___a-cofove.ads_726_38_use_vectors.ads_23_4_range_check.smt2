...
;; H
  (assert
  (and (= o1 (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 o1)
  (= o1 (last4 (model__ container))))))
...
;; H
  (assert
  (and (= us temp___421) (dynamic_property3 first2 last3 temp___421)))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 704, characters 0-0
  (not (dynamic_property2 first1 last2 index)))
(check-sat)
(exit)
