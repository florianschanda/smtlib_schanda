...
(declare-const state57 us_private__ref)
...
(declare-const state70 us_private)
...
;; H
  (assert
  (= o4 (statusiswaitingfinishadminop (us_private__content state68))))

;; H
  (assert (= o5 (statusiswaitingstartadminop (us_private__content state68))))
...
;; H
  (assert (= o1 (statusisgotadmintoken (us_private__content state68))))
