...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result12 (ite (< 0 o53) true false))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result12 true)
  (= result11 (ite (= o52 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o50) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result13 true)
  (= result10 (ite (= o49 first_allocated1) true false))))))
