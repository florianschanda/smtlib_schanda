...
(declare-const temp___173 length_type)

(declare-const temp___1731 (Array Int natural))
...
(declare-const s__split_fields4 length_type)

(declare-const s__split_fields5 (Array Int natural))

(declare-const s__split_fields6 length_type)

(declare-const s__split_fields7 (Array Int natural))

(declare-const s__split_fields8 length_type)

(declare-const s__split_fields9 (Array Int natural))
...
;; H
  (assert (= temp___173 o7))

;; H
  (assert (= temp___1731 o8))
...
;; H
  (assert (= temp___173 s__split_fields4))

;; H
  (assert (= temp___1731 s__split_fields5))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (peek (mk___rep (mk___split_fields s__split_fields6 s__split_fields7)))
  e)))
(check-sat)
(exit)
