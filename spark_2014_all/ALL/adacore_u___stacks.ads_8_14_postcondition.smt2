...
(declare-fun temp___173 () length_type)

(declare-fun temp___1731 () (Array Int natural))
...
(declare-fun s__split_fields4 () length_type)

(declare-fun s__split_fields5 () (Array Int natural))

(declare-fun s__split_fields6 () length_type)

(declare-fun s__split_fields7 () (Array Int natural))

(declare-fun s__split_fields8 () length_type)

(declare-fun s__split_fields9 () (Array Int natural))
