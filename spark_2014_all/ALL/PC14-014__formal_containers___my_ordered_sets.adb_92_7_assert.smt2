...
(declare-fun m__split_fields1 () us_main_type)

(declare-fun m__split_fields2 () us_main_type)

(declare-fun m__split_fields3 () us_main_type)
...
(declare-fun my_ordered_sets__test_set_pos__B_1__m__assume () us_rep)

(declare-fun my_ordered_sets__test_set_pos__B_2__m__assume () us_rep)

(declare-fun my_ordered_sets__test_set_pos__B_3__m__assume () us_rep)

(declare-fun my_ordered_sets__test_set_pos__B_4__m__assume () us_rep)

(declare-fun temp___1076 () us_rep1)

(declare-fun temp___1078 () us_rep1)
...
(declare-fun m__split_fields4 () us_split_fields)

(declare-fun m__split_fields5 () us_split_fields)

(declare-fun m__split_fields6 () us_split_fields)

(declare-fun result17 () us_split_fields__ref)

(declare-fun m__split_fields7 () us_split_fields)

(declare-fun m__split_fields8 () us_split_fields)

(declare-fun m__split_fields9 () us_split_fields)

(declare-fun result18 () us_split_fields__ref)

(declare-fun m__split_fields10 () us_split_fields)

(declare-fun m__split_fields11 () us_split_fields)

(declare-fun m__split_fields12 () us_split_fields)

(declare-fun result19 () us_split_fields__ref)

(declare-fun m__split_fields13 () us_split_fields)

(declare-fun m__split_fields14 () us_split_fields)

(declare-fun m__split_fields15 () us_split_fields)

(declare-fun my_ordered_sets__m__delete_first__container__fields () us_split_fields)

(declare-fun result20 () us_split_fields__ref)

(declare-fun l__split_fields12 () us_split_fields)

(declare-fun my_ordered_sets__m__delete_last__container__fields () us_split_fields)

(declare-fun result21 () us_split_fields__ref)

(declare-fun l__split_fields13 () us_split_fields)

(declare-fun result22 () us_split_fields__ref1)

(declare-fun c__split_fields4 () us_split_fields2)

(declare-fun c__split_fields5 () us_split_fields2)

(declare-fun my_ordered_sets__m__delete__2__container__fields () us_split_fields)

(declare-fun result23 () us_split_fields__ref)

(declare-fun l__split_fields14 () us_split_fields)

(declare-fun result24 () us_split_fields__ref1)

(declare-fun c__split_fields6 () us_split_fields2)

(declare-fun my_ordered_sets__m__exclude__container__fields () us_split_fields)

(declare-fun result25 () us_split_fields__ref)

(declare-fun l__split_fields15 () us_split_fields)

(declare-fun my_ordered_sets__m__exclude__container__fields1 () us_split_fields)
...
;; H
  ...
  (= (bool_eq1 temp___10581 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= (bool_eq1 temp___10591 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  (assert
  (and
  (= my_ordered_sets__test_set_pos__B_1__m__assume (intersection__2
  ...
  (and
  (and
  (= (length my_ordered_sets__test_set_pos__B_1__m__assume) (num_overlaps
                                                            (model__
                                                            (mk___rep
                                                            k__split_discrs
                                                            k__split_fields3))
                                                            ...
                                                            l__split_discrs
                                                            l__split_fields11))))
  (= (ole (model__ my_ordered_sets__test_set_pos__B_1__m__assume)
  ...
  (= (includes_intersection
     (model__ my_ordered_sets__test_set_pos__B_1__m__assume)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included
     (elements my_ordered_sets__test_set_pos__B_1__m__assume)
  ...
  (= (e_elements_included__2
     ...
     (elements my_ordered_sets__test_set_pos__B_1__m__assume)) true))))

;; H
  (assert
  (= result16 (mk___split_fields__ref (mk___split_fields m__split_fields))))

;; H
  (assert
  (= m__split_fields4 (us_split_fields1
                      my_ordered_sets__test_set_pos__B_1__m__assume)))

;; H
  (assert
  (= m__split_discrs (us_split_discrs1
                     my_ordered_sets__test_set_pos__B_1__m__assume)))
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs m__split_fields5))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs m__split_fields5))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
...
;; H
  ...
  (= (oeq
     ...
     (mk___rep l__split_discrs l__split_fields11))
...
;; H
  (assert
  (and
  (= my_ordered_sets__test_set_pos__B_2__m__assume (union__2
                                                   (mk___rep k__split_discrs
                                                   k__split_fields3)
                                                   (mk___rep l__split_discrs
                                                   l__split_fields11)))
  ...
  (and
  (and
  (= (length my_ordered_sets__test_set_pos__B_2__m__assume) (+ (- (length
                                                                  (mk___rep
                                                                  k__split_discrs
                                                                  k__split_fields3))
  (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3))
  (model__ (mk___rep l__split_discrs l__split_fields11)))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields11))))
  (= (ole (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ my_ordered_sets__test_set_pos__B_2__m__assume)) true))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ my_ordered_sets__test_set_pos__B_2__m__assume)) true))
  (= (included_in_union
     (model__ my_ordered_sets__test_set_pos__B_2__m__assume)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included__3
     (elements my_ordered_sets__test_set_pos__B_2__m__assume)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included__2
     (elements (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements my_ordered_sets__test_set_pos__B_2__m__assume)) true))
  (= (e_elements_included__3
     (elements (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields11))
     (elements my_ordered_sets__test_set_pos__B_2__m__assume)) true))))
...
;; H
  (assert
  (= result17 (mk___split_fields__ref (mk___split_fields m__split_fields1))))

;; H
  (assert
  (= m__split_fields7 (us_split_fields1
                      my_ordered_sets__test_set_pos__B_2__m__assume)))
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs1 m__split_fields8))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs1 m__split_fields8))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
...
;; H
  (assert
  (and
  (= my_ordered_sets__test_set_pos__B_3__m__assume (difference__2
                                                   (mk___rep k__split_discrs
                                                   k__split_fields3)
                                                   (mk___rep l__split_discrs
                                                   l__split_fields11)))
  ...
  (and
  (and
  (= (length my_ordered_sets__test_set_pos__B_3__m__assume) (- (length
                                                               (mk___rep
                                                               k__split_discrs
                                                               k__split_fields3))
  (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3))
  (model__ (mk___rep l__split_discrs l__split_fields11)))))
  (= (ole (model__ my_ordered_sets__test_set_pos__B_3__m__assume)
     (model__ (mk___rep k__split_discrs k__split_fields3))) true))
  (= (no_overlap (model__ my_ordered_sets__test_set_pos__B_3__m__assume)
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ my_ordered_sets__test_set_pos__B_3__m__assume)
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included
     (elements my_ordered_sets__test_set_pos__B_3__m__assume)
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
  (= (e_elements_included__2
     (elements (mk___rep k__split_discrs k__split_fields3))
     (model__ my_ordered_sets__test_set_pos__B_3__m__assume)
...
;; H
  (assert
  (= result18 (mk___split_fields__ref (mk___split_fields m__split_fields2))))

;; H
  (assert
  (= m__split_fields10 (us_split_fields1
                       my_ordered_sets__test_set_pos__B_3__m__assume)))
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs2 m__split_fields11))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs2 m__split_fields11))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
...
;; H
  (assert
  (and
  (= my_ordered_sets__test_set_pos__B_4__m__assume (symmetric_difference__2
                                                   (mk___rep k__split_discrs
                                                   k__split_fields3)
                                                   (mk___rep l__split_discrs
                                                   l__split_fields11)))
  ...
  (and
  (and
  (= (length my_ordered_sets__test_set_pos__B_4__m__assume) (+ (- (length
                                                                  (mk___rep
                                                                  k__split_discrs
                                                                  k__split_fields3)) (* 2
  (num_overlaps (model__ (mk___rep k__split_discrs k__split_fields3))
  (model__ (mk___rep l__split_discrs l__split_fields11))))) (length
                                                            ...
                                                            l__split_discrs
                                                            l__split_fields11))))
  (= (not_in_both (model__ my_ordered_sets__test_set_pos__B_4__m__assume)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union (model__ (mk___rep k__split_discrs k__split_fields3))
     (model__ my_ordered_sets__test_set_pos__B_4__m__assume)
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union
     (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ my_ordered_sets__test_set_pos__B_4__m__assume)
     (model__ (mk___rep k__split_discrs k__split_fields3))) true))
  (= (e_elements_included__3
     (elements my_ordered_sets__test_set_pos__B_4__m__assume)
     (model__ (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep k__split_discrs k__split_fields3))
     (elements (mk___rep l__split_discrs l__split_fields11))) true))
  (= (e_elements_included__2
...
;; H
  (assert
  (= result19 (mk___split_fields__ref (mk___split_fields m__split_fields3))))

;; H
  (assert
  (= m__split_fields13 (us_split_fields1
                       my_ordered_sets__test_set_pos__B_4__m__assume)))
...
;; H
  ...
  (and
  (and
  (= (oeq3 (model__ (mk___rep m__split_discrs3 m__split_fields14))
     (model__ (mk___rep k__split_discrs k__split_fields3))) true)
  (= (oeq2 (elements (mk___rep m__split_discrs3 m__split_fields14))
     (elements (mk___rep k__split_discrs k__split_fields3))) true))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep m__split_discrs3 m__split_fields15)) (+ (- (length
                                                                  (mk___rep
                                                                  m__split_discrs3
                                                                  m__split_fields14)) (* 2
  (num_overlaps (model__ (mk___rep m__split_discrs3 m__split_fields14))
  (model__ (mk___rep l__split_discrs l__split_fields11))))) (length
                                                            (mk___rep
                                                            l__split_discrs
                                                            l__split_fields11))))
  (= (not_in_both (model__ (mk___rep m__split_discrs3 m__split_fields15))
     (model__ (mk___rep m__split_discrs3 m__split_fields14))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union
     (model__ (mk___rep m__split_discrs3 m__split_fields14))
     (model__ (mk___rep m__split_discrs3 m__split_fields15))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_in_union
     (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep m__split_discrs3 m__split_fields15))
     (model__ (mk___rep m__split_discrs3 m__split_fields14))) true))
  (= (e_elements_included__3
     (elements (mk___rep m__split_discrs3 m__split_fields15))
     (model__ (mk___rep m__split_discrs3 m__split_fields14))
  ...
  (= (e_elements_included__2
     (elements (mk___rep m__split_discrs3 m__split_fields14))
     (model__ (mk___rep m__split_discrs3 m__split_fields15))
     (elements (mk___rep m__split_discrs3 m__split_fields15))) true))
  (= (e_elements_included__2
     (elements (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep m__split_discrs3 m__split_fields15))
     (elements (mk___rep m__split_discrs3 m__split_fields15))) true)))
...
;; H
  ...
  (= (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields)) 0)
  (and
  (and
  (and
  (and
  ...
  (= (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields)) (- (length
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields11)) 1))
  (not
  (= (contains
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields))
     (first_element (mk___rep l__split_discrs l__split_fields11))) true)))
  (= (ole
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields))
     (first_element (mk___rep l__split_discrs l__split_fields11))) true))
  (= (range_shifted
     ...
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields))
     (elements (mk___rep l__split_discrs l__split_fields11)) 1
     (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_first__container__fields))
     (positions (mk___rep l__split_discrs l__split_fields11)) 1 1) true))))
...
;; H
  (assert
  (= l__split_fields12 my_ordered_sets__m__delete_first__container__fields))

;; H
  (assert
  (ite (= (= (length (mk___rep l__split_discrs l__split_fields12)) 0) true)
  (= (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields)) 0)
  (and
  (and
  (and
  (and
  ...
  (= (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields)) (- (length
                                                             (mk___rep
                                                             l__split_discrs
                                                             l__split_fields12)) 1))
  (not
  (= (contains
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields))
     (last_element (mk___rep l__split_discrs l__split_fields12))) true)))
  (= (ole
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields12))) true))
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields12))
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields))
     (last_element (mk___rep l__split_discrs l__split_fields12))) true))
  (= (range_equal (elements (mk___rep l__split_discrs l__split_fields12))
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields)) 1
     (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields))) true))
  (= (ole1
     (positions
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete_last__container__fields))
     (positions (mk___rep l__split_discrs l__split_fields12))) true))))
...
;; H
  (assert
  (= l__split_fields13 my_ordered_sets__m__delete_last__container__fields))

;; H
  (assert
  (and (= temp___1076 (find1 (mk___rep l__split_discrs l__split_fields13) 3))
  (ite (ite (= (contains
               (model__ (mk___rep l__split_discrs l__split_fields13)) 3) false) true false)
  (and
  (not
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields13))
     temp___1076) true))
  (= (bool_eq1 temp___1076 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields13))
     temp___1076) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields13))
     temp___1076) (find
                  (elements (mk___rep l__split_discrs l__split_fields13)) 3)))
  (= (equivalent_elements
     (element (mk___rep l__split_discrs l__split_fields13) temp___1076) 3) true)))))
...
;; H
  ...
  (= (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete__2__container__fields)) (- (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields13)) 1)))
  (not
  (= (contains
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete__2__container__fields))
     (element (mk___rep l__split_discrs l__split_fields13)
  ...
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields13))
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete__2__container__fields))
     (element (mk___rep l__split_discrs l__split_fields13)
     (mk___rep1 c__split_fields4))) true))
  (= (range_equal (elements (mk___rep l__split_discrs l__split_fields13))
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete__2__container__fields)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields13))
  ...
  (= (range_shifted
     ...
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete__2__container__fields))
     (elements (mk___rep l__split_discrs l__split_fields13))
     (get (positions (mk___rep l__split_discrs l__split_fields13))
     (mk___rep1 c__split_fields4))
     (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete__2__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs
     my_ordered_sets__m__delete__2__container__fields))
...
;; H
  (assert
  (= l__split_fields14 my_ordered_sets__m__delete__2__container__fields))

;; H
  (assert
  (not
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields14)) 3) true)))

;; H
  (assert
  (and (= temp___1078 (find1 (mk___rep l__split_discrs l__split_fields14) 3))
  (ite (ite (= (contains
               (model__ (mk___rep l__split_discrs l__split_fields14)) 3) false) true false)
  (and
  (not
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields14))
     temp___1078) true))
  (= (bool_eq1 temp___1078 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields14))
     temp___1078) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields14))
     temp___1078) (find
                  (elements (mk___rep l__split_discrs l__split_fields14)) 3)))
  (= (equivalent_elements
     (element (mk___rep l__split_discrs l__split_fields14) temp___1078) 3) true)))))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields)) 2) true))
  (ite (ite (= (contains
  ...
  (= (oeq3
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields14))) true)
  (= (oeq2
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields))
     (elements (mk___rep l__split_discrs l__split_fields14))) true))
  (= (oeq4
     (positions
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields))
  ...
  (= (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields)) (- (length
                                                         (mk___rep
                                                         l__split_discrs
                                                         l__split_fields14)) 1))
  (= (ole
     ...
     my_ordered_sets__m__exclude__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields14))) true))
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields14))
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields)) 2) true))
  (= (range_equal (elements (mk___rep l__split_discrs l__split_fields14))
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields)) 1
     (- (find (elements (mk___rep l__split_discrs l__split_fields14)) 2) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields))
     (elements (mk___rep l__split_discrs l__split_fields14))
     (find (elements (mk___rep l__split_discrs l__split_fields14)) 2)
     (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields))
...
;; H
  (assert
  (= l__split_fields15 my_ordered_sets__m__exclude__container__fields))

;; H
  (assert
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields15)) 4) true))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1)) 4) true))
  (ite (ite (= (contains
  ...
  (= (oeq3
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1))
     (model__ (mk___rep l__split_discrs l__split_fields15))) true)
  (= (oeq2
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1))
     (elements (mk___rep l__split_discrs l__split_fields15))) true))
  (= (oeq4
     (positions
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1))
  ...
  (= (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1)) (- (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields15)) 1))
  (= (ole
     ...
     my_ordered_sets__m__exclude__container__fields1))
     (model__ (mk___rep l__split_discrs l__split_fields15))) true))
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields15))
     (model__
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1)) 4) true))
  (= (range_equal (elements (mk___rep l__split_discrs l__split_fields15))
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1)) 1
     (- (find (elements (mk___rep l__split_discrs l__split_fields15)) 4) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1))
     (elements (mk___rep l__split_discrs l__split_fields15))
     (find (elements (mk___rep l__split_discrs l__split_fields15)) 4)
     (length
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs
     my_ordered_sets__m__exclude__container__fields1))
...
;; H
  (assert
  (= l__split_fields16 my_ordered_sets__m__exclude__container__fields1))

(assert
;; WP_parameter_def
 ;; File "my_ordered_sets.adb", line 189, characters 0-0
  (not (not (= (length (mk___rep l__split_discrs l__split_fields16)) 0))))
(check-sat)
(exit)
