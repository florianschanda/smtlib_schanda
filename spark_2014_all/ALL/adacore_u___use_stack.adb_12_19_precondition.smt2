...
(declare-const the_stack1 us_private)

(declare-const result2 Int)

(declare-const f2 Int)

(declare-const p_stack1 us_private)
...
;; H
  (assert (and (= o (peek the_stack)) (in_range1 o)))
...
;; H
  (assert
  (and (not (= (is_empty the_stack1) true))
  (ite (= (is_full the_stack) true)
  (= (bool_eq1 (get_stack the_stack1) (get_stack the_stack)) true)
  (= (peek the_stack1) e1))))

;; H
  (assert (or (= (peek the_stack1) e1) (= (peek the_stack1) f1)))

;; H
  (assert
  (and (= o1 (peek2 p_top p_stack p_content))
  (and (in_range1 o1) (= o1 (to_rep1 (select p_content p_top))))))
...
;; H
  (assert
  (and
  (and (not (= (is_empty2 p_top1 p_stack1 p_content1) true))
  (ite (= (is_full2 p_top p_stack p_content) true)
  (= (bool_eq1 (get_stack2 p_top1 p_stack1 p_content1)
     (get_stack2 p_top p_stack p_content)) true)
  (= (peek2 p_top1 p_stack1 p_content1) e1))) (in_range2 p_top1)))

;; H
  (assert
  (and (= o2 (peek2 p_top1 p_stack1 p_content1))
  (and (in_range1 o2) (= o2 (to_rep1 (select p_content1 p_top1))))))

;; H
  (assert (= o3 (ite (= o2 f2) true false)))

(assert
;; WP_parameter_def
 ;; File "stack.ads", line 54, characters 0-0
  (not (not (= (is_empty2 p_top1 p_stack1 p_content1) true))))
(check-sat)
(exit)
