...
;; H
  ...
  (<= 0 (to_rep1
        (select (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) i14) j)))
  (< (to_rep1
     (select (select (rec__patience__state__stacks
                     (us_split_fields__content s__split_fields20)) i14) j))
  (to_rep1
...
;; H
  (assert
  (= o111 (select (rec__patience__state__posstack
...
;; H
  (assert
  (= o108 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o107)))
...
;; H
  (assert
  (= o106 (select (rec__patience__state__posstack
