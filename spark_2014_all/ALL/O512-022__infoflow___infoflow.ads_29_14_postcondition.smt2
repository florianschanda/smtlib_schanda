...
(declare-fun flags () (Array Int flagvalue))
...
(declare-fun flags1 () (Array Int flagvalue))

(declare-fun flags2 () (Array Int flagvalue))

(declare-fun flags3 () (Array Int flagvalue))
