...
(declare-fun o9 () group1_id)

(declare-fun o10 () Int)

(declare-fun o11 () Int)

(declare-fun o12 () group2_id)
...
;; H
  (assert
  (=> (= result1 true) (= o12 (select (select ranking_1 g1_id) o11))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o15 (is_preferred_1 g1_id o10 o14))
  (= (= o15 true)
  (<= (to_rep2 (select (invert_1 o14) g1_id)) (to_rep2
                                              (select (invert_1 o14)
                                              o10)))))))
