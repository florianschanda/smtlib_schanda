...
;; H
  (assert
  (and (= o (div1 (- c17b c16b) 10)) (in_range2 (div1 (- c17b c16b) 10))))
...
;; H
  (assert
  (=> (not (< 1000 result__2))
  (=> (< result__2 (- 1000)) (= result__2 result3))))

;; H
  (assert
  (=> (not (< 1000 result__2))
  (=> (< result__2 (- 1000)) (= result__4 (- 1000)))))

;; H
  (assert
  (=> (not (< 1000 result__2))
  (=> (not (< result__2 (- 1000))) (= result__4 result__2))))
