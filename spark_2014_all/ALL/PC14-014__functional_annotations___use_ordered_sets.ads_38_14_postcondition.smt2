...
(declare-fun use_ordered_sets__are_disjoint_2__result2 () Bool)

(declare-fun result2 () Bool)

(declare-fun result3 () Bool)

(declare-fun use_ordered_sets__are_disjoint_2__result3 () Bool)
...
(declare-fun use_ordered_sets__are_disjoint_2__result4 () bool__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint_2__result5 () Bool)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_ordered_sets__are_disjoint_2__result6 () bool__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint_2__result7 () Bool)

(declare-fun result6 () bool__ref)

(declare-fun use_ordered_sets__are_disjoint_2__result8 () Bool)

(declare-fun use_ordered_sets__are_disjoint_2__result9 () bool__ref)

(declare-fun use_ordered_sets__are_disjoint_2__result10 () Bool)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_ordered_sets__are_disjoint_2__result11 () bool__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint_2__result12 () Bool)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_ordered_sets__are_disjoint_2__result13 () bool__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_ordered_sets__are_disjoint_2__result14 () Bool)
...
;; H
  ...
  (and
  (and
  (= use_ordered_sets__are_disjoint_2__result11 (mk_bool__ref
                                                use_ordered_sets__are_disjoint_2__result3))
  (= cu__split_fields8 (mk___split_fields__ref1 cu__split_fields13)))
  (and
  (= use_ordered_sets__are_disjoint_2__result12 use_ordered_sets__are_disjoint_2__result3)
  ...
  (and (= result2 true)
  (and (= use_ordered_sets__are_disjoint_2__result2 result3)
  (= use_ordered_sets__are_disjoint_2__result3 (of_int 0)))))))))))
  (and
  (and
  (and (= result1 (has_key (positions s1) (mk___rep1 cu__split_fields14)))
  (= (= result1 true)
  ...
  (and
  (and
  (= use_ordered_sets__are_disjoint_2__result4 (mk_bool__ref
                                               use_ordered_sets__are_disjoint_2__result3))
  (= cu__split_fields4 (mk___split_fields__ref1 cu__split_fields12)))
  (and
  (= use_ordered_sets__are_disjoint_2__result5 use_ordered_sets__are_disjoint_2__result3)
  (= cu__split_fields5 cu__split_fields12))))
  (and
  (and
  (= use_ordered_sets__are_disjoint_2__result6 use_ordered_sets__are_disjoint_2__result4)
  (= cu__split_fields6 cu__split_fields4))
  (and
  (= use_ordered_sets__are_disjoint_2__result7 use_ordered_sets__are_disjoint_2__result5)
  (= cu__split_fields7 cu__split_fields5))))
  (and
  (and
  (= use_ordered_sets__are_disjoint_2__result6 (mk_bool__ref
                                               use_ordered_sets__are_disjoint_2__result))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields14)))
  (and
  (= use_ordered_sets__are_disjoint_2__result7 use_ordered_sets__are_disjoint_2__result1)
  (= cu__split_fields7 cu__split_fields14)))))
  (and
  (and
  (and
  (= use_ordered_sets__are_disjoint_2__result11 use_ordered_sets__are_disjoint_2__result9)
  (= cu__split_fields8 cu__split_fields6))
  (and
  (= use_ordered_sets__are_disjoint_2__result12 use_ordered_sets__are_disjoint_2__result10)
  (= cu__split_fields9 cu__split_fields7)))
  (and
  (and
  (= use_ordered_sets__are_disjoint_2__result9 (mk_bool__ref
                                               use_ordered_sets__are_disjoint_2__result8))
  (= use_ordered_sets__are_disjoint_2__result10 use_ordered_sets__are_disjoint_2__result8))
  (and (= result6 use_ordered_sets__are_disjoint_2__result6)
  (= use_ordered_sets__are_disjoint_2__result8 (of_int 1))))))))

;; H
  (assert
  (= use_ordered_sets__are_disjoint_2__result13 use_ordered_sets__are_disjoint_2__result11))
...
;; H
  (assert
  (= use_ordered_sets__are_disjoint_2__result14 use_ordered_sets__are_disjoint_2__result12))
...
;; H
  (assert
  (= result7 (bool__content use_ordered_sets__are_disjoint_2__result13)))

;; H
  (assert
  (= (bool__content use_ordered_sets__are_disjoint_2__result13) true))
