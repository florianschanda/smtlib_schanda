...
;; H
  (assert (and (= o43 o42) (uint_in_range1 o42)))

;; H
  (assert (= o44 ((_ int2bv 64) o43)))

;; H
  (assert (= o45 (bvadd o44 ((_ int2bv 64) 1))))

;; H
  (assert (= o46 (bvmul o45 ((_ int2bv 64) 32))))

;; H
  (assert (= o47 (ite (bvult i2 o46) true false)))
...
;; H
  (assert (= o37 (from_integer j3)))

;; H
  (assert (= o41 (ole o37 o40)))

;; H
  (assert (and (= o35 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o36 (ite (<= j3 o35) true false)))

;; H
  (assert (= o31 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o32 (oexpon o31 j3)))

;; H
  (assert (= o26 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o25 (from_integer j3)))
...
;; H
  (assert (and (= o12 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert (= o16 (oexpon o11 o15)))

;; H
  (assert (= o10 (from_word32 w2)))

;; H
  (assert (= o17 (omultiply o10 o16)))

;; H
  (assert (= o34 (oeq o17 o33)))
