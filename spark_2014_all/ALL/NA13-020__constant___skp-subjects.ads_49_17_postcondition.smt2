...
(define-fun us_split_fields_Dst_Subject__2__projection ((a us_split_fields4)) dst_subject_type
  (rec__skp__subjects__event_entry_type__dst_subject a))

(define-fun us_split_fields_Dst_Vector__2__projection ((a us_split_fields4)) dst_vector_range
...
(define-fun us_rep___2__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                  a))
