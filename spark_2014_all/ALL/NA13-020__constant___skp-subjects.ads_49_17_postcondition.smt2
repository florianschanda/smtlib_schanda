...
(declare-fun skp__subjects__get_pml4_address__result () (_ BitVec 64))
...
;; H
  (assert
  (= (bvurem skp__subjects__get_pml4_address__result ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))

;; H
  (assert (= result skp__subjects__get_pml4_address__result))
