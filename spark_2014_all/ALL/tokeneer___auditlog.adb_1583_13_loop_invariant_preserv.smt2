...
;; H
  (assert
  (and (= o (- (to_rep3 usedlogfiles__split_fields7) 1)) (in_range7
...
;; H
  (assert (= usedlogfiles__split_fields4 o2))

;; H
  (assert (= usedlogfiles__split_fields5 o3))

;; H
  (assert (= usedlogfiles__split_fields6 o4))

;; H
  (assert (= o1 o5))

;; H
  (assert (= temp___1289 o2))

;; H
  (assert (= temp___12891 o3))

;; H
  (assert (= temp___12892 o4))

;; H
  (assert (= temp___12893 o5))

;; H
  (assert (= result usedlogfiles__split_fields4))

;; H
  (assert (= result1 usedlogfiles__split_fields5))

;; H
  (assert (= result2 usedlogfiles__split_fields6))

;; H
  (assert (= result3 usedlogfiles__split_fields7))

;; H
  (assert
  (= usedlogfiles__split_fields8 (mk___split_fields temp___1289 temp___12891
...
;; H
  ...
  (= o6 (ite (= (to_rep4
                (rec__auditlog__logfilelistt__head
                usedlogfiles__split_fields8)) 17)
        1
        (+ (to_rep4
           (rec__auditlog__logfilelistt__head usedlogfiles__split_fields8)) 1))))))

;; H
  (assert (= (to_rep4 o7) o6))

;; H
  (assert
  (= (rec__auditlog__logfilelistt__list usedlogfiles__split_fields8)
  o8))
...
;; H
  (assert (= temp___1291 o8))

;; H
  (assert (= temp___12911 o9))

;; H
  (assert (= temp___12912 o10))

;; H
  (assert (= temp___12913 o11))

;; H
  (assert (= result4 (mk___split_fields__ref usedlogfiles__split_fields8)))

;; H
  (assert
  (= usedlogfiles__split_fields9 (mk___split_fields temp___1291 temp___12911
                                 temp___12912 temp___12913)))

;; H
  (assert
  (and (= o12 (- numberlogentries1 1024)) (in_range9
  (- numberlogentries1 1024))))

;; H
  (assert (= result5 (mk_int__ref numberlogentries1)))

;; H
  (assert (= numberlogentries2 o12))
  ...
  (= (to_rep5
     (select logfilesstatus2 (to_rep4
                             (select (rec__auditlog__logfilelistt__list
                                     usedlogfiles__split_fields9) (to_rep4
                                                                  (rec__auditlog__logfilelistt__head
