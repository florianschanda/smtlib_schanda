...
;; s__def_axiom
  (assert (= s (get_line__4 Tuple0)))

(declare-const l Int)

(declare-const p__pt__dummy2__nested__B_1__s__assume (Array Int character))

(declare-const p__pt__dummy2__nested__B_1__s__assume1 t)

(declare-const result Int)

(declare-const l1 Int)

(define-fun p__pt__dummy2__nested__B_1__s__assume2 () us_t (mk___t
                                                           p__pt__dummy2__nested__B_1__s__assume
                                                           p__pt__dummy2__nested__B_1__s__assume1))
...
;; H
  (assert
  (and (= p__pt__dummy2__nested__B_1__s__assume2 (get_line__4 Tuple0))
  (dynamic_invariant1 p__pt__dummy2__nested__B_1__s__assume2 true false
  true)))

;; H
  (assert (= p__pt__dummy2__nested__B_1__s__assume2 s))
