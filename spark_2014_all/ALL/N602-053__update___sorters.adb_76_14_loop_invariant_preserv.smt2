...
(declare-fun temp___1812 () (Array Int integer))

(declare-fun temp___1813 () t1)
...
;; H
  (assert (not (= current2 temp___188)))
...
;; H
  (assert (= (mk1 current3 (to_rep values__last)) temp___1813))

;; H
  (assert (= temp___1812 o6))

;; H
  (assert
  (= (mk (to_rep (first2 temp___1813)) (to_rep (last2 temp___1813)))
  o7))
...
;; H
  ...
  (= (let ((temp___151 (temp___141
                       (mk___t values3
                       (mk (to_rep values__first) (to_rep values__last)))
                       o9 (to_rep (select values3 smallest3)) smallest3
                       (to_rep (select values3 o9)))))
     (bool_eq values4 (to_rep values__first) (to_rep values__last)
     (elts temp___151) (to_rep (first (rt temp___151)))
     (to_rep (last (rt temp___151))))) true)))
...
;; WP_parameter_def
 ;; File "sorters.adb", line 25, characters 0-0
  (not (<= (to_rep (select values4 j)) (to_rep (select values4 (+ j 1))))))
(check-sat)
(exit)
