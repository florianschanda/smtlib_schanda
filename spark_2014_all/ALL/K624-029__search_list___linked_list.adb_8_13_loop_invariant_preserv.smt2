...
(declare-fun linked_list__search__result1 () us_rep1)
...
;; H
  (assert
  (and (= (has_key (positions l) (mk___rep1 cu__split_fields4)) true)
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions l) (mk___rep1 cu__split_fields4)) 1)))
  (not (= (get (model__ l) i) 0))))))

;; H
  (assert (not (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) true)))

;; H
  (assert
  (and (= o2 (element l (mk___rep1 cu__split_fields4)))
  (and (in_range5 o2)
  (= o2 (get (model__ l) (get1 (positions l) (mk___rep1 cu__split_fields4)))))))
...
;; H
  (assert
  (= linked_list__search__result1 (mk___rep1
                                  (mk___split_fields1
...
;; H
  ...
  (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (=
          (get1 (positions l) (mk___rep1 cu__split_fields4)) (length2 l)) true) true)
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not (= (has_key (positions l) (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
