...
(((mk_position__ref (position__content position)))))
...
;; H
  ...
  (and (= (to_rep (select t i2)) v) (and (= pos2 result2) (= pos3 i2))))
  (and (and (not (= (to_rep (select t i2)) v)) (= pos3 pos2))
  (and (and (= pos3 pos4) (= pos5 pos3)) (= i2 10))))))
...
;; H
  (assert (= result4 search__search__result4))

;; H
  (assert (= search__search__result4 0))

(declare-const pos14 Int)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (to_rep (select t pos14)) v))))
(check-sat)
(exit)
