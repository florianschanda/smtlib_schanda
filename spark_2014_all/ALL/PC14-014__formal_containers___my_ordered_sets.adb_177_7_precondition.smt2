...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o41) true))
  (= (bool_eq
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o41)) o41) true))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields)) o41) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (elements
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o41)
     (length
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o40) true))
  (= (bool_eq
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o40)) o40) true))
  ...
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields1)) o40) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o40)
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o39) true)
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs
  ...
  (= (e_is_find
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o39
     (get1
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields))
