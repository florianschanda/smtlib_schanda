...
(define-fun dynamic_ranges__search_0__nested__result8 () int__ref (mk_int__ref
                                                                  dynamic_ranges__search_0__nested__result6))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)) (= temp___262 e)))

;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)) (= temp___261 i1)))

;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)) (= o2 (to_rep o1))))

;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))
  (= (mk_int__ref result1) e9)))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)) (in_range1 e2)))

;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)) (not (= e2 0))))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)) (= i2 last4)))

;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))
  (= dynamic_ranges__search_0__nested__result3 dynamic_ranges__search_0__nested__result4)))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))
  (= dynamic_ranges__search_0__nested__result5 dynamic_ranges__search_0__nested__result3)))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))
  (= dynamic_ranges__search_0__nested__result8 (mk_int__ref
                                               dynamic_ranges__search_0__nested__result4))))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))
  (= dynamic_ranges__search_0__nested__result7 dynamic_ranges__search_0__nested__result5)))
...
;; H
  (assert
  (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)))
  (= dynamic_ranges__search_0__nested__result8 (mk_int__ref
                                               dynamic_ranges__search_0__nested__result))))

;; H
  (assert
  (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))) (= e8 e9)))

;; H
  (assert
  (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))) (= i1 i5)))

;; H
  (assert
  (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 last4)))
  (= dynamic_ranges__search_0__nested__result7 dynamic_ranges__search_0__nested__result1)))

;; H
  (assert
  (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))) (= e7 e1)))

;; H
  (assert
  (=> (not (and (<= (to_rep (first (rt a))) i1) (<= i1 last4))) (= i6 i1)))
