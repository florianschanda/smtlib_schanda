...
;; H
  (assert
  (and (= o11 (* 3 (- 9223372036))) (in_range2 (* 3 (- 9223372036)))))
...
;; H
  (assert
  (and (= o8 (result_sc sc ts))
  (and (in_range3 o8) (= o8 (+ sc (ts_sc ts))))))
...
;; H
  (assert
  (and (= o5 (result_sc sc ts))
  (and (in_range3 o5) (= o5 (+ sc (ts_sc ts))))))
