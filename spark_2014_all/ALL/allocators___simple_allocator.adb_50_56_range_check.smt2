...
;; H
  (assert (and (= o12 (length alloc3)) (in_range5 o12)))

;; H
  (assert (and (= o13 (length avail3)) (in_range5 o13)))
...
;; H
  (assert (= result5 (ite (= o15 r2) true false)))

;; H
  (assert
  (=> (= result5 true)
  (and (= o10 (contains avail3 e1))
  (=> (= (of_int 1) true)
  (=>
  (exists ((e2 Int))
...
;; H
  (assert (=> (= result5 true) (= (= o11 true) (in_range4 e1))))

;; H
  (assert (=> (= result5 true) (= result6 (ite (= o11 true) o10 false))))
...
;; H
  (assert (=> (= result4 true) (= (= o9 true) (in_range4 e))))

;; H
  (assert (=> (= result4 true) (= result7 (ite (= o9 true) o8 false))))
...
;; H
  (assert (and (= o5 rr) (in_range4 rr)))

;; H
  (assert
  (and (= o6 (contains alloc3 o5))
  (=> (= (of_int 1) true)
  (=>
  (exists ((e2 Int))
  (and (and (in_range4 e2) (= (contains alloc3 e2) true)) (= e2 o5)))
  (= o6 true)))))
