...
(declare-fun bitwalker__pokebit64__result () (_ BitVec 64))
...
(declare-fun bitwalker__pokebit64__result1 () (_ BitVec 64))

(declare-fun bitwalker__pokebit64__result2 () (_ BitVec 64))

(declare-fun bitwalker__pokebit64__result3 () (_ BitVec 64))

(declare-fun bitwalker__pokebit64__result4 () (_ BitVec 64))

(declare-fun bitwalker__pokebit64__result5 () (_ BitVec 64))
...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 63)))
  (=> (not (= i (bvsub ((_ int2bv 64) 63) left_bv)))
  (= (= (nth_bv r i) true) (= (nth_bv value i) true))))))

;; H
  (assert
  (forall ((i Int))
  (=> (and (<= 0 i) (<= i 63))
  (and (bvule ((_ int2bv 64) 0) ((_ int2bv 64) i))
  (bvule ((_ int2bv 64) i) ((_ int2bv 64) 63))))))

;; H
  (assert
  (= (= flag true) (= (nth_bv r (bvsub ((_ int2bv 64) 63) left_bv)) true)))
...
;; H
  (assert
  (= (mk_t__ref bitwalker__pokebit64__result4) (mk_t__ref
