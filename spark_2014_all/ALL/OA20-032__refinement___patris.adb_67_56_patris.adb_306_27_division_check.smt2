...
(declare-fun o3 () py_coord)

(declare-fun o4 () px_coord)
...
;; H
  (assert (= (to_rep next_piece__split_fields) 0))
...
;; H
  (assert (and (= o1 (rand Tuple0)) (in_range2 o1)))

;; H
  (assert (= o2 (mod2 o1 4)))

;; H
  (assert (= (to_rep4 o5) o2))

;; H
  (assert (and (= o (rand Tuple0)) (in_range2 o)))
