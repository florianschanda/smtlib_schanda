...
(declare-const temp___1196 (Array Int character))

(declare-const temp___11961 t1)

(declare-const o30 (Array Int character))

(declare-const temp___1199 (Array Int character))
...
;; H
  (assert
  (= (slide (elts fullstring) (to_rep1 (first (rt fullstring))) 1) temp___1196))

;; H
  (assert (= (mk1 1 (to_rep1 (last (rt fullstring)))) temp___11961))

;; H
  (assert
  (=> (<= 1 (to_rep1 (last (rt fullstring))))
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 (to_rep1 (last (rt fullstring))))
  (<= (to_rep1 (last (rt fullstring))) 150)))))

;; H
  (assert (= o30 result__))

;; H
  (assert (= o30 temp___1199))

;; H
  (assert (= (mk1 1 (to_rep1 (last (rt fullstring)))) temp___11991))

(assert
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___11961)) (to_rep1 (last2 temp___11961)))
     (+ (- (to_rep1 (last2 temp___11961)) (to_rep1 (first2 temp___11961))) 1)
     0) (ite (<= (to_rep1 (first2 temp___11991)) (to_rep1
                                                 (last2 temp___11991)))
        (+ (- (to_rep1 (last2 temp___11991)) (to_rep1 (first2 temp___11991))) 1)
        0))))
(check-sat)
(exit)
