...
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  ...
  (= (ite (<= (to_rep1 (first2 temp___11961)) (to_rep1 (last2 temp___11961)))
     ...
     0) (ite (<= (to_rep1 (first2 (mk1 1 (to_rep1 (last (rt fullstring))))))
        (to_rep1 (last2 (mk1 1 (to_rep1 (last (rt fullstring)))))))
        (+ (- (to_rep1 (last2 (mk1 1 (to_rep1 (last (rt fullstring))))))
        (to_rep1 (first2 (mk1 1 (to_rep1 (last (rt fullstring))))))) 1) 0))))
(check-sat)
(exit)
