...
;; H
  ...
  (and (= my_stack__split_fields4 o7) (= my_stack__split_fields5 o8))))
...
;; H
  ...
  (= o13 (to_rep
         (select (rec__stack_functional_spec__stack_type__s
                 ...
                 my_stack__split_fields1)))) i))))))

;; H
  (assert
  (and
  (= (mk___rep (mk___split_fields o11 o12)) (state__2
                                            (mk___split_fields
                                            my_stack__split_fields4
                                            my_stack__split_fields5)))
  (and (= my_stack__split_fields4 o11) (= my_stack__split_fields5 o12))))
