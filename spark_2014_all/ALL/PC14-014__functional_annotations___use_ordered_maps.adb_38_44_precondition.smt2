...
;; H
  ...
  (=> (and (in_range3 temp___396) (= (iter_has_element o5 temp___396) true))
  (= (has_key (model__ s) (get o5 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o5 key2))
  (= (equivalent_keys (get o5 (find o5 key2)) key2) true)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (and (= (find o5 (get o5 i1)) i1) (= (k_is_find o5 (get o5 i1) i1) true)))))))
