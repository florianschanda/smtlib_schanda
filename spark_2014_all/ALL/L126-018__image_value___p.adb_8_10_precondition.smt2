...
;; H
  (assert
  (and (= p__s__assume2 (get_line__4 Tuple0)) (dynamic_invariant1
  p__s__assume2 true false true)))
...
;; WP_parameter_def
 ;; File "p.adb", line 2, characters 0-0
  (not (attr__ATTRIBUTE_VALUE__pre_check3
  (from_string (mk___t s1 (mk (to_rep1 s__first) (to_rep1 s__last)))))))
(check-sat)
(exit)
