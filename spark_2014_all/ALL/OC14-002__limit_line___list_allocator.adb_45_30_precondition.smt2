...
;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o20) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true)
  (and (= o19 (get model____split_fields 1)) (in_range7 o19)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o19 first_available) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o17) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result3 true)
  (and (= o16 (get model____split_fields1 1)) (in_range7 o16))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o16 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result6 true)
  (=> (= result7 true) (and (= o12 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result6 true)
  (=> (= result7 true)
  (and (= o13 (get model____split_fields o12)) (in_range7 o13)))))
