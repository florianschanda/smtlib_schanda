...
(declare-fun a24 () map__ref)

(declare-fun i18 () int__ref)

(declare-fun a25 () (Array Int integer))

(declare-fun i19 () Int)

(declare-fun a26 () map__ref)
...
;; H
  ...
  (forall ((i24 Int))
  (=> (and (<= 0 i24) (<= i24 k1))
  (= (to_rep (select b1 i24)) (to_rep (select b2 i24)))))
  (forall ((i24 Int))
  (=> (and (<= (+ k1 1) i24) (<= i24 100))
  (= (to_rep (select c1 (- i24 k1))) (to_rep (select c2 (- i24 k2)))))))))))))
...
;; H
  (assert
  (=> (and (<= 0 i4) (<= i4 k1)) (= (mk_int__ref i8) (mk_int__ref i6))))
