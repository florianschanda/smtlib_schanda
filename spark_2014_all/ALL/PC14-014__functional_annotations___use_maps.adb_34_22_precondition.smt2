...
(declare-fun temp___765 () us_rep3)
...
;; H
  ...
  (forall ((i1 Int))
  (=>
  (and (<= (get1 (positions s) (mk___rep1 cu__split_fields3)) i1)
  (<= i1 (length s)))
  (not
...
;; H
  (assert
  (and (= temp___765 (keys (mk___rep r__split_discrs r__split_fields2)))
  (and
  (and
  (and
  (and
  (= (length3 temp___765) (length
                          (mk___rep r__split_discrs r__split_fields2)))
  (forall ((temp___431 Int))
  (=>
  (and (in_range3 temp___431)
  (= (iter_has_element temp___765 temp___431) true))
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2))
     (get temp___765 temp___431)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true))
  (and (< 0 (find temp___765 key2))
  (= (get temp___765 (find temp___765 key2)) key2)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep r__split_discrs r__split_fields2))))
  (= (find temp___765 (get temp___765 i1)) i1))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep r__split_discrs r__split_fields2))))
  (forall ((j Int))
  (=>
  (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields2))))
  (=> (= (get temp___765 i1) (get temp___765 j)) (= i1 j)))))))))

;; H
  (assert
  (and (= o (iter_has_element temp___765 temp___764))
  (= (= o true) (and (<= 1 temp___764) (<= temp___764 (last temp___765))))))

;; H
  (assert (= (= o1 true) (in_range3 temp___764)))
...
;; H
  (assert (and (= k (get temp___765 temp___764)) (in_range4 k)))

;; H
  (assert
  (and (= o2 (positions s))
  (and (not (= (has_key1 o2 no_element) true))
  (forall ((i1 us_rep1))
  (=> (= (has_key1 o2 i1) true)
  (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length s)))
  (forall ((j us_rep1))
  (=> (= (has_key1 o2 j) true)
  (=> (= (get1 o2 i1) (get1 o2 j)) (= (bool_eq3 i1 j) true))))))))))
...
;; H
  ...
  (forall ((k1 us_rep1))
  (=> (= (has_key1 o2 k1) true)
  (= (= (bool_eq3 k1 (mk___rep1 cu__split_fields3)) true)
  (= (witness o2 (mk___rep1 cu__split_fields3)) (witness o2 k1))))))))))
...
;; H
  ...
  (forall ((temp___431 Int))
  (=> (and (in_range3 temp___431) (= (iter_has_element o6 temp___431) true))
  (= (has_key (model__ s) (get o6 temp___431)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o6 key2)) (= (get o6 (find o6 key2)) key2)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o6 (get o6 i1)) i1))))
  (forall ((i1 Int))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) k) true)))
(check-sat)
