...
;; H
  (assert
  (and (= o29 (base Tuple0))
  (= o29 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert (= o28 (num_of_big_int x x_first o27)))

;; H
  (assert (= o32 (omultiply o28 o31)))
...
;; H
  (assert
  (= o26 (num_of_big_int
         (mk___t aux4 (mk (to_rep aux4__first) (to_rep aux4__last)))
         aux4_first o25)))

;; H
  (assert (= o36 (oeq o26 o35)))
...
;; H
  (assert
  (= o17 (num_of_big_int
         (mk___t aux3 (mk (to_rep aux3__first) (to_rep aux3__last)))
         aux3_first o16)))

;; H
  (assert (= o24 (oeq o17 o23)))
