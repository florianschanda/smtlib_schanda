...
(declare-fun bool_eq11 (us_rep1 us_rep1) Bool)
...
(define-fun bool_eq12 ((a (Array Int us_rep1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq11 (select a temp___idx_149)
...
(define-fun bool_eq14 ((a (Array Int filestatust)) (a__first Int)
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 70, characters 0-0
  (not (in_range10 (- (to_rep2 usedlogfiles__split_fields) 1))))
(check-sat)
