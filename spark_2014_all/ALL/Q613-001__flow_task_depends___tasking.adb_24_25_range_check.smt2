...
(declare-fun self__1 () message_count_type)

(declare-fun self__2 () Bool)

(declare-fun self__3 () (Array Int message_type))
...
;; H
  (assert (= m1 (to_rep (select self__3 (to_rep1 self__)))))

(assert
;; WP_parameter_def
 ;; File "tasking.ads", line 11, characters 0-0
  (not (in_range3 (- (to_rep2 self__1) 1))))
(check-sat)
(exit)
