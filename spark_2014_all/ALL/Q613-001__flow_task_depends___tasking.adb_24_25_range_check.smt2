...
(((mk_map__ref (map__content (Array Int message_type))))))
...
(((mk_mailboxT__ref (mailboxT__content us_rep)))))
...
(declare-const self__1 message_count_type)

(declare-const self__2 Bool)

(declare-const self__3 (Array Int message_type))
