...
(define-fun dynamic_invariant3 ((temp___expr_168 (_ BitVec 32))
...
(declare-const temp___698 count_type)
...
;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___698)) no_element))
