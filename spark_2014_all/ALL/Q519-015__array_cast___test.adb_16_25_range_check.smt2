...
(((mk_map__ref3 (map__content3 (Array Int (Array Int natural)))))))
...
(((mk_map__ref4 (map__content4 (Array Int (Array Int natural)))))))
...
(((mk___split_discrs (rec__test__rec__x integer)))))
...
(((mk___split_fields (rec__test__rec__y integer)))))
...
(declare-datatypes ((rec1__ref 0)) (((mk_rec1__ref (rec1__content us_rep)))))
...
(declare-datatypes ((rec2__ref 0)) (((mk_rec2__ref (rec2__content us_rep)))))
...
(((mk_map__ref6 (map__content6 (Array Int us_rep))))))
...
(((mk_tarr4D1__ref (tarr4D1__content tarr4D1)))))
