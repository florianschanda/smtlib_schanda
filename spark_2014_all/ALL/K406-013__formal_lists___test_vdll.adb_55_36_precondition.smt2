...
;; H
  (assert
  (and (= o9 (first (mk___rep l2__split_discrs l2__split_fields4)))
  (ite (= (= (length (mk___rep l2__split_discrs l2__split_fields4)) 0) true)
  (= (bool_eq1 o9 no_element) true)
  (and
  (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields4)) o9) true)
  (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields4)) o9) 1)))))
