...
(declare-fun records__init_b__result () unsigned_byte)

(declare-fun records__init_b__result1 () unsigned_byte)
...
(declare-fun temp___260 () unsigned_byte)

(declare-fun temp___2601 () unsigned_byte)
...
(declare-fun records__init_b__result2 () unsigned_byte)

(declare-fun records__init_b__result3 () unsigned_byte)

(declare-fun records__init_b__result4 () unsigned_byte)

(declare-fun records__init_b__result5 () unsigned_byte)

(declare-fun records__init_b__result6 () unsigned_byte)

(declare-fun records__init_b__result7 () unsigned_byte)

(declare-fun r__split_fields4 () us_split_fields__ref)

(declare-fun records__init_b__result8 () pair__ref)

(declare-fun r__split_fields5 () us_split_fields)

(declare-fun records__init_b__result9 () us_rep)

(define-fun records__init_b__result10 () us_rep (mk___rep
                                                (mk___split_fields
                                                records__init_b__result6
                                                records__init_b__result7)))
...
;; H
  (assert (= temp___260 o2))

;; H
  (assert (= temp___2601 o3))
...
;; H
  (assert (= temp___260 r__split_fields2))

;; H
  (assert (= temp___2601 r__split_fields3))
...
;; H
  (assert
  (= records__init_b__result10 (mk___rep
                               (mk___split_fields records__init_b__result2
                               records__init_b__result3))))
...
;; H
  (assert
  (= records__init_b__result8 (mk_pair__ref
                              (mk___rep
                              (mk___split_fields records__init_b__result4
                              records__init_b__result5)))))

;; H
  (assert (= r__split_fields4 (mk___split_fields__ref r__split_fields6)))

;; H
  (assert (= records__init_b__result9 records__init_b__result10))
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 11, characters 0-0
  ...
  (= (to_rep
     (rec__records_prooffuncs__pair__a
     (us_split_fields1 (pair__content records__init_b__result8)))) 0)))
(check-sat)
(exit)
