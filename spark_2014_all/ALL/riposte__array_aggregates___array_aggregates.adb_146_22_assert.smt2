...
;; def_axiom
  (assert
  (forall ((temp___443 Int) (temp___444 Int))
  (let ((temp___442 (temp___441 temp___443 temp___444)))
  (forall ((temp___445 Int))
  (ite (or (= temp___445 2) (and (<= 4 temp___445) (<= temp___445 6)))
  (= (select temp___442 temp___445) (of_rep temp___443))
  (= (select temp___442 temp___445) (of_rep temp___444)))))))
