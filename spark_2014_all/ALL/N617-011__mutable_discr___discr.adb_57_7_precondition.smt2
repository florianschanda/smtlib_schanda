...
(define-fun dynamic_invariant1 ((temp___expr_197 us_rep)
  ...
  (temp___do_toplevel_196 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_195 true))
                                      (in_range2 c temp___expr_197))
                                      (= (attr__constrained temp___expr_197) true)))
...
(declare-fun discr__r4__d1__assume () natural)

(declare-fun discr__r4__d1__assume1 () Bool)
...
(declare-fun discr__r4__d2__assume () natural)

(declare-fun discr__r4__d2__assume1 () Bool)

(declare-fun result () natural)

(declare-fun d1__split_discrs1 () natural)

(declare-fun discr__r4__nested1__d__discrs () natural)

(define-fun o10 () us_rep (mk___rep (mk___split_discrs o8) o9))

(define-fun o11 () us_rep (mk___rep (mk___split_discrs o6) o7))
...
;; H
  (assert (= o11 (mk___rep (mk___split_discrs o4) o5)))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs discr__r4__d2__assume)
     discr__r4__d2__assume1) o10))
...
;; H
  (assert
  (and (= c (to_rep (rec__discr__with_default__c d2__split_discrs)))
  (= d2__attr__constrained true)))

;; H
  (assert
  (=> (= d2__attr__constrained true)
  (= (mk___split_discrs discr__r4__nested1__d__discrs) d2__split_discrs)))

(assert
;; WP_parameter_def
 ;; File "discr.adb", line 27, characters 0-0
