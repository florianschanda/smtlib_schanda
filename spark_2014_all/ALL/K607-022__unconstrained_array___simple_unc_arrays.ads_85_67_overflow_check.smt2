...
(((mk_values__ref (values__content us_t)))))
...
(declare-datatypes ((tS58bP1__ref 0))
(((mk_tS58bP1__ref (tS58bP1__content integer)))))
...
(((mk___t2 (elts2 (Array Int value))(rt2 t2)))))
...
(declare-datatypes ((s58b__ref 0)) (((mk_s58b__ref (s58b__content us_t2)))))
