...
;; range_axiom
  (assert
  (forall ((x value)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(declare-datatypes ()
((tS58bP1__ref (mk_tS58bP1__ref (tS58bP1__content integer)))))
(define-fun tS58bP1__ref___projection ((a1 tS58bP1__ref)) integer (tS58bP1__content
                                                                  a1))
...
(define-fun of_array2 ((a1 (Array Int value)) (f Int)
...
;; object__component__size_axiom
  (assert
  (forall ((a1 (Array Int value))) (<= 0 (object__component__size2 a1))))
...
(declare-fun res__split_fields () (Array Int value))

(declare-fun res__split_fields1 () t1)

(declare-fun i () Int)

(declare-fun simple_unc_arrays__bubble_sort__result () natural)

(declare-fun simple_unc_arrays__bubble_sort__result1 () (Array Int value))

(declare-fun simple_unc_arrays__bubble_sort__result2 () t1)
...
(declare-fun res__split_fields5 () us_split_fields)

(declare-fun result7 () bool__ref)

(declare-fun bull5 () Bool)

(declare-fun bull6 () bool__ref)

(declare-fun res__split_fields6 () us_split_fields__ref)

(declare-fun i5 () int__ref)

(declare-fun bull7 () Bool)

(declare-fun res__split_fields7 () us_split_fields)

(declare-fun i6 () Int)

(declare-fun rho2 () (Array Int value))

(declare-fun bull8 () bool__ref)

(declare-fun res__split_fields8 () us_split_fields__ref)

(declare-fun i7 () int__ref)

(declare-fun bull9 () Bool)

(declare-fun res__split_fields9 () us_split_fields)

(declare-fun i8 () Int)

(declare-fun rho3 () (Array Int value))

(declare-fun bull10 () bool__ref)

(declare-fun res__split_fields10 () us_split_fields__ref)

(declare-fun i9 () int__ref)

(declare-fun bull11 () Bool)

(declare-fun res__split_fields11 () us_split_fields)

(declare-fun i10 () Int)

(declare-fun bull12 () bool__ref)

(declare-fun res__split_fields12 () us_split_fields__ref)

(declare-fun i11 () int__ref)

(declare-fun bull13 () Bool)

(declare-fun res__split_fields13 () us_split_fields)

(declare-fun i12 () Int)

(declare-fun result8 () table__ref)

(declare-fun simple_unc_arrays__bubble_sort__result3 () us_rep)

(declare-fun simple_unc_arrays__bubble_sort__result4 () table__ref)

(declare-fun simple_unc_arrays__bubble_sort__result5 () us_rep)

(declare-fun bull14 () bool__ref)

(declare-fun res__split_fields14 () us_split_fields__ref)

(declare-fun i13 () int__ref)

(declare-fun simple_unc_arrays__bubble_sort__result6 () table__ref)

(declare-fun bull15 () Bool)

(declare-fun res__split_fields15 () us_split_fields)

(declare-fun i14 () Int)

(declare-fun simple_unc_arrays__bubble_sort__result7 () us_rep)
...
;; H
  (assert
  (= (mk___split_fields__ref (mk___split_fields (mk___t1 result1 result2)))
...
;; H
  (assert (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields2)
  true false true))
...
;; H
  (assert
  (=> (= bull1 true)
  (= (- (to_rep (rec__simple_unc_arrays__table__last res__split_discrs)) 1)
  r56b)))
...
;; H
  ...
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (= o3 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4))
  o2)))))

;; H
  (assert
  (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o4 (to_rep2 o3)))))
...
;; H
  ...
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (= o1 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4))
  o)))))

;; H
  (assert
  (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= o5 (to_rep2 o1)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (= result5 (ite (< o5 o4) true false)))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true)
  (= (to_rep (rec__simple_unc_arrays__table__last res__split_discrs))
  r59b)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (=> (= result5 true) (in_range2 r59b)))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true)
  (= (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) simple_unc_arrays__swap_cells__a__compl)))))
...
;; H
  ...
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true) (and (= o8 (+ i4 1)) (in_range1 (+ i4 1)))))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true)
  (= (to_rep1 o6) (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)))))))
...
;; H
  ...
  (and
  (and
  (= (to_rep2 (select simple_unc_arrays__swap_cells__a i4)) (to_rep2
                                                            (select simple_unc_arrays__swap_cells__a__compl
                                                            o8)))
  (= (to_rep2 (select simple_unc_arrays__swap_cells__a o8)) (to_rep2
                                                            (select simple_unc_arrays__swap_cells__a__compl
                                                            i4))))
  (forall ((k Int))
  (=> (and (<= (to_rep1 o6) k) (<= k (to_rep1 o7)))
  (=> (and (not (= k i4)) (not (= k o8)))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true)
  (= result6 (mk___split_fields__ref res__split_fields4))))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true)
  (= res__split_fields5 (mk___split_fields
                        (mk___t1
...
;; H
  ...
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true) (= result7 (mk_bool__ref bull4))))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (= result5 true) (= bull5 (of_int 1))))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (not (= result5 true)) (= res__split_fields5 res__split_fields4)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (not (= result5 true)) (= bull5 bull4)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (=> (not (= result5 true)) (= simple_unc_arrays__swap_cells__a rho1)))))
...
;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (= i5 (mk_int__ref i4)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b))
  (= res__split_fields6 (mk___split_fields__ref res__split_fields5)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (= bull6 (mk_bool__ref bull5)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (= rho2 simple_unc_arrays__swap_cells__a))))
...
;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (= res__split_fields7 res__split_fields5))))

;; H
  (assert
  (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= bull7 bull5))))
...
;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (= res__split_fields8 res__split_fields6))))

;; H
  (assert
  (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= bull8 bull6))))

;; H
  (assert
  (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= rho3 rho2))))
...
;; H
  (assert
  (=> (= bull1 true)
  (=> (and (<= 1 i3) (<= i3 r56b)) (= res__split_fields9 res__split_fields7))))

;; H
  (assert
  (=> (= bull1 true) (=> (and (<= 1 i3) (<= i3 r56b)) (= bull9 bull7))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (not (and (<= 1 i3) (<= i3 r56b))) (= i7 (mk_int__ref i3)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (not (and (<= 1 i3) (<= i3 r56b)))
  (= res__split_fields8 (mk___split_fields__ref res__split_fields3)))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (not (and (<= 1 i3) (<= i3 r56b))) (= bull8 (mk_bool__ref bull3)))))

;; H
  (assert
  (=> (= bull1 true) (=> (not (and (<= 1 i3) (<= i3 r56b))) (= rho3 rho))))

;; H
  (assert
  (=> (= bull1 true) (=> (not (and (<= 1 i3) (<= i3 r56b))) (= i8 i3))))

;; H
  (assert
  (=> (= bull1 true)
  (=> (not (and (<= 1 i3) (<= i3 r56b)))
  (= res__split_fields9 res__split_fields3))))

;; H
  (assert
  (=> (= bull1 true) (=> (not (and (<= 1 i3) (<= i3 r56b))) (= bull9 bull3))))
...
;; H
  (assert
  (=> (not (= bull1 true))
  (= res__split_fields12 (mk___split_fields__ref res__split_fields2))))
...
;; H
  (assert
  (=> (not (= bull1 true)) (= res__split_fields13 res__split_fields2)))
...
;; H
  (assert
  (= simple_unc_arrays__bubble_sort__result4 (mk_table__ref
                                             simple_unc_arrays__bubble_sort__result3)))

;; H
  (assert
  (= simple_unc_arrays__bubble_sort__result5 simple_unc_arrays__bubble_sort__result3))

;; H
  (assert
  (= result8 (mk_table__ref
             (mk___rep
             (mk___split_discrs simple_unc_arrays__bubble_sort__result)
             (mk___split_fields
             (mk___t1 simple_unc_arrays__bubble_sort__result1
             simple_unc_arrays__bubble_sort__result2))))))

;; H
  (assert
  (= simple_unc_arrays__bubble_sort__result3 (mk___rep res__split_discrs
                                             (us_split_fields__content
                                             res__split_fields12))))

;; H
  (assert
  (= simple_unc_arrays__bubble_sort__result6 simple_unc_arrays__bubble_sort__result4))
...
;; H
  (assert
  (= simple_unc_arrays__bubble_sort__result7 simple_unc_arrays__bubble_sort__result5))
...
;; H
  (assert
  (<= j (- (to_rep
           (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 1)))
