...
(define-fun default_initial_assumption ((temp___expr_250 us_rep4)
...
;; temp___String_Literal_354__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (= (to_rep (select (temp___String_Literal_354 us_void_param) 1)) 58) :pattern (
  (temp___String_Literal_354 us_void_param)) )))
...
;; temp___String_Literal_355__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (= (to_rep (select (temp___String_Literal_355 us_void_param) 1)) 58) :pattern (
...
(assert
;; WP_parameter_def
 ;; File "instr.ads", line 62, characters 0-0
  (not (not (= 10 0))))
(check-sat)
(exit)
