...
(declare-fun y1__split_discrs () enum)
...
(declare-fun z2__split_fields () integer)

(declare-fun z2__split_fields1 () integer)
...
(declare-fun temp___224 () us_rep)

(declare-fun temp___226 () us_rep)
...
(declare-fun z2__split_fields2 () us_split_fields)
