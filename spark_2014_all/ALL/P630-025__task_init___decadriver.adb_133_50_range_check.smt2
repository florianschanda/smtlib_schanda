...
(define-fun o43 () us_rep1 (mk___rep1 (mk___split_fields1 o28 o29 o30 o31)))
...
;; H
  (assert (= o43 temp___45734))

;; H
  (assert
  (= o32 (store (rec__decadriver__receiver_type__frame_queue
                (us_split_fields5 self__5)) next_idx1 o43)))
