...
(define-fun tint_arrayD1__ref___projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___projection ((a tint_arrayT__ref)) us_t1
...
(define-fun tnumber_array_typeD1__ref___projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___projection ((a number_array_type__ref)) us_t3
...
(define-fun tint_arrayB__ref___projection ((a tint_arrayB__ref)) us_t5
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1158 Int) (temp___1159 Int) (temp___1160 Int)
  (temp___1161 Int) (temp___1162 Int) (temp___1163 Int) (temp___1164 Int)
  (temp___1165 Int) (temp___1166 Int) (temp___1167 Int) (temp___1168 Int)
  (temp___1169 Int))
  (let ((temp___1157 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def
                     temp___1158 temp___1159 temp___1160 temp___1161
                     temp___1162 temp___1163 temp___1164 temp___1165
                     temp___1166 temp___1167 temp___1168 temp___1169)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1168
  temp___1169)
  (and (= (first5 temp___1157) temp___1168)
  (= (last5 temp___1157) temp___1169)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1157) (+ (first1 source) 0)) (of_rep1
                                                            temp___1158))
  (= (select (to_array2 temp___1157) (+ (first1 source) 1)) (of_rep1
                                                            temp___1159)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 2)) (of_rep1
                                                            temp___1160)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 3)) (of_rep1
                                                            temp___1161)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 4)) (of_rep1
                                                            temp___1162)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 5)) (of_rep1
                                                            temp___1163)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 6)) (of_rep1
                                                            temp___1164)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 7)) (of_rep1
                                                            temp___1165)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 8)) (of_rep1
                                                            temp___1166)))
  (= (select (to_array2 temp___1157) (+ (first1 source) 9)) (of_rep1
                                                            temp___1167)))))))
...
(define-fun tnumber_array_typeB__ref___projection ((a tnumber_array_typeB__ref)) us_t6
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___1175 Int) (temp___1176 Int) (temp___1177 Int))
  (let ((temp___1174 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def
                     temp___1175 temp___1176 temp___1177)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1176
  temp___1177)
  (and (= (first9 temp___1174) temp___1176)
  (= (last9 temp___1174) temp___1177)))
  (forall ((temp___1178 Int))
  (= (select (to_array4 temp___1174) temp___1178) (of_rep1 temp___1175)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_167 us_t3)
  (temp___is_init_164 Bool) (temp___skip_constant_165 Bool)
  (temp___do_toplevel_166 Bool)) Bool (=>
                                      (not (= temp___skip_constant_165 true))
                                      (and (dynamic_property6 (first1 source)
                                      (+ (first1 source) 9)
                                      (first7 temp___expr_167)
                                      (last7 temp___expr_167))
                                      (and
                                      (= (first7 temp___expr_167) (first1
                                                                  source))
                                      (= (last7 temp___expr_167) (+ (first1
                                                                    source) 9))))))
...
(declare-fun temp___1192 () Int)

(declare-fun temp___1193 () Int)
...
;; H
  (assert
  (and (= temp___1198 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1198)
  (<= temp___1198 (to_rep1 (last (rt source))))))

;; H
  (assert (= o20 temp___1198))
...
;; H
  (assert
  (and (= temp___1197 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1197)
  (<= temp___1197 (to_rep1 (last (rt source))))))

;; H
  (assert (= o16 temp___1197))
...
;; H
  (assert
  (and (= temp___1196 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1196)
  (<= temp___1196 (to_rep1 (last (rt source))))))

;; H
  (assert (= o12 temp___1196))
...
;; H
  (assert
  (and (= temp___1195 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1195)
  (<= temp___1195 (to_rep1 (last (rt source))))))

;; H
  (assert (= o8 temp___1195))
...
;; H
  (assert
  (and (= temp___1194 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1194)
  (<= temp___1194 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___1194))
...
;; H
  (assert
  (and (= temp___1193 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1193)
  (<= temp___1193 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1193))
...
;; H
  (assert
  (and (= temp___1192 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep1 (first (rt source))) temp___1192)))
(check-sat)
(exit)
