...
(declare-fun temp___290 (map1 Int (_ BitVec 8) Int (_ BitVec 8) Int) map1)

;; def_axiom
  (assert
  (forall ((temp___292 map1))
  (forall ((temp___293 Int) (temp___295 Int) (temp___297 Int))
  (forall ((temp___294 (_ BitVec 8)) (temp___296 (_ BitVec 8)))
  (let ((temp___291 (temp___290 temp___292 temp___293 temp___294 temp___295
                    temp___296 temp___297)))
  (forall ((temp___298 Int))
  (forall ((temp___299 (_ BitVec 8)))
  (ite (or (and (= temp___298 temp___293) (= temp___299 temp___294))
       (and (= temp___298 temp___295) (= temp___299 temp___296)))
  (= (get temp___291 temp___298 temp___299) (of_rep temp___297))
  (= (get temp___291 temp___298 temp___299) (get temp___292 temp___298
                                            temp___299))))))))))
...
(assert
;; WP_parameter_def
 ;; File "update_logic_fn.ads", line 106, characters 0-0
  (not
  (= (bool_eq a4 1 10 ((_ int2bv 8) 0) ((_ int2bv 8) 7)
     (temp___290 a_2d_arr 5 ((_ int2bv 8) 7) x y v1) 1 10 ((_ int2bv 8) 0)
     ((_ int2bv 8) 7)) true)))
(check-sat)
(exit)
