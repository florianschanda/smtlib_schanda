...
(define-fun dynamic_invariant ((temp___expr_705 Int)
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__instances__vectors__vector us_main_type)))))
...
(declare-fun instances__vectors__vector__capacity__first__bit () Int)

(declare-fun instances__vectors__vector__capacity__last__bit () Int)

(declare-fun instances__vectors__vector__capacity__position () Int)
...
(define-fun default_initial_assumption ((temp___expr_757 us_rep1)
  (temp___skip_top_level_758 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_758 true))
                                         (= (length temp___expr_757) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_717 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_521 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_723 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length container1)))
     (and (<= (+ 0 result) 1000) (dynamic_invariant3 result true false true))) :pattern (
  (length container1)) )))
...
;; H
  (assert
  (and (= o3 (last (model__ container)))
  (and (in_range5 o3) (= o3 (last (model__ container))))))
