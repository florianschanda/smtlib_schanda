...
(declare-fun foo__value__kind__first__bit () Int)

(declare-fun foo__value__kind__last__bit () Int)

(declare-fun foo__value__kind__position () Int)
...
(declare-fun foo__value__bool_field__first__bit () Int)

(declare-fun foo__value__bool_field__last__bit () Int)

(declare-fun foo__value__bool_field__position () Int)
...
(declare-fun foo__value__int_field__first__bit () Int)

(declare-fun foo__value__int_field__last__bit () Int)

(declare-fun foo__value__int_field__position () Int)
...
(declare-fun foo__value__kind__first__bit1 () Int)

(declare-fun foo__value__kind__last__bit1 () Int)

(declare-fun foo__value__kind__position1 () Int)
...
(declare-fun foo__value__bool_field__first__bit1 () Int)

(declare-fun foo__value__bool_field__last__bit1 () Int)

(declare-fun foo__value__bool_field__position1 () Int)
...
(declare-fun foo__value__int_field__first__bit1 () Int)

(declare-fun foo__value__int_field__last__bit1 () Int)

(declare-fun foo__value__int_field__position1 () Int)
...
(define-fun us_split_discrs_2__projection ((a us_split_discrs2)) value_kind
...
(declare-fun foo__record_b__kind__first__bit () Int)

(declare-fun foo__record_b__kind__last__bit () Int)

(declare-fun foo__record_b__kind__position () Int)
...
(declare-fun foo__record_b__f__first__bit () Int)

(declare-fun foo__record_b__f__last__bit () Int)

(declare-fun foo__record_b__f__position () Int)
...
(declare-fun v__split_fields () value_kind)
