...
(declare-datatypes ((t645s__ref 0))
(((mk_t645s__ref (t645s__content integer)))))
(define-fun t645s__ref___projection ((a t645s__ref)) integer (t645s__content
                                                             a))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= (bvand result__2 (let ((temp___432 (- i1 1)))
                      (ite (< temp___432 65536)
                      (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___432))
                      ((_ int2bv 16) 0)))) (let ((temp___433 (- i1 1)))
                                           (ite (< temp___433 65536)
                                           (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___433))
                                           ((_ int2bv 16) 0))))))
(check-sat)
(exit)
