...
;; axiom____post_axiom
  ...
  (! (=> (= (axiom__ us_void_param) true)
     ...
     (=> (and (bvule ((_ int2bv 16) 0) v) (bvule v ((_ int2bv 16) 65535)))
     (forall ((n Int))
     (=> (and (<= 0 n) (<= n 15))
     (=>
     (= (bvand v (ite (< n 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) n))
                 ((_ int2bv 16) 0))) ((_ int2bv 16) 0))
     (= (bvand (bvadd v (ite (< n 65536)
                        (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) n))
                        ((_ int2bv 16) 0))) (ite (< n 65536)
                                            (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) n))
                                            ((_ int2bv 16) 0))) (ite (< n 65536)
                                                                (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) n))
...
(declare-datatypes ()
((t517s__ref (mk_t517s__ref (t517s__content integer)))))
(define-fun t517s__ref___projection ((a t517s__ref)) integer (t517s__content
                                                             a))
...
;; H
  (assert (= result__1 ((_ int2bv 16) 0)))
...
;; H
  (assert
  (=> (< (- i1 1) 65536)
  (= o (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) (- i1 1))))))

;; H
  (assert (=> (not (< (- i1 1) 65536)) (= o ((_ int2bv 16) 0))))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= (bvand result__2 (let ((temp___418 (- i1 1)))
                      (ite (< temp___418 65536)
                      (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___418))
                      ((_ int2bv 16) 0)))) (let ((temp___419 (- i1 1)))
                                           (ite (< temp___419 65536)
                                           (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) temp___419))
                                           ((_ int2bv 16) 0))))))
(check-sat)
(exit)
