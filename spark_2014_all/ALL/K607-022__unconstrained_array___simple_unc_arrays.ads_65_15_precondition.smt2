...
(declare-fun simple_unc_arrays__average__result () Int)
...
(declare-fun simple_unc_arrays__average__result1 () Int)

(declare-fun simple_unc_arrays__average__result2 () Int)

(declare-fun simple_unc_arrays__average__result3 () Int)

(declare-fun sum8 () Int)

(declare-fun i7 () Int)

(declare-fun simple_unc_arrays__average__result4 () Int)

(declare-fun sum9 () Int)

(declare-fun i8 () Int)

(declare-fun simple_unc_arrays__average__result5 () Int)
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= temp___884 sum1)))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= o2 (to_rep1 o1))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= o3 (+ sum2 o2))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (and (= o4 o3) (in_range2 o3))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= sum2 result2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= sum3 o4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= i2 r43b)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= i2 i3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= sum3 sum4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= i4 i2)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= sum5 sum3)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= i9 (mk_int__ref i3))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= sum10 (mk_int__ref sum4))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= i6 i4)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 r43b)) (= sum7 sum5)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 r43b))) (= i1 i5)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 r43b))) (= sum1 sum6)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 r43b))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 r43b))) (= sum7 sum1)))

;; H
  (assert
  (= simple_unc_arrays__average__result1 simple_unc_arrays__average__result2))

;; H
  (assert
  (= simple_unc_arrays__average__result3 simple_unc_arrays__average__result1))

;; H
  (assert
  (= (mk_int__ref result3) (mk_int__ref simple_unc_arrays__average__result)))

;; H
  (assert
  (= simple_unc_arrays__average__result1 (div1 sum6
                                         (to_rep
                                         (rec__simple_unc_arrays__table__last
                                         (us_split_discrs1 a))))))
...
;; H
  (assert
  (= (mk_int__ref simple_unc_arrays__average__result4) (mk_int__ref
                                                       simple_unc_arrays__average__result2)))
...
;; H
  (assert
  (= simple_unc_arrays__average__result5 simple_unc_arrays__average__result3))
...
;; H
  (assert
  (= result4 (ite (<= o5 simple_unc_arrays__average__result4) true false)))
