...
;; H
  ...
  (and (dynamic_invariant3 temp___1277 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1277 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= (mk___rep (mk___split_fields o6 o7)) (select temp___1277 i)))
...
;; H
  ...
  (= temp___1278 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1278 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1278 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (=> (= result2 true)
  (= (mk___rep (mk___split_fields o o1)) (select temp___1278 i))))
...
;; H
  ...
  (= temp___1276 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1276 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1276 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o9 (select temp___1276 i)))
