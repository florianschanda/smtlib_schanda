...
(declare-datatypes ()
((tbitfieldD1__ref (mk_tbitfieldD1__ref (tbitfieldD1__content tbitfieldD1)))))
(define-fun tbitfieldD1__ref___projection ((a tbitfieldD1__ref)) tbitfieldD1
...
;; def_axiom
  (assert
  (forall ((temp___220 Bool) (temp___221 Bool))
  (let ((temp___219 (temp___218 temp___220 temp___221)))
  (forall ((temp___222 Int))
  (ite (= temp___222 1) (= (select temp___219 temp___222) temp___220)
  (= (select temp___219 temp___222) temp___221))))))
...
(declare-const p3 (Array Int Bool))

(declare-const n3 Int)

(declare-const result3 (Array Int Bool))

(declare-const p4 (Array Int Bool))
