...
;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o19) true false))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o18 first_available) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o16) true false)))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o15 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result6 true)
  (=> (= result7 true) (and (= o11 (+ j 1)) (in_range1 (+ j 1))))))
...
;; H
  (assert (=> (= result6 true) (= o9 o8)))

;; H
  (assert (=> (= result6 true) (= o13 (to_rep o9))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (= o13 o12) true false))))
