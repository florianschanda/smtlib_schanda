...
(declare-fun dummy2 () tTnew_strSP1)
...
(declare-fun dummy3 () tTnew_subSP1)
...
;; temp___String_Literal_186__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_186 us_void_param) 1)) 49)
     (= (to_rep (select (temp___String_Literal_186 us_void_param) 2)) 50))
     (= (to_rep (select (temp___String_Literal_186 us_void_param) 3)) 51))
     (= (to_rep (select (temp___String_Literal_186 us_void_param) 4)) 52))
     (= (to_rep (select (temp___String_Literal_186 us_void_param) 5)) 53)) :pattern (
...
(declare-fun temp___189 () (Array Int character))
...
;; H
  (assert (= new_str1 (temp___String_Literal_186 Tuple0)))
...
;; H
  (assert (= (mk pos1 5) temp___1891))

;; H
  (assert
  (= o1 (bool_eq2 temp___189 (to_rep1 (first temp___1891))
        (to_rep1 (last temp___1891)) new_sub1 1 5)))
...
;; H
  ...
  (not
  (= (bool_eq2 new_str1 (to_rep1 (first (mk pos2 5)))
     (to_rep1 (last (mk pos2 5))) new_sub1 1 5) true))))
