...
(declare-fun temp___4589 () (Array Int (Array Int et1)))
...
;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (and (= o13 (- e 1)) (in_range2 (- e 1))))))
...
;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (and (= o16 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (< j 50)
  (=> (< 0 e)
  (= temp___4584 (temp___866 a j (temp___874 (select a j) i e) o16 o15)))))

;; H
  (assert
  (=> (< j 50) (=> (< 0 e) (= result7 (bool_eq1 a3 5 50 temp___4584 5 50)))))
...
;; H
  (assert
  (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o8 (+ j 1))))))

;; H
  (assert
  (=> (< j 50) (=> (not (= result7 true)) (=> (= e 0) (= o9 (select a o8))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result7 true)) (=> (= e 0) (= o10 (temp___904 o9 i 99))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result7 true))
  (=> (= e 0) (and (= o11 (+ j 1)) (in_range1 (+ j 1)))))))
...
;; H
  ...
  (=> (not (= result7 true))
  (=> (= e 0)
  (= temp___4589 (temp___889 a j (temp___897 (select a j) i e) o11 o10))))))

;; H
  (assert
  (=> (< j 50)
  (=> (not (= result7 true))
  (=> (= e 0) (= result6 (bool_eq1 a3 5 50 temp___4589 5 50))))))
