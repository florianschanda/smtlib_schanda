...
(declare-fun dummy13 () (Array Int value))
...
(declare-fun dummy16 () (Array Int value))
...
(declare-fun my_test__t2__assume () natural)

(declare-fun my_test__t2__assume1 () (Array Int value))

(declare-fun my_test__t2__assume2 () t1)
...
(declare-fun temp___326 () us_rep3)

(declare-fun o15 () us_rep)

(declare-fun o16 () us_rep)

(declare-fun temp___330 () us_rep3)
...
;; H
  (assert
  (and (= o8 (max (mk___rep t1__split_discrs t1__split_fields2)))
  (and (in_range5 o8)
  (and
  (forall ((j Int))
  (=>
...
;; H
  (assert
  (and (= o9 (min (mk___rep t1__split_discrs t1__split_fields2)))
  (and (in_range5 o9)
  (and
  (forall ((j Int))
  (=>
...
;; H
  (assert
  (and (= o10 (average (mk___rep t1__split_discrs t1__split_fields2)))
  (and (in_range5 o10)
  (and (<= (min (mk___rep t1__split_discrs t1__split_fields2)) o10)
  (<= o10 (max (mk___rep t1__split_discrs t1__split_fields2)))))))

;; H
  (assert
  (and (= o11 (search (mk___rep t1__split_discrs t1__split_fields2) 0))
  (and (in_range4 o11)
  (or
  (and (= o11 0)
  ...
  (= (to_rep3
     ...
     o11)) 0)
  (= (not_in (mk___rep t1__split_discrs t1__split_fields2) 0 1 (- o11 1)) true))))))

;; H
  (assert
  (and (= o12 (search (mk___rep t2__split_discrs t2__split_fields2) 9))
  (and (in_range4 o12)
  (or
  (and (= o12 0)
  ...
  (= (to_rep3
     ...
     o12)) 9)
  (= (not_in (mk___rep t2__split_discrs t2__split_fields2) 9 1 (- o12 1)) true))))))

;; H
  (assert
  (and
  (= o13 (add (mk___rep t1__split_discrs t1__split_fields2)
         (mk___rep t2__split_discrs t2__split_fields2)))
  (and (dynamic_invariant o13 true false true)
  (and
  (= (same_range o13 (mk___rep t1__split_discrs t1__split_fields2)) true)
  (forall ((j Int))
  (=>
  (and (<= 1 j)
  (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs))))
  (= (to_rep3
     (select (elts1
             (rec__simple_unc_arrays__table__v (us_split_fields1 o13))) j)) (+ 
  (to_rep3
  (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) 
  (to_rep3
...
;; H
  (assert
  (= temp___326 (mk___rep3 (us_split_discrs1 o14)
                (mk___split_fields3
                (elts1
                (rec__simple_unc_arrays__table__v (us_split_fields1 o14)))))))
...
;; H
  (assert
  (and (= o15 (bubble_sort (mk___rep t1__split_discrs t1__split_fields2)))
  (and (dynamic_invariant o15 true false true)
  (and
  (forall ((j Int))
  (=>
  (and (<= 1 j)
  ...
  (<= (to_rep3
      (select (elts1
              (rec__simple_unc_arrays__table__v (us_split_fields1 o15))) j)) 
  (to_rep3
  (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o15))) (+ j 1))))))
  (forall ((j Int))
  (=>
  (and (<= 1 j)
  (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs))))
  ...
  (= (to_rep3
     (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) 
  (to_rep3
  (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o15))) k)))))))))))
...
;; H
  (assert
  (= temp___330 (mk___rep3 (us_split_discrs1 o16)
                (mk___split_fields3
                (elts1
                (rec__simple_unc_arrays__table__v (us_split_fields1 o16)))))))

;; H
  (assert (= result3 (mk___split_fields__ref3 t3__split_fields1)))

;; H
  (assert (= t3__split_fields2 (us_split_fields7 temp___330)))

;; H
  (assert (= t3__split_discrs (us_split_discrs4 temp___330)))
