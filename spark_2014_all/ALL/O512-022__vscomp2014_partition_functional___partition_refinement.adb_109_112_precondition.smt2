...
;; H
  (assert
  (and
  (= o (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c))
  (= (= o true)
...
;; H
  (assert
  (and (= o4 (key (mk___rep d__split_discrs d__split_fields1) c))
  (and (in_range5 o4)
  (= o4 (get (keys (mk___rep d__split_discrs d__split_fields1))
        (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
...
;; H
  (assert
  (and (= o2 (key (mk___rep d__split_discrs d__split_fields1) c))
  (and (in_range5 o2)
  (= o2 (get (keys (mk___rep d__split_discrs d__split_fields1))
        (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
