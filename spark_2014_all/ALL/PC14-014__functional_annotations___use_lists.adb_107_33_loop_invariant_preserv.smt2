...
;; H
  ...
  (=> (and (<= 1 i) (<= i n2))
  (and
  (= (get (model__ (mk___rep l__split_discrs l__split_fields4)) (* 2 i))
  (get
...
;; H
  ...
  (<= i (length
        (mk___rep l__split_discrs (mk___split_fields l__split_fields)))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields4)) (+ i n2))
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i)))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields4))
     (mk___rep1 cu__split_fields5)) (+ (* 2 n2) 1)))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields3)) (+ (length
                                                             ...
                                                             l__split_discrs
                                                             l__split_fields4)) 1))
  (ite (= (bool_eq1 (mk___rep1 cu__split_fields5) no_element) true)
  (and
  (and
  (and
  (and
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields3))
     (length (mk___rep l__split_discrs l__split_fields3))) o))
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields4))
     ...
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields4))
        (mk___rep1 cu__split_fields5)) 1)) true)
...
;; H
  (assert
  (and
  (= o2 (has_key (positions (mk___rep l__split_discrs l__split_fields3))
