...
;; H
  (assert (= o28 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o27 (from_word64 i2)))

;; H
  (assert (= o29 (oadd o27 o28)))

;; H
  (assert (= o26 (from_integer j3)))

;; H
  (assert (= o30 (ole o26 o29)))
...
;; H
  (assert (= o22 (oexpon o21 j3)))

;; H
  (assert (= o16 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o15 (from_integer j3)))

;; H
  (assert (= o17 (osubtract o15 o16)))

;; H
  (assert (= o14 (from_word64 i2)))

;; H
  (assert (= o18 (osubtract o14 o17)))

;; H
  (assert (= o13 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o19 (oexpon__2 o13 o18)))
