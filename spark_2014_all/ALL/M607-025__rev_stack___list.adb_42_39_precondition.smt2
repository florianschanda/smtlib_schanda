...
;; H
  (assert
  (and (= o18 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o18)
  (<= o18 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
;; H
  (assert
  (=> (= result6 true) (and (= o13 (- last5 i9)) (in_range1 (- last5 i9)))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o12 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o12 true false true)
  (and (= (to_rep (first (rt o12))) 1) (<= 0 (to_rep (last (rt o12)))))))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o8 (- last5 i9)) (in_range1 (- last5 i9)))))
