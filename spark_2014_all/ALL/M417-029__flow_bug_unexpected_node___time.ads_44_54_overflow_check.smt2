...
(declare-fun time__t_increment__result () natural)

(declare-fun time__t_increment__result1 () minutes_t)

(declare-fun time__t_increment__result2 () seconds_t)
...
(declare-fun o7 () seconds_t)

(declare-fun o8 () natural)

(declare-fun o9 () minutes_t)

(declare-fun o10 () seconds_t)

(declare-fun temp___165 () natural)

(declare-fun temp___1651 () minutes_t)

(declare-fun temp___1652 () seconds_t)

(declare-fun o11 () seconds_t)

(declare-fun o12 () natural)

(declare-fun o13 () minutes_t)

(declare-fun o14 () seconds_t)
...
(declare-fun o16 () minutes_t)

(declare-fun o17 () natural)

(declare-fun o18 () minutes_t)

(declare-fun o19 () seconds_t)

(declare-fun temp___163 () natural)

(declare-fun temp___1631 () minutes_t)

(declare-fun temp___1632 () seconds_t)

(declare-fun o20 () minutes_t)

(declare-fun o21 () natural)

(declare-fun o22 () minutes_t)

(declare-fun o23 () seconds_t)
...
(declare-fun o27 () minutes_t)

(declare-fun o28 () seconds_t)

(declare-fun temp___161 () us_rep)
...
(declare-fun time__t_increment__result3 () us_rep)
...
(declare-fun time__t_increment__result4 () us_rep)
...
(declare-fun time__t_increment__result5 () us_rep)

(declare-fun result____split_fields9 () us_split_fields__ref)

(declare-fun time__t_increment__result6 () t__ref)

(declare-fun result____split_fields10 () us_split_fields)

(declare-fun time__t_increment__result7 () us_rep)

(declare-fun result____split_fields11 () us_split_fields__ref)

(declare-fun time__t_increment__result8 () t__ref)

(declare-fun result____split_fields12 () us_split_fields)

(declare-fun time__t_increment__result9 () us_rep)

(declare-fun result____split_fields13 () us_split_fields__ref)

(declare-fun time__t_increment__result10 () t__ref)

(declare-fun result____split_fields14 () us_split_fields)

(declare-fun time__t_increment__result11 () us_rep)

(declare-fun result____split_fields15 () us_split_fields__ref)

(declare-fun time__t_increment__result12 () t__ref)

(declare-fun result____split_fields16 () us_split_fields)

(declare-fun time__t_increment__result13 () us_rep)
...
;; WP_parameter_def
 ;; File "time.ads", line 6, characters 0-0
  (not (in_range1
  (+ (to_rep (rec__time__t__hours (us_split_fields1 x))) 1))))
(check-sat)
(exit)
