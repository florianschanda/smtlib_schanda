...
(define-fun dynamic_invariant3 ((temp___expr_360 us_rep2)
  (temp___is_init_357 Bool) (temp___skip_constant_358 Bool)
  (temp___do_toplevel_359 Bool)) Bool (and (in_range4 1000
...
(declare-fun result____split_fields () capacity_range)

(declare-fun result____split_fields1 () us_main_type)

(declare-fun result____split_fields2 () capacity_range)

(declare-fun result____split_fields3 () us_main_type)

(declare-fun amortized_queue__tail__result () capacity_range)

(declare-fun amortized_queue__tail__result1 () us_main_type)

(declare-fun amortized_queue__tail__result2 () capacity_range)

(declare-fun amortized_queue__tail__result3 () us_main_type)

(declare-fun o () capacity_range)

(declare-fun o1 () us_main_type)

(declare-fun o2 () capacity_range)
...
(declare-fun o8 () us_split_fields2)

(declare-fun amortized_queue__tail__R62b__result__assume () us_rep2)
...
(declare-fun amortized_queue__my_vectors__delete_last__container__fields () us_split_fields)
...
(declare-fun amortized_queue__reverse_insert__rear__fields () us_split_fields)

(declare-fun amortized_queue__reverse_insert__front__fields () us_split_fields)
...
(declare-fun result5 () queue__ref)

(declare-fun amortized_queue__tail__result4 () us_rep2)

(declare-fun result____split_fields8 () us_split_fields__ref1)

(declare-fun amortized_queue__tail__result5 () queue__ref)

(declare-fun result____split_fields9 () us_split_fields2)

(declare-fun amortized_queue__tail__result6 () us_rep2)

(declare-fun result____split_fields10 () us_split_fields__ref1)

(declare-fun amortized_queue__tail__result7 () queue__ref)

(declare-fun result____split_fields11 () us_split_fields2)

(declare-fun amortized_queue__tail__result8 () us_rep2)

(declare-fun result6 () Bool)

(define-fun o21 () us_rep (mk___rep (mk___split_discrs o2)
                          (mk___split_fields o3)))

(define-fun o22 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  (assert
  (= amortized_queue__tail__result5 (mk_queue__ref
                                    amortized_queue__tail__result4)))
...
;; H
  (assert (= amortized_queue__tail__result6 amortized_queue__tail__result4))
...
;; H
  (assert
  (and
  (= o22 (copy (rec__amortized_queue__queue__front (us_split_fields3 q))
         1000))
  (and
  (= (oeq1 (model__ o22)
...
;; H
  ...
  (= result____split_fields4 (us_split_fields3
                             amortized_queue__tail__R62b__result__assume)))
...
;; H
  ...
  (rec__amortized_queue__queue__front result____split_fields4))
  (us_split_fields1
  (rec__amortized_queue__queue__front result____split_fields4)))) 1))
  (= (olt
     (model__
     (mk___rep
     (us_split_discrs1
     ...
     (rec__amortized_queue__queue__front result____split_fields4))
     (us_split_fields1
     (rec__amortized_queue__queue__front result____split_fields4))))) true)))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o14 (copy (rec__amortized_queue__queue__rear result____split_fields5)
         1000))
  (and
  (= (oeq1 (model__ o14)
  ...
  (= (to_rep
     (rec__amortized_queue__my_vectors__vector__capacity
     (us_split_discrs1 o14))) (length
                              (rec__amortized_queue__queue__rear
                              result____split_fields5)))
  (= (to_rep
     (rec__amortized_queue__my_vectors__vector__capacity
     (us_split_discrs1 o14))) 1000))))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o11 (copy (rec__amortized_queue__queue__front result____split_fields5)
         1000))
  (and
  (= (oeq1 (model__ o11)
     (model__ (rec__amortized_queue__queue__front result____split_fields5))) true)
  (ite (= 1000 0)
  (= (to_rep
     (rec__amortized_queue__my_vectors__vector__capacity
...
;; H
  ...
  (= (length
     ...
     (us_split_discrs1
     (rec__amortized_queue__queue__front result____split_fields5))
     amortized_queue__reverse_insert__front__fields)) (+ (length o13)
  (length o16)))
  (and
  (= (length
     (mk___rep
     (us_split_discrs1
     (rec__amortized_queue__queue__rear result____split_fields5))
     amortized_queue__reverse_insert__rear__fields)) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (last (model__ o13))))
  (= (get
     (model__
     (mk___rep
     (us_split_discrs1
     (rec__amortized_queue__queue__front result____split_fields5))
     amortized_queue__reverse_insert__front__fields)) i) (get (model__ o13)
                                                         i))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (last (model__ o16))))
  (= (get
     (model__
     (mk___rep
     (us_split_discrs1
     ...
     (- (+ (last
           ...
           (us_split_discrs1
           (rec__amortized_queue__queue__front result____split_fields5))
           amortized_queue__reverse_insert__front__fields))) 1) i)) (get
                                                                    (model__
                                                                    o16) i)))))))))
...
;; H
  (assert
  (=> (= result2 true)
  (= result3 (mk___split_fields__ref1 result____split_fields5))))

;; H
  (assert
  (=> (= result2 true)
  (= result____split_fields6 (mk___split_fields1
                             (mk___rep
                             (us_split_discrs1
                             (rec__amortized_queue__queue__front
                             result____split_fields5))
...
;; H
  (assert
  (=> (= result2 true)
  (= result4 (mk___split_fields__ref1 result____split_fields6))))

;; H
  (assert
  (=> (= result2 true)
  (= result____split_fields7 (mk___split_fields1
                             (rec__amortized_queue__queue__front
...
;; H
  (assert
  (= result5 (mk_queue__ref
             (mk___rep1
             (mk___split_fields1
             (mk___rep (mk___split_discrs amortized_queue__tail__result)
             (mk___split_fields amortized_queue__tail__result1))
             (mk___rep (mk___split_discrs amortized_queue__tail__result2)
             (mk___split_fields amortized_queue__tail__result3)))))))

;; H
  (assert
  (= amortized_queue__tail__result4 (mk___rep1 result____split_fields7)))

;; H
  (assert (= amortized_queue__tail__result7 amortized_queue__tail__result5))

;; H
  (assert (= result____split_fields10 result____split_fields8))

;; H
  (assert (= amortized_queue__tail__result8 amortized_queue__tail__result6))
...
;; H
  ...
  (<= (length
      (rec__amortized_queue__queue__rear
      (us_split_fields3 (queue__content amortized_queue__tail__result7))))
  (length
  (rec__amortized_queue__queue__front
  (us_split_fields3 (queue__content amortized_queue__tail__result7)))))
  (<= (length
...
;; H
  (assert (and (= o18 (model__1 q)) (= (is_model q o18) true)))

;; H
  (assert
  (and (= o19 (last_element o18))
  (and (in_range2 o19) (= o19 (get (model__ o18) (last (model__ o18)))))))

;; H
  (assert
  (and (= o17 (model__1 (queue__content amortized_queue__tail__result7)))
  (= (is_model (queue__content amortized_queue__tail__result7) o17) true)))

;; H
  (assert
  (and (= o20 (oconcat__3 o17 o19))
  (and (= (length o20) (+ (length o17) 1))
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (last (model__ o17))))
  (= (get (model__ o20) i) (get (model__ o17) i))))
  (= (get (model__ o20) (+ (last (model__ o17)) 1)) o19)))))
