...
(declare-const amortized_queue__tail__result capacity_range)

(declare-const amortized_queue__tail__result1 us_main_type)

(declare-const amortized_queue__tail__result2 capacity_range)

(declare-const amortized_queue__tail__result3 us_main_type)
...
(declare-const amortized_queue__tail__result4 us_rep2)

(declare-const result____split_fields8 us_split_fields__ref1)

(declare-const amortized_queue__tail__result5 queue__ref)

(declare-const result____split_fields9 us_split_fields2)

(declare-const amortized_queue__tail__result6 us_rep2)

(declare-const result____split_fields10 us_split_fields__ref1)

(declare-const amortized_queue__tail__result7 queue__ref)

(declare-const result____split_fields11 us_split_fields2)

(declare-const amortized_queue__tail__result8 us_rep2)
