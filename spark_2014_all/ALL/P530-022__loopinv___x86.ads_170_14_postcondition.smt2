...
(declare-fun x86__ah__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__ah__result1 () (_ BitVec 8))

(declare-fun x86__ah__result2 () (_ BitVec 8))

(declare-fun x86__ah__result3 () (_ BitVec 8))

(declare-fun x86__ah__result4 () (_ BitVec 8))

(declare-fun x86__ah__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= x86__ah__result1 ((_ extract 7 0) (bvudiv (bvand rax ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not (= x86__ah__result4 (readreghigh8 rax))))
(check-sat)
(exit)
