...
(define-fun register_type__ref_17__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_12__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_12__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2263 us_t1)
  (temp___is_init_2260 Bool) (temp___skip_constant_2261 Bool)
  (temp___do_toplevel_2262 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2261 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2263)
                                       (last3 temp___expr_2263))
                                       (and (= (first3 temp___expr_2263) 1)
                                       (= (last3 temp___expr_2263) 5)))))
