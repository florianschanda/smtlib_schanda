...
(declare-fun temp___277 () natural)

(declare-fun temp___2771 () Bool)
...
;; H
  (assert
  (=> (= d__attr__constrained true)
  (= temp___275 (rec__discr__with_default__c d__split_discrs2))))

;; H
  (assert
  (= (mk___rep (mk___split_discrs usq_2) usq_3) (mk___rep
                                                (mk___split_discrs
                                                temp___275) temp___2751)))
