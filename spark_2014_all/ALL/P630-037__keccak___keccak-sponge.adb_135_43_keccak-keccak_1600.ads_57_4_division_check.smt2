...
(declare-const temp___840 us_rep)
...
;; H
  (assert
  (=> (< 0 free_bits_in_block1)
  (= temp___817 (mk___t4 o10 (mk4 (to_rep1 (first (rt data))) r85s)))))

;; H
  (assert
  (=> (< 0 free_bits_in_block1)
  (= (ite (<= (to_rep1 (first8 (rt4 temp___817))) (to_rep1
                                                  (last8 (rt4 temp___817))))
     (+ (- (to_rep1 (last8 (rt4 temp___817))) (to_rep1
                                              (first8 (rt4 temp___817)))) 1)
...
;; H
  ...
  (=> (< 0 free_bits_in_block1)
  (= temp___818 (mk___t3
                (slide (elts4 temp___817) (to_rep1 (first8 (rt4 temp___817)))
                r81s) (mk3 r81s r82s)))))
...
;; H
  ...
  (=> (< 0 free_bits_in_block1)
  (=> (<= r81s r82s)
  (and (and (<= 0 r81s) (<= r81s 199)) (and (<= 0 r82s) (<= r82s 199))))))
...
;; H
  (assert
  (=> (< 0 free_bits_in_block1) (= temp___820 (mk___t3 o11 (mk3 r81s r82s)))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first6 (rt3 temp___818))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first6 (rt3 temp___820))) (to_rep1
                                                     (last6 (rt3 temp___820))))
        (+ (- (to_rep1 (last6 (rt3 temp___820))) (to_rep1
                                                 (first6 (rt3 temp___820)))) 1)
        0))))
...
;; H
  ...
  (= (select o12 temp___823) (select (elts3 temp___822) temp___823))
  (= (select o12 temp___823) (select ctx__split_fields1 temp___823))))))

;; H
  (assert
  (=> (< 0 free_bits_in_block1)
  (= o13 (mk___split_fields ctx__split_fields o12 ctx__split_fields2
...
;; H
  (assert
  (=> (< 0 free_bits_in_block1)
  (= ctx__split_fields7 (us_split_fields1 temp___825))))

;; H
  (assert
  (=> (< 0 free_bits_in_block1)
  (and (= o14 (+ offset1 free_bytes_in_block1)) (in_range1
...
;; H
  (assert
  (=> (< 0 free_bits_in_block1)
  (and (= o15 (- remaining_bytes1 free_bytes_in_block1)) (in_range1
...
;; H
  (assert
  (=> (< 0 free_bits_in_block1)
  (and (= o17 (- remaining_bits1 free_bits_in_block1)) (in_range1
...
;; H
  (assert (=> (<= initial_bit_rate1 remaining_bits2) (= temp___841 offset2)))
...
;; H
  ...
  (= temp___840 (mk___rep ctx__split_fields9))))
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= result15 (let ((subject temp___844)) (mk_int__ref temp___8441)))))
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= result16 (let ((subject temp___843)) (mk_int__ref temp___8431)))))
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= result17 (let ((subject temp___842)) (mk_int__ref temp___8421)))))
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= o22 (+ (to_rep1 (first (rt data))) o21))))

;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (and (= keccak__keccak_1600__sponge__absorb__L_1__R92s__assume o22)
  (in_range1 o22))))
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= temp___833 (mk___t6 o23 (mk6 r91s r92s)))))

;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (= o24 (mk___t (elts6 temp___833)
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bytes4 o26)))

;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2)
  (and (= o27 (- remaining_bits3 initial_bit_rate1)) (in_range2
...
;; H
  (assert
  (=> (<= initial_bit_rate1 remaining_bits2) (= remaining_bits4 o27)))
...
;; H
  ...
  (= (- (int__content remaining_bytes7) 1) r95s)))
...
;; H
  ...
  (=> (< 0 (int__content remaining_bits7))
  (and
  (= keccak__keccak_1600__sponge__absorb__R98s__assume (+ (to_rep1
                                                          (first (rt data)))
  (int__content offset7))) (in_range1
  (+ (to_rep1 (first (rt data))) (int__content offset7))))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= keccak__keccak_1600__sponge__absorb__R98s__assume r98s)))
...
;; H
  ...
  (=> (< 0 (int__content remaining_bits7))
  (and
  (= o28 (+ (int__content offset7) (- (int__content remaining_bytes7) 1)))
  (in_range1
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= o29 (+ (to_rep1 (first (rt data))) o28))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (and (= keccak__keccak_1600__sponge__absorb__R99s__assume o29) (in_range1
  o29))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= keccak__keccak_1600__sponge__absorb__R99s__assume r99s)))
...
;; H
  ...
  (=> (<= r98s r99s)
  (and
  (and (<= (to_rep1 (first (rt data))) r98s)
  (<= r98s (to_rep1 (last (rt data)))))
  (and (<= (to_rep1 (first (rt data))) r99s)
  (<= r99s (to_rep1 (last (rt data)))))))))
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= temp___845 (mk___t8 o30 (mk8 r98s r99s)))))
...
;; H
  ...
  (=> (< 0 (int__content remaining_bits7))
  (=> (<= 0 r95s)
  (and (and (<= 0 0) (<= 0 199)) (and (<= 0 r95s) (<= r95s 199))))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= o31 (rec__keccak__keccak_1600__sponge__context__block
         (us_split_fields__content ctx__split_fields15)))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= temp___849 (mk___t7 o31 (mk7 0 r95s)))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first14 (rt7 temp___846))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first14 (rt7 temp___849))) (to_rep1
                                                      (last14
                                                      (rt7 temp___849))))
        (+ (- (to_rep1 (last14 (rt7 temp___849))) (to_rep1
                                                  (first14 (rt7 temp___849)))) 1)
        0))))
...
;; H
  ...
  (= (select o32 temp___852) (select (elts7 temp___851) temp___852))
  (= (select o32 temp___852) (select (rec__keccak__keccak_1600__sponge__context__block
                                     (us_split_fields__content
                                     ctx__split_fields15)) temp___852))))))
...
;; H
  ...
  (= o33 (mk___split_fields
         (rec__keccak__keccak_1600__sponge__context__state
         (us_split_fields__content ctx__split_fields15)) o32
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
         (us_split_fields__content ctx__split_fields15))
         (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
         (us_split_fields__content ctx__split_fields15))
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7)) (= temp___854 (mk___rep o33))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7)) (= result23 ctx__split_fields15)))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= ctx__split_fields17 (us_split_fields1 temp___854))))
...
;; H
  (assert
  (=> (not (< 0 (int__content remaining_bits7)))
  (= ctx__split_fields18 ctx__split_fields15)))

;; H
  (assert
  (=> (not (< 0 (int__content remaining_bits7)))
  (= ctx__split_fields19 ctx__split_fields16)))

;; H
  (assert
  (and
  (= o38 (rate_of (mk___rep (us_split_fields__content ctx__split_fields18))))
  (and (in_range3 o38)
  (and
  (= o38 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
            (us_split_fields__content ctx__split_fields18))) 8))
  (< o38 1600)))))

;; H
  (assert (= o39 (ite (= o38 initial_bit_rate1) true false)))

;; H
  (assert
  (and
  (= o36 (rate_of (mk___rep (us_split_fields__content ctx__split_fields18))))
  (and (in_range3 o36)
  (and
  (= o36 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert (= o37 (ite (< (int__content remaining_bits7) o36) true false)))

;; H
  (assert
  (and
  (= o34 (state_of (mk___rep (us_split_fields__content ctx__split_fields18))))
  (and (in_range5 o34)
  (= o34 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         (us_split_fields__content ctx__split_fields18)))))))

;; H
  (assert (= o35 (ite (= o34 0) true false)))
