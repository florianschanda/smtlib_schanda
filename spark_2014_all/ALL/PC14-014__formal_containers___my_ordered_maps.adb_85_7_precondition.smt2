...
(define-fun dynamic_invariant2 ((temp___expr_711 us_rep1)
  (temp___is_init_708 Bool) (temp___skip_constant_709 Bool)
  (temp___do_toplevel_710 Bool)) Bool (=>
                                      (not (= temp___skip_constant_709 true))
                                      (in_range5 10 temp___expr_711)))

(define-fun default_initial_assumption ((temp___expr_713 us_rep1)
  (temp___skip_top_level_714 Bool)) Bool (and
                                         ...
                                         (=>
                                         (not
                                         (= temp___skip_top_level_714 true))
                                         (= (is_empty temp___expr_713) true))))
...
(define-fun dynamic_invariant3 ((temp___expr_720 us_rep1)
  (temp___is_init_717 Bool) (temp___skip_constant_718 Bool)
  (temp___do_toplevel_719 Bool)) Bool (=>
                                      (not (= temp___skip_constant_718 true))
                                      (in_range6 10 temp___expr_720)))

(define-fun default_initial_assumption1 ((temp___expr_722 us_rep1)
  (temp___skip_top_level_723 Bool)) Bool (and
                                         (= (to_rep1
                                            (rec__my_ordered_maps__n__map__capacity
                                            (us_split_discrs1
                                            temp___expr_722))) 10)
...
(declare-fun temp___965 () count_type)
...
(declare-fun temp___948 () count_type)
...
(define-fun temp___9481 () us_rep2 (mk___rep2
                                   (mk___split_fields2 temp___948)))

(define-fun temp___9471 () us_rep2 (mk___rep2
                                   (mk___split_fields2 temp___947)))
...
;; H
  ...
  (= (bool_eq2 temp___9471 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= (bool_eq2 temp___9481 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o28) true))
  (= (bool_eq
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o28)) o28) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o28) 1))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields)) o28) 1)) true))
  (= (range_shifted
     (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o28)
     (length
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o27) true))
  (= (bool_eq
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o27)) o27) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o27) 2))
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o27) true))
  (= (range_equal (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields1)) o27) 1)) true))
  (= (range_shifted (keys (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields1)) o27)
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__container__fields)) o18) true)
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs
  ...
  (= (equivalent_keys
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__container__fields)
     (mk___rep2 c__split_fields3)) o18) true))
  (= (k_is_find
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__container__fields)) o18
     (get1
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__container__fields))
  ...
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__container__fields)) o18) 3))
  ...
  (= (keys_included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields2)) o18) true))
...
;; H
  ...
  (= (bool_eq
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__replace__container__fields)) o22)) o22) true))
  (= (equal_except (keys (mk___rep1 l__split_discrs l__split_fields4))
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__replace__container__fields)) o22)) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__replace__container__fields)) o22) 1))
  (= (same_keys
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__replace__container__fields))
...
;; H
  ...
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields6))
     (mk___rep (mk___split_fields (of_rep 1) (of_rep 1)))) true))
...
;; WP_parameter_def
 ;; File "my_ordered_maps.adb", line 4, characters 0-0
  (not
  (or
  (< (length (mk___rep1 l__split_discrs l__split_fields6)) (to_rep1
                                                           (rec__my_ordered_maps__n__map__capacity
                                                           l__split_discrs)))
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields6)) o26) true))))
(check-sat)
(exit)
