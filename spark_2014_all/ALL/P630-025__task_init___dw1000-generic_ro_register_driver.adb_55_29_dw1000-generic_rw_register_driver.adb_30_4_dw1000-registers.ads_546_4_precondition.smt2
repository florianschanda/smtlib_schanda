...
(define-fun register_type__ref___190__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___133__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___133__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6550 us_t1)
  (temp___is_init_6547 Bool) (temp___skip_constant_6548 Bool)
  (temp___do_toplevel_6549 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6548 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6550)
                                       (last3 temp___expr_6550))
                                       (and (= (first3 temp___expr_6550) 1)
                                       (= (last3 temp___expr_6550) 4)))))
