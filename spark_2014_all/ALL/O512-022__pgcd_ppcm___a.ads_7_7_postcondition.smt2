...
;; H
  (assert (= result7 (int__content a__pgcd__result4)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (or
  (or (= (int__content a__pgcd__result4) 0)
  (and (<= 1 (int__content a__pgcd__result4))
  (<= (int__content a__pgcd__result4) (abs a))))
  (and (<= 1 (int__content a__pgcd__result4))
  (<= (int__content a__pgcd__result4) (abs b))))))
(check-sat)
(exit)
