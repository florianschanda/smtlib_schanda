...
;; H
  (assert
  (=> (<= 0 r12b2)
  (and (and (<= (to_rep (first (rt p))) 0) (<= 0 (to_rep (last (rt p)))))
  (and (<= (to_rep (first (rt p))) r12b2) (<= r12b2 (to_rep (last (rt p))))))))

;; H
  (assert (= o5 (elts p)))

;; H
  (assert (= temp___173 o5))

;; H
  (assert (= temp___1731 (mk4 0 r12b2)))
