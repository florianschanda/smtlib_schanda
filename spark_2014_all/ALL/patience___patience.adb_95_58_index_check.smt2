...
;; H
  (assert
  (= o126 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o125)))

;; H
  (assert (= o127 (to_rep1 o126)))

;; H
  (assert
  (= o128 (ite (<= o127 (- (to_rep1
                           (rec__patience__state__numstacks
                           (us_split_fields__content s__split_fields20))) 1))
          true false)))
...
;; H
  (assert
  (=> (= result23 true)
  (= o114 (select (rec__patience__state__posstack
                  (us_split_fields__content s__split_fields20)) o113))))

;; H
  (assert (=> (= result23 true) (= temp___651 (to_rep1 o114))))

;; H
  (assert (=> (= result23 true) (and (<= 0 temp___651) (<= temp___651 99))))

;; H
  (assert (=> (= result23 true) (= o115 temp___651)))

;; H
  (assert
  (=> (= result23 true)
  (= o116 (select (rec__patience__state__stacksizes
                  (us_split_fields__content s__split_fields20)) o115))))

;; H
  (assert (=> (= result23 true) (= o117 (to_rep1 o116))))
...
;; H
  (assert
  (=> (= result23 true)
  (= o112 (select (rec__patience__state__posheight
                  (us_split_fields__content s__split_fields20)) o111))))

;; H
  (assert (=> (= result23 true) (= o119 (to_rep1 o112))))
...
;; H
  (assert (=> (= result23 true) (= o110 (to_rep1 o109))))
