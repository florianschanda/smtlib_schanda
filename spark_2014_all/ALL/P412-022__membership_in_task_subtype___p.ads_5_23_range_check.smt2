...
(declare-datatypes ()
((us_split_fields4 (mk___split_fields2 (rec__p__tt2 us_main_type)))))
(define-fun us_split_fields_TT3__projection ((a us_split_fields4)) us_main_type
  (rec__p__tt2 a))
...
(declare-fun p__tt__x__first__bit2 () Int)

(declare-fun p__tt__x__last__bit2 () Int)

(declare-fun p__tt__x__position2 () Int)
...
(declare-datatypes ()
((tto1S__ref (mk_tto1S__ref (tto1S__content us_rep2)))))
(define-fun tto1S__ref___projection ((a tto1S__ref)) us_rep2 (tto1S__content
                                                             a))

(define-fun dynamic_invariant ((temp___expr_184 us_rep2)
...
(define-fun default_initial_assumption ((temp___expr_186 us_rep2)
  (temp___skip_top_level_187 Bool)) Bool (= (to_rep
                                            (rec__p__tt__x
                                            (us_split_discrs3
                                            temp___expr_186))) 1))

(declare-fun to1__split_discrs () us_split_discrs)
