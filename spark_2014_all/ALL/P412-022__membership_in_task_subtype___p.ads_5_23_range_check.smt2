...
(declare-datatypes ((tt1__ref 0)) (((mk_tt1__ref (tt1__content us_rep1)))))
(define-fun tt1__ref___projection ((a tt1__ref)) us_rep1 (tt1__content a))

(declare-datatypes ((us_split_fields4 0))
(((mk___split_fields2 (rec__p__tt2 us_main_type)))))
(define-fun us_split_fields_TT__3__projection ((a us_split_fields4)) us_main_type
  (rec__p__tt2 a))
...
(((mk_tto1S__ref (tto1S__content us_rep2)))))
