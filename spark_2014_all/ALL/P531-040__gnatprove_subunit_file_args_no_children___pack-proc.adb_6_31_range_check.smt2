...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (to_rep1
                        (rec__pack__point_t__x (us_split_fields1 b))))
                        (= (to_rep1
                           (rec__pack__point_t__y (us_split_fields1 a)))
                        (to_rep1
                        (rec__pack__point_t__y (us_split_fields1 b)))))
                   true false))
...
(declare-fun pack__point_t__x__first__bit () Int)

(declare-fun pack__point_t__x__last__bit () Int)

(declare-fun pack__point_t__x__position () Int)
...
(declare-fun pack__point_t__y__first__bit () Int)

(declare-fun pack__point_t__y__last__bit () Int)

(declare-fun pack__point_t__y__position () Int)
...
(declare-fun pack__exp_seq_t__len__first__bit () Int)

(declare-fun pack__exp_seq_t__len__last__bit () Int)

(declare-fun pack__exp_seq_t__len__position () Int)
...
(declare-fun pack__exp_seq_t__points__first__bit () Int)

(declare-fun pack__exp_seq_t__points__last__bit () Int)

(declare-fun pack__exp_seq_t__points__position () Int)
...
(define-fun bool_eq3 ((a us_rep2)
  (b us_rep2)) Bool (ite (and
                         (and
                         (= (rec__pack__opt_p_t__flag (us_split_fields5 a))
                         (rec__pack__opt_p_t__flag (us_split_fields5 b)))
                         (= (to_rep
...
(declare-fun pack__opt_p_t__flag__first__bit () Int)

(declare-fun pack__opt_p_t__flag__last__bit () Int)

(declare-fun pack__opt_p_t__flag__position () Int)
...
(declare-fun pack__opt_p_t__idx__first__bit () Int)

(declare-fun pack__opt_p_t__idx__last__bit () Int)

(declare-fun pack__opt_p_t__idx__position () Int)
...
(declare-fun pack__opt_p_t__the_p__first__bit () Int)

(declare-fun pack__opt_p_t__the_p__last__bit () Int)

(declare-fun pack__opt_p_t__the_p__position () Int)
