...
;; H
  ...
  (=> (and (<= 1 g1) (<= g1 64))
  (exists ((g22 Int))
  (and (and (<= 1 g22) (<= g22 64)) (= (to_rep (select g2_to_g1 g22)) g1))))))
...
;; H
  ...
  (=> (and (<= 1 g22) (<= g22 64))
  (=> (not (= g211 g22))
  (not (= (to_rep (select g2_to_g1 g211)) (to_rep (select g2_to_g1 g22))))))))))
...
;; H
  (assert
  (exists ((prev2 Int))
  (and (and (<= 1 prev2) (<= prev2 (- g21 1)))
  (= (to_rep (select g2_to_g1 prev2)) g1))))

(assert
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 17, characters 0-0
  (not (= (to_rep (select g2_to_g1 (to_rep1 (select result__1 g1)))) g1)))
(check-sat)
(exit)
