...
;; range_axiom
  (assert
  (forall ((x et4)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(declare-fun temp___2934 ((Array Int us_rep2) Int
  us_rep2) (Array Int us_rep2))

;; def_axiom
  (assert
  (forall ((temp___2936 (Array Int us_rep2)))
  (forall ((temp___2937 Int))
  (forall ((temp___2938 us_rep2))
  (let ((temp___2935 (temp___2934 temp___2936 temp___2937 temp___2938)))
  (forall ((temp___2939 Int))
  (ite (= temp___2939 temp___2937)
  (= (select temp___2935 temp___2939) temp___2938)
  (= (select temp___2935 temp___2939) (select temp___2936 temp___2939)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1348, characters 0-0
  (not
  (= (bool_eq3 (map__content a2) 1 16
     (temp___2934 a i
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (let ((usq_ (us_split_fields3
                 (rec__ar__rec3t__f3 (us_split_fields5 (select a i))))))
     ...
     (rec__ar__rec3t__g3 (us_split_fields5 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
