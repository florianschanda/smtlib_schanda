...
(define-fun register_type__ref_229__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_164__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_164__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7188 us_t1)
  (temp___is_init_7185 Bool) (temp___skip_constant_7186 Bool)
  (temp___do_toplevel_7187 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7186 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_7188)
                                       (last3 temp___expr_7188))
                                       (and (= (first3 temp___expr_7188) 1)
                                       (= (last3 temp___expr_7188) 4)))))
