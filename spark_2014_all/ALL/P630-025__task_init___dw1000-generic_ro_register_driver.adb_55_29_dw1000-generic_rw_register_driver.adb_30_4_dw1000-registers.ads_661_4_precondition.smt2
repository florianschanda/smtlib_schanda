...
(define-fun register_type__ref___229__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___164__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___164__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7324 us_t1)
  (temp___is_init_7321 Bool) (temp___skip_constant_7322 Bool)
  (temp___do_toplevel_7323 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7322 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_7324)
                                       (last3 temp___expr_7324))
                                       (and (= (first3 temp___expr_7324) 1)
                                       (= (last3 temp___expr_7324) 4)))))
