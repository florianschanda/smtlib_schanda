...
(declare-fun main2__some_record__c1__first__bit () Int)

(declare-fun main2__some_record__c1__last__bit () Int)

(declare-fun main2__some_record__c1__position () Int)
...
(declare-fun main2__some_record__c2__first__bit () Int)

(declare-fun main2__some_record__c2__last__bit () Int)

(declare-fun main2__some_record__c2__position () Int)
...
(declare-fun main2__off_c1__assume () Int)

(declare-fun main2__off_c2__assume () Int)
...
;; H
  (assert (and (= main2__off_c1__assume 0) (in_range 0)))

;; H
  (assert (= main2__off_c1__assume off_c1))

;; H
  (assert (in_range off_c1))

;; H
  (assert (and (= main2__off_c2__assume 1) (in_range 1)))

;; H
  (assert (= main2__off_c2__assume off_c2))
