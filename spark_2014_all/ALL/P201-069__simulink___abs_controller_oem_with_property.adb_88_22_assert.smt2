...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 2000000000000000111022302462515654042363166809082031250.0 10000000000000000000000000000000000000000000000000000000.0))))
...
(declare-fun diff_out11 () t)

(declare-fun result3 () t)

(declare-fun difference_out11 () t)

(declare-fun result4 () t)

(declare-fun sum_out11 () t)
...
;; H
  (assert
  (and (= o3 (sub RNE1 fliteral4 diff_out11)) (tqtisFinite
  (sub RNE1 fliteral4 diff_out11))))
...
;; H
  ...
  (= o4 (boolean_to_long_float
        (ite (lt difference_out11 fliteral3) true false)))
  (tqtisFinite o4)))
...
;; H
  ...
  (= o5 (boolean_to_long_float
        (ite (lt fliteral3 difference_out11) true false)))
  (tqtisFinite o5)))

;; H
  (assert (= o6 (sub RNE1 o5 o4)))
...
;; WP_parameter_def
 ;; File "abs_controller_oem_with_property.ads", line 20, characters 0-0
  (not (or (not (eq vehicle_speed fliteral3)) (eq sum_out11 fliteral))))
(check-sat)
