...
;; H
  ...
  (= o31 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o24 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (= o23 (maxvalue len))
  (= o23 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o16 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (= o15 (maxvalue len))
  (= o15 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
