...
(declare-const threshold1 Int)

(declare-const result1 Int)

(declare-const i1 Int)

(declare-const threshold2 Int)
...
;; H
  (assert (= threshold1 2147483647))

;; H
  (assert (in_range2 threshold1))
...
;; H
  (assert
  (and (=> (<= 1 2147483647) (in_range2 threshold2))
...
(assert
;; WP_parameter_def
 ;; File "p.adb", line 45, characters 0-0
  (not (in_range1 (- i2 1))))
(check-sat)
(exit)
