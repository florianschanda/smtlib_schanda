...
(declare-datatypes ((tTpreviousSP1__ref 0))
...
(((mk_tpreviousS__ref (tpreviousS__content us_t1)))))
...
;; H
  (assert (<= current1 (to_rep1 values__last)))

(assert
;; WP_parameter_def
 ;; File "sort.adb", line 59, characters 0-0
  (not (<= (to_rep1 values__first) current1)))
(check-sat)
(exit)
