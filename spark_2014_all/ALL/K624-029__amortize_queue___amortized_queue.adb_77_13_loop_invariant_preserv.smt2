...
(define-fun front__split_fields4 () us_split_fields (mk___split_fields
...
(define-fun front__split_fields5 () us_split_fields (mk___split_fields
...
;; H
  (assert
  (= (mk___split_fields front__split_fields1) amortized_queue__my_vectors__append__2__container__fields3))

;; H
  (assert
  (= (length (mk___rep front__split_discrs front__split_fields5)) (+ (- (+
  (length ofront) (last
                  (model__
...
;; H
  ...
  (= (get (model__ (mk___rep front__split_discrs front__split_fields5)) i)
...
;; H
  ...
  (<= i (last
        (model__
        (mk___rep rear__split_discrs (mk___split_fields rear__split_fields))))))
  (= (get (model__ (mk___rep front__split_discrs front__split_fields5))
     (- (+ (last
           (model__ (mk___rep front__split_discrs front__split_fields5)))
     idx2) i)) (get
               (model__
               (mk___rep rear__split_discrs
...
;; H
  ...
  (length (mk___rep front__split_discrs front__split_fields5)) 1))
  (= (olt (model__ (mk___rep front__split_discrs front__split_fields5))
     (model__
     (mk___rep front__split_discrs
  ...
  (= (get
     ...
     (mk___rep front__split_discrs
     amortized_queue__my_vectors__append__2__container__fields2))
     (+ (last (model__ (mk___rep front__split_discrs front__split_fields5))) 1))
  o3)))
...
;; H
  (assert
  (= front__split_fields4 amortized_queue__my_vectors__append__2__container__fields2))
...
;; WP_parameter_def
 ;; File "amortized_queue.ads", line 41, characters 0-0
  (not
  (= (get (model__ (mk___rep front__split_discrs front__split_fields4))
     (- (+ (last
           (model__ (mk___rep front__split_discrs front__split_fields4)))
     idx3) i)) (get
               (model__
               (mk___rep rear__split_discrs
               (mk___split_fields rear__split_fields))) i))))
