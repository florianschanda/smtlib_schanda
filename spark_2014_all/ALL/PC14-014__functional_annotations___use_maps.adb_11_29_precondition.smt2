...
;; H
  ...
  (forall ((i1 us_rep1))
  (=> (= (has_key1 o2 i1) true)
  (and (and (<= 1 (get1 o2 i1)) (<= (get1 o2 i1) (length3 s)))
  (forall ((j us_rep1))
  (=> (= (has_key1 o2 j) true)
...
;; H
  ...
  (and
  (and
  (and (= (length1 o6) (length3 s))
  (forall ((temp___431 Int))
  (=> (and (in_range5 temp___431) (= (iter_has_element o6 temp___431) true))
  (= (has_key (model__ s) (get o6 temp___431)) true))))
  (forall ((key2 Int))
  (=> (and (in_range3 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o6 key2)) (= (get o6 (find o6 key2)) key2)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length3 s))) (= (find o6 (get o6 i1)) i1))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length3 s)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length3 s)))
