...
(define-fun dynamic_invariant1 ((temp___expr_149 (_ BitVec 16))
  (temp___is_init_146 Bool) (temp___skip_constant_147 Bool)
  (temp___do_toplevel_148 Bool)) Bool true)
...
;; readmem16__post_axiom
  ...
  (! (=> (dynamic_invariant addr true true true)
     ...
     (bvuge result ((_ int2bv 16) 0))) (dynamic_invariant1 result true false
...
;; H
  ...
  (and
  (= o1 (bvadd ((_ zero_extend 8) (to_rep
                                  (select memory (bvadd addr ((_ int2bv 64) 2))))) (bvmul ((_ zero_extend 8)
  (to_rep
  (select memory (bvadd (bvadd addr ((_ int2bv 64) 2)) ((_ int2bv 64) 1))))) ((_ int2bv 16) 256))))
  (bvuge o1 ((_ int2bv 16) 0)))))
...
;; H
  ...
  (and
  (= o (bvadd ((_ zero_extend 8) (to_rep (select memory addr))) (bvmul ((_ zero_extend 8)
  (to_rep (select memory (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 16) 256))))
  (bvuge o ((_ int2bv 16) 0)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 5, characters 0-0
  (not
  (= x86__readmem32__result4 (bvadd ((_ zero_extend 16) (readmem16 addr
