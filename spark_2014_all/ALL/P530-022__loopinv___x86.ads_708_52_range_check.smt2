...
(declare-const x86__signextend32to64__result (_ BitVec 64))
...
(declare-const x86__signextend32to64__result1 (_ BitVec 64))

(declare-const x86__signextend32to64__result2 (_ BitVec 64))

(declare-const x86__signextend32to64__result3 (_ BitVec 64))

(declare-const retval3 (_ BitVec 64))

(declare-const x86__signextend32to64__result4 (_ BitVec 64))

(declare-const retval4 (_ BitVec 64))

(declare-const x86__signextend32to64__result5 (_ BitVec 64))
