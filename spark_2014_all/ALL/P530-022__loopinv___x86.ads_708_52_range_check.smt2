...
(declare-fun x86__signextend32to64__result () (_ BitVec 64))
...
(declare-fun x86__signextend32to64__result1 () (_ BitVec 64))

(declare-fun x86__signextend32to64__result2 () (_ BitVec 64))

(declare-fun x86__signextend32to64__result3 () (_ BitVec 64))

(declare-fun retval3 () (_ BitVec 64))

(declare-fun x86__signextend32to64__result4 () (_ BitVec 64))

(declare-fun retval4 () (_ BitVec 64))

(declare-fun x86__signextend32to64__result5 () (_ BitVec 64))

(define-fun retval5 () t__ref1 (mk_t__ref1 retval))

;; H
  (assert
  (=> (bvugt val__ ((_ int2bv 32) 2147483647))
  (= (mk_t__ref1 result) retval5)))

;; H
  (assert
  (=> (bvugt val__ ((_ int2bv 32) 2147483647))
  (= retval1 (bvor ((_ int2bv 64) 18446744069414584320) ((_ zero_extend 32)
  val__)))))

;; H
  (assert
  (=> (not (bvugt val__ ((_ int2bv 32) 2147483647)))
  (= (mk_t__ref1 result1) retval5)))

;; H
  (assert
  (=> (not (bvugt val__ ((_ int2bv 32) 2147483647)))
  (= retval2 ((_ zero_extend 32) val__))))

;; H
  (assert
  (=> (not (bvugt val__ ((_ int2bv 32) 2147483647))) (= retval1 retval2)))

;; H
  (assert (= x86__signextend32to64__result1 x86__signextend32to64__result2))

;; H
  (assert (= x86__signextend32to64__result3 x86__signextend32to64__result1))

;; H
  (assert
  (= (mk_t__ref1 result2) (mk_t__ref1 x86__signextend32to64__result)))

;; H
  (assert (= x86__signextend32to64__result1 retval1))

;; H
  (assert
  (= (mk_t__ref1 x86__signextend32to64__result4) (mk_t__ref1
                                                 x86__signextend32to64__result2)))

;; H
  (assert (= retval1 retval3))

;; H
  (assert (= x86__signextend32to64__result5 x86__signextend32to64__result3))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  (not
  (bvule ((_ zero_extend 32) ((_ int2bv 32) 0)) (bvand x86__signextend32to64__result4 ((_ int2bv 64) 4294967295)))))
(check-sat)
(exit)
