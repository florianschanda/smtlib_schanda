...
(declare-fun r1__split_discrs () us_split_discrs)

(declare-fun r1__attr__tag () Int)
...
;; H
  (assert
  (and (= r1__attr__tag us_tag2)
  (= (to_rep (rec__membership_discr__root__c r1__split_discrs)) 1)))
...
;; WP_parameter_def
 ;; File "membership_discr.adb", line 1, characters 0-0
  (not (= 0 (to_rep (rec__membership_discr__root__c r1__split_discrs)))))
(check-sat)
