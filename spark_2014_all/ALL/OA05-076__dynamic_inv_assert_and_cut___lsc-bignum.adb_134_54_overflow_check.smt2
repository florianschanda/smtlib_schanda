...
;; H
  (assert (= o10 (num_of_boolean carry2)))
...
;; H
  (assert
  (and (= o6 (base Tuple0))
  (= o6 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert
  (= o5 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
        a_first o4)))

;; H
  (assert (= o12 (osubtract o5 o11)))
