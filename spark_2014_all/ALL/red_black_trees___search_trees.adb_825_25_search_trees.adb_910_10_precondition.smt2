...
(declare-fun o17 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= o17 (model__ (mk___rep2 f_1__split_fields3) o16))
  (and (dynamic_invariant6 o17 true false true)
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o17 o16))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o17 o16)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o16))
  (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select o17 (parent (mk___rep2 f_1__split_fields3) i1)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o17 i1))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o17 i1))) true))))))
  (and
  (forall ((i1 Int))
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1
     (select o17 (parent (mk___rep2 f_1__split_fields3) i1))))
     (position (mk___rep2 f_1__split_fields3) i1)
     (rec__tree_model__path_type__a (us_split_fields1 (select o17 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select o17 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o17 i1))) true)
  ...
  (=>
  (and
  (= (rec__tree_model__path_type__k (us_split_fields1 (select o17 j3))) true)
  (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o17 i1)))
     (rec__tree_model__path_type__a (us_split_fields1 (select o17 j3)))) true))
  (= j3 i1))))))))))))))
