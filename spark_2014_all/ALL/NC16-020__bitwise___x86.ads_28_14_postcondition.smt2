...
;; H
  (assert
  (= x86__ah__result1 ((_ extract 7 0) (bvurem (bvudiv (bvand rax ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= x86__ah__result4 ((_ extract 7 0) (bvurem (bvudiv (bvand rax ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)) ((_ int2bv 64) 256))))))
(check-sat)
(exit)
