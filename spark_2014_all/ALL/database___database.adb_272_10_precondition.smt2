...
(declare-fun dummy1 () name_len)

(declare-datatypes ()
((name_len__ref (mk_name_len__ref (name_len__content name_len)))))
(define-fun name_len__ref___projection ((a name_len__ref)) name_len (name_len__content
                                                                    a))

(declare-fun no_name () (Array Int character))
...
(declare-fun dummy2 () num_position)

(declare-datatypes ()
((num_position__ref
 (mk_num_position__ref (num_position__content num_position)))))
(define-fun num_position__ref___projection ((a num_position__ref)) num_position
  (num_position__content a))
...
;; range_axiom
  (assert
  (forall ((x num)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-fun no_id () (Array Int num))
...
(declare-fun dummy7 () ext_account_num)
...
;; range_axiom
  (assert
  (forall ((x ext_account_num)) (! (in_range6
...
(declare-fun dummy8 () account_num)
...
(declare-fun dummy11 () (Array Int num))
...
(declare-fun database__account_rec__owner_name__first__bit () Int)

(declare-fun database__account_rec__owner_name__last__bit () Int)

(declare-fun database__account_rec__owner_name__position () Int)
...
(declare-fun database__account_rec__owner_id__first__bit () Int)

(declare-fun database__account_rec__owner_id__last__bit () Int)

(declare-fun database__account_rec__owner_id__position () Int)
...
(declare-fun database__account_rec__account__first__bit () Int)

(declare-fun database__account_rec__account__last__bit () Int)

(declare-fun database__account_rec__account__position () Int)
...
(define-fun us_split_fields_Account2__projection ((a us_split_fields6)) ext_account_num
...
(declare-fun customer () (Array Int character))

(declare-fun attr__ATTRIBUTE_ADDRESS6 () Int)

(declare-fun id () (Array Int num))
...
(declare-fun no_account_rec () us_rep2)
...
;; no_account_rec__def_axiom
  (assert
  (= no_account_rec (mk___rep2
                    (mk___split_fields2 no_name no_id (of_rep4 0)))))
...
;; def_axiom
  ...
  (= (select (identity__no_name__aggregate_def temp___133) temp___134)
  (of_rep temp___133)))))
...
(define-fun dynamic_invariant5 ((temp___expr_168 Int)
  ...
  (temp___do_toplevel_167 Bool)) Bool (=>
                                      ...
                                      (<= 0 2)) (in_range2 temp___expr_168)))

(declare-fun identity__no_id__aggregate_def (Int Int Int) (Array Int num))

;; def_axiom
  (assert
  (forall ((temp___137 Int) (temp___138 Int) (temp___139 Int))
  (let ((temp___136 (identity__no_id__aggregate_def temp___137 temp___138
                    temp___139)))
  (and
  (and (= (select temp___136 0) (of_rep1 temp___137))
  (= (select temp___136 1) (of_rep1 temp___138)))
  (= (select temp___136 2) (of_rep1 temp___139))))))
...
(declare-fun accounts () (Array Int us_rep2))

(declare-fun accounts_balance () (Array Int us_rep3))

(declare-fun o () ext_account_num)

(declare-fun o1 () (Array Int character))

(declare-fun o2 () (Array Int num))
...
;; H
  ...
  (= (is_empty (balance account links accounts_balance)) true))))

(assert
;; WP_parameter_def
 ;; File "database.ads", line 26, characters 0-0
  (not (= (existing account links) true)))
(check-sat)
(exit)
