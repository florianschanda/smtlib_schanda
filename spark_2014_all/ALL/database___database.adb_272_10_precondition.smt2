...
(declare-datatypes ((name_len__ref 0))
(((mk_name_len__ref (name_len__content name_len)))))
...
(declare-datatypes ((num_position__ref 0))
...
(((mk_map__ref1 (map__content1 (Array Int num))))))
...
(declare-datatypes ((raw_amount__ref 0))
(((mk_raw_amount__ref (raw_amount__content raw_amount)))))
...
(declare-datatypes ((cur__ref 0)) (((mk_cur__ref (cur__content cur)))))
...
(declare-datatypes ((amount__ref 0))
(((mk_amount__ref (amount__content us_rep)))))
...
(((mk_account_num__ref (account_num__content account_num)))))
...
(((mk_account_link__ref (account_link__content us_rep1)))))
...
(declare-datatypes ((account_rec__ref 0))
(((mk_account_rec__ref (account_rec__content us_rep2)))))
(define-fun account_rec__ref___projection ((a account_rec__ref)) us_rep2
  (account_rec__content a))

(declare-datatypes ((map__ref3 0))
(((mk_map__ref3 (map__content3 (Array Int us_rep2))))))
...
(declare-datatypes ((account_balance__ref 0))
...
(declare-const temp___4021 (Array Int num))

(declare-const temp___4022 ext_account_num)
