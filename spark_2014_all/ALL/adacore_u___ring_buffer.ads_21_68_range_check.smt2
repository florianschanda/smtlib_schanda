...
;; H
  (assert (and (= o4 (length s2)) (and (in_range4 o4) (<= (+ 0 o4) 100))))

;; H
  (assert (= o5 (- o4 1)))

;; H
  (assert (and (= o6 (length s1)) (and (in_range4 o6) (<= (+ 0 o6) 100))))

;; H
  (assert (= result1 (ite (= o6 o5) true false)))

;; H
  (assert (=> (= result1 true) (and (= o3 (get s2 1)) (in_range5 o3))))

;; H
  (assert (=> (= result1 true) (= result (ite (= o3 e) true false))))
...
;; H
  (assert (and (= o2 (+ i 1)) (in_range1 (+ i 1))))
