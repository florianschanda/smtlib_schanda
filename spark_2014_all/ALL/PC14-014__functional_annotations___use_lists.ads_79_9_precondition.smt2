...
;; H
  (assert
  (and (= result (has_key o2 fst))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o2 k) true) (= (bool_eq1 k fst) true))) (= result true)))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o1 j) true)
  (=> (= (get1 o1 i) (get1 o1 j)) (= (bool_eq1 i j) true))))))))))

;; H
  (assert
  (and (= result1 (has_key o1 lst))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o1 k) true) (= (bool_eq1 k lst) true))) (= result1 true)))))
