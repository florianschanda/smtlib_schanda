...
(define-fun register_type__ref_156__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_110__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_110__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5663 us_t1)
  (temp___is_init_5660 Bool) (temp___skip_constant_5661 Bool)
  (temp___do_toplevel_5662 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5661 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5663)
                                       (last3 temp___expr_5663))
                                       (and (= (first3 temp___expr_5663) 1)
                                       (= (last3 temp___expr_5663) 1)))))
