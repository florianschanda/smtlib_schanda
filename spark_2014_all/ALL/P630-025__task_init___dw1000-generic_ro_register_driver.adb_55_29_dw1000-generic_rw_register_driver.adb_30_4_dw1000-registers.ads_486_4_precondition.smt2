...
(declare-datatypes ((fs_xtalt_type__ref 0))
(((mk_fs_xtalt_type__ref (fs_xtalt_type__content us_rep)))))
...
(define-fun register_type__ref___156__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___110__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___110__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5761 us_t1)
  (temp___is_init_5758 Bool) (temp___skip_constant_5759 Bool)
  (temp___do_toplevel_5760 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5759 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5761)
                                       (last3 temp___expr_5761))
                                       (and (= (first3 temp___expr_5761) 1)
                                       (= (last3 temp___expr_5761) 1)))))
