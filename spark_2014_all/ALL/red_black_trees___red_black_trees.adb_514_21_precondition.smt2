...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields16) i1) 0)
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields16) (parent
                                                                  ...
                                                                  i1))) 1))
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields16) i1)) 0))))))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields27) i1) 0)
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields27) (parent
                                                                  ...
                                                                  i1))) 1))
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields27) i1)) 0))))))))
...
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  ...
  (= (size
     (rec__red_black_trees__rbt__struct
     (us_split_fields__content4 t__split_fields34))) 0))))
(check-sat)
