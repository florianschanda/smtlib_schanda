...
(declare-fun o19 () (Array Int positive))
...
(declare-fun result4 () (Array Int positive))
...
;; H
  (assert (not (= j2 (to_rep2 (last (rt needle))))))
...
;; H
  (assert (= o19 (store bad_shift3 (to_rep1 (select (elts needle) j3))
  o18)))

;; H
  (assert (= result4 bad_shift3))

;; H
  (assert (= bad_shift4 o19))
...
;; H
  (assert (= (to_rep (select bad_shift4 c)) (+ (length needle) 1)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= c (to_rep1 (select (elts needle) k))))))
(check-sat)
(exit)
