...
;; H
  (assert
  (and (= temp___686 (keys (mk___rep r__split_discrs r__split_fields2)))
  (and
  (and
  (and
  (= (length3 temp___686) (length
  ...
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2))
     (get temp___686 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
...
;; H
  (assert
  (and (= o (iter_has_element temp___686 temp___685))
  (= (= o true) (and (<= 1 temp___685) (<= temp___685 (last temp___686))))))
