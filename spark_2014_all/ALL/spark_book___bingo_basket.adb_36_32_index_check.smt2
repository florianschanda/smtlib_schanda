...
(declare-datatypes ((bingo_number__ref 0))
...
(declare-datatypes ((callable_number__ref 0))
...
(declare-datatypes ((bingo_letter__ref 0))
...
(((mk_map__ref (map__content (Array Int callable_number))))))
