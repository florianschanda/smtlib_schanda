...
(declare-fun x86__r10l__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__r10l__result1 () (_ BitVec 8))

(declare-fun x86__r10l__result2 () (_ BitVec 8))

(declare-fun x86__r10l__result3 () (_ BitVec 8))

(declare-fun x86__r10l__result4 () (_ BitVec 8))

(declare-fun x86__r10l__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= x86__r10l__result1 ((_ extract 7 0) (bvand r10 ((_ int2bv 64) 255)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= x86__r10l__result4 ((_ extract 7 0) (bvand r10 ((_ int2bv 64) 255))))))
(check-sat)
(exit)
