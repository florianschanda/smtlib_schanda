...
;; H
  (assert
  (= o112 (select (rec__patience__state__preds
...
;; H
  (assert (= o115 (ite (<= (- 1) o110) true false)))

;; H
  (assert (= result27 (ite (= o115 true) o114 false)))

;; H
  (assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))

;; H
  (assert (=> (= result27 true) (= o105 i1)))
...
;; H
  (assert (=> (= result27 true) (= o107 (to_rep1 o106))))

;; H
  (assert (=> (= result27 true) (= result26 (ite (< o107 i1) true false))))
