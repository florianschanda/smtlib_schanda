...
;; H
  (assert
  (and (= o13 (last2 left))
  (and (dynamic_property1 first1 last1 o13)
  (= o13 (+ (- first 1) (length left))))))

;; H
  (assert (= result (ite (<= lst1 o13) true false)))

;; H
  (assert (= result true))

;; H
  (assert (=> (< offset 0) (and (= o11 first) (in_range1 first))))

;; H
  (assert
  (=> (< offset 0)
  (and (= o12 (- (- 2147483648) offset)) (in_range1
  (- (- 2147483648) offset)))))

;; H
  (assert (=> (< offset 0) (= result1 (ite (<= o12 o11) true false))))
...
;; H
  (assert (and (= o6 lst1) (in_range1 lst1)))

;; H
  (assert
  (and (= o3 (length right))
  (and (in_range3 o3) (<= (+ (- first 1) o3) last))))

;; H
  (assert (and (= o1 first) (in_range1 first)))
...
;; H
  (assert (= o10 (ite (<= offset o9) true false)))

;; H
  (assert (and (= o fst1) (in_range1 fst1)))
