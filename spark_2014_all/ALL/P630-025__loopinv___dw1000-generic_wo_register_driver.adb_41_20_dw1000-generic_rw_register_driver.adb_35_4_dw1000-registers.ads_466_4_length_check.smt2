...
(define-fun us_split_fields__ref___62__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___62__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-const dw1000__register_types__tc_pgdelay_type__tc_pgdelay__first__bit Int)

(declare-const dw1000__register_types__tc_pgdelay_type__tc_pgdelay__last__bit Int)

(declare-const dw1000__register_types__tc_pgdelay_type__tc_pgdelay__position Int)
...
(define-fun register_type__ref___145__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___103__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___103__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5547 us_t1)
  (temp___is_init_5544 Bool) (temp___skip_constant_5545 Bool)
  (temp___do_toplevel_5546 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5545 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5547)
                                       (last3 temp___expr_5547))
                                       (and (= (first3 temp___expr_5547) 1)
                                       (= (last3 temp___expr_5547) 1)))))
...
(define-fun target__ref___43__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___43__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_5563 us_t2)
  (temp___is_init_5560 Bool) (temp___skip_constant_5561 Bool)
  (temp___do_toplevel_5562 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5561 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_5563)
                                       (last5 temp___expr_5563))
                                       (and (= (first5 temp___expr_5563) 1)
                                       (= (last5 temp___expr_5563) 1)))))
...
(declare-const temp___8027 (Array Int bits_8))

(declare-const temp___80271 t2)

(define-fun temp___80272 () us_t2 (mk___t2 temp___8027 temp___80271))
...
;; H
  (assert
  (and (= temp___80272 (register_to_bytes reg)) (dynamic_invariant1
  temp___80272 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___80271)) (to_rep (last4 temp___80271)))
     (+ (- (to_rep (last4 temp___80271)) (to_rep (first4 temp___80271))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
