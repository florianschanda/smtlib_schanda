...
;; H
  ...
  (forall ((k7 Int))
  (=>
  (and (<= (to_rep2 (first (rt needle))) k7)
  (<= k7 (to_rep2 (last (rt needle)))))
  (not (= c (to_rep1 (select (elts needle) k7))))))
  (and
  (= (to_rep1
  ...
  (forall ((k7 Int))
  (=>
  (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k7)
  (<= k7 (to_rep2 (last (rt needle)))))
  (not (= (to_rep1 (select (elts needle) k7)) c))))))))))
...
;; H
  ...
  (=> (and (<= r58b1 k1) (<= k1 r59b1))
  (forall ((l Int))
  (=> (and (<= 1 l) (<= l k2)) (not (= (match_at needle haystack l) true))))))

;; H
  (assert
  (=> (and (<= r58b1 k1) (<= k1 r59b1))
  (and (=> (<= r58b1 r59b1) (dynamic_property3 r58b1 r59b1 k2))
  (and (<= r58b1 k2) (<= k2 r59b1)))))
...
;; H
  (assert
  (=> (not (and (<= r58b1 k1) (<= k1 r59b1))) (= k5 (mk_int__ref k1))))
  ...
  (<= k7 (- (+ i2 (to_rep
                  (select bad_shift (to_rep1
                                    (select (elts haystack) (+ i2 (length
                                                                  needle))))))) 1)))
  (not (= (match_at needle haystack k7) true)))))
...
;; H
  ...
  (=> (<= 1 2147483647) (in_range2 r52b2)))
  (=> (<= (- 2147483648) 2147483647) (in_range1 r53b2)))
  (=> (<= (- 2147483648) 2147483647) (in_range1 r58b2)))
  (=> (<= (- 2147483648) 2147483647) (in_range1 r59b2)))
  (=> (<= 1 2147483647) (in_range2 shift2))))
