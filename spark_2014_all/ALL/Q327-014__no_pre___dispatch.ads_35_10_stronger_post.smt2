...
(declare-fun dispatch__incr6__result () integer)
...
;; H
  (assert
  (ite (= (< (to_rep (rec__dispatch__root__f (us_split_fields1 x))) 2147483647) true)
  (= (to_rep dispatch__incr6__result) (+ (to_rep
                                         (rec__dispatch__root__f
                                         (us_split_fields1 x))) 1))
  (= (to_rep dispatch__incr6__result) 0)))
