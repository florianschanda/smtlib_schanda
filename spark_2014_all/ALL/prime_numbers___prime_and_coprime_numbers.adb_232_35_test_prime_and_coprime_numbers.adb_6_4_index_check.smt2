...
;; H
  (assert (and (= o6 (+ index_22 1)) (in_range2 (+ index_22 1))))

;; H
  (assert (= o7 (ite (<= o6 v) true false)))

;; H
  (assert
  (= result8 (ite (= o7 true) (ite (<= v index_33) true false) false)))

;; H
  (assert
  (=> (= result8 true) (= o8 (ite (not (= (mod2 v index_22) 0)) true false))))

;; H
  (assert (=> (not (= result8 true)) (= o8 (of_int1 1))))
