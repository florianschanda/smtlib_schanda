...
(define-fun dynamic_invariant ((temp___expr_222 Int)
  ...
  (temp___do_toplevel_221 Bool)) Bool (=>
                                      ...
                                      (<= 1 10)) (in_range2 temp___expr_222)))
...
(define-fun dynamic_invariant1 ((temp___expr_234 Int)
  ...
  (temp___do_toplevel_233 Bool)) Bool (=>
                                      ...
                                      (<= 0 10)) (in_range3 temp___expr_234)))
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     (and (<= (+ 0 result) 10) (dynamic_invariant2 result true false true))) :pattern (
  (length container)) )))
...
;; H
  (assert (and (= o (length right)) (and (in_range4 o) (<= (+ 0 o) 10))))
