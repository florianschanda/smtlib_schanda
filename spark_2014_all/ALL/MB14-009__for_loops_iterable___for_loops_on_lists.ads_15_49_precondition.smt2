...
(define-fun default_initial_assumption ((temp___expr_227 us_rep2)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant3 (length2 container)
...
(assert
;; WP_parameter_def
 ;; File "for_loops_on_lists.ads", line 14, characters 0-0
  (not true))
(check-sat)
(exit)
