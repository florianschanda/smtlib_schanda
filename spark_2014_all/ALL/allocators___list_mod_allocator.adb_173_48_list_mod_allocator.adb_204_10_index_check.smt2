...
;; H
  (assert
  (and (= o25 (model__ data first_available))
  (= (model_is_well_formed o25 data first_available) true)))
...
;; H
  (assert
  (and (= o24 (model__ data1 first_available1))
  (= (model_is_well_formed o24 data1 first_available1) true)))
...
;; H
  (assert (and (= temp___317 (get c98b i2)) (in_range6 temp___317)))
