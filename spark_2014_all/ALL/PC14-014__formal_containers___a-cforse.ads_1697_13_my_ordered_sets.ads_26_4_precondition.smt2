...
(define-fun equivalent_elements ((left us_rep1)
  (right us_rep1)) Bool (and (not (my_lt left right)) (not (my_lt right left))))
...
(define-fun default_initial_assumption ((temp___expr_559 us_rep2)
...
(define-fun get_f ((x us_rep1)) Int (to_rep2
                                    (rec__my_ordered_sets__my_rec__f
                                    (us_split_fields3 x))))
...
(define-fun e_is_find ((container1 us_rep3) (item us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_592 us_rep3)
...
;; find__post_axiom
  ...
  (! (let ((result (find container1 item)))
     ...
     (dynamic_invariant4 result true false true))) :pattern ((find container1
                                                             item)) ))))
...
(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 1750, characters 0-0
  (not true))
(check-sat)
(exit)
