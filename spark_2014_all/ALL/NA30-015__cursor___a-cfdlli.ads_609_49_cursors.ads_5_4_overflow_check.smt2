...
(declare-const temp___411 count_type)
...
;; H
  (assert (= temp___411 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___411)) no_element))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 55, characters 0-0
  (not (in_range
  (- (to_rep (rec__cursors__l__list__capacity container__split_discrs))
  count))))
(check-sat)
(exit)
