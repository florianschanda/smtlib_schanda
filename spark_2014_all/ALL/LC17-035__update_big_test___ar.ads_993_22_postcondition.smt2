...
(declare-fun result4 () et4)

(declare-fun r__split_fields5 () et3)

(declare-fun r__split_fields6 () et1)

(declare-fun r__split_fields7 () et2)

(declare-fun r__split_fields8 () enum1ta)

(declare-fun r__split_fields9 () et4)

(declare-fun result5 () et3)

(declare-fun result6 () et1)

(declare-fun result7 () et2)

(declare-fun result8 () enum1ta)

(declare-fun result9 () et4)

(declare-fun r__split_fields10 () us_split_fields4)

(declare-fun r__split_fields11 () us_split_fields__ref2)

(declare-fun r__split_fields12 () us_split_fields4)
...
;; H
  (assert
  (= a (mk___rep1
       (mk___split_fields1 r__split_fields5
...
;; H
  (assert
  (= r__split_fields10 (mk___split_fields2
                       (mk___rep1
                       (mk___split_fields1 r__split_fields5 b
                       r__split_fields8)) r__split_fields9)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 986, characters 0-0
  (not
  (= (bool_eq2 (mk___rep2 (us_split_fields__content2 r__split_fields11))
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (let ((usq_ (us_split_fields3 a)))
     (mk___split_fields1 (rec__ar__rec2t__f2 usq_) b
