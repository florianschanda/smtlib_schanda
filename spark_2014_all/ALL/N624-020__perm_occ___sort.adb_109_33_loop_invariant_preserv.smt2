...
(declare-fun previous4 () (Array Int natural))
...
;; H
  ...
  (forall ((i Int))
  (=> (and (<= (to_rep1 (first o11)) i) (<= i (to_rep1 (last o11))))
  (<= (to_rep (select o10 o12)) (to_rep (select o10 i)))))))))
...
;; H
  (assert
  (=> (not (= smallest3 current3))
  (and (= o16 current3) (in_range3 current3))))
...
;; H
  ...
  (= (is_perm
     ...
     (mk___t values4 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)
  (= (to_rep (select values4 o16)) (to_rep (select values3 smallest3))))
  (= (to_rep (select values4 smallest3)) (to_rep (select values3 o16))))
  (forall ((z Int))
  (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last)))
  (=> (and (not (= z o16)) (not (= z smallest3)))
  (= (to_rep (select values4 z)) (to_rep (select values3 z)))))))))
