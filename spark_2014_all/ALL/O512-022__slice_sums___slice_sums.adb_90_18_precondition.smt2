...
(declare-const o7 extended_index)

(declare-const o8 index)

(declare-const o9 us_split_fields)

(declare-const o10 slice_bounds)
...
;; H
  ...
  (<= hi_index1 (- current_hi2 1)))
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep1 lo_index) (of_rep2 hi_index1)))) max_sum2))))))
...
;; H
  (assert
  (forall ((hi_index1 Int))
  (=> (and (<= current_lo2 hi_index1) (<= hi_index1 (- current_hi2 1)))
  (<= 0 (sum__logic x
        (mk_slice_bounds
        (mk___split_fields (of_rep1 current_lo2) (of_rep2 hi_index1))))))))
...
;; H
  (assert (and (= o5 (- current_hi2 1)) (in_range1 (- current_hi2 1))))

;; H
  (assert (= o6 (ite (<= hi_index o5) true false)))

;; H
  (assert (= result5 (ite (<= current_lo2 hi_index) o6 false)))

;; H
  (assert (= result5 true))

;; H
  (assert (= (to_rep2 o7) hi_index))

;; H
  (assert (= (to_rep1 o8) current_lo2))

;; H
  (assert (= o9 (mk___split_fields o8 o7)))

;; H
  (assert (= o10 (mk_slice_bounds o9)))
...
;; WP_parameter_def
 ;; File "sums.ads", line 12, characters 0-0
  (not
  (or
  (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o10))) (to_rep1
                                                                    (rec__sums__slice_bounds__lo
                                                                    (us_split_fields1
                                                                    o10))))
  (and
  ...
  (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o10)))
  (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
