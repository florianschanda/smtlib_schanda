...
(declare-fun block__first () integer)

(declare-fun block__last () integer)
...
;; H
  ...
  (= o1 (+ (- (to_rep block__last) (to_rep block__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep block__first) (to_rep block__last))) (= o1 0)))
