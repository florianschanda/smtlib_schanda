...
;; H
  ...
  (= (bool_eq1 sorted_lists__my_insert__current__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
...
;; H
  (assert (=> (= result1 true) (= temp___472 current__split_fields1)))

;; H
  (assert
  (=> (= result1 true)
  (or
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (first
     (mk___rep container__split_discrs
...
;; H
  (assert
  (=> (= result1 true)
  (ite (= (ite (= (bool_eq1 (mk___rep1 current__split_fields11) no_element) false) (=
          (get1
          (positions
          (mk___rep container__split_discrs
          (mk___split_fields container__split_fields)))
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields10) no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
...
;; H
  (assert (= result6 (ite (= o10 new_item) true false)))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o3 j) true)
  (=> (= (get1 o3 i1) (get1 o3 j)) (= (bool_eq1 i1 j) true))))))))))
...
;; H
  (assert (= result7 (ite (<= 1 i) o6 false)))
...
;; H
  (assert (and (= o9 (get o8 i)) (in_range5 o9)))
