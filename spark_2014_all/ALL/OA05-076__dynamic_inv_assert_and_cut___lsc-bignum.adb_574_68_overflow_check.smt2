...
;; H
  (assert (= o45 (ite (<= j3 o44) true false)))

;; H
  (assert (= o40 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o41 (oexpon o40 j3)))

;; H
  (assert (= o35 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o34 (from_integer j3)))
...
;; H
  (assert (and (= o21 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert (= o19 (from_word32 w2)))

;; H
  (assert (= o26 (omultiply o19 o25)))
...
;; H
  (assert
  (and (= o14 (base Tuple0))
  (= o14 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
