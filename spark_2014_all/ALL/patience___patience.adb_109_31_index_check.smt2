...
(declare-fun temp___692 () (Array Int cardindex))

(declare-fun o118 () Int)

(declare-fun temp___694 () (Array Int cardindex))

(declare-fun o119 () Int)

(declare-fun o120 () cardindex)
...
;; H
  ...
  (<= 1 (to_rep1
        (select (rec__patience__state__stacksizes
                (us_split_fields__content s__split_fields20)) i14))))))
...
;; H
  ...
  (<= (to_rep1
      (select (rec__patience__state__stacksizes
              (us_split_fields__content s__split_fields20)) i14)) (to_rep1
                                                                  (rec__patience__state__numelts
                                                                  (us_split_fields__content
                                                                  s__split_fields20))))
  (forall ((j1 Int))
  ...
  (<= j1 (- (to_rep1
            (select (rec__patience__state__stacksizes
                    (us_split_fields__content s__split_fields20)) i14)) 1)))
  (and
  (<= 0 (to_rep1
        (select (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) i14) j1)))
  (< (to_rep1
     (select (select (rec__patience__state__stacks
                     (us_split_fields__content s__split_fields20)) i14) j1))
  (to_rep1
  ...
  (= (to_rep1
     (select (select (rec__patience__state__stacks
                     (us_split_fields__content s__split_fields20)) (to_rep1
                                                                   ...
                                                                   (rec__patience__state__posstack
                                                                   (us_split_fields__content
                                                                   s__split_fields20)) i14)))
     (to_rep1
     (select (rec__patience__state__posheight
             (us_split_fields__content s__split_fields20)) i14)))) i14))))))
...
;; H
  ...
  (<= ip (- (to_rep1
            (select (rec__patience__state__stacksizes
                    (us_split_fields__content s__split_fields20)) ist)) 1)))
  (and
  (= ist (to_rep1
         (select (rec__patience__state__posstack
                 (us_split_fields__content s__split_fields20)) (to_rep1
...
;; H
  (assert
  (= o112 (select (rec__patience__state__stacksizes
                  (us_split_fields__content s__split_fields20)) o111)))

;; H
  (assert (= o113 (to_rep1 o112)))

;; H
  (assert (= o114 (- o113 1)))

;; H
  (assert (= o115 (ite (<= k o114) true false)))

;; H
  (assert (and (= o110 (+ j 1)) (in_range1 (+ j 1))))

;; H
  (assert (= o116 (ite (<= o110 k) true false)))

;; H
  (assert (= result25 (ite (= o116 true) o115 false)))
...
;; H
  (assert
  (= temp___694 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20))
  o118)))
...
;; H
  (assert (= o120 (select temp___694 o119)))

;; H
  (assert (= o121 (to_rep1 o120)))
...
;; H
  (assert
  (= temp___692 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20))
  o117)))
