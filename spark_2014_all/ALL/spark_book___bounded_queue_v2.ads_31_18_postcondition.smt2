...
(declare-const temp___280 positive)

(declare-const temp___2801 natural)

(declare-const temp___2802 positive)

(declare-const temp___2803 positive)

(declare-const temp___2804 (Array Int element_type))

(declare-const temp___2805 t)
...
(declare-const temp___2841 natural)

(declare-const temp___2842 positive)

(declare-const temp___2843 positive)

(declare-const temp___2844 (Array Int element_type))

(declare-const temp___2845 t)
...
(declare-const temp___286 positive)

(declare-const temp___2861 natural)

(declare-const temp___2862 positive)

(declare-const temp___2863 positive)

(declare-const temp___2864 (Array Int element_type))
...
;; H
  (assert (= queue__split_discrs (mk___split_discrs temp___286)))

;; H
  (assert (= temp___2861 o20))

;; H
  (assert (= temp___2862 o21))

;; H
  (assert (= temp___2863 o22))

;; H
  (assert (= temp___2864 o23))

;; H
  (assert (= temp___2865 o24))
...
;; H
  (assert
  (= queue__split_fields7 (mk___split_fields temp___2861 temp___2862
                          temp___2863 (mk___t temp___2864 temp___2865))))
