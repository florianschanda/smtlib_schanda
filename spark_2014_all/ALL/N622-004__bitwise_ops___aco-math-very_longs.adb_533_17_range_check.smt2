...
(declare-fun aco__math__very_longs__divide__full_left_shift__result__fields () us_split_fields)
...
(declare-fun aco__math__very_longs__divide__left_shift__number__fields () us_split_fields)
...
;; H
  ...
  aco__math__very_longs__divide__full_left_shift__result__fields) true true
  true))
...
;; H
  ...
  (= u__split_fields2 (us_split_fields3
                      (of_base
                      (mk___rep u__split_discrs
                      aco__math__very_longs__divide__full_left_shift__result__fields)))))
...
;; H
  ...
  aco__math__very_longs__divide__left_shift__number__fields) true true true))
...
;; H
  ...
  (= v__split_fields3 (us_split_fields5
                      (of_base1
                      (mk___rep v__split_discrs
                      aco__math__very_longs__divide__left_shift__number__fields)))))
...
;; H
  (assert
  (and
  (and (=> (<= 1 2147483647) (in_range2 j2)) (dynamic_invariant2
  (mk___rep quotient__split_discrs quotient__split_fields3) false true true))
  (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) false true
  true)))

;; H
  (assert (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields4)
  true true true))

;; H
  (assert
  (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields5) true
  true true) (dynamic_invariant2
