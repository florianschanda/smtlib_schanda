...
;; range_axiom
  (assert
  (forall ((x bits_5)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
;; range_axiom
  (assert
  (forall ((x bits_6)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)) )))
...
(define-fun to_int6 ((x bits_6)) Int (bv2nat (to_rep4 x)))

;; range_int_axiom
  (assert
  (forall ((x bits_6)) (! (in_range_int2
...
(define-fun in_range_int3 ((x Int)) Bool (and (<= 0 x) (<= x 511)))
...
(declare-fun to_rep5 (bits_9) (_ BitVec 16))

(declare-fun of_rep5 ((_ BitVec 16)) bits_9)
...
;; range_axiom
  (assert
  (forall ((x bits_9)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(define-fun to_int7 ((x bits_9)) Int (bv2nat (to_rep5 x)))

;; range_int_axiom
  (assert
  (forall ((x bits_9)) (! (in_range_int3
  (to_int7 x)) :pattern ((to_int7 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__agc_stat1_type__edg1 bits_5)(rec__dw1000__register_types__agc_stat1_type__edv2 bits_9)(rec__dw1000__register_types__agc_stat1_type__reserved_1 bits_6)(rec__dw1000__register_types__agc_stat1_type__reserved_2 bits_4)))))
(define-fun us_split_fields_EDG1__projection ((a us_split_fields)) bits_5
  (rec__dw1000__register_types__agc_stat1_type__edg1 a))

(define-fun us_split_fields_EDV2__projection ((a us_split_fields)) bits_9
  (rec__dw1000__register_types__agc_stat1_type__edv2 a))

(define-fun us_split_fields_Reserved_1__7__projection ((a us_split_fields)) bits_6
  (rec__dw1000__register_types__agc_stat1_type__reserved_1 a))

(define-fun us_split_fields_Reserved_2__7__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__agc_stat1_type__reserved_2 a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (and
                        (= (to_rep3
                           (rec__dw1000__register_types__agc_stat1_type__edg1
                           (us_split_fields1 a))) (to_rep3
                                                  (rec__dw1000__register_types__agc_stat1_type__edg1
                                                  (us_split_fields1 b))))
                        (= (to_rep5
                           (rec__dw1000__register_types__agc_stat1_type__edv2
                           (us_split_fields1 a))) (to_rep5
                                                  (rec__dw1000__register_types__agc_stat1_type__edv2
                                                  (us_split_fields1 b)))))
                        (= (to_rep4
                           (rec__dw1000__register_types__agc_stat1_type__reserved_1
                           (us_split_fields1 a))) (to_rep4
                                                  (rec__dw1000__register_types__agc_stat1_type__reserved_1
                                                  (us_split_fields1 b)))))
                        (= (to_rep2
                           (rec__dw1000__register_types__agc_stat1_type__reserved_2
...
(declare-const dw1000__register_types__agc_stat1_type__edg1__first__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__edg1__last__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__edg1__position Int)

;; dw1000__register_types__agc_stat1_type__edg1__first__bit_axiom
  (assert (<= 0 dw1000__register_types__agc_stat1_type__edg1__first__bit))

;; dw1000__register_types__agc_stat1_type__edg1__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_stat1_type__edg1__first__bit dw1000__register_types__agc_stat1_type__edg1__last__bit))

;; dw1000__register_types__agc_stat1_type__edg1__position_axiom
  (assert (<= 0 dw1000__register_types__agc_stat1_type__edg1__position))

(declare-const dw1000__register_types__agc_stat1_type__edv2__first__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__edv2__last__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__edv2__position Int)

;; dw1000__register_types__agc_stat1_type__edv2__first__bit_axiom
  (assert (<= 0 dw1000__register_types__agc_stat1_type__edv2__first__bit))

;; dw1000__register_types__agc_stat1_type__edv2__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_stat1_type__edv2__first__bit dw1000__register_types__agc_stat1_type__edv2__last__bit))

;; dw1000__register_types__agc_stat1_type__edv2__position_axiom
  (assert (<= 0 dw1000__register_types__agc_stat1_type__edv2__position))

(declare-const dw1000__register_types__agc_stat1_type__reserved_1__first__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__reserved_1__last__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__reserved_1__position Int)

;; dw1000__register_types__agc_stat1_type__reserved_1__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__agc_stat1_type__reserved_1__first__bit))

;; dw1000__register_types__agc_stat1_type__reserved_1__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_stat1_type__reserved_1__first__bit dw1000__register_types__agc_stat1_type__reserved_1__last__bit))

;; dw1000__register_types__agc_stat1_type__reserved_1__position_axiom
  (assert
  (<= 0 dw1000__register_types__agc_stat1_type__reserved_1__position))

(declare-const dw1000__register_types__agc_stat1_type__reserved_2__first__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__reserved_2__last__bit Int)

(declare-const dw1000__register_types__agc_stat1_type__reserved_2__position Int)

;; dw1000__register_types__agc_stat1_type__reserved_2__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__agc_stat1_type__reserved_2__first__bit))

;; dw1000__register_types__agc_stat1_type__reserved_2__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_stat1_type__reserved_2__first__bit dw1000__register_types__agc_stat1_type__reserved_2__last__bit))

;; dw1000__register_types__agc_stat1_type__reserved_2__position_axiom
  (assert
  (<= 0 dw1000__register_types__agc_stat1_type__reserved_2__position))
...
(declare-datatypes ()
((agc_stat1_type__ref
 (mk_agc_stat1_type__ref (agc_stat1_type__content us_rep)))))
(define-fun agc_stat1_type__ref___projection ((a agc_stat1_type__ref)) us_rep
  (agc_stat1_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___68__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___49__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___49__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3651 us_t1)
  (temp___is_init_3648 Bool) (temp___skip_constant_3649 Bool)
  (temp___do_toplevel_3650 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3649 true))
                                       (and (dynamic_property2 1 3
                                       (first3 temp___expr_3651)
                                       (last3 temp___expr_3651))
                                       (and (= (first3 temp___expr_3651) 1)
                                       (= (last3 temp___expr_3651) 3)))))
...
;; H
  (assert
  (and (dynamic_property2 1 3 (to_rep reg_bytes__first)
  (to_rep reg_bytes__last))
  (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 3))))
