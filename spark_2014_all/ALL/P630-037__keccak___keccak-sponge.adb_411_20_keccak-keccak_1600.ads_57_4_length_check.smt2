...
(declare-const o48 (Array Int byte))
...
;; H
  ...
  (=> (<= r140s r141s)
  (and
  (and (<= (to_rep digest__first) r140s) (<= r140s (to_rep digest__last)))
  (and (<= (to_rep digest__first) r141s) (<= r141s (to_rep digest__last)))))))
...
;; H
  ...
  (ite (<= (to_rep (first6 temp___9201)) (to_rep (last6 temp___9201)))
  (+ (- (to_rep (last6 temp___9201)) (to_rep (first6 temp___9201))) 1) 0))))
...
;; H
  ...
  (= (select o28 temp___922) (select temp___921 temp___922))
  (= (select o28 temp___922) (select digest1 temp___922))))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
       ctx__split_fields10)))
  (= o32 (mk___split_fields
         (rec__keccak__keccak_1600__sponge__context__state
         ctx__split_fields10)
         (rec__keccak__keccak_1600__sponge__context__block
         ctx__split_fields10)
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
         ctx__split_fields10) o31
         (rec__keccak__keccak_1600__sponge__context__rate
         ctx__split_fields10)
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields10)))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
       ctx__split_fields10)))
  (and (= o33 (+ offset1 bytes_to_squeeze3)) (in_range1
  (+ offset1 bytes_to_squeeze3)))))
...
;; H
  ...
  (< 0 (to_rep3
       (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
       ctx__split_fields10)))
  (and (= o34 (- remaining1 bytes_to_squeeze3)) (in_range1
...
;; H
  ...
  (= (select o39 temp___932) (select (slide
                                     ...
                                     keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl2))))))
                                     0) temp___932))
  (= (select o39 temp___932) (select (rec__keccak__keccak_1600__sponge__context__block
...
;; H
  ...
  (to_rep3
  (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
  ctx__split_fields11))) (= temp___934 (mk___rep o40)))))
...
;; H
  ...
  (to_rep3
  (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
  ctx__split_fields11))) (= (to_rep3 o41) 0))))
...
;; H
  ...
  (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
  ctx__split_fields11)))
  (= o42 (mk___split_fields
         (rec__keccak__keccak_1600__sponge__context__state
         ctx__split_fields13)
         (rec__keccak__keccak_1600__sponge__context__block
         ctx__split_fields13)
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
         ctx__split_fields13) o41
         (rec__keccak__keccak_1600__sponge__context__rate
         ctx__split_fields13)
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields13))))))
...
;; H
  ...
  (to_rep3
  (rec__keccak__keccak_1600__sponge__context__bytes_squeezed
  ctx__split_fields11))) (= temp___936 (mk___rep o42)))))
...
;; H
  ...
  (<= (to_rep4
      (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))
  remaining2) (= o45 (+ (to_rep digest__first) o44))))
...
;; H
  ...
  (<= (to_rep4
      (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))
  remaining2)
  (and (= keccak__keccak_1600__sponge__squeeze__L_3__R152s__assume o45)
  (in_range1 o45))))
...
;; H
  ...
  (<= (to_rep4
      (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))
  remaining2)
  (= o46 (rec__keccak__keccak_1600__sponge__context__block
         ctx__split_fields15))))
...
;; H
  ...
  (<= (to_rep4
      (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))
  remaining2) (= temp___939 (mk___t7 o46 (mk7 0 r155s)))))
...
;; H
  ...
  (=> (<= r151s r152s)
  (and
  (and (<= (to_rep digest__first) r151s) (<= r151s (to_rep digest__last)))
  (and (<= (to_rep digest__first) r152s) (<= r152s (to_rep digest__last)))))))
...
;; H
  ...
  (<= (to_rep4
      (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))
  remaining2) (= temp___941 (mk___t6 o47 (mk6 r151s r152s)))))
...
;; H
  ...
  (= (ite (<= (to_rep (first12 (rt6 temp___940))) (to_rep
     ...
     0) (ite (<= (to_rep (first12 (rt6 temp___941))) (to_rep
                                                     (last12
                                                     (rt6 temp___941))))
        (+ (- (to_rep (last12 (rt6 temp___941))) (to_rep
                                                 (first12 (rt6 temp___941)))) 1)
        0))))
...
;; H
  ...
  (= (select o48 temp___943) (select (elts6 temp___942) temp___943))
  (= (select o48 temp___943) (select digest3 temp___943))))))
...
;; H
  ...
  (<= (to_rep4
      (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))
  remaining2)
  (= o49 (rec__keccak__keccak_1600__sponge__context__block
         ctx__split_fields16))))
...
;; H
  ...
  (= (select o52 temp___951) (select (slide
                                     ...
                                     keccak__keccak_1600__keccakf_1600_lanes__extract_bytes__data__compl3))))))
                                     0) temp___951))
  (= (select o52 temp___951) (select (rec__keccak__keccak_1600__sponge__context__block
...
;; H
  ...
  (<= (to_rep4
      (rec__keccak__keccak_1600__sponge__context__rate ctx__split_fields14))
  remaining2) (= temp___953 (mk___rep o53))))
...
;; H
  (assert
  (and (= o56 (+ (int__content offset7) (int__content remaining7)))
...
;; H
  (assert
  (and (= keccak__keccak_1600__sponge__squeeze__R162s__assume o58) (in_range1
  o58)))
...
;; H
  (assert
  (= o59 (rec__keccak__keccak_1600__sponge__context__block
         (us_split_fields__content ctx__split_fields20))))

;; H
  (assert (= temp___965 (mk___t10 o59 (mk10 0 r165s))))
