...
(declare-fun temp___177 () status)

(declare-fun temp___1771 () natural)

(declare-fun temp___1772 () natural)

(declare-fun temp___1773 () Bool)

(declare-fun temp___1774 () Bool)
...
;; WP_parameter_def
 ;; File "definite.adb", line 48, characters 0-0
  (not (= temp___177 x__split_discrs)))
(check-sat)
(exit)
