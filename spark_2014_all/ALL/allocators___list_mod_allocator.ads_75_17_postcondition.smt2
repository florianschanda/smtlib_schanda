...
(declare-const unseen10 set__ref)

(declare-const r11 int__ref)

(declare-const avail5 us_rep1)

(declare-const unseen11 us_rep2)

(declare-const r12 Int)

(declare-const avail6 sequence__ref)

(declare-const unseen12 set__ref)

(declare-const r13 int__ref)

(declare-const avail7 us_rep1)

(declare-const unseen13 us_rep2)
...
(declare-const avail8 sequence__ref)

(declare-const alloc8 set__ref)

(declare-const unseen14 set__ref)
...
(declare-const avail9 us_rep1)

(declare-const alloc9 us_rep2)

(declare-const unseen15 us_rep2)
...
(declare-const result11 us_rep1)

(declare-const result12 us_rep2)
