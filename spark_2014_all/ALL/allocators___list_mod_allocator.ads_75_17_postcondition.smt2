...
(declare-fun list_mod_allocator__m__model__result () us_rep1)

(declare-fun list_mod_allocator__m__model__result1 () us_rep2)
...
(declare-fun temp___294 () us_rep2)

(declare-fun temp___293 () us_rep1)
...
(declare-fun temp___2992 () Int)

(declare-fun result9 () Bool)

(declare-fun avail4 () sequence__ref)

(declare-fun unseen10 () set__ref)

(declare-fun r11 () int__ref)

(declare-fun avail5 () us_rep1)

(declare-fun unseen11 () us_rep2)

(declare-fun r12 () Int)

(declare-fun avail6 () sequence__ref)

(declare-fun unseen12 () set__ref)

(declare-fun r13 () int__ref)

(declare-fun avail7 () us_rep1)

(declare-fun unseen13 () us_rep2)

(declare-fun r14 () Int)

(declare-fun result10 () t__ref)

(declare-fun list_mod_allocator__m__model__result2 () us_rep3)

(declare-fun list_mod_allocator__m__model__result3 () t__ref)

(declare-fun list_mod_allocator__m__model__result4 () us_rep3)

(declare-fun avail8 () sequence__ref)

(declare-fun alloc8 () set__ref)

(declare-fun unseen14 () set__ref)

(declare-fun r15 () int__ref)

(declare-fun r16 () int__ref)

(declare-fun list_mod_allocator__m__model__result5 () t__ref)

(declare-fun avail9 () us_rep1)

(declare-fun alloc9 () us_rep2)

(declare-fun unseen15 () us_rep2)

(declare-fun r17 () Int)

(declare-fun r18 () Int)

(declare-fun list_mod_allocator__m__model__result6 () us_rep3)

(define-fun avail10 () sequence__ref (mk_sequence__ref avail))

(declare-fun result11 () us_rep1)

(declare-fun result12 () us_rep2)
...
;; H
  (assert (=> (= result4 true) (= temp___295 r8)))

;; H
  (assert (=> (= result4 true) (= temp___294 (set__content unseen6))))

;; H
  (assert (=> (= result4 true) (= temp___293 avail)))

;; H
  (assert (=> (= result4 true) (= 0 temp___299)))
...
;; H
  (assert (=> (= result4 true) (= result5 unseen6)))

;; H
  (assert (=> (= result4 true) (= unseen8 o4)))
...
;; H
  (assert (=> (= result4 true) (= result6 avail10)))

;; H
  (assert (=> (= result4 true) (= avail2 o5)))

;; H
  (assert (=> (= result4 true) (and (<= 1 r8) (<= r8 10000))))

;; H
  (assert (=> (= result4 true) (= o6 r8)))

;; H
  (assert
  (=> (= result4 true)
  (= (mk___rep (mk___split_fields o7 o8)) (select data o6))))
...
;; H
  (assert (=> (= result4 true) (= o11 o10)))

;; H
  (assert (=> (= result4 true) (= o12 (to_rep o11))))

;; H
  (assert (=> (= result4 true) (= result7 (mk_int__ref r8))))

;; H
  (assert (=> (= result4 true) (= r9 o12)))

;; H
  (assert (=> (= result4 true) (<= (length1 unseen9) 10000)))

;; H
  (assert
  (=> (= result4 true) (<= (length avail3) (- 10000 (length1 unseen9)))))
...
;; H
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e)))) 0)
  (not (= (contains1 avail3 e) true))) (= (contains unseen9 e) true))))))

;; H
  (assert
  (=> (= result4 true)
  (and (< 0 (length avail3)) (= (get avail3 1) first_available))))

;; H
  (assert
  (=> (= result4 true)
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length avail3))) (in_range3 (get avail3 j))))))
...
;; H
  ...
  (= r10 (to_rep
         (rec__list_mod_allocator__cell__next
         (us_split_fields1 (select data (get avail3 (length avail3)))))))))

;; H
  (assert
  (=> (= result4 true)
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (- (length avail3) 1)))
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1 (select data (get avail3 j))))) (get avail3 (+ j 1)))))))

;; H
  (assert
  (=> (= result4 true)
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (length avail3)))
  (= (get avail3 j) (to_rep
                    (rec__list_mod_allocator__cell__next
                    (us_split_fields1 (select data (get avail3 (- j 1)))))))))))

;; H
  (assert
  (=> (= result4 true)
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length avail3)))
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (length avail3)))
  (=> (= (get avail3 j) (get avail3 k)) (= j k))))))))
...
;; H
  (assert (=> (= result4 true) (=> (<= 0 10000) (in_range2 r10))))

;; H
  (assert (=> (= result4 true) (= result8 (mk_int__ref temp___2991))))

;; H
  (assert (=> (= result4 true) (= temp___2992 (length avail3))))

;; H
  (assert
  (=> (= result4 true)
  (and (= o13 (contains1 avail3 r10))
  (= (= o13 true)
  (exists ((i Int))
  (and (and (<= 1 i) (<= i (length avail3))) (= (get avail3 i) r10)))))))

;; H
  (assert (=> (= result4 true) (= o14 (ite (not (= o13 true)) true false))))

;; H
  (assert (=> (= result4 true) (= o15 (ite (not (= r10 0)) o14 false))))

;; H
  (assert
  (=> (= result4 true) (= result9 (ite (not (= o15 true)) true false))))

;; H
  (assert (=> (= result4 true) (= result9 true)))

;; H
  (assert (=> (= result4 true) (= r11 (mk_int__ref r10))))

;; H
  (assert (=> (= result4 true) (= unseen10 (mk_set__ref unseen9))))

;; H
  (assert (=> (= result4 true) (= avail4 (mk_sequence__ref avail3))))

;; H
  (assert (=> (= result4 true) (= r12 r10)))

;; H
  (assert (=> (= result4 true) (= unseen11 unseen9)))

;; H
  (assert (=> (= result4 true) (= avail5 avail3)))

;; H
  (assert (=> (= result4 true) (= r13 r11)))

;; H
  (assert (=> (= result4 true) (= unseen12 unseen10)))

;; H
  (assert (=> (= result4 true) (= avail6 avail4)))

;; H
  (assert (=> (= result4 true) (= r14 r12)))

;; H
  (assert (=> (= result4 true) (= unseen13 unseen11)))

;; H
  (assert (=> (= result4 true) (= avail7 avail5)))

;; H
  (assert (=> (not (= result4 true)) (= r13 (mk_int__ref r8))))

;; H
  (assert (=> (not (= result4 true)) (= unseen12 unseen6)))

;; H
  (assert (=> (not (= result4 true)) (= avail6 avail10)))

;; H
  (assert (=> (not (= result4 true)) (= r14 r8)))

;; H
  (assert (=> (not (= result4 true)) (= unseen13 unseen7)))

;; H
  (assert (=> (not (= result4 true)) (= avail7 avail1)))

;; H
  (assert
  (= list_mod_allocator__m__model__result3 (mk_t__ref
                                           list_mod_allocator__m__model__result2)))

;; H
  (assert
  (= list_mod_allocator__m__model__result4 list_mod_allocator__m__model__result2))

;; H
  (assert
  (= result10 (mk_t__ref
              (mk___rep1
              (mk___split_fields1 list_mod_allocator__m__model__result
              list_mod_allocator__m__model__result1)))))

;; H
  (assert
  (= list_mod_allocator__m__model__result2 (mk___rep1
                                           (mk___split_fields1
                                           (sequence__content avail6)
                                           (set__content alloc6)))))

;; H
  (assert
  (= list_mod_allocator__m__model__result5 list_mod_allocator__m__model__result3))
...
;; H
  (assert (= unseen14 unseen12))

;; H
  (assert (= alloc8 alloc6))

;; H
  (assert (= avail8 avail6))

;; H
  (assert
  (= list_mod_allocator__m__model__result6 list_mod_allocator__m__model__result4))
...
;; H
  (assert (= unseen15 unseen13))

;; H
  (assert (= alloc9 alloc7))

;; H
  (assert (= avail9 avail7))

;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 result11 result12)) (t__content
                                                        list_mod_allocator__m__model__result5)))

(assert
;; WP_parameter_def
 ;; File "list_mod_allocator.ads", line 36, characters 0-0
  (not
  (= (model_is_well_formed (t__content list_mod_allocator__m__model__result5)
     data first_available) true)))
(check-sat)
(exit)
