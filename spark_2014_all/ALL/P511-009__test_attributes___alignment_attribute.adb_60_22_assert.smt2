...
(declare-fun alignment_attribute__q__a1__assume () (Array Int integer))

(declare-fun alignment_attribute__q__a1__assume1 () t)
...
;; H
  (assert (= temp___272 alignment_attribute__q__a1__assume))

;; H
  (assert
  (= (mk (to_rep (first2 temp___2721)) (to_rep (last2 temp___2721)))
  alignment_attribute__q__a1__assume1))
...
;; H
  (assert
  (= (to_rep a1__first) (to_rep (first alignment_attribute__q__a1__assume1))))

;; H
  (assert
  (= (to_rep a1__last) (to_rep (last alignment_attribute__q__a1__assume1))))
...
;; H
  (assert
  (= a21 (alignment_attribute__q__a2__aggregate_def
...
;; H
  (assert (<= 0 (object__alignment1 a21)))

(assert
;; WP_parameter_def
 ;; File "alignment_attribute.adb", line 47, characters 0-0
  (not (< (object__alignment1 a21) 0)))
(check-sat)
(exit)
