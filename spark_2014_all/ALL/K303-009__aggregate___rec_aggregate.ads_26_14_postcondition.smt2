...
(declare-fun temp___166 () integer)

(declare-fun o2 () integer)

(declare-fun o3 () integer)

(declare-fun temp___167 () integer)
...
;; H
  (assert
  (=> (not (= b 1))
  (= (mk___split_fields r__split_fields1) (mk___split_fields
                                          r__split_fields2))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (bool_eq (mk___rep (mk___split_fields r__split_fields3))
     (mk___rep (mk___split_fields (of_rep one)))) true)))
(check-sat)
(exit)
