...
(define-fun dynamic_invariant ((temp___expr_715 Int)
  (temp___is_init_712 Bool) (temp___skip_constant_713 Bool)
  (temp___do_toplevel_714 Bool)) Bool (=>
...
(define-fun default_initial_assumption ((temp___expr_734 us_rep)
  (temp___skip_top_level_735 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_735 true))
                                         (= (length temp___expr_734) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_721 Int)
  (temp___is_init_718 Bool) (temp___skip_constant_719 Bool)
  (temp___do_toplevel_720 Bool)) Bool (=>
                                      (or (= temp___is_init_718 true)
