...
(declare-fun o86 () us_rep)

(declare-fun o87 () us_rep)

(declare-fun o88 () us_rep)

(declare-fun o89 () us_rep)

(declare-fun o90 () us_rep)
...
;; H
  (assert (= o97 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (and (= o91 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert (and (= o94 o93) (in_range2 o93)))

;; H
  (assert (= o95 (num_of_big_int m m_first o94)))

;; H
  (assert (= o90 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o96 (omultiply o90 o95)))

;; H
  (assert (= o98 (osubtract o96 o97)))

;; H
  (assert (= o87 (from_word32 a_msw3)))
...
;; H
  (assert
  (and (= o81 (base Tuple0))
  (= o81 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o86 (oexpon o81 o85)))

;; H
  (assert (= o88 (omultiply o86 o87)))
...
;; H
  (assert (and (= o79 o78) (in_range2 o78)))

;; H
  (assert
  (= o80 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o79)))

;; H
  (assert (= o89 (oadd o80 o88)))

;; H
  (assert (= o99 (olt o89 o98)))

;; H
  (assert (and (= o70 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert (= o74 (num_of_big_int m m_first o73)))

;; H
  (assert (and (= o64 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o65 (- o64 a_first)))
...
;; H
  (assert
  (and (= o62 (base Tuple0))
  (= o62 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert (= o63 (inverse o61 o62)))

;; H
  (assert (= o68 (oexpon o63 o67)))
...
;; H
  (assert (= o55 (num_of_big_int c c_first o54)))

;; H
  (assert (and (= o46 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o47 (- o46 a_first)))
...
;; H
  (assert (= o50 (num_of_big_int b b_first o49)))

;; H
  (assert (= o56 (omultiply o50 o55)))

;; H
  (assert (= o69 (omultiply o56 o68)))

;; H
  (assert (= o75 (omod o69 o74)))
