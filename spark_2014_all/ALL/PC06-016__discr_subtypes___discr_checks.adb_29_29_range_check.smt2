...
(declare-fun discr_checks__check_subtype_prot__R6b__assume () Int)

;; H
  (assert
  (and (= discr_checks__check_subtype_prot__R6b__assume (bad Tuple0))
  (and (in_range discr_checks__check_subtype_prot__R6b__assume)
  (= discr_checks__check_subtype_prot__R6b__assume 6))))

;; H
  (assert (= discr_checks__check_subtype_prot__R6b__assume r6b))
