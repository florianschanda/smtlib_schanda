...
(declare-fun temp___694 () us_rep3)

(declare-fun temp___693 () Int)
...
(declare-fun temp___696 () us_rep3)
...
;; H
  ...
  (=>
  (and (in_range2 g1)
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields10)) g1) true))
  (exists ((i Int))
  (and
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields10)) 1)))
  (= g1 (f (get (elements s) i)))))))))
...
;; H
  ...
  (and
  (and
  (= (length2 temp___694) (length
                          (mk___rep r__split_discrs
                          (us_split_fields__content r__split_fields7))))
  (forall ((temp___390 Int))
  (=>
  (and (in_range3 temp___390)
  (= (iter_has_element temp___694 temp___390) true))
  (= (contains
     (model__
     (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))
     (get temp___694 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range2 item)
  (= (contains
     ...
     (mk___rep r__split_discrs (us_split_fields__content r__split_fields7)))
     item) true))
  (and (< 0 (find temp___694 item))
  (= (equivalent_elements (get temp___694 (find temp___694 item)) item) true)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep r__split_discrs
        (us_split_fields__content r__split_fields7)))))
  (and (= (find temp___694 (get temp___694 i)) i)
  (= (e_is_find temp___694 (get temp___694 i) i) true)))))))

;; H
  (assert
  (and (= o3 (iter_has_element temp___694 temp___693))
  (= (= o3 true) (and (<= 1 temp___693) (<= temp___693 (last temp___694))))))
...
;; H
  (assert
  (and (= temp___696 (elements s))
  (and
  (and
  (and (= (length2 temp___696) (length s))
  (forall ((temp___390 Int))
  (=>
  (and (in_range3 temp___390)
  (= (iter_has_element temp___696 temp___390) true))
  (= (contains (model__ s) (get temp___696 temp___390)) true))))
  (forall ((item Int))
  (=> (and (in_range2 item) (= (contains (model__ s) item) true))
  (and (< 0 (find temp___696 item))
  (= (equivalent_elements (get temp___696 (find temp___696 item)) item) true)))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (length s)))
  (and (= (find temp___696 (get temp___696 i)) i)
  (= (e_is_find temp___696 (get temp___696 i) i) true)))))))

;; H
  (assert
  (and (= o5 (iter_has_element temp___696 temp___695))
  (= (= o5 true) (and (<= 1 temp___695) (<= temp___695 (last temp___696))))))
