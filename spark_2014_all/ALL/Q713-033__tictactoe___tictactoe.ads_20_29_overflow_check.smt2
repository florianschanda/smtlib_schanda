...
;; H
  ...
  (=> (<= 3 x)
  (=> (<= 3 y)
  (and (= o7 (one_free_slot 3 3 my_board))
  (and (in_range o7)
  (= o7 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))

;; H
  (assert (=> (<= 3 x) (=> (not (<= 3 y)) (= o7 0))))
...
;; H
  ...
  (and (in_range o4)
  (= o4 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))

;; H
  (assert (=> (<= 3 x) (=> (not (<= 2 y)) (= o4 0))))

;; H
  (assert
  (=> (<= 3 x)
  (and (= o5 (one_free_slot 3 1 my_board))
  (and (in_range o5)
...
;; H
  (assert (=> (<= 3 x) (and (= o8 o6) (in_range o6))))

;; H
  (assert (=> (<= 3 x) (= o9 (+ o8 o7))))

;; H
  (assert (=> (<= 3 x) (and (= o10 o9) (in_range o9))))

;; H
  (assert (=> (not (<= 3 x)) (= o10 0)))
...
;; H
  (assert
  (=> (<= 3 y)
  (and (= o3 (one_free_slot 2 3 my_board))
  (and (in_range o3)
  (= o3 (ite (= (to_rep (select (select my_board 2) 3)) 0) 1 0))))))
...
;; H
  (assert
  (=> (<= 2 y)
  (and (= o (one_free_slot 2 2 my_board))
  (and (in_range o)
  (= o (ite (= (to_rep (select (select my_board 2) 2)) 0) 1 0))))))
...
;; H
  (assert
  (and (= o1 (one_free_slot 2 1 my_board))
  (and (in_range o1)
  (= o1 (ite (= (to_rep (select (select my_board 2) 1)) 0) 1 0)))))
