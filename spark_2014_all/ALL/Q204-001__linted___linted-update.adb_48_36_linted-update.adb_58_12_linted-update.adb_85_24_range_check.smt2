...
(declare-fun o154 () storage_element)

(declare-fun o155 () (_ BitVec 8))
...
;; H
  (assert (= o154 (select temp___492 1)))

;; H
  (assert (= o155 (to_rep o154)))

;; H
  (assert (= o156 ((_ zero_extend 24) o155)))

;; H
  (assert (= o157 (bvshl o156 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o150 (select temp___488 2)))
...
;; H
  (assert (= o153 (bvshl o152 ((_ int2bv 32) 16))))
...
;; H
  (assert (= o146 (select temp___484 3)))
...
;; H
  (assert (= o149 (bvshl o148 ((_ int2bv 32) 8))))
