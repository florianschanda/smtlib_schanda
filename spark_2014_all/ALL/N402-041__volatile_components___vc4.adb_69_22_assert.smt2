...
(declare-fun v31 () (Array Int integer))
...
;; H
  (assert (= temp___209 x1))

;; H
  (assert (= o2 (select temp___209 2)))
...
;; H
  (assert (= temp___210 v3))

;; H
  (assert (= o4 (select temp___210 2)))
...
;; H
  (assert (= temp___211 v31))

;; H
  (assert (= o6 (select temp___211 2)))
...
(assert
;; WP_parameter_def
 ;; File "vc4.adb", line 39, characters 0-0
  (not (= t31 t41)))
(check-sat)
(exit)
