...
;; mk_def
  ...
  (! (=> (in_range f)
     ...
     (= (to_rep (last1 (mk f l1))) l1)))) :pattern ((mk f l1)) )))
...
(define-fun dynamic_invariant1 ((temp___expr_142 us_t)
  ...
  (temp___do_toplevel_141 Bool)) Bool (and
                                      ...
                                      (first2 temp___expr_142)
                                      (last2 temp___expr_142))
                                      (and (= (first2 temp___expr_142)
                                      l) (= (last2 temp___expr_142) u))))
                                      (forall ((temp___143 Int))
                                      (=>
                                      (and
                                      (<= (first2 temp___expr_142) temp___143)
...
(define-fun default_initial_assumption ((temp___expr_144 us_t)
  (temp___skip_top_level_145 Bool)) Bool (forall ((temp___146 Int))
                                         (=>
                                         (and
                                         (<= (first2 temp___expr_144) temp___146)
                                         (<= temp___146 (last2
                                                        temp___expr_144)))
                                         (= (to_rep
                                            (select (to_array
                                                    temp___expr_144) temp___146)) 5))))
...
(declare-datatypes ((taB__ref 0)) (((mk_taB__ref (taB__content us_t2)))))
...
;; def_axiom
  (assert
  (forall ((temp___152 Int) (temp___153 Int))
  (let ((temp___151 (temp___150 temp___152 temp___153)))
  (=> (dynamic_property4 first last temp___152 temp___153)
  (and (= (first4 temp___151) temp___152) (= (last4 temp___151) temp___153))))))
