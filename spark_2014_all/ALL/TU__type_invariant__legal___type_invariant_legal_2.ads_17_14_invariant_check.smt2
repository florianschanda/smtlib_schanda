...
;; H
  (assert (and (= o1 (pub x1)) (in_range o1)))
...
;; H
  (assert (and (= o2 (priv x1)) (in_range o2)))
...
;; H
  (assert (and (= o3 (e_pub x2)) (and (in_range o3) (= o3 1))))
...
;; H
  (assert (and (= o4 (e_priv x2)) (and (in_range o4) (= o4 1))))
