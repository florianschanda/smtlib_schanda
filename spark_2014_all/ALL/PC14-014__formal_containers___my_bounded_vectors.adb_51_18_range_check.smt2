...
(define-fun l__split_fields18 () us_split_fields (mk___split_fields
                                                 l__split_fields2))
...
;; H
  ...
  (length (mk___rep l__split_discrs l__split_fields19)) 4))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields19))
     (model__
  ...
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1))
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields19))) 1)
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields19))) 4) 9) true))))
...
;; H
  ...
  (= (olt
     ...
     (model__ (mk___rep l__split_discrs l__split_fields18))) true)))
