...
(declare-const temp___743 bits_6)

(declare-const temp___7431 sub_index_type)

(declare-const temp___7432 operation_type)

(declare-const temp___7433 bits_7)

(declare-const temp___7434 extended_address_type)
...
(declare-const o10 bits_6)

(declare-const o11 sub_index_type)

(declare-const o12 operation_type)

(declare-const o13 bits_7)

(declare-const o14 extended_address_type)

(declare-const o15 (Array Int bits_8))

(declare-const o16 (Array Int bits_8))
