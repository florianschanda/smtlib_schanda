...
;; H
  (assert (= temp___749 o5))

;; H
  (assert (= temp___7491 o6))

;; H
  (assert (= temp___7492 o7))

;; H
  (assert (= temp___7493 o8))

;; H
  (assert (= temp___7494 o9))

;; H
  (assert (and (= (to_rep5 temp___7491) 1) (= (to_rep6 temp___7494) 0)))
...
;; H
  (assert
  (let ((temp___696 header1))
  (and
  (= (to_rep5
     (rec__dw1000__register_driver__short_indexed_header__sub_index
     (us_split_fields3 temp___696))) 1)
  (= (to_rep6
     (rec__dw1000__register_driver__short_indexed_header__extended_address
     (us_split_fields3 temp___696))) 0))))
