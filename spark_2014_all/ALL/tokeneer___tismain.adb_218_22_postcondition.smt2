...
;; H
  (assert (= o (privatekeypresent state3)))

;; H
  (assert (= o1 (privatekeypresent state3)))

;; H
  (assert
  (and
  (and (not (= (isgood state10) true))
  (not (= (authcertvalid state10) true)))
  (not (in_range7 (theauthcertrole state10)))))

;; H
  (assert
  (and
  (= (= (privatekeypresent state3) true)
  (not (= (enrolmentisinprogress state11) true)))
  (or (= (enrolmentisinprogress state11) true)
  (= (statusisenclavequiescent state11) true))))

;; H
  (assert (= result (privatekeypresent state3)))

;; H
  (assert (=> (= result true) (= (valid_numberlogentries state12) true)))

;; H
  (assert
  (=> (not (= result true)) (= (valid_numberlogentries state13) true)))

;; H
  (assert (=> (not (= result true)) (= state12 state13)))
...
;; H
  (assert
  (= theadmin__split_fields2 (let ((subject theadmin__split_fields))
                             (mk___split_fields__ref theadmin__split_fields1))))

;; H
  (assert
  (= thestats__split_fields1 (mk___split_fields__ref1 thestats__split_fields)))

;; H
  (assert (= state25 (mk___private__ref state11)))

;; H
  (assert (= status3 (mk___private__ref status)))

;; H
  (assert (= state24 (mk___private__ref state9)))

;; H
  (assert (= output1 (mk___private__ref output)))

;; H
  (assert (= state23 (mk___private__ref state5)))

;; H
  (assert (= writtenstate1 (mk___private__ref writtenstate)))

;; H
  (assert (= state22 (mk___private__ref state)))

;; H
  (assert (= state21 (mk___private__ref state4)))
...
;; H
  (assert (= status2 (mk___private__ref status1)))

;; H
  (assert (= state17 (mk___private__ref state10)))

;; H
  (assert (= state16 (mk___private__ref state3)))

;; H
  (assert (= state15 (mk___private__ref state12)))

;; H
  (assert (= filestate5 (mk___private__ref filestate2)))

;; H
  (assert (= state14 (mk___private__ref state1)))
...
;; H
  (assert (= state37 state11))

;; H
  (assert (= status5 status))

;; H
  (assert (= state36 state9))

;; H
  (assert (= output2 output))

;; H
  (assert (= state35 state5))

;; H
  (assert (= writtenstate2 writtenstate))

;; H
  (assert (= state34 state))

;; H
  (assert (= state33 state4))
...
;; H
  (assert (= state30 state6))

;; H
  (assert (= status4 status1))

;; H
  (assert (= state29 state10))

;; H
  (assert (= state28 state3))
