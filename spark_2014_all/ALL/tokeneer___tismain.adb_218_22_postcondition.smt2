...
(declare-fun filestate4 () us_private__ref)

(declare-fun state14 () us_private__ref)
...
(declare-fun status2 () us_private__ref)

(declare-fun state18 () us_private__ref)
...
(declare-fun writtenstate1 () us_private__ref)

(declare-fun state23 () us_private__ref)

(declare-fun output1 () us_private__ref)
...
(declare-fun thestats__split_fields1 () us_split_fields__ref1)
