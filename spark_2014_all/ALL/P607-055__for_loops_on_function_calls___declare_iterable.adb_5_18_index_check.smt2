...
(declare-fun x__split_fields () (Array Int natural))
...
;; H
  (assert
  (= (has_element (mk___rep (mk___split_fields x__split_fields)) c) true))
...
(assert
;; WP_parameter_def
 ;; File "declare_iterable.ads", line 11, characters 0-0
  (not (<= 1 c)))
(check-sat)
