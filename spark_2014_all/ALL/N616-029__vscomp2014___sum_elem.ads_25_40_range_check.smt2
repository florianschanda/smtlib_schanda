...
(declare-fun dummy1 () partition_index)
...
(declare-fun sum_elem__partitions__vector__capacity__first__bit1 () Int)

(declare-fun sum_elem__partitions__vector__capacity__last__bit1 () Int)

(declare-fun sum_elem__partitions__vector__capacity__position1 () Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ (- 1) result) 10000) (dynamic_invariant5 result true false
...
;; H
  (assert (and (= o (length p)) (and (in_range4 o) (<= o (capacity p)))))
