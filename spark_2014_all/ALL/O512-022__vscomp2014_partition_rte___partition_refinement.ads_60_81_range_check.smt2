...
(define-fun c3 () us_rep (mk___rep (mk___split_fields c)))
...
;; H
  (assert (and (= o14 o12) (in_range2 o12)))

;; H
  (assert (= result (ite (<= o14 o13) true false)))
...
;; H
  (assert (= result1 (ite (<= o10 5000) true false)))
...
;; H
  ...
  (= (has_key1
     (positions1
     (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c4) true)
  (= (to_rep
     (select a (element1
               (mk___rep3 d__split_discrs
               (mk___split_fields3 d__split_fields)) c4))) (key
                                                           (mk___rep3
                                                           d__split_discrs
                                                           (mk___split_fields3
                                                           d__split_fields))
...
;; H
  (assert
  (and (= o6 (has_key (positions x) c3))
  (= (= o6 true) (= (has_key (positions x) c3) true))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 0 j1) (<= j1 5))
  (and (<= 0 (to_rep4 (select f j1)))
  (<= (to_rep4 (select f j1)) (- (length2
...
;; H
  (assert (and (= o3 o2) (in_range10 o2)))
...
;; H
  (assert (= result9 (ite (<= 0 j) o5 false)))
