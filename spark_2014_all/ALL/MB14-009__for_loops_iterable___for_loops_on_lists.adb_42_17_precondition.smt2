...
(define-fun o14 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
...
;; H
  ...
  (< 0 (get
       (model__
       (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i1))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i1) (-
  (get
...
;; H
  ...
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2) i1)
...
;; H
  (assert
  (and (= o6 (length (mk___rep l__split_discrs l__split_fields1)))
  (and (in_range1 o6)
  (<= o6 (to_rep
...
;; H
  (assert
  (and (= o4 (positions (mk___rep l__split_discrs l__split_fields1)))
  (and (not (= (has_key o4 no_element) true))
  (forall ((i1 us_rep1))
  (=> (= (has_key o4 i1) true)
  (and
  (and (<= 1 (get1 o4 i1))
  (<= (get1 o4 i1) (length (mk___rep l__split_discrs l__split_fields1))))
  (forall ((j us_rep1))
  (=> (= (has_key o4 j) true)
  (=> (= (get1 o4 i1) (get1 o4 j)) (= (bool_eq1 i1 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o5)
  (=> (= (of_int 0) true)
  (and (= o5 (w_get o4 (witness o4 cu2)))
  (forall ((k us_rep1))
  (=> (= (has_key o4 k) true)
  (= (= (bool_eq1 k cu2) true) (= (witness o4 cu2) (witness o4 k))))))))))
...
;; H
  (assert (and (= o13 (get o11 o12)) (in_range4 o13)))
...
;; H
  (assert
  (and (= o9 (model__ (mk___rep l__split_discrs l__split_fields1)))
  (= (length1 o9) (length (mk___rep l__split_discrs l__split_fields1)))))
