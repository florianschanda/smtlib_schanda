...
(declare-const temp___1376 (Array Int character))

(declare-const temp___13761 t1)

(declare-const o (Array Int character))

(declare-const temp___1379 (Array Int character))

(declare-const temp___13791 t1)
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text))))
     (+ (- (to_rep1 (last (rt text))) (to_rep1 (first (rt text)))) 1) 0)
  (ite (<= 1 (to_rep1 (last (rt text))))
  (+ (- (to_rep1 (last (rt text))) 1) 1) 0)))

;; H
  (assert (= (slide (elts text) (to_rep1 (first (rt text))) 1) temp___1376))

;; H
  (assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___13761))

;; H
  (assert
  (=> (<= 1 (to_rep1 (last (rt text))))
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 (to_rep1 (last (rt text)))) (<= (to_rep1 (last (rt text))) 150)))))

;; H
  (assert (= o result__1))

;; H
  (assert (= o temp___1379))

;; H
  (assert (= (mk1 1 (to_rep1 (last (rt text)))) temp___13791))

(assert
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___13761)) (to_rep1 (last2 temp___13761)))
     (+ (- (to_rep1 (last2 temp___13761)) (to_rep1 (first2 temp___13761))) 1)
     0) (ite (<= (to_rep1 (first2 temp___13791)) (to_rep1
                                                 (last2 temp___13791)))
        (+ (- (to_rep1 (last2 temp___13791)) (to_rep1 (first2 temp___13791))) 1)
        0))))
(check-sat)
(exit)
