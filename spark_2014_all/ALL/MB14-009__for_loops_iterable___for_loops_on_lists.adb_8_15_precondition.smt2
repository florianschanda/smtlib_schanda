...
;; H
  (assert
  (and (= o8 (first l))
  (ite (= (= (length2 l) 0) true) (= (bool_eq1 o8 no_element) true)
  (and (= (has_key (positions l) o8) true) (= (get1 (positions l) o8) 1)))))
...
;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (- (get1 (positions l) cu2) 1)))
...
;; H
  ...
  (and (in_range4 o4)
  (=> (= (of_int 0) true)
  (and (= o4 (w_get o3 (witness o3 cu2)))
  (forall ((k us_rep1))
  (=> (= (has_key o3 k) true)
  (= (= (bool_eq1 k cu2) true) (= (witness o3 cu2) (witness o3 k))))))))))
