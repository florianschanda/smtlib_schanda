...
(define-fun e_is_find ((container us_rep2) (item Int)
  (position Int)) Bool (and (ite (< 0 position)
                            ...
                            item) (of_int 1)) (ite (< position (length
                                                               container))
                                              (e_smaller_than_range container
                                              (+ position 1)
                                              (length container) item)
                                              (of_int 1))))
...
(define-fun element_type__ref_2__projection ((a element_type__ref4)) element_type4
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant6 item true true true)
     ...
     (=>
     (exists ((e1 Int))
     (and (and (in_range6 e1) (= (contains container e1) true))
...
;; length__post_axiom
  (assert
  (forall ((container us_rep4)) (! (dynamic_invariant5 (length4 container)
...
(define-fun temp___6781 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___678)))

(define-fun use_ordered_sets__my_find__cu__assume1 () us_rep1 (mk___rep1
                                                              (mk___split_fields1
                                                              use_ordered_sets__my_find__cu__assume)))
...
;; H
  (assert
  (and (= use_ordered_sets__my_find__cu__assume1 (first s))
  (ite (= (= (length2 s) 0) true)
  (= (bool_eq1 use_ordered_sets__my_find__cu__assume1 no_element) true)
  (and
  (= (has_key (positions s) use_ordered_sets__my_find__cu__assume1) true)
  (= (get1 (positions s) use_ordered_sets__my_find__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= o2 (element s (mk___rep1 cu__split_fields4)))
  (and (in_range7 o2)
  (= o2 (get (elements s) (get1 (positions s) (mk___rep1 cu__split_fields4)))))))
...
;; H
  (assert
  (= use_ordered_sets__my_find__result1 (mk___rep1
                                        (mk___split_fields1
                                        use_ordered_sets__my_find__result))))

;; H
  (assert
  (and (= temp___6781 (next s (mk___rep1 cu__split_fields4)))
  ...
  (= (bool_eq1 temp___6781 no_element) true)
  (and (= (has_key (positions s) temp___6781) true)
  (= (get1 (positions s) temp___6781) (+ (get1 (positions s)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___678)))

;; H
  (assert
  (and (= o3 (has_key (positions s) (mk___rep1 cu__split_fields3)))
  (= (= o3 true)
...
(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 80, characters 0-0
  (not (not (= (get (elements s) i) e))))
(check-sat)
(exit)
