...
;; first__post_axiom
  ...
  (! (let ((result (first container)))
     (ite (= (length2 container) 0) (= (bool_eq3 result no_element) true)
...
;; H
  ...
  (= (bool_eq3 use_ordered_sets__my_find__cu__assume1 no_element) true)
  (and
...
;; H
  ...
  (= (bool_eq3 temp___6781 no_element) true)
