...
;; def_axiom
  ...
  (let ((temp___132 (p__x__aggregate_def temp___133 temp___134 temp___135)))
  (and
  (and (= (select temp___132 5) (of_rep temp___133))
  (= (select temp___132 6) (of_rep temp___134)))
  (= (select temp___132 7) (of_rep temp___135))))))
...
(((mk_tstr3P1__ref (tstr3P1__content tstr3P1)))))
(define-fun tstr3P1__ref___projection ((a tstr3P1__ref)) tstr3P1 (tstr3P1__content
                                                                 a))
