...
;; H
  (assert (= o2 (mk___split_fields1 o1 (temp___206 1 2 3 4))))
...
;; H
  (assert (= temp___213 (mk___rep2 o5 o4 true)))
...
;; WP_parameter_def
 ;; File "use_unchecked_union.ads", line 33, characters 0-0
  (not
  (= (rec__use_unchecked_union__myunion__discr (us_split_discrs1 temp___213))
