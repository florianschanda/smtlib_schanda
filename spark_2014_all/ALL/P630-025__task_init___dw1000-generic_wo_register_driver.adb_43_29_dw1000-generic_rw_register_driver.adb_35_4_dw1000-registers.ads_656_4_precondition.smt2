...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___82131)) (to_rep (last4 temp___82131)))
  temp___82141))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___82141)) (to_rep (last2 temp___82141)))
     (+ (- (to_rep (last2 temp___82141)) (to_rep (first2 temp___82141))) 1)
