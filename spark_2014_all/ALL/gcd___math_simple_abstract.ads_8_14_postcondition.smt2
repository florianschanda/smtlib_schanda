...
(declare-fun math_simple_abstract__gcd__result () Int)
...
(declare-fun math_simple_abstract__gcd__result1 () Int)

(declare-fun math_simple_abstract__gcd__result2 () Int)

(declare-fun math_simple_abstract__gcd__result3 () Int)

(declare-fun c10 () Int)

(declare-fun math_simple_abstract__gcd__result4 () Int)

(declare-fun c11 () Int)

(declare-fun math_simple_abstract__gcd__result5 () Int)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (divides math_simple_abstract__gcd__result4 a) true)))
(check-sat)
