...
(define-fun in_range ((x Int)) Bool (and (<= 0 x) (<= x 1599)))
...
(declare-fun user_eq (bit_absorption_number bit_absorption_number) Bool)

(declare-fun dummy () bit_absorption_number)
...
(declare-fun to_rep (bit_absorption_number) Int)

(declare-fun of_rep (Int) bit_absorption_number)
...
;; range_axiom
  (assert
  (forall ((x bit_absorption_number)) (! (in_range
...
;; range_axiom
  (assert
  (forall ((x states)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun in_range2 ((x Int)) Bool (and (<= 0 x) (<= x 199)))
...
(declare-fun dummy4 () byte_absorption_number)
...
;; range_axiom
  (assert
  (forall ((x byte_absorption_number)) (! (in_range2
...
(define-fun bool_eq6 ((a (Array Int byte)) (a__first Int) (a__last Int)
...
(declare-fun dummy6 () (Array Int byte))
...
(define-fun in_range3 ((x Int)) Bool (and (<= 1 x) (<= x 199)))
...
(declare-fun to_rep5 (rate_number) Int)
...
(declare-fun ctx () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(define-fun dynamic_invariant ((temp___expr_249 (_ BitVec 8))
...
(declare-fun keccak__keccak_1600__sponge__in_queue_bit_length__result1 () Int)

(declare-fun keccak__keccak_1600__sponge__in_queue_bit_length__result2 () Int)

(declare-fun keccak__keccak_1600__sponge__in_queue_bit_length__result3 () Int)

(declare-fun keccak__keccak_1600__sponge__in_queue_bit_length__result4 () Int)

(declare-fun keccak__keccak_1600__sponge__in_queue_bit_length__result5 () Int)

(declare-fun result1 () Int)

;; H
  (assert
  (= keccak__keccak_1600__sponge__in_queue_bit_length__result1 keccak__keccak_1600__sponge__in_queue_bit_length__result2))

;; H
  (assert
  (= keccak__keccak_1600__sponge__in_queue_bit_length__result3 keccak__keccak_1600__sponge__in_queue_bit_length__result1))

;; H
  (assert
  (= result keccak__keccak_1600__sponge__in_queue_bit_length__result))

;; H
  (assert
  (= keccak__keccak_1600__sponge__in_queue_bit_length__result1 (to_rep
                                                               (rec__keccak__keccak_1600__sponge__context__bits_absorbed
                                                               (us_split_fields1
                                                               ctx)))))
...
;; H
  (assert
  (= (mk_int__ref keccak__keccak_1600__sponge__in_queue_bit_length__result4) 
  (mk_int__ref keccak__keccak_1600__sponge__in_queue_bit_length__result2)))

;; H
  (assert
  (= keccak__keccak_1600__sponge__in_queue_bit_length__result5 keccak__keccak_1600__sponge__in_queue_bit_length__result3))

;; H
  (assert
  (= result1 keccak__keccak_1600__sponge__in_queue_bit_length__result4))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (< keccak__keccak_1600__sponge__in_queue_bit_length__result4 1600)))
(check-sat)
