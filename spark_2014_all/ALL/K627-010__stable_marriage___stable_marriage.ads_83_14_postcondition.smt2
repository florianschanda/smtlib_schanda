...
;; invert_2__post_axiom
  ...
  (! (=> (= (is_permutation_2 r2) true)
     ...
     (forall ((rank Int))
     (=> (and (<= 1 rank) (<= rank 64))
     (= (to_rep (select result (to_rep1 (select r2 rank)))) rank)))
     (forall ((g2 Int))
     (=> (and (<= 1 g2) (<= g2 64))
     (= (to_rep1 (select r2 (to_rep (select result g2)))) g2)))))) :pattern (
  (invert_2 r2)) )))

(declare-fun g2_a () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun g2_b () Int)
...
(declare-fun stable_marriage__is_preferred_2__result () Bool)
...
(declare-fun stable_marriage__is_preferred_2__result1 () Bool)

(declare-fun stable_marriage__is_preferred_2__result2 () Bool)

(declare-fun stable_marriage__is_preferred_2__result3 () Bool)

(declare-fun inverted2 () (Array Int ranking))

(declare-fun stable_marriage__is_preferred_2__result4 () Bool)

(declare-fun inverted3 () (Array Int ranking))

(declare-fun stable_marriage__is_preferred_2__result5 () Bool)
...
;; H
  ...
  (forall ((rank Int))
  (=> (and (<= 1 rank) (<= rank 64))
  (= (to_rep (select o (to_rep1 (select r2 rank)))) rank)))
  (forall ((g2 Int))
  (=> (and (<= 1 g2) (<= g2 64))
  (= (to_rep1 (select r2 (to_rep (select o g2)))) g2))))))
...
;; H
  (assert
  (= stable_marriage__is_preferred_2__result1 stable_marriage__is_preferred_2__result2))

;; H
  (assert
  (= stable_marriage__is_preferred_2__result3 stable_marriage__is_preferred_2__result1))

;; H
  (assert
  (= (mk_bool__ref result1) (mk_bool__ref
                            stable_marriage__is_preferred_2__result)))

;; H
  (assert
  (= stable_marriage__is_preferred_2__result1 (ite (<= (to_rep
                                                       (select inverted1
                                                       g2_a)) (to_rep
                                                              (select
                                                              inverted1
...
;; H
  (assert
  (= (mk_bool__ref stable_marriage__is_preferred_2__result4) (mk_bool__ref
                                                             stable_marriage__is_preferred_2__result2)))
...
;; H
  (assert
  (= stable_marriage__is_preferred_2__result5 stable_marriage__is_preferred_2__result3))

;; H
  (assert (= inverted3 inverted1))

;; H
  (assert (= result2 stable_marriage__is_preferred_2__result4))

;; H
  (assert (= stable_marriage__is_preferred_2__result4 true))

(assert
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 80, characters 0-0
  (not
  (<= (to_rep (select (invert_2 r2) g2_a)) (to_rep
