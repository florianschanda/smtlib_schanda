...
(declare-fun indefinite_unbounded_tagged__sort__sort__container__fields () us_split_fields2)
...
;; H
  ...
  (= (length
     (mk___rep1 v__split_discrs
     indefinite_unbounded_tagged__sort__sort__container__fields)) (length
                                                                  (mk___rep1
                                                                  v__split_discrs
                                                                  v__split_fields9)))
  (= (m_elements_sorted
     (model__
     (mk___rep1 v__split_discrs
     indefinite_unbounded_tagged__sort__sort__container__fields))) true))
  (= (m_elements_included
     (model__ (mk___rep1 v__split_discrs v__split_fields9)) 1
     (last
     (model__
     (mk___rep1 v__split_discrs
     indefinite_unbounded_tagged__sort__sort__container__fields)))
     (model__
     (mk___rep1 v__split_discrs
     indefinite_unbounded_tagged__sort__sort__container__fields)) 1
     (last
     (model__
     (mk___rep1 v__split_discrs
     indefinite_unbounded_tagged__sort__sort__container__fields)))) true))
...
;; H
  (assert
  (= v__split_fields10 indefinite_unbounded_tagged__sort__sort__container__fields))
...
;; WP_parameter_def
 ;; File "a-cfinve.ads", line 813, characters 0-0
  (not (= (length (mk___rep1 v__split_discrs v__split_fields10)) 2)))
(check-sat)
(exit)
