...
(declare-datatypes ()
((t708s__ref (mk_t708s__ref (t708s__content integer)))))
...
(declare-const temp___458 (_ BitVec 32))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___458 result__1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___457 i1)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 amount))
  (= (bvand result__3 (let ((temp___461 (- i2 1)))
                      (ite (< temp___461 4294967296)
                      (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___461))
                      ((_ int2bv 32) 0)))) (let ((temp___462 (- i2 1)))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  ...
  (let ((temp___469 (- i9 1)))
  (ite (< temp___469 4294967296)
  (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___469)) ((_ int2bv 32) 0))))
  (let ((temp___470 (- i9 1)))
  (ite (< temp___470 4294967296)
  (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___470)) ((_ int2bv 32) 0))))))
(check-sat)
(exit)
