...
(declare-datatypes ()
((t580s__ref (mk_t580s__ref (t580s__content integer)))))
(define-fun t580s__ref___projection ((a t580s__ref)) integer (t580s__content
                                                             a))
...
(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result1 () (_ BitVec 32))

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result2 () (_ BitVec 32))

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result3 () (_ BitVec 32))

(declare-fun result__8 () (_ BitVec 32))

(declare-fun i7 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result4 () (_ BitVec 32))

(declare-fun result__9 () (_ BitVec 32))

(declare-fun i8 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result5 () (_ BitVec 32))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 amount))
  (=> (not (< (- i1 1) 4294967296)) (= o ((_ int2bv 32) 0)))))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result1
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result3
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result1))

;; H
  (assert
  (= result3 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result))
...
;; H
  (assert
  (= (mk_t__ref
     bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result4)
  (mk_t__ref
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result5
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result3))
...
;; H
  (assert
  (= result4 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__ones__result4))
