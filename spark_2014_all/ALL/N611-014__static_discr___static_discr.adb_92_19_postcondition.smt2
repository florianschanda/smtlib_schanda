...
(define-fun us_split_fields_Content15__projection ((a us_split_fields6)) us_t2
...
(define-fun us_split_fields__ref_15__projection ((a us_split_fields__ref3)) us_split_fields6
...
(define-fun us_rep_29__projection ((a us_rep3)) us_split_discrs (us_split_discrs5
                                                                a))

(define-fun us_rep_30__projection ((a us_rep3)) us_split_fields6 (us_split_fields7
                                                                 a))
...
(declare-fun temp___407 () natural)

(declare-fun temp___4071 () natural)

(declare-fun temp___4072 () natural)

(declare-fun temp___4073 () natural)

(declare-fun temp___4074 () (Array Int natural))

(declare-fun temp___4075 () t1)

(declare-fun temp___4076 () natural)
...
(declare-fun current__split_fields6 () us_split_fields__ref2)
...
;; WP_parameter_def
 ;; File "static_discr.ads", line 31, characters 0-0
  (not
  (= (let ((temp___419 (rec__static_discr__i_holder__content1
                       (us_split_fields3
                       (rec__static_discr__holder__content
                       (us_split_fields__content2 current__split_fields6))))))
     (bool_eq (elts1 temp___419) (to_rep1 (first2 (rt1 temp___419)))
     (to_rep1 (last2 (rt1 temp___419))) current__split_fields2
     (to_rep1 (first2 current__split_fields3))
