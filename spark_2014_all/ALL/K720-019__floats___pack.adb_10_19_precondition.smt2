...
(declare-fun add1 (t t) t)

(declare-fun add__function_guard (t t t) Bool)
...
;; add__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant r1 true true true) (dynamic_invariant r2 true
     true true))
     (and (lt r1 fliteral)
     (and (lt r2 fliteral)
     (and (lt (neg fliteral) r1) (lt (neg fliteral) r2)))))
     (let ((result (add1 r1 r2)))
     (and (eq result (add RNE1 r1 r2)) (dynamic_invariant result true false
     true)))) :pattern ((add1 r1 r2)) )))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral3) (/ 3000000119209289550781250.0 10000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 100000001490116119384765625.0 1000000000000000000000000000.0))))
...
;; H
  (assert
  (and (= o (add1 fliteral2 fliteral3))
  (and (tqtisFinite o) (eq o (add RNE1 fliteral2 fliteral3)))))

;; H
  (assert
  (and (= o1 (add1 fliteral4 o))
  (and (tqtisFinite o1) (eq o1 (add RNE1 fliteral4 o)))))

(assert
;; WP_parameter_def
 ;; File "pack.ads", line 17, characters 0-0
  (not (lt fliteral4 fliteral)))
(check-sat)
