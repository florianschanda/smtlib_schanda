...
;; H
  ...
  (<= (to_rep2
      ...
      (get5
      (model__2
      (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j1)))) k)
  (<= k (to_rep2
        (rec__partition_refinement__interval__last
        (us_split_fields9
        (get5
        (model__2
        (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j1))))))
  (= (to_rep4 (select f k)) j1)))))
  (forall ((j1 Int))
  (=>
  (and (<= 0 j1)
  (<= j1 (- (length1
...
;; H
  ...
  (<= (to_rep2
      (rec__partition_refinement__interval__first
      (us_split_fields9
      (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j1)))) k)
  (<= k (to_rep2
        (rec__partition_refinement__interval__last
        (us_split_fields9
