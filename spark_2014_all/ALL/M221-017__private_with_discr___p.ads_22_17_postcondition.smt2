...
(declare-fun p__my_capacity__result () Int)

(declare-fun result () Int)

(declare-fun p__my_capacity__result1 () Int)

(declare-fun p__my_capacity__result2 () Int)

(declare-fun p__my_capacity__result3 () Int)

(declare-fun p__my_capacity__result4 () Int)

(declare-fun p__my_capacity__result5 () Int)
...
;; H
  (assert
  (= p__my_capacity__result1 (to_rep
                             (rec__p__private_types__t1__capacity
                             (us_split_discrs1 l)))))

;; H
  (assert
  (= (mk_int__ref p__my_capacity__result4) (mk_int__ref
                                           p__my_capacity__result2)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= p__my_capacity__result4 10)))
(check-sat)
(exit)
