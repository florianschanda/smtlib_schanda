...
(((mk_value_type__ref (value_type__content value_type)))))
...
;; H
  ...
  value o))) 1) 0) v1) (<= v1 value)) (not (= (select is_prime1 v1) true))))
  (forall ((v1 Int))
  (=>
  (and (<= value v1)
  (<= v1 (ite (< 100000 (- (+ value (abs (- value o))) 1)) 100000 (- (+
  value (abs (- value o))) 1)))) (not (= (select is_prime1 v1) true)))))))))))))
...
;; H
  (assert
  (=> (= (ite (= (is_prime value) false) (= mode 0) false) true)
  (and
  (< value test_prime_and_coprime_numbers__p__nearest_prime_number__result4)
  (forall ((v1 Int))
  (=>
  (and (<= value v1)
  (<= v1 (- test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1)))
  (not (= (is_prime v1) true)))))))
...
;; H
  ...
  (=>
  (and
  (<= (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1) v1)
  (<= v1 value)) (not (= (is_prime v1) true)))))))
...
;; H
  (assert
  (and
  (= o7 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
  (in_range1
  (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))))
...
;; H
  (assert (= o14 (ite (< 0 o13) o13 0)))

;; H
  (assert (= o15 (ite (<= o14 v) true false)))

;; H
  (assert (= result2 (ite (= o15 true) (ite (<= v value) true false) false)))
...
;; H
  ...
  value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1) 0) v1)
  (<= v1 value)) (not (= (is_prime v1) true))))))
...
;; H
  (assert
  (and
  (= o1 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
  (in_range1
  (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))))
