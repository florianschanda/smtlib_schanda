...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 item true true true)
     ...
     (= (my_eq (element container result) item) true))))) :pattern ((find
                                                                    container
                                                                    item)) ))))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 item true true true)
     ...
     result true false true)))) :pattern ((find2 container item)) ))))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (= (my_eq (get result (find2 result item)) item) true)))))
     (forall ((i Int))
...
;; H
  ...
  (and
  (and
  (= (oeq2 (model__ (mk___rep l__split_discrs l__split_fields6))
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields6)) e) true))
  (= (oeq3 (positions (mk___rep l__split_discrs l__split_fields6))
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true))
  (= (element (mk___rep l__split_discrs l__split_fields6)
     (find (mk___rep l__split_discrs l__split_fields6) e)) e))
  (= (equal_except
     (elements
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (elements (mk___rep l__split_discrs l__split_fields6))
     (get1 (positions (mk___rep l__split_discrs l__split_fields6))
     (find (mk___rep l__split_discrs l__split_fields6) e))) true))))
...
;; H
  ...
  (= (element (mk___rep l__split_discrs l__split_fields5)
     (find (mk___rep l__split_discrs l__split_fields5) e)) e))
  (= (ole
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  ...
  (= (keys_included_except
     ...
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (find (mk___rep l__split_discrs l__split_fields5) e)) true))))
...
;; H
  (assert
  (and
  (= o1 (find (mk___rep l__split_discrs (mk___split_fields l__split_fields3))
        e))
  (ite (ite (= (contains
               (model__
               (mk___rep l__split_discrs
               (mk___split_fields l__split_fields3))) e) false) true false)
  (= (bool_eq1 o1 no_element) true)
  (and
  (and
  (= (has_key
     (positions
...
(assert
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 1134, characters 0-0
  (not
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields3)))
