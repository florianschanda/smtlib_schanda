...
(declare-const dw1000__register_types__lde_cfg2_type__lde_cfg2__first__bit Int)

(declare-const dw1000__register_types__lde_cfg2_type__lde_cfg2__last__bit Int)

(declare-const dw1000__register_types__lde_cfg2_type__lde_cfg2__position Int)
...
(declare-datatypes ((lde_cfg2_type__ref 0))
(((mk_lde_cfg2_type__ref (lde_cfg2_type__content us_rep)))))
...
(define-fun register_type__ref_205__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_144__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_144__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6718 us_t1)
  (temp___is_init_6715 Bool) (temp___skip_constant_6716 Bool)
  (temp___do_toplevel_6717 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6716 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6718)
                                       (last3 temp___expr_6718))
                                       (and (= (first3 temp___expr_6718) 1)
                                       (= (last3 temp___expr_6718) 2)))))
