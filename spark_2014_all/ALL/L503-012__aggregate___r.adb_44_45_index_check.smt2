...
(declare-datatypes ((int6__ref 0)) (((mk_int6__ref (int6__content int6)))))
...
(((mk_map__ref1 (map__content1 (Array Int (Array Int int5)))))))
...
(define-fun bool_eq1 ((a (Array Int (Array Int int5))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq (select a temp___idx_134) 2 6
...
(((mk_tar37P1__ref (tar37P1__content tar37P1)))))
