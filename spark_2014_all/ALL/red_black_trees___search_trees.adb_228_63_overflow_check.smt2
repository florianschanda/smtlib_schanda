...
(declare-fun temp___1309 () (Array Int us_rep1))
...
(declare-fun temp___1308 () (Array Int us_rep1))

(declare-fun o20 () us_rep1)

(declare-fun o21 () us_split_fields)

(declare-fun temp___1307 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1293 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1294 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1296 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1295 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert
  (and (= temp___1308 (model__ f root))
  (and (dynamic_invariant5 temp___1308 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1308 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1308 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1308 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1308 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1308 i3))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1308 (parent f i3)))) (position f i3)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1308 i3)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1308 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1308 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1308 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1308 j3)))) true))
  (= j3 i3))))))))))))))

;; H
  (assert (= o20 (select temp___1308 i2)))
...
;; H
  (assert
  (=> (= result7 true)
  (and (= temp___1309 (model__ f root))
  (and (dynamic_invariant5 temp___1309 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1309 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1309 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1309 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1309 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1309 i3))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1309 (parent f i3)))) (position f i3)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1309 i3)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1309 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1309 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1309 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1309 j3)))) true))
  (= j3 i3)))))))))))))))
...
;; H
  (assert (=> (= result7 true) (= o18 (select temp___1309 o17))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= temp___1311 (model__ f root))
  (and (dynamic_invariant5 temp___1311 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1311 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1311 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1311 i3))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1311 (parent f i3)))) (position f i3)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1311 i3)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1311 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1311 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1311 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1311 j3)))) true))
  (= j3 i3)))))))))))))))
...
;; H
  (assert (=> (= result6 true) (= o14 (select temp___1311 o13))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= temp___1310 (model__ f root))
  (and (dynamic_invariant5 temp___1310 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1310 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1310 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1310 i3))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1310 (parent f i3)))) (position f i3)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1310 i3)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1310 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1310 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1310 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1310 j3)))) true))
  (= j3 i3)))))))))))))))

;; H
  (assert (=> (= result6 true) (= o10 (select temp___1310 i2))))
...
;; H
  (assert
  (and (= temp___1307 (model__ f root))
  (and (dynamic_invariant5 temp___1307 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1307 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1307 root)))) 0)
  (and
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=> (not (= i3 root))
  (ite (and (not (= (parent f i3) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1307 (parent f i3)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1307 i3))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1307 i3))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1307 (parent f i3)))) (position f i3)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1307 i3)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1307 i3)))) 0))))
  (forall ((i3 Int))
  (=> (and (<= 1 i3) (<= i3 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1307 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1307 i3)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1307 j3)))) true))
  (= j3 i3))))))))))))))

;; H
  (assert (= o22 (select temp___1307 i2)))
