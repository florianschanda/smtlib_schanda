...
;; H
  (assert
  (and (= o4 (positions (mk___rep l__split_discrs l__split_fields2)))
  (and (not (= (has_key o4 no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o4 i) true)
  (and
  (and (<= 1 (get1 o4 i))
  (<= (get1 o4 i) (length (mk___rep l__split_discrs l__split_fields2))))
  (forall ((j us_rep1))
  (=> (= (has_key o4 j) true)
  (=> (= (get1 o4 i) (get1 o4 j)) (= (bool_eq2 i j) true))))))))))
...
;; H
  ...
  (and (in_range4 o5)
  (=> (= (of_int 0) true)
  (and (= o5 (w_get o4 (witness o4 lst)))
  (forall ((k us_rep1))
  (=> (= (has_key o4 k) true)
  (= (= (bool_eq2 k lst) true) (= (witness o4 lst) (witness o4 k))))))))))

;; H
  (assert
  (and (= o3 (positions (mk___rep l__split_discrs l__split_fields2)))
  (and (not (= (has_key o3 no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o3 i) true)
  (and
  (and (<= 1 (get1 o3 i))
  (<= (get1 o3 i) (length (mk___rep l__split_discrs l__split_fields2))))
  (forall ((j us_rep1))
  (=> (= (has_key o3 j) true)
...
;; H
  (assert
  (and (= o6 (get1 o3 (mk___rep1 current__split_fields3)))
  (and (in_range4 o6)
  (=> (= (of_int 0) true)
  (and (= o6 (w_get o3 (witness o3 (mk___rep1 current__split_fields3))))
  (forall ((k us_rep1))
  (=> (= (has_key o3 k) true)
  (= (= (bool_eq2 k (mk___rep1 current__split_fields3)) true)
  (= (witness o3 (mk___rep1 current__split_fields3)) (witness o3 k))))))))))
...
;; H
  (assert
  (and (= o1 (positions (mk___rep l__split_discrs l__split_fields2)))
  (and (not (= (has_key o1 no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o1 i) true)
  (and
  (and (<= 1 (get1 o1 i))
  (<= (get1 o1 i) (length (mk___rep l__split_discrs l__split_fields2))))
  (forall ((j us_rep1))
  (=> (= (has_key o1 j) true)
  (=> (= (get1 o1 i) (get1 o1 j)) (= (bool_eq2 i j) true))))))))))

;; H
  (assert
  (and (= o2 (get1 o1 (mk___rep1 current__split_fields3)))
  (and (in_range4 o2)
  (=> (= (of_int 0) true)
  (and (= o2 (w_get o1 (witness o1 (mk___rep1 current__split_fields3))))
  (forall ((k us_rep1))
  (=> (= (has_key o1 k) true)
  (= (= (bool_eq2 k (mk___rep1 current__split_fields3)) true)
  (= (witness o1 (mk___rep1 current__split_fields3)) (witness o1 k))))))))))
