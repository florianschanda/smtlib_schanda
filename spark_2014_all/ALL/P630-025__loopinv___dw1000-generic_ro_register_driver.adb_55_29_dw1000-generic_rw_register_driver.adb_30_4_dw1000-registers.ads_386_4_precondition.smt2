...
(define-fun register_type__ref_104__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_74__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_74__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_4686 us_t1)
  (temp___is_init_4683 Bool) (temp___skip_constant_4684 Bool)
  (temp___do_toplevel_4685 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_4684 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_4686)
                                       (last3 temp___expr_4686))
                                       (and (= (first3 temp___expr_4686) 1)
                                       (= (last3 temp___expr_4686) 2)))))
