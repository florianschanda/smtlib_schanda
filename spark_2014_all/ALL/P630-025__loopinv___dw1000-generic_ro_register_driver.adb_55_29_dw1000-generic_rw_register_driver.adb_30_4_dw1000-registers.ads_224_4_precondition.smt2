...
(define-fun register_type__ref___20__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___14__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___14__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2332 us_t1)
  (temp___is_init_2329 Bool) (temp___skip_constant_2330 Bool)
  (temp___do_toplevel_2331 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2330 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_2332)
                                       (last3 temp___expr_2332))
                                       (and (= (first3 temp___expr_2332) 1)
                                       (= (last3 temp___expr_2332) 2)))))
