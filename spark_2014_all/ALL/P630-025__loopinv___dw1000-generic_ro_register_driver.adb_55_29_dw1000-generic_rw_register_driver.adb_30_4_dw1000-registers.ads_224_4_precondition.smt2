...
(define-fun register_type__ref_20__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_14__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_14__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2318 us_t1)
  (temp___is_init_2315 Bool) (temp___skip_constant_2316 Bool)
  (temp___do_toplevel_2317 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2316 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_2318)
                                       (last3 temp___expr_2318))
                                       (and (= (first3 temp___expr_2318) 1)
                                       (= (last3 temp___expr_2318) 2)))))
