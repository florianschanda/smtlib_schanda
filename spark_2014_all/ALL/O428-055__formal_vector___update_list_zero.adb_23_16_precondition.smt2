...
;; H
  (assert (and (= o9 (get o7 o8)) (in_range4 o9)))
...
;; H
  (assert
  (and (= o5 (model__ (mk___rep l__split_discrs l__split_fields1)))
  (= (length1 o5) (length (mk___rep l__split_discrs l__split_fields1)))))
