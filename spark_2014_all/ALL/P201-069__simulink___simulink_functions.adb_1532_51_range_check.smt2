...
(define-fun source__ref___7__projection ((a source__ref)) source (source__content
                                                                 a))
...
(define-fun target__ref___7__projection ((a target__ref)) target (target__content
                                                                 a))
