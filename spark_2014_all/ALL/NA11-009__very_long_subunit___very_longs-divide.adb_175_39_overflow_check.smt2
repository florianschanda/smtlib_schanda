...
(declare-fun temp___1279 () (_ BitVec 16))

(declare-fun temp___1276 () digit_index_type)

(declare-fun temp___12761 () (Array Int octet))

(declare-fun temp___12762 () t1)

(declare-fun temp___1275 () (_ BitVec 16))

(declare-fun temp___1274 () (_ BitVec 16))

(declare-fun temp___1273 () (_ BitVec 16))

(declare-fun temp___1272 () (_ BitVec 16))
...
(declare-fun temp___1271 () us_rep1)
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (and (= (mk___split_discrs temp___1276) u__split_discrs)
  (and (= temp___12761 u__split_fields) (= temp___12762 u__split_fields1)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= temp___1275 current_borrow1)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= temp___1274 future_borrow)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= temp___1273 temporary_digit)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= temp___1271 (mk___rep1 u__split_discrs
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= u__split_fields4 (us_split_fields3 temp___1271))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r125b))
  (= u__split_discrs (us_split_discrs2 temp___1271))))
