...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result12 (ite (< 0 o52) true false))))
...
;; H
  ...
  (=> (= result12 true)
  (and
  (= o51 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o51)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result12 true)
  (= result11 (ite (= o51 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o49) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result13 true)
  (= result10 (ite (= o48 first_allocated1) true false))))))
...
;; H
  (assert
  (and
  (= o47 (get (rec__list_allocator__m__t__available model____split_fields3)
         j))
  (in_range7 o47)))

;; H
  (assert (= result15 (ite (in_range4 o47) true false)))
