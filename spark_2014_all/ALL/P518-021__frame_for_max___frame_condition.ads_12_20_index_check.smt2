...
;; H
  ...
  (or
  (and
  (and (and (= max18 max22) (and (= k18 k22) (= a14 a18)))
  (and (= max19 max1) (and (= k19 k1) (= a15 a1))))
  (and
  (and
  ...
  (and
  (and (and (= max18 max16) (and (= k18 k16) (= a14 a12)))
  (and (= max19 max17) (and (= k19 k17) (= a15 a13))))
  (and
  (and (and (= o1 (to_rep1 a__first)) (in_range3 (to_rep1 a__first)))
  (and (= result1 k22) (= k2 o1)))
  (and (and (= result2 max22) (= max2 0))
  (and
  (and
  (and
  (and (= temp___228 max2)
  ...
  (and
  (and
  (and (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last))) (= o2 k2))
  (= (mk___rep (mk___split_fields o3 o4 o5)) (select a o2)))
  (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o6)) (= o10 (to_rep o9)))
  (= result3 (ite (< max2 o10) true false)))
  (ite (= result3 true)
  (and
  (and
  (and
  (and
  (and
  (and (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last))) (= o11 k2))
  (= (mk___rep (mk___split_fields o12 o13 o14)) (select a o11)))
  (and (= o12 o15) (and (= o13 o16) (= o14 o17)))) (= o18 o15))
  (= o19 (to_rep o18))) (and (= result4 (mk_int__ref max2)) (= max3 o19)))
  (= max3 max2)))
  (and
  (and
  (and
  ...
  (and (= (to_rep o20) max3)
  (and
  (= (rec__frame_condition__cell__value (us_split_fields1 (select a k2)))
  o21)
  (and (= o20 o22)
  (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a k2)))
  o23)))) (and (= o24 o21) (and (= o25 o22) (= o26 o23))))
  (and
  (and (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last))) (= o27 k2))
  (= o28 (store a o27 (mk___rep (mk___split_fields o24 o25 o26))))))
  (and (= result5 a18) (= a2 o28)))
  (and
  (and (and (<= (to_rep1 a__first) k3) (<= k3 (to_rep1 a__last)))
  (and
  (forall ((i1 Int))
  (=> (and (<= (to_rep1 a__first) i1) (<= i1 k3))
  (<= (to_rep
  ...
  (and
  (and
  (and (=> (<= 1 2147483647) (in_range3 k3))
  (forall ((temp___227 Int))
  (=>
  (and (<= (to_rep1 a__first) temp___227) (<= temp___227 (to_rep1 a__last)))
  (and
  (= (rec__frame_condition__cell__value
     (us_split_fields1 (select a3 temp___227))) (rec__frame_condition__cell__value
                                                (us_split_fields1
                                                (select temp___226 temp___227))))
  (= (rec__frame_condition__cell__max_right
     (us_split_fields1 (select a3 temp___227))) (rec__frame_condition__cell__max_right
                                                (us_split_fields1
                                                (select temp___226 temp___227))))))))
  (=> (<= 0 2147483647) (in_range2 max4)))
  (and (and (= k4 (mk_int__ref k3)) (= k5 k3)) (= k3 (to_rep1 a__last))))))))))
  (and
  (and (= max5 (mk_int__ref max4)) (and (= k6 k4) (= a4 (mk_map__ref a3))))
  (and (= max6 max4) (and (= k7 k5) (= a5 a3)))))
  (and (and (= max7 max5) (and (= k8 k6) (= a6 a4)))
  (and (= max8 max6) (and (= k9 k7) (= a7 a5)))))
  (and
  (and (and (= o29 (to_rep1 a__last)) (in_range3 (to_rep1 a__last)))
  (and (= result6 k8) (= k10 o29)))
  (and (and (= result7 max7) (= max9 0))
  (and
  (and
  (and (= temp___234 max9)
  (and (= temp___232 (map__content a6))
  (and (= temp___230 k10)
  (and
  (and
  (and
  ...
  (and
  (and
  (and (and (<= (to_rep1 a__first) k10) (<= k10 (to_rep1 a__last)))
  (= o30 k10)) (= o31 (select (map__content a6) o30)))
  (= o32 (us_split_fields1 o31)))
  (= o33 (rec__frame_condition__cell__value o32))) (= o34 (to_rep o33)))
  (= result8 (ite (< max9 o34) true false)))
  (ite (= result8 true)
  (and
  (and
  (and
  ...
  (and
  (and (and (<= (to_rep1 a__first) k10) (<= k10 (to_rep1 a__last)))
  (= o35 k10)) (= o36 (select (map__content a6) o35)))
  (= o37 (us_split_fields1 o36)))
  (= o38 (rec__frame_condition__cell__value o37))) (= o39 (to_rep o38)))
  (and (= result9 (mk_int__ref max9)) (= max10 o39)))
  (and (= max11 (mk_int__ref max10)) (= max12 max10)))
  (and (= max11 (mk_int__ref max9)) (= max12 max9))))
  (and
  (and
  (and
  (and
  (and (= (to_rep o40) (int__content max11))
  (= o41 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select (map__content a6) k10)))
         (rec__frame_condition__cell__max_left
         (us_split_fields1 (select (map__content a6) k10))) o40)))
  (= o42 (mk___rep o41)))
  (and
  (and (and (<= (to_rep1 a__first) k10) (<= k10 (to_rep1 a__last)))
  (= o43 k10)) (= o44 (store (map__content a6) o43 o42))))
  (and (= result10 a6) (= a8 o44)))
  (and
  (and (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last)))
  (and
  (forall ((i1 Int))
  (=> (and (<= k11 i1) (<= i1 (to_rep1 a__last)))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a9 i1))))
  max13)))
  (forall ((i1 Int))
  (=> (and (<= k11 i1) (<= i1 (to_rep1 a__last)))
  (forall ((j Int))
  ...
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a9 j))))
  (to_rep
  (rec__frame_condition__cell__max_right (us_split_fields1 (select a9 i1)))))))))))
  (and
  (and
  (and (=> (<= 1 2147483647) (in_range3 k11))
  (forall ((temp___233 Int))
  (=>
  (and (<= (to_rep1 a__first) temp___233) (<= temp___233 (to_rep1 a__last)))
  (and
  (= (rec__frame_condition__cell__value
     (us_split_fields1 (select a9 temp___233))) (rec__frame_condition__cell__value
                                                (us_split_fields1
                                                (select temp___232 temp___233))))
  (= (rec__frame_condition__cell__max_left
     (us_split_fields1 (select a9 temp___233))) (rec__frame_condition__cell__max_left
                                                (us_split_fields1
                                                (select temp___232 temp___233))))))))
  (=> (<= 0 2147483647) (in_range2 max13)))
  (and (and (= k12 (mk_int__ref k11)) (= k13 k11))
  (= k11 (to_rep1 a__first))))))))))
  (and
  (and (= max14 (mk_int__ref max13))
  (and (= k14 k12) (= a10 (mk_map__ref a9))))
  (and (= max15 max13) (and (= k15 k13) (= a11 a9)))))
  (and (and (= max16 max14) (and (= k16 k14) (= a12 a10)))
  (and (= max17 max15) (and (= k17 k15) (= a13 a11))))))))))))))
...
;; H
  ...
  (<= (to_rep
      (rec__frame_condition__cell__value
      (us_split_fields1 (select (map__content a16) i)))) (to_rep
                                                         (rec__frame_condition__cell__max_left
                                                         (us_split_fields1
                                                         (select (map__content
                                                                 a16) j)))))
  (<= (to_rep
      (rec__frame_condition__cell__value
      (us_split_fields1 (select (map__content a16) j)))) (to_rep
                                                         (rec__frame_condition__cell__max_right
                                                         (us_split_fields1
                                                         (select (map__content
                                                                 a16)
...
;; H
  (assert (= o46 (select a o45)))

;; H
  (assert (= o47 (us_split_fields1 o46)))

;; H
  (assert (= o48 (rec__frame_condition__cell__value o47)))
