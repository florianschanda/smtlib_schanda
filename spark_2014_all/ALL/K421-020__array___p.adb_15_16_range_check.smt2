...
(declare-datatypes ((ta1C__ref 0)) (((mk_ta1C__ref (ta1C__content ta1C)))))
...
(((mk_map__ref (map__content (Array Int ta1C))))))
...
(declare-datatypes ((ttmp3C__ref 0))
(((mk_ttmp3C__ref (ttmp3C__content ttmp3C)))))
...
(((mk_map__ref1 (map__content1 (Array Int ttmp3C))))))
...
(declare-datatypes ((ttmp4C__ref 0))
(((mk_ttmp4C__ref (ttmp4C__content ttmp4C)))))
...
(((mk_map__ref2 (map__content2 (Array Int ttmp4C))))))
...
(declare-datatypes ((ttmp5C__ref 0))
(((mk_ttmp5C__ref (ttmp5C__content ttmp5C)))))
...
(((mk_map__ref3 (map__content3 (Array Int ttmp5C))))))
