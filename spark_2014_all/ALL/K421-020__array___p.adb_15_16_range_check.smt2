...
;; range_axiom
  (assert
  (forall ((x1 ta1C)) (! (in_range2 (to_rep x1)) :pattern ((to_rep x1)) )))
...
(declare-fun user_eq2 (ta1D1 ta1D1) Bool)

(declare-fun dummy2 () ta1D1)
...
(define-fun bool_eq3 ((a (Array Int ta1C)) (a__first Int) (a__last Int)
...
(declare-fun user_eq3 (ttmp3C ttmp3C) Bool)

(declare-fun dummy3 () ttmp3C)
...
;; range_axiom
  (assert
  (forall ((x1 ttmp3C)) (! (in_range4
  (to_rep1 x1)) :pattern ((to_rep1 x1)) )))

;; coerce_axiom
  (assert
  (forall ((x1 Int))
  (! (=> (in_range4 x1) (= (to_rep1 (of_rep1 x1)) x1)) :pattern ((to_rep1
                                                                 (of_rep1 x1))) )))
...
(define-fun bool_eq5 ((a (Array Int ttmp3C)) (a__first Int) (a__last Int)
...
(declare-fun user_eq4 (ttmp4C ttmp4C) Bool)

(declare-fun dummy4 () ttmp4C)
...
;; range_axiom
  (assert
  (forall ((x1 ttmp4C)) (! (in_range5
  (to_rep2 x1)) :pattern ((to_rep2 x1)) )))

;; coerce_axiom
  (assert
  (forall ((x1 Int))
  (! (=> (in_range5 x1) (= (to_rep2 (of_rep2 x1)) x1)) :pattern ((to_rep2
                                                                 (of_rep2 x1))) )))
...
(define-fun bool_eq7 ((a (Array Int ttmp4C)) (a__first Int) (a__last Int)
...
(declare-fun user_eq5 (ttmp5C ttmp5C) Bool)

(declare-fun dummy5 () ttmp5C)
...
;; range_axiom
  (assert
  (forall ((x1 ttmp5C)) (! (in_range6
  (to_rep3 x1)) :pattern ((to_rep3 x1)) )))

;; coerce_axiom
  (assert
  (forall ((x1 Int))
  (! (=> (in_range6 x1) (= (to_rep3 (of_rep3 x1)) x1)) :pattern ((to_rep3
                                                                 (of_rep3 x1))) )))
...
(define-fun bool_eq9 ((a (Array Int ttmp5C)) (a__first Int) (a__last Int)
