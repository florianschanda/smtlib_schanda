...
(declare-datatypes ((dictionaryt__ref 0))
(((mk_dictionaryt__ref (dictionaryt__content us_t1)))))
...
(declare-datatypes ((doorstatet__ref 0))
(((mk_doorstatet__ref (doorstatet__content doorstatet)))))
