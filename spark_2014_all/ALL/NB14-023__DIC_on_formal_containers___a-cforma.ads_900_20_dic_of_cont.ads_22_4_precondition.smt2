...
(define-fun us_split_discrs___6__projection ((a us_split_discrs)) count_type
...
(define-fun map__ref___6__projection ((a map__ref)) us_rep (map__content a))
...
(define-fun us_split_fields_Node__4__projection ((a us_split_fields2)) count_type
...
(define-fun cursor__ref___4__projection ((a cursor__ref)) us_rep1 (cursor__content
                                                                  a))
...
(define-fun map__ref___8__projection ((a map__ref1)) us_rep2 (map__content1
                                                             a))

(declare-datatypes ((key_type__ref 0))
(((mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref___8__projection ((a key_type__ref)) us_rep1
  (key_type__content a))
...
(define-fun element_type__ref___15__projection ((a element_type__ref)) element_type
...
(define-fun map__ref___7__projection ((a map__ref2)) us_rep3 (map__content2
                                                             a))
...
(define-fun key_type__ref___7__projection ((a key_type__ref1)) key_type
...
(define-fun element_type__ref___13__projection ((a element_type__ref1)) element_type1
