...
(declare-const dic_of_cont__my_orma__cursor__node__first__bit Int)

(declare-const dic_of_cont__my_orma__cursor__node__last__bit Int)

(declare-const dic_of_cont__my_orma__cursor__node__position Int)
...
(declare-const temp___2061 count_type)
