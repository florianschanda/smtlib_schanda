...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__dic_of_cont__my_orma__map__capacity count_type)))))
(define-fun us_split_discrs_6__projection ((a us_split_discrs)) count_type
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__dic_of_cont__my_orma__map us_main_type)))))
...
(define-fun us_rep_16__projection ((a us_rep)) us_split_discrs (us_split_discrs1
                                                               a))

(define-fun us_rep_17__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(define-fun map__ref_6__projection ((a map__ref)) us_rep (map__content a))
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__dic_of_cont__my_orma__cursor__node count_type)))))
(define-fun us_split_fields_Node4__projection ((a us_split_fields2)) count_type
  (rec__dic_of_cont__my_orma__cursor__node a))
...
(define-fun us_rep_18__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))

(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__dic_of_cont__my_orma__cursor__node
...
(declare-fun dic_of_cont__my_orma__cursor__node__first__bit () Int)

(declare-fun dic_of_cont__my_orma__cursor__node__last__bit () Int)

(declare-fun dic_of_cont__my_orma__cursor__node__position () Int)

;; dic_of_cont__my_orma__cursor__node__first__bit_axiom
  (assert (<= 0 dic_of_cont__my_orma__cursor__node__first__bit))

;; dic_of_cont__my_orma__cursor__node__last__bit_axiom
  (assert
  (< dic_of_cont__my_orma__cursor__node__first__bit dic_of_cont__my_orma__cursor__node__last__bit))

;; dic_of_cont__my_orma__cursor__node__position_axiom
  (assert (<= 0 dic_of_cont__my_orma__cursor__node__position))
...
(define-fun cursor__ref_4__projection ((a cursor__ref)) us_rep1 (cursor__content
                                                                a))
...
(define-fun map__ref_8__projection ((a map__ref1)) us_rep2 (map__content1 a))

(declare-datatypes ()
((key_type__ref (mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref_8__projection ((a key_type__ref)) us_rep1 (key_type__content
                                                                    a))
...
(define-fun element_type__ref_15__projection ((a element_type__ref)) element_type
  (element_type__content a))

(define-fun dynamic_invariant1 ((temp___expr_1154 Int)
  (temp___is_init_1151 Bool) (temp___skip_constant_1152 Bool)
  (temp___do_toplevel_1153 Bool)) Bool (=>
                                       (or (= temp___is_init_1151 true)
...
(define-fun default_initial_assumption ((temp___expr_1161 us_rep2)
  (temp___skip_top_level_1162 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1162 true))
                                          (and
                                          (= (is_empty temp___expr_1161) true)
                                          (= (length2 temp___expr_1161) 0))))
...
(define-fun map__ref_7__projection ((a map__ref2)) us_rep3 (map__content2 a))
...
(define-fun default_initial_assumption1 ((temp___expr_1110 us_rep3)
  (temp___skip_top_level_1111 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1111 true))
                                          (and
                                          (= (is_empty1 temp___expr_1110) true)
                                          (= (length3 temp___expr_1110) 0))))
...
(define-fun key_type__ref_7__projection ((a key_type__ref1)) key_type
  (key_type__content1 a))

(define-fun dynamic_invariant2 ((temp___expr_1097 Int)
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant2 key true true true)
     ...
     (=>
     (exists ((k Int))
     (and (and (in_range3 k) (= (has_key1 container1 k) true))
...
(define-fun element_type__ref_13__projection ((a element_type__ref1)) element_type1
  (element_type__content1 a))

(define-fun dynamic_invariant3 ((temp___expr_1103 Int)
...
;; get__post_axiom
  ...
  (forall ((key Int))
  (! (=>
     (and (dynamic_invariant2 key true true true)
...
(declare-fun temp___2061 () count_type)
...
;; H
  (assert (= temp___2061 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___2061)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cforma.ads", line 880, characters 0-0
