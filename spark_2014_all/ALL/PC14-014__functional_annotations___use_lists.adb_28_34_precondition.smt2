...
;; H
  (assert
  (and (= o1 (length (mk___rep l2__split_discrs l2__split_fields2)))
  (and (in_range2 o1)
  (<= o1 (to_rep (rec__use_lists__my_lists__list__capacity l2__split_discrs))))))
...
;; H
  ...
  (forall ((i us_rep1))
  (=> (= (has_key o i) true)
  (and (and (<= 1 (get1 o i)) (<= (get1 o i) (length l1)))
  (forall ((j us_rep1))
  (=> (= (has_key o j) true)
