...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ (- first2 1) result) last3) (dynamic_invariant7 result true
...
(declare-const temp___431 tcount_typeB)

(declare-const temp___4311 us_main_type)
...
(define-fun v2__split_fields10 () us_split_fields (mk___split_fields
                                                  v2__split_fields3))

(define-fun v2__split_fields11 () us_split_fields (mk___split_fields
                                                  v2__split_fields2))

(define-fun v2__split_fields12 () us_split_fields (mk___split_fields
                                                  v2__split_fields1))

(define-fun v2__split_fields13 () us_split_fields (mk___split_fields
                                                  v2__split_fields))

;; H
  (assert (dynamic_property2 0 last2
  (to_rep1
  (rec__use_vectors__my_vectors__vector__capacity (us_split_discrs1 v1)))))

;; H
  (assert (dynamic_property2 0 last2
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs))))

;; H
  (assert
  (and (= o (last4 (model__ v1)))
  (and (dynamic_property4 first3 last5 o) (= o (last4 (model__ v1))))))
...
;; H
  (assert
  (and (= (length (mk___rep v2__split_discrs v2__split_fields13)) 0)
...
;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (and (= v2__split_discrs (mk___split_discrs temp___431))
  (= temp___4311 v2__split_fields))))

;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= temp___430 i1)))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (= (length (mk___rep v2__split_discrs v2__split_fields12)) (- i2 first))))
...
;; H
  ...
  (=>
  (and (<= first n1)
  (<= n1 (last4 (model__ (mk___rep v2__split_discrs v2__split_fields12)))))
  (= (is_incr (get (model__ v1) n1)
     (get (model__ (mk___rep v2__split_discrs v2__split_fields12)) n1)) true)))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (and
  (and (=> (<= first r1b) (dynamic_property5 first r1b i2))
  (dynamic_property2 0 last2
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs))))
  (and (<= first i2) (<= i2 r1b)))))
...
;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= o1 i2)))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (and (= o2 (get (model__ v1) o1))
  (and (in_range4 o2) (= o2 (get (model__ v1) o1))))))
...
;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b)) (=> (= result2 true) (= o3 i2))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (=> (= result2 true)
  (and (= o4 (get (model__ v1) o3))
  (and (in_range4 o4) (= o4 (get (model__ v1) o3)))))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b)) (=> (= result2 true) (= o5 (+ o4 1)))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (=> (= result2 true) (and (= o6 o5) (in_range2 o5)))))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep v2__split_discrs v2__split_fields11)) (+ (length
                                                                (mk___rep
                                                                v2__split_discrs
                                                                v2__split_fields12)) 1))
  (= (olt (model__ (mk___rep v2__split_discrs v2__split_fields12))
     (model__ (mk___rep v2__split_discrs v2__split_fields11))) true))
  (= (get (model__ (mk___rep v2__split_discrs v2__split_fields11))
     (+ (last4 (model__ (mk___rep v2__split_discrs v2__split_fields12))) 1))
  o6)) (dynamic_property2 0 last2
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))))
...
;; H
  ...
  (=> (and (<= first i1) (<= i1 r1b))
  (=> (not (= result2 true))
  (and (= us2 i2) (dynamic_property1 first1 last1 i2)))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b)) (=> (not (= result2 true)) (= o7 i2))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (=> (not (= result2 true))
  (and (= o8 (get (model__ v1) o7))
  (and (in_range4 o8) (= o8 (get (model__ v1) o7)))))))
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep v2__split_discrs v2__split_fields10)) (+ (length
                                                                (mk___rep
                                                                v2__split_discrs
                                                                v2__split_fields12)) 1))
  (= (olt (model__ (mk___rep v2__split_discrs v2__split_fields12))
     (model__ (mk___rep v2__split_discrs v2__split_fields10))) true))
  (= (get (model__ (mk___rep v2__split_discrs v2__split_fields10))
     (+ (last4 (model__ (mk___rep v2__split_discrs v2__split_fields12))) 1))
  o8)) (dynamic_property2 0 last2
  (to_rep1 (rec__use_vectors__my_vectors__vector__capacity v2__split_discrs)))))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (=> (not (= result2 true)) (= v2__split_fields11 v2__split_fields10))))

;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= i2 r1b)))

;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= i2 i3)))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (= v2__split_fields4 v2__split_fields2)))

;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= i4 i2)))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (= v2__split_fields5 v2__split_fields11)))

;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= i5 (mk_int__ref i3))))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (= v2__split_fields6 (mk___split_fields__ref
                       (mk___split_fields v2__split_fields4)))))

;; H
  (assert (=> (and (<= first i1) (<= i1 r1b)) (= i6 i4)))

;; H
  (assert
  (=> (and (<= first i1) (<= i1 r1b))
  (= v2__split_fields7 v2__split_fields5)))

;; H
  (assert (=> (not (and (<= first i1) (<= i1 r1b))) (= i5 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (and (<= first i1) (<= i1 r1b)))
  (= v2__split_fields6 (mk___split_fields__ref v2__split_fields13))))

;; H
  (assert (=> (not (and (<= first i1) (<= i1 r1b))) (= i6 i1)))

;; H
  (assert
  (=> (not (and (<= first i1) (<= i1 r1b)))
  (= v2__split_fields7 v2__split_fields13)))
...
;; H
  (assert
  (and (= o9 (last4 (model__ v1)))
  (and (dynamic_property4 first3 last5 o9) (= o9 (last4 (model__ v1))))))

;; H
  (assert (= o10 (ite (<= n o9) true false)))

;; H
  (assert (= result3 (ite (<= first n) o10 false)))
...
;; H
  ...
  (= o12 (get
         (model__
         (mk___rep v2__split_discrs
         (us_split_fields__content v2__split_fields8))) o11))
  (and (in_range4 o12)
  (= o12 (get
         (model__
         (mk___rep v2__split_discrs
...
(assert
;; WP_parameter_def
 ;; File "use_vectors.ads", line 33, characters 0-0
  (not (dynamic_property1 first1 last1 n)))
(check-sat)
(exit)
