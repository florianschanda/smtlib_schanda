...
(declare-const temp___5053 cursor__ref)
...
(declare-const temp___5054 us_rep1)
...
(declare-const temp___5055 cursor__ref)
...
(declare-const temp___5056 us_rep1)
...
;; H
  (assert
  (and (= o7 (first l))
  (ite (= (= (length1 l) 0) true) (= (bool_eq1 o7 no_element) true)
...
;; H
  ...
  (ite (= (ite (= (bool_eq1 temp___5052 no_element) false) (= (get1
                                                              (positions l)
                                                              temp___5052)
          (length1 l)) true) true)
