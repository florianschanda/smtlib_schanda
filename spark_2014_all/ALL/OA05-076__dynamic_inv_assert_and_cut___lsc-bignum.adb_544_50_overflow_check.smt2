...
;; H
  (assert (and (= o31 (- e_last e_first)) (in_range1 (- e_last e_first))))

;; H
  (assert (and (= o32 o31) (uint_in_range1 o31)))

;; H
  (assert (= o33 ((_ int2bv 64) o32)))

;; H
  (assert (= o34 (bvadd o33 ((_ int2bv 64) 1))))

;; H
  (assert (= o35 (bvmul o34 ((_ int2bv 64) 32))))

;; H
  (assert (= o36 (ite (bvult i2 o35) true false)))
...
;; H
  (assert (= o26 (oexpon o24 o25)))

;; H
  (assert (and (= o19 (* 2 n)) (in_range1 (* 2 n))))
...
;; H
  (assert (= o23 (oexpon o18 o22)))

;; H
  (assert (= o27 (omultiply o23 o26)))

;; H
  (assert (= o30 (omod o27 o29)))
