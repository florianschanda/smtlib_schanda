...
;; WP_parameter_def
 ;; File "ar.ads", line 476, characters 0-0
  ...
  (= (bool_eq2 a3 1 16
     (temp___1645 a k
     (temp___1653 (select a k) j (temp___1660 (select (select a k) j) i e))
     (+ k 1)
     (temp___1668 (select a (+ k 1)) j
     (temp___1675 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true))
  (and (= e 0)
  (= (bool_eq2 a3 1 16
     (temp___1684 a k
     (temp___1692 (select a k) j (temp___1699 (select (select a k) j) i e))
     (+ k 1)
     (temp___1707 (select a (+ k 1)) j
     (temp___1714 (select (select a (+ k 1)) j) i 99))) 1 16) true))))
  (and (= k 16)
  (or
  (and (< 0 e)
  (= (bool_eq2 a3 1 16
     (temp___1723 a k
     (temp___1731 (select a k) j (temp___1738 (select (select a k) j) i e)) 1
     (temp___1746 (select a 1) j
     (temp___1753 (select (select a 1) j) i (- e 1)))) 1 16) true))
  (and (= e 0)
  (= (bool_eq2 a3 1 16
     (temp___1762 a k
     (temp___1770 (select a k) j (temp___1777 (select (select a k) j) i e)) 1
     (temp___1785 (select a 1) j (temp___1792 (select (select a 1) j) i 99)))
     1 16) true)))))))
(check-sat)
(exit)
