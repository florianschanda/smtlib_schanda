...
;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__si__result)))

;; H
  (assert
  (= x86__si__result1 ((_ extract 15 0) (bvand rsi ((_ int2bv 64) 65535)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not
  (bvule ((_ zero_extend 48) ((_ int2bv 16) 0)) (bvand rsi ((_ int2bv 64) 65535)))))
(check-sat)
(exit)
