...
;; H
  ...
  (= (e_is_find (elements (mk___rep l__split_discrs l__split_fields6))
     e
  ...
  (and
  (and (not (= i true))
  (= (oeq4 (model__ (mk___rep l__split_discrs l__split_fields6))
  ...
  (= (range_equal
     (elements
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (elements (mk___rep l__split_discrs l__split_fields6)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields6))
...
;; H
  ...
  (and
  (and
  (and (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) true)
  ...
  (= (range_equal (elements (mk___rep l__split_discrs l__split_fields6))
     ...
     (- (get (positions (mk___rep l__split_discrs l__split_fields6))
        (mk___rep1 cu__split_fields5)) 1)) true))
  (= (range_shifted (elements (mk___rep l__split_discrs l__split_fields5))
     (elements (mk___rep l__split_discrs l__split_fields6))
     (get (positions (mk___rep l__split_discrs l__split_fields6))
     (mk___rep1 cu__split_fields5))
