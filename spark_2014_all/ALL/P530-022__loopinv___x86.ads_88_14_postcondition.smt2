...
;; H
  (assert
  (bvult var1_range_size (bvsub ((_ int2bv 64) 18446744073709551615)
  var2_range_size)))
...
;; H
  (assert
  (and
  (= o (inrange64 var1 (bvsub var2 (bvsub var1_range_size ((_ int2bv 64) 1)))
       (bvadd (bvsub var1_range_size ((_ int2bv 64) 1)) var2_range_size)))
  (and
  (= (= o true)
  (and
  (not
  (= (bvadd (bvsub var1_range_size ((_ int2bv 64) 1)) var2_range_size) ((_ int2bv 64) 0)))
  (ite (bvule (bvsub var2 (bvsub var1_range_size ((_ int2bv 64) 1))) (bvsub ((_ int2bv 64) 18446744073709551615) (bvsub (bvadd (bvsub
  var1_range_size ((_ int2bv 64) 1)) var2_range_size) ((_ int2bv 64) 1))))
  (and (bvule (bvsub var2 (bvsub var1_range_size ((_ int2bv 64) 1)))
  var1)
  (bvule var1 (bvadd (bvsub var2 (bvsub var1_range_size ((_ int2bv 64) 1))) (bvsub (bvadd (bvsub
  var1_range_size ((_ int2bv 64) 1)) var2_range_size) ((_ int2bv 64) 1)))))
  (or (bvule (bvsub var2 (bvsub var1_range_size ((_ int2bv 64) 1))) var1)
  (bvule var1 (bvsub (bvsub (bvadd (bvsub var1_range_size ((_ int2bv 64) 1))
  var2_range_size) (bvsub ((_ int2bv 64) 18446744073709551615) (bvsub
  var2 (bvsub var1_range_size ((_ int2bv 64) 1))))) ((_ int2bv 64) 2)))))))
  (= (= o true)
  (and
  (not
  (= (bvadd (bvsub var1_range_size ((_ int2bv 64) 1)) var2_range_size) ((_ int2bv 64) 0)))
  ...
  (or
  (and (bvule (bvsub var2 (bvsub var1_range_size ((_ int2bv 64) 1)))
  var1) (bvule var1 ((_ int2bv 64) 18446744073709551615)))
  (bvule var1 (bvsub (bvsub (bvadd (bvsub var1_range_size ((_ int2bv 64) 1))
  var2_range_size) (bvsub ((_ int2bv 64) 18446744073709551615) (bvsub
  var2 (bvsub var1_range_size ((_ int2bv 64) 1))))) ((_ int2bv 64) 2))))))))))
...
;; H
  (assert
  (= (mk_bool__ref x86__rangesintersect__result4) (mk_bool__ref
                                                  x86__rangesintersect__result2)))
...
(assert
;; WP_parameter_def
 ;; File "x86.ads", line 85, characters 0-0
  (not
  (= (inrange64 var1 (bvsub var2 (bvsub var1_range_size ((_ int2bv 64) 1)))
     (bvadd (bvsub var1_range_size ((_ int2bv 64) 1)) var2_range_size)) true)))
(check-sat)
(exit)
