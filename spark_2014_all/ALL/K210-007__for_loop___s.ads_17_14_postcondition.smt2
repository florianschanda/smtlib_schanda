...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___188 index1)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___189 src)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___186 src)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___184 dest)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 10)) (= temp___190 src)))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= index2 j) (<= j 10))
  (= (to_rep (select dest3 j)) (to_rep (select temp___189 j)))))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (- index2 1)))
  (= (to_rep (select src3 j)) (to_rep (select temp___190 j))))))))
...
;; H
  ...
  (=> (< temp___185 index2)
  (= (select dest3 temp___185) (select temp___184 temp___185)))))
  (forall ((temp___187 Int))
  (=> (and (<= 1 temp___187) (<= temp___187 10))
  (=> (< temp___187 index2)
  (= (select src3 temp___187) (select temp___186 temp___187))))))
