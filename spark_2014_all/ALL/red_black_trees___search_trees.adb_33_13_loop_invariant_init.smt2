...
(define-fun dynamic_invariant3 ((temp___expr_273 us_rep4)
...
(define-fun default_initial_assumption1 ((temp___expr_276 us_rep4)
...
;; size__post_axiom
  (assert
  (forall ((f us_rep4))
  (! (=> (dynamic_invariant3 f true true true) (dynamic_invariant2 (size f)
...
(define-fun dynamic_invariant4 ((temp___expr_150 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_376 us_rep5)
...
(define-fun default_initial_assumption3 ((temp___expr_380 us_rep5)
...
;; size__post_axiom
  ...
  (! (=> (and (dynamic_invariant6 t true true true) (type_invariant1 t))
     (dynamic_invariant2 (size1 t) true false true)) :pattern ((size1 t)) )))
...
(define-fun default_initial_assumption4 ((temp___expr_252 us_rep2)
...
(define-fun dynamic_predicate ((temp___211 us_rep1)) Bool (< (length1
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields1
                                                             temp___211))) 100))
...
(define-fun default_initial_assumption6 ((temp___expr_199 us_rep)
  (temp___skip_top_level_200 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_200 true))
                                         (= (length1 temp___expr_199) 0)))
...
(define-fun dynamic_invariant11 ((temp___expr_192 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_186 Int)
  (temp___is_init_183 Bool) (temp___skip_constant_184 Bool)
  (temp___do_toplevel_185 Bool)) Bool (=>
                                      (or (= temp___is_init_183 true)
                                      (<= 0 1)) (in_range9 temp___expr_186)))
...
(declare-fun temp___625 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___625 (model__
                ...
                o1))
  (and (dynamic_invariant5 temp___625 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___625 o1))) true)
  (and
  (= (length1
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___625 o1)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i o1))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___625 (parent
                             (rec__search_trees__search_tree__struct
                             (us_split_fields7 t)) i)))) true))
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 i))) true)
  (not
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 i))) true))))))
  (and
  (forall ((i Int))
  ...
  (ite (and
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___625 i))) true)
       (not (= i o1)))
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1
     ...
     i)
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 i)))) true)
  (= (length1
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 i))) true)
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___625 j2))) true)
  (= (oeq
     (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___625 j2)))) true))
  (= j2 i))))))))))))))

;; H
  (assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___625 j1)))
