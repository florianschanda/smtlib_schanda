...
;; H
  ...
  (= (oeq
     ...
     (omultiply
     (num_of_big_int
     (mk___t aux41 (mk (to_rep aux4__first) (to_rep aux4__last))) o7
     (+ (- a_last a_first) 1))
     (num_of_big_int
     (mk___t aux2 (mk (to_rep aux2__first) (to_rep aux2__last))) aux2_first
     (+ (- a_last a_first) 1)))
...
;; H
  (assert
  (forall ((k1 Int))
  (=> (and (<= (to_rep aux4__first) k1) (<= k1 (to_rep aux4__last)))
  (and
  (=> (and (<= o13 k1) (<= k1 (- (+ o13 a_last) a_first)))
  (= (to_rep1 (select aux42 k1)) (to_rep1 (select a (- (+ a_first k1) o13)))))
  (=> (=> (<= o13 k1) (not (<= k1 (- (+ o13 a_last) a_first))))
  (= (to_rep1 (select aux42 k1)) (to_rep1 (select aux41 k1))))))))
...
;; H
  (assert (and (= o22 (* 2 n)) (in_range1 (* 2 n))))
...
;; H
  (assert (= o21 (num_of_big_int x x_first o20)))

;; H
  (assert (= o26 (oexpon o21 o25)))

;; H
  (assert (= o30 (omultiply o26 o29)))
