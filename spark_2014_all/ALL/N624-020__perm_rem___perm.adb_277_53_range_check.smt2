...
;; H
  ...
  (and (= (to_rep2 (last (rt o25))) (- (to_rep2 (last (rt o24))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o24) k)) (to_rep (select (elts o25) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o24)))))
  (= (to_rep (select (elts o24) k)) (to_rep (select (elts o25) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o24))) 1)))
  (= (to_rep (select (elts o24) (+ k 1))) (to_rep (select (elts o25) k))))))))))))
