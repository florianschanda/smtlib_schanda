...
(declare-fun types__t3__c__first__bit () Int)

(declare-fun types__t3__c__last__bit () Int)

(declare-fun types__t3__c__position () Int)
...
(declare-fun to3__split_fields () Bool)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun to11 () Int)

(declare-fun result1 () Int)

(declare-fun to21 () Int)

(declare-fun to22 () Int)
...
;; H
  (assert (and (not (= (of_int 1) true)) (= (r Tuple0) true)))
...
;; H
  (assert (dynamic_invariant1 to21 true false true))

;; H
  (assert
  (and (= to3__split_fields (of_int 1))
  (and (= (r Tuple0) true) (= (func Tuple0) true))))

;; H
  (assert (dynamic_invariant1 to22 true true true))

(assert
;; WP_parameter_def
 ;; File "types.ads", line 24, characters 0-0
  (not (type_invariant to11)))
(check-sat)
(exit)
