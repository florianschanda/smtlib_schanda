...
(declare-fun temp___981 () natural)

(declare-fun temp___9811 () (Array Int value))

(declare-fun temp___9812 () t1)
...
(declare-fun a__split_fields4 () us_split_fields__ref)

(declare-fun right9 () int__ref)

(declare-fun left9 () int__ref)

(declare-fun a__split_fields5 () us_split_fields)
...
(declare-fun a__split_fields6 () us_split_fields__ref)

(declare-fun right11 () int__ref)

(declare-fun left11 () int__ref)

(declare-fun a__split_fields7 () us_split_fields)

(declare-fun right12 () Int)

(declare-fun left12 () Int)

(declare-fun a__split_fields8 () us_split_fields__ref)
...
(define-fun a__split_fields10 () us_split_fields (mk___split_fields
...
;; H
  (assert (= temp___984 left1))

;; H
  (assert (= temp___983 right1))

;; H
  (assert
  (and (= a__split_discrs (mk___split_discrs temp___981))
  (and (= a__split_fields temp___9811) (= a__split_fields1 temp___9812))))

;; H
  (assert
  (and
  (and
  (and (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields10) true
  true true)
  (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___981))
...
;; H
  (assert (= a__split_fields4 (mk___split_fields__ref a__split_fields10)))
...
;; H
  (assert (= a__split_fields5 a__split_fields10))

;; H
  (assert (<= (int__content right7) (int__content left7)))

;; H
  (assert (= left11 left9))

;; H
  (assert (= right11 right9))

;; H
  (assert (= a__split_fields6 a__split_fields4))
...
;; H
  (assert (= a__split_fields7 a__split_fields5))
...
;; H
  (assert (= a__split_fields8 a__split_fields6))
...
;; H
  (assert (= a__split_fields9 a__split_fields7))

;; H
  (assert (< first4 (int__content right13)))

;; H
  (assert
  (and (= o23 (- (int__content right13) 1)) (in_range2
  (- (int__content right13) 1))))

(assert
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 126, characters 0-0
  (not (or (= o23 0) (<= first4 o23))))
(check-sat)
(exit)
