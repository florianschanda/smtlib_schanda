...
(declare-const temp___981 natural)

(declare-const temp___9811 (Array Int value))

(declare-const temp___9812 t1)
...
(declare-const a__split_fields4 us_split_fields__ref)

(declare-const right9 int__ref)

(declare-const left9 int__ref)

(declare-const a__split_fields5 us_split_fields)
...
(declare-const a__split_fields6 us_split_fields__ref)
...
(declare-const a__split_fields8 us_split_fields__ref)
