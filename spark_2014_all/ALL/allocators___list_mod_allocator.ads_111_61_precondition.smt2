...
(declare-fun list_mod_allocator__free__C112b__assume () us_rep1)

(declare-fun list_mod_allocator__free__B113b__L_4__R114b__assume () Int)
...
;; H
  (assert
  (=> (= result true)
  (= list_mod_allocator__free__C112b__assume (rec__list_mod_allocator__m__t__available
                                             o21))))

;; H
  (assert
  (=> (= result true) (= list_mod_allocator__free__C112b__assume c112b)))

;; H
  (assert
  (=> (= result true)
  (and (= list_mod_allocator__free__B113b__L_4__R114b__assume (length c111b))
  (and (in_range5 list_mod_allocator__free__B113b__L_4__R114b__assume)
  (<= (+ 0 list_mod_allocator__free__B113b__L_4__R114b__assume) 2147483647)))))

;; H
  (assert
  (=> (= result true)
  (= list_mod_allocator__free__B113b__L_4__R114b__assume r114b)))
...
;; H
  (assert
  (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= temp___318 i2))))

;; H
  (assert
  (=> (= result true)
  (=> (and (<= 1 i2) (<= i2 r114b)) (<= (+ i3 1) (length c112b)))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r114b))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i3)) (= (get c111b j) (get c112b (+ j 1))))))))
...
;; H
  ...
  (=> (and (<= 1 i2) (<= i2 r114b))
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (+ i3 1))) (= (get c111b (- j 1)) (get c112b j)))))))

;; H
  (assert
  (=> (= result true)
  (=> (and (<= 1 i2) (<= i2 r114b))
  (and (=> (<= 1 r114b) (dynamic_property 1 r114b i3))
  (and (<= 1 i3) (<= i3 r114b))))))
...
;; H
  ...
  (= (get c112b j) (to_rep
                   (rec__list_mod_allocator__cell__next
                   (us_split_fields1 (select data2 (get c111b i3))))))))))))

;; H
  (assert
  (=> (= result true) (=> (and (<= 1 i2) (<= i2 r114b)) (= i3 r114b))))

;; H
  (assert
  (=> (= result true)
  (=> (and (<= 1 i2) (<= i2 r114b)) (= i4 (mk_int__ref i3)))))
...
;; H
  (assert
  (=> (= result true)
  (=> (not (and (<= 1 i2) (<= i2 r114b))) (= i6 (mk_int__ref i2)))))

;; H
  (assert
  (=> (= result true) (=> (not (and (<= 1 i2) (<= i2 r114b))) (= i7 i2))))
