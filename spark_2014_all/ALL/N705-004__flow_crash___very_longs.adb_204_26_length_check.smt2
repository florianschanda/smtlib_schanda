...
(declare-datatypes ()
((tT61bP1__ref (mk_tT61bP1__ref (tT61bP1__content tdigit_index_typeB)))))
...
(declare-datatypes ()
((t62b__ref (mk_t62b__ref (t62b__content tdigit_index_typeB)))))
...
(declare-fun temp___908 () (Array Int octet))

(declare-fun temp___9081 () t2)

(declare-fun temp___909 () (Array Int octet))

(declare-fun temp___9091 () t1)
