...
;; H
  (assert (= o50 (ite (<= o49 k) true false)))

;; H
  (assert
  (= result7 (ite (= o50 true) (ite (<= k a_last) true false) false)))
...
;; H
  (assert (= o46 (num_of_boolean carry3)))
...
;; H
  (assert (and (= o35 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o36 (- o35 a_first)))
...
;; H
  (assert
  (= o39 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o38)))

;; H
  (assert (= o48 (osubtract o39 o47)))
...
;; H
  (assert (= o34 (num_of_big_int b b_first o33)))
