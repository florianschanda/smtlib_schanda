...
;; H
  (assert (and (= o9 (ccwdiff o7 o8)) (tqtisFinite o9)))

;; H
  (assert (= result4 (ite (lt o9 fliteral4) true false)))
...
;; H
  (assert (and (= o12 (ccwdiff o10 o11)) (tqtisFinite o12)))

;; H
  (assert (= o13 (div2 RNE1 o12 fliteral5)))
