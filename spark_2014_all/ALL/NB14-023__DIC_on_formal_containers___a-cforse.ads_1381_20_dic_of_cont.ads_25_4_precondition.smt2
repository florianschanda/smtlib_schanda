...
(define-fun us_split_discrs___7__projection ((a us_split_discrs)) count_type
...
(define-fun us_rep___19__projection ((a us_rep)) us_split_discrs (us_split_discrs1
                                                                 a))

(define-fun us_rep___20__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(((mk___split_fields1 (rec__dic_of_cont__my_orse__cursor__node count_type)))))
(define-fun us_split_fields_Node__5__projection ((a us_split_fields2)) count_type
  (rec__dic_of_cont__my_orse__cursor__node a))
...
(define-fun us_rep___21__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))

(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__dic_of_cont__my_orse__cursor__node
...
;; dic_of_cont__my_orse__cursor__node__first__bit_axiom
  (assert (<= 0 dic_of_cont__my_orse__cursor__node__first__bit))

;; dic_of_cont__my_orse__cursor__node__last__bit_axiom
  (assert
  (< dic_of_cont__my_orse__cursor__node__first__bit dic_of_cont__my_orse__cursor__node__last__bit))

;; dic_of_cont__my_orse__cursor__node__position_axiom
...
(define-fun cursor__ref___5__projection ((a cursor__ref)) us_rep1 (cursor__content
                                                                  a))
...
(define-fun key_type__ref___9__projection ((a key_type__ref)) us_rep1
  (key_type__content a))
...
(define-fun element_type__ref___19__projection ((a element_type__ref)) element_type
  (element_type__content a))

(define-fun dynamic_invariant ((temp___expr_1337 Int)
  (temp___is_init_1334 Bool) (temp___skip_constant_1335 Bool)
  (temp___do_toplevel_1336 Bool)) Bool (=>
                                       (or (= temp___is_init_1334 true)
...
(define-fun default_initial_assumption ((temp___expr_1344 us_rep2)
  (temp___skip_top_level_1345 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1345 true))
                                          (and
                                          (= (is_empty temp___expr_1344) true)
                                          (= (length temp___expr_1344) 0))))
...
;; length__post__dispatch_axiom
  ...
  (forall ((container1 us_rep)) (! (dynamic_invariant1
...
(define-fun sequence__ref___5__projection ((a sequence__ref)) us_rep3
  (sequence__content a))
...
(define-fun element_type__ref___16__projection ((a element_type__ref1)) element_type1
  (element_type__content1 a))

(define-fun dynamic_invariant2 ((temp___expr_1260 Int)
...
(define-fun default_initial_assumption1 ((temp___expr_1324 us_rep3)
  (temp___skip_top_level_1325 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1325 true))
                                          (= (length3 temp___expr_1324) 0)))
...
(define-fun set__ref___4__projection ((a set__ref1)) us_rep4 (set__content1
                                                             a))
...
(define-fun default_initial_assumption2 ((temp___expr_1293 us_rep4)
  (temp___skip_top_level_1294 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1294 true))
                                          (= (is_empty1 temp___expr_1293) true)))
...
;; model____post_axiom
  (assert
  (forall ((container1 us_rep))
  (! (= (length4 (model__ container1)) (length1 container1)) :pattern (
  (model__ container1)) )))
...
(define-fun element_type__ref___17__projection ((a element_type__ref2)) element_type2
...
(define-fun extended_index__ref___5__projection ((a extended_index__ref)) extended_index
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (=>
     (and (in_range5 temp___1358)
     (= (iter_has_element result temp___1358) true))
     (= (contains (model__ container1) (get1 result temp___1358)) true))))
     (forall ((item Int))
     (=> (and (in_range4 item) (= (contains (model__ container1) item) true))
...
(define-fun dynamic_invariant3 ((temp___expr_1286 Int)
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep4)) (! (dynamic_invariant1 (length4 container1)
...
;; is_empty__post_axiom
  ...
  (! (let ((result (is_empty1 container1)))
     ...
     (= (= result true)
     (forall ((item Int))
     (not (and (in_range4 item) (= (contains container1 item) true)))))
     (= (= result true) (= (length4 container1) 0)))) :pattern ((is_empty1
                                                                container1)) )))

(define-fun dynamic_invariant4 ((temp___expr_1317 Int)
...
(define-fun element_type__ref___18__projection ((a element_type__ref3)) element_type3
  (element_type__content3 a))

(define-fun dynamic_invariant5 ((temp___expr_1311 Int)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant5 (get1 container1 position) true false true)) :pattern (
...
(declare-const temp___2172 count_type)
...
;; H
  (assert (= temp___2172 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___2172)) no_element))

;; H
  (assert
  (or
  (= (has_key (positions container)
     (mk___rep1 (mk___split_fields1 position__split_fields))) true)
  (= (bool_eq1 (mk___rep1 (mk___split_fields1 position__split_fields))
     no_element) true)))
...
(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 1360, characters 0-0
  (not
  (= (has_key o2 (mk___rep1 (mk___split_fields1 position__split_fields))) true)))
(check-sat)
(exit)
