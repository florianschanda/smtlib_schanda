...
(declare-fun fake_socket_package__fake_socket__ready__first__bit () Int)

(declare-fun fake_socket_package__fake_socket__ready__last__bit () Int)

(declare-fun fake_socket_package__fake_socket__ready__position () Int)
...
(declare-fun fake_socket_package__fake_socket__buffer__first__bit () Int)

(declare-fun fake_socket_package__fake_socket__buffer__last__bit () Int)

(declare-fun fake_socket_package__fake_socket__buffer__position () Int)
...
(declare-datatypes ()
((fake_socket__ref (mk_fake_socket__ref (fake_socket__content us_rep)))))
