...
(declare-fun dummy1 () state_range)
...
(declare-fun dummy2 () (Array Int unsigned_32))
...
(declare-fun mat () (Array (_ BitVec 32) unsigned_32))
...
(declare-fun upper_mask () (_ BitVec 32))

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun lower_mask () (_ BitVec 32))
...
(declare-fun o9 () (Array Int unsigned_32))

(declare-fun o10 () (Array Int unsigned_32))

(declare-fun o11 () state_range)

(declare-fun temp___317 () (Array Int unsigned_32))

(declare-fun temp___3171 () state_range)

(declare-fun result () (_ BitVec 32))

(declare-fun value1 () (_ BitVec 32))

(declare-fun result1 () (Array Int unsigned_32))

(declare-fun result2 () state_range)
...
;; H
  (assert
  (=>
  (and (<= 0 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 226))
  (and (= o5 (+ (to_rep1 g__split_fields1) 397)) (in_range1
  (+ (to_rep1 g__split_fields1) 397)))))
...
;; H
  ...
  (and (<= 0 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 226)))
  (=>
  (and (<= 227 (to_rep1 g__split_fields1))
  (<= (to_rep1 g__split_fields1) 622))
  (and (= o5 (+ (to_rep1 g__split_fields1) (- 227))) (in_range1
  (+ (to_rep1 g__split_fields1) (- 227)))))))
...
;; H
  ...
  (not
  (and (<= 227 (to_rep1 g__split_fields1))
  (<= (to_rep1 g__split_fields1) 622))) (= o5 396))))
...
;; H
  (assert (= o9 (store g__split_fields (to_rep1 g__split_fields1) o8)))
...
;; H
  (assert (= temp___317 o10))

;; H
  (assert (= temp___3171 o11))
...
;; H
  (assert (= g__split_fields2 temp___317))

;; H
  (assert (= g__split_fields3 temp___3171))

(assert
;; WP_parameter_def
 ;; File "random.ads", line 68, characters 0-0
  (not (bvule ((_ int2bv 32) 0) (bvand value1 ((_ int2bv 32) 1)))))
(check-sat)
(exit)
