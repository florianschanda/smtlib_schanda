...
;; H
  (assert
  (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields2) true
...
;; H
  (assert
  (and (= o6 (shift_right product1 8))
  (= o6 (bvudiv product1 (ite (< 8 65536)
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields2))))
  temp___1543)
  (<= temp___1543 (to_rep2
                  (last3
                  (rt1
...
;; H
  (assert
  (= result6 (ite (bvuge o11 (bvadd temporary_digit1 current_borrow2)) true
             false)))
