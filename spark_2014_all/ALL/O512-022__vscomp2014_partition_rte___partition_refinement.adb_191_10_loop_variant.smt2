...
;; H
  (assert
  (and (= o5 (element x (mk___rep c__split_fields3)))
  (and (in_range7 o5)
  (= o5 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields3)))))))
...
;; H
  ...
  (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) (capacity
                                                             ...
                                                             p__split_fields2)))
  (and
  (= (length2 (mk___rep5 p__split_discrs p__split_fields3)) (length2
                                                            (mk___rep5
                                                            p__split_discrs
                                                            p__split_fields2)))
  (and
  ...
  (= (oeq2 (keys (mk___rep3 d__split_discrs d__split_fields2))
     (keys (mk___rep3 d__split_discrs d__split_fields3))) true)))))))

;; H
  (assert
  (ite (= (ite (= (bool_eq1 (mk___rep c__split_fields3) no_element) false) (=
          (get (positions x) (mk___rep c__split_fields3)) (length x)) true) true)
  (= (bool_eq1 (mk___rep c__split_fields4) no_element) true)
  (and (= (has_key (positions x) (mk___rep c__split_fields4)) true)
  (= (get (positions x) (mk___rep c__split_fields4)) (+ (get (positions x)
                                                        (mk___rep
                                                        c__split_fields3)) 1)))))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 807, characters 0-0
  (not
  (< temp___11421 (ite (= (bool_eq1 (mk___rep c__split_fields4) no_element) true)
                  (length x)
                  (- (get (positions x) (mk___rep c__split_fields4)) 1)))))
(check-sat)
(exit)
