...
(define-fun result6 () cursor__ref (mk_cursor__ref
...
;; H
  ...
  (and
  (and (= o7 (first l))
  (ite (= (= (length2 l) 0) true) (= (bool_eq2 o7 no_element) true)
  (and (= (has_key (positions l) o7) true) (= (get1 (positions l) o7) 1))))
  (and (= result6 cu11) (= cu1 o7)))
  (and
...
;; H
  ...
  (= (mk___rep1 (mk___split_fields1 result7)) (cursor__content
                                              for_loops_on_lists__search_0_for_in__result13)))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  ...
  (= (element l
     (cursor__content for_loops_on_lists__search_0_for_in__result13)) 0))
  (and
  (= (bool_eq2
     (cursor__content for_loops_on_lists__search_0_for_in__result13)
     no_element) true)
  (let ((temp___475 (model__ l)))
  (forall ((temp___474 Int))
  (=>
  (and (in_range2 temp___474)
  (= (iter_has_element temp___475 temp___474) true))
  (not (= (get temp___475 temp___474) 0)))))))))
(check-sat)
