...
(declare-fun lsc__bignum__bit_set__result () Bool)

(declare-fun o () Int)

(declare-fun o1 () Int)

(declare-fun temp___751 () Int)
...
(declare-fun lsc__bignum__bit_set__result1 () Bool)

(declare-fun lsc__bignum__bit_set__result2 () Bool)

(declare-fun lsc__bignum__bit_set__result3 () Bool)

(declare-fun lsc__bignum__bit_set__result4 () Bool)

(declare-fun lsc__bignum__bit_set__result5 () Bool)
...
;; H
  (assert (= result1 lsc__bignum__bit_set__result4))

;; H
  (assert (= lsc__bignum__bit_set__result4 true))
...
;; WP_parameter_def
 ;; File "lsc-bignum.adb", line 391, characters 0-0
  ...
  (not
  (= (bvand (to_rep
            (select (elts a) (+ a_first (bv2nat (bvudiv i ((_ int2bv 64) 32)))))) 
  (let ((temp___755 (bv2nat (bvurem i ((_ int2bv 64) 32)))))
  (ite (< temp___755 4294967296)
  (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___755)) ((_ int2bv 32) 0)))) ((_ int2bv 32) 0)))))
(check-sat)
