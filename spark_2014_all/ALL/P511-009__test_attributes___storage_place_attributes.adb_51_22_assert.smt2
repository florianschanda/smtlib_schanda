...
(define-fun us_split_fields_F1__projection ((a us_split_fields)) Bool
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (= (rec__storage_place_attributes__r1__f1
                           (us_split_fields1 a)) (rec__storage_place_attributes__r1__f1
                                                 (us_split_fields1 b)))
                   true false))
...
(declare-fun storage_place_attributes__r1__f1__first__bit () Int)

(declare-fun storage_place_attributes__r1__f1__last__bit () Int)

(declare-fun storage_place_attributes__r1__f1__position () Int)
...
(define-fun default_initial_assumption ((temp___expr_179 us_rep)
  (temp___skip_top_level_180 Bool)) Bool (= (attr__tag temp___expr_179)
  us_tag))
