...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields4))
     (last1 (mk___rep l__split_discrs l__split_fields4))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields4)))
  (= (keys_included_except
     ...
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (last1 (mk___rep l__split_discrs l__split_fields4))) true))
  (= (ole1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (positions (mk___rep l__split_discrs l__split_fields4))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields4))
     (length (mk___rep l__split_discrs l__split_fields4))) 0))
  (= (ole
  ...
  (= (range_shifted
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (model__ (mk___rep l__split_discrs l__split_fields4))
     (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 
     cu)
...
;; H
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields4))
     ...
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields4)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields4))
     (model__ (mk___rep l__split_discrs l__split_fields3))
     (get1 (positions (mk___rep l__split_discrs l__split_fields4)) cu)
     (length (mk___rep l__split_discrs l__split_fields4)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields3))
     (get1 (positions (mk___rep l__split_discrs l__split_fields4)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields4))
     (positions (mk___rep l__split_discrs l__split_fields3))
     (get1 (positions (mk___rep l__split_discrs l__split_fields4)) cu) 1) true)))))
...
;; WP_parameter_def
 ;; File "a-cofuve.ads", line 75, characters 0-0
  (not
  (< (length (mk___rep l__split_discrs l__split_fields3)) (to_rep
                                                          (rec__use_lists__my_lists__list__capacity
                                                          l__split_discrs)))))
(check-sat)
