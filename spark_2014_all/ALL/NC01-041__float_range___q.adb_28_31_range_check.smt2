...
;; of_ubv32_to_real
  ...
  (= (tqtreal (of_ubv32 m x)) (round m (to_real (bv2nat x))))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 2500000000000000000000000.0 10000000000000000000000000.0))))
...
(declare-fun dummy2 () scale_t)

(declare-datatypes ()
((scale_t__ref (mk_scale_t__ref (scale_t__content scale_t)))))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 32.0)))
...
(declare-fun raw_in () (_ BitVec 16))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 3276800048828125.0 1000000000000.0))))

(declare-fun fliteral5 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral5) (= (tqtreal fliteral5) 10.0)))

(declare-fun fliteral6 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral6) (= (tqtreal fliteral6) 20.0)))
...
;; H
  (assert (in_range2 scale))

;; H
  (assert (=> (le (neg fliteral3) fliteral3) (in_range3 value)))
...
;; H
  (assert (= x1 (div1 RNE1 (of_ubv16 RNA1 raw_in) fliteral4)))

;; H
  (assert
  (=> (le fliteral5 x1)
  (and (= o (sub RNE1 x1 fliteral6)) (tqtisFinite (sub RNE1 x1 fliteral6)))))

;; H
  (assert (=> (le fliteral5 x1) (= result1 x1)))

;; H
  (assert (=> (le fliteral5 x1) (= x2 o)))

;; H
  (assert (=> (not (le fliteral5 x1)) (= x2 x1)))

;; H
  (assert (and (le (neg fliteral6) x2) (le x2 fliteral6)))

;; H
  (assert
  (and (= o1 (div1 RNE1 x2 scale)) (tqtisFinite (div1 RNE1 x2 scale))))
...
;; H
  (assert (not (le fliteral3 x3)))

;; H
  (assert (not (le x3 (neg fliteral3))))
