...
(define-fun register_type__ref___129__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___91__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___91__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5244 us_t1)
  (temp___is_init_5241 Bool) (temp___skip_constant_5242 Bool)
  (temp___do_toplevel_5243 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5242 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5244)
                                       (last3 temp___expr_5244))
                                       (and (= (first3 temp___expr_5244) 1)
                                       (= (last3 temp___expr_5244) 1)))))
