...
;; H
  ...
  (<= j (last5
        (model__
        (mk___rep v__split_discrs (mk___split_fields v__split_fields))))))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields2)) j) (get
                                                                   (model__
                                                                   (mk___rep
                                                                   v__split_discrs
                                                                   (mk___split_fields
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= first j) (<= j (- i2 1)))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields2))
     (+ j (length
          (mk___rep v__split_discrs (mk___split_fields v__split_fields)))))
  (get
...
;; H
  (assert (and (= o1 (- i2 first)) (in_range1 (- i2 first))))
