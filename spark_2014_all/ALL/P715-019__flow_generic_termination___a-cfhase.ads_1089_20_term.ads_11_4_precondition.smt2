...
(((mk___split_fields (rec__term__tset__set us_main_type)))))
...
(((mk___split_fields1 (rec__term__tset__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type
  (rec__term__tset__cursor__node a))
...
(declare-const term__tset__cursor__node__first__bit Int)

(declare-const term__tset__cursor__node__last__bit Int)

(declare-const term__tset__cursor__node__position Int)

;; term__tset__cursor__node__first__bit_axiom
  (assert (<= 0 term__tset__cursor__node__first__bit))

;; term__tset__cursor__node__last__bit_axiom
  (assert
  (< term__tset__cursor__node__first__bit term__tset__cursor__node__last__bit))

;; term__tset__cursor__node__position_axiom
  (assert (<= 0 term__tset__cursor__node__position))
...
(define-fun default_initial_assumption1 ((temp___expr_361 us_rep4)
...
(define-fun default_initial_assumption2 ((temp___expr_392 us_rep3)
...
(declare-const temp___709 count_type)
...
;; H
  (assert (= temp___709 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___709)) no_element))
...
;; H
  ...
  (and (in_range1 o3)
  (<= o3 (to_rep
         (rec__term__tset__set__capacity (us_split_discrs1 container)))))))
