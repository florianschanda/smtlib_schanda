...
(declare-fun term__tset__cursor__node__first__bit () Int)

(declare-fun term__tset__cursor__node__last__bit () Int)

(declare-fun term__tset__cursor__node__position () Int)
...
(declare-fun temp___709 () count_type)
