...
;; H
  (assert (and (= o25 (- e_last e_first)) (in_range1 (- e_last e_first))))

;; H
  (assert (and (= o26 o25) (uint_in_range1 o25)))

;; H
  (assert (= o27 ((_ int2bv 64) o26)))

;; H
  (assert (= o28 (bvadd o27 ((_ int2bv 64) 1))))

;; H
  (assert (= o29 (bvmul o28 ((_ int2bv 64) 32))))

;; H
  (assert (= o30 (ite (bvult i2 o29) true false)))
...
;; H
  (assert (= o20 (from_integer s10)))

;; H
  (assert (= o24 (ole o20 o23)))

;; H
  (assert (and (= o18 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o19 (ite (<= s10 o18) true false)))

;; H
  (assert (= o16 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o17 (oexpon o16 s10)))

;; H
  (assert (= o12 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o11 (from_integer s10)))

;; H
  (assert (= o13 (osubtract o11 o12)))

;; H
  (assert (= o10 (from_word64 i2)))

;; H
  (assert (= o14 (osubtract o10 o13)))

;; H
  (assert (= o9 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o15 (oexpon__2 o9 o14)))
