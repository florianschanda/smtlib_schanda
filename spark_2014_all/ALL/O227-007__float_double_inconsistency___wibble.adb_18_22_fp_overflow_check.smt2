...
(define-fun t__ref___projection ((a t__ref2)) t1 (t__content2 a))
...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 11.0)))
...
;; H
  (assert
  (and (bvult x ((_ int2bv 32) 1000000)) (le state
  (mul RNE1 (of_ubv32 RNA1 x) fliteral2))))

(assert
;; WP_parameter_def
 ;; File "wibble.adb", line 51, characters 0-0
  (not (tqtisFinite (add RNE1 state fliteral3))))
(check-sat)
