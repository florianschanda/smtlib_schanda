...
(((mk_t108b__ref (t108b__content tdigit_index_typeB)))))
...
;; H
  ...
  (= o5 (select (elts
                (rec__very_longs__very_long__long_digits
                (us_split_fields1 number))) o4)))

;; H
  (assert (= o6 (to_rep1 o5)))

;; H
  (assert (= o7 (ite (= o6 ((_ int2bv 8) 0)) true false)))

;; H
  (assert (= result5 (ite (not (= o7 true)) true false)))

;; H
  (assert (=> (= result5 true) (= result6 digit_index3)))

;; H
  (assert (=> (= result5 true) (= digit_index4 i3)))

;; H
  (assert (=> (not (= result5 true)) (= digit_index4 digit_index3)))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 5, characters 0-0
  ...
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 number))) digit_index4)) ((_ int2bv 8) 0)))
  (exists ((j Int))
  (and
  (and (<= (+ i3 1) j)
  (<= j (to_rep2
