...
(declare-const result3 (Array Int (Array Int (Array Int et1))))

(declare-const a4 (Array Int (Array Int (Array Int et1))))

(declare-const a5 (Array Int (Array Int (Array Int et1))))

(declare-const a6 (Array Int (Array Int (Array Int et1))))
...
;; H
  (assert (= a3 (store a2 i (store (select a2 i) j d))))

;; H
  (assert (= (to_rep o) e))

;; H
  (assert (= o1 (store (select (select a3 i) j) k o)))

;; H
  (assert (= o2 (store (select a3 i) j o1)))

;; H
  (assert (= o3 (store a3 i o2)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 560, characters 0-0
  (not (in_range4 (to_rep (select (select (select a5 o4) n) m)))))
(check-sat)
(exit)
