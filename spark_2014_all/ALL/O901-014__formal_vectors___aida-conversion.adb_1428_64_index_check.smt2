...
;; H
  (assert
  (and (= o33 (+ (to_rep1 (first (rt source))) 10)) (in_range1
  (+ (to_rep1 (first (rt source))) 10))))

;; H
  (assert (= o34 (ite (<= index o33) true false)))

;; H
  (assert
  (and (= o32 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert (= o35 (ite (<= o32 index) true false)))
...
;; H
  ...
  (forall ((index1 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 8) index1)
  (<= index1 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index1))) true)))))

;; H
  (assert
  (and (= temp___1896 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1896)
  (<= temp___1896 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1895 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1895)
  (<= temp___1895 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1894 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1894)
  (<= temp___1894 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1893 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1893)
  (<= temp___1893 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1892 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1892)
  (<= temp___1892 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1891 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1891)
  (<= temp___1891 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1890 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1890)
  (<= temp___1890 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___1890))
...
;; H
  (assert
  (and (= temp___1889 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1889)
  (<= temp___1889 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1889))
...
;; H
  (assert
  (and (= temp___1888 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1391, characters 0-0
  (not (<= (to_rep1 (first (rt source))) temp___1888)))
(check-sat)
(exit)
