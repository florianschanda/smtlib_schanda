...
(declare-datatypes ((bit__ref 0)) (((mk_bit__ref (bit__content bit)))))
...
(declare-datatypes ((n__ref 0)) (((mk_n__ref (n__content n)))))
...
(declare-datatypes ((sum__ref 0)) (((mk_sum__ref (sum__content sum)))))
...
(((mk_map__ref (map__content (Array Int bit))))))
...
(((mk_map__ref1 (map__content1 (Array Int (Array Int bit)))))))
...
(define-fun bool_eq1 ((a (Array Int (Array Int bit))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq (select a temp___idx_133) 0 9
...
;; H
  (assert
  (and (= o1 (+ r3 (to_rep (select (select x i1) j3)))) (in_range4
  (+ r3 (to_rep (select (select x i1) j3))))))
