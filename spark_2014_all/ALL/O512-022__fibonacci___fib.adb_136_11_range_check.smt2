...
;; H
  ...
  (forall ((i14 Int))
  (=> (and (<= (+ k1 1) i14) (<= i14 100))
  (= (to_rep (select c1 (- i14 k1))) (to_rep (select c2 (- i14 k2)))))))))))))
...
;; H
  (assert
  (=> (and (<= temp___202 i8) (<= i8 0))
  (and (= temp___199 (- i9 k1)) (in_range1 (- i9 k1)))))
...
;; H
  (assert
  (=> (and (<= temp___202 i8) (<= i8 0)) (and (<= 0 i9) (<= i9 100))))
...
;; H
  (assert
  (=> (and (<= temp___202 i8) (<= i8 0)) (= a114 (mk_map__ref a110))))
...
;; H
  (assert
  (=> (not (and (<= temp___202 i8) (<= i8 0))) (= i12 (mk_int__ref i8))))
