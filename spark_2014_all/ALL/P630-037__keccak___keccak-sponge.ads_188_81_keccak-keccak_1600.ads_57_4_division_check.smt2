...
(declare-datatypes ((t106s__ref 0))
(((mk_t106s__ref (t106s__content integer)))))
...
(((mk_t107s__ref (t107s__content us_t1)))))
...
(((mk_t109s__ref (t109s__content integer)))))
...
(((mk_t110s__ref (t110s__content us_t2)))))
...
(declare-const ctx__split_fields32 us_split_fields__ref)

(declare-const suffix_array5 map__ref)
...
(declare-const ctx__split_fields33 us_split_fields)

(declare-const suffix_array6 (Array Int byte))
