...
;; H
  (assert (= o40 (ite (<= o39 (to_rep (last (rt x)))) true false)))

;; H
  (assert (and (= o34 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o35 (+ x_first o34)))

;; H
  (assert (and (= o36 o35) (in_range1 o35)))

;; H
  (assert (= o41 (ite (<= (to_rep (first (rt x))) o36) true false)))

;; H
  (assert (= result (ite (= o41 true) o40 false)))
...
;; H
  (assert (= o32 (ite (<= o31 (to_rep (last (rt m)))) true false)))

;; H
  (assert (and (= o26 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o27 (+ m_first o26)))

;; H
  (assert (and (= o28 o27) (in_range1 o27)))

;; H
  (assert (= o33 (ite (<= (to_rep (first (rt m))) o28) true false)))

;; H
  (assert (= result1 (ite (= o33 true) o32 false)))
...
;; H
  (assert (= o24 (ite (<= o23 (to_rep aux1__last)) true false)))

;; H
  (assert (and (= o18 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o19 (+ aux1_first o18)))

;; H
  (assert (and (= o20 o19) (in_range1 o19)))

;; H
  (assert (= o25 (ite (<= (to_rep aux1__first) o20) true false)))
...
;; H
  (assert (= o16 (ite (<= o15 (to_rep aux2__last)) true false)))

;; H
  (assert (and (= o10 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o11 (+ aux2_first o10)))

;; H
  (assert (and (= o12 o11) (in_range1 o11)))

;; H
  (assert (= o17 (ite (<= (to_rep aux2__first) o12) true false)))

;; H
  (assert (= result3 (ite (= o17 true) o16 false)))
...
;; H
  (assert (= o8 (ite (<= o7 (to_rep aux3__last)) true false)))

;; H
  (assert (and (= o2 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o3 (+ aux3_first o2)))

;; H
  (assert (and (= o4 o3) (in_range1 o3)))

;; H
  (assert (= o9 (ite (<= (to_rep aux3__first) o4) true false)))
