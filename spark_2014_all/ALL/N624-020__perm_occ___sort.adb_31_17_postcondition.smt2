...
(define-fun dynamic_invariant7 ((temp___expr_201 us_t2)
...
;; H
  ...
  (= (is_set
     ...
     (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))) true)
  (= (is_set
     (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
     y (to_rep (select (elts1 init) x))
     (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))))
...
;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= temp___268 e1)))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647))
  (and (<= (to_rep1 (first2 (rt1 init))) y)
  (<= y (to_rep1 (last2 (rt1 init)))))))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= o1 y)))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647)) (= o2 (select (elts1 init) o1))))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= o3 (to_rep o2))))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647)) (and (= o x) (in_range4 x))))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647))
  (ite (= o3 (to_rep (select (elts1 init) o)))
  (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
     e1) (occ
         (mk___t (elts1 init)
         (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init)))))
         e1))
  ...
  (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
     e1) (+ (occ
            ...
            (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init)))))
            e1) 1))
  (ite (= (to_rep (select (elts1 init) o)) e1)
  (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
     e1) (- (occ
            (mk___t (elts1 init)
            (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init)))))
...
;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647))
  (and (<= (to_rep1 (first2 (rt1 init))) x)
  (<= x (to_rep1 (last2 (rt1 init)))))))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= o5 x)))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647)) (= o6 (select (elts1 init) o5))))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= o7 (to_rep o6))))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647)) (and (= o4 y) (in_range4 y))))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647))
  (ite (= o7 (to_rep (select interm o4)))
  (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
     e1) (occ
         (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last)))
         e1))
  (ite (= o7 e1)
  (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
     e1) (+ (occ
            (mk___t interm
            (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1))
  (ite (= (to_rep (select interm o4)) e1)
  (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
     e1) (- (occ
            (mk___t interm
            (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1))
...
;; H
  ...
  (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last)))
     f) (occ
        (mk___t (elts1 init)
        (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) f))))))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647))
  (and (=> (<= 0 2147483647) (in_range1 e2))
  (and (<= 0 e2) (<= e2 2147483647)))))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= e2 2147483647)))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= e2 e3)))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= e4 e2)))

;; H
  (assert
  (=> (and (<= 0 e1) (<= e1 2147483647))
  (= (mk_int__ref e5) (mk_int__ref e3))))

;; H
  (assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= e6 e4)))

;; H
  (assert (=> (not (and (<= 0 e1) (<= e1 2147483647))) (= e1 e5)))

;; H
  (assert (=> (not (and (<= 0 e1) (<= e1 2147483647))) (= e6 e1)))
