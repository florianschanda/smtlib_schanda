...
(define-fun temp___4782 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___4781)))
...
;; H
  (assert
  (and (= (has_key (positions l) temp___4782) true)
  (= e3 (element l temp___4782))))
...
;; H
  (assert
  (= for_loops_on_lists__contains_0_for_of__result1 for_loops_on_lists__contains_0_for_of__result))

(assert
;; WP_parameter_def
 ;; File "for_loops_on_lists.ads", line 14, characters 0-0
  (not
  (or (= (has_key (positions l) temp___4782) true)
  (= (bool_eq1 temp___4782 no_element) true))))
(check-sat)
(exit)
