...
;; H
  (assert (= accepted1 (of_int 1)))

;; H
  (assert (= (to_rep (select result__ g21)) c132b))

;; H
  (assert (in_range1 c132b))
...
;; H
  (assert (= temp___603 o15))

;; H
  (assert (= temp___6031 o16))

;; H
  (assert
  (= result8 (mk___split_fields__ref unmatched_g1_set__split_fields2)))
...
;; H
  (assert (= temp___607 o20))

;; H
  (assert (= temp___6071 o21))

;; H
  (assert
  (= result9 (mk___split_fields__ref unmatched_g1_set__split_fields3)))
...
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 194, characters 0-0
  (not (= (is_permutation_1 (select ranking_2 g21)) true)))
(check-sat)
(exit)
