...
(define-fun dynamic_invariant ((temp___expr_384 Int)
...
(define-fun default_initial_assumption1 ((temp___expr_340 us_rep3)
  (temp___skip_top_level_341 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_341 true))
                                         (and
                                         (= (is_empty1 temp___expr_340) true)
...
(declare-const temp___576 count_type)
...
;; H
  (assert (= temp___576 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___576)) no_element))
