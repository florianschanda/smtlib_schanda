...
((us_split_fields4
 (mk___split_fields2
 (rec__simple_oo_without_contracts__t2__z1 integer)(rec__simple_oo_without_contracts__t__x2 integer)(rec__simple_oo_without_contracts__t1__y1 integer)(rec__ext__2 us_private)))))
(define-fun us_split_fields_Z1__projection ((a us_split_fields4)) integer 
  (rec__simple_oo_without_contracts__t2__z1 a))
...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep
                                          ...
                                          (us_split_fields5 a))
                                          (hide_ext__1
                                          (rec__simple_oo_without_contracts__t2__z1
                                          (us_split_fields5 a))
...
(declare-fun simple_oo_without_contracts__t2__z1__first__bit () Int)

(declare-fun simple_oo_without_contracts__t2__z1__last__bit () Int)

(declare-fun simple_oo_without_contracts__t2__z1__position () Int)

;; simple_oo_without_contracts__t2__z1__first__bit_axiom
  (assert (<= 0 simple_oo_without_contracts__t2__z1__first__bit))

;; simple_oo_without_contracts__t2__z1__last__bit_axiom
  (assert
  (< simple_oo_without_contracts__t2__z1__first__bit simple_oo_without_contracts__t2__z1__last__bit))

;; simple_oo_without_contracts__t2__z1__position_axiom
...
;; WP_parameter_def
 ;; File "simple_oo_without_contracts.ads", line 15, characters 0-0
  (not
  (= g3 (to_rep
        (rec__simple_oo_without_contracts__t2__z1 (us_split_fields5 par1))))))
(check-sat)
