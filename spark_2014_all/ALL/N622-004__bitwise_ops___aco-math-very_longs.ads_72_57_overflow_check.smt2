...
(declare-fun aco__math__very_longs__Omultiply__result () digit_index_type)

(declare-fun aco__math__very_longs__Omultiply__result1 () (Array Int octet))

(declare-fun aco__math__very_longs__Omultiply__result2 () t)
...
(declare-fun temp___1271 () (_ BitVec 16))

(declare-fun temp___1270 () (_ BitVec 16))

(declare-fun temp___1267 () us_rep1)

(declare-fun temp___1266 () (_ BitVec 16))

(declare-fun temp___1265 () (_ BitVec 16))

(declare-fun temp___1258 () (_ BitVec 16))

(declare-fun temp___1257 () (_ BitVec 16))

(declare-fun temp___1256 () (_ BitVec 16))

(declare-fun temp___1253 () us_rep1)

(declare-fun temp___1252 () (_ BitVec 16))

(declare-fun temp___1251 () (_ BitVec 16))
...
(declare-fun temp___1250 () us_rep1)
...
(declare-fun o29 () (Array Int octet))

(declare-fun o30 () us_t1)

(declare-fun o31 () us_split_fields2)

(declare-fun temp___1264 () us_rep1)
...
(declare-fun aco__math__very_longs__Omultiply__result3 () us_rep)

(declare-fun aco__math__very_longs__Omultiply__result4 () very_long__ref)

(declare-fun aco__math__very_longs__Omultiply__result5 () us_rep)
...
(declare-fun aco__math__very_longs__Omultiply__result6 () very_long__ref)
...
(declare-fun aco__math__very_longs__Omultiply__result7 () us_rep)
...
;; H
  ...
  (<= j1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 r)))))))
  (= temp___1267 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1253 (mk___rep1 result____split_discrs result____split_fields3)))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      result____split_fields4)))) temp___1246)
  (<= temp___1246 (to_rep2
                  (last2
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      result____split_fields4)))) temp___1248)
  (<= temp___1248 (to_rep2
                  (last2
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1250 (mk___rep1 result____split_discrs o24)))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_fields5 (us_split_fields3 temp___1250)))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___1250)))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (and (= o25 (shift_right temp4 8))
  (= o25 (bvudiv temp4 (ite (< 8 65536)
...
;; H
  ...
  (<= j1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 r)))))))
  (= o26 (takelsb_from16 (t__content1 carry8)))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      (us_split_fields__content1 result____split_fields8))))) temp___1262)
  (<= temp___1262 (to_rep2
                  (last2
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
...
;; H
  ...
  (<= j1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 r)))))))
  (= temp___1264 (mk___rep1 result____split_discrs o31))))
...
;; H
  ...
  (<= j1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 r)))))))
  (= result____split_fields10 (us_split_fields3 temp___1264))))
...
;; H
  ...
  (<= j1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 r)))))))
  (= result____split_discrs (us_split_discrs2 temp___1264))))
...
;; H
  (assert
  (= aco__math__very_longs__Omultiply__result4 (mk_very_long__ref
                                               aco__math__very_longs__Omultiply__result3)))

;; H
  (assert
  (= aco__math__very_longs__Omultiply__result5 aco__math__very_longs__Omultiply__result3))

;; H
  (assert
  (= result11 (mk_very_long__ref
              (mk___rep
              (mk___split_discrs aco__math__very_longs__Omultiply__result)
              (mk___split_fields
              (mk___t aco__math__very_longs__Omultiply__result1
              aco__math__very_longs__Omultiply__result2))))))

;; H
  (assert
  (= aco__math__very_longs__Omultiply__result3 (to_base
                                               (mk___rep1
...
;; H
  (assert
  (= aco__math__very_longs__Omultiply__result6 aco__math__very_longs__Omultiply__result4))
...
;; H
  (assert
  (= aco__math__very_longs__Omultiply__result7 aco__math__very_longs__Omultiply__result5))
