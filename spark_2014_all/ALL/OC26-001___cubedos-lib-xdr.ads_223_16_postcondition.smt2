...
;; H
  (assert (=> (not (= temporary ((_ int2bv 32) 0))) (= result value)))

;; H
  (assert (=> (not (= temporary ((_ int2bv 32) 0))) (= value1 1)))

;; H
  (assert (=> (not (not (= temporary ((_ int2bv 32) 0)))) (= result1 value)))

;; H
  (assert (=> (not (not (= temporary ((_ int2bv 32) 0)))) (= value2 0)))

;; H
  (assert (=> (not (not (= temporary ((_ int2bv 32) 0)))) (= value1 value2)))
