...
(declare-datatypes ((percentage__ref 0))
(((mk_percentage__ref (percentage__content percentage)))))
...
(declare-datatypes ((participation__ref 0))
(((mk_participation__ref (participation__content us_rep)))))
...
(declare-datatypes ((subject__ref 0))
(((mk_subject__ref (subject__content subject)))))
...
(declare-datatypes ((formtype__ref 0))
(((mk_formtype__ref (formtype__content formtype)))))
...
(declare-datatypes ((pupiltype__ref 0))
(((mk_pupiltype__ref (pupiltype__content us_rep1)))))
...
(declare-datatypes ((pupilnumbers__ref 0))
...
(declare-datatypes ((pupilindex__ref 0))
(((mk_pupilindex__ref (pupilindex__content pupilindex)))))
...
(declare-datatypes ((pupildata__ref 0))
(((mk_pupildata__ref (pupildata__content us_rep2)))))
(define-fun pupildata__ref___projection ((a pupildata__ref)) us_rep2
  (pupildata__content a))

(declare-datatypes ((map__ref3 0))
(((mk_map__ref3 (map__content3 (Array Int subject))))))
...
(declare-datatypes ((subject_score_pair__ref 0))
...
(((mk_map__ref4 (map__content4 (Array Int us_rep3))))))
