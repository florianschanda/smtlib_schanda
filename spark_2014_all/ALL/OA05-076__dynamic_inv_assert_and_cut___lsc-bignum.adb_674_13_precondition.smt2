...
;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___655 s10)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___670 aux31)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___668 a7)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___675 s10)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___666 h8)))
...
;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= h9 r94b)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9))))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= aux34 (mk_map__ref aux33))))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= a9 (mk_map__ref a8))))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= h11 h9)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= aux35 aux33)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= a10 a8)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= h12 h10)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= aux36 aux34)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= a11 a9)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= h13 h11)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= aux37 aux35)))

;; H
  (assert (=> (and (<= 1 h8) (<= h8 r94b)) (= a12 a10)))

;; H
  (assert (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8))))
...
;; H
  (assert (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a11 (mk_map__ref a7))))

;; H
  (assert (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8)))

;; H
  (assert (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux37 aux31)))

;; H
  (assert (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a12 a7)))
