...
;; H
  (assert
  (and (= o9 (length right)) (and (in_range6 o9) (<= o9 (capacity right)))))
...
;; H
  (assert
  (and
  (= o11 (length (vector__content amortized_queue__Oconcat__2__result5)))
  (and (in_range6 o11)
  (<= o11 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
...
;; H
  (assert
  (and
  (= o8 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1))
  (and (in_range7 o8)
  (= o8 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1)))))
...
;; H
  (assert (= result5 (ite (= o8 left) true false)))
...
;; H
  ...
  (and (in_range7 o7) (= o7 (get (model__ right) o6)))))

;; H
  (assert (and (= o5 (+ 1 i)) (in_range1 (+ 1 i))))
