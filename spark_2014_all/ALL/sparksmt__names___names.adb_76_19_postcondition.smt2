...
(define-fun bool_eq7 ((a (Array (_ BitVec 32) name_id))
...
(declare-fun user_eq10 (tchar_table_indexB tchar_table_indexB) Bool)

(declare-fun dummy12 () tchar_table_indexB)
...
(declare-fun user_eq11 (char_table_index char_table_index) Bool)

(declare-fun dummy13 () char_table_index)
...
(declare-fun bool_eq15 (us_rep4 us_rep4) Bool)
...
(declare-fun dummy18 () extended_index1)
...
(define-fun dynamic_invariant7 ((temp___expr_348 Int)
...
(declare-fun dummy20 () count_type)
...
(declare-fun user_eq19 (extended_index2 extended_index2) Bool)

(declare-fun dummy21 () extended_index2)
...
(declare-fun dummy22 () element_type)
...
(define-fun dynamic_invariant14 ((temp___expr_305 Int)
...
(define-fun default_initial_assumption3 ((temp___expr_387 us_rep4)
  (temp___skip_top_level_388 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_388 true))
                                         (= (length4 temp___expr_387) 0)))
...
(declare-fun dummy23 () index_type)
...
(define-fun dynamic_invariant15 ((temp___expr_333 Int)
...
(declare-fun user_eq22 (extended_index3 extended_index3) Bool)

(declare-fun dummy24 () extended_index3)
...
(define-fun dynamic_invariant16 ((temp___expr_380 Int)
...
(declare-fun temp___506 () capacity_range)

(declare-fun temp___5061 () us_main_type)

(declare-fun o () Int)

(declare-fun o1 () Int)

(declare-fun temp___504 () Int)

(declare-fun o2 () Int)

(declare-fun o3 () character)
...
(declare-fun o12 () name_id)

(declare-fun o13 () positive)

(declare-fun o14 () char_table_index)

(declare-fun o15 () char_table_index)

(declare-fun o16 () positive)

(declare-fun o17 () name_id)

(declare-fun o18 () char_table_index)

(declare-fun o19 () positive)

(declare-fun o20 () name_id)

(declare-fun o21 () Int)

(declare-fun char_table__split_fields1 () us_main_type)

(declare-fun result () Int)

(declare-fun i1 () Int)

(declare-fun names__data__char_tables__append__2__container__fields () us_main_type)

(declare-fun result1 () us_main_type)

(declare-fun char_table__split_fields2 () us_main_type)

(declare-fun char_table__split_fields3 () us_main_type)

(declare-fun i2 () Int)

(declare-fun char_table__split_fields4 () us_split_fields__ref)

(declare-fun i3 () int__ref)

(declare-fun char_table__split_fields5 () us_split_fields)

(declare-fun i4 () Int)

(declare-fun char_table__split_fields6 () us_split_fields__ref)

(declare-fun i5 () int__ref)

(declare-fun char_table__split_fields7 () us_split_fields)

(declare-fun i6 () Int)

(declare-fun names__data__entry_tables__append__2__container__fields () us_split_fields2)

(declare-fun result2 () us_split_fields__ref1)

(declare-fun entry_table__split_fields1 () us_split_fields2)

(declare-fun result3 () int__ref)

(declare-fun n1 () Int)

(declare-fun char_table__split_fields8 () us_split_fields__ref)

(declare-fun entry_table__split_fields2 () us_split_fields__ref1)

(declare-fun n2 () int__ref)

(declare-fun i7 () int__ref)

(declare-fun char_table__split_fields9 () us_split_fields)

(declare-fun entry_table__split_fields3 () us_split_fields2)
...
;; H
  (assert (and (= temp___510 (length s)) (in_range1 (length s))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= temp___507 i1)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___510))
  (= temp___508 (length1
                (mk___rep char_table__split_discrs
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___510))
  (and (= char_table__split_discrs (mk___split_discrs temp___506))
  (= char_table__split_fields temp___5061))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= o1 (+ i1 o))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___510))
  (and (= temp___504 o1) (in_range1 o1))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___510))
  (and (<= (to_rep1 (first (rt s))) temp___504)
  (<= temp___504 (to_rep1 (last (rt s)))))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= o2 temp___504)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___510)) (= o3 (select (elts s) o2))))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= o4 (to_rep o3))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= i2 temp___510)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= i3 (mk_int__ref i2))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= i4 i2)))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= i5 i3)))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___510)) (= i6 i4)))
...
;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 temp___510))) (= i5 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 temp___510)))
  (= char_table__split_fields6 char_table__split_fields11)))

;; H
  (assert (=> (not (and (<= 1 i1) (<= i1 temp___510))) (= i6 i1)))
