...
(((mk_map__ref1 (map__content1 (Array (_ BitVec 32) name_id))))))
...
(define-fun in_range7 ((rec__names__data__char_tables__vector__capacity1 Int)
...
(((mk_tchar_tableS__ref (tchar_tableS__content us_rep)))))
...
(define-fun dynamic_invariant2 ((temp___expr_569 us_rep)
  (temp___is_init_566 Bool) (temp___skip_constant_567 Bool)
  (temp___do_toplevel_568 Bool)) Bool (=>
                                      (not (= temp___skip_constant_567 true))
                                      (in_range7 1024 temp___expr_569)))

(define-fun default_initial_assumption ((temp___expr_571 us_rep)
  (temp___skip_top_level_572 Bool)) Bool (and
                                         (= (to_rep4
                                            (rec__names__data__char_tables__vector__capacity
                                            (us_split_discrs1
                                            temp___expr_571))) 1024)
                                         (=>
                                         (not
...
(define-fun us_split_discrs___2__projection ((a us_split_discrs2)) capacity_range1
...
(define-fun us_split_fields_Vector__2__projection ((a us_split_fields2)) us_main_type1
...
(define-fun vector__ref___2__projection ((a vector__ref1)) us_rep1 (vector__content1
                                                                   a))
...
;; range_axiom
  (assert
  (forall ((x capacity_range1)) (! (in_range8
...
(define-fun in_range9 ((rec__names__data__entry_tables__vector__capacity1 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_578 us_rep1)
  (temp___is_init_575 Bool) (temp___skip_constant_576 Bool)
  (temp___do_toplevel_577 Bool)) Bool (=>
                                      (not (= temp___skip_constant_576 true))
                                      (in_range9 256 temp___expr_578)))

(define-fun default_initial_assumption1 ((temp___expr_580 us_rep1)
  (temp___skip_top_level_581 Bool)) Bool (and
                                         (= (to_rep5
                                         ...
                                         (=>
                                         (not
                                         (= temp___skip_top_level_581 true))
                                         (= (is_empty1 temp___expr_580) true))))

(declare-fun invariant__ ((Array (_ BitVec 32) name_id) us_split_fields
  us_split_fields2) Bool)

(declare-fun invariant____function_guard (Bool (Array (_ BitVec 32) name_id)
  us_split_fields us_split_fields2) Bool)
...
(declare-fun valid_name_table__function_guard (Bool us_split_fields
  us_split_fields2) Bool)
...
(define-fun dynamic_invariant4 ((temp___expr_288 Int)
...
(define-fun us_split_fields__ref___2__projection ((a us_split_fields__ref2)) us_split_fields4
  (us_split_fields__content2 a))

(declare-datatypes ((us_rep3 0))
(((mk___rep2 (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___3__projection ((a us_rep3)) us_split_fields4 (us_split_fields5
                                                                  a))
...
(((mk_name_entry__ref (name_entry__content us_rep3)))))
(define-fun name_entry__ref___projection ((a name_entry__ref)) us_rep3
  (name_entry__content a))

(declare-datatypes ((element_type__ref 0))
(((mk_element_type__ref (element_type__content us_rep3)))))
(define-fun element_type__ref___3__projection ((a element_type__ref)) us_rep3
...
;; length__post_axiom
  ...
  (! (let ((result (length3 container)))
     (and (<= result (capacity1 container)) (dynamic_invariant6 result true
...
(((mk_sequence__ref1 (sequence__content1 us_rep4)))))
(define-fun sequence__ref___2__projection ((a sequence__ref1)) us_rep4
...
(define-fun last_index1 ((container us_rep1)) Int (last3
                                                  (model__1 container)))
...
(define-fun dynamic_invariant7 ((temp___expr_436 Int)
...
(define-fun element_type__ref___4__projection ((a element_type__ref1)) us_rep3
...
;; valid_hashes__def_axiom
  ...
  (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true)
     ...
     (=> (and (bvule ((_ int2bv 32) 0) h) (bvule h ((_ int2bv 32) 255)))
     (<= (to_rep3 (select names__hash_table h)) (last_index1
                                                (mk___rep1
...
(declare-fun valid_entry__function_guard (Bool us_rep3 us_split_fields
  us_split_fields2) Bool)
...
;; valid_entry__def_axiom
  ...
  (! (=
     ...
     (last_index
     (mk___rep char_table__split_discrs names__char_table__fields)) (to_rep6
                                                                    (rec__names__data__name_entry__table_index
                                                                    (us_split_fields5
                                                                    e))))))) :pattern (
...
;; valid_name_table__def_axiom
  ...
  (! (=
     ...
     (= (valid_entry
        (element
        (mk___rep1 entry_table__split_discrs names__entry_table__fields) i)
...
(define-fun dynamic_invariant11 ((temp___expr_142 Int)
...
(define-fun dynamic_invariant12 ((temp___expr_264 Int)
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq14 a b) (oeq a b)) :pattern ((user_eq14 a b)) )))
...
(define-fun extended_index__ref___2__projection ((a extended_index__ref2)) extended_index2
  (extended_index__content2 a))

(define-fun dynamic_invariant13 ((temp___expr_315 Int)
...
(define-fun element_type__ref___2__projection ((a element_type__ref2)) element_type
  (element_type__content2 a))

(define-fun dynamic_invariant14 ((temp___expr_309 Int)
...
;; get__post_axiom
  ...
  (forall ((position Int))
  (! (=>
     (and (dynamic_invariant13 position true true true)
     (and (<= 0 position) (<= position (last2 container))))
     (dynamic_invariant14 (get container position) true false true)) :pattern (
...
(define-fun default_initial_assumption3 ((temp___expr_479 us_rep4)
  (temp___skip_top_level_480 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_480 true))
                                         (= (length4 temp___expr_479) 0)))
...
(define-fun dynamic_invariant15 ((temp___expr_421 Int)
  (temp___is_init_418 Bool) (temp___skip_constant_419 Bool)
  (temp___do_toplevel_420 Bool)) Bool (=>
...
(define-fun extended_index__ref___4__projection ((a extended_index__ref3)) extended_index3
  (extended_index__content3 a))

(define-fun dynamic_invariant16 ((temp___expr_472 Int)
...
(define-fun char_table__split_fields10 () us_split_fields (mk___split_fields
                                                          char_table__split_fields3))

(define-fun names__data__char_tables__append__2__container__fields1 () us_split_fields
  (mk___split_fields names__data__char_tables__append__2__container__fields))

(define-fun char_table__split_fields11 () us_split_fields__ref (mk___split_fields__ref
                                                               (mk___split_fields
...
;; H
  (assert
  (and (< 0 (length s))
  (= (invariant__ hash_table (mk___split_fields char_table__split_fields)
...
;; H
  ...
  (< (last2
     (model__
     (mk___rep char_table__split_discrs
     (mk___split_fields char_table__split_fields)))) (- 2147483646 (length s))))
...
;; H
  ...
  (< (last3
     ...
     (mk___split_fields1 entry_table__split_fields)))) 2147483647))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= temp___683 i1)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (= temp___684 (length1
                (mk___rep char_table__split_discrs
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (and (= char_table__split_discrs (mk___split_discrs temp___682))
  (= char_table__split_fields temp___6821))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (and (= o (- (to_rep1 (first (rt s))) 1)) (in_range1
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (and (= temp___680 o1) (in_range1 o1))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (and (<= (to_rep1 (first (rt s))) temp___680)
  (<= temp___680 (to_rep1 (last (rt s)))))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686)) (= o3 (select (elts s) o2))))
...
;; H
  ...
  (= (length1
     (mk___rep char_table__split_discrs
     names__data__char_tables__append__2__container__fields1)) (+ (length1
                                                                  (mk___rep
                                                                  char_table__split_discrs
                                                                  (mk___split_fields
                                                                  char_table__split_fields))) 1))
  (= (olt
     (model__
     (mk___rep char_table__split_discrs
     (mk___split_fields char_table__split_fields)))
     (model__
     (mk___rep char_table__split_discrs
     names__data__char_tables__append__2__container__fields1))) true))
  (= (get
     (model__
     (mk___rep char_table__split_discrs
     names__data__char_tables__append__2__container__fields1))
     (+ (last2
        (model__
        (mk___rep char_table__split_discrs
        (mk___split_fields char_table__split_fields)))) 1)) o4))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (= (mk___split_fields__ref (mk___split_fields result1)) char_table__split_fields11)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (= (mk___split_fields char_table__split_fields2) names__data__char_tables__append__2__container__fields1)))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (and
  (= (invariant__ hash_table char_table__split_fields10
     (mk___split_fields1 entry_table__split_fields)) true)
  (= (length1 (mk___rep char_table__split_discrs char_table__split_fields10)) (+
  temp___684 i2)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (and (=> (<= 1 (length s)) (dynamic_property1 1 (length s) i2))
  (and (<= 1 i2) (<= i2 (length s))))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (= char_table__split_fields4 (mk___split_fields__ref
                               char_table__split_fields10))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (= char_table__split_fields5 char_table__split_fields10)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 temp___686))
  (= char_table__split_fields7 char_table__split_fields5)))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 temp___686))) (= i5 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 temp___686)))
  (= char_table__split_fields6 char_table__split_fields11)))
...
;; H
  (assert
  (=> (not (and (<= 1 i1) (<= i1 temp___686)))
  (= char_table__split_fields7 (mk___split_fields char_table__split_fields1))))
...
;; H
  ...
  (= o7 (last2
        (model__
        (mk___rep char_table__split_discrs
        (us_split_fields__content char_table__split_fields6)))))
  (and (in_range12 o7)
  (= o7 (last2
        (model__
        (mk___rep char_table__split_discrs
...
;; H
  ...
  (= (length3
     (mk___rep1 entry_table__split_discrs
     names__data__entry_tables__append__2__container__fields)) (+ (length3
                                                                  (mk___rep1
                                                                  entry_table__split_discrs
                                                                  (mk___split_fields1
  ...
  (= (olt1
     ...
     (model__1
     (mk___rep1 entry_table__split_discrs
     names__data__entry_tables__append__2__container__fields))) true))
  (= (bool_eq4
     (get1
     (model__1
     (mk___rep1 entry_table__split_discrs
     names__data__entry_tables__append__2__container__fields))
     (+ (last3
        (model__1
        (mk___rep1 entry_table__split_discrs
        (mk___split_fields1 entry_table__split_fields)))) 1))
     (mk___rep2 (mk___split_fields2 o18 o19 o20))) true)))
...
;; H
  (assert
  (= entry_table__split_fields1 names__data__entry_tables__append__2__container__fields))
...
;; H
  ...
  (= o21 (last3
         (model__1
         (mk___rep1 entry_table__split_discrs entry_table__split_fields1))))
  (and (in_range13 o21)
  (= o21 (last3
         (model__1
         (mk___rep1 entry_table__split_discrs entry_table__split_fields1)))))))
...
;; H
  (assert
  (= entry_table__split_fields2 (mk___split_fields__ref1
                                entry_table__split_fields1)))

;; H
  (assert (= char_table__split_fields8 char_table__split_fields6))
...
;; H
  (assert (= entry_table__split_fields3 entry_table__split_fields1))

;; H
  (assert (= char_table__split_fields9 char_table__split_fields7))

(assert
;; WP_parameter_def
 ;; File "names.adb", line 64, characters 0-0
  (not
  (= (invariant__ hash_table
     (us_split_fields__content char_table__split_fields8)
     (us_split_fields__content1 entry_table__split_fields2)) true)))
(check-sat)
(exit)
