...
(define-fun default_initial_assumption ((temp___expr_365 us_rep3)
...
(define-fun default_initial_assumption1 ((temp___expr_334 us_rep4)
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     ...
     (= (has_key1 (model__ container) (get result temp___399)) true))))
     (forall ((key2 Int))
     (=> (and (in_range4 key2) (= (has_key1 (model__ container) key2) true))
...
(define-fun default_initial_assumption2 ((temp___expr_385 us_rep2)
...
;; has_key__post_axiom
  ...
  (! (=> (dynamic_invariant3 key2 true true true)
     ...
     (=>
     (exists ((k1 Int))
     (and (and (in_range4 k1) (= (has_key1 container k1) true))
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (forall ((k1 Int))
     (=> (and (in_range4 k1) (= (has_key1 container k1) true))
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq4 left right) true)
     (and
     (forall ((key2 Int))
     (=> (and (in_range4 key2) (= (has_key1 left key2) true))
     (and (= (has_key1 right key2) true)
     (= (get2 right key2) (get2 left key2)))))
     (forall ((key2 Int))
     (=> (and (in_range4 key2) (= (has_key1 right key2) true))
...
;; is_empty__post_axiom
  ...
  (! (= (= (is_empty container) true)
     (forall ((key2 Int))
     (not (and (in_range4 key2) (= (has_key1 container key2) true))))) :pattern (
  (is_empty container)) )))
...
;; elements_equal_except__post_axiom
  ...
  (forall ((left us_rep4) (right us_rep4))
  (forall ((new_key Int))
  (! (=> (dynamic_invariant3 new_key true true true)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep2)) (! (dynamic_invariant2 (length4 container)
...
(declare-fun replacement__inverse_sets__replace__container__fields () us_main_type)
...
(define-fun replacement__inverse_sets__replace__container__fields1 () us_split_fields
  (mk___split_fields replacement__inverse_sets__replace__container__fields))
...
;; H
  ...
  (= (oeq2
     ...
     replacement__inverse_sets__replace__container__fields1))
     (positions
  ...
  (= (get
     ...
     (keys
     (mk___rep d__split_discrs
     replacement__inverse_sets__replace__container__fields1)) k)) k))
  (= (equal_except
     ...
     (keys
     (mk___rep d__split_discrs
     replacement__inverse_sets__replace__container__fields1)) k)) true))
  (= (get2
     (model__
     (mk___rep d__split_discrs
     replacement__inverse_sets__replace__container__fields1)) k) 0))
  (= (same_keys
     (model__
     (mk___rep d__split_discrs
     replacement__inverse_sets__replace__container__fields1))
...
;; H
  (assert
  (= d__split_fields2 replacement__inverse_sets__replace__container__fields1))
