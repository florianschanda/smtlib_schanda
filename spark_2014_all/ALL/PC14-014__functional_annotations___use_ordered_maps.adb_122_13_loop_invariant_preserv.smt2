...
;; H
  (assert
  (let ((temp___780 (keys (mk___rep s1__split_discrs s1__split_fields4))))
...
;; H
  ...
  (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields3))
     (find (keys (mk___rep s1__split_discrs s1__split_fields3)) o)) o))
  (= (equal_except (keys (mk___rep s1__split_discrs s1__split_fields4))
     (keys (mk___rep s1__split_discrs s1__split_fields3))
     (find (keys (mk___rep s1__split_discrs s1__split_fields3)) o)) true))
  ...
  (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields3))
     (find (keys (mk___rep s1__split_discrs s1__split_fields3)) o)) o))
  (= (range_equal (keys (mk___rep s1__split_discrs s1__split_fields4))
     (keys (mk___rep s1__split_discrs s1__split_fields3)) 1
     (- (find (keys (mk___rep s1__split_discrs s1__split_fields3)) o) 1)) true))
  (= (range_shifted (keys (mk___rep s1__split_discrs s1__split_fields4))
     (keys (mk___rep s1__split_discrs s1__split_fields3))
     (find (keys (mk___rep s1__split_discrs s1__split_fields3)) o)
     (length (mk___rep s1__split_discrs s1__split_fields4)) 1) true))
  (= (p_positions_shifted
...
;; H
  (assert
  (and (= temp___7711 (next s2 (mk___rep1 cu__split_fields4)))
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___771)))
