...
(declare-fun temp___6691 () et3)

(declare-fun temp___66911 () et1)

(declare-fun temp___66912 () et2)

(declare-fun temp___66913 () enum1ta)
...
(declare-fun temp___6694 () et3)

(declare-fun temp___66941 () et1)

(declare-fun temp___66942 () et2)

(declare-fun temp___66943 () enum1ta)
...
;; H
  (assert
  (= r__split_fields4 (mk___split_fields1 temp___6691
                      (mk___rep
                      (mk___split_fields temp___66911 temp___66912))
                      temp___66913)))
...
;; H
  (assert
  (= (rec__ar__rec1t__f1
     (us_split_fields1 (rec__ar__rec2t__g2 r__split_fields4))) o10))
...
;; H
  (assert
  (= r__split_fields5 (mk___split_fields1 temp___6694
                      (mk___rep
                      (mk___split_fields temp___66941 temp___66942))
                      temp___66943)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 795, characters 0-0
  (not
  (= (bool_eq1 (mk___rep1 (us_split_fields__content1 r__split_fields6))
     (mk___rep1
     (let ((usq_ (us_split_fields__content1 r__split_fields6)))
     (mk___split_fields1 (rec__ar__rec2t__f2 usq_)
     (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))
     (rec__ar__rec2t__h2 usq_))))) true)))
(check-sat)
(exit)
