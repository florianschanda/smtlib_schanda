...
(declare-fun temp___924 () (_ BitVec 16))

(declare-fun temp___921 () us_rep1)

(declare-fun temp___920 () (_ BitVec 16))

(declare-fun temp___919 () (_ BitVec 16))

(declare-fun temp___918 () (_ BitVec 16))
...
(declare-fun temp___917 () us_rep1)
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___921 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___917 (mk___rep1 result____split_discrs o18))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields3 temp___917))))
...
;; H
  ...
  (<= i1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___917))))
