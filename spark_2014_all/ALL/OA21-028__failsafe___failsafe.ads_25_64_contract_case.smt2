...
;; H
  ...
  (= o2 (to_rep o1))) (= result2 (ite (lt o2 fliteral2) true false)))
  (not (= result2 true))))
  (and
  (and
  (and
  ...
  (bvule s17 current_time)) (lt (to_rep (select battery_level_at s17))
  fliteral2)))
  (and
  (forall ((s17 (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) s17) (bvule s17 current_time)) (lt
  (to_rep (select battery_level_at s17)) fliteral2)))
  (forall ((s17 (_ BitVec 8)))
  (=>
  (and
  ...
  (bvule s17 ((_ int2bv 8) 49))) (lt (to_rep (select battery_level_at s17))
  fliteral2))))) (= res3 (bvadd s2 ((_ int2bv 8) 1))))
  (and
  (and
  ...
  (= o6 (to_rep o5))) (= result5 (ite (lt o6 fliteral2) true false)))
  (not (= result5 true)))))))))))))))
...
;; H
  (assert
  (= (bool_ge (to_rep (select battery_level_at current_time)) fliteral2) true))
