...
;; H
  (assert (= o120 (select temp___720 o119)))

;; H
  (assert (= temp___721 (to_rep1 o120)))

;; H
  (assert (and (<= 0 temp___721) (<= temp___721 99)))

;; H
  (assert (= o121 temp___721))

;; H
  (assert
  (= o122 (select (rec__patience__state__values
                  (us_split_fields__content s__split_fields20)) o121)))
