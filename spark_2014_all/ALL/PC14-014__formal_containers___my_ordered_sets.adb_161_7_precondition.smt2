...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o19) true))
  (= (bool_eq3
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o19)) o19) true))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields)) o19) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (elements
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o19)
     (length
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o18) true))
  (= (bool_eq3
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o18)) o18) true))
  ...
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields1)) o18) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o18)
...
;; WP_parameter_def
 ;; File "my_ordered_sets.adb", line 95, characters 0-0
  (not
  (or
  (< (length (mk___rep1 l__split_discrs l__split_fields2)) (to_rep2
                                                           (rec__my_ordered_sets__n__set__capacity
                                                           l__split_discrs)))
  (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields2))
     (mk___rep (mk___split_fields o16 o17))) true))))
(check-sat)
