...
(declare-fun a8 () (Array Int word32))
...
(declare-fun a11 () map__ref)

(declare-fun aux36 () map__ref)

(declare-fun h12 () int__ref)
...
(declare-fun a13 () (Array Int word32))

(declare-fun aux38 () (Array Int word32))
...
;; H
  (assert
  (=> (= result2 true) (not (and (<= j3 k) (bvule ((_ int2bv 64) j3) i2)))))
...
;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___655 s10))))

;; H
  (assert
  (=> (= result2 true)
  (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___670 aux31))))

;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___668 a7))))

;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___675 s10))))

;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= temp___666 h8))))
...
;; H
  ...
  (= (oeq
     (num_of_big_int
     (mk___t aux33 (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first
     (+ l1 1))
     (omod
     (omultiply
     (oexpon__2 (num_of_big_int x x_first (+ l1 1))
     ...
     (oexpon__2 (from_word32 ((_ int2bv 32) 2))
     (oadd (from_word64 i2) (from_word32 ((_ int2bv 32) 1)))))
     (oexpon (from_word32 ((_ int2bv 32) 2)) h9)))
     (oexpon (base Tuple0) (+ l1 1))) (num_of_big_int m m_first (+ l1 1)))) true))
  (forall ((n1 Int))
  (=> (and (<= 0 n1) (<= n1 (- (power 2 k) 1)))
  (= (oeq
...
;; H
  (assert
  (=> (= result2 true)
  (=> (and (<= 1 h8) (<= h8 r94b)) (=> (<= 0 2147483647) (in_range2 l1)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (and (<= 1 h8) (<= h8 r94b)) (=> (<= 0 2147483647) (in_range2 s10)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (and (<= 1 h8) (<= h8 r94b))
  (=> (<= 1 r94b) (dynamic_property2 1 r94b h9)))))

;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h9 r94b))))

;; H
  (assert
  (=> (= result2 true)
  (=> (and (<= 1 h8) (<= h8 r94b)) (= h10 (mk_int__ref h9)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (and (<= 1 h8) (<= h8 r94b)) (= aux34 (mk_map__ref aux33)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (and (<= 1 h8) (<= h8 r94b)) (= a9 (mk_map__ref a8)))))
...
;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux35 aux33))))
...
;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h12 h10))))

;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux36 aux34))))
...
;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= h13 h11))))

;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= aux37 aux35))))

;; H
  (assert
  (=> (= result2 true) (=> (and (<= 1 h8) (<= h8 r94b)) (= a12 a10))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h12 (mk_int__ref h8)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux36 (mk_map__ref aux31)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a11 (mk_map__ref a7)))))

;; H
  (assert
  (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= h13 h8))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (and (<= 1 h8) (<= h8 r94b))) (= aux37 aux31))))

;; H
  (assert
  (=> (= result2 true) (=> (not (and (<= 1 h8) (<= h8 r94b))) (= a12 a7))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o10 (bv2nat (bvlshr (t__content w7) ((_ int2bv 32) 1)))) (in_range2
  (bv2nat (bvlshr (t__content w7) ((_ int2bv 32) 1)))))))
...
;; H
  ...
  (=> (= result2 true)
  (= (oeq
     (num_of_big_int (mk___t a13 (mk (to_rep a__first) (to_rep a__last)))
     a_first (+ (- a_last a_first) 1))
     (omod
     (omultiply
     (omultiply
     (num_of_big_int
     (mk___t (map__content aux36)
     (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first
     (+ (- a_last a_first) 1))
     (num_of_big_int
     (mk___t (map__content aux45)
     (mk (to_rep aux4__first) (to_rep aux4__last))) o15
     (+ (- a_last a_first) 1)))
     (oexpon
     (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1))
     (base Tuple0)) (+ (- a_last a_first) 1)))
     (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true)))
...
;; H
  ...
  (=> (= result2 true)
  (forall ((k1 Int))
  (=> (and (<= (to_rep aux3__first) k1) (<= k1 (to_rep aux3__last)))
  (and
  (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first)))
  (= (to_rep1 (select aux38 k1)) (to_rep1
                                 (select a13 (- (+ a_first k1) aux3_first)))))
  (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first))))
  (= (to_rep1 (select aux38 k1)) (to_rep1 (select (map__content aux36) k1)))))))))
...
;; H
  ...
  (=> (not (= result2 true))
  (= (oeq
     (num_of_big_int (mk___t a14 (mk (to_rep a__first) (to_rep a__last)))
     a_first (+ (- a_last a_first) 1))
     (omod
     (omultiply
     (omultiply
...
;; H
  ...
  (and
  (=> (and (<= aux3_first k1) (<= k1 (- (+ aux3_first a_last) a_first)))
  (= (to_rep1 (select aux39 k1)) (to_rep1
                                 (select a14 (- (+ a_first k1) aux3_first)))))
  (=> (=> (<= aux3_first k1) (not (<= k1 (- (+ aux3_first a_last) a_first))))
  (= (to_rep1 (select aux39 k1)) (to_rep1 (select aux31 k1)))))))))
...
;; H
  (assert (and (= o59 (- e_last e_first)) (in_range1 (- e_last e_first))))

;; H
  (assert (and (= o60 o59) (uint_in_range1 o59)))

;; H
  (assert (= o61 ((_ int2bv 64) o60)))

;; H
  (assert (= o62 (bvadd o61 ((_ int2bv 64) 1))))

;; H
  (assert (= o63 (bvmul o62 ((_ int2bv 64) 32))))

;; H
  (assert (= o64 (ite (bvult i2 o63) true false)))

;; H
  (assert (= o56 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o55 (from_word64 i2)))

;; H
  (assert (= o57 (oadd o55 o56)))

;; H
  (assert (= o54 (from_integer (int__content s12))))

;; H
  (assert (= o58 (ole o54 o57)))

;; H
  (assert (and (= o49 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o52 (ite (<= n o51) true false)))

;; H
  (assert (= result9 (ite (<= 0 n) o52 false)))
...
;; H
  (assert (and (= o45 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert (= o46 (num_of_big_int m m_first o45)))

;; H
  (assert (and (= o42 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert
  (and (= o41 (base Tuple0))
  (= o41 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o43 (oexpon o41 o42)))

;; H
  (assert (= o36 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o34 (from_integer (int__content s12))))

;; H
  (assert (= o33 (from_word64 i2)))

;; H
  (assert (= o35 (osubtract o33 o34)))

;; H
  (assert (= o37 (oadd o35 o36)))
...
;; H
  (assert (= o40 (oexpon__2 o26 o39)))

;; H
  (assert (= o44 (omultiply o40 o43)))

;; H
  (assert (= o47 (omod o44 o46)))

;; H
  (assert (and (= o23 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert
  (= o24 (num_of_big_int
         (mk___t (map__content aux310)
         (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o23)))

;; H
  (assert (= o48 (oeq o24 o47)))

;; H
  (assert (and (= o21 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert (= o22 (num_of_big_int m m_first o21)))
...
;; H
  (assert
  (and (= o18 (base Tuple0))
  (= o18 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o20 (oexpon o18 o19)))
