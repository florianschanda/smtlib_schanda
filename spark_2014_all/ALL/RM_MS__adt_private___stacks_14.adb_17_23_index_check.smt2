...
(declare-fun temp___1871 () pointer_range)
...
;; H
  (assert
  (and (= o (+ (to_rep1 s__split_fields1) 1)) (in_range2
  (+ (to_rep1 s__split_fields1) 1))))
...
;; H
  (assert (= temp___187 o2))

;; H
  (assert (= temp___1871 o3))
...
;; H
  (assert (= temp___187 s__split_fields2))

;; H
  (assert (= temp___1871 s__split_fields3))
...
(assert
;; WP_parameter_def
 ;; File "stacks_14.adb", line 8, characters 0-0
  (not (<= 1 (to_rep1 s__split_fields3))))
(check-sat)
(exit)
