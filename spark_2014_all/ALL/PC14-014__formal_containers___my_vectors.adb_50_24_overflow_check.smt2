...
(define-fun l__split_fields19 () us_split_fields (mk___split_fields
                                                 l__split_fields2))
...
;; H
  (assert (= l__split_fields20 my_vectors__v__append__2__container__fields1))
...
;; H
  ...
  (length (mk___rep l__split_discrs l__split_fields20)) 4))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields20))
     (model__
  ...
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1))
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields20))) 1)
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields20))) 4) 9) true))))

;; H
  (assert (= result2 l__split_fields1))

;; H
  (assert (= l__split_fields19 my_vectors__v__append__3__container__fields1))
...
;; H
  ...
  (= (olt
     ...
     (model__ (mk___rep l__split_discrs l__split_fields19))) true)))
...
;; H
  (assert
  (and (= o9 (last (model__ (mk___rep l__split_discrs l__split_fields18))))
  (and (in_range4 o9)
  (= o9 (last (model__ (mk___rep l__split_discrs l__split_fields18)))))))
