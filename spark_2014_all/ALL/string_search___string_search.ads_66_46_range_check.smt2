...
;; H
  ...
  (forall ((k23 Int))
  (=>
  (and (<= (to_rep2 (first (rt needle))) k23)
  (<= k23 (to_rep2 (last (rt needle)))))
  (not (= c (to_rep1 (select (elts needle) k23))))))
  (and
  (= (to_rep1
  ...
  (forall ((k23 Int))
  (=>
  (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k23)
  (<= k23 (to_rep2 (last (rt needle)))))
  (not (= (to_rep1 (select (elts needle) k23)) c))))))))))
...
;; H
  ...
  r59b2))
  (and
  (and (and (= result21 k22) (= k3 r58b2))
  (ite (and (<= r58b2 k3) (<= k3 r59b2))
  (and
  (and
  (and (= temp___300 k3)
  (and
  ...
  (and
  (forall ((l Int))
  (=> (and (<= 1 l) (<= l k4)) (not (= (match_at needle haystack l) true))))
  (and
  (and (=> (<= r58b2 r59b2) (dynamic_property3 r58b2 r59b2 k4))
  (and (<= r58b2 k4) (<= k4 r59b2))) (= k4 r59b2)))))
  (and (= k5 (mk_int__ref k4)) (= k6 k4))) (and (= k7 k5) (= k8 k6)))
  (and (= k7 (mk_int__ref k3)) (= k8 k3))))
  (and
  ...
  (<= k23 (- (+ i2 (to_rep
                   (select bad_shift (to_rep1
                                     (select (elts haystack) (+ i2 (length
                                                                   needle))))))) 1)))
  (not (= (match_at needle haystack k23) true)))))
  (and
  (and
  (and
  (and
