...
(define-fun m_elements_reversed ((left us_rep2)
  (right us_rep2)) Bool (and (and (= (length left) (length right)) (ite
                                                                   (forall
                                                                   ((i Int))
                                                                   (=>
                                                                   (and
...
;; H
  ...
  (= (to_rep
     (rec__hnco__test2__v_type_owner__vector_type__capacity
     container__split_discrs)) r265s))

;; H
  (assert (in_range r265s))

(assert
;; WP_parameter_def
 ;; File "aida-containers-formal_vectors.ads", line 112, characters 0-0
  (not (in_range1 r265s)))
(check-sat)
(exit)
