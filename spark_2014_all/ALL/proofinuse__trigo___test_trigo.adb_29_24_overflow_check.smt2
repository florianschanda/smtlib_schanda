...
;; H
  (assert (=> (le f1 fliteral) (= dummy22 (mk_t__ref dummy9))))
...
;; H
  (assert (=> (not (le f1 fliteral)) (= dummy22 (mk_t__ref dummy5))))
...
;; H
  (assert (=> (le f8 fliteral) (= dummy21 (mk_t__ref dummy15))))
...
;; H
  (assert (=> (not (le f8 fliteral)) (= dummy21 dummy22)))
