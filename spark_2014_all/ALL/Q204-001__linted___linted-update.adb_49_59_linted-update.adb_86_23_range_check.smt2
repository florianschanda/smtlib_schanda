...
(declare-const o173 (_ BitVec 32))
...
(declare-const o175 storage_element)

(declare-const o176 (_ BitVec 8))
...
;; H
  (assert (= o175 (select temp___513 1)))

;; H
  (assert (= o176 (to_rep o175)))

;; H
  (assert (= o177 ((_ zero_extend 24) o176)))

;; H
  (assert (= o178 (bvshl o177 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o171 (select temp___509 2)))

;; H
  (assert (= o172 (to_rep o171)))

;; H
  (assert (= o173 ((_ zero_extend 24) o172)))

;; H
  (assert (= o174 (bvshl o173 ((_ int2bv 32) 16))))
