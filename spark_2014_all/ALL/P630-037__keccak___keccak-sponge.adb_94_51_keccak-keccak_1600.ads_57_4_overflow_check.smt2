...
;; H
  (assert (= o10 temp___817))

;; H
  (assert (= (mk4 (to_rep1 (first (rt data))) r85s) temp___8171))
...
;; H
  (assert (= temp___825 (mk___rep o12)))
...
;; H
  (assert (= ctx__split_fields6 (us_split_fields1 temp___825)))
...
;; H
  (assert (= result11 (mk_int__ref remaining_bytes1)))

;; H
  (assert (= remaining_bytes2 o15))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range1 (- remaining_bits1 free_bits_in_block1))))
(check-sat)
(exit)
