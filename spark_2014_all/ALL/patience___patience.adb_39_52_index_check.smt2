...
;; H
  (assert
  (=> (= result8 true)
  (= result7 (ite (< o28 (to_rep1 s__split_fields2)) true false))))
...
;; H
  (assert (=> (= result7 true) (= o25 (to_rep1 o24))))
...
;; H
  (assert (=> (= result6 true) (= temp___544 (to_rep1 o18))))

;; H
  (assert (=> (= result6 true) (and (<= 0 temp___544) (<= temp___544 99))))

;; H
  (assert (=> (= result6 true) (= o19 temp___544)))

;; H
  (assert (=> (= result6 true) (= o20 (select s__split_fields3 o19))))

;; H
  (assert (=> (= result6 true) (= o21 (to_rep1 o20))))
...
;; H
  (assert (=> (= result6 true) (= o22 (to_rep1 o16))))
