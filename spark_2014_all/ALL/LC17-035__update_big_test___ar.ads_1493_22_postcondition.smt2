...
(declare-fun temp___3097 ((Array Int et1) Int Int Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3099 (Array Int et1)))
  (forall ((temp___3100 Int) (temp___3101 Int) (temp___3102 Int)
  (temp___3103 Int))
  (let ((temp___3098 (temp___3097 temp___3099 temp___3100 temp___3101
                     temp___3102 temp___3103)))
  (forall ((temp___3104 Int))
  (ite (= temp___3104 temp___3102)
  (= (select temp___3098 temp___3104) (of_rep temp___3103))
  (ite (= temp___3104 temp___3100)
  (= (select temp___3098 temp___3104) (of_rep temp___3101))
  (= (select temp___3098 temp___3104) (select temp___3099 temp___3104)))))))))
...
(declare-const temp___8046 (Array Int et1))

(declare-const temp___80461 enum2t)
...
(declare-const temp___8049 (Array Int et1))

(declare-const temp___80491 enum2t)
...
;; H
  (assert (= temp___8046 o2))

;; H
  (assert (= temp___80461 o3))
...
;; H
  (assert (= temp___8046 r__split_fields2))

;; H
  (assert (= temp___80461 r__split_fields3))
...
;; H
  (assert (= temp___8049 o6))

;; H
  (assert (= temp___80491 o7))
...
;; H
  (assert (= temp___8049 r__split_fields4))

;; H
  (assert (= temp___80491 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1484, characters 0-0
  (not
  (= (bool_eq r__split_fields6 1 10 (temp___3097 r__split_fields i e j f) 1
     10) true)))
(check-sat)
(exit)
