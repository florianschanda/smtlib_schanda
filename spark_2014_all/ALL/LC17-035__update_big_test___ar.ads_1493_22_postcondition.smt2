...
(declare-fun temp___8046 () (Array Int et1))

(declare-fun temp___80461 () enum2t)
...
(declare-fun temp___8049 () (Array Int et1))

(declare-fun temp___80491 () enum2t)
...
;; WP_parameter_def
 ;; File "ar.ads", line 1484, characters 0-0
  (not
  (= (bool_eq3 r__split_fields6 1 10 (temp___3097 r__split_fields i e j f) 1
     10) true)))
(check-sat)
