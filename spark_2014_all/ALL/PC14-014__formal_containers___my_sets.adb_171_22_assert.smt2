...
(declare-fun temp___1453 () us_rep2)
...
;; H
  (assert
  (and
  (= temp___1453 (find1 (mk___rep1 l__split_discrs l__split_fields10) o46))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
               o46) false) true false)
  (= (bool_eq2 temp___1453 no_element) true)
  (and
  (and
  ...
  (= (= (to_rep1
        (rec__my_sets__my_rec__f
        (us_split_fields1
        (element (mk___rep1 l__split_discrs l__split_fields10) temp___1453))))
...
;; H
  (assert (= c__split_fields6 (us_split_fields5 temp___1453)))
