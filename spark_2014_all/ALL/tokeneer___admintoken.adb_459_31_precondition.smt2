...
(declare-fun dummy6 () adminprivileget)
...
(declare-fun dummy12 () serialnumbert)
...
(declare-fun dummy17 () millisecst)
...
(define-fun us_split_fields_ID6__projection ((a us_split_fields12)) us_rep1
  (rec__cert__id__contentst__id a))

(define-fun us_split_fields_NotBefore4__projection ((a us_split_fields12)) us_rep2
  (rec__cert__id__contentst__notbefore a))

(define-fun us_split_fields_NotAfter4__projection ((a us_split_fields12)) us_rep2
  (rec__cert__id__contentst__notafter a))

(define-fun us_split_fields_Mechanism4__projection ((a us_split_fields12)) algorithmt
...
(define-fun us_split_fields__ref_13__projection ((a us_split_fields__ref6)) us_split_fields12
...
(declare-fun dummy26 () us_rep6)

(declare-datatypes ()
((contentst__ref1 (mk_contentst__ref1 (contentst__content1 us_rep6)))))
(define-fun contentst__ref_4__projection ((a contentst__ref1)) us_rep6
...
(define-fun us_split_fields__ref_14__projection ((a us_split_fields__ref7)) us_split_fields14
  (us_split_fields__content7 a))

(declare-datatypes ()
((us_rep7 (mk___rep7 (us_split_fields15 us_split_fields14)))))
(define-fun us_rep_15__projection ((a us_rep7)) us_split_fields14 (us_split_fields15
                                                                  a))
...
(define-fun us_split_fields_Contents2__projection ((a us_split_fields16)) us_rep6
...
(declare-fun tokentry () Int)

(declare-fun tokenid () Int)

(declare-fun authcertcontents__split_fields () us_split_fields__ref4)
...
(declare-fun tokentry1 () Int)

(declare-fun result1 () Int)

(declare-fun tokenid1 () Int)

(declare-fun idvalid () Bool)

(declare-fun authvalid () Bool)

(declare-fun authcertcontents__split_fields1 () us_split_fields8)
