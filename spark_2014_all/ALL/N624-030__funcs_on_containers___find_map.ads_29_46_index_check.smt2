...
;; H
  ...
  (<= (to_rep1 (first (rt a))) (get
                               (model__
                               (index_map__content
                               find_map__find_all__result6)) e))
  (<= (get (model__ (index_map__content find_map__find_all__result6)) e)
  (to_rep1 (last (rt a)))))
  (= (to_rep
     (select (elts a) (get
                      (model__
                      (index_map__content find_map__find_all__result6)) e))) e)))))))
...
;; H
  ...
  (= result5 (has_key
             ...
             o4))
  (= (= result5 true)
  (= (has_key (model__ (index_map__content find_map__find_all__result6)) o4) true))))
