...
;; H
  (assert
  (and (= o9 (last1 (mk___rep l1__split_discrs l1__split_fields4)))
  ...
  (= (get1 (positions (mk___rep l1__split_discrs l1__split_fields4)) o9)
  (length (mk___rep l1__split_discrs l1__split_fields4)))))))

;; H
  (assert
  (and (= o10 (previous (mk___rep l1__split_discrs l1__split_fields4) o9))
