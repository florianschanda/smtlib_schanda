...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep r__split_discrs r__split_fields3))))
  (= (find temp___867 (get temp___867 i1)) i1))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep r__split_discrs r__split_fields3))))
  ...
  (=> (= (get temp___867 i1) (get temp___867 j)) (= i1 j)))))))))
...
;; H
  ...
  (and
  (and
  (and (= (length2 o6) (length s))
  (forall ((temp___425 Int))
  (=> (and (in_range2 temp___425) (= (iter_has_element o6 temp___425) true))
