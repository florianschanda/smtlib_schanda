...
;; H
  (assert (not (= zeroflag30 true)))

;; H
  (assert (= (to_int5 signflag30) (to_int5 overflowflag30)))

;; H
  (assert (= (let ((subject rsp)) rsp70) (let ((subject rsp)) rsp69)))
...
;; H
  (assert (= result136 (mk_t__ref3 xmm031)))
...
;; H
  (assert (= (writereg32post rax26 ((_ int2bv 32) 1)) true))
...
;; H
  (assert (= o188 (bvadd o187 ((_ int2bv 32) 1))))

;; H
  (assert (= (writereg32post (let ((subject rbx)) rbx31) o188) true))

;; H
  (assert (= result137 (let ((subject rbp)) (mk_t__ref3 rbp31))))
...
;; H
  (assert (= result138 (let ((subject rsp)) (mk_t__ref3 rsp70))))
...
;; H
  (assert (= o191 (bvsub o190 o189)))

;; H
  (assert (= o192 (ite (= o191 ((_ int2bv 32) 0)) true false)))

;; H
  (assert (= result139 (mk_bool__ref zeroflag31)))

;; H
  (assert (= zeroflag32 o192))
...
;; H
  (assert (= o195 (bvsub o194 o193)))

;; H
  (assert (= o196 (ite (bvugt o195 ((_ int2bv 32) 2147483647)) true false)))

;; H
  (assert (= result140 (mk_bool__ref signflag31)))

;; H
  (assert (= signflag32 o196))
...
;; H
  (assert (= o199 (ite (bvult o198 o197) true false)))

;; H
  (assert (= result141 (mk_bool__ref carryflag31)))

;; H
  (assert (= carryflag32 o199))
...
;; H
  (assert (=> (not (not (= signflag32 true))) (= result142 false)))
...
;; H
  (assert (=> (not (= result142 true)) (= o204 false)))
...
;; H
  (assert (=> (not (= signflag32 true)) (= result143 false)))
...
;; H
  (assert (=> (not (= result143 true)) (= o205 false)))

;; H
  (assert (= o206 (ite (= o205 false) o204 true)))

;; H
  (assert (= result144 (mk_bool__ref overflowflag31)))

;; H
  (assert (= overflowflag32 o206))
...
;; H
  (assert (= rdi39 (let ((subject rdi)) (mk_t__ref3 rdi38))))

;; H
  (assert (= rbp33 (let ((subject rbp)) (mk_t__ref3 rbp32))))

;; H
  (assert (= rsp73 (let ((subject rsp)) (mk_t__ref3 rsp72))))

;; H
  (assert (= rbx32 (let ((subject rbx)) (mk_t__ref3 rbx31))))

;; H
  (assert (= rax27 (mk_t__ref3 rax26)))

;; H
  (assert (= xmm033 (mk_t__ref3 xmm032)))

;; H
  (assert (= overflowflag33 (mk_bool__ref overflowflag32)))

;; H
  (assert (= signflag33 (mk_bool__ref signflag32)))

;; H
  (assert (= carryflag33 (mk_bool__ref carryflag32)))

;; H
  (assert (= zeroflag33 (mk_bool__ref zeroflag32)))
...
;; H
  (assert (= xmm034 xmm032))

;; H
  (assert (= overflowflag34 overflowflag32))

;; H
  (assert (= signflag34 signflag32))

;; H
  (assert (= carryflag34 carryflag32))

;; H
  (assert (= zeroflag34 zeroflag32))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 334, characters 0-0
  (not (= (t__content3 rsp73) (let ((subject rsp)) rsp69))))
(check-sat)
(exit)
