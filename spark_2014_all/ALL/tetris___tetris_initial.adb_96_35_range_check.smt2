...
(declare-fun temp___751 () (Array Int (Array Int cell)))

(declare-fun temp___750 () Bool)
...
;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___753 to_line1)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___751 cur_board)))

;; H
  (assert
  (=> (and (<= 1 del_line1) (<= del_line1 50))
  (= temp___750 has_complete_lines1)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___752 Int))
  (=> (and (<= 1 temp___752) (<= temp___752 50))
  (=> (<= del_line2 temp___752)
  (= (select cur_board2 temp___752) (select temp___751 temp___752)))))
