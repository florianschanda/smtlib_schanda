...
;; H
  (assert (bvugt n3 var1_range_size))

;; H
  (assert (= (mk_t__ref result1) (mk_t__ref n1)))

;; H
  (assert (= n11 ((_ int2bv 64) 0)))

;; H
  (assert (= (mk_t__ref result2) (mk_t__ref n2)))

;; H
  (assert (= n21 (bvsub n3 var1_range_size)))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 19, characters 0-0
  (not (bvule n21 var2_range_size)))
(check-sat)
(exit)
