...
(((mk_t76b__ref (t76b__content unsigned_64)))))
...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 (bvsub rcx_start rcx)))
  (=> (not (= i2 (bvsub rcx_start rcx)))
  (= (hasmem64 mem (bvadd rdi_start (bvmul i2 ((_ int2bv 64) 8))) rax) true))))
  (and
  ...
  (=> (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 (bvsub rcx_start rcx)))
  (=> (not (= i2 (bvsub rcx_start rcx)))
  (= (nooverlap8 (bvadd rdi_start (bvmul i2 ((_ int2bv 64) 8))) rdi) true))))))))))
