...
;; def_axiom
  (assert
  (forall ((temp___273 map1))
  (forall ((temp___274 Int) (temp___275 Int) (temp___276 Int)
  (temp___277 Int) (temp___278 Int) (temp___279 Int) (temp___280 Int))
  (let ((temp___272 (temp___271 temp___273 temp___274 temp___275 temp___276
                    temp___277 temp___278 temp___279 temp___280)))
  (forall ((temp___281 Int) (temp___282 Int) (temp___283 Int))
  (ite (or
       (and (and (= temp___281 temp___274) (= temp___282 temp___275))
       (= temp___283 temp___276))
       (and (and (= temp___281 temp___277) (= temp___282 temp___278))
       (= temp___283 temp___279)))
  (= (get temp___272 temp___281 temp___282 temp___283) (of_rep temp___280))
  (= (get temp___272 temp___281 temp___282 temp___283) (get temp___273
...
(assert
;; WP_parameter_def
 ;; File "update_checks.adb", line 49, characters 0-0
  (not (in_range2 (+ z2 1))))
(check-sat)
