...
;; H
  (assert
  (=> (= (length (mk___t temp___523 temp___5231)) 0)
  (= (temp___String_Literal_522 Tuple0) temp___525)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___523 temp___5231)) 0))
  (=> (<= 1 5) (= o26 (+ (- 5 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___523 temp___5231)) 0))
  (= o29 (+ (to_rep1 (first temp___5231)) o28))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___523 temp___5231)) 0)) (= o30 (- o29 1))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___523 temp___5231)) 0))
  (and (= o31 o30) (in_range2 o30))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___523 temp___5231)) 0))
  (= (concat1 temp___523 (to_rep1 (first temp___5231))
     (to_rep1 (last temp___5231)) (temp___String_Literal_522 Tuple0) 1 5)
  temp___525)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___523 temp___5231)) 0))
  (= (mk (to_rep1 (first temp___5231)) o31) temp___5251)))

;; H
  (assert (not (= (length (mk___t temp___525 temp___5251)) 0)))

;; H
  (assert
  (=>
  (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22)))))
  (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22))))))
  (= o32 (+ (- (to_rep1
               (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22)))))
  (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22)))))) 1))))
...
;; H
  ...
  (= o33 (+ (- (to_rep1 (last temp___5251)) (to_rep1 (first temp___5251))) 1))))
...
;; H
  (assert (= o35 (+ (to_rep1 (first temp___5251)) o34)))
