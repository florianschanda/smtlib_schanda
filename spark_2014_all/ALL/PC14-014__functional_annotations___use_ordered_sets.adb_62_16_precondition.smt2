...
(declare-fun use_ordered_sets__are_disjoint_2__result () Bool)

(declare-fun result2 () Bool)

(declare-fun use_ordered_sets__are_disjoint_2__result1 () Bool)
...
(define-fun use_ordered_sets__are_disjoint_2__cu__assume1 () us_rep1
  (mk___rep1
  (mk___split_fields1 use_ordered_sets__are_disjoint_2__cu__assume)))

;; H
  (assert
  (and (= use_ordered_sets__are_disjoint_2__cu__assume1 (first s1))
  (ite (= (= (length2 s1) 0) true)
  (= (bool_eq1 use_ordered_sets__are_disjoint_2__cu__assume1 no_element) true)
  (and
  (= (has_key (positions s1) use_ordered_sets__are_disjoint_2__cu__assume1) true)
  (= (get1 (positions s1) use_ordered_sets__are_disjoint_2__cu__assume1) 1)))))
...
;; H
  (assert
  (= use_ordered_sets__are_disjoint_2__result1 use_ordered_sets__are_disjoint_2__result))
