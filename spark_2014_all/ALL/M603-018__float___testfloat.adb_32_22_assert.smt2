...
;; H
  (assert
  (and (and (le x z) (le z y))
  (and (and (le (neg fliteral2) x) (le x fliteral2))
  (and (eq y (add RNE1 x fliteral))
  (and (eq (roundToIntegral RTN1 z) x) (eq (roundToIntegral RTP1 z) y))))))

;; H
  (assert (and (= o (add RNE1 x y)) (tqtisFinite (add RNE1 x y))))

;; H
  (assert (= o1 (div1 RNE1 o fliteral3)))
...
;; H
  (assert (tqtisFinite t2))

;; H
  (assert (eq (roundToIntegral RTN1 x) x))

;; H
  (assert (eq (roundToIntegral RTN1 y) y))

;; H
  (assert (eq (roundToIntegral RTN1 z) x))

;; H
  (assert (eq (roundToIntegral RTN1 t2) x))

;; H
  (assert (eq (roundToIntegral RTP1 x) x))

;; H
  (assert (eq (roundToIntegral RTP1 y) y))

;; H
  (assert (eq (roundToIntegral RTP1 z) y))

;; H
  (assert (eq (roundToIntegral RTP1 t2) y))

;; H
  (assert (and (le x z) (le z y)))
