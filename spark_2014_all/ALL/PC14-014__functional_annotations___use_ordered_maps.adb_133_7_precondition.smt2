...
(define-fun m__split_fields2 () us_split_fields (mk___split_fields
                                                m__split_fields1))
...
;; H
  ...
  (= (length (mk___rep m__split_discrs m__split_fields2)) (+ (length
                                                             ...
                                                             (mk___split_fields
                                                             m__split_fields))) 1))
  (= (has_key (model__ (mk___rep m__split_discrs m__split_fields2)) 1) true))
  (= (get1 (keys (mk___rep m__split_discrs m__split_fields2))
     (find (keys (mk___rep m__split_discrs m__split_fields2)) 1)) 1))
  (= (get (model__ (mk___rep m__split_discrs m__split_fields2)) 1) 0))
  (= (ole
  ...
  (= (keys_included_except
     (model__ (mk___rep m__split_discrs m__split_fields2))
     (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     1) true))
  (= (range_equal
     (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (keys (mk___rep m__split_discrs m__split_fields2)) 1
     (- (find (keys (mk___rep m__split_discrs m__split_fields2)) 1) 1)) true))
  (= (range_shifted
     (keys (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (keys (mk___rep m__split_discrs m__split_fields2))
     (find (keys (mk___rep m__split_discrs m__split_fields2)) 1)
     (length (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     (positions (mk___rep m__split_discrs m__split_fields2))
     (find (keys (mk___rep m__split_discrs m__split_fields2)) 1) 1) true)))
...
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 76, characters 0-0
  (not
  (< (length (mk___rep m__split_discrs m__split_fields2)) (to_rep
                                                          (rec__use_ordered_maps__my_maps__map__capacity
                                                          m__split_discrs)))))
(check-sat)
(exit)
