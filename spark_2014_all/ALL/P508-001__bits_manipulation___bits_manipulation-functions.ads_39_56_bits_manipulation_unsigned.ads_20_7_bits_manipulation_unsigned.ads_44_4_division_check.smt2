...
(define-fun dynamic_invariant1 ((temp___expr_305 (_ BitVec 32))
...
;; H
  (assert
  (=> (< n 4294967296) (= o1 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) n)))))

;; H
  (assert (=> (not (< n 4294967296)) (= o1 ((_ int2bv 32) 0))))

;; H
  (assert (= o2 (ite (= o1 ((_ int2bv 32) 0)) true false)))
...
;; H
  (assert
  (=> (< n 4294967296) (= o (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) n)))))

;; H
  (assert (=> (not (< n 4294967296)) (= o ((_ int2bv 32) 0))))
