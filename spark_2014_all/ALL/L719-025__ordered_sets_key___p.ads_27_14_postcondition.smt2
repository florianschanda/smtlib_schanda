...
(define-fun default_initial_assumption ((temp___expr_379 us_rep1)
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant2 key1 true true true)
     ...
     (exists ((e Int))
     (and (and (in_range4 e) (= (contains1 (model__ container) e) true))
...
;; key__post_axiom
  (assert
  (forall ((i Int))
  (! (=> (dynamic_invariant i true true true) (dynamic_invariant1 (key i)
     true false true)) :pattern ((key i)) )))

;; key__def_axiom
  (assert
  (forall ((i Int))
  (! (=> (dynamic_invariant i true true true) (= (key i) i)) :pattern (
  (key i)) )))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (=>
     (and (in_range7 temp___393)
     (= (iter_has_element result temp___393) true))
     (= (contains1 (model__ container) (get1 result temp___393)) true))))
     (forall ((item Int))
     (=> (and (in_range4 item) (= (contains1 (model__ container) item) true))
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant5 item true true true)
     ...
     (=>
     (exists ((e Int))
     (and (and (in_range4 e) (= (contains1 container e) true))
...
;; is_empty__post_axiom
  ...
  (! (let ((result (is_empty1 container)))
     ...
     (= (= result true)
     (forall ((item Int))
     (not (and (in_range4 item) (= (contains1 container item) true)))))
...
;; included_except__post_axiom
  ...
  (! (=> (dynamic_invariant5 item true true true)
     ...
     (forall ((e Int))
     (=> (and (in_range4 e) (= (contains1 left e) true))
...
(define-fun dynamic_invariant8 ((temp___expr_372 Int)
...
;; get__post_axiom
  ...
  (! (=> (= (has_key container key1) true)
     ...
     (dynamic_invariant8 result true false true)))) :pattern ((get container
                                                              key1)) ))))
...
(define-fun e_is_find1 ((container us_rep3) (key1 Int)
  (position Int)) Bool (and (ite (< 0 position)
                            ...
                            key1) (of_int 1)) (ite (< position (length3
                                                               container))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 key1 true true true)
     ...
     (= (e_is_find1 container key1 result) true))) (dynamic_invariant4 result
     true false true)))) :pattern ((find2 container key1)) ))))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 key1 true true true)
     ...
     (ite (forall ((e Int))
          (=> (and (in_range4 e) (= (contains1 (model__ container) e) true))
...
;; H
  ...
  (and
  (and
  (= (length1 (mk___rep l__split_discrs l__split_fields4)) (length1
                                                           (mk___rep
                                                           l__split_discrs
                                                           (mk___split_fields
                                                           l__split_fields))))
...
(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 1732, characters 0-0
  (not
