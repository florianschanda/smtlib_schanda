...
(declare-fun certprocessing__timet__year__first__bit () Int)

(declare-fun certprocessing__timet__year__last__bit () Int)

(declare-fun certprocessing__timet__year__position () Int)
...
(declare-fun certprocessing__timet__month__first__bit () Int)

(declare-fun certprocessing__timet__month__last__bit () Int)

(declare-fun certprocessing__timet__month__position () Int)
...
(declare-fun certprocessing__timet__day__first__bit () Int)

(declare-fun certprocessing__timet__day__last__bit () Int)

(declare-fun certprocessing__timet__day__position () Int)
...
(declare-fun certprocessing__timet__hour__first__bit () Int)

(declare-fun certprocessing__timet__hour__last__bit () Int)

(declare-fun certprocessing__timet__hour__position () Int)
...
(declare-fun certprocessing__timet__minute__first__bit () Int)

(declare-fun certprocessing__timet__minute__last__bit () Int)

(declare-fun certprocessing__timet__minute__position () Int)
...
(declare-fun certprocessing__validityt__notbefore__first__bit () Int)

(declare-fun certprocessing__validityt__notbefore__last__bit () Int)

(declare-fun certprocessing__validityt__notbefore__position () Int)
...
(declare-fun certprocessing__validityt__notafter__first__bit () Int)

(declare-fun certprocessing__validityt__notafter__last__bit () Int)

(declare-fun certprocessing__validityt__notafter__position () Int)
...
(declare-datatypes ()
((validityt__ref (mk_validityt__ref (validityt__content us_rep4)))))
...
(define-fun us_split_fields_KeyID2__projection ((a us_split_fields10)) unsigned32t
  (rec__certprocessing__publickeyinfot__keyid a))

(define-fun us_split_fields_KeyLength2__projection ((a us_split_fields10)) unsigned32t
...
(define-fun us_rep_11__projection ((a us_rep5)) us_split_fields10 (us_split_fields11
                                                                  a))
...
(declare-fun certprocessing__publickeyinfot__algorithmid__first__bit () Int)

(declare-fun certprocessing__publickeyinfot__algorithmid__last__bit () Int)

(declare-fun certprocessing__publickeyinfot__algorithmid__position () Int)
...
(declare-fun certprocessing__publickeyinfot__keyid__first__bit () Int)

(declare-fun certprocessing__publickeyinfot__keyid__last__bit () Int)

(declare-fun certprocessing__publickeyinfot__keyid__position () Int)
...
(declare-fun certprocessing__publickeyinfot__keylength__first__bit () Int)

(declare-fun certprocessing__publickeyinfot__keylength__last__bit () Int)

(declare-fun certprocessing__publickeyinfot__keylength__position () Int)
...
(define-fun us_split_fields_SerialNumber2__projection ((a us_split_fields12)) unsigned32t
...
(define-fun us_split_fields_Issuer2__projection ((a us_split_fields12)) us_rep
...
(declare-fun certprocessing__idcertdatat__serialnumber__first__bit () Int)

(declare-fun certprocessing__idcertdatat__serialnumber__last__bit () Int)

(declare-fun certprocessing__idcertdatat__serialnumber__position () Int)
...
(declare-fun certprocessing__idcertdatat__sigalgid__first__bit () Int)

(declare-fun certprocessing__idcertdatat__sigalgid__last__bit () Int)

(declare-fun certprocessing__idcertdatat__sigalgid__position () Int)
...
(declare-fun certprocessing__idcertdatat__issuer__first__bit () Int)

(declare-fun certprocessing__idcertdatat__issuer__last__bit () Int)

(declare-fun certprocessing__idcertdatat__issuer__position () Int)
...
(declare-fun certprocessing__idcertdatat__validity__first__bit () Int)

(declare-fun certprocessing__idcertdatat__validity__last__bit () Int)

(declare-fun certprocessing__idcertdatat__validity__position () Int)
...
(declare-fun certprocessing__idcertdatat__subject__first__bit () Int)

(declare-fun certprocessing__idcertdatat__subject__last__bit () Int)

(declare-fun certprocessing__idcertdatat__subject__position () Int)
...
(declare-fun certprocessing__idcertdatat__subjectpublickeyinfo__first__bit () Int)

(declare-fun certprocessing__idcertdatat__subjectpublickeyinfo__last__bit () Int)

(declare-fun certprocessing__idcertdatat__subjectpublickeyinfo__position () Int)
...
(declare-datatypes ()
((idcertdatat__ref (mk_idcertdatat__ref (idcertdatat__content us_rep6)))))
...
(declare-fun dummy19 () millisecst)
...
(define-fun us_split_fields_Year2__projection ((a us_split_fields14)) yearst
  (rec__clock__timet__year a))

(define-fun us_split_fields_Month2__projection ((a us_split_fields14)) monthst
  (rec__clock__timet__month a))

(define-fun us_split_fields_Day2__projection ((a us_split_fields14)) dayst
...
(define-fun us_split_fields__ref_16__projection ((a us_split_fields__ref7)) us_split_fields14
  (us_split_fields__content7 a))

(declare-datatypes ()
((us_rep7 (mk___rep7 (us_split_fields15 us_split_fields14)))))
(define-fun us_rep_16__projection ((a us_rep7)) us_split_fields14 (us_split_fields15
                                                                  a))
...
(declare-fun dummy20 () us_rep7)

(declare-datatypes ()
((timet__ref1 (mk_timet__ref1 (timet__content1 us_rep7)))))
(define-fun timet__ref_2__projection ((a timet__ref1)) us_rep7 (timet__content1
                                                               a))
...
(define-fun us_split_fields_ID4__projection ((a us_split_fields16)) us_rep2
  (rec__cert__id__contentst__id a))

(define-fun us_split_fields_NotBefore3__projection ((a us_split_fields16)) us_rep7
  (rec__cert__id__contentst__notbefore a))

(define-fun us_split_fields_NotAfter3__projection ((a us_split_fields16)) us_rep7
...
(define-fun us_split_fields_Subject2__projection ((a us_split_fields16)) us_rep
...
(define-fun us_split_fields__ref_19__projection ((a us_split_fields__ref8)) us_split_fields16
  (us_split_fields__content8 a))

(declare-datatypes ()
((us_rep8 (mk___rep8 (us_split_fields17 us_split_fields16)))))
(define-fun us_rep_20__projection ((a us_rep8)) us_split_fields16 (us_split_fields17
                                                                  a))
...
(declare-datatypes ()
((contentst__ref (mk_contentst__ref (contentst__content us_rep8)))))
(define-fun contentst__ref_2__projection ((a contentst__ref)) us_rep8
  (contentst__content a))

(declare-fun rawcert () (Array Int character))
...
(declare-fun contents__split_fields () us_split_fields__ref8)

(declare-fun localcontents__split_fields () us_split_fields__ref6)

(declare-fun o () serialnumbert)
...
(declare-fun o9 () us_split_fields16)

(declare-fun temp___1295 () us_rep8)

(declare-fun o10 () algorithmt)

(declare-fun o11 () us_split_fields16)

(declare-fun temp___1297 () us_rep8)

(declare-fun o12 () algorithmt)

(declare-fun o13 () algorithmt)

(declare-fun o14 () keyidt)

(declare-fun o15 () keylengtht)

(declare-fun o16 () algorithmt)

(declare-fun o17 () keyidt)

(declare-fun o18 () keylengtht)

(declare-fun o19 () us_split_fields16)

(declare-fun temp___1302 () us_rep8)

(declare-fun o20 () keyidt)

(declare-fun o21 () algorithmt)

(declare-fun o22 () keyidt)

(declare-fun o23 () keylengtht)

(declare-fun o24 () algorithmt)

(declare-fun o25 () keyidt)

(declare-fun o26 () keylengtht)

(declare-fun o27 () us_split_fields16)

(declare-fun temp___1305 () us_rep8)

(declare-fun localcontents__split_fields1 () us_split_fields12)

(declare-fun result () us_split_fields__ref8)

(declare-fun contents__split_fields1 () us_split_fields16)

(declare-fun result1 () us_split_fields__ref8)

(declare-fun contents__split_fields2 () us_split_fields16)

(declare-fun result2 () us_split_fields__ref8)

(declare-fun contents__split_fields3 () us_split_fields16)

(declare-fun result3 () us_split_fields__ref8)

(declare-fun contents__split_fields4 () us_split_fields16)

(declare-fun result4 () us_split_fields__ref8)

(declare-fun contents__split_fields5 () us_split_fields16)

(declare-fun result5 () us_split_fields__ref8)

(declare-fun contents__split_fields6 () us_split_fields16)
