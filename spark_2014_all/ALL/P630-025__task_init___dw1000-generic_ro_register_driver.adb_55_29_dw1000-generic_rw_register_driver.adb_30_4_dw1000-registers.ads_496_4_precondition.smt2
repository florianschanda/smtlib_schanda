...
(define-fun register_type__ref___162__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___114__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___114__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5931 us_t1)
  (temp___is_init_5928 Bool) (temp___skip_constant_5929 Bool)
  (temp___do_toplevel_5930 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5929 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5931)
                                       (last3 temp___expr_5931))
                                       (and (= (first3 temp___expr_5931) 1)
                                       (= (last3 temp___expr_5931) 1)))))
