...
;; H
  (assert
  (=> (< (to_rep1 a__first) i1)
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= temp___325 bad1))))
...
;; H
  (assert
  (=> (< (to_rep1 a__first) i1)
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad3 bad4))))
...
;; H
  (assert
  (=> (< (to_rep1 a__first) i1)
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad5 bad3))))
...
;; H
  (assert
  (=> (< (to_rep1 a__first) i1)
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= bad7 bad5))))
...
;; H
  (assert
  (=> (< (to_rep1 a__first) i1)
  (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= bad1 bad6))))
...
;; H
  (assert
  (=> (< (to_rep1 a__first) i1)
  (=> (not (and (<= (to_rep1 a__first) j3) (<= j3 i1))) (= bad7 bad1))))
