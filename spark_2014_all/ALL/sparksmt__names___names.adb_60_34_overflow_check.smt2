...
(define-fun in_range4 ((rec__names__data__char_tables__vector__capacity1 Int)
...
(define-fun dynamic_invariant ((temp___expr_393 us_rep)
  ...
  (temp___do_toplevel_392 Bool)) Bool (=>
                                      ...
                                      (in_range4 1024 temp___expr_393)))
...
(declare-fun dummy5 () capacity_range1)
...
(define-fun in_range6 ((rec__names__data__entry_tables__vector__capacity1 Int)
...
(declare-fun dummy8 () tchar_table_indexB)
...
(define-fun dynamic_invariant2 ((temp___expr_282 Int)
...
(declare-fun dummy13 () extended_index1)
...
(define-fun dynamic_invariant8 ((temp___expr_288 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_311 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_305 Int)
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq14 a b) (oeq1 a b)) :pattern ((user_eq14 a b)) )))
...
(define-fun dynamic_invariant12 ((temp___expr_380 Int)
