...
;; H
  (assert (= o27 (ite (= o26 initial_bit_rate1) true false)))

;; H
  (assert
  (and (= o24 (state_of (mk___rep ctx__split_fields10)))
  (and (in_range5 o24)
  (= o24 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields10))))))
...
;; H
  (assert (= o25 (ite (= o24 0) true false)))

;; H
  (assert
  (and (= o21 (+ remaining_bits3 7)) (in_range1 (+ remaining_bits3 7))))

;; H
  (assert (= o22 (div1 o21 8)))

;; H
  (assert (= o23 (ite (= remaining_bytes3 o22) true false)))
