...
;; H
  (assert
  (and (= o25 (rate_of (mk___rep ctx__split_fields10)))
  (and (in_range3 o25)
  (and
  (= o25 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert (= o26 (ite (= o25 initial_bit_rate1) true false)))

;; H
  (assert
  (and (= o23 (state_of (mk___rep ctx__split_fields10)))
  (and (in_range5 o23)
  (= o23 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields10))))))
...
;; H
  (assert (= o24 (ite (= o23 0) true false)))

;; H
  (assert
  (and (= o20 (+ remaining_bits3 7)) (in_range1 (+ remaining_bits3 7))))

;; H
  (assert (= o21 (div1 o20 8)))

;; H
  (assert (= o22 (ite (= remaining_bytes3 o21) true false)))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range1 (+ offset3 remaining_bytes3))))
(check-sat)
(exit)
