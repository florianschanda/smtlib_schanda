...
(declare-fun o32 () (Array Int natural))
...
;; H
  (assert
  (and (= o42 (remove a o10))
  (and (dynamic_invariant2 o42 true false true)
...
;; H
  (assert
  (and (= o16 (shift_perm_l o44 o43 o41))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o41 o43) true)))))
...
;; H
  (assert
  (and (= o31 (shift_perm_r o39 o38 o36))
  (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o39 o36) true)))))
...
;; H
  (assert
  (and
  (= o34 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o35 (remove b ib1))
  (and (dynamic_invariant2 o35 true false true)
  (and (= (invariant__ o35) true)
  (and (= (to_rep2 (last o33)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o32 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o32 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o32 k))))))))))))
