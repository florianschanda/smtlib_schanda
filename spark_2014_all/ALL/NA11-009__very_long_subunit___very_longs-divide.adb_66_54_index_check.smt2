...
(declare-datatypes ((tS115bP1__ref 0))
(((mk_tS115bP1__ref (tS115bP1__content tdigit_count_typeB)))))
(define-fun tS115bP1__ref___projection ((a tS115bP1__ref)) tdigit_count_typeB
  (tS115bP1__content a))
...
(((mk_s115b__ref (s115b__content us_t1)))))
...
(((mk_t117b__ref (t117b__content tdigit_count_typeB)))))
(define-fun t117b__ref___projection ((a t117b__ref)) tdigit_count_typeB
  (t117b__content a))
...
(((mk_t118b__ref (t118b__content us_t2)))))
...
(declare-fun temp___1179 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1181 (_ BitVec 8)))
  (forall ((temp___1182 Int) (temp___1183 Int))
  (let ((temp___1180 (temp___1179 temp___1181 temp___1182 temp___1183)))
  (and
  (=> (dynamic_property6 1 65536 temp___1182 temp___1183)
  (and (= (first5 temp___1180) temp___1182)
  (= (last5 temp___1180) temp___1183)))
  (forall ((temp___1184 Int))
  (= (select (to_array2 temp___1180) temp___1184) (of_rep1 temp___1181))))))))
...
(declare-const temp___1186 (Array Int octet))

(declare-const temp___11861 t2)

(declare-const temp___1187 (Array Int octet))

(declare-const temp___11871 t1)
...
(declare-const temp___1191 digit_index_type)

(declare-const temp___11911 (Array Int octet))

(declare-const temp___11912 t)
...
(declare-const temp___1196 us_rep)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1179 ((_ int2bv 8) 0) 1 r116b)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1179 ((_ int2bv 8) 0) 1 r116b)))) r116b))

;; H
  (assert
  (= (mk___t2 temp___1186 temp___11861) (temp___1179 ((_ int2bv 8) 0) 1
                                        r116b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11861)) (to_rep2 (last4 temp___11861)))
     (+ (- (to_rep2 (last4 temp___11861)) (to_rep2 (first4 temp___11861))) 1)
     0) (ite (<= 1 r116b) (+ (- r116b 1) 1) 0)))

;; H
  (assert (= temp___1186 temp___1187))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11861)) (to_rep2 (last4 temp___11861)))
  temp___11871))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___11871)) (to_rep2 (last2 temp___11871)))
     (+ (- (to_rep2 (last2 temp___11871)) (to_rep2 (first2 temp___11871))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1189 temp___11891) (mk___t1 temp___1187 temp___11871)))

;; H
  (assert (= temp___1189 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11891)) (to_rep2 (last2 temp___11891)))
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1191)))

;; H
  (assert (= temp___11911 o2))

;; H
  (assert (= temp___11912 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___11911 temp___11912))))
...
;; H
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1204)
  (<= temp___1204 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1204) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1204))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
...
;; H
  (assert (= temp___1196 (mk___rep result____split_discrs o18)))

;; H
  (assert (= result5 (mk___split_fields__ref result____split_fields3)))

;; H
  (assert (= result____split_fields4 (us_split_fields1 temp___1196)))

;; H
  (assert (= result____split_discrs (us_split_discrs1 temp___1196)))
