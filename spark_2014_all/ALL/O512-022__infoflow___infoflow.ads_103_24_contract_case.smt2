...
;; H
  ...
  (ite (<= k (div1 (to_rep h_v1__last) 2))
  (= (to_rep1 (select h_v11 k)) (to_rep1
                                (select h_v1 (+ k (div1 (to_rep h_v1__last)
                                                  2)))))
  (= (to_rep1 (select h_v11 k)) (to_rep1
                                (select h_v1 (- k (div1 (to_rep h_v1__last)
                                                  2)))))))))
...
;; H
  ...
  (ite (<= k (div1 (to_rep h_v2__last) 2))
  (= (to_rep1 (select h_v21 k)) (to_rep1
                                (select h_v2 (+ k (div1 (to_rep h_v2__last)
                                                  2)))))
  (= (to_rep1 (select h_v21 k)) (to_rep1
                                (select h_v2 (- k (div1 (to_rep h_v2__last)
                                                  2)))))))))
...
;; H
  ...
  (= (to_rep1 (select h_v12 i)) (to_rep1 (select h_v22 i)))))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 73, characters 0-0
  (not (= (to_rep1 (select h_v12 i)) (to_rep1 (select h_v22 i)))))
(check-sat)
(exit)
