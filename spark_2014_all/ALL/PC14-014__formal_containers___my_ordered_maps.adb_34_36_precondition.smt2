...
;; H
  (assert
  (and (= o4 (ceiling (mk___rep l__split_discrs l__split_fields8) 1))
  (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (<
          (last_key (mk___rep l__split_discrs l__split_fields8)) 1) true) true)
  ...
  (< (get1 (keys (mk___rep l__split_discrs l__split_fields8))
     (get (positions (mk___rep l__split_discrs l__split_fields8)) o4)) 1)))
