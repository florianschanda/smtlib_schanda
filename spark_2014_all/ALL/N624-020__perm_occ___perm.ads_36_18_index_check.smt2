...
;; H
  ...
  (and
  (and
  (and (= o13 (remove_last r))
  (and (dynamic_invariant2 o13 true false true)
  (and (= (elts r) o5)
  (= (mk
     (to_rep1
     (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))
     ...
     (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))))
  o6))))
  (= (occ o13 e) (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last)))
                 e)))
  (and
  (and (= o12 (remove_last a))
  ...
  (= (occ (mk___t b2 (mk (to_rep1 b__first) (to_rep1 b__last))) e) (occ
                                                                   o12
                                                                   e))
  (ite (= v e)
