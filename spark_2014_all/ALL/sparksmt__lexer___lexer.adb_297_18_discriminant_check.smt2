...
;; H
  (assert (= temp___863 o10))

;; H
  (assert (= temp___8631 o6))

;; H
  (assert (= temp___8632 o7))

;; H
  (assert (= temp___8633 o8))

;; H
  (assert (= temp___8634 o9))

;; H
  (assert (= true temp___8635))
...
;; WP_parameter_def
 ;; File "lexer.ads", line 79, characters 0-0
  (not (= temp___863 t__split_discrs)))
(check-sat)
(exit)
