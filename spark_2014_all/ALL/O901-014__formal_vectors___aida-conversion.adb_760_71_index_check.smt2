...
;; H
  ...
  (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer
                              (to_rep (select (elts source) j1)))))))
...
;; H
  ...
  (=> (< index2 temp___1568)
  (= (select n3 temp___1568) (select n1 temp___1568)))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) j)
  (<= j (to_rep1 (last (rt source))))))
