...
;; H
  ...
  (and (= o (add RNE1 x x)) (tqtisFinite (add RNE1 x x)))))
...
;; H
  ...
  (and (= o1 (mul RNE1 x2 fliteral2)) (tqtisFinite (mul RNE1 x2 fliteral2)))))
...
;; H
  (assert (le (neg fliteral) x3))

;; H
  (assert (le x3 fliteral))

(assert
;; WP_parameter_def
 ;; File "hard_stuff.adb", line 1, characters 0-0
  (not (tqtisFinite (mul RNE1 x3 x3))))
(check-sat)
