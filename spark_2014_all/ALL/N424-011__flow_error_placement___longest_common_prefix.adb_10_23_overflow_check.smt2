...
;; H
  (assert (and (= o4 (+ x l)) (in_range1 (+ x l))))

;; H
  (assert (= result1 (ite (<= o4 1000) true false)))

;; H
  (assert (=> (= result1 true) (and (= o3 (+ y l)) (in_range1 (+ y l)))))

;; H
  (assert (=> (= result1 true) (= result (ite (<= o3 1000) true false))))
...
;; H
  (assert (and (= temp___154 (+ y l)) (in_range1 (+ y l))))

;; H
  (assert (and (<= 1 temp___154) (<= temp___154 1000)))
