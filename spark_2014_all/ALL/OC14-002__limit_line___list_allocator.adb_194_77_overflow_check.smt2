...
;; H
  ...
  (= (bool_eq
     (select data3 (get
                   (rec__list_allocator__m__t__available
                   model____split_fields3) j2))
     (select data3 (get ma1 (+ j2 1)))) true))))

;; H
  (assert
  (forall ((j2 Int))
  (=> (and (<= 1 j2) (<= j2 (- (length ma1) 2)))
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 (get ma1 (+ j2 1)))))) (get ma1
                                                            (+ j2 2))))))
...
;; H
  ...
  (= (to_rep
     (rec__list_allocator__cell__next
     (us_split_fields1 (select data3 (get ma1 (+ j2 1)))))) (ite (< j2
                                                            (length
                                                            (rec__list_allocator__m__t__available
                                                            model____split_fields3)))
                                                            (get ma1
...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o53) true false))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o52 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o52)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o52 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o50) true false)))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o49 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o49))))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result14 true)
  (= result11 (ite (= o49 first_allocated1) true false))))))
...
;; H
  (assert (=> (= result11 true) (= o48 (ite (<= j1 o47) true false))))

;; H
  (assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o48 false))))
...
;; H
  (assert
  (and
  (= o46 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         j))
  (in_range7 o46)))

;; H
  (assert (= result17 (ite (in_range4 o46) true false)))
...
;; H
  (assert (= result18 (ite (< j o45) true false)))
