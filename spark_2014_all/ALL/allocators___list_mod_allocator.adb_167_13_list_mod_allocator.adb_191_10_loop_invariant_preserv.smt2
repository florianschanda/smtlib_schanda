...
(declare-fun c96b () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun c97b () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS6 () Int)

(declare-fun r99b () Int)
...
(declare-fun list_mod_allocator__alloc__C96b__assume () us_rep1)

(declare-fun list_mod_allocator__alloc__B98b__L_4__R99b__assume () Int)
...
;; H
  (assert
  (and (= o21 (model__ data first_available))
...
;; H
  (assert
  (= list_mod_allocator__alloc__C96b__assume (rec__list_mod_allocator__m__t__available
                                             o20)))
...
;; H
  (assert
  (and (= list_mod_allocator__alloc__B98b__L_4__R99b__assume (length c96b))
  (and (in_range5 list_mod_allocator__alloc__B98b__L_4__R99b__assume)
  (<= (+ 0 list_mod_allocator__alloc__B98b__L_4__R99b__assume) 2147483647))))
...
;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i2)) (= (get c96b j) (get c97b (+ j 1))))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (+ i2 1))) (= (get c96b (- j 1)) (get c97b j)))))

;; H
  (assert
  (and (=> (<= 1 r99b) (dynamic_property 1 r99b i2))
  (and (<= 1 i2) (<= i2 r99b))))
...
;; H
  ...
  (= (get c97b j) (to_rep
                  (rec__list_mod_allocator__cell__next
                  (us_split_fields1 (select data1 (get c96b i2))))))))))
