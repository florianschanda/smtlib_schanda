...
;; H
  (assert (and (= o (mul RNE1 x x)) (tqtisFinite (mul RNE1 x x))))

;; H
  (assert (= o1 (mul RNE1 o x)))

;; H
  (assert (and (= o2 o1) (tqtisFinite o1)))

;; H
  (assert (= o3 (mul RNE1 o2 x)))

;; H
  (assert (and (= o4 o3) (tqtisFinite o3)))

;; H
  (assert (= o5 (mul RNE1 o4 x)))

;; H
  (assert (and (= o6 o5) (tqtisFinite o5)))

;; H
  (assert (= o7 (mul RNE1 o6 x)))

;; H
  (assert (and (= o8 o7) (tqtisFinite o7)))

;; H
  (assert (= o9 (mul RNE1 o8 x)))

;; H
  (assert (and (= o10 o9) (tqtisFinite o9)))

;; H
  (assert (= o11 (mul RNE1 o10 x)))

;; H
  (assert (and (= o12 o11) (tqtisFinite o11)))

;; H
  (assert (= o13 (mul RNE1 o12 x)))
