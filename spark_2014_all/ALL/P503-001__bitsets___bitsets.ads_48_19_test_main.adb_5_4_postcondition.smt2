...
;; union__post_axiom
  ...
  (! (forall ((elt Int))
     (=> (and (<= 1 elt) (<= elt 10))
     (= (= (mem (union1 a b) elt) true)
     (or (= (mem a elt) true) (= (mem b elt) true))))) :pattern ((union1 a b)) )))
...
;; WP_parameter_def
 ;; File "bitsets.ads", line 44, characters 0-0
  (not (= (ext_equal a2 (union1 a b)) true)))
(check-sat)
(exit)
