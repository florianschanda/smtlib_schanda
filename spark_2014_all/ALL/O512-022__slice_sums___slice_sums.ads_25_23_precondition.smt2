...
;; H
  ...
  (= (= result13 true)
  (forall ((lo Int))
  (=> (and (<= (to_rep3 (first (rt x))) lo) (<= lo (to_rep3 (last (rt x)))))
  (forall ((hi Int))
  (=> (and (<= (to_rep3 (first (rt x))) hi) (<= hi (to_rep3 (last (rt x)))))
  (<= (sum__logic x
      (mk_slice_bounds (mk___split_fields (of_rep1 lo) (of_rep2 hi))))
  (sum__logic x
  (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5))))))))))
