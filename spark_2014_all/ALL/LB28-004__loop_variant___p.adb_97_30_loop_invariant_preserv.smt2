...
(declare-fun o42 () (Array Int integer))
...
(declare-fun temp___1872 () Int)

(declare-fun tab40 () map__ref)

(declare-fun j48 () int__ref)

(declare-fun k27 () int__ref)

(declare-fun tab41 () (Array Int integer))

(declare-fun j49 () Int)

(declare-fun k28 () Int)

(declare-fun tab42 () map__ref)

(declare-fun j50 () int__ref)

(declare-fun k29 () int__ref)

(declare-fun tab43 () (Array Int integer))
...
(declare-fun tab44 () (Array Int integer))
...
(declare-fun tab45 () (Array Int integer))
...
(declare-fun tab46 () (Array Int integer))
...
(declare-fun tab47 () map__ref)

(declare-fun j56 () int__ref)

(declare-fun k35 () int__ref)

(declare-fun temp___1942 () int__ref)

(declare-fun temp___1932 () int__ref)

(declare-fun tab48 () (Array Int integer))

(declare-fun j57 () Int)

(declare-fun k36 () Int)

(declare-fun temp___1943 () Int)
...
;; H
  (assert
  (=> (<= j45 b)
  (and (<= (to_rep tab__first) j45) (<= j45 (to_rep tab__last)))))
...
;; H
  (assert
  (forall ((l Int))
  (=> (and (<= a l) (<= l (- j54 1))) (= (to_rep (select tab45 l)) l))))

;; H
  (assert
  (forall ((l Int))
  (=> (and (<= a l) (<= l (- (+ a k33) 1))) (= (to_rep (select tab45 l)) l))))

;; H
  (assert
  (and (=> (<= (- 2147483648) 2147483647) (in_range1 j54))
  (=> (<= (- 2147483648) 2147483647) (in_range1 k33))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (int__content j56) (+ a (int__content k35)))))
(check-sat)
(exit)
