...
(declare-fun temp___178 () natural)

(declare-fun temp___1781 () Bool)

;; H
  (assert (and (= (to_rep temp___178) 0) (= temp___1781 (of_int 0))))

;; H
  (assert (= temp___1781 true))

(assert
;; WP_parameter_def
 ;; File "p.adb", line 2, characters 0-0
  (not (< 3 (to_rep temp___178))))
(check-sat)
(exit)
