...
(declare-fun temp___499 () count_type)

(declare-fun o2 () count_type)

(declare-fun temp___490 () count_type)

(declare-fun temp___4901 () us_main_type)

(declare-fun temp___488 () count_type)

(declare-fun temp___487 () count_type)

(declare-fun temp___4871 () us_main_type)

(declare-fun temp___486 () count_type)

(declare-fun temp___489 () us_rep)

(declare-fun temp___491 () us_rep)

(declare-fun temp___492 () us_rep)
...
(declare-fun result () cursor__ref)
...
(declare-fun c__split_fields5 () us_split_fields__ref1)

(declare-fun cu4 () cursor__ref)

(declare-fun l__split_fields5 () us_split_fields)

(declare-fun c__split_fields6 () us_split_fields2)

(declare-fun cu5 () us_rep1)

(declare-fun l__split_fields6 () us_split_fields__ref)

(declare-fun c__split_fields7 () us_split_fields__ref1)

(declare-fun cu6 () cursor__ref)

(declare-fun l__split_fields7 () us_split_fields)

(declare-fun c__split_fields8 () us_split_fields2)

(declare-fun cu7 () us_rep1)

(declare-fun l__split_fields8 () us_split_fields__ref)

(declare-fun c__split_fields9 () us_split_fields__ref1)

(declare-fun cu8 () cursor__ref)

(declare-fun l__split_fields9 () us_split_fields)

(declare-fun c__split_fields10 () us_split_fields2)

(declare-fun cu9 () us_rep1)

(declare-fun result8 () us_split_fields__ref1)

(declare-fun c__split_fields11 () us_split_fields2)

(declare-fun l__split_fields10 () us_split_fields__ref)

(declare-fun c__split_fields12 () us_split_fields__ref1)

(declare-fun cu10 () cursor__ref)

(declare-fun l__split_fields11 () us_split_fields)

(declare-fun c__split_fields13 () us_split_fields2)

(declare-fun cu11 () us_rep1)

(declare-fun l__split_fields12 () us_split_fields__ref)

(declare-fun c__split_fields14 () us_split_fields__ref1)

(declare-fun cu12 () cursor__ref)

(declare-fun l__split_fields13 () us_split_fields)

(declare-fun c__split_fields15 () us_split_fields2)

(declare-fun cu13 () us_rep1)
...
(define-fun o18 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
...
;; H
  (assert (=> (= result10 true) (= result9 (ite (= o17 0) true false))))
...
;; H
  (assert (= result12 (ite (< 0 o16) true false)))
