...
(declare-fun mul_div_2__mul_div__result () Int)
...
(declare-fun result_lo1 () Int)

(declare-fun result7 () Int)

(declare-fun mul_div_2__mul_div__result1 () Int)

(declare-fun mul_div_2__mul_div__result2 () Int)

(declare-fun mul_div_2__mul_div__result3 () Int)

(declare-fun v_m_hi2 () Int)

(declare-fun v_m_lo3 () Int)

(declare-fun result_hi3 () Int)

(declare-fun result_lo2 () Int)

(declare-fun remainder2 () Int)

(declare-fun mul_div_2__mul_div__result4 () Int)

(declare-fun v_m_hi3 () Int)

(declare-fun v_m_lo4 () Int)

(declare-fun result_hi4 () Int)

(declare-fun result_lo3 () Int)

(declare-fun remainder3 () Int)

(declare-fun mul_div_2__mul_div__result5 () Int)
...
;; H
  (assert
  (and (= o14 (+ result_hi2 result_lo1)) (in_range1
...
;; H
  (assert
  (= (mk_int__ref mul_div_2__mul_div__result4) (mk_int__ref
                                               mul_div_2__mul_div__result2)))
