...
(declare-datatypes ((t18s__ref 0)) (((mk_t18s__ref (t18s__content us_t1)))))
...
(((mk_tS32bP1__ref (tS32bP1__content tdigit_index_typeB)))))
...
(declare-datatypes ((s32b__ref 0)) (((mk_s32b__ref (s32b__content us_t2)))))
...
(((mk_t34b__ref (t34b__content tdigit_index_typeB)))))
...
(declare-datatypes ((t35b__ref 0)) (((mk_t35b__ref (t35b__content us_t3)))))
...
(declare-const temp___848 (Array Int octet))

(declare-const temp___8481 t3)

(declare-const temp___849 (Array Int octet))

(declare-const temp___8491 t2)

(declare-const temp___851 (Array Int octet))

(declare-const temp___8511 t2)
...
(declare-const temp___853 digit_index_type)

(declare-const temp___8531 (Array Int octet))

(declare-const temp___8532 t1)
