...
;; H
  (assert (= temp___986 o10))

;; H
  (assert (= temp___9861 o6))

;; H
  (assert (= temp___9862 o7))

;; H
  (assert (= temp___9863 o8))

;; H
  (assert (= temp___9864 o9))

;; H
  (assert (= true temp___9865))
...
;; WP_parameter_def
 ;; File "lexer.ads", line 79, characters 0-0
  (not (= temp___986 t__split_discrs)))
(check-sat)
(exit)
