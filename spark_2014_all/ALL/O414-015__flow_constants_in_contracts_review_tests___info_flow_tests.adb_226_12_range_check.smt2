...
(declare-datatypes ((t3__ref 0)) (((mk_t3__ref (t3__content tt2B)))))
...
(declare-datatypes ((tt4B__ref 0)) (((mk_tt4B__ref (tt4B__content tt4B)))))
...
(declare-datatypes ((t4__ref 0)) (((mk_t4__ref (t4__content tt4B)))))
