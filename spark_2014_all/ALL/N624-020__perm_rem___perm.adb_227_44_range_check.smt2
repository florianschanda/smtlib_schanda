...
(define-fun o26 () us_t (mk___t o24 o25))

(define-fun o27 () us_t (mk___t o21 o22))

(define-fun o28 () us_t (mk___t o19 o20))
...
;; H
  (assert
  (and (= o16 (shift_perm_l o32 o31 o29))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o29 o31) true)))))
...
;; H
  (assert
  (and
  (= o23 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o27 (remove b ib1))
  (and (dynamic_invariant2 o27 true false true)
  (and (= (invariant__ o27) true)
  (and (= (to_rep2 (last o22)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o21 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o21 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o21 k))))))))))))

;; H
  (assert
  (and (= o26 (remove o27 o23))
  (and (dynamic_invariant2 o26 true false true)
  (and (= (invariant__ o26) true)
  (and (= (to_rep2 (last o25)) (- (to_rep2 (last o22)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o23 1)))
  (= (to_rep (select o21 k)) (to_rep (select o24 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o23 1) k) (<= k (to_rep2 (last o22))))
  (= (to_rep (select o21 k)) (to_rep (select o24 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o23 k) (<= k (- (to_rep2 (last o22)) 1)))
  (= (to_rep (select o21 (+ k 1))) (to_rep (select o24 k))))))))))))

;; H
  (assert
  (and (= o28 (remove bb ib1))
  (and (dynamic_invariant2 o28 true false true)
  (and (= (invariant__ o28) true)
  (and (= (to_rep2 (last o20)) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select o19 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select o19 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o19 k))))))))))))

;; H
  (assert
  (and
  (= o18 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
