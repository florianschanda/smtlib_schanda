...
;; H
  ...
  (= (rec__dynamic_array__rec__b
     (us_split_discrs1
     (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j1))) true)
  (= (to_rep1
     (rec__dynamic_array__rec__f1
     (us_split_fields1
     (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) j1))))
  (increment
  (select (elts
          (rec__dynamic_array__holder__content
          (us_split_fields3 (new_holder c)))) j1)))))))
...
;; H
  ...
  (and
  (<= (to_rep1
      (first2 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3))))
  j)
  (<= j (to_rep1
        (last3 (rt1 (rec__dynamic_array__holder__content1 h__split_fields3)))))))
...
;; H
  (assert (= o23 (us_split_discrs1 o22)))

;; H
  (assert (= result2 (rec__dynamic_array__rec__b o23)))
...
;; H
  (assert
  (and (= o19 (new_holder c))
  (and (dynamic_invariant2 o19 true false true)
  (ite (= c 0)
  (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19))) 0)
  (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 o19)))
  c)))))
...
;; WP_parameter_def
 ;; File "dynamic_array.adb", line 31, characters 0-0
  (not (<= (to_rep1 (first (rt temp___218))) j)))
(check-sat)
(exit)
