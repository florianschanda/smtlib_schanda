...
(define-fun y10 () int__ref (mk_int__ref y2))

(define-fun y11 () int__ref (mk_int__ref y1))

(define-fun y12 () int__ref (mk_int__ref y))
...
;; H
  (assert
  (=> (bvule x3 ((_ int2bv 32) 2147483647))
  (and (= o18 (bv2nat x3)) (in_range1 (bv2nat x3)))))

;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= result1 y12)))

;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= y4 o18)))

;; H
  (assert
  (=> (not (bvule x3 ((_ int2bv 32) 2147483647)))
  (and (= o19 (bv2nat (bvnot x3))) (in_range1 (bv2nat (bvnot x3))))))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= o20 (- o19))))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= o21 (- o20 1))))
...
;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= result2 y12)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y5 o22)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y4 y5)))

;; H
  (assert (= (to_rep1 o23) y4))
...
;; H
  ...
  (and (= o50 (bv2nat x4)) (in_range1 (bv2nat x4)))))

;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= result5 y11)))

;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= y6 o50)))

;; H
  (assert
  (=> (not (bvule x4 ((_ int2bv 32) 2147483647)))
  (and (= o51 (bv2nat (bvnot x4))) (in_range1 (bv2nat (bvnot x4))))))

;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= o52 (- o51))))

;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= o53 (- o52 1))))
...
;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= result6 y11)))

;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= y7 o54)))

;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= y6 y7)))

;; H
  (assert (= (to_rep1 o55) y6))
...
;; H
  ...
  (and (= o82 (bv2nat x5)) (in_range1 (bv2nat x5)))))

;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= result9 y10)))

;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= y8 o82)))

;; H
  (assert
  (=> (not (bvule x5 ((_ int2bv 32) 2147483647)))
  (and (= o83 (bv2nat (bvnot x5))) (in_range1 (bv2nat (bvnot x5))))))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= o84 (- o83))))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= o85 (- o84 1))))
...
;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= result10 y10)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y9 o86)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y8 y9)))

;; H
  (assert (= (to_rep1 o87) y8))
...
;; H
  (assert (= o104 (select temp___450 1)))

;; H
  (assert (= o105 (to_rep o104)))

;; H
  (assert (= o106 ((_ zero_extend 24) o105)))

;; H
  (assert (= o107 (bvshl o106 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o100 (select temp___446 2)))

;; H
  (assert (= o101 (to_rep o100)))

;; H
  (assert (= o102 ((_ zero_extend 24) o101)))

;; H
  (assert (= o103 (bvshl o102 ((_ int2bv 32) 16))))
...
;; H
  (assert (= o96 (select temp___442 3)))

;; H
  (assert (= o97 (to_rep o96)))

;; H
  (assert (= o98 ((_ zero_extend 24) o97)))

;; H
  (assert (= o99 (bvshl o98 ((_ int2bv 32) 8))))
