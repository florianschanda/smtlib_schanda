...
(define-fun o33 () us_t (mk___t o14 o15))

(define-fun o34 () us_t (mk___t o11 o12))

(define-fun o35 () us_t (mk___t o8 o9))

(define-fun o36 () us_t (mk___t o6 o7))
...
;; H
  ...
  (and (in_range3 o2)
  (=> (= (of_int o2) true)
  (= (let ((temp___157 (remove
                       (remove a
                       (to_rep1
                       (rec__perm__witnesses__ia (us_split_fields1 w))))
                       o1)))
     (let ((temp___156 (remove (remove a o1)
                       (- (to_rep1
...
;; H
  (assert
  (and (= o16 (shift_perm_l o36 o35 o33))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o33 o35) true)))))
...
;; H
  (assert
  (and (= o25 (remove b ib2))
  (and (dynamic_invariant2 o25 true false true)
  (and (= (invariant__ o25) true)
  (and (= (to_rep2 (last (rt o25))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o25) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o25) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o25) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o26))) (- (to_rep2 (last (rt o25))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o25) k)) (to_rep (select (elts o26) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o25)))))
  (= (to_rep (select (elts o25) k)) (to_rep (select (elts o26) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o25))) 1)))
  (= (to_rep (select (elts o25) (+ k 1))) (to_rep (select (elts o26) k))))))))))))
...
;; H
  (assert
  (and (= o24 (remove bb o23))
  (and (dynamic_invariant2 o24 true false true)
  (and (= (invariant__ o24) true)
  (and (= (to_rep2 (last (rt o24))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o23 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o24) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o23 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o24) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o23 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o24) k))))))))))))
...
;; H
  (assert
  (and (= o20 (remove a o19))
  (and (dynamic_invariant2 o20 true false true)
  (and (= (invariant__ o20) true)
  (and (= (to_rep2 (last (rt o20))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o19 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o20) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o19 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o20) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o19 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o20) k))))))))))))

;; H
  (assert
  (and (= o22 (remove o20 o21))
  (and (dynamic_invariant2 o22 true false true)
  (and (= (invariant__ o22) true)
  (and (= (to_rep2 (last (rt o22))) (- (to_rep2 (last (rt o20))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o21 1)))
  (= (to_rep (select (elts o20) k)) (to_rep (select (elts o22) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o21 1) k) (<= k (to_rep2 (last (rt o20)))))
  (= (to_rep (select (elts o20) k)) (to_rep (select (elts o22) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o21 k) (<= k (- (to_rep2 (last (rt o20))) 1)))
  (= (to_rep (select (elts o20) (+ k 1))) (to_rep (select (elts o22) k))))))))))))

;; H
  (assert
  (and (= o27 (shift_perm_r o22 o24 o26))
  (and (in_range3 o27) (=> (= (of_int o27) true) (= (is_perm o22 o26) true)))))
...
;; H
  (assert
  (and (= o31 (remove b ib2))
  (and (dynamic_invariant2 o31 true false true)
  (and (= (invariant__ o31) true)
  (and (= (to_rep2 (last (rt o31))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o31) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o31) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o31) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o32))) (- (to_rep2 (last (rt o31))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o31) k)) (to_rep (select (elts o32) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o31)))))
  (= (to_rep (select (elts o31) k)) (to_rep (select (elts o32) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o31))) 1)))
  (= (to_rep (select (elts o31) (+ k 1))) (to_rep (select (elts o32) k))))))))))))

;; H
  (assert
  (and
  (= o30 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
...
;; H
  (assert
  (and (= o29 (remove a o28))
  (and (dynamic_invariant2 o29 true false true)
  (and (= (invariant__ o29) true)
  (and (= (to_rep2 (last (rt o29))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o28 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o29) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o28 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o29) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o28 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o29) k))))))))))))
