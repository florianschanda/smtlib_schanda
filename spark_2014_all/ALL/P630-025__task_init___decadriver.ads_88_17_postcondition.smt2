...
(declare-fun o21 () rx_frame_queue_index)
...
(declare-fun o26 () rx_frame_queue_index)
...
(declare-fun result7 () receiver_type__ref)

(declare-fun self__7 () us_rep1)

(declare-fun frame4 () map__ref)

(declare-fun size2 () int__ref)

(declare-fun error2 () int__ref)

(declare-fun self__8 () receiver_type__ref)

(declare-fun frame5 () (Array Int bits_8))

(declare-fun size3 () Int)

(declare-fun error3 () Int)

(declare-fun self__9 () us_rep1)
