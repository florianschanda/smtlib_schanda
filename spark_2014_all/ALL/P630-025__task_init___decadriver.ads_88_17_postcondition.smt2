...
;; H
  (assert
  (=> (= error1 0)
  (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___45531))))
...
;; H
  ...
  (= (select o4 temp___4555) (select temp___4554 temp___4555))
  (= (select o4 temp___4555) (select frame temp___4555)))))))
...
;; H
  ...
  (=> (not (= result2 true))
  (=> (<= (to_rep1 frame__first) (to_rep1 frame__last))
  (= o5 (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1))))))

;; H
  (assert
  (=> (= error1 0)
  (=> (not (= result2 true))
  (=> (not (<= (to_rep1 frame__first) (to_rep1 frame__last))) (= o5 0)))))

;; H
  (assert
  (=> (= error1 0)
  (=> (not (= result2 true)) (and (= temp___4541 o5) (in_range1 o5)))))
...
;; H
  ...
  (=> (= error1 0)
  (=> (not (= result2 true))
  (= o6 (rec__decadriver__rx_frame_type__frame
        (us_split_fields1 (select self__ (to_rep5 self__1))))))))
...
;; H
  ...
  (=> (= error1 0)
  (=> (not (= result2 true))
  (= o7 (slide temp___4546 (to_rep1 (first temp___45461))
...
;; H
  (assert
  (= (to_rep5 o8) (bvurem (bvadd (to_rep5 self__1) ((_ int2bv 8) 1)) ((_ int2bv 8) 2))))
