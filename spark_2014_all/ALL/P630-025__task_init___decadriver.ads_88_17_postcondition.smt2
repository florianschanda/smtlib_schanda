...
(declare-const o5 (Array Int bits_8))
...
(declare-const o8 (Array (_ BitVec 8) us_rep))

(declare-const o9 rx_frame_queue_index)
...
(declare-const o13 (Array (_ BitVec 8) us_rep))

(declare-const o14 rx_frame_queue_index)
...
(declare-const o21 rx_frame_queue_index)
...
(declare-const o26 rx_frame_queue_index)
...
(declare-const result3 (Array Int bits_8))
...
;; H
  (assert
  (=> (= error1 0) (=> (= result2 true) (= (mk_map__ref result3) frame6))))
...
;; H
  (assert
  (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5))
  o20))
...
;; H
  (assert (= self__6 (mk___rep1 (mk___split_fields1 o25 o26 o27 o28 o29))))
