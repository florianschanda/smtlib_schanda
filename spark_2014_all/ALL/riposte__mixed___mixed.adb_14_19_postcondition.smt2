...
(declare-const mixed__get_i__result Int)

(declare-const result Int)

(declare-const mixed__get_i__result1 Int)

(declare-const mixed__get_i__result2 Int)

(declare-const mixed__get_i__result3 Int)

(declare-const mixed__get_i__result4 Int)

(declare-const mixed__get_i__result5 Int)

(declare-const result1 Int)

;; H
  (assert (= mixed__get_i__result1 mixed__get_i__result2))

;; H
  (assert (= mixed__get_i__result3 mixed__get_i__result1))

;; H
  (assert (= result mixed__get_i__result))

;; H
  (assert
  (= mixed__get_i__result1 (to_rep (rec__mixed__rec__i (us_split_fields1 r)))))

;; H
  (assert
  (= (mk_int__ref mixed__get_i__result4) (mk_int__ref mixed__get_i__result2)))

;; H
  (assert (= mixed__get_i__result5 mixed__get_i__result3))

;; H
  (assert (= result1 mixed__get_i__result4))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= mixed__get_i__result4 (to_rep (rec__mixed__rec__i (us_split_fields1 r))))))
(check-sat)
(exit)
