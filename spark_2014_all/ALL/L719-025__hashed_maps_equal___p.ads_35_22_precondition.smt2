...
;; H
  (assert
  (and
  (= o7 (find (mk___rep l__split_discrs (mk___split_fields l__split_fields))
        k))
  (ite (ite (= (has_key1
               (model__
               (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  ...
  (= (get2
     ...
     o7) (find2
         ...
         k)))
  (= (my_eq
     (key (mk___rep l__split_discrs (mk___split_fields l__split_fields)) o7)
     k) true)))))

;; H
  (assert
  (and
  (= o6 (find (mk___rep l__split_discrs (mk___split_fields l__split_fields3))
        k))
  (ite (ite (= (has_key1
               (model__
               (mk___rep l__split_discrs
               (mk___split_fields l__split_fields3))) k) false) true false)
  ...
  (= (get2
     ...
     o6) (find2
         ...
         k)))
  (= (my_eq
     (key (mk___rep l__split_discrs (mk___split_fields l__split_fields3)) o6)
     k) true)))))
...
;; H
  ...
  (= o5 (get
        (model__
        (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
        (key (mk___rep l__split_discrs (mk___split_fields l__split_fields))
        cu1))))))
