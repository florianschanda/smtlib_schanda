...
(declare-fun user_eq4 (letter letter) Bool)

(declare-fun dummy4 () letter)

(declare-datatypes ()
((letter__ref (mk_letter__ref (letter__content letter)))))
(define-fun letter__ref___projection ((a letter__ref)) letter (letter__content
                                                              a))
...
(declare-datatypes ()
((string_access__ref (mk_string_access__ref (string_access__content us_rep)))))
(define-fun string_access__ref___projection ((a string_access__ref)) us_rep
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt w))) (to_rep1 (first (rt w))))
  (<= (to_rep1 (first (rt w))) (to_rep1 (last (rt w))))))

;; H
  (assert (= o (to_rep1 (first (rt w)))))

;; H
  (assert (= o1 (select (elts w) o)))
