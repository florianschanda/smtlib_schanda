...
(((mk_item_type__ref (item_type__content item_type)))))
...
(((mk_map__ref (map__content (Array Int item_type))))))
...
(((mk___t (elts (Array Int item_type))(rt t)))))
...
(((mk_item_array__ref (item_array__content us_t)))))
...
(((mk___t1 (elts1 (Array Int item_type))(rt1 t1)))))
...
(declare-datatypes ((t10b__ref 0)) (((mk_t10b__ref (t10b__content us_t1)))))
...
(((mk___t2 (elts2 (Array Int item_type))(rt2 t2)))))
...
(declare-datatypes ((t5b__ref 0)) (((mk_t5b__ref (t5b__content us_t2)))))
