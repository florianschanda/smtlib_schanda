...
(declare-datatypes ((us_t 0)) (((mk___t (elts (Array Int integer))(rt t1)))))
...
(declare-datatypes ((t3b__ref 0)) (((mk_t3b__ref (t3b__content ttB)))))
...
(((mk___t1 (elts1 (Array Int integer))(rt1 t2)))))
...
(((mk___split_discrs (rec__proc__r__length t)))))
...
(((mk___split_fields (rec__proc__r__contents us_t1)))))
...
(declare-datatypes ((tT14bP1__ref 0))
(((mk_tT14bP1__ref (tT14bP1__content ttB)))))
...
(((mk___t2 (elts2 (Array Int integer))(rt2 t3)))))
...
(declare-datatypes ((t14b__ref 0)) (((mk_t14b__ref (t14b__content us_t2)))))
(define-fun t14b__ref___projection ((a t14b__ref)) us_t2 (t14b__content a))

(declare-datatypes ((us_split_fields2 0))
(((mk___split_fields1 (rec__proc__r__contents1 us_t2)))))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields2)) us_t2
