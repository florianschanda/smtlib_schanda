...
(declare-const temp___8025 (Array Int bits_8))

(declare-const temp___80251 t2)

(declare-const temp___8026 (Array Int bits_8))

(declare-const temp___80261 t1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8026 temp___80261)))
