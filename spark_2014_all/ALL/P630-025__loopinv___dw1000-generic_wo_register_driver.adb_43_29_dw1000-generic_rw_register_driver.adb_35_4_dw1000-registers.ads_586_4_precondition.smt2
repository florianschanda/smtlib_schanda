...
(declare-const temp___8176 (Array Int bits_8))

(declare-const temp___81761 t1)
...
;; H
  (assert (= temp___8175 temp___8176))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___81751)) (to_rep (last4 temp___81751)))
  temp___81761))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___81761)) (to_rep (last2 temp___81761)))
     (+ (- (to_rep (last2 temp___81761)) (to_rep (first2 temp___81761))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8176 temp___81761)))
