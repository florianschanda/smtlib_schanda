...
(define-fun tT16bP1__ref___projection ((a tT16bP1__ref)) integer (tT16bP1__content
                                                                 a))
...
(define-fun us_split_fields_Content8__projection ((a us_split_fields6)) us_t2
...
(define-fun us_split_fields__ref_8__projection ((a us_split_fields__ref3)) us_split_fields6
...
(define-fun us_rep_15__projection ((a us_rep3)) us_split_discrs (us_split_discrs5
                                                                a))
...
(define-fun us_split_fields_Content9__projection ((a us_split_fields8)) us_rep3
  (rec__static_discr__holder__content1 a))

(define-fun us_split_fields_Length4__projection ((a us_split_fields8)) natural
...
(define-fun us_rep_17__projection ((a us_rep4)) us_split_discrs3 (us_split_discrs6
                                                                 a))

(define-fun us_rep_18__projection ((a us_rep4)) us_split_fields8 (us_split_fields9
                                                                 a))

(define-fun to_base2 ((a us_rep4)) us_rep2 (mk___rep2 (us_split_discrs6 a)
                                           (mk___split_fields2
                                           (of_base
                                           (to_base1
...
(define-fun my_holder__ref___projection ((a my_holder__ref)) us_rep4
...
(declare-datatypes ()
((nat_array__ref (mk_nat_array__ref (nat_array__content us_t3)))))
(define-fun nat_array__ref___projection ((a nat_array__ref)) us_t3 (nat_array__content
                                                                   a))
...
(define-fun dynamic_invariant1 ((temp___expr_224 us_rep4)
  ...
  (temp___do_toplevel_223 Bool)) Bool (and
                                      ...
                                      (in_range5 (last7 a) (last7 a)
                                      (to_base2 temp___expr_224)))
                                      (and (in_range4 (last7 a) (last7 a)
                                      (to_base1
                                      (rec__static_discr__holder__content1
                                      (us_split_fields9 temp___expr_224))))
                                      (and (dynamic_property5 1 (last7 a)
                                      (first5
                                      (rec__static_discr__i_holder__content2
                                      (us_split_fields7
                                      (rec__static_discr__holder__content1
...
(define-fun dynamic_invariant4 ((temp___expr_155 us_t3)
  (temp___is_init_152 Bool) (temp___skip_constant_153 Bool)
  (temp___do_toplevel_154 Bool)) Bool (=>
                                      (not (= temp___skip_constant_153 true))
                                      (dynamic_property6 1 2147483647
                                      (first7 temp___expr_155)
                                      (last7 temp___expr_155))))
...
(declare-fun current__split_fields3 () t2)
...
(declare-fun temp___390 () natural)

(declare-fun temp___3901 () natural)

(declare-fun temp___3902 () natural)

(declare-fun temp___3903 () natural)

(declare-fun temp___3904 () (Array Int natural))

(declare-fun temp___3905 () t2)

(declare-fun temp___3906 () natural)
...
(declare-fun result3 () us_split_fields__ref4)

(declare-fun current__split_fields5 () us_split_fields8)

(declare-fun current__split_fields6 () us_split_fields__ref4)
...
;; H
  ...
  (mk___rep4 current__split_discrs
  (mk___split_fields4
  (mk___rep3 (mk___split_discrs current__split_fields current__split_fields1)
  (mk___split_fields3
  (mk___t2 current__split_fields2 current__split_fields3)))
...
;; H
  (assert
  (and
  (<= (to_rep1 (first4 current__split_fields3)) (to_rep
                                                current__split_fields4))
  (<= (to_rep current__split_fields4) (to_rep1
                                      (last4 current__split_fields3)))))
...
;; H
  (assert
  (= current__split_discrs (mk___split_discrs1 temp___390 temp___3901)))
...
;; H
  (assert
  (= result3 (mk___split_fields__ref4
             (mk___split_fields4
             (mk___rep3
...
;; H
  (assert
  (= current__split_fields5 (mk___split_fields4
                            (mk___rep3
                            (mk___split_discrs temp___3902 temp___3903)
                            (mk___split_fields3
                            (mk___t2 temp___3904 temp___3905))) temp___3906)))
...
;; H
  (assert
  (= current__split_fields6 (mk___split_fields__ref4 current__split_fields5)))
...
;; H
  ...
  (= (bool_eq
     ...
     (us_split_fields7
     (rec__static_discr__holder__content1
     (us_split_fields__content4 current__split_fields6)))))
     (to_rep1
     (first4
     (rt2
     (rec__static_discr__i_holder__content2
     ...
     (rec__static_discr__holder__content1
     (us_split_fields__content4 current__split_fields6)))))))
     current__split_fields2 (to_rep1 (first4 current__split_fields3))
     (to_rep1 (last4 current__split_fields3))) true))

;; H
  (assert
  (< (to_rep
     (rec__static_discr__holder__length1
     (us_split_fields__content4 current__split_fields6))) (to_rep
                                                          current__split_fields4)))
...
;; H
  ...
  (= o10 (+ (to_rep
            (rec__static_discr__holder__length1
            (us_split_fields__content4 current__split_fields6))) 1))
  (in_range1
  (+ (to_rep
     (rec__static_discr__holder__length1
     (us_split_fields__content4 current__split_fields6))) 1))))
...
;; H
  (assert
  (= result4 (ite (= o11 true) (ite (<= i (to_rep current__split_fields4))
                               true false) false)))
...
;; WP_parameter_def
 ;; File "static_discr.ads", line 17, characters 0-0
  ...
  (<= (to_rep1
      ...
      (us_split_fields7
      (rec__static_discr__holder__content1
      (us_split_fields__content4 current__split_fields6))))))) i)))
(check-sat)
(exit)
