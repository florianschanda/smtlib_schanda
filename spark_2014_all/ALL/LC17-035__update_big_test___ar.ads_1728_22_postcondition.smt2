...
(declare-datatypes ((it4__ref 0)) (((mk_it4__ref (it4__content it4)))))
...
(declare-datatypes ((rofa4__ref 0))
(((mk_rofa4__ref (rofa4__content us_rep)))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1723, characters 0-0
  (not (= (bool_eq2 (select a2 m) (select a m)) true)))
(check-sat)
(exit)
