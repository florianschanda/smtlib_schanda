...
(define-fun us_split_discrs___2__projection ((a us_split_discrs2)) count_type
  (rec__dic_of_cont__my_hama__map__capacity a))

(define-fun us_split_discrs___3__projection ((a us_split_discrs2)) hash_type
...
(define-fun us_rep___10__projection ((a us_rep1)) us_split_discrs2 (us_split_discrs3
                                                                   a))
...
(define-fun us_split_discrs___4__projection ((a us_split_discrs4)) count_type
  (rec__dic_of_cont__my_hase__set__capacity a))

(define-fun us_split_discrs___5__projection ((a us_split_discrs4)) hash_type
...
(define-fun us_rep___13__projection ((a us_rep2)) us_split_discrs4 (us_split_discrs5
                                                                   a))
...
(define-fun us_split_discrs___6__projection ((a us_split_discrs6)) count_type
...
(define-fun us_split_fields_Map__2__projection ((a us_split_fields6)) us_main_type3
...
(define-fun us_rep___16__projection ((a us_rep3)) us_split_discrs6 (us_split_discrs7
                                                                   a))

(define-fun us_rep___17__projection ((a us_rep3)) us_split_fields6 (us_split_fields7
                                                                   a))
...
(define-fun map__ref___6__projection ((a map__ref1)) us_rep3 (map__content1
                                                             a))
...
(define-fun us_split_discrs___7__projection ((a us_split_discrs8)) count_type
...
(define-fun us_split_discrs__ref___5__projection ((a us_split_discrs__ref4)) us_split_discrs8
...
(define-fun us_split_fields_Set__2__projection ((a us_split_fields8)) us_main_type4
...
(define-fun us_rep___19__projection ((a us_rep4)) us_split_discrs8 (us_split_discrs9
                                                                   a))

(define-fun us_rep___20__projection ((a us_rep4)) us_split_fields8 (us_split_fields9
                                                                   a))
...
(define-fun set__ref___3__projection ((a set__ref1)) us_rep4 (set__content1
                                                             a))
...
(define-fun us_split_discrs___8__projection ((a us_split_discrs10)) capacity_range
...
(define-fun us_split_discrs__ref___6__projection ((a us_split_discrs__ref5)) us_split_discrs10
...
(define-fun us_split_fields__ref___15__projection ((a us_split_fields__ref5)) us_split_fields10
...
(define-fun us_rep___22__projection ((a us_rep5)) us_split_discrs10 (us_split_discrs11
                                                                    a))
...
(define-fun map__ref___3__projection ((a map__ref2)) us_rep6 (map__content2
                                                             a))
...
(define-fun element_type__ref___8__projection ((a element_type__ref1)) element_type1
...
(define-fun sequence__ref___3__projection ((a sequence__ref)) us_rep7
  (sequence__content a))
...
(define-fun set__ref___2__projection ((a set__ref2)) us_rep8 (set__content2
                                                             a))
...
(define-fun element_type__ref___9__projection ((a element_type__ref2)) element_type2
...
(define-fun element_type__ref___10__projection ((a element_type__ref3)) element_type3
...
(define-fun map__ref___7__projection ((a map__ref3)) us_rep9 (map__content3
                                                             a))
...
(define-fun key_type__ref___7__projection ((a key_type__ref1)) key_type1
...
(define-fun element_type__ref___13__projection ((a element_type__ref4)) element_type4
...
(define-fun sequence__ref___5__projection ((a sequence__ref1)) us_rep10
...
(define-fun element_type__ref___16__projection ((a element_type__ref5)) element_type5
...
(define-fun set__ref___4__projection ((a set__ref3)) us_rep11 (set__content3
                                                              a))
...
(define-fun element_type__ref___17__projection ((a element_type__ref6)) element_type6
...
(define-fun extended_index__ref___5__projection ((a extended_index__ref1)) extended_index1
...
(define-fun element_type__ref___18__projection ((a element_type__ref7)) element_type7
