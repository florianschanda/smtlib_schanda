...
(declare-fun arithmetic__halve_c__result () Int)
...
(declare-fun arithmetic__halve_c__result1 () Int)

(declare-fun arithmetic__halve_c__result2 () Int)

(declare-fun arithmetic__halve_c__result3 () Int)

(declare-fun r13 () Int)

(declare-fun i12 () Int)

(declare-fun arithmetic__halve_c__result4 () int__ref)

(declare-fun r14 () Int)

(declare-fun i13 () Int)

(declare-fun arithmetic__halve_c__result5 () Int)
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 127)) (= temp___180 r)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 127)) (= temp___179 i1)))
...
;; H
  (assert
  (= arithmetic__halve_c__result4 (mk_int__ref arithmetic__halve_c__result2)))
...
;; WP_parameter_def
 ;; File "arithmetic.adb", line 3, characters 0-0
  (not
  (or
  (= (+ (int__content arithmetic__halve_c__result4) (int__content
                                                    arithmetic__halve_c__result4))
  n)
  (= (+ (+ (int__content arithmetic__halve_c__result4) (int__content
                                                       arithmetic__halve_c__result4)) 1)
  n))))
(check-sat)
(exit)
