...
;; range_axiom
  (assert
  (forall ((x shape)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
;; range_axiom
  (assert
  (forall ((x px_coord)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
(define-fun in_range6 ((x Int)) Bool (and (<= (- 1) x) (<= x 19)))
...
;; range_axiom
  (assert
  (forall ((x py_coord)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun in_range8 ((x Int)) Bool (and (<= 0 x) (<= x 4)))
...
(define-fun dynamic_invariant2 ((temp___expr_2016 Int)
...
;; slide_def
  ...
  (forall ((i Int))
  (forall ((j Int))
  (! (= (get (slide2 a1 old_first new_first old_first_2 new_first_2) i j)
  (get a1 (- i (- new_first old_first)) (- j (- new_first_2 old_first_2)))) :pattern (
  (get (slide2 a1 old_first new_first old_first_2 new_first_2) i j)) )))))))

(define-fun bool_eq3 ((a1 map1) (a__first Int) (a__last Int) (a__first_2 Int)
  ...
  (b__last_2 Int)) Bool (ite (and
                             ...
                             (= (get a1 temp___idx_141 temp___idx_142)
...
;; bool_eq_rev
  ...
  (= (get a1 temp___idx_141 temp___idx_142) (get b
...
;; object__size_axiom
  (assert (forall ((a1 map1)) (<= 0 (object__size2 a1))))

;; value__component__size_axiom
  (assert (<= 0 value__component__size1))

;; object__component__size_axiom
  (assert (forall ((a1 map1)) (<= 0 (object__component__size1 a1))))

;; value__alignment_axiom
  (assert (<= 0 value__alignment2))

;; object__alignment_axiom
  (assert (forall ((a1 map1)) (<= 0 (object__alignment2 a1))))
...
;; slide_eq
  (assert
  (forall ((a1 (Array Int map1)))
  (forall ((first Int))
  (! (= (slide3 a1 first first) a1) :pattern ((slide3 a1 first first)) ))))
...
;; slide_def
  ...
  (forall ((new_first Int))
  (forall ((i Int))
  (! (= (select (slide3 a1 old_first new_first) i) (select a1 (- i (- new_first old_first)))) :pattern ((select
  (slide3 a1 old_first new_first) i)) ))))))
...
;; concat_def
  (assert
  (forall ((a1 (Array Int map1)) (b (Array Int map1)))
  (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int))
  (forall ((i Int))
  (! (and
     (=> (and (<= a_first i) (<= i a_last))
     (= (select (concat3 a1 a_first a_last b b_first b_last) i) (select a1 i)))
     (=> (< a_last i)
     (= (select (concat3 a1 a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select
  (concat3 a1 a_first a_last b b_first b_last) i)) )))))
...
(define-fun bool_eq4 ((a1 (Array Int map1)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq3 (select a1 temp___idx_143) 0 3 0 3
...
;; bool_eq_rev
  ...
  (forall ((a1 (Array Int map1)) (b (Array Int map1)))
  (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int))
  (=> (= (bool_eq4 b b__first b__last a1 a__first a__last) true)
  (and
  (ite (<= a__first a__last)
  (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first)))
  (< b__last b__first))
...
;; object__size_axiom
  (assert (forall ((a1 map1)) (<= 0 (object__size3 a1))))

;; value__component__size_axiom
  (assert (<= 0 value__component__size2))

;; object__component__size_axiom
  (assert (forall ((a1 map1)) (<= 0 (object__component__size2 a1))))

;; value__alignment_axiom
  (assert (<= 0 value__alignment3))

;; object__alignment_axiom
  (assert (forall ((a1 map1)) (<= 0 (object__alignment3 a1))))
...
;; slide_def
  ...
  (forall ((i Int))
  (forall ((j Int))
  (! (= (get1 (slide4 a1 old_first new_first old_first_2 new_first_2) i j)
  (get1 a1 (- i (- new_first old_first)) (- j (- new_first_2 old_first_2)))) :pattern (
  (get1 (slide4 a1 old_first new_first old_first_2 new_first_2) i j)) )))))))

(define-fun bool_eq5 ((a1 map2) (a__first Int) (a__last Int) (a__first_2 Int)
  ...
  (b__last_2 Int)) Bool (ite (and
                             ...
                             (= (bool_eq3
                                (get1 a1 temp___idx_230 temp___idx_231) 0 2 0
                                2
                                (get1 b
...
;; bool_eq_rev
  ...
  (b__first Int) (b__last Int) (b__first_2 Int) (b__last_2 Int))
  (=>
  (= (bool_eq5 b b__first b__last b__first_2 b__last_2 a1 a__first a__last
     a__first_2 a__last_2) true)
  (and
  (and
  (ite (<= a__first a__last)
  ...
  (= (bool_eq3 (get1 a1 temp___idx_230 temp___idx_231) 0 2 0 2
...
;; H
  (assert (in_range2 action_request_nbr))
...
;; H
  (assert (= speed_up2 speed_up))

;; H
  (assert (= speed_up2 speed_up1))

;; H
  (assert (< action_request_nbr 2))

(assert
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  (not (= (get_state cur_state) 0)))
(check-sat)
(exit)
