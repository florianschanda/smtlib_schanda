...
(declare-fun records__safe_add_pair_a__result () unsigned_byte)

(declare-fun records__safe_add_pair_a__result1 () unsigned_byte)

(declare-fun temp___272 () unsigned_byte)

(declare-fun temp___2721 () unsigned_byte)
...
(declare-fun temp___271 () unsigned_byte)

(declare-fun temp___2711 () unsigned_byte)
...
(declare-fun result3 () unsigned_byte)

(declare-fun r__split_fields4 () unsigned_byte)

(declare-fun r__split_fields5 () unsigned_byte)

(declare-fun result4 () unsigned_byte)

(declare-fun result5 () unsigned_byte)

(declare-fun records__safe_add_pair_a__result2 () unsigned_byte)

(declare-fun records__safe_add_pair_a__result3 () unsigned_byte)

(declare-fun records__safe_add_pair_a__result4 () pair__ref)

(declare-fun records__safe_add_pair_a__result5 () us_rep)

(declare-fun r__split_fields6 () us_split_fields__ref)

(declare-fun records__safe_add_pair_a__result6 () pair__ref)

(declare-fun r__split_fields7 () us_split_fields)

(declare-fun records__safe_add_pair_a__result7 () us_rep)

(define-fun records__safe_add_pair_a__result8 () us_rep (mk___rep
                                                        (mk___split_fields
                                                        records__safe_add_pair_a__result2
                                                        records__safe_add_pair_a__result3)))

(define-fun r__split_fields8 () us_split_fields (mk___split_fields
                                                r__split_fields2
                                                r__split_fields3))

(define-fun temp___2722 () us_rep (mk___rep
                                  (mk___split_fields temp___272 temp___2721)))
...
;; H
  ...
  (=>
  (and
  (<= (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a))) (- 255
  (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 b)))))
  (<= (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 a))) (- 255
  (to_rep (rec__records_prooffuncs__pair__b (us_split_fields1 b))))))
  (and (= temp___2722 (add_pair_a a b))
  (= (bool_eq temp___2722
     (mk___rep
     (mk___split_fields
     (of_rep
...
;; H
  (assert
  (= records__safe_add_pair_a__result4 (mk_pair__ref
                                       records__safe_add_pair_a__result8)))

;; H
  (assert
  (= records__safe_add_pair_a__result5 records__safe_add_pair_a__result8))
...
;; H
  (assert
  (= records__safe_add_pair_a__result6 records__safe_add_pair_a__result4))
...
;; H
  (assert
  (= records__safe_add_pair_a__result7 records__safe_add_pair_a__result5))
...
;; H
  ...
  (= (mk___rep (mk___split_fields result6 result7)) (pair__content
                                                    records__safe_add_pair_a__result6)))
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 11, characters 0-0
  (not
  (= (bool_eq (pair__content records__safe_add_pair_a__result6)
     (mk___rep
     (mk___split_fields
     (of_rep
     (+ (to_rep (rec__records_prooffuncs__pair__a (us_split_fields1 a)))
