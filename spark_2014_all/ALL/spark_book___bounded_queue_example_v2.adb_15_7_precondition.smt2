...
(declare-const temp___575 positive)

(declare-const temp___5751 natural)

(declare-const temp___5752 positive)

(declare-const temp___5753 positive)

(declare-const temp___5754 (Array Int element_type))
...
(define-fun my_queue__split_fields20 () us_split_fields2 (mk___split_fields1
...
(define-fun my_queue__split_fields21 () us_split_fields2 (mk___split_fields1
...
;; H
  (assert
  (=> (and (<= 17 count2) (<= count2 52))
  (= bounded_queue_v2__enqueue__queue__fields my_queue__split_fields12)))

;; H
  (assert
  (=> (and (<= 17 count2) (<= count2 52))
  (= bounded_queue_v2__enqueue__queue__fields1 my_queue__split_fields13)))

;; H
  (assert
  (=> (and (<= 17 count2) (<= count2 52))
  (= bounded_queue_v2__enqueue__queue__fields2 my_queue__split_fields14)))

;; H
  (assert
  (=> (and (<= 17 count2) (<= count2 52))
  (= bounded_queue_v2__enqueue__queue__fields3 my_queue__split_fields15)))
...
;; H
  (assert
  (=> (and (<= 17 count2) (<= count2 52))
  (= my_queue__split_fields17 my_queue__split_fields20)))
...
;; H
  (assert
  (=> (not (and (<= 17 count2) (<= count2 52)))
  (= my_queue__split_fields19 my_queue__split_fields21)))
...
;; WP_parameter_def
 ;; File "bounded_queue_example_v2.adb", line 3, characters 0-0
  ...
  (= (empty
     ...
     (mk___t1
     (rec__bounded_queue_v2__queue_type__items1
     (us_split_fields__content1 my_queue__split_fields18)) (mk1 1 100))))) true))))
(check-sat)
(exit)
