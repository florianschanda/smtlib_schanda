...
(declare-fun o () message_index)

(declare-fun o1 () (Array (_ BitVec 8) integer))

(declare-fun o2 () message_index)

(declare-fun o3 () message_index)

(declare-fun o4 () message_count)

(declare-fun o5 () (Array (_ BitVec 8) integer))

(declare-fun o6 () message_index)

(declare-fun o7 () message_index)

(declare-fun o8 () message_count)

(declare-fun result () Int)

(declare-fun n1 () Int)

(declare-fun result1 () (Array (_ BitVec 8) integer))

(declare-fun result2 () message_index)

(declare-fun result3 () message_index)

(declare-fun result4 () message_count)
...
;; H
  (assert
  (= (to_rep1 o) (bvurem (bvadd (to_rep1 self__2) ((_ int2bv 8) 1)) ((_ int2bv 8) 16))))
...
;; WP_parameter_def
 ;; File "communications.ads", line 10, characters 0-0
  (not (in_range2 (- (to_rep2 self__7) 1))))
(check-sat)
(exit)
