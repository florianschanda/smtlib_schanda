...
(declare-fun currentlogfile1 () int__ref)

(declare-fun numberlogentries1 () int__ref)

(declare-fun usedlogfiles__split_fields4 () us_split_fields__ref)

(declare-fun logfileentries1 () map__ref1)

(declare-fun auditalarm1 () int__ref)
