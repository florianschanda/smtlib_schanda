...
;; H
  (assert
  (and (= temp___1737 (+ (to_rep1 (first (rt source))) 0)) (in_range1
  (+ (to_rep1 (first (rt source))) 0))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1737)
  (<= temp___1737 (to_rep1 (last (rt source))))))

;; H
  (assert (= o26 temp___1737))
