...
;; H
  ...
  (= o34 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o34 0)))
...
;; H
  (assert (= o37 (ite (< o36 (+ start len)) true false)))
...
;; H
  (assert (= o30 (ite (<= (+ start len) o29) true false)))

;; H
  (assert
  (and (= o26 (maxvalue len))
  (= o26 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))

;; H
  (assert (= o31 (ite (bvule o26 value) true false)))

;; H
  (assert (= o32 (ite (= o31 true) o30 false)))
...
;; H
  (assert (= o23 (ite (bvugt o18 value) true false)))
...
;; H
  ...
  (= o16 (nth8_stream
         ...
         o15))
  (= (= o16 true)
  (= (nth1 (to_rep1 (select addr (div1 o15 8))) (- 7 (mod1 o15 8))) true))))
