...
(define-fun dynamic_invariant1 ((temp___expr_586 Int)
...
;; H
  (assert (= temp___1059 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1059)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cforma.ads", line 894, characters 0-0
  (not
