...
(declare-fun temp___3517 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___3519 (Array Int (Array Int et1))))
  (forall ((temp___3520 Int))
  (forall ((temp___3521 (Array Int et1)))
  (let ((temp___3518 (temp___3517 temp___3519 temp___3520 temp___3521)))
  (forall ((temp___3522 Int))
  (ite (= temp___3522 temp___3520)
  (= (select temp___3518 temp___3522) temp___3521)
  (= (select temp___3518 temp___3522) (select temp___3519 temp___3522)))))))))

(declare-fun temp___3523 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3525 (Array Int et1)))
  (forall ((temp___3526 Int) (temp___3527 Int))
  (let ((temp___3524 (temp___3523 temp___3525 temp___3526 temp___3527)))
  (forall ((temp___3528 Int))
  (ite (= temp___3528 temp___3526)
  (= (select temp___3524 temp___3528) (of_rep temp___3527))
...
;; def_axiom
  (assert
  (forall ((temp___3534 (Array Int et1)))
  (forall ((temp___3535 Int) (temp___3536 Int))
  (let ((temp___3533 (temp___3532 temp___3534 temp___3535 temp___3536)))
  (forall ((temp___3537 Int))
  (ite (= temp___3537 temp___3535)
  (= (select temp___3533 temp___3537) (of_rep temp___3536))
  (= (select temp___3533 temp___3537) (select temp___3534 temp___3537))))))))
...
(declare-fun temp___8774 () (Array Int et1))

(declare-fun temp___87741 () (Array Int (Array Int et1)))
...
(declare-fun temp___8779 () (Array Int et1))

(declare-fun temp___87791 () (Array Int (Array Int et1)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1626, characters 0-0
  (not
  (= (bool_eq3 r__split_fields6 1 10 (temp___3532 r__split_fields j e) 1 10) true)))
(check-sat)
