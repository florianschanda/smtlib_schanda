...
;; H
  ...
  (and
  (forall ((i1 Int))
  (=> (and (<= first3 i1) (<= i1 k11))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a11 i1))))
  max13)))
  (forall ((i1 Int))
  (=> (and (<= k11 i1) (<= i1 first3))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a11 i1))))
  max13)))))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= i1 j1) (<= j1 (to_rep1 a__last)))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a11 j1))))
  (to_rep
  (rec__frame_condition__cell__max_right (us_split_fields1 (select a11 i1))))))))))
...
;; H
  ...
  (= (to_rep
     (rec__frame_condition__cell__max_left
     (us_split_fields1 (select a11 i1)))) (to_rep
                                          (rec__frame_condition__cell__max_left
                                          (us_split_fields1
                                          (select (map__content a5) i1))))))))
