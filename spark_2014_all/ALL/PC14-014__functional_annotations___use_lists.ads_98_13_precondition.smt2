...
;; H
  ...
  (and (not (= (has_key o22 no_element) true))
  (forall ((i3 us_rep1))
  (=> (= (has_key o22 i3) true)
  (and
  (and (<= 1 (get1 o22 i3))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o22 j) true)
  (=> (= (get1 o22 i3) (get1 o22 j)) (= (bool_eq1 i3 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o26)
  (=> (= (of_int 0) true)
  (and (= o26 (w_get o22 (witness o22 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o22 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o22 cu) (witness o22 k))))))))))
...
;; H
  ...
  (= o20 (positions
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (not (= (has_key o20 no_element) true))
  (forall ((i3 us_rep1))
  (=> (= (has_key o20 i3) true)
  (and
  (and (<= 1 (get1 o20 i3))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o20 j) true)
  (=> (= (get1 o20 i3) (get1 o20 j)) (= (bool_eq1 i3 j) true))))))))))

;; H
  (assert
  (and (= o21 (has_key o20 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o20 k) true) (= (bool_eq1 k cu) true))) (= o21 true)))))
...
;; H
  ...
  (= o16 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o16)
  (<= o16 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep l__split_discrs (mk___split_fields l__split_fields8))) i3)
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  (- i3 7)))))))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep l__split_discrs (mk___split_fields l__split_fields8))) i3) 0)))))
