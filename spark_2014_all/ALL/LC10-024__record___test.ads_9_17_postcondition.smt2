...
(declare-fun temp___177 () (_ BitVec 8))
...
;; H
  (assert (= temp___177 (bvadd (to_rep1 s__split_fields4) o6)))
...
;; H
  (assert (=> (= result3 true) (= o9 (bvsub temp___177 ((_ int2bv 8) 5)))))

;; H
  (assert (=> (not (= result3 true)) (= o9 temp___177)))
