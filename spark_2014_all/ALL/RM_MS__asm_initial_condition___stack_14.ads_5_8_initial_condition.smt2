...
;; def_axiom
  ...
  (= (select (temp___159 temp___161) temp___162) (of_rep temp___161)))))
...
;; H
  (assert
  (and (= result2 (is_empty pointer1)) (= (= result2 true) (= pointer1 0))))

(assert
;; WP_parameter_def
 ;; File "stack_14.ads", line 23, characters 0-0
