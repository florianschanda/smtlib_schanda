...
;; H
  (assert
  (and (= o5 (next (mk___rep l2__split_discrs l2__split_fields2) o4))
  (ite (= (ite (= (bool_eq1 o4 no_element) false) (= (get1
                                                     (positions
                                                     (mk___rep
                                                     l2__split_discrs
                                                     l2__split_fields2))
                                                     o4) (length
                                                         (mk___rep
                                                         l2__split_discrs
                                                         l2__split_fields2))) true) true)
  (= (bool_eq1 o5 no_element) true)
  (and
  (= (has_key (positions (mk___rep l2__split_discrs l2__split_fields2)) o5) true)
  (= (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o5) (+
  (get1 (positions (mk___rep l2__split_discrs l2__split_fields2)) o4) 1))))))
