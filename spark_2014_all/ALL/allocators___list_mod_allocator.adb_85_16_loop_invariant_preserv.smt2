...
;; H
  (assert
  (forall ((e Int))
  (=> (and (in_range8 e) (= (contains alloc1 e) true))
  (and (<= 1 e) (<= e (- r2 1))))))

;; H
  (assert
  (forall ((e Int))
  (=> (and (in_range8 e) (= (contains unseen1 e) true))
  (and (<= 1 e) (<= e (- r2 1))))))
...
;; H
  ...
  (= (contains alloc1 e) true) (= (contains unseen1 e) true)))))
...
;; H
  (assert
  (and (=> (<= 1 10000) (in_range3 r2)) (and (<= 1 r2) (<= r2 10000))))
...
;; H
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data r2)))) 1)
  (and (= o (add1 alloc1 r2))
  (and
  (and (and (= (length1 o) (+ (length1 alloc1) 1)) (= (contains o r2) true))
  (= (ole1 alloc1 o) true)) (= (included_except o alloc1 r2) true)))))
...
;; H
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data r2)))) 1))
  (and (= o1 (add1 unseen1 r2))
  (and
  (and
  (and (= (length1 o1) (+ (length1 unseen1) 1)) (= (contains o1 r2) true))
  (= (ole1 unseen1 o1) true)) (= (included_except o1 unseen1 r2) true)))))
...
;; H
  (assert (= (contains unseen2 e) true))
