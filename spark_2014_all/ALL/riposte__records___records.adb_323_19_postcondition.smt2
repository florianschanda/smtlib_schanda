...
(declare-const records__update_b__result Bool)

(declare-const records__update_b__result1 unsigned_byte)

(declare-const records__update_b__result2 unsigned_byte)
...
(declare-const temp___3891 unsigned_byte)

(declare-const temp___3892 unsigned_byte)
...
(declare-const records__update_b__result3 us_rep1)

(declare-const records__update_b__result4 optional_pair__ref)

(declare-const records__update_b__result5 us_rep1)

(declare-const tmp__split_fields5 us_split_fields__ref1)

(declare-const records__update_b__result6 optional_pair__ref)

(declare-const tmp__split_fields6 us_split_fields2)

(declare-const records__update_b__result7 us_rep1)
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 19, characters 0-0
  (not
  (= (bool_eq1 (optional_pair__content records__update_b__result6)
     (mk___rep1
     (mk___split_fields1
