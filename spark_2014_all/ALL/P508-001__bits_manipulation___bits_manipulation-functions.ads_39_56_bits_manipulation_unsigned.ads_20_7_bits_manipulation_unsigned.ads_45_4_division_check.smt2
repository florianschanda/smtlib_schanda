...
;; H
  ...
  (= o1 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)))))

;; H
  (assert (=> (not (< n 18446744073709551616)) (= o1 ((_ int2bv 64) 0))))

;; H
  (assert (= o2 (ite (= o1 ((_ int2bv 64) 0)) true false)))
...
;; H
  (assert
  (=> (< n 18446744073709551616)
  (= o (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) n)))))
