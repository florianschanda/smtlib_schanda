...
(declare-fun update_list_zero__cu__assume () count_type)
...
(define-fun update_list_zero__cu__assume1 () us_rep1 (mk___rep1
                                                     (mk___split_fields1
...
;; H
  (assert
  (and
  (= update_list_zero__cu__assume1 (first
  ...
  (= (bool_eq1 update_list_zero__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     update_list_zero__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     update_list_zero__cu__assume1) 1)))))
...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields1))
            (mk___rep1 cu__split_fields2)) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i1) (ite (<=
                                                                    (get
                                                                    (model__
                                                                    (mk___rep
                                                                    l__split_discrs
...
;; H
  ...
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields1))
      (mk___rep1 cu__split_fields2)) i1)
  (<= i1 (length (mk___rep l__split_discrs l__split_fields1))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields1)) i1) (get
                                                                    (model__
                                                                    (mk___rep
                                                                    l__split_discrs
                                                                    (mk___split_fields
...
;; H
  (assert
  (and (= o (positions (mk___rep l__split_discrs l__split_fields1)))
  (and (not (= (has_key o no_element) true))
  (forall ((i1 us_rep1))
  (=> (= (has_key o i1) true)
  (and
  (and (<= 1 (get1 o i1))
  (<= (get1 o i1) (length (mk___rep l__split_discrs l__split_fields1))))
  (forall ((j us_rep1))
  (=> (= (has_key o j) true)
...
;; H
  (assert
  (and (= o1 (get1 o (mk___rep1 cu__split_fields2)))
  (and (in_range5 o1)
  (=> (= (of_int 0) true)
  (and (= o1 (w_get o (witness o (mk___rep1 cu__split_fields2))))
  (forall ((k us_rep1))
  (=> (= (has_key o k) true)
  (= (= (bool_eq1 k (mk___rep1 cu__split_fields2)) true)
  (= (witness o (mk___rep1 cu__split_fields2)) (witness o k))))))))))
...
;; H
  (assert (= result3 (ite (<= o4 threshold) true false)))
