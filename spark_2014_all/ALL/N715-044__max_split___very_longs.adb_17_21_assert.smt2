...
(((mk_t4s__ref (t4s__content tdigit_index_typeB)))))
...
(((mk_tT1bP1__ref (tT1bP1__content tdigit_index_typeB)))))
...
(declare-datatypes ((t1b__ref 0)) (((mk_t1b__ref (t1b__content us_t1)))))
...
(define-fun us_split_fields_Long_Digits__2__projection ((a us_split_fields2)) us_t1
...
(((mk_t2b__ref (t2b__content tdigit_index_typeB)))))
...
(declare-datatypes ((t3b__ref 0)) (((mk_t3b__ref (t3b__content us_t2)))))
