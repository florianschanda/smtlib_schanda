...
(declare-datatypes ()
((t4s__ref (mk_t4s__ref (t4s__content tdigit_index_typeB)))))
(define-fun t4s__ref___projection ((a t4s__ref)) tdigit_index_typeB (t4s__content
                                                                    a))
...
(declare-fun very_longs__very_long__digit_length__first__bit () Int)

(declare-fun very_longs__very_long__digit_length__last__bit () Int)

(declare-fun very_longs__very_long__digit_length__position () Int)
...
(declare-datatypes ()
((tT1bP1__ref (mk_tT1bP1__ref (tT1bP1__content tdigit_index_typeB)))))
(define-fun tT1bP1__ref___projection ((a tT1bP1__ref)) tdigit_index_typeB
  (tT1bP1__content a))
...
(define-fun us_split_fields_Long_Digits2__projection ((a us_split_fields2)) us_t1
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___134 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r)
                                         (mk___split_fields1
                                         (let ((temp___133 (rec__very_longs__very_long__long_digits
                                                           (us_split_fields1
                                                           r))))
...
(define-fun in_range4 ((rec__very_longs__very_long__digit_length1 Int)
  (a us_rep)) Bool (= rec__very_longs__very_long__digit_length1 (to_rep
                                                                (rec__very_longs__very_long__digit_length
                                                                (us_split_discrs1
                                                                a)))))
...
(declare-fun very_longs__very_long__digit_length__first__bit1 () Int)

(declare-fun very_longs__very_long__digit_length__last__bit1 () Int)

(declare-fun very_longs__very_long__digit_length__position1 () Int)
...
(define-fun dynamic_invariant2 ((temp___expr_177 us_rep1)
  (temp___is_init_174 Bool) (temp___skip_constant_175 Bool)
  (temp___do_toplevel_176 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_175 true))
                                      (in_range4 digit_length
                                      (to_base temp___expr_177)))
                                      (and (dynamic_property3 1 digit_length
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_177)))
                                      (last3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_177))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_177))) 1)
                                      (= (last3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_177)))
                                      digit_length)))))
...
(declare-datatypes ()
((t2b__ref (mk_t2b__ref (t2b__content tdigit_index_typeB)))))
(define-fun t2b__ref___projection ((a t2b__ref)) tdigit_index_typeB (t2b__content
                                                                    a))
...
;; def_axiom
  (assert
  (forall ((temp___194 (_ BitVec 8)))
  (forall ((temp___195 Int) (temp___196 Int))
  (let ((temp___193 (temp___192 temp___194 temp___195 temp___196)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___195 temp___196)
  (and (= (first5 temp___193) temp___195) (= (last5 temp___193) temp___196)))
  (forall ((temp___197 Int))
  (= (select (to_array2 temp___193) temp___197) (of_rep1 temp___194))))))))

(define-fun dynamic_invariant3 ((temp___expr_144 (_ BitVec 8))
  (temp___is_init_141 Bool) (temp___skip_constant_142 Bool)
  (temp___do_toplevel_143 Bool)) Bool true)

(define-fun dynamic_invariant4 ((temp___expr_155 us_rep)
  (temp___is_init_152 Bool) (temp___skip_constant_153 Bool)
  (temp___do_toplevel_154 Bool)) Bool (let ((temp___156 (rec__very_longs__very_long__digit_length
                                                        (us_split_discrs1
                                                        temp___expr_155))))
                                      ...
                                      (= (first1
                                         (rec__very_longs__very_long__long_digits
                                         (us_split_fields1 temp___expr_155))) 1)
                                      (= (last1
                                         (rec__very_longs__very_long__long_digits
                                         (us_split_fields1 temp___expr_155)))
                                      (to_rep temp___156))))))
...
(declare-fun temp___199 () (Array Int octet))

(declare-fun temp___1991 () t2)

(declare-fun temp___200 () (Array Int octet))
...
(declare-fun temp___203 () digit_index_type)

(declare-fun temp___2031 () (Array Int octet))

(declare-fun temp___2032 () t1)

(declare-fun temp___208 () digit_index_type)

(declare-fun temp___2081 () (Array Int octet))

(declare-fun temp___2082 () t1)
...
(declare-fun temp___206 () us_rep1)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___192 ((_ int2bv 8) 0) 1 digit_length)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___192 ((_ int2bv 8) 0) 1 digit_length))))
  digit_length))

;; H
  (assert
  (= (mk___t2 temp___199 temp___1991) (temp___192 ((_ int2bv 8) 0) 1
                                      digit_length)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___1991)) (to_rep2 (last4 temp___1991)))
     (+ (- (to_rep2 (last4 temp___1991)) (to_rep2 (first4 temp___1991))) 1)
     0) (ite (<= 1 digit_length) (+ (- digit_length 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___1991)) (to_rep2 (last4 temp___1991)))
  temp___2001))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___2001)) (to_rep2 (last2 temp___2001)))
     (+ (- (to_rep2 (last2 temp___2001)) (to_rep2 (first2 temp___2001))) 1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___2031 temp___2032))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b))
  (and (= result____split_discrs (mk___split_discrs temp___208))
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___2081 temp___2082))))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= temp___207 temp1)))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___210)
  (<= temp___210 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___210) (select temp___2081 temp___210))))))
  (and (<= 1 index2) (<= index2 r4b)))))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= o5 ((_ int2bv 8) o4))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= (to_rep1 o6) o5)))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= o7 index2)))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b)) (= o10 (mk___split_fields1 o9))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b))
  (= temp___206 (mk___rep1 result____split_discrs o10))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b))
  (= result____split_fields4 (us_split_fields3 temp___206))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b))
  (= result____split_discrs (us_split_discrs2 temp___206))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b)) (= result4 (mk_int__ref temp2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b)) (= temp3 (div1 temp2 256))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= index2 r4b)))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b)) (= index3 (mk_int__ref index2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r4b)) (= temp4 (mk_int__ref temp3))))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= index4 index2)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= temp5 temp3)))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= index5 index3)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= temp6 temp4)))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= index6 index4)))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r4b)) (= temp7 temp5)))
...
;; H
  (assert (=> (not (and (<= 1 index1) (<= index1 r4b))) (= index6 index1)))

;; H
  (assert (=> (not (and (<= 1 index1) (<= index1 r4b))) (= temp7 temp1)))
...
(assert
;; WP_parameter_def
 ;; File "very_longs.ads", line 20, characters 0-0
  (not
  (= (to_rep
     (rec__very_longs__very_long__digit_length result____split_discrs))
  digit_length)))
