...
(declare-fun temp___322 () even)

(declare-fun temp___3221 () even)
...
(define-fun temp___3222 () us_rep (mk___rep
                                  (mk___split_fields temp___322 temp___3221)))
...
;; H
  (assert
  (and
  (= temp___3222 (get_even_close_pair__2 (mk___rep (mk___split_fields o o1))))
  (dynamic_invariant2 temp___3222 true false true)))
...
;; H
  (assert (= temp___322 x__split_fields2))

;; H
  (assert (= temp___3221 x__split_fields3))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds.adb", line 148, characters 0-0
