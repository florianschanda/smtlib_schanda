...
;; H
  ...
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 (root (mk___rep3 search_trees__insert__t__fields))))
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__ (mk___rep3 search_trees__insert__t__fields)) i1))) true))))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (= (parent (mk___rep3 search_trees__insert__t__fields) i1) (parent
                                                             (mk___rep3
                                                             (mk___split_fields3
                                                             t__split_fields
                                                             (mk___rep2
...
;; H
  ...
  (=>
  (and (not (= i1 x1))
  (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields6) i1) 0)
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields6) (parent
                                                                 ...
                                                                 i1))) 1)))
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields6) i1)) 0)))))
...
;; H
  ...
  (=>
  (and (not (= i1 x2))
  (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields7) i1) 0)
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields7) (parent
                                                                 ...
                                                                 i1))) 1)))
  (= (to_rep3
     (select (rec__red_black_trees__rbt__color t__split_fields7) i1)) 0)))))
...
;; H
  (assert
  (and
  (= o23 (peek (rec__red_black_trees__rbt__struct t__split_fields7) o22 1))
  (and (in_range3 o23)
  (= o23 (peek1
         (rec__search_trees__search_tree__struct
         (us_split_fields7
         (rec__red_black_trees__rbt__struct t__split_fields7))) o22 1)))))
...
;; H
  ...
  (= (root (mk___rep3 search_trees__left_rotate__t__fields)) (peek
                                                             ...
                                                             o26 1)))
  (and
  (= (parent (mk___rep3 search_trees__left_rotate__t__fields) o26) (peek
                                                                   (mk___rep3
                                                                   (us_split_fields7
                                                                   (rec__red_black_trees__rbt__struct
                                                                   t__split_fields7)))
                                                                   o26 1))
  (and (= (position1 (mk___rep3 search_trees__left_rotate__t__fields) o26) 0)
  (and
  ...
  (and
  (= (peek (mk___rep3 search_trees__left_rotate__t__fields) o26 1) (peek
                                                                   (mk___rep3
                                                                   (us_split_fields7
                                                                   (rec__red_black_trees__rbt__struct
                                                                   t__split_fields7)))
  ...
  (= (peek (mk___rep3 search_trees__left_rotate__t__fields)
     ...
     o26)) (peek
           (mk___rep3
           (us_split_fields7
           (rec__red_black_trees__rbt__struct t__split_fields7))) o26 1)))
  (and
  (= (peek (mk___rep3 search_trees__left_rotate__t__fields)
     (peek
     (mk___rep3
...
;; H
  (assert (=> (= result9 true) (= (mk___rep4 t_old__split_fields7) c80b)))

;; H
  (assert (=> (= result9 true) (dynamic_invariant6 c80b true false true)))

;; H
  (assert (=> (= result9 true) (= (mk___rep4 t__split_fields8) c81b)))
...
;; H
  (assert
  (=> (= result9 true)
  (and (= red_black_trees__insert__L_8__C82b__assume x3) (in_range2 x3))))

;; H
  (assert
  (=> (= result9 true) (= red_black_trees__insert__L_8__C82b__assume c82b)))

;; H
  (assert (=> (= result9 true) (in_range2 c82b)))

;; H
  (assert
  (=> (= result9 true)
  (and
  (= o27 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))
         c82b))
  (and (in_range3 o27)
  (and
  (= o27 (parent1
...
;; H
  (assert
  (=> (= result9 true)
  (and (= red_black_trees__insert__L_8__B83b__y__assume o27) (in_range2 o27))))

;; H
  (assert
  (=> (= result9 true) (= red_black_trees__insert__L_8__B83b__y__assume y)))

;; H
  (assert (=> (= result9 true) (in_range2 y)))

;; H
  (assert (=> (= result9 true) (= (same_nb_blacks c81b) true)))
...
;; H
  (assert
  (=> (= result9 true) (= rho1 search_trees__left_rotate__t__fields)))
...
;; H
  ...
  (= (peek
     ...
     (parent
     (rec__red_black_trees__rbt__struct
     (us_split_fields__content4 t__split_fields9)) (int__content x4))) 0) 0)))
...
;; H
  (assert
  (and
  (= temp___821 (parent (rec__red_black_trees__rbt__struct t__split_fields11)
                o35))
...
;; H
  ...
  (= (root (mk___rep3 search_trees__right_rotate__t__fields)) (peek
                                                              ...
                                                              o44 0)))
  (and
  (= (parent (mk___rep3 search_trees__right_rotate__t__fields) o44) (peek
                                                                    (mk___rep3
                                                                    (us_split_fields7
                                                                    (rec__red_black_trees__rbt__struct
                                                                    t__split_fields12)))
                                                                    o44 0))
  (and
  (= (position1 (mk___rep3 search_trees__right_rotate__t__fields) o44) 1)
  (and
  ...
  (and
  (= (peek (mk___rep3 search_trees__right_rotate__t__fields) o44 0) (peek
                                                                    (mk___rep3
                                                                    (us_split_fields7
                                                                    (rec__red_black_trees__rbt__struct
                                                                    t__split_fields12)))
  ...
  (= (peek (mk___rep3 search_trees__right_rotate__t__fields)
     ...
     o44)) (peek
           (mk___rep3
           (us_split_fields7
           (rec__red_black_trees__rbt__struct t__split_fields12))) o44 0)))
  (and
  (= (peek (mk___rep3 search_trees__right_rotate__t__fields)
     (peek
     (mk___rep3
...
;; H
  (assert (dynamic_invariant6 c86b true false true))

;; H
  (assert (= (mk___rep4 t__split_fields13) c87b))
...
;; H
  (assert
  (and (= red_black_trees__insert__L_8__C88b__assume o48) (in_range2 o48)))

;; H
  (assert (= red_black_trees__insert__L_8__C88b__assume c88b))

;; H
  (assert (in_range2 c88b))

;; H
  (assert
  (and
  (= o49 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))
         c88b))
  (and (in_range3 o49)
  (and
  (= o49 (parent1
...
;; H
  (assert
  (and (= red_black_trees__insert__L_8__B89b__y__assume o49) (in_range2 o49)))

;; H
  (assert (= red_black_trees__insert__L_8__B89b__y__assume y1))

;; H
  (assert (in_range2 y1))

;; H
  (assert (= (same_nb_blacks c87b) true))

;; H
  (assert
  (= (color (mk___rep4 t__split_fields13)
     (parent (rec__red_black_trees__rbt__struct t__split_fields13)
     (int__content x4))) 0))
...
;; H
  (assert
  (and
  (= o50 (parent (rec__red_black_trees__rbt__struct t__split_fields13) i))
  (and (in_range3 o50)
  (and
  (= o50 (parent1
         (rec__search_trees__search_tree__struct
         (us_split_fields7
         (rec__red_black_trees__rbt__struct t__split_fields13))) i))
  (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields13)) 0)
  (= o50 0))))))

;; H
  (assert (= result16 (ite (= o50 0) true false)))
...
;; H
  (assert
  (and
  (= temp___885 (parent (rec__red_black_trees__rbt__struct t__split_fields13)
                i))
  (and (in_range3 temp___885)
  (and
  (= temp___885 (parent1
                (rec__search_trees__search_tree__struct
                (us_split_fields7
                (rec__red_black_trees__rbt__struct t__split_fields13))) 
                i))
  (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields13)) 0)
  (= temp___885 0))))))
