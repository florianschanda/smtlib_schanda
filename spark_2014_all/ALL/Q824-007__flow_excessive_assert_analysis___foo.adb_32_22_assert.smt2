...
(define-fun us_split_fields_A1__projection ((a us_split_fields)) Bool
  (rec__foo__level_0__a1 a))

(define-fun us_split_fields_A2__projection ((a us_split_fields)) Bool
  (rec__foo__level_0__a2 a))

(define-fun us_split_fields_A3__projection ((a us_split_fields)) Bool
  (rec__foo__level_0__a3 a))

(define-fun us_split_fields_A4__projection ((a us_split_fields)) Bool
  (rec__foo__level_0__a4 a))

(define-fun us_split_fields_A5__projection ((a us_split_fields)) Bool
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        ...
                        (and
                        (and
                        (= (rec__foo__level_0__a1 (us_split_fields1 a))
                        (rec__foo__level_0__a1 (us_split_fields1 b)))
                        (= (rec__foo__level_0__a2 (us_split_fields1 a))
                        (rec__foo__level_0__a2 (us_split_fields1 b))))
                        (= (rec__foo__level_0__a3 (us_split_fields1 a))
                        (rec__foo__level_0__a3 (us_split_fields1 b))))
                        (= (rec__foo__level_0__a4 (us_split_fields1 a))
                        (rec__foo__level_0__a4 (us_split_fields1 b))))
                        (= (rec__foo__level_0__a5 (us_split_fields1 a))
                        (rec__foo__level_0__a5 (us_split_fields1 b))))
                   true false))
...
(declare-datatypes ()
((level_0__ref (mk_level_0__ref (level_0__content us_rep)))))
(define-fun level_0__ref___projection ((a level_0__ref)) us_rep (level_0__content
                                                                a))
...
(define-fun us_split_fields_B1__projection ((a us_split_fields2)) us_rep
  (rec__foo__level_1__b1 a))

(define-fun us_split_fields_B2__projection ((a us_split_fields2)) us_rep
  (rec__foo__level_1__b2 a))

(define-fun us_split_fields_B3__projection ((a us_split_fields2)) us_rep
  (rec__foo__level_1__b3 a))

(define-fun us_split_fields_B4__projection ((a us_split_fields2)) us_rep
...
(declare-datatypes ()
((level_1__ref (mk_level_1__ref (level_1__content us_rep1)))))
(define-fun level_1__ref___projection ((a level_1__ref)) us_rep1 (level_1__content
                                                                 a))
...
(define-fun us_split_fields_C1__projection ((a us_split_fields4)) us_rep1
  (rec__foo__level_2__c1 a))

(define-fun us_split_fields_C2__projection ((a us_split_fields4)) us_rep1
  (rec__foo__level_2__c2 a))

(define-fun us_split_fields_C3__projection ((a us_split_fields4)) us_rep1
...
(declare-datatypes ()
((level_2__ref (mk_level_2__ref (level_2__content us_rep2)))))
(define-fun level_2__ref___projection ((a level_2__ref)) us_rep2 (level_2__content
                                                                 a))
...
;; H
  (assert
  (= (invariant__
     (rec__foo__level_2__c1
     (let ((subject red__split_fields)) red__split_fields1))
     (rec__foo__level_2__c2
     (let ((subject red__split_fields)) red__split_fields1))
     (rec__foo__level_2__c3
     (let ((subject red__split_fields)) red__split_fields1))) true))
...
;; WP_parameter_def
 ;; File "foo.ads", line 18, characters 0-0
  ...
  (= (invariant__
     (rec__foo__level_2__c1
     (let ((subject black__split_fields)) black__split_fields1))
     (rec__foo__level_2__c2
     (let ((subject black__split_fields)) black__split_fields1))
     (rec__foo__level_2__c3
     (let ((subject black__split_fields)) black__split_fields1))) true)))
(check-sat)
(exit)
