...
(declare-fun tab23 () map__ref)

(declare-fun j28 () int__ref)

(declare-fun temp___1682 () int__ref)

(declare-fun tab24 () (Array Int integer))

(declare-fun j29 () Int)

(declare-fun temp___1683 () Int)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (to_rep (select (map__content tab23) l)) l)))
(check-sat)
(exit)
