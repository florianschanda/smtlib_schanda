...
(define-fun o23 () us_rep (mk___rep (mk___split_fields o16 o17)))

(define-fun o24 () us_rep (mk___rep (mk___split_fields o10 o11)))

(define-fun o25 () us_rep (mk___rep (mk___split_fields o4 o5)))
...
;; H
  ...
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o24) true))
...
;; H
  ...
  (= (bool_eq
     ...
     (mk___rep2 c__split_fields3)) o23) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
     o23) 3))
  ...
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields2)) o23) true))
...
;; WP_parameter_def
 ;; File "my_maps.adb", line 44, characters 0-0
  (not
  (<= (length (mk___rep1 l__split_discrs l__split_fields5)) (to_rep3
                                                            (rec__my_maps__n__map__capacity
                                                            k__split_discrs)))))
(check-sat)
(exit)
