...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__foo__misc_private_t__valid Bool)))))
...
(declare-fun foo__misc_private_t__valid__first__bit () Int)

(declare-fun foo__misc_private_t__valid__last__bit () Int)

(declare-fun foo__misc_private_t__valid__position () Int)
...
(declare-fun foo__misc_private_t__field__first__bit () Int)

(declare-fun foo__misc_private_t__field__last__bit () Int)

(declare-fun foo__misc_private_t__field__position () Int)
...
(declare-fun foo__misc_private_t__valid__first__bit1 () Int)

(declare-fun foo__misc_private_t__valid__last__bit1 () Int)

(declare-fun foo__misc_private_t__valid__position1 () Int)
...
(declare-fun foo__misc_private_t__field__first__bit1 () Int)

(declare-fun foo__misc_private_t__field__last__bit1 () Int)

(declare-fun foo__misc_private_t__field__position1 () Int)
