...
(declare-datatypes ((tS18bP1__ref 0))
(((mk_tS18bP1__ref (tS18bP1__content tdigit_count_typeB)))))
(define-fun tS18bP1__ref___projection ((a tS18bP1__ref)) tdigit_count_typeB
  (tS18bP1__content a))
...
(declare-datatypes ((s18b__ref 0)) (((mk_s18b__ref (s18b__content us_t1)))))
...
(((mk_t20b__ref (t20b__content tdigit_count_typeB)))))
(define-fun t20b__ref___projection ((a t20b__ref)) tdigit_count_typeB
  (t20b__content a))
...
(((mk_t22b__ref (t22b__content tdigit_count_typeB)))))
(define-fun t22b__ref___projection ((a t22b__ref)) tdigit_count_typeB
  (t22b__content a))
...
(declare-fun temp___1150 ((_ BitVec 8) Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1152 (_ BitVec 8)))
  (forall ((temp___1153 Int) (temp___1154 Int))
  (let ((temp___1151 (temp___1150 temp___1152 temp___1153 temp___1154)))
  (and
  (=> (dynamic_property7 1 65536 temp___1153 temp___1154)
  (and (= (first5 temp___1151) temp___1153)
  (= (last5 temp___1151) temp___1154)))
  (forall ((temp___1155 Int))
  (= (select (to_array2 temp___1151) temp___1155) (of_rep1 temp___1152))))))))

(define-fun dynamic_invariant4 ((temp___expr_375 us_t1)
  (temp___is_init_372 Bool) (temp___skip_constant_373 Bool)
  (temp___do_toplevel_374 Bool)) Bool (=>
                                      (not (= temp___skip_constant_373 true))
                                      (and (dynamic_property3 1 r19b
                                      (first3 temp___expr_375)
                                      (last3 temp___expr_375))
                                      (and (= (first3 temp___expr_375) 1)
                                      (= (last3 temp___expr_375) r19b)))))
...
(declare-const temp___1158 (Array Int octet))

(declare-const temp___11581 t1)

(declare-const temp___1160 (Array Int octet))

(declare-const temp___11601 t1)
...
(declare-const temp___1162 digit_index_type)

(declare-const temp___11621 (Array Int octet))

(declare-const temp___11622 t)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1150 ((_ int2bv 8) 0) 1 r19b)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1150 ((_ int2bv 8) 0) 1 r19b)))) r19b))

;; H
  (assert
  (= (mk___t2 temp___1157 temp___11571) (temp___1150 ((_ int2bv 8) 0) 1 r19b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___11571)) (to_rep2 (last4 temp___11571)))
     (+ (- (to_rep2 (last4 temp___11571)) (to_rep2 (first4 temp___11571))) 1)
     0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))

;; H
  (assert (= temp___1157 temp___1158))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___11571)) (to_rep2 (last4 temp___11571)))
  temp___11581))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___11581)) (to_rep2 (last2 temp___11581)))
     (+ (- (to_rep2 (last2 temp___11581)) (to_rep2 (first2 temp___11581))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1160 temp___11601) (mk___t1 temp___1158 temp___11581)))

;; H
  (assert (= temp___1160 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11601)) (to_rep2 (last2 temp___11601)))
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1162)))

;; H
  (assert (= temp___11621 o2))

;; H
  (assert (= temp___11622 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___11621 temp___11622))))
...
;; H
  ...
  (= (to_rep2
     ...
     (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))
  (to_rep2
  (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))
  (= (to_rep2
     (last
     (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))
  (to_rep2
...
;; H
  ...
  (dynamic_property6 1
  (to_rep2
  (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))
  i2)) (dynamic_invariant1
  (mk___rep result____split_discrs result____split_fields3) false true true))
  (forall ((temp___1174 Int))
  (=>
  (and
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1174)
  (<= temp___1174 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1174) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1174))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
