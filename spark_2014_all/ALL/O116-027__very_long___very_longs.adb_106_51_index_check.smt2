...
(declare-datatypes ()
((tS18bP1__ref (mk_tS18bP1__ref (tS18bP1__content tdigit_count_typeB)))))
...
(declare-datatypes ()
((t20b__ref (mk_t20b__ref (t20b__content tdigit_count_typeB)))))
...
(declare-datatypes ()
((t22b__ref (mk_t22b__ref (t22b__content tdigit_count_typeB)))))
