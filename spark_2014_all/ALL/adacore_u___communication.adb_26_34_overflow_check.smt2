...
(declare-fun o3 () (Array Int data))

(declare-fun o4 () (Array Int data))
...
(declare-fun temp___235 () (Array Int data))

(declare-fun temp___2351 () t)

(declare-fun temp___2352 () positive)

(declare-fun temp___2353 () natural)
...
;; H
  (assert
  (and (<= (to_rep3 (first b__split_fields1)) temp___233)
  (<= temp___233 (to_rep3 (last b__split_fields1)))))

;; H
  (assert (= o2 temp___233))

;; H
  (assert (= o3 (store b__split_fields o2 o1)))
...
;; H
  (assert (= b__split_fields2 o8))

;; H
  (assert (= b__split_fields3 o9))

;; H
  (assert (= temp___235 o6))

;; H
  (assert (= temp___2351 o7))

;; H
  (assert (= temp___2352 o8))

;; H
  (assert (= temp___2353 o9))
...
;; H
  (assert
  (= b__split_fields4 (mk___split_fields (mk___t temp___235 temp___2351)
                      temp___2352 temp___2353)))
