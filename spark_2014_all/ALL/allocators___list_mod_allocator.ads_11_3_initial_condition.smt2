...
;; all_available__def_axiom
  ...
  (! (= (= (all_available list_mod_allocator__data) true)
     (forall ((r Int))
     (=> (and (<= 1 r) (<= r 10000))
     (= (to_rep1
        (rec__list_mod_allocator__cell__stat
        (us_split_fields1 (select list_mod_allocator__data r)))) 0)))) :pattern (
  (all_available list_mod_allocator__data)) )))
...
(declare-fun c143b () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS4 () Int)

(declare-fun r145b () Int)
...
;; def_axiom
  ...
  (= (select (list_mod_allocator__data__aggregate_def temp___267) temp___268) temp___267))))
...
(define-fun dynamic_invariant5 ((temp___expr_234 Int)
  ...
  (temp___do_toplevel_233 Bool)) Bool (=>
                                      ...
                                      (<= 0 1)) (in_range5 temp___expr_234)))

(define-fun dynamic_invariant6 ((temp___expr_154 Int)
...
;; model_is_well_formed__def_axiom
  ...
  (! (=
     ...
     (= j k)))))))
     (=>
     (and (not (= list_mod_allocator__first_available 0)) (in_range4
     (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1
     (select list_mod_allocator__data (get
...
(define-fun dynamic_invariant7 ((temp___expr_191 Int)
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant7 item true true true)
     ...
     (=>
     (exists ((e Int))
     (and (and (in_range9 e) (= (contains1 container e) true)) (= e item)))
...
;; ole__post_axiom
  ...
  (! (= (= (ole left right) true)
     (forall ((item Int))
     (=> (and (in_range9 item) (= (contains1 left item) true))
...
;; is_empty__post_axiom
  ...
  (! (let ((result (is_empty container)))
     ...
     (= (= result true)
     (forall ((item Int))
     (not (and (in_range9 item) (= (contains1 container item) true)))))
...
(declare-fun temp___257 () (Array Int us_rep))
...
(declare-fun o13 () (Array Int us_rep))
...
(declare-fun list_mod_allocator__C143b__assume () us_rep1)

(declare-fun list_mod_allocator__B144b__L_5__R145b__assume () Int)
...
(declare-fun data6 () map__ref)

(declare-fun r5 () int__ref)

(declare-fun data7 () (Array Int us_rep))
...
;; H
  (assert
  (= o6 (list_mod_allocator__data__aggregate_def
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (=> (< r1 10000) (and (= o7 (+ r1 1)) (in_range3 (+ r1 1))))))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= (to_rep o8) o7))))
...
;; H
  ...
  (=> (< r1 10000)
  (= (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data1 r1))) o9))))
...
;; H
  ...
  (=> (and (<= 1 r1) (<= r1 10000))
  (=> (< r1 10000)
  (= o13 (store data1 r1 (mk___rep (mk___split_fields o11 o12)))))))

;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000))
  (=> (< r1 10000) (= result3 (mk_map__ref data1)))))
...
;; H
  (assert
  (=> (and (<= 1 r1) (<= r1 10000)) (=> (not (< r1 10000)) (= data2 data1))))
...
;; H
  ...
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1 (select data3 rr)))) (ite (= rr 10000) 0 (+ rr 1)))))))
...
;; H
  ...
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1 (select data3 10000)))) 0)))
...
;; H
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data3 rr)))) 0)))))
...
;; H
  ...
  (=> (and (<= 1 temp___258) (<= temp___258 10000))
  (ite (< r2 temp___258)
  (= (select data3 temp___258) (select temp___257 temp___258))
  (= (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data3 temp___258))) (rec__list_mod_allocator__cell__stat
                                                   (us_split_fields1
                                                   (select temp___257 temp___258)))))))
  (=> (<= 1 10000) (in_range4 r2))) (and (<= 1 r2) (<= r2 10000)))))
...
;; H
  (assert
  (=> (not (and (<= 1 r1) (<= r1 10000))) (= data6 (mk_map__ref data1))))
...
;; H
  (assert
  (and (= o20 (model__ (map__content data6) first_available1))
  (= (model_is_well_formed o20 (map__content data6) first_available1) true)))
...
;; H
  (assert
  (and (= list_mod_allocator__B144b__L_5__R145b__assume (length c143b))
  (and (in_range6 list_mod_allocator__B144b__L_5__R145b__assume)
  (<= (+ 0 list_mod_allocator__B144b__L_5__R145b__assume) 2147483647))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r145b))
  (forall ((j Int)) (=> (and (<= 1 j) (<= j i2)) (= (get c143b j) j)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 r145b))
  (and (=> (<= 1 r145b) (dynamic_property 1 r145b i2))
  (and (<= 1 i2) (<= i2 r145b)))))
...
;; H
  ...
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1
     (select (map__content data6) (get
                                  (rec__list_mod_allocator__m__t__available
                                  (us_split_fields3
                                  (model__ (map__content data6)
                                  first_available1)))
                                  (length
                                  (rec__list_mod_allocator__m__t__available
                                  (us_split_fields3
...
;; H
  (assert
  (and (= o18 (is_valid (map__content data6) first_available1))
  (= (= o18 true)
  (and
  (and (= (is_well_formed (map__content data6) first_available1) true)
  (=> (not (= first_available1 0))
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1
     (select (map__content data6) (get
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select (map__content data6) r7)))) 0)
  (= (contains
     (rec__list_mod_allocator__m__t__available
     (us_split_fields3 (model__ (map__content data6) first_available1))) r7) true))))))))

;; H
  (assert
  (and (= o19 (all_available (map__content data6)))
  (= (= o19 true)
  (forall ((r7 Int))
  (=> (and (<= 1 r7) (<= r7 10000))
  (= (to_rep1
...
(assert
;; WP_parameter_def
 ;; File "list_mod_allocator.adb", line 15, characters 0-0
  (not (= (all_available (map__content data6)) true)))
(check-sat)
(exit)
