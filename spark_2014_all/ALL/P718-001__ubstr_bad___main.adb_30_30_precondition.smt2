...
(declare-fun extension__mutable_tag_name__initialize__this () us_rep)

(declare-fun result1 () us_rep)

(declare-fun n2 () us_rep)
...
;; H
  (assert
  (and (= o (name (mk___rep tag_v__split_fields2)))
...
;; H
  (assert
  (= (length (mk___t (temp___String_Literal_847 Tuple0) (mk 1 3))) (length1
...
;; H
  (assert
  (and (= o1 (name (mk___rep tag_v__split_fields2)))
  (= o1 tag_v__split_fields1)))
...
;; H
  (assert
  (and (= o3 (name (mk___rep tag_v__split_fields2)))
  (= o3 tag_v__split_fields1)))

(assert
;; WP_parameter_def
 ;; File "main.adb", line 9, characters 0-0
  (not (< (length1 o3) 500000)))
(check-sat)
(exit)
