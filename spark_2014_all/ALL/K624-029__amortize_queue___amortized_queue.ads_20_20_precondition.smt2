...
;; H
  (assert
  (and (= o16 (length right))
  (and (in_range5 o16) (<= o16 (capacity right)))))

;; H
  (assert
  (and (= o17 (length left)) (and (in_range5 o17) (<= o17 (capacity left)))))
...
;; H
  (assert
  (and (= o19 (length (vector__content amortized_queue__Oconcat__result5)))
  (and (in_range5 o19)
  (<= o19 (capacity (vector__content amortized_queue__Oconcat__result5))))))

;; H
  (assert (= result5 (ite (= o19 o18) true false)))
...
;; H
  (assert
  (and (= o14 (last (model__ left)))
  (and (in_range4 o14) (= o14 (last (model__ left))))))

;; H
  (assert (= o15 (ite (<= i1 o14) true false)))

;; H
  (assert (= result7 (ite (<= 1 i1) o15 false)))
...
;; H
  (assert
  (and (= o13 (get (model__ right) o12))
  (and (in_range6 o13) (= o13 (get (model__ right) o12)))))
