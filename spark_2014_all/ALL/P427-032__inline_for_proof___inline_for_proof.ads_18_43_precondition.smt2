...
(define-fun get ((x (Array Int t)) (i Int)
  (inline_for_proof__y (Array Int t))
  (inline_for_proof__b Bool)) Int (ite (= inline_for_proof__b true)
                                  (to_rep (select x i))
                                  (to_rep (select inline_for_proof__y i))))

(declare-fun get__function_guard (Int (Array Int t) Int (Array Int t)
  Bool) Bool)
...
;; H
  (assert
  (and (= o (get y j y b)) (and (in_range1 o) (= o (to_rep (select y j))))))
