...
;; H
  (assert
  (and
  (= o7 (length (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and (in_range4 o7)
  (<= o7 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o5 (length m)) (and (in_range4 o5) (<= o5 (capacity m))))))
