...
(declare-fun find_map__index_maps__insert__2__container__fields1 () us_split_fields)
...
(define-fun find_map__index_maps__insert__2__container__fields2 () us_split_fields 
  (mk___split_fields find_map__index_maps__insert__2__container__fields))

(define-fun result____split_fields7 () us_split_fields (mk___split_fields
...
;; H
  (assert
  (= result____split_fields7 find_map__index_maps__clear__container__fields1))
...
;; H
  ...
  (and
  (= o (has_key
       (model__ (mk___rep result____split_discrs result____split_fields7))
...
;; H
  ...
  (= (length1
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields2)) (+ (length1
                                                              (mk___rep
                                                              result____split_discrs
                                                              result____split_fields7)) 1))
  (= (has_key
     (model__
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields2))
     (to_rep (select (elts a) k1))) true))
  (= (key
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields2)
  ...
  (= (ole (model__ (mk___rep result____split_discrs result____split_fields7))
     (model__
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields2))) true))
  (= (keys_included_except
     ...
     (to_rep (select (elts a) k1))) true))
  (= (mapping_preserved
     (keys (mk___rep result____split_discrs result____split_fields7))
     (keys
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields2))
     (positions (mk___rep result____split_discrs result____split_fields7))
     (positions
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields2))) true))
...
;; H
  (assert
  (=> (= result2 true)
  (= result____split_fields6 find_map__index_maps__insert__2__container__fields2)))

;; H
  (assert
  (=> (not (= result2 true))
  (= result____split_fields6 result____split_fields7)))

;; H
  (assert
  (<= (length1 (mk___rep result____split_discrs result____split_fields5)) 
  k2))
...
;; H
  ...
  (and
  (= (has_key
     (model__ (mk___rep result____split_discrs result____split_fields5))
  ...
  (= (to_rep
     (select (elts a) (get
                      (model__
                      (mk___rep result____split_discrs
                      result____split_fields5)) (to_rep (select (elts a) i))))) 
  (to_rep (select (elts a) i)))))))
...
;; H
  ...
  (=>
  (= (has_key
     (model__ (mk___rep result____split_discrs result____split_fields5)) e) true)
  (and
  (and
  (<= (to_rep1 (first (rt a))) (get
                               (model__
                               (mk___rep result____split_discrs
                               result____split_fields5)) e))
  (<= (get
      (model__ (mk___rep result____split_discrs result____split_fields5)) e) 
  k2))
  (= (equivalent_keys
     (to_rep
     (select (elts a) (get
...
;; H
  (assert (not (= k2 (to_rep1 (last (rt a))))))
...
;; H
  (assert (=> (= result5 true) (and (= o3 k3) (in_range5 k3))))
...
;; H
  ...
  (= (key
     ...
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1)
     (to_rep (select (elts a) k3)))) (to_rep (select (elts a) k3))))
  (= (get
     (model__
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1))
     (to_rep (select (elts a) k3))) o3))
  (= (ole (model__ (mk___rep result____split_discrs result____split_fields5))
     (model__
     (mk___rep result____split_discrs
  ...
  (= (keys_included_except
     ...
     (to_rep (select (elts a) k3))) true))
  (= (mapping_preserved
     (keys (mk___rep result____split_discrs result____split_fields5))
     (keys
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1))
     (positions (mk___rep result____split_discrs result____split_fields5))
     (positions
     (mk___rep result____split_discrs
     find_map__index_maps__insert__2__container__fields1))) true))
  (= (keys_included_except1
...
;; H
  (assert
  (=> (= result5 true)
  (= result____split_fields4 find_map__index_maps__insert__2__container__fields1)))

;; H
  (assert
  (=> (not (= result5 true))
  (= result____split_fields4 result____split_fields5)))

;; H
  (assert
  (=> (not (= result5 true))
  (= find_map__index_maps__insert__2__container__fields1 (mk___split_fields
                                                         rho))))
