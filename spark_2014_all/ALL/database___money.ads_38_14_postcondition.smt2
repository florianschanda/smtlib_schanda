...
(declare-fun money__Osubtract__result () cur)

(declare-fun money__Osubtract__result1 () raw_amount)
...
(declare-fun money__Osubtract__result2 () cur)

(declare-fun money__Osubtract__result3 () raw_amount)

(declare-fun money__Osubtract__result4 () cur)

(declare-fun money__Osubtract__result5 () raw_amount)

(declare-fun money__Osubtract__result6 () cur)

(declare-fun money__Osubtract__result7 () raw_amount)

(declare-fun money__Osubtract__result8 () cur)

(declare-fun money__Osubtract__result9 () raw_amount)

(declare-fun money__Osubtract__result10 () cur)

(declare-fun money__Osubtract__result11 () raw_amount)

(define-fun money__Osubtract__result12 () us_rep (mk___rep
                                                 (mk___split_fields
                                                 money__Osubtract__result2
                                                 money__Osubtract__result3)))
...
;; H
  (assert
  (= (mk___rep
     (mk___split_fields money__Osubtract__result6 money__Osubtract__result7)) 
  money__Osubtract__result12))
...
;; H
  (assert
  (= money__Osubtract__result12 (mk___rep (mk___split_fields o4 o5))))

;; H
  (assert
  (= (mk_amount__ref
     (mk___rep
     (mk___split_fields money__Osubtract__result8 money__Osubtract__result9))) 
  (mk_amount__ref
  (mk___rep
  (mk___split_fields money__Osubtract__result4 money__Osubtract__result5)))))
