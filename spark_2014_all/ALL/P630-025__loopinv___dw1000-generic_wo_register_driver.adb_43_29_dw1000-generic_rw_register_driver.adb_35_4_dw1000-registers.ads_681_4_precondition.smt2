...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___82481)) (to_rep (last4 temp___82481)))
  temp___82491))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___82491)) (to_rep (last2 temp___82491)))
     (+ (- (to_rep (last2 temp___82491)) (to_rep (first2 temp___82491))) 1)
