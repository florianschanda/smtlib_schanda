...
(define-fun dynamic_invariant ((temp___expr_7514 us_t1)
  ...
  (temp___do_toplevel_7513 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_7514))
                                       (and (= (first3 temp___expr_7514) 1)
                                       (= (last3 temp___expr_7514) 4)))))
...
(define-fun dynamic_invariant1 ((temp___expr_7534 us_t2)
  ...
  (temp___do_toplevel_7533 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_7534))
                                       (and (= (first5 temp___expr_7534) 1)
                                       (= (last5 temp___expr_7534) 4)))))
...
;; H
  (assert
  (and (= temp___80982 (register_to_bytes reg)) (dynamic_invariant1
  temp___80982 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80981)) (to_rep (last4 temp___80981)))
     (+ (- (to_rep (last4 temp___80981)) (to_rep (first4 temp___80981))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80981)) (to_rep (last4 temp___80981))) 
  temp___80991))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80991)) (to_rep (last2 temp___80991)))
     (+ (- (to_rep (last2 temp___80991)) (to_rep (first2 temp___80991))) 1)
