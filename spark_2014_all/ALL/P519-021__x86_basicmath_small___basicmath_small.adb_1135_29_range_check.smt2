...
(declare-fun user_eq3 (unsigned81 unsigned81) Bool)

(declare-fun dummy3 () unsigned81)
...
(define-fun dynamic_invariant3 ((temp___expr_292 (_ BitVec 8))
...
(define-fun dynamic_invariant4 ((temp___expr_208 (_ BitVec 32))
...
;; readreg32__post_axiom
  ...
  (! (=> (dynamic_invariant reg true true true)
     ...
     (dynamic_invariant4 result true false true)))) :pattern ((readreg32 reg)) )))
...
;; writereg32post__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant regnew true true true) (dynamic_invariant4 val__
     true true true))
