...
;; H
  (assert
  (and (= o8 (length orear)) (and (in_range4 o8) (<= o8 (capacity orear)))))

;; H
  (assert
  (and (= o9 (length ofront)) (and (in_range4 o9) (<= o9 (capacity ofront)))))
...
;; H
  (assert (= result4 (ite (= o7 0) true false)))
...
;; H
  (assert
  (and (= o6 (get (model__ ofront) o5))
  (and (in_range5 o6) (= o6 (get (model__ ofront) o5)))))
