...
;; H
  ...
  (and
  (<= (+ (int__content
         test_prime_and_coprime_numbers__p__nearest_number__result19) 1) v1)
...
;; H
  (assert (= o34 (ite (< 0 o33) o33 0)))

;; H
  (assert (= o35 (ite (<= o34 v) true false)))

;; H
  (assert
  (= result24 (ite (= o35 true) (ite (<= v value) true false) false)))
...
;; H
  ...
  value (abs (- value (int__content
                      test_prime_and_coprime_numbers__p__nearest_number__result19)))) 1) 0) v1)
  (<= v1 value)) (not (= (select number_list v1) true))))))
