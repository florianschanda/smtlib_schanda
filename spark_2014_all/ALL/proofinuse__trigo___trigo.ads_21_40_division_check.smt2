...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 720.0)))
...
;; H
  (assert (= o4 (div1 RNE1 o3 fliteral2)))

;; H
  (assert
  (and (= o1 (pow6 x))
  (and (tqtisFinite o1)
  (= o1 (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 x x) x) x) x) x)))))

;; H
  (assert (= o2 (div1 RNE1 o1 fliteral3)))

;; H
  (assert
  (and (= o (pow4 x))
  (and (tqtisFinite o) (= o (mul RNE1 (mul RNE1 (mul RNE1 x x) x) x)))))
