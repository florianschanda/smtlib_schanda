...
(((mk_sequence__ref (sequence__content us_t)))))
...
(declare-const sq (Array Int unsigned_8))
...
(declare-const temp___226 (Array Int unsigned_8))

(declare-const o2 (Array Int unsigned_8))

(declare-const result Int)

(declare-const i1 Int)

(declare-const sq1 (Array Int unsigned_8))

(declare-const i2 Int)

(declare-const result1 (Array Int unsigned_8))

(declare-const sq2 (Array Int unsigned_8))
