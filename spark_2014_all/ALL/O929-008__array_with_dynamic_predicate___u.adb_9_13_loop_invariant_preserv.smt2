...
(define-fun bool_eq3 ((a (Array Int unsigned_8)) (a__first Int) (a__last Int)
...
(declare-datatypes ()
((sequence__ref (mk_sequence__ref (sequence__content us_t)))))
(define-fun sequence__ref___projection ((a sequence__ref)) us_t (sequence__content
                                                                a))

(declare-fun sq__first () integer)

(declare-fun sq__last () integer)
...
(define-fun dynamic_invariant2 ((temp___expr_202 us_t)
  ...
  (temp___do_toplevel_201 Bool)) Bool (and
                                      ...
                                      (= (first1 temp___expr_202) 0)))))

(define-fun dynamic_predicate ((temp___205 us_t)) Bool (= (first1 temp___205) 0))

(define-fun dynamic_invariant3 ((temp___expr_160 (_ BitVec 8))
  (temp___is_init_157 Bool) (temp___skip_constant_158 Bool)
  (temp___do_toplevel_159 Bool)) Bool true)

(declare-fun sq () (Array Int unsigned_8))
...
(declare-fun temp___226 () (Array Int unsigned_8))

(declare-fun o2 () (Array Int unsigned_8))

(declare-fun result () Int)

(declare-fun i1 () Int)

(declare-fun sq1 () (Array Int unsigned_8))

(declare-fun i2 () Int)

(declare-fun result1 () (Array Int unsigned_8))

(declare-fun sq2 () (Array Int unsigned_8))
...
;; H
  (assert
  (and (dynamic_property 0 2147483647 (to_rep sq__first) (to_rep sq__last))
  (= (to_rep sq__first) 0)))
...
;; H
  (assert (<= i1 (to_rep sq__last)))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= i2 j) (<= j (to_rep sq__last)))
  (= (to_rep1 (select sq1 j)) (to_rep1 (select sq j))))))
...
;; H
  ...
  (and
  (and
  (=> (<= 0 (to_rep sq__last)) (dynamic_property1 0 (to_rep sq__last) i2))
  (= (to_rep sq__first) 0))
  (forall ((temp___232 Int))
  (=>
  (and (<= (to_rep sq__first) temp___232) (<= temp___232 (to_rep sq__last)))
  (=> (<= i2 temp___232) (= (select sq1 temp___232) (select sq temp___232))))))
  (and (<= 0 i2) (<= i2 (to_rep sq__last)))))

;; H
  (assert (= (to_rep1 o) ((_ int2bv 8) 0)))

;; H
  (assert (and (<= (to_rep sq__first) i2) (<= i2 (to_rep sq__last))))

;; H
  (assert (= o1 i2))

;; H
  (assert (= temp___226 (store sq1 o1 o)))

;; H
  (assert (= (to_rep sq__first) 0))

;; H
  (assert (= o2 temp___226))
...
;; H
  (assert (<= j (to_rep sq__last)))

(assert
;; WP_parameter_def
 ;; File "u.ads", line 7, characters 0-0
  (not (= (to_rep1 (select sq2 j)) (to_rep1 (select sq j)))))
(check-sat)
