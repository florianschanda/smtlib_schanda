...
;; range_axiom
  (assert
  (forall ((x bits_12)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(define-fun to_int8 ((x bits_12)) Int (bv2nat (to_rep6 x)))
...
(define-fun register_type__ref___31__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___22__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___22__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2865 us_t1)
  (temp___is_init_2862 Bool) (temp___skip_constant_2863 Bool)
  (temp___do_toplevel_2864 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2863 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2865)
                                       (last3 temp___expr_2865))
                                       (and (= (first3 temp___expr_2865) 1)
                                       (= (last3 temp___expr_2865) 4)))))
