...
(declare-fun o5 () (Array Int data))

(declare-fun o6 () (Array Int data))

(declare-fun o7 () t)

(declare-fun o8 () (Array Int data))
...
(declare-fun temp___241 () (Array Int data))

(declare-fun temp___2411 () t)

(declare-fun temp___2412 () positive)

(declare-fun temp___2413 () natural)

(declare-fun result () Bool)

(declare-fun result1 () us_split_fields__ref)

(declare-fun b__split_fields4 () us_split_fields)
...
;; H
  (assert (not (<= max (to_rep b__split_fields3))))

;; H
  (assert
  (and (= o (+ (to_rep1 b__split_fields2) (to_rep b__split_fields3)))
  (in_range (+ (to_rep1 b__split_fields2) (to_rep b__split_fields3)))))

;; H
  (assert (= result (ite (<= max o) true false)))
...
;; H
  (assert
  (and (= o1 (+ (to_rep1 b__split_fields2) (to_rep b__split_fields3)))
  (in_range (+ (to_rep1 b__split_fields2) (to_rep b__split_fields3)))))
...
;; H
  (assert (and (= temp___239 o2) (in_range o2)))

;; H
  (assert
  (and (<= (to_rep3 (first b__split_fields1)) temp___239)
  (<= temp___239 (to_rep3 (last b__split_fields1)))))

;; H
  (assert (= o4 temp___239))

;; H
  (assert (= o5 (store b__split_fields o4 o3)))

;; H
  (assert (= o5 o6))

;; H
  (assert (= b__split_fields1 o7))
...
;; H
  (assert (= b__split_fields2 o10))

;; H
  (assert (= b__split_fields3 o11))

;; H
  (assert (= temp___241 o8))

;; H
  (assert (= temp___2411 o9))

;; H
  (assert (= temp___2412 o10))

;; H
  (assert (= temp___2413 o11))
...
;; H
  (assert
  (= b__split_fields4 (mk___split_fields (mk___t temp___241 temp___2411)
                      temp___2412 temp___2413)))
...
;; WP_parameter_def
 ;; File "communication.ads", line 18, characters 0-0
  (not (in_range
  (+ (to_rep
     (rec__communication__ring_buffer__buffer__length b__split_fields4)) 1))))
(check-sat)
(exit)
