...
(declare-const temp___998 us_t1)

(declare-const o144 (Array Int character))

(declare-const temp___1001 us_t1)
...
;; H
  (assert
  (= temp___998 (mk___t1 (slide str1 (to_rep1 str__first) 1)
                (mk1 1 (to_rep1 str__last)))))

;; H
  (assert
  (=> (<= 1 (to_rep1 str__last))
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 (to_rep1 str__last)) (<= (to_rep1 str__last) 150)))))

;; H
  (assert (= o144 localtext1))

;; H
  (assert (= temp___1001 (mk___t1 o144 (mk1 1 (to_rep1 str__last)))))

(assert
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 (rt1 temp___998))) (to_rep1
                                                  (last2 (rt1 temp___998))))
     (+ (- (to_rep1 (last2 (rt1 temp___998))) (to_rep1
                                              (first2 (rt1 temp___998)))) 1)
     0) (ite (<= (to_rep1 (first2 (rt1 temp___1001))) (to_rep1
                                                      (last2
                                                      (rt1 temp___1001))))
        (+ (- (to_rep1 (last2 (rt1 temp___1001))) (to_rep1
                                                  (first2 (rt1 temp___1001)))) 1)
        0))))
(check-sat)
(exit)
