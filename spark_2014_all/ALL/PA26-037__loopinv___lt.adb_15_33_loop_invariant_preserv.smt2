...
;; H
  (assert
  (=> (and (<= 0 j8) (<= j8 9))
  (and (= o1 (+ r8 (to_rep (select (select x i3) j8)))) (in_range4
  (+ r8 (to_rep (select (select x i3) j8)))))))
...
;; H
  (assert
  (=> (and (<= 0 j8) (<= j8 9))
  (and (and (=> (<= 0 100) (in_range4 r10)) (=> (<= 0 9) (in_range3 j9)))
  (and (<= 0 j9) (<= j9 9)))))
...
;; WP_parameter_def
 ;; File "lt.ads", line 7, characters 0-0
  (not (<= (int__content r15) (* (+ (int__content i4) 1) 10))))
(check-sat)
