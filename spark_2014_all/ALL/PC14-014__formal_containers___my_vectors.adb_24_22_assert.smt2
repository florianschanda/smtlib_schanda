...
;; H
  ...
  (length (mk___rep l__split_discrs l__split_fields11)) 4))
  ...
  (= (constant_range
     ...
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields11))) 4) 9) true))))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 855, characters 0-0
  (not (< 3 (length (mk___rep l__split_discrs l__split_fields9)))))
(check-sat)
(exit)
