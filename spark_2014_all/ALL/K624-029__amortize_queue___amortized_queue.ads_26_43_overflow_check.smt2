...
;; H
  (assert
  (and (= o8 (length right)) (and (in_range6 o8) (<= o8 (capacity right)))))
...
;; H
  (assert
  (and
  (= o10 (length (vector__content amortized_queue__Oconcat__2__result5)))
  (and (in_range6 o10)
  (<= o10 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
...
;; H
  (assert
  (and
  (= o7 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1))
  (and (in_range7 o7)
  (= o7 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1)))))
...
;; H
  (assert (= result5 (ite (= o7 left) true false)))
...
;; H
  (assert
  (and (= o6 (get (model__ right) o5))
  (and (in_range7 o6) (= o6 (get (model__ right) o5)))))
