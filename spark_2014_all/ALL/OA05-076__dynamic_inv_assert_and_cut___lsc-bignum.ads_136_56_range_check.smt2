...
(declare-fun lsc__bignum__less__result1 () Bool)

(declare-fun lsc__bignum__less__result2 () Bool)

(declare-fun lsc__bignum__less__result3 () Bool)

(declare-fun j8 () int__ref)

(declare-fun result__10 () bool__ref)

(declare-fun i7 () int__ref)

(declare-fun lsc__bignum__less__result4 () bool__ref)

(declare-fun j9 () Int)

(declare-fun result__11 () Bool)

(declare-fun i8 () Int)

(declare-fun lsc__bignum__less__result5 () Bool)
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last))
  (and (= o (- i2 a_first)) (in_range1 (- i2 a_first)))))
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (and (= o2 o1) (in_range1 o1))))

;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (and (= o3 o2) (in_range2 o2))))
...
;; H
  ...
  (= o6 j3)) (= o7 (select (elts b) o6))) (= o8 (to_rep o7)))
  (and
  (and
  (and
  (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a)))))
  (= o4 i2)) (= o5 (select (elts a) o4))) (= o9 (to_rep o5)))
  (= result3 (ite (bvult o9 o8) true false))))
  ...
  (and
  (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b)))))
  (= o12 j3)) (= o13 (select (elts b) o12))) (= o14 (to_rep o13)))
  (and
  (and
  (and
  (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a)))))
  (= o10 i2)) (= o11 (select (elts a) o10))) (= o15 (to_rep o11)))
  (= result5 (ite (bvugt o15 o14) true false)))) (= result5 true))
  (and
  (and
  (and
  (and
  ...
  (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a)))))
  (= o10 i2)) (= o11 (select (elts a) o10))) (= o15 (to_rep o11)))
  (= result5 (ite (bvugt o15 o14) true false)))) (not (= result5 true)))
  (= i2 a_first))))))))
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last))
  (= result__13 (mk_bool__ref result__4))))
...
;; H
  (assert
  (=> (and (<= a_first i1) (<= i1 a_last)) (= result__12 result__13)))
...
;; H
  (assert
  (=> (not (and (<= a_first i1) (<= i1 a_last))) (= result__1 result__8)))

;; H
  (assert
  (=> (not (and (<= a_first i1) (<= i1 a_last))) (= j10 (mk_int__ref j))))
...
;; H
  (assert
  (=> (not (and (<= a_first i1) (<= i1 a_last))) (= result__9 result__1)))
...
;; H
  (assert
  (= (mk_bool__ref result6) (mk_bool__ref lsc__bignum__less__result)))
...
;; H
  (assert
  (= lsc__bignum__less__result4 (mk_bool__ref lsc__bignum__less__result2)))
