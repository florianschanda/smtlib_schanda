...
(define-fun default_initial_assumption ((temp___expr_149 us_rep1)
...
(declare-fun set_width__specific_post (Int us_split_fields2 Int Int
  us_split_fields2) Bool)

;; rectangle__t__compat_axiom
  (assert true)

(declare-fun set_height__specific_post (Int us_split_fields2 Int Int
  us_split_fields2) Bool)
...
(declare-fun rec____split_fields () integer)

(declare-fun rec____split_fields1 () integer)
...
(declare-fun rec____split_fields5 () integer)

(declare-fun rec____split_fields6 () natural)

(declare-fun rec____split_fields7 () natural)

(declare-fun rec____split_fields8 () us_private)

(declare-fun window__prepare_to_draw__obj__fields () integer)

(declare-fun window__prepare_to_draw__obj__fields1 () integer)

(declare-fun window__prepare_to_draw__obj__fields2 () integer)

(declare-fun window__prepare_to_draw__obj__fields3 () us_private)
...
(declare-fun rec____split_fields9 () integer)

(declare-fun rec____split_fields10 () integer)

(declare-fun rec____split_fields11 () integer)

(declare-fun rec____split_fields12 () natural)

(declare-fun rec____split_fields13 () natural)

(declare-fun rec____split_fields14 () us_private)

(define-fun window__prepare_to_draw__obj__fields4 () us_split_fields
  (mk___split_fields window__prepare_to_draw__obj__fields
  window__prepare_to_draw__obj__fields1 window__prepare_to_draw__obj__fields2
  window__prepare_to_draw__obj__fields3))
...
;; H
  (assert
  (and (= rec____attr__tag us_tag1)
  (and
  (and (= (to_rep rec____split_fields) (- 1))
  (= (to_rep rec____split_fields1) (- 1)))
  (= (to_rep rec____split_fields2) (- 1)))))

;; H
  (assert
  (= (has_stored_area1 rec____attr__tag
     (mk___rep window__prepare_to_draw__obj__fields4 rec____attr__tag)) true))
...
;; H
  (assert
  (= (mk___split_fields1 rec____split_fields9 rec____split_fields10
     rec____split_fields11 rec____split_fields12 rec____split_fields13
     rec____split_fields14) (us_split_fields3
                            (of_base
                            (mk___rep window__prepare_to_draw__obj__fields4
                            rec____attr__tag)))))

(assert
;; WP_parameter_def
 ;; File "window.ads", line 13, characters 0-0
  (not
  (= (has_stored_area1 rec____attr__tag
     (mk___rep
     (mk___split_fields rec____split_fields9 rec____split_fields10
     rec____split_fields11
     (hide_ext__ rec____split_fields12 rec____split_fields13
     rec____split_fields14)) rec____attr__tag)) true)))
(check-sat)
(exit)
