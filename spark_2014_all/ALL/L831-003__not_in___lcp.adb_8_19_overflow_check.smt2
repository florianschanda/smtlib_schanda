...
;; H
  (assert (and (= o1 (+ x l2)) (in_range1 (+ x l2))))

;; H
  (assert (= o2 (ite (<= o1 (to_rep (last (rt a)))) true false)))

;; H
  (assert (and (= o (+ x l2)) (in_range1 (+ x l2))))

;; H
  (assert (= o3 (ite (<= (to_rep (first (rt a))) o) true false)))

;; H
  (assert (= o4 (ite (= o3 true) o2 false)))
