...
(declare-fun temp___243 () us_rep2)
...
;; H
  (assert
  (= temp___243 (mk___rep2 (mk___split_discrs output__split_discrs) o3
...
;; H
  (assert (= output__split_fields4 (us_split_fields5 temp___243)))
...
;; H
  (assert (= output__split_discrs1 (us_split_discrs1 temp___243)))
