...
(declare-fun sum_elem__partitions__append__2__container__fields () us_main_type)

(declare-fun result () us_main_type)

(declare-fun p__split_fields1 () us_main_type)

(define-fun sum_elem__partitions__append__2__container__fields1 () us_split_fields2
  (mk___split_fields1 sum_elem__partitions__append__2__container__fields))
...
;; H
  ...
  (= (length
     ...
     sum_elem__partitions__append__2__container__fields1)) (+ (length
                                                              (mk___rep1
                                                              p__split_discrs
                                                              (mk___split_fields1
                                                              p__split_fields))) 1))
  (= (olt
     ...
     (model__
     (mk___rep1 p__split_discrs
     sum_elem__partitions__append__2__container__fields1))) true))
  (= (bool_eq
     (get
     (model__
     (mk___rep1 p__split_discrs
     sum_elem__partitions__append__2__container__fields1))
     (+ (last
        (model__
        (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) 1))
     (mk___rep (mk___split_fields o4 o5))) true)))
...
;; H
  (assert
  (= (mk___split_fields1 p__split_fields1) sum_elem__partitions__append__2__container__fields1))
