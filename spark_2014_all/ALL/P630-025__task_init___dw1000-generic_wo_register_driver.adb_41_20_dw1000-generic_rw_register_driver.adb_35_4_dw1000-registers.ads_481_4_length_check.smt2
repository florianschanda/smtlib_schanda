...
(define-fun dynamic_invariant ((temp___expr_5622 us_t1)
  ...
  (temp___do_toplevel_5621 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_5622))
                                       (and (= (first3 temp___expr_5622) 1)
                                       (= (last3 temp___expr_5622) 1)))))
...
(define-fun dynamic_invariant1 ((temp___expr_5638 us_t2)
  ...
  (temp___do_toplevel_5637 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_5638))
                                       (and (= (first5 temp___expr_5638) 1)
                                       (= (last5 temp___expr_5638) 1)))))
...
;; H
  (assert
  (and (= temp___78982 (register_to_bytes reg)) (dynamic_invariant1
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___78981)) (to_rep (last4 temp___78981)))
     (+ (- (to_rep (last4 temp___78981)) (to_rep (first4 temp___78981))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
