...
(define-fun o34 () us_t (mk___t o28 o29))
...
;; H
  (assert
  (and (= o34 (remove (mk___t values2 (mk 1 100)) o27))
...
;; H
  (assert
  (and (= o32 (remove (mk___t interm1 (mk 1 100)) o31))
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o31 1)))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o32) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o31 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o32) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o31 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o32) k))))))))))))
