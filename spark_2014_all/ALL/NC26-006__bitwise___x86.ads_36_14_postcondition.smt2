...
(declare-fun x86__readmem32_v2__result () (_ BitVec 32))
...
(declare-fun x86__readmem32_v2__result1 () (_ BitVec 32))

(declare-fun x86__readmem32_v2__result2 () (_ BitVec 32))

(declare-fun x86__readmem32_v2__result3 () (_ BitVec 32))

(declare-fun x86__readmem32_v2__result4 () (_ BitVec 32))

(declare-fun x86__readmem32_v2__result5 () (_ BitVec 32))
...
;; H
  (assert
  (and (= o1 (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory))
  (= o1 (bvor ((_ zero_extend 8) (to_rep
                                 (select memory (bvadd addr ((_ int2bv 64) 2)))))
  (ite (< 8 16)
  (bvshl ((_ zero_extend 8) (to_rep
                            (select memory (bvadd (bvadd addr ((_ int2bv 64) 2)) ((_ int2bv 64) 1))))) ((_ int2bv 16) 8))
  ((_ int2bv 16) 0))))))
...
;; H
  (assert (= o3 (bvshl o2 ((_ int2bv 32) 16))))

;; H
  (assert
  (and (= o (readmem16 addr memory))
  (= o (bvor ((_ zero_extend 8) (to_rep (select memory addr))) (ite (< 8 16)
...
;; H
  (assert (= result x86__readmem32_v2__result))

;; H
  (assert (= x86__readmem32_v2__result1 o5))

;; H
  (assert
  (= (mk_t__ref1 x86__readmem32_v2__result4) (mk_t__ref1
                                             x86__readmem32_v2__result2)))

;; H
  (assert (= x86__readmem32_v2__result5 x86__readmem32_v2__result3))

;; H
  (assert (= result1 x86__readmem32_v2__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not
  (= x86__readmem32_v2__result4 (bvor ((_ zero_extend 16) (readmem16
                                                          addr memory)) (bvshl ((_ zero_extend 16)
