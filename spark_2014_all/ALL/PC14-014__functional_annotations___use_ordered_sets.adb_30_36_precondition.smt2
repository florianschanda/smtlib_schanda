...
;; H
  ...
  (=>
  (and (in_range2 g1)
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields2)) g1) true))
  (exists ((i Int))
  (and
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
...
;; H
  (assert
  (and (= temp___685 (model__ (mk___rep r__split_discrs r__split_fields2)))
  (= (length4 temp___685) (length
                          (mk___rep r__split_discrs r__split_fields2)))))

;; H
  (assert
  (and (= o (contains temp___685 g))
  (=> (= (of_int 1) true)
  (=>
  (exists ((e Int))
  (and (and (in_range2 e) (= (contains temp___685 e) true))
  (= (equivalent_elements e g) true))) (= o true)))))
