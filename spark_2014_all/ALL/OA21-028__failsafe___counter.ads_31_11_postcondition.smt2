...
(((mk_map__ref (map__content (Array (_ BitVec 8) Bool))))))
...
(declare-const temp___237 (_ BitVec 8))

(declare-const temp___238 (Array (_ BitVec 8) Bool))

(declare-const temp___240 (Array (_ BitVec 8) Bool))

(declare-const temp___235 (Array (_ BitVec 8) Bool))
...
(declare-const result1 (Array (_ BitVec 8) Bool))

(declare-const inputs3 (Array (_ BitVec 8) Bool))

(declare-const inputs4 (Array (_ BitVec 8) Bool))

(declare-const i3 (_ BitVec 8))

(declare-const inputs5 (Array (_ BitVec 8) Bool))

(declare-const i4 (_ BitVec 8))

(declare-const inputs6 (Array (_ BitVec 8) Bool))

(declare-const i5 (_ BitVec 8))

(declare-const inputs7 (Array (_ BitVec 8) Bool))

(declare-const i6 (_ BitVec 8))

(declare-const result2 (Array (_ BitVec 8) Bool))

(declare-const inputs8 (Array (_ BitVec 8) Bool))

(declare-const inputs9 (Array (_ BitVec 8) Bool))

(declare-const i7 (_ BitVec 8))

(declare-const inputs10 (Array (_ BitVec 8) Bool))

(declare-const i8 (_ BitVec 8))

(define-fun inputs11 () map__ref (mk_map__ref inputs6))
...
;; H
  (assert
  (=> (and (bvule ((_ int2bv 8) 1) i1) (bvule i1 ((_ int2bv 8) 9)))
  (= (mk_t__ref i5) (mk_t__ref i3))))

;; H
  (assert
  (=> (and (bvule ((_ int2bv 8) 1) i1) (bvule i1 ((_ int2bv 8) 9)))
  (= inputs11 (mk_map__ref inputs4))))
...
;; H
  (assert
  (=> (not (and (bvule ((_ int2bv 8) 1) i1) (bvule i1 ((_ int2bv 8) 9))))
  (= i1 i5)))

;; H
  (assert
  (=> (not (and (bvule ((_ int2bv 8) 1) i1) (bvule i1 ((_ int2bv 8) 9))))
  (= inputs11 (mk_map__ref inputs))))
...
;; H
  (assert (= result2 inputs6))

;; H
  (assert (= inputs8 (store inputs6 ((_ int2bv 8) 10) input)))

;; H
  (assert (= i7 i5))

;; H
  (assert (= inputs8 inputs9))

;; H
  (assert (= i8 i6))

;; H
  (assert (= inputs10 inputs8))

(declare-const k (_ BitVec 8))

;; H
  (assert (bvule ((_ int2bv 8) 1) k))

;; H
  (assert (bvule k ((_ int2bv 8) 9)))

;; H
  (assert (= (select inputs9 k) true))

(assert
;; WP_parameter_def
 ;; File "counter.ads", line 9, characters 0-0
  (not (= (select inputs (bvadd k ((_ int2bv 8) 1))) true)))
(check-sat)
(exit)
