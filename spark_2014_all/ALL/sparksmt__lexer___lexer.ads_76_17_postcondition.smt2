...
(declare-fun current_pos3 () int__ref)

(declare-fun next_read__split_fields1 () us_split_fields__ref)

(declare-fun next_read__split_discrs1 () us_split_discrs__ref)
...
(declare-fun current_pos4 () Int)

(declare-fun next_read__split_fields2 () us_split_fields)

(declare-fun next_read__split_discrs2 () us_split_discrs)

(define-fun next_read__split_discrs3 () us_split_discrs (mk___split_discrs
                                                        next_read__split_discrs))

(define-fun next_read__split_fields3 () us_split_fields (mk___split_fields
                                                        next_read__split_fields))

(define-fun current_read__split_discrs3 () us_split_discrs (mk___split_discrs
...
;; H
  (assert
  (and (<= current_pos1 current_pos2)
  (and (and (in_range2 current_line2) (in_range1 current_col2)) (in_range1
  current_pos2))))

;; H
  (assert
  (= next_read__split_discrs1 (mk___split_discrs__ref
                              next_read__split_discrs3)))

;; H
  (assert
  (= next_read__split_fields1 (mk___split_fields__ref
...
;; WP_parameter_def
 ;; File "lexer.ads", line 65, characters 0-0
  ...
  (= (invariant__1 (us_private__content name_table2)
     ...
     (us_split_discrs__content next_read__split_discrs1)) true)))
(check-sat)
(exit)
