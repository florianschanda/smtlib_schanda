...
(declare-fun temp___1781 () (Array Int us_rep1))
...
(declare-fun temp___1780 () (Array Int us_rep1))
...
;; H
  ...
  (= temp___1780 (model__
                 ...
                 root))
  (and (dynamic_invariant3 temp___1780 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1780 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1780 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1780 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1780 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1780 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1780 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1780 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1780 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1780 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o4 (select temp___1780 i)))
...
;; H
  ...
  (= temp___1781 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (and (dynamic_invariant3 temp___1781 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1781 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1781 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1781 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1781 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1781 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1781 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1781 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1781 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1781 j)))) true))
  (= j i1)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o (select temp___1781 i))))
...
;; H
  (assert (=> (= result2 true) (= o6 (ite (< o3 n2) true false))))

;; H
  (assert (=> (not (= result2 true)) (= o6 false)))

;; H
  (assert (= result1 (ite (and (= o6 true) (not (= i v))) true false)))
