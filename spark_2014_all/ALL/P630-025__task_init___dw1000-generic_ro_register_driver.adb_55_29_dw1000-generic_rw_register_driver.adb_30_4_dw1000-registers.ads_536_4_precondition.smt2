...
(define-fun register_type__ref_186__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_130__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_130__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6355 us_t1)
  ...
  (temp___do_toplevel_6354 Bool)) Bool (=>
                                       ...
                                       (first3 temp___expr_6355)
                                       (last3 temp___expr_6355))
                                       (and (= (first3 temp___expr_6355) 1)
                                       (= (last3 temp___expr_6355) 2)))))
