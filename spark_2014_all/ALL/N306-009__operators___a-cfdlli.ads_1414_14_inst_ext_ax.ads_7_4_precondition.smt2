...
(declare-datatypes ()
((us_split_discrs
 (mk___split_discrs (rec__inst_ext_ax__ok_lists2__list__capacity count_type)))))
(define-fun us_split_discrs_2__projection ((a us_split_discrs)) count_type
  (rec__inst_ext_ax__ok_lists2__list__capacity a))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__inst_ext_ax__ok_lists2__list us_main_type)))))
(define-fun us_split_fields_List2__projection ((a us_split_fields)) us_main_type
  (rec__inst_ext_ax__ok_lists2__list a))
...
(define-fun bool_eq ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep
                           (rec__inst_ext_ax__ok_lists2__list__capacity
                           (us_split_discrs1 a))) (to_rep
                                                  (rec__inst_ext_ax__ok_lists2__list__capacity
                                                  (us_split_discrs1 b))))
                        (= (us_main_eq
                           (rec__inst_ext_ax__ok_lists2__list
                           (us_split_fields1 a))
                           (rec__inst_ext_ax__ok_lists2__list
...
(declare-fun inst_ext_ax__ok_lists2__list__capacity__first__bit () Int)

(declare-fun inst_ext_ax__ok_lists2__list__capacity__last__bit () Int)

(declare-fun inst_ext_ax__ok_lists2__list__capacity__position () Int)

;; inst_ext_ax__ok_lists2__list__capacity__first__bit_axiom
  (assert (<= 0 inst_ext_ax__ok_lists2__list__capacity__first__bit))

;; inst_ext_ax__ok_lists2__list__capacity__last__bit_axiom
  (assert
  (< inst_ext_ax__ok_lists2__list__capacity__first__bit inst_ext_ax__ok_lists2__list__capacity__last__bit))

;; inst_ext_ax__ok_lists2__list__capacity__position_axiom
...
(define-fun list__ref_2__projection ((a list__ref)) us_rep (list__content a))

(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__inst_ext_ax__ok_lists2__cursor__node count_type)))))
(define-fun us_split_fields_Node2__projection ((a us_split_fields2)) count_type
  (rec__inst_ext_ax__ok_lists2__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__inst_ext_ax__ok_lists2__cursor__node
...
(declare-fun inst_ext_ax__ok_lists2__cursor__node__first__bit () Int)

(declare-fun inst_ext_ax__ok_lists2__cursor__node__last__bit () Int)

(declare-fun inst_ext_ax__ok_lists2__cursor__node__position () Int)

;; inst_ext_ax__ok_lists2__cursor__node__first__bit_axiom
  (assert (<= 0 inst_ext_ax__ok_lists2__cursor__node__first__bit))

;; inst_ext_ax__ok_lists2__cursor__node__last__bit_axiom
  (assert
  (< inst_ext_ax__ok_lists2__cursor__node__first__bit inst_ext_ax__ok_lists2__cursor__node__last__bit))

;; inst_ext_ax__ok_lists2__cursor__node__position_axiom
...
(define-fun default_initial_assumption ((temp___expr_367 us_rep1)
  (temp___skip_top_level_368 Bool)) Bool (= (to_rep
                                            (rec__inst_ext_ax__ok_lists2__cursor__node
                                            (us_split_fields3
                                            temp___expr_367))) 0))
...
(define-fun map__ref_2__projection ((a map__ref)) us_rep3 (map__content a))

(declare-datatypes ()
((key_type__ref (mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref_2__projection ((a key_type__ref)) us_rep1 (key_type__content
                                                                    a))
...
(define-fun dynamic_invariant2 ((temp___expr_411 Int)
...
(define-fun default_initial_assumption1 ((temp___expr_418 us_rep3)
...
(define-fun default_initial_assumption2 ((temp___expr_406 us_rep1)
  (temp___skip_top_level_407 Bool)) Bool (= (to_rep
                                            (rec__inst_ext_ax__ok_lists2__cursor__node
                                            (us_split_fields3
                                            temp___expr_406))) 0))
...
(define-fun default_initial_assumption3 ((temp___expr_399 us_rep2)
  (temp___skip_top_level_400 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_400 true))
                                         (= (length1 temp___expr_399) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_386 Int)
...
(declare-fun temp___730 () count_type)
...
;; H
  (assert (= temp___730 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___730)) no_element))
