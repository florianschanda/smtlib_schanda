...
(declare-fun untangle__word_a__lo__first__bit () Int)

(declare-fun untangle__word_a__lo__last__bit () Int)

(declare-fun untangle__word_a__lo__position () Int)
...
(declare-fun untangle__word_a__hi__first__bit () Int)

(declare-fun untangle__word_a__hi__last__bit () Int)

(declare-fun untangle__word_a__hi__position () Int)
...
(declare-fun dummy3 () tword_arrayD1)
...
(declare-fun untangle__thing__a__first__bit () Int)

(declare-fun untangle__thing__a__last__bit () Int)

(declare-fun untangle__thing__a__position () Int)
...
(declare-fun untangle__thing__b__first__bit () Int)

(declare-fun untangle__thing__b__last__bit () Int)

(declare-fun untangle__thing__b__position () Int)
...
(declare-fun untangle__thing__c__first__bit () Int)

(declare-fun untangle__thing__c__last__bit () Int)

(declare-fun untangle__thing__c__position () Int)
...
(declare-fun untangle__optional_thing__exists__first__bit () Int)

(declare-fun untangle__optional_thing__exists__last__bit () Int)

(declare-fun untangle__optional_thing__exists__position () Int)
...
(declare-fun untangle__optional_thing__t__first__bit () Int)

(declare-fun untangle__optional_thing__t__last__bit () Int)

(declare-fun untangle__optional_thing__t__position () Int)
