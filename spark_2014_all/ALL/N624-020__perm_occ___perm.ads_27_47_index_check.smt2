...
;; H
  ...
  (= result1 (ite (= (to_rep1 (last (rt r))) (to_rep1 (last (rt a)))) true
             false))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (<= (to_rep1 (first (rt r))) i) (<= i (to_rep1 (last (rt r)))))))

;; H
  (assert (=> (= result1 true) (= o i)))

;; H
  (assert (=> (= result1 true) (= o1 (select (elts r) o))))

;; H
  (assert (=> (= result1 true) (= o2 (to_rep o1))))

;; H
  (assert (=> (= result1 true) (= result (ite (= o2 v) true false))))
