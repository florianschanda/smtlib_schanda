...
;; H
  (assert (=> (< 0 e) (and (= o6 (- e 1)) (in_range1 (- e 1)))))

;; H
  (assert (=> (< 0 e) (and (= o7 (+ i 1)) (in_range (+ i 1)))))

;; H
  (assert (=> (< 0 e) (= temp___4341 (temp___601 a i e o7 o6))))

;; H
  (assert (=> (< 0 e) (= result6 (bool_eq a3 1 10 temp___4341 1 10))))
