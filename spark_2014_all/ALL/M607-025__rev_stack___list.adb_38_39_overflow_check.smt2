...
;; H
  (assert
  (and (= o8 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o8)
  (<= o8 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o3 (- last5 i9)) (in_range1 (- last5 i9)))))
...
;; H
  (assert
  (=> (= result5 true)
  (and (= o2 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o2 true false true)
  (and (= (to_rep (first (rt o2))) 1) (<= 0 (to_rep (last (rt o2)))))))))
