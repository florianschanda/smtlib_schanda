...
;; H
  (assert
  (and
  (and (=> (<= 1 l) (dynamic_property3 1 l i2))
  (forall ((temp___665 Int))
  (=>
  (and (<= (to_rep1 s__first) temp___665) (<= temp___665 (to_rep1 s__last)))
  (=> (< i2 temp___665) (= (select s2 temp___665) (select s temp___665))))))
  (and (<= 1 i2) (<= i2 l))))
...
;; H
  ...
  (= o8 (get
        (model__
        (mk___rep char_table__split_discrs
        (mk___split_fields char_table__split_fields))) o7))
  (and (in_range12 o8)
  (= o8 (get
        (model__
        (mk___rep char_table__split_discrs
