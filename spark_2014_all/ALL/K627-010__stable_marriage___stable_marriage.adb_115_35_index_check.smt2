...
;; H
  ...
  (=> (and (<= 1 g11) (<= g11 64))
  (exists ((g23 Int))
  (and (and (<= 1 g23) (<= g23 64)) (= (to_rep (select g2_to_g1 g23)) g11))))))
...
;; H
  ...
  (=>
  (exists ((prev21 Int))
  (and (and (<= 1 prev21) (<= prev21 (- g22 1)))
  (= (to_rep (select g2_to_g1 prev21)) g11)))
  (= (to_rep (select g2_to_g1 (to_rep1 (select result__2 g11)))) g11)))))
