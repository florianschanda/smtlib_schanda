...
(declare-const temp___242 positive)

(declare-const temp___2421 (Array Int element))

(declare-const temp___2422 t)

(declare-const temp___2423 natural)

(declare-const temp___2424 us_private)

(declare-const temp___2425 Int)

(define-fun temp___2426 () us_rep (mk___rep (mk___split_discrs temp___242)
                                  (mk___split_fields
                                  (mk___t temp___2421 temp___2422)
...
;; H
  (assert
  (and (dynamic_invariant1 temp___2426 true false true)
  (and (= temp___2425 us_tag)
  (and
  (let ((temp___244 (temp___218 0 1 (to_rep1 temp___242))))
  (and (= temp___2421 (elts1 temp___244))
  (= temp___2422 (mk (to_rep2 (first2 (rt1 temp___244)))
                 (to_rep2 (last2 (rt1 temp___244)))))))
  (= (to_rep temp___2423) 0)))))

(assert
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 48, characters 0-0
  (not (= (empty temp___2426) true)))
(check-sat)
(exit)
