...
(declare-const temp___142 natural)

(declare-const temp___1421 Bool)

;; H
  (assert (and (= (to_rep temp___142) 0) (= temp___1421 (of_int 0))))

;; H
  (assert (= temp___1421 true))

(assert
;; WP_parameter_def
 ;; File "p.ads", line 5, characters 0-0
  (not (< 3 (to_rep temp___142))))
(check-sat)
(exit)
