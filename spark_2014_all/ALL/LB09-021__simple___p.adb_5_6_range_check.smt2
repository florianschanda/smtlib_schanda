...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__p__s__d enum)))))
...
(declare-fun p__s__d__first__bit () Int)

(declare-fun p__s__d__last__bit () Int)

(declare-fun p__s__d__position () Int)
...
(declare-fun p__s__bool_field__first__bit () Int)

(declare-fun p__s__bool_field__last__bit () Int)

(declare-fun p__s__bool_field__position () Int)
...
(declare-fun p__s__int_field__first__bit () Int)

(declare-fun p__s__int_field__last__bit () Int)

(declare-fun p__s__int_field__position () Int)
...
(declare-fun p__s__d__first__bit1 () Int)

(declare-fun p__s__d__last__bit1 () Int)

(declare-fun p__s__d__position1 () Int)
...
(declare-fun p__s__bool_field__first__bit1 () Int)

(declare-fun p__s__bool_field__last__bit1 () Int)

(declare-fun p__s__bool_field__position1 () Int)
...
(declare-fun p__s__int_field__first__bit1 () Int)

(declare-fun p__s__int_field__last__bit1 () Int)

(declare-fun p__s__int_field__position1 () Int)
...
(declare-datatypes ()
((us_split_discrs2 (mk___split_discrs1 (rec__p__t__z enum)))))
...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__p__t__field us_rep)))))
...
(declare-fun p__t__z__first__bit () Int)

(declare-fun p__t__z__last__bit () Int)

(declare-fun p__t__z__position () Int)
...
(declare-fun p__t__field__first__bit () Int)

(declare-fun p__t__field__last__bit () Int)

(declare-fun p__t__field__position () Int)
...
(declare-fun v__split_fields () enum)
