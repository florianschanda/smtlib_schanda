...
;; H
  ...
  (= (let ((temp___604 (get_model__3
     ...
     (bool_eq (elts temp___604) (to_rep1 (first (rt temp___604)))
     ...
     (- (+ (to_rep1
           ...
           (mk___rep1
           (mk___split_fields1 s__split_fields s__split_fields1
           s__split_fields2 s__split_fields3) s__attr__tag))))) (+ (ite (<=
                                                                   (to_rep1
                                                                   (first
                                                                   (rt
                                                                   (get_model__3
...
;; WP_parameter_def
 ;; File "stackp.adb", line 32, characters 0-0
  ...
  (= (let ((temp___600 (get_model__3
                       (mk___rep1 s__split_fields8 s__attr__tag))))
     (bool_eq (elts temp___600) (to_rep1 (first (rt temp___600)))
