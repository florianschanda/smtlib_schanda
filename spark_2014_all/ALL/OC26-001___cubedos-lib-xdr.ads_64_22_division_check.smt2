...
(define-fun dynamic_invariant3 ((temp___expr_235 (_ BitVec 32))
  (temp___is_init_232 Bool) (temp___skip_constant_233 Bool)
  (temp___do_toplevel_234 Bool)) Bool true)
...
;; xdr_integer_to_unsigned__post_axiom
  ...
  (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3
     (xdr_integer_to_unsigned s) true false true)) :pattern ((xdr_integer_to_unsigned
                                                             s)) )))
