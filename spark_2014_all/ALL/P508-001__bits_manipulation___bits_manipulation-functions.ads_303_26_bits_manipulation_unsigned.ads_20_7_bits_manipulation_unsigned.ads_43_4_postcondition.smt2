...
(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result () Bool)
...
(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result1 () Bool)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result2 () Bool)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result3 () Bool)

(declare-fun i7 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result4 () Bool)

(declare-fun i8 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result5 () Bool)
...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 15)) (= i9 (mk_int__ref i3))))
...
;; H
  ...
  bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result2))
...
;; H
  (assert
  (= result1 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result5
  bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result3))
...
;; H
  (assert
  (= result2 bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result4))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__proofs__make_mask__lemma2__result4 true))
