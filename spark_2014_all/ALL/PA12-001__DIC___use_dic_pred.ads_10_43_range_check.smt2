...
;; H
  (assert
  (and
  (and (= (to_rep (rec__containers__container__c v__split_discrs)) 10)
  (= (to_rep v__split_fields) 0))
  (= (length1
     (mk___rep2 v__split_discrs
     (mk___split_fields2 v__split_fields (mk___t v__split_fields1 (mk 1 10))))) 0)))
