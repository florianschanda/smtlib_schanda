...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11
      (select (nb_blacks c86b) (parent
                               (rec__red_black_trees__rbt__struct
                               (us_split_fields9 c87b)) y1))))) n11)
  (= (rec__red_black_trees__black_count__status
     (us_split_fields11
     (select (nb_blacks c87b) (parent
                              (rec__red_black_trees__rbt__struct
                              (us_split_fields9 c87b)) y1)))) true)))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c86b) i)))) (int__content n13)))
