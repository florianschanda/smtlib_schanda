...
;; H
  ...
  (and
  (and
  (and (= (mod2 (int__content remaining_bits7) 8) (mod2 bit_length 8))
  (= (state_of (mk___rep (us_split_fields__content ctx__split_fields18))) 0))
  (< (int__content remaining_bits7) (rate_of
                                    (mk___rep
                                    (us_split_fields__content
                                    ctx__split_fields18)))))
  (= (rate_of (mk___rep (us_split_fields__content ctx__split_fields18)))
  initial_bit_rate1)))

(assert
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range7 (int__content remaining_bits7))))
(check-sat)
(exit)
