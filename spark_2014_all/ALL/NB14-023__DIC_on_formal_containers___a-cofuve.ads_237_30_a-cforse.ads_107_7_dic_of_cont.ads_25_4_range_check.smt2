...
(define-fun index_type__ref___5__projection ((a index_type__ref)) index_type
  (index_type__content a))

(define-fun dynamic_invariant ((temp___expr_1305 Int)
  (temp___is_init_1302 Bool) (temp___skip_constant_1303 Bool)
  (temp___do_toplevel_1304 Bool)) Bool (=>
                                       (or (= temp___is_init_1302 true)
...
(define-fun dynamic_invariant1 ((temp___expr_1317 Int)
...
(define-fun sequence__ref___5__projection ((a sequence__ref)) us_rep
  (sequence__content a))
...
(define-fun default_initial_assumption ((temp___expr_1324 us_rep)
  (temp___skip_top_level_1325 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1325 true))
                                          (= (length temp___expr_1324) 0)))
...
(define-fun element_type__ref___18__projection ((a element_type__ref)) element_type
