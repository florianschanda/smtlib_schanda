...
(define-fun index_type__ref_5__projection ((a index_type__ref)) index_type
...
(define-fun sequence__ref_5__projection ((a sequence__ref)) us_rep (sequence__content
                                                                   a))
...
(define-fun element_type__ref_18__projection ((a element_type__ref)) element_type
