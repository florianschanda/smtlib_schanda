...
;; H
  (assert
  (and (= o51 (rate_of (mk___rep ctx__split_fields15)))
  (and (in_range3 o51)
  (and
  (= o51 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert (= o52 (ite (= o51 initial_rate1) true false)))

;; H
  (assert
  (and (= o49 (state_of (mk___rep ctx__split_fields15)))
  (and (in_range5 o49)
  (= o49 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields15))))))
...
;; H
  (assert (= o50 (ite (= o49 1) true false)))
