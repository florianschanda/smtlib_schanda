...
;; H
  (assert
  (and (= o47 (rate_of (mk___rep ctx__split_fields15)))
  (and (in_range3 o47)
  (and
  (= o47 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
            ctx__split_fields15)) 8))
  (< o47 1600)))))

;; H
  (assert (= o48 (ite (= o47 initial_rate1) true false)))

;; H
  (assert
  (and (= o45 (state_of (mk___rep ctx__split_fields15)))
  (and (in_range5 o45)
  (= o45 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
         ctx__split_fields15))))))
...
;; H
  (assert (= o46 (ite (= o45 1) true false)))
...
;; WP_parameter_def
 ;; File "keccak-sponge.ads", line 265, characters 0-0
  (not (in_range1 (+ offset3 remaining3))))
(check-sat)
(exit)
