...
;; H
  (assert
  (and (= temp___2292 (to__ s))
  (and (dynamic_invariant temp___2292 true false true)
  (and
  (and (= (rec__stack__stack__content (us_split_fields1 s)) temp___229)
  (= (mk
     (to_rep
     (first2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))
     (to_rep
     (last2 (mk1 1 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))) 
  temp___2291))
  (and (= (to_rep (first temp___2291)) 1) (<= 0 (to_rep (last temp___2291))))))))
...
;; H
  (assert (= temp___230 (to_rep (last o4))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep (first temp___2291)) temp___230)))
(check-sat)
