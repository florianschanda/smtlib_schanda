...
(declare-fun x86__signextend16to32__result () (_ BitVec 32))

(declare-fun result () (_ BitVec 32))

(declare-fun retval1 () (_ BitVec 32))

(declare-fun result1 () (_ BitVec 32))

(declare-fun retval2 () (_ BitVec 32))

(declare-fun result2 () (_ BitVec 32))

(declare-fun x86__signextend16to32__result1 () (_ BitVec 32))

(declare-fun x86__signextend16to32__result2 () (_ BitVec 32))

(declare-fun x86__signextend16to32__result3 () (_ BitVec 32))

(declare-fun retval3 () (_ BitVec 32))

(declare-fun x86__signextend16to32__result4 () (_ BitVec 32))

(declare-fun retval4 () (_ BitVec 32))

(declare-fun x86__signextend16to32__result5 () (_ BitVec 32))
...
;; H
  (assert
  (=> (bvugt val__ ((_ int2bv 16) 32767)) (= (mk_t__ref1 result) retval5)))

;; H
  (assert
  (=> (bvugt val__ ((_ int2bv 16) 32767))
  (= retval1 (bvor ((_ int2bv 32) 4294901760) ((_ zero_extend 16) val__)))))

;; H
  (assert
  (=> (not (bvugt val__ ((_ int2bv 16) 32767)))
  (= (mk_t__ref1 result1) retval5)))

;; H
  (assert
  (=> (not (bvugt val__ ((_ int2bv 16) 32767)))
  (= retval2 ((_ zero_extend 16) val__))))

;; H
  (assert (=> (not (bvugt val__ ((_ int2bv 16) 32767))) (= retval1 retval2)))
...
;; H
  (assert
  (= (mk_t__ref1 result2) (mk_t__ref1 x86__signextend16to32__result)))
...
;; H
  (assert
  (= (mk_t__ref1 x86__signextend16to32__result4) (mk_t__ref1
                                                 x86__signextend16to32__result2)))
...
;; H
  (assert (bvugt val__ ((_ int2bv 16) 32767)))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not
  (= x86__signextend16to32__result4 (bvor ((_ int2bv 32) 4294901760) ((_ zero_extend 16)
  val__)))))
(check-sat)
(exit)
