...
(declare-const records__is_valid__result Bool)
...
(declare-const temp___277 unsigned_byte)

(declare-const temp___2771 unsigned_byte)

(declare-const result Bool)

(declare-const records__is_valid__result1 Bool)

(declare-const records__is_valid__result2 Bool)

(declare-const records__is_valid__result3 Bool)

(declare-const records__is_valid__result4 Bool)

(declare-const records__is_valid__result5 Bool)
...
;; H
  (assert (= records__is_valid__result1 records__is_valid__result2))

;; H
  (assert (= records__is_valid__result3 records__is_valid__result1))

;; H
  (assert (= result records__is_valid__result))

;; H
  (assert
  (= records__is_valid__result1 (ite (or
                                     (= (rec__records_prooffuncs__optional_pair__exists
                                        (us_split_fields3 a)) true)
                                     (= (bool_eq
                                        (rec__records_prooffuncs__optional_pair__the_pair
                                        (us_split_fields3 a)) null_pair) true))
                                true false)))

;; H
  (assert
  (= (mk_bool__ref records__is_valid__result4) (mk_bool__ref
                                               records__is_valid__result2)))

;; H
  (assert (= records__is_valid__result5 records__is_valid__result3))

;; H
  (assert (= result1 records__is_valid__result4))

;; H
  (assert (= records__is_valid__result4 true))
...
(assert
;; WP_parameter_def
 ;; File "records.adb", line 102, characters 0-0
  (not
  (= (bool_eq
