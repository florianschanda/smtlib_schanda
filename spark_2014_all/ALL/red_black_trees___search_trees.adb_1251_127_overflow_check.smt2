...
(declare-fun temp___2083 () (Array Int us_rep1))
...
(declare-fun temp___2081 () (Array Int us_rep1))
...
(declare-fun temp___2082 () (Array Int us_rep1))
...
(declare-fun temp___2080 () (Array Int us_rep1))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 o18))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 o18)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o18))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2092 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2092 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o19 (select temp___2092 l)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2083 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2083 o))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2083 o)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2083 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2083 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2083 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2083 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2083 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2083 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2083 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o1 (select temp___2083 i1)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2082 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2082 o7))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2082 o7)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o7))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2082 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2082 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2082 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2082 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2082 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2082 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2082 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o8 (select temp___2082 l)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2081 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2081 o3))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2081 o3)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o3))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2081 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2081 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2081 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2081 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2081 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2081 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2081 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o4 (select temp___2081 i1)))
...
;; H
  ...
  (and (dynamic_invariant8 temp___2080 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2080 o11))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2080 o11)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o11))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___2080 (parent
                              (mk___rep2
                              (mk___split_fields2 t_old__split_fields1
                              t_old__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2080 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2080 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2080 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___2080 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2080 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___2080 j)))) true))
  (= j i2))))))))))))))

;; H
  (assert (= o12 (select temp___2080 i1)))
