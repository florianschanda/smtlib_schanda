...
(declare-fun pred () Int)

(declare-fun i () Int)

(declare-fun stackisize () Int)
...
(declare-fun o11 () card)

(declare-fun o12 () Int)

(declare-fun o13 () (Array Int card))

(declare-fun o14 () cardindex)

(declare-fun o15 () (Array Int card))

(declare-fun o16 () cardindex)

(declare-fun o17 () (Array Int cardindex))

(declare-fun o18 () (Array Int (Array Int cardindex)))

(declare-fun o19 () (Array Int cardindex))

(declare-fun o20 () (Array Int cardindex))
...
(declare-fun o24 () cardindex)

(declare-fun o25 () cardindex)

(declare-fun o26 () (Array Int card))

(declare-fun o27 () cardindex)

(declare-fun o28 () (Array Int cardindex))

(declare-fun o29 () (Array Int (Array Int cardindex)))

(declare-fun o30 () (Array Int cardindex))

(declare-fun o31 () (Array Int cardindex))
...
(declare-fun o34 () cardindex)

(declare-fun o35 () Int)

(declare-fun o36 () (Array Int cardindex))

(declare-fun o37 () cardindex)

(declare-fun o38 () (Array Int card))

(declare-fun o39 () cardindex)

(declare-fun o40 () (Array Int cardindex))

(declare-fun o41 () (Array Int (Array Int cardindex)))

(declare-fun o42 () (Array Int cardindex))

(declare-fun o43 () (Array Int cardindex))
...
(declare-fun o46 () cardindex)

(declare-fun o47 () cardindex)

(declare-fun o48 () (Array Int card))

(declare-fun o49 () cardindex)

(declare-fun o50 () (Array Int cardindex))

(declare-fun o51 () (Array Int (Array Int cardindex)))

(declare-fun o52 () (Array Int cardindex))

(declare-fun o53 () (Array Int cardindex))
...
(declare-fun o57 () (Array Int cardindex))

(declare-fun o58 () cardindex)

(declare-fun o59 () (Array Int card))

(declare-fun o60 () cardindex)

(declare-fun o61 () (Array Int cardindex))

(declare-fun o62 () (Array Int (Array Int cardindex)))

(declare-fun o63 () (Array Int cardindex))

(declare-fun o64 () (Array Int cardindex))
...
(declare-fun o67 () cardindex)

(declare-fun o68 () (Array Int cardindex))

(declare-fun o69 () Int)

(declare-fun o70 () (Array Int (Array Int cardindex)))
...
(declare-fun o73 () cardindex)

(declare-fun o74 () Int)

(declare-fun o75 () (Array Int cardindex))
...
(declare-fun o79 () (Array Int cardindex))
...
(declare-fun o82 () cardindex)

(declare-fun o83 () Int)

(declare-fun o84 () Int)

(declare-fun o85 () cardindex)

(declare-fun o86 () Int)

(declare-fun o87 () (Array Int cardindex))
...
(declare-fun o90 () cardindex)

(declare-fun o91 () Int)

(declare-fun o92 () (Array Int cardindex))

(declare-fun o93 () Int)

(declare-fun o94 () (Array Int (Array Int cardindex)))
...
(declare-fun o97 () cardindex)

(declare-fun o98 () Int)

(declare-fun o99 () (Array Int cardindex))
...
(declare-fun o103 () (Array Int cardindex))
...
(declare-fun temp___673 () (Array Int cardindex))

(declare-fun o111 () Int)

(declare-fun o112 () cardindex)

(declare-fun temp___674 () Int)

(declare-fun o113 () Int)

(declare-fun o114 () cardindex)

(declare-fun o115 () Int)

(declare-fun o116 () Bool)

(declare-fun stackisize1 () Int)

(declare-fun topstacki1 () Int)

(declare-fun result () int__ref)

(declare-fun pred1 () Int)

(declare-fun result1 () int__ref)

(declare-fun i1 () Int)

(declare-fun pred2 () Int)

(declare-fun i2 () Int)

(declare-fun stackisize2 () Int)

(declare-fun topstacki2 () Int)

(declare-fun result2 () int__ref)

(declare-fun stackisize3 () Int)

(declare-fun result3 () int__ref)

(declare-fun topstacki3 () Int)

(declare-fun result4 () Bool)

(declare-fun result5 () int__ref)

(declare-fun pred3 () Int)

(declare-fun result6 () int__ref)

(declare-fun i3 () Int)

(declare-fun pred4 () int__ref)

(declare-fun i4 () int__ref)

(declare-fun pred5 () Int)

(declare-fun i5 () Int)

(declare-fun pred6 () int__ref)

(declare-fun i6 () int__ref)

(declare-fun stackisize4 () int__ref)

(declare-fun topstacki4 () int__ref)

(declare-fun pred7 () Int)

(declare-fun i7 () Int)

(declare-fun stackisize5 () Int)

(declare-fun topstacki5 () Int)

(declare-fun pred8 () int__ref)

(declare-fun i8 () int__ref)

(declare-fun stackisize6 () int__ref)

(declare-fun topstacki6 () int__ref)

(declare-fun pred9 () Int)

(declare-fun i9 () Int)

(declare-fun stackisize7 () Int)

(declare-fun topstacki7 () Int)
...
(declare-fun s__split_fields11 () us_split_fields)
...
(declare-fun s__split_fields13 () us_split_fields)
...
(declare-fun s__split_fields15 () us_split_fields)

(declare-fun result17 () int__ref)

(declare-fun stackisize8 () Int)
...
(declare-fun s__split_fields17 () us_split_fields)
...
(declare-fun s__split_fields19 () us_split_fields)

(declare-fun s__split_fields20 () us_split_fields__ref)

(declare-fun i11 () int__ref)

(declare-fun stackisize9 () int__ref)

(declare-fun s__split_fields21 () us_split_fields)

(declare-fun i12 () Int)

(declare-fun stackisize10 () Int)
...
;; H
  ...
  (and (<= 0 i2) (<= i2 (to_rep1 s__split_fields2)))))
...
;; H
  ...
  (= pred2 (to_rep1
           (select (select s__split_fields4 (- i2 1)) (- (to_rep1
                                                         (select s__split_fields3 (-
                                                         i2 1))) 1)))))
  (< (to_rep (select s__split_fields1 pred2)) c))
  (= (to_rep1 (select s__split_fields5 pred2)) (- i2 1))))))
...
;; H
  (assert
  (=> (< i1 (to_rep1 s__split_fields2)) (= o1 (select s__split_fields3 o))))
...
;; H
  (assert
  (=> (< i1 (to_rep1 s__split_fields2)) (= result3 (mk_int__ref topstacki2))))
...
;; H
  ...
  (or
  (and
  (and (and (= i4 (mk_int__ref i2)) (= pred4 (mk_int__ref pred2)))
  (and (= i5 i2) (= pred5 pred2)))
  (and
  (and
  (and
  ...
  (and
  (and (and (= i4 (mk_int__ref i3)) (= pred4 (mk_int__ref pred3)))
  (and (= i5 i3) (= pred5 pred3)))
  ...
  (= (to_rep1 (select s__split_fields5 topstacki3)) i2))
  (= (to_rep1 (select s__split_fields6 topstacki3)) (- stackisize3 1)))
  (and (and (= result5 (mk_int__ref pred2)) (= pred3 topstacki3))
  (and
  (and (and (= o10 (+ i2 1)) (in_range1 (+ i2 1)))
  (and (= result6 (mk_int__ref i2)) (= i3 o10)))
  (not (< i3 (to_rep1 s__split_fields2))))))))))))
...
;; H
  (assert
  (=> (not (< i1 (to_rep1 s__split_fields2)))
...
;; H
  (assert
  (=> (not (< i1 (to_rep1 s__split_fields2))) (= i8 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (< i1 (to_rep1 s__split_fields2))) (= pred8 (mk_int__ref pred1))))

;; H
  (assert
  (=> (not (< i1 (to_rep1 s__split_fields2))) (= topstacki7 topstacki1)))

;; H
  (assert
  (=> (not (< i1 (to_rep1 s__split_fields2))) (= stackisize7 stackisize1)))
...
;; H
  ...
  (= (int__content i8) (to_rep1
                       (rec__patience__state__numstacks s__split_fields10)))
  (= i10 (to_rep1 (rec__patience__state__numstacks s__split_fields10)))))
...
;; H
  ...
  (= (int__content i8) (to_rep1
                       (rec__patience__state__numstacks s__split_fields10))))
  (and (<= 0 (int__content i8)) (<= (int__content i8) 99))))
...
;; H
  ...
  (= (int__content i8) (to_rep1
                       (rec__patience__state__numstacks s__split_fields10))))
  (and (= o96 (int__content i8)) (in_range3 (int__content i8)))))
...
;; H
  ...
  (<= 1 (to_rep1
        (select (rec__patience__state__stacksizes
                (us_split_fields__content s__split_fields20)) i13))))))
...
;; H
  ...
  (<= (to_rep1
      (select (rec__patience__state__stacksizes
              (us_split_fields__content s__split_fields20)) i13)) (to_rep1
                                                                  (rec__patience__state__numelts
                                                                  (us_split_fields__content
                                                                  s__split_fields20))))
  (forall ((j Int))
  ...
  (<= j (- (to_rep1
           (select (rec__patience__state__stacksizes
                   (us_split_fields__content s__split_fields20)) i13)) 1)))
  (and
  (<= 0 (to_rep1
        (select (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20)) i13) j)))
  (< (to_rep1
     (select (select (rec__patience__state__stacks
                     (us_split_fields__content s__split_fields20)) i13) j))
  (to_rep1
  ...
  (= (to_rep1
     (select (select (rec__patience__state__stacks
                     (us_split_fields__content s__split_fields20)) (to_rep1
                                                                   ...
                                                                   (rec__patience__state__posstack
                                                                   (us_split_fields__content
                                                                   s__split_fields20)) i13)))
     (to_rep1
     (select (rec__patience__state__posheight
             (us_split_fields__content s__split_fields20)) i13)))) i13))))))
...
;; H
  (assert
  (= o106 (select (rec__patience__state__stacksizes
                  (us_split_fields__content s__split_fields20)) o105)))
...
;; H
  (assert (= o109 (ite (<= ip o108) true false)))

;; H
  (assert (= result23 (ite (<= 0 ip) o109 false)))
...
;; H
  (assert
  (= temp___673 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20))
  o110)))

;; H
  (assert (and (<= 0 ip) (<= ip 99)))

;; H
  (assert (= o111 ip))

;; H
  (assert (= o112 (select temp___673 o111)))

;; H
  (assert (= temp___674 (to_rep1 o112)))

;; H
  (assert (and (<= 0 temp___674) (<= temp___674 99)))

;; H
  (assert (= o113 temp___674))

;; H
  (assert
  (= o114 (select (rec__patience__state__posheight
                  (us_split_fields__content s__split_fields20)) o113)))

;; H
  (assert (= o115 (to_rep1 o114)))

;; H
  (assert (= o116 (ite (= ip o115) true false)))
