...
;; H
  ...
  (= (bool_eq1 use_ordered_maps__apply_f_4__cu__assume1 no_element) true)
  (and
  (= (has_key1
     (positions
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep
         (rec__use_ordered_maps__my_maps__map__capacity s__split_discrs))))))
...
;; H
  (assert (and (= o8 i) (in_range4 i)))

;; H
  (assert
  (and (= o7 (keys (mk___rep s__split_discrs s__split_fields2)))
  (and
  (and
  (and (= (length3 o7) (length (mk___rep s__split_discrs s__split_fields2)))
  (forall ((temp___396 Int))
  (=> (and (in_range4 temp___396) (= (iter_has_element o7 temp___396) true))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 o7 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true))
  (and (< 0 (find o7 key2))
  (= (equivalent_keys (get1 o7 (find o7 key2)) key2) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
  (and (= (find o7 (get1 o7 i1)) i1) (= (k_is_find o7 (get1 o7 i1) i1) true)))))))

;; H
  (assert (and (= o9 (get1 o7 o8)) (in_range5 o9)))

;; H
  (assert
  (and (= o10 (get (model__ (mk___rep s__split_discrs s__split_fields2)) o9))
  (and (in_range8 o10)
  (= o10 (get (model__ (mk___rep s__split_discrs s__split_fields2)) o9)))))
...
;; H
  ...
  (forall ((temp___396 Int))
  (=> (and (in_range4 temp___396) (= (iter_has_element o5 temp___396) true))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 o5 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) key2) true))
  (and (< 0 (find o5 key2))
  (= (equivalent_keys (get1 o5 (find o5 key2)) key2) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s__split_discrs s__split_fields2))))
  (and (= (find o5 (get1 o5 i1)) i1) (= (k_is_find o5 (get1 o5 i1) i1) true)))))))
