...
(declare-const content1 (Array Int natural))

(declare-const result1 (Array Int natural))

(declare-const content2 (Array Int natural))

(declare-const result2 Int)

(declare-const length2 Int)

(declare-const content3 (Array Int natural))

(declare-const length3 Int)

(declare-const content4 (Array Int natural))
