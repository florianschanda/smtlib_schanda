...
(declare-fun x86__ch__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__ch__result1 () (_ BitVec 8))

(declare-fun x86__ch__result2 () (_ BitVec 8))

(declare-fun x86__ch__result3 () (_ BitVec 8))

(declare-fun x86__ch__result4 () (_ BitVec 8))

(declare-fun x86__ch__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= x86__ch__result1 ((_ extract 7 0) (bvudiv (bvand rcx ((_ int2bv 64) 65280)) ((_ int2bv 64) 256)))))
