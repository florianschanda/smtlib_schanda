...
;; H
  (assert (= o30 (osubtract o28 o29)))

;; H
  (assert (= o19 (from_word32 a_msw2)))
...
;; H
  (assert
  (= o12 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
         a_first o11)))

;; H
  (assert (= o21 (oadd o12 o20)))

;; H
  (assert (= o31 (olt o21 o30)))
...
;; H
  (assert
  (and (= o (base Tuple0)) (= o (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
