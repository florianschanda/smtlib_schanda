...
(define-fun usedlogfiles__split_fields23 () us_split_fields (mk___split_fields
...
(define-fun logfileentries13 () map__ref1 (mk_map__ref1 logfileentries))

(define-fun usedlogfiles__split_fields24 () us_split_fields__ref (mk___split_fields__ref
                                                                 (mk___split_fields
...
(define-fun numberlogentries13 () int__ref (mk_int__ref numberlogentries))
...
;; H
  ...
  (and
  (and
  (and (= auditsystemfault3 auditsystemfault12)
  (and (= logfileentries4 logfileentries13)
  (and (= usedlogfiles__split_fields14 usedlogfiles__split_fields24)
  (and (= numberlogentries4 numberlogentries13)
  (and (= logfilesstatus4 logfilesstatus13) (= logfiles3 logfiles12))))))
  (and (= auditsystemfault4 auditsystemfault1)
  (and (= logfileentries5 logfileentries1)
  (and (= usedlogfiles__split_fields15 usedlogfiles__split_fields23)
...
;; H
  ...
  (= auditsystemfault7 auditsystemfault12)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= logfileentries8 logfileentries13)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= usedlogfiles__split_fields18 usedlogfiles__split_fields24)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= numberlogentries8 numberlogentries13)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= logfilesstatus8 logfilesstatus13)))

;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= logfiles7 logfiles12)))
...
;; H
  (assert
  (=> (not (< 1 (to_rep3 usedlogfiles__split_fields3)))
  (= usedlogfiles__split_fields19 usedlogfiles__split_fields23)))
...
;; WP_parameter_def
 ;; File "auditlog.ads", line 33, characters 0-0
  (not
  (= (valid_numberlogentries (map__content1 logfileentries11)
     (int__content numberlogentries11) (int__content currentlogfile3)
     (us_split_fields__content usedlogfiles__split_fields21)) true)))
(check-sat)
(exit)
