...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int2 x) 0)
     (ite (< 0 x) (pos_div_relation (to_int2 x) x 16) (pos_div_relation
     (- (to_int2 x)) (- x) 16))) :pattern ((to_int2 x)) )))
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int3 x) 0)
     (ite (< 0 x) (pos_div_relation1 (to_int3 x) x 16) (pos_div_relation1
     (- (to_int3 x)) (- x) 16))) :pattern ((to_int3 x)) )))
...
;; H
  (assert
  (=> (not (= (to_fixed1 x) 0))
  (= (to_fixed1 o) (fxp_div (to_fixed1 x) (to_fixed1 x)))))

;; H
  (assert
  (=> (not (= (to_fixed1 x) 0)) (= (mk_t__ref result1) (mk_t__ref z))))
...
;; H
  (assert (= (to_fixed1 o1) (fxp_div (to_fixed1 x) 8)))
...
;; H
  (assert (= (to_fixed1 z3) (fxp_mult 32 (to_fixed1 x))))
...
;; H
  (assert
  (and (<= (- (* (to_fixed1 z4) 2) 1) (to_fixed1 x))
  (<= (to_fixed1 x) (+ (* (to_fixed1 z4) 2) 1))))
