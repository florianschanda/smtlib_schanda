...
(define-fun r8 () model_type__ref (mk_model_type__ref r6))
...
;; H
  (assert (=> (and (<= r17b j2) (<= j2 c)) (= r8 (mk_model_type__ref r4))))
...
;; H
  (assert
  (=> (not (and (<= r17b j2) (<= j2 c))) (= r8 (mk_model_type__ref r))))
