...
(define-fun tc_pu1S__ref_5__projection ((a tc_pu1S__ref)) us_rep1 (tc_pu1S__content
                                                                  a))
...
(declare-fun r_g1__split_discrs () us_split_discrs)

(declare-fun r_g1__attr__tag () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun r_g2__split_discrs () us_split_discrs)

(declare-fun r_g2__attr__tag () Int)
...
(declare-fun r_g1__split_fields () natural)

(declare-fun r_g1__split_fields1 () us_private)

(declare-fun r_g2__split_fields () natural)

(declare-fun r_g2__split_fields1 () us_private)
...
(declare-fun record_equality__test_eq_ko_d3__g_pu1__assume () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu1__assume1 () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu1__assume2 () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu1__assume3 () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu1__assume4 () us_private)

(declare-fun record_equality__test_eq_ko_d3__g_pu1__assume5 () Int)
...
(declare-fun record_equality__test_eq_ko_d3__g_pu2__assume () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu2__assume1 () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu2__assume2 () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu2__assume3 () natural)

(declare-fun record_equality__test_eq_ko_d3__g_pu2__assume4 () us_private)

(declare-fun record_equality__test_eq_ko_d3__g_pu2__assume5 () Int)
...
(declare-fun r_g1__split_fields2 () us_split_fields)

(declare-fun result6 () us_split_fields__ref)

(declare-fun r_g2__split_fields2 () us_split_fields)
...
;; H
  (assert
  (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r14b))
...
;; H
  ...
  (= c_pu1__split_discrs (mk___split_discrs
                         record_equality__test_eq_ko_d3__g_pu1__assume)))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu1__assume1 o1))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu1__assume2 o2))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu1__assume3 o3))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu1__assume4 o4))

;; H
  (assert (= us_tag4 record_equality__test_eq_ko_d3__g_pu1__assume5))
...
;; H
  (assert
  (= record_equality__test_eq_ko_d3__g_pu1__assume1 g_pu1__split_fields4))

;; H
  (assert
  (= record_equality__test_eq_ko_d3__g_pu1__assume2 g_pu1__split_fields5))

;; H
  (assert
  (= record_equality__test_eq_ko_d3__g_pu1__assume3 g_pu1__split_fields6))

;; H
  (assert
  (= record_equality__test_eq_ko_d3__g_pu1__assume4 g_pu1__split_fields7))
...
;; H
  (assert
  (= (to_rep (rec__record_equality__root__c c_pu1__split_discrs)) r16b))
...
;; H
  (assert
  (= c_pu1__split_discrs (mk___split_discrs
                         record_equality__test_eq_ko_d3__g_pu2__assume)))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu2__assume1 o6))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu2__assume2 o7))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu2__assume3 o8))

;; H
  (assert (= record_equality__test_eq_ko_d3__g_pu2__assume4 o9))

;; H
  (assert (= us_tag5 record_equality__test_eq_ko_d3__g_pu2__assume5))
...
;; H
  ...
  (= g_pu2__split_fields4 (mk___split_fields2
                          record_equality__test_eq_ko_d3__g_pu2__assume1
                          record_equality__test_eq_ko_d3__g_pu2__assume2
                          record_equality__test_eq_ko_d3__g_pu2__assume3
                          record_equality__test_eq_ko_d3__g_pu2__assume4)))
...
;; H
  ...
  (= result5 (mk___split_fields__ref
             (mk___split_fields r_g1__split_fields r_g1__split_fields1))))

;; H
  (assert
  (= r_g1__split_fields2 (mk___split_fields g_pu1__split_fields5
                         (hide_ext__1 g_pu1__split_fields4
                         g_pu1__split_fields6 g_pu1__split_fields7))))

;; H
  (assert (= r_g1__split_discrs g_pu1__split_discrs))

;; H
  (assert (= r_g1__attr__tag g_pu1__attr__tag))

;; H
  (assert
  (= result6 (mk___split_fields__ref
             (mk___split_fields r_g2__split_fields r_g2__split_fields1))))

;; H
  (assert
  (= r_g2__split_fields2 (mk___split_fields
                         (rec__record_equality__root__f12
                         g_pu2__split_fields4)
                         (hide_ext__1
                         (rec__record_equality__grandchild__f3
                         g_pu2__split_fields4)
                         (rec__record_equality__child__f21
                         g_pu2__split_fields4)
                         (rec__ext__2 g_pu2__split_fields4)))))

;; H
  (assert (= r_g2__split_discrs g_pu2__split_discrs))

;; H
  (assert (= r_g2__attr__tag g_pu2__attr__tag))

(assert
;; WP_parameter_def
 ;; File "record_equality.adb", line 33, characters 0-0
  (not
  (= (ite (= r_g1__attr__tag r_g2__attr__tag)
     (us_dispatch_eq
     (mk___rep r_g1__split_discrs r_g1__split_fields2 r_g1__attr__tag)
     (mk___rep r_g2__split_discrs r_g2__split_fields2 r_g2__attr__tag))
     false) true)))
(check-sat)
(exit)
