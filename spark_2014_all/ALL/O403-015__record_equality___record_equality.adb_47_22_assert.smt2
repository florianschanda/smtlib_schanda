...
(declare-const r_g1__split_fields natural)

(declare-const r_g1__split_fields1 us_private)

(declare-const r_g2__split_fields natural)

(declare-const r_g2__split_fields1 us_private)
...
(declare-const record_equality__test_eq_ko_d3__g_pu1__assume natural)

(declare-const record_equality__test_eq_ko_d3__g_pu1__assume1 natural)

(declare-const record_equality__test_eq_ko_d3__g_pu1__assume2 natural)

(declare-const record_equality__test_eq_ko_d3__g_pu1__assume3 natural)

(declare-const record_equality__test_eq_ko_d3__g_pu1__assume4 us_private)

(declare-const record_equality__test_eq_ko_d3__g_pu1__assume5 Int)
...
(declare-const record_equality__test_eq_ko_d3__g_pu2__assume natural)

(declare-const record_equality__test_eq_ko_d3__g_pu2__assume1 natural)

(declare-const record_equality__test_eq_ko_d3__g_pu2__assume2 natural)

(declare-const record_equality__test_eq_ko_d3__g_pu2__assume3 natural)

(declare-const record_equality__test_eq_ko_d3__g_pu2__assume4 us_private)

(declare-const record_equality__test_eq_ko_d3__g_pu2__assume5 Int)
...
(declare-const r_g1__split_fields2 us_split_fields)

(declare-const result6 us_split_fields__ref)

(declare-const r_g2__split_fields2 us_split_fields)
