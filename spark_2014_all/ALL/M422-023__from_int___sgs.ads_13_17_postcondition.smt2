...
;; c__def_axiom
  (assert
  (forall ((x Int))
  (! (=> (dynamic_invariant x true true true) (= (c x) (of_int RNE1 x))) :pattern (
  (c x)) )))
...
(declare-fun sgs__a__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun sgs__a__result1 () t)

(declare-fun sgs__a__result2 () t)

(declare-fun sgs__a__result3 () t)

(declare-fun sgs__a__result4 () t)

(declare-fun sgs__a__result5 () t)
...
;; H
  (assert (and (= o (c x)) (and (tqtisFinite o) (= o (of_int RNE1 x)))))
...
;; WP_parameter_def
 ;; File "sgs.ads", line 3, characters 0-0
  (not (le fliteral2 sgs__a__result4)))
(check-sat)
