...
;; range_axiom
  (assert
  (forall ((x bits_14)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
;; range_int_axiom
  (assert
  (forall ((x bits_14)) (! (in_range_int1
  (to_int5 x)) :pattern ((to_int5 x)) )))

(declare-datatypes ((us_split_fields 0))
(((mk___split_fields
  (rec__dw1000__register_types__otp_stat_type__otpprgd bits_1)(rec__dw1000__register_types__otp_stat_type__otpvpok bits_1)(rec__dw1000__register_types__otp_stat_type__reserved bits_14)))))
(define-fun us_split_fields_OTPPRGD__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__otp_stat_type__otpprgd a))

(define-fun us_split_fields_OTPVPOK__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__otp_stat_type__otpvpok a))

(define-fun us_split_fields_Reserved__21__projection ((a us_split_fields)) bits_14
  (rec__dw1000__register_types__otp_stat_type__reserved a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___76__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___76__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (and
                        (= (to_rep2
                           (rec__dw1000__register_types__otp_stat_type__otpprgd
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__otp_stat_type__otpprgd
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__otp_stat_type__otpvpok
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__otp_stat_type__otpvpok
                                                  (us_split_fields1 b)))))
                        (= (to_rep3
                           (rec__dw1000__register_types__otp_stat_type__reserved
...
;; dw1000__register_types__otp_stat_type__otpprgd__first__bit_axiom
  (assert (<= 0 dw1000__register_types__otp_stat_type__otpprgd__first__bit))

;; dw1000__register_types__otp_stat_type__otpprgd__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_stat_type__otpprgd__first__bit dw1000__register_types__otp_stat_type__otpprgd__last__bit))

;; dw1000__register_types__otp_stat_type__otpprgd__position_axiom
...
;; dw1000__register_types__otp_stat_type__otpvpok__first__bit_axiom
  (assert (<= 0 dw1000__register_types__otp_stat_type__otpvpok__first__bit))

;; dw1000__register_types__otp_stat_type__otpvpok__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_stat_type__otpvpok__first__bit dw1000__register_types__otp_stat_type__otpvpok__last__bit))

;; dw1000__register_types__otp_stat_type__otpvpok__position_axiom
...
;; dw1000__register_types__otp_stat_type__reserved__first__bit_axiom
  (assert (<= 0 dw1000__register_types__otp_stat_type__reserved__first__bit))

;; dw1000__register_types__otp_stat_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__otp_stat_type__reserved__first__bit dw1000__register_types__otp_stat_type__reserved__last__bit))

;; dw1000__register_types__otp_stat_type__reserved__position_axiom
...
(declare-datatypes ((otp_stat_type__ref 0))
(((mk_otp_stat_type__ref (otp_stat_type__content us_rep)))))
(define-fun otp_stat_type__ref___projection ((a otp_stat_type__ref)) us_rep
  (otp_stat_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___187__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___131__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___131__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6491 us_t1)
  (temp___is_init_6488 Bool) (temp___skip_constant_6489 Bool)
  (temp___do_toplevel_6490 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6489 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6491)
                                       (last3 temp___expr_6491))
                                       (and (= (first3 temp___expr_6491) 1)
                                       (= (last3 temp___expr_6491) 2)))))
...
(define-fun target__ref___57__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___57__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_6509 us_t2)
  (temp___is_init_6506 Bool) (temp___skip_constant_6507 Bool)
  (temp___do_toplevel_6508 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6507 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6509)
                                       (last5 temp___expr_6509))
                                       (and (= (first5 temp___expr_6509) 1)
                                       (= (last5 temp___expr_6509) 2)))))
...
;; H
  (assert
  (and (= temp___81252 (register_to_bytes reg)) (dynamic_invariant1
  temp___81252 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___81251)) (to_rep (last4 temp___81251)))
     (+ (- (to_rep (last4 temp___81251)) (to_rep (first4 temp___81251))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___81251)) (to_rep (last4 temp___81251)))
  temp___81261))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___81261)) (to_rep (last2 temp___81261)))
     (+ (- (to_rep (last2 temp___81261)) (to_rep (first2 temp___81261))) 1)
