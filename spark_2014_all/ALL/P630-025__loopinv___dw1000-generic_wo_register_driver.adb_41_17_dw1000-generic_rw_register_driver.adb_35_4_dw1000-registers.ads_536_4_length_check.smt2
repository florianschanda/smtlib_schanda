...
(define-fun us_split_fields_Reserved21__projection ((a us_split_fields)) bits_14
  (rec__dw1000__register_types__otp_stat_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_76__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_76__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(declare-fun dw1000__register_types__otp_stat_type__otpprgd__first__bit () Int)

(declare-fun dw1000__register_types__otp_stat_type__otpprgd__last__bit () Int)

(declare-fun dw1000__register_types__otp_stat_type__otpprgd__position () Int)
...
(declare-fun dw1000__register_types__otp_stat_type__otpvpok__first__bit () Int)

(declare-fun dw1000__register_types__otp_stat_type__otpvpok__last__bit () Int)

(declare-fun dw1000__register_types__otp_stat_type__otpvpok__position () Int)
...
(declare-fun dw1000__register_types__otp_stat_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__otp_stat_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__otp_stat_type__reserved__position () Int)
...
(define-fun register_type__ref_187__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_131__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_131__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6373 us_t1)
  (temp___is_init_6370 Bool) (temp___skip_constant_6371 Bool)
  (temp___do_toplevel_6372 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6371 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6373)
                                       (last3 temp___expr_6373))
                                       (and (= (first3 temp___expr_6373) 1)
                                       (= (last3 temp___expr_6373) 2)))))
...
(define-fun target__ref_57__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_57__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_6391 us_t2)
  (temp___is_init_6388 Bool) (temp___skip_constant_6389 Bool)
  (temp___do_toplevel_6390 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6389 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6391)
                                       (last5 temp___expr_6391))
                                       (and (= (first5 temp___expr_6391) 1)
                                       (= (last5 temp___expr_6391) 2)))))
...
(declare-fun temp___7975 () (Array Int bits_8))

(declare-fun temp___79751 () t2)

(declare-fun temp___7976 () (Array Int bits_8))

(declare-fun temp___79761 () t1)

(define-fun temp___79752 () us_t2 (mk___t2 temp___7975 temp___79751))
...
;; H
  (assert
  (and (= temp___79752 (register_to_bytes reg)) (dynamic_invariant1
  temp___79752 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79751)) (to_rep (last4 temp___79751)))
     (+ (- (to_rep (last4 temp___79751)) (to_rep (first4 temp___79751))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))

;; H
  (assert (= temp___7975 temp___7976))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79751)) (to_rep (last4 temp___79751)))
  temp___79761))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___79761)) (to_rep (last2 temp___79761)))
     (+ (- (to_rep (last2 temp___79761)) (to_rep (first2 temp___79761))) 1)
