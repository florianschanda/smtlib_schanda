...
;; WP_parameter_def
 ;; File "t.adb", line 6, characters 0-0
  (not
  (<= (+ (+ (+ (+ (+ 0 (ite (= (ite (= (= x ((_ int2bv 8) 0)) true) (=
                               y ((_ int2bv 8) 0)) false) true)
                       1 0)) (ite (= (ite (= (not (= x ((_ int2bv 8) 0))) true) (=
                                     y ((_ int2bv 8) 0)) false) true)
                             1 0)) (ite (= (ite (= (= x ((_ int2bv 8) 0)) true) (not (=
                                           y ((_ int2bv 8) 0))) false) true)
                                   1 0)) (ite (= (ite (= (= x ((_ int2bv 8) 2)) true) (=
                                                 y ((_ int2bv 8) 4)) false) true)
                                         1 0)) (ite (= (ite (= (= x ((_ int2bv 8) 4)) true) (=
                                                       y ((_ int2bv 8) 2)) false) true)
                                               1 0)) 1)))
(check-sat)
(exit)
