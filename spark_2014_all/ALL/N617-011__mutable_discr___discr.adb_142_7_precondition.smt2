...
(declare-fun d1__split_discrs () natural)

(declare-fun d2__split_fields () us_main_type)

(declare-fun discr__p4__d1__assume () natural)

(declare-fun discr__p4__d1__assume1 () us_main_type)

(declare-fun discr__p4__d1__assume2 () Bool)
...
(declare-fun discr__p4__d2__assume () natural)

(declare-fun discr__p4__d2__assume1 () us_main_type)

(declare-fun discr__p4__d2__assume2 () Bool)

(declare-fun result () us_main_type)

(declare-fun d1__split_fields1 () us_main_type)

(declare-fun result1 () us_split_discrs__ref)

(declare-fun d1__split_discrs1 () us_split_discrs)

(declare-fun result2 () us_split_fields__ref)

(declare-fun d2__split_fields1 () us_split_fields)

(declare-fun discr__p4__nested1__d__discrs () us_split_discrs)

(declare-fun discr__p4__nested1__d__fields () us_split_fields)

(declare-fun result3 () us_split_fields__ref)

(declare-fun d2__split_fields2 () us_split_fields)
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs discr__p4__d2__assume)
     (mk___split_fields discr__p4__d2__assume1) discr__p4__d2__assume2)
  o6))

;; H
  (assert
  (= result2 (mk___split_fields__ref (mk___split_fields d2__split_fields))))
...
;; H
  (assert
  (and
  (= c (to_rep (rec__private_discr__p_with_default__c d2__split_discrs)))
  (= d2__attr__constrained true)))

;; H
  (assert (= result3 (mk___split_fields__ref d2__split_fields1)))

;; H
  (assert (= d2__split_fields2 discr__p4__nested1__d__fields))

;; H
  (assert
  (=> (= d2__attr__constrained true)
  (= discr__p4__nested1__d__discrs d2__split_discrs)))

(assert
;; WP_parameter_def
 ;; File "discr.adb", line 111, characters 0-0
  (not (not (= d2__attr__constrained true))))
(check-sat)
(exit)
