...
(declare-const dw1000__register_types__agc_tune3_type__agc_tune3__first__bit Int)

(declare-const dw1000__register_types__agc_tune3_type__agc_tune3__last__bit Int)

(declare-const dw1000__register_types__agc_tune3_type__agc_tune3__position Int)
...
(declare-datatypes ((agc_tune3_type__ref 0))
...
(define-fun tregister_byte_arrayP1__ref___48__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___48__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3614 us_t1)
  (temp___is_init_3611 Bool) (temp___skip_constant_3612 Bool)
  (temp___do_toplevel_3613 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3612 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3614)
                                       (last3 temp___expr_3614))
                                       (and (= (first3 temp___expr_3614) 1)
                                       (= (last3 temp___expr_3614) 2)))))
...
(define-fun target__ref___20__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___20__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_3630 us_t2)
  (temp___is_init_3627 Bool) (temp___skip_constant_3628 Bool)
  (temp___do_toplevel_3629 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3628 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_3630)
                                       (last5 temp___expr_3630))
                                       (and (= (first5 temp___expr_3630) 1)
                                       (= (last5 temp___expr_3630) 2)))))
...
(declare-const temp___7847 (Array Int bits_8))

(declare-const temp___78471 t2)

(define-fun temp___78472 () us_t2 (mk___t2 temp___7847 temp___78471))
...
;; H
  (assert
  (and (= temp___78472 (register_to_bytes reg)) (dynamic_invariant1
  temp___78472 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___78471)) (to_rep (last4 temp___78471)))
     (+ (- (to_rep (last4 temp___78471)) (to_rep (first4 temp___78471))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
