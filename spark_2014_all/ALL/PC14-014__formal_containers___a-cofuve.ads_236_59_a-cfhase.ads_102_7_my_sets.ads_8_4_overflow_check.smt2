...
(define-fun dynamic_invariant ((temp___expr_367 Int)
...
(define-fun default_initial_assumption ((temp___expr_386 us_rep)
  (temp___skip_top_level_387 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_387 true))
                                         (= (length temp___expr_386) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_373 Int)
