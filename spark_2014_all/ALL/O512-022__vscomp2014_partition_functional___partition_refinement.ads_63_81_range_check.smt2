...
;; H
  (assert
  (and (= o7 (has_key (positions x) c))
  (= (= o7 true) (= (has_key (positions x) c) true))))
...
;; H
  ...
  (forall ((j2 Int))
  (=> (and (<= 0 j2) (<= j2 5))
  (and (<= 0 (to_rep4 (select f j2)))
  (<= (to_rep4 (select f j2)) (- (length1
...
;; H
  ...
  (<= (to_rep2
      ...
      (get5
      (model__2
      (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j2)))) k)
  (<= k (to_rep2
        (rec__partition_refinement__interval__last
        (us_split_fields9
        (get5
        (model__2
        (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j2))))))
  (= (to_rep4 (select f k)) j2)))))))
