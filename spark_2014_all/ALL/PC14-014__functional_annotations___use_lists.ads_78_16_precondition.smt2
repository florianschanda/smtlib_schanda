...
;; H
  (assert
  (and (= result (has_key o4 fst))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o4 k) true) (= (bool_eq1 k fst) true))) (= result true)))))
...
;; H
  (assert
  (and (= result1 (has_key o3 lst))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o3 k) true) (= (bool_eq1 k lst) true))) (= result1 true)))))
...
;; H
  ...
  (and (in_range4 o2)
  (=> (= (of_int 0) true)
  (and (= o2 (w_get o1 (witness o1 fst)))
  (forall ((k us_rep1))
  (=> (= (has_key o1 k) true)
  (= (= (bool_eq1 k fst) true) (= (witness o1 fst) (witness o1 k))))))))))
