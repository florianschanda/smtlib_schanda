...
(((mk___split_fields
  (rec__dw1000__register_types__lde_ppindx_type__lde_ppindx bits_16)))))
(define-fun us_split_fields_LDE_PPINDX__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__lde_ppindx_type__lde_ppindx a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_82__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_82__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__lde_ppindx_type__lde_ppindx
...
;; dw1000__register_types__lde_ppindx_type__lde_ppindx__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__lde_ppindx_type__lde_ppindx__first__bit))

;; dw1000__register_types__lde_ppindx_type__lde_ppindx__last__bit_axiom
  (assert
  (< dw1000__register_types__lde_ppindx_type__lde_ppindx__first__bit
  dw1000__register_types__lde_ppindx_type__lde_ppindx__last__bit))

;; dw1000__register_types__lde_ppindx_type__lde_ppindx__position_axiom
  (assert
  (<= 0 dw1000__register_types__lde_ppindx_type__lde_ppindx__position))

(declare-fun user_eq5 (us_rep us_rep) Bool)

(declare-const dummy5 us_rep)

(declare-datatypes ((lde_ppindx_type__ref 0))
(((mk_lde_ppindx_type__ref (lde_ppindx_type__content us_rep)))))
(define-fun lde_ppindx_type__ref___projection ((a lde_ppindx_type__ref)) us_rep
  (lde_ppindx_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_199__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_140__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_140__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6624 us_t1)
  (temp___is_init_6621 Bool) (temp___skip_constant_6622 Bool)
  (temp___do_toplevel_6623 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6622 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6624)
                                       (last3 temp___expr_6624))
                                       (and (= (first3 temp___expr_6624) 1)
                                       (= (last3 temp___expr_6624) 2)))))
