...
(define-fun us_split_fields__ref___82__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___82__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun register_type__ref___199__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___140__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___140__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6750 us_t1)
  ...
  (temp___do_toplevel_6749 Bool)) Bool (=>
                                       ...
                                       (first3 temp___expr_6750)
                                       (last3 temp___expr_6750))
                                       (and (= (first3 temp___expr_6750) 1)
                                       (= (last3 temp___expr_6750) 2)))))
