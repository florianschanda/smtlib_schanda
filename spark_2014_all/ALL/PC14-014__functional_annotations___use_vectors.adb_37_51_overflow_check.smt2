...
;; H
  (assert
  (and (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o1))
  (and (in_range5 o2)
  (= o2 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o1)))))
...
;; H
  (assert
  (and (= o4 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o3))
  (and (in_range5 o4)
  (= o4 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o3)))))
