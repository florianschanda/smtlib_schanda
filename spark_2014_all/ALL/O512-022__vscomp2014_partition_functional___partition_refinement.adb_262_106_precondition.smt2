...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant1 key2 true true true)
     ...
     (= (bool_eq5 result no_element1) true))
     (and
...
;; user_eq__def_axiom
  (assert
  (forall ((a us_rep5) (b us_rep5))
  (! (= (user_eq18 a b) (oeq a b)) :pattern ((user_eq18 a b)) )))
...
(define-fun element_type__ref___8__projection ((a element_type__ref2)) us_rep9
...
(define-fun element_type__ref___9__projection ((a element_type__ref3)) us_rep9
...
(define-fun element_type__ref___2__projection ((a element_type__ref4)) element_type2
...
(define-fun element_type__ref___3__projection ((a element_type__ref5)) element_type3
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq24 a b) (oeq5 a b)) :pattern ((user_eq24 a b)) )))
...
;; H
  ...
  (<= (to_rep2
      ...
      (get5
      (model__2
      (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j1)))) k1)
  (<= k1 (to_rep2
         (rec__partition_refinement__interval__last
         (us_split_fields9
         (get5
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 5))
  (= (to_rep (select a1 k1)) (ite (= k1 (get4
                                        (model__1
                                        (mk___rep3 d__split_discrs
...
;; H
  ...
  (=>
  (and (<= 0 j1)
  (<= j1 (- (length1 (mk___rep5 p__split_discrs p__split_fields2)) 1)))
  (forall ((k1 Int))
  (=>
  (and
  (<= (to_rep2
      (rec__partition_refinement__interval__first
      (us_split_fields9
      (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j1)))) k1)
  (<= k1 (to_rep2
         (rec__partition_refinement__interval__last
         (us_split_fields9
         (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j1))))))
  (= (to_rep4 (select f k1)) j1))))))

;; H
  (assert
  (and (= o1 (length1 (mk___rep5 p__split_discrs p__split_fields2)))
  (and (in_range11 o1)
  (<= o1 (capacity (mk___rep5 p__split_discrs p__split_fields2))))))
...
;; H
  (assert
  (and
  (= o6 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) o5))
  (= (bool_eq10 o6
     (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) o5)) true)))
