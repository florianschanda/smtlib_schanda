...
(define-fun index_type__ref___7__projection ((a index_type__ref)) index_type
...
(define-fun extended_index__ref___7__projection ((a extended_index__ref)) extended_index
...
(define-fun sequence__ref___6__projection ((a sequence__ref)) us_rep
  (sequence__content a))
