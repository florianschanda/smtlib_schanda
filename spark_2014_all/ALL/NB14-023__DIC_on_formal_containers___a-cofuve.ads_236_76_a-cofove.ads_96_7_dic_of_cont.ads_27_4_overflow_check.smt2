...
(define-fun index_type__ref_7__projection ((a index_type__ref)) index_type
  (index_type__content a))

(define-fun dynamic_invariant ((temp___expr_1518 Int)
  (temp___is_init_1515 Bool) (temp___skip_constant_1516 Bool)
  (temp___do_toplevel_1517 Bool)) Bool (=>
                                       (or (= temp___is_init_1515 true)
...
(define-fun extended_index__ref_7__projection ((a extended_index__ref)) extended_index
  (extended_index__content a))

(define-fun dynamic_invariant1 ((temp___expr_1530 Int)
...
(define-fun sequence__ref_6__projection ((a sequence__ref)) us_rep (sequence__content
                                                                   a))
...
(define-fun default_initial_assumption ((temp___expr_1537 us_rep)
  (temp___skip_top_level_1538 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1538 true))
                                          (= (length temp___expr_1537) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_1524 Int)
