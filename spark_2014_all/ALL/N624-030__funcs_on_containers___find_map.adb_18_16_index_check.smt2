...
;; H
  (assert (=> (= result5 true) (= o12 i)))

;; H
  (assert (=> (= result5 true) (= o13 (select (elts a) o12))))

;; H
  (assert (=> (= result5 true) (= o14 (to_rep o13))))
...
;; H
  (assert (=> (= result5 true) (= o16 (ite (<= o15 i) true false))))
...
;; H
  (assert (=> (= result5 true) (= o8 i)))

;; H
  (assert (=> (= result5 true) (= o9 (select (elts a) o8))))

;; H
  (assert (=> (= result5 true) (= o10 (to_rep o9))))
...
;; H
  (assert
  (=> (= result5 true)
  (= o17 (ite (<= (to_rep1 (first (rt a))) o11) true false))))

;; H
  (assert (=> (= result5 true) (= result4 (ite (= o17 true) o16 false))))
...
;; WP_parameter_def
 ;; File "find_map.ads", line 23, characters 0-0
  (not (<= (to_rep1 (first (rt a))) temp___707)))
(check-sat)
(exit)
