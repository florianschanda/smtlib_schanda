...
;; H
  (assert
  (and
  (= o27 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o28))) (- (to_rep2 (last (rt o26))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o27 1)))
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (+ o27 1) k) (<= k (to_rep2 (last (rt o26)))))
  (= (to_rep (select (elts o26) k)) (to_rep (select (elts o28) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o27 k) (<= k (- (to_rep2 (last (rt o26))) 1)))
