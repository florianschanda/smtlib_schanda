...
;; H
  ...
  (<= j1 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))
  (= temp___994 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= i3 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
  (= temp___984 (mk___rep1 result____split_discrs result____split_fields3)))))
