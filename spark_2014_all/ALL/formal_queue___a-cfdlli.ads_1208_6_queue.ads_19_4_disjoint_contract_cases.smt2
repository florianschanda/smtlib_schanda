...
(declare-const temp___437 count_type)
...
;; H
  (assert (= temp___437 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___437)) no_element))
...
;; H
  ...
  (= (bool_eq1 before no_element) true))
  (= (has_key
     (positions
     (mk___rep container__split_discrs
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1118, characters 0-0
  (not
  (<= (+ (+ 0 (ite (= (bool_eq1 before position) true) 1 0)) (ite (=
                                                             (bool_eq1
                                                             before
                                                             no_element) true)
                                                             1 0)) 1)))
