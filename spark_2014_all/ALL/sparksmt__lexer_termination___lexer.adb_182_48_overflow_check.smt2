...
(declare-fun dummy5 () read_status)
...
(declare-fun s__split_fields1 () us_main_type1)

(declare-fun the_file1 () us_rep)

(declare-fun current_read__split_fields1 () character)

(declare-fun current_read__split_discrs1 () read_status)
...
(declare-fun next_read__split_fields1 () character)

(declare-fun next_read__split_discrs1 () read_status)

(declare-fun next_idx1 () Int)

(declare-fun the_file2 () us_rep)

(declare-fun current_read__split_fields2 () us_split_fields__ref)

(declare-fun current_read__split_discrs2 () us_split_discrs__ref)

(declare-fun current_line2 () int__ref)

(declare-fun current_col2 () int__ref)

(declare-fun current_idx2 () int__ref)

(declare-fun next_read__split_fields2 () us_split_fields__ref)

(declare-fun next_read__split_discrs2 () us_split_discrs__ref)

(declare-fun next_idx2 () int__ref)

(declare-fun s__split_fields2 () us_split_fields__ref1)
...
;; H
  ...
  (and
  (and
  (= (local_invariant the_file1 current_read__split_fields4
     current_read__split_discrs4 current_idx1 next_read__split_fields4
     next_read__split_discrs4 next_idx1) true)
  (= (bool_eq1
  ...
  current_idx1)) (in_range2 next_idx1))))
...
;; H
  (assert
  (= current_read__split_fields2 (mk___split_fields__ref
...
;; H
  ...
  (= (to_rep1
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs2))) 0)
  (and (= o (+ current_idx 1)) (in_range1 (+ current_idx 1)))))
...
;; H
  ...
  (= (to_rep1
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs2))) 0)
  (= o1 (ite (= (int__content current_idx2) o) true false))))
...
;; H
  ...
  (= (to_rep1
     (rec__file_io__read_result__status
     (us_split_discrs__content current_read__split_discrs2))) 0))
  (= o1 (ite (= (int__content current_idx2) current_idx) true false))))
