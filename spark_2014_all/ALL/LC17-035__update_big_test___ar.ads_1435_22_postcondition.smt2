...
(declare-fun temp___7908 () (Array Int et1))

(declare-fun temp___79081 () enum2t)
...
(declare-fun temp___7910 () (Array Int et1))

(declare-fun temp___79101 () enum2t)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1428, characters 0-0
