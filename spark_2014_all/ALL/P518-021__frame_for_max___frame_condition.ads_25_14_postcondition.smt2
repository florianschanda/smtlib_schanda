...
;; H
  ...
  (=> (and (<= first3 i) (<= i k13))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a12 i))))
  max15)))
  (forall ((i Int))
  (=> (and (<= k13 i) (<= i first3))
  (<= (to_rep
  ...
  (and
  (forall ((i Int))
  (=> (and (<= k13 i) (<= i (to_rep1 a__last)))
  (forall ((j Int))
  (=> (and (<= i j) (<= j (to_rep1 a__last)))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a12 j))))
  (to_rep
  (rec__frame_condition__cell__max_right (us_split_fields1 (select a12 i)))))))))
  (forall ((i Int))
  (=> (and (<= (to_rep1 a__first) i) (<= i (to_rep1 a__last)))
  (= (to_rep
     (rec__frame_condition__cell__max_left (us_split_fields1 (select a12 i))))
  (to_rep
  (rec__frame_condition__cell__max_left
  (us_split_fields1 (select temp___264 i))))))))))
  (and
  (and
  (and
  (and
