...
(declare-fun v (Bool) t)

(declare-fun v__function_guard (t Bool) Bool)
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral2) (/ 100000001490116119384765625.0 1000000000000000000000000000.0))))

;; v__def_axiom
  (assert
  (forall ((b Bool))
  (! (= (v b) (ite (= b true) fliteral2 (neg fliteral2))) :pattern ((v b)) )))
...
;; H
  ...
  (and (= o (v (of_int1 1)))
  (and (tqtisFinite o)
  (= o (ite (= (of_int1 1) true) fliteral2 (neg fliteral2))))))
...
;; H
  ...
  (and (= o1 (v (of_int1 0)))
  (and (tqtisFinite o1)
  (= o1 (ite (= (of_int1 0) true) fliteral2 (neg fliteral2))))))
...
;; H
  (assert (eq x1 fliteral2))

(assert
;; WP_parameter_def
 ;; File "u.adb", line 7, characters 0-0
  (not (eq y1 (neg fliteral2))))
(check-sat)
