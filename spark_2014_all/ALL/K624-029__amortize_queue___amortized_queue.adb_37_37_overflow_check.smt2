...
;; H
  (assert
  (= result____split_fields5 amortized_queue__my_vectors__append__2__container__fields3))
...
;; H
  ...
  (length (mk___rep result____split_discrs result____split_fields5)) 1))
  (= (olt (model__ (mk___rep result____split_discrs result____split_fields5))
     (model__
     (mk___rep result____split_discrs
  ...
  (= (get
     ...
     amortized_queue__my_vectors__append__2__container__fields2))
     (+ (last
        (model__ (mk___rep result____split_discrs result____split_fields5))) 1))
  o2)))
...
;; H
  (assert
  (= (get (model__ (mk___rep result____split_discrs result____split_fields4))
     1) left))
...
;; H
  (assert (and (= o3 i) (in_range4 i)))

;; H
  (assert
  (and (= o4 (get (model__ right) o3))
  (and (in_range7 o4) (= o4 (get (model__ right) o3)))))
