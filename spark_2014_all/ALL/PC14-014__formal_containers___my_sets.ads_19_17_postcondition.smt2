...
(declare-fun my_sets__my_eq__result () Bool)

(declare-fun result () Bool)

(declare-fun my_sets__my_eq__result1 () Bool)

(declare-fun my_sets__my_eq__result2 () Bool)

(declare-fun my_sets__my_eq__result3 () Bool)

(declare-fun my_sets__my_eq__result4 () Bool)

(declare-fun my_sets__my_eq__result5 () Bool)
...
;; H
  (assert
  (= my_sets__my_eq__result1 (ite (= (to_rep
...
;; H
  (assert
  (= (mk_bool__ref my_sets__my_eq__result4) (mk_bool__ref
                                            my_sets__my_eq__result2)))
...
(assert
;; WP_parameter_def
 ;; File "my_sets.ads", line 18, characters 0-0
  (not
  (= (to_rep (rec__my_sets__my_rec__f (us_split_fields1 x))) (to_rep
                                                             (rec__my_sets__my_rec__f
                                                             (us_split_fields1
                                                             y))))))
(check-sat)
