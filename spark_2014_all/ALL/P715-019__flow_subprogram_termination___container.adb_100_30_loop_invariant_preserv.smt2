...
(declare-fun x38 () int__ref)

(declare-fun r11 () int__ref)

(declare-fun b23 () bool__ref)

(declare-fun e29 () int__ref)

(declare-fun i15 () int__ref)

(declare-fun temp___5933 () cursor__ref)

(declare-fun temp___5902 () int__ref)
...
(declare-fun temp___5934 () us_rep1)

(declare-fun temp___5903 () Int)

(declare-fun rho8 () Int)

(declare-fun rho9 () Int)
...
;; H
  (assert
  (= temp___5933 (let ((subject temp___593)) (mk_cursor__ref temp___5932))))
