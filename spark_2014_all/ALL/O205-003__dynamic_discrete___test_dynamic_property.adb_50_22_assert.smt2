...
(declare-fun test_dynamic_property__dyn_param__x () Int)
...
(declare-fun test_dynamic_property__dyn_param__x1 () Int)
...
;; H
  (assert
  (and (= us2 test_dynamic_property__dyn_param__x1) (dynamic_property1 0
  last1 test_dynamic_property__dyn_param__x1)))
