...
(declare-fun temp___1427 () digit_index_type)

(declare-fun temp___14271 () (Array Int octet))

(declare-fun temp___14272 () t)

(declare-fun temp___1426 () (_ BitVec 16))

(declare-fun temp___1425 () (_ BitVec 16))

(declare-fun temp___1424 () (_ BitVec 16))
...
(declare-fun temp___1423 () us_rep)
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (and (= result____split_discrs (mk___split_discrs temp___1427))
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___14271 temp___14272))))))
...
;; H
  ...
  (and
  (= (rec__aco__math__very_longs__very_long__octet_length
     result____split_discrs) temp___1427)
  ...
  (= (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             result____split_fields3)) temp___1429) (select temp___14271 temp___1429)))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1423 (mk___rep result____split_discrs o17))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields1 temp___1423))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs1 temp___1423))))
