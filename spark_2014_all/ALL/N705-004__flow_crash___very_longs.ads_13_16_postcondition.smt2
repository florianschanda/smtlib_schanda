...
(declare-fun temp___833 () digit_index_type)

(declare-fun temp___8331 () (Array Int octet))

(declare-fun temp___8332 () t1)
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b))
  (and (= result____split_discrs (mk___split_discrs temp___833))
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___8331 temp___8332))))))
...
;; H
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___835) (select temp___8331 temp___835))))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b)) (= o10 (mk___split_fields1 o9))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b))
  (= temp___832 (mk___rep1 result____split_discrs o10))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b))
  (= result____split_fields4 (us_split_fields3 temp___832))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b))
  (= result____split_discrs (us_split_discrs2 temp___832))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b)) (= result4 (mk_int__ref temp2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b)) (= temp3 (div1 temp2 256))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b)) (= index3 (mk_int__ref index2))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r28b)) (= temp4 (mk_int__ref temp3))))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 85, characters 0-0
  ...
  (= (to_rep
     (rec__very_longs__very_long__octet_length
     (us_split_discrs1
     (very_long__content very_longs__make_from_natural__result6)))) octet_length)))
(check-sat)
(exit)
