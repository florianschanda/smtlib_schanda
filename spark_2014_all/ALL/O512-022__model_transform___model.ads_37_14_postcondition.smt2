...
(declare-fun dummy () uml_state_access)
...
(declare-fun self__split_fields () uml_state_access)

(declare-fun self__split_fields1 () uml_state_access)

(declare-fun o () uml_state_access)

(declare-fun o1 () uml_state_access)
...
(declare-fun result1 () uml_state_access)

(declare-fun self__split_fields2 () uml_state_access)

(declare-fun self__split_fields3 () uml_state_access)

(declare-fun self__split_fields4 () uml_state_access)

(declare-fun self__split_fields5 () uml_state_access)

(declare-fun self__split_fields6 () uml_state_access)

(declare-fun self__split_fields7 () uml_state_access)
...
(assert
;; WP_parameter_def
 ;; File "model.ads", line 12, characters 0-0
  (not
  (= (from
