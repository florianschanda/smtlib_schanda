...
(define-fun upper4 () int__ref (mk_int__ref upper))
...
;; H
  (assert (=> (<= 46341 n) (= (mk_int__ref result1) upper4)))
...
;; H
  (assert (=> (not (<= 46341 n)) (= (mk_int__ref result2) upper4)))
