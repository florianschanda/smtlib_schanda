...
(declare-fun o1 () (Array (_ BitVec 8) us_rep))
...
(declare-fun result1 () (Array (_ BitVec 8) us_rep))
...
(declare-fun self__4 () (Array (_ BitVec 8) us_rep))
...
;; H
  ...
  (= n1 (to_rep
        (rec__core__message_record__value
        (us_split_fields1 (select self__ (to_rep1 self__2)))))))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 self__4 self__5 self__6 self__7))
  (mk___rep1 (mk___split_fields1 o5 o6 o7 o8))))
