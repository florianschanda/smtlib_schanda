...
;; H
  ...
  (and (= e11 (mk_int__ref e5)) (= i11 (mk_int__ref i5))))
  (and
  ...
  (and (and (= result8 i16) (= i2 temp___263))
  (and (and (<= temp___263 i2) (<= i2 temp___264))
  (and (= temp___262 e)
  (and (= temp___261 i2)
  (and
  (and
  ...
  (= o i2)) (= o1 (select (elts a) o))) (= o2 (to_rep o1)))
  ...
  (and (= e6 e2) (= i6 i2))))
  (and (= e2 0)
  (and (and (and (= us i2) (dynamic_property3 0 last4 i2)) (= o3 i2))
  ...
  (and
  (forall ((j Int))
  (=> (and (<= (to_rep (first (rt a))) j) (<= j i3))
  (not (= (to_rep (select (elts a) j)) 0))))
  (and
  (and
  (and
  (=> (<= (to_rep (first (rt a))) last4) (dynamic_property4
  (to_rep (first (rt a))) last4 i3))
  (=> (<= (- 2147483648) 2147483647) (in_range1 e3)))
  (and (<= (to_rep (first (rt a))) i3) (<= i3 last4)))
  (and (not (= i3 temp___264))
  (and (and (= i3 result3) (= i4 (+ i3 1)))
  (and
  (and
  (and
  (and
  (and
  (and (and (<= (to_rep (first (rt a))) i4) (<= i4 (to_rep (last (rt a)))))
  (= o4 i4)) (= o5 (select (elts a) o4))) (= o6 (to_rep o5)))
  (and (= e3 result4) (= e4 o6))) (in_range1 e4))
  (and (= e4 0)
  (and (and (and (= us1 i4) (dynamic_property3 0 last4 i4)) (= o7 i4))
  (and (= dynamic_ranges__search_0__nested__result3 result5)
  (= dynamic_ranges__search_0__nested__result4 o7))))))))))))))))))))
  (and
  (and (and (= result8 i16) (= i2 (to_rep (first (rt a)))))
  (ite (and (<= (to_rep (first (rt a))) i2) (<= i2 last4))
  (and
  (and
  (and (= temp___262 e)
  (and (= temp___261 i2)
  ...
  (to_rep (first (rt a))) last4 i3))
  (=> (<= (- 2147483648) 2147483647) (in_range1 e3)))
  (and (<= (to_rep (first (rt a))) i3) (<= i3 last4))) (= i3 last4)))))))
  (and
  (and
  ...
  (and (= e15 (mk_int__ref e7)) (= i15 (mk_int__ref i7))))
  (and
