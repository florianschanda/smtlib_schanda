...
(declare-fun user_eq2 (t582s t582s) Bool)

(declare-fun dummy2 () t582s)

(declare-datatypes () ((t582s__ref (mk_t582s__ref (t582s__content t582s)))))
(define-fun t582s__ref___projection ((a t582s__ref)) t582s (t582s__content a))
...
(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result () Bool)

(declare-fun temp___428 () Int)
...
(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result1 () Bool)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result2 () Bool)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result3 () Bool)

(declare-fun i7 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result4 () Bool)

(declare-fun i8 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result5 () Bool)
...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 31)) (= temp___428 i1)))
...
;; H
  ...
  (= (make_mask j) (bvsub (ite (< j 4294967296)
                          (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j))
                          ((_ int2bv 32) 0)) ((_ int2bv 32) 1)))))))

;; H
  (assert
  (=> (and (<= 2 i1) (<= i1 31))
  (and (=> (<= 2 31) (in_range2 i2)) (and (<= 2 i2) (<= i2 31)))))
...
;; H
  (assert (=> (and (<= 2 i1) (<= i1 31)) (= i9 (mk_int__ref i3))))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result1
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result3
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result1))

;; H
  (assert (= o (lemma2_goal Tuple0)))

;; H
  (assert
  (= result1 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result))
...
;; H
  (assert
  (= (mk_bool__ref
     bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result4)
  (mk_bool__ref
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result5
  bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result3))
...
;; H
  (assert
  (= result2 bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result4))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__proofs__make_mask__lemma2__result4 true))
