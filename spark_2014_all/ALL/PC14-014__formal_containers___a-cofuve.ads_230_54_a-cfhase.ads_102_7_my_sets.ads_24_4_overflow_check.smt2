...
(define-fun dynamic_invariant ((temp___expr_703 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_717 Int)
...
(define-fun default_initial_assumption ((temp___expr_724 us_rep)
  (temp___skip_top_level_725 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_725 true))
                                         (= (length temp___expr_724) 0)))
