...
(declare-datatypes ((otp_wdat_type__ref 0))
(((mk_otp_wdat_type__ref (otp_wdat_type__content us_rep)))))
...
(declare-const temp___7954 (Array Int bits_8))

(declare-const temp___79541 t2)
