...
(declare-const temp___325 (Array Int storage_element))

(declare-const temp___3251 t)
...
;; H
  ...
  (= (concat1
     (temp___302
     ((_ extract 7 0) (bvand (bvlshr c210b ((_ int2bv 32) 24)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c210b ((_ int2bv 32) 16)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c210b ((_ int2bv 32) 8)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand c210b ((_ int2bv 32) 255)))) 1 4
     (temp___309
     ((_ extract 7 0) (bvand (bvlshr c220b ((_ int2bv 32) 24)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c220b ((_ int2bv 32) 16)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand (bvlshr c220b ((_ int2bv 32) 8)) ((_ int2bv 32) 255)))
     ((_ extract 7 0) (bvand c220b ((_ int2bv 32) 255)))) 1 4) temp___325))

;; H
  (assert (= (mk 1 o41) temp___3251))

;; H
  (assert (not (= (length (mk___t temp___325 temp___3251)) 0)))

;; H
  (assert (=> (<= 1 4) (= o42 (+ (- 4 1) 1))))

;; H
  (assert (=> (not (<= 1 4)) (= o42 0)))
...
;; H
  (assert (= o45 (+ (to_rep1 (first temp___3251)) o44)))
