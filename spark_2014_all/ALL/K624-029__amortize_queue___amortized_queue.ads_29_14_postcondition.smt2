...
(declare-fun result4 () capacity_range)

(declare-fun result5 () us_main_type)
...
;; H
  ...
  (=> (and (<= 1 i) (<= i idx2))
  (= (get
     (model__ (mk___rep result____split_discrs result____split_fields13)) i) 
  (get (model__ left) i))))))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result4) (mk___split_fields result5)) 
  (vector__content amortized_queue__Oconcat__3__result5)))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 76, characters 0-0
  (not
  (= (length (vector__content amortized_queue__Oconcat__3__result5)) (+ 
  (length left) 1))))
(check-sat)
