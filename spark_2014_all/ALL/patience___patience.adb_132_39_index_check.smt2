...
(declare-fun o118 () card)

(declare-fun o119 () Int)

(declare-fun o120 () card)
...
;; H
  (assert
  (= o130 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o129)))
...
;; H
  (assert
  (= o127 (select (rec__patience__state__preds
                  (us_split_fields__content s__split_fields20)) o126)))
...
;; H
  (assert
  (=> (= result27 true)
  (= o124 (select (rec__patience__state__preds
...
;; H
  (assert
  (= o120 (select (rec__patience__state__values
...
;; H
  (assert
  (= o116 (select (rec__patience__state__preds
...
;; H
  (assert
  (= o118 (select (rec__patience__state__values
...
;; H
  (assert
  (=> (= result30 true)
  (= o113 (select (rec__patience__state__posstack
