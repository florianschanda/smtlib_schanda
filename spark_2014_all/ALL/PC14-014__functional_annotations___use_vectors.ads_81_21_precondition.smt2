...
;; H
  (assert
  (=> (and (<= fst1 current1) (<= current1 lst1))
  (and (= v__split_discrs (mk___split_discrs temp___473))
  (= v__split_fields temp___4731))))

;; H
  (assert
  (=> (and (<= fst1 current1) (<= current1 lst1)) (= temp___472 current1)))
...
;; H
  (assert
  (=> (and (<= fst1 current1) (<= current1 lst1))
  (= (length (mk___rep v__split_discrs v__split_fields13)) temp___474)))

;; H
  (assert
  (=> (and (<= fst1 current1) (<= current1 lst1))
  (forall ((i1 Int))
  (=> (and (<= fst1 i1) (<= i1 (- current2 1)))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i1) 0)))))

;; H
  (assert
  (=> (and (<= fst1 current1) (<= current1 lst1))
  (forall ((i1 Int))
  (=> (and (<= first i1) (<= i1 (- fst1 1)))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i1)
  (get temp___475 i1))))))
...
;; H
  ...
  (=>
  (and (<= current2 i1)
  (<= i1 (last5 (model__ (mk___rep v__split_discrs v__split_fields13)))))
  (= (get (model__ (mk___rep v__split_discrs v__split_fields13)) i1)
  (get temp___476 i1))))))
...
;; H
  (assert (= result1 (ite (<= first i) o1 false)))
