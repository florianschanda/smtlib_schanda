...
(define-fun us_split_fields_Node3__projection ((a us_split_fields2)) count_type
...
(define-fun cursor__ref_3__projection ((a cursor__ref)) us_rep1 (cursor__content
                                                                a))
...
(define-fun map__ref_5__projection ((a map__ref)) us_rep2 (map__content a))

(declare-datatypes ((key_type__ref 0))
(((mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref_5__projection ((a key_type__ref)) us_rep1 (key_type__content
                                                                    a))
...
(define-fun element_type__ref_11__projection ((a element_type__ref)) element_type
...
(define-fun sequence__ref_3__projection ((a sequence__ref)) us_rep3 (sequence__content
                                                                    a))
