...
(define-fun us_split_discrs___4__projection ((a us_split_discrs)) count_type
  (rec__dic_of_cont__my_hase__set__capacity a))

(define-fun us_split_discrs___5__projection ((a us_split_discrs)) hash_type
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__dic_of_cont__my_hase__cursor__node count_type)))))
(define-fun us_split_fields_Node__3__projection ((a us_split_fields2)) count_type
  (rec__dic_of_cont__my_hase__cursor__node a))
...
(define-fun us_rep___15__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))

(define-fun bool_eq1 ((a us_rep1)
  (b us_rep1)) Bool (ite (= (to_rep
                            (rec__dic_of_cont__my_hase__cursor__node
...
(declare-const dic_of_cont__my_hase__cursor__node__first__bit Int)

(declare-const dic_of_cont__my_hase__cursor__node__last__bit Int)

(declare-const dic_of_cont__my_hase__cursor__node__position Int)

;; dic_of_cont__my_hase__cursor__node__first__bit_axiom
  (assert (<= 0 dic_of_cont__my_hase__cursor__node__first__bit))

;; dic_of_cont__my_hase__cursor__node__last__bit_axiom
  (assert
  (< dic_of_cont__my_hase__cursor__node__first__bit dic_of_cont__my_hase__cursor__node__last__bit))

;; dic_of_cont__my_hase__cursor__node__position_axiom
  (assert (<= 0 dic_of_cont__my_hase__cursor__node__position))
...
(define-fun cursor__ref___3__projection ((a cursor__ref)) us_rep1 (cursor__content
                                                                  a))
...
(define-fun map__ref___5__projection ((a map__ref)) us_rep2 (map__content a))

(declare-datatypes ()
((key_type__ref (mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref___5__projection ((a key_type__ref)) us_rep1
  (key_type__content a))
...
(define-fun element_type__ref___11__projection ((a element_type__ref)) element_type
  (element_type__content a))

(define-fun dynamic_invariant1 ((temp___expr_821 Int)
  (temp___is_init_818 Bool) (temp___skip_constant_819 Bool)
  (temp___do_toplevel_820 Bool)) Bool (=>
                                      (or (= temp___is_init_818 true)
...
(define-fun default_initial_assumption ((temp___expr_828 us_rep2)
  (temp___skip_top_level_829 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_829 true))
                                         (and
                                         (= (is_empty temp___expr_828) true)
                                         (= (length2 temp___expr_828) 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_741 Int)
...
(define-fun sequence__ref___3__projection ((a sequence__ref)) us_rep3
  (sequence__content a))
...
(define-fun default_initial_assumption1 ((temp___expr_808 us_rep3)
  (temp___skip_top_level_809 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_809 true))
                                         (= (length3 temp___expr_808) 0)))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant3 item true true true)
     ...
     (and
     (=> (< 0 result)
     (and (<= result (length3 container1)) (= item (get1 container1 result))))
...
(define-fun default_initial_assumption2 ((temp___expr_777 us_rep4)
  (temp___skip_top_level_778 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_778 true))
                                         (= (is_empty1 temp___expr_777) true)))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (= (contains (model__ container1) (get1 result temp___845)) true))))
     (forall ((item Int))
...
(define-fun dynamic_invariant4 ((temp___expr_770 Int)
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant4 item true true true)
     ...
     (=>
     (exists ((e Int))
     (and (and (in_range4 e) (= (contains container1 e) true)) (= e item)))
...
(define-fun dynamic_invariant6 ((temp___expr_795 Int)
...
;; get__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant5 position1 true true true)
     (and (<= 1 position1) (<= position1 (last container1))))
     (dynamic_invariant6 (get1 container1 position1) true false true)) :pattern (
...
(declare-const temp___1996 count_type)
...
;; H
  (assert (= temp___1996 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1996)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 1058, characters 0-0
