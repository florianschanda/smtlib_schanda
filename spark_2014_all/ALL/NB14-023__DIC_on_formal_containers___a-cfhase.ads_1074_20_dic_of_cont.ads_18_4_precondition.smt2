...
(declare-fun dic_of_cont__my_hase__cursor__node__first__bit () Int)

(declare-fun dic_of_cont__my_hase__cursor__node__last__bit () Int)

(declare-fun dic_of_cont__my_hase__cursor__node__position () Int)
...
(declare-fun temp___1996 () count_type)
