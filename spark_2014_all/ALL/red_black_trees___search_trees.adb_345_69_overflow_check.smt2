...
(declare-fun temp___1706 () (Array Int us_rep1))

(declare-fun o () us_rep1)

(declare-fun o1 () us_split_fields)

(declare-fun temp___1707 () (Array Int us_rep1))
...
(declare-fun temp___1708 () (Array Int us_rep1))
...
(declare-fun temp___1705 () (Array Int us_rep1))
...
(declare-fun temp___1716 () (Array Int us_rep1))
...
;; H
  (assert
  (and (= result (valid_root f_old root))
  (=> (< (size f_old) root) (not (= result true)))))
...
;; H
  (assert
  (and (= result1 (valid_root f root))
  (=> (< (size f) root) (not (= result1 true)))))
...
;; H
  (assert
  (and (= result2 (valid_root f_old v))
  (=> (< (size f_old) v) (not (= result2 true)))))
...
;; H
  (assert
  (and (= o17 (valid_root f v)) (=> (< (size f) v) (not (= o17 true)))))

;; H
  (assert (= result3 (ite (not (= o17 true)) true false)))
...
;; H
  (assert
  (and (= temp___1716 (model__ f root))
  (and (dynamic_invariant5 temp___1716 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1716 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1716 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1716 (parent f i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1716 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1716 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1716 (parent f i1)))) (position f i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1716 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1716 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1716 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1716 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1716 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o15 (select temp___1716 v)))

;; H
  (assert (= o16 (us_split_fields1 o15)))

;; H
  (assert (= result4 (rec__tree_model__path_type__k o16)))
...
;; H
  (assert
  (and (= result5 (ordered_leafs f_old root values))
  (= (= result5 true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (forall ((j Int))
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old root) j))) true))
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old root) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old root) j)))) true))
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f_old root) j)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f_old root) i1)))) 1)) 0)
  (< (to_rep (select values j)) (to_rep (select values i1)))
  (< (to_rep (select values i1)) (to_rep (select values j))))))))))))
...
;; H
  (assert
  (and (= result6 (ordered_leafs f_old v values))
  (= (= result6 true)
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (forall ((j Int))
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old v) i1))) true)
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select (model__ f_old v) j))) true))
  (= (olt
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old v) i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select (model__ f_old v) j)))) true))
  (ite (= (get
          (rec__tree_model__path_type__a
          (us_split_fields1 (select (model__ f_old v) j)))
          (+ (length
             (rec__tree_model__path_type__a
             (us_split_fields1 (select (model__ f_old v) i1)))) 1)) 0)
  (< (to_rep (select values j)) (to_rep (select values i1)))
  (< (to_rep (select values i1)) (to_rep (select values j))))))))))))
...
;; H
  (assert
  (and (= temp___1708 (model__ f root))
  (and (dynamic_invariant5 temp___1708 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1708 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1708 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1708 (parent f i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1708 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1708 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1708 (parent f i1)))) (position f i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1708 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1708 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1708 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1708 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1708 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o5 (select temp___1708 v)))
...
;; H
  (assert
  (and (= temp___1707 (model__ f_old root))
  (and (dynamic_invariant5 temp___1707 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1707 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1707 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f_old i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1707 (parent f_old i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1707 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1707 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1707 (parent f_old i1))))
     (position f_old i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1707 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1707 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1707 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1707 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1707 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o2 (select temp___1707 i)))
...
;; H
  ...
  (and (= o8 (olt o4 o7))
  (= (= o8 true)
  (and (< (length o4) (length o7))
  (forall ((n Int))
  (=> (and (<= 1 n) (<= n (last o4))) (= (get o4 n) (get o7 n))))))))

;; H
  (assert
  (and (= temp___1706 (model__ f_old root))
  (and (dynamic_invariant5 temp___1706 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1706 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1706 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f_old i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1706 (parent f_old i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1706 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1706 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1706 (parent f_old i1))))
     (position f_old i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1706 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1706 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1706 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1706 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1706 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o (select temp___1706 i)))
...
;; H
  (assert
  (and (= temp___1705 (model__ f_old root))
  (and (dynamic_invariant5 temp___1705 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1705 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1705 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and (not (= (parent f_old i1) 0))
       (= (rec__tree_model__path_type__k
          (us_split_fields1 (select temp___1705 (parent f_old i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1705 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1705 i1))) true))))))
  (and
  ...
  (= (is_add
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1705 (parent f_old i1))))
     (position f_old i1)
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1705 i1)))) true)
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1705 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1705 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1705 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1705 j)))) true))
  (= j i1))))))))))))))

;; H
  (assert (= o10 (select temp___1705 i)))
...
;; H
  (assert
  (and (= o13 (length o12)) (and (in_range4 o13) (<= (+ 0 o13) 2147483647))))
