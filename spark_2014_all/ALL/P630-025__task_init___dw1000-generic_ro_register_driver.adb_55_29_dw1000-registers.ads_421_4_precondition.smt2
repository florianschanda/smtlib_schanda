...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat bits_16)))))
(define-fun us_split_fields_RXPACC_NOSAT__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_53__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_53__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat
...
(declare-fun dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__first__bit () Int)

(declare-fun dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__last__bit () Int)

(declare-fun dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__position () Int)

;; dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__first__bit))

;; dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__last__bit_axiom
  (assert
  (< dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__first__bit
  dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__last__bit))

;; dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__position_axiom
  (assert
  (<= 0 dw1000__register_types__rxpacc_nosat_type__rxpacc_nosat__position))
...
(declare-datatypes ()
((rxpacc_nosat_type__ref
 (mk_rxpacc_nosat_type__ref (rxpacc_nosat_type__content us_rep)))))
(define-fun rxpacc_nosat_type__ref___projection ((a rxpacc_nosat_type__ref)) us_rep
  (rxpacc_nosat_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_124__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_88__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_88__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5064 us_t1)
  (temp___is_init_5061 Bool) (temp___skip_constant_5062 Bool)
  (temp___do_toplevel_5063 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5062 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5064)
                                       (last3 temp___expr_5064))
                                       (and (= (first3 temp___expr_5064) 1)
                                       (= (last3 temp___expr_5064) 2)))))
