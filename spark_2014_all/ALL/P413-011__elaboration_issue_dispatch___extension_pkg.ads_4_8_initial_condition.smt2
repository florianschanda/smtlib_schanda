...
(declare-fun extension_pkg__early_call__assume () Bool)
...
(declare-fun body_elaborated2 () Bool)
...
;; H
  (assert
  (= extension_pkg__early_call__assume (op_wrapper
                                       (mk___rep
                                       (mk___split_fields
                                       (hide_ext__ (of_int 0) us_null_ext__))
...
;; H
  (assert (= body_elaborated2 (of_int 1)))
