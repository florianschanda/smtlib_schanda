...
;; last_element__post_axiom
  ...
  (! (=> (not (= (is_empty container) true))
     ...
     (and
     (and (= result (get (elements container) (length container)))
     (= (e_bigger_than_range (elements container) 1 (- (length container) 1)
        result) true))
     (dynamic_invariant result true false true)))) :pattern ((last_element
                                                             container)) )))
...
(define-fun e_smaller_than_range ((container1 us_rep1) (fst Int) (lst Int)
  (item1 Int)) Bool (ite (forall ((i Int))
                         (=> (and (<= fst i) (<= i lst))
                         (< item1 (get container1 i))))
                    true false))
...
(define-fun default_initial_assumption ((temp___expr_353 us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_322 us_rep2)
  (temp___skip_top_level_323 Bool)) Bool (=>
                                         ...
                                         (= (is_empty2 temp___expr_322) true)))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (=>
     (and (in_range4 temp___387)
     (= (iter_has_element result temp___387) true))
     (= (contains (model__ container1) (get result temp___387)) true))))
     (forall ((item1 Int))
     (=>
...
(define-fun dynamic_invariant3 ((temp___expr_346 Int)
...
;; H
  ...
  (and (in_range2 o)
  (<= o (to_rep
        (rec__my_ordered_sets__m__set__capacity (us_split_discrs1 container)))))))
