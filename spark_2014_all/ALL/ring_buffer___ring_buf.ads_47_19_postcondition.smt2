...
(declare-const temp___1961 ar_index)

(declare-const temp___1962 length_type)

(declare-const o5 Int)

(declare-const o6 length_type)

(declare-const o7 (Array Int integer))

(declare-const o8 ar_index)

(declare-const o9 length_type)

(declare-const temp___198 (Array Int integer))

(declare-const temp___1981 ar_index)

(declare-const temp___1982 length_type)
...
;; H
  (assert
  (and (= o5 (+ (to_rep2 r__split_fields5) 1)) (in_range2
...
;; H
  (assert (= temp___198 r__split_fields6))

;; H
  (assert (= temp___1981 r__split_fields7))

;; H
  (assert (= temp___1982 r__split_fields8))
