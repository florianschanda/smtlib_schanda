...
;; H
  (assert
  (and
  (= o45 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7)))))
  (in_range1
...
;; H
  (assert
  (= o44 (select (rec__skein__skein_512_context__x local_ctx__split_fields33)
  o43)))
...
;; WP_parameter_def
 ;; File "skein.adb", line 21, characters 0-0
  (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) o49)))
(check-sat)
(exit)
