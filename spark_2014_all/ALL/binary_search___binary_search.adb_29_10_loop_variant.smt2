...
;; H
  (assert
  (=> (< (to_rep (select a med2)) i)
  (and (= o1 (+ med2 1)) (in_range2 (+ med2 1)))))
...
;; H
  (assert
  (=> (not (< (to_rep (select a med2)) i)) (< i (to_rep (select a med2)))))

;; H
  (assert
  (=> (not (< (to_rep (select a med2)) i))
  (and (= o2 (- med2 1)) (in_range2 (- med2 1)))))
