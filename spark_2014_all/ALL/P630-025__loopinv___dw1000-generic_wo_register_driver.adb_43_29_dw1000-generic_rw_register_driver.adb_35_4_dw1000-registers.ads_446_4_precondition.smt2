...
(define-fun in_range2 ((x (_ BitVec 64))) Bool (and
                                               ...
                                               (bvule x ((_ int2bv 64) 1099511627775))))
...
(declare-fun user_eq4 (bits_40 bits_40) Bool)

(declare-fun dummy4 () bits_40)

(declare-datatypes ()
((bits_40__ref (mk_bits_40__ref (bits_40__content bits_40)))))
(define-fun bits_40__ref___projection ((a bits_40__ref)) bits_40 (bits_40__content
                                                                 a))
...
;; range_axiom
  (assert
  (forall ((x bits_40)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)) )))

;; coerce_axiom
  (assert
  (forall ((x (_ BitVec 64)))
  (! (let ((y (bvurem x ((_ int2bv 64) 1099511627776))))
...
;; range_int_axiom
  (assert
  (forall ((x bits_40)) (! (in_range_int
  (to_int5 x)) :pattern ((to_int5 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__ldotune_type__ldotune bits_40)))))
(define-fun us_split_fields_LDOTUNE__projection ((a us_split_fields)) bits_40 
  (rec__dw1000__register_types__ldotune_type__ldotune a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_58__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_58__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq6 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__ldotune_type__ldotune
...
(declare-fun dw1000__register_types__ldotune_type__ldotune__first__bit () Int)

(declare-fun dw1000__register_types__ldotune_type__ldotune__last__bit () Int)

(declare-fun dw1000__register_types__ldotune_type__ldotune__position () Int)

;; dw1000__register_types__ldotune_type__ldotune__first__bit_axiom
  (assert (<= 0 dw1000__register_types__ldotune_type__ldotune__first__bit))

;; dw1000__register_types__ldotune_type__ldotune__last__bit_axiom
  (assert
  (< dw1000__register_types__ldotune_type__ldotune__first__bit dw1000__register_types__ldotune_type__ldotune__last__bit))

;; dw1000__register_types__ldotune_type__ldotune__position_axiom
  (assert (<= 0 dw1000__register_types__ldotune_type__ldotune__position))

(declare-fun dummy5 () us_rep)

(declare-datatypes ()
((ldotune_type__ref (mk_ldotune_type__ref (ldotune_type__content us_rep)))))
(define-fun ldotune_type__ref___projection ((a ldotune_type__ref)) us_rep 
  (ldotune_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_137__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_97__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_97__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5308 us_t1)
  (temp___is_init_5305 Bool) (temp___skip_constant_5306 Bool)
  (temp___do_toplevel_5307 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5306 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_5308)
                                       (last3 temp___expr_5308))
                                       (and (= (first3 temp___expr_5308) 1)
                                       (= (last3 temp___expr_5308) 5)))))
...
(define-fun target__ref_41__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_41__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_5324 us_t2)
  (temp___is_init_5321 Bool) (temp___skip_constant_5322 Bool)
  (temp___do_toplevel_5323 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5322 true))
                                       (and (dynamic_property3 1 5
                                       (first5 temp___expr_5324)
                                       (last5 temp___expr_5324))
                                       (and (= (first5 temp___expr_5324) 1)
                                       (= (last5 temp___expr_5324) 5)))))
...
(declare-fun temp___7859 () (Array Int bits_8))

(declare-fun temp___78591 () t2)

(declare-fun temp___7860 () (Array Int bits_8))

(declare-fun temp___78601 () t1)
...
(define-fun temp___78592 () us_t2 (mk___t2 temp___7859 temp___78591))

;; H
  (assert
  (and (dynamic_property2 1 5 (to_rep reg_bytes__first)
  (to_rep reg_bytes__last))
  (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 5))))

;; H
  (assert
  (and (= temp___78592 (register_to_bytes reg)) (dynamic_invariant1
  temp___78592 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78591)) (to_rep (last4 temp___78591)))
     (+ (- (to_rep (last4 temp___78591)) (to_rep (first4 temp___78591))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))

;; H
  (assert (= temp___7859 temp___7860))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78591)) (to_rep (last4 temp___78591))) 
  temp___78601))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78601)) (to_rep (last2 temp___78601)))
     (+ (- (to_rep (last2 temp___78601)) (to_rep (first2 temp___78601))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7860 temp___78601)))
