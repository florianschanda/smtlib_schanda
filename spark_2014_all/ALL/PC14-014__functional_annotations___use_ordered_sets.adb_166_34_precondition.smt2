...
;; H
  (assert (and (= o1 (* 2 n2)) (in_range1 (* 2 n2))))
...
;; H
  (assert
  (and (= o (positions (mk___rep s__split_discrs s__split_fields1)))
  (and (not (= (has_key o no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o i) true)
  (and
  (and (<= 1 (get1 o i))
  (<= (get1 o i) (length (mk___rep s__split_discrs s__split_fields1))))
  (forall ((j us_rep1))
  (=> (= (has_key o j) true)
...
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 71, characters 0-0
  (not (= (has_key o (mk___rep1 cu__split_fields2)) true)))
(check-sat)
(exit)
