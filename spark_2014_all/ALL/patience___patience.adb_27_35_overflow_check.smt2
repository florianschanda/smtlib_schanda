...
;; H
  (assert
  (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))
  (and (= temp___570 (- i2 1)) (in_range1 (- i2 1)))))

;; H
  (assert
  (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))
  (and (<= 0 temp___570) (<= temp___570 99))))
...
;; H
  (assert
  (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))
  (= temp___571 (select s__split_fields4 o3))))

;; H
  (assert
  (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))
  (and (= temp___573 (- i2 1)) (in_range1 (- i2 1)))))

;; H
  (assert
  (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))
  (and (<= 0 temp___573) (<= temp___573 99))))
...
;; H
  (assert
  (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))
  (and (<= 0 temp___574) (<= temp___574 99))))
...
;; H
  (assert
  (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))
  (= result3 (ite (= pred2 o9) true false))))

;; H
  (assert
  (=> (not (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))))
  (= result3 false)))
...
;; H
  (assert (=> (= result3 true) (= o2 (to_rep o1))))
