...
(declare-fun bounded_strings__make__result3 () length_type)
...
(declare-fun temp___204 () index_type)

(declare-fun temp___2041 () (Array Int character))

(declare-fun temp___2042 () t2)

(declare-fun temp___2043 () length_type)
...
(declare-fun o8 () us_t2)

(declare-fun o9 () us_split_fields2)

(declare-fun temp___208 () us_rep1)

(declare-fun o10 () length_type)

(declare-fun o11 () us_split_fields2)

(declare-fun temp___210 () us_rep1)
...
(declare-fun result7 () length_type)
...
;; H
  (assert
  (= (mk2 (to_rep3 (first8 temp___2001)) (to_rep3 (last8 temp___2001)))
  temp___2011))

;; H
  (assert
  (= (ite (<= (to_rep3 (first4 temp___2011)) (to_rep3 (last4 temp___2011)))
     (+ (- (to_rep3 (last4 temp___2011)) (to_rep3 (first4 temp___2011))) 1)
     0) (ite (<= (to_rep3 (first4 result____split_fields1)) (to_rep3
                                                            (last4
                                                            result____split_fields1)))
        (+ (- (to_rep3 (last4 result____split_fields1)) (to_rep3
                                                        (first4
...
;; H
  ...
  (= result____split_fields3 (mk___split_fields1
                             (mk___t2 temp___2041 temp___2042) temp___2043)))
...
;; H
  ...
  (<= 1 (to_rep3
        (last4
        (rt2
        (rec__bounded_strings__bounded_string__text1 result____split_fields3)))))))
...
;; H
  (assert
  (= o9 (mk___split_fields1 o8
        (rec__bounded_strings__bounded_string__length1
        result____split_fields3))))

;; H
  (assert (= temp___208 (mk___rep1 result____split_discrs o9)))

;; H
  (assert (= result1 (mk___split_fields__ref1 result____split_fields3)))

;; H
  (assert (= result____split_fields4 (us_split_fields3 temp___208)))

;; H
  (assert (= result____split_discrs (us_split_discrs2 temp___208)))

;; H
  (assert (= (to_rep2 o10) 1))

;; H
  (assert
  (= o11 (mk___split_fields1
         (rec__bounded_strings__bounded_string__text1
         result____split_fields4) o10)))

;; H
  (assert (= temp___210 (mk___rep1 result____split_discrs o11)))

;; H
  (assert (= result2 (mk___split_fields__ref1 result____split_fields4)))

;; H
  (assert (= result____split_fields5 (us_split_fields3 temp___210)))

;; H
  (assert (= result____split_discrs (us_split_discrs2 temp___210)))
...
;; H
  (assert (= result____split_fields7 result____split_fields5))
...
;; WP_parameter_def
 ;; File "bounded_strings.ads", line 27, characters 0-0
  ...
  (= (to_rep1
     (rec__bounded_strings__bounded_string__bound
     (us_split_discrs1
     (bounded_string__content bounded_strings__make__result7)))) upper_bound)))
(check-sat)
(exit)
