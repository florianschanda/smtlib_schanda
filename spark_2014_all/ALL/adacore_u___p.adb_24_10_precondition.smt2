...
;; H
  (assert
  (=> (< (to_rep1 a__first) i2)
  (and (= temp___265 (- i2 1)) (in_range1 (- i2 1)))))

;; H
  (assert
  (=> (< (to_rep1 a__first) i2)
  (and (<= (to_rep1 a__first) temp___265) (<= temp___265 (to_rep1 a__last)))))

;; H
  (assert (=> (< (to_rep1 a__first) i2) (= o temp___265)))

;; H
  (assert (=> (< (to_rep1 a__first) i2) (= o1 (select a o))))

;; H
  (assert (=> (< (to_rep1 a__first) i2) (= o2 (to_rep o1))))

;; H
  (assert (=> (< (to_rep1 a__first) i2) (= result2 threshold2)))

;; H
  (assert (=> (< (to_rep1 a__first) i2) (= threshold3 o2)))

;; H
  (assert (=> (not (< (to_rep1 a__first) i2)) (= threshold3 threshold2)))
