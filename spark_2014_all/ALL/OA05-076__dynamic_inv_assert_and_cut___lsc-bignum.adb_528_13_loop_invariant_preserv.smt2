...
;; H
  (assert (not (bvult i2 ((_ int2bv 64) (int__content s2)))))

;; H
  (assert (= result2 (mk_t__ref1 i2)))

;; H
  (assert (= i3 (bvsub i2 ((_ int2bv 64) (int__content s2)))))
