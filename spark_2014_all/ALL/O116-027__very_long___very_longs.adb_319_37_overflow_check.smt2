...
(declare-datatypes ()
((tT89bP1__ref (mk_tT89bP1__ref (tT89bP1__content tdigit_count_typeB)))))
(define-fun tT89bP1__ref___projection ((a tT89bP1__ref)) tdigit_count_typeB
  (tT89bP1__content a))
...
(define-fun us_split_fields_Long_Digits__24__projection ((a us_split_fields2)) us_t1
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ()
((us_split_fields__ref1
 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___24__projection ((a us_split_fields__ref1)) us_split_fields2
...
(define-fun us_rep___47__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                                  a))

(define-fun us_rep___48__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))
...
(define-fun tresultS__ref___4__projection ((a tresultS__ref)) us_rep1
  (tresultS__content a))

(define-fun dynamic_invariant4 ((temp___expr_618 us_rep1)
  (temp___is_init_615 Bool) (temp___skip_constant_616 Bool)
  (temp___do_toplevel_617 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_616 true))
                                      (in_range4
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_618)))
                                      ...
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_618)))
                                      (last3
                                      (rec__very_longs__very_long__long_digits1
                                      (us_split_fields3 temp___expr_618))))
                                      (and
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_618))) 1)
                                      (= (last3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_618)))
                                      (to_rep
...
(define-fun default_initial_assumption ((temp___expr_621 us_rep1)
  (temp___skip_top_level_622 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_621))) (to_rep
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-datatypes ()
((t90b__ref (mk_t90b__ref (t90b__content tdigit_count_typeB)))))
(define-fun t90b__ref___projection ((a t90b__ref)) tdigit_count_typeB
  (t90b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___964 (_ BitVec 8)))
  (forall ((temp___965 Int) (temp___966 Int))
  (let ((temp___963 (temp___962 temp___964 temp___965 temp___966)))
  (and
  (=> (dynamic_property6 1 65536 temp___965 temp___966)
  (and (= (first5 temp___963) temp___965) (= (last5 temp___963) temp___966)))
  (forall ((temp___967 Int))
  (= (select (to_array2 temp___963) temp___967) (of_rep1 temp___964))))))))
...
;; H
  (assert
  (= (mk___t2 temp___969 temp___9691) (temp___962 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___9691)) (to_rep2 (last4 temp___9691)))
     (+ (- (to_rep2 (last4 temp___9691)) (to_rep2 (first4 temp___9691))) 1)
     0) (ite (<= 1 (to_rep
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___9691)) (to_rep2 (last4 temp___9691)))
  temp___9701))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9701)) (to_rep2 (last2 temp___9701)))
     (+ (- (to_rep2 (last2 temp___9701)) (to_rep2 (first2 temp___9701))) 1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9731 temp___9732))))
...
;; H
  (assert (= o16 (ite (<= o15 r94b) true false)))
...
;; H
  (assert (= o23 (takelsb_from16 temp1)))
