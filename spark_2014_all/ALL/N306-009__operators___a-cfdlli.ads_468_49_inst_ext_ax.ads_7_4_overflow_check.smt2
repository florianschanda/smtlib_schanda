...
(define-fun map__ref_2__projection ((a map__ref)) us_rep2 (map__content a))
...
(declare-fun temp___667 () count_type)
...
;; H
  (assert (= temp___667 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___667)) no_element))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 55, characters 0-0
  (not (in_range
  (- (to_rep
     (rec__inst_ext_ax__ok_lists2__list__capacity container__split_discrs)) 
  count))))
(check-sat)
