...
(declare-fun dummy7 () (Array Int group1_id))
...
;; H
  ...
  (not (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id))))))

;; H
  (assert (= result1 true))

;; H
  (assert (< 0 (to_rep3 (select proposals_made g1_id))))

(assert
;; WP_parameter_def
 ;; File "stable_marriage.adb", line 194, characters 0-0
  (not (in_range3 (to_rep3 (select proposals_made g1_id)))))
(check-sat)
