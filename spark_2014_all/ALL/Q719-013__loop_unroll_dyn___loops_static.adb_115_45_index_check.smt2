...
;; H
  ...
  (=> (= i1 (to_rep1 a__last)) (= (mk_int__ref result4) j16))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last)) (= j3 (to_rep1 a__first)))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last))
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= temp___337 bad1)))))
...
;; H
  ...
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (= i1 (to_rep1 a__last))
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= j15 (mk_int__ref j5))))))
...
;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (not (= i1 (to_rep1 a__last))) (= j14 j16))))
