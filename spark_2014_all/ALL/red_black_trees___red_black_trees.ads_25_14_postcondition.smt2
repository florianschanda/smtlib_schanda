...
(declare-datatypes ()
((value_set__ref (mk_value_set__ref (value_set__content us_rep)))))
(define-fun value_set__ref___projection ((a value_set__ref)) us_rep (value_set__content
                                                                    a))
...
(define-fun us_rep_2__projection ((a us_rep1)) us_split_fields (us_split_fields1
                                                               a))
...
((us_split_fields2
 (mk___split_fields1
 (rec__binary_trees__forest__s extended_index_type)(rec__binary_trees__forest__c (Array Int us_rep1))))))
(define-fun us_split_fields_S__projection ((a us_split_fields2)) extended_index_type 
  (rec__binary_trees__forest__s a))

(define-fun us_split_fields_C__projection ((a us_split_fields2)) (Array Int us_rep1) 
...
(declare-datatypes ()
((forest__ref (mk_forest__ref (forest__content us_rep2)))))
(define-fun forest__ref___projection ((a forest__ref)) us_rep2 (forest__content
                                                               a))
...
((us_split_fields4
 (mk___split_fields2
 (rec__search_trees__search_tree__root extended_index_type)(rec__search_trees__search_tree__struct us_rep2)(rec__search_trees__search_tree__values (Array Int natural))))))
(define-fun us_split_fields_Root__projection ((a us_split_fields4)) extended_index_type 
  (rec__search_trees__search_tree__root a))

(define-fun us_split_fields_Struct__projection ((a us_split_fields4)) us_rep2 
...
(define-fun us_rep_4__projection ((a us_rep3)) us_split_fields4 (us_split_fields5
                                                                a))
...
(declare-datatypes ()
((search_tree__ref (mk_search_tree__ref (search_tree__content us_rep3)))))
(define-fun search_tree__ref___projection ((a search_tree__ref)) us_rep3 
...
(declare-fun dummy10 () index_type)
...
(declare-fun ordered_leafs__function_guard (Bool us_rep2 Int
...
(define-fun dynamic_invariant2 ((temp___expr_378 us_rep3)
...
(define-fun type_invariant ((temp___395 us_rep3)) Bool (ite (= (size
                                                               (rec__search_trees__search_tree__struct
                                                               (us_split_fields5
                                                               temp___395))) 0)
                                                       (= (to_rep
...
(declare-fun contains1 (us_rep3 Int) Bool)

(declare-fun contains__function_guard1 (Bool us_rep3 Int) Bool)
...
;; contains__post_axiom
  ...
  (forall ((v Int))
  (! (=>
     (and (dynamic_invariant2 t true true true) (dynamic_invariant v true
     true true))
     (= (= (contains1 t v) true) (= (contains (values t) v) true))) :pattern (
  (contains1 t v)) ))))
...
(declare-fun dummy11 () color_type)
...
(define-fun bool_eq12 ((a (Array Int color_type)) (a__first Int)
...
(declare-fun dummy12 () (Array Int color_type))
...
;; object__alignment_axiom
  (assert
  (forall ((a (Array Int color_type))) (<= 0 (object__alignment6 a))))
...
((us_split_fields6
 (mk___split_fields3
 (rec__red_black_trees__rbt__struct us_rep3)(rec__red_black_trees__rbt__color (Array Int color_type))))))
(define-fun us_split_fields_Struct2__projection ((a us_split_fields6)) us_rep3 
...
(define-fun us_rep_5__projection ((a us_rep4)) us_split_fields6 (us_split_fields7
                                                                a))
...
(define-fun dynamic_invariant3 ((temp___expr_487 us_rep4)
...
(define-fun default_initial_assumption2 ((temp___expr_493 us_rep4)
...
(define-fun type_invariant1 ((temp___507 us_rep4)) Bool (= (invariant__
                                                           temp___507) true))

(declare-fun values1 (us_rep4) us_rep)

(declare-fun values__function_guard1 (us_rep us_rep4) Bool)

(declare-fun size2 (us_rep4) Int)

(declare-fun size__function_guard2 (Int us_rep4) Bool)

(define-fun default_initial_assumption3 ((temp___expr_254 us_rep)
...
;; values__def_axiom
  ...
  (! (=> (dynamic_invariant3 t true true true)
     (= (values1 t) (values
                    (rec__red_black_trees__rbt__struct (us_split_fields7 t))))) :pattern (
  (values1 t)) )))
...
(define-fun us_split_fields_Status__projection ((a us_split_fields8)) Bool 
  (rec__red_black_trees__black_count__status a))

(define-fun us_split_fields_Depth__projection ((a us_split_fields8)) extended_index_type 
  (rec__red_black_trees__black_count__depth a))

(define-fun us_split_fields_Count__projection ((a us_split_fields8)) extended_index_type 
...
(define-fun us_rep_6__projection ((a us_rep5)) us_split_fields8 (us_split_fields9
                                                                a))
...
(define-fun bool_eq14 ((a us_rep5)
  (b us_rep5)) Bool (ite (and
                         ...
                         (= (rec__red_black_trees__black_count__status
                            (us_split_fields9 a)) (rec__red_black_trees__black_count__status
                                                  (us_split_fields9 b)))
                         (= (to_rep
...
(declare-datatypes ()
((black_count__ref (mk_black_count__ref (black_count__content us_rep5)))))
(define-fun black_count__ref___projection ((a black_count__ref)) us_rep5 
...
;; singleton_def
  ...
  (forall ((v1 us_rep5))
  (forall ((i Int))
  (! (= (select (singleton4 v1 i) i) v1) :pattern ((select (singleton4 v1 i) i)) ))))

(define-fun bool_eq15 ((a (Array Int us_rep5)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq14 (select a temp___idx_136)
...
(declare-fun bool_eq16 (us_rep6 us_rep6) Bool)
...
(declare-datatypes ()
((sequence__ref (mk_sequence__ref (sequence__content us_rep6)))))
(define-fun sequence__ref___projection ((a sequence__ref)) us_rep6 (sequence__content
                                                                   a))

(declare-datatypes ()
((us_split_fields10
 (mk___split_fields5
 (rec__tree_model__path_type__a us_rep6)(rec__tree_model__path_type__k Bool)))))
(define-fun us_split_fields_A__projection ((a us_split_fields10)) us_rep6 
  (rec__tree_model__path_type__a a))

(define-fun us_split_fields_K__projection ((a us_split_fields10)) Bool 
  (rec__tree_model__path_type__k a))

(declare-datatypes ()
((us_split_fields__ref5
 (mk___split_fields__ref5 (us_split_fields__content5 us_split_fields10)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref5)) us_split_fields10 
  (us_split_fields__content5 a))

(declare-datatypes ()
((us_rep7 (mk___rep5 (us_split_fields11 us_split_fields10)))))
(define-fun us_rep___projection ((a us_rep7)) us_split_fields10 (us_split_fields11
                                                                a))
...
(define-fun bool_eq17 ((a us_rep7)
  (b us_rep7)) Bool (ite (and
                         ...
                         (= (rec__tree_model__path_type__k
                            (us_split_fields11 a)) (rec__tree_model__path_type__k
                                                   (us_split_fields11 b))))
                    true false))
...
(declare-datatypes ()
((path_type__ref (mk_path_type__ref (path_type__content us_rep7)))))
(define-fun path_type__ref___projection ((a path_type__ref)) us_rep7 
...
(define-fun bool_eq18 ((a (Array Int us_rep7)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq17 (select a temp___idx_132)
...
;; nb_blacks__post_axiom
  ...
  (! (=>
     ...
     (and
     (= (bool_eq14 (select result 0)
        (mk___rep4 (mk___split_fields4 (of_int 1) (of_rep 0) (of_rep 0)))) true)
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=>
     (= (rec__tree_model__path_type__k
     ...
     (= (to_rep
        (rec__red_black_trees__black_count__depth
        (us_split_fields9 (select result i)))) (+ 1 (ite (< (to_rep
                                                            (rec__red_black_trees__black_count__depth
                                                            (us_split_fields9
                                                            (select result 
                                                            (peek
     ...
     (= (to_rep
        (rec__red_black_trees__black_count__count
        (us_split_fields9 (select result i)))) (+ (ite (= (to_rep3
                                                          (let ((temp___566 
                                                          (rec__red_black_trees__rbt__color
                                                          (us_split_fields7
                                                          t1))))
...
;; size__post_axiom
  (assert
  (forall ((t1 us_rep4))
  (! (=> (and (dynamic_invariant3 t1 true true true) (type_invariant1 t1))
     (dynamic_invariant4 (size2 t1) true false true)) :pattern ((size2 t1)) )))

;; size__def_axiom
  (assert
  (forall ((t1 us_rep4))
  (! (=> (dynamic_invariant3 t1 true true true)
     (= (size2 t1) (size1
                   (rec__red_black_trees__rbt__struct (us_split_fields7 t1))))) :pattern (
  (size2 t1)) )))
...
(define-fun dynamic_invariant6 ((temp___expr_152 Int)
...
(declare-fun length (us_rep6) Int)

(declare-fun length__function_guard (Int us_rep6) Bool)

(define-fun dynamic_invariant9 ((temp___expr_207 us_rep7)
  (temp___is_init_204 Bool) (temp___skip_constant_205 Bool)
  (temp___do_toplevel_206 Bool)) Bool (=> (= temp___do_toplevel_206 true)
                                      (=> (= temp___is_init_204 true)
                                      (< (length
                                         (rec__tree_model__path_type__a
                                         (us_split_fields11 temp___expr_207))) 100))))

(define-fun default_initial_assumption4 ((temp___expr_209 us_rep7)
...
(define-fun dynamic_predicate ((temp___213 us_rep7)) Bool (< (length
                                                             (rec__tree_model__path_type__a
                                                             (us_split_fields11
                                                             temp___213))) 100))

(define-fun dynamic_invariant10 ((temp___expr_218 (Array Int us_rep7))
...
(define-fun default_initial_assumption5 ((temp___expr_221 (Array Int us_rep7))
...
(define-fun last ((container us_rep6)) Int (+ 0 (length container)))
...
(define-fun oeq ((left us_rep6)
  (right us_rep6)) Bool (and (= (length left) (length right)) (ite (forall
                                                                   ((n Int))
                                                                   (=>
                                                                   (and
                                                                   (<= 1 n)
...
(define-fun default_initial_assumption6 ((temp___expr_201 us_rep6)
  (temp___skip_top_level_202 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_202 true))
                                         (= (length temp___expr_201) 0)))

(define-fun olt ((left us_rep6)
  (right us_rep6)) Bool (and (< (length left) (length right)) (ite (forall
                                                                   ((n Int))
                                                                   (=>
                                                                   (and
...
(define-fun dynamic_invariant11 ((temp___expr_146 Int)
...
;; size__post_axiom
  (assert
  (forall ((t1 us_rep3))
  (! (=> (dynamic_invariant2 t1 true true true) (dynamic_invariant4
...
;; parent__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant2 t1 true true true) (dynamic_invariant6 i true
     true true))
     (let ((result (parent t1 i)))
     (and (=> (= (size1 t1) 0) (= result 0)) (dynamic_invariant4 result true
...
;; parent__def_axiom
  ...
  (! (=>
     ...
     (= (parent t1 i) (parent1
                      (rec__search_trees__search_tree__struct
                      (us_split_fields5 t1)) i))) :pattern ((parent t1 i)) ))))
...
;; model____post_axiom
  ...
  (! (=> (and (dynamic_invariant2 t1 true true true) (not (= (size1 t1) 0)))
     (dynamic_invariant10 (model__ t1) true false true)) :pattern ((model__
                                                                   t1)) )))
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (and
     (and (dynamic_invariant2 t1 true true true) (dynamic_invariant6 i true
     true true)) (dynamic_invariant8 d true true true))
     (and (not (= (size1 t1) 0))
     (= (rec__tree_model__path_type__k
        (us_split_fields11
        (let ((temp___422 (model__ t1))) (select temp___422 i)))) true)))
     (dynamic_invariant4 (peek t1 i d) true false true)) :pattern ((peek t1 i
                                                                   d)) ))))
...
;; values__post_axiom
  ...
  (forall ((t1 us_rep3))
  (! (=> (dynamic_invariant2 t1 true true true)
     (=> (= (size1 t1) 0) (= (is_empty (values t1)) true))) :pattern (
  (values t1)) )))

(define-fun dynamic_invariant12 ((temp___expr_275 us_rep2)
...
(define-fun default_initial_assumption7 ((temp___expr_278 us_rep2)
...
(define-fun type_invariant2 ((temp___284 us_rep2)) Bool (= (tree_structure
                                                           temp___284) true))
...
;; size__post_axiom
  (assert
  (forall ((f us_rep2))
  (! (=> (dynamic_invariant12 f true true true) (dynamic_invariant4 (size f)
...
;; valid_root__post_axiom
  ...
  (forall ((i Int))
  (! (=>
     (and (dynamic_invariant12 f true true true) (dynamic_invariant6 i true
...
;; parent__post_axiom
  ...
  (! (=>
     ...
     (=> (= (size f) 0) (= result 0))) (dynamic_invariant4 result true false
...
;; position__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant12 f true true true) (dynamic_invariant6 i true
     true true)) (not (= (parent1 f i) 0))) (dynamic_invariant8
...
;; peek__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant4 result true false true)))) :pattern ((peek1 f i d)) ))))
...
;; model____post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant12 f true true true) (dynamic_invariant6 root
     true true true)) (= (valid_root f root) true))
     (let ((result (model__1 f root)))
     (and
     (and
     (= (rec__tree_model__path_type__k
        (us_split_fields11 (select result root))) true)
     (and
     (= (length
        (rec__tree_model__path_type__a
        (us_split_fields11 (select result root)))) 0)
     (and
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=> (not (= i root))
     (ite (and (not (= (parent1 f i) 0))
          (= (rec__tree_model__path_type__k
             (us_split_fields11 (select result (parent1 f i)))) true))
     (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true)
     (not
     (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true))))))
     (and
     (forall ((i Int))
     ...
     (= (is_add
        (rec__tree_model__path_type__a
        (us_split_fields11 (select result (parent1 f i)))) (position f i)
        (rec__tree_model__path_type__a (us_split_fields11 (select result i)))) true)
     (= (length
        (rec__tree_model__path_type__a (us_split_fields11 (select result i)))) 0))))
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i 100))
     (=>
     (= (rec__tree_model__path_type__k (us_split_fields11 (select result i))) true)
     ...
     (=>
     (and
     (= (rec__tree_model__path_type__k (us_split_fields11 (select result j))) true)
     (= (oeq
        (rec__tree_model__path_type__a (us_split_fields11 (select result i)))
        (rec__tree_model__path_type__a (us_split_fields11 (select result j)))) true))
     (= j i))))))))))) (dynamic_invariant10 result true false true)))) :pattern (
  (model__1 f root)) ))))

(define-fun default_initial_assumption8 ((temp___expr_261 us_rep1)
...
(define-fun default_initial_assumption9 ((temp___expr_268 (Array Int us_rep1))
...
(define-fun dynamic_invariant13 ((temp___expr_194 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_188 Int)
  (temp___is_init_185 Bool) (temp___skip_constant_186 Bool)
  (temp___do_toplevel_187 Bool)) Bool (=>
                                      (or (= temp___is_init_185 true)
                                      (<= 0 1)) (in_range10 temp___expr_188)))
...
;; get__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant13 position1 true true true)
     (and (<= 1 position1) (<= position1 (last container))))
     (dynamic_invariant14 (get container position1) true false true)) :pattern (
...
;; length__post_axiom
  (assert
  (forall ((container us_rep)) (! (dynamic_invariant11 (length1 container)
...
(declare-fun red_black_trees__contains__result () Bool)

(declare-fun o () Bool)

(declare-fun result () Bool)

(declare-fun red_black_trees__contains__result1 () Bool)

(declare-fun red_black_trees__contains__result2 () Bool)

(declare-fun red_black_trees__contains__result3 () Bool)

(declare-fun red_black_trees__contains__result4 () Bool)

(declare-fun red_black_trees__contains__result5 () Bool)
...
;; H
  (assert
  (= red_black_trees__contains__result1 red_black_trees__contains__result2))

;; H
  (assert
  (= red_black_trees__contains__result3 red_black_trees__contains__result1))

;; H
  (assert
  (and
  (= o (contains1 (rec__red_black_trees__rbt__struct (us_split_fields7 t)) v))
  (= (= o true)
  (= (contains
     (values (rec__red_black_trees__rbt__struct (us_split_fields7 t))) 
     v) true))))

;; H
  (assert
  (= (mk_bool__ref result) (mk_bool__ref red_black_trees__contains__result)))

;; H
  (assert (= red_black_trees__contains__result1 o))

;; H
  (assert
  (= (mk_bool__ref red_black_trees__contains__result4) (mk_bool__ref
                                                       red_black_trees__contains__result2)))

;; H
  (assert
  (= red_black_trees__contains__result5 red_black_trees__contains__result3))

;; H
  (assert (= result1 red_black_trees__contains__result4))

;; H
  (assert (= red_black_trees__contains__result4 true))

(assert
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 24, characters 0-0
  (not (= (contains (values1 t) v) true)))
(check-sat)
