...
(declare-const t__mmul__result (_ BitVec 8))

(declare-const result (_ BitVec 8))

(declare-const t__mmul__result1 (_ BitVec 8))

(declare-const t__mmul__result2 (_ BitVec 8))

(declare-const t__mmul__result3 (_ BitVec 8))

(declare-const t__mmul__result4 (_ BitVec 8))

(declare-const t__mmul__result5 (_ BitVec 8))
...
;; H
  (assert (= t__mmul__result1 t__mmul__result2))

;; H
  (assert (= t__mmul__result3 t__mmul__result1))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref t__mmul__result)))

;; H
  (assert
  (= t__mmul__result1 ((_ extract 7 0) (bvurem (bvmul ((_ zero_extend 8)
  x) ((_ zero_extend 8) y)) ((_ int2bv 16) 230)))))

;; H
  (assert (= (mk_t__ref t__mmul__result4) (mk_t__ref t__mmul__result2)))

;; H
  (assert (= t__mmul__result5 t__mmul__result3))

(assert
;; WP_parameter_def
 ;; File "t.adb", line 6, characters 0-0
  (not (not (= ((_ int2bv 16) 230) #x0000))))
(check-sat)
(exit)
