...
;; def_axiom
  (assert
  (forall ((temp___621 Int) (temp___622 Int))
  (let ((temp___620 (temp___619 temp___621 temp___622)))
  (forall ((temp___623 Int))
  (ite (= temp___623 2)
  (= (select temp___620 temp___623) (of_rep temp___621))
  (= (select temp___620 temp___623) (of_rep temp___622)))))))
