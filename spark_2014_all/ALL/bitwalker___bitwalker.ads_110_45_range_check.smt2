...
;; H
  ...
  (= o29 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o22 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (= o21 (maxvalue len))
  (= o21 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o14 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (= o13 (maxvalue len))
  (= o13 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
...
;; H
  (assert
  (and (= o10 (+ (- (- len i1) 1) start)) (in_range2
  (+ (- (- len i1) 1) start))))
