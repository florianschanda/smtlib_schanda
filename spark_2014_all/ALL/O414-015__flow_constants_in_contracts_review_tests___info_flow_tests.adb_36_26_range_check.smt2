...
(define-fun tt1B__ref_2__projection ((a tt1B__ref)) tt1B (tt1B__content a))
...
(define-fun t1__ref_2__projection ((a t1__ref)) tt1B (t1__content a))
...
(define-fun tt2B__ref_2__projection ((a tt2B__ref)) tt2B (tt2B__content a))
...
(define-fun t2__ref_2__projection ((a t2__ref)) tt2B (t2__content a))
