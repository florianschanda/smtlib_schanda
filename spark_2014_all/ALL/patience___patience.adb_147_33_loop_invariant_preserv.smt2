...
(declare-datatypes ((us_t 0)) (((mk___t (elts (Array Int card))(rt t)))))
...
(((mk_cardstack__ref (cardstack__content us_t)))))
...
(((mk_t28b__ref (t28b__content integer)))))
...
(declare-const s__split_fields17 (Array Int card))
...
(declare-const s__split_fields24 cardindex)

(declare-const s__split_fields25 (Array Int card))

(declare-const s__split_fields26 cardindex)

(declare-const s__split_fields27 (Array Int cardindex))

(declare-const s__split_fields28 (Array Int (Array Int cardindex)))

(declare-const s__split_fields29 (Array Int cardindex))

(declare-const s__split_fields30 (Array Int cardindex))

(declare-const s__split_fields31 (Array Int cardindex))
