...
(declare-fun dummy5 () (Array Int card))
...
(declare-fun dummy7 () (Array Int (Array Int cardindex)))
...
(declare-fun o () cardindex)

(declare-fun o1 () cardindex)

(declare-fun o2 () cardindex)

(declare-fun o3 () (Array Int card))

(declare-fun o4 () cardindex)

(declare-fun o5 () (Array Int cardindex))

(declare-fun o6 () (Array Int (Array Int cardindex)))

(declare-fun o7 () (Array Int cardindex))

(declare-fun o8 () (Array Int cardindex))
...
(declare-fun result1 () (Array Int card))

(declare-fun result2 () cardindex)

(declare-fun result3 () (Array Int cardindex))

(declare-fun result4 () (Array Int (Array Int cardindex)))

(declare-fun result5 () (Array Int cardindex))

(declare-fun result6 () (Array Int cardindex))

(declare-fun result7 () (Array Int cardindex))

(declare-fun s__split_fields8 () cardindex)

(declare-fun s__split_fields9 () (Array Int card))

(declare-fun s__split_fields10 () cardindex)

(declare-fun s__split_fields11 () (Array Int cardindex))

(declare-fun s__split_fields12 () (Array Int (Array Int cardindex)))

(declare-fun s__split_fields13 () (Array Int cardindex))

(declare-fun s__split_fields14 () (Array Int cardindex))

(declare-fun s__split_fields15 () (Array Int cardindex))

(declare-fun result8 () Int)

(declare-fun i1 () Int)

(declare-fun s__split_fields16 () cardindex)

(declare-fun s__split_fields17 () (Array Int card))

(declare-fun s__split_fields18 () cardindex)

(declare-fun s__split_fields19 () (Array Int cardindex))

(declare-fun s__split_fields20 () (Array Int (Array Int cardindex)))

(declare-fun s__split_fields21 () (Array Int cardindex))

(declare-fun s__split_fields22 () (Array Int cardindex))

(declare-fun s__split_fields23 () (Array Int cardindex))

(declare-fun i2 () Int)

(declare-fun s__split_fields24 () cardindex)

(declare-fun s__split_fields25 () (Array Int card))

(declare-fun s__split_fields26 () cardindex)

(declare-fun s__split_fields27 () (Array Int cardindex))

(declare-fun s__split_fields28 () (Array Int (Array Int cardindex)))

(declare-fun s__split_fields29 () (Array Int cardindex))

(declare-fun s__split_fields30 () (Array Int cardindex))

(declare-fun s__split_fields31 () (Array Int cardindex))

(declare-fun result9 () Int)

(declare-fun i3 () Int)

(define-fun s__split_fields32 () us_split_fields (mk___split_fields
                                                 s__split_fields24
                                                 s__split_fields25
                                                 s__split_fields26
                                                 s__split_fields27
...
;; H
  (assert
  (= (mk___split_fields s__split_fields8 s__split_fields9 s__split_fields10
     s__split_fields11 s__split_fields12 s__split_fields13 s__split_fields14
     s__split_fields15) (us_split_fields1 null_state)))
...
;; H
  (assert
  (= (to_rep2 s__split_fields16) (- i2 (to_rep1 (first (rt cards))))))
...
;; H
  (assert
  (and
  (=> (<= (to_rep1 (first (rt cards))) (to_rep1 (last (rt cards))))
  (dynamic_property1 (to_rep1 (first (rt cards))) (to_rep1 (last (rt cards)))
  i2))
  (and (<= (to_rep1 (first (rt cards))) i2)
  (<= i2 (to_rep1 (last (rt cards)))))))

;; H
  (assert
  (and
  (and (= (inv (mk___rep s__split_fields32)) true)
  (= (to_rep (select s__split_fields25 (to_rep2 s__split_fields16)))
  (to_rep (select (elts cards) i2))))
  (= (to_rep2 s__split_fields24) (+ (to_rep2 s__split_fields16) 1))))

;; H
  (assert (not (= i2 (to_rep1 (last (rt cards))))))
...
;; WP_parameter_def
 ;; File "patience.ads", line 27, characters 0-0
  (not (= (inv (mk___rep s__split_fields32)) true)))
(check-sat)
(exit)
