...
;; H
  ...
  (and
  (and
  (and (= (length3 o5) (length s))
  (forall ((temp___431 Int))
  (=> (and (in_range3 temp___431) (= (iter_has_element o5 temp___431) true))
  (= (has_key (model__ s) (get o5 temp___431)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o5 key2)) (= (get o5 (find o5 key2)) key2)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o5 (get o5 i1)) i1))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length s)))
  (=> (= (get o5 i1) (get o5 j)) (= i1 j)))))))))
