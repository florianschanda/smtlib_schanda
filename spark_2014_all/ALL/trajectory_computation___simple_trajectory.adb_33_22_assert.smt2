...
;; delta_speed__def_axiom
  ...
  (= delta_speed (add RNE1 drag
                 (mul RNE1 (mul RNE1 factor fliteral5) fliteral6))))

;; n_bv__def_axiom
  (assert (= n_bv ((_ int2bv 16) n)))

(declare-fun new_speed () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun new_speed1 () t)
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite new_speed)))
...
;; H
  (assert
  (= (add RNE1 drag (mul RNE1 (mul RNE1 factor fliteral5) fliteral6)) 
  delta_speed))
...
;; H
  (assert
  (and (= o (add RNE1 old_speed delta_speed)) (tqtisFinite
  (add RNE1 old_speed delta_speed))))
