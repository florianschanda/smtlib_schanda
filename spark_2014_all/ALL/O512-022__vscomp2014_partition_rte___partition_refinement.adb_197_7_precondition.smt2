...
;; range_axiom
  (assert
  (forall ((x index)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun default_initial_assumption ((temp___expr_332 us_rep)
  (temp___skip_top_level_333 Bool)) Bool (= (to_rep1
                                            (rec__partition_refinement__partitioning_sets__cursor__node
                                            (us_split_fields1
                                            temp___expr_332))) 0))
...
(define-fun us_rep___7__projection ((a us_rep1)) us_split_discrs (us_split_discrs1
                                                                 a))
...
(define-fun default_initial_assumption2 ((temp___expr_371 us_rep)
  (temp___skip_top_level_372 Bool)) Bool (= (to_rep1
                                            (rec__partition_refinement__partitioning_sets__cursor__node
                                            (us_split_fields1
                                            temp___expr_371))) 0))
...
(define-fun element ((container us_rep1)
  (position us_rep)) Int (get1 (model__ container)
...
(define-fun us_rep___12__projection ((a us_rep4)) us_split_fields4 (us_split_fields5
                                                                   a))
...
(((mk_cursor__ref1 (cursor__content1 us_rep4)))))
(define-fun cursor__ref___2__projection ((a cursor__ref1)) us_rep4 (cursor__content1
                                                                   a))
...
(define-fun us_rep___10__projection ((a us_rep5)) us_split_discrs2 (us_split_discrs3
                                                                   a))

(define-fun us_rep___11__projection ((a us_rep5)) us_split_fields6 (us_split_fields7
                                                                   a))
...
(define-fun map__ref___2__projection ((a map__ref2)) us_rep5 (map__content2
                                                             a))
...
(((mk_map__ref3 (map__content3 us_rep6)))))
(define-fun map__ref___4__projection ((a map__ref3)) us_rep6 (map__content3
                                                             a))

(declare-datatypes ((key_type__ref1 0))
(((mk_key_type__ref1 (key_type__content1 us_rep4)))))
(define-fun key_type__ref___4__projection ((a key_type__ref1)) us_rep4
...
(define-fun sequence__ref___2__projection ((a sequence__ref1)) us_rep7
...
(((mk_key_type__ref2 (key_type__content2 key_type)))))
(define-fun key_type__ref___2__projection ((a key_type__ref2)) key_type
  (key_type__content2 a))

(define-fun dynamic_invariant3 ((temp___expr_497 Int)
...
;; key__post__dispatch_axiom
  ...
  (forall ((position us_rep4)) (! (dynamic_invariant3
...
(((mk_map__ref4 (map__content4 us_rep8)))))
(define-fun map__ref___3__projection ((a map__ref4)) us_rep8 (map__content4
                                                             a))
...
(((mk_inverse_set__ref (inverse_set__content us_rep5)))))
...
;; range_axiom
  (assert
  (forall ((x partition_index)) (! (in_range10
...
(define-fun us_rep___13__projection ((a us_rep9)) us_split_fields8 (us_split_fields9
                                                                   a))
...
(((mk_interval__ref (interval__content us_rep9)))))
...
(define-fun element_type__ref___8__projection ((a element_type__ref3)) us_rep9
...
;; range_axiom
  (assert
  (forall ((x capacity_range)) (! (in_range12
...
(define-fun us_split_discrs___3__projection ((a us_split_discrs4)) capacity_range
...
(define-fun us_rep___14__projection ((a us_rep10)) us_split_discrs4 (us_split_discrs5
                                                                    a))

(define-fun us_rep___15__projection ((a us_rep10)) us_split_fields10
  (us_split_fields11 a))
...
(((mk_vector__ref (vector__content us_rep10)))))
...
(((mk_element_type__ref4 (element_type__content4 us_rep9)))))
(define-fun element_type__ref___9__projection ((a element_type__ref4)) us_rep9
...
(((mk_sequence__ref2 (sequence__content2 us_rep11)))))
(define-fun sequence__ref___3__projection ((a sequence__ref2)) us_rep11
...
(define-fun bool_eq12 ((a (Array Int partition_index)) (a__first Int)
...
(define-fun dynamic_invariant8 ((temp___expr_305 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_706 Int)
...
(define-fun oeq3 ((left us_rep3)
  (right us_rep3)) Bool (and (= (length5 left) (length5 right)) (ite
                                                                (forall
                                                                ((n Int))
                                                                (=>
                                                                (and (<= 1 n)
...
(define-fun default_initial_assumption3 ((temp___expr_364 us_rep3)
  (temp___skip_top_level_365 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_365 true))
                                         (= (length5 temp___expr_364) 0)))

;; model____post_axiom
  (assert
  (forall ((container us_rep1))
  (! (= (length5 (model__ container)) (length container)) :pattern ((model__
                                                                    container)) )))
...
(define-fun dynamic_invariant10 ((temp___expr_357 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length5 container)))
     ...
     true))) :pattern ((length5 container)) )))
...
(define-fun element_type__ref___2__projection ((a element_type__ref5)) element_type3
  (element_type__content5 a))

(define-fun dynamic_invariant11 ((temp___expr_351 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length6 container)))
     ...
     (dynamic_invariant result true false true))) :pattern ((length6
                                                            container)) )))

;; length__post__dispatch_axiom
  (assert
  (forall ((attr__tag Int))
  (forall ((container us_rep5)) (! (dynamic_invariant
  (length7 attr__tag container) true false
  true) :pattern ((length7 attr__tag container)) ))))
...
(define-fun k_is_find ((container us_rep7) (key2 Int)
  (position Int)) Bool (and (ite (< 0 position)
                            ...
                            key2) (of_int 1)) (ite (< position (length4
                                                               container))
                                              (k_smaller_than_range container
                                              (+ position 1)
                                              (length4 container) key2)
                                              (of_int 1))))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq15 a b) (oeq2 a b)) :pattern ((user_eq15 a b)) )))
...
(((mk_key_type__ref3 (key_type__content3 key_type1)))))
(define-fun key_type__ref___3__projection ((a key_type__ref3)) key_type1
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     (and
     (and
     (and (= (length4 result) (length6 container))
     ...
     (= (equivalent_keys (get2 result (find result key2)) key2) true)))))
     (forall ((i Int))
     (=> (and (<= 1 i) (<= i (length6 container)))
...
;; positions__post_axiom
  ...
  (! (let ((result (positions1 container)))
     ...
     (and
     (and (<= 1 (get3 result i)) (<= (get3 result i) (length6 container)))
     (forall ((j us_rep4))
     (=> (= (has_key1 result j) true)
     (=> (= (get3 result i) (get3 result j)) (= (bool_eq5 i j) true))))))))) :pattern (
...
(define-fun element_type__ref___5__projection ((a element_type__ref6)) element_type4
...
(define-fun element_type__ref___6__projection ((a element_type__ref7)) element_type5
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k us_rep4))
     (and (= (has_key1 container k) true) (= (bool_eq5 k key2) true)))
...
(define-fun element_type__ref___7__projection ((a element_type__ref8)) element_type6
...
;; w_get__post_axiom
  ...
  (forall ((witness3 Int))
  (! (=>
     (and (dynamic_invariant witness3 true true true)
...
(define-fun oeq5 ((left us_rep11)
  (right us_rep11)) Bool (and (= (length3 left) (length3 right)) (ite
                                                                 (forall
                                                                 ((n Int))
                                                                 (=>
                                                                 (and
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq25 a b) (oeq5 a b)) :pattern ((user_eq25 a b)) )))
...
(define-fun default_initial_assumption7 ((temp___expr_770 us_rep11)
  (temp___skip_top_level_771 Bool)) Bool (=>
                                         ...
                                         (= (length3 temp___expr_770) 0)))

;; model____post_axiom
  (assert
  (forall ((container us_rep10))
  (! (= (length3 (model__2 container)) (length2 container)) :pattern (
  (model__2 container)) )))
...
(declare-const p__split_fields4 us_split_fields__ref5)
...
(declare-const p__split_fields5 us_split_fields10)
...
(declare-const p__split_fields6 us_split_fields__ref5)
...
(declare-const p__split_fields7 us_split_fields10)
...
;; H
  ...
  (ite (= (= (length x) 0) true)
  (= (bool_eq1 partition_refinement__refine__c__assume no_element) true)
  (and
  (= (has_key (positions x) partition_refinement__refine__c__assume) true)
  (= (get (positions x) partition_refinement__refine__c__assume) 1)))))
...
;; H
  (assert (=> (= result1 true) (= temp___1136 a)))

;; H
  (assert (=> (= result1 true) (= temp___1135 (mk___rep c__split_fields1))))
...
;; H
  (assert
  (=> (= result1 true)
  (= temp___1134 (mk___rep5 p__split_discrs
                 (mk___split_fields5 p__split_fields)))))

;; H
  (assert
  (=> (= result1 true)
  (= temp___1133 (mk___rep3 d__split_discrs
                 (mk___split_fields3 d__split_fields)))))

;; H
  (assert (=> (= result1 true) (= temp___1142 (mk_int__ref 0))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o2 (element x (mk___rep c__split_fields1)))
  (and (in_range7 o2)
  (= o2 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields1))))))))
...
;; H
  ...
  (= (capacity (mk___rep5 p__split_discrs p__split_fields2)) (capacity
                                                             ...
                                                             p__split_fields))))
  (and
  (= (length2 (mk___rep5 p__split_discrs p__split_fields2)) (length2
                                                            (mk___rep5
                                                            p__split_discrs
                                                            (mk___split_fields5
                                                            p__split_fields))))
  ...
  (= (oeq2
     (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)))
     (keys (mk___rep3 d__split_discrs d__split_fields2))) true))))))))

;; H
  (assert
  (=> (= result1 true)
  (ite (= (ite (= (bool_eq1 (mk___rep c__split_fields1) no_element) false) (=
          (get (positions x) (mk___rep c__split_fields1)) (length x)) true) true)
  (= (bool_eq1 (mk___rep c__split_fields2) no_element) true)
  (and (= (has_key (positions x) (mk___rep c__split_fields2)) true)
  (= (get (positions x) (mk___rep c__split_fields2)) (+ (get (positions x)
                                                        (mk___rep
                                                        c__split_fields1)) 1))))))
...
;; H
  (assert
  (=> (= result1 true)
  (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) temp___1137)))

;; H
  (assert
  (=> (= result1 true)
  (= (length2 (mk___rep5 p__split_discrs p__split_fields3)) temp___1138)))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= (bool_eq1 (mk___rep c__split_fields3) no_element) true)
  (= o3 (length x)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= (bool_eq1 (mk___rep c__split_fields3) no_element) true))
  (= o3 (- (get (positions x) (mk___rep c__split_fields3)) 1)))))

;; H
  (assert
  (=> (= result1 true)
  (= result2 (let ((subject temp___1142)) (mk_int__ref temp___11421)))))

;; H
  (assert
  (=> (= result1 true) (= (let ((subject temp___1142)) temp___11422) o3)))

;; H
  (assert
  (=> (= result1 true)
  (and (= o4 (has_key (positions x) (mk___rep c__split_fields3)))
  (= (= o4 true)
  (= (has_key (positions x) (mk___rep c__split_fields3)) true)))))

;; H
  (assert
  (=> (= result1 true) (= result3 (ite (not (= o4 true)) true false))))
...
;; H
  (assert
  (=> (= result1 true)
  (= c__split_fields4 (mk___split_fields__ref c__split_fields3))))

;; H
  (assert
  (=> (= result1 true)
  (= p__split_fields4 (mk___split_fields__ref5 p__split_fields3))))

;; H
  (assert
  (=> (= result1 true)
  (= d__split_fields4 (mk___split_fields__ref3 d__split_fields3))))

;; H
  (assert (=> (= result1 true) (= a4 (mk_map__ref a3))))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= c__split_fields6 (mk___split_fields__ref c__split_fields1))))

;; H
  (assert
  (=> (not (= result1 true))
  (= p__split_fields6 (mk___split_fields__ref5
                      (mk___split_fields5 p__split_fields)))))

;; H
  (assert
  (=> (not (= result1 true))
  (= d__split_fields6 (mk___split_fields__ref3
                      (mk___split_fields3 d__split_fields)))))

;; H
  (assert (=> (not (= result1 true)) (= a6 (mk_map__ref a))))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 807, characters 0-0
  ...
  (<= (* 2 (length2
           (mk___rep5 p__split_discrs
           (us_split_fields__content5 p__split_fields6)))) (capacity
                                                           (mk___rep5
                                                           p__split_discrs
