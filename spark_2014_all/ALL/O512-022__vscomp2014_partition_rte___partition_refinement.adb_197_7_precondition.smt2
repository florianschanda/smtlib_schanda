...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (=> (= (get result i) (get result j)) (= (bool_eq6 i j) true))))))))) :pattern (
  (positions container)) )))
...
(define-fun bool_eq12 ((a us_rep4)
...
(declare-fun bool_eq14 (us_rep6 us_rep6) Bool)
...
(declare-fun bool_eq17 (us_rep8 us_rep8) Bool)
...
(declare-fun user_eq17 (element_type2 element_type2) Bool)

(declare-fun dummy18 () element_type2)
...
(declare-fun dummy20 () partition_index)
...
(declare-fun user_eq19 (index_type index_type) Bool)

(declare-fun dummy21 () index_type)
...
(define-fun bool_eq21 ((a us_rep9)
...
(define-fun element_type__ref_8__projection ((a element_type__ref3)) us_rep9 
...
(declare-fun user_eq21 (capacity_range capacity_range) Bool)

(declare-fun dummy23 () capacity_range)
...
(define-fun element_type__ref_9__projection ((a element_type__ref4)) us_rep9 
...
(declare-fun bool_eq23 (us_rep11 us_rep11) Bool)

(declare-fun user_eq23 (us_rep11 us_rep11) Bool)
...
(define-fun bool_eq24 ((a (Array Int partition_index)) (a__first Int)
...
(declare-fun user_eq24 (extended_index extended_index) Bool)

(declare-fun dummy27 () extended_index)
...
(define-fun element_type__ref_2__projection ((a element_type__ref5)) element_type3 
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq14 a b) (oeq2 a b)) :pattern ((user_eq14 a b)) )))
...
;; positions__post_axiom
  ...
  (! (let ((result (positions1 container)))
     ...
     (=> (= (get3 result i) (get3 result j)) (= (bool_eq12 i j) true))))))))) :pattern (
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k us_rep4))
     (and (= (has_key1 container k) true) (= (bool_eq12 k key2) true)))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq23 a b) (oeq5 a b)) :pattern ((user_eq23 a b)) )))
...
(declare-fun temp___1155 () count_type)

(declare-fun partition_refinement__refine__c__assume () us_rep)

(declare-fun temp___1136 () (Array Int positive))

(declare-fun temp___1135 () us_rep)

(declare-fun temp___1138 () Int)

(declare-fun temp___1137 () Int)

(declare-fun temp___1134 () us_rep10)

(declare-fun temp___1133 () us_rep5)

(declare-fun temp___1142 () int__ref)
...
(declare-fun temp___11421 () Int)

(declare-fun result2 () int__ref)

(declare-fun temp___11422 () Int)

(declare-fun result3 () Bool)

(declare-fun a4 () map__ref)

(declare-fun d__split_fields4 () us_split_fields__ref3)

(declare-fun p__split_fields4 () us_split_fields__ref5)

(declare-fun c__split_fields4 () us_split_fields__ref)

(declare-fun a5 () (Array Int positive))

(declare-fun d__split_fields5 () us_split_fields6)

(declare-fun p__split_fields5 () us_split_fields10)

(declare-fun c__split_fields5 () us_split_fields)

(declare-fun a6 () map__ref)

(declare-fun d__split_fields6 () us_split_fields__ref3)

(declare-fun p__split_fields6 () us_split_fields__ref5)

(declare-fun c__split_fields6 () us_split_fields__ref)

(declare-fun a7 () (Array Int positive))

(declare-fun d__split_fields7 () us_split_fields6)

(declare-fun p__split_fields7 () us_split_fields10)

(declare-fun c__split_fields7 () us_split_fields)
...
;; H
  (assert
  (=> (= result1 true)
  (=> (= (bool_eq6 (mk___rep c__split_fields3) no_element) true)
  (= o3 (length x)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= (bool_eq6 (mk___rep c__split_fields3) no_element) true))
