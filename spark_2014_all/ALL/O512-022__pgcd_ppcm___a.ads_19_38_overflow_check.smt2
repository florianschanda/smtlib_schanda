...
;; H
  (assert
  (=> (not (= a__ppcm__result4 0)) (and (= o8 (* a b)) (in_range1 (* a b)))))
...
;; H
  ...
  (= o11 (ite (<= a__ppcm__result4 o10) true false))))

;; H
  (assert
  (=> (not (= a__ppcm__result4 0)) (and (= o7 (abs a)) (in_range1 (abs a)))))

;; H
  (assert
  (=> (not (= a__ppcm__result4 0))
  (= o12 (ite (<= o7 a__ppcm__result4) true false))))

;; H
  (assert
  (=> (not (= a__ppcm__result4 0)) (= result3 (ite (= o12 true) o11 false))))
