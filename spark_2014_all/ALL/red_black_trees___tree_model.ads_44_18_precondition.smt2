...
;; H
  (assert
  (and (= o11 (length q)) (and (in_range3 o11) (<= (+ 0 o11) 2147483647))))

;; H
  (assert
  (and (= o8 (length v)) (and (in_range3 o8) (<= (+ 0 o8) 2147483647))))

;; H
  (assert
  (and (= o9 (length p)) (and (in_range3 o9) (<= (+ 0 o9) 2147483647))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o6 (length q)) (and (in_range3 o6) (<= (+ 0 o6) 2147483647)))))
