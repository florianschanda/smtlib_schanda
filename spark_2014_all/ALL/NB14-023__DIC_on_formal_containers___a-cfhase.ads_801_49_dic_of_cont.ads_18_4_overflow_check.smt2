...
(define-fun sequence__ref_3__projection ((a sequence__ref)) us_rep1 (sequence__content
                                                                    a))
...
(define-fun default_initial_assumption ((temp___expr_808 us_rep1)
...
(define-fun default_initial_assumption1 ((temp___expr_777 us_rep2)
...
;; H
  ...
  (and (in_range1 o)
  (<= o (to_rep1
        (rec__dic_of_cont__my_hase__set__capacity (us_split_discrs1 right)))))))
