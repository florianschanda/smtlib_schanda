...
(declare-fun discr__r6__with_bad_default1__d__first__bit () Int)

(declare-fun discr__r6__with_bad_default1__d__last__bit () Int)

(declare-fun discr__r6__with_bad_default1__d__position () Int)
...
(declare-fun discr__r6__with_bad_default2__d__first__bit () Int)

(declare-fun discr__r6__with_bad_default2__d__last__bit () Int)

(declare-fun discr__r6__with_bad_default2__d__position () Int)
