...
(((mk_tarray1D1__ref (tarray1D1__content integer)))))
...
(((mk_array1__ref (array1__content us_t)))))
(define-fun array1__ref___projection ((a array1__ref)) us_t (array1__content
                                                            a))

(declare-datatypes ((map__ref1 0))
(((mk_map__ref1 (map__content1 (Array Int us_t))))))
...
(define-fun bool_eq2 ((a (Array Int us_t)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq1 (select a temp___idx_135)
...
(((mk_tarray2D1__ref (tarray2D1__content tarray2D1)))))
...
(((mk_tarray1B__ref (tarray1B__content us_t2)))))
