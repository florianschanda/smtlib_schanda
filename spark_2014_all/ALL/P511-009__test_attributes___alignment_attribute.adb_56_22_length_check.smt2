...
(define-fun bool_eq4 ((a (Array Int us_t)) (a__first Int) (a__last Int)
...
(declare-fun dummy3 () (Array Int us_t))
...
;; H
  (assert
  (= (to_rep (last2 (rt1 (alignment_attribute__q__a1__aggregate_def 1 1 x)))) 
  x))
...
;; WP_parameter_def
 ;; File "alignment_attribute.adb", line 47, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___2721)) (to_rep (last2 temp___2721)))
     (+ (- (to_rep (last2 temp___2721)) (to_rep (first2 temp___2721))) 1) 0) 
  (ite (<= 1 x) (+ (- x 1) 1) 0))))
(check-sat)
