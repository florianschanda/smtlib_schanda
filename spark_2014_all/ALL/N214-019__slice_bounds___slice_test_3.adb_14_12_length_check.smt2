...
(declare-datatypes ((t1b__ref 0)) (((mk_t1b__ref (t1b__content tindexB)))))
...
(declare-datatypes ((t3b__ref 0)) (((mk_t3b__ref (t3b__content tindexB)))))
...
;; H
  (assert
  (=> (<= k l) (and (and (<= 1 k) (<= k 8)) (and (<= 1 l) (<= l 8)))))
...
;; WP_parameter_def
 ;; File "slice_test_3.ads", line 9, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___1501)) (to_rep1 (last2 temp___1501)))
     (+ (- (to_rep1 (last2 temp___1501)) (to_rep1 (first2 temp___1501))) 1)
     0) (ite (<= i j) (+ (- j i) 1) 0))))
(check-sat)
(exit)
