...
;; H
  ...
  true true true)
  (forall ((temp___1225 Int))
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1225)
  (<= temp___1225 (to_rep1 (last number__split_fields3))))
  (=> (<= i2 temp___1225)
  (= (select number__split_fields2 temp___1225) (select number__split_fields temp___1225))))))
  (and (<= 1 i2) (<= i2 r122b))))
