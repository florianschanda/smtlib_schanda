...
(declare-const x86__dx__result (_ BitVec 16))

(declare-const result (_ BitVec 16))

(declare-const x86__dx__result1 (_ BitVec 16))

(declare-const x86__dx__result2 (_ BitVec 16))

(declare-const x86__dx__result3 (_ BitVec 16))

(declare-const x86__dx__result4 (_ BitVec 16))

(declare-const x86__dx__result5 (_ BitVec 16))

(declare-const result1 (_ BitVec 16))

;; H
  (assert (= x86__dx__result1 x86__dx__result2))

;; H
  (assert (= x86__dx__result3 x86__dx__result1))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__dx__result)))

;; H
  (assert
  (= x86__dx__result1 ((_ extract 15 0) (bvand rdx ((_ int2bv 64) 65535)))))

;; H
  (assert (= (mk_t__ref x86__dx__result4) (mk_t__ref x86__dx__result2)))

;; H
  (assert (= x86__dx__result5 x86__dx__result3))

;; H
  (assert (= result1 x86__dx__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not
  (= x86__dx__result4 ((_ extract 15 0) (bvand rdx ((_ int2bv 64) 65535))))))
(check-sat)
(exit)
