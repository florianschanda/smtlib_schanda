...
(declare-fun dynamic_preds_array__update_even_close_pair__x () (Array Int even))

(declare-fun dynamic_preds_array__update_even_close_pair__x1 () (Array Int even))
...
;; H
  (assert (dynamic_invariant2 dynamic_preds_array__update_even_close_pair__x1
  true true true))
