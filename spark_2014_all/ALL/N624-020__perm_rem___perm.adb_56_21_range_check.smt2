...
;; H
  (assert
  (and (= o1 (get_witness a b o))
  (and (in_range2 o1)
  (and (and (<= (to_rep2 (first (rt b))) o1) (<= o1 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) o)) (to_rep (select (elts b) o1)))
  (= (is_perm (remove a o) (remove b o1)) true))))))
