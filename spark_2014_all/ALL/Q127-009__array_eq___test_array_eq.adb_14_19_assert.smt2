...
(declare-const test_array_eq__my_rec__f1__first__bit Int)

(declare-const test_array_eq__my_rec__f1__last__bit Int)

(declare-const test_array_eq__my_rec__f1__position Int)
...
(declare-const test_array_eq__my_rec__f2__first__bit Int)

(declare-const test_array_eq__my_rec__f2__last__bit Int)

(declare-const test_array_eq__my_rec__f2__position Int)
...
;; def_axiom
  ...
  (let ((temp___188 (test_array_eq__a__aggregate_def temp___189 temp___190)))
...
;; def_axiom
  ...
  (let ((temp___192 (test_array_eq__b__aggregate_def temp___193 temp___194)))
...
;; WP_parameter_def
 ;; File "test_array_eq.adb", line 7, characters 0-0
  (not (= (bool_eq1 a1 1 2 b1 1 2) true)))
(check-sat)
(exit)
