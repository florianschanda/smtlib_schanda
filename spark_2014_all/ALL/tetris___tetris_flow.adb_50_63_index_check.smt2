...
(declare-fun tetris_flow__piece__s__first__bit () Int)

(declare-fun tetris_flow__piece__s__last__bit () Int)

(declare-fun tetris_flow__piece__s__position () Int)
...
(declare-fun tetris_flow__piece__d__first__bit () Int)

(declare-fun tetris_flow__piece__d__last__bit () Int)

(declare-fun tetris_flow__piece__d__position () Int)
...
(declare-fun tetris_flow__piece__x__first__bit () Int)

(declare-fun tetris_flow__piece__x__last__bit () Int)

(declare-fun tetris_flow__piece__x__position () Int)
...
(declare-fun tetris_flow__piece__y__first__bit () Int)

(declare-fun tetris_flow__piece__y__last__bit () Int)

(declare-fun tetris_flow__piece__y__position () Int)
