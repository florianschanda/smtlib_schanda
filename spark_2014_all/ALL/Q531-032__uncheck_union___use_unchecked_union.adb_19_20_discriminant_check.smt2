...
(((mk_small_record__ref (small_record__content us_rep)))))
...
(((mk_big_record__ref (big_record__content us_rep1)))))
...
(((mk_myunion__ref (myunion__content us_rep2)))))
...
(declare-datatypes ((t4b__ref 0)) (((mk_t4b__ref (t4b__content us_rep2)))))
