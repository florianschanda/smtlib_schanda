...
(declare-fun dummy1 () (Array Int integer))
...
(declare-fun use_unchecked_union__small_record__field1__first__bit () Int)

(declare-fun use_unchecked_union__small_record__field1__last__bit () Int)

(declare-fun use_unchecked_union__small_record__field1__position () Int)
...
(declare-fun use_unchecked_union__small_record__field2__first__bit () Int)

(declare-fun use_unchecked_union__small_record__field2__last__bit () Int)

(declare-fun use_unchecked_union__small_record__field2__position () Int)
...
(define-fun us_split_fields_field12__projection ((a us_split_fields2)) integer
  (rec__use_unchecked_union__big_record__field1 a))

(define-fun us_split_fields_field22__projection ((a us_split_fields2)) (Array Int integer)
...
(declare-fun use_unchecked_union__big_record__field1__first__bit () Int)

(declare-fun use_unchecked_union__big_record__field1__last__bit () Int)

(declare-fun use_unchecked_union__big_record__field1__position () Int)
...
(declare-fun use_unchecked_union__big_record__field2__first__bit () Int)

(declare-fun use_unchecked_union__big_record__field2__last__bit () Int)

(declare-fun use_unchecked_union__big_record__field2__position () Int)
...
(declare-fun use_unchecked_union__myunion__discr__first__bit () Int)

(declare-fun use_unchecked_union__myunion__discr__last__bit () Int)

(declare-fun use_unchecked_union__myunion__discr__position () Int)
...
(declare-fun use_unchecked_union__myunion__record1__first__bit () Int)

(declare-fun use_unchecked_union__myunion__record1__last__bit () Int)

(declare-fun use_unchecked_union__myunion__record1__position () Int)
...
(declare-fun use_unchecked_union__myunion__record2__first__bit () Int)

(declare-fun use_unchecked_union__myunion__record2__last__bit () Int)

(declare-fun use_unchecked_union__myunion__record2__position () Int)
...
(declare-fun output__attr__constrained () Bool)
...
(declare-fun use_unchecked_union__myunion__discr__first__bit1 () Int)

(declare-fun use_unchecked_union__myunion__discr__last__bit1 () Int)

(declare-fun use_unchecked_union__myunion__discr__position1 () Int)
...
(declare-fun use_unchecked_union__myunion__record2__first__bit1 () Int)

(declare-fun use_unchecked_union__myunion__record2__last__bit1 () Int)

(declare-fun use_unchecked_union__myunion__record2__position1 () Int)
...
(declare-fun use_unchecked_union__myunion__record1__first__bit1 () Int)

(declare-fun use_unchecked_union__myunion__record1__last__bit1 () Int)

(declare-fun use_unchecked_union__myunion__record1__position1 () Int)
...
(declare-fun use_unchecked_union__myunion__discr__first__bit2 () Int)

(declare-fun use_unchecked_union__myunion__discr__last__bit2 () Int)

(declare-fun use_unchecked_union__myunion__discr__position2 () Int)
...
(declare-fun use_unchecked_union__myunion__record1__first__bit2 () Int)

(declare-fun use_unchecked_union__myunion__record1__last__bit2 () Int)

(declare-fun use_unchecked_union__myunion__record1__position2 () Int)
...
(declare-fun use_unchecked_union__myunion__record2__first__bit2 () Int)

(declare-fun use_unchecked_union__myunion__record2__last__bit2 () Int)

(declare-fun use_unchecked_union__myunion__record2__position2 () Int)
...
(declare-fun use_unchecked_union__myunion__discr__first__bit3 () Int)

(declare-fun use_unchecked_union__myunion__discr__last__bit3 () Int)

(declare-fun use_unchecked_union__myunion__discr__position3 () Int)
...
(declare-fun use_unchecked_union__myunion__record1__first__bit3 () Int)

(declare-fun use_unchecked_union__myunion__record1__last__bit3 () Int)

(declare-fun use_unchecked_union__myunion__record1__position3 () Int)
...
(declare-fun use_unchecked_union__myunion__record2__first__bit3 () Int)

(declare-fun use_unchecked_union__myunion__record2__last__bit3 () Int)

(declare-fun use_unchecked_union__myunion__record2__position3 () Int)
...
;; def_axiom
  ...
  (and
  (and (= (select temp___198 0) (of_rep temp___199))
  (= (select temp___198 1) (of_rep temp___200)))
  (= (select temp___198 2) (of_rep temp___201))))))
...
;; def_axiom
  ...
  (temp___211 Int))
  (let ((temp___207 (temp___206 temp___208 temp___209 temp___210 temp___211)))
  (and
  (and
  (and (= (select temp___207 0) (of_rep temp___208))
  (= (select temp___207 1) (of_rep temp___209)))
  (= (select temp___207 2) (of_rep temp___210)))
  (= (select temp___207 3) (of_rep temp___211))))))
...
;; def_axiom
  ...
  (and
  (and
  (and (= (select temp___217 0) (of_rep temp___218))
  (= (select temp___217 1) (of_rep temp___219)))
  (= (select temp___217 2) (of_rep temp___220)))
  (= (select temp___217 3) (of_rep temp___221))))))
...
(declare-fun output__split_discrs () integer)
...
(declare-fun o4 () us_split_fields4)

(declare-fun o5 () us_split_discrs)

(declare-fun temp___223 () us_rep2)
...
;; H
  (assert (= o2 (mk___split_fields1 o1 (temp___216 0 0 0 0))))
...
;; H
  (assert (= temp___223 (mk___rep2 o5 o4 true)))
...
;; WP_parameter_def
 ;; File "use_unchecked_union.ads", line 33, characters 0-0
  (not
  (= (rec__use_unchecked_union__myunion__discr (us_split_discrs1 temp___223))
  output__split_discrs)))
(check-sat)
(exit)
