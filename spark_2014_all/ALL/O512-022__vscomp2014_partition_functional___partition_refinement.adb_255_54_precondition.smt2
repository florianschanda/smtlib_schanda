...
;; H
  (assert
  (forall ((c1 us_rep4))
  (=> (= (has_key1 (positions1 d_old) c1) true)
  (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c1) true))))
...
;; H
  (assert
  (and
  (= o1 (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2))
        c))
  (= (= o1 true)
...
;; H
  (assert
  (and (= o3 (key (mk___rep3 d__split_discrs d__split_fields2) c))
  (and (in_range7 o3)
  (= o3 (get2 (keys (mk___rep3 d__split_discrs d__split_fields2))
