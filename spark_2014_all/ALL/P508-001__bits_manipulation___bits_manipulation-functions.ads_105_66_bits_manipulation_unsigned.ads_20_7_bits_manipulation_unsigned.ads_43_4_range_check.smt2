...
;; H
  ...
  (= o (ite (and (<= 1 16) (<= 16 8))
       ((_ zero_extend 8) (ite (< n 8)
                          (bvlshr ((_ extract 7 0) val__) ((_ int2bv 8)
                          n)) ((_ int2bv 8) 0)))
       (ite (and (<= 9 16) (<= 16 16))
       (ite (< n 16) (bvlshr val__ ((_ int2bv 16) n)) ((_ int2bv 16) 0))
       (ite (and (<= 17 16) (<= 16 32))
       ((_ extract 15 0) (bvlshr ((_ zero_extend 16) val__) ((_ int2bv 32)
       n)))
       ((_ extract 15 0) (bvlshr ((_ zero_extend 48) val__) ((_ int2bv 64)
       n)))))))))
