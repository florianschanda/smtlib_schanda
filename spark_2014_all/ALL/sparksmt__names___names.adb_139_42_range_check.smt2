...
(define-fun o11 () us_rep2 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
;; H
  ...
  (= o11 (get
         (model__
         (mk___rep1 entry_table__split_discrs
         (mk___split_fields1 entry_table__split_fields))) o2))
  (= (bool_eq3 o11
     (get
     (model__
     (mk___rep1 entry_table__split_discrs
     (mk___split_fields1 entry_table__split_fields))) o2)) true)))
