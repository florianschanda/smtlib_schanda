...
(declare-fun c5 () (Array Int natural))

(declare-fun i4 () Int)

(declare-fun c6 () (Array Int natural))

(declare-fun i5 () Int)

(declare-fun c7 () (Array Int natural))

(declare-fun i6 () Int)

(declare-fun c8 () (Array Int natural))

(declare-fun i7 () Int)

(declare-fun c9 () (Array Int natural))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (= (to_rep (select c i1)) 0) (= (to_rep o) 1))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (= (to_rep (select c i1)) 0) (= o1 (store c i1 o)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (= (to_rep (select c i1)) 0) (= (mk_map__ref result1) c11))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (= (to_rep (select c i1)) 0) (= c2 o1))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= (to_rep (select c i1)) 0)) (= c2 c))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= (to_rep (select c i1)) 0)) (= c2 c1))))
...
;; H
  ...
  (=> (< i2 temp___173)
  (= (select c3 temp___173) (select temp___172 temp___173)))))
...
(declare-fun temp___181 () us_rep)

;; H
  (assert (= (has_element c8 temp___181) true))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (valid (element c8 temp___181)) true)))
(check-sat)
