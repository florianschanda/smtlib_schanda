...
(declare-fun o227 () (Array Int us_rep1))

(declare-fun o228 () us_split_fields4)

(declare-fun temp___442 () us_rep2)
...
(declare-fun result34 () us_split_fields__ref2)

(declare-fun p__split_fields36 () us_split_fields4)

(declare-fun p__split_fields37 () us_split_fields__ref2)

(declare-fun p__split_fields38 () us_split_fields4)

(declare-fun p__split_fields39 () us_split_fields__ref2)

(declare-fun success31 () bool__ref)

(declare-fun subject_scores2 () map__ref4)

(declare-fun i31 () int__ref)

(declare-fun p__split_fields40 () us_split_fields4)

(declare-fun success32 () Bool)

(declare-fun subject_scores3 () (Array Int us_rep3))
...
;; H
  (assert (<= i34 (to_rep4 p__split_fields)))
...
;; WP_parameter_def
 ;; File "pupils.ads", line 74, characters 0-0
  ...
  (= (bool_eq3
     (select (rec__pupils__pupildata__pupilentries
             (us_split_fields__content2 p__split_fields39)) i34)
     (select p__split_fields1 i34)) true)))
(check-sat)
(exit)
