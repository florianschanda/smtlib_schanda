...
;; H
  (assert (= o63 (from_integer (int__content s12))))

;; H
  (assert (= o67 (ole o63 o66)))

;; H
  (assert (and (= o58 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o61 (ite (<= n o60) true false)))

;; H
  (assert (= result9 (ite (<= 0 n) o61 false)))
...
;; H
  (assert (= o52 (oexpon o50 o51)))

;; H
  (assert (= o45 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o43 (from_integer (int__content s12))))
...
;; H
  (assert (= o46 (oadd o44 o45)))

;; H
  (assert (= o41 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o47 (oexpon__2 o41 o46)))
...
;; H
  (assert (= o40 (num_of_big_int e e_first o39)))

;; H
  (assert (= o48 (odivide o40 o47)))

;; H
  (assert (and (= o34 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert (= o35 (num_of_big_int x x_first o34)))

;; H
  (assert (= o49 (oexpon__2 o35 o48)))

;; H
  (assert (= o53 (omultiply o49 o52)))

;; H
  (assert (= o56 (omod o53 o55)))
...
;; H
  ...
  (= o33 (num_of_big_int
         ...
         (mk (to_rep aux3__first) (to_rep aux3__last))) aux3_first o32)))

;; H
  (assert (= o57 (oeq o33 o56)))
...
;; H
  (assert (= o22 (num_of_big_int x x_first o21)))
