...
(((mk___split_discrs (rec__rec__my_rec__e sub_enum)))))
...
(((mk___split_fields
  (rec__rec__my_rec__x integer)(rec__rec__my_rec__y float)))))
...
(((mk___split_discrs1 (rec__rec__sub_rec__z enum)))))
...
(((mk___split_fields1 (rec__rec__sub_rec__plop us_rep)))))
...
(((mk_sub_rec__ref (sub_rec__content us_rep1)))))
...
(define-fun t2b__ref___projection ((a1 t2b__ref)) us_rep (t2b__content a1))

(declare-datatypes ((us_split_fields4 0))
(((mk___split_fields2 (rec__rec__sub_rec__plop1 us_rep)))))
(define-fun us_split_fields_Plop__3__projection ((a1 us_split_fields4)) us_rep
  (rec__rec__sub_rec__plop1 a1))

(declare-datatypes ((us_split_fields__ref2 0))
(((mk___split_fields__ref2 (us_split_fields__content2 us_split_fields4)))))
(define-fun us_split_fields__ref___6__projection ((a1 us_split_fields__ref2)) us_split_fields4
  (us_split_fields__content2 a1))

(declare-datatypes ((us_rep2 0))
(((mk___rep2
  (us_split_discrs4 us_split_discrs2)(us_split_fields5 us_split_fields4)))))
(define-fun us_rep___11__projection ((a1 us_rep2)) us_split_discrs2 (us_split_discrs4
                                                                    a1))

(define-fun us_rep___12__projection ((a1 us_rep2)) us_split_fields4 (us_split_fields5
                                                                    a1))

(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a1)
                                           (mk___split_fields1
                                           (rec__rec__sub_rec__plop1
                                           (us_split_fields5 a1)))))
...
(define-fun in_range7 ((rec__rec__sub_rec__z1 Int)
  (a1 us_rep1)) Bool (= rec__rec__sub_rec__z1 (to_rep
...
(declare-datatypes ((tzS__ref 0)) (((mk_tzS__ref (tzS__content us_rep2)))))
(define-fun tzS__ref___projection ((a1 tzS__ref)) us_rep2 (tzS__content a1))

(define-fun dynamic_invariant1 ((temp___expr_226 us_rep2)
  (temp___is_init_223 Bool) (temp___skip_constant_224 Bool)
  (temp___do_toplevel_225 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_224 true))
                                      (in_range7 a
                                      (to_base temp___expr_226))) (in_range6
                                      a
                                      (rec__rec__sub_rec__plop1
                                      (us_split_fields5 temp___expr_226)))))
...
(define-fun dynamic_invariant5 ((temp___expr_155 us_rep1)
  (temp___is_init_152 Bool) (temp___skip_constant_153 Bool)
  (temp___do_toplevel_154 Bool)) Bool (in_range5
