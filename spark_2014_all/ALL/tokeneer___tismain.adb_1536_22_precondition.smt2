...
(declare-fun output () us_private__ref)

(declare-fun state () us_private__ref)

(declare-fun systemfault () bool__ref)

(declare-fun shutdowncompleted () bool__ref)
...
(declare-fun shutdowncompleted1 () Bool)
...
;; H
  ...
  (and
  (and
  (and (not (= (let ((subject shutdowncompleted)) shutdowncompleted1) true))
  (= (not (= (enrolmentisinprogress (let ((subject state)) state15)) true))
  (= (privatekeypresent state9) true)))
  (=>
  (and (and (= (islocked state11) true) (= (thecurrentdoor state12) 0))
  (= (greaterthanorequal (thecurrenttime currenttime)
     (alarm_timeout state12)) true))
  (or (= (isalarming Tuple0) true)
  (= (let ((subject systemfault)) systemfault1) true))))
  (or (= (= (islocked state11) true) (= (interfac_islocked Tuple0) true))
  (= (let ((subject systemfault)) systemfault1) true)))
  (=>
  (= (rolepresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1)
  (and (and (= (isgood state10) true) (= (authcertvalid state10) true))
  (= (theauthcertrole state10) 1))))
  (=>
  (and
  (= (isdoingop
     (mk___rep
  ...
  (= (statusiswaitingstartadminop (let ((subject state)) state15)) true)))
  (=>
  (or (= (statusisgotadmintoken (let ((subject state)) state15)) true)
  (= (statusiswaitingremoveadmintokenfail (let ((subject state)) state15)) true))
  (not
  (= (ispresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))
  (=>
  (or (= (statusiswaitingstartadminop (let ((subject state)) state15)) true)
  (= (statusiswaitingfinishadminop (let ((subject state)) state15)) true))
  (and
  (= (isdoingop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)
  (= (ispresent
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))
  (=> (= (statusisenclavequiescent (let ((subject state)) state15)) true)
  (not
  (= (isdoingop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))
  (=> (= (statusisshutdown (let ((subject state)) state15)) true)
  (and
  (not
  (= (isdoingop
     (mk___rep
  ...
  (=> (= (enrolmentisinprogress (let ((subject state)) state15)) true)
  (and
  (not
  (= (ispresent
     (mk___rep
...
;; H
  ...
  (= (let ((subject theadmin__split_fields))
     (mk___split_fields__ref theadmin__split_fields4)) (let ((subject
...
;; H
  (assert
  (= (let ((subject output)) (mk___private__ref output8)) (let ((subject
                                                          output))
                                                          (mk___private__ref
                                                          output4))))
...
;; H
  (assert (= state18 state12))

;; H
  (assert (= output5 output1))

;; H
  (assert (= state17 state11))
...
;; H
  (assert (= result (systemfaultoccurred state16)))
...
;; H
  (assert
  (= (let ((subject theadmin__split_fields))
     (mk___split_fields__ref theadmin__split_fields5)) (let ((subject
                                                       theadmin__split_fields))
                                                       (mk___split_fields__ref
...
;; H
  (assert
  (= (let ((subject output)) (mk___private__ref output12)) (let ((subject
                                                           output))
                                                           (mk___private__ref
                                                           output8))))
...
;; H
  (assert (= state22 state17))

;; H
  (assert (= state21 state16))
...
;; H
  (assert
  (= result1 (enrolmentisinprogress (let ((subject state)) state15))))
...
;; H
  ...
  (= o32 (isdoingop
         (mk___rep
         (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))

;; H
  (assert (=> (= result1 true) (= o33 (ite (not (= o32 true)) true false))))
...
;; H
  (assert (=> (= result1 true) (= o34 (ite (not (= o31 true)) true false))))

;; H
  (assert (=> (= result1 true) (= o35 (ite (= o34 true) o33 false))))

;; H
  (assert (=> (not (= result1 true)) (= o35 (of_int 1))))

;; H
  (assert (= result2 (statusisshutdown (let ((subject state)) state15))))
...
;; H
  (assert (=> (= result2 true) (= o28 (ite (= o27 0) true false))))
...
;; H
  (assert (=> (= result2 true) (= o29 (ite (not (= o26 true)) true false))))

;; H
  (assert (=> (= result2 true) (= o30 (ite (= o29 true) o28 false))))

;; H
  (assert (=> (not (= result2 true)) (= o30 (of_int 1))))

;; H
  (assert
  (= result3 (statusisenclavequiescent (let ((subject state)) state15))))
...
;; H
  (assert (=> (= result3 true) (= o25 (ite (not (= o24 true)) true false))))

;; H
  (assert (=> (not (= result3 true)) (= o25 (of_int 1))))

;; H
  (assert
  (= o19 (statusiswaitingfinishadminop (let ((subject state)) state15))))

;; H
  (assert
  (= o20 (statusiswaitingstartadminop (let ((subject state)) state15))))

;; H
  (assert (= result4 (ite (= o20 false) o19 true)))
...
;; H
  (assert (=> (= result4 true) (= o23 (ite (= o22 true) o21 false))))

;; H
  (assert (=> (not (= result4 true)) (= o23 (of_int 1))))

;; H
  (assert
  (= o15 (statusiswaitingremoveadmintokenfail
         (let ((subject state)) state15))))

;; H
  (assert (= o16 (statusisgotadmintoken (let ((subject state)) state15))))

;; H
  (assert (= result5 (ite (= o16 false) o15 true)))
...
;; H
  (assert (=> (= result5 true) (= o18 (ite (not (= o17 true)) true false))))

;; H
  (assert (=> (not (= result5 true)) (= o18 (of_int 1))))
...
;; H
  (assert (= result6 (ite (= o13 true) o12 false)))

;; H
  (assert
  (=> (= result6 true)
  (= o14 (statusiswaitingstartadminop (let ((subject state)) state15)))))

;; H
  (assert (=> (not (= result6 true)) (= o14 (of_int 1))))
...
;; H
  (assert (=> (= result7 true) (= o10 (ite (not (= o9 true)) true false))))

;; H
  (assert (=> (not (= result7 true)) (= o10 (of_int 1))))
...
;; H
  (assert (=> (= result8 true) (= o5 (ite (not (= o4 true)) true false))))
...
;; H
  (assert (=> (= result8 true) (= o2 (ite (= o1 3) true false))))
...
;; H
  (assert (=> (= result8 true) (= o6 (ite (= o3 true) o2 false))))

;; H
  (assert (=> (= result8 true) (= o7 (ite (= o6 false) o5 true))))

;; H
  (assert (=> (not (= result8 true)) (= o7 (of_int 1))))
...
;; WP_parameter_def
 ;; File "tismain.adb", line 134, characters 0-0
  ...
  (= (isdoingop
     (mk___rep
     (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)))
(check-sat)
(exit)
