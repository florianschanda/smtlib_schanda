...
;; H
  (assert
  (=> (= result3 true)
  (and (= o13 (length1 model____split_fields1)) (in_range6 o13))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o9 (length1 model____split_fields1)) (in_range6 o9))))

;; H
  (assert
  (=> (= result2 true)
  (and (= o10 (length model____split_fields))
  (and (in_range6 o10) (<= (+ 0 o10) 2147483647)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result4 (ite (< 0 o7) true false)))))
...
;; H
  ...
  (=> (not (= first_available 0))
  (=> (= result4 true)
  (and (= o6 (get model____split_fields 1)) (in_range7 o6))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result4 true) (= result (ite (= o6 first_available) true false))))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_available 0))) (= result (ite (= o8 0) true false)))))
