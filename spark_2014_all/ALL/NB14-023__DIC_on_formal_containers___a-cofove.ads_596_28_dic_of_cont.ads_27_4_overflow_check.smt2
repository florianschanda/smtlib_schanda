...
(define-fun dynamic_invariant1 ((temp___expr_1497 Int)
  (temp___is_init_1494 Bool) (temp___skip_constant_1495 Bool)
  (temp___do_toplevel_1496 Bool)) Bool (=>
                                       (or (= temp___is_init_1494 true)
...
(define-fun dynamic_invariant2 ((temp___expr_1503 Int)
...
(define-fun index_type__ref___6__projection ((a index_type__ref)) index_type
  (index_type__content a))

(define-fun dynamic_invariant3 ((temp___expr_1485 Int)
  (temp___is_init_1482 Bool) (temp___skip_constant_1483 Bool)
  (temp___do_toplevel_1484 Bool)) Bool (=>
                                       (or (= temp___is_init_1482 true)
...
(define-fun default_initial_assumption ((temp___expr_1537 us_rep1)
  (temp___skip_top_level_1538 Bool)) Bool (=>
                                          (not
                                          (= temp___skip_top_level_1538 true))
                                          (= (length1 temp___expr_1537) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_1530 Int)
  (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool)
  (temp___do_toplevel_1529 Bool)) Bool (=>
                                       (or (= temp___is_init_1527 true)
...
(define-fun dynamic_invariant5 ((temp___expr_1524 Int)
  (temp___is_init_1521 Bool) (temp___skip_constant_1522 Bool)
  (temp___do_toplevel_1523 Bool)) Bool (=>
                                       (or (= temp___is_init_1521 true)
