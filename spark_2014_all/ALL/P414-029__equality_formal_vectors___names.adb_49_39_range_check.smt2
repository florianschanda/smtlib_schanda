...
;; def_axiom
  ...
  (forall ((temp___426 (_ BitVec 32)))
  (= (select (names__hash_table__aggregate_def temp___425) temp___426)
  (of_rep1 temp___425)))))
