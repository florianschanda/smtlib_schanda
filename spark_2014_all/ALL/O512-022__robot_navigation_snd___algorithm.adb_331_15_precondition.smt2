...
;; H
  (assert
  (and
  (= o9 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep2
                                                                  (rec__robot_iface__proxy__scan_res
                                                                  (us_split_fields5
                                                                  (rec__algorithm__controller__robot
                                                                  (let ((subject
...
;; H
  (assert (= o7 (us_split_fields7 o6)))

;; H
  (assert (= o8 (rec__gaps__gap__bearing o7)))
...
;; H
  (assert (and (= o10 (ccwdiff o5 o8)) (fp.isFinite32 o10)))

;; H
  (assert (= result3 (ite (fp.lt o10 o9) true false)))
