...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 23299999237060546875000.0 10000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral6) (/ 23399999141693115234375.0 10000000000000000000000.0))))
...
;; H
  (assert (= z1 (mul RNE1 fliteral5 x)))

(assert
;; WP_parameter_def
 ;; File "fr.adb", line 18, characters 0-0
  (not (in_range3 (mul RNE1 fliteral6 x))))
(check-sat)
