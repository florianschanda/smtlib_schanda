...
(declare-fun dummy2 () max_lsid_type)
...
;; range_axiom
  (assert
  (forall ((x max_lsid_type)) (! (in_range2
...
(declare-fun dummy3 () local_subject_id_type)
...
(define-fun dynamic_invariant1 ((temp___expr_164 Int)
  ...
  (temp___do_toplevel_163 Bool)) Bool (and
                                      ...
                                      (<= 0 5)) (in_range3 temp___expr_164))
                                      (=> (= temp___do_toplevel_163 true)
                                      (=> (= temp___is_init_161 true)
                                      (<= temp___expr_164 (to_rep1
...
;; def_axiom
  ...
  (and (= (select temp___133 0) (of_rep1 temp___134))
  (= (select temp___133 1) (of_rep1 temp___135))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep2 (first states__split_fields1)) id)))
(check-sat)
(exit)
