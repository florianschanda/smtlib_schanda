...
;; H
  (assert (and (= o30 o29) (uint_in_range1 o29)))

;; H
  (assert (= o31 ((_ int2bv 64) o30)))

;; H
  (assert (= o32 (bvadd o31 ((_ int2bv 64) 1))))

;; H
  (assert (= o33 (bvmul o32 ((_ int2bv 64) 32))))

;; H
  (assert (= o34 (ite (bvult i2 o33) true false)))
...
;; H
  (assert (= o24 (oexpon o22 o23)))

;; H
  (assert (and (= o17 (* 2 n)) (in_range1 (* 2 n))))
...
;; H
  (assert (= o25 (omultiply o21 o24)))

;; H
  (assert (= o28 (omod o25 o27)))
