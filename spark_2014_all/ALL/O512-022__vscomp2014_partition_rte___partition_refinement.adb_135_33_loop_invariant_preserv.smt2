...
(declare-fun partition_refinement__make_new_partitions__L_1__R29b__assume () Int)

(declare-fun temp___1212 () index)

(declare-fun temp___12121 () index)

(declare-fun temp___12122 () index_count)
...
(declare-fun temp___1213 () index)

(declare-fun temp___12131 () index)

(declare-fun temp___12132 () index_count)
...
(declare-fun o11 () index_count)

(declare-fun temp___1215 () index)

(declare-fun temp___12151 () index)

(declare-fun temp___12152 () index_count)

(declare-fun o12 () index_count)
...
(declare-fun temp___1217 () index)

(declare-fun temp___12171 () index)

(declare-fun temp___12172 () index_count)
...
(declare-fun o18 () partition_index)

(declare-fun o19 () (Array Int partition_index))
...
(declare-fun p__split_fields6 () us_split_fields__ref1)

(declare-fun f9 () map__ref)

(declare-fun p_elem__split_fields6 () us_split_fields__ref)

(declare-fun p_prime__split_fields4 () us_split_fields__ref)

(declare-fun p_prime_index5 () int__ref)

(declare-fun j4 () int__ref)

(declare-fun i9 () int__ref)

(declare-fun p__split_fields7 () us_split_fields2)
...
(declare-fun p_prime_index6 () Int)

(declare-fun j5 () Int)

(declare-fun i10 () Int)

(declare-fun rho4 () us_split_fields2)

(declare-fun rho5 () us_split_fields2)

(define-fun temp___12123 () us_rep (mk___rep
                                   (mk___split_fields temp___1212
                                   temp___12121 temp___12122)))
...
;; H
  (assert
  (= partition_refinement__make_new_partitions__L_1__R29b__assume (-
  o 1)))

;; H
  (assert
  (= partition_refinement__make_new_partitions__L_1__R29b__assume r29b))
...
;; H
  (assert
  (= (capacity (mk___rep1 p__split_discrs p__split_fields1)) (capacity
                                                             (mk___rep1
                                                             p__split_discrs
                                                             (mk___split_fields1
                                                             p__split_fields)))))
...
;; H
  (assert
  (and
  (<= 0 (- (length (mk___rep1 p__split_discrs p__split_fields1)) (length
                                                                 (mk___rep1
                                                                 p__split_discrs
                                                                 (mk___split_fields1
                                                                 p__split_fields)))))
  (<= (- (length (mk___rep1 p__split_discrs p__split_fields1)) (length
                                                               (mk___rep1
                                                               p__split_discrs
                                                               (mk___split_fields1
                                                               p__split_fields))))
...
;; H
  ...
  (=> (<= 0 r29b) (dynamic_property 0 r29b j2)))
  (and (<= 0 j2) (<= j2 r29b))))

;; H
  (assert
  (and
  (= temp___12123 (get (model__ (mk___rep1 p__split_discrs p__split_fields1))
                  j2))
  (= (bool_eq temp___12123
...
;; H
  (assert
  (= p_elem__split_fields1 (mk___split_fields temp___1212 temp___12121
                           temp___12122)))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (= p_prime__split_fields1 (mk___split_fields temp___1213 temp___12131
                            temp___12132))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (= p_elem__split_fields2 (mk___split_fields temp___1215 temp___12151
                           temp___12152))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (= p_elem__split_fields3 (mk___split_fields temp___1217 temp___12171
                           temp___12172))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (and (= o16 (length (mk___rep1 p__split_discrs p__split_fields2)))
  (and (in_range6 o16)
  (<= o16 (capacity (mk___rep1 p__split_discrs p__split_fields2)))))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (and (<= r31b i1) (<= i1 r32b)) (= temp___1220 f))))
...
;; H
  ...
  (=> (<= i2 temp___1221)
  (= (select f1 temp___1221) (select temp___1220 temp___1221)))))
  (and (<= r31b i2) (<= i2 r32b))))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (and (<= r31b i1) (<= i1 r32b)) (= (to_rep2 o18) p_prime_index2))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (and (<= r31b i1) (<= i1 r32b)) (= o19 (store f1 i2 o18)))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (and (<= r31b i1) (<= i1 r32b)) (= result9 (mk_map__ref f1)))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (and (<= r31b i1) (<= i1 r32b)) (= i3 (mk_int__ref i2)))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (and (<= r31b i1) (<= i1 r32b)) (= f3 (mk_map__ref f2)))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (not (and (<= r31b i1) (<= i1 r32b))) (= i5 (mk_int__ref i1)))))
...
;; H
  ...
  (to_rep1
  (rec__partition_refinement__interval__first p_elem__split_fields1)))))
  (=> (not (and (<= r31b i1) (<= i1 r32b))) (= f5 (mk_map__ref f)))))
...
;; H
  (assert (= p_elem__split_fields7 p_elem__split_fields5))
...
;; WP_parameter_def
 ;; File "partition_refinement.adb", line 18, characters 0-0
  ...
  (<= 0 (- (length
           (mk___rep1 p__split_discrs
           (us_split_fields__content1 p__split_fields6))) (length
                                                          (mk___rep1
                                                          p__split_discrs
                                                          (mk___split_fields1
                                                          p__split_fields)))))))
