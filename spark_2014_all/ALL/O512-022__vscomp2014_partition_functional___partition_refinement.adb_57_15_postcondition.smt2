...
;; H
  ...
  (forall ((j9 Int))
  (=> (and (<= 0 j9) (<= j9 5))
  (and (<= 0 (to_rep2 (select f j9)))
  (<= (to_rep2 (select f j9)) (- (length
  ...
  (<= (to_rep1
      ...
      (get
      (model__
      (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j9)))) k)
  (<= k (to_rep1
        (rec__partition_refinement__interval__last
        (us_split_fields1
        (get
        (model__
        (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) j9))))))
  (= (to_rep2 (select f k)) j9))))))))))
...
;; H
  ...
  (= temp___1212 (get (model__ (mk___rep1 p__split_discrs p__split_fields2))
                 j2))
  (= (bool_eq temp___1212
     (get (model__ (mk___rep1 p__split_discrs p__split_fields2)) j2)) true))))
...
;; H
  ...
  (= (bool_eq
     ...
     (mk___rep1 p__split_discrs
     partition_refinement__partitions__replace_element__container__fields))
     j2) (mk___rep p_elem__split_fields7)) true))
...
;; H
  ...
  (<= (to_rep1
      (rec__partition_refinement__interval__first
      (us_split_fields1
      (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) j2)))) l)
  (<= l (to_rep1
        (rec__partition_refinement__interval__last
        (us_split_fields1
        (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) j2))))))
  (= (to_rep2 (select (map__content f7) l)) j2))))))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p_prime_index6 p_prime_index4)))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p__split_fields7 p__split_fields5)))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p_prime_index7 p_prime_index5)))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p__split_fields8 p__split_fields6)))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p_prime_index8 p_prime_index6)))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p__split_fields9 p__split_fields7)))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p_prime_index9 p_prime_index7)))
...
;; H
  (assert
  (=> (and (<= 0 j1) (<= j1 r50b)) (= p__split_fields10 p__split_fields8)))
...
;; H
  (assert
  (=> (not (and (<= 0 j1) (<= j1 r50b))) (= p_prime_index9 p_prime_index1)))
...
;; WP_parameter_def
 ;; File "partition_refinement.adb", line 18, characters 0-0
  (not (<= 0 (to_rep2 (select (map__content f15) j9)))))
(check-sat)
(exit)
