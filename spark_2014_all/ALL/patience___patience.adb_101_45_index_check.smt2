...
;; H
  (assert (= o113 (select temp___673 o112)))

;; H
  (assert (= temp___674 (to_rep1 o113)))

;; H
  (assert (and (<= 0 temp___674) (<= temp___674 99)))

;; H
  (assert (= o114 temp___674))

;; H
  (assert
  (= o115 (select (rec__patience__state__posheight
                  (us_split_fields__content s__split_fields20)) o114)))

;; H
  (assert (= o116 (to_rep1 o115)))

;; H
  (assert (= o117 (ite (= ip o116) true false)))
