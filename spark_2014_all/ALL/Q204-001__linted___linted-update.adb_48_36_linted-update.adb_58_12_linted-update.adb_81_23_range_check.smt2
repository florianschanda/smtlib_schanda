...
(declare-const o36 storage_element)
...
(declare-const o40 storage_element)
...
;; H
  (assert (=> (bvule x1 ((_ int2bv 32) 2147483647)) (= result1 y4)))

;; H
  (assert (=> (bvule x1 ((_ int2bv 32) 2147483647)) (= y2 o18)))
...
;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= result2 y4)))

;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= y3 o22)))

;; H
  (assert (=> (not (bvule x1 ((_ int2bv 32) 2147483647))) (= y2 y3)))
...
;; H
  (assert (= o40 (select temp___408 1)))

;; H
  (assert (= o41 (to_rep o40)))

;; H
  (assert (= o42 ((_ zero_extend 24) o41)))

;; H
  (assert (= o43 (bvshl o42 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o36 (select temp___404 2)))

;; H
  (assert (= o37 (to_rep o36)))

;; H
  (assert (= o38 ((_ zero_extend 24) o37)))

;; H
  (assert (= o39 (bvshl o38 ((_ int2bv 32) 16))))
...
;; H
  (assert (= o32 (select temp___400 3)))

;; H
  (assert (= o33 (to_rep o32)))

;; H
  (assert (= o34 ((_ zero_extend 24) o33)))

;; H
  (assert (= o35 (bvshl o34 ((_ int2bv 32) 8))))
