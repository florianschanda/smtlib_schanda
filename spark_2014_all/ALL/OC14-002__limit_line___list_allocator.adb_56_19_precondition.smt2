...
;; H
  ...
  (and (= o23 (length model____split_fields)) (in_range6 o23))))

;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o23) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o22 (get model____split_fields 1)) (in_range7 o22)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o22 first_available) true false)))))
...
;; H
  ...
  (and (= o24 (length model____split_fields)) (in_range6 o24))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= result2 (ite (= o24 0) true false))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (and (= o20 (length model____split_fields1)) (in_range6 o20)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o20) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o19 (get model____split_fields1 1)) (in_range7 o19))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o19 first_allocated) true false))))))
...
;; H
  ...
  (and (= o21 (length model____split_fields1)) (in_range6 o21)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (not (= first_allocated 0)))
  (= result1 (ite (= o21 0) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o17 (length model____split_fields)) (in_range6 o17))))

;; H
  (assert (=> (= result1 true) (= o18 (ite (<= j1 o17) true false))))

;; H
  (assert (=> (= result1 true) (= result5 (ite (<= 1 j1) o18 false))))
...
;; H
  (assert (and (= o16 (get model____split_fields1 j)) (in_range7 o16)))

;; H
  (assert (= result8 (ite (in_range4 o16) true false)))

;; H
  (assert
  (=> (= result8 true)
  (and (= o12 (length model____split_fields1)) (in_range6 o12))))

;; H
  (assert (=> (= result8 true) (= result9 (ite (< j o12) true false))))

;; H
  (assert
  (=> (= result8 true)
  (=> (= result9 true) (and (= o13 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result8 true)
  (=> (= result9 true)
  (and (= o14 (get model____split_fields1 o13)) (in_range7 o14)))))

;; H
  (assert (=> (= result8 true) (=> (not (= result9 true)) (= o14 0))))

;; H
  (assert
  (=> (= result8 true)
  (and (= temp___387 (get model____split_fields1 j)) (in_range7 temp___387))))

;; H
  (assert (=> (= result8 true) (and (<= 1 temp___387) (<= temp___387 3))))

;; H
  (assert (=> (= result8 true) (= o4 temp___387)))

;; H
  (assert
  (=> (= result8 true)
  (= (mk___rep (mk___split_fields o5 o6 o7)) (select data o4))))

;; H
  (assert (=> (= result8 true) (= o5 o8)))

;; H
  (assert (=> (= result8 true) (= o6 o9)))

;; H
  (assert (=> (= result8 true) (= o7 o10)))

;; H
  (assert (=> (= result8 true) (= o11 o10)))

;; H
  (assert (=> (= result8 true) (= o15 (to_rep o11))))

;; H
  (assert (=> (= result8 true) (= result7 (ite (= o15 o14) true false))))
...
;; H
  (assert
  (=> (< 1 j) (and (= o3 (get model____split_fields1 o2)) (in_range7 o3))))
