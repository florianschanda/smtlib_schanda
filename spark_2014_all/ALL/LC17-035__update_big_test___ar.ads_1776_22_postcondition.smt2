...
(declare-fun temp___3986 ((Array Int us_rep) Int us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___3988 (Array Int us_rep)))
  (forall ((temp___3989 Int))
  (forall ((temp___3990 us_rep))
  (let ((temp___3987 (temp___3986 temp___3988 temp___3989 temp___3990)))
  (forall ((temp___3991 Int))
  (ite (= temp___3991 temp___3989)
  (= (select temp___3987 temp___3991) temp___3990)
  (= (select temp___3987 temp___3991) (select temp___3988 temp___3991)))))))))
...
(declare-fun temp___9315 () (Array Int us_rep))

(declare-fun temp___93151 () Bool)

(declare-fun temp___93152 () enum1t)
...
(declare-fun r__split_fields9 () (Array Int us_rep))

(declare-fun r__split_fields10 () Bool)

(declare-fun r__split_fields11 () enum1t)
...
;; H
  (assert (= temp___9315 o6))

;; H
  (assert (= temp___93151 o7))

;; H
  (assert (= temp___93152 o8))
...
;; H
  (assert (= temp___9315 r__split_fields3))

;; H
  (assert (= temp___93151 r__split_fields4))

;; H
  (assert (= temp___93152 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1769, characters 0-0
  (not
  (= (bool_eq2
     (mk___rep1
