...
;; H
  (assert (= us_tag2 main__c1__assume3))
...
;; H
  (assert (= c1__attr__tag us_tag2))

(assert
;; WP_parameter_def
 ;; File "main.adb", line 2, characters 0-0
  (not
  (= (less_than_max1 c1__attr__tag
     (mk___rep
     (mk___split_fields c1__split_fields4
     (hide_ext__ c1__split_fields3 c1__split_fields5)) c1__attr__tag)) true)))
(check-sat)
(exit)
