...
(declare-datatypes ((int5__ref 0)) (((mk_int5__ref (int5__content int5)))))
...
(((mk_map__ref (map__content (Array Int int5))))))
...
(((mk_ta26P1__ref (ta26P1__content ta26P1)))))
...
(((mk___split_fields (rec__r__r__f (Array Int int5))))))
...
(((mk_tar15P1__ref (tar15P1__content tar15P1)))))
