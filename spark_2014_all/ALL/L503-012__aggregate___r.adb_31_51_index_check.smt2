...
(declare-fun dummy3 () (Array Int int5))
...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__r__r__f (Array Int int5))))))
(define-fun us_split_fields_F__projection ((a us_split_fields)) (Array Int int5)
  (rec__r__r__f a))
...
(declare-fun r__r__f__first__bit () Int)

(declare-fun r__r__f__last__bit () Int)

(declare-fun r__r__f__position () Int)
...
(declare-fun dummy5 () tar15P1)

(declare-datatypes ()
((tar15P1__ref (mk_tar15P1__ref (tar15P1__content tar15P1)))))
(define-fun tar15P1__ref___projection ((a tar15P1__ref)) tar15P1 (tar15P1__content
                                                                 a))
...
(declare-fun temp___274 (us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___276 us_rep))
  (forall ((temp___277 Int))
  (= (select (temp___274 temp___276) temp___277) temp___276))))

(declare-fun temp___278 (Int Int) (Array Int int5))

;; def_axiom
  (assert
  (forall ((temp___280 Int) (temp___281 Int))
  (let ((temp___279 (temp___278 temp___280 temp___281)))
  (forall ((temp___282 Int))
  (ite (= temp___282 2)
  (= (select temp___279 temp___282) (of_rep temp___280))
  (= (select temp___279 temp___282) (of_rep temp___281)))))))
