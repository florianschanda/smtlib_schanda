...
(declare-fun test_equal__my_int_mod__content__first__bit () Int)

(declare-fun test_equal__my_int_mod__content__last__bit () Int)

(declare-fun test_equal__my_int_mod__content__position () Int)
...
(define-fun us_split_fields_Content2__projection ((a us_split_fields2)) us_rep
...
(declare-fun test_equal__my_rec__content__first__bit () Int)

(declare-fun test_equal__my_rec__content__last__bit () Int)

(declare-fun test_equal__my_rec__content__position () Int)
...
(declare-fun o () my_int)

(declare-fun o1 () my_int)

(declare-fun test_equal__content_x__assume () my_int)

(declare-fun o2 () my_int)

(declare-fun o3 () my_int)

(declare-fun test_equal__content_y__assume () my_int)
