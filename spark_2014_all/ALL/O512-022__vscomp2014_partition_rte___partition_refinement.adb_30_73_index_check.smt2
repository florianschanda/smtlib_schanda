...
(declare-fun bool_eq11 (us_rep4 us_rep4) Bool)
...
(declare-fun user_eq14 (partition_index partition_index) Bool)
...
(declare-fun bool_eq17 (us_rep7 us_rep7) Bool)
...
(define-fun bool_eq18 ((a (Array Int partition_index)) (a__first Int)
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 0) true)
     (=>
     (exists ((k us_rep1))
     (and (= (has_key1 container k) true) (= (bool_eq6 k key2) true)))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq17 a b) (oeq5 a b)) :pattern ((user_eq17 a b)) )))
...
;; H
  ...
  (= partition_refinement__refine_one__p_elem__assume3 (get3
                                                       ...
                                                       p__split_fields)))
                                                       (to_rep4 (select f i))))
  (= (bool_eq14 partition_refinement__refine_one__p_elem__assume3
     (get3
     (model__1
...
;; H
  ...
  (forall ((c us_rep1))
  (=>
  (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c) true)
  (=>
  (and
  (not
...
;; H
  ...
  (forall ((c us_rep1))
  (=>
  (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true)
  (=>
  (and
  (not
