...
(declare-fun my_sets__get_f__result () Int)

(declare-fun result () Int)

(declare-fun my_sets__get_f__result1 () Int)

(declare-fun my_sets__get_f__result2 () Int)

(declare-fun my_sets__get_f__result3 () Int)

(declare-fun my_sets__get_f__result4 () Int)

(declare-fun my_sets__get_f__result5 () Int)
...
;; H
  (assert
  (= my_sets__get_f__result1 (to_rep
                             (rec__my_sets__my_rec__f (us_split_fields1 x)))))

;; H
  (assert
  (= (mk_int__ref my_sets__get_f__result4) (mk_int__ref
                                           my_sets__get_f__result2)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= my_sets__get_f__result4 (to_rep
                             (rec__my_sets__my_rec__f (us_split_fields1 x))))))
(check-sat)
(exit)
