...
;; H
  (assert (<= (to_rep1 input__first) i1))

;; H
  (assert (<= i1 (to_rep1 input__last)))

;; H
  (assert (and (<= (to_rep1 input__first) i2) (<= i2 (to_rep1 input__last))))
...
;; H
  (assert (= o15 (select input1 o14)))

;; H
  (assert (= o16 (to_rep2 o15)))

;; H
  (assert (= o17 (attr__ATTRIBUTE_IMAGE4 o16)))

;; H
  (assert (= (mk___t temp___786 temp___7861) (to_string o17)))
...
;; H
  (assert (=> (<= 1 1) (= o19 (+ (- 1 1) 1))))

;; H
  (assert (=> (not (<= 1 1)) (= o19 0)))
