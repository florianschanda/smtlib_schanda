...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral2) (= (tqtreal fliteral2) 7.0)))

(declare-fun fliteral3 () t)

;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 12.0)))

;; record_const__def_axiom
  (assert
  (= record_const (mk___rep
                  (mk___split_fields (of_rep fliteral2) (of_rep fliteral3)))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral4) (/ 1999999955296516418457031250.0 100000000000000000000000000000.0))))
...
;; fliteral_axiom
  ...
  (= (tqtreal fliteral5) (/ 9999999776482582092285156250.0 1000000000000000000000000000000.0))))
...
(declare-fun res_11 () t)

;; H
  (assert (= (to_rep o) fliteral3))

;; H
  (assert (= (to_rep o1) fliteral2))
...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite res_1)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite res_2)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite res_3)))
...
;; H
  (assert (tqtisFinite temp))

;; H
  (assert (= result res_1))

;; H
  (assert (= res_11 fliteral4))
