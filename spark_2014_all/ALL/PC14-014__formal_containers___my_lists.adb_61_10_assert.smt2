...
(declare-fun temp___508 () count_type)

(declare-fun temp___509 () us_rep1)

(declare-fun temp___510 () us_rep1)

(declare-fun temp___511 () us_rep1)

(declare-fun o2 () us_rep)

(declare-fun o3 () us_rep)

(declare-fun temp___514 () us_rep)

(declare-fun temp___515 () us_rep1)

(declare-fun temp___517 () us_rep1)

(declare-fun temp___519 () us_rep1)

(declare-fun c__split_fields1 () us_split_fields2)

(declare-fun l__split_fields1 () us_split_fields)

(declare-fun my_lists__m__insert__container__fields () us_split_fields)

(declare-fun result () us_split_fields__ref)

(declare-fun l__split_fields2 () us_split_fields)

(declare-fun my_lists__m__insert__2__container__fields () us_split_fields)
...
(declare-fun c__split_fields7 () us_split_fields2)

(declare-fun c__split_fields8 () us_split_fields2)

(declare-fun result5 () us_split_fields__ref1)

(declare-fun d__split_fields1 () us_split_fields2)

(declare-fun my_lists__m__insert__container__fields1 () us_split_fields)

(declare-fun result6 () us_split_fields__ref)

(declare-fun l__split_fields4 () us_split_fields)

(declare-fun my_lists__m__insert__2__container__fields1 () us_split_fields)
...
(declare-fun c__split_fields9 () us_split_fields2)

(declare-fun d__split_fields2 () us_split_fields2)

(declare-fun my_lists__m__delete__2__container__fields () us_split_fields)
...
(declare-fun my_lists__m__delete__container__fields () us_split_fields)
...
(define-fun temp___5081 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___508)))
...
;; H
  ...
  (= (get
     ...
     (last1
     (mk___rep l__split_discrs my_lists__m__insert__container__fields))) 
  (length (mk___rep l__split_discrs my_lists__m__insert__container__fields)))
  (= (keys_included_except
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__container__fields))
     (positions (mk___rep l__split_discrs l__split_fields1))
     (last1
     (mk___rep l__split_discrs my_lists__m__insert__container__fields))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields1))
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__container__fields))) true))
  (= (get1
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__container__fields))
     (length
     (mk___rep l__split_discrs my_lists__m__insert__container__fields))) 8))
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields1))
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__container__fields)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields1))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields)) (+ 
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields2))
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields)) 1
     (length (mk___rep l__split_discrs l__split_fields2))) true)
  (=> (< 0 4)
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields))
     ...
     (length
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields)) 7) true)))
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields))
     (+ (length (mk___rep l__split_discrs l__split_fields2)) 1)
  ...
  (= (p_positions_truncated
     ...
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields))
     (+ (length (mk___rep l__split_discrs l__split_fields2)) 1) 4) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields2))
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields2))
        (mk___rep1 c__split_fields1)) 1)) true)
  ...
  (= (constant_range
     ...
     (mk___rep1 c__split_fields1))
     (+ (- (get (positions (mk___rep l__split_discrs l__split_fields2))
           (mk___rep1 c__split_fields1)) 1) 4)
     7) true))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields2))
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields))
     (get (positions (mk___rep l__split_discrs l__split_fields2))
     (mk___rep1 c__split_fields1)) 4) true)))))
...
;; H
  (assert
  (not (= (is_empty1 (mk___rep l__split_discrs l__split_fields3)) true)))

;; H
  (assert
  (and (= temp___5081 (first (mk___rep l__split_discrs l__split_fields3)))
  (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true)
  (= (bool_eq3 temp___5081 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
     temp___5081) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields3))
     temp___5081) 1)))))
...
;; H
  ...
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields2) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields3))
          (mk___rep1 c__split_fields2)) 1) true) true)
  (= (bool_eq3 (mk___rep1 c__split_fields3) no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 c__split_fields3)) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 c__split_fields3)) (- (get
                                      (positions
...
;; H
  (assert
  (and (= temp___509 (last1 (mk___rep l__split_discrs l__split_fields3)))
  (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true)
  (= (bool_eq3 temp___509 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
     temp___509) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___509) 
...
;; H
  (assert
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields4) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields3))
          (mk___rep1 c__split_fields4)) (length
                                        (mk___rep l__split_discrs
                                        l__split_fields3))) true) true)
  (= (bool_eq3 (mk___rep1 c__split_fields5) no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
...
;; H
  (assert
  (and (= temp___510 (last1 (mk___rep l__split_discrs l__split_fields3)))
  (ite (= (= (length (mk___rep l__split_discrs l__split_fields3)) 0) true)
  (= (bool_eq3 temp___510 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
     temp___510) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___510) 
  (length (mk___rep l__split_discrs l__split_fields3)))))))
...
;; H
  (assert
  (and (not (= (bool_eq3 (mk___rep1 c__split_fields6) no_element) true))
  (not
  (= (bool_eq3 (mk___rep1 c__split_fields6)
     (first (mk___rep l__split_discrs l__split_fields3))) true))))

;; H
  (assert
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields6) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields3))
          (mk___rep1 c__split_fields6)) 1) true) true)
  (= (bool_eq3 (mk___rep1 c__split_fields7) no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 c__split_fields7)) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 c__split_fields7)) (- (get
                                      (positions
                                      (mk___rep l__split_discrs
                                      l__split_fields3))
                                      (mk___rep1 c__split_fields6)) 1)))))

;; H
  (assert
  (and (not (= (bool_eq3 (mk___rep1 c__split_fields7) no_element) true))
  (not
  (= (bool_eq3 (mk___rep1 c__split_fields7)
     (last1 (mk___rep l__split_discrs l__split_fields3))) true))))

;; H
  (assert
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields7) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields3))
          (mk___rep1 c__split_fields7)) (length
                                        (mk___rep l__split_discrs
                                        l__split_fields3))) true) true)
  (= (bool_eq3 (mk___rep1 c__split_fields8) no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 c__split_fields8)) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 c__split_fields8)) (+ (get
                                      (positions
                                      (mk___rep l__split_discrs
                                      l__split_fields3))
                                      (mk___rep1 c__split_fields7)) 1)))))

;; H
  (assert
  (and
  (= temp___511 (previous (mk___rep l__split_discrs l__split_fields3)
                (mk___rep1 c__split_fields8)))
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields8) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields3))
          (mk___rep1 c__split_fields8)) 1) true) true)
  (= (bool_eq3 temp___511 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields3))
     temp___511) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields3)) temp___511) (- 
  (get (positions (mk___rep l__split_discrs l__split_fields3))
  (mk___rep1 c__split_fields8)) 1))))))

;; H
  (assert
  (= result5 (mk___split_fields__ref1 (mk___split_fields1 d__split_fields))))

;; H
  (assert (= d__split_fields1 (us_split_fields3 temp___511)))

;; H
  (assert (not (= (bool_eq3 (mk___rep1 c__split_fields8) no_element) true)))

;; H
  (assert
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1)) (+ 
  (length (mk___rep l__split_discrs l__split_fields3)) 1))
  (ite (= (bool_eq3 (mk___rep1 c__split_fields8) no_element) true)
  (and
  (and
  (and
  (and
  (= (get
     ...
     (last1
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1))) 
  (length (mk___rep l__split_discrs my_lists__m__insert__container__fields1)))
  (= (keys_included_except
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1))
     (positions (mk___rep l__split_discrs l__split_fields3))
     (last1
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields3))
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1))) true))
  (= (get1
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1))
     (length
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1))) 10))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields3))
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1))) true))
  (and
  (and
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields3))
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__container__fields1)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields3))
        (mk___rep1 c__split_fields8)) 1)) true)
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields1)) (+ 
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields4))
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields1)) 1
     (length (mk___rep l__split_discrs l__split_fields4))) true)
  (=> (< 0 4)
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields1))
     (+ (length (mk___rep l__split_discrs l__split_fields4)) 1)
     (length
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields1))
     9) true)))
  (= (constant_range
  ...
  (= (p_positions_truncated
     ...
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields1))
     (+ (length (mk___rep l__split_discrs l__split_fields4)) 1) 4) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields4))
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields1)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields4))
        (mk___rep1 c__split_fields8)) 1)) true)
  ...
  (= (constant_range
     ...
     (mk___rep1 c__split_fields8))
     (+ (- (get (positions (mk___rep l__split_discrs l__split_fields4))
           (mk___rep1 c__split_fields8)) 1) 4)
     9) true))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields4))
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__2__container__fields1))
     (get (positions (mk___rep l__split_discrs l__split_fields4))
     (mk___rep1 c__split_fields8)) 4) true)))))
...
;; H
  (assert
  (and (= o2 (copy (mk___rep l__split_discrs l__split_fields5) 0))
  (and
  (and
  (= (oeq (model__ o2) (model__ (mk___rep l__split_discrs l__split_fields5))) true)
  (= (oeq1 (positions o2)
     (positions (mk___rep l__split_discrs l__split_fields5))) true))
  (= (to_rep (rec__my_lists__m__list__capacity (us_split_discrs1 o2))) 
  (to_rep (rec__my_lists__m__list__capacity l__split_discrs))))))
...
;; H
  (assert
  (= result8 (mk___split_fields__ref (mk___split_fields k__split_fields))))
...
;; H
  (assert
  (and
  (= temp___515 (next (mk___rep l__split_discrs l__split_fields5)
                (mk___rep1 d__split_fields1)))
  (ite (= (ite (= (bool_eq3 (mk___rep1 d__split_fields1) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields5))
          (mk___rep1 d__split_fields1)) (length
                                        (mk___rep l__split_discrs
                                        l__split_fields5))) true) true)
  (= (bool_eq3 temp___515 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields5))
     temp___515) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields5)) temp___515) (+ 
  (get (positions (mk___rep l__split_discrs l__split_fields5))
  (mk___rep1 d__split_fields1)) 1))))))
...
;; H
  ...
  (and
  (and
  (<= (- (length (mk___rep l__split_discrs l__split_fields5)) 0) (length
                                                                 (mk___rep
                                                                 l__split_discrs
                                                                 my_lists__m__delete__2__container__fields)))
  (<= (length
      (mk___rep l__split_discrs my_lists__m__delete__2__container__fields)) 
  (length (mk___rep l__split_discrs l__split_fields5))))
  (= (bool_eq3 (mk___rep1 d__split_fields2) no_element) true))
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields5))
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields5))
        (mk___rep1 d__split_fields1)) 1)) true))
  (ite (= (< (- (length (mk___rep l__split_discrs l__split_fields5)) 0) 
  (get (positions (mk___rep l__split_discrs l__split_fields5))
  ...
  (= (p_positions_truncated
     ...
     (get (positions (mk___rep l__split_discrs l__split_fields5))
     (mk___rep1 d__split_fields1)) 0) true))
  (and
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields)) (- 
  ...
  (= (range_shifted
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields5))
     (get (positions (mk___rep l__split_discrs l__split_fields5))
     (mk___rep1 d__split_fields1))
     (length
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields)) 0) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields))
     (positions (mk___rep l__split_discrs l__split_fields5))
...
;; H
  (assert
  (and
  (= temp___517 (previous (mk___rep l__split_discrs l__split_fields6)
                (mk___rep1 c__split_fields9)))
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields9) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields6))
          (mk___rep1 c__split_fields9)) 1) true) true)
  (= (bool_eq3 temp___517 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields6))
     temp___517) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields6)) temp___517) (- 
  (get (positions (mk___rep l__split_discrs l__split_fields6))
  (mk___rep1 c__split_fields9)) 1))))))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__delete__container__fields)) (- 
  (length (mk___rep l__split_discrs l__split_fields6)) 1))
  (= (bool_eq3 (mk___rep1 d__split_fields4) no_element) true))
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields6))
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__container__fields)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields6))
        (mk___rep1 d__split_fields3)) 1)) true))
  (= (range_shifted
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields6))
     (get (positions (mk___rep l__split_discrs l__split_fields6))
     (mk___rep1 d__split_fields3))
     (length
     (mk___rep l__split_discrs my_lists__m__delete__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep l__split_discrs my_lists__m__delete__container__fields))
...
;; H
  (assert
  (and
  (= temp___519 (next (mk___rep l__split_discrs l__split_fields7)
                (mk___rep1 c__split_fields9)))
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields9) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields7))
          (mk___rep1 c__split_fields9)) (length
                                        (mk___rep l__split_discrs
                                        l__split_fields7))) true) true)
  (= (bool_eq3 temp___519 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields7))
     temp___519) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields7)) temp___519) (+ 
  (get (positions (mk___rep l__split_discrs l__split_fields7))
  (mk___rep1 c__split_fields9)) 1))))))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not
  (< (+ (get (positions (mk___rep l__split_discrs l__split_fields7))
        (mk___rep1 d__split_fields5)) 3) (length
                                         (mk___rep l__split_discrs
                                         l__split_fields7)))))
(check-sat)
