...
(declare-datatypes ((tresultP1__ref 0))
(((mk_tresultP1__ref (tresultP1__content integer)))))
...
(declare-datatypes ((result____ref 0))
(((mk_result____ref (result____content us_t1)))))
