...
;; H
  ...
  (and (= o5 (abs a)) (in_range1 (abs a)))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (and (= o6 (abs an2)) (in_range1 (abs an2)))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (= result3 (ite (<= o6 o5) true false))))
...
;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (=> (not (= result3 true)) (and (= o3 (abs b)) (in_range1 (abs b))))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (=> (not (= result3 true)) (and (= o4 (abs an2)) (in_range1 (abs an2))))))

;; H
  (assert
  (=> (and (not (= an2 (- 2147483648))) (not (= bn2 (- 2147483648))))
  (=> (not (= result3 true)) (= result2 (ite (<= o4 o3) true false)))))
