...
(declare-datatypes ((t72b__ref 0)) (((mk_t72b__ref (t72b__content t72b)))))
...
(declare-datatypes ((t74b__ref 0)) (((mk_t74b__ref (t74b__content t74b)))))
...
;; H
  ...
  (and (<= (to_rep1 a__first) 5) (<= 5 (to_rep1 a__last))))))
...
(assert
;; WP_parameter_def
 ;; File "test.adb", line 233, characters 0-0
