...
(declare-fun temp___923 () us_rep10)
...
;; H
  ...
  (=> (and (<= 1 temp___931) (<= temp___931 1000))
  (=> (<= (let ((subject i)) i2) temp___931)
  (= (select (rec__algorithm__controller__laserscan
             (let ((subject this__split_fields)) this__split_fields2)) temp___931) (select
  (rec__algorithm__controller__laserscan
  (let ((subject this__split_fields)) this__split_fields1)) temp___931))))))
  (= (rec__algorithm__controller__gapvec
...
;; H
  (assert (= temp___923 (mk___rep10 o8)))
...
;; WP_parameter_def
 ;; File "algorithm.ads", line 107, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.mul RNE (to_rep3
                                      (rec__robot_iface__proxy__scan_res
                                      (us_split_fields9
                                      (rec__algorithm__controller__robot
                                      (let ((subject this__split_fields))
                                      this__split_fields3))))) (of_int RNE
                                                               (- (-
                                                               (let ((subject
                                                               i)) i2) 1)
                                                               (div1
                                                               (let ((subject
                                                               inumlps))
                                                               inumlps1) 2))))) (fp.isNaN (fp.mul RNE
  (to_rep3
  (rec__robot_iface__proxy__scan_res
  (us_split_fields9
  (rec__algorithm__controller__robot
  (let ((subject this__split_fields)) this__split_fields3))))) (of_int RNE
                                                               (- (-
                                                               (let ((subject
                                                               i)) i2) 1)
                                                               (div1
