...
(declare-fun o22 () track_id)

(declare-fun o23 () track_id)

(declare-fun o24 () natural)

(declare-fun o25 () track_id)

(declare-fun o26 () track_id)

(declare-fun o27 () Int)

(declare-fun o28 () track_id)

(declare-fun o29 () natural)

(declare-fun o30 () track_id)
...
;; H
  (assert (= (mk___rep (mk___split_fields o28 o29 o30)) (select trains
  o27)))
...
;; H
  (assert (= (mk___rep (mk___split_fields o20 o21 o22)) (select trains
  o19)))
...
;; H
  (assert
  (=> (= result1 true)
  (= (mk___rep (mk___split_fields o9 o10 o11)) (select trains o8))))
...
;; H
  (assert
  (=> (= result1 true)
  (= (mk___rep (mk___split_fields o1 o2 o3)) (select trains o))))
...
;; H
  (assert
  (=> (= result1 true) (= result (ite (not (= o18 true)) true false))))
