...
(declare-fun z1__split_fields () integer)

(declare-fun z1__split_fields1 () integer)
...
(declare-fun run__c2__assume () us_rep)
...
(declare-fun z1__split_fields2 () us_split_fields)
