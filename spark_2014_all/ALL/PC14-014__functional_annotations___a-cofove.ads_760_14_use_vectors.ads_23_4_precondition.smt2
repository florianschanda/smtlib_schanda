...
(define-fun dynamic_invariant2 ((temp___expr_231 us_rep)
  ...
  (temp___do_toplevel_230 Bool)) Bool (dynamic_property1 0 last1
  (to_rep1
...
;; H
  (assert
  (and (= o2 (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 o2)
  (= o2 (last4 (model__ container))))))

;; H
  (assert (= result (ite (<= index o2) true false)))

;; H
  (assert
  (=> (= result true)
  (and (= us1 index) (dynamic_property3 first2 last3 index))))
...
;; H
  (assert
  (=> (not (= result true))
  (and (= temp___426 (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 temp___426)
  (= temp___426 (last4 (model__ container)))))))

;; H
  (assert
  (=> (not (= result true))
  (and (= us2 temp___426) (dynamic_property3 first2 last3 temp___426))))

;; H
  (assert (=> (not (= result true)) (= o3 temp___426)))

;; H
  (assert (and (= us first) (dynamic_property2 first1 last2 first)))
