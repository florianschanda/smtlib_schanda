...
(declare-fun normalize__r4__result () t)

(declare-fun o () t)

(declare-fun result () t)

(declare-fun normalize__r4__result1 () t)

(declare-fun normalize__r4__result2 () t)

(declare-fun normalize__r4__result3 () t)

(declare-fun normalize__r4__result4 () t)

(declare-fun normalize__r4__result5 () t)
...
;; H
  (assert
  (and (= o (roundToIntegral RTN1 x)) (tqtisFinite (roundToIntegral RTN1 x))))
...
;; WP_parameter_def
 ;; File "normalize.ads", line 5, characters 0-0
  (not (eq normalize__r4__result4 (roundToIntegral RTN1 x))))
(check-sat)
