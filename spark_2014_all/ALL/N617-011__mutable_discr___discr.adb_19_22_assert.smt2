...
(define-fun dynamic_invariant1 ((temp___expr_181 us_rep)
  (temp___is_init_178 Bool) (temp___skip_constant_179 Bool)
  (temp___do_toplevel_180 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_179 true))
                                      (in_range2 c temp___expr_181))
                                      (= (attr__constrained temp___expr_181) true)))
...
(declare-fun discr__with_default__c__first__bit4 () Int)

(declare-fun discr__with_default__c__last__bit4 () Int)

(declare-fun discr__with_default__c__position4 () Int)
...
(declare-fun discr__with_default__c__first__bit5 () Int)

(declare-fun discr__with_default__c__last__bit5 () Int)

(declare-fun discr__with_default__c__position5 () Int)
...
(declare-fun discr__r2__d__assume () natural)

(declare-fun discr__r2__d__assume1 () Bool)
...
;; H
  (assert
  (= result (mk___split_discrs__ref (mk___split_discrs d__split_discrs))))
...
;; H
  ...
  (= (to_rep (rec__discr__with_default__c d1__split_discrs)) c)))
...
;; WP_parameter_def
 ;; File "discr.adb", line 4, characters 0-0
  (not
  (= (bool_eq (mk___rep d__split_discrs1 d__attr__constrained)
     (mk___rep d1__split_discrs d1__attr__constrained)) true)))
(check-sat)
(exit)
