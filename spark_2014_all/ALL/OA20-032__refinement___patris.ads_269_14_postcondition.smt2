...
(declare-const new_board (Array Int (Array Int cell)))

(declare-const attr__ATTRIBUTE_ADDRESS6 Int)

(declare-const new_cur_state Int)

(declare-const attr__ATTRIBUTE_ADDRESS7 Int)

(declare-const new_cur_piece us_rep)

(declare-const attr__ATTRIBUTE_ADDRESS8 Int)

(declare-const new_next_piece us_rep)
...
(declare-const result5 shape)

(declare-const result6 direction)

(declare-const result7 px_coord)

(declare-const result8 py_coord)

(declare-const next_piece__split_fields4 shape)

(declare-const next_piece__split_fields5 direction)

(declare-const next_piece__split_fields6 px_coord)

(declare-const next_piece__split_fields7 py_coord)
...
(declare-const next_piece__split_fields8 us_split_fields__ref)
...
(declare-const cur_piece__split_fields12 us_split_fields)

(declare-const next_piece__split_fields9 us_split_fields)
...
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  ...
  (= (valid_configuration__2 (int__content cur_state2)
     ...
     cur_piece__split_fields10 cur_piece__split_fields11) cur_board2) true)))
(check-sat)
(exit)
