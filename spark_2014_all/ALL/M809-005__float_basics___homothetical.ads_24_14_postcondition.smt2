...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o1 (mul RNE1 (to_rep (select kvp2 i4)) (abs1 (to_rep (select d j4)))))
  (tqtisFinite
  (mul RNE1 (to_rep (select kvp2 i4)) (abs1 (to_rep (select d j4))))))))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o (mul RNE1 (to_rep (select kvp2 j4)) (abs1 (to_rep (select d i4)))))
  (tqtisFinite
  (mul RNE1 (to_rep (select kvp2 j4)) (abs1 (to_rep (select d i4))))))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2)) (=> (not (= i4 j4)) (= o2 (div1 RNE1 o o1))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (and (= o3 o2) (tqtisFinite o2))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o4 (min (to_rep (select lambda3 i4)) o3))))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o8 (mul RNE1 (to_rep (select ka i4)) (abs1 (to_rep (select d j4)))))
  (tqtisFinite
  (mul RNE1 (to_rep (select ka i4)) (abs1 (to_rep (select d j4))))))))))
...
;; H
  ...
  (=> (not (= i4 j4))
  (and
  (= o7 (mul RNE1 (to_rep (select ka j4)) (abs1 (to_rep (select d i4)))))
  (tqtisFinite
  (mul RNE1 (to_rep (select ka j4)) (abs1 (to_rep (select d i4))))))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o9 (div1 RNE1 o7 o8))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (and (= o10 o9) (tqtisFinite o9))))))

;; H
  (assert
  (=> (and (<= 1 i3) (<= i3 2))
  (=> (and (<= 1 j3) (<= j3 2))
  (=> (not (= i4 j4)) (= o11 (min (to_rep (select upsilon3 i4)) o10))))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 2))
  (and
  (= o14 (mul RNE1 (to_rep (select (map__content lambda9) i4))
         (to_rep (select kvp2 i4))))
  (tqtisFinite
  (mul RNE1 (to_rep (select (map__content lambda9) i4))
  (to_rep (select kvp2 i4)))))))
...
;; H
  ...
  (=> (and (<= 1 i3) (<= i3 2))
  (and
  (= o17 (mul RNE1 (to_rep (select (map__content upsilon9) i4))
         (to_rep (select ka i4))))
  (tqtisFinite
  (mul RNE1 (to_rep (select (map__content upsilon9) i4))
  (to_rep (select ka i4)))))))
