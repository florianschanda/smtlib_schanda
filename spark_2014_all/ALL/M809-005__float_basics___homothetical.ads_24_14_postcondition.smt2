...
(declare-fun o33 () (Array Int float))
...
(declare-fun o39 () float)

(declare-fun o40 () (Array Int float))
...
(declare-fun o46 () float)

(declare-fun o47 () (Array Int float))
...
(declare-fun o53 () float)

(declare-fun o54 () (Array Int float))
...
(declare-fun o61 () (Array Int float))

(declare-fun o62 () Float32)

(declare-fun o63 () float)

(declare-fun o64 () (Array Int float))

(declare-fun o65 () Float32)

(declare-fun o66 () float)

(declare-fun o67 () (Array Int float))
...
(declare-fun lambda11 () (Array Int float))

(declare-fun result18 () map__ref)

(declare-fun upsilon11 () (Array Int float))

(declare-fun lambda12 () map__ref)

(declare-fun upsilon12 () map__ref)

(declare-fun lambda13 () (Array Int float))

(declare-fun upsilon13 () (Array Int float))
...
(declare-fun lambda14 () map__ref)

(declare-fun upsilon14 () map__ref)
...
(declare-fun lambda15 () (Array Int float))

(declare-fun upsilon15 () (Array Int float))
