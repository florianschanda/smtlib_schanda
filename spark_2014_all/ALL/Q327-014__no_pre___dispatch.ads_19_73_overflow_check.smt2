...
(declare-fun dispatch__incr3__result () integer)

(declare-fun dispatch__incr3__result1 () us_private)

(declare-fun dispatch__incr3__result2 () Int)
...
(declare-fun dispatch__incr3__result3 () integer)

(declare-fun dispatch__incr3__result4 () us_private)

(declare-fun dispatch__incr3__result5 () Int)
...
(declare-fun dispatch__incr3__result6 () integer)

(declare-fun dispatch__incr3__result7 () us_private)

(declare-fun dispatch__incr3__result8 () Int)

(declare-fun dispatch__incr3__result9 () integer)

(declare-fun dispatch__incr3__result10 () us_private)

(declare-fun dispatch__incr3__result11 () Int)

(declare-fun dispatch__incr3__result12 () us_rep)

(declare-fun dispatch__incr3__result13 () root__ref)

(declare-fun dispatch__incr3__result14 () us_rep)

(declare-fun dispatch__incr3__result15 () root__ref)

(declare-fun dispatch__incr3__result16 () us_rep)
