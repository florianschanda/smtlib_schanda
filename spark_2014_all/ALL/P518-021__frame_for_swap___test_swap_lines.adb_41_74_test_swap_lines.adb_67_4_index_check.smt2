...
;; H
  ...
  (=> (<= 1 10) (in_range5 c3))) (=> (<= 0 2147483647) (in_range2 tmp4)))
  (and (<= 1 c3) (<= c3 10)))))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 0 9) (in_range6 c9)) (=> (<= 0 2147483647) (in_range2 tmp10)))
...
;; H
  (assert
  (=> (and (<= 0 c8) (<= c8 9))
  (= (to_rep o4) (to_rep (get m10 7 (+ c9 1))))))
...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 (- i2 1)))
  (= (to_rep (get m18 k1 k1)) (+ (to_rep (get m17 k1 k1)) 1)))))
...
;; H
  ...
  (forall ((h1 Int))
  (=> (and (<= 1 h1) (<= h1 (- i2 1)))
  (=> (not (= k1 h1)) (= (to_rep (get m18 k1 h1)) (to_rep (get m17 k1 h1)))))))))

;; H
  (assert
  (and
  (and (=> (<= 1 10) (in_range7 i2))
