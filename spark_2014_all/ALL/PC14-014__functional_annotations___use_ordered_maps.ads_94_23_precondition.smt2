...
;; H
  ...
  (= (has_key
     (model__
     (mk___rep m__split_discrs (mk___split_fields m__split_fields5))) k1) true)
  (= (get
     (model__
     (mk___rep m__split_discrs (mk___split_fields m__split_fields5))) k1) 0))))))
...
;; H
  ...
  (= (has_key
     (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     k1) true))
  (= (equivalent_keys k1 k) true))) (= result1 true)))))
