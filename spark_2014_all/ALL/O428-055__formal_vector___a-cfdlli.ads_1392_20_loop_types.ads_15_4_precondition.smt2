...
(define-fun default_initial_assumption2 ((temp___expr_403 us_rep1)
...
(declare-fun temp___672 () count_type)
...
;; H
  (assert (= temp___672 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___672)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1371, characters 0-0
  (not
