...
(declare-datatypes ((workspace_type__ref 0))
...
(declare-datatypes ((tTworkspaceSP1__ref 0))
...
(declare-datatypes ((tworkspaceS__ref 0))
(((mk_tworkspaceS__ref (tworkspaceS__content us_t1)))))
...
(declare-const temp___155 (Array Int natural))

(declare-const temp___1551 t2)
