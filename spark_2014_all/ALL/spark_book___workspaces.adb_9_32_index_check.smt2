...
(declare-datatypes ()
((workspace_type__ref
 (mk_workspace_type__ref (workspace_type__content us_t)))))
(define-fun workspace_type__ref___projection ((a workspace_type__ref)) us_t
  (workspace_type__content a))
...
(declare-datatypes ()
((tTworkspaceSP1__ref
 (mk_tTworkspaceSP1__ref (tTworkspaceSP1__content integer)))))
(define-fun tTworkspaceSP1__ref___projection ((a tTworkspaceSP1__ref)) integer
  (tTworkspaceSP1__content a))
...
(declare-fun workspace__first () integer)

(declare-fun workspace__last () integer)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun workspaces__generate_workspace__workspace__aggregate_def (Int
  Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___150 Int) (temp___151 Int) (temp___152 Int))
  (let ((temp___149 (workspaces__generate_workspace__workspace__aggregate_def
...
(define-fun dynamic_invariant4 ((temp___expr_143 us_t1)
...
(declare-fun temp___155 () (Array Int natural))

(declare-fun temp___1551 () t2)

(declare-fun workspaces__generate_workspace__workspace__assume () (Array Int natural))

(declare-fun workspaces__generate_workspace__workspace__assume1 () t1)
...
(declare-fun workspace1 () (Array Int natural))

(declare-fun result1 () Int)

(declare-fun j1 () Int)

(declare-fun workspace2 () (Array Int natural))

(declare-fun j2 () Int)

(declare-fun result2 () (Array Int natural))

(declare-fun workspace3 () (Array Int natural))
...
;; H
  ...
  (= (to_rep1
     (first4
     (rt2
     (workspaces__generate_workspace__workspace__aggregate_def 0 1 size)))) 1))
...
;; H
  (assert
  (= (mk___t2 temp___155 temp___1551) (workspaces__generate_workspace__workspace__aggregate_def
                                      0 1 size)))
...
;; H
  (assert (= temp___155 workspaces__generate_workspace__workspace__assume))
...
;; H
  (assert
  (= (to_rep1 workspace__first) (to_rep1
                                (first2
                                workspaces__generate_workspace__workspace__assume1))))
...
;; H
  (assert
  (and (dynamic_property2 1 size (to_rep1 workspace__first)
  (to_rep1 workspace__last))
  (and (= (to_rep1 workspace__first) 1) (= (to_rep1 workspace__last) size))))
...
;; H
  (assert
  (and (<= (to_rep1 workspace__first) j2) (<= j2 (to_rep1 workspace__last))))
...
;; H
  (assert (= temp___157 (- o3 j2)))

(assert
;; WP_parameter_def
 ;; File "workspaces.ads", line 3, characters 0-0
  (not (<= (to_rep1 workspace__first) temp___157)))
(check-sat)
(exit)
