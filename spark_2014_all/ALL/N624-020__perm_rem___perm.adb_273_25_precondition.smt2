...
;; H
  (assert
  (and (= o19 (remove bb o18))
  (and (dynamic_invariant2 o19 true false true)
  (and (= (invariant__ o19) true)
  (and (= (to_rep2 (last (rt o19))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o18 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o19) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o18 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o19) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o18 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o19) k))))))))))))
