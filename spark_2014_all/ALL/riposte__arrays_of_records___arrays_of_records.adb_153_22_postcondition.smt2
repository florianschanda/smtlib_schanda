...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a 23))) o1))

;; H
  (assert
  (= (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a 23))) o2))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a2 5))) o17))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a2 5))) o19))
...
;; H
  (assert
  (= a4 (store a3 23 (mk___rep
                     (mk___split_fields (of_int 1)
                     (rec__arrays_of_records__basic_record__first_value
                     (us_split_fields1 (select a3 23)))
                     (rec__arrays_of_records__basic_record__second_value
                     (us_split_fields1 (select a3 23))))))))
...
;; H
  ...
  (= (to_rep
     (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a4 23)))) 69))
...
(assert
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 138, characters 0-0
  (not
  (not
  (= (to_rep
     (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a5 17)))) 23))))
(check-sat)
(exit)
