...
(declare-fun temp___521 () us_rep1)
...
(declare-fun my_lists__m__delete__2__container__fields1 () us_split_fields)
...
(declare-fun d__split_fields7 () us_split_fields2)
...
;; H
  ...
  (and
  (and
  (<= (- (length (mk___rep l__split_discrs l__split_fields7)) 3) (length
                                                                 (mk___rep
                                                                 l__split_discrs
                                                                 my_lists__m__delete__2__container__fields1)))
  (<= (length
      (mk___rep l__split_discrs my_lists__m__delete__2__container__fields1)) 
  (length (mk___rep l__split_discrs l__split_fields7))))
  (= (bool_eq3 (mk___rep1 d__split_fields6) no_element) true))
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields7))
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields1)) 1
     (- (get (positions (mk___rep l__split_discrs l__split_fields7))
        (mk___rep1 d__split_fields5)) 1)) true))
  (ite (= (< (- (length (mk___rep l__split_discrs l__split_fields7)) 3) 
  (get (positions (mk___rep l__split_discrs l__split_fields7))
  ...
  (= (length
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields1)) (- 
  (length (mk___rep l__split_discrs l__split_fields7)) 3))
  (= (range_shifted
     (model__
     (mk___rep l__split_discrs my_lists__m__delete__2__container__fields1))
     (model__ (mk___rep l__split_discrs l__split_fields7))
     (get (positions (mk___rep l__split_discrs l__split_fields7))
...
;; H
  (assert
  (and
  (= temp___521 (next (mk___rep l__split_discrs l__split_fields8)
                (mk___rep1 c__split_fields9)))
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields9) no_element) false) (= 
          (get (positions (mk___rep l__split_discrs l__split_fields8))
          (mk___rep1 c__split_fields9)) (length
                                        (mk___rep l__split_discrs
                                        l__split_fields8))) true) true)
  (= (bool_eq3 temp___521 no_element) true)
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields8))
     temp___521) true)
  (= (get (positions (mk___rep l__split_discrs l__split_fields8)) temp___521) (+ 
  (get (positions (mk___rep l__split_discrs l__split_fields8))
  (mk___rep1 c__split_fields9)) 1))))))
...
;; H
  (assert
  (<= (length (mk___rep l__split_discrs l__split_fields8)) (+ (get
                                                              (positions
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields8))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields8))
     (mk___rep1 d__split_fields7)) true)))
(check-sat)
