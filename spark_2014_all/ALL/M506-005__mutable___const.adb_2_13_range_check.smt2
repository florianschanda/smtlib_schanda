...
(declare-datatypes ((tdB__ref 0)) (((mk_tdB__ref (tdB__content tdB)))))
...
(declare-datatypes ((t3s__ref 0)) (((mk_t3s__ref (t3s__content tdB)))))
...
(((mk___split_discrs (rec__const__t__k d)))))
