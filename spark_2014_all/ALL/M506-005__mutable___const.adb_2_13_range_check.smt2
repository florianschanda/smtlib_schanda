...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__const__t__k d)))))
(define-fun us_split_discrs___projection ((a us_split_discrs)) d (rec__const__t__k
                                                                 a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (and
                        (= (to_rep1 (rec__const__t__k (us_split_discrs1 a)))
                        (to_rep1 (rec__const__t__k (us_split_discrs1 b))))
                        (= (to_rep (rec__const__t__som (us_split_fields1 a)))
                        (to_rep (rec__const__t__som (us_split_fields1 b)))))
                        (= (bool_eq1
                           (rec__const__t__arr (us_split_fields1 a))
                           (rec__const__t__arr (us_split_fields1 b))) true))
                   true false))
...
(declare-fun const__t__k__first__bit () Int)

(declare-fun const__t__k__last__bit () Int)

(declare-fun const__t__k__position () Int)

;; const__t__k__first__bit_axiom
  (assert (<= 0 const__t__k__first__bit))

;; const__t__k__last__bit_axiom
  (assert (< const__t__k__first__bit const__t__k__last__bit))

;; const__t__k__position_axiom
  (assert (<= 0 const__t__k__position))

(declare-fun const__t__som__first__bit () Int)

(declare-fun const__t__som__last__bit () Int)

(declare-fun const__t__som__position () Int)

;; const__t__som__first__bit_axiom
  (assert (<= 0 const__t__som__first__bit))

;; const__t__som__last__bit_axiom
  (assert (< const__t__som__first__bit const__t__som__last__bit))

;; const__t__som__position_axiom
  (assert (<= 0 const__t__som__position))

(declare-fun const__t__arr__first__bit () Int)

(declare-fun const__t__arr__last__bit () Int)

(declare-fun const__t__arr__position () Int)

;; const__t__arr__first__bit_axiom
  (assert (<= 0 const__t__arr__first__bit))

;; const__t__arr__last__bit_axiom
  (assert (< const__t__arr__first__bit const__t__arr__last__bit))

;; const__t__arr__position_axiom
...
(define-fun dynamic_invariant1 ((temp___expr_149 us_rep)
  ...
  (temp___do_toplevel_148 Bool)) Bool (let ((temp___150 (rec__const__t__k
                                                        (us_split_discrs1
                                                        temp___expr_149))))
...
(assert
;; WP_parameter_def
 ;; File "const.ads", line 9, characters 0-0
  (not (in_range1 (to_rep1 (rec__const__t__k (us_split_discrs1 x))))))
(check-sat)
(exit)
