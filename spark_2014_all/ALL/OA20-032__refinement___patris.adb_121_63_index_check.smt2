...
;; H
  ...
  (=> (and (<= 0 xx) (<= xx 3))
  (=>
  (= (get (select possible_i_shapes (to_rep4 cur_piece__split_fields1)) yy
     xx) true)
...
;; H
  ...
  (=> (and (<= 1 temp___2133) (<= temp___2133 20))
  (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___2133))
  (= (select cur_board2 temp___2133) (select cur_board1 temp___2133)))))
  (and (<= 0 x2) (<= x2 3))))
