...
(declare-fun ih4 () int__ref)

(declare-fun ia5 () int__ref)

(declare-fun ib4 () int__ref)
...
(declare-fun ih6 () int__ref)

(declare-fun ia7 () int__ref)
...
(declare-fun perm__extended_perm__result3 () Int)

(declare-fun ih8 () int__ref)

(declare-fun ia9 () int__ref)

(declare-fun ib8 () int__ref)

(declare-fun perm__extended_perm__result4 () int__ref)

(declare-fun ih9 () Int)

(declare-fun ia10 () Int)

(declare-fun ib9 () Int)

(declare-fun perm__extended_perm__result5 () Int)

(declare-fun ih10 () int__ref)

(declare-fun ia11 () int__ref)

(declare-fun ib10 () int__ref)

(declare-fun perm__extended_perm__result6 () int__ref)

(declare-fun ih11 () Int)

(declare-fun ia12 () Int)

(declare-fun ib11 () Int)

(declare-fun perm__extended_perm__result7 () Int)

(declare-fun ih12 () int__ref)

(declare-fun ia13 () int__ref)

(declare-fun ib12 () int__ref)

(declare-fun perm__extended_perm__result8 () int__ref)

(declare-fun ih13 () Int)

(declare-fun ia14 () Int)

(declare-fun ib13 () Int)

(declare-fun perm__extended_perm__result9 () Int)
...
;; H
  ...
  (and
  (and
  (= perm__extended_perm__result6 (mk_int__ref perm__extended_perm__result2))
  (and (= ib10 ib14) (and (= ia11 ia15) (= ih10 ih14))))
  (and (= perm__extended_perm__result7 perm__extended_perm__result2)
  (and (= ib11 ib2) (and (= ia12 ia2) (= ih11 ih1)))))
  (and (= (length a) 0)
  (and (= result (mk_int__ref perm__extended_perm__result))
  (= perm__extended_perm__result2 1))))
  (and
  (and (not (= (length a) 0))
  (and (= perm__extended_perm__result2 perm__extended_perm__result)
  (= perm__extended_perm__result2 perm__extended_perm__result1)))
  (and
  (and
  (and (= perm__extended_perm__result6 perm__extended_perm__result4)
  (and (= ib10 ib8) (and (= ia11 ia9) (= ih10 ih8))))
  (and (= perm__extended_perm__result7 perm__extended_perm__result5)
  (and (= ib11 ib9) (and (= ia12 ia10) (= ih11 ih9)))))
  (and
  (and
  (and
  (= perm__extended_perm__result4 (mk_int__ref perm__extended_perm__result3))
  (and (= ib8 ib6) (and (= ia9 ia7) (= ih8 ih6))))
  (and (= perm__extended_perm__result5 perm__extended_perm__result3)
  ...
  (= perm__extended_perm__B_6__w__assume2 w))
  (and
  (and
  (and
  ...
  (= (to_rep (select (elts a) (+ k 1))) (to_rep
                                        (select perm__extended_perm__B_6__aa__assume k)))))))))))
  (= perm__extended_perm__B_6__aa__assume2 aa))
  (and (dynamic_invariant2 aa true false true)
  (and
  (and
  (and
  ...
  (= (to_rep (select (elts b) (+ k 1))) (to_rep
                                        (select perm__extended_perm__B_6__bb__assume k)))))))))))
  (= perm__extended_perm__B_6__bb__assume2 bb))
  ...
  (forall ((ia16 Int))
  (=>
  (and (<= (to_rep2 (first (rt aa))) ia16)
  (<= ia16 (to_rep2 (last (rt aa)))))
  (exists ((ib15 Int))
  (and
  (and (<= (to_rep2 (first (rt bb))) ib15)
  (<= ib15 (to_rep2 (last (rt bb)))))
  (and (= (to_rep (select (elts aa) ia16)) (to_rep (select (elts bb) ib15)))
  (= (is_perm (remove aa ia16) (remove bb ib15)) true)))))))))
  (and (= result1 ih14) (= ih2 o)))
  (and (in_range3 ih2)
  (and (= (of_int ih2) true)
  (and
  (and (and (= result2 ia15) (= ia3 (to_rep2 (first (rt a)))))
  (ite (and (<= (to_rep2 (first (rt a))) ia3)
  ...
  (exists ((ib15 Int))
  (and
  (and (<= (to_rep2 (first (rt b))) ib15) (<= ib15 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib15)))
  (= (is_perm (remove a ia3) (remove b ib15)) true))))
  (and
  ...
  (and
  (and (<= (to_rep2 (first (rt b))) ib15) (<= ib15 (to_rep2 (last (rt b)))))
  (and (= (to_rep (select (elts a) k)) (to_rep (select (elts b) ib15)))
  (= (is_perm (remove a k) (remove b ib15)) true))))))
  (and
  (and
  (and
  (and (=> (<= 1 1) (in_range3 ih3))
  (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a))))
  (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))
  ia4))) (=> (<= 1 100) (in_range4 ib3)))
  (and (<= (to_rep2 (first (rt a))) ia4) (<= ia4 (to_rep2 (last (rt a))))))
  (= ia4 (to_rep2 (last (rt a)))))))))))
  (and
  (and (= ib4 (mk_int__ref ib3))
  (and (= ia5 (mk_int__ref ia4)) (= ih4 (mk_int__ref ih3))))
  (and (= ib5 ib3) (and (= ia6 ia4) (= ih5 ih3)))))
  (and (and (= ib6 ib4) (and (= ia7 ia5) (= ih6 ih4)))
  (and (= ib7 ib5) (and (= ia8 ia6) (= ih7 ih5)))))
  (and
  (and (= ib6 ib14)
  (and (= ia7 (mk_int__ref ia3)) (= ih6 (mk_int__ref ih2))))
  (and (= ib7 ib2) (and (= ia8 ia3) (= ih7 ih2))))))
  (and (= result3 (mk_int__ref perm__extended_perm__result2))
  (= perm__extended_perm__result3 (int__content ih6)))))))))))))))))
