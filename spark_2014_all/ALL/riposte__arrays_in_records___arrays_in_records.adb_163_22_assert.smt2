...
(declare-fun temp___289 () index)

(declare-fun temp___2891 () (Array Int value))

(declare-fun temp___2892 () (Array Int value))
...
(declare-fun temp___292 () index)

(declare-fun temp___2921 () (Array Int value))

(declare-fun temp___2922 () (Array Int value))
...
(declare-fun temp___295 () index)

(declare-fun temp___2951 () (Array Int value))

(declare-fun temp___2952 () (Array Int value))
...
(declare-fun temp___297 () index)

(declare-fun temp___2971 () (Array Int value))

(declare-fun temp___2972 () (Array Int value))
...
;; H
  (assert
  (= a__split_fields9 (mk___split_fields temp___295 temp___2951 temp___2952)))
...
;; H
  (assert
  (= a__split_fields10 (mk___split_fields temp___297 temp___2971 temp___2972)))

(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 141, characters 0-0
  (not
  (= (to_rep1
