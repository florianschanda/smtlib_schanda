...
;; range_axiom
  (assert
  (forall ((x enum1t)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(define-fun bool_eq3 ((a us_rep3)
  (b us_rep3)) Bool (ite (and
                         ...
                         (to_rep1 (rec__ar__rec4t__g4 (us_split_fields7 b)))))
                    true false))
...
(declare-const temp___7081 us_rep3)
...
;; H
  (assert (= temp___7081 (mk___rep3 o19)))
...
;; H
  (assert (= r__split_fields6 (us_split_fields7 temp___7081)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1019, characters 0-0
  (not
  (= (bool_eq2
     (rec__ar__rec4t__f4 (us_split_fields__content3 r__split_fields7))
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1 r__split_fields
