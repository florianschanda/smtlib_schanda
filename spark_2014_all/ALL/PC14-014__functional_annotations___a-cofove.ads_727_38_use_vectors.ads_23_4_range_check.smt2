...
;; H
  (assert
  (and (= temp___421 (last4 (model__ container)))
  (and (dynamic_property4 first3 last5 temp___421)
  (= temp___421 (last4 (model__ container))))))

(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 704, characters 0-0
  (not (dynamic_property3 first2 last3 temp___421)))
(check-sat)
(exit)
