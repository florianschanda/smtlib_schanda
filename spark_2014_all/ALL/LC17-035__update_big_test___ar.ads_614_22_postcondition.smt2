...
(declare-fun dummy5 () (Array Int (Array Int (Array Int et1))))
...
(declare-fun user_eq5 ((Array Int (Array Int (Array Int et1)))
...
(define-fun bool_eq6 ((a (Array Int (Array Int (Array Int (Array Int et1)))))
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq5 (select a temp___idx_135) 1 16
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 609, characters 0-0
  (not (= (bool_eq5 (select a2 n) 1 16 (select a n) 1 16) true)))
(check-sat)
