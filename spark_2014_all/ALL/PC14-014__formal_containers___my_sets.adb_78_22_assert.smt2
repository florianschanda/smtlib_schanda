...
(declare-fun temp___1387 () us_rep1)

(declare-fun temp___1389 () us_rep1)
...
(declare-fun my_sets__m__delete__2__container__fields () us_split_fields)
...
(declare-fun my_sets__m__exclude__container__fields () us_split_fields)

(declare-fun result21 () us_split_fields__ref)

(declare-fun l__split_fields11 () us_split_fields)

(declare-fun my_sets__m__exclude__container__fields1 () us_split_fields)
...
;; H
  (assert
  (and (= temp___1387 (find1 (mk___rep l__split_discrs l__split_fields9) 3))
  (ite (ite (= (contains
               (model__ (mk___rep l__split_discrs l__split_fields9)) 3) false) true false)
  (= (bool_eq1 temp___1387 no_element) true)
  (and
  (and
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields9))
     temp___1387) (find
                  (elements (mk___rep l__split_discrs l__split_fields9)) 3)))
  (= (element (mk___rep l__split_discrs l__split_fields9) temp___1387) 3)))))

;; H
  (assert (= result18 (mk___split_fields__ref1 c__split_fields3)))

;; H
  (assert (= c__split_fields4 (us_split_fields3 temp___1387)))
...
;; H
  ...
  (= (length
     (mk___rep l__split_discrs my_sets__m__delete__2__container__fields)) (-
  (length (mk___rep l__split_discrs l__split_fields9)) 1)))
  (not
  (= (contains
     (model__
     (mk___rep l__split_discrs my_sets__m__delete__2__container__fields))
     (element (mk___rep l__split_discrs l__split_fields9)
  ...
  (= (ole
     ...
     (mk___rep l__split_discrs my_sets__m__delete__2__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields9))) true))
  (= (included_except (model__ (mk___rep l__split_discrs l__split_fields9))
     (model__
     (mk___rep l__split_discrs my_sets__m__delete__2__container__fields))
     (element (mk___rep l__split_discrs l__split_fields9)
     (mk___rep1 c__split_fields4))) true))
...
;; H
  (assert (= l__split_fields10 my_sets__m__delete__2__container__fields))

;; H
  (assert
  (not
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields10)) 3) true)))

;; H
  (assert
  (and (= temp___1389 (find1 (mk___rep l__split_discrs l__split_fields10) 3))
  (ite (ite (= (contains
               (model__ (mk___rep l__split_discrs l__split_fields10)) 3) false) true false)
  (= (bool_eq1 temp___1389 no_element) true)
  (and
  (and
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields10))
     temp___1389) (find
                  (elements (mk___rep l__split_discrs l__split_fields10)) 3)))
  (= (element (mk___rep l__split_discrs l__split_fields10) temp___1389) 3)))))

;; H
  (assert (= result20 (mk___split_fields__ref1 c__split_fields5)))

;; H
  (assert (= c__split_fields6 (us_split_fields3 temp___1389)))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep l__split_discrs my_sets__m__exclude__container__fields)) 2) true))
  (ite (ite (= (contains
  ...
  (= (oeq2
     (model__
     (mk___rep l__split_discrs my_sets__m__exclude__container__fields))
     (model__ (mk___rep l__split_discrs l__split_fields10))) true)
  (= (oeq4
     (elements
     (mk___rep l__split_discrs my_sets__m__exclude__container__fields))
     (elements (mk___rep l__split_discrs l__split_fields10))) true))
  (= (oeq3
     (positions
     (mk___rep l__split_discrs my_sets__m__exclude__container__fields))
...
;; H
  (assert (= result21 (mk___split_fields__ref l__split_fields10)))

;; H
  (assert (= l__split_fields11 my_sets__m__exclude__container__fields))

;; H
  (assert
  (= (contains (model__ (mk___rep l__split_discrs l__split_fields11)) 1) true))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep l__split_discrs my_sets__m__exclude__container__fields1)) 1) true))
  (ite (ite (= (contains
  ...
  (= (oeq2
     (model__
     (mk___rep l__split_discrs my_sets__m__exclude__container__fields1))
...
;; H
  (assert (= result22 (mk___split_fields__ref l__split_fields11)))

;; H
  (assert (= l__split_fields12 my_sets__m__exclude__container__fields1))
