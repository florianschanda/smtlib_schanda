...
;; H
  (assert (=> (not (= result3 true)) (and (= o7 (get o6 i)) (in_range4 o7))))

;; H
  (assert
  (and (= o4 (model__ (mk___rep l__split_discrs l__split_fields1)))
  (= (length1 o4) (length (mk___rep l__split_discrs l__split_fields1)))))
