...
;; H
  (assert
  (and (= o1 (last5 (model__ (mk___rep v__split_discrs v__split_fields2))))
  (and (dynamic_property5 first4 last6 o1)
  (= o1 (last5 (model__ (mk___rep v__split_discrs v__split_fields2)))))))
...
;; H
  (assert
  (and (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o4))
  (and (in_range5 o5)
  (= o5 (get (model__ (mk___rep v__split_discrs v__split_fields2)) o4)))))
