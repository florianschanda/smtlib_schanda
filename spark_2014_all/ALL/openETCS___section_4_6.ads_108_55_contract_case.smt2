...
(declare-fun dummy1 () ertms_etcs_level_t)
...
(declare-fun condition_transition_sb_to_sh (Int Bool Bool Bool Bool Bool Bool
  Int) Bool)

(declare-fun condition_transition_sb_to_sh__function_guard (Bool Int Bool
  Bool Bool Bool Bool Bool Int) Bool)
...
;; condition_transition_sb_to_sh__post_axiom
  (assert true)

;; condition_transition_sb_to_sh__def_axiom
  (assert
  (forall ((etcs_level__ertms_etcs_level Int) (section_4_6__priority Int))
  (forall
  ((section_4_6__an_acknowledge_request_for_shunting_is_displayed_to_the_driver Bool)
  (section_4_6__driver_acknowledges Bool)
  (section_4_6__driver_selects_shunting_mode Bool)
  ...
  (! (=
     (= (condition_transition_sb_to_sh etcs_level__ertms_etcs_level
        ...
        section_4_6__train_is_at_standstill section_4_6__priority) true)
     (and
     (or
     (or
...
(declare-fun condition_transition_sb_to_fs__function_guard (Bool Bool Bool
  Bool Int) Bool)
...
;; condition_transition_sb_to_fs__post_axiom
  (assert true)

;; condition_transition_sb_to_fs__def_axiom
  (assert
...
(declare-fun condition_transition_sb_to_is__function_guard (Bool Bool
  Int) Bool)
...
;; condition_transition_sb_to_is__post_axiom
  (assert true)

;; condition_transition_sb_to_is__def_axiom
  (assert
...
;; condition_10__post_axiom
  (assert true)

;; condition_10__def_axiom
  (assert
  (forall ((section_4_6__ma_ssp_gardient_on_board Bool)
  (section_4_6__no_specific_mode_is_required_by_a_mode_profile Bool)
  (section_4_6__valid_train_data_is_stored_on_board Bool))
...
;; condition_50__post_axiom
  (assert true)

;; condition_50__def_axiom
  (assert
  (forall
  ((section_4_6__an_acknowledge_request_for_shunting_is_displayed_to_the_driver Bool)
  (section_4_6__driver_acknowledges Bool)
