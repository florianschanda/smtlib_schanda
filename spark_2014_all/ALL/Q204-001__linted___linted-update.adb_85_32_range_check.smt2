...
(define-fun y15 () int__ref (mk_int__ref y4))

(define-fun y16 () int__ref (mk_int__ref y3))

(define-fun y17 () int__ref (mk_int__ref y2))

(define-fun y18 () int__ref (mk_int__ref y1))

(define-fun y19 () int__ref (mk_int__ref y))
...
;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= result1 y19)))
...
;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= result2 y19)))
...
;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= result5 y18)))
...
;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= result6 y18)))
...
;; H
  (assert (=> (bvule x7 ((_ int2bv 32) 2147483647)) (= result9 y17)))
...
;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= result10 y17)))
...
;; H
  (assert (=> (bvule x8 ((_ int2bv 32) 2147483647)) (= result13 y16)))
...
;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= result14 y16)))
...
;; H
  (assert (=> (bvule x9 ((_ int2bv 32) 2147483647)) (= result17 y15)))

;; H
  (assert (=> (bvule x9 ((_ int2bv 32) 2147483647)) (= y13 o139)))
...
;; H
  (assert (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= result18 y15)))

;; H
  (assert (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= y14 o143)))

;; H
  (assert (=> (not (bvule x9 ((_ int2bv 32) 2147483647))) (= y13 y14)))

;; H
  (assert (= (to_rep1 o144) y13))
