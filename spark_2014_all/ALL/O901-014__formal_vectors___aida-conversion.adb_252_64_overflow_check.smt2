...
(define-fun tint_arrayD1__ref___2__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___2__projection ((a tint_arrayT__ref)) us_t1
...
(((mk_t56b__ref (t56b__content integer)))))
...
(declare-datatypes ((t57b__ref 0)) (((mk_t57b__ref (t57b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___2__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___2__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t61b__ref 0)) (((mk_t61b__ref (t61b__content us_t4)))))
...
(define-fun tint_arrayB__ref___2__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___2__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; H
  (assert
  (and (= temp___1240 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1240)
  (<= temp___1240 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1239 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1239)
  (<= temp___1239 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1238 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1238)
  (<= temp___1238 (to_rep1 (last (rt source))))))

;; H
  (assert (= o20 temp___1238))
...
;; H
  (assert
  (and (= temp___1237 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1237)
  (<= temp___1237 (to_rep1 (last (rt source))))))

;; H
  (assert (= o16 temp___1237))
...
;; H
  (assert
  (and (= temp___1236 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1236)
  (<= temp___1236 (to_rep1 (last (rt source))))))

;; H
  (assert (= o12 temp___1236))
...
;; H
  (assert
  (and (= temp___1235 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1235)
  (<= temp___1235 (to_rep1 (last (rt source))))))

;; H
  (assert (= o8 temp___1235))
...
;; H
  (assert
  (and (= temp___1234 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1234)
  (<= temp___1234 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___1234))
...
;; H
  (assert
  (and (= temp___1233 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1233)
  (<= temp___1233 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1233))
