...
;; H
  ...
  (mk___t x__split_fields1 x__split_fields2))) true false true))
...
;; H
  (assert (dynamic_invariant1
  (mk___rep x__split_discrs
  (mk___split_fields x__split_fields3
  (mk___t x__split_fields4 x__split_fields5))) true true true))

(assert
;; WP_parameter_def
 ;; File "const.adb", line 2, characters 0-0
  (not (<= (to_rep2 (first x__split_fields5)) 1)))
(check-sat)
(exit)
