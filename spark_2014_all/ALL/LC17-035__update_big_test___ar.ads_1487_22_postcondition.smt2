...
;; def_axiom
  (assert
  (forall ((temp___3088 (Array Int et1)))
  (forall ((temp___3089 Int) (temp___3090 Int) (temp___3091 Int)
  (temp___3092 Int))
  (let ((temp___3087 (temp___3086 temp___3088 temp___3089 temp___3090
                     temp___3091 temp___3092)))
  (forall ((temp___3093 Int))
  (ite (= temp___3093 temp___3091)
  (= (select temp___3087 temp___3093) (of_rep temp___3092))
  (ite (= temp___3093 temp___3089)
  (= (select temp___3087 temp___3093) (of_rep temp___3090))
  (= (select temp___3087 temp___3093) (select temp___3088 temp___3093)))))))))
...
(declare-fun temp___8035 () (Array Int et1))

(declare-fun temp___80351 () enum2t)
...
(declare-fun o7 () enum2t)

(declare-fun temp___8038 () (Array Int et1))

(declare-fun temp___80381 () enum2t)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1478, characters 0-0
  (not
  (= (bool_eq1
     (mk___rep (mk___split_fields r__split_fields6 r__split_fields7))
     (mk___rep
     (mk___split_fields (temp___3086 r__split_fields i e j f)
