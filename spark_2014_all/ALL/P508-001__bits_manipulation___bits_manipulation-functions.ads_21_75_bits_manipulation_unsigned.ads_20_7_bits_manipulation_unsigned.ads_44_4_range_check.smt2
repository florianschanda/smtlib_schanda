...
(define-fun dynamic_invariant3 ((temp___expr_317 Int)
...
;; H
  (assert
  (and (= o6 (make_mask o5))
  (= o6 (shift_right ((_ int2bv 32) 4294967295) (- 32 o5)))))

;; H
  (assert
  (and (= o7 (shift_right value from))
  (= o7 (ite (and (<= 1 32) (<= 32 8))
        ((_ zero_extend 24) (ite (< from 8)
                            (bvlshr ((_ extract 7 0) value) ((_ int2bv 8)
                            from)) ((_ int2bv 8) 0)))
        (ite (and (<= 9 32) (<= 32 16))
        ((_ zero_extend 16) (ite (< from 16)
                            (bvlshr ((_ extract 15 0) value) ((_ int2bv 16)
                            from)) ((_ int2bv 16) 0)))
        (ite (and (<= 17 32) (<= 32 32)) (bvlshr value ((_ int2bv 32)
        from))
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64)
        from)))))))))
...
;; H
  (assert
  (= result4 (ite (= bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result4
             o8) true false)))
...
;; H
  (assert
  (and (= o4 (make_mask o3))
  (= o4 (shift_right ((_ int2bv 32) 4294967295) (- 32 o3)))))

;; H
  (assert
  (= result5 (ite (bvule bits_manipulation_unsigned__unsigned_32__functions__extract_bits__result4
             o4) true false)))
