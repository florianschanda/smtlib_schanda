...
(declare-fun cu () natural)

(declare-fun cu1 () natural)
...
(define-fun cu2 () us_rep1 (mk___rep1 (mk___split_discrs cu)
                           (mk___split_fields1 cu1)))

;; H
  (assert
  (and (= o (has_element a cu2))
  (= (= o true) (and (<= 1 (to_rep cu1)) (<= (to_rep cu1) 100)))))
