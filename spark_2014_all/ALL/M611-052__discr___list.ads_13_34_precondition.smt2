...
(declare-fun list__reverse_list__result () capacity_range)

(declare-fun list__reverse_list__result1 () us_main_type)
...
(declare-fun temp___476 () index)

(declare-fun temp___4761 () index)

(declare-fun temp___4762 () (Array Int integer))

(declare-fun temp___4763 () t2)

(declare-fun o () Int)

(declare-fun o1 () Int)

(declare-fun list__reverse_list__L_2__R7b__assume () Int)

(declare-fun list__reverse_list__L_2__R8b__assume () Int)

(declare-fun temp___485 () capacity_range)

(declare-fun temp___4851 () us_main_type)

(declare-fun temp___484 () Int)

(declare-fun temp___483 () index)

(declare-fun temp___4831 () index)

(declare-fun temp___4832 () (Array Int integer))

(declare-fun temp___4833 () t2)
...
(declare-fun s__split_fields4 () us_split_fields4)

(declare-fun i4 () Int)

(declare-fun stack__push__s__fields () us_split_fields)

(declare-fun result1 () us_split_fields__ref2)

(declare-fun s__split_fields5 () us_split_fields4)

(declare-fun s__split_fields6 () us_split_fields__ref2)

(declare-fun i5 () int__ref)

(declare-fun s__split_fields7 () us_split_fields4)

(declare-fun i6 () Int)

(declare-fun s__split_fields8 () us_split_fields__ref2)

(declare-fun i7 () int__ref)

(declare-fun s__split_fields9 () us_split_fields4)
...
(declare-fun list__my_lists__append__2__container__fields () us_split_fields2)

(declare-fun result3 () us_split_fields__ref1)

(declare-fun res__split_fields2 () us_split_fields2)

(declare-fun stack__pop__s__fields () us_split_fields)

(declare-fun result4 () us_split_fields__ref2)

(declare-fun s__split_fields10 () us_split_fields4)

(declare-fun s__split_fields11 () us_split_fields4)

(declare-fun res__split_fields3 () us_split_fields2)

(declare-fun i10 () Int)

(declare-fun s__split_fields12 () us_split_fields__ref2)

(declare-fun res__split_fields4 () us_split_fields__ref1)

(declare-fun i11 () int__ref)

(declare-fun s__split_fields13 () us_split_fields4)

(declare-fun res__split_fields5 () us_split_fields2)

(declare-fun i12 () Int)

(declare-fun s__split_fields14 () us_split_fields__ref2)

(declare-fun res__split_fields6 () us_split_fields__ref1)

(declare-fun i13 () int__ref)

(declare-fun s__split_fields15 () us_split_fields4)

(declare-fun res__split_fields7 () us_split_fields2)

(declare-fun i14 () Int)

(declare-fun result5 () list__ref)

(declare-fun list__reverse_list__result2 () us_rep1)

(declare-fun s__split_fields16 () us_split_fields__ref2)

(declare-fun res__split_fields8 () us_split_fields__ref1)

(declare-fun i15 () int__ref)

(declare-fun i16 () int__ref)

(declare-fun list__reverse_list__result3 () list__ref)

(declare-fun s__split_fields17 () us_split_fields4)

(declare-fun res__split_fields9 () us_split_fields2)

(declare-fun i17 () Int)

(declare-fun i18 () Int)

(declare-fun list__reverse_list__result4 () us_rep1)

(declare-fun s__split_fields18 () us_split_fields__ref2)

(declare-fun res__split_fields10 () us_split_fields__ref1)

(declare-fun i19 () int__ref)

(declare-fun i20 () int__ref)

(declare-fun list__reverse_list__result5 () list__ref)

(declare-fun s__split_fields19 () us_split_fields4)

(declare-fun res__split_fields11 () us_split_fields2)

(declare-fun i21 () Int)

(declare-fun i22 () Int)

(declare-fun list__reverse_list__result6 () us_rep1)

(declare-fun result6 () Bool)

(define-fun res__split_fields12 () us_split_fields__ref1 (mk___split_fields__ref1
                                                         (mk___split_fields1
                                                         res__split_fields)))
...
;; H
  (assert
  (= list__reverse_list__result3 (mk_list__ref list__reverse_list__result2)))
...
;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b))
  (and (= s__split_discrs (mk___split_discrs temp___476))
  (and (= s__split_fields temp___4761)
  (and (= s__split_fields1 temp___4762) (= s__split_fields2 temp___4763))))))
...
;; H
  ...
  (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields4))))
  (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields4)))))
  (and
  (= (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields4)))) 1)
  (= (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields4))))
  r1b))) (and (<= r4b i4) (<= i4 r5b)))))
...
;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b))
  (and (= o1 (get (model__ l) o))
  (and (in_range7 o1) (= o1 (get (model__ l) o))))))

;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b))
  (and
  (and (= (top (mk___rep s__split_discrs stack__push__s__fields)) o1)
  (= (let ((temp___182 (to__
                       (mk___rep s__split_discrs
                       (us_split_fields1
                       (to_base (mk___rep2 s__split_discrs s__split_fields4)))))))
     (let ((temp___181 (to_but_top
                       (mk___rep s__split_discrs stack__push__s__fields))))
     (bool_eq (elts1 temp___181) (to_rep (first2 (rt1 temp___181)))
     (to_rep (last2 (rt1 temp___181))) (elts1 temp___182)
     (to_rep (first2 (rt1 temp___182))) (to_rep (last2 (rt1 temp___182)))))) true))
  (dynamic_invariant2 (mk___rep s__split_discrs stack__push__s__fields) true
  true true))))

;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b))
  (= result1 (mk___split_fields__ref2 s__split_fields4))))

;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b))
  (= s__split_fields5 (us_split_fields5
                      (of_base
                      (mk___rep s__split_discrs stack__push__s__fields))))))
...
;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b))
  (= s__split_discrs (us_split_discrs4
                     (of_base
                     (mk___rep s__split_discrs stack__push__s__fields))))))
...
;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b))
  (= s__split_fields6 (mk___split_fields__ref2 s__split_fields5))))
...
;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b)) (= s__split_fields7 s__split_fields5)))
...
;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b)) (= s__split_fields8 s__split_fields6)))
...
;; H
  (assert
  (=> (and (<= r4b i3) (<= i3 r5b)) (= s__split_fields9 s__split_fields7)))
...
;; H
  (assert
  (=> (not (and (<= r4b i3) (<= i3 r5b)))
  (= s__split_fields8 (mk___split_fields__ref2
                      (mk___split_fields2 s__split_fields
                      (mk___t2 s__split_fields1 s__split_fields2))))))
...
;; H
  (assert
  (=> (not (and (<= r4b i3) (<= i3 r5b)))
  (= s__split_fields9 s__split_fields3)))

;; H
  (assert
  (and (= list__reverse_list__L_2__R7b__assume 1)
  (and (in_range4 list__reverse_list__L_2__R7b__assume)
  (= list__reverse_list__L_2__R7b__assume 1))))
...
;; H
  (assert
  (and (= list__reverse_list__L_2__R8b__assume (last4 (model__ l)))
  (and (in_range5 list__reverse_list__L_2__R8b__assume)
  (= list__reverse_list__L_2__R8b__assume (last4 (model__ l))))))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (and (= res__split_discrs (mk___split_discrs1 temp___485))
  (= res__split_fields temp___4851))))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (and (= s__split_discrs (mk___split_discrs temp___483))
  (= (us_split_fields__content2 s__split_fields8) (mk___split_fields2
                                                  temp___4831
                                                  (mk___t2 temp___4832
                                                  temp___4833))))))
...
;; H
  ...
  (= o2 (top
        (to_base
        (mk___rep2 s__split_discrs
        (us_split_fields__content2 s__split_fields8)))))
  (and (in_range1 o2)
  (= o2 (to_rep1
        (rec__stack__stack__top
        (us_split_fields1
...
;; H
  ...
  (and
  (= (length2
     (mk___rep1 res__split_discrs
     list__my_lists__append__2__container__fields)) (+ (length2
                                                       (mk___rep1
                                                       res__split_discrs
                                                       (mk___split_fields1
                                                       res__split_fields))) 1))
  ...
  (= (get
     (model__
     (mk___rep1 res__split_discrs
     list__my_lists__append__2__container__fields))
     (+ (last4
        (model__
        (mk___rep1 res__split_discrs (mk___split_fields1 res__split_fields)))) 1))
  o2))))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (= res__split_fields2 list__my_lists__append__2__container__fields)))
...
;; H
  ...
  (and
  (= (let ((temp___188 (to__
                       (mk___rep s__split_discrs stack__pop__s__fields))))
     (let ((temp___187 (to_but_top
                       (mk___rep s__split_discrs
                       (us_split_fields1
                       (to_base
                       (mk___rep2 s__split_discrs
                       (us_split_fields__content2 s__split_fields8))))))))
     (bool_eq (elts1 temp___187) (to_rep (first2 (rt1 temp___187)))
     (to_rep (last2 (rt1 temp___187))) (elts1 temp___188)
     (to_rep (first2 (rt1 temp___188))) (to_rep (last2 (rt1 temp___188)))))) true)
  (dynamic_invariant2 (mk___rep s__split_discrs stack__pop__s__fields) true
  true true))))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (= s__split_fields10 (us_split_fields5
                       (of_base
                       (mk___rep s__split_discrs stack__pop__s__fields))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i10))
  (= (get (model__ (mk___rep1 res__split_discrs res__split_fields3)) j)
  (get (model__ l) (+ (- (last4 (model__ l)) j) 1)))))))
...
;; H
  ...
  (and
  (and (dynamic_property4 1 r1b
  (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields11))))
  (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields11)))))
  (and
  (= (to_rep (first4 (rt2 (rec__stack__stack__content1 s__split_fields11)))) 1)
  (= (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields11))))
  r1b))) (=> (<= r7b r8b) (dynamic_property5 r7b r8b i10)))
  (and (<= r7b i10) (<= i10 r8b)))))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3))))

;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (= s__split_fields12 (mk___split_fields__ref2 s__split_fields11))))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (= res__split_fields5 res__split_fields3)))

;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b)) (= s__split_fields13 s__split_fields11)))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (= res__split_fields6 res__split_fields4)))

;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b)) (= s__split_fields14 s__split_fields12)))
...
;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b))
  (= res__split_fields7 res__split_fields5)))

;; H
  (assert
  (=> (and (<= r7b i9) (<= i9 r8b)) (= s__split_fields15 s__split_fields13)))
...
;; H
  (assert
  (=> (not (and (<= r7b i9) (<= i9 r8b)))
  (= res__split_fields6 res__split_fields12)))

;; H
  (assert
  (=> (not (and (<= r7b i9) (<= i9 r8b)))
  (= s__split_fields14 s__split_fields8)))
...
;; H
  (assert
  (=> (not (and (<= r7b i9) (<= i9 r8b)))
  (= res__split_fields7 res__split_fields1)))

;; H
  (assert
  (=> (not (and (<= r7b i9) (<= i9 r8b)))
  (= s__split_fields15 s__split_fields9)))

;; H
  (assert
  (= result5 (mk_list__ref
             (mk___rep1 (mk___split_discrs1 list__reverse_list__result)
             (mk___split_fields1 list__reverse_list__result1)))))

;; H
  (assert
  (= list__reverse_list__result2 (mk___rep1 res__split_discrs
...
;; H
  (assert
  (and (= o4 (last4 (model__ l)))
  (and (in_range5 o4) (= o4 (last4 (model__ l))))))
...
;; H
  (assert
  (and (= o7 (last4 (model__ l)))
  (and (in_range5 o7) (= o7 (last4 (model__ l))))))
