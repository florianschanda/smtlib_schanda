...
(((mk_t10s__ref (t10s__content integer)))))
...
(declare-datatypes ((t11s__ref 0)) (((mk_t11s__ref (t11s__content us_t)))))
(define-fun t11s__ref___projection ((a t11s__ref)) us_t (t11s__content a))

(declare-datatypes ((us_split_discrs 0))
(((mk___split_discrs (rec__stack__stack__n index)))))
...
(declare-datatypes ((m__ref 0)) (((mk_m__ref (m__content us_t1)))))
...
(((mk_list__ref (list__content us_rep1)))))
...
(declare-datatypes ((t2b__ref 0)) (((mk_t2b__ref (t2b__content us_t2)))))
...
(define-fun us_split_fields_Top__2__projection ((a us_split_fields4)) index
  (rec__stack__stack__top1 a))

(define-fun us_split_fields_Content__2__projection ((a us_split_fields4)) us_t2
...
(define-fun us_rep___5__projection ((a us_rep3)) us_split_discrs (us_split_discrs4
                                                                 a))

(define-fun us_rep___6__projection ((a us_rep3)) us_split_fields4 (us_split_fields5
                                                                  a))
...
(declare-datatypes ((tsS__ref 0)) (((mk_tsS__ref (tsS__content us_rep3)))))
...
(declare-datatypes ((t9b__ref 0)) (((mk_t9b__ref (t9b__content integer)))))
