...
;; H
  ...
  (=> (and (<= 1 j) (<= j 100))
  (=> (= (select todo3 j) true)
  (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true)))))
...
;; H
  ...
  (not
  (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))
...
;; H
  ...
  (= (rec__tree_model__path_type__k
     ...
     (select r2 (to_rep
                (rec__binary_trees__cell__parent
                (us_split_fields3
                (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))))) true))))))
...
;; H
  ...
  (= (is_add
     ...
     (us_split_fields3
     (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))
     (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))) true)
  (= (length
     (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))) 0)))))
...
;; H
  ...
  (=> (and (<= 1 j) (<= j 100))
  (<= (length
      (rec__tree_model__path_type__a (us_split_fields1 (select r2 j)))) (- 100 
  (length1 unseen2))))))
