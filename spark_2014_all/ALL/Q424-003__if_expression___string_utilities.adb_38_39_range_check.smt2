...
;; H
  (assert (and (= o (- x12 1)) (in_range1 (- x12 1))))

;; H
  (assert
  (and (= o3 (get_length o o2 lengths2))
  (and (dynamic_property3 0 last4 o3)
  (= o3 (ite (and (dynamic_property1 first2 last2 o) (dynamic_property2
             first3 last3 o2))
        (to_rep2 (get lengths2 o o2)) 0)))))

;; H
  (assert (= o4 (+ 1 o3)))

;; H
  (assert (and (= temp___250 o4) (in_range5 o4)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (dynamic_property3 0 last4 temp___250)))
(check-sat)
(exit)
