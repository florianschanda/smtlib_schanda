...
(declare-fun user_eq1 (int100 int100) Bool)

(declare-const dummy1 int100)

(declare-datatypes ()
((int100__ref (mk_int100__ref (int100__content int100)))))
(define-fun int100__ref___projection ((a int100__ref)) int100 (int100__content
                                                              a))

(define-fun dynamic_invariant ((temp___expr_527 Int)
...
(declare-fun user_eq2 (int200 int200) Bool)

(declare-const dummy2 int200)

(declare-datatypes ()
((int200__ref (mk_int200__ref (int200__content int200)))))
(define-fun int200__ref___projection ((a int200__ref)) int200 (int200__content
                                                              a))
...
(define-fun dynamic_invariant2 ((temp___expr_533 Int)
...
(assert
;; WP_parameter_def
 ;; File "inst_ext_ax.ads", line 11, characters 0-0
  (not (in_range o1)))
(check-sat)
(exit)
