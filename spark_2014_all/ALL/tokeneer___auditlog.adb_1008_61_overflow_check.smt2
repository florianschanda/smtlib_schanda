...
(declare-fun dummy4 () fileentrycountt)
...
(declare-fun dummy5 () logfilecountt)
...
(declare-fun dummy6 () logfileindext)
...
(declare-fun dummy7 () (Array Int logfileindext))
...
(declare-fun dummy10 () filestatust)
...
(declare-fun dummy11 () tlogentrycounttB)
