...
;; H
  (assert
  (forall ((i (_ BitVec 8)))
  (=> (and (bvule ((_ int2bv 8) 0) i) (bvule i ((_ int2bv 8) 7)))
  (=> (not (= i (bvsub ((_ int2bv 8) 7) left_bv)))
  (= (= (nth_bv r i) true) (= (nth_bv byte i) true))))))

;; H
  (assert
  (= (= (nth_bv r (bvsub ((_ int2bv 8) 7) left_bv)) true) (= flag true)))
...
;; H
  (assert
  (= (mk_t__ref bitwalker__pokebit8__result4) (mk_t__ref
...
;; H
  (assert (= result2 bitwalker__pokebit8__result4))
...
;; H
  (assert (= (nth bitwalker__pokebit8__result4 i) true))
