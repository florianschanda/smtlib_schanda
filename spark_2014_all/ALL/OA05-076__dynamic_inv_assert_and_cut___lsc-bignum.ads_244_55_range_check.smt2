...
;; H
  (assert (= o69 (+ x_first o68)))

;; H
  (assert (and (= o70 o69) (in_range1 o69)))

;; H
  (assert (= o71 (ite (<= o70 (to_rep (last (rt x)))) true false)))
...
;; H
  (assert (= o72 (ite (<= (to_rep (first (rt x))) o67) true false)))

;; H
  (assert (= result (ite (= o72 true) o71 false)))
...
;; H
  (assert (= o61 (+ m_first o60)))

;; H
  (assert (and (= o62 o61) (in_range1 o61)))

;; H
  (assert (= o63 (ite (<= o62 (to_rep (last (rt m)))) true false)))
...
;; H
  (assert (= o64 (ite (<= (to_rep (first (rt m))) o59) true false)))

;; H
  (assert (= result1 (ite (= o64 true) o63 false)))
...
;; H
  (assert (= o53 (+ aux1_first o52)))

;; H
  (assert (and (= o54 o53) (in_range1 o53)))

;; H
  (assert (= o55 (ite (<= o54 (to_rep aux1__last)) true false)))
...
;; H
  (assert (= o56 (ite (<= (to_rep aux1__first) o51) true false)))

;; H
  (assert (= result2 (ite (= o56 true) o55 false)))
...
;; H
  (assert (= o45 (+ aux2_first o44)))

;; H
  (assert (and (= o46 o45) (in_range1 o45)))

;; H
  (assert (= o47 (ite (<= o46 (to_rep aux2__last)) true false)))
...
;; H
  (assert (= o48 (ite (<= (to_rep aux2__first) o43) true false)))

;; H
  (assert (= result3 (ite (= o48 true) o47 false)))
...
;; H
  (assert (= o37 (+ aux3_first o36)))

;; H
  (assert (and (= o38 o37) (in_range1 o37)))

;; H
  (assert (= o39 (ite (<= o38 (to_rep aux3__last)) true false)))
...
;; H
  (assert (= o40 (ite (<= (to_rep aux3__first) o35) true false)))

;; H
  (assert (= result4 (ite (= o40 true) o39 false)))
...
;; H
  (assert (= o29 (+ aux4_first o28)))

;; H
  (assert (and (= o30 o29) (in_range1 o29)))

;; H
  (assert (= o31 (ite (<= o30 (to_rep aux4__last)) true false)))
...
;; H
  (assert (and (= o14 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o19 (+ aux4_first o18)))

;; H
  (assert (and (= o20 o19) (in_range1 o19)))

;; H
  (assert (= o32 (ite (<= (to_rep aux4__first) o20) true false)))

;; H
  (assert (= result5 (ite (= o32 true) o31 false)))
...
;; H
  (assert (= o7 (+ r_first o6)))

;; H
  (assert (and (= o8 o7) (in_range1 o7)))

;; H
  (assert (= o9 (ite (<= o8 (to_rep (last (rt r)))) true false)))
...
;; H
  (assert (= o10 (ite (<= (to_rep (first (rt r))) o5) true false)))
