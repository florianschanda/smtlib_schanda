...
;; H
  (assert (and (= o28 (- x 1)) (in_range5 (- x 1))))
...
;; H
  (assert
  (and (= o27 (remove (mk___t values2 (mk 1 100)) o26))
  (and (dynamic_invariant4 o27 true false true)
  (and (= (invariant__ o27) true)
  (and (= (to_rep1 (last (rt o27))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o26 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o27) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o26 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o27) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o26 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o27) k))))))))))))

;; H
  (assert
  (and (= o29 (remove o27 o28))
  (and (dynamic_invariant4 o29 true false true)
  (and (= (invariant__ o29) true)
  (and (= (to_rep1 (last (rt o29))) (- (to_rep1 (last (rt o27))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o28 1)))
  (= (to_rep (select (elts o27) k)) (to_rep (select (elts o29) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o28 1) k) (<= k (to_rep1 (last (rt o27)))))
  (= (to_rep (select (elts o27) k)) (to_rep (select (elts o29) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o28 k) (<= k (- (to_rep1 (last (rt o27))) 1)))
  (= (to_rep (select (elts o27) (+ k 1))) (to_rep (select (elts o29) k))))))))))))
