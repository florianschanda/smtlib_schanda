...
(declare-fun dynamic_array__new_holder__result () natural)

(declare-fun dynamic_array__new_holder__result1 () (Array Int us_rep))

(declare-fun dynamic_array__new_holder__result2 () t)
...
(declare-fun temp___236 () us_t2)

(declare-fun temp___237 () us_t2)

(declare-fun o22 () us_t1)

(declare-fun o23 () us_split_fields6)

(declare-fun o24 () us_split_discrs2)

(declare-fun o25 () us_rep3)

(declare-fun o26 () us_rep1)

(declare-fun result () holder__ref)

(declare-fun dynamic_array__new_holder__result3 () us_rep1)

(declare-fun result1 () holder__ref)

(declare-fun dynamic_array__new_holder__result4 () us_rep1)

(declare-fun dynamic_array__new_holder__result5 () holder__ref)

(declare-fun dynamic_array__new_holder__result6 () us_rep1)

(declare-fun dynamic_array__new_holder__result7 () holder__ref)

(declare-fun dynamic_array__new_holder__result8 () us_rep1)

(declare-fun dynamic_array__new_holder__result9 () holder__ref)

(declare-fun dynamic_array__new_holder__result10 () us_rep1)

(define-fun dynamic_array__new_holder__result11 () holder__ref (mk_holder__ref
                                                               (mk___rep1
                                                               (mk___split_discrs1
                                                               dynamic_array__new_holder__result)
                                                               (mk___split_fields1
                                                               (mk___t
                                                               dynamic_array__new_holder__result1
                                                               dynamic_array__new_holder__result2)))))
...
;; H
  (assert
  (= dynamic_array__new_holder__result7 dynamic_array__new_holder__result5))

;; H
  (assert
  (= dynamic_array__new_holder__result8 dynamic_array__new_holder__result6))

;; H
  (assert
  (=> (= c 0)
  (= dynamic_array__new_holder__result5 (mk_holder__ref
                                        dynamic_array__new_holder__result3))))

;; H
  (assert
  (=> (= c 0)
  (= dynamic_array__new_holder__result6 dynamic_array__new_holder__result3)))
...
;; H
  (assert (=> (= c 0) (= o2 (of_rep1 o1))))

;; H
  (assert (=> (= c 0) (= o2 o3)))

;; H
  (assert (=> (= c 0) (= dummy3 o4)))

;; H
  (assert (=> (= c 0) (= (of_int 1) usq_)))
...
;; H
  (assert
  (=> (= c 0)
  (= dynamic_array__new_holder__result3 (mk___rep1 (mk___split_discrs1 o14)
                                        (mk___split_fields1 (mk___t o15 o16))))))

;; H
  (assert
  (=> (not (= c 0))
  (= dynamic_array__new_holder__result5 (mk_holder__ref
                                        dynamic_array__new_holder__result4))))

;; H
  (assert
  (=> (not (= c 0))
  (= dynamic_array__new_holder__result6 dynamic_array__new_holder__result4)))

;; H
  (assert (=> (not (= c 0)) (and (= us1 c) (dynamic_property 0 last c))))

;; H
  (assert (=> (not (= c 0)) (= o18 c)))

;; H
  (assert (=> (not (= c 0)) (= o19 (of_rep1 o18))))

;; H
  (assert (=> (not (= c 0)) (= o20 (mk___split_fields o19 dummy3))))

;; H
  (assert
  (=> (not (= c 0))
  (= usq_4 (mk___rep (mk___split_discrs (of_int 1)) o20 true))))

;; H
  (assert
  (=> (not (= c 0))
  (= o21 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) false))))

;; H
  (assert (=> (not (= c 0)) (= temp___236 (temp___230 o21 1 d))))

;; H
  (assert (=> (not (= c 0)) (= (to_rep1 (first4 (rt2 temp___236))) 1)))

;; H
  (assert (=> (not (= c 0)) (= (to_rep1 (last5 (rt2 temp___236))) d)))

;; H
  (assert (=> (not (= c 0)) (= temp___237 temp___236)))

;; H
  (assert
  (=> (not (= c 0))
  (= (ite (<= (to_rep1 (first4 (rt2 temp___237))) (to_rep1
                                                  (last5 (rt2 temp___237))))
     (+ (- (to_rep1 (last5 (rt2 temp___237))) (to_rep1
                                              (first4 (rt2 temp___237)))) 1)
     0) (ite (<= 1 d) (+ (- d 1) 1) 0))))

;; H
  (assert
  (=> (not (= c 0))
  (= o22 (mk___t1 (elts2 temp___237)
         (mk1 (to_rep1 (first4 (rt2 temp___237)))
         (to_rep1 (last5 (rt2 temp___237))))))))

;; H
  (assert (=> (not (= c 0)) (= o23 (mk___split_fields3 o22))))

;; H
  (assert (=> (not (= c 0)) (= (to_rep o17) d)))

;; H
  (assert (=> (not (= c 0)) (= o24 (mk___split_discrs1 o17))))

;; H
  (assert (=> (not (= c 0)) (= o25 (mk___rep3 o24 o23))))

;; H
  (assert (=> (not (= c 0)) (= o26 (to_base1 o25))))

;; H
  (assert (=> (not (= c 0)) (= result1 dynamic_array__new_holder__result11)))

;; H
  (assert (=> (not (= c 0)) (= dynamic_array__new_holder__result4 o26)))

;; H
  (assert
  (= dynamic_array__new_holder__result9 dynamic_array__new_holder__result7))

;; H
  (assert
  (= dynamic_array__new_holder__result10 dynamic_array__new_holder__result8))

;; H
  (assert
  (= (mk___rep1 (mk___split_discrs1 result2)
     (mk___split_fields1 (mk___t result3 result4))) (holder__content
                                                    dynamic_array__new_holder__result9)))
...
;; WP_parameter_def
 ;; File "dynamic_array.adb", line 14, characters 0-0
  ...
  (= (to_rep
     (rec__dynamic_array__holder__d
     (us_split_discrs3 (holder__content dynamic_array__new_holder__result9)))) 0)))
(check-sat)
(exit)
