...
(declare-fun o9 () (Array Int (Array Int et1)))

(declare-fun o10 () (Array Int (Array Int et1)))

(declare-fun o11 () Int)

(declare-fun temp___5522 () (Array Int (Array Int (Array Int et1))))
...
(declare-fun o17 () (Array Int (Array Int et1)))
...
;; H
  (assert
  (=> (< k 16) (=> (< 0 e) (and (= o14 (- e 1)) (in_range4 (- e 1))))))
...
;; H
  (assert
  (=> (< k 16) (=> (< 0 e) (and (= o19 (+ k 1)) (in_range3 (+ k 1))))))
...
;; H
  ...
  (= temp___5512 (temp___1815 a k
                 ...
                 (temp___1830 (select (select a k) j) i e)) o19 o18)))))

;; H
  (assert
  (=> (< k 16) (=> (< 0 e) (= result4 (bool_eq2 a3 1 16 temp___5512 1 16)))))
...
;; H
  (assert
  (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o6 (+ k 1))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result4 true)) (=> (= e 0) (= temp___5521 (select a o6))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result4 true)) (=> (= e 0) (= o7 (select temp___5521 j))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result4 true)) (=> (= e 0) (= o8 (temp___1884 o7 i 99))))))
...
;; H
  (assert
  (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o5 (+ k 1))))))

;; H
  (assert
  (=> (< k 16) (=> (not (= result4 true)) (=> (= e 0) (= o9 (select a o5))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result4 true)) (=> (= e 0) (= o10 (temp___1877 o9 j o8))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result4 true))
  (=> (= e 0) (and (= o11 (+ k 1)) (in_range3 (+ k 1)))))))
...
;; H
  ...
  (=> (not (= result4 true))
  (=> (= e 0)
  (= temp___5522 (temp___1854 a k
                 (temp___1862 (select a k) j
                 (temp___1869 (select (select a k) j) i e)) o11 o10))))))

;; H
  (assert
  (=> (< k 16)
  (=> (not (= result4 true))
  (=> (= e 0) (= result3 (bool_eq2 a3 1 16 temp___5522 1 16))))))
