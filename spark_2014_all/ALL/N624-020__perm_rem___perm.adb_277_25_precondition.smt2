...
;; H
  (assert
  (and (= o27 (remove b ib2))
  (and (dynamic_invariant2 o27 true false true)
  (and (= (invariant__ o27) true)
  (and (= (to_rep2 (last (rt o27))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o27) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o27) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o27) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o28))) (- (to_rep2 (last (rt o27))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o27) k)) (to_rep (select (elts o28) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o27)))))
  (= (to_rep (select (elts o27) k)) (to_rep (select (elts o28) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o27))) 1)))
  (= (to_rep (select (elts o27) (+ k 1))) (to_rep (select (elts o28) k))))))))))))
