...
(declare-const temp___532 integer)

(declare-const temp___5321 us_private)

(declare-const temp___5322 Int)
...
;; H
  (assert
  (and
  (= (mk___rep (mk___split_fields temp___532 temp___5321) temp___5322)
  (f 2))
  (and (and (= (of_rep 2) temp___532) (= us_null_ext__ temp___5321))
  (= us_tag temp___5322))))
