...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 idx3))
  (= (get
     (model__ (mk___rep result____split_discrs result____split_fields18)) i1)
  (get (model__ left) i1))))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 idx9))
  (= (get (model__ (mk___rep result____split_discrs result____split_fields9))
     (+ (last (model__ left)) i1)) (get (model__ right) i1))))))
...
;; H
  (assert
  (and (= o10 (length right))
  (and (in_range5 o10) (<= o10 (capacity right)))))

;; H
  (assert
  (and (= o11 (length left)) (and (in_range5 o11) (<= o11 (capacity left)))))
...
;; H
  (assert
  (and (= o13 (length (vector__content amortized_queue__Oconcat__result5)))
  (and (in_range5 o13)
  (<= o13 (capacity (vector__content amortized_queue__Oconcat__result5))))))

;; H
  (assert (= result5 (ite (= o13 o12) true false)))
...
;; H
  (assert
  (and (= o6 (last (model__ left)))
  (and (in_range4 o6) (= o6 (last (model__ left))))))

;; H
  (assert (= o7 (ite (<= i o6) true false)))

;; H
  (assert (= result6 (ite (<= 1 i) o7 false)))
...
;; H
  (assert
  (and (= o9 (get (model__ left) o8))
  (and (in_range6 o9) (= o9 (get (model__ left) o8)))))
