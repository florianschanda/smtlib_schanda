...
(declare-fun to_rep (positive_float) t)

(declare-fun of_rep (t) positive_float)
...
(define-fun dynamic_invariant1 ((temp___expr_146 t) (temp___is_init_143 Bool)
...
(declare-fun to_rep1 (nonnegative_float) t)

(declare-fun of_rep1 (t) nonnegative_float)
...
(declare-fun to_rep4 (float) t)

(declare-fun of_rep4 (t) float)
...
;; range_axiom
  (assert
  (forall ((x float)) (! (tqtisFinite (to_rep4 x)) :pattern ((to_rep4 x)) )))

;; coerce_axiom
  (assert
  (forall ((x t))
  (! (=> (tqtisFinite x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4
                                                                (of_rep4 x))) )))
...
(declare-fun to_rep5 (unbounded_float) t)

(declare-fun of_rep5 (t) unbounded_float)
...
(define-fun bool_eq16 ((a us_rep5)
...
(define-fun in_range10 ((x t)) Bool (and (tqtisFinite x)
                                    (and (le fliteral2 x) (le x fliteral))))

(define-fun bool_eq17 ((x t) (y t)) Bool (ite (eq x y) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_679 t) (temp___is_init_676 Bool)
  (temp___skip_constant_677 Bool)
  (temp___do_toplevel_678 Bool)) Bool (=>
                                      (or (= temp___is_init_676 true) (le
                                      fliteral2 fliteral)) (in_range10
                                      temp___expr_679)))
...
(define-fun dynamic_invariant9 ((temp___expr_140 t) (temp___is_init_137 Bool)
...
(define-fun dynamic_invariant10 ((temp___expr_158 t)
...
;; null_angle__def_axiom
  (assert (= null_angle (mk___rep (mk___split_fields (of_rep2 fliteral2)))))

(define-fun dynamic_invariant11 ((temp___expr_170 t)
...
(declare-fun deltamag () t)

(declare-fun deltaangle () t)

(declare-fun deltaareasum () t)

(declare-fun obstacleavoiddelta () t)

(declare-fun i () Int)

(declare-fun temp___884 () t)

(declare-fun temp___883 () t)

(declare-fun temp___882 () t)

(declare-fun temp___881 () t)

(declare-fun temp___880 () Int)

(declare-fun temp___879 () t)
...
(declare-fun deltamag1 () t)

(declare-fun deltaangle1 () t)

(declare-fun result () t)

(declare-fun deltaareasum1 () t)

(declare-fun result1 () t)

(declare-fun obstacleavoiddelta1 () t)

(declare-fun result2 () Int)

(declare-fun i1 () Int)

(declare-fun deltamag2 () t)

(declare-fun deltaangle2 () t)

(declare-fun deltaareasum2 () t)

(declare-fun obstacleavoiddelta2 () t)
...
(declare-fun deltamag3 () t)

(declare-fun result5 () t)

(declare-fun deltaangle3 () t)

(declare-fun result6 () t)

(declare-fun deltaareasum3 () t)

(declare-fun result7 () t)

(declare-fun obstacleavoiddelta3 () t)

(declare-fun deltamag4 () t__ref)

(declare-fun deltaangle4 () t__ref)

(declare-fun deltaareasum4 () t__ref)

(declare-fun obstacleavoiddelta4 () t__ref)

(declare-fun i3 () int__ref)

(declare-fun deltamag5 () t)

(declare-fun deltaangle5 () t)

(declare-fun deltaareasum5 () t)

(declare-fun obstacleavoiddelta5 () t)
...
(declare-fun deltamag7 () t)

(declare-fun deltaangle7 () t)

(declare-fun deltaareasum7 () t)

(declare-fun obstacleavoiddelta7 () t)
...
;; H
  (assert (tqtisFinite safetydist))

;; H
  (assert (neq safetydist fliteral2))

;; H
  (assert (=> (le fliteral2 fliteral) (in_range10 deltamag)))

;; H
  (assert (=> (le (neg fliteral1) fliteral1) (tqtisFinite deltaangle)))

;; H
  (assert (= result deltaareasum))

;; H
  (assert (= deltaareasum1 fliteral2))
...
;; H
  (assert (= obstacleavoiddelta1 fliteral2))

;; H
  (assert (tqtisFinite obstacleavoiddelta1))
...
;; H
  ...
  (and
  (and
  (and (=> (le (neg fliteral1) fliteral1) (tqtisFinite obstacleavoiddelta2))
  (=> (<= 1 1000) (dynamic_property 1 1000 i2)))
  (=> (le fliteral2 fliteral) (in_range10 deltamag2)))
  (=> (le (neg fliteral1) fliteral1) (tqtisFinite deltaangle2)))
  (=> (le fliteral2 fliteral1) (in_range3 deltaareasum2)))
  (and (<= 1 i2) (<= i2 1000)))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (and (= o3 o2) (tqtisFinite o2)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (= o4 (div1 RNE1 o3 safetydist)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (and (= o5 o4) (tqtisFinite o4)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true)
  (and (= o6 (limit o5 fliteral2 fliteral))
  (and (tqtisFinite o6) (and (le fliteral2 o6) (le o6 fliteral)))))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (and (= o7 o6) (tqtisFinite o6)))))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (= o16 (create__2 fliteral4)))))
...
;; H
  ...
  (= o10 (aldiff
         ...
         o15))
  (and (tqtisFinite o10) (and (lt (neg fliteral4) o10) (le o10 fliteral4)))))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true)
  (and (= o11 (add RNE1 deltaareasum2 (mul RNE1 deltamag3 deltamag3)))
  (tqtisFinite (add RNE1 deltaareasum2 (mul RNE1 deltamag3 deltamag3)))))))
...
;; H
  ...
  (=> (= result3 true)
  (and
  (= o12 (mul RNE1 (mul RNE1 (mul RNE1 deltamag3 deltamag3) deltamag3)
         deltaangle3))
  (tqtisFinite
  (mul RNE1 (mul RNE1 (mul RNE1 deltamag3 deltamag3) deltamag3) deltaangle3))))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (= o13 (add RNE1 obstacleavoiddelta2 o12)))))

;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 1000))
  (=> (= result3 true) (and (= o14 o13) (tqtisFinite o13)))))
...
;; H
  (assert (lt fliteral2 (t__content deltaareasum6)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (eq (t__content deltaareasum6) zeroF))))
(check-sat)
