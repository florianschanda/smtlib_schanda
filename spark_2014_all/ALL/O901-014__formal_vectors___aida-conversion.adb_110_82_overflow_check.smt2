...
;; H
  (assert (= o201 (ite (< o200 50) true false)))
...
;; H
  (assert (= o195 (ite (< o194 49) true false)))
...
;; H
  (assert (= o196 (ite (= o191 50) true false)))

;; H
  (assert (= o197 (ite (= o196 true) o195 false)))
...
;; H
  (assert (= o129 (ite (< o128 56) true false)))
...
;; H
  (assert (= o119 (ite (= o118 55) true false)))
