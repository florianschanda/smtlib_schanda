...
;; def_axiom
  (assert
  (forall ((temp___603 (Array Int et1)))
  (forall ((temp___604 Int) (temp___605 Int) (temp___606 Int)
  (temp___607 Int))
  (let ((temp___602 (temp___601 temp___603 temp___604 temp___605 temp___606
                    temp___607)))
  (forall ((temp___608 Int))
  (ite (= temp___608 temp___606)
  (= (select temp___602 temp___608) (of_rep temp___607))
  (ite (= temp___608 temp___604)
  (= (select temp___602 temp___608) (of_rep temp___605))
  (= (select temp___602 temp___608) (select temp___603 temp___608)))))))))

(declare-fun temp___610 ((Array Int et1) Int Int Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___612 (Array Int et1)))
  (forall ((temp___613 Int) (temp___614 Int) (temp___615 Int)
  (temp___616 Int))
  (let ((temp___611 (temp___610 temp___612 temp___613 temp___614 temp___615
                    temp___616)))
  (forall ((temp___617 Int))
  (ite (= temp___617 temp___615)
  (= (select temp___611 temp___617) (of_rep temp___616))
  (ite (= temp___617 temp___613)
  (= (select temp___611 temp___617) (of_rep temp___614))
  (= (select temp___611 temp___617) (select temp___612 temp___617)))))))))

(declare-fun temp___619 ((Array Int et1) Int Int Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___621 (Array Int et1)))
  (forall ((temp___622 Int) (temp___623 Int) (temp___624 Int)
  (temp___625 Int))
  (let ((temp___620 (temp___619 temp___621 temp___622 temp___623 temp___624
                    temp___625)))
  (forall ((temp___626 Int))
  (ite (= temp___626 temp___624)
  (= (select temp___620 temp___626) (of_rep temp___625))
  (ite (= temp___626 temp___622)
  (= (select temp___620 temp___626) (of_rep temp___623))
  (= (select temp___620 temp___626) (select temp___621 temp___626)))))))))

(declare-fun temp___628 ((Array Int et1) Int Int Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___630 (Array Int et1)))
  (forall ((temp___631 Int) (temp___632 Int) (temp___633 Int)
  (temp___634 Int))
  (let ((temp___629 (temp___628 temp___630 temp___631 temp___632 temp___633
                    temp___634)))
  (forall ((temp___635 Int))
  (ite (= temp___635 temp___633)
  (= (select temp___629 temp___635) (of_rep temp___634))
  (ite (= temp___635 temp___631)
  (= (select temp___629 temp___635) (of_rep temp___632))
  (= (select temp___629 temp___635) (select temp___630 temp___635)))))))))
...
(declare-const temp___4343 (Array Int et1))

(declare-const o7 Int)

(declare-const o8 Int)

(declare-const temp___4341 (Array Int et1))
...
;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (and (= o7 (- e 1)) (in_range1 (- e 1))))))
...
;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (= temp___4341 (temp___601 a i e o8 o7)))))

;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (= result7 (bool_eq a3 1 10 temp___4341 1 10)))))
...
;; H
  ...
  (=> (< i 10)
  (=> (not (= result7 true))
  (=> (= e 0) (and (= o6 (+ i 1)) (in_range (+ i 1)))))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result7 true))
  (=> (= e 0) (= temp___4343 (temp___610 a i e o6 99))))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result7 true))
  (=> (= e 0) (= result6 (bool_eq a3 1 10 temp___4343 1 10))))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result7 true)) (=> (not (= e 0)) (= result6 false)))))
