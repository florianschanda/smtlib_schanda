...
(define-fun dynamic_invariant ((temp___expr_605 Int)
...
;; length__post__dispatch_axiom
  ...
  (forall ((container1 us_rep)) (! (dynamic_invariant3
...
;; find__post_axiom
  ...
  (! (let ((result (find container1 item)))
     ...
     (dynamic_invariant3 result true false true))) :pattern ((find container1
                                                             item)) ))))
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep5)) (! (dynamic_invariant3 (length4 container1)
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep2)) (! (dynamic_invariant3 (length container1)
...
;; witness__post_axiom
  ...
  (! (=> (= (has_key container1 key) true)
     ...
     (and (= (has_witness container1 result) true) (dynamic_invariant3 result
...
(declare-const temp___1016 count_type)
...
;; H
  (assert (= temp___1016 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___1016)) no_element))
