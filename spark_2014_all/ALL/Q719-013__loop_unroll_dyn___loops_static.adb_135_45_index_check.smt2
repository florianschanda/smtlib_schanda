...
;; H
  (assert (=> (= i1 (to_rep1 a__first)) (= j11 j13)))

;; H
  (assert (=> (= i1 (to_rep1 a__first)) (= bad2 bad9)))

;; H
  (assert (=> (= i1 (to_rep1 a__first)) (= j10 j2)))

;; H
  (assert (=> (= i1 (to_rep1 a__first)) (= bad10 bad2)))

;; H
  (assert (=> (not (= i1 (to_rep1 a__first))) (= (mk_int__ref result4) j13)))

;; H
  (assert (=> (not (= i1 (to_rep1 a__first))) (= j3 (to_rep1 a__first))))

;; H
  (assert
  (=> (not (= i1 (to_rep1 a__first)))
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (= temp___349 bad1))))
...
;; H
  (assert (=> (not (= i1 (to_rep1 a__first))) (= j11 j12)))

;; H
  (assert (=> (not (= i1 (to_rep1 a__first))) (= (mk_bool__ref bad9) bad11)))

;; H
  (assert (=> (not (= i1 (to_rep1 a__first))) (= j10 j8)))
...
(assert
;; WP_parameter_def
 ;; File "loops_static.adb", line 100, characters 0-0
