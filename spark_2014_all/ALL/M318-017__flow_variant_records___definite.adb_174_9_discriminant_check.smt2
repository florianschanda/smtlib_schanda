...
(declare-fun temp___225 () status)

(declare-fun temp___2251 () natural)

(declare-fun temp___2252 () natural)

(declare-fun temp___2253 () Bool)

(declare-fun temp___2254 () Bool)
...
;; WP_parameter_def
 ;; File "definite.adb", line 157, characters 0-0
  (not (= temp___225 x__split_discrs)))
(check-sat)
