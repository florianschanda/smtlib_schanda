...
;; H
  (assert
  (and (= temp___734 (elements s2))
  (and
  (and
  (and (= (length2 temp___734) (length s2))
  (forall ((temp___390 Int))
  (=>
  (and (in_range3 temp___390)
  (= (iter_has_element temp___734 temp___390) true))
  (= (contains (model__ s2) (get temp___734 temp___390)) true))))
  (forall ((item Int))
  (=> (and (in_range5 item) (= (contains (model__ s2) item) true))
  (and (< 0 (find temp___734 item))
  (= (equivalent_elements (get temp___734 (find temp___734 item)) item) true)))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (length s2)))
  (and (= (find temp___734 (get temp___734 i)) i)
  (= (e_is_find temp___734 (get temp___734 i) i) true)))))))

;; H
  (assert
  (and (= o (iter_has_element temp___734 temp___733))
  (= (= o true) (and (<= 1 temp___733) (<= temp___733 (last temp___734))))))

;; H
  (assert (= (= o1 true) (in_range3 temp___733)))
