...
;; def_axiom
  (assert
  (forall ((temp___3015 (Array Int et1)))
  (forall ((temp___3016 Int) (temp___3017 Int))
  (let ((temp___3014 (temp___3013 temp___3015 temp___3016 temp___3017)))
  (forall ((temp___3018 Int))
  (ite (= temp___3018 temp___3016)
  (= (select temp___3014 temp___3018) (of_rep temp___3017))
  (= (select temp___3014 temp___3018) (select temp___3015 temp___3018))))))))
...
(declare-fun temp___7897 () (Array Int et1))

(declare-fun temp___78971 () enum2t)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1423, characters 0-0
  (not
  (= (bool_eq r__split_fields4 1 10 (temp___3013 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
