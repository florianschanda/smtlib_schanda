...
;; H
  ...
  (and (<= (to_rep (first (rt a))) j)
  (<= j (- (+ (to_rep (last (rt a))) 1) (length b)))))))

;; H
  (assert (and (= o (length b)) (in_range1 (length b))))

;; H
  (assert (and (= o1 (- j 1)) (in_range1 (- j 1))))

;; H
  (assert (= o2 (+ o1 o)))

;; H
  (assert (and (= temp___184 o2) (in_range1 o2)))
