...
(declare-fun temp___553 () (Array Int character))

(declare-fun temp___5531 () t1)
...
(declare-fun name4 () (Array Int character))
...
;; H
  (assert
  (= (mk___t1 temp___553 temp___5531) (mk___t1 temp___550 temp___5501)))

;; H
  (assert
  (forall ((temp___554 Int))
  (ite (and (<= 1 temp___554) (<= temp___554 r9b))
  (= (select o12 temp___554) (select temp___553 temp___554))
  (= (select o12 temp___554) (select name3 temp___554)))))
