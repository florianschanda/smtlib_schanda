...
;; H
  (assert
  (= o14 (statusiswaitingfinishadminop (us_private__content state68))))

;; H
  (assert
  (= o15 (statusiswaitingstartadminop (us_private__content state68))))
...
;; H
  (assert
  (= o10 (statusiswaitingremoveadmintokenfail (us_private__content state68))))

;; H
  (assert (= o11 (statusisgotadmintoken (us_private__content state68))))
...
;; H
  (assert
  (=> (= result10 true)
  (= o9 (statusiswaitingstartadminop (us_private__content state68)))))
