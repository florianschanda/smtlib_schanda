...
(declare-fun dummy9 () hash_bit_length)
...
(declare-fun dummy10 () initialized_hash_bit_length)
...
(declare-fun dummy11 () skein_512_block_bytes_count)
...
(declare-fun dummy12 () skein_512_block_bytes_index)
...
(declare-fun dummy13 () positive_block_512_count_t)
...
(declare-fun dummy18 () (Array (_ BitVec 64) u64))
...
(declare-fun dummy19 () (Array (_ BitVec 64) byte))
...
(declare-fun dummy21 () modifier_words_index)
...
(declare-fun ctx__split_fields () u32)

(declare-fun ctx__split_fields1 () u16)

(declare-fun ctx__split_fields2 () u7)

(declare-fun ctx__split_fields3 () Bool)

(declare-fun ctx__split_fields4 () u6)

(declare-fun ctx__split_fields5 () Bool)

(declare-fun ctx__split_fields6 () hash_bit_length)

(declare-fun ctx__split_fields7 () u64)

(declare-fun ctx__split_fields8 () (Array (_ BitVec 64) byte))
...
(declare-fun o40 () (Array (_ BitVec 64) u64))
...
(declare-fun o63 () byte)

(declare-fun o64 () (_ BitVec 8))

(declare-fun o65 () (_ BitVec 64))

(declare-fun o66 () (_ BitVec 64))

(declare-fun o67 () (_ BitVec 64))

(declare-fun o68 () byte)

(declare-fun o69 () (_ BitVec 8))

(declare-fun o70 () (_ BitVec 64))
...
(declare-fun ctx__split_fields9 () us_split_fields4)
...
(declare-fun ctx__split_fields10 () us_split_fields4)
...
(declare-fun ks7 () (Array (_ BitVec 64) u64))
...
(declare-fun result14 () map__ref1)

(declare-fun ks9 () (Array (_ BitVec 64) u64))

(declare-fun result15 () t__ref1)

(declare-fun i5 () (_ BitVec 64))

(declare-fun result16 () map__ref1)

(declare-fun ks10 () (Array (_ BitVec 64) u64))

(declare-fun result17 () map__ref1)

(declare-fun ks11 () (Array (_ BitVec 64) u64))

(declare-fun result18 () t__ref1)

(declare-fun i6 () (_ BitVec 64))

(declare-fun result19 () map__ref1)

(declare-fun ks12 () (Array (_ BitVec 64) u64))

(declare-fun result20 () map__ref1)

(declare-fun ks13 () (Array (_ BitVec 64) u64))

(declare-fun result21 () t__ref1)

(declare-fun i7 () (_ BitVec 64))

(declare-fun result22 () map__ref1)

(declare-fun ks14 () (Array (_ BitVec 64) u64))

(declare-fun result23 () map__ref1)

(declare-fun ks15 () (Array (_ BitVec 64) u64))
...
(declare-fun result26 () map__ref1)

(declare-fun ks17 () (Array (_ BitVec 64) u64))
...
(declare-fun result29 () map__ref1)
...
(declare-fun src_index1 () (_ BitVec 64))
...
;; H
  ...
  (and
  (and
  (and (in_range4 (to_rep3 ctx__split_fields6)) (in_range5
  (to_rep1 ctx__split_fields7)))
...
;; H
  ...
  (= (rec__skein__tweak_value__byte_count_msb
     (us_split_fields1
     (rec__skein__context_header__tweak_words
     (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields9)))))
  ctx__split_fields)
  (= (rec__skein__tweak_value__reserved
     (us_split_fields1
     (rec__skein__context_header__tweak_words
  ...
  (= (rec__skein__context_header__byte_count
     (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields9)))
  ctx__split_fields7))
  (= (rec__skein__skein_512_context__b ctx__split_fields9) ctx__split_fields8)))
...
;; H
  ...
  (= (to_rep1 o) (bvadd (to_rep1
                        ...
                        (rec__skein__context_header__tweak_words
                        (us_split_fields3
                        (rec__skein__skein_512_context__h ctx__split_fields9))))))
  byte_count_add)))
...
;; H
  ...
  (= o5 (mk___split_fields2 o4
        (rec__skein__skein_512_context__x ctx__split_fields9)
        (rec__skein__skein_512_context__b ctx__split_fields9))))

;; H
  (assert (= temp___1507 (mk___rep2 o5)))

;; H
  (assert (= result1 (mk___split_fields__ref2 ctx__split_fields9)))

;; H
  (assert (= ctx__split_fields10 (us_split_fields5 temp___1507)))

;; H
  (assert (= (to_rep1 o6) ((_ int2bv 64) 2004413935125273122)))

;; H
  (assert (= o7 (store ks ((_ int2bv 64) 8) o6)))
...
;; H
  (assert
  (= (to_rep1 o10) (bvxor (to_rep1 (select ks2 ((_ int2bv 64) 8))) (to_rep1
                                                                   (select
                                                                   (rec__skein__skein_512_context__x
                                                                   ctx__split_fields10)
                                                                   i1)))))
...
;; H
  (assert (= o11 (store ks2 ((_ int2bv 64) 8) o10)))
...
;; H
  (assert
  (= (to_rep1 o14) (bvxor (to_rep1 (select ks4 ((_ int2bv 64) 8))) (to_rep1
                                                                   (select
                                                                   (rec__skein__skein_512_context__x
                                                                   ctx__split_fields10)
                                                                   i2)))))
...
;; H
  (assert (= o15 (store ks4 ((_ int2bv 64) 8) o14)))
...
;; H
  (assert
  (= (to_rep1 o18) (bvxor (to_rep1 (select ks6 ((_ int2bv 64) 8))) (to_rep1
                                                                   (select
                                                                   (rec__skein__skein_512_context__x
                                                                   ctx__split_fields10)
                                                                   i3)))))
...
;; H
  (assert (= o19 (store ks6 ((_ int2bv 64) 8) o18)))
...
;; H
  (assert
  (= (to_rep1 o22) (bvxor (to_rep1 (select ks8 ((_ int2bv 64) 8))) (to_rep1
                                                                   (select
                                                                   (rec__skein__skein_512_context__x
                                                                   ctx__split_fields10)
                                                                   i4)))))
...
;; H
  (assert (= o23 (store ks8 ((_ int2bv 64) 8) o22)))
...
;; H
  (assert
  (= (to_rep1 o26) (bvxor (to_rep1 (select ks10 ((_ int2bv 64) 8))) (to_rep1
                                                                    (select
                                                                    (rec__skein__skein_512_context__x
                                                                    ctx__split_fields10)
                                                                    i5)))))
...
;; H
  (assert (= o27 (store ks10 ((_ int2bv 64) 8) o26)))
...
;; H
  (assert
  (= (to_rep1 o30) (bvxor (to_rep1 (select ks12 ((_ int2bv 64) 8))) (to_rep1
                                                                    (select
                                                                    (rec__skein__skein_512_context__x
                                                                    ctx__split_fields10)
                                                                    i6)))))
...
;; H
  (assert (= o31 (store ks12 ((_ int2bv 64) 8) o30)))
...
;; H
  (assert
  (= (to_rep1 o34) (bvxor (to_rep1 (select ks14 ((_ int2bv 64) 8))) (to_rep1
                                                                    (select
                                                                    (rec__skein__skein_512_context__x
                                                                    ctx__split_fields10)
                                                                    i7)))))
...
;; H
  (assert (= o35 (store ks14 ((_ int2bv 64) 8) o34)))
...
;; H
  (assert
  (= (to_rep1 o38) (bvxor (to_rep1 (select ks16 ((_ int2bv 64) 8))) (to_rep1
                                                                    (select
                                                                    (rec__skein__skein_512_context__x
                                                                    ctx__split_fields10)
                                                                    i8)))))
...
;; H
  (assert (= o39 (store ks16 ((_ int2bv 64) 8) o38)))
...
;; H
  ...
  (= o40 (tweak_to_words
         (rec__skein__context_header__tweak_words
         (us_split_fields3
         (rec__skein__skein_512_context__h ctx__split_fields10))))))

;; H
  (assert
  (= temp___1514 (mk___t1 o40 (mk1 ((_ int2bv 64) 0) ((_ int2bv 64) 1)))))

;; H
  (assert (= o41 (select (elts1 temp___1514) ((_ int2bv 64) 0))))
...
;; H
  (assert
  (= temp___1515 (mk___t1 o43 (mk1 ((_ int2bv 64) 0) ((_ int2bv 64) 1)))))

;; H
  (assert (= o44 (select (elts1 temp___1515) ((_ int2bv 64) 1))))
...
;; H
  (assert (= ts1 (temp___1516 w01 w11 (bvxor w01 w11))))
...
;; H
  (assert (= dst_index1 ((_ int2bv 64) 0)))

;; H
  (assert (= o46 (bvadd c206b (bvmul dst_index1 ((_ int2bv 64) 8)))))
...
;; H
  (assert
  (and
  (bvule (to_rep2 (first (rt block))) (bvadd src_index1 ((_ int2bv 64) 7)))
  (bvule (bvadd src_index1 ((_ int2bv 64) 7)) (to_rep2 (last (rt block))))))

;; H
  (assert (= o67 (bvadd src_index1 ((_ int2bv 64) 7))))

;; H
  (assert (= o68 (select (elts block) o67)))

;; H
  (assert (= o69 (to_rep o68)))

;; H
  (assert (= o70 ((_ zero_extend 56) o69)))

;; H
  (assert (= o71 (bvshl o70 ((_ int2bv 64) 56))))

;; H
  (assert
  (and
  (bvule (to_rep2 (first (rt block))) (bvadd src_index1 ((_ int2bv 64) 6)))
  (bvule (bvadd src_index1 ((_ int2bv 64) 6)) (to_rep2 (last (rt block))))))

;; H
  (assert (= o62 (bvadd src_index1 ((_ int2bv 64) 6))))

;; H
  (assert (= o63 (select (elts block) o62)))

;; H
  (assert (= o64 (to_rep o63)))

;; H
  (assert (= o65 ((_ zero_extend 56) o64)))

;; H
  (assert (= o66 (bvshl o65 ((_ int2bv 64) 48))))

;; H
  (assert
  (and
  (bvule (to_rep2 (first (rt block))) (bvadd src_index1 ((_ int2bv 64) 5)))
  (bvule (bvadd src_index1 ((_ int2bv 64) 5)) (to_rep2 (last (rt block))))))

;; H
  (assert (= o57 (bvadd src_index1 ((_ int2bv 64) 5))))

;; H
  (assert (= o58 (select (elts block) o57)))

;; H
  (assert (= o59 (to_rep o58)))

;; H
  (assert (= o60 ((_ zero_extend 56) o59)))

;; H
  (assert (= o61 (bvshl o60 ((_ int2bv 64) 40))))

;; H
  (assert
  (and
  (bvule (to_rep2 (first (rt block))) (bvadd src_index1 ((_ int2bv 64) 4)))
  (bvule (bvadd src_index1 ((_ int2bv 64) 4)) (to_rep2 (last (rt block))))))

;; H
  (assert (= o52 (bvadd src_index1 ((_ int2bv 64) 4))))

;; H
  (assert (= o53 (select (elts block) o52)))

;; H
  (assert (= o54 (to_rep o53)))

;; H
  (assert (= o55 ((_ zero_extend 56) o54)))

;; H
  (assert (= o56 (bvshl o55 ((_ int2bv 64) 32))))

;; H
  (assert
  (and
  (bvule (to_rep2 (first (rt block))) (bvadd src_index1 ((_ int2bv 64) 3)))
  (bvule (bvadd src_index1 ((_ int2bv 64) 3)) (to_rep2 (last (rt block))))))

;; H
  (assert (= o47 (bvadd src_index1 ((_ int2bv 64) 3))))
...
;; H
  (assert (= o51 (bvshl o50 ((_ int2bv 64) 24))))

(assert
;; WP_parameter_def
 ;; File "g-bytswa.ads", line 189, characters 0-0
  (not
  (bvule (to_rep2 (first (rt block))) (bvadd src_index1 ((_ int2bv 64) 2)))))
(check-sat)
(exit)
