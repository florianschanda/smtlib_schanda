...
;; H
  (assert (= temp___1514 (mk___rep2 o5)))

;; H
  (assert (= result1 (mk___split_fields__ref2 ctx__split_fields9)))

;; H
  (assert (= ctx__split_fields10 (us_split_fields5 temp___1514)))
...
;; H
  (assert (= o41 (select (elts1 temp___1521) ((_ int2bv 64) 0))))
...
;; H
  (assert (= o44 (select (elts1 temp___1522) ((_ int2bv 64) 1))))
...
;; H
  (assert (= ts1 (temp___1523 w01 w11 (bvxor w01 w11))))
