...
(((mk___split_fields (rec__default_init__glob2__f natural)))))
(define-fun us_split_fields_F__3__projection ((a us_split_fields)) natural
...
(((mk_glob2__ref (glob2__content us_rep)))))
...
;; H
  ...
  (mk___rep (mk___split_fields g__split_fields)) false n1))

(assert
;; WP_parameter_def
 ;; File "default_init.adb", line 48, characters 0-0
