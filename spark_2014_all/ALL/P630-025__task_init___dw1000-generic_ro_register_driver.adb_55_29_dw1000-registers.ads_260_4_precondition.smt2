...
(define-fun us_rep_18__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(declare-fun dw1000__register_types__rx_time_type__rx_stamp__first__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__rx_stamp__last__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__rx_stamp__position () Int)
...
(declare-fun dw1000__register_types__rx_time_type__fp_index__first__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__fp_index__last__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__fp_index__position () Int)
...
(declare-fun dw1000__register_types__rx_time_type__fp_ampl1__first__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__fp_ampl1__last__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__fp_ampl1__position () Int)
...
(declare-fun dw1000__register_types__rx_time_type__rx_rawst__first__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__rx_rawst__last__bit () Int)

(declare-fun dw1000__register_types__rx_time_type__rx_rawst__position () Int)
...
(define-fun register_type__ref_36__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_27__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_27__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2937 us_t1)
  (temp___is_init_2934 Bool) (temp___skip_constant_2935 Bool)
  (temp___do_toplevel_2936 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2935 true))
                                       (and (dynamic_property2 1 14
                                       (first3 temp___expr_2937)
                                       (last3 temp___expr_2937))
                                       (and (= (first3 temp___expr_2937) 1)
                                       (= (last3 temp___expr_2937) 14)))))
