...
;; H
  (assert
  (and (= o30 (model__ data first_available))
  (= (model_is_well_formed o30 data first_available) true)))
...
;; H
  (assert
  (and (= o29 (model__ data1 first_available1))
  (= (model_is_well_formed o29 data1 first_available1) true)))
