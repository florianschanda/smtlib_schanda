...
(define-fun register_type__ref_150__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_106__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_106__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5551 us_t1)
  (temp___is_init_5548 Bool) (temp___skip_constant_5549 Bool)
  (temp___do_toplevel_5550 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5549 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_5551)
                                       (last3 temp___expr_5551))
                                       (and (= (first3 temp___expr_5551) 1)
                                       (= (last3 temp___expr_5551) 4)))))
