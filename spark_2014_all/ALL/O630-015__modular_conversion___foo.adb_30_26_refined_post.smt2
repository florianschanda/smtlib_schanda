...
(declare-fun dummy1 () field_type)

(declare-datatypes ()
((field_type__ref (mk_field_type__ref (field_type__content field_type)))))
(define-fun field_type__ref___projection ((a field_type__ref)) field_type
...
(define-fun dynamic_invariant1 ((temp___expr_202 Int)
  ...
  (temp___do_toplevel_201 Bool)) Bool (=>
                                      ...
                                      (<= 0 4)) (in_range temp___expr_202)))

(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int unsigned_64))))))
...
(declare-fun concat1 ((Array Int unsigned_64) Int Int (Array Int unsigned_64)
  Int Int) (Array Int unsigned_64))
...
(declare-fun compare ((Array Int unsigned_64) Int Int (Array Int unsigned_64)
  Int Int) Int)
...
(declare-fun field () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun data () (_ BitVec 64))

(declare-fun value () (Array Int unsigned_64))

(declare-fun result () (_ BitVec 64))

(declare-fun data1 () (_ BitVec 64))

(declare-fun data2 () (_ BitVec 64))

(declare-fun data3 () (_ BitVec 64))
...
;; WP_parameter_def
 ;; File "foo.adb", line 13, characters 0-0
  (not (= data2 (to_rep (select value field)))))
(check-sat)
(exit)
