...
(declare-fun tab29 () map__ref)

(declare-fun j35 () int__ref)

(declare-fun temp___1732 () int__ref)

(declare-fun tab30 () (Array Int integer))

(declare-fun j36 () Int)

(declare-fun temp___1733 () Int)

(define-fun tab31 () map__ref (mk_map__ref tab))
...
;; H
  (assert (=> (<= j1 b) (= (mk_map__ref result1) tab31)))
...
;; H
  (assert (= temp___1732 (mk_int__ref temp___1731)))

;; H
  (assert (= j35 (mk_int__ref j34)))

;; H
  (assert (= tab29 (mk_map__ref tab28)))

;; H
  (assert (= temp___1733 temp___1731))
...
;; H
  (assert (<= l (- (int__content j35) 1)))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (to_rep (select (map__content tab29) l)) l)))
(check-sat)
(exit)
