...
(declare-fun dummy13 () description_index_type)
...
(declare-fun datebooks__event_record__description_text__first__bit () Int)

(declare-fun datebooks__event_record__description_text__last__bit () Int)

(declare-fun datebooks__event_record__description_text__position () Int)
...
(declare-fun datebooks__event_record__description_size__first__bit () Int)

(declare-fun datebooks__event_record__description_size__last__bit () Int)

(declare-fun datebooks__event_record__description_size__position () Int)
...
(declare-fun datebooks__event_record__date__first__bit () Int)

(declare-fun datebooks__event_record__date__last__bit () Int)

(declare-fun datebooks__event_record__date__position () Int)
...
(declare-fun datebooks__event_record__is_used__first__bit () Int)

(declare-fun datebooks__event_record__is_used__last__bit () Int)

(declare-fun datebooks__event_record__is_used__position () Int)
...
(declare-fun dummy17 () event_index_type)
...
(declare-fun dummy18 () status_type)
...
(declare-fun datebooks__add_event__find_result_record__fresh_index__first__bit () Int)

(declare-fun datebooks__add_event__find_result_record__fresh_index__last__bit () Int)

(declare-fun datebooks__add_event__find_result_record__fresh_index__position () Int)
...
(declare-fun datebooks__add_event__find_result_record__found_slot__first__bit () Int)

(declare-fun datebooks__add_event__find_result_record__found_slot__last__bit () Int)

(declare-fun datebooks__add_event__find_result_record__found_slot__position () Int)
...
(declare-fun find_result__split_fields () event_index_type)

(declare-fun find_result__split_fields1 () Bool)

(declare-fun i () Int)

(declare-fun i1 () Int)

(declare-fun o () event_index_type)

(declare-fun o1 () event_index_type)
...
(declare-fun o4 () event_index_type)
...
(declare-fun o12 () description_count_type)

(declare-fun o13 () day_type)

(declare-fun o14 () month_type)

(declare-fun o15 () year_type)

(declare-fun o16 () hour_type)

(declare-fun o17 () minute_type)

(declare-fun o18 () second_type)

(declare-fun o19 () Bool)

(declare-fun o20 () us_rep3)

(declare-fun o21 () (Array Int us_rep3))

(declare-fun result () us_split_fields__ref4)

(declare-fun find_result__split_fields2 () us_split_fields8)

(declare-fun result1 () int__ref)

(declare-fun i2 () Int)

(declare-fun find_result__split_fields3 () us_split_fields8)

(declare-fun i3 () Int)

(declare-fun result2 () us_split_fields__ref4)

(declare-fun find_result__split_fields4 () us_split_fields8)

(declare-fun find_result__split_fields5 () us_split_fields__ref4)

(declare-fun find_result__split_fields6 () us_split_fields8)

(declare-fun find_result__split_fields7 () us_split_fields__ref4)

(declare-fun i4 () int__ref)

(declare-fun find_result__split_fields8 () us_split_fields8)

(declare-fun i5 () Int)

(declare-fun find_result__split_fields9 () us_split_fields__ref4)

(declare-fun i6 () int__ref)

(declare-fun find_result__split_fields10 () us_split_fields8)

(declare-fun i7 () Int)

(declare-fun result3 () map__ref1)

(declare-fun book1 () (Array Int us_rep3))

(declare-fun result4 () int__ref)

(declare-fun i8 () Int)

(declare-fun book2 () (Array Int us_rep3))

(declare-fun i9 () Int)

(declare-fun result5 () map__ref1)

(declare-fun book3 () (Array Int us_rep3))

(declare-fun result6 () int__ref)

(declare-fun i10 () Int)

(declare-fun book4 () map__ref1)

(declare-fun i11 () int__ref)

(declare-fun book5 () (Array Int us_rep3))
...
;; H
  (assert (= (to_rep o8) (to_rep (select (elts description) i9))))
...
;; H
  (assert (and (= temp___372 o7) (in_range1 o7)))

;; H
  (assert (and (<= 1 temp___372) (<= temp___372 128)))

;; H
  (assert (= o9 temp___372))
