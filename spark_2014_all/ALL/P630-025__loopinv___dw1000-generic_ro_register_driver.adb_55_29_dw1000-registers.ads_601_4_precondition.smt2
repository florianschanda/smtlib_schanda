...
(define-fun us_split_fields_Reserved24__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__evc_rse_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_89__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_89__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(declare-fun dw1000__register_types__evc_rse_type__evc_rse__first__bit () Int)

(declare-fun dw1000__register_types__evc_rse_type__evc_rse__last__bit () Int)

(declare-fun dw1000__register_types__evc_rse_type__evc_rse__position () Int)
...
(declare-fun dw1000__register_types__evc_rse_type__reserved__first__bit () Int)

(declare-fun dw1000__register_types__evc_rse_type__reserved__last__bit () Int)

(declare-fun dw1000__register_types__evc_rse_type__reserved__position () Int)
...
(define-fun register_type__ref_214__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_151__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_151__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6902 us_t1)
  (temp___is_init_6899 Bool) (temp___skip_constant_6900 Bool)
  (temp___do_toplevel_6901 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6900 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_6902)
                                       (last3 temp___expr_6902))
                                       (and (= (first3 temp___expr_6902) 1)
                                       (= (last3 temp___expr_6902) 2)))))
