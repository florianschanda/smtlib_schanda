...
(define-fun y9 () int__ref (mk_int__ref y2))

(define-fun y10 () int__ref (mk_int__ref y1))

(define-fun y11 () int__ref (mk_int__ref y))
...
;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= result1 y11)))
...
;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= result2 y11)))
...
;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= result5 y10)))
...
;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= result6 y10)))
...
;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= result9 y9)))

;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= y7 o82)))
...
;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= result10 y9)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y8 o86)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y7 y8)))

;; H
  (assert (= (to_rep1 o87) y7))
