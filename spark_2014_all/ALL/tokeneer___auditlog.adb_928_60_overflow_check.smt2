...
(declare-fun temp___1430 () (Array Int logfileindext))

(declare-fun temp___14301 () logfileindext)

(declare-fun temp___14302 () logfileindext)

(declare-fun temp___14303 () logfilecountt)

(declare-fun o6 () Int)

(declare-fun o7 () logfilecountt)
...
(declare-fun temp___1432 () (Array Int logfileindext))

(declare-fun temp___14321 () logfileindext)

(declare-fun temp___14322 () logfileindext)

(declare-fun temp___14323 () logfilecountt)
...
(declare-fun logfilesstatus1 () map__ref4)

(declare-fun numberlogentries2 () int__ref)

(declare-fun usedlogfiles__split_fields6 () us_split_fields__ref)

(declare-fun logfileentries2 () map__ref1)

(declare-fun auditalarm2 () int__ref)

(declare-fun auditsystemfault1 () bool__ref)

(declare-fun description1 () map__ref)

(declare-fun thefile3 () t__ref)

(declare-fun head2 () int__ref)

(declare-fun logfiles4 () (Array Int us_rep))
...
;; H
  (assert
  (and
  (and (<= 1 (to_rep2 usedlogfiles__split_fields3))
  (= (to_rep2 usedlogfiles__split_fields3) 17))
  (= numberlogentries (* (to_rep2 usedlogfiles__split_fields3) 1024))))

;; H
  (assert (=> (<= 1 17) (in_range5 head)))

;; H
  (assert (= (mk_int__ref result) (mk_int__ref head)))

;; H
  (assert
  (= head1 (to_rep3
           (select usedlogfiles__split_fields (to_rep3
                                              usedlogfiles__split_fields1)))))

;; H
  (assert (= (mk_t__ref result1) (mk_t__ref thefile)))

;; H
  (assert (= thefile1 (select logfiles head1)))

;; H
  (assert (= (mk_map__ref3 result2) (mk_map__ref3 logfiles)))

;; H
  (assert (= logfiles1 (store logfiles head1 thefile2)))

;; H
  (assert (not (= head1 currentlogfile)))
...
;; H
  ...
  (=> (and (<= 1 i) (<= i 17))
  (=> (not (= i head1))
  (= (to_rep1 (select logfileentries1 i)) (to_rep1 (select logfileentries i)))))))

;; H
  (assert
  (and (= o (nextlistindex (to_rep3 usedlogfiles__split_fields1)))
  (and (in_range5 o)
  (= o (ite (= (to_rep3 usedlogfiles__split_fields1) 17) 1
       (+ (to_rep3 usedlogfiles__split_fields1) 1))))))

;; H
  (assert (= (to_rep3 o1) o))

;; H
  (assert (= usedlogfiles__split_fields o2))

;; H
  (assert (= o1 o3))

;; H
  (assert (= usedlogfiles__split_fields2 o4))

;; H
  (assert (= usedlogfiles__split_fields3 o5))

;; H
  (assert (= temp___1430 o2))

;; H
  (assert (= temp___14301 o3))

;; H
  (assert (= temp___14302 o4))

;; H
  (assert (= temp___14303 o5))
...
;; H
  (assert
  (= usedlogfiles__split_fields4 (mk___split_fields temp___1430 temp___14301
                                 temp___14302 temp___14303)))

;; H
  (assert
  (and
  (= o6 (- (to_rep2
           (rec__auditlog__logfilelistt__length usedlogfiles__split_fields4)) 1))
  (in_range4
  (- (to_rep2
     (rec__auditlog__logfilelistt__length usedlogfiles__split_fields4)) 1))))

;; H
  (assert (= (to_rep2 o7) o6))
...
;; H
  (assert (= temp___14321 o9))

;; H
  (assert (= temp___14322 o10))

;; H
  (assert (= temp___14323 o11))

;; H
  (assert (= result4 (mk___split_fields__ref usedlogfiles__split_fields4)))

;; H
  (assert
  (= usedlogfiles__split_fields5 (mk___split_fields temp___1432 temp___14321
                                 temp___14322 temp___14323)))

;; H
  (assert
  (and (= o12 (- numberlogentries 1024)) (in_range8
  (- numberlogentries 1024))))

;; H
  (assert (= result5 (mk_int__ref numberlogentries)))

;; H
  (assert (= numberlogentries1 o12))

;; H
  (assert (= result6 (mk_int__ref auditalarm)))

;; H
  (assert (= auditalarm1 0))

;; H
  (assert (= head2 (mk_int__ref head1)))
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 825, characters 0-0
  ...
  (* (to_rep2
     (rec__auditlog__logfilelistt__length
     (us_split_fields__content usedlogfiles__split_fields6))) 1024))))
(check-sat)
(exit)
