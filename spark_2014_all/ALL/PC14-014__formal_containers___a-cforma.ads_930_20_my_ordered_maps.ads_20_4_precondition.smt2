...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__my_ordered_maps__n__map us_main_type)))))
(define-fun us_split_fields_Map2__projection ((a us_split_fields)) us_main_type
...
(define-fun map__ref_4__projection ((a map__ref)) us_rep (map__content a))
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__my_ordered_maps__n__cursor__node count_type)))))
...
(define-fun us_rep_13__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                 a))
...
(define-fun map__ref_6__projection ((a map__ref1)) us_rep2 (map__content1 a))

(declare-datatypes ()
((key_type__ref (mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref_6__projection ((a key_type__ref)) us_rep1 (key_type__content
                                                                    a))
...
(define-fun dynamic_invariant ((temp___expr_587 Int)
...
(define-fun default_initial_assumption ((temp___expr_594 us_rep2)
  (temp___skip_top_level_595 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_595 true))
                                         (and
                                         (= (is_empty temp___expr_594) true)
                                         (= (length temp___expr_594) 0))))
...
(define-fun us_split_fields_F__projection ((a us_split_fields4)) integer
...
(define-fun us_rep_10__projection ((a us_rep3)) us_split_fields4 (us_split_fields5
                                                                 a))
...
(define-fun my_lt ((x us_rep3)
  (y us_rep3)) Bool (< (to_rep1
                       (rec__my_ordered_maps__my_rec__f (us_split_fields5 x)))
  (to_rep1 (rec__my_ordered_maps__my_rec__f (us_split_fields5 y)))))
...
(define-fun key_type__ref_4__projection ((a key_type__ref1)) us_rep3
  (key_type__content1 a))

(define-fun equivalent_keys ((left us_rep3)
...
;; length__post__dispatch_axiom
  ...
  (forall ((container1 us_rep)) (! (dynamic_invariant2
  (length2 attr__tag container1) true false
  true) :pattern ((length2 attr__tag container1)) ))))
...
(define-fun map__ref_5__projection ((a map__ref2)) us_rep4 (map__content2 a))
...
(define-fun default_initial_assumption1 ((temp___expr_541 us_rep4)
  (temp___skip_top_level_542 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_542 true))
                                         (and
                                         (= (is_empty1 temp___expr_541) true)
                                         (= (length3 temp___expr_541) 0))))
...
(declare-datatypes ()
((key_type__ref2 (mk_key_type__ref2 (key_type__content2 us_rep3)))))
(define-fun key_type__ref_5__projection ((a key_type__ref2)) us_rep3
...
;; has_key__post_axiom
  ...
  (! (=> (= (of_int 1) true)
     (=>
     (exists ((k us_rep3))
     (and (= (has_key1 container1 k) true) (= (equivalent_keys k key) true)))
...
(define-fun element_type__ref_6__projection ((a element_type__ref1)) element_type1
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep4)) (! (dynamic_invariant2 (length3 container1)
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep2)) (! (dynamic_invariant2 (length container1)
...
;; witness__post_axiom
  ...
  (! (=> (= (has_key container1 key) true)
     ...
     (and (= (has_witness1 container1 result) true) (dynamic_invariant2
     result true false true)))) :pattern ((witness container1 key)) ))))
...
;; H
  (assert (= temp___892 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___892)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cforma.ads", line 909, characters 0-0
