...
(declare-fun loop_tutorial__isqrt__result () Int)
...
(declare-fun middle3 () Int)

(declare-fun lower5 () int__ref)

(declare-fun upper6 () int__ref)

(declare-fun middle4 () int__ref)

(declare-fun lower6 () Int)

(declare-fun upper7 () Int)

(declare-fun middle5 () Int)

(declare-fun lower7 () int__ref)

(declare-fun upper8 () int__ref)

(declare-fun middle6 () int__ref)

(declare-fun lower8 () Int)

(declare-fun upper9 () Int)

(declare-fun middle7 () Int)

(declare-fun result6 () int__ref)

(declare-fun loop_tutorial__isqrt__result1 () Int)

(declare-fun loop_tutorial__isqrt__result2 () int__ref)

(declare-fun loop_tutorial__isqrt__result3 () Int)

(declare-fun lower9 () int__ref)

(declare-fun upper10 () int__ref)

(declare-fun middle8 () int__ref)

(declare-fun loop_tutorial__isqrt__result4 () int__ref)

(declare-fun lower10 () Int)

(declare-fun upper11 () Int)

(declare-fun middle9 () Int)

(declare-fun loop_tutorial__isqrt__result5 () Int)
...
;; H
  (assert
  (and (= o2 (+ (int__content loop_tutorial__isqrt__result4) 1)) (in_range1
  (+ (int__content loop_tutorial__isqrt__result4) 1))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1 (+ (int__content loop_tutorial__isqrt__result4) 1))))
(check-sat)
(exit)
