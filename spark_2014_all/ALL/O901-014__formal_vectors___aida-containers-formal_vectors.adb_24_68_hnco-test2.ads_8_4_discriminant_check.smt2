...
(define-fun us_split_fields_Hidden_Vector__5__projection ((a us_split_fields4)) us_rep
  (rec__hnco__test2__v_type_owner__vector_type__hidden_vector1 a))

(define-fun us_split_fields___5__projection ((a us_split_fields4)) us_private
  (rec__ext__1 a))
...
(define-fun us_rep___15__projection ((a us_rep3)) us_split_discrs2 (us_split_discrs4
                                                                   a))

(define-fun us_rep___16__projection ((a us_rep3)) us_split_fields4 (us_split_fields5
                                                                   a))

(define-fun us_rep___17__projection ((a us_rep3)) Int (attr__tag1 a))
...
(((mk_t202s__ref (t202s__content us_rep3)))))
