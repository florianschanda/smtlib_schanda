...
(declare-fun temp___745 () bits_6)

(declare-fun temp___7451 () sub_index_type)

(declare-fun temp___7452 () operation_type)

(declare-fun dw1000__register_driver__read_register__B_1__header__assume () bits_6)

(declare-fun dw1000__register_driver__read_register__B_1__header__assume1 () sub_index_type)

(declare-fun dw1000__register_driver__read_register__B_1__header__assume2 () operation_type)

(define-fun dw1000__register_driver__read_register__B_1__header__assume3 () us_rep
  (mk___rep
  (mk___split_fields
  dw1000__register_driver__read_register__B_1__header__assume
  dw1000__register_driver__read_register__B_1__header__assume1
  dw1000__register_driver__read_register__B_1__header__assume2)))
...
;; H
  (assert (= temp___745 o3))

;; H
  (assert (= temp___7451 o4))

;; H
  (assert (= temp___7452 o5))

;; H
  (assert (= (to_rep5 temp___7451) 0))

;; H
  (assert
  (= dw1000__register_driver__read_register__B_1__header__assume3 (mk___rep
                                                                  (mk___split_fields
                                                                  temp___745
                                                                  temp___7451
                                                                  temp___7452))))
...
;; H
  (assert
  (= dw1000__register_driver__read_register__B_1__header__assume3 header))
