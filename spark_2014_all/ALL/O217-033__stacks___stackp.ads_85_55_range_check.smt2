...
(declare-fun dummy1 () positive_less_than_max)
...
;; range_axiom
  (assert
  (forall ((x positive_less_than_max)) (! (in_range1
...
(assert
;; WP_parameter_def
 ;; File "stackp.ads", line 3, characters 0-0
  (not (in_range
  (- (+ (to_rep1 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep
                                                                    (rec__stackp__stack_root__length1
                                                                    (us_split_fields3
                                                                    s)))) 1))))
(check-sat)
