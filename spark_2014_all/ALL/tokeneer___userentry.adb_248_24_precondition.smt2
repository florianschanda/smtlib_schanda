...
(declare-fun user_eq10 (durationt durationt) Bool)

(declare-fun dummy10 () durationt)
...
(define-fun dynamic_invariant8 ((temp___expr_382 Int)
  ...
  (temp___do_toplevel_381 Bool)) Bool (=>
                                      ...
                                      (<= 1 12)) (in_range5 temp___expr_382)))
...
(define-fun dynamic_invariant9 ((temp___expr_388 Int)
  ...
  (temp___do_toplevel_387 Bool)) Bool (=>
                                      ...
                                      (<= 1 31)) (in_range6 temp___expr_388)))
...
(assert
;; WP_parameter_def
 ;; File "userentry.adb", line 94, characters 0-0
