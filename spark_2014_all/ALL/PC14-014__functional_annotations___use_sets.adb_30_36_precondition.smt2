...
;; H
  (assert
  (and (= temp___867 (elements (mk___rep r__split_discrs r__split_fields3)))
  (and
  (and
  (and
  (and
  (= (length2 temp___867) (length
                          (mk___rep r__split_discrs r__split_fields3)))
  (forall ((temp___425 Int))
  (=>
  (and (in_range2 temp___425)
  (= (iter_has_element temp___867 temp___425) true))
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields3))
     (get temp___867 temp___425)) true))))
  (forall ((item Int))
  (=>
  (and (in_range5 item)
  (= (contains (model__ (mk___rep r__split_discrs r__split_fields3)) item) true))
  (and (< 0 (find temp___867 item))
  (= (get temp___867 (find temp___867 item)) item)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields3))))
  (= (find temp___867 (get temp___867 i)) i))))
  (forall ((i Int))
  (=>
  (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields3))))
  (forall ((j Int))
  (=>
  (and (<= 1 j) (<= j (length (mk___rep r__split_discrs r__split_fields3))))
  (=> (= (get temp___867 i) (get temp___867 j)) (= i j)))))))))

;; H
  (assert
  (and (= o (iter_has_element temp___867 temp___866))
  (= (= o true) (and (<= 1 temp___866) (<= temp___866 (last temp___867))))))

;; H
  (assert (= (= o1 true) (in_range2 temp___866)))
...
;; H
  (assert (and (= g (get temp___867 temp___866)) (in_range3 g)))
...
;; WP_parameter_def
 ;; File "use_sets.ads", line 6, characters 0-0
  (not (= (has_key o2 (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
