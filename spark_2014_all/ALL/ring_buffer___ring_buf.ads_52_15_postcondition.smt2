...
(declare-const temp___2041 ar_index)

(declare-const temp___2042 length_type)
...
;; H
  (assert (= temp___206 o6))

;; H
  (assert (= temp___2061 o7))

;; H
  (assert (= temp___2062 o8))
...
;; H
  (assert (= temp___206 r__split_fields6))

;; H
  (assert (= temp___2061 r__split_fields7))

;; H
  (assert (= temp___2062 r__split_fields8))
...
;; WP_parameter_def
 ;; File "ring_buf.ads", line 47, characters 0-0
  (not (= (to_rep2 r__split_fields11) (- (to_rep2 r__split_fields2) 1))))
(check-sat)
(exit)
