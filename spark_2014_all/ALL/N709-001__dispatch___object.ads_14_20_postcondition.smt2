...
(declare-fun obj__attr__tag () Int)
...
(declare-fun obj__split_fields () integer)

(declare-fun obj__split_fields1 () integer)

(declare-fun obj__split_fields2 () integer)

(declare-fun obj__split_fields3 () us_private)
...
(declare-fun temp___146 () integer)

(declare-fun temp___1461 () integer)

(declare-fun temp___1462 () integer)

(declare-fun temp___1463 () us_private)

(declare-fun temp___1464 () Int)
...
(declare-fun obj__split_fields4 () integer)

(declare-fun obj__split_fields5 () integer)

(declare-fun obj__split_fields6 () integer)

(declare-fun obj__split_fields7 () us_private)

(declare-fun obj__split_fields8 () integer)

(declare-fun obj__split_fields9 () integer)

(declare-fun obj__split_fields10 () integer)

(declare-fun obj__split_fields11 () us_private)

(declare-fun obj__split_fields12 () integer)

(declare-fun obj__split_fields13 () integer)

(declare-fun obj__split_fields14 () integer)

(declare-fun obj__split_fields15 () us_private)
