...
;; H
  ...
  (=> (bvugt n3 var1_range_size) (= (mk_t__ref result1) n19))))
...
;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3))
  (=> (bvugt n3 var1_range_size) (= (mk_t__ref result2) n29))))
...
;; H
  ...
  (=> (bvult n3 var2_range_size) (= (mk_t__ref result3) n19)))))
...
;; H
  ...
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3))
  (=> (not (bvugt n3 var1_range_size))
  (=> (bvult n3 var2_range_size) (= (mk_t__ref result4) n29)))))
...
;; H
  ...
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3))
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result5) n19)))))
...
;; H
  ...
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n3))
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result6) n29)))))
...
;; H
  ...
  (=> (and (bvule ((_ int2bv 64) 0) m) (bvule m n4))
...
;; H
  (assert (= n5 (bvadd n4 ((_ int2bv 64) 1))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (bvugt n5 var1_range_size) (= n15 result8))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (bvugt n5 var1_range_size) (= n16 ((_ int2bv 64) 0)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (bvugt n5 var1_range_size) (= n25 result9))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (bvugt n5 var1_range_size) (= n26 (bvsub n5 var1_range_size)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (bvugt n5 var1_range_size) (bvule n26 var2_range_size))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (bvult n5 var2_range_size) (= n15 result10)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (bvult n5 var2_range_size) (= n17 var1_range_size)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (bvult n5 var2_range_size) (= n25 result11)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (bvult n5 var2_range_size) (= n27 n5)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (not (bvult n5 var2_range_size)) (= n15 result12)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (not (bvult n5 var2_range_size)) (= n18 (bvsub var1_range_size n5))))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (not (bvult n5 var2_range_size)) (= n25 result13)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (not (bvult n5 var2_range_size)) (= n28 ((_ int2bv 64) 0))))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (not (bvult n5 var2_range_size)) (= n27 n28)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size))
  (=> (not (bvult n5 var2_range_size)) (= n17 n18)))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size)) (= n26 n27))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (=> (not (bvugt n5 var1_range_size)) (= n16 n17))))

;; H
  (assert
  (=> (= var1 (bvadd (bvsub var2 var1_range_size) n5))
  (and
  (and (and (bvule ((_ int2bv 64) 0) n16) (bvule n16 var1_range_size))
  (and (bvule ((_ int2bv 64) 0) n26) (bvule n26 var2_range_size)))
  (= (bvadd var1 n16) (bvadd var2 n26)))))
...
;; H
  (assert
  (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n5))) (= n26 n25)))

;; H
  (assert
  (=> (not (= var1 (bvadd (bvsub var2 var1_range_size) n5))) (= n16 n15)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 19, characters 0-0
  ...
  (or
  (forall ((m (_ BitVec 64)))
  (=> (and (bvule ((_ int2bv 64) 0) m) (bvule m n5))
  (not (= var1 (bvadd (bvsub var2 var1_range_size) m)))))
  (exists ((i (_ BitVec 64)))
  (and (and (bvule ((_ int2bv 64) 0) i) (bvule i var1_range_size))
  (exists ((j (_ BitVec 64)))
