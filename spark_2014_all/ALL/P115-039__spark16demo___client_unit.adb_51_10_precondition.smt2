...
(declare-fun item_done () Bool)

(declare-fun state3 () Int)

(declare-fun item_done1 () Bool)
...
;; H
  (assert
  (=> (= item_done true)
  (and (= (cur_state state3) (ite (= item_done1 true) 2 1)) (in_range
  state3))))

;; H
  (assert (=> (not (= item_done true)) (= item_done1 item_done)))

;; H
  (assert (=> (not (= item_done true)) (= state3 state2)))

;; H
  (assert (= item_done1 true))

(assert
;; WP_parameter_def
 ;; File "client_unit.adb", line 22, characters 0-0
