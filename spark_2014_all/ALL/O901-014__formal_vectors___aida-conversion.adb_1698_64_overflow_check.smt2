...
;; H
  (assert
  (and (= o12 (+ (to_rep1 (first (rt source))) 3)) (in_range1
...
;; H
  ...
  (forall ((index1 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 3) index1)
  (<= index1 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index1))) true)))))

;; H
  (assert
  (and (= temp___2091 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2091)
  (<= temp___2091 (to_rep1 (last (rt source))))))

;; H
  (assert (= o8 temp___2091))
...
;; H
  (assert
  (and (= temp___2090 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2090)
  (<= temp___2090 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___2090))
...
;; H
  (assert
  (and (= temp___2089 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___2089)
  (<= temp___2089 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___2089))
