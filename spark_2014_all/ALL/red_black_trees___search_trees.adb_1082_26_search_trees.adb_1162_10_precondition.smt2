...
;; H
  (assert
  (and (= temp___1089 (model__ (mk___rep2 f_old__split_fields2) o25))
  (and (dynamic_invariant6 temp___1089 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1089 o25))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1089 o25)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o25))
...
;; H
  (assert (= o26 (select temp___1089 y1)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1088 o21))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1088 o21)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o21))
...
;; H
  (assert (= o22 (select temp___1088 x1)))
...
;; H
  (assert
  (and (= temp___1087 (model__ (mk___rep2 f_old__split_fields2) o17))
  (and (dynamic_invariant6 temp___1087 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1087 o17))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1087 o17)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o17))
...
;; H
  (assert (= o18 (select temp___1087 j2)))
