...
;; H
  (assert (and (= o2 i3) (in_range5 i3)))

;; H
  (assert
  (and (= o3 (get (model__ l) o2))
  (and (in_range8 o3) (= o3 (get (model__ l) o2)))))

;; H
  (assert
  (= (let ((temp___188 (to__ (mk___rep s__split_fields5))))
     (bool_eq (elts temp___188) (to_rep (first (rt temp___188)))
     (to_rep (last (rt temp___188)))
     (let ((temp___187 (temp___182 o3)))
     (let ((temp___186 (to__ (mk___rep s__split_fields4))))
     (ite (= (length temp___186) 0) temp___187
     (concat1 (elts temp___186) (to_rep (first (rt temp___186)))
     (to_rep (last (rt temp___186))) temp___187 1 1))))
     (to_rep
...
;; WP_parameter_def
 ;; File "list.ads", line 9, characters 0-0
  (not
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields5))))) (+ (- i3
  first4) 1))))
(check-sat)
(exit)
