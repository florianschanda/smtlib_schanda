...
;; H
  (assert
  (=> (= result3 true)
  (=> (not (= first_available 0)) (= result4 (ite (< 0 o9) true false)))))
...
;; H
  ...
  (=> (= result4 true)
  (and
  (= o8 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m))
        1))
  (in_range6 o8))))))
...
;; H
  ...
  (=> (= result3 true)
  (=> (not (= first_available 0))
  (=> (= result4 true) (= result2 (ite (= o8 first_available) true false))))))
