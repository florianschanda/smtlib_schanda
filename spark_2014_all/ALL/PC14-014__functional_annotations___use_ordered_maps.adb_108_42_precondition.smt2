...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (- (get1 (positions s1) (mk___rep1 cu__split_fields3)) 1)))
  (not (= (has_key (model__ s2) (get (keys s1) i1)) true)))))
...
;; H
  ...
  (forall ((i1 us_rep1))
  (=> (= (has_key1 o i1) true)
  (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length3 s1)))
  (forall ((j us_rep1))
  (=> (= (has_key1 o j) true)
...
;; H
  ...
  (and
  (and
  (and (= (length1 o4) (length3 s1))
  (forall ((temp___396 Int))
  (=> (and (in_range3 temp___396) (= (iter_has_element o4 temp___396) true))
  (= (has_key (model__ s1) (get o4 temp___396)) true))))
  (forall ((key2 Int))
  (=> (and (in_range2 key2) (= (has_key (model__ s1) key2) true))
  (and (< 0 (find o4 key2))
  (= (equivalent_keys (get o4 (find o4 key2)) key2) true)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length3 s1)))
