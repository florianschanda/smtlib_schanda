...
(declare-const r__split_fields2 natural)

(declare-const r__split_fields3 natural)

;; H
  (assert (= (to_rep r__split_fields2) (to_rep r__split_fields)))

(assert
;; WP_parameter_def
 ;; File "wrong_lsp.adb", line 8, characters 0-0
  (not (= (to_rep r__split_fields3) (to_rep r__split_fields1))))
(check-sat)
(exit)
