...
;; H
  (assert
  (and (= o4 (ceiling (mk___rep l__split_discrs l__split_fields8) 3))
  (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (<
          (last_key (mk___rep l__split_discrs l__split_fields8)) 3) true) true)
  (= (bool_eq1 o4 no_element) true)
  (and
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o4) true)
  (not
  (< (get1 (keys (mk___rep l__split_discrs l__split_fields8))
     (get (positions (mk___rep l__split_discrs l__split_fields8)) o4)) 3)))
  (= (k_is_find (keys (mk___rep l__split_discrs l__split_fields8)) 3
