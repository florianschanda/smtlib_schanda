...
(declare-fun result____split_fields6 () integer)
...
;; H
  (assert (= temp___1631 result____split_fields4))

;; H
  (assert (= temp___1632 result____split_fields5))

;; H
  (assert (= temp___1633 result____split_fields6))

;; H
  (assert (= temp___1634 result____split_fields7))
