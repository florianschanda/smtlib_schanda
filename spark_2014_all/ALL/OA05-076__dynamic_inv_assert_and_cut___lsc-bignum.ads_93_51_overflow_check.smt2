...
;; H
  (assert (and (= o2 (+ b_first a_last)) (in_range1 (+ b_first a_last))))

;; H
  (assert (= o3 (- o2 a_first)))
...
;; H
  (assert (=> (= result1 true) (= o11 (to_rep1 o10))))
...
;; H
  (assert (=> (= result1 true) (= o7 k)))

;; H
  (assert (=> (= result1 true) (= o8 (select b8 o7))))

;; H
  (assert (=> (= result1 true) (= o12 (to_rep1 o8))))
