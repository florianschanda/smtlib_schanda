...
;; range_axiom
  (assert
  (forall ((x name_id)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(declare-datatypes ()
((us_split_discrs2 (mk___split_discrs1 (rec__lexer__token__kind token_kind)))))
...
(define-fun us_split_fields_Line__projection ((a us_split_fields2)) natural
  (rec__lexer__token__line a))

(define-fun us_split_fields_Col__projection ((a us_split_fields2)) natural
  (rec__lexer__token__col a))

(define-fun us_split_fields_Length__projection ((a us_split_fields2)) natural
  (rec__lexer__token__length a))

(define-fun us_split_fields_Value__projection ((a us_split_fields2)) name_id
...
;; temp___String_Literal_891__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (= (to_rep (select (temp___String_Literal_891 us_void_param) 1)) 58) :pattern (
  (temp___String_Literal_891 us_void_param)) )))

(declare-fun temp___String_Literal_892 (tuple0) (Array Int character))

;; temp___String_Literal_892__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (= (to_rep (select (temp___String_Literal_892 us_void_param) 1)) 58) :pattern (
  (temp___String_Literal_892 us_void_param)) )))

(declare-fun temp___String_Literal_893 (tuple0) (Array Int character))

;; temp___String_Literal_893__def_axiom
  (assert
  (forall ((us_void_param tuple0))
  (! (and
     (= (to_rep (select (temp___String_Literal_893 us_void_param) 1)) 58)
     (= (to_rep (select (temp___String_Literal_893 us_void_param) 2)) 32)) :pattern (
  (temp___String_Literal_893 us_void_param)) )))
...
;; H
  (assert
  (and (= us (to_rep4 (rec__lexer__token__kind (us_split_discrs3 t1))))
  (in_range6 (to_rep4 (rec__lexer__token__kind (us_split_discrs3 t1))))))
