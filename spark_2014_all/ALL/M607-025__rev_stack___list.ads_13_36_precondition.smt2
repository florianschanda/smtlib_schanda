...
(declare-fun temp___471 () Int)

(declare-fun temp___470 () r1)

(declare-fun temp___4701 () (Array Int integer))
...
(declare-fun temp___480 () r1)

(declare-fun temp___4801 () (Array Int integer))

(declare-fun temp___479 () capacity_range)

(declare-fun temp___4791 () us_main_type)

(declare-fun temp___483 () us_rep)
...
;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last5))
  (= s__split_fields2 (mk___split_fields temp___470 temp___4701))))

;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last5)) (and (= o i3) (in_range5 i3))))
...
;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last5))
  (= (let ((temp___188 (to__ (mk___rep s__split_fields3))))
     (bool_eq (elts temp___188) (to_rep (first (rt temp___188)))
     (to_rep (last (rt temp___188)))
     (let ((temp___187 (temp___182 o1)))
     (let ((temp___186 (to__ (mk___rep s__split_fields2))))
     (ite (= (length temp___186) 0) temp___187
     (concat1 (elts temp___186) (to_rep (first (rt temp___186)))
     (to_rep (last (rt temp___186))) temp___187 1 1))))
     (to_rep
     (first
     (let ((temp___186 (to__ (mk___rep s__split_fields2))))
     (ite (= (length temp___186) 0) (mk 1 1)
     (mk (to_rep (first (rt temp___186)))
     (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep
                                                        (first
                                                        (rt temp___186)))
                                               (to_rep
                                               (last (rt temp___186))))
...
;; H
  (assert
  (=> (and (<= first4 i3) (<= i3 last5))
  (and (=> (<= first4 last5) (dynamic_property3 first4 last5 i4))
  (and (<= first4 i4) (<= i4 last5)))))
...
;; H
  (assert
  (=> (not (and (<= first4 i3) (<= i3 last5))) (= i7 (mk_int__ref i3))))

;; H
  (assert
  (=> (not (and (<= first4 i3) (<= i3 last5)))
...
;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last5))
  (= (us_split_fields__content s__split_fields7) (mk___split_fields
                                                 temp___480 temp___4801))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last5))
  (and (= res__split_discrs (mk___split_discrs temp___479))
  (= res__split_fields1 (mk___split_fields1 temp___4791)))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last5))
  (= temp___483 (mk___rep (us_split_fields__content s__split_fields7)))))
...
;; H
  ...
  first4))
  (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5
  i10) 1)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (+ (- last5 i10) 1)))
  ...
  (get (model__ l) (+ (- last5 j) first4))))))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last5))
  (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i10))
  (and (<= first4 i10) (<= i10 last5)))))

;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last5))
  (and (= o2 (top (mk___rep s__split_fields9)))
  (and (in_range1 o2)
  (and
  (= o2 (to_rep
...
;; H
  (assert
  (=> (and (<= first4 i9) (<= i9 last5))
  (= (let ((temp___195 (to__ (mk___rep s__split_fields10))))
     (bool_eq (elts temp___195) (to_rep (first (rt temp___195)))
     (to_rep (last (rt temp___195)))
...
;; H
  (assert
  (=> (not (and (<= first4 i9) (<= i9 last5))) (= i13 (mk_int__ref i9))))

;; H
  (assert
  (=> (not (and (<= first4 i9) (<= i9 last5)))
...
;; H
  ...
  (and (in_range7 o4) (= o4 (last4 (model__ l))))))
...
;; H
  ...
  (and (in_range7 o7) (= o7 (last4 (model__ l))))))
