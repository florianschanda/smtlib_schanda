...
(declare-fun temp___198 () status)

(declare-fun temp___1981 () natural)

(declare-fun temp___1982 () natural)

(declare-fun temp___1983 () Bool)

(declare-fun temp___1984 () Bool)
...
(assert
;; WP_parameter_def
 ;; File "definite.adb", line 99, characters 0-0
  (not (= temp___198 x__split_discrs)))
(check-sat)
(exit)
