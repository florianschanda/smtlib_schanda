...
(define-fun default_initial_assumption ((temp___expr_691 us_rep2)
...
(define-fun get_f ((x us_rep1)) Int (to_rep3
...
(define-fun dynamic_invariant1 ((temp___expr_981 Int)
...
;; length__post__dispatch_axiom
  ...
  (forall ((container1 us_rep)) (! (dynamic_invariant4
  (length1 attr__tag container1) true false
  true) :pattern ((length1 attr__tag container1)) ))))

(declare-datatypes ()
((element_type__ref1
 (mk_element_type__ref1 (element_type__content1 us_rep1)))))
(define-fun element_type__ref_5__projection ((a element_type__ref1)) us_rep1
  (element_type__content1 a))

(declare-datatypes ()
((element_type__ref2
 (mk_element_type__ref2 (element_type__content2 us_rep1)))))
(define-fun element_type__ref_7__projection ((a element_type__ref2)) us_rep1
...
(define-fun default_initial_assumption1 ((temp___expr_724 us_rep3)
...
;; find__post_axiom
  ...
  (! (let ((result (find container1 item)))
     ...
     (= (my_eq item (get container1 result)) true))) (dynamic_invariant4
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (= (contains (model__ container1) (get result temp___761)) true))))
     (forall ((item us_rep1))
...
;; length__post_axiom
  (assert
  (forall ((container1 us_rep2)) (! (dynamic_invariant4 (length2 container1)
...
;; is_empty__post_axiom
  ...
  (! (let ((result (is_empty container1)))
     (and
     (= (= result true)
     (forall ((item us_rep1)) (not (= (contains container1 item) true))))
     (= (= result true) (= (length2 container1) 0)))) :pattern ((is_empty
                                                                container1)) )))
...
(assert
;; WP_parameter_def
 ;; File "a-cfhase.ads", line 1304, characters 0-0
  (not true))
(check-sat)
(exit)
