...
;; H
  (assert
  (forall ((k1 Int))
  (=> (and (<= (to_rep h_v2__first) k1) (<= k1 (to_rep h_v2__last)))
  (ite (< k1 q_v22)
  (= (to_rep1 (select h_v21 k1)) (to_rep1 (select h_v2 (+ k1 m_v21))))
  (ite (< (+ q_v22 m_v21) k1)
  (= (to_rep1 (select h_v21 k1)) (to_rep1 (select h_v2 (- k1 m_v21))))
  (= (to_rep1 (select h_v21 k1)) (to_rep1 (select h_v2 k1))))))))
...
;; H
  ...
  r17b q_v22)) (=> (<= (- 2147483648) 2147483647) (in_range2 t_v21)))
...
;; WP_parameter_def
 ;; File "infoflow.ads", line 61, characters 0-0
  (not (<= (to_rep h_v2__first) (- k m_v21))))
(check-sat)
(exit)
