...
(declare-fun temp___1346 () digit_index_type)

(declare-fun temp___13461 () (Array Int octet))

(declare-fun temp___13462 () t1)
...
;; H
  (assert
  (=> (= result1 true)
  (= (mk___rep1 (mk___split_discrs temp___1346)
     (mk___split_fields1 (mk___t1 temp___13461 temp___13462))) (of_base o6))))
...
;; H
  ...
  (= result____split_fields3 (mk___split_fields1
                             (mk___t1 temp___13461 temp___13462)))))

;; H
  (assert
  (=> (= result1 true)
  (= result____split_discrs (mk___split_discrs temp___1346))))
