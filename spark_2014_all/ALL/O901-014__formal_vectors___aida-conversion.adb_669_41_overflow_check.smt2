...
(declare-fun temp___1520 () (Array Int integer))

(declare-fun temp___1518 () Int)
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1523))
  (= temp___1520 n1)))
...
;; H
  ...
  (=> (< index2 temp___1521)
  (= (select n3 temp___1521) (select temp___1520 temp___1521))))))
...
;; H
  (assert
  (and (= temp___1524 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1524)
  (<= temp___1524 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1525 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1525)
  (<= temp___1525 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1526 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1526)
  (<= temp___1526 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1527 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1527)
  (<= temp___1527 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1528 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1528)
  (<= temp___1528 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1529 (+ (to_rep1 (first (rt source))) 4)) (in_range1
...
;; H
  (assert
  (and (= temp___1530 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1530)
  (<= temp___1530 (to_rep1 n__last))))
