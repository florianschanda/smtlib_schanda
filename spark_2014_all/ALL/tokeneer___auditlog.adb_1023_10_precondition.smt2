...
(declare-fun usedlogfiles__split_fields1 () logfilecountt)
...
;; H
  ...
  (and
  (and
  (and (<= 1 (to_rep2 usedlogfiles__split_fields1))
  (= (to_rep1 (select logfileentries1 currentlogfile)) (to_rep1
                                                       (select logfileentries
                                                       currentlogfile))))
  (= (to_rep2 usedlogfiles__split_fields1) 16))
  (= numberlogentries1 (* (to_rep2 usedlogfiles__split_fields1) 1024)))
  (and (in_range10 numberlogentries1) (in_range4 auditalarm1))))

(assert
;; WP_parameter_def
 ;; File "auditlog.adb", line 70, characters 0-0
  (not (< numberlogentries1 17408)))
(check-sat)
(exit)
