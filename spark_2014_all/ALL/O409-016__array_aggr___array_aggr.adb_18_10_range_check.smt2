...
(declare-const dummy3 tTbSP2)

(declare-datatypes ((tTbSP2__ref 0))
(((mk_tTbSP2__ref (tTbSP2__content tTbSP2)))))
...
(declare-const dummy5 tTfSP2)

(declare-datatypes ((tTfSP2__ref 0))
(((mk_tTfSP2__ref (tTfSP2__content tTfSP2)))))
