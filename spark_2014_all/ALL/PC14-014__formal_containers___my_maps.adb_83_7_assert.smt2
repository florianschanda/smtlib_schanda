...
;; find__post_axiom
  ...
  (! (let ((result (find1 container key2)))
     ...
     (= (bool_eq6 result no_element) true)
     (and
...
;; next__post_axiom
  ...
  (! (=>
     ...
     (= (bool_eq6 position no_element) true))
     (let ((result (next container position)))
     (ite (or (= (bool_eq6 position no_element) true)
...
;; k_keys_included__post_axiom
  ...
  (! (= (= (k_keys_included left right) true)
     ...
     (= (bool_eq4 (get right (find right (get left i))) (get left i)) true))))) :pattern (
...
;; mapping_preserved__post_axiom
  ...
  (! (=> (= (mapping_preserved k_left k_right p_left p_right) true)
     ...
     (= (bool_eq4 (get k_left (get1 p_left c))
        (get k_right (get1 p_right c))) true))))) :pattern ((mapping_preserved
                                                            k_left k_right
                                                            p_left p_right)) ))))
...
;; keys_included_except__post_axiom
  ...
  (! (= (= (keys_included_except1 left right new_key) true)
     (forall ((key2 us_rep2))
     (=> (= (has_key left key2) true)
     (=> (not (= (bool_eq6 key2 new_key) true))
...
(declare-fun my_maps__test_map_rec__R9b__assume () (_ BitVec 32))

(declare-fun us () (_ BitVec 32))

(declare-fun us1 () Int)

(declare-fun my_maps__test_map_rec__R12b__assume () (_ BitVec 32))

(declare-fun us2 () (_ BitVec 32))

(declare-fun us3 () Int)

(declare-fun temp___1102 () count_type)

(declare-fun temp___1103 () count_type)
...
;; H
  ...
  (= (bool_eq6 temp___11021 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (ite (= (ite (= (bool_eq6 (mk___rep2 c__split_fields1) no_element) false) (= 
          (get1
          (positions
          (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
  ...
  (= (bool_eq6 temp___11031 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
...
;; H
  ...
  (= (bool_eq6 temp___1115 no_element) true)
  (and
  (and
...
;; H
  ...
  (and
  (and
  (and (= (bool_eq6 (mk___rep2 c__split_fields5) no_element) true)
  (= (length
...
;; H
  ...
  (= (bool_eq6 temp___1117 no_element) true)
  (and
  (and
