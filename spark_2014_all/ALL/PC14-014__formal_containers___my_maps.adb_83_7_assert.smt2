...
(define-fun key_type__ref___4__projection ((a key_type__ref)) us_rep
  (key_type__content a))
...
(((mk___split_fields1 (rec__my_maps__n__map us_main_type)))))
(define-fun us_split_fields_Map__2__projection ((a us_split_fields2)) us_main_type
...
(define-fun element_type__ref___7__projection ((a element_type__ref)) us_rep
...
(define-fun key_type__ref___6__projection ((a key_type__ref1)) us_rep2
...
(define-fun map__ref___6__projection ((a map__ref1)) us_rep4 (map__content1
                                                             a))
...
(define-fun map__ref___5__projection ((a map__ref2)) us_rep5 (map__content2
                                                             a))
...
(define-fun key_type__ref___5__projection ((a key_type__ref2)) us_rep
...
(define-fun element_type__ref___5__projection ((a element_type__ref1)) element_type
...
(define-fun dynamic_invariant3 ((temp___expr_843 us_rep1)
  (temp___is_init_840 Bool) (temp___skip_constant_841 Bool)
  (temp___do_toplevel_842 Bool)) Bool (=>
                                      (not (= temp___skip_constant_841 true))
                                      (in_range6 10 r9b temp___expr_843)))

(define-fun default_initial_assumption ((temp___expr_846 us_rep1)
  (temp___skip_top_level_847 Bool)) Bool (and
                                         (and
                                         (= (to_rep3
                                            (rec__my_maps__n__map__capacity
                                            (us_split_discrs1
                                         ...
                                         (=>
                                         (not
                                         (= temp___skip_top_level_847 true))
                                         (= (is_empty temp___expr_846) true))))
...
(define-fun dynamic_invariant4 ((temp___expr_854 us_rep1)
  (temp___is_init_851 Bool) (temp___skip_constant_852 Bool)
  (temp___do_toplevel_853 Bool)) Bool (=>
                                      (not (= temp___skip_constant_852 true))
                                      (in_range7 10 r12b temp___expr_854)))

(define-fun default_initial_assumption1 ((temp___expr_857 us_rep1)
  (temp___skip_top_level_858 Bool)) Bool (and
                                         (and
                                         (= (to_rep3
                                            (rec__my_maps__n__map__capacity
                                            (us_split_discrs1
                                         ...
                                         (= (to_rep2
                                            (rec__my_maps__n__map__modulus
                                            (us_split_discrs1
                                            temp___expr_857))) r12b))
                                         (=>
                                         (not
                                         (= temp___skip_top_level_858 true))
                                         (= (is_empty temp___expr_857) true))))
...
(define-fun element_type__ref___6__projection ((a element_type__ref2)) element_type1
...
(define-fun element_type__ref___8__projection ((a element_type__ref3)) element_type2
...
(define-fun o49 () us_rep (mk___rep (mk___split_fields o10 o11)))

(define-fun o50 () us_rep (mk___rep (mk___split_fields o4 o5)))

(define-fun temp___11031 () us_rep2 (mk___rep2
                                    (mk___split_fields2 temp___1103)))

(define-fun temp___11021 () us_rep2 (mk___rep2
                                    (mk___split_fields2 temp___1102)))
...
;; H
  ...
  (= r9b (to_rep2 (rec__my_maps__n__map__modulus l__split_discrs)))))
...
;; H
  ...
  (= r12b (to_rep2 (rec__my_maps__n__map__modulus k__split_discrs)))))
...
;; H
  ...
  (= (bool_eq2 temp___11021 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (= (bool_eq2 temp___11031 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
...
;; H
  ...
  (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields1))
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__2__container__fields1))) true))
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o49) true))
  (= (mapping_preserved (keys (mk___rep1 l__split_discrs l__split_fields1))
     (keys
     (mk___rep1 l__split_discrs my_maps__n__insert__2__container__fields1))
...
;; H
  ...
  (= (get2 (model__ (mk___rep1 l__split_discrs l__split_fields2))
     (mk___rep (mk___split_fields (of_rep1 2) (of_rep 4)))) 2))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
     o16) true)
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
  ...
  (= (= (to_rep1
        (rec__my_maps__my_rec__f
        (us_split_fields1
        (key
        (mk___rep1 l__split_discrs my_maps__n__insert__container__fields)
        (mk___rep2 c__split_fields3))))) (to_rep1
                                         (rec__my_maps__my_rec__f
                                         (us_split_fields1 o16)))) true))
  ...
  (= (oeq3
     (keys (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
  ...
  (= (bool_eq
     (key (mk___rep1 l__split_discrs my_maps__n__insert__container__fields)
     (mk___rep2 c__split_fields3)) o16) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
     o16) 3))
  (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields2))
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))) true))
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields2)) o16) true))
  (= (mapping_preserved (keys (mk___rep1 l__split_discrs l__split_fields2))
     (keys (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
...
;; H
  ...
  (= (oeq3
     (keys
     (mk___rep1 l__split_discrs
     my_maps__n__replace_element__container__fields))
...
;; H
  (assert
  (= l__split_fields4 my_maps__n__replace_element__container__fields))
...
;; H
  ...
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs my_maps__n__replace__container__fields))
  ...
  (= (elements_equal_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__replace__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields4)) o20) true)))
...
;; H
  (assert
  (let ((temp___702 (keys (mk___rep1 l__split_discrs l__split_fields5))))
  (forall ((temp___701 Int))
  (=>
  (and (in_range4 temp___701)
  (= (iter_has_element temp___702 temp___701) true))
  (exists ((i us_rep2))
  (and
  ...
  (= (bool_eq
     ...
     (get temp___702 temp___701)) true)))))))
...
;; H
  ...
  (and
  (= (oeq2
     (model__ (mk___rep1 k__split_discrs my_maps__n__assign__target__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields5))) true)
  (= (length (mk___rep1 l__split_discrs l__split_fields5)) (length
                                                           (mk___rep1
                                                           k__split_discrs
                                                           my_maps__n__assign__target__fields))))
  (= (k_keys_included
     (keys (mk___rep1 k__split_discrs my_maps__n__assign__target__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields5))) true))
  (= (k_keys_included (keys (mk___rep1 l__split_discrs l__split_fields5))
     (keys (mk___rep1 k__split_discrs my_maps__n__assign__target__fields))) true)))
...
;; H
  ...
  (and
  (= (oeq2
     (model__ (mk___rep1 l__split_discrs my_maps__n__move__target__fields))
     (model__ (mk___rep1 k__split_discrs k__split_fields1))) true)
  (= (length (mk___rep1 k__split_discrs k__split_fields1)) (length
                                                           (mk___rep1
                                                           l__split_discrs
                                                           my_maps__n__move__target__fields))))
  (= (length (mk___rep1 k__split_discrs my_maps__n__move__source__fields)) 0))
  (= (k_keys_included
     (keys (mk___rep1 l__split_discrs my_maps__n__move__target__fields))
     (keys (mk___rep1 k__split_discrs k__split_fields1))) true))
  (= (k_keys_included (keys (mk___rep1 k__split_discrs k__split_fields1))
     (keys (mk___rep1 l__split_discrs my_maps__n__move__target__fields))) true)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields))
     o24) true)
  (= (get2
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields))
  ...
  (= (elements_equal_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields6)) o24) true))
  (and
  (and
  (and
  (and
  ...
  (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields6))
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields))) true))
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields6)) o24) true))
  (= (bool_eq
     ...
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields)
     o24))) o24) true))
  (= (mapping_preserved (keys (mk___rep1 l__split_discrs l__split_fields6))
     (keys
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields))
...
;; H
  ...
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields7))
     (mk___rep (mk___split_fields (of_rep1 3) (of_rep 3)))) true)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     o28) true)
  (= (get2
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     o28) 3))
  (ite (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields7))
          o28) true)
  (and
  (and
  (and
  ...
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     (positions (mk___rep1 l__split_discrs l__split_fields7))) true)
  (= (bool_eq
     (get
     (keys
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     ...
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1)
     o28))) o28) true))
  (= (equal_except (keys (mk___rep1 l__split_discrs l__split_fields7))
     (keys
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     (get1
     (positions
  ...
  (= (same_keys
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields7))) true))
  (= (elements_equal_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields7)) o28) true))
  (and
  (and
  (and
  (and
  ...
  (= (length
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1)) (+
  (length (mk___rep1 l__split_discrs l__split_fields7)) 1))
  (= (ole (model__ (mk___rep1 l__split_discrs l__split_fields7))
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))) true))
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields7)) o28) true))
  (= (bool_eq
     ...
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1)
     o28))) o28) true))
  (= (mapping_preserved (keys (mk___rep1 l__split_discrs l__split_fields7))
     (keys
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     (positions (mk___rep1 l__split_discrs l__split_fields7))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))) true))
  (= (keys_included_except1
     (positions
...
;; H
  ...
  (and
  (= (length
     (mk___rep1 l__split_discrs my_maps__n__delete__container__fields)) (-
  (length (mk___rep1 l__split_discrs l__split_fields8)) 1))
  (not
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs my_maps__n__delete__container__fields))
  ...
  (= (ole
     (model__
     (mk___rep1 l__split_discrs my_maps__n__delete__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields8))) true))
  (= (keys_included_except
     (model__ (mk___rep1 l__split_discrs l__split_fields8))
     (model__
     (mk___rep1 l__split_discrs my_maps__n__delete__container__fields))
     o32) true))
  (= (mapping_preserved
     (keys (mk___rep1 l__split_discrs my_maps__n__delete__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields8))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__delete__container__fields))
     (positions (mk___rep1 l__split_discrs l__split_fields8))) true))
  (= (keys_included_except1
     (positions (mk___rep1 l__split_discrs l__split_fields8))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__delete__container__fields))
     (find1 (mk___rep1 l__split_discrs l__split_fields8) o32)) true)))
...
;; H
  (assert
  (and
  (= temp___1115 (find1 (mk___rep1 l__split_discrs l__split_fields9) o36))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields9))
               o36) false) true false)
  (= (bool_eq2 temp___1115 no_element) true)
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1115) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1115) (find (keys (mk___rep1 l__split_discrs l__split_fields9))
                  o36)))
  (= (= (to_rep1
        (rec__my_maps__my_rec__f
        (us_split_fields1
        (key (mk___rep1 l__split_discrs l__split_fields9) temp___1115))))
  (to_rep1 (rec__my_maps__my_rec__f (us_split_fields1 o36)))) true)))))

;; H
  (assert (= result13 (mk___split_fields__ref2 c__split_fields3)))

;; H
  (assert (= c__split_fields4 (us_split_fields5 temp___1115)))
...
;; H
  ...
  (and
  (and
  (and (= (bool_eq2 (mk___rep2 c__split_fields5) no_element) true)
  (= (length
     (mk___rep1 l__split_discrs my_maps__n__delete__2__container__fields)) (-
  (length (mk___rep1 l__split_discrs l__split_fields9)) 1)))
  (not
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs my_maps__n__delete__2__container__fields))
     (key (mk___rep1 l__split_discrs l__split_fields9)
  ...
  (= (ole
     (model__
     (mk___rep1 l__split_discrs my_maps__n__delete__2__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields9))) true))
  (= (keys_included_except
     (model__ (mk___rep1 l__split_discrs l__split_fields9))
     (model__
     (mk___rep1 l__split_discrs my_maps__n__delete__2__container__fields))
  ...
  (= (mapping_preserved
     (keys
     (mk___rep1 l__split_discrs my_maps__n__delete__2__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields9))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__delete__2__container__fields))
     (positions (mk___rep1 l__split_discrs l__split_fields9))) true))
  (= (keys_included_except1
     (positions (mk___rep1 l__split_discrs l__split_fields9))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__delete__2__container__fields))
     (mk___rep2 c__split_fields4)) true)))
...
;; H
  (assert
  (not
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields10))
     (mk___rep (mk___split_fields (of_rep1 2) (of_rep 2)))) true)))

;; H
  (assert (= (to_rep o37) 2))

;; H
  (assert (= (to_rep1 o38) 2))

;; H
  (assert (= o39 (mk___split_fields o38 o37)))
...
;; H
  (assert
  (and
  (= temp___1117 (find1 (mk___rep1 l__split_discrs l__split_fields10) o40))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
               o40) false) true false)
  (= (bool_eq2 temp___1117 no_element) true)
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1117) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1117) (find (keys (mk___rep1 l__split_discrs l__split_fields10))
                  o40)))
  (= (= (to_rep1
        (rec__my_maps__my_rec__f
        (us_split_fields1
        (key (mk___rep1 l__split_discrs l__split_fields10) temp___1117))))
  (to_rep1 (rec__my_maps__my_rec__f (us_split_fields1 o40)))) true)))))

;; H
  (assert (= result15 (mk___split_fields__ref2 c__split_fields5)))

;; H
  (assert (= c__split_fields6 (us_split_fields5 temp___1117)))

;; H
  (assert (= (to_rep o41) 2))

;; H
  (assert (= (to_rep1 o42) 2))

;; H
  (assert (= o43 (mk___split_fields o42 o41)))

;; H
  (assert (= o44 (mk___rep o43)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     o44) true))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
               o44) false) true false)
  (and
  (and
  (= (oeq2
     (model__
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields10))) true)
  (= (oeq3
     (keys
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields10))) true))
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (positions (mk___rep1 l__split_discrs l__split_fields10))) true))
  (and
  (and
  (and
  (and
  (= (length
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields)) (-
  (length (mk___rep1 l__split_discrs l__split_fields10)) 1))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields10))) true))
  ...
  (= (mapping_preserved
     (keys
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (keys (mk___rep1 l__split_discrs l__split_fields10))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (positions (mk___rep1 l__split_discrs l__split_fields10))) true))
  (= (keys_included_except1
     (positions (mk___rep1 l__split_discrs l__split_fields10))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (find1 (mk___rep1 l__split_discrs l__split_fields10) o44)) true)))))
...
;; H
  (assert
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields11))
     (mk___rep (mk___split_fields (of_rep1 1) (of_rep 1)))) true))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     o48) true))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields11))
               o48) false) true false)
  (and
  (and
  (= (oeq2
     (model__
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields11))) true)
  (= (oeq3
     (keys
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (keys (mk___rep1 l__split_discrs l__split_fields11))) true))
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (positions (mk___rep1 l__split_discrs l__split_fields11))) true))
  (and
  (and
  (and
  (and
  (= (length
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1)) (-
  (length (mk___rep1 l__split_discrs l__split_fields11)) 1))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields11))) true))
  ...
  (= (mapping_preserved
     (keys
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (keys (mk___rep1 l__split_discrs l__split_fields11))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (positions (mk___rep1 l__split_discrs l__split_fields11))) true))
  (= (keys_included_except1
     (positions (mk___rep1 l__split_discrs l__split_fields11))
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (find1 (mk___rep1 l__split_discrs l__split_fields11) o48)) true)))))

;; H
  (assert (= result17 (mk___split_fields__ref1 l__split_fields11)))
...
;; WP_parameter_def
 ;; File "my_maps.adb", line 4, characters 0-0
  (not (not (= (length (mk___rep1 l__split_discrs l__split_fields12)) 0))))
(check-sat)
(exit)
