...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields9))
     (last1 (mk___rep l__split_discrs l__split_fields9))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields9)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields10))
     (last1 (mk___rep l__split_discrs l__split_fields9))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields10))
     (positions (mk___rep l__split_discrs l__split_fields9))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields9))
     (length (mk___rep l__split_discrs l__split_fields9))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields10))
     (model__ (mk___rep l__split_discrs l__split_fields9))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields10))
     (model__ (mk___rep l__split_discrs l__split_fields9)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields10)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields10))
     (model__ (mk___rep l__split_discrs l__split_fields9))
     (get1 (positions (mk___rep l__split_discrs l__split_fields10)) cu)
     (length (mk___rep l__split_discrs l__split_fields10)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields9))
     (get1 (positions (mk___rep l__split_discrs l__split_fields10)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields10))
     (positions (mk___rep l__split_discrs l__split_fields9))
     (get1 (positions (mk___rep l__split_discrs l__split_fields10)) cu) 1) true)))))
...
;; H
  (assert
  (and
  (= (length (mk___rep l__split_discrs l__split_fields8)) (+ (length
                                                             (mk___rep
                                                             l__split_discrs
                                                             l__split_fields9)) 1))
  (ite (= (bool_eq1 cu no_element) true)
  ...
  (and
  (and
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields8))
     (last1 (mk___rep l__split_discrs l__split_fields8))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields8)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields9))
     (last1 (mk___rep l__split_discrs l__split_fields8))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields9))
     (positions (mk___rep l__split_discrs l__split_fields8))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields8))
     (length (mk___rep l__split_discrs l__split_fields8))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields9))
     (model__ (mk___rep l__split_discrs l__split_fields8))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields9))
     (model__ (mk___rep l__split_discrs l__split_fields8)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields9)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields9))
     (model__ (mk___rep l__split_discrs l__split_fields8))
     (get1 (positions (mk___rep l__split_discrs l__split_fields9)) cu)
     (length (mk___rep l__split_discrs l__split_fields9)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields8))
     (get1 (positions (mk___rep l__split_discrs l__split_fields9)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields9))
     (positions (mk___rep l__split_discrs l__split_fields8))
     (get1 (positions (mk___rep l__split_discrs l__split_fields9)) cu) 1) true)))))
...
;; H
  (assert
  (and
  (= (length (mk___rep l__split_discrs l__split_fields7)) (+ (length
                                                             (mk___rep
                                                             l__split_discrs
                                                             l__split_fields8)) 1))
  (ite (= (bool_eq1 cu no_element) true)
  ...
  (and
  (and
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields7))
     (last1 (mk___rep l__split_discrs l__split_fields7))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields7)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields8))
     (last1 (mk___rep l__split_discrs l__split_fields7))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields8))
     (positions (mk___rep l__split_discrs l__split_fields7))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields7))
     (length (mk___rep l__split_discrs l__split_fields7))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields8))
     (model__ (mk___rep l__split_discrs l__split_fields7))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields8))
     (model__ (mk___rep l__split_discrs l__split_fields7)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields8)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields8))
     (model__ (mk___rep l__split_discrs l__split_fields7))
     (get1 (positions (mk___rep l__split_discrs l__split_fields8)) cu)
     (length (mk___rep l__split_discrs l__split_fields8)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields7))
     (get1 (positions (mk___rep l__split_discrs l__split_fields8)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields8))
     (positions (mk___rep l__split_discrs l__split_fields7))
     (get1 (positions (mk___rep l__split_discrs l__split_fields8)) cu) 1) true)))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields6))
     (last1 (mk___rep l__split_discrs l__split_fields6))) (length
                                                          (mk___rep
                                                          l__split_discrs
                                                          l__split_fields6)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields7))
     (last1 (mk___rep l__split_discrs l__split_fields6))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields7))
     (positions (mk___rep l__split_discrs l__split_fields6))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields6))
     (length (mk___rep l__split_discrs l__split_fields6))) 0))
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields7))
     ...
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields7)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields7))
     (model__ (mk___rep l__split_discrs l__split_fields6))
     (get1 (positions (mk___rep l__split_discrs l__split_fields7)) cu)
     (length (mk___rep l__split_discrs l__split_fields7)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields6))
     (get1 (positions (mk___rep l__split_discrs l__split_fields7)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields7))
     (positions (mk___rep l__split_discrs l__split_fields6))
     (get1 (positions (mk___rep l__split_discrs l__split_fields7)) cu) 1) true)))))
