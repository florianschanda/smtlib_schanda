...
(declare-fun dummy2 () descriptioni)
...
(declare-fun dummy10 () privileget)
...
(declare-fun dummy16 () millisecst)
...
(define-fun us_split_fields_ID6__projection ((a us_split_fields8)) us_rep1
  (rec__cert__attr__priv__contentst__id a))

(define-fun us_split_fields_NotBefore4__projection ((a us_split_fields8)) us_rep3
  (rec__cert__attr__priv__contentst__notbefore a))

(define-fun us_split_fields_NotAfter4__projection ((a us_split_fields8)) us_rep3
  (rec__cert__attr__priv__contentst__notafter a))

(define-fun us_split_fields_Mechanism4__projection ((a us_split_fields8)) algorithmt
...
(define-fun contentst__ref_4__projection ((a contentst__ref)) us_rep4
...
(declare-fun dummy21 () (Array Int bytet))
...
(declare-fun dummy22 () templatelengtht)
...
(declare-fun dummy23 () (Array Int character))
...
(define-fun us_split_fields_ID2__projection ((a us_split_fields10)) (Array Int character)
...
(declare-fun iandatypes__templatet__length__first__bit () Int)

(declare-fun iandatypes__templatet__length__last__bit () Int)

(declare-fun iandatypes__templatet__length__position () Int)
...
(declare-fun iandatypes__templatet__requiredmaxfar__first__bit () Int)

(declare-fun iandatypes__templatet__requiredmaxfar__last__bit () Int)

(declare-fun iandatypes__templatet__requiredmaxfar__position () Int)
...
(declare-fun iandatypes__templatet__id__first__bit () Int)

(declare-fun iandatypes__templatet__id__last__bit () Int)

(declare-fun iandatypes__templatet__id__position () Int)
...
(declare-fun iandatypes__templatet__pad__first__bit () Int)

(declare-fun iandatypes__templatet__pad__last__bit () Int)

(declare-fun iandatypes__templatet__pad__position () Int)
...
(define-fun us_split_fields_ID8__projection ((a us_split_fields12)) us_rep1
  (rec__cert__attr__ianda__contentst__id a))

(define-fun us_split_fields_NotBefore6__projection ((a us_split_fields12)) us_rep3
  (rec__cert__attr__ianda__contentst__notbefore a))

(define-fun us_split_fields_NotAfter6__projection ((a us_split_fields12)) us_rep3
  (rec__cert__attr__ianda__contentst__notafter a))

(define-fun us_split_fields_Mechanism6__projection ((a us_split_fields12)) algorithmt
  (rec__cert__attr__ianda__contentst__mechanism a))

(define-fun us_split_fields_BaseCertID4__projection ((a us_split_fields12)) us_rep1
...
(define-fun us_split_fields__ref_15__projection ((a us_split_fields__ref6)) us_split_fields12
  (us_split_fields__content6 a))

(declare-datatypes ()
((us_rep6 (mk___rep6 (us_split_fields13 us_split_fields12)))))
(define-fun us_rep_16__projection ((a us_rep6)) us_split_fields12 (us_split_fields13
                                                                  a))
...
(declare-fun cert__attr__ianda__contentst__id__first__bit () Int)

(declare-fun cert__attr__ianda__contentst__id__last__bit () Int)

(declare-fun cert__attr__ianda__contentst__id__position () Int)
...
(declare-fun cert__attr__ianda__contentst__notbefore__first__bit () Int)

(declare-fun cert__attr__ianda__contentst__notbefore__last__bit () Int)

(declare-fun cert__attr__ianda__contentst__notbefore__position () Int)
...
(declare-fun cert__attr__ianda__contentst__notafter__first__bit () Int)

(declare-fun cert__attr__ianda__contentst__notafter__last__bit () Int)

(declare-fun cert__attr__ianda__contentst__notafter__position () Int)
...
(declare-fun cert__attr__ianda__contentst__mechanism__first__bit () Int)

(declare-fun cert__attr__ianda__contentst__mechanism__last__bit () Int)

(declare-fun cert__attr__ianda__contentst__mechanism__position () Int)
...
(declare-fun cert__attr__ianda__contentst__basecertid__first__bit () Int)

(declare-fun cert__attr__ianda__contentst__basecertid__last__bit () Int)

(declare-fun cert__attr__ianda__contentst__basecertid__position () Int)
...
(declare-fun cert__attr__ianda__contentst__template__first__bit () Int)

(declare-fun cert__attr__ianda__contentst__template__last__bit () Int)

(declare-fun cert__attr__ianda__contentst__template__position () Int)
...
(declare-fun dummy25 () us_rep6)

(declare-datatypes ()
((contentst__ref1 (mk_contentst__ref1 (contentst__content1 us_rep6)))))
(define-fun contentst__ref_6__projection ((a contentst__ref1)) us_rep6
...
(declare-fun dummy27 () keylengtht)
...
(define-fun us_split_fields_ID4__projection ((a us_split_fields16)) us_rep1
  (rec__cert__id__contentst__id a))

(define-fun us_split_fields_NotBefore2__projection ((a us_split_fields16)) us_rep3
  (rec__cert__id__contentst__notbefore a))

(define-fun us_split_fields_NotAfter2__projection ((a us_split_fields16)) us_rep3
  (rec__cert__id__contentst__notafter a))

(define-fun us_split_fields_Mechanism2__projection ((a us_split_fields16)) algorithmt
...
(define-fun us_split_fields__ref_11__projection ((a us_split_fields__ref8)) us_split_fields16
  (us_split_fields__content8 a))

(declare-datatypes ()
((us_rep8 (mk___rep8 (us_split_fields17 us_split_fields16)))))
(define-fun us_rep_12__projection ((a us_rep8)) us_split_fields16 (us_split_fields17
                                                                  a))
...
(declare-fun dummy29 () us_rep8)

(declare-datatypes ()
((contentst__ref2 (mk_contentst__ref2 (contentst__content2 us_rep8)))))
(define-fun contentst__ref_2__projection ((a contentst__ref2)) us_rep8
...
(declare-fun dummy30 () certificatestatus)
...
(define-fun us_split_fields_Valid4__projection ((a us_split_fields20)) Bool
  (rec__usertoken__validiandacertt__valid a))

(define-fun us_split_fields_Contents4__projection ((a us_split_fields20)) us_rep6
...
(define-fun us_split_fields__ref_27__projection ((a us_split_fields__ref10)) us_split_fields20
  (us_split_fields__content10 a))

(declare-datatypes ()
((us_rep10 (mk___rep10 (us_split_fields21 us_split_fields20)))))
(define-fun us_rep_28__projection ((a us_rep10)) us_split_fields20 (us_split_fields21
                                                                   a))
...
(declare-fun usertoken__validiandacertt__valid__first__bit () Int)

(declare-fun usertoken__validiandacertt__valid__last__bit () Int)

(declare-fun usertoken__validiandacertt__valid__position () Int)
...
(declare-fun usertoken__validiandacertt__contents__first__bit () Int)

(declare-fun usertoken__validiandacertt__contents__last__bit () Int)

(declare-fun usertoken__validiandacertt__contents__position () Int)
...
(define-fun us_split_fields_Contents2__projection ((a us_split_fields22)) us_rep4
...
(declare-fun c88b () (Array Int character))
