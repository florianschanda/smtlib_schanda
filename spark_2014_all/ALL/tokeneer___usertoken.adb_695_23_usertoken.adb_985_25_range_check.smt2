...
(declare-datatypes ((templatelengtht__ref 0))
...
(declare-datatypes ((templatet__ref 0))
(((mk_templatet__ref (templatet__content us_rep5)))))
...
(((mk_contentst__ref2 (contentst__content2 us_rep8)))))
...
(declare-datatypes ((validiandacertt__ref 0))
