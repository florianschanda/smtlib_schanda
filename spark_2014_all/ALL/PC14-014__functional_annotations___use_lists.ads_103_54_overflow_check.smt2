...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o6 j) true)
  (=> (= (get1 o6 i1) (get1 o6 j)) (= (bool_eq1 i1 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o10)
  (=> (= (of_int 0) true)
  (and (= o10 (w_get o6 (witness o6 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o6 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o6 cu) (witness o6 k))))))))))
...
;; H
  (assert
  (and (= o5 (has_key o4 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o4 k) true) (= (bool_eq1 k cu) true))) (= o5 true)))))
