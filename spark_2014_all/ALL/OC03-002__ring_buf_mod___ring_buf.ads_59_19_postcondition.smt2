...
;; to_model__post_axiom
  (assert
  (forall ((r us_rep)) (! (dynamic_invariant (to_model r) true false
...
(declare-fun temp___267 (Int) (Array (_ BitVec 16) integer))

;; def_axiom
  (assert
  (forall ((temp___269 Int))
  (forall ((temp___270 (_ BitVec 16)))
  (= (select (temp___267 temp___269) temp___270) (of_rep2 temp___269)))))
...
(declare-const temp___264 (Array (_ BitVec 16) integer))

(declare-const temp___2641 ar_index)

(declare-const temp___2642 length_type)

(declare-const o4 ar_index)

(declare-const o5 (Array (_ BitVec 16) integer))

(declare-const o6 ar_index)

(declare-const o7 length_type)

(declare-const temp___266 (Array (_ BitVec 16) integer))

(declare-const temp___2661 ar_index)

(declare-const temp___2662 length_type)

(declare-const result (Array (_ BitVec 16) integer))

(declare-const result1 ar_index)
...
(declare-const result3 (Array (_ BitVec 16) integer))

(declare-const result4 ar_index)

(declare-const result5 length_type)
...
(declare-const result6 (Array (_ BitVec 16) integer))

(declare-const result7 ar_index)

(declare-const result8 length_type)
...
(declare-const r__split_fields15 (Array (_ BitVec 16) integer))

(declare-const r__split_fields16 ar_index)

(declare-const r__split_fields17 length_type)
...
;; H
  (assert (= temp___264 r__split_fields3))

;; H
  (assert (= temp___2641 r__split_fields4))

;; H
  (assert (= temp___2642 r__split_fields5))
...
;; H
  (assert (= temp___266 o5))

;; H
  (assert (= temp___2661 o6))

;; H
  (assert (= temp___2662 o7))
...
;; H
  (assert (= temp___266 r__split_fields6))

;; H
  (assert (= temp___2661 r__split_fields7))

;; H
  (assert (= temp___2662 r__split_fields8))
...
;; H
  (assert (= (temp___267 0) r__split_fields9))
...
;; WP_parameter_def
 ;; File "ring_buf.ads", line 56, characters 0-0
  (not
  (= (let ((temp___276 (to_model
                       (mk___rep
                       (mk___split_fields r__split_fields12 r__split_fields13
                       r__split_fields14)))))
     (bool_eq (elts temp___276) (to_rep (first (rt temp___276)))
     (to_rep (last (rt temp___276))) (temp___219 0) ((_ int2bv 16) 1)
     ((_ int2bv 16) 0))) true)))
(check-sat)
(exit)
