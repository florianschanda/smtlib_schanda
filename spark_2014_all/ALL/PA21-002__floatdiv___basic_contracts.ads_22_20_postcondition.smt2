...
(declare-fun basic_contracts__average_orig__result () t)
...
(declare-fun basic_contracts__average_orig__result1 () t)

(declare-fun basic_contracts__average_orig__result2 () t)

(declare-fun basic_contracts__average_orig__result3 () t)

(declare-fun res2 () t)

(declare-fun basic_contracts__average_orig__result4 () t)

(declare-fun res3 () t)

(declare-fun basic_contracts__average_orig__result5 () t)
...
;; H
  (assert (le fliteral (of_int RNE1 denominator)))

;; H
  (assert
  (and (= o (div1 RNE1 (of_int RNE1 numerator) (of_int RNE1 denominator)))
  (tqtisFinite
  (div1 RNE1 (of_int RNE1 numerator) (of_int RNE1 denominator)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (le fliteral2 basic_contracts__average_orig__result4)))
(check-sat)
