...
(declare-fun logging__log_type__log_data__first__bit () Int)

(declare-fun logging__log_type__log_data__last__bit () Int)

(declare-fun logging__log_type__log_data__position () Int)
...
(declare-fun logging__log_type__log_size__first__bit () Int)

(declare-fun logging__log_type__log_size__last__bit () Int)

(declare-fun logging__log_type__log_size__position () Int)
...
(declare-datatypes ()
((log_type__ref (mk_log_type__ref (log_type__content us_rep)))))
...
(declare-fun log__attr__tag () Int)
...
;; log_size__def_axiom
  ...
  (! (= (log_size log) (to_rep
                       (rec__logging__log_type__log_size
                       (us_split_fields1 log)))) :pattern ((log_size log)) )))

(declare-fun log__split_fields () (Array Int integer))

(declare-fun log__split_fields1 () log_count)

(declare-fun log__split_fields2 () us_private)

(define-fun log__split_fields3 () us_split_fields (mk___split_fields
                                                  log__split_fields
                                                  log__split_fields1
                                                  log__split_fields2))

;; H
  (assert (= (log_size (mk___rep log__split_fields3 log__attr__tag)) 0))

(assert
;; WP_parameter_def
 ;; File "use_logging.adb", line 3, characters 0-0
  (not (< (log_size (mk___rep log__split_fields3 log__attr__tag)) 10000)))
(check-sat)
(exit)
