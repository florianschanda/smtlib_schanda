...
(declare-fun o44 () (_ BitVec 16))

(declare-fun o45 () (_ BitVec 8))

(declare-fun o46 () octet)
...
;; WP_parameter_def
 ;; File "very_longs.adb", line 418, characters 0-0
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1328)))
(check-sat)
(exit)
