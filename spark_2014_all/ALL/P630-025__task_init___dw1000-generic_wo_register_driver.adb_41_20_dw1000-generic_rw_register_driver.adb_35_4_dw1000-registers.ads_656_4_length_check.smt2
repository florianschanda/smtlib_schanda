...
(define-fun us_split_fields_Reserved_1__15__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__diag_tmc_type__reserved_1 a))

(define-fun us_split_fields_Reserved_2__15__projection ((a us_split_fields)) bits_11
  (rec__dw1000__register_types__diag_tmc_type__reserved_2 a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___100__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___100__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                  a))
...
(declare-datatypes ((diag_tmc_type__ref 0))
(((mk_diag_tmc_type__ref (diag_tmc_type__content us_rep)))))
...
(define-fun register_type__ref___227__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___163__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___163__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7251 us_t1)
  (temp___is_init_7248 Bool) (temp___skip_constant_7249 Bool)
  (temp___do_toplevel_7250 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7249 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_7251)
                                       (last3 temp___expr_7251))
                                       (and (= (first3 temp___expr_7251) 1)
                                       (= (last3 temp___expr_7251) 2)))))
...
(define-fun target__ref___65__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___65__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_7269 us_t2)
  (temp___is_init_7266 Bool) (temp___skip_constant_7267 Bool)
  (temp___do_toplevel_7268 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7267 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_7269)
                                       (last5 temp___expr_7269))
                                       (and (= (first5 temp___expr_7269) 1)
                                       (= (last5 temp___expr_7269) 2)))))
...
;; H
  (assert
  (and (= temp___82132 (register_to_bytes reg)) (dynamic_invariant1
  temp___82132 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___82131)) (to_rep (last4 temp___82131)))
     (+ (- (to_rep (last4 temp___82131)) (to_rep (first4 temp___82131))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
