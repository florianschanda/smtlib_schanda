...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o14) true))
  (= (bool_eq2
     (get
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o14)) o14) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o14) 1))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (keys
        (mk___rep1 l__split_discrs
        my_ordered_maps__n__insert__2__container__fields)) o14) 1)) true))
  (= (range_shifted
     (keys (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (keys
     (mk___rep1 l__split_discrs
     ...
     (keys
     (mk___rep1 l__split_discrs
     my_ordered_maps__n__insert__2__container__fields)) o14)
     (length
...
;; WP_parameter_def
 ;; File "my_ordered_maps.adb", line 4, characters 0-0
  (not
  (< (length (mk___rep1 l__split_discrs l__split_fields1)) (to_rep1
                                                           (rec__my_ordered_maps__n__map__capacity
                                                           l__split_discrs)))))
(check-sat)
