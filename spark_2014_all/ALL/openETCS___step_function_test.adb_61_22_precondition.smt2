...
;; H
  (assert
  (and (= o108 (get_value (mk___rep1 sfun4__split_fields2) i1))
  (and (not (or (fp.isInfinite o108) (fp.isNaN o108)))
  (or
  (exists ((i2 Int))
  (and
  (and (<= 0 i2)
...
;; H
  (assert
  (and (= o107 (get_value (mk___rep1 sfun3__split_fields2) i1))
...
;; H
  (assert
  (and (= o109 (min o107 o108))
  (and (not (or (fp.isInfinite o109) (fp.isNaN o109)))
  (ite (fp.leq o107 o108) (fp.eq o109 o107) (fp.eq o109 o108)))))
