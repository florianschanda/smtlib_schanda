...
;; H
  (assert (= result3 a__ppcm__result4))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (or
  (or (= a__ppcm__result4 0)
  (and (<= (abs a) a__ppcm__result4) (<= a__ppcm__result4 (abs (* a b)))))
  (and (<= (abs b) a__ppcm__result4) (<= a__ppcm__result4 (abs (* a b)))))))
(check-sat)
