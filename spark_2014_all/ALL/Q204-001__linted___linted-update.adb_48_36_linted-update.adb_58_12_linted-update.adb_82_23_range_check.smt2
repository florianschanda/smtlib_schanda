...
(declare-const o68 storage_element)
...
(declare-const o72 storage_element)
...
;; H
  (assert (= o72 (select temp___429 1)))

;; H
  (assert (= o73 (to_rep o72)))

;; H
  (assert (= o74 ((_ zero_extend 24) o73)))

;; H
  (assert (= o75 (bvshl o74 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o68 (select temp___425 2)))

;; H
  (assert (= o69 (to_rep o68)))

;; H
  (assert (= o70 ((_ zero_extend 24) o69)))

;; H
  (assert (= o71 (bvshl o70 ((_ int2bv 32) 16))))
...
;; H
  (assert (= o64 (select temp___421 3)))
...
;; H
  (assert (= o67 (bvshl o66 ((_ int2bv 32) 8))))
