...
(define-fun dynamic_invariant1 ((temp___expr_189 t) (temp___is_init_186 Bool)
  (temp___skip_constant_187 Bool)
  (temp___do_toplevel_188 Bool)) Bool (=>
                                      (or (= temp___is_init_186 true) (le
                                      (neg fliteral2) fliteral2))
                                      (tqtisFinite temp___expr_189)))

(declare-fun to_fp1 ((_ BitVec 32)) t)

(declare-fun to_fp__function_guard (t (_ BitVec 32)) Bool)
...
;; H
  (assert (= (to_rep o1) fliteral1))

;; H
  (assert (and (= o (to_fp1 ((_ int2bv 32) 2139094902))) (tqtisFinite o)))
...
;; H
  (assert (and (= o5 (to_fp1 ((_ int2bv 32) 4144594944))) (tqtisFinite o5)))

;; H
  (assert (lt fliteral1 o5))

(assert
;; WP_parameter_def
 ;; File "a-unccon.ads", line 20, characters 0-0
  (not (le (add RNE1 (neg fliteral2) o5) (to_rep x__split_fields2))))
(check-sat)
