...
;; H
  (assert
  (= o10 (select (rec__patience__state__preds (us_split_fields1 s)) o9)))
...
;; H
  (assert
  (= o7 (select (rec__patience__state__preds (us_split_fields1 s)) o6)))

;; H
  (assert (= o8 (to_rep1 o7)))

;; H
  (assert (= o13 (ite (<= (- 1) o8) true false)))
...
;; H
  (assert (=> (= result6 true) (= o5 (to_rep1 o4))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (< o5 i) true false))))
