...
(declare-fun temp___4167 ((Array Int us_rep2) Int us_rep2 Int
  us_rep2) (Array Int us_rep2))

;; def_axiom
  (assert
  (forall ((temp___4169 (Array Int us_rep2)))
  (forall ((temp___4170 Int) (temp___4172 Int))
  (forall ((temp___4171 us_rep2) (temp___4173 us_rep2))
  (let ((temp___4168 (temp___4167 temp___4169 temp___4170 temp___4171
                     temp___4172 temp___4173)))
  (forall ((temp___4174 Int))
  (ite (= temp___4174 temp___4172)
  (= (select temp___4168 temp___4174) temp___4173)
  (ite (= temp___4174 temp___4170)
  (= (select temp___4168 temp___4174) temp___4171)
  (= (select temp___4168 temp___4174) (select temp___4169 temp___4174))))))))))
...
(declare-fun temp___9827 () us_rep3)

(declare-fun o29 () it4)

(declare-fun o30 () us_split_fields6)

(declare-fun temp___9829 () us_rep3)
...
(declare-fun temp___9838 () us_rep3)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1838, characters 0-0
  (not
  (= (bool_eq4 (mk___rep3 (us_split_fields__content3 r__split_fields5))
     (mk___rep3
     (mk___split_fields3 (of_rep i)
     (temp___4167 r__split_fields1 i
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1
     ...
     (us_split_fields1
     (rec__ar__rec5t__h5
     (us_split_fields5 (select r__split_fields1 (to_rep r__split_fields)))))))))))))) true)))
(check-sat)
(exit)
