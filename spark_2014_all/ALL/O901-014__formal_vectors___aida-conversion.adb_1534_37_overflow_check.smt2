...
;; H
  (assert
  (and (= o8 (+ (to_rep1 (first (rt source))) 6)) (in_range1
...
;; H
  ...
  (forall ((index1 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 6) index1)
  (<= index1 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index1))) true)))))

;; H
  (assert
  (and (= temp___1971 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1971)
  (<= temp___1971 (to_rep1 (last (rt source))))))

;; H
  (assert (= o4 temp___1971))
...
;; H
  (assert
  (and (= temp___1970 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1970)
  (<= temp___1970 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1970))
