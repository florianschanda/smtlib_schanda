...
;; H
  (assert
  (= (mk___split_fields result____split_fields1) amortized_queue__my_vectors__append__2__container__fields1))

;; H
  (assert
  (= (length (mk___rep result____split_discrs result____split_fields3))
  idx2))
...
;; H
  (assert
  (and (= o5 (get (model__ left) o4))
  (and (in_range6 o5) (= o5 (get (model__ left) o4)))))
