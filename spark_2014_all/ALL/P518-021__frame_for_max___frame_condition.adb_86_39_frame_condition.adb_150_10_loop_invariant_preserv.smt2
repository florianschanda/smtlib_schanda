...
;; H
  (assert
  (= (frame_right (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true))
...
;; H
  (assert
  (=> (= result8 true)
  (= (mk___rep (mk___split_fields o38 o39 o40)) (select a2 o37))))
...
;; H
  (assert
  (= (rec__frame_condition__cell__value
     (us_split_fields1 (select a2 c267b3))) o47))

;; H
  (assert
  (= (rec__frame_condition__cell__max_left
     (us_split_fields1 (select a2 c267b3))) o48))
