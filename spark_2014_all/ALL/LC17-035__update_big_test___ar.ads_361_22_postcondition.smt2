...
(declare-fun temp___1181 ((Array Int (Array Int et1)) Int (Array Int et1) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___1183 (Array Int (Array Int et1))))
  (forall ((temp___1184 Int) (temp___1186 Int))
  (forall ((temp___1185 (Array Int et1)) (temp___1187 (Array Int et1)))
  (let ((temp___1182 (temp___1181 temp___1183 temp___1184 temp___1185
                     temp___1186 temp___1187)))
  (forall ((temp___1188 Int))
  (ite (= temp___1188 temp___1186)
  (= (select temp___1182 temp___1188) temp___1187)
  (ite (= temp___1188 temp___1184)
  (= (select temp___1182 temp___1188) temp___1185)
  (= (select temp___1182 temp___1188) (select temp___1183 temp___1188))))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 352, characters 0-0
  (not (= (bool_eq1 a3 5 50 (temp___1181 a i b j c) 5 50) true)))
(check-sat)
(exit)
