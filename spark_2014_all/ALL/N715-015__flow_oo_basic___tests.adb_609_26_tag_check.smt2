...
(declare-fun f__split_fields () integer)

(declare-fun f__split_fields1 () integer)

(declare-fun f__split_fields2 () us_private)

(declare-fun g__split_fields () integer)

(declare-fun g__split_fields1 () integer)

(declare-fun g__split_fields2 () us_private)
...
(declare-fun f__split_fields3 () us_split_fields2)

(declare-fun result6 () us_split_fields__ref1)

(declare-fun g__split_fields3 () us_split_fields2)
...
;; H
  ...
  (= result5 (mk___split_fields__ref1
             (mk___split_fields1 f__split_fields f__split_fields1
             f__split_fields2))))
...
;; H
  ...
  (= g__attr__tag (attr__tag1
                  ...
                  (rec__foo__nice_widget_t__round
                  (us_split_fields5
                  (rec__tests__pair__b (us_split_fields7 c))))
                  (rec__foo__widget_t__x1
                  (us_split_fields5
                  (rec__tests__pair__b (us_split_fields7 c))))
                  (rec__foo__widget_t__y1
                  ...
                  (us_split_fields5
                  (rec__tests__pair__b (us_split_fields7 c))))))
                  (attr__tag2 (rec__tests__pair__b (us_split_fields7 c))))))))
...
;; H
  ...
  (= usq_5 (of_base
           ...
           (hide_ext__1
           (rec__foo__nice_widget_t__round
           (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c))))
           (rec__foo__widget_t__x1
           (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c))))
           (rec__foo__widget_t__y1
           (us_split_fields5 (rec__tests__pair__b (us_split_fields7 c))))
...
;; H
  (assert (= temp___455 (mk___rep1 (us_split_fields3 usq_5) g__attr__tag)))

;; H
  (assert
  (= result6 (mk___split_fields__ref1
             (mk___split_fields1 g__split_fields g__split_fields1
             g__split_fields2))))

;; H
  (assert (= g__split_fields3 (us_split_fields3 temp___455)))

(assert
;; WP_parameter_def
 ;; File "tests.adb", line 573, characters 0-0
  (not
  (= h__attr__tag (attr__tag1
                  (of_base
                  (mk___rep
                  (mk___split_fields
                  (hide_ext__1
                  (rec__foo__nice_widget_t__round (us_split_fields5 nw))
                  (rec__foo__widget_t__x1 (us_split_fields5 nw))
                  (rec__foo__widget_t__y1 (us_split_fields5 nw))
                  (rec__ext__2 (us_split_fields5 nw)))) (attr__tag2 nw)))))))
(check-sat)
