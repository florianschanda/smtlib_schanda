...
(declare-fun variable_constant () Bool)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun ordinary_constant () Bool)
...
(declare-fun var () us_private)

(declare-fun main__variable_constant__assume () Bool)

(declare-fun main__ordinary_constant__assume () Bool)
