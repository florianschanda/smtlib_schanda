...
(declare-fun arrays__contains_b__result () Bool)

(declare-fun result () Bool)

(declare-fun arrays__contains_b__result1 () Bool)

(declare-fun arrays__contains_b__result2 () Bool)

(declare-fun arrays__contains_b__result3 () Bool)

(declare-fun arrays__contains_b__result4 () Bool)

(declare-fun arrays__contains_b__result5 () Bool)
...
;; H
  (assert
  (= (mk_bool__ref arrays__contains_b__result4) (mk_bool__ref
                                                arrays__contains_b__result2)))
...
(assert
;; WP_parameter_def
 ;; File "arrays.adb", line 57, characters 0-0
  (not (= (select s c) true)))
(check-sat)
(exit)
