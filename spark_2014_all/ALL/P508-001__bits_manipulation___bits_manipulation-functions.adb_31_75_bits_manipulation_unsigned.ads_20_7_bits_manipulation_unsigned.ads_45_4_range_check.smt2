...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__len__assume () Int)

(declare-fun o () Int)

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__mask__assume () (_ BitVec 64))
...
(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result2 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result3 () (_ BitVec 64))

(declare-fun result__2 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4 () (_ BitVec 64))

(declare-fun result__3 () (_ BitVec 64))

(declare-fun bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result5 () (_ BitVec 64))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result1
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result5
  bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result3))
...
;; H
  (assert
  (and (= o6 (make_mask o5))
  (= o6 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o5)))))

;; H
  (assert
  (and (= o7 (shift_right value from))
  (= o7 (ite (and (<= 1 64) (<= 64 8))
        ((_ zero_extend 56) (ite (< from 8)
                            (bvlshr ((_ extract 7 0) value) ((_ int2bv 8)
                            from)) ((_ int2bv 8) 0)))
        (ite (and (<= 9 64) (<= 64 16))
...
;; H
  (assert
  (= result2 (ite (= bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4
             o8) true false)))
...
;; H
  (assert
  (and (= o4 (make_mask o3))
  (= o4 (shift_right ((_ int2bv 64) 18446744073709551615) (- 64 o3)))))

;; H
  (assert
  (= result3 (ite (bvule bits_manipulation_unsigned__unsigned_64__functions__extract_bits_inline_always__result4
             o4) true false)))
