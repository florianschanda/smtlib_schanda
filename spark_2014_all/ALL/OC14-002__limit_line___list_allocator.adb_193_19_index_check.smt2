...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o55) true false))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o54 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o54)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o54 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o52) true false)))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o51 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o51))))))
...
;; H
  ...
  (=> (not (= first_allocated1 0))
  (=> (= result14 true)
  (= result11 (ite (= o51 first_allocated1) true false))))))
