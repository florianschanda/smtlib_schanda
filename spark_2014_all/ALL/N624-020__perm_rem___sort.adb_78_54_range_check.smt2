...
;; H
  (assert (and (= o16 (- y 1)) (in_range5 (- y 1))))
...
;; H
  (assert
  (and (= o17 (remove o15 o16))
  (and (dynamic_invariant4 o17 true false true)
  (and (= (invariant__ o17) true)
  (and (= (to_rep1 (last (rt o17))) (- (to_rep1 (last (rt o15))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o16 1)))
