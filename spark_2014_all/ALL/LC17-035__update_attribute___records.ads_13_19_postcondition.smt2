...
(declare-fun temp___205 () integer)

(declare-fun temp___2051 () natural)

(declare-fun temp___2052 () my_range)

(declare-fun temp___2053 () integer)
...
(declare-fun temp___207 () integer)

(declare-fun temp___2071 () natural)

(declare-fun temp___2072 () my_range)

(declare-fun temp___2073 () integer)
...
(declare-fun temp___2091 () natural)

(declare-fun temp___2092 () my_range)

(declare-fun temp___2093 () integer)

(declare-fun o15 () my_range)

(declare-fun o16 () integer)

(declare-fun o17 () natural)

(declare-fun o18 () my_range)
...
(declare-fun temp___2112 () my_range)
...
(declare-fun r__split_fields12 () us_split_fields)

(declare-fun result12 () us_split_fields__ref)

(declare-fun r__split_fields13 () us_split_fields)

(declare-fun r__split_fields14 () us_split_fields__ref)
...
;; H
  (assert (= temp___205 r__split_fields4))

;; H
  (assert (= temp___2051 r__split_fields5))

;; H
  (assert (= temp___2052 r__split_fields6))

;; H
  (assert (= temp___2053 r__split_fields7))
...
;; H
  (assert (= temp___2071 o7))

;; H
  (assert (= temp___2072 o8))

;; H
  (assert (= temp___2073 o9))
...
;; H
  (assert (= temp___207 r__split_fields8))

;; H
  (assert (= temp___2071 r__split_fields9))

;; H
  (assert (= temp___2072 r__split_fields10))

;; H
  (assert (= temp___2073 r__split_fields11))
...
;; H
  (assert (= temp___209 o11))

;; H
  (assert (= temp___2091 o12))

;; H
  (assert (= temp___2092 o13))

;; H
  (assert (= temp___2093 o14))
...
;; H
  (assert
  (= r__split_fields12 (mk___split_fields temp___209 temp___2091 temp___2092
                       temp___2093)))
...
;; H
  (assert (= temp___211 o16))

;; H
  (assert (= temp___2111 o17))

;; H
  (assert (= temp___2112 o18))

;; H
  (assert (= temp___2113 o19))
...
;; H
  (assert
  (= r__split_fields13 (mk___split_fields temp___211 temp___2111 temp___2112
                       temp___2113)))
...
;; WP_parameter_def
 ;; File "records.ads", line 44, characters 0-0
  (not
  (= (bool_eq3 (mk___rep (us_split_fields__content r__split_fields14))
     (mk___rep
     (mk___split_fields (of_rep 3) (of_rep1 new_data) (of_rep2 4)
