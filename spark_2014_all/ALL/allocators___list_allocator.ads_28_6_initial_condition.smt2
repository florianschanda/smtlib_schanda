...
;; H
  ...
  (= result7 (is_empty
             (rec__list_allocator__m__t__allocated
             (us_split_fields__content model____split_fields10))))
  (and
  (= (= result7 true)
  (forall ((item Int))
  (not
  ...
  (= (contains
     (rec__list_allocator__m__t__allocated
     (us_split_fields__content model____split_fields10)) item) true)))))
  (= (= result7 true)
  (= (length1
     (rec__list_allocator__m__t__allocated
     (us_split_fields__content model____split_fields10))) 0)))))
...
;; H
  ...
  (= o3 (get
        (rec__list_allocator__m__t__available
        (us_split_fields__content model____split_fields10)) 1))
  (in_range4 o3))))
...
;; H
  ...
  (= (get
     (rec__list_allocator__m__t__available
     (us_split_fields__content model____split_fields10)) rr) rr))))))
...
;; H
  ...
  (= (contains1
     (rec__list_allocator__m__t__available
     (us_split_fields__content model____split_fields10)) rr) true))))))
...
;; WP_parameter_def
 ;; File "list_allocator.adb", line 21, characters 0-0
  ...
  (= (is_empty
     (rec__list_allocator__m__t__allocated
     (us_split_fields__content model____split_fields10))) true)))
(check-sat)
(exit)
