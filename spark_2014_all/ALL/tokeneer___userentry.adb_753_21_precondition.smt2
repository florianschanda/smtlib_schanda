...
(declare-fun isinentryperiod__function_guard (Bool Int us_rep
  us_private) Bool)
...
(define-fun dynamic_invariant7 ((temp___expr_334 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_376 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_388 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_412 Int)
...
(declare-fun o2 () yearst)

(declare-fun o3 () monthst)

(declare-fun o4 () dayst)

(declare-fun o5 () millisecst)
...
(assert
;; WP_parameter_def
 ;; File "userentry.adb", line 582, characters 0-0
