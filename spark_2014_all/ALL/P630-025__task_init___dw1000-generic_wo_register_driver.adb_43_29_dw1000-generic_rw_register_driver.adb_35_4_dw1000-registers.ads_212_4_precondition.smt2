...
(define-fun register_type__ref___14__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___10__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___10__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2182 us_t1)
  (temp___is_init_2179 Bool) (temp___skip_constant_2180 Bool)
  (temp___do_toplevel_2181 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2180 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2182)
                                       (last3 temp___expr_2182))
                                       (and (= (first3 temp___expr_2182) 1)
                                       (= (last3 temp___expr_2182) 5)))))
...
(define-fun target__ref___4__projection ((a target__ref)) us_t2 (target__content
                                                                a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___4__projection ((a source__ref)) us_rep (source__content
                                                                 a))

(define-fun dynamic_invariant1 ((temp___expr_2207 us_t2)
  (temp___is_init_2204 Bool) (temp___skip_constant_2205 Bool)
  (temp___do_toplevel_2206 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2205 true))
                                       (and (dynamic_property3 1 5
                                       (first5 temp___expr_2207)
                                       (last5 temp___expr_2207))
                                       (and (= (first5 temp___expr_2207) 1)
                                       (= (last5 temp___expr_2207) 5)))))
...
;; H
  (assert
  (and (= temp___77162 (register_to_bytes reg)) (dynamic_invariant1
  temp___77162 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___77161)) (to_rep (last4 temp___77161)))
     (+ (- (to_rep (last4 temp___77161)) (to_rep (first4 temp___77161))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___77161)) (to_rep (last4 temp___77161)))
  temp___77171))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___77171)) (to_rep (last2 temp___77171)))
     (+ (- (to_rep (last2 temp___77171)) (to_rep (first2 temp___77171))) 1)
