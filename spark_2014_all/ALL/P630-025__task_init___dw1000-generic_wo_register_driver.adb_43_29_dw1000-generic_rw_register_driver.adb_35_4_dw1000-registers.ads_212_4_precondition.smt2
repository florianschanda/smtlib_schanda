...
(define-fun dynamic_invariant ((temp___expr_2176 us_t1)
  ...
  (temp___do_toplevel_2175 Bool)) Bool (=>
                                       ...
                                       (last3 temp___expr_2176))
                                       (and (= (first3 temp___expr_2176) 1)
                                       (= (last3 temp___expr_2176) 5)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2201 us_t2)
  ...
  (temp___do_toplevel_2200 Bool)) Bool (=>
                                       ...
                                       (last5 temp___expr_2201))
                                       (and (= (first5 temp___expr_2201) 1)
                                       (= (last5 temp___expr_2201) 5)))))
...
(declare-const temp___7570 (Array Int bits_8))

(declare-const temp___75701 t2)

(declare-const temp___7571 (Array Int bits_8))

(declare-const temp___75711 t1)
...
;; H
  (assert
  (and (= temp___75702 (register_to_bytes reg)) (dynamic_invariant1
  temp___75702 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75701)) (to_rep (last4 temp___75701)))
     (+ (- (to_rep (last4 temp___75701)) (to_rep (first4 temp___75701))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75701)) (to_rep (last4 temp___75701)))
  temp___75711))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___75711)) (to_rep (last2 temp___75711)))
     (+ (- (to_rep (last2 temp___75711)) (to_rep (first2 temp___75711))) 1)
