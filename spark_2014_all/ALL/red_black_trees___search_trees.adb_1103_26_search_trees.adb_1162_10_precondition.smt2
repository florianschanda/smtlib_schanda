...
(declare-fun temp___1133 () (Array Int us_rep1))
...
(declare-fun temp___1134 () (Array Int us_rep1))
...
(declare-fun temp___1135 () (Array Int us_rep1))
...
(declare-fun temp___1131 () (Array Int us_rep1))

(declare-fun o47 () us_rep1)

(declare-fun o48 () us_split_fields)

(declare-fun o49 () us_rep)

(declare-fun o50 () Int)

(declare-fun temp___1132 () (Array Int us_rep1))

(declare-fun o51 () us_rep1)

(declare-fun o52 () us_split_fields)

(declare-fun o53 () us_rep)
...
;; H
  ...
  (= temp___1135 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o39))
  (and (dynamic_invariant6 temp___1135 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1135 o39))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1135 o39)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o39))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1135 (parent
                              (rec__search_trees__search_tree__struct
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1135 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1135 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1135 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1135 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1135 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1135 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o40 (select temp___1135 x1)))
...
;; H
  ...
  (= temp___1134 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o35))
  (and (dynamic_invariant6 temp___1134 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1134 o35))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1134 o35)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o35))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1134 (parent
                              (mk___rep2
                              (let ((subject f_5__split_fields))
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1134 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1134 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1134 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1134 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1134 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1134 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o36 (select temp___1134 i1)))
...
;; H
  ...
  (= temp___1133 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o32))
  (and (dynamic_invariant6 temp___1133 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1133 o32))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1133 o32)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o32))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1133 (parent
                              (mk___rep2
                              (let ((subject f_5__split_fields))
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1133 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1133 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1133 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1133 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1133 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1133 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o33 (select temp___1133 i1)))
...
;; H
  (assert
  (and
  (= o50 (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))))
...
;; H
  ...
  (= temp___1132 (model__
                 ...
                 (let ((subject f_5__split_fields)) f_5__split_fields2)) 
                 o50))
  (and (dynamic_invariant6 temp___1132 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1132 o50))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1132 o50)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o50))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1132 (parent
                              (mk___rep2
                              (let ((subject f_5__split_fields))
                              f_5__split_fields2)) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1132 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1132 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1132 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1132 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1132 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1132 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o51 (select temp___1132 i1)))
...
;; H
  (assert
  (and (= o54 (length o53)) (and (in_range6 o54) (<= (+ 0 o54) 2147483647))))
...
;; H
  (assert
  (and
  (= o46 (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))
  (in_range3
  (to_rep1 (rec__search_trees__search_tree__root t__split_fields10)))))
...
;; H
  ...
  (= temp___1131 (model__
                 (rec__search_trees__search_tree__struct t__split_fields10)
                 o46))
  (and (dynamic_invariant6 temp___1131 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1131 o46))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1131 o46)))) 0)
  (and
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=> (not (= i2 o46))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1131 (parent
                              (rec__search_trees__search_tree__struct
                              t__split_fields10) i2)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1131 i2))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1131 i2))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1131 i2)))) 0))))
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1131 j3))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1131 i2)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1131 j3)))) true))
  (= j3 i2))))))))))))))

;; H
  (assert (= o47 (select temp___1131 x1)))
...
;; H
  (assert (and (= o57 (get o49 o56)) (in_range7 o57)))
