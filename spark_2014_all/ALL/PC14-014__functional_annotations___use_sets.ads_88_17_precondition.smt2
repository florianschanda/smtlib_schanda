...
(declare-fun temp___987 () us_rep1)
...
;; H
  (assert
  (and (= temp___987 (elements s))
  (and
  (and
  (and
  (and (= (length2 temp___987) (length s))
  (forall ((temp___425 Int))
  (=>
  (and (in_range2 temp___425)
  (= (iter_has_element temp___987 temp___425) true))
  (= (contains (model__ s) (get temp___987 temp___425)) true))))
  (forall ((item Int))
  (=> (and (in_range4 item) (= (contains (model__ s) item) true))
  (and (< 0 (find temp___987 item))
  (= (get temp___987 (find temp___987 item)) item)))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (length s)))
  (= (find temp___987 (get temp___987 i)) i))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (length s)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length s)))
  (=> (= (get temp___987 i) (get temp___987 j)) (= i j)))))))))

;; H
  (assert
  (and (= o (iter_has_element temp___987 temp___986))
  (= (= o true) (and (<= 1 temp___986) (<= temp___986 (last temp___987))))))

;; H
  (assert (= (= o1 true) (in_range2 temp___986)))
