...
(define-fun dynamic_invariant ((temp___expr_201 (_ BitVec 8))
  (temp___is_init_198 Bool) (temp___skip_constant_199 Bool)
  (temp___do_toplevel_200 Bool)) Bool true)

(declare-const attr__ATTRIBUTE_ADDRESS Int)

(declare-const al_test (_ BitVec 8))

(declare-const x86__al__result (_ BitVec 8))

(declare-const result (_ BitVec 8))

(declare-const x86__al__result1 (_ BitVec 8))

(declare-const x86__al__result2 (_ BitVec 8))

(declare-const x86__al__result3 (_ BitVec 8))

(declare-const x86__al__result4 (_ BitVec 8))

(declare-const x86__al__result5 (_ BitVec 8))

(declare-const result1 (_ BitVec 8))

;; H
  (assert (= al_test (bvand al_test ((_ int2bv 8) 255))))
...
;; H
  (assert (= x86__al__result1 (bvand al_test ((_ int2bv 8) 255))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  (not (= x86__al__result4 (bvand al_test ((_ int2bv 8) 255)))))
(check-sat)
(exit)
