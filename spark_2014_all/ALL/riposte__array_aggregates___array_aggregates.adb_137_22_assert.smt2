...
;; def_axiom
  ...
  (let ((temp___437 (temp___436 temp___438 temp___439)))
  (forall ((temp___440 Int))
  (ite (and (<= 2 temp___440) (<= temp___440 5))
  (= (select temp___437 temp___440) (of_rep temp___438))
  (= (select temp___437 temp___440) (of_rep temp___439)))))))
