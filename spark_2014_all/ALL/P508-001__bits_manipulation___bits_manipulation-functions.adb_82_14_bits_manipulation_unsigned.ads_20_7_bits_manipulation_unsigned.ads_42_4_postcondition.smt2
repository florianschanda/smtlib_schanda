...
(declare-const new_v (_ BitVec 8))

(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline_always__result Int)

(declare-const temp___393 Int)

(declare-const temp___392 (_ BitVec 8))

(declare-const temp___391 (_ BitVec 8))
...
(declare-const new_v1 (_ BitVec 8))
...
(declare-const new_v2 (_ BitVec 8))

(declare-const result3 (_ BitVec 8))

(declare-const new_v3 (_ BitVec 8))
...
(declare-const new_v4 (_ BitVec 8))
...
(declare-const new_v5 (_ BitVec 8))
...
(declare-const new_v7 (_ BitVec 8))

(declare-const result7 int__ref)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline_always__result1 Int)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline_always__result2 int__ref)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline_always__result3 Int)
...
(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline_always__result4 int__ref)
...
(declare-const new_v9 (_ BitVec 8))

(declare-const bits_manipulation_unsigned__unsigned_8__functions__msb_index_fast_inline_always__result5 Int)
...
;; H
  (assert
  (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 8) 0))))
  (= temp___390 result__1)))

;; H
  (assert
  (=> (and (not (= shift_amount1 0)) (not (= v1 ((_ int2bv 8) 0))))
  (and
  (and (=> (<= 0 7) (in_range1 result__2))
  (=> (<= 0 7) (in_range1 shift_amount2)))
