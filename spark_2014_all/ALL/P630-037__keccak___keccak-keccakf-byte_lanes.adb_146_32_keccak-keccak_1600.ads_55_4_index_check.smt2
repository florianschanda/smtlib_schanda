...
(declare-fun initial_offset () Int)
...
(declare-fun temp___763 () (_ BitVec 64))

(declare-fun temp___762 () Int)

(declare-fun temp___761 () Int)

(declare-fun temp___760 () (_ BitVec 8))

(declare-fun temp___758 () (Array Int byte))

(declare-fun temp___756 () (_ BitVec 8))
...
(declare-fun temp___766 () Int)

(declare-fun o103 () byte)
...
(declare-fun temp___7652 () Int)

(declare-fun result6 () Int)

(declare-fun temp___7642 () Int)
...
(declare-fun remaining_bytes4 () int__ref)

(declare-fun offset4 () int__ref)

(declare-fun lane4 () t__ref1)

(declare-fun i11 () int__ref)

(declare-fun data12 () (Array Int byte))

(declare-fun x5 () (_ BitVec 8))

(declare-fun y5 () (_ BitVec 8))

(declare-fun remaining_bytes5 () Int)
...
(declare-fun remaining_bytes6 () int__ref)
...
(declare-fun data14 () (Array Int byte))

(declare-fun x7 () (_ BitVec 8))

(declare-fun y7 () (_ BitVec 8))

(declare-fun remaining_bytes7 () Int)
...
(declare-fun initial_offset1 () Int)
...
(declare-fun temp___7751 () Int)

(declare-fun result32 () int__ref)

(declare-fun temp___7741 () Int)

(declare-fun result33 () int__ref)

(declare-fun temp___7731 () Int)
...
;; H
  (assert
  (= (to_rep1 o103) ((_ extract 7 0) (bvand (bvlshr lane8 ((_ int2bv 64)
  shift2)) ((_ int2bv 64) 255)))))

;; H
  (assert
  (and (= temp___766 (+ (to_rep data__first) offset8)) (in_range1
  (+ (to_rep data__first) offset8))))

(assert
;; WP_parameter_def
 ;; File "keccak-keccakf-byte_lanes.adb", line 30, characters 0-0
  (not (<= (to_rep data__first) temp___766)))
(check-sat)
(exit)
