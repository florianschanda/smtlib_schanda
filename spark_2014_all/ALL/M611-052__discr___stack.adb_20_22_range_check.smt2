...
;; to____post_axiom
  (assert
  (forall ((s us_rep))
  (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (to__ s)
...
(declare-datatypes ((t12b__ref 0)) (((mk_t12b__ref (t12b__content us_t3)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range2 (+ (to_rep1 s__split_fields) 1))))
(check-sat)
(exit)
