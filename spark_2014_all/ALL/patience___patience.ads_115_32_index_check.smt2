...
;; H
  (assert
  (= o27 (select (rec__patience__state__preds (us_split_fields1 s)) o26)))
...
;; H
  (assert
  (= o24 (select (rec__patience__state__preds (us_split_fields1 s)) o23)))
...
;; H
  (assert
  (=> (= result6 true)
  (= o21 (select (rec__patience__state__preds (us_split_fields1 s)) o20))))
...
;; H
  (assert
  (= o17 (select (rec__patience__state__values (us_split_fields1 s))
  o16)))
...
;; H
  (assert
  (= o15 (select (rec__patience__state__values (us_split_fields1 s))
  o14)))
...
;; H
  (assert
  (=> (= result9 true)
  (= o10 (select (rec__patience__state__posstack (us_split_fields1 s))
  o9))))
