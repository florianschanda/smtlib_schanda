...
;; H
  ...
  (= (bool_eq13 names__to_string__B_3__e__assume3
     (get1
     (model__1
     (mk___rep entry_table__split_discrs
...
;; H
  ...
  (=>
  (and (<= (to_rep1 s__first) temp___450) (<= temp___450 (to_rep1 s__last)))
  (=> (<= i2 temp___450) (= (select s1 temp___450) (select s temp___450)))))
  (and (<= 1 i2) (<= i2 l))))
