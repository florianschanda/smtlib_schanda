...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1133 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= sum3 (bvadd (bvadd l_digit3 r_digit3) carry2))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (and (= o12 (shift_right sum3 8))
  (= o12 (bvudiv sum3 (ite (< 8 65536)
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1128 (mk___rep1 result____split_discrs o18))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result7 (mk___split_fields__ref1 result____split_fields3))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields3 temp___1128))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___1128))))
...
;; H
  (assert
  (= aco__math__very_longs__modadd__result4 (mk_very_long__ref
                                            aco__math__very_longs__modadd__result3)))

;; H
  (assert
  (= aco__math__very_longs__modadd__result5 aco__math__very_longs__modadd__result3))

;; H
  (assert
  (= result8 (mk_very_long__ref
             (mk___rep
             (mk___split_discrs aco__math__very_longs__modadd__result)
             (mk___split_fields
             (mk___t aco__math__very_longs__modadd__result1
             aco__math__very_longs__modadd__result2))))))

;; H
  (assert
  (= aco__math__very_longs__modadd__result3 (to_base
                                            (mk___rep1 result____split_discrs
...
;; H
  (assert
  (= aco__math__very_longs__modadd__result6 aco__math__very_longs__modadd__result4))
...
;; H
  (assert
  (= aco__math__very_longs__modadd__result7 aco__math__very_longs__modadd__result5))
...
;; H
  (assert
  (= (mk___rep (mk___split_discrs result9)
     (mk___split_fields (mk___t result10 result11))) (very_long__content
                                                     aco__math__very_longs__modadd__result6)))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  ...
  (= (to_rep1
     (rec__aco__math__very_longs__very_long__octet_length
     (us_split_discrs1
     (very_long__content aco__math__very_longs__modadd__result6)))) (to_rep1
                                                                    (rec__aco__math__very_longs__very_long__octet_length
                                                                    (us_split_discrs1
                                                                    l))))))
(check-sat)
