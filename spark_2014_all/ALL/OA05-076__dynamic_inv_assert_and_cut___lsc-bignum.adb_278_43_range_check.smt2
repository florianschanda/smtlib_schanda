...
;; H
  (assert (and (= o25 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o26 (ite (<= k o25) true false)))

;; H
  (assert (= result1 (ite (<= i2 k) o26 false)))
...
;; H
  (assert (= o20 (from_word32 carry21)))
...
;; H
  (assert (= o18 (from_word32 carry11)))

;; H
  (assert (= o22 (oadd o18 o21)))
...
;; H
  (assert (= o17 (oexpon o14 o16)))

;; H
  (assert (= o23 (omultiply o17 o22)))
...
;; H
  (assert
  (= o13 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last)))
         a_first o12)))

;; H
  (assert (= o24 (oadd o13 o23)))

;; H
  (assert (= o9 (from_word32 carry2)))

;; H
  (assert
  (and (= o8 (base Tuple0))
  (= o8 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o10 (omultiply o8 o9)))

;; H
  (assert (= o7 (from_word32 carry1)))

;; H
  (assert (= o5 (from_word32 y)))
...
;; H
  (assert (= o4 (num_of_big_int c c_first o3)))

;; H
  (assert (= o6 (omultiply o4 o5)))

;; H
  (assert (= o1 (from_word32 x)))
