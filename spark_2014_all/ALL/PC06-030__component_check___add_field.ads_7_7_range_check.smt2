...
(declare-datatypes ()
((tmy_arrayC__ref (mk_tmy_arrayC__ref (tmy_arrayC__content integer)))))
(define-fun tmy_arrayC__ref___projection ((a tmy_arrayC__ref)) integer
  (tmy_arrayC__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_159 us_t)
  ...
  (temp___do_toplevel_158 Bool)) Bool (and
                                      ...
                                      (<= d 2147483647)) (dynamic_property
                                      d 2147483647
                                      (to_rep
                                      (select (to_array temp___expr_159) temp___160))))))))
...
(assert
;; WP_parameter_def
 ;; File "add_field.ads", line 12, characters 0-0
  (not (<= 0 d)))
(check-sat)
(exit)
