...
;; H
  (assert
  (and (= o17 (+ (to_rep1 (first (rt source))) 10)) (in_range1
...
;; H
  (assert
  (and (= o16 (+ (to_rep1 (first (rt source))) 9)) (in_range1
...
;; H
  ...
  (forall ((index1 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 9) index1)
  (<= index1 (+ (to_rep1 (first (rt source))) 10)))
  (= (is_digit (to_rep (select (elts source) index1))) true)))))

;; H
  (assert
  (and (= temp___1860 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (and (= temp___1859 (+ (to_rep1 (first (rt source))) 8)) (in_range1
...
;; H
  (assert
  (and (= temp___1858 (+ (to_rep1 (first (rt source))) 7)) (in_range1
...
;; H
  (assert
  (and (= temp___1857 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1857)
  (<= temp___1857 (to_rep1 (last (rt source))))))
