...
(declare-fun o35 () (Array Int natural))
...
;; H
  (assert
  (and (= o16 (shift_perm_l o47 o46 o44))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o44 o46) true)))))
...
;; H
  (assert
  (and (= o31 (shift_perm_r o42 o41 o39))
  (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o42 o39) true)))))
...
;; H
  (assert
  (and (= o37 (remove o38 o34))
  (and (dynamic_invariant2 o37 true false true)
  (and (= (invariant__ o37) true)
  (and (= (to_rep2 (last o36)) (- (to_rep2 (last o33)) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o34 1)))
  (= (to_rep (select o32 k)) (to_rep (select o35 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o34 1) k) (<= k (to_rep2 (last o33))))
  (= (to_rep (select o32 k)) (to_rep (select o35 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o34 k) (<= k (- (to_rep2 (last o33)) 1)))
  (= (to_rep (select o32 (+ k 1))) (to_rep (select o35 k))))))))))))
