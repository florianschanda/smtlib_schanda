...
(define-fun o5 () us_rep (mk___rep (mk___split_discrs o)
...
;; H
  (assert
  (and
  (= o2 (copy (rec__amortized_queue__queue__rear (us_split_fields3 q)) 1000))
  (and
  (= (oeq1 (model__ o2)
  ...
  (= (to_rep
     (rec__amortized_queue__my_vectors__vector__capacity
     (us_split_discrs1 o2))) (length
                             (rec__amortized_queue__queue__rear
                             (us_split_fields3 q))))
  (= (to_rep
     (rec__amortized_queue__my_vectors__vector__capacity
     (us_split_discrs1 o2))) 1000)))))
...
;; H
  (assert
  (and
  (= o5 (copy (rec__amortized_queue__queue__front (us_split_fields3 q)) 1000))
  (and
  (= (oeq1 (model__ o5)
