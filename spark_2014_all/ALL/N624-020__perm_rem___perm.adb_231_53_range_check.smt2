...
;; H
  (assert
  (and (= o16 (shift_perm_l o48 o47 o45))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o45 o47) true)))))
...
;; H
  (assert
  (and (= o31 (shift_perm_r o43 o42 o40))
  (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o43 o40) true)))))
...
;; H
  (assert
  (and
  (= o35 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o39 (remove b ib1))
  (and (dynamic_invariant2 o39 true false true)
  (and (= (invariant__ o39) true)
  (and (= (to_rep2 (last o34)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o33 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o33 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o33 k))))))))))))

;; H
  (assert
  (and (= o38 (remove o39 o35))
...
;; H
  (assert
  (and
  (= o32 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))))
