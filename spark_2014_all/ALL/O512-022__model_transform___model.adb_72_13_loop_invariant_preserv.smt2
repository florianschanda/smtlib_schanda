...
(((mk_uml_state__ref (uml_state__content us_rep)))))
...
(((mk_uml_action__ref (uml_action__content us_rep3)))))
...
(((mk_map__ref3 (map__content3 (Array Int us_rep4))))))
...
(((mk_uml_activity__ref (uml_activity__content us_rep5)))))
...
(declare-datatypes ((t2b__ref 0)) (((mk_t2b__ref (t2b__content t2b)))))
