...
(declare-fun dummy () name_t)

(declare-datatypes ()
((name_t__ref (mk_name_t__ref (name_t__content name_t)))))
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__model__uml_state__name_data name_t)))))
(define-fun us_split_fields_Name_Data__projection ((a us_split_fields)) name_t
...
(declare-fun model__uml_state__name_data__first__bit () Int)

(declare-fun model__uml_state__name_data__last__bit () Int)

(declare-fun model__uml_state__name_data__position () Int)
...
(declare-datatypes ()
((uml_state__ref (mk_uml_state__ref (uml_state__content us_rep)))))
(define-fun uml_state__ref___projection ((a uml_state__ref)) us_rep (uml_state__content
                                                                    a))
...
(declare-fun dummy2 () uml_state_access)
...
(define-fun us_split_fields_From_Data__projection ((a us_split_fields2)) uml_state_access
  (rec__model__uml_transition__from_data a))

(define-fun us_split_fields_To_Data__projection ((a us_split_fields2)) uml_state_access
...
(declare-fun model__uml_transition__from_data__first__bit () Int)

(declare-fun model__uml_transition__from_data__last__bit () Int)

(declare-fun model__uml_transition__from_data__position () Int)
...
(declare-fun model__uml_transition__to_data__first__bit () Int)

(declare-fun model__uml_transition__to_data__last__bit () Int)

(declare-fun model__uml_transition__to_data__position () Int)
...
(declare-datatypes ()
((uml_transition__ref
 (mk_uml_transition__ref (uml_transition__content us_rep1)))))
(define-fun uml_transition__ref___projection ((a uml_transition__ref)) us_rep1
...
(declare-fun dummy4 () uml_transition_access)
...
(declare-fun dummy6 () (Array Int us_rep1))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int us_rep1))) (<= 0 (object__component__size1 a))))
...
(define-fun us_split_fields_Owned_State_Data__projection ((a us_split_fields4)) (Array Int us_rep)
  (rec__model__uml_state_machine__owned_state_data a))

(define-fun us_split_fields_Owned_Transition_Data__projection ((a us_split_fields4)) (Array Int us_rep1)
...
(declare-fun model__uml_state_machine__owned_state_data__first__bit () Int)

(declare-fun model__uml_state_machine__owned_state_data__last__bit () Int)

(declare-fun model__uml_state_machine__owned_state_data__position () Int)
...
(declare-fun model__uml_state_machine__owned_transition_data__first__bit () Int)

(declare-fun model__uml_state_machine__owned_transition_data__last__bit () Int)

(declare-fun model__uml_state_machine__owned_transition_data__position () Int)
...
(declare-datatypes ()
((us_split_fields6
 (mk___split_fields3 (rec__model__uml_action__name_data name_t)))))
(define-fun us_split_fields_Name_Data2__projection ((a us_split_fields6)) name_t
...
(declare-fun model__uml_action__name_data__first__bit () Int)

(declare-fun model__uml_action__name_data__last__bit () Int)

(declare-fun model__uml_action__name_data__position () Int)
...
(declare-datatypes ()
((uml_action__ref (mk_uml_action__ref (uml_action__content us_rep3)))))
(define-fun uml_action__ref___projection ((a uml_action__ref)) us_rep3
  (uml_action__content a))

(declare-fun no_uml_action () us_rep3)
...
(declare-fun dummy9 () uml_action_access)
...
(define-fun bool_eq6 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq5 (select a temp___idx_134)
...
(declare-fun no_uml_action_vector () (Array Int us_rep3))
...
;; def_axiom
  (assert
  (forall ((temp___136 us_rep3))
  (forall ((temp___137 Int))
  (= (select (model__no_uml_action_vector__aggregate_def temp___136) temp___137) temp___136))))
...
;; range_axiom
  (assert
  (forall ((x uml_action_access)) (! (in_range4
...
(define-fun us_split_fields_From_Data2__projection ((a us_split_fields8)) uml_action_access
  (rec__model__uml_control_flow__from_data a))

(define-fun us_split_fields_To_Data2__projection ((a us_split_fields8)) uml_action_access
...
(define-fun us_rep_5__projection ((a us_rep4)) us_split_fields8 (us_split_fields9
                                                                a))
...
((uml_control_flow__ref
 (mk_uml_control_flow__ref (uml_control_flow__content us_rep4)))))
(define-fun uml_control_flow__ref___projection ((a uml_control_flow__ref)) us_rep4
  (uml_control_flow__content a))

(declare-fun no_uml_control_flow () us_rep4)
...
(declare-fun user_eq11 (uml_control_flow_access
  uml_control_flow_access) Bool)

(declare-fun dummy11 () uml_control_flow_access)

(declare-datatypes ()
((uml_control_flow_access__ref
 (mk_uml_control_flow_access__ref
 (uml_control_flow_access__content uml_control_flow_access)))))
(define-fun uml_control_flow_access__ref___projection ((a uml_control_flow_access__ref)) uml_control_flow_access
  (uml_control_flow_access__content a))

(declare-datatypes ()
((map__ref3 (mk_map__ref3 (map__content3 (Array Int us_rep4))))))
...
(declare-fun concat4 ((Array Int us_rep4) Int Int (Array Int us_rep4) Int
...
(define-fun bool_eq8 ((a (Array Int us_rep4)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq7 (select a temp___idx_138)
...
(declare-fun no_uml_control_flow_vector () (Array Int us_rep4))
...
;; def_axiom
  (assert
  (forall ((temp___140 us_rep4))
  (forall ((temp___141 Int))
  (= (select (model__no_uml_control_flow_vector__aggregate_def temp___140) temp___141) temp___140))))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int us_rep3))) (<= 0 (object__component__size2 a))))
...
(declare-fun dummy13 () (Array Int us_rep4))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int us_rep4))) (<= 0 (object__component__size3 a))))
...
(define-fun us_split_fields_Owned_Action_Data__projection ((a us_split_fields10)) (Array Int us_rep3)
  (rec__model__uml_activity__owned_action_data a))

(define-fun us_split_fields_Owned_Flow_Data__projection ((a us_split_fields10)) (Array Int us_rep4)
...
(define-fun us_rep_6__projection ((a us_rep5)) us_split_fields10 (us_split_fields11
                                                                 a))
...
(declare-fun model__uml_activity__owned_action_data__first__bit () Int)

(declare-fun model__uml_activity__owned_action_data__last__bit () Int)

(declare-fun model__uml_activity__owned_action_data__position () Int)
...
(declare-fun model__uml_activity__owned_flow_data__first__bit () Int)

(declare-fun model__uml_activity__owned_flow_data__last__bit () Int)

(declare-fun model__uml_activity__owned_flow_data__position () Int)
...
(declare-datatypes ()
((uml_activity__ref (mk_uml_activity__ref (uml_activity__content us_rep5)))))
(define-fun uml_activity__ref___projection ((a uml_activity__ref)) us_rep5
  (uml_activity__content a))

(declare-fun no_uml_activity () us_rep5)
...
(declare-fun r1b () (Array Int us_rep))
...
(declare-fun r7b () (Array Int us_rep1))
...
;; no_uml_activity__def_axiom
  (assert
  (= no_uml_activity (mk___rep5
                     (mk___split_fields5 no_uml_action_vector
                     no_uml_control_flow_vector))))

(declare-fun av () (Array Int us_rep3))

(declare-fun cfv () (Array Int us_rep4))

(declare-fun act__split_fields () (Array Int us_rep3))

(declare-fun act__split_fields1 () (Array Int us_rep4))
...
(declare-fun o2 () name_t)

(declare-fun o3 () name_t)

(declare-fun o4 () name_t)
...
(declare-fun av1 () (Array Int us_rep3))

(declare-fun result1 () map__ref3)

(declare-fun cfv1 () (Array Int us_rep4))

(declare-fun result2 () us_split_fields__ref5)

(declare-fun act__split_fields2 () us_split_fields10)

(declare-fun result3 () int__ref)

(declare-fun s2 () Int)

(declare-fun av2 () (Array Int us_rep3))

(declare-fun s3 () Int)

(declare-fun result4 () map__ref2)

(declare-fun av3 () (Array Int us_rep3))

(declare-fun av4 () map__ref2)

(declare-fun s4 () int__ref)

(declare-fun av5 () (Array Int us_rep3))

(declare-fun s5 () Int)

(declare-fun av6 () map__ref2)

(declare-fun s6 () int__ref)

(declare-fun av7 () (Array Int us_rep3))
...
(declare-fun cfv2 () (Array Int us_rep4))

(declare-fun s9 () Int)

(declare-fun model__set_from__2__self__fields () us_split_fields8)

(declare-fun result6 () map__ref3)

(declare-fun cfv3 () (Array Int us_rep4))

(declare-fun model__set_to__2__self__fields () us_split_fields8)

(declare-fun result7 () map__ref3)

(declare-fun cfv4 () (Array Int us_rep4))

(declare-fun result8 () int__ref)

(declare-fun s10 () Int)

(declare-fun cfv5 () map__ref3)

(declare-fun s11 () int__ref)

(declare-fun cfv6 () (Array Int us_rep4))
...
;; H
  (assert
  (= (mk___rep5
     (mk___split_fields5 no_uml_action_vector no_uml_control_flow_vector))
  no_uml_activity))
...
;; H
  ...
  (= result2 (mk___split_fields__ref5
             (mk___split_fields5 act__split_fields act__split_fields1))))
...
;; H
  ...
  (forall ((t Int))
  (=> (and (<= 0 t) (<= t (- s3 1)))
  (= (name (select (owned_state sm) t)) (name__2 (select av2 t)))))))

;; H
  (assert
  (=> (and (<= 0 s2) (<= s2 100))
  (and (=> (<= 0 100) (in_range6 s3)) (and (<= 0 s3) (<= s3 100)))))
...
;; H
  (assert
  (=> (and (<= 0 s2) (<= s2 100))
  (= o5 (store av2 s3 (mk___rep3 (mk___split_fields3 o4))))))
...
;; H
  (assert (= o6 (select temp___443 s9)))
...
;; H
  (assert
  (and (= (from__2 (mk___rep4 model__set_from__2__self__fields)) o7)
  (= (to__2 (mk___rep4 model__set_from__2__self__fields)) (to__2
                                                          (mk___rep4
                                                          (us_split_fields9
                                                          (select cfv2
                                                          s9)))))))
...
;; H
  (assert (= result6 (mk_map__ref3 cfv2)))

;; H
  (assert
  (= cfv3 (store cfv2 s9 (mk___rep4 model__set_from__2__self__fields))))
...
;; H
  (assert (= o8 (select temp___444 s9)))
...
;; H
  (assert
  (and (= (to__2 (mk___rep4 model__set_to__2__self__fields)) o9)
  (= (from__2 (mk___rep4 model__set_to__2__self__fields)) (from__2
                                                          (mk___rep4
                                                          (us_split_fields9
                                                          (select cfv3
                                                          s9)))))))
...
;; H
  (assert (= result7 (mk_map__ref3 cfv3)))

;; H
  (assert
  (= cfv4 (store cfv3 s9 (mk___rep4 model__set_to__2__self__fields))))

;; H
  (assert (not (= s9 100)))

;; H
  (assert (= result8 (mk_int__ref s9)))

;; H
  (assert (= s10 (+ s9 1)))

;; H
  (assert (= s11 (mk_int__ref s10)))

;; H
  (assert (= cfv5 (mk_map__ref3 cfv4)))

;; H
  (assert (= rho1 model__set_to__2__self__fields))

;; H
  (assert (= rho model__set_from__2__self__fields))
...
;; WP_parameter_def
 ;; File "model.ads", line 121, characters 0-0
  ...
  (= (name (select (owned_state sm) (from (select (owned_transition sm) t))))
  (name__2
  (select (map__content2 av6) (from__2 (select (map__content3 cfv5) t)))))))
(check-sat)
(exit)
