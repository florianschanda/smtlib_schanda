...
;; def_axiom
  ...
  (= (select (evoting__do_vote__counters__aggregate_def temp___745) temp___746)
  (of_rep2 temp___745)))))

(declare-fun temp___String_Literal_747 (tuple0) (Array Int character))

;; temp___String_Literal_747__def_axiom
  (assert
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 1)) 42)
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 2)) 42))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 3)) 42))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 4)) 42))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 5)) 32))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 6)) 83))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 7)) 116))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 8)) 97))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 9)) 114))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 10)) 116))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 11)) 32))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 12)) 111))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 13)) 102))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 14)) 32))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 15)) 101))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 16)) 118))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 17)) 111))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 18)) 116))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 19)) 105))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 20)) 110))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 21)) 103))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 22)) 32))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 23)) 112))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 24)) 114))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 25)) 111))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 26)) 103))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 27)) 114))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 28)) 97))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 29)) 109))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 30)) 32))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 31)) 40))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 32)) 65))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 33)) 100))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 34)) 97))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 35)) 32))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 36)) 118))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 37)) 101))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 38)) 114))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 39)) 115))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 40)) 105))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 41)) 111))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 42)) 110))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 43)) 41))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 44)) 32))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 45)) 42))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 46)) 42))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 47)) 42))
     (= (to_rep (select (temp___String_Literal_747 us_void_param) 48)) 42)) :pattern (
  (temp___String_Literal_747 us_void_param)) )))
...
(define-fun dynamic_invariant6 ((temp___expr_545 Int)
...
(assert
;; WP_parameter_def
 ;; File "evoting.adb", line 270, characters 0-0
  (not true))
(check-sat)
(exit)
