...
(((mk___split_fields
  (rec__dw1000__register_types__tx_buffer_type__tx_buffer (Array Int bits_8))))))
(define-fun us_split_fields_TX_BUFFER__projection ((a us_split_fields)) (Array Int bits_8)
  (rec__dw1000__register_types__tx_buffer_type__tx_buffer a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (bool_eq
                           (rec__dw1000__register_types__tx_buffer_type__tx_buffer
                           (us_split_fields1 a)) 1 1024
                           (rec__dw1000__register_types__tx_buffer_type__tx_buffer
                           (us_split_fields1 b)) 1 1024) true)
                   true false))
...
;; dw1000__register_types__tx_buffer_type__tx_buffer__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__tx_buffer_type__tx_buffer__first__bit))

;; dw1000__register_types__tx_buffer_type__tx_buffer__last__bit_axiom
  (assert
  (< dw1000__register_types__tx_buffer_type__tx_buffer__first__bit dw1000__register_types__tx_buffer_type__tx_buffer__last__bit))

;; dw1000__register_types__tx_buffer_type__tx_buffer__position_axiom
...
(declare-datatypes ((tx_buffer_type__ref 0))
(((mk_tx_buffer_type__ref (tx_buffer_type__content us_rep)))))
(define-fun tx_buffer_type__ref___projection ((a tx_buffer_type__ref)) us_rep
  (tx_buffer_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___15__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___11__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___11__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2229 us_t1)
  (temp___is_init_2226 Bool) (temp___skip_constant_2227 Bool)
  (temp___do_toplevel_2228 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2227 true))
                                       (and (dynamic_property2 1 1024
                                       (first3 temp___expr_2229)
                                       (last3 temp___expr_2229))
                                       (and (= (first3 temp___expr_2229) 1)
                                       (= (last3 temp___expr_2229) 1024)))))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int bits_8))) (<= 0 (object__component__size3 a))))
...
(define-fun target__ref___5__projection ((a target__ref)) us_t2 (target__content
                                                                a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___5__projection ((a source__ref)) us_rep (source__content
                                                                 a))

(define-fun dynamic_invariant1 ((temp___expr_2248 us_t2)
  (temp___is_init_2245 Bool) (temp___skip_constant_2246 Bool)
  (temp___do_toplevel_2247 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2246 true))
                                       (and (dynamic_property3 1 1024
                                       (first5 temp___expr_2248)
                                       (last5 temp___expr_2248))
                                       (and (= (first5 temp___expr_2248) 1)
                                       (= (last5 temp___expr_2248) 1024)))))
...
;; H
  (assert
  (and (dynamic_property2 1 1024 (to_rep reg_bytes__first)
  (to_rep reg_bytes__last))
  (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 1024))))
