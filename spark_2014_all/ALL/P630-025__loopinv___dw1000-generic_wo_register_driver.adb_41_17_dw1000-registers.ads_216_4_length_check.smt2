...
(declare-fun dummy4 () (Array Int bits_8))
...
(declare-fun dw1000__register_types__tx_buffer_type__tx_buffer__first__bit () Int)

(declare-fun dw1000__register_types__tx_buffer_type__tx_buffer__last__bit () Int)

(declare-fun dw1000__register_types__tx_buffer_type__tx_buffer__position () Int)
...
(define-fun register_type__ref_15__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_11__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_11__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2221 us_t1)
  (temp___is_init_2218 Bool) (temp___skip_constant_2219 Bool)
  (temp___do_toplevel_2220 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2219 true))
                                       (and (dynamic_property2 1 1024
                                       (first3 temp___expr_2221)
                                       (last3 temp___expr_2221))
                                       (and (= (first3 temp___expr_2221) 1)
                                       (= (last3 temp___expr_2221) 1024)))))
...
(define-fun target__ref_5__projection ((a target__ref)) us_t2 (target__content
                                                              a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_5__projection ((a source__ref)) us_rep (source__content
                                                               a))

(define-fun dynamic_invariant1 ((temp___expr_2240 us_t2)
  (temp___is_init_2237 Bool) (temp___skip_constant_2238 Bool)
  (temp___do_toplevel_2239 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2238 true))
                                       (and (dynamic_property3 1 1024
                                       (first5 temp___expr_2240)
                                       (last5 temp___expr_2240))
                                       (and (= (first5 temp___expr_2240) 1)
                                       (= (last5 temp___expr_2240) 1024)))))
...
(declare-fun temp___7574 () (Array Int bits_8))

(declare-fun temp___75741 () t2)

(declare-fun temp___7575 () (Array Int bits_8))

(declare-fun temp___75751 () t1)

(define-fun temp___75742 () us_t2 (mk___t2 temp___7574 temp___75741))
...
;; H
  (assert
  (and (= temp___75742 (register_to_bytes reg)) (dynamic_invariant1
  temp___75742 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___75741)) (to_rep (last4 temp___75741)))
     (+ (- (to_rep (last4 temp___75741)) (to_rep (first4 temp___75741))) 1)
     0) (ite (<= 1 1024) (+ (- 1024 1) 1) 0)))

;; H
  (assert (= temp___7574 temp___7575))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___75741)) (to_rep (last4 temp___75741))) 
  temp___75751))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___75751)) (to_rep (last2 temp___75751)))
     (+ (- (to_rep (last2 temp___75751)) (to_rep (first2 temp___75751))) 1)
