...
;; H
  ...
  (= o (+ (- (to_rep x__last) (to_rep x__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep x__first) (to_rep x__last))) (= o 0)))

;; H
  (assert (= result (ite (< 1 o) true false)))
...
;; H
  (assert
  (and (<= (to_rep x__first) (to_rep x__first))
  (<= (to_rep x__first) (to_rep x__last))))

;; H
  (assert (= o1 (to_rep x__first)))

;; H
  (assert (= o2 (select x o1)))
...
(assert
;; WP_parameter_def
 ;; File "unconstr_call.adb", line 3, characters 0-0
