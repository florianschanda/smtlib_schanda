...
(declare-fun o36 () (Array Int character))

(declare-fun o37 () Int)

(declare-fun o38 () character)

(declare-fun o39 () (Array Int character))
...
;; H
  (assert (= localtext2 (temp___String_Literal_1147 Tuple0)))
...
;; H
  (assert
  (and (= o32 (+ 48 (div1 localvalue2 10))) (in_range3
...
;; H
  (assert (= o34 (store localtext2 1 o33)))

;; H
  (assert (= result3 (mk_map__ref localtext2)))

;; H
  (assert (= localtext3 o34))

;; H
  (assert (= (to_rep o35) (+ 48 (mod2 localvalue2 10))))

;; H
  (assert (= o36 (store localtext3 2 o35)))

;; H
  (assert (= result4 (mk_map__ref localtext3)))

;; H
  (assert (= localtext4 o36))
...
;; H
  (assert
  (and (= o37 (+ 48 (div1 localvalue3 10))) (in_range3
...
;; H
  (assert (= o39 (store localtext4 4 o38)))

;; H
  (assert (= result6 (mk_map__ref localtext4)))

;; H
  (assert (= localtext5 o39))

;; H
  (assert (= (to_rep o40) (+ 48 (mod2 localvalue3 10))))

;; H
  (assert (= o41 (store localtext5 5 o40)))

;; H
  (assert (= result7 (mk_map__ref localtext5)))

;; H
  (assert (= localtext6 o41))
...
;; H
  (assert (= localtext7 (temp___String_Literal_1148 Tuple0)))
