...
(((mk_t21s__ref (t21s__content tdigit_index_typeB)))))
...
(declare-datatypes ((t22s__ref 0)) (((mk_t22s__ref (t22s__content us_t)))))
...
(declare-datatypes ((tT98bP1__ref 0))
(((mk_tT98bP1__ref (tT98bP1__content tdigit_index_typeB)))))
...
(declare-datatypes ((t98b__ref 0)) (((mk_t98b__ref (t98b__content us_t1)))))
...
(define-fun dynamic_invariant5 ((temp___expr_819 us_rep1)
...
(declare-datatypes ((tT99bP1__ref 0))
(((mk_tT99bP1__ref (tT99bP1__content tdigit_index_typeB)))))
...
(declare-datatypes ((t99b__ref 0)) (((mk_t99b__ref (t99b__content us_t2)))))
...
(define-fun dynamic_invariant6 ((temp___expr_831 us_rep2)
...
(define-fun dynamic_invariant7 ((temp___expr_219 (_ BitVec 8))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temp___1557 future_borrow)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (and (= (mk___split_discrs temp___1554) u__split_discrs)
  (and (= temp___15541 u__split_fields) (= temp___15542 u__split_fields1)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temp___1553 current_borrow1)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temp___1552 temporary_digit)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) true
  true true) (and (<= 1 divisor_index2) (<= divisor_index2 r130b)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= result3 (mk_t__ref1 product2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b)) (= product3 o5)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= result4 (mk_t__ref1 carry2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b)) (= carry3 o6)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= result5 (mk_t__ref1 temporary_digit2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temporary_digit3 (bvand product3 ((_ int2bv 16) 255)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (and (= o7 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1 u__split_fields3))))
  temp___1543)
  (<= temp___1543 (to_rep2
                  (last3
                  (rt1
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= result6 (ite (bvuge o11 (bvadd temporary_digit3 current_borrow2)) true
             false))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (=> (= result6 true) (= result7 (mk_t__ref1 future_borrow2)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (=> (= result6 true) (= future_borrow3 ((_ int2bv 16) 0)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (=> (not (= result6 true)) (= result8 (mk_t__ref1 future_borrow2)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (=> (not (= result6 true)) (= future_borrow4 ((_ int2bv 16) 1)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (=> (not (= result6 true)) (= future_borrow3 future_borrow4))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (and (= o13 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= o18 (bvsub o17 temporary_digit3))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= o19 (bvsub o18 current_borrow2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= o20 (bvand o19 ((_ int2bv 16) 255)))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b)) (= o21 o20)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= o22 ((_ extract 7 0) o21))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (and (= o12 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
...
;; H
  ...
  (= o25 (store (elts1
                (rec__aco__math__very_longs__very_long__long_digits1
                u__split_fields3)) o24 o23))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b)) (= o25 o26)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b)) (= o28 o26)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b)) (= o29 o27)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temp___1549 (mk___rep1 u__split_discrs
                 (mk___split_fields1 (mk___t1 o28 o29))))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= result9 (mk___split_fields__ref1 u__split_fields3))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= u__split_fields4 (us_split_fields3 temp___1549))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= u__split_discrs (us_split_discrs2 temp___1549))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= result10 (mk_t__ref1 current_borrow2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= current_borrow3 future_borrow3)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= divisor_index2 r130b)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= divisor_index3 (mk_int__ref divisor_index2))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= future_borrow5 (mk_t__ref1 future_borrow3))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temporary_digit4 (mk_t__ref1 temporary_digit3))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= product4 (mk_t__ref1 product3))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= current_borrow4 (mk_t__ref1 current_borrow3))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= u__split_fields5 (mk___split_fields__ref1 u__split_fields4))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= divisor_index4 divisor_index2)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= future_borrow6 future_borrow3)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temporary_digit5 temporary_digit3)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= current_borrow5 current_borrow3)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= u__split_fields6 u__split_fields4)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= divisor_index5 divisor_index3)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= future_borrow7 future_borrow5)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temporary_digit6 temporary_digit4)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= current_borrow6 current_borrow4)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= u__split_fields7 u__split_fields5)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= divisor_index6 divisor_index4)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= future_borrow8 future_borrow6)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= temporary_digit7 temporary_digit5)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= current_borrow7 current_borrow5)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r130b))
  (= u__split_fields8 u__split_fields6)))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= divisor_index5 (mk_int__ref divisor_index1))))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= future_borrow7 (mk_t__ref1 future_borrow))))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= temporary_digit6 (mk_t__ref1 temporary_digit))))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= product6 (mk_t__ref1 product))))
...
;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= current_borrow6 (mk_t__ref1 current_borrow1))))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= u__split_fields7 (mk___split_fields__ref1
                      (mk___split_fields1
                      (mk___t1 u__split_fields u__split_fields1))))))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= divisor_index6 divisor_index1)))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= future_borrow8 future_borrow1)))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= temporary_digit7 temporary_digit1)))
...
;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= current_borrow7 current_borrow1)))

;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r130b)))
  (= u__split_fields8 u__split_fields2)))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1561)
  (<= temp___1561 (to_rep2
                  (last3
                  (rt1
                  (rec__aco__math__very_longs__very_long__long_digits1
                  (us_split_fields__content1 u__split_fields7))))))))
...
;; H
  ...
  (= o32 (select (elts1
                 (rec__aco__math__very_longs__very_long__long_digits1
                 (us_split_fields__content1 u__split_fields7))) o31)))
...
;; H
  (assert
  (= result11 (ite (bvuge o34 (bvadd (t__content1 carry6) (t__content1
                                                          current_borrow6)))
              true false)))
...
;; H
  (assert
  (=> (= result11 true) (= future_borrow11 (mk_t__ref1 future_borrow9))))
...
;; H
  (assert
  (=> (not (= result11 true))
  (= future_borrow11 (mk_t__ref1 future_borrow10))))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.adb", line 415, characters 0-0
  ...
  (<= (to_rep2
      ...
      (rt1
      (rec__aco__math__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1563)))
(check-sat)
(exit)
