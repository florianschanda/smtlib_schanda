...
(declare-const temp___1335 (Array Int character))

(declare-const temp___13351 t)
...
;; H
  (assert
  (=> (= (length (mk___t temp___1333 temp___13331)) 0)
  (= (temp___String_Literal_1078 Tuple0) temp___1335)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1333 temp___13331)) 0))
  (=> (<= 1 5) (= o6 (+ (- 5 1) 1)))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1333 temp___13331)) 0))
  (= o9 (+ (to_rep1 (first temp___13331)) o8))))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___1333 temp___13331)) 0))
  (= (concat1 temp___1333 (to_rep1 (first temp___13331))
     (to_rep1 (last temp___13331)) (temp___String_Literal_1078 Tuple0) 1 5)
  temp___1335)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___1333 temp___13331)) 0))
  (= (mk (to_rep1 (first temp___13331)) o11) temp___13351)))

;; H
  (assert (not (= (length (mk___t temp___1335 temp___13351)) 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 (first temp___13351)) (to_rep1 (last temp___13351)))
  (= o13 (+ (- (to_rep1 (last temp___13351)) (to_rep1 (first temp___13351))) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 (first temp___13351)) (to_rep1 (last temp___13351))))
  (= o13 0)))
...
;; H
  (assert (= o15 (+ (to_rep1 (first temp___13351)) o14)))
