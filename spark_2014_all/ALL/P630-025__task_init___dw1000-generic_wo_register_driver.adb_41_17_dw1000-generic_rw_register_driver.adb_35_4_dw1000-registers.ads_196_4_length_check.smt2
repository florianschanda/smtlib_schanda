...
(declare-fun dummy4 () bits_64)

(declare-datatypes ()
((bits_64__ref (mk_bits_64__ref (bits_64__content bits_64)))))
(define-fun bits_64__ref___projection ((a bits_64__ref)) bits_64 (bits_64__content
                                                                 a))
...
;; range_int_axiom
  (assert
  (forall ((x bits_64)) (! (uint_in_range2
  (to_int5 x)) :pattern ((to_int5 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__dw1000__register_types__eui_type__eui bits_64)))))
(define-fun us_split_fields_EUI__projection ((a us_split_fields)) bits_64
  (rec__dw1000__register_types__eui_type__eui a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__eui_type__eui
...
(declare-fun dw1000__register_types__eui_type__eui__first__bit () Int)

(declare-fun dw1000__register_types__eui_type__eui__last__bit () Int)

(declare-fun dw1000__register_types__eui_type__eui__position () Int)

;; dw1000__register_types__eui_type__eui__first__bit_axiom
  (assert (<= 0 dw1000__register_types__eui_type__eui__first__bit))

;; dw1000__register_types__eui_type__eui__last__bit_axiom
  (assert
  (< dw1000__register_types__eui_type__eui__first__bit dw1000__register_types__eui_type__eui__last__bit))

;; dw1000__register_types__eui_type__eui__position_axiom
...
(declare-datatypes ()
((eui_type__ref (mk_eui_type__ref (eui_type__content us_rep)))))
(define-fun eui_type__ref___projection ((a eui_type__ref)) us_rep (eui_type__content
                                                                  a))
...
(define-fun dynamic_invariant ((temp___expr_1868 us_t1)
  (temp___is_init_1865 Bool) (temp___skip_constant_1866 Bool)
  (temp___do_toplevel_1867 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_1866 true))
                                       (and (dynamic_property2 1 8
                                       (first3 temp___expr_1868)
                                       (last3 temp___expr_1868))
                                       (and (= (first3 temp___expr_1868) 1)
                                       (= (last3 temp___expr_1868) 8)))))
...
(define-fun target__ref___projection ((a target__ref)) us_t2 (target__content
                                                             a))
...
(define-fun dynamic_invariant1 ((temp___expr_1884 us_t2)
  (temp___is_init_1881 Bool) (temp___skip_constant_1882 Bool)
  (temp___do_toplevel_1883 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_1882 true))
                                       (and (dynamic_property3 1 8
                                       (first5 temp___expr_1884)
                                       (last5 temp___expr_1884))
                                       (and (= (first5 temp___expr_1884) 1)
                                       (= (last5 temp___expr_1884) 8)))))
...
(declare-fun temp___7547 () (Array Int bits_8))

(declare-fun temp___75471 () t2)

(declare-fun temp___7548 () (Array Int bits_8))

(declare-fun temp___75481 () t1)

(define-fun temp___75472 () us_t2 (mk___t2 temp___7547 temp___75471))

;; H
  (assert
  (and (dynamic_property2 1 8 (to_rep reg_bytes__first)
  (to_rep reg_bytes__last))
  (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 8))))
