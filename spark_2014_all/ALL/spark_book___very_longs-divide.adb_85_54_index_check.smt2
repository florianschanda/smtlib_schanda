...
(define-fun dynamic_invariant3 ((temp___expr_702 Int)
...
;; H
  ...
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1227)
  (<= temp___1227 (to_rep1 (last number__split_fields3))))
  (=> (<= i2 temp___1227)
  (= (select number__split_fields2 temp___1227) (select number__split_fields temp___1227))))))
  (and (<= 1 i2) (<= i2 r121b))))
...
;; H
  (assert (= number__split_discrs (mk___split_discrs temp___1218)))

;; H
  (assert (= temp___12181 o15))

;; H
  (assert (= temp___12182 o16))
...
;; H
  ...
  (= number__split_fields4 (mk___split_fields
                           (mk___t temp___12181 temp___12182))))
