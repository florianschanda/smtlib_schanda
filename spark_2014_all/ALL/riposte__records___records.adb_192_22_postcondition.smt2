...
(declare-fun temp___301 () Bool)

(declare-fun temp___3011 () unsigned_byte)

(declare-fun temp___3012 () unsigned_byte)

(declare-fun o8 () unsigned_byte)

(declare-fun o9 () unsigned_byte)

(declare-fun o10 () unsigned_byte)

(declare-fun o11 () unsigned_byte)

(declare-fun o12 () unsigned_byte)

(declare-fun o13 () Bool)

(declare-fun o14 () unsigned_byte)

(declare-fun o15 () unsigned_byte)

(declare-fun temp___304 () us_rep1)
...
(declare-fun x__split_fields4 () us_split_fields2)

(declare-fun x__split_fields5 () us_split_fields__ref1)

(declare-fun tmp2 () int__ref)

(declare-fun x__split_fields6 () us_split_fields2)
...
;; H
  (assert (= result (mk_int__ref tmp)))

;; H
  (assert (= tmp1 (to_rep x__split_fields2)))

;; H
  (assert (= (to_rep o) (to_rep x__split_fields2)))

;; H
  (assert (= o o1))

;; H
  (assert (= x__split_fields2 o2))
...
;; H
  (assert (= temp___301 o5))

;; H
  (assert (= temp___3011 o6))

;; H
  (assert (= temp___3012 o7))
...
;; H
  (assert
  (= x__split_fields3 (mk___split_fields1 temp___301
                      (mk___rep (mk___split_fields temp___3011 temp___3012)))))
...
;; H
  ...
  (= (rec__records_prooffuncs__pair__a
     (us_split_fields1
     (rec__records_prooffuncs__optional_pair__the_pair x__split_fields3)))
  o9))
...
;; H
  (assert
  (= (rec__records_prooffuncs__optional_pair__exists x__split_fields3)
  o13))
...
;; H
  (assert
  (= temp___304 (mk___rep1
                (mk___split_fields1 o13
                (mk___rep (mk___split_fields o14 o15))))))

;; H
  (assert (= result2 (mk___split_fields__ref1 x__split_fields3)))

;; H
  (assert (= x__split_fields4 (us_split_fields3 temp___304)))
...
;; H
  (assert
  (= (rec__records_prooffuncs__optional_pair__exists
     (us_split_fields__content1 x__split_fields5)) true))

(assert
;; WP_parameter_def
 ;; File "records.adb", line 179, characters 0-0
