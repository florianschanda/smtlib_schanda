...
;; H
  (assert
  (and (= o4 (floor (mk___rep l__split_discrs l__split_fields8) 1))
  (ite (= (ite (= (= (length (mk___rep l__split_discrs l__split_fields8)) 0) false) (< 1 
          (first_key (mk___rep l__split_discrs l__split_fields8))) true) true)
  (= (bool_eq2 o4 no_element) true)
  (and
  (and
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields8)) o4) true)
  (not
  (< 1 (get1 (keys (mk___rep l__split_discrs l__split_fields8))
       (get (positions (mk___rep l__split_discrs l__split_fields8)) o4)))))
  (= (k_is_find (keys (mk___rep l__split_discrs l__split_fields8)) 1
     (get (positions (mk___rep l__split_discrs l__split_fields8)) o4)) true)))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o2 j) true)
  (=> (= (get o2 i) (get o2 j)) (= (bool_eq2 i j) true))))))))))

(assert
;; WP_parameter_def
 ;; File "my_ordered_maps.adb", line 145, characters 0-0
  (not (= (has_key o2 o4) true)))
(check-sat)
