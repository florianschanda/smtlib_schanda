...
(declare-fun temp___330 () index)

(declare-fun temp___3301 () (Array Int value))

(declare-fun temp___3302 () (Array Int value))
...
(declare-fun temp___333 () index)

(declare-fun temp___3331 () (Array Int value))

(declare-fun temp___3332 () (Array Int value))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 183, characters 0-0
  (not
  (not
  (= (bool_eq1
     (mk___rep
