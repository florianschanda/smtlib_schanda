...
(((mk___split_fields
  (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl bits_32)))))
(define-fun us_split_fields_RF_TXCTRL__projection ((a us_split_fields)) bits_32
  (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___56__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___56__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl
...
;; dw1000__register_types__rf_txctrl_type__rf_txctrl__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__rf_txctrl_type__rf_txctrl__first__bit))

;; dw1000__register_types__rf_txctrl_type__rf_txctrl__last__bit_axiom
  (assert
  (< dw1000__register_types__rf_txctrl_type__rf_txctrl__first__bit dw1000__register_types__rf_txctrl_type__rf_txctrl__last__bit))

;; dw1000__register_types__rf_txctrl_type__rf_txctrl__position_axiom
...
(declare-datatypes ((rf_txctrl_type__ref 0))
(((mk_rf_txctrl_type__ref (rf_txctrl_type__content us_rep)))))
(define-fun rf_txctrl_type__ref___projection ((a rf_txctrl_type__ref)) us_rep
  (rf_txctrl_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___132__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___93__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___93__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5301 us_t1)
  (temp___is_init_5298 Bool) (temp___skip_constant_5299 Bool)
  (temp___do_toplevel_5300 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5299 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_5301)
                                       (last3 temp___expr_5301))
                                       (and (= (first3 temp___expr_5301) 1)
                                       (= (last3 temp___expr_5301) 4)))))
