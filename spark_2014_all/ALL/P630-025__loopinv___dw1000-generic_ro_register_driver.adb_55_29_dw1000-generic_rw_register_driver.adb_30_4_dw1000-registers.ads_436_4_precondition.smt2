...
(define-fun us_split_fields__ref_56__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_56__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(define-fun register_type__ref_132__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_93__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_93__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5217 us_t1)
  (temp___is_init_5214 Bool) (temp___skip_constant_5215 Bool)
  (temp___do_toplevel_5216 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5215 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_5217)
                                       (last3 temp___expr_5217))
                                       (and (= (first3 temp___expr_5217) 1)
                                       (= (last3 temp___expr_5217) 4)))))
