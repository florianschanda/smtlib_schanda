...
(define-fun o51 () us_rep (mk___rep (mk___split_fields o16 o17)))

(define-fun o52 () us_rep (mk___rep (mk___split_fields o10 o11)))

(define-fun o53 () us_rep (mk___rep (mk___split_fields o4 o5)))
...
;; H
  ...
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o52) true))
...
;; H
  ...
  (= (bool_eq
     ...
     (mk___rep2 c__split_fields3)) o51) true))
  (= (get2
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
     o51) 3))
  ...
  (= (keys_included_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__insert__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields2)) o51) true))
...
;; H
  ...
  (= (elements_equal_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__replace__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields4)) o22) true)))
...
;; H
  ...
  (= (elements_equal_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields6)) o26) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (= (elements_equal_except
     (model__
     (mk___rep1 l__split_discrs my_maps__n__include__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields7)) o30) true))
  (and
  (and
  (and
  (and
...
;; H
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep1 l__split_discrs my_maps__n__delete__container__fields))
     (find1 (mk___rep1 l__split_discrs l__split_fields8) o34)) true)))
...
;; H
  (assert
  (and
  (= temp___1143 (find1 (mk___rep1 l__split_discrs l__split_fields9) o38))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields9))
               o38) false) true false)
  (= (bool_eq2 temp___1143 no_element) true)
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1143) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1143) (find (keys (mk___rep1 l__split_discrs l__split_fields9))
                  o38)))
  (= (= (to_rep1
        (rec__my_maps__my_rec__f
        (us_split_fields1
        (key (mk___rep1 l__split_discrs l__split_fields9) temp___1143))))
  (to_rep1 (rec__my_maps__my_rec__f (us_split_fields1 o38)))) true)))))
...
;; H
  ...
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields10))
     (mk___rep (mk___split_fields (of_rep1 2) (of_rep 5)))) true)))
...
;; H
  (assert
  (and
  (= temp___1145 (find1 (mk___rep1 l__split_discrs l__split_fields10) o42))
  (ite (ite (= (has_key1
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
               o42) false) true false)
  (= (bool_eq2 temp___1145 no_element) true)
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1145) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1145) (find (keys (mk___rep1 l__split_discrs l__split_fields10))
                  o42)))
  (= (= (to_rep1
        (rec__my_maps__my_rec__f
        (us_split_fields1
        (key (mk___rep1 l__split_discrs l__split_fields10) temp___1145))))
...
;; H
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields))
     (find1 (mk___rep1 l__split_discrs l__split_fields10) o46)) true)))))
...
;; H
  ...
  (= (has_key1 (model__ (mk___rep1 l__split_discrs l__split_fields11))
     (mk___rep (mk___split_fields (of_rep1 1) (of_rep 8)))) true))
...
;; H
  ...
  (= (keys_included_except1
     ...
     (positions
     (mk___rep1 l__split_discrs my_maps__n__exclude__container__fields1))
     (find1 (mk___rep1 l__split_discrs l__split_fields11) o50)) true)))))
