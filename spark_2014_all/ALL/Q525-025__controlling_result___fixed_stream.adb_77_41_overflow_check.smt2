...
(declare-fun dummy5 () stream_element)
...
(define-fun bool_eq9 ((a (Array Int stream_element)) (a__first Int)
...
(declare-fun in_string () us_t)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun out_stream__first () tstream_element_offsetB)

(declare-fun out_stream__last () tstream_element_offsetB)
...
(define-fun dynamic_invariant6 ((temp___expr_142 (_ BitVec 8))
  (temp___is_init_139 Bool) (temp___skip_constant_140 Bool)
  (temp___do_toplevel_141 Bool)) Bool true)

(define-fun dynamic_invariant7 ((temp___expr_148 Int)
...
(declare-fun out_stream () (Array Int stream_element))
...
(declare-fun fixed_stream__convert__out_stream__assume () (Array Int stream_element))
...
(declare-fun o8 () stream_element)

(declare-fun result () Int)

(declare-fun len1 () Int)

(declare-fun result1 () (Array Int stream_element))

(declare-fun out_stream1 () (Array Int stream_element))
...
(define-fun fixed_stream__convert__out_stream__assume2 () us_t1 (mk___t1
                                                                fixed_stream__convert__out_stream__assume
                                                                fixed_stream__convert__out_stream__assume1))
...
;; H
  ...
  o (to_rep2 (rec__fixed_stream__object__width (us_split_fields1 this))))))
...
;; H
  (assert
  (= (to_rep4 out_stream__first) (to_rep4
                                 (first2
                                 fixed_stream__convert__out_stream__assume1))))

;; H
  (assert
  (= (to_rep4 out_stream__last) (to_rep4
                                (last2
                                fixed_stream__convert__out_stream__assume1))))

;; H
  (assert (dynamic_property1 (- 9223372036854775808) 9223372036854775807
  (to_rep4 out_stream__first) (to_rep4 out_stream__last)))
...
;; WP_parameter_def
 ;; File "a-stream.ads", line 54, characters 0-0
  (not (in_range5 (+ (to_rep4 out_stream__first) i2))))
(check-sat)
