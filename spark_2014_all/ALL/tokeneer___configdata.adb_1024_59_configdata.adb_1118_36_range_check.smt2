...
(declare-fun c44b () (Array Int character))
...
(declare-fun o46 () (Array Int character))

(declare-fun o47 () Int)

(declare-fun o48 () character)

(declare-fun o49 () (Array Int character))
...
(declare-fun o54 () (Array Int character))
...
(declare-fun localtext8 () (Array Int character))

(declare-fun result10 () int__ref)

(declare-fun localvalue5 () Int)

(declare-fun result11 () map__ref)

(declare-fun localtext9 () (Array Int character))

(declare-fun result12 () map__ref)

(declare-fun localtext10 () (Array Int character))

(declare-fun result13 () int__ref)

(declare-fun localvalue6 () Int)

(declare-fun result14 () map__ref)

(declare-fun localtext11 () (Array Int character))

(declare-fun result15 () map__ref)

(declare-fun localtext12 () (Array Int character))

(declare-fun result16 () map__ref)

(declare-fun c44b1 () (Array Int character))

(declare-fun result17 () map__ref)

(declare-fun localtext13 () (Array Int character))

(declare-fun result18 () int__ref)

(declare-fun localvalue7 () Int)

(declare-fun result19 () map__ref)

(declare-fun localtext14 () (Array Int character))

(declare-fun result20 () map__ref)

(declare-fun localtext15 () (Array Int character))

(declare-fun result21 () int__ref)

(declare-fun localvalue8 () Int)
...
;; H
  (assert (= localtext3 (temp___String_Literal_1147 Tuple0)))
...
;; H
  (assert
  (and (= o32 (+ 48 (div1 localvalue3 10))) (in_range3
...
;; H
  (assert
  (and (= o37 (+ 48 (div1 localvalue4 10))) (in_range3
  (+ 48 (div1 localvalue4 10)))))
...
;; H
  (assert (= localtext8 (temp___String_Literal_1148 Tuple0)))
...
;; H
  (assert
  (and (= o42 (+ 48 (div1 localvalue5 10))) (in_range3
  (+ 48 (div1 localvalue5 10)))))
...
;; H
  (assert
  (and (= o47 (+ 48 (div1 localvalue6 10))) (in_range3
  (+ 48 (div1 localvalue6 10)))))
...
;; H
  (assert (= localtext13 (temp___String_Literal_1149 Tuple0)))
...
;; H
  (assert
  (and (= o52 (+ 48 (div1 localvalue7 10))) (in_range3
  (+ 48 (div1 localvalue7 10)))))
...
;; WP_parameter_def
 ;; File "configdata.adb", line 1359, characters 0-0
  (not (in_range3 (+ 48 (div1 localvalue8 10)))))
(check-sat)
(exit)
