...
(declare-datatypes ((aon_ctrl_type__ref 0))
(((mk_aon_ctrl_type__ref (aon_ctrl_type__content us_rep)))))
...
(define-fun us_split_fields__ref___69__projection ((a us_split_fields__ref1)) us_split_fields2
  (us_split_fields__content1 a))

(declare-datatypes ((us_rep1 0))
(((mk___rep1 (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___69__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                   a))
...
(declare-datatypes ((aon_rdat_type__ref 0))
...
(define-fun us_split_fields__ref___70__projection ((a us_split_fields__ref2)) us_split_fields4
  (us_split_fields__content2 a))

(declare-datatypes ((us_rep2 0))
(((mk___rep2 (us_split_fields5 us_split_fields4)))))
(define-fun us_rep___70__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                   a))
...
(declare-datatypes ((aon_addr_type__ref 0))
...
(((mk_t47b__ref (t47b__content integer)))))
...
(declare-datatypes ((t48b__ref 0)) (((mk_t48b__ref (t48b__content us_t1)))))
...
;; def_axiom
  ...
  (and (= (first3 temp___3376) temp___3378)
  (= (last3 temp___3376) temp___3379)))
...
(declare-const temp___3382 (Array Int bits_8))

(declare-const temp___33821 t1)

(declare-const temp___3383 (Array Int bits_8))

(declare-const temp___33831 t)

(declare-const temp___3384 (Array Int bits_8))

(declare-const temp___33841 t)
...
(declare-const temp___3393 Int)

(declare-const temp___3385 Int)

(declare-const o3 Int)

(declare-const o4 bits_8)

(declare-const o5 bits_8)

(declare-const o6 bits_8)

(declare-const o7 bits_3)
...
(declare-const o24 bits_3)

(declare-const o25 bits_3)
...
(declare-const o42 bits_3)

(declare-const o43 bits_8)
...
(declare-const aon_rdat_reg__split_fields bits_8)

(declare-const i2 Int)

(declare-const dw1000__registers__aon_rdat__read__reg__fields bits_8)

(declare-const result2 bits_8)

(declare-const aon_rdat_reg__split_fields1 us_split_fields2)
...
;; H
  (assert
  (= (mk (to_rep (first2 temp___33821)) (to_rep (last2 temp___33821)))
  temp___33831))
...
;; H
  (assert
  (= (mk___t temp___3384 temp___33841) (mk___t temp___3383 temp___33831)))

;; H
  (assert
  (= o (slide temp___3384 (to_rep (first temp___33841)) (to_rep data__first))))
...
;; H
  ...
  (= o1 (+ (- (to_rep data__last) (to_rep data__first)) 1))))
...
;; H
  (assert (<= i1 temp___3393))

;; H
  (assert
  (and (<= 0 i2)
  (<= i2 (- (ite (<= (to_rep data__first) (to_rep data__last))
            (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 1))))

;; H
  (assert (and (= temp___3385 (+ a_first i2)) (in_range1 (+ a_first i2))))

;; H
  (assert
  (and (<= (to_rep (first (rt addresses))) temp___3385)
  (<= temp___3385 (to_rep (last (rt addresses))))))

;; H
  (assert (= o3 temp___3385))

;; H
  (assert (= o4 (select (elts addresses) o3)))
...
;; H
  (assert (= (to_rep2 o7) ((_ int2bv 8) 0)))

;; H
  (assert (= (to_rep1 o8) ((_ int2bv 8) 1)))

;; H
  (assert (= (to_rep1 o9) ((_ int2bv 8) 0)))

;; H
  (assert (= (to_rep1 o10) ((_ int2bv 8) 0)))

;; H
  (assert (= (to_rep1 o11) ((_ int2bv 8) 0)))

;; H
  (assert (= (to_rep1 o12) ((_ int2bv 8) 0)))
...
;; H
  (assert (= (to_rep2 o25) ((_ int2bv 8) 0)))

;; H
  (assert (= (to_rep1 o26) ((_ int2bv 8) 1)))

;; H
  (assert (= (to_rep1 o27) ((_ int2bv 8) 1)))

;; H
  (assert (= (to_rep1 o28) ((_ int2bv 8) 0)))

;; H
  (assert (= (to_rep1 o29) ((_ int2bv 8) 0)))

;; H
  (assert (= (to_rep1 o30) ((_ int2bv 8) 0)))
...
;; H
  (assert (= result2 aon_rdat_reg__split_fields))

;; H
  (assert
  (= aon_rdat_reg__split_fields1 (mk___split_fields1
                                 dw1000__registers__aon_rdat__read__reg__fields)))

;; H
  (assert
  (= (to_rep3 o43) (to_rep3
                   (rec__dw1000__register_types__aon_rdat_type__aon_rdat
                   aon_rdat_reg__split_fields1))))

(assert
;; WP_parameter_def
 ;; File "dw1000-driver.adb", line 936, characters 0-0
  (not (in_range1 (+ d_first i2))))
(check-sat)
(exit)
