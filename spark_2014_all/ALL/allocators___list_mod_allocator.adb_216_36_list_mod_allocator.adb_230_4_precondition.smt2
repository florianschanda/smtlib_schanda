...
;; H
  (assert
  (and (= o19 (model__ (map__content data6) first_available1))
  (= (model_is_well_formed o19 (map__content data6) first_available1) true)))
...
;; H
  (assert
  (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (get c143b j1) j1))))
