...
(declare-fun test_01__databaseT__cache__first__bit () Int)

(declare-fun test_01__databaseT__cache__last__bit () Int)

(declare-fun test_01__databaseT__cache__position () Int)
