...
;; H
  (assert (and (= o33 (+ k 1)) (in_range1 (+ k 1))))

;; H
  (assert (= o34 (ite (<= j3 o33) true false)))

;; H
  (assert (= o29 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o30 (oexpon o29 j3)))

;; H
  (assert (= o24 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o23 (from_integer j3)))

;; H
  (assert (= o25 (osubtract o23 o24)))

;; H
  (assert (= o22 (from_word64 i2)))

;; H
  (assert (= o26 (osubtract o22 o25)))
...
;; H
  (assert (and (= o10 (- j3 s3)) (in_range1 (- j3 s3))))
...
;; H
  (assert (= o8 (from_word32 w2)))

;; H
  (assert (= o15 (omultiply o8 o14)))

;; H
  (assert (= o32 (oeq o15 o31)))
