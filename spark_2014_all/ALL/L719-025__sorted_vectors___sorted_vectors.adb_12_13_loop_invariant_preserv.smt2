...
;; H
  (assert (and (= o3 (+ position2 1)) (in_range3 (+ position2 1))))

;; H
  (assert (= position2 result3))
...
;; H
  (assert (= result5 (ite (<= position3 o5) true false)))
...
;; H
  (assert (=> (= result5 true) (= o6 (ite (< o4 new_item) true false))))

;; H
  (assert (=> (not (= result5 true)) (= o6 false)))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 855, characters 0-0
  ...
  (< (get
     (model__
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))) (- position3 1)) new_item))))
(check-sat)
(exit)
