...
(((mk_str_length__ref (str_length__content str_length)))))
...
(((mk_str_index__ref (str_index__content str_index)))))
...
(declare-datatypes ((str__ref 0)) (((mk_str__ref (str__content us_rep)))))
