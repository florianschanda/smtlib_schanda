...
(declare-fun temp___562 () (Array Int component_t))
...
(declare-fun a_loop_entry2 () (Array Int component_t))

(declare-fun j7 () Int)

(declare-fun a9 () (Array Int component_t))

(declare-fun a_loop_entry3 () (Array Int component_t))
...
;; H
  (assert
  (=> (and (<= first j1) (<= j1 last)) (= (mk_map__ref result2) a11)))
...
;; H
  ...
  (= (bool_eq a3 1 1000 (temp___564 a_loop_entry1 first j2 0) 1 1000) true)))
...
;; H
  ...
  (=> (< j2 temp___563)
  (= (select a3 temp___563) (select temp___562 temp___563))))))
...
;; WP_parameter_def
 ;; File "loop_entry_test.ads", line 8, characters 0-0
  (not (= (bool_eq a8 1 1000 (temp___542 a first last 0) 1 1000) true)))
(check-sat)
(exit)
