...
;; H
  ...
  (and
  (ite (= (ite (= (bool_eq2 (mk___rep1 c__split_fields2) no_element) false) (= 
          (get1 (positions l) (mk___rep1 c__split_fields2)) (length2 l)) true) true)
  (= (bool_eq2 (mk___rep1 c__split_fields3) no_element) true)
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not (= (element l (cursor__content lists__search__result13)) 0)))
(check-sat)
