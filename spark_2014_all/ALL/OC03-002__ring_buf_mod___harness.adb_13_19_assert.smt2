...
;; H
  (assert
  (= (let ((temp___223 (to_model (mk___rep r__split_fields14))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields14)) x)))
     (let ((temp___230 (to_model (mk___rep r__split_fields13))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields13)) y)))
     (let ((temp___230 (to_model (mk___rep r__split_fields12))))
     (bool_eq (elts temp___230) (to_rep (first (rt temp___230)))
     (to_rep (last (rt temp___230))) (elts temp___231)
     (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields12)))))
  ...
  (= h1 (func_head (to_model (mk___rep r__split_fields12))))) (in_range
  h1)))
