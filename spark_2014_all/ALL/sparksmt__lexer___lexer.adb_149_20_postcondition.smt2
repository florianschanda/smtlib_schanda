...
;; H
  (assert
  (and (= temp___927 next_read__split_discrs)
  (and (= temp___9271 next_read__split_fields)
  (= temp___9272 next_read__attr__constrained))))
...
;; H
  (assert
  (and (= temp___923 current_read__split_discrs)
  (and (= temp___9231 current_read__split_fields)
  (= temp___9232 current_read__attr__constrained))))
