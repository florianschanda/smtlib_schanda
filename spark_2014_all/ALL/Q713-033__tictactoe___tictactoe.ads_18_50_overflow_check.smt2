...
;; H
  ...
  (=> (<= 3 x)
  (=> (<= 3 y)
  (and (= o18 (one_free_slot 3 3 my_board))
  (and (in_range o18)
  (= o18 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))
...
;; H
  ...
  (=> (<= 3 x)
  (=> (<= 2 y)
  (and (= o15 (one_free_slot 3 2 my_board))
  (and (in_range o15)
  (= o15 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))
...
;; H
  (assert
  (=> (<= 3 x)
  (and (= o16 (one_free_slot 3 1 my_board))
  (and (in_range o16)
  (= o16 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0))))))
