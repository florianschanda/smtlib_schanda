...
(declare-fun x__split_fields () positive)
...
;; H
  ...
  (mk___split_fields x__split_fields x__split_fields1) x__attr__tag) false))

;; H
  (assert (= (of_int 1) (rec__private_types__p2__t__d x__split_discrs)))
