...
(declare-fun has_failed7 () bool__ref)
...
(declare-fun has_failed9 () bool__ref)
...
;; H
  (assert
  (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))
  (= temp___882 target4)))
...
;; H
  (assert
  (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))
  (= result2 (ite (not (= o6 true)) true false))))
...
;; H
  (assert
  (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))
  (= has_failed7 (mk_bool__ref has_failed6))))

;; H
  (assert
  (=> (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source)))))
  (= target7 (mk_int__ref target6))))
...
;; H
  (assert
  (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))))
  (= i5 (mk_int__ref i1))))

;; H
  (assert
  (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))))
  (= has_failed9 (mk_bool__ref has_failed4))))

;; H
  (assert
  (=> (not (and (<= temp___883 i1) (<= i1 (to_rep1 (last (rt source))))))
  (= target9 (mk_int__ref target4))))
