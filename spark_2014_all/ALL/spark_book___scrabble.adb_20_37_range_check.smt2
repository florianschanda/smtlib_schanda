...
(((mk_map__ref (map__content (Array Int scrabble_letter))))))
...
(define-fun bool_eq ((a (Array Int scrabble_letter)) (a__first Int)
...
(((mk___t (elts (Array Int scrabble_letter))(rt t)))))
...
(declare-datatypes ((scrabble_word__ref 0))
(((mk_scrabble_word__ref (scrabble_word__content us_t)))))
...
(declare-datatypes ((scrabble_score__ref 0))
...
(((mk_map__ref1 (map__content1 (Array Int scrabble_value))))))
...
(define-fun bool_eq2 ((a (Array Int scrabble_value)) (a__first Int)
