...
(declare-fun temp___646 () us_rep3)
...
;; H
  (assert
  (and (= temp___646 (keys (mk___rep r__split_discrs r__split_fields2)))
  (and
  (and
  (and
  (= (length3 temp___646) (length
                          (mk___rep r__split_discrs r__split_fields2)))
  (forall ((temp___396 Int))
  (=>
  (and (in_range3 temp___396)
  (= (iter_has_element temp___646 temp___396) true))
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2))
     (get temp___646 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range2 key2)
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields2)) key2) true))
  (and (< 0 (find temp___646 key2))
  (= (equivalent_keys (get temp___646 (find temp___646 key2)) key2) true)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i) (<= i (length (mk___rep r__split_discrs r__split_fields2))))
  (and (= (find temp___646 (get temp___646 i)) i)
  (= (k_is_find temp___646 (get temp___646 i) i) true)))))))

;; H
  (assert
  (and (= o (iter_has_element temp___646 temp___645))
  (= (= o true) (and (<= 1 temp___645) (<= temp___645 (last temp___646))))))
...
;; H
  (assert (and (= k (get temp___646 temp___645)) (in_range4 k)))
...
;; H
  ...
  (forall ((i us_rep1))
  (=> (= (has_key1 o2 i) true)
  (and (and (<= 1 (get1 o2 i)) (<= (get1 o2 i) (length s)))
  (forall ((j us_rep1))
  (=> (= (has_key1 o2 j) true)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (has_key1 o2 (mk___rep1 cu__split_fields3)) true)))
(check-sat)
(exit)
