...
;; wibble_0__post_axiom
  ...
  (forall ((levels__x0 Int))
  (! (=> (dynamic_invariant levels__x0 true true true) (dynamic_invariant
     (wibble_0 levels__x0) true false true)) :pattern ((wibble_0 levels__x0)) )))

;; wibble_0__def_axiom
  (assert
  (forall ((levels__x0 Int))
  (! (=> (dynamic_invariant levels__x0 true true true)
     (= (wibble_0 levels__x0) (+ (read_partial_0 levels__x0) 1))) :pattern (
  (wibble_0 levels__x0)) )))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (< (read_partial_0 x0) (wibble_0 x0))))
(check-sat)
(exit)
