...
;; H
  (assert
  (and (= o2 (bvadd dst1 (bvsub c238b ((_ int2bv 64) 1)))) (in_range3
  (bvadd dst1 (bvsub c238b ((_ int2bv 64) 1))))))
...
;; H
  (assert
  (and (bvule (to_rep2 (first (rt msg))) src1)
  (bvule src1 (to_rep2 (last (rt msg))))))
