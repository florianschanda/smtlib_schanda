...
(declare-const lists__cell__is_set__first__bit1 Int)

(declare-const lists__cell__is_set__last__bit1 Int)

(declare-const lists__cell__is_set__position1 Int)
...
(declare-const lists__cell__next__first__bit1 Int)

(declare-const lists__cell__next__last__bit1 Int)

(declare-const lists__cell__next__position1 Int)
...
(declare-const memory11 (Array Int us_rep))

(declare-const memory12 (Array Int us_rep))

(declare-const memory13 (Array Int us_rep))
