...
(define-fun us_split_fields_RXPRF__2__projection ((a us_split_fields)) bits_2
...
(define-fun us_split_fields_Reserved__3__projection ((a us_split_fields)) bits_9
  (rec__dw1000__register_types__chan_ctrl_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___24__projection ((a us_split_fields__ref)) us_split_fields
...
(define-fun register_type__ref___52__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___38__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___38__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3299 us_t1)
  (temp___is_init_3296 Bool) (temp___skip_constant_3297 Bool)
  (temp___do_toplevel_3298 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3297 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3299)
                                       (last3 temp___expr_3299))
                                       (and (= (first3 temp___expr_3299) 1)
                                       (= (last3 temp___expr_3299) 4)))))
...
(define-fun target__ref___15__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___15__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_3323 us_t2)
  (temp___is_init_3320 Bool) (temp___skip_constant_3321 Bool)
  (temp___do_toplevel_3322 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3321 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_3323)
                                       (last5 temp___expr_3323))
                                       (and (= (first5 temp___expr_3323) 1)
                                       (= (last5 temp___expr_3323) 4)))))
...
(define-fun temp___78072 () us_t2 (mk___t2 temp___7807 temp___78071))
...
;; H
  (assert
  (and (= temp___78072 (register_to_bytes reg)) (dynamic_invariant1
  temp___78072 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___78071)) (to_rep (last4 temp___78071)))
     (+ (- (to_rep (last4 temp___78071)) (to_rep (first4 temp___78071))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7807 temp___7808))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78071)) (to_rep (last4 temp___78071)))
  temp___78081))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___78081)) (to_rep (last2 temp___78081)))
     (+ (- (to_rep (last2 temp___78081)) (to_rep (first2 temp___78081))) 1)
