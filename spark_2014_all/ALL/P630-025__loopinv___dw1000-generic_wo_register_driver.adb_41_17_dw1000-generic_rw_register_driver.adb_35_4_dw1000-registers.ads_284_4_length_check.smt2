...
;; range_axiom
  (assert
  (forall ((x bits_9)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)) )))
...
(define-fun us_split_fields_TX_CHAN__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__chan_ctrl_type__tx_chan a))

(define-fun us_split_fields_RX_CHAN__projection ((a us_split_fields)) bits_4
  (rec__dw1000__register_types__chan_ctrl_type__rx_chan a))

(define-fun us_split_fields_DWSFD__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__chan_ctrl_type__dwsfd a))

(define-fun us_split_fields_RXPRF2__projection ((a us_split_fields)) bits_2
  (rec__dw1000__register_types__chan_ctrl_type__rxprf a))

(define-fun us_split_fields_TNSSFD__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__chan_ctrl_type__tnssfd a))

(define-fun us_split_fields_RNSSFD__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__chan_ctrl_type__rnssfd a))

(define-fun us_split_fields_TX_PCODE__projection ((a us_split_fields)) bits_5
  (rec__dw1000__register_types__chan_ctrl_type__tx_pcode a))

(define-fun us_split_fields_RX_PCODE__projection ((a us_split_fields)) bits_5
  (rec__dw1000__register_types__chan_ctrl_type__rx_pcode a))

(define-fun us_split_fields_Reserved3__projection ((a us_split_fields)) bits_9
  (rec__dw1000__register_types__chan_ctrl_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_24__projection ((a us_split_fields__ref)) us_split_fields
...
(declare-datatypes ()
((chan_ctrl_type__ref
 (mk_chan_ctrl_type__ref (chan_ctrl_type__content us_rep)))))
(define-fun chan_ctrl_type__ref___projection ((a chan_ctrl_type__ref)) us_rep
  (chan_ctrl_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_52__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_38__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_38__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3269 us_t1)
  (temp___is_init_3266 Bool) (temp___skip_constant_3267 Bool)
  (temp___do_toplevel_3268 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3267 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3269)
                                       (last3 temp___expr_3269))
                                       (and (= (first3 temp___expr_3269) 1)
                                       (= (last3 temp___expr_3269) 4)))))
...
(define-fun target__ref_15__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_15__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_3293 us_t2)
  (temp___is_init_3290 Bool) (temp___skip_constant_3291 Bool)
  (temp___do_toplevel_3292 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3291 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_3293)
                                       (last5 temp___expr_3293))
                                       (and (= (first5 temp___expr_3293) 1)
                                       (= (last5 temp___expr_3293) 4)))))
...
(declare-fun temp___7660 () (Array Int bits_8))

(declare-fun temp___76601 () t2)

(declare-fun temp___7661 () (Array Int bits_8))

(declare-fun temp___76611 () t1)

(define-fun temp___76602 () us_t2 (mk___t2 temp___7660 temp___76601))
...
;; H
  (assert
  (and (= temp___76602 (register_to_bytes reg)) (dynamic_invariant1
  temp___76602 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___76601)) (to_rep (last4 temp___76601)))
     (+ (- (to_rep (last4 temp___76601)) (to_rep (first4 temp___76601))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___7660 temp___7661))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___76601)) (to_rep (last4 temp___76601)))
  temp___76611))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___76611)) (to_rep (last2 temp___76611)))
     (+ (- (to_rep (last2 temp___76611)) (to_rep (first2 temp___76611))) 1)
