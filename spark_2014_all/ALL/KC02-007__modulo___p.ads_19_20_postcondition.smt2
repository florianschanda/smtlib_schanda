...
(declare-const p__id__result (_ BitVec 8))

(declare-const result (_ BitVec 8))

(declare-const p__id__result1 (_ BitVec 8))

(declare-const p__id__result2 (_ BitVec 8))

(declare-const p__id__result3 (_ BitVec 8))

(declare-const p__id__result4 (_ BitVec 8))

(declare-const p__id__result5 (_ BitVec 8))
...
;; H
  (assert (= result p__id__result))

;; H
  (assert (= p__id__result1 x))

;; H
  (assert (= (mk_t__ref p__id__result4) (mk_t__ref p__id__result2)))
