...
(define-fun dynamic_invariant ((temp___expr_352 Int)
...
(define-fun default_initial_assumption1 ((temp___expr_415 us_rep3)
...
(define-fun default_initial_assumption3 ((temp___expr_396 us_rep2)
...
(define-fun dynamic_invariant4 ((temp___expr_383 Int)
...
(declare-fun temp___676 () count_type)
