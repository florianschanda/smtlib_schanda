...
;; H
  (assert
  (and (= 0 (to_rep (rec__membership_discr__root__c r00__split_discrs)))
  (= r00__attr__tag us_tag1)))

;; H
  (assert (= c00__attr__tag us_tag2))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= 0 (to_rep (rec__membership_discr__root__c c00__split_discrs)))))
(check-sat)
(exit)
