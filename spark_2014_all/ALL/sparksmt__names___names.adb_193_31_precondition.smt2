...
;; range_axiom
  (assert
  (forall ((x name_id)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
;; range_axiom
  (assert
  (forall ((x positive)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
;; H
  (assert
  (and
  (= o (valid_hashes hash_table
       (mk___split_fields1 entry_table__split_fields)))
  (= (= o true)
  (forall ((h (_ BitVec 32)))
  (=> (and (bvule ((_ int2bv 32) 0) h) (bvule h ((_ int2bv 32) 255)))
  (<= (to_rep (select hash_table h)) (last1
                                     (model__1
...
;; H
  (assert
  (and
  (= result (valid_tables (mk___split_fields char_table__split_fields)
            (mk___split_fields1 entry_table__split_fields)))
  (= (= result true)
  (and
  (<= (last1
  ...
  (<= (last
      ...
      (mk___split_fields char_table__split_fields)))) 2147483646)))))
