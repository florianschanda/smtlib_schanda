...
;; H
  ...
  (and (<= 1 i1)
  (<= i1 (- (get1 (positions s) (mk___rep1 cu__split_fields3)) 1)))
  (= (get temp___871 temp___870) (f (get (elements s) i1)))))))))
...
;; H
  ...
  (and
  (and
  (and (= (length2 o4) (length s))
  (forall ((temp___425 Int))
  (=> (and (in_range2 temp___425) (= (iter_has_element o4 temp___425) true))
  (= (contains (model__ s) (get o4 temp___425)) true))))
  (forall ((item Int))
  (=> (and (in_range5 item) (= (contains (model__ s) item) true))
  (and (< 0 (find o4 item)) (= (get o4 (find o4 item)) item)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s))) (= (find o4 (get o4 i1)) i1))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length s)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length s)))
  (=> (= (get o4 i1) (get o4 j)) (= i1 j)))))))))
