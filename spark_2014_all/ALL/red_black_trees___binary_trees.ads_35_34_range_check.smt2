...
;; size__post_axiom
  (assert
  (forall ((f1 us_rep1))
  (! (=> (type_invariant f1) (dynamic_invariant2 (size f1) true false true)) :pattern (
  (size f1)) )))
...
;; valid_root__post_axiom
  ...
  (! (=> (and (dynamic_invariant i1 true true true) (type_invariant f1))
     (=> (< (size f1) i1) (not (= (valid_root f1 i1) true)))) :pattern (
  (valid_root f1 i1)) ))))
  ...
  (! (= (= (valid_root f1 i1) true)
     ...
     (= (to_rep1
        ...
        (let ((temp___288 (rec__binary_trees__forest__c
                          (us_split_fields3 f1))))
        (select temp___288 i1))))) 2))) :pattern ((valid_root f1 i1)) ))))
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 15, characters 0-0
  (not (in_range1 binary_trees__peek__result4)))
(check-sat)
