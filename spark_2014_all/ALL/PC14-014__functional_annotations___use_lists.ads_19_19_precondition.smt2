...
;; H
  ...
  (= (get (model__ l) (get1 (positions l) o10)) e))
  (=> (not (= (bool_eq1 no_element no_element) true))
  (<= (get1 (positions l) no_element) (get1 (positions l) o10))))
  (not
  (= (contains (model__ l)
     (ite (= (bool_eq1 no_element no_element) true) 1
     (get1 (positions l) no_element)) (- (get1 (positions l) o10) 1)
     e) true))))))
...
;; H
  ...
  (= (get (model__ l) (get1 (positions l) o9)) e))
  (=> (not (= (bool_eq1 no_element no_element) true))
  (<= (get1 (positions l) no_element) (get1 (positions l) o9))))
  (not
  (= (contains (model__ l)
     (ite (= (bool_eq1 no_element no_element) true) 1
     (get1 (positions l) no_element)) (- (get1 (positions l) o9) 1) e) true))))))
