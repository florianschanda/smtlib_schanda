...
(define-fun register_type__ref___23__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___16__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___16__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2411 us_t1)
  (temp___is_init_2408 Bool) (temp___skip_constant_2409 Bool)
  (temp___do_toplevel_2410 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2409 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2411)
                                       (last3 temp___expr_2411))
                                       (and (= (first3 temp___expr_2411) 1)
                                       (= (last3 temp___expr_2411) 4)))))
