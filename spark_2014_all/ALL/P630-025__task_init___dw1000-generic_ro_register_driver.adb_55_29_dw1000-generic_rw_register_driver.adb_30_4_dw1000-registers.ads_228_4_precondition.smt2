...
(define-fun register_type__ref_23__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_16__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_16__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2395 us_t1)
  (temp___is_init_2392 Bool) (temp___skip_constant_2393 Bool)
  (temp___do_toplevel_2394 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2393 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2395)
                                       (last3 temp___expr_2395))
                                       (and (= (first3 temp___expr_2395) 1)
                                       (= (last3 temp___expr_2395) 4)))))
