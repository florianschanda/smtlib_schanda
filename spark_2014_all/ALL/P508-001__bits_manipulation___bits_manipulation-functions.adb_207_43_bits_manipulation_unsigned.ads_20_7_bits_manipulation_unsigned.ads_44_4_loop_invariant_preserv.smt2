...
;; H
  (assert
  (=> (< (- i3 1) 4294967296)
  (= o2 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) (- i3 1))))))

;; H
  (assert (=> (not (< (- i3 1) 4294967296)) (= o2 ((_ int2bv 32) 0))))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= (bvand result__4 (let ((temp___444 (- i3 1)))
                      (ite (< temp___444 4294967296)
                      (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___444))
                      ((_ int2bv 32) 0)))) (let ((temp___445 (- i3 1)))
                                           (ite (< temp___445 4294967296)
                                           (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___445))
                                           ((_ int2bv 32) 0))))))
(check-sat)
