...
(declare-fun temp___6824 () us_rep2)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 887, characters 0-0
  (not
  (= (to_rep3
     (rec__ar__rec3t__g3 (us_split_fields__content2 r__split_fields6)))
  (to_rep3 r__split_fields4))))
(check-sat)
(exit)
