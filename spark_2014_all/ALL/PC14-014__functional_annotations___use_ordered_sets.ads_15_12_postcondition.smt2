...
(define-fun default_initial_assumption ((temp___expr_359 us_rep3)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant5 (get1 container position) true false true)) :pattern (
...
(declare-fun use_ordered_sets__my_contains__result () Bool)

(declare-fun o () count_type)

(declare-fun o1 () count_type)

(declare-fun temp___677 () count_type)
...
(declare-fun use_ordered_sets__my_contains__result1 () Bool)

(declare-fun use_ordered_sets__my_contains__result2 () Bool)

(declare-fun use_ordered_sets__my_contains__result3 () Bool)

(declare-fun use_ordered_sets__my_contains__result4 () Bool)

(declare-fun use_ordered_sets__my_contains__result5 () Bool)

(define-fun o5 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
...
;; H
  (assert
  (= use_ordered_sets__my_contains__result1 use_ordered_sets__my_contains__result2))

;; H
  (assert
  (= use_ordered_sets__my_contains__result3 use_ordered_sets__my_contains__result1))

;; H
  (assert
  (and (= o5 (find1 s e))
  (ite (ite (= (contains (model__ s) e) false) true false)
  (and (not (= (has_key (positions s) o5) true))
  (= (bool_eq1 o5 no_element) true))
  (and
  (and (= (has_key (positions s) o5) true)
  (= (get (positions s) o5) (find (elements s) e)))
  (= (equivalent_elements (element s o5) e) true)))))

;; H
  (assert (= o3 (bool_eq1 o5 no_element)))
...
;; H
  (assert
  (= (mk_bool__ref use_ordered_sets__my_contains__result4) (mk_bool__ref
                                                           use_ordered_sets__my_contains__result2)))

;; H
  (assert
  (= use_ordered_sets__my_contains__result5 use_ordered_sets__my_contains__result3))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 13, characters 0-0
  (not (= (contains (model__ s) e) true)))
(check-sat)
(exit)
