...
(declare-fun temp___706 () Int)

(declare-fun temp___705 () count_type)

(declare-fun temp___7051 () hash_type)

(declare-fun temp___7052 () us_main_type)
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) k1) (<= k1 (to_rep1 (last (rt a)))))
  (and (= result____split_discrs (mk___split_discrs temp___705 temp___7051))
  (= temp___7052 result____split_fields1))))
...
;; H
  ...
  (=>
  (= (has_key
     (model__ (mk___rep result____split_discrs result____split_fields10)) e1) true)
  (and
  (and
  (<= (to_rep1 (first (rt a))) (get
                               (model__
                               (mk___rep result____split_discrs
                               result____split_fields10)) e1))
  (<= (get
      (model__ (mk___rep result____split_discrs result____split_fields10))
      e1) k2))
  (= (equivalent_keys
...
;; H
  ...
  (and
  (= result5 (has_key
             (model__ (index_map__content find_map__find_all__result6))
             e))
  (= (= result5 true)
  (= (has_key (model__ (index_map__content find_map__find_all__result6)) e) true))))
