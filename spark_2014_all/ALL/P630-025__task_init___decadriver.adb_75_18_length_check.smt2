...
(declare-fun dummy4 () frame_length)
...
(declare-fun dummy6 () (Array Int bits_8))
...
(declare-fun dummy8 () rx_frame_queue_index)
...
(declare-fun decadriver__receiver_type__wait__R6b__assume () Int)
...
(declare-fun temp___4551 () (Array Int bits_8))

(declare-fun temp___45511 () t1)
