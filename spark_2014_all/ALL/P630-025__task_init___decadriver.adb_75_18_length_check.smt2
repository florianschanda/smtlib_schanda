...
(define-fun dynamic_invariant1 ((temp___expr_4407 Int)
...
(define-fun dynamic_invariant2 ((temp___expr_4413 Int)
...
(((mk_rx_frame_type__ref (rx_frame_type__content us_rep)))))
...
(((mk_map__ref1 (map__content1 (Array (_ BitVec 8) us_rep))))))
...
(define-fun bool_eq3 ((a (Array (_ BitVec 8) us_rep)) (a__first (_ BitVec 8))
  ...
  (b__last (_ BitVec 8))) Bool (ite (and
                                    ...
                                    (= (bool_eq2 (select a temp___idx_183)
...
(((mk___t3 (elts3 (Array Int bits_8))(rt3 t3)))))
...
;; object__component__size_axiom
  (assert
  (forall ((a (Array Int bits_8))) (<= 0 (object__component__size4 a))))
...
(declare-datatypes ((t13b__ref 0)) (((mk_t13b__ref (t13b__content us_t3)))))
...
(define-fun dynamic_invariant5 ((temp___expr_4419 us_rep)
...
(define-fun dynamic_predicate ((temp___4430 us_rep)) Bool (ite (= (to_rep4
                                                                  (rec__decadriver__rx_frame_type__error
                                                                  (us_split_fields1
                                                                  temp___4430))) 0)
                                                          (< 0 (to_rep3
...
(define-fun dynamic_invariant6 ((temp___expr_4437 (_ BitVec 8))
...
(define-fun dynamic_invariant7 ((temp___expr_323 (_ BitVec 8))
  (temp___is_init_320 Bool) (temp___skip_constant_321 Bool)
  (temp___do_toplevel_322 Bool)) Bool true)

(define-fun dynamic_invariant8 ((temp___expr_665 us_t)
...
(declare-const temp___4550 (Array Int bits_8))

(declare-const temp___45501 t2)

(declare-const temp___4551 (Array Int bits_8))

(declare-const temp___45511 t1)
...
;; H
  (assert (dynamic_property 0 2147483647 (to_rep1 frame__first)
  (to_rep1 frame__last)))
...
;; H
  (assert
  (and
  (< 0 (ite (<= (to_rep1 frame__first) (to_rep1 frame__last))
       (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0))
  (= self__4 true)))
...
;; H
  ...
  (= o (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 frame__first) (to_rep1 frame__last))) (= o 0)))
...
;; H
  (assert
  (and
  (= decadriver__receiver_type__wait__R6b__assume (+ (to_rep1 frame__first) (-
  size1 1))) (in_range1 (+ (to_rep1 frame__first) (- size1 1)))))
...
;; H
  (assert
  (= o2 (rec__decadriver__rx_frame_type__frame
        (us_split_fields1 (select self__ (to_rep5 self__1))))))
...
;; H
  (assert
  (= (slide temp___4550 (to_rep1 (first4 temp___45501))
     (to_rep1 frame__first)) temp___4551))

;; H
  (assert (= (mk1 (to_rep1 frame__first) r6b) temp___45511))

(assert
;; WP_parameter_def
 ;; File "decadriver.ads", line 77, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___45511)) (to_rep1 (last2 temp___45511)))
     (+ (- (to_rep1 (last2 temp___45511)) (to_rep1 (first2 temp___45511))) 1)
     0) (ite (<= (to_rep1 (first2 (mk1 (to_rep1 frame__first) r6b)))
        (to_rep1 (last2 (mk1 (to_rep1 frame__first) r6b))))
        (+ (- (to_rep1 (last2 (mk1 (to_rep1 frame__first) r6b))) (to_rep1
                                                                 (first2
                                                                 (mk1
                                                                 (to_rep1
                                                                 frame__first)
