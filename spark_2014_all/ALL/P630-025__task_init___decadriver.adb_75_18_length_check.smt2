...
(declare-const temp___4553 (Array Int bits_8))

(declare-const temp___45531 t1)
...
;; H
  (assert
  (=> (<= (to_rep1 frame__first) r6b)
  (and
  (and (<= (to_rep1 frame__first) (to_rep1 frame__first))
  (<= (to_rep1 frame__first) (to_rep1 frame__last)))
...
;; H
  (assert (= o3 temp___4553))

;; H
  (assert (= (mk1 (to_rep1 frame__first) r6b) temp___45531))
...
;; WP_parameter_def
 ;; File "decadriver.ads", line 77, characters 0-0
  ...
  (= (ite (<= (to_rep1 (first2 temp___45511)) (to_rep1 (last2 temp___45511)))
     ...
     0) (ite (<= (to_rep1 (first2 temp___45531)) (to_rep1
                                                 (last2 temp___45531)))
        (+ (- (to_rep1 (last2 temp___45531)) (to_rep1 (first2 temp___45531))) 1)
        0))))
(check-sat)
(exit)
