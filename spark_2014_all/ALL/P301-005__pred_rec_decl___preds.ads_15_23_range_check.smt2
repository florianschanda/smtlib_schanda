...
(declare-fun dummy () sub_int_ok)

(declare-datatypes ()
((sub_int_ok__ref (mk_sub_int_ok__ref (sub_int_ok__content sub_int_ok)))))
(define-fun sub_int_ok__ref___projection ((a sub_int_ok__ref)) sub_int_ok
  (sub_int_ok__content a))

(define-fun dynamic_invariant ((temp___expr_166 Int)
  (temp___is_init_163 Bool) (temp___skip_constant_164 Bool)
  (temp___do_toplevel_165 Bool)) Bool (and
                                      (=>
                                      ...
                                      (or
                                      (and
                                      (<= (- 2147483648) temp___expr_166)
                                      (<= temp___expr_166 (- 1)))
                                      (and (<= 1 temp___expr_166)
                                      (<= temp___expr_166 2147483647)))))))

(define-fun dynamic_predicate ((temp___170 Int)) Bool (or
                                                      (and
                                                      (<= (- 2147483648) temp___170)
                                                      (<= temp___170 (- 1)))
                                                      (and (<= 1 temp___170)
                                                      (<= temp___170 2147483647))))

(declare-fun to_rep (sub_int_ok) Int)
...
(assert
;; WP_parameter_def
 ;; File "preds.ads", line 23, characters 0-0
  (not (in_range 1)))
(check-sat)
(exit)
