...
(declare-datatypes ((date__ref 0)) (((mk_date__ref (date__content date)))))
...
;; H
  ...
  (= (to_fixed2 o6) (+ (to_fixed2 fees1) 512000))))
...
;; H
  ...
  (= (to_fixed2 o7) (+ (to_fixed2 fees3) 12800))))))
...
;; H
  ...
  (= (to_fixed2 o8) (+ (to_fixed2 fees3) 128000)))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students__student_record__meal_plan (us_split_fields1 student))) 2))
  (= (to_fixed2 o9) (+ (to_fixed2 fees3) 384000)))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students__student_record__meal_plan (us_split_fields1 student))) 1)
  (= (to_fixed2 o10) (+ (to_fixed2 fees1) 25600))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students__student_record__meal_plan (us_split_fields1 student))) 2)
  (= (to_fixed2 o11) (+ (to_fixed2 fees1) 192000)))))))
...
;; H
  ...
  (= (to_rep1
     (rec__students__student_record__meal_plan (us_split_fields1 student))) 2))
  (= (to_fixed2 o12) (+ (to_fixed2 fees1) 576000)))))))
...
;; H
  (assert
  (<= 384 (to_fixed
          (rec__students__student_record__gpa (us_split_fields1 student)))))
...
;; H
  (assert
  (= (to_rep
     (rec__students__student_record__gender (us_split_fields1 student))) 1))

(assert
;; WP_parameter_def
 ;; File "students.ads", line 12, characters 0-0
  (not (in_range5 (+ (to_fixed2 grants2) 32000))))
(check-sat)
(exit)
