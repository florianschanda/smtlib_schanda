...
(declare-fun temp___216 () status)

(declare-fun temp___2161 () natural)

(declare-fun temp___2162 () natural)

(declare-fun temp___2163 () Bool)

(declare-fun temp___2164 () Bool)
...
;; WP_parameter_def
 ;; File "definite.adb", line 125, characters 0-0
  (not (= temp___216 x__split_discrs)))
(check-sat)
