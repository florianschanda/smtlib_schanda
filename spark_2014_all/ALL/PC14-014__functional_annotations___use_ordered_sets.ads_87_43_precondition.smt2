...
(define-fun o14 () us_rep1 (mk___rep1 (mk___split_fields1 o3)))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o14 (next (mk___rep s__split_discrs s__split_fields3)
         (mk___rep1 cu__split_fields2)))
  ...
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o14) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o14) (+
  (get1 (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o14))
  (ite (= (ite (= (bool_eq1 o14 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      s__split_discrs
                                                      s__split_fields3))
...
;; H
  (assert (and (= o12 (get o6 o8)) (in_range5 o12)))
