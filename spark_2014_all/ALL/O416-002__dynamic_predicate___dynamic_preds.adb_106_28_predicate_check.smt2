...
(declare-fun dynamic_preds__get_even_close_pair_error__result__assume () even)

(declare-fun dynamic_preds__get_even_close_pair_error__result__assume1 () even)
...
(declare-fun temp___276 () even)

(declare-fun temp___2761 () even)
...
(declare-fun temp___272 () even)

(declare-fun temp___2721 () even)
...
(declare-fun result4 () even)

(declare-fun result5 () even)
...
;; H
  (assert
  (=> (= (mod2 above 2) 0)
  (and (= temp___273 (+ above 1)) (in_range (+ above 1)))))
...
;; H
  (assert
  (=> (not (= (mod2 above 2) 0))
  (and (= temp___269 (+ above 1)) (in_range (+ above 1)))))
...
;; H
  (assert
  (=> (not (= (mod2 above 2) 0)) (= result4 result____split_fields2)))

;; H
  (assert
  (=> (not (= (mod2 above 2) 0)) (= result5 result____split_fields3)))

;; H
  (assert
  (=> (not (= (mod2 above 2) 0))
  (= result____split_fields6 (mk___split_fields temp___272 temp___2721))))
...
;; H
  (assert
  (and (= temp___277 (+ (to_rep result____split_fields4) 4)) (in_range
  (+ (to_rep result____split_fields4) 4))))

(assert
;; WP_parameter_def
 ;; File "dynamic_preds.ads", line 25, characters 0-0
  (not (= (mod2 temp___277 2) 0)))
(check-sat)
(exit)
