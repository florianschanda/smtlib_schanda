...
(declare-fun user_eq1 (intmax intmax) Bool)

(declare-const dummy1 intmax)

(declare-datatypes ()
((intmax__ref (mk_intmax__ref (intmax__content intmax)))))
(define-fun intmax__ref___projection ((a intmax__ref)) intmax (intmax__content
                                                              a))
...
(declare-fun is_full__function_guard (Bool Int (Array Int integer)) Bool)
...
(declare-const data1 (Array Int integer))

(declare-const top2 Int)

(declare-const data2 (Array Int integer))

(declare-const top3 Int)

(declare-const data3 (Array Int integer))
...
;; H
  (assert (and (= o (+ top 1)) (in_range1 (+ top 1))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (= (size top2 data2) (+ (size top data) 1))))
(check-sat)
(exit)
