...
;; H
  (assert
  (and (= o22 (model__ data1 first_available1))
...
;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i2)) (= (get c111b j) (get c112b (+ j 1))))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= 2 j) (<= j (+ i2 1))) (= (get c111b (- j 1)) (get c112b j)))))

;; H
  (assert
  (and (=> (<= 1 r114b) (dynamic_property 1 r114b i2))
  (and (<= 1 i2) (<= i2 r114b))))
...
;; H
  ...
  (= (get c112b j) (to_rep
                   (rec__list_mod_allocator__cell__next
                   (us_split_fields1 (select data1 (get c111b i2))))))))))
