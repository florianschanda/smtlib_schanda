...
(declare-fun result9 () (Array Int (Array Int cell)))
...
;; H
  ...
  (= (select cur_board3 temp___771) (select cur_board temp___771)))))
  (=> (<= 1 50) (in_range4 del_line2))) (=> (<= 1 50) (in_range4 to_line3)))
  (and (<= 1 del_line2) (<= del_line2 50))))

;; H
  (assert (not (= del_line2 50)))
...
;; H
  (assert (=> (= result8 true) (= cur_board3 result9)))
...
;; H
  (assert (=> (= result8 true) (= has_complete_lines3 result10)))

;; H
  (assert (=> (= result8 true) (= has_complete_lines4 (of_int 1))))

;; H
  (assert (=> (= result8 true) (= to_line3 result11)))
...
;; H
  (assert
  (=> (not (= result8 true)) (= has_complete_lines4 has_complete_lines3)))
