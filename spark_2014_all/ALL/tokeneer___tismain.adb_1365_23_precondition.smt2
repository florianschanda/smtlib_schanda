...
;; H
  (assert (= result (enrolmentisinprogress (let ((subject state)) state7))))
...
;; H
  (assert (= result1 (statusisshutdown (let ((subject state)) state7))))
...
;; H
  (assert
  (= result2 (statusisenclavequiescent (let ((subject state)) state7))))
...
;; H
  (assert
  (= o14 (statusiswaitingfinishadminop (let ((subject state)) state7))))

;; H
  (assert
  (= o15 (statusiswaitingstartadminop (let ((subject state)) state7))))
...
;; H
  (assert
  (= o10 (statusiswaitingremoveadmintokenfail (let ((subject state)) state7))))

;; H
  (assert (= o11 (statusisgotadmintoken (let ((subject state)) state7))))
...
;; H
  (assert
  (=> (= result5 true)
  (= o9 (statusiswaitingstartadminop (let ((subject state)) state7)))))
