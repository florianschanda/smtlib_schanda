...
;; H
  (assert
  (=> (= result3 true)
  (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last)))))
...
;; H
  (assert
  (=> (= result10 true)
  (and (<= (to_rep1 a__first) k10) (<= k10 (to_rep1 a__last)))))
...
;; H
  (assert
  (=> (= result10 true) (= o36 (rec__frame_condition__cell__value o35))))
...
;; H
  ...
  (= o39 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select (map__content a5) c204b1))) o38
         (rec__frame_condition__cell__max_right
         (us_split_fields1 (select (map__content a5) c204b1)))))))
...
;; H
  (assert
  (=> (= 1 0)
  (and (<= (to_rep1 a__first) c204b1) (<= c204b1 (to_rep1 a__last)))))
...
;; H
  ...
  (= o44 (mk___split_fields
         ...
         (us_split_fields1 (select (map__content a5) c204b1)))
         (rec__frame_condition__cell__max_left
         (us_split_fields1 (select (map__content a5) c204b1))) o43))))
...
;; H
  ...
  (=> (and (<= first3 i) (<= i k11))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a11 i))))
  max13)))
  (forall ((i Int))
  (=> (and (<= k11 i) (<= i first3))
  (<= (to_rep
...
;; H
  (assert
  (forall ((i Int))
  (=> (and (<= k11 i) (<= i (to_rep1 a__last)))
  (forall ((j Int))
  (=> (and (<= i j) (<= j (to_rep1 a__last)))
  (<= (to_rep
      (rec__frame_condition__cell__value (us_split_fields1 (select a11 j))))
  (to_rep
  (rec__frame_condition__cell__max_right (us_split_fields1 (select a11 i))))))))))
...
;; H
  ...
  (= (to_rep
     (rec__frame_condition__cell__max_left (us_split_fields1 (select a11 i))))
  (to_rep
  (rec__frame_condition__cell__max_left
  (us_split_fields1 (select (map__content a5) i))))))))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 1 2147483647) (in_range3 c204b2))
  (=> (<= 0 2147483647) (in_range2 c205b2)))
  (=> (<= 1 2147483647) (in_range3 k11)))
  (forall ((temp___262 Int))
  (=>
  (and (<= (to_rep1 a__first) temp___262) (<= temp___262 (to_rep1 a__last)))
  (= (rec__frame_condition__cell__value
     (us_split_fields1 (select a11 temp___262))) (rec__frame_condition__cell__value
                                                 (us_split_fields1
                                                 (select (map__content a5) temp___262)))))))
...
;; H
  (assert
  (and (<= (to_rep1 a__first) (int__content k14))
  (<= (int__content k14) (to_rep1 a__last))))
...
;; H
  (assert
  (=> (= result18 true) (= o58 (rec__frame_condition__cell__value o57))))
...
;; H
  (assert
  (=> (= 1 0)
  (= o61 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select a11 c204b3))) o60
         (rec__frame_condition__cell__max_right
         (us_split_fields1 (select a11 c204b3)))))))
...
;; H
  (assert
  (=> (= 1 0)
  (and (<= (to_rep1 a__first) c204b3) (<= c204b3 (to_rep1 a__last)))))
...
;; H
  (assert
  (=> (not (= 1 0))
  (= o66 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select a11 c204b3)))
         (rec__frame_condition__cell__max_left
         (us_split_fields1 (select a11 c204b3))) o65))))
...
;; WP_parameter_def
 ;; File "frame_condition.adb", line 50, characters 0-0
  (not (<= (to_rep1 a__first) (int__content k16))))
(check-sat)
(exit)
