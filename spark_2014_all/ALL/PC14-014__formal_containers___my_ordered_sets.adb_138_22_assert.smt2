...
(declare-fun dummy10 () key_type)

(declare-datatypes ()
((key_type__ref1 (mk_key_type__ref1 (key_type__content1 key_type)))))
(define-fun key_type__ref_3__projection ((a key_type__ref1)) key_type
...
(define-fun tlS__ref_2__projection ((a tlS__ref)) us_rep1 (tlS__content a))
...
(define-fun tkS__ref_2__projection ((a tkS__ref)) us_rep1 (tkS__content a))
...
(declare-fun dummy15 () element_type)
...
(declare-fun temp___1090 () count_type)

(declare-fun temp___1091 () count_type)
...
(declare-fun o56 () natural)

(declare-fun o57 () us_split_fields)

(declare-fun o58 () us_rep)

(declare-fun temp___1111 () us_rep2)
...
(declare-fun my_ordered_sets__n__insert__2__container__fields () us_split_fields2)

(declare-fun result2 () us_split_fields__ref1)

(declare-fun l__split_fields1 () us_split_fields2)

(declare-fun my_ordered_sets__n__insert__2__container__fields1 () us_split_fields2)
...
(declare-fun my_ordered_sets__n__insert__container__fields () us_split_fields2)

(declare-fun result4 () us_split_fields__ref1)

(declare-fun l__split_fields3 () us_split_fields2)

(declare-fun my_ordered_sets__n__replace_element__container__fields () us_split_fields2)

(declare-fun result5 () us_split_fields__ref1)

(declare-fun l__split_fields4 () us_split_fields2)

(declare-fun my_ordered_sets__n__replace__container__fields () us_split_fields2)

(declare-fun result6 () us_split_fields__ref1)

(declare-fun l__split_fields5 () us_split_fields2)

(declare-fun my_ordered_sets__n__assign__target__fields () us_split_fields2)

(declare-fun result7 () us_split_fields__ref1)

(declare-fun k__split_fields1 () us_split_fields2)

(declare-fun my_ordered_sets__n__move__source__fields () us_split_fields2)

(declare-fun my_ordered_sets__n__move__target__fields () us_split_fields2)
...
(declare-fun my_ordered_sets__n__include__container__fields () us_split_fields2)

(declare-fun result10 () us_split_fields__ref1)

(declare-fun l__split_fields7 () us_split_fields2)

(declare-fun my_ordered_sets__n__include__container__fields1 () us_split_fields2)

(declare-fun result11 () us_split_fields__ref1)

(declare-fun l__split_fields8 () us_split_fields2)

(declare-fun my_ordered_sets__n__assign__target__fields1 () us_split_fields2)

(declare-fun result12 () us_split_fields__ref1)

(declare-fun k__split_fields3 () us_split_fields2)

(declare-fun my_ordered_sets__n__delete__container__fields () us_split_fields2)
...
(declare-fun my_ordered_sets__n__delete__2__container__fields () us_split_fields2)
...
(declare-fun my_ordered_sets__n__exclude__container__fields () us_split_fields2)

(declare-fun result17 () us_split_fields__ref1)

(declare-fun l__split_fields11 () us_split_fields2)

(declare-fun my_ordered_sets__n__exclude__container__fields1 () us_split_fields2)

(declare-fun result18 () us_split_fields__ref1)

(declare-fun l__split_fields12 () us_split_fields2)

(declare-fun my_ordered_sets__g__replace__container__fields () us_split_fields2)

(declare-fun result19 () us_split_fields__ref1)

(declare-fun k__split_fields4 () us_split_fields2)

(declare-fun my_ordered_sets__g__delete__container__fields () us_split_fields2)

(declare-fun result20 () us_split_fields__ref1)

(declare-fun k__split_fields5 () us_split_fields2)

(declare-fun result21 () us_split_fields__ref2)

(declare-fun c__split_fields7 () us_split_fields4)
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o61) true))
  (= (bool_eq
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o61)) o61) true))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (model__
  ...
  (= (range_equal
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields)) o61) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs (mk___split_fields1 l__split_fields)))
     (elements
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields)) o61)
     (length
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o60) true))
  (= (bool_eq
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o60)) o60) true))
  ...
  (= (included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o60) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__insert__2__container__fields1)) o60) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields1))
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__2__container__fields1)) o60)
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o59) true)
  (= (has_key
     (positions
     (mk___rep1 l__split_discrs
  ...
  (= (equivalent_elements
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)
     (mk___rep2 c__split_fields3)) o59) true))
  (= (e_is_find
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields)) o59
     (get1
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields))
  ...
  (= (included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__insert__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields2)) o59) true))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields)) o30) true)
  (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields6))
          o30) true)
  (and
  (and
  (and
  (= (oeq2 (model__ (mk___rep1 l__split_discrs l__split_fields6))
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields))) true)
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields))
  ...
  (= (bool_eq
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields)) o30)) o30) true))
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields)) (+ (length
                                                         (mk___rep1
                                                         l__split_discrs
                                                         l__split_fields6)) 1))
  ...
  (= (bool_eq
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields)) o30)) o30) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields6))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields)) 1
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__include__container__fields)) o30) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields6))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields))
     (find
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields)) o30)
...
;; H
  (assert
  (= l__split_fields7 my_ordered_sets__n__include__container__fields))

;; H
  (assert
  (not
  (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields7))
     (mk___rep (mk___split_fields (of_rep1 4) (of_rep 4)))) true)))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1)) o34) true)
  (ite (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields7))
          o34) true)
  (and
  (and
  (and
  (= (oeq2 (model__ (mk___rep1 l__split_discrs l__split_fields7))
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1))) true)
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1))
  ...
  (= (bool_eq
     ...
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1)) o34)) o34) true))
  (= (equal_except (elements (mk___rep1 l__split_discrs l__split_fields7))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1))
     (find
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1)) (+ (length
                                                          (mk___rep1
                                                          l__split_discrs
                                                          l__split_fields7)) 1))
  ...
  (= (included_except
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields7)) o34) true))
  (= (bool_eq
     (get
     (elements
     (mk___rep1 l__split_discrs
     ...
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1)) o34)) o34) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields7))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1)) 1
     (- (find
        (elements
        (mk___rep1 l__split_discrs
        my_ordered_sets__n__include__container__fields1)) o34) 1)) true))
  (= (range_shifted (elements (mk___rep1 l__split_discrs l__split_fields7))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1))
     (find
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__include__container__fields1)) o34)
     (length (mk___rep1 l__split_discrs l__split_fields7)) 1) true))
  (= (p_positions_shifted
...
;; H
  (assert
  (= l__split_fields8 my_ordered_sets__n__include__container__fields1))
...
;; H
  ...
  (= (oeq2
     (model__
     (mk___rep1 k__split_discrs my_ordered_sets__n__assign__target__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields8))) true)
  (= (oeq3
     (elements
     (mk___rep1 k__split_discrs my_ordered_sets__n__assign__target__fields1))
     (elements (mk___rep1 l__split_discrs l__split_fields8))) true))
  (= (length
     (mk___rep1 k__split_discrs my_ordered_sets__n__assign__target__fields1))
...
;; H
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields)) (- (length
                                                        (mk___rep1
                                                        l__split_discrs
                                                        l__split_fields8)) 1))
  (not
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields)) o38) true)))
  (= (ole
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields8))) true))
  (= (included_except (model__ (mk___rep1 l__split_discrs l__split_fields8))
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields)) o38) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields8))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields)) 1
     (- (find (elements (mk___rep1 l__split_discrs l__split_fields8)) o38) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields))
     (elements (mk___rep1 l__split_discrs l__split_fields8))
     (find (elements (mk___rep1 l__split_discrs l__split_fields8)) o38)
     (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__container__fields))
...
;; H
  (assert
  (and
  (= temp___1104 (find1 (mk___rep1 l__split_discrs l__split_fields9) o42))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields9))
               o42) false) true false)
  (and
  (not
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1104) true))
  (= (bool_eq2 temp___1104 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1104) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
     temp___1104) (find
                  (elements (mk___rep1 l__split_discrs l__split_fields9))
                  o42)))
  (= (equivalent_elements
     (element (mk___rep1 l__split_discrs l__split_fields9) temp___1104)
     o42) true)))))
...
;; H
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__2__container__fields)) (- (length
                                                           (mk___rep1
                                                           l__split_discrs
                                                           l__split_fields9)) 1)))
  (not
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__2__container__fields))
     (element (mk___rep1 l__split_discrs l__split_fields9)
  ...
  (= (included_except (model__ (mk___rep1 l__split_discrs l__split_fields9))
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__2__container__fields))
     (element (mk___rep1 l__split_discrs l__split_fields9)
     (mk___rep2 c__split_fields4))) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields9))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__2__container__fields)) 1
     (- (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
        (mk___rep2 c__split_fields4)) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__2__container__fields))
     (elements (mk___rep1 l__split_discrs l__split_fields9))
     (get1 (positions (mk___rep1 l__split_discrs l__split_fields9))
     (mk___rep2 c__split_fields4))
     (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__2__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__delete__2__container__fields))
...
;; H
  (assert
  (= l__split_fields10 my_ordered_sets__n__delete__2__container__fields))

;; H
  (assert
  (not
  (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields10))
...
;; H
  (assert
  (and
  (= temp___1106 (find1 (mk___rep1 l__split_discrs l__split_fields10) o46))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
               o46) false) true false)
  (and
  (not
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1106) true))
  (= (bool_eq2 temp___1106 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1106) true)
  (= (get1 (positions (mk___rep1 l__split_discrs l__split_fields10))
     temp___1106) (find
                  (elements (mk___rep1 l__split_discrs l__split_fields10))
                  o46)))
  (= (equivalent_elements
     (element (mk___rep1 l__split_discrs l__split_fields10) temp___1106)
     o46) true)))))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields)) o50) true))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields10))
               o50) false) true false)
  (and
  (and
  (= (oeq2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields10))) true)
  (= (oeq3
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields))
     (elements (mk___rep1 l__split_discrs l__split_fields10))) true))
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields))
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields)) (- (length
                                                         (mk___rep1
                                                         l__split_discrs
                                                         l__split_fields10)) 1))
  (= (ole
     ...
     my_ordered_sets__n__exclude__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields10))) true))
  (= (included_except (model__ (mk___rep1 l__split_discrs l__split_fields10))
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields)) o50) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields10))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields)) 1
     (- (find (elements (mk___rep1 l__split_discrs l__split_fields10)) o50) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields))
     (elements (mk___rep1 l__split_discrs l__split_fields10))
     (find (elements (mk___rep1 l__split_discrs l__split_fields10)) o50)
     (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields))
...
;; H
  (assert
  (= l__split_fields11 my_ordered_sets__n__exclude__container__fields))

;; H
  (assert
  (= (contains (model__ (mk___rep1 l__split_discrs l__split_fields11))
     (mk___rep (mk___split_fields (of_rep1 1) (of_rep 1)))) true))
...
;; H
  ...
  (= (contains
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1)) o54) true))
  (ite (ite (= (contains
               (model__ (mk___rep1 l__split_discrs l__split_fields11))
               o54) false) true false)
  (and
  (and
  (= (oeq2
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields11))) true)
  (= (oeq3
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1))
     (elements (mk___rep1 l__split_discrs l__split_fields11))) true))
  (= (oeq4
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1))
  ...
  (= (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1)) (- (length
                                                          (mk___rep1
                                                          l__split_discrs
                                                          l__split_fields11)) 1))
  (= (ole
     ...
     my_ordered_sets__n__exclude__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields11))) true))
  (= (included_except (model__ (mk___rep1 l__split_discrs l__split_fields11))
     (model__
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1)) o54) true))
  (= (range_equal (elements (mk___rep1 l__split_discrs l__split_fields11))
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1)) 1
     (- (find (elements (mk___rep1 l__split_discrs l__split_fields11)) o54) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1))
     (elements (mk___rep1 l__split_discrs l__split_fields11))
     (find (elements (mk___rep1 l__split_discrs l__split_fields11)) o54)
     (length
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 l__split_discrs
     my_ordered_sets__n__exclude__container__fields1))
...
;; H
  (assert
  (= l__split_fields12 my_ordered_sets__n__exclude__container__fields1))
...
;; H
  ...
  (= (length
     ...
     my_ordered_sets__g__replace__container__fields)) (length
                                                      (mk___rep1
                                                      k__split_discrs
                                                      k__split_fields3)))
  (= (bool_eq
     (element2
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__replace__container__fields) 1) o58) true))
  (= (contains
     (model__
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__replace__container__fields)) o58) true))
  (= (m_included_except
     (model__ (mk___rep1 k__split_discrs k__split_fields3))
     (model__
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__replace__container__fields)) 1) true))
  (= (included_except
     (model__
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__replace__container__fields))
     (model__ (mk___rep1 k__split_discrs k__split_fields3)) o58) true))
  (= (mapping_preserved_except
     (elements (mk___rep1 k__split_discrs k__split_fields3))
     (elements
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__replace__container__fields))
     (positions (mk___rep1 k__split_discrs k__split_fields3))
     (positions
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__replace__container__fields))
     (find4
  ...
  (= (oeq4
     ...
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__replace__container__fields))
     (positions (mk___rep1 k__split_discrs k__split_fields3))) true)))
...
;; H
  (assert
  (= k__split_fields4 my_ordered_sets__g__replace__container__fields))
...
;; H
  ...
  (= (length
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields)) (- (length
                                                        (mk___rep1
                                                        k__split_discrs
                                                        k__split_fields4)) 1))
  (not
  (= (contains3
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields) 4) true)))
  (= (ole
     (model__
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields))
     (model__ (mk___rep1 k__split_discrs k__split_fields4))) true))
  (= (m_included_except
     (model__ (mk___rep1 k__split_discrs k__split_fields4))
     (model__
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields)) 4) true))
  (= (range_equal (elements (mk___rep1 k__split_discrs k__split_fields4))
     (elements
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields)) 1
     (- (find3 (elements (mk___rep1 k__split_discrs k__split_fields4)) 4) 1)) true))
  (= (range_shifted
     (elements
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields))
     (elements (mk___rep1 k__split_discrs k__split_fields4))
     (find3 (elements (mk___rep1 k__split_discrs k__split_fields4)) 4)
     (length
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields)) 1) true))
  (= (p_positions_shifted
     (positions
     (mk___rep1 k__split_discrs
     my_ordered_sets__g__delete__container__fields))
     (positions (mk___rep1 k__split_discrs k__split_fields4))
     (find3 (elements (mk___rep1 k__split_discrs k__split_fields4)) 4) 1) true)))
...
;; H
  (assert
  (and (= temp___1111 (find4 (mk___rep1 k__split_discrs k__split_fields5) 2))
  (ite (forall ((e us_rep))
       (=>
       (= (contains (model__ (mk___rep1 k__split_discrs k__split_fields5)) e) true)
       (not
       (= (equivalent_keys 2
          (to_rep1 (rec__my_ordered_sets__my_rec__f (us_split_fields1 e)))) true))))
  (and
  (not
  (= (has_key (positions (mk___rep1 k__split_discrs k__split_fields5))
     temp___1111) true))
  (= (bool_eq2 temp___1111 no_element) true))
  (and
  (and
  (= (has_key (positions (mk___rep1 k__split_discrs k__split_fields5))
     temp___1111) true)
  (= (get1 (positions (mk___rep1 k__split_discrs k__split_fields5))
     temp___1111) (find3
                  (elements (mk___rep1 k__split_discrs k__split_fields5)) 2)))
  (= (equivalent_keys
     (to_rep1
     (rec__my_ordered_sets__my_rec__f
     (us_split_fields1
     (element (mk___rep1 k__split_discrs k__split_fields5) temp___1111)))) 2) true)))))
...
;; WP_parameter_def
 ;; File "my_ordered_sets.adb", line 4, characters 0-0
  (not (= (contains3 (mk___rep1 k__split_discrs k__split_fields5) 2) true)))
(check-sat)
(exit)
