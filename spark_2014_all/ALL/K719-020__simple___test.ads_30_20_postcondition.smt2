...
(declare-fun temp___227 () integer)

(declare-fun temp___2271 () Bool)

(declare-fun temp___2272 () (Array Int integer))
...
(declare-fun x__split_fields4 () Bool)

(declare-fun x__split_fields5 () (Array Int integer))

(declare-fun x__split_fields6 () integer)

(declare-fun x__split_fields7 () Bool)

(declare-fun x__split_fields8 () (Array Int integer))

(declare-fun x__split_fields9 () integer)

(declare-fun x__split_fields10 () Bool)

(declare-fun x__split_fields11 () (Array Int integer))
...
;; WP_parameter_def
 ;; File "test.ads", line 5, characters 0-0
  (not (= (to_rep (select x__split_fields8 2)) 1)))
(check-sat)
(exit)
