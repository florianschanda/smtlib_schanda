...
;; H
  ...
  (=> (= result2 true)
  (and (= o22 (remove a ia))
  (and (dynamic_invariant1 o22 true false true)
...
;; H
  (assert
  (=> (= result2 true)
  (and (= result1 (is_perm o22 o21))
  (= (= result1 true)
  (or (and (= (length o22) 0) (= (length o21) 0))
  (exists ((ia1 Int))
  ...
  (= (is_perm (remove o22 ia1) (remove o21 ib3)) true)))))))))))
