...
;; fliteral_axiom
  (assert (and (tqtisFinite fliteral3) (= (tqtreal fliteral3) 180.0)))
...
;; H
  (assert (and (le (neg fliteral3) y) (le y fliteral2)))

;; H
  (assert (and (le fliteral2 z) (le z fliteral)))

;; H
  (assert (le fliteral2 (add RNE1 x y)))

;; H
  (assert (and (= o (mul RNE1 y z)) (tqtisFinite (mul RNE1 y z))))
