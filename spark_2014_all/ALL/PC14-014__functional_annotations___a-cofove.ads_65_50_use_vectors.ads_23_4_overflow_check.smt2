...
(((mk_smaller__ref (smaller__content smaller)))))
...
(declare-datatypes ((bigger__ref 0))
(((mk_bigger__ref (bigger__content integer)))))
...
;; H
  (assert (and (= o last1) (in_range2 last1)))

;; H
  (assert (= o1 (- o 2147483647)))
