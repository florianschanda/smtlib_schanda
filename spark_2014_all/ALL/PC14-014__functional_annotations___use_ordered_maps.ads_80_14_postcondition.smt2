...
(declare-const temp___7731 us_main_type)
...
(define-fun temp___7711 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___771)))

(define-fun use_ordered_maps__union_prop__cu__assume1 () us_rep1 (mk___rep1
                                                                 (mk___split_fields1
                                                                 use_ordered_maps__union_prop__cu__assume)))
...
;; H
  (assert
  (and (= use_ordered_maps__union_prop__cu__assume1 (first s2))
  (ite (= (= (length s2) 0) true)
  (= (bool_eq1 use_ordered_maps__union_prop__cu__assume1 no_element) true)
  (and
  (= (has_key1 (positions s2) use_ordered_maps__union_prop__cu__assume1) true)
  (= (get2 (positions s2) use_ordered_maps__union_prop__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= result1 (has_key1 (positions s2) (mk___rep1 cu__split_fields11)))
  (= (= result1 true)
...
;; H
  (assert
  (=> (= result1 true)
  (and (= s1__split_discrs (mk___split_discrs temp___773))
  (= s1__split_fields temp___7731))))
...
;; H
  (assert (=> (= result1 true) (= temp___772 cu__split_fields1)))

;; H
  (assert
  (=> (= result1 true)
  (< (length (mk___rep s1__split_discrs s1__split_fields11)) (+ temp___774
  (get2 (positions s2) (mk___rep1 cu__split_fields10))))))

;; H
  (assert
  (=> (= result1 true)
  (let ((temp___780 (keys (mk___rep s1__split_discrs s1__split_fields11))))
  (forall ((temp___779 Int))
  (=>
  (and (in_range5 temp___779)
  (= (iter_has_element temp___780 temp___779) true))
  (= (prop__
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o1 (element s2 (mk___rep1 cu__split_fields10)))
  (and (in_range9 o1)
  (= o1 (get (model__ s2) (key s2 (mk___rep1 cu__split_fields10))))))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o (key s2 (mk___rep1 cu__split_fields10)))
  (and (in_range8 o)
  (= o (get1 (keys s2) (get2 (positions s2) (mk___rep1 cu__split_fields10))))))))
...
;; H
  ...
  (and
  (and
  (= (has_key (model__ (mk___rep s1__split_discrs s1__split_fields10)) o) true)
  (= (get (model__ (mk___rep s1__split_discrs s1__split_fields10)) o)
  o1))
  ...
  (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields10))
     (find (keys (mk___rep s1__split_discrs s1__split_fields10)) o))
  o))
  (= (equal_except (keys (mk___rep s1__split_discrs s1__split_fields11))
     (keys (mk___rep s1__split_discrs s1__split_fields10))
     (find (keys (mk___rep s1__split_discrs s1__split_fields10)) o)) true))
  ...
  (= (elements_equal_except
     ...
     (model__ (mk___rep s1__split_discrs s1__split_fields11)) o) true))
  (and
  (and
  (and
  (and
  ...
  (= (get1 (keys (mk___rep s1__split_discrs s1__split_fields10))
     (find (keys (mk___rep s1__split_discrs s1__split_fields10)) o))
  o))
  (= (range_equal (keys (mk___rep s1__split_discrs s1__split_fields11))
     (keys (mk___rep s1__split_discrs s1__split_fields10)) 1
     (- (find (keys (mk___rep s1__split_discrs s1__split_fields10)) o) 1)) true))
  (= (range_shifted (keys (mk___rep s1__split_discrs s1__split_fields11))
     (keys (mk___rep s1__split_discrs s1__split_fields10))
     (find (keys (mk___rep s1__split_discrs s1__split_fields10)) o)
     (length (mk___rep s1__split_discrs s1__split_fields11)) 1) true))
  (= (p_positions_shifted
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___7711 (next s2 (mk___rep1 cu__split_fields10)))
  ...
  (= (bool_eq1 temp___7711 no_element) true)
  (and (= (has_key1 (positions s2) temp___7711) true)
  (= (get2 (positions s2) temp___7711) (+ (get2 (positions s2)
...
;; H
  (assert
  (=> (= result1 true) (= cu__split_fields3 (mk___split_fields1 temp___771))))
...
(define-fun temp___801 () us_rep3 (keys
                                  (mk___rep s1__split_discrs
                                  (us_split_fields__content
                                  s1__split_fields8))))

(declare-const temp___800 Int)

;; H
  (assert (in_range5 temp___800))

;; H
  (assert (= (iter_has_element temp___801 temp___800) true))
...
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 73, characters 0-0
  ...
  (= (prop__
     ...
     (get1 temp___801 temp___800))) true)))
(check-sat)
(exit)
