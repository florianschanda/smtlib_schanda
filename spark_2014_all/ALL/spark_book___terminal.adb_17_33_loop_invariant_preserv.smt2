...
(declare-fun dummy6 () status_type)
...
(declare-fun dummy7 () status_type1)

(declare-datatypes ()
((status_type__ref1
 (mk_status_type__ref1 (status_type__content1 status_type1)))))
(define-fun status_type__ref_2__projection ((a status_type__ref1)) status_type1
...
;; def_axiom
  ...
  (let ((temp___252 (temp___251 temp___253 temp___254 temp___255)))
  (and
  (=> (dynamic_property 1 2147483647 temp___254 temp___255)
  (and (= (first3 temp___252) temp___254) (= (last3 temp___252) temp___255)))
  (forall ((temp___256 Int))
  (= (select (to_array1 temp___252) temp___256) (of_rep temp___253)))))))
...
(declare-fun temp___258 () (Array Int character))

(declare-fun temp___2581 () t1)

(declare-fun temp___259 () (Array Int character))

(declare-fun temp___2591 () t)

(declare-fun temp___260 () (Array Int character))

(declare-fun temp___2601 () t)
...
;; H
  (assert (dynamic_property 1 2147483647 (to_rep1 buffer__first)
...
;; H
  ...
  (= (to_rep1
     (first2
     (rt1 (temp___251 32 (to_rep1 buffer__first) (to_rep1 buffer__last)))))
  (to_rep1 buffer__first)))
...
;; H
  (assert
  (= (mk___t1 temp___258 temp___2581) (temp___251 32 (to_rep1 buffer__first)
                                      (to_rep1 buffer__last))))
...
;; H
  (assert
  (= (mk (to_rep1 (first2 temp___2581)) (to_rep1 (last2 temp___2581)))
  temp___2591))

;; H
  (assert
  (= (ite (<= (to_rep1 (first temp___2591)) (to_rep1 (last temp___2591)))
     (+ (- (to_rep1 (last temp___2591)) (to_rep1 (first temp___2591))) 1) 0)
  (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last))
  (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0)))

;; H
  (assert
  (= (mk___t temp___260 temp___2601) (mk___t temp___259 temp___2591)))

;; H
  (assert
  (= o (slide temp___260 (to_rep1 (first temp___2601))
       (to_rep1 buffer__first))))
...
;; H
  (assert
  (<= count2 (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last))
             (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0)))

;; H
  (assert
  (and
  (and (=> (<= 0 2) (in_range5 status2))
  (=> (<= 0 2) (in_range4 port_status1)))
  (=> (<= 0 2147483647) (in_range3 count2))))

;; H
  (assert
  (=> (<= (to_rep1 buffer__first) (to_rep1 buffer__last))
  (= o1 (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 buffer__first) (to_rep1 buffer__last))) (= o1 0)))
...
;; H
  (assert
  (and (= temp___261 (+ (to_rep1 buffer__first) count2)) (in_range
  (+ (to_rep1 buffer__first) count2))))

;; H
  (assert
  (and (<= (to_rep1 buffer__first) temp___261)
  (<= temp___261 (to_rep1 buffer__last))))

;; H
  (assert (= o4 temp___261))
...
;; H
  (assert (and (= o6 (+ count2 1)) (in_range (+ count2 1))))

;; H
  (assert (= result5 count2))
...
;; WP_parameter_def
 ;; File "terminal.ads", line 9, characters 0-0
  (not
  (<= count3 (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last))
             (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0))))
(check-sat)
(exit)
