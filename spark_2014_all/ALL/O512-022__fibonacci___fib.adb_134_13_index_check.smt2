...
;; H
  ...
  (forall ((i10 Int))
  (=> (and (<= (+ k1 1) i10) (<= i10 100))
  (= (to_rep (select c1 (- i10 k1))) (to_rep (select c2 (- i10 k2)))))))))))))
...
;; H
  (assert
  (=> (and (<= 0 i2) (<= i2 k1)) (= (mk_int__ref i6) (mk_int__ref i4))))
...
;; H
  ...
  (=> (<= i9 temp___201) (= (select a18 temp___201) (select a16 temp___201)))))
  (and (<= (+ k1 1) i9) (<= i9 0))))
...
;; H
  (assert (and (<= 0 temp___199) (<= temp___199 100)))

;; H
  (assert (= o6 temp___199))
