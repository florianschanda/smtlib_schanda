...
;; H
  ...
  (= o1 (add RNE1
        (sub RNE1
        (add RNE1 (sub RNE1 fliteral (div1 RNE1 (pow21 x) fliteral3))
        (div1 RNE1 (pow4 x) fliteral4)) (div1 RNE1 (pow6 x) fliteral5))
        (div1 RNE1 (pow8 x) fliteral6))))))

;; H
  (assert (= o2 (sub RNE1 trigo__cos__result4 o1)))
