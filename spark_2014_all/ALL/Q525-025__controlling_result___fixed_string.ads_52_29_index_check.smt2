...
;; H
  ...
  (and (= o16 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1
  (- 2147483647 (to_rep1 (first (rt new_val))))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (and (= o17 (- i (to_rep1 change__first))) (in_range1
  (- i (to_rep1 change__first))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (= result4 (ite (<= o17 o16) true false))))

;; H
  (assert
  (=> (= result4 true)
  (and (= o13 (- i (to_rep1 change__first))) (in_range1
  (- i (to_rep1 change__first))))))

;; H
  (assert
  (=> (= result4 true) (= o14 (+ o13 (to_rep1 (first (rt new_val)))))))

;; H
  (assert (=> (= result4 true) (and (= o15 o14) (in_range1 o14))))

;; H
  (assert
  (=> (= result4 true)
  (= result3 (ite (<= o15 (to_rep1 (last (rt new_val)))) true false))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt new_val))) temp___259)
  (<= temp___259 (to_rep1 (last (rt new_val))))))

;; H
  (assert (= o10 temp___259))

;; H
  (assert (= o11 (select (elts new_val) o10)))
