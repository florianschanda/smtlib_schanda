...
;; H
  ...
  (and (= o17 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1
  (- 2147483647 (to_rep1 (first (rt new_val))))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (and (= o18 (- i (to_rep1 change__first))) (in_range1
  (- i (to_rep1 change__first))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (= result4 (ite (<= o18 o17) true false))))
...
;; H
  (assert
  (=> (= result4 true) (= o15 (+ o14 (to_rep1 (first (rt new_val)))))))
...
;; H
  (assert
  (=> (= result4 true)
  (= result3 (ite (<= o16 (to_rep1 (last (rt new_val)))) true false))))
...
;; H
  (assert (and (= temp___259 o10) (in_range1 o10)))
