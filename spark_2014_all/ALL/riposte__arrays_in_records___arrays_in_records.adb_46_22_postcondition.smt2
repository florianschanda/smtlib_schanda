...
(declare-const temp___198 index)

(declare-const temp___1981 (Array Int value))

(declare-const temp___1982 (Array Int value))
...
;; H
  (assert (= temp___198 a__split_fields3))

;; H
  (assert (= temp___1981 a__split_fields4))

;; H
  (assert (= temp___1982 a__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 37, characters 0-0
  (not (= (to_rep (select a__split_fields7 i)) 23)))
(check-sat)
(exit)
