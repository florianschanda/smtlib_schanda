...
(declare-const vk__tag__t__my_name__first__bit Int)

(declare-const vk__tag__t__my_name__last__bit Int)

(declare-const vk__tag__t__my_name__position Int)
...
(declare-const n__attr__tag Int)
...
(declare-const tag_v__split_fields1 us_private)

(declare-const tag_v__split_fields2 Int)

(declare-const n__split_fields us_main_type)

(declare-const n__split_fields1 us_private)

(declare-const usq_ us_main_type)
...
(declare-const tag_v__split_fields3 us_main_type)

(declare-const tag_v__split_fields4 us_private)

(declare-const tag_v__split_fields5 Int)

(declare-const result us_main_type)

(declare-const result1 us_private)

(declare-const n__split_fields2 us_main_type)

(declare-const n__split_fields3 us_private)
