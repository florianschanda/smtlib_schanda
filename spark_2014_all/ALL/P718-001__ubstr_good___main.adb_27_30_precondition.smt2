...
(define-fun default_initial_assumption ((temp___expr_814 us_rep)
  (temp___skip_top_level_815 Bool)) Bool (and
                                         (= (attr__tag temp___expr_814)
                                         us_tag)
                                         (=>
                                         (not
...
(declare-datatypes ()
((mutable_t__ref1 (mk_mutable_t__ref1 (mutable_t__content1 us_rep)))))
...
;; vk__tag__fs__name__t__compat_axiom
  (assert
  (forall ((this us_rep))
  (! (= (to_string1 this) (to_string2 us_tag this)) :pattern ((to_string2
                                                              us_tag this)) )))

;; vk__tag__name_p__mutable_t__compat_axiom
  (assert
  (forall ((this us_rep))
  (! (= (to_string1 this) (to_string2 us_tag1 this)) :pattern ((to_string2
                                                               us_tag1 this)) )))

;; extension__mutable_tag_name__mutable_t__compat_axiom
  (assert
  (forall ((this us_rep))
  (! (= (to_string1 this) (to_string2 us_tag2 this)) :pattern ((to_string2
                                                               us_tag2 this)) )))

(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__vk__tag__t__my_name us_rep)))))
(define-fun us_split_fields_My_Name__projection ((a us_split_fields2)) us_rep
  (rec__vk__tag__t__my_name a))
...
(declare-fun vk__tag__t__my_name__first__bit () Int)

(declare-fun vk__tag__t__my_name__last__bit () Int)

(declare-fun vk__tag__t__my_name__position () Int)

;; vk__tag__t__my_name__first__bit_axiom
  (assert (<= 0 vk__tag__t__my_name__first__bit))

;; vk__tag__t__my_name__last__bit_axiom
  (assert (< vk__tag__t__my_name__first__bit vk__tag__t__my_name__last__bit))

;; vk__tag__t__my_name__position_axiom
  (assert (<= 0 vk__tag__t__my_name__position))
...
(define-fun default_initial_assumption1 ((temp___expr_833 us_rep1)
  (temp___skip_top_level_834 Bool)) Bool (let ((temp___835 (rec__vk__tag__t__my_name
                                                           ...
                                                           temp___expr_833))))
                                         (and
                                         (= (attr__tag temp___835) us_tag1)
                                         (= (length1 temp___835) 0))))

(declare-fun name (us_rep1) us_rep)

(declare-fun name__function_guard (us_rep us_rep1) Bool)

;; name__post_axiom
  (assert
  (forall ((this us_rep1))
  (! (= (attr__tag (name this)) us_tag) :pattern ((name this)) )))

;; name__def_axiom
  (assert
  (forall ((this us_rep1))
  (! (= (name this) (rec__vk__tag__t__my_name (us_split_fields3 this))) :pattern (
  (name this)) )))

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun n__attr__tag () Int)
...
(define-fun default_initial_assumption2 ((temp___expr_826 us_rep)
  (temp___skip_top_level_827 Bool)) Bool (and
                                         (= (attr__tag temp___expr_826)
                                         us_tag1)
                                         (=>
                                         (not
...
(declare-fun tag_v__split_fields () us_main_type)

(declare-fun tag_v__split_fields1 () us_private)

(declare-fun tag_v__split_fields2 () Int)

(declare-fun n__split_fields () us_main_type)

(declare-fun n__split_fields1 () us_private)

(declare-fun usq_ () us_main_type)

(declare-fun usq_1 () us_private)

(declare-fun usq_2 () Int)

(declare-fun temp___864 () us_main_type)

(declare-fun temp___8641 () us_private)

(declare-fun temp___8642 () Int)

(declare-fun o () us_main_type)
...
(declare-fun tag_v__split_fields3 () us_main_type)

(declare-fun tag_v__split_fields4 () us_private)

(declare-fun tag_v__split_fields5 () Int)

(declare-fun result () us_main_type)

(declare-fun result1 () us_private)

(declare-fun n__split_fields2 () us_main_type)

(declare-fun n__split_fields3 () us_private)

(declare-fun result2 () Bool)

(define-fun tag_v__split_fields6 () us_split_fields2 (mk___split_fields1
                                                     (mk___rep
                                                     (mk___split_fields
                                                     tag_v__split_fields3
                                                     tag_v__split_fields4)
                                                     tag_v__split_fields5)))

(define-fun o7 () us_rep (mk___rep (mk___split_fields o4 o5) o6))

(define-fun o8 () us_rep (mk___rep (mk___split_fields o o1) o2))

;; H
  (assert (default_initial_assumption1
  (mk___rep1
  (mk___split_fields1
  (mk___rep (mk___split_fields tag_v__split_fields tag_v__split_fields1)
  tag_v__split_fields2))) false))

;; H
  (assert (default_initial_assumption
  (mk___rep (mk___split_fields n__split_fields n__split_fields1)
  n__attr__tag) false))

;; H
  (assert
  (and
  (= (mk___rep (mk___split_fields usq_ usq_1) usq_2) (name
                                                     (mk___rep1
                                                     tag_v__split_fields6)))
  (and (and (= tag_v__split_fields3 usq_) (= tag_v__split_fields4 usq_1))
...
;; H
  (assert
  (and (= o8 (name (mk___rep1 tag_v__split_fields6)))
  (and (and (= tag_v__split_fields3 o) (= tag_v__split_fields4 o1))
  (= tag_v__split_fields5 o2))))

;; H
  (assert (and (= o3 (length1 o8)) (in_range3 o3)))

;; H
  (assert (= result2 (ite (< o3 500000) true false)))
...
;; H
  (assert
  (and (= o7 (name (mk___rep1 tag_v__split_fields6)))
  (and (and (= tag_v__split_fields3 o4) (= tag_v__split_fields4 o5))
  (= tag_v__split_fields5 o6))))

(assert
;; WP_parameter_def
 ;; File "main.adb", line 7, characters 0-0
  (not (< (length1 o7) 500000)))
(check-sat)
(exit)
