...
;; H
  (assert
  (and (= rax__attr__constrained true)
  (= (to_rep4 (rec__discrimrec__register_type__option rax__split_discrs)) 0)))

;; H
  (assert
  (and
  (= 0 (to_rep4 (rec__discrimrec__register_type__option rax__split_discrs)))
