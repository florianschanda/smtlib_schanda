...
;; H
  ...
  (= o1 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o1 0)))
...
;; H
  (assert
  (=> (<= (to_rep1 data__first) (to_rep1 data__last))
  (= o (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o 0)))
