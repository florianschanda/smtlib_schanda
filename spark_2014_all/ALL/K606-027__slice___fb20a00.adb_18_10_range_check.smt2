...
(declare-sort lower 0)

(define-fun in_range4 ((x Int)) Bool (and (<= 97 x) (<= x 122)))
...
(declare-fun user_eq4 (lower lower) Bool)

(declare-const dummy4 lower)

(declare-datatypes ((lower__ref 0))
(((mk_lower__ref (lower__content lower)))))
(define-fun lower__ref___projection ((a lower__ref)) lower (lower__content a))
...
(define-fun dynamic_invariant2 ((temp___expr_194 us_t1)
  ...
  (temp___do_toplevel_193 Bool)) Bool (=>
                                      ...
                                      (last1 str) (first3 temp___expr_194)
                                      (last3 temp___expr_194))
                                      (and
                                      (= (first3 temp___expr_194) (first1
                                                                  str))
                                      (= (last3 temp___expr_194) (last1 str))))))
...
;; H
  (assert (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= 1 (to_rep1 (first (rt str))))))
(check-sat)
(exit)
