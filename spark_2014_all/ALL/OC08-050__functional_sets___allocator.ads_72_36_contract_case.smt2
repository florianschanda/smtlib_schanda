...
(declare-fun o5 () (Array Int status))
...
;; H
  (assert
  (= (mem (rec__allocator__m__t__allocated (us_split_fields1 (model__ data)))
     res) true))

(assert
;; WP_parameter_def
 ;; File "allocator.adb", line 7, characters 0-0
  (not
  (= (is_add
     (rec__allocator__m__t__available (us_split_fields1 (model__ data)))
     res
     (rec__allocator__m__t__available (us_split_fields1 (model__ data3)))) true)))
(check-sat)
(exit)
