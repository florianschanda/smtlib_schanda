...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a1 i))) o1))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__second_value
     (us_split_fields1 (select a1 i))) o3))
...
;; H
  (assert
  (= (rec__arrays_of_records__basic_record__flag
     (us_split_fields1 (select a2 i))) o9))

;; H
  (assert
  (= (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a2 i))) o10))
...
;; WP_parameter_def
 ;; File "arrays_of_records.adb", line 15, characters 0-0
  ...
  (= (to_rep
     (rec__arrays_of_records__basic_record__first_value
     (us_split_fields1 (select a4 i)))) 23)))
(check-sat)
(exit)
