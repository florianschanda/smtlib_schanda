...
(declare-fun perm__perm_transitive__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun perm__perm_transitive__result1 () Int)

(declare-fun perm__perm_transitive__result2 () Int)

(declare-fun perm__perm_transitive__result3 () Int)

(declare-fun perm__perm_transitive__result4 () Int)

(declare-fun perm__perm_transitive__result5 () Int)
