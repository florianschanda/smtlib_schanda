...
;; H
  (assert
  (and (= o (induction_hypothesis a b c))
  (and (in_range4 o) (=> (= (of_int o) true) (= (is_perm a c) true)))))

;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref perm__perm_transitive__result)))
...
;; H
  (assert
  (= (mk_int__ref perm__perm_transitive__result4) (mk_int__ref
                                                  perm__perm_transitive__result2)))

;; H
  (assert (= perm__perm_transitive__result5 perm__perm_transitive__result3))

;; H
  (assert (= (of_int perm__perm_transitive__result4) true))
