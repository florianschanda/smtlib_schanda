...
(((mk___split_fields (rec__dic_pred__t__f natural)))))
...
(declare-datatypes ((s__ref 0)) (((mk_s__ref (s__content us_rep1)))))
...
(((mk_container__ref (container__content us_rep2)))))
...
(declare-datatypes ((tT1sP1__ref 0))
(((mk_tT1sP1__ref (tT1sP1__content tT1sP1)))))
...
(declare-datatypes ((tvS__ref 0)) (((mk_tvS__ref (tvS__content us_rep3)))))
