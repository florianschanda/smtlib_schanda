...
(define-fun us_split_fields_Reserved_1__4__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__sys_status_type__reserved_1 a))

(define-fun us_split_fields_Reserved_2__4__projection ((a us_split_fields)) bits_5
...
(define-fun register_type__ref___30__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___21__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___21__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2788 us_t1)
  (temp___is_init_2785 Bool) (temp___skip_constant_2786 Bool)
  (temp___do_toplevel_2787 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2786 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2788)
                                       (last3 temp___expr_2788))
                                       (and (= (first3 temp___expr_2788) 1)
                                       (= (last3 temp___expr_2788) 5)))))
...
(define-fun target__ref___10__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___10__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_2839 us_t2)
  (temp___is_init_2836 Bool) (temp___skip_constant_2837 Bool)
  (temp___do_toplevel_2838 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2837 true))
                                       (and (dynamic_property3 1 5
                                       (first5 temp___expr_2839)
                                       (last5 temp___expr_2839))
                                       (and (= (first5 temp___expr_2839) 1)
                                       (= (last5 temp___expr_2839) 5)))))
...
(declare-const temp___7757 (Array Int bits_8))

(declare-const temp___77571 t2)

(define-fun temp___77572 () us_t2 (mk___t2 temp___7757 temp___77571))
...
;; H
  (assert
  (and (= temp___77572 (register_to_bytes reg)) (dynamic_invariant1
  temp___77572 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___77571)) (to_rep (last4 temp___77571)))
     (+ (- (to_rep (last4 temp___77571)) (to_rep (first4 temp___77571))) 1)
     0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
