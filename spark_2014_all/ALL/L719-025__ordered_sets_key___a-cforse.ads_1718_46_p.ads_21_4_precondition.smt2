...
(declare-fun dummy3 () element_type1)
...
;; key__post_axiom
  (assert
  (forall ((i Int))
  (! (=> (dynamic_invariant i true true true) (dynamic_invariant3 (key i)
...
(define-fun e_is_find ((container1 us_rep1) (item Int)
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container1)))
     ...
     (forall ((item Int))
     (=> (and (in_range6 item) (= (contains (model__ container1) item) true))
