...
(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_not_inline__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_not_inline__result1 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_not_inline__result2 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_not_inline__result3 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_not_inline__result4 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_not_inline__result5 () Int)
