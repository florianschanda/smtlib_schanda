...
(declare-fun stable_marriage__invert_2__result1 () (Array Int ranking))

(declare-fun stable_marriage__invert_2__result2 () (Array Int ranking))

(declare-fun stable_marriage__invert_2__result3 () (Array Int ranking))

(declare-fun result__8 () (Array Int ranking))

(declare-fun rank7 () Int)

(declare-fun stable_marriage__invert_2__result4 () (Array Int ranking))

(declare-fun result__9 () (Array Int ranking))

(declare-fun rank8 () Int)

(declare-fun stable_marriage__invert_2__result5 () (Array Int ranking))
...
;; H
  (assert
  (= stable_marriage__invert_2__result1 stable_marriage__invert_2__result2))

;; H
  (assert
  (= stable_marriage__invert_2__result3 stable_marriage__invert_2__result1))
...
;; H
  (assert
  (= (mk_map__ref1 stable_marriage__invert_2__result4) (mk_map__ref1
                                                       stable_marriage__invert_2__result2)))
...
;; H
  (assert
  (= stable_marriage__invert_2__result5 stable_marriage__invert_2__result3))
...
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 45, characters 0-0
  (not
  (= (to_rep1
     (select stable_marriage__invert_2__result4 (to_rep (select r2 rank10)))) 
  rank10)))
(check-sat)
