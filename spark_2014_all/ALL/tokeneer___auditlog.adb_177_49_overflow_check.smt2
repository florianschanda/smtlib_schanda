...
(define-fun in_range ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq (fileentrycountt fileentrycountt) Bool)

(declare-const dummy fileentrycountt)
...
;; range_axiom
  (assert
  (forall ((x fileentrycountt)) (! (in_range
...
(((mk_map__ref (map__content (Array Int fileentrycountt))))))
(declare-fun slide ((Array Int fileentrycountt) Int
...
(declare-fun concat1 ((Array Int fileentrycountt) Int Int
...
(declare-fun singleton1 (fileentrycountt Int) (Array Int fileentrycountt))
...
(define-fun bool_eq ((a (Array Int fileentrycountt)) (a__first Int)
...
(declare-fun compare ((Array Int fileentrycountt) Int Int
...
(declare-fun user_eq1 (logfilecountt logfilecountt) Bool)

(declare-const dummy1 logfilecountt)
...
;; range_axiom
  (assert
  (forall ((x logfilecountt)) (! (in_range1
...
;; range_axiom
  (assert
  (forall ((x logfileindext)) (! (in_range2
...
(((mk_map__ref1 (map__content1 (Array Int logfileindext))))))
(declare-fun slide1 ((Array Int logfileindext) Int
...
(declare-fun concat2 ((Array Int logfileindext) Int Int
...
(define-fun bool_eq1 ((a (Array Int logfileindext)) (a__first Int)
...
(declare-fun compare1 ((Array Int logfileindext) Int Int
...
(declare-fun user_eq3 ((Array Int logfileindext)
...
(define-fun dynamic_invariant1 ((temp___expr_1049 Int)
...
;; H
  (assert (in_range2 currentlogfile))

;; H
  (assert (in_range4 numberlogentries))

;; H
  (assert (<= 1 (to_rep1 usedlogfiles__split_fields)))

;; H
  (assert
  (and (= o (- (to_rep1 usedlogfiles__split_fields) 1)) (in_range4
  (- (to_rep1 usedlogfiles__split_fields) 1))))
