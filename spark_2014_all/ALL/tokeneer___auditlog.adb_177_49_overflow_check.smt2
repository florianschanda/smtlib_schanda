...
(declare-fun dummy () fileentrycountt)
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int fileentrycountt))))))
...
(declare-fun dummy1 () logfilecountt)
...
(declare-fun dummy2 () logfileindext)
...
(declare-datatypes ()
((map__ref1 (mk_map__ref1 (map__content1 (Array Int logfileindext))))))
...
(declare-fun dummy3 () (Array Int logfileindext))
...
(declare-fun dummy5 () tlogentrycounttB)
...
(declare-fun dummy6 () logentrycountt)
