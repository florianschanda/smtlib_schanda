...
(declare-fun a_v2 () (Array Int integer))

(declare-fun i_v2 () Int)

(declare-fun temp___451 () Int)

(declare-fun temp___449 () (Array Int integer))
...
(declare-fun a_v21 () (Array Int integer))

(declare-fun a_v1 () map__ref)

(declare-fun result () int__ref)

(declare-fun i_v21 () Int)

(declare-fun a_v22 () (Array Int integer))

(declare-fun i_v22 () Int)

(declare-fun result1 () map__ref)

(declare-fun a_v23 () (Array Int integer))

(declare-fun a_v24 () map__ref)

(declare-fun i_v23 () int__ref)

(declare-fun a_v25 () (Array Int integer))

(declare-fun i_v24 () Int)

(declare-fun a_v26 () map__ref)

(declare-fun i_v25 () int__ref)

(declare-fun a_v27 () (Array Int integer))

(declare-fun i_v26 () Int)
...
;; H
  ...
  (= (to_rep (select (map__content a_v1) m1)) (to_rep
                                              (select (elts b_v1) m1)))))
  (forall ((m1 Int))
  (=> (and (<= (+ k_1 1) m1) (<= m1 (to_rep a_v1__last)))
  (= (to_rep (select (map__content a_v1) m1)) (to_rep
                                              (select (elts c_v1) (- m1
                                              k_1))))))))
...
;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (= temp___451 i_v21)))
...
;; H
  ...
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (forall ((m1 Int))
  (=> (and (<= (to_rep a_v2__first) m1) (<= m1 (- i_v22 1)))
  (= (to_rep (select a_v22 m1)) (to_rep (select (elts b_v2) m1)))))))
...
;; H
  ...
  (=>
  (and (<= (to_rep a_v2__first) temp___450)
  (<= temp___450 (to_rep a_v2__last)))
  (=> (<= i_v22 temp___450)
  (= (select a_v22 temp___450) (select temp___449 temp___450)))))
  (=> (<= (to_rep a_v2__first) k_2) (dynamic_property3 (to_rep a_v2__first)
  k_2 i_v22))) (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 k_2)))))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (and (<= (to_rep (first (rt b_v2))) i_v22)
  (<= i_v22 (to_rep (last (rt b_v2)))))))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= o i_v22)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (= o1 (select (elts b_v2) o))))
...
;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (and (<= (to_rep a_v2__first) i_v22) (<= i_v22 (to_rep a_v2__last)))))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= o4 i_v22)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (= o5 (store a_v22 o4 o3))))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (= result1 (mk_map__ref a_v22))))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= a_v23 o5)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= i_v22 k_2)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (= i_v23 (mk_int__ref i_v22))))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2))
  (= a_v24 (mk_map__ref a_v23))))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= i_v24 i_v22)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= a_v25 a_v23)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= i_v25 i_v23)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= a_v26 a_v24)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= i_v26 i_v24)))

;; H
  (assert
  (=> (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)) (= a_v27 a_v25)))

;; H
  (assert
  (=> (not (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)))
  (= i_v25 (mk_int__ref i_v21))))

;; H
  (assert
  (=> (not (and (<= (to_rep a_v2__first) i_v21) (<= i_v21 k_2)))
  (= a_v26 (mk_map__ref a_v2))))
...
;; H
  (assert (<= m (to_rep a_v1__last)))

(assert
;; WP_parameter_def
 ;; File "infoflow.ads", line 89, characters 0-0
  (not (<= (to_rep (first (rt c_v1))) (- m k_1))))
(check-sat)
(exit)
