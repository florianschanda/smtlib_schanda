...
(declare-datatypes ()
((natural_array__ref (mk_natural_array__ref (natural_array__content us_t)))))
...
(declare-fun y () (Array Int natural))

(declare-fun z () (Array Int natural))
...
(declare-fun y1 () (Array Int natural))

(declare-fun result2 () (Array Int natural))

(declare-fun z1 () (Array Int natural))
...
;; WP_parameter_def
 ;; File "array_comparison.ads", line 5, characters 0-0
  (not (= (bool_eq2 x1 1 5 z1 1 5) true)))
(check-sat)
