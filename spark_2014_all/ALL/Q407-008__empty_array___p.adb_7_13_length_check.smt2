...
(declare-fun temp___154 () (Array Int integer))

(declare-fun temp___1541 () t1)

(declare-fun temp___155 () (Array Int integer))

(declare-fun temp___1551 () t1)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___1551)) (to_rep (last3 temp___1551)))
     (+ (- (to_rep (last3 temp___1551)) (to_rep (first2 temp___1551))) 1) 0)
  (ite (<= 1 last) (+ (- last 1) 1) 0))))
(check-sat)
(exit)
