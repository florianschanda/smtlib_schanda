...
(define-fun tint_arrayD1__ref___9__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___9__projection ((a tint_arrayT__ref)) us_t1
...
(((mk_t224b__ref (t224b__content integer)))))
...
(declare-datatypes ((t225b__ref 0))
(((mk_t225b__ref (t225b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___9__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___9__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t228b__ref 0))
(((mk_t228b__ref (t228b__content integer)))))
...
(declare-datatypes ((t229b__ref 0))
(((mk_t229b__ref (t229b__content us_t4)))))
...
(declare-datatypes ((t230b__ref 0))
(((mk_t230b__ref (t230b__content integer)))))
...
(define-fun tint_arrayB__ref___9__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___9__projection ((a tnumber_array_typeB__ref)) us_t6
