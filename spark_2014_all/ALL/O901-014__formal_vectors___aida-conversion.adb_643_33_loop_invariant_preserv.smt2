...
;; def_axiom
  (assert
  (forall ((temp___1494 Int) (temp___1495 Int) (temp___1496 Int)
  (temp___1497 Int) (temp___1498 Int) (temp___1499 Int) (temp___1500 Int)
  (temp___1501 Int) (temp___1502 Int) (temp___1503 Int) (temp___1504 Int)
  (temp___1505 Int))
  (let ((temp___1493 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def
                     temp___1494 temp___1495 temp___1496 temp___1497
                     temp___1498 temp___1499 temp___1500 temp___1501
                     temp___1502 temp___1503 temp___1504 temp___1505)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1504
  temp___1505)
  (and (= (first5 temp___1493) temp___1504)
  (= (last5 temp___1493) temp___1505)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1493) (+ (first1 source) 0)) (of_rep1
                                                            temp___1494))
  (= (select (to_array2 temp___1493) (+ (first1 source) 1)) (of_rep1
                                                            temp___1495)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 2)) (of_rep1
                                                            temp___1496)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 3)) (of_rep1
                                                            temp___1497)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 4)) (of_rep1
                                                            temp___1498)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 5)) (of_rep1
                                                            temp___1499)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 6)) (of_rep1
                                                            temp___1500)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 7)) (of_rep1
                                                            temp___1501)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 8)) (of_rep1
                                                            temp___1502)))
  (= (select (to_array2 temp___1493) (+ (first1 source) 9)) (of_rep1
                                                            temp___1503)))))))
...
;; def_axiom
  (assert
  (forall ((temp___1511 Int) (temp___1512 Int) (temp___1513 Int))
  (let ((temp___1510 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def
                     temp___1511 temp___1512 temp___1513)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1512
  temp___1513)
  (and (= (first9 temp___1510) temp___1512)
  (= (last9 temp___1510) temp___1513)))
  (forall ((temp___1514 Int))
  (= (select (to_array4 temp___1510) temp___1514) (of_rep1 temp___1511)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_311 us_t3)
  ...
  (temp___do_toplevel_310 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first7 temp___expr_311)
                                      (last7 temp___expr_311))
                                      (and
                                      (= (first7 temp___expr_311) (first1
                                                                  source))
                                      (= (last7 temp___expr_311) (+ (first1
                                                                    source) 9))))))
...
(declare-fun temp___1508 () (Array Int integer))

(declare-fun temp___15081 () t2)
...
;; H
  (assert
  (= (mk___t2 temp___1508 temp___15081) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def
                                        2 0 9 9 9 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___15081)) (to_rep1 (last4 temp___15081)))
     (+ (- (to_rep1 (last4 temp___15081)) (to_rep1 (first4 temp___15081))) 1)
...
;; H
  (assert
  (= (slide1 temp___1508 (to_rep1 (first4 temp___15081))
...
;; H
  (assert
  (= (mk___t4 temp___1516 temp___15161) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___15161)) (to_rep1 (last8 temp___15161)))
     (+ (- (to_rep1 (last8 temp___15161)) (to_rep1 (first8 temp___15161))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1516 (to_rep1 (first8 temp___15161))
...
;; H
  (assert
  (and (= temp___1523 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 n__first) temp___1521)
  (<= temp___1521 (to_rep1 n__last)))
  (=> (< index2 temp___1521)
  (= (select n3 temp___1521) (select n1 temp___1521))))))
  (and (<= (to_rep1 (first (rt source))) index2)
  (<= index2 (+ (to_rep1 (first (rt source))) 9)))))

;; H
  (assert (not (= index2 temp___1523)))
