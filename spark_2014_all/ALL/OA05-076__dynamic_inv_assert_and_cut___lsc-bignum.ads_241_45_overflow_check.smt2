...
;; H
  (assert (= o80 (+ x_first o79)))

;; H
  (assert (and (= o81 o80) (in_range1 o80)))

;; H
  (assert (= o82 (ite (<= o81 (to_rep (last (rt x)))) true false)))

;; H
  (assert (and (= o76 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o77 (+ x_first o76)))

;; H
  (assert (and (= o78 o77) (in_range1 o77)))

;; H
  (assert (= o83 (ite (<= (to_rep (first (rt x))) o78) true false)))

;; H
  (assert (= result (ite (= o83 true) o82 false)))
...
;; H
  (assert (= o72 (+ m_first o71)))

;; H
  (assert (and (= o73 o72) (in_range1 o72)))

;; H
  (assert (= o74 (ite (<= o73 (to_rep (last (rt m)))) true false)))

;; H
  (assert (and (= o68 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o69 (+ m_first o68)))

;; H
  (assert (and (= o70 o69) (in_range1 o69)))

;; H
  (assert (= o75 (ite (<= (to_rep (first (rt m))) o70) true false)))

;; H
  (assert (= result1 (ite (= o75 true) o74 false)))
...
;; H
  (assert (= o64 (+ aux1_first o63)))

;; H
  (assert (and (= o65 o64) (in_range1 o64)))

;; H
  (assert (= o66 (ite (<= o65 (to_rep aux1__last)) true false)))

;; H
  (assert (and (= o60 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o61 (+ aux1_first o60)))

;; H
  (assert (and (= o62 o61) (in_range1 o61)))

;; H
  (assert (= o67 (ite (<= (to_rep aux1__first) o62) true false)))

;; H
  (assert (= result2 (ite (= o67 true) o66 false)))
...
;; H
  (assert (= o56 (+ aux2_first o55)))

;; H
  (assert (and (= o57 o56) (in_range1 o56)))

;; H
  (assert (= o58 (ite (<= o57 (to_rep aux2__last)) true false)))

;; H
  (assert (and (= o52 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o53 (+ aux2_first o52)))

;; H
  (assert (and (= o54 o53) (in_range1 o53)))

;; H
  (assert (= o59 (ite (<= (to_rep aux2__first) o54) true false)))
...
;; H
  (assert (= o48 (+ aux3_first o47)))

;; H
  (assert (and (= o49 o48) (in_range1 o48)))

;; H
  (assert (= o50 (ite (<= o49 (to_rep aux3__last)) true false)))

;; H
  (assert (and (= o44 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o45 (+ aux3_first o44)))

;; H
  (assert (and (= o46 o45) (in_range1 o45)))

;; H
  (assert (= o51 (ite (<= (to_rep aux3__first) o46) true false)))
...
;; H
  (assert (and (= o35 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o40 (+ aux4_first o39)))

;; H
  (assert (and (= o41 o40) (in_range1 o40)))

;; H
  (assert (= o42 (ite (<= o41 (to_rep aux4__last)) true false)))
...
;; H
  (assert (and (= o25 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o30 (+ aux4_first o29)))

;; H
  (assert (and (= o31 o30) (in_range1 o30)))

;; H
  (assert (= o43 (ite (<= (to_rep aux4__first) o31) true false)))

;; H
  (assert (= result5 (ite (= o43 true) o42 false)))
...
;; H
  (assert (= o18 (+ r_first o17)))

;; H
  (assert (and (= o19 o18) (in_range1 o18)))

;; H
  (assert (= o20 (ite (<= o19 (to_rep (last (rt r)))) true false)))

;; H
  (assert (and (= o14 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o15 (+ r_first o14)))

;; H
  (assert (and (= o16 o15) (in_range1 o15)))

;; H
  (assert (= o21 (ite (<= (to_rep (first (rt r))) o16) true false)))
...
;; H
  (assert (= o5 (from_integer o4)))

;; H
  (assert (= o1 (from_integer 2)))

;; H
  (assert (= o6 (omultiply o1 o5)))
...
;; H
  (assert (= o7 (oexpon__2 o o6)))

;; H
  (assert (= o13 (omod o7 o12)))
