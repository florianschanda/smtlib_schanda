...
(declare-fun o125 () storage_element)

(declare-fun o126 () (_ BitVec 8))
...
;; H
  (assert (= o125 (select temp___471 1)))
...
;; H
  (assert (= o128 (bvshl o127 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o121 (select temp___467 2)))
...
;; H
  (assert (= o124 (bvshl o123 ((_ int2bv 32) 16))))
