...
(declare-fun temp___849 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___851 (Array Int (Array Int et1))))
  (forall ((temp___852 Int))
  (forall ((temp___853 (Array Int et1)))
  (let ((temp___850 (temp___849 temp___851 temp___852 temp___853)))
  (forall ((temp___854 Int))
  (ite (= temp___854 temp___852)
  (= (select temp___850 temp___854) temp___853)
  (= (select temp___850 temp___854) (select temp___851 temp___854)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 307, characters 0-0
  (not (= (bool_eq3 a2 5 50 (temp___849 a i b) 5 50) true)))
(check-sat)
