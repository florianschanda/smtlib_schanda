...
(((mk_score_t__ref (score_t__content score_t)))))
...
(((mk_state__ref (state__content state)))))
...
(declare-const temp___2220 shape)

(declare-const temp___22201 direction)

(declare-const temp___22202 px_coord)

(declare-const temp___22203 py_coord)
...
(declare-const temp___2222 shape)

(declare-const temp___22221 direction)

(declare-const temp___22222 px_coord)

(declare-const temp___22223 py_coord)
