...
(define-fun dynamic_invariant1 ((temp___expr_641 Int)
  (temp___is_init_638 Bool) (temp___skip_constant_639 Bool)
  (temp___do_toplevel_640 Bool)) Bool (=>
                                      (or (= temp___is_init_638 true)
                                      (<= (- 2147483648) 2147483647))
                                      (in_range2 temp___expr_641)))
...
;; rand__post_axiom
  ...
  (rand us_void_param) true false true) :pattern ((rand us_void_param)) )))

(declare-sort score_t 0)

(define-fun in_range3 ((x (_ BitVec 32))) Bool (and
...
(define-fun dynamic_invariant2 ((temp___expr_1849 (_ BitVec 32))
...
;; range_axiom
  (assert
  (forall ((x shape)) (! (in_range4 (to_rep x)) :pattern ((to_rep x)) )))
...
;; inversion_axiom
  (assert
  (forall ((x cell)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)) )))

;; range_axiom
  (assert
  (forall ((x cell)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(define-fun bool_eq ((a (Array Int cell)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep1 (select a temp___idx_139)) (to_rep1
...
(declare-fun possible_three_shapes () map2)
...
;; no_overlap__def_axiom
  ...
  (forall ((p us_rep))
  (! (= (= (no_overlap b p) true)
     (ite (= (to_rep (rec__patris__piece__s (us_split_fields1 p))) 2)
     (and
     (and
     (and
     ...
     (= (is_empty b
        (+ (to_rep3 (rec__patris__piece__y (us_split_fields1 p))) 1)
        (+ (to_rep2 (rec__patris__piece__x (us_split_fields1 p))) 1)) true))
     (ite (= (to_rep (rec__patris__piece__s (us_split_fields1 p))) 1)
     (forall ((y Int))
     (=> (and (<= 0 y) (<= y 3))
     (forall ((x Int))
     (=> (and (<= 0 x) (<= x 3))
...
(define-fun dynamic_invariant5 ((temp___expr_1855 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_1861 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_1873 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_1879 Int)
...
(define-fun dynamic_invariant9 ((temp___expr_1914 Int)
...
(define-fun dynamic_invariant10 ((temp___expr_1920 Int)
...
(define-fun dynamic_invariant11 ((temp___expr_1926 Int)
...
;; is_empty__def_axiom
  ...
  (! (= (= (is_empty b y x) true)
     ...
     (= (to_rep1 (let ((temp___1984 (select b y))) (select temp___1984 x))) 0))) :pattern (
  (is_empty b y x)) ))))
...
;; is_complete_line__def_axiom
  ...
  (! (= (= (is_complete_line l) true)
     (forall ((x Int))
     (=> (and (<= 1 x) (<= x 10)) (not (= (to_rep1 (select l x)) 0))))) :pattern (
  (is_complete_line l)) )))
...
(declare-fun redraw_board () Bool)

(declare-fun redraw_score () Bool)

(declare-fun redraw_current_piece () Bool)

(declare-fun score_nbr () (_ BitVec 32))

(declare-fun level_nbr () (_ BitVec 32))

(declare-fun line_counter () (_ BitVec 32))

(declare-fun best_score_nbr () (_ BitVec 32))

(declare-fun cur_board () (Array Int (Array Int cell)))

(declare-fun cur_piece__split_fields () shape)

(declare-fun cur_piece__split_fields1 () direction)

(declare-fun cur_piece__split_fields2 () px_coord)

(declare-fun cur_piece__split_fields3 () py_coord)

(declare-fun next_piece__split_fields () shape)

(declare-fun next_piece__split_fields1 () direction)

(declare-fun next_piece__split_fields2 () px_coord)

(declare-fun next_piece__split_fields3 () py_coord)

(declare-fun cur_state () Int)

(declare-fun action_request_nbr () Int)

(declare-fun speed_up () Bool)
...
(declare-fun o5 () py_coord)

(declare-fun o6 () px_coord)

(declare-fun o7 () direction)

(declare-fun o8 () shape)

(declare-fun o9 () shape)

(declare-fun o10 () direction)

(declare-fun o11 () px_coord)

(declare-fun o12 () py_coord)

(declare-fun temp___2220 () shape)

(declare-fun temp___22201 () direction)

(declare-fun temp___22202 () px_coord)

(declare-fun temp___22203 () py_coord)
...
(declare-fun o19 () py_coord)

(declare-fun o20 () px_coord)

(declare-fun o21 () direction)

(declare-fun o22 () shape)

(declare-fun o23 () shape)

(declare-fun o24 () direction)

(declare-fun o25 () px_coord)

(declare-fun o26 () py_coord)

(declare-fun temp___2222 () shape)

(declare-fun temp___22221 () direction)

(declare-fun temp___22222 () px_coord)

(declare-fun temp___22223 () py_coord)

(declare-fun score_nbr1 () (_ BitVec 32))

(declare-fun level_nbr1 () (_ BitVec 32))

(declare-fun line_counter1 () (_ BitVec 32))

(declare-fun best_score_nbr1 () (_ BitVec 32))

(declare-fun cur_board1 () (Array Int (Array Int cell)))

(declare-fun cur_piece__split_fields4 () us_split_fields)

(declare-fun next_piece__split_fields4 () us_split_fields)

(declare-fun cur_state1 () Int)

(declare-fun action_request_nbr1 () Int)

(declare-fun speed_up1 () Bool)

(declare-fun success1 () Bool)

(declare-fun result () bool__ref)

(declare-fun redraw_board1 () Bool)

(declare-fun result1 () bool__ref)

(declare-fun redraw_current_piece1 () Bool)

(declare-fun result2 () bool__ref)

(declare-fun redraw_score1 () Bool)

(declare-fun result3 () int__ref)

(declare-fun action_request_nbr2 () Int)

(declare-fun cur_piece__split_fields5 () us_split_fields)

(declare-fun success2 () Bool)

(declare-fun result4 () bool__ref)

(declare-fun redraw_current_piece2 () Bool)
...
(declare-fun score_nbr2 () (_ BitVec 32))

(declare-fun level_nbr2 () (_ BitVec 32))

(declare-fun line_counter2 () (_ BitVec 32))
...
(declare-fun redraw_board2 () Bool)

(declare-fun result7 () bool__ref)

(declare-fun speed_up2 () Bool)

(declare-fun result8 () us_split_fields__ref)

(declare-fun next_piece__split_fields5 () us_split_fields)

(declare-fun result9 () Bool)

(declare-fun result10 () int__ref)

(declare-fun cur_state5 () Int)

(declare-fun result11 () t__ref)

(declare-fun best_score_nbr2 () (_ BitVec 32))

(declare-fun result12 () us_split_fields__ref)

(declare-fun cur_piece__split_fields6 () us_split_fields)

(declare-fun result13 () us_split_fields__ref)

(declare-fun next_piece__split_fields6 () us_split_fields)

(declare-fun result14 () int__ref)

(declare-fun cur_state6 () Int)

(declare-fun result15 () bool__ref)

(declare-fun redraw_score2 () Bool)

(declare-fun redraw_board3 () bool__ref)

(declare-fun redraw_score3 () bool__ref)

(declare-fun redraw_current_piece3 () bool__ref)

(declare-fun score_nbr3 () t__ref)

(declare-fun level_nbr3 () t__ref)

(declare-fun line_counter3 () t__ref)

(declare-fun best_score_nbr3 () t__ref)

(declare-fun cur_board4 () map__ref1)

(declare-fun cur_piece__split_fields7 () us_split_fields__ref)

(declare-fun next_piece__split_fields7 () us_split_fields__ref)

(declare-fun cur_state7 () int__ref)

(declare-fun action_request_nbr3 () int__ref)

(declare-fun speed_up3 () bool__ref)

(declare-fun success3 () bool__ref)

(declare-fun redraw_board4 () Bool)

(declare-fun redraw_score4 () Bool)

(declare-fun redraw_current_piece4 () Bool)

(declare-fun score_nbr4 () (_ BitVec 32))

(declare-fun level_nbr4 () (_ BitVec 32))

(declare-fun line_counter4 () (_ BitVec 32))

(declare-fun best_score_nbr4 () (_ BitVec 32))

(declare-fun cur_board5 () (Array Int (Array Int cell)))

(declare-fun cur_piece__split_fields8 () us_split_fields)

(declare-fun next_piece__split_fields8 () us_split_fields)

(declare-fun cur_state8 () Int)

(declare-fun action_request_nbr4 () Int)

(declare-fun speed_up4 () Bool)

(declare-fun success4 () Bool)

(define-fun cur_state9 () int__ref (mk_int__ref cur_state))
...
;; H
  (assert (=> (= cur_state 0) (= result3 (mk_int__ref action_request_nbr))))

;; H
  (assert (=> (= cur_state 0) (= action_request_nbr2 0)))

;; H
  (assert
  (=> (= cur_state 0)
  (= (valid_configuration__2 cur_state cur_piece__split_fields5 cur_board) true)))

;; H
  (assert
  (=> (= cur_state 0) (= result4 (mk_bool__ref redraw_current_piece1))))

;; H
  (assert (=> (= cur_state 0) (= redraw_current_piece2 (of_int 1))))

;; H
  (assert
  (=> (= cur_state 0) (=> (not (= success2 true)) (= result5 cur_state9))))

;; H
  (assert (=> (= cur_state 0) (=> (not (= success2 true)) (= cur_state2 1))))
...
;; H
  ...
  (= (valid_configuration__2 cur_state3 cur_piece__split_fields5 cur_board2) true))
  (in_range9 cur_state3)))))
...
;; H
  ...
  (=> (not (= success2 true))
  (and
  (and (= (get_state cur_state4) 3)
  (= (valid_configuration__2 cur_state4 cur_piece__split_fields5 cur_board3) true))
  (and
  (and (and (in_range9 cur_state4) (in_range3 level_nbr2)) (in_range3
  score_nbr2)) (in_range3 line_counter2))))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (= success2 true)) (= result6 (mk_bool__ref redraw_board1)))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (= success2 true)) (= redraw_board2 (of_int 1)))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= cur_state4 cur_state))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= cur_board3 cur_board))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= line_counter2 line_counter))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= level_nbr2 level_nbr))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= score_nbr2 score_nbr))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= redraw_board2 redraw_board1))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= cur_state4 cur_state1))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= cur_board3 cur_board1))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= line_counter2 line_counter1))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= level_nbr2 level_nbr1))))

;; H
  (assert
  (=> (= cur_state 0)
  (=> (not (not (= success2 true))) (= score_nbr2 score_nbr1))))
...
;; H
  (assert (=> (= cur_state 0) (= speed_up2 speed_up)))

;; H
  (assert
  (=> (= cur_state 0)
  (= next_piece__split_fields6 (mk___split_fields next_piece__split_fields
                               next_piece__split_fields1
                               next_piece__split_fields2
                               next_piece__split_fields3))))

;; H
  (assert (=> (= cur_state 0) (= best_score_nbr2 best_score_nbr)))

;; H
  (assert (=> (= cur_state 0) (= redraw_score2 redraw_score1)))

;; H
  (assert (=> (= cur_state 0) (= speed_up2 speed_up1)))

;; H
  (assert
  (=> (= cur_state 0)
  (= next_piece__split_fields6 next_piece__split_fields4)))

;; H
  (assert (=> (= cur_state 0) (= best_score_nbr2 best_score_nbr1)))
...
;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (= result7 (mk_bool__ref speed_up)))))

;; H
  (assert
  (=> (not (= cur_state 0)) (=> (= cur_state 3) (= speed_up2 (of_int 0)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep3 o5) 1)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep2 o6) 5)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0)
  (and (= o3 (rand Tuple0)) (in_range2 o3))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= o4 (mod2 o3 4))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep4 o7) o4)))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0)
  (and (= o (rand Tuple0)) (in_range2 o))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= o1 (mod2 o 7))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= o2 (+ 1 o1))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep o8) o2)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (= (to_rep next_piece__split_fields) 0) (= o8 o9)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= o7 o10)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= o6 o11)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= o5 o12)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= temp___2220 o9)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= temp___22201 o10)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= temp___22202 o11)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0) (= temp___22203 o12)))))
...
;; H
  ...
  (= result8 (mk___split_fields__ref
             (mk___split_fields next_piece__split_fields
             next_piece__split_fields1 next_piece__split_fields2
             next_piece__split_fields3)))))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (= (to_rep next_piece__split_fields) 0)
  (= next_piece__split_fields5 (mk___split_fields temp___2220 temp___22201
                               temp___22202 temp___22203))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (not (= (to_rep next_piece__split_fields) 0))
  (= next_piece__split_fields5 (mk___split_fields next_piece__split_fields
                               next_piece__split_fields1
                               next_piece__split_fields2
                               next_piece__split_fields3))))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (not (= (to_rep next_piece__split_fields) 0))
  (= next_piece__split_fields5 next_piece__split_fields4)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (and (= o13 (no_overlap cur_board (mk___rep next_piece__split_fields5)))
  (= (= o13 true)
  (ite (= (to_rep (rec__patris__piece__s next_piece__split_fields5)) 2)
  (and
  (and
  (and
  (= (is_empty cur_board
     (to_rep3 (rec__patris__piece__y next_piece__split_fields5))
     (to_rep2 (rec__patris__piece__x next_piece__split_fields5))) true)
  (= (is_empty cur_board
     (to_rep3 (rec__patris__piece__y next_piece__split_fields5))
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields5)) 1)) true))
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields5)) 1)
     (to_rep2 (rec__patris__piece__x next_piece__split_fields5))) true))
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields5)) 1)
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields5)) 1)) true))
  (ite (= (to_rep (rec__patris__piece__s next_piece__split_fields5)) 1)
  (forall ((y Int))
  (=> (and (<= 0 y) (<= y 3))
  (forall ((x Int))
  (=> (and (<= 0 x) (<= x 3))
  ...
  (= (get
     (select possible_i_shapes (to_rep4
                               (rec__patris__piece__d
                               next_piece__split_fields5)))
     y x) true)
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields5)) y)
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields5)) x)) true))))))
  (forall ((y Int))
  (=> (and (<= 0 y) (<= y 2))
  (forall ((x Int))
  (=> (and (<= 0 x) (<= x 2))
  ...
  (= (get
     ...
     (to_rep (rec__patris__piece__s next_piece__split_fields5))
     (to_rep4 (rec__patris__piece__d next_piece__split_fields5))) y x) true)
  (= (is_empty cur_board
     (+ (to_rep3 (rec__patris__piece__y next_piece__split_fields5)) y)
     (+ (to_rep2 (rec__patris__piece__x next_piece__split_fields5)) x)) true)))))))))))))
...
;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (= result9 (ite (not (= o13 true)) true false)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (= result9 true) (= result10 cur_state9)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (= result9 true) (= cur_state5 4)))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (= result9 true)
  (=> (bvugt score_nbr best_score_nbr)
  (= result11 (mk_t__ref best_score_nbr)))))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (= result9 true)
  (=> (bvugt score_nbr best_score_nbr) (= best_score_nbr2 score_nbr))))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (= result9 true)
  (=> (not (bvugt score_nbr best_score_nbr))
  (= best_score_nbr2 best_score_nbr))))))
...
;; H
  ...
  (=> (= result9 true)
  (=> (not (bvugt score_nbr best_score_nbr))
  (= best_score_nbr2 best_score_nbr1))))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (= result9 true)
  (= next_piece__split_fields6 next_piece__split_fields5)))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (= result9 true)
  (= cur_piece__split_fields6 (mk___split_fields cur_piece__split_fields
                              cur_piece__split_fields1
                              cur_piece__split_fields2
...
;; H
  ...
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (= result9 true) (= cur_piece__split_fields6 cur_piece__split_fields4)))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (not (= result9 true))
  (= result12 (mk___split_fields__ref
              (mk___split_fields cur_piece__split_fields
              cur_piece__split_fields1 cur_piece__split_fields2
              cur_piece__split_fields3)))))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (not (= result9 true))
  (= cur_piece__split_fields6 next_piece__split_fields5)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= (to_rep3 o19) 1)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= (to_rep2 o20) 5)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (not (= result9 true)) (and (= o17 (rand Tuple0)) (in_range2 o17))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= o18 (mod2 o17 4))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= (to_rep4 o21) o18)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (not (= result9 true)) (and (= o14 (rand Tuple0)) (in_range2 o14))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= o15 (mod2 o14 7))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= o16 (+ 1 o15))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= (to_rep o22) o16)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= o22 o23)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= o21 o24)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= o20 o25)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= o19 o26)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= temp___2222 o23)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= temp___22221 o24)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= temp___22222 o25)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= temp___22223 o26)))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (not (= result9 true))
  (= result13 (mk___split_fields__ref next_piece__split_fields5))))))
...
;; H
  ...
  (=> (= cur_state 3)
  (=> (not (= result9 true))
  (= next_piece__split_fields6 (mk___split_fields temp___2222 temp___22221
                               temp___22222 temp___22223))))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= result14 cur_state9)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= cur_state6 0)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (=> (not (= result9 true)) (= cur_state5 cur_state6)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (not (= result9 true)) (= best_score_nbr2 best_score_nbr)))))
...
;; H
  ...
  (=> (not (= cur_state 0))
  (=> (= cur_state 3)
  (=> (not (= result9 true)) (= best_score_nbr2 best_score_nbr1)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (= result15 (mk_bool__ref redraw_score1)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (= cur_state 3) (= redraw_score2 (of_int 1)))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3)) (= speed_up2 speed_up))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3)) (= cur_state5 cur_state))))
...
;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3)) (= best_score_nbr2 best_score_nbr))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3)) (= redraw_score2 redraw_score1))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3)) (= speed_up2 speed_up1))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3)) (= cur_state5 cur_state1))))
...
;; H
  ...
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3))
  (= cur_piece__split_fields6 cur_piece__split_fields4))))

;; H
  (assert
  (=> (not (= cur_state 0))
  (=> (not (= cur_state 3)) (= best_score_nbr2 best_score_nbr1))))
...
;; H
  (assert (=> (not (= cur_state 0)) (= success2 success)))

;; H
  (assert
  (=> (not (= cur_state 0)) (= action_request_nbr2 action_request_nbr)))

;; H
  (assert (=> (not (= cur_state 0)) (= cur_state4 cur_state5)))

;; H
  (assert
  (=> (not (= cur_state 0))
  (= cur_piece__split_fields5 cur_piece__split_fields6)))

;; H
  (assert (=> (not (= cur_state 0)) (= cur_board3 cur_board)))

;; H
  (assert (=> (not (= cur_state 0)) (= line_counter2 line_counter)))

;; H
  (assert (=> (not (= cur_state 0)) (= level_nbr2 level_nbr)))

;; H
  (assert (=> (not (= cur_state 0)) (= score_nbr2 score_nbr)))

;; H
  (assert
  (=> (not (= cur_state 0)) (= redraw_current_piece2 redraw_current_piece1)))

;; H
  (assert (=> (not (= cur_state 0)) (= redraw_board2 redraw_board1)))

;; H
  (assert (=> (not (= cur_state 0)) (= success2 success1)))

;; H
  (assert
  (=> (not (= cur_state 0)) (= action_request_nbr2 action_request_nbr1)))
...
;; H
  (assert (=> (not (= cur_state 0)) (= cur_board3 cur_board1)))

;; H
  (assert (=> (not (= cur_state 0)) (= line_counter2 line_counter1)))

;; H
  (assert (=> (not (= cur_state 0)) (= level_nbr2 level_nbr1)))

;; H
  (assert (=> (not (= cur_state 0)) (= score_nbr2 score_nbr1)))
...
;; H
  (assert (= success3 (mk_bool__ref success2)))

;; H
  (assert (= speed_up3 (mk_bool__ref speed_up2)))

;; H
  (assert (= action_request_nbr3 (mk_int__ref action_request_nbr2)))

;; H
  (assert (= cur_state7 (mk_int__ref cur_state4)))

;; H
  (assert
  (= next_piece__split_fields7 (mk___split_fields__ref
                               next_piece__split_fields6)))

;; H
  (assert
  (= cur_piece__split_fields7 (mk___split_fields__ref
                              cur_piece__split_fields5)))

;; H
  (assert (= cur_board4 (mk_map__ref1 cur_board3)))

;; H
  (assert (= best_score_nbr3 (mk_t__ref best_score_nbr2)))

;; H
  (assert (= line_counter3 (mk_t__ref line_counter2)))

;; H
  (assert (= level_nbr3 (mk_t__ref level_nbr2)))

;; H
  (assert (= score_nbr3 (mk_t__ref score_nbr2)))

;; H
  (assert (= redraw_current_piece3 (mk_bool__ref redraw_current_piece2)))

;; H
  (assert (= redraw_score3 (mk_bool__ref redraw_score2)))

;; H
  (assert (= redraw_board3 (mk_bool__ref redraw_board2)))

;; H
  (assert (= success4 success2))

;; H
  (assert (= speed_up4 speed_up2))

;; H
  (assert (= action_request_nbr4 action_request_nbr2))

;; H
  (assert (= cur_state8 cur_state4))

;; H
  (assert (= next_piece__split_fields8 next_piece__split_fields6))

;; H
  (assert (= cur_piece__split_fields8 cur_piece__split_fields5))

;; H
  (assert (= cur_board5 cur_board3))

;; H
  (assert (= best_score_nbr4 best_score_nbr2))

;; H
  (assert (= line_counter4 line_counter2))

;; H
  (assert (= level_nbr4 level_nbr2))

;; H
  (assert (= score_nbr4 score_nbr2))

;; H
  (assert (= redraw_current_piece4 redraw_current_piece2))

;; H
  (assert (= redraw_score4 redraw_score2))

;; H
  (assert (= redraw_board4 redraw_board2))

(assert
;; WP_parameter_def
 ;; File "patris.ads", line 196, characters 0-0
  (not
  (= (valid_configuration__2 (int__content cur_state7)
     (us_split_fields__content cur_piece__split_fields7)
     (map__content1 cur_board4)) true)))
(check-sat)
(exit)
