...
;; H
  (assert
  (= result1 (ite (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4
             o6) true false)))
...
;; H
  (assert
  (= result2 (ite (bvule bits_manipulation_unsigned__unsigned_8__functions__extract_bits_inline__result4
             o2) true false)))
