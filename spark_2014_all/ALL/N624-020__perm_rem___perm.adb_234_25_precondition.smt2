...
;; H
  (assert
  (and (= o16 (shift_perm_l o43 o42 o40))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o40 o42) true)))))
...
;; H
  (assert
  (and (= o31 (shift_perm_r o38 o37 o35))
  (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o38 o35) true)))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o34))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o34) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o34) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o34) k))))))))))))
...
;; H
  (assert
  (and (= o33 (remove a o32))
  (and (dynamic_invariant2 o33 true false true)
  (and (= (invariant__ o33) true)
  (and (= (to_rep2 (last (rt o33))) (- (to_rep2 (last (rt a))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o32 1)))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o33) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o32 1) k) (<= k (to_rep2 (last (rt a)))))
  (= (to_rep (select (elts a) k)) (to_rep (select (elts o33) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o32 k) (<= k (- (to_rep2 (last (rt a))) 1)))
  (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o33) k))))))))))))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (= (invariant__ o33) true)))
(check-sat)
(exit)
