...
;; H
  (assert
  (= a__split_fields9 (mk___split_fields temp___310 temp___3101 temp___3102)))
...
;; H
  (assert
  (= a__split_fields10 (mk___split_fields temp___312 temp___3121 temp___3122)))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 156, characters 0-0
  (not
  (not
  (= (to_rep1
     (select (rec__arrays_in_records__record_with_arrays__first_array
             (us_split_fields__content a__split_fields11)) i)) 23))))
(check-sat)
(exit)
