...
(declare-fun temp___785 () pos)

(declare-fun temp___7851 () pos)
...
(declare-fun temp___773 () pos)

(declare-fun temp___7731 () pos)
...
(declare-fun temp___774 () pos)

(declare-fun temp___7741 () pos)
...
(declare-fun temp___775 () pos)

(declare-fun temp___7751 () pos)
...
(declare-fun temp___776 () pos)

(declare-fun temp___7761 () pos)
...
(declare-fun p__split_fields9 () us_split_fields)
...
(declare-fun p__split_fields11 () us_split_fields)
...
(declare-fun p__split_fields13 () us_split_fields__ref)

(declare-fun found3 () bool__ref)

(declare-fun c2 () int__ref)
...
(declare-fun p__split_fields15 () us_split_fields__ref)

(declare-fun s2 () map__ref)
...
(declare-fun p__split_fields17 () us_split_fields__ref)
