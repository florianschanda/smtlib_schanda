...
;; H
  (assert (and (= temp___5041 o6) (in_range1 o6)))

;; H
  (assert
  (and (<= (to_rep1 (first (rt s))) temp___5041)
  (<= temp___5041 (to_rep1 (last (rt s))))))

;; H
  (assert (= o7 temp___5041))
