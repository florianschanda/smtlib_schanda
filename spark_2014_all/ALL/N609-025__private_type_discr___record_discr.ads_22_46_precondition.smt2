...
(declare-datatypes ()
((tT19bP1__ref (mk_tT19bP1__ref (tT19bP1__content integer)))))
...
(declare-datatypes ()
((my_interm__ref (mk_my_interm__ref (my_interm__content us_rep2)))))
...
(declare-fun record_discr__interm_result__upto__first__bit2 () Int)

(declare-fun record_discr__interm_result__upto__last__bit2 () Int)

(declare-fun record_discr__interm_result__upto__position2 () Int)
...
(declare-fun record_discr__interm_result__to_search__first__bit2 () Int)

(declare-fun record_discr__interm_result__to_search__last__bit2 () Int)

(declare-fun record_discr__interm_result__to_search__position2 () Int)
