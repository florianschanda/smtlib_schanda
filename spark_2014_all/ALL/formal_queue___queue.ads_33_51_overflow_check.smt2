...
;; H
  ...
  (and (= o4 (length q))
  (and (in_range2 o4)
  (<= o4 (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))))
...
;; H
  (assert
  (and (= o2 (first_element (list__content queue__enqueue__result7)))
  (and (in_range6 o2)
  (= o2 (get (model__ (list__content queue__enqueue__result7)) 1)))))
