...
(declare-fun result____split_fields9 () integer)
...
;; H
  (assert (= result____split_fields4 o6))

;; H
  (assert (= result____split_fields5 o7))

;; H
  (assert (= o5 o8))

;; H
  (assert (= result____split_fields7 o9))
...
;; H
  (assert (= result6 result____split_fields6))

;; H
  (assert (= result7 result____split_fields7))

;; H
  (assert (= temp___1651 result____split_fields8))

;; H
  (assert (= temp___1652 result____split_fields9))

;; H
  (assert (= temp___1653 result____split_fields10))

;; H
  (assert (= temp___1654 result____split_fields11))
