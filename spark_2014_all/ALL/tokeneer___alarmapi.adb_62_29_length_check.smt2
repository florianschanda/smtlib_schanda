...
(declare-fun temp___166 (Int) (Array Int character))

;; def_axiom
  (assert
  (forall ((temp___168 Int))
  (forall ((temp___169 Int))
  (= (select (temp___166 temp___168) temp___169) (of_rep temp___168)))))
...
;; temp___String_Literal_145__def_axiom
  ...
  (! (and
     ...
     (and
     (and
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 1)) 97)
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 2)) 108))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 3)) 97))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 4)) 114))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 5)) 109))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 6)) 46))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 7)) 100))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 8)) 101))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 9)) 97))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 10)) 99))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 11)) 116))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 12)) 105))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 13)) 118))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 14)) 97))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 15)) 116))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 16)) 101))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 17)) 40))
     (= (to_rep (select (temp___String_Literal_145 us_void_param) 18)) 41)) :pattern (
...
;; outmsg__def_axiom
  ...
  (= outmsg (mk___rep
            (mk___split_fields
            (let ((temp___146 (overwrite
                              (of_array
                              (rec__tcpip__messaget__data
                              (us_split_fields1 nullmsg)) 1 4096) 1
                              (of_array (temp___String_Literal_145 Tuple0) 1
                              18))))
            (slide (to_array temp___146) (first1 temp___146) 1))
            (of_rep2 18)))))
...
(declare-const temp___6291 messagelengtht)
...
;; H
  (assert (= temp___629 o1))

;; H
  (assert (= temp___6291 o2))

;; H
  (assert (= (mk___rep (mk___split_fields temp___629 temp___6291)) nullmsg))

;; H
  (assert
  (and (= inmsg__split_fields (temp___166 0))
...
;; H
  ...
  (= temp___6282 (overwrite
                 ...
                 (mk 1 4096)) 1
                 (mk___t (temp___String_Literal_145 Tuple0) (mk 1 18))))
  (dynamic_invariant1 temp___6282 true false true)))

(assert
;; WP_parameter_def
 ;; File "alarmapi.adb", line 33, characters 0-0
  (not
