...
(define-fun o4 () us_rep1 (mk___rep1 (mk___split_fields1 o2)))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2) 1)))
  (and
  (< 0 (get
       (model__
       (mk___rep l__split_discrs (mk___split_fields l__split_fields))) i))
...
;; H
  ...
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields1)) cu2) i)
...
;; H
  (assert
  (not (= (element (mk___rep l__split_discrs l__split_fields1) cu2) 0)))

;; H
  (assert
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields1)) cu2) true))
