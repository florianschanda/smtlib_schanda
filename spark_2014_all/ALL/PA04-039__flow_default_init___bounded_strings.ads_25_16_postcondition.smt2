...
(declare-fun temp___189 () index_type)

(declare-fun temp___1891 () (Array Int character))

(declare-fun temp___1892 () t)

(declare-fun temp___1893 () length_type)
...
(declare-fun temp___191 () index_type)

(declare-fun temp___1911 () (Array Int character))

(declare-fun temp___1912 () t)

(declare-fun temp___1913 () length_type)
...
(declare-fun target__split_fields4 () t)

(declare-fun target__split_fields5 () length_type)

(declare-fun result3 () us_split_fields__ref)

(declare-fun target__split_fields6 () us_split_fields)

(declare-fun target__split_fields7 () us_split_fields__ref)

(declare-fun target__split_fields8 () us_split_fields)
