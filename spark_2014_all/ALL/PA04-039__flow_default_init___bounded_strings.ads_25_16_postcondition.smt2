...
(define-fun dynamic_invariant4 ((temp___expr_135 Int)
...
;; H
  ...
  target__split_fields2)) true false true))
...
;; H
  ...
  (<= (+ (length1
         (mk___rep target__split_discrs
         (mk___split_fields
         (mk___t target__split_fields target__split_fields1)
         target__split_fields2))) 1) (to_rep1
                                     (rec__bounded_strings__bounded_string__bound
...
;; H
  (assert
  (and
  (<= (to_rep3 (first target__split_fields1)) (+ (to_rep2
                                                 target__split_fields2) 1))
  (<= (+ (to_rep2 target__split_fields2) 1) (to_rep3
                                            (last target__split_fields1)))))
...
;; H
  ...
  (= (mk___split_fields__ref
     (mk___split_fields (mk___t result result1) result2)) (mk___split_fields__ref
                                                          (mk___split_fields
                                                          (mk___t
                                                          target__split_fields
                                                          target__split_fields1)
                                                          target__split_fields2))))
...
;; H
  (assert
  (and (= o8 (+ (to_rep2 target__split_fields5) 1)) (in_range2
  (+ (to_rep2 target__split_fields5) 1))))

;; H
  (assert (= (to_rep2 o9) o8))

;; H
  (assert (= target__split_fields3 o10))

;; H
  (assert (= target__split_fields4 o11))

;; H
  (assert (= o9 o12))

;; H
  (assert (= target__split_discrs (mk___split_discrs temp___191)))

;; H
  (assert (= temp___1911 o10))

;; H
  (assert (= temp___1912 o11))

;; H
  (assert (= temp___1913 o12))

;; H
  (assert
  (= result3 (mk___split_fields__ref
             (mk___split_fields
             (mk___t target__split_fields3 target__split_fields4)
             target__split_fields5))))

;; H
  (assert
  (= target__split_fields6 (mk___split_fields
                           (mk___t temp___1911 temp___1912) temp___1913)))
...
;; H
  (assert
  (= target__split_fields7 (mk___split_fields__ref target__split_fields6)))

;; H
  (assert (= target__split_fields8 target__split_fields6))

(assert
;; WP_parameter_def
 ;; File "bounded_strings.ads", line 7, characters 0-0
  (not
  (= (length1
     (mk___rep target__split_discrs
     (us_split_fields__content target__split_fields7))) (+ (length1
                                                           (mk___rep
                                                           target__split_discrs
                                                           (mk___split_fields
                                                           (mk___t
