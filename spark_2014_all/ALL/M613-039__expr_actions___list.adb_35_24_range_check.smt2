...
;; H
  (assert
  (and (= o3 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1
  o3 true false true)))
...
;; H
  (assert (and (= temp___470 (- last3 i9)) (in_range1 (- last3 i9))))

;; H
  (assert (<= first2 temp___470))

(assert
;; WP_parameter_def
 ;; File "list.ads", line 10, characters 0-0
  (not (<= (to_rep (first (rt list__reverse_list__L_2__R20b))) first2)))
(check-sat)
(exit)
