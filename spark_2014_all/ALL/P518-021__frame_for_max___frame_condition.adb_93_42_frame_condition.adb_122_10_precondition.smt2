...
;; get_max_left__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant (get_max_left index frame_condition__update_max_2__a)
     true false true)) :pattern ((get_max_left index
...
;; H
  (assert
  (= (rec__frame_condition__cell__value (us_split_fields1 (select a c238b1)))
  o19))
...
;; H
  (assert
  (= (rec__frame_condition__cell__max_right
     (us_split_fields1 (select a c238b1))) o21))
...
;; H
  ...
  (and
  (= (rec__frame_condition__cell__value
     (us_split_fields1 (select a2 temp___277))) (rec__frame_condition__cell__value
                                                (us_split_fields1
                                                (select a temp___277))))
  (= (rec__frame_condition__cell__max_right
     (us_split_fields1 (select a2 temp___277))) (rec__frame_condition__cell__max_right
                                                (us_split_fields1
                                                (select a temp___277)))))))
  (=> (<= 1 2147483647) (in_range3 k2)))
  (=> (<= 1 2147483647) (in_range3 c238b2)))
  (=> (<= 0 2147483647) (in_range2 max3)))
  (=> (<= 0 2147483647) (in_range2 c239b2))))
