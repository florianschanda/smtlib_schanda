...
(declare-const use_ordered_maps__my_contains__result Bool)

(declare-const o count_type)

(declare-const o1 count_type)

(declare-const temp___633 count_type)

(declare-const o2 Bool)

(declare-const result Bool)

(declare-const use_ordered_maps__my_contains__result1 Bool)

(declare-const use_ordered_maps__my_contains__result2 Bool)

(declare-const use_ordered_maps__my_contains__result3 Bool)

(declare-const use_ordered_maps__my_contains__result4 Bool)

(declare-const use_ordered_maps__my_contains__result5 Bool)
