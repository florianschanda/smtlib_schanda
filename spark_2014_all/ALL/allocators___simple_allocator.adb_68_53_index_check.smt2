...
;; H
  (assert
  (and (= (bool_eq data3 1 10000 data 1 10000) true)
  (forall ((rr1 Int))
  (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (select data3 rr1)) 1)))))
...
;; H
  ...
  (=> (< r2 temp___246)
  (= (select data3 temp___246) (select data temp___246))))))
  (and (<= 1 r2) (<= r2 10000))))

;; H
  (assert (= (bool_eq data3 1 10000 data 1 10000) true))
