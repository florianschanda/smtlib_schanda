...
(declare-datatypes ()
((tS18bP1__ref (mk_tS18bP1__ref (tS18bP1__content tdigit_index_typeB)))))
(define-fun tS18bP1__ref___projection ((a tS18bP1__ref)) tdigit_index_typeB
  (tS18bP1__content a))
...
(declare-datatypes ()
((t20b__ref (mk_t20b__ref (t20b__content tdigit_index_typeB)))))
(define-fun t20b__ref___projection ((a t20b__ref)) tdigit_index_typeB
  (t20b__content a))
...
;; def_axiom
  ...
  (forall ((temp___1409 Int) (temp___1410 Int))
  (let ((temp___1407 (temp___1406 temp___1408 temp___1409 temp___1410)))
  (and
  (=> (dynamic_property6 1 2147483647 temp___1409 temp___1410)
  (and (= (first5 temp___1407) temp___1409)
  (= (last5 temp___1407) temp___1410)))
  (forall ((temp___1411 Int))
  (= (select (to_array2 temp___1407) temp___1411) (of_rep temp___1408))))))))

(define-fun dynamic_invariant4 ((temp___expr_498 us_t1)
  (temp___is_init_495 Bool) (temp___skip_constant_496 Bool)
  (temp___do_toplevel_497 Bool)) Bool (=>
                                      (not (= temp___skip_constant_496 true))
                                      (and (dynamic_property3 1 r19b
                                      (first3 temp___expr_498)
                                      (last3 temp___expr_498))
                                      (and (= (first3 temp___expr_498) 1)
                                      (= (last3 temp___expr_498) r19b)))))
...
(declare-fun temp___1413 () (Array Int octet))

(declare-fun temp___14131 () t2)

(declare-fun temp___1414 () (Array Int octet))

(declare-fun temp___14141 () t1)

(declare-fun temp___1416 () (Array Int octet))

(declare-fun temp___14161 () t1)
...
(declare-fun temp___1418 () digit_index_type)

(declare-fun temp___14181 () (Array Int octet))

(declare-fun temp___14182 () t)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___1406 ((_ int2bv 8) 0) 1 r19b)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___1406 ((_ int2bv 8) 0) 1 r19b)))) r19b))

;; H
  (assert
  (= (mk___t2 temp___1413 temp___14131) (temp___1406 ((_ int2bv 8) 0) 1 r19b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___14131)) (to_rep2 (last4 temp___14131)))
     (+ (- (to_rep2 (last4 temp___14131)) (to_rep2 (first4 temp___14131))) 1)
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___14131)) (to_rep2 (last4 temp___14131)))
  temp___14141))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___14141)) (to_rep2 (last2 temp___14141)))
     (+ (- (to_rep2 (last2 temp___14141)) (to_rep2 (first2 temp___14141))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1416 temp___14161) (mk___t1 temp___1414 temp___14141)))
...
;; H
  (assert
  (= (mk (to_rep2 (first2 temp___14161)) (to_rep2 (last2 temp___14161)))
  o1))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___14181 temp___14182))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      result____split_fields3)))) temp___1429)
  (<= temp___1429 (to_rep2
                  (last
                  (rt
                  (rec__aco__math__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             result____split_fields3)) temp___1429) (select (elts
                                                            (rec__aco__math__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1429))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
