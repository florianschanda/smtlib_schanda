...
;; H
  ...
  (and
  (and
  (= (length3 (mk___rep l__split_discrs l__split_fields6)) (- (length3
                                                              (mk___rep
                                                              l__split_discrs
                                                              (mk___split_fields
                                                              l__split_fields))) 1))
  ...
  (= (range_shifted (keys (mk___rep l__split_discrs l__split_fields6))
     ...
     (find
     (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 
     k) (length3 (mk___rep l__split_discrs l__split_fields6)) 1) true))
  (= (p_positions_shifted
...
;; H
  ...
  (and
  (and
  (= (length3 (mk___rep l__split_discrs l__split_fields5)) (+ (length3
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields6)) 1))
  ...
  (= (range_shifted (keys (mk___rep l__split_discrs l__split_fields6))
     ...
     (length3 (mk___rep l__split_discrs l__split_fields6)) 1) true))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields6))
