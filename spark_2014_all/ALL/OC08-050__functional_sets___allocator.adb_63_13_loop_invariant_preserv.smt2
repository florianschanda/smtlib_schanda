...
;; H
  (assert
  (and (= (bool_eq data3 1 3 data 1 3) true)
  (forall ((rr Int))
...
;; H
  ...
  (=> (< r2 temp___376)
  (= (select data3 temp___376) (select data temp___376)))))
...
;; H
  (assert (not (= (to_rep (select data3 r3)) 0)))
...
;; WP_parameter_def
 ;; File "allocator.ads", line 47, characters 0-0
  (not (= (bool_eq data4 1 3 data 1 3) true)))
(check-sat)
(exit)
