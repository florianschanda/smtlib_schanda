...
(define-fun bool_eq ((a (Array Int natural)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (to_rep (select a temp___idx_137)) (to_rep
...
(declare-fun dummy2 () tmax_lsid_typeB)
...
(declare-fun dummy5 () max_lsid_type)
...
(declare-fun to_rep2 (max_lsid_type) Int)
...
;; range_axiom
  (assert
  (forall ((x max_lsid_type)) (! (in_range3
...
(declare-fun dummy6 () tmax_lsid_typeB)
...
(declare-datatypes ()
((us_split_fields
 (mk___split_fields (rec__foo__subject_state__states us_t1)))))
(define-fun us_split_fields_States__projection ((a us_split_fields)) us_t1
...
(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1 (rec__foo__subject_state__states1 us_t)))))
(define-fun us_split_fields_States2__projection ((a us_split_fields2)) us_t
...
(define-fun in_range4 ((rec__foo__subject_state__max_id1 Int)
  (a us_rep)) Bool (= rec__foo__subject_state__max_id1 (to_rep2
                                                       (rec__foo__subject_state__max_id
                                                       (us_split_discrs1 a)))))
...
(declare-datatypes ()
((map__ref1 (mk_map__ref1 (map__content1 (Array Int max_lsid_type))))))
(declare-fun slide1 ((Array Int max_lsid_type) Int
...
(declare-fun concat2 ((Array Int max_lsid_type) Int Int
...
(declare-fun singleton2 (max_lsid_type Int) (Array Int max_lsid_type))
...
(define-fun bool_eq5 ((a (Array Int max_lsid_type)) (a__first Int)
...
(declare-fun compare1 ((Array Int max_lsid_type) Int Int
...
(define-fun dynamic_invariant1 ((temp___expr_184 us_rep1)
  ...
  (temp___do_toplevel_183 Bool)) Bool (and
                                      ...
                                      (in_range4
                                      (to_rep2 (select cpu_lsid_last cpu_id))
                                      ...
                                      (= (last1
                                         (rec__foo__subject_state__states1
                                         (us_split_fields3 temp___expr_184)))
                                      (to_rep2 (select cpu_lsid_last
                                      cpu_id)))))))

(define-fun default_initial_assumption ((temp___expr_187 us_rep1)
  (temp___skip_top_level_188 Bool)) Bool (= (to_rep2
                                            (rec__foo__subject_state__max_id
                                            (us_split_discrs2
                                            temp___expr_187))) (to_rep2
                                                               (select
                                                               cpu_lsid_last
                                                               cpu_id))))
...
;; def_axiom
  ...
  (and (= (select temp___133 0) (of_rep2 temp___134))
  (= (select temp___133 1) (of_rep2 temp___135))))))
...
(declare-fun states__split_fields1 () t)
...
;; H
  ...
  (mk___split_fields1 (mk___t states__split_fields states__split_fields1)))
  true false true))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep1 (first states__split_fields1)) 5)))
(check-sat)
(exit)
