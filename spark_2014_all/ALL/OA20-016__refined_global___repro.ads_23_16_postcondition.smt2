...
(define-fun bool_eq1 ((a (Array Int (Array Int cell))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq (select a temp___idx_134) 1 10
...
;; bool_eq_rev
  ...
  (= (bool_eq (select a temp___idx_134) 1 10
     (select b (+ (- b__first a__first) temp___idx_134)) 1 10) true))))))))
...
;; is_empty__def_axiom
  ...
  (! (= (= (is_empty b) true)
     ...
     (forall ((x Int))
     (=> (and (<= 1 x) (<= x 10))
     (= (to_rep (let ((temp___309 (select b y))) (select temp___309 x))) 0)))))) :pattern (
  (is_empty b)) )))
...
;; def_axiom
  (assert
  (forall ((temp___335 (Array Int cell)))
  (forall ((temp___336 Int))
  (= (select (temp___333 temp___335) temp___336) temp___335))))
...
;; def_axiom
  ...
  (= (select (temp___337 temp___339) temp___340) (of_rep temp___339)))))
...
;; WP_parameter_def
 ;; File "repro.ads", line 11, characters 0-0
  (not (= (is_empty (get_board cur_board2)) true)))
(check-sat)
(exit)
