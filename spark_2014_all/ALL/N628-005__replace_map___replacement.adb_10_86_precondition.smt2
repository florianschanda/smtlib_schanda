...
(declare-fun replacement__inverse_sets__cursor__node__first__bit () Int)

(declare-fun replacement__inverse_sets__cursor__node__last__bit () Int)

(declare-fun replacement__inverse_sets__cursor__node__position () Int)
...
(define-fun map__ref_3__projection ((a map__ref2)) us_rep2 (map__content2 a))
...
(define-fun map__ref_2__projection ((a map__ref3)) us_rep4 (map__content3 a))
...
(declare-fun replacement__inverse_sets__map__capacity__first__bit1 () Int)

(declare-fun replacement__inverse_sets__map__capacity__last__bit1 () Int)

(declare-fun replacement__inverse_sets__map__capacity__position1 () Int)
...
(declare-fun replacement__inverse_sets__replace_element__container__fields () us_main_type)
...
(define-fun d__split_fields2 () us_split_fields (mk___split_fields
                                                d__split_fields1))

(define-fun replacement__inverse_sets__replace_element__container__fields1 () us_split_fields
  (mk___split_fields
  replacement__inverse_sets__replace_element__container__fields))

(define-fun c1 () us_rep1 (mk___rep1 (mk___split_fields1 c)))

(define-fun o5 () us_rep1 (mk___rep1 (mk___split_fields1 o)))
...
;; H
  ...
  (= (has_key
     (positions
     (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c2) true)
  (= (to_rep
     (select (elts a) (element
                      (mk___rep d__split_discrs
                      (mk___split_fields d__split_fields)) c2))) (key
                                                                 (mk___rep
                                                                 d__split_discrs
                                                                 (mk___split_fields
                                                                 d__split_fields))
...
;; H
  (assert
  (= (mk___rep d__split_discrs (mk___split_fields d__split_fields)) d_old))
...
;; H
  ...
  (=>
  (not
  (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c2)
  k))
  (= (to_rep
     (select (elts a) (element
                      (mk___rep d__split_discrs
...
;; H
  (assert
  (and
  (= o5 (find1 (mk___rep d__split_discrs (mk___split_fields d__split_fields))
        k))
  (ite (ite (= (has_key1
               (model__
  ...
  (= (get1
     ...
     o5) (find
         ...
         k)))
  (= (equivalent_keys
     (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) o5)
     k) true)))))
...
;; H
  ...
  (= (oeq2
     (keys
     (mk___rep d__split_discrs
     replacement__inverse_sets__replace_element__container__fields1))
     (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true)
  (= (oeq3
     (positions
     (mk___rep d__split_discrs
     replacement__inverse_sets__replace_element__container__fields1))
...
;; H
  (assert
  (= d__split_fields2 replacement__inverse_sets__replace_element__container__fields1))

;; H
  (assert
  (and
  (= o1 (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c1))
  (= (= o1 true)
...
;; H
  (assert (= result1 (ite (= o2 true) o1 false)))
...
;; H
  (assert
  (and (= o3 (key (mk___rep d__split_discrs d__split_fields2) c1))
  (and (in_range3 o3)
  (= o3 (get (keys (mk___rep d__split_discrs d__split_fields2))
        (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c1))))))

;; H
  (assert (= o4 (ite (= o3 k) true false)))

;; H
  (assert (= result2 (ite (not (= o4 true)) true false)))
