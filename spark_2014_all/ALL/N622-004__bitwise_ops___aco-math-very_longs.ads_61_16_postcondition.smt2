...
(declare-fun aco__math__very_longs__modsubtract__result () digit_index_type)

(declare-fun aco__math__very_longs__modsubtract__result1 () (Array Int octet))

(declare-fun aco__math__very_longs__modsubtract__result2 () t)
...
(declare-fun temp___1164 () us_rep1)
...
(declare-fun temp___1163 () us_rep1)
...
(declare-fun aco__math__very_longs__modsubtract__result3 () us_rep)

(declare-fun aco__math__very_longs__modsubtract__result4 () very_long__ref)

(declare-fun aco__math__very_longs__modsubtract__result5 () us_rep)
...
(declare-fun aco__math__very_longs__modsubtract__result6 () very_long__ref)
...
(declare-fun aco__math__very_longs__modsubtract__result7 () us_rep)
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1164 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1163 (mk___rep1 result____split_discrs o17))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_fields4 (us_split_fields3 temp___1163))))
...
;; H
  ...
  (<= i1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= result____split_discrs (us_split_discrs2 temp___1163))))
...
;; H
  (assert
  (= aco__math__very_longs__modsubtract__result4 (mk_very_long__ref
                                                 aco__math__very_longs__modsubtract__result3)))

;; H
  (assert
  (= aco__math__very_longs__modsubtract__result5 aco__math__very_longs__modsubtract__result3))

;; H
  (assert
  (= result9 (mk_very_long__ref
             (mk___rep
             (mk___split_discrs aco__math__very_longs__modsubtract__result)
             (mk___split_fields
             (mk___t aco__math__very_longs__modsubtract__result1
             aco__math__very_longs__modsubtract__result2))))))

;; H
  (assert
  (= aco__math__very_longs__modsubtract__result3 (to_base
                                                 (mk___rep1
...
;; H
  (assert
  (= aco__math__very_longs__modsubtract__result6 aco__math__very_longs__modsubtract__result4))
...
;; H
  (assert
  (= aco__math__very_longs__modsubtract__result7 aco__math__very_longs__modsubtract__result5))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs result10)
     (mk___split_fields (mk___t result11 result12))) (very_long__content
                                                     aco__math__very_longs__modsubtract__result6)))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  ...
  (= (to_rep1
     (rec__aco__math__very_longs__very_long__octet_length
     (us_split_discrs1
     (very_long__content aco__math__very_longs__modsubtract__result6))))
  (to_rep1
  (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(check-sat)
(exit)
