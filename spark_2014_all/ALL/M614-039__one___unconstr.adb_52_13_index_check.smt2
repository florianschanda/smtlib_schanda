...
(declare-datatypes ((tsP1__ref 0)) (((mk_tsP1__ref (tsP1__content tsP1)))))
...
;; def_axiom
  ...
  (= (select (unconstr__constr_return_call__s__aggregate_def temp___211) temp___212)
  (of_rep temp___211)))))
...
;; H
  ...
  (=>
  (and (<= (to_rep1 s__first) temp___216) (<= temp___216 (to_rep1 s__last)))
  (=> (<= i2 temp___216) (= (select s2 temp___216) (select s1 temp___216)))))
...
(assert
;; WP_parameter_def
 ;; File "unconstr.adb", line 32, characters 0-0
