...
(define-fun tint_arrayD1__ref___6__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___6__projection ((a tint_arrayT__ref)) us_t1
...
(define-fun tnumber_array_typeD1__ref___6__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___6__projection ((a number_array_type__ref)) us_t3
...
(define-fun tint_arrayB__ref___6__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___6__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; H
  (assert
  (= (mk___t2 temp___1382 temp___13821) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def
                                        2 1 4 7 3 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___13821)) (to_rep1 (last4 temp___13821)))
     (+ (- (to_rep1 (last4 temp___13821)) (to_rep1 (first4 temp___13821))) 1)
...
;; H
  (assert
  (= (slide1 temp___1382 (to_rep1 (first4 temp___13821))
...
;; H
  (assert
  (= (mk___t4 temp___1390 temp___13901) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___13901)) (to_rep1 (last8 temp___13901)))
     (+ (- (to_rep1 (last8 temp___13901)) (to_rep1 (first8 temp___13901))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1390 (to_rep1 (first8 temp___13901))
...
;; H
  (assert
  (and (= temp___1397 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1397))
  (= temp___1395 index1)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1394 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1394)
  (<= temp___1394 (to_rep1 n__last)))
  (=> (< index2 temp___1394)
  (= (select n3 temp___1394) (select temp___1393 temp___1394)))))
...
;; H
  (assert
  (and (= temp___1398 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1398)
  (<= temp___1398 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1399 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1399)
  (<= temp___1399 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1400 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1400)
  (<= temp___1400 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1401 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1401)
  (<= temp___1401 (to_rep1 n__last))))

;; H
  (assert (= o26 temp___1401))
...
;; H
  (assert
  (and (= temp___1402 (+ (to_rep1 (first (rt source))) 5)) (in_range1
  (+ (to_rep1 (first (rt source))) 5))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1402)
  (<= temp___1402 (to_rep1 n__last))))

;; H
  (assert (= o33 temp___1402))
