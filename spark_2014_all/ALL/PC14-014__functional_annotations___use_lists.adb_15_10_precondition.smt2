...
(declare-const use_lists__my_find__result us_rep1)

(declare-const result2 Bool)

(declare-const use_lists__my_find__result1 us_rep1)
...
;; H
  (assert
  (and (= result1 (has_key (positions l) (mk___rep1 cu__split_fields3)))
  (= (= result1 true)
...
;; H
  (assert (= use_lists__my_find__result1 use_lists__my_find__result))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not
  (or (= (has_key (positions l) (mk___rep1 cu__split_fields2)) true)
  (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) true))))
(check-sat)
(exit)
