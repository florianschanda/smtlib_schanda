...
(declare-fun o15 () py_coord)

(declare-fun o16 () px_coord)
...
;; H
  (assert (not (= cur_state 0)))

;; H
  (assert (= cur_state 3))

;; H
  (assert (= result3 (mk_bool__ref speed_up)))

;; H
  (assert (= speed_up1 (of_int 0)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep3 o5) 1)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep2 o6) 5)))
...
;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= o4 (mod2 o3 4))))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep4 o7) o4)))
...
;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= o1 (mod2 o 7))))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= o2 (+ 1 o1))))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= (to_rep o8) o2)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= o8 o9)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= o7 o10)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= o6 o11)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= o5 o12)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___2220 o9)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___22201 o10)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___22202 o11)))

;; H
  (assert (=> (= (to_rep next_piece__split_fields) 0) (= temp___22203 o12)))
...
;; H
  (assert (= result5 (ite (not (= o13 true)) true false)))
...
;; H
  (assert (= cur_piece__split_fields4 next_piece__split_fields5))

;; H
  (assert (= (to_rep3 o15) 1))

;; H
  (assert (= (to_rep2 o16) 5))

;; H
  (assert (and (= o14 (rand Tuple0)) (in_range2 o14)))
