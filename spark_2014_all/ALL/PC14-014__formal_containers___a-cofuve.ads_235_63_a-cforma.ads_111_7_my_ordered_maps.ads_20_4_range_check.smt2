...
(define-fun dynamic_invariant ((temp___expr_553 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_567 Int)
...
(define-fun default_initial_assumption ((temp___expr_574 us_rep)
  (temp___skip_top_level_575 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_575 true))
                                         (= (length temp___expr_574) 0)))
