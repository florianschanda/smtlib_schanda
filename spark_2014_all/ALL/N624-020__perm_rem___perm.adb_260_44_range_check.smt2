...
;; H
  (assert
  (and
  (= o17 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))

;; H
  (assert
  (and (= o16 (remove b ib1))
  (and (dynamic_invariant2 o16 true false true)
  (and (= (invariant__ o16) true)
  (and (= (to_rep2 (last (rt o16))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o16) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o16) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o16) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o18))) (- (to_rep2 (last (rt o16))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o17 1)))
  ...
  (and
  (forall ((k Int))
  (=> (and (<= (+ o17 1) k) (<= k (to_rep2 (last (rt o16)))))
  (= (to_rep (select (elts o16) k)) (to_rep (select (elts o18) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o17 k) (<= k (- (to_rep2 (last (rt o16))) 1)))
  (= (to_rep (select (elts o16) (+ k 1))) (to_rep (select (elts o18) k))))))))))))

;; H
  (assert
  (and (= o15 (remove bb ib1))
  (and (dynamic_invariant2 o15 true false true)
  (and (= (invariant__ o15) true)
  (and (= (to_rep2 (last (rt o15))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o15) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o15) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o15) k))))))))))))
