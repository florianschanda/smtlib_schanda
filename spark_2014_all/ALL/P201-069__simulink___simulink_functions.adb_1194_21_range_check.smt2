...
(declare-fun atan2__2 (t1 t1) t1)

(declare-fun atan2__2__function_guard (t1 t1 t1) Bool)

;; atan2__2__post_axiom
  (assert
  (forall ((left1 t1) (right1 t1))
  (! (=>
...
;; H
  (assert
  (and (= o (atan2__2 (to_float64 RNE1 left) (to_float64 RNE1 right)))
  (tqtisFinite1 o)))

;; H
  (assert (= o1 (to_float32 RNE1 o)))
