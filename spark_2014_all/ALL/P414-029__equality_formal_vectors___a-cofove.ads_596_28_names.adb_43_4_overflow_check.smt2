...
(define-fun dynamic_invariant1 ((temp___expr_437 Int)
...
(define-fun dynamic_invariant2 ((temp___expr_443 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_422 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_256 Int)
...
(define-fun element_type__ref___4__projection ((a element_type__ref)) us_rep2
...
(define-fun default_initial_assumption ((temp___expr_480 us_rep1)
  (temp___skip_top_level_481 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_481 true))
                                         (= (length1 temp___expr_480) 0)))
...
(define-fun dynamic_invariant7 ((temp___expr_473 Int)
