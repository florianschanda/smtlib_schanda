...
(declare-fun this__split_fields5 () us_split_fields__ref10)
...
(declare-fun rho2 () us_split_fields8)
...
;; H
  ...
  (= result4 (ite (fp.leq (to_rep4
                          ...
                          (select (rec__algorithm__controller__laserscan
                                  (us_split_fields__content10
                                  this__split_fields3)) (let ((subject
                                                        i)) i2))))) o3)
             true false)))
...
;; H
  ...
  disttoclosestobstacle2 (to_rep4
                         ...
                         (select (rec__algorithm__controller__laserscan
                                 (us_split_fields__content10
                                 this__split_fields3)) (let ((subject i)) i2))))))))))))
...
;; H
  (assert (=> (= result4 true) (= disttoclosestobstacle3 o4)))
...
;; H
  (assert (not (= (let ((subject i)) i2) 1000)))

;; H
  (assert (= result6 (let ((subject i)) (mk_int__ref i2))))

;; H
  (assert (= (let ((subject i)) i3) (+ (let ((subject i)) i2) 1)))

;; H
  (assert (= i4 (let ((subject i)) (mk_int__ref i3))))

;; H
  (assert (= disttoclosestobstacle6 disttoclosestobstacle4))

;; H
  (assert (= this__split_fields5 this__split_fields3))
...
;; H
  (assert (= disttoclosestobstacle7 disttoclosestobstacle5))

;; H
  (assert (= this__split_fields6 this__split_fields4))
