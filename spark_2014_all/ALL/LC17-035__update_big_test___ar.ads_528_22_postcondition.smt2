...
(declare-fun temp___2059 ((Array Int (Array Int (Array Int et1))) Int
  (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))

;; def_axiom
  (assert
  (forall ((temp___2061 (Array Int (Array Int (Array Int et1)))))
  (forall ((temp___2062 Int))
  (forall ((temp___2063 (Array Int (Array Int et1))))
  (let ((temp___2060 (temp___2059 temp___2061 temp___2062 temp___2063)))
  (forall ((temp___2064 Int))
  (ite (= temp___2064 temp___2062)
  (= (select temp___2060 temp___2064) temp___2063)
  (= (select temp___2060 temp___2064) (select temp___2061 temp___2064)))))))))

(declare-fun temp___2065 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___2067 (Array Int (Array Int et1))))
  (forall ((temp___2068 Int))
  (forall ((temp___2069 (Array Int et1)))
  (let ((temp___2066 (temp___2065 temp___2067 temp___2068 temp___2069)))
  (forall ((temp___2070 Int))
  (ite (= temp___2070 temp___2068)
  (= (select temp___2066 temp___2070) temp___2069)
  (= (select temp___2066 temp___2070) (select temp___2067 temp___2070)))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 521, characters 0-0
  (not
  (= (bool_eq2 a3 1 16 (temp___2059 a i (temp___2065 b j c)) 1 16) true)))
(check-sat)
(exit)
