...
;; H
  (assert (= temp___273 a__split_fields3))

;; H
  (assert (= temp___2731 a__split_fields4))

;; H
  (assert (= temp___2732 a__split_fields5))
...
;; H
  (assert (= temp___276 o7))

;; H
  (assert (= temp___2761 o8))

;; H
  (assert (= temp___2762 o9))
...
;; H
  (assert (= temp___276 a__split_fields6))

;; H
  (assert (= temp___2761 a__split_fields7))

;; H
  (assert (= temp___2762 a__split_fields8))
...
(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 117, characters 0-0
  (not (not (= (to_rep (select a__split_fields10 17)) 23))))
(check-sat)
(exit)
