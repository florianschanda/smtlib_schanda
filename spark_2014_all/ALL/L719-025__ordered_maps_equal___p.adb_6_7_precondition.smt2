...
;; H
  ...
  (= (get1 (keys (mk___rep l__split_discrs l__split_fields2))
     (find (keys (mk___rep l__split_discrs l__split_fields2)) k)) k))
  ...
  (= (range_equal
     ...
     (- (find (keys (mk___rep l__split_discrs l__split_fields2)) k) 1)) true))
  (= (range_shifted
     (keys (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (keys (mk___rep l__split_discrs l__split_fields2))
     (find (keys (mk___rep l__split_discrs l__split_fields2)) k)
     (length (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     1) true))
  (= (p_positions_shifted
     (positions
