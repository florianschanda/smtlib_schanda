...
;; def_axiom
  ...
  (and
  (=> (dynamic_property4 1 2147483647 temp___175 temp___176)
  (and (= (first3 temp___173) temp___175) (= (last3 temp___173) temp___176)))
  (forall ((temp___177 Int))
  (= (select (to_array1 temp___173) temp___177) (of_rep2 temp___174)))))))
...
(declare-fun temp___170 () index_type)

(declare-fun temp___180 () index_type)

(declare-fun temp___1801 () (Array Int character))

(declare-fun temp___1802 () t)

(declare-fun temp___1803 () length_type)

(define-fun temp___1804 () us_rep (mk___rep (mk___split_discrs temp___180)
                                  (mk___split_fields
                                  (mk___t temp___1801 temp___1802)
                                  temp___1803)))
...
;; H
  (assert
  (and (dynamic_invariant1 temp___1804 true false true)
  (and
  (let ((temp___182 (temp___172 32 1 (to_rep temp___180))))
  (and (= temp___1801 (elts1 temp___182))
  (= temp___1802 (mk (to_rep3 (first2 (rt1 temp___182)))
                 (to_rep3 (last2 (rt1 temp___182)))))))
  (= (to_rep1 temp___1803) 0))))

(assert
;; WP_parameter_def
 ;; File "bounded_strings.ads", line 38, characters 0-0
  (not (= (length2 temp___1804) 0)))
(check-sat)
(exit)
