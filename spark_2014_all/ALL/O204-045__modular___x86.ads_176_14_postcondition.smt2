...
;; H
  (assert
  (= rbx1 (bvor (bvand rbx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8)
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= rbx2 (bvor (bvand rbx ((_ int2bv 64) 65280)) ((_ zero_extend 48) (bvmul ((_ zero_extend 8)
  val__) ((_ int2bv 16) 256)))))))
(check-sat)
(exit)
