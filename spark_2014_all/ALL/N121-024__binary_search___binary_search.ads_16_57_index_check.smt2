...
;; H
  ...
  (and
  (and
  (and (=> (<= 1 2147483647) (in_range3 left3))
  (=> (<= 1 2147483647) (in_range3 right3)))
  (=> (<= 1 2147483647) (in_range3 med2))) (< left3 right3))
  ...
  (and
  (and (<= (to_rep1 (first (rt a))) med3) (<= med3 (to_rep1 (last (rt a)))))
  (= o20 med3)) (= o21 (select (elts a) o20))) (= o22 (to_rep o21)))
  (= result12 (ite (< i o22) true false)))
  ...
  (and (= result12 true)
  (and
  (and (and (= o23 (- med3 1)) (in_range3 (- med3 1)))
  (and (= right3 result13) (= right4 o23)))
