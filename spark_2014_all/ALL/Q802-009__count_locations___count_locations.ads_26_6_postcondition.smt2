...
;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100))
  (= lowest_max10 (mk_int__ref lowest_max4))))

;; H
  (assert
  (=> (and (<= 1 st1) (<= st1 100)) (= st_count10 (mk_int__ref st_count4))))
...
;; H
  ...
  (forall ((s Int))
  (=> (and (<= 1 s) (<= s 100))
  (=> (= (select sel s) true) (<= lowest_max6 (to_rep (select max s)))))))

;; H
  (assert
  (= count_locations__check_selected_locations__result1 count_locations__check_selected_locations__result2))

;; H
  (assert
  (= count_locations__check_selected_locations__result3 count_locations__check_selected_locations__result1))
...
;; H
  (assert
  (= count_locations__check_selected_locations__result1 (ite (<= st_count6
                                                        lowest_max6) true
                                                        false)))

;; H
  (assert
  (= count_locations__check_selected_locations__result4 (mk_bool__ref
                                                        count_locations__check_selected_locations__result2)))
...
;; H
  (assert
  (= count_locations__check_selected_locations__result5 count_locations__check_selected_locations__result3))
...
;; H
  (assert
  (= result6 (bool__content
             count_locations__check_selected_locations__result4)))

;; H
  (assert
  (= (bool__content count_locations__check_selected_locations__result4) true))
