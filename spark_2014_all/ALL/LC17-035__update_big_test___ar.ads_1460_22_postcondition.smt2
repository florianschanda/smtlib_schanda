...
(declare-const temp___7965 (Array Int et1))

(declare-const temp___79651 enum2t)
...
(declare-const temp___7968 (Array Int et1))

(declare-const temp___79681 enum2t)
...
;; H
  (assert (= temp___7965 o1))

;; H
  (assert (= temp___79651 o2))
...
;; H
  (assert (= temp___7965 r__split_fields2))

;; H
  (assert (= temp___79651 r__split_fields3))
...
;; H
  (assert (= temp___7968 o5))

;; H
  (assert (= temp___79681 o6))
...
;; H
  (assert (= temp___7968 r__split_fields4))

;; H
  (assert (= temp___79681 r__split_fields5))
