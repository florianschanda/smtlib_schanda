...
(define-fun to_int5 ((x (_ BitVec 32))) Int (ite (bvsge x (_ bv0 32))
                                            (bv2nat x)
                                            (- (- 4294967296 (bv2nat x)))))
...
;; H
  ...
  (= o (ite (and (<= 1 64) (<= 64 8))
       ((_ zero_extend 56) (ite (< n 8)
                           (bvlshr ((_ extract 7 0) val__) ((_ int2bv 8)
                           n)) ((_ int2bv 8) 0)))
       (ite (and (<= 9 64) (<= 64 16))
       ((_ zero_extend 48) (ite (< n 16)
                           (bvlshr ((_ extract 15 0) val__) ((_ int2bv 16)
                           n)) ((_ int2bv 16) 0)))
       (ite (and (<= 17 64) (<= 64 32))
       ((_ zero_extend 32) (bvlshr ((_ extract 31 0) val__) ((_ int2bv 32)
       n))) (bvlshr val__ ((_ int2bv 64) n))))))))

;; H
  (assert (= result1 (ite (= o ((_ int2bv 64) 1)) true false)))
...
;; H
  ...
  (forall ((j1 Int))
  (=> (and (<= 0 j1) (<= j1 n))
  (bvuge (shift_right val__ j1) ((_ int2bv 64) 1)))))))
