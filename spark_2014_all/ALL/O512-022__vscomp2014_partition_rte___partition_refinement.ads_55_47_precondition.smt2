...
;; H
  (assert (and (= o10 o8) (in_range2 o8)))

;; H
  (assert (= result (ite (<= o10 o9) true false)))
...
;; H
  (assert (= result1 (ite (<= o6 5000) true false)))
...
;; H
  (assert
  (and (= o2 (has_key (positions x) c3))
  (= (= o2 true) (= (has_key (positions x) c3) true))))

;; H
  (assert (= o3 true))

;; H
  (assert (= result5 (ite (= o3 true) o2 false)))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 807, characters 0-0
  (not (= (has_key (positions x) c3) true)))
(check-sat)
(exit)
