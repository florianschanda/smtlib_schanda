...
;; H
  ...
  (and
  (and
  (= (length2 temp___724) (length
                          (mk___rep s1__split_discrs
                          (mk___split_fields s1__split_fields2))))
  (forall ((temp___390 Int))
  (=>
  (and (in_range3 temp___390)
  (= (iter_has_element temp___724 temp___390) true))
  (= (contains
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))
     (get temp___724 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range5 item)
  (= (contains
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2))) item) true))
  (and (< 0 (find temp___724 item))
  (= (equivalent_elements (get temp___724 (find temp___724 item)) item) true)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep s1__split_discrs (mk___split_fields s1__split_fields2)))))
  (and (= (find temp___724 (get temp___724 i)) i)
  (= (e_is_find temp___724 (get temp___724 i) i) true)))))))

;; H
  (assert
  (and (= o (iter_has_element temp___724 temp___723))
  (= (= o true) (and (<= 1 temp___723) (<= temp___723 (last temp___724))))))

;; H
  (assert (= (= o1 true) (in_range3 temp___723)))
