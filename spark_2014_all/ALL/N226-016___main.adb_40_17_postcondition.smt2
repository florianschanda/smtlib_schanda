...
(declare-fun main__with_spoon_feeding__result () Int)

(declare-fun result () Int)

(declare-fun main__with_spoon_feeding__result1 () Int)

(declare-fun main__with_spoon_feeding__result2 () Int)

(declare-fun main__with_spoon_feeding__result3 () Int)

(declare-fun main__with_spoon_feeding__result4 () Int)

(declare-fun main__with_spoon_feeding__result5 () Int)
...
;; H
  (assert
  (= main__with_spoon_feeding__result1 main__with_spoon_feeding__result2))

;; H
  (assert
  (= main__with_spoon_feeding__result3 main__with_spoon_feeding__result1))
...
;; H
  (assert
  (= (mk_int__ref main__with_spoon_feeding__result4) (mk_int__ref
                                                     main__with_spoon_feeding__result2)))

;; H
  (assert
  (= main__with_spoon_feeding__result5 main__with_spoon_feeding__result3))
...
;; WP_parameter_def
 ;; File "main.adb", line 8, characters 0-0
  (not (not (= id main__with_spoon_feeding__result4))))
(check-sat)
(exit)
