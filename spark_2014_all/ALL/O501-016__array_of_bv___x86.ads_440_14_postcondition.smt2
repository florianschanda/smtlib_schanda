...
(define-fun dynamic_invariant2 ((temp___expr_214 (_ BitVec 16))
...
;; readmem16__post_axiom
  ...
  (! (=> (dynamic_invariant addr true true true)
     ...
     ((_ int2bv 16) 0)))) (dynamic_invariant2 result true false true)))) :pattern (
...
(declare-fun x86__readmem32__result () (_ BitVec 32))
...
(declare-fun x86__readmem32__result1 () (_ BitVec 32))

(declare-fun x86__readmem32__result2 () (_ BitVec 32))

(declare-fun x86__readmem32__result3 () (_ BitVec 32))

(declare-fun x86__readmem32__result4 () (_ BitVec 32))

(declare-fun x86__readmem32__result5 () (_ BitVec 32))
...
;; H
  ...
  (= (bvor ((_ zero_extend 8) (readmem8 addr memory)) (ite (< 8 16)
                                                      ...
                                                      (readmem8
                                                      (bvadd addr ((_ int2bv 64) 1))
                                                      memory)) ((_ int2bv 16) 8))
                                                      ((_ int2bv 16) 0)))
  (readmem16 addr memory)))

;; H
  (assert
  (= (bvor (bvshl ((_ zero_extend 24) (readmem8
                                      (bvadd addr ((_ int2bv 64) 2))
                                      memory)) ((_ int2bv 32) 16)) (bvshl ((_ zero_extend 24)
  (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory)) ((_ int2bv 32) 24))) (bvshl ((_ zero_extend 16)
  (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 16))))
...
;; H
  (assert (= o10 ((_ zero_extend 24) o9)))

;; H
  (assert (= o11 (bvshl o10 ((_ int2bv 32) 24))))
...
;; H
  (assert (= o6 ((_ zero_extend 24) o5)))

;; H
  (assert (= o7 (bvshl o6 ((_ int2bv 32) 16))))
...
;; H
  (assert (= o2 ((_ zero_extend 24) o1)))

;; H
  (assert (= o3 (bvshl o2 ((_ int2bv 32) 8))))
...
;; H
  (assert (= o13 (bvor o12 o11)))

;; H
  (assert (= result x86__readmem32__result))

;; H
  (assert (= x86__readmem32__result1 o13))

;; H
  (assert
  (= (mk_t__ref2 x86__readmem32__result4) (mk_t__ref2
                                          x86__readmem32__result2)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not
  (= x86__readmem32__result4 (bvor ((_ zero_extend 16) (readmem16 addr
