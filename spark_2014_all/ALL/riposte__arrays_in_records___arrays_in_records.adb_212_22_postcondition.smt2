...
(declare-fun temp___337 () index)

(declare-fun temp___3371 () (Array Int value))

(declare-fun temp___3372 () (Array Int value))
...
(declare-fun temp___341 () index)

(declare-fun temp___3411 () (Array Int value))

(declare-fun temp___3412 () (Array Int value))
...
(declare-fun temp___344 () index)

(declare-fun temp___3441 () (Array Int value))

(declare-fun temp___3442 () (Array Int value))
...
(declare-fun temp___347 () index)

(declare-fun temp___3471 () (Array Int value))

(declare-fun temp___3472 () (Array Int value))
...
;; H
  (assert
  (= a__split_fields6 (mk___split_fields temp___341 temp___3411 temp___3412)))
...
;; H
  (assert
  (= a__split_fields7 (mk___split_fields temp___344 temp___3441 temp___3442)))
...
;; H
  (assert
  (= a__split_fields8 (mk___split_fields temp___347 temp___3471 temp___3472)))
