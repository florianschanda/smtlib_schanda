...
;; H
  (assert
  (and
  (= o6 (find1 (mk___rep d__split_discrs (mk___split_fields d__split_fields))
        k))
  (ite (ite (= (has_key1
               (model__
  ...
  (= (get1
     ...
     o6) (find
         ...
         k)))
  (= (equivalent_keys
     (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) o6)
     k) true)))))
...
;; H
  (assert
  (and (= o5 (key (mk___rep d__split_discrs d__split_fields2) c1))
  (and (in_range3 o5)
  (= o5 (get (keys (mk___rep d__split_discrs d__split_fields2))
        (get1 (positions (mk___rep d__split_discrs d__split_fields2)) c1))))))

;; H
  (assert
  (and
  (= temp___592 (element (mk___rep d__split_discrs d__split_fields2) c1))
  (and (in_range4 temp___592)
  (= temp___592 (get2 (model__ (mk___rep d__split_discrs d__split_fields2))
                (key (mk___rep d__split_discrs d__split_fields2) c1))))))

(assert
;; WP_parameter_def
 ;; File "a-cforma.ads", line 997, characters 0-0
  (not (<= (to_rep (first (rt a))) temp___592)))
(check-sat)
(exit)
