...
;; H
  (assert (=> (= result true) (=> (= status 3) (= o (extractuser state1)))))

;; H
  (assert
  (=> (= result true)
  (=> (= status 3) (= (valid_numberlogentries state4) true))))

;; H
  (assert (=> (= result true) (=> (= status 3) (= status2 status))))

;; H
  (assert (=> (= result true) (=> (= status 3) (= status2 status1))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (=> (not (= status 6)) (= status 7))
  (and (= status2 3) (in_range7 status2))))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= status2 status)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= state7 state1)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= state6 state)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= filestate3 filestate)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= status2 status1)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= state7 state3)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= state6 state2)))))

;; H
  (assert
  (=> (= result true)
  (=> (not (= status 3))
  (=> (not (=> (not (= status 6)) (= status 7))) (= filestate3 filestate1)))))

;; H
  (assert (=> (= result true) (=> (not (= status 3)) (= state5 state7))))

;; H
  (assert (=> (= result true) (=> (not (= status 3)) (= state4 state6))))

;; H
  (assert
  (=> (= result true) (=> (not (= status 3)) (= filestate2 filestate3))))

;; H
  (assert (=> (not (= result true)) (= o1 (extractuser state1))))

;; H
  (assert
  (=> (not (= result true)) (= (valid_numberlogentries state8) true)))

;; H
  (assert (=> (not (= result true)) (= result1 status)))

;; H
  (assert (=> (not (= result true)) (= status3 4)))

;; H
  (assert (=> (not (= result true)) (= status2 status3)))

;; H
  (assert (=> (not (= result true)) (= state5 state1)))

;; H
  (assert (=> (not (= result true)) (= state4 state8)))
...
;; H
  (assert (=> (not (= result true)) (= state5 state3)))
...
;; H
  (assert
  (and (not (= (ispresent (mk___rep theadmin__split_fields8)) true))
  (not (= (isdoingop (mk___rep theadmin__split_fields8)) true))))
...
;; H
  (assert (= state11 state4))

;; H
  (assert (= filestate6 filestate2))
...
;; WP_parameter_def
 ;; File "enclave.ads", line 82, characters 0-0
  ...
  (= (rolepresent
     (mk___rep
     (mk___split_fields theadmin__split_fields4 theadmin__split_fields5))) 0)))
(check-sat)
(exit)
