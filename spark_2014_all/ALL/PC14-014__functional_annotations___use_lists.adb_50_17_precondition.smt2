...
;; H
  ...
  (=>
  (and (<= 1 n1)
  (<= n1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields2))
            (mk___rep1 cu__split_fields3)) 1)))
  (= (is_incr
     (get
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     n1) (get (model__ (mk___rep l__split_discrs l__split_fields2)) n1)) true))))
...
;; H
  ...
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields2))
      (mk___rep1 cu__split_fields3)) n1)
  (<= n1 (length (mk___rep l__split_discrs l__split_fields2))))
  (= (get
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     n1) (get (model__ (mk___rep l__split_discrs l__split_fields2)) n1)))))
...
;; H
  (assert
  (and (= o2 (length (mk___rep l__split_discrs l__split_fields2)))
  (and (in_range2 o2)
  (<= o2 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  (assert
  (and (= o (positions (mk___rep l__split_discrs l__split_fields2)))
  (and (not (= (has_key o no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o i) true)
  (and
  (and (<= 1 (get1 o i))
  (<= (get1 o i) (length (mk___rep l__split_discrs l__split_fields2))))
  (forall ((j us_rep1))
  (=> (= (has_key o j) true)
  (=> (= (get1 o i) (get1 o j)) (= (bool_eq1 i j) true))))))))))
...
;; H
  (assert
  (and (= o5 (model__ (mk___rep l__split_discrs l__split_fields2)))
  (= (length1 o5) (length (mk___rep l__split_discrs l__split_fields2)))))
