...
(((mk___split_fields
  (rec__dw1000__register_types__usr_sfd_type__sub_registers (Array Int bits_8))))))
(define-fun us_split_fields_Sub_Registers__projection ((a us_split_fields)) (Array Int bits_8)
  (rec__dw1000__register_types__usr_sfd_type__sub_registers a))
...
(define-fun us_rep___25__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (bool_eq
                           (rec__dw1000__register_types__usr_sfd_type__sub_registers
                           (us_split_fields1 a)) 0 40
                           (rec__dw1000__register_types__usr_sfd_type__sub_registers
                           (us_split_fields1 b)) 0 40) true)
                   true false))
...
;; dw1000__register_types__usr_sfd_type__sub_registers__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__usr_sfd_type__sub_registers__first__bit))

;; dw1000__register_types__usr_sfd_type__sub_registers__last__bit_axiom
  (assert
  (< dw1000__register_types__usr_sfd_type__sub_registers__first__bit
  dw1000__register_types__usr_sfd_type__sub_registers__last__bit))

;; dw1000__register_types__usr_sfd_type__sub_registers__position_axiom
  (assert
  (<= 0 dw1000__register_types__usr_sfd_type__sub_registers__position))

(declare-fun user_eq5 (us_rep us_rep) Bool)

(declare-const dummy5 us_rep)

(declare-datatypes ((usr_sfd_type__ref 0))
(((mk_usr_sfd_type__ref (usr_sfd_type__content us_rep)))))
(define-fun usr_sfd_type__ref___projection ((a usr_sfd_type__ref)) us_rep
  (usr_sfd_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___54__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___39__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___39__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3357 us_t1)
  (temp___is_init_3354 Bool) (temp___skip_constant_3355 Bool)
  (temp___do_toplevel_3356 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3355 true))
                                       (and (dynamic_property2 1 41
                                       (first3 temp___expr_3357)
                                       (last3 temp___expr_3357))
                                       (and (= (first3 temp___expr_3357) 1)
                                       (= (last3 temp___expr_3357) 41)))))
...
;; H
  (assert
  (and (dynamic_property2 1 41 (to_rep reg_bytes__first)
  (to_rep reg_bytes__last))
  (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 41))))
