...
(define-fun us_rep_25__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))
...
(declare-fun dw1000__register_types__usr_sfd_type__sub_registers__first__bit () Int)

(declare-fun dw1000__register_types__usr_sfd_type__sub_registers__last__bit () Int)

(declare-fun dw1000__register_types__usr_sfd_type__sub_registers__position () Int)
...
(define-fun register_type__ref_54__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_39__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_39__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3324 us_t1)
  (temp___is_init_3321 Bool) (temp___skip_constant_3322 Bool)
  (temp___do_toplevel_3323 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3322 true))
                                       (and (dynamic_property2 1 41
                                       (first3 temp___expr_3324)
                                       (last3 temp___expr_3324))
                                       (and (= (first3 temp___expr_3324) 1)
                                       (= (last3 temp___expr_3324) 41)))))
