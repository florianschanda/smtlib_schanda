...
(declare-fun temp___5371 () (Array Int (Array Int et1)))
...
(declare-fun temp___5361 () (Array Int (Array Int et1)))
...
(declare-fun o14 () (Array Int (Array Int et1)))

(declare-fun o15 () (Array Int (Array Int et1)))

(declare-fun o16 () Int)

(declare-fun temp___5362 () (Array Int (Array Int (Array Int et1))))
...
(declare-fun t2 () (Array Int (Array Int (Array Int et1))))
...
;; H
  (assert (=> (< 0 e) (and (= o11 (- e 1)) (in_range3 (- e 1)))))
...
;; H
  (assert (=> (< 0 e) (= temp___5361 (select a o10))))

;; H
  (assert (=> (< 0 e) (= o12 (select temp___5361 j))))

;; H
  (assert (=> (< 0 e) (= o13 (temp___1675 o12 i o11))))
...
;; H
  (assert (=> (< 0 e) (= o14 (select a o9))))

;; H
  (assert (=> (< 0 e) (= o15 (temp___1668 o14 j o13))))

;; H
  (assert (=> (< 0 e) (and (= o16 (+ k 1)) (in_range2 (+ k 1)))))
...
;; H
  ...
  (= temp___5362 (temp___1645 a k
                 ...
                 (temp___1660 (select (select a k) j) i e)) o16 o15))))

;; H
  (assert (=> (< 0 e) (= result5 (bool_eq2 a3 1 16 temp___5362 1 16))))

;; H
  (assert (=> (not (< 0 e)) (= result5 false)))
...
;; H
  (assert (= temp___5371 (select a o6)))

;; H
  (assert (= o7 (select temp___5371 j)))

;; H
  (assert (= o8 (temp___1714 o7 i 99)))
