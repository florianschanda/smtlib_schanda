...
(declare-fun temp___532 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun temp___529 () Bool)

(declare-fun temp___528 () (_ BitVec 64))

(declare-fun temp___538 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun exit_called2 () bool__ref)
...
(declare-fun rax2 () t__ref2)

(declare-fun rcx2 () t__ref2)

(declare-fun rdx2 () t__ref2)

(declare-fun rbx3 () t__ref2)

(declare-fun rsp6 () t__ref2)

(declare-fun rsi4 () t__ref2)

(declare-fun rdi4 () t__ref2)

(declare-fun r82 () t__ref2)

(declare-fun memory3 () map__ref)

(declare-fun exit_called3 () Bool)
...
(declare-fun exit_called4 () bool__ref)

(declare-fun zeroflag5 () bool__ref)

(declare-fun carryflag5 () bool__ref)

(declare-fun signflag5 () bool__ref)

(declare-fun overflowflag5 () bool__ref)

(declare-fun rax4 () t__ref2)

(declare-fun rcx4 () t__ref2)

(declare-fun rdx4 () t__ref2)

(declare-fun rbx5 () t__ref2)

(declare-fun rsp8 () t__ref2)

(declare-fun rsi6 () t__ref2)

(declare-fun rdi6 () t__ref2)

(declare-fun r84 () t__ref2)

(declare-fun memory5 () map__ref)

(declare-fun exit_called5 () Bool)
...
(declare-fun r85 () (_ BitVec 64))

(declare-fun memory6 () (Array (_ BitVec 64) unsigned8))

(declare-fun exit_called6 () bool__ref)

(declare-fun zeroflag7 () bool__ref)

(declare-fun carryflag7 () bool__ref)

(declare-fun signflag7 () bool__ref)

(declare-fun overflowflag7 () bool__ref)

(declare-fun rax6 () t__ref2)

(declare-fun rcx6 () t__ref2)

(declare-fun rdx6 () t__ref2)

(declare-fun rbx7 () t__ref2)

(declare-fun rsp10 () t__ref2)

(declare-fun rsi8 () t__ref2)

(declare-fun rdi8 () t__ref2)

(declare-fun r86 () t__ref2)

(declare-fun memory7 () map__ref)

(declare-fun exit_called7 () Bool)
...
(declare-fun r87 () (_ BitVec 64))

(declare-fun memory8 () (Array (_ BitVec 64) unsigned8))

;; H
  (assert (= temp___536 rbx))

;; H
  (assert (= temp___535 exit_called))

;; H
  (assert (= temp___534 rsp))

;; H
  (assert (= temp___532 memory))

;; H
  (assert (= temp___533 rsi))

;; H
  (assert (= temp___531 r8))

;; H
  (assert (= temp___530 overflowflag))

;; H
  (assert (= temp___529 signflag))

;; H
  (assert (= temp___528 rax))

;; H
  (assert (= temp___538 memory))

;; H
  (assert (= temp___527 carryflag))

;; H
  (assert (= temp___526 rcx))

;; H
  (assert (= temp___525 rdi))

;; H
  (assert (= temp___537 rsp))

;; H
  (assert (= temp___523 rdx))

;; H
  (assert (= temp___524 zeroflag))

;; H
  (assert (= rsp1 temp___537))
...
;; H
  ...
  (and
  (and
  (not (= i (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104))))
  (not
  (= i (bvadd (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 1)))))
  (not
  (= i (bvadd (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 2)))))
  (not
  (= i (bvadd (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 3)))))
  (not
  (= i (bvadd (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 4)))))
  (not
  (= i (bvadd (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 5)))))
  (not
  (= i (bvadd (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 6)))))
  (not
  (= i (bvadd (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 7)))))
  (= (to_rep (select memory1 i)) (to_rep (select temp___538 i)))))))
...
;; H
  (assert
  (= rsi2 (bvsub (bvadd rsp1 ((_ int2bv 64) 152)) ((_ int2bv 64) 104))))
...
;; H
  ...
  (and
  (and
  (and (= rsp3 (bvadd rsp2 ((_ int2bv 64) 8)))
  (= (to_rep (select memory2 rsp2)) (to_rep (select memory1 rsp2))))
  (= (to_rep (select memory2 (bvadd rsp2 ((_ int2bv 64) 1)))) (to_rep
                                                              (select 
                                                              memory1 (bvadd 
                                                              rsp2 ((_ int2bv 64) 1))))))
  (= (to_rep (select memory2 (bvadd rsp2 ((_ int2bv 64) 2)))) (to_rep
                                                              (select 
                                                              memory1 (bvadd 
                                                              rsp2 ((_ int2bv 64) 2))))))
  (= (to_rep (select memory2 (bvadd rsp2 ((_ int2bv 64) 3)))) (to_rep
                                                              (select 
                                                              memory1 (bvadd 
                                                              rsp2 ((_ int2bv 64) 3))))))
  (= (to_rep (select memory2 (bvadd rsp2 ((_ int2bv 64) 4)))) (to_rep
                                                              (select 
                                                              memory1 (bvadd 
                                                              rsp2 ((_ int2bv 64) 4))))))
  (= (to_rep (select memory2 (bvadd rsp2 ((_ int2bv 64) 5)))) (to_rep
                                                              (select 
                                                              memory1 (bvadd 
                                                              rsp2 ((_ int2bv 64) 5))))))
  (= (to_rep (select memory2 (bvadd rsp2 ((_ int2bv 64) 6)))) (to_rep
                                                              (select 
                                                              memory1 (bvadd 
                                                              rsp2 ((_ int2bv 64) 6))))))
  (= (to_rep (select memory2 (bvadd rsp2 ((_ int2bv 64) 7)))) (to_rep
                                                              (select 
                                                              memory1 (bvadd 
                                                              rsp2 ((_ int2bv 64) 7))))))
  (forall ((i (_ BitVec 64)))
  ...
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
  (=> (not (= (inrange64 i rsi2 ((_ int2bv 64) 8)) true))
...
;; H
  ...
  (and
  (= o (readmem32
       (bvsub (bvadd rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) memory2))
  (and
  (and
  (and
  (= (bvand o ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep
                                                       (select memory2 (bvsub (bvadd 
                                                       rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 104))))))
  (= (bvand o ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep
                                                                (select 
                                                                memory2 (bvadd (bvsub (bvadd 
                                                                rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256))))
  (= (bvand o ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep
                                                                   (select 
                                                                   memory2 (bvadd (bvsub (bvadd 
                                                                   rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536))))
  (= (bvand o ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) 
  (to_rep
  (select memory2 (bvadd (bvsub (bvadd rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216))))))
...
;; H
  (assert (= (writereg32post rdi3 ((_ int2bv 32) 4198703)) true))
...
;; H
  (assert
  (= zeroflag2 (ite (= (bvsub rbx2 ((_ int2bv 64) 1001)) ((_ int2bv 64) 0))
               true false)))
...
;; H
  (assert
  (= signflag2 (ite (bvugt (bvsub rbx2 ((_ int2bv 64) 1001)) ((_ int2bv 64) 9223372036854775807))
               true false)))
...
;; H
  (assert
  (= overflowflag2 (ite (and (and (= signflag2 true) (= (of_int 0) true))
                        (bvule rbx2 ((_ int2bv 64) 9223372036854775807)))
                   true
                   (ite (and
                        (and (not (= signflag2 true))
                        (bvugt rbx2 ((_ int2bv 64) 9223372036854775807)))
                        (= (of_int 1) true))
                   true false))))
...
;; H
  (assert
  (not
  (= i (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 1)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 2)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 3)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 4)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 5)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 6)))))

;; H
  (assert
  (not
  (= i (bvadd (bvsub (bvadd (t__content2 rsp10) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 7)))))
