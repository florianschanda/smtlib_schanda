...
(((mk___split_fields
  (rec__dw1000__register_types__agc_tune1_type__agc_tune1 bits_16)))))
(define-fun us_split_fields_AGC_TUNE1__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__agc_tune1_type__agc_tune1 a))
...
(define-fun us_rep___27__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__agc_tune1_type__agc_tune1
...
;; dw1000__register_types__agc_tune1_type__agc_tune1__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__agc_tune1_type__agc_tune1__first__bit))

;; dw1000__register_types__agc_tune1_type__agc_tune1__last__bit_axiom
  (assert
  (< dw1000__register_types__agc_tune1_type__agc_tune1__first__bit dw1000__register_types__agc_tune1_type__agc_tune1__last__bit))

;; dw1000__register_types__agc_tune1_type__agc_tune1__position_axiom
...
(declare-datatypes ((agc_tune1_type__ref 0))
(((mk_agc_tune1_type__ref (agc_tune1_type__content us_rep)))))
(define-fun agc_tune1_type__ref___projection ((a agc_tune1_type__ref)) us_rep
  (agc_tune1_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___61__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___44__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___44__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3500 us_t1)
  (temp___is_init_3497 Bool) (temp___skip_constant_3498 Bool)
  (temp___do_toplevel_3499 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3498 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3500)
                                       (last3 temp___expr_3500))
                                       (and (= (first3 temp___expr_3500) 1)
                                       (= (last3 temp___expr_3500) 2)))))
...
(define-fun target__ref___18__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___18__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_3516 us_t2)
  (temp___is_init_3513 Bool) (temp___skip_constant_3514 Bool)
  (temp___do_toplevel_3515 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3514 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_3516)
                                       (last5 temp___expr_3516))
                                       (and (= (first5 temp___expr_3516) 1)
                                       (= (last5 temp___expr_3516) 2)))))
...
(define-fun temp___78332 () us_t2 (mk___t2 temp___7833 temp___78331))
...
;; H
  (assert
  (and (= temp___78332 (register_to_bytes reg)) (dynamic_invariant1
  temp___78332 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___78331)) (to_rep (last4 temp___78331)))
     (+ (- (to_rep (last4 temp___78331)) (to_rep (first4 temp___78331))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
