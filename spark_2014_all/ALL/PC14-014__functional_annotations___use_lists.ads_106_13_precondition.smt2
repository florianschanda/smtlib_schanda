...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o10 j) true)
  (=> (= (get1 o10 i1) (get1 o10 j)) (= (bool_eq1 i1 j) true))))))))))
...
;; H
  ...
  (forall ((k us_rep1))
  (=> (= (has_key o10 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o10 cu) (witness o10 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o8 j) true)
  (=> (= (get1 o8 i1) (get1 o8 j)) (= (bool_eq1 i1 j) true))))))))))
...
;; H
  ...
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o8 k) true) (= (bool_eq1 k cu) true))) (= o9 true)))))
