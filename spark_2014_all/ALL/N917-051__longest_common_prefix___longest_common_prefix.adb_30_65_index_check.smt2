...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 0 k1) (<= k1 (- l2 1)))
  (= (to_rep (select a (+ x k1))) (to_rep (select a (+ y k1)))))))
...
;; H
  (assert (and (= temp___166 (+ y k)) (in_range1 (+ y k))))

;; H
  (assert (and (<= 1 temp___166) (<= temp___166 1000)))

;; H
  (assert (= o8 temp___166))
...
;; H
  (assert (and (= temp___165 (+ x k)) (in_range1 (+ x k))))
