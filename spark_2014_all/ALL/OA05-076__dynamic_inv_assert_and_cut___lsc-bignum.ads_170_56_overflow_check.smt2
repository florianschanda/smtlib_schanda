...
(declare-fun temp___612 () (Array Int word32))

(declare-fun temp___610 () (_ BitVec 32))

(declare-fun temp___609 () (_ BitVec 32))

(declare-fun temp___608 () (_ BitVec 32))

(declare-fun temp___607 () Int)

(declare-fun temp___606 () (_ BitVec 32))

(declare-fun temp___605 () (_ BitVec 32))
...
;; H
  (assert (and (= o20 (- a_last a_first)) (in_range1 (- a_last a_first))))
...
;; H
  (assert (= o12 (num_of_big_int m m_first o11)))

;; H
  (assert (= o14 (inverse o12 o13)))
