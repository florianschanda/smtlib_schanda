...
(declare-fun dummy13 () positive_count_type)
...
(declare-fun use_ordered_sets__double_size__cu__assume () count_type)

(declare-fun temp___796 () us_rep2)

(declare-fun temp___798 () us_rep2)

(declare-fun temp___794 () us_rep2)

(declare-fun temp___792 () count_type)

(declare-fun temp___7921 () us_main_type)

(declare-fun temp___791 () Int)

(declare-fun temp___797 () Int)

(declare-fun temp___790 () count_type)

(declare-fun temp___795 () us_rep2)

(declare-fun temp___793 () Int)
...
(define-fun o18 () us_rep1 (mk___rep1 (mk___split_fields1 o3)))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= s__split_discrs (mk___split_discrs temp___792))
  (= s__split_fields temp___7921))))

;; H
  (assert (=> (= result2 true) (= temp___791 n1)))
...
;; H
  (assert (=> (= result2 true) (= temp___790 cu__split_fields1)))
...
;; H
  (assert
  (=> (= result2 true)
  (= (length (mk___rep s__split_discrs s__split_fields2)) (+ temp___793
  n2))))
...
;; H
  ...
  (=> (and (<= 1 i1) (<= i1 n2))
  (and
  (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (* 2 i1)) (+
  (get temp___794 i1) 1))
  (= (get (elements (mk___rep s__split_discrs s__split_fields2))
     (- (* 2 i1) 1)) (get temp___795 i1)))))))
...
;; H
  ...
  (= (get (elements (mk___rep s__split_discrs s__split_fields2)) i1)
  (get temp___796 (- i1 n2)))))))

;; H
  (assert
  (=> (= result2 true)
  (forall ((i1 Int))
  (=> (and (<= (+ n2 1) i1) (<= i1 temp___797))
  (= (get (elements (mk___rep s__split_discrs s__split_fields2)) (+ i1 n2))
  (get temp___798 i1))))))
...
;; H
  ...
  (=> (= result2 true)
  (not
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields2))
     (+ (element (mk___rep s__split_discrs s__split_fields2)
        (mk___rep1 cu__split_fields2)) 1)) true))))

;; H
  (assert
  (=> (= result2 true)
  (and
  (= o (element (mk___rep s__split_discrs s__split_fields2)
       (mk___rep1 cu__split_fields2)))
  (and (in_range8 o)
  (= o (get (elements (mk___rep s__split_discrs s__split_fields2))
       (get1 (positions (mk___rep s__split_discrs s__split_fields2))
       (mk___rep1 cu__split_fields2))))))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= (contains (model__ (mk___rep s__split_discrs s__split_fields3)) o2) true)
  (ite (= (contains (model__ (mk___rep s__split_discrs s__split_fields2)) o2) true)
  (and
  (and
  (and
  (= (oeq3 (model__ (mk___rep s__split_discrs s__split_fields2))
     (model__ (mk___rep s__split_discrs s__split_fields3))) true)
  (= (oeq4 (positions (mk___rep s__split_discrs s__split_fields3))
     (positions (mk___rep s__split_discrs s__split_fields2))) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) o2))
  o2))
  (= (equal_except (elements (mk___rep s__split_discrs s__split_fields2))
     (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) o2)) true))
  (and
  (and
  (and
  (and
  ...
  (= (length (mk___rep s__split_discrs s__split_fields3)) (+ (length
                                                             ...
                                                             s__split_discrs
                                                             s__split_fields2)) 1))
  (= (ole (model__ (mk___rep s__split_discrs s__split_fields2))
     (model__ (mk___rep s__split_discrs s__split_fields3))) true))
  (= (included_except (model__ (mk___rep s__split_discrs s__split_fields3))
     (model__ (mk___rep s__split_discrs s__split_fields2)) o2) true))
  (= (get (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) o2))
  o2))
  (= (range_equal (elements (mk___rep s__split_discrs s__split_fields2))
     (elements (mk___rep s__split_discrs s__split_fields3)) 1
     (- (find (elements (mk___rep s__split_discrs s__split_fields3)) o2) 1)) true))
  (= (range_shifted (elements (mk___rep s__split_discrs s__split_fields2))
     (elements (mk___rep s__split_discrs s__split_fields3))
     (find (elements (mk___rep s__split_discrs s__split_fields3)) o2)
     (length (mk___rep s__split_discrs s__split_fields2)) 1) true))
  (= (p_positions_shifted
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o18 (next (mk___rep s__split_discrs s__split_fields3)
         (mk___rep1 cu__split_fields2)))
  (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields2) no_element) false) (=
          (get1 (positions (mk___rep s__split_discrs s__split_fields3))
          (mk___rep1 cu__split_fields2)) (length
                                         (mk___rep s__split_discrs
                                         s__split_fields3))) true) true)
  (= (bool_eq1 o18 no_element) true)
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o18) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o18) (+
  (get1 (positions (mk___rep s__split_discrs s__split_fields3))
  (mk___rep1 cu__split_fields2)) 1)))))))

;; H
  (assert
  (=> (= result2 true)
  (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o18))
  (ite (= (ite (= (bool_eq1 o18 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      s__split_discrs
                                                      s__split_fields3))
                                                      o18) (length
                                                           ...
                                                           s__split_discrs
                                                           s__split_fields3))) true) true)
  (= (bool_eq1 temp___7891 no_element) true)
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields3))
     temp___7891) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields3))
     temp___7891) (+ (get1
                     (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (=> (= result2 true)
  (= result3 (mk___split_fields__ref1 cu__split_fields2))))

;; H
  (assert
  (=> (= result2 true) (= cu__split_fields3 (mk___split_fields1 temp___789))))
...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o5 (has_key (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (=> (= result2 true) (= result5 (ite (not (= o5 true)) true false))))
...
;; H
  (assert
  (=> (= result2 true)
  (= s__split_fields4 (mk___split_fields__ref s__split_fields3))))
...
;; H
  (assert
  (=> (not (= result2 true))
  (= cu__split_fields6 (mk___split_fields__ref1 cu__split_fields10))))
...
;; H
  (assert
  (=> (not (= result2 true)) (= cu__split_fields7 cu__split_fields10)))
...
;; H
  (assert (and (= o11 (* 2 i)) (in_range1 (* 2 i))))
...
;; H
  ...
  (=> (and (in_range4 temp___390) (= (iter_has_element o10 temp___390) true))
  (= (contains
     (model__
     (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))
     (get o10 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range7 item)
  (= (contains
     ...
     item) true))
  (and (< 0 (find o10 item))
  (= (equivalent_elements (get o10 (find o10 item)) item) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length
         (mk___rep s__split_discrs
         (us_split_fields__content s__split_fields8)))))
  (and (= (find o10 (get o10 i1)) i1)
  (= (e_is_find o10 (get o10 i1) i1) true)))))))

;; H
  (assert (and (= o16 (get o10 o12)) (in_range5 o16)))
...
;; H
  (assert (and (= o6 (* 2 i)) (in_range1 (* 2 i))))
