...
(declare-fun p__pt__j__first__bit () Int)

(declare-fun p__pt__j__last__bit () Int)

(declare-fun p__pt__j__position () Int)
...
(define-fun us_split_fields_X2__projection ((a us_split_fields2)) positive
  (rec__p__pt__x1 a))
...
(declare-fun p__pt__j__first__bit1 () Int)

(declare-fun p__pt__j__last__bit1 () Int)

(declare-fun p__pt__j__position1 () Int)
