...
(declare-fun temp___144 ((Array Int Bool) Int Int Bool Int Int Bool Int Int
  Bool Int Int Bool Int Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___146 (Array Int Bool)))
  (forall ((temp___147 Int) (temp___148 Int) (temp___150 Int)
  (temp___151 Int) (temp___153 Int) (temp___154 Int) (temp___156 Int)
  (temp___157 Int) (temp___159 Int))
  (forall ((temp___149 Bool) (temp___152 Bool) (temp___155 Bool)
  (temp___158 Bool) (temp___160 Bool))
  (let ((temp___145 (temp___144 temp___146 temp___147 temp___148 temp___149
                    temp___150 temp___151 temp___152 temp___153 temp___154
                    temp___155 temp___156 temp___157 temp___158 temp___159
                    temp___160)))
  (forall ((temp___161 Int))
  (ite (= temp___161 temp___159)
  (= (select temp___145 temp___161) temp___160)
  (ite (and (<= temp___156 temp___161) (<= temp___161 temp___157))
  (= (select temp___145 temp___161) temp___158)
  (ite (and (<= temp___153 temp___161) (<= temp___161 temp___154))
  (= (select temp___145 temp___161) temp___155)
  (ite (and (<= temp___150 temp___161) (<= temp___161 temp___151))
  (= (select temp___145 temp___161) temp___152)
  (ite (and (<= temp___147 temp___161) (<= temp___161 temp___148))
  (= (select temp___145 temp___161) temp___149)
  (= (select temp___145 temp___161) (select temp___146 temp___161)))))))))))))
...
;; H
  (assert
  (= arr1 (temp___144 arr 1 5 (of_int 1) 2 5 (of_int 0) 3 5 (of_int 1) 4 5
          (of_int 0) 5 (of_int 1))))

(assert
;; WP_parameter_def
 ;; File "update_legal.ads", line 6, characters 0-0
  (not (= (select arr1 1) true)))
(check-sat)
(exit)
