...
(define-fun dynamic_invariant1 ((temp___expr_380 Int)
  ...
  (temp___do_toplevel_379 Bool)) Bool (=>
                                      ...
                                      (<= 0 31)) (in_range3 temp___expr_380)))
...
;; range_axiom
  (assert
  (forall ((x profile_kind)) (! (in_range5
...
(define-fun bool_eq14 ((a (Array Int us_rep3)) (a__first Int) (a__last Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq13 (select a temp___idx_140)
