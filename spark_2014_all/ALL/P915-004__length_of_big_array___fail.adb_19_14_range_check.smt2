...
;; temp___String_Literal_640__def_axiom
  ...
  (! (and
     (and
     (and
     (= (to_rep (select (temp___String_Literal_640 us_void_param) 1)) 122)
     (= (to_rep (select (temp___String_Literal_640 us_void_param) 2)) 101))
     (= (to_rep (select (temp___String_Literal_640 us_void_param) 3)) 114))
     (= (to_rep (select (temp___String_Literal_640 us_void_param) 4)) 111)) :pattern (
...
;; temp___String_Literal_641__def_axiom
  ...
  (! (and
     (and
     (= (to_rep (select (temp___String_Literal_641 us_void_param) 1)) 109)
     (= (to_rep (select (temp___String_Literal_641 us_void_param) 2)) 97))
     (= (to_rep (select (temp___String_Literal_641 us_void_param) 3)) 120)) :pattern (
...
;; H
  (assert
  (= result (ite (bvugt o1 ((_ int2bv 64) 18446744073709551615)) true false)))
