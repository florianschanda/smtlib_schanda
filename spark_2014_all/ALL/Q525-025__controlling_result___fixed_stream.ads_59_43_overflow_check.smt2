...
;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (= result4 (ite (<= o12 o11) true false))))
...
;; H
  (assert (=> (= result4 true) (= o9 (+ o8 (to_rep1 (first (rt new_val)))))))

;; H
  (assert (=> (= result4 true) (and (= o10 o9) (in_range1 o9))))

;; H
  (assert
  (=> (= result4 true)
  (= result3 (ite (<= o10 (to_rep1 (last (rt new_val)))) true false))))
