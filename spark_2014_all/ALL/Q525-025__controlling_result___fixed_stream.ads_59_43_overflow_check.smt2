...
;; H
  ...
  (and (= o12 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1
...
;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (= result4 (ite (<= o13 o12) true false))))
...
;; H
  (assert
  (=> (= result4 true) (= o10 (+ o9 (to_rep1 (first (rt new_val)))))))
...
;; H
  (assert
  (=> (= result4 true)
  (= result3 (ite (<= o11 (to_rep1 (last (rt new_val)))) true false))))
