...
(declare-datatypes ()
((tT111bP1__ref (mk_tT111bP1__ref (tT111bP1__content tdigit_count_typeB)))))
(define-fun tT111bP1__ref___projection ((a tT111bP1__ref)) tdigit_count_typeB
  (tT111bP1__content a))
...
(declare-datatypes ()
((tS131bP1__ref (mk_tS131bP1__ref (tS131bP1__content tdigit_count_typeB)))))
(define-fun tS131bP1__ref___projection ((a tS131bP1__ref)) tdigit_count_typeB
  (tS131bP1__content a))
...
(declare-datatypes ()
((t133b__ref (mk_t133b__ref (t133b__content tdigit_count_typeB)))))
(define-fun t133b__ref___projection ((a t133b__ref)) tdigit_count_typeB
  (t133b__content a))
...
(declare-datatypes ()
((tS135bP1__ref (mk_tS135bP1__ref (tS135bP1__content tdigit_count_typeB)))))
(define-fun tS135bP1__ref___projection ((a tS135bP1__ref)) tdigit_count_typeB
  (tS135bP1__content a))
...
(declare-datatypes ()
((t137b__ref (mk_t137b__ref (t137b__content tdigit_count_typeB)))))
(define-fun t137b__ref___projection ((a t137b__ref)) tdigit_count_typeB
  (t137b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___1069 (_ BitVec 8)))
  (forall ((temp___1070 Int) (temp___1071 Int))
  (let ((temp___1068 (temp___1067 temp___1069 temp___1070 temp___1071)))
  (and
  (=> (dynamic_property16 1 65536 temp___1070 temp___1071)
  (and (= (first10 temp___1068) temp___1070)
  (= (last11 temp___1068) temp___1071)))
  (forall ((temp___1072 Int))
  (= (select (to_array4 temp___1068) temp___1072) (of_rep1 temp___1069))))))))

(declare-fun temp___1080 ((_ BitVec 8) Int Int) us_t6)

;; def_axiom
  (assert
  (forall ((temp___1082 (_ BitVec 8)))
  (forall ((temp___1083 Int) (temp___1084 Int))
  (let ((temp___1081 (temp___1080 temp___1082 temp___1083 temp___1084)))
  (and
  (=> (dynamic_property16 1 65536 temp___1083 temp___1084)
  (and (= (first14 temp___1081) temp___1083)
  (= (last15 temp___1081) temp___1084)))
  (forall ((temp___1085 Int))
  (= (select (to_array6 temp___1081) temp___1085) (of_rep1 temp___1082))))))))
...
(declare-fun temp___1074 () (Array Int octet))

(declare-fun temp___10741 () t4)

(declare-fun temp___1075 () (Array Int octet))

(declare-fun temp___10751 () t3)

(declare-fun temp___1077 () us_t3)

(declare-fun o () us_t)

(declare-fun o1 () us_split_fields)

(declare-fun temp___1079 () us_rep)

(declare-fun temp___1087 () us_t6)

(declare-fun temp___1088 () us_t5)
...
(declare-fun temp___1092 () us_rep)
...
(declare-fun very_longs__divide__L_7__R139b__assume () Int)

(declare-fun temp___1102 () (_ BitVec 16))

(declare-fun temp___1101 () (_ BitVec 16))

(declare-fun temp___1100 () us_rep)

(declare-fun temp___1099 () us_rep1)
...
(declare-fun u__split_fields4 () us_split_fields2)

(declare-fun current_borrow2 () (_ BitVec 16))

(declare-fun quotient__split_fields4 () us_split_fields)

(declare-fun u__split_fields5 () us_split_fields2)

(declare-fun quotient__split_fields5 () us_split_fields__ref)

(declare-fun u__split_fields6 () us_split_fields__ref1)

(declare-fun q_hat3 () t__ref1)

(declare-fun current_borrow3 () t__ref1)

(declare-fun j3 () int__ref)

(declare-fun quotient__split_fields6 () us_split_fields)

(declare-fun u__split_fields7 () us_split_fields2)
...
(declare-fun quotient__split_fields7 () us_split_fields__ref)

(declare-fun u__split_fields8 () us_split_fields__ref1)

(declare-fun q_hat5 () t__ref1)

(declare-fun current_borrow5 () t__ref1)

(declare-fun j5 () int__ref)

(declare-fun quotient__split_fields8 () us_split_fields)

(declare-fun u__split_fields9 () us_split_fields2)

(declare-fun q_hat6 () (_ BitVec 16))

(declare-fun current_borrow6 () (_ BitVec 16))
...
;; H
  (assert
  (= (to_rep2 (first9 (rt4 (temp___1067 ((_ int2bv 8) 0) 1 r132b)))) 1))

;; H
  (assert
  (= (to_rep2 (last10 (rt4 (temp___1067 ((_ int2bv 8) 0) 1 r132b))))
  r132b))

;; H
  (assert
  (= (mk___t4 temp___1074 temp___10741) (temp___1067 ((_ int2bv 8) 0) 1
                                        r132b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first9 temp___10741)) (to_rep2 (last10 temp___10741)))
     (+ (- (to_rep2 (last10 temp___10741)) (to_rep2 (first9 temp___10741))) 1)
     0) (ite (<= 1 r132b) (+ (- r132b 1) 1) 0)))
...
;; H
  (assert
  (= (mk3 (to_rep2 (first9 temp___10741)) (to_rep2 (last10 temp___10741)))
  temp___10751))

;; H
  (assert
  (= (ite (<= (to_rep2 (first7 temp___10751)) (to_rep2 (last8 temp___10751)))
     (+ (- (to_rep2 (last8 temp___10751)) (to_rep2 (first7 temp___10751))) 1)
...
;; H
  (assert
  (= o (mk___t (elts3 temp___1077)
       (mk (to_rep2 (first7 (rt3 temp___1077)))
       (to_rep2 (last8 (rt3 temp___1077)))))))

;; H
  (assert (= o1 (mk___split_fields o)))

;; H
  (assert (= temp___1079 (mk___rep quotient__split_discrs o1)))
...
;; H
  (assert
  (= (to_rep2 (first13 (rt6 (temp___1080 ((_ int2bv 8) 0) 1 r136b)))) 1))

;; H
  (assert
  (= (to_rep2 (last14 (rt6 (temp___1080 ((_ int2bv 8) 0) 1 r136b))))
  r136b))

;; H
  (assert (= temp___1087 (temp___1080 ((_ int2bv 8) 0) 1 r136b)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first13 (rt6 temp___1087))) (to_rep2
                                                    (last14
                                                    (rt6 temp___1087))))
     (+ (- (to_rep2 (last14 (rt6 temp___1087))) (to_rep2
                                                (first13 (rt6 temp___1087)))) 1)
     0) (ite (<= 1 r136b) (+ (- r136b 1) 1) 0)))

;; H
  (assert
  (= temp___1088 (mk___t5 (elts6 temp___1087)
                 (mk5 (to_rep2 (first13 (rt6 temp___1087)))
                 (to_rep2 (last14 (rt6 temp___1087)))))))

;; H
  (assert
  (= (ite (<= (to_rep2 (first11 (rt5 temp___1088))) (to_rep2
                                                    (last12
                                                    (rt5 temp___1088))))
     (+ (- (to_rep2 (last12 (rt5 temp___1088))) (to_rep2
                                                (first11 (rt5 temp___1088)))) 1)
...
;; H
  (assert
  (= o2 (mk___t (elts5 temp___1090)
        (mk (to_rep2 (first11 (rt5 temp___1090)))
        (to_rep2 (last12 (rt5 temp___1090)))))))

;; H
  (assert (= o3 (mk___split_fields o2)))

;; H
  (assert (= temp___1092 (mk___rep remainder__split_discrs o3)))
...
;; H
  (assert
  (and (= temp___1093 (number_of_digits1 divisor))
  (and (in_range3 temp___1093)
  (and
  (=> (< 0 temp___1093)
  (not
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 divisor))) temp___1093)) ((_ int2bv 8) 0))))
  (forall ((j7 Int))
  (=>
  (and (<= (+ temp___1093 1) j7)
  (<= j7 (to_rep2
         (last
         (rt
  ...
  (= (to_rep1
     (select (elts
             (rec__very_longs__very_long__long_digits
             (us_split_fields1 divisor))) j7)) ((_ int2bv 8) 0))))))))

;; H
  (assert (and (= us4 temp___1093) (dynamic_property2 1 last2 temp___1093)))

;; H
  (assert (= o4 temp___1093))
...
;; H
  (assert
  (and (= very_longs__divide__L_7__R139b__assume (+ m1 1)) (in_range1
  (+ m1 1))))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1102 current_borrow)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= temp___1101 q_hat)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= temp___1100 (mk___rep quotient__split_discrs quotient__split_fields2))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= temp___1099 (mk___rep1 u__split_discrs u__split_fields2))))
...
;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o10 j2) (in_range2 j2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o11 j2) (in_range2 j2))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b)) (dynamic_invariant7
  (mk___rep1 u__split_discrs u__split_fields4) true true true)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (and (= o12 j2) (in_range2 j2))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (and (dynamic_invariant1
  (mk___rep quotient__split_discrs quotient__split_fields4) true true true)
  (dynamic_invariant7 (mk___rep1 u__split_discrs u__split_fields5) true true
  true))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j2 1)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j3 (mk_int__ref j2))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= current_borrow3 (mk_t__ref1 current_borrow2))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat3 (mk_t__ref1 q_hat2))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= u__split_fields6 (mk___split_fields__ref1 u__split_fields5))))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= quotient__split_fields5 (mk___split_fields__ref quotient__split_fields4))))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j4 j2)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b)) (= current_borrow4 current_borrow2)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat4 q_hat2)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b)) (= u__split_fields7 u__split_fields5)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= quotient__split_fields6 quotient__split_fields4)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j5 j3)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b)) (= current_borrow5 current_borrow3)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat5 q_hat3)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b)) (= u__split_fields8 u__split_fields6)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= quotient__split_fields7 quotient__split_fields5)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= j6 j4)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b)) (= current_borrow6 current_borrow4)))

;; H
  (assert (=> (and (<= 1 j1) (<= j1 r139b)) (= q_hat6 q_hat4)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b)) (= u__split_fields9 u__split_fields7)))

;; H
  (assert
  (=> (and (<= 1 j1) (<= j1 r139b))
  (= quotient__split_fields8 quotient__split_fields6)))

;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= j5 (mk_int__ref j1))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r139b)))
  (= current_borrow5 (mk_t__ref1 current_borrow))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r139b))) (= q_hat5 (mk_t__ref1 q_hat))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r139b)))
  (= u__split_fields8 (mk___split_fields__ref1 u__split_fields2))))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r139b)))
  (= quotient__split_fields7 (mk___split_fields__ref quotient__split_fields2))))

;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= j6 j1)))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r139b)))
  (= current_borrow6 current_borrow1)))

;; H
  (assert (=> (not (and (<= 1 j1) (<= j1 r139b))) (= q_hat6 q_hat1)))

;; H
  (assert
  (=> (not (and (<= 1 j1) (<= j1 r139b)))
  (= u__split_fields9 u__split_fields2)))
...
;; H
  (assert (dynamic_property2 1 last2 r141b))
