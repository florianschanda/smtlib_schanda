...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result11 (ite (< 0 o60) true false))))
...
;; H
  ...
  (=> (= result11 true)
  (and
  (= o59 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o59)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result11 true)
  (= result10 (ite (= o59 first_available1) true false)))))

;; H
  (assert
  (=> (not (= first_available1 0))
  (=> (not (= result11 true)) (= result10 false))))
