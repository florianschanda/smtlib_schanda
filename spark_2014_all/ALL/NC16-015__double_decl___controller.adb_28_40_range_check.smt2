...
(declare-datatypes ((cell_type__ref 0))
(((mk_cell_type__ref (cell_type__content cell_type)))))
...
(((mk___split_fields (rec__tetris__cell__kind cell_type)))))
...
(((mk_map__ref1 (map__content1 (Array Int (Array Int us_rep)))))))
...
(define-fun bool_eq2 ((a (Array Int (Array Int us_rep))) (a__first Int)
  ...
  (b__last Int)) Bool (ite (and
                           ...
                           (= (bool_eq1 (select a temp___idx_133) 1 8
...
(declare-datatypes ((piece_count_type__ref 0))
