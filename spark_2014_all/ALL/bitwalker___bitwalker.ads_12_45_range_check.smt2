...
(declare-fun bitwalker__peekbit8__result () Bool)
...
(declare-fun bitwalker__peekbit8__ret__assume () Bool)

(declare-fun result () Bool)

(declare-fun result1 () Bool)

(declare-fun bitwalker__peekbit8__result1 () Bool)

(declare-fun bitwalker__peekbit8__result2 () Bool)

(declare-fun bitwalker__peekbit8__result3 () Bool)

(declare-fun bitwalker__peekbit8__result4 () Bool)

(declare-fun bitwalker__peekbit8__result5 () Bool)
...
;; H
  (assert
  (= (mk_bool__ref result1) (mk_bool__ref bitwalker__peekbit8__result)))
...
;; H
  (assert
  (= (mk_bool__ref bitwalker__peekbit8__result4) (mk_bool__ref
