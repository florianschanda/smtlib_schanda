...
(define-fun m18 () map__ref (mk_map__ref m7))
...
;; H
  ...
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 (- c3 1)))
  (and (= (to_rep (get m2 5 i2)) (to_rep (get temp___232 7 i2)))
  (= (to_rep (get m2 7 i2)) (to_rep (get temp___233 5 i2))))))))
...
;; H
  (assert (=> (and (<= 1 c2) (<= c2 10)) (= m18 (mk_map__ref m5))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i2 5) (= (to_rep (get m7 i2 j)) 2)
  (ite (= i2 7) (= (to_rep (get m7 i2 j)) 1) (= (to_rep (get m7 i2 j)) 0))))))))
...
;; H
  ...
  (forall ((i2 Int))
  (=> (and (<= 1 i2) (<= i2 c9))
  (and (= (to_rep (get m10 5 i2)) (to_rep (get temp___248 7 i2)))
  (= (to_rep (get m10 7 i2)) (to_rep (get temp___249 5 i2))))))))
...
;; H
  ...
  (forall ((i2 Int))
  (=> (and (<= (+ c9 1) i2) (<= i2 10))
  (and (= (to_rep (get m10 5 i2)) (to_rep (get temp___250 5 i2)))
  (= (to_rep (get m10 7 i2)) (to_rep (get temp___251 7 i2))))))))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j 10))
  (ite (= i2 5) (= (to_rep (get (map__content m15) i2 j)) 2)
  (ite (= i2 7) (= (to_rep (get (map__content m15) i2 j)) 1)
  (= (to_rep (get (map__content m15) i2 j)) 0))))))))
...
;; WP_parameter_def
 ;; File "test_swap_lines.adb", line 1, characters 0-0
  (not (= (to_rep (get m17 k k)) (+ (to_rep (get m17 k k)) 1))))
(check-sat)
(exit)
