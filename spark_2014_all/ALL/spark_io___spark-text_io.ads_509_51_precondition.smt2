...
;; range_axiom
  (assert
  (forall ((x file_status)) (! (in_range1
...
(define-fun us_rep_9__projection ((a us_rep1)) Bool (attr__constrained a))
...
(define-fun default_initial_assumption ((temp___expr_708 us_rep1)
  (temp___skip_top_level_709 Bool)) Bool (and
                                         (= (attr__constrained
                                            temp___expr_708) false)
                                         (= (to_rep1
                                            (rec__spark__text_io__character_result__status
                                            (us_split_discrs1
                                            temp___expr_708))) 3)))
