...
;; H
  (assert
  (and (le (neg fliteral2) delta_speed2) (lt delta_speed2 fliteral3)))

(assert
;; WP_parameter_def
 ;; File "units.ads", line 27, characters 0-0
  (not (tqtisFinite (add RNE1 speed2 delta_speed2))))
(check-sat)
