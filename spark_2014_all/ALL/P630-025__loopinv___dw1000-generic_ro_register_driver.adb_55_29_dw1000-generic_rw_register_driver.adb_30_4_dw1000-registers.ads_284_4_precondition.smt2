...
(define-fun register_type__ref_51__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_37__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_37__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3245 us_t1)
  (temp___is_init_3242 Bool) (temp___skip_constant_3243 Bool)
  (temp___do_toplevel_3244 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3243 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3245)
                                       (last3 temp___expr_3245))
                                       (and (= (first3 temp___expr_3245) 1)
                                       (= (last3 temp___expr_3245) 4)))))
