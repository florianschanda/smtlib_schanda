...
;; H
  (assert
  (=> (= (to_rep (select buf1 1)) 118)
  (and (<= chosen_vote2 last_candidate) (in_range7 chosen_vote2))))

;; H
  (assert
  (=> (= (to_rep (select buf1 1)) 118)
  (< (to_rep2 (select counters1 chosen_vote2)) 10000)))
...
;; H
  (assert
  (=> (= (to_rep (select buf1 1)) 118)
  (= o5 (store counters1 chosen_vote2 o4))))
...
;; H
  (assert
  (=> (= (to_rep (select buf1 1)) 118)
  (and (= o6 (+ number_of_votes1 1)) (in_range1 (+ number_of_votes1 1)))))
...
;; H
  (assert
  (=> (not (= (to_rep (select buf1 1)) 118))
  (= result4 (bool_eq3 temp___691 1 11 (temp___String_Literal_690 Tuple0) 1
             11))))
...
;; H
  (assert
  (=> (not (= (to_rep (select buf1 1)) 118)) (= chosen_vote2 chosen_vote1)))
...
;; H
  (assert
  (=> (not (= (to_rep (select buf1 1)) 118)) (= counters2 counters1)))

;; H
  (assert
  (and (= o7 (* last_candidate 20)) (in_range1 (* last_candidate 20))))
