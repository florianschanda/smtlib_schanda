...
;; H
  ...
  (= o30 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o23 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (= o22 (maxvalue len))
  (= o22 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
...
;; H
  (assert
  (=> (<= (to_rep addr__first) (to_rep addr__last))
  (= o15 (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  (assert
  (and (= o14 (maxvalue len))
  (= o14 (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) len)))))
...
;; H
  (assert
  (and (= o11 (+ (- (- len i1) 1) start)) (in_range2
  (+ (- (- len i1) 1) start))))
