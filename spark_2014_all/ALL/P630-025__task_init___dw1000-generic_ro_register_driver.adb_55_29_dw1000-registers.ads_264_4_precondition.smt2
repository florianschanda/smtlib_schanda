...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__tx_time_type__tx_stamp bits_40)(rec__dw1000__register_types__tx_time_type__tx_rawst bits_40)))))
(define-fun us_split_fields_TX_STAMP__projection ((a us_split_fields)) bits_40
  (rec__dw1000__register_types__tx_time_type__tx_stamp a))

(define-fun us_split_fields_TX_RAWST__projection ((a us_split_fields)) bits_40
  (rec__dw1000__register_types__tx_time_type__tx_rawst a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_19__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_19__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (= (to_rep2
                           (rec__dw1000__register_types__tx_time_type__tx_stamp
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__tx_time_type__tx_stamp
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__tx_time_type__tx_rawst
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__tx_time_type__tx_rawst
                                                  (us_split_fields1 b)))))
                   true false))
...
(declare-fun dw1000__register_types__tx_time_type__tx_stamp__first__bit () Int)

(declare-fun dw1000__register_types__tx_time_type__tx_stamp__last__bit () Int)

(declare-fun dw1000__register_types__tx_time_type__tx_stamp__position () Int)

;; dw1000__register_types__tx_time_type__tx_stamp__first__bit_axiom
  (assert (<= 0 dw1000__register_types__tx_time_type__tx_stamp__first__bit))

;; dw1000__register_types__tx_time_type__tx_stamp__last__bit_axiom
  (assert
  (< dw1000__register_types__tx_time_type__tx_stamp__first__bit dw1000__register_types__tx_time_type__tx_stamp__last__bit))

;; dw1000__register_types__tx_time_type__tx_stamp__position_axiom
  (assert (<= 0 dw1000__register_types__tx_time_type__tx_stamp__position))

(declare-fun dw1000__register_types__tx_time_type__tx_rawst__first__bit () Int)

(declare-fun dw1000__register_types__tx_time_type__tx_rawst__last__bit () Int)

(declare-fun dw1000__register_types__tx_time_type__tx_rawst__position () Int)

;; dw1000__register_types__tx_time_type__tx_rawst__first__bit_axiom
  (assert (<= 0 dw1000__register_types__tx_time_type__tx_rawst__first__bit))

;; dw1000__register_types__tx_time_type__tx_rawst__last__bit_axiom
  (assert
  (< dw1000__register_types__tx_time_type__tx_rawst__first__bit dw1000__register_types__tx_time_type__tx_rawst__last__bit))

;; dw1000__register_types__tx_time_type__tx_rawst__position_axiom
...
(declare-datatypes ()
((tx_time_type__ref (mk_tx_time_type__ref (tx_time_type__content us_rep)))))
(define-fun tx_time_type__ref___projection ((a tx_time_type__ref)) us_rep
  (tx_time_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_37__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_28__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_28__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2954 us_t1)
  (temp___is_init_2951 Bool) (temp___skip_constant_2952 Bool)
  (temp___do_toplevel_2953 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2952 true))
                                       (and (dynamic_property2 1 10
                                       (first3 temp___expr_2954)
                                       (last3 temp___expr_2954))
                                       (and (= (first3 temp___expr_2954) 1)
                                       (= (last3 temp___expr_2954) 10)))))
...
;; H
  (assert
  (and (dynamic_property2 1 10 (to_rep reg_bytes__first)
  (to_rep reg_bytes__last))
  (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 10))))
