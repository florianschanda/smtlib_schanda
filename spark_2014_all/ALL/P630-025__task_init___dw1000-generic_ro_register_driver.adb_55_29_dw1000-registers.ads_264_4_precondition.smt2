...
(define-fun us_split_fields__ref___19__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___19__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun register_type__ref___37__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___28__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___28__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2976 us_t1)
  (temp___is_init_2973 Bool) (temp___skip_constant_2974 Bool)
  (temp___do_toplevel_2975 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2974 true))
                                       (and (dynamic_property2 1 10
                                       (first3 temp___expr_2976)
                                       (last3 temp___expr_2976))
                                       (and (= (first3 temp___expr_2976) 1)
                                       (= (last3 temp___expr_2976) 10)))))
