...
;; H
  ...
  (= (rec__tree_model__path_type__k
     (us_split_fields1
     (select (model__
             (rec__red_black_trees__rbt__struct (us_split_fields9 c99b))) i))) true)
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c99b) i)))) n6))
  (not (= i y2)))
...
;; H
  ...
  (< (to_rep
     (rec__red_black_trees__black_count__depth
     (us_split_fields11 (select (nb_blacks c99b) c101b)))) n6)
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11 (select (nb_blacks c99b) c101b)))) n6)
  (= (eq (select (nb_blacks c100b) c101b) (select (nb_blacks c99b) c101b)) true)))
...
;; H
  ...
  (<= (to_rep
      (rec__red_black_trees__black_count__depth
      (us_split_fields11
      (select (nb_blacks c99b) (parent
                               (rec__red_black_trees__rbt__struct
                               (us_split_fields9 c100b)) y2))))) n6))
...
;; WP_parameter_def
 ;; File "red_black_trees.ads", line 59, characters 0-0
  (not
  (= (eq
     (select (nb_blacks c100b) (parent
                               (rec__red_black_trees__rbt__struct
                               (us_split_fields9 c100b)) y2))
     (select (nb_blacks c99b) (parent
                              (rec__red_black_trees__rbt__struct
                              (us_split_fields9 c100b)) y2))) true)))
(check-sat)
