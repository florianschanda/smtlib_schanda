...
;; H
  ...
  (= (bool_eq3 temp___4921 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (ite (= (= (length
             (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true)
  (= (bool_eq3 temp___4931 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (= (bool_eq3 temp___4941 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (ite (= (ite (= (bool_eq3 (mk___rep1 c__split_fields3) no_element) false) (= 
          (get
          (positions
          (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
          (mk___rep1 c__split_fields3)) 1) true) true)
  (= (bool_eq3 temp___4951 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not
  (not (= (is_empty1 (mk___rep l__split_discrs l__split_fields2)) true))))
(check-sat)
