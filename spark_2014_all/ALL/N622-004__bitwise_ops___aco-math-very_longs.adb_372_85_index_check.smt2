...
(declare-datatypes ((tS121bP1__ref 0))
(((mk_tS121bP1__ref (tS121bP1__content tdigit_index_typeB)))))
...
(((mk_s121b__ref (s121b__content us_t1)))))
...
(declare-datatypes ((t123b__ref 0))
(((mk_t123b__ref (t123b__content tdigit_index_typeB)))))
...
(((mk_t124b__ref (t124b__content us_t2)))))
...
(declare-const temp___1461 (Array Int octet))

(declare-const temp___14611 t2)

(declare-const temp___1462 (Array Int octet))

(declare-const temp___14621 t1)

(declare-const temp___1464 (Array Int octet))

(declare-const temp___14641 t1)
...
(declare-const temp___1466 digit_index_type)

(declare-const temp___14661 (Array Int octet))

(declare-const temp___14662 t)
...
;; H
  (assert (= temp___1461 temp___1462))

;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___14611)) (to_rep2 (last4 temp___14611)))
  temp___14621))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___14621)) (to_rep2 (last2 temp___14621)))
     (+ (- (to_rep2 (last2 temp___14621)) (to_rep2 (first2 temp___14621))) 1)
...
;; H
  (assert
  (= (mk___t1 temp___1464 temp___14641) (mk___t1 temp___1462 temp___14621)))

;; H
  (assert (= temp___1464 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___14641)) (to_rep2 (last2 temp___14641)))
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1466)))

;; H
  (assert (= temp___14661 o2))

;; H
  (assert (= temp___14662 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___14661 temp___14662))))
...
;; H
  ...
  (<= (to_rep2
      ...
      (rt
      (rec__aco__math__very_longs__very_long__long_digits
      result____split_fields3)))) temp___1480)
  (<= temp___1480 (to_rep2
                  (last
                  (rt
                  (rec__aco__math__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__aco__math__very_longs__very_long__long_digits
             result____split_fields3)) temp___1480) (select (elts
                                                            (rec__aco__math__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1480))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt
...
;; H
  (assert
  (and (= o9 (shift_right o8 (- 8 distance)))
