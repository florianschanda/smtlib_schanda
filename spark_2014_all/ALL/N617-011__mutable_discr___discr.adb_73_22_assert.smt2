...
(declare-fun usq_2 () us_rep)

(declare-fun o13 () us_rep)

(declare-fun o14 () us_split_fields)

(declare-fun temp___299 () us_rep1)
...
(declare-fun h__split_fields3 () us_split_fields)
...
;; WP_parameter_def
 ;; File "discr.adb", line 34, characters 0-0
  ...
  (= (to_rep
     (rec__discr__with_default__c
     (us_split_discrs1 (rec__discr__holder__content h__split_fields3))))
  c)))
(check-sat)
(exit)
