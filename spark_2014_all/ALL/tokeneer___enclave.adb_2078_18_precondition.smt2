...
(declare-fun theadmin__split_fields8 () privileget)

(declare-fun theadmin__split_fields9 () opandnullt)
...
;; H
  (assert (=> (= result3 true) (= o5 (ite (not (= o4 true)) true false))))
...
;; H
  (assert (=> (= result3 true) (= o2 (ite (= o1 3) true false))))
...
;; H
  (assert (=> (= result3 true) (= o6 (ite (= o3 true) o2 false))))

;; H
  (assert (=> (= result3 true) (= o7 (ite (= o6 false) o5 true))))

;; H
  (assert (=> (not (= result3 true)) (= o7 (of_int 1))))
