...
(declare-fun private_a__optional_stack__exists__first__bit () Int)

(declare-fun private_a__optional_stack__exists__last__bit () Int)

(declare-fun private_a__optional_stack__exists__position () Int)
...
(declare-fun private_a__optional_stack__the_stack__first__bit () Int)

(declare-fun private_a__optional_stack__the_stack__last__bit () Int)

(declare-fun private_a__optional_stack__the_stack__position () Int)
...
(declare-fun s__split_fields1 () length_t)
...
(declare-fun temp___2411 () length_t)

(declare-fun temp___2412 () (Array Int integer))
