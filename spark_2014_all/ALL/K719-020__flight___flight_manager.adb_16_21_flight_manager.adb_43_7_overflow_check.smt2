...
(declare-fun temp___151 () integer)

(declare-fun temp___1511 () integer)

(declare-fun o18 () Int)

(declare-fun flight_manager__set_engine_speed__C7b__assume () Int)
...
;; H
  (assert (=> (< target_x position_x) (= result result____split_fields8)))
...
;; H
  (assert
  (=> (not (< target_x position_x))
  (=> (< position_x target_x) (= result1 result____split_fields8))))
