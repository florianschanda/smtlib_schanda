...
(declare-fun aco__math__very_longs__modmultiply__result () digit_index_type)

(declare-fun aco__math__very_longs__modmultiply__result1 () (Array Int octet))

(declare-fun aco__math__very_longs__modmultiply__result2 () t)
...
(declare-fun temp___1219 () (_ BitVec 16))

(declare-fun temp___1218 () (_ BitVec 16))

(declare-fun temp___1217 () (_ BitVec 16))

(declare-fun temp___1216 () (_ BitVec 16))

(declare-fun temp___1213 () us_rep1)

(declare-fun temp___1212 () (_ BitVec 16))

(declare-fun temp___1209 () (_ BitVec 16))

(declare-fun temp___1208 () (_ BitVec 16))

(declare-fun temp___1207 () (_ BitVec 16))

(declare-fun temp___1206 () (_ BitVec 16))

(declare-fun temp___1203 () us_rep1)

(declare-fun temp___1202 () (_ BitVec 16))
...
(declare-fun temp___1201 () us_rep1)
...
(declare-fun aco__math__very_longs__modmultiply__result3 () us_rep)

(declare-fun aco__math__very_longs__modmultiply__result4 () very_long__ref)

(declare-fun aco__math__very_longs__modmultiply__result5 () us_rep)
...
(declare-fun aco__math__very_longs__modmultiply__result6 () very_long__ref)
...
(declare-fun aco__math__very_longs__modmultiply__result7 () us_rep)
...
;; H
  ...
  (<= j1 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 r)))))))
  (= temp___1213 (mk___rep1 result____split_discrs result____split_fields2))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (= temp___1203 (mk___rep1 result____split_discrs result____split_fields3)))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (=> (= result6 true) (and (= o18 (+ i4 j2)) (in_range2 (+ i4 j2)))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (=> (= result6 true) (= temp___1197 (- o18 1))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (=> (= result6 true) (and (= o23 (+ i4 j2)) (in_range2 (+ i4 j2)))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (rec__aco__math__very_longs__very_long__long_digits
         (us_split_fields1 l)))))))
  (=> (= result6 true) (= temp___1199 (- o23 1))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (us_split_fields1 l)))))))
  (=> (= result6 true)
  (= temp___1201 (mk___rep1 result____split_discrs o29))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (us_split_fields1 l)))))))
  (=> (= result6 true)
  (= result____split_fields5 (us_split_fields3 temp___1201))))))
...
;; H
  ...
  (<= i3 (to_rep2
         ...
         (us_split_fields1 l)))))))
  (=> (= result6 true)
  (= result____split_discrs (us_split_discrs2 temp___1201))))))
...
;; H
  (assert
  (= aco__math__very_longs__modmultiply__result4 (mk_very_long__ref
                                                 aco__math__very_longs__modmultiply__result3)))

;; H
  (assert
  (= aco__math__very_longs__modmultiply__result5 aco__math__very_longs__modmultiply__result3))

;; H
  (assert
  (= result11 (mk_very_long__ref
              (mk___rep
              (mk___split_discrs aco__math__very_longs__modmultiply__result)
              (mk___split_fields
              (mk___t aco__math__very_longs__modmultiply__result1
              aco__math__very_longs__modmultiply__result2))))))

;; H
  (assert
  (= aco__math__very_longs__modmultiply__result3 (to_base
                                                 (mk___rep1
...
;; H
  (assert
  (= aco__math__very_longs__modmultiply__result6 aco__math__very_longs__modmultiply__result4))
...
;; H
  (assert
  (= aco__math__very_longs__modmultiply__result7 aco__math__very_longs__modmultiply__result5))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs result12)
     (mk___split_fields (mk___t result13 result14))) (very_long__content
                                                     aco__math__very_longs__modmultiply__result6)))
...
;; WP_parameter_def
 ;; File "aco-math-very_longs.ads", line 108, characters 0-0
  ...
  (= (to_rep1
     (rec__aco__math__very_longs__very_long__octet_length
     (us_split_discrs1
     (very_long__content aco__math__very_longs__modmultiply__result6))))
  (to_rep1
  (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(check-sat)
(exit)
