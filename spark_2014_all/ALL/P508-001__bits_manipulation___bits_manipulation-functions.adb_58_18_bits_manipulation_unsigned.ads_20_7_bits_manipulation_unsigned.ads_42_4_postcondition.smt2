...
;; H
  (assert
  (= result1 bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result4))

(assert
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  (not
  (= bits_manipulation_unsigned__unsigned_8__functions__extract_bits_not_inline__result4 (bvand
