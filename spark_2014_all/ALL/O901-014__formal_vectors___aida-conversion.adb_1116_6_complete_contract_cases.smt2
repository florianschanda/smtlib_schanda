...
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1093, characters 0-0
  (not
  (<= 1 (+ (+ (+ (+ (+ (+ (+ (+ (+ 0 (ite (= (= (length source) 1) true) 1 0))
  (ite (= (= (length source) 2) true) 1 0)) (ite (= (= (length source) 3) true)
                                            1 0)) (ite (= (= (length source) 4) true)
                                                  1 0)) (ite (= (= (length
                                                                   source) 5) true)
                                                        1 0)) (ite (= (=
                                                              (length
                                                              ...
                                                              1 0)) (ite (= (=
                                                                    ...
                                                                    source) 7) true)
                                                                    1 0))
  (ite (= (= (length source) 8) true) 1 0)) (ite (= (= (length source) 9) true)
                                            1 0)))))
(check-sat)
(exit)
