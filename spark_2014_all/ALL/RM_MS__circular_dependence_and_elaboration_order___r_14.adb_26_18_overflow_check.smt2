...
;; H
  (assert
  (=> (< 0 global_var)
  (and (= o (- 2147483647 global_var)) (in_range1 (- 2147483647 global_var)))))

;; H
  (assert (=> (< 0 global_var) (= result (ite (<= r_s1 o) true false))))

;; H
  (assert (=> (not (< 0 global_var)) (= result false)))
