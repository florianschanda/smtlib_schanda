...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 (- o2 1)))
  (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) k1)))))
  (and
  (forall ((k1 Int))
  (=> (and (<= (+ o2 1) k1) (<= k1 (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k1)) (to_rep (select (elts o3) (- k1 1))))))
  (forall ((k1 Int))
  (=> (and (<= o2 k1) (<= k1 (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o3) k1))))))))))))
