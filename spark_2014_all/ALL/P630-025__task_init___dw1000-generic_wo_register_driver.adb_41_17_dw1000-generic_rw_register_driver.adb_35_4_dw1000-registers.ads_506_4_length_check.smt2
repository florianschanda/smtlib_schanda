...
(define-fun register_type__ref___169__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___119__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___119__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6071 us_t1)
  (temp___is_init_6068 Bool) (temp___skip_constant_6069 Bool)
  (temp___do_toplevel_6070 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6069 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_6071)
                                       (last3 temp___expr_6071))
                                       (and (= (first3 temp___expr_6071) 1)
                                       (= (last3 temp___expr_6071) 1)))))
...
(define-fun target__ref___51__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___51__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_6087 us_t2)
  (temp___is_init_6084 Bool) (temp___skip_constant_6085 Bool)
  (temp___do_toplevel_6086 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6085 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_6087)
                                       (last5 temp___expr_6087))
                                       (and (= (first5 temp___expr_6087) 1)
                                       (= (last5 temp___expr_6087) 1)))))
...
;; H
  (assert
  (and (= temp___80832 (register_to_bytes reg)) (dynamic_invariant1
  temp___80832 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80831)) (to_rep (last4 temp___80831)))
     (+ (- (to_rep (last4 temp___80831)) (to_rep (first4 temp___80831))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80831)) (to_rep (last4 temp___80831)))
  temp___80841))
...
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first2 temp___80841)) (to_rep (last2 temp___80841)))
     (+ (- (to_rep (last2 temp___80841)) (to_rep (first2 temp___80841))) 1)
