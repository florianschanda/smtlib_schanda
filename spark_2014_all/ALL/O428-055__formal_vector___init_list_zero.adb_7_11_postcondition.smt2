...
;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___531))
  (= l__split_fields temp___5311))))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields11))
           (mk___rep1 cu__split_fields10)) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields11)) i) 0)))))
...
;; H
  ...
  (= (get
     ...
     (mk___rep l__split_discrs
     loop_types__lists__replace_element__container__fields1))
     (mk___rep1 cu__split_fields10))) 0))
...
;; H
  (assert
  (=> (= result1 true)
  (= l__split_fields10 loop_types__lists__replace_element__container__fields1)))
...
;; H
  ...
  (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields10) no_element) false) (=
          ...
          (mk___rep1 cu__split_fields10)) (length2
                                          (mk___rep l__split_discrs
...
;; H
  ...
  (=> (= result1 true)
  (and
  (= o (has_key (positions (mk___rep l__split_discrs l__split_fields10))
...
;; H
  (assert
  (=> (= result1 true) (= result3 (ite (not (= o true)) true false))))
...
(define-fun temp___540 () us_rep2 (model__
                                  (mk___rep l__split_discrs
...
;; WP_parameter_def
 ;; File "init_list_zero.adb", line 5, characters 0-0
  (not (= (get temp___540 temp___539) 0)))
(check-sat)
(exit)
