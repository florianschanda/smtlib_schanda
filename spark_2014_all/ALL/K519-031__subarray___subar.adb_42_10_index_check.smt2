...
(((mk_one_twenty__ref (one_twenty__content one_twenty)))))
...
(declare-datatypes ((tsmaller_localP1__ref 0))
...
(((mk_smaller_local__ref (smaller_local__content us_t)))))
...
(((mk_t6b__ref (t6b__content tone_twentyB)))))
