...
;; H
  (assert
  (and (= o (div1 RNE1 (of_int RNE1 left) (of_int RNE1 right))) (tqtisFinite
  (div1 RNE1 (of_int RNE1 left) (of_int RNE1 right)))))

;; H
  (assert (= o1 (roundToIntegral RTN1 o)))

;; H
  (assert (= o2 (to_int1 RNA1 o1)))
