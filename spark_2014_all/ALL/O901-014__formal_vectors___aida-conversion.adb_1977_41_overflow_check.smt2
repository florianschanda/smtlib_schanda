...
(define-fun tint_arrayD1__ref___20__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___20__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t661b__ref 0))
(((mk_t661b__ref (t661b__content integer)))))
...
(declare-datatypes ((t662b__ref 0))
(((mk_t662b__ref (t662b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___29__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___29__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t665b__ref 0))
(((mk_t665b__ref (t665b__content integer)))))
...
(declare-datatypes ((t666b__ref 0))
(((mk_t666b__ref (t666b__content us_t4)))))
...
(declare-datatypes ((t667b__ref 0))
(((mk_t667b__ref (t667b__content integer)))))
...
(define-fun tint_arrayB__ref___20__projection ((a tint_arrayB__ref)) us_t5
...
;; def_axiom
  (assert
  (forall ((temp___2216 Int) (temp___2217 Int) (temp___2218 Int)
  (temp___2219 Int) (temp___2220 Int) (temp___2221 Int) (temp___2222 Int)
  (temp___2223 Int) (temp___2224 Int) (temp___2225 Int))
  (let ((temp___2215 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def
                     temp___2216 temp___2217 temp___2218 temp___2219
                     temp___2220 temp___2221 temp___2222 temp___2223
                     temp___2224 temp___2225)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 8)
  temp___2224 temp___2225)
  (and (= (first5 temp___2215) temp___2224)
  (= (last5 temp___2215) temp___2225)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2216))
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2217)))
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 2)) (of_rep1
                                                                  temp___2218)))
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 3)) (of_rep1
                                                                  temp___2219)))
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 4)) (of_rep1
                                                                  temp___2220)))
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 5)) (of_rep1
                                                                  temp___2221)))
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 6)) (of_rep1
                                                                  temp___2222)))
  (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 7)) (of_rep1
                                                                  temp___2223)))))))
...
(define-fun tnumber_array_typeB__ref___29__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; def_axiom
  ...
  (let ((temp___2230 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def
                     temp___2231 temp___2232 temp___2233)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 8)
  temp___2232 temp___2233)
  (and (= (first9 temp___2230) temp___2232)
  (= (last9 temp___2230) temp___2233)))
...
(define-fun dynamic_invariant4 ((temp___expr_707 us_t3)
  (temp___is_init_704 Bool) (temp___skip_constant_705 Bool)
  (temp___do_toplevel_706 Bool)) Bool (=>
                                      (not (= temp___skip_constant_705 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 8)
                                      (first7 temp___expr_707)
                                      (last7 temp___expr_707))
                                      (and
                                      (= (first7 temp___expr_707) (+
                                      (first1 source) 1))
                                      (= (last7 temp___expr_707) (+ (first1
                                                                    source) 8))))))
...
;; H
  ...
  (<= index7 (+ (to_rep1 (first (rt source))) 8)))
...
;; H
  (assert
  (= (mk___t2 temp___2228 temp___22281) (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def
                                        9 9 9 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___22281)) (to_rep1 (last4 temp___22281)))
     (+ (- (to_rep1 (last4 temp___22281)) (to_rep1 (first4 temp___22281))) 1)
...
;; H
  (assert
  (= (slide1 temp___2228 (to_rep1 (first4 temp___22281))
...
;; H
  (assert
  (= (mk___t4 temp___2236 temp___22361) (aida__conversion__calculate_negative_target_length_9__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___22361)) (to_rep1 (last8 temp___22361)))
     (+ (- (to_rep1 (last8 temp___22361)) (to_rep1 (first8 temp___22361))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 8))
        (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2236 (to_rep1 (first8 temp___22361))
...
;; H
  (assert
  (and (= temp___2242 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2243 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))
...
;; H
  (assert
  (and (= temp___2244 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))
...
;; H
  (assert
  (and (= temp___2245 (+ (to_rep1 (first (rt source))) 7)) (in_range1
...
;; H
  (assert
  (and (= temp___2246 (+ (to_rep1 (first (rt source))) 6)) (in_range1
...
;; H
  (assert
  (and (= temp___2247 (+ (to_rep1 (first (rt source))) 5)) (in_range1
...
;; H
  (assert
  (and (= temp___2248 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2248)
  (<= temp___2248 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___2249 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___2249)
  (<= temp___2249 (to_rep1 n__last))))
