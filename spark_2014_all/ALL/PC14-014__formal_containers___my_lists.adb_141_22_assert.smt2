...
(declare-fun my_lists__s__merge__source__fields1 () us_split_fields)

(declare-fun my_lists__s__merge__target__fields1 () us_split_fields)
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1)) (+ 
  (length (mk___rep l__split_discrs l__split_fields6)) (length
                                                       (mk___rep
                                                       k__split_discrs
                                                       k__split_fields6))))
  (= (length (mk___rep k__split_discrs my_lists__s__merge__source__fields1)) 0))
  (=>
  (and
  (= (m_elements_sorted
  ...
  (= (m_elements_sorted
     (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true)))
  (= (m_elements_included
     (model__ (mk___rep l__split_discrs l__split_fields6)) 1
     (length (mk___rep l__split_discrs l__split_fields6))
     (model__ (mk___rep l__split_discrs my_lists__s__merge__target__fields1))
     1
     (length (mk___rep l__split_discrs my_lists__s__merge__target__fields1))) true))
  (= (m_elements_included
