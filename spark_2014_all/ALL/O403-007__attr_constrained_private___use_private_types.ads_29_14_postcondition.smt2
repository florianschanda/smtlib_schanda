...
;; WP_parameter_def
 ;; File "use_private_types.ads", line 11, characters 0-0
  ...
  (and
  (and (= (to_rep private_types__private_reinit__s__discrs) 0)
  (and
  (and
  (and (= result s__split_fields)
  (and (= result1 s__split_fields1) (= result2 s__split_fields2)))
  (and (= s__split_fields3 private_types__private_reinit__s__discrs)
  (and (= s__split_fields4 private_types__private_reinit__s__fields)
  (= s__split_fields2 s__split_fields5))))
  (=> (= s__split_fields2 true)
  (= s__split_fields private_types__private_reinit__s__discrs))))
  (and
  (and (= s__split_fields6 s__split_fields3)
  (and (= s__split_fields7 s__split_fields4)
  (= s__split_fields8 s__split_fields5)))
