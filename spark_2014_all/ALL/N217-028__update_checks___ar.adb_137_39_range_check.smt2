...
(declare-fun temp___285 ((Array Int et1) Int Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___287 (Array Int et1)))
  (forall ((temp___288 Int) (temp___289 Int) (temp___290 Int))
  (let ((temp___286 (temp___285 temp___287 temp___288 temp___289 temp___290)))
  (forall ((temp___291 Int))
  (ite (and (<= temp___288 temp___291) (<= temp___291 temp___289))
  (= (select temp___286 temp___291) (of_rep temp___290))
  (= (select temp___286 temp___291) (select temp___287 temp___291))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.adb", line 125, characters 0-0
  (not (in_range1 (- e 1))))
(check-sat)
(exit)
