...
(declare-fun dummy1 () tmy_arrayD1)
...
;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (and (<= 1 j) (<= j 10))))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= o j)))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= o1 (select a o))))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= o2 (to_rep o1))))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= v1 result1)))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= v2 o2)))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= (to_rep o3) 0)))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (and (<= 1 j) (<= j 10))))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= o4 j)))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= o5 (store a o4 o3))))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= result2 a)))

;; H
  (assert (=> (and (<= 1 j) (<= j 10)) (= a2 o5)))

;; H
  (assert (=> (not (and (<= 1 j) (<= j 10))) (= v2 v1)))

;; H
  (assert (=> (not (and (<= 1 j) (<= j 10))) (= a2 a)))

;; H
  (assert (=> (not (and (<= 1 j) (<= j 10))) (= v2 v1)))

;; H
  (assert (=> (not (and (<= 1 j) (<= j 10))) (= a2 a1)))
...
;; H
  (assert
  (=> (and (<= 1 j) (<= j 10))
  (and (= v3 (to_rep (select a j))) (= (to_rep (select a3 j)) 0))))

;; H
  (assert (not (and (<= 1 j) (<= j 10))))

(assert
;; WP_parameter_def
 ;; File "example.ads", line 6, characters 0-0
  (not (= (bool_eq a3 1 10 a 1 10) true)))
(check-sat)
(exit)
