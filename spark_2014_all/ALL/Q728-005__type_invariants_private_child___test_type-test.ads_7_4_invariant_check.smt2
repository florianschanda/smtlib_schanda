...
;; decr_int__post_axiom
  ...
  (forall ((x us_rep))
  (! (=>
     (and (type_invariant x)
     (< (- 2147483648) (to_rep (rec__test_type__t__f (us_split_fields1 x)))))
     (type_invariant (decr_int x))) :pattern ((decr_int x)) )))
...
(declare-fun test_type__test__x__assume () integer)

(declare-fun test_type__test__y__assume () integer)

(define-fun test_type__test__y__assume1 () us_rep (mk___rep
                                                  (mk___split_fields
                                                  test_type__test__y__assume)))
...
;; H
  (assert
  (and (= test_type__test__y__assume1 (decr_int x))
  (and (in_range1 (to_rep test_type__test__y__assume))
...
;; WP_parameter_def
 ;; File "test_type-test.ads", line 4, characters 0-0
  (not (in_range1 (to_rep (rec__test_type__t__f (us_split_fields1 y))))))
(check-sat)
(exit)
