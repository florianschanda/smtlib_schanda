...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 j2))
  (= (to_rep (rec__frame__rec__c1 (us_split_fields1 (select a2 k1))))
  (to_rep (rec__frame__rec__c2 (us_split_fields1 (select a k1))))))))
...
;; H
  ...
  (ite (< j2 temp___191) (= (select a2 temp___191) (select a temp___191))
  (= (rec__frame__rec__c2 (us_split_fields1 (select a2 temp___191)))
  (rec__frame__rec__c2 (us_split_fields1 (select a temp___191))))))))
  (and (<= 1 j2) (<= j2 10))))
