...
(declare-datatypes ((a__ref 0)) (((mk_a__ref (a__content integer)))))
...
(declare-datatypes ((b__ref 0)) (((mk_b__ref (b__content integer)))))
...
(declare-datatypes ((e__ref 0)) (((mk_e__ref (e__content integer)))))
...
(declare-datatypes ((f__ref 0)) (((mk_f__ref (f__content integer)))))
...
(declare-datatypes ((g__ref 0)) (((mk_g__ref (g__content integer)))))
