...
(define-fun dynamic_invariant ((temp___expr_368 us_t)
...
(declare-fun user_eq4 (skein_512_state_bytes_index
  skein_512_state_bytes_index) Bool)

(declare-fun dummy4 () skein_512_state_bytes_index)
...
(define-fun dynamic_invariant1 ((temp___expr_581 (Array (_ BitVec 64) byte))
  (temp___is_init_578 Bool) (temp___skip_constant_579 Bool)
  (temp___do_toplevel_580 Bool)) Bool (=> (= temp___do_toplevel_580 true)
                                      (=> (= temp___is_init_578 true)
                                      (bvult (last1
                                             (of_array temp___expr_581
                                             ((_ int2bv 64) 0)
                                             ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))))

(define-fun dynamic_predicate1 ((temp___589 (Array (_ BitVec 64) byte))) Bool (bvult
  (last1 (of_array temp___589 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))
...
;; range_int_axiom
  (assert
  (forall ((x u64)) (! (uint_in_range (to_int6 x)) :pattern ((to_int6 x)) )))
...
(declare-fun dummy5 () (Array (_ BitVec 64) u64))
...
(declare-fun user_eq5 ((Array (_ BitVec 64) u64)
  (Array (_ BitVec 64) u64)) Bool)

(declare-fun dummy6 () (Array (_ BitVec 64) byte))
...
;; object__alignment_axiom
  (assert
  (forall ((a (Array (_ BitVec 64) byte))) (<= 0 (object__alignment2 a))))

(declare-fun user_eq6 ((Array (_ BitVec 64) byte)
...
(declare-fun attr__ATTRIBUTE_MODULUS5 () (_ BitVec 16))
...
(define-fun dynamic_invariant2 ((temp___expr_652 us_rep2)
...
(define-fun dynamic_invariant3 ((temp___expr_308 (_ BitVec 64))
...
(declare-fun user_eq16 (initialized_hash_bit_length
  initialized_hash_bit_length) Bool)

(declare-fun dummy16 () initialized_hash_bit_length)
...
(declare-fun user_eq17 (skein_512_block_bytes_count
  skein_512_block_bytes_count) Bool)

(declare-fun dummy17 () skein_512_block_bytes_count)
...
(define-fun dynamic_invariant8 ((temp___expr_526 (_ BitVec 64))
...
(define-fun dynamic_invariant9 ((temp___expr_547 (_ BitVec 64))
...
(define-fun dynamic_invariant10 ((temp___expr_553 (_ BitVec 64))
  ...
  (temp___do_toplevel_552 Bool)) Bool (=>
                                      ...
                                      (in_range5 temp___expr_553)))

(define-fun dynamic_invariant11 ((temp___expr_559 (Array (_ BitVec 64) byte))
...
;; byte_count_of__post_axiom
  (assert
  (forall ((ctx us_rep2))
  (! (=> (dynamic_invariant2 ctx true true true) (dynamic_invariant3
...
(define-fun dynamic_invariant13 ((temp___expr_615 (_ BitVec 8))
...
(define-fun dynamic_invariant14 ((temp___expr_609 (_ BitVec 8))
...
(define-fun dynamic_invariant15 ((temp___expr_266 (_ BitVec 64))
  (temp___is_init_263 Bool) (temp___skip_constant_264 Bool)
  (temp___do_toplevel_265 Bool)) Bool true)

(declare-fun result__ () (Array (_ BitVec 64) byte))

(declare-fun o () unsigned_64)
...
(declare-fun ctx__split_fields12 () u64)

(declare-fun ctx__split_fields13 () u32)

(declare-fun ctx__split_fields14 () u16)

(declare-fun ctx__split_fields15 () u7)

(declare-fun ctx__split_fields16 () Bool)

(declare-fun ctx__split_fields17 () u6)

(declare-fun ctx__split_fields18 () Bool)

(declare-fun ctx__split_fields19 () Bool)

(declare-fun ctx__split_fields20 () hash_bit_length)

(declare-fun ctx__split_fields21 () u64)

(declare-fun ctx__split_fields22 () (Array (_ BitVec 64) u64))

(declare-fun ctx__split_fields23 () (Array (_ BitVec 64) byte))

(declare-fun skein__skein_512_final__hash () (Array (_ BitVec 64) byte))

(declare-fun result () (Array (_ BitVec 64) byte))

(declare-fun result__1 () (Array (_ BitVec 64) byte))

(define-fun ctx__split_fields24 () us_split_fields4 (mk___split_fields2
                                                    (mk___rep1
                                                    (mk___split_fields1
                                                    (mk___rep
                                                    (mk___split_fields
...
(define-fun ctx__split_fields25 () us_split_fields4 (mk___split_fields2
                                                    (mk___rep1
                                                    (mk___split_fields1
                                                    (mk___rep
                                                    (mk___split_fields
...
;; H
  (assert
  (and
  (and (= (to_rep (first (rt data))) ((_ int2bv 64) 0))
  (= (add_in_range (to_rep (last (rt data))) ((_ int2bv 64) 64)) true))
  (bvult (bvadd (to_rep (last (rt data))) ((_ int2bv 64) 64)) ((_ int2bv 64) 18446744073709551615))))
...
;; H
  ...
  (and
  (and
  (and (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields25)))
  (= (hash_bit_len_of (mk___rep2 ctx__split_fields25)) ((_ int2bv 64) 512)))
  (= (byte_count_of (mk___rep2 ctx__split_fields25)) ((_ int2bv 64) 0)))
  (in_range7 (byte_count_of (mk___rep2 ctx__split_fields25))))
...
;; H
  ...
  (and
  (and
  (and (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields24)))
  (= (hash_bit_len_of (mk___rep2 ctx__split_fields24)) (hash_bit_len_of
                                                       (mk___rep2
                                                       ctx__split_fields25))))
  (in_range7 (byte_count_of (mk___rep2 ctx__split_fields24))))
  (bvult (to_rep (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615))))
...
;; H
  (assert
  (= result__1 (slide skein__skein_512_final__hash
               (to_rep (first (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63))))
               ((_ int2bv 64) 0))))

(assert
;; WP_parameter_def
 ;; File "skein.ads", line 110, characters 0-0
  (not (dynamic_predicate1 result__1)))
(check-sat)
(exit)
