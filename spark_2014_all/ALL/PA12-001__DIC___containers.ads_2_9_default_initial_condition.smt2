...
(define-fun us_split_fields_L__projection ((a us_split_fields)) natural
...
(define-fun dynamic_invariant1 ((temp___expr_141 us_rep)
  (temp___is_init_138 Bool) (temp___skip_constant_139 Bool)
  (temp___do_toplevel_140 Bool)) Bool (let ((temp___142 (rec__containers__container__c
                                                        (us_split_discrs1
                                                        temp___expr_141))))
                                      ...
                                      (first1
                                      (rec__containers__container__v
                                      (us_split_fields1 temp___expr_141)))
                                      (last1
                                      (rec__containers__container__v
                                      (us_split_fields1 temp___expr_141))))
                                      (and
                                      (= (first1
                                         (rec__containers__container__v
                                         (us_split_fields1 temp___expr_141))) 1)
                                      (= (last1
                                         (rec__containers__container__v
                                         (us_split_fields1 temp___expr_141)))
                                      (to_rep temp___142))))))
...
;; length__post_axiom
  (assert
  (forall ((x us_rep))
  (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant (length1 x)
     true false true)) :pattern ((length1 x)) )))
...
;; length__def_axiom
  ...
  (! (=> (dynamic_invariant1 x true true true)
     (= (length1 x) (to_rep
                    (rec__containers__container__l (us_split_fields1 x))))) :pattern (
  (length1 x)) )))
...
(declare-const temp___149 natural)

(declare-const temp___151 natural)

(declare-const temp___1511 natural)

(declare-const temp___1512 (Array Int natural))

(declare-const temp___1513 t)

(define-fun temp___1514 () us_rep (mk___rep (mk___split_discrs temp___151)
                                  (mk___split_fields temp___1511
                                  (mk___t temp___1512 temp___1513))))

;; H
  (assert (in_range temp___150))

;; H
  (assert (= temp___150 (to_rep temp___149)))

;; H
  (assert
  (and (dynamic_invariant1 temp___1514 true false true)
  (= (to_rep temp___1511) 0)))

(assert
;; WP_parameter_def
 ;; File "containers.ads", line 13, characters 0-0
  (not (= (length1 temp___1514) 0)))
(check-sat)
(exit)
