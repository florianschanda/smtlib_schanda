...
(define-fun register_type__ref_129__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_91__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_91__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5162 us_t1)
  (temp___is_init_5159 Bool) (temp___skip_constant_5160 Bool)
  (temp___do_toplevel_5161 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5160 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_5162)
                                       (last3 temp___expr_5162))
                                       (and (= (first3 temp___expr_5162) 1)
                                       (= (last3 temp___expr_5162) 1)))))
