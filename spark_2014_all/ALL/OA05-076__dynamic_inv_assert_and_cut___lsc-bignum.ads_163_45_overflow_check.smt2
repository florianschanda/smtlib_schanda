...
;; H
  (assert (= o25 (+ b_first o24)))

;; H
  (assert (and (= o26 o25) (in_range1 o25)))

;; H
  (assert (= o27 (ite (<= o26 (to_rep (last (rt b)))) true false)))
...
;; H
  (assert (= o28 (ite (<= (to_rep (first (rt b))) o23) true false)))

;; H
  (assert (= result (ite (= o28 true) o27 false)))
...
;; H
  (assert (= o17 (+ c_first o16)))

;; H
  (assert (and (= o18 o17) (in_range1 o17)))

;; H
  (assert (= o19 (ite (<= o18 (to_rep (last (rt c)))) true false)))
...
;; H
  (assert (= o20 (ite (<= (to_rep (first (rt c))) o15) true false)))

;; H
  (assert (= result1 (ite (= o20 true) o19 false)))
...
;; H
  (assert (= o11 (ite (<= o10 (to_rep (last (rt m)))) true false)))
...
;; H
  (assert (= o12 (ite (<= (to_rep (first (rt m))) o7) true false)))
