...
(define-fun us_rep_10__projection ((a us_rep)) us_split_discrs (us_split_discrs1
                                                               a))
...
(define-fun map__ref_2__projection ((a map__ref1)) us_rep (map__content1 a))

(declare-datatypes ()
((us_split_fields2
 (mk___split_fields1
 (rec__partition_refinement__inverse_sets__cursor__node count_type)))))
(define-fun us_split_fields_Node2__projection ((a us_split_fields2)) count_type
...
(define-fun cursor__ref_2__projection ((a cursor__ref)) us_rep1 (cursor__content
                                                                a))
...
(define-fun map__ref_4__projection ((a map__ref2)) us_rep2 (map__content2 a))

(declare-datatypes ()
((key_type__ref (mk_key_type__ref (key_type__content us_rep1)))))
(define-fun key_type__ref_4__projection ((a key_type__ref)) us_rep1 (key_type__content
                                                                    a))
...
(define-fun dynamic_invariant2 ((temp___expr_497 Int)
...
(define-fun map__ref_3__projection ((a map__ref3)) us_rep4 (map__content3 a))
...
;; element__2__post__dispatch_axiom
  ...
  (forall ((container us_rep))
  (! (=> (dynamic_invariant2 key2 true true true) (dynamic_invariant3
...
(declare-datatypes ()
((inverse_set__ref (mk_inverse_set__ref (inverse_set__content us_rep)))))
...
(define-fun us_split_fields_First__projection ((a us_split_fields4)) index
  (rec__partition_refinement__interval__first a))

(define-fun us_split_fields_Last__projection ((a us_split_fields4)) index
  (rec__partition_refinement__interval__last a))

(define-fun us_split_fields_Count__projection ((a us_split_fields4)) index_count
...
(declare-datatypes ()
((us_rep5 (mk___rep2 (us_split_fields5 us_split_fields4)))))
(define-fun us_rep_13__projection ((a us_rep5)) us_split_fields4 (us_split_fields5
                                                                 a))
...
(declare-datatypes ()
((interval__ref (mk_interval__ref (interval__content us_rep5)))))
(define-fun interval__ref___projection ((a interval__ref)) us_rep5 (interval__content
                                                                   a))
...
(declare-fun dummy13 () partition_index)
...
(declare-datatypes ()
((element_type__ref1
 (mk_element_type__ref1 (element_type__content1 us_rep5)))))
(define-fun element_type__ref_8__projection ((a element_type__ref1)) us_rep5
...
(declare-fun dummy14 () capacity_range)
...
(define-fun us_split_discrs_3__projection ((a us_split_discrs2)) capacity_range
...
(define-fun us_split_fields_Vector__projection ((a us_split_fields6)) us_main_type4
...
(define-fun us_rep_14__projection ((a us_rep6)) us_split_discrs2 (us_split_discrs3
                                                                 a))

(define-fun us_rep_15__projection ((a us_rep6)) us_split_fields6 (us_split_fields7
                                                                 a))
...
(declare-datatypes ()
((vector__ref (mk_vector__ref (vector__content us_rep6)))))
(define-fun vector__ref___projection ((a vector__ref)) us_rep6 (vector__content
                                                               a))
...
(define-fun capacity ((container us_rep6)) Int (ite (= (of_int 1) true)
                                               (to_rep5
...
(define-fun dynamic_invariant4 ((temp___expr_733 Int)
...
(declare-datatypes ()
((element_type__ref2
 (mk_element_type__ref2 (element_type__content2 us_rep5)))))
(define-fun element_type__ref_9__projection ((a element_type__ref2)) us_rep5
...
(define-fun sequence__ref_3__projection ((a sequence__ref1)) us_rep7
...
(define-fun element2 ((container us_rep6)
  (index1 Int)) us_rep5 (get3 (model__1 container) index1))
...
(declare-datatypes ()
((partition__ref (mk_partition__ref (partition__content us_rep6)))))
(define-fun partition__ref___projection ((a partition__ref)) us_rep6
  (partition__content a))

(declare-datatypes ()
((map__ref4 (mk_map__ref4 (map__content4 (Array Int partition_index))))))
...
(define-fun bool_eq8 ((a (Array Int partition_index)) (a__first Int)
...
(declare-fun p__split_discrs () us_split_discrs2)
...
(declare-fun a_old () (Array Int positive))

(declare-fun attr__ATTRIBUTE_ADDRESS8 () Int)

(declare-fun a_update () (Array Int positive))

(declare-fun attr__ATTRIBUTE_ADDRESS9 () Int)

(declare-fun temp___135 ((Array Int positive) Int Int Int
  Int) (Array Int positive))

;; def_axiom
  (assert
  (forall ((temp___137 (Array Int positive)))
  (forall ((temp___138 Int) (temp___139 Int) (temp___140 Int)
  (temp___141 Int))
  (let ((temp___136 (temp___135 temp___137 temp___138 temp___139 temp___140
                    temp___141)))
  (forall ((temp___142 Int))
  (ite (= temp___142 temp___140)
  (= (select temp___136 temp___142) (of_rep temp___141))
  (ite (= temp___142 temp___138)
  (= (select temp___136 temp___142) (of_rep temp___139))
  (= (select temp___136 temp___142) (select temp___137 temp___142)))))))))

;; a_update__def_axiom
  (assert
  (= a_update (temp___135 a_old i (to_rep (select a_old j)) j
              (to_rep (select a_old i)))))
...
(define-fun dynamic_invariant6 ((temp___expr_706 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_152 Int)
...
;; length__post_axiom
  ...
  (! (let ((result (length3 container)))
     ...
     (dynamic_invariant7 result true false true))) :pattern ((length3
                                                             container)) )))
...
(define-fun k_bigger_than_range ((container us_rep3) (fst Int) (lst Int)
  (key2 Int)) Bool (ite (forall ((i1 Int))
                        (=> (and (<= fst i1) (<= i1 lst))
                        (< (get container i1) key2)))
                   true false))
...
(define-fun k_is_find ((container us_rep3) (key2 Int)
  (position Int)) Bool (and (ite (< 0 position)
                            ...
                            key2) (of_int 1)) (ite (< position (length
                                                               container))
                                              (k_smaller_than_range container
                                              (+ position 1)
                                              (length container) key2)
                                              (of_int 1))))
...
(define-fun default_initial_assumption ((temp___expr_573 us_rep3)
  (temp___skip_top_level_574 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_574 true))
                                         (= (length temp___expr_573) 0)))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant2 key2 true true true)
     ...
     (and
     (=> (< 0 result)
     (and (<= result (length container))
     (= (equivalent_keys key2 (get container result)) true)))
     (dynamic_invariant7 result true false true)))) :pattern ((find container
                                                              key2)) ))))
...
(define-fun default_initial_assumption1 ((temp___expr_542 us_rep4)
  (temp___skip_top_level_543 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_543 true))
                                         (and
                                         (= (is_empty temp___expr_542) true)
                                         (= (length5 temp___expr_542) 0))))
...
(declare-fun dummy18 () key_type1)

(declare-datatypes ()
((key_type__ref2 (mk_key_type__ref2 (key_type__content2 key_type1)))))
(define-fun key_type__ref_3__projection ((a key_type__ref2)) key_type1
...
;; keys__post_axiom
  ...
  (! (let ((result (keys container)))
     (and
     (and
     (and (= (length result) (length3 container))
     (forall ((temp___607 Int))
     (=>
     (and (in_range10 temp___607)
     (= (iter_has_element result temp___607) true))
     (= (has_key1 (model__ container) (get result temp___607)) true))))
     (forall ((key2 Int))
     ...
     (forall ((i1 Int))
     (=> (and (<= 1 i1) (<= i1 (length3 container)))
     (and (= (find result (get result i1)) i1)
     (= (k_is_find result (get result i1) i1) true)))))) :pattern ((keys
                                                                   container)) )))
...
(define-fun default_initial_assumption2 ((temp___expr_593 us_rep2)
  (temp___skip_top_level_594 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_594 true))
                                         (and
                                         (= (is_empty1 temp___expr_593) true)
                                         (= (length6 temp___expr_593) 0))))
...
;; positions__post_axiom
  ...
  (! (let ((result (positions container)))
     ...
     (and
     (and (<= 1 (get1 result i1)) (<= (get1 result i1) (length3 container)))
     (forall ((j1 us_rep1))
     (=> (= (has_key result j1) true)
     (=> (= (get1 result i1) (get1 result j1)) (= (bool_eq2 i1 j1) true))))))))) :pattern (
  (positions container)) )))
...
(define-fun dynamic_invariant8 ((temp___expr_529 Int)
...
;; has_key__post_axiom
  ...
  (forall ((key2 Int))
  (! (=> (dynamic_invariant8 key2 true true true)
     (=> (= (of_int 1) true)
     (=>
     (exists ((k Int))
...
(define-fun element_type__ref_5__projection ((a element_type__ref3)) element_type1
  (element_type__content3 a))

(define-fun dynamic_invariant9 ((temp___expr_535 Int)
  (temp___is_init_532 Bool) (temp___skip_constant_533 Bool)
  (temp___do_toplevel_534 Bool)) Bool (=>
                                      (or (= temp___is_init_532 true)
                                      (<= 0 5)) (in_range11 temp___expr_535)))
...
;; get__post_axiom
  ...
  (forall ((key2 Int))
  (! (=>
     (and (dynamic_invariant8 key2 true true true)
...
;; length__post_axiom
  (assert
  (forall ((container us_rep4)) (! (dynamic_invariant7 (length5 container)
...
;; elements_equal_except__post_axiom
  ...
  (forall ((left us_rep4) (right us_rep4))
  (forall ((new_key Int))
  (! (=> (dynamic_invariant8 new_key true true true)
...
(define-fun element_type__ref_6__projection ((a element_type__ref4)) element_type2
  (element_type__content4 a))

(define-fun dynamic_invariant11 ((temp___expr_560 Int)
...
(declare-fun dummy22 () element_type3)

(declare-datatypes ()
((element_type__ref5
 (mk_element_type__ref5 (element_type__content5 element_type3)))))
(define-fun element_type__ref_7__projection ((a element_type__ref5)) element_type3
  (element_type__content5 a))

(define-fun dynamic_invariant12 ((temp___expr_586 Int)
...
;; get__post_axiom
  ...
  (! (=> (= (has_key container key2) true)
     ...
     (dynamic_invariant12 result true false true)))) :pattern ((get1
                                                               container
                                                               key2)) ))))

;; length__post_axiom
  (assert
  (forall ((container us_rep2)) (! (dynamic_invariant7 (length6 container)
  true false true) :pattern ((length6 container)) )))
...
;; w_get__post_axiom
  ...
  (forall ((witness2 Int))
  (! (=>
     (and (dynamic_invariant7 witness2 true true true)
...
(define-fun dynamic_invariant13 ((temp___expr_727 Int)
...
(define-fun default_initial_assumption3 ((temp___expr_770 us_rep7)
...
;; model____post_axiom
  (assert
  (forall ((container us_rep6))
  (! (= (length2 (model__1 container)) (length1 container)) :pattern (
  (model__1 container)) )))
...
(declare-fun dummy24 () index_type)
...
(define-fun dynamic_invariant14 ((temp___expr_712 Int)
...
(define-fun extended_index__ref_4__projection ((a extended_index__ref2)) extended_index2
  (extended_index__content2 a))

(define-fun dynamic_invariant15 ((temp___expr_763 Int)
...
(declare-fun p__split_fields () us_main_type4)
...
(declare-fun partition_refinement__refine_one__i__assume () Int)

(declare-fun partition_refinement__refine_one__p_elem__assume () index)

(declare-fun partition_refinement__refine_one__p_elem__assume1 () index)

(declare-fun partition_refinement__refine_one__p_elem__assume2 () index_count)

(declare-fun partition_refinement__refine_one__j__assume () Int)

(declare-fun o () Int)

(declare-fun o1 () index_count)

(declare-fun o2 () us_split_fields4)

(declare-fun temp___1186 () us_rep5)
...
(declare-fun p_elem__split_fields3 () us_split_fields4)

(declare-fun a1 () (Array Int positive))

(declare-fun partition_refinement__inverse_sets__replace__container__fields () us_split_fields)

(declare-fun result1 () us_split_fields__ref)

(declare-fun d__split_fields1 () us_split_fields)

(declare-fun partition_refinement__inverse_sets__replace__container__fields1 () us_split_fields)

(declare-fun result2 () us_split_fields__ref)

(declare-fun d__split_fields2 () us_split_fields)

(declare-fun result3 () us_split_fields__ref2)

(declare-fun p_elem__split_fields4 () us_split_fields4)

(declare-fun partition_refinement__partitions__replace_element__container__fields () us_split_fields6)

(declare-fun result4 () us_split_fields__ref3)

(declare-fun p__split_fields1 () us_split_fields6)

(declare-fun a2 () map__ref)

(declare-fun d__split_fields3 () us_split_fields__ref)

(declare-fun p__split_fields2 () us_split_fields__ref3)

(declare-fun p_elem__split_fields5 () us_split_fields__ref2)

(declare-fun a3 () (Array Int positive))

(declare-fun d__split_fields4 () us_split_fields)

(declare-fun p__split_fields3 () us_split_fields6)

(declare-fun p_elem__split_fields6 () us_split_fields4)
...
(define-fun partition_refinement__refine_one__p_elem__assume3 () us_rep5
  (mk___rep2
  (mk___split_fields2 partition_refinement__refine_one__p_elem__assume
  partition_refinement__refine_one__p_elem__assume1
  partition_refinement__refine_one__p_elem__assume2)))
...
;; H
  ...
  (and
  (< (length1
     (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) 10000)
  (and
  (= (has_key1
  ...
  (<= 0 (to_rep4
        (select f (get2
                  ...
                  (mk___split_fields d__split_fields))) x_elem))))
  (<= (to_rep4
      (select f (get2
                (model__
                (mk___rep d__split_discrs
                (mk___split_fields d__split_fields))) x_elem))) (- (length1
                                                                   (mk___rep3
                                                                   p__split_discrs
                                                                   (mk___split_fields3
                                                                   p__split_fields))) 1)))
  ...
  (= (has_key
     (positions
     (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1) true)
  (= (to_rep
     (select a (element
               (mk___rep d__split_discrs (mk___split_fields d__split_fields))
               c1))) (key
                     (mk___rep d__split_discrs
                     (mk___split_fields d__split_fields)) c1)))))))))

;; H
  (assert
  (and
  (= partition_refinement__refine_one__i__assume (get2
                                                 (model__
                                                 (mk___rep d__split_discrs
                                                 (mk___split_fields
                                                 d__split_fields))) x_elem))
  (and (in_range6 partition_refinement__refine_one__i__assume)
  (= partition_refinement__refine_one__i__assume (get2
                                                 (model__
                                                 (mk___rep d__split_discrs
                                                 (mk___split_fields
...
;; H
  (assert
  (and
  (= partition_refinement__refine_one__p_elem__assume3 (get3
                                                       (model__1
                                                       (mk___rep3
                                                       p__split_discrs
                                                       (mk___split_fields3
                                                       p__split_fields)))
                                                       (to_rep4 (select f i))))
  (= (bool_eq6 partition_refinement__refine_one__p_elem__assume3
     (get3
     (model__1
     (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))
     (to_rep4 (select f i)))) true)))

;; H
  (assert
  (= result (mk___split_fields__ref2
            (mk___split_fields2 p_elem__split_fields p_elem__split_fields1
            p_elem__split_fields2))))

;; H
  (assert
  (= p_elem__split_fields3 (mk___split_fields2
...
;; H
  (assert (in_range3
  (+ (to_rep2
     (rec__partition_refinement__interval__first p_elem__split_fields3))
  (to_rep1
  (rec__partition_refinement__interval__count p_elem__split_fields3)))))

;; H
  (assert
  (and
  (= partition_refinement__refine_one__j__assume (+ (to_rep2
                                                    (rec__partition_refinement__interval__first
...
;; H
  (assert
  (= (temp___135 a_old i (to_rep (select a_old j)) j
     (to_rep (select a_old i))) a_update))

;; H
  (assert
  (= (bool_eq a1 0 5
     (temp___881 a i (to_rep (select a j)) j (to_rep (select a i))) 0 5) true))
...
;; H
  ...
  (and
  (not
  (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)
  (to_rep (select a1 i))))
  (not
  (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)
  (to_rep (select a1 j)))))
  (= (to_rep
     (select a1 (element
                (mk___rep d__split_discrs
                (mk___split_fields d__split_fields)) c1))) (key
                                                           (mk___rep
                                                           d__split_discrs
                                                           (mk___split_fields
                                                           d__split_fields))
...
;; H
  ...
  (= (oeq2
     ...
     (positions
     (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true)
  (= (get
     (keys
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields))
     ...
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields))
     (to_rep (select a1 i)))) (to_rep (select a1 i))))
  (= (equal_except
  ...
  (= (get2
     ...
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields))
     (to_rep (select a1 i))) i))
  (= (same_keys
     (model__
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields))
     (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields)))) true))
...
;; H
  (assert
  (= result1 (mk___split_fields__ref (mk___split_fields d__split_fields))))
...
;; H
  ...
  (forall ((c1 us_rep1))
  (=>
  (= (has_key (positions (mk___rep d__split_discrs d__split_fields1)) c1) true)
  (=>
  (and
  (not
  (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep
                                                          (select a1
                                                          i))))
  (not
  (= (key (mk___rep d__split_discrs d__split_fields1) c1) (to_rep
                                                          ...
                                                          j)))))
  (= (to_rep
     (select a1 (element (mk___rep d__split_discrs d__split_fields1) c1)))
  (key (mk___rep d__split_discrs d__split_fields1) c1))))))
...
;; H
  ...
  (= (oeq2
     ...
     (positions (mk___rep d__split_discrs d__split_fields1))) true)
  (= (get
     (keys
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields1))
     ...
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields1))
     (to_rep (select a1 j)))) (to_rep (select a1 j))))
  (= (equal_except (keys (mk___rep d__split_discrs d__split_fields1))
     (keys
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields1))
     (find
  ...
  (= (get2
     ...
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields1))
     (to_rep (select a1 j))) j))
  (= (same_keys
     (model__
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields1))
     (model__ (mk___rep d__split_discrs d__split_fields1))) true))
  (= (elements_equal_except
     (model__
     (mk___rep d__split_discrs
     partition_refinement__inverse_sets__replace__container__fields1))
     (model__ (mk___rep d__split_discrs d__split_fields1))
     (to_rep (select a1 j))) true)))
...
;; H
  ...
  (forall ((c1 us_rep1))
  (=>
  (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c1) true)
  (=>
  (and
  (not
  (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep
                                                          (select a1
                                                          i))))
  (not
  (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep
                                                          ...
                                                          j)))))
  (= (to_rep
     (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1)))
  (key (mk___rep d__split_discrs d__split_fields2) c1))))))
...
;; H
  ...
  (and
  (= o (+ (to_rep1
          (rec__partition_refinement__interval__count p_elem__split_fields3)) 1))
  (in_range2
  (+ (to_rep1
     (rec__partition_refinement__interval__count p_elem__split_fields3)) 1))))
...
;; H
  (assert
  (= o2 (mk___split_fields2
        (rec__partition_refinement__interval__first p_elem__split_fields3)
        (rec__partition_refinement__interval__last p_elem__split_fields3)
        o1)))

;; H
  (assert (= temp___1186 (mk___rep2 o2)))

;; H
  (assert (= result3 (mk___split_fields__ref2 p_elem__split_fields3)))

;; H
  (assert (= p_elem__split_fields4 (us_split_fields5 temp___1186)))
...
;; H
  ...
  (and
  (= (length1
     (mk___rep3 p__split_discrs
     partition_refinement__partitions__replace_element__container__fields))
  (length1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))))
  (= (bool_eq6
     (get3
     (model__1
     (mk___rep3 p__split_discrs
     partition_refinement__partitions__replace_element__container__fields))
     (to_rep4 (select f i))) (mk___rep2 p_elem__split_fields4)) true))
  (= (equal_except1
     (model__1
     (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))
     (model__1
...
;; H
  (assert
  (= result4 (mk___split_fields__ref3 (mk___split_fields3 p__split_fields))))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 0 k) (<= k 5))
  (= (to_rep (select a1 k)) (ite (= k i) (to_rep (select a_old j))
                            (ite (= k j) (to_rep (select a_old i))
                            (to_rep (select a_old k))))))))

;; H
  (assert
  (= p_elem__split_fields5 (mk___split_fields__ref2 p_elem__split_fields4)))

;; H
  (assert (= p__split_fields2 (mk___split_fields__ref3 p__split_fields1)))

;; H
  (assert (= d__split_fields3 (mk___split_fields__ref d__split_fields2)))

;; H
  (assert (= a2 (mk_map__ref a1)))

;; H
  (assert (= p_elem__split_fields6 p_elem__split_fields4))

;; H
  (assert (= p__split_fields3 p__split_fields1))

;; H
  (assert (= d__split_fields4 d__split_fields2))
...
;; H
  ...
  (forall ((k Int))
  (=> (and (<= 0 k) (<= k 5))
  (= (to_rep (select (map__content a2) k)) (ite (= k (get2
                                                     (model__
                                                     (mk___rep
                                                     d__split_discrs
                                                     (mk___split_fields
...
;; H
  ...
  (= o7 (capacity
        (mk___rep3 p__split_discrs
        (us_split_fields__content3 p__split_fields2))))
  (and (in_range8 o7)
  (= o7 (ite (= (of_int 1) true)
        (to_rep5
        (rec__partition_refinement__partitions__vector__capacity
...
;; H
  (assert
  (= result6 (ite (= o7 (capacity
                        (mk___rep3 p__split_discrs
                        (mk___split_fields3 p__split_fields))))
             true false)))
...
;; H
  ...
  (= (has_key1
     (model__
     (mk___rep d__split_discrs (us_split_fields__content d__split_fields3)))
     (to_rep (select (map__content a2) j1))) true)))))
...
;; H
  ...
  (= o3 (has_key
        (positions
        (mk___rep d__split_discrs
        (us_split_fields__content d__split_fields3))) c))
  (= (= o3 true)
  (= (has_key
     (positions
     (mk___rep d__split_discrs (us_split_fields__content d__split_fields3)))
...
;; H
  (assert (= result9 (ite (= o4 true) o3 false)))
...
;; H
  ...
  (= o5 (get
        (keys
        (mk___rep d__split_discrs
        (us_split_fields__content d__split_fields3)))
        (get1
        (positions
        (mk___rep d__split_discrs
        (us_split_fields__content d__split_fields3))) c))))))
