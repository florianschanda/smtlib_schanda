...
(declare-datatypes ((t8s__ref 0)) (((mk_t8s__ref (t8s__content us_t2)))))
...
(declare-datatypes ((t11b__ref 0)) (((mk_t11b__ref (t11b__content us_t4)))))
...
;; H
  (assert
  (and (= o31 (+ y (int__content lcp__result4))) (in_range1
...
;; H
  (assert (and (= temp___179 o32) (in_range1 o32)))

;; H
  (assert
  (=> (<= y temp___179)
  (and (and (<= (to_rep (first (rt a))) y) (<= y (to_rep (last (rt a)))))
  (and (<= (to_rep (first (rt a))) temp___179)
  (<= temp___179 (to_rep (last (rt a))))))))

;; H
  (assert (= o33 (elts a)))

;; H
  (assert (= o33 temp___181))

;; H
  (assert (= (mk2 y temp___179) temp___1811))

;; H
  (assert
  (and (= o34 (+ x (int__content lcp__result4))) (in_range1
...
;; H
  (assert (and (= temp___178 o35) (in_range1 o35)))

;; H
  (assert
  (=> (<= x temp___178)
  (and (and (<= (to_rep (first (rt a))) x) (<= x (to_rep (last (rt a)))))
  (and (<= (to_rep (first (rt a))) temp___178)
  (<= temp___178 (to_rep (last (rt a))))))))

;; H
  (assert (= o36 (elts a)))

;; H
  (assert (= o36 temp___180))

;; H
  (assert (= (mk1 x temp___178) temp___1801))

;; H
  (assert
  (= result12 (bool_eq temp___180 (to_rep (first2 temp___1801))
              (to_rep (last2 temp___1801)) temp___181
              (to_rep (first4 temp___1811)) (to_rep (last4 temp___1811)))))
...
;; H
  (assert
  (and (= o29 (+ (to_rep (last (rt a))) 1)) (in_range1
  (+ (to_rep (last (rt a))) 1))))

;; H
  (assert
  (and (= o30 (+ x (int__content lcp__result4))) (in_range1
  (+ x (int__content lcp__result4)))))

;; H
  (assert (= result14 (ite (= o30 o29) true false)))

;; H
  (assert (=> (= result14 true) (= result13 true)))

;; H
  (assert
  (=> (not (= result14 true))
  (and (= o27 (+ (to_rep (last (rt a))) 1)) (in_range1
  (+ (to_rep (last (rt a))) 1)))))

;; H
  (assert
  (=> (not (= result14 true))
  (and (= o28 (+ y (int__content lcp__result4))) (in_range1
  (+ y (int__content lcp__result4))))))

;; H
  (assert
  (=> (not (= result14 true)) (= result13 (ite (= o28 o27) true false))))
...
;; H
  (assert
  (and (= temp___177 (+ y (int__content lcp__result4))) (in_range1
  (+ y (int__content lcp__result4)))))

;; H
  (assert
  (and (<= (to_rep (first (rt a))) temp___177)
  (<= temp___177 (to_rep (last (rt a))))))

;; H
  (assert (= o24 temp___177))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (in_range1 (+ x (int__content lcp__result4)))))
(check-sat)
(exit)
