...
;; H
  (assert
  (and (= o50 (mul RNE1 q3 rad_gz4)) (tqtisFinite (mul RNE1 q3 rad_gz4))))

;; H
  (assert
  (and (= o49 (mul RNE1 (let ((subject qc)) qc1) rad_gy4)) (tqtisFinite
  (mul RNE1 (let ((subject qc)) qc1) rad_gy4))))

(assert
;; WP_parameter_def
 ;; File "i-cexten.ads", line 59, characters 0-0
  (not (tqtisFinite (mul RNE1 (let ((subject qb)) qb1) rad_gx4))))
(check-sat)
