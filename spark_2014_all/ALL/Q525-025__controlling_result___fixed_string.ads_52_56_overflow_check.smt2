...
(declare-const temp___253 (Array Int character))

(declare-const temp___2531 t3)

(declare-const temp___254 (Array Int character))

(declare-const temp___2541 t2)
...
;; H
  (assert (= o6 temp___253))

;; H
  (assert (= (mk3 (to_rep1 (first (rt new_val))) r8b) temp___2531))

;; H
  (assert
  (= (ite (<= (to_rep1 (first6 temp___2531)) (to_rep1 (last6 temp___2531)))
     (+ (- (to_rep1 (last6 temp___2531)) (to_rep1 (first6 temp___2531))) 1)
     0) (ite (<= (to_rep1 change__first) r5b)
        (+ (- r5b (to_rep1 change__first)) 1) 0)))

;; H
  (assert
  (= (slide temp___253 (to_rep1 (first6 temp___2531))
     (to_rep1 change__first)) temp___254))

;; H
  (assert (= (mk2 (to_rep1 change__first) r5b) temp___2541))
...
;; H
  (assert (= o7 temp___256))

;; H
  (assert (= (mk2 (to_rep1 change__first) r5b) temp___2561))

;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___2541)) (to_rep1 (last4 temp___2541)))
     (+ (- (to_rep1 (last4 temp___2541)) (to_rep1 (first4 temp___2541))) 1)
     0) (ite (<= (to_rep1 (first4 temp___2561)) (to_rep1 (last4 temp___2561)))
        (+ (- (to_rep1 (last4 temp___2561)) (to_rep1 (first4 temp___2561))) 1)
        0)))

;; H
  (assert
  (= (mk___t2 temp___257 temp___2571) (mk___t2 temp___254 temp___2541)))

;; H
  (assert
  (forall ((temp___258 Int))
  (ite (and (<= (to_rep1 change__first) temp___258) (<= temp___258 r5b))
  (= (select o8 temp___258) (select temp___257 temp___258))
  (= (select o8 temp___258) (select change1 temp___258)))))
...
;; H
  (assert (= o17 (select change3 o16)))

;; H
  (assert (= o18 (to_rep o17)))

;; H
  (assert (= o19 (ite (= o18 0) true false)))
...
;; H
  ...
  (and (= o14 (- 2147483647 (to_rep1 (first (rt new_val))))) (in_range1
  (- 2147483647 (to_rep1 (first (rt new_val))))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (and (= o15 (- i (to_rep1 change__first))) (in_range1
  (- i (to_rep1 change__first))))))

;; H
  (assert
  (=> (not (< (to_rep1 (first (rt new_val))) 0))
  (= result4 (ite (<= o15 o14) true false))))

;; H
  (assert
  (=> (= result4 true)
  (and (= o11 (- i (to_rep1 change__first))) (in_range1
  (- i (to_rep1 change__first))))))

;; H
  (assert
  (=> (= result4 true) (= o12 (+ o11 (to_rep1 (first (rt new_val)))))))

;; H
  (assert (=> (= result4 true) (and (= o13 o12) (in_range1 o12))))

;; H
  (assert
  (=> (= result4 true)
  (= result3 (ite (<= o13 (to_rep1 (last (rt new_val)))) true false))))
