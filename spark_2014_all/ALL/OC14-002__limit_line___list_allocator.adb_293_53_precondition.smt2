...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result12 (ite (< 0 o67) true false))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result12 true)
  (= result11 (ite (= o66 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result11 true)
  (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o64) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated2 0))
  (=> (= result13 true)
  (= result10 (ite (= o63 first_allocated2) true false))))))
