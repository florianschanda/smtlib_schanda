...
(define-fun tr_pu1S__ref_2__projection ((a tr_pu1S__ref)) us_rep (tr_pu1S__content
                                                                 a))
...
(assert
;; WP_parameter_def
 ;; File "record_equality.adb", line 20, characters 0-0
  (not (in_range1 0)))
(check-sat)
(exit)
