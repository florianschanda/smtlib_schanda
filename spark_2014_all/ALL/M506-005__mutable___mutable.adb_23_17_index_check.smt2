...
(declare-fun x__split_fields4 () (Array Int integer))

(declare-fun x__split_fields5 () t)

(declare-fun x__split_discrs1 () d)

(declare-fun x__split_fields6 () integer)

(declare-fun x__split_fields7 () (Array Int integer))

(declare-fun x__split_fields8 () t)

(declare-fun x__split_discrs2 () d)
...
;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_discrs x__split_discrs2)))

;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields x__split_fields6)))

;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields1 x__split_fields7)))

;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields2 x__split_fields8)))

;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_discrs1 x__split_discrs2)))

;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields3 x__split_fields6)))

;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields4 x__split_fields7)))

;; H
  (assert
  (=> (< 0 (to_rep1 x__split_discrs)) (= x__split_fields5 x__split_fields8)))

;; H
  (assert
  (=> (not (< 0 (to_rep1 x__split_discrs))) (dynamic_invariant1
  (mk___rep (mk___split_discrs x__split_discrs2)
  (mk___split_fields x__split_fields6
  (mk___t x__split_fields7 x__split_fields8)) x__attr__constrained) true true
  true)))

(assert
;; WP_parameter_def
 ;; File "mutable.adb", line 2, characters 0-0
  (not (<= (to_rep2 (first x__split_fields8)) 1)))
(check-sat)
