...
;; H
  (assert (and (= o16 (- x 1)) (in_range5 (- x 1))))
...
;; H
  (assert
  (and (= o17 (remove (mk___t values2 (mk 1 100)) o13))
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o13 1)))
  (= (to_rep (select values2 k)) (to_rep (select o14 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select o14 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select o14 k))))))))))))
