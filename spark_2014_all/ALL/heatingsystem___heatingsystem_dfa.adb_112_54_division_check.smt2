...
(declare-fun dummy1 () advancemodes)
...
(declare-fun currentmode () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS5 () Int)

(declare-fun time () Int)

(declare-fun heatingsystem_dfa__checkadvancebutton__currentmode__assume () Int)
...
;; H
  (assert (in_range1
  heatingsystem_dfa__checkadvancebutton__currentmode__assume))

;; H
  (assert
  (= heatingsystem_dfa__checkadvancebutton__currentmode__assume currentmode))

;; H
  (assert (in_range1 currentmode))

;; H
  (assert (not (= currentmode 0)))
