...
(declare-const usedlogfiles__split_fields us_split_fields__ref)

(declare-const logfileentries map__ref1)
...
;; H
  ...
  (<= 1 (to_rep3
        (rec__auditlog__logfilelistt__length
        (us_split_fields__content usedlogfiles__split_fields))))
  (= (int__content numberlogentries1) (+ (* (- (to_rep3
                                               (rec__auditlog__logfilelistt__length
                                               (us_split_fields__content
                                               usedlogfiles__split_fields))) 1) 1024)
  (to_rep2
  (select (map__content1 logfileentries) (int__content currentlogfile1)))))))

;; H
  (assert
  (and
  (and (in_range8 (int__content numberlogentries1)) (in_range4
  (int__content auditalarm1))) (in_range7 (int__content currentlogfile1))))

(assert
;; WP_parameter_def
 ;; File "auditlog.adb", line 174, characters 0-0
  (not
  (= (valid_numberlogentries (map__content1 logfileentries)
     (int__content numberlogentries1) (int__content currentlogfile1)
     (us_split_fields__content usedlogfiles__split_fields)) true)))
(check-sat)
(exit)
