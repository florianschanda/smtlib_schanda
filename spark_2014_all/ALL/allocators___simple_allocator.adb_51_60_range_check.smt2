...
;; H
  (assert (and (= o11 (length alloc3)) (in_range5 o11)))

;; H
  (assert (and (= o12 (length avail3)) (in_range5 o12)))
...
;; H
  (assert (= result5 (ite (= o14 r2) true false)))

;; H
  (assert
  (=> (= result5 true)
  (and (= o9 (contains avail3 e1))
  (=> (= (of_int 1) true)
  (=>
  (exists ((e2 Int))
...
;; H
  (assert (=> (= result5 true) (= (= o10 true) (in_range4 e1))))

;; H
  (assert (=> (= result5 true) (= result6 (ite (= o10 true) o9 false))))
...
;; H
  (assert (=> (= result4 true) (= (= o8 true) (in_range4 e))))

;; H
  (assert (=> (= result4 true) (= result7 (ite (= o8 true) o7 false))))
