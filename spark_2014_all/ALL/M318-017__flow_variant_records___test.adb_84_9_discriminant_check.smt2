...
(declare-datatypes ((t25b__ref 0)) (((mk_t25b__ref (t25b__content us_rep)))))
...
(declare-const temp___263 Bool)

(declare-const temp___2631 integer)

(declare-const temp___2632 failure_reason)

(declare-const temp___2633 Bool)
