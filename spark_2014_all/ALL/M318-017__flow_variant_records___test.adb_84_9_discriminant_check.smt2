...
(declare-datatypes () ((t25b__ref (mk_t25b__ref (t25b__content us_rep)))))
(define-fun t25b__ref___projection ((a t25b__ref)) us_rep (t25b__content a))
...
(declare-fun temp___263 () Bool)

(declare-fun temp___2631 () integer)

(declare-fun temp___2632 () failure_reason)

(declare-fun temp___2633 () Bool)

;; H
  (assert (= x__split_discrs r24b))
...
;; H
  (assert (= (of_int 1) temp___263))

;; H
  (assert (= temp___2631 o1))

;; H
  (assert (= temp___2632 o2))

;; H
  (assert (= true temp___2633))
...
(assert
;; WP_parameter_def
 ;; File "test.adb", line 43, characters 0-0
  (not (= temp___263 x__split_discrs)))
(check-sat)
