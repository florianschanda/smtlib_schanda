...
(declare-fun temp___7028 () us_rep2)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 981, characters 0-0
  (not
  (= (bool_eq2 (mk___rep2 (us_split_fields__content2 r__split_fields7))
     (mk___rep2
     (mk___split_fields2
     (mk___rep1
     (mk___split_fields1 (rec__ar__rec2t__f2 (us_split_fields3 a))
     (mk___rep
     (mk___split_fields (of_rep e)
     (rec__ar__rec1t__g1
     (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 a))))))
     (rec__ar__rec2t__h2 (us_split_fields3 a)))) r__split_fields4))) true)))
(check-sat)
(exit)
