...
(declare-datatypes ((root_d__ref 0))
(((mk_root_d__ref (root_d__content us_rep1)))))
...
(declare-datatypes ((non_tagged__ref 0))
(((mk_non_tagged__ref (non_tagged__content us_rep2)))))
