...
(declare-fun dummy () my_mod)

(declare-datatypes ()
((my_mod__ref (mk_my_mod__ref (my_mod__content my_mod)))))
(define-fun my_mod__ref___projection ((a my_mod__ref)) my_mod (my_mod__content
                                                              a))
...
(assert
;; WP_parameter_def
 ;; File "my_shift.ads", line 5, characters 0-0
  (not (= z1 (bvudiv z_old ((_ int2bv 32) 2)))))
(check-sat)
(exit)
