...
;; H
  (assert
  (and
  (and (= (is_writable standard_error1) true)
  (= (is_writable standard_output1) true))
  (= (is_readable standard_input1) true)))

;; H
  (assert (not (= (end_of_file standard_input1) true)))
...
;; H
  ...
  (= (let ((temp___715 (name standard_input1)))
     (let ((temp___714 (name standard_input2)))
     (bool_eq (elts temp___714) (to_rep1 (first (rt temp___714)))
     (to_rep1 (last (rt temp___714))) (elts temp___715)
     (to_rep1 (first (rt temp___715))) (to_rep1 (last (rt temp___715)))))) true))
  (= (let ((temp___717 (form standard_input1)))
     (let ((temp___716 (form standard_input2)))
...
;; WP_parameter_def
 ;; File "spark-text_io.ads", line 80, characters 0-0
  (not (= (is_writable standard_output1) true)))
(check-sat)
(exit)
