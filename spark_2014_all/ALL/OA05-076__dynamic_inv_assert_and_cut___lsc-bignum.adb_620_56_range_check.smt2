...
;; H
  (assert (= o61 (bvadd o60 ((_ int2bv 64) 1))))

;; H
  (assert (= o62 (bvmul o61 ((_ int2bv 64) 32))))
...
;; H
  (assert (= o52 (ite (<= s10 o51) true false)))

;; H
  (assert (= o47 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o48 (oexpon o47 s10)))

;; H
  (assert (= o42 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o41 (from_integer s10)))
...
;; H
  (assert (= o39 (from_word32 ((_ int2bv 32) 2))))
...
;; H
  (assert (= o33 (from_word32 (t__content w7))))
