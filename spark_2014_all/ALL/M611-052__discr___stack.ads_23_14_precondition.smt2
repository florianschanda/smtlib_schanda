...
;; H
  ...
  (and (dynamic_invariant2 temp___2582 true false true)
  (and (= s__split_fields1 temp___258)
  (= (mk1 (to_rep (first4 (mk2 1 (to_rep1 s__split_fields))))
     (to_rep (last4 (mk2 1 (to_rep1 s__split_fields))))) temp___2581)))))

;; H
  (assert
  (and
  (= temp___2572 (to_but_top
                 (mk___rep s__split_discrs
                 (us_split_fields__content s__split_fields5))))
  (and (dynamic_invariant2 temp___2572 true false true)
  (and
  (= (elts
...
;; H
  (assert
  (= o13 (bool_eq2 temp___257 (to_rep (first2 temp___2571))
         (to_rep (last2 temp___2571)) temp___258
         (to_rep (first2 temp___2581)) (to_rep (last2 temp___2581)))))
