...
(declare-fun saved_rbp2 () t__ref3)

(declare-fun saved_rdi2 () t__ref3)

(declare-fun saved_rdx2 () t__ref3)
...
(declare-fun savemem3 () (Array (_ BitVec 64) unsigned8))
...
(declare-fun saved_rdi3 () (_ BitVec 64))

(declare-fun saved_rdx3 () (_ BitVec 64))
