...
(declare-fun temp___271 () integer)

(declare-fun temp___2711 () float)
...
;; H
  (assert
  (and (= o (+ (to_rep full_s__split_fields) x)) (in_range1
...
;; H
  (assert (= temp___271 full_s__split_fields2))

;; H
  (assert (= temp___2711 full_s__split_fields3))

(assert
;; WP_parameter_def
 ;; File "p.ads", line 18, characters 0-0
  (not
  (not (or (fp.isInfinite (fp.add RNE (to_rep1 full_s__split_fields3)
  y)) (fp.isNaN (fp.add RNE (to_rep1 full_s__split_fields3) y))))))
(check-sat)
(exit)
