...
;; H
  (assert (and (= temp___269 (- x19 1)) (in_range1 (- x19 1))))

;; H
  (assert
  (and (= us6 temp___269) (dynamic_property1 first2 last2 temp___269)))

;; H
  (assert (= o26 temp___269))

;; H
  (assert (= result10 (mk_int__ref x19)))

;; H
  (assert (= x110 o26))

;; H
  (assert (and (= temp___270 (- x215 1)) (in_range1 (- x215 1))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (dynamic_property2 first3 last3 temp___270)))
(check-sat)
(exit)
