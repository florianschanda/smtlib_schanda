...
;; H
  (assert (= o16 (mul RNE1 fliteral2 o15)))

;; H
  (assert (and (= o17 o16) (tqtisFinite o16)))

;; H
  (assert (= o18 (div1 RNE1 o17 fliteral3)))
...
;; H
  (assert (= o10 (mul RNE1 fliteral4 o9)))

;; H
  (assert (and (= o11 o10) (tqtisFinite o10)))

;; H
  (assert (= o12 (div1 RNE1 o11 fliteral5)))

;; H
  (assert
  (and (= o3 (pow5 x))
  (and (tqtisFinite o3)
  (= o3 (mul RNE1 (mul RNE1 (mul RNE1 (mul RNE1 x x) x) x) x)))))

;; H
  (assert (= o4 (mul RNE1 fliteral6 o3)))

;; H
  (assert (and (= o5 o4) (tqtisFinite o4)))

;; H
  (assert (= o6 (div1 RNE1 o5 fliteral7)))

;; H
  (assert
  (and (= o (pow3 x))
  (and (tqtisFinite o) (= o (mul RNE1 (mul RNE1 x x) x)))))

;; H
  (assert (= o1 (div1 RNE1 o fliteral8)))

;; H
  (assert (= o2 (add RNE1 x o1)))

;; H
  (assert (and (= o7 o2) (tqtisFinite o2)))

;; H
  (assert (= o8 (add RNE1 o7 o6)))

;; H
  (assert (and (= o13 o8) (tqtisFinite o8)))

;; H
  (assert (= o14 (add RNE1 o13 o12)))
