...
(declare-fun temp___4751 () us_main_type)

(declare-fun temp___472 () count_type)

(declare-fun temp___4721 () us_main_type)

(declare-fun temp___476 () count_type)

(declare-fun temp___4761 () us_main_type)

(declare-fun temp___471 () count_type)

(declare-fun temp___474 () us_rep3)
...
;; H
  ...
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields))) c1) true)
...
;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___475))
  (= l__split_fields temp___4751))))

;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___472))
  (= l__split_fields temp___4721))))

;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___476))
  (= l__split_fields temp___4761))))

;; H
  (assert
  (=> (= result1 true) (= c__split_fields1 (mk___split_fields1 temp___471))))

;; H
  (assert
  (=> (= result1 true)
  (= temp___474 (positions
                (mk___rep l__split_discrs
                (mk___split_fields l__split_fields))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= l__split_discrs (mk___split_discrs temp___473))
  (= l__split_fields temp___4731))))
...
;; H
  ...
  (get
  (model__
  (mk___rep (mk___split_discrs temp___475) (mk___split_fields temp___4751)))
  i) 1))))))
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 c__split_fields3)) (+ (get1
                                      (positions
                                      (mk___rep l__split_discrs
                                      l__split_fields3))
                                      (mk___rep1 c__split_fields2)) 1))))))
...
;; H
  ...
  (=> (= result1 true)
  (and
  (= o3 (has_key (positions (mk___rep l__split_discrs l__split_fields3))
...
;; H
  (assert
  (=> (= result1 true) (= result2 (ite (not (= o3 true)) true false))))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= c__split_fields6 (mk___split_fields__ref1 c__split_fields1))))
...
;; H
  ...
  (= o8 (length
        (mk___rep l__split_discrs (mk___split_fields l__split_fields))))
  (and (in_range2 o8)
  (<= o8 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))
...
;; H
  ...
  (and (in_range2 o9)
  (<= o9 (to_rep (rec__int_list__my_lists__list__capacity l__split_discrs))))))

;; H
  (assert (= result3 (ite (= o9 o8) true false)))
...
;; H
  ...
  (= o4 (has_key
        (positions
        (mk___rep l__split_discrs
        (us_split_fields__content l__split_fields8))) c))
  (= (= o4 true)
  (= (has_key
     (positions
