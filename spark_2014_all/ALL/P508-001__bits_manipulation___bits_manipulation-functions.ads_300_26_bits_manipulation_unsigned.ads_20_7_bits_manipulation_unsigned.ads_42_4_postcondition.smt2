...
(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result Bool)

(declare-const o Bool)

(declare-const result Bool)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result1 Bool)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result2 Bool)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result3 Bool)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result4 Bool)

(declare-const bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result5 Bool)
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result1
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result3
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result1))
...
;; H
  (assert
  (= result bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result))
...
;; H
  (assert
  (= (mk_bool__ref
     bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result4)
  (mk_bool__ref
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result2)))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result5
  bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result3))

;; H
  (assert
  (= result1 bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result4))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_8__functions__proofs__make_mask__lemma1__result4 true))

(assert
;; WP_parameter_def
 ;; File "bits_manipulation-functions.ads", line 299, characters 0-0
  (not (= (lemma1 Tuple0) true)))
(check-sat)
(exit)
