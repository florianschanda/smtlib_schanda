...
;; length__post_axiom
  (assert
  (forall ((container us_rep2)) (! (dynamic_invariant3 (length2 container)
...
;; H
  (assert
  (and (= o (has_key (positions s) cu1))
  (= (= o true) (= (has_key (positions s) cu1) true))))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_sets.ads", line 137, characters 0-0
  (not (= (has_key (positions s) cu1) true)))
(check-sat)
(exit)
