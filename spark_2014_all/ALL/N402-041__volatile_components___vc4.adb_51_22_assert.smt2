...
(declare-const v21 (Array Int integer))
...
;; H
  (assert (= temp___202 x1))

;; H
  (assert (= o2 (select temp___202 2)))
...
;; H
  (assert (= temp___203 v2))

;; H
  (assert (= o4 (select temp___203 2)))
...
;; H
  (assert (= temp___204 v21))

;; H
  (assert (= o6 (select temp___204 2)))
...
(assert
;; WP_parameter_def
 ;; File "vc4.adb", line 22, characters 0-0
  (not (= t31 t41)))
(check-sat)
(exit)
