...
;; H
  ...
  (fp.isFinite64 (fp.add RNE (to_rep1 (select c5 1)) (to_rep1 (select b5 1))))))
...
;; H
  ...
  (fp.isFinite64 (fp.add RNE (to_rep1 (select c5 2)) (to_rep1 (select b5 2))))))
...
;; H
  ...
  (fp.isFinite64 (fp.add RNE (to_rep1 (select c5 3)) (to_rep1 (select b5 3))))))
...
;; H
  ...
  (fp.isFinite64 (fp.add RNE (to_rep1 (select c5 4)) (to_rep1 (select b5 4))))))
...
;; H
  ...
  (to_rep1 (select d5 1)))
  (fp.leq (to_rep1 (select d5 1)) (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000))))
...
;; H
  ...
  (fp.leq (fp.neg (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000))
  (to_rep1 (select d5 2)))
  (fp.leq (to_rep1 (select d5 2)) (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000))))
...
;; H
  ...
  (fp.leq (fp.neg (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000))
  (to_rep1 (select d5 3)))
  (fp.leq (to_rep1 (select d5 3)) (fp #b0 #b10000000000 #b0000000000000000000000000000000000000000000000000000))))
