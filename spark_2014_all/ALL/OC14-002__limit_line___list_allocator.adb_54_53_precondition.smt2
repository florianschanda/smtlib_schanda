...
;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o11) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o10 (get model____split_fields 1)) (in_range7 o10)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o10 first_available) true false)))))
...
;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o8) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o7 (get model____split_fields1 1)) (in_range7 o7))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o7 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o5 (length model____split_fields)) (in_range6 o5))))
