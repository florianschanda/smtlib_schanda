...
(declare-const usedlogfiles__split_fields8 logfilecountt)
...
(declare-const usedlogfiles__split_fields9 (Array Int logfileindext))

(declare-const usedlogfiles__split_fields10 logfileindext)

(declare-const usedlogfiles__split_fields11 logfileindext)

(declare-const usedlogfiles__split_fields12 logfilecountt)

(declare-const logfileentries3 (Array Int fileentrycountt))

(declare-const auditsystemfault2 Bool)

(declare-const logfiles3 (Array Int us_rep1))
...
(declare-const usedlogfiles__split_fields13 (Array Int logfileindext))

(declare-const usedlogfiles__split_fields14 logfileindext)

(declare-const usedlogfiles__split_fields15 logfileindext)

(declare-const usedlogfiles__split_fields16 logfilecountt)
...
(declare-const usedlogfiles__split_fields17 (Array Int logfileindext))

(declare-const usedlogfiles__split_fields18 logfileindext)

(declare-const usedlogfiles__split_fields19 logfileindext)

(declare-const usedlogfiles__split_fields20 logfilecountt)
