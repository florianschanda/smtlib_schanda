...
(declare-fun truncatedescription () (Array Int character))
...
(declare-fun truncatedescription1 () (Array Int character))

(declare-fun numberlogentries2 () Int)

(declare-fun usedlogfiles__split_fields8 () logfilecountt)

(declare-fun logfileentries2 () (Array Int fileentrycountt))

(declare-fun auditalarm2 () Int)

(declare-fun truncatedescription2 () (Array Int character))
...
(declare-fun usedlogfiles__split_fields9 () (Array Int logfileindext))

(declare-fun usedlogfiles__split_fields10 () logfileindext)

(declare-fun usedlogfiles__split_fields11 () logfileindext)

(declare-fun usedlogfiles__split_fields12 () logfilecountt)

(declare-fun logfileentries3 () (Array Int fileentrycountt))

(declare-fun auditsystemfault2 () Bool)

(declare-fun logfiles3 () (Array Int us_rep1))

(declare-fun currentlogfile3 () Int)

(declare-fun logfilesstatus3 () (Array Int filestatust))

(declare-fun numberlogentries4 () Int)

(declare-fun usedlogfiles__split_fields13 () (Array Int logfileindext))

(declare-fun usedlogfiles__split_fields14 () logfileindext)

(declare-fun usedlogfiles__split_fields15 () logfileindext)

(declare-fun usedlogfiles__split_fields16 () logfilecountt)
...
(declare-fun logfilesstatus4 () (Array Int filestatust))

(declare-fun numberlogentries5 () Int)

(declare-fun usedlogfiles__split_fields17 () (Array Int logfileindext))

(declare-fun usedlogfiles__split_fields18 () logfileindext)

(declare-fun usedlogfiles__split_fields19 () logfileindext)

(declare-fun usedlogfiles__split_fields20 () logfilecountt)

(declare-fun logfileentries5 () (Array Int fileentrycountt))

(declare-fun auditalarm3 () int__ref)

(declare-fun auditsystemfault4 () bool__ref)

(declare-fun truncatedescription3 () map__ref)

(declare-fun logfiles5 () (Array Int us_rep1))

(declare-fun currentlogfile5 () Int)

(declare-fun logfilesstatus5 () (Array Int filestatust))

(declare-fun numberlogentries6 () Int)

(declare-fun usedlogfiles__split_fields21 () us_split_fields)

(declare-fun logfileentries6 () (Array Int fileentrycountt))

(declare-fun auditalarm4 () Int)

(declare-fun auditsystemfault5 () Bool)

(declare-fun truncatedescription4 () (Array Int character))
...
;; H
  (assert
  (=>
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17))
  (and
  (and
  (and
  (and (<= 1 (to_rep2 usedlogfiles__split_fields8))
  (= (to_rep1 (select logfileentries2 currentlogfile)) (to_rep1
                                                       (select logfileentries
                                                       currentlogfile))))
  (= (to_rep2 usedlogfiles__split_fields8) 16))
  (= numberlogentries2 (* (to_rep2 usedlogfiles__split_fields8) 1024)))
  (and (in_range10 numberlogentries2) (in_range4 auditalarm2)))))
...
;; H
  ...
  (and
  (and
  (= numberlogentries3 (+ (* (- (to_rep2 usedlogfiles__split_fields12) 1) 1024)
  (to_rep1 (select logfileentries3 currentlogfile2))))
  (= numberlogentries3 (+ numberlogentries2 1)))
  (=> (= (to_rep1 (select logfileentries3 currentlogfile)) 1024)
  (and (= (to_rep1 (select logfileentries3 currentlogfile2)) 1)
  (= (to_rep2 usedlogfiles__split_fields12) (+ (to_rep2
                                               usedlogfiles__split_fields8) 1)))))
  (=> (< (to_rep1 (select logfileentries3 currentlogfile)) 1024)
  (and
  (= (to_rep1 (select logfileentries3 currentlogfile2)) (+ (to_rep1
                                                           (select logfileentries3
                                                           currentlogfile)) 1))
  (= (to_rep2 usedlogfiles__split_fields12) (to_rep2
                                            usedlogfiles__split_fields8)))))
  (and (in_range10 numberlogentries3) (in_range7 currentlogfile2)))))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= truncatedescription2 truncatedescription)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= auditsystemfault2 auditsystemfault)))
...
;; H
  ...
  (not
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17))) (= auditalarm2 auditalarm)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= logfileentries3 logfileentries)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= usedlogfiles__split_fields usedlogfiles__split_fields9)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= usedlogfiles__split_fields1 usedlogfiles__split_fields10)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= usedlogfiles__split_fields2 usedlogfiles__split_fields11)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= usedlogfiles__split_fields3 usedlogfiles__split_fields12)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= numberlogentries3 numberlogentries)))
...
;; H
  ...
  (not
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17))) (= logfiles2 logfiles)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= truncatedescription2 truncatedescription1)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= auditsystemfault2 auditsystemfault1)))
...
;; H
  ...
  (not
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17))) (= auditalarm2 auditalarm1)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= logfileentries3 logfileentries1)))
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= (mk___split_fields usedlogfiles__split_fields9
     usedlogfiles__split_fields10 usedlogfiles__split_fields11
     usedlogfiles__split_fields12) (mk___split_fields
...
;; H
  ...
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17)))
  (= numberlogentries3 numberlogentries1)))
...
;; H
  ...
  (not
  (and (= (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= (to_rep2 usedlogfiles__split_fields3) 17))) (= logfiles2 logfiles1)))
...
;; H
  ...
  (and
  (and
  (= numberlogentries4 (+ (* (- (to_rep2 usedlogfiles__split_fields16) 1) 1024)
  (to_rep1 (select logfileentries4 currentlogfile3))))
  (= numberlogentries4 (+ numberlogentries3 1)))
  (=> (= (to_rep1 (select logfileentries4 currentlogfile2)) 1024)
  (and (= (to_rep1 (select logfileentries4 currentlogfile3)) 1)
  (= (to_rep2 usedlogfiles__split_fields16) (+ (to_rep2
                                               usedlogfiles__split_fields12) 1)))))
  (=> (< (to_rep1 (select logfileentries4 currentlogfile2)) 1024)
  (and
  (= (to_rep1 (select logfileentries4 currentlogfile3)) (+ (to_rep1
                                                           (select logfileentries4
                                                           currentlogfile2)) 1))
  (= (to_rep2 usedlogfiles__split_fields16) (to_rep2
                                            usedlogfiles__split_fields12)))))
  (and (in_range10 numberlogentries4) (in_range7 currentlogfile3))))
...
;; H
  (assert (= logfileentries4 logfileentries5))

;; H
  (assert (= usedlogfiles__split_fields17 usedlogfiles__split_fields13))

;; H
  (assert (= usedlogfiles__split_fields18 usedlogfiles__split_fields14))

;; H
  (assert (= usedlogfiles__split_fields19 usedlogfiles__split_fields15))

;; H
  (assert (= usedlogfiles__split_fields20 usedlogfiles__split_fields16))

;; H
  (assert (= numberlogentries4 numberlogentries5))

;; H
  (assert (= logfilesstatus3 logfilesstatus4))

;; H
  (assert (= currentlogfile3 currentlogfile4))

;; H
  (assert (= logfiles3 logfiles4))
...
;; H
  (assert (= logfileentries6 logfileentries4))

;; H
  (assert
  (= usedlogfiles__split_fields21 (mk___split_fields
                                  usedlogfiles__split_fields13
                                  usedlogfiles__split_fields14
                                  usedlogfiles__split_fields15
                                  usedlogfiles__split_fields16)))

;; H
  (assert (= numberlogentries6 numberlogentries4))
...
;; H
  (assert
  (and (= o (- (to_rep2 usedlogfiles__split_fields20) 1)) (in_range10
  (- (to_rep2 usedlogfiles__split_fields20) 1))))
...
;; H
  (assert (= o3 (+ o2 (to_rep1 (select logfileentries5 currentlogfile4)))))
