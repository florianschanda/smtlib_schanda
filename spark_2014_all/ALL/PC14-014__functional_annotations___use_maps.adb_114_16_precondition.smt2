...
;; H
  (assert
  (and (= result1 (has_key1 (positions s1) (mk___rep1 cu__split_fields4)))
  (= (= result1 true)
...
;; H
  (assert
  (and (= o (key s1 (mk___rep1 cu__split_fields3)))
  (and (in_range6 o)
  (= o (get (keys s1) (get1 (positions s1) (mk___rep1 cu__split_fields3)))))))
...
;; WP_parameter_def
 ;; File "use_maps.ads", line 70, characters 0-0
  (not
  (or (= (has_key1 (positions s1) (mk___rep1 cu__split_fields3)) true)
