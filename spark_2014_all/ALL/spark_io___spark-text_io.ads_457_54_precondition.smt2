...
(declare-fun dummy1 () positive_count)
...
;; H
  (assert
  (and (= result (is_writable file))
  (= (= result true)
  (and (= (is_open file) true)
  (or (= (mode__2 file) 1) (= (mode__2 file) 2))))))
...
;; H
  (assert
  (and (= result2 (is_readable file))
  (= (= result2 true) (and (= (is_open file) true) (= (mode__2 file) 0)))))
