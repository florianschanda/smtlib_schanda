...
;; H
  (assert
  (and (le1 (neg1 fliteral1) (to_rep1 (select d4 1))) (le1
  (to_rep1 (select d4 1)) fliteral1)))

;; H
  (assert
  (and (le1 (neg1 fliteral1) (to_rep1 (select d4 2))) (le1
  (to_rep1 (select d4 2)) fliteral1)))

(assert
;; WP_parameter_def
 ;; File "floats.ads", line 5, characters 0-0
  (not (le1 (neg1 fliteral1) (to_rep1 (select d4 3)))))
(check-sat)
