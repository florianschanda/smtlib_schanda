...
(define-fun obj__split_fields4 () us_split_fields (mk___split_fields
                                                  obj__split_fields
                                                  obj__split_fields1
                                                  obj__split_fields2
                                                  obj__split_fields3))
...
;; H
  (assert
  (and
  (= result (has_stored_area (mk___rep obj__split_fields4 obj__attr__tag)))
  (= (= result true) (in_range (to_rep obj__split_fields)))))
...
(assert
;; WP_parameter_def
 ;; File "object.adb", line 3, characters 0-0
  (not
  (= (has_stored_area (mk___rep obj__split_fields4 obj__attr__tag)) true)))
(check-sat)
(exit)
