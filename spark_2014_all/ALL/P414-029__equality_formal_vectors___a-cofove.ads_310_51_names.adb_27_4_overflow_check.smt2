...
(define-fun dynamic_invariant4 ((temp___expr_301 Int)
...
;; H
  (assert
  (=> (not (= before (- 1))) (= o6 (ite (= (- before 1) o5) true false))))

;; H
  (assert (=> (not (not (= before (- 1)))) (= o6 false)))
...
;; H
  ...
  (and (in_range2 o) (<= o (capacity new_item)))))
...
(assert
;; WP_parameter_def
 ;; File "a-cofove.ads", line 283, characters 0-0
  (not (in_range1 o2)))
(check-sat)
(exit)
