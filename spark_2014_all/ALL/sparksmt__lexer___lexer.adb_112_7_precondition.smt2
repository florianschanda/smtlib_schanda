...
(declare-fun invariant__1 (us_private us_split_fields us_split_discrs
  us_split_fields us_split_discrs) Bool)

(declare-fun invariant____function_guard1 (Bool us_private us_split_fields
...
;; invariant____def_axiom
  ...
  (! (=
     (= (invariant__1 names__name_table lexer__current_read__fields
