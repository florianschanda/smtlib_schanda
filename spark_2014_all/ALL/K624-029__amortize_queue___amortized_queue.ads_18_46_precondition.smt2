...
;; H
  (assert
  (and (= o9 (length right)) (and (in_range5 o9) (<= o9 (capacity right)))))

;; H
  (assert
  (and (= o10 (length left)) (and (in_range5 o10) (<= o10 (capacity left)))))
...
;; H
  (assert
  (and (= o12 (length (vector__content amortized_queue__Oconcat__result5)))
  (and (in_range5 o12)
  (<= o12 (capacity (vector__content amortized_queue__Oconcat__result5))))))
