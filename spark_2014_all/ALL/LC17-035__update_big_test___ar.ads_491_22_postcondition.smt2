...
;; WP_parameter_def
 ;; File "ar.ads", line 486, characters 0-0
  ...
  (= (bool_eq2 a3 1 16
     (temp___1815 a k
     (temp___1823 (select a k) j (temp___1830 (select (select a k) j) i e))
     (+ k 1)
     (temp___1838 (select a (+ k 1)) j
     (temp___1845 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true))
  (and (= e 0)
  (= (bool_eq2 a3 1 16
     (temp___1854 a k
     (temp___1862 (select a k) j (temp___1869 (select (select a k) j) i e))
     (+ k 1)
     (temp___1877 (select a (+ k 1)) j
     (temp___1884 (select (select a (+ k 1)) j) i 99))) 1 16) true))))
  (and (= k 16)
  (or
  (and (< 0 e)
  (= (bool_eq2 a3 1 16
     (temp___1893 a k
     (temp___1901 (select a k) j (temp___1908 (select (select a k) j) i e)) 1
     (temp___1916 (select a 1) j
     (temp___1923 (select (select a 1) j) i (- e 1)))) 1 16) true))
  (and (= e 0)
  (= (bool_eq2 a3 1 16
     (temp___1932 a k
     (temp___1940 (select a k) j (temp___1947 (select (select a k) j) i e)) 1
     (temp___1955 (select a 1) j (temp___1962 (select (select a 1) j) i 99)))
     1 16) true)))))))
(check-sat)
(exit)
