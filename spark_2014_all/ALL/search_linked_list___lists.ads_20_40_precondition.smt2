...
(declare-fun lists__l__list__capacity__first__bit () Int)

(declare-fun lists__l__list__capacity__last__bit () Int)

(declare-fun lists__l__list__capacity__position () Int)
...
(declare-fun lists__l__cursor__node__first__bit () Int)

(declare-fun lists__l__cursor__node__last__bit () Int)

(declare-fun lists__l__cursor__node__position () Int)
...
(declare-fun lists__search__result () count_type)
...
(declare-fun o4 () us_rep3)

(declare-fun o5 () Int)

(declare-fun lists__search__result1 () count_type)
...
(declare-fun lists__search__result2 () us_rep1)

(declare-fun result2 () Bool)

(declare-fun result3 () cursor__ref)

(declare-fun lists__search__result3 () us_rep1)

(declare-fun c__split_fields3 () us_split_fields2)

(declare-fun result4 () Bool)

(declare-fun c__split_fields4 () us_split_fields__ref1)

(declare-fun lists__search__result4 () cursor__ref)

(declare-fun c__split_fields5 () us_split_fields2)

(declare-fun lists__search__result5 () us_rep1)

(declare-fun c__split_fields6 () us_split_fields__ref1)

(declare-fun lists__search__result6 () cursor__ref)

(declare-fun c__split_fields7 () us_split_fields2)

(declare-fun lists__search__result7 () us_rep1)

(declare-fun result5 () cursor__ref)

(declare-fun lists__search__result8 () us_rep1)

(declare-fun lists__search__result9 () cursor__ref)

(declare-fun lists__search__result10 () us_rep1)

(declare-fun c__split_fields8 () us_split_fields__ref1)

(declare-fun lists__search__result11 () cursor__ref)

(declare-fun c__split_fields9 () us_split_fields2)

(declare-fun lists__search__result12 () us_rep1)

(declare-fun c__split_fields10 () us_split_fields__ref1)

(declare-fun lists__search__result13 () cursor__ref)

(declare-fun c__split_fields11 () us_split_fields2)

(declare-fun lists__search__result14 () us_rep1)

(declare-fun result6 () Bool)

(define-fun c__split_fields12 () us_split_fields2 (mk___split_fields1
                                                  c__split_fields1))
...
;; H
  ...
  (and
  (and
  (and (= lists__search__result11 (mk_cursor__ref lists__search__result3))
  (= c__split_fields8 (mk___split_fields__ref1 c__split_fields2)))
  (and (= lists__search__result12 lists__search__result3)
  (= c__split_fields9 c__split_fields2)))
  (and
  (and (= result1 (has_key (positions l) (mk___rep1 c__split_fields12)))
  (= (= result1 true)
  ...
  (and (= (has_key (positions l) (mk___rep1 c__split_fields2)) true)
  (and
  (and
  (and (= o2 (element l (mk___rep1 c__split_fields2)))
  (and (in_range5 o2)
  (= o2 (get (model__ l) (get1 (positions l) (mk___rep1 c__split_fields2))))))
  (= result2 (ite (= o2 0) true false)))
  (and (= result2 true)
  (and (= result3 (mk_cursor__ref lists__search__result2))
  (= lists__search__result3 (mk___rep1 c__split_fields2)))))))))))
  (and
  (and
  (and (= result1 (has_key (positions l) (mk___rep1 c__split_fields12)))
  (= (= result1 true)
  ...
  (= lists__search__result3 lists__search__result2)))
  (and
  (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) false) (=
          (get1 (positions l) (mk___rep1 c__split_fields2)) (length2 l)) true) true)
  (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true)
  (and (= (has_key (positions l) (mk___rep1 c__split_fields3)) true)
  (= (get1 (positions l) (mk___rep1 c__split_fields3)) (+ (get1 (positions l)
                                                          (mk___rep1
                                                          c__split_fields2)) 1))))
  (and
  (and
  (and (= o3 (has_key (positions l) (mk___rep1 c__split_fields3)))
  (= (= o3 true)
  (= (has_key (positions l) (mk___rep1 c__split_fields3)) true)))
  (= result4 (ite (not (= o3 true)) true false))) (= result4 true)))))))
  (and
  (and (= lists__search__result4 (mk_cursor__ref lists__search__result3))
  (= c__split_fields4 (mk___split_fields__ref1 c__split_fields3)))
  (and (= lists__search__result5 lists__search__result3)
  (= c__split_fields5 c__split_fields3))))
  (and
  (and (= lists__search__result6 lists__search__result4)
  (= c__split_fields6 c__split_fields4))
  (and (= lists__search__result7 lists__search__result5)
  (= c__split_fields7 c__split_fields5))))
  (and
  (and
  (= lists__search__result6 (mk_cursor__ref
                            (mk___rep1
                            (mk___split_fields1 lists__search__result))))
  (= c__split_fields6 (mk___split_fields__ref1 c__split_fields12)))
  (and
  (= lists__search__result7 (mk___rep1
                            (mk___split_fields1 lists__search__result1)))
  (= c__split_fields7 c__split_fields12)))))
  (and
  (and
  (and (= lists__search__result11 lists__search__result9)
  (= c__split_fields8 c__split_fields6))
  (and (= lists__search__result12 lists__search__result10)
  (= c__split_fields9 c__split_fields7)))
  (and
  (and (= lists__search__result9 (mk_cursor__ref lists__search__result8))
  (= lists__search__result10 lists__search__result8))
  (and (= result5 lists__search__result6)
  (= lists__search__result8 no_element)))))))

;; H
  (assert (= lists__search__result13 lists__search__result11))

;; H
  (assert (= c__split_fields10 c__split_fields8))

;; H
  (assert (= lists__search__result14 lists__search__result12))
...
;; H
  ...
  (not
  (= (has_key (positions l) (cursor__content lists__search__result13)) true))))

;; H
  (assert
  (exists ((cu count_type))
  (let ((cu1 (mk___rep1 (mk___split_fields1 cu))))
  (and (= (has_key (positions l) cu1) true) (= (element l cu1) 0)))))

;; H
  (assert
  (and (= o5 (element l (cursor__content lists__search__result13)))
  (and (in_range5 o5)
  (= o5 (get (model__ l)
        (get1 (positions l) (cursor__content lists__search__result13)))))))

;; H
  (assert (= result6 (ite (= o5 0) true false)))
...
;; H
  (assert
  (and (= o4 (positions l))
  (and (not (= (has_key o4 no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o4 i) true)
  (and (and (<= 1 (get1 o4 i)) (<= (get1 o4 i) (length2 l)))
  (forall ((j us_rep1))
  (=> (= (has_key o4 j) true)
  (=> (= (get1 o4 i) (get1 o4 j)) (= (bool_eq1 i j) true))))))))))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not (= (has_key o4 (cursor__content lists__search__result13)) true)))
(check-sat)
(exit)
