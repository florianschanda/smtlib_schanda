...
;; H
  (assert
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o21) true false))))
...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o20 first_available) true false)))))
...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o18) true false)))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o17 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o12 (length model____split_fields)) (in_range6 o12))))
...
;; H
  (assert
  (=> (= result6 true)
  (=> (= result7 true) (and (= o13 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result6 true)
  (=> (= result7 true)
  (and (= o14 (get model____split_fields o13)) (in_range7 o14)))))
...
;; H
  (assert
  (=> (< 1 j) (and (= o3 (get model____split_fields o2)) (in_range7 o3))))
