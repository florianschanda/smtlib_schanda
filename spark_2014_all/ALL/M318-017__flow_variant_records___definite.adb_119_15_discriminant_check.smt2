...
(declare-fun temp___201 () status)

(declare-fun temp___2011 () natural)

(declare-fun temp___2012 () natural)

(declare-fun temp___2013 () Bool)

(declare-fun temp___2014 () Bool)
...
;; WP_parameter_def
 ;; File "definite.adb", line 99, characters 0-0
  (not (= temp___201 x__split_discrs)))
(check-sat)
(exit)
