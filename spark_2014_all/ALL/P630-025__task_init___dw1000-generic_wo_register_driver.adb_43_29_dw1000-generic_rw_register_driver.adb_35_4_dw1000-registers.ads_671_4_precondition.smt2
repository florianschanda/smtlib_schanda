...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim bits_8)))))
(define-fun us_split_fields_SNOZ_TIM__projection ((a us_split_fields)) bits_8 
  (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref_103__projection ((a us_split_fields__ref)) us_split_fields 
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep_103__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                a))

(define-fun bool_eq5 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep1
                           (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim
...
(declare-fun dw1000__register_types__pmsc_snozt_type__snoz_tim__first__bit () Int)

(declare-fun dw1000__register_types__pmsc_snozt_type__snoz_tim__last__bit () Int)

(declare-fun dw1000__register_types__pmsc_snozt_type__snoz_tim__position () Int)

;; dw1000__register_types__pmsc_snozt_type__snoz_tim__first__bit_axiom
  (assert
  (<= 0 dw1000__register_types__pmsc_snozt_type__snoz_tim__first__bit))

;; dw1000__register_types__pmsc_snozt_type__snoz_tim__last__bit_axiom
  (assert
  (< dw1000__register_types__pmsc_snozt_type__snoz_tim__first__bit dw1000__register_types__pmsc_snozt_type__snoz_tim__last__bit))

;; dw1000__register_types__pmsc_snozt_type__snoz_tim__position_axiom
  (assert (<= 0 dw1000__register_types__pmsc_snozt_type__snoz_tim__position))

(declare-fun dummy4 () us_rep)

(declare-datatypes ()
((pmsc_snozt_type__ref
 (mk_pmsc_snozt_type__ref (pmsc_snozt_type__content us_rep)))))
(define-fun pmsc_snozt_type__ref___projection ((a pmsc_snozt_type__ref)) us_rep 
  (pmsc_snozt_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_236__projection ((a register_type__ref)) us_rep 
...
(define-fun tregister_byte_arrayP1__ref_169__projection ((a tregister_byte_arrayP1__ref)) integer 
...
(define-fun register_byte_array__ref_169__projection ((a register_byte_array__ref)) us_t1 
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7392 us_t1)
  (temp___is_init_7389 Bool) (temp___skip_constant_7390 Bool)
  (temp___do_toplevel_7391 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7390 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_7392)
                                       (last3 temp___expr_7392))
                                       (and (= (first3 temp___expr_7392) 1)
                                       (= (last3 temp___expr_7392) 1)))))
...
(define-fun target__ref_68__projection ((a target__ref)) us_t2 (target__content
                                                               a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref_68__projection ((a source__ref)) us_rep (source__content
                                                                a))

(define-fun dynamic_invariant1 ((temp___expr_7408 us_t2)
  (temp___is_init_7405 Bool) (temp___skip_constant_7406 Bool)
  (temp___do_toplevel_7407 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7406 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_7408)
                                       (last5 temp___expr_7408))
                                       (and (= (first5 temp___expr_7408) 1)
                                       (= (last5 temp___expr_7408) 1)))))
...
(declare-fun temp___8084 () (Array Int bits_8))

(declare-fun temp___80841 () t2)

(declare-fun temp___8085 () (Array Int bits_8))

(declare-fun temp___80851 () t1)
...
(define-fun temp___80842 () us_t2 (mk___t2 temp___8084 temp___80841))
...
;; H
  (assert
  (and (= temp___80842 (register_to_bytes reg)) (dynamic_invariant1
  temp___80842 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___80841)) (to_rep (last4 temp___80841)))
     (+ (- (to_rep (last4 temp___80841)) (to_rep (first4 temp___80841))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))

;; H
  (assert (= temp___8084 temp___8085))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___80841)) (to_rep (last4 temp___80841))) 
  temp___80851))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___80851)) (to_rep (last2 temp___80851)))
     (+ (- (to_rep (last2 temp___80851)) (to_rep (first2 temp___80851))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8085 temp___80851)))
