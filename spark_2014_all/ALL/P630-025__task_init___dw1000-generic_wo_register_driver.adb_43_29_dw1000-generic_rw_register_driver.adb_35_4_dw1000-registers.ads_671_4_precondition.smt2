...
(define-fun us_split_fields__ref___103__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___103__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                  a))
...
(define-fun register_type__ref___236__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___169__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___169__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_7532 us_t1)
  (temp___is_init_7529 Bool) (temp___skip_constant_7530 Bool)
  (temp___do_toplevel_7531 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7530 true))
                                       (and (dynamic_property2 1 1
                                       (first3 temp___expr_7532)
                                       (last3 temp___expr_7532))
                                       (and (= (first3 temp___expr_7532) 1)
                                       (= (last3 temp___expr_7532) 1)))))
...
(define-fun target__ref___68__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___68__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_7548 us_t2)
  (temp___is_init_7545 Bool) (temp___skip_constant_7546 Bool)
  (temp___do_toplevel_7547 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_7546 true))
                                       (and (dynamic_property3 1 1
                                       (first5 temp___expr_7548)
                                       (last5 temp___expr_7548))
                                       (and (= (first5 temp___expr_7548) 1)
                                       (= (last5 temp___expr_7548) 1)))))
...
;; H
  (assert
  (and (= temp___82342 (register_to_bytes reg)) (dynamic_invariant1
  temp___82342 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___82341)) (to_rep (last4 temp___82341)))
     (+ (- (to_rep (last4 temp___82341)) (to_rep (first4 temp___82341))) 1)
     0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___82341)) (to_rep (last4 temp___82341)))
  temp___82351))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___82351)) (to_rep (last2 temp___82351)))
     (+ (- (to_rep (last2 temp___82351)) (to_rep (first2 temp___82351))) 1)
