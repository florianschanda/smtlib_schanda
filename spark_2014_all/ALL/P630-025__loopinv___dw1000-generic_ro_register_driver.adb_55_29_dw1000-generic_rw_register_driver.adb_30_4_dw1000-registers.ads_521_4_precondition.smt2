...
(define-fun register_type__ref_177__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_124__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_124__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6150 us_t1)
  (temp___is_init_6147 Bool) (temp___skip_constant_6148 Bool)
  (temp___do_toplevel_6149 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6148 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6150)
                                       (last3 temp___expr_6150))
                                       (and (= (first3 temp___expr_6150) 1)
                                       (= (last3 temp___expr_6150) 4)))))
