...
(declare-const o py_coord)

(declare-const o1 px_coord)

(declare-const o2 direction)

(declare-const o3 shape)

(declare-const o4 shape)

(declare-const o5 direction)

(declare-const o6 px_coord)

(declare-const o7 py_coord)

(declare-const temp___2212 shape)

(declare-const temp___22121 direction)

(declare-const temp___22122 px_coord)

(declare-const temp___22123 py_coord)

(declare-const o8 py_coord)

(declare-const o9 px_coord)

(declare-const o10 direction)

(declare-const o11 shape)

(declare-const o12 shape)

(declare-const o13 direction)

(declare-const o14 px_coord)

(declare-const o15 py_coord)

(declare-const temp___2213 shape)

(declare-const temp___22131 direction)

(declare-const temp___22132 px_coord)

(declare-const temp___22133 py_coord)
