...
(declare-fun temp___472 () (Array Int ranking))
...
;; H
  (assert
  (and (= temp___472 (invert_1 r1))
  (and
  (forall ((rank Int))
  (=> (and (<= 1 rank) (<= rank 64))
  (= (to_rep (select temp___472 (to_rep1 (select r1 rank)))) rank)))
  (forall ((g1 Int))
  (=> (and (<= 1 g1) (<= g1 64))
  (= (to_rep1 (select r1 (to_rep (select temp___472 g1)))) g1))))))
