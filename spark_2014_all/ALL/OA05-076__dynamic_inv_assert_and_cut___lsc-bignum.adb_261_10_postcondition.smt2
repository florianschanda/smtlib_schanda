...
;; WP_parameter_def
 ;; File "lsc-types.ads", line 54, characters 0-0
  ...
  (= (oeq
     ...
     (+ a_first 1) (+ (- a_last a_first) 1))
     (omultiply (num_of_big_int b b_first (+ (- a_last a_first) 1))
     (from_word32 x)))
     (omultiply (num_of_big_int c c_first (+ (- a_last a_first) 1))
     (from_word32 y))) (from_word32 carry1))
     ...
     (oadd (from_word32 (t__content carry18))
     (omultiply (base Tuple0) (from_word32 (t__content carry28))))))) true)))
(check-sat)
(exit)
