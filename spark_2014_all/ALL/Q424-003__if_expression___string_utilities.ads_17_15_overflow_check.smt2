...
(((mk_t15s__ref (t15s__content integer)))))
...
(define-fun t16s__ref___projection ((a t16s__ref)) us_t1 (t16s__content a))
...
(define-fun o9 () us_t (mk___t o2 o3))
...
;; H
  (assert
  (not
  (= (ite (= (bool_eq (elts s1) (to_rep1 (first (rt s1)))
             (to_rep1 (last (rt s1))) (temp___String_Literal_152 Tuple0) 1 0) false)
     (bool_eq (elts s2) (to_rep1 (first (rt s2))) (to_rep1 (last (rt s2)))
     (temp___String_Literal_154 Tuple0) 1 0) true) true)))
...
;; H
  (assert (= result (ite (= o1 o) true false)))
...
;; H
  (assert
  (and (= o8 (tail s2))
  (and (dynamic_invariant o8 true false true)
  (and (= (elts s2) o4)
  (= (mk
     (to_rep1
...
;; H
  (assert
  (and (= o6 (slow_lcs_length o9 o8))
  (and (in_range4 o6)
  (= o6 (ite (or
             (= (bool_eq o2 (to_rep1 (first o3)) (to_rep1 (last o3))
                (temp___String_Literal_152 Tuple0) 1 0) true)
             (= (bool_eq o4 (to_rep1 (first o5)) (to_rep1 (last o5))
                (temp___String_Literal_154 Tuple0) 1 0) true))
        0
        (ite (= (head o9) (head o8))
        (+ 1 (slow_lcs_length (tail o9) (tail o8)))
        (ite (< (slow_lcs_length o9 (tail o8)) (slow_lcs_length (tail o9) o8))
        (slow_lcs_length (tail o9) o8) (slow_lcs_length o9 (tail o8)))))))))
