...
(declare-fun the_stack () (Array Int integer))
...
(declare-fun the_stack1 () (Array Int integer))

(declare-fun the_stack2 () (Array Int integer))

(declare-fun the_ptr2 () Int)

(declare-fun the_stack3 () (Array Int integer))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (is_empty the_ptr2) true))))
(check-sat)
(exit)
