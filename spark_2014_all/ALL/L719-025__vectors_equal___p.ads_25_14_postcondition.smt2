...
;; H
  ...
  (= (m_elements_swapped
     ...
     (model__ (mk___rep l__split_discrs l__split_fields6)) i1 i2) true))

;; H
  (assert
  (= (get (model__ (mk___rep l__split_discrs l__split_fields6)) i1) (get
                                                                    (model__
                                                                    l_in)
                                                                    i2)))
...
;; H
  ...
  (= (m_elements_swapped
     ...
     (model__ (mk___rep l__split_discrs l__split_fields5)) i1 i2) true))
