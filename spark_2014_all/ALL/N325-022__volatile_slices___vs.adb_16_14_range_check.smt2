...
(declare-const temp___217 (Array Int (Array Int integer)))

(declare-const temp___218 (Array Int integer))

(declare-const v2 (Array Int (Array Int integer)))

;; H
  (assert (=> (<= (- 2147483648) 2147483647) (in_range a)))

;; H
  (assert (= temp___217 v2))

;; H
  (assert (= temp___218 (select temp___217 3)))
...
(assert
;; WP_parameter_def
 ;; File "vs.adb", line 4, characters 0-0
  (not (<= 1 1)))
(check-sat)
(exit)
