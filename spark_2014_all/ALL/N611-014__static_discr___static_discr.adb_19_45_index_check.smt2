...
(declare-const current__split_fields2 natural)
...
;; H
  (assert
  (and (<= 1 (to_rep current__split_fields2))
  (<= (to_rep current__split_fields2) (to_rep
                                      (rec__static_discr__holder__c
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= 1 (to_rep current__split_fields2))))
(check-sat)
(exit)
