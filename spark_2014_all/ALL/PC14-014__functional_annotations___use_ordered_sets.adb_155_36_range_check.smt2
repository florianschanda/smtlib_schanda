...
;; H
  (assert
  (and (= o4 (elements (mk___rep s__split_discrs s__split_fields1)))
  (and
  (and
  (and (= (length2 o4) (length (mk___rep s__split_discrs s__split_fields1)))
  (forall ((temp___390 Int))
  (=> (and (in_range4 temp___390) (= (iter_has_element o4 temp___390) true))
