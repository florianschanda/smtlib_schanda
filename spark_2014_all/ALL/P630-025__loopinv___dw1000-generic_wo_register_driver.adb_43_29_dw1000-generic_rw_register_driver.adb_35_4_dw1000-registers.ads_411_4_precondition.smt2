...
(define-fun us_split_fields__ref___51__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___51__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-datatypes ((drx_pretoc_type__ref 0))
...
(define-fun register_type__ref___120__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___85__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___85__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5053 us_t1)
  (temp___is_init_5050 Bool) (temp___skip_constant_5051 Bool)
  (temp___do_toplevel_5052 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5051 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5053)
                                       (last3 temp___expr_5053))
                                       (and (= (first3 temp___expr_5053) 1)
                                       (= (last3 temp___expr_5053) 2)))))
...
(define-fun target__ref___36__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___36__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_5069 us_t2)
  (temp___is_init_5066 Bool) (temp___skip_constant_5067 Bool)
  (temp___do_toplevel_5068 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5067 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_5069)
                                       (last5 temp___expr_5069))
                                       (and (= (first5 temp___expr_5069) 1)
                                       (= (last5 temp___expr_5069) 2)))))
...
;; H
  (assert
  (and (= temp___79702 (register_to_bytes reg)) (dynamic_invariant1
  temp___79702 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___79701)) (to_rep (last4 temp___79701)))
     (+ (- (to_rep (last4 temp___79701)) (to_rep (first4 temp___79701))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79701)) (to_rep (last4 temp___79701)))
  temp___79711))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79711)) (to_rep (last2 temp___79711)))
     (+ (- (to_rep (last2 temp___79711)) (to_rep (first2 temp___79711))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7971 temp___79711)))
