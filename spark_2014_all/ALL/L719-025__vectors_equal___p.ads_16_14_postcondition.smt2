...
(declare-fun dummy () extended_index)
...
;; H
  ...
  (to_rep (rec__p__my_vectors__vector__capacity l__split_discrs))) (<= 1
  i))
  (<= i (+ (last
           (model__
           (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) 1))))
...
;; H
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields6))
     (+ (last
        (model__
        (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) 1)) 1)))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields5)) (- (length
                                                             ...
                                                             l__split_discrs
                                                             l__split_fields6)) 1))
  (= (olt (model__ (mk___rep l__split_discrs l__split_fields5))
     (model__ (mk___rep l__split_discrs l__split_fields6))) true)))
