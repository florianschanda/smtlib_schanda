...
;; H
  ...
  (<= (to_rep1
      (rec__partition_refinement__interval__first
      (us_split_fields1
      (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k1)))) l1)
  (<= l1 (to_rep1
         (rec__partition_refinement__interval__last
         (us_split_fields1
         (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k1))))))
  (= (to_rep2 (select (map__content f6) l1)) k1))))))
...
;; H
  ...
  (<= (to_rep1
      (rec__partition_refinement__interval__first
      (us_split_fields1
      (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) j2)))) l1)
  (<= l1 (to_rep1
         (rec__partition_refinement__interval__last
         (us_split_fields1
         (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) j2))))))
  (= (to_rep2 (select (map__content f6) l1)) j2))))

;; H
  (assert
  (and (= o15 (length (mk___rep1 p__split_discrs p__split_fields3)))
  (and (in_range9 o15)
  (<= o15 (capacity (mk___rep1 p__split_discrs p__split_fields3))))))
...
;; H
  (assert (and (= o24 k) (in_range8 k)))

;; H
  (assert
  (and
  (= o25 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o24))
  (= (bool_eq o25
     (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o24)) true)))

;; H
  (assert (= o26 (us_split_fields1 o25)))

;; H
  (assert (= o27 (rec__partition_refinement__interval__last o26)))

;; H
  (assert (= o28 (to_rep1 o27)))

;; H
  (assert (= o29 (ite (<= l o28) true false)))
...
;; H
  (assert (= o22 (rec__partition_refinement__interval__first o21)))

;; H
  (assert (= o23 (to_rep1 o22)))

;; H
  (assert (= o30 (ite (<= o23 l) true false)))

;; H
  (assert (= result11 (ite (= o30 true) o29 false)))
