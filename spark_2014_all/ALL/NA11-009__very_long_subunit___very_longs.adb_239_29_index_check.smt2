...
(declare-datatypes ()
((tT69bP1__ref (mk_tT69bP1__ref (tT69bP1__content tdigit_count_typeB)))))
(define-fun tT69bP1__ref___projection ((a tT69bP1__ref)) tdigit_count_typeB
  (tT69bP1__content a))
...
(define-fun us_split_fields_Long_Digits__18__projection ((a us_split_fields2)) us_t1
  (rec__very_longs__very_long__long_digits1 a))

(declare-datatypes ()
((us_split_fields__ref1
 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___18__projection ((a us_split_fields__ref1)) us_split_fields2
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___166 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___166)
                                         (first3 temp___166)
                                         (last3 temp___166))))))

(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1)
                                          (mk___split_fields1
                                          (let ((temp___165 (rec__very_longs__very_long__long_digits
                                                            (us_split_fields1
                                                            r1))))
                                          (of_array1 (to_array temp___165)
                                          (first1 temp___165)
                                          (last1 temp___165))))))
...
(define-fun dynamic_invariant4 ((temp___expr_546 us_rep1)
  ...
  (temp___do_toplevel_545 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_544 true))
                                      (in_range4
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l)))
                                      (to_base temp___expr_546)))
...
(define-fun default_initial_assumption ((temp___expr_549 us_rep1)
  (temp___skip_top_level_550 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_549))) (to_rep
                                                               (rec__very_longs__very_long__length
                                                               (us_split_discrs1
                                                               l)))))
...
(declare-datatypes ()
((t70b__ref (mk_t70b__ref (t70b__content tdigit_count_typeB)))))
(define-fun t70b__ref___projection ((a t70b__ref)) tdigit_count_typeB
  (t70b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___894 (_ BitVec 8)))
  (forall ((temp___895 Int) (temp___896 Int))
  (let ((temp___893 (temp___892 temp___894 temp___895 temp___896)))
  (and
  (=> (dynamic_property6 1 65536 temp___895 temp___896)
  (and (= (first5 temp___893) temp___895) (= (last5 temp___893) temp___896)))
  (forall ((temp___897 Int))
  (= (select (to_array2 temp___893) temp___897) (of_rep1 temp___894))))))))
...
;; H
  (assert
  (= (mk___t2 temp___899 temp___8991) (temp___892 ((_ int2bv 8) 0) 1
                                      (to_rep
                                      (rec__very_longs__very_long__length
                                      (us_split_discrs1 l))))))
...
;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___8991)) (to_rep2 (last4 temp___8991)))
     (+ (- (to_rep2 (last4 temp___8991)) (to_rep2 (first4 temp___8991))) 1)
     0) (ite (<= 1 (to_rep
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___8991)) (to_rep2 (last4 temp___8991)))
  temp___9001))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___9001)) (to_rep2 (last2 temp___9001)))
     (+ (- (to_rep2 (last2 temp___9001)) (to_rep2 (first2 temp___9001))) 1)
...
;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___900 temp___9001)))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___903)))

;; H
  (assert (= temp___9031 o2))

;; H
  (assert (= temp___9032 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___9031 temp___9032))))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___913)
  (<= temp___913 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___913) (select (elts1
                                                           (rec__very_longs__very_long__long_digits1
                                                           result____split_fields2)) temp___913))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
