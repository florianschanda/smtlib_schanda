...
;; H
  (assert (= o66 (+ x_first o65)))

;; H
  (assert (and (= o67 o66) (in_range1 o66)))

;; H
  (assert (= o68 (ite (<= o67 (to_rep (last (rt x)))) true false)))

;; H
  (assert (and (= o62 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o63 (+ x_first o62)))

;; H
  (assert (and (= o64 o63) (in_range1 o63)))

;; H
  (assert (= o69 (ite (<= (to_rep (first (rt x))) o64) true false)))

;; H
  (assert (= result (ite (= o69 true) o68 false)))
...
;; H
  (assert (= o58 (+ m_first o57)))

;; H
  (assert (and (= o59 o58) (in_range1 o58)))

;; H
  (assert (= o60 (ite (<= o59 (to_rep (last (rt m)))) true false)))

;; H
  (assert (and (= o54 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o55 (+ m_first o54)))

;; H
  (assert (and (= o56 o55) (in_range1 o55)))

;; H
  (assert (= o61 (ite (<= (to_rep (first (rt m))) o56) true false)))

;; H
  (assert (= result1 (ite (= o61 true) o60 false)))
...
;; H
  (assert (and (= o49 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o50 (+ aux1_first o49)))

;; H
  (assert (and (= o51 o50) (in_range1 o50)))

;; H
  (assert (= o52 (ite (<= o51 (to_rep aux1__last)) true false)))

;; H
  (assert (and (= o46 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o47 (+ aux1_first o46)))

;; H
  (assert (and (= o48 o47) (in_range1 o47)))

;; H
  (assert (= o53 (ite (<= (to_rep aux1__first) o48) true false)))

;; H
  (assert (= result2 (ite (= o53 true) o52 false)))
...
;; H
  (assert (= o42 (+ aux2_first o41)))

;; H
  (assert (and (= o43 o42) (in_range1 o42)))

;; H
  (assert (= o44 (ite (<= o43 (to_rep aux2__last)) true false)))

;; H
  (assert (and (= o38 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o39 (+ aux2_first o38)))

;; H
  (assert (and (= o40 o39) (in_range1 o39)))

;; H
  (assert (= o45 (ite (<= (to_rep aux2__first) o40) true false)))

;; H
  (assert (= result3 (ite (= o45 true) o44 false)))
...
;; H
  (assert (= o34 (+ aux3_first o33)))

;; H
  (assert (and (= o35 o34) (in_range1 o34)))

;; H
  (assert (= o36 (ite (<= o35 (to_rep aux3__last)) true false)))

;; H
  (assert (and (= o30 (- a_last a_first)) (in_range1 (- a_last a_first))))

;; H
  (assert (= o31 (+ aux3_first o30)))

;; H
  (assert (and (= o32 o31) (in_range1 o31)))

;; H
  (assert (= o37 (ite (<= (to_rep aux3__first) o32) true false)))

;; H
  (assert (= result4 (ite (= o37 true) o36 false)))
...
;; H
  (assert (= o26 (+ aux4_first o25)))

;; H
  (assert (and (= o27 o26) (in_range1 o26)))

;; H
  (assert (= o28 (ite (<= o27 (to_rep aux4__last)) true false)))
...
;; H
  (assert (= o29 (ite (<= (to_rep aux4__first) o17) true false)))

;; H
  (assert (= result5 (ite (= o29 true) o28 false)))
...
;; H
  (assert (= o4 (+ r_first o3)))

;; H
  (assert (and (= o5 o4) (in_range1 o4)))

;; H
  (assert (= o6 (ite (<= o5 (to_rep (last (rt r)))) true false)))
...
;; H
  (assert (= o7 (ite (<= (to_rep (first (rt r))) o2) true false)))
