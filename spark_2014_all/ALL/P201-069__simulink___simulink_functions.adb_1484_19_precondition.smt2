...
;; oexpon__post_axiom
  ...
  (! (=>
     ...
     (fp.lt (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) right))
     (fp.leq (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000) left)))
     ...
     (and
     (=>
     (fp.eq right (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))
     (fp.eq result left))
     (and
     (=>
     (fp.eq left (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000))
     (fp.eq result (fp #b0 #b01111111111 #b0000000000000000000000000000000000000000000000000000)))
     (=>
     (fp.eq left (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))
     (fp.eq result (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000)))))))
     (dynamic_invariant result true false true)))) :pattern ((oexpon left
                                                             right)) )))
