...
(declare-fun bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result () Int)

(declare-fun temp___436 () Int)
...
(declare-fun bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result1 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result2 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result3 () Int)

(declare-fun result__13 () Int)

(declare-fun i12 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result4 () int__ref)

(declare-fun result__14 () Int)

(declare-fun i13 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result5 () Int)
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 31)) (= temp___436 result__)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 31)) (= temp___435 i1)))

;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 31)) (= (mk_int__ref result1) result__18)))
...
;; H
  ...
  (= o (ite (and (<= 1 32) (<= 32 8))
       ...
       i1))))))))
  (= result2 (ite (= o ((_ int2bv 32) 1)) true false))) (= result2 true)))
  (and
  (and
  (and
  (and (= o (shift_right value i1))
  (= o (ite (and (<= 1 32) (<= 32 8))
       ...
       ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) 
       i1))))))))
  (= result2 (ite (= o ((_ int2bv 32) 1)) true false)))
  (not (= result2 true)))
  (and
  ...
  (and
  (and
  (and (=> (<= 0 31) (in_range1 i2)) (=> (<= 0 31) (in_range1 result__3)))
  (and (<= 0 i2) (<= i2 31)))
  (or
  (and
  (and (and (= i2 i4) (= result__3 result__5))
  (and (= i5 i2) (= result__6 result__3))) (= i2 31))
  (and (not (= i2 31))
  (and
  ...
  (= o1 (ite (and (<= 1 32) (<= 32 8))
        ...
        ((_ extract 31 0) (bvlshr ((_ zero_extend 32) value) ((_ int2bv 64) 
        i3))))))))
  (= result5 (ite (= o1 ((_ int2bv 32) 1)) true false))) (= result5 true))))))))))))))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result1 
  bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result3 
  bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result1))

;; H
  (assert
  (= result6 bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result4 
  (mk_int__ref
  bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result5 
  bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result3))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  ...
  (= (shift_right value
     (int__content
     bits_manipulation_unsigned__unsigned_32__functions__msb_index_slow_inline_always__result4)) ((_ int2bv 32) 1))))
(check-sat)
