...
;; H
  ...
  (and (and (<= 1 1) (<= 1 50))
  (and (<= 1 (to_rep1 fullstring__last)) (<= (to_rep1 fullstring__last) 50)))))

;; H
  (assert (= o18 localuser1))

;; H
  (assert (= o18 temp___1043))

;; H
  (assert (= (mk1 1 (to_rep1 fullstring__last)) temp___10431))
