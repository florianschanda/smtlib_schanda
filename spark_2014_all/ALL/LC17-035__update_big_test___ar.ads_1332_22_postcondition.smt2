...
;; range_axiom
  (assert
  (forall ((x et3)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)) )))
...
;; range_axiom
  (assert
  (forall ((x enum1ta)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(declare-fun temp___2914 ((Array Int us_rep1) Int
  us_rep1) (Array Int us_rep1))

;; def_axiom
  (assert
  (forall ((temp___2916 (Array Int us_rep1)))
  (forall ((temp___2917 Int))
  (forall ((temp___2918 us_rep1))
  (let ((temp___2915 (temp___2914 temp___2916 temp___2917 temp___2918)))
  (forall ((temp___2919 Int))
  (ite (= temp___2919 temp___2917)
  (= (select temp___2915 temp___2919) temp___2918)
  (= (select temp___2915 temp___2919) (select temp___2916 temp___2919)))))))))
...
;; H
  (assert
  (= (rec__ar__rec2t__g2 (us_split_fields3 (select a i))) (mk___rep
                                                          (mk___split_fields
                                                          o2 o3))))
...
;; H
  (assert
  (= (rec__ar__rec1t__g1
     (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (select a1 i)))))
  o12))
...
;; H
  (assert
  (= o23 (store a1 i (mk___rep1
                     (mk___split_fields1 o19
                     (mk___rep (mk___split_fields o20 o21)) o22)))))
...
;; H
  (assert
  (= (rec__ar__rec1t__f1
     (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (select a2 i)))))
  o25))
...
;; H
  (assert
  (= o29 (mk___split_fields1
         (rec__ar__rec2t__f2 (us_split_fields3 (select a2 i)))
         (mk___rep (mk___split_fields o27 o28))
         (rec__ar__rec2t__h2 (us_split_fields3 (select a2 i))))))
...
;; H
  ...
  (= o33 (mk___split_fields1
         (rec__ar__rec2t__f2 (us_split_fields3 (select a3 i)))
         (rec__ar__rec2t__g2 (us_split_fields3 (select a3 i))) o32)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1325, characters 0-0
  (not
  (= (bool_eq2 (map__content a5) 5 50
     (temp___2914 a i
     (mk___rep1
     (mk___split_fields1 (of_rep2 e)
     (mk___rep (mk___split_fields (of_rep f) (of_rep1 g))) (of_rep3 h)))) 5
     50) true)))
(check-sat)
(exit)
