...
;; H
  (assert
  (and (= o4 (length s)) (and (in_range3 o4) (<= (+ 0 o4) 2147483647))))

;; H
  (assert (= result1 (ite (< o4 2147483647) true false)))

;; H
  (assert
  (=> (= result1 true)
  (and (= o (length s)) (and (in_range3 o) (<= (+ 0 o) 2147483647)))))

;; H
  (assert (=> (= result1 true) (= o1 (+ o 1))))

;; H
  (assert (=> (= result1 true) (and (= o2 o1) (in_range o1))))

;; H
  (assert
  (=> (= result1 true)
  (and (= o3 (length result__))
