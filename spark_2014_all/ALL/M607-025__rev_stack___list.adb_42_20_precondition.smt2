...
;; H
  (assert (and (= o19 (- i9 first4)) (in_range1 (- i9 first4))))

;; H
  (assert
  (and (= o20 (length2 (mk___rep1 res__split_discrs res__split_fields2)))
  (and (in_range6 o20)
  (<= o20 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))

;; H
  (assert (= result6 (ite (= o20 o19) true false)))

;; H
  (assert
  (=> (= result6 true) (and (= o15 (- last5 i9)) (in_range1 (- last5 i9)))))

;; H
  (assert (=> (= result6 true) (= o16 (+ o15 1))))

;; H
  (assert (=> (= result6 true) (and (= o17 o16) (in_range1 o16))))

;; H
  (assert
  (=> (= result6 true)
  (and (= o14 (to__ (mk___rep s__split_fields9)))
  (and (dynamic_invariant1 o14 true false true)
  (and (= (to_rep (first (rt o14))) 1) (<= 0 (to_rep (last (rt o14)))))))))

;; H
  (assert (=> (= result6 true) (= o18 (to_rep (last (rt o14))))))

;; H
  (assert (=> (= result6 true) (= result5 (ite (= o18 o17) true false))))
...
;; H
  (assert
  (=> (= result5 true) (and (= o10 (- last5 i9)) (in_range1 (- last5 i9)))))
...
;; H
  (assert (=> (= result5 true) (= o13 (ite (<= j1 o12) true false))))

;; H
  (assert (=> (= result5 true) (= result7 (ite (<= 1 j1) o13 false))))
...
;; H
  (assert (and (= o5 (- last5 j)) (in_range1 (- last5 j))))
...
;; H
  ...
  (and (in_range8 o9) (= o9 (get (model__ l) o8)))))
