...
;; copy__post_axiom
  ...
  (! (=>
     ...
     (or (= capacity 0)
     (<= (to_rep
         (rec__p__my_lists__list__capacity (us_split_discrs1 source))) capacity)))
     (let ((result (copy source capacity)))
     (and
     (and (= (oeq (model__ result) (model__ source)) true)
     (= (oeq1 (positions result) (positions source)) true))
     (ite (= capacity 0)
     (= (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 result)))
     (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 source))))
     (= (to_rep (rec__p__my_lists__list__capacity (us_split_discrs1 result))) capacity))))) :pattern (
...
(define-fun equal_except__2 ((left us_rep2) (right us_rep2) (x Int)
  (y Int)) Bool (and (= (length left) (length right)) (ite (forall ((i Int))
                                                           (=>
                                                           (and (<= 1 i)
                                                           (<= i (last left)))
                                                           (=>
...
(define-fun m_elements_swapped ((left us_rep2) (right us_rep2) (x Int)
  (y Int)) Bool (and (and (and (= (length left) (length right)) (= (get left
                                                                   x)
  (get right y))) (= (get left y) (get right x))) (equal_except__2 left right
                                                  x y)))
...
(declare-fun cu2 () us_rep1)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun l_in () us_rep)
...
;; length__post_axiom
  ...
  (! (let ((result (length2 container)))
     ...
     (dynamic_invariant result true false true))) :pattern ((length2
                                                            container)) )))
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant (length1 container)
...
(declare-fun p__identity_swap__l_in__assume () count_type)

(declare-fun p__identity_swap__l_in__assume1 () us_main_type)
...
(define-fun p__identity_swap__l_in__assume2 () us_rep (mk___rep
                                                      (mk___split_discrs
                                                      p__identity_swap__l_in__assume)
                                                      (mk___split_fields
                                                      p__identity_swap__l_in__assume1)))
...
;; H
  (assert
  (and
  (= p__identity_swap__l_in__assume2 (copy
                                     (mk___rep l__split_discrs
                                     (mk___split_fields l__split_fields)) 0))
  (and
  (and
  (= (oeq (model__ p__identity_swap__l_in__assume2)
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true)
  (= (oeq1 (positions p__identity_swap__l_in__assume2)
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))) true))
  (= (to_rep p__identity_swap__l_in__assume) (to_rep
                                             (rec__p__my_lists__list__capacity
                                             l__split_discrs))))))
...
;; WP_parameter_def
 ;; File "p.ads", line 21, characters 0-0
  (not
  (= (element (mk___rep l__split_discrs l__split_fields2) cu1) (element
                                                               l_in cu2))))
(check-sat)
(exit)
