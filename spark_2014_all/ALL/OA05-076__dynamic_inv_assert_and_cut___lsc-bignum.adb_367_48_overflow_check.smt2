...
;; H
  (assert (= o89 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (= o87 (num_of_big_int m m_first o86)))

;; H
  (assert (= o82 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o88 (omultiply o82 o87)))

;; H
  (assert (= o90 (osubtract o88 o89)))

;; H
  (assert (= o79 (from_word32 a_msw3)))
...
;; H
  (assert
  (and (= o73 (base Tuple0))
  (= o73 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o78 (oexpon o73 o77)))

;; H
  (assert (= o80 (omultiply o78 o79)))
...
;; H
  (assert
  (= o72 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o71)))

;; H
  (assert (= o81 (oadd o72 o80)))

;; H
  (assert (= o91 (olt o81 o90)))
...
;; H
  (assert (= o66 (num_of_big_int m m_first o65)))
...
;; H
  (assert
  (and (= o54 (base Tuple0))
  (= o54 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert (= o47 (num_of_big_int c c_first o46)))
...
;; H
  (assert (= o42 (num_of_big_int b b_first o41)))

;; H
  (assert (= o48 (omultiply o42 o47)))

;; H
  (assert (= o61 (omultiply o48 o60)))

;; H
  (assert (= o67 (omod o61 o66)))
