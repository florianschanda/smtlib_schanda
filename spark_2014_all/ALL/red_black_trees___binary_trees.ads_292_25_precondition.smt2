...
(declare-fun temp___822 () (Array Int us_rep1))
...
;; H
  ...
  (= o59 (size
         (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))))
  (and (in_range2 o59) (= o59 (to_rep f__split_fields)))))
...
;; H
  (assert (= result5 (ite (= o60 o59) true false)))
...
;; H
  (assert
  (and
  (= o58 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d))
  (and (in_range2 o58)
  (and
  (= o58 (ite (= d 0)
         (to_rep
  ...
  (ite (not (= o58 0))
  (and
  (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o58) 
  d)
  (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o58) 
  i))
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 100))
  (=>
...
;; H
  (assert (= result6 (ite (= v o58) true false)))
...
;; H
  (assert (= o55 (select temp___826 j)))
...
;; H
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___825 o51))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___825 o51)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 o51))
...
;; H
  (assert (= o52 (select temp___825 j)))
...
;; H
  ...
  (= temp___822 (model__
                (mk___rep2 (us_split_fields__content2 f__split_fields7))
                root))
  (and (dynamic_invariant3 temp___822 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___822 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___822 root)))) 0)
  (and
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=> (not (= i1 root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___822 (parent
                             (mk___rep2
                             (us_split_fields__content2 f__split_fields7))
                             i1)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___822 i1))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___822 i1))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___822 i1)))) 0))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___822 j1))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___822 i1)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___822 j1)))) true))
  (= j1 i1))))))))))))))
...
;; H
  ...
  (= temp___823 (ite (= d 0)
                ...
                i))))))
  (and
  (ite (not (= temp___823 0))
  (and
  (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7))
     temp___823) d)
  (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7))
     temp___823) i))
  (forall ((j1 Int))
...
;; H
  (assert (and (<= 1 temp___823) (<= temp___823 100)))

;; H
  (assert (= o46 temp___823))

;; H
  (assert (= o47 (select temp___822 o46)))
