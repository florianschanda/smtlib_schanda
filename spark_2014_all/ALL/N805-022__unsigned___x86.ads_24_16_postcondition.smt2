...
;; H
  (assert (= result x86__ecx__result))

;; H
  (assert
  (= x86__ecx__result1 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep
                                                                (select
                                                                xcx 0))) (bvmul ((_ zero_extend 24)
...
;; H
  (assert (= (mk_t__ref1 x86__ecx__result4) (mk_t__ref1 x86__ecx__result2)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 5, characters 0-0
  (not
  (= x86__ecx__result4 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep
                                                                (select
                                                                xcx 0))) (bvmul ((_ zero_extend 24)
  (to_rep (select xcx 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24)
  (to_rep (select xcx 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24)
