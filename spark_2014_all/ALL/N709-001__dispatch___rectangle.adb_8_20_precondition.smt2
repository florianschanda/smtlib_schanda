...
(declare-fun rec____split_fields8 () integer)

(declare-fun rec____split_fields9 () integer)

(declare-fun rec____split_fields10 () integer)

(declare-fun rec____split_fields11 () us_private)

(declare-fun result () Bool)

(declare-fun object__set_area__obj__fields () integer)

(declare-fun object__set_area__obj__fields1 () integer)

(declare-fun object__set_area__obj__fields2 () integer)

(declare-fun object__set_area__obj__fields3 () us_private)
...
(declare-fun rec____split_fields14 () integer)

(declare-fun rec____split_fields15 () integer)

(declare-fun rec____split_fields16 () integer)

(declare-fun rec____split_fields17 () us_private)
