...
(define-fun rec____split_fields18 () us_split_fields2 (mk___split_fields1
                                                      rec____split_fields12
                                                      rec____split_fields13
                                                      rec____split_fields14
                                                      rec____split_fields15
                                                      rec____split_fields16
                                                      rec____split_fields17))

(define-fun object__set_area__obj__fields4 () us_split_fields (mk___split_fields
                                                              object__set_area__obj__fields
                                                              object__set_area__obj__fields1
                                                              object__set_area__obj__fields2
                                                              object__set_area__obj__fields3))
...
;; H
  ...
  (and
  (= (has_stored_area
     (mk___rep object__set_area__obj__fields4 rec____attr__tag)) true)
  (= o2 (get_stored_area
        (mk___rep object__set_area__obj__fields4 rec____attr__tag))))))

;; H
  (assert
  (=> (= result true)
  (= (mk___split_fields__ref1
     (mk___split_fields1 result1 result2 result3 result4 result5 result6))
  (mk___split_fields__ref1
  (mk___split_fields1 rec____split_fields rec____split_fields1
  rec____split_fields2 rec____split_fields3 rec____split_fields4
  rec____split_fields5)))))

;; H
  (assert
  (=> (= result true)
  (= rec____split_fields18 (us_split_fields3
                           (of_base
                           (mk___rep object__set_area__obj__fields4
                           rec____attr__tag))))))

;; H
  (assert
  (=> (not (= result true)) (= rec____split_fields rec____split_fields12)))

;; H
  (assert
  (=> (not (= result true)) (= rec____split_fields1 rec____split_fields13)))

;; H
  (assert
  (=> (not (= result true)) (= rec____split_fields2 rec____split_fields14)))

;; H
  (assert
  (=> (not (= result true)) (= rec____split_fields3 rec____split_fields15)))

;; H
  (assert
  (=> (not (= result true)) (= rec____split_fields4 rec____split_fields16)))

;; H
  (assert
  (=> (not (= result true)) (= rec____split_fields5 rec____split_fields17)))

;; H
  (assert
  (=> (not (= result true))
  (= rec____split_fields18 (mk___split_fields1 rec____split_fields6
                           rec____split_fields7 rec____split_fields8
                           rec____split_fields9 rec____split_fields10
...
;; WP_parameter_def
 ;; File "rectangle.ads", line 9, characters 0-0
  ...
  (= (has_stored_area
     (mk___rep
     (mk___split_fields rec____split_fields14 rec____split_fields15
     rec____split_fields16
     (hide_ext__ rec____split_fields12 rec____split_fields13
     rec____split_fields17)) rec____attr__tag)) true)))
(check-sat)
(exit)
