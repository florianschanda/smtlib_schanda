...
(declare-datatypes ()
((tS2bP1__ref (mk_tS2bP1__ref (tS2bP1__content tindexB)))))
...
(declare-fun temp___397 () (Array Int integer))

(declare-fun temp___3971 () t)

(declare-fun temp___398 () (Array Int integer))
...
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 6, characters 0-0
  ...
  (= (let ((temp___405 (temp___224
                       ...
                       (+ i 1) new_val)))
     (bool_eq3 a2 (to_rep a__first) (to_rep a__last) (elts temp___405)
