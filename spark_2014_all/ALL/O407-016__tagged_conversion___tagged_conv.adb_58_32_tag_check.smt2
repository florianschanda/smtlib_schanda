...
(declare-fun rc () us_rep)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun rc2__attr__tag () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun rc3__attr__tag () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS3 () Int)

(declare-fun rc4__attr__tag () Int)
...
(declare-fun rc2__split_fields () us_private)

(declare-fun rc3__split_fields () us_private)

(declare-fun result () us_private)

(declare-fun rc2__split_fields1 () us_private)

(declare-fun result1 () us_private)

(declare-fun rc3__split_fields1 () us_private)
