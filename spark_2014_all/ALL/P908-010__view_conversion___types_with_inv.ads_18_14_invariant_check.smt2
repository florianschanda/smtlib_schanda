...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__types_with_inv__r1__f integer)))))
...
(declare-fun types_with_inv__r1__f__first__bit () Int)

(declare-fun types_with_inv__r1__f__last__bit () Int)

(declare-fun types_with_inv__r1__f__position () Int)
...
(define-fun default_initial_assumption ((temp___expr_150 us_rep)
  (temp___skip_top_level_151 Bool)) Bool (= (to_rep
...
(declare-fun types_with_inv__r1__f__first__bit1 () Int)

(declare-fun types_with_inv__r1__f__last__bit1 () Int)

(declare-fun types_with_inv__r1__f__position1 () Int)
...
(define-fun type_invariant ((temp___158 us_rep)) Bool (not
                                                      (= (to_rep
                                                         (rec__types_with_inv__r1__f
                                                         (us_split_fields1
                                                         temp___158))) 0)))
...
(declare-fun types_with_inv__set_to_zero__2__x__fields () integer)

(declare-fun result () integer)

(declare-fun x__split_fields1 () integer)

(declare-fun types_with_inv__set_to_zero__2__x__fields1 () integer)
...
;; H
  (assert
  (= (mk___split_fields x__split_fields1) (mk___split_fields
                                          types_with_inv__set_to_zero__2__x__fields)))
...
;; H
  (assert
  (= (mk___split_fields x__split_fields2) (mk___split_fields
                                          types_with_inv__set_to_zero__2__x__fields1)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (to_rep x__split_fields3) 0))))
(check-sat)
