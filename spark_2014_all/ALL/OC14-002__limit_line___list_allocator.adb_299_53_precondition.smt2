...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o69) true false))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o68 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o66) true false)))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o65 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o65))))))
...
;; H
  ...
  (=> (not (= first_allocated2 0))
  (=> (= result14 true)
  (= result11 (ite (= o65 first_allocated2) true false))))))
...
;; H
  (assert (= result17 (ite (in_range4 o62) true false)))
