...
(declare-fun dummy1 () tdigit_count_typeB)
...
(declare-fun dummy4 () tdigit_count_typeB)
...
(declare-fun dummy7 () tdigit_count_typeB)

(declare-datatypes ()
((tT23bP1__ref (mk_tT23bP1__ref (tT23bP1__content tdigit_count_typeB)))))
(define-fun tT23bP1__ref___projection ((a tT23bP1__ref)) tdigit_count_typeB
  (tT23bP1__content a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a)
                                         (mk___split_fields
                                         (let ((temp___142 (rec__very_longs__very_long__long_digits1
                                                           (us_split_fields3
                                                           a))))
                                         (of_array (to_array1 temp___142)
                                         (first3 temp___142)
                                         (last3 temp___142))))))

(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r)
                                         (mk___split_fields1
                                         (let ((temp___141 (rec__very_longs__very_long__long_digits
                                                           (us_split_fields1
                                                           r))))
                                         (of_array1 (to_array temp___141)
                                         (first1 temp___141)
                                         (last1 temp___141))))))
...
(define-fun dynamic_invariant2 ((temp___expr_384 us_rep1)
  (temp___is_init_381 Bool) (temp___skip_constant_382 Bool)
  (temp___do_toplevel_383 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_382 true))
                                      (in_range4 length1
                                      (to_base temp___expr_384)))
                                      (and (dynamic_property3 1 length1
                                      (first3
                                      (rec__very_longs__very_long__long_digits1
                                      ...
                                      (= (first3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_384))) 1)
                                      (= (last3
                                         (rec__very_longs__very_long__long_digits1
                                         (us_split_fields3 temp___expr_384)))
                                      length1)))))

(define-fun default_initial_assumption ((temp___expr_387 us_rep1)
  (temp___skip_top_level_388 Bool)) Bool (= (to_rep
                                            (rec__very_longs__very_long__length
                                            (us_split_discrs2
                                            temp___expr_387))) length1))
...
(declare-datatypes ()
((t24b__ref (mk_t24b__ref (t24b__content tdigit_count_typeB)))))
(define-fun t24b__ref___projection ((a t24b__ref)) tdigit_count_typeB
  (t24b__content a))
...
;; def_axiom
  (assert
  (forall ((temp___796 (_ BitVec 8)))
  (forall ((temp___797 Int) (temp___798 Int))
  (let ((temp___795 (temp___794 temp___796 temp___797 temp___798)))
  (and
  (=> (dynamic_property6 1 65536 temp___797 temp___798)
  (and (= (first5 temp___795) temp___797) (= (last5 temp___795) temp___798)))
  (forall ((temp___799 Int))
  (= (select (to_array2 temp___795) temp___799) (of_rep1 temp___796))))))))
...
(declare-fun very_longs__make_from_natural__result () digit_index_type)

(declare-fun very_longs__make_from_natural__result1 () (Array Int octet))

(declare-fun very_longs__make_from_natural__result2 () t)

(declare-fun us () Int)

(declare-fun temp___801 () (Array Int octet))

(declare-fun temp___8011 () t2)

(declare-fun temp___802 () (Array Int octet))

(declare-fun temp___8021 () t1)
...
(declare-fun temp___805 () digit_index_type)

(declare-fun temp___8051 () (Array Int octet))

(declare-fun temp___8052 () t1)

(declare-fun temp___810 () digit_index_type)

(declare-fun temp___8101 () (Array Int octet))

(declare-fun temp___8102 () t1)
...
(declare-fun temp___808 () us_rep1)
...
(declare-fun very_longs__make_from_natural__result3 () us_rep)

(declare-fun very_longs__make_from_natural__result4 () very_long__ref)

(declare-fun very_longs__make_from_natural__result5 () us_rep)
...
(declare-fun very_longs__make_from_natural__result6 () very_long__ref)
...
(declare-fun very_longs__make_from_natural__result7 () us_rep)
...
;; H
  (assert
  (= (to_rep2 (first4 (rt2 (temp___794 ((_ int2bv 8) 0) 1 length1)))) 1))

;; H
  (assert
  (= (to_rep2 (last4 (rt2 (temp___794 ((_ int2bv 8) 0) 1 length1))))
  length1))

;; H
  (assert
  (= (mk___t2 temp___801 temp___8011) (temp___794 ((_ int2bv 8) 0) 1 length1)))

;; H
  (assert
  (= (ite (<= (to_rep2 (first4 temp___8011)) (to_rep2 (last4 temp___8011)))
     (+ (- (to_rep2 (last4 temp___8011)) (to_rep2 (first4 temp___8011))) 1)
     0) (ite (<= 1 length1) (+ (- length1 1) 1) 0)))
...
;; H
  (assert
  (= (mk1 (to_rep2 (first4 temp___8011)) (to_rep2 (last4 temp___8011)))
  temp___8021))

;; H
  (assert
  (= (ite (<= (to_rep2 (first2 temp___8021)) (to_rep2 (last2 temp___8021)))
     (+ (- (to_rep2 (last2 temp___8021)) (to_rep2 (first2 temp___8021))) 1)
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___8051 temp___8052))))
...
;; H
  ...
  (= (to_rep2
     (last2
     (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields2))))
  r26b))
...
;; H
  ...
  (and (= result____split_discrs (mk___split_discrs temp___810))
  (= result____split_fields2 (mk___split_fields1
                             (mk___t1 temp___8101 temp___8102))))))

;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= temp___809 temp1)))
...
;; H
  ...
  (and
  (and
  (and (=> (<= 0 2147483647) (in_range1 temp2)) (dynamic_invariant2
  (mk___rep1 result____split_discrs result____split_fields3) false true
  true))
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___812)
  (<= temp___812 (to_rep2
                 (last2
                 (rt1
                 (rec__very_longs__very_long__long_digits1
  ...
  (= (select (elts1
             (rec__very_longs__very_long__long_digits1
             result____split_fields3)) temp___812) (select temp___8101 temp___812))))))
...
;; H
  (assert (=> (and (<= 1 index1) (<= index1 r26b)) (= (to_rep1 o6) o5)))
...
;; H
  ...
  (<= (to_rep2
      (first2
      (rt1
      (rec__very_longs__very_long__long_digits1 result____split_fields3))))
  index2)
  (<= index2 (to_rep2
             (last2
             (rt1
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= temp___808 (mk___rep1 result____split_discrs o10))))
...
;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= result____split_fields4 (us_split_fields3 temp___808))))

;; H
  (assert
  (=> (and (<= 1 index1) (<= index1 r26b))
  (= result____split_discrs (us_split_discrs2 temp___808))))
...
;; H
  (assert
  (= very_longs__make_from_natural__result4 (mk_very_long__ref
                                            very_longs__make_from_natural__result3)))

;; H
  (assert
  (= very_longs__make_from_natural__result5 very_longs__make_from_natural__result3))

;; H
  (assert
  (= result5 (mk_very_long__ref
             (mk___rep
             (mk___split_discrs very_longs__make_from_natural__result)
             (mk___split_fields
             (mk___t very_longs__make_from_natural__result1
             very_longs__make_from_natural__result2))))))

;; H
  (assert
  (= very_longs__make_from_natural__result3 (to_base
                                            (mk___rep1 result____split_discrs
...
;; H
  (assert
  (= very_longs__make_from_natural__result6 very_longs__make_from_natural__result4))
...
;; H
  (assert
  (= very_longs__make_from_natural__result7 very_longs__make_from_natural__result5))
...
;; H
  ...
  (= (mk___rep (mk___split_discrs result6)
     (mk___split_fields (mk___t result7 result8))) (very_long__content
                                                   very_longs__make_from_natural__result6)))
...
;; WP_parameter_def
 ;; File "very_longs.ads", line 84, characters 0-0
  ...
  (= (to_rep
     (rec__very_longs__very_long__length
     (us_split_discrs1
     (very_long__content very_longs__make_from_natural__result6)))) length1)))
(check-sat)
(exit)
