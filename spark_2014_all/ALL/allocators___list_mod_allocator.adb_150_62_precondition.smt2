...
(define-fun o18 () us_rep3 (mk___rep1 (mk___split_fields1 o5 o6)))
...
;; H
  (assert
  (and (= result1 (is_well_formed data first_available))
  (= (= result1 true)
  (and
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data r1)))) 0)
  (not
  (= (to_rep
     (rec__list_mod_allocator__cell__next
     (us_split_fields1 (select data r1)))) 0)))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (and (= o18 (model__ data first_available))
  (= (model_is_well_formed o18 data first_available) true)))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o5 o7))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o6 o8))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o9 o7))))
...
;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o o2))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o1 o3))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o4 o2))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (and (= temp___301 (get o4 o10)) (in_range5 temp___301)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (and (<= 1 temp___301) (<= temp___301 10000)))))

;; H
  (assert
  (=> (= result1 true) (=> (not (= first_available 0)) (= o11 temp___301))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (= (mk___rep (mk___split_fields o12 o13)) (select data o11)))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o12 o14))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o13 o15))))

;; H
  (assert (=> (= result1 true) (=> (not (= first_available 0)) (= o16 o15))))

;; H
  (assert
  (=> (= result1 true) (=> (not (= first_available 0)) (= o17 (to_rep o16)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result (ite (= o17 0) true false)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_available 0))) (= result (of_int 1)))))
