...
;; H
  (assert
  (and (= temp___1783 (+ (to_rep1 (first (rt source))) 4)) (in_range1
  (+ (to_rep1 (first (rt source))) 4))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1783)
  (<= temp___1783 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1782 (+ (to_rep1 (first (rt source))) 3)) (in_range1
  (+ (to_rep1 (first (rt source))) 3))))

;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1782)
  (<= temp___1782 (to_rep1 (last (rt source))))))
...
;; H
  (assert
  (and (= temp___1781 (+ (to_rep1 (first (rt source))) 2)) (in_range1
...
;; H
  (assert
  (and (= temp___1780 (+ (to_rep1 (first (rt source))) 1)) (in_range1
...
;; H
  (assert
  (and (= temp___1779 (+ (to_rep1 (first (rt source))) 0)) (in_range1
