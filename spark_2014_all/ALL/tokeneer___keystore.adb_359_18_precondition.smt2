...
(define-fun bool_eq12 ((a (Array Int unsigned32t)) (a__first Int)
...
(declare-fun temp___1291 () (Array Int character))

(declare-fun temp___12911 () t2)

(declare-fun temp___1295 () (Array Int character))

(declare-fun temp___12951 () t2)

(declare-fun o16 () (Array Int character))

(declare-fun temp___1290 () (Array Int character))

(declare-fun temp___12901 () t)
...
(declare-fun temp___1304 () us_t3)

(declare-fun temp___1308 () us_t3)

(declare-fun o25 () (Array Int character))

(declare-fun temp___1303 () us_t)
...
;; H
  ...
  (= (select o7 temp___1283) (select result__5 temp___1283)))))))
...
;; H
  (assert
  (=> (= (select issystem retvaldo2) true) (=> (not (<= 1 39)) (= o10 0))))

;; H
  (assert (=> (= (select issystem retvaldo2) true) (= o11 (+ o10 o9))))

;; H
  (assert (=> (= (select issystem retvaldo2) true) (= o12 (+ 1 o11))))

;; H
  (assert (=> (= (select issystem retvaldo2) true) (= o13 (- o12 1))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true) (and (= o14 o13) (in_range2 o13))))
...
;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (= (mk 1 o14) keystore__dofind__B86b__thestring__assume1)))
...
;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (and (= o15 (length thestring1)) (in_range1 (length thestring1)))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (= result9 (ite (<= o15 150) true false))))
...
;; H
  ...
  (=> (= (select issystem retvaldo2) true)
  (=> (= result9 true)
  (= (mk___t2 temp___1295 temp___12951) (mk___t2 temp___1291 temp___12911)))))
...
;; H
  ...
  (= (select o16 temp___1296) (select temp___1295 temp___1296))
  (= (select o16 temp___1296) (select result__8 temp___1296)))))))
...
;; H
  ...
  (=> (= (select issystem retvaldo2) true)
  (=> (not (= result9 true))
  (= (mk___t temp___1290 temp___12901) thestring1))))

;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (not (= result9 true)) (= o17 temp___1290))))
...
;; H
  (assert
  (=> (= (select issystem retvaldo2) true)
  (=> (not (= result9 true)) (= result__10 o17))))
...
;; H
  (assert (=> (<= 1 44) (= o19 (+ (- 44 1) 1))))

;; H
  (assert (=> (not (<= 1 44)) (= o19 0)))
...
;; H
  (assert (and (= o24 (length thestring2)) (in_range1 (length thestring2))))

;; H
  (assert (= result14 (ite (<= o24 150) true false)))
...
;; H
  (assert
  (=> (= result14 true)
  (= (ite (<= (to_rep1 (first6 (rt3 temp___1304))) (to_rep1
                                                   (last6 (rt3 temp___1304))))
     (+ (- (to_rep1 (last6 (rt3 temp___1304))) (to_rep1
                                               (first6 (rt3 temp___1304)))) 1)
     0) (ite (<= (to_rep1 (first6 (mk3 1 (length thestring2)))) (to_rep1
                                                                (last6
                                                                (mk3 1
                                                                (length
                                                                thestring2)))))
        (+ (- (to_rep1 (last6 (mk3 1 (length thestring2)))) (to_rep1
                                                            (first6
                                                            (mk3 1
                                                            (length
                                                            thestring2))))) 1)
...
;; H
  (assert (=> (= result14 true) (= temp___1308 temp___1304)))

;; H
  (assert
  (=> (= result14 true)
  (forall ((temp___1309 Int))
  (ite (and (<= 1 temp___1309) (<= temp___1309 (length thestring2)))
  (= (select o25 temp___1309) (select (elts3 temp___1308) temp___1309))
  (= (select o25 temp___1309) (select result__11 temp___1309))))))

;; H
  (assert (=> (= result14 true) (= result15 (mk_map__ref result__11))))

;; H
  (assert (=> (= result14 true) (= result__12 o25)))
...
;; H
  (assert (=> (not (= result14 true)) (= temp___1303 thestring2)))

;; H
  (assert (=> (not (= result14 true)) (= o26 (elts temp___1303))))

;; H
  (assert (=> (not (= result14 true)) (= result16 (mk_map__ref result__11))))

;; H
  (assert (=> (not (= result14 true)) (= result__13 o26)))
