...
(declare-const temp___1307 us_t3)
...
;; H
  (assert
  (=> (= result14 true)
  (and (= temp___1306 (length thestring2)) (in_range1 (length thestring2)))))
...
;; H
  ...
  (=> (<= 1 temp___1306)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1306) (<= temp___1306 150))))))
...
;; H
  (assert
  (=> (= result14 true) (= temp___1307 (mk___t3 o27 (mk3 1 temp___1306)))))
...
;; H
  ...
  (= (ite (<= (to_rep1 (first6 (rt3 temp___1304))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first6 (rt3 temp___1307))) (to_rep1
                                                      (last6
                                                      (rt3 temp___1307))))
        (+ (- (to_rep1 (last6 (rt3 temp___1307))) (to_rep1
                                                  (first6 (rt3 temp___1307)))) 1)
        0))))
...
;; H
  ...
  (= (select o28 temp___1309) (select (elts3 temp___1308) temp___1309))
  (= (select o28 temp___1309) (select result__11 temp___1309))))))
...
;; H
  (assert (=> (not (= result14 true)) (= o29 (elts temp___1303))))
