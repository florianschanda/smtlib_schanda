...
(declare-const r (Array (_ BitVec 64) Bool))

(declare-const fail__create__result (Array (_ BitVec 64) Bool))

(declare-const fail__create__result1 t)

(declare-const temp___637 (Array (_ BitVec 64) Bool))

(declare-const temp___6371 t2)

(declare-const fail__create__r__assume (Array (_ BitVec 64) Bool))

(declare-const fail__create__r__assume1 t1)

(declare-const result (Array (_ BitVec 64) Bool))

(declare-const r1 (Array (_ BitVec 64) Bool))

(declare-const result1 (Array (_ BitVec 64) Bool))

(declare-const result2 t)

(declare-const fail__create__result2 (Array (_ BitVec 64) Bool))

(declare-const fail__create__result3 t)

(declare-const fail__create__result4 (Array (_ BitVec 64) Bool))

(declare-const fail__create__result5 t)

(declare-const fail__create__result6 (Array (_ BitVec 64) Bool))

(declare-const fail__create__result7 t)

(declare-const r2 (Array (_ BitVec 64) Bool))

(declare-const fail__create__result8 (Array (_ BitVec 64) Bool))

(declare-const fail__create__result9 t)

(declare-const r3 (Array (_ BitVec 64) Bool))

(declare-const fail__create__result10 (Array (_ BitVec 64) Bool))

(declare-const fail__create__result11 t)

(declare-const result3 (Array (_ BitVec 64) Bool))
