...
;; H
  (assert
  (=> (not (= result3 true))
  (=> (= result5 true) (and (= o6 (- j2 1)) (in_range2 (- j2 1))))))
...
;; H
  ...
  (=> (not (= result5 true))
  (and
  (and (= (= (select a1 i2) true) (= (select a j2) true))
  (= (= (select a1 j2) true) (= (select a i2) true)))
  (forall ((k Int))
  (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last)))
  (=> (and (not (= k i2)) (not (= k j2)))
  (= (= (select a1 k) true) (= (select a k) true)))))))))

;; H
  (assert
  (=> (not (= result3 true))
  (=> (not (= result5 true)) (and (= o7 (+ i2 1)) (in_range2 (+ i2 1))))))

;; H
  (assert
  (=> (not (= result3 true)) (=> (not (= result5 true)) (= i2 result7))))
...
;; H
  (assert
  (=> (not (= result3 true))
  (=> (not (= result5 true)) (and (= o8 (- j2 1)) (in_range2 (- j2 1))))))

;; H
  (assert
  (=> (not (= result3 true)) (=> (not (= result5 true)) (= j2 result8))))
