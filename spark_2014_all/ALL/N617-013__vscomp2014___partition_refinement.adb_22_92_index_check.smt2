...
;; H
  ...
  (= temp___5013 (get
                 ...
                 (mk___split_fields1 p__split_fields))) j3))
  (= (bool_eq temp___5013
     (get
     (model__
     (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))
...
;; H
  ...
  (and
  (<= (to_rep1
      (rec__partition_refinement__interval__first p_prime__split_fields3)) j4)
  (<= j4 i2)) (= (to_rep2 (select f2 j4)) p_prime_index2))))
...
;; H
  ...
  (= (to_rep2 (select f2 j4)) (to_rep2 (select f j4))))))
