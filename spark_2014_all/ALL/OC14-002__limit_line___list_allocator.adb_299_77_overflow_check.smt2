...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o68) true false))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o67 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o65) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated2 0))
  (=> (= result14 true)
  (= result11 (ite (= o64 first_allocated2) true false))))))
