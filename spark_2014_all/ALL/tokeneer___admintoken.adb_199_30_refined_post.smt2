...
(declare-fun idcertcontents__split_fields2 () us_split_fields12)
...
(declare-fun authcertcontents__split_fields2 () us_split_fields8)
...
(declare-fun roleok2 () Bool)

(declare-fun result6 () Bool)

(declare-fun roleok3 () Bool)

(declare-fun result7 () Bool)

(declare-fun authvalid2 () Bool)

(declare-fun result8 () Bool)

(declare-fun idvalid2 () Bool)

(declare-fun result9 () Bool)

(declare-fun roleok4 () Bool)
...
(declare-fun result12 () us_split_fields__ref8)

(declare-fun idcert__split_fields1 () us_split_fields16)

(declare-fun result13 () us_split_fields__ref7)
...
(declare-fun description4 () map__ref)

(declare-fun tokenok2 () bool__ref)

(declare-fun status3 () us_private__ref)

(declare-fun tokentry2 () int__ref)

(declare-fun tokenid3 () int__ref)

(declare-fun authcert__split_fields2 () us_split_fields__ref7)

(declare-fun idcert__split_fields2 () us_split_fields__ref8)

(declare-fun authvalid3 () bool__ref)

(declare-fun idvalid3 () bool__ref)

(declare-fun roleok5 () bool__ref)

(declare-fun authcertcontents__split_fields3 () us_split_fields__ref4)

(declare-fun idcertcontents__split_fields3 () us_split_fields__ref6)
...
(declare-fun tokenok3 () Bool)

(declare-fun status4 () us_private)

(declare-fun tokentry3 () Int)

(declare-fun tokenid4 () Int)

(declare-fun authcert__split_fields3 () us_split_fields14)

(declare-fun idcert__split_fields3 () us_split_fields16)

(declare-fun authvalid4 () Bool)

(declare-fun idvalid4 () Bool)

(declare-fun roleok6 () Bool)

(declare-fun authcertcontents__split_fields4 () us_split_fields8)

(declare-fun idcertcontents__split_fields4 () us_split_fields12)
...
;; H
  (assert
  (=> (= tokentry1 2) (and (= o1 (thetokenid state1)) (in_range4 o1))))

;; H
  (assert
  (=> (= tokentry1 2) (= (mk_int__ref result1) (mk_int__ref tokenid))))
...
;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (and
  (= o2 (therole
        (mk___rep4
...
;; H
  ...
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (= result2 (ite (in_range6 o2) true false)))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (= result2 true) (= result3 roleok)))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (= result2 true) (= roleok1 (of_int 1))))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (= result2 true) (= description2 description1)))))
...
;; H
  ...
  (=> (not (= result2 true))
  (= o3 (makedescription
        (mk___t (temp___String_Literal_1343 Tuple0) (mk 1 47))))))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (not (= result2 true)) (= result4 description1)))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (not (= result2 true)) (= description2 o3)))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (not (= result2 true)) (= result5 roleok)))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (not (= result2 true)) (= roleok2 (of_int 0))))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (= (ite (= idvalid1 true) authvalid1 false) true)
  (=> (not (= result2 true)) (= roleok1 roleok2)))))

;; H
  (assert
  (=> (= tokentry1 2)
  (=> (not (= (ite (= idvalid1 true) authvalid1 false) true))
  (= result6 roleok))))
...
;; H
  (assert
  (=> (not (= tokentry1 2))
  (= (mk_bool__ref result7) (mk_bool__ref authvalid))))
...
;; H
  (assert
  (=> (not (= tokentry1 2))
  (= (mk_bool__ref result8) (mk_bool__ref idvalid))))
...
;; H
  (assert
  (=> (not (= tokentry1 2)) (= (mk_bool__ref result9) (mk_bool__ref roleok))))
...
;; H
  ...
  (=> (not (= tokentry1 2))
  (= o4 (makedescription
        (mk___t (temp___String_Literal_1342 Tuple0) (mk 1 9))))))
...
;; H
  ...
  (= (let ((subject idcertcontents__split_fields))
     (mk___split_fields__ref6 idcertcontents__split_fields2)) (let ((subject
...
;; H
  ...
  (=> (not (= tokentry1 2))
  (= (let ((subject authcertcontents__split_fields))
     (mk___split_fields__ref4 authcertcontents__split_fields2)) (let ((subject
                                                                authcertcontents__split_fields))
...
;; H
  (assert
  (= tokenok1 (ite (= (ite (= authvalid1 true) idvalid1 false) true)
              roleok1 false)))
...
;; H
  (assert
  (= idcertcontents__split_fields3 (let ((subject idcertcontents__split_fields))
                                   (mk___split_fields__ref6
                                   idcertcontents__split_fields2))))

;; H
  (assert
  (= authcertcontents__split_fields3 (let ((subject authcertcontents__split_fields))
                                     (mk___split_fields__ref4
                                     authcertcontents__split_fields2))))
...
;; H
  (assert
  (= authcertcontents__split_fields4 authcertcontents__split_fields2))
...
;; WP_parameter_def
 ;; File "admintoken.ads", line 40, characters 0-0
  (not
  (= (rec__admintoken__valididcertt__valid
     (us_split_fields__content8 idcert__split_fields2)) true)))
(check-sat)
(exit)
