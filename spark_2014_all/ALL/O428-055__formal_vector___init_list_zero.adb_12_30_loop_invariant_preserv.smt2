...
(declare-fun loop_types__lists__list__capacity__first__bit () Int)

(declare-fun loop_types__lists__list__capacity__last__bit () Int)

(declare-fun loop_types__lists__list__capacity__position () Int)
...
(declare-fun loop_types__lists__cursor__node__first__bit () Int)

(declare-fun loop_types__lists__cursor__node__last__bit () Int)

(declare-fun loop_types__lists__cursor__node__position () Int)
...
(define-fun dynamic_invariant ((temp___expr_383 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_389 Int)
...
(define-fun dynamic_invariant2 ((temp___expr_408 Int)
...
(declare-fun loop_types__lists__list__capacity__first__bit1 () Int)

(declare-fun loop_types__lists__list__capacity__last__bit1 () Int)

(declare-fun loop_types__lists__list__capacity__position1 () Int)
...
(declare-datatypes ()
((list_t__ref (mk_list_t__ref (list_t__content us_rep)))))
...
;; length__post_axiom
  ...
  (! (let ((result (length2 container)))
     ...
     (dynamic_invariant3 result true false true))) :pattern ((length2
                                                             container)) )))
...
;; length__post_axiom
  (assert
  (forall ((container us_rep3)) (! (dynamic_invariant3 (length1 container)
...
(declare-fun init_list_zero__cu__assume () count_type)
...
(declare-fun loop_types__lists__replace_element__container__fields () us_main_type)
...
(define-fun loop_types__lists__replace_element__container__fields1 () us_split_fields
  (mk___split_fields loop_types__lists__replace_element__container__fields))
...
(define-fun init_list_zero__cu__assume1 () us_rep1 (mk___rep1
                                                   (mk___split_fields1
...
;; H
  (assert
  (and
  (= init_list_zero__cu__assume1 (first
  ...
  (= (bool_eq1 init_list_zero__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     init_list_zero__cu__assume1) true)
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     init_list_zero__cu__assume1) 1)))))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields4))
           (mk___rep1 cu__split_fields4)) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields4)) i) 0))))

;; H
  (assert
  (= (has_key (positions (mk___rep l__split_discrs l__split_fields4))
...
;; H
  ...
  (= (length2
     (mk___rep l__split_discrs
     loop_types__lists__replace_element__container__fields1)) (length2
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields4)))
  (= (oeq1 (positions (mk___rep l__split_discrs l__split_fields4))
     (positions
     (mk___rep l__split_discrs
     loop_types__lists__replace_element__container__fields1))) true))
  (= (get
     (model__
     (mk___rep l__split_discrs
     loop_types__lists__replace_element__container__fields1))
     (get1
     (positions
     (mk___rep l__split_discrs
     loop_types__lists__replace_element__container__fields1))
     (mk___rep1 cu__split_fields4))) 0))
  (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields4))
     (model__
     (mk___rep l__split_discrs
     loop_types__lists__replace_element__container__fields1))
     (get1
...
;; H
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields3))
     (mk___rep1 cu__split_fields3)) (+ (get1
                                       (positions
                                       (mk___rep l__split_discrs
                                       l__split_fields3))
                                       (mk___rep1 cu__split_fields4)) 1)))))
...
;; H
  (assert
  (and
  (= o (has_key (positions (mk___rep l__split_discrs l__split_fields3))
...
;; WP_parameter_def
 ;; File "init_list_zero.adb", line 5, characters 0-0
  (not (= (get (model__ (mk___rep l__split_discrs l__split_fields3)) i) 0)))
(check-sat)
(exit)
