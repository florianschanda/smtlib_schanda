...
;; H
  ...
  (=> (= result2 true)
  (and
  (= o20 (next (mk___rep s__split_discrs s__split_fields3)
         (mk___rep1 cu__split_fields2)))
  ...
  (= (bool_eq1 o20 no_element) true)
  (and
  (= (has_key (positions (mk___rep s__split_discrs s__split_fields3)) o20) true)
  (= (get1 (positions (mk___rep s__split_discrs s__split_fields3)) o20) (+
  (get1 (positions (mk___rep s__split_discrs s__split_fields3))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o20))
  (ite (= (ite (= (bool_eq1 o20 no_element) false) (= (get1
                                                      (positions
                                                      (mk___rep
                                                      s__split_discrs
                                                      s__split_fields3))
...
;; H
  ...
  (=> (and (in_range4 temp___390) (= (iter_has_element o12 temp___390) true))
  (= (contains
     (model__
     (mk___rep s__split_discrs (us_split_fields__content s__split_fields8)))
     (get o12 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range7 item)
  (= (contains
     ...
     item) true))
  (and (< 0 (find o12 item))
  (= (equivalent_elements (get o12 (find o12 item)) item) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length
         (mk___rep s__split_discrs
         (us_split_fields__content s__split_fields8)))))
  (and (= (find o12 (get o12 i1)) i1)
  (= (e_is_find o12 (get o12 i1) i1) true)))))))
