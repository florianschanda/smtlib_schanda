...
;; H
  (assert
  (and (= o12 (last2 left))
  (and (dynamic_property1 first1 last1 o12)
  (= o12 (+ (- first 1) (length left))))))

;; H
  (assert (= result (ite (<= lst1 o12) true false)))

;; H
  (assert (= result true))

;; H
  (assert (=> (< offset 0) (and (= o10 first) (in_range1 first))))

;; H
  (assert
  (=> (< offset 0)
  (and (= o11 (- (- 2147483648) offset)) (in_range1
  (- (- 2147483648) offset)))))

;; H
  (assert (=> (< offset 0) (= result1 (ite (<= o11 o10) true false))))
...
;; H
  (assert (= o9 (ite (<= offset o8) true false)))
