...
(declare-datatypes ((t30b__ref 0)) (((mk_t30b__ref (t30b__content t30b)))))
...
;; H
  (assert (dynamic_property 1 2147483647 (to_rep1 b__first)
  (to_rep1 b__last)))
...
(assert
;; WP_parameter_def
 ;; File "test.adb", line 206, characters 0-0
