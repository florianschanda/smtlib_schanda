...
(declare-sort bits_30 0)

(define-fun in_range3 ((x (_ BitVec 32))) Bool (and
                                               (bvule ((_ int2bv 32) 0) x)
                                               (bvule x ((_ int2bv 32) 1073741823))))

(define-fun in_range_int1 ((x Int)) Bool (and (<= 0 x) (<= x 1073741823)))
...
(declare-fun user_eq5 (bits_30 bits_30) Bool)

(declare-const dummy5 bits_30)

(declare-datatypes ()
((bits_30__ref (mk_bits_30__ref (bits_30__content bits_30)))))
(define-fun bits_30__ref___projection ((a bits_30__ref)) bits_30 (bits_30__content
                                                                 a))

(declare-fun to_rep3 (bits_30) (_ BitVec 32))

(declare-fun of_rep3 ((_ BitVec 32)) bits_30)
...
;; range_axiom
  (assert
  (forall ((x bits_30)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)) )))

;; coerce_axiom
  (assert
  (forall ((x (_ BitVec 32)))
  (! (let ((y (bvurem x ((_ int2bv 32) 1073741824))))
     (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3
                                                               (of_rep3 x))) )))

(define-fun to_int6 ((x bits_30)) Int (bv2nat (to_rep3 x)))

;; range_int_axiom
  (assert
  (forall ((x bits_30)) (! (in_range_int1
  (to_int6 x)) :pattern ((to_int6 x)) )))

(declare-datatypes ()
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__evc_ctrl_type__evc_en bits_1)(rec__dw1000__register_types__evc_ctrl_type__evc_clr bits_1)(rec__dw1000__register_types__evc_ctrl_type__reserved bits_30)))))
(define-fun us_split_fields_EVC_EN__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__evc_ctrl_type__evc_en a))

(define-fun us_split_fields_EVC_CLR__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__evc_ctrl_type__evc_clr a))

(define-fun us_split_fields_Reserved__22__projection ((a us_split_fields)) bits_30
  (rec__dw1000__register_types__evc_ctrl_type__reserved a))

(declare-datatypes ()
((us_split_fields__ref
 (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___87__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ()
((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___87__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (and
                        (and
                        (= (to_rep2
                           (rec__dw1000__register_types__evc_ctrl_type__evc_en
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__evc_ctrl_type__evc_en
                                                  (us_split_fields1 b))))
                        (= (to_rep2
                           (rec__dw1000__register_types__evc_ctrl_type__evc_clr
                           (us_split_fields1 a))) (to_rep2
                                                  (rec__dw1000__register_types__evc_ctrl_type__evc_clr
                                                  (us_split_fields1 b)))))
                        (= (to_rep3
                           (rec__dw1000__register_types__evc_ctrl_type__reserved
...
(declare-const dw1000__register_types__evc_ctrl_type__evc_en__first__bit Int)

(declare-const dw1000__register_types__evc_ctrl_type__evc_en__last__bit Int)

(declare-const dw1000__register_types__evc_ctrl_type__evc_en__position Int)

;; dw1000__register_types__evc_ctrl_type__evc_en__first__bit_axiom
  (assert (<= 0 dw1000__register_types__evc_ctrl_type__evc_en__first__bit))

;; dw1000__register_types__evc_ctrl_type__evc_en__last__bit_axiom
  (assert
  (< dw1000__register_types__evc_ctrl_type__evc_en__first__bit dw1000__register_types__evc_ctrl_type__evc_en__last__bit))

;; dw1000__register_types__evc_ctrl_type__evc_en__position_axiom
  (assert (<= 0 dw1000__register_types__evc_ctrl_type__evc_en__position))

(declare-const dw1000__register_types__evc_ctrl_type__evc_clr__first__bit Int)

(declare-const dw1000__register_types__evc_ctrl_type__evc_clr__last__bit Int)

(declare-const dw1000__register_types__evc_ctrl_type__evc_clr__position Int)

;; dw1000__register_types__evc_ctrl_type__evc_clr__first__bit_axiom
  (assert (<= 0 dw1000__register_types__evc_ctrl_type__evc_clr__first__bit))

;; dw1000__register_types__evc_ctrl_type__evc_clr__last__bit_axiom
  (assert
  (< dw1000__register_types__evc_ctrl_type__evc_clr__first__bit dw1000__register_types__evc_ctrl_type__evc_clr__last__bit))

;; dw1000__register_types__evc_ctrl_type__evc_clr__position_axiom
  (assert (<= 0 dw1000__register_types__evc_ctrl_type__evc_clr__position))

(declare-const dw1000__register_types__evc_ctrl_type__reserved__first__bit Int)

(declare-const dw1000__register_types__evc_ctrl_type__reserved__last__bit Int)

(declare-const dw1000__register_types__evc_ctrl_type__reserved__position Int)

;; dw1000__register_types__evc_ctrl_type__reserved__first__bit_axiom
  (assert (<= 0 dw1000__register_types__evc_ctrl_type__reserved__first__bit))

;; dw1000__register_types__evc_ctrl_type__reserved__last__bit_axiom
  (assert
  (< dw1000__register_types__evc_ctrl_type__reserved__first__bit dw1000__register_types__evc_ctrl_type__reserved__last__bit))

;; dw1000__register_types__evc_ctrl_type__reserved__position_axiom
  (assert (<= 0 dw1000__register_types__evc_ctrl_type__reserved__position))
...
(declare-datatypes ()
((evc_ctrl_type__ref (mk_evc_ctrl_type__ref (evc_ctrl_type__content us_rep)))))
(define-fun evc_ctrl_type__ref___projection ((a evc_ctrl_type__ref)) us_rep
  (evc_ctrl_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___212__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___149__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___149__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_6982 us_t1)
  (temp___is_init_6979 Bool) (temp___skip_constant_6980 Bool)
  (temp___do_toplevel_6981 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6980 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_6982)
                                       (last3 temp___expr_6982))
                                       (and (= (first3 temp___expr_6982) 1)
                                       (= (last3 temp___expr_6982) 4)))))
...
(define-fun target__ref___64__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ()
((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___64__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_7000 us_t2)
  (temp___is_init_6997 Bool) (temp___skip_constant_6998 Bool)
  (temp___do_toplevel_6999 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6998 true))
                                       (and (dynamic_property3 1 4
                                       (first5 temp___expr_7000)
                                       (last5 temp___expr_7000))
                                       (and (= (first5 temp___expr_7000) 1)
                                       (= (last5 temp___expr_7000) 4)))))
...
(declare-const temp___8182 (Array Int bits_8))

(declare-const temp___81821 t2)

(declare-const temp___8183 (Array Int bits_8))

(declare-const temp___81831 t1)
...
(define-fun temp___81822 () us_t2 (mk___t2 temp___8182 temp___81821))
...
;; H
  (assert
  (and (= temp___81822 (register_to_bytes reg)) (dynamic_invariant1
  temp___81822 true false true)))

;; H
  (assert
  (= (ite (<= (to_rep (first4 temp___81821)) (to_rep (last4 temp___81821)))
     (+ (- (to_rep (last4 temp___81821)) (to_rep (first4 temp___81821))) 1)
     0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))

;; H
  (assert (= temp___8182 temp___8183))

;; H
  (assert
  (= (mk1 (to_rep (first4 temp___81821)) (to_rep (last4 temp___81821)))
  temp___81831))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___81831)) (to_rep (last2 temp___81831)))
     (+ (- (to_rep (last2 temp___81831)) (to_rep (first2 temp___81831))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___8183 temp___81831)))
