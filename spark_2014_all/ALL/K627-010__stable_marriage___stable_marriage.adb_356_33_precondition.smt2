...
(declare-fun o33 () group2_id)

(declare-fun o34 () Int)

(declare-fun o35 () group1_id)
...
(declare-fun o39 () group2_id)

(declare-fun o40 () Int)

(declare-fun o41 () group1_id)

(declare-fun o42 () Int)

(declare-fun o43 () Int)

(declare-fun o44 () group2_id)

(declare-fun o45 () Int)

(declare-fun o46 () (Array Int group1_id))
...
;; H
  ...
  (= (is_preferred_1 g11
     (to_rep
     (select result__ (to_rep1 (select (select ranking_1 g11) (- rank3 1)))))
     (select ranking_2 (to_rep1 (select (select ranking_1 g11) (- rank3 1))))) true))))
