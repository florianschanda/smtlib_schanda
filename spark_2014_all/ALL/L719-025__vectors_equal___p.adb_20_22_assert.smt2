...
;; copy__post_axiom
  ...
  (forall ((capacity Int))
  (! (=>
     (and (dynamic_invariant2 capacity true true true)
     (=> (= (of_int 1) true)
     (or (= capacity 0) (<= (length1 source) capacity))))
...
;; length__post_axiom
  ...
  (! (let ((result (length container)))
     (and (<= (+ 0 result) 100) (dynamic_invariant5 result true false true))) :pattern (
  (length container)) )))
...
;; H
  ...
  (= (to_rep p__identity_swap__l_in__assume) (length1
                                             (mk___rep l__split_discrs
                                             (mk___split_fields
                                             l__split_fields)))))))
...
;; H
  ...
  (= (m_elements_swapped
     ...
     (model__ (mk___rep l__split_discrs l__split_fields2)) i1 i2) true))
