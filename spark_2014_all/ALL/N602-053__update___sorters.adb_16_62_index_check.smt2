...
;; H
  (assert
  (and (= us1 y) (dynamic_property1 (to_rep values__first)
...
;; H
  (assert
  (and (= us x) (dynamic_property1 (to_rep values__first)
  (to_rep values__last) x)))
...
;; H
  (assert
  (= temp___2002 (temp___192
                 (mk___t values
                 (mk (to_rep values__first) (to_rep values__last))) o7
                 o6 o5 o4)))

;; H
  (assert
  (= (ite (<= (to_rep (first temp___2001)) (to_rep (last temp___2001)))
     (+ (- (to_rep (last temp___2001)) (to_rep (first temp___2001))) 1) 0)
...
;; H
  (assert
  (= o8 (slide temp___201 (to_rep (first temp___2011))
