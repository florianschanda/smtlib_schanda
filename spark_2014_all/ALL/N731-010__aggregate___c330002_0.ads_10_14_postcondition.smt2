...
(declare-datatypes ((t6s__ref 0)) (((mk_t6s__ref (t6s__content t6s)))))
...
(declare-fun temp___144 (Int Int) (Array Int integer))

;; def_axiom
  (assert
  (forall ((temp___146 Int) (temp___147 Int))
  (let ((temp___145 (temp___144 temp___146 temp___147)))
  (and (= (select temp___145 1) (of_rep temp___146))
  (= (select temp___145 2) (of_rep temp___147))))))

(declare-fun temp___183 (Int Int Int Int) us_t1)
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property 1 2147483647 temp___187 temp___188)
  (and (= (first3 temp___184) temp___187) (= (last3 temp___184) temp___188)))
  (and
  (= (select (to_array1 temp___184) (+ (to_rep a__first) 0)) (of_rep
                                                             temp___185))
  (= (select (to_array1 temp___184) (+ (to_rep a__first) 1)) (of_rep
                                                             temp___186)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_140 us_t)
  ...
  (temp___do_toplevel_139 Bool)) Bool (=>
                                      ...
                                      (first1 temp___expr_140)
                                      (last1 temp___expr_140))))
...
;; H
  ...
  (= (to_rep
     (first2
     (rt1 (temp___183 85 36 (to_rep a__first) (+ (to_rep a__first) 1)))))
  (to_rep a__first)))
...
;; H
  (assert
  (= (mk___t1 temp___191 temp___1911) (temp___183 85 36 (to_rep a__first)
                                      (+ (to_rep a__first) 1))))

;; H
  (assert (= temp___191 temp___192))

;; H
  (assert
  (= (mk (to_rep (first2 temp___1911)) (to_rep (last2 temp___1911)))
  temp___1921))

;; H
  (assert
  (= (ite (<= (to_rep (first temp___1921)) (to_rep (last temp___1921)))
     (+ (- (to_rep (last temp___1921)) (to_rep (first temp___1921))) 1) 0)
  (ite (<= (to_rep a__first) (to_rep a__last))
  (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))

;; H
  (assert
  (= (mk___t temp___193 temp___1931) (mk___t temp___192 temp___1921)))

;; H
  (assert
  (= o (slide temp___193 (to_rep (first temp___1931)) (to_rep a__first))))
...
(assert
;; WP_parameter_def
 ;; File "c330002_0.adb", line 3, characters 0-0
  (not
  (= (bool_eq a2 (to_rep a__first) (to_rep a__last) (temp___144 85 36) 1 2) true)))
(check-sat)
(exit)
