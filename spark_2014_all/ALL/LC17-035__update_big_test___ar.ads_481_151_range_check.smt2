...
(declare-fun o11 () (Array Int (Array Int et1)))

(declare-fun o12 () (Array Int (Array Int et1)))
...
;; H
  (assert (and (= o8 (- e 1)) (in_range3 (- e 1))))
...
;; H
  (assert (= temp___5361 (select a o7)))

;; H
  (assert (= o9 (select temp___5361 j)))

;; H
  (assert (= o10 (temp___1675 o9 i o8)))
...
;; H
  (assert (= o11 (select a o6)))

;; H
  (assert (= o12 (temp___1668 o11 j o10)))
