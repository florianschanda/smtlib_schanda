...
;; H
  (assert
  (= (let ((temp___223 (to_model (mk___rep r__split_fields23))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields23)) x)))
     (let ((temp___230 (to_model (mk___rep r__split_fields22))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields22)) y)))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields21)))))
     (let ((temp___234 (to_model (mk___rep r__split_fields20))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields20)) z)))
     (let ((temp___230 (to_model (mk___rep r__split_fields19))))
     (bool_eq (elts temp___230) (to_rep (first (rt temp___230)))
     (to_rep (last (rt temp___230))) (elts temp___231)
     (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
...
;; H
  ...
  (and
  (and
  (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields19)))))
     (let ((temp___234 (to_model (mk___rep r__split_fields18))))
     (bool_eq (elts temp___234) (to_rep (first (rt temp___234)))
     (to_rep (last (rt temp___234))) (elts temp___235)
     (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (is_empty (mk___rep r__split_fields18)) true))))
(check-sat)
(exit)
