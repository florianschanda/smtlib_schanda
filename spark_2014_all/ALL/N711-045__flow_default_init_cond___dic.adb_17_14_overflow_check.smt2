...
(declare-datatypes ()
((pr_record_t__ref (mk_pr_record_t__ref (pr_record_t__content us_rep)))))
(define-fun pr_record_t__ref___projection ((a pr_record_t__ref)) us_rep
...
(declare-datatypes ()
((pr_record_t2__ref (mk_pr_record_t2__ref (pr_record_t2__content us_rep1)))))
(define-fun pr_record_t2__ref___projection ((a pr_record_t2__ref)) us_rep1
...
(define-fun default_initial_assumption1 ((temp___expr_149 us_rep1)
  ...
  (dic__g Int)) Bool (and
                     ...
                     (= (to_rep
                        ...
                        (us_split_fields3 temp___expr_149))) 0)
                     (= (to_rep
...
(declare-fun dic__pr_uninit_t__x__first__bit () Int)

(declare-fun dic__pr_uninit_t__x__last__bit () Int)

(declare-fun dic__pr_uninit_t__x__position () Int)
...
(declare-fun dic__pr_uninit_t__y__first__bit () Int)

(declare-fun dic__pr_uninit_t__y__last__bit () Int)

(declare-fun dic__pr_uninit_t__y__position () Int)
...
(declare-datatypes ()
((pr_uninit_t__ref (mk_pr_uninit_t__ref (pr_uninit_t__content us_rep2)))))
...
(define-fun us_split_fields_X5__projection ((a us_split_fields6)) integer
  (rec__dic__pr_liar_t__x a))

(define-fun us_split_fields_Y4__projection ((a us_split_fields6)) integer
...
(declare-fun dic__pr_liar_t__x__first__bit () Int)

(declare-fun dic__pr_liar_t__x__last__bit () Int)

(declare-fun dic__pr_liar_t__x__position () Int)
...
(declare-fun dic__pr_liar_t__y__first__bit () Int)

(declare-fun dic__pr_liar_t__y__last__bit () Int)

(declare-fun dic__pr_liar_t__y__position () Int)
...
(declare-datatypes ()
((pr_liar_t__ref (mk_pr_liar_t__ref (pr_liar_t__content us_rep3)))))
(define-fun pr_liar_t__ref___projection ((a pr_liar_t__ref)) us_rep3
...
(assert
;; WP_parameter_def
 ;; File "dic.adb", line 13, characters 0-0
  (not (in_range (+ (to_rep a__split_fields) (to_rep a__split_fields1)))))
(check-sat)
(exit)
