...
(define-fun us_rep___16__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(declare-datatypes ((rx_ttcki_type__ref 0))
(((mk_rx_ttcki_type__ref (rx_ttcki_type__content us_rep)))))
...
(define-fun register_type__ref___34__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___25__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___25__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2920 us_t1)
  (temp___is_init_2917 Bool) (temp___skip_constant_2918 Bool)
  (temp___do_toplevel_2919 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2918 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2920)
                                       (last3 temp___expr_2920))
                                       (and (= (first3 temp___expr_2920) 1)
                                       (= (last3 temp___expr_2920) 4)))))
