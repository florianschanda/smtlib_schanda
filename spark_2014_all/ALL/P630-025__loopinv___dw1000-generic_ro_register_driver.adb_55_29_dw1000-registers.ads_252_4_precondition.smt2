...
((us_split_fields
 (mk___split_fields
 (rec__dw1000__register_types__rx_ttcki_type__rxttcki bits_32)))))
(define-fun us_split_fields_RXTTCKI__projection ((a us_split_fields)) bits_32
  (rec__dw1000__register_types__rx_ttcki_type__rxttcki a))
...
(define-fun us_rep_16__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                               a))

(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__rx_ttcki_type__rxttcki
...
(declare-fun dw1000__register_types__rx_ttcki_type__rxttcki__first__bit () Int)

(declare-fun dw1000__register_types__rx_ttcki_type__rxttcki__last__bit () Int)

(declare-fun dw1000__register_types__rx_ttcki_type__rxttcki__position () Int)

;; dw1000__register_types__rx_ttcki_type__rxttcki__first__bit_axiom
  (assert (<= 0 dw1000__register_types__rx_ttcki_type__rxttcki__first__bit))

;; dw1000__register_types__rx_ttcki_type__rxttcki__last__bit_axiom
  (assert
  (< dw1000__register_types__rx_ttcki_type__rxttcki__first__bit dw1000__register_types__rx_ttcki_type__rxttcki__last__bit))

;; dw1000__register_types__rx_ttcki_type__rxttcki__position_axiom
...
(declare-datatypes ()
((rx_ttcki_type__ref (mk_rx_ttcki_type__ref (rx_ttcki_type__content us_rep)))))
(define-fun rx_ttcki_type__ref___projection ((a rx_ttcki_type__ref)) us_rep
  (rx_ttcki_type__content a))

(declare-datatypes ()
((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref_34__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_25__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_25__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2898 us_t1)
  (temp___is_init_2895 Bool) (temp___skip_constant_2896 Bool)
  (temp___do_toplevel_2897 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2896 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_2898)
                                       (last3 temp___expr_2898))
                                       (and (= (first3 temp___expr_2898) 1)
                                       (= (last3 temp___expr_2898) 4)))))
