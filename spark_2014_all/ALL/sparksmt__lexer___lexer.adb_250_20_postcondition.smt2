...
(declare-const temp___944 token_kind)

(declare-const temp___9441 natural)

(declare-const temp___9442 natural)

(declare-const temp___9443 natural)

(declare-const temp___9444 name_id)

(declare-const temp___9445 Bool)
...
(declare-const temp___946 token_kind)

(declare-const temp___9461 natural)

(declare-const temp___9462 natural)

(declare-const temp___9463 natural)

(declare-const temp___9464 name_id)

(declare-const temp___9465 Bool)
...
(declare-const temp___947 token_kind)

(declare-const temp___9471 natural)

(declare-const temp___9472 natural)

(declare-const temp___9473 natural)

(declare-const temp___9474 name_id)

(declare-const temp___9475 Bool)

(declare-const usq_6 us_rep)

(declare-const temp___949 us_rep)
...
;; H
  (assert (=> (= kind 1) (= temp___944 o8)))

;; H
  (assert (=> (= kind 1) (= temp___9441 o4)))

;; H
  (assert (=> (= kind 1) (= temp___9442 o5)))

;; H
  (assert (=> (= kind 1) (= temp___9443 o6)))

;; H
  (assert (=> (= kind 1) (= temp___9444 o7)))

;; H
  (assert (=> (= kind 1) (= true temp___9445)))

;; H
  (assert
  (=> (= kind 1)
  (=> (= t__attr__constrained true) (= temp___944 t__split_discrs))))
...
;; H
  (assert (=> (= kind 1) (= usq_ temp___946)))

;; H
  (assert (=> (= kind 1) (= usq_1 temp___9461)))

;; H
  (assert (=> (= kind 1) (= usq_2 temp___9462)))

;; H
  (assert (=> (= kind 1) (= usq_3 temp___9463)))

;; H
  (assert (=> (= kind 1) (= usq_4 temp___9464)))

;; H
  (assert (=> (= kind 1) (= t__attr__constrained temp___9465)))
...
;; H
  (assert
  (=> (= kind 1)
  (= t__split_fields4 (mk___split_fields temp___9461 temp___9462 temp___9463
                      temp___9464))))
...
;; H
  (assert
  (=> (= kind 1) (= t__split_discrs1 (mk___split_discrs temp___946))))
...
;; H
  (assert (=> (not (= kind 1)) (= temp___947 o17)))

;; H
  (assert (=> (not (= kind 1)) (= temp___9471 o13)))

;; H
  (assert (=> (not (= kind 1)) (= temp___9472 o14)))

;; H
  (assert (=> (not (= kind 1)) (= temp___9473 o15)))

;; H
  (assert (=> (not (= kind 1)) (= temp___9474 o16)))

;; H
  (assert (=> (not (= kind 1)) (= true temp___9475)))

;; H
  (assert
  (=> (not (= kind 1))
  (=> (= t__attr__constrained true) (= temp___947 t__split_discrs))))

;; H
  (assert
  (=> (not (= kind 1))
  (= usq_6 (mk___rep (mk___split_discrs temp___947)
           (mk___split_fields temp___9471 temp___9472 temp___9473
           temp___9474) temp___9475))))

;; H
  (assert
  (=> (not (= kind 1))
  (= temp___949 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6)
...
;; H
  (assert
  (=> (not (= kind 1)) (= t__split_fields5 (us_split_fields1 temp___949))))
...
;; H
  (assert
  (=> (not (= kind 1)) (= t__split_discrs2 (us_split_discrs1 temp___949))))
