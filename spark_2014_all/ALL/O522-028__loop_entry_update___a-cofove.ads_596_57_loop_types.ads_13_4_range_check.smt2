...
(define-fun default_initial_assumption ((temp___expr_263 us_rep1)
  (temp___skip_top_level_264 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_264 true))
                                         (= (length1 temp___expr_263) 0)))
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ 0 result) 1000) (dynamic_invariant result true false true))) :pattern (
  (length1 container)) )))
