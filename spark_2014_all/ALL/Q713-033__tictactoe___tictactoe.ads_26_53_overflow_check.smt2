...
;; H
  ...
  (and (in_range o3)
  (= o3 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0))))))
...
;; H
  (assert
  (=> (<= 2 y)
  (and (= o (one_free_slot 3 2 my_board))
  (and (in_range o)
  (= o (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0))))))
...
;; H
  (assert
  (and (= o1 (one_free_slot 3 1 my_board))
  (and (in_range o1)
  (= o1 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0)))))
