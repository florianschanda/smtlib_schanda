...
;; range_axiom
  (assert
  (forall ((x et2)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)) )))
...
;; range_axiom
  (assert
  (forall ((x et1)) (! (in_range (to_rep1 x)) :pattern ((to_rep1 x)) )))
...
(declare-fun temp___6653 () et3)

(declare-fun temp___66531 () et1)

(declare-fun temp___66532 () et2)

(declare-fun temp___66533 () enum1ta)
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 770, characters 0-0
  (not
