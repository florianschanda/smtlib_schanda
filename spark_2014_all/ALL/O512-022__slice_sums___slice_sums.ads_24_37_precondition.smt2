...
(declare-fun o18 () extended_index)

(declare-fun o19 () index)

(declare-fun o20 () us_split_fields)

(declare-fun o21 () slice_bounds)
...
;; H
  (assert (<= (to_rep3 (first (rt x))) hi))

;; H
  (assert (<= hi (to_rep3 (last (rt x)))))

;; H
  (assert (= (to_rep2 o18) hi))

;; H
  (assert (= (to_rep1 o19) lo))

;; H
  (assert (= o20 (mk___split_fields o19 o18)))

;; H
  (assert (= o21 (mk_slice_bounds o20)))
...
;; WP_parameter_def
 ;; File "sums.ads", line 12, characters 0-0
  (not
  (or
  (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o21))) (to_rep1
                                                                    (rec__sums__slice_bounds__lo
                                                                    (us_split_fields1
                                                                    o21))))
  (and
  (<= (to_rep3 (first (rt x))) (to_rep1
                               (rec__sums__slice_bounds__lo
                               (us_split_fields1 o21))))
  (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o21)))
  (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
