...
(declare-fun types__t__d__first__bit1 () Int)

(declare-fun types__t__d__last__bit1 () Int)

(declare-fun types__t__d__position1 () Int)
...
(declare-fun types__t__c__first__bit1 () Int)

(declare-fun types__t__c__last__bit1 () Int)

(declare-fun types__t__c__position1 () Int)
