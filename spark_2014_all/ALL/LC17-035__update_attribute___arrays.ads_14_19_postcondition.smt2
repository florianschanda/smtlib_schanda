...
(declare-fun an_arr () (Array Int integer))
...
(declare-fun arrays__f1__result1 () (Array Int integer))

(declare-fun arrays__f1__result2 () (Array Int integer))

(declare-fun arrays__f1__result3 () (Array Int integer))

(declare-fun arr5 () (Array Int integer))

(declare-fun arrays__f1__result4 () (Array Int integer))

(declare-fun arr6 () (Array Int integer))

(declare-fun arrays__f1__result5 () (Array Int integer))
...
;; H
  (assert
  (= (mk_map__ref arrays__f1__result4) (mk_map__ref arrays__f1__result2)))
...
;; WP_parameter_def
 ;; File "types.ads", line 5, characters 0-0
  (not
  (= (bool_eq arrays__f1__result4 1 8
     (temp___198 x (+ init_val 1) (to_rep (select an_arr 5))) 1 8) true)))
(check-sat)
(exit)
