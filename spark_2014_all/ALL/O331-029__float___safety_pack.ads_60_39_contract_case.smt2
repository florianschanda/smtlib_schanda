...
;; H
  (assert (=> (le (neg fliteral1) fliteral1) (in_range3 res)))

;; H
  (assert (=> (eq x fliteral2) (= result res)))

;; H
  (assert (=> (eq x fliteral2) (= res1 fliteral2)))
...
;; H
  (assert
  (=> (not (eq x fliteral2))
  (=> (and (le (neg fliteral3) x) (le x fliteral2)) (= res2 (neg fliteral3)))))
...
;; H
  ...
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (and (le fliteral2 x) (le x fliteral3)) (= res3 fliteral3)))))
...
;; H
  ...
  (=> (not (eq x fliteral2))
  (=> (not (and (le (neg fliteral3) x) (le x fliteral2)))
  (=> (not (and (le fliteral2 x) (le x fliteral3))) (= res4 x)))))
...
;; H
  (assert
  (=> (= (bool_eq x fliteral2) true) (eq
  safety_pack__lift_away_from_zero__result4 fliteral2)))

;; H
  (assert (= (bool_neq x fliteral2) true))

(assert
;; WP_parameter_def
 ;; File "imu_pack.ads", line 16, characters 0-0
  (not (neq safety_pack__lift_away_from_zero__result4 fliteral2)))
(check-sat)
