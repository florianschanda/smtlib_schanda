...
;; H
  (assert
  (and (= o18 (remove b ib2))
  (and (dynamic_invariant2 o18 true false true)
  (and (= (invariant__ o18) true)
  (and (= (to_rep2 (last (rt o18))) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib2 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o18) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select (elts o18) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o18) k))))))))))))
...
;; H
  ...
  (and (= (to_rep2 (last (rt o19))) (- (to_rep2 (last (rt o18))) 1))
  (and
  (forall ((k Int))
  (=>
  (and (<= 1 k)
  (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))
  (= (to_rep (select (elts o18) k)) (to_rep (select (elts o19) k)))))
  (and
  (forall ((k Int))
  (=>
  (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k)
  (<= k (to_rep2 (last (rt o18)))))
  (= (to_rep (select (elts o18) k)) (to_rep (select (elts o19) (- k 1))))))
  (forall ((k Int))
  (=>
  (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k)
  (<= k (- (to_rep2 (last (rt o18))) 1)))
  (= (to_rep (select (elts o18) (+ k 1))) (to_rep (select (elts o19) k))))))))))))

;; H
  (assert (and (= o16 (- ib2 1)) (in_range4 (- ib2 1))))

;; H
  (assert
  (and (= o17 (remove bb o16))
  (and (dynamic_invariant2 o17 true false true)
  (and (= (invariant__ o17) true)
  (and (= (to_rep2 (last (rt o17))) (- (to_rep2 (last (rt bb))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o16 1)))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o17) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o16 1) k) (<= k (to_rep2 (last (rt bb)))))
  (= (to_rep (select (elts bb) k)) (to_rep (select (elts o17) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o16 k) (<= k (- (to_rep2 (last (rt bb))) 1)))
  (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o17) k))))))))))))
