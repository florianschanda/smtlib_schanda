...
(declare-fun temp___4379 () (Array Int et1))

(declare-fun o5 () Int)

(declare-fun o6 () Int)

(declare-fun temp___4377 () (Array Int et1))
...
;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (and (= o5 (- e 1)) (in_range1 (- e 1))))))
...
;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (= temp___4377 (temp___641 a i e o6 o5)))))

;; H
  (assert
  (=> (< i 10) (=> (< 0 e) (= result6 (bool_eq a3 1 10 temp___4377 1 10)))))
...
;; H
  ...
  (=> (< i 10)
  (=> (not (= result6 true))
  (=> (= e 0) (and (= o4 (+ i 1)) (in_range (+ i 1)))))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result6 true))
  (=> (= e 0) (= temp___4379 (temp___650 a i e o4 99))))))

;; H
  (assert
  (=> (< i 10)
  (=> (not (= result6 true))
  (=> (= e 0) (= result5 (bool_eq a3 1 10 temp___4379 1 10))))))
