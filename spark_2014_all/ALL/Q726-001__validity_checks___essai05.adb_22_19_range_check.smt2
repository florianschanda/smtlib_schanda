...
(declare-fun to_rep (tindex_aB) Int)
...
;; range_axiom
  (assert
  (forall ((x tindex_aB)) (! (in_range (to_rep x)) :pattern ((to_rep x)) )))
...
(declare-datatypes ((t14b__ref 0)) (((mk_t14b__ref (t14b__content t14b)))))
...
(declare-datatypes ((tTC17bSP1__ref 0))
(((mk_tTC17bSP1__ref (tTC17bSP1__content tindex_aB)))))
(define-fun tTC17bSP1__ref___projection ((a tTC17bSP1__ref)) tindex_aB
  (tTC17bSP1__content a))
...
(declare-datatypes ((tC17bS__ref 0))
(((mk_tC17bS__ref (tC17bS__content us_t2)))))
(define-fun tC17bS__ref___projection ((a tC17bS__ref)) us_t2 (tC17bS__content
                                                             a))

(define-fun dynamic_invariant ((temp___expr_212 us_t2)
  (temp___is_init_209 Bool) (temp___skip_constant_210 Bool)
  (temp___do_toplevel_211 Bool)) Bool (=>
                                      (not (= temp___skip_constant_210 true))
                                      (and (dynamic_property3
                                      (to_rep a__first) (to_rep a__last)
                                      (first5 temp___expr_212)
                                      (last5 temp___expr_212))
                                      (and
                                      (= (first5 temp___expr_212) (to_rep
                                                                  a__first))
                                      (= (last5 temp___expr_212) (to_rep
                                                                 a__last))))))
...
;; def_axiom
  ...
  (let ((temp___227 (essai05__a__aggregate_def temp___228 temp___229
                    temp___230)))
  (and
  (and (= (select temp___227 (- 3)) (of_rep1 temp___228))
  (= (select temp___227 (- 2)) (of_rep1 temp___229)))
  (= (select temp___227 (- 1)) (of_rep1 temp___230))))))
...
(define-fun dynamic_invariant3 ((temp___expr_178 Int)
  ...
  (temp___do_toplevel_177 Bool)) Bool (=>
                                      ...
                                      (<= 3 15)) (in_range2 temp___expr_178)))
...
(define-fun dynamic_invariant5 ((temp___expr_189 us_t1)
...
(assert
;; WP_parameter_def
 ;; File "essai05.adb", line 1, characters 0-0
  (not (<= 3 (to_rep a__first))))
(check-sat)
(exit)
