...
;; H
  (assert
  (and
  (= o9 (length (rec__amortized_queue__queue__front (us_split_fields3 q))))
  (and (in_range4 o9)
  (<= o9 (capacity (rec__amortized_queue__queue__front (us_split_fields3 q)))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o7 (length m)) (and (in_range4 o7) (<= o7 (capacity m))))))
...
;; H
  (assert
  (and
  (= o (length (rec__amortized_queue__queue__rear (us_split_fields3 q))))
  (and (in_range4 o)
  (<= o (capacity (rec__amortized_queue__queue__rear (us_split_fields3 q)))))))
...
;; H
  ...
  (and
  (= o6 (get
        (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q)))
        o5))
  (and (in_range5 o6)
  (= o6 (get
        (model__ (rec__amortized_queue__queue__rear (us_split_fields3 q)))
