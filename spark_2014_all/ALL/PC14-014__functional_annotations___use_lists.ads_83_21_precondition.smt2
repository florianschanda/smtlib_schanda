...
;; H
  (assert
  (ite (= (ite (= (bool_eq2 (mk___rep1 n_last__split_fields6) no_element) false) (= 
          (get1
          (positions
          (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  ...
  (= (bool_eq2 (mk___rep1 n_last__split_fields5) no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (= (bool_eq2 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (not
  (= (bool_eq2 (mk___rep1 current__split_fields10)
     (mk___rep1 n_last__split_fields5)) true))))
...
;; H
  ...
  (= (bool_eq2 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (ite (= (ite (= (bool_eq2 (mk___rep1 current__split_fields10) no_element) false) (= 
          (get1 (positions (mk___rep l__split_discrs l__split_fields3))
