...
(declare-fun n_last__split_fields3 () us_split_fields__ref1)

(declare-fun l__split_fields9 () us_split_fields)

(declare-fun current__split_fields9 () us_split_fields2)

(declare-fun n_last__split_fields4 () us_split_fields2)
...
(define-fun n_last__split_fields5 () us_split_fields2 (mk___split_fields1
                                                      n_last__split_fields2))

(define-fun n_last__split_fields6 () us_split_fields2 (mk___split_fields1
...
;; H
  (assert
  (ite (= (ite (= (bool_eq1 (mk___rep1 n_last__split_fields6) no_element) false) (=
          (get1
          (positions
          (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
          (mk___rep1 n_last__split_fields6)) (length
                                             (mk___rep l__split_discrs
                                             (mk___split_fields
                                             l__split_fields)))) true) true)
  (= (bool_eq1 (mk___rep1 n_last__split_fields5) no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  ...
  (= (get1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 n_last__split_fields5)) (+ (get1
                                           (positions
                                           (mk___rep l__split_discrs
                                           (mk___split_fields
                                           l__split_fields)))
                                           (mk___rep1 n_last__split_fields6)) 1)))))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) fst)
...
;; H
  ...
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) fst) i1)
  (<= i1 (- (get1 (positions (mk___rep l__split_discrs l__split_fields10))
            (mk___rep1 current__split_fields10)) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i1) 0)))))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (not
  (= (bool_eq1 (mk___rep1 current__split_fields10)
     (mk___rep1 n_last__split_fields5)) true))))
...
;; H
  ...
  (= (get (model__ (mk___rep l__split_discrs l__split_fields3))
     ...
     (mk___rep1 current__split_fields10))) 0))
  (= (equal_except (model__ (mk___rep l__split_discrs l__split_fields10))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (ite (= (ite (= (bool_eq1 (mk___rep1 current__split_fields10) no_element) false) (=
          (get1 (positions (mk___rep l__split_discrs l__split_fields3))
          (mk___rep1 current__split_fields10)) (length
                                               (mk___rep l__split_discrs
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (= current__split_fields4 (mk___split_fields__ref1 current__split_fields3))))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (= current__split_fields5 current__split_fields3)))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (= current__split_fields6 current__split_fields4)))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (= l__split_fields6 l__split_fields4)))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (= current__split_fields7 current__split_fields5)))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true))
  (= l__split_fields7 l__split_fields5)))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true)))
  (= current__split_fields6 (mk___split_fields__ref1 current__split_fields11))))
...
;; H
  ...
  (= (bool_eq1 (mk___rep1 current__split_fields11)
     (mk___rep1 n_last__split_fields5)) true)))
  (= current__split_fields7 current__split_fields11)))
...
;; H
  (assert
  (= n_last__split_fields3 (mk___split_fields__ref1 n_last__split_fields5)))
