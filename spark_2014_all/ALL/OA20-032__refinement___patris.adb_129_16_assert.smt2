...
(define-fun dynamic_invariant ((temp___expr_1942 Int)
...
;; get_state__post_axiom
  ...
  (! (=> (dynamic_invariant patris__cur_state true true true)
     (dynamic_invariant (get_state patris__cur_state) true false true)) :pattern (
...
(define-fun dynamic_invariant2 ((temp___expr_1855 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_1867 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_1873 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_1879 Int)
