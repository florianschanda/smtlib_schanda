...
(define-fun register_type__ref_29__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_20__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_20__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2717 us_t1)
  (temp___is_init_2714 Bool) (temp___skip_constant_2715 Bool)
  (temp___do_toplevel_2716 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2715 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2717)
                                       (last3 temp___expr_2717))
                                       (and (= (first3 temp___expr_2717) 1)
                                       (= (last3 temp___expr_2717) 5)))))
