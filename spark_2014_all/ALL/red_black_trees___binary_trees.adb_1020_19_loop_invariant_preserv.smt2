...
(declare-fun temp___1732 () (Array Int us_rep1))
...
(declare-fun temp___1731 () (Array Int us_rep1))

(declare-fun o4 () us_rep1)

(declare-fun o5 () us_split_fields)

(declare-fun temp___1733 () (Array Int us_rep1))
...
(declare-fun temp___1736 () (Array Int us_rep1))
...
(declare-fun temp___1739 () (Array Int us_rep1))
...
(declare-fun temp___1740 () (Array Int us_rep1))
...
(declare-fun temp___17321 () (Array Int us_rep1))
...
(declare-fun temp___17311 () (Array Int us_rep1))

(declare-fun o25 () us_rep1)

(declare-fun o26 () us_split_fields)

(declare-fun temp___17331 () (Array Int us_rep1))
...
(declare-fun temp___17361 () (Array Int us_rep1))
...
(declare-fun temp___17391 () (Array Int us_rep1))
...
(declare-fun temp___17401 () (Array Int us_rep1))
...
;; H
  ...
  (and (dynamic_invariant3 temp___1731 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1731 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1731 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1731 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1731 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1731 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1731 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1731 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1731 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1731 j)))) true))
  (= j i))))))))))))))

;; H
  (assert (= o4 (select temp___1731 ki1)))
...
;; H
  ...
  (= temp___1732 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1732 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1732 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1732 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1732 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1732 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1732 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1732 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1732 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1732 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1732 j)))) true))
  (= j i)))))))))))))))

;; H
  (assert (=> (= result3 true) (= o (select temp___1732 ki1))))
...
;; H
  ...
  (= temp___1740 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1740 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1740 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1740 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1740 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1740 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1740 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1740 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1740 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1740 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1740 j)))) true))
  (= j i)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o17 (select temp___1740 ki1))))
...
;; H
  ...
  (= temp___1739 (model__
                 ...
                 root))
  (and (dynamic_invariant3 temp___1739 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1739 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1739 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1739 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1739 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1739 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1739 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1739 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1739 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1739 j)))) true))
  (= j i)))))))))))))))

;; H
  (assert (=> (= result2 true) (= o14 (select temp___1739 ki1))))
...
;; H
  ...
  (= temp___1736 (model__
                 ...
                 (mk___split_fields2 f_old__split_fields
                 f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___1736 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1736 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1736 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1736 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1736 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1736 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1736 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1736 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1736 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1736 j)))) true))
  (= j i)))))))))))))))
...
;; H
  (assert (=> (= result2 true) (= o11 (select temp___1736 o10))))
...
;; H
  ...
  (= temp___1733 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (and (dynamic_invariant3 temp___1733 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1733 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1733 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1733 (parent
                              (mk___rep2
                              (mk___split_fields2 f__split_fields
                              f__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1733 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1733 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1733 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1733 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1733 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1733 j)))) true))
  (= j i)))))))))))))))
...
;; H
  (assert (=> (= result2 true) (= o7 (select temp___1733 o6))))
...
;; H
  (assert
  (and
  (= temp___17311 (model__
                  (mk___rep2
                  (mk___split_fields2 f_old__split_fields
                  f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___17311 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17311 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17311 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___17311 (parent
                               (mk___rep2
                               (mk___split_fields2 f_old__split_fields
                               f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17311 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17311 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17311 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17311 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17311 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17311 j)))) true))
  (= j i))))))))))))))

;; H
  (assert (= o25 (select temp___17311 ki3)))
...
;; H
  ...
  (=> (= result6 true)
  (and
  (= temp___17321 (model__
                  (mk___rep2
                  (mk___split_fields2 f_old__split_fields
                  f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___17321 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17321 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17321 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___17321 (parent
                               (mk___rep2
                               (mk___split_fields2 f_old__split_fields
                               f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17321 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17321 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17321 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17321 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17321 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17321 j)))) true))
  (= j i)))))))))))))))

;; H
  (assert (=> (= result6 true) (= o21 (select temp___17321 ki3))))
...
;; H
  (assert
  (=> (= result6 true)
  (and (= o24 (length o23)) (and (in_range5 o24) (<= (+ 0 o24) 2147483647)))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (= temp___17401 (model__
                  (mk___rep2
                  (mk___split_fields2 f_old__split_fields
                  f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___17401 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17401 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17401 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___17401 (parent
                               (mk___rep2
                               (mk___split_fields2 f_old__split_fields
                               f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17401 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17401 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17401 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17401 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17401 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17401 j)))) true))
  (= j i)))))))))))))))

;; H
  (assert (=> (= result5 true) (= o38 (select temp___17401 ki3))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (= temp___17391 (model__
                  (mk___rep2
                  (mk___split_fields2 f__split_fields f__split_fields1))
                  root))
  (and (dynamic_invariant3 temp___17391 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17391 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17391 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___17391 (parent
                               (mk___rep2
                               (mk___split_fields2 f__split_fields
                               f__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17391 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17391 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17391 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17391 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17391 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17391 j)))) true))
  (= j i)))))))))))))))

;; H
  (assert (=> (= result5 true) (= o35 (select temp___17391 ki3))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (= temp___17361 (model__
                  (mk___rep2
                  (mk___split_fields2 f_old__split_fields
                  f_old__split_fields1)) root))
  (and (dynamic_invariant3 temp___17361 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17361 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17361 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___17361 (parent
                               (mk___rep2
                               (mk___split_fields2 f_old__split_fields
                               f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17361 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17361 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17361 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17361 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17361 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17361 j)))) true))
  (= j i)))))))))))))))
...
;; H
  (assert (=> (= result5 true) (= o32 (select temp___17361 o31))))
...
;; H
  ...
  (=> (= result5 true)
  (and
  (= temp___17331 (model__
                  (mk___rep2
                  (mk___split_fields2 f__split_fields f__split_fields1))
                  root))
  (and (dynamic_invariant3 temp___17331 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17331 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17331 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___17331 (parent
                               (mk___rep2
                               (mk___split_fields2 f__split_fields
                               f__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17331 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17331 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17331 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___17331 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17331 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___17331 j)))) true))
  (= j i)))))))))))))))
...
;; H
  (assert (=> (= result5 true) (= o28 (select temp___17331 o27))))
