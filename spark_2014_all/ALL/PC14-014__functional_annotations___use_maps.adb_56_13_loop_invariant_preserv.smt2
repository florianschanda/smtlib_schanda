...
(define-fun dynamic_invariant4 ((temp___expr_411 Int)
...
(define-fun dynamic_invariant8 ((temp___expr_167 (_ BitVec 32))
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant5 key2 true true true)
     ...
     (and
     (=> (< 0 result)
     (and (<= result (length3 container)) (= key2 (get container result))))
...
(define-fun temp___8041 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___804)))

(define-fun use_maps__apply_f_2__cu__assume1 () us_rep1 (mk___rep1
                                                        (mk___split_fields1
                                                        use_maps__apply_f_2__cu__assume)))
...
;; H
  (assert
  (and (= use_maps__apply_f_2__cu__assume1 (first s))
  (ite (= (= (length s) 0) true)
  (= (bool_eq1 use_maps__apply_f_2__cu__assume1 no_element) true)
  (and (= (has_key1 (positions s) use_maps__apply_f_2__cu__assume1) true)
  (= (get1 (positions s) use_maps__apply_f_2__cu__assume1) 1)))))
...
;; H
  (assert
  (and (= result1 (has_key1 (positions s) (mk___rep1 cu__split_fields5)))
  (= (= result1 true)
  (= (has_key1 (positions s) (mk___rep1 cu__split_fields5)) true))))
...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1)))
  (and
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields4))
     (get (keys s) i)) true)
  (= (get2 (model__ (mk___rep r__split_discrs r__split_fields4))
     (get (keys s) i)) (f (get2 (model__ s) (get (keys s) i))))))))

;; H
  (assert
  (let ((temp___812 (keys (mk___rep r__split_discrs r__split_fields4))))
  ...
  (and (<= 1 i)
  (<= i (- (get1 (positions s) (mk___rep1 cu__split_fields4)) 1)))
  (= (get temp___812 temp___811) (get (keys s) i))))))))
...
;; H
  (assert
  (and (= o1 (element s (mk___rep1 cu__split_fields4)))
  (and (in_range7 o1)
  (= o1 (get2 (model__ s) (key s (mk___rep1 cu__split_fields4)))))))
...
;; H
  (assert
  (and (= o (key s (mk___rep1 cu__split_fields4)))
  (and (in_range6 o)
  (= o (get (keys s) (get1 (positions s) (mk___rep1 cu__split_fields4)))))))

;; H
  (assert
  (and
  (and
  (= (has_key (model__ (mk___rep r__split_discrs r__split_fields3)) o) true)
  (= (get2 (model__ (mk___rep r__split_discrs r__split_fields3)) o) o2))
  (ite (= (has_key (model__ (mk___rep r__split_discrs r__split_fields4)) o) true)
  (and
  (and
  (and
  (and
  (= (oeq3 (positions (mk___rep r__split_discrs r__split_fields3))
     (positions (mk___rep r__split_discrs r__split_fields4))) true)
  (= (get (keys (mk___rep r__split_discrs r__split_fields3))
     (get1 (positions (mk___rep r__split_discrs r__split_fields3))
     (find1 (mk___rep r__split_discrs r__split_fields3) o))) o))
  (= (equal_except (keys (mk___rep r__split_discrs r__split_fields4))
     (keys (mk___rep r__split_discrs r__split_fields3))
     (get1 (positions (mk___rep r__split_discrs r__split_fields3))
     (find1 (mk___rep r__split_discrs r__split_fields3) o))) true))
  (= (same_keys (model__ (mk___rep r__split_discrs r__split_fields3))
     (model__ (mk___rep r__split_discrs r__split_fields4))) true))
  (= (elements_equal_except
     (model__ (mk___rep r__split_discrs r__split_fields3))
     (model__ (mk___rep r__split_discrs r__split_fields4)) o) true))
  (and
  (and
  (and
  (and
  ...
  (= (get (keys (mk___rep r__split_discrs r__split_fields3))
     (get1 (positions (mk___rep r__split_discrs r__split_fields3))
     (find1 (mk___rep r__split_discrs r__split_fields3) o))) o))
  (= (mapping_preserved (keys (mk___rep r__split_discrs r__split_fields4))
     (keys (mk___rep r__split_discrs r__split_fields3))
     (positions (mk___rep r__split_discrs r__split_fields4))
     (positions (mk___rep r__split_discrs r__split_fields3))) true))
...
;; H
  (assert
  (and (= temp___8041 (next s (mk___rep1 cu__split_fields4)))
  (ite (= (ite (= (bool_eq1 (mk___rep1 cu__split_fields4) no_element) false) (=
          (get1 (positions s) (mk___rep1 cu__split_fields4)) (length s)) true) true)
  (= (bool_eq1 temp___8041 no_element) true)
  (and (= (has_key1 (positions s) temp___8041) true)
  (= (get1 (positions s) temp___8041) (+ (get1 (positions s)
...
;; H
  (assert (= cu__split_fields3 (mk___split_fields1 temp___804)))
...
(define-fun temp___812 () us_rep3 (keys
                                  (mk___rep r__split_discrs r__split_fields3)))

(declare-const temp___811 Int)

;; H
  (assert (in_range3 temp___811))
...
(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 36, characters 0-0
  (not
  (exists ((i Int))
  (and
  (and (<= 1 i)
