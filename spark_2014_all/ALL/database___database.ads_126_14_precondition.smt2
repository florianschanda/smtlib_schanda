...
(define-fun o19 () us_rep (mk___rep (mk___split_fields o17 o18)))

(define-fun o20 () us_rep (mk___rep (mk___split_fields o8 o9)))

(define-fun o21 () us_rep (mk___rep (mk___split_fields o o1)))
...
;; H
  ...
  (and
  (and
  (and (= o21 (balance account links accounts_balance))
  (= o21 (rec__database__account_balance__value
         (us_split_fields5 (select accounts_balance account)))))
...
;; H
  (assert
  (and (= o19 (osubtract (balance account links accounts_balance) sum))
  (= (bool_eq o19
     (mk___rep
     (mk___split_fields
     (rec__money__amount__currency
     ...
     (- (to_rep1
        (rec__money__amount__raw
        (us_split_fields1 (balance account links accounts_balance))))
     (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))))) true)))
