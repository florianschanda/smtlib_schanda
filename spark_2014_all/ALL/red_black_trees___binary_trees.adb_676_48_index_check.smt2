...
(declare-fun temp___1690 () (Array Int us_rep1))
...
(declare-fun o30 () position_type)

(declare-fun o31 () position_type)
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 o23 o24 o25 o26)) (select f_old__split_fields1 
  o22)))
...
;; H
  (assert (= o32 (to_rep1 o31)))

;; H
  (assert (= result (ite (= o32 2) true false)))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 o11 o12 o13 o14)) (select f__split_fields1 
  o10)))
...
;; H
  (assert (= o21 (ite (= o20 0) true false)))
...
;; H
  ...
  (and (dynamic_invariant3 temp___1690 true false true)
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1690 root))) true)
  (and
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1690 root)))) 0)
  (and
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=> (not (= i root))
  (ite (and
       ...
       (= (rec__tree_model__path_type__k
          (us_split_fields1
          (select temp___1690 (parent
                              (mk___rep2
                              (mk___split_fields2 f_old__split_fields
                              f_old__split_fields1)) i)))) true))
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1690 i))) true)
  (not
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1690 i))) true))))))
  (and
  ...
  (= (length
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1690 i)))) 0))))
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i 100))
  (=>
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1690 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1690 i)))
     (rec__tree_model__path_type__a
     (us_split_fields1 (select temp___1690 j)))) true))
  (= j i))))))))))))))
...
;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 o1 o2 o3 o4)) (select f__split_fields1 
  o)))
