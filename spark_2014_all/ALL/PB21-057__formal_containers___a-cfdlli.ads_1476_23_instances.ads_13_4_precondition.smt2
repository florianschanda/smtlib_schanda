...
(define-fun default_initial_assumption1 ((temp___expr_596 us_rep3)
...
(define-fun default_initial_assumption3 ((temp___expr_577 us_rep2)
  (temp___skip_top_level_578 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_578 true))
                                         (= (length1 temp___expr_577) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_570 Int)
...
(declare-const temp___968 count_type)
