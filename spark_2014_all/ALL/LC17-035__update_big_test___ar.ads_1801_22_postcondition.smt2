...
(declare-fun temp___4028 ((Array Int us_rep) Int us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___4030 (Array Int us_rep)))
  (forall ((temp___4031 Int))
  (forall ((temp___4032 us_rep))
  (let ((temp___4029 (temp___4028 temp___4030 temp___4031 temp___4032)))
  (forall ((temp___4033 Int))
  (ite (= temp___4033 temp___4031)
  (= (select temp___4029 temp___4033) temp___4032)
  (= (select temp___4029 temp___4033) (select temp___4030 temp___4033)))))))))
...
(declare-const temp___9414 (Array Int us_rep))

(declare-const temp___94141 Bool)

(declare-const temp___94142 enum1t)
...
(declare-const temp___9421 (Array Int us_rep))

(declare-const temp___94211 Bool)

(declare-const temp___94212 enum1t)
...
;; H
  (assert (= temp___9414 o6))

;; H
  (assert (= temp___94141 o7))

;; H
  (assert (= temp___94142 o8))
...
;; H
  (assert (= temp___9414 r__split_fields3))

;; H
  (assert (= temp___94141 r__split_fields4))

;; H
  (assert (= temp___94142 r__split_fields5))
...
;; H
  (assert (= temp___9421 o15))

;; H
  (assert (= temp___94211 o16))

;; H
  (assert (= temp___94212 o17))
...
;; H
  (assert
  (= r__split_fields9 (mk___split_fields1 temp___9421 temp___94211
                      temp___94212)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1796, characters 0-0
  (not
  (= (bool_eq2 (mk___rep1 (us_split_fields__content1 r__split_fields10))
     (mk___rep1
     (mk___split_fields1
     (temp___4028 r__split_fields i
