...
(declare-const arrays__contains_a__result Bool)

(declare-const result Bool)

(declare-const arrays__contains_a__result1 Bool)

(declare-const arrays__contains_a__result2 Bool)

(declare-const arrays__contains_a__result3 Bool)

(declare-const arrays__contains_a__result4 Bool)

(declare-const arrays__contains_a__result5 Bool)
...
;; H
  (assert (= arrays__contains_a__result1 arrays__contains_a__result2))

;; H
  (assert (= arrays__contains_a__result3 arrays__contains_a__result1))

;; H
  (assert (= result arrays__contains_a__result))

;; H
  (assert (= arrays__contains_a__result1 (select s c)))

;; H
  (assert
  (= (mk_bool__ref arrays__contains_a__result4) (mk_bool__ref
                                                arrays__contains_a__result2)))

;; H
  (assert (= arrays__contains_a__result5 arrays__contains_a__result3))

;; H
  (assert (= result1 arrays__contains_a__result4))

;; H
  (assert (= arrays__contains_a__result4 true))

(assert
;; WP_parameter_def
 ;; File "arrays.adb", line 48, characters 0-0
  (not (= (select s c) true)))
(check-sat)
(exit)
