...
;; get__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant4 position1 true true true)
     (and (<= 1 position1) (<= position1 (last container1))))
     (dynamic_invariant5 (get1 container1 position1) true false true)) :pattern (
...
(declare-const temp___2168 count_type)
...
;; H
  (assert (= temp___2168 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___2168)) no_element))
...
(assert
;; WP_parameter_def
 ;; File "a-cforse.ads", line 1345, characters 0-0
