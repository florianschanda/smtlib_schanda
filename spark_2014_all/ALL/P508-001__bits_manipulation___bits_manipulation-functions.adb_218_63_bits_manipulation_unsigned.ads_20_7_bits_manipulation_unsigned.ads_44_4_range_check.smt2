...
;; H
  ...
  (= (make_mask j1) (bvsub (ite (< j1 4294967296)
                           (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j1))
                           ((_ int2bv 32) 0)) ((_ int2bv 32) 1))))))
...
;; H
  (assert
  (=> (< j 4294967296) (= o (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) j)))))

;; H
  (assert (=> (not (< j 4294967296)) (= o ((_ int2bv 32) 0))))

;; H
  (assert (= o1 (bvsub o ((_ int2bv 32) 1))))
