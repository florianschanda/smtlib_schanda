...
;; H
  ...
  (= (included_except
     (model__
     (mk___rep1 l__split_discrs my_sets__n__insert__2__container__fields1))
     (model__ (mk___rep1 l__split_discrs l__split_fields1)) o44) true))
  (= (mapping_preserved
...
;; H
  ...
  (= (bool_eq
     (element
     (mk___rep1 l__split_discrs my_sets__n__insert__container__fields)
     (mk___rep2 c__split_fields3)) o43) true))
  ...
  (= (included_except
     (model__
     (mk___rep1 l__split_discrs my_sets__n__insert__container__fields))
     (model__ (mk___rep1 l__split_discrs l__split_fields2)) o43) true))
  (= (mapping_preserved
