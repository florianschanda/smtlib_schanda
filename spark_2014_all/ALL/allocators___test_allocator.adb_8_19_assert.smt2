...
(define-fun model____split_fields4 () us_split_fields (mk___split_fields
...
;; H
  (assert
  (and
  (and (= (is_valid state1 model____split_fields4) true)
  (ite (= (= (length model____split_fields) 0) true)
  (and (= res11 0)
  (= (oeq (mk___rep model____split_fields4)
     (mk___rep
     (mk___split_fields model____split_fields model____split_fields1))) true))
  (and
...
;; WP_parameter_def
 ;; File "list_allocator.ads", line 80, characters 0-0
  (not (= (is_allocated res11 state1) true)))
(check-sat)
(exit)
