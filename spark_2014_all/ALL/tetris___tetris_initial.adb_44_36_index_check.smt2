...
(declare-fun cur_piece__split_fields1 () px_coord)

(declare-fun cur_piece__split_fields2 () py_coord)
...
(declare-fun o14 () (Array Int (Array Int cell)))

(declare-fun o15 () cell)

(declare-fun o16 () Int)

(declare-fun o17 () (Array Int cell))
...
(declare-fun result2 () (Array Int (Array Int cell)))
...
;; H
  (assert (= o13 (to_rep3 cur_piece__split_fields2)))
...
;; H
  (assert (= o16 (+ (to_rep2 cur_piece__split_fields1) 1)))

;; H
  (assert
  (= o17 (store (select cur_board3 (+ (to_rep3 cur_piece__split_fields2) 1))
  o16 o15)))

(assert
;; WP_parameter_def
 ;; File "tetris_initial.adb", line 107, characters 0-0
  (not (<= 1 (+ (to_rep3 cur_piece__split_fields2) 1))))
(check-sat)
(exit)
