...
(declare-datatypes ()
((us_split_fields (mk___split_fields (rec__vk__tag__t__my_name us_rep)))))
(define-fun us_split_fields_My_Name__projection ((a us_split_fields)) us_rep
...
(declare-fun tag_v__split_fields1 () us_rep)
