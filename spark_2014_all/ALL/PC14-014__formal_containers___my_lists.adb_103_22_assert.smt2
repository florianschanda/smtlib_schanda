...
;; H
  ...
  (and
  (and
  (= (bool_eq1 (mk___rep1 d__split_fields2) (mk___rep1 c__split_fields1)) true)
  (= (oeq
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__4__container__fields))
...
;; H
  ...
  (ite (= (ite (= (bool_eq1 o2 no_element) false) (= (get
                                                     (positions
                                                     (mk___rep
                                                     l__split_discrs
                                                     l__split_fields3))
                                                     o2) 1) true) true)
  (= (bool_eq1 temp___526 no_element) true)
  (and
...
;; H
  ...
  (ite (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) true)
  (= (get
     (positions
     (mk___rep l__split_discrs my_lists__m__insert__3__container__fields1))
...
;; H
  ...
  (and
  (and
  (= (bool_eq1 (mk___rep1 d__split_fields4) (mk___rep1 c__split_fields2)) true)
  (= (oeq
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__4__container__fields1))
...
;; H
  ...
  (and
  (and
  (= (bool_eq1 (mk___rep1 d__split_fields5) (mk___rep1 c__split_fields2)) true)
  (= (oeq
     (model__
     (mk___rep l__split_discrs my_lists__m__insert__4__container__fields2))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not (= (length (mk___rep l__split_discrs l__split_fields13)) 10)))
(check-sat)
(exit)
