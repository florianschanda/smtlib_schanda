...
(define-fun o23 () us_t (mk___t o17 o18))

(define-fun o24 () us_t (mk___t o14 o15))
...
;; H
  (assert
  (and (= o23 (remove (mk___t values2 (mk 1 100)) o16))
  (and (dynamic_invariant4 o23 true false true)
  (and (= (invariant__ o23) true)
...
;; H
  (assert
  (and (= o24 (remove (mk___t interm1 (mk 1 100)) o13))
  (and (dynamic_invariant4 o24 true false true)
...
;; H
  (assert
  (and (= o20 (remove_eq o24 o23 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o23 o19)))
     (let ((temp___162 (remove o24 o19)))
