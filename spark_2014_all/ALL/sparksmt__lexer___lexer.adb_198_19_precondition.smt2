...
;; H
  (assert
  (=> (= result true)
  (and (= next_read__split_discrs1 (mk___split_discrs temp___913))
  (and (= next_read__split_fields1 (mk___split_fields temp___9131))
  (= next_read__attr__constrained temp___9132)))))
...
;; H
  (assert
  (=> (= result true)
  (= temp___909 (mk___rep current_read__split_discrs1
...
;; H
  ...
  (let ((temp___916 (to_rep
                    (rec__file_io__read_result__c
                    current_read__split_fields2))))
  (or (= temp___916 10)
  (or (= temp___916 13) (or (= temp___916 32) (= temp___916 9)))))))))
...
;; H
  ...
  (= (local_invariant current_read__split_fields3 current_read__split_discrs3
     next_read__split_fields3 next_read__split_discrs3) true)
  (= (bool_eq1
...
;; H
  (assert
  (=> (not (= result true)) (= current_pos6 (mk_int__ref current_pos1))))
...
;; H
  ...
  (= result2 (ite (= (to_rep
                     (rec__file_io__read_result__c
                     (us_split_fields__content current_read__split_fields6))) 59)
             true false))))
...
;; H
  ...
  (= (bool_eq1
     (mk___rep current_read__split_discrs8 current_read__split_fields8
     current_read__attr__constrained)
     (mk___rep (us_split_discrs__content next_read__split_discrs6)
     (us_split_fields__content next_read__split_fields6)
     next_read__attr__constrained)) true))
  (<= (int__content current_pos6) current_pos8))
  (and (and (in_range2 current_line8) (in_range1 current_col8)) (in_range1
  current_pos8))))
...
;; H
  ...
  (= result3 (ite (not
                  (= (to_rep
                     (rec__file_io__read_result__c
                     current_read__split_fields8)) 10))
             true false))))
...
;; H
  (assert
  (and
  (and (and (in_range2 current_line9) (in_range1 current_col9)) (in_range1
  current_pos9))
  (and
  (= (to_rep1
     (rec__file_io__read_result__status current_read__split_discrs9)) 0)
  (not
  (= (to_rep (rec__file_io__read_result__c current_read__split_fields9)) 10)))))

(assert
;; WP_parameter_def
 ;; File "lexer.adb", line 47, characters 0-0
  (not
  (= (local_invariant current_read__split_fields9 current_read__split_discrs9
     next_read__split_fields9 next_read__split_discrs9) true)))
(check-sat)
(exit)
