...
(declare-fun dummy3 () tvec_10P1)

(declare-datatypes ()
((tvec_10P1__ref (mk_tvec_10P1__ref (tvec_10P1__content tvec_10P1)))))
(define-fun tvec_10P1__ref___projection ((a tvec_10P1__ref)) tvec_10P1
...
(declare-fun a () (Array Int myint))

(declare-fun unconstr__p__x__compl () (Array Int myint))

(declare-fun unconstr__p__x__compl1 () t)

(declare-fun o () integer)

(declare-fun o1 () integer)

(declare-fun unconstr__p__x () (Array Int myint))

(declare-fun result () (Array Int myint))

(declare-fun a1 () (Array Int myint))
...
;; H
  (assert (= (to_rep1 (select unconstr__p__x (to_rep o))) 0))
...
;; H
  ...
  (= a1 (slide unconstr__p__x
        (to_rep
        (first
        (mk (to_rep (first unconstr__p__x__compl1))
        (to_rep (last unconstr__p__x__compl1))))) 0)))
