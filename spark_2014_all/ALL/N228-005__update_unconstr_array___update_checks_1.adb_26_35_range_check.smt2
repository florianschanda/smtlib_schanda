...
;; H
  (assert
  (and (= us1 l) (dynamic_property1 (to_rep a__first) (to_rep a__last) l)))
...
;; H
  (assert
  (and (= us k) (dynamic_property1 (to_rep a__first) (to_rep a__last) k)))
...
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 12, characters 0-0
  (not (dynamic_property1 (to_rep a__first) (to_rep a__last) j)))
(check-sat)
(exit)
