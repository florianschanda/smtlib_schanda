...
;; H
  (assert (= o36 (from_integer (int__content s12))))

;; H
  (assert (= o40 (ole o36 o39)))

;; H
  (assert (and (= o31 (power 2 k)) (in_range1 (power 2 k))))

;; H
  (assert (= o32 (- o31 1)))

;; H
  (assert (and (= o33 o32) (in_range1 o32)))

;; H
  (assert (= o34 (ite (<= n o33) true false)))

;; H
  (assert (= result9 (ite (<= 0 n) o34 false)))
...
;; H
  (assert
  (and (= o26 (base Tuple0))
  (= o26 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o28 (oexpon o26 o27)))

;; H
  (assert (= o23 (from_word32 ((_ int2bv 32) 1))))

;; H
  (assert (= o21 (from_integer (int__content s12))))

;; H
  (assert (= o20 (from_word64 i2)))

;; H
  (assert (= o22 (osubtract o20 o21)))

;; H
  (assert (= o24 (oadd o22 o23)))

;; H
  (assert (= o19 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o25 (oexpon__2 o19 o24)))
