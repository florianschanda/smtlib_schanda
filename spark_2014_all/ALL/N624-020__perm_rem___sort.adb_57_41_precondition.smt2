...
;; H
  (assert (and (= o38 (- x 1)) (in_range5 (- x 1))))
...
;; H
  (assert
  (and (= o37 (remove (mk___t values2 (mk 1 100)) o36))
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o36 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o37) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o36 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o37) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o36 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o37) k))))))))))))

;; H
  (assert
  (and (= o39 (remove o37 o38))
  (and (dynamic_invariant4 o39 true false true)
  (and (= (invariant__ o39) true)
  (and (= (to_rep1 (last (rt o39))) (- (to_rep1 (last (rt o37))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o38 1)))
  (= (to_rep (select (elts o37) k)) (to_rep (select (elts o39) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o38 1) k) (<= k (to_rep1 (last (rt o37)))))
  (= (to_rep (select (elts o37) k)) (to_rep (select (elts o39) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o38 k) (<= k (- (to_rep1 (last (rt o37))) 1)))
  (= (to_rep (select (elts o37) (+ k 1))) (to_rep (select (elts o39) k))))))))))))
