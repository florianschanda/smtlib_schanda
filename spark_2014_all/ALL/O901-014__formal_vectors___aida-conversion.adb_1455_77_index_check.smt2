...
;; H
  ...
  (forall ((index3 Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 8) index3)
...
;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= (+ (to_rep1 (first (rt source))) 8) j1) (<= j1 index2))
...
;; H
  ...
  (=> (< index2 temp___1881)
  (= (select n3 temp___1881) (select n1 temp___1881)))))
  (=>
...
;; H
  (assert
  (and (= o9 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))
