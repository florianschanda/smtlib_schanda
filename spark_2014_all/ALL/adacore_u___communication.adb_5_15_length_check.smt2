...
(declare-datatypes ()
((map__ref1 (mk_map__ref1 (map__content1 (Array Int data))))))
...
(define-fun bool_eq9 ((a (Array Int data)) (a__first Int) (a__last Int)
...
(declare-datatypes () ((us_t1 (mk___t1 (elts1 (Array Int data))(rt1 t1)))))
...
(declare-datatypes ()
((data_array__ref (mk_data_array__ref (data_array__content us_t1)))))
...
(declare-fun communication__mailbox__address__first__bit () Int)

(declare-fun communication__mailbox__address__last__bit () Int)

(declare-fun communication__mailbox__address__position () Int)
...
(declare-fun communication__mailbox__port__first__bit () Int)

(declare-fun communication__mailbox__port__last__bit () Int)

(declare-fun communication__mailbox__port__position () Int)
...
(declare-fun communication__mailbox__in_buffer__first__bit () Int)

(declare-fun communication__mailbox__in_buffer__last__bit () Int)

(declare-fun communication__mailbox__in_buffer__position () Int)
...
(declare-fun communication__mailbox__out_buffer__first__bit () Int)

(declare-fun communication__mailbox__out_buffer__last__bit () Int)

(declare-fun communication__mailbox__out_buffer__position () Int)
...
(declare-datatypes ()
((mailbox__ref (mk_mailbox__ref (mailbox__content us_rep1)))))
(define-fun mailbox__ref___projection ((a mailbox__ref)) us_rep1 (mailbox__content
                                                                 a))

(declare-fun address () us_t)
...
(assert
;; WP_parameter_def
 ;; File "communication.ads", line 25, characters 0-0
  (not
