...
(declare-fun result4 () us_rep)

(declare-fun avail4 () us_rep)

(declare-fun result5 () us_rep)

(declare-fun alloc4 () us_rep)
...
;; H
  ...
  (forall ((e Int))
  (=> (and (in_range4 e) (= (contains avail3 e) true))
  (and (<= 1 e) (<= e r2)))))
  (forall ((e Int))
  (=> (and (in_range4 e) (= (contains alloc3 e) true))
  (and (<= 1 e) (<= e r2)))))
  (forall ((rr Int))
  (=> (and (<= 1 rr) (<= rr r2))
  (ite (= (to_rep (select data rr)) 0)
  (and (= (contains avail3 rr) true) (not (= (contains alloc3 rr) true)))
  (and (not (= (contains avail3 rr) true)) (= (contains alloc3 rr) true)))))))
...
;; H
  (assert
  (=> (= (to_rep (select data r3)) 0)
  (and (= o2 (add avail3 r3))
  (and
  (and (and (= (length o2) (+ (length avail3) 1)) (= (contains o2 r3) true))
  (= (ole avail3 o2) true)) (= (included_except o2 avail3 r3) true)))))
...
;; H
  (assert
  (=> (not (= (to_rep (select data r3)) 0))
  (and (= o3 (add alloc3 r3))
  (and
  (and (and (= (length o3) (+ (length alloc3) 1)) (= (contains o3 r3) true))
  (= (ole alloc3 o3) true)) (= (included_except o3 alloc3 r3) true)))))
...
;; WP_parameter_def
 ;; File "simple_allocator.ads", line 30, characters 0-0
  (not (= (+ (length avail4) (length alloc4)) r3)))
(check-sat)
(exit)
