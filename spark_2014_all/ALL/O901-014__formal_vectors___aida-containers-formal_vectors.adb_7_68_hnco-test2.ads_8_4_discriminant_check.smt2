...
(define-fun us_rep_6__projection ((a us_rep2)) us_split_discrs2 (us_split_discrs4
                                                                a))

(define-fun us_rep_7__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                a))

(define-fun us_rep_8__projection ((a us_rep2)) Int (attr__tag1 a))
...
(declare-datatypes ()
((t187s__ref (mk_t187s__ref (t187s__content us_rep2)))))
(define-fun t187s__ref___projection ((a t187s__ref)) us_rep2 (t187s__content
                                                             a))
...
(declare-fun o2 () capacity_range1)

(declare-fun o3 () capacity_range1)

(declare-fun hnco__test2__v_type_owner__empty_vector__R185s__R186s__assume () Int)

(declare-fun o4 () capacity_range1)

(declare-fun o5 () us_main_type)

(define-fun o6 () us_rep (mk___rep (mk___split_discrs o4)
...
;; H
  (assert
  (= hnco__test2__v_type_owner__empty_vector__R185s__R186s__assume (to_rep1
                                                                   o3)))

;; H
  (assert
  (= hnco__test2__v_type_owner__empty_vector__R185s__R186s__assume r186s))
