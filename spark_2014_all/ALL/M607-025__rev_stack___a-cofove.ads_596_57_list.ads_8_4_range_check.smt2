...
(define-fun default_initial_assumption ((temp___expr_308 us_rep1)
  (temp___skip_top_level_309 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_309 true))
                                         (= (length1 temp___expr_308) 0)))
...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= (+ 0 result) 100) (dynamic_invariant result true false true))) :pattern (
  (length1 container)) )))
