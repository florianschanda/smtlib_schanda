...
(declare-const p_max_array__max_array_2__result (Array Int natural))

(declare-const p_max_array__max_array_2__result1 t)

(declare-const temp___258 (Array Int natural))

(declare-const temp___2581 t2)

(declare-const p_max_array__max_array_2__r__assume (Array Int natural))

(declare-const p_max_array__max_array_2__r__assume1 t1)

(declare-const temp___264 Int)

(declare-const temp___263 Int)

(declare-const temp___261 (Array Int natural))
...
(declare-const result7 nat_array__ref)

(declare-const p_max_array__max_array_2__result2 us_t)

(declare-const p_max_array__max_array_2__result3 nat_array__ref)

(declare-const p_max_array__max_array_2__result4 us_t)
...
(declare-const p_max_array__max_array_2__result5 nat_array__ref)

(declare-const r10 (Array Int natural))

(declare-const j9 Int)

(declare-const i8 Int)

(declare-const p_max_array__max_array_2__result6 us_t)

(declare-const result8 Bool)

(define-fun r11 () map__ref (mk_map__ref r7))
...
;; H
  ...
  (=> (<= i2 temp___262)
  (= (select r2 temp___262) (select temp___261 temp___262)))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (= result3 (ite (< o2 (to_rep (select (elts a) i2))) true false))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (= result3 true) (= (to_rep o3) (to_rep (select (elts a) i2))))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (= result3 true) (= o4 (store r2 i2 o3)))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (= result3 true) (= r2 result4))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= o5 j2))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= o6 (select (elts b) o5)))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= o7 (to_rep o6)))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= (to_rep o8) o7))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= o9 (store r2 i2 o8)))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= r2 result5))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= r4 o9))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (=> (not (= result3 true)) (= r3 r4))))

;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a)))))
  (and (= o10 (+ j2 1)) (in_range1 (+ j2 1)))))
...
;; H
  (assert
  (= p_max_array__max_array_2__result3 (mk_nat_array__ref
                                       p_max_array__max_array_2__result2)))

;; H
  (assert
  (= p_max_array__max_array_2__result4 p_max_array__max_array_2__result2))

;; H
  (assert
  (= result7 (mk_nat_array__ref
             (mk___t p_max_array__max_array_2__result
             p_max_array__max_array_2__result1))))

;; H
  (assert
  (= p_max_array__max_array_2__result2 (mk___t r7
                                       (mk (to_rep1 r__first)
                                       (to_rep1 r__last)))))

;; H
  (assert
  (= p_max_array__max_array_2__result5 p_max_array__max_array_2__result3))
...
;; H
  (assert
  (= p_max_array__max_array_2__result6 p_max_array__max_array_2__result4))
...
;; H
  (assert
  (and (= o13 (- k (to_rep1 (first (rt a))))) (in_range1
  (- k (to_rep1 (first (rt a)))))))

;; H
  (assert (= o14 (+ o13 (to_rep1 (first (rt b))))))

;; H
  (assert (and (= temp___271 o14) (in_range1 o14)))

;; H
  (assert
  (and (<= (to_rep1 (first (rt b))) temp___271)
  (<= temp___271 (to_rep1 (last (rt b))))))

;; H
  (assert (= o15 temp___271))

;; H
  (assert (= o16 (select (elts b) o15)))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt a))) k) (<= k (to_rep1 (last (rt a))))))

;; H
  (assert (= o11 k))

;; H
  (assert (= o12 (select (elts a) o11)))

;; H
  (assert (= o18 (to_rep o12)))

;; H
  (assert (= result8 (ite (< o17 o18) true false)))
...
;; H
  (assert
  (and (= o19 (- k (to_rep1 (first (rt a))))) (in_range1
  (- k (to_rep1 (first (rt a)))))))

;; H
  (assert (= o20 (+ o19 (to_rep1 (first (rt b))))))
