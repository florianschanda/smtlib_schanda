...
(declare-fun arrays__single_char_set_broken__result () (Array Int Bool))

(declare-fun temp___316 () Int)

(declare-fun temp___314 () (Array Int Bool))
...
(declare-fun arrays__single_char_set_broken__result1 () (Array Int Bool))

(declare-fun arrays__single_char_set_broken__result2 () (Array Int Bool))

(declare-fun arrays__single_char_set_broken__result3 () (Array Int Bool))

(declare-fun r8 () (Array Int Bool))

(declare-fun x7 () Int)

(declare-fun arrays__single_char_set_broken__result4 () (Array Int Bool))

(declare-fun r9 () (Array Int Bool))

(declare-fun x8 () Int)

(declare-fun arrays__single_char_set_broken__result5 () (Array Int Bool))
...
;; H
  (assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___316 x1)))

;; H
  (assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___314 r)))
...
;; H
  ...
  (=> (and (<= 0 temp___315) (<= temp___315 255))
  (=> (< x2 temp___315)
  (= (select r3 temp___315) (select temp___314 temp___315)))))
...
;; H
  (assert
  (= arrays__single_char_set_broken__result1 arrays__single_char_set_broken__result2))

;; H
  (assert
  (= arrays__single_char_set_broken__result3 arrays__single_char_set_broken__result1))
...
;; H
  (assert
  (= (mk_map__ref arrays__single_char_set_broken__result4) (mk_map__ref
                                                           arrays__single_char_set_broken__result2)))
...
;; H
  (assert
  (= arrays__single_char_set_broken__result5 arrays__single_char_set_broken__result3))
