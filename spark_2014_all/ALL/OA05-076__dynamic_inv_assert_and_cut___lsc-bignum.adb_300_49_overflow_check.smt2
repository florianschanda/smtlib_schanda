...
;; H
  (assert (and (= o49 (+ a_last 1)) (in_range1 (+ a_last 1))))

;; H
  (assert (= o50 (ite (<= k o49) true false)))

;; H
  (assert (and (= o48 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o51 (ite (<= o48 k) true false)))

;; H
  (assert (= result3 (ite (= o51 true) o50 false)))
...
;; H
  (assert (= o43 (from_word32 carry22)))

;; H
  (assert
  (and (= o42 (base Tuple0))
  (= o42 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o44 (omultiply o42 o43)))

;; H
  (assert (= o41 (from_word32 carry12)))

;; H
  (assert (= o45 (oadd o41 o44)))

;; H
  (assert (and (= o36 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o37 (- o36 a_first)))
...
;; H
  (assert
  (and (= o35 (base Tuple0))
  (= o35 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o40 (oexpon o35 o39)))

;; H
  (assert (= o46 (omultiply o40 o45)))
...
;; H
  (assert
  (= o34 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o33)))

;; H
  (assert (= o47 (oadd o34 o46)))

;; H
  (assert (= o28 (from_word32 carry2)))
...
;; H
  (assert (= o29 (omultiply o27 o28)))

;; H
  (assert (= o26 (from_word32 carry1)))

;; H
  (assert (= o24 (from_word32 y)))
...
;; H
  (assert (= o23 (num_of_big_int c c_first o22)))

;; H
  (assert (= o25 (omultiply o23 o24)))

;; H
  (assert (= o18 (from_word32 x)))
