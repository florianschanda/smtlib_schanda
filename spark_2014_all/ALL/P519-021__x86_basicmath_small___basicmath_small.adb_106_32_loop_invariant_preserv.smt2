...
;; H
  ...
  (= (= signflag1 true) (= overflowflag1 true))))

;; H
  (assert
  (and (= o (readmem64 rbp memory))
  (and
  (and
  (and
  (and
...
;; H
  (assert (= (writereg32post rdi ((_ int2bv 32) 4198699)) true))

;; H
  (assert (= (writereg32post rax ((_ int2bv 32) 1)) true))
...
;; H
  (assert (= rbp1 (bvadd rbp ((_ int2bv 64) 8))))
...
;; H
  ...
  (and
  (= o4 (readmem32
        (bvsub (bvadd rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 108))
        memory))
  (and
  (and
  (and
  (= (bvand o4 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep
                                                        ...
                                                        rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 108))))))
  (= (bvand o4 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep
                                                                 (select
                                                                 memory (bvadd (bvsub (bvadd
                                                                 rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256))))
  (= (bvand o4 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep
                                                                    (select
                                                                    memory (bvadd (bvsub (bvadd
                                                                    rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536))))
  (= (bvand o4 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24)
  (to_rep
  (select memory (bvadd (bvsub (bvadd rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216))))))
...
;; H
  ...
  (to_rep
  (select memory (bvadd (bvsub (bvadd rsp3 ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536))))
...
;; H
  (assert
  (=> (= result6 true) (and (= o16 (ebx rbx1)) (= o16 (readreg32 rbx1)))))
...
;; H
  (assert
  (=> (= signflag2 true) (and (= o15 (ebx rbx1)) (= o15 (readreg32 rbx1)))))
...
;; H
  (assert (= (to_int3 signflag2) (to_int3 overflowflag2)))
