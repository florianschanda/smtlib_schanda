...
;; H
  (assert
  (and (= o29 (find_char_in_slice 10 cur_position o28 the_file))
  (and (in_range2 o29)
  (and (and (<= cur_position o29) (<= o29 o28))
  (and (= (no_char_in_slice 10 cur_position (- o29 1) the_file) true)
  (= (to_rep (select the_file o29)) 10))))))
...
;; H
  (assert
  (and (= o22 (find_char_in_slice 10 cur_position o21 the_file))
  (and (in_range2 o22)
  (and (and (<= cur_position o22) (<= o22 o21))
  (and (= (no_char_in_slice 10 cur_position (- o22 1) the_file) true)
  (= (to_rep (select the_file o22)) 10))))))
