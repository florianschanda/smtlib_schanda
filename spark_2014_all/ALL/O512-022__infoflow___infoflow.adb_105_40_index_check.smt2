...
;; H
  (assert
  (forall ((k1 Int))
  (=> (and (<= (to_rep h_v1__first) k1) (<= k1 (to_rep h_v1__last)))
  (ite (< k1 q_v12)
  (= (to_rep1 (select h_v11 k1)) (to_rep1 (select h_v1 (+ k1 m_v11))))
  (ite (< (+ q_v12 m_v11) k1)
  (= (to_rep1 (select h_v11 k1)) (to_rep1 (select h_v1 (- k1 m_v11))))
  (= (to_rep1 (select h_v11 k1)) (to_rep1 (select h_v1 k1))))))))
...
;; H
  (assert
  (and (<= (to_rep h_v1__first) (- k m_v11))
  (<= (- k m_v11) (to_rep h_v1__last))))
