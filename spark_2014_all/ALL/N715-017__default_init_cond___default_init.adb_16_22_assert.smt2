...
(declare-datatypes ((simple_priv__ref 0))
(((mk_simple_priv__ref (simple_priv__content us_rep)))))
...
(declare-datatypes ((wrong_priv__ref 0))
(((mk_wrong_priv__ref (wrong_priv__content us_rep1)))))
...
(declare-datatypes ((priv_with_glob__ref 0))
