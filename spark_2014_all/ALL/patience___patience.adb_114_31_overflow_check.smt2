...
;; H
  ...
  (<= j1 (- (to_rep1
            (select (rec__patience__state__stacksizes
                    (us_split_fields__content s__split_fields20)) i14)) 2)))
  (forall ((k1 Int))
  (=>
  (and (<= (+ j1 1) k1)
  (<= k1 (- (to_rep1
  ...
  (to_rep1
  (select (select (rec__patience__state__stacks
                  (us_split_fields__content s__split_fields20)) i14) k1))))))))))))
...
;; H
  (assert (= result25 (ite (<= 0 j) o109 false)))
...
;; H
  (assert
  (= o111 (select (rec__patience__state__stacksizes
                  (us_split_fields__content s__split_fields20)) o110)))
