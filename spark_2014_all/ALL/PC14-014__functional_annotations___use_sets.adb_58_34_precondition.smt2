...
;; H
  ...
  (not (= (contains (model__ s2) (get (elements s1) i1)) true)))))
...
;; H
  ...
  (forall ((i1 us_rep1))
  (=> (= (has_key o i1) true)
  (and (and (<= 1 (get1 o i1)) (<= (get1 o i1) (length2 s1)))
  (forall ((j us_rep1))
  (=> (= (has_key o j) true)
...
;; H
  ...
  (and
  (and
  (and (= (length o4) (length2 s1))
  (forall ((temp___425 Int))
  (=> (and (in_range4 temp___425) (= (iter_has_element o4 temp___425) true))
  (= (contains (model__ s1) (get o4 temp___425)) true))))
  (forall ((item Int))
  (=> (and (in_range2 item) (= (contains (model__ s1) item) true))
  (and (< 0 (find o4 item)) (= (get o4 (find o4 item)) item)))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length2 s1))) (= (find o4 (get o4 i1)) i1))))
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 (length2 s1)))
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j (length2 s1)))
