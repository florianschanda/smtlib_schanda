...
(declare-fun dummy2 () tmy_duration2B)
...
(declare-datatypes ()
((tmy_duration2B__ref
 (mk_tmy_duration2B__ref (tmy_duration2B__content tmy_duration2B)))))
(define-fun tmy_duration2B__ref___projection ((a tmy_duration2B__ref)) tmy_duration2B
  (tmy_duration2B__content a))

(declare-sort my_duration2 0)

(define-fun in_range3 ((x Int)) Bool (and (<= (- 20000000000) x)
                                     (<= x 20000000000)))

(declare-fun dummy3 () my_duration2)
...
;; fxp_mult_def
  ...
  (! (ite (or (= x 0) (= y 0)) (= (fxp_mult3 x y) 0)
     ...
     (fxp_mult3 x y) (* x y) 1000000000) (pos_div_relation3
     (- (fxp_mult3 x y)) (- (* x y)) 1000000000))) :pattern ((fxp_mult3 x y)) ))))
...
;; fxp_div_def
  ...
  (! (ite (= x 0) (= (fxp_div3 x y) 0)
     (ite (and (< 0 x) (< 0 y)) (pos_div_relation3 (fxp_div3 x y)
     (* x 1000000000) y)
     ...
     (* x 1000000000) (- y))))))) :pattern ((fxp_div3 x y)) ))))
...
;; to_int_def
  ...
  (forall ((x Int))
  (! (ite (= x 0) (= (to_int4 x) 0)
     (ite (< 0 x) (pos_div_relation3 (to_int4 x) x 1000000000)
     (pos_div_relation3 (- (to_int4 x)) (- x) 1000000000))) :pattern (
  (to_int4 x)) )))
...
;; coerce_axiom
  (assert
  (forall ((x Int))
  (! (=> (in_range3 x) (= (to_fixed3 (of_fixed3 x)) x)) :pattern ((to_fixed3
                                                                  (of_fixed3
                                                                  x))) )))

(declare-datatypes ()
((my_duration2__ref
 (mk_my_duration2__ref (my_duration2__content my_duration2)))))
(define-fun my_duration2__ref___projection ((a my_duration2__ref)) my_duration2
...
(declare-fun md2 () my_duration2)

(declare-fun o () my_duration)

(declare-fun o1 () my_duration2)

(declare-fun result () my_duration)

(declare-fun md1 () my_duration)

(declare-fun result1 () my_duration2)

(declare-fun md21 () my_duration2)
