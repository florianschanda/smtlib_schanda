...
(declare-const dummy2 t5s)

(declare-datatypes ((t5s__ref 0)) (((mk_t5s__ref (t5s__content t5s)))))
...
(declare-const s__split_fields1 (Array Int natural))
...
(declare-const temp___169 length_type)

(declare-const temp___1691 (Array Int natural))
...
(declare-const s__split_fields2 length_type)

(declare-const s__split_fields3 (Array Int natural))
...
;; H
  (assert
  (and (= o (+ (to_rep1 s__split_fields) 1)) (in_range1
...
;; H
  (assert (= temp___169 s__split_fields2))

;; H
  (assert (= temp___1691 s__split_fields3))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= 1 (to_rep1 s__split_fields2))))
(check-sat)
(exit)
