...
;; in_bounds__def_axiom
  ...
  (! (= (= (in_bounds c1) true)
     ...
     (and
     (and (in_range1
     (+ (to_rep (rec__shapes4__circle__center_x (us_split_fields1 c1)))
...
;; H
  ...
  (and
  (= o (abs (- x (to_rep
                 (rec__shapes4__circle__center_x (us_split_fields1 c))))))
  (in_range
  (abs (- x (to_rep (rec__shapes4__circle__center_x (us_split_fields1 c))))))))
...
;; H
  ...
  (and
  (= o2 (abs (- y (to_rep
                  (rec__shapes4__circle__center_y (us_split_fields1 c))))))
  (in_range
  (abs (- y (to_rep (rec__shapes4__circle__center_y (us_split_fields1 c))))))))
