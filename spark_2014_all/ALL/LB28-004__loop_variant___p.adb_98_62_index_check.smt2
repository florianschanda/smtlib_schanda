...
(define-fun tab46 () map__ref (mk_map__ref tab))
...
;; H
  (assert (=> (<= j1 b) (= (mk_map__ref result1) tab46)))
...
;; H
  (assert
  (forall ((l1 Int))
  (=> (and (<= a l1) (<= l1 (- j54 1))) (= (to_rep (select tab45 l1)) l1))))

;; H
  (assert
  (forall ((l1 Int))
  (=> (and (<= a l1) (<= l1 (- (+ a k33) 1)))
  (= (to_rep (select tab45 l1)) l1))))
...
;; H
  (assert (and (= o40 (- j54 1)) (in_range1 (- j54 1))))

;; H
  (assert (= o41 (ite (<= l o40) true false)))

;; H
  (assert (= result47 (ite (<= a l) o41 false)))
