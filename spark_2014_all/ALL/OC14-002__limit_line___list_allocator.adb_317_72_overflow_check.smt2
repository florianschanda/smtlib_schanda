...
;; H
  ...
  (=> (and (<= 1 rr1) (<= rr1 r2))
  (= (to_rep
     (rec__list_allocator__cell__prev (us_split_fields1 (select data4 rr1))))
  (ite (= rr1 1) 0 (- rr1 1))))))
...
;; H
  ...
  (=> (and (<= 1 rr1) (<= rr1 r2))
  (= (to_rep
     (rec__list_allocator__cell__next (us_split_fields1 (select data4 rr1))))
  (ite (= rr1 3) 0 (+ rr1 1))))))
...
;; H
  ...
  (=> (and (<= 1 rr1) (<= rr1 3))
  (= (to_rep1
     (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr1)))) 0))))
