...
(declare-datatypes ()
((read_result__ref (mk_read_result__ref (read_result__content us_rep)))))
...
(define-fun current_col4 () int__ref (mk_int__ref current_col))
...
;; H
  (assert
  (=> (= (to_rep current_read__split_fields) 10)
  (and (= o (+ current_line 1)) (in_range (+ current_line 1)))))

;; H
  (assert
  (=> (= (to_rep current_read__split_fields) 10)
  (= (mk_int__ref result) (mk_int__ref current_line))))

;; H
  (assert
  (=> (= (to_rep current_read__split_fields) 10) (= current_line2 o)))

;; H
  (assert
  (=> (= (to_rep current_read__split_fields) 10)
  (= (mk_int__ref result1) current_col4)))

;; H
  (assert (=> (= (to_rep current_read__split_fields) 10) (= current_col2 0)))

;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (=> (= (to_rep current_read__split_fields) 13)
  (= current_col3 current_col))))

;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (=> (= (to_rep current_read__split_fields) 13)
  (= current_col3 current_col1))))

;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (=> (not (= (to_rep current_read__split_fields) 13))
  (and (= o1 (+ current_col 1)) (in_range (+ current_col 1))))))

;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (=> (not (= (to_rep current_read__split_fields) 13))
  (= (mk_int__ref result2) current_col4))))

;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (=> (not (= (to_rep current_read__split_fields) 13)) (= current_col3 o1))))

;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (= current_col2 current_col3)))

;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (= current_line2 current_line)))
...
;; H
  (assert
  (=> (not (= (to_rep current_read__split_fields) 10))
  (= current_line2 current_line1)))

(assert
;; WP_parameter_def
 ;; File "lexer.adb", line 578, characters 0-0
  (not (in_range (+ current_pos 1))))
(check-sat)
(exit)
