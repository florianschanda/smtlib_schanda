...
;; H
  ...
  (=> (<= i2 temp___583) (= (select a1 temp___583) (select a temp___583))))))
...
;; H
  (assert
  (and (= o24 (word_of_boolean carry2))
  (= (oeq (from_word32 o24) (num_of_boolean carry2)) true)))
...
;; H
  (assert
  (= result7 (ite (= o48 true) (ite (<= k a_last) true false) false)))
...
;; H
  (assert
  (and (= o38 (base Tuple0))
  (= o38 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert
  (= o37 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))
         a_first o36)))
