...
(define-fun us_split_fields_ARX2INIT__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl1_type__arx2init a))

(define-fun us_split_fields_PKTSEQ__projection ((a us_split_fields)) bits_8
  (rec__dw1000__register_types__pmsc_ctrl1_type__pktseq a))

(define-fun us_split_fields_ATXSLP__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl1_type__atxslp a))

(define-fun us_split_fields_ARXSLP__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl1_type__arxslp a))

(define-fun us_split_fields_SNOZE__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl1_type__snoze a))

(define-fun us_split_fields_SNOZR__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl1_type__snozr a))

(define-fun us_split_fields_PLLSYN__projection ((a us_split_fields)) bits_1
  (rec__dw1000__register_types__pmsc_ctrl1_type__pllsyn a))

(define-fun us_split_fields_LDERUNE__projection ((a us_split_fields)) bits_1
...
((pmsc_ctrl1_type__ref
 (mk_pmsc_ctrl1_type__ref (pmsc_ctrl1_type__content us_rep)))))
(define-fun pmsc_ctrl1_type__ref___projection ((a pmsc_ctrl1_type__ref)) us_rep
...
(declare-fun temp___8077 () (Array Int bits_8))

(declare-fun temp___80771 () t2)

(declare-fun temp___8078 () (Array Int bits_8))

(declare-fun temp___80781 () t1)
