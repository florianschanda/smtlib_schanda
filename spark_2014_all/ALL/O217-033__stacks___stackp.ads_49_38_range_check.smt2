...
(declare-fun dummy2 () less_than_max)
...
;; wraps_around__def_axiom
  ...
  (! (= (= (wraps_around s) true)
     ...
     (to_rep1 (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1))) :pattern (
  (wraps_around s)) )))
...
;; H
  ...
  (<= (to_rep2
      ...
      s__split_fields3) s__attr__tag))))) (to_rep2
                                          (last
                                          (rt
                                          (get_model__3
                                          (mk___rep1
  ...
  (= o (+ (- (to_rep2
             ...
             s__split_fields2 s__split_fields3) s__attr__tag))))) (to_rep2
                                                                  (first
                                                                  (rt
                                                                  (get_model__3
                                                                  (mk___rep1
...
(assert
;; WP_parameter_def
 ;; File "stackp.adb", line 38, characters 0-0
  (not (in_range o3)))
(check-sat)
(exit)
