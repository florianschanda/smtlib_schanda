...
(declare-fun dynamic_preds_array__init_constant_even_pair__tmp__aggregate_def (Int
  Int) (Array Int even))

;; def_axiom
  (assert
  (forall ((temp___262 Int) (temp___263 Int))
  (let ((temp___261 (dynamic_preds_array__init_constant_even_pair__tmp__aggregate_def
                    temp___262 temp___263)))
  (and (= (select temp___261 1) (of_rep temp___262))
  (= (select temp___261 2) (of_rep temp___263))))))
...
(assert
;; WP_parameter_def
 ;; File "dynamic_preds_array.adb", line 39, characters 0-0
  (not (= (mod2 2 2) 0)))
(check-sat)
(exit)
