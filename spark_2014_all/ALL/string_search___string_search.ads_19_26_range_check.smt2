...
;; H
  (assert (dynamic_invariant1 needle true false true))

;; H
  (assert (dynamic_invariant1 haystack true false true))

;; H
  (assert (in_range2 loc))

;; H
  (assert (and (= o (length needle)) (in_range (length needle))))

(assert
;; WP_parameter_def
 ;; File "string_search.ads", line 18, characters 0-0
  (not (in_range (length haystack))))
(check-sat)
(exit)
