...
;; H
  ...
  (and
  (and
  (= (length2 (mk___rep l__split_discrs l__split_fields2)) (- (length2
                                                              (mk___rep
                                                              l__split_discrs
                                                              (mk___split_fields
                                                              l__split_fields))) 1))
  ...
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields2))
     ...
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (mk___rep1 (mk___split_fields1 cu__split_fields)))
     (length2 (mk___rep l__split_discrs l__split_fields2)) 1) true))
  (= (p_positions_shifted
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 55, characters 0-0
  (not
  (< (length2 (mk___rep l__split_discrs l__split_fields2)) (to_rep
                                                           (rec__p__my_lists__list__capacity
                                                           l__split_discrs)))))
(check-sat)
(exit)
