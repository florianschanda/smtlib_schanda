...
(declare-fun bool_eq1 ((Array Int us_rep) Int Int (Array Int us_rep) Int
  Int) Bool)
...
(declare-fun ada__synchronous_task_control__suspend_until_true__s () us_rep)

(declare-fun sos () (Array Int us_rep))

(declare-fun ada__synchronous_task_control__suspend_until_true__s1 () us_rep)

(declare-fun result () (Array Int us_rep))

(declare-fun sos1 () (Array Int us_rep))
