...
;; H
  (assert (= temp___1260 (- o38 2)))

;; H
  (assert
  (and (<= (to_rep2 (first2 u__split_fields1)) temp___1260)
  (<= temp___1260 (to_rep2 (last3 u__split_fields1)))))

;; H
  (assert (= o39 temp___1260))
