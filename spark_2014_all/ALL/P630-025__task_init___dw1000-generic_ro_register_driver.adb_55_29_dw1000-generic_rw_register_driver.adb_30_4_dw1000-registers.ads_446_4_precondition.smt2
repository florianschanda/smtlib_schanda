...
(define-fun register_type__ref___136__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___96__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___96__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5378 us_t1)
  (temp___is_init_5375 Bool) (temp___skip_constant_5376 Bool)
  (temp___do_toplevel_5377 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5376 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_5378)
                                       (last3 temp___expr_5378))
                                       (and (= (first3 temp___expr_5378) 1)
                                       (= (last3 temp___expr_5378) 5)))))
