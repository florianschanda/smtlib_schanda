...
(define-fun register_type__ref_136__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_96__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_96__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5292 us_t1)
  (temp___is_init_5289 Bool) (temp___skip_constant_5290 Bool)
  (temp___do_toplevel_5291 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5290 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_5292)
                                       (last3 temp___expr_5292))
                                       (and (= (first3 temp___expr_5292) 1)
                                       (= (last3 temp___expr_5292) 5)))))
