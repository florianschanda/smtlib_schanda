...
;; H
  (assert
  (and (= o20 (count o26)) (and (in_range4 o20) (= o20 (to_rep1 o19)))))
...
;; H
  (assert
  (and (= o21 (stack_entry o27 o20))
  (and (in_range1 o21) (= o21 (to_rep (select o16 o20))))))
...
;; H
  (assert
  (and (= o13 (max_stack_size Tuple0)) (and (in_range4 o13) (= o13 100))))
...
;; H
  (assert
  (and (= o14 (count o28)) (and (in_range4 o14) (= o14 (to_rep1 o12)))))
