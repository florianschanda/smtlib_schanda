...
(declare-datatypes ((tname_stringP1__ref 0))
...
(declare-datatypes ((tTaddressSP1__ref 0))
...
(declare-datatypes ((tTcitySP1__ref 0))
(((mk_tTcitySP1__ref (tTcitySP1__content tTcitySP1)))))
...
;; WP_parameter_def
 ;; File "string_examples.adb", line 2, characters 0-0
  ...
  (= (ite (<= (to_rep1 (first2 temp___5501)) (to_rep1 (last2 temp___5501)))
     ...
     0) (ite (<= (to_rep1 (first2 (mk1 1 r9b))) (to_rep1 (last2 (mk1 1 r9b))))
        (+ (- (to_rep1 (last2 (mk1 1 r9b))) (to_rep1 (first2 (mk1 1 r9b)))) 1)
        0))))
(check-sat)
(exit)
