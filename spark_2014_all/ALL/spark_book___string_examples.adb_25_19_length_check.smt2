...
;; H
  (assert (= (concat1 name3 1 20 name3 1 20) temp___546))

;; H
  (assert (= (mk 1 o9) temp___5461))

;; H
  (assert
  (= (ite (<= (to_rep1 (first temp___5461)) (to_rep1 (last temp___5461)))
     (+ (- (to_rep1 (last temp___5461)) (to_rep1 (first temp___5461))) 1) 0)
  (ite (<= 1 40) (+ (- 40 1) 1) 0)))

;; H
  (assert (= o10 (slide temp___546 (to_rep1 (first temp___5461)) 1)))
...
;; H
  ...
  (ite (and (<= 9 temp___548) (<= temp___548 28))
  (= (select o11 temp___548) (select (slide name3 1 9) temp___548))
  (= (select o11 temp___548) (select address3 temp___548)))))
...
;; H
  (assert
  (= (ite (<= 1 5) (+ (- 5 1) 1) 0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))

;; H
  (assert (= (temp___String_Literal_549 Tuple0) temp___550))

;; H
  (assert (= (mk1 1 5) temp___5501))

;; H
  (assert
  (=> (<= 1 r9b) (and (and (<= 1 1) (<= 1 20)) (and (<= 1 r9b) (<= r9b 20)))))

;; H
  (assert (= o12 name3))

;; H
  (assert (= o12 temp___552))

;; H
  (assert (= (mk1 1 r9b) temp___5521))

(assert
;; WP_parameter_def
 ;; File "string_examples.adb", line 2, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___5501)) (to_rep1 (last2 temp___5501)))
     (+ (- (to_rep1 (last2 temp___5501)) (to_rep1 (first2 temp___5501))) 1)
     0) (ite (<= (to_rep1 (first2 temp___5521)) (to_rep1 (last2 temp___5521)))
        (+ (- (to_rep1 (last2 temp___5521)) (to_rep1 (first2 temp___5521))) 1)
        0))))
(check-sat)
(exit)
