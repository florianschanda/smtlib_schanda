...
(declare-fun idx11 () int__ref)

(declare-fun result____split_fields12 () us_split_fields)

(declare-fun idx12 () Int)

(declare-fun rho () us_split_fields)
...
;; H
  ...
  (=> (and (<= 1 i) (<= i idx9))
  (= (get (model__ (mk___rep result____split_discrs result____split_fields9))
     (+ (last (model__ left)) i)) (get (model__ right) i)))))
...
;; H
  (assert
  (and (= o7 (get (model__ right) o6))
  (and (in_range6 o7) (= o7 (get (model__ right) o6)))))
...
;; H
  ...
  (length (mk___rep result____split_discrs result____split_fields9)) 1))
  (= (olt (model__ (mk___rep result____split_discrs result____split_fields9))
     (model__
     (mk___rep result____split_discrs
  ...
  (= (get
     ...
     amortized_queue__my_vectors__append__2__container__fields2))
     (+ (last
        (model__ (mk___rep result____split_discrs result____split_fields9))) 1))
  o7)))
...
;; H
  (assert
  (= result____split_fields10 amortized_queue__my_vectors__append__2__container__fields2))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 76, characters 0-0
  ...
  (= (get
     (model__
     (mk___rep result____split_discrs
     (us_split_fields__content result____split_fields11)))
     (+ (last (model__ left)) i)) (get (model__ right) i))))
(check-sat)
(exit)
