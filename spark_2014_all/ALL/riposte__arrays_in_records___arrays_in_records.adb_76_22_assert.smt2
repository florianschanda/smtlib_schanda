...
(declare-fun temp___214 () index)

(declare-fun temp___2141 () (Array Int value))

(declare-fun temp___2142 () (Array Int value))
...
(declare-fun temp___217 () index)

(declare-fun temp___2171 () (Array Int value))

(declare-fun temp___2172 () (Array Int value))
...
(declare-fun o12 () (Array Int value))

(declare-fun o13 () (Array Int value))

(declare-fun temp___220 () index)

(declare-fun temp___2201 () (Array Int value))

(declare-fun temp___2202 () (Array Int value))
...
;; H
  (assert (= (to_rep1 (select a__split_fields1 i)) 23))
...
;; H
  (assert (= temp___214 a__split_fields3))

;; H
  (assert (= temp___2141 a__split_fields4))

;; H
  (assert (= temp___2142 a__split_fields5))

;; H
  (assert (= (to_rep1 o4) 42))
...
;; H
  (assert (= temp___217 o6))

;; H
  (assert (= temp___2171 o7))

;; H
  (assert (= temp___2172 o8))
...
;; H
  (assert (= temp___217 a__split_fields6))

;; H
  (assert (= temp___2171 a__split_fields7))

;; H
  (assert (= temp___2172 a__split_fields8))

;; H
  (assert (= (to_rep1 o9) 23))

;; H
  (assert (= o10 (store a__split_fields8 i o9)))

;; H
  (assert (= a__split_fields6 o11))

;; H
  (assert (= a__split_fields7 o12))

;; H
  (assert (= o10 o13))

;; H
  (assert (= temp___220 o11))

;; H
  (assert (= temp___2201 o12))

;; H
  (assert (= temp___2202 o13))
...
;; H
  (assert (= temp___220 a__split_fields9))

;; H
  (assert (= temp___2201 a__split_fields10))

;; H
  (assert (= temp___2202 a__split_fields11))

(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 57, characters 0-0
  (not (= (to_rep1 (select a__split_fields11 i)) 23)))
(check-sat)
(exit)
