...
(declare-const temp___214 index)

(declare-const temp___2141 (Array Int value))

(declare-const temp___2142 (Array Int value))
...
(declare-const temp___217 index)

(declare-const temp___2171 (Array Int value))

(declare-const temp___2172 (Array Int value))
