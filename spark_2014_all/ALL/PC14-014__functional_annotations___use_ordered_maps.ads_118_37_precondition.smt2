...
(define-fun default_initial_assumption ((temp___expr_334 us_rep1)
...
;; H
  ...
  (=> (and (in_range4 temp___396) (= (iter_has_element o2 temp___396) true))
...
(assert
;; WP_parameter_def
 ;; File "use_ordered_maps.ads", line 104, characters 0-0
  (not (<= 1 i)))
(check-sat)
(exit)
