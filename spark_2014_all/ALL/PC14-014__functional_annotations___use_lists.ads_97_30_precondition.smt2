...
;; H
  ...
  (and (not (= (has_key o17 no_element) true))
  (forall ((i2 us_rep1))
  (=> (= (has_key o17 i2) true)
  (and
  (and (<= 1 (get1 o17 i2))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o17 j) true)
  (=> (= (get1 o17 i2) (get1 o17 j)) (= (bool_eq1 i2 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o21)
  (=> (= (of_int 0) true)
  (and (= o21 (w_get o17 (witness o17 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o17 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o17 cu) (witness o17 k))))))))))
...
;; H
  ...
  (= o15 (positions
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (not (= (has_key o15 no_element) true))
  (forall ((i2 us_rep1))
  (=> (= (has_key o15 i2) true)
  (and
  (and (<= 1 (get1 o15 i2))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o15 j) true)
  (=> (= (get1 o15 i2) (get1 o15 j)) (= (bool_eq1 i2 j) true))))))))))

;; H
  (assert
  (and (= o16 (has_key o15 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o15 k) true) (= (bool_eq1 k cu) true))) (= o16 true)))))
...
;; H
  ...
  (= o11 (length
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o11)
  (<= o11 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep l__split_discrs (mk___split_fields l__split_fields8))) i2) 0)))))
