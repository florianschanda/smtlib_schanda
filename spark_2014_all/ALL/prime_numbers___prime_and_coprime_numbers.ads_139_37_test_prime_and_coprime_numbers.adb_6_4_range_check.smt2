...
;; H
  (assert (= (ite (= (is_prime value) false) (= mode 1) false) true))
...
;; H
  (assert
  (and
  (= o1 (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1))
  (in_range1
  (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1))))

;; H
  (assert (= o2 (ite (<= o1 v) true false)))

;; H
  (assert (= result1 (ite (= o2 true) (ite (<= v value) true false) false)))
