...
;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_available 0)) (= result2 (ite (< 0 o3) true false)))))
...
;; H
  ...
  (=> (= result1 true)
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result (ite (= o2 first_available) true false))))))
...
;; H
  ...
  (= o4 (length
        (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))
  (and (in_range5 o4) (<= (+ 0 o4) 2147483647))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_available 0))) (= result (ite (= o4 0) true false)))))
