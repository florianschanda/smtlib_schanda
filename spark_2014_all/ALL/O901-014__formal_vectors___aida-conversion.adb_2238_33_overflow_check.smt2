...
(define-fun tint_arrayD1__ref___26__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___26__projection ((a tint_arrayT__ref)) us_t1
...
(declare-datatypes ((t811b__ref 0))
(((mk_t811b__ref (t811b__content integer)))))
...
(((mk_t812b__ref (t812b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___35__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___35__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ((t815b__ref 0))
(((mk_t815b__ref (t815b__content integer)))))
...
(declare-datatypes ((t816b__ref 0))
(((mk_t816b__ref (t816b__content us_t4)))))
...
(declare-datatypes ((t817b__ref 0))
(((mk_t817b__ref (t817b__content integer)))))
...
(define-fun tint_arrayB__ref___26__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___35__projection ((a tnumber_array_typeB__ref)) us_t6
