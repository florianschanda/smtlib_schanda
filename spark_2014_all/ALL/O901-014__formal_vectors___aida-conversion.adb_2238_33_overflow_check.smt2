...
;; def_axiom
  (assert
  (forall ((temp___2414 Int) (temp___2415 Int) (temp___2416 Int)
  (temp___2417 Int))
  (let ((temp___2413 (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def
                     temp___2414 temp___2415 temp___2416 temp___2417)))
  (and
  (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 2)
  temp___2416 temp___2417)
  (and (= (first5 temp___2413) temp___2416)
  (= (last5 temp___2413) temp___2417)))
  (and
  (= (select (to_array2 temp___2413) (+ (+ (first1 source) 1) 0)) (of_rep1
                                                                  temp___2414))
  (= (select (to_array2 temp___2413) (+ (+ (first1 source) 1) 1)) (of_rep1
                                                                  temp___2415)))))))
...
;; def_axiom
  (assert
  (forall ((temp___2423 Int) (temp___2424 Int) (temp___2425 Int))
  (let ((temp___2422 (aida__conversion__calculate_negative_target_length_3__n__aggregate_def
                     temp___2423 temp___2424 temp___2425)))
  (and
  (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 2)
  temp___2424 temp___2425)
  (and (= (first9 temp___2422) temp___2424)
  (= (last9 temp___2422) temp___2425)))
  (forall ((temp___2426 Int))
...
(define-fun dynamic_invariant4 ((temp___expr_815 us_t3)
  (temp___is_init_812 Bool) (temp___skip_constant_813 Bool)
  (temp___do_toplevel_814 Bool)) Bool (=>
                                      (not (= temp___skip_constant_813 true))
                                      (and (dynamic_property6
                                      (+ (first1 source) 1)
                                      (+ (first1 source) 2)
                                      (first7 temp___expr_815)
                                      (last7 temp___expr_815))
                                      (and
                                      (= (first7 temp___expr_815) (+
                                      (first1 source) 1))
                                      (= (last7 temp___expr_815) (+ (first1
                                                                    source) 2))))))
...
(declare-fun temp___2420 () (Array Int integer))

(declare-fun temp___24201 () t2)
...
(declare-fun temp___2428 () (Array Int integer))

(declare-fun temp___24281 () t4)
...
(declare-fun temp___2434 () Int)

(declare-fun temp___2435 () Int)

(declare-fun temp___2433 () Int)
...
;; H
  (assert
  (= (mk___t2 temp___2420 temp___24201) (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def
                                        9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___24201)) (to_rep1 (last4 temp___24201)))
     (+ (- (to_rep1 (last4 temp___24201)) (to_rep1 (first4 temp___24201))) 1)
...
;; H
  (assert
  (= (slide1 temp___2420 (to_rep1 (first4 temp___24201))
...
;; H
  (assert
  (= (mk___t4 temp___2428 temp___24281) (aida__conversion__calculate_negative_target_length_3__n__aggregate_def
                                        0 (+ (to_rep1 (first (rt source))) 1)
                                        (+ (to_rep1 (first (rt source))) 2))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___24281)) (to_rep1 (last8 temp___24281)))
     (+ (- (to_rep1 (last8 temp___24281)) (to_rep1 (first8 temp___24281))) 1)
     0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1
                                                        (first (rt source))) 2))
        (+ (- (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1
                                                     (first (rt source))) 1)) 1)
...
;; H
  (assert
  (= (slide1 temp___2428 (to_rep1 (first8 temp___24281))
...
;; H
  (assert
  (and (= temp___2434 (+ (to_rep1 (first (rt source))) 1)) (in_range1
  (+ (to_rep1 (first (rt source))) 1))))

;; H
  (assert
  (and (= temp___2435 (+ (to_rep1 (first (rt source))) 2)) (in_range1
  (+ (to_rep1 (first (rt source))) 2))))
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435))
  (= temp___2433 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= o index1)))
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= o3 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= o7 index1)))
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= n1 result3)))

;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= n2 o8)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___2432 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___2432)
  (<= temp___2432 (to_rep1 n__last)))
  (=> (< index2 temp___2432)
  (= (select n3 temp___2432) (select temp___2431 temp___2432)))))
  (=>
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= n3 n4)))
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= n5 n3)))
...
;; H
  (assert
  (=> (and (<= temp___2434 index1) (<= index1 temp___2435)) (= n7 n5)))

;; H
  (assert
  (=> (not (and (<= temp___2434 index1) (<= index1 temp___2435)))
...
;; H
  (assert
  (=> (not (and (<= temp___2434 index1) (<= index1 temp___2435))) (= n7 n1)))
