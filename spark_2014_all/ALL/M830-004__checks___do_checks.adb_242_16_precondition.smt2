...
;; def_axiom
  (assert
  (forall ((temp___807 Bool))
  (forall ((temp___808 Int))
  (= (select (do_checks__do_length_check__B_19__y__aggregate_def temp___807) temp___808) temp___807))))

(declare-fun do_checks__do_length_check__B_19__x__aggregate_def (Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___810 Bool))
  (forall ((temp___811 Int))
  (= (select (do_checks__do_length_check__B_19__x__aggregate_def temp___810) temp___811) temp___810))))
...
;; def_axiom
  ...
  (= (select (do_checks__do_length_check__B_20__y__aggregate_def temp___815) temp___816) temp___815))))

(declare-fun do_checks__do_length_check__B_20__x__aggregate_def (Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___818 Bool))
  (forall ((temp___819 Int))
  (= (select (do_checks__do_length_check__B_20__x__aggregate_def temp___818) temp___819) temp___818))))

(declare-fun do_checks__do_length_check__B_21__x__aggregate_def (Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___821 Bool))
  (forall ((temp___822 Int))
  (= (select (do_checks__do_length_check__B_21__x__aggregate_def temp___821) temp___822) temp___821))))

(declare-fun do_checks__do_length_check__B_22__x__aggregate_def (Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___824 Bool))
  (forall ((temp___825 Int))
  (= (select (do_checks__do_length_check__B_22__x__aggregate_def temp___824) temp___825) temp___824))))

(declare-fun do_checks__do_length_check__B_23__x__aggregate_def (Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___828 Bool))
  (forall ((temp___829 Int))
  (= (select (do_checks__do_length_check__B_23__x__aggregate_def temp___828) temp___829) temp___828))))

(declare-fun do_checks__do_length_check__B_24__x__aggregate_def (Bool) (Array Int Bool))

;; def_axiom
  (assert
  (forall ((temp___832 Bool))
  (forall ((temp___833 Int))
  (= (select (do_checks__do_length_check__B_24__x__aggregate_def temp___832) temp___833) temp___832))))
...
(define-fun dynamic_invariant2 ((temp___expr_320 us_t)
  ...
  (temp___do_toplevel_319 Bool)) Bool (=>
                                      ...
                                      (first1 temp___expr_320)
                                      (last1 temp___expr_320))))

(assert
;; WP_parameter_def
 ;; File "do_checks.adb", line 11, characters 0-0
  (not true))
(check-sat)
(exit)
