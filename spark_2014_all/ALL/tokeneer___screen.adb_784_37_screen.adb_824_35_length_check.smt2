...
(declare-const temp___1444 us_t7)
...
;; H
  (assert
  (=> (<= 1 temp___1443)
  (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___1443) (<= temp___1443 10)))))

;; H
  (assert (= o22 (let ((subject result__3)) result__10)))

;; H
  (assert (= temp___1444 (mk___t7 o22 (mk7 1 temp___1443))))

(assert
;; WP_parameter_def
 ;; File "screen.adb", line 712, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first14 (rt7 temp___1441))) (to_rep1
                                                    (last14
                                                    (rt7 temp___1441))))
     (+ (- (to_rep1 (last14 (rt7 temp___1441))) (to_rep1
                                                (first14 (rt7 temp___1441)))) 1)
     0) (ite (<= (to_rep1 (first14 (rt7 temp___1444))) (to_rep1
                                                       (last14
                                                       (rt7 temp___1444))))
        (+ (- (to_rep1 (last14 (rt7 temp___1444))) (to_rep1
                                                   (first14
                                                   (rt7 temp___1444)))) 1)
        0))))
(check-sat)
