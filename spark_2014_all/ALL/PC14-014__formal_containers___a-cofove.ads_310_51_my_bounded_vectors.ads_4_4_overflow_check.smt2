...
(define-fun dynamic_invariant ((temp___expr_694 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_700 Int)
...
(define-fun dynamic_invariant3 ((temp___expr_727 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_721 Int)
