...
;; H
  (assert (le (add RNE1 (mul RNE1 (of_int RNE1 n) fliteral2) fliteral)
  (mul RNE1 (of_int RNE1 (+ n 1)) fliteral2)))
...
;; H
  (assert (le (sub RNE1 (low_bound n) fliteral)
  (sub RNE1 old_speed fliteral)))

;; H
  (assert (le (sub RNE1 (low_bound n) fliteral) new_speed1))

;; H
  (assert (le (mul RNE1 (of_int RNE1 (+ n 1)) (neg fliteral2))
  (sub RNE1 (mul RNE1 (of_int RNE1 n) (neg fliteral2)) fliteral)))
...
;; H
  (assert
  (and (= o4 (low_bound o3))
  (and (tqtisFinite o4) (= o4 (mul RNE1 (of_int RNE1 o3) (neg fliteral2))))))
