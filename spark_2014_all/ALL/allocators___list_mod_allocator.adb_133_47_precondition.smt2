...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 (length avail2)))
  (=> (= (get avail2 j1) (get avail2 k1)) (= j1 k1)))))))
...
;; H
  (assert (= result8 (ite (<= 1 j) o14 false)))
...
;; H
  (assert
  (and (= o15 (length avail2))
  (and (in_range5 o15) (<= (+ 0 o15) 2147483647))))

;; H
  (assert (= o16 (ite (<= k o15) true false)))

;; H
  (assert (= result9 (ite (<= 1 k) o16 false)))
