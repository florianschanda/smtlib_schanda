...
(declare-fun dummy2 () storage_offset)
...
;; oadd__post_axiom
  ...
  (forall ((right Int))
  (! (=>
     (and (dynamic_invariant1 left true true true) (dynamic_invariant2 right
     true true true)) (dynamic_invariant1 (oadd left right) true false true)) :pattern (
  (oadd left right)) ))))
...
;; omod__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant1 left true true true) (dynamic_invariant2 right
     true true true)) (dynamic_invariant2 (omod left right) true false true)) :pattern (
  (omod left right)) ))))
...
(declare-fun dummy3 () integer_address)

(declare-datatypes ()
((integer_address__ref
 (mk_integer_address__ref (integer_address__content integer_address)))))
(define-fun integer_address__ref___projection ((a integer_address__ref)) integer_address
  (integer_address__content a))

(define-fun dynamic_invariant3 ((temp___expr_195 (_ BitVec 64))
  (temp___is_init_192 Bool) (temp___skip_constant_193 Bool)
  (temp___do_toplevel_194 Bool)) Bool true)
...
;; to_address__post_axiom
  ...
  (! (=> (dynamic_invariant3 value true true true) (dynamic_invariant1
     (to_address value) true false true)) :pattern ((to_address value)) )))

(declare-fun buffer () (_ BitVec 64))
...
;; zero__post_axiom
  (assert
  (forall ((us_void_param tuple0)) (! (dynamic_invariant4
...
(declare-fun pixel__buffer__assume () (_ BitVec 64))
...
(assert
;; WP_parameter_def
 ;; File "pixel.adb", line 12, characters 0-0
  (not (not (= o 0))))
(check-sat)
(exit)
