...
(define-fun element_type__ref_6__projection ((a element_type__ref)) element_type
...
;; H
  ...
  (= o (positions
       (mk___rep container__split_discrs
       (mk___split_fields container__split_fields))))
  (and (not (= (has_key o no_element) true))
  (forall ((i us_rep1))
  (=> (= (has_key o i) true)
  (and
  (and (<= 1 (get o i))
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o j) true)
  (=> (= (get o i) (get o j)) (= (bool_eq1 i j) true))))))))))

(assert
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not
  (= (has_key o (mk___rep1 (mk___split_fields1 position__split_fields))) true)))
(check-sat)
(exit)
