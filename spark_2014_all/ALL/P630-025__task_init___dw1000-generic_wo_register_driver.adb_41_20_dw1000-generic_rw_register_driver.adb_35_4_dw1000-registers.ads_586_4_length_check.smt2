...
(define-fun us_split_fields_LDE_REPC__projection ((a us_split_fields)) bits_16
  (rec__dw1000__register_types__lde_repc_type__lde_repc a))

(declare-datatypes ((us_split_fields__ref 0))
(((mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___86__projection ((a us_split_fields__ref)) us_split_fields
  (us_split_fields__content a))

(declare-datatypes ((us_rep 0))
(((mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___86__projection ((a us_rep)) us_split_fields (us_split_fields1
                                                                 a))
...
(((mk_lde_repc_type__ref (lde_repc_type__content us_rep)))))
(define-fun lde_repc_type__ref___projection ((a lde_repc_type__ref)) us_rep
  (lde_repc_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___209__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___147__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___147__projection ((a register_byte_array__ref)) us_t1
...
(define-fun target__ref___63__projection ((a target__ref)) us_t2 (target__content
                                                                 a))

(declare-datatypes ((source__ref 0))
(((mk_source__ref (source__content us_rep)))))
(define-fun source__ref___63__projection ((a source__ref)) us_rep (source__content
                                                                  a))

(define-fun dynamic_invariant1 ((temp___expr_6935 us_t2)
  (temp___is_init_6932 Bool) (temp___skip_constant_6933 Bool)
  (temp___do_toplevel_6934 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_6933 true))
                                       (and (dynamic_property3 1 2
                                       (first5 temp___expr_6935)
                                       (last5 temp___expr_6935))
                                       (and (= (first5 temp___expr_6935) 1)
                                       (= (last5 temp___expr_6935) 2)))))
...
(declare-const temp___8175 (Array Int bits_8))

(declare-const temp___81751 t2)

(define-fun temp___81752 () us_t2 (mk___t2 temp___8175 temp___81751))
...
;; H
  (assert
  (and (= temp___81752 (register_to_bytes reg)) (dynamic_invariant1
  temp___81752 true false true)))

(assert
;; WP_parameter_def
 ;; File "dw1000-generic_wo_register_driver.adb", line 28, characters 0-0
  (not
  (= (ite (<= (to_rep (first4 temp___81751)) (to_rep (last4 temp___81751)))
     (+ (- (to_rep (last4 temp___81751)) (to_rep (first4 temp___81751))) 1)
     0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
