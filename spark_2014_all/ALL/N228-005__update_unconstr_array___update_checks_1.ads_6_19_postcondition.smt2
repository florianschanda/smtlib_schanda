...
(((mk_tS1bP1__ref (tS1bP1__content tindexB)))))
...
(declare-const temp___381 (Array Int integer))

(declare-const temp___3811 t)

(declare-const temp___382 (Array Int integer))

(declare-const temp___3821 t)
...
;; WP_parameter_def
 ;; File "update_checks_1.ads", line 32, characters 0-0
  ...
  (= (let ((temp___389 (temp___214
                       ...
                       i new_val)))
     (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___389)
