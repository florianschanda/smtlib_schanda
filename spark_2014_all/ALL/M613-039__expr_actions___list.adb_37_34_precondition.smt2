...
;; H
  (assert (and (= o12 (- last3 i9)) (in_range1 (- last3 i9))))

;; H
  (assert
  (and (= o11 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1
  o11 true false true)))

;; H
  (assert (= o13 (to_rep (last (rt o11)))))

;; H
  (assert (= result4 (ite (= o13 o12) true false)))
...
;; H
  (assert (=> (= result4 true) (= o9 (elts list__reverse_list__L_2__R20b))))

;; H
  (assert
  (=> (= result4 true) (= temp___472 (mk___t2 o9 (mk2 first2 temp___470)))))
...
;; H
  (assert (=> (= result4 true) (= o10 (elts list__reverse_list__L_2__R16b))))

;; H
  (assert
  (=> (= result4 true) (= temp___471 (mk___t1 o10 (mk1 first2 temp___469)))))
