...
;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o22) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o21 (get model____split_fields 1)) (in_range7 o21)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o21 first_available) true false)))))
...
;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o19) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o18 (get model____split_fields1 1)) (in_range7 o18))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o18 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o16 (length model____split_fields)) (in_range6 o16))))
...
;; H
  (assert
  (=> (= result8 true)
  (and (= o11 (length model____split_fields1)) (in_range6 o11))))
...
;; H
  (assert
  (=> (= result8 true)
  (=> (= result9 true) (and (= o12 (+ j 1)) (in_range1 (+ j 1))))))

;; H
  (assert
  (=> (= result8 true)
  (=> (= result9 true)
  (and (= o13 (get model____split_fields1 o12)) (in_range7 o13)))))
...
;; H
  (assert
  (=> (= result8 true)
  (= (mk___rep (mk___split_fields o4 o5 o6)) (select data o3))))
