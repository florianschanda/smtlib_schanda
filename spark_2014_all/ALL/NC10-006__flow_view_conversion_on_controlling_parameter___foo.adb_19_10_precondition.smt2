...
(declare-fun logging__log_type_public__tmp__first__bit () Int)

(declare-fun logging__log_type_public__tmp__last__bit () Int)

(declare-fun logging__log_type_public__tmp__position () Int)
...
(declare-fun log__split_fields1 () us_private)

(declare-fun logging__init_log__2__log__fields () log_count)

(declare-fun logging__init_log__2__log__fields1 () us_private)

(declare-fun result () log_count)

(declare-fun result1 () us_private)

(declare-fun log__split_fields2 () log_count)

(declare-fun log__split_fields3 () us_private)

(define-fun log__split_fields4 () us_split_fields (mk___split_fields
                                                  log__split_fields2
                                                  log__split_fields3))

(define-fun logging__init_log__2__log__fields2 () us_split_fields (mk___split_fields
                                                                  logging__init_log__2__log__fields
...
(assert
;; WP_parameter_def
 ;; File "foo.adb", line 8, characters 0-0
  (not
