...
(declare-fun temp___837 () us_rep)

(declare-fun temp___839 () Int)

(declare-fun temp___836 () read_status)

(declare-fun temp___8361 () character)

(declare-fun temp___8362 () Bool)

(declare-fun temp___835 () Int)

(declare-fun temp___834 () Int)

(declare-fun temp___833 () Int)

(declare-fun temp___832 () read_status)

(declare-fun temp___8321 () character)

(declare-fun temp___8322 () Bool)

(declare-fun temp___840 () Int)

(declare-fun temp___8401 () Int)
...
(declare-fun temp___8402 () Int)

(declare-fun result () int__ref)

(declare-fun temp___8403 () Int)
...
(declare-fun temp___8404 () int__ref)
...
(declare-fun temp___8406 () int__ref)
...
(declare-fun temp___8408 () int__ref)
...
;; H
  ...
  (and (= current_idx16 (mk_int__ref current_idx1))
  (and (= current_col16 (mk_int__ref current_col1))
  (and (= current_line16 (mk_int__ref current_line1))
  (and
  ...
  (and (= current_idx17 current_idx1)
  (and (= current_col17 current_col1)
  (and (= current_line17 current_line1)
  (and (= current_read__split_discrs17 current_read__split_discrs1)
  (and (= current_read__split_fields17 current_read__split_fields1)
  (= the_file17 the_file1)))))))))))
  (not
  (= (to_rep1
  ...
  (= next_read__split_fields14 (mk___split_fields__ref
                               next_read__split_fields1))
  (and (= current_idx14 (mk_int__ref current_idx1))
  (and (= current_col14 (mk_int__ref current_col1))
  (and (= current_line14 (mk_int__ref current_line1))
  (and
  ...
  (and (= current_idx15 current_idx1)
  (and (= current_col15 current_col1)
  ...
  (and (= current_idx14 current_idx12)
  (and (= current_col14 current_col12)
  (and (= current_line14 current_line12)
  ...
  (and (= current_idx15 current_idx13)
  (and (= current_col15 current_col13)
  (and (= current_line15 current_line13)
  ...
  (< current_idx1 current_idx2) (<= current_idx1 current_idx2)))
  (and
  ...
  (and (= current_idx12 (mk_int__ref current_idx2))
  (and (= current_col12 (mk_int__ref current_col2))
  (and (= current_line12 (mk_int__ref current_line2))
  (and
  ...
  (and (= current_idx13 current_idx2)
  (and (= current_col13 current_col2)
  (and (= current_line13 current_line2)
  (and (= current_read__split_discrs13 current_read__split_discrs2)
  (and (= current_read__split_fields13 current_read__split_fields2)
  (= the_file13 the_file2)))))))))))
  (not
  (= (to_rep1
     (rec__file_io__read_result__status current_read__split_discrs2)) 0)))
  (and
  ...
  (and (= current_idx13 current_idx11)
  (and (= current_col13 current_col11)
  (and (= current_line13 current_line11)
  (and (= current_read__split_discrs13 current_read__split_discrs11)
  (and (= current_read__split_fields13 current_read__split_fields11)
  (= the_file13 the_file11)))))))))))
  (and
  (and
  ...
  (and (= next_read__split_discrs10 next_read__split_discrs8)
  (and (= next_read__split_fields10 next_read__split_fields8)
  (and (= current_idx10 current_idx8)
  (and (= current_col10 current_col8)
  (and (= current_line10 current_line8)
  (and (= current_read__split_discrs10 current_read__split_discrs8)
  (and (= current_read__split_fields10 current_read__split_fields8)
  (= the_file10 the_file8)))))))))
  ...
  (and
  (and (and (in_range2 current_line4) (in_range1 current_col4)) (in_range1
  current_idx4)) (in_range1 next_idx4)))
  (or
  (and
  (and
  (and (= next_idx8 (mk_int__ref next_idx4))
  (and
  ...
  (and (= current_idx8 (mk_int__ref current_idx4))
  (and (= current_col8 (mk_int__ref current_col4))
  (and (= current_line8 (mk_int__ref current_line4))
  (and
  ...
  (= the_file8 (mk_file__ref the_file4))))))))))
  (and (= next_idx9 next_idx4)
  (and (= next_read__split_discrs9 next_read__split_discrs4)
  (and (= next_read__split_fields9 next_read__split_fields4)
  (and (= current_idx9 current_idx4)
  (and (= current_col9 current_col4)
  (and (= current_line9 current_line4)
  (and (= current_read__split_discrs9 current_read__split_discrs4)
  (and (= current_read__split_fields9 current_read__split_fields4)
  (= the_file9 the_file4))))))))))
  (not
  (= (to_rep1
     (rec__file_io__read_result__status current_read__split_discrs4)) 0)))
  (and
  (= (to_rep1
     (rec__file_io__read_result__status current_read__split_discrs4)) 0)
  (and
  ...
  (= the_file8 the_file6)))))))))
  (and (= next_idx9 next_idx7)
  (and (= next_read__split_discrs9 next_read__split_discrs7)
  (and (= next_read__split_fields9 next_read__split_fields7)
  (and (= current_idx9 current_idx7)
  (and (= current_col9 current_col7)
  (and (= current_line9 current_line7)
  (and (= current_read__split_discrs9 current_read__split_discrs7)
  (and (= current_read__split_fields9 current_read__split_fields7)
  (= the_file9 the_file7))))))))))
  (or
  (and
  (and
  (and (= next_idx6 (mk_int__ref next_idx4))
  (and
  ...
  (= next_read__split_fields6 (mk___split_fields__ref
                              next_read__split_fields4))
  (and (= current_idx6 (mk_int__ref current_idx4))
  (and (= current_col6 (mk_int__ref current_col4))
  (and (= current_line6 (mk_int__ref current_line4))
  (and
  ...
  (= current_read__split_fields6 (mk___split_fields__ref
                                 current_read__split_fields4))
  (= the_file6 (mk_file__ref the_file4))))))))))
  (and (= next_idx7 next_idx4)
  (and (= next_read__split_discrs7 next_read__split_discrs4)
  (and (= next_read__split_fields7 next_read__split_fields4)
  (and (= current_idx7 current_idx4)
  (and (= current_col7 current_col4)
  (and (= current_line7 current_line4)
  (and (= current_read__split_discrs7 current_read__split_discrs4)
  (and (= current_read__split_fields7 current_read__split_fields4)
  (= the_file7 the_file4))))))))))
  (not
  (= (to_rep (rec__file_io__read_result__c current_read__split_fields4)) 59)))
  (and
  (= (to_rep (rec__file_io__read_result__c current_read__split_fields4)) 59)
  (and
  (and
  (and (= next_idx6 (mk_int__ref next_idx5))
  (and
  (= next_read__split_discrs6 (mk___split_discrs__ref
  ...
  (and (= current_idx6 (mk_int__ref current_idx5))
  (and (= current_col6 (mk_int__ref current_col5))
  (and (= current_line6 (mk_int__ref current_line5))
  (and
  (= current_read__split_discrs6 (mk___split_discrs__ref
                                 current_read__split_discrs5))
  (and
  (= current_read__split_fields6 (mk___split_fields__ref
                                 current_read__split_fields5))
  (= the_file6 (mk_file__ref the_file5))))))))))
  ...
  (and
  (and
  (= (local_invariant the_file5 current_read__split_fields5
     current_read__split_discrs5 current_idx5 next_read__split_fields5
     next_read__split_discrs5 next_idx5) true)
  (ite (= (to_rep1
          (rec__file_io__read_result__status current_read__split_discrs5)) 0)
  (< current_idx4 current_idx5) (<= current_idx4 current_idx5)))
  (and
  (and (and (in_range2 current_line5) (in_range1 current_col5)) (in_range1
...
;; WP_parameter_def
 ;; File "lexer.adb", line 48, characters 0-0
  (not
  (= (local_invariant (file__content the_file22)
     (us_split_fields__content current_read__split_fields22)
     (us_split_discrs__content current_read__split_discrs22)
     (int__content current_idx22)
     (us_split_fields__content next_read__split_fields22)
     (us_split_discrs__content next_read__split_discrs22)
     (int__content next_idx22)) true)))
(check-sat)
(exit)
