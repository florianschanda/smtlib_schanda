...
(declare-fun x2 () (Array Int even))

(declare-fun x3 () (Array Int even))

(declare-fun x4 () (Array Int even))
...
(assert
;; WP_parameter_def
 ;; File "dynamic_preds_array.adb", line 126, characters 0-0
  (not (= (to_rep (select x3 1)) 0)))
(check-sat)
(exit)
