...
(declare-const o9 (Array Int group1_id))
...
;; H
  ...
  (=>
  (forall ((idx Int))
  (=> (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1)))
  (not (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1))))
...
;; H
  ...
  (forall ((g1_id1 Int))
  (=> (and (<= 1 g1_id1) (<= g1_id1 64))
  (=> (= (to_rep3 (select proposals_made g1_id1)) 0)
  (exists ((idx Int))
  (and (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1)))
  (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1))))))))
...
;; H
  (assert (<= rank (to_rep3 (select proposals_made g1_id))))
...
;; H
  (assert (= o7 (select (select ranking_1 g1_id) o6)))

;; H
  (assert (= o8 (to_rep1 o7)))

;; H
  (assert (= o9 (select ranking_2 o8)))
