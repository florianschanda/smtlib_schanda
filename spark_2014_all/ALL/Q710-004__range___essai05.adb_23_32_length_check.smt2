...
(((mk_tindex_aB__ref (tindex_aB__content tindex_aB)))))
...
(((mk_index_b__ref (index_b__content index_b)))))
...
(((mk_index_a__ref (index_a__content index_a)))))
...
(((mk_array_a__ref (array_a__content us_t)))))
...
(((mk_array_b__ref (array_b__content us_t1)))))
...
(((mk_t16b__ref (t16b__content tindex_aB)))))
