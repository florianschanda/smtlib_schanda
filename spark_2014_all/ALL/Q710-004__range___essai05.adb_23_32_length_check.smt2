...
(declare-fun dummy1 () tindex_aB)

(declare-datatypes ()
((tindex_aB__ref (mk_tindex_aB__ref (tindex_aB__content tindex_aB)))))
(define-fun tindex_aB__ref___projection ((a tindex_aB__ref)) tindex_aB
...
(declare-fun dummy2 () index_b)

(declare-datatypes ()
((index_b__ref (mk_index_b__ref (index_b__content index_b)))))
(define-fun index_b__ref___projection ((a index_b__ref)) index_b (index_b__content
                                                                 a))
...
(declare-fun dummy3 () index_a)

(declare-datatypes ()
((index_a__ref (mk_index_a__ref (index_a__content index_a)))))
(define-fun index_a__ref___projection ((a index_a__ref)) index_a (index_a__content
                                                                 a))
...
(declare-datatypes ()
((array_a__ref (mk_array_a__ref (array_a__content us_t)))))
(define-fun array_a__ref___projection ((a array_a__ref)) us_t (array_a__content
                                                              a))
...
(declare-datatypes ()
((array_b__ref (mk_array_b__ref (array_b__content us_t1)))))
(define-fun array_b__ref___projection ((a array_b__ref)) us_t1 (array_b__content
                                                               a))
...
(declare-fun dummy6 () tindex_aB)

(declare-datatypes ()
((tTrSP1__ref (mk_tTrSP1__ref (tTrSP1__content tindex_aB)))))
...
(declare-fun dummy8 () tindex_aB)

(declare-datatypes () ((t16b__ref (mk_t16b__ref (t16b__content tindex_aB)))))
(define-fun t16b__ref___projection ((a t16b__ref)) tindex_aB (t16b__content
                                                             a))
...
(declare-fun r__first () tindex_aB)

(declare-fun r__last () tindex_aB)
...
;; def_axiom
  (assert
  (forall ((temp___259 Int) (temp___260 Int) (temp___261 Int))
  (let ((temp___258 (essai05__conv2__r__aggregate_def temp___259 temp___260
                    temp___261)))
  (and
  (=> (dynamic_property1 3 15 temp___260 temp___261)
  (and (= (first7 temp___258) temp___260) (= (last7 temp___258) temp___261)))
  (forall ((temp___262 Int))
  (= (select (to_array3 temp___258) temp___262) (of_rep temp___259)))))))
...
(define-fun dynamic_invariant3 ((temp___expr_178 Int)
  ...
  (temp___do_toplevel_177 Bool)) Bool (=>
                                      ...
                                      (<= 3 15)) (in_range3 temp___expr_178)))

(define-fun dynamic_invariant4 ((temp___expr_189 us_t1)
  ...
  (temp___do_toplevel_188 Bool)) Bool (=>
                                      ...
                                      (first3 temp___expr_189)
                                      (last3 temp___expr_189))))

(define-fun dynamic_invariant5 ((temp___expr_225 us_t2)
  (temp___is_init_222 Bool) (temp___skip_constant_223 Bool)
  (temp___do_toplevel_224 Bool)) Bool (=>
                                      (not (= temp___skip_constant_223 true))
                                      (and (dynamic_property3 (first1 v)
                                      (last1 v) (first5 temp___expr_225)
                                      (last5 temp___expr_225))
                                      (and
                                      (= (first5 temp___expr_225) (first1 v))
                                      (= (last5 temp___expr_225) (last1 v))))))

(declare-fun temp___264 () (Array Int integer))

(declare-fun temp___2641 () t3)
...
;; H
  ...
  (= (to_rep1
     (first6
     (rt3
     (essai05__conv2__r__aggregate_def 0 (to_rep1 (first (rt v)))
     (to_rep1 (last (rt v))))))) (to_rep1 (first (rt v)))))
...
;; H
  ...
  (= (to_rep1
     ...
     (rt3
     (essai05__conv2__r__aggregate_def 0 (to_rep1 (first (rt v)))
     (to_rep1 (last (rt v))))))) (to_rep1 (last (rt v)))))

;; H
  (assert
  (= (mk___t3 temp___264 temp___2641) (essai05__conv2__r__aggregate_def 0
                                      (to_rep1 (first (rt v)))
                                      (to_rep1 (last (rt v))))))

(assert
;; WP_parameter_def
 ;; File "essai05.adb", line 7, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first6 temp___2641)) (to_rep1 (last6 temp___2641)))
     (+ (- (to_rep1 (last6 temp___2641)) (to_rep1 (first6 temp___2641))) 1)
     0) (ite (<= (to_rep1 (first (rt v))) (to_rep1 (last (rt v))))
        (+ (- (to_rep1 (last (rt v))) (to_rep1 (first (rt v)))) 1) 0))))
(check-sat)
(exit)
