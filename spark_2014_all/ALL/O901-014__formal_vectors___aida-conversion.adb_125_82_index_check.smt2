...
;; H
  (assert (= o130 (ite (< o129 50) true false)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (<= (to_rep1 (first (rt source))) temp___1139)))
(check-sat)
(exit)
