...
;; H
  (assert (= o62 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (and (= o59 o58) (in_range2 o58)))

;; H
  (assert (= o60 (num_of_big_int m m_first o59)))

;; H
  (assert (= o55 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o61 (omultiply o55 o60)))

;; H
  (assert (= o63 (osubtract o61 o62)))

;; H
  (assert (= o52 (from_word32 a_msw3)))
...
;; H
  (assert
  (and (= o46 (base Tuple0))
  (= o46 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o51 (oexpon o46 o50)))

;; H
  (assert (= o53 (omultiply o51 o52)))
...
;; H
  (assert
  (= o45 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o44)))

;; H
  (assert (= o54 (oadd o45 o53)))

;; H
  (assert (= o64 (olt o54 o63)))
