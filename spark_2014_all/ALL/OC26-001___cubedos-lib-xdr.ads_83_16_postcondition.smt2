...
(declare-fun temporary_2 () (_ BitVec 32))
...
(declare-fun temporary_21 () (_ BitVec 32))
...
(declare-fun temporary_12 () (_ BitVec 32))
...
(declare-fun temporary_22 () (_ BitVec 32))
...
(declare-fun temporary_13 () (_ BitVec 32))
...
(declare-fun temporary_23 () (_ BitVec 32))

(declare-fun result11 () (Array Int octet))

(declare-fun data3 () (Array Int octet))

(declare-fun result12 () (_ BitVec 32))

(declare-fun temporary_14 () (_ BitVec 32))

(declare-fun result13 () Int)

(declare-fun i4 () Int)

(declare-fun result14 () (_ BitVec 32))

(declare-fun temporary_24 () (_ BitVec 32))
...
(declare-fun temporary_15 () (_ BitVec 32))
...
(declare-fun temporary_16 () t__ref1)

(declare-fun temporary_25 () t__ref1)
...
(declare-fun temporary_17 () (_ BitVec 32))

(declare-fun temporary_26 () (_ BitVec 32))
...
;; H
  (assert
  (and (<= (to_rep data__first) (+ position (- 4 i1)))
  (<= (+ position (- 4 i1)) (to_rep data__last))))
...
;; H
  (assert (= temporary_12 (bvudiv temporary_11 ((_ int2bv 32) 256))))
...
;; H
  (assert (= temporary_22 (bvurem temporary_12 ((_ int2bv 32) 256))))
...
;; H
  (assert
  (and (<= (to_rep data__first) (+ position (- 4 i2)))
  (<= (+ position (- 4 i2)) (to_rep data__last))))
...
;; H
  (assert (= temporary_13 (bvudiv temporary_12 ((_ int2bv 32) 256))))
...
;; H
  (assert (= temporary_23 (bvurem temporary_13 ((_ int2bv 32) 256))))
...
;; H
  (assert
  (and (<= (to_rep data__first) (+ position (- 4 i3)))
  (<= (+ position (- 4 i3)) (to_rep data__last))))
...
;; H
  (assert (= temporary_14 (bvudiv temporary_13 ((_ int2bv 32) 256))))
...
;; H
  (assert (= temporary_24 (bvurem temporary_14 ((_ int2bv 32) 256))))
...
;; H
  (assert
  (and (<= (to_rep data__first) (+ position (- 4 i4)))
  (<= (+ position (- 4 i4)) (to_rep data__last))))
...
;; H
  (assert (= temporary_15 (bvudiv temporary_14 ((_ int2bv 32) 256))))

;; H
  (assert (and (= o12 (+ position 3)) (in_range2 (+ position 3))))

;; H
  (assert (= result17 (mk_int__ref last2)))
...
;; H
  (assert (= temporary_25 (mk_t__ref1 temporary_24)))

;; H
  (assert (= temporary_16 (mk_t__ref1 temporary_15)))
...
;; H
  (assert (= temporary_26 temporary_24))

;; H
  (assert (= temporary_17 temporary_15))
