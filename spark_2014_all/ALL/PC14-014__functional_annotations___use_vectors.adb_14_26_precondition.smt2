...
;; H
  ...
  (=>
  (and (<= first n1)
  (<= n1 (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2)))))
  (= (is_incr (get (model__ v1) n1)
     (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) n1)) true))))
...
;; H
  (assert
  (and (= o1 (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2))))
  (and (dynamic_property4 first3 last5 o1)
  (= o1 (last4 (model__ (mk___rep v2__split_discrs v2__split_fields2)))))))
...
;; H
  (assert
  (and
  (= o5 (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) o4))
  (and (in_range4 o5)
  (= o5 (get (model__ (mk___rep v2__split_discrs v2__split_fields2)) o4)))))
