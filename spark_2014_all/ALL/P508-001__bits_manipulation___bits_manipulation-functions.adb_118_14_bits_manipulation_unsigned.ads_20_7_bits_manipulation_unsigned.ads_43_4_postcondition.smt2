...
(define-fun dynamic_invariant ((temp___expr_267 (_ BitVec 16))
  ...
  (temp___do_toplevel_266 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_273 Int)
  ...
  (temp___do_toplevel_272 Bool)) Bool (=>
                                      ...
                                      (<= 0 15)) (in_range1 temp___expr_273)))
...
(declare-const temp___424 Int)

(declare-const temp___423 Int)
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 15)) (= temp___424 i1)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 15)) (= temp___423 result__)))

;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 15)) (= (mk_int__ref result1) result__18)))
...
;; H
  ...
  (= o (ite (and (<= 1 16) (<= 16 8))
       ...
       i1))))))))
  (= result2 (ite (= o ((_ int2bv 16) 1)) true false))) (= result2 true)))
  (and
  (and
  (and
  (and (= o (shift_right value i1))
  (= o (ite (and (<= 1 16) (<= 16 8))
       ...
       ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64)
       i1))))))))
  (= result2 (ite (= o ((_ int2bv 16) 1)) true false)))
  (not (= result2 true)))
  (and
  ...
  (forall ((j Int))
  (=> (and (<= 0 j) (<= j i2))
  (bvugt (shift_right value j) ((_ int2bv 16) 1))))
  (and
  (and
  (and (=> (<= 0 15) (in_range1 result__3)) (=> (<= 0 15) (in_range1 i2)))
  (and (<= 0 i2) (<= i2 15)))
  (or
  (and
  (and (and (= i2 i4) (= result__3 result__5))
  (and (= i5 i2) (= result__6 result__3))) (= i2 15))
  (and (not (= i2 15))
  (and
  ...
  (= o1 (ite (and (<= 1 16) (<= 16 8))
        ((_ zero_extend 8) (ite (< i3 8)
                           (bvlshr ((_ extract 7 0) value) ((_ int2bv 8)
                           i3)) ((_ int2bv 8) 0)))
        (ite (and (<= 9 16) (<= 16 16))
        (ite (< i3 16) (bvlshr value ((_ int2bv 16) i3)) ((_ int2bv 16) 0))
        (ite (and (<= 17 16) (<= 16 32))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 16) value) ((_ int2bv 32)
        i3)))
        ((_ extract 15 0) (bvlshr ((_ zero_extend 48) value) ((_ int2bv 64)
        i3))))))))
  (= result5 (ite (= o1 ((_ int2bv 16) 1)) true false))) (= result5 true))))))))))))))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result1
  bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result2))

;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result3
  bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result1))

;; H
  (assert
  (= result6 bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result4
  (mk_int__ref
  bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result2)))
...
;; H
  (assert
  (= bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result5
  bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result3))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 10, characters 0-0
  ...
  (= (shift_right value
     (int__content
     bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result4)) ((_ int2bv 16) 1))))
(check-sat)
(exit)
