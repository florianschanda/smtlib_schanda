...
(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result () Int)

(declare-fun temp___410 () Int)

(declare-fun temp___409 () Int)
...
(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result1 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result2 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result3 () Int)

(declare-fun result__13 () Int)

(declare-fun i12 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result4 () int__ref)

(declare-fun result__14 () Int)

(declare-fun i13 () Int)

(declare-fun bits_manipulation_unsigned__unsigned_16__functions__msb_index_slow_inline_always__result5 () Int)
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 15)) (= temp___410 i1)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 15)) (= temp___409 result__)))
