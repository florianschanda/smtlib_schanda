...
(((mk_t__ref (t__content null_record_type)))))
...
(declare-datatypes ((foo__ref 0)) (((mk_foo__ref (foo__content us_rep)))))
...
;; H
  (assert (= (mk___rep (mk___split_fields o1 o2)) (select cache o)))
...
;; H
  (assert (= x__split_fields1 o7))

;; H
  (assert (= temp___168 o6))

;; H
  (assert (= temp___1681 o7))
...
;; H
  (assert (= x__split_fields2 temp___168))

;; H
  (assert (= x__split_fields3 temp___1681))
