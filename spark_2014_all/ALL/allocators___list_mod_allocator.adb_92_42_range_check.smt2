...
;; H
  (assert
  (forall ((e1 Int))
  (=> (and (in_range8 e1) (= (contains alloc1 e1) true))
  (and (<= 1 e1) (<= e1 (- r2 1))))))

;; H
  (assert
  (forall ((e1 Int))
  (=> (and (in_range8 e1) (= (contains unseen1 e1) true))
  (and (<= 1 e1) (<= e1 (- r2 1))))))
...
;; H
  ...
  (= (to_rep1
     (rec__list_mod_allocator__cell__stat
     (us_split_fields1 (select data e1)))) 0)
  (not (= (contains alloc1 e1) true))))))
...
;; H
  ...
  (ite (= (to_rep1
          (rec__list_mod_allocator__cell__stat
          (us_split_fields1 (select data e1)))) 1)
  (= (contains alloc1 e1) true) (= (contains unseen1 e1) true)))))
