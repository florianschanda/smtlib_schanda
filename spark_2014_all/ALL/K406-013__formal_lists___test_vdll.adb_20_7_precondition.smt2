...
(define-fun default_initial_assumption2 ((temp___expr_210 us_rep2)
  (temp___skip_top_level_211 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_211 true))
                                         (and
                                         (= (is_empty temp___expr_210) true)
                                         (= (length2 temp___expr_210) 0))))

(define-fun default_initial_assumption3 ((temp___expr_198 us_rep1)
...
;; get__post_axiom
  ...
  (! (=> (= (has_key container1 key) true)
     ...
     (and
     (=> (= (of_int 0) true)
     (and (= result (w_get container1 (witness container1 key)))
     (forall ((k us_rep1))
     (=> (= (has_key container1 k) true)
     (= (= (bool_eq1 k key) true)
     (= (witness container1 key) (witness container1 k)))))))
     (dynamic_invariant5 result true false true)))) :pattern ((get1
                                                              container1 key)) ))))

;; length__post_axiom
  (assert
  (forall ((container1 us_rep2)) (! (dynamic_invariant2 (length2 container1)
...
;; w_get__post_axiom
  ...
  (! (=>
     ...
     (= (has_witness container1 witness1) true)) (dynamic_invariant5
...
(assert
;; WP_parameter_def
 ;; File "test_vdll.adb", line 15, characters 0-0
  (not (= (has_key (positions container) position) true)))
(check-sat)
(exit)
