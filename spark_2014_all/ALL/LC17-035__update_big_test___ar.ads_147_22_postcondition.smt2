...
(declare-fun temp___574 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___576 (Array Int et1)))
  (forall ((temp___577 Int) (temp___578 Int))
  (let ((temp___575 (temp___574 temp___576 temp___577 temp___578)))
  (forall ((temp___579 Int))
  (ite (= temp___579 temp___577)
  (= (select temp___575 temp___579) (of_rep temp___578))
  (= (select temp___575 temp___579) (select temp___576 temp___579))))))))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 140, characters 0-0
  (not (= (bool_eq a2 1 10 (temp___574 a i e) 1 10) true)))
(check-sat)
(exit)
