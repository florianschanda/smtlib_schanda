...
(declare-fun temp___492 () count_type)

(declare-fun temp___493 () count_type)

(declare-fun temp___494 () count_type)

(declare-fun temp___495 () count_type)
...
(declare-fun my_lists__m__append__container__fields () us_split_fields)

(declare-fun result4 () us_split_fields__ref)

(declare-fun l__split_fields1 () us_split_fields)

(declare-fun my_lists__m__append__2__container__fields () us_split_fields)
...
(declare-fun my_lists__m__prepend__container__fields () us_split_fields)

(declare-fun result9 () us_split_fields__ref)

(declare-fun l__split_fields6 () us_split_fields)

(define-fun temp___4951 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___495)))

(define-fun temp___4941 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___494)))

(define-fun temp___4931 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___493)))

(define-fun temp___4921 () us_rep1 (mk___rep1
                                   (mk___split_fields1 temp___492)))
...
;; H
  ...
  (= (bool_eq1 temp___4921 no_element) true)
  (and
  (= (has_key
     (positions
...
;; H
  ...
  (ite (= (= (length
             (mk___rep l__split_discrs (mk___split_fields l__split_fields))) 0) true)
  (= (bool_eq1 temp___4931 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (= (bool_eq1 temp___4941 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  (assert
  (and
  (= temp___4951 (previous
                 (mk___rep l__split_discrs
                 (mk___split_fields l__split_fields))
                 (mk___rep1 c__split_fields3)))
  (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) false) (=
          (get
          (positions
          (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
          (mk___rep1 c__split_fields3)) 1) true) true)
  (= (bool_eq1 temp___4951 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__append__container__fields)) (+
  ...
  (= (keys_included_except
     ...
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (last1
     (mk___rep l__split_discrs my_lists__m__append__container__fields))) true))
  (= (ole1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (positions
  ...
  (= (get1
     ...
     (mk___rep l__split_discrs my_lists__m__append__container__fields))
     (length
     (mk___rep l__split_discrs my_lists__m__append__container__fields))) 10))
  (= (ole
...
;; H
  (assert
  (= result4 (mk___split_fields__ref (mk___split_fields l__split_fields))))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__append__2__container__fields)) (+
  (length (mk___rep l__split_discrs l__split_fields1)) 4))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields1))
     (model__
     (mk___rep l__split_discrs my_lists__m__append__2__container__fields))) true))
  (=> (< 0 4)
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_lists__m__append__2__container__fields))
     ...
     (length
     (mk___rep l__split_discrs my_lists__m__append__2__container__fields)) 9) true)))
  (= (p_positions_truncated
     (positions (mk___rep l__split_discrs l__split_fields1))
     (positions
     (mk___rep l__split_discrs my_lists__m__append__2__container__fields))
     (+ (length (mk___rep l__split_discrs l__split_fields1)) 1) 4) true)))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__delete_last__container__fields)) (-
  ...
  (= (has_key
     (positions
     (mk___rep l__split_discrs my_lists__m__delete_last__container__fields))
     (last1 (mk___rep l__split_discrs l__split_fields2))) true)))
  (= (keys_included_except
...
;; H
  (assert
  (= l__split_fields4 my_lists__m__delete_last__2__container__fields))
...
;; H
  (assert
  (= l__split_fields5 my_lists__m__delete_last__2__container__fields1))
...
;; H
  ...
  (and
  (= (length
     (mk___rep l__split_discrs my_lists__m__prepend__container__fields)) (+
  (length (mk___rep l__split_discrs l__split_fields5)) 1))
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields5))
     (model__
     (mk___rep l__split_discrs my_lists__m__prepend__container__fields)) 1
     (length (mk___rep l__split_discrs l__split_fields5)) 1) true))
  (= (get1
     (model__
     (mk___rep l__split_discrs my_lists__m__prepend__container__fields)) 1) 10))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields5))
     (positions
     (mk___rep l__split_discrs my_lists__m__prepend__container__fields)) 1 1) true)))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 1572, characters 0-0
  (not
  (<= (length (mk___rep l__split_discrs l__split_fields6)) (- (to_rep
                                                              (rec__my_lists__m__list__capacity
                                                              l__split_discrs)) 4))))
(check-sat)
(exit)
