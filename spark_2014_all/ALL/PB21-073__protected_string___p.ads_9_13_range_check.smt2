...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__p__pt__s1 us_t)))))
(define-fun us_split_fields_S2__projection ((a us_split_fields2)) us_t
  (rec__p__pt__s1 a))
...
(define-fun in_range2 ((rec__p__pt__x1 Int)
  (a us_rep)) Bool (= rec__p__pt__x1 (to_rep1
...
(declare-fun p__pt__s__first__bit1 () Int)

(declare-fun p__pt__s__last__bit1 () Int)

(declare-fun p__pt__s__position1 () Int)
...
;; def_axiom
  ...
  (= (select (to_array1 temp___186) temp___190) (of_rep temp___187)))))))

(define-fun dynamic_invariant ((temp___expr_179 us_rep1)
  (temp___is_init_176 Bool) (temp___skip_constant_177 Bool)
  (temp___do_toplevel_178 Bool)) Bool (and
                                      (=>
                                      (not (= temp___skip_constant_177 true))
                                      (in_range2 3
                                      (to_base temp___expr_179)))
                                      (let ((temp___180 (rec__p__pt__x
                                                        (us_split_discrs2
                                                        temp___expr_179))))
...
(define-fun default_initial_assumption ((temp___expr_182 us_rep1)
  (temp___skip_top_level_183 Bool)) Bool (and
                                         ...
                                         (= (rec__p__pt__s1
                                            (us_split_fields3
                                            temp___expr_182)) (let ((temp___191
                                                              (temp___185 32
                                                              1
                                                              (to_rep1
                                                              (rec__p__pt__x
...
(define-fun dynamic_invariant3 ((temp___expr_171 us_rep)
