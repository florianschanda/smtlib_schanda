...
(declare-datatypes ((t1s__ref 0)) (((mk_t1s__ref (t1s__content integer)))))
...
(declare-datatypes ((t2s__ref 0)) (((mk_t2s__ref (t2s__content us_t)))))
...
(((mk___split_fields (rec__p__pt__s us_t)))))
...
(((mk___split_fields1 (rec__p__pt__s1 us_t)))))
(define-fun us_split_fields_S__2__projection ((a us_split_fields2)) us_t
  (rec__p__pt__s1 a))
