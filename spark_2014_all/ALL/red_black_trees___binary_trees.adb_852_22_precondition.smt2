...
;; H
  (assert (= o63 (select temp___1614 i)))
...
;; H
  ...
  (= temp___1613 (model__
                 ...
                 (mk___split_fields2 f__split_fields f__split_fields1)) 
                 root))
  (and (dynamic_invariant3 temp___1613 true false true)
  (and
  (= (rec__tree_model__path_type__k
  ...
  (and
  (= (rec__tree_model__path_type__k
     (us_split_fields1 (select temp___1613 j))) true)
  (= (oeq
     (rec__tree_model__path_type__a
...
;; H
  (assert (= o60 (select temp___1613 o59)))
...
;; H
  (assert
  (and (= result9 (ole o62 o65))
  (= (= result9 true)
  (and (<= (length o62) (length o65))
  (forall ((n7 Int))
  (=> (and (<= 1 n7) (<= n7 (last o62))) (= (get o62 n7) (get o65 n7))))))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  ...
  (= (valid_root
     (mk___rep2
     (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o67) true)))
(check-sat)
