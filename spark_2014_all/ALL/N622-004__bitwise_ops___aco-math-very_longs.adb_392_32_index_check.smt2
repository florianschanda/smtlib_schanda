...
(declare-fun temp___1491 () digit_index_type)

(declare-fun temp___14911 () (Array Int octet))

(declare-fun temp___14912 () t)
...
;; H
  ...
  true true true)
  (forall ((temp___1500 Int))
  (=>
  (and (<= (to_rep1 (first number__split_fields3)) temp___1500)
  (<= temp___1500 (to_rep1 (last number__split_fields3))))
  (=> (<= i2 temp___1500)
  (= (select number__split_fields2 temp___1500) (select number__split_fields temp___1500))))))
  (and (<= 1 i2) (<= i2 r126b))))
...
;; H
  (assert
  (and (= o5 (shift_right o4 (- 8 distance)))
...
;; H
  ...
  (= number__split_fields4 (mk___split_fields
                           (mk___t temp___14911 temp___14912))))
