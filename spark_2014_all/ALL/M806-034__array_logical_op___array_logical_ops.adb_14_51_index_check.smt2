...
;; def_axiom
  ...
  (temp___138 Int))
  (let ((temp___134 (array_logical_ops__test_ok1__x__aggregate_def temp___135
                    temp___136 temp___137 temp___138)))
  (forall ((temp___139 Int))
  (ite (and (<= 31 temp___139) (<= temp___139 40))
  (= (select temp___134 temp___139) (of_rep temp___138))
  (ite (and (<= 21 temp___139) (<= temp___139 30))
  (= (select temp___134 temp___139) (of_rep temp___137))
  (ite (and (<= 11 temp___139) (<= temp___139 20))
  (= (select temp___134 temp___139) (of_rep temp___136))
  (=> (and (<= 1 temp___139) (<= temp___139 10))
  (= (select temp___134 temp___139) (of_rep temp___135))))))))))
...
;; def_axiom
  ...
  (let ((temp___140 (array_logical_ops__test_ok1__y__aggregate_def temp___141
                    temp___142 temp___143)))
  (forall ((temp___144 Int))
  (ite (and (<= 31 temp___144) (<= temp___144 40))
  (= (select temp___140 temp___144) (of_rep temp___143))
  (ite (and (<= 11 temp___144) (<= temp___144 30))
  (= (select temp___140 temp___144) (of_rep temp___142))
  (=> (and (<= 1 temp___144) (<= temp___144 10))
  (= (select temp___140 temp___144) (of_rep temp___141)))))))))
...
;; H
  (assert
  (= (mk___t (array_logical_ops__test_ok1__x__aggregate_def 1 0 1 0)
     (mk 1 40)) x))
...
;; H
  (assert
  (= (mk___t (array_logical_ops__test_ok1__y__aggregate_def 0 1 0) (mk 1 40))
  y))
...
;; H
  (assert
  (= (mk___t
     (andb (elts x) (to_rep1 (first (rt x))) (to_rep1 (last (rt x)))
     (elts y) (to_rep1 (first (rt y))) (to_rep1 (last (rt y))))
     (mk (to_rep1 (first (rt x))) (to_rep1 (last (rt x))))) r1))

;; H
  (assert (dynamic_invariant r1 true false true))

;; H
  (assert (= (to_rep1 (first (rt r1))) 1))

;; H
  (assert
  (forall ((i1 Int))
  (=> (and (<= 1 i1) (<= i1 20))
  (not (= (of_int (to_rep (select (elts r1) i1))) true)))))
