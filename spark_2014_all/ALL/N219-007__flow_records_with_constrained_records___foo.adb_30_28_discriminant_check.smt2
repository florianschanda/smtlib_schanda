...
(declare-fun foo__value__kind__first__bit2 () Int)

(declare-fun foo__value__kind__last__bit2 () Int)

(declare-fun foo__value__kind__position2 () Int)
...
(declare-fun foo__value__bool_field__first__bit2 () Int)

(declare-fun foo__value__bool_field__last__bit2 () Int)

(declare-fun foo__value__bool_field__position2 () Int)
...
(declare-fun foo__value__int_field__first__bit2 () Int)

(declare-fun foo__value__int_field__last__bit2 () Int)

(declare-fun foo__value__int_field__position2 () Int)
...
(declare-fun foo__value__kind__first__bit3 () Int)

(declare-fun foo__value__kind__last__bit3 () Int)

(declare-fun foo__value__kind__position3 () Int)
...
(declare-fun foo__value__bool_field__first__bit3 () Int)

(declare-fun foo__value__bool_field__last__bit3 () Int)

(declare-fun foo__value__bool_field__position3 () Int)
...
(declare-fun foo__value__int_field__first__bit3 () Int)

(declare-fun foo__value__int_field__last__bit3 () Int)

(declare-fun foo__value__int_field__position3 () Int)
...
(declare-fun foo__record_a__x__first__bit () Int)

(declare-fun foo__record_a__x__last__bit () Int)

(declare-fun foo__record_a__x__position () Int)
...
(declare-fun foo__record_a__y__first__bit () Int)

(declare-fun foo__record_a__y__last__bit () Int)

(declare-fun foo__record_a__y__position () Int)
...
(declare-fun foo__record_a__z__first__bit () Int)

(declare-fun foo__record_a__z__last__bit () Int)

(declare-fun foo__record_a__z__position () Int)
...
(declare-datatypes ()
((record_a__ref (mk_record_a__ref (record_a__content us_rep1)))))
...
(declare-fun v__split_fields () us_split_fields__ref1)
