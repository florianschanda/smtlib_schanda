...
(declare-fun result1_base () us_rep)
...
(declare-datatypes ()
((tT14bP1__ref (mk_tT14bP1__ref (tT14bP1__content integer)))))
(define-fun tT14bP1__ref___projection ((a tT14bP1__ref)) integer (tT14bP1__content
                                                                 a))
...
(define-fun us_split_fields_To_Search4__projection ((a us_split_fields4)) us_t1 
...
(define-fun us_rep_9__projection ((a us_rep2)) us_split_discrs2 (us_split_discrs4
                                                                a))
