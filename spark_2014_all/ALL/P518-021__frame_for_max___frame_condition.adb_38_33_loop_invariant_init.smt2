...
;; H
  (assert
  (=> (= result8 true)
  (and (<= (to_rep1 a__first) k9) (<= k9 (to_rep1 a__last)))))
...
;; H
  (assert
  (=> (= result8 true) (= o38 (rec__frame_condition__cell__value o37))))
...
;; H
  ...
  (= o41 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select (map__content a5) k9)))
         (rec__frame_condition__cell__max_left
         (us_split_fields1 (select (map__content a5) k9))) o40)))
