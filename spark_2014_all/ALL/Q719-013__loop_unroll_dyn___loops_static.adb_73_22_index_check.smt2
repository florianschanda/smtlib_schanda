...
(declare-fun temp___312 () (Array Int natural))

(declare-fun temp___3121 () t1)

(declare-fun loops_static__loop4__B_11__a_begins__assume () (Array Int natural))

(declare-fun loops_static__loop4__B_11__a_begins__assume1 () t)
...
;; H
  (assert
  (forall ((j3 Int))
  (=> (and (<= (to_rep1 a__first) j3) (<= j3 i2))
  (= (to_rep (select a2 j3)) 0))))
...
;; H
  (assert
  (= (mk (to_rep1 (first2 temp___3121)) (to_rep1 (last2 temp___3121)))
  loops_static__loop4__B_11__a_begins__assume1))

;; H
  (assert
  (= (mk___t loops_static__loop4__B_11__a_begins__assume
     loops_static__loop4__B_11__a_begins__assume1) a_begins))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt a_begins))) j2)
  (<= j2 (to_rep1 (last (rt a_begins))))))
