...
;; H
  (assert
  (and
  (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ ((_ int2bv 32) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
...
;; H
  ...
  val__ ((_ int2bv 32) 24)) ((_ int2bv 32) 255))))
  (forall ((i (_ BitVec 64)))
  (=>
  (and (bvule ((_ int2bv 64) 0) i)
  (bvule i ((_ int2bv 64) 18446744073709551615)))
...
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not
  (bvule ((_ zero_extend 16) ((_ int2bv 16) 0)) (bvlshr (bvand val__ ((_ int2bv 32) 16711680)) ((_ int2bv 32) 16)))))
(check-sat)
(exit)
