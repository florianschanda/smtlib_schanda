...
;; def_axiom
  ...
  (and (= (first3 temp___193) temp___195) (= (last3 temp___193) temp___196)))
...
(declare-fun p__a__assume () (Array Int integer))

(declare-fun p__a__assume1 () t)
...
;; H
  (assert
  (= (slide temp___199 (to_rep (first2 temp___1991)) r4b) p__a__assume))
