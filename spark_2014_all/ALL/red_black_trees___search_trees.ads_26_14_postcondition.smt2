...
;; size__post_axiom
  (assert
  (forall ((f us_rep1))
  (! (=> (dynamic_invariant2 f true true true) (dynamic_invariant1 (size f)
...
;; position__post_axiom
  ...
  (! (=>
     (and
     (and (dynamic_invariant2 f true true true) (dynamic_invariant i1 true
     true true)) (not (= (parent f i1) 0))) (dynamic_invariant6
     (position f i1) true false true)) :pattern ((position f i1)) ))))
...
(declare-fun search_trees__parent__result () Int)

(declare-fun o () Int)

(declare-fun result () Int)

(declare-fun search_trees__parent__result1 () Int)

(declare-fun search_trees__parent__result2 () Int)

(declare-fun search_trees__parent__result3 () Int)

(declare-fun search_trees__parent__result4 () Int)

(declare-fun search_trees__parent__result5 () Int)
...
;; H
  (assert
  (and
  (= o (parent (rec__search_trees__search_tree__struct (us_split_fields5 t))
       i))
  (and (in_range2 o)
  (and
  (=>
  (= (valid_root
     (rec__search_trees__search_tree__struct (us_split_fields5 t)) i) true)
  (= o 0))
  (=>
  (= (size (rec__search_trees__search_tree__struct (us_split_fields5 t))) 0)
  (= o 0))))))

;; H
  (assert
  (= (mk_int__ref result) (mk_int__ref search_trees__parent__result)))
...
;; H
  (assert
  (= (mk_int__ref search_trees__parent__result4) (mk_int__ref
                                                 search_trees__parent__result2)))
...
;; WP_parameter_def
 ;; File "tree_model.ads", line 15, characters 0-0
  (not (= search_trees__parent__result4 0)))
(check-sat)
