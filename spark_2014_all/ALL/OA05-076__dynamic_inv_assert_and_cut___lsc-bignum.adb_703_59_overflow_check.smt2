...
;; H
  (assert (and (= o40 (- e_last e_first)) (in_range1 (- e_last e_first))))

;; H
  (assert (and (= o41 o40) (uint_in_range1 o40)))

;; H
  (assert (= o42 ((_ int2bv 64) o41)))

;; H
  (assert (= o43 (bvadd o42 ((_ int2bv 64) 1))))

;; H
  (assert (= o44 (bvmul o43 ((_ int2bv 64) 32))))

;; H
  (assert (= o45 (ite (bvult i2 o44) true false)))
...
;; H
  (assert (= o38 (oadd o36 o37)))

;; H
  (assert (= o35 (from_integer (int__content s12))))

;; H
  (assert (= o39 (ole o35 o38)))

;; H
  (assert (and (= o30 (power 2 k)) (in_range1 (power 2 k))))
...
;; H
  (assert (= o33 (ite (<= n o32) true false)))

;; H
  (assert (= result9 (ite (<= 0 n) o33 false)))
...
;; H
  (assert (and (= o28 (+ l1 1)) (in_range1 (+ l1 1))))

;; H
  (assert (= o29 (num_of_big_int m m_first o28)))
...
;; H
  (assert (= o20 (from_integer (int__content s12))))

;; H
  (assert (= o19 (from_word64 i2)))

;; H
  (assert (= o21 (osubtract o19 o20)))
