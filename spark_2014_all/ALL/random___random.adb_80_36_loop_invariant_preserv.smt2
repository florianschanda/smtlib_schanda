...
(declare-fun o42 () unsigned_32)

(declare-fun o43 () (Array Int unsigned_32))

(declare-fun o44 () (Array Int unsigned_32))

(declare-fun o45 () state_range)

(declare-fun temp___2762 () (Array Int unsigned_32))

(declare-fun temp___2763 () state_range)

(declare-fun o46 () unsigned_32)

(declare-fun o47 () (Array Int unsigned_32))

(declare-fun o48 () (Array Int unsigned_32))

(declare-fun o49 () state_range)

(declare-fun temp___2802 () (Array Int unsigned_32))

(declare-fun temp___2803 () state_range)
...
(declare-fun g__split_fields6 () us_split_fields)
...
;; H
  ...
  (and
  (and
  (= (rec__random__generator__index g__split_fields5) (rec__random__generator__index
                                                      g__split_fields2))
  (=> (<= 1 (ite (< 624 (length initiator)) (length initiator) 624))
  (dynamic_property1 1
  (ite (< 624 (length initiator)) (length initiator) 624) k2)))
...
;; H
  (assert
  (not (= k2 (ite (< 624 (length initiator)) (length initiator) 624))))
...
;; H
  (assert
  (= o29 (select (rec__random__generator__state g__split_fields5) o28)))
...
;; H
  (assert
  (= o27 (select (rec__random__generator__state g__split_fields5) o26)))
...
;; H
  (assert (= o34 (bvmul o33 ((_ int2bv 32) 1664525))))

;; H
  (assert
  (= o38 (bvxor (to_rep
                (select (rec__random__generator__state g__split_fields5) 
                i4)) o34)))
...
;; H
  (assert
  (= o43 (store (rec__random__generator__state g__split_fields5) i4 o42)))
...
;; H
  (assert (= temp___2762 o44))

;; H
  (assert (= temp___2763 o45))

;; H
  (assert (= result10 (mk___split_fields__ref g__split_fields5)))

;; H
  (assert (= g__split_fields6 (mk___split_fields temp___2762 temp___2763)))

;; H
  (assert
  (=> (= i4 623)
  (= (to_rep o46) (to_rep
                  (select (rec__random__generator__state g__split_fields6) 623)))))

;; H
  (assert
  (=> (= i4 623)
  (= o47 (store (rec__random__generator__state g__split_fields6) 0 o46))))
...
;; H
  (assert
  (=> (= i4 623) (= (rec__random__generator__index g__split_fields6) o49)))

;; H
  (assert (=> (= i4 623) (= temp___2802 o48)))

;; H
  (assert (=> (= i4 623) (= temp___2803 o49)))

;; H
  (assert
  (=> (= i4 623) (= result11 (mk___split_fields__ref g__split_fields6))))

;; H
  (assert
  (=> (= i4 623)
  (= g__split_fields7 (mk___split_fields temp___2802 temp___2803))))
...
;; H
  (assert
  (=> (not (= j3 (to_rep2 (last (rt initiator)))))
  (and (= o51 (+ j3 1)) (in_range1 (+ j3 1)))))
