...
;; H
  (assert (= l__split_fields10 my_vectors__v__append__2__container__fields1))
...
;; H
  ...
  (length (mk___rep l__split_discrs l__split_fields10)) 4))
  ...
  (= (constant_range
     (model__
     (mk___rep l__split_discrs my_vectors__v__append__3__container__fields1))
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields10))) 1)
     (+ (last (model__ (mk___rep l__split_discrs l__split_fields10))) 4) 9) true))))

;; H
  (assert (= result2 l__split_fields1))

;; H
  (assert (= l__split_fields9 my_vectors__v__append__3__container__fields1))
...
;; WP_parameter_def
 ;; File "a-cofove.ads", line 855, characters 0-0
  (not (< 0 (length (mk___rep l__split_discrs l__split_fields8)))))
(check-sat)
(exit)
