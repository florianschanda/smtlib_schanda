...
(declare-fun temp___219 () integer)
...
(declare-fun temp___221 () integer)
...
(declare-fun par__split_fields () us_split_fields)

(declare-fun result () us_split_fields__ref)

(declare-fun par__split_fields1 () us_split_fields)

(declare-fun par__split_fields2 () us_split_fields)

(declare-fun result1 () us_split_fields__ref)

(declare-fun par__split_fields3 () us_split_fields)

(declare-fun par__split_fields4 () us_split_fields)

(declare-fun result2 () int__ref)

(declare-fun tmp11 () Int)

(declare-fun par__split_fields5 () us_split_fields)
