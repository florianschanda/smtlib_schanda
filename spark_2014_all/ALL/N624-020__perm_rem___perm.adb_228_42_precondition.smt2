...
(declare-fun o18 () (Array Int natural))
...
(define-fun o21 () us_t (mk___t o18 o19))

(define-fun o22 () us_t (mk___t o14 o15))

(define-fun o23 () us_t (mk___t o11 o12))

(define-fun o24 () us_t (mk___t o8 o9))

(define-fun o25 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and (= o23 (remove a o10))
  (and (dynamic_invariant2 o23 true false true)
...
;; H
  (assert
  (and (= o16 (shift_perm_l o25 o24 o22))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o22 o24) true)))))
...
;; H
  (assert
  (and (= o21 (remove b ib1))
  (and (dynamic_invariant2 o21 true false true)
  (and (= (invariant__ o21) true)
  (and (= (to_rep2 (last o19)) (- (to_rep2 (last (rt b))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ib1 1)))
  (= (to_rep (select (elts b) k)) (to_rep (select o18 k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b)))))
  (= (to_rep (select (elts b) k)) (to_rep (select o18 (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1)))
  (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o18 k))))))))))))

(assert
;; WP_parameter_def
 ;; File "perm.ads", line 2, characters 0-0
  (not (= (invariant__ o21) true)))
(check-sat)
(exit)
