...
(declare-const x86__edi__result (_ BitVec 32))

(declare-const result (_ BitVec 32))

(declare-const x86__edi__result1 (_ BitVec 32))

(declare-const x86__edi__result2 (_ BitVec 32))

(declare-const x86__edi__result3 (_ BitVec 32))

(declare-const x86__edi__result4 (_ BitVec 32))

(declare-const x86__edi__result5 (_ BitVec 32))

(declare-const result1 (_ BitVec 32))

;; H
  (assert (= x86__edi__result1 x86__edi__result2))

;; H
  (assert (= x86__edi__result3 x86__edi__result1))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__edi__result)))

;; H
  (assert
  (= x86__edi__result1 ((_ extract 31 0) (bvand rdi ((_ int2bv 64) 4294967295)))))
...
;; H
  (assert (= result1 x86__edi__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 8, characters 0-0
  (not
  (= x86__edi__result4 ((_ extract 31 0) (bvand rdi ((_ int2bv 64) 4294967295))))))
(check-sat)
(exit)
