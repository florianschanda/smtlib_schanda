...
(declare-fun temp___8061 () (Array Int et1))

(declare-fun temp___80611 () enum2t)
...
;; H
  (assert (= temp___8061 o1))

;; H
  (assert (= temp___80611 o2))
...
;; H
  (assert (= temp___8061 r__split_fields4))

;; H
  (assert (= temp___80611 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1490, characters 0-0
  (not (in_range1 (to_rep (select r__split_fields6 n)))))
(check-sat)
