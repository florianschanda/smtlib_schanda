...
(define-fun dynamic_invariant4 ((temp___expr_153 us_t1)
...
;; H
  (assert
  (=> (<= 1 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1))
  (and
  (and
  (<= (to_rep1
      (first (rt (rec__stack__stack__content (us_split_fields1 s))))) 1)
  (<= 1 (to_rep1
        (last (rt (rec__stack__stack__content (us_split_fields1 s)))))))
  (and
  (<= (to_rep1
      (first (rt (rec__stack__stack__content (us_split_fields1 s))))) (-
  (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1))
  (<= (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1) (to_rep1
                                                                   (last
                                                                   (rt
                                                                   (rec__stack__stack__content
                                                                   (us_split_fields1
...
;; H
  (assert
  (= (mk2 1 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1))
  temp___2381))

(assert
;; WP_parameter_def
 ;; File "stack.ads", line 9, characters 0-0
  (not (dynamic_property2 1 2147483647 (to_rep1 (first4 temp___2381))
  (to_rep1 (last4 temp___2381)))))
(check-sat)
(exit)
