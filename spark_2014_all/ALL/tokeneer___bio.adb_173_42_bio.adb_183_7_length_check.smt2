...
(declare-const temp___906 (Array Int character))

(declare-const temp___9061 t1)
...
;; H
  (assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___906))

;; H
  (assert (= (mk1 1 (to_rep1 fullstring__last)) temp___9061))
...
;; H
  (assert (= o31 result__2))

;; H
  (assert (= o31 temp___909))

;; H
  (assert (= (mk1 1 (to_rep1 fullstring__last)) temp___9091))

(assert
;; WP_parameter_def
 ;; File "audittypes.ads", line 92, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 temp___9061)) (to_rep1 (last2 temp___9061)))
     (+ (- (to_rep1 (last2 temp___9061)) (to_rep1 (first2 temp___9061))) 1)
     0) (ite (<= (to_rep1 (first2 temp___9091)) (to_rep1 (last2 temp___9091)))
        (+ (- (to_rep1 (last2 temp___9091)) (to_rep1 (first2 temp___9091))) 1)
        0))))
(check-sat)
(exit)
