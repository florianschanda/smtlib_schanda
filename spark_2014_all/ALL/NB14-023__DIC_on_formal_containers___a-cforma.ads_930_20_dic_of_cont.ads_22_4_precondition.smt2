...
(define-fun dynamic_invariant ((temp___expr_1154 Int)
...
(declare-const temp___2069 count_type)
...
;; H
  (assert (= temp___2069 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___2069)) no_element))
