...
;; H
  ...
  (=>
  (and (<= (to_rep1 ret__first) temp___217)
  (<= temp___217 (to_rep1 ret__last)))
  (=> (<= i2 temp___217)
  (= (select ret1 temp___217) (select ret temp___217)))))
  (=> (<= (- 2147483648) 2147483647) (in_range1 pos1)))
  (and (<= (to_rep1 (first (rt str))) i2) (<= i2 (to_rep1 (last (rt str)))))))
