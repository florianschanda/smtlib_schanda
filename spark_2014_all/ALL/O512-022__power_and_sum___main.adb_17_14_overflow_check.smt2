...
;; H
  (assert
  (=> (= (length (mk___t temp___525 temp___5251)) 0)
  (= (elts (to_string (attr__ATTRIBUTE_IMAGE1 result22))) o38)))

;; H
  (assert
  (=> (= (length (mk___t temp___525 temp___5251)) 0)
  (= (mk (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22)))))
     (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22))))))
  o39)))

;; H
  (assert
  (=> (not (= (length (mk___t temp___525 temp___5251)) 0))
  (=>
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___525 temp___5251)) 0))
  (= o35 (+ (to_rep1 (first temp___5251)) o34))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___525 temp___5251)) 0)) (= o36 (- o35 1))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___525 temp___5251)) 0))
  (and (= o37 o36) (in_range2 o36))))

;; H
  (assert
  (=> (not (= (length (mk___t temp___525 temp___5251)) 0))
  (= (concat1 temp___525 (to_rep1 (first temp___5251))
     (to_rep1 (last temp___5251))
     (elts (to_string (attr__ATTRIBUTE_IMAGE1 result22)))
     (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22)))))
     (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE1 result22))))))
  o38)))
...
;; H
  (assert
  (=> (not (= (length (mk___t temp___525 temp___5251)) 0))
  (= (mk (to_rep1 (first temp___5251)) o37) o39)))
