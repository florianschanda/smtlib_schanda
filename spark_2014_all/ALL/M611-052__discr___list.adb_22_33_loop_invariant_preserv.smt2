...
(define-fun bool_eq15 ((a us_rep3)
...
(declare-fun list__my_lists__append__2__container__fields1 () us_split_fields2)

(declare-fun result6 () us_split_fields__ref1)

(declare-fun res__split_fields3 () us_split_fields2)

(declare-fun stack__pop__s__fields1 () us_split_fields)

(declare-fun result7 () us_split_fields__ref2)

(declare-fun s__split_fields12 () us_split_fields4)

(declare-fun s__split_fields13 () us_split_fields__ref2)

(declare-fun res__split_fields4 () us_split_fields__ref1)

(declare-fun i11 () int__ref)

(declare-fun s__split_fields14 () us_split_fields4)
...
(declare-fun rho1 () us_split_fields)
...
;; H
  ...
  (= (let ((temp___182 (to__
     ...
     (bool_eq2 (elts1 temp___181) (to_rep (first2 (rt1 temp___181)))
...
;; H
  (assert
  (=> (and (<= r4b i2) (<= i2 r5b)) (= s__split_fields7 s__split_fields5)))
...
;; H
  (assert
  (=> (and (<= r4b i2) (<= i2 r5b)) (= s__split_fields8 s__split_fields6)))
...
;; H
  (assert
  (=> (and (<= r4b i2) (<= i2 r5b)) (= s__split_fields9 s__split_fields7)))
...
;; H
  ...
  (= (let ((temp___188 (to__
     ...
     (let ((temp___187 (to_but_top
                       ...
                       (mk___rep2 s__split_discrs
                       (us_split_fields__content2 s__split_fields8))))))))
     (bool_eq2 (elts1 temp___187) (to_rep (first2 (rt1 temp___187)))
...
;; H
  ...
  (forall ((j Int))
  (=> (and (<= 1 j) (<= j i9))
  (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j) 
...
;; H
  ...
  (= (to_rep (last5 (rt2 (rec__stack__stack__content1 s__split_fields11)))) 
  r1b))) (=> (<= r7b r8b) (dynamic_property5 r7b r8b i9)))
  (and (<= r7b i9) (<= i9 r8b))))
...
;; H
  (assert
  (and (= o3 (top (to_base (mk___rep2 s__split_discrs s__split_fields11))))
  (and (in_range1 o3)
  (= o3 (to_rep1
        (rec__stack__stack__top
        (us_split_fields1
        (to_base (mk___rep2 s__split_discrs s__split_fields11)))))))))
...
;; H
  ...
  (= (length2
     (mk___rep1 res__split_discrs
     list__my_lists__append__2__container__fields1)) (+ (length2
                                                        (mk___rep1
                                                        res__split_discrs
                                                        res__split_fields2)) 1))
  (= (olt (model__ (mk___rep1 res__split_discrs res__split_fields2))
     (model__
     (mk___rep1 res__split_discrs
  ...
  (= (get
     (model__
     (mk___rep1 res__split_discrs
     list__my_lists__append__2__container__fields1))
     (+ (last4 (model__ (mk___rep1 res__split_discrs res__split_fields2))) 1)) 
  o3)))

;; H
  (assert (= result6 (mk___split_fields__ref1 res__split_fields2)))

;; H
  (assert
  (= res__split_fields3 list__my_lists__append__2__container__fields1))

;; H
  (assert
  (and
  (= (let ((temp___188 (to__
                       (mk___rep s__split_discrs stack__pop__s__fields1))))
     (let ((temp___187 (to_but_top
                       (mk___rep s__split_discrs
                       (us_split_fields1
                       (to_base
                       (mk___rep2 s__split_discrs s__split_fields11)))))))
     (bool_eq2 (elts1 temp___187) (to_rep (first2 (rt1 temp___187)))
     (to_rep (last2 (rt1 temp___187))) (elts1 temp___188)
     (to_rep (first2 (rt1 temp___188))) (to_rep (last2 (rt1 temp___188)))))) true)
  (dynamic_invariant2 (mk___rep s__split_discrs stack__pop__s__fields1) true
  true true)))

;; H
  (assert (= result7 (mk___split_fields__ref2 s__split_fields11)))

;; H
  (assert
  (= s__split_fields12 (us_split_fields5
                       (of_base
                       (mk___rep s__split_discrs stack__pop__s__fields1)))))
...
;; H
  (assert (= s__split_fields13 (mk___split_fields__ref2 s__split_fields12)))

;; H
  (assert (= rho1 stack__pop__s__fields1))

;; H
  (assert (= rho list__my_lists__append__2__container__fields1))

;; H
  (assert (= i12 i10))

;; H
  (assert (= res__split_fields5 res__split_fields3))

;; H
  (assert (= s__split_fields14 s__split_fields12))
...
;; WP_parameter_def
 ;; File "list.ads", line 9, characters 0-0
  ...
  (= (get
     (model__
     (mk___rep1 res__split_discrs
     (us_split_fields__content1 res__split_fields4))) j) (get (model__ l)
                                                         (+ (- (last4
                                                               (model__ l)) 
                                                         j) 1)))))
(check-sat)
