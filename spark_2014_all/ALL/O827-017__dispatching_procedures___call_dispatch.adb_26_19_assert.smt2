...
(declare-fun a22 () (Array Int natural))

(declare-fun a32 () (Array Int natural))

(declare-fun r2__split_fields2 () us_split_fields)

(declare-fun r2__split_discrs2 () us_split_discrs)

(declare-fun r3__split_fields2 () us_split_fields)

(declare-fun r3__split_discrs2 () us_split_discrs)

(declare-fun v2__split_fields2 () us_split_fields2)

(declare-fun v3__split_fields2 () us_split_fields2)

(declare-fun y22 () Int)

(declare-fun y33 () Int)

(declare-fun z23 () (Array Int natural))

(declare-fun z33 () (Array Int natural))

(declare-fun w2__split_fields3 () us_split_fields)

(declare-fun w2__split_discrs3 () us_split_discrs)

(declare-fun w3__split_fields3 () us_split_fields)

(declare-fun w3__split_discrs3 () us_split_discrs)
...
;; H
  ...
  (and
  (and
  (and (in_range (let ((subject y2)) y22)) (in_range
  (let ((subject y3)) y33))) (in_range c22)) (in_range c32))
  (p__specific_post v1__attr__tag
  (mk___rep1 (let ((subject v1__split_fields)) v1__split_fields1)
  v1__attr__tag) (let ((subject v2__split_fields)) v2__split_fields2)
  v2__attr__tag (let ((subject v3__split_fields)) v3__split_fields2)
  v3__attr__tag (let ((subject y1)) y11) (let ((subject y2)) y22)
  (let ((subject y3)) y33)
  (mk___t (let ((subject z1)) z11) (mk (to_rep z1__first) (to_rep z1__last)))
  (let ((subject z2)) z23) z2__first z2__last (let ((subject z3)) z33)
  z3__first z3__last
  (mk___rep (let ((subject w1__split_discrs)) w1__split_discrs1)
  (let ((subject w1__split_fields)) w1__split_fields1) w1__attr__constrained)
  (let ((subject w2__split_fields)) w2__split_fields3)
  (let ((subject w2__split_discrs)) w2__split_discrs3) w2__attr__constrained
  (let ((subject w3__split_fields)) w3__split_fields3)
  (let ((subject w3__split_discrs)) w3__split_discrs3) w3__attr__constrained
  c1 c32 a1 a32 (mk___split_fields r1__split_fields)
  (mk___split_discrs r1__split_discrs) r3__split_fields2 r3__split_discrs2
  c22 a22 r2__split_fields2 r2__split_discrs2
  (let ((subject v2__split_fields)) v2__split_fields1)
  (let ((subject v3__split_fields)) v3__split_fields1)
  (let ((subject y2)) y21) (let ((subject y3)) y32) (let ((subject z2)) z22)
  (let ((subject z3)) z32)
  (let ((subject w2__split_fields)) w2__split_fields2)
  (let ((subject w2__split_discrs)) w2__split_discrs2)
  (let ((subject w3__split_fields)) w3__split_fields2)
  (let ((subject w3__split_discrs)) w3__split_discrs2) c1 c31 a1 a31
  (mk___split_fields r1__split_fields) (mk___split_discrs r1__split_discrs)
  r3__split_fields1 r3__split_discrs1 c21 a21 r2__split_fields1
  r2__split_discrs1)))
...
;; H
  ...
  (= (to_rep
     (rec__dispatch__root__i
     (let ((subject v2__split_fields)) v2__split_fields2))) (to_rep
                                                            (rec__dispatch__root__i
                                                            (let ((subject
                                                            v1__split_fields))
                                                            v1__split_fields1)))))
...
;; H
  ...
  (= (to_rep
     (rec__dispatch__root__i
     (let ((subject v3__split_fields)) v3__split_fields2))) 3))
...
;; H
  ...
  (< (to_rep
     ...
     (us_split_fields5
     (of_base
     (mk___rep1 (let ((subject v2__split_fields)) v2__split_fields2)
     v2__attr__tag))))) 0))
...
;; WP_parameter_def
 ;; File "dispatch.ads", line 24, characters 0-0
  ...
  (= (to_rep
     ...
     (us_split_fields5
     (of_base
     (mk___rep1 (let ((subject v3__split_fields)) v3__split_fields2)
     v3__attr__tag))))) 3)))
(check-sat)
(exit)
