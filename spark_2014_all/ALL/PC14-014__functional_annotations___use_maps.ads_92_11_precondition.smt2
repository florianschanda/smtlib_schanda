...
;; H
  ...
  (= (has_key
     (model__ (mk___rep m__split_discrs (mk___split_fields m__split_fields)))
     key2) true))
  (and (< 0 (find temp___950 key2))
  (= (get1 temp___950 (find temp___950 key2)) key2)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep m__split_discrs (mk___split_fields m__split_fields)))))
  (= (find temp___950 (get1 temp___950 i)) i))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
  ...
  (<= j (length
        (mk___rep m__split_discrs (mk___split_fields m__split_fields)))))
  (=> (= (get1 temp___950 i) (get1 temp___950 j)) (= i j)))))))))

;; H
  (assert
  (and (= o (iter_has_element temp___950 temp___949))
  (= (= o true) (and (<= 1 temp___949) (<= temp___949 (last temp___950))))))

;; H
  (assert (= (= o1 true) (in_range5 temp___949)))
