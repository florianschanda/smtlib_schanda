...
;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= result1 y8)))

;; H
  (assert (=> (bvule x3 ((_ int2bv 32) 2147483647)) (= y3 o18)))
...
;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= result2 y8)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y4 o22)))

;; H
  (assert (=> (not (bvule x3 ((_ int2bv 32) 2147483647))) (= y3 y4)))
...
;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= result5 y7)))

;; H
  (assert (=> (bvule x4 ((_ int2bv 32) 2147483647)) (= y5 o50)))
...
;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= result6 y7)))

;; H
  (assert (=> (not (bvule x4 ((_ int2bv 32) 2147483647))) (= y6 o54)))
...
;; H
  (assert (not (bvule x5 ((_ int2bv 32) 2147483647))))

;; H
  (assert (and (= o82 (bv2nat (bvnot x5))) (in_range1 (bv2nat (bvnot x5)))))
