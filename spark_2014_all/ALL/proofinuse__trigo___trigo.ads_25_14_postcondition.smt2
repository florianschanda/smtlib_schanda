...
;; approx_cos__def_axiom
  ...
  (! (=> (dynamic_invariant x true true true)
     (= (approx_cos x) (add RNE1
                       (sub RNE1
                       (add RNE1
                       (sub RNE1 fliteral (div1 RNE1 (pow21 x) fliteral3))
                       (div1 RNE1 (pow4 x) fliteral4))
                       (div1 RNE1 (pow6 x) fliteral5))
                       (div1 RNE1 (pow8 x) fliteral6)))) :pattern ((approx_cos
                                                                   x)) )))
...
;; pow2__def_axiom
  ...
  (! (=> (dynamic_invariant x1 true true true)
     (= (pow21 x1) (mul RNE1 x1 x1))) :pattern ((pow21 x1)) )))
...
;; pow4__def_axiom
  ...
  (forall ((x1 t))
  (! (=> (dynamic_invariant x1 true true true)
     (= (pow4 x1) (mul RNE1 (mul RNE1 (mul RNE1 x1 x1) x1) x1))) :pattern (
  (pow4 x1)) )))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (lt (abs1 (sub RNE1 trigo__cos__result4 (approx_cos x))) fliteral7)))
(check-sat)
