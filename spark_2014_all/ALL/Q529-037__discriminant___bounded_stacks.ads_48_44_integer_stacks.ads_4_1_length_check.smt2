...
(declare-datatypes ((t21b__ref 0)) (((mk_t21b__ref (t21b__content us_t2)))))
...
(declare-datatypes ((t28b__ref 0)) (((mk_t28b__ref (t28b__content us_t3)))))
...
(declare-datatypes ((t26b__ref 0)) (((mk_t26b__ref (t26b__content us_t4)))))
...
(((mk_contents__ref (contents__content us_t5)))))
...
(declare-const temp___239 Int)

(declare-const temp___238 positive)

(declare-const temp___241 (Array Int element))

(declare-const temp___2411 t1)
