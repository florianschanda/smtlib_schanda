...
((us_split_fields2
 (mk___split_fields1
 (rec__integer_stacks__stack__values1 us_t2)(rec__integer_stacks__stack__top1 natural)(rec__ext__1 us_private)))))
(define-fun us_split_fields_Values2__projection ((a us_split_fields2)) us_t2
...
((us_split_fields4
 (mk___split_fields2
 (rec__integer_stacks__stack__values2 us_t3)(rec__integer_stacks__stack__top2 natural)(rec__ext__2 us_private)))))
(define-fun us_split_fields_Values3__projection ((a us_split_fields4)) us_t3
...
((us_split_fields6
 (mk___split_fields3
 (rec__integer_stacks__stack__values3 us_t4)(rec__integer_stacks__stack__top3 natural)(rec__ext__3 us_private)))))
(define-fun us_split_fields_Values4__projection ((a us_split_fields6)) us_t4
...
(declare-fun dummy18 () us_t5)

(declare-datatypes ()
((contents__ref (mk_contents__ref (contents__content us_t5)))))
(define-fun contents__ref___projection ((a contents__ref)) us_t5 (contents__content
                                                                 a))

(declare-fun temp___218 (Int Int Int) us_t1)
...
;; def_axiom
  ...
  (and
  (=> (dynamic_property10 1 2147483647 temp___221 temp___222)
  (and (= (first3 temp___219) temp___221) (= (last3 temp___219) temp___222)))
  (forall ((temp___223 Int))
  (= (select (to_array1 temp___219) temp___223) (of_rep3 temp___220)))))))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq11 a b) (oeq (to_base a) (to_base b))) :pattern ((user_eq11 a
                                                                 b)) )))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq17 a b) (oeq (to_base2 a) (to_base2 b))) :pattern ((user_eq17
                                                                   a b)) )))
...
;; user_eq__def_axiom
  ...
  (! (= (user_eq14 a b) (oeq (to_base1 a) (to_base1 b))) :pattern ((user_eq14
                                                                   a b)) )))
...
(declare-fun temp___238 () positive)

(declare-fun temp___241 () (Array Int element))

(declare-fun temp___2411 () t1)

;; H
  (assert (in_range1 temp___239))

;; H
  (assert (= temp___239 (to_rep1 temp___238)))

;; H
  (assert (= (to_rep2 (first2 (rt1 (temp___218 0 1 temp___239)))) 1))

;; H
  (assert (= (to_rep2 (last2 (rt1 (temp___218 0 1 temp___239)))) temp___239))

;; H
  (assert (= (mk___t1 temp___241 temp___2411) (temp___218 0 1 temp___239)))

(assert
;; WP_parameter_def
 ;; File "bounded_stacks.ads", line 48, characters 0-0
  (not
  (= (ite (<= (to_rep2 (first2 temp___2411)) (to_rep2 (last2 temp___2411)))
     (+ (- (to_rep2 (last2 temp___2411)) (to_rep2 (first2 temp___2411))) 1)
     0) (ite (<= 1 temp___239) (+ (- temp___239 1) 1) 0))))
(check-sat)
(exit)
