...
;; H
  ...
  (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 10))) 57))
  (forall ((index Int))
  (=>
  (and (<= (+ (to_rep1 (first (rt source))) 10) index)
...
;; H
  ...
  (and
  (and (and (<= 0 n1) (<= n1 9))
  (= n1 (convert_character_digit_to_integer o2)))
  (ite (= (= o2 48) true) (= n1 0)
  (ite (= (= o2 49) true) (= n1 1)
  (ite (= (= o2 50) true) (= n1 2)
  (ite (= (= o2 51) true) (= n1 3)
  ...
  (ite (= (= o2 54) true) (= n1 6)
  (ite (= (= o2 55) true) (= n1 7)
  (ite (= (= o2 56) true) (= n1 8) (=> (= (= o2 57) true) (= n1 9))))))))))))
  (in_range1 n1)))

;; H
  (assert (and (= o3 (- n1)) (in_range1 (- n1))))
...
;; H
  (assert
  (and (= o4 (- target1 2147483640)) (in_range1 (- target1 2147483640))))

;; H
  (assert (= target1 result1))
