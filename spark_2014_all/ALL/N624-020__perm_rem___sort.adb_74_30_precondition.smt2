...
;; H
  (assert
  (and (= o27 (remove (mk___t interm1 (mk 1 100)) o26))
  ...
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o26 1)))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o27) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o26 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select interm1 k)) (to_rep (select (elts o27) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o26 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o27) k))))))))))))
