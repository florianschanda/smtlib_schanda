...
(define-fun dynamic_invariant ((temp___expr_171 (_ BitVec 8))
  ...
  (temp___do_toplevel_170 Bool)) Bool (=> (= temp___do_toplevel_170 true)
                                      ...
                                      (or
                                      (and
                                      (bvule ((_ int2bv 8) 1) temp___expr_171)
                                      (bvule temp___expr_171 ((_ int2bv 8) 3)))
                                      (and
                                      (bvule ((_ int2bv 8) 5) temp___expr_171)
                                      (bvule temp___expr_171 ((_ int2bv 8) 255)))))))

(define-fun dynamic_predicate ((temp___175 (_ BitVec 8))) Bool (or
                                                               (and
                                                               (bvule ((_ int2bv 8) 1) temp___175)
                                                               (bvule temp___175 ((_ int2bv 8) 3)))
                                                               (and
                                                               (bvule ((_ int2bv 8) 5) temp___175)
                                                               (bvule temp___175 ((_ int2bv 8) 255)))))

(declare-fun i1b () (_ BitVec 8))
...
(assert
;; WP_parameter_def
 ;; File "t.adb", line 4, characters 0-0
  (not
  (or
  (and (bvule ((_ int2bv 8) 1) temp___178)
  (bvule temp___178 ((_ int2bv 8) 3)))
  (and (bvule ((_ int2bv 8) 5) temp___178)
  (bvule temp___178 ((_ int2bv 8) 255))))))
(check-sat)
