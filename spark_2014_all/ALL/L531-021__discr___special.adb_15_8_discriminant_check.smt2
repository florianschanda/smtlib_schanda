...
(declare-const v__split_fields3 natural)
...
(declare-const special__t__v__assume enum)

(declare-const special__t__v__assume1 integer)

(declare-const special__t__v__assume2 integer)

(declare-const special__t__v__assume3 Bool)

(declare-const special__t__v__assume4 natural)
...
(declare-const v__split_fields7 natural)
