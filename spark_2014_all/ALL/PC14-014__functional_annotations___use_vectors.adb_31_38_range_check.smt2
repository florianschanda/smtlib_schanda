...
;; H
  ...
  (= (is_incr
     ...
     n1) (get (model__ (mk___rep v__split_discrs v__split_fields2)) n1)) true))))
...
;; H
  ...
  (=>
  (and (<= i2 n1)
  (<= n1 (last5 (model__ (mk___rep v__split_discrs v__split_fields2)))))
  (= (get
     (model__ (mk___rep v__split_discrs (mk___split_fields v__split_fields)))
     n1) (get (model__ (mk___rep v__split_discrs v__split_fields2)) n1)))))
