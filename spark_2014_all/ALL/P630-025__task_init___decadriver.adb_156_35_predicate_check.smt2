...
(define-fun dynamic_invariant ((temp___expr_4413 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_4419 us_rep)
...
(define-fun dynamic_invariant6 ((temp___expr_4407 Int)
...
(declare-const temp___4589 frame_length)

(declare-const temp___45891 (Array Int bits_8))

(declare-const temp___45892 rx_errors)

(declare-const temp___45893 Bool)
...
;; H
  (assert
  (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1)) (in_range5 next_idx)))
...
;; H
  (assert
  (and (= o4 (+ (to_rep self__2) 1)) (in_range1 (+ (to_rep self__2) 1))))
...
;; H
  (assert
  (= result1 (mk_receiver_type__ref
             (mk___rep1
             (mk___split_fields1 self__ self__1 self__2 self__3 self__4)))))
...
;; H
  ...
  (= (rec__decadriver__rx_frame_type__frame
     ...
     (select (rec__decadriver__receiver_type__frame_queue
             (us_split_fields3 self__5)) next_idx1))) o18))
...
;; H
  ...
  (= (rec__decadriver__rx_frame_type__error
     (us_split_fields1
     (select (rec__decadriver__receiver_type__frame_queue
             (us_split_fields3 self__5)) next_idx1))) o19))
...
;; WP_parameter_def
 ;; File "decadriver.ads", line 77, characters 0-0
  ...
  (mk___rep
  (mk___split_fields temp___4589 temp___45891 temp___45892 temp___45893)))))
(check-sat)
(exit)
