...
(declare-fun o6 () (Array Int element_type))
...
(declare-fun o11 () (Array Int element_type))
...
(declare-fun o23 () (Array Int element_type))
...
;; H
  (assert
  (and
  (= o (+ (mod1 (to_rep1 queue__split_fields2)
          (to_rep1
          (rec__bounded_queue_example__char_queue__queue_type__max_size
          queue__split_discrs))) 1))
  (in_range
  (+ (mod1 (to_rep1 queue__split_fields2)
     (to_rep1
     (rec__bounded_queue_example__char_queue__queue_type__max_size
     queue__split_discrs))) 1))))
...
;; H
  ...
  (= (rt
     (rec__bounded_queue_example__char_queue__queue_type__items
     queue__split_fields5)) o12))

;; H
  (assert
  (= (rec__bounded_queue_example__char_queue__queue_type__count
     queue__split_fields5) o13))

;; H
  (assert
  (= (rec__bounded_queue_example__char_queue__queue_type__front
     queue__split_fields5) o14))

;; H
  (assert
  (= (rec__bounded_queue_example__char_queue__queue_type__rear
     queue__split_fields5) o15))
...
;; H
  (assert
  (= (rec__bounded_queue_example__char_queue__queue_type__front
     queue__split_fields6) o21))

;; H
  (assert
  (= (rec__bounded_queue_example__char_queue__queue_type__rear
     queue__split_fields6) o22))
