...
(define-fun current__split_fields8 () us_split_fields2 (mk___split_fields1
                                                       current__split_fields3))

(define-fun current__split_fields9 () us_split_fields2 (mk___split_fields1
...
;; H
  ...
  (=> (= result1 true)
  (or
  (= (bool_eq1 (mk___rep1 current__split_fields9)
     (first
     (mk___rep container__split_discrs
  ...
  (< (element
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (mk___rep1 current__split_fields9))) new_item))))
...
;; H
  ...
  (= (has_key
     ...
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields9)) true)
  (< (element
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields))
     (mk___rep1 current__split_fields9)) new_item))))
...
;; H
  (assert
  (=> (= result1 true)
  (ite (= (ite (= (bool_eq1 (mk___rep1 current__split_fields9) no_element) false) (=
          (get1
          (positions
          (mk___rep container__split_discrs
          (mk___split_fields container__split_fields)))
          (mk___rep1 current__split_fields9)) (length
                                              (mk___rep
                                              container__split_discrs
                                              (mk___split_fields
                                              container__split_fields)))) true) true)
  (= (bool_eq1 (mk___rep1 current__split_fields8) no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields8)) true)
  (= (get1
     (positions
     (mk___rep container__split_discrs
     (mk___split_fields container__split_fields)))
     (mk___rep1 current__split_fields8)) (+ (get1
                                            (positions
                                            (mk___rep container__split_discrs
                                            (mk___split_fields
                                            container__split_fields)))
...
;; H
  ...
  (= result4 (has_key
             ...
             (mk___rep container__split_discrs
             (mk___split_fields container__split_fields)))
             (mk___rep1 current__split_fields8)))
  (= (= result4 true)
  (= (has_key
     (positions
     (mk___rep container__split_discrs
...
;; H
  (assert
  (=> (= result1 true)
  (= current__split_fields4 (mk___split_fields__ref1 current__split_fields8))))

;; H
  (assert
  (=> (= result1 true) (= current__split_fields5 current__split_fields8)))
...
;; H
  (assert
  (=> (not (= result1 true))
  (= current__split_fields6 (mk___split_fields__ref1 current__split_fields10))))

;; H
  (assert
  (=> (not (= result1 true))
  (= current__split_fields7 current__split_fields10)))
