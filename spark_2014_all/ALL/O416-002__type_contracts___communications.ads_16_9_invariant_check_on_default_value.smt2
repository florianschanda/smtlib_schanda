...
(declare-fun temp___288 () positive)

(declare-fun temp___2881 () (Array Int us_rep))

(declare-fun temp___2882 () t)

(define-fun temp___2883 () us_rep1 (mk___rep1 (mk___split_discrs temp___288)
                                   (mk___split_fields1
                                   (mk___t temp___2881 temp___2882))))
...
;; WP_parameter_def
 ;; File "communications.ads", line 12, characters 0-0
  (not (type_invariant temp___2883)))
(check-sat)
(exit)
