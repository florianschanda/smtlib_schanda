...
(define-fun dynamic_invariant ((temp___expr_181 us_rep)
...
(declare-fun r01__split_discrs () us_split_discrs)

(declare-fun r01__attr__tag () Int)
...
;; H
  (assert
  (and (= r01__attr__tag us_tag1)
  (= (to_rep (rec__membership_discr__root__c r01__split_discrs)) 0)))
...
;; WP_parameter_def
 ;; File "membership_discr.adb", line 11, characters 0-0
  (not (= 0 (to_rep (rec__membership_discr__root__c r01__split_discrs)))))
(check-sat)
(exit)
