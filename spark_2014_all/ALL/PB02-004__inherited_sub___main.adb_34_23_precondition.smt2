...
;; range_axiom
  (assert
  (forall ((x sub_enum)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)) )))
...
(define-fun in_range3 ((rec__rec__my_rec__e1 Int)
...
(declare-datatypes ()
((us_split_discrs2 (mk___split_discrs1 (rec__rec__sub_rec__z enum)))))
(define-fun us_split_discrs___2__projection ((a us_split_discrs2)) enum
...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__rec__sub_rec__plop us_rep)))))
(define-fun us_split_fields_Plop__projection ((a us_split_fields2)) us_rep
...
(define-fun dynamic_invariant ((temp___expr_155 us_rep1)
  (temp___is_init_152 Bool) (temp___skip_constant_153 Bool)
  (temp___do_toplevel_154 Bool)) Bool (in_range3
  (to_rep (rec__rec__sub_rec__z (us_split_discrs3 temp___expr_155)))
  (rec__rec__sub_rec__plop (us_split_fields3 temp___expr_155))))
...
(declare-datatypes ()
((us_split_discrs4 (mk___split_discrs2 (rec__rec__sub_rec_ok__z enum)))))
(define-fun us_split_discrs___3__projection ((a us_split_discrs4)) enum
...
(declare-datatypes ()
((us_split_fields4 (mk___split_fields2 (rec__rec__sub_rec_ok__plop us_rep)))))
(define-fun us_split_fields_Plop__2__projection ((a us_split_fields4)) us_rep
...
(define-fun us_rep___5__projection ((a us_rep2)) us_split_discrs4 (us_split_discrs5
                                                                  a))
...
(declare-datatypes ()
((sub_rec_ok__ref (mk_sub_rec_ok__ref (sub_rec_ok__content us_rep2)))))
(define-fun sub_rec_ok__ref___projection ((a sub_rec_ok__ref)) us_rep2
  (sub_rec_ok__content a))

(define-fun dynamic_invariant1 ((temp___expr_161 us_rep2)
  (temp___is_init_158 Bool) (temp___skip_constant_159 Bool)
  (temp___do_toplevel_160 Bool)) Bool (=> (rec__sub_rec_ok__plop__pred
                                      temp___expr_161) (in_range4
                                      (to_rep
                                      (rec__rec__sub_rec_ok__z
                                      (us_split_discrs5 temp___expr_161)))
...
(define-fun us_split_discrs___4__projection ((a us_split_discrs6)) natural
  (rec__rec__sub_arr__f a))

(define-fun us_split_discrs___5__projection ((a us_split_discrs6)) natural
...
(declare-datatypes ()
((us_split_fields6 (mk___split_fields3 (rec__rec__sub_arr__content us_t)))))
(define-fun us_split_fields_Content__projection ((a us_split_fields6)) us_t
...
(define-fun us_rep___7__projection ((a us_rep3)) us_split_discrs6 (us_split_discrs7
                                                                  a))
...
(define-fun bool_eq5 ((a us_rep3)
  (b us_rep3)) Bool (ite (and
                         ...
                         (to_rep4
                         (rec__rec__sub_arr__f (us_split_discrs7 b))))
                         (= (to_rep4
                            (rec__rec__sub_arr__l (us_split_discrs7 a)))
                         (to_rep4
                         (rec__rec__sub_arr__l (us_split_discrs7 b)))))
                         (= (bool_eq4
...
(declare-datatypes ()
((sub_arr__ref (mk_sub_arr__ref (sub_arr__content us_rep3)))))
(define-fun sub_arr__ref___projection ((a sub_arr__ref)) us_rep3 (sub_arr__content
                                                                 a))

(define-fun dynamic_invariant2 ((temp___expr_172 us_rep3)
...
(define-fun dynamic_invariant7 ((temp___expr_144 Int)
