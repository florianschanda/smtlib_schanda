...
(define-fun dynamic_invariant ((temp___expr_155 us_rep1)
  ...
  (temp___do_toplevel_154 Bool)) Bool (in_range4
...
(define-fun us_split_discrs_3__projection ((a us_split_discrs4)) enum
...
(define-fun us_split_fields_Plop2__projection ((a us_split_fields4)) us_rep
...
(define-fun us_rep_5__projection ((a us_rep2)) us_split_discrs4 (us_split_discrs5
                                                                a))
...
(define-fun us_split_discrs_4__projection ((a us_split_discrs6)) natural
  (rec__rec__sub_arr__f a))

(define-fun us_split_discrs_5__projection ((a us_split_discrs6)) natural
...
(define-fun us_rep_7__projection ((a us_rep3)) us_split_discrs6 (us_split_discrs7
                                                                a))
...
(declare-fun y__split_discrs () us_split_discrs4)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun f__split_discrs () us_split_discrs6)
