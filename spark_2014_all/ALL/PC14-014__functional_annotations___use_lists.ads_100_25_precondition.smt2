...
;; p_positions_shifted__post_axiom
  ...
  (! (=>
     (and (dynamic_invariant4 cut true true true) (dynamic_invariant count
     true true true))
...
(declare-fun l__split_fields5 () us_main_type)

(declare-fun l__split_fields6 () us_main_type)

(declare-fun l__split_fields7 () us_main_type)

(declare-fun l__split_fields8 () us_main_type)

(declare-fun l__split_fields9 () us_main_type)

(declare-fun result () Bool)

(define-fun l__split_fields10 () us_split_fields (mk___split_fields
                                                 l__split_fields7))

(define-fun l__split_fields11 () us_split_fields (mk___split_fields
                                                 l__split_fields6))

(define-fun l__split_fields12 () us_split_fields (mk___split_fields
                                                 l__split_fields5))

(define-fun l__split_fields13 () us_split_fields (mk___split_fields
                                                 l__split_fields4))

(define-fun l__split_fields14 () us_split_fields (mk___split_fields
                                                 l__split_fields3))

(define-fun l__split_fields15 () us_split_fields (mk___split_fields
                                                 l__split_fields2))

(define-fun l__split_fields16 () us_split_fields (mk___split_fields
                                                 l__split_fields1))
...
;; H
  ...
  (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs)) 7))))
...
;; H
  ...
  (= (length (mk___rep l__split_discrs l__split_fields16)) (+ (length
                                                              ...
                                                              (mk___split_fields
                                                              l__split_fields))) 1))
  (ite (= (bool_eq1 cu no_element) true)
  (and
  (and
  (and
  (and
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields16))
     (last1 (mk___rep l__split_discrs l__split_fields16))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields16)))
  (= (keys_included_except
     ...
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (last1 (mk___rep l__split_discrs l__split_fields16))) true))
  (= (ole1
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (positions (mk___rep l__split_discrs l__split_fields16))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields16))
  ...
  (= (range_equal
     (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     (model__ (mk___rep l__split_discrs l__split_fields16)) 1
     (- (get1
        (positions
        (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
        cu) 1)) true)
...
;; H
  (assert
  (and
  (= (length (mk___rep l__split_discrs l__split_fields15)) (+ (length
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields16)) 1))
  (ite (= (bool_eq1 cu no_element) true)
  ...
  (and
  (and
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields15))
     (last1 (mk___rep l__split_discrs l__split_fields15))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields15)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields16))
     (last1 (mk___rep l__split_discrs l__split_fields15))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields16))
     (positions (mk___rep l__split_discrs l__split_fields15))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields15))
     (length (mk___rep l__split_discrs l__split_fields15))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields16))
  ...
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields16))
     ...
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields16)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields16))
     (model__ (mk___rep l__split_discrs l__split_fields15))
     (get1 (positions (mk___rep l__split_discrs l__split_fields16)) cu)
     (length (mk___rep l__split_discrs l__split_fields16)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields15))
     (get1 (positions (mk___rep l__split_discrs l__split_fields16)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields16))
     (positions (mk___rep l__split_discrs l__split_fields15))
     (get1 (positions (mk___rep l__split_discrs l__split_fields16)) cu) 1) true)))))
...
;; H
  (assert
  (and
  (= (length (mk___rep l__split_discrs l__split_fields14)) (+ (length
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields15)) 1))
  (ite (= (bool_eq1 cu no_element) true)
  ...
  (and
  (and
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields14))
     (last1 (mk___rep l__split_discrs l__split_fields14))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields14)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields15))
     (last1 (mk___rep l__split_discrs l__split_fields14))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields15))
     (positions (mk___rep l__split_discrs l__split_fields14))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields14))
     (length (mk___rep l__split_discrs l__split_fields14))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields15))
     (model__ (mk___rep l__split_discrs l__split_fields14))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields15))
     (model__ (mk___rep l__split_discrs l__split_fields14)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields15)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields15))
     (model__ (mk___rep l__split_discrs l__split_fields14))
     (get1 (positions (mk___rep l__split_discrs l__split_fields15)) cu)
     (length (mk___rep l__split_discrs l__split_fields15)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields14))
     (get1 (positions (mk___rep l__split_discrs l__split_fields15)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields15))
     (positions (mk___rep l__split_discrs l__split_fields14))
     (get1 (positions (mk___rep l__split_discrs l__split_fields15)) cu) 1) true)))))
...
;; H
  (assert
  (and
  (= (length (mk___rep l__split_discrs l__split_fields13)) (+ (length
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields14)) 1))
  (ite (= (bool_eq1 cu no_element) true)
  ...
  (and
  (and
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields13))
     (last1 (mk___rep l__split_discrs l__split_fields13))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields13)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields14))
     (last1 (mk___rep l__split_discrs l__split_fields13))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields14))
     (positions (mk___rep l__split_discrs l__split_fields13))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields13))
     (length (mk___rep l__split_discrs l__split_fields13))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields14))
     (model__ (mk___rep l__split_discrs l__split_fields13))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields14))
     (model__ (mk___rep l__split_discrs l__split_fields13)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields14)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields14))
     (model__ (mk___rep l__split_discrs l__split_fields13))
     (get1 (positions (mk___rep l__split_discrs l__split_fields14)) cu)
     (length (mk___rep l__split_discrs l__split_fields14)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields13))
     (get1 (positions (mk___rep l__split_discrs l__split_fields14)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields14))
     (positions (mk___rep l__split_discrs l__split_fields13))
     (get1 (positions (mk___rep l__split_discrs l__split_fields14)) cu) 1) true)))))
...
;; H
  ...
  (and
  (and
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields12))
     (last1 (mk___rep l__split_discrs l__split_fields12))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields12)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields13))
     (last1 (mk___rep l__split_discrs l__split_fields12))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields13))
     (positions (mk___rep l__split_discrs l__split_fields12))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields12))
     (length (mk___rep l__split_discrs l__split_fields12))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields13))
     (model__ (mk___rep l__split_discrs l__split_fields12))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields13))
     (model__ (mk___rep l__split_discrs l__split_fields12)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields13)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields13))
     (model__ (mk___rep l__split_discrs l__split_fields12))
     (get1 (positions (mk___rep l__split_discrs l__split_fields13)) cu)
     (length (mk___rep l__split_discrs l__split_fields13)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields12))
     (get1 (positions (mk___rep l__split_discrs l__split_fields13)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields13))
     (positions (mk___rep l__split_discrs l__split_fields12))
     (get1 (positions (mk___rep l__split_discrs l__split_fields13)) cu) 1) true)))))
...
;; H
  (assert
  (and
  (= (length (mk___rep l__split_discrs l__split_fields11)) (+ (length
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields12)) 1))
  (ite (= (bool_eq1 cu no_element) true)
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields11))
     (last1 (mk___rep l__split_discrs l__split_fields11))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields11)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields12))
     (last1 (mk___rep l__split_discrs l__split_fields11))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields12))
     (positions (mk___rep l__split_discrs l__split_fields11))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields11))
     (length (mk___rep l__split_discrs l__split_fields11))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields12))
     (model__ (mk___rep l__split_discrs l__split_fields11))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields12))
     (model__ (mk___rep l__split_discrs l__split_fields11)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields12)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields12))
     (model__ (mk___rep l__split_discrs l__split_fields11))
     (get1 (positions (mk___rep l__split_discrs l__split_fields12)) cu)
     (length (mk___rep l__split_discrs l__split_fields12)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields11))
     (get1 (positions (mk___rep l__split_discrs l__split_fields12)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields12))
     (positions (mk___rep l__split_discrs l__split_fields11))
     (get1 (positions (mk___rep l__split_discrs l__split_fields12)) cu) 1) true)))))
...
;; H
  (assert
  (and
  (= (length (mk___rep l__split_discrs l__split_fields10)) (+ (length
                                                              (mk___rep
                                                              l__split_discrs
                                                              l__split_fields11)) 1))
  (ite (= (bool_eq1 cu no_element) true)
  ...
  (= (get1 (positions (mk___rep l__split_discrs l__split_fields10))
     (last1 (mk___rep l__split_discrs l__split_fields10))) (length
                                                           (mk___rep
                                                           l__split_discrs
                                                           l__split_fields10)))
  (= (keys_included_except
     ...
     (positions (mk___rep l__split_discrs l__split_fields11))
     (last1 (mk___rep l__split_discrs l__split_fields10))) true))
  (= (ole1 (positions (mk___rep l__split_discrs l__split_fields11))
     (positions (mk___rep l__split_discrs l__split_fields10))) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10))
     (length (mk___rep l__split_discrs l__split_fields10))) 0))
  (= (ole (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep l__split_discrs l__split_fields10))) true))
  (and
  (and
  (and
  (= (range_equal (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep l__split_discrs l__split_fields10)) 1
     (- (get1 (positions (mk___rep l__split_discrs l__split_fields11)) cu) 1)) true)
  (= (range_shifted (model__ (mk___rep l__split_discrs l__split_fields11))
     (model__ (mk___rep l__split_discrs l__split_fields10))
     (get1 (positions (mk___rep l__split_discrs l__split_fields11)) cu)
     (length (mk___rep l__split_discrs l__split_fields11)) 1) true))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10))
     (get1 (positions (mk___rep l__split_discrs l__split_fields11)) cu)) 0))
  (= (p_positions_shifted
     (positions (mk___rep l__split_discrs l__split_fields11))
     (positions (mk___rep l__split_discrs l__split_fields10))
     (get1 (positions (mk___rep l__split_discrs l__split_fields11)) cu) 1) true)))))
...
;; H
  ...
  (= (has_key
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields))) k) true)
  (= (= (bool_eq1 k cu) true)
  (= (witness
     (positions
     (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
     cu) (witness
         (positions
         (mk___rep l__split_discrs (mk___split_fields l__split_fields))) k))))))))))
...
;; H
  ...
  (and
  (= o14 (positions
         (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (not (= (has_key o14 no_element) true))
  (forall ((i2 us_rep1))
  (=> (= (has_key o14 i2) true)
  (and
  (and (<= 1 (get1 o14 i2))
  (<= (get1 o14 i2) (length
                    ...
                    (mk___split_fields l__split_fields8)))))
  (forall ((j us_rep1))
  (=> (= (has_key o14 j) true)
  (=> (= (get1 o14 i2) (get1 o14 j)) (= (bool_eq1 i2 j) true))))))))))
...
;; H
  ...
  (and (in_range5 o18)
  (=> (= (of_int 0) true)
  (and (= o18 (w_get o14 (witness o14 cu)))
  (forall ((k us_rep1))
  (=> (= (has_key o14 k) true)
  (= (= (bool_eq1 k cu) true) (= (witness o14 cu) (witness o14 k))))))))))
...
;; H
  ...
  (forall ((j us_rep1))
  (=> (= (has_key o12 j) true)
  (=> (= (get1 o12 i2) (get1 o12 j)) (= (bool_eq1 i2 j) true))))))))))

;; H
  (assert
  (and (= o13 (has_key o12 cu))
  (=> (= (of_int 0) true)
  (=>
  (exists ((k us_rep1))
  (and (= (has_key o12 k) true) (= (bool_eq1 k cu) true))) (= o13 true)))))
...
;; H
  ...
  (= o8 (length
        (mk___rep l__split_discrs (mk___split_fields l__split_fields8))))
  (and (in_range2 o8)
  (<= o8 (to_rep (rec__use_lists__my_lists__list__capacity l__split_discrs))))))
...
;; H
  ...
  (= (get
     (model__
     (mk___rep l__split_discrs (mk___split_fields l__split_fields8))) i2)
  (get
  (model__ (mk___rep l__split_discrs (mk___split_fields l__split_fields)))
  (- i2 7)))))))
