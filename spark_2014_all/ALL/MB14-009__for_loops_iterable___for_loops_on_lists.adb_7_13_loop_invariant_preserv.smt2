...
(declare-fun for_loops_on_lists__search_0_for_in__result () us_rep1)

(declare-fun result2 () Bool)

(declare-fun for_loops_on_lists__search_0_for_in__result1 () us_rep1)

(declare-fun result3 () Bool)

(declare-fun result4 () cursor__ref)

(declare-fun cu3 () us_rep1)

(define-fun o7 () us_rep1 (mk___rep1 (mk___split_fields1 o6)))

(define-fun o8 () us_rep1 (mk___rep1 (mk___split_fields1 o4)))
...
;; H
  (assert
  (and (= o9 (first l))
  (ite (= (= (length2 l) 0) true) (= (bool_eq1 o9 no_element) true)
  (and (= (has_key (positions l) o9) true) (= (get1 (positions l) o9) 1)))))
...
;; H
  (assert
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (- (get1 (positions l) cu2) 1)))
...
;; H
  (assert
  (and (= o3 (element l cu2))
  (and (in_range5 o3) (= o3 (get (model__ l) (get1 (positions l) cu2))))))
...
;; H
  (assert
  (= for_loops_on_lists__search_0_for_in__result1 for_loops_on_lists__search_0_for_in__result))

;; H
  (assert
  (and (= o8 (next l cu2))
  (ite (= (ite (= (bool_eq1 cu2 no_element) false) (= (get1 (positions l)
                                                      cu2) (length2 l)) true) true)
  (= (bool_eq1 o8 no_element) true)
  (and (= (has_key (positions l) o8) true)
  (= (get1 (positions l) o8) (+ (get1 (positions l) cu2) 1))))))

;; H
  (assert
  (and (= o5 (has_key (positions l) o8))
  (= (= o5 true) (= (has_key (positions l) o8) true))))
...
;; H
  ...
  (= (get1 (positions l) o7) (+ (get1 (positions l) cu2) 1))))))
...
;; H
  (assert (<= i (- (get1 (positions l) cu3) 1)))
