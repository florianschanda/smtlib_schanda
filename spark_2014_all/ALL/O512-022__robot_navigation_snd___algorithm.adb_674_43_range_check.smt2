...
(declare-fun disttoclosestobstacle1 () t)
...
(declare-fun disttoclosestobstacle2 () t)
...
;; H
  ...
  (=> (le fliteral2 fliteral1) (in_range7 disttoclosestobstacle2)))
  (and
  (= (attr__constrained
     (rec__robot_iface__proxy__speed
     (us_split_fields9
...
;; H
  ...
  (select (rec__algorithm__controller__laserscan
          (let ((subject this__split_fields)) this__split_fields2)) (let ((subject 
                                                                    i)) 
                                                                    i2)))))
  (to_rep3
  (rec__robot_iface__proxy__robot_radius
...
;; H
  ...
  (us_split_fields19
  (select (rec__algorithm__controller__laserscan
          (us_split_fields__content10 this__split_fields3)) (let ((subject 
                                                            i)) i2)))))))
...
;; H
  ...
  (= result4 (ite (le
             ...
             (select (rec__algorithm__controller__laserscan
                     (us_split_fields__content10 this__split_fields3)) 
             (let ((subject i)) i2))))) o3) true false)))
