...
;; H
  (assert (dynamic_property first 9999999999 (to_fixed s)))

;; H
  (assert (< 0 (to_fixed s)))

;; H
  (assert (= (to_fixed1 o) (to_fixed s)))
...
;; H
  (assert
  (=> (= result true) (= (to_fixed1 o2) (- (to_fixed1 stash) (to_fixed s)))))
...
;; H
  (assert
  (=> (= result true) (= (to_fixed1 o3) (+ (to_fixed1 pocket) (to_fixed s)))))
