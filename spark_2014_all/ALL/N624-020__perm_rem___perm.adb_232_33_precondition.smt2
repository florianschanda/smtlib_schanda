...
(define-fun o33 () us_t (mk___t o29 o30))

(define-fun o34 () us_t (mk___t o26 o27))

(define-fun o35 () us_t (mk___t o24 o25))

(define-fun o36 () us_t (mk___t o22 o23))

(define-fun o37 () us_t (mk___t o19 o20))

(define-fun o38 () us_t (mk___t o14 o15))

(define-fun o39 () us_t (mk___t o11 o12))

(define-fun o40 () us_t (mk___t o8 o9))

(define-fun o41 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and (= o16 (shift_perm_l o41 o40 o38))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o38 o40) true)))))
...
;; H
  (assert
  (and (= o31 (shift_perm_r o36 o35 o33))
  (and (in_range3 o31) (=> (= (of_int o31) true) (= (is_perm o36 o33) true)))))
...
;; H
  (assert
  (and
  (= o32 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))
  (in_range4
  (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
