...
;; H
  ...
  (=>
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields10)) fst) i)
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields10))
           (mk___rep1 current__split_fields10)) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i) 0)))))
...
;; H
  ...
  (<= i (- (get1 (positions (mk___rep l__split_discrs l__split_fields10))
           fst) 1)))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i) (get
                                                                    temp___543
                                                                    i))))))
...
;; H
  ...
  (and
  (<= (get1 (positions (mk___rep l__split_discrs l__split_fields10))
      (mk___rep1 current__split_fields10)) i)
  (<= i (length (mk___rep l__split_discrs l__split_fields10))))
  (= (get (model__ (mk___rep l__split_discrs l__split_fields10)) i) (get
                                                                    temp___544
                                                                    i))))))
