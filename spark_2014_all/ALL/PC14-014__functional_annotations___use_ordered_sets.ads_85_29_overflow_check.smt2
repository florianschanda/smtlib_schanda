...
;; H
  (assert
  (=> (= result2 true)
  (and (= temp___7891 (next (mk___rep s__split_discrs s__split_fields3) o7))
  (ite (= (ite (= (bool_eq1 o7 no_element) false) (= (get1
                                                     (positions
                                                     (mk___rep
                                                     s__split_discrs
                                                     s__split_fields3))
