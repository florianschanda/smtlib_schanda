...
;; H
  (assert
  (=> (= result9 true)
  (and (<= (to_rep1 a__first) k3) (<= k3 (to_rep1 a__last)))))
...
;; H
  (assert
  (=> (= result9 true) (= o37 (rec__frame_condition__cell__value o36))))
...
;; H
  ...
  (= o40 (mk___split_fields
         (rec__frame_condition__cell__value
         (us_split_fields1 (select a2 c167b3))) o39
         (rec__frame_condition__cell__max_right
         (us_split_fields1 (select a2 c167b3))))))
