...
(define-fun indefinite_bounded__vect__append__2__container__fields1 () us_split_fields
...
;; H
  (assert
  (= v__split_fields4 indefinite_bounded__vect__clear__container__fields1))
...
;; H
  (assert
  (= (oeq (mk___rep v__split_discrs v__split_fields4) (empty_vector Tuple0)) true))
...
;; H
  ...
  (= (get
     ...
     (+ (last (model__ (mk___rep v__split_discrs v__split_fields4))) 1)) 1)))
