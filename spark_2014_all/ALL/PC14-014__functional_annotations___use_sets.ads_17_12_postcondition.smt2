...
(define-fun default_initial_assumption ((temp___expr_392 us_rep3)
...
;; find__post_axiom
  ...
  (! (=> (dynamic_invariant1 item true true true)
     ...
     (and
     (=> (< 0 result)
     (and (<= result (length2 container)) (= item (get1 container result))))
...
;; elements__post_axiom
  ...
  (! (let ((result (elements container)))
     ...
     (= (contains (model__ container) (get1 result temp___429)) true))))
     (forall ((item Int))
...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant4 item true true true)
     ...
     (=>
     (exists ((e1 Int))
     (and (and (in_range4 e1) (= (contains container e1) true)) (= e1 item)))
...
(declare-const use_sets__my_contains__result Bool)

(declare-const o count_type)

(declare-const o1 count_type)

(declare-const temp___857 count_type)
...
(declare-const use_sets__my_contains__result1 Bool)

(declare-const use_sets__my_contains__result2 Bool)

(declare-const use_sets__my_contains__result3 Bool)

(declare-const use_sets__my_contains__result4 Bool)

(declare-const use_sets__my_contains__result5 Bool)
...
;; H
  (assert (= temp___857 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___857)) no_element))

;; H
  (assert (in_range2 e))

;; H
  (assert (= use_sets__my_contains__result1 use_sets__my_contains__result2))

;; H
  (assert (= use_sets__my_contains__result3 use_sets__my_contains__result1))
...
;; H
  ...
  (= (get (positions s) o5) (find (elements s) e))) (= (element s o5)
  e)))))
...
;; H
  (assert (= result use_sets__my_contains__result))

;; H
  (assert (= use_sets__my_contains__result1 o4))

;; H
  (assert
  (= (mk_bool__ref use_sets__my_contains__result4) (mk_bool__ref
                                                   use_sets__my_contains__result2)))

;; H
  (assert (= use_sets__my_contains__result5 use_sets__my_contains__result3))

;; H
  (assert (= result1 use_sets__my_contains__result4))

;; H
  (assert (= use_sets__my_contains__result4 true))

(assert
;; WP_parameter_def
 ;; File "use_sets.ads", line 15, characters 0-0
