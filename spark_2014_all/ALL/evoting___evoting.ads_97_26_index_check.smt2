...
(declare-const temp___699 (Array Int counter_range_t))

(declare-const temp___698 (Array Int character))
...
;; H
  ...
  (and
  (forall ((i1 Int))
  (=> (and (<= 0 i1) (<= i1 20)) (= (to_rep2 (select counters i1)) 0)))
  (= number_of_votes 0))))
...
;; H
  ...
  (and
  (forall ((i1 Int))
  (=> (and (<= (+ last_candidate 1) i1) (<= i1 20))
  (= (to_rep2 (select counters2 i1)) 0)))
  (and
  (and
  (and
