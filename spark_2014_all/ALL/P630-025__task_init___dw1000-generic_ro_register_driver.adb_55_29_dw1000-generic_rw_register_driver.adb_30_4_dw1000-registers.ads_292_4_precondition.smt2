...
(define-fun register_type__ref_57__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_41__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_41__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3387 us_t1)
  (temp___is_init_3384 Bool) (temp___skip_constant_3385 Bool)
  (temp___do_toplevel_3386 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3385 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_3387)
                                       (last3 temp___expr_3387))
                                       (and (= (first3 temp___expr_3387) 1)
                                       (= (last3 temp___expr_3387) 2)))))
