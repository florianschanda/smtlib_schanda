...
(declare-datatypes ()
((t771s__ref (mk_t771s__ref (t771s__content integer)))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___487 i1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___486 result__1)))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  ...
  (let ((temp___498 (- i9 1)))
  (ite (< temp___498 18446744073709551616)
  (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___498)) ((_ int2bv 64) 0))))
  (let ((temp___499 (- i9 1)))
  (ite (< temp___499 18446744073709551616)
  (bvshl ((_ int2bv 64) 1) ((_ int2bv 64) temp___499)) ((_ int2bv 64) 0))))))
(check-sat)
(exit)
