...
;; H
  ...
  (forall ((z4 Int))
  (=> (and (<= (to_rep a__first) z4) (<= z4 (to_rep a__last)))
  (=> (and (not (= z4 o14)) (not (= z4 o15)))
  (= (to_rep (select a2 z4)) (to_rep (select a z4)))))))))
  (= (to_rep a__first) 0))))
...
;; H
  ...
  (forall ((z4 Int))
  (=> (and (<= (to_rep a__first) z4) (<= z4 (to_rep a__last)))
  (=> (and (not (= z4 o26)) (not (= z4 o28)))
  (= (to_rep (select a8 z4)) (to_rep (select a6 z4)))))))))
  (= (to_rep a__first) 0))))
...
;; H
  ...
  (forall ((z4 Int))
  (=> (and (<= (to_rep a__first) z4) (<= z4 (to_rep a__last)))
  (=> (and (not (= z4 o33)) (not (= z4 o34)))
  (= (to_rep (select a11 z4)) (to_rep (select (map__content a9) z4)))))))))
  (= (to_rep a__first) 0))))
...
;; H
  (assert
  (=> (<= (to_rep a__first) (to_rep a__last))
  (= o40 (+ (- (to_rep a__last) (to_rep a__first)) 1))))

;; H
  (assert (=> (not (<= (to_rep a__first) (to_rep a__last))) (= o40 0)))
