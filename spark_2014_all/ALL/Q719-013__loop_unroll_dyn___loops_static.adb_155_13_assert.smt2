...
;; H
  (assert (=> (not (= i1 1)) (= (mk_int__ref result4) j12)))

;; H
  (assert (=> (not (= i1 1)) (= j2 (to_rep1 a__first))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= temp___361 bad1))))
...
;; H
  ...
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1))
  (and (<= (to_rep1 a__first) j3) (<= j3 (to_rep1 a__last))))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o3 j3))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o4 (select a1 o3)))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o5 (to_rep o4)))))
...
;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j3 i1))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j3 j4))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= bad4 bad5))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j5 j3))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= bad6 bad4))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j11 (mk_int__ref j4)))))
...
;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j7 j5))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= bad8 bad6))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= j2 j6))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= bad1 bad7))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= j7 j2))))

;; H
  (assert
  (=> (not (= i1 1))
  (=> (not (and (<= (to_rep1 a__first) j2) (<= j2 i1))) (= bad8 bad1))))

;; H
  (assert (=> (not (= i1 1)) (= j10 j11)))

;; H
  (assert (=> (not (= i1 1)) (= (mk_bool__ref bad9) bad11)))

;; H
  (assert (=> (not (= i1 1)) (= j9 j7)))
