...
(declare-fun temp___275 () Bool)

(declare-fun temp___2751 () integer)

(declare-fun temp___2752 () failure_reason)

(declare-fun temp___2753 () Bool)
...
;; H
  (assert (= (of_int 0) temp___275))

;; H
  (assert (= temp___2751 o1))

;; H
  (assert (= temp___2752 o2))

;; H
  (assert (= true temp___2753))
...
;; WP_parameter_def
 ;; File "test.adb", line 96, characters 0-0
  (not (= temp___275 x__split_discrs)))
(check-sat)
(exit)
