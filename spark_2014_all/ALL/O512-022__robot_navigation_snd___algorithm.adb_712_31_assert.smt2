...
(declare-fun usq_ () us_rep7)

(declare-fun temp___962 () us_rep7)
...
(declare-fun result2 () us_split_fields__ref7)

(declare-fun pbestvalley__split_fields1 () us_split_fields14)

(declare-fun result3 () us_split_discrs__ref1)
...
;; H
  (assert
  (= temp___962 (mk___rep7 (us_split_discrs3 usq_) (us_split_fields15 usq_)
