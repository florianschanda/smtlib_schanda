...
(declare-fun r91 () (_ BitVec 64))

(declare-fun r92 () (_ BitVec 64))

(declare-fun r93 () (_ BitVec 64))
...
;; H
  (assert
  (= r91 (bvor (bvand r9 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56)
  val__))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= r92 (bvor (bvand r9 ((_ int2bv 64) 18446744073709551360)) ((_ zero_extend 56)
  val__)))))
(check-sat)
(exit)
