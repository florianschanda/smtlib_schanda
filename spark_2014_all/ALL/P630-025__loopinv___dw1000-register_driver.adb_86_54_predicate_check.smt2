...
(declare-fun temp___741 () bits_6)

(declare-fun temp___7411 () sub_index_type)

(declare-fun temp___7412 () operation_type)

(declare-fun temp___7413 () bits_7)

(declare-fun temp___7414 () extended_address_type)

(declare-fun temp___7415 () bits_8)

(declare-fun dw1000__register_driver__read_register__B_3__header__assume () bits_6)

(declare-fun dw1000__register_driver__read_register__B_3__header__assume1 () sub_index_type)

(declare-fun dw1000__register_driver__read_register__B_3__header__assume2 () operation_type)

(declare-fun dw1000__register_driver__read_register__B_3__header__assume3 () bits_7)

(declare-fun dw1000__register_driver__read_register__B_3__header__assume4 () extended_address_type)

(declare-fun dw1000__register_driver__read_register__B_3__header__assume5 () bits_8)

(define-fun dw1000__register_driver__read_register__B_3__header__assume6 () us_rep2
  (mk___rep2
  (mk___split_fields2
  dw1000__register_driver__read_register__B_3__header__assume
  dw1000__register_driver__read_register__B_3__header__assume1
  dw1000__register_driver__read_register__B_3__header__assume2
  dw1000__register_driver__read_register__B_3__header__assume3
  dw1000__register_driver__read_register__B_3__header__assume4
...
;; H
  (assert
  (= (to_rep3 o) ((_ extract 7 0) (bvudiv sub_address ((_ int2bv 16) 128)))))
...
;; H
  (assert
  (= (to_rep2 o2) ((_ extract 7 0) (bvand sub_address ((_ int2bv 16) 127)))))
...
;; H
  (assert (= temp___741 o6))

;; H
  (assert (= temp___7411 o7))

;; H
  (assert (= temp___7412 o8))

;; H
  (assert (= temp___7413 o9))

;; H
  (assert (= temp___7414 o10))

;; H
  (assert (= temp___7415 o11))

;; H
  (assert (and (= (to_rep5 temp___7411) 1) (= (to_rep6 temp___7414) 1)))

;; H
  (assert
  (= dw1000__register_driver__read_register__B_3__header__assume6 (mk___rep2
                                                                  (mk___split_fields2
                                                                  temp___741
                                                                  temp___7411
                                                                  temp___7412
...
;; H
  (assert
  (= dw1000__register_driver__read_register__B_3__header__assume6 header2))
