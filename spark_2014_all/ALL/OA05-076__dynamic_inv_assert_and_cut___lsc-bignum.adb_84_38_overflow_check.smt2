...
;; H
  (assert (and (= o6 (+ b_first i2)) (in_range1 (+ b_first i2))))

;; H
  (assert (= o7 (- o6 a_first)))
...
;; H
  (assert (= o12 (ite (<= b_first k) o11 false)))

;; H
  (assert (= result1 (ite (not (= o12 true)) true false)))
...
;; H
  (assert (=> (= result1 true) (= o15 k)))

;; H
  (assert (=> (= result1 true) (= o16 (select b o15))))

;; H
  (assert (=> (= result1 true) (= o17 (to_rep1 o16))))
...
;; H
  (assert (=> (= result1 true) (= o13 k)))

;; H
  (assert (=> (= result1 true) (= o14 (select b1 o13))))

;; H
  (assert (=> (= result1 true) (= o18 (to_rep1 o14))))

;; H
  (assert (=> (= result1 true) (= o19 (ite (= o18 o17) true false))))
