...
;; H
  (assert (=> (not (= result7 true)) (= o20 med2)))

;; H
  (assert (=> (not (= result7 true)) (= o21 (select (elts a) o20))))

;; H
  (assert (=> (not (= result7 true)) (= o22 (to_rep o21))))

;; H
  (assert (=> (not (= result7 true)) (= result9 (ite (< i o22) true false))))
...
;; H
  (assert
  (=> (not (= result7 true)) (and (= o23 (- med2 1)) (in_range3 (- med2 1)))))

;; H
  (assert (=> (not (= result7 true)) (= right2 result10)))

;; H
  (assert (=> (not (= result7 true)) (= right3 o23)))
