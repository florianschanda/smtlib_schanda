...
;; H
  ...
  (ite (< k q2) (= (to_rep1 (select h1 k)) (to_rep1 (select h (+ k m1))))
  (ite (< (+ q2 m1) k)
  (= (to_rep1 (select h1 k)) (to_rep1 (select h (- k m1))))
  (= (to_rep1 (select h1 k)) (to_rep1 (select h k))))))))
...
;; H
  ...
  r30b q2)) (=> (<= (- 2147483648) 2147483647) (in_range2 t2)))
...
;; H
  (assert (and (= temp___476 (+ q2 m1)) (in_range1 (+ q2 m1))))
...
;; H
  (assert (= o3 temp___476))

;; H
  (assert (= o4 (select h1 o3)))
...
;; H
  (assert (= (to_rep1 o9) t3))

;; H
  (assert (and (= temp___477 (+ q2 m1)) (in_range1 (+ q2 m1))))

(assert
;; WP_parameter_def
 ;; File "infoflow.ads", line 114, characters 0-0
  (not (<= (to_rep h__first) temp___477)))
(check-sat)
(exit)
