...
(declare-const temp___252 Bool)

(declare-const temp___2521 integer)

(declare-const temp___2522 Bool)

(declare-const result____split_fields1 integer)

(declare-const result____split_discrs1 Bool)
...
(declare-const result____split_discrs2 Bool)

(declare-const i2 Int)

(declare-const result____split_fields3 integer)

(declare-const result____split_discrs3 Bool)

(declare-const result____split_fields4 us_split_fields__ref)

(declare-const result____split_discrs4 us_split_discrs__ref)
...
(declare-const result____split_discrs6 us_split_discrs__ref)
