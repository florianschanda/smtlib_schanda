...
(declare-datatypes ()
((us_split_discrs (mk___split_discrs (rec__p__search_result__found Bool)))))
...
(declare-fun p__search_result__found__first__bit () Int)

(declare-fun p__search_result__found__last__bit () Int)

(declare-fun p__search_result__found__position () Int)
...
(declare-fun p__search_result__content__first__bit () Int)

(declare-fun p__search_result__content__last__bit () Int)

(declare-fun p__search_result__content__position () Int)
...
(declare-fun p__search_result__found__first__bit1 () Int)

(declare-fun p__search_result__found__last__bit1 () Int)

(declare-fun p__search_result__found__position1 () Int)
...
(declare-fun p__search_result__content__first__bit1 () Int)

(declare-fun p__search_result__content__last__bit1 () Int)

(declare-fun p__search_result__content__position1 () Int)
...
(declare-fun p__search_result__found__first__bit2 () Int)

(declare-fun p__search_result__found__last__bit2 () Int)

(declare-fun p__search_result__found__position2 () Int)
...
(declare-fun p__search_result__content__first__bit2 () Int)

(declare-fun p__search_result__content__last__bit2 () Int)

(declare-fun p__search_result__content__position2 () Int)
...
(declare-datatypes () ((t22b__ref (mk_t22b__ref (t22b__content us_rep)))))
...
(declare-fun result____split_discrs () Bool)

(declare-fun i () Int)

(declare-fun temp___252 () Bool)

(declare-fun temp___2521 () integer)

(declare-fun temp___2522 () Bool)

(declare-fun result____split_fields1 () integer)

(declare-fun result____split_discrs1 () Bool)
...
(declare-fun result____split_discrs2 () Bool)

(declare-fun i2 () Int)

(declare-fun result____split_fields3 () integer)

(declare-fun result____split_discrs3 () Bool)

(declare-fun result____split_fields4 () us_split_fields__ref)

(declare-fun result____split_discrs4 () us_split_discrs__ref)
...
(declare-fun result____split_discrs6 () us_split_discrs__ref)
...
(define-fun result____split_discrs8 () us_split_discrs (mk___split_discrs
                                                       result____split_discrs3))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (and (= temp___252 result____split_discrs)
  (and (= temp___2521 result____split_fields)
  (= temp___2522 result____attr__constrained)))))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (not (= (to_rep1 (select (elts a) i2)) e))))

;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (= result____split_discrs8 (mk___split_discrs result____split_discrs2))))

;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (= result____split_fields8 (mk___split_fields result____split_fields2))))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (= result____split_discrs4 (mk___split_discrs__ref result____split_discrs8))))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (= result____split_discrs5 result____split_discrs8)))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (= result____split_discrs6 result____split_discrs4)))
...
;; H
  (assert
  (=> (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a)))))
  (= result____split_discrs7 result____split_discrs5)))
...
;; H
  (assert
  (=>
  (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))))
  (= i5 (mk_int__ref i1))))
...
;; H
  ...
  (=>
  (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))))
  (= result____split_discrs6 (mk___split_discrs__ref
                             (mk___split_discrs result____split_discrs)))))
...
;; H
  ...
  (=>
  (not (and (<= (to_rep (first (rt a))) i1) (<= i1 (to_rep (last (rt a))))))
  (= result____split_discrs7 (mk___split_discrs result____split_discrs1))))
...
;; H
  (assert
  (= (rec__p__search_result__found
     (us_split_discrs__content result____split_discrs6)) r21b))
...
;; WP_parameter_def
 ;; File "p.adb", line 28, characters 0-0
  (not
  (= (of_int 0) (rec__p__search_result__found
                (us_split_discrs__content result____split_discrs6)))))
(check-sat)
(exit)
