...
;; H
  (assert
  (forall ((lo_index1 Int))
  (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1)))
  ...
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index1)))) max_sum2))))))
...
;; H
  ...
  (<= (sum__logic x
      (mk_slice_bounds
      (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index1)))) max_sum3)))))
  (forall ((hi_index1 Int))
...
;; H
  (assert (and (= o6 (- hi2 1)) (in_range1 (- hi2 1))))

;; H
  (assert (= o7 (ite (<= hi_index o6) true false)))

;; H
  (assert (= result4 (ite (<= (to_rep3 (first (rt x))) hi_index) o7 false)))
...
;; H
  (assert (and (= o4 (- lo2 1)) (in_range1 (- lo2 1))))

;; H
  (assert (= o5 (ite (<= lo_index o4) true false)))

;; H
  (assert (= result5 (ite (<= (to_rep3 (first (rt x))) lo_index) o5 false)))
