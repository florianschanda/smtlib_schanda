...
(declare-fun temp___240 () integer)

(declare-fun temp___2401 () natural)

(declare-fun temp___2402 () my_range)

(declare-fun temp___2403 () integer)
...
;; H
  (assert
  (and (= o6 (- (to_rep1 r__split_fields6) 1)) (in_range2
...
;; H
  (assert (= temp___240 o8))

;; H
  (assert (= temp___2401 o9))

;; H
  (assert (= temp___2402 o10))

;; H
  (assert (= temp___2403 o11))
...
;; H
  (assert (= temp___240 r__split_fields8))

;; H
  (assert (= temp___2401 r__split_fields9))

;; H
  (assert (= temp___2402 r__split_fields10))

;; H
  (assert (= temp___2403 r__split_fields11))
...
;; WP_parameter_def
 ;; File "records.ads", line 28, characters 0-0
  ...
  (= (bool_eq
     ...
     r__split_fields15))
     (mk___rep
     (mk___split_fields (of_rep (+ (to_rep r__split_fields) 1))
     r__split_fields1 (of_rep1 (- (to_rep1 r__split_fields2) 1))
