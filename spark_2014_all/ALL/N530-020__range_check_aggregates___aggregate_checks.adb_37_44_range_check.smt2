...
(define-fun a_range__ref_4__projection ((a1 a_range__ref)) integer (a_range__content
                                                                   a1))
...
(declare-datatypes ()
((uarray__ref (mk_uarray__ref (uarray__content us_t1)))))
(define-fun uarray__ref___projection ((a1 uarray__ref)) us_t1 (uarray__content
                                                              a1))

(define-fun dynamic_invariant1 ((temp___expr_245 us_t1)
...
(define-fun t15b__ref___projection ((a1 t15b__ref)) integer (t15b__content
                                                            a1))
...
(declare-fun should_fail3 () us_t1)
...
;; def_axiom
  ...
  (let ((temp___142 (aggregate_checks__do_wrong_aggregate_4__should_fail3__aggregate_def
...
;; H
  (assert (<= 0 (to_rep (last (rt a)))))

(assert
;; WP_parameter_def
 ;; File "aggregate_checks.adb", line 24, characters 0-0
  (not (<= first2 0)))
(check-sat)
(exit)
