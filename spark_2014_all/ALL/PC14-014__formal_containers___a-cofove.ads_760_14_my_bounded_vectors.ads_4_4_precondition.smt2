...
(define-fun dynamic_invariant ((temp___expr_682 Int)
...
(define-fun dynamic_invariant2 ((temp___expr_694 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_700 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_721 Int)
