...
;; H
  ...
  (=>
  (and (<= 1 i)
  (<= i (- (get2 (positions (mk___rep s__split_discrs s__split_fields2))
           (mk___rep1 cu__split_fields3)) 1)))
  (= (get (model__ (mk___rep s__split_discrs s__split_fields2))
     (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i)) (f
                                                                  (get
                                                                  (model__
                                                                  (mk___rep
                                                                  s__split_discrs
...
;; H
  ...
  (<= (get2 (positions (mk___rep s__split_discrs s__split_fields2))
      (mk___rep1 cu__split_fields3)) i)
  (<= i (length (mk___rep s__split_discrs s__split_fields2))))
  (= (get
     (model__ (mk___rep s__split_discrs (mk___split_fields s__split_fields)))
     (get1 (keys (mk___rep s__split_discrs s__split_fields2)) i)) (get
                                                                  (model__
                                                                  (mk___rep
                                                                  s__split_discrs
                                                                  s__split_fields2))
...
;; H
  (assert
  (and
  (= o1 (element (mk___rep s__split_discrs s__split_fields2)
        (mk___rep1 cu__split_fields3)))
  (and (in_range8 o1)
  (= o1 (get (model__ (mk___rep s__split_discrs s__split_fields2))
        (key (mk___rep s__split_discrs s__split_fields2)
        (mk___rep1 cu__split_fields3)))))))
...
;; H
  (assert
  (and
  (= o (key (mk___rep s__split_discrs s__split_fields2)
       (mk___rep1 cu__split_fields3)))
  (and (in_range7 o)
  (= o (get1 (keys (mk___rep s__split_discrs s__split_fields2))
       (get2 (positions (mk___rep s__split_discrs s__split_fields2))
       (mk___rep1 cu__split_fields3)))))))
...
;; WP_parameter_def
 ;; File "a-cofuma.ads", line 84, characters 0-0
  (not
  (or
  (< (length (mk___rep s__split_discrs s__split_fields2)) (to_rep1
                                                          (rec__use_maps__my_maps__map__capacity
                                                          s__split_discrs)))
  (= (has_key (model__ (mk___rep s__split_discrs s__split_fields2)) o) true))))
(check-sat)
(exit)
