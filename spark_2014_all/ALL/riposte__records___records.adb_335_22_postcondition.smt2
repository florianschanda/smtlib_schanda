...
(declare-fun x__split_fields6 () Bool)

(declare-fun x__split_fields7 () unsigned_byte)

(declare-fun x__split_fields8 () unsigned_byte)

(declare-fun x__split_fields9 () Bool)

(declare-fun x__split_fields10 () unsigned_byte)
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 19, characters 0-0
  ...
  (= (bool_eq1
     (mk___rep1
     (mk___split_fields1 x__split_fields6
     (mk___rep (mk___split_fields x__split_fields7 x__split_fields8))))
     (mk___rep1
     (mk___split_fields1 x__split_fields
     (mk___rep (mk___split_fields x__split_fields2 x__split_fields2))))) true)))
(check-sat)
(exit)
