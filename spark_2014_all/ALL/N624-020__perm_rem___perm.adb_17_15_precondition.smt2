...
;; H
  ...
  (and (= result1 (is_perm o30 o29))
  (= (= result1 true)
  (or (and (= (length o30) 0) (= (length o29) 0))
  (exists ((ia1 Int))
  ...
  (= (is_perm (remove o30 ia1) (remove o29 ib10)) true)))))))))))
  (= result1 false)))
  (and (= result1 true)
  ...
  (and (= o27 (remove b o11))
  (and (dynamic_invariant1 o27 true false true)
  ...
  (and (= result5 (is_perm o28 o27))
  (= (= result5 true)
  (or (and (= (length o28) 0) (= (length o27) 0))
  (exists ((ia1 Int))
  ...
  (= (is_perm (remove o28 ia1) (remove o27 ib10)) true)))))))))))
  (= result5 false)))
  (and (= result5 true)
...
;; H
  (assert
  (and (= o26 (remove b (int__content perm__get_witness__result9)))
  (and (dynamic_invariant1 o26 true false true)
  (and (= (invariant__ o26) true)
  (and (= (to_rep1 (last o19)) (- (to_rep1 (last (rt b))) 1))
  (and
  (forall ((k Int))
