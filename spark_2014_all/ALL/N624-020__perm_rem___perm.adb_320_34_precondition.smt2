...
;; H
  ...
  (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt c))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- ic 1)))
  (= (to_rep2 (select (elts c) k)) (to_rep2 (select o k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ ic 1) k) (<= k (to_rep1 (last (rt c)))))
  (= (to_rep2 (select (elts c) k)) (to_rep2 (select o (- k 1))))))
  (forall ((k Int))
  (=> (and (<= ic k) (<= k (- (to_rep1 (last (rt c))) 1)))
  (= (to_rep2 (select (elts c) (+ k 1))) (to_rep2 (select o k))))))))))))
