...
(declare-const test__f1__result Int)

(declare-const result Int)

(declare-const test__f1__result1 Int)

(declare-const test__f1__result2 Int)

(declare-const test__f1__result3 Int)

(declare-const test__f1__result4 Int)

(declare-const test__f1__result5 Int)

(declare-const result1 Int)

;; H
  (assert (< 10 (to_rep (rec__test__t__a (us_split_fields1 x)))))

;; H
  (assert (= test__f1__result1 test__f1__result2))

;; H
  (assert (= test__f1__result3 test__f1__result1))

;; H
  (assert (= result test__f1__result))

;; H
  (assert
  (= test__f1__result1 (to_rep (rec__test__t__a (us_split_fields1 x)))))

;; H
  (assert
  (= (mk_int__ref test__f1__result4) (mk_int__ref test__f1__result2)))

;; H
  (assert (= test__f1__result5 test__f1__result3))

;; H
  (assert (= result1 test__f1__result4))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (< 10 test__f1__result4)))
(check-sat)
(exit)
