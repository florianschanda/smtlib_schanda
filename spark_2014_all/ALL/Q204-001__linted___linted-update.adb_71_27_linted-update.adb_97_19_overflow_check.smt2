...
(define-fun y9 () t__ref1 (mk_t__ref1 y2))

(define-fun y10 () t__ref1 (mk_t__ref1 y1))
...
;; H
  (assert (=> (not (< c206b 0)) (= y4 o5)))

;; H
  (assert (=> (not (< c206b 0)) (= y3 y4)))
...
;; H
  (assert (=> (< c216b 0) (= result3 y10)))

;; H
  (assert (=> (< c216b 0) (= y5 o9)))
...
;; H
  (assert (=> (not (< c216b 0)) (= result4 y10)))

;; H
  (assert (=> (not (< c216b 0)) (= y6 o11)))

;; H
  (assert (=> (not (< c216b 0)) (= y5 y6)))
...
;; H
  (assert (=> (< c226b 0) (= result6 y9)))

;; H
  (assert (=> (< c226b 0) (= y7 o15)))
...
;; H
  (assert (=> (not (< c226b 0)) (= result7 y9)))

;; H
  (assert (=> (not (< c226b 0)) (= y8 o17)))

;; H
  (assert (=> (not (< c226b 0)) (= y7 y8)))
...
;; WP_parameter_def
 ;; File "linted-update.ads", line 41, characters 0-0
  (not (in_range2 (- c236b (- 2147483648)))))
(check-sat)
(exit)
