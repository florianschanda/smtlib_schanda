...
(declare-fun first_block__first () integer)

(declare-fun first_block__last () integer)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun num_used_bits () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun max_bit_length () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS2 () Int)

(declare-fun next_block__first () integer)

(declare-fun next_block__last () integer)
...
;; H
  (assert
  (=> (<= (to_rep first_block__first) (to_rep first_block__last))
  (= o1 (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep first_block__first) (to_rep first_block__last)))
  (= o1 0)))

;; H
  (assert
  (=> (<= (to_rep next_block__first) (to_rep next_block__last))
  (= o2 (+ (- (to_rep next_block__last) (to_rep next_block__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep next_block__first) (to_rep next_block__last)))
  (= o2 0)))

;; H
  (assert (= result (ite (= o2 o1) true false)))
...
;; H
  (assert
  (=> (<= (to_rep first_block__first) (to_rep first_block__last))
  (= o (+ (- (to_rep first_block__last) (to_rep first_block__first)) 1))))
