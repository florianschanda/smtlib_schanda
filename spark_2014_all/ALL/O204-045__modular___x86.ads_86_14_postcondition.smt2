...
(declare-fun x86__cl__result () (_ BitVec 8))

(declare-fun result () (_ BitVec 8))

(declare-fun x86__cl__result1 () (_ BitVec 8))

(declare-fun x86__cl__result2 () (_ BitVec 8))

(declare-fun x86__cl__result3 () (_ BitVec 8))

(declare-fun x86__cl__result4 () (_ BitVec 8))

(declare-fun x86__cl__result5 () (_ BitVec 8))
...
;; H
  (assert
  (= x86__cl__result1 ((_ extract 7 0) (bvand rcx ((_ int2bv 64) 255)))))
...
;; H
  (assert (= result1 x86__cl__result4))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 10, characters 0-0
  (not
  (= x86__cl__result4 ((_ extract 7 0) (bvand rcx ((_ int2bv 64) 255))))))
(check-sat)
(exit)
