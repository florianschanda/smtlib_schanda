...
;; H
  (assert
  (=> (not (= first_available 0)) (= result3 (ite (< 0 o12) true false))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true)
  (and (= o11 (get model____split_fields 1)) (in_range7 o11)))))

;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result3 true) (= result2 (ite (= o11 first_available) true false)))))
...
;; H
  ...
  (and (= o13 (length model____split_fields)) (in_range6 o13))))

;; H
  (assert
  (=> (not (not (= first_available 0)))
  (= result2 (ite (= o13 0) true false))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (and (= o9 (length model____split_fields1)) (in_range6 o9)))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o9) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result4 true)
  (and (= o8 (get model____split_fields1 1)) (in_range7 o8))))))

;; H
  (assert
  (=> (= result2 true)
  (=> (not (= first_allocated 0))
  (=> (= result4 true) (= result1 (ite (= o8 first_allocated) true false))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= o6 (length model____split_fields)) (in_range6 o6))))
...
;; H
  (assert (and (= o5 (get model____split_fields1 j)) (in_range7 o5)))

;; H
  (assert (= result7 (ite (in_range4 o5) true false)))
...
;; H
  (assert
  (=> (= result8 true)
  (and (= o4 (get model____split_fields1 o3)) (in_range7 o4))))
