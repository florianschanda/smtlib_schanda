...
(declare-fun temp___627 () (Array Int cardindex))

(declare-fun o111 () Int)

(declare-fun temp___629 () (Array Int cardindex))

(declare-fun o112 () Int)

(declare-fun o113 () cardindex)
...
;; H
  (assert (= result22 (ite (<= 0 j) o109 false)))
...
;; H
  (assert
  (= temp___629 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20))
  o111)))
...
;; H
  (assert (= o113 (select temp___629 o112)))

;; H
  (assert (= o114 (to_rep1 o113)))

;; H
  (assert
  (= o115 (ite (< o114 (to_rep1
                       (rec__patience__state__numelts
                       (us_split_fields__content s__split_fields20))))
          true false)))
...
;; H
  (assert
  (= temp___627 (select (rec__patience__state__stacks
                        (us_split_fields__content s__split_fields20))
  o110)))
