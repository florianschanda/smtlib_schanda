...
(define-fun dynamic_invariant5 ((temp___expr_182 Int)
...
;; H
  ...
  (forall ((temp___286 Int) (temp___287 Int))
  (=>
  (and
  (and (<= (to_rep1 lengths__first) temp___286)
  (<= temp___286 (to_rep1 lengths__last)))
  (and (<= (to_rep1 lengths__first_2) temp___287)
  (<= temp___287 (to_rep1 lengths__last_2)))) (dynamic_property3 0 last4
...
(assert
;; WP_parameter_def
 ;; File "string_utilities.adb", line 10, characters 0-0
