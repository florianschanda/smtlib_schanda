...
;; H
  (assert (not (= currentdoor newdoor1)))

;; H
  (assert (=> (= newdoor1 1) (= (mk_int__ref result) id3)))

;; H
  (assert (=> (= newdoor1 1) (= id1 6)))

;; H
  (assert (=> (not (= newdoor1 1)) (= (mk_int__ref result1) id3)))

;; H
  (assert (=> (not (= newdoor1 1)) (= id2 7)))

;; H
  (assert (=> (not (= newdoor1 1)) (= id1 id2)))
