...
(declare-fun a__split_fields () (Array Int natural))

(declare-fun first__split_fields () natural)
...
(declare-fun temp___222 () natural)

(declare-fun temp___2221 () natural)

(declare-fun with_iterable__set_to_0__first__assume () us_rep1)
...
(declare-fun temp___225 () us_rep)

(declare-fun result () us_split_fields__ref1)

(declare-fun first__split_fields1 () us_split_fields2)

(declare-fun result1 () us_split_fields__ref)

(declare-fun a__split_fields1 () us_split_fields)

(declare-fun a__split_fields2 () us_split_fields__ref)

(declare-fun first__split_fields2 () us_split_fields__ref1)

(declare-fun a__split_fields3 () us_split_fields)

(declare-fun first__split_fields3 () us_split_fields2)
