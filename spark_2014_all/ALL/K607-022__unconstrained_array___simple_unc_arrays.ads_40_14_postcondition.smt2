...
(declare-fun simple_unc_arrays__min__result () Int)
...
(declare-fun temp___850 () Int)

(declare-fun temp___849 () Int)
...
(declare-fun simple_unc_arrays__min__result1 () Int)

(declare-fun simple_unc_arrays__min__result2 () Int)

(declare-fun simple_unc_arrays__min__result3 () Int)

(declare-fun res8 () Int)

(declare-fun i7 () Int)

(declare-fun simple_unc_arrays__min__result4 () Int)

(declare-fun res9 () Int)

(declare-fun i8 () Int)

(declare-fun simple_unc_arrays__min__result5 () Int)
...
;; H
  (assert (= result5 simple_unc_arrays__min__result4))
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 4, characters 0-0
  (not
  (<= simple_unc_arrays__min__result4 (to_rep1
                                      (select (elts
                                              (rec__simple_unc_arrays__table__v
                                              (us_split_fields1 a)))
                                      j)))))
