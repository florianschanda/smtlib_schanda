...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__r__pt1 us_main_type)))))
...
(declare-fun r__pt__x__first__bit1 () Int)

(declare-fun r__pt__x__last__bit1 () Int)

(declare-fun r__pt__x__position1 () Int)
...
(declare-fun r__pt__y__first__bit1 () Int)

(declare-fun r__pt__y__last__bit1 () Int)

(declare-fun r__pt__y__position1 () Int)
...
(declare-fun r__pt__z__first__bit1 () Int)

(declare-fun r__pt__z__last__bit1 () Int)

(declare-fun r__pt__z__position1 () Int)
