...
(declare-fun temp___2901 () integer)

(declare-fun temp___2902 () failure_reason)

(declare-fun temp___2903 () Bool)
...
;; H
  (assert (= (of_int 0) temp___290))

;; H
  (assert (= temp___2901 o1))

;; H
  (assert (= temp___2902 o2))

;; H
  (assert (= true temp___2903))
...
;; WP_parameter_def
 ;; File "test.adb", line 135, characters 0-0
  (not (= temp___290 x__split_discrs)))
(check-sat)
