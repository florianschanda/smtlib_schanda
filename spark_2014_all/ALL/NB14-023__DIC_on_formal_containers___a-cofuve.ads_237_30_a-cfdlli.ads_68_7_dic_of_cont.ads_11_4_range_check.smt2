...
(define-fun dynamic_invariant ((temp___expr_350 Int)
...
(define-fun dynamic_invariant1 ((temp___expr_362 Int)
...
(define-fun default_initial_assumption ((temp___expr_369 us_rep)
  (temp___skip_top_level_370 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_370 true))
                                         (= (length temp___expr_369) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_356 Int)
