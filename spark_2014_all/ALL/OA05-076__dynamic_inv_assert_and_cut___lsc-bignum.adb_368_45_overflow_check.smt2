...
;; H
  (assert (= o81 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (= o79 (num_of_big_int m m_first o78)))

;; H
  (assert (= o74 (from_word32 ((_ int2bv 32) 2))))

;; H
  (assert (= o80 (omultiply o74 o79)))

;; H
  (assert (= o82 (osubtract o80 o81)))

;; H
  (assert (= o71 (from_word32 a_msw3)))
...
;; H
  (assert
  (and (= o65 (base Tuple0))
  (= o65 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))

;; H
  (assert (= o70 (oexpon o65 o69)))

;; H
  (assert (= o72 (omultiply o70 o71)))
...
;; H
  (assert
  (= o64 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o63)))

;; H
  (assert (= o73 (oadd o64 o72)))

;; H
  (assert (= o83 (olt o73 o82)))
...
;; H
  (assert (and (= o50 (+ i2 1)) (in_range1 (+ i2 1))))

;; H
  (assert (= o51 (- o50 a_first)))
...
;; H
  (assert (= o49 (inverse o47 o48)))

;; H
  (assert (= o54 (oexpon o49 o53)))
...
;; H
  (assert (= o42 (num_of_big_int c c_first o41)))
