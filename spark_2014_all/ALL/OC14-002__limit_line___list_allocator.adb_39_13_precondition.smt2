...
;; H
  (assert
  (=> (not (= first_available 0))
  (=> (= result2 true) (= result1 (ite (= o5 first_available) true false)))))
...
;; H
  ...
  (and (= o7 (length model____split_fields)) (in_range6 o7))))
...
;; H
  ...
  (and (= o3 (length model____split_fields1)) (in_range6 o3)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o3) true false)))))
...
;; H
  ...
  (=> (not (= first_allocated 0))
  (=> (= result3 true)
  (and (= o2 (get model____split_fields1 1)) (in_range7 o2))))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (= first_allocated 0))
  (=> (= result3 true) (= result (ite (= o2 first_allocated) true false))))))
...
;; H
  ...
  (and (= o4 (length model____split_fields1)) (in_range6 o4)))))

;; H
  (assert
  (=> (= result1 true)
  (=> (not (not (= first_allocated 0))) (= result (ite (= o4 0) true false)))))
