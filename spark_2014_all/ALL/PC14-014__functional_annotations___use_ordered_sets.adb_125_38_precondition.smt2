...
;; H
  ...
  (= (bool_eq1 use_ordered_sets__move_3__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2))))
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2))
     (get
     (elements
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1)) true))))
...
;; H
  ...
  (=>
  (and (in_range3 e1)
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields2)) e1) true))
  (exists ((i1 Int))
  (and
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s2__split_discrs s2__split_fields2))))
  (= (get
     (elements
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) i1) e1))))))
...
;; H
  (assert
  (and (= temp___772 (model__ (mk___rep s2__split_discrs s2__split_fields2)))
  (= (length4 temp___772) (length
                          (mk___rep s2__split_discrs s2__split_fields2)))))

;; H
  (assert
  (and (= o (contains temp___772 e))
  (=> (= (of_int 1) true)
  (=>
  (exists ((e1 Int))
  (and (and (in_range3 e1) (= (contains temp___772 e1) true))
  (= (equivalent_elements e1 e) true))) (= o true)))))
...
;; H
  (assert
  (and (= o2 (length (mk___rep s2__split_discrs s2__split_fields2)))
  (and (in_range2 o2)
  (<= o2 (to_rep
...
;; H
  ...
  (=> (and (in_range5 temp___390) (= (iter_has_element o4 temp___390) true))
  (= (contains
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
     (get o4 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range3 item)
  (= (contains
     (model__
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields))) item) true))
  (and (< 0 (find o4 item))
  (= (equivalent_elements (get o4 (find o4 item)) item) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length
         (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))))
  (and (= (find o4 (get o4 i1)) i1) (= (e_is_find o4 (get o4 i1) i1) true)))))))
