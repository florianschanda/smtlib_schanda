...
;; H
  (assert (not (fp.lt a (fp #b0 #b00000000 #b00000000000000000000000))))

;; H
  (assert (not (fp.eq a (fp #b0 #b00000000 #b00000000000000000000000))))

(assert
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) a)))
(check-sat)
(exit)
