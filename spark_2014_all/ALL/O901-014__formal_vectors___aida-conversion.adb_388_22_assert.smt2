...
(define-fun tint_arrayD1__ref___4__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___4__projection ((a tint_arrayT__ref)) us_t1
...
(define-fun tnumber_array_typeD1__ref___4__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___4__projection ((a number_array_type__ref)) us_t3
...
(define-fun tint_arrayB__ref___4__projection ((a tint_arrayB__ref)) us_t5
...
;; def_axiom
  (assert
  (forall ((temp___1284 Int) (temp___1285 Int) (temp___1286 Int)
  ...
  (temp___1295 Int))
  (let ((temp___1283 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def
                     temp___1284 temp___1285 temp___1286 temp___1287
                     temp___1288 temp___1289 temp___1290 temp___1291
                     temp___1292 temp___1293 temp___1294 temp___1295)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1294
  temp___1295)
  (and (= (first5 temp___1283) temp___1294)
  (= (last5 temp___1283) temp___1295)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1283) (+ (first1 source) 0)) (of_rep1
                                                            temp___1284))
  (= (select (to_array2 temp___1283) (+ (first1 source) 1)) (of_rep1
                                                            temp___1285)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 2)) (of_rep1
                                                            temp___1286)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 3)) (of_rep1
                                                            temp___1287)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 4)) (of_rep1
                                                            temp___1288)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 5)) (of_rep1
                                                            temp___1289)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 6)) (of_rep1
                                                            temp___1290)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 7)) (of_rep1
                                                            temp___1291)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 8)) (of_rep1
                                                            temp___1292)))
  (= (select (to_array2 temp___1283) (+ (first1 source) 9)) (of_rep1
                                                            temp___1293)))))))
...
(define-fun tnumber_array_typeB__ref___4__projection ((a tnumber_array_typeB__ref)) us_t6
...
;; def_axiom
  (assert
  (forall ((temp___1301 Int) (temp___1302 Int) (temp___1303 Int))
  (let ((temp___1300 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def
                     temp___1301 temp___1302 temp___1303)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1302
  temp___1303)
  (and (= (first9 temp___1300) temp___1302)
  (= (last9 temp___1300) temp___1303)))
  (forall ((temp___1304 Int))
  (= (select (to_array4 temp___1300) temp___1304) (of_rep1 temp___1301)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_221 us_t3)
  ...
  (temp___do_toplevel_220 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first7 temp___expr_221)
                                      (last7 temp___expr_221))
                                      (and
                                      (= (first7 temp___expr_221) (first1
                                                                  source))
                                      (= (last7 temp___expr_221) (+ (first1
                                                                    source) 9))))))
...
;; H
  (assert
  (= (mk___t2 temp___1298 temp___12981) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def
                                        2 1 4 7 4 8 2 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___12981)) (to_rep1 (last4 temp___12981)))
     (+ (- (to_rep1 (last4 temp___12981)) (to_rep1 (first4 temp___12981))) 1)
...
;; H
  (assert
  (= (slide1 temp___1298 (to_rep1 (first4 temp___12981))
...
;; H
  (assert
  (= (mk___t4 temp___1306 temp___13061) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___13061)) (to_rep1 (last8 temp___13061)))
     (+ (- (to_rep1 (last8 temp___13061)) (to_rep1 (first8 temp___13061))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1306 (to_rep1 (first8 temp___13061))
...
;; H
  (assert
  (and (= temp___1313 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  (assert
  (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1313))
  (= temp___1311 index1)))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1310 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1310)
  (<= temp___1310 (to_rep1 n__last)))
  (=> (< index2 temp___1310)
  (= (select n3 temp___1310) (select temp___1309 temp___1310)))))
...
;; H
  (assert
  (and (= temp___1314 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1314)
  (<= temp___1314 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1315 (+ (to_rep1 (first (rt source))) 8)) (in_range1
  (+ (to_rep1 (first (rt source))) 8))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1315)
  (<= temp___1315 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1316 (+ (to_rep1 (first (rt source))) 7)) (in_range1
  (+ (to_rep1 (first (rt source))) 7))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1316)
  (<= temp___1316 (to_rep1 n__last))))
...
;; H
  (assert
  (and (= temp___1317 (+ (to_rep1 (first (rt source))) 6)) (in_range1
  (+ (to_rep1 (first (rt source))) 6))))

;; H
  (assert
  (and (<= (to_rep1 n__first) temp___1317)
  (<= temp___1317 (to_rep1 n__last))))
