...
(declare-fun bt__o__t__f1__first__bit () Int)

(declare-fun bt__o__t__f1__last__bit () Int)

(declare-fun bt__o__t__f1__position () Int)
...
(declare-fun bt__o__t__f2__first__bit () Int)

(declare-fun bt__o__t__f2__last__bit () Int)

(declare-fun bt__o__t__f2__position () Int)
...
(declare-datatypes ()
((us_split_fields2 (mk___split_fields1 (rec__f__r1__f1 us_rep)))))
(define-fun us_split_fields_F12__projection ((a us_split_fields2)) us_rep
  (rec__f__r1__f1 a))
...
(declare-fun f__r1__f1__first__bit () Int)

(declare-fun f__r1__f1__last__bit () Int)

(declare-fun f__r1__f1__position () Int)
...
(declare-fun f__v__result1 () Bool)

(declare-fun f__v__result2 () Bool)

(declare-fun f__v__result3 () Bool)

(declare-fun y2 () Int)

(declare-fun f__v__result4 () Bool)

(declare-fun y3 () Int)

(declare-fun f__v__result5 () Bool)
