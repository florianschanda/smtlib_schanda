...
(declare-fun records__make_optional_pair_b__result () Bool)

(declare-fun records__make_optional_pair_b__result1 () unsigned_byte)

(declare-fun records__make_optional_pair_b__result2 () unsigned_byte)
...
(declare-fun records__make_optional_pair_b__result3 () us_rep1)

(declare-fun records__make_optional_pair_b__result4 () optional_pair__ref)

(declare-fun records__make_optional_pair_b__result5 () us_rep1)

(declare-fun r__split_fields6 () us_split_fields__ref1)

(declare-fun records__make_optional_pair_b__result6 () optional_pair__ref)

(declare-fun r__split_fields7 () us_split_fields2)

(declare-fun records__make_optional_pair_b__result7 () us_rep1)

(define-fun r__split_fields8 () us_split_fields2 (mk___split_fields1
                                                 r__split_fields3
                                                 (mk___rep
                                                 (mk___split_fields
                                                 r__split_fields4
...
(declare-fun result8 () unsigned_byte)
...
;; H
  (assert (= (of_int 1) r__split_fields3))

;; H
  (assert
  (= x (mk___rep (mk___split_fields r__split_fields4 r__split_fields5))))

;; H
  (assert
  (= records__make_optional_pair_b__result4 (mk_optional_pair__ref
                                            records__make_optional_pair_b__result3)))

;; H
  (assert
  (= records__make_optional_pair_b__result5 records__make_optional_pair_b__result3))
...
;; H
  (assert
  (= records__make_optional_pair_b__result3 (mk___rep1 r__split_fields8)))

;; H
  (assert
  (= records__make_optional_pair_b__result6 records__make_optional_pair_b__result4))
...
;; H
  (assert
  (= records__make_optional_pair_b__result7 records__make_optional_pair_b__result5))
...
;; H
  (assert
  (= (mk___rep1
     (mk___split_fields1 result6
     (mk___rep (mk___split_fields result7 result8)))) (optional_pair__content
                                                      records__make_optional_pair_b__result6)))
...
;; WP_parameter_def
 ;; File "records_prooffuncs.ads", line 19, characters 0-0
  (not
  (= (bool_eq1
     (optional_pair__content records__make_optional_pair_b__result6)
