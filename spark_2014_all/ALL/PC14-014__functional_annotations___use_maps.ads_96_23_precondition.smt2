...
;; H
  ...
  (= (has_key
     (model__
     (mk___rep m__split_discrs (mk___split_fields m__split_fields6))) k1) true)
  (= (get
     (model__
     (mk___rep m__split_discrs (mk___split_fields m__split_fields6))) k1) 0))))))
...
;; H
  (assert (and (= k (get1 temp___942 temp___941)) (in_range6 k)))
...
;; H
  ...
  (= (witness
     ...
     k) (witness
        (model__
        (mk___rep m__split_discrs (mk___split_fields m__split_fields))) k1))))))))))
