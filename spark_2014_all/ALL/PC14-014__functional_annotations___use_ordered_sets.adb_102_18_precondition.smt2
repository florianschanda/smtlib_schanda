...
;; H
  ...
  (= (bool_eq1 use_ordered_sets__move_2__cu__assume1 no_element) true)
  (and
  (= (has_key
     (positions
     (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s2__split_discrs s2__split_fields1))))
  (= (get (elements (mk___rep s2__split_discrs s2__split_fields1)) i1)
  (get
...
;; H
  ...
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s1__split_discrs s1__split_fields1))))
  (= (get (elements (mk___rep s1__split_discrs s1__split_fields1)) i1)
  (get
  (elements (mk___rep s1__split_discrs (mk___split_fields s1__split_fields)))
  (+ (length (mk___rep s2__split_discrs s2__split_fields1)) i1))))))
...
;; H
  (assert
  (and (= o (length (mk___rep s2__split_discrs s2__split_fields1)))
  (and (in_range2 o)
  (<= o (to_rep
        (rec__use_ordered_sets__my_sets__set__capacity s2__split_discrs))))))
...
;; H
  (assert
  (and (= o2 (elements (mk___rep s2__split_discrs s2__split_fields1)))
  (and
  (and
  (and
  (= (length2 o2) (length (mk___rep s2__split_discrs s2__split_fields1)))
  (forall ((temp___390 Int))
  (=> (and (in_range4 temp___390) (= (iter_has_element o2 temp___390) true))
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields1))
     (get o2 temp___390)) true))))
  (forall ((item Int))
  (=>
  (and (in_range6 item)
  (= (contains (model__ (mk___rep s2__split_discrs s2__split_fields1)) item) true))
  (and (< 0 (find o2 item))
  (= (equivalent_elements (get o2 (find o2 item)) item) true)))))
  (forall ((i1 Int))
  (=>
  (and (<= 1 i1)
  (<= i1 (length (mk___rep s2__split_discrs s2__split_fields1))))
  (and (= (find o2 (get o2 i1)) i1) (= (e_is_find o2 (get o2 i1) i1) true)))))))
