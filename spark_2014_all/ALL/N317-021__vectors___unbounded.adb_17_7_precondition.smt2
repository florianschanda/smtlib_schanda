...
(define-fun unbounded__vect__append__2__container__fields1 () us_split_fields 
...
;; H
  ...
  (= (length
     ...
     unbounded__vect__append__2__container__fields1)) (+ (length
                                                         (mk___rep
                                                         v__split_discrs
                                                         v__split_fields4)) 1))
  (= (olt (model__ (mk___rep v__split_discrs v__split_fields4))
     (model__
     (mk___rep v__split_discrs
     unbounded__vect__append__2__container__fields1))) true))
  (= (get
     (model__
     (mk___rep v__split_discrs
     unbounded__vect__append__2__container__fields1))
...
;; H
  (assert
  (= v__split_fields3 unbounded__vect__append__2__container__fields1))
