...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___79351)) (to_rep (last4 temp___79351)))
  temp___79361))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___79361)) (to_rep (last2 temp___79361)))
     (+ (- (to_rep (last2 temp___79361)) (to_rep (first2 temp___79361))) 1)
