...
(((mk_tnat_array_12P2__ref (tnat_array_12P2__content tnat_array_12P2)))))
(define-fun tnat_array_12P2__ref___projection ((a tnat_array_12P2__ref)) tnat_array_12P2
...
(define-fun tTaSP2__ref___projection ((a tTaSP2__ref)) tTaSP2 (tTaSP2__content
                                                              a))
...
;; def_axiom
  ...
  (= (get (array_aggr__bi_dim_aggr_ok__a__aggregate_def temp___259)
     temp___260 temp___261) (of_rep1 temp___259)))))
...
;; def_axiom
  ...
  (= (get (array_aggr__bi_dim_aggr_ok__c__aggregate_def temp___264)
     temp___265 temp___266) (of_rep1 temp___264)))))
