...
(define-fun n24 () t__ref (mk_t__ref n2))

(define-fun n14 () t__ref (mk_t__ref n1))
...
;; H
  (assert (= var1 (bvadd (bvsub var2 var1_range_size) n3)))

;; H
  (assert (=> (bvugt n3 var1_range_size) (= (mk_t__ref result1) n14)))

;; H
  (assert (=> (bvugt n3 var1_range_size) (= n11 ((_ int2bv 64) 0))))

;; H
  (assert (=> (bvugt n3 var1_range_size) (= (mk_t__ref result2) n24)))

;; H
  (assert (=> (bvugt n3 var1_range_size) (= n21 (bvsub n3 var1_range_size))))

;; H
  (assert (=> (bvugt n3 var1_range_size) (bvule n21 var2_range_size)))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (bvult n3 var2_range_size) (= (mk_t__ref result3) n14))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (bvult n3 var2_range_size) (= n12 var1_range_size))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (bvult n3 var2_range_size) (= (mk_t__ref result4) n24))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (bvult n3 var2_range_size) (= n22 n3))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result5) n14))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= n13 (bvsub var1_range_size n3)))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= (mk_t__ref result6) n24))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= n23 ((_ int2bv 64) 0)))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= n22 n23))))

;; H
  (assert
  (=> (not (bvugt n3 var1_range_size))
  (=> (not (bvult n3 var2_range_size)) (= n12 n13))))

;; H
  (assert (=> (not (bvugt n3 var1_range_size)) (= n21 n22)))

;; H
  (assert (=> (not (bvugt n3 var1_range_size)) (= n11 n12)))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 19, characters 0-0
  (not (bvule ((_ int2bv 64) 0) n11)))
(check-sat)
(exit)
