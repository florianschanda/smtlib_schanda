...
(define-fun us_split_fields_My_Task_Type2__projection ((a us_split_fields2)) us_main_type
...
(define-fun us_rep_6__projection ((a us_rep1)) us_split_discrs (us_split_discrs2
                                                               a))

(define-fun us_rep_7__projection ((a us_rep1)) us_split_fields2 (us_split_fields3
                                                                a))

(define-fun us_rep_8__projection ((a us_rep1)) Bool (attr__constrained1 a))
...
(declare-fun task_types__my_task_type__c__first__bit1 () Int)

(declare-fun task_types__my_task_type__c__last__bit1 () Int)

(declare-fun task_types__my_task_type__c__position1 () Int)
...
(define-fun us_split_fields_My_Task_Type3__projection ((a us_split_fields4)) us_main_type
...
(define-fun us_rep_9__projection ((a us_rep2)) us_split_discrs (us_split_discrs3
                                                               a))

(define-fun us_rep_10__projection ((a us_rep2)) us_split_fields4 (us_split_fields5
                                                                 a))

(define-fun us_rep_11__projection ((a us_rep2)) Bool (attr__constrained2 a))
...
(declare-fun task_types__my_task_type__c__first__bit2 () Int)

(declare-fun task_types__my_task_type__c__last__bit2 () Int)

(declare-fun task_types__my_task_type__c__position2 () Int)
...
(declare-fun t2__attr__constrained () Bool)
...
;; H
  (assert
  (and (= t__attr__constrained true)
  (= (to_rep (rec__task_types__my_task_type__c t__split_discrs)) 0)))

;; H
  (assert
  (and (= 0 (to_rep (rec__task_types__my_task_type__c t__split_discrs)))
