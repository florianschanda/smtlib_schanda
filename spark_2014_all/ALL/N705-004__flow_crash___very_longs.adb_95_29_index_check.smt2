...
(declare-datatypes ((tS20bP1__ref 0))
(((mk_tS20bP1__ref (tS20bP1__content tdigit_index_typeB)))))
...
(declare-datatypes ((s20b__ref 0)) (((mk_s20b__ref (s20b__content us_t1)))))
...
(((mk_t22b__ref (t22b__content tdigit_index_typeB)))))
...
(declare-const temp___1176 (Array Int octet))

(declare-const temp___11761 t2)

(declare-const temp___1177 (Array Int octet))

(declare-const temp___11771 t1)

(declare-const temp___1179 (Array Int octet))

(declare-const temp___11791 t1)
...
(declare-const temp___1181 digit_index_type)

(declare-const temp___11811 (Array Int octet))

(declare-const temp___11812 t)
...
;; H
  (assert
  (= (mk___t1 temp___1179 temp___11791) (mk___t1 temp___1177 temp___11771)))

;; H
  (assert (= temp___1179 o))

;; H
  (assert
  (= (mk (to_rep2 (first2 temp___11791)) (to_rep2 (last2 temp___11791)))
  o1))
...
;; H
  (assert (= result____split_discrs (mk___split_discrs temp___1181)))

;; H
  (assert (= temp___11811 o2))

;; H
  (assert (= temp___11812 o3))
...
;; H
  ...
  (= result____split_fields2 (mk___split_fields
                             (mk___t temp___11811 temp___11812))))
...
;; H
  ...
  (<= (to_rep2
      (first
      (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1192)
  (<= temp___1192 (to_rep2
                  (last
                  (rt
                  (rec__very_longs__very_long__long_digits
  ...
  (= (select (elts
             (rec__very_longs__very_long__long_digits
             result____split_fields3)) temp___1192) (select (elts
                                                            (rec__very_longs__very_long__long_digits
                                                            result____split_fields2)) temp___1192))))))
  (and (<= 1 i2)
  (<= i2 (to_rep2
         (last
         (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
