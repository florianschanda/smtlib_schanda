...
;; H
  (assert (= o27 (ite (< o26 56) true false)))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt source))) temp___1192)
  (<= temp___1192 (to_rep1 (last (rt source))))))

;; H
  (assert (= o temp___1192))
