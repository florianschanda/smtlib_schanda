...
(define-fun o36 () us_rep (mk___rep (mk___split_discrs o22 o23)
                          (mk___split_fields (mk___t1 o24 o25))))

(define-fun o37 () us_rep (mk___rep (mk___split_discrs o18 o19)
...
;; H
  ...
  (and
  (= o34 (+ (to_rep
            (rec__static_discr__holder__length1 current__split_fields6)) 1))
  (in_range1
...
;; H
  (assert
  (= result2 (ite (= o35 true) (ite (<= i (to_rep1 (last (rt a)))) true
                               false) false)))
