...
;; H
  (assert
  (=> (not (= first_available1 0)) (= result13 (ite (< 0 o70) true false))))
...
;; H
  ...
  (=> (= result13 true)
  (and
  (= o69 (get (rec__list_allocator__m__t__available model____split_fields3)
         1))
  (in_range7 o69)))))
...
;; H
  ...
  (=> (not (= first_available1 0))
  (=> (= result13 true)
  (= result12 (ite (= o69 first_available1) true false)))))
...
;; H
  (assert
  (=> (= result12 true)
  (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o67) true false)))))
...
;; H
  ...
  (=> (= result14 true)
  (and
  (= o66 (get (rec__list_allocator__m__t__allocated model____split_fields3)
         1))
  (in_range7 o66))))))
...
;; H
  ...
  (=> (not (= first_allocated2 0))
  (=> (= result14 true)
  (= result11 (ite (= o66 first_allocated2) true false))))))
