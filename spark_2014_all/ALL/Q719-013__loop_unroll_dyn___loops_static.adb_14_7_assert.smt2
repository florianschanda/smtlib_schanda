...
(declare-fun temp___2811 () t1)

(declare-fun loops_static__loop1__B_2__a_begins__assume () (Array Int natural))

(declare-fun loops_static__loop1__B_2__a_begins__assume1 () t)
...
;; WP_parameter_def
 ;; File "loops_static.adb", line 160, characters 0-0
  (not
  (not
  (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 1))
  (ite (and (<= 1 i1) (<= i1 2))
  (and
  (and
  (and (= temp___283 a)
  ...
  (=>
  (and (<= (to_rep1 a__first) temp___284) (<= temp___284 (to_rep1 a__last)))
  (=> (<= i2 temp___284)
  (= (select a2 temp___284) (select temp___283 temp___284)))))
  (and (<= 1 i2) (<= i2 2)))
  (and
  (and
  (and (= (to_rep o) 0)
  (and
  (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o1 i2))
  (= o2 (store a2 o1 o)))) (and (= a2 result1) (= a3 o2)))
  (and
  (and
  (and
  (and
  ...
  (=> (<= (to_rep1 a__first) i2)
  (and
  (and (<= (to_rep1 a__first) (to_rep1 a__first))
  (<= (to_rep1 a__first) (to_rep1 a__last)))
  (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))))) (= o3
  a3)) (and (= o3 temp___281) (= (mk1 (to_rep1 a__first) i2) temp___2811)))
  (and (= temp___281 loops_static__loop1__B_2__a_begins__assume)
  (= (mk (to_rep1 (first2 temp___2811)) (to_rep1 (last2 temp___2811)))
  loops_static__loop1__B_2__a_begins__assume1)))
  (= (mk___t loops_static__loop1__B_2__a_begins__assume
     loops_static__loop1__B_2__a_begins__assume1) a_begins))
  (dynamic_invariant a_begins true false true))
  (and
  (forall ((i7 Int))
  (=>
  (and (<= (to_rep1 (first (rt a_begins))) i7)
  (<= i7 (to_rep1 (last (rt a_begins)))))
  (= (to_rep (select (elts a_begins) i7)) 0))) (= i2 2))))))
  (and (and (= i2 i3) (= a3 a4)) (and (= i4 i2) (= a5 a3))))
  (and (and (= (mk_int__ref i5) (mk_int__ref i3)) (= a8 (mk_map__ref a4)))
  (and (= i6 i4) (= a7 a5))))
  (and (and (= i1 i5) (= a8 (mk_map__ref a))) (and (= i6 i1) (= a7 a1))))))))
(check-sat)
(exit)
