...
;; H
  ...
  (forall ((idx Int))
  (=> (and (<= (to_rep1 item__first) idx) (<= idx last3))
  (= (to_rep (select item idx)) (to_rep
...
;; WP_parameter_def
 ;; File "textio.ads", line 129, characters 0-0
  (not
  (or (= last4 (- (to_rep1 item__first) 1))
  (and (<= (to_rep1 item__first) last4) (<= last4 (to_rep1 item__last))))))
(check-sat)
(exit)
