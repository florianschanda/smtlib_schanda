...
(declare-const temp___1111 us_t1)
...
;; H
  (assert
  (and (= temp___1110 (length thestring)) (in_range1 (length thestring))))

;; H
  (assert
  (=> (<= 1 temp___1110)
  (and (and (<= 1 1) (<= 1 150))
  (and (<= 1 temp___1110) (<= temp___1110 150)))))

;; H
  (assert (= o22 result__1))

;; H
  (assert (= temp___1111 (mk___t1 o22 (mk1 1 temp___1110))))
...
;; WP_parameter_def
 ;; File "keystore.adb", line 57, characters 0-0
  ...
  (= (ite (<= (to_rep1 (first2 (rt1 temp___1108))) (to_rep1
     ...
     0) (ite (<= (to_rep1 (first2 (rt1 temp___1111))) (to_rep1
                                                      (last2
                                                      (rt1 temp___1111))))
        (+ (- (to_rep1 (last2 (rt1 temp___1111))) (to_rep1
                                                  (first2 (rt1 temp___1111)))) 1)
        0))))
(check-sat)
(exit)
