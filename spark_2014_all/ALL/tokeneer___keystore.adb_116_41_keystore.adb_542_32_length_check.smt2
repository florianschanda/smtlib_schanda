...
(define-fun us_split_fields_Owner2__projection ((a us_split_fields2)) us_rep
...
(define-fun us_split_fields_KeyID2__projection ((a us_split_fields4)) unsigned32t
  (rec__keystore__interfac__keytemplatet__keyid a))

(define-fun us_split_fields_KeyLength2__projection ((a us_split_fields4)) unsigned32t
...
(declare-fun theprivatekey__split_fields () maskt)

(declare-fun theprivatekey__split_fields1 () issueridt)

(declare-fun theprivatekey__split_fields2 () namecountt)

(declare-fun theprivatekey__split_fields3 () (Array Int character))

(declare-fun theprivatekey__split_fields4 () unsigned32t)

(declare-fun theprivatekey__split_fields5 () unsigned32t)

(declare-fun theprivatekey__split_fields6 () Bool)
...
(declare-fun temp___1127 () issueridt)

(declare-fun temp___11271 () namecountt)

(declare-fun temp___11272 () (Array Int character))
...
(declare-fun keystore__init__theprivatekey__assume () maskt)

(declare-fun keystore__init__theprivatekey__assume1 () issueridt)

(declare-fun keystore__init__theprivatekey__assume2 () namecountt)

(declare-fun keystore__init__theprivatekey__assume3 () (Array Int character))

(declare-fun keystore__init__theprivatekey__assume4 () unsigned32t)

(declare-fun keystore__init__theprivatekey__assume5 () unsigned32t)

(declare-fun keystore__init__theprivatekey__assume6 () Bool)
...
(declare-fun keystore__init__B112b__thestring__assume () us_t)

(declare-fun o21 () Int)

(declare-fun temp___1108 () us_t1)

(declare-fun result () us_split_fields__ref2)

(declare-fun theprivatekey__split_fields7 () us_split_fields4)
...
;; WP_parameter_def
 ;; File "keystore.adb", line 57, characters 0-0
  (not
  (= (ite (<= (to_rep1 (first2 (rt1 temp___1108))) (to_rep1
                                                   (last2 (rt1 temp___1108))))
     (+ (- (to_rep1 (last2 (rt1 temp___1108))) (to_rep1
                                               (first2 (rt1 temp___1108)))) 1)
