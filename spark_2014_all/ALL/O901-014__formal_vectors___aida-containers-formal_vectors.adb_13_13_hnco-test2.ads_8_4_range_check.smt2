...
(define-fun oeq ((left1 us_rep2)
  (right1 us_rep2)) Bool (and (= (length left1) (length right1)) (ite
                                                                 (forall
                                                                 ((n Int))
                                                                 (=>
                                                                 (and
...
;; oeq__post_axiom
  ...
  (! (= (= (oeq1 left1 right1) true)
     (= (oeq (model__ left1) (model__ right1)) true)) :pattern ((oeq1 left1
                                                                right1)) )))
...
;; H
  ...
  (= (to_rep
     (rec__hnco__test2__v_type_owner__vector_type__capacity
     (us_split_discrs3 left))) (to_rep1
                               (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity
                               (us_split_discrs1
                               (rec__hnco__test2__v_type_owner__vector_type__hidden_vector
                               (us_split_fields3 left)))))))

;; H
  (assert
  (= (to_rep
     (rec__hnco__test2__v_type_owner__vector_type__capacity
     (us_split_discrs3 right))) (to_rep1
                                (rec__hnco__test2__v_type_owner__vector_type_owner__vector__capacity
                                (us_split_discrs1
                                (rec__hnco__test2__v_type_owner__vector_type__hidden_vector
                                (us_split_fields3 right)))))))

(assert
;; WP_parameter_def
 ;; File "aida-containers-formal_vectors.ads", line 38, characters 0-0
  (not (in_range
  (to_rep
  (rec__hnco__test2__v_type_owner__vector_type__capacity
