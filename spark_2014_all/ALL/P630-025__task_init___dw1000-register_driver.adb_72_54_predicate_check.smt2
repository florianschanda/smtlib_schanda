...
(declare-fun temp___743 () bits_6)

(declare-fun temp___7431 () sub_index_type)

(declare-fun temp___7432 () operation_type)

(declare-fun temp___7433 () bits_7)

(declare-fun temp___7434 () extended_address_type)

(declare-fun dw1000__register_driver__read_register__B_2__header__assume () bits_6)

(declare-fun dw1000__register_driver__read_register__B_2__header__assume1 () sub_index_type)

(declare-fun dw1000__register_driver__read_register__B_2__header__assume2 () operation_type)

(declare-fun dw1000__register_driver__read_register__B_2__header__assume3 () bits_7)

(declare-fun dw1000__register_driver__read_register__B_2__header__assume4 () extended_address_type)

(define-fun dw1000__register_driver__read_register__B_2__header__assume5 () us_rep1
  (mk___rep1
  (mk___split_fields1
  dw1000__register_driver__read_register__B_2__header__assume
  dw1000__register_driver__read_register__B_2__header__assume1
  dw1000__register_driver__read_register__B_2__header__assume2
  dw1000__register_driver__read_register__B_2__header__assume3
  dw1000__register_driver__read_register__B_2__header__assume4)))
...
;; H
  (assert (= (to_rep2 o1) ((_ extract 7 0) sub_address)))
...
;; H
  (assert (= temp___743 o5))

;; H
  (assert (= temp___7431 o6))

;; H
  (assert (= temp___7432 o7))

;; H
  (assert (= temp___7433 o8))

;; H
  (assert (= temp___7434 o9))

;; H
  (assert (and (= (to_rep5 temp___7431) 1) (= (to_rep6 temp___7434) 0)))

;; H
  (assert
  (= dw1000__register_driver__read_register__B_2__header__assume5 (mk___rep1
                                                                  (mk___split_fields1
                                                                  temp___743
                                                                  temp___7431
                                                                  temp___7432
...
;; H
  (assert
  (= dw1000__register_driver__read_register__B_2__header__assume5 header1))
