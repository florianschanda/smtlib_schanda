...
;; H
  (assert
  (and (= o25 (model__ data1 first_available1))
  (= (model_is_well_formed o25 data1 first_available1) true)))
...
;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 i2)) (= (get c111b j1) (get c112b (+ j1 1))))))

;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 2 j1) (<= j1 (+ i2 1)))
  (= (get c111b (- j1 1)) (get c112b j1)))))
