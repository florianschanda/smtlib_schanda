...
(declare-fun o30 () (Array Int byte))
...
;; H
  ...
  (=> (< 0 (int__content remaining_bits7))
  (and
  (= o27 (+ (int__content offset7) (- (int__content remaining_bytes7) 1)))
  (in_range1
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= o28 (+ (to_rep1 (first (rt data))) o27))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (and (= keccak__keccak_1600__sponge__absorb__R99s__assume o28) (in_range1
  o28))))
...
;; H
  (assert (=> (< 0 (int__content remaining_bits7)) (= o29 (elts data))))

;; H
  (assert
  (=> (< 0 (int__content remaining_bits7))
  (= temp___845 (mk___t8 o29 (mk8 r98s r99s)))))
...
;; H
  ...
  (= (select o30 temp___852) (select (elts7 temp___851) temp___852))
  (= (select o30 temp___852) (select (rec__keccak__keccak_1600__sponge__context__block
...
;; H
  ...
  (= o31 (mk___split_fields
         (rec__keccak__keccak_1600__sponge__context__state
         (us_split_fields__content ctx__split_fields15)) o30
         (rec__keccak__keccak_1600__sponge__context__bits_absorbed
...
;; H
  (assert
  (=> (< 0 (int__content remaining_bits7)) (= temp___854 (mk___rep o31))))
...
;; H
  (assert (= o37 (ite (= o36 initial_bit_rate1) true false)))

;; H
  (assert
  (and
  (= o34 (rate_of (mk___rep (us_split_fields__content ctx__split_fields18))))
  (and (in_range3 o34)
  (and
  (= o34 (* (to_rep4
            (rec__keccak__keccak_1600__sponge__context__rate
...
;; H
  (assert (= o35 (ite (< (int__content remaining_bits7) o34) true false)))

;; H
  (assert
  (and
  (= o32 (state_of (mk___rep (us_split_fields__content ctx__split_fields18))))
  (and (in_range5 o32)
  (= o32 (to_rep5
         (rec__keccak__keccak_1600__sponge__context__curr_state
...
;; H
  (assert (= o33 (ite (= o32 0) true false)))
