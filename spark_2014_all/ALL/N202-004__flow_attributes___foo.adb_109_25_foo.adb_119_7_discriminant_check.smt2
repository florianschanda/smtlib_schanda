...
(declare-const temp___2961 positive)

;; H
  (assert (= (to_int1 (rec__foo__dt__found a__split_discrs)) 1))

;; H
  (assert (= (rec__foo__dt__found a__split_discrs) r42b))
...
;; H
  (assert (= (of_int 1) temp___296))

;; H
  (assert (= temp___2961 o1))

(assert
;; WP_parameter_def
 ;; File "foo.adb", line 98, characters 0-0
  (not (= temp___296 (rec__foo__dt__found a__split_discrs))))
(check-sat)
(exit)
