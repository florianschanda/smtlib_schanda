...
(declare-const temp___9276 (Array Int us_rep))

(declare-const temp___92761 Bool)

(declare-const temp___92762 enum1t)
...
;; H
  (assert (= temp___9276 o6))

;; H
  (assert (= temp___92761 o7))

;; H
  (assert (= temp___92762 o8))
...
;; H
  (assert (= temp___9276 r__split_fields3))

;; H
  (assert (= temp___92761 r__split_fields4))

;; H
  (assert (= temp___92762 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1758, characters 0-0
  (not (in_range2
  (to_rep
  (rec__ar__rec1t__f1 (us_split_fields1 (select r__split_fields6 n)))))))
(check-sat)
(exit)
