...
(declare-fun temp___750 () (Array Int byte))
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= temp___750 data2)))
...
;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 7)) (and (= o5 (* i2 8)) (in_range1 (* i2 8)))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (and (= o6 o5) (in_range2 o5))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o7 ((_ int2bv 64) o6))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o8 (bvlshr lane1 o7))))

;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 7)) (= o9 (bvand o8 ((_ int2bv 64) 255)))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o10 o9)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o11 ((_ extract 7 0) o10))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= (to_rep1 o12) o11)))
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o4 (+ o3 i2))))

;; H
  (assert
  (=> (and (<= 0 i1) (<= i1 7)) (and (= temp___748 o4) (in_range1 o4))))
...
;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o13 temp___748)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= o14 (store data3 o13 o12))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= result9 (mk_map__ref data3))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= data4 o14)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i2 7)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i3 (mk_int__ref i2))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= data5 (mk_map__ref data4))))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i4 i2)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= data6 data4)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i5 i3)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= data7 data5)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= i6 i4)))

;; H
  (assert (=> (and (<= 0 i1) (<= i1 7)) (= data8 data6)))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= i5 (mk_int__ref i1))))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= data7 (mk_map__ref data2))))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= i6 i1)))

;; H
  (assert (=> (not (and (<= 0 i1) (<= i1 7))) (= data8 data2)))

;; H
  (assert
  (=> (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1))
  (= o15 (bvsub (bvadd x2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5)))))

;; H
  (assert
  (=> (not (bvule (bvsub ((_ int2bv 8) 5) x2) ((_ int2bv 8) 1)))
  (= o15 (bvadd x2 ((_ int2bv 8) 1)))))

;; H
  (assert (= result10 (mk_t__ref x2)))
...
;; H
  ...
  (= o16 (bvsub (bvadd y2 ((_ int2bv 8) 1)) ((_ int2bv 8) 5))))))

;; H
  (assert
  (=> (= x3 ((_ int2bv 8) 0))
  (=> (not (bvule (bvsub ((_ int2bv 8) 5) y2) ((_ int2bv 8) 1)))
  (= o16 (bvadd y2 ((_ int2bv 8) 1))))))

;; H
  (assert (=> (= x3 ((_ int2bv 8) 0)) (= result11 (mk_t__ref y2))))

;; H
  (assert (=> (= x3 ((_ int2bv 8) 0)) (= y3 o16)))

;; H
  (assert (=> (= x3 ((_ int2bv 8) 0)) (= y4 (mk_t__ref y3))))

;; H
  (assert (=> (= x3 ((_ int2bv 8) 0)) (= y5 y3)))

;; H
  (assert (=> (not (= x3 ((_ int2bv 8) 0))) (= y4 (mk_t__ref y2))))

;; H
  (assert (=> (not (= x3 ((_ int2bv 8) 0))) (= y5 y2)))

;; H
  (assert
  (and (= o17 (- remaining_bytes2 8)) (in_range2 (- remaining_bytes2 8))))

;; H
  (assert (= result12 (mk_int__ref remaining_bytes2)))

;; H
  (assert (= remaining_bytes3 o17))
