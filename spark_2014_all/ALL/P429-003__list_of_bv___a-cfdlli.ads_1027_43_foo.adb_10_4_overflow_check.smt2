...
(declare-const temp___428 count_type)
...
;; H
  (assert (= temp___428 o1))

;; H
  (assert (= (mk___rep1 (mk___split_fields1 temp___428)) no_element))
...
;; H
  ...
  (and (in_range1 o2)
  (<= o2 (to_rep (rec__foo__lists__list__capacity target__split_discrs))))))

;; H
  (assert
  (= o3 (- (to_rep (rec__foo__lists__list__capacity target__split_discrs))
  o2)))
