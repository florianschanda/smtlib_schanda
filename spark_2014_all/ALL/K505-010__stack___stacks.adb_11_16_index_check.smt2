...
;; H
  ...
  (= (mk___split_fields__ref
     (mk___split_fields result1 (mk___t result2 result3) result4)) (mk___split_fields__ref
                                                                   (mk___split_fields
                                                                   s__split_fields
                                                                   (mk___t
                                                                   s__split_fields1
...
;; H
  (assert
  (= s__split_fields4 (mk___split_fields temp___2101
...
;; WP_parameter_def
 ;; File "stacks.ads", line 17, characters 0-0
  (not
  (<= (to_rep2 (first (rt (rec__stacks__stack__data s__split_fields4))))
  (to_rep (rec__stacks__stack__top s__split_fields4)))))
(check-sat)
(exit)
