...
(((mk___split_fields
  (rec__dw1000__register_types__sys_time_type__sys_time bits_40)))))
(define-fun us_split_fields_SYS_TIME__projection ((a us_split_fields)) bits_40
  (rec__dw1000__register_types__sys_time_type__sys_time a))
...
(define-fun bool_eq2 ((a us_rep)
  (b us_rep)) Bool (ite (= (to_rep2
                           (rec__dw1000__register_types__sys_time_type__sys_time
...
(declare-const dw1000__register_types__sys_time_type__sys_time__first__bit Int)

(declare-const dw1000__register_types__sys_time_type__sys_time__last__bit Int)

(declare-const dw1000__register_types__sys_time_type__sys_time__position Int)

;; dw1000__register_types__sys_time_type__sys_time__first__bit_axiom
  (assert (<= 0 dw1000__register_types__sys_time_type__sys_time__first__bit))

;; dw1000__register_types__sys_time_type__sys_time__last__bit_axiom
  (assert
  (< dw1000__register_types__sys_time_type__sys_time__first__bit dw1000__register_types__sys_time_type__sys_time__last__bit))

;; dw1000__register_types__sys_time_type__sys_time__position_axiom
  (assert (<= 0 dw1000__register_types__sys_time_type__sys_time__position))

(declare-fun user_eq5 (us_rep us_rep) Bool)

(declare-const dummy5 us_rep)

(declare-datatypes ((sys_time_type__ref 0))
(((mk_sys_time_type__ref (sys_time_type__content us_rep)))))
(define-fun sys_time_type__ref___projection ((a sys_time_type__ref)) us_rep
  (sys_time_type__content a))

(declare-datatypes ((register_type__ref 0))
(((mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___11__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___8__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___8__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_2116 us_t1)
  (temp___is_init_2113 Bool) (temp___skip_constant_2114 Bool)
  (temp___do_toplevel_2115 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_2114 true))
                                       (and (dynamic_property2 1 5
                                       (first3 temp___expr_2116)
                                       (last3 temp___expr_2116))
                                       (and (= (first3 temp___expr_2116) 1)
                                       (= (last3 temp___expr_2116) 5)))))
