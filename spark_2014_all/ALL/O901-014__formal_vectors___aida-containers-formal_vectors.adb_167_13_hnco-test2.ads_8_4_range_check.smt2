...
;; contains__post_axiom
  ...
  (! (=> (dynamic_invariant2 item1 true true true)
     ...
     (= (contains (model__ container1) 1 (last_index container1) item1) true))) :pattern (
...
(define-fun dynamic_invariant6 ((temp___expr_219 Int)
...
(define-fun dynamic_invariant7 ((temp___expr_395 Int)
