...
;; H
  (assert (= c1 (roundToIntegral RTP1 x)))
...
;; H
  (assert (= f1 (roundToIntegral RTN1 x)))
...
;; H
  (assert (= r1 (roundToIntegral RNA1 x)))
...
;; H
  (assert (= t2 (roundToIntegral RTZ1 x)))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (tqtisFinite (sub RNE1 c1 fliteral))))
(check-sat)
