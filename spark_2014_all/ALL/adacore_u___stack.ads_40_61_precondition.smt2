...
(declare-fun dummy4 () tTp_contentSP1)
...
(declare-fun p_content () (Array Int element))
...
(declare-fun p_top1 () Int)

(declare-fun p_content1 () (Array Int element))

(declare-fun result () Int)

(declare-fun p_top2 () Int)

(declare-fun result1 () (Array Int element))

(declare-fun p_content2 () (Array Int element))

(declare-fun p_top3 () Int)

(declare-fun p_content3 () (Array Int element))

(declare-fun p_top4 () Int)

(declare-fun p_content4 () (Array Int element))

(declare-fun p_top5 () Int)

(declare-fun p_content5 () (Array Int element))

(declare-fun p_top6 () Int)

(declare-fun p_content6 () (Array Int element))

(define-fun p_content7 () map__ref (mk_map__ref p_content3))

(define-fun p_top7 () int__ref (mk_int__ref p_top3))

(define-fun p_content8 () map__ref (mk_map__ref p_content))

(define-fun p_top8 () int__ref (mk_int__ref p_top))
...
;; H
  ...
  (or
  (and
  (and (and (= p_content7 p_content8) (= p_top7 p_top8))
  (and (= p_content4 p_content1) (= p_top4 p_top1))) (<= 100 p_top))
  (and (not (<= 100 p_top))
  (and
  (and (and (= p_content2 p_content3) (= p_top2 p_top3))
  (and (= p_content4 p_content2) (= p_top4 p_top2)))
  (and
  (and (and (= o (+ p_top 1)) (in_range2 (+ p_top 1)))
  (and (= (mk_int__ref result) p_top8) (= p_top2 o)))
  (and
  (and (= (to_rep o1) e)
  (and (and (and (<= 1 p_top2) (<= p_top2 100)) (= o2 p_top2))
  (= o3 (store p_content o2 o1))))
  (and (= (mk_map__ref result1) p_content8) (= p_content2 o3))))))))

;; H
  (assert (= (mk_map__ref p_content5) p_content7))

;; H
  (assert (= (mk_int__ref p_top5) p_top7))

;; H
  (assert (= p_content6 p_content4))

;; H
  (assert (= p_top6 p_top4))

;; H
  (assert (not (= (is_full2 p_top) true)))

(assert
;; WP_parameter_def
 ;; File "stack.ads", line 2, characters 0-0
  (not (not (= (is_empty2 p_top5) true))))
(check-sat)
(exit)
