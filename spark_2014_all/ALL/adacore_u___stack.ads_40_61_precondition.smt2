...
(declare-const p_content (Array Int element))
...
(declare-const p_content1 (Array Int element))

(declare-const result Int)

(declare-const p_top2 Int)

(declare-const result1 (Array Int element))

(declare-const p_content2 (Array Int element))

(declare-const p_top3 Int)

(declare-const p_content3 (Array Int element))

(declare-const p_top4 Int)

(declare-const p_content4 (Array Int element))

(declare-const p_top5 Int)

(declare-const p_content5 (Array Int element))

(declare-const p_top6 Int)

(declare-const p_content6 (Array Int element))
