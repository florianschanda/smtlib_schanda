...
(define-fun tint_arrayD1__ref_8__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref_8__projection ((a tint_arrayT__ref)) us_t1
...
(define-fun tnumber_array_typeD1__ref_8__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref_8__projection ((a number_array_type__ref)) us_t3
...
(declare-datatypes ()
((t204b__ref (mk_t204b__ref (t204b__content integer)))))
(define-fun t204b__ref___projection ((a t204b__ref)) integer (t204b__content
                                                             a))
...
(declare-datatypes ()
((t206b__ref (mk_t206b__ref (t206b__content integer)))))
(define-fun t206b__ref___projection ((a t206b__ref)) integer (t206b__content
                                                             a))
...
(define-fun tint_arrayB__ref_8__projection ((a tint_arrayB__ref)) us_t5
  (tint_arrayB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def (Int
  Int Int Int Int Int Int Int Int Int Int Int) us_t2)

;; def_axiom
  (assert
  (forall ((temp___1452 Int) (temp___1453 Int) (temp___1454 Int)
  ...
  (temp___1463 Int))
  (let ((temp___1451 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def
                     temp___1452 temp___1453 temp___1454 temp___1455
                     temp___1456 temp___1457 temp___1458 temp___1459
                     temp___1460 temp___1461 temp___1462 temp___1463)))
  (and
  (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1462
  temp___1463)
  (and (= (first5 temp___1451) temp___1462)
  (= (last5 temp___1451) temp___1463)))
  (and
  (and
  (and
  (and
  ...
  (and
  (and
  (= (select (to_array2 temp___1451) (+ (first1 source) 0)) (of_rep1
                                                            temp___1452))
  (= (select (to_array2 temp___1451) (+ (first1 source) 1)) (of_rep1
                                                            temp___1453)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 2)) (of_rep1
                                                            temp___1454)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 3)) (of_rep1
                                                            temp___1455)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 4)) (of_rep1
                                                            temp___1456)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 5)) (of_rep1
                                                            temp___1457)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 6)) (of_rep1
                                                            temp___1458)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 7)) (of_rep1
                                                            temp___1459)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 8)) (of_rep1
                                                            temp___1460)))
  (= (select (to_array2 temp___1451) (+ (first1 source) 9)) (of_rep1
                                                            temp___1461)))))))
...
(define-fun tnumber_array_typeB__ref_8__projection ((a tnumber_array_typeB__ref)) us_t6
  (tnumber_array_typeB__content a))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def (Int
  Int Int) us_t4)

;; def_axiom
  (assert
  (forall ((temp___1469 Int) (temp___1470 Int) (temp___1471 Int))
  (let ((temp___1468 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def
                     temp___1469 temp___1470 temp___1471)))
  (and
  (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1470
  temp___1471)
  (and (= (first9 temp___1468) temp___1470)
  (= (last9 temp___1468) temp___1471)))
  (forall ((temp___1472 Int))
  (= (select (to_array4 temp___1468) temp___1472) (of_rep1 temp___1469)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_293 us_t3)
  ...
  (temp___do_toplevel_292 Bool)) Bool (=>
                                      ...
                                      (+ (first1 source) 9)
                                      (first7 temp___expr_293)
                                      (last7 temp___expr_293))
                                      (and
                                      (= (first7 temp___expr_293) (first1
                                                                  source))
                                      (= (last7 temp___expr_293) (+ (first1
                                                                    source) 9))))))
...
(declare-fun temp___1466 () (Array Int integer))

(declare-fun temp___14661 () t2)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume1 () t1)

(declare-fun temp___1474 () (Array Int integer))

(declare-fun temp___14741 () t4)

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume () (Array Int integer))

(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume1 () t3)
...
;; H
  ...
  (= (to_rep1
     (first4
     (rt2
     (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def
     2 1 3 9 9 9 9 9 9 9 (to_rep1 (first (rt source)))
...
;; H
  (assert
  (= (mk___t2 temp___1466 temp___14661) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def
                                        2 1 3 9 9 9 9 9 9 9
...
;; H
  (assert
  (= (ite (<= (to_rep1 (first4 temp___14661)) (to_rep1 (last4 temp___14661)))
     (+ (- (to_rep1 (last4 temp___14661)) (to_rep1 (first4 temp___14661))) 1)
...
;; H
  (assert
  (= (slide1 temp___1466 (to_rep1 (first4 temp___14661))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume))

;; H
  (assert
  (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))
  aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume1))
...
;; H
  (assert
  (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume))
...
;; H
  (assert
  (= (mk___t4 temp___1474 temp___14741) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def
                                        0 (to_rep1 (first (rt source)))
                                        (+ (to_rep1 (first (rt source))) 9))))

;; H
  (assert
  (= (ite (<= (to_rep1 (first8 temp___14741)) (to_rep1 (last8 temp___14741)))
     (+ (- (to_rep1 (last8 temp___14741)) (to_rep1 (first8 temp___14741))) 1)
     0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1
                                                  (first (rt source))) 9))
        (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1
                                                  (first (rt source)))) 1)
...
;; H
  (assert
  (= (slide1 temp___1474 (to_rep1 (first8 temp___14741))
     (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume))

;; H
  (assert
  (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))
  aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume1))
...
;; H
  (assert
  (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume))
...
;; H
  (assert
  (and (= temp___1481 (+ (to_rep1 (first (rt source))) 9)) (in_range1
  (+ (to_rep1 (first (rt source))) 9))))
...
;; H
  ...
  (and
  (and
  (forall ((temp___1478 Int))
  (=>
  (and (<= (to_rep1 n__first) temp___1478)
  (<= temp___1478 (to_rep1 n__last)))
  (=> (< index2 temp___1478)
  (= (select n3 temp___1478) (select n1 temp___1478)))))
...
(assert
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 512, characters 0-0
