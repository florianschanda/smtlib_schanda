...
(define-fun tint_arrayD1__ref___8__projection ((a tint_arrayD1__ref)) integer
...
(define-fun tint_arrayT__ref___8__projection ((a tint_arrayT__ref)) us_t1
...
(((mk_t201b__ref (t201b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___8__projection ((a tnumber_array_typeD1__ref)) integer
...
(define-fun number_array_type__ref___8__projection ((a number_array_type__ref)) us_t3
...
(((mk_t204b__ref (t204b__content integer)))))
...
(declare-datatypes ((t205b__ref 0))
(((mk_t205b__ref (t205b__content us_t4)))))
...
(declare-datatypes ((t206b__ref 0))
(((mk_t206b__ref (t206b__content integer)))))
...
(define-fun tint_arrayB__ref___8__projection ((a tint_arrayB__ref)) us_t5
...
(define-fun tnumber_array_typeB__ref___8__projection ((a tnumber_array_typeB__ref)) us_t6
