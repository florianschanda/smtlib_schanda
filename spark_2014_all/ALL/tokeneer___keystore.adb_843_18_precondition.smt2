...
;; H
  (assert (=> (= result4 true) (= o17 result__1)))
...
;; H
  (assert (=> (= result4 true) (= temp___1195 temp___1191)))
...
;; H
  ...
  (= (select o18 temp___1196) (select result__1 temp___1196))))))

;; H
  (assert (=> (= result4 true) (= result5 (mk_map__ref result__1))))

;; H
  (assert (=> (= result4 true) (= result__2 o18)))
...
;; H
  (assert (=> (not (= result4 true)) (= temp___1190 thestring)))

;; H
  (assert (=> (not (= result4 true)) (= o19 (elts temp___1190))))

;; H
  (assert (=> (not (= result4 true)) (= result6 (mk_map__ref result__1))))

;; H
  (assert (=> (not (= result4 true)) (= result__3 o19)))

;; H
  (assert (=> (not (= result4 true)) (= result__2 result__3)))

;; H
  (assert (= result7 (mk_map__ref c151b)))

;; H
  (assert (= c151b1 result__2))
