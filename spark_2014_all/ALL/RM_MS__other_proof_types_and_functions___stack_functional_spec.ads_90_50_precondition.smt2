...
;; H
  (assert
  (and (= o16 (state__2 (us_split_fields__content my_stack__split_fields4)))
  (= o16 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
...
;; H
  (assert (= o19 (ite (<= i o18) true false)))

;; H
  (assert (= result3 (ite (<= 1 i) o19 false)))
