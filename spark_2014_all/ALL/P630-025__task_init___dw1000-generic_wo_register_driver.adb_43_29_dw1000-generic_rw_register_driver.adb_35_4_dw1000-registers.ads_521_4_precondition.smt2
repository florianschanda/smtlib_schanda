...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___81041)) (to_rep (last4 temp___81041)))
  temp___81051))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___81051)) (to_rep (last2 temp___81051)))
     (+ (- (to_rep (last2 temp___81051)) (to_rep (first2 temp___81051))) 1)
