...
(declare-fun long_side () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS () Int)

(declare-fun side_2 () Int)

(declare-fun attr__ATTRIBUTE_ADDRESS1 () Int)

(declare-fun side_3 () Int)
...
(declare-fun main__is_right_angle_triangle__result () Bool)
...
(declare-fun main__is_right_angle_triangle__result1 () Bool)

(declare-fun result2 () Bool)

(declare-fun main__is_right_angle_triangle__result2 () Bool)

(declare-fun main__is_right_angle_triangle__result3 () Bool)

(declare-fun main__is_right_angle_triangle__result4 () Bool)

(declare-fun main__is_right_angle_triangle__result5 () Bool)

(declare-fun main__is_right_angle_triangle__result6 () Bool)

(declare-fun main__is_right_angle_triangle__result7 () Bool)

(declare-fun main__is_right_angle_triangle__result8 () Bool)
...
;; H
  (assert (and (= o5 (* side_3 side_3)) (in_range1 (* side_3 side_3))))

;; H
  (assert (and (= o6 (* side_2 side_2)) (in_range1 (* side_2 side_2))))
...
;; WP_parameter_def
 ;; File "main.adb", line 14, characters 0-0
  (not (in_range1 (* long_side long_side))))
(check-sat)
(exit)
