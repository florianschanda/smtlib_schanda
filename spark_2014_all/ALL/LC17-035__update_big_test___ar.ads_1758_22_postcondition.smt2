...
(declare-fun temp___3937 ((Array Int us_rep) Int us_rep) (Array Int us_rep))

;; def_axiom
  (assert
  (forall ((temp___3939 (Array Int us_rep)))
  (forall ((temp___3940 Int))
  (forall ((temp___3941 us_rep))
  (let ((temp___3938 (temp___3937 temp___3939 temp___3940 temp___3941)))
  (forall ((temp___3942 Int))
  (ite (= temp___3942 temp___3940)
  (= (select temp___3938 temp___3942) temp___3941)
  (= (select temp___3938 temp___3942) (select temp___3939 temp___3942)))))))))

(declare-fun temp___3943 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3945 (Array Int et1)))
  (forall ((temp___3946 Int) (temp___3947 Int))
  (let ((temp___3944 (temp___3943 temp___3945 temp___3946 temp___3947)))
  (forall ((temp___3948 Int))
  (ite (= temp___3948 temp___3946)
  (= (select temp___3944 temp___3948) (of_rep temp___3947))
  (= (select temp___3944 temp___3948) (select temp___3945 temp___3948))))))))

(declare-fun temp___3950 ((Array Int (Array Int et1)) Int
  (Array Int et1)) (Array Int (Array Int et1)))

;; def_axiom
  (assert
  (forall ((temp___3952 (Array Int (Array Int et1))))
  (forall ((temp___3953 Int))
  (forall ((temp___3954 (Array Int et1)))
  (let ((temp___3951 (temp___3950 temp___3952 temp___3953 temp___3954)))
  (forall ((temp___3955 Int))
  (ite (= temp___3955 temp___3953)
  (= (select temp___3951 temp___3955) temp___3954)
  (= (select temp___3951 temp___3955) (select temp___3952 temp___3955)))))))))

(declare-fun temp___3957 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3959 (Array Int et1)))
  (forall ((temp___3960 Int) (temp___3961 Int))
  (let ((temp___3958 (temp___3957 temp___3959 temp___3960 temp___3961)))
  (forall ((temp___3962 Int))
  (ite (= temp___3962 temp___3960)
  (= (select temp___3958 temp___3962) (of_rep temp___3961))
  (= (select temp___3958 temp___3962) (select temp___3959 temp___3962))))))))
...
(declare-fun o13 () (Array Int (Array Int et1)))
...
;; H
  (assert
  (= o9 (store (rec__ar__rofa4__s4 (us_split_fields1 (select a1 i)))
  k o8)))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1753, characters 0-0
  (not
  (= (bool_eq3 a3 90 99
     (temp___3937 a i
     (mk___rep
     (mk___split_fields
     (temp___3943 (rec__ar__rofa4__s4 (us_split_fields1 (select a i))) k f)
     (temp___3950 (rec__ar__rofa4__t4 (us_split_fields1 (select a i)))
     j
     (temp___3957
