...
;; H
  (assert
  (and
  (= (log_size1 log__attr__tag (mk___rep log__split_fields6 log__attr__tag)) 0)
  (init_log__specific_post log__attr__tag log__split_fields6 log__attr__tag
  (mk___split_fields log__split_fields log__split_fields1 log__split_fields2))))
