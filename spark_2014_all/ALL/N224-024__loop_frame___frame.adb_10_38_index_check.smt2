...
;; H
  ...
  (forall ((k1 Int))
  (=> (and (<= 1 k1) (<= k1 j2))
  (= (to_rep (select a3 k1)) (ite (< 10 (to_rep (select a k1))) 10
                             (to_rep (select a k1)))))))
...
;; H
  ...
  (=> (< j2 temp___177) (= (select a3 temp___177) (select a temp___177))))))
  (and (<= 1 j2) (<= j2 10))))
...
;; H
  (assert (=> (= result2 true) (= o7 10)))

;; H
  (assert (=> (not (= result2 true)) (and (<= 1 k) (<= k 10))))

;; H
  (assert (=> (not (= result2 true)) (= o5 k)))

;; H
  (assert (=> (not (= result2 true)) (= o6 (select a o5))))

;; H
  (assert (=> (not (= result2 true)) (= o7 (to_rep o6))))
