...
;; H
  ...
  (= o (+ (- (to_rep addr__last) (to_rep addr__first)) 1))))
...
;; H
  ...
  (= (nth8_stream (mk___t addr (mk (to_rep addr__first) (to_rep addr__last)))
     j) true)
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j) true)))))

;; H
  (assert
  (forall ((j Int))
  (=> (and (<= start j) (<= j (- (+ start i2) 1)))
  (=
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) j) true)
...
;; H
  (assert
  (and (=> (<= 0 (- len 1)) (dynamic_property1 0 (- len 1) i2))
  (and (<= 0 i2) (<= i2 (- len 1)))))
...
;; H
  ...
  (=>
  (and (<= 0 i3)
  (<= i3 (- (* 8 (ite (<= (to_rep addr__first) (to_rep addr__last))
                 (+ (- (to_rep addr__last) (to_rep addr__first)) 1) 0)) 1)))
  (=> (not (= i3 o9))
  (=
  (= (nth8_stream
     (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) i3) true)
  (= (nth8_stream
     (mk___t addr1 (mk (to_rep addr__first) (to_rep addr__last))) i3) true)))))
  (=
  (= (nth8_stream
     (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last))) o9) true)
  (= flag1 true))))
...
;; H
  ...
  (=
  (= (nth8_stream
     (mk___t addr2 (mk (to_rep addr__first) (to_rep addr__last)))
     (+ start i2)) true)
  (= (nth value (- (- len i2) 1)) true)))
...
;; H
  (assert
  (=> (not (= k (+ start i2)))
  (=> (not (<= (to_rep addr__first) (to_rep addr__last))) (= o10 0))))

;; H
  (assert (=> (not (= k (+ start i2))) (and (= o11 o10) (in_range1 o10))))

;; H
  (assert (=> (not (= k (+ start i2))) (= o12 (* 8 o11))))

;; H
  (assert (=> (not (= k (+ start i2))) (= o13 (- o12 1))))

;; H
  (assert (=> (not (= k (+ start i2))) (= o14 (ite (<= k o13) true false))))

;; H
  (assert (=> (not (= k (+ start i2))) (= result4 (ite (<= 0 k) o14 false))))
