...
(define-fun dynamic_invariant ((temp___expr_1485 Int)
...
(define-fun dynamic_invariant4 ((temp___expr_1503 Int)
...
(define-fun dynamic_invariant5 ((temp___expr_1530 Int)
...
(define-fun dynamic_invariant6 ((temp___expr_1524 Int)
