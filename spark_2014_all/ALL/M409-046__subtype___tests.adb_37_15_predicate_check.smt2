...
(declare-fun dummy1 () positive_but_not_ten)
...
;; H
  ...
  (= (= o true)
  (let ((temp___185 x))
  (or (and (<= 1 temp___185) (<= temp___185 9))
  (and (<= 11 temp___185) (<= temp___185 2147483647))))))
...
;; WP_parameter_def
 ;; File "tests.adb", line 27, characters 0-0
  (not
  (or (and (<= 1 temp___187) (<= temp___187 9))
  (and (<= 11 temp___187) (<= temp___187 2147483647)))))
(check-sat)
(exit)
