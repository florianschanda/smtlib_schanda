...
;; H
  (assert (= o18 (from_word32 (t__content carry28))))
...
;; H
  (assert (= o16 (from_word32 (t__content carry18))))
...
;; H
  (assert (= o22 (oadd o9 o21)))

;; H
  (assert (= o3 (from_word32 carry2)))
...
;; H
  (assert (= o1 (from_word32 carry1)))

;; H
  (assert (= o (from_word32 y)))
