...
(declare-const b_top3 Int)

(declare-const b_content3 (Array Int element))

(declare-const b_top4 Int)

(declare-const b_content4 (Array Int element))

(declare-const b_top5 Int)

(declare-const b_content5 (Array Int element))

(declare-const b_top6 Int)

(declare-const b_content6 (Array Int element))
