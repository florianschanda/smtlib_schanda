...
;; H
  (assert
  (= a__split_fields9 (mk___split_fields temp___264 temp___2641 temp___2642)))
...
;; H
  (assert
  (= a__split_fields10 (mk___split_fields temp___266 temp___2661 temp___2662)))

(assert
;; WP_parameter_def
 ;; File "arrays_in_records.adb", line 105, characters 0-0
  (not
  (= (to_rep1
     (select (rec__arrays_in_records__record_with_arrays__second_array
             a__split_fields10) i)) 69)))
(check-sat)
(exit)
