...
;; H
  (assert
  (and (= result6 (bit_set e e_first (bvsub i2 ((_ int2bv 64) j3))))
  (= (= result6 true)
  (not
  (= (bvand (to_rep1
            (select (elts e) (+ e_first (bv2nat (bvudiv (bvsub i2 ((_ int2bv 64)
            j3)) ((_ int2bv 64) 32)))))) (let ((temp___455 (bv2nat (bvurem (bvsub
                                         i2 ((_ int2bv 64) j3)) ((_ int2bv 64) 32)))))
                                         (ite (< temp___455 4294967296)
                                         (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___455))
                                         ((_ int2bv 32) 0)))) ((_ int2bv 32) 0))))))

;; H
  (assert (=> (= result6 true) (and (= o8 (- j3 s3)) (in_range1 (- j3 s3)))))

;; H
  (assert (=> (= result6 true) (and (= o9 o8) (in_range2 o8))))

;; H
  (assert (=> (= result6 true) (= o10 ((_ int2bv 32) o9))))

;; H
  (assert (=> (= result6 true) (= o11 (bvshl w2 o10))))

;; H
  (assert (=> (= result6 true) (= o12 (bvor o11 ((_ int2bv 32) 1)))))

;; H
  (assert (=> (= result6 true) (= result7 (mk_t__ref w2))))

;; H
  (assert (=> (= result6 true) (= w3 o12)))

;; H
  (assert (=> (= result6 true) (= result8 (mk_int__ref s3))))

;; H
  (assert (=> (= result6 true) (= s4 j3)))

;; H
  (assert (=> (= result6 true) (= w4 (mk_t__ref w3))))

;; H
  (assert (=> (= result6 true) (= s5 (mk_int__ref s4))))

;; H
  (assert (=> (= result6 true) (= w5 w3)))

;; H
  (assert (=> (= result6 true) (= s6 s4)))

;; H
  (assert (=> (not (= result6 true)) (= w4 (mk_t__ref w2))))

;; H
  (assert (=> (not (= result6 true)) (= s5 (mk_int__ref s3))))

;; H
  (assert (=> (not (= result6 true)) (= w5 w2)))

;; H
  (assert (=> (not (= result6 true)) (= s6 s3)))
