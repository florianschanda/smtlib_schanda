...
(declare-fun us_self__compl10 () us_rep2)
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (dynamic_invariant us_self__compl10 true true true))))
...
;; H
  ...
  (= (rec__decadriver__driver_type__detect_frame_timeout
     (us_split_fields11 (driver_type__content self__))) true)
  (= receiver__split_fields7 (us_split_fields5 us_self__compl10)))))
...
;; H
  (assert (dynamic_invariant (mk___rep2 receiver__split_fields8) true true
  true))
