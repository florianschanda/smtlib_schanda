...
(declare-fun discr_checks__check_subtype_task__R10b__assume () Int)

;; H
  (assert
  (and (= discr_checks__check_subtype_task__R10b__assume (bad Tuple0))
  (and (in_range discr_checks__check_subtype_task__R10b__assume)
  (= discr_checks__check_subtype_task__R10b__assume 6))))
