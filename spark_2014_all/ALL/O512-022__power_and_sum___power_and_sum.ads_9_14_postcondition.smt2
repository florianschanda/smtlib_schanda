...
(declare-fun result__2 () int__ref)

(declare-fun i8 () int__ref)

(declare-fun j14 () int__ref)

(declare-fun totalsum8 () int__ref)

(declare-fun innersum14 () int__ref)
...
(declare-fun totalsum9 () Int)

(declare-fun innersum15 () Int)
...
;; H
  (assert
  (=> (<= i1 n) (=> (<= j3 i2) (= innersum16 (mk_int__ref innersum6)))))
...
;; H
  (assert
  (and (= o4 (int__content totalsum6)) (in_range3 (int__content totalsum6))))
...
;; WP_parameter_def
 ;; File "power_and_sum.ads", line 5, characters 0-0
  (not (= (* 6 (int__content result__2)) (* (* n (+ n 1)) (+ n 2)))))
(check-sat)
(exit)
