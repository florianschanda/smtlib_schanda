...
(declare-fun temp___203 () integer)

(declare-fun temp___2031 () integer)

(declare-fun temp___2032 () (Array Int integer))

(declare-fun temp___2033 () integer)

(declare-fun temp___2034 () (Array Int integer))

(declare-fun temp___2035 () Bool)
...
;; WP_parameter_def
 ;; File "use_unchecked_union.ads", line 33, characters 0-0
  (not (= temp___203 output__split_discrs)))
(check-sat)
(exit)
