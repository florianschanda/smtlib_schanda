...
(declare-fun incr__specific_post (Int us_split_fields Int
...
(declare-fun incr2__specific_post (Int us_split_fields Int
  us_split_fields) Bool)
...
(declare-fun c1__split_fields1 () us_private)
...
(declare-fun main__c1__assume1 () us_private)

(declare-fun main__c1__assume2 () Int)
...
(declare-fun c1__split_fields2 () integer)

(declare-fun c1__split_fields3 () us_private)
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not
  (= (less_than_max
     (mk___rep (mk___split_fields c1__split_fields2 c1__split_fields3)
     c1__attr__tag)) true)))
(check-sat)
(exit)
