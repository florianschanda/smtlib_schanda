...
(declare-const temp___1861 pointer_range)
...
;; H
  (assert
  (and (= o (+ (to_rep1 s__split_fields1) 1)) (in_range1
...
;; H
  (assert (= temp___186 o2))

;; H
  (assert (= temp___1861 o3))
...
;; H
  (assert (= temp___186 s__split_fields2))

;; H
  (assert (= temp___1861 s__split_fields3))
