...
;; H
  (assert
  (= (mk1 (to_rep (first4 temp___78471)) (to_rep (last4 temp___78471)))
  temp___78481))

;; H
  (assert
  (= (ite (<= (to_rep (first2 temp___78481)) (to_rep (last2 temp___78481)))
     (+ (- (to_rep (last2 temp___78481)) (to_rep (first2 temp___78481))) 1)
     0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last))
        (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))

;; H
  (assert (= (mk___t1 o o1) (mk___t1 temp___7848 temp___78481)))
