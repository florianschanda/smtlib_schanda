...
;; readmem16__post_axiom
  ...
  (! (=> (dynamic_invariant addr1 true true true)
     ...
     (to_rep (select x86__memory (bvadd addr1 ((_ int2bv 64) 1))))) ((_ int2bv 16) 256))))
     (bvuge result ((_ int2bv 16) 0))) (dynamic_invariant2 result true false
     true)))) :pattern ((readmem16 addr1 x86__memory)) ))))
...
;; H
  (assert
  (and (= o1 (readmem32 (bvadd addr ((_ int2bv 64) 4)) memory))
  (and
  (= o1 (bvadd ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 4))
                                   memory)) (bvmul ((_ zero_extend 16)
  (readmem16 (bvadd (bvadd addr ((_ int2bv 64) 4)) ((_ int2bv 64) 2))
  memory)) ((_ int2bv 32) 65536)))) (bvuge o1 ((_ int2bv 32) 0)))))
...
;; H
  (assert
  (and (= o (readmem32 addr memory))
  (and
  (= o (bvadd ((_ zero_extend 16) (readmem16 addr memory)) (bvmul ((_ zero_extend 16)
  (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 65536))))
  (bvuge o ((_ int2bv 32) 0)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 7, characters 0-0
  (not
  (= x86__readmem64__result4 (bvadd ((_ zero_extend 32) (readmem32 addr
                                                        memory)) (bvmul ((_ zero_extend 32)
  (readmem32 (bvadd addr ((_ int2bv 64) 4)) memory)) ((_ int2bv 64) 4294967296))))))
(check-sat)
(exit)
