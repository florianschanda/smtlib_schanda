...
;; H
  (assert (= o71 (from_word32 ((_ int2bv 32) 1))))
...
;; H
  (assert (= o64 (from_word32 ((_ int2bv 32) 2))))
...
;; H
  (assert
  (and (= o55 (base Tuple0))
  (= o55 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
;; H
  (assert
  (= o54 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last)))
         a_first o53)))
