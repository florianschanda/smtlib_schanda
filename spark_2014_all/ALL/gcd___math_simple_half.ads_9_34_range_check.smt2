...
(declare-fun math_simple_half__gcd__result () Int)
...
(declare-fun math_simple_half__gcd__result1 () Int)
...
(declare-fun math_simple_half__gcd__result2 () Int)

(declare-fun c11 () int__ref)

(declare-fun j8 () int__ref)

(declare-fun math_simple_half__gcd__result3 () int__ref)

(declare-fun c12 () Int)

(declare-fun j9 () Int)

(declare-fun math_simple_half__gcd__result4 () Int)

(declare-fun c13 () int__ref)

(declare-fun j10 () int__ref)

(declare-fun math_simple_half__gcd__result5 () int__ref)

(declare-fun c14 () Int)

(declare-fun j11 () Int)

(declare-fun math_simple_half__gcd__result6 () Int)

(declare-fun c15 () int__ref)

(declare-fun j12 () int__ref)

(declare-fun math_simple_half__gcd__result7 () int__ref)

(declare-fun c16 () Int)

(declare-fun j13 () Int)

(declare-fun math_simple_half__gcd__result8 () Int)
...
(define-fun math_simple_half__gcd__result9 () int__ref (mk_int__ref
...
;; H
  (assert
  (=> (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))
  (= math_simple_half__gcd__result3 (mk_int__ref
                                    math_simple_half__gcd__result1))))
...
;; H
  (assert
  (=> (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)) (= c11 (mk_int__ref c1))))

;; H
  (assert
  (=> (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))
  (= math_simple_half__gcd__result4 math_simple_half__gcd__result1)))
...
;; H
  (assert
  (=> (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))
  (= (mk_int__ref result1) math_simple_half__gcd__result9)))

;; H
  (assert
  (=> (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))
  (= math_simple_half__gcd__result1 c1)))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (= math_simple_half__gcd__result3 (mk_int__ref
                                    math_simple_half__gcd__result2))))
...
;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (= math_simple_half__gcd__result4 math_simple_half__gcd__result2)))
...
;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (and (= o1 (div1 c1 2)) (in_range1 (div1 c1 2)))))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (= c1 result2)))
...
;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (= (+ c2 1) r4b)))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0))) (in_range2 r4b)))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (= (mk_int__ref result3) j15)))
...
;; H
  ...
  (and (= o3 (ite (< a b) a b)) (in_range1 (ite (< a b) a b))))))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1)))
  (and (= o2 j2) (in_range1 j2)))))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1)))
  (not (= (divides o2 o3) true)))))
...
;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1))) (= j3 j4))))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1))) (= j5 j3))))
...
;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1))) (= j7 j5))))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (not (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1)))) (= j2 j6))))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (not (and (<= r4b j2) (<= j2 (- (ite (< a b) a b) 1)))) (= j7 j2))))
...
;; H
  ...
  (=> (< 1 c2)
  (or
  (and (and (= c2 c5) (= c6 c2)) (and (= (mod2 a c2) 0) (= (mod2 b c2) 0)))
  (and (not (and (= (mod2 a c2) 0) (= (mod2 b c2) 0)))
  (and (and (= c4 c5) (= c6 c4))
  (and
  (and (< 1 c3)
  (forall ((x1 Int))
  (=> (and (<= c3 x1) (<= x1 (ite (< a b) a b)))
  (not (and (= (divides x1 a) true) (= (divides x1 b) true))))))
  (and (=> (<= 1 2147483647) (in_range1 c3))
  (and
  (and (and (= o4 (- c3 1)) (in_range1 (- c3 1)))
  (and (= c3 result4) (= c4 o4)))
  (or (not (< 1 c4))
  (and (< 1 c4) (and (= (mod2 a c4) 0) (= (mod2 b c4) 0)))))))))))))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (=> (< 1 c2) (= c18 (mk_int__ref c5)))))
...
;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (= (mk_int__ref result5) math_simple_half__gcd__result9)))

;; H
  (assert
  (=> (not (and (= (mod2 a c1) 0) (= (mod2 b c1) 0)))
  (= math_simple_half__gcd__result2 c9)))
...
;; H
  (assert (and (= o5 x) (in_range1 x)))

;; H
  (assert (and (= o6 (divides o5 b)) (= (= o6 true) (= (mod2 b o5) 0))))
