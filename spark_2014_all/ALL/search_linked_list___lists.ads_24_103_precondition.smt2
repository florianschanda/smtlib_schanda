...
(define-fun element ((container us_rep)
  (position us_rep1)) Int (get1 (model__ container)
...
(define-fun default_initial_assumption3 ((temp___expr_227 us_rep3)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant4 (get1 container position) true false true)) :pattern (
...
(declare-fun lists__search2__result () count_type)
...
(declare-fun lists__search2__result1 () count_type)

(declare-fun lists__search2__result2 () count_type)

(declare-fun lists__search2__result3 () count_type)

(declare-fun lists__search2__result4 () count_type)

(declare-fun lists__search2__result5 () count_type)
...
(define-fun lists__search2__result6 () us_rep1 (mk___rep1
                                               (mk___split_fields1
                                               lists__search2__result3)))

(define-fun lists__search2__result7 () us_rep1 (mk___rep1
                                               (mk___split_fields1
                                               lists__search2__result1)))

(define-fun cu1 () us_rep1 (mk___rep1 (mk___split_fields1 cu)))

(define-fun o7 () us_rep1 (mk___rep1 (mk___split_fields1 o)))
...
;; H
  (assert
  (and (= o7 (search l))
  (ite (forall ((cu2 us_rep1))
       (=> (= (has_key (positions l) cu2) true) (not (= (element l cu2) 0))))
  (not (= (has_key (positions l) o7) true))
  (=>
  (exists ((cu2 us_rep1))
  (and (= (has_key (positions l) cu2) true) (= (element l cu2) 0)))
  (and (= (element l o7) 0)
  (forall ((i Int))
  (=> (and (<= 1 i) (<= i (- (get (positions l) o7) 1)))
  (not (= (get1 (model__ l) i) 0)))))))))
...
;; H
  ...
  (= (mk_cursor__ref (mk___rep1 (mk___split_fields1 result))) (mk_cursor__ref
                                                              (mk___rep1
                                                              (mk___split_fields1
                                                              lists__search2__result)))))

;; H
  (assert (= lists__search2__result7 o7))

;; H
  (assert
  (= (mk_cursor__ref
     (mk___rep1 (mk___split_fields1 lists__search2__result4))) (mk_cursor__ref
                                                               (mk___rep1
                                                               (mk___split_fields1
                                                               lists__search2__result2)))))

;; H
  (assert
  (= (mk___rep1 (mk___split_fields1 lists__search2__result5)) lists__search2__result6))

;; H
  (assert
  (and
  (= result1 (has_key (positions l)
             (mk___rep1 (mk___split_fields1 lists__search2__result4))))
  (= (= result1 true)
  (= (has_key (positions l)
     (mk___rep1 (mk___split_fields1 lists__search2__result4))) true))))
...
;; H
  (assert
  (and (= o1 (has_key (positions l) cu1))
  (= (= o1 true) (= (has_key (positions l) cu1) true))))
...
;; H
  ...
  (forall ((i us_rep1))
  (=> (= (has_key o4 i) true)
  (and (and (<= 1 (get o4 i)) (<= (get o4 i) (length1 l)))
  (forall ((j us_rep1))
  (=> (= (has_key o4 j) true)
  (=> (= (get o4 i) (get o4 j)) (= (bool_eq1 i j) true))))))))))

;; H
  (assert
  (and
  (= o5 (get o4 (mk___rep1 (mk___split_fields1 lists__search2__result4))))
  (and (in_range2 o5)
  (=> (= (of_int 0) true)
  (and
  (= o5 (w_get o4
        (witness o4 (mk___rep1 (mk___split_fields1 lists__search2__result4)))))
  (forall ((k us_rep1))
  (=> (= (has_key o4 k) true)
  (=
  (= (bool_eq1 k (mk___rep1 (mk___split_fields1 lists__search2__result4))) true)
  (= (witness o4 (mk___rep1 (mk___split_fields1 lists__search2__result4)))
  (witness o4 k))))))))))
...
;; H
  ...
  (forall ((i us_rep1))
  (=> (= (has_key o3 i) true)
  (and (and (<= 1 (get o3 i)) (<= (get o3 i) (length1 l)))
  (forall ((j us_rep1))
  (=> (= (has_key o3 j) true)
  (=> (= (get o3 i) (get o3 j)) (= (bool_eq1 i j) true))))))))))
...
;; H
  ...
  (and (in_range2 o6)
  (=> (= (of_int 0) true)
  (and (= o6 (w_get o3 (witness o3 cu1)))
  (forall ((k us_rep1))
  (=> (= (has_key o3 k) true)
  (= (= (bool_eq1 k cu1) true) (= (witness o3 cu1) (witness o3 k))))))))))

;; H
  (assert (= result3 (ite (< o6 o5) true false)))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not (= (has_key (positions l) cu1) true)))
(check-sat)
(exit)
