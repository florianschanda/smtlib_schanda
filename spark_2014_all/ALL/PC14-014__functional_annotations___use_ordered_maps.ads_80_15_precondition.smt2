...
;; H
  ...
  (= (iter_has_element temp___783 temp___396) true))
  (= (has_key
     (model__
     (mk___rep s1__split_discrs (us_split_fields__content s1__split_fields8)))
     (get1 temp___783 temp___396)) true))))
  (forall ((key2 Int))
  (=>
  (and (in_range3 key2)
  (= (has_key
  ...
  (= (equivalent_keys (get1 temp___783 (find temp___783 key2)) key2) true)))))
  (forall ((i Int))
  (=>
  (and (<= 1 i)
  (<= i (length
        (mk___rep s1__split_discrs
        (us_split_fields__content s1__split_fields8)))))
  (and (= (find temp___783 (get1 temp___783 i)) i)
  (= (k_is_find temp___783 (get1 temp___783 i) i) true)))))))

;; H
  (assert
  (and (= o3 (iter_has_element temp___783 temp___782))
  (= (= o3 true) (and (<= 1 temp___782) (<= temp___782 (last temp___783))))))
