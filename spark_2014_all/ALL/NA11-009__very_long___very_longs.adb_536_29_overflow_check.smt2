...
(declare-const temp___1310 us_rep1)
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b))
  (= temp___1314 sum)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b))
  (= temp___1310 (mk___rep1 u__split_discrs
                 (mk___split_fields1
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= sum3 o26)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b))
  (= temp___1309 (mk___rep1 u__split_discrs o33))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b))
  (= u__split_fields4 (us_split_fields3 temp___1309))))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b))
  (= u__split_discrs (us_split_discrs2 temp___1309))))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= carry3 o34)))

;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b))
  (= divisor_index2 r127b)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= sum5 sum3)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= sum6 sum4)))
...
;; H
  (assert
  (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= sum7 sum5)))
...
;; H
  (assert
  (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r127b)))
...
;; H
  ...
  (<= (to_rep1
      ...
      (rt1
      (rec__very_longs__very_long__long_digits1
      (us_split_fields__content1 u__split_fields7))))) temp___1318)
  (<= temp___1318 (to_rep1
                  (last3
                  (rt1
                  (rec__very_longs__very_long__long_digits1
