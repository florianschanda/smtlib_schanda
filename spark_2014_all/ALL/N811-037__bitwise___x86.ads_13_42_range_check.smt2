...
(define-fun dynamic_invariant1 ((temp___expr_141 (_ BitVec 8))
...
;; H
  (assert
  (= x86__dl__result1 ((_ extract 7 0) (bvand rdx ((_ int2bv 64) 255)))))
...
;; WP_parameter_def
 ;; File "x86.ads", line 5, characters 0-0
  (not
  (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand rdx ((_ int2bv 64) 255)))))
(check-sat)
(exit)
