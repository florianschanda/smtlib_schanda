...
(declare-fun temp___3031 ((Array Int et1) Int Int) (Array Int et1))

;; def_axiom
  (assert
  (forall ((temp___3033 (Array Int et1)))
  (forall ((temp___3034 Int) (temp___3035 Int))
  (let ((temp___3032 (temp___3031 temp___3033 temp___3034 temp___3035)))
  (forall ((temp___3036 Int))
  (ite (= temp___3036 temp___3034)
  (= (select temp___3032 temp___3036) (of_rep temp___3035))
  (= (select temp___3032 temp___3036) (select temp___3033 temp___3036))))))))
...
(declare-const temp___7934 (Array Int et1))

(declare-const temp___79341 enum2t)
...
(declare-const temp___7936 (Array Int et1))

(declare-const temp___79361 enum2t)
...
;; H
  (assert (= temp___7934 o2))

;; H
  (assert (= temp___79341 o3))
...
;; H
  (assert (= temp___7934 r__split_fields2))

;; H
  (assert (= temp___79341 r__split_fields3))
...
;; H
  (assert (= temp___7936 o5))

;; H
  (assert (= temp___79361 o6))
...
;; H
  (assert (= temp___7936 r__split_fields4))

;; H
  (assert (= temp___79361 r__split_fields5))
...
(assert
;; WP_parameter_def
 ;; File "ar.ads", line 1438, characters 0-0
  (not
  (= (bool_eq1
     (mk___rep (mk___split_fields r__split_fields6 r__split_fields7))
     (mk___rep
     (mk___split_fields (temp___3031 r__split_fields i e) (of_rep1 f)))) true)))
(check-sat)
(exit)
