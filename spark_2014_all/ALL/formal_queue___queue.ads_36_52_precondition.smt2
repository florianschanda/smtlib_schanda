...
(declare-fun queue__enqueue__result () count_type)

(declare-fun queue__enqueue__result1 () us_main_type)
...
(declare-fun queue__enqueue__result2 () count_type)

(declare-fun queue__enqueue__result3 () us_main_type)

(declare-fun queue__enqueue__result4 () count_type)

(declare-fun queue__enqueue__result5 () us_main_type)

(declare-fun queue__enqueue__result6 () us_rep)

(declare-fun r__split_fields3 () us_split_fields__ref)

(declare-fun queue__enqueue__result7 () list__ref)

(declare-fun r__split_fields4 () us_split_fields)

(declare-fun queue__enqueue__result8 () us_rep)
...
;; H
  ...
  (and
  (and
  (= (length (mk___rep r__split_discrs r__split_fields5)) (+ (length
                                                             (mk___rep
                                                             r__split_discrs
                                                             r__split_fields6)) 1))
  (= (range_shifted (model__ (mk___rep r__split_discrs r__split_fields6))
     (model__ (mk___rep r__split_discrs r__split_fields5)) 1
     (length (mk___rep r__split_discrs r__split_fields6)) 1) true))
  (= (get (model__ (mk___rep r__split_discrs r__split_fields5)) 1) v))
  (= (p_positions_shifted
     (positions (mk___rep r__split_discrs r__split_fields6))
     (positions (mk___rep r__split_discrs r__split_fields5)) 1 1) true)))
...
;; H
  (assert
  (= queue__enqueue__result6 (mk___rep
                             (mk___split_discrs queue__enqueue__result2)
                             (mk___split_fields queue__enqueue__result3))))

;; H
  (assert
  (= (mk_list__ref
     (mk___rep (mk___split_discrs result1) (mk___split_fields result2)))
  (mk_list__ref
  (mk___rep (mk___split_discrs queue__enqueue__result)
  (mk___split_fields queue__enqueue__result1)))))
...
;; H
  (assert
  (= queue__enqueue__result7 (mk_list__ref
                             (mk___rep
                             (mk___split_discrs queue__enqueue__result4)
                             (mk___split_fields queue__enqueue__result5)))))
...
;; H
  ...
  (and (= o (length q))
  (and (in_range2 o)
  (<= o (to_rep (rec__queue__mylists__list__capacity (us_split_discrs1 q)))))))
