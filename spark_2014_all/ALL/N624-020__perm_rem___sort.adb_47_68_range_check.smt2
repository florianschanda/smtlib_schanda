...
;; H
  (assert
  (and (= o27 (remove (mk___t values2 (mk 1 100)) o16))
...
;; H
  (assert
  (and (= o28 (remove (mk___t interm1 (mk 1 100)) o13))
...
;; H
  (assert
  (and (= o20 (remove_eq o28 o27 o19))
  (and (in_range4 o20)
  (=> (= (of_int o20) true)
  (= (let ((temp___163 (remove o27 o19)))
     (let ((temp___162 (remove o28 o19)))
