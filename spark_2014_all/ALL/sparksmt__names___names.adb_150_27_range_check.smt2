...
(declare-fun o13 () char_table_index)

(declare-fun o14 () positive)

(declare-fun o15 () name_id)

(declare-fun o16 () char_table_index)
...
;; H
  ...
  (= temp___4743 (get
                 (model__
                 (mk___rep1 entry_table__split_discrs
                 entry_table__split_fields1)) o11))
...
;; H
  (assert (= temp___474 o13))

;; H
  (assert (= temp___4741 o14))
