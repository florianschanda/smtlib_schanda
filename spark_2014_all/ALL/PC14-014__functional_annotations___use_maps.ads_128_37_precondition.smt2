...
(define-fun element ((container us_rep)
  (position us_rep1)) Int (get1 (model__ container) (key container position)))
...
(define-fun element__2 ((container us_rep)
  (key2 Int)) Int (get1 (model__ container) key2))
...
;; H
  ...
  (=> (and (in_range3 temp___431) (= (iter_has_element o2 temp___431) true))
  (= (has_key (model__ s) (get o2 temp___431)) true))))
  (forall ((key2 Int))
  (=> (and (in_range4 key2) (= (has_key (model__ s) key2) true))
  (and (< 0 (find o2 key2)) (= (get o2 (find o2 key2)) key2)))))
  (forall ((i1 Int))
...
(assert
;; WP_parameter_def
 ;; File "use_maps.ads", line 115, characters 0-0
  (not (<= 1 i)))
(check-sat)
(exit)
