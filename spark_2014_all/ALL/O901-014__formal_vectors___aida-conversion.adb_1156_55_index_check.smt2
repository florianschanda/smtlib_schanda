...
;; H
  (assert
  (and (= o33 (convert_character_digit_to_integer o32))
  (and (in_range1 o33)
  (and (and (<= 0 o33) (<= o33 9))
  (ite (= (= o32 48) true) (= o33 0)
  (ite (= (= o32 49) true) (= o33 1)
  (ite (= (= o32 50) true) (= o33 2)
  (ite (= (= o32 51) true) (= o33 3)
  (ite (= (= o32 52) true) (= o33 4)
  (ite (= (= o32 53) true) (= o33 5)
  (ite (= (= o32 54) true) (= o33 6)
  (ite (= (= o32 55) true) (= o33 7)
  (ite (= (= o32 56) true) (= o33 8) (=> (= (= o32 57) true) (= o33 9)))))))))))))))
...
;; WP_parameter_def
 ;; File "aida-conversion.adb", line 1093, characters 0-0
  (not (<= (to_rep1 (first (rt source))) temp___1806)))
(check-sat)
(exit)
