...
(declare-fun dummy6 () matchresultt)
...
(define-fun bool_eq9 ((a (Array Int bytet)) (a__first Int) (a__last Int)
...
(declare-fun dummy8 () (Array Int bytet))
...
(declare-fun dummy9 () templatelengtht)
...
(declare-fun dummy12 () descriptioni)
...
(declare-fun numericreturn1 () Int)

(declare-fun result () Int)

(declare-fun c44b1 () Int)

(declare-fun result1 () Int)

(declare-fun matchresult2 () Int)
