...
;; H
  ...
  (= o6 (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1))))

;; H
  (assert
  (=> (not (<= (to_rep1 data__first) (to_rep1 data__last))) (= o6 0)))

;; H
  (assert (= result (ite (< 0 o6) true false)))
...
;; H
  (assert (and (= o3 (length value)) (in_range1 (length value))))

;; H
  (assert (= result2 (ite (<= o3 65536) true false)))
...
;; H
  (assert
  (and (= o (- (to_rep1 data__last) position)) (in_range1
