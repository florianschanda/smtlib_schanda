...
;; H
  (assert
  (= (let ((temp___223 (to_model (mk___rep r__split_fields11))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields11)) x)))
     (let ((temp___230 (to_model (mk___rep r__split_fields10))))
...
;; H
  (assert
  (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields10)) y)))
     (let ((temp___230 (to_model (mk___rep r__split_fields9))))
     (bool_eq (elts temp___230) (to_rep (first (rt temp___230)))
     (to_rep (last (rt temp___230))) (elts temp___231)
     (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (not (= (is_empty (mk___rep r__split_fields9)) true))))
(check-sat)
(exit)
