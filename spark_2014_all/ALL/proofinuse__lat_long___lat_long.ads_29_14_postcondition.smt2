...
;; WP_parameter_def
 ;; File "lat_long.ads", line 6, characters 0-0
  (not (eq lat_long__distance__result4
  (sqrt2
  (add RNE1
  (mul RNE1 (delta_lat_in_meters source destination)
  (delta_lat_in_meters source destination))
  (mul RNE1 (delta_long_in_meters source destination)
