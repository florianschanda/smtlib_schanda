...
;; length__post_axiom
  ...
  (! (let ((result (length1 container)))
     (and (<= result (capacity1 container)) (dynamic_invariant3 result true
...
;; H
  ...
  (= (to_rep
     (rec__hnco__test2__v_type_owner__vector_type__capacity
     container__split_discrs)) r210s))

;; H
  (assert (in_range1 r210s))

;; H
  (assert (and (= us r210s) (in_range2 r210s)))
...
;; WP_parameter_def
 ;; File "aida-containers-formal_vectors.ads", line 47, characters 0-0
  (not (<= capacity (to_rep1 container__split_fields))))
(check-sat)
