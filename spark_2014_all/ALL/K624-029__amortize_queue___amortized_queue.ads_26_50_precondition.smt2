...
;; H
  (assert
  (and (= o7 (length right)) (and (in_range6 o7) (<= o7 (capacity right)))))
...
;; H
  (assert
  (and (= o9 (length (vector__content amortized_queue__Oconcat__2__result5)))
  (and (in_range6 o9)
  (<= o9 (capacity (vector__content amortized_queue__Oconcat__2__result5))))))
...
;; H
  (assert
  (and
  (= o6 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1))
  (and (in_range7 o6)
  (= o6 (get (model__ (vector__content amortized_queue__Oconcat__2__result5))
        1)))))
