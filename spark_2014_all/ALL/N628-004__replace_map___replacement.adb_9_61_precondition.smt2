...
;; H
  (assert
  (forall ((c2 us_rep1))
  (=> (= (has_key (positions d_old) c2) true)
  (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c2) true))))

;; H
  (assert
  (and (= o (has_key (positions d_old) c1))
  (= (= o true) (= (has_key (positions d_old) c1) true))))
