...
(declare-fun p__t__x__first__bit () Int)

(declare-fun p__t__x__last__bit () Int)

(declare-fun p__t__x__position () Int)
...
(declare-fun p__t__x__first__bit1 () Int)

(declare-fun p__t__x__last__bit1 () Int)

(declare-fun p__t__x__position1 () Int)
...
(declare-fun p__t__x__first__bit2 () Int)

(declare-fun p__t__x__last__bit2 () Int)

(declare-fun p__t__x__position2 () Int)
...
(declare-fun p__t__x__first__bit3 () Int)

(declare-fun p__t__x__last__bit3 () Int)

(declare-fun p__t__x__position3 () Int)
...
(declare-fun p__t__x__first__bit4 () Int)

(declare-fun p__t__x__last__bit4 () Int)

(declare-fun p__t__x__position4 () Int)
...
(declare-fun x__split_discrs () integer)
