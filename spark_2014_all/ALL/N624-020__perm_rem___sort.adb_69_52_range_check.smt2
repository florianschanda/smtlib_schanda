...
;; H
  (assert
  (and (= o23 (remove (mk___t values2 (mk 1 100)) o22))
  (and (dynamic_invariant4 o23 true false true)
  (and (= (invariant__ o23) true)
  (and (= (to_rep1 (last (rt o23))) (- (to_rep1 (last (mk 1 100))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o22 1)))
  (= (to_rep (select values2 k)) (to_rep (select (elts o23) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o22 1) k) (<= k (to_rep1 (last (mk 1 100)))))
  (= (to_rep (select values2 k)) (to_rep (select (elts o23) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o22 k) (<= k (- (to_rep1 (last (mk 1 100))) 1)))
  (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o23) k))))))))))))

;; H
  (assert
  (and (= temp___225 (remove o23 o24))
  (and (dynamic_invariant4 temp___225 true false true)
  (and (= (invariant__ temp___225) true)
  (and (= (to_rep1 (last (rt temp___225))) (- (to_rep1 (last (rt o23))) 1))
  (and
  (forall ((k Int))
  (=> (and (<= 1 k) (<= k (- o24 1)))
  (= (to_rep (select (elts o23) k)) (to_rep (select (elts temp___225) k)))))
  (and
  (forall ((k Int))
  (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (rt o23)))))
  (= (to_rep (select (elts o23) k)) (to_rep
                                    (select (elts temp___225) (- k 1))))))
  (forall ((k Int))
  (=> (and (<= o24 k) (<= k (- (to_rep1 (last (rt o23))) 1)))
  (= (to_rep (select (elts o23) (+ k 1))) (to_rep
                                          (select (elts temp___225) k))))))))))))

;; H
  (assert (and (= o25 (- y 1)) (in_range5 (- y 1))))
