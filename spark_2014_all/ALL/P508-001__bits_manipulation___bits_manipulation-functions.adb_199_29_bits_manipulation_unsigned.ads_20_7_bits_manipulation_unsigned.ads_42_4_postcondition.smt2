...
(declare-datatypes ((t582s__ref 0))
(((mk_t582s__ref (t582s__content integer)))))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___400 i1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___399 result__1)))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  ...
  (let ((temp___411 (- i9 1)))
  (ite (< temp___411 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___411))
  ((_ int2bv 8) 0)))) (let ((temp___412 (- i9 1)))
                      (ite (< temp___412 256)
                      (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___412))
                      ((_ int2bv 8) 0))))))
(check-sat)
(exit)
