...
(declare-datatypes ()
((t454s__ref (mk_t454s__ref (t454s__content integer)))))
(define-fun t454s__ref___projection ((a t454s__ref)) integer (t454s__content
                                                             a))
...
(declare-fun temp___388 () (_ BitVec 8))
...
;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___389 i1)))

;; H
  (assert (=> (and (<= 1 i1) (<= i1 amount)) (= temp___388 result__1)))
...
;; H
  (assert
  (=> (and (<= 1 i1) (<= i1 amount))
  (= (bvand result__3 (let ((temp___392 (- i2 1)))
                      (ite (< temp___392 256)
                      (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___392))
                      ((_ int2bv 8) 0)))) (let ((temp___393 (- i2 1)))
                                          (ite (< temp___393 256)
                                          (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___393))
                                          ((_ int2bv 8) 0))))))
...
;; WP_parameter_def
 ;; File "bits_manipulation.ads", line 3, characters 0-0
  ...
  (let ((temp___400 (- i9 1)))
  (ite (< temp___400 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___400))
  ((_ int2bv 8) 0)))) (let ((temp___401 (- i9 1)))
                      (ite (< temp___401 256)
                      (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___401))
                      ((_ int2bv 8) 0))))))
(check-sat)
(exit)
