...
(declare-fun idvalid1 () Bool)

(declare-fun result3 () Bool)

(declare-fun roleok1 () Bool)
...
;; H
  (assert (not (= tokentry1 2)))

;; H
  (assert (= (mk_bool__ref result1) (mk_bool__ref authvalid)))

;; H
  (assert (= authvalid1 (of_int 0)))

;; H
  (assert (= (mk_bool__ref result2) (mk_bool__ref idvalid)))

;; H
  (assert (= idvalid1 (of_int 0)))

;; H
  (assert (= (mk_bool__ref result3) (mk_bool__ref roleok)))

;; H
  (assert (= roleok1 (of_int 0)))

(assert
;; WP_parameter_def
 ;; File "admintoken.ads", line 40, characters 0-0
  (not (= (to_rep1 (first (mk 1 9))) 1)))
(check-sat)
(exit)
