...
(define-fun register_type__ref___119__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref___84__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref___84__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_5037 us_t1)
  (temp___is_init_5034 Bool) (temp___skip_constant_5035 Bool)
  (temp___do_toplevel_5036 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_5035 true))
                                       (and (dynamic_property2 1 2
                                       (first3 temp___expr_5037)
                                       (last3 temp___expr_5037))
                                       (and (= (first3 temp___expr_5037) 1)
                                       (= (last3 temp___expr_5037) 2)))))
