...
(declare-fun x86__cx__result () (_ BitVec 16))

(declare-fun result () (_ BitVec 16))

(declare-fun x86__cx__result1 () (_ BitVec 16))

(declare-fun x86__cx__result2 () (_ BitVec 16))

(declare-fun x86__cx__result3 () (_ BitVec 16))

(declare-fun x86__cx__result4 () (_ BitVec 16))

(declare-fun x86__cx__result5 () (_ BitVec 16))

;; H
  (assert (= x86__cx__result1 x86__cx__result2))

;; H
  (assert (= x86__cx__result3 x86__cx__result1))

;; H
  (assert (= (mk_t__ref result) (mk_t__ref x86__cx__result)))

;; H
  (assert
  (= x86__cx__result1 ((_ extract 15 0) (bvand rcx ((_ int2bv 64) 65535)))))

;; H
  (assert (= (mk_t__ref x86__cx__result4) (mk_t__ref x86__cx__result2)))

;; H
  (assert (= x86__cx__result5 x86__cx__result3))

(assert
;; WP_parameter_def
 ;; File "x86.ads", line 9, characters 0-0
  (not
  (bvule ((_ zero_extend 48) ((_ int2bv 16) 0)) (bvand rcx ((_ int2bv 64) 65535)))))
(check-sat)
(exit)
