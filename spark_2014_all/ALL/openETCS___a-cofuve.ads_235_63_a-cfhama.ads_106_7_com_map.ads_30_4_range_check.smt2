...
(define-fun default_initial_assumption ((temp___expr_404 us_rep)
  (temp___skip_top_level_405 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_405 true))
                                         (= (length temp___expr_404) 0)))
...
;; H
  (assert
  (and (= o5 (last left)) (and (in_range3 o5) (= o5 (+ 0 (length left))))))
