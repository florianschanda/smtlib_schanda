...
;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= result1 y16)))

;; H
  (assert (=> (bvule x5 ((_ int2bv 32) 2147483647)) (= y5 o18)))
...
;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= result2 y16)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y6 o22)))

;; H
  (assert (=> (not (bvule x5 ((_ int2bv 32) 2147483647))) (= y5 y6)))
...
;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= result5 y15)))

;; H
  (assert (=> (bvule x6 ((_ int2bv 32) 2147483647)) (= y7 o50)))
...
;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= result6 y15)))

;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= y8 o54)))

;; H
  (assert (=> (not (bvule x6 ((_ int2bv 32) 2147483647))) (= y7 y8)))
...
;; H
  (assert (=> (bvule x7 ((_ int2bv 32) 2147483647)) (= result9 y14)))

;; H
  (assert (=> (bvule x7 ((_ int2bv 32) 2147483647)) (= y9 o82)))
...
;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= result10 y14)))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= y10 o86)))

;; H
  (assert (=> (not (bvule x7 ((_ int2bv 32) 2147483647))) (= y9 y10)))
...
;; H
  (assert (=> (bvule x8 ((_ int2bv 32) 2147483647)) (= result13 y13)))

;; H
  (assert (=> (bvule x8 ((_ int2bv 32) 2147483647)) (= y11 o114)))
...
;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= result14 y13)))

;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= y12 o118)))

;; H
  (assert (=> (not (bvule x8 ((_ int2bv 32) 2147483647))) (= y11 y12)))
...
;; H
  (assert (not (bvule x9 ((_ int2bv 32) 2147483647))))

;; H
  (assert (and (= o139 (bv2nat (bvnot x9))) (in_range1 (bv2nat (bvnot x9)))))
