...
;; compare_def_lt
  ...
  (! (= (< (compare1 a a_first a_last b b_first b_last) 0)
     ...
     (or (= i a_last)
     (and (bvult i a_last)
     (< (to_rep2 (select a (bvadd i #x00000001))) (to_rep2
...
;; compare_def_gt
  ...
  (! (= (< 0 (compare1 a a_first a_last b b_first b_last))
     ...
     (or (= i b_last)
     (and (bvult i b_last)
     (< (to_rep2 (select b (bvadd i #x00000001))) (to_rep2
...
(define-fun dynamic_invariant3 ((temp___expr_569 us_rep)
...
(define-fun dynamic_invariant4 ((temp___expr_578 us_rep1)
...
(declare-fun to_string1 (Int (Array (_ BitVec 32) name_id) us_split_fields
  us_split_fields2) us_t)

(declare-fun to_string__function_guard (us_t Int
  (Array (_ BitVec 32) name_id) us_split_fields us_split_fields2) Bool)
...
;; to_string__post_axiom
  ...
  (! (=>
     ...
     (mk___rep char_table__split_discrs names__char_table__fields) true true
     true)) (dynamic_invariant4
     (mk___rep1 entry_table__split_discrs names__entry_table__fields) true
     true true))
     (= (invariant__ names__hash_table names__char_table__fields
        names__entry_table__fields) true))
     (dynamic_invariant
     (to_string1 n names__hash_table names__char_table__fields
     names__entry_table__fields) true false true)) :pattern ((to_string1 n
                                                             names__hash_table
...
;; range_axiom
  (assert
  (forall ((x positive)) (! (in_range2 (to_rep5 x)) :pattern ((to_rep5 x)) )))
...
(((mk_name_entry__ref (name_entry__content us_rep2)))))
...
(define-fun element_type__ref___3__projection ((a element_type__ref)) us_rep2
...
(define-fun dynamic_invariant6 ((temp___expr_436 Int)
...
(define-fun element_type__ref___4__projection ((a element_type__ref1)) us_rep2
...
;; valid_hashes__def_axiom
  ...
  (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true)
     ...
     (=> (and (bvule ((_ int2bv 32) 0) h1) (bvule h1 ((_ int2bv 32) 255)))
     (<= (to_rep2 (select names__hash_table h1)) (last_index
                                                 (mk___rep1
...
(define-fun dynamic_invariant11 ((temp___expr_243 Int)
...
(define-fun dynamic_invariant13 ((temp___expr_282 Int)
...
(define-fun dynamic_invariant14 ((temp___expr_288 Int)
...
;; get__post_axiom
  ...
  (! (=>
     ...
     (dynamic_invariant16 (get1 container position) true false true)) :pattern (
...
(define-fun default_initial_assumption3 ((temp___expr_479 us_rep3)
  (temp___skip_top_level_480 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_480 true))
                                         (= (length1 temp___expr_479) 0)))
...
;; H
  (assert
  (and
  (= temp___6472 (to_string1 ptr2 hash_table
                 (mk___split_fields char_table__split_fields)
                 (mk___split_fields1 entry_table__split_fields)))
  (dynamic_invariant temp___6472 true false true)))

;; H
  (assert
  (= result3 (bool_eq temp___647 (to_rep1 (first temp___6471))
             (to_rep1 (last temp___6471)) (elts s) (to_rep1 (first (rt s)))
             (to_rep1 (last (rt s))))))
