...
;; fliteral_axiom
  (assert
  (and (tqtisFinite fliteral13)
  (= (tqtreal fliteral13) (/ 31412551403045654296875.0 10000000000000000000000.0))))
...
;; H
  (assert
  (and (= o20 (div1 RNE1 num1 (let ((subject den)) den1))) (tqtisFinite
  (div1 RNE1 num1 (let ((subject den)) den1)))))
...
;; WP_parameter_def
 ;; File "system.ads", line 1, characters 0-0
  (not (eq (let ((subject res)) res1) fliteral13)))
(check-sat)
