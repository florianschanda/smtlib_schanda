...
(define-fun task_id__ref___projection ((a task_id__ref)) task_id (task_id__content
                                                                 a))
...
(declare-datatypes ()
((map__ref (mk_map__ref (map__content (Array Int pt))))))
...
(declare-fun concat1 ((Array Int pt) Int Int (Array Int pt) Int
  Int) (Array Int pt))

;; concat_def
  (assert
  (forall ((a (Array Int pt)) (b (Array Int pt)))
