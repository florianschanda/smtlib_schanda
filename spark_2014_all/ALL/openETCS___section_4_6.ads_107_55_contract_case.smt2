...
(declare-datatypes ((etcs_mode_t__ref 0))
(((mk_etcs_mode_t__ref (etcs_mode_t__content etcs_mode_t)))))
...
(declare-datatypes ((priority_t__ref 0))
(((mk_priority_t__ref (priority_t__content priority_t)))))
