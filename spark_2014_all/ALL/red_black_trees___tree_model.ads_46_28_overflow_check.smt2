...
;; H
  (assert
  (and (= o17 (length q)) (and (in_range3 o17) (<= (+ 0 o17) 2147483647))))

;; H
  (assert
  (and (= o14 (length v)) (and (in_range3 o14) (<= (+ 0 o14) 2147483647))))

;; H
  (assert
  (and (= o15 (length p)) (and (in_range3 o15) (<= (+ 0 o15) 2147483647))))
...
;; H
  (assert
  (=> (= result2 true)
  (and (= o12 (length q)) (and (in_range3 o12) (<= (+ 0 o12) 2147483647)))))
...
;; H
  (assert (and (= o9 (get p o8)) (in_range4 o9)))
