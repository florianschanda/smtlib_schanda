...
;; H
  (assert
  (= (bool_eq
     (let ((temp___486 (temp___213 e2)))
     (let ((temp___485 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___485) 0) temp___486
     (concat1 (elts temp___485) (to_rep1 (first (rt temp___485)))
     (to_rep1 (last (rt temp___485))) temp___486 1 1))))
     (to_rep1
     (first
     (let ((temp___485 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___485) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___485)))
     (- (+ (to_rep1 (first (rt temp___485))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___485)))
                                                (to_rep1
                                                (last (rt temp___485))))
...
;; WP_parameter_def
 ;; File "stackp.adb", line 8, characters 0-0
  (not
  (= (bool_eq
     (let ((temp___482 (temp___477 e2)))
     (let ((temp___481 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___481) 0) temp___482
     (concat1 (elts temp___481) (to_rep1 (first (rt temp___481)))
     (to_rep1 (last (rt temp___481))) temp___482 1 1))))
     (to_rep1
     (first
     (let ((temp___481 (get_model__2
                       (mk___rep s__split_fields6 s__attr__tag))))
     (ite (= (length temp___481) 0) (mk 1 1)
     (mk (to_rep1 (first (rt temp___481)))
     (- (+ (to_rep1 (first (rt temp___481))) (+ (ite (<= (to_rep1
                                                         (first
                                                         (rt temp___481)))
                                                (to_rep1
                                                (last (rt temp___481))))
