...
;; H
  (assert
  (and (= o4 (get_previous_track o13 id))
  (and (in_range7 o4)
  (= o4 (to_rep5
        (select (select previous_tracks (to_rep3
                                        (rec__trains__track__from
                                        (us_split_fields3
                                        (select tracks (to_rep1 o3))))))
        id))))))
...
;; H
  (assert
  (=> (= result1 true)
  (and (= temp___338 (get_previous_track o12 id))
  (and (in_range7 temp___338)
  (= temp___338 (to_rep5
                (select (select previous_tracks (to_rep3
                                                (rec__trains__track__from
                                                (us_split_fields3
                                                (select tracks (to_rep1 o9))))))
                id)))))))
...
;; H
  (assert (=> (= result1 true) (= o10 temp___338)))

;; H
  (assert (=> (= result1 true) (= o11 (select track_signals o10))))

;; H
  (assert (=> (= result1 true) (= temp___339 (to_rep2 o11))))
