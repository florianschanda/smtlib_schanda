...
(declare-fun o2 () (Array Int positive))
...
;; H
  (assert
  (forall ((j1 Int))
  (=> (and (<= 1 j1) (<= j1 i2)) (= (to_rep (select content2 j1)) e))))
...
;; H
  ...
  (=> (< i2 temp___223)
  (= (select content2 temp___223) (select content temp___223)))))
