...
(define-fun dynamic_invariant ((temp___expr_557 Int)
...
(define-fun default_initial_assumption ((temp___expr_576 us_rep)
  (temp___skip_top_level_577 Bool)) Bool (=>
                                         (not
                                         (= temp___skip_top_level_577 true))
                                         (= (length temp___expr_576) 0)))
