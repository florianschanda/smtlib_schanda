...
(declare-const dummy5 twrapper2D1)

(declare-datatypes ((twrapper2D1__ref 0))
(((mk_twrapper2D1__ref (twrapper2D1__content twrapper2D1)))))
...
(declare-const should_fail2 (Array Int integer))
