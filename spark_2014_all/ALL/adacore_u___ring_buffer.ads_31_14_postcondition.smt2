...
(declare-fun ring_buffer__get_model__result () us_rep)
...
(declare-fun r10 () model_type__ref)
...
(declare-fun r12 () model_type__ref)

(declare-fun j12 () int__ref)

(declare-fun r13 () us_rep)

(declare-fun j13 () Int)

(declare-fun result4 () model_type__ref)

(declare-fun ring_buffer__get_model__result1 () us_rep)

(declare-fun ring_buffer__get_model__result2 () model_type__ref)

(declare-fun ring_buffer__get_model__result3 () us_rep)

(declare-fun r14 () model_type__ref)

(declare-fun j14 () int__ref)

(declare-fun j15 () int__ref)

(declare-fun ring_buffer__get_model__result4 () model_type__ref)

(declare-fun r15 () us_rep)

(declare-fun j16 () Int)

(declare-fun j17 () Int)

(declare-fun ring_buffer__get_model__result5 () us_rep)
