...
;; H
  (assert (and (= o11 o9) (in_range2 o9)))

;; H
  (assert (= result (ite (<= o11 o10) true false)))
...
;; H
  (assert (= result1 (ite (<= o7 5000) true false)))
...
;; H
  ...
  (= (has_key1
     (positions1
     (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true)
  (= (to_rep
     (select a (element1
               (mk___rep3 d__split_discrs
               (mk___split_fields3 d__split_fields)) c2))) (key
                                                           (mk___rep3
                                                           d__split_discrs
                                                           (mk___split_fields3
                                                           d__split_fields))
...
;; H
  (assert
  (and (= o3 (has_key (positions x) c))
  (= (= o3 true) (= (has_key (positions x) c) true))))

;; H
  (assert (= o4 true))

;; H
  (assert (= result6 (ite (= o4 true) o3 false)))

;; H
  (assert
  (= (= result5 true)
  (forall ((c2 us_rep))
  (=> (= (has_key (positions x) c2) true)
  (= (has_key2
     (model__1
     (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)))
     (element x c2)) true)))))
...
;; H
  (assert (= result9 (ite (<= 0 j) o2 false)))
