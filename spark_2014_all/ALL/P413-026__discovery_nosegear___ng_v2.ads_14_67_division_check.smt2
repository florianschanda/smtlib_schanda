...
;; H
  (assert
  (and (= o6 (timesincelastclickbeforelastupdate prevtime currtime thistime))
  (= o6 (bvadd (timefromlastclicktolastupdate prevtime thistime) (timesincelastupdate
                                                                 currtime
                                                                 thistime)))))
...
;; H
  (assert
  (and
  (= o4 (distancesincelastclickbeforelastupdate prevtime prevcount currtime
        thistime thiscount))
  (= o4 (bvadd (distancefromlastclicktolastupdate prevcount thiscount)
  (distancesincelastupdate prevtime prevcount currtime thistime thiscount)))))
