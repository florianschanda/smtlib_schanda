...
(declare-datatypes ((bits_30__ref 0))
(((mk_bits_30__ref (bits_30__content bits_30)))))
...
(declare-datatypes ((evc_ctrl_type__ref 0))
(((mk_evc_ctrl_type__ref (evc_ctrl_type__content us_rep)))))
...
(declare-const temp___8032 (Array Int bits_8))

(declare-const temp___80321 t2)

(declare-const temp___8033 (Array Int bits_8))

(declare-const temp___80331 t1)
