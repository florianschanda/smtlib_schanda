...
(declare-fun use_lists__my_find__result () count_type)

(declare-fun o () count_type)

(declare-fun o1 () count_type)

(declare-fun temp___482 () count_type)

(declare-fun use_lists__my_find__cu__assume () count_type)

(declare-fun temp___480 () count_type)

(declare-fun o2 () Int)

(declare-fun o3 () Bool)

(declare-fun o4 () count_type)

(declare-fun o5 () us_rep3)

(declare-fun o6 () count_type)
...
(declare-fun use_lists__my_find__result1 () count_type)
...
(declare-fun use_lists__my_find__result2 () us_rep1)

(declare-fun result2 () Bool)

(declare-fun result3 () cursor__ref)

(declare-fun use_lists__my_find__result3 () us_rep1)
...
(declare-fun use_lists__my_find__result4 () cursor__ref)

(declare-fun cu__split_fields5 () us_split_fields2)

(declare-fun use_lists__my_find__result5 () us_rep1)

(declare-fun cu__split_fields6 () us_split_fields__ref1)

(declare-fun use_lists__my_find__result6 () cursor__ref)

(declare-fun cu__split_fields7 () us_split_fields2)

(declare-fun use_lists__my_find__result7 () us_rep1)

(declare-fun result5 () cursor__ref)

(declare-fun use_lists__my_find__result8 () us_rep1)

(declare-fun use_lists__my_find__result9 () cursor__ref)

(declare-fun use_lists__my_find__result10 () us_rep1)

(declare-fun cu__split_fields8 () us_split_fields__ref1)

(declare-fun use_lists__my_find__result11 () cursor__ref)

(declare-fun cu__split_fields9 () us_split_fields2)

(declare-fun use_lists__my_find__result12 () us_rep1)

(declare-fun cu__split_fields10 () us_split_fields__ref1)

(declare-fun use_lists__my_find__result13 () cursor__ref)

(declare-fun cu__split_fields11 () us_split_fields2)

(declare-fun use_lists__my_find__result14 () us_rep1)
...
(define-fun o11 () us_rep1 (mk___rep1 (mk___split_fields1 o6)))

(define-fun o12 () us_rep1 (mk___rep1 (mk___split_fields1 o4)))
...
;; H
  ...
  (= (bool_eq1 o12 no_element) true)
  (and
  (and
  (and (= (has_key (positions l) o12) true)
  (= (get (model__ l) (get1 (positions l) o12)) e))
  (=> (not (= (bool_eq1 no_element no_element) true))
  (<= (get1 (positions l) no_element) (get1 (positions l) o12))))
  (not
  (= (contains (model__ l)
     (ite (= (bool_eq1 no_element no_element) true) 1
     (get1 (positions l) no_element)) (- (get1 (positions l) o12) 1)
     e) true))))))

;; H
  (assert (= result6 (bool_eq1 o12 no_element)))
...
;; H
  ...
  (forall ((i us_rep1))
  (=> (= (has_key o7 i) true)
  (and (and (<= 1 (get1 o7 i)) (<= (get1 o7 i) (length2 l)))
  (forall ((j us_rep1))
  (=> (= (has_key o7 j) true)
  (=> (= (get1 o7 i) (get1 o7 j)) (= (bool_eq1 i j) true))))))))))

;; H
  (assert
  (and (= o8 (get1 o7 (cursor__content use_lists__my_find__result13)))
  (and (in_range5 o8)
  (=> (= (of_int 0) true)
  (and
  (= o8 (w_get o7
        (witness o7 (cursor__content use_lists__my_find__result13))))
  (forall ((k us_rep1))
  (=> (= (has_key o7 k) true)
  (= (= (bool_eq1 k (cursor__content use_lists__my_find__result13)) true)
  (= (witness o7 (cursor__content use_lists__my_find__result13)) (witness
                                                                 o7 k))))))))))

;; H
  (assert
  (and (= o11 (find l e no_element))
  (ite (ite (= (contains (model__ l)
               (ite (= (bool_eq1 no_element no_element) true) 1
               (get1 (positions l) no_element)) (length2 l) e) false) true false)
  ...
  (and
  (and
  (and (= (has_key (positions l) o11) true)
  (= (get (model__ l) (get1 (positions l) o11)) e))
  (=> (not (= (bool_eq1 no_element no_element) true))
  (<= (get1 (positions l) no_element) (get1 (positions l) o11))))
  (not
  (= (contains (model__ l)
     (ite (= (bool_eq1 no_element no_element) true) 1
     (get1 (positions l) no_element)) (- (get1 (positions l) o11) 1)
     e) true))))))
...
;; H
  ...
  (and (in_range5 o9)
  (=> (= (of_int 0) true)
  (and (= o9 (w_get o5 (witness o5 o11)))
  (forall ((k us_rep1))
  (=> (= (has_key o5 k) true)
  (= (= (bool_eq1 k o11) true) (= (witness o5 o11) (witness o5 k))))))))))
...
;; WP_parameter_def
 ;; File "a-cfdlli.ads", line 51, characters 0-0
  (not
  (= (has_key (positions l) (cursor__content use_lists__my_find__result13)) true)))
(check-sat)
(exit)
