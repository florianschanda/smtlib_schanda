...
(declare-const usedlogfiles__split_fields16 (Array Int logfileindext))

(declare-const usedlogfiles__split_fields17 logfileindext)

(declare-const usedlogfiles__split_fields18 logfileindext)

(declare-const usedlogfiles__split_fields19 logfilecountt)
