...
(declare-fun dummy9 () filestatust)
...
(declare-fun dummy10 () tlogentrycounttB)
...
(declare-fun usedlogfiles__split_fields16 () (Array Int logfileindext))

(declare-fun usedlogfiles__split_fields17 () logfileindext)

(declare-fun usedlogfiles__split_fields18 () logfileindext)

(declare-fun usedlogfiles__split_fields19 () logfilecountt)
...
;; H
  (assert
  (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024)
  (= usedlogfiles__split_fields20 (mk___split_fields
...
;; H
  (assert
  (and (= o (+ numberlogentries 1)) (in_range9 (+ numberlogentries 1))))

;; H
  (assert (= (mk_int__ref result) (mk_int__ref numberlogentries)))

;; H
  (assert (= numberlogentries1 o))

;; H
  (assert (= auditsystemfault auditsystemfault2))

;; H
  (assert (= logfileentries1 logfileentries3))
...
;; H
  (assert (= numberlogentries1 numberlogentries2))
...
;; H
  (assert (= logfiles logfiles2))

;; H
  (assert (= auditsystemfault3 auditsystemfault))

;; H
  (assert (= logfileentries4 logfileentries1))

;; H
  (assert
  (= (mk___split_fields usedlogfiles__split_fields16
     usedlogfiles__split_fields17 usedlogfiles__split_fields18
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 553, characters 0-0
  (not
  (= numberlogentries2 (+ (* (- (to_rep2 usedlogfiles__split_fields15) 1) 1024)
  (to_rep1 (select logfileentries3 currentlogfile3))))))
(check-sat)
(exit)
