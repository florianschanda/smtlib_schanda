...
;; H
  ...
  (=> (and (<= 1 j) (<= j (- i2 1)))
  (= (to_rep1
     (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields2)) j)) (+
  (to_rep1
...
;; H
  ...
  (and
  (and
  (and (dynamic_invariant2 (mk___rep1 c__split_discrs c__split_fields2) false
  true true)
  (forall ((temp___787 Int))
  (=>
  (and
  (<= (to_rep2
      (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))) temp___787)
  (<= temp___787 (to_rep2
                 (last2
                 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2))))))
  (=> (<= i2 temp___787)
  (= (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields2)) temp___787) (select
  c__split_fields temp___787))))))
  (=> (<= 1 r7b) (dynamic_property4 1 r7b i2))) (and (<= 1 i2) (<= i2 r7b))))
...
;; H
  ...
  (and
  (<= (to_rep2
      (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2))))
  i2)
  (<= i2 (to_rep2
         (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2)))))))
...
;; H
  (assert
  (= o10 (store (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields2))
  o9 o8)))
...
;; H
  (assert (= (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields2))
  o12))
...
;; H
  (assert
  (= c__split_fields3 (mk___split_fields1 (mk___t1 temp___7841 temp___7842))))
...
;; WP_parameter_def
 ;; File "simple_unc_arrays.ads", line 10, characters 0-0
  (not
  (= (to_rep1
     (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields3))
     j)) (+ (to_rep1
            (select (elts
                    (rec__simple_unc_arrays__table__v (us_split_fields1 a)))
            j)) (to_rep1
