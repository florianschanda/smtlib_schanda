...
;; priv__post_axiom
  (assert
  (forall ((x1 Int))
  (! (=> (dynamic_invariant1 x1 true true true) (dynamic_invariant (priv x1)
     true false true)) :pattern ((priv x1)) )))
...
;; e_priv__post_axiom
  (assert
  (forall ((x1 Int))
  (! (=> (dynamic_invariant1 x1 true true true) (dynamic_invariant
     (e_priv x1) true false true)) :pattern ((e_priv x1)) )))

;; e_priv__def_axiom
  (assert
  (forall ((x1 Int))
  (! (=> (dynamic_invariant1 x1 true true true) (= (e_priv x1) 1)) :pattern (
  (e_priv x1)) )))
