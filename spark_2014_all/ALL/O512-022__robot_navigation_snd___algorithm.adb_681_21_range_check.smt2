...
;; H
  (assert
  (fp.leq (fp.div RNE (to_rep3
                      (rec__robot_iface__proxy__robot_radius
                      (us_split_fields9
                      (rec__algorithm__controller__robot
                      (us_split_fields__content10 this__split_fields1))))) (fp #b0 #b10000010 #b01000000000000000000000))
  (to_rep3
  (rec__robot_iface__proxy__obstacle_avoid_dist
  (us_split_fields9
  (rec__algorithm__controller__robot
...
;; H
  (assert
  (and
  (= o3 (fp.sub RNE (t__content disttoclosestobstacle1) (to_rep3
                                                        (rec__robot_iface__proxy__robot_radius
                                                        (us_split_fields9
                                                        (rec__algorithm__controller__robot
...
;; H
  (assert
  (= o4 (fp.mul RNE (fp #b0 #b10000000 #b10000000000000000000000) o3)))
