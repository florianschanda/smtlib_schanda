...
;; H
  (assert
  (and
  (= o3 (sub RNE1 (t__content disttoclosestobstacle1)
        (to_rep3
        (rec__robot_iface__proxy__robot_radius
        (us_split_fields9
        (rec__algorithm__controller__robot
...
;; H
  (assert (= o4 (mul RNE1 fliteral5 o3)))

;; H
  (assert (and (= o5 o4) (tqtisFinite o4)))
...
;; H
  ...
  (us_split_fields9
  (rec__algorithm__controller__robot
  (us_split_fields__content10 this__split_fields1))))) fliteral4) o6) (le 
  o6
  (to_rep3
  (rec__robot_iface__proxy__obstacle_avoid_dist
  (us_split_fields9
