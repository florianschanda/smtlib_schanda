...
;; H
  ...
  (forall ((g1_id Int))
  (=> (and (<= 1 g1_id) (<= g1_id 64))
  (and (= (to_rep3 (select proposals_made1 g1_id)) 0)
  (= (to_rep
     (select (rec__stable_marriage__matching__group1_set__elements
             (us_split_fields__content unmatched_g1_set__split_fields8)) g1_id)) g1_id)))))
...
;; WP_parameter_def
 ;; File "stable_marriage.ads", line 18, characters 0-0
  ...
  (= (invariant_holds
     (us_split_fields__content unmatched_g1_set__split_fields8)
     proposals_made1 result__1 unmatched_g2_set1) true)))
(check-sat)
(exit)
