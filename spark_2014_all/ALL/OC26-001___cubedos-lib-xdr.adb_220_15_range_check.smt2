...
(declare-fun result15 () (_ BitVec 64))
...
(declare-fun temporary_29 () (_ BitVec 64))
...
(declare-fun temporary_211 () (_ BitVec 64))

(declare-fun result28 () t__ref1)

(declare-fun temporary_212 () (_ BitVec 64))
...
(declare-fun temporary_213 () (_ BitVec 64))

(declare-fun result33 () t__ref1)

(declare-fun temporary_214 () (_ BitVec 64))

(declare-fun result34 () t__ref1)

(declare-fun value7 () (_ BitVec 64))

(declare-fun result35 () t__ref1)
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt data))) (+ position i4))
  (<= (+ position i4) (to_rep1 (last (rt data))))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt data))) (+ position i5))
  (<= (+ position i5) (to_rep1 (last (rt data))))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt data))) (+ position i6))
  (<= (+ position i6) (to_rep1 (last (rt data))))))
...
;; H
  (assert
  (and (<= (to_rep1 (first (rt data))) (+ position i7))
  (<= (+ position i7) (to_rep1 (last (rt data))))))
