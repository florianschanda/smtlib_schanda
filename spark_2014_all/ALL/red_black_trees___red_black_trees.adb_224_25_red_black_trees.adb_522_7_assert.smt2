...
(declare-fun n89 () int__ref)

(declare-fun n90 () Int)

(declare-fun n91 () int__ref)
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100))
  (= temp___960 (let ((subject n7)) n87))))
...
;; H
  (assert
  (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100))
  (= (let ((subject n7)) n88) 100)))

;; H
  (assert
  (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100))
  (= n89 (let ((subject n7)) (mk_int__ref n88)))))
...
;; H
  ...
  (not
  (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)))
  (= n91 (let ((subject n7)) (mk_int__ref n87)))))
