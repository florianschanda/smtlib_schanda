...
(define-fun register_type__ref_63__projection ((a register_type__ref)) us_rep
...
(define-fun tregister_byte_arrayP1__ref_45__projection ((a tregister_byte_arrayP1__ref)) integer
...
(define-fun register_byte_array__ref_45__projection ((a register_byte_array__ref)) us_t1
  (register_byte_array__content a))

(define-fun dynamic_invariant ((temp___expr_3499 us_t1)
  (temp___is_init_3496 Bool) (temp___skip_constant_3497 Bool)
  (temp___do_toplevel_3498 Bool)) Bool (=>
                                       (not
                                       (= temp___skip_constant_3497 true))
                                       (and (dynamic_property2 1 4
                                       (first3 temp___expr_3499)
                                       (last3 temp___expr_3499))
                                       (and (= (first3 temp___expr_3499) 1)
                                       (= (last3 temp___expr_3499) 4)))))
