...
;; H
  ...
  (= o9 (mk___split_fields
        ...
        (us_split_fields__content usedlogfiles__split_fields6))
        (rec__auditlog__logfilelistt__head
        (us_split_fields__content usedlogfiles__split_fields6)) o8
        (rec__auditlog__logfilelistt__length
        (us_split_fields__content usedlogfiles__split_fields6)))))
...
;; H
  (assert (= result6 usedlogfiles__split_fields6))

;; H
  (assert (= usedlogfiles__split_fields8 (us_split_fields1 temp___1203)))
...
;; WP_parameter_def
 ;; File "auditlog.adb", line 174, characters 0-0
  (not (in_range6
  (+ (to_rep3
     (rec__auditlog__logfilelistt__length usedlogfiles__split_fields8)) 1))))
(check-sat)
(exit)
