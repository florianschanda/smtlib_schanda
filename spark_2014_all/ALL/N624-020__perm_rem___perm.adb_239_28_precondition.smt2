...
(define-fun o28 () us_t (mk___t o11 o12))

(define-fun o29 () us_t (mk___t o8 o9))

(define-fun o30 () us_t (mk___t o6 o7))
...
;; H
  (assert
  (and (= o28 (remove a o10))
  (and (dynamic_invariant2 o28 true false true)
...
;; H
  (assert
  (and (= o16 (shift_perm_l o30 o29 o27))
  (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o27 o29) true)))))
