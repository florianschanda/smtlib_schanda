...
;; H
  (assert
  (and (= o (sqrt2 (of_ubv32 RNA1 i)))
  (and (tqtisFinite o)
  (and (le fliteral2 o)
  (and (=> (eq (of_ubv32 RNA1 i) fliteral2) (eq o fliteral2))
  (and (=> (eq (of_ubv32 RNA1 i) fliteral) (eq o fliteral))
  (=> (le fliteral3 (of_ubv32 RNA1 i)) (lt fliteral2 o))))))))
...
;; WP_parameter_def
 ;; File "interfac.ads", line 74, characters 0-0
  (not (le (of_ubv32 RTP1 ((_ int2bv 32) 0)) o1)))
(check-sat)
