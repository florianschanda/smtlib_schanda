...
(define-fun dynamic_invariant ((temp___expr_181 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (dyn_pred_in_loop__L_1__i Int)) Bool (and (=> (or (= temp___is_init_178 true) (<= 0 2147483647)) (in_range2 temp___expr_181)) (=> (= temp___do_toplevel_180 true) (=> (= temp___is_init_178 true) (< (* temp___expr_181 dyn_pred_in_loop__L_1__i) 2147483647)))))
