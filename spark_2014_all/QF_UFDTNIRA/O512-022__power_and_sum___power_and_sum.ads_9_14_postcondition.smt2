...
(define-fun innersum16 () int__ref (mk_int__ref innersum8))
...
(assert (=> (<= i1 n) (= temp___584 totalsum1)))
(assert (=> (<= i1 n) (= temp___583 j1)))
(assert (=> (<= i1 n) (= temp___582 i1)))
(assert (=> (<= i1 n) (= temp___581 innersum1)))
...
(assert (=> (<= i1 n) (= j3 1)))
(assert (=> (<= i1 n) (=> (<= j3 i2) (= temp___580 j3))))
(assert (=> (<= i1 n) (=> (<= j3 i2) (= temp___579 innersum3))))
...
(assert (=> (<= i1 n) (=> (<= j3 i2) (= innersum16 (mk_int__ref innersum6)))))
(assert (=> (<= i1 n) (=> (<= j3 i2) (= j16 (mk_int__ref j6)))))
...
(assert (=> (<= i1 n) (= innersum10 innersum16)))
...
(assert (and (= o4 (int__content totalsum6)) (in_range3 (int__content totalsum6))))
(assert (= result10 (mk_int__ref result__)))
(assert (= result__1 o4))
(assert (= innersum14 innersum12))
(assert (= totalsum8 totalsum6))
(assert (= j14 j12))
(assert (= i8 i6))
(assert (= result__2 (mk_int__ref result__1)))
(assert (= innersum15 innersum13))
(assert (= totalsum9 totalsum7))
(assert (= j15 j13))
(assert (= i9 i7))
