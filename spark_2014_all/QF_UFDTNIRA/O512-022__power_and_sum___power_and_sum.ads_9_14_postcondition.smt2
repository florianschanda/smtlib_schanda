...
(assert (and (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 1)) (and (in_range3 i1) (and (and (= (mk_int__ref result1) (mk_int__ref j)) (= j1 1)) (and (in_range3 j1) (and (and (= (mk_int__ref result2) (mk_int__ref totalsum)) (= totalsum1 0)) (and (in_range2 totalsum1) (and (and (= (mk_int__ref result3) (mk_int__ref innersum)) (= innersum1 0)) (and (in_range2 innersum1) (and (ite (<= i1 n) (and (and (and (= temp___514 totalsum1) (and (= temp___513 j1) (and (= temp___512 i1) (and (= temp___511 innersum1) (and (= (* 6 totalsum2) (* (* (- i2 1) i2) (+ i2 1))) (and (and (and (and (and (=> (<= 0 2147483647) (in_range2 innersum2)) (=> (<= 1 2147483647) (in_range3 i2))) (=> (<= 1 2147483647) (in_range3 j2))) (=> (<= 0 2147483647) (in_range2 totalsum2))) (<= i2 n)) (and (and (= innersum2 result4) (= innersum3 0)) (and (and (= j2 result5) (= j3 1)) (and (ite (<= j3 i2) (and (and (and (= temp___510 j3) (and (= temp___509 innersum3) (and (= (* 2 innersum4) (* j4 (- j4 1))) (and (and (and (=> (<= 0 2147483647) (in_range2 innersum4)) (=> (<= 1 2147483647) (in_range3 j4))) (<= j4 i2)) (and (and (and (= o (+ innersum4 j4)) (in_range1 (+ innersum4 j4))) (and (= innersum4 result6) (= innersum5 o))) (and (and (and (= o1 (+ j4 1)) (in_range1 (+ j4 1))) (and (= j4 result7) (= j5 o1))) (not (<= j5 i2)))))))) (and (and (= innersum5 innersum8) (= j5 j8)) (and (= innersum9 innersum5) (= j9 j5)))) (and (and (= (mk_int__ref innersum10) (mk_int__ref innersum8)) (= (mk_int__ref j10) (mk_int__ref j8))) (and (= innersum11 innersum9) (= j11 j9)))) (and (and (= innersum3 innersum10) (= j3 j10)) (and (= innersum11 innersum3) (= j11 j3)))) (and (= j10 (+ i2 1)) (and (= (* 2 innersum10) (* i2 (+ i2 1))) (and (and (and (= o2 (+ totalsum2 innersum10)) (in_range1 (+ totalsum2 innersum10))) (and (= totalsum2 result8) (= totalsum3 o2))) (and (and (and (= o3 (+ i2 1)) (in_range1 (+ i2 1))) (and (= i2 result9) (= i3 o3))) (not (<= i3 n))))))))))))))) (and (and (= innersum16 (mk_int__ref innersum10)) (and (= totalsum8 (mk_int__ref totalsum3)) (and (= j16 (mk_int__ref j10)) (= i8 (mk_int__ref i3))))) (and (= innersum17 innersum11) (and (= totalsum9 totalsum3) (and (= j17 j11) (= i9 i3)))))) (and (and (= innersum18 innersum16) (and (= totalsum10 totalsum8) (and (= j18 j16) (= i10 i8)))) (and (= innersum19 innersum17) (and (= totalsum11 totalsum9) (and (= j19 j17) (= i11 i9)))))) (and (and (= innersum18 (mk_int__ref innersum1)) (and (= totalsum10 (mk_int__ref totalsum1)) (and (= j18 (mk_int__ref j1)) (= i10 (mk_int__ref i1))))) (and (= innersum19 innersum1) (and (= totalsum11 totalsum1) (and (= j19 j1) (= i11 i1)))))) (and (= (* 6 (int__content totalsum10)) (* (* n (+ n 1)) (+ n 2))) (and (and (= o4 (int__content totalsum10)) (in_range3 (int__content totalsum10))) (and (= result10 (mk_int__ref result__)) (= result__1 o4))))))))))))) (and (and (= innersum20 innersum18) (and (= totalsum12 totalsum10) (and (= j20 j18) (and (= i12 i10) (= result__2 (mk_int__ref result__1)))))) (and (= innersum21 innersum19) (and (= totalsum13 totalsum11) (and (= j21 j19) (and (= i13 i11) (= result__3 result__1))))))))
(assert (not (= (* 6 (int__content result__2)) (* (* n (+ n 1)) (+ n 2)))))
(check-sat)
(exit)
