...
(assert (= j10 (+ i2 1)))
(assert (= (* 2 innersum10) (* i2 (+ i2 1))))
(assert (and (= o2 (+ totalsum2 innersum10)) (in_range1 (+ totalsum2 innersum10))))
...
(assert (= i3 o3))
(assert (<= i3 n))
(assert (= innersum12 (mk_int__ref innersum10)))
(assert (= totalsum4 (mk_int__ref totalsum3)))
(assert (= j12 (mk_int__ref j10)))
(assert (= i4 (mk_int__ref i3)))
(assert (= innersum13 innersum11))
