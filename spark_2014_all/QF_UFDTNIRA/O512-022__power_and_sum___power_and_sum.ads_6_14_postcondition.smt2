...
(define-fun totalsum10 () int__ref (mk_int__ref totalsum6))
...
(assert (=> (<= i1 n) (= temp___578 totalsum1)))
(assert (=> (<= i1 n) (= temp___577 i1)))
...
(assert (=> (<= i1 n) (= i5 i3)))
(assert (=> (<= i1 n) (= totalsum10 (mk_int__ref totalsum4))))
(assert (=> (<= i1 n) (= i10 (mk_int__ref i4))))
...
(assert (and (= o2 totalsum6) (in_range3 totalsum6)))
(assert (= result4 result__))
(assert (= result__1 o2))
(assert (= (mk_int__ref totalsum8) totalsum10))
