...
(declare-const totalsum4 Int)
(declare-const i5 Int)
(declare-const totalsum5 Int)
(declare-const i6 Int)
(declare-const totalsum6 Int)
(declare-const i7 Int)
(declare-const totalsum7 Int)
(declare-const i8 Int)
(declare-const totalsum8 Int)
...
(assert (<= i1 n))
(assert (= (* 2 totalsum2) (* i2 (- i2 1))))
(assert (and (and (=> (<= 1 2147483647) (in_range3 i2)) (=> (<= 0 2147483647) (in_range2 totalsum2))) (<= i2 n)))
(assert (and (= o (+ totalsum2 i2)) (in_range1 (+ totalsum2 i2))))
(assert (= totalsum2 result2))
(assert (= totalsum3 o))
(assert (and (= o1 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= i2 result3))
(assert (= i3 o1))
(assert (<= i3 n))
(assert (not (= (* 2 totalsum3) (* i3 (- i3 1)))))
(check-sat)
(exit)
