...
(assert (= r1 m))
(assert (=> (<= n r1) (and (and (= temp___133 r1) (and (= temp___132 q1) (and (and (and (<= q2 (- m r2)) (= m (+ (* q2 n) r2))) (<= 0 r2)) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 q2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r2))) (<= n r2)) (and (and (and (= o4 (+ q2 1)) (in_range1 (+ q2 1))) (and (= q2 result3) (= q3 o4))) (and (and (and (= o5 (- r2 n)) (in_range1 (- r2 n))) (and (= r2 result4) (= r3 o5))) (not (<= n r3)))))))) (and (and (= r3 r6) (= q3 q6)) (and (= r7 r3) (= q7 q3))))))
(assert (=> (<= n r1) (= (mk_int__ref r8) (mk_int__ref r6))))
(assert (=> (<= n r1) (= (mk_int__ref q8) (mk_int__ref q6))))
(assert (=> (<= n r1) (= r9 r7)))
(assert (=> (<= n r1) (= q9 q7)))
(assert (=> (not (<= n r1)) (= r1 r8)))
(assert (=> (not (<= n r1)) (= q1 q8)))
(assert (=> (not (<= n r1)) (= r9 r1)))
(assert (=> (not (<= n r1)) (= q9 q1)))
(assert (= (mk_int__ref r10) (mk_int__ref r8)))
(assert (= (mk_int__ref q10) (mk_int__ref q8)))
(assert (= r11 r9))
(assert (= q11 q9))
(assert (and (= o6 (* q10 n)) (in_range1 (* q10 n))))
(assert (= o7 (+ o6 r10)))
