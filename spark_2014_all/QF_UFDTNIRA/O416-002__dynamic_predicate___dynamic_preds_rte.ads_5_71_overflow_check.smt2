...
(define-fun dynamic_invariant ((temp___expr_145 Int) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (and (=> (or (= temp___is_init_142 true) (<= 0 2147483647)) (in_range1 temp___expr_145)) (=> (= temp___do_toplevel_144 true) (=> (= temp___is_init_142 true) (< (* temp___expr_145 temp___expr_145) 100000)))))
