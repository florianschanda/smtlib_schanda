...
(assert (= j result3))
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___155 j1)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= temp___154 x3)))
(assert (=> (and (<= 1 j1) (<= j1 10)) (= x4 (* i2 (- j2 1)))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 x4)) (=> (<= 1 10) (in_range3 j2))) (and (<= 1 j2) (<= j2 10)))))
(assert (=> (and (<= 1 j1) (<= j1 10)) (and (= o (* i2 j2)) (in_range1 (* i2 j2)))))
