...
(assert (= j2 result3))
(assert (= j3 1))
(assert (=> (and (<= 1 j3) (<= j3 10)) (and (and (= temp___133 j3) (and (= temp___132 x3) (and (= x4 (* i2 (- j4 1))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 x4)) (=> (<= 1 10) (in_range3 j4))) (and (<= 1 j4) (<= j4 10))) (and (and (and (= o2 (* i2 j4)) (in_range1 (* i2 j4))) (and (= x4 result4) (= x5 o2))) (and (not (<= 45 x5)) (= j4 10))))))) (and (and (= j4 j8) (= x5 x8)) (and (= j9 j4) (= x9 x5))))))
(assert (=> (and (<= 1 j3) (<= j3 10)) (= (mk_int__ref j10) (mk_int__ref j8))))
(assert (=> (and (<= 1 j3) (<= j3 10)) (= (mk_int__ref x10) (mk_int__ref x8))))
(assert (=> (and (<= 1 j3) (<= j3 10)) (= j11 j9)))
(assert (=> (and (<= 1 j3) (<= j3 10)) (= x11 x9)))
(assert (=> (not (and (<= 1 j3) (<= j3 10))) (= j3 j10)))
(assert (=> (not (and (<= 1 j3) (<= j3 10))) (= x3 x10)))
(assert (=> (not (and (<= 1 j3) (<= j3 10))) (= j11 j3)))
(assert (=> (not (and (<= 1 j3) (<= j3 10))) (= x11 x3)))
(assert (not (= i2 10)))
(assert (= result6 i2))
(assert (= i3 (+ i2 1)))
(assert (= j14 (mk_int__ref j10)))
(assert (= i3 i4))
(assert (= (mk_int__ref x14) (mk_int__ref x10)))
(assert (= j15 j11))
(assert (= i5 i3))
(assert (= x15 x11))
(assert (not (= x14 (* (- i4 1) 10))))
(check-sat)
(exit)
