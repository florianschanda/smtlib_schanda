...
(assert (=> (= result true) (= main__is_right_angle_triangle__result1 (of_int 1))))
...
(assert (=> (not (= result true)) (= main__is_right_angle_triangle__result2 (of_int 0))))
...
(assert (not (in_range1 (* long_side long_side))))
(check-sat)
(exit)
