...
(assert (=> (<= i1 n) (and (and (= temp___508 totalsum1) (and (= temp___507 i1) (and (= (* 2 totalsum2) (* i2 (- i2 1))) (and (and (and (=> (<= 1 2147483647) (in_range3 i2)) (=> (<= 0 2147483647) (in_range2 totalsum2))) (<= i2 n)) (and (and (and (= o (+ totalsum2 i2)) (in_range1 (+ totalsum2 i2))) (and (= totalsum2 result2) (= totalsum3 o))) (and (and (and (= o1 (+ i2 1)) (in_range1 (+ i2 1))) (and (= i2 result3) (= i3 o1))) (not (<= i3 n)))))))) (and (and (= totalsum3 totalsum6) (= i3 i6)) (and (= totalsum7 totalsum3) (= i7 i3))))))
(assert (=> (<= i1 n) (= (mk_int__ref totalsum8) (mk_int__ref totalsum6))))
(assert (=> (<= i1 n) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (<= i1 n) (= totalsum9 totalsum7)))
(assert (=> (<= i1 n) (= i9 i7)))
(assert (=> (not (<= i1 n)) (= totalsum1 totalsum8)))
(assert (=> (not (<= i1 n)) (= i1 i8)))
(assert (=> (not (<= i1 n)) (= totalsum9 totalsum1)))
(assert (=> (not (<= i1 n)) (= i9 i1)))
(assert (= (* 2 totalsum8) (* n (+ n 1))))
(assert (not (in_range3 totalsum8)))
(check-sat)
(exit)
