...
(assert (and (= o3 (ccwdiff (rec__algorithm__laser_scan_data__second rayr__split_fields2) (rec__algorithm__laser_scan_data__second rayl__split_fields2))) (fp.isFinite32 o3)))
(assert (and (= o4 (cos1 o3)) (and (fp.isFinite32 o4) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) o4) (fp.leq o4 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq o3 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq o4 (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (and (= o1 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(assert (= o2 (fp.mul RNE o1 (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)))))
(assert (and (= o5 o2) (fp.isFinite32 o2)))
(assert (= o6 (fp.mul RNE o5 o4)))
...
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(check-sat)
(exit)
