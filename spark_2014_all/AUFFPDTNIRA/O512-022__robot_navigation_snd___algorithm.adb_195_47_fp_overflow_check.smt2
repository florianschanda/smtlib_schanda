...
(assert (and (= o1 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(assert (= o2 (fp.mul RNE o1 (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)))))
...
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(check-sat)
(exit)
