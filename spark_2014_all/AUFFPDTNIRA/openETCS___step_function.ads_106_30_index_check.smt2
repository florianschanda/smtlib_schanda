...
(assert (and (<= 0 i) (<= i 10)))
(assert (= o76 i))
(assert (= o77 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun1)) o76)))
