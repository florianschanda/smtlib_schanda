...
(assert (= o29 i2))
(assert (= (mk___rep (mk___split_fields o30 o31)) (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o29)))
(assert (= o30 o32))
(assert (= o31 o33))
(assert (= o34 o33))
(assert (= o35 (to_rep o34)))
(assert (= o36 (ite (fp.eq (t__content step_function__minimum_until_point__result4) o35) true false)))
(assert (not (<= 0 i2)))
(check-sat)
(exit)
