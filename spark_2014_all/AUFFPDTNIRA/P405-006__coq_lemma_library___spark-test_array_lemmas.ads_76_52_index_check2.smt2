...
(define-fun bool_eq ((a (Array Int float)) (a__first Int) (a__last Int) (b (Array Int float)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (to_rep (select a temp___idx_155)) (to_rep (select b (+ (- b__first a__first) temp___idx_155))))))) true false))
...
(define-fun of_array ((a (Array Int float)) (f Int) (l Int)) us_t (mk___t a (mk f l)))
...
(assert (forall ((a (Array Int float))) (<= 0 (object__component__size a))))
...
(define-fun of_array1 ((a (Array Int float)) (f Int) (l Int)) us_t1 (mk___t1 a (mk1 f l)))
...
(assert (forall ((a (Array Int float))) (<= 0 (object__component__size1 a))))
...
(declare-datatypes () ((arr_float_unconstrained__ref (mk_arr_float_unconstrained__ref (arr_float_unconstrained__content us_t1)))))
(define-fun arr_float_unconstrained__ref___projection ((a arr_float_unconstrained__ref)) us_t1 (arr_float_unconstrained__content a))
(define-fun dynamic_invariant ((temp___expr_195 us_t1) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool) (temp___do_typ_inv_194 Bool)) Bool (=> (not (= temp___skip_constant_192 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_195) (last3 temp___expr_195))))
...
(define-fun dynamic_invariant3 ((temp___expr_248 us_t) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool) (temp___do_typ_inv_247 Bool)) Bool (=> (not (= temp___skip_constant_245 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_248) (last1 temp___expr_248))))
(declare-const o (Array Int float))
(declare-const o1 t)
(declare-const i Int)
(declare-const j Int)
(assert (dynamic_invariant arr true false true true))
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep1 (first2 (rt1 arr))) 1) i1) (<= i1 (to_rep1 (last2 (rt1 arr))))) (fp.lt (to_rep (select (elts1 arr) (- i1 1))) (to_rep (select (elts1 arr) i1))))))
(assert (dynamic_property (- 2147483648) 2147483647 (to_rep1 (first2 (rt1 arr))) (to_rep1 (last2 (rt1 arr)))))
(assert (= (elts1 arr) o))
(assert (= (mk (to_rep1 (first2 (rt1 arr))) (to_rep1 (last2 (rt1 arr)))) o1))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first o1)) i1) (<= i1 (to_rep1 (last o1)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first o1)) j1) (<= j1 (to_rep1 (last o1)))) (=> (< i1 j1) (fp.lt (to_rep (select o i1)) (to_rep (select o j1)))))))))
(assert (<= (to_rep1 (first2 (rt1 arr))) i))
(assert (<= i (to_rep1 (last2 (rt1 arr)))))
(assert (<= (to_rep1 (first2 (rt1 arr))) j))
(assert (<= j (to_rep1 (last2 (rt1 arr)))))
(assert (< i j))
(assert (not (<= (to_rep1 (first2 (rt1 arr))) j)))
(check-sat)
(exit)
