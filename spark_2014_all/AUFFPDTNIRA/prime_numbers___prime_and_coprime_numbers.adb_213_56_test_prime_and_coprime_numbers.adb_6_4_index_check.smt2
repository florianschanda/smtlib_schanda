...
(assert (forall ((temp___252 Bool)) (forall ((temp___253 Int)) (= (select (temp___250 temp___252) temp___253) temp___252))))
...
(assert (forall ((v4 Int)) (=> (and (<= 0 v4) (<= v4 index_22)) (= (= (select is_prime5 v4) true) (= (is_prime v4) true)))))
(assert (forall ((v4 Int)) (=> (and (<= index_22 v4) (<= v4 100000)) (= (= (select is_prime5 v4) true) (forall ((div4 Int)) (=> (and (<= 2 div4) (<= div4 (- index_22 1))) (not (= (mod2 v4 div4) 0))))))))
(assert (and (and (and (=> (<= 2 r87b) (dynamic_property 2 r87b index_22)) (=> (<= 0 2147483647) (in_range2 index_12))) (=> (<= (- 2147483648) 2147483647) (in_range1 index_32))) (and (<= 2 index_22) (<= index_22 r87b))))
(assert (<= 0 v))
(assert (<= v index_22))
(assert (and (= o (is_prime v)) (= (= o true) (and (<= 2 v) (forall ((v4 Int)) (=> (and (<= 2 v4) (<= v4 (- v 1))) (not (= (mod2 v v4) 0))))))))
(assert (= o1 (to_int2 o)))
(assert (not (<= 0 v)))
(check-sat)
(exit)
