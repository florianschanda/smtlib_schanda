...
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 index_11)) (=> (<= (- 2147483648) 2147483647) (in_range1 index_31))) (=> (<= 2 r87b) (dynamic_property 2 r87b index_22))) (and (<= 2 index_22) (<= index_22 r87b))))
(assert (<= 0 v))
(assert (<= v index_22))
(assert (and (= o (is_prime v)) (= (= o true) (and (<= 2 v) (forall ((v1 Int)) (=> (and (<= 2 v1) (<= v1 (- v 1))) (not (= (mod2 v v1) 0))))))))
(assert (= o1 (to_int2 o)))
(assert (not (<= 0 v)))
(check-sat)
(exit)
