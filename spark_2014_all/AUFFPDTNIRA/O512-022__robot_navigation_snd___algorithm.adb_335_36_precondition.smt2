...
(define-fun o24 () us_rep3 (mk___rep3 (mk___split_fields3 (mk___rep (mk___split_fields o3)) o4 o5)))
...
(assert (=> (= result4 true) (and (= o24 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 riterr__split_fields3))) (= (bool_eq6 o24 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 riterr__split_fields3)))) true))))
...
(assert (and (= o23 (previous (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 riterl__split_fields2))) (ite (= (ite (= (bool_eq8 (mk___rep5 riterl__split_fields2) no_element) false) (= (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 riterl__split_fields2)) 1) true) true) (= (bool_eq8 o23 no_element) true) (and (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) o23) true) (= (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) o23) (- (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 riterl__split_fields2)) 1))))))
