...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 2)) (and (and (not (fp.eq (to_rep (select d j1)) (fp #b0 #b00000000 #b00000000000000000000000))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kv j1)))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka j1)))))))
...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kvp2 j1))))))
