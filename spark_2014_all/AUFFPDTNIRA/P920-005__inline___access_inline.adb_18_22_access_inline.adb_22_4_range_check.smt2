...
(define-fun dynamic_invariant ((temp___expr_172 Float32) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111101110)) (fp #b0 #b11111110 #b11111111111111111101110))) (in_range temp___expr_172)))
...
(declare-fun concat1 ((Array Int t_angle_360) Int Int (Array Int t_angle_360) Int Int) (Array Int t_angle_360))
(assert (forall ((a (Array Int t_angle_360)) (b (Array Int t_angle_360))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (t_angle_360 Int) (Array Int t_angle_360))
(assert (forall ((v t_angle_360)) (forall ((i Int)) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array Int t_angle_360)) (a__first Int) (a__last Int) (b (Array Int t_angle_360)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((temp___197 Float32)) (forall ((temp___198 Int)) (= (select (access_inline__angle__aggregate_def temp___197) temp___198) (of_rep temp___197)))))
(assert (= c_2pi_in_degrees (fp #b0 #b10000111 #b01101000000000000000000)))
(define-fun dynamic_invariant1 ((temp___expr_178 Float32) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000111 #b01101000000000000000000))) (in_range1 temp___expr_178)))
...
(assert (in_range c6b))
(assert (and (= o (fp.sub RNE (to_rep (select angle1 3)) (to_rep (select angle1 3)))) (fp.isFinite32 (fp.sub RNE (to_rep (select angle1 3)) (to_rep (select angle1 3))))))
