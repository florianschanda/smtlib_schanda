...
(assert (= sec_3_13_2_monitoring_inputs__kwet_rst__result1 sec_3_13_2_monitoring_inputs__kwet_rst__result2))
(assert (= sec_3_13_2_monitoring_inputs__kwet_rst__result3 sec_3_13_2_monitoring_inputs__kwet_rst__result1))
(assert (and (= o13 (to_int1 RNA v)) (in_range1 (to_int1 RNA v))))
(assert (and (= o14 (get_value kwet_rst_model o13)) (and (fp.isFinite32 o14) (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 kwet_rst_model))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kwet_rst_model)) i)))) o13) (< o13 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kwet_rst_model)) (+ i 1))))))) (fp.eq o14 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kwet_rst_model)) i)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kwet_rst_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 kwet_rst_model))))))) o13) (fp.eq o14 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kwet_rst_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 kwet_rst_model)))))))))))))
(assert (= (mk_t__ref result) (mk_t__ref sec_3_13_2_monitoring_inputs__kwet_rst__result)))
(assert (= sec_3_13_2_monitoring_inputs__kwet_rst__result1 o14))
(assert (= (mk_t__ref sec_3_13_2_monitoring_inputs__kwet_rst__result4) (mk_t__ref sec_3_13_2_monitoring_inputs__kwet_rst__result2)))
(assert (= sec_3_13_2_monitoring_inputs__kwet_rst__result5 sec_3_13_2_monitoring_inputs__kwet_rst__result3))
(assert (and (= o15 (to_int1 RNA v)) (in_range1 (to_int1 RNA v))))
