...
(assert (and (= o2 (ccwdiff (rec__algorithm__laser_scan_data__second rayr__split_fields7) (rec__algorithm__laser_scan_data__second rayl__split_fields7))) (fp.isFinite32 o2)))
(assert (and (= o3 (cos1 o2)) (and (fp.isFinite32 o3) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) o3) (fp.leq o3 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq o2 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq o3 (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (not (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))
(check-sat)
(exit)
