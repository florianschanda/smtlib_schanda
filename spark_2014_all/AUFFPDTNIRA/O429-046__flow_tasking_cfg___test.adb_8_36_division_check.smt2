...
(define-fun dynamic_invariant2 ((temp___expr_467 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 0 255)) (in_range5 temp___expr_467)))
...
(define-fun default_initial_assumption ((temp___expr_517 us_rep) (temp___skip_top_level_518 Bool)) Bool (= (to_rep2 (rec__support__protT__summary (us_split_fields1 temp___expr_517))) 0))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_525 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_525 us_void_param) 2)) 118)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 5)) 97)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 6)) 103)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 10)) 117)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 11)) 109)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 12)) 98)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 14)) 114)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 17)) 115)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 18)) 58)) (= (to_rep (select (temp___String_Literal_525 us_void_param) 19)) 32)) :pattern ((temp___String_Literal_525 us_void_param)))))
