...
(define-fun dynamic_invariant2 ((temp___expr_473 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 0 255)) (in_range5 temp___expr_473)))
...
(define-fun default_initial_assumption ((temp___expr_523 us_rep) (temp___skip_top_level_524 Bool)) Bool (= (to_rep2 (rec__support__protT__summary (us_split_fields1 temp___expr_523))) 0))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun get (us_rep) Int)
(declare-fun get__function_guard (Int us_rep) Bool)
(assert (forall ((self__ us_rep)) (! (dynamic_invariant (get self__) true false true) :pattern ((get self__)))))
(declare-const g Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const f Float32)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-fun temp___String_Literal_531 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_531 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_531 us_void_param) 2)) 118)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 5)) 97)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 6)) 103)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 10)) 117)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 11)) 109)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 12)) 98)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 14)) 114)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 17)) 115)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 18)) 58)) (= (to_rep (select (temp___String_Literal_531 us_void_param) 19)) 32)) :pattern ((temp___String_Literal_531 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_217 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 0 97)) (in_range4 temp___expr_217)))
