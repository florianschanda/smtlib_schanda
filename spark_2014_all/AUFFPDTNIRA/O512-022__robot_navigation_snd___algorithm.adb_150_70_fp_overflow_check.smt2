...
(assert (forall ((x unbounded_float)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x unbounded_float)) (! (fp.isFinite32 (to_rep8 x)) :pattern ((to_rep8 x)))))
(assert (forall ((x Float32)) (! (=> (fp.isFinite32 x) (= (to_rep8 (of_rep8 x)) x)) :pattern ((to_rep8 (of_rep8 x))))))
...
(assert (forall ((x option)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x option)) (! (in_range9 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun robot_iface__speed_option__modulus__pred ((a us_rep3)) Bool (= (to_rep9 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))
(define-fun robot_iface__speed_option__angle__pred ((a us_rep3)) Bool (= (to_rep9 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))
(define-fun bool_eq6 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep9 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) (to_rep9 (rec__robot_iface__speed_option__opt (us_split_discrs1 b)))) (and (=> (robot_iface__speed_option__modulus__pred a) (= (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields7 a))) (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields7 b))))) (=> (robot_iface__speed_option__angle__pred a) (= (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields7 a))) (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields7 b))))))) true false))
...
(define-fun us_split_fields_first__projection ((a us_split_fields10)) nonnegative_float (rec__algorithm__laser_scan_data__first a))
...
(define-fun bool_eq8 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (to_rep6 (rec__algorithm__laser_scan_data__first (us_split_fields11 a))) (to_rep6 (rec__algorithm__laser_scan_data__first (us_split_fields11 b)))) (= (bool_eq2 (rec__algorithm__laser_scan_data__second (us_split_fields11 a)) (rec__algorithm__laser_scan_data__second (us_split_fields11 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__algorithm__controller__robot us_rep4) (rec__algorithm__controller__laserscan (Array Int us_rep5)) (rec__algorithm__controller__gapvec us_rep6) (rec__algorithm__controller__obsavoiddelta float) (rec__algorithm__controller__driveangle us_rep)))))
(define-fun us_split_fields_robot__projection ((a us_split_fields14)) us_rep4 (rec__algorithm__controller__robot a))
...
(define-fun in_range12 ((rec__robot_iface__speed_option__opt1 Int) (a us_rep3)) Bool (= rec__robot_iface__speed_option__opt1 (to_rep9 (rec__robot_iface__speed_option__opt (us_split_discrs1 a)))))
...
(define-fun default_initial_assumption ((temp___expr_678 us_rep7) (temp___skip_top_level_679 Bool)) Bool (and (and (and (and (= (rec__algorithm__controller__robot (us_split_fields15 temp___expr_678)) (mk___rep4 (mk___split_fields4 (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep6 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep6 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) rliteral (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (temp_____aggregate_def_680 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep8 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep8 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep8 (fp #b0 #b00000000 #b00000000000000000000000)) (let ((usq_ (mk___rep3 (mk___split_discrs (of_rep9 0)) (mk___split_fields3 dummy4 dummy4) true))) (mk___rep3 (us_split_discrs1 usq_) (us_split_fields7 usq_) false)) (distinct 0 0)))) (= (rec__algorithm__controller__laserscan (us_split_fields15 temp___expr_678)) (temp_____aggregate_def_684 (mk___rep5 (mk___split_fields5 (of_rep6 (fp #b0 #b00000000 #b00000000000000000000000)) null_angle))))) (and (= (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_678))))) 1000) (= (is_empty (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_678))) true))) (= (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields15 temp___expr_678))) (fp #b0 #b00000000 #b00000000000000000000000))) (= (rec__algorithm__controller__driveangle (us_split_fields15 temp___expr_678)) null_angle)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_865 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_865 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 5)) 71)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 7)) 112)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_865 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_865 us_void_param)))))
(declare-fun temp___String_Literal_866 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_866 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_866 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 3)) 117)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 6)) 100)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 12)) 102)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 15)) 98)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 16)) 121)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 19)) 98)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 22)) 97)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 24)) 108)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_866 us_void_param) 29)) 32)) :pattern ((temp___String_Literal_866 us_void_param)))))
(define-fun dynamic_invariant3 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range8 temp___expr_39)))
...
(assert (= posgapcorner (create__4 (to_rep2 (rec__gaps__gap__distance (us_split_fields5 risinggap))) (rec__gaps__gap__bearing (us_split_fields5 risinggap)))))
...
(assert (forall ((temp___686 us_rep5)) (forall ((temp___687 Int)) (= (select (temp_____aggregate_def_684 temp___686) temp___687) temp___686))))
(define-fun dynamic_invariant8 ((temp___expr_254 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool) (temp___do_typ_inv_253 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 1)) (in_range9 temp___expr_254)))
(define-fun default_initial_assumption2 ((temp___expr_263 us_rep3) (temp___skip_top_level_264 Bool)) Bool (and (= (attr__constrained temp___expr_263) false) (= (to_rep9 (rec__robot_iface__speed_option__opt (us_split_discrs1 temp___expr_263))) 0)))
(define-fun dynamic_invariant9 ((temp___expr_272 us_rep4) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool) (temp___do_typ_inv_271 Bool)) Bool (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields9 temp___expr_272))) false))
(define-fun default_initial_assumption3 ((temp___expr_275 us_rep4) (temp___skip_top_level_276 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields9 temp___expr_275))) false) (= (to_rep9 (rec__robot_iface__speed_option__opt (us_split_discrs1 (rec__robot_iface__proxy__speed (us_split_fields9 temp___expr_275))))) 0)))
...
(define-fun dynamic_invariant13 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range4 temp___expr_198)))
...
(define-fun dynamic_invariant14 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 1) 1)) (in_range5 temp___expr_323)))
...
(assert (forall ((temp___682 Float32)) (=> (dynamic_invariant11 temp___682 true true true true) (forall ((temp___683 Int)) (= (to_rep6 (select (temp_____aggregate_def_680 temp___682) temp___683)) temp___682)))))
(declare-const i Int)
...
(assert (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields9 (rec__algorithm__controller__robot (us_split_fields15 this))))) false) (= 1000 (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields15 this))))))))
(assert (and (= algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 (create__4 (to_rep2 (rec__gaps__gap__distance (us_split_fields5 risinggap))) (rec__gaps__gap__bearing (us_split_fields5 risinggap)))) (=> (not (fp.eq (to_rep2 (rec__gaps__gap__distance (us_split_fields5 risinggap))) (fp #b0 #b00000000 #b00000000000000000000000))) (not (= (oeq algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 zero_position) true)))))
...
(assert (and (= o (aldiff (rec__algorithm__laser_scan_data__second (us_split_fields11 (select (rec__algorithm__controller__laserscan (us_split_fields15 this)) i2))) (rec__gaps__gap__bearing (us_split_fields5 risinggap)))) (and (fp.isFinite32 o) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o) (fp.leq o (fp #b0 #b10000000 #b10010010000111111011011))))))
(assert (= o1 (fp.mul RNE (of_int RNE (to_rep4 (rec__gaps__gap__idir (us_split_fields5 risinggap)))) o)))
