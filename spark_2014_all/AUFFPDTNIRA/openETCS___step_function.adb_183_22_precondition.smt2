...
(assert (= (to_rep2 o103) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i22))))))
(assert (= o104 (mk___split_fields o103 (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step merge__split_fields3) im2))))))
(assert (= o105 (mk___rep o104)))
(assert (= o106 (store (rec__step_function__step_function_t__step merge__split_fields3) im2 o105)))
(assert (= o107 (mk___split_fields1 (rec__step_function__step_function_t__number_of_delimiters merge__split_fields3) o106)))
(assert (= temp___319 (mk___rep1 o107)))
(assert (= result14 (mk___split_fields__ref1 merge__split_fields3)))
(assert (= merge__split_fields12 (us_split_fields3 temp___319)))
