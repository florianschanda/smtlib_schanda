...
(assert (= o7 j1))
(assert (= (mk___rep (mk___split_fields o8 o9)) (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o7)))
(assert (= o8 o10))
(assert (= o9 o11))
(assert (= o12 o11))
(assert (= o13 (to_rep o12)))
(assert (= o14 (ite (fp.eq min2 o13) true false)))
(assert (not (<= 0 j1)))
(check-sat)
(exit)
