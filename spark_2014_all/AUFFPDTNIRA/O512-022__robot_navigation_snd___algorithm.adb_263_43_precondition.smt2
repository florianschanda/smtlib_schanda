...
(assert (and (= result4 (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2))) (= (= result4 true) (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)) true))))
(assert (=> (= result4 true) (and (= result3 (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3))) (= (= result3 true) (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3)) true)))))
