...
(assert (or (and (and (and (= step_function__get_value__result11 (mk_t__ref step_function__get_value__result3)) (= i7 (mk_int__ref i2))) (and (= step_function__get_value__result12 step_function__get_value__result3) (= i8 i2))) (and (= temp___274 0) (and (= temp___275 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (and (and (= result4 i12) (= i1 temp___274)) (and (and (<= temp___274 i1) (<= i1 temp___275)) (and (= temp___270 i1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j i2)) (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j)))) x))) (and (and (=> (<= 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (dynamic_property 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1) i2)) (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))) (and (and (and (and (and (and (and (and (and (= temp___268 (+ i2 1)) (in_range1 (+ i2 1))) (and (and (<= 0 temp___268) (<= temp___268 10)) (= o temp___268))) (= o8 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o))) (and (= o1 o3) (= o2 o4))) (= o5 o3)) (= o6 (to_rep2 o5))) (= o7 (ite (< x o6) true false))) (= result1 (ite (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) x) o7 false))) (and (= result1 true) (and (= step_function__get_value__result2 result2) (= step_function__get_value__result3 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))))))))))))))) (and (and (and (= result4 i12) (= i1 0)) (ite (and (<= 0 i1) (<= i1 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (and (= temp___270 i1) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j i2)) (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j)))) x))) (and (and (=> (<= 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (dynamic_property 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1) i2)) (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))) (and (and (and (and (and (and (and (and (and (and (= temp___268 (+ i2 1)) (in_range1 (+ i2 1))) (and (and (<= 0 temp___268) (<= temp___268 10)) (= o temp___268))) (= o8 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o))) (and (= o1 o3) (= o2 o4))) (= o5 o3)) (= o6 (to_rep2 o5))) (= o7 (ite (< x o6) true false))) (= result1 (ite (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) x) o7 false))) (and (not (= result1 true)) (= step_function__get_value__result3 step_function__get_value__result2))) (= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))))) (and (and (= step_function__get_value__result3 step_function__get_value__result4) (= i2 i3)) (and (= step_function__get_value__result5 step_function__get_value__result3) (= i4 i2)))) (and (and (= step_function__get_value__result15 (mk_t__ref step_function__get_value__result4)) (= i11 (mk_int__ref i3))) (and (= step_function__get_value__result7 step_function__get_value__result5) (= i6 i4)))) (and (and (= step_function__get_value__result15 (mk_t__ref step_function__get_value__result)) (= i1 i5)) (and (= step_function__get_value__result7 step_function__get_value__result1) (= i6 i1))))) (and (and (and (= step_function__get_value__result11 step_function__get_value__result9) (= i7 i11)) (and (= step_function__get_value__result12 step_function__get_value__result10) (= i8 i6))) (and (and (= step_function__get_value__result9 (mk_t__ref step_function__get_value__result8)) (= step_function__get_value__result10 step_function__get_value__result8)) (and (= (mk_t__ref result3) step_function__get_value__result15) (= step_function__get_value__result8 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))))))
