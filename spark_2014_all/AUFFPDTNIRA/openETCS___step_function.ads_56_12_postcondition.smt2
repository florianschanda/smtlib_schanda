...
(assert (or (and (and (and (= step_function__get_value__result13 (mk_t__ref step_function__get_value__result3)) (= i11 (mk_int__ref i3))) (and (= step_function__get_value__result14 step_function__get_value__result3) (= i12 i3))) (and (= temp___247 0) (and (= temp___248 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i2 temp___247)) (and (and (<= temp___247 i2) (<= i2 temp___248)) (and (= temp___243 i2) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i3)) (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j1)))) x))) (and (and (=> (<= 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (dynamic_property 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1) i3)) (and (<= 0 i3) (<= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))) (and (and (and (and (and (and (and (and (and (= temp___241 (+ i3 1)) (in_range1 (+ i3 1))) (and (and (<= 0 temp___241) (<= temp___241 10)) (= o temp___241))) (= (mk___rep (mk___split_fields o1 o2)) (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o))) (and (= o1 o3) (= o2 o4))) (= o5 o3)) (= o6 (to_rep2 o5))) (= o7 (ite (< x o6) true false))) (= result1 (ite (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i3)))) x) o7 false))) (and (= result1 true) (and (= step_function__get_value__result2 result2) (= step_function__get_value__result3 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i3)))))))))))))))) (and (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i2 0)) (ite (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (and (= temp___243 i2) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i3)) (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j1)))) x))) (and (and (=> (<= 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)) (dynamic_property 0 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1) i3)) (and (<= 0 i3) (<= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))) (and (and (and (and (and (and (and (and (and (and (= temp___241 (+ i3 1)) (in_range1 (+ i3 1))) (and (and (<= 0 temp___241) (<= temp___241 10)) (= o temp___241))) (= (mk___rep (mk___split_fields o1 o2)) (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) o))) (and (= o1 o3) (= o2 o4))) (= o5 o3)) (= o6 (to_rep2 o5))) (= o7 (ite (< x o6) true false))) (= result1 (ite (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i3)))) x) o7 false))) (and (not (= result1 true)) (= step_function__get_value__result3 step_function__get_value__result2))) (= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1)))))) (and (and (= step_function__get_value__result3 step_function__get_value__result6) (= i3 i7)) (and (= step_function__get_value__result7 step_function__get_value__result3) (= i8 i3)))) (and (and (= (mk_t__ref step_function__get_value__result8) (mk_t__ref step_function__get_value__result6)) (= (mk_int__ref i9) (mk_int__ref i7))) (and (= step_function__get_value__result9 step_function__get_value__result7) (= i10 i8)))) (and (and (= (mk_t__ref step_function__get_value__result8) (mk_t__ref step_function__get_value__result)) (= i2 i9)) (and (= step_function__get_value__result9 step_function__get_value__result1) (= i10 i2))))) (and (and (and (= step_function__get_value__result13 step_function__get_value__result11) (= i11 (mk_int__ref i9))) (and (= step_function__get_value__result14 step_function__get_value__result12) (= i12 i10))) (and (and (= step_function__get_value__result11 (mk_t__ref step_function__get_value__result10)) (= step_function__get_value__result12 step_function__get_value__result10)) (and (= (mk_t__ref result4) (mk_t__ref step_function__get_value__result8)) (= step_function__get_value__result10 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))))))
(assert (= step_function__get_value__result15 step_function__get_value__result13))
(assert (= i13 i11))
(assert (= step_function__get_value__result16 step_function__get_value__result14))
(assert (= i14 i12))
(assert (= result5 (t__content step_function__get_value__result15)))
(assert (not (or (exists ((i15 Int)) (and (and (<= 0 i15) (<= i15 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i15)))) x) (< x (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (+ i15 1))))))) (fp.eq (t__content step_function__get_value__result15) (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i15)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))) x) (fp.eq (t__content step_function__get_value__result15) (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))))
(check-sat)
(exit)
