...
(define-fun dynamic_invariant1 ((temp___expr_140 Float32) (temp___is_init_137 Bool) (temp___skip_constant_138 Bool) (temp___do_toplevel_139 Bool)) Bool (=> (or (= temp___is_init_137 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range1 temp___expr_140)))
...
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (let ((result (cos1 x))) (and (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) result) (fp.leq result (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq result (fp #b0 #b01111111 #b00000000000000000000000)))) (dynamic_invariant result true false true)))) :pattern ((cos1 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_324 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 0 2147483647)) (in_range5 temp___expr_324)))
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= result (to_rep4 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_577 us_rep2) (temp___is_init_574 Bool) (temp___skip_constant_575 Bool) (temp___do_toplevel_576 Bool)) Bool (=> (not (= temp___skip_constant_575 true)) (in_range6 1000 temp___expr_577)))
(define-fun default_initial_assumption ((temp___expr_579 us_rep2) (temp___skip_top_level_580 Bool)) Bool (and (= (to_rep4 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs1 temp___expr_579))) 1000) (=> (not (= temp___skip_top_level_580 true)) (= (is_empty temp___expr_579) true))))
...
(declare-fun concat1 ((Array Int us_rep6) Int Int (Array Int us_rep6) Int Int) (Array Int us_rep6))
...
(assert (forall ((v us_rep6)) (forall ((i Int)) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq7 ((a (Array Int us_rep6)) (a__first Int) (a__last Int) (b (Array Int us_rep6)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq6 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true)))) true false))
(assert (forall ((a (Array Int us_rep6)) (b (Array Int us_rep6))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq6 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_146 Float32) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range2 temp___expr_146)))
(define-fun dynamic_invariant5 ((temp___expr_170 Float32) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range3 temp___expr_170)))
(define-fun dynamic_invariant6 ((temp___expr_286 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 1) 1)) (in_range4 temp___expr_286)))
(define-fun default_initial_assumption1 ((temp___expr_413 us_rep3) (temp___skip_top_level_414 Bool)) Bool (= (to_rep4 (rec__algorithm__gap_vectors__cursor__node (us_split_fields7 temp___expr_413))) 0))
...
(define-fun default_initial_assumption2 ((temp___expr_449 us_rep4) (temp___skip_top_level_450 Bool)) Bool (=> (not (= temp___skip_top_level_450 true)) (= (length1 temp___expr_449) 0)))
...
(define-fun default_initial_assumption3 ((temp___expr_468 us_rep5) (temp___skip_top_level_469 Bool)) Bool (=> (not (= temp___skip_top_level_469 true)) (and (= (is_empty1 temp___expr_468) true) (= (length2 temp___expr_468) 0))))
(declare-fun has_key (us_rep5 us_rep3) Bool)
(declare-fun has_key__function_guard (Bool us_rep5 us_rep3) Bool)
(define-fun default_initial_assumption4 ((temp___expr_456 us_rep3) (temp___skip_top_level_457 Bool)) Bool (= (to_rep4 (rec__algorithm__gap_vectors__cursor__node (us_split_fields7 temp___expr_456))) 0))
...
(define-fun dynamic_invariant7 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range8 temp___expr_442)))
(assert (forall ((container us_rep4)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true))) :pattern ((length1 container)))))
(assert true)
(assert (forall ((container us_rep5)) (forall ((key us_rep3)) (! (=> (= (of_int1 0) true) (=> (exists ((k us_rep3)) (and (= (has_key container k) true) (= (bool_eq3 k key) true))) (= (has_key container key) true))) :pattern ((has_key container key))))))
...
(define-fun dynamic_invariant8 ((temp___expr_461 Int) (temp___is_init_458 Bool) (temp___skip_constant_459 Bool) (temp___do_toplevel_460 Bool)) Bool (=> (or (= temp___is_init_458 true) (<= 1 2147483647)) (in_range9 temp___expr_461)))
...
(assert (forall ((container us_rep5)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (get1 container key))) (and (=> (= (of_int1 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep3)) (=> (= (has_key container k) true) (= (= (bool_eq3 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant8 result true false true)))) :pattern ((get1 container key))))))
(assert (forall ((container us_rep5)) (! (dynamic_invariant2 (length2 container) true false true) :pattern ((length2 container)))))
...
(assert true)
(assert (forall ((container us_rep5)) (forall ((key us_rep3)) (! (=> (= (has_key container key) true) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep5)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant8 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (and (= (to_rep4 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000) (<= (length (mk___rep2 gapvec__split_discrs gapvec__split_fields2)) 1)))
(assert (= result4 (mk_int__ref i)))
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 999)) (and (and (= (mk___split_fields4 temp___820 (mk___rep (mk___split_fields temp___8201))) rayl__split_fields2) (and (= (mk___split_fields4 temp___819 (mk___rep (mk___split_fields temp___8191))) rayr__split_fields2) (and (= temp___818 (mk___rep2 gapvec__split_discrs gapvec__split_fields2)) (and (= temp___817 i1) (and (and (= (to_rep4 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000) (< (length (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) i2)) (and (and (=> (<= 2 999) (in_range7 i2)) (and (<= 2 i2) (<= i2 999))) (and (and (= result5 (mk___split_fields__ref4 rayr__split_fields3)) (= rayr__split_fields4 rayl__split_fields3)) (and (and (= result6 (mk___split_fields__ref4 rayl__split_fields3)) (= rayl__split_fields4 (us_split_fields9 (select laserscan i2)))) (and (and (and (and (= algorithm__buildgapvector__B_9__dist__assume (fp.sub RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)))) (fp.isFinite32 (fp.sub RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4))))) (= algorithm__buildgapvector__B_9__dist__assume dist1)) (fp.isFinite32 dist1)) (and (ite (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)) fmaxrange))) (and (and (and (= o15 (create__2 (rec__algorithm__laser_scan_data__second rayr__split_fields4) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)) (- 1))) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) o15) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true))) (and (= result7 (mk___split_fields__ref2 gapvec__split_fields3)) (= gapvec__split_fields4 algorithm__gap_vectors__append__container__fields1))) (= algorithm__gap_vectors__append__container__fields2 rho1)) (and (ite (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) fmaxrange))) (and (and (= o16 (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields4) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) 1)) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2))) o16) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields2))) true))) (and (= result8 (mk___split_fields__ref2 gapvec__split_fields3)) (= gapvec__split_fields5 algorithm__gap_vectors__append__container__fields2))) (and (= gapvec__split_fields5 gapvec__split_fields3) (and (= algorithm__gap_vectors__append__container__fields2 rho1) (= gapvec__split_fields5 gapvec__split_fields3)))) (and (= gapvec__split_fields4 gapvec__split_fields5) (and (= algorithm__gap_vectors__append__container__fields1 rho) (= gapvec__split_fields4 gapvec__split_fields5))))) (= i2 999))))))))))) (and (and (= i6 (mk_int__ref i2)) (and (= rayl__split_fields7 (mk___split_fields__ref4 rayl__split_fields4)) (and (= rayr__split_fields7 (mk___split_fields__ref4 rayr__split_fields4)) (= gapvec__split_fields8 (mk___split_fields__ref2 gapvec__split_fields4))))) (and (= i7 i2) (and (= rayl__split_fields8 rayl__split_fields4) (and (= rayr__split_fields8 rayr__split_fields4) (= gapvec__split_fields9 gapvec__split_fields4))))))))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= i8 i6)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= rayl__split_fields9 rayl__split_fields7)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= rayr__split_fields9 rayr__split_fields7)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= gapvec__split_fields10 gapvec__split_fields8)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= i9 i7)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= rayl__split_fields10 rayl__split_fields8)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= rayr__split_fields10 rayr__split_fields8)))
(assert (=> (and (<= 2 i1) (<= i1 999)) (= gapvec__split_fields11 gapvec__split_fields9)))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= i8 (mk_int__ref i1))))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= rayl__split_fields9 (mk___split_fields__ref4 rayl__split_fields2))))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= rayr__split_fields9 (mk___split_fields__ref4 rayr__split_fields2))))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= gapvec__split_fields10 (mk___split_fields__ref2 gapvec__split_fields2))))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= i9 i1)))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= rayl__split_fields10 rayl__split_fields2)))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= rayr__split_fields10 rayr__split_fields2)))
(assert (=> (not (and (<= 2 i1) (<= i1 999))) (= gapvec__split_fields11 gapvec__split_fields2)))
(assert (= result10 rayr__split_fields9))
(assert (= rayr__split_fields11 (us_split_fields9 (select laserscan 1000))))
(assert (= result11 rayl__split_fields9))
(assert (= rayl__split_fields11 (us_split_fields9 (select laserscan 1))))
(assert (and (= o22 (ccwdiff (rec__algorithm__laser_scan_data__second rayr__split_fields11) (rec__algorithm__laser_scan_data__second rayl__split_fields11))) (fp.isFinite32 o22)))
(assert (and (= o23 (cos1 o22)) (and (fp.isFinite32 o23) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) o23) (fp.leq o23 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq o22 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq o23 (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (and (= o20 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11))))))
(assert (= o21 (fp.mul RNE o20 (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields11)))))
(assert (and (= o24 o21) (fp.isFinite32 o21)))
(assert (= o25 (fp.mul RNE o24 o23)))
(assert (and (= o26 o25) (fp.isFinite32 o25)))
(assert (and (= o17 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields11)) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields11)))) (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields11)) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields11))))))
(assert (and (= o18 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11)))) (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11))))))
(assert (= o19 (fp.add RNE o18 o17)))
(assert (not (fp.isFinite32 o19)))
(check-sat)
(exit)
