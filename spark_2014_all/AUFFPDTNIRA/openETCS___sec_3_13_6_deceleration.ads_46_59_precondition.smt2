...
(assert (forall ((x num_delimiters_range)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((v Float32)) (! (=> (and (dynamic_invariant1 v true true true true) (= (is_valid_kdry_rst Tuple0) true)) (let ((result (kdry_rst v))) (and (fp.eq result (get_value kdry_rst_model (to_int1 RNA v))) (dynamic_invariant result true false true true)))) :pattern ((kdry_rst v)))))
...
(assert (forall ((v Float32)) (! (=> (and (dynamic_invariant1 v true true true true) (= (is_valid_kwet_rst Tuple0) true)) (let ((result (kwet_rst v))) (and (fp.eq result (get_value kwet_rst_model (to_int1 RNA v))) (dynamic_invariant result true false true true)))) :pattern ((kwet_rst v)))))
...
(define-fun dynamic_invariant3 ((temp___expr_202 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 0 2147483647)) (in_range3 temp___expr_202)))
(declare-const a_brake_emergency_model us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (and (dynamic_invariant1 v true true true true) (dynamic_invariant3 d true true true true)) (and (= (is_valid_deceleration_model a_brake_emergency_model) true) (= (is_valid_speed v) true))) (let ((result (a_brake_emergency v d))) (and (fp.eq result (get_value a_brake_emergency_model (to_int1 RNA v))) (dynamic_invariant2 result true false true true)))) :pattern ((a_brake_emergency v d))))))
...
(assert (forall ((speed Float32)) (! (=> (and (dynamic_invariant4 speed true true true true) (= (is_valid_speed_km_per_h speed) true)) (dynamic_invariant1 (m_per_s_from_km_per_h speed) true false true true)) :pattern ((m_per_s_from_km_per_h speed)))))
...
(define-fun dynamic_invariant5 ((temp___expr_216 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool) (temp___do_typ_inv_215 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= 0 10)) (in_range temp___expr_216)))
(define-fun dynamic_invariant6 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 0 2147483647)) (in_range1 temp___expr_223)))
...
(assert (= a_brake_emergency_model (mk___rep1 (mk___split_fields1 rliteral (temp_____aggregate_def_155 (mk___rep (mk___split_fields rliteral1 (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields rliteral1 (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(declare-fun temp_____aggregate_def_160 (us_rep us_rep) (Array Int us_rep))
(assert (= kdry_rst_model (mk___rep1 (mk___split_fields1 rliteral (temp_____aggregate_def_160 (mk___rep (mk___split_fields rliteral1 (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields rliteral1 (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(declare-fun temp_____aggregate_def_165 (us_rep us_rep) (Array Int us_rep))
(assert (= kwet_rst_model (mk___rep1 (mk___split_fields1 rliteral (temp_____aggregate_def_165 (mk___rep (mk___split_fields rliteral1 (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields rliteral1 (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(assert true)
...
(assert (forall ((temp___162 us_rep) (temp___163 us_rep)) (let ((temp___161 (temp_____aggregate_def_160 temp___162 temp___163))) (forall ((temp___164 Int)) (ite (= temp___164 0) (= (select temp___161 temp___164) temp___162) (= (select temp___161 temp___164) temp___163))))))
...
(assert (in_range3 d))
(assert (and (= o (a_brake_emergency v d)) (and (in_range2 o) (fp.eq o (get_value a_brake_emergency_model (to_int1 RNA v))))))
