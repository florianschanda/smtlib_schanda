...
(define-fun dynamic_invariant1 ((temp___expr_175 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range1 temp___expr_175)))
...
(assert (forall ((v Float32)) (! (=> (and (dynamic_invariant v true true true) (= (is_valid_kdry_rst Tuple0) true)) (let ((result (kdry_rst v))) (and (fp.eq result (get_value kdry_rst_model (to_int1 RNA v))) (dynamic_invariant2 result true false true)))) :pattern ((kdry_rst v)))))
...
(assert (forall ((v Float32)) (! (=> (and (dynamic_invariant v true true true) (= (is_valid_kwet_rst Tuple0) true)) (let ((result (kwet_rst v))) (and (fp.eq result (get_value kwet_rst_model (to_int1 RNA v))) (dynamic_invariant2 result true false true)))) :pattern ((kwet_rst v)))))
(define-fun dynamic_invariant3 ((temp___expr_169 Float32) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range temp___expr_169)))
...
(define-fun dynamic_invariant4 ((temp___expr_157 Float32) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool)) Bool (=> (or (= temp___is_init_154 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_157)))
...
(define-fun dynamic_invariant5 ((temp___expr_187 Int) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (or (= temp___is_init_184 true) (<= 0 10)) (in_range2 temp___expr_187)))
(define-fun dynamic_invariant6 ((temp___expr_193 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 2147483647)) (in_range3 temp___expr_193)))
(declare-fun is_valid (us_rep1) Bool)
(declare-fun is_valid__function_guard (Bool us_rep1) Bool)
(assert true)
(assert (forall ((sfun us_rep1)) (! (= (= (is_valid sfun) true) (and (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___233 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___233 0))))) 0) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (< (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___235 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___235 i))))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___234 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___234 (+ i 1))))))))))) :pattern ((is_valid sfun)))))
...
(assert true)
(assert (forall ((sfun1 us_rep1) (sfun2 us_rep1)) (! (= (= (has_same_delimiters sfun1 sfun2) true) (and (= (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun1))) (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun2)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun1))))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___242 (rec__step_function__step_function_t__step (us_split_fields3 sfun1)))) (select temp___242 i))))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___243 (rec__step_function__step_function_t__step (us_split_fields3 sfun2)))) (select temp___243 i)))))))))) :pattern ((has_same_delimiters sfun1 sfun2)))))
(assert (forall ((sfun us_rep1)) (forall ((x Int)) (! (=> (and (dynamic_invariant6 x true true true) (= (is_valid sfun) true)) (let ((result (get_value sfun x))) (and (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___250 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___250 i))))) x) (< x (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___251 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___251 (+ i 1)))))))) (fp.eq result (to_rep1 (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___252 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___252 i))))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___253 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___253 (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))))) x) (fp.eq result (to_rep1 (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___254 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___254 (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))) (dynamic_invariant2 result true false true)))) :pattern ((get_value sfun x))))))
(assert true)
...
(assert (= a_brake_emergency_model (mk___rep1 (mk___split_fields1 (of_rep 0) (temp___133 (mk___rep (mk___split_fields (of_rep2 0) (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields (of_rep2 0) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
...
(assert (= kdry_rst_model (mk___rep1 (mk___split_fields1 (of_rep 0) (temp___138 (mk___rep (mk___split_fields (of_rep2 0) (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields (of_rep2 0) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(declare-fun temp___143 (us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___145 us_rep) (temp___146 us_rep)) (let ((temp___144 (temp___143 temp___145 temp___146))) (forall ((temp___147 Int)) (ite (= temp___147 0) (= (select temp___144 temp___147) temp___145) (= (select temp___144 temp___147) temp___146))))))
(assert (= kwet_rst_model (mk___rep1 (mk___split_fields1 (of_rep 0) (temp___143 (mk___rep (mk___split_fields (of_rep2 0) (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields (of_rep2 0) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(assert true)
...
(assert (in_range1 d))
(assert (and (= o9 (a_brake_emergency v d)) (and (in_range o9) (fp.eq o9 (get_value a_brake_emergency_model (to_int1 RNA v))))))
(assert (not (= (is_valid_kwet_rst Tuple0) true)))
(check-sat)
(exit)
