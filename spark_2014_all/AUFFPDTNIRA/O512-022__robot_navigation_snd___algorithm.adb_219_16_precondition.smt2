...
(assert (not (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange))))
(assert (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange))))
(assert (= o (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields1) (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields1)) 1)))
