...
(assert (not (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)) fmaxrange))))
(assert (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) fmaxrange))))
(assert (= o16 (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields4) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) 1)))
(assert (not (< (length (mk___rep2 gapvec__split_discrs gapvec__split_fields3)) (to_rep4 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)))))
(check-sat)
(exit)
