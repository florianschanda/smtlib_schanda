...
(define-fun dynamic_invariant2 ((temp___expr_362 Int) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool) (temp___do_typ_inv_361 Bool)) Bool (=> (or (= temp___is_init_358 true) (<= 0 1000)) (in_range5 temp___expr_362)))
...
(define-fun dynamic_invariant3 ((temp___expr_203 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 2147483647)) (in_range4 temp___expr_203)))
(declare-fun curve_index_from_location (Int) Int)
(declare-fun curve_index_from_location__function_guard (Int Int) Bool)
(assert (forall ((d Int)) (! (=> (and (dynamic_invariant3 d true true true true) (<= d 5000)) (dynamic_invariant2 (curve_index_from_location d) true false true true)) :pattern ((curve_index_from_location d)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_447 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_447 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_447 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_447 us_void_param) 4)) 32)) :pattern ((temp___String_Literal_447 us_void_param)))))
