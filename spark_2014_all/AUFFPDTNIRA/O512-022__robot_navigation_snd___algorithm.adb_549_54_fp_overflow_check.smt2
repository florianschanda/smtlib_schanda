...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep6 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) (to_rep6 (rec__robot_iface__speed_option__opt (us_split_discrs1 b)))) (=> (robot_iface__speed_option__modulus__pred a) (= (to_rep4 (rec__robot_iface__speed_option__modulus (us_split_fields3 a))) (to_rep4 (rec__robot_iface__speed_option__modulus (us_split_fields3 b)))))) (=> (robot_iface__speed_option__angle__pred a) (= (to_rep4 (rec__robot_iface__speed_option__angle (us_split_fields3 a))) (to_rep4 (rec__robot_iface__speed_option__angle (us_split_fields3 b)))))) true false))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___884 (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))))
...
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___879 obstacleavoiddelta1)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (fp.eq (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))) temp___884)))
