...
(define-fun bool_eq1 ((a (Array Int nonnegative_float)) (a__first Int) (a__last Int) (b (Array Int nonnegative_float)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep1 (select a temp___idx_154)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(declare-fun temp___684 (us_rep3) (Array Int us_rep3))
...
(define-fun default_initial_assumption ((temp___expr_678 us_rep5) (temp___skip_top_level_679 Bool)) Bool (and (and (and (and (= (rec__algorithm__controller__robot (us_split_fields11 temp___expr_678)) (mk___rep2 (mk___split_fields2 (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 0) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (temp___680 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000)) (let ((usq_ (mk___rep1 (mk___split_discrs (of_rep6 0)) (mk___split_fields1 dummy dummy) true))) (mk___rep1 (us_split_discrs1 usq_) (us_split_fields3 usq_) false)) (distinct 0 0)))) (= (rec__algorithm__controller__laserscan (us_split_fields11 temp___expr_678)) (temp___684 (mk___rep3 (mk___split_fields3 (of_rep1 (fp #b0 #b00000000 #b00000000000000000000000)) null_angle))))) (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_678))))) 1000) (= (is_empty (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_678))) true))) (= (to_rep4 (rec__algorithm__controller__obsavoiddelta (us_split_fields11 temp___expr_678))) (fp #b0 #b00000000 #b00000000000000000000000))) (= (rec__algorithm__controller__driveangle (us_split_fields11 temp___expr_678)) null_angle)))
...
(assert (forall ((temp___686 us_rep3)) (forall ((temp___687 Int)) (= (select (temp___684 temp___686) temp___687) temp___686))))
...
(define-fun dynamic_invariant11 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range3 temp___expr_198)))
...
(assert (forall ((temp___682 Float32)) (=> (dynamic_invariant1 temp___682 true true true true) (forall ((temp___683 Int)) (= (to_rep1 (select (temp___680 temp___682) temp___683)) temp___682)))))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___953 (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___952 deltaareasum1)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___951 deltaangle)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___950 deltamag)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___949 i1)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= temp___948 obstacleavoiddelta1)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (fp.eq (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))) temp___953)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (and (and (and (and (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 obstacleavoiddelta2)) (=> (<= 1 1000) (dynamic_property 1 1000 i2))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (in_range9 deltamag2))) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 deltaangle2))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111)) (in_range2 deltaareasum2))) (and (<= 1 i2) (<= i2 1000)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (and (= o (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))) (fp.isFinite32 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= result3 (ite (fp.leq (to_rep1 (rec__algorithm__laser_scan_data__first (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2)))) o) true false))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o1 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))) (fp.isFinite32 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this)))))))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= o2 (fp.sub RNE o1 (to_rep1 (rec__algorithm__laser_scan_data__first (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2)))))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o3 o2) (fp.isFinite32 o2)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= o4 (fp.div RNE o3 safetydist)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o5 o4) (fp.isFinite32 o4)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o6 (limit o5 (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (and (fp.isFinite32 o6) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o6) (fp.leq o6 (fp #b0 #b01111111 #b00000000000000000000000))))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o7 o6) (fp.isFinite32 o6)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= deltamag2 result4))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= deltamag3 o7))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= o16 (create__2 (fp #b0 #b10000000 #b10010010000111111011011))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= o15 (oadd (rec__algorithm__laser_scan_data__second (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))) o16)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o10 (aldiff (rec__algorithm__controller__driveangle (us_split_fields11 this)) o15)) (and (fp.isFinite32 o10) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o10) (fp.leq o10 (fp #b0 #b10000000 #b10010010000111111011011))))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= deltaangle2 result5))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= deltaangle3 o10))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o11 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag3 deltamag3))) (fp.isFinite32 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag3 deltamag3)))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= deltaareasum2 result6))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= deltaareasum3 o11))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o12 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag3 deltamag3) deltamag3) deltaangle3)) (fp.isFinite32 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag3 deltamag3) deltamag3) deltaangle3))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= o13 (fp.add RNE obstacleavoiddelta2 o12)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (and (= o14 o13) (fp.isFinite32 o13)))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= obstacleavoiddelta2 result7))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (= result3 true) (= obstacleavoiddelta3 o14))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (not (= result3 true)) (= obstacleavoiddelta3 obstacleavoiddelta2))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (not (= result3 true)) (= deltaareasum3 deltaareasum2))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (not (= result3 true)) (= deltaangle3 deltaangle2))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (=> (not (= result3 true)) (= deltamag3 deltamag2))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= i2 1000)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= obstacleavoiddelta4 (mk_t__ref obstacleavoiddelta3))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= deltaareasum4 (mk_t__ref deltaareasum3))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= deltaangle4 (mk_t__ref deltaangle3))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= deltamag4 (mk_t__ref deltamag3))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= obstacleavoiddelta5 obstacleavoiddelta3)))
...
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= obstacleavoiddelta6 obstacleavoiddelta4)))
...
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= obstacleavoiddelta7 obstacleavoiddelta5)))
...
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= obstacleavoiddelta6 (mk_t__ref obstacleavoiddelta1))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaareasum6 (mk_t__ref deltaareasum1))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaangle6 (mk_t__ref deltaangle))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltamag6 (mk_t__ref deltamag))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= obstacleavoiddelta7 obstacleavoiddelta1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaareasum7 deltaareasum1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaangle7 deltaangle1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltamag7 deltamag1)))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (t__content deltaareasum6)))
(assert (not (fp.isFinite32 (fp.div RNE (t__content obstacleavoiddelta6) (t__content deltaareasum6)))))
(check-sat)
(exit)
