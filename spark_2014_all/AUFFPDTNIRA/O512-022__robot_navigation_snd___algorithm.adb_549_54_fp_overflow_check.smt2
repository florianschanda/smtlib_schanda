...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (and (and (= temp___884 (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this)))))) (and (= temp___883 deltaareasum1) (and (= temp___882 deltaangle) (and (= temp___881 deltamag) (and (= temp___880 i1) (and (= temp___879 obstacleavoiddelta1) (and (fp.eq (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))) temp___884) (and (and (and (and (and (and (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 obstacleavoiddelta2)) (=> (<= 1 1000) (dynamic_property 1 1000 i2))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000)) (in_range9 deltamag2))) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 deltaangle2))) (=> (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111)) (in_range2 deltaareasum2))) (and (<= 1 i2) (<= i2 1000))) (and (and (and (and (= o (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))) (fp.isFinite32 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this)))))))) (= result3 (ite (fp.leq (to_rep1 (rec__algorithm__laser_scan_data__first (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2)))) o) true false))) (ite (= result3 true) (and (and (and (and (and (and (and (and (and (= o1 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))) (fp.isFinite32 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this)))))))) (= o2 (fp.sub RNE o1 (to_rep1 (rec__algorithm__laser_scan_data__first (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))))))) (and (= o3 o2) (fp.isFinite32 o2))) (= o4 (fp.div RNE o3 safetydist))) (and (= o5 o4) (fp.isFinite32 o4))) (and (= o6 (limit o5 (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (and (fp.isFinite32 o6) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o6) (fp.leq o6 (fp #b0 #b01111111 #b00000000000000000000000)))))) (and (= o7 o6) (fp.isFinite32 o6))) (and (= deltamag2 result4) (= deltamag3 o7))) (and (and (and (and (= (mk___rep (mk___split_fields o8)) (create__2 (fp #b0 #b10000000 #b10010010000111111011011))) (= (mk___rep (mk___split_fields o9)) (oadd (rec__algorithm__laser_scan_data__second (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))) (mk___rep (mk___split_fields o8))))) (and (= o10 (aldiff (rec__algorithm__controller__driveangle (us_split_fields11 this)) (mk___rep (mk___split_fields o9)))) (and (fp.isFinite32 o10) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o10) (fp.leq o10 (fp #b0 #b10000000 #b10010010000111111011011)))))) (and (= deltaangle2 result5) (= deltaangle3 o10))) (and (and (and (= o11 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag3 deltamag3))) (fp.isFinite32 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag3 deltamag3)))) (and (= deltaareasum2 result6) (= deltaareasum3 o11))) (and (and (and (and (= o12 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag3 deltamag3) deltamag3) deltaangle3)) (fp.isFinite32 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag3 deltamag3) deltamag3) deltaangle3))) (= o13 (fp.add RNE obstacleavoiddelta2 o12))) (and (= o14 o13) (fp.isFinite32 o13))) (and (= obstacleavoiddelta2 result7) (= obstacleavoiddelta3 o14)))))) (and (= obstacleavoiddelta3 obstacleavoiddelta2) (and (= deltaareasum3 deltaareasum2) (and (= deltaangle3 deltaangle2) (= deltamag3 deltamag2)))))) (= i2 1000)))))))))) (and (and (= i6 (mk_int__ref i2)) (and (= obstacleavoiddelta6 (mk_t__ref obstacleavoiddelta3)) (and (= deltaareasum6 (mk_t__ref deltaareasum3)) (and (= deltaangle6 (mk_t__ref deltaangle3)) (= deltamag6 (mk_t__ref deltamag3)))))) (and (= i7 i2) (and (= obstacleavoiddelta7 obstacleavoiddelta3) (and (= deltaareasum7 deltaareasum3) (and (= deltaangle7 deltaangle3) (= deltamag7 deltamag3)))))))))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= i8 i6)))
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= obstacleavoiddelta8 obstacleavoiddelta6)))
...
(assert (=> (and (<= 1 i1) (<= i1 1000)) (= obstacleavoiddelta9 obstacleavoiddelta7)))
...
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= obstacleavoiddelta8 (mk_t__ref obstacleavoiddelta1))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaareasum8 (mk_t__ref deltaareasum1))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaangle8 (mk_t__ref deltaangle))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltamag8 (mk_t__ref deltamag))))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= obstacleavoiddelta9 obstacleavoiddelta1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaareasum9 deltaareasum1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltaangle9 deltaangle1)))
(assert (=> (not (and (<= 1 i1) (<= i1 1000))) (= deltamag9 deltamag1)))
(assert (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (t__content deltaareasum8)))
(assert (not (fp.isFinite32 (fp.div RNE (t__content obstacleavoiddelta8) (t__content deltaareasum8)))))
(check-sat)
(exit)
