...
(define-fun us_split_fields_Y__projection ((a us_split_fields)) float (rec__rec__my_rec__y a))
...
(define-fun dynamic_invariant ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 2)) (in_range temp___expr_161)))
(define-fun dynamic_invariant1 ((temp___expr_181 us_rep1) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (in_range3 (to_rep (rec__rec__sub_rec__z (us_split_discrs3 temp___expr_181))) (rec__rec__sub_rec__plop (us_split_fields3 temp___expr_181))))
(assert (forall ((a Int)) (! (=> (dynamic_invariant a true true true true) (dynamic_invariant1 (build_rec a) true false true true)) :pattern ((build_rec a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_188 us_rep2) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool) (temp___do_typ_inv_187 Bool)) Bool (=> (rec__sub_rec_ok__plop__pred temp___expr_188) (in_range4 (to_rep (rec__rec__sub_rec_ok__z (us_split_discrs5 temp___expr_188))) (rec__rec__sub_rec_ok__plop (us_split_fields5 temp___expr_188)))))
(assert (forall ((a Int)) (! (=> (dynamic_invariant a true true true true) (dynamic_invariant2 (build_rec_ok a) true false true true)) :pattern ((build_rec_ok a)))))
...
(define-fun bool_eq3 ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep4 (select a temp___idx_154)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range5 temp___expr_39)))
(declare-fun build_arr (Int Int) us_rep3)
(declare-fun build_arr__function_guard (us_rep3 Int Int) Bool)
(define-fun dynamic_invariant4 ((temp___expr_201 us_rep3) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (let ((temp___203 (rec__rec__sub_arr__l (us_split_discrs7 temp___expr_201)))) (let ((temp___202 (rec__rec__sub_arr__f (us_split_discrs7 temp___expr_201)))) (and (dynamic_property1 (to_rep4 temp___202) (to_rep4 temp___203) (first1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201))) (last1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201)))) (and (= (first1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201))) (to_rep4 temp___202)) (= (last1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201))) (to_rep4 temp___203)))))))
(assert (forall ((f Int) (l Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant3 l true true true true)) (dynamic_invariant4 (build_arr f l) true false true true)) :pattern ((build_arr f l)))))
...
(define-fun dynamic_invariant7 ((temp___expr_168 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 0 1)) (in_range2 temp___expr_168)))
(assert (not true))
(check-sat)
(exit)
