...
(assert (= o44 i7))
(assert (= o45 (select (rec__step_function__step_function_t__step merge__split_fields3) o44)))
(assert (= o46 (us_split_fields1 o45)))
(assert (= o47 (rec__step_function__delimiter_entry__delimiter o46)))
(assert (= o48 (to_rep2 o47)))
(assert (and (= o49 (get_value sfun2 o48)) (and (fp.isFinite32 o49) (or (exists ((i30 Int)) (and (and (<= 0 i30) (<= i30 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun2))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i30)))) o48) (< o48 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) (+ i30 1))))))) (fp.eq o49 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i30)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun2))))))) o48) (fp.eq o49 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun2)))))))))))))
(assert (and (<= 0 i7) (<= i7 10)))
(assert (= o38 i7))
(assert (= o39 (select (rec__step_function__step_function_t__step merge__split_fields3) o38)))
