...
(assert (= is_prime6 o7))
(assert (forall ((v4 Int)) (=> (and (<= 0 v4) (<= v4 index_22)) (= (= (select is_prime7 v4) true) (= (is_prime v4) true)))))
(assert (forall ((v4 Int)) (=> (and (<= index_22 v4) (<= v4 100000)) (= (= (select is_prime7 v4) true) (and (forall ((div4 Int)) (=> (and (<= 2 div4) (<= div4 (- index_22 1))) (not (= (mod2 v4 div4) 0)))) (=> (and (<= (+ index_22 1) v4) (<= v4 index_34)) (not (= (mod2 v4 index_22) 0))))))))
...
(assert (and (= o16 (+ index_34 index_13)) (in_range1 (+ index_34 index_13))))
...
(declare-const div4 Int)
(assert (<= 2 div4))
(assert (<= div4 (- index_22 1)))
(assert (not (not (= (mod2 v4 div4) 0))))
(check-sat)
(exit)
