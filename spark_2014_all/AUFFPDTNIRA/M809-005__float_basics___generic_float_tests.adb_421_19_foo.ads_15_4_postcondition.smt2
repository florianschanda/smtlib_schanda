...
(define-fun bool_eq ((a (Array Int ft)) (a__first Int) (a__last Int) (b (Array Int ft)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (to_rep (select a temp___idx_155)) (to_rep (select b (+ (- b__first a__first) temp___idx_155))))))) true false))
...
(assert (forall ((temp___267 Float64)) (=> (dynamic_invariant temp___267 true true true true) (forall ((temp___268 Int)) (= (to_rep (select (foo__double_tests__test_array_1__a__aggregate_def temp___267) temp___268)) temp___267)))))
