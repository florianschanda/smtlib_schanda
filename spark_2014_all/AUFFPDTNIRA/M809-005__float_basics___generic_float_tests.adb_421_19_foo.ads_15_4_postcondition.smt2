...
(assert (forall ((temp___273 Float64)) (=> (dynamic_invariant temp___273 true true true true) (forall ((temp___274 Int)) (= (to_rep (select (foo__double_tests__test_array_1__a__aggregate_def temp___273) temp___274)) temp___273)))))
