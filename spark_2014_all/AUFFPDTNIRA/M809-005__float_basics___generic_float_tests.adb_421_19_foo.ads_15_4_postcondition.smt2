...
(define-fun bool_eq ((a (Array Int ft)) (a__first Int) (a__last Int) (b (Array Int ft)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep (select a temp___idx_133)) (to_rep (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
...
(assert (forall ((temp___237 Float64)) (forall ((temp___238 Int)) (= (select (foo__double_tests__test_array_1__a__aggregate_def temp___237) temp___238) (of_rep temp___237)))))
...
(assert (= result a))
(assert (= a1 (foo__double_tests__test_array_1__a__aggregate_def (fp #b0 #b00000000000 #b0000000000000000000000000000000000000000000000000000))))
(assert (= (to_rep o) x))
(assert (= o1 (store a1 8 o)))
(assert (= result1 a1))
(assert (= a2 o1))
(assert (= (to_rep o2) (fp #b0 #b10000000000 #b1000000000000000000000000000000000000000000000000000)))
