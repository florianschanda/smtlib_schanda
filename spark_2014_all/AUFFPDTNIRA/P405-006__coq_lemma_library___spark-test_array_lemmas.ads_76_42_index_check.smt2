...
(define-fun dynamic_invariant3 ((temp___expr_214 us_t1) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_214) (last3 temp___expr_214))))
(declare-const i Int)
(declare-const o Int)
...
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt arr))) 1) i2) (<= i2 (to_rep1 (last (rt arr))))) (fp.lt (to_rep (select (elts arr) (- i2 1))) (to_rep (select (elts arr) i2))))))
(assert (and (and (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 (first (rt arr))) (to_rep1 (last (rt arr)))) (and (= (elts arr) o3) (= (mk1 (to_rep1 (first (rt arr))) (to_rep1 (last (rt arr)))) o4))) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first2 o4)) i2) (<= i2 (to_rep1 (last2 o4)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first2 o4)) j1) (<= j1 (to_rep1 (last2 o4)))) (=> (< i2 j1) (fp.lt (to_rep (select o3 i2)) (to_rep (select o3 j1))))))))))
(assert (<= (to_rep1 (first (rt arr))) i1))
(assert (<= i1 (to_rep1 (last (rt arr)))))
(assert (<= (to_rep1 (first (rt arr))) j))
(assert (<= j (to_rep1 (last (rt arr)))))
(assert (< i1 j))
(assert (and (<= (to_rep1 (first (rt arr))) j) (<= j (to_rep1 (last (rt arr))))))
(assert (= o5 j))
(assert (= o6 (select (elts arr) o5)))
(assert (= o7 (to_rep o6)))
(assert (not (<= (to_rep1 (first (rt arr))) i1)))
(check-sat)
(exit)
