...
(define-fun dynamic_invariant3 ((temp___expr_248 us_t1) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool) (temp___do_typ_inv_247 Bool)) Bool (=> (not (= temp___skip_constant_245 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_248) (last3 temp___expr_248))))
...
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep1 (first (rt arr))) 1) i1) (<= i1 (to_rep1 (last (rt arr))))) (fp.lt (to_rep (select (elts arr) (- i1 1))) (to_rep (select (elts arr) i1))))))
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 (first (rt arr))) (to_rep1 (last (rt arr)))))
(assert (= (elts arr) o))
(assert (= (mk1 (to_rep1 (first (rt arr))) (to_rep1 (last (rt arr)))) o1))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first2 o1)) i1) (<= i1 (to_rep1 (last2 o1)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first2 o1)) j1) (<= j1 (to_rep1 (last2 o1)))) (=> (< i1 j1) (fp.lt (to_rep (select o i1)) (to_rep (select o j1)))))))))
...
(assert (= o2 j))
(assert (= o3 (select (elts arr) o2)))
(assert (= o4 (to_rep o3)))
(assert (not (<= (to_rep1 (first (rt arr))) i)))
(check-sat)
(exit)
