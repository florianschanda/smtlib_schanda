...
(assert (forall ((y Float32) (x Float32)) (! (=> (and (and (dynamic_invariant y true true true true) (dynamic_invariant x true true true true)) (or (not (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq y (fp #b0 #b00000000 #b00000000000000000000000))))) (let ((result (arctan y x))) (and (=> (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.eq y (fp #b0 #b00000000 #b00000000000000000000000))) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000))) (dynamic_invariant result true false true true)))) :pattern ((arctan y x)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_852 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_852 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 3)) 70)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 9)) 58)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 12)) 98)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 13)) 115)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 16)) 99)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 20)) 97)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_852 us_void_param) 22)) 32)) :pattern ((temp___String_Literal_852 us_void_param)))))
(declare-fun temp___String_Literal_853 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_853 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_853 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 5)) 102)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 16)) 110)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 17)) 103)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 18)) 108)) (= (to_rep (select (temp___String_Literal_853 us_void_param) 19)) 101)) :pattern ((temp___String_Literal_853 us_void_param)))))
(declare-fun temp___String_Literal_854 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_854 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_854 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 3)) 70)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 9)) 58)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 13)) 98)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 14)) 115)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 17)) 99)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 18)) 108)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 19)) 101)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 22)) 116)) (= (to_rep (select (temp___String_Literal_854 us_void_param) 23)) 32)) :pattern ((temp___String_Literal_854 us_void_param)))))
(declare-fun temp___String_Literal_855 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_855 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_855 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 12)) 109)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 14)) 45)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 19)) 108)) (= (to_rep (select (temp___String_Literal_855 us_void_param) 20)) 101)) :pattern ((temp___String_Literal_855 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range5 temp___expr_198)))
(declare-const i Int)
