...
(assert (forall ((x nonnegative_float)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x Float32)) (! (=> (dynamic_invariant x true true true) (let ((result (sin1 x))) (and (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) result) (fp.leq result (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq x (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq result (fp #b0 #b00000000 #b00000000000000000000000)))) (dynamic_invariant result true false true)))) :pattern ((sin1 x)))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__algorithm__laser_scan_data__first (us_split_fields3 a))) (to_rep2 (rec__algorithm__laser_scan_data__first (us_split_fields3 b)))) (= (bool_eq2 (rec__algorithm__laser_scan_data__second (us_split_fields3 a)) (rec__algorithm__laser_scan_data__second (us_split_fields3 b))) true)) true false))
...
(define-fun bool_eq4 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq3 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true)))) true false))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_783 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_783 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 3)) 70)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 9)) 58)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 11)) 111)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 12)) 98)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 13)) 115)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 16)) 99)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 20)) 97)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_783 us_void_param) 22)) 32)) :pattern ((temp___String_Literal_783 us_void_param)))))
(declare-fun temp___String_Literal_784 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_784 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_784 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 5)) 102)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 15)) 97)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 16)) 110)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 17)) 103)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 18)) 108)) (= (to_rep (select (temp___String_Literal_784 us_void_param) 19)) 101)) :pattern ((temp___String_Literal_784 us_void_param)))))
(declare-fun temp___String_Literal_785 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_785 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_785 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 3)) 70)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 9)) 58)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 13)) 98)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 14)) 115)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 17)) 99)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 18)) 108)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 19)) 101)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 22)) 116)) (= (to_rep (select (temp___String_Literal_785 us_void_param) 23)) 32)) :pattern ((temp___String_Literal_785 us_void_param)))))
(declare-fun temp___String_Literal_786 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_786 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_786 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 12)) 109)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 14)) 45)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 19)) 108)) (= (to_rep (select (temp___String_Literal_786 us_void_param) 20)) 101)) :pattern ((temp___String_Literal_786 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_146 Float32) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range4 temp___expr_146)))
(define-fun dynamic_invariant6 ((temp___expr_170 Float32) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range5 temp___expr_170)))
(declare-const i Int)
...
(assert (not (or (not (fp.eq (fp.abs forwardlength) (fp #b0 #b00000000 #b00000000000000000000000))) (not (fp.eq (fp.div RNE (fp.abs width) (fp #b0 #b10000000 #b00000000000000000000000)) (fp #b0 #b00000000 #b00000000000000000000000))))))
(check-sat)
(exit)
