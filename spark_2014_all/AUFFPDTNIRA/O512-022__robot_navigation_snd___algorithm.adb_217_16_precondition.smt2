...
(assert (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)) fmaxrange))))
(assert (= o15 (create__2 (rec__algorithm__laser_scan_data__second rayr__split_fields4) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4)) (- 1))))
