...
(assert (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange))))
(assert (= o (create__2 (rec__algorithm__laser_scan_data__second rayr__split_fields1) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) (- 1))))
