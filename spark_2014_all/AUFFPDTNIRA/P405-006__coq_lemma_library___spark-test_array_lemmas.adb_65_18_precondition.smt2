...
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 (first temp___2461)) (to_rep1 (last temp___2461))))
(assert (= temp___246 o))
(assert (= (mk1 (to_rep1 (first temp___2461)) (to_rep1 (last temp___2461))) o1))
(declare-const i Int)
(assert (<= (to_rep1 (first2 o1)) i))
(assert (<= i (to_rep1 (last2 o1))))
(assert (not (= i (to_rep1 (first2 o1)))))
(assert (not (fp.lt (to_rep (select o (- i 1))) (to_rep (select o i)))))
(check-sat)
(exit)
