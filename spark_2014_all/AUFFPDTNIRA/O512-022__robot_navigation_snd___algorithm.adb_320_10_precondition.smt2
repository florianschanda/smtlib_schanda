...
(assert (not (or (= (has_key (positions (rec__algorithm__controller__gapvec (us_split_fields__content7 this__split_fields))) (mk___rep5 riterr__split_fields1)) true) (= (bool_eq8 (mk___rep5 riterr__split_fields1) no_element) true))))
(check-sat)
(exit)
