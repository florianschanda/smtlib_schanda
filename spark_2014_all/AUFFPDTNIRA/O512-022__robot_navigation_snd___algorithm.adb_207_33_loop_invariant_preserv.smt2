...
(assert (<= 2 i1))
(assert (<= i1 999))
(assert (and (= (to_rep4 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000) (< (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) i2)))
...
(assert (and (= algorithm__buildgapvector__B_9__dist__assume (fp.sub RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)))) (fp.isFinite32 (fp.sub RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1))))))
(assert (= algorithm__buildgapvector__B_9__dist__assume dist1))
(assert (fp.isFinite32 dist1))
(assert (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange))) (= o (create__2 (rec__algorithm__laser_scan_data__second rayr__split_fields1) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) (- 1)))))
(assert (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange))) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) o) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true))))
(assert (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange))) (= result3 (mk___split_fields__ref2 gapvec__split_fields1))))
(assert (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange))) (= gapvec__split_fields2 algorithm__gap_vectors__append__container__fields)))
(assert (=> (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange))) (= algorithm__gap_vectors__append__container__fields1 rho1)))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange))) (= o1 (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields1) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) 1)))))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange))) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) o1) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields1))) true)))))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange))) (= result4 (mk___split_fields__ref2 gapvec__split_fields1)))))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (=> (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange))) (= gapvec__split_fields3 algorithm__gap_vectors__append__container__fields1))))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (=> (not (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange)))) (= gapvec__split_fields3 gapvec__split_fields1))))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (=> (not (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange)))) (= algorithm__gap_vectors__append__container__fields1 rho1))))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (=> (not (or (fp.leq dist1 (fp.neg mingapwidth)) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange)))) (= gapvec__split_fields3 gapvec__split_fields1))))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (= gapvec__split_fields2 gapvec__split_fields3)))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (= algorithm__gap_vectors__append__container__fields rho)))
(assert (=> (not (or (fp.leq mingapwidth dist1) (and (fp.eq (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields1)) fmaxrange) (fp.lt (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields1)) fmaxrange)))) (= gapvec__split_fields2 gapvec__split_fields3)))
(assert (not (= i2 999)))
