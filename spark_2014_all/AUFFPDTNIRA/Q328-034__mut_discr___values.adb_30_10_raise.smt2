...
(declare-datatypes () ((number_kind__ref (mk_number_kind__ref (number_kind__content number_kind)))))
(define-fun number_kind__ref___projection ((a number_kind__ref)) number_kind (number_kind__content a))
(define-fun dynamic_invariant3 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 2)) (in_range3 temp___expr_160)))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__types__value__e (us_split_fields1 a))) (to_rep (rec__types__value__e (us_split_fields1 b)))) true false))
...
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 real_val)))
(assert (=> (<= 0 2) (in_range3 kind)))
(assert (and (and (in_range int_val1) (fp.isFinite32 real_val1)) (in_range3 kind1)))
(assert (not (= kind1 1)))
(check-sat)
(exit)
