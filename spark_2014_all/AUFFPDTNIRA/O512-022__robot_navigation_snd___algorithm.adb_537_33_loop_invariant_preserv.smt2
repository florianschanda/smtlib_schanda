...
(assert (=> (= result3 true) (and (= o1 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))) (fp.isFinite32 (fp.add RNE safetydist (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))))))
(assert (=> (= result3 true) (= o2 (fp.sub RNE o1 (to_rep1 (rec__algorithm__laser_scan_data__first (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))))))))
...
(assert (=> (= result3 true) (and (= o6 (limit o5 (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b01111111 #b00000000000000000000000))) (and (fp.isFinite32 o6) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) o6) (fp.leq o6 (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (=> (= result3 true) (and (= o7 o6) (fp.isFinite32 o6))))
(assert (=> (= result3 true) (= deltamag1 result4)))
(assert (=> (= result3 true) (= deltamag2 o7)))
(assert (=> (= result3 true) (= o16 (create__2 (fp #b0 #b10000000 #b10010010000111111011011)))))
(assert (=> (= result3 true) (= o15 (oadd (rec__algorithm__laser_scan_data__second (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))) o16))))
(assert (=> (= result3 true) (and (= o10 (aldiff (rec__algorithm__controller__driveangle (us_split_fields11 this)) o15)) (and (fp.isFinite32 o10) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o10) (fp.leq o10 (fp #b0 #b10000000 #b10010010000111111011011)))))))
(assert (=> (= result3 true) (= deltaangle1 result5)))
(assert (=> (= result3 true) (= deltaangle2 o10)))
(assert (=> (= result3 true) (and (= o11 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag2 deltamag2))) (fp.isFinite32 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag2 deltamag2))))))
(assert (=> (= result3 true) (= deltaareasum2 result6)))
(assert (=> (= result3 true) (= deltaareasum3 o11)))
(assert (=> (= result3 true) (and (= o12 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag2 deltamag2) deltamag2) deltaangle2)) (fp.isFinite32 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag2 deltamag2) deltamag2) deltaangle2)))))
...
(assert (=> (= result3 true) (= obstacleavoiddelta3 o14)))
(assert (=> (not (= result3 true)) (= obstacleavoiddelta3 obstacleavoiddelta2)))
(assert (=> (not (= result3 true)) (= deltaareasum3 deltaareasum2)))
(assert (=> (not (= result3 true)) (= deltaangle2 deltaangle1)))
(assert (=> (not (= result3 true)) (= deltamag2 deltamag1)))
(assert (not (= i2 1000)))
(assert (= result8 i2))
(assert (= i3 (+ i2 1)))
(assert (not (fp.eq (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))) (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields11 this))))))))
(check-sat)
(exit)
