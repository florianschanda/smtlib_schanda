...
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= temp___1902 (t__dummy__aggregate_def (mk___rep (mk___split_fields o5 o6 o7)) 0 (div1 value__size 8))))
(assert (= (to_rep (first2 temp___1901)) 0))
(assert (= (to_rep (last2 temp___1901)) (div1 value__size 8)))
(assert (= (mk___t1 temp___191 temp___1911) temp___1902))
(assert (not (= (ite (<= (to_rep (first2 temp___1911)) (to_rep (last2 temp___1911))) (+ (- (to_rep (last2 temp___1911)) (to_rep (first2 temp___1911))) 1) 0) (ite (<= 0 (div1 value__size 8)) (+ (- (div1 value__size 8) 0) 1) 0))))
(check-sat)
(exit)
