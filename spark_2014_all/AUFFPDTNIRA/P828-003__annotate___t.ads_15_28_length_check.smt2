...
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= (mk___t1 temp___165 temp___1651) (t__dummy__aggregate_def (mk___rep (mk___split_fields o6 o7 o8)) 0 (div1 value__size 8))))
(assert (= (to_rep (first2 temp___1651)) 0))
(assert (= (to_rep (last2 temp___1651)) (div1 value__size 8)))
(assert (= (mk___t1 temp___166 temp___1661) (mk___t1 temp___165 temp___1651)))
(assert (not (= (ite (<= (to_rep (first2 temp___1661)) (to_rep (last2 temp___1661))) (+ (- (to_rep (last2 temp___1661)) (to_rep (first2 temp___1661))) 1) 0) (ite (<= 0 (div1 value__size 8)) (+ (- (div1 value__size 8) 0) 1) 0))))
(check-sat)
(exit)
