...
(define-fun bool_eq ((a (Array Int nonnegative_float)) (a__first Int) (a__last Int) (b (Array Int nonnegative_float)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(declare-fun concat2 ((Array Int us_rep4) Int Int (Array Int us_rep4) Int Int) (Array Int us_rep4))
...
(assert (forall ((v us_rep4)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq6 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq5 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true)))) true false))
(assert (forall ((a (Array Int us_rep4)) (b (Array Int us_rep4))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq5 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true))))))))
...
(assert (forall ((temp___616 Float32)) (forall ((temp___617 Int)) (= (select (temp___614 temp___616) temp___617) (of_rep3 temp___616)))))
(declare-fun temp___618 (us_rep4) (Array Int us_rep4))
(assert (forall ((temp___620 us_rep4)) (forall ((temp___621 Int)) (= (select (temp___618 temp___620) temp___621) temp___620))))
(define-fun dynamic_invariant ((temp___expr_607 us_rep5) (temp___is_init_604 Bool) (temp___skip_constant_605 Bool) (temp___do_toplevel_606 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 (rec__algorithm__controller__robot (us_split_fields11 temp___expr_607))))) false) (in_range6 1000 (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_607)))))
(define-fun default_initial_assumption ((temp___expr_612 us_rep5) (temp___skip_top_level_613 Bool)) Bool (and (and (and (and (= (rec__algorithm__controller__robot (us_split_fields11 temp___expr_612)) (mk___rep1 (mk___split_fields1 (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep1 0) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (temp___614 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (let ((usq_ (mk___rep (mk___split_discrs (of_rep5 0)) (mk___split_fields dummy2 dummy2) true))) (mk___rep (us_split_discrs1 usq_) (us_split_fields1 usq_) false)) (of_int1 0)))) (= (rec__algorithm__controller__laserscan (us_split_fields11 temp___expr_612)) (temp___618 (mk___rep4 (mk___split_fields4 (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) null_angle))))) (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_612))))) 1000) (= (is_empty (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_612))) true))) (= (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields11 temp___expr_612))) (fp #b0 #b00000000 #b00000000000000000000000))) (= (rec__algorithm__controller__driveangle (us_split_fields11 temp___expr_612)) null_angle)))
...
(define-fun dynamic_invariant3 ((temp___expr_577 us_rep3) (temp___is_init_574 Bool) (temp___skip_constant_575 Bool) (temp___do_toplevel_576 Bool)) Bool (=> (not (= temp___skip_constant_575 true)) (in_range6 1000 temp___expr_577)))
(define-fun default_initial_assumption1 ((temp___expr_579 us_rep3) (temp___skip_top_level_580 Bool)) Bool (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 temp___expr_579))) 1000) (=> (not (= temp___skip_top_level_580 true)) (= (is_empty temp___expr_579) true))))
(define-fun dynamic_invariant4 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 1)) (in_range3 temp___expr_220)))
(define-fun default_initial_assumption2 ((temp___expr_228 us_rep) (temp___skip_top_level_229 Bool)) Bool (and (= (attr__constrained temp___expr_228) false) (= (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 temp___expr_228))) 0)))
(define-fun dynamic_invariant5 ((temp___expr_236 us_rep1) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 temp___expr_236))) false))
(define-fun default_initial_assumption3 ((temp___expr_239 us_rep1) (temp___skip_top_level_240 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 temp___expr_239))) false) (= (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 (rec__robot_iface__proxy__speed (us_split_fields3 temp___expr_239))))) 0)))
(define-fun dynamic_invariant6 ((temp___expr_140 Float32) (temp___is_init_137 Bool) (temp___skip_constant_138 Bool) (temp___do_toplevel_139 Bool)) Bool (=> (or (= temp___is_init_137 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range temp___expr_140)))
(define-fun dynamic_invariant7 ((temp___expr_146 Float32) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range2 temp___expr_146)))
(define-fun dynamic_invariant8 ((temp___expr_158 Float32) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_158)))
(assert (= null_angle (mk___rep2 (mk___split_fields2 (of_rep6 (fp #b0 #b00000000 #b00000000000000000000000))))))
(define-fun dynamic_invariant9 ((temp___expr_170 Float32) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range4 temp___expr_170)))
(define-fun dynamic_invariant10 ((temp___expr_324 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 0 2147483647)) (in_range5 temp___expr_324)))
(declare-fun length (us_rep3) Int)
(declare-fun length__function_guard (Int us_rep3) Bool)
(assert (forall ((container us_rep3)) (! (let ((result (length container))) (and (<= result (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 container)))) (dynamic_invariant10 result true false true))) :pattern ((length container)))))
