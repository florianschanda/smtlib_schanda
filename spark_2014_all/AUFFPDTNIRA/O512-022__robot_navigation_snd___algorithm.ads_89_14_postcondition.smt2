...
(assert (forall ((x positive_float)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x nonnegative_float)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Float32)) (! (=> (in_range2 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
...
(assert (forall ((x unbounded_float)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x unbounded_float)) (! (fp.isFinite32 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq ((a (Array Int nonnegative_float)) (a__first Int) (a__last Int) (b (Array Int nonnegative_float)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep3 (select a temp___idx_154)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(assert (forall ((a (Array Int nonnegative_float))) (<= 0 (object__size a))))
(assert (<= 0 value__component__size))
(assert (forall ((a (Array Int nonnegative_float))) (<= 0 (object__component__size a))))
(assert (<= 0 value__alignment))
(assert (forall ((a (Array Int nonnegative_float))) (<= 0 (object__alignment a))))
(declare-fun user_eq5 ((Array Int nonnegative_float) (Array Int nonnegative_float)) Bool)
...
(assert (forall ((x option)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x option)) (! (in_range3 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__robot_iface__speed_option__modulus float) (rec__robot_iface__speed_option__angle float)))))
(define-fun us_split_fields_modulus__projection ((a us_split_fields)) float (rec__robot_iface__speed_option__modulus a))
(define-fun us_split_fields_angle__projection ((a us_split_fields)) float (rec__robot_iface__speed_option__angle a))
...
(define-fun robot_iface__speed_option__modulus__pred ((a us_rep)) Bool (= (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))
(define-fun robot_iface__speed_option__angle__pred ((a us_rep)) Bool (= (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 b)))) (and (=> (robot_iface__speed_option__modulus__pred a) (= (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields1 a))) (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields1 b))))) (=> (robot_iface__speed_option__angle__pred a) (= (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields1 a))) (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields1 b))))))) true false))
...
(declare-datatypes () ((speed_option__ref (mk_speed_option__ref (speed_option__content us_rep)))))
(define-fun speed_option__ref___projection ((a speed_option__ref)) us_rep (speed_option__content a))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__robot_iface__proxy__robot_radius positive_float) (rec__robot_iface__proxy__min_gap_width positive_float) (rec__robot_iface__proxy__obstacle_avoid_dist positive_float) (rec__robot_iface__proxy__max_speed positive_float) (rec__robot_iface__proxy__max_turn_rate positive_float) (rec__robot_iface__proxy__goal_position_tol nonnegative_float) (rec__robot_iface__proxy__goal_angle_tol nonnegative_float) (rec__robot_iface__proxy__goalx float) (rec__robot_iface__proxy__goaly float) (rec__robot_iface__proxy__goala float) (rec__robot_iface__proxy__scan_count natural) (rec__robot_iface__proxy__scan_res positive_float) (rec__robot_iface__proxy__max_range positive_float) (rec__robot_iface__proxy__scans (Array Int nonnegative_float)) (rec__robot_iface__proxy__x unbounded_float) (rec__robot_iface__proxy__y unbounded_float) (rec__robot_iface__proxy__yaw unbounded_float) (rec__robot_iface__proxy__speed us_rep) (rec__robot_iface__proxy__goal_reached Bool)))))
(define-fun us_split_fields_robot_radius__projection ((a us_split_fields2)) positive_float (rec__robot_iface__proxy__robot_radius a))
(define-fun us_split_fields_min_gap_width__projection ((a us_split_fields2)) positive_float (rec__robot_iface__proxy__min_gap_width a))
(define-fun us_split_fields_obstacle_avoid_dist__projection ((a us_split_fields2)) positive_float (rec__robot_iface__proxy__obstacle_avoid_dist a))
(define-fun us_split_fields_max_speed__projection ((a us_split_fields2)) positive_float (rec__robot_iface__proxy__max_speed a))
(define-fun us_split_fields_max_turn_rate__projection ((a us_split_fields2)) positive_float (rec__robot_iface__proxy__max_turn_rate a))
(define-fun us_split_fields_goal_position_tol__projection ((a us_split_fields2)) nonnegative_float (rec__robot_iface__proxy__goal_position_tol a))
(define-fun us_split_fields_goal_angle_tol__projection ((a us_split_fields2)) nonnegative_float (rec__robot_iface__proxy__goal_angle_tol a))
(define-fun us_split_fields_goalX__projection ((a us_split_fields2)) float (rec__robot_iface__proxy__goalx a))
(define-fun us_split_fields_goalY__projection ((a us_split_fields2)) float (rec__robot_iface__proxy__goaly a))
(define-fun us_split_fields_goalA__projection ((a us_split_fields2)) float (rec__robot_iface__proxy__goala a))
(define-fun us_split_fields_scan_Count__projection ((a us_split_fields2)) natural (rec__robot_iface__proxy__scan_count a))
(define-fun us_split_fields_scan_Res__projection ((a us_split_fields2)) positive_float (rec__robot_iface__proxy__scan_res a))
(define-fun us_split_fields_max_Range__projection ((a us_split_fields2)) positive_float (rec__robot_iface__proxy__max_range a))
(define-fun us_split_fields_scans__projection ((a us_split_fields2)) (Array Int nonnegative_float) (rec__robot_iface__proxy__scans a))
(define-fun us_split_fields_X__projection ((a us_split_fields2)) unbounded_float (rec__robot_iface__proxy__x a))
(define-fun us_split_fields_Y__projection ((a us_split_fields2)) unbounded_float (rec__robot_iface__proxy__y a))
(define-fun us_split_fields_Yaw__projection ((a us_split_fields2)) unbounded_float (rec__robot_iface__proxy__yaw a))
(define-fun us_split_fields_speed__projection ((a us_split_fields2)) us_rep (rec__robot_iface__proxy__speed a))
(define-fun us_split_fields_goal_reached__projection ((a us_split_fields2)) Bool (rec__robot_iface__proxy__goal_reached a))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 a))) (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 b)))) (= (to_rep (rec__robot_iface__proxy__min_gap_width (us_split_fields3 a))) (to_rep (rec__robot_iface__proxy__min_gap_width (us_split_fields3 b))))) (= (to_rep (rec__robot_iface__proxy__obstacle_avoid_dist (us_split_fields3 a))) (to_rep (rec__robot_iface__proxy__obstacle_avoid_dist (us_split_fields3 b))))) (= (to_rep (rec__robot_iface__proxy__max_speed (us_split_fields3 a))) (to_rep (rec__robot_iface__proxy__max_speed (us_split_fields3 b))))) (= (to_rep (rec__robot_iface__proxy__max_turn_rate (us_split_fields3 a))) (to_rep (rec__robot_iface__proxy__max_turn_rate (us_split_fields3 b))))) (= (to_rep3 (rec__robot_iface__proxy__goal_position_tol (us_split_fields3 a))) (to_rep3 (rec__robot_iface__proxy__goal_position_tol (us_split_fields3 b))))) (= (to_rep3 (rec__robot_iface__proxy__goal_angle_tol (us_split_fields3 a))) (to_rep3 (rec__robot_iface__proxy__goal_angle_tol (us_split_fields3 b))))) (= (to_rep2 (rec__robot_iface__proxy__goalx (us_split_fields3 a))) (to_rep2 (rec__robot_iface__proxy__goalx (us_split_fields3 b))))) (= (to_rep2 (rec__robot_iface__proxy__goaly (us_split_fields3 a))) (to_rep2 (rec__robot_iface__proxy__goaly (us_split_fields3 b))))) (= (to_rep2 (rec__robot_iface__proxy__goala (us_split_fields3 a))) (to_rep2 (rec__robot_iface__proxy__goala (us_split_fields3 b))))) (= (to_rep1 (rec__robot_iface__proxy__scan_count (us_split_fields3 a))) (to_rep1 (rec__robot_iface__proxy__scan_count (us_split_fields3 b))))) (= (to_rep (rec__robot_iface__proxy__scan_res (us_split_fields3 a))) (to_rep (rec__robot_iface__proxy__scan_res (us_split_fields3 b))))) (= (to_rep (rec__robot_iface__proxy__max_range (us_split_fields3 a))) (to_rep (rec__robot_iface__proxy__max_range (us_split_fields3 b))))) (= (bool_eq (rec__robot_iface__proxy__scans (us_split_fields3 a)) 1 1000 (rec__robot_iface__proxy__scans (us_split_fields3 b)) 1 1000) true)) (= (to_rep4 (rec__robot_iface__proxy__x (us_split_fields3 a))) (to_rep4 (rec__robot_iface__proxy__x (us_split_fields3 b))))) (= (to_rep4 (rec__robot_iface__proxy__y (us_split_fields3 a))) (to_rep4 (rec__robot_iface__proxy__y (us_split_fields3 b))))) (= (to_rep4 (rec__robot_iface__proxy__yaw (us_split_fields3 a))) (to_rep4 (rec__robot_iface__proxy__yaw (us_split_fields3 b))))) (= (bool_eq1 (rec__robot_iface__proxy__speed (us_split_fields3 a)) (rec__robot_iface__proxy__speed (us_split_fields3 b))) true)) (= (rec__robot_iface__proxy__goal_reached (us_split_fields3 a)) (rec__robot_iface__proxy__goal_reached (us_split_fields3 b)))) true false))
...
(assert (forall ((x normalized2pi)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x normalized2pi)) (! (in_range4 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x Float32)) (! (=> (in_range4 x) (= (to_rep6 (of_rep6 x)) x)) :pattern ((to_rep6 (of_rep6 x))))))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep6 (rec__spaces__angles__angle__theta (us_split_fields5 a))) (to_rep6 (rec__spaces__angles__angle__theta (us_split_fields5 b)))) true false))
...
(declare-datatypes () ((angle__ref (mk_angle__ref (angle__content us_rep2)))))
(define-fun angle__ref___projection ((a angle__ref)) us_rep2 (angle__content a))
...
(assert (forall ((x count_type)) (! (in_range5 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__algorithm__gap_vectors__list us_main_type)))))
(define-fun us_split_fields_List__projection ((a us_split_fields6)) us_main_type (rec__algorithm__gap_vectors__list a))
...
(declare-datatypes () ((us_rep3 (mk___rep3 (us_split_discrs3 us_split_discrs2) (us_split_fields7 us_split_fields6)))))
(define-fun us_rep___13__projection ((a us_rep3)) us_split_discrs2 (us_split_discrs3 a))
(define-fun us_rep___14__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 a))) (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 b)))) (= (us_main_eq (rec__algorithm__gap_vectors__list (us_split_fields7 a)) (rec__algorithm__gap_vectors__list (us_split_fields7 b))) true)) true false))
...
(define-fun in_range6 ((rec__algorithm__gap_vectors__list__capacity1 Int) (a us_rep3)) Bool (= rec__algorithm__gap_vectors__list__capacity1 (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 a)))))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__algorithm__laser_scan_data__first nonnegative_float) (rec__algorithm__laser_scan_data__second us_rep2)))))
...
(define-fun us_split_fields_second__projection ((a us_split_fields8)) us_rep2 (rec__algorithm__laser_scan_data__second a))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (to_rep3 (rec__algorithm__laser_scan_data__first (us_split_fields9 a))) (to_rep3 (rec__algorithm__laser_scan_data__first (us_split_fields9 b)))) (= (bool_eq3 (rec__algorithm__laser_scan_data__second (us_split_fields9 a)) (rec__algorithm__laser_scan_data__second (us_split_fields9 b))) true)) true false))
...
(declare-datatypes () ((laser_scan_data__ref (mk_laser_scan_data__ref (laser_scan_data__content us_rep4)))))
(define-fun laser_scan_data__ref___projection ((a laser_scan_data__ref)) us_rep4 (laser_scan_data__content a))
...
(assert (forall ((a (Array Int us_rep4))) (<= 0 (object__component__size1 a))))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__algorithm__controller__robot us_rep1) (rec__algorithm__controller__laserscan (Array Int us_rep4)) (rec__algorithm__controller__gapvec us_rep3) (rec__algorithm__controller__obsavoiddelta float) (rec__algorithm__controller__driveangle us_rep2)))))
(define-fun us_split_fields_robot__projection ((a us_split_fields10)) us_rep1 (rec__algorithm__controller__robot a))
(define-fun us_split_fields_laserScan__projection ((a us_split_fields10)) (Array Int us_rep4) (rec__algorithm__controller__laserscan a))
(define-fun us_split_fields_gapVec__projection ((a us_split_fields10)) us_rep3 (rec__algorithm__controller__gapvec a))
...
(define-fun us_split_fields_driveAngle__projection ((a us_split_fields10)) us_rep2 (rec__algorithm__controller__driveangle a))
...
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (= (bool_eq2 (rec__algorithm__controller__robot (us_split_fields11 a)) (rec__algorithm__controller__robot (us_split_fields11 b))) true) (= (bool_eq6 (rec__algorithm__controller__laserscan (us_split_fields11 a)) 1 1000 (rec__algorithm__controller__laserscan (us_split_fields11 b)) 1 1000) true)) (= (bool_eq4 (rec__algorithm__controller__gapvec (us_split_fields11 a)) (rec__algorithm__controller__gapvec (us_split_fields11 b))) true)) (= (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields11 a))) (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields11 b))))) (= (bool_eq3 (rec__algorithm__controller__driveangle (us_split_fields11 a)) (rec__algorithm__controller__driveangle (us_split_fields11 b))) true)) true false))
...
(define-fun in_range8 ((rec__robot_iface__speed_option__opt1 Int) (a us_rep)) Bool (= rec__robot_iface__speed_option__opt1 (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 a)))))
...
(define-fun t252s__ref___projection ((a t252s__ref)) us_rep (t252s__content a))
...
(define-fun dynamic_invariant ((temp___expr_673 us_rep5) (temp___is_init_669 Bool) (temp___skip_constant_670 Bool) (temp___do_toplevel_671 Bool) (temp___do_typ_inv_672 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 (rec__algorithm__controller__robot (us_split_fields11 temp___expr_673))))) false) (in_range6 1000 (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_673)))))
(declare-const rliteral natural)
(assert (= (naturalqtint rliteral) 0))
(define-fun default_initial_assumption ((temp___expr_678 us_rep5) (temp___skip_top_level_679 Bool)) Bool (and (and (and (and (= (rec__algorithm__controller__robot (us_split_fields11 temp___expr_678)) (mk___rep1 (mk___split_fields1 (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) rliteral (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)) (temp_____aggregate_def_680 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (let ((usq_ (mk___rep (mk___split_discrs (of_rep5 0)) (mk___split_fields dummy2 dummy2) true))) (mk___rep (us_split_discrs1 usq_) (us_split_fields1 usq_) false)) (distinct 0 0)))) (= (rec__algorithm__controller__laserscan (us_split_fields11 temp___expr_678)) (temp_____aggregate_def_684 (mk___rep4 (mk___split_fields4 (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) null_angle))))) (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_678))))) 1000) (= (is_empty (rec__algorithm__controller__gapvec (us_split_fields11 temp___expr_678))) true))) (= (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields11 temp___expr_678))) (fp #b0 #b00000000 #b00000000000000000000000))) (= (rec__algorithm__controller__driveangle (us_split_fields11 temp___expr_678)) null_angle)))
...
(define-fun dynamic_invariant3 ((temp___expr_640 us_rep3) (temp___is_init_636 Bool) (temp___skip_constant_637 Bool) (temp___do_toplevel_638 Bool) (temp___do_typ_inv_639 Bool)) Bool (=> (not (= temp___skip_constant_637 true)) (in_range6 1000 temp___expr_640)))
(define-fun default_initial_assumption1 ((temp___expr_642 us_rep3) (temp___skip_top_level_643 Bool)) Bool (and (= (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 temp___expr_642))) 1000) (=> (not (= temp___skip_top_level_643 true)) (= (is_empty temp___expr_642) true))))
(assert (forall ((temp___686 us_rep4)) (forall ((temp___687 Int)) (= (select (temp_____aggregate_def_684 temp___686) temp___687) temp___686))))
(define-fun dynamic_invariant4 ((temp___expr_254 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool) (temp___do_typ_inv_253 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 1)) (in_range3 temp___expr_254)))
(define-fun default_initial_assumption2 ((temp___expr_263 us_rep) (temp___skip_top_level_264 Bool)) Bool (and (= (attr__constrained temp___expr_263) false) (= (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 temp___expr_263))) 0)))
(define-fun dynamic_invariant5 ((temp___expr_272 us_rep1) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool) (temp___do_typ_inv_271 Bool)) Bool (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 temp___expr_272))) false))
(define-fun default_initial_assumption3 ((temp___expr_275 us_rep1) (temp___skip_top_level_276 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 temp___expr_275))) false) (= (to_rep5 (rec__robot_iface__speed_option__opt (us_split_discrs1 (rec__robot_iface__proxy__speed (us_split_fields3 temp___expr_275))))) 0)))
(define-fun dynamic_invariant6 ((temp___expr_163 Float32) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool) (temp___do_typ_inv_162 Bool)) Bool (=> (or (= temp___is_init_159 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range temp___expr_163)))
(define-fun dynamic_invariant7 ((temp___expr_170 Float32) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool) (temp___do_typ_inv_169 Bool)) Bool (=> (or (= temp___is_init_166 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range2 temp___expr_170)))
...
(assert (= null_angle (mk___rep2 (mk___split_fields2 (of_rep6 (fp #b0 #b00000000 #b00000000000000000000000))))))
(define-fun dynamic_invariant9 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range4 temp___expr_198)))
(define-fun dynamic_invariant10 ((temp___expr_365 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range5 temp___expr_365)))
(declare-fun length (us_rep3) Int)
(declare-fun length__function_guard (Int us_rep3) Bool)
(assert (forall ((container us_rep3)) (! (let ((result (length container))) (and (<= result (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 container)))) (dynamic_invariant10 result true false true true))) :pattern ((length container)))))
(assert (forall ((container us_rep3)) (! (= (= (is_empty container) true) (= (length container) 0)) :pattern ((is_empty container)))))
(assert (forall ((temp___682 Float32)) (=> (dynamic_invariant7 temp___682 true true true true) (forall ((temp___683 Int)) (= (to_rep3 (select (temp_____aggregate_def_680 temp___682) temp___683)) temp___682)))))
...
(assert (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 (rec__algorithm__controller__robot (us_split_fields__content5 this__split_fields))))) false) (= 1000 (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields__content5 this__split_fields))))))))
(assert (and (fp.eq (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields1))))) (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 (rec__algorithm__controller__robot (us_split_fields__content5 this__split_fields)))))) (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields1))))) false) (= 1000 (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)))))))))
(assert (and (fp.eq (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields2))))) (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields1)))))) (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields3 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields2))))) false) (= 1000 (to_rep7 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2)))))))))
(assert (= this__split_fields3 (let ((subject this__split_fields)) (mk___split_fields__ref5 this__split_fields2))))
(assert (= this__split_fields4 this__split_fields2))
(assert (not (fp.eq (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 (rec__algorithm__controller__robot (us_split_fields__content5 this__split_fields3))))) (to_rep (rec__robot_iface__proxy__robot_radius (us_split_fields3 (rec__algorithm__controller__robot (us_split_fields__content5 this__split_fields))))))))
(check-sat)
(exit)
