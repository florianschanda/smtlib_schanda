...
(assert (forall ((temp___686 us_rep4)) (forall ((temp___687 Int)) (= (select (temp___684 temp___686) temp___687) temp___686))))
...
(assert (forall ((temp___682 Float32)) (=> (dynamic_invariant7 temp___682 true true true true) (forall ((temp___683 Int)) (= (to_rep3 (select (temp___680 temp___682) temp___683)) temp___682)))))
