...
(assert (=> (and (not (= (bool_eq8 (mk___rep5 riterl__split_fields4) no_element) true)) (not (= (bool_eq8 (mk___rep5 riterr__split_fields4) no_element) true))) (and (= o29 (length1 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields3)))) (and (in_range10 o29) (<= o29 (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields3))))))))))
(assert (=> (and (not (= (bool_eq8 (mk___rep5 riterl__split_fields4) no_element) true)) (not (= (bool_eq8 (mk___rep5 riterr__split_fields4) no_element) true))) (= o30 (ite (< 1 o29) true false))))
(assert (=> (not (and (not (= (bool_eq8 (mk___rep5 riterl__split_fields4) no_element) true)) (not (= (bool_eq8 (mk___rep5 riterr__split_fields4) no_element) true)))) (= o30 false)))
(assert (= result10 (ite (not (= o30 true)) true false)))
(assert (not (= result10 true)))
(assert (not (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields3))) (mk___rep5 riterr__split_fields4)) true)))
(check-sat)
(exit)
