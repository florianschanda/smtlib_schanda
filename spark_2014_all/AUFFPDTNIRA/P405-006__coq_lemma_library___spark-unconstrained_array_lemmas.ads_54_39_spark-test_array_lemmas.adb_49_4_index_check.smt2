...
(define-fun dynamic_invariant ((temp___expr_214 us_t) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_214) (last1 temp___expr_214))))
...
(assert (not (<= (to_rep1 (first (rt arr))) temp___255)))
(check-sat)
(exit)
