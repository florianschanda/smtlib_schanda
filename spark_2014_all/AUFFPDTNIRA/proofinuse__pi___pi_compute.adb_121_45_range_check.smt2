...
(assert (= o9 (concat1 (temp___String_Literal_575 Tuple0) 1 29 temp___577 (to_rep1 (first temp___5771)) (to_rep1 (last temp___5771)))))
(assert (= o10 (mk 1 o8)))
...
(assert (= (mk___t temp___580 temp___5801) (to_string o12)))
(assert (=> (<= (to_rep1 (first temp___5801)) (to_rep1 (last temp___5801))) (= o13 (+ (- (to_rep1 (last temp___5801)) (to_rep1 (first temp___5801))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5801)) (to_rep1 (last temp___5801)))) (= o13 0)))
...
(assert (= o19 (concat1 (temp___String_Literal_578 Tuple0) 1 30 temp___580 (to_rep1 (first temp___5801)) (to_rep1 (last temp___5801)))))
(assert (= o20 (mk 1 o18)))
(assert (and (= o21 (shanks_fixed Tuple0)) (= (to_fixed o21) 3293842)))
(assert (= o22 (to_fixed o21)))
(assert (= o23 (attr__ATTRIBUTE_IMAGE4 o22)))
(assert (= (mk___t temp___583 temp___5831) (to_string o23)))
(assert (=> (<= (to_rep1 (first temp___5831)) (to_rep1 (last temp___5831))) (= o24 (+ (- (to_rep1 (last temp___5831)) (to_rep1 (first temp___5831))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5831)) (to_rep1 (last temp___5831)))) (= o24 0)))
