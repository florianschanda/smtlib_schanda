...
(define-fun dynamic_invariant ((temp___expr_520 Float32) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool)) Bool (=> (or (= temp___is_init_517 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_520)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_523 us_void_param) 1)) 88) (= (to_rep (select (temp___String_Literal_523 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 3)) 49)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 5)) 61)) (= (to_rep (select (temp___String_Literal_523 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_523 us_void_param)))))
(declare-fun temp___String_Literal_526 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_526 us_void_param) 1)) 88) (= (to_rep (select (temp___String_Literal_526 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_526 us_void_param) 3)) 50)) (= (to_rep (select (temp___String_Literal_526 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_526 us_void_param) 5)) 61)) (= (to_rep (select (temp___String_Literal_526 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_526 us_void_param)))))
(declare-fun temp___String_Literal_529 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_529 us_void_param) 1)) 88) (= (to_rep (select (temp___String_Literal_529 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_529 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_529 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_529 us_void_param) 5)) 61)) (= (to_rep (select (temp___String_Literal_529 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_529 us_void_param)))))
(declare-fun temp___String_Literal_532 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_532 us_void_param) 1)) 88) (= (to_rep (select (temp___String_Literal_532 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_532 us_void_param) 3)) 52)) (= (to_rep (select (temp___String_Literal_532 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_532 us_void_param) 5)) 61)) (= (to_rep (select (temp___String_Literal_532 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_532 us_void_param)))))
(declare-fun temp___String_Literal_535 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_535 us_void_param) 1)) 88) (= (to_rep (select (temp___String_Literal_535 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 3)) 53)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 5)) 61)) (= (to_rep (select (temp___String_Literal_535 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_535 us_void_param)))))
...
(declare-const x23 Float32)
(declare-const x24 Float32)
(declare-const x25 Float32)
(declare-const o Int)
...
(declare-const x231 Float32)
(declare-const x241 Float32)
(declare-const x251 Float32)
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 x21)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 x22)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 x23)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 x24)))
(assert (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 x25)))
(assert (and (and (and (and (fp.isFinite32 x211) (fp.isFinite32 x221)) (fp.isFinite32 x231)) (fp.isFinite32 x241)) (fp.isFinite32 x251)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x211))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x211)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x211))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x211)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x211))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x211))))))) (= o 0)))
(assert (=> (<= 1 6) (= o1 (+ (- 6 1) 1))))
(assert (=> (not (<= 1 6)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
