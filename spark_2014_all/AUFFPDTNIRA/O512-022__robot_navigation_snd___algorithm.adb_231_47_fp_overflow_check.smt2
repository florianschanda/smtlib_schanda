...
(assert (and (= o3 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields7)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))
(assert (= o4 (fp.mul RNE o3 (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields7)))))
...
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields7)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields7))))))
(check-sat)
(exit)
