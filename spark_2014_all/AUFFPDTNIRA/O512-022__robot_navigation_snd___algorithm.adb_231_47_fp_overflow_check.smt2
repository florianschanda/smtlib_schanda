...
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields11))))))
(check-sat)
(exit)
