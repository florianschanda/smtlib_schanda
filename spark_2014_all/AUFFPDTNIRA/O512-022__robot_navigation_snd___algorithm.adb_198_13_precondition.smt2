...
(assert (fp.leq mingapwidth dist))
(assert (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o12)) o13 o14)) (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields2) (fp.neg robotradius) (- 1))))
(assert (not (< (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (to_rep4 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)))))
(check-sat)
(exit)
