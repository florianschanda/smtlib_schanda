...
(define-fun bool_eq ((a (Array Int ft)) (a__first Int) (a__last Int) (b (Array Int ft)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep (select a temp___idx_154)) (to_rep (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(assert (forall ((temp___240 Float32)) (=> (dynamic_invariant temp___240 true true true true) (forall ((temp___241 Int)) (= (to_rep (select (foo__float_tests__test_array_1__a__aggregate_def temp___240) temp___241)) temp___240)))))
