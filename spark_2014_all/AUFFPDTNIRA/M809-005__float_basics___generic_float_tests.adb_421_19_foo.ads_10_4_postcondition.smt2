...
(assert (forall ((temp___243 Float32)) (=> (dynamic_invariant temp___243 true true true true) (forall ((temp___244 Int)) (= (to_rep (select (foo__float_tests__test_array_1__a__aggregate_def temp___243) temp___244)) temp___243)))))
