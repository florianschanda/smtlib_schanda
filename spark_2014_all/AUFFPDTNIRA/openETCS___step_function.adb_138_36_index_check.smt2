...
(assert (<= 0 i6))
(assert (<= i6 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun2)))))
(assert (<= 0 j3))
(assert (<= j3 (- im2 1)))
(assert (and (<= 0 j3) (<= j3 10)))
(assert (= o33 j3))
(assert (= o34 (select (rec__step_function__step_function_t__step merge__split_fields3) o33)))
