...
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 2)) (and (and (not (fp.eq (to_rep (select d j3)) (fp #b0 #b00000000 #b00000000000000000000000))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kv j3)))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka j3)))))))
...
(assert (= j1 1))
(assert (=> (not (= i1 j1)) (and (= o1 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j1))))))))
(assert (=> (not (= i1 j1)) (and (= o (fp.mul RNE (to_rep (select kvp2 j1)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j1)) (fp.abs (to_rep (select d i1))))))))
(assert (=> (not (= i1 j1)) (= o2 (fp.div RNE o o1))))
(assert (=> (not (= i1 j1)) (and (= o3 o2) (fp.isFinite32 o2))))
(assert (=> (not (= i1 j1)) (= o4 (fp.min (to_rep (select lambda1 i1)) o3))))
...
(assert (=> (not (= i1 j1)) (and (= o8 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j1))))))))
(assert (=> (not (= i1 j1)) (and (= o7 (fp.mul RNE (to_rep (select ka j1)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka j1)) (fp.abs (to_rep (select d i1))))))))
(assert (=> (not (= i1 j1)) (= o9 (fp.div RNE o7 o8))))
(assert (=> (not (= i1 j1)) (and (= o10 o9) (fp.isFinite32 o9))))
(assert (=> (not (= i1 j1)) (= o11 (fp.min (to_rep (select upsilon1 i1)) o10))))
...
(assert (= j2 2))
(assert (=> (not (= i1 j2)) (and (= o15 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j2))))))))
(assert (=> (not (= i1 j2)) (and (= o14 (fp.mul RNE (to_rep (select kvp2 j2)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j2)) (fp.abs (to_rep (select d i1))))))))
(assert (=> (not (= i1 j2)) (= o16 (fp.div RNE o14 o15))))
(assert (=> (not (= i1 j2)) (and (= o17 o16) (fp.isFinite32 o16))))
(assert (=> (not (= i1 j2)) (= o18 (fp.min (to_rep (select (map__content lambda3) i1)) o17))))
...
(assert (=> (not (= i1 j2)) (and (= o22 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j2))))))))
(assert (=> (not (= i1 j2)) (and (= o21 (fp.mul RNE (to_rep (select ka j2)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka j2)) (fp.abs (to_rep (select d i1))))))))
(assert (=> (not (= i1 j2)) (= o23 (fp.div RNE o21 o22))))
(assert (=> (not (= i1 j2)) (and (= o24 o23) (fp.isFinite32 o23))))
(assert (=> (not (= i1 j2)) (= o25 (fp.min (to_rep (select (map__content upsilon3) i1)) o24))))
(assert (=> (not (= i1 j2)) (= (to_rep o26) o25)))
(assert (=> (not (= i1 j2)) (= o27 (store (map__content upsilon3) i1 o26))))
...
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content lambda6) i1)) (to_rep (select kvp2 i1))))))
(check-sat)
(exit)
