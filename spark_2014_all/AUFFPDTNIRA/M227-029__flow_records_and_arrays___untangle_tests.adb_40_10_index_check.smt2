...
(assert (= o1 b))
(assert (= (mk___rep1 (mk___split_fields1 o2 (mk___rep (mk___split_fields o3 o4 o5 o6)))) (select l o1)))
(assert (and (<= 1 a) (<= a 100)))
(assert (= o7 a))
(assert (= o8 (store l o7 (mk___rep1 (mk___split_fields1 o2 (mk___rep (mk___split_fields o3 o4 o5 o6)))))))
(assert (= result5 l))
(assert (= l1 o8))
(assert (not (<= 1 b)))
(check-sat)
