...
(define-fun dynamic_invariant ((temp___expr_181 us_rep1) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (in_range3 (to_rep (rec__rec__sub_rec__z (us_split_discrs3 temp___expr_181))) (rec__rec__sub_rec__plop (us_split_fields3 temp___expr_181))))
...
(define-fun dynamic_invariant2 ((temp___expr_201 us_rep3) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (let ((temp___203 (rec__rec__sub_arr__l (us_split_discrs7 temp___expr_201)))) (let ((temp___202 (rec__rec__sub_arr__f (us_split_discrs7 temp___expr_201)))) (and (dynamic_property1 (to_rep4 temp___202) (to_rep4 temp___203) (first1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201))) (last1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201)))) (and (= (first1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201))) (to_rep4 temp___202)) (= (last1 (rec__rec__sub_arr__content (us_split_fields7 temp___expr_201))) (to_rep4 temp___203)))))))
(define-fun dynamic_invariant3 ((temp___expr_161 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool) (temp___do_typ_inv_160 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 2)) (in_range temp___expr_161)))
(declare-fun build_rec (Int) us_rep1)
(declare-fun build_rec__function_guard (us_rep1 Int) Bool)
(assert (forall ((a Int)) (! (=> (dynamic_invariant3 a true true true true) (dynamic_invariant (build_rec a) true false true true)) :pattern ((build_rec a)))))
(declare-fun build_rec_ok (Int) us_rep2)
(declare-fun build_rec_ok__function_guard (us_rep2 Int) Bool)
(assert (forall ((a Int)) (! (=> (dynamic_invariant3 a true true true true) (dynamic_invariant1 (build_rec_ok a) true false true true)) :pattern ((build_rec_ok a)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (and (dynamic_invariant4 f true true true true) (dynamic_invariant4 l true true true true)) (dynamic_invariant2 (build_arr f l) true false true true)) :pattern ((build_arr f l)))))
