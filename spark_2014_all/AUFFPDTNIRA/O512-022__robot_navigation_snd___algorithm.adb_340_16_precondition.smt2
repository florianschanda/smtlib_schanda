...
(assert (=> (= (of_int1 0) true) (and (= o25 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2)) o24)) (= (bool_eq6 o25 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) o24))) true))))
(assert (=> (= (of_int1 0) true) (= o26 (us_split_fields7 o25))))
(assert (=> (= (of_int1 0) true) (= o27 (rec__gaps__gap__bearing o26))))
(assert (=> (= (of_int1 0) true) (and (= o28 (print o27)) (dynamic_invariant1 o28 true false true))))
(assert (not (= (has_key (positions (mk___rep4 (us_split_discrs3 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (us_split_fields9 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))))) (mk___rep5 riterl__split_fields2)) true)))
(check-sat)
(exit)
