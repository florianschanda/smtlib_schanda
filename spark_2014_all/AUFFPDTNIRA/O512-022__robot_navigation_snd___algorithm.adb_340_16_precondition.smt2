...
(assert (= result3 true))
(assert (=> (= (of_int1 0) true) (and (= o23 (previous (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 riterl__split_fields2))) (ite (= (ite (= (bool_eq8 (mk___rep5 riterl__split_fields2) no_element) false) (= (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 riterl__split_fields2)) 1) true) true) (= (bool_eq8 o23 no_element) true) (and (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) o23) true) (= (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) o23) (- (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 riterl__split_fields2)) 1)))))))
