...
(define-fun dynamic_invariant1 ((temp___expr_203 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 2147483647)) (in_range2 temp___expr_203)))
...
(define-fun dynamic_invariant2 ((temp___expr_196 Float32) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range3 temp___expr_196)))
...
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 d true true true true)) (dynamic_invariant2 (a_safe v d) true false true true)) :pattern ((a_safe v d))))))
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 d true true true true)) (= (a_safe v d) (fp.add RNE (a_brake_safe v d) (a_gradient d)))) :pattern ((a_safe v d))))))
...
(define-fun dynamic_invariant3 ((temp___expr_362 Int) (temp___is_init_358 Bool) (temp___skip_constant_359 Bool) (temp___do_toplevel_360 Bool) (temp___do_typ_inv_361 Bool)) Bool (=> (or (= temp___is_init_358 true) (<= 0 1000)) (in_range4 temp___expr_362)))
...
(assert (forall ((d Int)) (! (=> (and (dynamic_invariant1 d true true true true) (<= d 5000)) (dynamic_invariant3 (curve_index_from_location d) true false true true)) :pattern ((curve_index_from_location d)))))
...
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (and (dynamic_invariant v true true true true) (dynamic_invariant1 d true true true true)) (and (= (is_valid_deceleration_model a_brake_emergency_model) true) (= (is_valid_speed v) true))) (let ((result (a_brake_emergency v d))) (and (fp.eq result (get_value a_brake_emergency_model (to_int1 RNA v))) (dynamic_invariant2 result true false true true)))) :pattern ((a_brake_emergency v d))))))
...
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 d true true true true)) (dynamic_invariant2 (a_brake_safe v d) true false true true)) :pattern ((a_brake_safe v d))))))
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true true) (dynamic_invariant1 d true true true true)) (= (a_brake_safe v d) (fp.mul RNE (fp.mul RNE (kdry_rst v) (fp.add RNE (kwet_rst v) (fp.mul RNE (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) (kwet_rst v))))) (a_brake_emergency v d)))) :pattern ((a_brake_safe v d))))))
...
(assert (= a_brake_emergency_model (mk___rep4 (mk___split_fields4 (of_rep2 0) (temp___155 (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(declare-const kdry_rst_model us_rep4)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-fun temp___160 (us_rep3 us_rep3) (Array Int us_rep3))
(assert (= kdry_rst_model (mk___rep4 (mk___split_fields4 (of_rep2 0) (temp___160 (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(declare-const kwet_rst_model us_rep4)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp___165 (us_rep3 us_rep3) (Array Int us_rep3))
(assert (= kwet_rst_model (mk___rep4 (mk___split_fields4 (of_rep2 0) (temp___165 (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
...
(assert (forall ((d Int)) (! (=> (dynamic_invariant1 d true true true true) (dynamic_invariant2 (a_gradient d) true false true true)) :pattern ((a_gradient d)))))
(assert (forall ((d Int)) (! (=> (dynamic_invariant1 d true true true true) (= (a_gradient d) (fp #b0 #b00000000 #b00000000000000000000000))) :pattern ((a_gradient d)))))
(assert (forall ((temp___157 us_rep3) (temp___158 us_rep3)) (let ((temp___156 (temp___155 temp___157 temp___158))) (forall ((temp___159 Int)) (ite (= temp___159 0) (= (select temp___156 temp___159) temp___157) (= (select temp___156 temp___159) temp___158))))))
(assert (forall ((temp___162 us_rep3) (temp___163 us_rep3)) (let ((temp___161 (temp___160 temp___162 temp___163))) (forall ((temp___164 Int)) (ite (= temp___164 0) (= (select temp___161 temp___164) temp___162) (= (select temp___161 temp___164) temp___163))))))
(assert (forall ((temp___167 us_rep3) (temp___168 us_rep3)) (let ((temp___166 (temp___165 temp___167 temp___168))) (forall ((temp___169 Int)) (ite (= temp___169 0) (= (select temp___166 temp___169) temp___167) (= (select temp___166 temp___169) temp___168))))))
...
(assert (= braking_curve__split_fields2 (mk___split_fields1 temp___417 temp___4171)))
...
(assert (= braking_curve__split_fields3 (mk___split_fields1 temp___422 temp___4221)))
...
(assert (= braking_curve__split_fields4 (mk___split_fields1 temp___427 temp___4271)))
(assert (= result5 (mk_int__ref i)))
(assert (= i1 (- end_point 1)))
(assert (<= 0 i1))
(assert (<= i1 (- end_point 1)))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 location2)) (and (forall ((temp___440 Int)) (=> (and (<= 0 temp___440) (<= temp___440 1000)) (=> (<= temp___440 i2) (= (select (rec__deceleration_curve__braking_curve_t__curve braking_curve__split_fields5) temp___440) (select (rec__deceleration_curve__braking_curve_t__curve braking_curve__split_fields4) temp___440))))) (= (rec__deceleration_curve__braking_curve_t__end_point braking_curve__split_fields5) (rec__deceleration_curve__braking_curve_t__end_point braking_curve__split_fields4)))) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 speed2))) (and (<= 0 i2) (<= i2 (- end_point 1)))))
