...
(define-fun dynamic_invariant1 ((temp___expr_176 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 2147483647)) (in_range2 temp___expr_176)))
...
(define-fun dynamic_invariant2 ((temp___expr_170 Float32) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range3 temp___expr_170)))
...
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 d true true true)) (dynamic_invariant2 (a_safe v d) true false true)) :pattern ((a_safe v d))))))
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 d true true true)) (= (a_safe v d) (fp.add RNE (a_brake_safe v d) (a_gradient d)))) :pattern ((a_safe v d))))))
...
(define-fun dynamic_invariant3 ((temp___expr_323 Int) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool)) Bool (=> (or (= temp___is_init_320 true) (<= 0 1000)) (in_range4 temp___expr_323)))
...
(assert (forall ((d Int)) (! (=> (and (dynamic_invariant1 d true true true) (<= d 5000)) (dynamic_invariant3 (curve_index_from_location d) true false true)) :pattern ((curve_index_from_location d)))))
...
(define-fun dynamic_invariant4 ((temp___expr_51 Float32) (temp___is_init_48 Bool) (temp___skip_constant_49 Bool) (temp___do_toplevel_50 Bool)) Bool (=> (or (= temp___is_init_48 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_51)))
...
(define-fun dynamic_invariant5 ((temp___expr_158 Float32) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_158)))
...
(assert (forall ((speed Float32)) (! (=> (and (dynamic_invariant5 speed true true true) (= (is_valid_speed_km_per_h speed) true)) (dynamic_invariant (m_per_s_from_km_per_h speed) true false true)) :pattern ((m_per_s_from_km_per_h speed)))))
(assert (forall ((speed Float32)) (! (=> (dynamic_invariant5 speed true true true) (= (m_per_s_from_km_per_h speed) (fp.div RNE (fp.mul RNE speed (fp #b0 #b10001000 #b11110100000000000000000)) (fp #b0 #b10001010 #b11000010000000000000000)))) :pattern ((m_per_s_from_km_per_h speed)))))
...
(define-fun bool_eq5 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (bool_eq4 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true)))) true false))
(assert (forall ((a (Array Int us_rep3)) (b (Array Int us_rep3))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (bool_eq4 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true))))))))
...
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (and (dynamic_invariant v true true true) (dynamic_invariant1 d true true true)) (and (= (is_valid_deceleration_model a_brake_emergency_model) true) (= (is_valid_speed v) true))) (let ((result (a_brake_emergency v d))) (and (fp.eq result (get_value a_brake_emergency_model (to_int1 RNA v))) (dynamic_invariant2 result true false true)))) :pattern ((a_brake_emergency v d))))))
...
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 d true true true)) (dynamic_invariant2 (a_brake_safe v d) true false true)) :pattern ((a_brake_safe v d))))))
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant v true true true) (dynamic_invariant1 d true true true)) (= (a_brake_safe v d) (fp.mul RNE (fp.mul RNE (kdry_rst v) (fp.add RNE (kwet_rst v) (fp.mul RNE (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) (kwet_rst v))))) (a_brake_emergency v d)))) :pattern ((a_brake_safe v d))))))
(define-fun dynamic_invariant6 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 10)) (in_range5 temp___expr_206)))
(define-fun dynamic_invariant7 ((temp___expr_212 Int) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (=> (or (= temp___is_init_209 true) (<= 0 2147483647)) (in_range6 temp___expr_212)))
(declare-fun is_valid (us_rep4) Bool)
(declare-fun is_valid__function_guard (Bool us_rep4) Bool)
(assert true)
(assert (forall ((sfun us_rep4)) (! (= (= (is_valid sfun) true) (and (= (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___252 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___252 0))))) 0) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields9 sfun))) 1))) (< (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___254 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___254 i))))) (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___253 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___253 (+ i 1))))))))))) :pattern ((is_valid sfun)))))
...
(assert true)
(assert (forall ((sfun1 us_rep4) (sfun2 us_rep4)) (! (= (= (has_same_delimiters sfun1 sfun2) true) (and (= (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields9 sfun1))) (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields9 sfun2)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields9 sfun1))))) (= (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___261 (rec__step_function__step_function_t__step (us_split_fields9 sfun1)))) (select temp___261 i))))) (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___262 (rec__step_function__step_function_t__step (us_split_fields9 sfun2)))) (select temp___262 i)))))))))) :pattern ((has_same_delimiters sfun1 sfun2)))))
(assert (forall ((sfun us_rep4)) (forall ((x Int)) (! (=> (and (dynamic_invariant7 x true true true) (= (is_valid sfun) true)) (let ((result (get_value sfun x))) (and (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields9 sfun))) 1))) (and (and (<= (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___269 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___269 i))))) x) (< x (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___270 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___270 (+ i 1)))))))) (fp.eq result (to_rep3 (rec__step_function__delimiter_entry__value (us_split_fields7 (let ((temp___271 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___271 i))))))))) (and (<= (to_rep4 (rec__step_function__delimiter_entry__delimiter (us_split_fields7 (let ((temp___272 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___272 (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields9 sfun)))))))) x) (fp.eq result (to_rep3 (rec__step_function__delimiter_entry__value (us_split_fields7 (let ((temp___273 (rec__step_function__step_function_t__step (us_split_fields9 sfun)))) (select temp___273 (to_rep2 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields9 sfun))))))))))) (dynamic_invariant4 result true false true)))) :pattern ((get_value sfun x))))))
(assert true)
...
(assert (forall ((temp___135 us_rep3) (temp___136 us_rep3)) (let ((temp___134 (temp___133 temp___135 temp___136))) (forall ((temp___137 Int)) (ite (= temp___137 0) (= (select temp___134 temp___137) temp___135) (= (select temp___134 temp___137) temp___136))))))
(assert (= a_brake_emergency_model (mk___rep4 (mk___split_fields4 (of_rep2 0) (temp___133 (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(declare-const kdry_rst_model us_rep4)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-fun temp___138 (us_rep3 us_rep3) (Array Int us_rep3))
(assert (forall ((temp___140 us_rep3) (temp___141 us_rep3)) (let ((temp___139 (temp___138 temp___140 temp___141))) (forall ((temp___142 Int)) (ite (= temp___142 0) (= (select temp___139 temp___142) temp___140) (= (select temp___139 temp___142) temp___141))))))
(assert (= kdry_rst_model (mk___rep4 (mk___split_fields4 (of_rep2 0) (temp___138 (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(declare-const kwet_rst_model us_rep4)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp___143 (us_rep3 us_rep3) (Array Int us_rep3))
(assert (forall ((temp___145 us_rep3) (temp___146 us_rep3)) (let ((temp___144 (temp___143 temp___145 temp___146))) (forall ((temp___147 Int)) (ite (= temp___147 0) (= (select temp___144 temp___147) temp___145) (= (select temp___144 temp___147) temp___146))))))
(assert (= kwet_rst_model (mk___rep4 (mk___split_fields4 (of_rep2 0) (temp___143 (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep3 (mk___split_fields3 (of_rep4 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)))))))))
...
(assert (forall ((v Float32)) (! (=> (and (dynamic_invariant v true true true) (= (is_valid_kdry_rst Tuple0) true)) (let ((result (kdry_rst v))) (and (fp.eq result (get_value kdry_rst_model (to_int1 RNA v))) (dynamic_invariant4 result true false true)))) :pattern ((kdry_rst v)))))
...
(assert (forall ((v Float32)) (! (=> (and (dynamic_invariant v true true true) (= (is_valid_kwet_rst Tuple0) true)) (let ((result (kwet_rst v))) (and (fp.eq result (get_value kwet_rst_model (to_int1 RNA v))) (dynamic_invariant4 result true false true)))) :pattern ((kwet_rst v)))))
(assert (forall ((d Int)) (! (=> (dynamic_invariant1 d true true true) (dynamic_invariant2 (a_gradient d) true false true)) :pattern ((a_gradient d)))))
(assert (forall ((d Int)) (! (=> (dynamic_invariant1 d true true true) (= (a_gradient d) (fp #b0 #b00000000 #b00000000000000000000000))) :pattern ((a_gradient d)))))
...
(assert (and (= deceleration_curve__curve_from_target__end_point__assume (curve_index_from_location (to_rep1 (rec__deceleration_curve__target_t__location (us_split_fields5 target))))) (in_range4 deceleration_curve__curve_from_target__end_point__assume)))
...
(assert (= braking_curve__split_fields2 (mk___split_fields1 temp___374 temp___3741)))
...
(assert (= braking_curve__split_fields3 (mk___split_fields1 temp___379 temp___3791)))
...
(assert (= braking_curve__split_fields4 (mk___split_fields1 temp___384 temp___3841)))
(assert (= result5 (mk_int__ref i)))
(assert (= i1 (- end_point 1)))
(assert (<= 0 i1))
(assert (<= i1 (- end_point 1)))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 location2)) (and (forall ((temp___397 Int)) (=> (and (<= 0 temp___397) (<= temp___397 1000)) (=> (<= temp___397 i2) (= (select (rec__deceleration_curve__braking_curve_t__curve braking_curve__split_fields5) temp___397) (select (rec__deceleration_curve__braking_curve_t__curve braking_curve__split_fields4) temp___397))))) (= (rec__deceleration_curve__braking_curve_t__end_point braking_curve__split_fields5) (rec__deceleration_curve__braking_curve_t__end_point braking_curve__split_fields4)))) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 speed2))) (and (<= 0 i2) (<= i2 (- end_point 1)))))
(assert (and (= o19 (a_safe speed2 location2)) (and (in_range3 o19) (= o19 (fp.add RNE (a_brake_safe speed2 location2) (a_gradient location2))))))
