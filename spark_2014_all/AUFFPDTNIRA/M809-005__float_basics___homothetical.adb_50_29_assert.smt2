...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 2)) (and (and (= temp___169 kvp1) (and (= temp___168 i2) (and (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (- i3 1))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kvp2 j8))))) (and (and (and (=> (<= 1 2) (in_range2 i3)) (forall ((temp___170 Int)) (=> (and (<= 1 temp___170) (<= temp___170 2)) (=> (<= i3 temp___170) (= (select kvp2 temp___170) (select temp___169 temp___170)))))) (and (<= 1 i3) (<= i3 2))) (and (and (and (and (and (= o (adjust2triangle (to_rep (select d i3)) (to_rep (select kv i3)) (to_rep (select ka i3)))) (and (fp.isFinite32 o) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o) (fp.leq o (to_rep (select kv i3)))))) (= (to_rep o1) o)) (= o2 (store kvp2 i3 o1))) (and (= kvp2 result4) (= kvp3 o2))) (= i3 2)))))) (and (and (= i3 i7) (= kvp3 kvp6)) (and (= i8 i3) (= kvp7 kvp3))))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (mk_int__ref i9) (mk_int__ref i7))))
(assert (=> (and (<= 1 i2) (<= i2 2)) (= (mk_map__ref kvp8) (mk_map__ref kvp6))))
...
(assert (= kvmax1 (temp___173 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (= result7 (mk_map__ref kamax)))
(assert (= kamax1 (temp___177 (fp #b0 #b00000000 #b00000000000000000000000))))
(declare-const i17 Int)
(assert (<= 1 i17))
(assert (<= i17 2))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka i17)))))
(check-sat)
(exit)
