...
(assert (=> (and (<= 1 i1) (<= i1 2)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kvp2 j)))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (and (=> (<= 1 2) (in_range2 i2)) (forall ((temp___170 Int)) (=> (and (<= 1 temp___170) (<= temp___170 2)) (=> (<= i2 temp___170) (= (select kvp2 temp___170) (select temp___169 temp___170)))))) (and (<= 1 i2) (<= i2 2)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (= o (adjust2triangle (to_rep (select d i2)) (to_rep (select kv i2)) (to_rep (select ka i2)))) (and (fp.isFinite32 o) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o) (fp.leq o (to_rep (select kv i2))))))))
...
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (mk_map__ref kvp6) (mk_map__ref kvp4))))
...
(assert (<= 1 i7))
(assert (<= i7 2))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka i7)))))
(check-sat)
(exit)
