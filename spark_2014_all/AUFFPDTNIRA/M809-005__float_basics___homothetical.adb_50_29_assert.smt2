...
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (and (=> (<= 1 2) (in_range2 i2)) (forall ((temp___195 Int)) (=> (and (<= 1 temp___195) (<= temp___195 2)) (=> (<= i2 temp___195) (= (select kvp2 temp___195) (select temp___194 temp___195)))))) (and (<= 1 i2) (<= i2 2)))))
...
(assert (= kvmax1 (temp___198 (fp #b0 #b00000000 #b00000000000000000000000))))
(assert (= result6 (mk_map__ref kamax)))
(assert (= kamax1 (temp___202 (fp #b0 #b00000000 #b00000000000000000000000))))
