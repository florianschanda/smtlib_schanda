...
(assert (= dummy7 (let ((temp___160 (t__dummy__aggregate_def (mk___rep (mk___split_fields (of_rep 0) (distinct 1 0) (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) 0 (div1 value__size 8)))) (of_array (to_array1 temp___160) (first3 temp___160) (last3 temp___160)))))
(declare-sort t2 0)
