...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__t__stupid_record__a (us_split_fields1 a))) (to_rep (rec__t__stupid_record__a (us_split_fields1 b)))) (= (rec__t__stupid_record__b (us_split_fields1 a)) (rec__t__stupid_record__b (us_split_fields1 b)))) (= (to_rep1 (rec__t__stupid_record__c (us_split_fields1 a))) (to_rep1 (rec__t__stupid_record__c (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_156 us_t) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (not (= temp___skip_constant_154 true)) (and (dynamic_property1 0 (div1 value__size 8) (first1 temp___expr_156) (last1 temp___expr_156)) (and (= (first1 temp___expr_156) 0) (= (last1 temp___expr_156) (div1 value__size 8))))))
...
(assert (forall ((temp___134 us_rep)) (forall ((temp___135 Int) (temp___136 Int)) (let ((temp___133 (t__dummy__aggregate_def temp___134 temp___135 temp___136))) (and (=> (dynamic_property4 (- 2147483648) 2147483647 temp___135 temp___136) (and (= (first3 temp___133) temp___135) (= (last3 temp___133) temp___136))) (forall ((temp___137 Int)) (= (select (to_array1 temp___133) temp___137) temp___134)))))))
...
(assert (= dummy7 (let ((temp___138 (t__dummy__aggregate_def (mk___rep (mk___split_fields (of_rep 0) (of_int1 1) (of_rep1 (fp #b0 #b01111111 #b00000000000000000000000)))) 0 (div1 value__size 8)))) (of_array (to_array1 temp___138) (first3 temp___138) (last3 temp___138)))))
(declare-const o Int)
