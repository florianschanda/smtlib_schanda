...
(assert (= (to_rep4 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000))
(assert (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__clear__container__fields)) 0))
(assert (= result (mk___split_fields__ref2 (mk___split_fields2 gapvec__split_fields))))
(assert (= gapvec__split_fields1 algorithm__gap_vectors__clear__container__fields))
(assert (= result1 (mk___split_fields__ref4 (mk___split_fields4 rayr__split_fields (mk___rep (mk___split_fields rayr__split_fields1))))))
(assert (= rayr__split_fields2 (us_split_fields9 (select laserscan 1000))))
(assert (= result2 (mk___split_fields__ref4 (mk___split_fields4 rayl__split_fields (mk___rep (mk___split_fields rayl__split_fields1))))))
(assert (= rayl__split_fields2 (us_split_fields9 (select laserscan 1))))
(assert (and (= o5 (ccwdiff (rec__algorithm__laser_scan_data__second rayr__split_fields2) (rec__algorithm__laser_scan_data__second rayl__split_fields2))) (fp.isFinite32 o5)))
(assert (and (= o6 (cos1 o5)) (and (fp.isFinite32 o6) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) o6) (fp.leq o6 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq o5 (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq o6 (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (and (= o3 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(assert (= o4 (fp.mul RNE o3 (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)))))
(assert (and (= o7 o4) (fp.isFinite32 o4)))
(assert (= o8 (fp.mul RNE o7 o6)))
(assert (and (= o9 o8) (fp.isFinite32 o8)))
(assert (and (= o (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)))) (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2))))))
(assert (and (= o1 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(assert (= o2 (fp.add RNE o1 o)))
(assert (and (= o10 o2) (fp.isFinite32 o2)))
(assert (= o11 (fp.sub RNE o10 o9)))
(assert (and (= algorithm__buildgapvector__B_7__dist__assume o11) (fp.isFinite32 o11)))
(assert (= algorithm__buildgapvector__B_7__dist__assume dist))
(assert (fp.isFinite32 dist))
(assert (=> (fp.leq mingapwidth dist) (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o12)) o13 o14)) (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields2) (fp.neg robotradius) (- 1)))))
(assert (=> (fp.leq mingapwidth dist) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o12)) o13 o14))) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true))))
(assert (=> (fp.leq mingapwidth dist) (= result3 (mk___split_fields__ref2 gapvec__split_fields1))))
(assert (=> (fp.leq mingapwidth dist) (= gapvec__split_fields2 algorithm__gap_vectors__append__container__fields)))
(assert (=> (not (fp.leq mingapwidth dist)) (= gapvec__split_fields2 gapvec__split_fields1)))
(assert (not (= (to_rep4 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000)))
(check-sat)
(exit)
