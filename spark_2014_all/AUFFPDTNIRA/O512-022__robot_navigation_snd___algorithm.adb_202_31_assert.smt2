...
(define-fun o15 () us_rep1 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o12)) o13 o14)))
...
(assert (=> (fp.leq mingapwidth dist) (= o15 (create__2 (rec__algorithm__laser_scan_data__second rayl__split_fields2) (fp.neg robotradius) (- 1)))))
(assert (=> (fp.leq mingapwidth dist) (and (and (and (and (and (= (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (+ (length (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) 1)) (= (get1 (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)))) (= (keys_included_except (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (last1 (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (ole1 (positions (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (positions (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true)) (= (bool_eq1 (get (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields)) (length (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) o15) true)) (= (ole (model__ (mk___rep2 gapvec__split_discrs gapvec__split_fields1)) (model__ (mk___rep2 gapvec__split_discrs algorithm__gap_vectors__append__container__fields))) true))))
