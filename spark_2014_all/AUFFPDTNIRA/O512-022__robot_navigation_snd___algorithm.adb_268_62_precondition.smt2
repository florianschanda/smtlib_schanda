...
(assert (and (= o10 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterl__split_fields3))) (= (bool_eq6 o10 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3)))) true)))
(assert (= o11 (us_split_fields7 o10)))
(assert (= o12 (rec__gaps__gap__bearing o11)))
(assert (and (= o7 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterr__split_fields2))) (= (bool_eq6 o7 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)))) true)))
