...
(assert (= result8 true))
(assert (not (= (has_key (positions (mk___rep4 (us_split_discrs3 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (us_split_fields9 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))))) (mk___rep5 iterr__split_fields2)) true)))
(check-sat)
(exit)
