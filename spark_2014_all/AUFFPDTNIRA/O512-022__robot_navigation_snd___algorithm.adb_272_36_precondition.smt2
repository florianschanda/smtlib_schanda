...
(define-fun o23 () us_rep3 (mk___rep3 (mk___split_fields3 (mk___rep (mk___split_fields o3)) o4 o5)))
...
(assert (not (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)) true)))
(check-sat)
(exit)
