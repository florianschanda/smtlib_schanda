...
(assert (not (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 iterr__split_fields2)) true)))
(check-sat)
(exit)
