...
(assert (forall ((x num_delimiters_range)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(declare-const i Int)
(assert (in_range1 i))
(assert (< i (to_rep (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))
