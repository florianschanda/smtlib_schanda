...
(assert (forall ((temp___148 Int) (temp___149 Int) (temp___150 Int)) (let ((temp___147 (elaboration_demo__line__aggregate_def temp___148 temp___149 temp___150))) (and (=> (dynamic_property4 1 2147483647 temp___149 temp___150) (and (= (first3 temp___147) temp___149) (= (last3 temp___147) temp___150))) (forall ((temp___151 Int)) (= (select (to_array1 temp___147) temp___151) (of_rep1 temp___148)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_141 us_t) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (not (= temp___skip_constant_139 true)) (and (dynamic_property1 1 size (first1 temp___expr_141) (last1 temp___expr_141)) (and (= (first1 temp___expr_141) 1) (= (last1 temp___expr_141) size)))))
(declare-const count Int)
(declare-const line (Array Int character))
(declare-const temp___153 (Array Int character))
(declare-const temp___1531 t1)
...
(assert (= (mk___t1 temp___153 temp___1531) (elaboration_demo__line__aggregate_def 32 1 size)))
(assert (= (ite (<= (to_rep (first2 temp___1531)) (to_rep (last2 temp___1531))) (+ (- (to_rep (last2 temp___1531)) (to_rep (first2 temp___1531))) 1) 0) (ite (<= 1 size) (+ (- size 1) 1) 0)))
(assert (= temp___153 elaboration_demo__line__assume))
(assert (= (mk (to_rep (first2 temp___1531)) (to_rep (last2 temp___1531))) elaboration_demo__line__assume1))
(assert (= result line))
