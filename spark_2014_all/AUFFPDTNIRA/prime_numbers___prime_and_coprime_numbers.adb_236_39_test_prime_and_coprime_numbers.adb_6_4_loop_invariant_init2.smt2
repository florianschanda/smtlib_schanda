...
(assert (forall ((v Int)) (=> (and (<= 0 v) (<= v index_22)) (= (= (select is_prime5 v) true) (= (is_prime v) true)))))
(assert (forall ((v Int)) (=> (and (<= index_22 v) (<= v 100000)) (= (= (select is_prime5 v) true) (forall ((div2 Int)) (=> (and (<= 2 div2) (<= div2 (- index_22 1))) (not (= (mod2 v div2) 0))))))))
