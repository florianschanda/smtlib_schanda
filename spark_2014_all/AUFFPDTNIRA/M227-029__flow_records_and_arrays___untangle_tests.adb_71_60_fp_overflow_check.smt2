...
(assert (= tl3 o44))
(assert (not (fp.isFinite32 (fp.add RNE (to_rep (rec__untangle_tests__coordinate__z (us_split_fields1 (select (rec__untangle_tests__triangle__vertices (us_split_fields3 (select tl3 t2))) v1)))) (to_rep (rec__untangle_tests__coordinate__z (us_split_fields1 o)))))))
(check-sat)
(exit)
