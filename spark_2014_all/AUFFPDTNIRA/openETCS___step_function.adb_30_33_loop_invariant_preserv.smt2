...
(assert (= o7 (ite (< x o6) true false)))
(assert (= result1 (ite (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i3)))) x) o7 false)))
(assert (not (= result1 true)))
(assert (= step_function__get_value__result3 step_function__get_value__result2))
(assert (not (= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))))
(assert (= result3 i3))
(assert (= i4 (+ i3 1)))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 i4))
(assert (not (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j1)))) x)))
(check-sat)
(exit)
