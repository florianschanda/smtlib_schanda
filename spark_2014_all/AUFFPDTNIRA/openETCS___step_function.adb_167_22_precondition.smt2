...
(assert (not (< (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i22)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun1)) i12)))))))
(assert (= (to_rep2 o77) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun1)) i12))))))
(assert (= o78 (mk___split_fields o77 (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step merge__split_fields3) im2))))))
(assert (= o79 (mk___rep o78)))
(assert (= o80 (store (rec__step_function__step_function_t__step merge__split_fields3) im2 o79)))
(assert (= o81 (mk___split_fields1 (rec__step_function__step_function_t__number_of_delimiters merge__split_fields3) o80)))
(assert (= temp___345 (mk___rep1 o81)))
(assert (= result10 (mk___split_fields__ref1 merge__split_fields3)))
(assert (= merge__split_fields8 (us_split_fields3 temp___345)))
