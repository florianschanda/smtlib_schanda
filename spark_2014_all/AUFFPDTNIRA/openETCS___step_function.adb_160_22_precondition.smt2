...
(assert (= (to_rep2 o64) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun2)) i22))))))
(assert (= o65 (mk___split_fields o64 (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step merge__split_fields3) im2))))))
(assert (= o66 (mk___rep o65)))
(assert (= o67 (store (rec__step_function__step_function_t__step merge__split_fields3) im2 o66)))
(assert (= o68 (mk___split_fields1 (rec__step_function__step_function_t__number_of_delimiters merge__split_fields3) o67)))
