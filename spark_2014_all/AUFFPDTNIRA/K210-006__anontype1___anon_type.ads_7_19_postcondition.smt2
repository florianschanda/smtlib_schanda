...
(assert (and (= o (+ var_in (+ var_out1 1))) (in_range (+ var_in (+ var_out1 1)))))
...
(assert (= (mk_int__ref result4) (mk_int__ref anon_type__increment__result)))
(assert (= anon_type__increment__result1 var_out2))
(assert (= (mk_int__ref anon_type__increment__result4) (mk_int__ref anon_type__increment__result2)))
...
(assert (not (= anon_type__increment__result4 (+ var_in 1))))
(check-sat)
(exit)
