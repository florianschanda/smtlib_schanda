...
(assert (= j1 1))
(assert (not (= i1 j1)))
(assert (and (= o (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j1)))))))
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j1)) (fp.abs (to_rep (select d i1)))))))
(check-sat)
(exit)
