...
(assert (= o3 (fp.mul RNE (fp #b0 #b00000000 #b00000000000000000000000) o2)))
(assert (and (= o4 (kwet_rst v)) (and (fp.isFinite32 o4) (fp.eq o4 (get_value kwet_rst_model (to_int1 RNA v))))))
(assert (= o5 (fp.add RNE o4 o3)))
(assert (and (= o6 o5) (fp.isFinite32 o5)))
(assert (and (= o7 (kdry_rst v)) (and (fp.isFinite32 o7) (fp.eq o7 (get_value kdry_rst_model (to_int1 RNA v))))))
