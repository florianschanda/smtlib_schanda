...
(assert (and (and (and (= (is_valid (mk___rep1 sfun_merge__split_fields)) true) (forall ((i14 Int)) (=> (and (<= 0 i14) (<= i14 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)))) (exists ((j Int)) (and (and (<= 0 j) (<= j (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) j)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i14)))))))))) (forall ((i14 Int)) (=> (and (<= 0 i14) (<= i14 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)))) (exists ((j Int)) (and (and (<= 0 j) (<= j (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) j)))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i14)))))))))) (forall ((i14 Int)) (=> (and (<= 0 i14) (<= i14 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun_merge__split_fields)))) (fp.eq (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i14)))) (min (get_value (mk___rep1 sfun3__split_fields2) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i14))))) (get_value (mk___rep1 sfun4__split_fields2) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun_merge__split_fields) i14)))))))))))
(assert (= result4 (mk_int__ref i)))
(assert (= i1 0))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i1) (min (get_value (mk___rep1 sfun3__split_fields2) i1) (get_value (mk___rep1 sfun4__split_fields2) i1))))
(assert (= result5 (mk_int__ref i1)))
(assert (= i2 1))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i2) (min (get_value (mk___rep1 sfun3__split_fields2) i2) (get_value (mk___rep1 sfun4__split_fields2) i2))))
(assert (= result6 (mk_int__ref i2)))
(assert (= i3 2))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i3) (min (get_value (mk___rep1 sfun3__split_fields2) i3) (get_value (mk___rep1 sfun4__split_fields2) i3))))
(assert (= result7 (mk_int__ref i3)))
(assert (= i4 3))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i4) (min (get_value (mk___rep1 sfun3__split_fields2) i4) (get_value (mk___rep1 sfun4__split_fields2) i4))))
(assert (= result8 (mk_int__ref i4)))
(assert (= i5 4))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i5) (min (get_value (mk___rep1 sfun3__split_fields2) i5) (get_value (mk___rep1 sfun4__split_fields2) i5))))
(assert (= result9 (mk_int__ref i5)))
(assert (= i6 5))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i6) (min (get_value (mk___rep1 sfun3__split_fields2) i6) (get_value (mk___rep1 sfun4__split_fields2) i6))))
(assert (= result10 (mk_int__ref i6)))
(assert (= i7 6))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i7) (min (get_value (mk___rep1 sfun3__split_fields2) i7) (get_value (mk___rep1 sfun4__split_fields2) i7))))
(assert (= result11 (mk_int__ref i7)))
(assert (= i8 7))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i8) (min (get_value (mk___rep1 sfun3__split_fields2) i8) (get_value (mk___rep1 sfun4__split_fields2) i8))))
(assert (= result12 (mk_int__ref i8)))
(assert (= i9 8))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i9) (min (get_value (mk___rep1 sfun3__split_fields2) i9) (get_value (mk___rep1 sfun4__split_fields2) i9))))
(assert (= result13 (mk_int__ref i9)))
(assert (= i10 9))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i10) (min (get_value (mk___rep1 sfun3__split_fields2) i10) (get_value (mk___rep1 sfun4__split_fields2) i10))))
(assert (= result14 (mk_int__ref i10)))
(assert (= i11 10))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i11) (min (get_value (mk___rep1 sfun3__split_fields2) i11) (get_value (mk___rep1 sfun4__split_fields2) i11))))
(assert (= result15 (mk_int__ref i11)))
(assert (= i12 11))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i12) (min (get_value (mk___rep1 sfun3__split_fields2) i12) (get_value (mk___rep1 sfun4__split_fields2) i12))))
(assert (= result16 (mk_int__ref i12)))
(assert (= i13 12))
(assert (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i13) (min (get_value (mk___rep1 sfun3__split_fields2) i13) (get_value (mk___rep1 sfun4__split_fields2) i13))))
(assert (fp.eq (minimum_until_point (mk___rep1 sfun4__split_fields2) 1) (fp #b0 #b10000010 #b01000000000000000000000)))
(assert (fp.eq (minimum_until_point (mk___rep1 sfun4__split_fields2) 5) (fp #b0 #b10000001 #b10000000000000000000000)))
(assert (not (fp.eq (minimum_until_point (mk___rep1 sfun_merge__split_fields) 11) (fp #b0 #b01111110 #b00000000000000000000000))))
(check-sat)
(exit)
