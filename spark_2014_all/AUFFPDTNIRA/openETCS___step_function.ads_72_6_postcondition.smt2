...
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (forall ((j3 Int)) (=> (and (<= 0 j3) (<= j3 (- i4 1))) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j3)))) x) (fp.leq min2 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j3))))))))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (exists ((j3 Int)) (and (and (<= 0 j3) (<= j3 i4)) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j3)))) x) (fp.eq min2 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j3))))))))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (and (and (=> (<= 0 r10b) (dynamic_property 0 r10b i4)) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 min2))) (and (<= 0 i4) (<= i4 r10b)))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) x) (=> (fp.lt (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) min2) (= min2 result3)))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) x) (=> (fp.lt (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) min2) (= min3 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))))))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) x) (=> (not (fp.lt (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) min2)) (= min3 min2)))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (=> (not (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) x)) (forall ((j3 Int)) (=> (and (<= (+ i4 1) j3) (<= j3 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (< (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (- j3 1))))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j3))))))))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (=> (not (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i4)))) x)) (= min3 min2))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i4 r10b)))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i6 (mk_int__ref i4))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= min4 (mk_t__ref min3))))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i7 i4)))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= min5 min3)))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i8 i6)))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= min6 min4)))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= i9 i7)))
(assert (=> (and (<= 0 i3) (<= i3 r10b)) (= min7 min5)))
(assert (=> (not (and (<= 0 i3) (<= i3 r10b))) (= i8 (mk_int__ref i3))))
(assert (=> (not (and (<= 0 i3) (<= i3 r10b))) (= min6 (mk_t__ref min1))))
(assert (=> (not (and (<= 0 i3) (<= i3 r10b))) (= i9 i3)))
(assert (=> (not (and (<= 0 i3) (<= i3 r10b))) (= min7 min1)))
(assert (= step_function__minimum_until_point__result2 (mk_t__ref step_function__minimum_until_point__result1)))
(assert (= step_function__minimum_until_point__result3 step_function__minimum_until_point__result1))
(assert (= result5 (mk_t__ref step_function__minimum_until_point__result)))
(assert (= step_function__minimum_until_point__result1 (t__content min6)))
(assert (= step_function__minimum_until_point__result4 step_function__minimum_until_point__result2))
(assert (= i10 i8))
(assert (= min8 min6))
(assert (= step_function__minimum_until_point__result5 step_function__minimum_until_point__result3))
(assert (= i11 i9))
(assert (= min9 min7))
(assert (= result7 (t__content step_function__minimum_until_point__result4)))
(declare-const i12 Int)
(assert (<= 0 i12))
(assert (<= i12 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))
(assert (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i12)))) x))
(assert (not (fp.leq (t__content step_function__minimum_until_point__result4) (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i12)))))))
(check-sat)
(exit)
