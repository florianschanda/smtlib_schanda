...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= temp___304 min1)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= temp___303 i1)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- i2 1))) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j)))) x) (fp.leq min2 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j))))))))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (exists ((j Int)) (and (and (<= 0 j) (<= j i2)) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j)))) x) (fp.eq min2 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j))))))))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (and (and (=> (<= 0 r10b) (dynamic_property 0 r10b i2)) (=> (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111)) (fp.isFinite32 min2))) (and (<= 0 i2) (<= i2 r10b)))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) x) (=> (fp.lt (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) min2) (= min2 result2)))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) x) (=> (fp.lt (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) min2) (= min3 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))))))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) x) (=> (not (fp.lt (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) min2)) (= min3 min2)))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (=> (not (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) x)) (forall ((j Int)) (=> (and (<= (+ i2 1) j) (<= j (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (< (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) (- j 1))))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j))))))))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (=> (not (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i2)))) x)) (= min3 min2))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= i2 r10b)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= min4 (mk_t__ref min3))))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= i4 i2)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= min5 min3)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= i5 i3)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= min6 min4)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= i6 i4)))
(assert (=> (and (<= 0 i1) (<= i1 r10b)) (= min7 min5)))
(assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= min6 (mk_t__ref min1))))
(assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= i6 i1)))
(assert (=> (not (and (<= 0 i1) (<= i1 r10b))) (= min7 min1)))
...
(assert (= i8 i6))
(assert (= min9 min7))
(assert (= result4 (t__content step_function__minimum_until_point__result4)))
(declare-const i9 Int)
(assert (<= 0 i9))
(assert (<= i9 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))
(assert (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i9)))) x))
(assert (not (fp.leq (t__content step_function__minimum_until_point__result4) (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i9)))))))
(check-sat)
(exit)
