...
(define-fun dynamic_invariant ((temp___expr_148 Float32) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_148)))
...
(define-fun dynamic_invariant1 ((temp___expr_154 Float32) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_154)))
...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 2147483647)) (in_range1 temp___expr_172)))
...
(assert (not (= (distance_to_speed initial_speed1 (fp #b0 #b00000000 #b00000000000000000000000) (fp.neg (fp #b0 #b01111111 #b00000000000000000000000))) 1000)))
(check-sat)
(exit)
