...
(assert (and (= o (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.sqrt RNE (fp #b0 #b10000001 #b01000000000000000000000)))) (fp.isFinite32 (fp.add RNE (fp #b0 #b01111111 #b00000000000000000000000) (fp.sqrt RNE (fp #b0 #b10000001 #b01000000000000000000000))))))
