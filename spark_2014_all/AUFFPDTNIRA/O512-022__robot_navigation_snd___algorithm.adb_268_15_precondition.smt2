...
(assert (and (= o6 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterl__split_fields3))) (= (bool_eq6 o6 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3)))) true)))
(assert (= o7 (us_split_fields7 o6)))
(assert (= o8 (rec__gaps__gap__bearing o7)))
(assert (and (= o3 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterr__split_fields2))) (= (bool_eq6 o3 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)))) true)))
