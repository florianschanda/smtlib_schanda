...
(assert (= result2 true))
(assert (and (and (and (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)) true) (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3)) true)) (= (bool_eq8 (mk___rep5 iterl__split_fields3) (next (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterr__split_fields2))) true)) (fp.eq (to_rep2 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields1))))) (to_rep2 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields__content7 this__split_fields))))))))
...
(assert (and (= o18 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterl__split_fields3))) (= (bool_eq6 o18 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3)))) true)))
(assert (= o19 (us_split_fields7 o18)))
(assert (= o20 (rec__gaps__gap__bearing o19)))
(assert (and (= o15 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterr__split_fields2))) (= (bool_eq6 o15 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)))) true)))
...
(assert (=> (= result5 true) (and (= o11 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterl__split_fields3))) (= (bool_eq6 o11 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3)))) true))))
...
(assert (=> (= result4 true) (and (= o28 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterr__split_fields2))) (= (bool_eq6 o28 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)))) true))))
...
(assert (= result3 true))
(assert (=> (= (of_int1 0) true) (and (= o23 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterr__split_fields2))) (= (bool_eq6 o23 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)))) true))))
(assert (=> (= (of_int1 0) true) (= o24 (us_split_fields7 o23))))
(assert (=> (= (of_int1 0) true) (= o25 (rec__gaps__gap__bearing o24))))
(assert (=> (= (of_int1 0) true) (and (= o26 (print o25)) (dynamic_invariant1 o26 true false true))))
(assert (and (= o27 (first2 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)))) (ite (= (= (length1 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) 0) true) (= (bool_eq8 o27 no_element) true) (and (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) o27) true) (= (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) o27) 1)))))
(assert (= result6 (bool_eq8 (mk___rep5 iterr__split_fields2) o27)))
(assert (not (= result6 true)))
(assert (not (or (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterr__split_fields2)) true) (= (bool_eq8 (mk___rep5 iterr__split_fields2) no_element) true))))
(check-sat)
(exit)
