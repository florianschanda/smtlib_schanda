...
(assert (= result2 true))
(assert (and (and (and (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 iterr__split_fields2)) true) (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 iterl__split_fields3)) true)) (= (bool_eq8 (mk___rep5 iterl__split_fields3) (next (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2)) (mk___rep5 iterr__split_fields2))) true)) (fp.eq (to_rep2 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields2))))) (to_rep2 (rec__robot_iface__proxy__robot_radius (us_split_fields5 (rec__algorithm__controller__robot (us_split_fields__content7 this__split_fields))))))))
(assert (and (and (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields5 (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields2))))) false) (= 1000 (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))))))) (and (and (and (= (rec__algorithm__controller__robot (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__robot (us_split_fields__content7 this__split_fields))) (= (rec__algorithm__controller__laserscan (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__laserscan (us_split_fields__content7 this__split_fields)))) (= (rec__algorithm__controller__obsavoiddelta (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__obsavoiddelta (us_split_fields__content7 this__split_fields)))) (= (rec__algorithm__controller__driveangle (let ((subject this__split_fields)) this__split_fields2)) (rec__algorithm__controller__driveangle (us_split_fields__content7 this__split_fields))))) (and (and (not (= (bool_eq8 (mk___rep5 iterl__split_fields3) no_element) true)) (not (= (bool_eq8 (mk___rep5 iterr__split_fields2) no_element) true))) (< 1 (length1 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2)))))))
...
(assert (=> (= (of_int1 0) true) (and (= o27 (print o26)) (dynamic_invariant1 o27 true false true))))
(assert (and (= o28 (first2 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2)))) (ite (= (= (length1 (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) 0) true) (= (bool_eq8 o28 no_element) true) (and (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) o28) true) (= (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) o28) 1)))))
(assert (= result8 (bool_eq8 (mk___rep5 iterr__split_fields2) o28)))
(assert (not (= result8 true)))
(assert (not (or (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 iterr__split_fields2)) true) (= (bool_eq8 (mk___rep5 iterr__split_fields2) no_element) true))))
(check-sat)
(exit)
