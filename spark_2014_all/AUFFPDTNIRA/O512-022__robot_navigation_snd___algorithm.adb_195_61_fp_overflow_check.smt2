...
(assert (= (to_rep3 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)) 1000))
...
(assert (and (= o3 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(assert (= o4 (fp.mul RNE o3 (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)))))
(assert (and (= o7 o4) (fp.isFinite32 o4)))
(assert (= o8 (fp.mul RNE o7 o6)))
(assert (and (= o9 o8) (fp.isFinite32 o8)))
(assert (and (= o (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)))) (fp.isFinite32 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2)) (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields2))))))
(assert (and (= o1 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
