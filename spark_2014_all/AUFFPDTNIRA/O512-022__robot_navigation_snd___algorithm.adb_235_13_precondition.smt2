...
(assert (not (< (length (mk___rep2 gapvec__split_discrs (us_split_fields__content2 gapvec__split_fields6))) (to_rep3 (rec__algorithm__gap_vectors__list__capacity gapvec__split_discrs)))))
(check-sat)
(exit)
