...
(assert (<= 0 i3))
(assert (<= i3 r10b))
(assert (not (exists ((j3 Int)) (and (and (<= 0 j3) (<= j3 i3)) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j3)))) x) (fp.eq min1 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) j3))))))))))
(check-sat)
(exit)
