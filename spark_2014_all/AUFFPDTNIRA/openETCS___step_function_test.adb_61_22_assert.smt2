...
(assert (= i1 0))
(assert (not (fp.eq (get_value (mk___rep1 sfun_merge__split_fields) i1) (min (get_value (mk___rep1 sfun3__split_fields2) i1) (get_value (mk___rep1 sfun4__split_fields2) i1)))))
(check-sat)
(exit)
