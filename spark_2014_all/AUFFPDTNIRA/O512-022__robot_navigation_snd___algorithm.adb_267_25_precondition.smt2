...
(assert (and (= o3 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 iterl__split_fields3))) (= (bool_eq6 o3 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 iterl__split_fields3)))) true)))
