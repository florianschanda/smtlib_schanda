...
(assert (not (or (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 riterl__split_fields2)) true) (= (bool_eq8 (mk___rep5 riterl__split_fields2) no_element) true))))
(check-sat)
(exit)
