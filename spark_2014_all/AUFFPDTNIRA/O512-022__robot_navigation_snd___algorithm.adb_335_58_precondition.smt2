...
(assert (=> (= result4 true) (and (= o23 (element (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1)) (mk___rep5 riterr__split_fields3))) (= (bool_eq6 o23 (get (model__ (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (get1 (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 riterr__split_fields3)))) true))))
...
(assert (not (or (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields1))) (mk___rep5 riterl__split_fields2)) true) (= (bool_eq8 (mk___rep5 riterl__split_fields2) no_element) true))))
(check-sat)
(exit)
