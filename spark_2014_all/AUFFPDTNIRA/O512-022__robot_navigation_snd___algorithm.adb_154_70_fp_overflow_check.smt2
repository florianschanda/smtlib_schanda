...
(define-fun dynamic_invariant2 ((temp___expr_673 us_rep7) (temp___is_init_669 Bool) (temp___skip_constant_670 Bool) (temp___do_toplevel_671 Bool) (temp___do_typ_inv_672 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields7 (rec__algorithm__controller__robot (us_split_fields15 temp___expr_673))))) false) (in_range11 1000 (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_673)))))
(define-fun default_initial_assumption ((temp___expr_678 us_rep7) (temp___skip_top_level_679 Bool)) Bool (and (and (and (and (= (rec__algorithm__controller__robot (us_split_fields15 temp___expr_678)) (mk___rep3 (mk___split_fields3 (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep6 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (temp___680 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep7 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep7 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep7 (fp #b0 #b00000000 #b00000000000000000000000)) (let ((usq_ (mk___rep2 (mk___split_discrs (of_rep8 0)) (mk___split_fields2 dummy4 dummy4) true))) (mk___rep2 (us_split_discrs1 usq_) (us_split_fields5 usq_) false)) (distinct 0 0)))) (= (rec__algorithm__controller__laserscan (us_split_fields15 temp___expr_678)) (temp___684 (mk___rep5 (mk___split_fields5 (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) null_angle))))) (and (= (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_678))))) 1000) (= (is_empty (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_678))) true))) (= (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields15 temp___expr_678))) (fp #b0 #b00000000 #b00000000000000000000000))) (= (rec__algorithm__controller__driveangle (us_split_fields15 temp___expr_678)) null_angle)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_863 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_863 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 5)) 71)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 7)) 112)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_863 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_863 us_void_param)))))
(declare-fun temp___String_Literal_864 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_864 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_864 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 3)) 117)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 6)) 100)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 12)) 102)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 15)) 98)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 16)) 121)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 19)) 98)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 22)) 97)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 24)) 108)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_864 us_void_param) 29)) 32)) :pattern ((temp___String_Literal_864 us_void_param)))))
(define-fun dynamic_invariant3 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range7 temp___expr_39)))
...
(define-fun dynamic_invariant7 ((temp___expr_640 us_rep6) (temp___is_init_636 Bool) (temp___skip_constant_637 Bool) (temp___do_toplevel_638 Bool) (temp___do_typ_inv_639 Bool)) Bool (=> (not (= temp___skip_constant_637 true)) (in_range11 1000 temp___expr_640)))
(define-fun default_initial_assumption1 ((temp___expr_642 us_rep6) (temp___skip_top_level_643 Bool)) Bool (and (= (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 temp___expr_642))) 1000) (=> (not (= temp___skip_top_level_643 true)) (= (is_empty temp___expr_642) true))))
(assert (forall ((temp___686 us_rep5)) (forall ((temp___687 Int)) (= (select (temp___684 temp___686) temp___687) temp___686))))
(define-fun dynamic_invariant8 ((temp___expr_254 Int) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool) (temp___do_typ_inv_253 Bool)) Bool (=> (or (= temp___is_init_250 true) (<= 0 1)) (in_range8 temp___expr_254)))
(define-fun default_initial_assumption2 ((temp___expr_263 us_rep2) (temp___skip_top_level_264 Bool)) Bool (and (= (attr__constrained temp___expr_263) false) (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 temp___expr_263))) 0)))
(define-fun dynamic_invariant9 ((temp___expr_272 us_rep3) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool) (temp___do_typ_inv_271 Bool)) Bool (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields7 temp___expr_272))) false))
(define-fun default_initial_assumption3 ((temp___expr_275 us_rep3) (temp___skip_top_level_276 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields7 temp___expr_275))) false) (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 (rec__robot_iface__proxy__speed (us_split_fields7 temp___expr_275))))) 0)))
(define-fun dynamic_invariant10 ((temp___expr_163 Float32) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool) (temp___do_typ_inv_162 Bool)) Bool (=> (or (= temp___is_init_159 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range4 temp___expr_163)))
(define-fun dynamic_invariant11 ((temp___expr_170 Float32) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool) (temp___do_typ_inv_169 Bool)) Bool (=> (or (= temp___is_init_166 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range5 temp___expr_170)))
(define-fun dynamic_invariant12 ((temp___expr_184 Float32) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool) (temp___do_typ_inv_183 Bool)) Bool (=> (or (= temp___is_init_180 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_184)))
(assert (= null_angle (mk___rep (mk___split_fields (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000))))))
(define-fun dynamic_invariant13 ((temp___expr_198 Float32) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range6 temp___expr_198)))
...
(define-fun dynamic_invariant14 ((temp___expr_323 Int) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool) (temp___do_typ_inv_322 Bool)) Bool (=> (or (= temp___is_init_319 true) (<= (- 1) 1)) (in_range9 temp___expr_323)))
(define-fun dynamic_invariant15 ((temp___expr_365 Int) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool) (temp___do_typ_inv_364 Bool)) Bool (=> (or (= temp___is_init_361 true) (<= 0 2147483647)) (in_range10 temp___expr_365)))
(declare-fun length1 (us_rep6) Int)
(declare-fun length__function_guard (Int us_rep6) Bool)
(assert (forall ((container us_rep6)) (! (let ((result (length1 container))) (and (<= result (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 container)))) (dynamic_invariant15 result true false true true))) :pattern ((length1 container)))))
(assert (forall ((container us_rep6)) (! (= (= (is_empty container) true) (= (length1 container) 0)) :pattern ((is_empty container)))))
(assert (forall ((temp___682 Float32)) (=> (dynamic_invariant11 temp___682 true true true true) (forall ((temp___683 Int)) (= (to_rep4 (select (temp___680 temp___682) temp___683)) temp___682)))))
(declare-const i Int)
