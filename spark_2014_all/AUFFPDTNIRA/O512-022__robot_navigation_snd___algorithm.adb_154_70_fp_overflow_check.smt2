...
(assert (forall ((x positive_float)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun in_range6 ((x Float32)) Bool (and (fp.isFinite32 x) (and (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) x) (fp.leq x (fp #b0 #b10000001 #b10010010000111111011011)))))
...
(assert (forall ((x normalized2pi)) (! (in_range6 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((a (Array Int nonnegative_float)) (b (Array Int nonnegative_float))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep4 (select a temp___idx_132)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_132)))))))))))
...
(assert (forall ((a (Array Int nonnegative_float))) (<= 0 (object__size3 a))))
(assert (<= 0 value__component__size1))
(assert (forall ((a (Array Int nonnegative_float))) (<= 0 (object__component__size1 a))))
(assert (<= 0 value__alignment3))
(assert (forall ((a (Array Int nonnegative_float))) (<= 0 (object__alignment3 a))))
(declare-fun user_eq12 ((Array Int nonnegative_float) (Array Int nonnegative_float)) Bool)
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__robot_iface__speed_option__modulus float) (rec__robot_iface__speed_option__angle float)))))
...
(define-fun us_rep___4__projection ((a us_rep2)) us_split_discrs (us_split_discrs1 a))
...
(define-fun robot_iface__speed_option__modulus__pred ((a us_rep2)) Bool (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))
(define-fun robot_iface__speed_option__angle__pred ((a us_rep2)) Bool (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) 1))
(define-fun bool_eq5 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 b)))) (and (=> (robot_iface__speed_option__modulus__pred a) (= (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields5 a))) (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields5 b))))) (=> (robot_iface__speed_option__angle__pred a) (= (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields5 a))) (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields5 b))))))) true false))
...
(declare-datatypes () ((speed_option__ref (mk_speed_option__ref (speed_option__content us_rep2)))))
(define-fun speed_option__ref___projection ((a speed_option__ref)) us_rep2 (speed_option__content a))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__robot_iface__proxy__robot_radius positive_float) (rec__robot_iface__proxy__min_gap_width positive_float) (rec__robot_iface__proxy__obstacle_avoid_dist positive_float) (rec__robot_iface__proxy__max_speed positive_float) (rec__robot_iface__proxy__max_turn_rate positive_float) (rec__robot_iface__proxy__goal_position_tol nonnegative_float) (rec__robot_iface__proxy__goal_angle_tol nonnegative_float) (rec__robot_iface__proxy__goalx float) (rec__robot_iface__proxy__goaly float) (rec__robot_iface__proxy__goala float) (rec__robot_iface__proxy__scan_count natural) (rec__robot_iface__proxy__scan_res positive_float) (rec__robot_iface__proxy__max_range positive_float) (rec__robot_iface__proxy__scans (Array Int nonnegative_float)) (rec__robot_iface__proxy__x unbounded_float) (rec__robot_iface__proxy__y unbounded_float) (rec__robot_iface__proxy__yaw unbounded_float) (rec__robot_iface__proxy__speed us_rep2) (rec__robot_iface__proxy__goal_reached Bool)))))
(define-fun us_split_fields_scan_Count__projection ((a us_split_fields6)) natural (rec__robot_iface__proxy__scan_count a))
(define-fun us_split_fields_scans__projection ((a us_split_fields6)) (Array Int nonnegative_float) (rec__robot_iface__proxy__scans a))
(define-fun us_split_fields_speed__projection ((a us_split_fields6)) us_rep2 (rec__robot_iface__proxy__speed a))
(define-fun us_split_fields_goal_reached__projection ((a us_split_fields6)) Bool (rec__robot_iface__proxy__goal_reached a))
...
(define-fun bool_eq6 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep3 (rec__robot_iface__proxy__robot_radius (us_split_fields7 a))) (to_rep3 (rec__robot_iface__proxy__robot_radius (us_split_fields7 b)))) (= (to_rep3 (rec__robot_iface__proxy__min_gap_width (us_split_fields7 a))) (to_rep3 (rec__robot_iface__proxy__min_gap_width (us_split_fields7 b))))) (= (to_rep3 (rec__robot_iface__proxy__obstacle_avoid_dist (us_split_fields7 a))) (to_rep3 (rec__robot_iface__proxy__obstacle_avoid_dist (us_split_fields7 b))))) (= (to_rep3 (rec__robot_iface__proxy__max_speed (us_split_fields7 a))) (to_rep3 (rec__robot_iface__proxy__max_speed (us_split_fields7 b))))) (= (to_rep3 (rec__robot_iface__proxy__max_turn_rate (us_split_fields7 a))) (to_rep3 (rec__robot_iface__proxy__max_turn_rate (us_split_fields7 b))))) (= (to_rep4 (rec__robot_iface__proxy__goal_position_tol (us_split_fields7 a))) (to_rep4 (rec__robot_iface__proxy__goal_position_tol (us_split_fields7 b))))) (= (to_rep4 (rec__robot_iface__proxy__goal_angle_tol (us_split_fields7 a))) (to_rep4 (rec__robot_iface__proxy__goal_angle_tol (us_split_fields7 b))))) (= (to_rep2 (rec__robot_iface__proxy__goalx (us_split_fields7 a))) (to_rep2 (rec__robot_iface__proxy__goalx (us_split_fields7 b))))) (= (to_rep2 (rec__robot_iface__proxy__goaly (us_split_fields7 a))) (to_rep2 (rec__robot_iface__proxy__goaly (us_split_fields7 b))))) (= (to_rep2 (rec__robot_iface__proxy__goala (us_split_fields7 a))) (to_rep2 (rec__robot_iface__proxy__goala (us_split_fields7 b))))) (= (to_rep6 (rec__robot_iface__proxy__scan_count (us_split_fields7 a))) (to_rep6 (rec__robot_iface__proxy__scan_count (us_split_fields7 b))))) (= (to_rep3 (rec__robot_iface__proxy__scan_res (us_split_fields7 a))) (to_rep3 (rec__robot_iface__proxy__scan_res (us_split_fields7 b))))) (= (to_rep3 (rec__robot_iface__proxy__max_range (us_split_fields7 a))) (to_rep3 (rec__robot_iface__proxy__max_range (us_split_fields7 b))))) (= (bool_eq4 (rec__robot_iface__proxy__scans (us_split_fields7 a)) 1 1000 (rec__robot_iface__proxy__scans (us_split_fields7 b)) 1 1000) true)) (= (to_rep7 (rec__robot_iface__proxy__x (us_split_fields7 a))) (to_rep7 (rec__robot_iface__proxy__x (us_split_fields7 b))))) (= (to_rep7 (rec__robot_iface__proxy__y (us_split_fields7 a))) (to_rep7 (rec__robot_iface__proxy__y (us_split_fields7 b))))) (= (to_rep7 (rec__robot_iface__proxy__yaw (us_split_fields7 a))) (to_rep7 (rec__robot_iface__proxy__yaw (us_split_fields7 b))))) (= (bool_eq5 (rec__robot_iface__proxy__speed (us_split_fields7 a)) (rec__robot_iface__proxy__speed (us_split_fields7 b))) true)) (= (rec__robot_iface__proxy__goal_reached (us_split_fields7 a)) (rec__robot_iface__proxy__goal_reached (us_split_fields7 b)))) true false))
...
(declare-datatypes () ((proxy__ref (mk_proxy__ref (proxy__content us_rep3)))))
(define-fun proxy__ref___projection ((a proxy__ref)) us_rep3 (proxy__content a))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__gaps__gap__bearing us_rep) (rec__gaps__gap__distance float) (rec__gaps__gap__idir idir_t)))))
(define-fun us_split_fields_bearing__projection ((a us_split_fields8)) us_rep (rec__gaps__gap__bearing a))
(define-fun us_split_fields_iDir__projection ((a us_split_fields8)) idir_t (rec__gaps__gap__idir a))
...
(define-fun bool_eq7 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (bool_eq2 (rec__gaps__gap__bearing (us_split_fields9 a)) (rec__gaps__gap__bearing (us_split_fields9 b))) true) (= (to_rep2 (rec__gaps__gap__distance (us_split_fields9 a))) (to_rep2 (rec__gaps__gap__distance (us_split_fields9 b))))) (= (to_rep9 (rec__gaps__gap__idir (us_split_fields9 a))) (to_rep9 (rec__gaps__gap__idir (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__algorithm__laser_scan_data__first nonnegative_float) (rec__algorithm__laser_scan_data__second us_rep)))))
(define-fun us_split_fields_second__projection ((a us_split_fields10)) us_rep (rec__algorithm__laser_scan_data__second a))
...
(define-fun bool_eq8 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (to_rep4 (rec__algorithm__laser_scan_data__first (us_split_fields11 a))) (to_rep4 (rec__algorithm__laser_scan_data__first (us_split_fields11 b)))) (= (bool_eq2 (rec__algorithm__laser_scan_data__second (us_split_fields11 a)) (rec__algorithm__laser_scan_data__second (us_split_fields11 b))) true)) true false))
...
(declare-datatypes () ((laser_scan_data__ref (mk_laser_scan_data__ref (laser_scan_data__content us_rep5)))))
(define-fun laser_scan_data__ref___projection ((a laser_scan_data__ref)) us_rep5 (laser_scan_data__content a))
...
(assert (forall ((a (Array Int us_rep5))) (forall ((first2 Int)) (! (= (slide2 a first2 first2) a) :pattern ((slide2 a first2 first2))))))
...
(declare-fun concat3 ((Array Int us_rep5) Int Int (Array Int us_rep5) Int Int) (Array Int us_rep5))
...
(assert (forall ((v us_rep5)) (forall ((i Int)) (! (= (select (singleton3 v i) i) v) :pattern ((select (singleton3 v i) i))))))
(define-fun bool_eq9 ((a (Array Int us_rep5)) (a__first Int) (a__last Int) (b (Array Int us_rep5)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq8 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true)))) true false))
(assert (forall ((a (Array Int us_rep5)) (b (Array Int us_rep5))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq8 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true))))))))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__algorithm__gap_vectors__list us_main_type)))))
(define-fun us_split_fields_List__projection ((a us_split_fields12)) us_main_type (rec__algorithm__gap_vectors__list a))
...
(declare-datatypes () ((us_rep6 (mk___rep6 (us_split_discrs3 us_split_discrs2) (us_split_fields13 us_split_fields12)))))
(define-fun us_rep___13__projection ((a us_rep6)) us_split_discrs2 (us_split_discrs3 a))
(define-fun us_rep___14__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq10 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 a))) (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 b)))) (= (us_main_eq (rec__algorithm__gap_vectors__list (us_split_fields13 a)) (rec__algorithm__gap_vectors__list (us_split_fields13 b))) true)) true false))
...
(define-fun in_range11 ((rec__algorithm__gap_vectors__list__capacity1 Int) (a us_rep6)) Bool (= rec__algorithm__gap_vectors__list__capacity1 (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 a)))))
...
(declare-datatypes () ((list__ref1 (mk_list__ref1 (list__content1 us_rep6)))))
(define-fun list__ref___2__projection ((a list__ref1)) us_rep6 (list__content1 a))
...
(assert (forall ((a (Array Int us_rep5))) (<= 0 (object__component__size2 a))))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__algorithm__controller__robot us_rep3) (rec__algorithm__controller__laserscan (Array Int us_rep5)) (rec__algorithm__controller__gapvec us_rep6) (rec__algorithm__controller__obsavoiddelta float) (rec__algorithm__controller__driveangle us_rep)))))
(define-fun us_split_fields_robot__projection ((a us_split_fields14)) us_rep3 (rec__algorithm__controller__robot a))
(define-fun us_split_fields_laserScan__projection ((a us_split_fields14)) (Array Int us_rep5) (rec__algorithm__controller__laserscan a))
(define-fun us_split_fields_gapVec__projection ((a us_split_fields14)) us_rep6 (rec__algorithm__controller__gapvec a))
...
(define-fun bool_eq11 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (= (bool_eq6 (rec__algorithm__controller__robot (us_split_fields15 a)) (rec__algorithm__controller__robot (us_split_fields15 b))) true) (= (bool_eq9 (rec__algorithm__controller__laserscan (us_split_fields15 a)) 1 1000 (rec__algorithm__controller__laserscan (us_split_fields15 b)) 1 1000) true)) (= (bool_eq10 (rec__algorithm__controller__gapvec (us_split_fields15 a)) (rec__algorithm__controller__gapvec (us_split_fields15 b))) true)) (= (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields15 a))) (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields15 b))))) (= (bool_eq2 (rec__algorithm__controller__driveangle (us_split_fields15 a)) (rec__algorithm__controller__driveangle (us_split_fields15 b))) true)) true false))
...
(declare-datatypes () ((controller__ref (mk_controller__ref (controller__content us_rep7)))))
(define-fun controller__ref___projection ((a controller__ref)) us_rep7 (controller__content a))
...
(define-fun in_range12 ((rec__robot_iface__speed_option__opt1 Int) (a us_rep2)) Bool (= rec__robot_iface__speed_option__opt1 (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 a)))))
...
(declare-datatypes () ((t252s__ref (mk_t252s__ref (t252s__content us_rep2)))))
(define-fun t252s__ref___projection ((a t252s__ref)) us_rep2 (t252s__content a))
...
(assert (forall ((temp___620 us_rep5)) (forall ((temp___621 Int)) (= (select (temp___618 temp___620) temp___621) temp___620))))
(define-fun dynamic_invariant2 ((temp___expr_607 us_rep7) (temp___is_init_604 Bool) (temp___skip_constant_605 Bool) (temp___do_toplevel_606 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields7 (rec__algorithm__controller__robot (us_split_fields15 temp___expr_607))))) false) (in_range11 1000 (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_607)))))
(define-fun default_initial_assumption ((temp___expr_612 us_rep7) (temp___skip_top_level_613 Bool)) Bool (and (and (and (and (= (rec__algorithm__controller__robot (us_split_fields15 temp___expr_612)) (mk___rep3 (mk___split_fields3 (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep2 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep6 0) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep3 (fp #b0 #b00000000 #b00000000000000000000000)) (temp___614 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep7 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep7 (fp #b0 #b00000000 #b00000000000000000000000)) (of_rep7 (fp #b0 #b00000000 #b00000000000000000000000)) (let ((usq_ (mk___rep2 (mk___split_discrs (of_rep8 0)) (mk___split_fields2 dummy4 dummy4) true))) (mk___rep2 (us_split_discrs1 usq_) (us_split_fields5 usq_) false)) (of_int1 0)))) (= (rec__algorithm__controller__laserscan (us_split_fields15 temp___expr_612)) (temp___618 (mk___rep5 (mk___split_fields5 (of_rep4 (fp #b0 #b00000000 #b00000000000000000000000)) null_angle))))) (and (= (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_612))))) 1000) (= (is_empty (rec__algorithm__controller__gapvec (us_split_fields15 temp___expr_612))) true))) (= (to_rep2 (rec__algorithm__controller__obsavoiddelta (us_split_fields15 temp___expr_612))) (fp #b0 #b00000000 #b00000000000000000000000))) (= (rec__algorithm__controller__driveangle (us_split_fields15 temp___expr_612)) null_angle)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_794 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_794 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 5)) 71)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 7)) 112)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_794 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_794 us_void_param)))))
(declare-fun temp___String_Literal_795 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_795 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_795 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 3)) 117)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 6)) 100)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 12)) 102)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 15)) 98)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 16)) 121)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 19)) 98)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 22)) 97)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 24)) 108)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_795 us_void_param) 29)) 32)) :pattern ((temp___String_Literal_795 us_void_param)))))
(define-fun dynamic_invariant3 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range7 temp___expr_33)))
...
(assert (= posgapcorner (create__4 (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap))) (rec__gaps__gap__bearing (us_split_fields9 risinggap)))))
(define-fun dynamic_invariant7 ((temp___expr_577 us_rep6) (temp___is_init_574 Bool) (temp___skip_constant_575 Bool) (temp___do_toplevel_576 Bool)) Bool (=> (not (= temp___skip_constant_575 true)) (in_range11 1000 temp___expr_577)))
(define-fun default_initial_assumption1 ((temp___expr_579 us_rep6) (temp___skip_top_level_580 Bool)) Bool (and (= (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 temp___expr_579))) 1000) (=> (not (= temp___skip_top_level_580 true)) (= (is_empty temp___expr_579) true))))
(define-fun dynamic_invariant8 ((temp___expr_220 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 1)) (in_range8 temp___expr_220)))
(define-fun default_initial_assumption2 ((temp___expr_228 us_rep2) (temp___skip_top_level_229 Bool)) Bool (and (= (attr__constrained temp___expr_228) false) (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 temp___expr_228))) 0)))
(define-fun dynamic_invariant9 ((temp___expr_236 us_rep3) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields7 temp___expr_236))) false))
(define-fun default_initial_assumption3 ((temp___expr_239 us_rep3) (temp___skip_top_level_240 Bool)) Bool (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields7 temp___expr_239))) false) (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 (rec__robot_iface__proxy__speed (us_split_fields7 temp___expr_239))))) 0)))
(define-fun dynamic_invariant10 ((temp___expr_140 Float32) (temp___is_init_137 Bool) (temp___skip_constant_138 Bool) (temp___do_toplevel_139 Bool)) Bool (=> (or (= temp___is_init_137 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range4 temp___expr_140)))
(define-fun dynamic_invariant11 ((temp___expr_146 Float32) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range5 temp___expr_146)))
(define-fun dynamic_invariant12 ((temp___expr_158 Float32) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (fp.leq (fp.neg (fp #b0 #b11111110 #b11111111111111111111111)) (fp #b0 #b11111110 #b11111111111111111111111))) (fp.isFinite32 temp___expr_158)))
(assert (= null_angle (mk___rep (mk___split_fields (of_rep5 (fp #b0 #b00000000 #b00000000000000000000000))))))
(define-fun dynamic_invariant13 ((temp___expr_170 Float32) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b10000001 #b10010010000111111011011))) (in_range6 temp___expr_170)))
...
(define-fun dynamic_invariant14 ((temp___expr_286 Int) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool (=> (or (= temp___is_init_283 true) (<= (- 1) 1)) (in_range9 temp___expr_286)))
(define-fun dynamic_invariant15 ((temp___expr_324 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 0 2147483647)) (in_range10 temp___expr_324)))
(declare-fun length1 (us_rep6) Int)
(declare-fun length__function_guard (Int us_rep6) Bool)
(assert (forall ((container us_rep6)) (! (let ((result (length1 container))) (and (<= result (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 container)))) (dynamic_invariant15 result true false true))) :pattern ((length1 container)))))
(assert (forall ((container us_rep6)) (! (= (= (is_empty container) true) (= (length1 container) 0)) :pattern ((is_empty container)))))
(declare-const i Int)
...
(assert (and (= (attr__constrained (rec__robot_iface__proxy__speed (us_split_fields7 (rec__algorithm__controller__robot (us_split_fields15 this))))) false) (= 1000 (to_rep10 (rec__algorithm__gap_vectors__list__capacity (us_split_discrs3 (rec__algorithm__controller__gapvec (us_split_fields15 this))))))))
(assert (and (= (mk___rep1 (mk___split_fields1 algorithm__isrisinggapsafe__B_4__posgapcorner__assume algorithm__isrisinggapsafe__B_4__posgapcorner__assume1)) (create__4 (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap))) (rec__gaps__gap__bearing (us_split_fields9 risinggap)))) (=> (not (fp.eq (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap))) (fp #b0 #b00000000 #b00000000000000000000000))) (not (= (oeq (mk___rep1 (mk___split_fields1 algorithm__isrisinggapsafe__B_4__posgapcorner__assume algorithm__isrisinggapsafe__B_4__posgapcorner__assume1)) zero_position) true)))))
(assert (= (mk___rep1 (mk___split_fields1 algorithm__isrisinggapsafe__B_4__posgapcorner__assume algorithm__isrisinggapsafe__B_4__posgapcorner__assume1)) posgapcorner))
(assert (= result i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 1000))
(assert (and (<= 1 i2) (<= i2 1000)))
(assert (and (= o (aldiff (rec__algorithm__laser_scan_data__second (us_split_fields11 (select (rec__algorithm__controller__laserscan (us_split_fields15 this)) i2))) (rec__gaps__gap__bearing (us_split_fields9 risinggap)))) (and (fp.isFinite32 o) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o) (fp.leq o (fp #b0 #b10000000 #b10010010000111111011011))))))
(assert (= o1 (fp.mul RNE (of_int RNE (to_rep9 (rec__gaps__gap__idir (us_split_fields9 risinggap)))) o)))
(assert (and (= algorithm__isrisinggapsafe__B_4__B_6__deltaangle__assume o1) (fp.isFinite32 o1)))
(assert (= algorithm__isrisinggapsafe__B_4__B_6__deltaangle__assume deltaangle))
...
(assert (not (fp.isFinite32 (fp.sub RNE (to_rep3 (rec__robot_iface__proxy__max_range (us_split_fields7 (rec__algorithm__controller__robot (us_split_fields15 this))))) (fp #b0 #b01111000 #b01000111101011100001010)))))
(check-sat)
(exit)
