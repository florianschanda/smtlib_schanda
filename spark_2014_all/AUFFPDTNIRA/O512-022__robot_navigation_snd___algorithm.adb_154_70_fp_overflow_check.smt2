...
(define-fun bool_eq5 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 a))) (to_rep8 (rec__robot_iface__speed_option__opt (us_split_discrs1 b)))) (=> (robot_iface__speed_option__modulus__pred a) (= (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields5 a))) (to_rep2 (rec__robot_iface__speed_option__modulus (us_split_fields5 b)))))) (=> (robot_iface__speed_option__angle__pred a) (= (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields5 a))) (to_rep2 (rec__robot_iface__speed_option__angle (us_split_fields5 b)))))) true false))
...
(define-fun algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 () us_rep1 (mk___rep1 (mk___split_fields1 algorithm__isrisinggapsafe__B_4__posgapcorner__assume algorithm__isrisinggapsafe__B_4__posgapcorner__assume1)))
...
(assert (and (= algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 (create__4 (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap))) (rec__gaps__gap__bearing (us_split_fields9 risinggap)))) (=> (not (fp.eq (to_rep2 (rec__gaps__gap__distance (us_split_fields9 risinggap))) (fp #b0 #b00000000 #b00000000000000000000000))) (not (= (oeq algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 zero_position) true)))))
(assert (= algorithm__isrisinggapsafe__B_4__posgapcorner__assume2 posgapcorner))
(assert (= result i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 1000))
