...
(assert (= i11 i9))
(assert (= min9 min7))
(assert (= (= o37 true) (exists ((i12 Int)) (and (and (<= 0 i12) (<= i12 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i12)))) x) (fp.eq (t__content step_function__minimum_until_point__result4) (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 sfun)) i12))))))))))
(assert (<= 0 i1))
