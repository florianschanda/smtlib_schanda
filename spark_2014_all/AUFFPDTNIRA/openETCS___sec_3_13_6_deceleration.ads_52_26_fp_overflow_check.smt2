...
(assert (forall ((d Int)) (! (=> (dynamic_invariant1 d true true true true) (dynamic_invariant (a_gradient d) true false true true)) :pattern ((a_gradient d)))))
...
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant2 v true true true true) (dynamic_invariant1 d true true true true)) (dynamic_invariant (a_brake_safe v d) true false true true)) :pattern ((a_brake_safe v d))))))
(assert (forall ((v Float32)) (forall ((d Int)) (! (=> (and (dynamic_invariant2 v true true true true) (dynamic_invariant1 d true true true true)) (= (a_brake_safe v d) (fp.mul RNE (fp.mul RNE (kdry_rst v) (fp.add RNE (kwet_rst v) (fp.mul RNE m_nvavadh (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) (kwet_rst v))))) (a_brake_emergency v d)))) :pattern ((a_brake_safe v d))))))
...
(declare-datatypes () ((tdeceleration_tB__ref (mk_tdeceleration_tB__ref (tdeceleration_tB__content tdeceleration_tB)))))
(define-fun tdeceleration_tB__ref___projection ((a tdeceleration_tB__ref)) tdeceleration_tB (tdeceleration_tB__content a))
...
(assert (forall ((v1 Float32)) (forall ((d1 Int)) (! (=> (and (and (dynamic_invariant2 v1 true true true true) (dynamic_invariant1 d1 true true true true)) (and (= (is_valid_deceleration_model a_brake_emergency_model) true) (= (is_valid_speed v1) true))) (let ((result (a_brake_emergency v1 d1))) (and (fp.eq result (get_value a_brake_emergency_model (to_int1 RNA v1))) (dynamic_invariant result true false true true)))) :pattern ((a_brake_emergency v1 d1))))))
...
(assert (forall ((speed Float32)) (! (=> (and (dynamic_invariant4 speed true true true true) (= (is_valid_speed_km_per_h speed) true)) (dynamic_invariant2 (m_per_s_from_km_per_h speed) true false true true)) :pattern ((m_per_s_from_km_per_h speed)))))
...
(assert (forall ((v1 Float32)) (! (=> (and (dynamic_invariant2 v1 true true true true) (= (is_valid_kdry_rst Tuple0) true)) (let ((result (kdry_rst v1))) (and (fp.eq result (get_value kdry_rst_model (to_int1 RNA v1))) (dynamic_invariant3 result true false true true)))) :pattern ((kdry_rst v1)))))
...
(assert (forall ((v1 Float32)) (! (=> (and (dynamic_invariant2 v1 true true true true) (= (is_valid_kwet_rst Tuple0) true)) (let ((result (kwet_rst v1))) (and (fp.eq result (get_value kwet_rst_model (to_int1 RNA v1))) (dynamic_invariant3 result true false true true)))) :pattern ((kwet_rst v1)))))
...
(assert (in_range1 d))
(assert (and (= o (a_gradient d)) (and (in_range o) (= o (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (and (= o1 (a_brake_safe v d)) (and (in_range o1) (= o1 (fp.mul RNE (fp.mul RNE (kdry_rst v) (fp.add RNE (kwet_rst v) (fp.mul RNE m_nvavadh (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) (kwet_rst v))))) (a_brake_emergency v d))))))
