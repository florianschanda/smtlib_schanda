...
(define-fun dynamic_invariant1 ((temp___expr_175 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range temp___expr_175)))
...
(define-fun dynamic_invariant2 ((temp___expr_169 Float32) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range1 temp___expr_169)))
...
(assert (forall ((v1 us_rep)) (forall ((i Int)) (! (= (select (singleton1 v1 i) i) v1) :pattern ((select (singleton1 v1 i) i))))))
...
(assert (forall ((v1 Float32)) (forall ((d1 Int)) (! (=> (and (and (dynamic_invariant v1 true true true) (dynamic_invariant1 d1 true true true)) (and (= (is_valid_deceleration_model a_brake_emergency_model) true) (= (is_valid_speed v1) true))) (let ((result (a_brake_emergency v1 d1))) (and (fp.eq result (get_value a_brake_emergency_model (to_int1 RNA v1))) (dynamic_invariant2 result true false true)))) :pattern ((a_brake_emergency v1 d1))))))
...
(assert (forall ((v1 Float32)) (! (=> (and (dynamic_invariant v1 true true true) (= (is_valid_kdry_rst Tuple0) true)) (let ((result (kdry_rst v1))) (and (fp.eq result (get_value kdry_rst_model (to_int1 RNA v1))) (dynamic_invariant3 result true false true)))) :pattern ((kdry_rst v1)))))
...
(assert (forall ((v1 Float32)) (! (=> (and (dynamic_invariant v1 true true true) (= (is_valid_kwet_rst Tuple0) true)) (let ((result (kwet_rst v1))) (and (fp.eq result (get_value kwet_rst_model (to_int1 RNA v1))) (dynamic_invariant3 result true false true)))) :pattern ((kwet_rst v1)))))
...
(assert (in_range d))
(assert (and (= o (a_gradient d)) (and (in_range1 o) (= o (fp #b0 #b00000000 #b00000000000000000000000)))))
(assert (and (= o1 (a_brake_safe v d)) (and (in_range1 o1) (= o1 (fp.mul RNE (fp.mul RNE (kdry_rst v) (fp.add RNE (kwet_rst v) (fp.mul RNE (fp #b0 #b00000000 #b00000000000000000000000) (fp.sub RNE (fp #b0 #b01111111 #b00000000000000000000000) (kwet_rst v))))) (a_brake_emergency v d))))))
