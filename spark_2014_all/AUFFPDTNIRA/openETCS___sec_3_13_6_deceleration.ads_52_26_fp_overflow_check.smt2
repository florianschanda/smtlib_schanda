...
(assert (forall ((v1 Float32)) (! (=> (and (dynamic_invariant v1 true true true true) (= (is_valid_kdry_rst Tuple0) true)) (let ((result (kdry_rst v1))) (and (fp.eq result (get_value kdry_rst_model (to_int1 RNA v1))) (dynamic_invariant3 result true false true true)))) :pattern ((kdry_rst v1)))))
...
(assert (forall ((v1 Float32)) (! (=> (and (dynamic_invariant v1 true true true true) (= (is_valid_kwet_rst Tuple0) true)) (let ((result (kwet_rst v1))) (and (fp.eq result (get_value kwet_rst_model (to_int1 RNA v1))) (dynamic_invariant3 result true false true true)))) :pattern ((kwet_rst v1)))))
