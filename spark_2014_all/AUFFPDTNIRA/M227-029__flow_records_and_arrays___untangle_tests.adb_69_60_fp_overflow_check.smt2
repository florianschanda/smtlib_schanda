...
(assert (<= 1 t1))
(assert (<= t1 100))
(assert (and (forall ((temp___252 Int)) (=> (and (<= 1 temp___252) (<= temp___252 100)) (ite (<= t2 temp___252) (= (select tl1 temp___252) (select tl temp___252)) (and (forall ((temp___253 Int)) (=> (and (<= 1 temp___253) (<= temp___253 3)) (= (rec__untangle_tests__coordinate__w (us_split_fields1 (select (rec__untangle_tests__triangle__vertices (us_split_fields3 (select tl1 temp___252))) temp___253))) (rec__untangle_tests__coordinate__w (us_split_fields1 (select (rec__untangle_tests__triangle__vertices (us_split_fields3 (select tl temp___252))) temp___253)))))) (= (rec__untangle_tests__triangle__normal (us_split_fields3 (select tl1 temp___252))) (rec__untangle_tests__triangle__normal (us_split_fields3 (select tl temp___252)))))))) (and (<= 1 t2) (<= t2 100))))
(assert (= result1 (mk_int__ref v)))
(assert (= v1 1))
(assert (not (fp.isFinite32 (fp.add RNE (to_rep (rec__untangle_tests__coordinate__x (us_split_fields1 (select (rec__untangle_tests__triangle__vertices (us_split_fields3 (select tl1 t2))) v1)))) (to_rep (rec__untangle_tests__coordinate__x (us_split_fields1 o)))))))
(check-sat)
(exit)
