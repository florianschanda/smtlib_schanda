...
(assert (<= 1 t1))
(assert (<= t1 100))
(assert (and (forall ((temp___279 Int)) (=> (and (<= 1 temp___279) (<= temp___279 100)) (ite (<= t2 temp___279) (= (select tl1 temp___279) (select tl temp___279)) (and (forall ((temp___280 Int)) (=> (and (<= 1 temp___280) (<= temp___280 3)) (= (rec__untangle_tests__coordinate__w (us_split_fields1 (select (rec__untangle_tests__triangle__vertices (us_split_fields3 (select tl1 temp___279))) temp___280))) (rec__untangle_tests__coordinate__w (us_split_fields1 (select (rec__untangle_tests__triangle__vertices (us_split_fields3 (select tl temp___279))) temp___280)))))) (= (rec__untangle_tests__triangle__normal (us_split_fields3 (select tl1 temp___279))) (rec__untangle_tests__triangle__normal (us_split_fields3 (select tl temp___279)))))))) (and (<= 1 t2) (<= t2 100))))
