...
(assert (forall ((v1 Int)) (=> (and (<= index_22 v1) (<= v1 100000)) (= (= (select is_prime5 v1) true) (forall ((div3 Int)) (=> (and (<= 2 div3) (<= div3 (- index_22 1))) (not (= (mod2 v1 div3) 0))))))))
...
(assert (forall ((v1 Int)) (=> (and (<= index_22 v1) (<= v1 100000)) (= (= (select is_prime7 v1) true) (and (forall ((div3 Int)) (=> (and (<= 2 div3) (<= div3 (- index_22 1))) (not (= (mod2 v1 div3) 0)))) (=> (and (<= (+ index_22 1) v1) (<= v1 index_33)) (not (= (mod2 v1 index_22) 0))))))))
