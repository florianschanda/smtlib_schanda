...
(assert (= index_21 2))
(assert (=> (and (<= 2 index_21) (<= index_21 r87b)) (= temp___261 index_21)))
(assert (=> (and (<= 2 index_21) (<= index_21 r87b)) (= temp___259 is_prime4)))
(assert (=> (and (<= 2 index_21) (<= index_21 r87b)) (= temp___258 index_3)))
(assert (=> (and (<= 2 index_21) (<= index_21 r87b)) (= temp___257 index_1)))
...
(assert (=> (and (<= 2 index_21) (<= index_21 r87b)) (and (and (and (=> (<= 0 2147483647) (in_range2 index_12)) (=> (<= (- 2147483648) 2147483647) (in_range1 index_32))) (=> (<= 2 r87b) (dynamic_property 2 r87b index_22))) (and (<= 2 index_22) (<= index_22 r87b)))))
...
(assert (=> (and (<= 2 index_21) (<= index_21 r87b)) (=> (= result4 true) (=> (<= index_33 100000) (= o3 (store is_prime5 o2 (of_int1 0)))))))
