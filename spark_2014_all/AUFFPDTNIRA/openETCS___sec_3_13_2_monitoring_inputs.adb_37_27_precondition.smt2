...
(define-fun dynamic_invariant2 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 0 2147483647)) (in_range1 temp___expr_223)))
...
(assert (= o10 o2))
(assert (= o11 o3))
(assert (= o12 (temp___165 (mk___rep (mk___split_fields o10 o11)) (mk___rep (mk___split_fields o8 o9)))))
(assert (= (to_rep1 o13) 0))
(assert (= o13 o14))
(assert (= o12 o15))
(assert (= temp___355 o14))
(assert (= temp___3551 o15))
