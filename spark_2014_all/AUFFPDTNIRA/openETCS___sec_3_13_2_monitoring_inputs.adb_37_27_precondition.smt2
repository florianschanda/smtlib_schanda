...
(assert (= kwet_rst_model (mk___rep1 (mk___split_fields1 (of_rep1 0) (temp___143 (mk___rep (mk___split_fields (of_rep2 0) (of_rep (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields (of_rep2 0) (of_rep (fp #b0 #b00000000 #b00000000000000000000000)))))))))
...
(assert (= o10 o2))
(assert (= o11 o3))
(assert (= o12 (temp___143 (mk___rep (mk___split_fields o10 o11)) (mk___rep (mk___split_fields o8 o9)))))
(assert (= (to_rep1 o13) 0))
(assert (= o13 o14))
(assert (= o12 o15))
(assert (= temp___319 o14))
(assert (= temp___3191 o15))
(assert (= (mk___rep1 (mk___split_fields1 temp___319 temp___3191)) kwet_rst_model))
