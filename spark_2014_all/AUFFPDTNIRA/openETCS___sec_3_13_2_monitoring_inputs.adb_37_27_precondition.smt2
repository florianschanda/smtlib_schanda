...
(define-fun dynamic_invariant1 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 0 2147483647)) (in_range1 temp___expr_223)))
(assert (forall ((sfun us_rep1)) (forall ((x Int)) (! (=> (and (dynamic_invariant1 x true true true true) (= (is_valid sfun) true)) (let ((result (get_value sfun x))) (and (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___283 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___283 i))))) x) (< x (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___284 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___284 (+ i 1)))))))) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___285 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___285 i))))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___286 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___286 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))))) x) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___287 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___287 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))) (dynamic_invariant result true false true true)))) :pattern ((get_value sfun x))))))
...
(assert (= kwet_rst_model (mk___rep1 (mk___split_fields1 rliteral (temp_____aggregate_def_165 (mk___rep (mk___split_fields rliteral1 (of_rep (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields rliteral1 (of_rep (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(define-fun dynamic_invariant3 ((temp___expr_216 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool) (temp___do_typ_inv_215 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= 0 10)) (in_range temp___expr_216)))
(assert true)
...
(assert (forall ((temp___167 us_rep) (temp___168 us_rep)) (let ((temp___166 (temp_____aggregate_def_165 temp___167 temp___168))) (forall ((temp___169 Int)) (ite (= temp___169 0) (= (select temp___166 temp___169) temp___167) (= (select temp___166 temp___169) temp___168))))))
...
(declare-const temp___355 num_delimiters_range)
(declare-const temp___3551 (Array Int us_rep))
...
(assert (= o8 o1))
(assert (= o9 o2))
(assert (= o10 (temp_____aggregate_def_165 (mk___rep (mk___split_fields o8 o9)) (mk___rep (mk___split_fields o6 o7)))))
(assert (= rliteral o11))
(assert (= o10 o12))
(assert (= temp___355 o11))
(assert (= temp___3551 o12))
(assert (= (mk___rep1 (mk___split_fields1 temp___355 temp___3551)) kwet_rst_model))
(assert (fp.isFinite32 v))
(assert (= (is_valid_kwet_rst Tuple0) true))
(assert (and (= o13 (to_int1 RNA v)) (in_range1 (to_int1 RNA v))))
(assert (not (= (is_valid kwet_rst_model) true)))
(check-sat)
(exit)
