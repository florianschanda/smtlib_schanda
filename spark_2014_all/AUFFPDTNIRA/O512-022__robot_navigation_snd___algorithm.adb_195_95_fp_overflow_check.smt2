...
(assert (and (= o (ccwdiff (rec__algorithm__laser_scan_data__second rayr__split_fields2) (rec__algorithm__laser_scan_data__second rayl__split_fields2))) (fp.isFinite32 o)))
(assert (and (= o1 (cos1 o)) (and (fp.isFinite32 o1) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) o1) (fp.leq o1 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq o (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq o1 (fp #b0 #b01111111 #b00000000000000000000000)))))))
(assert (not (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(check-sat)
(exit)
