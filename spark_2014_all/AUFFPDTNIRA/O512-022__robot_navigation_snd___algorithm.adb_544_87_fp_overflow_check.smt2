...
(assert (= deltamag3 o7))
(assert (= (mk___rep (mk___split_fields o8)) (create__2 (fp #b0 #b10000000 #b10010010000111111011011))))
(assert (= (mk___rep (mk___split_fields o9)) (oadd (rec__algorithm__laser_scan_data__second (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))) (mk___rep (mk___split_fields o8)))))
(assert (and (= o10 (aldiff (rec__algorithm__controller__driveangle (us_split_fields11 this)) (mk___rep (mk___split_fields o9)))) (and (fp.isFinite32 o10) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o10) (fp.leq o10 (fp #b0 #b10000000 #b10010010000111111011011))))))
(assert (= deltaangle2 result5))
(assert (= deltaangle3 o10))
(assert (and (= o11 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag3 deltamag3))) (fp.isFinite32 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag3 deltamag3)))))
(assert (= deltaareasum2 result6))
(assert (= deltaareasum3 o11))
(assert (not (fp.isFinite32 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag3 deltamag3) deltamag3) deltaangle3))))
(check-sat)
(exit)
