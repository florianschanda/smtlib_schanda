...
(assert (= kdry_rst_model (mk___rep1 (mk___split_fields1 rliteral (temp_____aggregate_def_160 (mk___rep (mk___split_fields rliteral1 (of_rep (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields rliteral1 (of_rep (fp #b0 #b00000000 #b00000000000000000000000)))))))))
...
(assert (= o8 o1))
(assert (= o9 o2))
(assert (= o10 (temp_____aggregate_def_160 (mk___rep (mk___split_fields o8 o9)) (mk___rep (mk___split_fields o6 o7)))))
(assert (= rliteral o11))
(assert (= o10 o12))
(assert (= temp___352 o11))
(assert (= temp___3521 o12))
(assert (= (mk___rep1 (mk___split_fields1 temp___352 temp___3521)) kdry_rst_model))
...
(assert (and (= o14 (get_value kdry_rst_model o13)) (and (fp.isFinite32 o14) (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 kdry_rst_model))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kdry_rst_model)) i)))) o13) (< o13 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kdry_rst_model)) (+ i 1))))))) (fp.eq o14 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kdry_rst_model)) i)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kdry_rst_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 kdry_rst_model))))))) o13) (fp.eq o14 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 kdry_rst_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 kdry_rst_model)))))))))))))
