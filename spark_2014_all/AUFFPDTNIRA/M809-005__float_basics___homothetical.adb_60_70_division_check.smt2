...
(assert (= lambda2 o6))
(assert (and (= o8 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka i1)) (fp.abs (to_rep (select d j1)))))))
(assert (and (= o7 (fp.mul RNE (to_rep (select ka j1)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka j1)) (fp.abs (to_rep (select d i1)))))))
(assert (not (not (fp.isZero o8))))
(check-sat)
(exit)
