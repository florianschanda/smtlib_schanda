...
(assert (= lambda2 o9))
(assert (and (= o11 (fp.mul RNE (to_rep (select ka i11)) (fp.abs (to_rep (select d j2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka i11)) (fp.abs (to_rep (select d j2)))))))
(assert (and (= o10 (fp.mul RNE (to_rep (select ka j2)) (fp.abs (to_rep (select d i11))))) (fp.isFinite32 (fp.mul RNE (to_rep (select ka j2)) (fp.abs (to_rep (select d i11)))))))
