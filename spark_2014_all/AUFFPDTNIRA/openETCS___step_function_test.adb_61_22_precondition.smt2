...
(assert (and (= o113 (get_value (mk___rep1 sfun3__split_fields2) i1)) (and (fp.isFinite32 o113) (or (exists ((i14 Int)) (and (and (<= 0 i14) (<= i14 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i14)))) i1) (< i1 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (+ i14 1))))))) (fp.eq o113 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i14)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)))))) i1) (fp.eq o113 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2))))))))))))
(assert (and (= o115 (min o113 o114)) (and (fp.isFinite32 o115) (ite (fp.leq o113 o114) (fp.eq o115 o113) (fp.eq o115 o114)))))
