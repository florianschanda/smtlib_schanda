...
(assert (= i1 0))
(assert (and (= o108 (get_value (mk___rep1 sfun4__split_fields2) i1)) (and (fp.isFinite32 o108) (or (exists ((i2 Int)) (and (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i2)))) i1) (< i1 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (+ i2 1))))))) (fp.eq o108 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i2)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)))))) i1) (fp.eq o108 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2))))))))))))
(assert (and (= o107 (get_value (mk___rep1 sfun3__split_fields2) i1)) (and (fp.isFinite32 o107) (or (exists ((i2 Int)) (and (and (<= 0 i2) (<= i2 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i2)))) i1) (< i1 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (+ i2 1))))))) (fp.eq o107 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i2)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)))))) i1) (fp.eq o107 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2))))))))))))
(assert (and (= o109 (min o107 o108)) (and (fp.isFinite32 o109) (ite (fp.leq o107 o108) (fp.eq o109 o107) (fp.eq o109 o108)))))
