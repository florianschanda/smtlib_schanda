...
(assert (= i2 1))
(assert (and (= o82 (get_value (mk___rep1 sfun4__split_fields2) i2)) (and (fp.isFinite32 o82) (or (exists ((i3 Int)) (and (and (<= 0 i3) (<= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i3)))) i2) (< i2 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (+ i3 1))))))) (fp.eq o82 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i3)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)))))) i2) (fp.eq o82 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2))))))))))))
(assert (and (= o81 (get_value (mk___rep1 sfun3__split_fields2) i2)) (and (fp.isFinite32 o81) (or (exists ((i3 Int)) (and (and (<= 0 i3) (<= i3 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i3)))) i2) (< i2 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (+ i3 1))))))) (fp.eq o81 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) i3)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2)))))) i2) (fp.eq o81 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun3__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun3__split_fields2))))))))))))
