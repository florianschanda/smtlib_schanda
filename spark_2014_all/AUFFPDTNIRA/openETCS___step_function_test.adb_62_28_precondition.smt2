...
(assert (= i1 0))
(assert (and (= o114 (get_value (mk___rep1 sfun4__split_fields2) i1)) (and (fp.isFinite32 o114) (or (exists ((i14 Int)) (and (and (<= 0 i14) (<= i14 (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i14)))) i1) (< i1 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (+ i14 1))))))) (fp.eq o114 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) i14)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2)))))) i1) (fp.eq o114 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step sfun4__split_fields2) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters sfun4__split_fields2))))))))))))
