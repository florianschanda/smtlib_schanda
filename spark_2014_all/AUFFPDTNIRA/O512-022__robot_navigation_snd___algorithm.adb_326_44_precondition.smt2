...
(assert (and (= result4 (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 riterr__split_fields3))) (= (= result4 true) (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 riterr__split_fields3)) true))))
(assert (=> (= result4 true) (and (= result3 (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 riterl__split_fields2))) (= (= result3 true) (= (has_key (positions (rec__algorithm__controller__gapvec (let ((subject this__split_fields)) this__split_fields2))) (mk___rep5 riterl__split_fields2)) true)))))
