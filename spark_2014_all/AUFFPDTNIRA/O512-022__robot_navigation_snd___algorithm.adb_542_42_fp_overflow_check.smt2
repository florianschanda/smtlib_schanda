...
(assert (= o11 (oadd (rec__algorithm__laser_scan_data__second (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))) o12)))
(assert (and (= o10 (aldiff (rec__algorithm__controller__driveangle (us_split_fields11 this)) o11)) (and (fp.isFinite32 o10) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o10) (fp.leq o10 (fp #b0 #b10000000 #b10010010000111111011011))))))
(assert (= deltaangle1 result5))
(assert (= deltaangle2 o10))
(assert (not (fp.isFinite32 (fp.add RNE deltaareasum2 (fp.mul RNE deltamag2 deltamag2)))))
(check-sat)
(exit)
