...
(assert (=> (= result4 true) (and (= o1 (* 2 index_12)) (in_range1 (* 2 index_12)))))
(assert (=> (= result4 true) (= index_31 result6)))
(assert (=> (= result4 true) (= index_32 o1)))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= temp___292 is_prime5))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= temp___291 index_32))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (and (<= 0 index_32) (<= index_32 100000)))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= o2 index_32))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= o3 (store is_prime5 o2 (distinct 0 0))))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime5 result7))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime6 o3))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (forall ((v Int)) (=> (and (<= 0 v) (<= v index_22)) (= (= (select is_prime7 v) true) (= (is_prime v) true)))))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (forall ((v Int)) (=> (and (<= index_22 v) (<= v 100000)) (= (= (select is_prime7 v) true) (and (forall ((div2 Int)) (=> (and (<= 2 div2) (<= div2 (- index_22 1))) (not (= (mod2 v div2) 0)))) (=> (and (<= (+ index_22 1) v) (<= v index_33)) (not (= (mod2 v index_22) 0))))))))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (and (<= index_22 index_33) (<= index_33 100000)))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= (mod2 index_33 index_22) 0))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (=> (<= (- 2147483648) 2147483647) (in_range1 index_33)))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (and (= o4 (+ index_33 index_12)) (in_range1 (+ index_33 index_12))))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= index_33 result8))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= index_34 o4))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (not (<= index_34 100000)))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= index_34 index_35))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime7 is_prime8))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= index_36 index_34))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime9 is_prime7))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= index_313 (mk_int__ref index_35)))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime17 (mk_map__ref is_prime8)))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= index_38 index_36))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= is_prime11 is_prime9))))
(assert (=> (= result4 true) (=> (not (<= index_32 100000)) (= index_32 index_37))))
(assert (=> (= result4 true) (=> (not (<= index_32 100000)) (= is_prime5 is_prime10))))
(assert (=> (= result4 true) (=> (not (<= index_32 100000)) (= index_38 index_32))))
(assert (=> (= result4 true) (=> (not (<= index_32 100000)) (= is_prime11 is_prime5))))
...
(assert (not (= (select (map__content is_prime14) v) true)))
(check-sat)
(exit)
