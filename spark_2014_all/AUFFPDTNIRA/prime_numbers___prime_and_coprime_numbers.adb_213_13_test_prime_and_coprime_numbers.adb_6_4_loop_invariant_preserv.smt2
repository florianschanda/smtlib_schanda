...
(assert (=> (= result4 true) (and (= o5 (* 2 index_13)) (in_range1 (* 2 index_13)))))
(assert (=> (= result4 true) (= index_32 result6)))
(assert (=> (= result4 true) (= index_33 o5)))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= temp___255 is_prime5))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= temp___254 index_33))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (and (<= 0 index_33) (<= index_33 100000)))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= o6 index_33))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= o7 (store is_prime5 o6 (of_int1 0))))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= is_prime5 result7))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= is_prime6 o7))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (forall ((v4 Int)) (=> (and (<= 0 v4) (<= v4 index_22)) (= (= (select is_prime7 v4) true) (= (is_prime v4) true)))))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (forall ((v4 Int)) (=> (and (<= index_22 v4) (<= v4 100000)) (= (= (select is_prime7 v4) true) (and (forall ((div4 Int)) (=> (and (<= 2 div4) (<= div4 (- index_22 1))) (not (= (mod2 v4 div4) 0)))) (=> (and (<= (+ index_22 1) v4) (<= v4 index_34)) (not (= (mod2 v4 index_22) 0))))))))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (and (<= index_22 index_34) (<= index_34 100000)))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= (mod2 index_34 index_22) 0))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (=> (<= (- 2147483648) 2147483647) (in_range1 index_34)))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (and (= o16 (+ index_34 index_13)) (in_range1 (+ index_34 index_13))))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= index_34 result9))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= index_35 o16))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (not (<= index_35 100000)))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= index_35 index_36))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= is_prime7 is_prime9))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= index_37 index_35))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= is_prime10 is_prime7))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= (mk_int__ref index_38) (mk_int__ref index_36)))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= (mk_map__ref is_prime11) (mk_map__ref is_prime9)))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= index_39 index_37))))
(assert (=> (= result4 true) (=> (<= index_33 100000) (= is_prime12 is_prime10))))
(assert (=> (= result4 true) (=> (not (<= index_33 100000)) (= index_33 index_38))))
(assert (=> (= result4 true) (=> (not (<= index_33 100000)) (= is_prime5 is_prime11))))
(assert (=> (= result4 true) (=> (not (<= index_33 100000)) (= index_39 index_33))))
(assert (=> (= result4 true) (=> (not (<= index_33 100000)) (= is_prime12 is_prime5))))
(assert (=> (= result4 true) (= index_310 (mk_int__ref index_38))))
(assert (=> (= result4 true) (= index_13 index_14)))
(assert (=> (= result4 true) (= (mk_map__ref is_prime13) (mk_map__ref is_prime11))))
(assert (=> (= result4 true) (= index_311 index_39)))
(assert (=> (= result4 true) (= index_15 index_13)))
(assert (=> (= result4 true) (= is_prime14 is_prime12)))
(assert (=> (not (= result4 true)) (= index_310 (mk_int__ref index_32))))
(assert (=> (not (= result4 true)) (= index_12 index_14)))
(assert (=> (not (= result4 true)) (= is_prime5 is_prime13)))
(assert (=> (not (= result4 true)) (= index_311 index_32)))
(assert (=> (not (= result4 true)) (= index_15 index_12)))
(assert (=> (not (= result4 true)) (= is_prime14 is_prime5)))
(assert (not (= index_22 r87b)))
(assert (= result11 (mk_int__ref index_22)))
(assert (= index_23 (+ index_22 1)))
(assert (= index_24 (mk_int__ref index_23)))
(assert (= index_312 index_310))
(assert (= index_16 (mk_int__ref index_14)))
(assert (= is_prime15 (mk_map__ref is_prime13)))
(assert (= index_25 index_23))
(assert (= index_313 index_311))
(assert (= index_17 index_15))
(assert (= is_prime16 is_prime14))
(declare-const v4 Int)
(assert (<= 0 v4))
(assert (<= v4 (int__content index_24)))
(assert (= (select (map__content is_prime15) v4) true))
(assert (not (= (is_prime v4) true)))
(check-sat)
(exit)
