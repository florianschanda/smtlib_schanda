...
(assert (forall ((x1 Float32) (x2 Float32)) (! (=> (and (dynamic_invariant x1 true true true) (dynamic_invariant x2 true true true)) (let ((result (min x1 x2))) (and (ite (fp.leq x1 x2) (fp.eq result x1) (fp.eq result x2)) (dynamic_invariant result true false true)))) :pattern ((min x1 x2)))))
...
(assert true)
(assert (forall ((sfun1 us_rep1) (sfun2 us_rep1)) (! (= (= (has_same_delimiters sfun1 sfun2) true) (and (= (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun1))) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun2)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun1))))) (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___191 (rec__step_function__step_function_t__step (us_split_fields3 sfun1)))) (select temp___191 i))))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___192 (rec__step_function__step_function_t__step (us_split_fields3 sfun2)))) (select temp___192 i)))))))))) :pattern ((has_same_delimiters sfun1 sfun2)))))
...
(assert (forall ((sfun us_rep1)) (forall ((x Int)) (! (=> (and (dynamic_invariant1 x true true true) (= (is_valid sfun) true)) (let ((result (get_value sfun x))) (and (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___199 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___199 i))))) x) (< x (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___200 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___200 (+ i 1)))))))) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___201 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___201 i))))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___202 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___202 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))))) x) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___203 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___203 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))) (dynamic_invariant result true false true)))) :pattern ((get_value sfun x))))))
...
(assert (forall ((sfun us_rep1)) (forall ((x Int)) (! (=> (and (dynamic_invariant1 x true true true) (= (is_valid sfun) true)) (let ((result (minimum_until_point sfun x))) (and (and (forall ((i Int)) (=> (and (<= 0 i) (<= i (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (=> (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___211 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___211 i))))) x) (fp.leq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___210 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___210 i))))))))) (exists ((i Int)) (and (and (<= 0 i) (<= i (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___212 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___212 i))))) x) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___213 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___213 i)))))))))) (dynamic_invariant result true false true)))) :pattern ((minimum_until_point sfun x))))))
...
(assert (forall ((temp___276 us_rep) (temp___277 us_rep) (temp___278 us_rep) (temp___279 us_rep)) (let ((temp___275 (temp___274 temp___276 temp___277 temp___278 temp___279))) (forall ((temp___280 Int)) (ite (= temp___280 0) (= (select temp___275 temp___280) temp___276) (ite (= temp___280 1) (= (select temp___275 temp___280) temp___277) (ite (= temp___280 2) (= (select temp___275 temp___280) temp___278) (= (select temp___275 temp___280) temp___279))))))))
(declare-fun temp___281 (us_rep us_rep us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___283 us_rep) (temp___284 us_rep) (temp___285 us_rep) (temp___286 us_rep)) (let ((temp___282 (temp___281 temp___283 temp___284 temp___285 temp___286))) (forall ((temp___287 Int)) (ite (= temp___287 0) (= (select temp___282 temp___287) temp___283) (ite (= temp___287 1) (= (select temp___282 temp___287) temp___284) (ite (= temp___287 2) (= (select temp___282 temp___287) temp___285) (= (select temp___282 temp___287) temp___286))))))))
(declare-fun temp___288 (us_rep us_rep us_rep us_rep us_rep us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___290 us_rep) (temp___291 us_rep) (temp___292 us_rep) (temp___293 us_rep) (temp___294 us_rep) (temp___295 us_rep) (temp___296 us_rep)) (let ((temp___289 (temp___288 temp___290 temp___291 temp___292 temp___293 temp___294 temp___295 temp___296))) (forall ((temp___297 Int)) (ite (= temp___297 0) (= (select temp___289 temp___297) temp___290) (ite (= temp___297 1) (= (select temp___289 temp___297) temp___291) (ite (= temp___297 2) (= (select temp___289 temp___297) temp___292) (ite (= temp___297 3) (= (select temp___289 temp___297) temp___293) (ite (= temp___297 4) (= (select temp___289 temp___297) temp___294) (ite (= temp___297 5) (= (select temp___289 temp___297) temp___295) (= (select temp___289 temp___297) temp___296)))))))))))
(declare-fun temp___298 (us_rep us_rep us_rep us_rep us_rep us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___300 us_rep) (temp___301 us_rep) (temp___302 us_rep) (temp___303 us_rep) (temp___304 us_rep) (temp___305 us_rep) (temp___306 us_rep)) (let ((temp___299 (temp___298 temp___300 temp___301 temp___302 temp___303 temp___304 temp___305 temp___306))) (forall ((temp___307 Int)) (ite (= temp___307 0) (= (select temp___299 temp___307) temp___300) (ite (= temp___307 1) (= (select temp___299 temp___307) temp___301) (ite (= temp___307 2) (= (select temp___299 temp___307) temp___302) (ite (= temp___307 3) (= (select temp___299 temp___307) temp___303) (ite (= temp___307 4) (= (select temp___299 temp___307) temp___304) (ite (= temp___307 5) (= (select temp___299 temp___307) temp___305) (= (select temp___299 temp___307) temp___306)))))))))))
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10)) (in_range temp___expr_136)))
...
(declare-const sfun_merge__split_fields us_split_fields2)
...
(assert (= o23 (temp___274 o22 (mk___rep (mk___split_fields o20 o21)) (mk___rep (mk___split_fields o18 o19)) (mk___rep (mk___split_fields o16 o17)))))
...
(assert (fp.eq (get_value (mk___rep1 sfun1__split_fields2) 0) (fp #b0 #b10000000 #b10000000000000000000000)))
(assert (fp.eq (get_value (mk___rep1 sfun1__split_fields2) 1) (fp #b0 #b10000000 #b10000000000000000000000)))
(assert (fp.eq (get_value (mk___rep1 sfun1__split_fields2) 3) (fp #b0 #b10000000 #b00000000000000000000000)))
(assert (fp.eq (get_value (mk___rep1 sfun1__split_fields2) 4) (fp #b0 #b10000000 #b00000000000000000000000)))
(assert (fp.eq (get_value (mk___rep1 sfun1__split_fields2) 5) (fp #b0 #b10000001 #b01000000000000000000000)))
(assert (fp.eq (get_value (mk___rep1 sfun1__split_fields2) 2147483647) (fp #b0 #b10000001 #b01000000000000000000000)))
(assert (not (= (has_same_delimiters (mk___rep1 sfun1__split_fields2) (mk___rep1 sfun2__split_fields2)) true)))
(check-sat)
(exit)
