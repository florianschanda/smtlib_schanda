...
(assert (forall ((i17 Int)) (=> (and (<= 1 i17) (<= i17 2)) (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka i17))) (not (fp.eq (to_rep (select kvp8 i17)) (fp #b0 #b00000000 #b00000000000000000000000)))) (not (fp.eq (to_rep (select d i17)) (fp #b0 #b00000000 #b00000000000000000000000)))))))
(assert (= result8 (mk_int__ref i1)))
(assert (= i11 1))
(assert (= result9 (mk_int__ref j)))
(assert (= j2 1))
(assert (not (= i11 j2)))
(assert (and (= o4 (fp.mul RNE (to_rep (select kvp8 i11)) (fp.abs (to_rep (select d j2))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp8 i11)) (fp.abs (to_rep (select d j2)))))))
(assert (and (= o3 (fp.mul RNE (to_rep (select kvp8 j2)) (fp.abs (to_rep (select d i11))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp8 j2)) (fp.abs (to_rep (select d i11)))))))
