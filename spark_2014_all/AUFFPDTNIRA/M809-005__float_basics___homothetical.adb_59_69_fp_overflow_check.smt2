...
(assert (forall ((d1 Float32) (kv1 Float32) (ka1 Float32)) (! (=> (and (and (and (dynamic_invariant d1 true true true true) (dynamic_invariant kv1 true true true true)) (dynamic_invariant ka1 true true true true)) (and (and (not (fp.eq d1 (fp #b0 #b00000000 #b00000000000000000000000))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) kv1)) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) ka1))) (let ((result (adjust2triangle d1 kv1 ka1))) (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) result) (fp.leq result kv1)) (dynamic_invariant result true false true true)))) :pattern ((adjust2triangle d1 kv1 ka1)))))
...
(assert (forall ((temp___185 Float32)) (=> (dynamic_invariant temp___185 true true true true) (forall ((temp___186 Int)) (= (to_rep (select (homothetical__homothetical__lambda__aggregate_def temp___185) temp___186)) temp___185)))))
(assert (forall ((temp___188 Float32)) (=> (dynamic_invariant temp___188 true true true true) (forall ((temp___189 Int)) (= (to_rep (select (homothetical__homothetical__upsilon__aggregate_def temp___188) temp___189)) temp___188)))))
(assert (forall ((temp___191 Float32)) (=> (dynamic_invariant temp___191 true true true true) (forall ((temp___192 Int)) (= (to_rep (select (homothetical__homothetical__kvp__aggregate_def temp___191) temp___192)) temp___191)))))
(assert (forall ((temp___200 Float32)) (=> (dynamic_invariant temp___200 true true true true) (forall ((temp___201 Int)) (= (to_rep (select (temp___198 temp___200) temp___201)) temp___200)))))
(assert (forall ((temp___204 Float32)) (=> (dynamic_invariant temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep (select (temp___202 temp___204) temp___205)) temp___204)))))
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 2)) (in_range1 temp___expr_166)))
...
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 2)) (and (and (not (fp.eq (to_rep (select d j2)) (fp #b0 #b00000000 #b00000000000000000000000))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kv j2)))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka j2)))))))
...
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 2)) (and (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka i2))) (not (fp.eq (to_rep (select kvp2 i2)) (fp #b0 #b00000000 #b00000000000000000000000)))) (not (fp.eq (to_rep (select d i2)) (fp #b0 #b00000000 #b00000000000000000000000)))))))
(assert (= result3 (mk_int__ref i)))
(assert (= i1 1))
(assert (= result4 (mk_int__ref j)))
(assert (= j1 1))
(assert (not (= i1 j1)))
(assert (and (= o1 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 i1)) (fp.abs (to_rep (select d j1)))))))
(assert (and (= o (fp.mul RNE (to_rep (select kvp2 j1)) (fp.abs (to_rep (select d i1))))) (fp.isFinite32 (fp.mul RNE (to_rep (select kvp2 j1)) (fp.abs (to_rep (select d i1)))))))
