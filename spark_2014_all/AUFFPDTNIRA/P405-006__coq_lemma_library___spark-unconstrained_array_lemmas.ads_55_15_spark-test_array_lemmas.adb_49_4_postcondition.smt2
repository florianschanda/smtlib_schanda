...
(assert (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt arr))) i) (<= i (to_rep1 (last (rt arr))))) (=> (not (= i (to_rep1 (first (rt arr))))) (fp.lt (to_rep (select (elts arr) (- i 1))) (to_rep (select (elts arr) i)))))))
(declare-const i Int)
