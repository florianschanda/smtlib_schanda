...
(assert (and (= o31 (fp.mul RNE (to_rep (select (map__content lambda6) i11)) (to_rep (select kvp8 i11)))) (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content lambda6) i11)) (to_rep (select kvp8 i11))))))
(assert (= (to_rep o32) o31))
(assert (= o33 (store kvmax1 i11 o32)))
(assert (= result15 (mk_map__ref kvmax1)))
(assert (= kvmax2 o33))
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (select (map__content upsilon6) i11)) (to_rep (select ka i11))))))
(check-sat)
(exit)
