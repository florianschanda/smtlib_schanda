...
(assert (and (= o4 (sin1 deltaangle)) (and (fp.isFinite32 o4) (and (and (fp.leq (fp.neg (fp #b0 #b01111111 #b00000000000000000000000)) o4) (fp.leq o4 (fp #b0 #b01111111 #b00000000000000000000000))) (=> (fp.eq deltaangle (fp #b0 #b00000000 #b00000000000000000000000)) (fp.eq o4 (fp #b0 #b00000000 #b00000000000000000000000)))))))
(assert (= o5 (fp.div RNE (fp.div RNE width (fp #b0 #b10000000 #b00000000000000000000000)) o4)))
