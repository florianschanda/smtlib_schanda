...
(define-fun bool_eq ((a (Array Int float)) (a__first Int) (a__last Int) (b (Array Int float)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep (select a temp___idx_133)) (to_rep (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
...
(declare-datatypes () ((arr_float_unconstrained__ref (mk_arr_float_unconstrained__ref (arr_float_unconstrained__content us_t)))))
(define-fun arr_float_unconstrained__ref___projection ((a arr_float_unconstrained__ref)) us_t (arr_float_unconstrained__content a))
(declare-sort t1 0)
...
(define-fun dynamic_invariant2 ((temp___expr_137 Int) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (or (= temp___is_init_134 true) (<= 1 10)) (in_range2 temp___expr_137)))
(define-fun dynamic_invariant3 ((temp___expr_168 us_t) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (not (= temp___skip_constant_166 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_168) (last1 temp___expr_168))))
(define-fun dynamic_invariant4 ((temp___expr_214 us_t1) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_214) (last3 temp___expr_214))))
(declare-const temp___246 (Array Int float))
(declare-const temp___2461 t)
(declare-const o (Array Int float))
(declare-const o1 t1)
(assert (forall ((i Int)) (=> (and (<= 2 i) (<= i 10)) (fp.lt (to_rep (select arr (- i 1))) (to_rep (select arr i))))))
(assert (and (and (and (dynamic_property (- 2147483648) 2147483647 1 10) (and (= arr temp___246) (= (mk 1 10) temp___2461))) (and (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 (first temp___2461)) (to_rep1 (last temp___2461))) (and (= temp___246 o) (= (mk1 (to_rep1 (first temp___2461)) (to_rep1 (last temp___2461))) o1)))) (forall ((i Int)) (=> (and (<= (to_rep1 (first2 o1)) i) (<= i (to_rep1 (last2 o1)))) (forall ((j Int)) (=> (and (<= (to_rep1 (first2 o1)) j) (<= j (to_rep1 (last2 o1)))) (=> (< i j) (fp.lt (to_rep (select o i)) (to_rep (select o j))))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 10))
(declare-const j Int)
...
(assert (<= j 10))
(assert (< i j))
(assert (not (fp.lt (to_rep (select arr i)) (to_rep (select arr j)))))
(check-sat)
(exit)
