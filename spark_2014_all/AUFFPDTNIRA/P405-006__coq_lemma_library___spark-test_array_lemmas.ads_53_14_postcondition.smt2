...
(define-fun dynamic_invariant2 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 10)) (in_range2 temp___expr_160)))
(define-fun dynamic_invariant3 ((temp___expr_195 us_t) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool) (temp___do_typ_inv_194 Bool)) Bool (=> (not (= temp___skip_constant_192 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_195) (last1 temp___expr_195))))
(define-fun dynamic_invariant4 ((temp___expr_248 us_t1) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool) (temp___do_typ_inv_247 Bool)) Bool (=> (not (= temp___skip_constant_245 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_248) (last3 temp___expr_248))))
...
(assert (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 (first temp___2831)) (to_rep1 (last temp___2831))))
(assert (= temp___283 o))
(assert (= (mk1 (to_rep1 (first temp___2831)) (to_rep1 (last temp___2831))) o1))
(assert (forall ((i Int)) (=> (and (<= (to_rep1 (first2 o1)) i) (<= i (to_rep1 (last2 o1)))) (forall ((j Int)) (=> (and (<= (to_rep1 (first2 o1)) j) (<= j (to_rep1 (last2 o1)))) (=> (< i j) (fp.lt (to_rep (select o i)) (to_rep (select o j)))))))))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 10))
(declare-const j Int)
