...
(define-fun dynamic_invariant1 ((temp___expr_175 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range2 temp___expr_175)))
...
(define-fun dynamic_invariant3 ((temp___expr_193 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 2147483647)) (in_range4 temp___expr_193)))
(declare-fun is_valid (us_rep1) Bool)
(declare-fun is_valid__function_guard (Bool us_rep1) Bool)
(assert (forall ((sfun us_rep1)) (forall ((x Int)) (! (=> (and (dynamic_invariant3 x true true true) (= (is_valid sfun) true)) (let ((result (get_value sfun x))) (and (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___250 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___250 i))))) x) (< x (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___251 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___251 (+ i 1)))))))) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___252 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___252 i))))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___253 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___253 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))))) x) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___254 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___254 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))) (dynamic_invariant2 result true false true)))) :pattern ((get_value sfun x))))))
...
(define-fun dynamic_invariant5 ((temp___expr_169 Float32) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (fp.leq (fp #b0 #b00000000 #b00000000000000000000000) (fp #b0 #b11111110 #b11111111111111111111111))) (in_range1 temp___expr_169)))
...
(define-fun dynamic_invariant6 ((temp___expr_187 Int) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (or (= temp___is_init_184 true) (<= 0 10)) (in_range3 temp___expr_187)))
(assert true)
...
(declare-const temp___301 num_delimiters_range)
(declare-const temp___3011 (Array Int us_rep))
...
(assert (= o10 o2))
(assert (= o11 o3))
(assert (= o12 (temp___133 (mk___rep (mk___split_fields o10 o11)) (mk___rep (mk___split_fields o8 o9)))))
(assert (= (to_rep1 o13) 0))
(assert (= o13 o14))
(assert (= o12 o15))
(assert (= temp___301 o14))
(assert (= temp___3011 o15))
(assert (= (mk___rep1 (mk___split_fields1 temp___301 temp___3011)) a_brake_emergency_model))
...
(assert (and (= o17 (get_value a_brake_emergency_model o16)) (and (fp.isFinite32 o17) (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 a_brake_emergency_model))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) i)))) o16) (< o16 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) (+ i 1))))))) (fp.eq o17 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) i)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 a_brake_emergency_model))))))) o16) (fp.eq o17 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 a_brake_emergency_model)))))))))))))
(assert (and (= o18 o17) (fp.isFinite32 o17)))
(assert (= (mk_t__ref result) (mk_t__ref sec_3_13_6_deceleration__a_brake_emergency__result)))
(assert (= sec_3_13_6_deceleration__a_brake_emergency__result1 o18))
...
(assert (not (in_range4 (to_int1 RNA v))))
(check-sat)
(exit)
