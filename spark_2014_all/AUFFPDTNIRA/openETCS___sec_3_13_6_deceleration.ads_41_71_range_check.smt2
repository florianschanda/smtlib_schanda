...
(define-fun dynamic_invariant2 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 0 2147483647)) (in_range2 temp___expr_223)))
(assert (forall ((sfun us_rep1)) (forall ((x Int)) (! (=> (and (dynamic_invariant2 x true true true true) (= (is_valid sfun) true)) (let ((result (get_value sfun x))) (and (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___283 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___283 i))))) x) (< x (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___284 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___284 (+ i 1)))))))) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___285 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___285 i))))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___286 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___286 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun)))))))) x) (fp.eq result (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (let ((temp___287 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___287 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))))))))))) (dynamic_invariant1 result true false true true)))) :pattern ((get_value sfun x))))))
...
(assert true)
(assert (forall ((s us_rep1)) (! (= (= (is_valid_deceleration_model s) true) (and (= (is_valid s) true) (<= (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 s))) 6))) :pattern ((is_valid_deceleration_model s)))))
...
(define-fun dynamic_invariant3 ((temp___expr_202 Int) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool) (temp___do_typ_inv_201 Bool)) Bool (=> (or (= temp___is_init_198 true) (<= 0 2147483647)) (in_range4 temp___expr_202)))
...
(define-fun dynamic_invariant6 ((temp___expr_216 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool) (temp___do_typ_inv_215 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= 0 10)) (in_range1 temp___expr_216)))
(assert true)
(assert (forall ((sfun us_rep1)) (! (= (= (is_valid sfun) true) (and (= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___266 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___266 0))))) 0) (forall ((i Int)) (=> (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun))) 1))) (< (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___268 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___268 i))))) (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (let ((temp___267 (rec__step_function__step_function_t__step (us_split_fields3 sfun)))) (select temp___267 (+ i 1))))))))))) :pattern ((is_valid sfun)))))
...
(assert (= a_brake_emergency_model (mk___rep1 (mk___split_fields1 rliteral (temp_____aggregate_def_155 (mk___rep (mk___split_fields rliteral1 (of_rep (fp #b0 #b01111111 #b00000000000000000000000)))) (mk___rep (mk___split_fields rliteral1 (of_rep (fp #b0 #b00000000 #b00000000000000000000000)))))))))
(assert (forall ((temp___157 us_rep) (temp___158 us_rep)) (let ((temp___156 (temp_____aggregate_def_155 temp___157 temp___158))) (forall ((temp___159 Int)) (ite (= temp___159 0) (= (select temp___156 temp___159) temp___157) (= (select temp___156 temp___159) temp___158))))))
...
(declare-const temp___338 num_delimiters_range)
(declare-const temp___3381 (Array Int us_rep))
...
(assert (= o8 o1))
(assert (= o9 o2))
(assert (= o10 (temp_____aggregate_def_155 (mk___rep (mk___split_fields o8 o9)) (mk___rep (mk___split_fields o6 o7)))))
(assert (= rliteral o11))
(assert (= o10 o12))
(assert (= temp___338 o11))
(assert (= temp___3381 o12))
(assert (= (mk___rep1 (mk___split_fields1 temp___338 temp___3381)) a_brake_emergency_model))
(assert (fp.isFinite32 v))
(assert (in_range4 d))
(assert (and (= (is_valid_deceleration_model a_brake_emergency_model) true) (= (is_valid_speed v) true)))
(assert (= sec_3_13_6_deceleration__a_brake_emergency__result1 sec_3_13_6_deceleration__a_brake_emergency__result2))
(assert (= sec_3_13_6_deceleration__a_brake_emergency__result3 sec_3_13_6_deceleration__a_brake_emergency__result1))
(assert (and (= o13 (to_int1 RNA v)) (in_range2 (to_int1 RNA v))))
(assert (and (= o14 (get_value a_brake_emergency_model o13)) (and (fp.isFinite32 o14) (or (exists ((i Int)) (and (and (<= 0 i) (<= i (- (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 a_brake_emergency_model))) 1))) (and (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) i)))) o13) (< o13 (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) (+ i 1))))))) (fp.eq o14 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) i)))))))) (and (<= (to_rep2 (rec__step_function__delimiter_entry__delimiter (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 a_brake_emergency_model))))))) o13) (fp.eq o14 (to_rep (rec__step_function__delimiter_entry__value (us_split_fields1 (select (rec__step_function__step_function_t__step (us_split_fields3 a_brake_emergency_model)) (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 a_brake_emergency_model)))))))))))))
(assert (and (= o15 o14) (fp.isFinite32 o14)))
(assert (= (mk_t__ref result) (mk_t__ref sec_3_13_6_deceleration__a_brake_emergency__result)))
(assert (= sec_3_13_6_deceleration__a_brake_emergency__result1 o15))
(assert (= (mk_t__ref sec_3_13_6_deceleration__a_brake_emergency__result4) (mk_t__ref sec_3_13_6_deceleration__a_brake_emergency__result2)))
(assert (= sec_3_13_6_deceleration__a_brake_emergency__result5 sec_3_13_6_deceleration__a_brake_emergency__result3))
(assert (not (in_range2 (to_int1 RNA v))))
(check-sat)
(exit)
