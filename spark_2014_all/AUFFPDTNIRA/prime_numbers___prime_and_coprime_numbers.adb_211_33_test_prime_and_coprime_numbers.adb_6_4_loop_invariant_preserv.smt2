...
(assert (=> (= result4 true) (=> (<= index_32 100000) (= temp___255 is_prime5))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= temp___254 index_32))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (and (<= 0 index_32) (<= index_32 100000)))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= o2 index_32))))
(assert (=> (= result4 true) (=> (<= index_32 100000) (= o3 (store is_prime5 o2 (of_int1 0))))))
