...
(assert (forall ((temp___214 Float32)) (=> (dynamic_invariant4 temp___214 true true true true) (forall ((temp___215 Int)) (= (to_rep2 (select (temp___212 temp___214) temp___215)) temp___214)))))
...
(assert (= board1 (temp___212 (fp #b0 #b01111111 #b00000000000000000000000))))
