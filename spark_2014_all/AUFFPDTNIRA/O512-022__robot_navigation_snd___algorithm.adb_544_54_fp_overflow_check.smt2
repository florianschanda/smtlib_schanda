...
(define-fun o14 () us_rep (mk___rep (mk___split_fields o9)))
(define-fun o15 () us_rep (mk___rep (mk___split_fields o8)))
...
(assert (= deltamag2 o7))
(assert (= o15 (create__2 (fp #b0 #b10000000 #b10010010000111111011011))))
(assert (= o14 (oadd (rec__algorithm__laser_scan_data__second (us_split_fields7 (select (rec__algorithm__controller__laserscan (us_split_fields11 this)) i2))) o15)))
(assert (and (= o10 (aldiff (rec__algorithm__controller__driveangle (us_split_fields11 this)) o14)) (and (fp.isFinite32 o10) (and (fp.lt (fp.neg (fp #b0 #b10000000 #b10010010000111111011011)) o10) (fp.leq o10 (fp #b0 #b10000000 #b10010010000111111011011))))))
...
(assert (and (= o12 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag2 deltamag2) deltamag2) deltaangle2)) (fp.isFinite32 (fp.mul RNE (fp.mul RNE (fp.mul RNE deltamag2 deltamag2) deltamag2) deltaangle2))))
