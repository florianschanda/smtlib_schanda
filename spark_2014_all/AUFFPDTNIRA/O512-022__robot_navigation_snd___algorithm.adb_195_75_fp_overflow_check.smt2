...
(assert (and (= o (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2)))) (fp.isFinite32 (fp.mul RNE (fp #b0 #b10000000 #b00000000000000000000000) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields2))))))
(assert (= o1 (fp.mul RNE o (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)))))
(assert (and (= o4 o1) (fp.isFinite32 o1)))
(assert (= o5 (fp.mul RNE o4 o3)))
(assert (and (= o6 o5) (fp.isFinite32 o5)))
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2)) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields2))))))
(check-sat)
(exit)
