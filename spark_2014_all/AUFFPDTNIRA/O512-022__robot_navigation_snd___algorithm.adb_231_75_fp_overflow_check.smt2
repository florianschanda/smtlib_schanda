...
(assert (not (fp.isFinite32 (fp.mul RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields7)) (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields7))))))
(check-sat)
(exit)
