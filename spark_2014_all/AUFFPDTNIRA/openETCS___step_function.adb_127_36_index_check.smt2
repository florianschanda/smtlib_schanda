...
(assert (<= 0 i4))
(assert (<= i4 (to_rep1 (rec__step_function__step_function_t__number_of_delimiters (us_split_fields3 sfun1)))))
(assert (<= 0 j1))
(assert (<= j1 (- im2 1)))
(assert (and (<= 0 j1) (<= j1 10)))
(assert (= o23 j1))
(assert (= o24 (select (rec__step_function__step_function_t__step merge__split_fields3) o23)))
(assert (= o25 (us_split_fields1 o24)))
(assert (= o26 (rec__step_function__delimiter_entry__delimiter o25)))
