...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 a))) (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 b)))) (and (=> (rec__my_rec__x__pred a) (= (to_rep1 (rec__rec__my_rec__x (us_split_fields1 a))) (to_rep1 (rec__rec__my_rec__x (us_split_fields1 b))))) (=> (rec__my_rec__y__pred a) (= (to_rep2 (rec__rec__my_rec__y (us_split_fields1 a))) (to_rep2 (rec__rec__my_rec__y (us_split_fields1 b))))))) true false))
...
(assert (and (= (mk___rep1 (mk___split_discrs1 main__x__assume) (mk___split_fields1 (mk___rep (mk___split_discrs main__x__assume1) (mk___split_fields main__x__assume2 main__x__assume3)))) (build_rec 2)) (= (to_rep main__x__assume) (to_rep3 main__x__assume1))))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___rep (mk___split_discrs x__split_fields) (mk___split_fields x__split_fields1 x__split_fields2))))))
(assert (= x__split_fields3 (mk___split_fields1 (mk___rep (mk___split_discrs main__x__assume1) (mk___split_fields main__x__assume2 main__x__assume3)))))
(assert (= x__split_discrs (mk___split_discrs1 main__x__assume)))
(assert (= (to_rep (rec__rec__sub_rec__z x__split_discrs)) (to_rep3 (rec__rec__my_rec__e (us_split_discrs1 (rec__rec__sub_rec__plop x__split_fields3))))))
(assert (and (= (mk___rep2 (mk___split_discrs2 main__y__assume) (mk___split_fields2 (mk___rep (mk___split_discrs main__y__assume1) (mk___split_fields main__y__assume2 main__y__assume3)))) (build_rec_ok 2)) (dynamic_invariant1 (mk___rep2 (mk___split_discrs2 main__y__assume) (mk___split_fields2 (mk___rep (mk___split_discrs main__y__assume1) (mk___split_fields main__y__assume2 main__y__assume3)))) true false true)))
(assert (= result1 (mk___split_fields__ref2 (mk___split_fields2 (mk___rep (mk___split_discrs y__split_fields) (mk___split_fields y__split_fields1 y__split_fields2))))))
(assert (= y__split_fields3 (mk___split_fields2 (mk___rep (mk___split_discrs main__y__assume1) (mk___split_fields main__y__assume2 main__y__assume3)))))
(assert (= y__split_discrs (mk___split_discrs2 main__y__assume)))
(assert (dynamic_invariant1 (mk___rep2 y__split_discrs y__split_fields3) true false true))
(assert (not true))
(check-sat)
(exit)
