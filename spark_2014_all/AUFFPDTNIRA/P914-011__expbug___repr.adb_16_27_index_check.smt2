...
(assert (= (fp #b0 #b10000000010 #b0100000000000000000000000000000000000000000000000000) limit))
(assert (and (= temp___159 (f Tuple0)) (in_range temp___159)))
(assert (not (<= temp___159 3)))
(check-sat)
(exit)
