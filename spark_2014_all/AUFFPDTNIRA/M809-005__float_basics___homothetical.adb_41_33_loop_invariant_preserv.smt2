...
(assert (and (and (=> (<= 1 2) (in_range2 i2)) (forall ((temp___170 Int)) (=> (and (<= 1 temp___170) (<= temp___170 2)) (=> (<= i2 temp___170) (= (select kvp2 temp___170) (select kvp1 temp___170)))))) (and (<= 1 i2) (<= i2 2))))
