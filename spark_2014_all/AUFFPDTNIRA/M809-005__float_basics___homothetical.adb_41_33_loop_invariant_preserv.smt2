...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 2)) (and (and (not (fp.eq (to_rep (select d j)) (fp #b0 #b00000000 #b00000000000000000000000))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kv j)))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select ka j)))))))
...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kvp2 j))))))
(assert (and (and (=> (<= 1 2) (in_range2 i2)) (forall ((temp___195 Int)) (=> (and (<= 1 temp___195) (<= temp___195 2)) (=> (<= i2 temp___195) (= (select kvp2 temp___195) (select kvp1 temp___195)))))) (and (<= 1 i2) (<= i2 2))))
(assert (and (= o (adjust2triangle (to_rep (select d i2)) (to_rep (select kv i2)) (to_rep (select ka i2)))) (and (fp.isFinite32 o) (and (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) o) (fp.leq o (to_rep (select kv i2)))))))
(assert (= (to_rep o1) o))
...
(assert (<= 1 j))
(assert (<= j (- i3 1)))
(assert (not (fp.lt (fp #b0 #b00000000 #b00000000000000000000000) (to_rep (select kvp3 j)))))
(check-sat)
(exit)
