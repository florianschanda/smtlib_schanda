...
(assert (not (fp.isFinite32 (fp.sub RNE (to_rep (rec__algorithm__laser_scan_data__first rayl__split_fields4)) (to_rep (rec__algorithm__laser_scan_data__first rayr__split_fields4))))))
(check-sat)
(exit)
