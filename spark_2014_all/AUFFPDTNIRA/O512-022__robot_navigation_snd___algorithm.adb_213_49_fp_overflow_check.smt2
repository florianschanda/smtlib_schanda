...
(assert (not (fp.isFinite32 (fp.sub RNE (to_rep4 (rec__algorithm__laser_scan_data__first rayl__split_fields1)) (to_rep4 (rec__algorithm__laser_scan_data__first rayr__split_fields1))))))
(check-sat)
(exit)
