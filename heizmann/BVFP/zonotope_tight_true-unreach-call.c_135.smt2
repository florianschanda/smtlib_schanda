...
(assert (or (and (= |c___VERIFIER_assert_#in~cond| (_ bv0 32)) (exists ((v_prenex_5 (_ FloatingPoint 11 53))) (and (not (fp.leq (fp.add RNE (fp.mul RNE v_prenex_5 v_prenex_5) ((_ to_fp 11 53) RNE 2.0)) ((_ to_fp 11 53) RNE 4.0))) (not (fp.geq (fp.sub RNE (fp.mul RNE v_prenex_5 v_prenex_5) v_prenex_5) ((_ to_fp 11 53) RNE (_ bv0 32)))) (fp.leq v_prenex_5 ((_ to_fp 11 53) RNE 10.0))))) (= (bvadd |c___VERIFIER_assert_#in~cond| (_ bv4294967295 32)) (_ bv0 32))))
(check-sat)
(exit)
