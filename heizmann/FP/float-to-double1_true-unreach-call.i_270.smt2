...
(declare-fun main_~ff~6_const_-825432397 () (_ FloatingPoint 8 24))
(declare-fun |main_#t~short5_const_2135493482| () Bool)
(assert (not (and (exists ((main_~f~6 (_ FloatingPoint 8 24))) (and (= main_~ff~6_const_-825432397 ((_ to_fp 8 24) RNE ((_ to_fp 11 53) RNE main_~f~6))) (fp.isNaN ((_ to_fp 8 24) RNE main_~f~6)))) |main_#t~short5_const_2135493482|)))
(assert (not |main_#t~short5_const_2135493482|))
(assert (not (exists ((v_prenex_1 (_ FloatingPoint 8 24))) (and (= main_~ff~6_const_-825432397 ((_ to_fp 8 24) RNE ((_ to_fp 11 53) RNE v_prenex_1))) (not (fp.isNaN ((_ to_fp 8 24) RNE v_prenex_1)))))))
(check-sat)
(exit)
