...
(declare-fun main_~S~7_const_1125584192 () (_ FloatingPoint 11 53))
(declare-fun main_~E0~7_const_-2102211224 () (_ FloatingPoint 11 53))
(assert (fp.leq main_~E0~7_const_-2102211224 ((_ to_fp 11 53) RNE 1.0)))
(assert (fp.geq main_~E0~7_const_-2102211224 (fp.neg ((_ to_fp 11 53) RNE 1.0))))
(assert (not (exists ((main_~E0~7 (_ FloatingPoint 11 53)) (main_~E1~7 (_ FloatingPoint 11 53))) (and (fp.geq main_~E1~7 (fp.neg ((_ to_fp 11 53) RNE 1.0))) (= main_~S~7_const_1125584192 (fp.sub RNE (fp.add RNE (fp.mul RNE ((_ to_fp 11 53) RNE 0.999) ((_ to_fp 11 53) RNE (_ bv0 32))) main_~E0~7) main_~E1~7)) (fp.geq main_~E0~7 (fp.neg ((_ to_fp 11 53) RNE 1.0))) (fp.leq main_~E0~7 ((_ to_fp 11 53) RNE 1.0)) (fp.leq main_~E1~7 ((_ to_fp 11 53) RNE 1.0))))))
(check-sat)
(exit)
