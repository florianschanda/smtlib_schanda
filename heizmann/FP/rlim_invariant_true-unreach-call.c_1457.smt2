...
(assert (and (fp.geq c_main_~D~6 (_ +zero 8 24)) (fp.leq c_main_~D~6 ((_ to_fp 8 24) RNE 16.0)) (= ((_ to_fp 8 24) RNE (_ bv0 32)) c_main_~S~6)))
(assert (not (and (exists ((main_~D~6 (_ FloatingPoint 8 24)) (v_prenex_3 (_ FloatingPoint 8 24))) (and (= c_main_~Y~6 (fp.sub RNE (fp.add RNE ((_ to_fp 8 24) RNE (_ bv0 32)) v_prenex_3) main_~D~6)) (fp.geq main_~D~6 (_ +zero 8 24)) (fp.leq v_prenex_3 ((_ to_fp 8 24) RNE 16.0)) (fp.leq main_~D~6 ((_ to_fp 8 24) RNE 16.0)) (fp.geq v_prenex_3 (_ +zero 8 24)))) (exists ((v_prenex_3 (_ FloatingPoint 8 24))) (and (fp.leq v_prenex_3 ((_ to_fp 8 24) RNE 16.0)) (= c_main_~S~6 (fp.add RNE ((_ to_fp 8 24) RNE (_ bv0 32)) v_prenex_3)) (fp.geq v_prenex_3 (_ +zero 8 24)))) (fp.geq c_main_~D~6 (_ +zero 8 24)) (fp.leq c_main_~D~6 ((_ to_fp 8 24) RNE 16.0)))))
(check-sat)
(exit)
