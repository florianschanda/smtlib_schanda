...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:35:05+01:00 from revision 2796, file edge-cases.cpp (60bd30e63af58eacb9e259778fcbc5857834a6b2a936e7ca184971dedc36326c93ea4a98426232ff16acfdd80db4b14bb033fab703de4fd0797cb440d6ff328d  edge-cases.cpp), benchmark sign_of_zero_matters_4_sat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function sign_of_zero_matters_4_sat --round-to-minus-inf edge-cases.cpp")
(set-logic QF_ABVFP)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; find_symbols
(declare-fun |nondet_symex::nondet1| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::g@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet1|)

; set_to true (equal)
(define-fun |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::eq@1#2| () Bool (fp.eq |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::f@1#1| |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::g@1#1|))

; set_to true (equal)
(define-fun |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::recipf@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven (fp #b0 #b01111111 #b00000000000000000000000) |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::f@1#1|))

; set_to true (equal)
(define-fun |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::recipg@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven (fp #b0 #b01111111 #b00000000000000000000000) |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::g@1#1|))

; set_to true (equal)
(define-fun |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::req@1#2| () Bool (fp.eq |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::recipf@1#2| |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::recipg@1#2|))

; set_to false
(assert (not (= |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::eq@1#2| |sign_of_zero_matters_4_sat::sign_of_zero_matters_4_sat(float,float)::1::req@1#2|)))
