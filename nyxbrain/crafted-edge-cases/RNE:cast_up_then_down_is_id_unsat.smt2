...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:35:45+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark cast_up_then_down_is_id_unsat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function cast_up_then_down_is_id_unsat --round-to-nearest rewrite-rules.cpp")
(set-logic QF_ABVFP)
(set-info :status unsat)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; set_to true (equal)
(define-fun |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::1::d@1#2| () (_ FloatingPoint 11 53) ((_ to_fp 11 53) roundNearestTiesToEven |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::f@1#1|))

; set_to true (equal)
(define-fun |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::1::g@1#2| () (_ FloatingPoint 8 24) ((_ to_fp 8 24) roundNearestTiesToEven |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::1::d@1#2|))

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::f@1#1|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::1::g@1#2|)
...
; set_to true (equal)
(define-fun |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::1::res@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |cast_up_then_down_is_id_unsat::cast_up_then_down_is_id_unsat(float)::1::res@1#2|))
