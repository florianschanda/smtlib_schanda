(set-info :source "Generated by Martin Brain on 2017-07-10 15:37:09+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark divide_is_almost_multiply_by_reciprocal_sat using cbmc revision 6561 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function divide_is_almost_multiply_by_reciprocal_sat --round-to-zero rewrite-rules.cpp")
(set-logic QF_ABVFP)
(set-info :status sat)
; SMT 2
