...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; find_symbols
(declare-fun |nondet_symex::nondet1| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::g@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet1|)

; set_to true (equal)
(define-fun |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::fpos@1#2| () Bool (fp.gt |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::f@1#1| (fp #b0 #b00000000 #b00000000000000000000000)))

; set_to true (equal)
(define-fun |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::gpos@1#2| () Bool (and (fp.leq |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::g@1#1| (fp #b0 #b01111111 #b11111111111111111111111)) (fp.geq |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::g@1#1| (fp #b0 #b00000000 #b00000000000000000000000))))

; set_to true (equal)
(define-fun |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::div@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::f@1#1| |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::g@1#1|))

; set_to true (equal)
(define-fun |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::divpos@1#2| () Bool (fp.gt |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::div@1#2| (fp #b0 #b00000000 #b00000000000000000000000)))

; set_to true
(assert (= |goto_symex::&92;guard#1| (not (or (not |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::fpos@1#2|) (not |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::gpos@1#2|)))))

; set_to false
(assert (not (=> |goto_symex::&92;guard#1| |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::divpos@1#2|)))

; convert
(define-fun |B1| () Bool (or (not |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::fpos@1#2|) (not |divide_underflow_4_sat::divide_underflow_4_sat(float,float)::1::gpos@1#2|)))
