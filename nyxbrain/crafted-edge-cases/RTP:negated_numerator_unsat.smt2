(set-info :source "Generated by Martin Brain on 2016-04-03 18:34:23+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark negated_numerator_unsat using cbmc revision  command /home/martin/working-copies/cbmc-trunk/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function negated_numerator_unsat --round-to-plus-inf rewrite-rules.cpp")
(set-logic QF_ABVFP)
; SMT 2
...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:36:20+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark negated_numerator_unsat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function negated_numerator_unsat --round-to-plus-inf rewrite-rules.cpp")
(set-logic QF_ABVFP)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |negated_numerator_unsat::negated_numerator_unsat(float,float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; find_symbols
(declare-fun |nondet_symex::nondet1| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |negated_numerator_unsat::negated_numerator_unsat(float,float)::g@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet1|)

; set_to true (equal)
(define-fun |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::neg@1#2| () (_ FloatingPoint 8 24) (fp.neg |negated_numerator_unsat::negated_numerator_unsat(float,float)::f@1#1|))

; set_to true (equal)
(define-fun |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::divn@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::neg@1#2| |negated_numerator_unsat::negated_numerator_unsat(float,float)::g@1#1|))

; set_to true (equal)
(define-fun |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::div@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven |negated_numerator_unsat::negated_numerator_unsat(float,float)::f@1#1| |negated_numerator_unsat::negated_numerator_unsat(float,float)::g@1#1|))

; set_to true (equal)
(define-fun |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::ndiv@1#2| () (_ FloatingPoint 8 24) (fp.neg |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::div@1#2|))

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::divn@1#2|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::ndiv@1#2|)
...
; set_to true (equal)
(define-fun |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::eq@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |negated_numerator_unsat::negated_numerator_unsat(float,float)::1::eq@1#2|))
