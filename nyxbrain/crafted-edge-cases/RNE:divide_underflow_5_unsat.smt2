...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:35:17+01:00 from revision 2796, file edge-cases.cpp (60bd30e63af58eacb9e259778fcbc5857834a6b2a936e7ca184971dedc36326c93ea4a98426232ff16acfdd80db4b14bb033fab703de4fd0797cb440d6ff328d  edge-cases.cpp), benchmark divide_underflow_5_unsat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function divide_underflow_5_unsat --round-to-nearest edge-cases.cpp")
(set-logic QF_ABVFP)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; find_symbols
(declare-fun |nondet_symex::nondet1| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::g@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet1|)

; set_to true (equal)
(define-fun |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::fpos@1#2| () Bool (fp.gt |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::f@1#1| (fp #b0 #b00000000 #b00000000000000000000000)))

; set_to true (equal)
(define-fun |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::gpos@1#2| () Bool (and (fp.leq |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::g@1#1| (fp #b0 #b01111110 #b11111111111111111111111)) (fp.geq |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::g@1#1| (fp #b0 #b00000000 #b00000000000000000000000))))

; set_to true (equal)
(define-fun |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::div@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::f@1#1| |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::g@1#1|))

; set_to true (equal)
(define-fun |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::divpos@1#2| () Bool (fp.gt |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::div@1#2| (fp #b0 #b00000000 #b00000000000000000000000)))

; set_to true
(assert (= |goto_symex::&92;guard#1| (not (or (not |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::fpos@1#2|) (not |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::gpos@1#2|)))))

; set_to false
(assert (not (=> |goto_symex::&92;guard#1| |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::divpos@1#2|)))

; convert
(define-fun |B1| () Bool (or (not |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::fpos@1#2|) (not |divide_underflow_5_unsat::divide_underflow_5_unsat(float,float)::1::gpos@1#2|)))
