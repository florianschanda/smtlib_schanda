...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:36:02+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark multiplication_by_three_fma_unsat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function multiplication_by_three_fma_unsat --round-to-minus-inf rewrite-rules.cpp")
(set-logic QF_ABVFP)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; set_to true (equal)
(define-fun |smtlib_fma::smtlib_fma(float,float,float)::f@1#1| () (_ FloatingPoint 8 24) |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::f@1#1|)

; set_to true (equal)
(define-fun |smtlib_fma::smtlib_fma(float,float,float)::h@1#1| () (_ FloatingPoint 8 24) |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::f@1#1|)
...
; set_to true (equal)
(define-fun |smtlib_fma(float,float,float)::$tmp::return_value___CPROVER_uninterpreted_smt_escape_float_fma$1!0@1#2| () (_ FloatingPoint 8 24) ( fp.fma RNE |smtlib_fma::smtlib_fma(float,float,float)::f@1#1| (fp #b0 #b10000000 #b00000000000000000000000) |smtlib_fma::smtlib_fma(float,float,float)::h@1#1| ) )
...
; set_to true (equal)
(define-fun |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::1::fma@1#2| () (_ FloatingPoint 8 24) |smtlib_fma(float,float,float)#return_value!0#1|)

; set_to true (equal)
(define-fun |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::1::mult@1#2| () (_ FloatingPoint 8 24) (fp.mul roundNearestTiesToEven (fp #b0 #b10000000 #b10000000000000000000000) |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::f@1#1|))

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::1::fma@1#2|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::1::mult@1#2|)
...
; set_to true (equal)
(define-fun |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::1::eq@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |multiplication_by_three_fma_unsat::multiplication_by_three_fma_unsat(float)::1::eq@1#2|))
