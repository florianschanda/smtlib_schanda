...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:36:18+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark reciprocal_does_not_simplify_1_sat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function reciprocal_does_not_simplify_1_sat --round-to-nearest rewrite-rules.cpp")
(set-logic QF_ABVFP)
(set-info :status sat)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; set_to true (equal)
(define-fun |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::1::recip@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven (fp #b0 #b01111111 #b00000000000000000000000) |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::f@1#1|))

; set_to true (equal)
(define-fun |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::1::reciprecip@1#2| () (_ FloatingPoint 8 24) (fp.div roundNearestTiesToEven (fp #b0 #b01111111 #b00000000000000000000000) |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::1::recip@1#2|))

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::f@1#1|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::1::reciprecip@1#2|)
...
; set_to true (equal)
(define-fun |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::1::eq@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |reciprocal_does_not_simplify_1_sat::reciprocal_does_not_simplify_1_sat(float)::1::eq@1#2|))
