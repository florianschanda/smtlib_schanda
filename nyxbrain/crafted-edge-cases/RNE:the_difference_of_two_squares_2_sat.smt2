...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:34:55+01:00 from revision 2796, file edge-cases.cpp (60bd30e63af58eacb9e259778fcbc5857834a6b2a936e7ca184971dedc36326c93ea4a98426232ff16acfdd80db4b14bb033fab703de4fd0797cb440d6ff328d  edge-cases.cpp), benchmark the_difference_of_two_squares_2_sat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function the_difference_of_two_squares_2_sat --round-to-nearest edge-cases.cpp")
(set-logic QF_ABVFP)
(set-info :status sat)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; find_symbols
(declare-fun |nondet_symex::nondet1| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::g@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet1|)

; set_to true (equal)
(define-fun |multiplyOut::multiplyOut(float,float)::f@1#1| () (_ FloatingPoint 8 24) |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::f@1#1|)

; set_to true (equal)
(define-fun |multiplyOut::multiplyOut(float,float)::g@1#1| () (_ FloatingPoint 8 24) |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::g@1#1|)
...
; set_to true (equal)
(define-fun |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::1::one@1#2| () (_ FloatingPoint 8 24) |multiplyOut(float,float)#return_value!0#1|)

; set_to true (equal)
(define-fun |fmaLeft::fmaLeft(float,float)::f@1#1| () (_ FloatingPoint 8 24) |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::f@1#1|)

; set_to true (equal)
(define-fun |fmaLeft::fmaLeft(float,float)::g@1#1| () (_ FloatingPoint 8 24) |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::g@1#1|)
...
; set_to true (equal)
(define-fun |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::1::two@1#2| () (_ FloatingPoint 8 24) |fmaLeft(float,float)#return_value!0#1|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::1::one@1#2|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::1::two@1#2|)
...
; set_to true (equal)
(define-fun |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::1::res@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |the_difference_of_two_squares_2_sat::the_difference_of_two_squares_2_sat(float,float)::1::res@1#2|))
