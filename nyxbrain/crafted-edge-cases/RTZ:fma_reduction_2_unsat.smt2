...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; find_symbols
(declare-fun |nondet_symex::nondet1| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::g@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet1|)

; set_to true (equal)
(define-fun |smtlib_fma::smtlib_fma(float,float,float)::f@1#1| () (_ FloatingPoint 8 24) |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::f@1#1|)

; set_to true (equal)
(define-fun |smtlib_fma::smtlib_fma(float,float,float)::h@1#1| () (_ FloatingPoint 8 24) |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::g@1#1|)
...
; set_to true (equal)
(define-fun |smtlib_fma(float,float,float)::$tmp::return_value___CPROVER_uninterpreted_smt_escape_float_fma$1!0@1#2| () (_ FloatingPoint 8 24) ( fp.fma RNE |smtlib_fma::smtlib_fma(float,float,float)::f@1#1| (fp #b1 #b01111111 #b00000000000000000000000) |smtlib_fma::smtlib_fma(float,float,float)::h@1#1| ) )
...
; set_to true (equal)
(define-fun |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::1::fma@1#2| () (_ FloatingPoint 8 24) |smtlib_fma(float,float,float)#return_value!0#1|)

; set_to true (equal)
(define-fun |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::1::sum@1#2| () (_ FloatingPoint 8 24) (fp.sub roundNearestTiesToEven |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::g@1#1| |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::f@1#1|))

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::1::fma@1#2|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::1::sum@1#2|)
...
; set_to true (equal)
(define-fun |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::1::eq@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |fma_reduction_2_unsat::fma_reduction_2_unsat(float,float)::1::eq@1#2|))
