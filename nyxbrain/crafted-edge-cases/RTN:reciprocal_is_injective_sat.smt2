(set-info :source "Generated by Martin Brain on 2016-04-03 18:34:21+01:00 from revision 2796, file edge-cases.cpp (60bd30e63af58eacb9e259778fcbc5857834a6b2a936e7ca184971dedc36326c93ea4a98426232ff16acfdd80db4b14bb033fab703de4fd0797cb440d6ff328d  edge-cases.cpp), benchmark reciprocal_is_injective_sat using cbmc revision  command /home/martin/working-copies/cbmc-trunk/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function reciprocal_is_injective_sat --round-to-minus-inf edge-cases.cpp")
(set-logic QF_ABVFP)
(set-info :status sat)
; SMT 2
...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:35:29+01:00 from revision 2796, file edge-cases.cpp (60bd30e63af58eacb9e259778fcbc5857834a6b2a936e7ca184971dedc36326c93ea4a98426232ff16acfdd80db4b14bb033fab703de4fd0797cb440d6ff328d  edge-cases.cpp), benchmark reciprocal_is_injective_sat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function reciprocal_is_injective_sat --round-to-minus-inf edge-cases.cpp")
(set-logic QF_ABVFP)
(set-info :status sat)
; SMT 2
