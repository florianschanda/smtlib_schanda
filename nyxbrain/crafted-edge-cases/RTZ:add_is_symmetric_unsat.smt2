...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:35:31+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark add_is_symmetric_unsat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function add_is_symmetric_unsat --round-to-zero rewrite-rules.cpp")
(set-logic QF_ABVFP)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; find_symbols
(declare-fun |nondet_symex::nondet1| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::g@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet1|)

; set_to true (equal)
(define-fun |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::1::fg@1#2| () (_ FloatingPoint 8 24) (fp.add roundNearestTiesToEven |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::f@1#1| |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::g@1#1|))

; set_to true (equal)
(define-fun |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::1::gf@1#2| () (_ FloatingPoint 8 24) (fp.add roundNearestTiesToEven |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::g@1#1| |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::f@1#1|))

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::1::fg@1#2|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::1::gf@1#2|)
...
; set_to true (equal)
(define-fun |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::1::res@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |add_is_symmetric_unsat::add_is_symmetric_unsat(float,float)::1::res@1#2|))
