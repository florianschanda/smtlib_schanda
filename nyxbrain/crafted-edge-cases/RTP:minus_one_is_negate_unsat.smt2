...
(exit)
; end of SMT2 file
(set-info :source "Generated by Martin Brain on 2016-04-03 18:35:58+01:00 from revision 2796, file rewrite-rules.cpp (c0b2da853d54cfbdc1ad49f73403e801f6652730d16a6ccd9157a6ef5270fecae2404a0241f938fc6f82c2882bcbe5c51c876f4fa19baeeceee8687cc549c740  rewrite-rules.cpp), benchmark minus_one_is_negate_unsat using cbmc revision 6525 command /home/martin/working-copies/cbmc-subversion/src/cbmc//cbmc --slice-formula --smt2 --fpa --outfile tmp.smt2 --function minus_one_is_negate_unsat --round-to-plus-inf rewrite-rules.cpp")
(set-logic QF_ABVFP)
; SMT 2
...
(declare-fun |nondet_symex::nondet0| () (_ FloatingPoint 8 24))
; set_to true (equal)
(define-fun |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::f@1#1| () (_ FloatingPoint 8 24) |nondet_symex::nondet0|)

; set_to true (equal)
(define-fun |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::1::fn1@1#2| () (_ FloatingPoint 8 24) (fp.mul roundNearestTiesToEven |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::f@1#1| (fp #b1 #b01111111 #b00000000000000000000000)))

; set_to true (equal)
(define-fun |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::1::fneg@1#2| () (_ FloatingPoint 8 24) (fp.neg |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::f@1#1|))

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::f@1#1| () (_ FloatingPoint 8 24) |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::1::fn1@1#2|)

; set_to true (equal)
(define-fun |smtlib_equal::smtlib_equal(float,float)::g@1#1| () (_ FloatingPoint 8 24) |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::1::fneg@1#2|)
...
; set_to true (equal)
(define-fun |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::1::eq@1#2| () Bool |smtlib_equal(float,float)#return_value!0#1|)

; set_to false
(assert (not |minus_one_is_negate_unsat::minus_one_is_negate_unsat(float)::1::eq@1#2|))
