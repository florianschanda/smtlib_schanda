...
(assert (= x ((_ to_fp 8 24) #x923F316B)))
;; x should be Float32(0x923F316B [Rational(-12530027, 20769187434139310514121985316880384), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xD23F316B)))
(check-sat)
(exit)
