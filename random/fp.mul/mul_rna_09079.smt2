...
(assert (= x (fp #b1 #b00000000 #b10101011001111110001010)))
;; x should be Float32(0x80559F8A [Rational(-2805701, 356811923176489970264571492362373784095686656), -0.000000])
