...
(assert (= y (fp #b1 #b00000000 #b00101010000011010100100)))
;; y should be Float32(0x801506A4 [Rational(-344489, 178405961588244985132285746181186892047843328), -0.000000])
