...
(assert (= y ((_ to_fp 8 24) #xCAF82E9D)))
;; y should be Float32(0xCAF82E9D [Rational(-16264861, 2), -8132430.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (= result (fp #b0 #b00000000 #b11111000001011101001110)))
(check-sat)
(exit)
