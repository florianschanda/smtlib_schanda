...
(assert (= y (fp #b0 #b10010101 #b00111000110111000101011)))
;; y should be Float32(0x4A9C6E2B [Rational(10251819, 2), 5125909.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (not (= result ((_ to_fp 8 24) #x804E3716))))
(check-sat)
(exit)
