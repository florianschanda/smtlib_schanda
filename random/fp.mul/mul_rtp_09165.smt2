...
(assert (= x (fp #b0 #b10010101 #b01010100101110011110101)))
;; x should be Float32(0x4AAA5CF5 [Rational(11164917, 2), 5582458.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BAA5CF4)))
(check-sat)
(exit)
