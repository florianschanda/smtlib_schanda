...
(assert (= x (fp #b1 #b00000000 #b01101111000011100111110)))
;; x should be Float32(0x8037873E [Rational(-1819551, 356811923176489970264571492362373784095686656), -0.000000])
