...
(assert (= x (fp #b1 #b00000000 #b10001010111000100010101)))
;; x should be Float32(0x80457115 [Rational(-4550933, 713623846352979940529142984724747568191373312), -0.000000])
