...
(assert (= y ((_ to_fp 8 24) #x004AC3D5)))
;; y should be Float32(0x004AC3D5 [Rational(4899797, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (= result ((_ to_fp 8 24) #x401587A9)))
(check-sat)
(exit)
