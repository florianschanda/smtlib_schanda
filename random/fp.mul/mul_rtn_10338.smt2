...
(assert (= x ((_ to_fp 8 24) #x981D40B9)))
;; x should be Float32(0x981D40B9 [Rational(-10305721, 5070602400912917605986812821504), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x581D40B8)))
(check-sat)
(exit)
