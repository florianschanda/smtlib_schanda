...
(assert (= y ((_ to_fp 8 24) #x0043F05F)))
;; y should be Float32(0x0043F05F [Rational(4452447, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (= result (fp #b1 #b10000000 #b00001111110000010111101)))
(check-sat)
(exit)
