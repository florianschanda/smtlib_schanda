...
(assert (= y (fp #b0 #b00000000 #b11000010010110101001111)))
;; y should be Float32(0x00612D4F [Rational(6368591, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #xC0425A9D))))
(check-sat)
(exit)
