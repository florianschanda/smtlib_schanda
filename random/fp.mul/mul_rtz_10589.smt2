...
(assert (= y (fp #b1 #b00000000 #b00010000110000000110001)))
;; y should be Float32(0x80086031 [Rational(-548913, 713623846352979940529142984724747568191373312), -0.000000])
