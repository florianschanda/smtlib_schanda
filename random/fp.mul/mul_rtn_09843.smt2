...
(assert (= x (fp #b0 #b10010101 #b11111101000001000011111)))
;; x should be Float32(0x4AFE821F [Rational(16679455, 2), 8339727.500000])
...
(assert (= result ((_ to_fp 8 24) #x807F4110)))
(check-sat)
(exit)
