...
(assert (= x ((_ to_fp 8 24) #x4A8184BB)))
;; x should be Float32(0x4A8184BB [Rational(8488123, 2), 4244061.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00000011000010010111010))))
(check-sat)
(exit)
