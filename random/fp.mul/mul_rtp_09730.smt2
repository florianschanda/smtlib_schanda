...
(assert (= x (fp #b1 #b00000000 #b11000101101100010000001)))
;; x should be Float32(0x8062D881 [Rational(-6477953, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4045B102)))
(check-sat)
(exit)
