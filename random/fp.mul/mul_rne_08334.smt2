...
(assert (= y (fp #b0 #b10010101 #b10001011101101101101001)))
;; y should be Float32(0x4AC5DB69 [Rational(12966761, 2), 6483380.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x8062EDB4))))
(check-sat)
(exit)
