...
(assert (= x ((_ to_fp 8 24) #x149BE57F)))
;; x should be Float32(0x149BE57F [Rational(10216831, 649037107316853453566312041152512), 0.000000])
...
(assert (not (= result (fp #b1 #b10101001 #b00110111110010101111110))))
(check-sat)
(exit)
