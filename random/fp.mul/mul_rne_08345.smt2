...
(assert (= y (fp #b0 #b00000000 #b01011000111001000100100)))
;; y should be Float32(0x002C7224 [Rational(728201, 178405961588244985132285746181186892047843328), 0.000000])
