...
(assert (= y (fp #b1 #b00000000 #b00100111000001100011011)))
;; y should be Float32(0x8013831B [Rational(-1278747, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result ((_ to_fp 8 24) #x3F1C18D7)))
(check-sat)
(exit)
