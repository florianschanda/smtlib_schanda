...
(assert (= y ((_ to_fp 8 24) #xC987405C)))
;; y should be Float32(0xC987405C [Rational(-2215959, 2), -1107979.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (not (= result (fp #b0 #b00010101 #b00001110100000001011100))))
(check-sat)
(exit)
