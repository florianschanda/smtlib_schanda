...
(assert (= x (fp #b0 #b10010011 #b11100101010111011000100)))
;; x should be Float32(0x49F2AEC4 [Rational(3976113, 2), 1988056.500000])
...
(assert (= result (fp #b0 #b00010101 #b11100101010111011000010)))
(check-sat)
(exit)
