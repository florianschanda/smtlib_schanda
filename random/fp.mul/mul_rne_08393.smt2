...
(assert (= x ((_ to_fp 8 24) #xD84F8B5B)))
;; x should be Float32(0xD84F8B5B [Rational(-912789736521728), -912789736521728.000000])
...
(assert (= result (fp #b0 #b00110010 #b10011111000101101011011)))
(check-sat)
(exit)
