...
(assert (= x ((_ to_fp 8 24) #x49B9587C)))
;; x should be Float32(0x49B9587C [Rational(3036703, 2), 1518351.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b01110010101100001111011))))
(check-sat)
(exit)
