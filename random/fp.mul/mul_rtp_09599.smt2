...
(assert (= y ((_ to_fp 8 24) #xDAFB3164)))
;; y should be Float32(0xDAFB3164 [Rational(-35352262360432640), -35352262360432640.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x1BFB3163))))
(check-sat)
(exit)
