...
(assert (= y (fp #b0 #b10010101 #b11010111010100101111011)))
;; y should be Float32(0x4AEBA97B [Rational(15444347, 2), 7722173.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result ((_ to_fp 8 24) #x0BEBA979)))
(check-sat)
(exit)
