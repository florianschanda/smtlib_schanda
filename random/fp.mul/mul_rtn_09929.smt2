...
(assert (= y (fp #b1 #b10010101 #b10100100011000010100001)))
;; y should be Float32(0xCAD230A1 [Rational(-13775009, 2), -6887504.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (= result ((_ to_fp 8 24) #x8BD230A0)))
(check-sat)
(exit)
