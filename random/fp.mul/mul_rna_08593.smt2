...
(assert (= y ((_ to_fp 8 24) #x1405BC26)))
;; y should be Float32(0x1405BC26 [Rational(4382227, 649037107316853453566312041152512), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result ((_ to_fp 8 24) #x5405BC25)))
(check-sat)
(exit)
