...
(assert (= y (fp #b0 #b10010101 #b01000011010011111100011)))
;; y should be Float32(0x4AA1A7E3 [Rational(10594275, 2), 5297137.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x0050D3F2))))
(check-sat)
(exit)
