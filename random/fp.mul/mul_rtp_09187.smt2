...
(assert (= x ((_ to_fp 8 24) #x4AB8F337)))
;; x should be Float32(0x4AB8F337 [Rational(12120887, 2), 6060443.500000])
...
(assert (= result (fp #b1 #b00000000 #b10111000111100110011011)))
(check-sat)
(exit)
