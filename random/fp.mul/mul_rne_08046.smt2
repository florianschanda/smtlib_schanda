...
(assert (= y (fp #b0 #b00000000 #b01000011100101101101100)))
;; y should be Float32(0x0021CB6C [Rational(553691, 178405961588244985132285746181186892047843328), 0.000000])
