...
(assert (= x (fp #b0 #b00000000 #b10011100100110101100010)))
;; x should be Float32(0x004E4D62 [Rational(2565809, 356811923176489970264571492362373784095686656), 0.000000])
