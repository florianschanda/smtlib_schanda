...
(assert (= y (fp #b1 #b10010101 #b00111011011001000111011)))
;; y should be Float32(0xCA9DB23B [Rational(-10334779, 2), -5167389.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (= result ((_ to_fp 8 24) #x0B9DB23A)))
(check-sat)
(exit)
