...
(assert (= x (fp #b0 #b00000000 #b00010111011001110001111)))
;; x should be Float32(0x000BB38F [Rational(766863, 713623846352979940529142984724747568191373312), 0.000000])
