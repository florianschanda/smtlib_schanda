...
(assert (= x (fp #b1 #b01111101 #b01000110110100000011010)))
;; x should be Float32(0xBEA3681A [Rational(-5354509, 16777216), -0.319154])
...
(assert (not (= result ((_ to_fp 8 24) #x0028DA07))))
(check-sat)
(exit)
