...
(assert (= y (fp #b0 #b10010101 #b10011001011011000101101)))
;; y should be Float32(0x4ACCB62D [Rational(13415981, 2), 6707990.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result (fp #b0 #b00010111 #b10011001011011000101011))))
(check-sat)
(exit)
