...
(assert (= y (fp #b1 #b10011101 #b11101110011000000001001)))
;; y should be Float32(0xCEF73009 [Rational(-2073560192), -2073560192.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (not (= result ((_ to_fp 8 24) #x84773009))))
(check-sat)
(exit)
