...
(assert (= y (fp #b1 #b00000000 #b11100001001000111111110)))
;; y should be Float32(0x807091FE [Rational(-3688703, 356811923176489970264571492362373784095686656), -0.000000])
