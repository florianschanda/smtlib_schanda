...
(assert (= y (fp #b1 #b00000000 #b00001101000110001110010)))
;; y should be Float32(0x80068C72 [Rational(-214585, 356811923176489970264571492362373784095686656), -0.000000])
