...
(assert (= x ((_ to_fp 8 24) #x49776378)))
;; x should be Float32(0x49776378 [Rational(2026607, 2), 1013303.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b11101110110001101110110))))
(check-sat)
(exit)
