...
(assert (= x (fp #b0 #b10010101 #b00110101110011101100111)))
;; x should be Float32(0x4A9AE767 [Rational(10151783, 2), 5075891.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B9AE766))))
(check-sat)
(exit)
