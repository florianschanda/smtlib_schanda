...
(assert (= x (fp #b1 #b00000000 #b11111111110010100011011)))
;; x should be Float32(0x807FE51B [Rational(-8381723, 713623846352979940529142984724747568191373312), -0.000000])
