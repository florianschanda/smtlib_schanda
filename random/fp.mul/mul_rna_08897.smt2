...
(assert (= y ((_ to_fp 8 24) #x006C35C4)))
;; y should be Float32(0x006C35C4 [Rational(1772913, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result ((_ to_fp 8 24) #xC0586B87)))
(check-sat)
(exit)
