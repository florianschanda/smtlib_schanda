...
(assert (= y ((_ to_fp 8 24) #xCAEEBBF9)))
;; y should be Float32(0xCAEEBBF9 [Rational(-15645689, 2), -7822844.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (= result (fp #b0 #b00010111 #b11011101011101111110111)))
(check-sat)
(exit)
