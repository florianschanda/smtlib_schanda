...
(assert (= y ((_ to_fp 8 24) #xCAEF879D)))
;; y should be Float32(0xCAEF879D [Rational(-15697821, 2), -7848910.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (= result (fp #b1 #b00010111 #b11011111000011110011011)))
(check-sat)
(exit)
