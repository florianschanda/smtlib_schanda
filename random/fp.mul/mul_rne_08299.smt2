...
(assert (= y (fp #b1 #b00000000 #b11010001011111111001010)))
;; y should be Float32(0x8068BFCA [Rational(-3432421, 356811923176489970264571492362373784095686656), -0.000000])
