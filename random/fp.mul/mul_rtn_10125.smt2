...
(assert (= x ((_ to_fp 8 24) #xC951F3F8)))
;; x should be Float32(0xC951F3F8 [Rational(-1719935, 2), -859967.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b10100011111001111110111))))
(check-sat)
(exit)
