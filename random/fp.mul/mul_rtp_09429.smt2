...
(assert (= x (fp #b0 #b00000000 #b01101111100110101111101)))
;; x should be Float32(0x0037CD7D [Rational(3657085, 713623846352979940529142984724747568191373312), 0.000000])
