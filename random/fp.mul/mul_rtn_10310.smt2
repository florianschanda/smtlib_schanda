...
(assert (= y (fp #b1 #b00000000 #b10100110000011101111010)))
;; y should be Float32(0x8053077A [Rational(-2720701, 356811923176489970264571492362373784095686656), -0.000000])
