...
(assert (= y ((_ to_fp 8 24) #xE3788772)))
;; y should be Float32(0xE3788772 [Rational(-4584552393622434086912), -4584552393622434086912.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result ((_ to_fp 8 24) #x24788772)))
(check-sat)
(exit)
