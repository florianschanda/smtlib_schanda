...
(assert (= y ((_ to_fp 8 24) #x0007BAE7)))
;; y should be Float32(0x0007BAE7 [Rational(506599, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTN x y)))
(assert (= result ((_ to_fp 8 24) #xBE775CE0)))
(check-sat)
(exit)
