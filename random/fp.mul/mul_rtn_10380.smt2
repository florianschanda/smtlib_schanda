...
(assert (= x (fp #b1 #b00000000 #b10010001000000101010100)))
;; x should be Float32(0x80488154 [Rational(-1187925, 178405961588244985132285746181186892047843328), -0.000000])
