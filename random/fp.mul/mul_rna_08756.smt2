...
(assert (= x (fp #b0 #b00000000 #b10011000011101000001101)))
;; x should be Float32(0x004C3A0D [Rational(4995597, 713623846352979940529142984724747568191373312), 0.000000])
