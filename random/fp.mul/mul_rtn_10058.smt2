...
(assert (= x (fp #b0 #b00000000 #b01101110011100011100111)))
;; x should be Float32(0x003738E7 [Rational(3619047, 713623846352979940529142984724747568191373312), 0.000000])
