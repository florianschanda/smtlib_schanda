...
(assert (= x (fp #b1 #b00000000 #b11100111011111101001011)))
;; x should be Float32(0x8073BF4B [Rational(-7585611, 713623846352979940529142984724747568191373312), -0.000000])
