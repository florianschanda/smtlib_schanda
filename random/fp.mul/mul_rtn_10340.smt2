...
(assert (= x (fp #b1 #b10101111 #b11110110100110010100001)))
;; x should be Float32(0xD7FB4CA1 [Rational(-552613074436096), -552613074436096.000000])
...
(assert (= result ((_ to_fp 8 24) #x18FB4C9F)))
(check-sat)
(exit)
