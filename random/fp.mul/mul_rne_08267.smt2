...
(assert (= y ((_ to_fp 8 24) #x806F23FD)))
;; y should be Float32(0x806F23FD [Rational(-7283709, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x405E47F9))))
(check-sat)
(exit)
