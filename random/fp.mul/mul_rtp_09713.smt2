...
(assert (= x ((_ to_fp 8 24) #x803B8BE3)))
;; x should be Float32(0x803B8BE3 [Rational(-3902435, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBFEE2F8B)))
(check-sat)
(exit)
