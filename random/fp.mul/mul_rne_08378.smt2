...
(assert (= x ((_ to_fp 8 24) #xC0CBE692)))
;; x should be Float32(0xC0CBE692 [Rational(-6681417, 1048576), -6.371896])
...
(assert (not (= result (fp #b1 #b00000000 #b00000000000000000000110))))
(check-sat)
(exit)
