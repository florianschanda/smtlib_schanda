...
(assert (= y (fp #b0 #b00000000 #b11001010110111111101010)))
;; y should be Float32(0x00656FEA [Rational(3323893, 356811923176489970264571492362373784095686656), 0.000000])
