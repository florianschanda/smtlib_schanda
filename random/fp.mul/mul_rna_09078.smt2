...
(assert (= x (fp #b1 #b00000000 #b10100000101101010010001)))
;; x should be Float32(0x80505A91 [Rational(-5266065, 713623846352979940529142984724747568191373312), -0.000000])
