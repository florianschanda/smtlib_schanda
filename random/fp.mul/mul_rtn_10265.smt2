...
(assert (= y (fp #b0 #b00000000 #b11111010011101111001010)))
;; y should be Float32(0x007D3BCA [Rational(4103653, 356811923176489970264571492362373784095686656), 0.000000])
