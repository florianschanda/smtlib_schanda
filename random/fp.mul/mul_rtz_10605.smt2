...
(assert (= y (fp #b0 #b00000000 #b11111010100100000100110)))
;; y should be Float32(0x007D4826 [Rational(4105235, 356811923176489970264571492362373784095686656), 0.000000])
