...
(assert (= y (fp #b0 #b10010100 #b11111111001111111111010)))
;; y should be Float32(0x4A7F9FFA [Rational(8376317, 2), 4188158.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTP x y)))
(assert (not (= result (fp #b1 #b00000000 #b01111111110011111111110))))
(check-sat)
(exit)
