...
(assert (= y (fp #b1 #b00000000 #b01001000111101101100100)))
;; y should be Float32(0x80247B64 [Rational(-597721, 178405961588244985132285746181186892047843328), -0.000000])
