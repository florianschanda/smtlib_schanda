...
(assert (= y (fp #b0 #b10010110 #b10001100000010100100010)))
;; y should be Float32(0x4B460522 [Rational(12977442), 12977442.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result (fp #b1 #b00000001 #b10001100000010100100010)))
(check-sat)
(exit)
