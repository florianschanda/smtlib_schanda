...
(assert (= y ((_ to_fp 8 24) #x10D2CBBB)))
;; y should be Float32(0x10D2CBBB [Rational(13814715, 166153499473114484112975882535043072), 0.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (= result (fp #b1 #b10100001 #b10100101100101110111010)))
(check-sat)
(exit)
