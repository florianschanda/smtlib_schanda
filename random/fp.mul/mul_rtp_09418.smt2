...
(assert (= x (fp #b0 #b00000000 #b11010100010010000101011)))
;; x should be Float32(0x006A242B [Rational(6956075, 713623846352979940529142984724747568191373312), 0.000000])
