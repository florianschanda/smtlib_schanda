...
(assert (= x (fp #b0 #b00000000 #b01011000001011001000001)))
;; x should be Float32(0x002C1641 [Rational(2889281, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFB05903))))
(check-sat)
(exit)
