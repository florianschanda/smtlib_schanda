...
(assert (= y (fp #b1 #b10010101 #b11001101100000001100011)))
;; y should be Float32(0xCAE6C063 [Rational(-15122531, 2), -7561265.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (= result ((_ to_fp 8 24) #x00736032)))
(check-sat)
(exit)
