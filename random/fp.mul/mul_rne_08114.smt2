...
(assert (= x (fp #b0 #b00000000 #b00001100111101010110110)))
;; x should be Float32(0x00067AB6 [Rational(212315, 356811923176489970264571492362373784095686656), 0.000000])
