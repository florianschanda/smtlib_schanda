...
(assert (= x (fp #b0 #b00101111 #b01101111110110010111111)))
;; x should be Float32(0x17B7ECBF [Rational(12053695, 10141204801825835211973625643008), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xD7B7ECBE))))
(check-sat)
(exit)
