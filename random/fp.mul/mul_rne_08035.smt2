...
(assert (= y ((_ to_fp 8 24) #x4AC61FC7)))
;; y should be Float32(0x4AC61FC7 [Rational(12984263, 2), 6492131.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result (fp #b0 #b00000000 #b11000110000111111100100))))
(check-sat)
(exit)
