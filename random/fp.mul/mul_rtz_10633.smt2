...
(assert (= y ((_ to_fp 8 24) #x603BF4BF)))
;; y should be Float32(0x603BF4BF [Rational(54174639944523317248), 54174639944523317248.000000])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (= result (fp #b0 #b00101011 #b01110111111010010111111)))
(check-sat)
(exit)
