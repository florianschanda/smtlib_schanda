...
(assert (= x ((_ to_fp 8 24) #xD291574D)))
;; x should be Float32(0xD291574D [Rational(-312117460992), -312117460992.000000])
...
(assert (not (= result (fp #b1 #b00100111 #b00100010101011101001101))))
(check-sat)
(exit)
