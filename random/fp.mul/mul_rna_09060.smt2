...
(assert (= x (fp #b1 #b00000000 #b11100001001110000000001)))
;; x should be Float32(0x80709C01 [Rational(-7379969, 713623846352979940529142984724747568191373312), -0.000000])
