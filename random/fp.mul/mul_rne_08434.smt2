...
(assert (= x (fp #b1 #b00000000 #b10001000101101000110100)))
;; x should be Float32(0x80445A34 [Rational(-1119885, 178405961588244985132285746181186892047843328), -0.000000])
