...
(assert (= y ((_ to_fp 8 24) #xE361D133)))
;; y should be Float32(0xE361D133 [Rational(-4165591808962388295680), -4165591808962388295680.000000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x98E1D133))))
(check-sat)
(exit)
