...
(assert (= x (fp #b0 #b00000000 #b11011011000101100010010)))
;; x should be Float32(0x006D8B12 [Rational(3589513, 356811923176489970264571492362373784095686656), 0.000000])
