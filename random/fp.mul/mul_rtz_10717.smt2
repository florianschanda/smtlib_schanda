...
(assert (= x ((_ to_fp 8 24) #x001D90F4)))
;; x should be Float32(0x001D90F4 [Rational(484413, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF6C879F))))
(check-sat)
(exit)
