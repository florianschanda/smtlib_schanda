...
(assert (= x (fp #b0 #b00000000 #b10000001110010000000111)))
;; x should be Float32(0x0040E407 [Rational(4252679, 713623846352979940529142984724747568191373312), 0.000000])
