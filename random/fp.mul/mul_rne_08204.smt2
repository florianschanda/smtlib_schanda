...
(assert (= x (fp #b1 #b10010000 #b10110001001010011100000)))
;; x should be Float32(0xC85894E0 [Rational(-443559, 2), -221779.500000])
...
(assert (= result (fp #b0 #b00000000 #b00000110110001001010100)))
(check-sat)
(exit)
