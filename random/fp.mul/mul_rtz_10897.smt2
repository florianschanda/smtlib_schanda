...
(assert (= y (fp #b1 #b00000000 #b00001000010110100110110)))
;; y should be Float32(0x80042D36 [Rational(-136859, 356811923176489970264571492362373784095686656), -0.000000])
