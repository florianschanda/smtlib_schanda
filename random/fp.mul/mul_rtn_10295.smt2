...
(assert (= y (fp #b0 #b00000000 #b00111000010001101110110)))
;; y should be Float32(0x001C2376 [Rational(922043, 356811923176489970264571492362373784095686656), 0.000000])
