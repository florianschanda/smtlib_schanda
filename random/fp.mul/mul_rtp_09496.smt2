...
(assert (= x (fp #b1 #b10010101 #b00011000010011110101101)))
;; x should be Float32(0xCA8C27AD [Rational(-9185197, 2), -4592598.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B8C27AC))))
(check-sat)
(exit)
