...
(assert (= y ((_ to_fp 8 24) #xCA9F2655)))
;; y should be Float32(0xCA9F2655 [Rational(-10430037, 2), -5215018.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNE x y)))
(assert (not (= result (fp #b1 #b00000000 #b10011111001001100101010))))
(check-sat)
(exit)
