...
(assert (= x (fp #b0 #b00000000 #b00100011101000001011110)))
;; x should be Float32(0x0011D05E [Rational(583727, 356811923176489970264571492362373784095686656), 0.000000])
