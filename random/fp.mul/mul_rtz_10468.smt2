...
(assert (= x (fp #b0 #b10010101 #b11001010001101101111001)))
;; x should be Float32(0x4AE51B79 [Rational(15014777, 2), 7507388.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BE51B79)))
(check-sat)
(exit)
