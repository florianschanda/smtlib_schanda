...
(assert (= x ((_ to_fp 8 24) #x8052DC68)))
;; x should be Float32(0x8052DC68 [Rational(-678797, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4025B8CF))))
(check-sat)
(exit)
