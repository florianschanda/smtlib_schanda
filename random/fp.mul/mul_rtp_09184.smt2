...
(assert (= x ((_ to_fp 8 24) #x4AA32F11)))
;; x should be Float32(0x4AA32F11 [Rational(10694417, 2), 5347208.500000])
...
(assert (= result (fp #b1 #b00010111 #b01000110010111100001111)))
(check-sat)
(exit)
