...
(assert (= x (fp #b1 #b10010101 #b11100001010101100001101)))
;; x should be Float32(0xCAF0AB0D [Rational(-15772429, 2), -7886214.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b11100001010101100001011))))
(check-sat)
(exit)
