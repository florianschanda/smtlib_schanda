...
(assert (= y (fp #b0 #b00000000 #b00111100000111011101111)))
;; y should be Float32(0x001E0EEF [Rational(1969903, 713623846352979940529142984724747568191373312), 0.000000])
