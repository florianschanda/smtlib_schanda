...
(assert (= y ((_ to_fp 8 24) #x4AAF340B)))
;; y should be Float32(0x4AAF340B [Rational(11482123, 2), 5741061.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (not (= result (fp #b1 #b00000000 #b10101111001101000000110))))
(check-sat)
(exit)
