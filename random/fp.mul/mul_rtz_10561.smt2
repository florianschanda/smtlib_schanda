...
(assert (= y (fp #b0 #b10010101 #b01000111101111010101001)))
;; y should be Float32(0x4AA3DEA9 [Rational(10739369, 2), 5369684.500000])

(declare-const result Float32)
(assert (= result (fp.mul RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x0BA3DEA7))))
(check-sat)
(exit)
