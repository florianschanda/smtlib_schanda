...
(assert (= x (fp #b0 #b00000000 #b11100000001100110001110)))
;; x should be Float32(0x0070198E [Rational(3673287, 356811923176489970264571492362373784095686656), 0.000000])
