...
(assert (= y ((_ to_fp 8 24) #xCAB152AF)))
;; y should be Float32(0xCAB152AF [Rational(-11621039, 2), -5810519.500000])

(declare-const result Float32)
(assert (= result (fp.mul RNA x y)))
(assert (not (= result (fp #b1 #b00010111 #b01100010101001010101110))))
(check-sat)
(exit)
