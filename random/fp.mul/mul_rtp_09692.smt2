...
(assert (= x ((_ to_fp 8 24) #x95CDDC9B)))
;; x should be Float32(0x95CDDC9B [Rational(-13491355, 162259276829213363391578010288128), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x55CDDC9B))))
(check-sat)
(exit)
