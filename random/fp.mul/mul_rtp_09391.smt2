...
(assert (= x ((_ to_fp 8 24) #x3E9D8BD5)))
;; x should be Float32(0x3E9D8BD5 [Rational(10324949, 33554432), 0.307707])
...
(assert (= result (fp #b1 #b00000000 #b01001110110001011110101)))
(check-sat)
(exit)
