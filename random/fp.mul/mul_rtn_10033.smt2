...
(assert (= x ((_ to_fp 8 24) #x696115C7)))
;; x should be Float32(0x696115C7 [Rational(17006946875718905941196800), 17006946875718905941196800.000000])
...
(assert (= result ((_ to_fp 8 24) #xAA6115C6)))
(check-sat)
(exit)
