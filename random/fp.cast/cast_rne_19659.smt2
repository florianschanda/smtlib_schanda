...
;; y should be Float64(0x415F2A5A20000000 [Rational(16339665, 2), 8169832.500000])

(declare-const z Float64)
(assert (= z (fp #b0 #b10000010101 #b1111001010100101101000100000000000000000000000000000)))
;; z should be y
