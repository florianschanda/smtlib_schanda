...
;; y should be Float64(0x414339EE40000000 [Rational(5040057, 2), 2520028.500000])

(declare-const z Float64)
(assert (= z (fp #b0 #b10000010100 #b0011001110011110111001000000000000000000000000000000)))
;; z should be y
