...
;; y should be Float128(0x3F7FE336800000000000000000000000 [Rational(247405, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const z Float128)
(assert (= z ((_ to_fp 15 113) #x3F7FE336800000000000000000000000)))
;; z should be y
