...
;; y should be Float64(0x37C9297000000000 [Rational(103063, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const z Float64)
(assert (= z (fp #b0 #b01101111100 #b1001001010010111000000000000000000000000000000000000)))
;; z should be y
