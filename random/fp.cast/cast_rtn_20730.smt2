...
;; y should be Float64(0xB80C6267C0000000 [Rational(-7440799, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01110000000 #b1100011000100110011111000000000000000000000000000000)))
;; z should be y
