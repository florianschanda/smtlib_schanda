...
;; y should be Float64(0xC114110200000000 [Rational(-657537, 2), -328768.500000])

(declare-const z Float64)
(assert (= z (fp #b1 #b10000010001 #b0100000100010000001000000000000000000000000000000000)))
;; z should be y
