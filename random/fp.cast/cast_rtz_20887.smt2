...
;; y should be Float128(0x3F7E7032800000000000000000000000 [Rational(188517, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const z Float128)
(assert (= z ((_ to_fp 15 113) #x3F7E7032800000000000000000000000)))
;; z should be y
