...
;; y should be Float64(0xC14976BB40000000 [Rational(-6675181, 2), -3337590.500000])

(declare-const z Float64)
(assert (= z (fp #b1 #b10000010100 #b1001011101101011101101000000000000000000000000000000)))
;; z should be y
