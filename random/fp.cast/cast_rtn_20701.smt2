...
;; y should be Float128(0xBFF1D04A6E0000000000000000000000 [Rational(-15213879, 137438953472), -0.000111])

(declare-const z Float128)
(assert (= z ((_ to_fp 15 113) #xBFF1D04A6E0000000000000000000000)))
;; z should be y
