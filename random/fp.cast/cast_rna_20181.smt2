...
;; y should be Float64(0xB7DDBB7E00000000 [Rational(-974271, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01101111101 #b1101101110110111111000000000000000000000000000000000)))
;; z should be y
