...
;; y should be Float64(0x37B9EC5800000000 [Rational(212363, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float64)
(assert (= z (fp #b0 #b01101111011 #b1001111011000101100000000000000000000000000000000000)))
;; z should be y
