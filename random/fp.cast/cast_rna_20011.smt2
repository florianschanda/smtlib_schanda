...
;; y should be Float128(0x3F9D51A2840000000000000000000000 [Rational(5531809, 1329227995784915872903807060280344576), 0.000000])

(declare-const z Float128)
(assert (= z ((_ to_fp 15 113) #x3F9D51A2840000000000000000000000)))
;; z should be y
