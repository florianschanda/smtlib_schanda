...
;; y should be Float64(0xBDE01E95C0000000 [Rational(-4225623, 36028797018963968), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01111011110 #b0000000111101001010111000000000000000000000000000000)))
;; z should be y
