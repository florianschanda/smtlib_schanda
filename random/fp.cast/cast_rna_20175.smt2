...
;; y should be Float64(0xB806A929C0000000 [Rational(-5940391, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01110000000 #b0110101010010010100111000000000000000000000000000000)))
;; z should be y
