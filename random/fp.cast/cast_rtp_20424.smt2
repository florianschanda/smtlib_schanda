...
;; y should be Float64(0xBC576490C0000000 [Rational(-6132291, 1208925819614629174706176), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01111000101 #b0111011001001001000011000000000000000000000000000000)))
;; z should be y
