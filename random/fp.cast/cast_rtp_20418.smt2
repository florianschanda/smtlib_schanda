...
;; y should be Float64(0xBC3B8B0A60000000 [Rational(-14440531, 9671406556917033397649408), -0.000000])

(declare-const z Float64)
(assert (= z (fp #b1 #b01111000011 #b1011100010110000101001100000000000000000000000000000)))
;; z should be y
