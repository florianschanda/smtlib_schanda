...
;; y should be Float64(0x37F8E9BE80000000 [Rational(3265405, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float64)
(assert (= z (fp #b0 #b01101111111 #b1000111010011011111010000000000000000000000000000000)))
;; z should be y
