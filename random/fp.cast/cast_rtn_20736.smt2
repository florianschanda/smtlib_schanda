...
;; y should be Float64(0xB803546D00000000 [Rational(-1266797, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const z Float64)
(assert (= z ((_ to_fp 11 53) #xB803546D00000000)))
;; z should be y
