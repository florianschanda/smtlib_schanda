...
(assert (= x ((_ to_fp 8 24) #x8057FC44)))
;; x should be Float32(0x8057FC44 [Rational(-1441553, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x8057FC43)))
(check-sat)
(exit)
