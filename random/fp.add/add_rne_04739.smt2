...
(assert (= y ((_ to_fp 8 24) #x802F1E4A)))
;; y should be Float32(0x802F1E4A [Rational(-1543973, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result ((_ to_fp 8 24) #x0050E1B5)))
(check-sat)
(exit)
