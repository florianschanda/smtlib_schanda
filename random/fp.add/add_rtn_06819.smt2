...
(assert (= x ((_ to_fp 8 24) #x00385A25)))
;; x should be Float32(0x00385A25 [Rational(3693093, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x00385A26)))
(check-sat)
(exit)
