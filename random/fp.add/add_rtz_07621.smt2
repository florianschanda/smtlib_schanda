...
(assert (= y (fp #b1 #b00000000 #b00111011100100000000010)))
;; y should be Float32(0x801DC802 [Rational(-975873, 356811923176489970264571492362373784095686656), -0.000000])
