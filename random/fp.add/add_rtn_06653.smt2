...
(assert (= y (fp #b0 #b00000000 #b10111110110100011111110)))
;; y should be Float32(0x005F68FE [Rational(3126399, 356811923176489970264571492362373784095686656), 0.000000])
