...
(assert (= x (fp #b1 #b01011110 #b10001100011011111001011)))
;; x should be Float32(0xAF4637CB [Rational(-12990411, 72057594037927936), -0.000000])
...
(assert (= result (fp #b1 #b01011110 #b10001100011011111001100)))
(check-sat)
(exit)
