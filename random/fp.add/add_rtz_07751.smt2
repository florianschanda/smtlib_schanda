...
(assert (= x (fp #b1 #b01001010 #b00000000000011010011011)))
;; x should be Float32(0xA500069B [Rational(-8390299, 75557863725914323419136), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA500069B))))
(check-sat)
(exit)
