...
(assert (= x (fp #b0 #b11110011 #b00100010111001101001000)))
;; x should be Float32(0x79917348 [Rational(94402653252458871908497829599903744), 94402653252458871908497829599903744.000000])
