...
(assert (= x (fp #b1 #b10010101 #b10110000100100111111111)))
;; x should be Float32(0xCAD849FF [Rational(-14174719, 2), -7087359.500000])
...
(assert (= result ((_ to_fp 8 24) #xCAD849FF)))
(check-sat)
(exit)
