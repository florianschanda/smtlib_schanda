...
(assert (= y ((_ to_fp 8 24) #x4A354E02)))
;; y should be Float32(0x4A354E02 [Rational(5940993, 2), 2970496.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (not (= result (fp #b0 #b10010100 #b01101010100111000000010))))
(check-sat)
(exit)
