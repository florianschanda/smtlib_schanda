...
(assert (= x (fp #b0 #b10010100 #b10001000110101001100110)))
;; x should be Float32(0x4A446A66 [Rational(6436147, 2), 3218073.500000])
...
(assert (not (= result (fp #b0 #b10010100 #b10001000110101001100111))))
(check-sat)
(exit)
