...
(assert (= y ((_ to_fp 8 24) #x4AEEDB43)))
;; y should be Float32(0x4AEEDB43 [Rational(15653699, 2), 7826849.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result (fp #b0 #b10010101 #b11011101101101101000011)))
(check-sat)
(exit)
