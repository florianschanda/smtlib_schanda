...
(assert (= x ((_ to_fp 8 24) #xE537817D)))
;; x should be Float32(0xE537817D [Rational(-54161356471869271703552), -54161356471869271703552.000000])
...
(assert (= result ((_ to_fp 8 24) #xE537817D)))
(check-sat)
(exit)
