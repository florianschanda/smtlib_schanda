...
(assert (= x (fp #b0 #b01010101 #b10100110101010111000110)))
;; x should be Float32(0x2AD355C6 [Rational(6925027, 18446744073709551616), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x2AD355C5)))
(check-sat)
(exit)
