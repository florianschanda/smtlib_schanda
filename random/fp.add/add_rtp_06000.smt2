...
(assert (= y (fp #b0 #b00000000 #b00111000011110101110010)))
;; y should be Float32(0x001C3D72 [Rational(925369, 356811923176489970264571492362373784095686656), 0.000000])
