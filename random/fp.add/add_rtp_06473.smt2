...
(assert (= x ((_ to_fp 8 24) #x807B14D0)))
;; x should be Float32(0x807B14D0 [Rational(-504141, 44601490397061246283071436545296723011960832), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x807B14CF))))
(check-sat)
(exit)
