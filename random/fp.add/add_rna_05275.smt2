...
(assert (= x ((_ to_fp 8 24) #x4A71FFDE)))
;; x should be Float32(0x4A71FFDE [Rational(7929839, 2), 3964919.500000])
...
(assert (not (= result (fp #b0 #b10010100 #b11100011111111111011110))))
(check-sat)
(exit)
