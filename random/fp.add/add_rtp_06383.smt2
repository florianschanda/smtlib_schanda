...
(assert (= y ((_ to_fp 8 24) #x858DD129)))
;; y should be Float32(0x858DD129 [Rational(-9294121, 696898287454081973172991196020261297061888), -0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (= result ((_ to_fp 8 24) #x858DF129)))
(check-sat)
(exit)
