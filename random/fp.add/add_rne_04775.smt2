...
(assert (= y (fp #b0 #b10010101 #b00110000101100101100011)))
;; y should be Float32(0x4A985963 [Rational(9984355, 2), 4992177.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result (fp #b0 #b10010101 #b00110000101100101100011)))
(check-sat)
(exit)
