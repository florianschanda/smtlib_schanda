...
(assert (= y ((_ to_fp 8 24) #x942CF9F3)))
;; y should be Float32(0x942CF9F3 [Rational(-11336179, 1298074214633706907132624082305024), -0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x942CF9F3))))
(check-sat)
(exit)
