...
(assert (= x ((_ to_fp 8 24) #xC9C3DAF4)))
;; x should be Float32(0xC9C3DAF4 [Rational(-3208893, 2), -1604446.500000])
...
(assert (not (= result (fp #b1 #b10010011 #b10000111101101011110101))))
(check-sat)
(exit)
