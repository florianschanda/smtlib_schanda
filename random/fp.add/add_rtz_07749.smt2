...
(assert (= x ((_ to_fp 8 24) #x8B7FB321)))
;; x should be Float32(0x8B7FB321 [Rational(-16757537, 340282366920938463463374607431768211456), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x8B7FB325)))
(check-sat)
(exit)
