...
(assert (= x (fp #b1 #b00000000 #b00111000010100011111001)))
;; x should be Float32(0x801C28F9 [Rational(-1845497, 713623846352979940529142984724747568191373312), -0.000000])
