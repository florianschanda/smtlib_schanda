...
(assert (= y ((_ to_fp 8 24) #xC782B940)))
;; y should be Float32(0xC782B940 [Rational(-133861, 2), -66930.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (not (= result (fp #b1 #b10001111 #b00000101011100101000000))))
(check-sat)
(exit)
