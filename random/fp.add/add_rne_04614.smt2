...
(assert (= x ((_ to_fp 8 24) #x4AAED42D)))
;; x should be Float32(0x4AAED42D [Rational(11457581, 2), 5728790.500000])
...
(assert (= result (fp #b0 #b10010101 #b01011101101010000101101)))
(check-sat)
(exit)
