...
(assert (= x (fp #b0 #b00000000 #b11000010110011110000010)))
;; x should be Float32(0x00616782 [Rational(3191745, 356811923176489970264571492362373784095686656), 0.000000])
