...
(assert (= x ((_ to_fp 8 24) #xCAB39A87)))
;; x should be Float32(0xCAB39A87 [Rational(-11770503, 2), -5885251.500000])
...
(assert (= result (fp #b1 #b10010101 #b01100111001101010000111)))
(check-sat)
(exit)
