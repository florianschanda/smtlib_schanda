...
(assert (= x (fp #b1 #b10010100 #b01111000010000000100110)))
;; x should be Float32(0xCA3C2026 [Rational(-6164499, 2), -3082249.500000])
...
(assert (= result (fp #b1 #b10010100 #b01111000010000000100110)))
(check-sat)
(exit)
