...
(assert (= x ((_ to_fp 8 24) #xBC153AB4)))
;; x should be Float32(0xBC153AB4 [Rational(-2444973, 268435456), -0.009108])
...
(assert (not (= result (fp #b1 #b01111000 #b00101010011101010110100))))
(check-sat)
(exit)
