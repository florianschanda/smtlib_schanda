...
(assert (= x ((_ to_fp 8 24) #x000BB2FE)))
;; x should be Float32(0x000BB2FE [Rational(383359, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x80744D01))))
(check-sat)
(exit)
