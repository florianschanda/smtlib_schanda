...
(assert (= x ((_ to_fp 8 24) #x5CBFC651)))
;; x should be Float32(0x5CBFC651 [Rational(431838173971087360), 431838173971087360.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x5CBFC651))))
(check-sat)
(exit)
