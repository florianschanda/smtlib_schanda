...
(assert (= x (fp #b1 #b10010101 #b01000011101100111110111)))
;; x should be Float32(0xCAA1D9F7 [Rational(-10607095, 2), -5303547.500000])
...
(assert (= result ((_ to_fp 8 24) #xCAA1D9F7)))
(check-sat)
(exit)
