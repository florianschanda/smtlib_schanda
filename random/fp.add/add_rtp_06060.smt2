...
(assert (= y ((_ to_fp 8 24) #x3324B2AE)))
;; y should be Float32(0x3324B2AE [Rational(5396823, 140737488355328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (= result (fp #b0 #b01100110 #b01001001011001010101111)))
(check-sat)
(exit)
