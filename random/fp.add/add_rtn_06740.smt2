...
(assert (= y ((_ to_fp 8 24) #x498F364C)))
;; y should be Float32(0x498F364C [Rational(2346387, 2), 1173193.500000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (not (= result (fp #b0 #b10010011 #b00011110011011001001100))))
(check-sat)
(exit)
