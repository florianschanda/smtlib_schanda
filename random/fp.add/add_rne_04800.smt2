...
(assert (= y ((_ to_fp 8 24) #x804651CF)))
;; y should be Float32(0x804651CF [Rational(-4608463, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result ((_ to_fp 8 24) #x804651CE)))
(check-sat)
(exit)
