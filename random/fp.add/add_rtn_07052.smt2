...
(assert (= y ((_ to_fp 8 24) #x1D5CB4A8)))
;; y should be Float32(0x1D5CB4A8 [Rational(1808021, 618970019642690137449562112), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (not (= result ((_ to_fp 8 24) #x1D5CB4A7))))
(check-sat)
(exit)
