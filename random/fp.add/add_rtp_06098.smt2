...
(assert (= y ((_ to_fp 8 24) #xC93D3598)))
;; y should be Float32(0xC93D3598 [Rational(-1550003, 2), -775001.500000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (not (= result (fp #b1 #b10010010 #b01111010011010110010111))))
(check-sat)
(exit)
