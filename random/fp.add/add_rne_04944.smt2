...
(assert (= x (fp #b1 #b10010100 #b11101011000101100111110)))
;; x should be Float32(0xCA758B3E [Rational(-8045983, 2), -4022991.500000])
...
(assert (= result (fp #b1 #b10010100 #b11101011000101100111110)))
(check-sat)
(exit)
