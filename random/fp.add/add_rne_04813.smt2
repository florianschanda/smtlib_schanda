...
(assert (= x ((_ to_fp 8 24) #x6CABE3BD)))
;; x should be Float32(0x6CABE3BD [Rational(1662414230242743435548164096), 1662414230242743435548164096.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x6CABE3BD))))
(check-sat)
(exit)
