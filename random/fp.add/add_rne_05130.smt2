...
(assert (= x (fp #b1 #b01011001 #b11110011010110100100000)))
;; x should be Float32(0xACF9AD20 [Rational(-511337, 72057594037927936), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xACF9AD20)))
(check-sat)
(exit)
