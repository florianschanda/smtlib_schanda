...
(assert (= x (fp #b0 #b00000000 #b00010100111111001011010)))
;; x should be Float32(0x000A7E5A [Rational(343853, 356811923176489970264571492362373784095686656), 0.000000])
