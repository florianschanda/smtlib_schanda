...
(assert (= y (fp #b1 #b10010001 #b10011111001011011010000)))
;; y should be Float32(0xC8CF96D0 [Rational(-850285, 2), -425142.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #xC8CF96D0))))
(check-sat)
(exit)
