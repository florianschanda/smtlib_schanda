...
(assert (= x (fp #b0 #b00000000 #b00110101001000010010001)))
;; x should be Float32(0x001A9091 [Rational(1740945, 713623846352979940529142984724747568191373312), 0.000000])
