...
(assert (= y ((_ to_fp 8 24) #xD18F967E)))
;; y should be Float32(0xD18F967E [Rational(-77088145408), -77088145408.000000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result (fp #b1 #b10100011 #b00011111001011001111110)))
(check-sat)
(exit)
