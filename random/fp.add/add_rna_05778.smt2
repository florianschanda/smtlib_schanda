...
(assert (= x (fp #b1 #b10101101 #b00000000010010111100110)))
;; x should be Float32(0xD68025E6 [Rational(-70450130452480), -70450130452480.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xD68025E6))))
(check-sat)
(exit)
