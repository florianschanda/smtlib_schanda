...
(assert (= y (fp #b1 #b01001100 #b11100110101110110101101)))
;; y should be Float32(0xA6735DAD [Rational(-15949229, 18889465931478580854784), -0.000000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #xA6735DAD))))
(check-sat)
(exit)
