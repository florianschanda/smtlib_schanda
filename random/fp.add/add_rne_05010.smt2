...
(assert (= y (fp #b1 #b00000000 #b11101100110110100111101)))
;; y should be Float32(0x80766D3D [Rational(-7761213, 713623846352979940529142984724747568191373312), -0.000000])
