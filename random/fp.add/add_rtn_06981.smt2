...
(assert (= y ((_ to_fp 8 24) #x49CA9AD4)))
;; y should be Float32(0x49CA9AD4 [Rational(3319477, 2), 1659738.500000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (not (= result (fp #b0 #b10010011 #b10010101001101011010011))))
(check-sat)
(exit)
