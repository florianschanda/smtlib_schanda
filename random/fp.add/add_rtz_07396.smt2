...
(assert (= y ((_ to_fp 8 24) #x001B6E35)))
;; y should be Float32(0x001B6E35 [Rational(1797685, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x001B6E36))))
(check-sat)
(exit)
