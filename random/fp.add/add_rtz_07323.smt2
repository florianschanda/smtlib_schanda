...
(assert (= y (fp #b0 #b10010100 #b10100101010001100110110)))
;; y should be Float32(0x4A52A336 [Rational(6902171, 2), 3451085.500000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result ((_ to_fp 8 24) #x4A52A336))))
(check-sat)
(exit)
