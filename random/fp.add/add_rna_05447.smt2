...
(assert (= y ((_ to_fp 8 24) #x001C415F)))
;; y should be Float32(0x001C415F [Rational(1851743, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (= result ((_ to_fp 8 24) #x001C4160)))
(check-sat)
(exit)
