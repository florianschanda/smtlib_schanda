...
(assert (= y ((_ to_fp 8 24) #xB706FE7C)))
;; y should be Float32(0xB706FE7C [Rational(-2211743, 274877906944), -0.000008])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result (fp #b1 #b01101110 #b00001101111111001111100)))
(check-sat)
(exit)
