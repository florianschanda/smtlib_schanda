...
(assert (= y (fp #b0 #b10010011 #b01101011000100110011100)))
;; y should be Float32(0x49B5899C [Rational(2974311, 2), 1487155.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result (fp #b0 #b10010011 #b01101011000100110011100)))
(check-sat)
(exit)
