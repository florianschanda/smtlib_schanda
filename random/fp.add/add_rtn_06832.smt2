...
(assert (= x (fp #b0 #b00000000 #b00101000101101110101010)))
;; x should be Float32(0x00145BAA [Rational(667093, 356811923176489970264571492362373784095686656), 0.000000])
