...
(assert (= y (fp #b1 #b00000010 #b11010100011111111010100)))
;; y should be Float32(0x816A3FD4 [Rational(-3837941, 89202980794122492566142873090593446023921664), -0.000000])
