...
(assert (= y (fp #b0 #b10010101 #b00000100101000100111111)))
;; y should be Float32(0x4A82513F [Rational(8540479, 2), 4270239.500000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (not (= result (fp #b0 #b10010101 #b00000100101000100111110))))
(check-sat)
(exit)
