...
(assert (= y ((_ to_fp 8 24) #xC3CA041F)))
;; y should be Float32(0xC3CA041F [Rational(-13239327, 32768), -404.032196])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (not (= result (fp #b1 #b10000111 #b10010100000010000011111))))
(check-sat)
(exit)
