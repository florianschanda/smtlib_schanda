...
(assert (= y (fp #b0 #b10010101 #b00011110010100111110001)))
;; y should be Float32(0x4A8F29F1 [Rational(9382385, 2), 4691192.500000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (not (= result ((_ to_fp 8 24) #x4A8F29F1))))
(check-sat)
(exit)
