...
(assert (= x ((_ to_fp 8 24) #x4AA2F8B3)))
;; x should be Float32(0x4AA2F8B3 [Rational(10680499, 2), 5340249.500000])
...
(assert (= result (fp #b0 #b10010101 #b01000101111100010110011)))
(check-sat)
(exit)
