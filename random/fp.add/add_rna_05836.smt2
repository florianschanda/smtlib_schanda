...
(assert (= x ((_ to_fp 8 24) #x804485EB)))
;; x should be Float32(0x804485EB [Rational(-4490731, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x804485EC)))
(check-sat)
(exit)
