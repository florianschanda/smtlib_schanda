...
(assert (= x (fp #b0 #b00000000 #b11010000000011001011001)))
;; x should be Float32(0x00680659 [Rational(6817369, 713623846352979940529142984724747568191373312), 0.000000])
