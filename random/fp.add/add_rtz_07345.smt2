...
(assert (= y (fp #b1 #b01101101 #b00100010011001011000111)))
;; y should be Float32(0xB69132C7 [Rational(-9515719, 2199023255552), -0.000004])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (= result ((_ to_fp 8 24) #xB69132C6)))
(check-sat)
(exit)
