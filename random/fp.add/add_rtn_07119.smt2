...
(assert (= x (fp #b1 #b00000000 #b11100010101100000000110)))
;; x should be Float32(0x80715806 [Rational(-3714051, 356811923176489970264571492362373784095686656), -0.000000])
