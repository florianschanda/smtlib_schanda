...
(assert (= x ((_ to_fp 8 24) #xCECA2BF7)))
;; x should be Float32(0xCECA2BF7 [Rational(-1695939456), -1695939456.000000])
...
(assert (not (= result (fp #b1 #b10011101 #b10010100010101111110111))))
(check-sat)
(exit)
