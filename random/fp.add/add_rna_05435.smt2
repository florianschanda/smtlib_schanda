...
(assert (= y (fp #b0 #b10010101 #b01111100011010101101011)))
;; y should be Float32(0x4ABE356B [Rational(12465515, 2), 6232757.500000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (= result ((_ to_fp 8 24) #x4ABE356B)))
(check-sat)
(exit)
