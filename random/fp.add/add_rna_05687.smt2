...
(assert (= y ((_ to_fp 8 24) #xCA4A7CD6)))
;; y should be Float32(0xCA4A7CD6 [Rational(-6635115, 2), -3317557.500000])

(declare-const result Float32)
(assert (= result (fp.add RNA x y)))
(assert (not (= result (fp #b1 #b10010100 #b10010100111110011010110))))
(check-sat)
(exit)
