...
(assert (= x ((_ to_fp 8 24) #xCA991AFF)))
;; x should be Float32(0xCA991AFF [Rational(-10033919, 2), -5016959.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b00110010001101011111111))))
(check-sat)
(exit)
