...
(assert (= y (fp #b0 #b01010010 #b00111111011000001101001)))
;; y should be Float32(0x291FB069 [Rational(10465385, 295147905179352825856), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTN x y)))
(assert (not (= result ((_ to_fp 8 24) #x291FB069))))
(check-sat)
(exit)
