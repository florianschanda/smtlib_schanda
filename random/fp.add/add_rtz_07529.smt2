...
(assert (= x ((_ to_fp 8 24) #xCA8EB08B)))
;; x should be Float32(0xCA8EB08B [Rational(-9351307, 2), -4675653.500000])
...
(assert (not (= result (fp #b1 #b10010101 #b00011101011000010001010))))
(check-sat)
(exit)
