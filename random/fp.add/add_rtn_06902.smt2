...
(assert (= x (fp #b1 #b10010011 #b11110001101110101011100)))
;; x should be Float32(0xC9F8DD5C [Rational(-4077399, 2), -2038699.500000])
...
(assert (not (= result ((_ to_fp 8 24) #xC9F8DD5D))))
(check-sat)
(exit)
