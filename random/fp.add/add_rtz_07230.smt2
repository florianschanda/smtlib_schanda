...
(assert (= x (fp #b0 #b10010101 #b11111111010100111000101)))
;; x should be Float32(0x4AFFA9C5 [Rational(16755141, 2), 8377570.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4AFFA9C5))))
(check-sat)
(exit)
