...
(assert (= y ((_ to_fp 8 24) #x009840EB)))
;; y should be Float32(0x009840EB [Rational(9978091, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RTZ x y)))
(assert (= result ((_ to_fp 8 24) #x010C2075)))
(check-sat)
(exit)
