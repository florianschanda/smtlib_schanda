...
(assert (= y (fp #b0 #b00000000 #b01101001100010001010011)))
;; y should be Float32(0x0034C453 [Rational(3458131, 713623846352979940529142984724747568191373312), 0.000000])
