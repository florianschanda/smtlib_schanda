...
(assert (= x (fp #b0 #b10010100 #b10110011000001110011010)))
;; x should be Float32(0x4A59839A [Rational(7127501, 2), 3563750.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x4A59839A))))
(check-sat)
(exit)
