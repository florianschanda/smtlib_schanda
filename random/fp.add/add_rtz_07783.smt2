...
(assert (= x (fp #b1 #b00000000 #b00001101110100011010101)))
;; x should be Float32(0x8006E8D5 [Rational(-452821, 713623846352979940529142984724747568191373312), -0.000000])
