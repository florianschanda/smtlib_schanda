...
(assert (= y ((_ to_fp 8 24) #x4AFAB41F)))
;; y should be Float32(0x4AFAB41F [Rational(16430111, 2), 8215055.500000])

(declare-const result Float32)
(assert (= result (fp.add RTP x y)))
(assert (not (= result (fp #b0 #b10010101 #b11110101011010000100000))))
(check-sat)
(exit)
