...
(assert (= y ((_ to_fp 8 24) #x21F12B20)))
;; y should be Float32(0x21F12B20 [Rational(493913, 302231454903657293676544), 0.000000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (not (= result ((_ to_fp 8 24) #x21F12B20))))
(check-sat)
(exit)
