...
(assert (= x (fp #b0 #b00000000 #b01100111111100101000100)))
;; x should be Float32(0x0033F944 [Rational(851537, 178405961588244985132285746181186892047843328), 0.000000])
