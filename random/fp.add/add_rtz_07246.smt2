...
(assert (= x ((_ to_fp 8 24) #x4AA10859)))
;; x should be Float32(0x4AA10859 [Rational(10553433, 2), 5276716.500000])
...
(assert (= result (fp #b0 #b10010101 #b01000010000100001011000)))
(check-sat)
(exit)
