...
(assert (= x (fp #b1 #b00000000 #b11111010101001011000110)))
;; x should be Float32(0x807D52C6 [Rational(-4106595, 356811923176489970264571492362373784095686656), -0.000000])
