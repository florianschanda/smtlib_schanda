...
(assert (= y (fp #b1 #b10010000 #b00001111101110010100000)))
;; y should be Float32(0xC807DCA0 [Rational(-278245, 2), -139122.500000])

(declare-const result Float32)
(assert (= result (fp.add RNE x y)))
(assert (= result (fp #b1 #b10010000 #b00001111101110010100000)))
(check-sat)
(exit)
