...
(assert (= x (fp #b0 #b10010101 #b01001111001111001111101)))
;; x should be Float32(0x4AA79E7D [Rational(10985085, 2), 5492542.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BA79E7E))))
(check-sat)
(exit)
