...
(assert (= z (fp #b1 #b10010001 #b00010101110001101011111)))
;; z should be Float32(0xC88AE35F [Rational(-9102175, 32), -284442.968750])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010001 #b00010101110001101011110))))
(check-sat)
(exit)
