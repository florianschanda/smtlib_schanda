...
(assert (= y (fp #b0 #b00110101 #b01010110100010100101101)))
;; y should be Float32(0x1AAB452D [Rational(11224365, 158456325028528675187087900672), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xDAAB452C))))
(check-sat)
(exit)
