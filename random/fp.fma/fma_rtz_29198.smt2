...
(assert (= y ((_ to_fp 8 24) #xE82CBCA3)))
;; y should be Float32(0xE82CBCA3 [Rational(-3262907073309058218852352), -3262907073309058218852352.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA92CBCA1))))
(check-sat)
(exit)
