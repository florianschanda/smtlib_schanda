...
(assert (= x ((_ to_fp 8 24) #x8CA83399)))
;; x should be Float32(0x8CA83399 [Rational(-11023257, 42535295865117307932921825928971026432), -0.000000])
...
(assert (= result (fp #b1 #b10011001 #b01010000011001110011000)))
(check-sat)
(exit)
