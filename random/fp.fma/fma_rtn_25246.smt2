...
(assert (= y ((_ to_fp 8 24) #x8061DD44)))
;; y should be Float32(0x8061DD44 [Rational(-1603409, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4043BA87)))
(check-sat)
(exit)
