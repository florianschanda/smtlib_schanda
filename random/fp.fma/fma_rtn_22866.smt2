...
(assert (= z (fp #b0 #b00000000 #b10100110011000100101001)))
;; z should be Float32(0x00533129 [Rational(5452073, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00533129))))
(check-sat)
(exit)
