...
(assert (= z (fp #b1 #b00000000 #b10001111111110101011000)))
;; z should be Float32(0x8047FD58 [Rational(-589739, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b10001111111110101011000)))
(check-sat)
(exit)
