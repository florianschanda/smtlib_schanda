...
(assert (= x (fp #b1 #b11110110 #b00000101110010110111010)))
;; x should be Float32(0xFB02E5BA [Rational(-679657999846991477402840842517872640), -679657999846991477402840842517872640.000000])
