...
(assert (= y (fp #b1 #b00000000 #b11101100100001010000010)))
;; y should be Float32(0x80764282 [Rational(-3875137, 356811923176489970264571492362373784095686656), -0.000000])
