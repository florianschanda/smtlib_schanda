...
(assert (= y (fp #b0 #b00000000 #b00110101101010010110100)))
;; y should be Float32(0x001AD4B4 [Rational(439597, 178405961588244985132285746181186892047843328), 0.000000])
