...
(assert (= x (fp #b1 #b00000000 #b00010010111011010111101)))
;; x should be Float32(0x800976BD [Rational(-620221, 713623846352979940529142984724747568191373312), -0.000000])
