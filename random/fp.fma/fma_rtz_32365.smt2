...
(assert (= z (fp #b0 #b10000110 #b01001011001101101010111)))
;; z should be Float32(0x43259B57 [Rational(10853207, 65536), 165.606796])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x43299B56))))
(check-sat)
(exit)
