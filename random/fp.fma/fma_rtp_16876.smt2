...
(assert (= x (fp #b0 #b00000000 #b01110110101111101011101)))
;; x should be Float32(0x003B5F5D [Rational(3891037, 713623846352979940529142984724747568191373312), 0.000000])
