...
(assert (= x (fp #b0 #b00000000 #b01010011000011000000100)))
;; x should be Float32(0x00298604 [Rational(680321, 178405961588244985132285746181186892047843328), 0.000000])
