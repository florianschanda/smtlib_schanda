...
(assert (= z (fp #b0 #b10010100 #b10100001100100100110110)))
;; z should be Float32(0x4A50C936 [Rational(6841499, 2), 3420749.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A50C936))))
(check-sat)
(exit)
