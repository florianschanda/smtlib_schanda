...
(assert (= x ((_ to_fp 8 24) #x0001E4CC)))
;; x should be Float32(0x0001E4CC [Rational(31027, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBD7265FF)))
(check-sat)
(exit)
