...
(assert (= z (fp #b0 #b00000000 #b00111000010100101010101)))
;; z should be Float32(0x001C2955 [Rational(1845589, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b01101010 #b00000000000000000000000))))
(check-sat)
(exit)
