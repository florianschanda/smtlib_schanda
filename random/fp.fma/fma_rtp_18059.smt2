...
(assert (= z ((_ to_fp 8 24) #x0043ED50)))
;; z should be Float32(0x0043ED50 [Rational(278229, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x0043ED50)))
(check-sat)
(exit)
