...
(assert (= z (fp #b0 #b00000000 #b11100001101000011100001)))
;; z should be Float32(0x0070D0E1 [Rational(7393505, 713623846352979940529142984724747568191373312), 0.000000])
