...
(assert (= z ((_ to_fp 8 24) #xCAE43CDF)))
;; z should be Float32(0xCAE43CDF [Rational(-14957791, 2), -7478895.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b11001000011110011011000)))
(check-sat)
(exit)
