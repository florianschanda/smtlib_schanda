...
(assert (= x (fp #b1 #b10010100 #b10001000110110111100110)))
;; x should be Float32(0xCA446DE6 [Rational(-6436595, 2), -3218297.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B446DE6))))
(check-sat)
(exit)
