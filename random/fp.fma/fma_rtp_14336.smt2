...
(assert (= x ((_ to_fp 8 24) #x498D74B4)))
;; x should be Float32(0x498D74B4 [Rational(2317613, 2), 1158806.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b00011010111010010110010))))
(check-sat)
(exit)
