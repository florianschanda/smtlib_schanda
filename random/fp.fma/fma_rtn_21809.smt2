...
(assert (= y ((_ to_fp 8 24) #x2A8B9570)))
;; y should be Float32(0x2A8B9570 [Rational(571735, 2305843009213693952), 0.000000])
...
(assert (not (= result (fp #b0 #b11010101 #b00010111001010101101111))))
(check-sat)
(exit)
