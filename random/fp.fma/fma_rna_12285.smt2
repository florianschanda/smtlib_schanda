...
(assert (= z ((_ to_fp 8 24) #xCAE05DB7)))
;; z should be Float32(0xCAE05DB7 [Rational(-14704055, 2), -7352027.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010101 #b11000000101110110110111)))
(check-sat)
(exit)
