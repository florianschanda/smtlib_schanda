...
(assert (= y ((_ to_fp 8 24) #x4D70509C)))
;; y should be Float32(0x4D70509C [Rational(251988416), 251988416.000000])
...
(assert (= result (fp #b1 #b00011100 #b11100000101000010011100)))
(check-sat)
(exit)
