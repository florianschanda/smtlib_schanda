...
(assert (= z ((_ to_fp 8 24) #xCAB6F287)))
;; z should be Float32(0xCAB6F287 [Rational(-11989639, 2), -5994819.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01101101111001010000111))))
(check-sat)
(exit)
