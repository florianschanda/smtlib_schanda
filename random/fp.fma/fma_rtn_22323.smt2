...
(assert (= z (fp #b1 #b11011110 #b11110111001101010011001)))
;; z should be Float32(0xEF7B9A99 [Rational(-77867634563450144198542491648), -77867634563450144198542491648.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xEF7B9A9A))))
(check-sat)
(exit)
