...
(assert (= x (fp #b1 #b10010101 #b10100101000001010111101)))
;; x should be Float32(0xCAD282BD [Rational(-13796029, 2), -6898014.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BD282BD))))
(check-sat)
(exit)
