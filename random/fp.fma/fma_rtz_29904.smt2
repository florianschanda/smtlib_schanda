...
(assert (= z ((_ to_fp 8 24) #xA5F1829B)))
;; z should be Float32(0xA5F1829B [Rational(-15827611, 37778931862957161709568), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b01001011 #b11100011000001010011011))))
(check-sat)
(exit)
