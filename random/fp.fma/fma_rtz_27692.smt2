...
(assert (= z ((_ to_fp 8 24) #x006C400C)))
;; z should be Float32(0x006C400C [Rational(1773571, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11011000100000000001100))))
(check-sat)
(exit)
