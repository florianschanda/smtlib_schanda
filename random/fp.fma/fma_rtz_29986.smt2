...
(assert (= x (fp #b0 #b01010101 #b01000101000000010011101)))
;; x should be Float32(0x2AA2809D [Rational(10649757, 36893488147419103232), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4AA0629B)))
;; y should be Float32(0x4AA0629B [Rational(10511003, 2), 5255501.500000])
