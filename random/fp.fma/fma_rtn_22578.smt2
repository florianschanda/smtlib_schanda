...
(assert (= y (fp #b1 #b10010101 #b01010000010000101001111)))
;; y should be Float32(0xCAA8214F [Rational(-11018575, 2), -5509287.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01010000010000101001101))))
(check-sat)
(exit)
