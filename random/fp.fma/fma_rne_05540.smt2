...
(assert (= z ((_ to_fp 8 24) #xCAC0C1BF)))
;; z should be Float32(0xCAC0C1BF [Rational(-12632511, 2), -6316255.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b10000001100000110111111)))
(check-sat)
(exit)
