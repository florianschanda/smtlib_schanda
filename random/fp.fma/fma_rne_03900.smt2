...
(assert (= x (fp #b1 #b10010101 #b00111000111110101010111)))
;; x should be Float32(0xCA9C7D57 [Rational(-10255703, 2), -5127851.500000])
...
(assert (= result (fp #b0 #b00000001 #b10011100011111010101010)))
(check-sat)
(exit)
