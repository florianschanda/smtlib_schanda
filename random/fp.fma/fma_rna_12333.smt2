...
(assert (= z (fp #b0 #b10010100 #b10010010100111110110110)))
;; z should be Float32(0x4A494FB6 [Rational(6596571, 2), 3298285.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010100 #b10010010100111110110110))))
(check-sat)
(exit)
