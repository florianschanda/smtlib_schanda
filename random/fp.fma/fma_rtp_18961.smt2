...
(assert (= z ((_ to_fp 8 24) #x80359850)))
;; z should be Float32(0x80359850 [Rational(-219525, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x80359850)))
(check-sat)
(exit)
