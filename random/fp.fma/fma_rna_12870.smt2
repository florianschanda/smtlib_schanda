...
(assert (= x ((_ to_fp 8 24) #x949F9A41)))
;; x should be Float32(0x949F9A41 [Rational(-10459713, 649037107316853453566312041152512), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x549F9A40))))
(check-sat)
(exit)
