...
(assert (= z ((_ to_fp 8 24) #x865496E4)))
;; z should be Float32(0x865496E4 [Rational(-3483065, 87112285931760246646623899502532662132736), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x865496E4)))
(check-sat)
(exit)
