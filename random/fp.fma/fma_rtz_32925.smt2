...
(assert (= z (fp #b1 #b10111011 #b11100010000100101101010)))
;; z should be Float32(0xDDF1096A [Rational(-2171066248270446592), -2171066248270446592.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xDDF1096A)))
(check-sat)
(exit)
