...
(assert (= x (fp #b1 #b00000000 #b01010000010011011011111)))
;; x should be Float32(0x802826DF [Rational(-2631391, 713623846352979940529142984724747568191373312), -0.000000])
