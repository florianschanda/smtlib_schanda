...
(assert (= y (fp #b1 #b10001001 #b00110001111011100101011)))
;; y should be Float32(0xC498F72B [Rational(-10024747, 8192), -1223.723999])
...
(assert (= result (fp #b1 #b00001011 #b00110001111011100101100)))
(check-sat)
(exit)
