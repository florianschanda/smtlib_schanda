...
(assert (= z ((_ to_fp 8 24) #x803A896F)))
;; z should be Float32(0x803A896F [Rational(-3836271, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01110101000100101101111))))
(check-sat)
(exit)
