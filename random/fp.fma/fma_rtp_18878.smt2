...
(assert (= z (fp #b1 #b10010101 #b10001000010110010111011)))
;; z should be Float32(0xCAC42CBB [Rational(-12856507, 2), -6428253.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b10001000010110010111011)))
(check-sat)
(exit)
