...
(assert (= y ((_ to_fp 8 24) #x4A22D8B6)))
;; y should be Float32(0x4A22D8B6 [Rational(5336155, 2), 2668077.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x5763F7B5)))
;; z should be Float32(0x5763F7B5 [Rational(250653033103360), 250653033103360.000000])
