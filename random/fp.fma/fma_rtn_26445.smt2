...
(assert (= x (fp #b1 #b10010001 #b01111011011011101101111)))
;; x should be Float32(0xC8BDB76F [Rational(-12433263, 32), -388539.468750])
...
(assert (not (= result ((_ to_fp 8 24) #x89BDB76E))))
(check-sat)
(exit)
