...
(assert (= y (fp #b1 #b10111001 #b00101001001110100010101)))
;; y should be Float32(0xDC949D15 [Rational(-334648080584409088), -334648080584409088.000000])
...
(assert (= result ((_ to_fp 8 24) #x1D949D14)))
(check-sat)
(exit)
