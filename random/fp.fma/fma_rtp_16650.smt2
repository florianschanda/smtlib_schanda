...
(assert (= x (fp #b0 #b00000000 #b01000010010010011010011)))
;; x should be Float32(0x002124D3 [Rational(2172115, 713623846352979940529142984724747568191373312), 0.000000])
