...
(assert (= x (fp #b1 #b00000000 #b00010111011111001100001)))
;; x should be Float32(0x800BBE61 [Rational(-769633, 713623846352979940529142984724747568191373312), -0.000000])
