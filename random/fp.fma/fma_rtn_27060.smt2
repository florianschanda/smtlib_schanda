...
(assert (= x (fp #b1 #b00000000 #b00100011100110101110100)))
;; x should be Float32(0x8011CD74 [Rational(-291677, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11100110011101100001100)))
