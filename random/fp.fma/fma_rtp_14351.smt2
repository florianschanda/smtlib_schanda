...
(assert (= x ((_ to_fp 8 24) #x4AE659B7)))
;; x should be Float32(0x4AE659B7 [Rational(15096247, 2), 7548123.500000])
...
(assert (= result (fp #b1 #b00010111 #b11001100101100110110101)))
(check-sat)
(exit)
