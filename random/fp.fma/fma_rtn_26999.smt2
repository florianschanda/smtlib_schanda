...
(assert (= x ((_ to_fp 8 24) #x800F98A7)))
;; x should be Float32(0x800F98A7 [Rational(-1022119, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFA82638)))
