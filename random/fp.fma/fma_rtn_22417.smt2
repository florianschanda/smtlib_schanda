...
(assert (= y ((_ to_fp 8 24) #x4AC6DD71)))
;; y should be Float32(0x4AC6DD71 [Rational(13032817, 2), 6516408.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10001101101110101110000))))
(check-sat)
(exit)
