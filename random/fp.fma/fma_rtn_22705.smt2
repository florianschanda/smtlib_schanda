...
(assert (= y ((_ to_fp 8 24) #x9A907032)))
;; y should be Float32(0x9A907032 [Rational(-4732953, 79228162514264337593543950336), -0.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b00110001010110100000011)))
