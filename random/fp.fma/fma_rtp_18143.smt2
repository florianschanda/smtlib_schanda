...
(assert (= z ((_ to_fp 8 24) #xFED3604D)))
;; z should be Float32(0xFED3604D [Rational(-140483564677288036906832430652553428992), -140483564677288036906832430652553428992.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b11111101 #b10100110110000001001101)))
(check-sat)
(exit)
