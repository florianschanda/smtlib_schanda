...
(assert (= x (fp #b0 #b00000011 #b00011101000000001011100)))
;; x should be Float32(0x018E805C [Rational(2334743, 44601490397061246283071436545296723011960832), 0.000000])
