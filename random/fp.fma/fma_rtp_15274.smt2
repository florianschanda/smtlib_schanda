...
(assert (= z ((_ to_fp 8 24) #xE2AB6E28)))
;; z should be Float32(0xE2AB6E28 [Rational(-1581165415473786912768), -1581165415473786912768.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b11000101 #b01010110110111000100111))))
(check-sat)
(exit)
