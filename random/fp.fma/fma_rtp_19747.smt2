...
(assert (= x ((_ to_fp 8 24) #xDF834671)))
;; x should be Float32(0xDF834671 [Rational(-18918744624304488448), -18918744624304488448.000000])
...
(assert (= result (fp #b0 #b01000001 #b00000110100011001110000)))
(check-sat)
(exit)
