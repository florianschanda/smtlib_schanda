...
(assert (= x (fp #b0 #b10010011 #b00000000000101110001100)))
;; x should be Float32(0x49800B8C [Rational(2097891, 2), 1048945.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b00000000000101110001100))))
(check-sat)
(exit)
