...
(assert (= z ((_ to_fp 8 24) #x8022511E)))
;; z should be Float32(0x8022511E [Rational(-1124495, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01000100101000100011110))))
(check-sat)
(exit)
