...
(assert (= x ((_ to_fp 8 24) #xFC45A5EF)))
;; x should be Float32(0xFC45A5EF [Rational(-4104992056987217910468575721290727424), -4104992056987217910468575721290727424.000000])
