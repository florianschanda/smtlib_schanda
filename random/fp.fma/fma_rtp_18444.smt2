...
(assert (= y ((_ to_fp 8 24) #x49BA77DC)))
;; y should be Float32(0x49BA77DC [Rational(3055095, 2), 1527547.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b01110100111011111100010))))
(check-sat)
(exit)
