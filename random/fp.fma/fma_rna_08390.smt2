...
(assert (= z (fp #b1 #b10010100 #b01111101000100000011110)))
;; z should be Float32(0xCA3E881E [Rational(-6243343, 2), -3121671.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010100 #b01111101000100000011110))))
(check-sat)
(exit)
