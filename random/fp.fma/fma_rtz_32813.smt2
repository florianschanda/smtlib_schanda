...
(assert (= y (fp #b1 #b01100000 #b10110100100011001111001)))
;; y should be Float32(0xB05A4679 [Rational(-14304889, 18014398509481984), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFD54544)))
