...
(assert (= z ((_ to_fp 8 24) #x49F2412C)))
;; z should be Float32(0x49F2412C [Rational(3969099, 2), 1984549.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010011 #b11100100100000100101100))))
(check-sat)
(exit)
