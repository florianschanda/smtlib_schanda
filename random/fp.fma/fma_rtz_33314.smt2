...
(assert (= x (fp #b1 #b11110101 #b01000101110111111100000)))
;; x should be Float32(0xFAA2EFE0 [Rational(-423008667043159010132442376117944320), -423008667043159010132442376117944320.000000])
...
(assert (= result ((_ to_fp 8 24) #xBBA2EFDF)))
(check-sat)
(exit)
