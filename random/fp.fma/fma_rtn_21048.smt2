...
(assert (= x ((_ to_fp 8 24) #x4A6B3F2E)))
;; x should be Float32(0x4A6B3F2E [Rational(7708567, 2), 3854283.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b11010110011111100101010))))
(check-sat)
(exit)
