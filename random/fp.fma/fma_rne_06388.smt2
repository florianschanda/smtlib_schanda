...
(assert (= x (fp #b1 #b00000000 #b00011000111000011000010)))
;; x should be Float32(0x800C70C2 [Rational(-407649, 356811923176489970264571492362373784095686656), -0.000000])
