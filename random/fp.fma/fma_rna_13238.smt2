...
(assert (= x ((_ to_fp 8 24) #x801A0E3F)))
;; x should be Float32(0x801A0E3F [Rational(-1707583, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b01111110 #b10100000111000111110111)))
(check-sat)
(exit)
