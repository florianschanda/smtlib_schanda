...
(assert (= z (fp #b1 #b10010101 #b01011110111110110001001)))
;; z should be Float32(0xCAAF7D89 [Rational(-11500937, 2), -5750468.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xCAAF7D89)))
(check-sat)
(exit)
