...
(assert (= y (fp #b1 #b10111100 #b10001111000001101011010)))
;; y should be Float32(0xDE47835A [Rational(-3594108347885813760), -3594108347885813760.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x13C7835A))))
(check-sat)
(exit)
