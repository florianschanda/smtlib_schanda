...
(assert (= y (fp #b1 #b10010101 #b10101101001110110101111)))
;; y should be Float32(0xCAD69DAF [Rational(-14065071, 2), -7032535.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BD69DAF)))
(check-sat)
(exit)
