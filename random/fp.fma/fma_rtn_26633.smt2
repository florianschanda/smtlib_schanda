...
(assert (= x ((_ to_fp 8 24) #xC1E80842)))
;; x should be Float32(0xC1E80842 [Rational(-7603233, 262144), -29.004032])
...
(assert (not (= result (fp #b0 #b00000101 #b11000000000100001000010))))
(check-sat)
(exit)
