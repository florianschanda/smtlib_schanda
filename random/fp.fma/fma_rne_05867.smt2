...
(assert (= x (fp #b1 #b10001100 #b01110111001011011110000)))
;; x should be Float32(0xC63B96F0 [Rational(-768367, 64), -12005.734375])
...
(assert (not (= result ((_ to_fp 8 24) #x873B9AEF))))
(check-sat)
(exit)
