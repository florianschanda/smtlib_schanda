...
(assert (= z (fp #b1 #b10010101 #b00111011110000011000001)))
;; z should be Float32(0xCA9DE0C1 [Rational(-10346689, 2), -5173344.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xCA9DE0C1)))
(check-sat)
(exit)
