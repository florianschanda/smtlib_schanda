...
(assert (= x (fp #b0 #b00000000 #b10100100100111000111001)))
;; x should be Float32(0x00524E39 [Rational(5393977, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FDEDAB2)))
