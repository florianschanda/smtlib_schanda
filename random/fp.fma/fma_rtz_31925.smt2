...
(assert (= y ((_ to_fp 8 24) #x000577B6)))
;; y should be Float32(0x000577B6 [Rational(179163, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b1 #b01111100 #b01011101111011010111111))))
(check-sat)
(exit)
