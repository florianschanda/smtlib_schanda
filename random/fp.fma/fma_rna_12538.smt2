...
(assert (= z ((_ to_fp 8 24) #xD5AD4280)))
;; z should be Float32(0xD5AD4280 [Rational(-23812640866304), -23812640866304.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10101011 #b01011010100001010000000))))
(check-sat)
(exit)
