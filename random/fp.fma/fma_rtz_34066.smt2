...
(assert (= x ((_ to_fp 8 24) #xFF80129C)))
...
(assert (= z (fp #b1 #b00000000 #b10101111111110100111010)))
;; z should be Float32(0x8057FD3A [Rational(-2883229, 356811923176489970264571492362373784095686656), -0.000000])
