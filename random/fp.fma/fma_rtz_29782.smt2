...
(assert (= z ((_ to_fp 8 24) #x00707B4D)))
;; z should be Float32(0x00707B4D [Rational(7371597, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b11100000111101101001101)))
(check-sat)
(exit)
