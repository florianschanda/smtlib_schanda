...
(assert (= x ((_ to_fp 8 24) #xFAFD65A8)))
;; x should be Float32(0xFAFD65A8 [Rational(-657856469455291302569874979528114176), -657856469455291302569874979528114176.000000])
