...
(assert (= x ((_ to_fp 8 24) #x62655A3F)))
;; x should be Float32(0x62655A3F [Rational(1057701827316608401408), 1057701827316608401408.000000])
...
(assert (= result (fp #b1 #b01000110 #b11001010101101000111110)))
(check-sat)
(exit)
