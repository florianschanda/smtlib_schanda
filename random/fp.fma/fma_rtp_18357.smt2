...
(assert (= y (fp #b1 #b11110011 #b00001000010010011111110)))
;; y should be Float32(0xF98424FE [Rational(-85766684503200916280379547083341824), -85766684503200916280379547083341824.000000])
