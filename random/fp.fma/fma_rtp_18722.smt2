...
(assert (= y (fp #b1 #b11010001 #b01101101011011111111011)))
;; y should be Float32(0xE8B6B7FB [Rational(-6902916324030942374002688), -6902916324030942374002688.000000])
...
(assert (= result ((_ to_fp 8 24) #x29B6B7FA)))
(check-sat)
(exit)
