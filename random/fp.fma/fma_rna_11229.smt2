...
(assert (= y (fp #b0 #b10010011 #b11110011010000100100100)))
;; y should be Float32(0x49F9A124 [Rational(4089929, 2), 2044964.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b11101100010001101101011)))
