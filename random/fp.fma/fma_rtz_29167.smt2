...
(assert (= z ((_ to_fp 8 24) #x4A3F7DA2)))
;; z should be Float32(0x4A3F7DA2 [Rational(6274769, 2), 3137384.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010100 #b01111110111110110100001))))
(check-sat)
(exit)
