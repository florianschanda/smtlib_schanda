...
(assert (= y (fp #b1 #b11011100 #b11100001100011101011001)))
;; y should be Float32(0xEE70C759 [Rational(-18629349721460775774534500352), -18629349721460775774534500352.000000])
