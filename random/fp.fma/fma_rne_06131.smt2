...
(assert (= x ((_ to_fp 8 24) #xF3193878)))
;; x should be Float32(0xF3193878 [Rational(-12139385096330792731161776881664), -12139385096330792731161776881664.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10000110001000000100100)))
