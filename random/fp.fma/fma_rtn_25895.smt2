...
(assert (= z ((_ to_fp 8 24) #xE0FF0041)))
;; z should be Float32(0xE0FF0041 [Rational(-146998063583419432960), -146998063583419432960.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xE0FF0041)))
(check-sat)
(exit)
