...
(assert (= z ((_ to_fp 8 24) #xDF5C6CC5)))
;; z should be Float32(0xDF5C6CC5 [Rational(-15883286589619568640), -15883286589619568640.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xDF5C6CC5)))
(check-sat)
(exit)
