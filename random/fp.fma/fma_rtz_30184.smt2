...
(assert (= x (fp #b0 #b11100000 #b00110101011001100001110)))
;; x should be Float32(0x701AB30E [Rational(191508621389315677523686719488), 191508621389315677523686719488.000000])
