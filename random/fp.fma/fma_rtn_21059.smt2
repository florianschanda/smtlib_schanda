...
(assert (= x (fp #b0 #b10010101 #b10000101110100001100101)))
;; x should be Float32(0x4AC2E865 [Rational(12773477, 2), 6386738.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x00617433))))
(check-sat)
(exit)
