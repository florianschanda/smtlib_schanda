...
(assert (= y (fp #b0 #b10011011 #b11101001111011001001110)))
;; y should be Float32(0x4DF4F64E [Rational(513722816), 513722816.000000])
...
(assert (= result (fp #b0 #b00000110 #b11101001111011001001110)))
(check-sat)
(exit)
