...
(assert (= z (fp #b1 #b10010101 #b00010101010001110000011)))
;; z should be Float32(0xCA8AA383 [Rational(-9085827, 2), -4542913.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00010101010001110000011))))
(check-sat)
(exit)
