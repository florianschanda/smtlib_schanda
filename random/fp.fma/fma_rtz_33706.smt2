...
(assert (= x ((_ to_fp 8 24) #x80789313)))
;; x should be Float32(0x80789313 [Rational(-7901971, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFB03D88)))
