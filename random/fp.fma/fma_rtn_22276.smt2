...
(assert (= z (fp #b0 #b01001010 #b10111010111001011110100)))
;; z should be Float32(0x255D72F4 [Rational(3628221, 18889465931478580854784), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x255D72F3))))
(check-sat)
(exit)
