...
(assert (= y (fp #b1 #b10010011 #b11011101000010110011100)))
;; y should be Float32(0xC9EE859C [Rational(-3907943, 2), -1953971.500000])
...
(assert (= result (fp #b1 #b00010101 #b11011101000010110100011)))
(check-sat)
(exit)
