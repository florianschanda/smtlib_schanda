...
(assert (= y ((_ to_fp 8 24) #xFFB96F0B)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b11000110 #b10101110000001010001000)))
;; z should be Float32(0x63570288 [Rational(3966232371632462102528), 3966232371632462102528.000000])
