...
(assert (= z ((_ to_fp 8 24) #x14CF48D7)))
;; z should be Float32(0x14CF48D7 [Rational(13584599, 649037107316853453566312041152512), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00101001 #b10011110100100011010111))))
(check-sat)
(exit)
