...
(assert (= x (fp #b0 #b11011011 #b10000010001101111110010)))
;; x should be Float32(0x6DC11BF2 [Rational(7470548838167255963217690624), 7470548838167255963217690624.000000])
