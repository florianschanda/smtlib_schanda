...
(assert (= y (fp #b1 #b10010100 #b01000111111111001010110)))
;; y should be Float32(0xCA23FE56 [Rational(-5373739, 2), -2686869.500000])
...
(assert (= result (fp #b1 #b00010110 #b01000111111111001010001)))
(check-sat)
(exit)
