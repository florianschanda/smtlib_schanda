...
(assert (= z (fp #b1 #b01110111 #b01011001001101011101010)))
;; z should be Float32(0xBBAC9AEA [Rational(-5655925, 1073741824), -0.005267])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b01110111 #b01011001001101011101001)))
(check-sat)
(exit)
