...
(assert (= x ((_ to_fp 8 24) #x659875EE)))
;; x should be Float32(0x659875EE [Rational(89996890520023889608704), 89996890520023889608704.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA69875ED))))
(check-sat)
(exit)
