...
(assert (= y (fp #b0 #b10101010 #b01101000001100000100111)))
;; y should be Float32(0x55341827 [Rational(12375989157888), 12375989157888.000000])
...
(assert (= result ((_ to_fp 8 24) #x16341825)))
(check-sat)
(exit)
