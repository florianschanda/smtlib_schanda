...
(assert (= z (fp #b1 #b01010111 #b11110010000000001111101)))
;; z should be Float32(0xABF9007D [Rational(-16318589, 9223372036854775808), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xABF9007D)))
(check-sat)
(exit)
