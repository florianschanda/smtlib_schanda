...
(assert (= y (fp #b1 #b10010101 #b10000111000110001011101)))
;; y should be Float32(0xCAC38C5D [Rational(-12815453, 2), -6407726.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b10000111000110001011101))))
(check-sat)
(exit)
