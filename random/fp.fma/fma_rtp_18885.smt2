...
(assert (= z ((_ to_fp 8 24) #x806D4159)))
;; z should be Float32(0x806D4159 [Rational(-7160153, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x806D4159)))
(check-sat)
(exit)
