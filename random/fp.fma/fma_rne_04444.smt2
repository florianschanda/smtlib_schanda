...
(assert (= z (fp #b1 #b10001000 #b10101000110101010101110)))
;; z should be Float32(0xC4546AAE [Rational(-6960471, 8192), -849.666870])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10001000 #b10101010110101010101110)))
(check-sat)
(exit)
