...
(assert (= z (fp #b0 #b10010100 #b01100100111110100000010)))
;; z should be Float32(0x4A327D02 [Rational(5848705, 2), 2924352.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010100 #b01100100111110100010010)))
(check-sat)
(exit)
