...
(assert (= y (fp #b1 #b00000000 #b01011000101000111111010)))
;; y should be Float32(0x802C51FA [Rational(-1452285, 356811923176489970264571492362373784095686656), -0.000000])
