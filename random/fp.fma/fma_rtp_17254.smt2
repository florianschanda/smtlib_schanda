...
(assert (= z (fp #b0 #b10010101 #b11100111111010011000011)))
;; z should be Float32(0x4AF3F4C3 [Rational(15987907, 2), 7993953.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b11100111111010011000011)))
(check-sat)
(exit)
