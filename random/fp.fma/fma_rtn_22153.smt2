...
(assert (= z ((_ to_fp 8 24) #x8074D602)))
;; z should be Float32(0x8074D602 [Rational(-3828481, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00000000 #b11101001101011000000010)))
(check-sat)
(exit)
