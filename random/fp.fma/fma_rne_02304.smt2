...
(assert (= y ((_ to_fp 8 24) #x69373697)))
;; y should be Float32(0x69373697 [Rational(13843201139869201872191488), 13843201139869201872191488.000000])
...
(assert (not (= result (fp #b0 #b00111101 #b01101110011011010010111))))
(check-sat)
(exit)
