...
(assert (= y (fp #b1 #b10010101 #b10010000001101111010001)))
;; y should be Float32(0xCAC81BD1 [Rational(-13114321, 2), -6557160.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BC81BD0))))
(check-sat)
(exit)
