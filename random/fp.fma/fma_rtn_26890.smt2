...
(assert (= x (fp #b1 #b00000000 #b00110111111111001111100)))
;; x should be Float32(0x801BFE7C [Rational(-458655, 178405961588244985132285746181186892047843328), -0.000000])
