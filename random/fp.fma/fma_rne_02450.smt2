...
(assert (= z ((_ to_fp 8 24) #x80494254)))
;; z should be Float32(0x80494254 [Rational(-1200277, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x80494254)))
(check-sat)
(exit)
