...
(assert (= z (fp #b1 #b10010101 #b10101011111011010110001)))
;; z should be Float32(0xCAD5F6B1 [Rational(-14022321, 2), -7011160.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b10101011111011010110000)))
(check-sat)
(exit)
