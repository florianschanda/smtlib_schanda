...
(assert (= x (fp #b0 #b10010110 #b00001001100000111100111)))
;; x should be Float32(0x4B04C1E7 [Rational(8700391), 8700391.000000])
...
(assert (not (= result (fp #b0 #b00000010 #b00000100110000011110011))))
(check-sat)
(exit)
