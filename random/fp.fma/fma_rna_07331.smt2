...
(assert (= x (fp #b0 #b10010101 #b01010000101101100010001)))
;; x should be Float32(0x4AA85B11 [Rational(11033361, 2), 5516680.500000])
...
(assert (= result (fp #b0 #b00010111 #b01010000101101100010001)))
(check-sat)
(exit)
