...
(assert (= y ((_ to_fp 8 24) #x001214CA)))
;; y should be Float32(0x001214CA [Rational(592485, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBF10A64F)))
(check-sat)
(exit)
