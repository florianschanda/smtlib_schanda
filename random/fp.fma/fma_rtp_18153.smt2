...
(assert (= z (fp #b0 #b10001111 #b10111010100001001101100)))
;; z should be Float32(0x47DD426C [Rational(3625115, 32), 113284.843750])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x47DD406D))))
(check-sat)
(exit)
