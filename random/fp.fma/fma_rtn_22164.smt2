...
(assert (= y ((_ to_fp 8 24) #x6F8C97D3)))
;; y should be Float32(0x6F8C97D3 [Rational(87022891186156008243980140544), 87022891186156008243980140544.000000])
...
(assert (= result (fp #b0 #b01100001 #b00011001001011111010001)))
(check-sat)
(exit)
