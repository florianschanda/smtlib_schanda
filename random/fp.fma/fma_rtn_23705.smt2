...
(assert (= x (fp #b0 #b00000000 #b11100000101100110011011)))
;; x should be Float32(0x0070599B [Rational(7362971, 713623846352979940529142984724747568191373312), 0.000000])
