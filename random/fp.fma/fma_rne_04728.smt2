...
(assert (= y ((_ to_fp 8 24) #x4AB7B66F)))
;; y should be Float32(0x4AB7B66F [Rational(12039791, 2), 6019895.500000])
...
(assert (= result (fp #b1 #b00010111 #b01101111011011001101110)))
(check-sat)
(exit)
