...
(assert (= y (fp #b0 #b11111111 #b01001011100011101111100)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x80116783)))
;; z should be Float32(0x80116783 [Rational(-1140611, 713623846352979940529142984724747568191373312), -0.000000])
