...
(assert (= z (fp #b1 #b00000000 #b01001100110010011110010)))
;; z should be Float32(0x802664F2 [Rational(-1258105, 356811923176489970264571492362373784095686656), -0.000000])
