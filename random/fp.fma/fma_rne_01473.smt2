...
(assert (= y ((_ to_fp 8 24) #x4A386F6A)))
;; y should be Float32(0x4A386F6A [Rational(6043573, 2), 3021786.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b01110000110111101101001))))
(check-sat)
(exit)
