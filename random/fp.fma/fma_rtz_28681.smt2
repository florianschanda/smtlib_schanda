...
(assert (= y ((_ to_fp 8 24) #x002D3458)))
;; y should be Float32(0x002D3458 [Rational(370315, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= result (fp #b0 #b01111111 #b01101001101000101011111)))
(check-sat)
(exit)
