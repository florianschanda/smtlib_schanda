...
(assert (= y ((_ to_fp 8 24) #x00298BD3)))
;; y should be Float32(0x00298BD3 [Rational(2722771, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FA62F4B)))
(check-sat)
(exit)
