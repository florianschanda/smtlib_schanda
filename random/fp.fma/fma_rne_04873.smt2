...
(assert (= z (fp #b0 #b00000000 #b11100100110110010001010)))
;; z should be Float32(0x00726C8A [Rational(3749445, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b11100100110110010001010)))
(check-sat)
(exit)
