...
(assert (= z (fp #b1 #b00010100 #b01000100101000011111011)))
;; z should be Float32(0x8A2250FB [Rational(-10637563, 1361129467683753853853498429727072845824), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00010100 #b01000100101000011111010)))
(check-sat)
(exit)
