...
(assert (= y ((_ to_fp 8 24) #x4AD551F9)))
;; y should be Float32(0x4AD551F9 [Rational(13980153, 2), 6990076.500000])
...
(assert (= result (fp #b1 #b00010111 #b10101010101000111110111)))
(check-sat)
(exit)
