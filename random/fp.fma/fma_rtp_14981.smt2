...
(assert (= z (fp #b0 #b00000000 #b00111100100101101111010)))
;; z should be Float32(0x001E4B7A [Rational(992701, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b00111100100101101111010)))
(check-sat)
(exit)
