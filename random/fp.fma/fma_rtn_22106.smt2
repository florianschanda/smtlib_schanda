...
(assert (= z ((_ to_fp 8 24) #x0036740C)))
;; z should be Float32(0x0036740C [Rational(892163, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0036740C))))
(check-sat)
(exit)
