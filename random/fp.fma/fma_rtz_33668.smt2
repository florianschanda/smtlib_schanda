...
(assert (= x ((_ to_fp 8 24) #x8048EBE4)))
;; x should be Float32(0x8048EBE4 [Rational(-1194745, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= z (fp #b1 #b11111111 #b01011100010100010100111)))
