...
(assert (= y (fp #b0 #b00000000 #b00011101001111100111110)))
;; y should be Float32(0x000E9F3E [Rational(479135, 356811923176489970264571492362373784095686656), 0.000000])
