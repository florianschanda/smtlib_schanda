...
(assert (= z (fp #b1 #b00000000 #b00100001111001110011000)))
;; z should be Float32(0x8010F398 [Rational(-138867, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00100001111001110011000))))
(check-sat)
(exit)
