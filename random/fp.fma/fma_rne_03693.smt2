...
(assert (= x (fp #b1 #b10010101 #b01111110011011011101011)))
;; x should be Float32(0xCABF36EB [Rational(-12531435, 2), -6265717.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BBF36EA))))
(check-sat)
(exit)
