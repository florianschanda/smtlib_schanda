...
(assert (= y (fp #b0 #b01111000 #b01010001100100110111001)))
;; y should be Float32(0x3C28C9B9 [Rational(11061689, 1073741824), 0.010302])
...
(assert (= result (fp #b1 #b00000000 #b00000010101000110010011)))
(check-sat)
(exit)
