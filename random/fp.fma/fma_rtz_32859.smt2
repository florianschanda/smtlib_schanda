...
(assert (= z (fp #b0 #b11100100 #b01101011000110011100011)))
;; z should be Float32(0x72358CE3 [Rational(3595974935654471483718895665152), 3595974935654471483718895665152.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x72358CE3))))
(check-sat)
(exit)
