...
(assert (= z (fp #b0 #b00000000 #b11001000111111111011110)))
;; z should be Float32(0x00647FDE [Rational(3293167, 356811923176489970264571492362373784095686656), 0.000000])
