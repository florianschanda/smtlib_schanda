...
(assert (= z (fp #b0 #b00000000 #b01101111100100100100101)))
;; z should be Float32(0x0037C925 [Rational(3655973, 713623846352979940529142984724747568191373312), 0.000000])
