...
(assert (= y (fp #b0 #b10010000 #b10110010111001011010011)))
;; y should be Float32(0x485972D3 [Rational(14250707, 64), 222667.296875])
...
(assert (= result (fp #b1 #b00010010 #b10110010111001100010011)))
(check-sat)
(exit)
