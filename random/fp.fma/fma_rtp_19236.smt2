...
(assert (= z ((_ to_fp 8 24) #x449EAEF1)))
;; z should be Float32(0x449EAEF1 [Rational(10399473, 8192), 1269.466919])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10001001 #b00111101010111011110001))))
(check-sat)
(exit)
