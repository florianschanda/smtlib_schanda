...
(assert (= z (fp #b0 #b00000000 #b10111101101000011000111)))
;; z should be Float32(0x005ED0C7 [Rational(6213831, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x005ED0C7))))
(check-sat)
(exit)
