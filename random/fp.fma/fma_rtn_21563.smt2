...
(assert (= z ((_ to_fp 8 24) #xFB34C2A0)))
;; z should be Float32(0xFB34C2A0 [Rational(-938560898505379679491750073041158144), -938560898505379679491750073041158144.000000])
