...
(assert (= y (fp #b1 #b01110110 #b01111010100010101100010)))
;; y should be Float32(0xBB3D4562 [Rational(-6202033, 2147483648), -0.002888])
...
(assert (= result ((_ to_fp 8 24) #x00005EA3)))
(check-sat)
(exit)
