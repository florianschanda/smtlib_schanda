...
(assert (= y (fp #b0 #b11101011 #b01011011101001101111010)))
;; y should be Float32(0x75ADD37A [Rational(440701470111680870334187083661312), 440701470111680870334187083661312.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2B2DD37A))))
(check-sat)
(exit)
