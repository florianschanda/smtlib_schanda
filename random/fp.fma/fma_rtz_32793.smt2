...
(assert (= z ((_ to_fp 8 24) #x804D5D26)))
;; z should be Float32(0x804D5D26 [Rational(-2535059, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10011010101110100100101))))
(check-sat)
(exit)
