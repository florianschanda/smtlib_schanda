...
(assert (= x (fp #b0 #b00000000 #b11011011101000100011110)))
;; x should be Float32(0x006DD11E [Rational(3598479, 356811923176489970264571492362373784095686656), 0.000000])
