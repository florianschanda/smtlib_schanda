...
(assert (= z ((_ to_fp 8 24) #x0026DB8B)))
;; z should be Float32(0x0026DB8B [Rational(2546571, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b01001101101101110001011)))
(check-sat)
(exit)
