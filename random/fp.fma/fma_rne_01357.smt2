...
(assert (= z (fp #b0 #b10101010 #b10001110001001100010000)))
;; z should be Float32(0x55471310 [Rational(13680292921344), 13680292921344.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x55471310)))
(check-sat)
(exit)
