...
(assert (= z (fp #b1 #b10010101 #b10010010110101110000001)))
;; z should be Float32(0xCAC96B81 [Rational(-13200257, 2), -6600128.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10010010110101110000001))))
(check-sat)
(exit)
