...
(assert (= y (fp #b0 #b10011001 #b11011101011001111111101)))
;; y should be Float32(0x4CEEB3FD [Rational(125149160), 125149160.000000])
...
(assert (= result (fp #b0 #b00000100 #b11011101011001111111101)))
(check-sat)
(exit)
