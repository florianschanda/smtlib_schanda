...
(assert (= y ((_ to_fp 8 24) #xF4666205)))
;; y should be Float32(0xF4666205 [Rational(-73011251815489550145584042606592), -73011251815489550145584042606592.000000])
...
(assert (= result (fp #b1 #b01010011 #b11001100110001000000101)))
(check-sat)
(exit)
