...
(assert (= x ((_ to_fp 8 24) #x803672F0)))
;; x should be Float32(0x803672F0 [Rational(-223023, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10100011010000000111010)))
