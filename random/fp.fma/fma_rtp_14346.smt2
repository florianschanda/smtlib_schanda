...
(assert (= x (fp #b0 #b10010101 #b01111111110110001001111)))
;; x should be Float32(0x4ABFEC4F [Rational(12577871, 2), 6288935.500000])
...
(assert (= result (fp #b1 #b00010111 #b01111111110110001001111)))
(check-sat)
(exit)
