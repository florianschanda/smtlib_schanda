...
(assert (= z (fp #b1 #b11100001 #b10011110001000001011100)))
;; z should be Float32(0xF0CF105C [Rational(-512665394430789498401477099520), -512665394430789498401477099520.000000])
