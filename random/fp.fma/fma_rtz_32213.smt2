...
(assert (= z (fp #b0 #b00001011 #b01110111010101100010000)))
;; z should be Float32(0x05BBAB10 [Rational(768689, 43556142965880123323311949751266331066368), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x05BBAB0F)))
(check-sat)
(exit)
