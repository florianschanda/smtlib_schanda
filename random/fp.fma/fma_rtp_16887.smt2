...
(assert (= x (fp #b0 #b00000000 #b10111101101001110101110)))
;; x should be Float32(0x005ED3AE [Rational(3107287, 356811923176489970264571492362373784095686656), 0.000000])
