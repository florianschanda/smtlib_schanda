...
(assert (= x (fp #b0 #b11110111 #b10100111001100001110100)))
;; x should be Float32(0x7BD39874 [Rational(2197333507754910676375071117518307328), 2197333507754910676375071117518307328.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11000011000110001111011)))
