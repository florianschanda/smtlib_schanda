...
(assert (= x (fp #b1 #b10010100 #b00000000000100101000010)))
;; x should be Float32(0xCA000942 [Rational(-4195489, 2), -2097744.500000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10001001001000101100100)))
