...
(assert (= y (fp #b0 #b00000000 #b00010101100000111000001)))
;; y should be Float32(0x000AC1C1 [Rational(704961, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3EAC1C10)))
(check-sat)
(exit)
