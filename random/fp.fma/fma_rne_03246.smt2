...
(assert (= x (fp #b0 #b00000000 #b11010001000110000100110)))
;; x should be Float32(0x00688C26 [Rational(3425811, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFF8A1A8A)))
