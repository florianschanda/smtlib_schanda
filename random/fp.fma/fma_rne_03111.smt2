...
(assert (= x (fp #b0 #b00000000 #b01110001001000000010101)))
;; x should be Float32(0x00389015 [Rational(3706901, 713623846352979940529142984724747568191373312), 0.000000])
