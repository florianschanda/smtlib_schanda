...
(assert (= x (fp #b0 #b00000000 #b10111101001011101000101)))
;; x should be Float32(0x005E9745 [Rational(6199109, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x403D2E89))))
(check-sat)
(exit)
