...
(assert (= x (fp #b1 #b00000000 #b11111000110010111011110)))
;; x should be Float32(0x807C65DE [Rational(-4076271, 356811923176489970264571492362373784095686656), -0.000000])
