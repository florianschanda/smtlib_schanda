...
(assert (= z (fp #b1 #b10010101 #b01111001100111001000001)))
;; z should be Float32(0xCABCCE41 [Rational(-12373569, 2), -6186784.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xCABCCE40)))
(check-sat)
(exit)
