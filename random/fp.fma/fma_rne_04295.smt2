...
(assert (= y (fp #b1 #b00000000 #b00010111110110001111100)))
;; y should be Float32(0x800BEC7C [Rational(-195359, 178405961588244985132285746181186892047843328), -0.000000])
