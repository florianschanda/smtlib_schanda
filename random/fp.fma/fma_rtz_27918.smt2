...
(assert (= x ((_ to_fp 8 24) #x495EBF98)))
;; x should be Float32(0x495EBF98 [Rational(1824755, 2), 912377.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b00011011110101111111010))))
(check-sat)
(exit)
