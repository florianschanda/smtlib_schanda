...
(assert (= y (fp #b1 #b01101011 #b11001111101111000100100)))
;; y should be Float32(0xB5E7DE24 [Rational(-3798921, 2199023255552), -0.000002])
...
(assert (= result (fp #b1 #b00000000 #b00000000000000000001110)))
(check-sat)
(exit)
