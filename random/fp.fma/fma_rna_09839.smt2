...
(assert (= x (fp #b0 #b00000000 #b00011111010110111111101)))
;; x should be Float32(0x000FADFD [Rational(1027581, 713623846352979940529142984724747568191373312), 0.000000])
