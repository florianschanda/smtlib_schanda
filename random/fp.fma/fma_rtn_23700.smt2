...
(assert (= x (fp #b0 #b00000000 #b10001011010111111011101)))
;; x should be Float32(0x0045AFDD [Rational(4567005, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC00B5FBA)))
(check-sat)
(exit)
