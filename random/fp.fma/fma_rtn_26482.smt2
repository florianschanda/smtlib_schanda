...
(assert (= x ((_ to_fp 8 24) #xF4CD4DA2)))
;; x should be Float32(0xF4CD4DA2 [Rational(-130126396057305682775156962885632), -130126396057305682775156962885632.000000])
...
(assert (not (= result (fp #b1 #b01010100 #b10011010100110110100011))))
(check-sat)
(exit)
