...
(assert (= z (fp #b0 #b00000000 #b11011111110110110001111)))
;; z should be Float32(0x006FED8F [Rational(7335311, 713623846352979940529142984724747568191373312), 0.000000])
