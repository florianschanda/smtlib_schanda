...
(assert (= z (fp #b1 #b10010100 #b11010100010110001000110)))
;; z should be Float32(0xCA6A2C46 [Rational(-7673379, 2), -3836689.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA6A2C47))))
(check-sat)
(exit)
