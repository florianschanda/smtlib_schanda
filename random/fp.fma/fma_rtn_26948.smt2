...
(assert (= x (fp #b1 #b00000000 #b00011011011111001001001)))
;; x should be Float32(0x800DBE49 [Rational(-900681, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3EDBE48F))))
(check-sat)
(exit)
