...
(assert (= z ((_ to_fp 8 24) #xCAFED003)))
;; z should be Float32(0xCAFED003 [Rational(-16699395, 2), -8349697.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010101 #b11111101101000000000011))))
(check-sat)
(exit)
