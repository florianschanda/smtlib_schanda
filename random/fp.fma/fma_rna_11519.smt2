...
(assert (= y (fp #b1 #b00000000 #b01010001110100110000100)))
;; y should be Float32(0x8028E984 [Rational(-670305, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FA3A60F)))
(check-sat)
(exit)
