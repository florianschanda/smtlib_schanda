...
(assert (= x (fp #b0 #b00000000 #b01010000010010110010010)))
;; x should be Float32(0x00282592 [Rational(1315529, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b0 #b01111111 #b01000001001011001000111)))
(check-sat)
(exit)
