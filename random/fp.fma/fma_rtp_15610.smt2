...
(assert (= z ((_ to_fp 8 24) #xC971DC28)))
;; z should be Float32(0xC971DC28 [Rational(-1981317, 2), -990658.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010010 #b11100011101110000100111))))
(check-sat)
(exit)
