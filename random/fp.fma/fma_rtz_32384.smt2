...
(assert (= z (fp #b0 #b00111011 #b01011001011011010000100)))
;; z should be Float32(0x1DACB684 [Rational(2829729, 618970019642690137449562112), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x1DACB684)))
(check-sat)
(exit)
