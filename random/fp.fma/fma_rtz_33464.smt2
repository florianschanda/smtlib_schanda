...
(assert (= x (fp #b1 #b10010000 #b10000001101111110001000)))
;; x should be Float32(0xC840DF88 [Rational(-1580017, 8), -197502.125000])
...
(assert (= result (fp #b0 #b00010010 #b10000001101111111000110)))
(check-sat)
(exit)
