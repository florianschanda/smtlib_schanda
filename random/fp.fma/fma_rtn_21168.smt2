...
(assert (= x ((_ to_fp 8 24) #x4AD47B03)))
;; x should be Float32(0x4AD47B03 [Rational(13925123, 2), 6962561.500000])
...
(assert (= z (fp #b0 #b10010101 #b01100100101011000101001)))
;; z should be Float32(0x4AB25629 [Rational(11687465, 2), 5843732.500000])
