...
(assert (= y ((_ to_fp 8 24) #xC36EACEA)))
;; y should be Float32(0xC36EACEA [Rational(-7820917, 32768), -238.675446])
...
(assert (not (= result (fp #b0 #b00001000 #b11011111010110011101010))))
(check-sat)
(exit)
