...
(assert (= y ((_ to_fp 8 24) #x00443FF1)))
;; y should be Float32(0x00443FF1 [Rational(4472817, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC0087FE1)))
(check-sat)
(exit)
