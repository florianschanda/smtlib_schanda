...
(assert (= x (fp #b0 #b10010101 #b10010110000110011000011)))
;; x should be Float32(0x4ACB0CC3 [Rational(13307075, 2), 6653537.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BCB0CC1)))
(check-sat)
(exit)
