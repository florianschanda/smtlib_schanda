...
(assert (= z ((_ to_fp 8 24) #x5A2B83A9)))
;; z should be Float32(0x5A2B83A9 [Rational(12069245722558464), 12069245722558464.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10110100 #b01010111000001110101010))))
(check-sat)
(exit)
