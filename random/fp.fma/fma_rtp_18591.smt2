...
(assert (= z ((_ to_fp 8 24) #x00493F03)))
;; z should be Float32(0x00493F03 [Rational(4800259, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b10010010011111100000011)))
(check-sat)
(exit)
