...
(assert (= x (fp #b1 #b00000000 #b11111110011110111111001)))
;; x should be Float32(0x807F3DF9 [Rational(-8338937, 713623846352979940529142984724747568191373312), -0.000000])
