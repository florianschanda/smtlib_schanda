...
(assert (= y (fp #b0 #b01110011 #b11110101101001100010010)))
;; y should be Float32(0x39FAD312 [Rational(8219017, 17179869184), 0.000478])
...
(assert (not (= result (fp #b1 #b00000000 #b11111111111000001010001))))
(check-sat)
(exit)
