...
(assert (= z ((_ to_fp 8 24) #x7C51E3D1)))
;; z should be Float32(0x7C51E3D1 [Rational(4359242836399093539182667238138183680), 4359242836399093539182667238138183680.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b11111000 #b10100011110001111010000)))
(check-sat)
(exit)
