...
(assert (= x (fp #b1 #b00000000 #b10100101111110011000000)))
;; x should be Float32(0x8052FCC0 [Rational(-84979, 11150372599265311570767859136324180752990208), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFE561FA)))
