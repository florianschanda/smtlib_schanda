...
(assert (= z (fp #b1 #b00000000 #b11100011011101111111011)))
;; z should be Float32(0x8071BBFB [Rational(-7453691, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x8071BBFB)))
(check-sat)
(exit)
