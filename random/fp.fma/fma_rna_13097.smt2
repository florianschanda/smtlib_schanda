...
(assert (= x (fp #b1 #b00000000 #b00011100100001101001111)))
;; x should be Float32(0x800E434F [Rational(-934735, 713623846352979940529142984724747568191373312), -0.000000])
