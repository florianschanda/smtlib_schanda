...
(assert (= x (fp #b1 #b10010100 #b11010100000011101101010)))
;; x should be Float32(0xCA6A076A [Rational(-7668661, 2), -3834330.500000])
...
(assert (= result (fp #b1 #b00000000 #b10001010111111000100100)))
(check-sat)
(exit)
