...
(assert (= z (fp #b1 #b00000000 #b10001111010000100100000)))
;; z should be Float32(0x8047A120 [Rational(-146697, 22300745198530623141535718272648361505980416), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8047A120))))
(check-sat)
(exit)
