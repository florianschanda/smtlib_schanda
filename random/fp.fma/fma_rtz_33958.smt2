...
(assert (= x (fp #b0 #b11111111 #b01011101101110000101101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10010011 #b11000011100001110101100)))
;; y should be Float32(0x49E1C3AC [Rational(3698923, 2), 1849461.500000])
