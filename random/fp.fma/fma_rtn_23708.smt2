...
(assert (= x (fp #b0 #b00000000 #b10110001101000011001111)))
;; x should be Float32(0x0058D0CF [Rational(5820623, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC031A19E)))
(check-sat)
(exit)
