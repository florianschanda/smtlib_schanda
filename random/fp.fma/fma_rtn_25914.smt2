...
(assert (= z ((_ to_fp 8 24) #xF5B459ED)))
;; z should be Float32(0xF5B459ED [Rational(-457244797883549732642202302021632), -457244797883549732642202302021632.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b11101011 #b01101000101100111101101)))
(check-sat)
(exit)
