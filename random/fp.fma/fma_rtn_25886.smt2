...
(assert (= z (fp #b0 #b01010110 #b00000000110000111010111)))
;; z should be Float32(0x2B0061D7 [Rational(8413655, 18446744073709551616), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b01010110 #b00000000110000111010111))))
(check-sat)
(exit)
