...
(assert (= x (fp #b0 #b11011110 #b01011001111001101100100)))
;; x should be Float32(0x6F2CF364 [Rational(53525662900085993674637312000), 53525662900085993674637312000.000000])
...
(assert (= result ((_ to_fp 8 24) #xB02CF362)))
(check-sat)
(exit)
