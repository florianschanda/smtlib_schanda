...
(assert (= x ((_ to_fp 8 24) #xCAA2B775)))
;; x should be Float32(0xCAA2B775 [Rational(-10663797, 2), -5331898.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01000101011011101110011))))
(check-sat)
(exit)
