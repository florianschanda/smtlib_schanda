...
(assert (= z (fp #b1 #b01111101 #b01011101100001010101110)))
;; z should be Float32(0xBEAEC2AE [Rational(-5726551, 16777216), -0.341329])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b01111101 #b01011101100001010101110))))
(check-sat)
(exit)
