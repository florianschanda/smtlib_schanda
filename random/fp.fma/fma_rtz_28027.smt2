...
(assert (= x ((_ to_fp 8 24) #x49C82484)))
;; x should be Float32(0x49C82484 [Rational(3279137, 2), 1639568.500000])
...
(assert (= z (fp #b0 #b10010101 #b00010101101110000100111)))
;; z should be Float32(0x4A8ADC27 [Rational(9100327, 2), 4550163.500000])
