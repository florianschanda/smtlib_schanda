...
(assert (= z (fp #b1 #b10010100 #b00101011011101101010010)))
;; z should be Float32(0xCA15BB52 [Rational(-4906409, 2), -2453204.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010100 #b00101011011101101100010))))
(check-sat)
(exit)
