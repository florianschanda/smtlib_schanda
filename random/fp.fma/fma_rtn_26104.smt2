...
(assert (= z (fp #b1 #b10000000 #b11100011001011001110101)))
;; z should be Float32(0xC0719675 [Rational(-15832693, 4194304), -3.774808])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10000000 #b11100011001011001110110)))
(check-sat)
(exit)
