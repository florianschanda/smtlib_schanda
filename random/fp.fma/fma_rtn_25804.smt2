...
(assert (= z (fp #b0 #b10010100 #b10101000110011111101110)))
;; z should be Float32(0x4A5467EE [Rational(6960119, 2), 3480059.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010100 #b10101000110011111101110))))
(check-sat)
(exit)
