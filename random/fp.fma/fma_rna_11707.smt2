...
(assert (= y (fp #b0 #b00000000 #b00110010100110010001010)))
;; y should be Float32(0x00194C8A [Rational(828997, 356811923176489970264571492362373784095686656), 0.000000])
