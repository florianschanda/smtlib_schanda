...
(assert (= z ((_ to_fp 8 24) #x80028DDA)))
;; z should be Float32(0x80028DDA [Rational(-83693, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80028DDA))))
(check-sat)
(exit)
