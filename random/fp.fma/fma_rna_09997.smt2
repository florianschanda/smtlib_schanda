...
(assert (= x (fp #b0 #b00000000 #b00010000100101100001010)))
;; x should be Float32(0x00084B0A [Rational(271749, 356811923176489970264571492362373784095686656), 0.000000])
