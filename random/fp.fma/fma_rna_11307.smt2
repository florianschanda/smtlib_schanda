...
(assert (= z ((_ to_fp 8 24) #x4AA5FAE5)))
;; z should be Float32(0x4AA5FAE5 [Rational(10877669, 2), 5438834.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01001011111101011100101))))
(check-sat)
(exit)
