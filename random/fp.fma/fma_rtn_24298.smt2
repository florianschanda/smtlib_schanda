...
(assert (= x (fp #b1 #b10010011 #b10011011011101010001100)))
;; x should be Float32(0xC9CDBA8C [Rational(-3370659, 2), -1685329.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b10011011011101010001101))))
(check-sat)
(exit)
