...
(assert (= x (fp #b0 #b00000000 #b11111011111100000011110)))
;; x should be Float32(0x007DF81E [Rational(4127759, 356811923176489970264571492362373784095686656), 0.000000])
