...
(assert (= x (fp #b0 #b00000000 #b11011110011001000000101)))
;; x should be Float32(0x006F3205 [Rational(7287301, 713623846352979940529142984724747568191373312), 0.000000])
