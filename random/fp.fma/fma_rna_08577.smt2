...
(assert (= z (fp #b0 #b10110101 #b10110000100000101111010)))
;; z should be Float32(0x5AD8417A [Rational(30435293605658624), 30435293605658624.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x5AD8417A)))
(check-sat)
(exit)
