...
(assert (= y ((_ to_fp 8 24) #x8075CF4C)))
;; y should be Float32(0x8075CF4C [Rational(-1930195, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b11010111001111010010111))))
(check-sat)
(exit)
