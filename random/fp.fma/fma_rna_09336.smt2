...
(assert (= y (fp #b1 #b10100110 #b00011011110000101000101)))
;; y should be Float32(0xD30DE145 [Rational(-609369784320), -609369784320.000000])
...
(assert (= result (fp #b1 #b00010001 #b00011011110000101000101)))
(check-sat)
(exit)
