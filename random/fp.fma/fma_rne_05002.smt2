...
(assert (= y ((_ to_fp 8 24) #xD0486D8D)))
;; y should be Float32(0xD0486D8D [Rational(-13450490880), -13450490880.000000])
...
(assert (= result (fp #b0 #b00100010 #b10010000110110110001011)))
(check-sat)
(exit)
