...
(assert (= y (fp #b0 #b10010001 #b01001010111101001010000)))
;; y should be Float32(0x48A57A50 [Rational(677797, 2), 338898.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x4AA8A56F)))
;; z should be Float32(0x4AA8A56F [Rational(11052399, 2), 5526199.500000])
