...
(assert (= z ((_ to_fp 8 24) #x00598BB6)))
;; z should be Float32(0x00598BB6 [Rational(2934235, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00598BB5))))
(check-sat)
(exit)
