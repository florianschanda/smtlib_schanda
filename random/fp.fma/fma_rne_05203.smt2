...
(assert (= y (fp #b0 #b01110010 #b10101010111100010100010)))
;; y should be Float32(0x395578A2 [Rational(6995025, 34359738368), 0.000204])
...
(assert (= result ((_ to_fp 8 24) #x800006AD)))
(check-sat)
(exit)
