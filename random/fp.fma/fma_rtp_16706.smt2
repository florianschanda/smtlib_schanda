...
(assert (= x (fp #b0 #b00000000 #b00101010100011001101011)))
;; x should be Float32(0x0015466B [Rational(1394283, 713623846352979940529142984724747568191373312), 0.000000])
