...
(assert (= y (fp #b1 #b00000000 #b10101111110000001011100)))
;; y should be Float32(0x8057E05C [Rational(-1439767, 178405961588244985132285746181186892047843328), -0.000000])
