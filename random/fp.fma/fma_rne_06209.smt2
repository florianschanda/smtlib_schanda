...
(assert (= x ((_ to_fp 8 24) #x802E6317)))
;; x should be Float32(0x802E6317 [Rational(-3040023, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBFB98C5B)))
(check-sat)
(exit)
