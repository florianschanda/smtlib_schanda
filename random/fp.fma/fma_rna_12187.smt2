...
(assert (= z ((_ to_fp 8 24) #x09907159)))
;; z should be Float32(0x09907159 [Rational(9466201, 2722258935367507707706996859454145691648), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x09907159)))
(check-sat)
(exit)
