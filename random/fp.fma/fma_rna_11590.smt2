...
(assert (= y (fp #b0 #b10010101 #b01101011101001111010011)))
;; y should be Float32(0x4AB5D3D3 [Rational(11916243, 2), 5958121.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b01110011001010100011011)))
