...
(assert (= x (fp #b1 #b10010101 #b10101100011001001000111)))
;; x should be Float32(0xCAD63247 [Rational(-14037575, 2), -7018787.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11010000000101101111000)))
