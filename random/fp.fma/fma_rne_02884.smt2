...
(assert (= x (fp #b0 #b11000000 #b00100001000001100000010)))
;; x should be Float32(0x60108302 [Rational(41652675849735897088), 41652675849735897088.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFF87C3E)))
