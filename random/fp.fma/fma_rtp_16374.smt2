...
(assert (= x (fp #b0 #b10011101 #b00100010011101101100010)))
;; x should be Float32(0x4E913B62 [Rational(1218294016), 1218294016.000000])
...
(assert (= result (fp #b0 #b00001000 #b00100000011101101100010)))
(check-sat)
(exit)
