...
(assert (= y ((_ to_fp 8 24) #xED0C4E0C)))
;; y should be Float32(0xED0C4E0C [Rational(-2713890891082252820802437120), -2713890891082252820802437120.000000])
...
(assert (= result ((_ to_fp 8 24) #x2E0C4E0C)))
(check-sat)
(exit)
