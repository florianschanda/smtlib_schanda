...
(assert (= x ((_ to_fp 8 24) #xCABB132B)))
;; x should be Float32(0xCABB132B [Rational(-12260139, 2), -6130069.500000])
...
(assert (= z (fp #b1 #b10010101 #b01001011100111100011101)))
;; z should be Float32(0xCAA5CF1D [Rational(-10866461, 2), -5433230.500000])
