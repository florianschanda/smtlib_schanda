...
(assert (= x (fp #b0 #b00000000 #b11001101000000011011101)))
;; x should be Float32(0x006680DD [Rational(6717661, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b0 #b10000000 #b10011010000000110111010)))
(check-sat)
(exit)
