...
(assert (= z (fp #b1 #b10010100 #b01000001001001001001110)))
;; z should be Float32(0xCA20924E [Rational(-5261607, 2), -2630803.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010100 #b01000001001001001001110)))
(check-sat)
(exit)
