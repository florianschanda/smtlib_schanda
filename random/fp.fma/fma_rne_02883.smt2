...
(assert (= x ((_ to_fp 8 24) #x584767C4)))
;; x should be Float32(0x584767C4 [Rational(876993935572992), 876993935572992.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b00101100110111000101011)))
