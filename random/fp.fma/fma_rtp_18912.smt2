...
(assert (= y ((_ to_fp 8 24) #x4C9055E4)))
;; y should be Float32(0x4C9055E4 [Rational(75673376), 75673376.000000])
...
(assert (not (= result (fp #b1 #b00011011 #b00100000101010111100011))))
(check-sat)
(exit)
