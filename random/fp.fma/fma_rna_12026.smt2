...
(assert (= z ((_ to_fp 8 24) #x803C00D9)))
;; z should be Float32(0x803C00D9 [Rational(-3932377, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01111000000000011011001))))
(check-sat)
(exit)
