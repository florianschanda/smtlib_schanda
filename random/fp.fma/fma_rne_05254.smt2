...
(assert (= y ((_ to_fp 8 24) #xC9F4B5F4)))
;; y should be Float32(0xC9F4B5F4 [Rational(-4009341, 2), -2004670.500000])
...
(assert (not (= result (fp #b0 #b00010101 #b11101001011010111110100))))
(check-sat)
(exit)
