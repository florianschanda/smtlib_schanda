...
(assert (= x (fp #b1 #b00000000 #b01000111000100101110111)))
;; x should be Float32(0x80238977 [Rational(-2328951, 713623846352979940529142984724747568191373312), -0.000000])
