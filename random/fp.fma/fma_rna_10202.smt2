...
(assert (= z ((_ to_fp 8 24) #x800DFFB5)))
;; z should be Float32(0x800DFFB5 [Rational(-917429, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00011011111111110110101))))
(check-sat)
(exit)
