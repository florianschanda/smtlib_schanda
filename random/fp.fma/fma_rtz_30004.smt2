...
(assert (= x (fp #b0 #b11011101 #b10000100001101011001010)))
;; x should be Float32(0x6EC21ACA [Rational(30036238947340231679741526016), 30036238947340231679741526016.000000])
