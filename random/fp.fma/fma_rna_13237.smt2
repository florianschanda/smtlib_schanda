...
(assert (= x (fp #b1 #b00000000 #b10100010000100011100100)))
;; x should be Float32(0x805108E4 [Rational(-1327673, 178405961588244985132285746181186892047843328), -0.000000])
