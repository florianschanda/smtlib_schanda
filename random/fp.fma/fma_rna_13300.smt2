...
(assert (= x ((_ to_fp 8 24) #x805FA686)))
;; x should be Float32(0x805FA686 [Rational(-3134275, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFFFAF47)))
