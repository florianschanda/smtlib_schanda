...
(assert (= z ((_ to_fp 8 24) #x806F862A)))
;; z should be Float32(0x806F862A [Rational(-3654421, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x806F862B))))
(check-sat)
(exit)
