...
(assert (= z ((_ to_fp 8 24) #x1C878801)))
;; z should be Float32(0x1C878801 [Rational(8882177, 9903520314283042199192993792), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x1C878801))))
(check-sat)
(exit)
