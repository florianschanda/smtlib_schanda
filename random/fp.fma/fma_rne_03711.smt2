...
(assert (= x ((_ to_fp 8 24) #xCA2C548A)))
;; x should be Float32(0xCA2C548A [Rational(-5646917, 2), -2823458.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b01011000101010010000110))))
(check-sat)
(exit)
