...
(assert (= x (fp #b1 #b00000000 #b00110010111000011001101)))
;; x should be Float32(0x801970CD [Rational(-1667277, 713623846352979940529142984724747568191373312), -0.000000])
