...
(assert (= y (fp #b1 #b00000000 #b10011100101101011010100)))
;; y should be Float32(0x804E5AD4 [Rational(-1283765, 178405961588244985132285746181186892047843328), -0.000000])
