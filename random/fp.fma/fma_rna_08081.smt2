...
(assert (= y ((_ to_fp 8 24) #x27743A41)))
;; y should be Float32(0x27743A41 [Rational(16005697, 4722366482869645213696), 0.000000])
...
(assert (not (= result (fp #b0 #b11001110 #b11101000011101001000000))))
(check-sat)
(exit)
