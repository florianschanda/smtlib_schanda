...
(assert (= z (fp #b1 #b10101000 #b00000111011111000111010)))
;; z should be Float32(0xD403BE3A [Rational(-2263328751616), -2263328751616.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xD403BE3A)))
(check-sat)
(exit)
