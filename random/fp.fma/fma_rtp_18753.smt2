...
(assert (= y (fp #b1 #b00000000 #b01001100100110000100011)))
;; y should be Float32(0x80264C23 [Rational(-2509859, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7F8F3118)))
