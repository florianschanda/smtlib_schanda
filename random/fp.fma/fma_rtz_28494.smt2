...
(assert (= y (fp #b1 #b00000000 #b00110010010000010000010)))
;; y should be Float32(0x80192082 [Rational(-823361, 356811923176489970264571492362373784095686656), -0.000000])
