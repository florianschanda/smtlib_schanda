...
(assert (= z ((_ to_fp 8 24) #x6C872A7D)))
;; z should be Float32(0x6C872A7D [Rational(1307245047066117419026087936), 1307245047066117419026087936.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b11011001 #b00001110010101001111101)))
(check-sat)
(exit)
