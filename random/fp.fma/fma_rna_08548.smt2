...
(assert (= z (fp #b1 #b01111101 #b11110011101000110111101)))
;; z should be Float32(0xBEF9D1BD [Rational(-16372157, 33554432), -0.487928])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10000001 #b00011111001110100011010)))
(check-sat)
(exit)
