...
(assert (= x (fp #b0 #b00000000 #b10000001111000000110010)))
;; x should be Float32(0x0040F032 [Rational(2127897, 356811923176489970264571492362373784095686656), 0.000000])
