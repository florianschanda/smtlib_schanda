...
(assert (= x (fp #b1 #b11100111 #b00010110111010011110110)))
;; x should be Float32(0xF38B74F6 [Rational(-22097824492747288304503322836992), -22097824492747288304503322836992.000000])
