...
(assert (= y ((_ to_fp 8 24) #x4EF8603A)))
;; y should be Float32(0x4EF8603A [Rational(2083527936), 2083527936.000000])
...
(assert (not (= result (fp #b0 #b00011111 #b11110000110000000111000))))
(check-sat)
(exit)
