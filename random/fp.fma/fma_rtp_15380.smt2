...
(assert (= z (fp #b0 #b00000000 #b10111100000111100111010)))
;; z should be Float32(0x005E0F3A [Rational(3082141, 356811923176489970264571492362373784095686656), 0.000000])
