...
(assert (= z (fp #b0 #b11100111 #b10000110011101111010001)))
;; z should be Float32(0x73C33BD1 [Rational(30936007942714609294586691977216), 30936007942714609294586691977216.000000])
