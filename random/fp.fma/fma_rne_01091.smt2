...
(assert (= z (fp #b0 #b00000101 #b00111110001101110000100)))
;; z should be Float32(0x029F1B84 [Rational(2606817, 11150372599265311570767859136324180752990208), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x029F1B84)))
(check-sat)
(exit)
