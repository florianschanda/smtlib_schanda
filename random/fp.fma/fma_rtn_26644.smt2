...
(assert (= x (fp #b1 #b10001111 #b10100101100100000100001)))
;; x should be Float32(0xC7D2C821 [Rational(-13813793, 128), -107920.257812])
...
(assert (not (= result (fp #b0 #b00000001 #b00000011010010110010000))))
(check-sat)
(exit)
