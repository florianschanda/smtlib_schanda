...
(assert (= y ((_ to_fp 8 24) #x7FA23642)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x0046F082)))
;; z should be Float32(0x0046F082 [Rational(2324545, 356811923176489970264571492362373784095686656), 0.000000])
