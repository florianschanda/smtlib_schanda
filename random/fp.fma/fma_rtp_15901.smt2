...
(assert (= z ((_ to_fp 8 24) #xE72F8DCC)))
;; z should be Float32(0xE72F8DCC [Rational(-829029825165764696473600), -829029825165764696473600.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b11001110 #b01011111000110111001100)))
(check-sat)
(exit)
