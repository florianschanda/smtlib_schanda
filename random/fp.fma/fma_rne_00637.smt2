...
(assert (= x ((_ to_fp 8 24) #x4931CC88)))
;; x should be Float32(0x4931CC88 [Rational(1456529, 2), 728264.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b01100011100110010001000))))
(check-sat)
(exit)
