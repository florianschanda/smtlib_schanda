...
(assert (= y (fp #b1 #b00000101 #b10101010011001000111011)))
;; y should be Float32(0x82D5323B [Rational(-13972027, 44601490397061246283071436545296723011960832), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x42D5323A)))
(check-sat)
(exit)
