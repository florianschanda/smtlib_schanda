...
(assert (= z (fp #b0 #b00101110 #b00101110111011001111110)))
;; z should be Float32(0x1717767E [Rational(4963135, 10141204801825835211973625643008), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00101110 #b00101110111011001111111)))
(check-sat)
(exit)
