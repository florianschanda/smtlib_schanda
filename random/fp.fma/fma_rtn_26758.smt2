...
(assert (= x (fp #b1 #b00000000 #b01000010111111011001011)))
;; x should be Float32(0x80217ECB [Rational(-2195147, 713623846352979940529142984724747568191373312), -0.000000])
