...
(assert (= x (fp #b1 #b00000000 #b00011111010000001110001)))
;; x should be Float32(0x800FA071 [Rational(-1024113, 713623846352979940529142984724747568191373312), -0.000000])
