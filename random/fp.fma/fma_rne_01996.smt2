...
(assert (= y (fp #b1 #b10010001 #b00000011001100110010000)))
;; y should be Float32(0xC8819990 [Rational(-530841, 2), -265420.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x89819990))))
(check-sat)
(exit)
