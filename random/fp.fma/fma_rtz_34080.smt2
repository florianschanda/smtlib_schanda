...
(assert (= x ((_ to_fp 8 24) #x7FB7266A)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b01101001 #b10000101001110010100111)))
;; y should be Float32(0x34C29CA7 [Rational(12754087, 35184372088832), 0.000000])
