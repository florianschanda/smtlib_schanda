...
(assert (= x (fp #b1 #b01000101 #b11100100110011111010100)))
;; x should be Float32(0xA2F267D4 [Rational(-3971573, 604462909807314587353088), -0.000000])
...
(assert (not (= result (fp #b0 #b11000101 #b11100100110011111010011))))
(check-sat)
(exit)
