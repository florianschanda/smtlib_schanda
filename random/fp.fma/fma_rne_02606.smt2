...
(assert (= x (fp #b0 #b11101001 #b01011100011001110010011)))
;; x should be Float32(0x74AE3393 [Rational(110413293800626933522162344001536), 110413293800626933522162344001536.000000])
