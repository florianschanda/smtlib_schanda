...
(assert (= y (fp #b1 #b00011011 #b01010000101100110101101)))
;; y should be Float32(0x8DA859AD [Rational(-11033005, 10633823966279326983230456482242756608), -0.000000])
...
(assert (not (= result (fp #b1 #b10011011 #b01010000101100110101100))))
(check-sat)
(exit)
