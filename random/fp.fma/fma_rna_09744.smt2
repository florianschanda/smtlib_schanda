...
(assert (= x (fp #b0 #b00101000 #b11001101111110010011110)))
;; x should be Float32(0x1466FC9E [Rational(7568975, 649037107316853453566312041152512), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00001101000010100111000)))
