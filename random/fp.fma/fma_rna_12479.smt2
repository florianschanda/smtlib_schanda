...
(assert (= y ((_ to_fp 8 24) #xC9A4FF64)))
;; y should be Float32(0xC9A4FF64 [Rational(-2703321, 2), -1351660.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b11010110110000000010100))))
(check-sat)
(exit)
