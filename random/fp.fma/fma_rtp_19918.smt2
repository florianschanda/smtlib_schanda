...
(assert (= x ((_ to_fp 8 24) #x801645B6)))
;; x should be Float32(0x801645B6 [Rational(-729819, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBF322DAF)))
(check-sat)
(exit)
