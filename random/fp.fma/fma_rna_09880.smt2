...
(assert (= x ((_ to_fp 8 24) #x003C484E)))
;; x should be Float32(0x003C484E [Rational(1975335, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFCE228B)))
