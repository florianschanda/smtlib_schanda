...
(assert (= y (fp #b0 #b00000000 #b11110010110100011010010)))
;; y should be Float32(0x007968D2 [Rational(3978345, 356811923176489970264571492362373784095686656), 0.000000])
