...
(assert (= x (fp #b0 #b00000000 #b00001101010111010011100)))
;; x should be Float32(0x0006AE9C [Rational(109479, 178405961588244985132285746181186892047843328), 0.000000])
