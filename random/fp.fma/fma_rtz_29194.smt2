...
(assert (= y (fp #b1 #b10100010 #b01101010111101100010110)))
;; y should be Float32(0xD1357B16 [Rational(-48715882496), -48715882496.000000])
...
(assert (not (= result (fp #b1 #b00100100 #b01101010111101100010100))))
(check-sat)
(exit)
