...
(assert (= z (fp #b1 #b11010011 #b11000011101010000110011)))
;; z should be Float32(0xE9E1D433 [Rational(-34126298986450961035165696), -34126298986450961035165696.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE9E1D434))))
(check-sat)
(exit)
