...
(assert (= z (fp #b0 #b10010101 #b01100110100000111001101)))
;; z should be Float32(0x4AB341CD [Rational(11747789, 2), 5873894.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x4AB341CD)))
(check-sat)
(exit)
