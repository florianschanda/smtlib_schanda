...
(assert (= z ((_ to_fp 8 24) #xCAFF9E7D)))
;; z should be Float32(0xCAFF9E7D [Rational(-16752253, 2), -8376126.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b11111111001111001111101)))
(check-sat)
(exit)
