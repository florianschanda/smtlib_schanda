...
(assert (= x ((_ to_fp 8 24) #xFFA9025F)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x8BA55494)))
;; y should be Float32(0x8BA55494 [Rational(-2708773, 42535295865117307932921825928971026432), -0.000000])
