...
(assert (= z ((_ to_fp 8 24) #xCABF4173)))
;; z should be Float32(0xCABF4173 [Rational(-12534131, 2), -6267065.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010101 #b01111110100000101110011))))
(check-sat)
(exit)
