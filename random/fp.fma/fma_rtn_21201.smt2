...
(assert (= x (fp #b0 #b10010101 #b01111010011101001101011)))
;; x should be Float32(0x4ABD3A6B [Rational(12401259, 2), 6200629.500000])
...
(assert (= result (fp #b1 #b00010111 #b01111010011101001101010)))
(check-sat)
(exit)
