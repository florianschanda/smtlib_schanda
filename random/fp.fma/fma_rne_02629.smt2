...
(assert (= x (fp #b0 #b11011001 #b10101001010101011110100)))
;; x should be Float32(0x6CD4AAF4 [Rational(2056796616527545678837055488), 2056796616527545678837055488.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x2DD4AAF4))))
(check-sat)
(exit)
