...
(assert (= x (fp #b0 #b00000000 #b10000010001110001101101)))
;; x should be Float32(0x00411C6D [Rational(4267117, 713623846352979940529142984724747568191373312), 0.000000])
