...
(assert (= z (fp #b1 #b00000000 #b01000110001101110101100)))
;; z should be Float32(0x80231BAC [Rational(-575211, 178405961588244985132285746181186892047843328), -0.000000])
