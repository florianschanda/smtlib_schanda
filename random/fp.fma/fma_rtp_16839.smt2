...
(assert (= x (fp #b0 #b00000000 #b01110011011001011100110)))
;; x should be Float32(0x0039B2E6 [Rational(1890675, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b11001101100101110010111))))
(check-sat)
(exit)
