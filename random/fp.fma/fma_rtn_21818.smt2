...
(assert (= y ((_ to_fp 8 24) #x004C4279)))
;; y should be Float32(0x004C4279 [Rational(4997753, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x401884F1)))
(check-sat)
(exit)
