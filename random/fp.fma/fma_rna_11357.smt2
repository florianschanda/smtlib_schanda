...
(assert (= y (fp #b0 #b00000000 #b11111110111001100100011)))
;; y should be Float32(0x007F7323 [Rational(8352547, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b1 #b10000000 #b11111101110011001000101)))
(check-sat)
(exit)
