...
(assert (= x (fp #b0 #b00000000 #b11110011101111100001001)))
;; x should be Float32(0x0079DF09 [Rational(7986953, 713623846352979940529142984724747568191373312), 0.000000])
