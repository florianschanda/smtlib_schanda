...
(assert (= x ((_ to_fp 8 24) #x7A57E7B9)))
;; x should be Float32(0x7A57E7B9 [Rational(280260929603374153726110832865050624), 280260929603374153726110832865050624.000000])
...
(assert (= result ((_ to_fp 8 24) #x2FD7E7B8)))
(check-sat)
(exit)
