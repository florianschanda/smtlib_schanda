...
(assert (= x ((_ to_fp 8 24) #x15DA9CC3)))
;; x should be Float32(0x15DA9CC3 [Rational(14326979, 162259276829213363391578010288128), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFC99C0D)))
