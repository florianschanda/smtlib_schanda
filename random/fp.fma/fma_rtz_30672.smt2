...
(assert (= x (fp #b0 #b00000000 #b00001011011111101101010)))
;; x should be Float32(0x0005BF6A [Rational(188341, 356811923176489970264571492362373784095686656), 0.000000])
