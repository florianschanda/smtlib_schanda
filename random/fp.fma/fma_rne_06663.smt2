...
(assert (= x (fp #b0 #b11111111 #b10101010100000011011100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x0020E0E5)))
;; y should be Float32(0x0020E0E5 [Rational(2154725, 713623846352979940529142984724747568191373312), 0.000000])
