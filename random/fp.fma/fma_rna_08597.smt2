...
(assert (= z ((_ to_fp 8 24) #x006BD20B)))
;; z should be Float32(0x006BD20B [Rational(7066123, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11010111101001000001011))))
(check-sat)
(exit)
