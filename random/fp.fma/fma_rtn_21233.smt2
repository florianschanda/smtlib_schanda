...
(assert (= x (fp #b0 #b10010101 #b01000101101111000001111)))
;; x should be Float32(0x4AA2DE0F [Rational(10673679, 2), 5336839.500000])
...
(assert (= result (fp #b1 #b00000000 #b10100010110111100001000)))
(check-sat)
(exit)
