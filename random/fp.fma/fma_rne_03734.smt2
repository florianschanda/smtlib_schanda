...
(assert (= x ((_ to_fp 8 24) #xCA0DE24A)))
;; x should be Float32(0xCA0DE24A [Rational(-4649253, 2), -2324626.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01000110111100010010010))))
(check-sat)
(exit)
