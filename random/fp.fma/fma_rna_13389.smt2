...
(assert (= x (fp #b1 #b11111111 #b00000010011011110100100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10010001 #b01000110100011010010000)))
;; y should be Float32(0x48A34690 [Rational(668777, 2), 334388.500000])
