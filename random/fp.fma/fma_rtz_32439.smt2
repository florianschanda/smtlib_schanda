...
(assert (= y ((_ to_fp 8 24) #xFAE1D12A)))
;; y should be Float32(0xFAE1D12A [Rational(-586254572180162507320072789219606528), -586254572180162507320072789219606528.000000])
...
(assert (not (= result (fp #b0 #b01110111 #b11000011101000100101000))))
(check-sat)
(exit)
