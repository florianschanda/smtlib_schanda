...
(assert (= y ((_ to_fp 8 24) #xFC5098EE)))
;; y should be Float32(0xFC5098EE [Rational(-4332398116550710382204521928533737472), -4332398116550710382204521928533737472.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3D5098ED))))
(check-sat)
(exit)
