...
(assert (= x ((_ to_fp 8 24) #x6C7C5AA6)))
;; x should be Float32(0x6C7C5AA6 [Rational(1220309526743444223523028992), 1220309526743444223523028992.000000])
...
(assert (= result (fp #b1 #b01011010 #b11111000101101010100101)))
(check-sat)
(exit)
