...
(assert (= y (fp #b0 #b00000000 #b10010100100100101100010)))
;; y should be Float32(0x004A4962 [Rational(2434225, 356811923176489970264571492362373784095686656), 0.000000])
