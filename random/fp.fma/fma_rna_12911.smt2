...
(assert (= x (fp #b1 #b10000100 #b01000110000011010010010)))
;; x should be Float32(0xC2230692 [Rational(-5342025, 131072), -40.756416])
...
(assert (= result (fp #b0 #b00000110 #b01000110000011010010010)))
(check-sat)
(exit)
