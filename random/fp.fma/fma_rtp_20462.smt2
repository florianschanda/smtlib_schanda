...
(assert (= x ((_ to_fp 8 24) #x7FEFFF11)))
...
(assert (= z ((_ to_fp 8 24) #x80172366)))
;; z should be Float32(0x80172366 [Rational(-758195, 356811923176489970264571492362373784095686656), -0.000000])
