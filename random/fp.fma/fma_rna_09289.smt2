...
(assert (= z (fp #b1 #b01100001 #b11001111000100001001111)))
;; z should be Float32(0xB0E7884F [Rational(-15173711, 9007199254740992), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b01100001 #b11001111000100001001111)))
(check-sat)
(exit)
