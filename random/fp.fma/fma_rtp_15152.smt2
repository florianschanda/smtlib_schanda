...
(assert (= y ((_ to_fp 8 24) #xFFC8896E)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x00642810)))
;; z should be Float32(0x00642810 [Rational(410241, 44601490397061246283071436545296723011960832), 0.000000])
