...
(assert (= z (fp #b1 #b10010101 #b00101100111101110101101)))
;; z should be Float32(0xCA967BAD [Rational(-9862061, 2), -4931030.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00101100111101110101101))))
(check-sat)
(exit)
