...
(assert (= x ((_ to_fp 8 24) #x5D7AF9E8)))
;; x should be Float32(0x5D7AF9E8 [Rational(1130296304086286336), 1130296304086286336.000000])
...
(assert (= result ((_ to_fp 8 24) #x9E7AF9E8)))
(check-sat)
(exit)
