...
(assert (= z ((_ to_fp 8 24) #xCF398C18)))
;; z should be Float32(0xCF398C18 [Rational(-3112966144), -3112966144.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10011110 #b01110011000110000011000)))
(check-sat)
(exit)
