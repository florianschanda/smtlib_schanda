...
(assert (= x (fp #b0 #b00000000 #b00111000100001110011010)))
;; x should be Float32(0x001C439A [Rational(926157, 356811923176489970264571492362373784095686656), 0.000000])
