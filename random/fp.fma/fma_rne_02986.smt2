...
(assert (= x (fp #b0 #b00000000 #b01100101001101101111110)))
;; x should be Float32(0x00329B7E [Rational(1658303, 356811923176489970264571492362373784095686656), 0.000000])
