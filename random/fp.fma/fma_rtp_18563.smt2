...
(assert (= y (fp #b0 #b10011111 #b00100111101000000101010)))
;; y should be Float32(0x4F93D02A [Rational(4959785984), 4959785984.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b11100110010001110000110)))
