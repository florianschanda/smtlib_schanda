...
(assert (= x (fp #b0 #b00000000 #b01010111001011111000111)))
;; x should be Float32(0x002B97C7 [Rational(2856903, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFAE5F1B))))
(check-sat)
(exit)
