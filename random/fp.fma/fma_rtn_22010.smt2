...
(assert (= y (fp #b0 #b11111111 #b11101100110000001011111)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b01101111 #b00000111010110110011110)))
;; z should be Float32(0x3783AD9E [Rational(4314831, 274877906944), 0.000016])
