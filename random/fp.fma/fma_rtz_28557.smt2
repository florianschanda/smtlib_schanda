...
(assert (= y (fp #b0 #b10010101 #b10100000111111110001001)))
;; y should be Float32(0x4AD07F89 [Rational(13664137, 2), 6832068.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b00000001110111001011001)))
