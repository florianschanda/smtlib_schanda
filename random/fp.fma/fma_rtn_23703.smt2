...
(assert (= x ((_ to_fp 8 24) #x00264737)))
;; x should be Float32(0x00264737 [Rational(2508599, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b00110010001110011011100))))
(check-sat)
(exit)
