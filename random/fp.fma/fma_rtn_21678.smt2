...
(assert (= z (fp #b1 #b00000000 #b10001010101111111010001)))
;; z should be Float32(0x80455FD1 [Rational(-4546513, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80455FD1))))
(check-sat)
(exit)
