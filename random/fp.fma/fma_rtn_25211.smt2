...
(assert (= z ((_ to_fp 8 24) #xDC08C264)))
;; z should be Float32(0xDC08C264 [Rational(-153977326340669440), -153977326340669440.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xDC08C264))))
(check-sat)
(exit)
