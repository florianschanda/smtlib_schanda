...
(assert (= z (fp #b1 #b10010100 #b10101010001000010000110)))
;; z should be Float32(0xCA551086 [Rational(-6981699, 2), -3490849.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010100 #b10101010001000010000110))))
(check-sat)
(exit)
