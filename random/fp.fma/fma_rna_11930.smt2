...
(assert (= z (fp #b1 #b10100100 #b01100011011101110001110)))
;; z should be Float32(0xD231BB8E [Rational(-190838964224), -190838964224.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10100100 #b01100011011101110001110)))
(check-sat)
(exit)
