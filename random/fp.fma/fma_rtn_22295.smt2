...
(assert (= z (fp #b0 #b01101110 #b11101101000111111011000)))
;; z should be Float32(0x37768FD8 [Rational(2019835, 137438953472), 0.000015])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b01101110 #b11101101000111111010111)))
(check-sat)
(exit)
