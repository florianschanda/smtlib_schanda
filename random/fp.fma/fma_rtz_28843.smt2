...
(assert (= y ((_ to_fp 8 24) #x80216F21)))
;; y should be Float32(0x80216F21 [Rational(-2191137, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBF85BC83)))
(check-sat)
(exit)
