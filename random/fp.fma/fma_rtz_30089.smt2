...
(assert (= x (fp #b0 #b11101010 #b11101011010000000010010)))
;; x should be Float32(0x7575A012 [Rational(311367026851694895755830040199168), 311367026851694895755830040199168.000000])
