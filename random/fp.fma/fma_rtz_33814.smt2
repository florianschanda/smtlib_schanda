...
(assert (= x (fp #b1 #b00000000 #b10011100111110001011100)))
;; x should be Float32(0x804E7C5C [Rational(-1285911, 178405961588244985132285746181186892047843328), -0.000000])
