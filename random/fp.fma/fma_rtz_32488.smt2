...
(assert (= y ((_ to_fp 8 24) #xFF8740C5)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x8C2A07EB)))
;; z should be Float32(0x8C2A07EB [Rational(-11143147, 85070591730234615865843651857942052864), -0.000000])
