...
(assert (= y (fp #b0 #b10010010 #b11111110110100111111000)))
;; y should be Float32(0x497F69F8 [Rational(2092351, 2), 1046175.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8A7F69E6))))
(check-sat)
(exit)
