...
(assert (= z (fp #b0 #b10010011 #b11100000000011011100100)))
;; z should be Float32(0x49F006E4 [Rational(3932601, 2), 1966300.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010011 #b11100000000011011100100))))
(check-sat)
(exit)
