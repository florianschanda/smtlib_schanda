...
(assert (= x (fp #b1 #b00100000 #b10001000101101001001111)))
;; x should be Float32(0x90445A4F [Rational(-12868175, 332306998946228968225951765070086144), -0.000000])
...
(assert (= result (fp #b1 #b10100000 #b10001000101101001001110)))
(check-sat)
(exit)
