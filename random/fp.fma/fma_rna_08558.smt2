...
(assert (= z (fp #b0 #b01100101 #b00011010010110011010001)))
;; z should be Float32(0x328D2CD1 [Rational(9252049, 562949953421312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b01100101 #b00011010010110011010001))))
(check-sat)
(exit)
