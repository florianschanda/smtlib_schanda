...
(assert (= z (fp #b1 #b00000000 #b11010111110000101001000)))
;; z should be Float32(0x806BE148 [Rational(-883753, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x806BE149)))
(check-sat)
(exit)
