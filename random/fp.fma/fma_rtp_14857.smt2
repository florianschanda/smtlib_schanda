...
(assert (= z (fp #b1 #b00000000 #b01111101000010100111100)))
;; z should be Float32(0x803E853C [Rational(-1024335, 178405961588244985132285746181186892047843328), -0.000000])
