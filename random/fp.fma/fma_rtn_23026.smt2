...
(assert (= z ((_ to_fp 8 24) #xA491D2C0)))
;; z should be Float32(0xA491D2C0 [Rational(-149323, 2361183241434822606848), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b01001001 #b00100011101001011000001))))
(check-sat)
(exit)
