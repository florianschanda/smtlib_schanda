...
(assert (= x (fp #b1 #b10010101 #b11101101001111001111011)))
;; x should be Float32(0xCAF69E7B [Rational(-16162427, 2), -8081213.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4AD587E3)))
;; y should be Float32(0x4AD587E3 [Rational(13993955, 2), 6996977.500000])
