...
(assert (= z (fp #b0 #b01101110 #b00011010000100100110010)))
;; z should be Float32(0x370D0932 [Rational(4621465, 549755813888), 0.000008])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b01101110 #b00011010000100100110010)))
(check-sat)
(exit)
