...
(assert (= y ((_ to_fp 8 24) #x4987DEC4)))
;; y should be Float32(0x4987DEC4 [Rational(2226097, 2), 1113048.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b11011110000010000100111))))
(check-sat)
(exit)
