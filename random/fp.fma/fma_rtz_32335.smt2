...
(assert (= y ((_ to_fp 8 24) #xC9472828)))
;; y should be Float32(0xC9472828 [Rational(-1631493, 2), -815746.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b10001110010100000100110))))
(check-sat)
(exit)
