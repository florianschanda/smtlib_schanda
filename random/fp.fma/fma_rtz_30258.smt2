...
(assert (= x ((_ to_fp 8 24) #x417389BF)))
;; x should be Float32(0x417389BF [Rational(15960511, 1048576), 15.221129])
...
(assert (not (= result (fp #b1 #b00000000 #b00000000000000000001111))))
(check-sat)
(exit)
