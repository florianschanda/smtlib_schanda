...
(assert (= x ((_ to_fp 8 24) #xF69CDD31)))
;; x should be Float32(0xF69CDD31 [Rational(-1590790243425397125326155963957248), -1590790243425397125326155963957248.000000])
...
(assert (= result ((_ to_fp 8 24) #xB79CDD31)))
(check-sat)
(exit)
