...
(assert (= z ((_ to_fp 8 24) #x179BEFAF)))
;; z should be Float32(0x179BEFAF [Rational(10219439, 10141204801825835211973625643008), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x179BEFAF))))
(check-sat)
(exit)
