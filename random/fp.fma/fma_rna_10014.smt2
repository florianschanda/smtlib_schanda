...
(assert (= x (fp #b0 #b00000000 #b10011001100100100100100)))
;; x should be Float32(0x004CC924 [Rational(1258057, 178405961588244985132285746181186892047843328), 0.000000])
