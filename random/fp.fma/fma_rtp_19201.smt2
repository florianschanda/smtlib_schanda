...
(assert (= z ((_ to_fp 8 24) #xCAD0FE77)))
;; z should be Float32(0xCAD0FE77 [Rational(-13696631, 2), -6848315.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b10100001111111001110111)))
(check-sat)
(exit)
