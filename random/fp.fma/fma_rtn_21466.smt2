...
(assert (= y (fp #b0 #b00000000 #b01100110101011110111110)))
;; y should be Float32(0x003357BE [Rational(1682399, 356811923176489970264571492362373784095686656), 0.000000])
