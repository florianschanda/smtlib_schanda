...
(assert (= y (fp #b1 #b00000000 #b10110111000001111101010)))
;; y should be Float32(0x805B83EA [Rational(-2998773, 356811923176489970264571492362373784095686656), -0.000000])
