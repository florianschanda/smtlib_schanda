...
(assert (= x ((_ to_fp 8 24) #x8006C8D1)))
;; x should be Float32(0x8006C8D1 [Rational(-444625, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FFC4306)))
