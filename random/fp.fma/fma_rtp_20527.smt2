...
(assert (= x (fp #b0 #b11111111 #b01100110100111111100111)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b11010100 #b11100010000110001011010)))
;; y should be Float32(0xEA710C5A [Rational(-72852362782971675176599552), -72852362782971675176599552.000000])
