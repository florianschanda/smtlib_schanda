...
(assert (= x (fp #b0 #b00000000 #b10001111100110011100001)))
;; x should be Float32(0x0047CCE1 [Rational(4705505, 713623846352979940529142984724747568191373312), 0.000000])
