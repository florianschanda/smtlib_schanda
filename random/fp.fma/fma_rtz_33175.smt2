...
(assert (= y (fp #b1 #b00000000 #b10001100110010011111111)))
;; y should be Float32(0x804664FF [Rational(-4613375, 713623846352979940529142984724747568191373312), -0.000000])
