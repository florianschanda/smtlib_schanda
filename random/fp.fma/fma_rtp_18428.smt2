...
(assert (= z (fp #b1 #b00110010 #b01000010100110101000110)))
;; z should be Float32(0x99214D46 [Rational(-5285539, 633825300114114700748351602688), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x99214D46)))
(check-sat)
(exit)
