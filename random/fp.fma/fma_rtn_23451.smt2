...
(assert (= x ((_ to_fp 8 24) #x663BCAC9)))
;; x should be Float32(0x663BCAC9 [Rational(221705814543978651975680), 221705814543978651975680.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10101001100110110000111)))
