...
(assert (= x (fp #b1 #b00011011 #b01110101111010111000000)))
;; x should be Float32(0x8DBAF5C0 [Rational(-191447, 166153499473114484112975882535043072), -0.000000])
...
(assert (not (= result (fp #b0 #b10011011 #b01110101111010110111111))))
(check-sat)
(exit)
