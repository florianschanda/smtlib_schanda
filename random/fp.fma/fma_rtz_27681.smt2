...
(assert (= z ((_ to_fp 8 24) #xE553B16E)))
;; z should be Float32(0xE553B16E [Rational(-62480770495117868924928), -62480770495117868924928.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE553B16E))))
(check-sat)
(exit)
