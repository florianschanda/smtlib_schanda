...
(assert (= z (fp #b0 #b10010101 #b11000001010011000100101)))
;; z should be Float32(0x4AE0A625 [Rational(14722597, 2), 7361298.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AE0A625))))
(check-sat)
(exit)
