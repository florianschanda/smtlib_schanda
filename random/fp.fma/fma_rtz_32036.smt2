...
(assert (= z (fp #b0 #b10010101 #b10111100100000011010111)))
;; z should be Float32(0x4ADE40D7 [Rational(14565591, 2), 7282795.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x4ADE40DE)))
(check-sat)
(exit)
