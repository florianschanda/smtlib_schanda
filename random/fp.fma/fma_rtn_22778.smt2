...
(assert (= y (fp #b0 #b10010100 #b00100100001000100111110)))
;; y should be Float32(0x4A12113E [Rational(4786335, 2), 2393167.500000])
...
(assert (= result (fp #b0 #b00000000 #b01001001000010001001110)))
(check-sat)
(exit)
