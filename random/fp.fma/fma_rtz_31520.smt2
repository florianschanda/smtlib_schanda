...
(assert (= z (fp #b1 #b00000000 #b11101111100110001100101)))
;; z should be Float32(0x8077CC65 [Rational(-7851109, 713623846352979940529142984724747568191373312), -0.000000])
