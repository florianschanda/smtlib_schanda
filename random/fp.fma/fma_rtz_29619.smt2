...
(assert (= z (fp #b1 #b10111010 #b11000011101011011001100)))
;; z should be Float32(0xDD61D6CC [Rational(-1017088662745120768), -1017088662745120768.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10111010 #b11000011101011011001100))))
(check-sat)
(exit)
