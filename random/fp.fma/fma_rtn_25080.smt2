...
(assert (= y ((_ to_fp 8 24) #x0058B68A)))
;; y should be Float32(0x0058B68A [Rational(2906949, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFB33CA9)))
