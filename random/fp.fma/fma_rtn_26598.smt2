...
(assert (= x ((_ to_fp 8 24) #xC186B52E)))
;; x should be Float32(0xC186B52E [Rational(-4414103, 262144), -16.838467])
...
(assert (= z ((_ to_fp 8 24) #xDD176F3F)))
;; z should be Float32(0xDD176F3F [Rational(-682000605710909440), -682000605710909440.000000])
