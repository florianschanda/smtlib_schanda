...
(assert (= z (fp #b0 #b10010101 #b10001011110011011101111)))
;; z should be Float32(0x4AC5E6EF [Rational(12969711, 2), 6484855.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x4AC5E6EF)))
(check-sat)
(exit)
