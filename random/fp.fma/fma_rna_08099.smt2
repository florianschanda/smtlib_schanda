...
(assert (= y (fp #b0 #b00000000 #b11000011000110110011011)))
;; y should be Float32(0x00618D9B [Rational(6393243, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b10000110001101100110101))))
(check-sat)
(exit)
