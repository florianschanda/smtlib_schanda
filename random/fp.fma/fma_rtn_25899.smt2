...
(assert (= z (fp #b0 #b10010101 #b01101000101010100101101)))
;; z should be Float32(0x4AB4552D [Rational(11818285, 2), 5909142.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AB4552D))))
(check-sat)
(exit)
