...
(assert (= z ((_ to_fp 8 24) #x6EC3B91F)))
;; z should be Float32(0x6EC3B91F [Rational(30286687292575981878827286528), 30286687292575981878827286528.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b11011101 #b10000111011100100011110))))
(check-sat)
(exit)
