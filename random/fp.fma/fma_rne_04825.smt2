...
(assert (= z (fp #b1 #b00000000 #b00001100111101000111110)))
;; z should be Float32(0x80067A3E [Rational(-212255, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b00000000 #b00001100111101000111110)))
(check-sat)
(exit)
