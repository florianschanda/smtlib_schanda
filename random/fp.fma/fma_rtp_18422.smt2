...
(assert (= z (fp #b1 #b10010100 #b01010010110011001000110)))
;; z should be Float32(0xCA296646 [Rational(-5550883, 2), -2775441.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010100 #b01010010110011001000110))))
(check-sat)
(exit)
