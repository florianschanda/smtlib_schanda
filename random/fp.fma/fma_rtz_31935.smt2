...
(assert (= y (fp #b0 #b00000000 #b11110001011100000011011)))
;; y should be Float32(0x0078B81B [Rational(7911451, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0717035))))
(check-sat)
(exit)
