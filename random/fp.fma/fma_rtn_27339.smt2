...
(assert (= x (fp #b0 #b11111111 #b10011000010010011111101)))
...
(assert (= z ((_ to_fp 8 24) #x97776196)))
;; z should be Float32(0x97776196 [Rational(-8106187, 10141204801825835211973625643008), -0.000000])
