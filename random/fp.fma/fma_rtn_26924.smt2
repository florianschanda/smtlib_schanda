...
(assert (= x (fp #b1 #b00000000 #b00010110100001000010111)))
;; x should be Float32(0x800B4217 [Rational(-737815, 713623846352979940529142984724747568191373312), -0.000000])
