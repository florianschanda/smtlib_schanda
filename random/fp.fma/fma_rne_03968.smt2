...
(assert (= x (fp #b1 #b10010101 #b00000001100100001001111)))
;; x should be Float32(0xCA80C84F [Rational(-8439887, 2), -4219943.500000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10101000110011001000111)))
