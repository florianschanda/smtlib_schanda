...
(assert (= x (fp #b0 #b10010101 #b10001100000010001110101)))
;; x should be Float32(0x4AC60475 [Rational(12977269, 2), 6488634.500000])
...
(assert (= result (fp #b1 #b00000000 #b11000110000001000111010)))
(check-sat)
(exit)
