...
(assert (= x ((_ to_fp 8 24) #x00671E8A)))
;; x should be Float32(0x00671E8A [Rational(3379013, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7F9CA4E4)))
