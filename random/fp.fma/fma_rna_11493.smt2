...
(assert (= z (fp #b1 #b10010001 #b00101010110000101111101)))
;; z should be Float32(0xC895617D [Rational(-9789821, 32), -305931.906250])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010001 #b00101010110000101111101))))
(check-sat)
(exit)
