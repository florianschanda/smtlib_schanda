...
(assert (= x (fp #b0 #b10010101 #b01111100111101001011001)))
;; x should be Float32(0x4ABE7A59 [Rational(12483161, 2), 6241580.500000])
...
(assert (= result (fp #b0 #b00010111 #b01111100111101001010111)))
(check-sat)
(exit)
