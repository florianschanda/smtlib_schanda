...
(assert (= z ((_ to_fp 8 24) #x89861E36)))
;; z should be Float32(0x89861E36 [Rational(-4394779, 1361129467683753853853498429727072845824), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00010011 #b00001100001111000110111))))
(check-sat)
(exit)
