...
(assert (= x ((_ to_fp 8 24) #x003BD7C7)))
;; x should be Float32(0x003BD7C7 [Rational(3921863, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBFEF5F1C)))
(check-sat)
(exit)
