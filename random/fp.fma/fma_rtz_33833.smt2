...
(assert (= x (fp #b1 #b00000000 #b01110001010000001011110)))
;; x should be Float32(0x8038A05E [Rational(-1855535, 356811923176489970264571492362373784095686656), -0.000000])
