...
(assert (= x (fp #b1 #b00000000 #b01101010000110001000111)))
;; x should be Float32(0x80350C47 [Rational(-3476551, 713623846352979940529142984724747568191373312), -0.000000])
