...
(assert (= y ((_ to_fp 8 24) #x6B5297DB)))
;; y should be Float32(0x6B5297DB [Rational(254591539294937585507368960), 254591539294937585507368960.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFC3E912)))
