...
(assert (= x (fp #b1 #b00000000 #b00101101000100000110110)))
;; x should be Float32(0x80168836 [Rational(-738331, 356811923176489970264571492362373784095686656), -0.000000])
