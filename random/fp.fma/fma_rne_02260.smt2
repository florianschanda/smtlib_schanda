...
(assert (= z ((_ to_fp 8 24) #x805B8D1C)))
;; z should be Float32(0x805B8D1C [Rational(-1499975, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x805B8D1C))))
(check-sat)
(exit)
