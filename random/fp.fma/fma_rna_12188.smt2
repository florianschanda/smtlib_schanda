...
(assert (= z (fp #b0 #b00000000 #b10111001011101011011111)))
;; z should be Float32(0x005CBADF [Rational(6077151, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10111001011101011011111))))
(check-sat)
(exit)
