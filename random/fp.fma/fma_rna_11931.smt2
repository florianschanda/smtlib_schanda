...
(assert (= z (fp #b1 #b00000000 #b00111101101010101111110)))
;; z should be Float32(0x801ED57E [Rational(-1010367, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x801ED57E)))
(check-sat)
(exit)
