...
(assert (= y (fp #b1 #b11111111 #b10110010100110011001000)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x179FFB82)))
;; z should be Float32(0x179FFB82 [Rational(5242305, 5070602400912917605986812821504), 0.000000])
