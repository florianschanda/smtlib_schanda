...
(assert (= y ((_ to_fp 8 24) #x7EC2CAD0)))
;; y should be Float32(0x7EC2CAD0 [Rational(129461646944447637035874955490578399232), 129461646944447637035874955490578399232.000000])
