...
(assert (= z (fp #b0 #b10011110 #b10010010000110000111100)))
;; z should be Float32(0x4F490C3C [Rational(3373022208), 3373022208.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x4F490C3C)))
(check-sat)
(exit)
