...
(assert (= z ((_ to_fp 8 24) #x801B0F41)))
;; z should be Float32(0x801B0F41 [Rational(-1773377, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x801B0F41)))
(check-sat)
(exit)
