...
(assert (= y ((_ to_fp 8 24) #xFFFD3099)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b10100101 #b10101100100000011010010)))
;; z should be Float32(0xD2D640D2 [Rational(-460105252864), -460105252864.000000])
