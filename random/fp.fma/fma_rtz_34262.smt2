...
(assert (= x ((_ to_fp 8 24) #x7F9CDACD)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x80467B8E)))
;; y should be Float32(0x80467B8E [Rational(-2309575, 356811923176489970264571492362373784095686656), -0.000000])
