...
(assert (= z ((_ to_fp 8 24) #xC9C7FF5C)))
;; z should be Float32(0xC9C7FF5C [Rational(-3276759, 2), -1638379.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010011 #b10001111111111101011100))))
(check-sat)
(exit)
