...
(assert (= y ((_ to_fp 8 24) #x48DD3393)))
;; y should be Float32(0x48DD3393 [Rational(14496659, 32), 453020.593750])
...
(assert (not (= result (fp #b0 #b00010011 #b10111010011001110110011))))
(check-sat)
(exit)
