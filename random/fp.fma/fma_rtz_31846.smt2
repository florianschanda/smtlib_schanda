...
(assert (= z (fp #b0 #b10010010 #b01110001110000101011000)))
;; z should be Float32(0x4938E158 [Rational(1514539, 2), 757269.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4938E118))))
(check-sat)
(exit)
