...
(assert (= z (fp #b1 #b10011101 #b11011001101001111110110)))
;; z should be Float32(0xCEECD3F6 [Rational(-1986657024), -1986657024.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCEECD3F6))))
(check-sat)
(exit)
