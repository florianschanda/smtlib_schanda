...
(assert (= x ((_ to_fp 8 24) #x003819B7)))
;; x should be Float32(0x003819B7 [Rational(3676599, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3FE066DB))))
(check-sat)
(exit)
