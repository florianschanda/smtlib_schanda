...
(assert (= x (fp #b0 #b00000000 #b10101111001010011011011)))
;; x should be Float32(0x005794DB [Rational(5739739, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC02F29B5)))
(check-sat)
(exit)
