...
(assert (= z ((_ to_fp 8 24) #xF93FFC7A)))
;; z should be Float32(0xF93FFC7A [Rational(-62303095814756189890334119910440960), -62303095814756189890334119910440960.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b11110010 #b01111111111110001111010))))
(check-sat)
(exit)
