...
(assert (= x (fp #b1 #b00000000 #b10011001001100000110100)))
;; x should be Float32(0x804C9834 [Rational(-1254925, 178405961588244985132285746181186892047843328), -0.000000])
