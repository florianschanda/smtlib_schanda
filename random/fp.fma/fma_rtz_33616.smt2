...
(assert (= x (fp #b1 #b00000000 #b00110100010111011101110)))
;; x should be Float32(0x801A2EEE [Rational(-857975, 356811923176489970264571492362373784095686656), -0.000000])
