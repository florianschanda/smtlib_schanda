...
(assert (= x (fp #b1 #b11100001 #b01100011101101111010100)))
;; x should be Float32(0xF0B1DBD4 [Rational(-440356821076544394546657624064), -440356821076544394546657624064.000000])
