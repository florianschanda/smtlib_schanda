...
(assert (= y (fp #b0 #b00000000 #b10000010001110010101110)))
;; y should be Float32(0x00411CAE [Rational(2133591, 356811923176489970264571492362373784095686656), 0.000000])
