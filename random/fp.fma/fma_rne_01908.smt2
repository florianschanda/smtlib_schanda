...
(assert (= z (fp #b0 #b10111110 #b11011010011111011011001)))
;; z should be Float32(0x5F6D3ED9 [Rational(17095339829568208896), 17095339829568208896.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10111110 #b11011010011111011011001)))
(check-sat)
(exit)
