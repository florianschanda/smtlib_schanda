...
(assert (= x ((_ to_fp 8 24) #xDA0A0D7E)))
;; x should be Float32(0xDA0A0D7E [Rational(-9714595400777728), -9714595400777728.000000])
...
(assert (not (= result (fp #b0 #b00110110 #b00010100000110101111110))))
(check-sat)
(exit)
