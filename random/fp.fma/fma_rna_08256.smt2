...
(assert (= y (fp #b1 #b01101101 #b11100010010100011000111)))
;; y should be Float32(0xB6F128C7 [Rational(-15804615, 2199023255552), -0.000007])
...
(assert (not (= result (fp #b1 #b11101101 #b11100010010100011000110))))
(check-sat)
(exit)
