...
(assert (= y (fp #b0 #b00000000 #b10111011001110111000000)))
;; y should be Float32(0x005D9DC0 [Rational(95863, 11150372599265311570767859136324180752990208), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFA87157)))
