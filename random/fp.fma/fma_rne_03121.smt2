...
(assert (= x (fp #b0 #b00000000 #b00001111101011000001000)))
;; x should be Float32(0x0007D608 [Rational(64193, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBE7AC0FF)))
(check-sat)
(exit)
