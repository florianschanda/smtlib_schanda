...
(assert (= x ((_ to_fp 8 24) #x7F979A76)))
...
(assert (= z (fp #b1 #b00101000 #b00001011011101100100100)))
;; z should be Float32(0x9405BB24 [Rational(-2191049, 324518553658426726783156020576256), -0.000000])
