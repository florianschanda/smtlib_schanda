...
(assert (= y ((_ to_fp 8 24) #x52D1724C)))
;; y should be Float32(0x52D1724C [Rational(449782874112), 449782874112.000000])
...
(assert (not (= result (fp #b0 #b00010000 #b10100010111001101001100))))
(check-sat)
(exit)
