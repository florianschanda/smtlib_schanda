...
(assert (= z ((_ to_fp 8 24) #x00580887)))
;; z should be Float32(0x00580887 [Rational(5769351, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x00580887)))
(check-sat)
(exit)
