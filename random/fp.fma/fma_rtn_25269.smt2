...
(assert (= y (fp #b1 #b11111111 #b11110011100100110001100)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00000000 #b00011101010110100001101)))
;; z should be Float32(0x800EAD0D [Rational(-961805, 713623846352979940529142984724747568191373312), -0.000000])
