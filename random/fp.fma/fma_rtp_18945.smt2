...
(assert (= z (fp #b0 #b10010101 #b11111110000100010011001)))
;; z should be Float32(0x4AFF0899 [Rational(16713881, 2), 8356940.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11111110000100010011001))))
(check-sat)
(exit)
