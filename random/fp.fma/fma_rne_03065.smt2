...
(assert (= x (fp #b0 #b00000000 #b01000001001101010010100)))
;; x should be Float32(0x00209A94 [Rational(534181, 178405961588244985132285746181186892047843328), 0.000000])
