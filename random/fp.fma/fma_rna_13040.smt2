...
(assert (= x (fp #b1 #b00000000 #b00110111101111000011111)))
;; x should be Float32(0x801BDE1F [Rational(-1826335, 713623846352979940529142984724747568191373312), -0.000000])
