...
(assert (= x ((_ to_fp 8 24) #x7FC459C3)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x1919D5C3)))
;; y should be Float32(0x1919D5C3 [Rational(10081731, 1267650600228229401496703205376), 0.000000])
