...
(assert (= x (fp #b1 #b00000000 #b00111010010000010010100)))
;; x should be Float32(0x801D2094 [Rational(-477221, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result (fp #b0 #b01111110 #b11010010000010010100000))))
(check-sat)
(exit)
