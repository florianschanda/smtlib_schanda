...
(assert (= y (fp #b0 #b10010101 #b01101111101100001100101)))
;; y should be Float32(0x4AB7D865 [Rational(12048485, 2), 6024242.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x80DBEC32))))
(check-sat)
(exit)
