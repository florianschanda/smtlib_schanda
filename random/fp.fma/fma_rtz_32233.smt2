...
(assert (= z ((_ to_fp 8 24) #x00622951)))
;; z should be Float32(0x00622951 [Rational(6433105, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00622950))))
(check-sat)
(exit)
