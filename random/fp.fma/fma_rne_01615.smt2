...
(assert (= y (fp #b0 #b00000000 #b11000010000001111111100)))
;; y should be Float32(0x006103FC [Rational(1589503, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FDE15D8)))
