...
(assert (= y (fp #b1 #b11111111 #b10100111111000111011110)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x18741AED)))
;; z should be Float32(0x18741AED [Rational(15997677, 5070602400912917605986812821504), 0.000000])
