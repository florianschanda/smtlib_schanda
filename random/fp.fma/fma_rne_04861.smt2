...
(assert (= y (fp #b0 #b00000000 #b00001101001100111110100)))
;; y should be Float32(0x000699F4 [Rational(108157, 178405961588244985132285746181186892047843328), 0.000000])
