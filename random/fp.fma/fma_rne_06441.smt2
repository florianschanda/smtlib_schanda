...
(assert (= x (fp #b1 #b00000000 #b10101001101010100000000)))
;; x should be Float32(0x8054D500 [Rational(-21717, 2787593149816327892691964784081045188247552), -0.000000])
...
(assert (= z (fp #b0 #b11111111 #b10001001110110001100110)))
