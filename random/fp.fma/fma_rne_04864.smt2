...
(assert (= y ((_ to_fp 8 24) #x0062DCAD)))
;; y should be Float32(0x0062DCAD [Rational(6479021, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FA6ABB7)))
