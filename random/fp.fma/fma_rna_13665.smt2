...
(assert (= x (fp #b1 #b11111111 #b11000101111110010011101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xEFA51E5C)))
;; y should be Float32(0xEFA51E5C [Rational(-102203457705653598444379439104), -102203457705653598444379439104.000000])
