...
(assert (= z (fp #b1 #b00000000 #b10010000011110101001001)))
;; z should be Float32(0x80483D49 [Rational(-4734281, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10010000011110101001000))))
(check-sat)
(exit)
