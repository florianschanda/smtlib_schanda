...
(assert (= x (fp #b0 #b10010101 #b10011111001101000100101)))
;; x should be Float32(0x4ACF9A25 [Rational(13605413, 2), 6802706.500000])
...
(assert (= z (fp #b1 #b10010100 #b11011011000100000001110)))
;; z should be Float32(0xCA6D880E [Rational(-7783431, 2), -3891715.500000])
