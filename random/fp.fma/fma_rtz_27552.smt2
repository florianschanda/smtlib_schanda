...
(assert (= z (fp #b0 #b10010101 #b11101110101001001010001)))
;; z should be Float32(0x4AF75251 [Rational(16208465, 2), 8104232.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AF75251))))
(check-sat)
(exit)
