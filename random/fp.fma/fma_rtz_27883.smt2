...
(assert (= x (fp #b0 #b10010101 #b01111011010001111110001)))
;; x should be Float32(0x4ABDA3F1 [Rational(12428273, 2), 6214136.500000])
...
(assert (= result (fp #b0 #b00010111 #b01111011010001111101111)))
(check-sat)
(exit)
