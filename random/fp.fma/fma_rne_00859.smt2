...
(assert (= y (fp #b0 #b00000110 #b11111000001000100001110)))
;; y should be Float32(0x037C110E [Rational(8259719, 11150372599265311570767859136324180752990208), 0.000000])
