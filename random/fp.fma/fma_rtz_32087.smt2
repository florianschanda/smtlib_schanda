...
(assert (= y (fp #b1 #b01111100 #b01001011010100000011011)))
;; y should be Float32(0xBE25A81B [Rational(-10856475, 67108864), -0.161774])
...
(assert (= result (fp #b0 #b11111100 #b01001011010100000011010)))
(check-sat)
(exit)
