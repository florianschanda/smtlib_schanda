...
(assert (= z (fp #b1 #b10010100 #b10000110100111100110010)))
;; z should be Float32(0xCA434F32 [Rational(-6399897, 2), -3199948.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA434F32))))
(check-sat)
(exit)
