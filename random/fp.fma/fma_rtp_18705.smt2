...
(assert (= z (fp #b0 #b00000000 #b10101011111100100100100)))
;; z should be Float32(0x0055F924 [Rational(1408585, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10101011111100100100101))))
(check-sat)
(exit)
