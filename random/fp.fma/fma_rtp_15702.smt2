...
(assert (= z ((_ to_fp 8 24) #x7AC25CA9)))
;; z should be Float32(0x7AC25CA9 [Rational(504592480899378712143486371957309440), 504592480899378712143486371957309440.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b11110101 #b10000100101110010101001))))
(check-sat)
(exit)
