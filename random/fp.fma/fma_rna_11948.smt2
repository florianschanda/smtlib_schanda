...
(assert (= y (fp #b0 #b10010100 #b10110001110010101010110)))
;; y should be Float32(0x4A58E556 [Rational(7107243, 2), 3553621.500000])
...
(assert (= result (fp #b1 #b00010110 #b10110001110010101010110)))
(check-sat)
(exit)
