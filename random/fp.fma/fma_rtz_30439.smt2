...
(assert (= x (fp #b0 #b00000000 #b10101000100001000001101)))
;; x should be Float32(0x0054420D [Rational(5521933, 713623846352979940529142984724747568191373312), 0.000000])
