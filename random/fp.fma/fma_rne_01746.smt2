...
(assert (= z ((_ to_fp 8 24) #xF4E3B9F1)))
;; z should be Float32(0xF4E3B9F1 [Rational(-144338711749419844776637323280384), -144338711749419844776637323280384.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xF4E3B9F1))))
(check-sat)
(exit)
