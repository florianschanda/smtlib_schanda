...
(assert (= x (fp #b0 #b10100111 #b10001010100000100100100)))
;; x should be Float32(0x53C54124 [Rational(1694402871296), 1694402871296.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x09454123))))
(check-sat)
(exit)
