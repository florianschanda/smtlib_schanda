...
(assert (= z (fp #b1 #b10010101 #b11110101000011010101111)))
;; z should be Float32(0xCAFA86AF [Rational(-16418479, 2), -8209239.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAFA86A8))))
(check-sat)
(exit)
