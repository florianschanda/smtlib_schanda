...
(assert (= y ((_ to_fp 8 24) #xFF10C592)))
;; y should be Float32(0xFF10C592 [Rational(-192434675105961379884850620755913736192), -192434675105961379884850620755913736192.000000])
