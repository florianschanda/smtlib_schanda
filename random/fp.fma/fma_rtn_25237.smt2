...
(assert (= y ((_ to_fp 8 24) #x80304E07)))
;; y should be Float32(0x80304E07 [Rational(-3165703, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3FC1381B)))
(check-sat)
(exit)
