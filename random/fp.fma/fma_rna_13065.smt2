...
(assert (= x (fp #b1 #b00000000 #b01011000010010110101111)))
;; x should be Float32(0x802C25AF [Rational(-2893231, 713623846352979940529142984724747568191373312), -0.000000])
