...
(assert (= x (fp #b0 #b00000000 #b11000111000100001111110)))
;; x should be Float32(0x0063887E [Rational(3261503, 356811923176489970264571492362373784095686656), 0.000000])
