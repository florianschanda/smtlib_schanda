...
(assert (= z ((_ to_fp 8 24) #x80075D2C)))
;; z should be Float32(0x80075D2C [Rational(-120651, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b00001110101110100101011)))
(check-sat)
(exit)
