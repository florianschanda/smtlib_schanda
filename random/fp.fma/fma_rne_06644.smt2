...
(assert (= x ((_ to_fp 8 24) #x7FA3604A)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00010110 #b10111100110011101001100)))
;; y should be Float32(0x0B5E674C [Rational(3643859, 85070591730234615865843651857942052864), 0.000000])
