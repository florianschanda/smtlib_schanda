...
(assert (= y (fp #b1 #b11111010 #b01000010101001000100001)))
;; y should be Float32(0xFD215221 [Rational(-13402009061455514494261026728963997696), -13402009061455514494261026728963997696.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB2A15220))))
(check-sat)
(exit)
