...
(assert (= z ((_ to_fp 8 24) #x89016858)))
;; z should be Float32(0x89016858 [Rational(-1060107, 680564733841876926926749214863536422912), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x89016858))))
(check-sat)
(exit)
