...
(assert (= x (fp #b0 #b10010101 #b11100101001000101001101)))
;; x should be Float32(0x4AF2914D [Rational(15896909, 2), 7948454.500000])
...
(assert (= result (fp #b0 #b00010111 #b11100101001000101001011)))
(check-sat)
(exit)
