...
(assert (= z (fp #b0 #b00000000 #b01001011110111001101000)))
;; z should be Float32(0x0025EE68 [Rational(310733, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01001011110111001100111))))
(check-sat)
(exit)
