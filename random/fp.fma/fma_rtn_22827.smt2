...
(assert (= z ((_ to_fp 8 24) #x46323439)))
;; z should be Float32(0x46323439 [Rational(11678777, 1024), 11405.055664])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10001100 #b01100100011010000111001)))
(check-sat)
(exit)
