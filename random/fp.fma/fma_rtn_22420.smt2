...
(assert (= y (fp #b0 #b10010101 #b00000100010110101010101)))
;; y should be Float32(0x4A822D55 [Rational(8531285, 2), 4265642.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b01111010100101001011001)))
