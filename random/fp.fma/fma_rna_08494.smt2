...
(assert (= y (fp #b1 #b10010101 #b00110110010101010100111)))
;; y should be Float32(0xCA9B2AA7 [Rational(-10168999, 2), -5084499.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b00110110010101010100110))))
(check-sat)
(exit)
