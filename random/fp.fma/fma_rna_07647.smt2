...
(assert (= z (fp #b0 #b00000000 #b11000001001001101010100)))
;; z should be Float32(0x00609354 [Rational(1582293, 178405961588244985132285746181186892047843328), 0.000000])
