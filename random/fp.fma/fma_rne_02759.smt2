...
(assert (= x (fp #b0 #b01110001 #b11001110111101010011110)))
;; x should be Float32(0x38E77A9E [Rational(7585103, 68719476736), 0.000110])
...
(assert (not (= result ((_ to_fp 8 24) #x7F7FF8C3))))
(check-sat)
(exit)
