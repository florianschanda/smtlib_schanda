...
(assert (= x (fp #b1 #b10111001 #b10110111011000011010100)))
;; x should be Float32(0xDCDBB0D4 [Rational(-494699555833511936), -494699555833511936.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x125BB0D4))))
(check-sat)
(exit)
