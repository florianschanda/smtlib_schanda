...
(assert (= z ((_ to_fp 8 24) #x85B4D50D)))
;; z should be Float32(0x85B4D50D [Rational(-11851021, 696898287454081973172991196020261297061888), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x85B4D50D))))
(check-sat)
(exit)
