...
(assert (= y (fp #b0 #b10010011 #b11101110100101010100100)))
;; y should be Float32(0x49F74AA4 [Rational(4051625, 2), 2025812.500000])
...
(assert (= result (fp #b1 #b00010101 #b11101110100101010101100)))
(check-sat)
(exit)
