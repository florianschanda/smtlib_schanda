...
(assert (= x ((_ to_fp 8 24) #xCA93FD85)))
;; x should be Float32(0xCA93FD85 [Rational(-9698693, 2), -4849346.500000])
...
(assert (= z ((_ to_fp 8 24) #x800A7A33)))
;; z should be Float32(0x800A7A33 [Rational(-686643, 713623846352979940529142984724747568191373312), -0.000000])
