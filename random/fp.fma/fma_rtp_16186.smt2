...
(assert (= z (fp #b1 #b01001101 #b00001001100001000111011)))
;; z should be Float32(0xA684C23B [Rational(-8700475, 9444732965739290427392), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b01001101 #b00001001100001000111011)))
(check-sat)
(exit)
