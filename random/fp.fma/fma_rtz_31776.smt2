...
(assert (= z ((_ to_fp 8 24) #x7A73DF7E)))
;; z should be Float32(0x7A73DF7E [Rational(316565274178513558385996907893751808), 316565274178513558385996907893751808.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x7A73DF7E))))
(check-sat)
(exit)
