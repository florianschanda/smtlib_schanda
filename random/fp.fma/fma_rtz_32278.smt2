...
(assert (= y (fp #b0 #b10011000 #b11101100100010111111010)))
;; y should be Float32(0x4C7645FA [Rational(64559080), 64559080.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x8D7645F8))))
(check-sat)
(exit)
