...
(assert (= y ((_ to_fp 8 24) #x4AE951F5)))
;; y should be Float32(0x4AE951F5 [Rational(15290869, 2), 7645434.500000])
...
(assert (= result (fp #b0 #b00000000 #b00010110101011100000110)))
(check-sat)
(exit)
