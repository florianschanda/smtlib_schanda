...
(assert (= y ((_ to_fp 8 24) #x7FB80B70)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00111110 #b00011000101100110110001)))
;; z should be Float32(0x9F0C59B1 [Rational(-9198001, 309485009821345068724781056), -0.000000])
