...
(assert (= y (fp #b0 #b00000000 #b11100101100111111101011)))
;; y should be Float32(0x0072CFEB [Rational(7524331, 713623846352979940529142984724747568191373312), 0.000000])
