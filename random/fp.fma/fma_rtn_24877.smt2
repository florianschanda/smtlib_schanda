...
(assert (= y (fp #b1 #b00000000 #b10000100000011111011011)))
;; y should be Float32(0x804207DB [Rational(-4327387, 713623846352979940529142984724747568191373312), -0.000000])
