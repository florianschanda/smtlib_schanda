...
(assert (= x ((_ to_fp 8 24) #xCEC78F79)))
;; x should be Float32(0xCEC78F79 [Rational(-1674034304), -1674034304.000000])
...
(assert (not (= result (fp #b1 #b00001000 #b10010001000111101111001))))
(check-sat)
(exit)
