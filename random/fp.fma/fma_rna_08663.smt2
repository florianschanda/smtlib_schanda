...
(assert (= y ((_ to_fp 8 24) #xFF80F5E4)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x805CB135)))
;; z should be Float32(0x805CB135 [Rational(-6074677, 713623846352979940529142984724747568191373312), -0.000000])
