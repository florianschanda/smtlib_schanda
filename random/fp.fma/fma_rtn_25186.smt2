...
(assert (= z (fp #b1 #b10010100 #b11101111101111111100010)))
;; z should be Float32(0xCA77DFE2 [Rational(-8122353, 2), -4061176.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010100 #b11101111101111111010011))))
(check-sat)
(exit)
