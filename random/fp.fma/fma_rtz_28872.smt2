...
(assert (= y (fp #b1 #b11111111 #b01000100000100000101101)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b10010011 #b11010011000001001001100)))
;; z should be Float32(0xC9E9824C [Rational(-3825811, 2), -1912905.500000])
