...
(assert (= z (fp #b1 #b11100110 #b11011000000110011011000)))
;; z should be Float32(0xF36C0CD8 [Rational(-18701821301461276572802806185984), -18701821301461276572802806185984.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xF36C0CD7))))
(check-sat)
(exit)
