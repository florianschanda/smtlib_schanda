...
(assert (= y ((_ to_fp 8 24) #x004C46B2)))
;; y should be Float32(0x004C46B2 [Rational(2499417, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0188D63))))
(check-sat)
(exit)
