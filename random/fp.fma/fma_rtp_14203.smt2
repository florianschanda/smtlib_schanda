...
(assert (= x ((_ to_fp 8 24) #x4A9D78D7)))
;; x should be Float32(0x4A9D78D7 [Rational(10320087, 2), 5160043.500000])
...
(assert (= result (fp #b0 #b00000000 #b10011101011110001101100)))
(check-sat)
(exit)
