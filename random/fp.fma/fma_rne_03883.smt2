...
(assert (= x ((_ to_fp 8 24) #xCAD537F9)))
;; x should be Float32(0xCAD537F9 [Rational(-13973497, 2), -6986748.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10101010011011111111001))))
(check-sat)
(exit)
