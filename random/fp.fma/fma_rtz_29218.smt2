...
(assert (= y (fp #b1 #b00000000 #b00010101010001000010010)))
;; y should be Float32(0x800AA212 [Rational(-348425, 356811923176489970264571492362373784095686656), -0.000000])
