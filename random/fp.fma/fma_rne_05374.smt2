...
(assert (= y (fp #b1 #b10100010 #b10111101111010001100001)))
;; y should be Float32(0xD15EF461 [Rational(-59848921088), -59848921088.000000])
...
(assert (= result (fp #b0 #b00100100 #b10111101111010001100001)))
(check-sat)
(exit)
