...
(assert (= z ((_ to_fp 8 24) #x00316710)))
;; z should be Float32(0x00316710 [Rational(202353, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01100010110011100010000))))
(check-sat)
(exit)
