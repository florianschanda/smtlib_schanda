...
(assert (= z (fp #b0 #b10010101 #b11001010011000010000111)))
;; z should be Float32(0x4AE53087 [Rational(15020167, 2), 7510083.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AE53087))))
(check-sat)
(exit)
