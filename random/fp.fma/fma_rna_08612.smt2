...
(assert (= y (fp #b1 #b10000000 #b10101010001111001110000)))
;; y should be Float32(0xC0551E70 [Rational(-872935, 262144), -3.329983])
...
(assert (= result (fp #b1 #b00000010 #b00101010001111001101111)))
(check-sat)
(exit)
