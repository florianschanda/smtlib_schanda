...
(assert (= x (fp #b0 #b11111000 #b11100001011110110011001)))
;; x should be Float32(0x7C70BD99 [Rational(4999986973489253916004387846921125888), 4999986973489253916004387846921125888.000000])
