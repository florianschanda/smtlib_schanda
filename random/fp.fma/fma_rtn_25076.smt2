...
(assert (= y ((_ to_fp 8 24) #x002BF3DB)))
;; y should be Float32(0x002BF3DB [Rational(2880475, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b01011111100111101101100))))
(check-sat)
(exit)
