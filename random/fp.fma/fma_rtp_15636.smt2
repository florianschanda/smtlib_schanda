...
(assert (= z ((_ to_fp 8 24) #x8008C098)))
;; z should be Float32(0x8008C098 [Rational(-71699, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b00010001100000010010111)))
(check-sat)
(exit)
