...
(assert (= x ((_ to_fp 8 24) #x4AB354D7)))
;; x should be Float32(0x4AB354D7 [Rational(11752663, 2), 5876331.500000])
...
(assert (= z ((_ to_fp 8 24) #x4571DE5E)))
;; z should be Float32(0x4571DE5E [Rational(7925551, 2048), 3869.897949])
