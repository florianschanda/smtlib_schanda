...
(assert (= z (fp #b0 #b00000000 #b10000101000001000101010)))
;; z should be Float32(0x0042822A [Rational(2179349, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b10000101000001000101010)))
(check-sat)
(exit)
