...
(assert (= x ((_ to_fp 8 24) #xCA7FC5D2)))
;; x should be Float32(0xCA7FC5D2 [Rational(-8381161, 2), -4190580.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b01111111111000101110101))))
(check-sat)
(exit)
