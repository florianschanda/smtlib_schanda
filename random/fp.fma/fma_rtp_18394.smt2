...
(assert (= y (fp #b0 #b11111111 #b00001001000100100011010)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b10010100 #b01011100001101111000110)))
;; z should be Float32(0x4A2E1BC6 [Rational(5705187, 2), 2852593.500000])
