...
(assert (= y (fp #b1 #b01111101 #b10110111000110010001101)))
;; y should be Float32(0xBEDB8C8D [Rational(-14388365, 33554432), -0.428807])
...
(assert (= result ((_ to_fp 8 24) #x8036E322)))
(check-sat)
(exit)
