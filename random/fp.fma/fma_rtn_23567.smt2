...
(assert (= x (fp #b0 #b00000000 #b10000000100001000011110)))
;; x should be Float32(0x0040421E [Rational(2105615, 356811923176489970264571492362373784095686656), 0.000000])
