...
(assert (= x (fp #b1 #b10010101 #b00101011011000011010111)))
;; x should be Float32(0xCA95B0D7 [Rational(-9810135, 2), -4905067.500000])
...
(assert (= result (fp #b1 #b00010111 #b00101011011000011010101)))
(check-sat)
(exit)
