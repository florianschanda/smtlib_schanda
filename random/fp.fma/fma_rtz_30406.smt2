...
(assert (= x (fp #b0 #b00000000 #b01101011000110011110110)))
;; x should be Float32(0x00358CF6 [Rational(1754747, 356811923176489970264571492362373784095686656), 0.000000])
