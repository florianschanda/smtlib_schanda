...
(assert (= x (fp #b1 #b00000000 #b00110011111100010110100)))
;; x should be Float32(0x8019F8B4 [Rational(-425517, 178405961588244985132285746181186892047843328), -0.000000])
