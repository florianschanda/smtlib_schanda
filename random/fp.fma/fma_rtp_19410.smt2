...
(assert (= z ((_ to_fp 8 24) #xCAA9C6DB)))
;; z should be Float32(0xCAA9C6DB [Rational(-11126491, 2), -5563245.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b01010011100011011011010)))
(check-sat)
(exit)
