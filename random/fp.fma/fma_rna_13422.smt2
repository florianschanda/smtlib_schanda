...
(assert (= x ((_ to_fp 8 24) #x7FF0571E)))
...
(assert (= z (fp #b0 #b01101000 #b00110101011000101011010)))
;; z should be Float32(0x341AB15A [Rational(5068973, 35184372088832), 0.000000])
