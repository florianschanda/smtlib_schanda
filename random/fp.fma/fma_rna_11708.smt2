...
(assert (= y (fp #b0 #b00000000 #b00010100011110011001100)))
;; y should be Float32(0x000A3CCC [Rational(167731, 178405961588244985132285746181186892047843328), 0.000000])
