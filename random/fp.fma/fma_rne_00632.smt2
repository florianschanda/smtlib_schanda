...
(assert (= x (fp #b0 #b10010011 #b00010011111010100110100)))
;; x should be Float32(0x4989F534 [Rational(2260301, 2), 1130150.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8A89F52C))))
(check-sat)
(exit)
