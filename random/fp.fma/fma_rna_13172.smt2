...
(assert (= x (fp #b1 #b00000000 #b01000001100100010010110)))
;; x should be Float32(0x8020C896 [Rational(-1074251, 356811923176489970264571492362373784095686656), -0.000000])
