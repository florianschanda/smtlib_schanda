...
(assert (= x (fp #b1 #b00000000 #b01011100110100110000001)))
;; x should be Float32(0x802E6981 [Rational(-3041665, 713623846352979940529142984724747568191373312), -0.000000])
