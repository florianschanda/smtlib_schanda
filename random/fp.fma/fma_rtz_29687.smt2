...
(assert (= z (fp #b0 #b00000000 #b01111100111000111100111)))
;; z should be Float32(0x003E71E7 [Rational(4092391, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b01111100111000111100111)))
(check-sat)
(exit)
