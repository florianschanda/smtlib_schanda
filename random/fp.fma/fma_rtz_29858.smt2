...
(assert (= z ((_ to_fp 8 24) #x004C6F13)))
;; z should be Float32(0x004C6F13 [Rational(5009171, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10011000110111100010010))))
(check-sat)
(exit)
