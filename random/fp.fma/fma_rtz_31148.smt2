...
(assert (= x ((_ to_fp 8 24) #xC94C0978)))
;; x should be Float32(0xC94C0978 [Rational(-1671471, 2), -835735.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b10011000000100101110111))))
(check-sat)
(exit)
