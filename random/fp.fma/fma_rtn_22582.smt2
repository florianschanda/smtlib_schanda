...
(assert (= y (fp #b1 #b10010010 #b11011110110011010001000)))
;; y should be Float32(0xC96F6688 [Rational(-1961169, 2), -980584.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8A6F6688))))
(check-sat)
(exit)
