...
(assert (= z (fp #b1 #b00000000 #b10100011011101011011011)))
;; z should be Float32(0x8051BADB [Rational(-5356251, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10100011011101011011011))))
(check-sat)
(exit)
