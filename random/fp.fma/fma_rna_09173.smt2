...
(assert (= y (fp #b0 #b10000010 #b01100011011010111111000)))
;; y should be Float32(0x4131B5F8 [Rational(1455807, 131072), 11.106926])
...
(assert (not (= result ((_ to_fp 8 24) #x807FFFF5))))
(check-sat)
(exit)
