...
(assert (= y (fp #b1 #b11111001 #b11011010110010001010110)))
;; y should be Float32(0xFCED6456 [Rational(-9860875280440764333897243199467945984), -9860875280440764333897243199467945984.000000])
...
(assert (= result ((_ to_fp 8 24) #xB26D6455)))
(check-sat)
(exit)
