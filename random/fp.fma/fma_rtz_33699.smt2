...
(assert (= x (fp #b1 #b00000000 #b11110010101101010001110)))
;; x should be Float32(0x80795A8E [Rational(-3976519, 356811923176489970264571492362373784095686656), -0.000000])
