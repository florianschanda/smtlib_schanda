...
(assert (= z ((_ to_fp 8 24) #xEA450A60)))
;; z should be Float32(0xEA450A60 [Rational(-59551845254085429996552192), -59551845254085429996552192.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b11010100 #b10001010000101001100000))))
(check-sat)
(exit)
