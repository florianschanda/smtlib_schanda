...
(assert (= x (fp #b0 #b00000000 #b00101010111100000010010)))
;; x should be Float32(0x00157812 [Rational(703497, 356811923176489970264571492362373784095686656), 0.000000])
