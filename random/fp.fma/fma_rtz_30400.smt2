...
(assert (= x (fp #b0 #b00000000 #b10110101110101011010101)))
;; x should be Float32(0x005AEAD5 [Rational(5958357, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b00000000000001010010100)))
