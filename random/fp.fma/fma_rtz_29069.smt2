...
(assert (= z (fp #b1 #b00000000 #b01011110001110000100111)))
;; z should be Float32(0x802F1C27 [Rational(-3087399, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b01011110001110000100111))))
(check-sat)
(exit)
