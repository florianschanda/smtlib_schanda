...
(assert (= z ((_ to_fp 8 24) #x006B4B8E)))
;; z should be Float32(0x006B4B8E [Rational(3515847, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x006B4B8E)))
(check-sat)
(exit)
