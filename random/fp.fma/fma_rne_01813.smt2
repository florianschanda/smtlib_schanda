...
(assert (= z ((_ to_fp 8 24) #x53C29CD1)))
;; z should be Float32(0x53C29CD1 [Rational(1671709196288), 1671709196288.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10100111 #b10000101001110011010001)))
(check-sat)
(exit)
