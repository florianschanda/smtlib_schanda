...
(assert (= z ((_ to_fp 8 24) #xC5575E8B)))
;; z should be Float32(0xC5575E8B [Rational(-14114443, 4096), -3445.908936])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10001010 #b10101110101111010001011))))
(check-sat)
(exit)
