...
(assert (= x (fp #b1 #b00000000 #b10001111001100110001010)))
;; x should be Float32(0x8047998A [Rational(-2346181, 356811923176489970264571492362373784095686656), -0.000000])
