...
(assert (= x ((_ to_fp 8 24) #x805766A3)))
;; x should be Float32(0x805766A3 [Rational(-5727907, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FE362B5)))
