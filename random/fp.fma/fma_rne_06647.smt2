...
(assert (= x ((_ to_fp 8 24) #x7F90B6F7)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b01010000 #b01101010010110100000100)))
;; y should be Float32(0x28352D04 [Rational(2968385, 295147905179352825856), 0.000000])
