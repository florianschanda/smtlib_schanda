...
(assert (= x (fp #b1 #b10010101 #b11010001001110110010111)))
;; x should be Float32(0xCAE89D97 [Rational(-15244695, 2), -7622347.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b11101000100111011001010))))
(check-sat)
(exit)
