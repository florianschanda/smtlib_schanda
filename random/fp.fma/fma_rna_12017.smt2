...
(assert (= z ((_ to_fp 8 24) #x0002F2D4)))
;; z should be Float32(0x0002F2D4 [Rational(48309, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b00000101111001011010100))))
(check-sat)
(exit)
