...
(assert (= x (fp #b1 #b00000000 #b11101010011111011110011)))
;; x should be Float32(0x80753EF3 [Rational(-7683827, 713623846352979940529142984724747568191373312), -0.000000])
