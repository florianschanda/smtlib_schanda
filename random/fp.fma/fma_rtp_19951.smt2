...
(assert (= x (fp #b1 #b00000000 #b01100101100000100111011)))
;; x should be Float32(0x8032C13B [Rational(-3326267, 713623846352979940529142984724747568191373312), -0.000000])
