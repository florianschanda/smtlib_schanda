...
(assert (= x ((_ to_fp 8 24) #x00508077)))
;; x should be Float32(0x00508077 [Rational(5275767, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC02100ED)))
(check-sat)
(exit)
