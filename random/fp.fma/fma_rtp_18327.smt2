...
(assert (= z (fp #b1 #b10010100 #b00011001111111111101010)))
;; z should be Float32(0xCA0CFFEA [Rational(-4620277, 2), -2310138.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010100 #b00011001111111111011010))))
(check-sat)
(exit)
