...
(assert (= y ((_ to_fp 8 24) #x04887AA0)))
;; y should be Float32(0x04887AA0 [Rational(279509, 87112285931760246646623899502532662132736), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x44887A9F))))
(check-sat)
(exit)
