...
(assert (= z (fp #b1 #b10010010 #b10111011100010000011000)))
;; z should be Float32(0xC95DC418 [Rational(-1816707, 2), -908353.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010010 #b10111011100010000011000)))
(check-sat)
(exit)
