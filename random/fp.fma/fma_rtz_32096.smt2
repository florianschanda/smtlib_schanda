...
(assert (= y ((_ to_fp 8 24) #x8063A806)))
;; y should be Float32(0x8063A806 [Rational(-3265539, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4047500B))))
(check-sat)
(exit)
