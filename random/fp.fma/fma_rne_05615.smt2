...
(assert (= y (fp #b1 #b10010011 #b10111001110000110111100)))
;; y should be Float32(0xC9DCE1BC [Rational(-3618927, 2), -1809463.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b00110111001110000111000))))
(check-sat)
(exit)
