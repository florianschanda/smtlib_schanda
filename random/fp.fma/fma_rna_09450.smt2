...
(assert (= x ((_ to_fp 8 24) #x7B534B7B)))
;; x should be Float32(0x7B534B7B [Rational(1097105562935111759415254775217782784), 1097105562935111759415254775217782784.000000])
