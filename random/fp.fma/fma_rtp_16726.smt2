...
(assert (= x ((_ to_fp 8 24) #x000D5B31)))
;; x should be Float32(0x000D5B31 [Rational(875313, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b00000001 #b00000000000000000000001))))
(check-sat)
(exit)
