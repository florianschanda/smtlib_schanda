...
(assert (= x ((_ to_fp 8 24) #x803BAF28)))
;; x should be Float32(0x803BAF28 [Rational(-488933, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b11011101011110010011111))))
(check-sat)
(exit)
