...
(assert (= z ((_ to_fp 8 24) #x006E6DB8)))
;; z should be Float32(0x006E6DB8 [Rational(904631, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x006E6DB8)))
(check-sat)
(exit)
