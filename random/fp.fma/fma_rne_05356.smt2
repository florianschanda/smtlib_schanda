...
(assert (= z (fp #b1 #b01010100 #b11111110011101010000010)))
;; z should be Float32(0xAA7F3A82 [Rational(-8363329, 36893488147419103232), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xAA7F3A82))))
(check-sat)
(exit)
