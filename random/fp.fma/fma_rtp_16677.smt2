...
(assert (= x ((_ to_fp 8 24) #x004B746B)))
;; x should be Float32(0x004B746B [Rational(4945003, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4016E8D6))))
(check-sat)
(exit)
