...
(assert (= x ((_ to_fp 8 24) #xE4334127)))
;; x should be Float32(0xE4334127 [Rational(-13226647641322267082752), -13226647641322267082752.000000])
...
(assert (= result ((_ to_fp 8 24) #x25334125)))
(check-sat)
(exit)
