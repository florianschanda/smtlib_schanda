...
(assert (= x (fp #b1 #b11100100 #b00111010001100000101111)))
;; x should be Float32(0xF21D182F [Rational(-3111576493622183792851751534592), -3111576493622183792851751534592.000000])
