...
(assert (= x (fp #b1 #b10010100 #b11110000100110000011010)))
;; x should be Float32(0xCA784C1A [Rational(-8136205, 2), -4068102.500000])
...
(assert (= result (fp #b1 #b00000001 #b01111100001001100000111)))
(check-sat)
(exit)
