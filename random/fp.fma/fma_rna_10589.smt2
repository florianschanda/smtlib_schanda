...
(assert (= x (fp #b1 #b10010101 #b01001110000101110101011)))
;; x should be Float32(0xCAA70BAB [Rational(-10947499, 2), -5473749.500000])
...
(assert (= result (fp #b0 #b00000000 #b01011000111101000101011)))
(check-sat)
(exit)
