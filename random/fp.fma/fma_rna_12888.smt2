...
(assert (= x (fp #b1 #b01111011 #b00010110001100110100101)))
;; x should be Float32(0xBD8B19A5 [Rational(-9116069, 134217728), -0.067920])
...
(assert (= result ((_ to_fp 8 24) #x0088B19A)))
(check-sat)
(exit)
