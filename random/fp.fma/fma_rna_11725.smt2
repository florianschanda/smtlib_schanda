...
(assert (= z (fp #b0 #b10010101 #b00101010111101100000011)))
;; z should be Float32(0x4A957B03 [Rational(9796355, 2), 4898177.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b00101010111101100000011)))
(check-sat)
(exit)
