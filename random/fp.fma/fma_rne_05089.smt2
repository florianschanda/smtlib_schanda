...
(assert (= y (fp #b0 #b10010101 #b10001010111110101101001)))
;; y should be Float32(0x4AC57D69 [Rational(12942697, 2), 6471348.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b10001010111110101101001))))
(check-sat)
(exit)
