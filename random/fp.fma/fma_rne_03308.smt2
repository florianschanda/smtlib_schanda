...
(assert (= z (fp #b0 #b10010101 #b01001100000010101001011)))
;; z should be Float32(0x4AA6054B [Rational(10880331, 2), 5440165.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01001100000010101001011))))
(check-sat)
(exit)
