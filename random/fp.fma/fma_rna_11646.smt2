...
(assert (= z ((_ to_fp 8 24) #x800A3F1B)))
;; z should be Float32(0x800A3F1B [Rational(-671515, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00010100011111100011011))))
(check-sat)
(exit)
