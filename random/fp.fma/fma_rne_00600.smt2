...
(assert (= x (fp #b0 #b10010101 #b00010111101111011110101)))
;; x should be Float32(0x4A8BDEF5 [Rational(9166581, 2), 4583290.500000])
...
(assert (= z ((_ to_fp 8 24) #xCAE930DD)))
;; z should be Float32(0xCAE930DD [Rational(-15282397, 2), -7641198.500000])
