...
(assert (= y (fp #b0 #b10010101 #b10010111101111100000001)))
;; y should be Float32(0x4ACBDF01 [Rational(13360897, 2), 6680448.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b10010111101111011111101))))
(check-sat)
(exit)
