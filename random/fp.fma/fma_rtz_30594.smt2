...
(assert (= x (fp #b0 #b00000000 #b00000100110100010100101)))
;; x should be Float32(0x000268A5 [Rational(157861, 713623846352979940529142984724747568191373312), 0.000000])
