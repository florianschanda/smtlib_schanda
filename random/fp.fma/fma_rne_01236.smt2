...
(assert (= y ((_ to_fp 8 24) #x001F4547)))
;; y should be Float32(0x001F4547 [Rational(2049351, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F7A2A37))))
(check-sat)
(exit)
