...
(assert (= z (fp #b1 #b10010101 #b10101001001100011111001)))
;; z should be Float32(0xCAD498F9 [Rational(-13932793, 2), -6966396.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b10101001001100011111001)))
(check-sat)
(exit)
