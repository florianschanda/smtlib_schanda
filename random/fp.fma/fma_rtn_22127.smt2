...
(assert (= z (fp #b1 #b10010100 #b11110101101001110111010)))
;; z should be Float32(0xCA7AD3BA [Rational(-8219101, 2), -4109550.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA7AD3BA))))
(check-sat)
(exit)
