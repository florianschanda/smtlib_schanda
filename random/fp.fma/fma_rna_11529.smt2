...
(assert (= y (fp #b1 #b00000000 #b10001100001111110111000)))
;; y should be Float32(0x80461FB8 [Rational(-574455, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b00011000011111101101111))))
(check-sat)
(exit)
