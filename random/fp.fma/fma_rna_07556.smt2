...
(assert (= x ((_ to_fp 8 24) #x49CD4F24)))
;; x should be Float32(0x49CD4F24 [Rational(3363785, 2), 1681892.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x8078B708)))
;; y should be Float32(0x8078B708 [Rational(-988897, 89202980794122492566142873090593446023921664), -0.000000])
