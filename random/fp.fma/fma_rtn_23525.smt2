...
(assert (= x (fp #b0 #b00000000 #b11000001100111000110110)))
;; x should be Float32(0x0060CE36 [Rational(3172123, 356811923176489970264571492362373784095686656), 0.000000])
