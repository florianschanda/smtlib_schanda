...
(assert (= x ((_ to_fp 8 24) #x4AD31AA1)))
;; x should be Float32(0x4AD31AA1 [Rational(13834913, 2), 6917456.500000])
...
(assert (= result (fp #b1 #b00010111 #b10100110001101010100001)))
(check-sat)
(exit)
