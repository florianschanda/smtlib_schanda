...
(assert (= z ((_ to_fp 8 24) #xCAC2FAF3)))
;; z should be Float32(0xCAC2FAF3 [Rational(-12778227, 2), -6389113.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b10000101111101011110011)))
(check-sat)
(exit)
