...
(assert (= z ((_ to_fp 8 24) #x005713F3)))
;; z should be Float32(0x005713F3 [Rational(5706739, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b10101110001001111110011)))
(check-sat)
(exit)
