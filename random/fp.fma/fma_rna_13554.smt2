...
(assert (= x (fp #b1 #b11111111 #b10000000100000010010110)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b10010101 #b01100111011000111101101)))
;; y should be Float32(0xCAB3B1ED [Rational(-11776493, 2), -5888246.500000])
