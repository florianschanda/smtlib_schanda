...
(assert (= x ((_ to_fp 8 24) #x001E51C1)))
;; x should be Float32(0x001E51C1 [Rational(1987009, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10101111010111110011111)))
