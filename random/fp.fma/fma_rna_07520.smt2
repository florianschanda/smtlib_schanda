...
(assert (= x ((_ to_fp 8 24) #x4A054B62)))
;; x should be Float32(0x4A054B62 [Rational(4367793, 2), 2183896.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b01000010101001011011001))))
(check-sat)
(exit)
