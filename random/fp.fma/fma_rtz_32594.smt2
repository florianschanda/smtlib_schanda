...
(assert (= z ((_ to_fp 8 24) #x002D4B8E)))
;; z should be Float32(0x002D4B8E [Rational(1484231, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x002D4B8D))))
(check-sat)
(exit)
