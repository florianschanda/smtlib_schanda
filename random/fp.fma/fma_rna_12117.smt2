...
(assert (= y (fp #b1 #b10010100 #b10111111101111001111010)))
;; y should be Float32(0xCA5FDE7A [Rational(-7335741, 2), -3667870.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b10111111101111001110110))))
(check-sat)
(exit)
