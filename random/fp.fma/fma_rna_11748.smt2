...
(assert (= y (fp #b1 #b10010101 #b11111101001110001100011)))
;; y should be Float32(0xCAFE9C63 [Rational(-16686179, 2), -8343089.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BFE9C63))))
(check-sat)
(exit)
