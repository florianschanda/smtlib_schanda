...
(assert (= x (fp #b0 #b00000000 #b11110111111011101101000)))
;; x should be Float32(0x007BF768 [Rational(1015533, 89202980794122492566142873090593446023921664), 0.000000])
