...
(assert (= y (fp #b1 #b10010101 #b10111011100000110011011)))
;; y should be Float32(0xCADDC19B [Rational(-14533019, 2), -7266509.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BDDC19B))))
(check-sat)
(exit)
