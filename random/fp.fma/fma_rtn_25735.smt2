...
(assert (= z (fp #b0 #b00000000 #b00100111001001101011001)))
;; z should be Float32(0x00139359 [Rational(1282905, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00139358))))
(check-sat)
(exit)
