...
(assert (= x ((_ to_fp 8 24) #xF108E4F0)))
;; x should be Float32(0xF108E4F0 [Rational(-677867676648495256212072300544), -677867676648495256212072300544.000000])
...
(assert (= result ((_ to_fp 8 24) #x3208E4EE)))
(check-sat)
(exit)
