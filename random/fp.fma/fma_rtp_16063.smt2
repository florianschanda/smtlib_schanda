...
(assert (= z ((_ to_fp 8 24) #x6A458B62)))
;; z should be Float32(0x6A458B62 [Rational(59704150796530012909469696), 59704150796530012909469696.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x6A458B62))))
(check-sat)
(exit)
