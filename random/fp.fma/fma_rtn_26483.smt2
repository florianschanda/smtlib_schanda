...
(assert (= x ((_ to_fp 8 24) #xCE1ED390)))
;; x should be Float32(0xCE1ED390 [Rational(-666166272), -666166272.000000])
...
(assert (not (= result (fp #b1 #b00000111 #b00111101101001110010001))))
(check-sat)
(exit)
