...
(assert (= x (fp #b1 #b00000000 #b01100010100110100000000)))
;; x should be Float32(0x80314D00 [Rational(-12621, 2787593149816327892691964784081045188247552), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBFC533FF))))
(check-sat)
(exit)
