...
(assert (= y (fp #b1 #b10010100 #b00110011000010000010110)))
;; y should be Float32(0xCA198416 [Rational(-5030411, 2), -2515205.500000])
...
(assert (= result (fp #b0 #b00000000 #b01001100110000100000111)))
(check-sat)
(exit)
