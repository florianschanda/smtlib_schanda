...
(assert (= y (fp #b0 #b01000110 #b11000110110101010001001)))
;; y should be Float32(0x23636A89 [Rational(14903945, 1208925819614629174706176), 0.000000])
...
(assert (not (= result (fp #b0 #b11000110 #b11000110110101010001000))))
(check-sat)
(exit)
