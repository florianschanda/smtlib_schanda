...
(assert (= x (fp #b0 #b00000110 #b11011111101001010110011)))
;; x should be Float32(0x036FD2B3 [Rational(15717043, 22300745198530623141535718272648361505980416), 0.000000])
