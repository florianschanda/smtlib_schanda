...
(assert (= z (fp #b1 #b10010101 #b11011110011011101011111)))
;; z should be Float32(0xCAEF375F [Rational(-15677279, 2), -7838639.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010101 #b11011110011011101011111))))
(check-sat)
(exit)
