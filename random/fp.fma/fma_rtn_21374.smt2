...
(assert (= z (fp #b1 #b00000000 #b01011010000110011111010)))
;; z should be Float32(0x802D0CFA [Rational(-1476221, 356811923176489970264571492362373784095686656), -0.000000])
