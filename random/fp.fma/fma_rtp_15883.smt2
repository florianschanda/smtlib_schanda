...
(assert (= y ((_ to_fp 8 24) #xFF951B13)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00000000 #b01011001100000111111101)))
;; z should be Float32(0x802CC1FD [Rational(-2933245, 713623846352979940529142984724747568191373312), -0.000000])
