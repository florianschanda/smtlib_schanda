...
(assert (= x (fp #b0 #b10100100 #b00101111101011010111101)))
;; x should be Float32(0x5217D6BD [Rational(163035693056), 163035693056.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x9317D6BC))))
(check-sat)
(exit)
