...
(assert (= x ((_ to_fp 8 24) #x7ACD7686)))
;; x should be Float32(0x7ACD7686 [Rational(533412398453323736190007529015607296), 533412398453323736190007529015607296.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10111100111100110111111)))
