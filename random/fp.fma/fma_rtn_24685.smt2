...
(assert (= y (fp #b0 #b11011010 #b01101110110001001001001)))
;; y should be Float32(0x6D376249 [Rational(3547161016273851919991046144), 3547161016273851919991046144.000000])
