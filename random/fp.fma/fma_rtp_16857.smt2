...
(assert (= x (fp #b0 #b00000000 #b10101110000000101101011)))
;; x should be Float32(0x0057016B [Rational(5701995, 713623846352979940529142984724747568191373312), 0.000000])
