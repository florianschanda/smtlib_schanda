...
(assert (= y (fp #b1 #b11111111 #b01011101010011101110111)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x8019A609)))
;; z should be Float32(0x8019A609 [Rational(-1680905, 713623846352979940529142984724747568191373312), -0.000000])
