...
(assert (= y (fp #b0 #b00000000 #b01110110110000011101110)))
;; y should be Float32(0x003B60EE [Rational(1945719, 356811923176489970264571492362373784095686656), 0.000000])
