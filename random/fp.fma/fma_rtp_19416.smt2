...
(assert (= z (fp #b1 #b01010011 #b00010001010001011010111)))
;; z should be Float32(0xA988A2D7 [Rational(-8954583, 147573952589676412928), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b01010011 #b00010001010001011010110)))
(check-sat)
(exit)
