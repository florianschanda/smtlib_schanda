...
(assert (= x ((_ to_fp 8 24) #x4A4B280A)))
;; x should be Float32(0x4A4B280A [Rational(6657029, 2), 3328514.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b10010110010100000000110))))
(check-sat)
(exit)
