...
(assert (= z ((_ to_fp 8 24) #x0069CE81)))
;; z should be Float32(0x0069CE81 [Rational(6934145, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b11010011100111010000001)))
(check-sat)
(exit)
