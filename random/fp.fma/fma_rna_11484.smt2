...
(assert (= z (fp #b0 #b11011000 #b10000000100000010001100)))
;; z should be Float32(0x6C40408C [Rational(929674285460331112697954304), 929674285460331112697954304.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b11011000 #b10000000100000010001100)))
(check-sat)
(exit)
