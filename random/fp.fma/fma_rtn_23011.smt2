...
(assert (= z (fp #b0 #b10010101 #b10110111100111111011101)))
;; z should be Float32(0x4ADBCFDD [Rational(14405597, 2), 7202798.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b10110111100111111011100)))
(check-sat)
(exit)
