...
(assert (= z (fp #b0 #b10010100 #b00010101000111000110110)))
;; z should be Float32(0x4A0A8E36 [Rational(4540187, 2), 2270093.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010100 #b00010101000111000110110)))
(check-sat)
(exit)
