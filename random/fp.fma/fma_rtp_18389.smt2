...
(assert (= y (fp #b1 #b00000000 #b00011110001110110011100)))
;; y should be Float32(0x800F1D9C [Rational(-247655, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3EF1D9C0))))
(check-sat)
(exit)
