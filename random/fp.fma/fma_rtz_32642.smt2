...
(assert (= y (fp #b0 #b00101101 #b10000010100111000101000)))
;; y should be Float32(0x16C14E28 [Rational(1583557, 5070602400912917605986812821504), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FDE2C2B)))
