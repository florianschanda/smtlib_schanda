...
(assert (= y ((_ to_fp 8 24) #x005FE82D)))
;; y should be Float32(0x005FE82D [Rational(6285357, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b00111101000011001001100)))
