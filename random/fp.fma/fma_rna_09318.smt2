...
(assert (= z ((_ to_fp 8 24) #x379359F1)))
;; z should be Float32(0x379359F1 [Rational(9656817, 549755813888), 0.000018])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b01101111 #b00100110101100111110001)))
(check-sat)
(exit)
