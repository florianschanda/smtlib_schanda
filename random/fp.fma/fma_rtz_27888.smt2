...
(assert (= x (fp #b0 #b10010000 #b10000011110110001100000)))
;; x should be Float32(0x4841EC60 [Rational(397155, 2), 198577.500000])
...
(assert (= result (fp #b0 #b00010010 #b10000011110110000011110)))
(check-sat)
(exit)
