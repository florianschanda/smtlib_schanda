...
(assert (= x (fp #b1 #b01011101 #b10000111000101101101010)))
;; x should be Float32(0xAEC38B6A [Rational(-6407605, 72057594037927936), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xEEC38B69))))
(check-sat)
(exit)
