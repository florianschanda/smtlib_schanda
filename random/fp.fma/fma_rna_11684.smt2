...
(assert (= z (fp #b1 #b00000000 #b00011101110001101101101)))
;; z should be Float32(0x800EE36D [Rational(-975725, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00011101110001101101101))))
(check-sat)
(exit)
