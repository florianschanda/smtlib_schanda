...
(assert (= y (fp #b0 #b00000000 #b10000001000000111111100)))
;; y should be Float32(0x004081FC [Rational(1056895, 178405961588244985132285746181186892047843328), 0.000000])
