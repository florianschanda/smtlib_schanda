...
(assert (= z (fp #b0 #b00000000 #b00110111110000111101101)))
;; z should be Float32(0x001BE1ED [Rational(1827309, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x001BE1ED)))
(check-sat)
(exit)
