...
(assert (= y (fp #b1 #b00000000 #b01101010001101111100011)))
;; y should be Float32(0x80351BE3 [Rational(-3480547, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFD6112B)))
