...
(assert (= z (fp #b0 #b00000000 #b01101001010000110100100)))
;; z should be Float32(0x0034A1A4 [Rational(862313, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0034A1A4))))
(check-sat)
(exit)
