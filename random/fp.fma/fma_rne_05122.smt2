...
(assert (= z (fp #b1 #b10010101 #b00101001111010000110111)))
;; z should be Float32(0xCA94F437 [Rational(-9761847, 2), -4880923.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b00101001111010000111111)))
(check-sat)
(exit)
