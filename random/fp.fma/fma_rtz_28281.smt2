...
(assert (= z (fp #b0 #b00000000 #b11000110101100011011001)))
;; z should be Float32(0x006358D9 [Rational(6510809, 713623846352979940529142984724747568191373312), 0.000000])
