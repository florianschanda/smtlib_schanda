...
(assert (= z ((_ to_fp 8 24) #x4FAA79D0)))
;; z should be Float32(0x4FAA79D0 [Rational(5720219648), 5720219648.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10011111 #b01010100111100111010000)))
(check-sat)
(exit)
