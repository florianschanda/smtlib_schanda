...
(assert (= z (fp #b1 #b00000000 #b10000010100110011010010)))
;; z should be Float32(0x80414CD2 [Rational(-2139753, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10000010100110011010010))))
(check-sat)
(exit)
