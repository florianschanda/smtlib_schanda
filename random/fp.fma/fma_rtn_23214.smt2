...
(assert (= x (fp #b0 #b11111010 #b11000110000100011000011)))
;; x should be Float32(0x7D6308C3 [Rational(18861265530494805865370319773017047040), 18861265530494805865370319773017047040.000000])
...
(assert (not (= result (fp #b0 #b01111100 #b11000110000100011000010))))
(check-sat)
(exit)
