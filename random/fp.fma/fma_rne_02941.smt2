...
(assert (= x (fp #b0 #b00000000 #b01110111011101000001101)))
;; x should be Float32(0x003BBA0D [Rational(3914253, 713623846352979940529142984724747568191373312), 0.000000])
