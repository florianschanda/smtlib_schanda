...
(assert (= x (fp #b0 #b10010100 #b11110000111010101001010)))
;; x should be Float32(0x4A78754A [Rational(8141477, 2), 4070738.500000])
...
(assert (= result (fp #b0 #b00000000 #b01111100001110101010010)))
(check-sat)
(exit)
