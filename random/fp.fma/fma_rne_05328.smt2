...
(assert (= z (fp #b0 #b01000110 #b00000000110110011111010)))
;; z should be Float32(0x23006CFA [Rational(4208253, 604462909807314587353088), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x23006CFA)))
(check-sat)
(exit)
