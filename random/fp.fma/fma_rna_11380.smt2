...
(assert (= z ((_ to_fp 8 24) #x803936F2)))
;; z should be Float32(0x803936F2 [Rational(-1874809, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00000000 #b01110010011011011110010)))
(check-sat)
(exit)
