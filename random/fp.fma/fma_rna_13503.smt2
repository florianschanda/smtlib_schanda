...
(assert (= x (fp #b0 #b11111111 #b01100011000101001010101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b01000101 #b01110101100100000000011)))
;; y should be Float32(0x22BAC803 [Rational(12240899, 2417851639229258349412352), 0.000000])
