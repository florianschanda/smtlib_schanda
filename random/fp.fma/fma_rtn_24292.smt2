...
(assert (= x (fp #b1 #b10010010 #b01100011100110101001000)))
;; x should be Float32(0xC931CD48 [Rational(-1456553, 2), -728276.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b01100011100110101001000))))
(check-sat)
(exit)
