...
(assert (= z (fp #b1 #b10110011 #b10111010100101001000101)))
;; z should be Float32(0xD9DD4A45 [Rational(-7785953758281728), -7785953758281728.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xD9DD4A45)))
(check-sat)
(exit)
