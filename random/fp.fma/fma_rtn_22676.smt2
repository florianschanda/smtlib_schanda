...
(assert (= z (fp #b0 #b00000000 #b11111100111100101111110)))
;; z should be Float32(0x007E797E [Rational(4144319, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b11111100111100101111101)))
(check-sat)
(exit)
