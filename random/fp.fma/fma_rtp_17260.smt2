...
(assert (= z ((_ to_fp 8 24) #x1F73BE4C)))
;; z should be Float32(0x1F73BE4C [Rational(3993491, 77371252455336267181195264), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x1F73BE4C))))
(check-sat)
(exit)
