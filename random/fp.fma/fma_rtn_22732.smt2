...
(assert (= y (fp #b0 #b11111111 #b01100010111111010001011)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b00101010 #b01101100000100011011011)))
;; z should be Float32(0x153608DB [Rational(11929819, 324518553658426726783156020576256), 0.000000])
