...
(assert (= x (fp #b1 #b11111100 #b11000111101101110111011)))
;; x should be Float32(0xFE63DBBB [Rational(-75718915216447728315545414878931976192), -75718915216447728315545414878931976192.000000])
