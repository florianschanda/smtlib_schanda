...
(assert (= x (fp #b0 #b00000000 #b00111010100000001111010)))
;; x should be Float32(0x001D407A [Rational(958525, 356811923176489970264571492362373784095686656), 0.000000])
