...
(assert (= x ((_ to_fp 8 24) #x0007ED86)))
;; x should be Float32(0x0007ED86 [Rational(259779, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FC6BF89)))
