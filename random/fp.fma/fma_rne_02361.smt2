...
(assert (= y ((_ to_fp 8 24) #xCABF8123)))
;; y should be Float32(0xCABF8123 [Rational(-12550435, 2), -6275217.500000])
...
(assert (= result (fp #b0 #b00000000 #b01000000011111101101110)))
(check-sat)
(exit)
