...
(assert (= x (fp #b0 #b00000000 #b11001001111111011101000)))
;; x should be Float32(0x0064FEE8 [Rational(827357, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC049FDD0)))
(check-sat)
(exit)
