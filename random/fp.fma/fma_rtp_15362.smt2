...
(assert (= y (fp #b1 #b10010011 #b01010011100100010100100)))
;; y should be Float32(0xC9A9C8A4 [Rational(-2781737, 2), -1390868.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b01010011100100010100010))))
(check-sat)
(exit)
