...
(assert (= z (fp #b0 #b00000000 #b10110111011110111000011)))
;; z should be Float32(0x005BBDC3 [Rational(6012355, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x005BBDC3))))
(check-sat)
(exit)
