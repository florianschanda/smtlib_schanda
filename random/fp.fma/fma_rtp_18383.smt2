...
(assert (= y (fp #b1 #b00000000 #b00101010100011101100000)))
;; y should be Float32(0x80154760 [Rational(-43579, 22300745198530623141535718272648361505980416), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F2A3B00))))
(check-sat)
(exit)
