...
(assert (= z (fp #b0 #b00000000 #b11011011110110101001101)))
;; z should be Float32(0x006DED4D [Rational(7204173, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b11011011110110101001101)))
(check-sat)
(exit)
