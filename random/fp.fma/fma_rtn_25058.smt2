...
(assert (= y (fp #b0 #b00101101 #b10110111001011001100000)))
;; y should be Float32(0x16DB9660 [Rational(449715, 1267650600228229401496703205376), 0.000000])
...
(assert (not (= result (fp #b1 #b10101101 #b10110111001011001100000))))
(check-sat)
(exit)
