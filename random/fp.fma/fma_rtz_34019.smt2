...
(assert (= x (fp #b1 #b11111111 #b11000000001100011110000)))
...
(assert (= z ((_ to_fp 8 24) #x00337300)))
;; z should be Float32(0x00337300 [Rational(13171, 2787593149816327892691964784081045188247552), 0.000000])
