...
(assert (= y (fp #b0 #b10010101 #b11101011101111111100101)))
;; y should be Float32(0x4AF5DFE5 [Rational(16113637, 2), 8056818.500000])
...
(assert (= result (fp #b1 #b00000000 #b11110101110111111110010)))
(check-sat)
(exit)
