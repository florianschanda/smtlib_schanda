...
(assert (= z (fp #b1 #b10010101 #b11011001001000011110001)))
;; z should be Float32(0xCAEC90F1 [Rational(-15503601, 2), -7751800.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xCAEC90F1)))
(check-sat)
(exit)
