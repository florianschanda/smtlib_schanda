...
(assert (= y ((_ to_fp 8 24) #x1FC42361)))
;; y should be Float32(0x1FC42361 [Rational(12854113, 154742504910672534362390528), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x5FC42360)))
(check-sat)
(exit)
