...
(assert (= z (fp #b0 #b00000000 #b00011110101110011000000)))
;; z should be Float32(0x000F5CC0 [Rational(15731, 11150372599265311570767859136324180752990208), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x000F5CBF))))
(check-sat)
(exit)
