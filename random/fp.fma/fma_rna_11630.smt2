...
(assert (= z (fp #b0 #b10010101 #b01010111110111111110111)))
;; z should be Float32(0x4AABEFF7 [Rational(11268087, 2), 5634043.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AABEFF7))))
(check-sat)
(exit)
