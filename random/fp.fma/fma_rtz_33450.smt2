...
(assert (= x ((_ to_fp 8 24) #x82C690E4)))
;; x should be Float32(0x82C690E4 [Rational(-3253305, 11150372599265311570767859136324180752990208), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x42C690E3))))
(check-sat)
(exit)
