...
(assert (= z (fp #b1 #b00000000 #b10011110101000000100111)))
;; z should be Float32(0x804F5027 [Rational(-5197863, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10011110101000000100111))))
(check-sat)
(exit)
