...
(assert (= x (fp #b1 #b10010101 #b11101111101100111110011)))
;; x should be Float32(0xCAF7D9F3 [Rational(-16243187, 2), -8121593.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b11101111101100111110000))))
(check-sat)
(exit)
