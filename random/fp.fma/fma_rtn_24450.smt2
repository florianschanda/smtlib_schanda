...
(assert (= x (fp #b1 #b10010100 #b10010100110000101101110)))
;; x should be Float32(0xCA4A616E [Rational(-6631607, 2), -3315803.500000])
...
(assert (= result (fp #b0 #b00010110 #b10010100110000101101100)))
(check-sat)
(exit)
