...
(assert (= x (fp #b0 #b10010010 #b00100101100111100001000)))
;; x should be Float32(0x4912CF08 [Rational(1202657, 2), 601328.500000])
...
(assert (not (= result (fp #b1 #b00010100 #b00100101100111100000111))))
(check-sat)
(exit)
