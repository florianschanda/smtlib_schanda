...
(assert (= y ((_ to_fp 8 24) #xCA934D75)))
;; y should be Float32(0xCA934D75 [Rational(-9653621, 2), -4826810.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b10010011010011010111010))))
(check-sat)
(exit)
