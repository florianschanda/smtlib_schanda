...
(assert (= z ((_ to_fp 8 24) #x8014930A)))
;; z should be Float32(0x8014930A [Rational(-674181, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00000000 #b00101001001001100001010)))
(check-sat)
(exit)
