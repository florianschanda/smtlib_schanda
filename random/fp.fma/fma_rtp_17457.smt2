...
(assert (= x (fp #b1 #b10010101 #b01111010101001101010011)))
;; x should be Float32(0xCABD5353 [Rational(-12407635, 2), -6203817.500000])
...
(assert (not (= result (fp #b1 #b00000001 #b10111101010100110101001))))
(check-sat)
(exit)
