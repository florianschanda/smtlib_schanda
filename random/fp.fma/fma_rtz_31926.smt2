...
(assert (= y (fp #b0 #b00000000 #b00110110110110001001010)))
;; y should be Float32(0x001B6C4A [Rational(898597, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b1 #b01111110 #b10110110110001001001111))))
(check-sat)
(exit)
