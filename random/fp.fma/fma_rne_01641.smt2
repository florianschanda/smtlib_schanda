...
(assert (= y (fp #b1 #b10010100 #b00100111001001000001010)))
;; y should be Float32(0xCA13920A [Rational(-4835589, 2), -2417794.500000])
...
(assert (= result (fp #b1 #b00010110 #b00100111001001000001001)))
(check-sat)
(exit)
