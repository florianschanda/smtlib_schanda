...
(assert (= y (fp #b1 #b11110110 #b00110011001111101111010)))
;; y should be Float32(0xFB199F7A [Rational(-797655988318635983011759963687092224), -797655988318635983011759963687092224.000000])
...
(assert (= result ((_ to_fp 8 24) #x30999F7A)))
(check-sat)
(exit)
