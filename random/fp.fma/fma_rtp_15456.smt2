...
(assert (= z ((_ to_fp 8 24) #x0025CA9C)))
;; z should be Float32(0x0025CA9C [Rational(619175, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01001011100101010011100))))
(check-sat)
(exit)
