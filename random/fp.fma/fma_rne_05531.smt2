...
(assert (= z (fp #b0 #b10010101 #b10111111111010001101101)))
;; z should be Float32(0x4ADFF46D [Rational(14677101, 2), 7338550.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10111111111010001101101))))
(check-sat)
(exit)
