...
(assert (= x ((_ to_fp 8 24) #xAD319D47)))
;; x should be Float32(0xAD319D47 [Rational(-11640135, 1152921504606846976), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b01001111100110011011101)))
