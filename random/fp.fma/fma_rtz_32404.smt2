...
(assert (= z (fp #b0 #b00000000 #b00000011010010010100111)))
;; z should be Float32(0x0001A4A7 [Rational(107687, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0001A4A7))))
(check-sat)
(exit)
