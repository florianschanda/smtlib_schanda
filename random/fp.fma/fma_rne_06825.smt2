...
(assert (= x (fp #b0 #b11111111 #b01010000100011111001011)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x8064CB55)))
;; y should be Float32(0x8064CB55 [Rational(-6605653, 713623846352979940529142984724747568191373312), -0.000000])
