...
(assert (= x (fp #b0 #b00000000 #b11001110110001100100101)))
;; x should be Float32(0x00676325 [Rational(6775589, 713623846352979940529142984724747568191373312), 0.000000])
