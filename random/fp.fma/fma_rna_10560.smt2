...
(assert (= x ((_ to_fp 8 24) #xC99595D4)))
;; x should be Float32(0xC99595D4 [Rational(-2450805, 2), -1225402.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b00101011001010111011011))))
(check-sat)
(exit)
