...
(assert (= x (fp #b1 #b10010101 #b11110110010011100101111)))
;; x should be Float32(0xCAFB272F [Rational(-16459567, 2), -8229783.500000])
...
(assert (= result ((_ to_fp 8 24) #x80FD9397)))
(check-sat)
(exit)
