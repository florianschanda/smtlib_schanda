...
(assert (= z ((_ to_fp 8 24) #x4AE394BF)))
;; z should be Float32(0x4AE394BF [Rational(14914751, 2), 7457375.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11000111001010010111111))))
(check-sat)
(exit)
