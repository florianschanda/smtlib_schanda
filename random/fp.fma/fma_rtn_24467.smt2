...
(assert (= x (fp #b1 #b10010101 #b01101010000011110100111)))
;; x should be Float32(0xCAB507A7 [Rational(-11863975, 2), -5931987.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01101010000011110100101))))
(check-sat)
(exit)
