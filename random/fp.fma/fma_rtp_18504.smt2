...
(assert (= z (fp #b1 #b10111000 #b11101111011100110010111)))
;; z should be Float32(0xDC77B997 [Rational(-278913509754929152), -278913509754929152.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xDC77B997))))
(check-sat)
(exit)
