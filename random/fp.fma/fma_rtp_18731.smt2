...
(assert (= y (fp #b1 #b11001111 #b00101101000111001110110)))
;; y should be Float32(0xE7968E76 [Rational(-1421965825770020027760640), -1421965825770020027760640.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x28968E75))))
(check-sat)
(exit)
