...
(assert (= y ((_ to_fp 8 24) #x39C32450)))
;; y should be Float32(0x39C32450 [Rational(799301, 2147483648), 0.000372])
...
(assert (= result (fp #b0 #b00000000 #b11111111111001111001100)))
(check-sat)
(exit)
