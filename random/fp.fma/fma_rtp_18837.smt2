...
(assert (= z (fp #b0 #b10011010 #b01001001101100010010001)))
;; z should be Float32(0x4D24D891 [Rational(172853520), 172853520.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10011010 #b01001001101100010010001)))
(check-sat)
(exit)
