...
(assert (= x (fp #b1 #b01000100 #b11100100001111110110110)))
;; x should be Float32(0xA2721FB6 [Rational(-7933915, 2417851639229258349412352), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00000100111000011001001)))
