...
(assert (= x (fp #b0 #b00001011 #b11011110010100100010011)))
;; x should be Float32(0x05EF2913 [Rational(15673619, 696898287454081973172991196020261297061888), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC5EF2912)))
(check-sat)
(exit)
