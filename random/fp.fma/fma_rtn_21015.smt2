...
(assert (= x (fp #b0 #b10010101 #b00100000001000000011011)))
;; x should be Float32(0x4A90101B [Rational(9441307, 2), 4720653.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0B901019))))
(check-sat)
(exit)
