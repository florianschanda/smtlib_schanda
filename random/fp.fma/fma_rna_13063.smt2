...
(assert (= x ((_ to_fp 8 24) #x8018F169)))
;; x should be Float32(0x8018F169 [Rational(-1634665, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBF478B47))))
(check-sat)
(exit)
