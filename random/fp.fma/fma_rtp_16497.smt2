...
(assert (= x ((_ to_fp 8 24) #x3E89FCAF)))
;; x should be Float32(0x3E89FCAF [Rational(9043119, 33554432), 0.269506])
...
(assert (not (= result (fp #b0 #b00000000 #b10111011000000011010100))))
(check-sat)
(exit)
