...
(assert (= y ((_ to_fp 8 24) #x800EDCEF)))
;; y should be Float32(0x800EDCEF [Rational(-974063, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FB292E8)))
