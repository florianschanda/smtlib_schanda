...
(assert (= z ((_ to_fp 8 24) #xE7C0296F)))
;; z should be Float32(0xE7C0296F [Rational(-1814917359221864365293568), -1814917359221864365293568.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xE7C0296F)))
(check-sat)
(exit)
