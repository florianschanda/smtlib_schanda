...
(assert (= y ((_ to_fp 8 24) #x006F6E6E)))
;; y should be Float32(0x006F6E6E [Rational(3651383, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b01000111111100101111111)))
