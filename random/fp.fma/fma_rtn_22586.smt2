...
(assert (= y ((_ to_fp 8 24) #xCAA429F7)))
;; y should be Float32(0xCAA429F7 [Rational(-10758647, 2), -5379323.500000])
...
(assert (= result (fp #b1 #b00010111 #b01001000010100111111001)))
(check-sat)
(exit)
