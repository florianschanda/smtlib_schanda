...
(assert (= x (fp #b1 #b00000000 #b00101101001101001100011)))
;; x should be Float32(0x80169A63 [Rational(-1481315, 713623846352979940529142984724747568191373312), -0.000000])
