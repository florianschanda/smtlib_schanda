...
(assert (= z ((_ to_fp 8 24) #xE23DBA50)))
;; z should be Float32(0xE23DBA50 [Rational(-874964965105074176000), -874964965105074176000.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xE23DBA50)))
(check-sat)
(exit)
