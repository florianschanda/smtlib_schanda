...
(assert (= z (fp #b1 #b00000000 #b00110001010001000001111)))
;; z should be Float32(0x8018A20F [Rational(-1614351, 713623846352979940529142984724747568191373312), -0.000000])
