...
(assert (= z ((_ to_fp 8 24) #x4AB9C23B)))
;; z should be Float32(0x4AB9C23B [Rational(12173883, 2), 6086941.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b01110011100001000111011)))
(check-sat)
(exit)
