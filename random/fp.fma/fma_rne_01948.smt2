...
(assert (= y (fp #b0 #b00000010 #b00001111010001001000010)))
;; y should be Float32(0x0107A242 [Rational(4444449, 178405961588244985132285746181186892047843328), 0.000000])
