...
(assert (= x (fp #b1 #b00000000 #b11111001011101001111000)))
;; x should be Float32(0x807CBA78 [Rational(-1021775, 89202980794122492566142873090593446023921664), -0.000000])
