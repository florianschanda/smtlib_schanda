...
(assert (= x (fp #b1 #b00000000 #b11101100000110111010111)))
;; x should be Float32(0x80760DD7 [Rational(-7736791, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11011000001101110101101))))
(check-sat)
(exit)
