...
(assert (= z (fp #b1 #b10010100 #b11010101011111011001010)))
;; z should be Float32(0xCA6ABECA [Rational(-7692133, 2), -3846066.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010100 #b11010101011111011001010)))
(check-sat)
(exit)
