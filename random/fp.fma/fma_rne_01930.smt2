...
(assert (= z ((_ to_fp 8 24) #xCA90A135)))
;; z should be Float32(0xCA90A135 [Rational(-9478453, 2), -4739226.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00100001010000100110101))))
(check-sat)
(exit)
