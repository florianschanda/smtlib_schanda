...
(assert (= x (fp #b1 #b00000000 #b01110101010110010111100)))
;; x should be Float32(0x803AACBC [Rational(-961327, 178405961588244985132285746181186892047843328), -0.000000])
