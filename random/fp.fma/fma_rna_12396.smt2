...
(assert (= z ((_ to_fp 8 24) #x3DAC28C0)))
;; z should be Float32(0x3DAC28C0 [Rational(176291, 2097152), 0.084062])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b01111011 #b01011000010100011000000))))
(check-sat)
(exit)
