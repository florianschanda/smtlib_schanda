...
(assert (= z ((_ to_fp 8 24) #x80275BDF)))
;; z should be Float32(0x80275BDF [Rational(-2579423, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80275BDF))))
(check-sat)
(exit)
