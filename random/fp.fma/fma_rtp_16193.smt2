...
(assert (= y ((_ to_fp 8 24) #xCD5BB188)))
;; y should be Float32(0xCD5BB188 [Rational(-230365312), -230365312.000000])
...
(assert (= result (fp #b1 #b00000101 #b10100111011000110001000)))
(check-sat)
(exit)
