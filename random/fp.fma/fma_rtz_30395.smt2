...
(assert (= x (fp #b0 #b00000000 #b01111111100001010000100)))
;; x should be Float32(0x003FC284 [Rational(1044641, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3FFF0A0F))))
(check-sat)
(exit)
