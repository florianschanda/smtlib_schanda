...
(assert (= z (fp #b1 #b10010101 #b10001101101001011100101)))
;; z should be Float32(0xCAC6D2E5 [Rational(-13030117, 2), -6515058.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xCAC6D2E5)))
(check-sat)
(exit)
