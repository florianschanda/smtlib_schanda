...
(assert (= z ((_ to_fp 8 24) #x4A8058AF)))
;; z should be Float32(0x4A8058AF [Rational(8411311, 2), 4205655.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00000000101100010101111))))
(check-sat)
(exit)
