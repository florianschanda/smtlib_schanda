...
(assert (= x (fp #b1 #b00000000 #b11100010110011010110100)))
;; x should be Float32(0x807166B4 [Rational(-1857965, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC062CD67)))
(check-sat)
(exit)
