...
(assert (= y (fp #b1 #b10101111 #b10110000001100010110000)))
;; y should be Float32(0xD7D818B0 [Rational(-475201087209472), -475201087209472.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b00011111111100001001101)))
