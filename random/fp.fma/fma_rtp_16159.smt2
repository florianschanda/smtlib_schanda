...
(assert (= z ((_ to_fp 8 24) #x000E8C65)))
;; z should be Float32(0x000E8C65 [Rational(953445, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x000E8C65))))
(check-sat)
(exit)
