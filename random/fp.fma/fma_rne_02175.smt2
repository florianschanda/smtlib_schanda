...
(assert (= z ((_ to_fp 8 24) #x0005CC24)))
;; z should be Float32(0x0005CC24 [Rational(94985, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x0005CC24)))
(check-sat)
(exit)
