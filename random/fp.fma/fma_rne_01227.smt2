...
(assert (= y ((_ to_fp 8 24) #x422131BF)))
;; y should be Float32(0x422131BF [Rational(10564031, 262144), 40.298580])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xC9D657EC)))
;; z should be Float32(0xC9D657EC [Rational(-3511803, 2), -1755901.500000])
