...
(assert (= x (fp #b0 #b00000000 #b11000001101100001010110)))
;; x should be Float32(0x0060D856 [Rational(3173419, 356811923176489970264571492362373784095686656), 0.000000])
