...
(assert (= z (fp #b0 #b01100001 #b00011100111110010110011)))
;; z should be Float32(0x308E7CB3 [Rational(9338035, 9007199254740992), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b01100001 #b00011100111110010110011))))
(check-sat)
(exit)
