...
(assert (= y (fp #b1 #b10010101 #b10001010111101100101111)))
;; y should be Float32(0xCAC57B2F [Rational(-12942127, 2), -6471063.500000])
...
(assert (= result ((_ to_fp 8 24) #x0062BD98)))
(check-sat)
(exit)
