...
(assert (= y ((_ to_fp 8 24) #x00463C03)))
;; y should be Float32(0x00463C03 [Rational(4602883, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b00011000111100000000101))))
(check-sat)
(exit)
