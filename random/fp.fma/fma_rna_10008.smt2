...
(assert (= x (fp #b0 #b00000000 #b11111111110011000111010)))
;; x should be Float32(0x007FE63A [Rational(4191005, 356811923176489970264571492362373784095686656), 0.000000])
