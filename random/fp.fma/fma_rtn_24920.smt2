...
(assert (= z (fp #b1 #b10010001 #b00001111101111011110000)))
;; z should be Float32(0xC887DEF0 [Rational(-556527, 2), -278263.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010001 #b00001111101111011110000)))
(check-sat)
(exit)
