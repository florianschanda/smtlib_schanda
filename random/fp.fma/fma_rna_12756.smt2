...
(assert (= x ((_ to_fp 8 24) #xF4C21BB4)))
;; x should be Float32(0xF4C21BB4 [Rational(-123030697837439907546036340523008), -123030697837439907546036340523008.000000])
...
(assert (= result (fp #b1 #b01010100 #b10000100001101110110100)))
(check-sat)
(exit)
