...
(assert (= y (fp #b0 #b10010101 #b10100100001001000011111)))
;; y should be Float32(0x4AD2121F [Rational(13767199, 2), 6883599.500000])
...
(assert (= result (fp #b0 #b00000000 #b11010010000100100001111)))
(check-sat)
(exit)
