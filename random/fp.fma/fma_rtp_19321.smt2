...
(assert (= z (fp #b1 #b10110100 #b00000010010111000001110)))
;; z should be Float32(0xDA012E0E [Rational(-9090227415023616), -9090227415023616.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10110100 #b00000010010111000001110))))
(check-sat)
(exit)
