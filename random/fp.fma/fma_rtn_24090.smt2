...
(assert (= z (fp #b1 #b01011010 #b01001111110111000111101)))
;; z should be Float32(0xAD27EE3D [Rational(-11005501, 1152921504606846976), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b01011010 #b01001111110111000111101)))
(check-sat)
(exit)
