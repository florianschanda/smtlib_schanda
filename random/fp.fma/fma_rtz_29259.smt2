...
(assert (= z ((_ to_fp 8 24) #x807F4D72)))
;; z should be Float32(0x807F4D72 [Rational(-4171449, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11111110100110101110010))))
(check-sat)
(exit)
