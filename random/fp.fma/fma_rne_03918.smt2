...
(assert (= x ((_ to_fp 8 24) #xCAF3F46B)))
;; x should be Float32(0xCAF3F46B [Rational(-15987819, 2), -7993909.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b01110010 #b00010000111000001100010)))
;; y should be Float32(0xB9087062 [Rational(-4470833, 34359738368), -0.000130])
