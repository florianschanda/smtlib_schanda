...
(assert (= y (fp #b1 #b00000000 #b11000101101100111110111)))
;; y should be Float32(0x8062D9F7 [Rational(-6478327, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b10001011011001111101101))))
(check-sat)
(exit)
