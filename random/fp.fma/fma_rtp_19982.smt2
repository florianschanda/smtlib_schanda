...
(assert (= x (fp #b1 #b00000000 #b01001001011101111000010)))
;; x should be Float32(0x8024BBC2 [Rational(-1203681, 356811923176489970264571492362373784095686656), -0.000000])
