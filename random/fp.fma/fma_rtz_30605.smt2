...
(assert (= x (fp #b0 #b00000000 #b11011101111110111100110)))
;; x should be Float32(0x006EFDE6 [Rational(3636979, 356811923176489970264571492362373784095686656), 0.000000])
