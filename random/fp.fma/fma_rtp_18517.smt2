...
(assert (= z (fp #b1 #b10010101 #b11111110100010000100101)))
;; z should be Float32(0xCAFF4425 [Rational(-16729125, 2), -8364562.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAFF4425))))
(check-sat)
(exit)
