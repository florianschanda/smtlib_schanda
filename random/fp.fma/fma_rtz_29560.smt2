...
(assert (= y ((_ to_fp 8 24) #xDF5C755B)))
;; y should be Float32(0xDF5C755B [Rational(-15885703316177420288), -15885703316177420288.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA05C755B))))
(check-sat)
(exit)
