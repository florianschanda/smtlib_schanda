...
(assert (= z ((_ to_fp 8 24) #x7F4A09DB)))
;; z should be Float32(0x7F4A09DB [Rational(268555227667983019491048645091624222720), 268555227667983019491048645091624222720.000000])
