...
(assert (= x (fp #b0 #b10010100 #b01011001100110011111010)))
;; x should be Float32(0x4A2CCCFA [Rational(5662333, 2), 2831166.500000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b11001110110011101110110)))
