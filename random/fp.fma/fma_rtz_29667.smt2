...
(assert (= z (fp #b0 #b10001011 #b11101001010001011000011)))
;; z should be Float32(0x45F4A2C3 [Rational(16032451, 2048), 7828.345215])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10001011 #b11101001010001011000011))))
(check-sat)
(exit)
