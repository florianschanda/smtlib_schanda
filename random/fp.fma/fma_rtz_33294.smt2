...
(assert (= x (fp #b1 #b11101011 #b01110100101001111011101)))
;; x should be Float32(0xF5BA53DD [Rational(-472396564994383144516830132961280), -472396564994383144516830132961280.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB6BA53DB))))
(check-sat)
(exit)
