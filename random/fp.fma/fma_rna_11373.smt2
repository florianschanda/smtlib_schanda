...
(assert (= z ((_ to_fp 8 24) #xCAD72D99)))
;; z should be Float32(0xCAD72D99 [Rational(-14101913, 2), -7050956.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10101110010110110011001))))
(check-sat)
(exit)
