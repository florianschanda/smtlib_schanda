...
(assert (= y ((_ to_fp 8 24) #xCAAD4A2D)))
;; y should be Float32(0xCAAD4A2D [Rational(-11356717, 2), -5678358.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b01111001 #b01011001101111101011000)))
;; z should be Float32(0x3CACDF58 [Rational(1416171, 67108864), 0.021103])
