...
(assert (= y (fp #b1 #b11111111 #b00110111110101110100010)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x102F5A00)))
;; z should be Float32(0x102F5A00 [Rational(22445, 649037107316853453566312041152512), 0.000000])
