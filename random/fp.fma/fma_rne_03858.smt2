...
(assert (= x (fp #b1 #b10010100 #b10110010001011010000110)))
;; x should be Float32(0xCA591686 [Rational(-7113539, 2), -3556769.500000])
...
(assert (= result (fp #b0 #b00010110 #b10110010001011010000100)))
(check-sat)
(exit)
