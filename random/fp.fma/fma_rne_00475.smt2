...
(assert (= x (fp #b0 #b10010100 #b00000111011001110111010)))
;; x should be Float32(0x4A03B3BA [Rational(4315613, 2), 2157806.500000])
...
(assert (= z (fp #b1 #b11111111 #b01011110011111101100111)))
