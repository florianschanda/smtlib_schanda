...
(assert (= z ((_ to_fp 8 24) #x8E9E5CAC)))
;; z should be Float32(0x8E9E5CAC [Rational(-2594603, 664613997892457936451903530140172288), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00011101 #b00111100101110010101100))))
(check-sat)
(exit)
