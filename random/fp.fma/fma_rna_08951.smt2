...
(assert (= z (fp #b0 #b10010101 #b01010101111111110111001)))
;; z should be Float32(0x4AAAFFB9 [Rational(11206585, 2), 5603292.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01010101111111110111001))))
(check-sat)
(exit)
