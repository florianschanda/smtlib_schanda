...
(assert (= y ((_ to_fp 8 24) #x806E8428)))
;; y should be Float32(0x806E8428 [Rational(-905349, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b10111010000100001001111))))
(check-sat)
(exit)
