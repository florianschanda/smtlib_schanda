...
(assert (= x (fp #b0 #b00000000 #b00010001011001100111001)))
;; x should be Float32(0x0008B339 [Rational(570169, 713623846352979940529142984724747568191373312), 0.000000])
