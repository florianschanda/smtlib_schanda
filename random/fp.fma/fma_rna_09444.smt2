...
(assert (= x ((_ to_fp 8 24) #x1825D336)))
;; x should be Float32(0x1825D336 [Rational(5433755, 2535301200456458802993406410752), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x5825D335))))
(check-sat)
(exit)
