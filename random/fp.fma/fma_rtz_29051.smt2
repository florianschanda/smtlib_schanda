...
(assert (= y (fp #b0 #b00000000 #b10111111110101000101001)))
;; y should be Float32(0x005FEA29 [Rational(6285865, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b11010010101010110000011)))
