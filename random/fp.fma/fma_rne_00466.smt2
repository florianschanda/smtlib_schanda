...
(assert (= x (fp #b0 #b10010000 #b01011101000010100100000)))
;; x should be Float32(0x482E8520 [Rational(357417, 2), 178708.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x092E8520))))
(check-sat)
(exit)
