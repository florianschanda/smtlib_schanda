...
(assert (= z (fp #b1 #b10010100 #b00101100110001101101010)))
;; z should be Float32(0xCA16636A [Rational(-4927925, 2), -2463962.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010100 #b00101100110001101101010)))
(check-sat)
(exit)
