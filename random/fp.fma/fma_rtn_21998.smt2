...
(assert (= y ((_ to_fp 8 24) #x8061A0AE)))
;; y should be Float32(0x8061A0AE [Rational(-3199063, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b10000110100000101011100)))
(check-sat)
(exit)
