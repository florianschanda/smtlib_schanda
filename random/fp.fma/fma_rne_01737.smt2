...
(assert (= z ((_ to_fp 8 24) #x5D1E2961)))
;; z should be Float32(0x5D1E2961 [Rational(712296686541602816), 712296686541602816.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x5D1E2961))))
(check-sat)
(exit)
