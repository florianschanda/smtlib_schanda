...
(assert (= x (fp #b1 #b00000000 #b00111100110001001101100)))
;; x should be Float32(0x801E626C [Rational(-497819, 178405961588244985132285746181186892047843328), -0.000000])
