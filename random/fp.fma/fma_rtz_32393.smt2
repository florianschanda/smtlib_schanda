...
(assert (= z (fp #b1 #b11100110 #b00110111000001100111010)))
;; z should be Float32(0xF31B833A [Rational(-12320977843695106179494391578624), -12320977843695106179494391578624.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b11100110 #b00110111000001100111001)))
(check-sat)
(exit)
