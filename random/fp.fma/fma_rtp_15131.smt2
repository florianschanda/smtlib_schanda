...
(assert (= y ((_ to_fp 8 24) #x806EB11B)))
;; y should be Float32(0x806EB11B [Rational(-7254299, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b10111010110001000110101)))
(check-sat)
(exit)
