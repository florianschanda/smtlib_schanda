...
(assert (= y ((_ to_fp 8 24) #x80105833)))
;; y should be Float32(0x80105833 [Rational(-1071155, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z (fp #b0 #b11111111 #b11101000101110101001001)))
