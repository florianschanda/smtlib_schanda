...
(assert (= y (fp #b1 #b01001011 #b00011101011101111110100)))
;; y should be Float32(0xA58EBBF4 [Rational(-2338557, 9444732965739290427392), -0.000000])
...
(assert (not (= result (fp #b1 #b11001011 #b00011101011101111110011))))
(check-sat)
(exit)
