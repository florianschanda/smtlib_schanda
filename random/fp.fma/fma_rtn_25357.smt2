...
(assert (= z ((_ to_fp 8 24) #xCA058BC2)))
;; z should be Float32(0xCA058BC2 [Rational(-4376033, 2), -2188016.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010100 #b00001011000101111000011))))
(check-sat)
(exit)
