...
(assert (= z ((_ to_fp 8 24) #x4AAB5429)))
;; z should be Float32(0x4AAB5429 [Rational(11228201, 2), 5614100.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01010110101010000101001))))
(check-sat)
(exit)
