...
(assert (= y (fp #b1 #b10010101 #b00110110110101000101011)))
;; y should be Float32(0xCA9B6A2B [Rational(-10185259, 2), -5092629.500000])
...
(assert (= result (fp #b1 #b00000000 #b01100100100101011101011)))
(check-sat)
(exit)
