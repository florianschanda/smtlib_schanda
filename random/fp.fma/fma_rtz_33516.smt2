...
(assert (= x (fp #b1 #b10001111 #b01101010010101100101110)))
;; x should be Float32(0xC7B52B2E [Rational(-5936535, 64), -92758.359375])
...
(assert (= z (fp #b0 #b11111111 #b11000110111100111000111)))
