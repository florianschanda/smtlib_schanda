...
(assert (= x (fp #b1 #b11111111 #b10011101010001101011100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00000000 #b00011100000011101110101)))
;; y should be Float32(0x000E0775 [Rational(919413, 713623846352979940529142984724747568191373312), 0.000000])
