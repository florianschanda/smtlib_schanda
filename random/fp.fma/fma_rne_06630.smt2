...
(assert (= x ((_ to_fp 8 24) #x7FF048E5)))
...
(assert (= z ((_ to_fp 8 24) #x8040208A)))
;; z should be Float32(0x8040208A [Rational(-2101317, 356811923176489970264571492362373784095686656), -0.000000])
