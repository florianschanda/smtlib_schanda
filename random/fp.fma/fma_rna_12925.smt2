...
(assert (= x (fp #b1 #b10001001 #b00111101000110000110000)))
;; x should be Float32(0xC49E8C30 [Rational(-649411, 512), -1268.380859])
...
(assert (not (= result ((_ to_fp 8 24) #x008004F3))))
(check-sat)
(exit)
