...
(assert (= z (fp #b1 #b10010100 #b01100110111100111111110)))
;; z should be Float32(0xCA3379FE [Rational(-5881087, 2), -2940543.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA3379FE))))
(check-sat)
(exit)
