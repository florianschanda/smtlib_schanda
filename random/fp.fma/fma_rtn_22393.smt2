...
(assert (= z (fp #b1 #b10010101 #b10001000011101110000101)))
;; z should be Float32(0xCAC43B85 [Rational(-12860293, 2), -6430146.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAC43B85))))
(check-sat)
(exit)
