...
(assert (= z ((_ to_fp 8 24) #x296AA748)))
;; z should be Float32(0x296AA748 [Rational(1922281, 36893488147419103232), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b01010010 #b11010101010011101000111))))
(check-sat)
(exit)
