...
(assert (= z ((_ to_fp 8 24) #xFD0F4217)))
;; z should be Float32(0xFD0F4217 [Rational(-11901422592832947027321698322787336192), -11901422592832947027321698322787336192.000000])
