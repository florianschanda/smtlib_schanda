...
(assert (= z (fp #b0 #b00000000 #b10111101010010111010100)))
;; z should be Float32(0x005EA5D4 [Rational(1550709, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x005EA5D4)))
(check-sat)
(exit)
