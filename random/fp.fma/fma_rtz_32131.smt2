...
(assert (= z (fp #b0 #b10010100 #b10101010000111010100110)))
;; z should be Float32(0x4A550EA6 [Rational(6981459, 2), 3490729.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010100 #b10101010000111010100110))))
(check-sat)
(exit)
