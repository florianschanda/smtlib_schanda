...
(assert (= y ((_ to_fp 8 24) #x776B8C17)))
;; y should be Float32(0x776B8C17 [Rational(4777465317765365447827280875225088), 4777465317765365447827280875225088.000000])
...
(assert (= result ((_ to_fp 8 24) #xB86B8C17)))
(check-sat)
(exit)
