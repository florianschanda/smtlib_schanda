...
(assert (= y ((_ to_fp 8 24) #xCA1CE00A)))
;; y should be Float32(0xCA1CE00A [Rational(-5140485, 2), -2570242.500000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x4AB3840D)))
;; z should be Float32(0x4AB3840D [Rational(11764749, 2), 5882374.500000])
