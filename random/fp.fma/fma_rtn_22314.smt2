...
(assert (= z (fp #b0 #b00000011 #b01010101000011111000101)))
;; z should be Float32(0x01AA87C5 [Rational(11175877, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b00000011 #b01010101000011111000100))))
(check-sat)
(exit)
