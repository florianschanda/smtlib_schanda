...
(assert (= z (fp #b0 #b10010101 #b00110001011000101111101)))
;; z should be Float32(0x4A98B17D [Rational(10006909, 2), 5003454.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b00110001011000101111101)))
(check-sat)
(exit)
