...
(assert (= z (fp #b1 #b00000000 #b11000110000101100011010)))
;; z should be Float32(0x80630B1A [Rational(-3245453, 356811923176489970264571492362373784095686656), -0.000000])
