...
(assert (= x (fp #b1 #b10010010 #b11000111110110100101000)))
;; x should be Float32(0xC963ED28 [Rational(-1867173, 2), -933586.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10100101010001110001000)))
