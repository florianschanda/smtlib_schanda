...
(assert (= y ((_ to_fp 8 24) #x80710FC9)))
;; y should be Float32(0x80710FC9 [Rational(-7409609, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC0621F91))))
(check-sat)
(exit)
