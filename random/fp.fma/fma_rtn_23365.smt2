...
(assert (= x ((_ to_fp 8 24) #x73C83528)))
;; x should be Float32(0x73C83528 [Rational(31724167130812366785036383420416), 31724167130812366785036383420416.000000])
...
(assert (= result ((_ to_fp 8 24) #xB4C83527)))
(check-sat)
(exit)
