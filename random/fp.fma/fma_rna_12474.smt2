...
(assert (= y (fp #b1 #b10010101 #b01111101001110100010011)))
;; y should be Float32(0xCABE9D13 [Rational(-12492051, 2), -6246025.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x005F4E8A))))
(check-sat)
(exit)
