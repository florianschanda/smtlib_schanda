...
(assert (= z (fp #b1 #b00000000 #b00001101001100111011000)))
;; z should be Float32(0x800699D8 [Rational(-54075, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b00000000 #b00001101001100111011000))))
(check-sat)
(exit)
