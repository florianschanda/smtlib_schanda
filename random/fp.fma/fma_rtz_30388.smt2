...
(assert (= x ((_ to_fp 8 24) #x000BEA70)))
;; x should be Float32(0x000BEA70 [Rational(48807, 44601490397061246283071436545296723011960832), 0.000000])
...
(assert (= result (fp #b0 #b01111101 #b01111101010011011111111)))
(check-sat)
(exit)
