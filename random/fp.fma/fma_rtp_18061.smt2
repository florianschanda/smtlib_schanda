...
(assert (= z (fp #b1 #b10010100 #b10100101100001010000010)))
;; z should be Float32(0xCA52C282 [Rational(-6906177, 2), -3453088.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010100 #b10100101100001010000010)))
(check-sat)
(exit)
