...
(assert (= y ((_ to_fp 8 24) #x80352F0C)))
;; y should be Float32(0x80352F0C [Rational(-871363, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b10101001011110000101111))))
(check-sat)
(exit)
