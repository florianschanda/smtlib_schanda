...
(assert (= z ((_ to_fp 8 24) #x136F1BFB)))
;; z should be Float32(0x136F1BFB [Rational(15670267, 5192296858534827628530496329220096), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x136F1BFB))))
(check-sat)
(exit)
