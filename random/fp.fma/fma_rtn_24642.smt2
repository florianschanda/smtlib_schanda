...
(assert (= z (fp #b1 #b00000000 #b00010110101100000000100)))
;; z should be Float32(0x800B5804 [Rational(-185857, 178405961588244985132285746181186892047843328), -0.000000])
