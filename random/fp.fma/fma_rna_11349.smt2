...
(assert (= y (fp #b0 #b00000000 #b00110110000001101101011)))
;; y should be Float32(0x001B036B [Rational(1770347, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b01111110 #b10110000001101101010111))))
(check-sat)
(exit)
