...
(assert (= y (fp #b0 #b10010001 #b00101011101101001110000)))
;; y should be Float32(0x4895DA70 [Rational(613799, 2), 306899.500000])
...
(assert (= result (fp #b0 #b00010011 #b00101011101101010001111)))
(check-sat)
(exit)
