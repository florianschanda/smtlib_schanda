...
(assert (= x (fp #b0 #b00000000 #b00101001000100000101100)))
;; x should be Float32(0x0014882C [Rational(336395, 178405961588244985132285746181186892047843328), 0.000000])
