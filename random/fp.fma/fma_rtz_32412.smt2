...
(assert (= z (fp #b1 #b00000111 #b11110011110101110110101)))
;; z should be Float32(0x83F9EBB5 [Rational(-16378805, 11150372599265311570767859136324180752990208), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000111 #b11110011110101110110100)))
(check-sat)
(exit)
