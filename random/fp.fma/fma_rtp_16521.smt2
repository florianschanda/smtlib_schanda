...
(assert (= x ((_ to_fp 8 24) #x4763FFC1)))
;; x should be Float32(0x4763FFC1 [Rational(14942145, 256), 58367.753906])
...
(assert (not (= result (fp #b1 #b00010000 #b11000111111111111000001))))
(check-sat)
(exit)
