...
(assert (= z (fp #b1 #b11010000 #b00110000110101101110001)))
;; z should be Float32(0xE8186B71 [Rational(-2879126598080797121445888), -2879126598080797121445888.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE8186B71))))
(check-sat)
(exit)
