...
(assert (= y ((_ to_fp 8 24) #x007BD8E8)))
;; y should be Float32(0x007BD8E8 [Rational(1014557, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC077B1CF))))
(check-sat)
(exit)
