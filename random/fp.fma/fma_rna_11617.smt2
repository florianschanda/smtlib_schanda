...
(assert (= z ((_ to_fp 8 24) #x5CB90548)))
;; z should be Float32(0x5CB90548 [Rational(416629419898044416), 416629419898044416.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b10111001 #b01110010000010101001000))))
(check-sat)
(exit)
