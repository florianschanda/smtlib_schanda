...
(assert (= x (fp #b0 #b10010101 #b11001011011001100011011)))
;; x should be Float32(0x4AE5B31B [Rational(15053595, 2), 7526797.500000])
...
(assert (= result (fp #b1 #b00010111 #b11001011011001100011100)))
(check-sat)
(exit)
