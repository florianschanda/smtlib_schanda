...
(assert (= x (fp #b0 #b00000000 #b00000111110001000011110)))
;; x should be Float32(0x0003E21E [Rational(127247, 356811923176489970264571492362373784095686656), 0.000000])
