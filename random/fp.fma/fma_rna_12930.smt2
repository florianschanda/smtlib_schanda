...
(assert (= x ((_ to_fp 8 24) #xEC6C9AD0)))
;; x should be Float32(0xEC6C9AD0 [Rational(-1144150299160726968721211392), -1144150299160726968721211392.000000])
...
(assert (= result (fp #b0 #b01000011 #b11011001001101011010000)))
(check-sat)
(exit)
