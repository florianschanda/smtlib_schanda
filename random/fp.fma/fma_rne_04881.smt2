...
(assert (= z (fp #b1 #b11010010 #b01001101110100111011010)))
;; z should be Float32(0xE926E9DA [Rational(-12611626177296571188641792), -12611626177296571188641792.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE926E9DA))))
(check-sat)
(exit)
