...
(assert (= z ((_ to_fp 8 24) #x4A9FE2AB)))
;; z should be Float32(0x4A9FE2AB [Rational(10478251, 2), 5239125.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b00111111110001010101010)))
(check-sat)
(exit)
