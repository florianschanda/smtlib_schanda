...
(assert (= z (fp #b1 #b10010101 #b10000000000111011010101)))
;; z should be Float32(0xCAC00ED5 [Rational(-12586709, 2), -6293354.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10000000000111011010110))))
(check-sat)
(exit)
