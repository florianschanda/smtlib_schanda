...
(assert (= z (fp #b0 #b10100010 #b11000100010111101110000)))
;; z should be Float32(0x51622F70 [Rational(60716154880), 60716154880.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x51622F70)))
(check-sat)
(exit)
