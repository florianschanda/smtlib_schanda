...
(assert (= y (fp #b1 #b10010101 #b01001011011101010001001)))
;; y should be Float32(0xCAA5BA89 [Rational(-10861193, 2), -5430596.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8BA5BA89))))
(check-sat)
(exit)
