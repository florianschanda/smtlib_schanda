...
(assert (= z ((_ to_fp 8 24) #xCAA3ACFD)))
;; z should be Float32(0xCAA3ACFD [Rational(-10726653, 2), -5363326.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b01000111010110011111100)))
(check-sat)
(exit)
