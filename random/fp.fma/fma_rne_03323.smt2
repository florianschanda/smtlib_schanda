...
(assert (= z (fp #b1 #b10110011 #b11100110001100110001000)))
;; z should be Float32(0xD9F31988 [Rational(-8553311405867008), -8553311405867008.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10110011 #b11100110001100110001000)))
(check-sat)
(exit)
