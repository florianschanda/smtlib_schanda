...
(assert (= y (fp #b1 #b00000000 #b10101001100110100111100)))
;; y should be Float32(0x8054CD3C [Rational(-1389391, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x40299A77)))
(check-sat)
(exit)
