...
(assert (= y (fp #b1 #b00000000 #b11101110010111000010010)))
;; y should be Float32(0x80772E12 [Rational(-3905289, 356811923176489970264571492362373784095686656), -0.000000])
