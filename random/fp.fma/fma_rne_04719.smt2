...
(assert (= y (fp #b0 #b10010100 #b00011110001110110100110)))
;; y should be Float32(0x4A0F1DA6 [Rational(4689619, 2), 2344809.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8B0F1DA5))))
(check-sat)
(exit)
