...
(assert (= y ((_ to_fp 8 24) #x4ADB678F)))
;; y should be Float32(0x4ADB678F [Rational(14378895, 2), 7189447.500000])
...
(assert (= result (fp #b0 #b00000000 #b00100100100110000110111)))
(check-sat)
(exit)
