...
(assert (= y (fp #b1 #b00000000 #b10010111000000010101111)))
;; y should be Float32(0x804B80AF [Rational(-4948143, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC017015D)))
(check-sat)
(exit)
