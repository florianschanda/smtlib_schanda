...
(assert (= z ((_ to_fp 8 24) #x39100D9B)))
;; z should be Float32(0x39100D9B [Rational(9440667, 68719476736), 0.000137])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b01110010 #b00100000000110110011011))))
(check-sat)
(exit)
