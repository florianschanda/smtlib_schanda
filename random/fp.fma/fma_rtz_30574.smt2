...
(assert (= x (fp #b0 #b00000000 #b00101000000000000010011)))
;; x should be Float32(0x00140013 [Rational(1310739, 713623846352979940529142984724747568191373312), 0.000000])
