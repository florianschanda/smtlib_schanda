...
(assert (= y ((_ to_fp 8 24) #xE16541C1)))
;; y should be Float32(0xE16541C1 [Rational(-264315153822653612032), -264315153822653612032.000000])
...
(assert (= result ((_ to_fp 8 24) #x226541C1)))
(check-sat)
(exit)
