...
(assert (= x (fp #b0 #b00000000 #b10100110011101010110111)))
;; x should be Float32(0x00533AB7 [Rational(5454519, 713623846352979940529142984724747568191373312), 0.000000])
