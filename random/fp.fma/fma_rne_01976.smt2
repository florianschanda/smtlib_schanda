...
(assert (= y (fp #b0 #b00000000 #b00111111010111000001111)))
;; y should be Float32(0x001FAE0F [Rational(2076175, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b11111111111111110011111)))
