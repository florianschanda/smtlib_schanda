...
(assert (= z (fp #b1 #b10010101 #b11100111110010100000111)))
;; z should be Float32(0xCAF3E507 [Rational(-15983879, 2), -7991939.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b11100111110010011111111))))
(check-sat)
(exit)
