...
(assert (= z (fp #b1 #b00000000 #b10011111101101100000000)))
;; z should be Float32(0x804FDB00 [Rational(-20443, 2787593149816327892691964784081045188247552), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10011111101101100000000))))
(check-sat)
(exit)
