...
(assert (= y ((_ to_fp 8 24) #x57034150)))
;; y should be Float32(0x57034150 [Rational(144316538290176), 144316538290176.000000])
...
(assert (not (= result (fp #b0 #b00110000 #b00000110100000101001111))))
(check-sat)
(exit)
