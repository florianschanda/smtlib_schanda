...
(assert (= z (fp #b0 #b00000000 #b10011010101101001111111)))
;; z should be Float32(0x004D5A7F [Rational(5069439, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x004D5A7F)))
(check-sat)
(exit)
