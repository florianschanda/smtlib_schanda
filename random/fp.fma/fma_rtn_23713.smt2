...
(assert (= x (fp #b0 #b00000000 #b11011101111110010011110)))
;; x should be Float32(0x006EFC9E [Rational(3636815, 356811923176489970264571492362373784095686656), 0.000000])
