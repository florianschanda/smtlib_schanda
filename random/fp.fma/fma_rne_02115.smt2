...
(assert (= y (fp #b1 #b11010100 #b10000110111001111001110)))
;; y should be Float32(0xEA4373CE [Rational(-59071851749915470608728064), -59071851749915470608728064.000000])
...
(assert (not (= result (fp #b1 #b01010110 #b10000110111001111001110))))
(check-sat)
(exit)
