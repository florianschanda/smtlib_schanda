...
(assert (= x ((_ to_fp 8 24) #xFD10DB25)))
;; x should be Float32(0xFD10DB25 [Rational(-12034168428387646753787630089047900160), -12034168428387646753787630089047900160.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBE10DB24))))
(check-sat)
(exit)
