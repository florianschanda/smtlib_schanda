...
(assert (= y (fp #b1 #b00101000 #b01111110111001111111010)))
;; y should be Float32(0x943F73FA [Rational(-6273533, 649037107316853453566312041152512), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xD43F73F9)))
(check-sat)
(exit)
