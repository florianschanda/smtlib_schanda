...
(assert (= x (fp #b0 #b10010011 #b00110011101100011001100)))
;; x should be Float32(0x4999D8CC [Rational(2520627, 2), 1260313.500000])
...
(assert (= result (fp #b1 #b00010101 #b00110011101100011000101)))
(check-sat)
(exit)
