...
(assert (= z (fp #b1 #b00000000 #b00010001110010111011010)))
;; z should be Float32(0x8008E5DA [Rational(-291565, 356811923176489970264571492362373784095686656), -0.000000])
