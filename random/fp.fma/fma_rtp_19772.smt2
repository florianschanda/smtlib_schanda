...
(assert (= x (fp #b1 #b00000011 #b01111100111101000011111)))
;; x should be Float32(0x81BE7A1F [Rational(-12483103, 178405961588244985132285746181186892047843328), -0.000000])
