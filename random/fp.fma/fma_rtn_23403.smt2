...
(assert (= x ((_ to_fp 8 24) #x68D2D24C)))
;; x should be Float32(0x68D2D24C [Rational(7964610032282011065909248), 7964610032282011065909248.000000])
...
(assert (= result ((_ to_fp 8 24) #x9E52D24D)))
(check-sat)
(exit)
