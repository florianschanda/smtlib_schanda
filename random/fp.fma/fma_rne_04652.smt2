...
(assert (= y ((_ to_fp 8 24) #xA93487B7)))
;; y should be Float32(0xA93487B7 [Rational(-11831223, 295147905179352825856), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x693487B6))))
(check-sat)
(exit)
