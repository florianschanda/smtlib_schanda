...
(assert (= z (fp #b1 #b10010101 #b00110100001101110100011)))
;; z should be Float32(0xCA9A1BA3 [Rational(-10099619, 2), -5049809.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00110100001101110101011))))
(check-sat)
(exit)
