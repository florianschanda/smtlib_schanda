...
(assert (= y (fp #b1 #b11111111 #b01011111010000011111001)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b0 #b00000000 #b11110001100100101101101)))
;; z should be Float32(0x0078C96D [Rational(7915885, 713623846352979940529142984724747568191373312), 0.000000])
