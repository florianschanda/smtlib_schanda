...
(assert (= x (fp #b0 #b11101111 #b01001100101100000011100)))
;; x should be Float32(0x77A6581C [Rational(6747721476175415099490799749955584), 6747721476175415099490799749955584.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB8A6581B))))
(check-sat)
(exit)
