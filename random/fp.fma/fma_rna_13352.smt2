...
(assert (= x (fp #b1 #b00000000 #b10000111110001001111111)))
;; x should be Float32(0x8043E27F [Rational(-4448895, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FAC942D)))
