...
(assert (= y ((_ to_fp 8 24) #x805D8DCB)))
;; y should be Float32(0x805D8DCB [Rational(-6131147, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFF9E96B2)))
