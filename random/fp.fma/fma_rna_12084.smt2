...
(assert (= y (fp #b0 #b00000000 #b01110010110010101110001)))
;; y should be Float32(0x00396571 [Rational(3761521, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FBB46E7)))
