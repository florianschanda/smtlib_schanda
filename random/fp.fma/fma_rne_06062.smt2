...
(assert (= x (fp #b1 #b11000100 #b10011100100111110010010)))
;; x should be Float32(0xE24E4F92 [Rational(-951440731114940923904), -951440731114940923904.000000])
...
(assert (= result (fp #b0 #b00101111 #b10011100100111110010010)))
(check-sat)
(exit)
