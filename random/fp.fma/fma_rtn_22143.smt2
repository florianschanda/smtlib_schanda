...
(assert (= z (fp #b0 #b10000000 #b00011010110000011010100)))
;; z should be Float32(0x400D60D4 [Rational(2316341, 1048576), 2.209035])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10000000 #b00011010110000011010100)))
(check-sat)
(exit)
