...
(assert (= x ((_ to_fp 8 24) #x7FCC8B77)))
...
(assert (= z ((_ to_fp 8 24) #x8011F318)))
;; z should be Float32(0x8011F318 [Rational(-147043, 89202980794122492566142873090593446023921664), -0.000000])
