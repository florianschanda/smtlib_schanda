...
(assert (= y ((_ to_fp 8 24) #xCAEBBE75)))
;; y should be Float32(0xCAEBBE75 [Rational(-15449717, 2), -7724858.500000])
...
(assert (= result (fp #b0 #b00010111 #b11010111011111001110100)))
(check-sat)
(exit)
