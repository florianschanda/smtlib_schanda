...
(assert (= y (fp #b1 #b00000000 #b10000100110000111010100)))
;; y should be Float32(0x804261D4 [Rational(-1087605, 178405961588244985132285746181186892047843328), -0.000000])
