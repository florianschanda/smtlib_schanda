...
(assert (= x (fp #b1 #b00000000 #b11001110000101011001000)))
;; x should be Float32(0x80670AC8 [Rational(-844121, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xC04E158F))))
(check-sat)
(exit)
