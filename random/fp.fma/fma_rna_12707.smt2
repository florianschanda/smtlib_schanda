...
(assert (= x (fp #b1 #b00110011 #b00111011011111100011000)))
;; x should be Float32(0x999DBF18 [Rational(-1292259, 79228162514264337593543950336), -0.000000])
...
(assert (not (= result (fp #b1 #b10110011 #b00111011011111100010111))))
(check-sat)
(exit)
