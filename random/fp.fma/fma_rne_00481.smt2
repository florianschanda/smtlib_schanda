...
(assert (= x ((_ to_fp 8 24) #x4AB1AC99)))
;; x should be Float32(0x4AB1AC99 [Rational(11644057, 2), 5822028.500000])
...
(assert (= result (fp #b0 #b00000001 #b10110001101011001001100)))
(check-sat)
(exit)
