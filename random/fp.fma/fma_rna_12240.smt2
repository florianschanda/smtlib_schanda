...
(assert (= y (fp #b1 #b00000000 #b01000100010110001000100)))
;; y should be Float32(0x80222C44 [Rational(-559889, 178405961588244985132285746181186892047843328), -0.000000])
