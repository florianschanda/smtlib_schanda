...
(assert (= z ((_ to_fp 8 24) #x80549675)))
;; z should be Float32(0x80549675 [Rational(-5543541, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xB5000000))))
(check-sat)
(exit)
