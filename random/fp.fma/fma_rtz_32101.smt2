...
(assert (= y (fp #b1 #b00000000 #b00110111001011001010011)))
;; y should be Float32(0x801B9653 [Rational(-1807955, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b01111110 #b10111001011001010010111)))
(check-sat)
(exit)
