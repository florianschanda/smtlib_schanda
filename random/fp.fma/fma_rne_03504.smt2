...
(assert (= z (fp #b0 #b10011111 #b01000100001100001010101)))
;; z should be Float32(0x4FA21855 [Rational(5439007232), 5439007232.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x4FA21855)))
(check-sat)
(exit)
