...
(assert (= y (fp #b1 #b10010101 #b01111110011100001001101)))
;; y should be Float32(0xCABF384D [Rational(-12531789, 2), -6265894.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BBF384D))))
(check-sat)
(exit)
