...
(assert (= x (fp #b1 #b10010101 #b01000000110001100101011)))
;; x should be Float32(0xCAA0632B [Rational(-10511147, 2), -5255573.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01000000110001100101011))))
(check-sat)
(exit)
