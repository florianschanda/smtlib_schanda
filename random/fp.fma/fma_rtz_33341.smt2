...
(assert (= x ((_ to_fp 8 24) #xE16FCA18)))
;; x should be Float32(0xE16FCA18 [Rational(-276458388938230333440), -276458388938230333440.000000])
...
(assert (= result (fp #b1 #b00101101 #b11011111100101000011000)))
(check-sat)
(exit)
