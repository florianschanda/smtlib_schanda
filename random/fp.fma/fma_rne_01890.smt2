...
(assert (= z (fp #b0 #b00000000 #b11110111111000101110100)))
;; z should be Float32(0x007BF174 [Rational(2030685, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x007BF174))))
(check-sat)
(exit)
