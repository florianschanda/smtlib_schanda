...
(assert (= z (fp #b1 #b00111111 #b10110000001001100100100)))
;; z should be Float32(0x9FD81324 [Rational(-3540169, 38685626227668133590597632), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x9FD81324)))
(check-sat)
(exit)
