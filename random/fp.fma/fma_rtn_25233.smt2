...
(assert (= y ((_ to_fp 8 24) #x801122C6)))
;; y should be Float32(0x801122C6 [Rational(-561507, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F09162F))))
(check-sat)
(exit)
