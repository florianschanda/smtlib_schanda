...
(assert (= y ((_ to_fp 8 24) #x0001A438)))
;; y should be Float32(0x0001A438 [Rational(13447, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFF813C26)))
