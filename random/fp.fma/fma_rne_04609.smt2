...
(assert (= z (fp #b1 #b10010100 #b11101100100011010000010)))
;; z should be Float32(0xCA764682 [Rational(-8069953, 2), -4034976.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA764672))))
(check-sat)
(exit)
