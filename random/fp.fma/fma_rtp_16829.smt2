...
(assert (= x (fp #b0 #b00000000 #b01000010000101101101110)))
;; x should be Float32(0x00210B6E [Rational(1082807, 356811923176489970264571492362373784095686656), 0.000000])
