...
(assert (= x (fp #b0 #b10010100 #b00111101010111111010110)))
;; x should be Float32(0x4A1EAFD6 [Rational(5199851, 2), 2599925.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b00111101010111111010110))))
(check-sat)
(exit)
