...
(assert (= z ((_ to_fp 8 24) #x8CAAEEC0)))
;; z should be Float32(0x8CAAEEC0 [Rational(-175035, 664613997892457936451903530140172288), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00011001 #b01010101110111011000000))))
(check-sat)
(exit)
