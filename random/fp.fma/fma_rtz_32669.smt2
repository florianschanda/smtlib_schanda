...
(assert (= z (fp #b0 #b00111100 #b10101100111101110110111)))
;; z should be Float32(0x1E567BB7 [Rational(14056375, 1237940039285380274899124224), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00111100 #b10101100111101110110111))))
(check-sat)
(exit)
