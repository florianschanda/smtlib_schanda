...
(assert (= y (fp #b1 #b11111111 #b11011101000010010101111)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x1035BF45)))
;; z should be Float32(0x1035BF45 [Rational(11910981, 332306998946228968225951765070086144), 0.000000])
