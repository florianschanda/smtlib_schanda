...
(assert (= y (fp #b1 #b10010011 #b10010101110111000011100)))
;; y should be Float32(0xC9CAEE1C [Rational(-3324807, 2), -1662403.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8ACAEE1D))))
(check-sat)
(exit)
