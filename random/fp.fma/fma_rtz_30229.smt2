...
(assert (= x (fp #b0 #b11011001 #b11011011101010001100000)))
;; x should be Float32(0x6CEDD460 [Rational(2300146654643732442460979200), 2300146654643732442460979200.000000])
...
(assert (= z (fp #b0 #b11111111 #b00100110011001000110110)))
