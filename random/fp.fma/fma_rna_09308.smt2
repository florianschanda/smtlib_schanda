...
(assert (= z ((_ to_fp 8 24) #xF49E1DD2)))
;; z should be Float32(0xF49E1DD2 [Rational(-100218228935685627351197208805376), -100218228935685627351197208805376.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b11101001 #b00111100001110111010010)))
(check-sat)
(exit)
