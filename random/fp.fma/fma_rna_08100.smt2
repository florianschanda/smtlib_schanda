...
(assert (= y ((_ to_fp 8 24) #x005C0ED1)))
;; y should be Float32(0x005C0ED1 [Rational(6033105, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b01110000001110110100001))))
(check-sat)
(exit)
