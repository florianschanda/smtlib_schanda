...
(assert (= x (fp #b0 #b00000000 #b00100011100000011011110)))
;; x should be Float32(0x0011C0DE [Rational(581743, 356811923176489970264571492362373784095686656), 0.000000])
