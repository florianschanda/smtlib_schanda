...
(assert (= y (fp #b1 #b00000000 #b01110011110011001000011)))
;; y should be Float32(0x8039E643 [Rational(-3794499, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b11001111001100100001100))))
(check-sat)
(exit)
