...
(assert (= z (fp #b1 #b10010100 #b11111000111101001100110)))
;; z should be Float32(0xCA7C7A66 [Rational(-8273203, 2), -4136601.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010100 #b11111000111101001100110))))
(check-sat)
(exit)
