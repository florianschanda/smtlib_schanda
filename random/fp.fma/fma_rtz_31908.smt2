...
(assert (= y (fp #b0 #b11101000 #b11111011101001011101111)))
;; y should be Float32(0x747DD2EF [Rational(80440023605768991087886312931328), 80440023605768991087886312931328.000000])
