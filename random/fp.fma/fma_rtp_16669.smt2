...
(assert (= x ((_ to_fp 8 24) #x004C7E92)))
;; x should be Float32(0x004C7E92 [Rational(2506569, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x4018FD24))))
(check-sat)
(exit)
