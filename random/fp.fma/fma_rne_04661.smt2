...
(assert (= y ((_ to_fp 8 24) #x80073903)))
;; y should be Float32(0x80073903 [Rational(-473347, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3E67205F))))
(check-sat)
(exit)
