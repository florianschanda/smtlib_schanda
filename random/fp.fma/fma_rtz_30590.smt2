...
(assert (= x (fp #b0 #b00000000 #b00100111111100000100110)))
;; x should be Float32(0x0013F826 [Rational(654355, 356811923176489970264571492362373784095686656), 0.000000])
