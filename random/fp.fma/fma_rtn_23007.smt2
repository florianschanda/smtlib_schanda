...
(assert (= z (fp #b1 #b11011101 #b01101011111010001010101)))
;; z should be Float32(0xEEB5F455 [Rational(-28156083039400235438828421120), -28156083039400235438828421120.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b11011101 #b01101011111010001010110))))
(check-sat)
(exit)
