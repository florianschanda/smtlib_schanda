...
(assert (= z (fp #b1 #b00000000 #b01101111100111100110100)))
;; z should be Float32(0x8037CF34 [Rational(-914381, 178405961588244985132285746181186892047843328), -0.000000])
