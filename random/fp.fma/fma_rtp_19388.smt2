...
(assert (= z (fp #b0 #b00110101 #b10001000101110001100111)))
;; z should be Float32(0x1AC45C67 [Rational(12868711, 158456325028528675187087900672), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00110101 #b10001000101110001101000))))
(check-sat)
(exit)
