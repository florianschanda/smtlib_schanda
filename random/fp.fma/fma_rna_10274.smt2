...
(assert (= y (fp #b0 #b00000000 #b10100011000010000001010)))
;; y should be Float32(0x0051840A [Rational(2671109, 356811923176489970264571492362373784095686656), 0.000000])
