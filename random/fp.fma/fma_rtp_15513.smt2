...
(assert (= y ((_ to_fp 8 24) #xFFDC5B71)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x007A8CFA)))
;; z should be Float32(0x007A8CFA [Rational(4015741, 356811923176489970264571492362373784095686656), 0.000000])
