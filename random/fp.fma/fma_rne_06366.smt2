...
(assert (= x (fp #b1 #b00000000 #b10000000011101111101100)))
;; x should be Float32(0x80403BEC [Rational(-1052411, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x400077D7))))
(check-sat)
(exit)
