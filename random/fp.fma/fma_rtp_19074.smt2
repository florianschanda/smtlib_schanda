...
(assert (= z (fp #b1 #b11010111 #b11100111111011000101111)))
;; z should be Float32(0xEBF3F62F [Rational(-589863086636224573050191872), -589863086636224573050191872.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xEBF3F62E)))
(check-sat)
(exit)
