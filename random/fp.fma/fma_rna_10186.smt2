...
(assert (= z ((_ to_fp 8 24) #x4AE708A5)))
;; z should be Float32(0x4AE708A5 [Rational(15141029, 2), 7570514.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b11001110000100010100101)))
(check-sat)
(exit)
