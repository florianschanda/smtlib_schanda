...
(assert (= z (fp #b0 #b00000000 #b11100010110001111111100)))
;; z should be Float32(0x007163FC [Rational(1857791, 178405961588244985132285746181186892047843328), 0.000000])
