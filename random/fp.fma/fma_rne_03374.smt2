...
(assert (= z ((_ to_fp 8 24) #xCACEF355)))
;; z should be Float32(0xCACEF355 [Rational(-13562709, 2), -6781354.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10011101111001101010101))))
(check-sat)
(exit)
