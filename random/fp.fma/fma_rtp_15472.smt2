...
(assert (= y (fp #b1 #b10101000 #b10111110110111000111001)))
;; y should be Float32(0xD45F6E39 [Rational(-3838507745280), -3838507745280.000000])
...
(assert (not (= result (fp #b1 #b00101010 #b10111110110111000110111))))
(check-sat)
(exit)
