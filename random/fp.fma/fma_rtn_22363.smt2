...
(assert (= y ((_ to_fp 8 24) #x80744F1A)))
;; y should be Float32(0x80744F1A [Rational(-3811213, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FC618DD)))
