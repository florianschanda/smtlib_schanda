...
(assert (= z ((_ to_fp 8 24) #x006024AC)))
;; z should be Float32(0x006024AC [Rational(1575211, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006024AC))))
(check-sat)
(exit)
