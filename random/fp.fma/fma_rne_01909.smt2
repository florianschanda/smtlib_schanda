...
(assert (= z ((_ to_fp 8 24) #x00363C46)))
;; z should be Float32(0x00363C46 [Rational(1777187, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b01101100011110001000110)))
(check-sat)
(exit)
