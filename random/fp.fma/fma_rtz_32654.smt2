...
(assert (= y (fp #b0 #b00000000 #b01111010010100001011100)))
;; y should be Float32(0x003D285C [Rational(1002007, 178405961588244985132285746181186892047843328), 0.000000])
