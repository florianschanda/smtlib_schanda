...
(assert (= z (fp #b1 #b10010101 #b11101000101011011110101)))
;; z should be Float32(0xCAF456F5 [Rational(-16013045, 2), -8006522.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010101 #b11101000101011011101101)))
(check-sat)
(exit)
