...
(assert (= z ((_ to_fp 8 24) #x00537506)))
;; z should be Float32(0x00537506 [Rational(2734723, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b10100110111010100000110)))
(check-sat)
(exit)
