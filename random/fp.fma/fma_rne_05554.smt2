...
(assert (= y ((_ to_fp 8 24) #x6F3D9125)))
;; y should be Float32(0x6F3D9125 [Rational(58668135827638205396188921856), 58668135827638205396188921856.000000])
...
(assert (= result (fp #b1 #b01001001 #b01111011001000100100101)))
(check-sat)
(exit)
