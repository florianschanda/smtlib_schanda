...
(assert (= y (fp #b1 #b10010100 #b11001111001001101110010)))
;; y should be Float32(0xCA679372 [Rational(-7588281, 2), -3794140.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b11101100000000001000100)))
