...
(assert (= y (fp #b0 #b10010101 #b01100101001110100001011)))
;; y should be Float32(0x4AB29D0B [Rational(11705611, 2), 5852805.500000])
...
(assert (= result (fp #b0 #b00000000 #b10110010100111010000110)))
(check-sat)
(exit)
