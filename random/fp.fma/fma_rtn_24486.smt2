...
(assert (= x (fp #b1 #b10010101 #b01111100110110010011111)))
;; x should be Float32(0xCABE6C9F [Rational(-12479647, 2), -6239823.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01000001100100110110000))))
(check-sat)
(exit)
