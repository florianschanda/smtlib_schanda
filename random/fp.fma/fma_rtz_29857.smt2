...
(assert (= z (fp #b0 #b11110001 #b00011100100100010001100)))
;; z should be Float32(0x788E488C [Rational(23086799354567513766534930531090432), 23086799354567513766534930531090432.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b11110001 #b00011100100100010001011))))
(check-sat)
(exit)
