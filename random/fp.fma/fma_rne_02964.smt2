...
(assert (= x ((_ to_fp 8 24) #x0016A78B)))
;; x should be Float32(0x0016A78B [Rational(1484683, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b11101111000111010010010)))
