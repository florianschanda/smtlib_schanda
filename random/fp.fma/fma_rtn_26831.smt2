...
(assert (= x (fp #b1 #b00000000 #b00011101001110100111111)))
;; x should be Float32(0x800E9D3F [Rational(-957759, 713623846352979940529142984724747568191373312), -0.000000])
