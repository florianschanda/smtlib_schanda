...
(assert (= z ((_ to_fp 8 24) #x0007BD2D)))
;; z should be Float32(0x0007BD2D [Rational(507181, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x0007BD2D)))
(check-sat)
(exit)
