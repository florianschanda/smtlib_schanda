...
(assert (= z ((_ to_fp 8 24) #x4AB1F805)))
;; z should be Float32(0x4AB1F805 [Rational(11663365, 2), 5831682.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b01100011111100000000101)))
(check-sat)
(exit)
