...
(assert (= x ((_ to_fp 8 24) #x80619C87)))
;; x should be Float32(0x80619C87 [Rational(-6397063, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b10000110011100100001101))))
(check-sat)
(exit)
