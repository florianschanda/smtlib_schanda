...
(assert (= y (fp #b0 #b10010101 #b11100010001100111111101)))
;; y should be Float32(0x4AF119FD [Rational(15800829, 2), 7900414.500000])
...
(assert (= result ((_ to_fp 8 24) #x80788CFD)))
(check-sat)
(exit)
