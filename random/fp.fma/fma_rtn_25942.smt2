...
(assert (= y (fp #b1 #b10000110 #b00001001010011110001011)))
;; y should be Float32(0xC304A78B [Rational(-8693643, 65536), -132.654465])
...
(assert (not (= result ((_ to_fp 8 24) #x0404A78B))))
(check-sat)
(exit)
