...
(assert (= y (fp #b0 #b00000000 #b10001010110110010110110)))
;; y should be Float32(0x00456CB6 [Rational(2274907, 356811923176489970264571492362373784095686656), 0.000000])
