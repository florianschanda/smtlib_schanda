...
(assert (= y ((_ to_fp 8 24) #xCA3F07E2)))
;; y should be Float32(0xCA3F07E2 [Rational(-6259697, 2), -3129848.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b01111110000011111100010))))
(check-sat)
(exit)
