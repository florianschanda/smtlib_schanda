...
(assert (= z ((_ to_fp 8 24) #x80151E50)))
;; z should be Float32(0x80151E50 [Rational(-86501, 44601490397061246283071436545296723011960832), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x80151E50)))
(check-sat)
(exit)
