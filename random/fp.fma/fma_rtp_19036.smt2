...
(assert (= z (fp #b1 #b01001101 #b11011100111000000101101)))
;; z should be Float32(0xA6EE702D [Rational(-15626285, 9444732965739290427392), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xA6EE702C)))
(check-sat)
(exit)
