...
(assert (= y ((_ to_fp 8 24) #x0034B232)))
;; y should be Float32(0x0034B232 [Rational(1726745, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b00011000111010000100010)))
