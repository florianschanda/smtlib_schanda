...
(assert (= x ((_ to_fp 8 24) #x7709EB0A)))
;; x should be Float32(0x7709EB0A [Rational(2797311828741229180865943502323712), 2797311828741229180865943502323712.000000])
...
(assert (not (= result (fp #b1 #b01110000 #b00010011110101100001010))))
(check-sat)
(exit)
