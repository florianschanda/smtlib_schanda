...
(assert (= z (fp #b0 #b00000000 #b11100110000000100101111)))
;; z should be Float32(0x0073012F [Rational(7536943, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11100110000000100101111))))
(check-sat)
(exit)
