...
(assert (= x (fp #b0 #b00000000 #b11011010010001101000110)))
;; x should be Float32(0x006D2346 [Rational(3576227, 356811923176489970264571492362373784095686656), 0.000000])
