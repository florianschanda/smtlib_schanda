...
(assert (= z ((_ to_fp 8 24) #x00710204)))
;; z should be Float32(0x00710204 [Rational(1851521, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11100010000001000000100))))
(check-sat)
(exit)
