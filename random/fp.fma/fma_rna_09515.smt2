...
(assert (= x (fp #b0 #b10001000 #b01010001000101000100110)))
;; x should be Float32(0x44288A26 [Rational(5522707, 8192), 674.158569])
...
(assert (not (= result (fp #b1 #b00000000 #b11111111111110101011110))))
(check-sat)
(exit)
