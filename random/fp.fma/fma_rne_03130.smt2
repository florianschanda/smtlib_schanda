...
(assert (= x (fp #b0 #b00000000 #b11100001000111100111111)))
;; x should be Float32(0x00708F3F [Rational(7376703, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC0611E7D)))
(check-sat)
(exit)
