...
(assert (= z ((_ to_fp 8 24) #x4AA75B33)))
;; z should be Float32(0x4AA75B33 [Rational(10967859, 2), 5483929.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01001110101101100110011))))
(check-sat)
(exit)
