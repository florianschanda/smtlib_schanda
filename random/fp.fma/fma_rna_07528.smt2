...
(assert (= x ((_ to_fp 8 24) #x4A9A8015)))
;; x should be Float32(0x4A9A8015 [Rational(10125333, 2), 5062666.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b10110101 #b10101100100101000100001)))
;; y should be Float32(0xDAD64A21 [Rational(-30158575305228288), -30158575305228288.000000])
