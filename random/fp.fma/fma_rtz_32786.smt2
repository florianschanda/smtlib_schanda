...
(assert (= z (fp #b1 #b10010010 #b00111111110111111111000)))
;; z should be Float32(0xC91FEFF8 [Rational(-1310207, 2), -655103.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC91FEFF7))))
(check-sat)
(exit)
