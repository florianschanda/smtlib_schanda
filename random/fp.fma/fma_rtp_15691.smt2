...
(assert (= y (fp #b0 #b00000000 #b01010000110100111111100)))
;; y should be Float32(0x002869FC [Rational(662143, 178405961588244985132285746181186892047843328), 0.000000])
