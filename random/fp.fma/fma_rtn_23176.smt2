...
(assert (= x (fp #b0 #b01111001 #b11111110101000010010100)))
;; x should be Float32(0x3CFF5094 [Rational(4183077, 134217728), 0.031166])
...
(assert (not (= result (fp #b0 #b11111001 #b11111110101000010010011))))
(check-sat)
(exit)
