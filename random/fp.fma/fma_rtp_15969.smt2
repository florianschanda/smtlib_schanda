...
(assert (= z (fp #b0 #b00000000 #b01111111100101010010001)))
;; z should be Float32(0x003FCA91 [Rational(4180625, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01111111100101010010010))))
(check-sat)
(exit)
