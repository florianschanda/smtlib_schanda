...
(assert (= x ((_ to_fp 8 24) #xCAB2FD11)))
;; x should be Float32(0xCAB2FD11 [Rational(-11730193, 2), -5865096.500000])
...
(assert (= result (fp #b1 #b00000000 #b01001101000000101111000)))
(check-sat)
(exit)
