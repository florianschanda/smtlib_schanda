...
(assert (= x (fp #b1 #b01011100 #b00001010110010110111011)))
;; x should be Float32(0xAE0565BB [Rational(-8742331, 288230376151711744), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xEE0565BA)))
(check-sat)
(exit)
