...
(assert (= y (fp #b1 #b01101001 #b11101110011101100010101)))
;; y should be Float32(0xB4F73B15 [Rational(-16202517, 35184372088832), -0.000000])
...
(assert (not (= result (fp #b0 #b00000000 #b11111111111111111111100))))
(check-sat)
(exit)
