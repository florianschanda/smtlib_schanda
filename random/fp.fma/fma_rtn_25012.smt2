...
(assert (= z (fp #b0 #b11101011 #b10010011111000101001100)))
;; z should be Float32(0x75C9F14C [Rational(511985229795083735349833085485056), 511985229795083735349833085485056.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x75C9F14B)))
(check-sat)
(exit)
