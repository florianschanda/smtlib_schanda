...
(assert (= x ((_ to_fp 8 24) #x00746521)))
;; x should be Float32(0x00746521 [Rational(7628065, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC068CA41)))
(check-sat)
(exit)
