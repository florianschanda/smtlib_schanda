...
(assert (= y (fp #b0 #b01100000 #b10001100000011111101010)))
;; y should be Float32(0x304607EA [Rational(6489077, 9007199254740992), 0.000000])
...
(assert (= result (fp #b1 #b11100000 #b10001100000011111101001)))
(check-sat)
(exit)
