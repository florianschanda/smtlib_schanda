...
(assert (= x (fp #b0 #b01011000 #b11110010000101110010000)))
;; x should be Float32(0x2C790B90 [Rational(1020089, 288230376151711744), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11000111010111110000100)))
