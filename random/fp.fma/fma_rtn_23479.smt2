...
(assert (= x (fp #b0 #b00000000 #b10111011001001001011111)))
;; x should be Float32(0x005D925F [Rational(6132319, 713623846352979940529142984724747568191373312), 0.000000])
