...
(assert (= y (fp #b1 #b10010100 #b00011011100100010000010)))
;; y should be Float32(0xCA0DC882 [Rational(-4645953, 2), -2322976.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x005C8DE0))))
(check-sat)
(exit)
