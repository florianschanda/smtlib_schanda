...
(assert (= z ((_ to_fp 8 24) #xF1215FC3)))
;; z should be Float32(0xF1215FC3 [Rational(-799085686329025686673656119296), -799085686329025686673656119296.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b11100010 #b01000010101111111000011))))
(check-sat)
(exit)
