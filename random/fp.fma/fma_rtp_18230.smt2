...
(assert (= z (fp #b0 #b00000000 #b11010110000011010111111)))
;; z should be Float32(0x006B06BF [Rational(7014079, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006B06BF))))
(check-sat)
(exit)
