...
(assert (= z (fp #b1 #b00000000 #b10100100110001110111011)))
;; z should be Float32(0x805263BB [Rational(-5399483, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00000000 #b10100100110001110111011))))
(check-sat)
(exit)
