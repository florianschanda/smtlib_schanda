...
(assert (= z (fp #b1 #b00000000 #b01000111000000100110100)))
;; z should be Float32(0x80238134 [Rational(-581709, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80238134))))
(check-sat)
(exit)
