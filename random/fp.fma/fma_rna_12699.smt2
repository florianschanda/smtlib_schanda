...
(assert (= x (fp #b1 #b11100011 #b11000011101101011010000)))
;; x should be Float32(0xF1E1DAD0 [Rational(-2236756969302626128299716247552), -2236756969302626128299716247552.000000])
