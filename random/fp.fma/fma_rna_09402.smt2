...
(assert (= x (fp #b0 #b11011000 #b10011101011000111010010)))
;; x should be Float32(0x6C4EB1D2 [Rational(999513806097348064792543232), 999513806097348064792543232.000000])
