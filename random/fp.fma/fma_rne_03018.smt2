...
(assert (= x (fp #b0 #b00000000 #b11111001010011000001000)))
;; x should be Float32(0x007CA608 [Rational(1021121, 89202980794122492566142873090593446023921664), 0.000000])
