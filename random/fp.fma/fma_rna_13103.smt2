...
(assert (= x (fp #b1 #b00000000 #b01101001111110000100110)))
;; x should be Float32(0x8034FC26 [Rational(-1736211, 356811923176489970264571492362373784095686656), -0.000000])
