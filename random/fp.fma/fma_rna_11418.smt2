...
(assert (= z (fp #b1 #b00000000 #b00110000000101000101100)))
;; z should be Float32(0x80180A2C [Rational(-393867, 178405961588244985132285746181186892047843328), -0.000000])
