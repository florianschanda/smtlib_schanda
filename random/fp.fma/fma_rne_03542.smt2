...
(assert (= z (fp #b0 #b11010101 #b00001111010000100000100)))
;; z should be Float32(0x6A87A104 [Rational(81982680219346623151472640), 81982680219346623151472640.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x6A87A104)))
(check-sat)
(exit)
