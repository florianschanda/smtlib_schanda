...
(assert (= x ((_ to_fp 8 24) #xCAB5A23D)))
;; x should be Float32(0xCAB5A23D [Rational(-11903549, 2), -5951774.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01101011010001000111010))))
(check-sat)
(exit)
