...
(assert (= x (fp #b0 #b00000000 #b10010100010101010100011)))
;; x should be Float32(0x004A2AA3 [Rational(4860579, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC0145545)))
(check-sat)
(exit)
