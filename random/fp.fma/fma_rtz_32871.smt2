...
(assert (= y (fp #b0 #b10010011 #b00110011001000100100100)))
;; y should be Float32(0x49999124 [Rational(2516041, 2), 1258020.500000])
...
(assert (= result (fp #b1 #b00000000 #b00100110011001000100100)))
(check-sat)
(exit)
