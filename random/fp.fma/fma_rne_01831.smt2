...
(assert (= y ((_ to_fp 8 24) #x4AB192FF)))
;; y should be Float32(0x4AB192FF [Rational(11637503, 2), 5818751.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01100011001001011111111))))
(check-sat)
(exit)
