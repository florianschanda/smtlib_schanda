...
(assert (= x (fp #b0 #b00000000 #b11001101101010011001101)))
;; x should be Float32(0x0066D4CD [Rational(6739149, 713623846352979940529142984724747568191373312), 0.000000])
