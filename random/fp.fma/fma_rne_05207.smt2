...
(assert (= y (fp #b0 #b00000000 #b00101000100110000000111)))
;; y should be Float32(0x00144C07 [Rational(1330183, 713623846352979940529142984724747568191373312), 0.000000])
