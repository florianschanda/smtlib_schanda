...
(assert (= z (fp #b1 #b10100111 #b01101001011010011101000)))
;; z should be Float32(0xD3B4B4E8 [Rational(-1552258433024), -1552258433024.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xD3B4B4E8)))
(check-sat)
(exit)
