...
(assert (= z ((_ to_fp 8 24) #x007E50FF)))
;; z should be Float32(0x007E50FF [Rational(8278271, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b11111100101000011111111))))
(check-sat)
(exit)
