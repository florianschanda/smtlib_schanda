...
(assert (= y (fp #b0 #b00000000 #b10001001001101000111101)))
;; y should be Float32(0x00449A3D [Rational(4495933, 713623846352979940529142984724747568191373312), 0.000000])
