...
(assert (= z (fp #b0 #b10010101 #b11010001010100000011001)))
;; z should be Float32(0x4AE8A819 [Rational(15247385, 2), 7623692.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11010001010100000011001))))
(check-sat)
(exit)
