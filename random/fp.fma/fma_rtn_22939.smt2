...
(assert (= y (fp #b1 #b10010100 #b01110011011010000011110)))
;; y should be Float32(0xCA39B41E [Rational(-6085135, 2), -3042567.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x005192F8))))
(check-sat)
(exit)
