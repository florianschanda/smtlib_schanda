...
(assert (= y (fp #b0 #b00000000 #b01000001110011011101100)))
;; y should be Float32(0x0020E6EC [Rational(539067, 178405961588244985132285746181186892047843328), 0.000000])
