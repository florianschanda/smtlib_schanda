...
(assert (= z (fp #b1 #b00000000 #b00011111100101001111110)))
;; z should be Float32(0x800FCA7E [Rational(-517439, 356811923176489970264571492362373784095686656), -0.000000])
