...
(assert (= y (fp #b0 #b00000000 #b00001111101001001011110)))
;; y should be Float32(0x0007D25E [Rational(256303, 356811923176489970264571492362373784095686656), 0.000000])
