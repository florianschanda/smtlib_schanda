...
(assert (= z ((_ to_fp 8 24) #x00077204)))
;; z should be Float32(0x00077204 [Rational(121985, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b00001110111001000000100)))
(check-sat)
(exit)
