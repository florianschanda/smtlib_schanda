...
(assert (= y (fp #b0 #b11100010 #b00001111001011001000100)))
;; y should be Float32(0x71079644 [Rational(671394181115913820638814404608), 671394181115913820638814404608.000000])
