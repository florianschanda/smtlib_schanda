...
(assert (= x ((_ to_fp 8 24) #x49271668)))
;; x should be Float32(0x49271668 [Rational(1368781, 2), 684390.500000])
...
(assert (not (= result (fp #b0 #b00010100 #b01001110001011001100110))))
(check-sat)
(exit)
