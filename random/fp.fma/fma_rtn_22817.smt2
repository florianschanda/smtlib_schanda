...
(assert (= z (fp #b1 #b00110101 #b10010000010101100110101)))
;; z should be Float32(0x9AC82B35 [Rational(-13118261, 158456325028528675187087900672), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x34FFFFFE)))
(check-sat)
(exit)
