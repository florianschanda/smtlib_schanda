...
(assert (= y ((_ to_fp 8 24) #x7BE86DB4)))
;; y should be Float32(0x7BE86DB4 [Rational(2413675829792261218952104473360596992), 2413675829792261218952104473360596992.000000])
...
(assert (not (= result (fp #b0 #b01100010 #b11010000110110110110100))))
(check-sat)
(exit)
