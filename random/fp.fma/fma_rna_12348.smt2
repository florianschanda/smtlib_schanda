...
(assert (= z (fp #b1 #b01111111 #b10111100000000111001100)))
;; z should be Float32(0xBFDE01CC [Rational(-3637363, 2097152), -1.734430])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b01111111 #b10111100000000111010000)))
(check-sat)
(exit)
