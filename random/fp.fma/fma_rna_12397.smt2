...
(assert (= z (fp #b0 #b00000000 #b11110101001111001110000)))
;; z should be Float32(0x007A9E70 [Rational(502247, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b11110101001111001110000)))
(check-sat)
(exit)
