...
(assert (= x (fp #b0 #b10010010 #b00101011100011011101000)))
;; x should be Float32(0x4915C6E8 [Rational(1226973, 2), 613486.500000])
...
(assert (= result (fp #b1 #b00010100 #b00101011100011011101000)))
(check-sat)
(exit)
