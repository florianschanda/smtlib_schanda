...
(assert (= z (fp #b1 #b10011010 #b10110111111110000101110)))
;; z should be Float32(0xCD5BFC2E [Rational(-230671072), -230671072.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCD5BFC2D))))
(check-sat)
(exit)
