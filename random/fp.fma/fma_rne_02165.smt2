...
(assert (= y ((_ to_fp 8 24) #x7FFE5969)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x8064075D)))
;; z should be Float32(0x8064075D [Rational(-6555485, 713623846352979940529142984724747568191373312), -0.000000])
