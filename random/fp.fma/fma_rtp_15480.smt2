...
(assert (= y ((_ to_fp 8 24) #xDEED950C)))
;; y should be Float32(0xDEED950C [Rational(-8559801376329170944), -8559801376329170944.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x9FED950A))))
(check-sat)
(exit)
