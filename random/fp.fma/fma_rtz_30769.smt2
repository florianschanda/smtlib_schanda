...
(assert (= z ((_ to_fp 8 24) #x53B22D81)))
;; z should be Float32(0x53B22D81 [Rational(1530535215104), 1530535215104.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10100111 #b01100100010110110000001)))
(check-sat)
(exit)
