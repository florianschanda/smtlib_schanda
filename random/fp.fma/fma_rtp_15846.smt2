...
(assert (= y ((_ to_fp 8 24) #x828C2548)))
;; y should be Float32(0x828C2548 [Rational(-1148073, 5575186299632655785383929568162090376495104), -0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFD74CB9)))
