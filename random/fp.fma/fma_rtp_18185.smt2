...
(assert (= y (fp #b0 #b10001100 #b11011101001100011100000)))
;; y should be Float32(0x466E98E0 [Rational(488647, 32), 15270.218750])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x4A67B2D2)))
;; z should be Float32(0x4A67B2D2 [Rational(7592297, 2), 3796148.500000])
