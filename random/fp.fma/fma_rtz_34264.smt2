...
(assert (= x ((_ to_fp 8 24) #x7FA66378)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x807D5C92)))
;; y should be Float32(0x807D5C92 [Rational(-4107849, 356811923176489970264571492362373784095686656), -0.000000])
