...
(assert (= x ((_ to_fp 8 24) #x8024B403)))
;; x should be Float32(0x8024B403 [Rational(-2405379, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b01111111 #b00100101101000000001011)))
(check-sat)
(exit)
