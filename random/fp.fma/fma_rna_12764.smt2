...
(assert (= x ((_ to_fp 8 24) #xFDBFF188)))
;; x should be Float32(0xFDBFF188 [Rational(-31892081143191490226285081869382844416), -31892081143191490226285081869382844416.000000])
...
(assert (not (= result (fp #b1 #b01100110 #b01111111111000110001000))))
(check-sat)
(exit)
