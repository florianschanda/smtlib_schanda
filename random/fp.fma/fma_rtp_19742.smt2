...
(assert (= x (fp #b1 #b10000011 #b11111000011000001001001)))
;; x should be Float32(0xC1FC3049 [Rational(-16527433, 524288), -31.523577])
...
(assert (= result ((_ to_fp 8 24) #x02FC3048)))
(check-sat)
(exit)
