...
(assert (= x (fp #b1 #b00000000 #b00111101010111101110001)))
;; x should be Float32(0x801EAF71 [Rational(-2010993, 713623846352979940529142984724747568191373312), -0.000000])
