...
(assert (= z (fp #b0 #b10010101 #b11110011111000011001011)))
;; z should be Float32(0x4AF9F0CB [Rational(16380107, 2), 8190053.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b11110011111000011001011))))
(check-sat)
(exit)
