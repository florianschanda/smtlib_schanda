...
(assert (= z ((_ to_fp 8 24) #xF189D1C4)))
;; z should be Float32(0xF189D1C4 [Rational(-1364897197620939979624655355904), -1364897197620939979624655355904.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b11100011 #b00010011101000111000011)))
(check-sat)
(exit)
