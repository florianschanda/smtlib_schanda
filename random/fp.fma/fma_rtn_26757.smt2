...
(assert (= x (fp #b1 #b00000000 #b01000100101111011101011)))
;; x should be Float32(0x80225EEB [Rational(-2252523, 713623846352979940529142984724747568191373312), -0.000000])
