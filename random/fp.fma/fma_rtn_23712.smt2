...
(assert (= x ((_ to_fp 8 24) #x00631F20)))
;; x should be Float32(0x00631F20 [Rational(203001, 22300745198530623141535718272648361505980416), 0.000000])
...
(assert (= z (fp #b1 #b11111111 #b01111110101011110000001)))
