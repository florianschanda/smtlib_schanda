...
(assert (= z (fp #b1 #b00000000 #b00101101111110000010100)))
;; z should be Float32(0x8016FC14 [Rational(-376581, 178405961588244985132285746181186892047843328), -0.000000])
