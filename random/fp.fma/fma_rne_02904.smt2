...
(assert (= x (fp #b0 #b00000000 #b01101111001111010101011)))
;; x should be Float32(0x00379EAB [Rational(3645099, 713623846352979940529142984724747568191373312), 0.000000])
