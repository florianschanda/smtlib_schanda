...
(assert (= x (fp #b1 #b11010101 #b10001110110001001100111)))
;; x should be Float32(0xEAC76267 [Rational(-120520465016636011540643840), -120520465016636011540643840.000000])
