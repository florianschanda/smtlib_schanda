...
(assert (= x (fp #b0 #b00000000 #b01001110101001100000010)))
;; x should be Float32(0x00275302 [Rational(1288577, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFE38687)))
