...
(assert (= x ((_ to_fp 8 24) #x801C41DD)))
;; x should be Float32(0x801C41DD [Rational(-1851869, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b0 #b01111110 #b11000100000111011100111))))
(check-sat)
(exit)
