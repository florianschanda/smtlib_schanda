...
(assert (= x (fp #b0 #b00000000 #b01000000101010001001101)))
;; x should be Float32(0x0020544D [Rational(2118733, 713623846352979940529142984724747568191373312), 0.000000])
