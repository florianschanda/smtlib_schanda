...
(assert (= z ((_ to_fp 8 24) #x801EC7CD)))
;; z should be Float32(0x801EC7CD [Rational(-2017229, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b00111101100011111001101)))
(check-sat)
(exit)
