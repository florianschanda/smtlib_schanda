...
(assert (= x ((_ to_fp 8 24) #xDE4DD7B2)))
;; x should be Float32(0xDE4DD7B2 [Rational(-3708129902709440512), -3708129902709440512.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10010010000000001000010)))
