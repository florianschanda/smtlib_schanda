...
(assert (= x ((_ to_fp 8 24) #x75368C3B)))
;; x should be Float32(0x75368C3B [Rational(231406796889511280236284415574016), 231406796889511280236284415574016.000000])
...
(assert (= result (fp #b0 #b01101100 #b01101101000110000111011)))
(check-sat)
(exit)
