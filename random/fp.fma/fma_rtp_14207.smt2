...
(assert (= x ((_ to_fp 8 24) #x4AE17FFB)))
;; x should be Float32(0x4AE17FFB [Rational(14778363, 2), 7389181.500000])
...
(assert (= result (fp #b1 #b00000000 #b00011110100000000000001)))
(check-sat)
(exit)
