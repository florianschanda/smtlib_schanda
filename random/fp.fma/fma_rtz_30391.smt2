...
(assert (= x ((_ to_fp 8 24) #x006D00A0)))
;; x should be Float32(0x006D00A0 [Rational(223237, 22300745198530623141535718272648361505980416), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x405A013F))))
(check-sat)
(exit)
