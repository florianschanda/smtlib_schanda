...
(assert (= x ((_ to_fp 8 24) #x800E5FAA)))
;; x should be Float32(0x800E5FAA [Rational(-470997, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xBEE5FAA0))))
(check-sat)
(exit)
