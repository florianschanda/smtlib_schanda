...
(assert (= x (fp #b0 #b11110110 #b00001111001101101011111)))
;; x should be Float32(0x7B079B5F [Rational(704111376066206593879400215069327360), 704111376066206593879400215069327360.000000])
