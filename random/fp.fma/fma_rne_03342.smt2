...
(assert (= z (fp #b1 #b10110001 #b10011101000001100100101)))
;; z should be Float32(0xD8CE8325 [Rational(-1816501254356992), -1816501254356992.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xD8CE8325))))
(check-sat)
(exit)
