...
(assert (= x ((_ to_fp 8 24) #xFFEA428C)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x000674E8)))
;; y should be Float32(0x000674E8 [Rational(52893, 89202980794122492566142873090593446023921664), 0.000000])
