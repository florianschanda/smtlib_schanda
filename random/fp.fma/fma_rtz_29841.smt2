...
(assert (= z ((_ to_fp 8 24) #xCA3188CA)))
;; z should be Float32(0xCA3188CA [Rational(-5817445, 2), -2908722.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010100 #b01100011000100011001010))))
(check-sat)
(exit)
