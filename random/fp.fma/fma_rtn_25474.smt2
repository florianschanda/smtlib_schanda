...
(assert (= y (fp #b1 #b10010101 #b00110101000100100000101)))
;; y should be Float32(0xCA9A8905 [Rational(-10127621, 2), -5063810.500000])
...
(assert (= result (fp #b0 #b00010111 #b00110101000100100000001)))
(check-sat)
(exit)
