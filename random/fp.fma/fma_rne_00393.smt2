...
(assert (= x (fp #b0 #b10010101 #b00011011001001111111111)))
;; x should be Float32(0x4A8D93FF [Rational(9278463, 2), 4639231.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4A4C4942)))
;; y should be Float32(0x4A4C4942 [Rational(6694049, 2), 3347024.500000])
