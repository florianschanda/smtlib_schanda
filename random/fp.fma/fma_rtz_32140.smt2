...
(assert (= z (fp #b1 #b10010101 #b10110010101010000110011)))
;; z should be Float32(0xCAD95433 [Rational(-14242867, 2), -7121433.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b10110010101010000110011)))
(check-sat)
(exit)
