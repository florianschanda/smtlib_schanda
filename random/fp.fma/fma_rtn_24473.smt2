...
(assert (= x (fp #b1 #b10010101 #b10110100110111011100001)))
;; x should be Float32(0xCADA6EE1 [Rational(-14315233, 2), -7157616.500000])
...
(assert (= result ((_ to_fp 8 24) #x006D3770)))
(check-sat)
(exit)
