...
(assert (= y (fp #b0 #b11101010 #b01100011011110101010101)))
;; y should be Float32(0x7531BD55 [Rational(225311683049211027448417805664256), 225311683049211027448417805664256.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB631BD54))))
(check-sat)
(exit)
