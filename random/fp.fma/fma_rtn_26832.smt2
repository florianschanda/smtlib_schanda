...
(assert (= x (fp #b1 #b00000000 #b00101010010101000011010)))
;; x should be Float32(0x80152A1A [Rational(-693517, 356811923176489970264571492362373784095686656), -0.000000])
