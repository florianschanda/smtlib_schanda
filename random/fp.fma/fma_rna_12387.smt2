...
(assert (= z (fp #b1 #b00000000 #b11111100010000010011001)))
;; z should be Float32(0x807E2099 [Rational(-8265881, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x807E2099)))
(check-sat)
(exit)
