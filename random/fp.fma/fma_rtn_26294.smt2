...
(assert (= z ((_ to_fp 8 24) #x9DF2B06F)))
;; z should be Float32(0x9DF2B06F [Rational(-15904879, 2475880078570760549798248448), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x9DF2B06F)))
(check-sat)
(exit)
