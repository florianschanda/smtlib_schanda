...
(assert (= x ((_ to_fp 8 24) #x8019EC79)))
;; x should be Float32(0x8019EC79 [Rational(-1698937, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBF4F63C8)))
(check-sat)
(exit)
