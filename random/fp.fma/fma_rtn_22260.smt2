...
(assert (= z (fp #b1 #b10010101 #b01001101001001000101011)))
;; z should be Float32(0xCAA6922B [Rational(-10916395, 2), -5458197.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xCAA69233)))
(check-sat)
(exit)
