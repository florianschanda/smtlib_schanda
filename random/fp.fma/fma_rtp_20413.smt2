...
(assert (= x (fp #b1 #b11111111 #b11110101100000011111000)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b10010101 #b01000011001001011001101)))
;; y should be Float32(0xCAA192CD [Rational(-10588877, 2), -5294438.500000])
