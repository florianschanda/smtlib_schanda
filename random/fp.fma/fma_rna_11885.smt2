...
(assert (= y (fp #b1 #b00000000 #b10101010000011101001111)))
;; y should be Float32(0x8055074F [Rational(-5572431, 713623846352979940529142984724747568191373312), -0.000000])
