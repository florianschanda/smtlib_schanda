...
(assert (= z (fp #b0 #b10010100 #b11100111000010010000010)))
;; z should be Float32(0x4A738482 [Rational(7979585, 2), 3989792.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010100 #b11100111000010001110010))))
(check-sat)
(exit)
