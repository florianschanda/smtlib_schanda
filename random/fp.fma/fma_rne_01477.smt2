...
(assert (= y (fp #b0 #b10010101 #b11100011101110011001011)))
;; y should be Float32(0x4AF1DCCB [Rational(15850699, 2), 7925349.500000])
...
(assert (= result (fp #b0 #b00010111 #b11100011101110011000111)))
(check-sat)
(exit)
