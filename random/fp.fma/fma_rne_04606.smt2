...
(assert (= z (fp #b0 #b01110000 #b01001110101110000100010)))
;; z should be Float32(0x38275C22 [Rational(5484049, 137438953472), 0.000040])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x40800053)))
(check-sat)
(exit)
