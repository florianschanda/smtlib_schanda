...
(assert (= z ((_ to_fp 8 24) #x6BC4BDC3)))
;; z should be Float32(0x6BC4BDC3 [Rational(475691170049648109100728320), 475691170049648109100728320.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b11010111 #b10001001011110111000010))))
(check-sat)
(exit)
