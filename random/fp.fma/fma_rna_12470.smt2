...
(assert (= y (fp #b1 #b10010001 #b10111111111101100110000)))
;; y should be Float32(0xC8DFFB30 [Rational(-917427, 2), -458713.500000])
...
(assert (not (= result (fp #b0 #b00000001 #b00001101111111111011010))))
(check-sat)
(exit)
