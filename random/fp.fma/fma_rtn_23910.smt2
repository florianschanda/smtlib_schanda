...
(assert (= z (fp #b0 #b10100111 #b00110010001011001011010)))
;; z should be Float32(0x5399165A [Rational(1315009986560), 1315009986560.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x5399165A))))
(check-sat)
(exit)
