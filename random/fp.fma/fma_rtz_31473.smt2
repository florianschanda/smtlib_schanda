...
(assert (= z (fp #b0 #b00000000 #b10000000001000101111010)))
;; z should be Float32(0x0040117A [Rational(2099389, 356811923176489970264571492362373784095686656), 0.000000])
