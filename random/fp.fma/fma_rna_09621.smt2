...
(assert (= x (fp #b0 #b00010100 #b00110001101101011111011)))
;; x should be Float32(0x0A18DAFB [Rational(10017531, 1361129467683753853853498429727072845824), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xCA18DAFA))))
(check-sat)
(exit)
