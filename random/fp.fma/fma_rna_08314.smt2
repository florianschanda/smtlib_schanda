...
(assert (= z (fp #b1 #b10010101 #b01111010111101010111101)))
;; z should be Float32(0xCABD7ABD [Rational(-12417725, 2), -6208862.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCABD7ABD))))
(check-sat)
(exit)
