...
(assert (= x ((_ to_fp 8 24) #xB078819D)))
;; x should be Float32(0xB078819D [Rational(-16286109, 18014398509481984), -0.000000])
...
(assert (not (= result (fp #b0 #b11100000 #b11110001000000110011100))))
(check-sat)
(exit)
