...
(assert (= z (fp #b1 #b00000110 #b10101010001101100011100)))
;; z should be Float32(0x83551B1C [Rational(-3491527, 5575186299632655785383929568162090376495104), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000110 #b10101010001101100011100)))
(check-sat)
(exit)
