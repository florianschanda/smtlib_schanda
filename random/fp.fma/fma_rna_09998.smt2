...
(assert (= x (fp #b0 #b00000000 #b00111000111010100101100)))
;; x should be Float32(0x001C752C [Rational(466251, 178405961588244985132285746181186892047843328), 0.000000])
