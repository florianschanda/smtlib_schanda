...
(assert (= z (fp #b0 #b00000000 #b10110011101100111000001)))
;; z should be Float32(0x0059D9C1 [Rational(5888449, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b00000000 #b10110011101100111000001)))
(check-sat)
(exit)
