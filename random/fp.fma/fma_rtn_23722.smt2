...
(assert (= x (fp #b0 #b00000000 #b01011100101110011111011)))
;; x should be Float32(0x002E5CFB [Rational(3038459, 713623846352979940529142984724747568191373312), 0.000000])
