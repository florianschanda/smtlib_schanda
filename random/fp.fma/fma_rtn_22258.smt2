...
(assert (= z (fp #b0 #b00000000 #b01100111101100011011011)))
;; z should be Float32(0x0033D8DB [Rational(3397851, 713623846352979940529142984724747568191373312), 0.000000])
