...
(assert (= x ((_ to_fp 8 24) #x0013D882)))
;; x should be Float32(0x0013D882 [Rational(650305, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b1 #b01111110 #b00111101100010000001111)))
(check-sat)
(exit)
