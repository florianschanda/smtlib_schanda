...
(assert (= x ((_ to_fp 8 24) #xCABFE02F)))
;; x should be Float32(0xCABFE02F [Rational(-12574767, 2), -6287383.500000])
...
(assert (= result (fp #b0 #b00010111 #b01111111110000000101011)))
(check-sat)
(exit)
