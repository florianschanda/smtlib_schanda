...
(assert (= z (fp #b0 #b00000000 #b10110110011101000000111)))
;; z should be Float32(0x005B3A07 [Rational(5978631, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x005B3A07))))
(check-sat)
(exit)
