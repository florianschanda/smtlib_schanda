...
(assert (= x ((_ to_fp 8 24) #x4AEAECD1)))
;; x should be Float32(0x4AEAECD1 [Rational(15396049, 2), 7698024.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b00010101000100110011000))))
(check-sat)
(exit)
