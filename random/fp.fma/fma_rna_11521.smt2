...
(assert (= y ((_ to_fp 8 24) #x8044BC66)))
;; y should be Float32(0x8044BC66 [Rational(-2252339, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b0 #b10000000 #b00010010111100011001011)))
(check-sat)
(exit)
