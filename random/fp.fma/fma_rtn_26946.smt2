...
(assert (= x (fp #b1 #b00000000 #b11011001001011010100001)))
;; x should be Float32(0x806C96A1 [Rational(-7116449, 713623846352979940529142984724747568191373312), -0.000000])
