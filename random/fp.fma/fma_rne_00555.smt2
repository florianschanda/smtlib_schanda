...
(assert (= x (fp #b0 #b10010101 #b10101001100101100000101)))
;; x should be Float32(0x4AD4CB05 [Rational(13945605, 2), 6972802.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xCAFACAA9)))
;; y should be Float32(0xCAFACAA9 [Rational(-16435881, 2), -8217940.500000])
