...
(assert (= z (fp #b1 #b10010101 #b10010010010011001101011)))
;; z should be Float32(0xCAC9266B [Rational(-13182571, 2), -6591285.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10010010010011001101011))))
(check-sat)
(exit)
