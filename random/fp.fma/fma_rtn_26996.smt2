...
(assert (= x (fp #b1 #b00000000 #b11100111111001011000001)))
;; x should be Float32(0x8073F2C1 [Rational(-7598785, 713623846352979940529142984724747568191373312), -0.000000])
