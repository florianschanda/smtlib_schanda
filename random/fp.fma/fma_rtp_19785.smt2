...
(assert (= x (fp #b1 #b11001111 #b01101110111110000111101)))
;; x should be Float32(0xE7B77C3D [Rational(-1732969716287042744221696), -1732969716287042744221696.000000])
...
(assert (= result (fp #b0 #b00111010 #b01101110111110000111110)))
(check-sat)
(exit)
