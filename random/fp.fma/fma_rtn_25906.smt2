...
(assert (= z ((_ to_fp 8 24) #x006EB097)))
;; z should be Float32(0x006EB097 [Rational(7254167, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x006EB097))))
(check-sat)
(exit)
