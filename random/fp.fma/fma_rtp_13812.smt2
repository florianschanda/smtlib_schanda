...
(assert (= z (fp #b1 #b00000000 #b11111010100101010010101)))
;; z should be Float32(0x807D4A95 [Rational(-8211093, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x807D4A95))))
(check-sat)
(exit)
