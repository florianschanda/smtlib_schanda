...
(assert (= y (fp #b1 #b10010100 #b11010101100110000011110)))
;; y should be Float32(0xCA6ACC1E [Rational(-7693839, 2), -3846919.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b11010101100110000011110))))
(check-sat)
(exit)
