...
(assert (= z (fp #b0 #b00000000 #b10101010011000101110111)))
;; z should be Float32(0x00553177 [Rational(5583223, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00553177))))
(check-sat)
(exit)
