...
(assert (= x ((_ to_fp 8 24) #xFE8239DB)))
;; x should be Float32(0xFE8239DB [Rational(-86550021110339374184072000287620988928), -86550021110339374184072000287620988928.000000])
