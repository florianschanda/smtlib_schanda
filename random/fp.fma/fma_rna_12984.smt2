...
(assert (= x (fp #b1 #b11011110 #b01110000110110000001101)))
;; x should be Float32(0xEF386C0D [Rational(-57075867186410149901615759360), -57075867186410149901615759360.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7F9FC0D0)))
