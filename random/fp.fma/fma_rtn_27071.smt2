...
(assert (= x (fp #b1 #b00000000 #b01010011110111001101011)))
;; x should be Float32(0x8029EE6B [Rational(-2748011, 713623846352979940529142984724747568191373312), -0.000000])
