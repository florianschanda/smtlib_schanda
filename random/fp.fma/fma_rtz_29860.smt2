...
(assert (= z (fp #b1 #b10010101 #b10101010010000111100001)))
;; z should be Float32(0xCAD521E1 [Rational(-13967841, 2), -6983920.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10101010010000111100001))))
(check-sat)
(exit)
