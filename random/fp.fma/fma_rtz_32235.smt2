...
(assert (= z (fp #b1 #b10010101 #b01010111000001010100011)))
;; z should be Float32(0xCAAB82A3 [Rational(-11240099, 2), -5620049.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xCAAB82A3)))
(check-sat)
(exit)
