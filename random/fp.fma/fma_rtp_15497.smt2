...
(assert (= y (fp #b1 #b00000000 #b11110100111001000001110)))
;; y should be Float32(0x807A720E [Rational(-4012295, 356811923176489970264571492362373784095686656), -0.000000])
