...
(assert (= x (fp #b1 #b10111010 #b10110111001101100100100)))
;; x should be Float32(0xDD5B9B24 [Rational(-989017581132185600), -989017581132185600.000000])
...
(assert (= result ((_ to_fp 8 24) #x12DB9B24)))
(check-sat)
(exit)
