...
(assert (= y ((_ to_fp 8 24) #x75F11E2C)))
;; y should be Float32(0x75F11E2C [Rational(611306397086989080185264721100800), 611306397086989080185264721100800.000000])
...
(assert (not (= result (fp #b1 #b01101101 #b11100010001111000101100))))
(check-sat)
(exit)
