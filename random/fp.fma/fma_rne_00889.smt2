...
(assert (= y (fp #b0 #b00000000 #b11100011110001011011100)))
;; y should be Float32(0x0071E2DC [Rational(1865911, 178405961588244985132285746181186892047843328), 0.000000])
