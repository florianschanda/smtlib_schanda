...
(assert (= x (fp #b1 #b00000000 #b00101010101101000010001)))
;; x should be Float32(0x80155A11 [Rational(-1399313, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b01111110 #b01010101101000010000111)))
(check-sat)
(exit)
