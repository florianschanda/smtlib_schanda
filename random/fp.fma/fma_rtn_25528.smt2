...
(assert (= z (fp #b1 #b10010100 #b01001110010100111110010)))
;; z should be Float32(0xCA2729F2 [Rational(-5477625, 2), -2738812.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010100 #b01001110010100111110010))))
(check-sat)
(exit)
