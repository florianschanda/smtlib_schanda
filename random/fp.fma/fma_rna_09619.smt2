...
(assert (= x (fp #b0 #b11101111 #b01111110110111000010010)))
;; x should be Float32(0x77BF6E12 [Rational(7765321805808429824640903752450048), 7765321805808429824640903752450048.000000])
