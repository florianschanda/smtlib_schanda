...
(assert (= z (fp #b0 #b10000000 #b01110011000000010101001)))
;; z should be Float32(0x403980A9 [Rational(12157097, 4194304), 2.898478])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x403980A9)))
(check-sat)
(exit)
