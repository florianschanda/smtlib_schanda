...
(assert (= y ((_ to_fp 8 24) #x6C8A6A06)))
;; y should be Float32(0x6C8A6A06 [Rational(1338659557075739606075310080), 1338659557075739606075310080.000000])
...
(assert (= result (fp #b0 #b01011011 #b00010100110101000000101)))
(check-sat)
(exit)
