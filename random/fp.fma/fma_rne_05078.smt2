...
(assert (= y ((_ to_fp 8 24) #x4ACFFE2B)))
;; y should be Float32(0x4ACFFE2B [Rational(13631019, 2), 6815509.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b10011111111111000101001))))
(check-sat)
(exit)
