...
(assert (= y (fp #b1 #b11100111 #b10000011001000101000010)))
;; y should be Float32(0xF3C19142 [Rational(-30671980961562413512089212551168), -30671980961562413512089212551168.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB4C19142))))
(check-sat)
(exit)
