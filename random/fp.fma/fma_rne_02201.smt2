...
(assert (= y (fp #b0 #b10010011 #b00101001111010111110100)))
;; y should be Float32(0x4994F5F4 [Rational(2440573, 2), 1220286.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b00100101001111010111110))))
(check-sat)
(exit)
