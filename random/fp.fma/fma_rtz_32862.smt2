...
(assert (= z (fp #b1 #b10010010 #b11110101000010000111000)))
;; z should be Float32(0xC97A8438 [Rational(-2052231, 2), -1026115.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC97A8438))))
(check-sat)
(exit)
