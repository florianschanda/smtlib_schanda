...
(assert (= x (fp #b0 #b11110100 #b11001000011111101001010)))
;; x should be Float32(0x7A643F4A [Rational(296281834608749202525660940536381440), 296281834608749202525660940536381440.000000])
...
(assert (= result ((_ to_fp 8 24) #xBB643F4A)))
(check-sat)
(exit)
