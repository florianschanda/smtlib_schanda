...
(assert (= z (fp #b1 #b10010101 #b11101011101110000011101)))
;; z should be Float32(0xCAF5DC1D [Rational(-16112669, 2), -8056334.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b11101011101110000011100)))
(check-sat)
(exit)
