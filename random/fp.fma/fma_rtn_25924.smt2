...
(assert (= z (fp #b0 #b10111001 #b00010110010110100001011)))
;; z should be Float32(0x5C8B2D0B [Rational(313396376245370880), 313396376245370880.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10111001 #b00010110010110100001011)))
(check-sat)
(exit)
