...
(assert (= y (fp #b0 #b00000000 #b00000011100000100001111)))
;; y should be Float32(0x0001C10F [Rational(114959, 713623846352979940529142984724747568191373312), 0.000000])
