...
(assert (= z (fp #b1 #b00000000 #b10110011010011001000000)))
;; z should be Float32(0x8059A640 [Rational(-91801, 11150372599265311570767859136324180752990208), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x8059A640)))
(check-sat)
(exit)
