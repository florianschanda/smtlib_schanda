...
(assert (= y (fp #b0 #b00000000 #b10010110001100111111010)))
;; y should be Float32(0x004B19FA [Rational(2460925, 356811923176489970264571492362373784095686656), 0.000000])
