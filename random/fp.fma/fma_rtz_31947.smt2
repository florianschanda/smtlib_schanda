...
(assert (= z ((_ to_fp 8 24) #x60D944DA)))
;; z should be Float32(0x60D944DA [Rational(125247023185452335104), 125247023185452335104.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b11000001 #b10110010100010011011010))))
(check-sat)
(exit)
