...
(assert (= y ((_ to_fp 8 24) #xC5752899)))
;; y should be Float32(0xC5752899 [Rational(-16066713, 4096), -3922.537354])
...
(assert (not (= result (fp #b1 #b00000000 #b11111111111000010101101))))
(check-sat)
(exit)
