...
(assert (= y (fp #b0 #b10010101 #b01001101101100011000011)))
;; y should be Float32(0x4AA6D8C3 [Rational(10934467, 2), 5467233.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b01001101101100011000011))))
(check-sat)
(exit)
