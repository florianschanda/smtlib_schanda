...
(assert (= x (fp #b0 #b00000000 #b00111110001000101101001)))
;; x should be Float32(0x001F1169 [Rational(2036073, 713623846352979940529142984724747568191373312), 0.000000])
