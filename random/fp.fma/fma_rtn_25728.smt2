...
(assert (= z ((_ to_fp 8 24) #x490F91C8)))
;; z should be Float32(0x490F91C8 [Rational(1176121, 2), 588060.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010010 #b00011111001000111000111))))
(check-sat)
(exit)
