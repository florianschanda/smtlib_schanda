...
(assert (= z (fp #b0 #b00000000 #b00011110101000101000001)))
;; z should be Float32(0x000F5141 [Rational(1003841, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x000F5141)))
(check-sat)
(exit)
