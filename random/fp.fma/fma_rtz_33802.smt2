...
(assert (= x ((_ to_fp 8 24) #x8078487D)))
;; x should be Float32(0x8078487D [Rational(-7882877, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b11100001001000011111001))))
(check-sat)
(exit)
