...
(assert (= x (fp #b1 #b10010101 #b00010000101011010100101)))
;; x should be Float32(0xCA8856A5 [Rational(-8935077, 2), -4467538.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x003BD4AD))))
(check-sat)
(exit)
