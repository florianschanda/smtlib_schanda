...
(assert (= y ((_ to_fp 8 24) #xC97F2E5F)))
;; y should be Float32(0xC97F2E5F [Rational(-16723551, 16), -1045221.937500])
...
(assert (= result (fp #b1 #b00010100 #b11111110010111001011101)))
(check-sat)
(exit)
