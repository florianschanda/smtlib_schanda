...
(assert (= x (fp #b0 #b00000000 #b00001001111100011001111)))
;; x should be Float32(0x0004F8CF [Rational(325839, 713623846352979940529142984724747568191373312), 0.000000])
