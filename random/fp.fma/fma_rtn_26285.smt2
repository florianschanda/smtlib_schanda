...
(assert (= z ((_ to_fp 8 24) #x43B286CB)))
;; z should be Float32(0x43B286CB [Rational(11699915, 32768), 357.053070])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10000111 #b01100101000011011001011))))
(check-sat)
(exit)
