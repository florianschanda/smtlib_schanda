...
(assert (= x ((_ to_fp 8 24) #xCA55573A)))
;; x should be Float32(0xCA55573A [Rational(-6990749, 2), -3495374.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b10101010101011100111010))))
(check-sat)
(exit)
