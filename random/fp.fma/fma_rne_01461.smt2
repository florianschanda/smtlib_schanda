...
(assert (= z (fp #b1 #b00111000 #b01011000010011111101111)))
;; z should be Float32(0x9C2C27EF [Rational(-11282415, 19807040628566084398385987584), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00111000 #b01011000010011111101111))))
(check-sat)
(exit)
