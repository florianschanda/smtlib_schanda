...
(assert (= z (fp #b1 #b10010010 #b00001000001010100111000)))
;; z should be Float32(0xC9041538 [Rational(-1082023, 2), -541011.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b1 #b10010010 #b00001000001010100111000))))
(check-sat)
(exit)
