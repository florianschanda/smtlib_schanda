...
(assert (= x (fp #b0 #b00000000 #b11110010100110010001010)))
;; x should be Float32(0x00794C8A [Rational(3974725, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x40729913))))
(check-sat)
(exit)
