...
(assert (= y (fp #b0 #b10001100 #b11011011101101000011001)))
;; y should be Float32(0x466DDA19 [Rational(15587865, 1024), 15222.524414])
...
(assert (not (= result ((_ to_fp 8 24) #x076DDA19))))
(check-sat)
(exit)
