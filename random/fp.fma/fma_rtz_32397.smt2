...
(assert (= z (fp #b0 #b10010100 #b10100101010000000000010)))
;; z should be Float32(0x4A52A002 [Rational(6901761, 2), 3450880.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010100 #b10100101010000000000010)))
(check-sat)
(exit)
