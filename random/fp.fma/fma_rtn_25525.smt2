...
(assert (= z (fp #b0 #b01110011 #b01011001111100100101111)))
;; z should be Float32(0x39ACF92F [Rational(11335983, 34359738368), 0.000330])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x39ACF92F)))
(check-sat)
(exit)
