...
(assert (= x (fp #b0 #b00000000 #b11001001100001001111010)))
;; x should be Float32(0x0064C27A [Rational(3301693, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b10010011000010011110011))))
(check-sat)
(exit)
