...
(assert (= y (fp #b1 #b10010101 #b11010110011110001110111)))
;; y should be Float32(0xCAEB3C77 [Rational(-15416439, 2), -7708219.500000])
...
(assert (= result (fp #b0 #b00000001 #b11101011001111000111100)))
(check-sat)
(exit)
