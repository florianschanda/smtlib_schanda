...
(assert (= x (fp #b0 #b00111111 #b11110110100010100101001)))
;; x should be Float32(0x1FFB4529 [Rational(16467241, 154742504910672534362390528), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b10111011001111010010111)))
