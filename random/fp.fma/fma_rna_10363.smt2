...
(assert (= z ((_ to_fp 8 24) #x5716D6EB)))
;; z should be Float32(0x5716D6EB [Rational(165849809813504), 165849809813504.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10101110 #b00101101101011011101011)))
(check-sat)
(exit)
