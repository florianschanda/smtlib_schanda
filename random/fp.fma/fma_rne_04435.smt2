...
(assert (= z (fp #b0 #b10010111 #b00000000000100100000011)))
;; z should be Float32(0x4B800903 [Rational(16781830), 16781830.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010111 #b00000000000100100000001)))
(check-sat)
(exit)
