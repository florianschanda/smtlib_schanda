...
(assert (= x ((_ to_fp 8 24) #x095CD075)))
;; x should be Float32(0x095CD075 [Rational(14471285, 5444517870735015415413993718908291383296), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x495CD074))))
(check-sat)
(exit)
