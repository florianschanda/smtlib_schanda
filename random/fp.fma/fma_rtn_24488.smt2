...
(assert (= x ((_ to_fp 8 24) #xCA235642)))
;; x should be Float32(0xCA235642 [Rational(-5352225, 2), -2676112.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b01010001101010110001111))))
(check-sat)
(exit)
