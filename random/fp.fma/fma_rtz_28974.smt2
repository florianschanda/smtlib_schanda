...
(assert (= z ((_ to_fp 8 24) #x80739783)))
;; z should be Float32(0x80739783 [Rational(-7575427, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000000 #b11100111001011110000010)))
(check-sat)
(exit)
