...
(assert (= y (fp #b0 #b00000000 #b10110110101100011000011)))
;; y should be Float32(0x005B58C3 [Rational(5986499, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x4036B185)))
(check-sat)
(exit)
