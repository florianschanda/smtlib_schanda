...
(assert (= z ((_ to_fp 8 24) #x669C93DF)))
;; z should be Float32(0x669C93DF [Rational(369708455774985207676928), 369708455774985207676928.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b11001101 #b00111001001001111011110)))
(check-sat)
(exit)
