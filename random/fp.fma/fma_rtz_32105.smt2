...
(assert (= y (fp #b1 #b00000000 #b01000000000001011111111)))
;; y should be Float32(0x802002FF [Rational(-2097919, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b0 #b01111111 #b00000000000101111111011)))
(check-sat)
(exit)
