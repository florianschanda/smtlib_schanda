...
(assert (= x (fp #b1 #b11111111 #b10001001011000000011011)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xDD055EF0)))
;; y should be Float32(0xDD055EF0 [Rational(-600648908602867712), -600648908602867712.000000])
