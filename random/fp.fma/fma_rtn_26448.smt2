...
(assert (= x (fp #b1 #b00110111 #b11000001000101100011110)))
;; x should be Float32(0x9BE08B1E [Rational(-7357839, 19807040628566084398385987584), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7F8ACA9E)))
