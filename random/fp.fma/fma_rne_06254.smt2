...
(assert (= x (fp #b1 #b00000000 #b01010000000000101010001)))
;; x should be Float32(0x80280151 [Rational(-2621777, 713623846352979940529142984724747568191373312), -0.000000])
