...
(assert (= x (fp #b1 #b11010101 #b10111100011001010110001)))
;; x should be Float32(0xEADE32B1 [Rational(-134310457676146102818045952), -134310457676146102818045952.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xABDE32B2))))
(check-sat)
(exit)
