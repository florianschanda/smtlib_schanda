...
(assert (= z ((_ to_fp 8 24) #xCACF0DC7)))
;; z should be Float32(0xCACF0DC7 [Rational(-13569479, 2), -6784739.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10011110000110111000110))))
(check-sat)
(exit)
