...
(assert (= x (fp #b1 #b00000000 #b00001010011011001100110)))
;; x should be Float32(0x80053666 [Rational(-170803, 356811923176489970264571492362373784095686656), -0.000000])
