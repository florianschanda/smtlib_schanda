...
(assert (= z ((_ to_fp 8 24) #xC9F2068C)))
;; z should be Float32(0xC9F2068C [Rational(-3965347, 2), -1982673.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010011 #b11100100000011010001100))))
(check-sat)
(exit)
