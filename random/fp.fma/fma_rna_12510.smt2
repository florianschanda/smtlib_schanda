...
(assert (= z ((_ to_fp 8 24) #x6B3A4606)))
;; z should be Float32(0x6B3A4606 [Rational(225190878782586343917617152), 225190878782586343917617152.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b11010110 #b01110100100011000000110))))
(check-sat)
(exit)
