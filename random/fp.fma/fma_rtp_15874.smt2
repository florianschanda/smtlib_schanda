...
(assert (= z (fp #b0 #b00000000 #b00111000001101110111111)))
;; z should be Float32(0x001C1BBF [Rational(1842111, 713623846352979940529142984724747568191373312), 0.000000])
