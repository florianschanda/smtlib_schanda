...
(assert (= z (fp #b0 #b00000000 #b00001000110110101100110)))
;; z should be Float32(0x00046D66 [Rational(145075, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00046D66))))
(check-sat)
(exit)
