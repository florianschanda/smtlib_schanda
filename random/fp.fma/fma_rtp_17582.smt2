...
(assert (= x (fp #b1 #b10010100 #b01100011101110001101110)))
;; x should be Float32(0xCA31DC6E [Rational(-5828151, 2), -2914075.500000])
...
(assert (= result (fp #b0 #b00010110 #b01100011101110001101101)))
(check-sat)
(exit)
