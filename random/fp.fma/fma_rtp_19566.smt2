...
(assert (= x (fp #b1 #b01011010 #b01011111010001001101010)))
;; x should be Float32(0xAD2FA26A [Rational(-5755189, 576460752303423488), -0.000000])
...
(assert (not (= result (fp #b1 #b11011010 #b01011111010001001101001))))
(check-sat)
(exit)
