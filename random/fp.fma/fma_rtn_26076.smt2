...
(assert (= z ((_ to_fp 8 24) #x7C0E65FC)))
;; z should be Float32(0x7C0E65FC [Rational(2957498571115471746308890896818503680), 2957498571115471746308890896818503680.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x7C0E65FB))))
(check-sat)
(exit)
