...
(assert (= x ((_ to_fp 8 24) #x7FD0E48F)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x803EF81E)))
;; y should be Float32(0x803EF81E [Rational(-2063375, 356811923176489970264571492362373784095686656), -0.000000])
