...
(assert (= y (fp #b0 #b10010101 #b10011000100000100010001)))
;; y should be Float32(0x4ACC4111 [Rational(13386001, 2), 6693000.500000])
...
(assert (= result (fp #b0 #b00000000 #b00110011101111101110111)))
(check-sat)
(exit)
