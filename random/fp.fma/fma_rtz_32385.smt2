...
(assert (= z (fp #b0 #b00000000 #b00111001110011100010010)))
;; z should be Float32(0x001CE712 [Rational(947081, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b00111001110011100010010)))
(check-sat)
(exit)
