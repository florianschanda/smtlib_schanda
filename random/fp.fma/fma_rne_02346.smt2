...
(assert (= z ((_ to_fp 8 24) #x0079BBC8)))
;; z should be Float32(0x0079BBC8 [Rational(997241, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x0079BBC8)))
(check-sat)
(exit)
