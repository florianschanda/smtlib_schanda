...
(assert (= z (fp #b0 #b10010101 #b01110110011000000011011)))
;; z should be Float32(0x4ABB301B [Rational(12267547, 2), 6133773.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x4ABB301B)))
(check-sat)
(exit)
