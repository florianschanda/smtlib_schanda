...
(assert (= x (fp #b0 #b01111010 #b01011100000011000011000)))
;; x should be Float32(0x3D2E0618 [Rational(1425603, 33554432), 0.042486])
...
(assert (= result (fp #b0 #b00000000 #b00001010111000000110000)))
(check-sat)
(exit)
