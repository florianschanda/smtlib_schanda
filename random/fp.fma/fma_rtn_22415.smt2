...
(assert (= y (fp #b0 #b10010101 #b11101000111101101010011)))
;; y should be Float32(0x4AF47B53 [Rational(16022355, 2), 8011177.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BF47B51)))
(check-sat)
(exit)
