...
(assert (= z (fp #b1 #b10111011 #b01101000010001011110010)))
;; z should be Float32(0xDDB422F2 [Rational(-1622525394731139072), -1622525394731139072.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10111011 #b01101000010001011110001))))
(check-sat)
(exit)
