...
(assert (= z ((_ to_fp 8 24) #xD0C988E9)))
;; z should be Float32(0xD0C988E9 [Rational(-27049543680), -27049543680.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10100001 #b10010011000100011101001)))
(check-sat)
(exit)
