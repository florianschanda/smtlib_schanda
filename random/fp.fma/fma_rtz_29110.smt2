...
(assert (= z (fp #b0 #b10010101 #b10000110110101000010001)))
;; z should be Float32(0x4AC36A11 [Rational(12806673, 2), 6403336.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10000110110101000001001))))
(check-sat)
(exit)
