...
(assert (= x (fp #b1 #b00000000 #b00111001010110001101000)))
;; x should be Float32(0x801CAC68 [Rational(-234893, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F656340)))
(check-sat)
(exit)
