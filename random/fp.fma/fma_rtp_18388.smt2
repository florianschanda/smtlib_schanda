...
(assert (= y ((_ to_fp 8 24) #x8012F430)))
;; y should be Float32(0x8012F430 [Rational(-77635, 44601490397061246283071436545296723011960832), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3F17A180))))
(check-sat)
(exit)
