...
(assert (= y ((_ to_fp 8 24) #x598357C6)))
;; y should be Float32(0x598357C6 [Rational(4621216233029632), 4621216233029632.000000])
...
(assert (not (= result (fp #b0 #b00110101 #b00000110101011111000100))))
(check-sat)
(exit)
