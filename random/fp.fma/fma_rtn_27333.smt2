...
(assert (= x (fp #b0 #b11111111 #b01011100000000000110010)))
...
(assert (= z (fp #b1 #b10010100 #b00111111101100001101110)))
;; z should be Float32(0xCA1FD86E [Rational(-5237815, 2), -2618907.500000])
