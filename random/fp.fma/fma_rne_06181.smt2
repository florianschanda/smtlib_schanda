...
(assert (= x (fp #b1 #b00000000 #b10100100011000010111011)))
;; x should be Float32(0x805230BB [Rational(-5386427, 713623846352979940529142984724747568191373312), -0.000000])
