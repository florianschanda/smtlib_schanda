...
(assert (= z ((_ to_fp 8 24) #x582941A7)))
;; z should be Float32(0x582941A7 [Rational(744397759053824), 744397759053824.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10110000 #b01010010100000110100111)))
(check-sat)
(exit)
