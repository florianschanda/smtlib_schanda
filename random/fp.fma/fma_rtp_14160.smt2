...
(assert (= x (fp #b0 #b10010010 #b10010010001100110011000)))
;; x should be Float32(0x49491998 [Rational(1647411, 2), 823705.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0A4919A7))))
(check-sat)
(exit)
