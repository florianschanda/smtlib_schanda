...
(assert (= z (fp #b1 #b00000000 #b00001111101001010101011)))
;; z should be Float32(0x8007D2AB [Rational(-512683, 713623846352979940529142984724747568191373312), -0.000000])
