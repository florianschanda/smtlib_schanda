...
(assert (= x ((_ to_fp 8 24) #x7C3EF34D)))
;; x should be Float32(0x7C3EF34D [Rational(3965884516895272814751232749993984000), 3965884516895272814751232749993984000.000000])
