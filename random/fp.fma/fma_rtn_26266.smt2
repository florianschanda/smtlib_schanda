...
(assert (= z (fp #b0 #b01101100 #b00100000000000111100011)))
;; z should be Float32(0x361001E3 [Rational(9437667, 4398046511104), 0.000002])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b01101100 #b00100000000000111100011))))
(check-sat)
(exit)
