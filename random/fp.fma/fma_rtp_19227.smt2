...
(assert (= z ((_ to_fp 8 24) #x8022A6DA)))
;; z should be Float32(0x8022A6DA [Rational(-1135469, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b01000101010011011011010)))
(check-sat)
(exit)
