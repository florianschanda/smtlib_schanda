...
(assert (= z ((_ to_fp 8 24) #x00438664)))
;; z should be Float32(0x00438664 [Rational(1106329, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b10000111000011001100100)))
(check-sat)
(exit)
