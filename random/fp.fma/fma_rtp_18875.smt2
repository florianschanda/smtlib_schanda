...
(assert (= z (fp #b0 #b01010110 #b11101101010000010010010)))
;; z should be Float32(0x2B76A092 [Rational(8081481, 9223372036854775808), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b01010110 #b11101101010000010010010))))
(check-sat)
(exit)
