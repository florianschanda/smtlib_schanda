...
(assert (= z (fp #b0 #b10100101 #b10101010010111111101110)))
;; z should be Float32(0x52D52FEE [Rational(457816080384), 457816080384.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x52D52FEE))))
(check-sat)
(exit)
