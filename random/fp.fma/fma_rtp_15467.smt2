...
(assert (= y ((_ to_fp 8 24) #xF23C4C72)))
;; y should be Float32(0xF23C4C72 [Rational(-3729638307742888440133815631872), -3729638307742888440133815631872.000000])
...
(assert (= result ((_ to_fp 8 24) #xB33C4C70)))
(check-sat)
(exit)
