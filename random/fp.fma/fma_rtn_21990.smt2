...
(assert (= y ((_ to_fp 8 24) #x8051BD89)))
;; y should be Float32(0x8051BD89 [Rational(-5356937, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b10000000 #b01000110111101100010010)))
(check-sat)
(exit)
