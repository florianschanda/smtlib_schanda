...
(assert (= z (fp #b0 #b10010011 #b10110000101111001011100)))
;; z should be Float32(0x49D85E5C [Rational(3544983, 2), 1772491.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x49D85E5C))))
(check-sat)
(exit)
