...
(assert (= y (fp #b1 #b00000000 #b00010101111001000100110)))
;; y should be Float32(0x800AF226 [Rational(-358675, 356811923176489970264571492362373784095686656), -0.000000])
