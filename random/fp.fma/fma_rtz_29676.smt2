...
(assert (= z ((_ to_fp 8 24) #xBB81F629)))
;; z should be Float32(0xBB81F629 [Rational(-8517161, 2147483648), -0.003966])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b01110111 #b00000011111001000101001)))
(check-sat)
(exit)
