...
(assert (= z ((_ to_fp 8 24) #x4AECA209)))
;; z should be Float32(0x4AECA209 [Rational(15507977, 2), 7753988.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b11011001010001000001010)))
(check-sat)
(exit)
