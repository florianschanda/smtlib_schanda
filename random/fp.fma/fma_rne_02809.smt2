...
(assert (= x ((_ to_fp 8 24) #x6FA1EFCC)))
;; x should be Float32(0x6FA1EFCC [Rational(100233966429773915690136240128), 100233966429773915690136240128.000000])
...
(assert (= result (fp #b1 #b01100001 #b01000011110111111001100)))
(check-sat)
(exit)
