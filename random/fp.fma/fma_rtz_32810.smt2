...
(assert (= y ((_ to_fp 8 24) #xF2819972)))
;; y should be Float32(0xF2819972 [Rational(-5133960994193100706403988799488), -5133960994193100706403988799488.000000])
...
(assert (= result (fp #b0 #b01100111 #b00000011001100101110001)))
(check-sat)
(exit)
