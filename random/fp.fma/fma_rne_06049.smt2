...
(assert (= x (fp #b1 #b10110110 #b01011101110111101011100)))
;; x should be Float32(0xDB2EEF5C [Rational(-49239824363683840), -49239824363683840.000000])
...
(assert (= result (fp #b0 #b00111000 #b01011101110111101011100)))
(check-sat)
(exit)
