...
(assert (= z ((_ to_fp 8 24) #x003EA095)))
;; z should be Float32(0x003EA095 [Rational(4104341, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x003EA095)))
(check-sat)
(exit)
