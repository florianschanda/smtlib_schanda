...
(assert (= x (fp #b0 #b10010010 #b00001110100001110100110)))
;; x should be Float32(0x490743A6 [Rational(4432339, 8), 554042.375000])
...
(assert (not (= result ((_ to_fp 8 24) #x0A074395))))
(check-sat)
(exit)
