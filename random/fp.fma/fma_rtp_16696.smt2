...
(assert (= x (fp #b0 #b00000000 #b11110001100111100010010)))
;; x should be Float32(0x0078CF12 [Rational(3958665, 356811923176489970264571492362373784095686656), 0.000000])
