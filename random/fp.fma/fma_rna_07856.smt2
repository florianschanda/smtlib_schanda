...
(assert (= z (fp #b0 #b00000000 #b01010100000010011111100)))
;; z should be Float32(0x002A04FC [Rational(688447, 178405961588244985132285746181186892047843328), 0.000000])
