...
(assert (= z (fp #b1 #b00010110 #b10011111011110001010001)))
;; z should be Float32(0x8B4FBC51 [Rational(-13614161, 340282366920938463463374607431768211456), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00010110 #b10011111011110001010001)))
(check-sat)
(exit)
