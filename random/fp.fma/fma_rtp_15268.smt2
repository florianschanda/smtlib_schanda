...
(assert (= z ((_ to_fp 8 24) #xCABAB127)))
;; z should be Float32(0xCABAB127 [Rational(-12235047, 2), -6117523.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b01110101011000100100110)))
(check-sat)
(exit)
