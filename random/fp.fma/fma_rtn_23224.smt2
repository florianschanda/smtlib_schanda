...
(assert (= x ((_ to_fp 8 24) #x53010A9A)))
;; x should be Float32(0x53010A9A [Rational(554228645888), 554228645888.000000])
...
(assert (not (= result (fp #b0 #b00010001 #b00000010000101100011010))))
(check-sat)
(exit)
