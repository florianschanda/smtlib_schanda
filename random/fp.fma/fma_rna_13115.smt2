...
(assert (= x (fp #b1 #b00000000 #b00110001110011100000110)))
;; x should be Float32(0x8018E706 [Rational(-816003, 356811923176489970264571492362373784095686656), -0.000000])
