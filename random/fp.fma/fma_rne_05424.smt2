...
(assert (= z ((_ to_fp 8 24) #x004447BA)))
;; z should be Float32(0x004447BA [Rational(2237405, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x004447BA)))
(check-sat)
(exit)
