...
(assert (= x ((_ to_fp 8 24) #xFE242CE4)))
;; x should be Float32(0xFE242CE4 [Rational(-54556619189972842038184089924438851584), -54556619189972842038184089924438851584.000000])
