...
(assert (= z (fp #b1 #b00000001 #b00010111001001101011011)))
;; z should be Float32(0x808B935B [Rational(-9147227, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b00000001 #b00010111001001101011010))))
(check-sat)
(exit)
