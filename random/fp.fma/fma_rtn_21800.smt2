...
(assert (= y (fp #b0 #b00011011 #b01011010001100110010101)))
;; y should be Float32(0x0DAD1995 [Rational(11344277, 10633823966279326983230456482242756608), 0.000000])
...
(assert (= result (fp #b0 #b10011011 #b01011010001100110010100)))
(check-sat)
(exit)
