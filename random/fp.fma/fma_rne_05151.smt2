...
(assert (= z (fp #b0 #b10010010 #b00111000010001100111000)))
;; z should be Float32(0x491C2338 [Rational(1279079, 2), 639539.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010010 #b00111000010001100111000)))
(check-sat)
(exit)
