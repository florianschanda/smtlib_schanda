...
(assert (= y (fp #b1 #b11111111 #b01101010011100100010101)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b00000000 #b10101000011100110011111)))
;; z should be Float32(0x8054399F [Rational(-5519775, 713623846352979940529142984724747568191373312), -0.000000])
