...
(assert (= z (fp #b0 #b10010101 #b11101001011100010000011)))
;; z should be Float32(0x4AF4B883 [Rational(16038019, 2), 8019009.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b11101001011100010000011)))
(check-sat)
(exit)
