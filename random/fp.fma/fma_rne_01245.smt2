...
(assert (= y (fp #b0 #b00000000 #b11111011001011000101010)))
;; y should be Float32(0x007D962A [Rational(4115221, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x407B2C53))))
(check-sat)
(exit)
