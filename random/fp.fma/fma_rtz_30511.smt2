...
(assert (= x (fp #b0 #b00000000 #b11100111111000100100001)))
;; x should be Float32(0x0073F121 [Rational(7598369, 713623846352979940529142984724747568191373312), 0.000000])
