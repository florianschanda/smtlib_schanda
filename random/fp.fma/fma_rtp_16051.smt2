...
(assert (= y (fp #b0 #b00000000 #b00000101001000001101011)))
;; y should be Float32(0x0002906B [Rational(168043, 713623846352979940529142984724747568191373312), 0.000000])
