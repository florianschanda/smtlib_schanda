...
(assert (= y (fp #b0 #b10010101 #b00000000111111001010001)))
;; y should be Float32(0x4A807E51 [Rational(8420945, 2), 4210472.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x00403F29))))
(check-sat)
(exit)
