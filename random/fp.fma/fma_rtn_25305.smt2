...
(assert (= y ((_ to_fp 8 24) #x4A800479)))
;; y should be Float32(0x4A800479 [Rational(8389753, 2), 4194876.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b00000000000010001111000))))
(check-sat)
(exit)
