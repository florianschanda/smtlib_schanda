...
(assert (= z (fp #b1 #b10010101 #b10001001010000011110101)))
;; z should be Float32(0xCAC4A0F5 [Rational(-12886261, 2), -6443130.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAC4A0F5))))
(check-sat)
(exit)
