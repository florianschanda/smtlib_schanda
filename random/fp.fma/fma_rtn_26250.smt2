...
(assert (= z (fp #b1 #b10010101 #b00000000110000000011101)))
;; z should be Float32(0xCA80601D [Rational(-8413213, 2), -4206606.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b00000000110000000011101)))
(check-sat)
(exit)
