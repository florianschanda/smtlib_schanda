...
(assert (= z (fp #b0 #b00000000 #b00100010001000110010100)))
;; z should be Float32(0x00111194 [Rational(279653, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x00111194)))
(check-sat)
(exit)
