...
(assert (= x (fp #b0 #b11111111 #b10001100101000110101010)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b01001011 #b00101111000011100011101)))
;; y should be Float32(0xA597871D [Rational(-9930525, 37778931862957161709568), -0.000000])
