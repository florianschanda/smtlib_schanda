...
(assert (= x (fp #b0 #b10010100 #b00000011111110110000010)))
;; x should be Float32(0x4A01FD82 [Rational(4259521, 2), 2129760.500000])
...
(assert (= result (fp #b1 #b00000000 #b01000000111111101100010)))
(check-sat)
(exit)
