...
(assert (= y (fp #b1 #b10010101 #b01011001000010100001011)))
;; y should be Float32(0xCAAC850B [Rational(-11306251, 2), -5653125.500000])
...
(assert (= result (fp #b0 #b00000000 #b10101100100001010000110)))
(check-sat)
(exit)
