...
(assert (= x (fp #b1 #b00000000 #b10001000000100000101000)))
;; x should be Float32(0x80440828 [Rational(-557317, 89202980794122492566142873090593446023921664), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b01001011110110011101111)))
