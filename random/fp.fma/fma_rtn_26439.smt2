...
(assert (= x ((_ to_fp 8 24) #xDC1C700D)))
;; x should be Float32(0xDC1C700D [Rational(-176133190014992384), -176133190014992384.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x9D1C700C))))
(check-sat)
(exit)
