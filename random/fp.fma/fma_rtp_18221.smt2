...
(assert (= y (fp #b0 #b00000000 #b11000001001001000101101)))
;; y should be Float32(0x0060922D [Rational(6328877, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b01011101010101110101101)))
