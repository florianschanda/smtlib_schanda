...
(assert (= z ((_ to_fp 8 24) #xC9E362C4)))
;; z should be Float32(0xC9E362C4 [Rational(-3725489, 2), -1862744.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010011 #b11000110110001011100100))))
(check-sat)
(exit)
