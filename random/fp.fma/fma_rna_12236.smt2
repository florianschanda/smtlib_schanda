...
(assert (= y ((_ to_fp 8 24) #xE27F2246)))
;; y should be Float32(0xE27F2246 [Rational(-1176597350060398739456), -1176597350060398739456.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFF8BED14)))
