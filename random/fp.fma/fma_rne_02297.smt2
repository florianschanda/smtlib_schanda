...
(assert (= z (fp #b1 #b01011010 #b10001010001001110101110)))
;; z should be Float32(0xAD4513AE [Rational(-6457815, 576460752303423488), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b01011010 #b10001010001001110101110))))
(check-sat)
(exit)
