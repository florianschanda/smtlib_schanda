...
(assert (= x (fp #b1 #b00000000 #b01110001111101111000111)))
;; x should be Float32(0x8038FBC7 [Rational(-3734471, 713623846352979940529142984724747568191373312), -0.000000])
