...
(assert (= y ((_ to_fp 8 24) #x4AAE85AB)))
;; y should be Float32(0x4AAE85AB [Rational(11437483, 2), 5718741.500000])
...
(assert (= result (fp #b0 #b00010111 #b01011101000010110101001)))
(check-sat)
(exit)
