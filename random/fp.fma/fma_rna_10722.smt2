...
(assert (= x ((_ to_fp 8 24) #xCA995B01)))
;; x should be Float32(0xCA995B01 [Rational(-10050305, 2), -5025152.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00110010101101100000010))))
(check-sat)
(exit)
