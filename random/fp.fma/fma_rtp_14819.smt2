...
(assert (= z (fp #b1 #b00000000 #b00000010000111100110111)))
;; z should be Float32(0x80010F37 [Rational(-69431, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b00000010000111100110111)))
(check-sat)
(exit)
