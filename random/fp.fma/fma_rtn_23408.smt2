...
(assert (= x (fp #b0 #b00000100 #b10100000111100011011101)))
;; x should be Float32(0x025078DD [Rational(13662429, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b10011000101101010000001)))
