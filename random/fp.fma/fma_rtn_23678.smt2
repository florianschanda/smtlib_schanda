...
(assert (= x (fp #b0 #b00000000 #b01100011111110100000010)))
;; x should be Float32(0x0031FD02 [Rational(1638017, 356811923176489970264571492362373784095686656), 0.000000])
