...
(assert (= y (fp #b0 #b10010100 #b10010111110101101001110)))
;; y should be Float32(0x4A4BEB4E [Rational(6682023, 2), 3341011.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x00B2FAD2))))
(check-sat)
(exit)
