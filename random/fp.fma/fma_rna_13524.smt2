...
(assert (= x ((_ to_fp 8 24) #x7F8D6C18)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b00000000 #b11101011101101000010001)))
;; y should be Float32(0x0075DA11 [Rational(7723537, 713623846352979940529142984724747568191373312), 0.000000])
