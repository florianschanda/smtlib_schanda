...
(assert (= y ((_ to_fp 8 24) #x96909869)))
;; y should be Float32(0x96909869 [Rational(-9476201, 40564819207303340847894502572032), -0.000000])
...
(assert (not (= result (fp #b0 #b10101101 #b00100001001100001101000))))
(check-sat)
(exit)
