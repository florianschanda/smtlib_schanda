...
(assert (= z (fp #b0 #b10010100 #b00110110110010010010110)))
;; z should be Float32(0x4A1B6496 [Rational(5091915, 2), 2545957.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A1B6496))))
(check-sat)
(exit)
