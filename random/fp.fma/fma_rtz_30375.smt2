...
(assert (= x (fp #b0 #b00000000 #b00001001101101100001110)))
;; x should be Float32(0x0004DB0E [Rational(159111, 356811923176489970264571492362373784095686656), 0.000000])
