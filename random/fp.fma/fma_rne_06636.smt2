...
(assert (= x ((_ to_fp 8 24) #x7FADB2BF)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x151ECD77)))
;; y should be Float32(0x151ECD77 [Rational(10407287, 324518553658426726783156020576256), 0.000000])
