...
(assert (= y (fp #b0 #b11111111 #b01110101000011011101101)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x2B6D8DE2)))
;; z should be Float32(0x2B6D8DE2 [Rational(7784177, 9223372036854775808), 0.000000])
