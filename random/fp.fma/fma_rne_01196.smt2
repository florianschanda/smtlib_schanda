...
(assert (= z ((_ to_fp 8 24) #x8060DECB)))
;; z should be Float32(0x8060DECB [Rational(-6348491, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x407FFFFF)))
(check-sat)
(exit)
