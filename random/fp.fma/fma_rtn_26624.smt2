...
(assert (= x ((_ to_fp 8 24) #xECD7687C)))
;; x should be Float32(0xECD7687C [Rational(-2083299717821030845187620864), -2083299717821030845187620864.000000])
...
(assert (= result ((_ to_fp 8 24) #x2DD7687C)))
(check-sat)
(exit)
