...
(assert (= y ((_ to_fp 8 24) #x4AFFCF57)))
;; y should be Float32(0x4AFFCF57 [Rational(16764759, 2), 8382379.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11111111100111101010101))))
(check-sat)
(exit)
