...
(assert (= z (fp #b0 #b10010011 #b11010000001011110110100)))
;; z should be Float32(0x49E817B4 [Rational(3802605, 2), 1901302.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x49E817B4))))
(check-sat)
(exit)
