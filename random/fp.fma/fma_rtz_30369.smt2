...
(assert (= x (fp #b0 #b00000000 #b01111001110100110010100)))
;; x should be Float32(0x003CE994 [Rational(997989, 178405961588244985132285746181186892047843328), 0.000000])
