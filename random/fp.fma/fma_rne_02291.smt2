...
(assert (= z (fp #b1 #b10010101 #b01001111011100000001101)))
;; z should be Float32(0xCAA7B80D [Rational(-10991629, 2), -5495814.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b01001111011100000001101)))
(check-sat)
(exit)
