...
(assert (= x (fp #b1 #b10010101 #b11110011101110010000001)))
;; x should be Float32(0xCAF9DC81 [Rational(-16374913, 2), -8187456.500000])
...
(assert (= result (fp #b1 #b00010111 #b11110011101110010000001)))
(check-sat)
(exit)
