...
(assert (= x (fp #b1 #b10010011 #b11011111011110010010100)))
;; x should be Float32(0xC9EFBC94 [Rational(-3927845, 2), -1963922.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0AEFBC8A))))
(check-sat)
(exit)
