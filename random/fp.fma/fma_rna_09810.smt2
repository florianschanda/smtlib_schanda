...
(assert (= x (fp #b0 #b00000000 #b11111010110011111000110)))
;; x should be Float32(0x007D67C6 [Rational(4109283, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x407ACF8B))))
(check-sat)
(exit)
