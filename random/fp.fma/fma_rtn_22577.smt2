...
(assert (= y (fp #b1 #b10010100 #b10101011000100001100010)))
;; y should be Float32(0xCA558862 [Rational(-6997041, 2), -3498520.500000])
...
(assert (= result (fp #b1 #b00010110 #b10101011000100001011111)))
(check-sat)
(exit)
