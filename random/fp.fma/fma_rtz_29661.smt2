...
(assert (= z ((_ to_fp 8 24) #x489495F0)))
;; z should be Float32(0x489495F0 [Rational(608607, 2), 304303.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010001 #b00101001001010111110000))))
(check-sat)
(exit)
