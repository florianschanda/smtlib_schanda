...
(assert (= z (fp #b1 #b00110111 #b11111001000010010110100)))
;; z should be Float32(0x9BFC84B4 [Rational(-4137261, 9903520314283042199192993792), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00110111 #b11111001000010010110100))))
(check-sat)
(exit)
