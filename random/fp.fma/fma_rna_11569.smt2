...
(assert (= z ((_ to_fp 8 24) #x8E00CEC6)))
;; z should be Float32(0x8E00CEC6 [Rational(-4220771, 2658455991569831745807614120560689152), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x8E00CEC6)))
(check-sat)
(exit)
