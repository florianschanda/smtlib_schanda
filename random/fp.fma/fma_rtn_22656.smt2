...
(assert (= z ((_ to_fp 8 24) #x732995BD)))
;; z should be Float32(0x732995BD [Rational(13435901218353960633462939451392), 13435901218353960633462939451392.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b11100110 #b01010011001010110111100))))
(check-sat)
(exit)
