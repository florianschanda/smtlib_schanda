...
(assert (= x ((_ to_fp 8 24) #xB6E0ECB2)))
;; x should be Float32(0xB6E0ECB2 [Rational(-7370329, 1099511627776), -0.000007])
...
(assert (not (= result (fp #b1 #b11101101 #b11000001110110010110001))))
(check-sat)
(exit)
