...
(assert (= z (fp #b1 #b10010100 #b00101110111101011111110)))
;; z should be Float32(0xCA177AFE [Rational(-4963711, 2), -2481855.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA177AEE))))
(check-sat)
(exit)
