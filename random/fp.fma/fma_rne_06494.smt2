...
(assert (= x ((_ to_fp 8 24) #x8000459D)))
;; x should be Float32(0x8000459D [Rational(-17821, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b00001001011011011111101)))
