...
(assert (= z (fp #b1 #b00000000 #b00010110110001010010010)))
;; z should be Float32(0x800B6292 [Rational(-373065, 356811923176489970264571492362373784095686656), -0.000000])
