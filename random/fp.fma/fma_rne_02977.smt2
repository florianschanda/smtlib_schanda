...
(assert (= x (fp #b0 #b00000000 #b00110000110111001110110)))
;; x should be Float32(0x00186E76 [Rational(800571, 356811923176489970264571492362373784095686656), 0.000000])
