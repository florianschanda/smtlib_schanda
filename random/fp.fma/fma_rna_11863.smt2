...
(assert (= y (fp #b1 #b10100010 #b11000010011001100101011)))
;; y should be Float32(0xD161332B [Rational(-60451631104), -60451631104.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x12613329))))
(check-sat)
(exit)
