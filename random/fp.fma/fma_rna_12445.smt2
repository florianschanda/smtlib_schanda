...
(assert (= y ((_ to_fp 8 24) #x00348E45)))
;; y should be Float32(0x00348E45 [Rational(3444293, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FE118C9)))
