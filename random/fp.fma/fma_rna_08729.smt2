...
(assert (= z (fp #b0 #b11101101 #b00110011011010000011111)))
;; z should be Float32(0x7699B41F [Rational(1558739666323288808663948913016832), 1558739666323288808663948913016832.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x7699B41F))))
(check-sat)
(exit)
