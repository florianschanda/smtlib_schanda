...
(assert (= x (fp #b0 #b00000000 #b01010001101011100101010)))
;; x should be Float32(0x0028D72A [Rational(1338261, 356811923176489970264571492362373784095686656), 0.000000])
