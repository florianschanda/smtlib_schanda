...
(assert (= x (fp #b1 #b00000000 #b10100110101101011101011)))
;; x should be Float32(0x80535AEB [Rational(-5462763, 713623846352979940529142984724747568191373312), -0.000000])
