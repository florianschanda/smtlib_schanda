...
(assert (= z ((_ to_fp 8 24) #x870BB3FF)))
;; z should be Float32(0x870BB3FF [Rational(-9155583, 87112285931760246646623899502532662132736), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b00001110 #b00010111011001111111111)))
(check-sat)
(exit)
