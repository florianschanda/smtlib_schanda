...
(assert (= y ((_ to_fp 8 24) #xCAED6705)))
;; y should be Float32(0xCAED6705 [Rational(-15558405, 2), -7779202.500000])
...
(assert (not (= result (fp #b0 #b00000000 #b00010010100110001111110))))
(check-sat)
(exit)
