...
(assert (= x (fp #b0 #b00000000 #b00011000011001111110110)))
;; x should be Float32(0x000C33F6 [Rational(399867, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b11011111110101010110010)))
