...
(assert (= z ((_ to_fp 8 24) #x00072E5A)))
;; z should be Float32(0x00072E5A [Rational(235309, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b00000000 #b00001110010111001011010))))
(check-sat)
(exit)
