...
(assert (= z (fp #b1 #b10010011 #b10011010010111101111100)))
;; z should be Float32(0xC9CD2F7C [Rational(-3361759, 2), -1680879.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010011 #b10011010010111101111101)))
(check-sat)
(exit)
