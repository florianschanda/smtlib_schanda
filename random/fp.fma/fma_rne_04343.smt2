...
(assert (= z (fp #b1 #b10010100 #b11000101001001100001110)))
;; z should be Float32(0xCA62930E [Rational(-7424391, 2), -3712195.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA62930E))))
(check-sat)
(exit)
