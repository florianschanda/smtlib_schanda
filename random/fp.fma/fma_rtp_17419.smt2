...
(assert (= x ((_ to_fp 8 24) #xCAF304FD)))
;; x should be Float32(0xCAF304FD [Rational(-15926525, 2), -7963262.500000])
...
(assert (= result (fp #b1 #b00010111 #b11100110000010011111101)))
(check-sat)
(exit)
