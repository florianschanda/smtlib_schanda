...
(assert (= x (fp #b1 #b11100101 #b00111110000100010110111)))
;; x should be Float32(0xF29F08B7 [Rational(-6299987476635794957531128791040), -6299987476635794957531128791040.000000])
