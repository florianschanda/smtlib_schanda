...
(assert (= z (fp #b0 #b10010010 #b01101101011100001001000)))
;; z should be Float32(0x4936B848 [Rational(1496841, 2), 748420.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010010 #b01101101011100001001000)))
(check-sat)
(exit)
