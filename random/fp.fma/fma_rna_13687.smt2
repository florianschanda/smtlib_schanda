...
(assert (= x (fp #b1 #b11111111 #b00000001010011111100001)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x8059CC79)))
;; y should be Float32(0x8059CC79 [Rational(-5885049, 713623846352979940529142984724747568191373312), -0.000000])
