...
(assert (= x (fp #b1 #b11111111 #b10100011100011010001100)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b10010101 #b11100101110111101010001)))
;; y should be Float32(0xCAF2EF51 [Rational(-15920977, 2), -7960488.500000])
