...
(assert (= x (fp #b1 #b10010001 #b10010100111000001110000)))
;; x should be Float32(0xC8CA7070 [Rational(-829191, 2), -414595.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x09CA7070))))
(check-sat)
(exit)
