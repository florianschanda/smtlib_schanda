...
(assert (= z ((_ to_fp 8 24) #x0040E41E)))
;; z should be Float32(0x0040E41E [Rational(2126351, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b00000000 #b10000001110010000011110)))
(check-sat)
(exit)
