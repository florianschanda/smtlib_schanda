...
(assert (= x (fp #b1 #b00000000 #b01110100000011010010101)))
;; x should be Float32(0x803A0695 [Rational(-3802773, 713623846352979940529142984724747568191373312), -0.000000])
