...
(assert (= z (fp #b1 #b10010101 #b10111100001111010110001)))
;; z should be Float32(0xCADE1EB1 [Rational(-14556849, 2), -7278424.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10111100001111010110001))))
(check-sat)
(exit)
