...
(assert (= x (fp #b0 #b00000000 #b10100110000000000100111)))
;; x should be Float32(0x00530027 [Rational(5439527, 713623846352979940529142984724747568191373312), 0.000000])
