...
(assert (= x ((_ to_fp 8 24) #x807E23CA)))
;; x should be Float32(0x807E23CA [Rational(-4133349, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x407C4793))))
(check-sat)
(exit)
