...
(assert (= x (fp #b0 #b10010101 #b10001010000101001110011)))
;; x should be Float32(0x4AC50A73 [Rational(12913267, 2), 6456633.500000])
...
(assert (= result (fp #b0 #b00010111 #b10001010000101001110101)))
(check-sat)
(exit)
