...
(assert (= z ((_ to_fp 8 24) #xCAEF7DE9)))
;; z should be Float32(0xCAEF7DE9 [Rational(-15695337, 2), -7847668.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b11011110111110111101001)))
(check-sat)
(exit)
