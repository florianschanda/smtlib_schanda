...
(assert (= x (fp #b1 #b11010110 #b11001001001100101101001)))
;; x should be Float32(0xEB649969 [Rational(-276359545852142247053623296), -276359545852142247053623296.000000])
