...
(assert (= z ((_ to_fp 8 24) #x0019E3B4)))
;; z should be Float32(0x0019E3B4 [Rational(424173, 178405961588244985132285746181186892047843328), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0019E3B4))))
(check-sat)
(exit)
