...
(assert (= z ((_ to_fp 8 24) #x1F6B1F43)))
;; z should be Float32(0x1F6B1F43 [Rational(15408963, 309485009821345068724781056), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00111110 #b11010110001111101000011)))
(check-sat)
(exit)
