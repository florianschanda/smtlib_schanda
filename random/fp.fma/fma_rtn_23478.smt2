...
(assert (= x (fp #b0 #b00000000 #b00001001000010110000111)))
;; x should be Float32(0x00048587 [Rational(296327, 713623846352979940529142984724747568191373312), 0.000000])
