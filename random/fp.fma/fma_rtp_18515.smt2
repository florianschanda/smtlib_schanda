...
(assert (= z ((_ to_fp 8 24) #x002B23FD)))
;; z should be Float32(0x002B23FD [Rational(2827261, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x002B23FD))))
(check-sat)
(exit)
