...
(assert (= z ((_ to_fp 8 24) #x92A983D5)))
;; z should be Float32(0x92A983D5 [Rational(-11109333, 10384593717069655257060992658440192), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00100101 #b01010011000001111010101)))
(check-sat)
(exit)
