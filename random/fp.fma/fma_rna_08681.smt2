...
(assert (= z (fp #b1 #b01100111 #b01011111011101101010000)))
;; z should be Float32(0xB3AFBB50 [Rational(-719797, 8796093022208), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b01100111 #b01011111011101101010000))))
(check-sat)
(exit)
