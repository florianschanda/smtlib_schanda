...
(assert (= x (fp #b1 #b00000101 #b01011100101011101100110)))
;; x should be Float32(0x82AE5766 [Rational(-5712819, 22300745198530623141535718272648361505980416), -0.000000])
