...
(assert (= x (fp #b0 #b00000000 #b11011110010111101010110)))
;; x should be Float32(0x006F2F56 [Rational(3643307, 356811923176489970264571492362373784095686656), 0.000000])
