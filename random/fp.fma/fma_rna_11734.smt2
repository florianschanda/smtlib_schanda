...
(assert (= z (fp #b1 #b10010101 #b01010110000100000010101)))
;; z should be Float32(0xCAAB0815 [Rational(-11208725, 2), -5604362.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b10010101 #b01010110000100000010101)))
(check-sat)
(exit)
