...
(assert (= y (fp #b0 #b10010100 #b01001110101000010001110)))
;; y should be Float32(0x4A27508E [Rational(5482567, 2), 2741283.500000])
...
(assert (= result (fp #b1 #b00010110 #b01001110101000010001100)))
(check-sat)
(exit)
