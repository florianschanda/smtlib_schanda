...
(assert (= z (fp #b0 #b00000000 #b10010101010011101100010)))
;; z should be Float32(0x004AA762 [Rational(2446257, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x004AA762)))
(check-sat)
(exit)
