...
(assert (= x (fp #b1 #b00000000 #b11001011111111001000010)))
;; x should be Float32(0x8065FE42 [Rational(-3342113, 356811923176489970264571492362373784095686656), -0.000000])
