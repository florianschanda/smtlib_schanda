...
(assert (= z (fp #b1 #b10010011 #b01010101011101111100100)))
;; z should be Float32(0xC9AABBE4 [Rational(-2797305, 2), -1398652.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC9AABBE4))))
(check-sat)
(exit)
