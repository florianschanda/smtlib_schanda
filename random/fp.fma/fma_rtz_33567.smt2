...
(assert (= x (fp #b1 #b10110100 #b10110110101100111111111)))
;; x should be Float32(0xDA5B59FF [Rational(-15435492912791552), -15435492912791552.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b11001010001011011101101)))
