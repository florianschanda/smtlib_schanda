...
(assert (= z (fp #b1 #b10010101 #b01100111010011000110111)))
;; z should be Float32(0xCAB3A637 [Rational(-11773495, 2), -5886747.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b01100111010011000101111)))
(check-sat)
(exit)
