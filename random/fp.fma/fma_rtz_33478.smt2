...
(assert (= x (fp #b1 #b10110101 #b00110110011101001100110)))
;; x should be Float32(0xDA9B3A66 [Rational(-21846415575613440), -21846415575613440.000000])
...
(assert (= z (fp #b0 #b11111111 #b01101101010010010111101)))
