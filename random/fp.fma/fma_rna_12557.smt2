...
(assert (= z (fp #b1 #b01001010 #b01110011010001000110111)))
;; z should be Float32(0xA539A237 [Rational(-12165687, 75557863725914323419136), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b01001010 #b01110011010001000110111))))
(check-sat)
(exit)
