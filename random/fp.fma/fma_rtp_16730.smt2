...
(assert (= x (fp #b0 #b00000000 #b00001011011001100111111)))
;; x should be Float32(0x0005B33F [Rational(373567, 713623846352979940529142984724747568191373312), 0.000000])
