...
(assert (= z ((_ to_fp 8 24) #x6BBB3B11)))
;; z should be Float32(0x6BBB3B11 [Rational(452696122970148435600080896), 452696122970148435600080896.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x6BBB3B11)))
(check-sat)
(exit)
