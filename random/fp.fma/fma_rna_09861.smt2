...
(assert (= x ((_ to_fp 8 24) #x007EA307)))
;; x should be Float32(0x007EA307 [Rational(8299271, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z (fp #b1 #b11111111 #b10000111100011111111000)))
