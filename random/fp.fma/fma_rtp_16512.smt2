...
(assert (= x (fp #b0 #b10111110 #b10011101011110001100110)))
;; x should be Float32(0x5F4EBC66 [Rational(14896893817620791296), 14896893817620791296.000000])
...
(assert (= result ((_ to_fp 8 24) #xA04EBC66)))
(check-sat)
(exit)
