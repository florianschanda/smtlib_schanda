...
(assert (= x (fp #b0 #b00111100 #b10011101001111000101000)))
;; x should be Float32(0x1E4E9E28 [Rational(1692613, 154742504910672534362390528), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFE1EBB2)))
