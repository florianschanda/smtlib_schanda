...
(assert (= x ((_ to_fp 8 24) #xDB96B3E1)))
;; x should be Float32(0xDB96B3E1 [Rational(-84838050911223808), -84838050911223808.000000])
...
(assert (not (= result (fp #b0 #b00111001 #b00101101011001111100000))))
(check-sat)
(exit)
