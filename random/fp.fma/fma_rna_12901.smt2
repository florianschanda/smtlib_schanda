...
(assert (= x (fp #b1 #b00110010 #b01110101011110001111111)))
;; x should be Float32(0x993ABC7F [Rational(-12237951, 1267650600228229401496703205376), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FA23089)))
