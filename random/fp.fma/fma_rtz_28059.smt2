...
(assert (= x (fp #b0 #b10010000 #b00100001111001110100000)))
;; x should be Float32(0x4810F3A0 [Rational(296861, 2), 148430.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8910F3DE))))
(check-sat)
(exit)
