...
(assert (= z (fp #b0 #b10010100 #b10101100001111111010110)))
;; z should be Float32(0x4A561FD6 [Rational(7016427, 2), 3508213.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010100 #b10101100001111111000111))))
(check-sat)
(exit)
