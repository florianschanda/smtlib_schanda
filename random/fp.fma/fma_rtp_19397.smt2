...
(assert (= z (fp #b1 #b11001010 #b11111101001101010111101)))
;; z should be Float32(0xE57E9ABD [Rational(-75145969007594645225472), -75145969007594645225472.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b11001010 #b11111101001101010111100))))
(check-sat)
(exit)
