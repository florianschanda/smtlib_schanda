...
(assert (= x ((_ to_fp 8 24) #x2955775F)))
;; x should be Float32(0x2955775F [Rational(13989727, 295147905179352825856), 0.000000])
...
(assert (= result (fp #b0 #b11010010 #b10101010111011101011110)))
(check-sat)
(exit)
