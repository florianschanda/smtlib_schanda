...
(assert (= x ((_ to_fp 8 24) #x0026736B)))
;; x should be Float32(0x0026736B [Rational(2519915, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= z (fp #b0 #b11111111 #b00110101001100111010011)))
