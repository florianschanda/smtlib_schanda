...
(assert (= z (fp #b1 #b10010100 #b11100101110110100100010)))
;; z should be Float32(0xCA72ED22 [Rational(-7960209, 2), -3980104.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCA72ED22))))
(check-sat)
(exit)
