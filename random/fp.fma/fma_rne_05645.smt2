...
(assert (= z ((_ to_fp 8 24) #x4AC69721)))
;; z should be Float32(0x4AC69721 [Rational(13014817, 2), 6507408.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10010101 #b10001101001011100100001)))
(check-sat)
(exit)
