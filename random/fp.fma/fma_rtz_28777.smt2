...
(assert (= z (fp #b1 #b10010101 #b10001100100100010101101)))
;; z should be Float32(0xCAC648AD [Rational(-12994733, 2), -6497366.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAC648B4))))
(check-sat)
(exit)
