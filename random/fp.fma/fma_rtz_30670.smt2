...
(assert (= x ((_ to_fp 8 24) #x007975D3)))
;; x should be Float32(0x007975D3 [Rational(7960019, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7FBF909D)))
