...
(assert (= x (fp #b1 #b00101010 #b00111010011001000100010)))
;; x should be Float32(0x951D3222 [Rational(-5150993, 162259276829213363391578010288128), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10111100100101100101001)))
