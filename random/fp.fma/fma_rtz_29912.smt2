...
(assert (= y (fp #b1 #b11010110 #b01111000010000100101110)))
;; y should be Float32(0xEB3C212E [Rational(-227434740731712373776187392), -227434740731712373776187392.000000])
...
(assert (= result (fp #b1 #b01000001 #b01111000010000100101101)))
(check-sat)
(exit)
