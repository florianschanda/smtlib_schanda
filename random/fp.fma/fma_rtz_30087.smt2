...
(assert (= x ((_ to_fp 8 24) #x6A1DAC0B)))
;; x should be Float32(0x6A1DAC0B [Rational(47653450907183792552673280), 47653450907183792552673280.000000])
...
(assert (= result ((_ to_fp 8 24) #x1F9DAC0B)))
(check-sat)
(exit)
