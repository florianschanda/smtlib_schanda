...
(assert (= y (fp #b0 #b10010101 #b10111100010000111111011)))
;; y should be Float32(0x4ADE21FB [Rational(14557691, 2), 7278845.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x006F10FD))))
(check-sat)
(exit)
