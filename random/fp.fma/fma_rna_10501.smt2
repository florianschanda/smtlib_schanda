...
(assert (= x ((_ to_fp 8 24) #xC9CB6D3C)))
;; x should be Float32(0xC9CB6D3C [Rational(-3332943, 2), -1666471.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4ACAF409)))
;; y should be Float32(0x4ACAF409 [Rational(13300745, 2), 6650372.500000])
