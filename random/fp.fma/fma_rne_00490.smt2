...
(assert (= x (fp #b0 #b10010100 #b11000110001111001100110)))
;; x should be Float32(0x4A631E66 [Rational(7442227, 2), 3721113.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x80473866))))
(check-sat)
(exit)
