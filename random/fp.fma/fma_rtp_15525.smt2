...
(assert (= z (fp #b0 #b10010101 #b00110111001101111000011)))
;; z should be Float32(0x4A9B9BC3 [Rational(10197955, 2), 5098977.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b00110111001101111000011))))
(check-sat)
(exit)
