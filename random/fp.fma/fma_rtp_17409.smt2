...
(assert (= x (fp #b1 #b10010101 #b10100000011011111111101)))
;; x should be Float32(0xCAD037FD [Rational(-13645821, 2), -6822910.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BD037F9)))
(check-sat)
(exit)
