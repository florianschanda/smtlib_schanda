...
(assert (= y (fp #b1 #b11101110 #b11000001000001111010101)))
;; y should be Float32(0xF76083D5 [Rational(-4553704560814434749688576923926528), -4553704560814434749688576923926528.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB86083D6))))
(check-sat)
(exit)
