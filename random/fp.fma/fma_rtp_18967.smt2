...
(assert (= y (fp #b1 #b10010101 #b01010010000001110001011)))
;; y should be Float32(0xCAA9038B [Rational(-11076491, 2), -5538245.500000])
...
(assert (= result (fp #b0 #b00010111 #b01010010000001110001101)))
(check-sat)
(exit)
