...
(assert (= z (fp #b0 #b00000000 #b11111001000111101001100)))
;; z should be Float32(0x007C8F4C [Rational(2040787, 178405961588244985132285746181186892047843328), 0.000000])
