...
(assert (= x ((_ to_fp 8 24) #x4AD7D289)))
;; x should be Float32(0x4AD7D289 [Rational(14144137, 2), 7072068.500000])
...
(assert (= result (fp #b1 #b00010111 #b10101111101001010001001)))
(check-sat)
(exit)
