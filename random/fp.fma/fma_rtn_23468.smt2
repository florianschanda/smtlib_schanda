...
(assert (= x (fp #b0 #b00000000 #b11011000010001100000111)))
;; x should be Float32(0x006C2307 [Rational(7086855, 713623846352979940529142984724747568191373312), 0.000000])
