...
(assert (= x (fp #b1 #b10010101 #b10010110010110110010111)))
;; x should be Float32(0xCACB2D97 [Rational(-13315479, 2), -6657739.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BCB2D95)))
(check-sat)
(exit)
