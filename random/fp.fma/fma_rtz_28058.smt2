...
(assert (= x (fp #b0 #b10010101 #b11001100001000111001001)))
;; x should be Float32(0x4AE611C9 [Rational(15077833, 2), 7538916.500000])
...
(assert (= result (fp #b1 #b00010111 #b11001100001000111001001)))
(check-sat)
(exit)
