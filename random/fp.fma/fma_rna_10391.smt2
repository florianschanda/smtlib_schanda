...
(assert (= z (fp #b1 #b01111001 #b01100000011100110010111)))
;; z should be Float32(0xBCB03997 [Rational(-11549079, 536870912), -0.021512])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #xBCB03997)))
(check-sat)
(exit)
