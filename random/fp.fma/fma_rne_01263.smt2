...
(assert (= z (fp #b0 #b00000000 #b10000100010011100100111)))
;; z should be Float32(0x00422727 [Rational(4335399, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x00422727))))
(check-sat)
(exit)
