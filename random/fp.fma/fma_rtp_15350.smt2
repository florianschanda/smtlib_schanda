...
(assert (= z ((_ to_fp 8 24) #xC8E0B7A9)))
;; z should be Float32(0xC8E0B7A9 [Rational(-14727081, 32), -460221.281250])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010001 #b11000001011011110101001)))
(check-sat)
(exit)
