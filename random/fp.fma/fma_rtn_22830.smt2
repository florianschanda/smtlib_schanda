...
(assert (= z (fp #b1 #b10010100 #b11000001011111101101110)))
;; z should be Float32(0xCA60BF6E [Rational(-7364535, 2), -3682267.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010100 #b11000001011111101101110)))
(check-sat)
(exit)
