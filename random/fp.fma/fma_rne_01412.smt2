...
(assert (= y (fp #b1 #b00000000 #b01010101010000010001101)))
;; y should be Float32(0x802AA08D [Rational(-2793613, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b01111111 #b01010101000001000110011))))
(check-sat)
(exit)
