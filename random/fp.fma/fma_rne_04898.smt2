...
(assert (= y (fp #b1 #b10010100 #b01001111001010010010010)))
;; y should be Float32(0xCA279492 [Rational(-5491273, 2), -2745636.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b01001111001010010001101))))
(check-sat)
(exit)
