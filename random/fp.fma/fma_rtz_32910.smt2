...
(assert (= z (fp #b0 #b10010001 #b10100000110011101010000)))
;; z should be Float32(0x48D06750 [Rational(853621, 2), 426810.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010001 #b10100000110011101001111)))
(check-sat)
(exit)
