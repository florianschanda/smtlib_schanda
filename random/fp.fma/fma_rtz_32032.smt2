...
(assert (= z (fp #b1 #b01101010 #b10000101001101010111110)))
;; z should be Float32(0xB5429ABE [Rational(-6376799, 8796093022208), -0.000001])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10000000 #b11111111111111111111001))))
(check-sat)
(exit)
