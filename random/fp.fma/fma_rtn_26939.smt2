...
(assert (= x (fp #b1 #b00000000 #b00100101100001000000010)))
;; x should be Float32(0x8012C202 [Rational(-614657, 356811923176489970264571492362373784095686656), -0.000000])
