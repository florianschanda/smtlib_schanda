...
(assert (= y ((_ to_fp 8 24) #xCAB3F45D)))
;; y should be Float32(0xCAB3F45D [Rational(-11793501, 2), -5896750.500000])
...
(assert (not (= result (fp #b0 #b00000001 #b10110011111101000101110))))
(check-sat)
(exit)
