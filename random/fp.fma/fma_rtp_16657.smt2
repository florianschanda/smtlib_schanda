...
(assert (= x (fp #b0 #b00000000 #b00010011001101000110110)))
;; x should be Float32(0x00099A36 [Rational(314651, 356811923176489970264571492362373784095686656), 0.000000])
