...
(assert (= z (fp #b0 #b00011010 #b10011100010110101011101)))
;; z should be Float32(0x0D4E2D5D [Rational(13512029, 21267647932558653966460912964485513216), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00011010 #b10011100010110101011101)))
(check-sat)
(exit)
