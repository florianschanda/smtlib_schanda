...
(assert (= z ((_ to_fp 8 24) #x7E3A0334)))
;; z should be Float32(0x7E3A0334 [Rational(61813259697967336682463937489549656064), 61813259697967336682463937489549656064.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b11111100 #b01110100000001100110011)))
(check-sat)
(exit)
