...
(assert (= x (fp #b1 #b10111001 #b11101011111111000111001)))
;; x should be Float32(0xDCF5FE39 [Rational(-553927120485613568), -553927120485613568.000000])
...
(assert (= result ((_ to_fp 8 24) #x9DF5FE39)))
(check-sat)
(exit)
