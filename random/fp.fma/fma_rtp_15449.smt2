...
(assert (= z (fp #b0 #b10010000 #b00101110010011001100000)))
;; z should be Float32(0x48172660 [Rational(309555, 2), 154777.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010000 #b00101110010011001100000))))
(check-sat)
(exit)
