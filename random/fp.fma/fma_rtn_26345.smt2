...
(assert (= y (fp #b1 #b11111111 #b00111011001011010011110)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z (fp #b1 #b10010010 #b01001101101100100011000)))
;; z should be Float32(0xC926D918 [Rational(-1366819, 2), -683409.500000])
