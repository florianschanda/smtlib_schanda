...
(assert (= z ((_ to_fp 8 24) #xFE9E2E48)))
;; z should be Float32(0xFE9E2E48 [Rational(-105129164661500386454992221278765580288), -105129164661500386454992221278765580288.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b11111101 #b00111100010111001001000)))
(check-sat)
(exit)
