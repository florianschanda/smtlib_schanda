...
(assert (= y (fp #b0 #b00000000 #b01001101011100011110111)))
;; y should be Float32(0x0026B8F7 [Rational(2537719, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBF9AE3DB)))
(check-sat)
(exit)
