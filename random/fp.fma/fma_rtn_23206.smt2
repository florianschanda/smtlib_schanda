...
(assert (= x ((_ to_fp 8 24) #x43206905)))
;; x should be Float32(0x43206905 [Rational(10512645, 65536), 160.410233])
...
(assert (= result (fp #b0 #b00001000 #b01000000110100100000101)))
(check-sat)
(exit)
