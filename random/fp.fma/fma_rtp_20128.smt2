...
(assert (= x (fp #b1 #b00000000 #b11000010011010100011111)))
;; x should be Float32(0x8061351F [Rational(-6370591, 713623846352979940529142984724747568191373312), -0.000000])
