...
(assert (= y ((_ to_fp 8 24) #xBC45C07E)))
;; y should be Float32(0xBC45C07E [Rational(-6479935, 536870912), -0.012070])
...
(assert (not (= result (fp #b1 #b00000000 #b00000011000101101111111))))
(check-sat)
(exit)
