...
(assert (= x (fp #b0 #b01100100 #b00011011001000101100001)))
;; x should be Float32(0x320D9161 [Rational(9277793, 1125899906842624), 0.000000])
...
(assert (= result (fp #b1 #b11100100 #b00011011001000101100001)))
(check-sat)
(exit)
