...
(assert (= x (fp #b0 #b11111111 #b10000110010011100010011)))
...
(assert (= z (fp #b0 #b00000000 #b00101101001001101100111)))
;; z should be Float32(0x00169367 [Rational(1479527, 713623846352979940529142984724747568191373312), 0.000000])
