...
(assert (= y (fp #b0 #b00000000 #b00101111101110111011011)))
;; y should be Float32(0x0017DDDB [Rational(1564123, 713623846352979940529142984724747568191373312), 0.000000])
