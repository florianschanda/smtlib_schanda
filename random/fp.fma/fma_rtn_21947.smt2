...
(assert (= z (fp #b0 #b10010101 #b00110110100101100010111)))
;; z should be Float32(0x4A9B4B17 [Rational(10177303, 2), 5088651.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b00110110100101100010110)))
(check-sat)
(exit)
