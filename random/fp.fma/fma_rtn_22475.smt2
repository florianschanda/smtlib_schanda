...
(assert (= z (fp #b1 #b11111000 #b10111101101011010110100)))
;; z should be Float32(0xFC5ED6B4 [Rational(-4628178397276663034341046939092516864), -4628178397276663034341046939092516864.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #xFC5ED6B4)))
(check-sat)
(exit)
