...
(assert (= x (fp #b1 #b00000000 #b10000011101011110011101)))
;; x should be Float32(0x8041D79D [Rational(-4315037, 713623846352979940529142984724747568191373312), -0.000000])
