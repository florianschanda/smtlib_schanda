...
(assert (= z (fp #b0 #b11011110 #b10001101000110001110110)))
;; z should be Float32(0x6F468C76 [Rational(61447838798617350310100729856), 61447838798617350310100729856.000000])
