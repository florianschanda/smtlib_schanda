...
(assert (= x (fp #b0 #b10010010 #b01101000000101100101000)))
;; x should be Float32(0x49340B28 [Rational(1474917, 2), 737458.500000])
...
(assert (= z (fp #b0 #b11111111 #b10000011000111100100101)))
