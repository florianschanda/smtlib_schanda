...
(assert (= z (fp #b1 #b10010011 #b00000011110110111101100)))
;; z should be Float32(0xC981EDEC [Rational(-2128763, 2), -1064381.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC981EDEC))))
(check-sat)
(exit)
