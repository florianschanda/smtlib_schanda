...
(assert (= y ((_ to_fp 8 24) #xCA809CC3)))
;; y should be Float32(0xCA809CC3 [Rational(-8428739, 2), -4214369.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b00000001001110011000011))))
(check-sat)
(exit)
