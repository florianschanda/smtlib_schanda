...
(assert (= y ((_ to_fp 8 24) #x59307BFF)))
;; y should be Float32(0x59307BFF [Rational(3104745690497024), 3104745690497024.000000])
...
(assert (not (= result (fp #b1 #b00011101 #b01100000111101111111111))))
(check-sat)
(exit)
