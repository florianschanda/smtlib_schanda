...
(assert (= y (fp #b0 #b00000000 #b11100111100101011111111)))
;; y should be Float32(0x0073CAFF [Rational(7588607, 713623846352979940529142984724747568191373312), 0.000000])
