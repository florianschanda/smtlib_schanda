...
(assert (= x (fp #b0 #b00000000 #b10100111110010111101010)))
;; x should be Float32(0x0053E5EA [Rational(2749173, 356811923176489970264571492362373784095686656), 0.000000])
