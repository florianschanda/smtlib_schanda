...
(assert (= y (fp #b1 #b00000000 #b00100011001100101010100)))
;; y should be Float32(0x80119954 [Rational(-288341, 178405961588244985132285746181186892047843328), -0.000000])
