...
(assert (= z (fp #b1 #b00000000 #b01110100100010110000111)))
;; z should be Float32(0x803A4587 [Rational(-3818887, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x803A4586)))
(check-sat)
(exit)
