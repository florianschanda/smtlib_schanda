...
(assert (= y (fp #b0 #b10001100 #b00111010100100000000010)))
;; y should be Float32(0x461D4802 [Rational(5153793, 512), 10066.001953])
...
(assert (= result (fp #b0 #b00000000 #b00000000010011101010010)))
(check-sat)
(exit)
