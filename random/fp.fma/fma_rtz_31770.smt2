...
(assert (= z ((_ to_fp 8 24) #x4AE37FA5)))
;; z should be Float32(0x4AE37FA5 [Rational(14909349, 2), 7454674.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010101 #b11000110111111110100101)))
(check-sat)
(exit)
