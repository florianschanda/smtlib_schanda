...
(assert (= x (fp #b0 #b00000000 #b01100001110000000101110)))
;; x should be Float32(0x0030E02E [Rational(1601559, 356811923176489970264571492362373784095686656), 0.000000])
