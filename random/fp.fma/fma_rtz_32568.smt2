...
(assert (= z (fp #b0 #b10010101 #b01011100010001000111111)))
;; z should be Float32(0x4AAE223F [Rational(11412031, 2), 5706015.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01011100010001000111110))))
(check-sat)
(exit)
