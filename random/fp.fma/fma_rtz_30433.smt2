...
(assert (= x (fp #b0 #b00000000 #b10001011011011010100100)))
;; x should be Float32(0x0045B6A4 [Rational(1142185, 178405961588244985132285746181186892047843328), 0.000000])
