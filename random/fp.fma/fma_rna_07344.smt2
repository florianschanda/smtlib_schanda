...
(assert (= x (fp #b0 #b10010101 #b01101110110010010100111)))
;; x should be Float32(0x4AB764A7 [Rational(12018855, 2), 6009427.500000])
...
(assert (= result (fp #b0 #b00000000 #b10110111011001001010100)))
(check-sat)
(exit)
