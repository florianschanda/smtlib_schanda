...
(assert (= x (fp #b0 #b00000000 #b10111000101010011100110)))
;; x should be Float32(0x005C54E6 [Rational(3025523, 356811923176489970264571492362373784095686656), 0.000000])
