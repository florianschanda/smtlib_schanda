...
(assert (= z ((_ to_fp 8 24) #x007F8462)))
;; z should be Float32(0x007F8462 [Rational(4178481, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #x007F8462))))
(check-sat)
(exit)
