...
(assert (= y ((_ to_fp 8 24) #xCAECBBC7)))
;; y should be Float32(0xCAECBBC7 [Rational(-15514567, 2), -7757283.500000])
...
(assert (= result (fp #b1 #b00010111 #b11011001011101111000011)))
(check-sat)
(exit)
