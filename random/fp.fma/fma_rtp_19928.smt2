...
(assert (= x (fp #b1 #b00000000 #b10110010100111011000001)))
;; x should be Float32(0x80594EC1 [Rational(-5852865, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC0329D81)))
(check-sat)
(exit)
