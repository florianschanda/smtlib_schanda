...
(assert (= z ((_ to_fp 8 24) #xC8556460)))
;; z should be Float32(0xC8556460 [Rational(-437027, 2), -218513.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b1 #b10010000 #b10101010110010101011111))))
(check-sat)
(exit)
