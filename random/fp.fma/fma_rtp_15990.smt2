...
(assert (= z (fp #b1 #b10010101 #b10100000010000100011011)))
;; z should be Float32(0xCAD0211B [Rational(-13639963, 2), -6819981.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10010101 #b10100000010000100011010)))
(check-sat)
(exit)
