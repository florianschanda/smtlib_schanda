...
(assert (= z ((_ to_fp 8 24) #x48E1DE90)))
;; z should be Float32(0x48E1DE90 [Rational(925161, 2), 462580.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010001 #b11000011101111000010000))))
(check-sat)
(exit)
