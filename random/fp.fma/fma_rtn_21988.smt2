...
(assert (= y ((_ to_fp 8 24) #x80658CA8)))
;; y should be Float32(0x80658CA8 [Rational(-831893, 89202980794122492566142873090593446023921664), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC04B1950)))
(check-sat)
(exit)
