...
(assert (= x (fp #b1 #b01001000 #b11111000000000101001100)))
;; x should be Float32(0xA47C014C [Rational(-4128851, 75557863725914323419136), -0.000000])
...
(assert (= result (fp #b0 #b11001000 #b11111000000000101001100)))
(check-sat)
(exit)
