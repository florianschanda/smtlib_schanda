...
(assert (= z ((_ to_fp 8 24) #x000EB83E)))
;; z should be Float32(0x000EB83E [Rational(482335, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b00011101011100000111110)))
(check-sat)
(exit)
