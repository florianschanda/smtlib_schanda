...
(assert (= x (fp #b1 #b00000000 #b11111010101010000101110)))
;; x should be Float32(0x807D542E [Rational(-4106775, 356811923176489970264571492362373784095686656), -0.000000])
