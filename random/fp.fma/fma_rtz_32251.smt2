...
(assert (= z (fp #b0 #b10110111 #b00101010010011101001010)))
;; z should be Float32(0x5B95274A [Rational(83965940621901824), 83965940621901824.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x5B952749)))
(check-sat)
(exit)
