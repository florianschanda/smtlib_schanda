...
(assert (= x (fp #b1 #b00000000 #b00001011111111011110011)))
;; x should be Float32(0x8005FEF3 [Rational(-392947, 713623846352979940529142984724747568191373312), -0.000000])
