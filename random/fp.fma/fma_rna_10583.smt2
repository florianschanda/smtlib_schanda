...
(assert (= x (fp #b1 #b10010100 #b10000111000011011101010)))
;; x should be Float32(0xCA4386EA [Rational(-6407029, 2), -3203514.500000])
...
(assert (= z (fp #b0 #b11111111 #b00111001001001110111010)))
