...
(assert (= z (fp #b0 #b10010101 #b11001011001101010010101)))
;; z should be Float32(0x4AE59A95 [Rational(15047317, 2), 7523658.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b10010101 #b11001011001101010010101)))
(check-sat)
(exit)
