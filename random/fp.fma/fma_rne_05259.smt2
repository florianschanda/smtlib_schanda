...
(assert (= y (fp #b1 #b10010101 #b10111100101110011111001)))
;; y should be Float32(0xCADE5CF9 [Rational(-14572793, 2), -7286396.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x0BDE5CF7))))
(check-sat)
(exit)
