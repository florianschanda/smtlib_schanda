...
(assert (= x ((_ to_fp 8 24) #x7FE25B0F)))
...
(assert (= z (fp #b0 #b11101111 #b01111001011111000001011)))
;; z should be Float32(0x77BCBE0B [Rational(7656299521398664597281225129852928), 7656299521398664597281225129852928.000000])
