...
(assert (= z (fp #b1 #b00000000 #b00011010000111001000010)))
;; z should be Float32(0x800D0E42 [Rational(-427809, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b00000000 #b00011010000111001000010)))
(check-sat)
(exit)
