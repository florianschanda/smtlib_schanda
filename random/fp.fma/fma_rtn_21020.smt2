...
(assert (= x ((_ to_fp 8 24) #x4AF334BD)))
;; x should be Float32(0x4AF334BD [Rational(15938749, 2), 7969374.500000])
...
(assert (= result (fp #b0 #b00010111 #b11100110011010010111101)))
(check-sat)
(exit)
