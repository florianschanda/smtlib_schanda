...
(assert (= y (fp #b1 #b00000000 #b00001100111011001010100)))
;; y should be Float32(0x80067654 [Rational(-105877, 178405961588244985132285746181186892047843328), -0.000000])
