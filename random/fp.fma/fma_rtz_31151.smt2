...
(assert (= x (fp #b1 #b10010101 #b10101101011111011101111)))
;; x should be Float32(0xCAD6BEEF [Rational(-14073583, 2), -7036791.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BD6BEEF)))
(check-sat)
(exit)
