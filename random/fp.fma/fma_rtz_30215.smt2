...
(assert (= x ((_ to_fp 8 24) #x60F1B177)))
;; x should be Float32(0x60F1B177 [Rational(139326656607216992256), 139326656607216992256.000000])
...
(assert (not (= result (fp #b1 #b01000011 #b11100011011000101110101))))
(check-sat)
(exit)
