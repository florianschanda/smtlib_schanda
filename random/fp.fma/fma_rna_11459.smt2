...
(assert (= z (fp #b0 #b10010101 #b11101001111110111010111)))
;; z should be Float32(0x4AF4FDD7 [Rational(16055767, 2), 8027883.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4AF4FDDF))))
(check-sat)
(exit)
