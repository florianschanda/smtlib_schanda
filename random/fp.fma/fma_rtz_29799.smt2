...
(assert (= y (fp #b1 #b10010011 #b00100001111011111100100)))
;; y should be Float32(0xC990F7E4 [Rational(-2375161, 2), -1187580.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x80121EFB))))
(check-sat)
(exit)
