...
(assert (= x (fp #b1 #b10010011 #b00101101100011110000100)))
;; x should be Float32(0xC996C784 [Rational(-2470369, 2), -1235184.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b00101101100011101111100))))
(check-sat)
(exit)
