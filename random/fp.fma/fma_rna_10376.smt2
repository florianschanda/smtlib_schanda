...
(assert (= z ((_ to_fp 8 24) #x4AEF27DD)))
;; z should be Float32(0x4AEF27DD [Rational(15673309, 2), 7836654.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10010101 #b11011110010011111011101)))
(check-sat)
(exit)
