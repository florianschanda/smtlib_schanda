...
(assert (= z (fp #b1 #b00000000 #b10011001001110100101010)))
;; z should be Float32(0x804C9D2A [Rational(-2510485, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b1 #b00000000 #b10011001001110100101010)))
(check-sat)
(exit)
