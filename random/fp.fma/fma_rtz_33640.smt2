...
(assert (= x (fp #b1 #b00000000 #b11101010001111101010100)))
;; x should be Float32(0x80751F54 [Rational(-1918933, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11010100011111010100111))))
(check-sat)
(exit)
