...
(assert (= x ((_ to_fp 8 24) #xC97D7FC8)))
;; x should be Float32(0xC97D7FC8 [Rational(-2076665, 2), -1038332.500000])
...
(assert (= z (fp #b1 #b10010001 #b11011001011101010010000)))
;; z should be Float32(0xC8ECBA90 [Rational(-969641, 2), -484820.500000])
