...
(assert (= y (fp #b0 #b10010101 #b11001011101011101111101)))
;; y should be Float32(0x4AE5D77D [Rational(15062909, 2), 7531454.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BE5D77D)))
(check-sat)
(exit)
