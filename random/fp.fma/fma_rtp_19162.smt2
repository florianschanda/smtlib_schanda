...
(assert (= y ((_ to_fp 8 24) #x4A78AEF2)))
;; y should be Float32(0x4A78AEF2 [Rational(8148857, 2), 4074428.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b01111100010101110111100))))
(check-sat)
(exit)
