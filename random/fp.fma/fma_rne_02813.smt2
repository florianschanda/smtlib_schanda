...
(assert (= x ((_ to_fp 8 24) #x62208F8B)))
;; x should be Float32(0x62208F8B [Rational(740455603190678683648), 740455603190678683648.000000])
...
(assert (= result ((_ to_fp 8 24) #x97A08F8B)))
(check-sat)
(exit)
