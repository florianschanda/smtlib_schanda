...
(assert (= y ((_ to_fp 8 24) #xE8FE0BC8)))
;; y should be Float32(0xE8FE0BC8 [Rational(-9597587298820066199470080), -9597587298820066199470080.000000])
...
(assert (= result ((_ to_fp 8 24) #xA9FE0BC8)))
(check-sat)
(exit)
