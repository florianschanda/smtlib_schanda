...
(assert (= x ((_ to_fp 8 24) #x7A37E5AC)))
;; x should be Float32(0x7A37E5AC [Rational(238712156038765535503557709587808256), 238712156038765535503557709587808256.000000])
...
(assert (= result ((_ to_fp 8 24) #x3B37E5AB)))
(check-sat)
(exit)
