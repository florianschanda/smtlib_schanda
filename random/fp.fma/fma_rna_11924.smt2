...
(assert (= z ((_ to_fp 8 24) #xCAD03517)))
;; z should be Float32(0xCAD03517 [Rational(-13645079, 2), -6822539.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b10100000011010100010111))))
(check-sat)
(exit)
