...
(assert (= z (fp #b0 #b00000000 #b00100111011001001101101)))
;; z should be Float32(0x0013B26D [Rational(1290861, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x0013B26C))))
(check-sat)
(exit)
