...
(assert (= y ((_ to_fp 8 24) #xC2425FE9)))
;; y should be Float32(0xC2425FE9 [Rational(-12738537, 262144), -48.593662])
...
(assert (= result (fp #b1 #b00000000 #b00000000000000000110001)))
(check-sat)
(exit)
