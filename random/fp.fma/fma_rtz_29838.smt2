...
(assert (= z (fp #b0 #b10001011 #b00001000100011000101110)))
;; z should be Float32(0x4584462E [Rational(4334359, 1024), 4232.772461])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4584462D))))
(check-sat)
(exit)
