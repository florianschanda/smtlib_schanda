...
(assert (= z (fp #b1 #b10010011 #b00000001010000000100100)))
;; z should be Float32(0xC980A024 [Rational(-2107401, 2), -1053700.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC980A025))))
(check-sat)
(exit)
