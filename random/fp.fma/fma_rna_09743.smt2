...
(assert (= x ((_ to_fp 8 24) #x07DF6526)))
;; x should be Float32(0x07DF6526 [Rational(7320211, 21778071482940061661655974875633165533184), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xFFB6D2E0)))
