...
(assert (= x (fp #b1 #b00000000 #b11001011111101110011110)))
;; x should be Float32(0x8065FB9E [Rational(-3341775, 356811923176489970264571492362373784095686656), -0.000000])
