...
(assert (= y ((_ to_fp 8 24) #x4A1AFEC2)))
;; y should be Float32(0x4A1AFEC2 [Rational(5078881, 2), 2539440.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b10010100 #b00111011001100010110010)))
;; z should be Float32(0x4A1D98B2 [Rational(5164121, 2), 2582060.500000])
