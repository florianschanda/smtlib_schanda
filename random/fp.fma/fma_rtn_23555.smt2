...
(assert (= x (fp #b0 #b00000000 #b01011001010100110111010)))
;; x should be Float32(0x002CA9BA [Rational(1463517, 356811923176489970264571492362373784095686656), 0.000000])
