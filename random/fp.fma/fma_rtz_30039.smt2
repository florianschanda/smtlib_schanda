...
(assert (= x (fp #b0 #b01011110 #b01000100110110111010110)))
;; x should be Float32(0x2F226DD6 [Rational(5322475, 36028797018963968), 0.000000])
...
(assert (= z (fp #b1 #b11111111 #b11010101010111001100011)))
