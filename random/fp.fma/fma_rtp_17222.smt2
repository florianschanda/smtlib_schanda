...
(assert (= z (fp #b0 #b01101011 #b11111110010100100101000)))
;; z should be Float32(0x35FF2928 [Rational(2090277, 1099511627776), 0.000002])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b01101011 #b11111110010100100101000)))
(check-sat)
(exit)
