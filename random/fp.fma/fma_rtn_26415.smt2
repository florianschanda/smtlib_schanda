...
(assert (= x ((_ to_fp 8 24) #xA1152F7F)))
;; x should be Float32(0xA1152F7F [Rational(-9777023, 19342813113834066795298816), -0.000000])
...
(assert (not (= result (fp #b1 #b11000010 #b00101010010111101111111))))
(check-sat)
(exit)
