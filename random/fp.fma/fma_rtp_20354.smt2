...
(assert (= y (fp #b0 #b00000111 #b10001000000001111101101)))
;; y should be Float32(0x03C403ED [Rational(12846061, 11150372599265311570767859136324180752990208), 0.000000])
