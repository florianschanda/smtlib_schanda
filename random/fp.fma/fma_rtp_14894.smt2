...
(assert (= z (fp #b1 #b10000100 #b01100000000111001101001)))
;; z should be Float32(0xC2300E69 [Rational(-11538025, 262144), -44.014072])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10000100 #b01000000000111001101001)))
(check-sat)
(exit)
