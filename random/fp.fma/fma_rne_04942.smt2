...
(assert (= z (fp #b0 #b10010100 #b01110011011001000111110)))
;; z should be Float32(0x4A39B23E [Rational(6084895, 2), 3042447.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010100 #b01110011011001000111110))))
(check-sat)
(exit)
