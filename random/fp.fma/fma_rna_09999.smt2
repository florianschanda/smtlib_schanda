...
(assert (= x (fp #b0 #b00000000 #b01110111001100101100101)))
;; x should be Float32(0x003B9965 [Rational(3905893, 713623846352979940529142984724747568191373312), 0.000000])
