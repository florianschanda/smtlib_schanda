...
(assert (= z ((_ to_fp 8 24) #xD5D9959C)))
;; z should be Float32(0xD5D9959C [Rational(-29904573825024), -29904573825024.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10101011 #b10110011001010110011011)))
(check-sat)
(exit)
