...
(assert (= z (fp #b1 #b10010101 #b01010011011001100011001)))
;; z should be Float32(0xCAA9B319 [Rational(-11121433, 2), -5560716.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #xCAA9B320)))
(check-sat)
(exit)
