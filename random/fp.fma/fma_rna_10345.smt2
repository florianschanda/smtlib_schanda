...
(assert (= z ((_ to_fp 8 24) #x00248CA0)))
;; z should be Float32(0x00248CA0 [Rational(74853, 22300745198530623141535718272648361505980416), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00000000 #b01001001000110010100000))))
(check-sat)
(exit)
