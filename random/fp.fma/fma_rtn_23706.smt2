...
(assert (= x (fp #b0 #b00000000 #b11100100000100001111010)))
;; x should be Float32(0x0072087A [Rational(3736637, 356811923176489970264571492362373784095686656), 0.000000])
