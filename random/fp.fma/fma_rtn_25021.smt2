...
(assert (= z (fp #b1 #b01000001 #b00001001010111110101110)))
;; z should be Float32(0xA084AFAE [Rational(-4347863, 19342813113834066795298816), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xC0800000))))
(check-sat)
(exit)
