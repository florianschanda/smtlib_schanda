...
(assert (= x (fp #b0 #b00000000 #b00110000000110110111011)))
;; x should be Float32(0x00180DBB [Rational(1576379, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x7F836192)))
