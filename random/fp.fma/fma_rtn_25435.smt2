...
(assert (= y (fp #b0 #b00000000 #b01011010110110001100101)))
;; y should be Float32(0x002D6C65 [Rational(2976869, 713623846352979940529142984724747568191373312), 0.000000])
