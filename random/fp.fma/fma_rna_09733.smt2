...
(assert (= x (fp #b0 #b11110011 #b10110111000110010110001)))
;; x should be Float32(0x79DB8CB1 [Rational(142495821593550438661910671069806592), 142495821593550438661910671069806592.000000])
