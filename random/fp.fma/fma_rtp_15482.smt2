...
(assert (= y ((_ to_fp 8 24) #xCE8C2450)))
;; y should be Float32(0xCE8C2450 [Rational(-1175595008), -1175595008.000000])
...
(assert (not (= result (fp #b1 #b00011111 #b00011000010010001001110))))
(check-sat)
(exit)
