...
(assert (= z ((_ to_fp 8 24) #x807B122E)))
;; z should be Float32(0x807B122E [Rational(-4032791, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x807B122F))))
(check-sat)
(exit)
