...
(assert (= z (fp #b1 #b00000000 #b10001011010001101101110)))
;; z should be Float32(0x8045A36E [Rational(-2281911, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x8045A36E)))
(check-sat)
(exit)
