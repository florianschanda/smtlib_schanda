...
(assert (= x (fp #b1 #b11111111 #b11101011110101010101100)))
...
(assert (= z (fp #b1 #b10101101 #b11101100011111010011000)))
;; z should be Float32(0xD6F63E98 [Rational(-135374349271040), -135374349271040.000000])
