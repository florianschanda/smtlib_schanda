...
(assert (= z ((_ to_fp 8 24) #x509E1B3A)))
;; z should be Float32(0x509E1B3A [Rational(21220675584), 21220675584.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10100001 #b00111100001101100111010)))
(check-sat)
(exit)
