...
(assert (= x (fp #b1 #b00000000 #b00010110000110110010010)))
;; x should be Float32(0x800B0D92 [Rational(-362185, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result (fp #b1 #b00000001 #b00000000000000000000001)))
(check-sat)
(exit)
