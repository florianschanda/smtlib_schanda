...
(assert (= x (fp #b1 #b00000000 #b01011111110001000010010)))
;; x should be Float32(0x802FE212 [Rational(-1569033, 356811923176489970264571492362373784095686656), -0.000000])
