...
(assert (= z (fp #b0 #b00000000 #b00101110111011010000011)))
;; z should be Float32(0x00177683 [Rational(1537667, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x00177683)))
(check-sat)
(exit)
