...
(assert (= y ((_ to_fp 8 24) #x99D18CEB)))
;; y should be Float32(0x99D18CEB [Rational(-13733099, 633825300114114700748351602688), -0.000000])
...
(assert (not (= result (fp #b0 #b10110011 #b10100011000110011101011))))
(check-sat)
(exit)
