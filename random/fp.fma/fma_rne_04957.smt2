...
(assert (= z (fp #b1 #b11011000 #b01100011101110110101000)))
;; z should be Float32(0xEC31DDA8 [Rational(-860106448470031754879565824), -860106448470031754879565824.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result ((_ to_fp 8 24) #xEC31DDA8))))
(check-sat)
(exit)
