...
(assert (= x ((_ to_fp 8 24) #xFF94DCE2)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x006A06C1)))
;; y should be Float32(0x006A06C1 [Rational(6948545, 713623846352979940529142984724747568191373312), 0.000000])
