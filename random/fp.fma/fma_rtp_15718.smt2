...
(assert (= y (fp #b1 #b10010101 #b00001100100011110110011)))
;; y should be Float32(0xCA8647B3 [Rational(-8800179, 2), -4400089.500000])
...
(assert (= result (fp #b1 #b00010111 #b00001100100011110110001)))
(check-sat)
(exit)
