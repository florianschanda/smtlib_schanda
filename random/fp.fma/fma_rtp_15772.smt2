...
(assert (= z (fp #b0 #b10010101 #b11100101100011000000111)))
;; z should be Float32(0x4AF2C607 [Rational(15910407, 2), 7955203.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x4AF2C607)))
(check-sat)
(exit)
