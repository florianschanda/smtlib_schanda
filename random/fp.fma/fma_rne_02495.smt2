...
(assert (= y (fp #b1 #b00000000 #b10110000000100000110100)))
;; y should be Float32(0x80580834 [Rational(-1442317, 178405961588244985132285746181186892047843328), -0.000000])
