...
(assert (= z (fp #b0 #b00111001 #b00100001001000010001011)))
;; z should be Float32(0x1C90908B [Rational(9474187, 9903520314283042199192993792), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b0 #b00111001 #b00100001001000010001011))))
(check-sat)
(exit)
