...
(assert (= z (fp #b0 #b10001001 #b01100000011100011011010)))
;; z should be Float32(0x44B038DA [Rational(5774445, 4096), 1409.776611])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x44B038DA))))
(check-sat)
(exit)
