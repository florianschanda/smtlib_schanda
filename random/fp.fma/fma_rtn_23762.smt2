...
(assert (= x (fp #b0 #b00000000 #b10101111110000010111010)))
;; x should be Float32(0x0057E0BA [Rational(2879581, 356811923176489970264571492362373784095686656), 0.000000])
