...
(assert (= y (fp #b1 #b00000000 #b10111101101000111111011)))
;; y should be Float32(0x805ED1FB [Rational(-6214139, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x403DA3F5)))
(check-sat)
(exit)
