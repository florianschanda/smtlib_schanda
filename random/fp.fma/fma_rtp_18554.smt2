...
(assert (= y ((_ to_fp 8 24) #x6838CCE3)))
;; y should be Float32(0x6838CCE3 [Rational(3490779702851592309964800), 3490779702851592309964800.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xA938CCE1))))
(check-sat)
(exit)
