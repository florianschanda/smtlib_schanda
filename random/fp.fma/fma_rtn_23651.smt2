...
(assert (= x (fp #b0 #b00000000 #b01100100101000101110111)))
;; x should be Float32(0x00325177 [Rational(3297655, 713623846352979940529142984724747568191373312), 0.000000])
