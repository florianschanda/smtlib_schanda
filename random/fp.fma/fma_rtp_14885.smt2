...
(assert (= z (fp #b0 #b10011000 #b11001011001100100000101)))
;; z should be Float32(0x4C659905 [Rational(60187668), 60187668.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10011000 #b11001011001100100000110))))
(check-sat)
(exit)
