...
(assert (= y (fp #b0 #b10010101 #b11010100100101001111011)))
;; y should be Float32(0x4AEA4A7B [Rational(15354491, 2), 7677245.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BEA4A7D)))
(check-sat)
(exit)
