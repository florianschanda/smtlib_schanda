...
(assert (= x (fp #b1 #b00000000 #b11111100000110001110111)))
;; x should be Float32(0x807E0C77 [Rational(-8260727, 713623846352979940529142984724747568191373312), -0.000000])
