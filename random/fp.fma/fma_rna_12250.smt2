...
(assert (= y (fp #b1 #b00000000 #b10100111100111001010110)))
;; y should be Float32(0x8053CE56 [Rational(-2746155, 356811923176489970264571492362373784095686656), -0.000000])
