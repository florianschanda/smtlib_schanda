...
(assert (= x ((_ to_fp 8 24) #xCA9F6467)))
;; x should be Float32(0xCA9F6467 [Rational(-10445927, 2), -5222963.500000])
...
(assert (= result (fp #b1 #b00000000 #b10011111011001000110100)))
(check-sat)
(exit)
