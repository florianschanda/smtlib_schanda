...
(assert (= x ((_ to_fp 8 24) #x7F8EC4F4)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b1 #b00000000 #b10110011100100111101010)))
;; y should be Float32(0x8059C9EA [Rational(-2942197, 356811923176489970264571492362373784095686656), -0.000000])
