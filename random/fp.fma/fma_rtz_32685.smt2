...
(assert (= y (fp #b1 #b10010100 #b11001001101000000100010)))
;; y should be Float32(0xCA64D022 [Rational(-7497745, 2), -3748872.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b11001001101000000100101))))
(check-sat)
(exit)
