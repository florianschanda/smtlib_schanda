...
(assert (= z (fp #b0 #b11100000 #b00101101010001001110100)))
;; z should be Float32(0x7016A274 [Rational(186476581001965372455457390592), 186476581001965372455457390592.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b11100000 #b00101101010001001110100))))
(check-sat)
(exit)
