...
(assert (= y (fp #b0 #b10010001 #b11101011110000110010000)))
;; y should be Float32(0x48F5E190 [Rational(1007129, 2), 503564.500000])

(declare-const z Float32)
(assert (= z (fp #b1 #b11111111 #b10101100100011000101101)))
