...
(assert (= x (fp #b0 #b00000000 #b00111101000011111111010)))
;; x should be Float32(0x001E87FA [Rational(1000445, 356811923176489970264571492362373784095686656), 0.000000])
