...
(assert (= x (fp #b1 #b10010100 #b00000011111010110111110)))
;; x should be Float32(0xCA01F5BE [Rational(-4258527, 2), -2129263.500000])
...
(assert (not (= result (fp #b1 #b00010110 #b00000011111010110111011))))
(check-sat)
(exit)
