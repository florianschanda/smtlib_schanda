...
(assert (= z (fp #b0 #b00000000 #b11000000111001110101110)))
;; z should be Float32(0x006073AE [Rational(3160535, 356811923176489970264571492362373784095686656), 0.000000])
