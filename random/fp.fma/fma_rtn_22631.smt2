...
(assert (= z ((_ to_fp 8 24) #x49132B88)))
;; z should be Float32(0x49132B88 [Rational(1205617, 2), 602808.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010010 #b00100110010101110000111))))
(check-sat)
(exit)
