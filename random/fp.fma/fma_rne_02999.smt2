...
(assert (= x (fp #b0 #b00000000 #b11000000110100100011100)))
;; x should be Float32(0x0060691C [Rational(1579591, 178405961588244985132285746181186892047843328), 0.000000])
