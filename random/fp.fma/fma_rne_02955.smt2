...
(assert (= x ((_ to_fp 8 24) #x006F1648)))
;; x should be Float32(0x006F1648 [Rational(910025, 89202980794122492566142873090593446023921664), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x405E2C8F)))
(check-sat)
(exit)
