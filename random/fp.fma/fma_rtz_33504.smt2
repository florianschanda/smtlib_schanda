...
(assert (= x ((_ to_fp 8 24) #xE2DA0F3F)))
;; x should be Float32(0xE2DA0F3F [Rational(-2011244402451391971328), -2011244402451391971328.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x185A0F3F))))
(check-sat)
(exit)
