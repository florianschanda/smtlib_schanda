...
(assert (= x (fp #b0 #b00000000 #b10101100110001100001110)))
;; x should be Float32(0x0056630E [Rational(2830727, 356811923176489970264571492362373784095686656), 0.000000])
