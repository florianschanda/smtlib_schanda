...
(assert (= x (fp #b0 #b00000000 #b00001011110110100110111)))
;; x should be Float32(0x0005ED37 [Rational(388407, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result (fp #b1 #b01111100 #b01111011010011011011111)))
(check-sat)
(exit)
