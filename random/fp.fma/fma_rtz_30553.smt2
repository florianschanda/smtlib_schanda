...
(assert (= x ((_ to_fp 8 24) #x0071F4F1)))
;; x should be Float32(0x0071F4F1 [Rational(7468273, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b11000111110100111100001))))
(check-sat)
(exit)
