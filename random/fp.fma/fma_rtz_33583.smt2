...
(assert (= x (fp #b1 #b00000000 #b10101000110110000011001)))
;; x should be Float32(0x80546C19 [Rational(-5532697, 713623846352979940529142984724747568191373312), -0.000000])
