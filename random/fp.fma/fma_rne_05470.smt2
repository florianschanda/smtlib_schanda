...
(assert (= z (fp #b1 #b00000101 #b00101110000101111001101)))
;; z should be Float32(0x82970BCD [Rational(-9898957, 44601490397061246283071436545296723011960832), -0.000000])
