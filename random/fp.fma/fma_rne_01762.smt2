...
(assert (= y (fp #b1 #b11011110 #b10001010000110100110000)))
;; y should be Float32(0xEF450D30 [Rational(-60984489644051146461023305728), -60984489644051146461023305728.000000])
...
(assert (= result ((_ to_fp 8 24) #xB0450D2E)))
(check-sat)
(exit)
