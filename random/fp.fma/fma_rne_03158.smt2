...
(assert (= x (fp #b0 #b00000000 #b11001010111000101000010)))
;; x should be Float32(0x00657142 [Rational(3324065, 356811923176489970264571492362373784095686656), 0.000000])
