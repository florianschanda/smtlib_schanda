...
(assert (= z ((_ to_fp 8 24) #x802D2324)))
;; z should be Float32(0x802D2324 [Rational(-739529, 178405961588244985132285746181186892047843328), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b01101010 #b00000000000000000000000)))
(check-sat)
(exit)
