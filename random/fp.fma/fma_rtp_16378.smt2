...
(assert (= x (fp #b0 #b00101101 #b11000110111011100101011)))
;; x should be Float32(0x16E3772B [Rational(14907179, 40564819207303340847894502572032), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFF8ECDD5)))
