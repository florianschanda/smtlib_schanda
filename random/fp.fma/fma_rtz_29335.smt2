...
(assert (= z (fp #b1 #b00000000 #b01001000101111010110110)))
;; z should be Float32(0x80245EB6 [Rational(-1191771, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #x80245EB5))))
(check-sat)
(exit)
