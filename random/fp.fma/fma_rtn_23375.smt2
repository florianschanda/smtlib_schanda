...
(assert (= x (fp #b0 #b01101110 #b00001000110011010101001)))
;; x should be Float32(0x370466A9 [Rational(8677033, 1099511627776), 0.000008])
...
(assert (not (= result ((_ to_fp 8 24) #x007FFFBC))))
(check-sat)
(exit)
