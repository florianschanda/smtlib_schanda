...
(assert (= y (fp #b0 #b00000000 #b01011000110100101100110)))
;; y should be Float32(0x002C6966 [Rational(1455283, 356811923176489970264571492362373784095686656), 0.000000])
