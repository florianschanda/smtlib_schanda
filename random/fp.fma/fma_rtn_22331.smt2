...
(assert (= y (fp #b1 #b11101000 #b10000101001101111011101)))
;; y should be Float32(0xF4429BDD [Rational(-61674003507582899247389909975040), -61674003507582899247389909975040.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB5429BDC))))
(check-sat)
(exit)
