...
(assert (= x ((_ to_fp 8 24) #x399F1403)))
;; x should be Float32(0x399F1403 [Rational(10425347, 34359738368), 0.000303])
...
(assert (not (= result (fp #b1 #b00000000 #b00000000000100111110001))))
(check-sat)
(exit)
