...
(assert (= y (fp #b1 #b00000000 #b11100011101111110111111)))
;; y should be Float32(0x8071DFBF [Rational(-7462847, 713623846352979940529142984724747568191373312), -0.000000])
