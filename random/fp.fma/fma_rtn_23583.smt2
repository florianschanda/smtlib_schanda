...
(assert (= x (fp #b0 #b00000000 #b11100011010001011010100)))
;; x should be Float32(0x0071A2D4 [Rational(1861813, 178405961588244985132285746181186892047843328), 0.000000])
