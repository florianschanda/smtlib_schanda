...
(assert (= z (fp #b1 #b00000000 #b01001111010111000111011)))
;; z should be Float32(0x8027AE3B [Rational(-2600507, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000000 #b01001111010111000111010)))
(check-sat)
(exit)
