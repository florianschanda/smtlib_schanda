...
(assert (= x (fp #b0 #b00000000 #b11111000000101111111001)))
;; x should be Float32(0x007C0BF9 [Rational(8129529, 713623846352979940529142984724747568191373312), 0.000000])
