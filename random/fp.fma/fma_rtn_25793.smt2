...
(assert (= y (fp #b0 #b00000000 #b00110000011111111011110)))
;; y should be Float32(0x00183FDE [Rational(794607, 356811923176489970264571492362373784095686656), 0.000000])
