...
(assert (= x ((_ to_fp 8 24) #x498CE194)))
;; x should be Float32(0x498CE194 [Rational(2308197, 2), 1154098.500000])
...
(assert (not (= result (fp #b1 #b00010101 #b00011001110000110011100))))
(check-sat)
(exit)
