...
(assert (= x (fp #b1 #b00000000 #b01110110000011011010110)))
;; x should be Float32(0x803B06D6 [Rational(-1934187, 356811923176489970264571492362373784095686656), -0.000000])
