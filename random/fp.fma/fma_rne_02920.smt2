...
(assert (= x ((_ to_fp 8 24) #x0043CB8E)))
;; x should be Float32(0x0043CB8E [Rational(2221511, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x4A168F16)))
;; y should be Float32(0x4A168F16 [Rational(4933515, 2), 2466757.500000])
