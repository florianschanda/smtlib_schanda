...
(assert (= x (fp #b1 #b11111111 #b01111110101011000011111)))
...
(assert (= z (fp #b1 #b00000000 #b11100010101010101000000)))
;; z should be Float32(0x80715540 [Rational(-116053, 11150372599265311570767859136324180752990208), -0.000000])
