...
(assert (= z ((_ to_fp 8 24) #xCA85D8AB)))
;; z should be Float32(0xCA85D8AB [Rational(-8771755, 2), -4385877.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010101 #b00001011101100010110011))))
(check-sat)
(exit)
