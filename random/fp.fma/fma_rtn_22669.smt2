...
(assert (= z ((_ to_fp 8 24) #x4AE04551)))
;; z should be Float32(0x4AE04551 [Rational(14697809, 2), 7348904.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b0 #b10010101 #b11000000100010101010000)))
(check-sat)
(exit)
