...
(assert (= x (fp #b0 #b11010111 #b10110010101010010000011)))
;; x should be Float32(0x6BD95483 [Rational(525471996328818474120904704), 525471996328818474120904704.000000])
