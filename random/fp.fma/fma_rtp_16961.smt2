...
(assert (= x (fp #b0 #b00000000 #b01111001011011101101011)))
;; x should be Float32(0x003CB76B [Rational(3979115, 713623846352979940529142984724747568191373312), 0.000000])
