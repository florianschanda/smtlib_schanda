...
(assert (= x (fp #b1 #b00000000 #b11110101001001011000001)))
;; x should be Float32(0x807A92C1 [Rational(-8032961, 713623846352979940529142984724747568191373312), -0.000000])
