...
(assert (= z (fp #b0 #b00000000 #b10011001110000101100011)))
;; z should be Float32(0x004CE163 [Rational(5038435, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10011001110000101100010))))
(check-sat)
(exit)
