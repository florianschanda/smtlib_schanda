...
(assert (= z (fp #b1 #b01000110 #b01011001111011011101011)))
;; z should be Float32(0xA32CF6EB [Rational(-11335403, 1208925819614629174706176), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #xA32CF6EA)))
(check-sat)
(exit)
