...
(assert (= y (fp #b0 #b11111111 #b00001010110011101110110)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x800190C0)))
;; z should be Float32(0x800190C0 [Rational(-1603, 11150372599265311570767859136324180752990208), -0.000000])
