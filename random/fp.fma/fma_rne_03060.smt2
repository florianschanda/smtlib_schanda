...
(assert (= x (fp #b0 #b00000000 #b00100001101011101101111)))
;; x should be Float32(0x0010D76F [Rational(1103727, 713623846352979940529142984724747568191373312), 0.000000])
