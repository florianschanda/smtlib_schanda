...
(assert (= z ((_ to_fp 8 24) #x4AB9A3AB)))
;; z should be Float32(0x4AB9A3AB [Rational(12166059, 2), 6083029.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10010101 #b01110011010001110101011))))
(check-sat)
(exit)
