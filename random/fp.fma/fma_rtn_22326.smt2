...
(assert (= y (fp #b1 #b10101110 #b01110111000111110111100)))
;; y should be Float32(0xD73B8FBC [Rational(-206226008834048), -206226008834048.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x983B8FBB))))
(check-sat)
(exit)
