...
(assert (= z (fp #b1 #b10010101 #b10001010100011001101101)))
;; z should be Float32(0xCAC5466D [Rational(-12928621, 2), -6464310.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b10001010100011001110100)))
(check-sat)
(exit)
