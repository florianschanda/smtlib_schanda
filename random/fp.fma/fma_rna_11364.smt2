...
(assert (= z (fp #b0 #b10010101 #b10000011110001110001001)))
;; z should be Float32(0x4AC1E389 [Rational(12706697, 2), 6353348.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result ((_ to_fp 8 24) #x4AC1E389)))
(check-sat)
(exit)
