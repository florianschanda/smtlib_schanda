...
(assert (= z ((_ to_fp 8 24) #x00396FA7)))
;; z should be Float32(0x00396FA7 [Rational(3764135, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x00396FA7)))
(check-sat)
(exit)
