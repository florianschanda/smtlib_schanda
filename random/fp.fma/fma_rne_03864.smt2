...
(assert (= x (fp #b1 #b10010100 #b00111110001010000111110)))
;; x should be Float32(0xCA1F143E [Rational(-5212703, 2), -2606351.500000])
...
(assert (not (= result (fp #b0 #b00010110 #b00111110001010000111101))))
(check-sat)
(exit)
