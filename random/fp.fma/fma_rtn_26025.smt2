...
(assert (= y (fp #b0 #b10010101 #b10010011001101110100001)))
;; y should be Float32(0x4AC99BA1 [Rational(13212577, 2), 6606288.500000])
...
(assert (= result (fp #b1 #b00000001 #b11001001100110111010000)))
(check-sat)
(exit)
