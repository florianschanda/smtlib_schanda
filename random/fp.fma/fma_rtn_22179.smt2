...
(assert (= y (fp #b0 #b00000000 #b11110010010010111011010)))
;; y should be Float32(0x007925DA [Rational(3969773, 356811923176489970264571492362373784095686656), 0.000000])
