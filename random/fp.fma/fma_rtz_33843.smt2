...
(assert (= x (fp #b1 #b00000000 #b00110011000010100101100)))
;; x should be Float32(0x8019852C [Rational(-418123, 178405961588244985132285746181186892047843328), -0.000000])
