...
(assert (= x (fp #b0 #b00000000 #b10101111001001000000111)))
;; x should be Float32(0x00579207 [Rational(5739015, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #xC02F240D)))
(check-sat)
(exit)
