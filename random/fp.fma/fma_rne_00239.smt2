...
(assert (= z (fp #b1 #b10010101 #b01011100000100011010001)))
;; z should be Float32(0xCAAE08D1 [Rational(-11405521, 2), -5702760.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #xCAAE08D1)))
(check-sat)
(exit)
