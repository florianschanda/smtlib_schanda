...
(assert (= x ((_ to_fp 8 24) #x835A74EB)))
;; x should be Float32(0x835A74EB [Rational(-14316779, 22300745198530623141535718272648361505980416), -0.000000])
...
(assert (= result (fp #b0 #b10000110 #b10110100111010011101010)))
(check-sat)
(exit)
