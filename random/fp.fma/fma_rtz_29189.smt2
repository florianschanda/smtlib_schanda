...
(assert (= y (fp #b1 #b11010100 #b11010101000100000111010)))
;; y should be Float32(0xEA6A883A [Rational(-70882988385662443446075392), -70882988385662443446075392.000000])
...
(assert (= result (fp #b1 #b01010110 #b11010101000100000111000)))
(check-sat)
(exit)
