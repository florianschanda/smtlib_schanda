...
(assert (= x (fp #b0 #b00000000 #b10111101111000101100010)))
;; x should be Float32(0x005EF162 [Rational(3111089, 356811923176489970264571492362373784095686656), 0.000000])
