...
(assert (= x (fp #b0 #b00000001 #b10111001110001000011110)))
;; x should be Float32(0x00DCE21E [Rational(7237903, 356811923176489970264571492362373784095686656), 0.000000])
