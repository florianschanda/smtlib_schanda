...
(assert (= z ((_ to_fp 8 24) #x79ADF498)))
;; z should be Float32(0x79ADF498 [Rational(112903538393814794437316651618664448), 112903538393814794437316651618664448.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x79ADF498))))
(check-sat)
(exit)
