...
(assert (= y (fp #b0 #b00000000 #b11100100011010111111010)))
;; y should be Float32(0x007235FA [Rational(3742461, 356811923176489970264571492362373784095686656), 0.000000])
...
(assert (= result (fp #b1 #b10000000 #b11001000110101111110011)))
(check-sat)
(exit)
