...
(assert (= z (fp #b0 #b00000000 #b00011000110011110101001)))
;; z should be Float32(0x000C67A9 [Rational(812969, 713623846352979940529142984724747568191373312), 0.000000])
