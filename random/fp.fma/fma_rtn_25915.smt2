...
(assert (= z (fp #b1 #b00000000 #b00110101001111100100000)))
;; z should be Float32(0x801A9F20 [Rational(-54521, 22300745198530623141535718272648361505980416), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x801A9F20))))
(check-sat)
(exit)
