...
(assert (= y ((_ to_fp 8 24) #x00653744)))
;; y should be Float32(0x00653744 [Rational(1658321, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x404A6E87))))
(check-sat)
(exit)
