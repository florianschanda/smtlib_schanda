...
(assert (= y (fp #b0 #b11101101 #b01011000001111010011010)))
;; y should be Float32(0x76AC1E9A [Rational(1745499478697513865093658577993728), 1745499478697513865093658577993728.000000])
...
(assert (not (= result ((_ to_fp 8 24) #xB7AC1E99))))
(check-sat)
(exit)
