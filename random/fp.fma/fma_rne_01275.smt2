...
(assert (= y (fp #b1 #b10010101 #b00010100100001100100101)))
;; y should be Float32(0xCA8A4325 [Rational(-9061157, 2), -4530578.500000])

(declare-const z Float32)
(assert (= z (fp #b0 #b10010011 #b00111110111101010100100)))
;; z should be Float32(0x499F7AA4 [Rational(2612905, 2), 1306452.500000])
