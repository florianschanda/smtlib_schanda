...
(assert (= z ((_ to_fp 8 24) #xCE4AC968)))
;; z should be Float32(0xCE4AC968 [Rational(-850549248), -850549248.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10011100 #b10010101100100101101000)))
(check-sat)
(exit)
