...
(assert (= y (fp #b0 #b00000000 #b01011011101000010100110)))
;; y should be Float32(0x002DD0A6 [Rational(1501267, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFECB90F)))
