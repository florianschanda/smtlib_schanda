...
(assert (= z (fp #b1 #b10001111 #b11100010100001101111011)))
;; z should be Float32(0xC7F1437B [Rational(-15811451, 128), -123526.960938])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b1 #b10001111 #b11100010100001101111011)))
(check-sat)
(exit)
