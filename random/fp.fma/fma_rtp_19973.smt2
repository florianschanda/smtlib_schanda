...
(assert (= x (fp #b1 #b00000000 #b01101011111011111000100)))
;; x should be Float32(0x8035F7C4 [Rational(-884209, 178405961588244985132285746181186892047843328), -0.000000])
