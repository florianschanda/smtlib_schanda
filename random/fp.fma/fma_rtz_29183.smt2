...
(assert (= z (fp #b1 #b00000000 #b01111011111010111011001)))
;; z should be Float32(0x803DF5D9 [Rational(-4060633, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b00000000 #b01111011111010111011001)))
(check-sat)
(exit)
