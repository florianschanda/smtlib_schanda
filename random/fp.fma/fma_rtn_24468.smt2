...
(assert (= x ((_ to_fp 8 24) #xCAAD4157)))
;; x should be Float32(0xCAAD4157 [Rational(-11354455, 2), -5677227.500000])
...
(assert (= result (fp #b0 #b00010111 #b01011010100000101010101)))
(check-sat)
(exit)
