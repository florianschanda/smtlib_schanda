...
(assert (= y (fp #b1 #b01110011 #b00100110011101011110010)))
;; y should be Float32(0xB9933AF2 [Rational(-4824441, 17179869184), -0.000281])
...
(assert (not (= result ((_ to_fp 8 24) #x00000934))))
(check-sat)
(exit)
