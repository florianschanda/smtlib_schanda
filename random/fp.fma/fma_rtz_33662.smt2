...
(assert (= x (fp #b1 #b00000000 #b10101110110011110111100)))
;; x should be Float32(0x805767BC [Rational(-1432047, 178405961588244985132285746181186892047843328), -0.000000])
