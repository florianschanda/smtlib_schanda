...
(assert (= z (fp #b1 #b00000000 #b11000000100011011100010)))
;; z should be Float32(0x806046E2 [Rational(-3154801, 356811923176489970264571492362373784095686656), -0.000000])
