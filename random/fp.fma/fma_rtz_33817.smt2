...
(assert (= x (fp #b1 #b00000000 #b00010100101011111101010)))
;; x should be Float32(0x800A57EA [Rational(-338933, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3EA57E9F)))
(check-sat)
(exit)
