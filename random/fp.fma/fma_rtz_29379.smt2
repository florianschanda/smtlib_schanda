...
(assert (= y (fp #b0 #b01110110 #b00001110100110110011101)))
;; y should be Float32(0x3B074D9D [Rational(8867229, 4294967296), 0.002065])
...
(assert (not (= result ((_ to_fp 8 24) #x008043A5))))
(check-sat)
(exit)
