...
(assert (= y (fp #b0 #b11111111 #b10001100010101100100011)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x8056C080)))
;; z should be Float32(0x8056C080 [Rational(-44417, 5575186299632655785383929568162090376495104), -0.000000])
