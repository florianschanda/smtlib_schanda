...
(assert (= z (fp #b1 #b10010101 #b01100100011111001111101)))
;; z should be Float32(0xCAB23E7D [Rational(-11681405, 2), -5840702.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAB23E7D))))
(check-sat)
(exit)
