...
(assert (= x (fp #b0 #b00000000 #b11011001111111011011001)))
;; x should be Float32(0x006CFED9 [Rational(7143129, 713623846352979940529142984724747568191373312), 0.000000])
