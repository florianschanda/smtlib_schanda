...
(assert (= x (fp #b0 #b00000000 #b01001101000101011111010)))
;; x should be Float32(0x00268AFA [Rational(1262973, 356811923176489970264571492362373784095686656), 0.000000])
