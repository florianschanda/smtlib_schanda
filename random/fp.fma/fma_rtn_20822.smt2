...
(assert (= z ((_ to_fp 8 24) #xF8905510)))
;; z should be Float32(0xF8905510 [Rational(-23419250627997681210119640139694080), -23419250627997681210119640139694080.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #xF8905510))))
(check-sat)
(exit)
