...
(assert (= x (fp #b0 #b00000000 #b00111111000000011001111)))
;; x should be Float32(0x001F80CF [Rational(2064591, 713623846352979940529142984724747568191373312), 0.000000])
