...
(assert (= z (fp #b0 #b10010101 #b10101111101111100000101)))
;; z should be Float32(0x4AD7DF05 [Rational(14147333, 2), 7073666.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result (fp #b0 #b10010101 #b10101111101111100000101))))
(check-sat)
(exit)
