...
(assert (= x (fp #b0 #b11111111 #b11011100000101000011111)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x83F52E7C)))
;; y should be Float32(0x83F52E7C [Rational(-4017055, 2787593149816327892691964784081045188247552), -0.000000])
