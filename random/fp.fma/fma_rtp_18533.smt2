...
(assert (= z (fp #b0 #b11101010 #b00100010100110110000110)))
;; z should be Float32(0x75114D86 [Rational(184193214502150414106641465081856), 184193214502150414106641465081856.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result ((_ to_fp 8 24) #x75114D86)))
(check-sat)
(exit)
