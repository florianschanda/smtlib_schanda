...
(assert (= x ((_ to_fp 8 24) #xE5D5363D)))
;; x should be Float32(0xE5D5363D [Rational(-125858072568056382488576), -125858072568056382488576.000000])
...
(assert (= result ((_ to_fp 8 24) #xA6D5363B)))
(check-sat)
(exit)
