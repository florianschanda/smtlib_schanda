...
(assert (= y ((_ to_fp 8 24) #xFFC60415)))
;; y should be Float32(NaN)

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x63978770)))
;; z should be Float32(0x63978770 [Rational(5590435311045308317696), 5590435311045308317696.000000])
