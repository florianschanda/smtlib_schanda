...
(assert (= z (fp #b1 #b10010101 #b00100111110001011001001)))
;; z should be Float32(0xCA93E2C9 [Rational(-9691849, 2), -4845924.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b00100111110001011001001)))
(check-sat)
(exit)
