...
(assert (= y (fp #b0 #b00000000 #b01111010110101101101110)))
;; y should be Float32(0x003D6B6E [Rational(2012599, 356811923176489970264571492362373784095686656), 0.000000])
