...
(assert (= z ((_ to_fp 8 24) #x0059CF17)))
;; z should be Float32(0x0059CF17 [Rational(5885719, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b00000000 #b10110011100111100010111)))
(check-sat)
(exit)
