...
(assert (= x ((_ to_fp 8 24) #x3419C97E)))
;; x should be Float32(0x3419C97E [Rational(5039295, 35184372088832), 0.000000])
...
(assert (= result (fp #b0 #b11101000 #b00110011100100101111101)))
(check-sat)
(exit)
