...
(assert (= y (fp #b1 #b10000010 #b11111101100001111101000)))
;; y should be Float32(0xC17EC3E8 [Rational(-2087037, 131072), -15.922829])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x4AEA6EBD)))
;; z should be Float32(0x4AEA6EBD [Rational(15363773, 2), 7681886.500000])
