...
(assert (= z ((_ to_fp 8 24) #x5D60142B)))
;; z should be Float32(0x5D60142B [Rational(1009161115189379072), 1009161115189379072.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result (fp #b0 #b10111010 #b11000000001010000101010))))
(check-sat)
(exit)
