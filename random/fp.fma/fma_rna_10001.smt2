...
(assert (= x (fp #b0 #b00000000 #b01001001110100011101001)))
;; x should be Float32(0x0024E8E9 [Rational(2418921, 713623846352979940529142984724747568191373312), 0.000000])
