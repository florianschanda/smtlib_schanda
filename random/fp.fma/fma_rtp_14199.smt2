...
(assert (= x (fp #b0 #b10010100 #b11011010101010000111010)))
;; x should be Float32(0x4A6D543A [Rational(7776797, 2), 3888398.500000])
...
(assert (= result (fp #b0 #b00000001 #b01110110101010100001111)))
(check-sat)
(exit)
