...
(assert (= x (fp #b1 #b10010101 #b11011110000001110000111)))
;; x should be Float32(0xCAEF0387 [Rational(-15664007, 2), -7832003.500000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b10001011001100110010100)))
