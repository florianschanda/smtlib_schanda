...
(assert (= x (fp #b0 #b11111111 #b00110100001101111111110)))
...
(assert (= z (fp #b0 #b00101010 #b00101001011010001001110)))
;; z should be Float32(0x1514B44E [Rational(4872743, 162259276829213363391578010288128), 0.000000])
