...
(assert (= z (fp #b1 #b10010101 #b01011110010010100011001)))
;; z should be Float32(0xCAAF2519 [Rational(-11478297, 2), -5739148.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b10010101 #b01011110010010100100000)))
(check-sat)
(exit)
