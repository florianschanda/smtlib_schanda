...
(assert (= x (fp #b1 #b00000000 #b10010011100111010100110)))
;; x should be Float32(0x8049CEA6 [Rational(-2418515, 356811923176489970264571492362373784095686656), -0.000000])
