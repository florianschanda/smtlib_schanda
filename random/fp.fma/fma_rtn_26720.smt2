...
(assert (= x (fp #b1 #b00000000 #b00101000101010000100001)))
;; x should be Float32(0x80145421 [Rational(-1332257, 713623846352979940529142984724747568191373312), -0.000000])
