...
(assert (= x (fp #b1 #b00000000 #b00101010010110010000010)))
;; x should be Float32(0x80152C82 [Rational(-693825, 356811923176489970264571492362373784095686656), -0.000000])
