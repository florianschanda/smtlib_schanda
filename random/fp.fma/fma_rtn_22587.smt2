...
(assert (= y (fp #b1 #b10010101 #b01010101100010010011001)))
;; y should be Float32(0xCAAAC499 [Rational(-11191449, 2), -5595724.500000])
...
(assert (not (= result (fp #b1 #b00010111 #b01010101100010010011011))))
(check-sat)
(exit)
