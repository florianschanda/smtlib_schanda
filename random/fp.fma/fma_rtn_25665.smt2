...
(assert (= y (fp #b0 #b10010011 #b11011000100011011100100)))
;; y should be Float32(0x49EC46E4 [Rational(3871161, 2), 1935580.500000])
...
(assert (not (= result ((_ to_fp 8 24) #x8AEC46EC))))
(check-sat)
(exit)
