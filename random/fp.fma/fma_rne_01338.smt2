...
(assert (= z ((_ to_fp 8 24) #x69DB551D)))
;; z should be Float32(0x69DB551D [Rational(33144586325278230835101696), 33144586325278230835101696.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result ((_ to_fp 8 24) #x69DB551D)))
(check-sat)
(exit)
