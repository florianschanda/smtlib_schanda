...
(assert (= z ((_ to_fp 8 24) #xCAC8D0ED)))
;; z should be Float32(0xCAC8D0ED [Rational(-13160685, 2), -6580342.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result (fp #b1 #b10010101 #b10010001101000011110101)))
(check-sat)
(exit)
