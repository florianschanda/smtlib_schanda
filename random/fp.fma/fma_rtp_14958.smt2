...
(assert (= y (fp #b0 #b00000000 #b00000001101101001110011)))
;; y should be Float32(0x0000DA73 [Rational(55923, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3CDA7300)))
(check-sat)
(exit)
