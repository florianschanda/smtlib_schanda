...
(assert (= x ((_ to_fp 8 24) #xCAB0D7E1)))
;; x should be Float32(0xCAB0D7E1 [Rational(-11589601, 2), -5794800.500000])

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #xCADC6169)))
;; y should be Float32(0xCADC6169 [Rational(-14442857, 2), -7221428.500000])
