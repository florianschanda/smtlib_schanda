...
(assert (= x ((_ to_fp 8 24) #x67C7AC83)))
;; x should be Float32(0x67C7AC83 [Rational(1885866419233112817926144), 1885866419233112817926144.000000])
...
(assert (= result (fp #b0 #b00111010 #b10001111010110010000100)))
(check-sat)
(exit)
