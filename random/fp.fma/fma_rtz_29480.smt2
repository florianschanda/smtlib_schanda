...
(assert (= z (fp #b1 #b10010101 #b11100011100101010111111)))
;; z should be Float32(0xCAF1CABF [Rational(-15846079, 2), -7923039.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result ((_ to_fp 8 24) #xCAF1CAC6))))
(check-sat)
(exit)
