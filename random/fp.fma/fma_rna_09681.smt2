...
(assert (= x ((_ to_fp 8 24) #x5AEC1F11)))
;; x should be Float32(0x5AEC1F11 [Rational(33231126189309952), 33231126189309952.000000])
...
(assert (= result (fp #b1 #b00100000 #b11011000001111100010001)))
(check-sat)
(exit)
