...
(assert (= z ((_ to_fp 8 24) #x0008DEEF)))
;; z should be Float32(0x0008DEEF [Rational(581359, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b00000000 #b00010001101111011110000)))
(check-sat)
(exit)
