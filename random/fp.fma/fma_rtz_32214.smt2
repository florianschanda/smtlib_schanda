...
(assert (= z (fp #b0 #b00000000 #b10111000100101001001110)))
;; z should be Float32(0x005C4A4E [Rational(3024167, 356811923176489970264571492362373784095686656), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b0 #b00000000 #b10111000100101001001101)))
(check-sat)
(exit)
