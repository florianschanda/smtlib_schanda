...
(assert (= z ((_ to_fp 8 24) #x951A29DD)))
;; z should be Float32(0x951A29DD [Rational(-10103261, 324518553658426726783156020576256), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x951A29DE)))
(check-sat)
(exit)
