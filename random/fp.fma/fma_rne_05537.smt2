...
(assert (= z (fp #b0 #b10000000 #b00000001001011101000100)))
;; z should be Float32(0x40009744 [Rational(2106833, 1048576), 2.009233])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b0 #b10000000 #b00000001001011101000100)))
(check-sat)
(exit)
