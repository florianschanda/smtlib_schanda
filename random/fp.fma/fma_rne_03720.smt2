...
(assert (= x (fp #b1 #b10010100 #b10101100001110000000110)))
;; x should be Float32(0xCA561C06 [Rational(-7015939, 2), -3507969.500000])
...
(assert (= result (fp #b1 #b00010110 #b10101100001110000001010)))
(check-sat)
(exit)
