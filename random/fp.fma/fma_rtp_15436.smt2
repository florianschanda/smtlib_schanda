...
(assert (= z (fp #b0 #b01000000 #b11100010000101110001011)))
;; z should be Float32(0x20710B8B [Rational(15797131, 77371252455336267181195264), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b01000000 #b11100010000101110001011)))
(check-sat)
(exit)
