...
(assert (= x (fp #b1 #b00000000 #b10100011000101001010100)))
;; x should be Float32(0x80518A54 [Rational(-1335957, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFD0B097)))
