...
(assert (= x ((_ to_fp 8 24) #xCADCEEDF)))
;; x should be Float32(0xCADCEEDF [Rational(-14479071, 2), -7239535.500000])
...
(assert (= z (fp #b1 #b10010010 #b11111010001110110001000)))
;; z should be Float32(0xC97D1D88 [Rational(-2073521, 2), -1036760.500000])
