...
(assert (= x (fp #b0 #b00000100 #b01110000011100001110001)))
;; x should be Float32(0x02383871 [Rational(12073073, 89202980794122492566142873090593446023921664), 0.000000])
