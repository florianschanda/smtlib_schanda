...
(assert (= x (fp #b0 #b00000000 #b11001111011000000011011)))
;; x should be Float32(0x0067B01B [Rational(6795291, 713623846352979940529142984724747568191373312), 0.000000])
