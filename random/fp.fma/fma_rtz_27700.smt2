...
(assert (= z (fp #b1 #b01010101 #b00011001010110001011001)))
;; z should be Float32(0xAA8CAC59 [Rational(-9219161, 36893488147419103232), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result (fp #b1 #b01010101 #b00011001010110001011001)))
(check-sat)
(exit)
