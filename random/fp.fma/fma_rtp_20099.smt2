...
(assert (= x (fp #b1 #b00000000 #b01110110011010110110010)))
;; x should be Float32(0x803B35B2 [Rational(-1940185, 356811923176489970264571492362373784095686656), -0.000000])
...
(assert (not (= result ((_ to_fp 8 24) #x3FECD6C8))))
(check-sat)
(exit)
