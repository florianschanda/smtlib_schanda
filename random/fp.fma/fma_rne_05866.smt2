...
(assert (= x (fp #b1 #b10110011 #b10111101111011010010111)))
;; x should be Float32(0xD9DEF697 [Rational(-7844821653782528), -7844821653782528.000000])
...
(assert (= result ((_ to_fp 8 24) #x9ADEF695)))
(check-sat)
(exit)
