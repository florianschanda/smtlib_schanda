...
(assert (= y (fp #b1 #b10010101 #b00110100001111101001101)))
;; y should be Float32(0xCA9A1F4D [Rational(-10100557, 2), -5050278.500000])
...
(assert (= result ((_ to_fp 8 24) #x0B9A1F4B)))
(check-sat)
(exit)
