...
(assert (= y ((_ to_fp 8 24) #xCAD48905)))
;; y should be Float32(0xCAD48905 [Rational(-13928709, 2), -6964354.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b10101001000100100000001))))
(check-sat)
(exit)
