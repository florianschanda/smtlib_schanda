...
(assert (= y (fp #b0 #b00000000 #b00001011101110111011000)))
;; y should be Float32(0x0005DDD8 [Rational(48059, 89202980794122492566142873090593446023921664), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #x7FA3EC57)))
