...
(assert (= y ((_ to_fp 8 24) #x002163BF)))
;; y should be Float32(0x002163BF [Rational(2188223, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F858EFB)))
(check-sat)
(exit)
