...
(assert (= x ((_ to_fp 8 24) #x7FA14373)))
...
(assert (= z (fp #b0 #b00000000 #b00101100101111110011001)))
;; z should be Float32(0x00165F99 [Rational(1466265, 713623846352979940529142984724747568191373312), 0.000000])
