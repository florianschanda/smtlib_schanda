...
(assert (= y ((_ to_fp 8 24) #xCAE7C459)))
;; y should be Float32(0xCAE7C459 [Rational(-15189081, 2), -7594540.500000])
...
(assert (not (= result (fp #b0 #b00010111 #b11001111100010001011001))))
(check-sat)
(exit)
