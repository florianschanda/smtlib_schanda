...
(assert (= y (fp #b1 #b00000000 #b01100111110000010001100)))
;; y should be Float32(0x8033E08C [Rational(-849955, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b10011111000001000101111))))
(check-sat)
(exit)
