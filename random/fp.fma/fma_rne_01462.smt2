...
(assert (= z ((_ to_fp 8 24) #x80756EC9)))
;; z should be Float32(0x80756EC9 [Rational(-7696073, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b1 #b00000000 #b11101010110111011001001))))
(check-sat)
(exit)
