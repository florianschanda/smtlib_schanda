...
(assert (= x (fp #b1 #b10010100 #b01101011000000011111010)))
;; x should be Float32(0xCA3580FA [Rational(-5947517, 2), -2973758.500000])
...
(assert (= result (fp #b0 #b00010110 #b01101011000000011110110)))
(check-sat)
(exit)
