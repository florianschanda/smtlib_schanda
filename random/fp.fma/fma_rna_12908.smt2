...
(assert (= x (fp #b1 #b10011111 #b01000111010101110101111)))
;; x should be Float32(0xCFA3ABAF [Rational(-5491875328), -5491875328.000000])
...
(assert (= result (fp #b0 #b00100001 #b01000111010101110101111)))
(check-sat)
(exit)
