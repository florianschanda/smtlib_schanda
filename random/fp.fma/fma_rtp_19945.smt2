...
(assert (= x (fp #b1 #b00000000 #b01100011000111110101111)))
;; x should be Float32(0x80318FAF [Rational(-3248047, 713623846352979940529142984724747568191373312), -0.000000])
