...
(assert (= z ((_ to_fp 8 24) #x8006B341)))
;; z should be Float32(0x8006B341 [Rational(-439105, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (not (= result ((_ to_fp 8 24) #x8006B341))))
(check-sat)
(exit)
