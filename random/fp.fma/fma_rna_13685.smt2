...
(assert (= x ((_ to_fp 8 24) #xFF9D916B)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y ((_ to_fp 8 24) #x8021848A)))
;; y should be Float32(0x8021848A [Rational(-1098309, 356811923176489970264571492362373784095686656), -0.000000])
