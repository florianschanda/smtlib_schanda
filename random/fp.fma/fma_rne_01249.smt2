...
(assert (= y (fp #b0 #b00000000 #b11110100111111101111100)))
;; y should be Float32(0x007A7F7C [Rational(2007007, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result (fp #b0 #b10000000 #b11101001111111011110111))))
(check-sat)
(exit)
