...
(assert (= z (fp #b1 #b00110110 #b00000010000110110101011)))
;; z should be Float32(0x9B010DAB [Rational(-8457643, 79228162514264337593543950336), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b00110110 #b00000010000110110101010))))
(check-sat)
(exit)
