...
(assert (= x (fp #b1 #b00000000 #b00001011101111001110010)))
;; x should be Float32(0x8005DE72 [Rational(-192313, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const y Float32)
(assert (= y (fp #b1 #b11111111 #b01001100110000010101011)))
