...
(assert (= y (fp #b0 #b10010101 #b11000111111110111111101)))
;; y should be Float32(0x4AE3FDFD [Rational(14941693, 2), 7470846.500000])
...
(assert (= result ((_ to_fp 8 24) #x0BE3FDFB)))
(check-sat)
(exit)
