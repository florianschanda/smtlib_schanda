...
(assert (= x (fp #b1 #b10010010 #b01001101111100101101000)))
;; x should be Float32(0xC926F968 [Rational(-1367853, 2), -683926.500000])
...
(assert (not (= result (fp #b1 #b00000000 #b00010100110111110010111))))
(check-sat)
(exit)
