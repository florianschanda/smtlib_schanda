...
(assert (= z ((_ to_fp 8 24) #x0051E9B3)))
;; z should be Float32(0x0051E9B3 [Rational(5368243, 713623846352979940529142984724747568191373312), 0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b00000000 #b10100011110100110110011))))
(check-sat)
(exit)
