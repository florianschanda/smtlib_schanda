...
(assert (= z ((_ to_fp 8 24) #x4ACF1655)))
;; z should be Float32(0x4ACF1655 [Rational(13571669, 2), 6785834.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (= result (fp #b0 #b10010101 #b10011110001011001010101)))
(check-sat)
(exit)
