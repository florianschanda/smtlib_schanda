...
(assert (= x (fp #b0 #b11111000 #b10100101110000001001010)))
;; x should be Float32(0x7C52E04A [Rational(4379725851710231326909401342706450432), 4379725851710231326909401342706450432.000000])
