...
(assert (= x (fp #b1 #b00000101 #b01010110101001010111111)))
;; x should be Float32(0x82AB52BF [Rational(-11227839, 44601490397061246283071436545296723011960832), -0.000000])
