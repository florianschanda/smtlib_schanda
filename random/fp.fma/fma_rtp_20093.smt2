...
(assert (= x (fp #b1 #b00000000 #b01000001100100011001001)))
;; x should be Float32(0x8020C8C9 [Rational(-2148553, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #x3F832324)))
(check-sat)
(exit)
