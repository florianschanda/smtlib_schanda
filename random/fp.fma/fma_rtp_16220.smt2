...
(assert (= y (fp #b1 #b00000000 #b00011110101111111010110)))
;; y should be Float32(0x800F5FD6 [Rational(-503787, 356811923176489970264571492362373784095686656), -0.000000])
