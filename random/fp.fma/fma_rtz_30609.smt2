...
(assert (= x (fp #b0 #b00000000 #b10110010111101001010100)))
;; x should be Float32(0x00597A54 [Rational(1466005, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (= z ((_ to_fp 8 24) #xFFD2E138)))
