...
(assert (= z (fp #b0 #b10010101 #b00010100010110111111111)))
;; z should be Float32(0x4A8A2DFF [Rational(9055743, 2), 4527871.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x4A8A2E00))))
(check-sat)
(exit)
