...
(assert (= z (fp #b1 #b00000000 #b11010011111101000011011)))
;; z should be Float32(0x8069FA1B [Rational(-6945307, 713623846352979940529142984724747568191373312), -0.000000])
