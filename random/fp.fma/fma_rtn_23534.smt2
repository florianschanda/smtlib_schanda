...
(assert (= x (fp #b0 #b00000000 #b11101010011101100011010)))
;; x should be Float32(0x00753B1A [Rational(3841421, 356811923176489970264571492362373784095686656), 0.000000])
