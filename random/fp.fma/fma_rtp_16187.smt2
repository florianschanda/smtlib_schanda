...
(assert (= z (fp #b1 #b00000000 #b01111100101011110100010)))
;; z should be Float32(0x803E57A2 [Rational(-2042833, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTP x y z)))
(assert (not (= result ((_ to_fp 8 24) #x803E57A2))))
(check-sat)
(exit)
