...
(assert (= y (fp #b0 #b00000000 #b00010100101010000010000)))
;; y should be Float32(0x000A5410 [Rational(42305, 44601490397061246283071436545296723011960832), 0.000000])

(declare-const z Float32)
(assert (= z ((_ to_fp 8 24) #xFFE4BA5F)))
