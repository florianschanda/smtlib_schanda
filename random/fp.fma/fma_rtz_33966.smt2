...
(assert (= x (fp #b1 #b11111111 #b11101110111011000100101)))
;; x should be Float32(NaN)

(declare-const y Float32)
(assert (= y (fp #b0 #b10010101 #b01111100001010110110011)))
;; y should be Float32(0x4ABE15B3 [Rational(12457395, 2), 6228697.500000])
