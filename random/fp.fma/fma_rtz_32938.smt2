...
(assert (= z ((_ to_fp 8 24) #xCA04A4FE)))
;; z should be Float32(0xCA04A4FE [Rational(-4346495, 2), -2173247.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (not (= result (fp #b1 #b10010100 #b00001001010010011111110))))
(check-sat)
(exit)
