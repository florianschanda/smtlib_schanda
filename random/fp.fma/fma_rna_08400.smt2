...
(assert (= z (fp #b0 #b10010011 #b11000011110000111001100)))
;; z should be Float32(0x49E1E1CC [Rational(3700851, 2), 1850425.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x49E1E1CC))))
(check-sat)
(exit)
