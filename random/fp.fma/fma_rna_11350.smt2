...
(assert (= y ((_ to_fp 8 24) #x00011FF4)))
;; y should be Float32(0x00011FF4 [Rational(18429, 178405961588244985132285746181186892047843328), 0.000000])
...
(assert (not (= result (fp #b1 #b01111010 #b00011111111100111111111))))
(check-sat)
(exit)
