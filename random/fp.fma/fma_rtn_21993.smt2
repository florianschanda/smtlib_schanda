...
(assert (= y ((_ to_fp 8 24) #x804B52E5)))
;; y should be Float32(0x804B52E5 [Rational(-4936421, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (not (= result (fp #b1 #b10000000 #b00101101010010111001010))))
(check-sat)
(exit)
