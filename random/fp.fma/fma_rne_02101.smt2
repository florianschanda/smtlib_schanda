...
(assert (= z (fp #b1 #b10010101 #b11011111001100110100111)))
;; z should be Float32(0xCAEF99A7 [Rational(-15702439, 2), -7851219.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b10010101 #b11011111001100110100111)))
(check-sat)
(exit)
