...
(assert (= y (fp #b0 #b10010101 #b10111011010111000100001)))
;; y should be Float32(0x4ADDAE21 [Rational(14528033, 2), 7264016.500000])
...
(assert (= result (fp #b1 #b00000001 #b11011101101011100010000)))
(check-sat)
(exit)
