...
(assert (= z (fp #b0 #b01111110 #b10111000001110000010101)))
;; z should be Float32(0x3F5C1C15 [Rational(14425109, 16777216), 0.859803])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #x3F5C1C15))))
(check-sat)
(exit)
