...
(assert (= y (fp #b0 #b10010101 #b11110110101000101110111)))
;; y should be Float32(0x4AFB5177 [Rational(16470391, 2), 8235195.500000])
...
(assert (= result ((_ to_fp 8 24) #x00025744)))
(check-sat)
(exit)
