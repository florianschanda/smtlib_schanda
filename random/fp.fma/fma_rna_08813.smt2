...
(assert (= y (fp #b0 #b11111101 #b11101001010100011101110)))
;; y should be Float32(0x7EF4A8EE [Rational(162604382028619496563841472768759562240), 162604382028619496563841472768759562240.000000])
...
(assert (not (= result (fp #b0 #b01111111 #b11101001010100011101110))))
(check-sat)
(exit)
