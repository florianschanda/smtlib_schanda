...
(assert (= z (fp #b1 #b00000000 #b00010010010000101100011)))
;; z should be Float32(0x80092163 [Rational(-598371, 713623846352979940529142984724747568191373312), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (= result (fp #b1 #b00000000 #b00010010010000101100011)))
(check-sat)
(exit)
