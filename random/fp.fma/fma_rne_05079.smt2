...
(assert (= y (fp #b0 #b10010101 #b11011110001000110010001)))
;; y should be Float32(0x4AEF1191 [Rational(15667601, 2), 7833800.500000])
...
(assert (= result ((_ to_fp 8 24) #x8BEF118F)))
(check-sat)
(exit)
