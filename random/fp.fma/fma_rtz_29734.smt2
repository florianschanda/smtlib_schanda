...
(assert (= z (fp #b1 #b00000000 #b10001010110000100010010)))
;; z should be Float32(0x80456112 [Rational(-2273417, 356811923176489970264571492362373784095686656), -0.000000])

(declare-const result Float32)
(assert (= result (fp.fma RTZ x y z)))
(assert (= result ((_ to_fp 8 24) #x80456111)))
(check-sat)
(exit)
