...
(assert (= x (fp #b0 #b10010100 #b10000010111111000001101)))
;; x should be Float32(0x4A417E0D [Rational(12680717, 4), 3170179.250000])
...
(assert (not (= result (fp #b0 #b00000000 #b10011111010000001111101))))
(check-sat)
(exit)
