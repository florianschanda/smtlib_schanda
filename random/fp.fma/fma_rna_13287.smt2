...
(assert (= x (fp #b1 #b00000000 #b00001110000111010011111)))
;; x should be Float32(0x80070E9F [Rational(-462495, 713623846352979940529142984724747568191373312), -0.000000])
