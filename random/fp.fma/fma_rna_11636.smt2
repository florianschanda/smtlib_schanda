...
(assert (= z ((_ to_fp 8 24) #x503E618A)))
;; z should be Float32(0x503E618A [Rational(12776253440), 12776253440.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (= result (fp #b0 #b10100000 #b01111100110000110001010)))
(check-sat)
(exit)
