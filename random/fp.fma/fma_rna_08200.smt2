...
(assert (= z (fp #b1 #b10010011 #b00101001000100001100100)))
;; z should be Float32(0xC9948864 [Rational(-2433561, 2), -1216780.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result (fp #b1 #b10010011 #b00101001000100010000100))))
(check-sat)
(exit)
