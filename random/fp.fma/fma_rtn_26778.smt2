...
(assert (= x (fp #b1 #b00000000 #b00011000000001111110111)))
;; x should be Float32(0x800C03F7 [Rational(-787447, 713623846352979940529142984724747568191373312), -0.000000])
...
(assert (= result (fp #b1 #b01111101 #b10000000011111101110000)))
(check-sat)
(exit)
