...
(assert (= y ((_ to_fp 8 24) #x7DA6CB51)))
;; y should be Float32(0x7DA6CB51 [Rational(27713440804719562586991000311090380800), 27713440804719562586991000311090380800.000000])
...
(assert (= result ((_ to_fp 8 24) #xBEA6CB4F)))
(check-sat)
(exit)
