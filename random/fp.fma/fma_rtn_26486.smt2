...
(assert (= x (fp #b1 #b01001000 #b11001000101000010101000)))
;; x should be Float32(0xA46450A8 [Rational(-1870357, 37778931862957161709568), -0.000000])
...
(assert (= z ((_ to_fp 8 24) #x7FB0D193)))
