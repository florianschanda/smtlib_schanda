...
(assert (= z ((_ to_fp 8 24) #x4A6B6AD6)))
;; z should be Float32(0x4A6B6AD6 [Rational(7714155, 2), 3857077.500000])

(declare-const result Float32)
(assert (= result (fp.fma RNE x y z)))
(assert (not (= result (fp #b0 #b10010100 #b11010110110101011010110))))
(check-sat)
(exit)
