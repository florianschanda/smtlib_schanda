...
(assert (= z (fp #b0 #b10010101 #b11011110011101101110001)))
;; z should be Float32(0x4AEF3B71 [Rational(15678321, 2), 7839160.500000])

(declare-const result Float32)
(assert (= result (fp.fma RTN x y z)))
(assert (= result ((_ to_fp 8 24) #x4AEF3B70)))
(check-sat)
(exit)
