...
(assert (= x ((_ to_fp 8 24) #x0017DE91)))
;; x should be Float32(0x0017DE91 [Rational(1564305, 713623846352979940529142984724747568191373312), 0.000000])
...
(assert (not (= result (fp #b0 #b01111110 #b01111101111010010000111))))
(check-sat)
(exit)
