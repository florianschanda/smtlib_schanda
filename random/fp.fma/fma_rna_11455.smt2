...
(assert (= z ((_ to_fp 8 24) #xE17AB053)))
;; z should be Float32(0xE17AB053 [Rational(-289024469837570637824), -289024469837570637824.000000])

(declare-const result Float32)
(assert (= result (fp.fma RNA x y z)))
(assert (not (= result ((_ to_fp 8 24) #xE17AB053))))
(check-sat)
(exit)
