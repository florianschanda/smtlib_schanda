...
(assert (= y ((_ to_fp 8 24) #x80132D7C)))
;; y should be Float32(0x80132D7C [Rational(-314207, 178405961588244985132285746181186892047843328), -0.000000])
...
(assert (= result ((_ to_fp 8 24) #xBF196BDF)))
(check-sat)
(exit)
