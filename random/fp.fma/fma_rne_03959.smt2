...
(assert (= x (fp #b1 #b10010101 #b01110110111001111010101)))
;; x should be Float32(0xCABB73D5 [Rational(-12284885, 2), -6142442.500000])

(declare-const y Float32)
(assert (= y (fp #b0 #b11111111 #b10101000111111011000110)))
